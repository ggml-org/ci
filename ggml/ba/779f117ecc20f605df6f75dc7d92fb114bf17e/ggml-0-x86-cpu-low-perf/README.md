...
- status:  SUCCESS ✅
- runtime: 2:02.79
- date:    Sun Nov 12 13:36:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/17 Test  #8: test2 ............................   Passed    9.81 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.67 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.12 sec
      Start  2: test-quantize-fns
...
main:  predict time =   604.22 ms / 9.44 ms per token
main:    total time =   770.34 ms
...
main:  predict time =   635.45 ms / 9.08 ms per token
main:    total time =   791.49 ms
...
main:  predict time =  2503.10 ms
main:    total time =  2831.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f220bf99960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f220be1a190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a0d260cb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f220bf99010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f220bf9e900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a0d260d940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f220be1a190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a0d260cb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a0d260e290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a0d260d940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f220bf99010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a0d260ebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a0d260e290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a0d260f530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f220bf99960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a0d260ebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a0d260f6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a0d260f530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f220bf9e900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a0d260f890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a0d260f6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    81.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.02 ms
whisper_print_timings:   sample time =    16.38 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1979.06 ms /     1 runs ( 1979.06 ms per run)
whisper_print_timings:   decode time =   265.30 ms /    27 runs (    9.83 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2400.62 ms
...
main:     load time =    72.76 ms
main:    total time = 18938.06 ms
embd_img
