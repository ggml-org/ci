...
- status:  SUCCESS ✅
- runtime: 4:49.95
- date:    Sun Nov 12 01:39:02 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ba779f117ecc20f605df6f75dc7d92fb114bf17e
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.20 sec
...
Total Test time (real) =  13.89 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.12 sec
      Start  2: test-opt
 ...
 5/18 Test  #5: test-mul-mat0 ....................   Passed    0.58 sec
...
main:  predict time =   811.93 ms / 12.69 ms per token
main:    total time =  1035.89 ms
...
main:     load time =   170.50 ms
main:   sample time =    16.95 ms
main:  predict time =   876.39 ms / 12.52 ms per token
main:    total time =  1066.56 ms
...
main:     n_decoded =      504
main:     load time =   145.29 ms
main:   sample time =   128.29 ms
main:  predict time =  5831.76 ms
main:    total time =  6185.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2b4a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa29cb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabeeeab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2b4a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2b4f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabeeeb940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa29cb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabeeeab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabeeec290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabeeeb940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2b4a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabeeecbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabeeec290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabeeed530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2b4a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabeeecbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabeeed6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabeeed530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2b4f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaabeeed890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabeeed6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   192.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.51 ms
whisper_print_timings:   sample time =    20.80 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4622.47 ms /     1 runs ( 4622.47 ms per run)
whisper_print_timings:   decode time =   174.32 ms /    27 runs (    6.46 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5070.80 ms
...
main:      load time = 12932.98 ms
main:    sample time =   528.85 ms / 8.26 ms per token
main:      eval time = 43446.86 ms / 620.67 ms per token
main:     total time = 59281.87 ms
...
main:      load time =  4342.65 ms
main:    sample time =   524.22 ms / 8.19 ms per token
main:      eval time = 17536.71 ms / 250.52 ms per token
main:     total time = 23372.82 ms
