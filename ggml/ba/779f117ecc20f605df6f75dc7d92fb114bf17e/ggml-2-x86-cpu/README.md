...
- status:  SUCCESS ✅
- runtime: 3:09.80
- date:    Sun Nov 12 13:37:21 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.23 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.11 sec
      Start  2: test-opt
...
main:  predict time =   434.40 ms / 6.79 ms per token
main:    total time =   660.09 ms
...
main:     load time =   123.18 ms
main:   sample time =    23.64 ms
main:  predict time =   449.72 ms / 6.42 ms per token
main:    total time =   598.23 ms
...
main:     n_decoded =      504
main:     load time =   100.67 ms
main:   sample time =   177.82 ms
main:  predict time =  1474.72 ms
main:    total time =  1783.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cefce0960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cefb61190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e5174fab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cefce0010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cefce5900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e5174fb940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cefb61190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e5174fab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e5174fc290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e5174fb940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cefce0010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e5174fcbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e5174fc290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e5174fd530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cefce0960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e5174fcbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e5174fd6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e5174fd530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cefce5900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e5174fd890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e5174fd6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1133.97 ms /     1 runs ( 1133.97 ms per run)
whisper_print_timings:   decode time =    91.32 ms /    27 runs (    3.38 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1425.53 ms
...
main:      load time = 12718.16 ms
main:    sample time =   469.25 ms / 7.33 ms per token
main:      eval time = 20180.57 ms / 288.29 ms per token
main:     total time = 34055.01 ms
...
main:      load time =  4371.54 ms
main:    sample time =   466.52 ms / 7.29 ms per token
main:      eval time =  7985.28 ms / 114.08 ms per token
main:     total time = 13208.08 ms
