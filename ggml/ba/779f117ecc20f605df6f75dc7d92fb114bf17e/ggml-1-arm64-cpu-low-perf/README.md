...
- status:  SUCCESS ✅
- runtime: 2:35.99
- date:    Sun Nov 12 01:36:56 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.11 sec
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.14 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.23 sec
      Start  9: test3
...
main:     load time =   188.65 ms
main:   sample time =    17.62 ms
main:  predict time =   830.18 ms / 12.97 ms per token
main:    total time =  1058.35 ms
...
main:  predict time =   890.63 ms / 12.72 ms per token
...
main:  predict time =  6048.21 ms
main:    total time =  6416.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa753a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa73bb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb980b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa753a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa753f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadb981940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa73bb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb980b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadb982290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadb981940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa753a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadb982be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadb982290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadb983530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa753a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadb982be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadb9836e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadb983530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa753f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadb983890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadb9836e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.77 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    21.41 ms /    27 runs (    0.79 ms per run)
whisper_print_timings:   encode time =  4723.69 ms /     1 runs ( 4723.69 ms per run)
whisper_print_timings:   decode time =   176.63 ms /    27 runs (    6.54 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5102.72 ms
