...
- status:  FAILURE ❌ (2)
- runtime: 1:52.60
- date:    Tue Aug 20 09:31:11 UTC 2024
...
main:  predict time =   661.10 ms / 10.33 ms per token
main:    total time =   810.42 ms
...
main:   sample time =    30.59 ms
main:  predict time =   684.47 ms / 9.78 ms per token
main:    total time =   824.00 ms
...
main:  predict time =   691.97 ms / 9.89 ms per token
...
main:   sample time =   209.83 ms
main:  predict time =  2775.16 ms
main:    total time =  3137.61 ms
