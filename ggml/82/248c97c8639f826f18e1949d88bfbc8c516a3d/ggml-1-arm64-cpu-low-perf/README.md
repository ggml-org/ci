...
- status:  SUCCESS ✅
- runtime: 6:02.23
- date:    Sat Feb 10 08:15:40 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  154.58 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 191.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.68 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.11 sec
...
main:     load time =   186.13 ms
main:   sample time =    16.91 ms
main:  predict time =   863.72 ms / 13.50 ms per token
main:    total time =  1088.91 ms
...
main:     load time =   188.64 ms
main:   sample time =    17.03 ms
main:  predict time =   948.66 ms / 13.55 ms per token
main:    total time =  1157.44 ms
...
main:  predict time =  6124.72 ms
main:    total time =  6496.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9eb4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e9cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05d2db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9eb4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9eb4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05d2e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e9cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05d2db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05d2f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05d2e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9eb4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05d2fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05d2f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab05d30580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9eb4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05d2fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05d30740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab05d30580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9eb4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab05d30900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05d30740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4721.47 ms /     1 runs ( 4721.47 ms per run)
whisper_print_timings:   decode time =    16.17 ms /     2 runs (    8.08 ms per run)
whisper_print_timings:   batchd time =   717.53 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5650.63 ms
...
main:     load time =    92.72 ms
main:    total time = 40509.62 ms
embd_img
