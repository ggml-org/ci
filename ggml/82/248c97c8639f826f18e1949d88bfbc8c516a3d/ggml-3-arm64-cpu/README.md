...
- status:  FAILURE ❌ (1)
- runtime: 4:50.46
- date:    Sat Feb 10 08:37:12 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  132.68 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 146.06 sec
...
21/21 Test #21: test-backend-ops .................   Passed   23.36 sec
...
main:     load time =   181.38 ms
main:   sample time =    17.38 ms
main:  predict time =   841.78 ms / 13.15 ms per token
main:    total time =  1062.73 ms
...
main:     load time =   180.87 ms
main:   sample time =    17.65 ms
main:  predict time =   921.17 ms / 13.16 ms per token
main:    total time =  1123.00 ms
...
main:  predict time =  5930.51 ms
main:    total time =  6289.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae54a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae3cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1dc19b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae54a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae54f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1dc1a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae3cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1dc19b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1dc1b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1dc1a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae54a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1dc1bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1dc1b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1dc1c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae54a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1dc1bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1dc1c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1dc1c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae54f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab1dc1c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1dc1c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.72 ms
whisper_print_timings:   sample time =    65.41 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4620.68 ms /     1 runs ( 4620.68 ms per run)
whisper_print_timings:   decode time =    15.57 ms /     2 runs (    7.79 ms per run)
whisper_print_timings:   batchd time =   710.31 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5534.92 ms
...
main:     load time =    86.68 ms
main:    total time = 39737.45 ms
embd_img
