...
- status:  SUCCESS ✅
- runtime: 6:17.74
- date:    Sat Jan 27 03:24:13 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.19 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.66 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  153.21 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 191.34 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.14 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.69 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.49 sec
...
main:  predict time =  1038.56 ms / 16.23 ms per token
main:    total time =  1273.51 ms
...
main:     load time =   191.00 ms
main:   sample time =    17.79 ms
main:  predict time =   968.27 ms / 13.83 ms per token
main:    total time =  1180.30 ms
...
main:     n_decoded =      504
main:     load time =   168.93 ms
main:   sample time =   129.46 ms
main:  predict time =  6269.01 ms
main:    total time =  6650.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff82f8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82e0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacaacbb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff82f8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff82f8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacaacc960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82e0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacaacbb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacaacd2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacaacc960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff82f8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacaacdc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacaacd2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacaace580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff82f8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacaacdc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacaace740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacaace580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff82f8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacaace900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacaace740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.11 ms
whisper_print_timings:   sample time =    67.12 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4772.93 ms /     1 runs ( 4772.93 ms per run)
whisper_print_timings:   decode time =    16.47 ms /     2 runs (    8.23 ms per run)
whisper_print_timings:   batchd time =   717.33 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5706.59 ms
...
main:     load time =    93.60 ms
main:    total time = 40673.12 ms
embd_img
