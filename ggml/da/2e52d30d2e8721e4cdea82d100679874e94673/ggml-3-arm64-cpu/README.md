...
- status:  SUCCESS ✅
- runtime: 8:15.52
- date:    Sat Jan 27 03:37:03 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  128.47 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.49 sec
...
main:     load time =   256.62 ms
main:   sample time =    16.75 ms
main:  predict time =   857.18 ms / 13.39 ms per token
main:    total time =  1152.37 ms
...
main:  predict time =   931.40 ms / 13.31 ms per token
main:    total time =  1129.16 ms
...
main:  predict time =  6012.35 ms
main:    total time =  6366.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf06a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaeeeb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac6977b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf06a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf06f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac6978960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaeeeb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac6977b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac69792c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac6978960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf06a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac6979c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac69792c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac697a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf06a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac6979c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac697a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac697a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf06f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac697a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac697a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.15 ms
whisper_print_timings:   sample time =    66.16 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4621.89 ms /     1 runs ( 4621.89 ms per run)
whisper_print_timings:   decode time =    15.78 ms /     2 runs (    7.89 ms per run)
whisper_print_timings:   batchd time =   712.04 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5611.18 ms
...
main:      load time = 12181.57 ms
main:    sample time =   520.81 ms / 8.14 ms per token
main:      eval time = 43741.97 ms / 624.89 ms per token
main:     total time = 58817.29 ms
...
main:      load time =  4375.97 ms
main:    sample time =   512.26 ms / 8.00 ms per token
main:      eval time = 17391.66 ms / 248.45 ms per token
main:     total time = 23236.01 ms
