...
- status:  SUCCESS ✅
- runtime: 5:00.57
- date:    Sat Jan 27 15:22:10 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/da2e52d30d2e8721e4cdea82d100679874e94673
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.11 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  116.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   23.92 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.94 sec
...
main:  predict time =   653.93 ms / 10.22 ms per token
main:    total time =   816.53 ms
...
main:     load time =   129.43 ms
main:   sample time =    23.48 ms
main:  predict time =   668.26 ms / 9.55 ms per token
main:    total time =   823.71 ms
...
main:  predict time =  2514.88 ms
main:    total time =  2847.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f87800e9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f877ff6a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5642362c3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f87800e9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f87800ee940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5642362c4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f877ff6a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5642362c3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5642362c52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5642362c4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f87800e9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5642362c5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5642362c52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5642362c6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f87800e9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5642362c5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5642362c6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5642362c6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f87800ee940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5642362c6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5642362c6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.37 ms
whisper_print_timings:   sample time =    71.82 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1982.29 ms /     1 runs ( 1982.29 ms per run)
whisper_print_timings:   decode time =    12.75 ms /     2 runs (    6.37 ms per run)
whisper_print_timings:   batchd time =   324.75 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2493.38 ms
