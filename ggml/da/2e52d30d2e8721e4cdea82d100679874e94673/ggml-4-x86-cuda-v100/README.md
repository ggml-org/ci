...
- status:  SUCCESS ✅
- runtime: 12:17.65
- date:    Sat Jan 27 15:41:22 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.97 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  220.99 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 267.38 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.58 sec
      Start  2: test-opt
...
14/21 Test #14: test-rel-pos .....................   Passed    0.60 sec
...
21/21 Test #21: test-backend-ops .................   Passed   46.84 sec
...
main:     load time =   589.79 ms
main:   sample time =    34.36 ms
main:  predict time =   615.91 ms / 9.62 ms per token
main:    total time =  1260.42 ms
...
main:     n_decoded =      504
main:     load time =   558.60 ms
main:   sample time =   239.62 ms
main:  predict time =  2397.25 ms
main:    total time =  3239.52 ms
...
main: loaded model in   475.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa1ad1b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa1ad0371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5624d615ca40                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa1ad1b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa1ad1bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5624d615d810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa1ad0371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5624d615ca40                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5624d615e170                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5624d615d810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa1ad1b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5624d615ead0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5624d615e170                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5624d615f430                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa1ad1b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5624d615ead0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5624d615f5f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5624d615f430                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa1ad1bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5624d615f7b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5624d615f5f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   808.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.66 ms
whisper_print_timings:   sample time =    66.74 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    24.93 ms /     1 runs (   24.93 ms per run)
whisper_print_timings:   decode time =    20.69 ms /     2 runs (   10.34 ms per run)
whisper_print_timings:   batchd time =    83.03 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1031.28 ms
...
main:     load time =   504.10 ms
main:    total time =  7974.93 ms
embd_img
...
main:      load time =  8361.09 ms
main:    sample time =   549.09 ms / 8.58 ms per token
main:      eval time = 26110.43 ms / 373.01 ms per token
main:     total time = 35929.14 ms
...
main:      load time =  2026.31 ms
main:    sample time =   537.87 ms / 8.40 ms per token
main:      eval time = 12439.04 ms / 177.70 ms per token
