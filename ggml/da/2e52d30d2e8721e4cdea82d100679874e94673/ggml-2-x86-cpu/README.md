...
- status:  SUCCESS ✅
- runtime: 5:37.18
- date:    Sat Jan 27 15:39:12 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  113.34 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 124.31 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.99 sec
...
main:     load time =   187.85 ms
main:   sample time =    23.42 ms
main:  predict time =   462.95 ms / 7.23 ms per token
main:    total time =   687.31 ms
...
main:     n_decoded =      504
main:     load time =   109.93 ms
main:   sample time =   177.87 ms
main:  predict time =  1519.86 ms
main:    total time =  1838.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f83208fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f832077b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559be7c9ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f83208fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f83208ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559be7c9b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f832077b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559be7c9ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559be7c9c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559be7c9b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f83208fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559be7c9cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559be7c9c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559be7c9d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f83208fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559be7c9cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559be7c9d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559be7c9d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f83208ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559be7c9d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559be7c9d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    55.97 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1165.89 ms /     1 runs ( 1165.89 ms per run)
whisper_print_timings:   decode time =    10.45 ms /     2 runs (    5.23 ms per run)
whisper_print_timings:   batchd time =   217.02 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1597.15 ms
...
main:     load time =    60.35 ms
main:    total time = 10622.42 ms
embd_img
...
main:      load time = 10454.58 ms
main:    sample time =   467.08 ms / 7.30 ms per token
main:      eval time = 20655.91 ms / 295.08 ms per token
main:     total time = 32241.06 ms
...
main:      load time =  4391.00 ms
main:    sample time =   464.64 ms / 7.26 ms per token
main:      eval time =  8339.16 ms / 119.13 ms per token
main:     total time = 13655.29 ms
