...
- status:  SUCCESS ✅
- runtime: 3:25.87
- date:    Sun Jun 16 12:03:48 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.27 sec
...
Total Test time (real) =  74.14 sec
...
main:     load time =   101.75 ms
main:   sample time =    23.87 ms
main:  predict time =   658.84 ms / 10.29 ms per token
main:    total time =   797.07 ms
...
main:  predict time =   669.93 ms / 9.57 ms per token
main:    total time =   799.91 ms
...
main:     load time =   122.61 ms
main:   sample time =    23.91 ms
main:  predict time =   686.93 ms / 9.81 ms per token
main:    total time =   836.49 ms
...
main:  predict time =  2579.67 ms
main:    total time =  2905.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7a9786afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7a978697b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5ef53757dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7a9786afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7a9786aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5ef53757eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7a978697b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5ef53757dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5ef53757f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5ef53757eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7a9786afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5ef53757fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5ef53757f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5ef5375806d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7a9786afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5ef53757fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5ef537580890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5ef5375806d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7a9786aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5ef537580a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5ef537580890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.05 ms
whisper_print_timings:   sample time =    72.27 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2000.81 ms /     1 runs ( 2000.81 ms per run)
whisper_print_timings:   decode time =    14.00 ms /     2 runs (    7.00 ms per run)
whisper_print_timings:   batchd time =   328.83 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2523.29 ms
