...
- status:  SUCCESS ✅
- runtime: 2:09.33
- date:    Sun Jun 16 12:07:11 UTC 2024
...
main:  predict time =   484.66 ms / 7.57 ms per token
main:    total time =   624.09 ms
...
main:  predict time =   498.63 ms / 7.12 ms per token
main:    total time =   629.12 ms
...
main:  predict time =   509.37 ms / 7.28 ms per token
main:    total time =   659.61 ms
...
main:   sample time =   178.24 ms
main:  predict time =  1541.21 ms
main:    total time =  1854.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x78eae9efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78eae9d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5a215c7e7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x78eae9efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x78eae9eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5a215c7e8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78eae9d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5a215c7e7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5a215c7e9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5a215c7e8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x78eae9efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5a215c7e9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5a215c7e9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5a215c7ea6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x78eae9efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5a215c7e9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5a215c7ea890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5a215c7ea6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x78eae9eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5a215c7eaa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5a215c7ea890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    55.31 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1164.39 ms /     1 runs ( 1164.39 ms per run)
whisper_print_timings:   decode time =    11.14 ms /     2 runs (    5.57 ms per run)
whisper_print_timings:   batchd time =   221.27 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1553.44 ms
...
main:     load time =    65.53 ms
main:    total time = 10630.99 ms
embd_img
