...
- status:  SUCCESS ✅
- runtime: 3:12.53
- date:    Sun Jun 16 12:04:16 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/71cc7dae774b8c4d91d8db7d085e079e9ed6b05c
- author:  0cc4m
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   33.37 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    2.46 sec
      Start  2: test-opt
 2/22 Test  #2: test-opt .........................   Passed    2.21 sec
 ...
 6/22 Test  #6: test-mul-mat2 ....................   Passed    1.83 sec
      Start  7: test0
...
main:     load time =   164.64 ms
main:   sample time =    19.68 ms
main:  predict time =   900.81 ms / 14.08 ms per token
main:    total time =  1106.58 ms
...
main:     load time =   163.58 ms
main:   sample time =    19.67 ms
main:  predict time =   969.41 ms / 13.85 ms per token
main:    total time =  1155.30 ms
...
main:     load time =   193.23 ms
main:   sample time =    19.42 ms
main:  predict time =   963.58 ms / 13.77 ms per token
main:    total time =  1179.60 ms
...
main:     n_decoded =      504
main:     load time =   162.88 ms
main:   sample time =   134.57 ms
main:  predict time =  6123.66 ms
main:    total time =  6504.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe6f465b2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe6f4659ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc0524b798ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe6f465b2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe6f465b2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc0524b799ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe6f4659ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc0524b798ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc0524b79a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc0524b799ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe6f465b2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc0524b79ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc0524b79a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc0524b79b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe6f465b2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc0524b79ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc0524b79b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc0524b79b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe6f465b2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc0524b79ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc0524b79b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.62 ms
whisper_print_timings:   sample time =    69.30 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4704.82 ms /     1 runs ( 4704.82 ms per run)
whisper_print_timings:   decode time =    15.21 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   736.24 ms /   125 runs (    5.89 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5672.58 ms
