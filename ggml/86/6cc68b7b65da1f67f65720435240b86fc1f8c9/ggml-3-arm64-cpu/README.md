...
- status:  SUCCESS ✅
- runtime: 7:07.77
- date:    Sat Jan 27 04:28:04 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  127.97 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 141.91 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.12 sec
      Start  2: test-opt
...
main:     load time =   226.58 ms
main:   sample time =    16.89 ms
main:  predict time =   853.86 ms / 13.34 ms per token
main:    total time =  1119.38 ms
...
main:  predict time =   933.78 ms / 13.34 ms per token
main:    total time =  1137.48 ms
...
main:     n_decoded =      504
main:     load time =   157.28 ms
main:   sample time =   127.17 ms
main:  predict time =  6038.43 ms
main:    total time =  6405.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8184a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff816cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafce8eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8184a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8184f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafce8f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff816cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafce8eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafce902c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafce8f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8184a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafce90c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafce902c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafce91580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8184a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafce90c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafce91740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafce91580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8184f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafce91900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafce91740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4623.12 ms /     1 runs ( 4623.12 ms per run)
whisper_print_timings:   decode time =    15.83 ms /     2 runs (    7.92 ms per run)
whisper_print_timings:   batchd time =   711.54 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5548.48 ms
...
main:     load time =    93.56 ms
main:    total time = 39723.50 ms
embd_img
...
main:      load time =  5667.73 ms
main:    sample time =   522.32 ms / 8.16 ms per token
main:      eval time = 43740.49 ms / 624.86 ms per token
main:     total time = 52304.10 ms
...
main:      load time =  1604.06 ms
main:    sample time =   515.30 ms / 8.05 ms per token
main:      eval time = 17402.64 ms / 248.61 ms per token
main:     total time = 20478.01 ms
