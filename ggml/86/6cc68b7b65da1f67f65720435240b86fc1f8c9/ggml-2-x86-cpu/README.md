...
- status:  SUCCESS ✅
- runtime: 5:05.21
- date:    Sat Jan 27 16:10:58 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  115.55 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 126.47 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.44 sec
...
main:  predict time =   467.27 ms / 7.30 ms per token
main:    total time =   627.90 ms
...
main:     load time =   126.05 ms
main:   sample time =    23.77 ms
main:  predict time =   487.98 ms / 6.97 ms per token
main:    total time =   640.22 ms
...
main:   sample time =   177.78 ms
main:  predict time =  1516.51 ms
main:    total time =  1829.04 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc7d7fb8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc7d7e391a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55813d035b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc7d7fb8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc7d7fbd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55813d036960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc7d7e391a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55813d035b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55813d0372c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55813d036960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc7d7fb8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55813d037c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55813d0372c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55813d038580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc7d7fb8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55813d037c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55813d038740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55813d038580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc7d7fbd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55813d038900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55813d038740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.96 ms
whisper_print_timings:   sample time =    56.25 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1156.67 ms /     1 runs ( 1156.67 ms per run)
whisper_print_timings:   decode time =    10.89 ms /     2 runs (    5.45 ms per run)
whisper_print_timings:   batchd time =   217.03 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1534.04 ms
...
main:      load time =  5323.96 ms
main:    sample time =   470.70 ms / 7.35 ms per token
main:      eval time = 19743.10 ms / 282.04 ms per token
main:     total time = 26177.66 ms
...
main:      load time =  1185.88 ms
main:    sample time =   466.62 ms / 7.29 ms per token
main:      eval time =  8170.92 ms / 116.73 ms per token
main:     total time = 10195.49 ms
