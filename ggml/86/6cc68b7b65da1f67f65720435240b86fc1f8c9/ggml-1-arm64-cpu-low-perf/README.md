...
- status:  SUCCESS ✅
- runtime: 6:05.23
- date:    Sat Jan 27 04:11:57 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.08 sec
...
20/20 Test #20: test-backend-ops .................   Passed  150.19 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 188.93 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.74 sec
...
main:     load time =   197.41 ms
main:   sample time =    17.98 ms
main:  predict time =   996.87 ms / 14.24 ms per token
main:    total time =  1215.60 ms
...
main:     n_decoded =      504
main:     load time =   162.28 ms
main:   sample time =   131.74 ms
main:  predict time =  6234.74 ms
main:    total time =  6611.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff94dea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff94c6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae4b13b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff94dea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff94def940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae4b14960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff94c6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae4b13b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae4b152c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae4b14960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff94dea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae4b15c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae4b152c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae4b16580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff94dea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae4b15c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae4b16740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae4b16580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff94def940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae4b16900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae4b16740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4748.70 ms /     1 runs ( 4748.70 ms per run)
whisper_print_timings:   decode time =    16.03 ms /     2 runs (    8.02 ms per run)
whisper_print_timings:   batchd time =   754.39 ms /   125 runs (    6.04 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5722.71 ms
