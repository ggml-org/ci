...
- status:  SUCCESS ✅
- runtime: 3:46.34
- date:    Sun Oct  8 03:01:13 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.66 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.58 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.63 sec
      Start  2: test-opt
...
main:     load time =   235.75 ms
main:   sample time =    17.19 ms
main:  predict time =   801.34 ms / 12.52 ms per token
main:    total time =  1077.07 ms
...
main:     load time =   141.59 ms
main:   sample time =    16.98 ms
main:  predict time =   866.78 ms / 12.38 ms per token
main:    total time =  1028.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb6bfa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb6a7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacac3ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb6bf9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb6bff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacac3f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb6a7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacac3ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacac401a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacac3f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb6bf9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacac40ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacac401a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacac41400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb6bfa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacac40ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacac41590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacac41400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb6bff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaacac41720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacac41590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   194.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.90 ms
whisper_print_timings:   sample time =    20.95 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4599.10 ms /     1 runs ( 4599.10 ms per run)
whisper_print_timings:   decode time =   177.63 ms /    27 runs (    6.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5056.48 ms
```
### mpt
...
main:      load time =  5633.25 ms
main:    sample time =   516.56 ms / 8.07 ms per token
main:      eval time = 43501.13 ms / 621.44 ms per token
main:     total time = 52024.49 ms
...
main:      load time =  1555.51 ms
main:    sample time =   518.14 ms / 8.10 ms per token
main:      eval time = 17379.55 ms / 248.28 ms per token
main:     total time = 20417.38 ms
