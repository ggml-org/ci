...
- status:  SUCCESS ✅
- runtime: 2:58.39
- date:    Sun Oct  8 14:52:04 UTC 2023
...
main:     load time =   183.99 ms
main:   sample time =    23.97 ms
main:  predict time =   481.16 ms / 7.52 ms per token
main:    total time =   702.73 ms
...
main:   sample time =    23.97 ms
main:  predict time =   492.39 ms / 7.03 ms per token
main:    total time =   630.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f987bc73900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f987baf4170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560dc03e7ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f987bc72fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f987bc78880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560dc03e8870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f987baf4170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560dc03e7ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560dc03e91a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560dc03e8870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f987bc72fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560dc03e9ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560dc03e91a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560dc03ea400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f987bc73900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560dc03e9ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560dc03ea590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560dc03ea400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f987bc78880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560dc03ea720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560dc03ea590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   140.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    22.06 ms
whisper_print_timings:   sample time =    16.52 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1186.31 ms /     1 runs ( 1186.31 ms per run)
whisper_print_timings:   decode time =   108.05 ms /    27 runs (    4.00 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1517.93 ms
```
### mpt
...
main:      load time = 11540.01 ms
main:    sample time =   463.50 ms / 7.24 ms per token
main:      eval time = 21774.86 ms / 311.07 ms per token
main:     total time = 34481.99 ms
...
main:      load time =  4383.72 ms
main:    sample time =   460.99 ms / 7.20 ms per token
main:      eval time =  8743.30 ms / 124.90 ms per token
main:     total time = 13972.08 ms
