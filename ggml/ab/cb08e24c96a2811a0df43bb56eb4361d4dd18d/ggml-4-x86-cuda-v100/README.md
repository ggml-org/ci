...
- status:  SUCCESS ✅
- runtime: 5:00.03
- date:    Sun Oct  8 15:02:40 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.18 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.59 sec
      Start  2: test-opt
...
main:     load time =   220.49 ms
main:   sample time =    35.77 ms
main:  predict time =   567.81 ms / 8.87 ms per token
main:    total time =   844.71 ms
...
main:     load time =   148.70 ms
main:   sample time =    34.63 ms
main:  predict time =   580.57 ms / 8.29 ms per token
main:    total time =   768.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f493cd37900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f493cbb8170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6df9fcad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f493cd36fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f493cd3c880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a6df9fd870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f493cbb8170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6df9fcad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a6df9fe1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a6df9fd870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f493cd36fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a6df9fead0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a6df9fe1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a6df9ff400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f493cd37900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a6df9fead0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a6df9ff590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a6df9ff400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f493cd3c880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a6df9ff720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a6df9ff590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   212.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.82 ms
whisper_print_timings:   sample time =    20.07 ms /    27 runs (    0.74 ms per run)
whisper_print_timings:   encode time =  1843.14 ms /     1 runs ( 1843.14 ms per run)
whisper_print_timings:   decode time =   144.16 ms /    27 runs (    5.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2303.21 ms
```
### mpt
...
main:      load time =  6851.81 ms
main:    sample time =   585.90 ms / 9.15 ms per token
main:      eval time = 24948.54 ms / 356.41 ms per token
main:     total time = 33295.64 ms
...
main:      load time =  1700.96 ms
main:    sample time =   571.04 ms / 8.92 ms per token
main:      eval time = 12163.10 ms / 173.76 ms per token
main:     total time = 15056.88 ms
