...
- status:  SUCCESS ✅
- runtime: 4:52.64
- date:    Thu Oct 12 07:37:42 UTC 2023
...
main:     load time =  1100.74 ms
main:   sample time =    34.80 ms
main:  predict time =   564.65 ms / 8.82 ms per token
main:    total time =  1720.15 ms
...
main:     load time =   167.69 ms
main:   sample time =    36.38 ms
main:  predict time =   603.74 ms / 8.62 ms per token
main:    total time =   812.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa756f9a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa756e1b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557a96860ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa756f99fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa756f9f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557a96861870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa756e1b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557a96860ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557a968621a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557a96861870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa756f99fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557a96862ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557a968621a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557a96863400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa756f9a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557a96862ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557a96863590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557a96863400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa756f9f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557a96863720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557a96863590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   629.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.69 ms
whisper_print_timings:   sample time =    19.97 ms /    27 runs (    0.74 ms per run)
whisper_print_timings:   encode time =  1865.38 ms /     1 runs ( 1865.38 ms per run)
whisper_print_timings:   decode time =   132.51 ms /    27 runs (    4.91 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2730.66 ms
```
### mpt
...
main:      load time =  7098.54 ms
main:    sample time =   592.52 ms / 9.26 ms per token
main:      eval time = 25505.09 ms / 364.36 ms per token
main:     total time = 34087.96 ms
...
main:      load time =  1716.23 ms
main:    sample time =   587.92 ms / 9.19 ms per token
main:      eval time = 12265.58 ms / 175.22 ms per token
main:     total time = 15225.13 ms
