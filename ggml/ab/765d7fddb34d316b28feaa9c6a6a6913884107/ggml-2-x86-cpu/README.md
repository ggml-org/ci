...
- status:  SUCCESS ✅
- runtime: 2:55.36
- date:    Thu Oct 12 07:16:19 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.71 sec
      Start  2: test-opt
...
main:     load time =   177.06 ms
main:   sample time =    24.03 ms
main:  predict time =   472.23 ms / 7.38 ms per token
main:    total time =   687.18 ms
...
main:     load time =   123.19 ms
main:   sample time =    23.89 ms
main:  predict time =   490.95 ms / 7.01 ms per token
main:    total time =   641.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4f5d1fd900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4f5d07e170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564ed5a14ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4f5d1fcfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4f5d202880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564ed5a15870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4f5d07e170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564ed5a14ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564ed5a161a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564ed5a15870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4f5d1fcfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564ed5a16ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564ed5a161a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564ed5a17400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4f5d1fd900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564ed5a16ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564ed5a17590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564ed5a17400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4f5d202880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564ed5a17720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564ed5a17590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   160.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    16.36 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1160.08 ms /     1 runs ( 1160.08 ms per run)
whisper_print_timings:   decode time =   106.17 ms /    27 runs (    3.93 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1501.56 ms
```
### mpt
...
main:      load time = 11279.50 ms
main:    sample time =   463.81 ms / 7.25 ms per token
main:      eval time = 22047.12 ms / 314.96 ms per token
main:     total time = 34481.74 ms
...
main:      load time =  4397.62 ms
main:    sample time =   460.63 ms / 7.20 ms per token
main:      eval time =  8572.76 ms / 122.47 ms per token
main:     total time = 13817.28 ms
