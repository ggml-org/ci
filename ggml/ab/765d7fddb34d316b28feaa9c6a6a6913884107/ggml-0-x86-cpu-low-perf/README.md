...
- status:  SUCCESS ✅
- runtime: 1:29.77
- date:    Thu Oct 12 07:14:53 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.04 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.82 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.72 sec
      Start  2: test-quantize-fns
...
main:     load time =   107.02 ms
main:   sample time =    24.02 ms
main:  predict time =   605.34 ms / 9.46 ms per token
main:    total time =   749.59 ms
...
main:     load time =   106.67 ms
main:   sample time =    23.90 ms
main:  predict time =   629.80 ms / 9.00 ms per token
main:    total time =   763.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6d5022c900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6d500ad170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b06dadad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6d5022bfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6d50231880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555b06dae870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6d500ad170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b06dadad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555b06daf1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555b06dae870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6d5022bfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555b06dafad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555b06daf1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555b06db0400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6d5022c900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555b06dafad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555b06db0590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555b06db0400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6d50231880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555b06db0720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555b06db0590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    85.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.04 ms
whisper_print_timings:   sample time =    16.83 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  2057.47 ms /     1 runs ( 2057.47 ms per run)
whisper_print_timings:   decode time =   158.01 ms /    27 runs (    5.85 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2383.17 ms
```
