...
- status:  FAILURE ❌ (124)
- runtime: 
- date:    Thu Oct 12 14:17:08 EEST 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    1.16 sec
...
10/15 Test #10: test3 ............................   Passed    0.23 sec
      Start 11: test-pool
11/15 Test #11: test-pool ........................   Passed    0.26 sec
...
13/16 Test #13: test-conv-transpose ..............   Passed    0.17 sec
...
main:     load time =   140.56 ms
main:   sample time =     8.92 ms
main:  predict time =   299.61 ms / 4.68 ms per token
main:    total time =   453.22 ms
...
main:  predict time =   314.38 ms / 4.49 ms per token
main:    total time =   412.85 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x148009160                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x148009f00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x140008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x148009160                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14800a830                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x148009f00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x140186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14800b160                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14800a830                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14800ba90                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1401878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14800b160                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14800bc20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14800ba90                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14018c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x14800bdb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14800bc20                           node_4
...
whisper_print_timings:     load time =   113.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.47 ms
whisper_print_timings:   sample time =    11.65 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   636.97 ms /     1 runs (  636.97 ms per run)
whisper_print_timings:   decode time =    63.31 ms /    27 runs (    2.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   846.91 ms
```
