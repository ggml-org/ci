...
- status:  SUCCESS ✅
- runtime: 3:58.78
- date:    Thu Oct 12 07:35:01 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.76 sec
...
main:  predict time =   870.91 ms / 12.44 ms per token
main:    total time =  1040.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff832ea900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8316b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeba7fad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff832e9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff832ef880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaeba80870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8316b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeba7fad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaeba811a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaeba80870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff832e9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaeba81ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaeba811a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaeba82400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff832ea900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaeba81ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaeba82590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaeba82400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff832ef880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaeba82720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaeba82590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   195.88 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.79 ms
whisper_print_timings:   sample time =    20.83 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4603.30 ms /     1 runs ( 4603.30 ms per run)
whisper_print_timings:   decode time =   180.47 ms /    27 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5065.60 ms
```
### mpt
