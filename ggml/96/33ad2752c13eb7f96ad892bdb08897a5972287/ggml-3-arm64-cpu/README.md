...
- status:  SUCCESS ✅
- runtime: 3:42.26
- date:    Fri Sep  8 12:04:36 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.80 sec
      Start  2: test-opt
...
main:     load time =   234.03 ms
main:   sample time =    17.42 ms
main:  predict time =   810.95 ms / 12.67 ms per token
main:    total time =  1085.35 ms
...
main:     load time =   171.48 ms
main:   sample time =    17.52 ms
main:  predict time =   874.03 ms / 12.49 ms per token
main:    total time =  1066.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5c5a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5adb160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac1acdac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5c59fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5c5f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac1ace850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5adb160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac1acdac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac1acf170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac1ace850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5c59fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac1acfa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac1acf170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac1ad03b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5c5a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac1acfa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac1ad0530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac1ad03b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5c5f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac1ad06b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac1ad0530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12393.94 ms
main:    sample time =   629.70 ms / 9.84 ms per token
main:      eval time = 43728.55 ms / 624.69 ms per token
main:     total time = 59128.91 ms
...
main:      load time =  4350.37 ms
main:    sample time =   621.60 ms / 9.71 ms per token
main:      eval time = 17361.30 ms / 248.02 ms per token
main:     total time = 23293.44 ms
