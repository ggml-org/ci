...
- status:  SUCCESS ✅
- runtime: 5:05.10
- date:    Fri Sep  8 12:06:06 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    3.76 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.77 sec
...
main:     load time =  1196.29 ms
main:   sample time =    34.62 ms
main:  predict time =   565.22 ms / 8.83 ms per token
main:    total time =  1816.05 ms
...
main:     load time =   203.44 ms
main:   sample time =    34.71 ms
main:  predict time =   595.79 ms / 8.51 ms per token
main:    total time =   838.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f076c7ac8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f076c62d160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cff7fabac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f076c7abfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f076c7b1840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cff7fac850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f076c62d160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cff7fabac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cff7fad170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cff7fac850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f076c7abfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cff7fada90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cff7fad170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cff7fae3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f076c7ac8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cff7fada90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cff7fae530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cff7fae3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f076c7b1840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55cff7fae6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cff7fae530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7236.66 ms
main:    sample time =   586.23 ms / 9.16 ms per token
main:      eval time = 25726.20 ms / 367.52 ms per token
main:     total time = 34462.59 ms
...
main:      load time =  1737.16 ms
main:    sample time =   591.54 ms / 9.24 ms per token
main:      eval time = 12321.49 ms / 176.02 ms per token
main:     total time = 15293.10 ms
