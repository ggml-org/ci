...
- status:  SUCCESS ✅
- runtime: 2:50.28
- date:    Fri Dec 29 13:10:27 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.57 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.24 sec
      Start  9: test3
...
main:     load time =   130.16 ms
main:   sample time =    23.46 ms
main:  predict time =   603.74 ms / 9.43 ms per token
...
main:  predict time =   635.91 ms / 9.08 ms per token
main:    total time =   789.69 ms
...
main:     n_decoded =      504
main:     load time =   107.58 ms
main:   sample time =   178.01 ms
main:  predict time =  2363.01 ms
main:    total time =  2693.96 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f519ff23990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f519fda41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f94ce65b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f519ff23030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f519ff28940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f94ce66960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f519fda41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f94ce65b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f94ce672c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f94ce66960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f519ff23030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f94ce67c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f94ce672c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f94ce68580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f519ff23990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f94ce67c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f94ce68740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f94ce68580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f519ff28940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f94ce68900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f94ce68740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.87 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.78 ms
whisper_print_timings:   sample time =    72.80 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1992.92 ms /     1 runs ( 1992.92 ms per run)
whisper_print_timings:   decode time =    12.61 ms /     2 runs (    6.30 ms per run)
whisper_print_timings:   batchd time =   325.30 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2507.56 ms
