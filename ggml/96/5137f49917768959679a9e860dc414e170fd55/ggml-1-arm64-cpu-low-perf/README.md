...
- status:  SUCCESS ✅
- runtime: 3:36.98
- date:    Fri Dec 29 01:13:16 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/965137f49917768959679a9e860dc414e170fd55
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.73 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.69 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   43.36 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.10 sec
...
main:     load time =   198.06 ms
main:   sample time =    17.84 ms
main:  predict time =   841.05 ms / 13.14 ms per token
main:    total time =  1078.94 ms
...
main:  predict time =   911.27 ms / 13.02 ms per token
main:    total time =  1123.97 ms
...
main:   sample time =   132.37 ms
main:  predict time =  6115.52 ms
main:    total time =  6516.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbc32a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbc1ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0a29eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbc32a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbc32f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0a29f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbc1ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0a29eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0a2a02c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0a29f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbc32a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0a2a0c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0a2a02c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0a2a1580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbc32a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0a2a0c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0a2a1740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0a2a1580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbc32f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0a2a1900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0a2a1740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.22 ms
whisper_print_timings:   sample time =    68.09 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4798.67 ms /     1 runs ( 4798.67 ms per run)
whisper_print_timings:   decode time =    15.63 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   712.59 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5726.59 ms
...
main:     load time =    97.84 ms
main:    total time = 40415.65 ms
embd_img
