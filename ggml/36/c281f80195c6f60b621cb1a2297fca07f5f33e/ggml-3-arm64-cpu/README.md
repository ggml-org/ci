...
- status:  SUCCESS ✅
- runtime: 3:06.71
- date:    Wed Mar 27 09:29:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.05 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   17.38 sec
...
main:  predict time =   895.24 ms / 13.99 ms per token
main:    total time =  1089.02 ms
...
main:  predict time =   974.74 ms / 13.92 ms per token
main:    total time =  1145.91 ms
...
main:     load time =   177.58 ms
main:   sample time =    17.12 ms
main:  predict time =   997.90 ms / 14.26 ms per token
main:    total time =  1195.98 ms
...
main:  predict time =  6421.86 ms
main:    total time =  6783.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8df0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8dd8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaaed2fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8df0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8df0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaaed30ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8dd8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaaed2fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaaed31410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaaed30ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8df0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaaed31d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaaed31410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaaed326d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8df0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaaed31d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaaed32890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaaed326d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8df0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaaed32a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaaed32890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.51 ms
whisper_print_timings:   sample time =    65.72 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4687.08 ms /     1 runs ( 4687.08 ms per run)
whisper_print_timings:   decode time =    15.35 ms /     2 runs (    7.68 ms per run)
whisper_print_timings:   batchd time =   708.03 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5599.47 ms
...
main:     load time =    90.91 ms
main:    total time = 39739.46 ms
embd_img
