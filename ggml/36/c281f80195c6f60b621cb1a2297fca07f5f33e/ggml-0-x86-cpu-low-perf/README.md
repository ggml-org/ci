...
- status:  SUCCESS ✅
- runtime: 3:30.17
- date:    Wed Mar 27 09:29:59 UTC 2024
...
Total Test time (real) =  75.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.87 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   15.93 sec
      Start  3: test-quantize-perf
...
main:  predict time =   761.52 ms / 11.90 ms per token
main:    total time =   909.10 ms
...
main:  predict time =   791.22 ms / 11.30 ms per token
main:    total time =   929.00 ms
...
main:     load time =   134.49 ms
main:   sample time =    23.98 ms
main:  predict time =   802.41 ms / 11.46 ms per token
main:    total time =   963.91 ms
...
main:     n_decoded =      504
main:     load time =   115.07 ms
main:   sample time =   175.78 ms
main:  predict time =  3150.61 ms
main:    total time =  3490.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2b1b679990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2b1b4fa1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a64c473ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2b1b679030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2b1b67e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a64c474ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2b1b4fa1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a64c473ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a64c475410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a64c474ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2b1b679030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a64c475d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a64c475410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a64c4766d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2b1b679990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a64c475d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a64c476890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a64c4766d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2b1b67e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a64c476a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a64c476890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    80.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.81 ms
whisper_print_timings:   sample time =    73.82 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2086.29 ms /     1 runs ( 2086.29 ms per run)
whisper_print_timings:   decode time =    16.48 ms /     2 runs (    8.24 ms per run)
whisper_print_timings:   batchd time =   338.36 ms /   125 runs (    2.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2623.13 ms
...
main:     load time =    79.14 ms
main:    total time = 19578.59 ms
embd_img
