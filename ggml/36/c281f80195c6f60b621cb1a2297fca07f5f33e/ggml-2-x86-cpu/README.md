...
- status:  SUCCESS ✅
- runtime: 2:08.54
- date:    Wed Mar 27 09:28:43 UTC 2024
...
main:  predict time =   485.30 ms / 7.58 ms per token
main:    total time =   628.23 ms
...
main:  predict time =   508.16 ms / 7.26 ms per token
main:    total time =   643.48 ms
...
main:  predict time =   520.71 ms / 7.44 ms per token
main:    total time =   671.88 ms
...
main:  predict time =  1839.71 ms
main:    total time =  2155.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5684c10990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5684a911a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c474ca7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5684c10030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5684c15940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c474ca8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5684a911a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c474ca7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c474ca9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c474ca8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5684c10030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c474ca9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c474ca9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c474caa6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5684c10990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c474ca9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c474caa890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c474caa6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5684c15940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c474caaa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c474caa890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =    54.68 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1191.15 ms /     1 runs ( 1191.15 ms per run)
whisper_print_timings:   decode time =    12.82 ms /     2 runs (    6.41 ms per run)
whisper_print_timings:   batchd time =   214.50 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1571.14 ms
...
main:     load time =    66.72 ms
main:    total time = 10730.34 ms
embd_img
