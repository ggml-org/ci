...
- status:  SUCCESS ✅
- runtime: 3:27.31
- date:    Wed May 15 08:56:17 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.78 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    2.62 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.07 sec
      Start  3: test-quantize-perf
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.19 sec
      Start  9: test3
...
main:  predict time =   693.80 ms / 10.84 ms per token
main:    total time =   831.63 ms
...
main:     load time =   101.23 ms
main:   sample time =    23.83 ms
main:  predict time =   737.60 ms / 10.54 ms per token
main:    total time =   864.73 ms
...
main:     load time =   121.96 ms
main:   sample time =    23.81 ms
main:  predict time =   743.47 ms / 10.62 ms per token
main:    total time =   892.24 ms
...
main:     n_decoded =      504
main:     load time =    99.39 ms
main:   sample time =   178.05 ms
main:  predict time =  3109.11 ms
main:    total time =  3432.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb5c20fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb5c1f7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5f2b0607fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb5c20fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb5c20ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5f2b06080ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb5c1f7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5f2b0607fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5f2b06081410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5f2b06080ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb5c20fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5f2b06081d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5f2b06081410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5f2b060826d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb5c20fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5f2b06081d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5f2b06082890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5f2b060826d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb5c20ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5f2b06082a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5f2b06082890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.35 ms
whisper_print_timings:   sample time =    71.51 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2011.84 ms /     1 runs ( 2011.84 ms per run)
whisper_print_timings:   decode time =    14.01 ms /     2 runs (    7.00 ms per run)
whisper_print_timings:   batchd time =   329.65 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2534.67 ms
