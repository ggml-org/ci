...
- status:  SUCCESS ✅
- runtime: 3:08.92
- date:    Wed May 15 08:55:51 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.14 sec
...
main:  predict time =   907.29 ms / 14.18 ms per token
main:    total time =  1098.07 ms
...
main:  predict time =   988.99 ms / 14.13 ms per token
main:    total time =  1155.51 ms
...
main:     load time =   174.13 ms
main:   sample time =    17.60 ms
main:  predict time =  1045.66 ms / 14.94 ms per token
main:    total time =  1240.59 ms
...
main:   sample time =   127.72 ms
main:  predict time =  6461.33 ms
main:    total time =  6817.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf8fa998aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf8fa9972b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb5752fcb6ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf8fa998aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf8fa998af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb5752fcb7ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf8fa9972b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb5752fcb6ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb5752fcb8410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb5752fcb7ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf8fa998aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb5752fcb8d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb5752fcb8410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb5752fcb96d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf8fa998aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb5752fcb8d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb5752fcb9890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb5752fcb96d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf8fa998af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb5752fcb9a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb5752fcb9890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.13 ms
whisper_print_timings:   sample time =    66.63 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4662.69 ms /     1 runs ( 4662.69 ms per run)
whisper_print_timings:   decode time =    13.88 ms /     2 runs (    6.94 ms per run)
whisper_print_timings:   batchd time =   708.82 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5585.30 ms
...
main:     load time =    83.70 ms
main:    total time = 40034.38 ms
embd_img
