...
- status:  SUCCESS ✅
- runtime: 4:03.10
- date:    Wed May 15 08:56:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.15 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.48 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.28 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.00 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   20.56 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.94 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.52 sec
      Start  5: test-mul-mat2
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.30 sec
      Start  9: test3
...
main:     load time =   137.63 ms
main:   sample time =    16.93 ms
main:  predict time =   898.09 ms / 14.03 ms per token
main:    total time =  1074.14 ms
...
main:     load time =   138.39 ms
main:   sample time =    17.01 ms
main:  predict time =  1013.08 ms / 14.47 ms per token
main:    total time =  1171.07 ms
...
main:     load time =   165.43 ms
main:   sample time =    16.80 ms
main:  predict time =  1042.92 ms / 14.90 ms per token
main:    total time =  1228.32 ms
...
main:     n_decoded =      504
main:     load time =   137.66 ms
main:   sample time =   128.03 ms
main:  predict time =  6462.11 ms
main:    total time =  6809.60 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf30bd0d6a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf30bd0beb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb2bd196b7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf30bd0d6a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf30bd0d6f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb2bd196b8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf30bd0beb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb2bd196b7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb2bd196b9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb2bd196b8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf30bd0d6a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb2bd196b9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb2bd196b9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb2bd196ba6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf30bd0d6a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb2bd196b9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb2bd196ba890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb2bd196ba6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf30bd0d6f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb2bd196baa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb2bd196ba890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    97.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.76 ms
whisper_print_timings:   sample time =    65.73 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4643.14 ms /     1 runs ( 4643.14 ms per run)
...
whisper_print_timings:    total time =  5558.04 ms
...
main:     load time =    87.15 ms
main:    total time = 39911.64 ms
embd_img
