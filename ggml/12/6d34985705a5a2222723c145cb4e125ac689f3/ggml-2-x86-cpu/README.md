...
- status:  SUCCESS ✅
- runtime: 2:10.59
- date:    Wed May 15 08:54:50 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   16.07 sec
...
main:  predict time =   512.65 ms / 8.01 ms per token
main:    total time =   653.61 ms
...
main:     load time =   108.58 ms
main:   sample time =    23.86 ms
main:  predict time =   530.16 ms / 7.57 ms per token
main:    total time =   664.77 ms
...
main:     load time =   128.27 ms
main:   sample time =    23.90 ms
main:  predict time =   536.54 ms / 7.66 ms per token
main:    total time =   691.74 ms
...
main:  predict time =  1834.27 ms
main:    total time =  2151.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7876354fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78763537b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56e790887ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7876354fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7876354ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56e790888ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78763537b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56e790887ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56e790889410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56e790888ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7876354fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56e790889d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56e790889410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56e79088a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7876354fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56e790889d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56e79088a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56e79088a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7876354ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56e79088aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56e79088a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.96 ms
whisper_print_timings:   sample time =    57.45 ms /   131 runs (    0.44 ms per run)
whisper_print_timings:   encode time =  1157.88 ms /     1 runs ( 1157.88 ms per run)
whisper_print_timings:   decode time =    11.43 ms /     2 runs (    5.71 ms per run)
whisper_print_timings:   batchd time =   218.40 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1549.94 ms
...
main:     load time =    66.00 ms
main:    total time = 10694.67 ms
embd_img
