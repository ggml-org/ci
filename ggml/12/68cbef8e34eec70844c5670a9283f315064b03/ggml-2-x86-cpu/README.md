...
- status:  SUCCESS ✅
- runtime: 2:35.77
- date:    Mon Aug  7 11:25:47 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/1268cbef8e34eec70844c5670a9283f315064b03
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/12 Test  #1: test-grad0 .......................   Passed    2.56 sec
      Start  2: test-opt
...
main:     load time =   185.97 ms
main:   sample time =    23.82 ms
main:  predict time =   419.84 ms / 6.56 ms per token
main:    total time =   668.38 ms
...
main: mem per token =  2015032 bytes
main:     load time =   134.23 ms
main:   sample time =    23.86 ms
main:  predict time =   441.15 ms / 6.30 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcc359ff870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcc35880140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5556c97aeaa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcc359fef70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcc35a047c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5556c97af810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcc35880140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5556c97aeaa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5556c97b0110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5556c97af810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcc359fef70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5556c97b0a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5556c97b0110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5556c97b1310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcc359ff870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5556c97b0a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5556c97b1470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5556c97b1310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcc35a047c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5556c97b15d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5556c97b1470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5595.66 ms
main:    sample time =   464.63 ms / 7.26 ms per token
main:      eval time = 21749.80 ms / 310.71 ms per token
main:     total time = 28995.09 ms
...
main:      load time =  1240.19 ms
main:    sample time =   460.53 ms / 7.20 ms per token
main:      eval time =  8543.17 ms / 122.05 ms per token
main:     total time = 10656.35 ms
