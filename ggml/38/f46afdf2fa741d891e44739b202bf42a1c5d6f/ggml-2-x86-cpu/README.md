...
- status:  SUCCESS ✅
- runtime: 2:46.52
- date:    Thu Nov 30 18:06:04 UTC 2023
...
main:  predict time =   436.81 ms / 6.83 ms per token
main:    total time =   600.37 ms
...
main:  predict time =   451.48 ms / 6.45 ms per token
...
main:  predict time =  1452.75 ms
main:    total time =  1769.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fedd331d960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fedd319e190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cafede8b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fedd331d010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fedd3322900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cafede9940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fedd319e190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cafede8b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cafedea290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cafede9940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fedd331d010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cafedeabe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cafedea290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cafedeb530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fedd331d960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cafedeabe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cafedeb6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cafedeb530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fedd3322900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55cafedeb890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cafedeb6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.61 ms
whisper_print_timings:   sample time =    54.37 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1145.87 ms /     1 runs ( 1145.87 ms per run)
whisper_print_timings:   decode time =     9.42 ms /     2 runs (    4.71 ms per run)
whisper_print_timings:   batchd time =   203.85 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1510.70 ms
...
main:     load time =    67.06 ms
main:    total time = 10437.48 ms
embd_img
...
main:      load time =  4289.78 ms
main:    sample time =   470.16 ms / 7.35 ms per token
main:      eval time = 19157.70 ms / 273.68 ms per token
main:     total time = 24552.93 ms
...
main:      load time =  1191.41 ms
main:    sample time =   464.96 ms / 7.27 ms per token
main:      eval time =  8054.47 ms / 115.06 ms per token
main:     total time = 10083.70 ms
