...
- status:  FAILURE ❌ (8)
- runtime: 51.39
- date:    Thu Nov 30 20:03:33 EET 2023
...
Backend 2/2 (Metal)
  ...
  SILU(type=f32,ne=[128,10,10,10]): [1;32mOK[0m
  LEAKY: not supported
    Error: GET_ROWS: NMSE = 2.146090
  GET_ROWS(type=f32,n=10,m=5,r=3): [1;31mFAIL[0m
  GET_ROWS(type=f32,n=16,m=5,r=3): [1;32mOK[0m
    Error: GET_ROWS: NMSE = 2.000061
