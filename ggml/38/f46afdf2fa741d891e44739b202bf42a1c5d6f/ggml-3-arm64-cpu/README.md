...
- status:  SUCCESS ✅
- runtime: 4:29.24
- date:    Thu Nov 30 06:07:47 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    1.59 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  15.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.16 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    0.23 sec
...
main:     load time =   184.15 ms
main:   sample time =    17.46 ms
main:  predict time =   821.68 ms / 12.84 ms per token
main:    total time =  1044.93 ms
...
main:     load time =   177.76 ms
main:   sample time =    17.13 ms
main:  predict time =   879.26 ms / 12.56 ms per token
main:    total time =  1077.01 ms
...
main:   sample time =   128.68 ms
main:  predict time =  5844.38 ms
main:    total time =  6208.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7b7a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa79fb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9b14b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7b7a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7b7f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae9b15940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa79fb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9b14b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae9b16290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae9b15940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7b7a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae9b16be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae9b16290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae9b17530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7b7a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae9b16be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae9b176e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae9b17530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7b7f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae9b17890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae9b176e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    13.07 ms
whisper_print_timings:   sample time =    65.37 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4640.70 ms /     1 runs ( 4640.70 ms per run)
whisper_print_timings:   decode time =    15.24 ms /     2 runs (    7.62 ms per run)
whisper_print_timings:   batchd time =   713.30 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5565.24 ms
...
main:     load time =   102.64 ms
main:    total time = 39352.71 ms
embd_img
...
main:      load time =  5521.60 ms
main:    sample time =   532.75 ms / 8.32 ms per token
main:      eval time = 43722.44 ms / 624.61 ms per token
main:     total time = 52148.17 ms
...
main:      load time =  1604.84 ms
main:    sample time =   527.11 ms / 8.24 ms per token
main:      eval time = 17498.38 ms / 249.98 ms per token
main:     total time = 20601.30 ms
