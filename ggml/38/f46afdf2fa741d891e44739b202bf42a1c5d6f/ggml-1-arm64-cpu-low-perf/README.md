...
- status:  SUCCESS ✅
- runtime: 2:41.20
- date:    Thu Nov 30 06:05:49 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.98 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.68 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    0.26 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  17.65 sec
...
main:     load time =   187.72 ms
main:   sample time =    17.54 ms
main:  predict time =   830.26 ms / 12.97 ms per token
main:    total time =  1057.21 ms
...
main:     load time =   188.11 ms
main:   sample time =    17.09 ms
main:  predict time =   901.82 ms / 12.88 ms per token
main:    total time =  1109.70 ms
...
main:     n_decoded =      504
main:     load time =   159.61 ms
main:   sample time =   128.61 ms
main:  predict time =  6018.58 ms
main:    total time =  6387.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ac3a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9aabb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed7f4b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ac3a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ac3f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaed7f5940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9aabb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed7f4b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaed7f6290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaed7f5940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ac3a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaed7f6be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaed7f6290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaed7f7530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ac3a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaed7f6be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaed7f76e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaed7f7530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ac3f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaed7f7890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaed7f76e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.52 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.69 ms
whisper_print_timings:   sample time =    64.69 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4697.84 ms /     1 runs ( 4697.84 ms per run)
...
whisper_print_timings:    total time =  5620.89 ms
