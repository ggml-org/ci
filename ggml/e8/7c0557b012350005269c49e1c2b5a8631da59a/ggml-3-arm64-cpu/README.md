...
- status:  SUCCESS ✅
- runtime: 3:14.64
- date:    Tue May 14 16:20:45 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   32.91 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   19.75 sec
...
main:  predict time =   923.21 ms / 14.43 ms per token
main:    total time =  1115.46 ms
...
main:     load time =   152.36 ms
main:   sample time =    18.36 ms
main:  predict time =   999.59 ms / 14.28 ms per token
main:    total time =  1172.89 ms
...
main:     load time =   180.58 ms
main:   sample time =    18.45 ms
main:  predict time =  1041.59 ms / 14.88 ms per token
main:    total time =  1243.78 ms
...
main:     n_decoded =      504
main:     load time =   153.05 ms
main:   sample time =   128.12 ms
main:  predict time =  6457.58 ms
main:    total time =  6821.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe3f5a9cba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe3f5a9b3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbe5d5dfa3ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe3f5a9cba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe3f5a9cbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbe5d5dfa4ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe3f5a9b3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbe5d5dfa3ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbe5d5dfa5410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbe5d5dfa4ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe3f5a9cba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbe5d5dfa5d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbe5d5dfa5410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbe5d5dfa66d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe3f5a9cba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbe5d5dfa5d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbe5d5dfa6890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbe5d5dfa66d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe3f5a9cbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbe5d5dfa6a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbe5d5dfa6890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.03 ms
whisper_print_timings:   sample time =    66.31 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4675.40 ms /     1 runs ( 4675.40 ms per run)
...
whisper_print_timings:    total time =  5595.53 ms
