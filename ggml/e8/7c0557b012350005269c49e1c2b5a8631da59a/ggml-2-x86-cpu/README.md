...
- status:  SUCCESS ✅
- runtime: 2:11.17
- date:    Tue May 14 16:29:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   29.89 sec
...
main:  predict time =   504.12 ms / 7.88 ms per token
main:    total time =   646.77 ms
...
main:  predict time =   521.37 ms / 7.45 ms per token
main:    total time =   653.71 ms
...
main:  predict time =   532.50 ms / 7.61 ms per token
main:    total time =   685.59 ms
...
main:     n_decoded =      504
main:     load time =   106.79 ms
main:   sample time =   177.90 ms
main:  predict time =  1842.07 ms
main:    total time =  2160.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7e869d0fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7e869cf7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5c674f02ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7e869d0fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7e869d0ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5c674f02bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7e869cf7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5c674f02ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5c674f02c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5c674f02bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7e869d0fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5c674f02cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5c674f02c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5c674f02d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7e869d0fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5c674f02cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5c674f02d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5c674f02d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7e869d0ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5c674f02da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5c674f02d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    55.23 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.76 ms /     1 runs ( 1159.76 ms per run)
whisper_print_timings:   decode time =    12.36 ms /     2 runs (    6.18 ms per run)
whisper_print_timings:   batchd time =   218.87 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1540.84 ms
...
main:     load time =    64.77 ms
main:    total time = 10692.50 ms
embd_img
