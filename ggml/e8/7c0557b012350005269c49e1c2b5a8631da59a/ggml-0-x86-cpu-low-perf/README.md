...
- status:  SUCCESS ✅
- runtime: 3:28.82
- date:    Tue May 14 16:17:56 UTC 2024
...
main:  predict time =   695.60 ms / 10.87 ms per token
main:    total time =   834.46 ms
...
main:  predict time =   744.77 ms / 10.64 ms per token
main:    total time =   872.94 ms
...
main:     load time =   126.50 ms
main:   sample time =    23.89 ms
main:  predict time =   753.30 ms / 10.76 ms per token
main:    total time =   906.69 ms
...
main:  predict time =  3111.49 ms
main:    total time =  3435.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7e3fa6afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7e3fa697b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5cc2d094fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7e3fa6afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7e3fa6aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5cc2d0950ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7e3fa697b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5cc2d094fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5cc2d0951410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5cc2d0950ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7e3fa6afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5cc2d0951d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5cc2d0951410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5cc2d09526d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7e3fa6afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5cc2d0951d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5cc2d0952890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5cc2d09526d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7e3fa6aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5cc2d0952a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5cc2d0952890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.48 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.81 ms
whisper_print_timings:   sample time =    72.40 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2025.11 ms /     1 runs ( 2025.11 ms per run)
whisper_print_timings:   decode time =    16.01 ms /     2 runs (    8.01 ms per run)
whisper_print_timings:   batchd time =   333.79 ms /   125 runs (    2.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2546.56 ms
...
main:     load time =    71.27 ms
main:    total time = 19421.80 ms
embd_img
