...
- status:  SUCCESS ✅
- runtime: 3:23.71
- date:    Sun Jun 16 07:44:08 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.22 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.05 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    2.12 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   16.01 sec
      Start  3: test-quantize-perf
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.37 sec
      Start  9: test3
...
main:  predict time =   648.75 ms / 10.14 ms per token
main:    total time =   786.82 ms
...
main:  predict time =   671.22 ms / 9.59 ms per token
main:    total time =   798.23 ms
...
main:     load time =   122.09 ms
main:   sample time =    23.90 ms
main:  predict time =   678.35 ms / 9.69 ms per token
main:    total time =   827.41 ms
...
main:     n_decoded =      504
main:     load time =   100.01 ms
main:   sample time =   178.18 ms
main:  predict time =  2566.61 ms
main:    total time =  2890.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7c23696fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7c236957b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x61917250ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7c23696fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7c23696ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x61917250fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7c236957b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x61917250ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x619172510410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x61917250fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7c23696fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x619172510d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x619172510410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6191725116d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7c23696fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x619172510d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x619172511890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6191725116d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7c23696ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x619172511a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x619172511890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    70.74 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.29 ms
whisper_print_timings:   sample time =    72.09 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1997.31 ms /     1 runs ( 1997.31 ms per run)
whisper_print_timings:   decode time =    13.93 ms /     2 runs (    6.96 ms per run)
whisper_print_timings:   batchd time =   327.76 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2518.37 ms
