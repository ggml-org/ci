...
- status:  SUCCESS ✅
- runtime: 14:40.29
- date:    Sun Jun 16 07:55:34 UTC 2024
...
21/21 Test #21: test-backend-ops .................   Passed  185.62 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 266.48 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/22 Test  #8: test1 ............................   Passed    0.04 sec
      Start  9: test2
 9/22 Test  #9: test2 ............................   Passed   20.25 sec
      Start 10: test3
...
22/22 Test #22: test-backend-ops .................   Passed   45.94 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 104.65 sec
...
main:  predict time =   573.77 ms / 8.97 ms per token
main:    total time =   776.84 ms
...
main:  predict time =   593.27 ms / 8.48 ms per token
...
main:     load time =   185.19 ms
main:   sample time =    39.35 ms
main:  predict time =   654.12 ms / 9.34 ms per token
main:    total time =   884.15 ms
...
main:   sample time =   234.89 ms
main:  predict time =  2375.42 ms
main:    total time =  2809.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3b494fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3b4937b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5620c5d09840                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3b494fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3b494ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5620c5d0a610                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3b4937b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5620c5d09840                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5620c5d0af70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5620c5d0a610                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3b494fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5620c5d0b8d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5620c5d0af70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620c5d0c230                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3b494fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5620c5d0b8d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5620c5d0c3f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620c5d0c230                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3b494ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5620c5d0c5b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5620c5d0c3f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   524.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.15 ms
whisper_print_timings:   sample time =    66.36 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    48.74 ms /     1 runs (   48.74 ms per run)
whisper_print_timings:   decode time =    12.17 ms /     2 runs (    6.08 ms per run)
whisper_print_timings:   batchd time =    77.51 ms /   125 runs (    0.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   758.08 ms
...
main:     load time =   116.77 ms
main:    total time = 16563.13 ms
embd_img
