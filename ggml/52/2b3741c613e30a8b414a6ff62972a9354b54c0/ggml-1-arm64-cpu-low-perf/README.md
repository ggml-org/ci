...
- status:  SUCCESS ✅
- runtime: 2:34.27
- date:    Wed Nov  1 12:11:17 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/522b3741c613e30a8b414a6ff62972a9354b54c0
- author:  Andrei
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.41 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    0.54 sec
      Start 10: test-pool
...
Total Test time (real) =  23.56 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.80 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.70 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    0.58 sec
      Start 10: test-pool
...
Total Test time (real) =  16.42 sec
...
main:     load time =   188.08 ms
main:   sample time =    17.50 ms
main:  predict time =   824.30 ms / 12.88 ms per token
main:    total time =  1051.87 ms
...
main:     load time =   195.80 ms
main:   sample time =    17.50 ms
main:  predict time =   889.93 ms / 12.71 ms per token
main:    total time =  1106.21 ms
...
main:     n_decoded =      504
main:     load time =   166.61 ms
main:   sample time =   129.60 ms
main:  predict time =  6005.81 ms
main:    total time =  6383.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff90baa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff90a2b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4bc5b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff90ba9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff90baf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf4bc6900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff90a2b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4bc5b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf4bc7230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf4bc6900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff90ba9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf4bc7b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf4bc7230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf4bc8490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff90baa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf4bc7b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf4bc8620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf4bc8490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff90baf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf4bc87b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf4bc8620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.33 ms
whisper_print_timings:   sample time =    21.17 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4633.50 ms /     1 runs ( 4633.50 ms per run)
whisper_print_timings:   decode time =   188.04 ms /    27 runs (    6.96 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5023.96 ms
...
main:     load time =    91.49 ms
main:    total time = 40212.12 ms
embd_img
