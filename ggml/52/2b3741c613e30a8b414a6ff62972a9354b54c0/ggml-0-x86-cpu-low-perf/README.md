...
- status:  SUCCESS ✅
- runtime: 2:02.46
- date:    Wed Nov  1 12:10:46 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.51 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.97 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.28 sec
      Start  2: test-quantize-fns
...
main:     load time =   124.00 ms
main:   sample time =    23.80 ms
main:  predict time =   614.81 ms / 9.61 ms per token
main:    total time =   775.16 ms
...
main:     load time =   124.75 ms
main:   sample time =    23.79 ms
main:  predict time =   620.41 ms / 8.86 ms per token
main:    total time =   771.09 ms
...
main:   sample time =   177.68 ms
main:  predict time =  2499.65 ms
main:    total time =  2825.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3378ad9900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f337895a170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e1b047b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3378ad8fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3378ade880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560e1b048900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f337895a170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e1b047b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560e1b049230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560e1b048900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3378ad8fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560e1b049b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560e1b049230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560e1b04a490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3378ad9900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560e1b049b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560e1b04a620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560e1b04a490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3378ade880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560e1b04a7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560e1b04a620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    81.48 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.26 ms
whisper_print_timings:   sample time =    16.30 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1975.14 ms /     1 runs ( 1975.14 ms per run)
whisper_print_timings:   decode time =   135.02 ms /    27 runs (    5.00 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2265.41 ms
...
main:     load time =    67.27 ms
main:    total time = 18740.45 ms
embd_img
