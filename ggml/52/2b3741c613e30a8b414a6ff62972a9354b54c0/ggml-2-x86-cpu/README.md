...
- status:  SUCCESS ✅
- runtime: 3:11.34
- date:    Wed Nov  1 12:17:25 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.35 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.24 sec
      Start  2: test-opt
...
main:  predict time =   467.85 ms / 7.31 ms per token
main:    total time =   692.43 ms
...
main:     load time =   124.44 ms
main:   sample time =    23.79 ms
main:  predict time =   443.14 ms / 6.33 ms per token
main:    total time =   593.37 ms
...
main:  predict time =  1459.89 ms
main:    total time =  1771.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbaec59a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbaec41b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563a20c0b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbaec599fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbaec59f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5563a20c1900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbaec41b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563a20c0b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5563a20c2230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5563a20c1900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbaec599fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5563a20c2b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5563a20c2230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5563a20c3490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbaec59a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5563a20c2b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5563a20c3620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5563a20c3490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbaec59f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5563a20c37b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5563a20c3620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   135.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.72 ms
whisper_print_timings:   sample time =    16.44 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1132.44 ms /     1 runs ( 1132.44 ms per run)
whisper_print_timings:   decode time =    93.24 ms /    27 runs (    3.45 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1425.99 ms
...
main:      load time = 12057.15 ms
main:    sample time =   470.12 ms / 7.35 ms per token
main:      eval time = 20220.26 ms / 288.86 ms per token
main:     total time = 33413.45 ms
...
main:      load time =  4399.13 ms
main:    sample time =   464.86 ms / 7.26 ms per token
main:      eval time =  8065.11 ms / 115.22 ms per token
main:     total time = 13354.12 ms
