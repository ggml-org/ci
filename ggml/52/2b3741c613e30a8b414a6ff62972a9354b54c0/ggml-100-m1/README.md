...
- status:  SUCCESS ✅
- runtime: 123.82
- date:    Wed Nov  1 14:09:45 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 4/15 Test  #4: test-mul-mat0 ....................   Passed    0.42 sec
      Start  5: test-blas0
 ...
 7/15 Test  #7: test0 ............................   Passed    0.19 sec
      Start  8: test1
 8/15 Test  #8: test1 ............................   Passed    0.20 sec
      Start  9: test2
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 5/16 Test  #5: test-mul-mat0 ....................   Passed    0.45 sec
      Start  6: test-blas0
...
main:     load time =   161.08 ms
main:   sample time =     8.96 ms
main:  predict time =   301.58 ms / 4.71 ms per token
main:    total time =   474.69 ms
...
main:     load time =    96.93 ms
main:   sample time =     8.65 ms
main:  predict time =   311.23 ms / 4.45 ms per token
main:    total time =   417.65 ms
...
main:   sample time =    65.93 ms
main:  predict time =   761.31 ms
main:    total time =   962.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1481878f0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x148008160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1380181f0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x148186fc0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x14818c870                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x138018f90                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x148008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1380181f0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x1380198c0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x138018f90                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x148186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13801a1f0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x1380198c0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13801ab20                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1481878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13801a1f0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13801acb0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13801ab20                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14818c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13801ae40                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13801acb0                           node_4
...
whisper_print_timings:     load time =   123.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.42 ms
whisper_print_timings:   sample time =    11.57 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   616.97 ms /     1 runs (  616.97 ms per run)
whisper_print_timings:   decode time =    62.75 ms /    27 runs (    2.32 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   834.02 ms
...
main:     load time =    72.19 ms
main:    total time =  5362.22 ms
embd_img
