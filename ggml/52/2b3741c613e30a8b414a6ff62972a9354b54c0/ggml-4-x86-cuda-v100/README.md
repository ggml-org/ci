...
- status:  SUCCESS ✅
- runtime: 5:32.31
- date:    Wed Nov  1 14:52:30 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    7.64 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.09 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.15 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.25 sec
      Start 10: test3
10/15 Test #10: test3 ............................   Passed    0.50 sec
      Start 11: test-pool
...
main:     load time =   538.13 ms
main:   sample time =    35.66 ms
main:  predict time =   587.11 ms / 9.17 ms per token
main:    total time =  1184.52 ms
...
main:     load time =   194.29 ms
main:   sample time =    35.87 ms
main:  predict time =   623.07 ms / 8.90 ms per token
main:    total time =   857.01 ms
...
main:     n_decoded =      504
main:     load time =   156.37 ms
main:   sample time =   237.03 ms
main:  predict time =  2235.76 ms
main:    total time =  2673.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43552fa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f435517b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ad1a3e2b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43552f9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43552ff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ad1a3e3900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f435517b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ad1a3e2b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ad1a3e4230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ad1a3e3900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43552f9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ad1a3e4b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ad1a3e4230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ad1a3e5490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43552fa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ad1a3e4b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ad1a3e5620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ad1a3e5490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43552ff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55ad1a3e57b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ad1a3e5620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   740.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.34 ms
whisper_print_timings:   sample time =    21.08 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  1877.16 ms /     1 runs ( 1877.16 ms per run)
whisper_print_timings:   decode time =   144.22 ms /    27 runs (    5.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2861.59 ms
...
main:     load time =   113.23 ms
main:    total time = 16769.01 ms
embd_img
...
main:      load time =  7404.11 ms
main:    sample time =   601.44 ms / 9.40 ms per token
main:      eval time = 25702.80 ms / 367.18 ms per token
main:     total time = 34663.91 ms
...
main:      load time =  1853.65 ms
main:    sample time =   600.19 ms / 9.38 ms per token
main:      eval time = 12814.91 ms / 183.07 ms per token
main:     total time = 15906.90 ms
