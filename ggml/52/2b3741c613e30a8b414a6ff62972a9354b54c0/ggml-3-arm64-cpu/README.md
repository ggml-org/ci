...
- status:  SUCCESS ✅
- runtime: 4:50.50
- date:    Wed Nov  1 12:15:58 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.28 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.55 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.17 sec
      Start  2: test-opt
...
main:     load time =   185.51 ms
main:   sample time =    16.94 ms
main:  predict time =   806.47 ms / 12.60 ms per token
main:    total time =  1031.01 ms
...
main:     load time =   175.36 ms
main:   sample time =    16.70 ms
main:  predict time =   875.70 ms / 12.51 ms per token
main:    total time =  1070.71 ms
...
main:     n_decoded =      504
main:     load time =   147.50 ms
main:   sample time =   128.29 ms
main:  predict time =  5857.55 ms
main:    total time =  6213.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9a8a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa990b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed4d1b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9a89fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9a8f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaed4d2900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa990b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed4d1b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaed4d3230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaed4d2900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9a89fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaed4d3b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaed4d3230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaed4d4490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9a8a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaed4d3b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaed4d4620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaed4d4490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9a8f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaed4d47b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaed4d4620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   212.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.76 ms
whisper_print_timings:   sample time =    20.85 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4602.07 ms /     1 runs ( 4602.07 ms per run)
whisper_print_timings:   decode time =   180.22 ms /    27 runs (    6.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5075.94 ms
...
main:     load time =    80.44 ms
main:    total time = 39321.19 ms
embd_img
...
main:      load time = 12811.98 ms
main:    sample time =   530.99 ms / 8.30 ms per token
main:      eval time = 43528.38 ms / 621.83 ms per token
main:     total time = 59242.50 ms
...
main:      load time =  4362.61 ms
main:    sample time =   524.64 ms / 8.20 ms per token
main:      eval time = 17577.92 ms / 251.11 ms per token
main:     total time = 23424.76 ms
