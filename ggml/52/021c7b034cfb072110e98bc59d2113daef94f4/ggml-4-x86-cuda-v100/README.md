...
- status:  SUCCESS ✅
- runtime: 8:49.72
- date:    Thu Feb 22 22:01:09 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    6.10 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    1.40 sec
 ...
 8/20 Test  #8: test2 ............................   Passed   20.76 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.98 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.51 sec
...
20/20 Test #20: test-backend-ops .................   Passed  150.28 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 201.10 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    3.36 sec
...
21/21 Test #21: test-backend-ops .................   Passed   39.30 sec
...
main:     load time =   530.17 ms
main:   sample time =    34.08 ms
main:  predict time =   684.49 ms / 10.70 ms per token
main:    total time =  1271.35 ms
...
main:     load time =   545.19 ms
main:   sample time =    35.55 ms
main:  predict time =   765.51 ms / 10.94 ms per token
main:    total time =  1349.91 ms
...
main:     load time =   603.43 ms
main:   sample time =    40.45 ms
main:  predict time =   831.13 ms / 11.87 ms per token
main:    total time =  1480.38 ms
...
main:   sample time =   244.87 ms
main:  predict time =  3235.95 ms
main:    total time =  4117.22 ms
...
main: loaded model in   393.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2cf59b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2cf58371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f4b09f4540                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2cf59b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2cf59bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f4b09f5310                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2cf58371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f4b09f4540                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f4b09f5c70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f4b09f5310                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2cf59b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f4b09f65d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f4b09f5c70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f4b09f6f30                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2cf59b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f4b09f65d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f4b09f70f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f4b09f6f30                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2cf59bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f4b09f72b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f4b09f70f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   516.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.26 ms
whisper_print_timings:   sample time =    66.46 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.54 ms /     1 runs (   34.54 ms per run)
whisper_print_timings:   decode time =    21.07 ms /     2 runs (   10.54 ms per run)
whisper_print_timings:   batchd time =    87.55 ms /   125 runs (    0.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   756.71 ms
...
main:     load time =   479.89 ms
main:    total time =  7987.16 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.715000 sec.)
