...
- status:  SUCCESS ✅
- runtime: 4:10.02
- date:    Thu Feb 22 21:53:17 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/52021c7b034cfb072110e98bc59d2113daef94f4
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.00 sec
...
20/20 Test #20: test-backend-ops .................   Passed   98.40 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 116.23 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    2.41 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.60 sec
...
main:     load time =   145.12 ms
main:   sample time =    16.81 ms
main:  predict time =   889.57 ms / 13.90 ms per token
main:    total time =  1073.03 ms
...
main:  predict time =   968.71 ms / 13.84 ms per token
main:    total time =  1139.07 ms
...
main:     load time =   172.82 ms
main:   sample time =    17.22 ms
main:  predict time =  1011.96 ms / 14.46 ms per token
main:    total time =  1205.04 ms
...
main:     n_decoded =      504
main:     load time =   150.91 ms
main:   sample time =   126.93 ms
main:  predict time =  6446.25 ms
main:    total time =  6806.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0e0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0c8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec2b0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0e0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0e0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec2b1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0c8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec2b0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec2b2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec2b1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0e0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec2b2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec2b2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec2b36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0e0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec2b2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec2b3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec2b36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0e0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaec2b3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec2b3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.90 ms
whisper_print_timings:   sample time =    65.60 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4691.18 ms /     1 runs ( 4691.18 ms per run)
whisper_print_timings:   decode time =    14.33 ms /     2 runs (    7.17 ms per run)
whisper_print_timings:   batchd time =   709.99 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5604.29 ms
