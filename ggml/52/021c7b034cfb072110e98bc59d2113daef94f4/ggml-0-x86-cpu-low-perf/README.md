...
- status:  SUCCESS ✅
- runtime: 4:14.06
- date:    Thu Feb 22 21:35:21 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    4.30 sec
...
20/20 Test #20: test-backend-ops .................   Passed   80.91 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 122.83 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.26 sec
...
main:  predict time =   697.67 ms / 10.90 ms per token
main:    total time =   839.66 ms
...
main:     load time =   108.60 ms
main:   sample time =    23.55 ms
main:  predict time =   748.82 ms / 10.70 ms per token
main:    total time =   883.39 ms
...
main:  predict time =   753.91 ms / 10.77 ms per token
main:    total time =   909.73 ms
...
main:  predict time =  3110.60 ms
main:    total time =  3441.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe6e0a43990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe6e08c41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e990a6ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe6e0a43030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe6e0a48940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560e990a7ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe6e08c41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e990a6ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560e990a8410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560e990a7ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe6e0a43030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560e990a8d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560e990a8410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560e990a96d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe6e0a43990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560e990a8d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560e990a9890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560e990a96d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe6e0a48940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560e990a9a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560e990a9890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.36 ms
whisper_print_timings:   sample time =    72.66 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2046.76 ms /     1 runs ( 2046.76 ms per run)
whisper_print_timings:   decode time =    16.17 ms /     2 runs (    8.08 ms per run)
whisper_print_timings:   batchd time =   330.59 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2569.81 ms
...
main:     load time =    68.21 ms
main:    total time = 19359.93 ms
embd_img
