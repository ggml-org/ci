...
- status:  SUCCESS ✅
- runtime: 5:12.89
- date:    Thu Feb 22 09:36:00 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.65 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.93 sec
...
20/20 Test #20: test-backend-ops .................   Passed  104.16 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 147.32 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.20 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.86 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   21.19 sec
...
main:     load time =   158.48 ms
main:   sample time =    17.44 ms
main:  predict time =   934.40 ms / 14.60 ms per token
main:    total time =  1132.02 ms
...
main:     load time =   163.38 ms
main:   sample time =    17.81 ms
main:  predict time =  1042.65 ms / 14.90 ms per token
main:    total time =  1227.21 ms
...
main:  predict time =  6646.86 ms
main:    total time =  7018.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb009a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaff1b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf410dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb009a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb009f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf410eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaff1b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf410dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf410f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf410eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb009a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf410fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf410f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf41106d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb009a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf410fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf4110890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf41106d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb009f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf4110a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf4110890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.94 ms
whisper_print_timings:   sample time =    67.01 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4814.51 ms /     1 runs ( 4814.51 ms per run)
whisper_print_timings:   decode time =    14.82 ms /     2 runs (    7.41 ms per run)
whisper_print_timings:   batchd time =   716.58 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5743.04 ms
