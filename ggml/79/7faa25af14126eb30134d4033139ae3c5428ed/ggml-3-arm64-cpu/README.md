...
- status:  SUCCESS ✅
- runtime: 2:22.47
- date:    Fri Aug  9 07:06:00 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/23 Test  #6: test-mul-mat2 ....................   Passed    1.88 sec
      Start  7: test0
...
main:     load time =   164.09 ms
main:   sample time =    19.58 ms
main:  predict time =   869.80 ms / 13.59 ms per token
main:    total time =  1075.08 ms
...
main:     load time =   163.99 ms
main:   sample time =    19.83 ms
main:  predict time =   932.63 ms / 13.32 ms per token
...
main:   sample time =    19.95 ms
main:  predict time =   950.04 ms / 13.57 ms per token
main:    total time =  1169.19 ms
...
main:     n_decoded =      504
main:     load time =   164.33 ms
main:   sample time =   129.38 ms
main:  predict time =  6261.63 ms
main:    total time =  6639.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xea7e514ea930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xea7e5136b180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb0e3fc64cee0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xea7e514e9ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xea7e514ef8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb0e3fc64dc90                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xea7e5136b180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb0e3fc64cee0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb0e3fc64e5d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb0e3fc64dc90                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xea7e514e9ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb0e3fc64ef10                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb0e3fc64e5d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb0e3fc64f850                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xea7e514ea930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb0e3fc64ef10                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb0e3fc64f9f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb0e3fc64f850                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xea7e514ef8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb0e3fc64fb90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb0e3fc64f9f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    95.83 ms
main:    total time = 40479.27 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.305000 sec.)
