...
- status:  SUCCESS ✅
- runtime: 2:36.94
- date:    Tue Sep  5 18:14:00 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.19 sec
...
main:  predict time =   433.07 ms / 6.77 ms per token
main:    total time =   658.08 ms
...
main:     load time =   134.28 ms
main:   sample time =    23.75 ms
main:  predict time =   446.98 ms / 6.39 ms per token
main:    total time =   608.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5f5eb998d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5f5ea1a160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5647e9657ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5f5eb98fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5f5eb9e840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5647e9658850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5f5ea1a160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5647e9657ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5647e9659170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5647e9658850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5f5eb98fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5647e9659a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5647e9659170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5647e965a3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5f5eb998d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5647e9659a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5647e965a530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5647e965a3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5f5eb9e840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5647e965a6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5647e965a530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 13655.24 ms
main:    sample time =   470.03 ms / 7.34 ms per token
main:      eval time = 19945.99 ms / 284.94 ms per token
main:     total time = 34725.61 ms
...
main:      load time =  4391.20 ms
main:    sample time =   466.19 ms / 7.28 ms per token
main:      eval time =  8059.24 ms / 115.13 ms per token
main:     total time = 13288.38 ms
