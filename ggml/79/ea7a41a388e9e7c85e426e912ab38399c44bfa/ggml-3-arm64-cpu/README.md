...
- status:  SUCCESS ✅
- runtime: 3:35.45
- date:    Tue Sep  5 18:14:48 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.98 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.96 sec
      Start  2: test-opt
...
main:     load time =   256.49 ms
main:   sample time =    17.45 ms
main:  predict time =   812.83 ms / 12.70 ms per token
main:    total time =  1109.67 ms
...
main:     load time =   178.51 ms
main:   sample time =    17.46 ms
main:  predict time =   876.88 ms / 12.53 ms per token
main:    total time =  1076.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb7a8a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb790b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6923ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7a89fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb7a8f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6924850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb790b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6923ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6925170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6924850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7a89fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6925a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6925170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad69263b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb7a8a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6925a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6926530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad69263b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb7a8f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad69266b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6926530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11390.06 ms
main:    sample time =   621.49 ms / 9.71 ms per token
main:      eval time = 43703.77 ms / 624.34 ms per token
main:     total time = 58093.30 ms
...
main:      load time =  4352.74 ms
main:    sample time =   623.05 ms / 9.74 ms per token
main:      eval time = 17366.10 ms / 248.09 ms per token
main:     total time = 23298.42 ms
