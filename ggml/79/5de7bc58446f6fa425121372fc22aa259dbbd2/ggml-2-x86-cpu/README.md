...
- status:  SUCCESS ✅
- runtime: 2:09.99
- date:    Wed Mar 27 17:51:12 UTC 2024
...
main:  predict time =   496.55 ms / 7.76 ms per token
...
main:  predict time =   525.82 ms / 7.51 ms per token
main:    total time =   682.15 ms
...
main:   sample time =   175.48 ms
main:  predict time =  1817.24 ms
main:    total time =  2130.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe244958990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe2447d91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c7de723ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe244958030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe24495d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c7de724ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe2447d91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c7de723ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c7de725410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c7de724ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe244958030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c7de725d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c7de725410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c7de7266d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe244958990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c7de725d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c7de726890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c7de7266d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe24495d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c7de726a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c7de726890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.71 ms
whisper_print_timings:   sample time =    55.85 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1191.41 ms /     1 runs ( 1191.41 ms per run)
whisper_print_timings:   decode time =    12.01 ms /     2 runs (    6.00 ms per run)
whisper_print_timings:   batchd time =   213.12 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1567.98 ms
