...
- status:  SUCCESS ✅
- runtime: 4:07.08
- date:    Wed Mar 27 05:53:18 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.90 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   35.05 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   20.81 sec
      Start  9: test3
...
main:     load time =   163.25 ms
main:   sample time =    18.13 ms
main:  predict time =   919.73 ms / 14.37 ms per token
main:    total time =  1122.94 ms
...
main:  predict time =   997.26 ms / 14.25 ms per token
main:    total time =  1186.64 ms
...
main:  predict time =  1026.65 ms / 14.67 ms per token
main:    total time =  1242.45 ms
...
main:     n_decoded =      504
main:     load time =   166.41 ms
main:   sample time =   127.89 ms
main:  predict time =  6501.52 ms
main:    total time =  6878.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d63a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d4bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab0539ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d63a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d63f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab053aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d4bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab0539ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab053b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab053aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d63a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab053bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab053b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab053c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d63a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab053bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab053c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab053c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d63f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab053ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab053c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.54 ms
whisper_print_timings:   sample time =    66.28 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4744.26 ms /     1 runs ( 4744.26 ms per run)
whisper_print_timings:   decode time =    15.81 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   716.53 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5678.46 ms
...
main:     load time =    93.08 ms
main:    total time = 40039.03 ms
embd_img
