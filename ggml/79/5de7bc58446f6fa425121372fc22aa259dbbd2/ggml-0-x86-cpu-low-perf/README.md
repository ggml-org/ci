...
- status:  SUCCESS ✅
- runtime: 3:28.87
- date:    Wed Mar 27 17:52:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.54 sec
      Start  2: test-quantize-fns
...
main:  predict time =   725.57 ms / 11.34 ms per token
main:    total time =   868.29 ms
...
main:     load time =   106.39 ms
main:   sample time =    23.43 ms
main:  predict time =   732.32 ms / 10.46 ms per token
main:    total time =   864.32 ms
...
main:     load time =   125.99 ms
main:   sample time =    23.83 ms
main:  predict time =   743.48 ms / 10.62 ms per token
...
main:  predict time =  3099.44 ms
main:    total time =  3423.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f67321b5990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f67320361a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b09ad5ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f67321b5030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f67321ba940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b09ad6ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f67320361a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b09ad5ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b09ad7410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b09ad6ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f67321b5030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b09ad7d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b09ad7410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b09ad86d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f67321b5990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b09ad7d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b09ad8890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b09ad86d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f67321ba940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558b09ad8a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b09ad8890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.25 ms
whisper_print_timings:   sample time =    72.01 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2057.17 ms /     1 runs ( 2057.17 ms per run)
whisper_print_timings:   decode time =    15.72 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   329.55 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2576.29 ms
...
main:     load time =    72.25 ms
main:    total time = 19386.03 ms
embd_img
