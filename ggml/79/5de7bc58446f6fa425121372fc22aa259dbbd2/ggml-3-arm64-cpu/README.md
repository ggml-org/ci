...
- status:  SUCCESS ✅
- runtime: 3:13.01
- date:    Wed Mar 27 17:52:18 UTC 2024
...
main:  predict time =   893.42 ms / 13.96 ms per token
main:    total time =  1082.19 ms
...
main:  predict time =   979.67 ms / 14.00 ms per token
main:    total time =  1152.77 ms
...
main:  predict time =  1002.38 ms / 14.32 ms per token
main:    total time =  1200.03 ms
...
main:  predict time =  6431.32 ms
main:    total time =  6795.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8216a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81feb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacf93ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8216a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8216f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacf93fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81feb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacf93ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacf940410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacf93fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8216a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacf940d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacf940410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacf9416d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8216a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacf940d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacf941890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacf9416d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8216f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacf941a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacf941890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    64.92 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4691.35 ms /     1 runs ( 4691.35 ms per run)
whisper_print_timings:   decode time =    15.55 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   709.90 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5607.93 ms
...
main:     load time =    92.15 ms
main:    total time = 39757.30 ms
embd_img
