...
- status:  SUCCESS ✅
- runtime: 3:13.82
- date:    Wed Nov  1 17:05:14 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.26 sec
      Start  2: test-opt
...
main:  predict time =   442.91 ms / 6.92 ms per token
main:    total time =   669.43 ms
...
main:  predict time =   471.94 ms / 6.74 ms per token
main:    total time =   623.85 ms
...
main:  predict time =  1463.49 ms
main:    total time =  1777.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7692e7a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7692cfb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c98e676b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7692e79fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7692e7f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c98e677900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7692cfb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c98e676b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c98e678230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c98e677900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7692e79fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c98e678b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c98e678230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c98e679490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7692e7a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c98e678b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c98e679620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c98e679490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7692e7f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c98e6797b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c98e679620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   130.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.24 ms
whisper_print_timings:   sample time =    16.15 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1171.36 ms /     1 runs ( 1171.36 ms per run)
whisper_print_timings:   decode time =    90.96 ms /    27 runs (    3.37 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1456.54 ms
...
main:     load time =    60.68 ms
main:    total time = 10414.00 ms
embd_img
...
main:      load time = 11915.66 ms
main:    sample time =   470.77 ms / 7.36 ms per token
main:      eval time = 20310.97 ms / 290.16 ms per token
main:     total time = 33434.29 ms
...
main:      load time =  4407.82 ms
main:    sample time =   467.33 ms / 7.30 ms per token
main:      eval time =  8066.90 ms / 115.24 ms per token
main:     total time = 13326.08 ms
