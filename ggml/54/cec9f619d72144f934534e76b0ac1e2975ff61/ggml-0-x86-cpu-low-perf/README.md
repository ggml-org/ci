...
- status:  SUCCESS ✅
- runtime: 2:05.38
- date:    Wed Nov  1 17:04:11 UTC 2023
...
main:  predict time =   604.77 ms / 9.45 ms per token
main:    total time =   771.15 ms
...
main:  predict time =   629.15 ms / 8.99 ms per token
main:    total time =   783.46 ms
...
main:  predict time =  2376.85 ms
main:    total time =  2707.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbfdc11f900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbfdbfa0170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560f1540db60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbfdc11efd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbfdc124880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560f1540e900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbfdbfa0170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560f1540db60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560f1540f230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560f1540e900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbfdc11efd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560f1540fb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560f1540f230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560f15410490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbfdc11f900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560f1540fb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560f15410620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560f15410490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbfdc124880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560f154107b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560f15410620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    82.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.63 ms
whisper_print_timings:   sample time =    17.36 ms /    27 runs (    0.64 ms per run)
whisper_print_timings:   encode time =  1963.19 ms /     1 runs ( 1963.19 ms per run)
whisper_print_timings:   decode time =   128.56 ms /    27 runs (    4.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2248.41 ms
