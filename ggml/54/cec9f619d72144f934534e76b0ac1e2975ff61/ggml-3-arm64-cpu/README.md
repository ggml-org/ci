...
- status:  SUCCESS ✅
- runtime: 4:47.14
- date:    Wed Nov  1 05:06:38 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/54cec9f619d72144f934534e76b0ac1e2975ff61
- author:  Philpax
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.18 sec
      Start  2: test-opt
...
main:     load time =   289.81 ms
main:   sample time =    17.13 ms
main:  predict time =   810.65 ms / 12.67 ms per token
main:    total time =  1139.76 ms
...
main:     load time =   177.88 ms
main:   sample time =    16.95 ms
main:  predict time =   875.24 ms / 12.50 ms per token
main:    total time =  1072.82 ms
...
main:     n_decoded =      504
main:     load time =   141.90 ms
main:   sample time =   126.89 ms
main:  predict time =  5860.03 ms
main:    total time =  6209.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb90fa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8f7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4de9b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb90f9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb90ff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac4dea900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8f7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4de9b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac4deb230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac4dea900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb90f9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac4debb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac4deb230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac4dec490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb90fa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac4debb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac4dec620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac4dec490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb90ff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac4dec7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac4dec620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   219.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    20.87 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4608.79 ms /     1 runs ( 4608.79 ms per run)
whisper_print_timings:   decode time =   179.90 ms /    27 runs (    6.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5088.40 ms
...
main:     load time =    78.61 ms
main:    total time = 39332.27 ms
embd_img
...
main:      load time = 12492.69 ms
main:    sample time =   535.42 ms / 8.37 ms per token
main:      eval time = 43502.87 ms / 621.47 ms per token
main:     total time = 58904.08 ms
...
main:      load time =  4359.34 ms
main:    sample time =   526.06 ms / 8.22 ms per token
main:      eval time = 17412.01 ms / 248.74 ms per token
main:     total time = 23257.87 ms
