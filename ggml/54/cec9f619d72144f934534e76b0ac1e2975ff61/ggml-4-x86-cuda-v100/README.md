...
- status:  SUCCESS ✅
- runtime: 5:40.64
- date:    Wed Nov  1 17:07:32 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    5.99 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.13 sec
...
main:     load time =   191.50 ms
main:   sample time =    35.08 ms
main:  predict time =   581.99 ms / 9.09 ms per token
main:    total time =   827.72 ms
...
main:     load time =   196.49 ms
main:   sample time =    38.85 ms
main:  predict time =   642.68 ms / 9.18 ms per token
main:    total time =   882.01 ms
...
main:     n_decoded =      504
main:     load time =   157.76 ms
main:   sample time =   240.05 ms
main:  predict time =  2256.25 ms
main:    total time =  2701.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0340afa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f034097b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556748778b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0340af9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0340aff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556748779900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f034097b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556748778b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55674877a230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556748779900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0340af9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55674877ab60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55674877a230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55674877b490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0340afa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55674877ab60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55674877b620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55674877b490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0340aff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55674877b7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55674877b620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    18.96 ms
whisper_print_timings:   sample time =    22.33 ms /    27 runs (    0.83 ms per run)
whisper_print_timings:   encode time =  1877.31 ms /     1 runs ( 1877.31 ms per run)
whisper_print_timings:   decode time =   146.46 ms /    27 runs (    5.42 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2848.51 ms
...
main:     load time =    99.36 ms
main:    total time = 16627.30 ms
embd_img
...
main:      load time =  7349.97 ms
main:    sample time =   575.19 ms / 8.99 ms per token
main:      eval time = 25623.86 ms / 366.06 ms per token
main:     total time = 34473.99 ms
...
main:      load time =  1742.67 ms
main:    sample time =   583.98 ms / 9.12 ms per token
main:      eval time = 12559.89 ms / 179.43 ms per token
main:     total time = 15556.10 ms
