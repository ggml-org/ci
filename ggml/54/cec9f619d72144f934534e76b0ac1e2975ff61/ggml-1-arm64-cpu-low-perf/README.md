...
- status:  SUCCESS ✅
- runtime: 2:34.81
- date:    Wed Nov  1 05:04:25 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.37 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.61 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.03 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.59 sec
      Start  9: test3
...
main:     load time =   190.09 ms
main:   sample time =    17.78 ms
main:  predict time =   919.00 ms / 13.13 ms per token
main:    total time =  1129.82 ms
...
main:     n_decoded =      504
main:     load time =   166.07 ms
main:   sample time =   131.60 ms
main:  predict time =  6061.48 ms
main:    total time =  6440.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f05a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9eedb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8c1ab60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f059fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f05f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c1b900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9eedb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8c1ab60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c1c230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c1b900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f059fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c1cb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c1c230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8c1d490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f05a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c1cb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf8c1d620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8c1d490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f05f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf8c1d7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf8c1d620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    22.50 ms /    27 runs (    0.83 ms per run)
whisper_print_timings:   encode time =  4608.49 ms /     1 runs ( 4608.49 ms per run)
whisper_print_timings:   decode time =   214.38 ms /    27 runs (    7.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5027.39 ms
