...
- status:  SUCCESS ✅
- runtime: 4:18.57
- date:    Fri Jan 26 13:08:34 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  114.54 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 137.18 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.73 sec
...
main:     load time =   133.99 ms
main:   sample time =    23.51 ms
main:  predict time =   648.43 ms / 10.13 ms per token
...
main:  predict time =   687.01 ms / 9.81 ms per token
main:    total time =   843.75 ms
...
main:  predict time =  2502.10 ms
main:    total time =  2831.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7e07c4e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7e07acf1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5602ab5f1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7e07c4e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7e07c53940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5602ab5f2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7e07acf1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5602ab5f1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5602ab5f32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5602ab5f2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7e07c4e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5602ab5f3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5602ab5f32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5602ab5f4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7e07c4e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5602ab5f3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5602ab5f4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5602ab5f4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7e07c53940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5602ab5f4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5602ab5f4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    83.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.22 ms
whisper_print_timings:   sample time =    72.11 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1986.25 ms /     1 runs ( 1986.25 ms per run)
whisper_print_timings:   decode time =    12.64 ms /     2 runs (    6.32 ms per run)
whisper_print_timings:   batchd time =   322.19 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.06 ms
