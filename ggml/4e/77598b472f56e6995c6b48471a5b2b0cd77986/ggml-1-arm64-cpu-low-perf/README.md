...
- status:  SUCCESS ✅
- runtime: 5:33.03
- date:    Fri Jan 26 01:15:39 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.15 sec
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.69 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed  148.41 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 172.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.80 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.14 sec
...
main:     load time =   194.37 ms
main:   sample time =    17.85 ms
main:  predict time =  1018.71 ms / 15.92 ms per token
main:    total time =  1253.27 ms
...
main:     load time =   194.64 ms
main:   sample time =    17.91 ms
main:  predict time =   954.07 ms / 13.63 ms per token
...
main:     n_decoded =      504
main:     load time =   164.46 ms
main:   sample time =   129.61 ms
main:  predict time =  6210.38 ms
main:    total time =  6588.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb82ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb814b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab17768b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb82ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb82cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab17769960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb814b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab17768b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1776a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab17769960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb82ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1776ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1776a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1776b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb82ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1776ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1776b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1776b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb82cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab1776b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1776b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   118.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.71 ms
whisper_print_timings:   sample time =    67.31 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4741.44 ms /     1 runs ( 4741.44 ms per run)
whisper_print_timings:   decode time =    16.20 ms /     2 runs (    8.10 ms per run)
whisper_print_timings:   batchd time =   712.20 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5674.72 ms
...
main:     load time =    93.29 ms
main:    total time = 40595.23 ms
embd_img
