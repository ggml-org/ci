...
- status:  SUCCESS ✅
- runtime: 3:41.73
- date:    Wed Oct 11 07:38:24 PM UTC 2023
...
main:     load time =   177.92 ms
main:   sample time =    17.17 ms
main:  predict time =   801.08 ms / 12.52 ms per token
main:    total time =  1019.46 ms
...
main:  predict time =   869.50 ms / 12.42 ms per token
main:    total time =  1035.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb38ea900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb376b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7ba7ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb38e9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb38ef880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ba8870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb376b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7ba7ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ba91a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ba8870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb38e9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ba9ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ba91a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf7baa400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb38ea900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ba9ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf7baa590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf7baa400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb38ef880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf7baa720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf7baa590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   209.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.20 ms
whisper_print_timings:   sample time =    20.88 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4602.66 ms /     1 runs ( 4602.66 ms per run)
whisper_print_timings:   decode time =   182.21 ms /    27 runs (    6.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5083.37 ms
```
### mpt
...
main:      load time =  5543.06 ms
main:    sample time =   521.80 ms / 8.15 ms per token
main:      eval time = 43601.17 ms / 622.87 ms per token
main:     total time = 52037.28 ms
...
main:      load time =  1500.60 ms
main:    sample time =   517.73 ms / 8.09 ms per token
main:      eval time = 17413.72 ms / 248.77 ms per token
main:     total time = 20395.80 ms
