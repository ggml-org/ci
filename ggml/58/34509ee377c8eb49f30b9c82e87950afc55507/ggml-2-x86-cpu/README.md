...
- status:  SUCCESS ✅
- runtime: 2:32.13
- date:    Wed Oct 11 19:37:11 UTC 2023
...
main:     load time =   112.05 ms
main:   sample time =    24.01 ms
main:  predict time =   470.89 ms / 7.36 ms per token
main:    total time =   620.58 ms
...
main:  predict time =   483.85 ms / 6.91 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7feb87fe7900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7feb87e68170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a0d278ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7feb87fe6fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7feb87fec880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a0d278f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7feb87e68170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a0d278ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a0d27901a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a0d278f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7feb87fe6fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a0d2790ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a0d27901a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a0d2791400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7feb87fe7900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a0d2790ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a0d2791590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a0d2791400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7feb87fec880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a0d2791720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a0d2791590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    91.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.93 ms
whisper_print_timings:   sample time =    16.61 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  1218.10 ms /     1 runs ( 1218.10 ms per run)
whisper_print_timings:   decode time =   107.63 ms /    27 runs (    3.99 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1493.02 ms
```
### mpt
...
main:      load time =  4754.81 ms
main:    sample time =   464.02 ms / 7.25 ms per token
main:      eval time = 21087.54 ms / 301.25 ms per token
main:     total time = 26970.13 ms
...
main:      load time =  1318.73 ms
main:    sample time =   460.97 ms / 7.20 ms per token
main:      eval time =  8668.49 ms / 123.84 ms per token
main:     total time = 10840.92 ms
