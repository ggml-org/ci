...
- status:  SUCCESS ✅
- runtime: 4:37.52
- date:    Wed Oct 11 19:39:16 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.92 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.06 sec
      Start  3: test-quantize-fns
 3/15 Test  #3: test-quantize-fns ................   Passed    0.00 sec
      Start  4: test-quantize-perf
 4/15 Test  #4: test-quantize-perf ...............   Passed    0.01 sec
      Start  5: test-mul-mat0
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.66 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.18 sec
      Start 10: test3
...
main:     load time =   161.50 ms
main:   sample time =    35.98 ms
main:  predict time =   578.87 ms / 9.04 ms per token
...
main:     load time =   153.69 ms
main:   sample time =    35.46 ms
main:  predict time =   575.45 ms / 8.22 ms per token
main:    total time =   769.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3915403900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3915284170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56464a64dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3915402fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3915408880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56464a64e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3915284170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56464a64dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56464a64f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56464a64e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3915402fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56464a64fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56464a64f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56464a650400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3915403900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56464a64fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56464a650590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56464a650400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3915408880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56464a650720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56464a650590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   140.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.66 ms
whisper_print_timings:   sample time =    20.58 ms /    27 runs (    0.76 ms per run)
whisper_print_timings:   encode time =  1846.35 ms /     1 runs ( 1846.35 ms per run)
whisper_print_timings:   decode time =   131.83 ms /    27 runs (    4.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2224.04 ms
```
### mpt
...
main:      load time =  6653.38 ms
main:    sample time =   594.57 ms / 9.29 ms per token
main:      eval time = 24582.32 ms / 351.18 ms per token
main:     total time = 32710.62 ms
...
main:      load time =  1686.81 ms
main:    sample time =   595.92 ms / 9.31 ms per token
main:      eval time = 12389.32 ms / 176.99 ms per token
main:     total time = 15314.89 ms
