...
- status:  SUCCESS ✅
- runtime: 4:04.14
- date:    Sun Jul 23 14:39:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/11 Test  #1: test-grad0 .......................   Passed    3.76 sec
      Start  2: test-opt
 2/11 Test  #2: test-opt .........................   Passed   44.74 sec
...
main:     load time =   179.95 ms
main:   sample time =    18.73 ms
main:  predict time =   824.51 ms / 12.88 ms per token
main:    total time =  1097.57 ms
...
main:   sample time =    19.45 ms
main:  predict time =   899.94 ms / 12.86 ms per token
main:    total time =  1155.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff90cba870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff90b3b140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5639aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff90cb9f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff90cbf7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf563a810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff90b3b140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5639aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf563b110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf563a810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff90cb9f70                         fc1_bias

DST    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0xaaaaf563ba10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf563b110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf563c310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff90cba870                       fc2_weight
SRC    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0xaaaaf563ba10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf563c470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf563c310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff90cbf7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf563c5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf563c470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5527.66 ms
main:    sample time =   640.86 ms / 10.01 ms per token
main:      eval time = 45157.82 ms / 645.11 ms per token
main:     total time = 53851.59 ms
...
main:      load time =  1602.16 ms
main:    sample time =   636.56 ms / 9.95 ms per token
main:      eval time = 17818.55 ms / 254.55 ms per token
main:     total time = 21028.91 ms
