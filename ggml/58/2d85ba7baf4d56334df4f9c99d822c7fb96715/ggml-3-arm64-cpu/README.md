...
- status:  SUCCESS ✅
- runtime: 4:22.46
- date:    Sun Feb 25 18:02:43 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  106.18 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 125.03 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    2.57 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.50 sec
...
21/21 Test #21: test-backend-ops .................   Passed   25.00 sec
...
main:     load time =   151.35 ms
main:   sample time =    17.83 ms
main:  predict time =   915.51 ms / 14.30 ms per token
main:    total time =  1107.19 ms
...
main:  predict time =   969.84 ms / 13.85 ms per token
main:    total time =  1141.40 ms
...
main:  predict time =   993.30 ms / 14.19 ms per token
main:    total time =  1193.86 ms
...
main:  predict time =  6665.07 ms
main:    total time =  7027.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa9cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf514dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf514eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa9cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf514dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf514f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf514eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf514fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf514f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf51506d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf514fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5150890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf51506d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf5150a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5150890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.99 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.24 ms
whisper_print_timings:   sample time =    65.67 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4681.91 ms /     1 runs ( 4681.91 ms per run)
whisper_print_timings:   decode time =    15.29 ms /     2 runs (    7.65 ms per run)
whisper_print_timings:   batchd time =   710.51 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5595.95 ms
