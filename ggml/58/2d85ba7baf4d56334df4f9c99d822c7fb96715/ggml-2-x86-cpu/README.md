...
- status:  SUCCESS ✅
- runtime: 3:07.49
- date:    Sun Feb 25 18:01:30 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/582d85ba7baf4d56334df4f9c99d822c7fb96715
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    4.63 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    1.17 sec
...
20/20 Test #20: test-backend-ops .................   Passed   88.49 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 103.91 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    2.32 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.67 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.47 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.45 sec
...
21/21 Test #21: test-backend-ops .................   Passed   21.37 sec
...
main:     load time =   108.88 ms
main:   sample time =    23.64 ms
main:  predict time =   495.13 ms / 7.74 ms per token
main:    total time =   640.29 ms
...
main:     load time =   109.47 ms
main:   sample time =    23.48 ms
main:  predict time =   518.81 ms / 7.41 ms per token
main:    total time =   653.74 ms
...
main:     load time =   129.42 ms
main:   sample time =    23.51 ms
main:  predict time =   521.02 ms / 7.44 ms per token
main:    total time =   676.42 ms
...
main:     n_decoded =      504
main:     load time =   109.20 ms
main:   sample time =   178.06 ms
main:  predict time =  1858.47 ms
main:    total time =  2176.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5ba741f990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ba72a01a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5619b45dbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5ba741f030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5ba7424940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5619b45dcab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ba72a01a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5619b45dbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5619b45dd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5619b45dcab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5ba741f030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5619b45ddd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5619b45dd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5619b45de6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5ba741f990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5619b45ddd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5619b45de890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5619b45de6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5ba7424940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5619b45dea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5619b45de890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.52 ms
whisper_print_timings:   sample time =    55.26 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1184.61 ms /     1 runs ( 1184.61 ms per run)
whisper_print_timings:   decode time =    12.36 ms /     2 runs (    6.18 ms per run)
whisper_print_timings:   batchd time =   213.79 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1563.46 ms
...
main:     load time =    68.70 ms
main:    total time = 10715.27 ms
embd_img
