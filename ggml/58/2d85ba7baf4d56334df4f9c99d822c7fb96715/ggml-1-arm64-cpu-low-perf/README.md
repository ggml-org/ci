...
- status:  SUCCESS ✅
- runtime: 5:18.22
- date:    Sun Feb 25 06:03:46 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    4.99 sec
...
Total Test time (real) = 148.99 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.03 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.57 sec
      Start  3: test-quantize-perf
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.42 sec
...
main:  predict time =   927.24 ms / 14.49 ms per token
...
main:  predict time =  1015.21 ms / 14.50 ms per token
main:    total time =  1192.44 ms
...
main:     load time =   183.12 ms
main:   sample time =    17.08 ms
main:  predict time =  1001.94 ms / 14.31 ms per token
main:    total time =  1205.36 ms
...
main:     n_decoded =      504
main:     load time =   156.13 ms
main:   sample time =   128.74 ms
main:  predict time =  6673.20 ms
main:    total time =  7040.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9b8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9a0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab060b7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9b8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9b8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab060b8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9a0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab060b7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab060b9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab060b8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9b8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab060b9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab060b9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab060ba6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9b8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab060b9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab060ba890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab060ba6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9b8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab060baa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab060ba890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.21 ms
whisper_print_timings:   sample time =    65.84 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4689.65 ms /     1 runs ( 4689.65 ms per run)
whisper_print_timings:   decode time =    15.50 ms /     2 runs (    7.75 ms per run)
whisper_print_timings:   batchd time =   841.10 ms /   125 runs (    6.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5738.82 ms
...
main:     load time =    89.24 ms
main:    total time = 40540.00 ms
embd_img
