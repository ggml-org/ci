...
- status:  SUCCESS ✅
- runtime: 1:57.66
- date:    Sun Jun 16 16:12:53 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   30.02 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   16.02 sec
      Start  4: test-quantize-perf
 4/22 Test  #4: test-quantize-perf ...............   Passed    4.48 sec
...
main:  predict time =   479.05 ms / 7.49 ms per token
main:    total time =   616.99 ms
...
main:  predict time =   495.86 ms / 7.08 ms per token
main:    total time =   626.14 ms
...
main:  predict time =   516.46 ms / 7.38 ms per token
main:    total time =   668.59 ms
...
main:     n_decoded =      504
main:     load time =   103.11 ms
main:   sample time =   178.20 ms
main:  predict time =  1540.39 ms
main:    total time =  1854.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x779adfcfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x779adfb7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x57201e89bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x779adfcfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x779adfcff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x57201e89cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x779adfb7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x57201e89bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x57201e89d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x57201e89cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x779adfcfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x57201e89dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x57201e89d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x57201e89e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x779adfcfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x57201e89dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x57201e89e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x57201e89e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x779adfcff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x57201e89ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x57201e89e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
