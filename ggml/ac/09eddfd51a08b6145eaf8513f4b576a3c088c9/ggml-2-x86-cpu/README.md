...
- status:  SUCCESS ✅
- runtime: 3:29.99
- date:    Sun Dec 24 14:11:36 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   26.96 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.37 sec
...
main:     load time =   202.20 ms
main:   sample time =    23.54 ms
main:  predict time =   443.76 ms / 6.93 ms per token
main:    total time =   682.52 ms
...
main:  predict time =   455.93 ms / 6.51 ms per token
main:    total time =   607.68 ms
...
main:  predict time =  1484.02 ms
main:    total time =  1796.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fca2a4c5990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fca2a3461a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563d14adfb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fca2a4c5030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fca2a4ca940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563d14ae0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fca2a3461a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563d14adfb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563d14ae12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563d14ae0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fca2a4c5030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563d14ae1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563d14ae12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563d14ae2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fca2a4c5990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563d14ae1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563d14ae2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563d14ae2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fca2a4ca940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563d14ae2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563d14ae2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.23 ms
whisper_print_timings:   sample time =    55.87 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1159.24 ms /     1 runs ( 1159.24 ms per run)
whisper_print_timings:   decode time =     9.63 ms /     2 runs (    4.81 ms per run)
whisper_print_timings:   batchd time =   208.04 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1576.11 ms
...
main:     load time =    63.57 ms
main:    total time = 10572.99 ms
embd_img
...
main:      load time =  4983.77 ms
main:    sample time =   466.08 ms / 7.28 ms per token
main:      eval time = 20075.77 ms / 286.80 ms per token
main:     total time = 26182.03 ms
...
main:      load time =  1191.80 ms
main:    sample time =   464.39 ms / 7.26 ms per token
main:      eval time =  8070.58 ms / 115.29 ms per token
main:     total time = 10096.76 ms
