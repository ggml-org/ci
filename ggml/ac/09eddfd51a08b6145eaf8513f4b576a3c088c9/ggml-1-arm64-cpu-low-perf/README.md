...
- status:  SUCCESS ✅
- runtime: 3:34.12
- date:    Sun Dec 24 02:11:00 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.54 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   42.81 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.01 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.05 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.07 sec
...
main:  predict time =   835.39 ms / 13.05 ms per token
main:    total time =  1066.16 ms
...
main:  predict time =   916.12 ms / 13.09 ms per token
main:    total time =  1129.03 ms
...
main:     n_decoded =      504
main:     load time =   169.23 ms
main:   sample time =   129.44 ms
main:  predict time =  6073.68 ms
main:    total time =  6454.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8286a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff826eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf195bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8286a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8286f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf195c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff826eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf195bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf195d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf195c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8286a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf195dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf195d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf195e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8286a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf195dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf195e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf195e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8286f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf195e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf195e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.25 ms
whisper_print_timings:   sample time =    69.45 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4806.20 ms /     1 runs ( 4806.20 ms per run)
whisper_print_timings:   decode time =    15.59 ms /     2 runs (    7.80 ms per run)
whisper_print_timings:   batchd time =   716.68 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5737.68 ms
...
main:     load time =    99.19 ms
main:    total time = 40513.53 ms
embd_img
