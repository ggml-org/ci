...
- status:  SUCCESS ✅
- runtime: 3:52.57
- date:    Fri Mar  8 09:51:04 UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed  103.83 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed    6.46 sec
...
23/23 Test #23: test-backend-ops .................   Passed   27.56 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) =  45.98 sec
...
main:  predict time =   503.44 ms / 7.87 ms per token
main:    total time =   642.95 ms
...
main:  predict time =   517.62 ms / 7.39 ms per token
...
main:  predict time =   517.41 ms / 7.39 ms per token
main:    total time =   667.50 ms
...
main:  predict time =  1869.97 ms
main:    total time =  2183.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efec2f9a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efec2e1b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56539b719ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efec2f9a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efec2f9f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56539b71aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efec2e1b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56539b719ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56539b71b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56539b71aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efec2f9a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56539b71bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56539b71b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56539b71c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efec2f9a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56539b71bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56539b71c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56539b71c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efec2f9f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56539b71ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56539b71c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    22.57 ms
whisper_print_timings:   sample time =    54.53 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1185.94 ms /     1 runs ( 1185.94 ms per run)
whisper_print_timings:   decode time =    12.14 ms /     2 runs (    6.07 ms per run)
whisper_print_timings:   batchd time =   210.76 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1569.02 ms
