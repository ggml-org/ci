...
- status:  SUCCESS ✅
- runtime: 6:12.66
- date:    Fri Mar  8 09:46:50 AM UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed  128.81 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 188.55 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.50 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed    7.95 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    5.59 sec
      Start  4: test-mul-mat0
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.58 sec
      Start  9: test3
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   29.28 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) =  71.86 sec
...
main:  predict time =   901.90 ms / 14.09 ms per token
main:    total time =  1097.45 ms
...
main:     load time =   161.17 ms
main:   sample time =    17.32 ms
main:  predict time =   984.33 ms / 14.06 ms per token
main:    total time =  1165.65 ms
...
main:  predict time =   995.14 ms / 14.22 ms per token
main:    total time =  1198.98 ms
...
main:     n_decoded =      504
main:     load time =   156.33 ms
main:   sample time =   126.95 ms
main:  predict time =  6512.65 ms
main:    total time =  6878.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9b93a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9b7bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab049cfce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9b93a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9b93f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab049d0ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9b7bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab049cfce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab049d1410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab049d0ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9b93a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab049d1d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab049d1410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab049d26d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9b93a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab049d1d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab049d2890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab049d26d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9b93f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab049d2a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab049d2890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.36 ms
whisper_print_timings:   sample time =    65.52 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4704.59 ms /     1 runs ( 4704.59 ms per run)
whisper_print_timings:   decode time =    15.41 ms /     2 runs (    7.70 ms per run)
whisper_print_timings:   batchd time =   712.80 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5625.56 ms
