...
- status:  SUCCESS ✅
- runtime: 5:15.18
- date:    Fri Mar  8 09:58:42 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   13.32 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.01 sec
...
22/22 Test #22: test-backend-ops .................   Passed  126.85 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 162.68 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.92 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.17 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed    6.83 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    5.59 sec
...
23/23 Test #23: test-backend-ops .................   Passed   30.92 sec
...
main:     load time =   150.20 ms
main:   sample time =    17.15 ms
main:  predict time =   889.95 ms / 13.91 ms per token
main:    total time =  1079.07 ms
...
main:  predict time =   969.72 ms / 13.85 ms per token
main:    total time =  1140.41 ms
...
main:     load time =   178.84 ms
main:   sample time =    16.98 ms
main:  predict time =   979.89 ms / 14.00 ms per token
main:    total time =  1179.04 ms
...
main:     n_decoded =      504
main:     load time =   151.71 ms
main:   sample time =   127.14 ms
main:  predict time =  6601.01 ms
main:    total time =  6963.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa847a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa82fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab02fbece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa847a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa847f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab02fbfab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa82fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab02fbece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab02fc0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab02fbfab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa847a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab02fc0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab02fc0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab02fc16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa847a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab02fc0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab02fc1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab02fc16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa847f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab02fc1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab02fc1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.97 ms
...
whisper_print_timings:   decode time =    15.39 ms /     2 runs (    7.69 ms per run)
whisper_print_timings:   batchd time =   711.03 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5602.09 ms
