...
- status:  SUCCESS ✅
- runtime: 14:36.92
- date:    Sun Jun 16 08:40:13 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.71 sec
...
21/21 Test #21: test-backend-ops .................   Passed  184.32 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 265.64 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   20.46 sec
 ...
 8/22 Test  #8: test1 ............................   Passed    0.04 sec
      Start  9: test2
 9/22 Test  #9: test2 ............................   Passed   20.28 sec
      Start 10: test3
...
22/22 Test #22: test-backend-ops .................   Passed   44.67 sec
...
main:  predict time =   581.93 ms / 9.09 ms per token
main:    total time =   787.02 ms
...
main:     load time =   161.39 ms
main:   sample time =    35.43 ms
main:  predict time =   624.43 ms / 8.92 ms per token
main:    total time =   824.95 ms
...
main:     load time =   183.78 ms
main:   sample time =    34.56 ms
main:  predict time =   645.43 ms / 9.22 ms per token
main:    total time =   869.12 ms
...
main:   sample time =   233.20 ms
main:  predict time =  2321.49 ms
main:    total time =  2752.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa4b9efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa4b9d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55593933b840                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa4b9efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa4b9eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55593933c610                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa4b9d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55593933b840                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55593933cf70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55593933c610                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa4b9efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55593933d8d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55593933cf70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55593933e230                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa4b9efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55593933d8d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55593933e3f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55593933e230                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa4b9eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55593933e5b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55593933e3f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   505.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.79 ms
whisper_print_timings:   sample time =    72.86 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =    47.52 ms /     1 runs (   47.52 ms per run)
whisper_print_timings:   decode time =    12.59 ms /     2 runs (    6.30 ms per run)
whisper_print_timings:   batchd time =    78.58 ms /   125 runs (    0.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   744.90 ms
