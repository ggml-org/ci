...
- status:  SUCCESS ✅
- runtime: 2:08.32
- date:    Sun Jun 16 07:59:43 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   30.10 sec
...
main:  predict time =   483.23 ms / 7.55 ms per token
main:    total time =   622.63 ms
...
main:  predict time =   499.08 ms / 7.13 ms per token
main:    total time =   630.81 ms
...
main:  predict time =   506.54 ms / 7.24 ms per token
main:    total time =   656.39 ms
...
main:  predict time =  1542.58 ms
main:    total time =  1857.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x748070afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x74807097b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5746cdd74ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x748070afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x748070aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5746cdd75ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x74807097b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5746cdd74ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5746cdd76410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5746cdd75ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x748070afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5746cdd76d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5746cdd76410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5746cdd776d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x748070afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5746cdd76d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5746cdd77890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5746cdd776d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x748070aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5746cdd77a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5746cdd77890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.74 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.13 ms
whisper_print_timings:   sample time =    54.73 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1164.31 ms /     1 runs ( 1164.31 ms per run)
whisper_print_timings:   decode time =    11.39 ms /     2 runs (    5.69 ms per run)
whisper_print_timings:   batchd time =   218.88 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1551.26 ms
...
main:     load time =    65.54 ms
main:    total time = 10614.46 ms
embd_img
