...
- status:  SUCCESS ✅
- runtime: 3:23.31
- date:    Sun Jun 16 07:55:14 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   23.99 sec
      Start  9: test3
...
Total Test time (real) =  73.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.23 sec
      Start  9: test3
...
main:     load time =   101.52 ms
main:   sample time =    23.84 ms
main:  predict time =   642.62 ms / 10.04 ms per token
main:    total time =   780.56 ms
...
main:     load time =   121.16 ms
main:   sample time =    23.85 ms
main:  predict time =   680.39 ms / 9.72 ms per token
main:    total time =   828.48 ms
...
main:     n_decoded =      504
main:     load time =   101.29 ms
main:   sample time =   178.19 ms
main:  predict time =  2571.29 ms
main:    total time =  2896.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x771a39cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x771a39b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x57a10e53bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x771a39cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x771a39cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x57a10e53cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x771a39b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x57a10e53bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x57a10e53d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x57a10e53cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x771a39cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x57a10e53dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x57a10e53d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x57a10e53e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x771a39cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x57a10e53dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x57a10e53e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x57a10e53e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x771a39cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x57a10e53ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x57a10e53e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    70.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.35 ms
whisper_print_timings:   sample time =    71.55 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1998.21 ms /     1 runs ( 1998.21 ms per run)
whisper_print_timings:   decode time =    13.76 ms /     2 runs (    6.88 ms per run)
whisper_print_timings:   batchd time =   326.38 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2516.93 ms
