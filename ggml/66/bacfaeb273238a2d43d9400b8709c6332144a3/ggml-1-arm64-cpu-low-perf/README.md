...
- status:  SUCCESS ✅
- runtime: 4:08.29
- date:    Sun Jun 16 07:55:56 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.63 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.33 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed   10.75 sec
      Start  4: test-mul-mat0
 4/21 Test  #4: test-mul-mat0 ....................   Passed    0.53 sec
      Start  5: test-mul-mat2
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.59 sec
      Start  6: test0
 6/21 Test  #6: test0 ............................   Passed    0.00 sec
      Start  7: test1
 7/21 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.53 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.62 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.76 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   20.22 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed    5.58 sec
      Start  4: test-mul-mat0
 4/21 Test  #4: test-mul-mat0 ....................   Passed    0.53 sec
      Start  5: test-mul-mat2
...
main:     load time =   145.44 ms
main:   sample time =    18.10 ms
main:  predict time =   887.87 ms / 13.87 ms per token
main:    total time =  1072.96 ms
...
main:     load time =   151.80 ms
main:   sample time =    18.69 ms
main:  predict time =   966.18 ms / 13.80 ms per token
main:    total time =  1139.44 ms
...
main:     load time =   181.06 ms
main:   sample time =    18.38 ms
main:  predict time =   987.08 ms / 14.10 ms per token
main:    total time =  1189.99 ms
...
main:     n_decoded =      504
main:     load time =   147.62 ms
main:   sample time =   130.85 ms
main:  predict time =  6138.72 ms
main:    total time =  6506.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf7fc9a83a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf7fc9a6bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xae24a29bbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf7fc9a83a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf7fc9a83f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xae24a29bcab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf7fc9a6bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xae24a29bbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xae24a29bd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xae24a29bcab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf7fc9a83a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xae24a29bdd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xae24a29bd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xae24a29be6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf7fc9a83a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xae24a29bdd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xae24a29be890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xae24a29be6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf7fc9a83f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xae24a29bea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xae24a29be890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.44 ms
whisper_print_timings:   sample time =    68.49 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4681.15 ms /     1 runs ( 4681.15 ms per run)
whisper_print_timings:   decode time =    15.09 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   747.24 ms /   125 runs (    5.98 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5647.90 ms
...
main:     load time =    93.78 ms
main:    total time = 39988.66 ms
embd_img
