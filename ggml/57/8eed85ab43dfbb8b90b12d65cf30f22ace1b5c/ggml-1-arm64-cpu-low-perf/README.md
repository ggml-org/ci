...
- status:  SUCCESS ✅
- runtime: 3:59.20
- date:    Sun May 26 15:39:47 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.21 sec
 ...
 8/22 Test  #8: test2 ............................   Passed   21.20 sec
      Start  9: test3
 9/22 Test  #9: test3 ............................   Passed    1.49 sec
      Start 10: test-pool
...
main:  predict time =   910.46 ms / 14.23 ms per token
main:    total time =  1091.85 ms
...
main:     load time =   168.91 ms
main:   sample time =    16.57 ms
main:  predict time =  1008.23 ms / 14.40 ms per token
main:    total time =  1196.68 ms
...
main:     n_decoded =      504
main:     load time =   139.94 ms
main:   sample time =   126.69 ms
main:  predict time =  6506.75 ms
main:    total time =  6856.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe40f938aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe40f9372b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xad48f84cace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe40f938aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe40f938af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xad48f84cbab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe40f9372b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xad48f84cace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xad48f84cc410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xad48f84cbab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe40f938aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xad48f84ccd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xad48f84cc410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xad48f84cd6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe40f938aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xad48f84ccd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xad48f84cd890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xad48f84cd6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe40f938af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xad48f84cda50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xad48f84cd890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    98.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.76 ms
whisper_print_timings:   sample time =    65.58 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4648.09 ms /     1 runs ( 4648.09 ms per run)
whisper_print_timings:   decode time =    14.54 ms /     2 runs (    7.27 ms per run)
whisper_print_timings:   batchd time =   727.13 ms /   125 runs (    5.82 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5583.76 ms
...
main:     load time =    90.40 ms
main:    total time = 40224.07 ms
embd_img
