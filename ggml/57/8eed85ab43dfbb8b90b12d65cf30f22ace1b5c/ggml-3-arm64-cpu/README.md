...
- status:  SUCCESS ✅
- runtime: 3:13.32
- date:    Sun May 26 15:39:08 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.30 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   35.31 sec
...
main:     load time =   161.23 ms
main:   sample time =    19.61 ms
main:  predict time =   937.26 ms / 14.64 ms per token
main:    total time =  1140.01 ms
...
main:     load time =   161.04 ms
main:   sample time =    19.44 ms
main:  predict time =  1016.89 ms / 14.53 ms per token
main:    total time =  1199.88 ms
...
main:     load time =   191.33 ms
main:   sample time =    19.38 ms
main:  predict time =  1041.96 ms / 14.89 ms per token
main:    total time =  1256.18 ms
...
main:     n_decoded =      504
main:     load time =   160.14 ms
main:   sample time =   128.98 ms
main:  predict time =  6528.80 ms
main:    total time =  6901.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf5684279a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf5684261b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb99370ceece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf5684279a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf5684279f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb99370cefab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf5684261b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb99370ceece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb99370cf0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb99370cefab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf5684279a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb99370cf0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb99370cf0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb99370cf16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf5684279a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb99370cf0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb99370cf1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb99370cf16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf5684279f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb99370cf1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb99370cf1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    68.85 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4687.36 ms /     1 runs ( 4687.36 ms per run)
whisper_print_timings:   decode time =    14.97 ms /     2 runs (    7.49 ms per run)
whisper_print_timings:   batchd time =   729.25 ms /   125 runs (    5.83 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5646.12 ms
...
main:     load time =    93.35 ms
main:    total time = 40520.85 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.282000 sec.)
