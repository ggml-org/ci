...
- status:  SUCCESS ✅
- runtime: 3:24.82
- date:    Sun May 26 15:39:25 UTC 2024
...
main:     load time =   102.12 ms
main:   sample time =    23.93 ms
main:  predict time =   688.99 ms / 10.77 ms per token
main:    total time =   827.53 ms
...
main:  predict time =   725.19 ms / 10.36 ms per token
main:    total time =   852.98 ms
...
main:  predict time =   739.41 ms / 10.56 ms per token
main:    total time =   888.29 ms
...
main:     n_decoded =      504
main:     load time =   100.30 ms
main:   sample time =   178.14 ms
main:  predict time =  2984.67 ms
main:    total time =  3308.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ae72f6fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ae72f57b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60b6638dbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ae72f6fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ae72f6ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60b6638dcab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ae72f57b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60b6638dbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60b6638dd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60b6638dcab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ae72f6fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60b6638ddd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60b6638dd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60b6638de6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ae72f6fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60b6638ddd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60b6638de890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60b6638de6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ae72f6ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x60b6638dea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60b6638de890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.47 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.98 ms
whisper_print_timings:   sample time =    72.87 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2004.09 ms /     1 runs ( 2004.09 ms per run)
whisper_print_timings:   decode time =    13.72 ms /     2 runs (    6.86 ms per run)
whisper_print_timings:   batchd time =   329.59 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2527.84 ms
