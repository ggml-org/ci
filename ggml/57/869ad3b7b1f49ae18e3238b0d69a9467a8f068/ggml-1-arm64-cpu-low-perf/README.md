...
- status:  SUCCESS ✅
- runtime: 6:09.19
- date:    Fri Mar  8 10:01:17 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.32 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   22.35 sec
      Start  9: test3
...
22/22 Test #22: test-backend-ops .................   Passed  126.92 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 187.36 sec
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   29.17 sec
...
main:     load time =   158.65 ms
main:   sample time =    17.02 ms
main:  predict time =   900.92 ms / 14.08 ms per token
...
main:     load time =   155.16 ms
main:   sample time =    17.17 ms
main:  predict time =   987.55 ms / 14.11 ms per token
main:    total time =  1162.65 ms
...
main:     load time =   184.85 ms
main:   sample time =    17.21 ms
main:  predict time =  1023.25 ms / 14.62 ms per token
main:    total time =  1228.57 ms
...
main:     n_decoded =      504
main:     load time =   160.34 ms
main:   sample time =   127.00 ms
main:  predict time =  6546.58 ms
main:    total time =  6920.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffafb8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffafa0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaace52ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffafb8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffafb8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaace52bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffafa0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaace52ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaace52c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaace52bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffafb8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaace52cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaace52c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaace52d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffafb8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaace52cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaace52d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaace52d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffafb8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaace52da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaace52d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4696.08 ms /     1 runs ( 4696.08 ms per run)
whisper_print_timings:   decode time =    15.27 ms /     2 runs (    7.64 ms per run)
whisper_print_timings:   batchd time =   746.38 ms /   125 runs (    5.97 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5651.31 ms
...
main:     load time =    88.64 ms
main:    total time = 39904.33 ms
embd_img
