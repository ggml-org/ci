...
- status:  SUCCESS ✅
- runtime: 3:51.30
- date:    Fri Mar  8 09:59:09 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   12.31 sec
...
22/22 Test #22: test-backend-ops .................   Passed  104.62 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 135.54 sec
...
23/23 Test #23: test-backend-ops .................   Passed   25.66 sec
...
main:  predict time =   492.10 ms / 7.69 ms per token
main:    total time =   635.15 ms
...
main:  predict time =   517.15 ms / 7.39 ms per token
main:    total time =   649.38 ms
...
main:     load time =   125.63 ms
main:   sample time =    23.79 ms
main:  predict time =   528.89 ms / 7.56 ms per token
main:    total time =   680.86 ms
...
main:  predict time =  1864.49 ms
main:    total time =  2177.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f293af74990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f293adf51a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55721fbccce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f293af74030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f293af79940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55721fbcdab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f293adf51a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55721fbccce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55721fbce410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55721fbcdab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f293af74030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55721fbced70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55721fbce410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55721fbcf6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f293af74990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55721fbced70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55721fbcf890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55721fbcf6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f293af79940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55721fbcfa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55721fbcf890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.18 ms
whisper_print_timings:   sample time =    54.70 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1183.07 ms /     1 runs ( 1183.07 ms per run)
whisper_print_timings:   decode time =    12.36 ms /     2 runs (    6.18 ms per run)
whisper_print_timings:   batchd time =   212.70 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1557.30 ms
