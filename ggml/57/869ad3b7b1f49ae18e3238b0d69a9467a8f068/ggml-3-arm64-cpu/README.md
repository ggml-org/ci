...
- status:  SUCCESS ✅
- runtime: 5:16.42
- date:    Fri Mar  8 10:09:35 UTC 2024
...
Total Test time (real) = 164.52 sec
...
23/23 Test #23: test-backend-ops .................   Passed   31.13 sec
...
main:  predict time =   890.42 ms / 13.91 ms per token
main:    total time =  1073.60 ms
...
main:     load time =   151.59 ms
main:   sample time =    17.09 ms
main:  predict time =   967.73 ms / 13.82 ms per token
main:    total time =  1139.27 ms
...
main:  predict time =   985.86 ms / 14.08 ms per token
main:    total time =  1186.38 ms
...
main:   sample time =   127.18 ms
main:  predict time =  6535.16 ms
main:    total time =  6894.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8298a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8280b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec958ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8298a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8298f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec959ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8280b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec958ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec95a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec959ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8298a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec95ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec95a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec95b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8298a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec95ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec95b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec95b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8298f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaec95ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec95b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4690.86 ms /     1 runs ( 4690.86 ms per run)
whisper_print_timings:   decode time =    15.12 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   710.65 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5604.55 ms
