...
- status:  SUCCESS ✅
- runtime: 4:49.61
- date:    Sun Nov 19 08:42:09 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.28 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.62 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.23 sec
      Start  2: test-opt
 2/18 Test  #2: test-opt .........................   Passed    2.03 sec
      Start  3: test-quantize-fns
 3/18 Test  #3: test-quantize-fns ................   Passed    0.01 sec
      Start  4: test-quantize-perf
 4/18 Test  #4: test-quantize-perf ...............   Passed    0.05 sec
      Start  5: test-mul-mat0
 5/18 Test  #5: test-mul-mat0 ....................   Passed    0.53 sec
...
main:     load time =   270.02 ms
main:   sample time =    16.67 ms
main:  predict time =   805.77 ms / 12.59 ms per token
main:    total time =  1114.43 ms
...
main:     load time =   180.68 ms
main:   sample time =    16.86 ms
main:  predict time =   877.20 ms / 12.53 ms per token
main:    total time =  1077.54 ms
...
main:     n_decoded =      504
main:     load time =   138.85 ms
main:   sample time =   126.71 ms
main:  predict time =  5821.38 ms
main:    total time =  6167.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f8fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f77b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab066a2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f8fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f8ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab066a3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f77b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab066a2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab066a4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab066a3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f8fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab066a4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab066a4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab066a5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f8fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab066a4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab066a56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab066a5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f8ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab066a5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab066a56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   188.98 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.03 ms
whisper_print_timings:   sample time =    64.89 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4630.49 ms /     1 runs ( 4630.49 ms per run)
whisper_print_timings:   decode time =    15.78 ms /     2 runs (    7.89 ms per run)
whisper_print_timings:   batchd time =   713.17 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5630.15 ms
...
main:     load time =    80.68 ms
main:    total time = 39348.47 ms
embd_img
...
main:      load time = 12603.60 ms
main:    sample time =   534.61 ms / 8.35 ms per token
main:      eval time = 43496.69 ms / 621.38 ms per token
main:     total time = 59009.38 ms
...
main:      load time =  4363.32 ms
main:    sample time =   524.29 ms / 8.19 ms per token
main:      eval time = 17574.67 ms / 251.07 ms per token
main:     total time = 23432.58 ms
