...
- status:  SUCCESS ✅
- runtime: 2:38.05
- date:    Sun Nov 19 08:39:57 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.26 sec
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.80 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.52 sec
      Start 10: test-pool
...
Total Test time (real) =  24.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.14 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.29 sec
      Start  9: test3
...
main:     load time =   188.22 ms
main:   sample time =    17.53 ms
main:  predict time =   821.57 ms / 12.84 ms per token
...
main:     n_decoded =      504
main:     load time =   161.31 ms
main:   sample time =   132.84 ms
main:  predict time =  6047.17 ms
main:    total time =  6422.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f6fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f57b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabfb52b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f6fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f6ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabfb53940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f57b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabfb52b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabfb54290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabfb53940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f6fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabfb54be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabfb54290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabfb55530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f6fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabfb54be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabfb556e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabfb55530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f6ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaabfb55890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabfb556e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.89 ms
whisper_print_timings:   sample time =    66.05 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4672.83 ms /     1 runs ( 4672.83 ms per run)
whisper_print_timings:   decode time =    16.09 ms /     2 runs (    8.04 ms per run)
whisper_print_timings:   batchd time =   721.52 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5613.67 ms
...
main:     load time =    90.21 ms
main:    total time = 40087.43 ms
embd_img
