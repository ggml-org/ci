...
- status:  SUCCESS ✅
- runtime: 3:11.25
- date:    Sun Nov 19 08:40:29 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/17 Test  #4: test-mul-mat0 ....................   Passed    0.51 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/18 Test  #6: test-mul-mat2 ....................   Passed    2.82 sec
      Start  7: test0
...
main:  predict time =   432.75 ms / 6.76 ms per token
...
main:  predict time =   445.95 ms / 6.37 ms per token
main:    total time =   599.87 ms
...
main:   sample time =   174.69 ms
main:  predict time =  1522.00 ms
main:    total time =  1829.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2349c36960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2349ab7190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556a00535b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2349c36010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2349c3b900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556a00536940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2349ab7190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556a00535b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556a00537290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556a00536940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2349c36010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556a00537be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556a00537290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556a00538530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2349c36960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556a00537be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556a005386e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556a00538530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2349c3b900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556a00538890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556a005386e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.25 ms
whisper_print_timings:   sample time =    53.58 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1135.22 ms /     1 runs ( 1135.22 ms per run)
whisper_print_timings:   decode time =     9.30 ms /     2 runs (    4.65 ms per run)
whisper_print_timings:   batchd time =   204.70 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1545.76 ms
...
main:     load time =    61.50 ms
main:    total time = 10371.25 ms
embd_img
...
main:      load time = 11103.26 ms
main:    sample time =   470.50 ms / 7.35 ms per token
main:      eval time = 20107.92 ms / 287.26 ms per token
main:     total time = 32390.12 ms
...
main:      load time =  4397.79 ms
main:    sample time =   465.92 ms / 7.28 ms per token
main:      eval time =  7949.26 ms / 113.56 ms per token
main:     total time = 13180.57 ms
