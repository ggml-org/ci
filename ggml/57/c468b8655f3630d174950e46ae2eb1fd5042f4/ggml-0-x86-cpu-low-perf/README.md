...
- status:  SUCCESS ✅
- runtime: 2:04.86
- date:    Sun Nov 19 08:39:29 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.76 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.63 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.31 sec
      Start  2: test-quantize-fns
 ...
 8/17 Test  #8: test2 ............................   Passed    9.76 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.58 sec
      Start 10: test-pool
10/17 Test #10: test-pool ........................   Passed    0.00 sec
      Start 11: test-conv-transpose
11/17 Test #11: test-conv-transpose ..............   Passed    0.00 sec
...
main:     load time =   127.30 ms
main:   sample time =    23.81 ms
main:  predict time =   602.85 ms / 9.42 ms per token
main:    total time =   766.64 ms
...
main:     load time =   129.85 ms
main:   sample time =    23.86 ms
main:  predict time =   636.73 ms / 9.10 ms per token
...
main:     n_decoded =      504
main:     load time =   105.80 ms
main:   sample time =   175.45 ms
main:  predict time =  2358.78 ms
main:    total time =  2684.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f33be242960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f33be0c3190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f4b2703b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f33be242010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f33be247900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f4b2704940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f33be0c3190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f4b2703b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f4b2705290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f4b2704940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f33be242010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f4b2705be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f4b2705290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f4b2706530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f33be242960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f4b2705be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f4b27066e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f4b2706530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f33be247900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f4b2706890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f4b27066e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.79 ms
whisper_print_timings:   sample time =    70.54 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1980.77 ms /     1 runs ( 1980.77 ms per run)
whisper_print_timings:   decode time =    12.50 ms /     2 runs (    6.25 ms per run)
whisper_print_timings:   batchd time =   321.20 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2487.71 ms
...
main:     load time =    69.74 ms
main:    total time = 18830.64 ms
embd_img
