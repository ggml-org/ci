...
- status:  SUCCESS ✅
- runtime: 2:33.61
- date:    Thu Nov  2 07:06:34 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.05 sec
      Start  4: test-mul-mat0
...
main:  predict time =   824.61 ms / 12.88 ms per token
main:    total time =  1057.62 ms
...
main:     load time =   191.31 ms
main:   sample time =    17.45 ms
main:  predict time =   896.02 ms / 12.80 ms per token
main:    total time =  1107.60 ms
...
main:   sample time =   127.75 ms
main:  predict time =  5971.12 ms
main:    total time =  6360.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffacbca960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaca4b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafc3d6b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffacbca010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffacbcf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafc3d7940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaca4b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafc3d6b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafc3d8290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafc3d7940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffacbca010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafc3d8be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafc3d8290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafc3d9530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffacbca960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafc3d8be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafc3d96e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafc3d9530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffacbcf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafc3d9890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafc3d96e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4614.16 ms /     1 runs ( 4614.16 ms per run)
whisper_print_timings:   decode time =   176.06 ms /    27 runs (    6.52 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  4992.05 ms
...
main:     load time =    92.45 ms
main:    total time = 40045.40 ms
embd_img
