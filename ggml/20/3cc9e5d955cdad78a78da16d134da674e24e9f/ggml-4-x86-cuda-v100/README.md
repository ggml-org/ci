...
- status:  SUCCESS ✅
- runtime: 6:21.63
- date:    Thu Nov  2 19:45:26 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.25 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.17 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    5.90 sec
      Start  2: test-opt
...
main:     load time =   183.27 ms
main:   sample time =    35.43 ms
main:  predict time =   607.31 ms / 9.49 ms per token
main:    total time =   848.92 ms
...
main:     load time =   199.98 ms
main:   sample time =    34.51 ms
main:  predict time =   580.61 ms / 8.29 ms per token
main:    total time =   818.84 ms
...
main:   sample time =   243.47 ms
main:  predict time =  2282.71 ms
main:    total time =  2722.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f36c1efa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f36c1d7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5637bd502b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f36c1efa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f36c1eff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5637bd503940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f36c1d7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5637bd502b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5637bd504290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5637bd503940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f36c1efa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5637bd504be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5637bd504290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5637bd505530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f36c1efa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5637bd504be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5637bd5056e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5637bd505530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f36c1eff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5637bd505890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5637bd5056e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   714.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.85 ms
whisper_print_timings:   sample time =    22.98 ms /    27 runs (    0.85 ms per run)
whisper_print_timings:   encode time =  1886.35 ms /     1 runs ( 1886.35 ms per run)
whisper_print_timings:   decode time =   145.24 ms /    27 runs (    5.38 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2843.87 ms
...
main:     load time =   100.39 ms
main:    total time = 16555.61 ms
embd_img
...
main:      load time = 39943.64 ms
main:    sample time =   588.62 ms / 9.20 ms per token
main:      eval time = 24836.76 ms / 354.81 ms per token
main:     total time = 66278.30 ms
...
main:      load time = 17449.64 ms
main:    sample time =   577.29 ms / 9.02 ms per token
main:      eval time = 12652.64 ms / 180.75 ms per token
main:     total time = 31327.99 ms
