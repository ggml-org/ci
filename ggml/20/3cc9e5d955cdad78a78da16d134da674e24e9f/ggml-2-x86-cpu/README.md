...
- status:  SUCCESS ✅
- runtime: 4:21.25
- date:    Thu Nov  2 19:14:25 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/14 Test  #2: test-quantize-fns ................   Passed    0.03 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.21 sec
...
main:     load time =   185.34 ms
main:   sample time =    23.68 ms
main:  predict time =   431.51 ms / 6.74 ms per token
main:    total time =   652.98 ms
...
main:     load time =   130.27 ms
main:   sample time =    23.69 ms
main:  predict time =   451.71 ms / 6.45 ms per token
main:    total time =   607.33 ms
...
main:     n_decoded =      504
main:     load time =   105.43 ms
main:   sample time =   177.47 ms
main:  predict time =  1457.29 ms
main:    total time =  1771.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fab9d33c960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fab9d1bd190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f404807b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fab9d33c010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fab9d341900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f404808940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fab9d1bd190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f404807b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f404809290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f404808940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fab9d33c010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f404809be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f404809290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f40480a530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fab9d33c960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f404809be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f40480a6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f40480a530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fab9d341900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f40480a890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f40480a6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   130.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    16.17 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1141.64 ms /     1 runs ( 1141.64 ms per run)
whisper_print_timings:   decode time =    92.44 ms /    27 runs (    3.42 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1430.48 ms
...
main:      load time = 11521.55 ms
main:    sample time =   471.01 ms / 7.36 ms per token
main:      eval time = 20028.26 ms / 286.12 ms per token
main:     total time = 32690.14 ms
...
main:      load time =  4366.61 ms
main:    sample time =   465.87 ms / 7.28 ms per token
main:      eval time =  8103.05 ms / 115.76 ms per token
main:     total time = 13321.27 ms
