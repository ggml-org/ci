...
- status:  SUCCESS ✅
- runtime: 2:02.68
- date:    Thu Nov  2 19:05:59 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.41 sec
...
main:  predict time =   721.61 ms / 11.28 ms per token
...
main:  predict time =   627.23 ms / 8.96 ms per token
main:    total time =   778.52 ms
...
main:  predict time =  2360.93 ms
main:    total time =  2687.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5fb5ec5960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5fb5d46190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c88b545b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5fb5ec5010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5fb5eca900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c88b546940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5fb5d46190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c88b545b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c88b547290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c88b546940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5fb5ec5010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c88b547be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c88b547290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c88b548530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5fb5ec5960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c88b547be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c88b5486e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c88b548530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5fb5eca900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c88b548890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c88b5486e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    81.69 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.70 ms
whisper_print_timings:   sample time =    16.11 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  2084.05 ms /     1 runs ( 2084.05 ms per run)
whisper_print_timings:   decode time =   130.94 ms /    27 runs (    4.85 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2370.09 ms
...
main:     load time =    70.79 ms
main:    total time = 18904.74 ms
embd_img
