...
- status:  SUCCESS ✅
- runtime: 4:38.12
- date:    Thu Nov  2 07:48:27 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.18 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.02 sec
      Start  2: test-opt
...
main:  predict time =   803.56 ms / 12.56 ms per token
main:    total time =  1012.03 ms
...
main:     load time =   176.01 ms
main:   sample time =    16.66 ms
main:  predict time =   873.53 ms / 12.48 ms per token
main:    total time =  1068.82 ms
...
main:     n_decoded =      504
main:     load time =   147.06 ms
main:   sample time =   127.05 ms
main:  predict time =  5827.21 ms
main:    total time =  6181.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa3b2a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa39ab190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0a06db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa3b2a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa3b2f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0a06e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa39ab190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0a06db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0a06f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0a06e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa3b2a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0a06fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0a06f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0a070530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa3b2a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0a06fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0a0706e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0a070530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa3b2f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0a070890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0a0706e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   206.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.59 ms
whisper_print_timings:   sample time =    20.84 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4601.49 ms /     1 runs ( 4601.49 ms per run)
whisper_print_timings:   decode time =   172.61 ms /    27 runs (    6.39 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5062.36 ms
...
main:     load time =    84.14 ms
main:    total time = 39257.75 ms
embd_img
...
main:      load time =  5918.39 ms
main:    sample time =   533.19 ms / 8.33 ms per token
main:      eval time = 43646.93 ms / 623.53 ms per token
main:     total time = 52469.29 ms
...
main:      load time =  1508.99 ms
main:    sample time =   528.06 ms / 8.25 ms per token
main:      eval time = 17481.86 ms / 249.74 ms per token
main:     total time = 20466.32 ms
