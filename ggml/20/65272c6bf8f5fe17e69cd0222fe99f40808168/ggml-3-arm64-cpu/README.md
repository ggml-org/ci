...
- status:  SUCCESS ✅
- runtime: 5:36.93
- date:    Sat Jan 13 10:22:12 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.36 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.04 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   40.42 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.53 sec
...
main:     load time =   179.74 ms
main:   sample time =    17.00 ms
main:  predict time =   847.56 ms / 13.24 ms per token
main:    total time =  1066.06 ms
...
main:     load time =   184.34 ms
main:   sample time =    16.83 ms
main:  predict time =   913.46 ms / 13.05 ms per token
main:    total time =  1117.60 ms
...
main:     n_decoded =      504
main:     load time =   153.00 ms
main:   sample time =   128.69 ms
main:  predict time =  5994.81 ms
main:    total time =  6358.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8267a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff824fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab14be2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8267a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8267f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab14be3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff824fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab14be2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab14be42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab14be3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8267a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab14be4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab14be42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab14be5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8267a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab14be4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab14be5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab14be5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8267f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab14be5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab14be5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   196.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.51 ms
whisper_print_timings:   sample time =    65.85 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4650.40 ms /     1 runs ( 4650.40 ms per run)
whisper_print_timings:   decode time =    15.39 ms /     2 runs (    7.70 ms per run)
whisper_print_timings:   batchd time =   708.77 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5655.51 ms
...
main:     load time =    91.46 ms
main:    total time = 39705.94 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.254000 sec.)
...
main:      load time =  5918.00 ms
main:    sample time =   519.71 ms / 8.12 ms per token
main:      eval time = 43725.05 ms / 624.64 ms per token
main:     total time = 52537.95 ms
...
main:      load time =  1486.58 ms
main:    sample time =   516.28 ms / 8.07 ms per token
main:      eval time = 17302.75 ms / 247.18 ms per token
main:     total time = 20269.91 ms
