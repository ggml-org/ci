...
- status:  SUCCESS ✅
- runtime: 2:55.01
- date:    Sat Jan 13 22:16:34 UTC 2024
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.01 sec
...
main:  predict time =   634.22 ms / 9.91 ms per token
main:    total time =   802.98 ms
...
main:  predict time =   662.94 ms / 9.47 ms per token
main:    total time =   818.90 ms
...
main:  predict time =  2506.11 ms
main:    total time =  2837.04 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe708898990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7087191a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563b6b97db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe708898030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe70889d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563b6b97e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7087191a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563b6b97db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563b6b97f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563b6b97e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe708898030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563b6b97fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563b6b97f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563b6b980580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe708898990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563b6b97fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563b6b980740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563b6b980580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe70889d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563b6b980900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563b6b980740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1995.32 ms /     1 runs ( 1995.32 ms per run)
whisper_print_timings:   decode time =    12.23 ms /     2 runs (    6.11 ms per run)
whisper_print_timings:   batchd time =   322.76 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2505.67 ms
