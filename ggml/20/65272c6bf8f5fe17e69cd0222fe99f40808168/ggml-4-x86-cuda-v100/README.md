...
- status:  SUCCESS ✅
- runtime: 8:08.11
- date:    Sat Jan 13 22:28:12 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    0.55 sec
...
20/20 Test #20: test-backend-ops .................   Passed   71.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    6.75 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.78 sec
...
21/21 Test #21: test-backend-ops .................   Passed   27.28 sec
...
main:     load time =   593.99 ms
main:   sample time =    34.44 ms
main:  predict time =   622.07 ms / 9.72 ms per token
main:    total time =  1274.03 ms
...
main:     load time =   567.65 ms
main:   sample time =    34.24 ms
main:  predict time =   617.91 ms / 8.83 ms per token
main:    total time =  1224.52 ms
...
main:     n_decoded =      504
main:     load time =   537.72 ms
main:   sample time =   237.78 ms
main:  predict time =  2322.40 ms
main:    total time =  3142.39 ms
...
main: loaded model in   398.20 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1bb61b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1bb60371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56248790ba70                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1bb61b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1bb61bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56248790c840                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1bb60371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56248790ba70                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56248790d1a0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56248790c840                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1bb61b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56248790db00                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56248790d1a0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56248790e460                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1bb61b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56248790db00                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56248790e620                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56248790e460                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1bb61bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56248790e7e0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56248790e620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   656.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.41 ms
whisper_print_timings:   sample time =    66.74 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    23.91 ms /     1 runs (   23.91 ms per run)
whisper_print_timings:   decode time =    22.16 ms /     2 runs (   11.08 ms per run)
whisper_print_timings:   batchd time =    80.51 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   876.23 ms
...
main:     load time =   503.83 ms
main:    total time =  7948.84 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.653000 sec.)
...
main:      load time =  7634.44 ms
main:    sample time =   544.47 ms / 8.51 ms per token
main:      eval time = 25842.45 ms / 369.18 ms per token
main:     total time = 34989.79 ms
...
main:      load time =  2184.29 ms
main:    sample time =   545.88 ms / 8.53 ms per token
main:      eval time = 12334.65 ms / 176.21 ms per token
main:     total time = 15707.31 ms
