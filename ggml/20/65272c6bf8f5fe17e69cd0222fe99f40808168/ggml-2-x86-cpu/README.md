...
- status:  SUCCESS ✅
- runtime: 3:46.90
- date:    Sat Jan 13 22:18:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.35 sec
...
20/20 Test #20: test-backend-ops .................   Passed   32.15 sec
...
21/21 Test #21: test-backend-ops .................   Passed    9.12 sec
...
main:     load time =   176.79 ms
main:   sample time =    23.60 ms
main:  predict time =   454.12 ms / 7.10 ms per token
main:    total time =   667.69 ms
...
main:  predict time =   469.74 ms / 6.71 ms per token
main:    total time =   620.37 ms
...
main:     n_decoded =      504
main:     load time =   105.53 ms
main:   sample time =   178.09 ms
main:  predict time =  1513.91 ms
main:    total time =  1827.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79c3043990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79c2ec41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561b55172b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79c3043030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79c3048940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561b55173960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79c2ec41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561b55172b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561b551742c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561b55173960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79c3043030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561b55174c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561b551742c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561b55175580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79c3043990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561b55174c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561b55175740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561b55175580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79c3048940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561b55175900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561b55175740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   124.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.34 ms
whisper_print_timings:   sample time =    54.84 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1158.75 ms /     1 runs ( 1158.75 ms per run)
whisper_print_timings:   decode time =     9.77 ms /     2 runs (    4.89 ms per run)
whisper_print_timings:   batchd time =   212.01 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1577.88 ms
...
main:     load time =    63.22 ms
main:    total time = 10628.11 ms
embd_img
...
main:      load time =  5666.15 ms
main:    sample time =   468.53 ms / 7.32 ms per token
main:      eval time = 20863.17 ms / 298.05 ms per token
main:     total time = 27667.71 ms
...
main:      load time =  1192.57 ms
main:    sample time =   466.37 ms / 7.29 ms per token
main:      eval time =  9392.43 ms / 134.18 ms per token
main:     total time = 11430.97 ms
