...
- status:  SUCCESS ✅
- runtime: 1:41.09
- date:    Mon Jul 24 10:48:05 UTC 2023
...
main:     load time =   135.15 ms
main:   sample time =    24.05 ms
main:  predict time =   605.10 ms / 9.45 ms per token
main:    total time =   820.91 ms
...
main:  predict time =   657.08 ms / 9.39 ms per token
main:    total time =   855.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cf80bf870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cf7f40140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5572e33a5aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cf80bef70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cf80c47c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5572e33a6810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cf7f40140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5572e33a5aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5572e33a7110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5572e33a6810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cf80bef70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5572e33a7a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5572e33a7110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5572e33a8310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cf80bf870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5572e33a7a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5572e33a8470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5572e33a8310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cf80c47c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5572e33a85d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5572e33a8470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
```diff
--- /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/stdall	2023-07-23 19:48:06.710597820 +0000
+++ /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/stdall	2023-07-24 10:48:05.492879042 +0000
@@ -1,7 +1,7 @@
 mkdir: cannot create directory ‘/mnt/ggml’: Permission denied
-rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/*.log': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/*.exit': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/*.md': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/*.md': No such file or directory
...
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_debug.log
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
...
-user	0m0.248s
-sys	0m0.118s
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_debug-make.log
+real	0m0.408s
+user	0m0.266s
+sys	0m0.124s
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_debug-make.log
 + make -j
...
-user	0m37.688s
-sys	0m3.551s
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_debug-ctest.log
+real	0m12.861s
+user	0m38.214s
+sys	0m3.856s
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_release.log
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_release.log
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_release-cmake.log
...
-user	0m0.266s
-sys	0m0.112s
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_release-make.log
+real	0m0.401s
+user	0m0.251s
+sys	0m0.133s
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_release-make.log
 + make -j
 [  1%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
 [  2%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
@@ -290,137 +290,137 @@
...
+sys	0m3.270s
 + '[' -z 1 ']'
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/ctest_release-ctest.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/ctest_release-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/gpt_2.log
 + local out=models-mnt/gpt-2
 + local url=https://huggingface.co/ggerganov/ggml/resolve/main/ggml-model-gpt-2-117M.bin
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/gpt_2.log
 ++ pwd
...
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/gpt_2-tg.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -506,15 +506,15 @@
 ...
 main: mem per token =  2015100 bytes
-main:     load time =   130.76 ms
-main:   sample time =    23.88 ms
-main:  predict time =   593.63 ms / 9.28 ms per token
-main:    total time =   802.69 ms
-
-real	0m0.811s
-user	0m2.483s
-sys	0m0.149s
...
@@ -539,14 +539,14 @@
 ...
 main: mem per token =  2015100 bytes
-main:     load time =   130.94 ms
-main:   sample time =    23.88 ms
-main:  predict time =   628.63 ms / 8.98 ms per token
-main:    total time =   823.96 ms
-
-real	0m0.832s
-user	0m2.618s
-sys	0m0.136s
...
@@ -555,8 +555,8 @@
 ...
 + cd build-ci-release
 + set -e
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/mnist.log
 + mkdir -p models/mnist
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/mnist.log
...
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-0-x86-cpu-low-perf/mnist-mnist.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-0-x86-cpu-low-perf/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
@@ -722,70 +722,70 @@
 ...
 TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3             DATA             NAME
-f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f41a3f84870                       fc2_weight
-f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f41a3e05140                       fc1_weight
-f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561eca569aa0                            input
-f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f41a3f83f70                         fc1_bias
-f32    NONE                1 10 1 1 1                4               40               40               40   0x7f41a3f897c0                         fc2_bias
+f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cf80bf870                       fc2_weight
+f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cf7f40140                       fc1_weight
+f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5572e33a5aa0                            input
+f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cf80bef70                         fc1_bias
+f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cf80c47c0                         fc2_bias
 ...
 ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
-DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561eca56a810                           node_0
-SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f41a3e05140                       fc1_weight
-SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561eca569aa0                            input
-
-DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561eca56b110                           node_1
-SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561eca56a810                           node_0
-SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f41a3f83f70                         fc1_bias
-
-DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561eca56ba10                           node_2
-SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561eca56b110                           node_1
-
-DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561eca56c310                           node_3
-SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f41a3f84870                       fc2_weight
-SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561eca56ba10                           node_2
-
-DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561eca56c470                           node_4
-SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561eca56c310                           node_3
-SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f41a3f897c0                         fc2_bias
+DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5572e33a6810                           node_0
+SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cf7f40140                       fc1_weight
+SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5572e33a5aa0                            input
+
...
-DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x561eca56c5d0                            probs
-SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561eca56c470       mnist_eval: exported compute graph to 'mnist.ggml'
+DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5572e33a85d0                            probs
+SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5572e33a8470       mnist_eval: exported compute graph to 'mnist.ggml'
                     node_4
