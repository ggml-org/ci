...
- status:  SUCCESS ✅
- runtime: 1:42.71
- date:    Mon Jul 24 10:48:21 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/10 Test  #1: test-grad0 .......................   Passed    5.56 sec
 ...
 5/10 Test  #5: test-mul-mat2 ....................   Passed    8.55 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 4/10 Test  #4: test-mul-mat0 ....................   Passed    0.54 sec
      Start  5: test-mul-mat2
 5/10 Test  #5: test-mul-mat2 ....................   Passed    1.76 sec
      Start  6: test0
...
main:     load time =   170.82 ms
main:   sample time =    17.34 ms
main:  predict time =   832.82 ms / 13.01 ms per token
main:    total time =  1094.99 ms
...
main: mem per token =  2015100 bytes
main:     load time =   166.34 ms
main:   sample time =    17.27 ms
main:  predict time =   880.62 ms / 12.58 ms per token
main:    total time =  1114.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9cb1a870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c99b140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2bf5aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cb19f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cb1f7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae2bf6810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c99b140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2bf5aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae2bf7110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae2bf6810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cb19f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae2bf7a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae2bf7110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae2bf8310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9cb1a870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae2bf7a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae2bf8470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae2bf8310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cb1f7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae2bf85d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae2bf8470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
```diff
--- /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/stdall	2023-07-23 19:48:12.389532324 +0000
+++ /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/stdall	2023-07-24 10:48:21.033404314 +0000
@@ -1,7 +1,7 @@
 mkdir: cannot create directory ‘/mnt/ggml’: Permission denied
-rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/*.log': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/*.exit': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/*.md': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/*.md': No such file or directory
...
+Requirement already satisfied: regex!=2019.12.17 in /home/ggml/.local/lib/python3.10/site-packages (from transformers==4.29.2->-r /home/ggml/work/ggml/requirements.txt (line 7)) (2023.6.3)
 ...
 + gg_run_ctest_debug
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_debug.log
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_debug.log
 + rm -rf build-ci-debug
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_debug-cmake.log
...
-user	0m0.300s
-sys	0m0.365s
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_debug-make.log
+real	0m0.667s
+user	0m0.337s
+sys	0m0.334s
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_debug-make.log
 + make -j
...
-user	0m34.426s
-sys	0m4.933s
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_debug-ctest.log
+real	0m12.907s
+user	0m34.058s
+sys	0m5.277s
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_release.log
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_release.log
 + cd /home/ggml/work/ggml
 + rm -rf build-ci-release
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_release-cmake.log
...
-user	0m0.325s
-sys	0m0.338s
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_release-make.log
+real	0m0.671s
+user	0m0.316s
+sys	0m0.359s
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_release-make.log
 + make -j
 [  1%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
 [  2%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
 [  4%] Linking C static library libggml.a
...
-[ 85%] Linking CXX executable ../../bin/starcoder-mmap
+[ 85%] Linking CXX executable ../../bin/gpt-2
...
+sys	0m4.644s
 + '[' -z 1 ']'
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/ctest_release-ctest.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/ctest_release-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
+sys	0m4.235s
 ...
 + set +x
 + gg_run_gpt_2
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/gpt_2.log
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/gpt_2.log
 + cd /home/ggml/work/ggml
...
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/gpt_2-tg.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -480,15 +480,15 @@
 ...
 main: mem per token =  2015100 bytes
-main:     load time =   166.38 ms
-main:   sample time =    17.41 ms
-main:  predict time =   811.98 ms / 12.69 ms per token
-main:    total time =  1069.84 ms
-
-real	0m1.105s
-user	0m3.437s
-sys	0m0.165s
...
-main:  predict time =   883.27 ms / 12.62 ms per token
-main:    total time =  1116.63 ms
-
-real	0m1.153s
-user	0m3.659s
-sys	0m0.204s
...
+sys	0m0.198s
 ...
 + set +x
 + gg_run_mnist
-+ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/mnist.log
++ tee /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/mnist.log
 + cd /home/ggml/work/ggml
 + cd build-ci-release
 + set -e
@@ -655,40 +655,40 @@
...
-+ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-1-arm64-cpu-low-perf/mnist-mnist.log
++ tee -a /home/ggml/results/ggml/20/28a0f58b47f72ae350abe155dd2f6b94ed0253/ggml-1-arm64-cpu-low-perf/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
@@ -698,69 +698,69 @@
 ...
 TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3             DATA             NAME
-f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb9caa870                       fc2_weight
-f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb9b2b140                       fc1_weight
-f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3f0daa0                            input
-f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb9ca9f70                         fc1_bias
-f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb9caf7c0                         fc2_bias
+f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9cb1a870                       fc2_weight
+f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c99b140                       fc1_weight
+f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2bf5aa0                            input
+f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cb19f70                         fc1_bias
+f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cb1f7c0                         fc2_bias
 ...
 ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
-DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf3f0e810                           node_0
-SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb9b2b140                       fc1_weight
-SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3f0daa0                            input
-
-DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf3f0f110                           node_1
-SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf3f0e810                           node_0
-SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb9ca9f70                         fc1_bias
-
-DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf3f0fa10                           node_2
-SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf3f0f110                           node_1
-
-DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf3f10310                           node_3
-SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb9caa870                       fc2_weight
-SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf3f0fa10                           node_2
-
-DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf3f10470                           node_4
-SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf3f10310                           node_3
-SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb9caf7c0                         fc2_bias
+DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae2bf6810                           node_0
+SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c99b140                       fc1_weight
+SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2bf5aa0                            input
+
...
-DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf3f105d0                            probs
-SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf3f10470       mnist_eval: exported compute graph to 'mnist.ggml'
+DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae2bf85d0                            probs
+SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae2bf8470       mnist_eval: exported compute graph to 'mnist.ggml'
                     node_4
