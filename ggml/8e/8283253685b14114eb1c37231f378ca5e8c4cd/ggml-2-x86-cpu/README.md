...
- status:  SUCCESS ✅
- runtime: 2:55.70
- date:    Thu Oct 12 14:11:22 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.83 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.72 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.62 sec
...
main:     load time =   212.53 ms
main:   sample time =    24.26 ms
main:  predict time =   480.19 ms / 7.50 ms per token
main:    total time =   730.51 ms
...
main:     load time =   115.76 ms
main:   sample time =    24.25 ms
main:  predict time =   511.65 ms / 7.31 ms per token
main:    total time =   654.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fda7ccab900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fda7cb2c170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559c4f041ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fda7ccaafd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fda7ccb0880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559c4f042870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fda7cb2c170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559c4f041ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559c4f0431a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559c4f042870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fda7ccaafd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559c4f043ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559c4f0431a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559c4f044400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fda7ccab900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559c4f043ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559c4f044590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559c4f044400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fda7ccb0880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559c4f044720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559c4f044590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   143.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.52 ms
whisper_print_timings:   sample time =    16.56 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1157.44 ms /     1 runs ( 1157.44 ms per run)
whisper_print_timings:   decode time =   106.42 ms /    27 runs (    3.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1481.54 ms
```
### mpt
...
main:      load time = 10037.14 ms
main:    sample time =   462.14 ms / 7.22 ms per token
main:      eval time = 21763.16 ms / 310.90 ms per token
main:     total time = 32959.43 ms
...
main:      load time =  4205.13 ms
main:    sample time =   459.50 ms / 7.18 ms per token
main:      eval time =  8749.86 ms / 125.00 ms per token
main:     total time = 13798.75 ms
