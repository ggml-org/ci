...
- status:  SUCCESS ✅
- runtime: 3:56.40
- date:    Thu Oct 12 02:12:23 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.65 sec
      Start  2: test-opt
...
main:     load time =   142.38 ms
main:   sample time =    16.73 ms
main:  predict time =   869.23 ms / 12.42 ms per token
main:    total time =  1032.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6c9a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6b1b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5104ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6c99fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6c9f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae5105870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6b1b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5104ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae51061a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae5105870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6c99fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae5106ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae51061a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5107400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6c9a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae5106ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae5107590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5107400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6c9f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae5107720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae5107590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   198.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.83 ms
whisper_print_timings:   sample time =    21.05 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4603.36 ms /     1 runs ( 4603.36 ms per run)
whisper_print_timings:   decode time =   180.07 ms /    27 runs (    6.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5067.07 ms
```
### mpt
...
main:      load time = 12197.33 ms
main:    sample time =   520.30 ms / 8.13 ms per token
main:      eval time = 43518.49 ms / 621.69 ms per token
main:     total time = 58610.04 ms
...
main:      load time =  4361.56 ms
main:    sample time =   514.15 ms / 8.03 ms per token
main:      eval time = 17558.76 ms / 250.84 ms per token
main:     total time = 23397.52 ms
