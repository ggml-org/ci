...
- status:  SUCCESS ✅
- runtime: 4:54.12
- date:    Thu Oct 12 14:13:11 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.72 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    7.42 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.69 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.29 sec
      Start 10: test3
...
main:     load time =   207.97 ms
main:   sample time =    38.03 ms
main:  predict time =   581.51 ms / 9.09 ms per token
main:    total time =   848.32 ms
...
main:     load time =   163.37 ms
main:   sample time =    34.43 ms
main:  predict time =   576.95 ms / 8.24 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f95598b4900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9559735170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558fead2cad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f95598b3fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f95598b9880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558fead2d870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9559735170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558fead2cad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558fead2e1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558fead2d870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f95598b3fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558fead2ead0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558fead2e1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558fead2f400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f95598b4900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558fead2ead0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558fead2f590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558fead2f400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f95598b9880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558fead2f720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558fead2f590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   367.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.54 ms
whisper_print_timings:   sample time =    20.22 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1853.25 ms /     1 runs ( 1853.25 ms per run)
whisper_print_timings:   decode time =   132.90 ms /    27 runs (    4.92 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2459.72 ms
```
### mpt
...
main:      load time =  7110.56 ms
main:    sample time =   579.78 ms / 9.06 ms per token
main:      eval time = 25082.90 ms / 358.33 ms per token
main:     total time = 33700.57 ms
...
main:      load time =  1671.21 ms
main:    sample time =   578.38 ms / 9.04 ms per token
main:      eval time = 12273.01 ms / 175.33 ms per token
main:     total time = 15173.51 ms
