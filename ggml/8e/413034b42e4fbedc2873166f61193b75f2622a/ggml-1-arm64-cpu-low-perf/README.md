...
- status:  SUCCESS ✅
- runtime: 4:02.96
- date:    Sat Apr  6 03:31:22 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/8e413034b42e4fbedc2873166f61193b75f2622a
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   32.63 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.17 sec
      Start  9: test3
...
Total Test time (real) =  78.26 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.47 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   17.47 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.93 sec
      Start  4: test-mul-mat0
...
main:  predict time =   901.94 ms / 14.09 ms per token
main:    total time =  1101.63 ms
...
main:  predict time =   986.03 ms / 14.09 ms per token
main:    total time =  1167.41 ms
...
main:  predict time =  1010.98 ms / 14.44 ms per token
...
main:     n_decoded =      504
main:     load time =   159.83 ms
main:   sample time =   129.58 ms
main:  predict time =  6467.86 ms
main:    total time =  6840.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb304a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb2ecb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab031ffce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb304a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb304f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab03200ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb2ecb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab031ffce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab03201410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab03200ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb304a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab03201d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab03201410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab032026d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb304a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab03201d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab03202890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab032026d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb304f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab03202a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab03202890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.73 ms
whisper_print_timings:   sample time =    65.57 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4693.01 ms /     1 runs ( 4693.01 ms per run)
whisper_print_timings:   decode time =    14.61 ms /     2 runs (    7.30 ms per run)
whisper_print_timings:   batchd time =   723.13 ms /   125 runs (    5.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5625.11 ms
