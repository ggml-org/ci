...
- status:  SUCCESS ✅
- runtime: 3:30.94
- date:    Sat Apr  6 15:30:46 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.04 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.27 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.63 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.05 sec
      Start  3: test-quantize-perf
...
main:     load time =   106.85 ms
main:   sample time =    23.65 ms
main:  predict time =   728.59 ms / 11.38 ms per token
main:    total time =   871.79 ms
...
main:     load time =   105.57 ms
main:   sample time =    23.66 ms
main:  predict time =   771.74 ms / 11.02 ms per token
main:    total time =   903.09 ms
...
main:  predict time =   785.19 ms / 11.22 ms per token
main:    total time =   940.43 ms
...
main:  predict time =  3112.60 ms
main:    total time =  3439.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0d6a2d8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0d6a1591a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a38b7a7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0d6a2d8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0d6a2dd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a38b7a8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0d6a1591a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a38b7a7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a38b7a9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a38b7a8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0d6a2d8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a38b7a9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a38b7a9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a38b7aa6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0d6a2d8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a38b7a9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a38b7aa890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a38b7aa6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0d6a2dd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a38b7aaa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a38b7aa890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.09 ms
whisper_print_timings:   sample time =    73.28 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2068.30 ms /     1 runs ( 2068.30 ms per run)
whisper_print_timings:   decode time =    16.45 ms /     2 runs (    8.23 ms per run)
whisper_print_timings:   batchd time =   332.07 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2591.59 ms
...
main:     load time =    69.53 ms
main:    total time = 19443.37 ms
embd_img
