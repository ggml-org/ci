...
- status:  SUCCESS ✅
- runtime: 9:10.28
- date:    Sat Apr  6 16:01:52 UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed   99.44 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 183.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/23 Test  #1: test-grad0 .......................   Passed    4.73 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    3.13 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   21.16 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    6.29 sec
...
23/23 Test #23: test-backend-ops .................   Passed   37.61 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) =  99.12 sec
...
main:  predict time =   659.75 ms / 10.31 ms per token
main:    total time =   867.14 ms
...
main:  predict time =   732.60 ms / 10.47 ms per token
main:    total time =   921.99 ms
...
main:   sample time =    38.12 ms
main:  predict time =   782.74 ms / 11.18 ms per token
main:    total time =  1024.70 ms
...
main:   sample time =   259.18 ms
main:  predict time =  3367.83 ms
main:    total time =  3863.43 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe830efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe830d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5594e4170e70                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe830efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe830eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5594e4171c40                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe830d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5594e4170e70                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5594e41725a0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5594e4171c40                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe830efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5594e4172f00                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5594e41725a0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5594e4173860                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe830efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5594e4172f00                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5594e4173a20                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5594e4173860                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe830eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5594e4173be0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5594e4173a20       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   526.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.53 ms
whisper_print_timings:   sample time =    66.99 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    48.07 ms /     1 runs (   48.07 ms per run)
whisper_print_timings:   decode time =    12.16 ms /     2 runs (    6.08 ms per run)
whisper_print_timings:   batchd time =    84.80 ms /   125 runs (    0.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   767.92 ms
