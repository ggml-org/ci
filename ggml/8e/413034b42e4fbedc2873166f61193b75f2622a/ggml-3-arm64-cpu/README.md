...
- status:  SUCCESS ✅
- runtime: 3:10.94
- date:    Sat Apr  6 15:30:30 UTC 2024
...
main:  predict time =   894.13 ms / 13.97 ms per token
main:    total time =  1081.41 ms
...
main:  predict time =   976.07 ms / 13.94 ms per token
main:    total time =  1150.30 ms
...
main:  predict time =   995.27 ms / 14.22 ms per token
main:    total time =  1199.41 ms
...
main:     n_decoded =      504
main:     load time =   147.49 ms
main:   sample time =   128.71 ms
main:  predict time =  6576.75 ms
main:    total time =  6935.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e47a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e2fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05001ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e47a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e47f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05002ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e2fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05001ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05003410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05002ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e47a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05003d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05003410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab050046d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e47a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05003d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05004890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab050046d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e47f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab05004a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05004890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.42 ms
whisper_print_timings:   sample time =    64.93 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4682.00 ms /     1 runs ( 4682.00 ms per run)
whisper_print_timings:   decode time =    14.44 ms /     2 runs (    7.22 ms per run)
whisper_print_timings:   batchd time =   709.21 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5593.61 ms
...
main:     load time =    92.55 ms
main:    total time = 39782.61 ms
embd_img
