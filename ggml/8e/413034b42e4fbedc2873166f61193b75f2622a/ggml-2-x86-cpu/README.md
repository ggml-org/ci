...
- status:  SUCCESS ✅
- runtime: 2:09.83
- date:    Sat Apr  6 15:29:15 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.44 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.71 sec
...
main:  predict time =   489.02 ms / 7.64 ms per token
main:    total time =   629.23 ms
...
main:  predict time =   509.95 ms / 7.28 ms per token
main:    total time =   638.96 ms
...
main:  predict time =   520.04 ms / 7.43 ms per token
main:    total time =   672.34 ms
...
main:  predict time =  1812.36 ms
main:    total time =  2122.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f81518e2990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81517631a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55681b92ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f81518e2030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f81518e7940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55681b92bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81517631a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55681b92ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55681b92c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55681b92bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f81518e2030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55681b92cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55681b92c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55681b92d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f81518e2990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55681b92cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55681b92d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55681b92d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f81518e7940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55681b92da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55681b92d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.04 ms
whisper_print_timings:   sample time =    56.31 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1191.86 ms /     1 runs ( 1191.86 ms per run)
whisper_print_timings:   decode time =    12.66 ms /     2 runs (    6.33 ms per run)
whisper_print_timings:   batchd time =   215.25 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1570.31 ms
