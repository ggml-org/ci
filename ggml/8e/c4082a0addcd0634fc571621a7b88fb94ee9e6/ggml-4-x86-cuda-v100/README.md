...
- status:  SUCCESS ✅
- runtime: 4:45.31
- date:    Tue Sep  5 11:43:26 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/8ec4082a0addcd0634fc571621a7b88fb94ee9e6
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.70 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    7.41 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.54 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.68 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed   16.08 sec
      Start 10: test3
...
main:     load time =   205.61 ms
main:   sample time =    35.26 ms
main:  predict time =   545.52 ms / 8.52 ms per token
main:    total time =   807.21 ms
...
main:     load time =   193.67 ms
main:   sample time =    34.89 ms
main:  predict time =   576.49 ms / 8.24 ms per token
main:    total time =   810.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fba5b5c88d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fba5b449160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5594c79faac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fba5b5c7fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fba5b5cd840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5594c79fb850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fba5b449160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5594c79faac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5594c79fc170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5594c79fb850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fba5b5c7fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5594c79fca90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5594c79fc170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5594c79fd3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fba5b5c88d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5594c79fca90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5594c79fd530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5594c79fd3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fba5b5cd840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5594c79fd6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5594c79fd530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7110.83 ms
main:    sample time =   589.33 ms / 9.21 ms per token
main:      eval time = 25423.72 ms / 363.20 ms per token
main:     total time = 34038.74 ms
...
main:      load time =  1822.17 ms
main:    sample time =   584.88 ms / 9.14 ms per token
main:      eval time = 12246.28 ms / 174.95 ms per token
main:     total time = 15310.63 ms
