...
- status:  SUCCESS ✅
- runtime: 3:21.73
- date:    Tue Sep  5 11:41:54 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.93 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.37 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.90 sec
      Start  2: test-opt
...
main:  predict time =   811.95 ms / 12.69 ms per token
main:    total time =  1029.23 ms
...
main:     load time =   175.51 ms
main:   sample time =    17.70 ms
main:  predict time =   875.52 ms / 12.51 ms per token
main:    total time =  1072.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88eea8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88d6b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6597ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88ee9fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88eef840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf6598850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88d6b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6597ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf6599170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf6598850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88ee9fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf6599a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf6599170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf659a3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88eea8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf6599a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf659a530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf659a3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88eef840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf659a6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf659a530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5546.77 ms
main:    sample time =   616.51 ms / 9.63 ms per token
main:      eval time = 44214.66 ms / 631.64 ms per token
main:     total time = 52755.92 ms
...
main:      load time =  1615.67 ms
main:    sample time =   621.21 ms / 9.71 ms per token
main:      eval time = 17373.52 ms / 248.19 ms per token
main:     total time = 20567.59 ms
