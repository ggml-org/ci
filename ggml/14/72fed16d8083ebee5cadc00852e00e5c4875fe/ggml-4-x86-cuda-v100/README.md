...
- status:  SUCCESS ✅
- runtime: 5:36.53
- date:    Fri Sep 15 17:51:48 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/1472fed16d8083ebee5cadc00852e00e5c4875fe
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed   16.08 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed   16.10 sec
      Start 10: test3
...
main:     load time =   265.07 ms
main:   sample time =    35.53 ms
main:  predict time =   564.12 ms / 8.81 ms per token
main:    total time =   885.11 ms
...
main:     load time =   194.43 ms
main:   sample time =    34.41 ms
main:  predict time =   555.26 ms / 7.93 ms per token
main:    total time =   789.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd7af56d8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd7af3ee160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5591cb9b6ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd7af56cfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd7af572840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5591cb9b7850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd7af3ee160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5591cb9b6ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5591cb9b8170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5591cb9b7850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd7af56cfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5591cb9b8a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5591cb9b8170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5591cb9b93b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd7af56d8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5591cb9b8a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5591cb9b9530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5591cb9b93b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd7af572840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5591cb9b96b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5591cb9b9530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7031.33 ms
main:    sample time =   613.64 ms / 9.59 ms per token
main:      eval time = 24998.87 ms / 357.13 ms per token
main:     total time = 33539.21 ms
...
main:      load time =  1710.50 ms
main:    sample time =   611.32 ms / 9.55 ms per token
main:      eval time = 12207.15 ms / 174.39 ms per token
main:     total time = 15203.57 ms
