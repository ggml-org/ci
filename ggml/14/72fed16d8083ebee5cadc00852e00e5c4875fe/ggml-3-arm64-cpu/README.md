...
- status:  SUCCESS ✅
- runtime: 3:42.82
- date:    Fri Sep 15 17:49:58 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.01 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.89 sec
      Start  2: test-opt
...
main:     load time =   251.01 ms
main:   sample time =    17.51 ms
main:  predict time =   805.71 ms / 12.59 ms per token
main:    total time =  1097.30 ms
...
main:     load time =   170.09 ms
main:   sample time =    17.57 ms
main:  predict time =   875.60 ms / 12.51 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb151a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb139b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaada28bac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb1519fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb151f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaada28c850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb139b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaada28bac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaada28d170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaada28c850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb1519fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaada28da90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaada28d170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaada28e3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb151a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaada28da90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaada28e530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaada28e3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb151f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaada28e6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaada28e530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11903.58 ms
main:    sample time =   626.14 ms / 9.78 ms per token
main:      eval time = 43797.79 ms / 625.68 ms per token
main:     total time = 58704.55 ms
...
main:      load time =  4360.98 ms
main:    sample time =   611.58 ms / 9.56 ms per token
main:      eval time = 17334.93 ms / 247.64 ms per token
main:     total time = 23263.91 ms
