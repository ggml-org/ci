...
- status:  FAILURE ❌ (1)
- runtime: 4:47.20
- date:    Sat Feb 10 08:03:54 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.07 sec
...
20/20 Test #20: test-backend-ops .................   Passed  130.33 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 143.74 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.85 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   22.50 sec
...
main:     load time =   177.66 ms
main:   sample time =    16.73 ms
main:  predict time =   848.00 ms / 13.25 ms per token
...
main:     load time =   177.24 ms
main:   sample time =    16.73 ms
main:  predict time =   918.54 ms / 13.12 ms per token
main:    total time =  1115.59 ms
...
main:     n_decoded =      504
main:     load time =   152.11 ms
main:   sample time =   128.34 ms
main:  predict time =  5979.77 ms
main:    total time =  6341.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8406a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83eeb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf29fdb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8406a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8406f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf29fe960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83eeb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf29fdb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf29ff2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf29fe960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8406a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf29ffc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf29ff2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf2a00580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8406a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf29ffc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf2a00740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf2a00580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8406f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf2a00900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf2a00740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.24 ms
whisper_print_timings:   sample time =    65.38 ms /   131 runs (    0.50 ms per run)
...
whisper_print_timings:   batchd time =   711.35 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5541.73 ms
...
main:     load time =    85.53 ms
main:    total time = 39678.16 ms
embd_img
