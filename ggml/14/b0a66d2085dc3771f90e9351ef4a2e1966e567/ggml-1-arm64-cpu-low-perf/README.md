...
- status:  SUCCESS ✅
- runtime: 6:02.82
- date:    Sat Feb 10 07:58:54 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.35 sec
 ...
 8/20 Test  #8: test2 ............................   Passed   21.87 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.62 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  155.13 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 193.21 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.63 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.60 sec
      Start 10: test-pool
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.32 sec
...
main:     load time =   188.49 ms
main:   sample time =    17.11 ms
main:  predict time =   856.87 ms / 13.39 ms per token
main:    total time =  1084.61 ms
...
main:     load time =   189.41 ms
main:   sample time =    16.89 ms
main:  predict time =   935.10 ms / 13.36 ms per token
main:    total time =  1144.51 ms
...
main:     n_decoded =      504
main:     load time =   159.95 ms
main:   sample time =   126.52 ms
main:  predict time =  6118.58 ms
main:    total time =  6486.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb24fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb237b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab007beb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb24fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb24ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab007bf960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb237b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab007beb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab007c02c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab007bf960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb24fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab007c0c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab007c02c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab007c1580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb24fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab007c0c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab007c1740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab007c1580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb24ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab007c1900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab007c1740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.18 ms
whisper_print_timings:   sample time =    65.32 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4742.95 ms /     1 runs ( 4742.95 ms per run)
whisper_print_timings:   decode time =    15.60 ms /     2 runs (    7.80 ms per run)
whisper_print_timings:   batchd time =   712.52 ms /   125 runs (    5.70 ms per run)
...
main:     load time =    90.82 ms
main:    total time = 40581.51 ms
embd_img
