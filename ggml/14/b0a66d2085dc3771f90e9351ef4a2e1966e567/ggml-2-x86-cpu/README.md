...
- status:  FAILURE ❌ (1)
- runtime: 3:19.06
- date:    Sat Feb 10 07:54:45 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  106.02 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.42 sec
...
main:  predict time =   466.62 ms / 7.29 ms per token
main:    total time =   626.79 ms
...
main:  predict time =   485.18 ms / 6.93 ms per token
main:    total time =   639.98 ms
...
main:  predict time =  1536.48 ms
main:    total time =  1850.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efe44f33990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efe44db41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x565490f48b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efe44f33030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efe44f38940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x565490f49960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efe44db41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x565490f48b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x565490f4a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x565490f49960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efe44f33030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x565490f4ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x565490f4a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x565490f4b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efe44f33990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x565490f4ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x565490f4b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x565490f4b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efe44f38940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x565490f4b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x565490f4b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.35 ms
whisper_print_timings:   sample time =    54.84 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1154.44 ms /     1 runs ( 1154.44 ms per run)
whisper_print_timings:   decode time =     9.90 ms /     2 runs (    4.95 ms per run)
whisper_print_timings:   batchd time =   211.06 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1529.76 ms
