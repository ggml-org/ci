...
- status:  FAILURE ❌ (1)
- runtime: 9:14.78
- date:    Sat Feb 10 08:09:01 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.72 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.86 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  225.76 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.67 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   40.83 sec
...
main:     load time =   607.55 ms
main:   sample time =    34.76 ms
main:  predict time =   597.28 ms / 9.33 ms per token
main:    total time =  1264.45 ms
...
main:     load time =   592.63 ms
main:   sample time =    34.23 ms
main:  predict time =   647.85 ms / 9.26 ms per token
main:    total time =  1279.47 ms
...
main:     n_decoded =      504
main:     load time =   556.61 ms
main:   sample time =   237.28 ms
main:  predict time =  2392.11 ms
main:    total time =  3230.29 ms
...
main: loaded model in   409.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1715bb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1715a371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5630acfb48b0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1715bb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1715bbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5630acfb5680                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1715a371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5630acfb48b0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5630acfb5fe0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5630acfb5680                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1715bb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5630acfb6940                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5630acfb5fe0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5630acfb72a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1715bb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5630acfb6940                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5630acfb7460                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5630acfb72a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1715bbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5630acfb7620                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5630acfb7460       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1099.90 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.21 ms
whisper_print_timings:   sample time =    66.03 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    28.85 ms /     1 runs (   28.85 ms per run)
whisper_print_timings:   decode time =    19.93 ms /     2 runs (    9.96 ms per run)
whisper_print_timings:   batchd time =    80.39 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1321.64 ms
...
main:     load time =   527.51 ms
main:    total time =  7960.16 ms
embd_img
