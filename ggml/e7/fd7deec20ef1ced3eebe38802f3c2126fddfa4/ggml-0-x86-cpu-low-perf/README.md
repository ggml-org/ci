...
- status:  SUCCESS ✅
- runtime: 1:48.70
- date:    Fri Oct  4 15:57:09 UTC 2024
...
main:  predict time =   673.31 ms / 10.52 ms per token
...
main:  predict time =   702.52 ms / 10.04 ms per token
main:    total time =   845.96 ms
...
main:   sample time =   213.25 ms
main:  predict time =  2859.14 ms
main:    total time =  3227.07 ms
