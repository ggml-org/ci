...
- status:  SUCCESS ✅
- runtime: 4:41.42
- date:    Fri Sep  8 15:29:49 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed   16.20 sec
      Start  9: test3
...
main:     load time =   221.96 ms
main:   sample time =    35.84 ms
main:  predict time =   593.61 ms / 9.28 ms per token
main:    total time =   871.65 ms
...
main:     load time =   194.09 ms
main:   sample time =    35.66 ms
main:  predict time =   591.69 ms / 8.45 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe8265ed8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe82646e160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56053a1e7ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe8265ecfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe8265f2840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56053a1e8850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe82646e160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56053a1e7ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56053a1e9170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56053a1e8850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe8265ecfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56053a1e9a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56053a1e9170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56053a1ea3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe8265ed8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56053a1e9a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56053a1ea530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56053a1ea3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe8265f2840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56053a1ea6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56053a1ea530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6692.43 ms
main:    sample time =   590.37 ms / 9.22 ms per token
main:      eval time = 24563.38 ms / 350.91 ms per token
main:     total time = 32704.68 ms
...
main:      load time =  1734.66 ms
main:    sample time =   591.28 ms / 9.24 ms per token
main:      eval time = 12281.66 ms / 175.45 ms per token
main:     total time = 15247.93 ms
