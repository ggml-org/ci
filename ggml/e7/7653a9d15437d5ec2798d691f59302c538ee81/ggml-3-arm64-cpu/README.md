...
- status:  SUCCESS ✅
- runtime: 3:38.88
- date:    Fri Sep  8 15:25:32 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/e77653a9d15437d5ec2798d691f59302c538ee81
- author:  Diogo
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.88 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.84 sec
      Start  2: test-opt
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.52 sec
...
main:     load time =   278.17 ms
main:   sample time =    17.64 ms
main:  predict time =   812.39 ms / 12.69 ms per token
main:    total time =  1130.82 ms
...
main:     load time =   184.05 ms
main:   sample time =    17.53 ms
main:  predict time =   877.30 ms / 12.53 ms per token
main:    total time =  1082.60 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f5ca8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f44b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1ad88ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f5c9fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f5cf840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1ad89850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f44b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1ad88ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1ad8a170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1ad89850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f5c9fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1ad8aa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1ad8a170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1ad8b3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f5ca8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1ad8aa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1ad8b530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1ad8b3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f5cf840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab1ad8b6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1ad8b530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12043.58 ms
main:    sample time =   619.20 ms / 9.67 ms per token
main:      eval time = 43712.63 ms / 624.47 ms per token
main:     total time = 58751.74 ms
...
main:      load time =  4359.97 ms
main:    sample time =   634.16 ms / 9.91 ms per token
main:      eval time = 17539.68 ms / 250.57 ms per token
main:     total time = 23489.85 ms
