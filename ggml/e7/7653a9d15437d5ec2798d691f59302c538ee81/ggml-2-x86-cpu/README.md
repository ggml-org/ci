...
- status:  SUCCESS ✅
- runtime: 2:47.21
- date:    Fri Sep  8 15:14:43 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.16 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.83 sec
...
main:     load time =   169.56 ms
main:   sample time =    23.42 ms
main:  predict time =   431.41 ms / 6.74 ms per token
main:    total time =   637.56 ms
...
main:  predict time =   456.40 ms / 6.52 ms per token
main:    total time =   612.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6f853d38d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6f85254160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d9167e3ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6f853d2fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6f853d8840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d9167e4850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6f85254160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d9167e3ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d9167e5170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d9167e4850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6f853d2fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d9167e5a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d9167e5170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d9167e63b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6f853d38d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d9167e5a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d9167e6530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d9167e63b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6f853d8840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d9167e66b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d9167e6530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 13213.25 ms
main:    sample time =   468.55 ms / 7.32 ms per token
main:      eval time = 20498.21 ms / 292.83 ms per token
main:     total time = 34919.78 ms
...
main:      load time =  4403.99 ms
main:    sample time =   466.78 ms / 7.29 ms per token
main:      eval time =  8304.78 ms / 118.64 ms per token
main:     total time = 13550.36 ms
