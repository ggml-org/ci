...
- status:  SUCCESS ✅
- runtime: 3:22.53
- date:    Sun Dec 24 14:15:19 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.07 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.22 sec
...
main:     load time =   124.77 ms
main:   sample time =    23.45 ms
main:  predict time =   439.59 ms / 6.87 ms per token
...
main:     load time =   128.05 ms
main:   sample time =    23.41 ms
main:  predict time =   452.41 ms / 6.46 ms per token
main:    total time =   605.99 ms
...
main:     n_decoded =      504
main:     load time =   101.51 ms
main:   sample time =   177.77 ms
main:  predict time =  1458.09 ms
main:    total time =  1769.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff8f0e0d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff8f0c8e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55623c619b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff8f0e0d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff8f0e12940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55623c61a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff8f0c8e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55623c619b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55623c61b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55623c61a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff8f0e0d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55623c61bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55623c61b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55623c61c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff8f0e0d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55623c61bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55623c61c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55623c61c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff8f0e12940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55623c61c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55623c61c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.66 ms
whisper_print_timings:   sample time =    54.78 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1155.36 ms /     1 runs ( 1155.36 ms per run)
whisper_print_timings:   decode time =     9.75 ms /     2 runs (    4.88 ms per run)
whisper_print_timings:   batchd time =   207.33 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1522.29 ms
...
main:      load time =  4416.01 ms
main:    sample time =   466.89 ms / 7.30 ms per token
main:      eval time = 19424.46 ms / 277.49 ms per token
main:     total time = 24945.22 ms
...
main:      load time =  1186.29 ms
main:    sample time =   465.94 ms / 7.28 ms per token
main:      eval time =  8147.82 ms / 116.40 ms per token
main:     total time = 10175.04 ms
