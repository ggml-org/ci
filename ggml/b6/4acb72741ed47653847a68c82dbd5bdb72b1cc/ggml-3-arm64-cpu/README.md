...
- status:  SUCCESS ✅
- runtime: 5:15.21
- date:    Sun Dec 24 02:32:53 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.38 sec
...
Total Test time (real) =  18.90 sec
...
main:     load time =   224.97 ms
main:   sample time =    17.20 ms
main:  predict time =   810.74 ms / 12.67 ms per token
main:    total time =  1074.74 ms
...
main:  predict time =   878.58 ms / 12.55 ms per token
...
main:     n_decoded =      504
main:     load time =   161.11 ms
main:   sample time =   127.33 ms
main:  predict time =  5887.89 ms
main:    total time =  6257.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5b6a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa59eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1659b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5b6a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5b6f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae165a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa59eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1659b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae165b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae165a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5b6a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae165bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae165b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae165c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5b6a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae165bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae165c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae165c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5b6f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae165c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae165c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4661.91 ms /     1 runs ( 4661.91 ms per run)
whisper_print_timings:   decode time =    15.10 ms /     2 runs (    7.55 ms per run)
whisper_print_timings:   batchd time =   706.59 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5599.68 ms
...
main:      load time =  5599.54 ms
main:    sample time =   519.02 ms / 8.11 ms per token
main:      eval time = 43568.22 ms / 622.40 ms per token
main:     total time = 52066.14 ms
...
main:      load time =  1535.86 ms
main:    sample time =   514.38 ms / 8.04 ms per token
main:      eval time = 17561.91 ms / 250.88 ms per token
main:     total time = 20604.44 ms
