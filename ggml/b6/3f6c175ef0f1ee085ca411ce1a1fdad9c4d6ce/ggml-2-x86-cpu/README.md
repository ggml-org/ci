...
- status:  SUCCESS ✅
- runtime: 4:28.62
- date:    Fri Jan  5 14:33:07 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   26.74 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.44 sec
...
main:     load time =   176.54 ms
main:   sample time =    23.49 ms
main:  predict time =   449.88 ms / 7.03 ms per token
main:    total time =   662.99 ms
...
main:  predict time =   468.68 ms / 6.70 ms per token
main:    total time =   619.06 ms
...
main:  predict time =  1501.95 ms
main:    total time =  1816.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5aa0b53990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5aa09d41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5603756d6b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5aa0b53030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5aa0b58940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5603756d7960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5aa09d41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5603756d6b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5603756d82c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5603756d7960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5aa0b53030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5603756d8c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5603756d82c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5603756d9580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5aa0b53990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5603756d8c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5603756d9740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5603756d9580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5aa0b58940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5603756d9900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5603756d9740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1162.10 ms /     1 runs ( 1162.10 ms per run)
whisper_print_timings:   decode time =     9.34 ms /     2 runs (    4.67 ms per run)
whisper_print_timings:   batchd time =   208.22 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1585.53 ms
...
main:     load time =    63.98 ms
main:    total time = 10639.28 ms
embd_img
...
main:      load time =  5762.65 ms
main:    sample time =   466.29 ms / 7.29 ms per token
main:      eval time = 21185.92 ms / 302.66 ms per token
main:     total time = 28108.50 ms
...
main:      load time =  1351.53 ms
main:    sample time =   465.47 ms / 7.27 ms per token
main:      eval time =  9562.19 ms / 136.60 ms per token
main:     total time = 11731.97 ms
