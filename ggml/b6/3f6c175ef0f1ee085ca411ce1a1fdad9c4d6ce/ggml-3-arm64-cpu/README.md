...
- status:  SUCCESS ✅
- runtime: 7:06.80
- date:    Fri Jan  5 02:35:45 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b63f6c175ef0f1ee085ca411ce1a1fdad9c4d6ce
- author:  Georgi Gerganov
```
metal : switch back to default.metallib
...
20/20 Test #20: test-backend-ops .................   Passed   34.76 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.23 sec
...
main:     load time =   206.96 ms
main:   sample time =    16.95 ms
main:  predict time =   824.28 ms / 12.88 ms per token
main:    total time =  1070.96 ms
...
main:     load time =   179.06 ms
main:   sample time =    16.93 ms
main:  predict time =   901.83 ms / 12.88 ms per token
main:    total time =  1100.71 ms
...
main:     n_decoded =      504
main:     load time =   149.13 ms
main:   sample time =   128.01 ms
main:  predict time =  5989.74 ms
main:    total time =  6348.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a24a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9a0cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4b28b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a24a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a24f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac4b29960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9a0cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4b28b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac4b2a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac4b29960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a24a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac4b2ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac4b2a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac4b2b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a24a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac4b2ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac4b2b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac4b2b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a24f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac4b2b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac4b2b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   191.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    65.46 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4633.31 ms /     1 runs ( 4633.31 ms per run)
whisper_print_timings:   decode time =    14.99 ms /     2 runs (    7.50 ms per run)
whisper_print_timings:   batchd time =   705.76 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5629.29 ms
...
main:     load time =    84.07 ms
main:    total time = 39732.69 ms
embd_img
...
main:      load time =  5885.85 ms
main:    sample time =   518.12 ms / 8.10 ms per token
main:      eval time = 43697.41 ms / 624.25 ms per token
main:     total time = 52472.40 ms
...
main:      load time =  1555.35 ms
main:    sample time =   521.04 ms / 8.14 ms per token
main:      eval time = 17447.38 ms / 249.25 ms per token
main:     total time = 20503.81 ms
