...
- status:  SUCCESS ✅
- runtime: 4:30.87
- date:    Fri Jan  5 14:33:06 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.37 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test2 ............................   Passed   10.01 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.72 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.00 sec
      Start 11: test-conv-transpose
11/20 Test #11: test-conv-transpose ..............   Passed    0.00 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    7.96 sec
...
main:     load time =   126.78 ms
main:   sample time =    23.47 ms
main:  predict time =   617.09 ms / 9.64 ms per token
main:    total time =   780.03 ms
...
main:     load time =   125.30 ms
main:   sample time =    23.42 ms
main:  predict time =   650.35 ms / 9.29 ms per token
main:    total time =   801.27 ms
...
main:  predict time =  2501.45 ms
main:    total time =  2831.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9605feb990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9605e6c1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5567a4b10b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9605feb030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9605ff0940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5567a4b11960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9605e6c1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5567a4b10b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5567a4b122c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5567a4b11960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9605feb030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5567a4b12c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5567a4b122c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5567a4b13580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9605feb990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5567a4b12c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5567a4b13740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5567a4b13580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9605ff0940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5567a4b13900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5567a4b13740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.06 ms
whisper_print_timings:   sample time =    75.64 ms /   131 runs (    0.58 ms per run)
whisper_print_timings:   encode time =  1985.20 ms /     1 runs ( 1985.20 ms per run)
whisper_print_timings:   decode time =    12.74 ms /     2 runs (    6.37 ms per run)
whisper_print_timings:   batchd time =   323.82 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2499.67 ms
...
main:     load time =    69.22 ms
main:    total time = 18946.11 ms
embd_img
