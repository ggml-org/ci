...
- status:  SUCCESS ✅
- runtime: 3:08.75
- date:    Fri May 17 15:15:30 UTC 2024
...
main:  predict time =   899.64 ms / 14.06 ms per token
...
main:     load time =   144.69 ms
main:   sample time =    17.38 ms
main:  predict time =   982.71 ms / 14.04 ms per token
main:    total time =  1147.39 ms
...
main:     load time =   175.32 ms
main:   sample time =    17.40 ms
main:  predict time =  1005.25 ms / 14.36 ms per token
main:    total time =  1201.15 ms
...
main:     n_decoded =      504
main:     load time =   146.80 ms
main:   sample time =   129.17 ms
main:  predict time =  6428.49 ms
main:    total time =  6786.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe011e5caa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe011e5b2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb3c12dd07ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe011e5caa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe011e5caf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb3c12dd08ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe011e5b2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb3c12dd07ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb3c12dd09410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb3c12dd08ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe011e5caa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb3c12dd09d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb3c12dd09410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb3c12dd0a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe011e5caa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb3c12dd09d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb3c12dd0a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb3c12dd0a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe011e5caf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb3c12dd0aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb3c12dd0a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    66.89 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4652.88 ms /     1 runs ( 4652.88 ms per run)
whisper_print_timings:   decode time =    13.67 ms /     2 runs (    6.83 ms per run)
whisper_print_timings:   batchd time =   712.74 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5579.49 ms
