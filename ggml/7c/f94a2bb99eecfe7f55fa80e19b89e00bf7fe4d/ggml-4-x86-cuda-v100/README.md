...
- status:  SUCCESS ✅
- runtime: 10:30.12
- date:    Fri May 17 15:35:33 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.61 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   37.08 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.99 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.05 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   20.50 sec
      Start  9: test3
...
23/23 Test #23: test-backend-ops .................   Passed   41.11 sec
...
main:     load time =   200.06 ms
main:   sample time =    34.56 ms
main:  predict time =   642.56 ms / 10.04 ms per token
main:    total time =   900.74 ms
...
main:  predict time =   680.43 ms / 9.72 ms per token
main:    total time =   873.32 ms
...
main:     load time =   187.27 ms
main:   sample time =    34.94 ms
main:  predict time =   723.61 ms / 10.34 ms per token
main:    total time =   951.09 ms
...
main:     n_decoded =      504
main:     load time =   168.33 ms
main:   sample time =   235.59 ms
main:  predict time =  2943.15 ms
main:    total time =  3394.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3abf4fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3abf37b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564a2afc7af0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3abf4fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3abf4ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564a2afc88c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3abf37b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564a2afc7af0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564a2afc9220                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564a2afc88c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3abf4fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564a2afc9b80                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564a2afc9220                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564a2afca4e0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3abf4fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564a2afc9b80                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564a2afca6a0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564a2afca4e0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3abf4ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564a2afca860                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564a2afca6a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1103.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.14 ms
whisper_print_timings:   sample time =    68.19 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    48.21 ms /     1 runs (   48.21 ms per run)
whisper_print_timings:   decode time =    12.24 ms /     2 runs (    6.12 ms per run)
whisper_print_timings:   batchd time =    80.17 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1341.03 ms
