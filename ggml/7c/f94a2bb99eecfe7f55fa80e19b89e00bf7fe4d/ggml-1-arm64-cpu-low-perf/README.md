...
- status:  SUCCESS ✅
- runtime: 4:07.58
- date:    Fri May 17 15:09:45 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/7cf94a2bb99eecfe7f55fa80e19b89e00bf7fe4d
- author:  Andrei
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.82 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.54 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.46 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.47 sec
      Start  9: test3
 9/22 Test  #9: test3 ............................   Passed    1.61 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.46 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   17.46 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.92 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.53 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    1.79 sec
      Start  6: test0
...
main:     load time =   141.89 ms
main:   sample time =    17.30 ms
main:  predict time =   899.09 ms / 14.05 ms per token
main:    total time =  1079.67 ms
...
main:     load time =   139.20 ms
main:   sample time =    17.17 ms
main:  predict time =   981.52 ms / 14.02 ms per token
main:    total time =  1140.50 ms
...
main:  predict time =  1049.70 ms / 15.00 ms per token
main:    total time =  1238.74 ms
...
main:     n_decoded =      504
main:     load time =   142.86 ms
main:   sample time =   127.31 ms
main:  predict time =  6443.60 ms
main:    total time =  6795.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf0e5e807a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf0e5e7efb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbc9ea4f9ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf0e5e807a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf0e5e807f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbc9ea4f9fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf0e5e7efb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbc9ea4f9ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbc9ea4fa0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbc9ea4f9fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf0e5e807a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbc9ea4fa0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbc9ea4fa0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbc9ea4fa16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf0e5e807a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbc9ea4fa0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbc9ea4fa1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbc9ea4fa16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf0e5e807f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbc9ea4fa1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbc9ea4fa1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    98.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.27 ms
whisper_print_timings:   sample time =    65.28 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4646.03 ms /     1 runs ( 4646.03 ms per run)
whisper_print_timings:   decode time =    13.74 ms /     2 runs (    6.87 ms per run)
whisper_print_timings:   batchd time =   708.53 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5562.36 ms
...
main:     load time =    86.94 ms
main:    total time = 39956.85 ms
embd_img
