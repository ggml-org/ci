...
- status:  SUCCESS ✅
- runtime: 4:14.31
- date:    Sat Feb 24 16:31:51 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/7c531538b3de534a52cd87b1dfe0af99c7d70058
- author:  UEXTM.com
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.96 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.24 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.20 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   81.93 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 123.83 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.52 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.35 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   16.96 sec
...
main:     load time =   115.05 ms
main:   sample time =    23.54 ms
main:  predict time =   703.37 ms / 10.99 ms per token
main:    total time =   854.98 ms
...
main:     load time =   108.04 ms
main:   sample time =    23.61 ms
main:  predict time =   741.76 ms / 10.60 ms per token
main:    total time =   875.52 ms
...
main:  predict time =   753.87 ms / 10.77 ms per token
main:    total time =   909.87 ms
...
main:     n_decoded =      504
main:     load time =   108.08 ms
main:   sample time =   178.17 ms
main:  predict time =  3100.39 ms
main:    total time =  3432.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f15501a9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f155002a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e97516dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f15501a9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f15501ae940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e97516eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f155002a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e97516dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e97516f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e97516eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f15501a9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e97516fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e97516f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e9751706d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f15501a9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e97516fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e975170890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e9751706d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f15501ae940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e975170a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e975170890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.15 ms
whisper_print_timings:   sample time =    72.32 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2049.67 ms /     1 runs ( 2049.67 ms per run)
whisper_print_timings:   decode time =    15.99 ms /     2 runs (    8.00 ms per run)
whisper_print_timings:   batchd time =   330.47 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2571.46 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.474000 sec.)
