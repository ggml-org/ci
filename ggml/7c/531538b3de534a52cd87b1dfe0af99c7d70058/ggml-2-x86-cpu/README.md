...
- status:  SUCCESS ✅
- runtime: 2:56.45
- date:    Sat Feb 24 16:30:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    4.23 sec
...
20/20 Test #20: test-backend-ops .................   Passed   81.00 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.34 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.67 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.28 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.21 sec
 ...
 8/21 Test  #8: test1 ............................   Passed    0.00 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    0.03 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   19.18 sec
...
main:  predict time =   487.64 ms / 7.62 ms per token
main:    total time =   629.63 ms
...
main:     load time =   108.27 ms
main:   sample time =    23.43 ms
main:  predict time =   506.89 ms / 7.24 ms per token
main:    total time =   640.68 ms
...
main:     load time =   126.60 ms
main:   sample time =    23.51 ms
main:  predict time =   517.72 ms / 7.40 ms per token
main:    total time =   670.34 ms
...
main:     n_decoded =      504
main:     load time =   105.99 ms
main:   sample time =   177.97 ms
main:  predict time =  1801.05 ms
main:    total time =  2118.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f522c211990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f522c0921a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563f1b8dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f522c211030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f522c216940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5563f1b8eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f522c0921a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563f1b8dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5563f1b8f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5563f1b8eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f522c211030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5563f1b8fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5563f1b8f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5563f1b906d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f522c211990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5563f1b8fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5563f1b90890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5563f1b906d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f522c216940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5563f1b90a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5563f1b90890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.59 ms
whisper_print_timings:   sample time =    54.91 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1180.46 ms /     1 runs ( 1180.46 ms per run)
whisper_print_timings:   decode time =    12.39 ms /     2 runs (    6.20 ms per run)
whisper_print_timings:   batchd time =   212.92 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1557.15 ms
...
main:     load time =    66.35 ms
main:    total time = 10679.53 ms
embd_img
