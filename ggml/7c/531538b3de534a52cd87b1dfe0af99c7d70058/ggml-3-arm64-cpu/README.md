...
- status:  SUCCESS ✅
- runtime: 4:09.80
- date:    Sat Feb 24 16:31:53 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.09 sec
...
20/20 Test #20: test-backend-ops .................   Passed   98.09 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 116.02 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    2.90 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.18 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.85 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.15 sec
...
main:  predict time =   892.11 ms / 13.94 ms per token
main:    total time =  1078.60 ms
...
main:  predict time =   970.27 ms / 13.86 ms per token
main:    total time =  1142.09 ms
...
main:     load time =   177.29 ms
main:   sample time =    16.98 ms
main:  predict time =   981.96 ms / 14.03 ms per token
main:    total time =  1179.38 ms
...
main:  predict time =  6470.82 ms
main:    total time =  6833.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb62da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb615b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf18aece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb62da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb62df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf18afab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb615b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf18aece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf18b0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf18afab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb62da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf18b0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf18b0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf18b16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb62da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf18b0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf18b1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf18b16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb62df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf18b1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf18b1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.41 ms
whisper_print_timings:   sample time =    65.94 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4677.58 ms /     1 runs ( 4677.58 ms per run)
whisper_print_timings:   decode time =    15.33 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   707.86 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5590.20 ms
