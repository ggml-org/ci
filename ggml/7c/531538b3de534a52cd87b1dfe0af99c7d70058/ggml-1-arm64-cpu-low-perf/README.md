...
- status:  SUCCESS ✅
- runtime: 5:11.78
- date:    Sat Feb 24 04:32:59 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.53 sec
...
20/20 Test #20: test-backend-ops .................   Passed  101.45 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 144.32 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    4.33 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.43 sec
      Start  3: test-quantize-perf
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.35 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.52 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   20.67 sec
...
main:     load time =   163.74 ms
main:   sample time =    24.89 ms
main:  predict time =   944.39 ms / 14.76 ms per token
main:    total time =  1154.78 ms
...
main:  predict time =  1137.85 ms / 16.26 ms per token
main:    total time =  1325.52 ms
...
main:  predict time =  1014.59 ms / 14.49 ms per token
main:    total time =  1227.25 ms
...
main:     n_decoded =      504
main:     load time =   165.20 ms
main:   sample time =   132.17 ms
main:  predict time =  6706.22 ms
main:    total time =  7086.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbf4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbbdcb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec271ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbf4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbf4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec272ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbbdcb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec271ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec273410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec272ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbf4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec273d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec273410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec2746d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbf4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec273d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec274890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec2746d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbf4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaec274a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec274890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.47 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.66 ms
whisper_print_timings:   sample time =    66.83 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4850.49 ms /     1 runs ( 4850.49 ms per run)
whisper_print_timings:   decode time =    15.76 ms /     2 runs (    7.88 ms per run)
whisper_print_timings:   batchd time =   716.72 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5783.61 ms
...
main:     load time =    93.24 ms
main:    total time = 40859.95 ms
embd_img
