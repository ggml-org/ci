...
- status:  SUCCESS ✅
- runtime: 2:43.65
- date:    Tue Aug 29 12:37:56 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/7c8a87690c363ea34ed15a2f912e669b92aeddde
- author:  Cebtenzzre
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.71 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.61 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.27 sec
...
main:  predict time =   452.15 ms / 7.06 ms per token
main:    total time =   679.74 ms
...
main:     load time =   136.11 ms
main:   sample time =    23.74 ms
main:  predict time =   460.90 ms / 6.58 ms per token
main:    total time =   623.43 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f01367768a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f01365f7150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b3ffe1ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0136775f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f013677b800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555b3ffe2830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f01365f7150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b3ffe1ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555b3ffe3140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555b3ffe2830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0136775f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555b3ffe3a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555b3ffe3140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555b3ffe4360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f01367768a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555b3ffe3a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555b3ffe44d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555b3ffe4360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f013677b800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555b3ffe4640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555b3ffe44d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11093.73 ms
main:    sample time =   471.71 ms / 7.37 ms per token
main:      eval time = 20378.50 ms / 291.12 ms per token
main:     total time = 32614.94 ms
...
main:      load time =  4398.41 ms
main:    sample time =   468.49 ms / 7.32 ms per token
main:      eval time =  8086.06 ms / 115.52 ms per token
main:     total time = 13333.68 ms
