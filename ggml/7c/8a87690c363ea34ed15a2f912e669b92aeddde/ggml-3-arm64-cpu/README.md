...
- status:  SUCCESS ✅
- runtime: 3:40.81
- date:    Tue Aug 29 12:38:45 UTC 2023
...
main:     load time =   257.19 ms
main:   sample time =    17.40 ms
main:  predict time =   809.36 ms / 12.65 ms per token
main:    total time =  1106.86 ms
...
main:     load time =   184.50 ms
main:   sample time =    17.43 ms
main:  predict time =   877.92 ms / 12.54 ms per token
main:    total time =  1083.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb046a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb02eb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac3f9cab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0469f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb046f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac3f9d830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb02eb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac3f9cab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac3f9e140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac3f9d830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0469f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac3f9ea50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac3f9e140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac3f9f360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb046a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac3f9ea50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac3f9f4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac3f9f360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb046f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac3f9f640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac3f9f4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11314.95 ms
main:    sample time =   620.84 ms / 9.70 ms per token
main:      eval time = 43855.58 ms / 626.51 ms per token
main:     total time = 58179.59 ms
...
main:      load time =  4128.08 ms
main:    sample time =   619.12 ms / 9.67 ms per token
main:      eval time = 17335.73 ms / 247.65 ms per token
main:     total time = 23042.67 ms
