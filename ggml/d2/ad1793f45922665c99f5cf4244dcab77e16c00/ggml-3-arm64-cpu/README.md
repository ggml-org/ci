...
- status:  SUCCESS ✅
- runtime: 3:13.99
- date:    Sat May 11 18:33:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.17 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    3.09 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.17 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   20.56 sec
...
main:     load time =   152.81 ms
main:   sample time =    17.62 ms
main:  predict time =   891.33 ms / 13.93 ms per token
...
main:  predict time =   973.31 ms / 13.90 ms per token
main:    total time =  1145.67 ms
...
main:     load time =   179.24 ms
main:   sample time =    17.49 ms
main:  predict time =  1019.86 ms / 14.57 ms per token
main:    total time =  1219.88 ms
...
main:  predict time =  6430.55 ms
main:    total time =  6793.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae6da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae55b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf49e8ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae6da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae6df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf49e9ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae55b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf49e8ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf49ea410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf49e9ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae6da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf49ead70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf49ea410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf49eb6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae6da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf49ead70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf49eb890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf49eb6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae6df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf49eba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf49eb890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.73 ms
whisper_print_timings:   sample time =   740.30 ms /   131 runs (    5.65 ms per run)
whisper_print_timings:   encode time =  4698.43 ms /     1 runs ( 4698.43 ms per run)
whisper_print_timings:   decode time =    15.54 ms /     2 runs (    7.77 ms per run)
whisper_print_timings:   batchd time =   710.79 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6286.55 ms
