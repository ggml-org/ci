...
- status:  SUCCESS ✅
- runtime: 4:08.53
- date:    Sat May 11 18:34:25 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.83 sec
      Start  9: test3
...
main:  predict time =   910.40 ms / 14.23 ms per token
main:    total time =  1110.26 ms
...
main:     load time =   189.58 ms
main:   sample time =    17.51 ms
main:  predict time =  1037.44 ms / 14.82 ms per token
main:    total time =  1247.97 ms
...
main:     n_decoded =      504
main:     load time =   161.13 ms
main:   sample time =   128.93 ms
main:  predict time =  6517.90 ms
main:    total time =  6895.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ac6a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8aaeb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaace250ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ac6a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ac6f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaace251ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8aaeb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaace250ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaace252410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaace251ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ac6a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaace252d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaace252410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaace2536d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ac6a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaace252d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaace253890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaace2536d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ac6f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaace253a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaace253890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.53 ms
whisper_print_timings:   sample time =   729.62 ms /   131 runs (    5.57 ms per run)
whisper_print_timings:   encode time =  4708.77 ms /     1 runs ( 4708.77 ms per run)
...
whisper_print_timings:    total time =  6298.43 ms
