...
- status:  FAILURE ❌ (1)
- runtime: 2:14.06
- date:    Sat May 11 18:32:39 UTC 2024
...
main:  predict time =   489.18 ms / 7.64 ms per token
main:    total time =   627.40 ms
...
main:  predict time =   519.93 ms / 7.43 ms per token
main:    total time =   648.57 ms
...
main:  predict time =  1846.97 ms
main:    total time =  2159.15 ms
