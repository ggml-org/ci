...
- status:  SUCCESS ✅
- runtime: 3:55.17
- date:    Sat Dec 23 15:57:14 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.32 sec
...
main:     load time =   179.21 ms
main:   sample time =    23.50 ms
main:  predict time =   431.91 ms / 6.75 ms per token
main:    total time =   647.74 ms
...
main:     load time =   122.93 ms
main:   sample time =    23.39 ms
main:  predict time =   450.94 ms / 6.44 ms per token
main:    total time =   599.34 ms
...
main:  predict time =  1469.80 ms
main:    total time =  1777.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f355df36990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f355ddb71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d92a26fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f355df36030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f355df3b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d92a270960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f355ddb71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d92a26fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d92a2712c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d92a270960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f355df36030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d92a271c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d92a2712c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d92a272580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f355df36990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d92a271c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d92a272740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d92a272580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f355df3b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d92a272900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d92a272740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.44 ms
whisper_print_timings:   sample time =    54.44 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1154.17 ms /     1 runs ( 1154.17 ms per run)
...
whisper_print_timings:    total time =  1568.53 ms
...
main:     load time =    60.33 ms
main:    total time = 10590.84 ms
embd_img
...
main:      load time = 10563.68 ms
main:    sample time =   468.77 ms / 7.32 ms per token
main:      eval time = 20258.96 ms / 289.41 ms per token
main:     total time = 31954.37 ms
...
main:      load time =  3597.30 ms
main:    sample time =   466.00 ms / 7.28 ms per token
main:      eval time =  8076.20 ms / 115.37 ms per token
main:     total time = 12514.09 ms
