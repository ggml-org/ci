...
- status:  SUCCESS ✅
- runtime: 2:49.72
- date:    Sat Dec 23 15:53:05 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.59 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.82 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.76 sec
...
main:  predict time =   603.03 ms / 9.42 ms per token
main:    total time =   764.55 ms
...
main:  predict time =   633.95 ms / 9.06 ms per token
main:    total time =   785.93 ms
...
main:  predict time =  2369.61 ms
main:    total time =  2696.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc08b5f8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc08b4791a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b24fe10b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc08b5f8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc08b5fd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b24fe11960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc08b4791a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b24fe10b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b24fe122c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b24fe11960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc08b5f8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b24fe12c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b24fe122c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b24fe13580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc08b5f8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b24fe12c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b24fe13740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b24fe13580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc08b5fd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b24fe13900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b24fe13740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.05 ms
whisper_print_timings:   sample time =    71.72 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1989.86 ms /     1 runs ( 1989.86 ms per run)
whisper_print_timings:   decode time =    12.88 ms /     2 runs (    6.44 ms per run)
whisper_print_timings:   batchd time =   324.51 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.95 ms
...
main:     load time =    73.14 ms
main:    total time = 18795.34 ms
embd_img
