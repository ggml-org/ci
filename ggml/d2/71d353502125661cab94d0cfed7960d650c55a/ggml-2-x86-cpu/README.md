...
- status:  SUCCESS ✅
- runtime: 2:46.89
- date:    Thu Nov  2 19:31:08 UTC 2023
...
main:  predict time =   438.94 ms / 6.86 ms per token
main:    total time =   601.66 ms
...
main:   sample time =   177.55 ms
main:  predict time =  1477.82 ms
main:    total time =  1787.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f623126a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f62310eb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555bee3d3b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6231269fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f623126f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555bee3d4900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f62310eb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555bee3d3b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555bee3d5230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555bee3d4900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6231269fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555bee3d5b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555bee3d5230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555bee3d6490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f623126a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555bee3d5b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555bee3d6620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555bee3d6490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f623126f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555bee3d67b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555bee3d6620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    87.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.14 ms
whisper_print_timings:   sample time =    16.38 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1141.63 ms /     1 runs ( 1141.63 ms per run)
whisper_print_timings:   decode time =    95.94 ms /    27 runs (    3.55 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1391.98 ms
...
main:      load time =  4290.97 ms
main:    sample time =   466.85 ms / 7.29 ms per token
main:      eval time = 19166.05 ms / 273.80 ms per token
main:     total time = 24573.91 ms
...
main:      load time =  1230.43 ms
main:    sample time =   465.41 ms / 7.27 ms per token
main:      eval time =  8100.63 ms / 115.72 ms per token
main:     total time = 10176.34 ms
