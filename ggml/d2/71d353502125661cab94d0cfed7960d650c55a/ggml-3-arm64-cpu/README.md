...
- status:  SUCCESS ✅
- runtime: 4:47.45
- date:    Thu Nov  2 07:43:46 PM UTC 2023
...
main:     load time =   267.50 ms
main:   sample time =    16.83 ms
main:  predict time =   807.77 ms / 12.62 ms per token
main:    total time =  1115.36 ms
...
main:     load time =   176.95 ms
main:   sample time =    17.01 ms
main:  predict time =   877.58 ms / 12.54 ms per token
main:    total time =  1074.36 ms
...
main:  predict time =  5858.63 ms
main:    total time =  6205.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8160a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8148b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabbc16b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81609fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8160f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabbc17900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8148b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabbc16b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabbc18230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabbc17900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81609fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabbc18b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabbc18230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabbc19490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8160a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabbc18b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabbc19620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabbc19490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8160f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaabbc197b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabbc19620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   189.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.33 ms
whisper_print_timings:   sample time =    20.82 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4603.93 ms /     1 runs ( 4603.93 ms per run)
whisper_print_timings:   decode time =   179.14 ms /    27 runs (    6.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5052.05 ms
...
main:     load time =    77.53 ms
main:    total time = 39337.64 ms
embd_img
...
main:      load time = 12361.88 ms
main:    sample time =   534.96 ms / 8.36 ms per token
main:      eval time = 43428.04 ms / 620.40 ms per token
main:     total time = 58695.76 ms
...
main:      load time =  4363.47 ms
main:    sample time =   524.94 ms / 8.20 ms per token
main:      eval time = 17393.79 ms / 248.48 ms per token
main:     total time = 23242.25 ms
