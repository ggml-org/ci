...
- status:  SUCCESS ✅
- runtime: 2:34.28
- date:    Thu Nov  2 07:31:01 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.99 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.64 sec
      Start  9: test3
...
main:     load time =   190.48 ms
main:   sample time =    17.73 ms
main:  predict time =   983.73 ms / 15.37 ms per token
main:    total time =  1213.99 ms
...
main:     load time =   192.25 ms
main:   sample time =    17.72 ms
main:  predict time =   928.88 ms / 13.27 ms per token
main:    total time =  1141.74 ms
...
main:     n_decoded =      504
main:     load time =   165.53 ms
main:   sample time =   127.87 ms
main:  predict time =  6049.44 ms
main:    total time =  6424.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa721a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa709b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad581ab60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7219fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa721f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad581b900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa709b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad581ab60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad581c230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad581b900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7219fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad581cb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad581c230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad581d490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa721a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad581cb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad581d620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad581d490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa721f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad581d7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad581d620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   119.15 ms
...
whisper_print_timings:   decode time =   182.50 ms /    27 runs (    6.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5111.01 ms
...
main:     load time =    91.62 ms
main:    total time = 39995.71 ms
embd_img
