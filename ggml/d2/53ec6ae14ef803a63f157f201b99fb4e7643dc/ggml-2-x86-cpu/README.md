...
- status:  FAILURE ❌ (1)
- runtime: 3:36.85
- date:    Sat Feb 10 07:51:07 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/d253ec6ae14ef803a63f157f201b99fb4e7643dc
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.40 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    2.25 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  106.43 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 119.07 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.29 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   18.31 sec
...
main:  predict time =   468.09 ms / 7.31 ms per token
main:    total time =   628.49 ms
...
main:  predict time =   484.31 ms / 6.92 ms per token
main:    total time =   635.41 ms
...
main:     n_decoded =      504
main:     load time =   102.66 ms
main:   sample time =   177.89 ms
main:  predict time =  1531.99 ms
main:    total time =  1842.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f22e49f1990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f22e48721a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fe0f70bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f22e49f1030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f22e49f6940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fe0f70c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f22e48721a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fe0f70bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fe0f70d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fe0f70c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f22e49f1030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fe0f70dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fe0f70d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fe0f70e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f22e49f1990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fe0f70dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fe0f70e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fe0f70e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f22e49f6940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55fe0f70e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fe0f70e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.56 ms
whisper_print_timings:   sample time =    55.52 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1152.47 ms /     1 runs ( 1152.47 ms per run)
whisper_print_timings:   decode time =     9.78 ms /     2 runs (    4.89 ms per run)
whisper_print_timings:   batchd time =   211.95 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1528.83 ms
...
main:     load time =    64.81 ms
main:    total time = 10593.94 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.454000 sec.)
