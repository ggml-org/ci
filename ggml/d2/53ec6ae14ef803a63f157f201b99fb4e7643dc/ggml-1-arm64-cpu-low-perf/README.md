...
- status:  SUCCESS ✅
- runtime: 5:56.89
- date:    Sat Feb 10 07:52:32 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  148.28 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   23.00 sec
...
main:  predict time =   859.84 ms / 13.44 ms per token
main:    total time =  1088.46 ms
...
main:     load time =   188.01 ms
main:   sample time =    17.17 ms
main:  predict time =   945.80 ms / 13.51 ms per token
main:    total time =  1154.13 ms
...
main:  predict time =  6119.53 ms
main:    total time =  6488.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9844a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff982cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf0c85b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9844a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9844f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf0c86960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff982cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf0c85b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf0c872c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf0c86960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9844a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf0c87c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf0c872c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf0c88580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9844a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf0c87c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf0c88740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf0c88580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9844f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf0c88900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf0c88740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.36 ms
whisper_print_timings:   sample time =    65.69 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4644.84 ms /     1 runs ( 4644.84 ms per run)
whisper_print_timings:   decode time =    15.75 ms /     2 runs (    7.87 ms per run)
whisper_print_timings:   batchd time =   840.69 ms /   125 runs (    6.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5697.01 ms
...
main:     load time =    90.73 ms
main:    total time = 40684.73 ms
embd_img
