...
- status:  SUCCESS ✅
- runtime: 4:39.95
- date:    Sat Feb 10 07:51:13 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  106.55 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 144.46 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.54 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.81 sec
...
main:     load time =   130.77 ms
main:   sample time =    23.59 ms
main:  predict time =   648.44 ms / 10.13 ms per token
main:    total time =   815.73 ms
...
main:  predict time =   670.04 ms / 9.57 ms per token
main:    total time =   826.63 ms
...
main:   sample time =   178.37 ms
main:  predict time =  2521.27 ms
main:    total time =  2852.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fecf1173990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fecf0ff41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5626d39d1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fecf1173030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fecf1178940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5626d39d2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fecf0ff41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5626d39d1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5626d39d32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5626d39d2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fecf1173030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5626d39d3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5626d39d32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5626d39d4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fecf1173990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5626d39d3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5626d39d4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5626d39d4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fecf1178940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5626d39d4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5626d39d4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.92 ms
whisper_print_timings:   sample time =    72.24 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1985.43 ms /     1 runs ( 1985.43 ms per run)
...
whisper_print_timings:    total time =  2498.89 ms
