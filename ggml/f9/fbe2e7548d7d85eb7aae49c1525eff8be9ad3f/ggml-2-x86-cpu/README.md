...
- status:  SUCCESS ✅
- runtime: 2:18.94
- date:    Tue Aug 22 09:04:57 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.56 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.34 sec
...
main:     load time =   131.14 ms
main:   sample time =    23.58 ms
main:  predict time =   424.08 ms / 6.63 ms per token
main:    total time =   614.44 ms
...
main: mem per token =  2017572 bytes
main:     load time =   130.45 ms
main:   sample time =    23.54 ms
main:  predict time =   432.27 ms / 6.18 ms per token
main:    total time =   610.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4ef81ce8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4ef804f150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555663ed4ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4ef81cdf90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4ef81d3800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555663ed5830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4ef804f150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555663ed4ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555663ed6140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555663ed5830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4ef81cdf90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555663ed6a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555663ed6140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555663ed7360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4ef81ce8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555663ed6a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555663ed74d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555663ed7360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4ef81d3800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555663ed7640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555663ed74d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4370.89 ms
main:    sample time =   460.04 ms / 7.19 ms per token
main:      eval time = 19079.04 ms / 272.56 ms per token
main:     total time = 24549.79 ms
...
main:    sample time =   458.89 ms / 7.17 ms per token
main:      eval time =  8075.89 ms / 115.37 ms per token
main:     total time = 10123.08 ms
