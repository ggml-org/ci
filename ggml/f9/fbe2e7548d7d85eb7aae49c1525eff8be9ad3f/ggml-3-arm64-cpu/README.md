...
- status:  SUCCESS ✅
- runtime: 3:21.61
- date:    Tue Aug 22 09:05:46 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f9fbe2e7548d7d85eb7aae49c1525eff8be9ad3f
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.55 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.45 sec
      Start  2: test-opt
...
main:     load time =   176.09 ms
main:   sample time =    17.62 ms
main:  predict time =   802.37 ms / 12.54 ms per token
main:    total time =  1064.36 ms
...
main: mem per token =  2017572 bytes
main:     load time =   169.95 ms
main:   sample time =    17.54 ms
main:  predict time =   873.65 ms / 12.48 ms per token
main:    total time =  1110.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0bba8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0a3b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5fecab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0bb9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0bbf800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf5fed830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0a3b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5fecab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf5fee140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf5fed830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0bb9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf5feea50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf5fee140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf5fef360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0bba8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf5feea50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf5fef4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf5fef360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0bbf800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf5fef640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf5fef4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5466.39 ms
main:    sample time =   606.69 ms / 9.48 ms per token
main:      eval time = 44103.83 ms / 630.05 ms per token
main:     total time = 52564.26 ms
...
main:      load time =  1712.68 ms
main:    sample time =   617.05 ms / 9.64 ms per token
main:      eval time = 17393.41 ms / 248.48 ms per token
main:     total time = 20693.96 ms
