...
- status:  SUCCESS ✅
- runtime: 4:39.23
- date:    Tue Aug 22 09:07:08 UTC 2023
...
main:     load time =   186.78 ms
main:   sample time =    35.44 ms
main:  predict time =   552.51 ms / 8.63 ms per token
main:    total time =   827.94 ms
...
main: mem per token =  2017572 bytes
main:     load time =   194.36 ms
main:   sample time =    34.40 ms
main:  predict time =   565.41 ms / 8.08 ms per token
main:    total time =   831.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f55806138a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5580494150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5566fae16ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5580612f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5580618800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5566fae17830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5580494150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5566fae16ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5566fae18140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5566fae17830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5580612f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5566fae18a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5566fae18140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5566fae19360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f55806138a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5566fae18a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5566fae194d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5566fae19360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5580618800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5566fae19640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5566fae194d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6414.35 ms
main:    sample time =   585.49 ms / 9.15 ms per token
main:      eval time = 23989.62 ms / 342.71 ms per token
main:     total time = 31814.32 ms
...
main:      load time =  1723.04 ms
main:    sample time =   574.16 ms / 8.97 ms per token
main:      eval time = 12015.29 ms / 171.65 ms per token
main:     total time = 14933.25 ms
