...
- status:  SUCCESS ✅
- runtime: 4:14.84
- date:    Wed Feb 21 14:33:20 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.88 sec
...
20/20 Test #20: test-backend-ops .................   Passed   83.50 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.64 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.29 sec
      Start  3: test-quantize-perf
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   16.91 sec
...
main:  predict time =   695.84 ms / 10.87 ms per token
main:    total time =   838.46 ms
...
main:  predict time =   742.41 ms / 10.61 ms per token
...
main:  predict time =   742.58 ms / 10.61 ms per token
main:    total time =   895.05 ms
...
main:  predict time =  3092.62 ms
main:    total time =  3420.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f41f9378990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f41f91f91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ef78504ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f41f9378030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f41f937d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ef78505ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f41f91f91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ef78504ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ef78506410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ef78505ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f41f9378030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ef78506d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ef78506410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ef785076d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f41f9378990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ef78506d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ef78507890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ef785076d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f41f937d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55ef78507a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ef78507890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.86 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.50 ms
whisper_print_timings:   sample time =    72.95 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2049.51 ms /     1 runs ( 2049.51 ms per run)
whisper_print_timings:   decode time =    16.64 ms /     2 runs (    8.32 ms per run)
whisper_print_timings:   batchd time =   333.07 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2572.20 ms
...
main:     load time =    68.32 ms
main:    total time = 19369.90 ms
embd_img
