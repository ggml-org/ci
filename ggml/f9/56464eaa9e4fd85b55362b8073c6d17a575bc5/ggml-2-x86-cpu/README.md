...
- status:  SUCCESS ✅
- runtime: 3:18.27
- date:    Wed Feb 21 14:33:37 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.46 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.31 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   82.18 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  96.99 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.35 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.68 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.11 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  29.06 sec
...
main:     load time =   111.28 ms
main:   sample time =    23.68 ms
main:  predict time =   489.31 ms / 7.65 ms per token
main:    total time =   636.94 ms
...
main:     load time =   109.55 ms
main:   sample time =    23.52 ms
main:  predict time =   505.19 ms / 7.22 ms per token
main:    total time =   640.34 ms
...
main:  predict time =   522.55 ms / 7.47 ms per token
main:    total time =   678.48 ms
...
main:     n_decoded =      504
main:     load time =   107.67 ms
main:   sample time =   178.67 ms
main:  predict time =  1816.61 ms
main:    total time =  2134.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f327ba2d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f327b8ae1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555719a4bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f327ba2d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f327ba32940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555719a4cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f327b8ae1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555719a4bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555719a4d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555719a4cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f327ba2d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555719a4dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555719a4d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555719a4e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f327ba2d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555719a4dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555719a4e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555719a4e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f327ba32940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555719a4ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555719a4e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.35 ms
whisper_print_timings:   sample time =    55.70 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1188.10 ms /     1 runs ( 1188.10 ms per run)
whisper_print_timings:   decode time =    12.10 ms /     2 runs (    6.05 ms per run)
whisper_print_timings:   batchd time =   213.54 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1566.92 ms
...
main:     load time =    66.60 ms
main:    total time = 10708.66 ms
embd_img
