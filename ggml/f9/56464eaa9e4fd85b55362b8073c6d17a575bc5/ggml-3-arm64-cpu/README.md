...
- status:  SUCCESS ✅
- runtime: 4:17.96
- date:    Wed Feb 21 02:48:20 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.99 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.55 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.10 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   99.70 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 117.48 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.90 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.16 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.42 sec
...
main:  predict time =   970.94 ms / 13.87 ms per token
main:    total time =  1141.35 ms
...
main:     load time =   178.13 ms
main:   sample time =    17.02 ms
main:  predict time =   974.13 ms / 13.92 ms per token
main:    total time =  1172.22 ms
...
main:  predict time =  6431.53 ms
main:    total time =  6790.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb3fea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb3e6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabb8aace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb3fea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb3fef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabb8abab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb3e6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabb8aace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabb8ac410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabb8abab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb3fea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabb8acd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabb8ac410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabb8ad6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb3fea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabb8acd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabb8ad890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabb8ad6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb3fef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaabb8ada50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabb8ad890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.32 ms
whisper_print_timings:   sample time =    65.37 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4696.12 ms /     1 runs ( 4696.12 ms per run)
whisper_print_timings:   decode time =    14.50 ms /     2 runs (    7.25 ms per run)
whisper_print_timings:   batchd time =   708.83 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5608.13 ms
