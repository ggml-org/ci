...
- status:  SUCCESS ✅
- runtime: 5:16.53
- date:    Fri Jan  5 02:41:23 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.33 sec
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.57 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed   35.18 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.27 sec
...
main:     load time =   187.12 ms
main:   sample time =    17.09 ms
main:  predict time =   823.02 ms / 12.86 ms per token
main:    total time =  1049.36 ms
...
main:   sample time =    17.09 ms
main:  predict time =   891.69 ms / 12.74 ms per token
main:    total time =  1090.82 ms
...
main:     n_decoded =      504
main:     load time =   154.81 ms
main:   sample time =   128.36 ms
main:  predict time =  5990.72 ms
main:    total time =  6355.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa608a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5f0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab20310b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa608a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa608f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab20311960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5f0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab20310b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab203122c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab20311960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa608a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab20312c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab203122c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab20313580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa608a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab20312c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab20313740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab20313580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa608f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab20313900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab20313740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.73 ms
whisper_print_timings:   sample time =    65.32 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4642.38 ms /     1 runs ( 4642.38 ms per run)
whisper_print_timings:   decode time =    15.20 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   707.27 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5563.69 ms
...
main:     load time =    95.32 ms
main:    total time = 39710.69 ms
embd_img
...
main:      load time =  5712.18 ms
main:    sample time =   522.25 ms / 8.16 ms per token
main:      eval time = 43987.38 ms / 628.39 ms per token
main:     total time = 52594.48 ms
...
main:      load time =  1616.90 ms
main:    sample time =   516.31 ms / 8.07 ms per token
main:      eval time = 17376.87 ms / 248.24 ms per token
main:     total time = 20484.13 ms
