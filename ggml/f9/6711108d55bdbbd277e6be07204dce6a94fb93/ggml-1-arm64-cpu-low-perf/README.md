...
- status:  SUCCESS ✅
- runtime: 3:37.37
- date:    Fri Jan  5 02:37:19 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.75 sec
...
20/20 Test #20: test-backend-ops .................   Passed   42.92 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.35 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.21 sec
...
main:     load time =   193.11 ms
main:   sample time =    17.65 ms
main:  predict time =   851.00 ms / 13.30 ms per token
main:    total time =  1083.51 ms
...
main:     load time =   192.65 ms
main:   sample time =    17.84 ms
main:  predict time =   923.71 ms / 13.20 ms per token
main:    total time =  1137.20 ms
...
main:     n_decoded =      504
main:     load time =   164.45 ms
main:   sample time =   129.11 ms
main:  predict time =  6175.84 ms
main:    total time =  6551.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ae0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ac8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae88e4b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ae0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ae0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae88e5960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ac8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae88e4b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae88e62c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae88e5960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ae0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae88e6c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae88e62c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae88e7580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ae0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae88e6c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae88e7740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae88e7580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ae0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae88e7900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae88e7740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.08 ms
whisper_print_timings:   sample time =    67.51 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4681.83 ms /     1 runs ( 4681.83 ms per run)
whisper_print_timings:   decode time =    15.64 ms /     2 runs (    7.82 ms per run)
whisper_print_timings:   batchd time =   838.57 ms /   125 runs (    6.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5740.68 ms
