...
- status:  SUCCESS ✅
- runtime: 23:14.26
- date:    Fri Jan  5 15:02:33 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.10 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   61.04 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    8.04 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    1.11 sec
      Start 11: test-pool
...
21/21 Test #21: test-backend-ops .................   Passed   24.06 sec
...
main:     load time =   577.03 ms
main:   sample time =    34.18 ms
main:  predict time =   551.51 ms / 8.62 ms per token
main:    total time =  1186.56 ms
...
main:     load time =   573.40 ms
main:   sample time =    40.33 ms
main:  predict time =   626.72 ms / 8.95 ms per token
main:    total time =  1245.60 ms
...
main:     n_decoded =      504
main:     load time =   537.16 ms
main:   sample time =   238.08 ms
main:  predict time =  2334.95 ms
main:    total time =  3154.24 ms
...
main: loaded model in   413.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2f435b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2f434371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b6b491f90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2f435b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2f435bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b6b492d60                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2f434371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b6b491f90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b6b4936c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b6b492d60                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2f435b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b6b494020                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b6b4936c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b6b494980                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2f435b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b6b494020                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b6b494b40                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b6b494980                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2f435bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558b6b494d00                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b6b494b40       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   494.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.69 ms
whisper_print_timings:   sample time =    66.99 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    32.84 ms /     1 runs (   32.84 ms per run)
whisper_print_timings:   decode time =    14.27 ms /     2 runs (    7.13 ms per run)
whisper_print_timings:   batchd time =    81.91 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   717.60 ms
...
main:     load time =   522.57 ms
main:    total time =  8322.97 ms
embd_img
...
main:      load time =  7322.07 ms
main:    sample time =   543.81 ms / 8.50 ms per token
main:      eval time = 24883.94 ms / 355.48 ms per token
main:     total time = 33678.99 ms
...
main:      load time =  2157.30 ms
main:    sample time =   530.33 ms / 8.29 ms per token
main:      eval time = 12477.49 ms / 178.25 ms per token
main:     total time = 15797.06 ms
