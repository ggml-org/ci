...
- status:  SUCCESS ✅
- runtime: 3:24.62
- date:    Fri Jan  5 14:36:52 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   27.68 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.26 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed    8.56 sec
...
main:     load time =   150.55 ms
main:   sample time =    23.41 ms
main:  predict time =   452.89 ms / 7.08 ms per token
main:    total time =   639.34 ms
...
main:     load time =   126.08 ms
main:   sample time =    23.48 ms
main:  predict time =   467.15 ms / 6.67 ms per token
main:    total time =   618.84 ms
...
main:     n_decoded =      504
main:     load time =   107.74 ms
main:   sample time =   178.21 ms
main:  predict time =  1520.83 ms
main:    total time =  1837.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc83e725990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc83e5a61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e199906b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc83e725030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc83e72a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e199907960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc83e5a61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e199906b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e1999082c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e199907960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc83e725030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e199908c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e1999082c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e199909580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc83e725990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e199908c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e199909740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e199909580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc83e72a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e199909900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e199909740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   133.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.92 ms
whisper_print_timings:   sample time =    55.53 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1160.54 ms /     1 runs ( 1160.54 ms per run)
whisper_print_timings:   decode time =     9.60 ms /     2 runs (    4.80 ms per run)
whisper_print_timings:   batchd time =   209.17 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1587.36 ms
...
main:     load time =    65.93 ms
main:    total time = 10636.35 ms
embd_img
...
main:      load time =  4358.31 ms
main:    sample time =   466.55 ms / 7.29 ms per token
main:      eval time = 19546.70 ms / 279.24 ms per token
main:     total time = 25018.84 ms
...
main:      load time =  1178.19 ms
main:    sample time =   464.20 ms / 7.25 ms per token
main:      eval time =  8171.90 ms / 116.74 ms per token
main:     total time = 10186.32 ms
