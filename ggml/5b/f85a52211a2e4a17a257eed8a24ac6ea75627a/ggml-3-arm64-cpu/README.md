...
- status:  SUCCESS ✅
- runtime: 5:54.68
- date:    Wed Dec 13 02:14:45 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.25 sec
...
19/19 Test #19: test-backend-ops .................   Passed   48.15 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.70 sec
...
main:     load time =   265.38 ms
main:   sample time =    16.62 ms
main:  predict time =   823.74 ms / 12.87 ms per token
main:    total time =  1127.67 ms
...
main:     load time =   166.31 ms
main:   sample time =    17.03 ms
main:  predict time =   895.83 ms / 12.80 ms per token
main:    total time =  1082.09 ms
...
main:     n_decoded =      504
main:     load time =   140.52 ms
main:   sample time =   128.33 ms
main:  predict time =  5847.05 ms
main:    total time =  6197.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88a6a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff888eb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacc1ccb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88a6a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88a6f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacc1cd940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff888eb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacc1ccb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacc1ce290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacc1cd940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88a6a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacc1cebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacc1ce290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacc1cf530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88a6a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacc1cebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacc1cf6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacc1cf530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88a6f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaacc1cf890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacc1cf6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   175.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.15 ms
whisper_print_timings:   sample time =    65.23 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4641.40 ms /     1 runs ( 4641.40 ms per run)
whisper_print_timings:   decode time =    15.22 ms /     2 runs (    7.61 ms per run)
whisper_print_timings:   batchd time =   705.65 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5621.37 ms
...
main:     load time =    77.33 ms
main:    total time = 39400.83 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.222000 sec.)
...
main:      load time = 11644.21 ms
main:    sample time =   535.65 ms / 8.37 ms per token
main:      eval time = 43453.27 ms / 620.76 ms per token
main:     total time = 58007.23 ms
...
main:      load time =  4339.38 ms
main:    sample time =   524.92 ms / 8.20 ms per token
main:      eval time = 17844.81 ms / 254.93 ms per token
main:     total time = 23680.85 ms
