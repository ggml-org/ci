...
- status:  SUCCESS ✅
- runtime: 4:08.78
- date:    Wed Dec 13 14:13:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.36 sec
...
19/19 Test #19: test-backend-ops .................   Passed   44.11 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.25 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    9.75 sec
...
main:     load time =   194.81 ms
main:   sample time =    23.47 ms
main:  predict time =   444.90 ms / 6.95 ms per token
main:    total time =   675.78 ms
...
main:     load time =   126.03 ms
main:   sample time =    23.43 ms
main:  predict time =   461.54 ms / 6.59 ms per token
main:    total time =   613.08 ms
...
main:     n_decoded =      504
main:     load time =   104.31 ms
main:   sample time =   178.12 ms
main:  predict time =  1473.38 ms
main:    total time =  1786.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9ba9771960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9ba95f2190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e5da45eb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9ba9771010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9ba9776900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e5da45f940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9ba95f2190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e5da45eb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e5da460290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e5da45f940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9ba9771010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e5da460be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e5da460290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e5da461530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9ba9771960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e5da460be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e5da4616e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e5da461530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9ba9776900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e5da461890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e5da4616e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   120.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.02 ms
whisper_print_timings:   sample time =    55.17 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1156.97 ms /     1 runs ( 1156.97 ms per run)
whisper_print_timings:   decode time =     9.45 ms /     2 runs (    4.72 ms per run)
whisper_print_timings:   batchd time =   209.60 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1569.33 ms
...
main:     load time =    63.55 ms
main:    total time = 10535.27 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.455000 sec.)
...
main:      load time = 12666.54 ms
main:    sample time =   469.90 ms / 7.34 ms per token
main:      eval time = 20372.85 ms / 291.04 ms per token
main:     total time = 34249.24 ms
...
main:      load time =  4406.11 ms
main:    sample time =   465.21 ms / 7.27 ms per token
main:      eval time =  8071.35 ms / 115.30 ms per token
main:     total time = 13312.64 ms
