...
- status:  SUCCESS ✅
- runtime: 3:11.11
- date:    Wed Dec 13 14:12:05 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/19 Test  #3: test-quantize-perf ...............   Passed    0.22 sec
...
19/19 Test #19: test-backend-ops .................   Passed   52.33 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.28 sec
...
main:     load time =   137.65 ms
main:   sample time =    23.42 ms
main:  predict time =   633.40 ms / 9.05 ms per token
main:    total time =   796.61 ms
...
main:  predict time =  2377.64 ms
main:    total time =  2710.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2a435aa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2a4342b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c73f983b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2a435aa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2a435af900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c73f984940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2a4342b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c73f983b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c73f985290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c73f984940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2a435aa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c73f985be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c73f985290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c73f986530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2a435aa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c73f985be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c73f9866e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c73f986530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2a435af900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c73f986890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c73f9866e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   135.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.63 ms
whisper_print_timings:   sample time =    71.52 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1974.06 ms /     1 runs ( 1974.06 ms per run)
whisper_print_timings:   decode time =    12.47 ms /     2 runs (    6.23 ms per run)
whisper_print_timings:   batchd time =   319.91 ms /   125 runs (    2.56 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2538.83 ms
...
main:     load time =    65.01 ms
main:    total time = 18695.50 ms
embd_img
