...
- status:  SUCCESS ✅
- runtime: 3:07.91
- date:    Wed Nov 29 18:57:56 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/5b855c02d37151efa3f7dced47c4d1533ff26a35
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.37 sec
...
19/19 Test #19: test-backend-ops .................   Passed    0.80 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.33 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    1.61 sec
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    2.82 sec
      Start  7: test0
...
20/20 Test #20: test-backend-ops .................   Passed    0.15 sec
...
main:     load time =   186.66 ms
main:   sample time =    23.72 ms
main:  predict time =   447.10 ms / 6.99 ms per token
main:    total time =   670.04 ms
...
main:     load time =   132.93 ms
main:   sample time =    23.62 ms
main:  predict time =   456.85 ms / 6.53 ms per token
main:    total time =   615.27 ms
...
main:     n_decoded =      504
main:     load time =   105.19 ms
main:   sample time =   175.21 ms
main:  predict time =  1451.40 ms
main:    total time =  1761.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6d01df7960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6d01c78190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5573c834eb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6d01df7010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6d01dfc900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5573c834f940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6d01c78190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5573c834eb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5573c8350290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5573c834f940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6d01df7010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5573c8350be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5573c8350290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5573c8351530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6d01df7960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5573c8350be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5573c83516e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5573c8351530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6d01dfc900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5573c8351890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5573c83516e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.66 ms
whisper_print_timings:   sample time =    54.18 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1155.46 ms /     1 runs ( 1155.46 ms per run)
whisper_print_timings:   decode time =    10.10 ms /     2 runs (    5.05 ms per run)
whisper_print_timings:   batchd time =   208.44 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1568.83 ms
...
main:     load time =    61.47 ms
main:    total time = 10449.61 ms
embd_img
...
main:      load time =  5934.52 ms
main:    sample time =   472.86 ms / 7.39 ms per token
main:      eval time = 20693.89 ms / 295.63 ms per token
main:     total time = 27771.68 ms
...
main:      load time =  1394.82 ms
main:    sample time =   467.83 ms / 7.31 ms per token
main:      eval time =  8830.67 ms / 126.15 ms per token
main:     total time = 11050.83 ms
