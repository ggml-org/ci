...
- status:  SUCCESS ✅
- runtime: 2:40.29
- date:    Wed Nov 29 06:57:32 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.98 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.89 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed    1.38 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.15 sec
      Start  9: test3
...
main:     load time =   186.35 ms
main:   sample time =    17.48 ms
main:  predict time =   872.37 ms / 13.63 ms per token
main:    total time =  1097.92 ms
...
main:     load time =   189.95 ms
main:   sample time =    17.32 ms
main:  predict time =   892.91 ms / 12.76 ms per token
main:    total time =  1102.97 ms
...
main:     n_decoded =      504
main:     load time =   157.77 ms
main:   sample time =   128.26 ms
main:  predict time =  5994.61 ms
main:    total time =  6361.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8186a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff816eb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabe721b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8186a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8186f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabe722940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff816eb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabe721b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabe723290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabe722940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8186a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabe723be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabe723290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabe724530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8186a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabe723be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabe7246e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabe724530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8186f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaabe724890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabe7246e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.69 ms
whisper_print_timings:   sample time =    64.51 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4684.54 ms /     1 runs ( 4684.54 ms per run)
whisper_print_timings:   decode time =    15.19 ms /     2 runs (    7.59 ms per run)
whisper_print_timings:   batchd time =   864.37 ms /   125 runs (    6.91 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5757.16 ms
