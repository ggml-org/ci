...
- status:  SUCCESS ✅
- runtime: 4:52.69
- date:    Wed Nov 29 06:59:53 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    1.35 sec
...
main:     load time =   185.38 ms
main:   sample time =    17.71 ms
main:  predict time =   814.42 ms / 12.73 ms per token
main:    total time =  1039.80 ms
...
main:  predict time =   880.09 ms / 12.57 ms per token
main:    total time =  1077.28 ms
...
main:  predict time =  5819.87 ms
main:    total time =  6176.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff883ea960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8826b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabe1e6b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff883ea010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff883ef900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabe1e7940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8826b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabe1e6b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabe1e8290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabe1e7940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff883ea010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabe1e8be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabe1e8290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabe1e9530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff883ea960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabe1e8be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabe1e96e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabe1e9530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff883ef900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaabe1e9890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabe1e96e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   186.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.95 ms
whisper_print_timings:   sample time =    64.23 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4633.20 ms /     1 runs ( 4633.20 ms per run)
whisper_print_timings:   decode time =    14.91 ms /     2 runs (    7.45 ms per run)
whisper_print_timings:   batchd time =   710.75 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5626.33 ms
...
main:     load time =    81.46 ms
main:    total time = 39328.73 ms
embd_img
...
main:      load time = 12956.31 ms
main:    sample time =   536.82 ms / 8.39 ms per token
main:      eval time = 43505.69 ms / 621.51 ms per token
main:     total time = 59373.25 ms
...
main:      load time =  4339.67 ms
main:    sample time =   524.13 ms / 8.19 ms per token
main:      eval time = 17560.72 ms / 250.87 ms per token
main:     total time = 23394.96 ms
