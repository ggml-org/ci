...
- status:  SUCCESS ✅
- runtime: 4:10.87
- date:    Wed Jan  3 09:48:10 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/20 Test  #4: test-mul-mat0 ....................   Passed    1.01 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    5.93 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   27.22 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.86 sec
...
main:     load time =   187.34 ms
main:   sample time =    23.71 ms
main:  predict time =   452.96 ms / 7.08 ms per token
main:    total time =   676.96 ms
...
main:  predict time =   464.43 ms / 6.63 ms per token
main:    total time =   624.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6583217990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f65830981a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5562c4259b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6583217030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f658321c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5562c425a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f65830981a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5562c4259b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5562c425b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5562c425a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6583217030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5562c425bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5562c425b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5562c425c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6583217990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5562c425bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5562c425c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5562c425c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f658321c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5562c425c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5562c425c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.49 ms
whisper_print_timings:   sample time =    54.72 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1167.30 ms /     1 runs ( 1167.30 ms per run)
whisper_print_timings:   decode time =     9.72 ms /     2 runs (    4.86 ms per run)
whisper_print_timings:   batchd time =   206.77 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1579.35 ms
...
main:     load time =    60.05 ms
main:    total time = 10607.60 ms
embd_img
...
main:      load time =  7464.29 ms
main:    sample time =   465.78 ms / 7.28 ms per token
main:      eval time = 20678.60 ms / 295.41 ms per token
main:     total time = 29293.47 ms
...
main:      load time =  2884.19 ms
main:    sample time =   508.70 ms / 7.95 ms per token
main:      eval time =  9429.59 ms / 134.71 ms per token
main:     total time = 13183.81 ms
