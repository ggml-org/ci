...
- status:  SUCCESS ✅
- runtime: 5:49.50
- date:    Wed Jan  3 10:01:53 AM UTC 2024
...
main:  predict time =   889.22 ms / 12.70 ms per token
main:    total time =  1082.69 ms
...
main:  predict time =  5997.90 ms
main:    total time =  6358.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb03fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb027b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad27ecb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb03fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb03ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad27ed960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb027b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad27ecb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad27ee2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad27ed960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb03fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad27eec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad27ee2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad27ef580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb03fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad27eec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad27ef740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad27ef580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb03ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad27ef900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad27ef740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   190.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    65.12 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4638.39 ms /     1 runs ( 4638.39 ms per run)
whisper_print_timings:   decode time =    15.11 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   705.85 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5633.65 ms
...
main:     load time =    83.82 ms
main:    total time = 39707.57 ms
embd_img
...
main:      load time =  9867.97 ms
main:    sample time =   518.90 ms / 8.11 ms per token
main:      eval time = 43705.32 ms / 624.36 ms per token
main:     total time = 56466.34 ms
...
main:      load time =  4349.34 ms
main:    sample time =   516.76 ms / 8.07 ms per token
main:      eval time = 17439.89 ms / 249.14 ms per token
main:     total time = 23278.17 ms
