...
- status:  SUCCESS ✅
- runtime: 3:20.85
- date:    Tue Sep  5 13:41:35 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.04 sec
      Start  2: test-opt
...
main:     load time =   177.08 ms
main:   sample time =    17.66 ms
main:  predict time =   811.79 ms / 12.68 ms per token
main:    total time =  1029.35 ms
...
main:  predict time =   878.15 ms / 12.54 ms per token
main:    total time =  1078.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0a8a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb090b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0dedac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0a89fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0a8f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad0dee850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb090b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0dedac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad0def170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad0dee850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0a89fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad0defa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad0def170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad0df03b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0a8a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad0defa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad0df0530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad0df03b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0a8f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad0df06b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad0df0530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5384.13 ms
main:    sample time =   624.28 ms / 9.75 ms per token
main:      eval time = 44288.80 ms / 632.70 ms per token
main:     total time = 52676.19 ms
...
main:      load time =  1641.12 ms
main:    sample time =   620.33 ms / 9.69 ms per token
main:      eval time = 17396.36 ms / 248.52 ms per token
main:     total time = 20615.46 ms
