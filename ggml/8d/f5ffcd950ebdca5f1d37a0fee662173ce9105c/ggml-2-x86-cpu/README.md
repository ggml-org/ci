...
- status:  SUCCESS ✅
- runtime: 2:19.73
- date:    Tue Sep  5 13:40:37 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/8df5ffcd950ebdca5f1d37a0fee662173ce9105c
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.14 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.12 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.40 sec
...
main:     load time =   135.65 ms
main:   sample time =    23.97 ms
main:  predict time =   440.90 ms / 6.89 ms per token
main:    total time =   614.02 ms
...
main:     load time =   135.71 ms
main:   sample time =    23.76 ms
main:  predict time =   460.95 ms / 6.58 ms per token
main:    total time =   623.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb1765458d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb1763c6160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556ccdd51ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb176544fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb17654a840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556ccdd52850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb1763c6160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556ccdd51ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556ccdd53170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556ccdd52850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb176544fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556ccdd53a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556ccdd53170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556ccdd543b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb1765458d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556ccdd53a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556ccdd54530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556ccdd543b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb17654a840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556ccdd546b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556ccdd54530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4561.09 ms
main:    sample time =   469.24 ms / 7.33 ms per token
main:      eval time = 19208.83 ms / 274.41 ms per token
main:     total time = 24874.38 ms
...
main:      load time =  1245.38 ms
main:    sample time =   467.20 ms / 7.30 ms per token
main:      eval time =  8017.50 ms / 114.54 ms per token
main:     total time = 10101.08 ms
