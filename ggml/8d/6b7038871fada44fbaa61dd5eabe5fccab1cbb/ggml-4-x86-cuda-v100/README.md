...
- status:  SUCCESS ✅
- runtime: 10:46.03
- date:    Fri May 24 21:09:27 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   37.32 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.04 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   20.16 sec
      Start  9: test3
...
12/22 Test #12: test-timestep_embedding ..........   Passed    0.05 sec
...
22/22 Test #22: test-backend-ops .................   Passed  166.61 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    4.86 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    3.34 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   20.53 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    6.35 sec
...
main:     load time =   424.29 ms
main:   sample time =    37.38 ms
main:  predict time =   753.89 ms / 11.78 ms per token
main:    total time =  1239.59 ms
...
main:  predict time =   722.83 ms / 10.33 ms per token
main:    total time =   916.29 ms
...
main:     load time =   218.42 ms
main:   sample time =    38.05 ms
main:  predict time =   820.10 ms / 11.72 ms per token
main:    total time =  1082.26 ms
...
main:     n_decoded =      504
main:     load time =   154.48 ms
main:   sample time =   238.48 ms
main:  predict time =  3116.46 ms
main:    total time =  3554.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f25b2cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f25b2b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f0a3160af0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f25b2cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f25b2cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f0a31618c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f25b2b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f0a3160af0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f0a3162220                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f0a31618c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f25b2cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f0a3162b80                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f0a3162220                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f0a31634e0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f25b2cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f0a3162b80                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f0a31636a0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f0a31634e0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f25b2cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f0a3163860                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f0a31636a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1174.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    22.97 ms
whisper_print_timings:   sample time =    65.76 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    47.18 ms /     1 runs (   47.18 ms per run)
whisper_print_timings:   decode time =    12.98 ms /     2 runs (    6.49 ms per run)
whisper_print_timings:   batchd time =    79.34 ms /   125 runs (    0.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1411.78 ms
...
main:     load time =   114.91 ms
main:    total time = 18052.54 ms
embd_img
