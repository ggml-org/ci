...
- status:  SUCCESS ✅
- runtime: 3:30.72
- date:    Fri Aug 18 11:54:01 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/12 Test  #1: test-grad0 .......................   Passed    3.61 sec
      Start  2: test-quantize-fns
 2/12 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/12 Test  #3: test-quantize-perf ...............   Passed    0.02 sec
      Start  4: test-mul-mat0
 4/12 Test  #4: test-mul-mat0 ....................   Passed    1.08 sec
      Start  5: test-mul-mat2
 5/12 Test  #5: test-mul-mat2 ....................   Passed    8.65 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/13 Test  #5: test-mul-mat0 ....................   Passed    0.52 sec
...
main:     load time =   266.90 ms
main:   sample time =    17.81 ms
main:  predict time =   803.82 ms / 12.56 ms per token
main:    total time =  1157.16 ms
...
main: mem per token =  2015032 bytes
main:     load time =   168.18 ms
main:   sample time =    17.38 ms
main:  predict time =   870.83 ms / 12.44 ms per token
main:    total time =  1105.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff963fa870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9627b140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacf30caa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff963f9f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff963ff7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacf30d810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9627b140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacf30caa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacf30e110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacf30d810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff963f9f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacf30ea10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacf30e110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacf30f310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff963fa870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacf30ea10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacf30f470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacf30f310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff963ff7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaacf30f5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacf30f470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5983.15 ms
main:    sample time =   610.39 ms / 9.54 ms per token
main:      eval time = 43696.70 ms / 624.24 ms per token
main:     total time = 52668.60 ms
...
main:      load time =  1681.86 ms
main:    sample time =   609.09 ms / 9.52 ms per token
main:      eval time = 17367.77 ms / 248.11 ms per token
main:     total time = 20628.71 ms
