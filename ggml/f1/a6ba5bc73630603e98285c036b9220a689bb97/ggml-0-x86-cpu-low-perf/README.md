...
- status:  FAILURE ❌ (1)
- runtime: 4:40.28
- date:    Sat Feb 10 12:56:06 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  108.01 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.79 sec
...
main:  predict time =   623.80 ms / 9.75 ms per token
main:    total time =   765.78 ms
...
main:   sample time =    23.81 ms
main:  predict time =   649.61 ms / 9.28 ms per token
main:    total time =   781.44 ms
...
main:     n_decoded =      504
main:     load time =   104.77 ms
main:   sample time =   178.23 ms
main:  predict time =  2514.31 ms
main:    total time =  2842.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f123481d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f123469e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56009083cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f123481d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1234822940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56009083d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f123469e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56009083cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56009083e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56009083d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f123481d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56009083ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56009083e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56009083f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f123481d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56009083ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56009083f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56009083f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1234822940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56009083f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56009083f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.19 ms
whisper_print_timings:   sample time =    72.95 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1994.07 ms /     1 runs ( 1994.07 ms per run)
whisper_print_timings:   decode time =    13.52 ms /     2 runs (    6.76 ms per run)
whisper_print_timings:   batchd time =   326.55 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2508.22 ms
