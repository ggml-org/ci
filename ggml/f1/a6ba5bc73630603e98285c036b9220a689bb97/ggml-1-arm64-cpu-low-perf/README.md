...
- status:  FAILURE ❌ (1)
- runtime: 5:59.18
- date:    Sat Feb 10 12:57:34 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  151.87 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 189.99 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.31 sec
...
main:     load time =   157.60 ms
main:   sample time =    17.34 ms
main:  predict time =   941.49 ms / 13.45 ms per token
main:    total time =  1119.22 ms
...
main:     load time =   188.85 ms
main:   sample time =    17.13 ms
main:  predict time =   940.09 ms / 13.43 ms per token
main:    total time =  1149.31 ms
...
main:  predict time =  6087.44 ms
main:    total time =  6455.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffafc1a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffafa9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf35a2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffafc1a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffafc1f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf35a3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffafa9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf35a2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf35a42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf35a3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffafc1a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf35a4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf35a42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf35a5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffafc1a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf35a4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf35a5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf35a5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffafc1f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf35a5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf35a5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   batchd time =   715.67 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5684.93 ms
...
main:     load time =    91.27 ms
main:    total time = 40299.00 ms
embd_img
