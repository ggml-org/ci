...
- status:  FAILURE ❌ (1)
- runtime: 4:46.84
- date:    Sat Feb 10 12:56:15 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.06 sec
...
20/20 Test #20: test-backend-ops .................   Passed  140.34 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 153.59 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.22 sec
...
21/21 Test #21: test-backend-ops .................   Passed   23.12 sec
...
main:  predict time =   833.75 ms / 13.03 ms per token
main:    total time =  1022.98 ms
...
main:  predict time =   938.32 ms / 13.40 ms per token
main:    total time =  1137.74 ms
...
main:     n_decoded =      504
main:     load time =   150.96 ms
main:   sample time =   128.58 ms
main:  predict time =  5964.69 ms
main:    total time =  6325.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9daba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d93b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab7959b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9daba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9dabf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab795a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d93b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab7959b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab795b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab795a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9daba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab795bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab795b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab795c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9daba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab795bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab795c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab795c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9dabf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab795c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab795c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.88 ms
whisper_print_timings:   sample time =    65.65 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4638.20 ms /     1 runs ( 4638.20 ms per run)
whisper_print_timings:   decode time =    15.70 ms /     2 runs (    7.85 ms per run)
whisper_print_timings:   batchd time =   712.33 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5553.68 ms
...
main:     load time =    85.86 ms
main:    total time = 39639.73 ms
embd_img
...
Skipping mask 0 with stability score 0.849928 below threshold 0.950000
Skipping mask 1 with stability score 0.793909 below threshold 0.950000
Skipping mask 2 with stability score 0.916652 below threshold 0.950000
