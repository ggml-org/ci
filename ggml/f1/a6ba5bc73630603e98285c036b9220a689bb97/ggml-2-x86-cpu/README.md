...
- status:  FAILURE ❌ (1)
- runtime: 3:20.26
- date:    Sat Feb 10 12:54:53 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.42 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.21 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.56 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.51 sec
...
20/20 Test #20: test-backend-ops .................   Passed  109.20 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 119.59 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.32 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.63 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    0.11 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.17 sec
      Start  5: test-mul-mat0
 5/21 Test  #5: test-mul-mat0 ....................   Passed    0.52 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.77 sec
...
ggml_gallocr_reserve_n: reallocating CPU buffer from size 0.00 MiB to 6.87 MiB
...
main:     load time =   106.23 ms
main:   sample time =    23.82 ms
main:  predict time =   458.28 ms / 7.16 ms per token
main:    total time =   600.66 ms
...
main:     load time =   104.29 ms
main:   sample time =    23.82 ms
main:  predict time =   480.07 ms / 6.86 ms per token
main:    total time =   610.09 ms
...
extract_tests_from_file : No test file found.
test_gpt_tokenizer : 0 tests failed out of 0 tests.
ggml_gallocr_reserve_n: reallocating CPU buffer from size 0.00 MiB to 3.49 MiB
main: seed = 1234
gpt2_model_load: loading model from '../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin'
gpt2_model_load: n_vocab = 50257
gpt2_model_load: n_ctx   = 1024
...
main:     load time =   125.62 ms
main:   sample time =    23.45 ms
main:  predict time =   487.56 ms / 6.97 ms per token
main:    total time =   639.03 ms
...
extract_tests_from_file : No test file found.
test_gpt_tokenizer : 0 tests failed out of 0 tests.
ggml_gallocr_reserve_n: reallocating CPU buffer from size 0.00 MiB to 6.93 MiB
...
main:     n_decoded =      504
main:     load time =   107.49 ms
main:   sample time =   177.85 ms
main:  predict time =  1529.55 ms
main:    total time =  1855.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3325e46990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3325cc71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561a71fefb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3325e46030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3325e4b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561a71ff0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3325cc71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561a71fefb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561a71ff12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561a71ff0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3325e46030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561a71ff1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561a71ff12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561a71ff2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3325e46990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561a71ff1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561a71ff2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561a71ff2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3325e4b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561a71ff2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561a71ff2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
ggml_gallocr_needs_realloc: graph has different number of nodes
ggml_gallocr_reserve_n: reallocating CPU buffer from size 0.00 MiB to 80.38 MiB
...
whisper_print_timings:     load time =    74.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.32 ms
whisper_print_timings:   sample time =    55.11 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1156.00 ms /     1 runs ( 1156.00 ms per run)
whisper_print_timings:   decode time =    10.32 ms /     2 runs (    5.16 ms per run)
whisper_print_timings:   batchd time =   209.26 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1525.49 ms
...
ggml_gallocr_needs_realloc: graph has different number of nodes
ggml_gallocr_reserve_n: reallocating CPU buffer from size 0.00 MiB to 848.00 MiB
prompt: (414.375000, 162.796875)
ggml_gallocr_needs_realloc: graph has different number of nodes
ggml_gallocr_reserve_n: reallocating CPU buffer from size 0.00 MiB to 28.04 MiB


main:     load time =    63.99 ms
main:    total time = 10459.18 ms
embd_img
...
Skipping mask 0 with stability score 0.850511 below threshold 0.950000
Skipping mask 1 with stability score 0.795421 below threshold 0.950000
Skipping mask 2 with stability score 0.916997 below threshold 0.950000
