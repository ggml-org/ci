...
- status:  SUCCESS ✅
- runtime: 5:12.89
- date:    Mon Jan 29 11:30:47 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  113.53 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.88 sec
...
main:     load time =   205.66 ms
main:   sample time =    23.70 ms
main:  predict time =   460.67 ms / 7.20 ms per token
main:    total time =   703.66 ms
...
main:  predict time =   474.65 ms / 6.78 ms per token
main:    total time =   623.23 ms
...
main:  predict time =  1559.32 ms
main:    total time =  1875.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f18a2f45990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f18a2dc61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556068382b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f18a2f45030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f18a2f4a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556068383960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f18a2dc61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556068382b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5560683842c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556068383960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f18a2f45030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556068384c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5560683842c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556068385580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f18a2f45990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556068384c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556068385740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556068385580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f18a2f4a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556068385900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556068385740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.16 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    55.98 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1176.37 ms /     1 runs ( 1176.37 ms per run)
whisper_print_timings:   decode time =    10.81 ms /     2 runs (    5.40 ms per run)
whisper_print_timings:   batchd time =   219.62 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1604.03 ms
...
main:     load time =    61.86 ms
main:    total time = 10643.06 ms
embd_img
...
main:      load time =  5636.16 ms
main:    sample time =   470.15 ms / 7.35 ms per token
main:      eval time = 20590.61 ms / 294.15 ms per token
main:     total time = 27380.14 ms
...
main:      load time =  1207.83 ms
main:    sample time =   470.34 ms / 7.35 ms per token
main:      eval time =  8271.33 ms / 118.16 ms per token
main:     total time = 10329.77 ms
