...
- status:  SUCCESS ✅
- runtime: 11:16.80
- date:    Mon Jan 29 11:36:51 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  220.20 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 266.61 sec
...
21/21 Test #21: test-backend-ops .................   Passed   43.96 sec
...
main:     load time =   589.21 ms
main:   sample time =    34.65 ms
main:  predict time =   598.07 ms / 9.34 ms per token
main:    total time =  1242.15 ms
...
main:     load time =   576.37 ms
main:   sample time =    34.49 ms
main:  predict time =   633.38 ms / 9.05 ms per token
main:    total time =  1248.86 ms
...
main:     n_decoded =      504
main:     load time =   549.26 ms
main:   sample time =   232.80 ms
main:  predict time =  2303.46 ms
main:    total time =  3130.35 ms
...
main: loaded model in   402.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f83b83b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f83b82371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5591d3300c40                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f83b83b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f83b83bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5591d3301a10                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f83b82371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5591d3300c40                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5591d3302370                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5591d3301a10                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f83b83b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5591d3302cd0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5591d3302370                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5591d3303630                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f83b83b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5591d3302cd0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5591d33037f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5591d3303630                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f83b83bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5591d33039b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5591d33037f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   728.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.97 ms
whisper_print_timings:   sample time =    66.20 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    21.66 ms /     1 runs (   21.66 ms per run)
whisper_print_timings:   decode time =    21.22 ms /     2 runs (   10.61 ms per run)
whisper_print_timings:   batchd time =    80.18 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   944.79 ms
...
main:     load time =   509.93 ms
main:    total time =  8018.59 ms
embd_img
...
main:      load time =  7559.83 ms
main:    sample time =   521.26 ms / 8.14 ms per token
main:      eval time = 25019.70 ms / 357.42 ms per token
main:     total time = 33965.51 ms
...
main:      load time =  2183.75 ms
main:    sample time =   525.82 ms / 8.22 ms per token
main:      eval time = 12502.41 ms / 178.61 ms per token
main:     total time = 15863.44 ms
