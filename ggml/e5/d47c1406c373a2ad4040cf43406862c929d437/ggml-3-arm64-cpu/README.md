...
- status:  SUCCESS ✅
- runtime: 7:23.96
- date:    Mon Jan 29 11:32:58 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  125.27 sec
...
main:     load time =   183.96 ms
main:   sample time =    17.09 ms
main:  predict time =   875.24 ms / 13.68 ms per token
main:    total time =  1098.50 ms
...
main:     load time =   184.18 ms
main:   sample time =    16.95 ms
main:  predict time =   950.73 ms / 13.58 ms per token
main:    total time =  1155.05 ms
...
main:     n_decoded =      504
main:     load time =   154.76 ms
main:   sample time =   127.35 ms
main:  predict time =  5992.11 ms
main:    total time =  6357.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87caa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff87b2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6783b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87caa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87caf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6784960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff87b2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6783b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf67852c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6784960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87caa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6785c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf67852c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6786580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87caa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6785c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6786740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6786580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87caf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf6786900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6786740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.80 ms
whisper_print_timings:   sample time =    65.42 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4637.37 ms /     1 runs ( 4637.37 ms per run)
whisper_print_timings:   decode time =    15.75 ms /     2 runs (    7.87 ms per run)
whisper_print_timings:   batchd time =   713.31 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5562.46 ms
...
main:      load time = 11928.11 ms
main:    sample time =   521.17 ms / 8.14 ms per token
main:      eval time = 43778.08 ms / 625.40 ms per token
main:     total time = 58600.95 ms
...
main:      load time =  4374.58 ms
main:    sample time =   514.28 ms / 8.04 ms per token
main:      eval time = 17401.74 ms / 248.60 ms per token
main:     total time = 23247.55 ms
