...
- status:  SUCCESS ✅
- runtime: 6:05.66
- date:    Mon Jan 29 11:31:35 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.34 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  153.73 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 191.15 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.58 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.47 sec
...
main:     load time =   189.14 ms
main:   sample time =    16.95 ms
main:  predict time =   892.74 ms / 13.95 ms per token
...
main:     load time =   194.21 ms
main:   sample time =    17.30 ms
main:  predict time =   958.59 ms / 13.69 ms per token
main:    total time =  1173.23 ms
...
main:     n_decoded =      504
main:     load time =   163.06 ms
main:   sample time =   128.77 ms
main:  predict time =  6197.75 ms
main:    total time =  6572.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96bda990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96a5b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1668b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96bda030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96bdf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae1669960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96a5b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1668b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae166a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae1669960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96bda030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae166ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae166a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae166b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96bda990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae166ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae166b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae166b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96bdf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae166b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae166b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.64 ms
whisper_print_timings:   sample time =    65.64 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4760.00 ms /     1 runs ( 4760.00 ms per run)
whisper_print_timings:   decode time =    15.98 ms /     2 runs (    7.99 ms per run)
whisper_print_timings:   batchd time =   715.53 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5686.28 ms
...
main:     load time =    91.56 ms
main:    total time = 40592.36 ms
embd_img
