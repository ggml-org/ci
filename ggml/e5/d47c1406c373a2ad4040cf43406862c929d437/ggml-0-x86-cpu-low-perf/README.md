...
- status:  SUCCESS ✅
- runtime: 4:55.11
- date:    Mon Jan 29 11:30:33 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.34 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  119.56 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 158.47 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   19.12 sec
...
main:  predict time =   631.27 ms / 9.86 ms per token
main:    total time =   796.80 ms
...
main:     load time =   130.57 ms
main:   sample time =    23.95 ms
main:  predict time =   667.74 ms / 9.54 ms per token
main:    total time =   824.82 ms
...
main:  predict time =  2507.19 ms
main:    total time =  2836.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f78ad723990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f78ad5a41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55dac0985b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f78ad723030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f78ad728940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55dac0986960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f78ad5a41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55dac0985b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55dac09872c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55dac0986960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f78ad723030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55dac0987c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55dac09872c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55dac0988580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f78ad723990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55dac0987c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55dac0988740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55dac0988580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f78ad728940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55dac0988900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55dac0988740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.94 ms
whisper_print_timings:   sample time =    71.26 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  2006.28 ms /     1 runs ( 2006.28 ms per run)
whisper_print_timings:   decode time =    13.56 ms /     2 runs (    6.78 ms per run)
whisper_print_timings:   batchd time =   326.05 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2519.18 ms
