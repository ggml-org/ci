...
- status:  SUCCESS ✅
- runtime: 1:48.45
- date:    Wed Aug 28 08:24:56 UTC 2024
...
main:  predict time =   442.66 ms / 6.92 ms per token
main:    total time =   588.16 ms
...
main:     load time =   123.03 ms
main:   sample time =    26.52 ms
main:  predict time =   468.58 ms / 6.69 ms per token
...
main:  predict time =  1552.66 ms
main:    total time =  1872.54 ms
