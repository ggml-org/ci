...
- status:  SUCCESS ✅
- runtime: 3:41.71
- date:    Wed Jan 10 16:16:16 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   26.78 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.70 sec
...
main:  predict time =   453.71 ms / 7.09 ms per token
main:    total time =   669.00 ms
...
main:  predict time =   467.79 ms / 6.68 ms per token
main:    total time =   618.08 ms
...
main:     n_decoded =      504
main:     load time =   103.06 ms
main:   sample time =   178.18 ms
main:  predict time =  1516.28 ms
main:    total time =  1827.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe1ca6d8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe1ca5591a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5579abb0fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe1ca6d8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe1ca6dd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5579abb10960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe1ca5591a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5579abb0fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5579abb112c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5579abb10960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe1ca6d8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5579abb11c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5579abb112c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5579abb12580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe1ca6d8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5579abb11c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5579abb12740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5579abb12580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe1ca6dd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5579abb12900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5579abb12740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.61 ms
...
whisper_print_timings:   decode time =     9.58 ms /     2 runs (    4.79 ms per run)
whisper_print_timings:   batchd time =   207.90 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1576.78 ms
...
main:     load time =    63.97 ms
main:    total time = 10635.15 ms
embd_img
...
main:      load time =  5631.09 ms
main:    sample time =   467.07 ms / 7.30 ms per token
main:      eval time = 20925.19 ms / 298.93 ms per token
main:     total time = 27697.48 ms
...
main:      load time =  1193.93 ms
main:    sample time =   466.16 ms / 7.28 ms per token
main:      eval time =  9764.15 ms / 139.49 ms per token
main:     total time = 11801.44 ms
