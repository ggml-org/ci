...
- status:  SUCCESS ✅
- runtime: 5:50.64
- date:    Wed Jan 10 04:18:25 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/c75db1e831de4286ed6e62794f3e386915787456
- author:  otaGran
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.32 sec
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.67 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.15 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.09 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   34.73 sec
...
15/21 Test #15: test-customop ....................   Passed    0.01 sec
      Start 16: test-xpos
...
21/21 Test #21: test-backend-ops .................   Passed   10.04 sec
...
main:     load time =   203.49 ms
main:   sample time =    17.10 ms
main:  predict time =   833.72 ms / 13.03 ms per token
main:    total time =  1076.90 ms
...
main:     load time =   177.67 ms
main:   sample time =    16.89 ms
main:  predict time =   896.60 ms / 12.81 ms per token
main:    total time =  1094.13 ms
...
main:     n_decoded =      504
main:     load time =   150.31 ms
main:   sample time =   126.94 ms
main:  predict time =  5984.19 ms
main:    total time =  6342.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f2da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f15b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae71feb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f2da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f2df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae71ff960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f15b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae71feb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae72002c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae71ff960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f2da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae7200c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae72002c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae7201580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f2da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae7200c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae7201740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae7201580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f2df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae7201900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae7201740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   190.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.32 ms
whisper_print_timings:   sample time =    65.94 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4637.86 ms /     1 runs ( 4637.86 ms per run)
whisper_print_timings:   decode time =    15.21 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   707.98 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5635.43 ms
...
main:     load time =    82.23 ms
main:    total time = 39714.33 ms
embd_img
...
main:      load time = 12270.54 ms
main:    sample time =   516.95 ms / 8.08 ms per token
main:      eval time = 43716.30 ms / 624.52 ms per token
main:     total time = 58874.99 ms
...
main:      load time =  4172.40 ms
main:    sample time =   515.85 ms / 8.06 ms per token
main:      eval time = 17414.08 ms / 248.77 ms per token
main:     total time = 23058.93 ms
