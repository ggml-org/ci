...
- status:  SUCCESS ✅
- runtime: 8:42.26
- date:    Wed Jan 10 16:21:11 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.72 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   61.84 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  94.22 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.82 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   23.08 sec
...
main:     load time =   571.12 ms
main:   sample time =    34.46 ms
main:  predict time =   647.27 ms / 10.11 ms per token
main:    total time =  1273.24 ms
...
main:     load time =   577.46 ms
main:   sample time =    34.14 ms
main:  predict time =   623.87 ms / 8.91 ms per token
main:    total time =  1239.70 ms
...
main:     n_decoded =      504
main:     load time =   550.61 ms
main:   sample time =   240.11 ms
main:  predict time =  2346.90 ms
main:    total time =  3186.23 ms
...
main: loaded model in   392.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf3d1b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf3d0371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cf083c6620                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf3d1b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf3d1bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cf083c73f0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf3d0371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cf083c6620                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cf083c7d50                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cf083c73f0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf3d1b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cf083c86b0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cf083c7d50                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cf083c9010                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf3d1b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cf083c86b0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cf083c91d0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cf083c9010                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf3d1bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55cf083c9390                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cf083c91d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   525.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.64 ms
whisper_print_timings:   sample time =    66.43 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    31.22 ms /     1 runs (   31.22 ms per run)
whisper_print_timings:   decode time =    13.30 ms /     2 runs (    6.65 ms per run)
whisper_print_timings:   batchd time =    80.90 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   743.34 ms
...
main:     load time =   557.22 ms
main:    total time =  8145.40 ms
embd_img
...
main:      load time = 23150.42 ms
main:    sample time =   541.88 ms / 8.47 ms per token
main:      eval time = 26435.90 ms / 377.66 ms per token
main:     total time = 51032.86 ms
...
main:      load time = 10876.90 ms
main:    sample time =   545.44 ms / 8.52 ms per token
main:      eval time = 12571.07 ms / 179.59 ms per token
main:     total time = 24683.99 ms
