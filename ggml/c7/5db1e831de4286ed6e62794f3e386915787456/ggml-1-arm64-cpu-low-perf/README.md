...
- status:  SUCCESS ✅
- runtime: 3:32.78
- date:    Wed Jan 10 04:16:02 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   42.98 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.97 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.90 sec
...
main:     load time =   191.71 ms
main:   sample time =    18.54 ms
main:  predict time =   861.69 ms / 13.46 ms per token
...
main:     load time =   194.54 ms
main:   sample time =    18.12 ms
main:  predict time =   941.76 ms / 13.45 ms per token
main:    total time =  1157.51 ms
...
main:     n_decoded =      504
main:     load time =   164.53 ms
main:   sample time =   129.27 ms
main:  predict time =  6327.87 ms
main:    total time =  6703.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa624a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa60cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafe569b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa624a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa624f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafe56a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa60cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafe569b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafe56b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafe56a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa624a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafe56bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafe56b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafe56c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa624a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafe56bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafe56c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafe56c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa624f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafe56c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafe56c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.94 ms
whisper_print_timings:   sample time =    67.38 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4777.85 ms /     1 runs ( 4777.85 ms per run)
whisper_print_timings:   decode time =    15.89 ms /     2 runs (    7.94 ms per run)
whisper_print_timings:   batchd time =   714.86 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5708.75 ms
