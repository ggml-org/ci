...
- status:  SUCCESS ✅
- runtime: 4:58.32
- date:    Sat Jan 27 15:27:11 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.16 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  115.45 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 154.20 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   23.88 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.82 sec
...
main:  predict time =   625.09 ms / 9.77 ms per token
main:    total time =   788.21 ms
...
main:  predict time =   653.72 ms / 9.34 ms per token
main:    total time =   806.26 ms
...
main:  predict time =  2499.29 ms
main:    total time =  2825.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efdce6cf990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efdce5501a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564a569a4b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efdce6cf030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efdce6d4940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564a569a5960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efdce5501a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564a569a4b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564a569a62c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564a569a5960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efdce6cf030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564a569a6c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564a569a62c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564a569a7580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efdce6cf990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564a569a6c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564a569a7740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564a569a7580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efdce6d4940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564a569a7900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564a569a7740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.95 ms
whisper_print_timings:   sample time =    73.05 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1985.50 ms /     1 runs ( 1985.50 ms per run)
whisper_print_timings:   decode time =    13.06 ms /     2 runs (    6.53 ms per run)
whisper_print_timings:   batchd time =   332.19 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2505.01 ms
