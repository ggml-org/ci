...
- status:  SUCCESS ✅
- runtime: 6:35.45
- date:    Sat Jan 27 03:30:51 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  146.11 sec
...
main:  predict time =   907.77 ms / 14.18 ms per token
main:    total time =  1142.23 ms
...
main:  predict time =   969.49 ms / 13.85 ms per token
main:    total time =  1186.92 ms
...
main:  predict time =  6257.35 ms
main:    total time =  6636.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa201a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1e9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacbfa0b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa201a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa201f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacbfa1960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1e9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacbfa0b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacbfa22c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacbfa1960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa201a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacbfa2c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacbfa22c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacbfa3580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa201a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacbfa2c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacbfa3740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacbfa3580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa201f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacbfa3900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacbfa3740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.16 ms
whisper_print_timings:   sample time =    67.42 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4734.29 ms /     1 runs ( 4734.29 ms per run)
whisper_print_timings:   decode time =    15.92 ms /     2 runs (    7.96 ms per run)
whisper_print_timings:   batchd time =   717.81 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5667.63 ms
