...
- status:  SUCCESS ✅
- runtime: 5:22.22
- date:    Sat Jan 27 15:44:36 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  112.06 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 122.91 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.31 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   18.52 sec
...
main:     load time =   183.16 ms
main:   sample time =    23.59 ms
main:  predict time =   481.77 ms / 7.53 ms per token
main:    total time =   701.67 ms
...
main:     load time =   129.59 ms
main:   sample time =    23.44 ms
main:  predict time =   479.18 ms / 6.85 ms per token
main:    total time =   634.63 ms
...
main:   sample time =   177.67 ms
main:  predict time =  1511.39 ms
main:    total time =  1822.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fda0517c990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fda04ffd1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c11f18b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fda0517c030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fda05181940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556c11f19960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fda04ffd1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c11f18b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556c11f1a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556c11f19960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fda0517c030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556c11f1ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556c11f1a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556c11f1b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fda0517c990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556c11f1ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556c11f1b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556c11f1b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fda05181940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556c11f1b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556c11f1b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   127.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.17 ms
whisper_print_timings:   sample time =    55.90 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1160.38 ms /     1 runs ( 1160.38 ms per run)
whisper_print_timings:   decode time =    10.11 ms /     2 runs (    5.06 ms per run)
whisper_print_timings:   batchd time =   213.83 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1586.31 ms
...
main:     load time =    64.00 ms
main:    total time = 10637.94 ms
embd_img
...
main:      load time =  5674.80 ms
main:    sample time =   468.33 ms / 7.32 ms per token
main:      eval time = 20898.71 ms / 298.55 ms per token
main:     total time = 27727.15 ms
...
main:      load time =  1243.85 ms
main:    sample time =   476.38 ms / 7.44 ms per token
main:      eval time =  8531.91 ms / 121.88 ms per token
main:     total time = 10607.63 ms
