...
- status:  SUCCESS ✅
- runtime: 7:52.20
- date:    Sat Jan 27 03:44:58 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  126.61 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 140.64 sec
...
21/21 Test #21: test-backend-ops .................   Passed   23.99 sec
...
main:     load time =   223.24 ms
main:   sample time =    17.27 ms
main:  predict time =   860.63 ms / 13.45 ms per token
main:    total time =  1123.29 ms
...
main:  predict time =   930.16 ms / 13.29 ms per token
main:    total time =  1126.85 ms
...
main:  predict time =  5999.07 ms
main:    total time =  6354.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff869aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8682b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0452b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff869aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff869af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0453960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8682b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0452b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae04542c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0453960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff869aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae0454c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae04542c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0455580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff869aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae0454c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0455740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0455580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff869af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae0455900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0455740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   173.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.82 ms
whisper_print_timings:   sample time =    65.40 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4624.67 ms /     1 runs ( 4624.67 ms per run)
whisper_print_timings:   decode time =    15.78 ms /     2 runs (    7.89 ms per run)
whisper_print_timings:   batchd time =   712.02 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5608.99 ms
...
main:     load time =    81.20 ms
main:    total time = 39621.27 ms
embd_img
...
main:      load time =  5904.46 ms
main:    sample time =   516.47 ms / 8.07 ms per token
main:      eval time = 43861.83 ms / 626.60 ms per token
main:     total time = 52657.03 ms
...
main:      load time =  1608.24 ms
main:    sample time =   516.28 ms / 8.07 ms per token
main:      eval time = 17330.18 ms / 247.57 ms per token
main:     total time = 20411.97 ms
