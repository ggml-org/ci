...
- status:  SUCCESS ✅
- runtime: 1:28.78
- date:    Fri Mar  7 08:13:18 UTC 2025
...
main:  predict time =   453.59 ms / 7.09 ms per token
main:    total time =   598.70 ms
...
main:     load time =   130.04 ms
main:   sample time =    26.76 ms
main:  predict time =   466.77 ms / 6.67 ms per token
main:    total time =   625.46 ms
...
main:   sample time =   181.57 ms
main:  predict time =  1554.56 ms
main:    total time =  1873.23 ms
