...
- status:  SUCCESS ✅
- runtime: 3:36.36
- date:    Thu Jan 11 08:09:12 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   48.84 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  71.92 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.92 sec
...
main:     load time =   187.89 ms
main:   sample time =    17.19 ms
main:  predict time =   837.53 ms / 13.09 ms per token
main:    total time =  1064.32 ms
...
main:  predict time =   907.84 ms / 12.97 ms per token
main:    total time =  1115.54 ms
...
main:     n_decoded =      504
main:     load time =   158.68 ms
main:   sample time =   128.11 ms
main:  predict time =  6177.36 ms
main:    total time =  6545.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb5e9a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb5d1b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff573b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb5e9a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb5e9f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaff574960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb5d1b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff573b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaff5752c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaff574960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb5e9a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaff575c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaff5752c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaff576580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb5e9a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaff575c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaff576740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaff576580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb5e9f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaff576900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaff576740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.87 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.09 ms
whisper_print_timings:   sample time =    65.38 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4744.91 ms /     1 runs ( 4744.91 ms per run)
whisper_print_timings:   decode time =    15.25 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   708.95 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5662.62 ms
...
main:     load time =    94.85 ms
main:    total time = 40460.02 ms
embd_img
