...
- status:  SUCCESS ✅
- runtime: 5:33.70
- date:    Thu Jan 11 20:06:15 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    3.32 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    3.79 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   31.91 sec
...
21/21 Test #21: test-backend-ops .................   Passed    9.84 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  18.27 sec
...
main:  predict time =   452.13 ms / 7.06 ms per token
main:    total time =   674.90 ms
...
main:  predict time =   473.10 ms / 6.76 ms per token
main:    total time =   624.94 ms
...
main:  predict time =  1519.83 ms
main:    total time =  1831.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9e15c06990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9e15a871a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b2416b3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9e15c06030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9e15c0b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b2416b4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9e15a871a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b2416b3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b2416b52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b2416b4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9e15c06030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b2416b5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b2416b52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b2416b6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9e15c06990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b2416b5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b2416b6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b2416b6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9e15c0b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b2416b6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b2416b6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    57.05 ms /   131 runs (    0.44 ms per run)
whisper_print_timings:   encode time =  1160.93 ms /     1 runs ( 1160.93 ms per run)
whisper_print_timings:   decode time =    10.17 ms /     2 runs (    5.08 ms per run)
whisper_print_timings:   batchd time =   213.81 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1582.28 ms
...
main:     load time =    60.07 ms
main:    total time = 10625.06 ms
embd_img
...
main:      load time = 11659.11 ms
main:    sample time =   466.94 ms / 7.30 ms per token
main:      eval time = 20398.96 ms / 291.41 ms per token
main:     total time = 33223.10 ms
...
main:    sample time =   481.23 ms / 7.52 ms per token
main:      eval time =  8779.91 ms / 125.43 ms per token
main:     total time = 13993.52 ms
