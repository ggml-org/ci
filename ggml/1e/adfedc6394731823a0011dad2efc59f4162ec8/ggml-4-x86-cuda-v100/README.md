...
- status:  SUCCESS ✅
- runtime: 9:00.68
- date:    Thu Jan 11 20:44:11 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   74.27 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.73 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   29.16 sec
...
main:     load time =   589.00 ms
main:   sample time =    34.41 ms
main:  predict time =   573.49 ms / 8.96 ms per token
main:    total time =  1220.70 ms
...
main:     load time =   604.56 ms
main:   sample time =    37.66 ms
main:  predict time =   632.41 ms / 9.03 ms per token
main:    total time =  1280.25 ms
...
main:     n_decoded =      504
main:     load time =   545.68 ms
main:   sample time =   232.63 ms
main:  predict time =  2273.66 ms
main:    total time =  3096.11 ms
...
main: loaded model in   395.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f58fdfb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f58fde371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56203342d7b0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f58fdfb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f58fdfbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56203342e580                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f58fde371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56203342d7b0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56203342eee0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56203342e580                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f58fdfb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56203342f840                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56203342eee0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620334301a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f58fdfb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56203342f840                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562033430360                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620334301a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f58fdfbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562033430520                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562033430360       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   514.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.92 ms
whisper_print_timings:   sample time =    72.40 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =    35.31 ms /     1 runs (   35.31 ms per run)
whisper_print_timings:   decode time =    14.23 ms /     2 runs (    7.12 ms per run)
whisper_print_timings:   batchd time =    81.29 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   743.74 ms
...
main:     load time =   501.10 ms
main:    total time =  7852.84 ms
embd_img
...
main:      load time = 22152.82 ms
main:    sample time =   538.65 ms / 8.42 ms per token
main:      eval time = 25832.57 ms / 369.04 ms per token
main:     total time = 49432.65 ms
...
main:      load time = 13152.01 ms
main:    sample time =   542.80 ms / 8.48 ms per token
main:      eval time = 12352.91 ms / 176.47 ms per token
main:     total time = 26738.54 ms
