...
- status:  SUCCESS ✅
- runtime: 5:56.88
- date:    Thu Jan 11 08:39:10 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.47 sec
...
20/20 Test #20: test-backend-ops .................   Passed   40.29 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.59 sec
...
main:     load time =   189.36 ms
main:   sample time =    16.81 ms
main:  predict time =   822.19 ms / 12.85 ms per token
main:    total time =  1050.21 ms
...
main:     load time =   186.95 ms
main:   sample time =    17.00 ms
main:  predict time =   894.25 ms / 12.78 ms per token
main:    total time =  1101.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85a4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff858cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3268b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85a4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85a4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf3269960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff858cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3268b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf326a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf3269960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85a4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf326ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf326a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf326b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85a4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf326ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf326b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf326b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85a4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf326b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf326b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   191.76 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.92 ms
whisper_print_timings:   sample time =    65.26 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4625.86 ms /     1 runs ( 4625.86 ms per run)
whisper_print_timings:   decode time =    15.07 ms /     2 runs (    7.53 ms per run)
whisper_print_timings:   batchd time =   705.98 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5621.92 ms
...
main:     load time =    86.00 ms
main:    total time = 39801.70 ms
embd_img
...
main:      load time =  7739.64 ms
main:    sample time =   516.62 ms / 8.07 ms per token
main:      eval time = 43677.33 ms / 623.96 ms per token
main:     total time = 54307.57 ms
...
main:      load time =  3395.41 ms
main:    sample time =   515.50 ms / 8.05 ms per token
main:      eval time = 17451.60 ms / 249.31 ms per token
main:     total time = 22316.77 ms
