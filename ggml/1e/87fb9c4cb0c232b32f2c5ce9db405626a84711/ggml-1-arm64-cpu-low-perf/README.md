...
- status:  SUCCESS ✅
- runtime: 2:39.77
- date:    Fri Dec  1 08:04:15 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.13 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.52 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.02 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.74 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    0.23 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  17.02 sec
...
main:  predict time =   833.89 ms / 13.03 ms per token
main:    total time =  1057.56 ms
...
main:     load time =   188.73 ms
main:   sample time =    17.30 ms
main:  predict time =   894.03 ms / 12.77 ms per token
main:    total time =  1102.86 ms
...
main:     n_decoded =      504
main:     load time =   157.59 ms
main:   sample time =   126.95 ms
main:  predict time =  6036.10 ms
main:    total time =  6401.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb5b5a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb59db190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaca35bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb5b5a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb5b5f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaca35c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb59db190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaca35bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaca35d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaca35c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb5b5a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaca35dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaca35d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaca35e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb5b5a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaca35dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaca35e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaca35e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb5b5f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaca35e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaca35e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.88 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    65.05 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4664.90 ms /     1 runs ( 4664.90 ms per run)
whisper_print_timings:   decode time =    15.34 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   714.58 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5589.54 ms
