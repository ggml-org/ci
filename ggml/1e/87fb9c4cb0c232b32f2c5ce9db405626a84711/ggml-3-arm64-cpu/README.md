...
- status:  SUCCESS ✅
- runtime: 4:40.21
- date:    Fri Dec  1 08:06:20 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/1e87fb9c4cb0c232b32f2c5ce9db405626a84711
- author:  RiverZhou
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.36 sec
...
Total Test time (real) =  15.57 sec
...
main:     load time =   183.08 ms
main:   sample time =    16.86 ms
main:  predict time =   819.91 ms / 12.81 ms per token
main:    total time =  1041.92 ms
...
main:     load time =   175.26 ms
main:   sample time =    16.75 ms
main:  predict time =   884.68 ms / 12.64 ms per token
main:    total time =  1079.34 ms
...
main:   sample time =   128.61 ms
main:  predict time =  5837.26 ms
main:    total time =  6193.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88cfa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88b7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5a00b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88cfa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88cff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae5a01940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88b7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5a00b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae5a02290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae5a01940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88cfa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae5a02be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae5a02290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5a03530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88cfa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae5a02be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae5a036e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5a03530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88cff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae5a03890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae5a036e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    64.98 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4633.89 ms /     1 runs ( 4633.89 ms per run)
whisper_print_timings:   decode time =    15.02 ms /     2 runs (    7.51 ms per run)
whisper_print_timings:   batchd time =   711.12 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5644.26 ms
...
main:     load time =    80.92 ms
main:    total time = 39296.78 ms
embd_img
...
main:      load time =  5787.78 ms
main:    sample time =   532.40 ms / 8.32 ms per token
main:      eval time = 43615.12 ms / 623.07 ms per token
main:     total time = 52308.05 ms
...
main:      load time =  1531.37 ms
main:    sample time =   530.98 ms / 8.30 ms per token
main:      eval time = 17481.31 ms / 249.73 ms per token
main:     total time = 20514.72 ms
