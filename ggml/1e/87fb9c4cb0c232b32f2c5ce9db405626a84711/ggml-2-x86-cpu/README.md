...
- status:  SUCCESS ✅
- runtime: 2:58.88
- date:    Fri Dec  1 08:04:36 UTC 2023
...
main:  predict time =   436.46 ms / 6.82 ms per token
main:    total time =   655.53 ms
...
main:     n_decoded =      504
main:     load time =   100.46 ms
main:   sample time =   177.47 ms
main:  predict time =  1449.91 ms
main:    total time =  1757.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f86658a4960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8665725190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558504af8b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f86658a4010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f86658a9900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558504af9940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8665725190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558504af8b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558504afa290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558504af9940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f86658a4010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558504afabe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558504afa290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558504afb530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f86658a4960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558504afabe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558504afb6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558504afb530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f86658a9900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558504afb890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558504afb6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.95 ms
whisper_print_timings:   sample time =    53.75 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1138.32 ms /     1 runs ( 1138.32 ms per run)
whisper_print_timings:   decode time =     9.63 ms /     2 runs (    4.82 ms per run)
whisper_print_timings:   batchd time =   206.47 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1557.41 ms
...
main:     load time =    67.72 ms
main:    total time = 10405.81 ms
embd_img
...
main:      load time =  5412.92 ms
main:    sample time =   466.85 ms / 7.29 ms per token
main:      eval time = 20399.16 ms / 291.42 ms per token
main:     total time = 26954.92 ms
...
main:      load time =  1190.40 ms
main:    sample time =   466.95 ms / 7.30 ms per token
main:      eval time =  7922.70 ms / 113.18 ms per token
main:     total time =  9948.79 ms
