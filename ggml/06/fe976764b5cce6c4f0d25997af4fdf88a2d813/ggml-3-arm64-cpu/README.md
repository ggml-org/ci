...
- status:  FAILURE ❌ (2)
- runtime: 1:55.06
- date:    Tue Aug 27 18:41:29 UTC 2024
...
main:     load time =   146.68 ms
main:   sample time =    16.81 ms
main:  predict time =   827.37 ms / 12.93 ms per token
main:    total time =  1012.41 ms
...
main:  predict time =   886.34 ms / 12.66 ms per token
...
main:     load time =   172.48 ms
main:   sample time =    16.90 ms
main:  predict time =   891.25 ms / 12.73 ms per token
main:    total time =  1082.94 ms
...
main:  predict time =  5893.30 ms
main:    total time =  6245.85 ms
