...
- status:  SUCCESS ✅
- runtime: 2:46.98
- date:    Wed Oct 11 19:31:32 UTC 2023
...
main:     load time =   173.64 ms
main:   sample time =    24.01 ms
main:  predict time =   479.82 ms / 7.50 ms per token
main:    total time =   691.12 ms
...
main:     load time =   112.01 ms
main:   sample time =    23.90 ms
main:  predict time =   495.90 ms / 7.08 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe869fc8900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe869e49170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aaba97fad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe869fc7fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe869fcd880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aaba980870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe869e49170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aaba97fad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aaba9811a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aaba980870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe869fc7fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aaba981ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aaba9811a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aaba982400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe869fc8900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aaba981ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aaba982590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aaba982400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe869fcd880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55aaba982720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aaba982590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   153.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.93 ms
whisper_print_timings:   sample time =    16.65 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  1165.83 ms /     1 runs ( 1165.83 ms per run)
whisper_print_timings:   decode time =   108.55 ms /    27 runs (    4.02 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1506.41 ms
```
### mpt
...
main:      load time =  5634.42 ms
main:    sample time =   464.55 ms / 7.26 ms per token
main:      eval time = 21960.72 ms / 313.72 ms per token
main:     total time = 28778.06 ms
...
main:      load time =  1319.07 ms
main:    sample time =   460.98 ms / 7.20 ms per token
main:      eval time =  8585.21 ms / 122.65 ms per token
main:     total time = 10813.89 ms
