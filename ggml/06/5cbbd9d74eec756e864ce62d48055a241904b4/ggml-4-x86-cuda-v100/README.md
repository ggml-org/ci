...
- status:  SUCCESS ✅
- runtime: 4:51.46
- date:    Wed Oct 11 19:33:41 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.47 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.22 sec
      Start  9: test3
...
Total Test time (real) =  22.30 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.54 sec
      Start  2: test-opt
...
main:     load time =   306.41 ms
main:   sample time =    35.04 ms
main:  predict time =   545.40 ms / 8.52 ms per token
main:    total time =   916.17 ms
...
main:  predict time =   593.00 ms / 8.47 ms per token
main:    total time =   786.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8dcc4ac900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8dcc32d170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5641cd19dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8dcc4abfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8dcc4b1880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5641cd19e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8dcc32d170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5641cd19dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5641cd19f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5641cd19e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8dcc4abfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5641cd19fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5641cd19f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5641cd1a0400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8dcc4ac900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5641cd19fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5641cd1a0590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5641cd1a0400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8dcc4b1880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5641cd1a0720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5641cd1a0590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   291.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.89 ms
whisper_print_timings:   sample time =    20.49 ms /    27 runs (    0.76 ms per run)
whisper_print_timings:   encode time =  1849.99 ms /     1 runs ( 1849.99 ms per run)
whisper_print_timings:   decode time =   139.05 ms /    27 runs (    5.15 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2386.05 ms
```
### mpt
...
main:      load time =  7394.81 ms
main:    sample time =   595.80 ms / 9.31 ms per token
main:      eval time = 24622.88 ms / 351.76 ms per token
main:     total time = 33472.30 ms
...
main:      load time =  2225.26 ms
main:    sample time =   585.67 ms / 9.15 ms per token
main:      eval time = 12273.12 ms / 175.33 ms per token
main:     total time = 15751.96 ms
