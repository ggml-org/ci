...
- status:  SUCCESS ✅
- runtime: 3:56.59
- date:    Wed Oct 11 07:32:41 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/065cbbd9d74eec756e864ce62d48055a241904b4
- author:  Georgi Gerganov
```
gpt-2-batched : simplify kv cache stuff
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.81 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.02 sec
      Start  4: test-mul-mat0
 4/14 Test  #4: test-mul-mat0 ....................   Passed    0.62 sec
      Start  5: test-mul-mat2
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.67 sec
      Start  6: test0
...
Total Test time (real) =  14.25 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.64 sec
      Start  2: test-opt
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.57 sec
...
main:     load time =   225.47 ms
main:   sample time =    16.77 ms
main:  predict time =   802.06 ms / 12.53 ms per token
main:    total time =  1067.67 ms
...
main:     load time =   150.45 ms
main:   sample time =    16.89 ms
main:  predict time =   868.58 ms / 12.41 ms per token
main:    total time =  1039.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8396a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff837eb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabf24fad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83969fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8396f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabf250870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff837eb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabf24fad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabf2511a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabf250870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83969fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabf251ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabf2511a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabf252400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8396a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabf251ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabf252590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabf252400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8396f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaabf252720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabf252590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   201.66 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.99 ms
whisper_print_timings:   sample time =    20.89 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4599.40 ms /     1 runs ( 4599.40 ms per run)
whisper_print_timings:   decode time =   180.70 ms /    27 runs (    6.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5067.54 ms
```
### mpt
...
main:      load time = 13336.11 ms
main:    sample time =   521.77 ms / 8.15 ms per token
main:      eval time = 43551.78 ms / 622.17 ms per token
main:     total time = 59782.03 ms
...
main:      load time =  4366.26 ms
main:    sample time =   521.52 ms / 8.15 ms per token
main:      eval time = 17344.91 ms / 247.78 ms per token
main:     total time = 23195.98 ms
