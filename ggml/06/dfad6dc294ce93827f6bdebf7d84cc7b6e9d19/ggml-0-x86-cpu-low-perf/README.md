...
- status:  SUCCESS ✅
- runtime: 5:02.06
- date:    Tue Jan 30 19:32:31 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/06dfad6dc294ce93827f6bdebf7d84cc7b6e9d19
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.34 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.19 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  122.02 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 161.28 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.10 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   20.81 sec
...
main:     load time =   126.22 ms
main:   sample time =    23.88 ms
main:  predict time =   638.51 ms / 9.98 ms per token
main:    total time =   801.96 ms
...
main:     load time =   127.24 ms
main:   sample time =    23.79 ms
main:  predict time =   672.33 ms / 9.60 ms per token
...
main:     n_decoded =      504
main:     load time =   105.51 ms
main:   sample time =   177.91 ms
main:  predict time =  2510.24 ms
main:    total time =  2839.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f61a775e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f61a75df1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559d4b7bfb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f61a775e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f61a7763940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559d4b7c0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f61a75df1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559d4b7bfb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559d4b7c12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559d4b7c0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f61a775e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559d4b7c1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559d4b7c12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559d4b7c2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f61a775e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559d4b7c1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559d4b7c2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559d4b7c2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f61a7763940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559d4b7c2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559d4b7c2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.26 ms
whisper_print_timings:   sample time =    72.38 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2010.37 ms /     1 runs ( 2010.37 ms per run)
whisper_print_timings:   decode time =    12.94 ms /     2 runs (    6.47 ms per run)
whisper_print_timings:   batchd time =   325.78 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2523.26 ms
...
main:     load time =    68.37 ms
main:    total time = 19021.18 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.457000 sec.)
