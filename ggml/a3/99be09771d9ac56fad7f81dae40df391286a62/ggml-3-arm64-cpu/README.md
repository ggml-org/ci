...
- status:  SUCCESS ✅
- runtime: 4:53.59
- date:    Fri Dec  1 08:11:07 PM UTC 2023
...
main:     load time =   180.81 ms
main:   sample time =    16.76 ms
main:  predict time =   887.69 ms / 12.68 ms per token
main:    total time =  1088.10 ms
...
main:     n_decoded =      504
main:     load time =   144.19 ms
main:   sample time =   127.84 ms
main:  predict time =  5838.19 ms
main:    total time =  6191.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdd5a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdbdb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab09e6ab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdd5a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdd5f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab09e6b940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdbdb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab09e6ab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab09e6c290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab09e6b940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdd5a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab09e6cbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab09e6c290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab09e6d530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdd5a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab09e6cbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab09e6d6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab09e6d530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdd5f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab09e6d890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab09e6d6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   180.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.05 ms
whisper_print_timings:   sample time =    64.54 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4632.87 ms /     1 runs ( 4632.87 ms per run)
whisper_print_timings:   decode time =    15.09 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   712.12 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5621.79 ms
...
main:     load time =    79.43 ms
main:    total time = 39274.00 ms
embd_img
...
main:      load time = 13066.25 ms
main:    sample time =   529.24 ms / 8.27 ms per token
main:      eval time = 43622.13 ms / 623.17 ms per token
main:     total time = 59588.68 ms
...
main:      load time =  4377.78 ms
main:    sample time =   534.04 ms / 8.34 ms per token
main:      eval time = 17619.47 ms / 251.71 ms per token
main:     total time = 23501.65 ms
