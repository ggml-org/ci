...
- status:  SUCCESS ✅
- runtime: 2:05.99
- date:    Fri Dec  1 20:08:10 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.63 sec
      Start  9: test3
...
main:     load time =   127.39 ms
main:   sample time =    23.50 ms
main:  predict time =   625.88 ms / 9.78 ms per token
main:    total time =   789.34 ms
...
main:     load time =   123.68 ms
main:   sample time =    23.43 ms
main:  predict time =   619.57 ms / 8.85 ms per token
main:    total time =   768.82 ms
...
main:     n_decoded =      504
main:     load time =   103.28 ms
main:   sample time =   177.90 ms
main:  predict time =  2366.45 ms
main:    total time =  2693.04 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd0d567a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd0d54fb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557974d05b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd0d567a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd0d567f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557974d06940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd0d54fb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557974d05b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557974d07290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557974d06940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd0d567a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557974d07be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557974d07290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557974d08530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd0d567a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557974d07be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557974d086e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557974d08530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd0d567f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557974d08890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557974d086e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    81.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.31 ms
whisper_print_timings:   sample time =    70.43 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1974.86 ms /     1 runs ( 1974.86 ms per run)
whisper_print_timings:   decode time =    12.74 ms /     2 runs (    6.37 ms per run)
whisper_print_timings:   batchd time =   322.16 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2487.26 ms
