...
- status:  SUCCESS ✅
- runtime: 3:13.30
- date:    Fri Dec  1 20:09:16 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    1.04 sec
...
main:  predict time =   442.26 ms / 6.91 ms per token
main:    total time =   664.02 ms
...
main:  predict time =   451.45 ms / 6.45 ms per token
main:    total time =   608.59 ms
...
main:     n_decoded =      504
main:     load time =   107.11 ms
main:   sample time =   177.67 ms
main:  predict time =  1454.42 ms
main:    total time =  1768.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f063d87e960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f063d6ff190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5607eb711b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f063d87e010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f063d883900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5607eb712940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f063d6ff190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5607eb711b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5607eb713290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5607eb712940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f063d87e010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5607eb713be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5607eb713290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5607eb714530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f063d87e960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5607eb713be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5607eb7146e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5607eb714530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f063d883900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5607eb714890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5607eb7146e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   124.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.92 ms
whisper_print_timings:   sample time =    53.49 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1138.62 ms /     1 runs ( 1138.62 ms per run)
whisper_print_timings:   decode time =     9.50 ms /     2 runs (    4.75 ms per run)
whisper_print_timings:   batchd time =   204.51 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1547.81 ms
...
main:     load time =    61.21 ms
main:    total time = 10381.95 ms
embd_img
...
main:      load time = 12903.76 ms
main:    sample time =   466.20 ms / 7.28 ms per token
main:      eval time = 20282.27 ms / 289.75 ms per token
main:     total time = 34318.00 ms
...
main:      load time =  4404.67 ms
main:    sample time =   464.98 ms / 7.27 ms per token
main:      eval time =  8461.25 ms / 120.88 ms per token
main:     total time = 13703.63 ms
