...
- status:  SUCCESS ✅
- runtime: 2:29.38
- date:    Tue Oct 24 04:39:40 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/43009962ce3164aec1d67835f843547974a7ce0c
- author:  PAB
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.86 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.79 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.56 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.18 sec
      Start  9: test3
...
main:     load time =   143.51 ms
main:   sample time =    17.35 ms
main:  predict time =   811.68 ms / 12.68 ms per token
main:    total time =   995.18 ms
...
main:     load time =   147.99 ms
main:   sample time =    16.82 ms
main:  predict time =   872.07 ms / 12.46 ms per token
main:    total time =  1040.73 ms
...
main:     n_decoded =      504
main:     load time =   144.38 ms
main:   sample time =   128.70 ms
main:  predict time =  6006.40 ms
main:    total time =  6450.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff92cfa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff92b7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6d87ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff92cf9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff92cff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6d88870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff92b7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6d87ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6d891a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6d88870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff92cf9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6d89ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6d891a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad6d8a400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff92cfa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6d89ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6d8a590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad6d8a400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff92cff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad6d8a720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6d8a590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.76 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.72 ms
whisper_print_timings:   sample time =    20.98 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4689.82 ms /     1 runs ( 4689.82 ms per run)
whisper_print_timings:   decode time =   180.03 ms /    27 runs (    6.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5066.44 ms
...
main:     load time =    89.53 ms
main:    total time = 40054.26 ms
embd_img
