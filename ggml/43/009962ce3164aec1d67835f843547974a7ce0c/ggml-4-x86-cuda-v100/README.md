...
- status:  SUCCESS ✅
- runtime: 6:03.44
- date:    Tue Oct 24 17:55:14 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/14 Test  #4: test-mul-mat0 ....................   Passed    0.69 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.73 sec
      Start  2: test-opt
...
main:     load time =   168.48 ms
main:   sample time =    34.56 ms
main:  predict time =   569.96 ms / 8.91 ms per token
main:    total time =   793.52 ms
...
main:  predict time =   596.51 ms / 8.52 ms per token
...
main:   sample time =   234.05 ms
main:  predict time =  2240.17 ms
main:    total time =  2666.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f958dcfa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f958db7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fc67599ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f958dcf9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f958dcff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55fc6759a870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f958db7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fc67599ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55fc6759b1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55fc6759a870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f958dcf9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55fc6759bad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55fc6759b1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55fc6759c400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f958dcfa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55fc6759bad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55fc6759c590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55fc6759c400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f958dcff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55fc6759c720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55fc6759c590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   753.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.87 ms
whisper_print_timings:   sample time =    20.22 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1803.34 ms /     1 runs ( 1803.34 ms per run)
whisper_print_timings:   decode time =   135.58 ms /    27 runs (    5.02 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2796.84 ms
...
main:     load time =    97.97 ms
main:    total time = 16615.56 ms
embd_img
...
main:      load time =  7257.81 ms
main:    sample time =   577.95 ms / 9.03 ms per token
main:      eval time = 25095.63 ms / 358.51 ms per token
main:     total time = 33814.57 ms
...
main:      load time =  1644.23 ms
main:    sample time =   579.96 ms / 9.06 ms per token
main:      eval time = 12139.72 ms / 173.42 ms per token
main:     total time = 15008.35 ms
