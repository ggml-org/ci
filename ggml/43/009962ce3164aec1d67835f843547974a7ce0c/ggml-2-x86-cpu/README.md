...
- status:  SUCCESS ✅
- runtime: 3:01.53
- date:    Tue Oct 24 16:40:21 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.58 sec
      Start  2: test-opt
...
main:     load time =   158.25 ms
main:   sample time =    23.38 ms
main:  predict time =   436.79 ms / 6.82 ms per token
main:    total time =   631.85 ms
...
main:  predict time =   455.20 ms / 6.50 ms per token
...
main:   sample time =   175.29 ms
main:  predict time =  1519.84 ms
main:    total time =  1834.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79b3385900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79b3206170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557f09590ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79b3384fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79b338a880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557f09591870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79b3206170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557f09590ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557f095921a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557f09591870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79b3384fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557f09592ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557f095921a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557f09593400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79b3385900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557f09592ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557f09593590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557f09593400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79b338a880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557f09593720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557f09593590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   132.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.18 ms
whisper_print_timings:   sample time =    15.96 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1137.85 ms /     1 runs ( 1137.85 ms per run)
whisper_print_timings:   decode time =    91.70 ms /    27 runs (    3.40 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1431.61 ms
...
main:      load time =  5757.80 ms
main:    sample time =   469.39 ms / 7.33 ms per token
main:      eval time = 20719.21 ms / 295.99 ms per token
main:     total time = 27644.64 ms
...
main:      load time =  1350.26 ms
main:    sample time =   467.32 ms / 7.30 ms per token
main:      eval time =  8887.23 ms / 126.96 ms per token
main:     total time = 11285.68 ms
