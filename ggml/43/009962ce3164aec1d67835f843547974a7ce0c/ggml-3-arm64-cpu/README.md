...
- status:  SUCCESS ✅
- runtime: 4:46.61
- date:    Tue Oct 24 04:41:56 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.89 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.71 sec
      Start  2: test-opt
...
main:     load time =   218.43 ms
main:   sample time =    16.90 ms
main:  predict time =   798.95 ms / 12.48 ms per token
main:    total time =  1056.89 ms
...
main:  predict time =   869.80 ms / 12.43 ms per token
main:    total time =  1043.33 ms
...
main:  predict time =  5870.19 ms
main:    total time =  6221.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d2da900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d15b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae78d9ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d2d9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d2df880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae78da870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d15b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae78d9ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae78db1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae78da870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d2d9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae78dbad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae78db1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae78dc400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d2da900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae78dbad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae78dc590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae78dc400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d2df880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae78dc720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae78dc590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   192.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.98 ms
whisper_print_timings:   sample time =    20.89 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4601.99 ms /     1 runs ( 4601.99 ms per run)
whisper_print_timings:   decode time =   179.84 ms /    27 runs (    6.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5060.96 ms
...
main:     load time =    77.91 ms
main:    total time = 39335.78 ms
embd_img
...
main:      load time = 12142.37 ms
main:    sample time =   518.60 ms / 8.10 ms per token
main:      eval time = 43776.97 ms / 625.39 ms per token
main:     total time = 58811.14 ms
...
main:      load time =  4357.90 ms
main:    sample time =   518.36 ms / 8.10 ms per token
main:      eval time = 17443.12 ms / 249.19 ms per token
main:     total time = 23283.01 ms
