...
- status:  SUCCESS ✅
- runtime: 5:15.52
- date:    Sun Mar 10 18:33:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   13.33 sec
...
22/22 Test #22: test-backend-ops .................   Passed  127.22 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 163.01 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.96 sec
      Start  2: test-opt
...
23/23 Test #23: test-backend-ops .................   Passed   30.95 sec
...
main:  predict time =   888.52 ms / 13.88 ms per token
main:    total time =  1077.09 ms
...
main:  predict time =   967.39 ms / 13.82 ms per token
main:    total time =  1138.62 ms
...
main:     load time =   177.10 ms
main:   sample time =    16.91 ms
main:  predict time =   979.16 ms / 13.99 ms per token
main:    total time =  1176.36 ms
...
main:     n_decoded =      504
main:     load time =   151.62 ms
main:   sample time =   127.35 ms
main:  predict time =  6463.82 ms
main:    total time =  6825.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa774a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa75cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2af9ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa774a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa774f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac2afaab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa75cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2af9ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac2afb410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac2afaab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa774a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac2afbd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac2afb410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac2afc6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa774a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac2afbd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac2afc890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac2afc6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa774f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac2afca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac2afc890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    65.76 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4694.15 ms /     1 runs ( 4694.15 ms per run)
whisper_print_timings:   decode time =    14.82 ms /     2 runs (    7.41 ms per run)
whisper_print_timings:   batchd time =   708.16 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.73 ms
...
main:     load time =    87.59 ms
main:    total time = 39715.73 ms
embd_img
