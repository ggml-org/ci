...
- status:  SUCCESS ✅
- runtime: 6:14.26
- date:    Sun Mar 10 06:22:02 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.16 sec
...
22/22 Test #22: test-backend-ops .................   Passed  130.47 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 190.10 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.67 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed    6.83 sec
      Start  3: test-quantize-perf
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.44 sec
      Start  9: test3
 9/22 Test  #9: test3 ............................   Passed    1.55 sec
      Start 10: test-pool
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   29.36 sec
...
main:     load time =   165.18 ms
main:   sample time =    17.94 ms
main:  predict time =   917.15 ms / 14.33 ms per token
main:    total time =  1122.23 ms
...
main:     load time =   160.44 ms
main:   sample time =    17.81 ms
main:  predict time =   997.11 ms / 14.24 ms per token
main:    total time =  1178.04 ms
...
main:  predict time =  1004.49 ms / 14.35 ms per token
main:    total time =  1216.53 ms
...
main:     n_decoded =      504
main:     load time =   159.81 ms
main:   sample time =   132.58 ms
main:  predict time =  6523.09 ms
main:    total time =  6899.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9df3a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ddbb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf19e1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9df3a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9df3f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf19e2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ddbb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf19e1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf19e3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf19e2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9df3a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf19e3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf19e3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf19e46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9df3a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf19e3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf19e4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf19e46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9df3f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf19e4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf19e4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.57 ms
whisper_print_timings:   sample time =    66.13 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4704.17 ms /     1 runs ( 4704.17 ms per run)
whisper_print_timings:   decode time =    16.00 ms /     2 runs (    8.00 ms per run)
whisper_print_timings:   batchd time =   720.45 ms /   125 runs (    5.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5640.59 ms
...
main:     load time =    90.92 ms
main:    total time = 40080.50 ms
embd_img
