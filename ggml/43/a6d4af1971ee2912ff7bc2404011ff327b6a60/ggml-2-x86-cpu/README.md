...
- status:  SUCCESS ✅
- runtime: 3:51.15
- date:    Sun Mar 10 18:26:10 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/43a6d4af1971ee2912ff7bc2404011ff327b6a60
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.41 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   12.27 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.97 sec
...
22/22 Test #22: test-backend-ops .................   Passed  102.70 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 133.58 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.30 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    1.68 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed    6.47 sec
...
23/23 Test #23: test-backend-ops .................   Passed   27.21 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) =  45.56 sec
...
main:     load time =   103.94 ms
main:   sample time =    23.37 ms
main:  predict time =   493.61 ms / 7.71 ms per token
main:    total time =   633.33 ms
...
main:     load time =   102.96 ms
main:   sample time =    23.41 ms
main:  predict time =   511.56 ms / 7.31 ms per token
main:    total time =   639.89 ms
...
main:     load time =   123.49 ms
main:   sample time =    23.65 ms
main:  predict time =   523.40 ms / 7.48 ms per token
main:    total time =   673.03 ms
...
main:     n_decoded =      504
main:     load time =   103.55 ms
main:   sample time =   175.76 ms
main:  predict time =  1857.73 ms
main:    total time =  2168.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff9e0ed6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff9e0d571a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ffada9dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff9e0ed6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff9e0edb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ffada9eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff9e0d571a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ffada9dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ffada9f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ffada9eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff9e0ed6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ffada9fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ffada9f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ffadaa06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff9e0ed6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ffada9fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ffadaa0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ffadaa06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff9e0edb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55ffadaa0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ffadaa0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.74 ms
whisper_print_timings:   sample time =    54.27 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1190.09 ms /     1 runs ( 1190.09 ms per run)
whisper_print_timings:   decode time =    12.54 ms /     2 runs (    6.27 ms per run)
whisper_print_timings:   batchd time =   215.75 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1568.82 ms
...
main:     load time =    64.01 ms
main:    total time = 10686.47 ms
embd_img
