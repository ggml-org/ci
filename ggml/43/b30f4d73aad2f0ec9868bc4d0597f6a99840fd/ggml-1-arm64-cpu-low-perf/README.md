...
- status:  SUCCESS ✅
- runtime: 4:07.60
- date:    Wed Mar 27 05:06:17 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   22.08 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.84 sec
      Start  9: test3
...
main:  predict time =   949.31 ms / 14.83 ms per token
main:    total time =  1155.79 ms
...
main:  predict time =  1055.75 ms / 15.08 ms per token
main:    total time =  1240.26 ms
...
main:     load time =   195.73 ms
main:   sample time =    20.08 ms
main:  predict time =  1086.92 ms / 15.53 ms per token
main:    total time =  1306.54 ms
...
main:     n_decoded =      504
main:     load time =   165.52 ms
main:   sample time =   131.10 ms
main:  predict time =  6527.98 ms
main:    total time =  6907.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ffaa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fe2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab9ccfce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ffaa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ffaf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab9cd0ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fe2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab9ccfce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab9cd1410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab9cd0ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ffaa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab9cd1d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab9cd1410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab9cd26d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ffaa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab9cd1d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab9cd2890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab9cd26d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ffaf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab9cd2a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab9cd2890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.01 ms
whisper_print_timings:   sample time =    66.13 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4766.84 ms /     1 runs ( 4766.84 ms per run)
whisper_print_timings:   decode time =    15.75 ms /     2 runs (    7.87 ms per run)
whisper_print_timings:   batchd time =   716.34 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5698.85 ms
...
main:     load time =    92.41 ms
main:    total time = 40365.35 ms
embd_img
