...
- status:  SUCCESS ✅
- runtime: 2:10.81
- date:    Wed Mar 27 17:04:21 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/43b30f4d73aad2f0ec9868bc4d0597f6a99840fd
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.09 sec
...
Total Test time (real) =  48.68 sec
...
main:     load time =   105.89 ms
main:   sample time =    23.51 ms
main:  predict time =   506.82 ms / 7.92 ms per token
main:    total time =   648.77 ms
...
main:     load time =   107.81 ms
main:   sample time =    23.63 ms
main:  predict time =   526.28 ms / 7.52 ms per token
main:    total time =   659.87 ms
...
main:     load time =   124.01 ms
main:   sample time =    23.89 ms
main:  predict time =   531.45 ms / 7.59 ms per token
main:    total time =   682.27 ms
...
main:     n_decoded =      504
main:     load time =   103.47 ms
main:   sample time =   175.04 ms
main:  predict time =  1831.47 ms
main:    total time =  2141.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f94fb8d2990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f94fb7531a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a385175ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f94fb8d2030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f94fb8d7940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a385176ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f94fb7531a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a385175ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a385177410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a385176ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f94fb8d2030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a385177d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a385177410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a3851786d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f94fb8d2990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a385177d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a385178890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a3851786d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f94fb8d7940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a385178a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a385178890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.17 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    55.10 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1193.14 ms /     1 runs ( 1193.14 ms per run)
whisper_print_timings:   decode time =    12.56 ms /     2 runs (    6.28 ms per run)
whisper_print_timings:   batchd time =   214.44 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1572.13 ms
...
main:     load time =    68.65 ms
main:    total time = 10750.55 ms
embd_img
