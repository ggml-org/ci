...
- status:  SUCCESS ✅
- runtime: 3:11.66
- date:    Wed Mar 27 17:05:12 UTC 2024
...
main:  predict time =   895.67 ms / 13.99 ms per token
main:    total time =  1086.43 ms
...
main:     load time =   184.71 ms
main:   sample time =    17.87 ms
main:  predict time =  1014.13 ms / 14.49 ms per token
main:    total time =  1220.28 ms
...
main:  predict time =  6421.38 ms
main:    total time =  6788.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0cca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0b4b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac1017ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0cca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0ccf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac1018ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0b4b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac1017ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac1019410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac1018ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0cca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac1019d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac1019410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac101a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0cca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac1019d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac101a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac101a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0ccf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac101aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac101a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.90 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.43 ms
whisper_print_timings:   sample time =    65.51 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4685.08 ms /     1 runs ( 4685.08 ms per run)
whisper_print_timings:   decode time =    15.29 ms /     2 runs (    7.64 ms per run)
whisper_print_timings:   batchd time =   711.00 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5606.19 ms
