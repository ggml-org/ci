...
- status:  SUCCESS ✅
- runtime: 3:30.24
- date:    Wed Mar 27 17:05:28 UTC 2024
...
Total Test time (real) =  76.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.93 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.61 sec
      Start  9: test3
...
main:  predict time =   710.90 ms / 11.11 ms per token
main:    total time =   854.43 ms
...
main:  predict time =   757.79 ms / 10.83 ms per token
main:    total time =   888.84 ms
...
main:     load time =   126.04 ms
main:   sample time =    23.85 ms
main:  predict time =   757.26 ms / 10.82 ms per token
main:    total time =   910.15 ms
...
main:  predict time =  3147.99 ms
main:    total time =  3473.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbefa015990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbef9e961a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a876453ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbefa015030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbefa01a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a876454ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbef9e961a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a876453ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a876455410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a876454ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbefa015030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a876455d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a876455410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a8764566d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbefa015990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a876455d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a876456890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a8764566d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbefa01a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a876456a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a876456890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  2089.54 ms /     1 runs ( 2089.54 ms per run)
whisper_print_timings:   decode time =    15.30 ms /     2 runs (    7.65 ms per run)
whisper_print_timings:   batchd time =   349.40 ms /   125 runs (    2.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2631.14 ms
...
main:     load time =    73.44 ms
main:    total time = 19659.59 ms
embd_img
