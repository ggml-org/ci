...
- status:  SUCCESS ✅
- runtime: 4:32.31
- date:    Sat Feb 10 14:13:43 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  109.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.07 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.46 sec
...
main:  predict time =   629.71 ms / 9.84 ms per token
main:    total time =   771.70 ms
...
main:     load time =   108.79 ms
main:   sample time =    23.83 ms
main:  predict time =   653.69 ms / 9.34 ms per token
main:    total time =   788.49 ms
...
main:     n_decoded =      504
main:     load time =   106.24 ms
main:   sample time =   177.89 ms
main:  predict time =  2506.24 ms
main:    total time =  2835.22 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f55bbf21990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f55bbda21a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5555623a7b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f55bbf21030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f55bbf26940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5555623a8960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f55bbda21a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5555623a7b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5555623a92c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5555623a8960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f55bbf21030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5555623a9c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5555623a92c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5555623aa580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f55bbf21990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5555623a9c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5555623aa740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5555623aa580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f55bbf26940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5555623aa900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5555623aa740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.76 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.17 ms
whisper_print_timings:   sample time =    71.83 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1994.05 ms /     1 runs ( 1994.05 ms per run)
whisper_print_timings:   decode time =    14.04 ms /     2 runs (    7.02 ms per run)
whisper_print_timings:   batchd time =   325.61 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2507.12 ms
...
main:     load time =    66.34 ms
main:    total time = 18921.11 ms
embd_img
