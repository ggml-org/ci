...
- status:  SUCCESS ✅
- runtime: 4:48.01
- date:    Sat Feb 10 02:14:10 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/a5604c15c07d50ab3790a20327499ddcc6bd7450
- author:  slaren
```
fix ci
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.02 sec
...
20/20 Test #20: test-backend-ops .................   Passed  144.06 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 157.25 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.86 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.09 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    0.12 sec
...
21/21 Test #21: test-backend-ops .................   Passed   23.09 sec
...
main:     load time =   148.90 ms
main:   sample time =    17.47 ms
main:  predict time =   832.19 ms / 13.00 ms per token
main:    total time =  1020.12 ms
...
main:     load time =   149.82 ms
main:   sample time =    17.68 ms
main:  predict time =   905.19 ms / 12.93 ms per token
main:    total time =  1075.55 ms
...
main:     load time =   177.07 ms
main:   sample time =    17.09 ms
main:  predict time =   929.41 ms / 13.28 ms per token
main:    total time =  1126.57 ms
...
main:     n_decoded =      504
main:     load time =   150.79 ms
main:   sample time =   128.65 ms
main:  predict time =  5963.02 ms
main:    total time =  6324.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb1aea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb196b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad7032b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb1aea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb1aef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad7033960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb196b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad7032b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad70342c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad7033960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb1aea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad7034c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad70342c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad7035580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb1aea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad7034c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad7035740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad7035580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb1aef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad7035900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad7035740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.84 ms
whisper_print_timings:   sample time =    65.50 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4618.56 ms /     1 runs ( 4618.56 ms per run)
whisper_print_timings:   decode time =    15.64 ms /     2 runs (    7.82 ms per run)
whisper_print_timings:   batchd time =   710.57 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5531.97 ms
...
main:     load time =    87.14 ms
main:    total time = 39580.20 ms
embd_img
