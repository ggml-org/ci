...
- status:  SUCCESS ✅
- runtime: 8:36.75
- date:    Sat Feb 10 14:33:05 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.83 sec
      Start  9: test3
...
Total Test time (real) = 261.11 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    0.69 sec
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.76 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    2.06 sec
      Start 11: test-pool
11/21 Test #11: test-pool ........................   Passed    0.60 sec
...
21/21 Test #21: test-backend-ops .................   Passed   44.22 sec
...
main:     load time =  1558.68 ms
main:   sample time =    34.53 ms
main:  predict time =   587.80 ms / 9.18 ms per token
...
main:     load time =   563.91 ms
main:   sample time =    34.70 ms
main:  predict time =   602.81 ms / 8.61 ms per token
main:    total time =  1204.92 ms
...
main:     load time =   574.90 ms
main:   sample time =    38.32 ms
main:  predict time =   613.29 ms / 8.76 ms per token
main:    total time =  1230.82 ms
...
main:     n_decoded =      504
main:     load time =   528.80 ms
main:   sample time =   236.37 ms
main:  predict time =  2352.81 ms
main:    total time =  3164.64 ms
...
main: loaded model in   401.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c634f9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c6337a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5644ceb689e0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c634f9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c634fe940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5644ceb697b0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c6337a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5644ceb689e0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5644ceb6a110                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5644ceb697b0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c634f9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5644ceb6aa70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5644ceb6a110                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5644ceb6b3d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c634f9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5644ceb6aa70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5644ceb6b590                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5644ceb6b3d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c634fe940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5644ceb6b750                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5644ceb6b590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
ggml_gallocr_reserve_n: reallocating CUDA0 buffer from size 0.00 MiB to 14.01 MiB
whisper_init_state: compute buffer (conv)   =   16.39 MB
ggml_gallocr_needs_realloc: graph has different number of nodes
ggml_gallocr_reserve_n: reallocating CUDA0 buffer from size 0.00 MiB to 80.38 MiB
whisper_init_state: compute buffer (encode) =   85.99 MB
ggml_gallocr_needs_realloc: graph has different number of nodes
ggml_gallocr_reserve_n: reallocating CUDA0 buffer from size 0.00 MiB to 2.93 MiB
whisper_init_state: compute buffer (cross)  =    4.78 MB
ggml_gallocr_needs_realloc: graph has different number of nodes
ggml_gallocr_reserve_n: reallocating CUDA0 buffer from size 0.00 MiB to 90.38 MiB
...
whisper_print_timings:     load time =  1079.74 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.56 ms
whisper_print_timings:   sample time =    67.08 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    28.59 ms /     1 runs (   28.59 ms per run)
whisper_print_timings:   decode time =    20.47 ms /     2 runs (   10.23 ms per run)
whisper_print_timings:   batchd time =    80.15 ms /   125 runs (    0.64 ms per run)
...
main:     load time =   499.81 ms
main:    total time =  8041.02 ms
embd_img
