...
- status:  SUCCESS ✅
- runtime: 7:13.75
- date:    Thu Nov 23 10:15:21 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    6.61 sec
 ...
 9/17 Test  #9: test3 ............................   Passed    0.99 sec
      Start 10: test-pool
10/17 Test #10: test-pool ........................   Passed    0.55 sec
...
15/17 Test #15: test-conv1d ......................   Passed    0.56 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    6.63 sec
      Start  2: test-opt
...
main:     load time =   559.67 ms
main:   sample time =    34.73 ms
main:  predict time =   591.38 ms / 9.24 ms per token
main:    total time =  1205.61 ms
...
main:     n_decoded =      504
main:     load time =   524.48 ms
main:   sample time =   234.10 ms
main:  predict time =  2186.20 ms
main:    total time =  2988.17 ms
...
main: loaded model in   391.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f53f7258960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f53f70d9190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559bfedc2900                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f53f7258010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f53f725d900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559bfedc36c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f53f70d9190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559bfedc2900                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559bfedc4010                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559bfedc36c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f53f7258010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559bfedc4960                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559bfedc4010                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559bfedc52b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f53f7258960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559bfedc4960                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559bfedc5460                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559bfedc52b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f53f725d900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559bfedc5610                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559bfedc5460       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1087.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.05 ms
whisper_print_timings:   sample time =    74.27 ms /   131 runs (    0.57 ms per run)
whisper_print_timings:   encode time =   479.80 ms /     1 runs (  479.80 ms per run)
whisper_print_timings:   decode time =    13.27 ms /     2 runs (    6.63 ms per run)
whisper_print_timings:   batchd time =   340.29 ms /   125 runs (    2.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2020.45 ms
...
main:     load time =   516.09 ms
main:    total time =  7694.44 ms
embd_img
...
main:      load time = 15965.94 ms
main:    sample time =   516.81 ms / 8.08 ms per token
main:      eval time = 24850.52 ms / 355.01 ms per token
main:     total time = 42176.34 ms
...
main:      load time =  7056.88 ms
main:    sample time =   521.22 ms / 8.14 ms per token
main:      eval time = 12349.50 ms / 176.42 ms per token
main:     total time = 20579.15 ms
