...
- status:  SUCCESS ✅
- runtime: 2:05.25
- date:    Thu Nov 23 10:10:00 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/a5e4560425f83797327001f12fb780cf33606d87
- author:  magicse
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.63 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.51 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.72 sec
      Start  9: test3
...
main:  predict time =   604.86 ms / 9.45 ms per token
main:    total time =   767.85 ms
...
main:     load time =   126.21 ms
main:   sample time =    23.81 ms
main:  predict time =   760.11 ms / 10.86 ms per token
main:    total time =   912.24 ms
...
main:   sample time =   175.72 ms
main:  predict time =  2371.16 ms
main:    total time =  2699.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0fd5a14960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0fd5895190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b166952b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0fd5a14010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0fd5a19900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b166953940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0fd5895190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b166952b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b166954290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b166953940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0fd5a14010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b166954be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b166954290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b166955530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0fd5a14960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b166954be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b1669556e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b166955530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0fd5a19900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b166955890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b1669556e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.12 ms
whisper_print_timings:   sample time =    70.72 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  2027.69 ms /     1 runs ( 2027.69 ms per run)
whisper_print_timings:   decode time =    12.51 ms /     2 runs (    6.26 ms per run)
whisper_print_timings:   batchd time =   321.72 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2537.92 ms
