...
- status:  SUCCESS ✅
- runtime: 4:53.14
- date:    Thu Nov 23 10:12:49 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.18 sec
      Start  2: test-opt
...
main:     load time =   248.03 ms
main:   sample time =    17.55 ms
main:  predict time =   816.88 ms / 12.76 ms per token
main:    total time =  1104.65 ms
...
main:  predict time =  5829.62 ms
main:    total time =  6183.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fc4a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7facb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadc16db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fc4a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fc4f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadc16e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7facb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadc16db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadc16f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadc16e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fc4a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadc16fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadc16f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadc170530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fc4a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadc16fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadc1706e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadc170530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fc4f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadc170890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadc1706e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   171.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.74 ms
whisper_print_timings:   sample time =    64.20 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4633.40 ms /     1 runs ( 4633.40 ms per run)
whisper_print_timings:   decode time =    15.71 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   710.31 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5611.55 ms
...
main:     load time =    77.88 ms
main:    total time = 39345.82 ms
embd_img
...
main:      load time = 11511.18 ms
main:    sample time =   531.88 ms / 8.31 ms per token
main:      eval time = 43525.41 ms / 621.79 ms per token
main:     total time = 57941.86 ms
...
main:      load time =  3744.12 ms
main:    sample time =   527.45 ms / 8.24 ms per token
main:      eval time = 17585.88 ms / 251.23 ms per token
main:     total time = 22827.65 ms
