...
- status:  SUCCESS ✅
- runtime: 3:06.26
- date:    Thu Nov 23 10:10:59 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.37 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.29 sec
      Start  2: test-opt
 ...
 8/18 Test  #8: test1 ............................   Passed    0.00 sec
      Start  9: test2
 9/18 Test  #9: test2 ............................   Passed    0.03 sec
      Start 10: test3
...
main:  predict time =   457.60 ms / 7.15 ms per token
main:    total time =   680.03 ms
...
main:     load time =   124.41 ms
main:   sample time =    23.69 ms
main:  predict time =   455.85 ms / 6.51 ms per token
main:    total time =   605.60 ms
...
main:   sample time =   175.07 ms
main:  predict time =  1471.40 ms
main:    total time =  1783.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1b79d57960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1b79bd8190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56112a6ddb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1b79d57010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1b79d5c900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56112a6de940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1b79bd8190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56112a6ddb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56112a6df290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56112a6de940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1b79d57010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56112a6dfbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56112a6df290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56112a6e0530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1b79d57960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56112a6dfbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56112a6e06e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56112a6e0530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1b79d5c900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56112a6e0890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56112a6e06e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   135.99 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.52 ms
whisper_print_timings:   sample time =    55.33 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1140.40 ms /     1 runs ( 1140.40 ms per run)
whisper_print_timings:   decode time =    10.80 ms /     2 runs (    5.40 ms per run)
whisper_print_timings:   batchd time =   220.02 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1580.29 ms
...
main:     load time =    61.75 ms
main:    total time = 10464.06 ms
embd_img
...
main:      load time =  6819.96 ms
main:    sample time =   469.65 ms / 7.34 ms per token
main:      eval time = 20191.66 ms / 288.45 ms per token
main:     total time = 28182.66 ms
...
main:      load time =  1603.71 ms
main:    sample time =   466.52 ms / 7.29 ms per token
main:      eval time =  8455.96 ms / 120.80 ms per token
main:     total time = 10900.25 ms
