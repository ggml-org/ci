...
- status:  SUCCESS ✅
- runtime: 5:46.47
- date:    Fri Dec 29 01:52:13 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.86 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    1.76 sec
      Start  7: test0
...
main:     load time =   270.07 ms
main:   sample time =    16.90 ms
main:  predict time =   807.37 ms / 12.62 ms per token
main:    total time =  1116.01 ms
...
main:     load time =   178.74 ms
main:   sample time =    16.86 ms
main:  predict time =   876.40 ms / 12.52 ms per token
main:    total time =  1074.92 ms
...
main:  predict time =  5916.46 ms
main:    total time =  6276.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88bca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88a4b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacfe76b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88bca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88bcf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacfe77960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88a4b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacfe76b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacfe782c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacfe77960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88bca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacfe78c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacfe782c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacfe79580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88bca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacfe78c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacfe79740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacfe79580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88bcf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacfe79900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacfe79740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   181.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    65.32 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4622.06 ms /     1 runs ( 4622.06 ms per run)
whisper_print_timings:   decode time =    14.95 ms /     2 runs (    7.47 ms per run)
whisper_print_timings:   batchd time =   705.86 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5607.50 ms
...
main:      load time =  6090.32 ms
main:    sample time =   516.62 ms / 8.07 ms per token
main:      eval time = 43483.31 ms / 621.19 ms per token
main:     total time = 52461.20 ms
...
main:      load time =  2662.59 ms
main:    sample time =   514.24 ms / 8.04 ms per token
main:      eval time = 17283.23 ms / 246.90 ms per token
main:     total time = 21429.09 ms
