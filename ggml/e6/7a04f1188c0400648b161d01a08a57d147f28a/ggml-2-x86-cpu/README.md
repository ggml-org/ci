...
- status:  SUCCESS ✅
- runtime: 3:45.38
- date:    Fri Dec 29 13:29:34 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/e67a04f1188c0400648b161d01a08a57d147f28a
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.32 sec
...
19/19 Test #19: test-backend-ops .................   Passed   27.89 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.23 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    7.88 sec
...
main:     load time =   236.65 ms
main:   sample time =    23.35 ms
main:  predict time =   438.37 ms / 6.85 ms per token
main:    total time =   711.15 ms
...
main:     load time =   121.57 ms
main:   sample time =    23.32 ms
main:  predict time =   451.84 ms / 6.45 ms per token
main:    total time =   598.80 ms
...
main:     n_decoded =      504
main:     load time =   101.34 ms
main:   sample time =   177.50 ms
main:  predict time =  1474.47 ms
main:    total time =  1782.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdbf394c990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdbf37cd1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5632e8431b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdbf394c030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdbf3951940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5632e8432960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdbf37cd1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5632e8431b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5632e84332c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5632e8432960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdbf394c030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5632e8433c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5632e84332c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5632e8434580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdbf394c990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5632e8433c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5632e8434740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5632e8434580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdbf3951940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5632e8434900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5632e8434740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   139.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.19 ms
whisper_print_timings:   sample time =    55.43 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1167.00 ms /     1 runs ( 1167.00 ms per run)
whisper_print_timings:   decode time =    10.29 ms /     2 runs (    5.15 ms per run)
whisper_print_timings:   batchd time =   209.36 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1599.91 ms
...
main:     load time =    59.61 ms
main:    total time = 10563.96 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.456000 sec.)
...
main:      load time =  5233.67 ms
main:    sample time =   466.45 ms / 7.29 ms per token
main:      eval time = 20441.41 ms / 292.02 ms per token
main:     total time = 26834.59 ms
...
main:      load time =  2321.29 ms
main:    sample time =   465.15 ms / 7.27 ms per token
main:      eval time =  8052.13 ms / 115.03 ms per token
main:     total time = 11225.71 ms
