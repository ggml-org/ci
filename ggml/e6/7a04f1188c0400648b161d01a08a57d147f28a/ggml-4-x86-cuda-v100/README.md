...
- status:  SUCCESS ✅
- runtime: 8:17.60
- date:    Fri Dec 29 13:50:05 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.53 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    7.91 sec
      Start  6: test0
 6/19 Test  #6: test0 ............................   Passed    0.56 sec
      Start  7: test1
...
11/19 Test #11: test-conv-transpose ..............   Passed    0.59 sec
...
19/19 Test #19: test-backend-ops .................   Passed   59.88 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/20 Test  #3: test-quantize-fns ................   Passed    0.56 sec
      Start  4: test-quantize-perf
 4/20 Test  #4: test-quantize-perf ...............   Passed    0.59 sec
      Start  5: test-mul-mat0
 5/20 Test  #5: test-mul-mat0 ....................   Passed    1.13 sec
 ...
 9/20 Test  #9: test2 ............................   Passed    8.02 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    1.09 sec
      Start 11: test-pool
11/20 Test #11: test-pool ........................   Passed    0.53 sec
      Start 12: test-conv-transpose
12/20 Test #12: test-conv-transpose ..............   Passed    0.52 sec
...
20/20 Test #20: test-backend-ops .................   Passed   24.92 sec
...
main:     load time =   564.02 ms
main:   sample time =    34.41 ms
main:  predict time =   554.51 ms / 8.66 ms per token
main:    total time =  1172.97 ms
...
main:     load time =   570.76 ms
main:   sample time =    34.77 ms
main:  predict time =   591.15 ms / 8.45 ms per token
main:    total time =  1200.79 ms
...
main:     n_decoded =      504
main:     load time =   529.74 ms
main:   sample time =   233.26 ms
main:  predict time =  2200.42 ms
main:    total time =  3006.96 ms
...
main: loaded model in   397.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdec35b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdec34371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5576352c3dc0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdec35b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdec35bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5576352c4b90                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdec34371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5576352c3dc0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5576352c54f0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5576352c4b90                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdec35b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5576352c5e50                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5576352c54f0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576352c67b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdec35b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5576352c5e50                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5576352c6970                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576352c67b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdec35bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5576352c6b30                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5576352c6970       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   497.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.52 ms
whisper_print_timings:   sample time =    66.35 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.71 ms /     1 runs (   34.71 ms per run)
whisper_print_timings:   decode time =    12.91 ms /     2 runs (    6.45 ms per run)
whisper_print_timings:   batchd time =    80.89 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   719.89 ms
...
main:     load time =   488.54 ms
main:    total time =  7896.49 ms
embd_img
...
main:      load time = 28550.64 ms
main:    sample time =   539.19 ms / 8.42 ms per token
main:      eval time = 24386.08 ms / 348.37 ms per token
main:     total time = 54382.11 ms
...
main:      load time = 14811.19 ms
main:    sample time =   536.72 ms / 8.39 ms per token
main:      eval time = 12072.51 ms / 172.46 ms per token
main:     total time = 28062.09 ms
