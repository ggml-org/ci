...
- status:  SUCCESS ✅
- runtime: 3:36.47
- date:    Fri Dec 29 01:23:02 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.77 sec
...
19/19 Test #19: test-backend-ops .................   Passed   43.34 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.99 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.16 sec
...
main:     load time =   196.95 ms
main:   sample time =    18.99 ms
main:  predict time =   846.35 ms / 13.22 ms per token
main:    total time =  1084.14 ms
...
main:     load time =   196.53 ms
main:   sample time =    18.00 ms
main:  predict time =  1044.03 ms / 14.91 ms per token
main:    total time =  1261.59 ms
...
main:  predict time =  6194.68 ms
main:    total time =  6570.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87b1a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8799b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18075b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87b1a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87b1f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18076960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8799b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18075b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab180772c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18076960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87b1a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18077c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab180772c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18078580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87b1a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18077c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18078740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18078580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87b1f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab18078900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18078740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    68.37 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4776.52 ms /     1 runs ( 4776.52 ms per run)
whisper_print_timings:   decode time =    15.56 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   721.03 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5716.15 ms
...
main:     load time =    98.08 ms
main:    total time = 40485.67 ms
embd_img
