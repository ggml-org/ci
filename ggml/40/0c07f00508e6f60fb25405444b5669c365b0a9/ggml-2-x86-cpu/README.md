...
- status:  SUCCESS ✅
- runtime: 4:10.06
- date:    Fri Jan 12 20:21:51 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   31.92 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.22 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  18.63 sec
...
main:     load time =   183.11 ms
main:   sample time =    23.46 ms
main:  predict time =   455.73 ms / 7.12 ms per token
...
main:  predict time =  1511.74 ms
main:    total time =  1821.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe55c3c5990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe55c2461a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c5d2646b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe55c3c5030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe55c3ca940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c5d2647960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe55c2461a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c5d2646b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c5d26482c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c5d2647960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe55c3c5030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c5d2648c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c5d26482c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c5d2649580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe55c3c5990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c5d2648c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c5d2649740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c5d2649580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe55c3ca940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c5d2649900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c5d2649740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1150.10 ms /     1 runs ( 1150.10 ms per run)
whisper_print_timings:   decode time =     9.94 ms /     2 runs (    4.97 ms per run)
whisper_print_timings:   batchd time =   208.81 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1572.02 ms
...
main:      load time =  5793.72 ms
main:    sample time =   467.92 ms / 7.31 ms per token
main:      eval time = 20897.69 ms / 298.54 ms per token
main:     total time = 27832.20 ms
...
main:      load time =  1370.07 ms
main:    sample time =   465.60 ms / 7.28 ms per token
main:      eval time =  8417.39 ms / 120.25 ms per token
main:     total time = 10610.26 ms
