...
- status:  SUCCESS ✅
- runtime: 3:37.24
- date:    Fri Jan 12 08:05:27 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.17 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   49.15 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.56 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.01 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.89 sec
...
main:     load time =   191.18 ms
main:   sample time =    17.16 ms
main:  predict time =   857.05 ms / 13.39 ms per token
main:    total time =  1087.28 ms
...
main:     load time =   191.27 ms
main:   sample time =    17.06 ms
main:  predict time =   933.22 ms / 13.33 ms per token
main:    total time =  1144.74 ms
...
main:  predict time =  6216.27 ms
main:    total time =  6589.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8a4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb88cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6a43b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8a4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8a4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6a44960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb88cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6a43b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf6a452c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6a44960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8a4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6a45c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf6a452c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6a46580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8a4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6a45c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6a46740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6a46580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8a4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf6a46900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6a46740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.70 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.75 ms
whisper_print_timings:   sample time =    65.63 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4678.76 ms /     1 runs ( 4678.76 ms per run)
whisper_print_timings:   decode time =    15.68 ms /     2 runs (    7.84 ms per run)
whisper_print_timings:   batchd time =   713.69 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.42 ms
...
main:     load time =    94.21 ms
main:    total time = 40524.85 ms
embd_img
