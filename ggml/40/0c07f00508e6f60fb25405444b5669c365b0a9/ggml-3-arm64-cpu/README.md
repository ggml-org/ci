...
- status:  SUCCESS ✅
- runtime: 5:52.17
- date:    Fri Jan 12 08:22:05 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/400c07f00508e6f60fb25405444b5669c365b0a9
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.23 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   40.16 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.08 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    0.06 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   11.63 sec
...
main:     load time =   186.26 ms
main:   sample time =    17.24 ms
main:  predict time =   846.99 ms / 13.23 ms per token
main:    total time =  1072.97 ms
...
main:     load time =   186.01 ms
main:   sample time =    17.10 ms
main:  predict time =   913.83 ms / 13.05 ms per token
main:    total time =  1120.13 ms
...
main:     n_decoded =      504
main:     load time =   154.32 ms
main:   sample time =   128.68 ms
main:  predict time =  5985.98 ms
main:    total time =  6350.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8017a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7fffb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9511b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8017a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8017f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae9512960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7fffb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9511b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae95132c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae9512960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8017a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae9513c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae95132c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae9514580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8017a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae9513c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae9514740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae9514580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8017f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae9514900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae9514740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   186.88 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.55 ms
whisper_print_timings:   sample time =    65.61 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4650.80 ms /     1 runs ( 4650.80 ms per run)
whisper_print_timings:   decode time =    15.32 ms /     2 runs (    7.66 ms per run)
whisper_print_timings:   batchd time =   706.86 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5644.09 ms
...
main:     load time =    83.68 ms
main:    total time = 39695.78 ms
embd_img
...
main:      load time =  5777.32 ms
main:    sample time =   515.98 ms / 8.06 ms per token
main:      eval time = 43728.98 ms / 624.70 ms per token
main:     total time = 52397.81 ms
...
main:      load time =  1633.74 ms
main:    sample time =   519.55 ms / 8.12 ms per token
main:      eval time = 17274.65 ms / 246.78 ms per token
main:     total time = 20393.64 ms
