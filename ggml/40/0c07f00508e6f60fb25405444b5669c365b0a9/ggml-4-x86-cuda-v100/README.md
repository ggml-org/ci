...
- status:  SUCCESS ✅
- runtime: 9:08.40
- date:    Fri Jan 12 20:25:19 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.87 sec
...
20/20 Test #20: test-backend-ops .................   Passed   71.34 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.86 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.77 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   29.07 sec
...
main:     load time =   628.15 ms
main:   sample time =    34.28 ms
main:  predict time =   606.46 ms / 9.48 ms per token
main:    total time =  1290.33 ms
...
main:     load time =   584.47 ms
main:   sample time =    34.18 ms
main:  predict time =   609.93 ms / 8.71 ms per token
main:    total time =  1233.17 ms
...
main:     n_decoded =      504
main:     load time =   542.03 ms
main:   sample time =   232.02 ms
main:  predict time =  2326.34 ms
main:    total time =  3144.94 ms
...
main: loaded model in   402.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f210dbb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f210da371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55da657b0a10                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f210dbb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f210dbbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55da657b17e0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f210da371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55da657b0a10                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55da657b2140                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55da657b17e0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f210dbb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55da657b2aa0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55da657b2140                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55da657b3400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f210dbb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55da657b2aa0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55da657b35c0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55da657b3400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f210dbbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55da657b3780                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55da657b35c0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   643.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.83 ms
whisper_print_timings:   sample time =    68.53 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    23.26 ms /     1 runs (   23.26 ms per run)
whisper_print_timings:   decode time =    22.76 ms /     2 runs (   11.38 ms per run)
whisper_print_timings:   batchd time =    81.72 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   866.44 ms
...
main:     load time =   492.26 ms
main:    total time =  8019.48 ms
embd_img
...
main:      load time = 23462.35 ms
main:    sample time =   538.37 ms / 8.41 ms per token
main:      eval time = 26036.90 ms / 371.96 ms per token
main:     total time = 50941.19 ms
...
main:      load time = 12975.61 ms
main:    sample time =   546.52 ms / 8.54 ms per token
main:      eval time = 12904.71 ms / 184.35 ms per token
main:     total time = 27081.41 ms
