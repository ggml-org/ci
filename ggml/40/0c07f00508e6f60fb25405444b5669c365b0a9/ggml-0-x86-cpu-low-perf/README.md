...
- status:  SUCCESS ✅
- runtime: 2:54.10
- date:    Fri Jan 12 20:04:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.55 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   40.78 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.23 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.11 sec
...
main:  predict time =   654.22 ms / 10.22 ms per token
...
main:  predict time =   682.10 ms / 9.74 ms per token
...
main:  predict time =  2509.31 ms
main:    total time =  2838.20 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc1657dc990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc16565d1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d87e7e2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc1657dc030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc1657e1940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d87e7e3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc16565d1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d87e7e2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d87e7e42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d87e7e3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc1657dc030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d87e7e4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d87e7e42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d87e7e5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc1657dc990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d87e7e4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d87e7e5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d87e7e5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc1657e1940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d87e7e5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d87e7e5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.12 ms
whisper_print_timings:   sample time =    72.50 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1999.46 ms /     1 runs ( 1999.46 ms per run)
whisper_print_timings:   decode time =    12.30 ms /     2 runs (    6.15 ms per run)
whisper_print_timings:   batchd time =   324.30 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2511.84 ms
