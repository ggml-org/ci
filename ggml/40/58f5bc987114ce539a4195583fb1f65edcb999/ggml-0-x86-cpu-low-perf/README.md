...
- status:  SUCCESS ✅
- runtime: 2:02.27
- date:    Thu Nov  2 19:26:17 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed   10.10 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.46 sec
      Start  2: test-quantize-fns
 ...
 7/14 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.63 sec
      Start  9: test3
...
main:  predict time =   611.49 ms / 9.55 ms per token
main:    total time =   777.67 ms
...
main:  predict time =   777.49 ms / 11.11 ms per token
main:    total time =   932.12 ms
...
main:  predict time =  2373.45 ms
main:    total time =  2702.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f23aa355900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f23aa1d6170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b56676fb60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f23aa354fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f23aa35a880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b566770900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f23aa1d6170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b56676fb60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b566771230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b566770900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f23aa354fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b566771b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b566771230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b566772490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f23aa355900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b566771b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b566772620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b566772490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f23aa35a880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b5667727b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b566772620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    86.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.23 ms
whisper_print_timings:   sample time =    16.55 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  2060.96 ms /     1 runs ( 2060.96 ms per run)
whisper_print_timings:   decode time =   133.45 ms /    27 runs (    4.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2356.52 ms
