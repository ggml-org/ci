...
- status:  SUCCESS ✅
- runtime: 3:03.15
- date:    Thu Nov  2 19:27:29 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.30 sec
...
main:     load time =   172.34 ms
main:   sample time =    23.80 ms
main:  predict time =   459.97 ms / 7.19 ms per token
main:    total time =   668.73 ms
...
main:     load time =   124.78 ms
main:   sample time =    23.72 ms
main:  predict time =   459.41 ms / 6.56 ms per token
main:    total time =   609.62 ms
...
main:   sample time =   177.57 ms
main:  predict time =  1455.26 ms
main:    total time =  1765.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f646a4eb900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f646a36c170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fbed869b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f646a4eafd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f646a4f0880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55fbed86a900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f646a36c170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fbed869b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55fbed86b230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55fbed86a900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f646a4eafd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55fbed86bb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55fbed86b230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55fbed86c490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f646a4eb900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55fbed86bb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55fbed86c620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55fbed86c490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f646a4f0880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55fbed86c7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55fbed86c620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   132.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.15 ms
whisper_print_timings:   sample time =    16.41 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1133.83 ms /     1 runs ( 1133.83 ms per run)
whisper_print_timings:   decode time =    94.52 ms /    27 runs (    3.50 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1427.89 ms
...
main:     load time =    64.17 ms
main:    total time = 10404.20 ms
embd_img
...
main:      load time =  5695.84 ms
main:    sample time =   471.03 ms / 7.36 ms per token
main:      eval time = 20662.30 ms / 295.18 ms per token
main:     total time = 27520.45 ms
...
main:      load time =  1194.48 ms
main:    sample time =   468.05 ms / 7.31 ms per token
main:      eval time =  8914.77 ms / 127.35 ms per token
main:     total time = 10925.92 ms
