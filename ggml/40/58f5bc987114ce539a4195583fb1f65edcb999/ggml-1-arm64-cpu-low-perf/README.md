...
- status:  SUCCESS ✅
- runtime: 2:35.37
- date:    Thu Nov  2 07:27:00 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.17 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.59 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.22 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
...
Total Test time (real) =  16.95 sec
...
main:     load time =   193.90 ms
main:   sample time =    17.91 ms
main:  predict time =   848.83 ms / 13.26 ms per token
main:    total time =  1082.72 ms
...
main:  predict time =  1018.19 ms / 14.55 ms per token
main:    total time =  1227.34 ms
...
main:     n_decoded =      504
main:     load time =   159.93 ms
main:   sample time =   129.73 ms
main:  predict time =  5997.48 ms
main:    total time =  6368.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbe39a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbe21b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae52a6b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbe399fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbe39f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae52a7900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbe21b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae52a6b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae52a8230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae52a7900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbe399fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae52a8b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae52a8230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae52a9490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbe39a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae52a8b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae52a9620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae52a9490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbe39f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae52a97b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae52a9620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.66 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    20.91 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4739.31 ms /     1 runs ( 4739.31 ms per run)
whisper_print_timings:   decode time =   181.52 ms /    27 runs (    6.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5121.46 ms
...
main:     load time =    91.48 ms
main:    total time = 40113.59 ms
embd_img
