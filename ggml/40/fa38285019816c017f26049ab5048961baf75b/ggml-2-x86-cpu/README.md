...
- status:  SUCCESS ✅
- runtime: 2:44.77
- date:    Sun Nov 12 14:11:22 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.28 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.15 sec
      Start  2: test-opt
 ...
 5/18 Test  #5: test-mul-mat0 ....................   Passed    0.51 sec
...
main:     load time =   121.67 ms
main:   sample time =    23.68 ms
main:  predict time =   434.12 ms / 6.78 ms per token
main:    total time =   591.71 ms
...
main:  predict time =   444.89 ms / 6.36 ms per token
main:    total time =   595.42 ms
...
main:     n_decoded =      504
main:     load time =   100.97 ms
main:   sample time =   177.63 ms
main:  predict time =  1453.07 ms
main:    total time =  1762.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9597fc2960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9597e43190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55887d645b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9597fc2010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9597fc7900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55887d646940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9597e43190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55887d645b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55887d647290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55887d646940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9597fc2010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55887d647be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55887d647290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55887d648530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9597fc2960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55887d647be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55887d6486e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55887d648530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9597fc7900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55887d648890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55887d6486e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    81.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.31 ms
whisper_print_timings:   sample time =    16.40 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1171.55 ms /     1 runs ( 1171.55 ms per run)
whisper_print_timings:   decode time =    94.32 ms /    27 runs (    3.49 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1382.15 ms
...
main:     load time =    69.15 ms
main:    total time = 10437.59 ms
embd_img
...
main:      load time =  4343.17 ms
main:    sample time =   469.89 ms / 7.34 ms per token
main:      eval time = 19136.32 ms / 273.38 ms per token
main:     total time = 24585.25 ms
...
main:      load time =  1236.09 ms
main:    sample time =   466.95 ms / 7.30 ms per token
main:      eval time =  8087.96 ms / 115.54 ms per token
main:     total time = 10174.21 ms
