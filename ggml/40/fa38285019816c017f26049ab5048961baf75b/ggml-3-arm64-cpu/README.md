...
- status:  SUCCESS ✅
- runtime: 4:27.00
- date:    Sun Nov 12 02:13:03 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.22 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.65 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.16 sec
      Start  2: test-opt
...
main:     load time =   180.71 ms
main:   sample time =    16.97 ms
main:  predict time =   813.37 ms / 12.71 ms per token
main:    total time =  1033.25 ms
...
main:     load time =   181.83 ms
main:   sample time =    17.37 ms
main:  predict time =   879.24 ms / 12.56 ms per token
main:    total time =  1081.35 ms
...
main:     n_decoded =      504
main:     load time =   144.03 ms
main:   sample time =   126.93 ms
main:  predict time =  5832.04 ms
main:    total time =  6183.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9951a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9939b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab06891b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9951a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9951f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab06892940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9939b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab06891b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab06893290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab06892940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9951a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab06893be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab06893290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab06894530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9951a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab06893be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab068946e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab06894530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9951f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab06894890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab068946e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    19.56 ms /    27 runs (    0.72 ms per run)
whisper_print_timings:   encode time =  4632.41 ms /     1 runs ( 4632.41 ms per run)
whisper_print_timings:   decode time =   188.97 ms /    27 runs (    7.00 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  4975.84 ms
...
main:     load time =    93.01 ms
main:    total time = 39325.40 ms
embd_img
...
main:      load time =  5635.66 ms
main:    sample time =   534.41 ms / 8.35 ms per token
main:      eval time = 43613.13 ms / 623.04 ms per token
main:     total time = 52155.98 ms
...
main:      load time =  1587.46 ms
main:    sample time =   528.11 ms / 8.25 ms per token
main:      eval time = 17508.20 ms / 250.12 ms per token
main:     total time = 20592.65 ms
