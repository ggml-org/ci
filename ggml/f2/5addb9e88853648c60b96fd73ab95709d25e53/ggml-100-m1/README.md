...
- status:  SUCCESS ✅
- runtime: 109.64
- date:    Fri Oct 20 10:06:43 EEST 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 8/15 Test  #8: test1 ............................   Passed    0.20 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    0.23 sec
      Start 10: test3
...
main:  predict time =   298.57 ms / 4.67 ms per token
main:    total time =   467.76 ms
...
main:  predict time =   304.76 ms / 4.35 ms per token
main:    total time =   404.28 ms
...
main:     n_decoded =      504
main:     load time =   125.27 ms
main:   sample time =    64.63 ms
main:  predict time =   760.53 ms
main:    total time =   961.47 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x154809f60                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x15480ad00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x158008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x154809f60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x15480b630                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x15480ad00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x158186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x15480bf60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x15480b630                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x15480c890                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1581878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x15480bf60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x15480ca20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x15480c890                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x15818c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x15480cbb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x15480ca20                           node_4
...
whisper_print_timings:     load time =   120.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.39 ms
whisper_print_timings:   sample time =    11.60 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   620.18 ms /     1 runs (  620.18 ms per run)
whisper_print_timings:   decode time =    63.41 ms /    27 runs (    2.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   837.30 ms
...
main:     load time =    71.31 ms
main:    total time =  5434.27 ms
embd_img
