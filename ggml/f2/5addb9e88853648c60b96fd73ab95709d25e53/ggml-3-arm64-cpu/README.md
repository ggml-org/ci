...
- status:  SUCCESS ✅
- runtime: 4:32.99
- date:    Fri Oct 20 07:10:13 AM UTC 2023
...
main:     load time =   158.35 ms
main:   sample time =    16.91 ms
main:  predict time =   800.38 ms / 12.51 ms per token
main:    total time =   998.87 ms
...
main:  predict time =   870.34 ms / 12.43 ms per token
main:    total time =  1041.25 ms
...
main:  predict time =  5861.16 ms
main:    total time =  6221.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5cea900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5b6b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6fa3ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5ce9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5cef880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6fa4870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5b6b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6fa3ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6fa51a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6fa4870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5ce9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6fa5ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6fa51a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6fa6400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5cea900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6fa5ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae6fa6590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6fa6400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5cef880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae6fa6720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae6fa6590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   210.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.22 ms
whisper_print_timings:   sample time =    20.85 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4603.89 ms /     1 runs ( 4603.89 ms per run)
whisper_print_timings:   decode time =   179.26 ms /    27 runs (    6.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5082.13 ms
...
main:      load time =  5899.98 ms
main:    sample time =   523.31 ms / 8.18 ms per token
main:      eval time = 43558.35 ms / 622.26 ms per token
main:     total time = 52354.14 ms
...
main:      load time =  1536.60 ms
main:    sample time =   516.74 ms / 8.07 ms per token
main:      eval time = 17322.24 ms / 247.46 ms per token
main:     total time = 20338.80 ms
