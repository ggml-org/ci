...
- status:  SUCCESS ✅
- runtime: 2:28.61
- date:    Fri Oct 20 07:08:20 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.52 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.22 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.35 sec
      Start  9: test3
...
Total Test time (real) =  18.48 sec
...
main:  predict time =   814.80 ms / 12.73 ms per token
main:    total time =  1003.64 ms
...
main:     load time =   148.80 ms
main:   sample time =    17.33 ms
main:  predict time =   881.65 ms / 12.60 ms per token
main:    total time =  1051.71 ms
...
main:  predict time =  6008.39 ms
main:    total time =  6370.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa1a5a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa18db170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6cebad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa1a59fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa1a5f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf6cec870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa18db170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6cebad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf6ced1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf6cec870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa1a59fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf6cedad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf6ced1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf6cee400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa1a5a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf6cedad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf6cee590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf6cee400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa1a5f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf6cee720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf6cee590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4617.87 ms /     1 runs ( 4617.87 ms per run)
whisper_print_timings:   decode time =   183.95 ms /    27 runs (    6.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5007.37 ms
...
main:     load time =    87.73 ms
main:    total time = 40080.47 ms
embd_img
