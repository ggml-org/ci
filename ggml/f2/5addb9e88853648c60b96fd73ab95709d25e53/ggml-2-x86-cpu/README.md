...
- status:  SUCCESS ✅
- runtime: 2:56.93
- date:    Fri Oct 20 07:08:39 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f25addb9e88853648c60b96fd73ab95709d25e53
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.71 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.64 sec
      Start  2: test-opt
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    0.04 sec
      Start 10: test3
...
main:     load time =   153.73 ms
main:   sample time =    23.66 ms
main:  predict time =   461.85 ms / 7.22 ms per token
main:    total time =   652.79 ms
...
extract_tests_from_file : No test file found.
test_gpt_tokenizer : 0 tests failed out of 0 tests.
main: compute buffer size: 6.81 MB
main: seed = 1234
gpt2_model_load: loading model from '../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin'
gpt2_model_load: n_vocab = 50257
gpt2_model_load: n_ctx   = 1024
...
main:  predict time =  1516.47 ms
main:    total time =  1833.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9c31cdf900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9c31b60170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55851f343ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9c31cdefd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9c31ce4880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55851f344870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9c31b60170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55851f343ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55851f3451a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55851f344870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9c31cdefd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55851f345ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55851f3451a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55851f346400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9c31cdf900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55851f345ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55851f346590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55851f346400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9c31ce4880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55851f346720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55851f346590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   133.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.42 ms
whisper_print_timings:   sample time =    16.41 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1146.73 ms /     1 runs ( 1146.73 ms per run)
whisper_print_timings:   decode time =    98.69 ms /    27 runs (    3.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1450.99 ms
...
main:      load time =  5462.99 ms
main:    sample time =   470.91 ms / 7.36 ms per token
main:      eval time = 20916.12 ms / 298.80 ms per token
main:     total time = 27549.70 ms
...
main:      load time =  1253.38 ms
main:    sample time =   467.82 ms / 7.31 ms per token
main:      eval time =  8489.77 ms / 121.28 ms per token
main:     total time = 10601.82 ms
