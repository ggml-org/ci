...
- status:  SUCCESS ✅
- runtime: 1:54.88
- date:    Fri Oct 20 07:07:38 UTC 2023
...
main:  predict time =   601.28 ms / 9.39 ms per token
main:    total time =   742.70 ms
...
main:  predict time =   636.31 ms / 9.09 ms per token
main:    total time =   764.89 ms
...
main:  predict time =  2356.30 ms
main:    total time =  2683.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb426eea900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb426d6b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559eede40ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb426ee9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb426eef880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559eede41870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb426d6b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559eede40ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559eede421a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559eede41870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb426ee9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559eede42ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559eede421a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559eede43400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb426eea900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559eede42ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559eede43590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559eede43400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb426eef880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559eede43720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559eede43590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    83.48 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.83 ms
whisper_print_timings:   sample time =    16.02 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1956.52 ms /     1 runs ( 1956.52 ms per run)
whisper_print_timings:   decode time =   129.43 ms /    27 runs (    4.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2247.91 ms
