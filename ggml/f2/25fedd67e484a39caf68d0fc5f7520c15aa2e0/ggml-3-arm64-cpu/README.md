...
- status:  SUCCESS ✅
- runtime: 3:57.14
- date:    Sun Oct  8 01:49:25 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.71 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.66 sec
      Start  2: test-opt
...
main:     load time =   139.52 ms
main:   sample time =    17.27 ms
main:  predict time =   869.31 ms / 12.42 ms per token
main:    total time =  1029.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa778a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa760b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec268ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7789fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa778f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaec269870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa760b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec268ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaec26a1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaec269870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7789fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaec26aad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaec26a1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaec26b400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa778a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaec26aad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaec26b590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaec26b400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa778f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaec26b720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaec26b590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   202.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.09 ms
whisper_print_timings:   sample time =    20.90 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4605.43 ms /     1 runs ( 4605.43 ms per run)
whisper_print_timings:   decode time =   176.27 ms /    27 runs (    6.53 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5071.13 ms
```
### mpt
...
main:      load time = 12200.93 ms
main:    sample time =   518.22 ms / 8.10 ms per token
main:      eval time = 43714.18 ms / 624.49 ms per token
main:     total time = 58808.49 ms
...
main:      load time =  3749.28 ms
main:    sample time =   520.25 ms / 8.13 ms per token
main:      eval time = 17376.47 ms / 248.24 ms per token
main:     total time = 22609.32 ms
