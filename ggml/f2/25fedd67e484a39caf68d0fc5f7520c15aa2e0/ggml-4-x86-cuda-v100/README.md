...
- status:  SUCCESS ✅
- runtime: 4:52.89
- date:    Sun Oct  8 13:50:23 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    7.44 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.55 sec
      Start  2: test-opt
...
main:   sample time =    35.39 ms
main:  predict time =   567.47 ms / 8.87 ms per token
main:    total time =   792.86 ms
...
main:  predict time =   620.63 ms / 8.87 ms per token
main:    total time =   810.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd8e750a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd8e738b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5618c2316ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd8e7509fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd8e750f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5618c2317870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd8e738b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5618c2316ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5618c23181a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5618c2317870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd8e7509fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5618c2318ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5618c23181a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5618c2319400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd8e750a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5618c2318ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5618c2319590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5618c2319400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd8e750f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5618c2319720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5618c2319590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   134.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.28 ms
whisper_print_timings:   sample time =    20.38 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1822.50 ms /     1 runs ( 1822.50 ms per run)
whisper_print_timings:   decode time =   149.85 ms /    27 runs (    5.55 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2212.27 ms
```
### mpt
...
main:      load time =  6888.59 ms
main:    sample time =   575.09 ms / 8.99 ms per token
main:      eval time = 24815.63 ms / 354.51 ms per token
main:     total time = 33184.77 ms
...
main:      load time =  1681.05 ms
main:    sample time =   603.59 ms / 9.43 ms per token
main:      eval time = 12206.42 ms / 174.38 ms per token
main:     total time = 15131.29 ms
