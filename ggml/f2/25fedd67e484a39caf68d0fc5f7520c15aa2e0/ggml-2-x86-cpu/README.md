...
- status:  SUCCESS ✅
- runtime: 2:58.93
- date:    Sun Oct  8 13:48:25 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f225fedd67e484a39caf68d0fc5f7520c15aa2e0
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    6.61 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.73 sec
      Start  2: test-opt
...
main:     load time =   181.89 ms
main:   sample time =    24.05 ms
main:  predict time =   485.99 ms / 7.59 ms per token
main:    total time =   705.70 ms
...
main:     load time =   121.17 ms
main:   sample time =    23.96 ms
main:  predict time =   498.49 ms / 7.12 ms per token
main:    total time =   646.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe1ff8aa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe1ff72b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563cceb70ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe1ff8a9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe1ff8af880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563cceb71870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe1ff72b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563cceb70ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563cceb721a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563cceb71870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe1ff8a9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563cceb72ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563cceb721a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563cceb73400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe1ff8aa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563cceb72ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563cceb73590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563cceb73400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe1ff8af880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563cceb73720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563cceb73590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   142.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.23 ms
whisper_print_timings:   sample time =    16.60 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1191.02 ms /     1 runs ( 1191.02 ms per run)
whisper_print_timings:   decode time =   106.45 ms /    27 runs (    3.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1514.22 ms
```
### mpt
...
main:      load time = 11709.57 ms
main:    sample time =   466.27 ms / 7.29 ms per token
main:      eval time = 21967.77 ms / 313.83 ms per token
main:     total time = 34842.55 ms
...
main:      load time =  4398.36 ms
main:    sample time =   461.44 ms / 7.21 ms per token
main:      eval time =  8605.07 ms / 122.93 ms per token
main:     total time = 13847.56 ms
