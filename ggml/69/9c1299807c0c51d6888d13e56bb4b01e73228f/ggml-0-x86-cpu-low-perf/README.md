...
- status:  SUCCESS ✅
- runtime: 3:24.58
- date:    Sun Jun 16 11:35:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    2.11 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   16.08 sec
      Start  3: test-quantize-perf
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.14 sec
      Start  9: test3
...
main:  predict time =   649.55 ms / 10.15 ms per token
main:    total time =   793.26 ms
...
main:     load time =   100.62 ms
main:   sample time =    23.81 ms
main:  predict time =   672.65 ms / 9.61 ms per token
main:    total time =   799.31 ms
...
main:     load time =   121.97 ms
main:   sample time =    23.91 ms
main:  predict time =   679.53 ms / 9.71 ms per token
main:    total time =   828.45 ms
...
main:     n_decoded =      504
main:     load time =    99.51 ms
main:   sample time =   178.00 ms
main:  predict time =  2568.29 ms
main:    total time =  2891.49 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70c5fb6fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70c5fb57b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5e67fb9d9ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70c5fb6fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x70c5fb6ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5e67fb9daab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70c5fb57b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5e67fb9d9ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5e67fb9db410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5e67fb9daab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70c5fb6fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5e67fb9dbd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5e67fb9db410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5e67fb9dc6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70c5fb6fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5e67fb9dbd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5e67fb9dc890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5e67fb9dc6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x70c5fb6ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5e67fb9dca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5e67fb9dc890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    69.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.32 ms
whisper_print_timings:   sample time =    71.86 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1997.54 ms /     1 runs ( 1997.54 ms per run)
whisper_print_timings:   decode time =    13.65 ms /     2 runs (    6.83 ms per run)
whisper_print_timings:   batchd time =   327.83 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2517.20 ms
