...
- status:  SUCCESS ✅
- runtime: 4:04.39
- date:    Sun Jun 16 11:36:27 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.10 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.45 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.67 sec
      Start  9: test3
...
main:     load time =   152.04 ms
main:   sample time =    18.65 ms
main:  predict time =   903.35 ms / 14.11 ms per token
main:    total time =  1095.70 ms
...
main:  predict time =   978.58 ms / 13.98 ms per token
main:    total time =  1150.13 ms
...
main:     load time =   182.89 ms
main:   sample time =    19.64 ms
main:  predict time =   984.70 ms / 14.07 ms per token
main:    total time =  1190.84 ms
...
main:   sample time =   130.34 ms
main:  predict time =  6115.12 ms
main:    total time =  6479.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe5477290a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe5477278b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb13e8aef1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe5477290a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe5477290f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb13e8aef2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe5477278b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb13e8aef1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb13e8aef3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb13e8aef2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe5477290a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb13e8aef3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb13e8aef3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb13e8aef46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe5477290a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb13e8aef3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb13e8aef4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb13e8aef46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe5477290f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb13e8aef4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb13e8aef4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.45 ms
whisper_print_timings:   sample time =    71.32 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  4722.64 ms /     1 runs ( 4722.64 ms per run)
whisper_print_timings:   decode time =    15.16 ms /     2 runs (    7.58 ms per run)
whisper_print_timings:   batchd time =   762.51 ms /   125 runs (    6.10 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5706.81 ms
...
main:     load time =    93.44 ms
main:    total time = 39955.07 ms
embd_img
