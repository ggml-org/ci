...
- status:  SUCCESS ✅
- runtime: 2:08.81
- date:    Sun Jun 16 11:34:31 UTC 2024
...
main:  predict time =   490.04 ms / 7.66 ms per token
main:    total time =   632.27 ms
...
main:  predict time =   500.53 ms / 7.15 ms per token
main:    total time =   630.57 ms
...
main:  predict time =   518.03 ms / 7.40 ms per token
main:    total time =   671.86 ms
...
main:  predict time =  1548.65 ms
main:    total time =  1863.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x71d9de0fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x71d9ddf7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60a35ddddce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x71d9de0fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x71d9de0ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60a35dddeab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x71d9ddf7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60a35ddddce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60a35dddf410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60a35dddeab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x71d9de0fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60a35dddfd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60a35dddf410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60a35dde06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x71d9de0fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60a35dddfd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60a35dde0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60a35dde06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x71d9de0ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x60a35dde0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60a35dde0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.29 ms
whisper_print_timings:   sample time =    55.36 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1168.15 ms /     1 runs ( 1168.15 ms per run)
whisper_print_timings:   decode time =    11.38 ms /     2 runs (    5.69 ms per run)
whisper_print_timings:   batchd time =   221.85 ms /   125 runs (    1.77 ms per run)
