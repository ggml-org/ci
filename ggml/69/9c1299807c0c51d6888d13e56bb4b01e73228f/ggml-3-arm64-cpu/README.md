...
- status:  SUCCESS ✅
- runtime: 3:09.60
- date:    Sun Jun 16 11:35:27 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.37 sec
      Start  2: test-opt
...
main:  predict time =   887.69 ms / 13.87 ms per token
...
main:   sample time =    19.19 ms
main:  predict time =   960.52 ms / 13.72 ms per token
main:    total time =  1144.64 ms
...
main:  predict time =   956.87 ms / 13.67 ms per token
main:    total time =  1161.60 ms
...
main:  predict time =  6116.97 ms
main:    total time =  6481.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf2a620c7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf2a620afb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaf532e60dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf2a620c7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf2a620c7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaf532e60eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf2a620afb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaf532e60dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaf532e60f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaf532e60eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf2a620c7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaf532e60fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaf532e60f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaf532e6106d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf2a620c7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaf532e60fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaf532e610890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaf532e6106d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf2a620c7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaf532e610a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaf532e610890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4696.06 ms /     1 runs ( 4696.06 ms per run)
whisper_print_timings:   decode time =    14.83 ms /     2 runs (    7.41 ms per run)
whisper_print_timings:   batchd time =   730.12 ms /   125 runs (    5.84 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5646.05 ms
