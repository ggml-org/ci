...
- status:  SUCCESS ✅
- runtime: 3:39.03
- date:    Thu Dec  7 17:41:50 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.38 sec
...
19/19 Test #19: test-backend-ops .................   Passed   42.63 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.22 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    8.79 sec
...
main:     load time =   135.49 ms
main:   sample time =    23.59 ms
main:  predict time =   444.60 ms / 6.95 ms per token
main:    total time =   616.16 ms
...
main:  predict time =   464.79 ms / 6.64 ms per token
main:    total time =   618.16 ms
...
main:     n_decoded =      504
main:     load time =   109.11 ms
main:   sample time =   177.91 ms
main:  predict time =  1498.50 ms
main:    total time =  1817.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd39bbfe960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd39ba7f190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a18c6efb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd39bbfe010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd39bc03900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a18c6f0940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd39ba7f190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a18c6efb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a18c6f1290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a18c6f0940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd39bbfe010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a18c6f1be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a18c6f1290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a18c6f2530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd39bbfe960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a18c6f1be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a18c6f26e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a18c6f2530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd39bc03900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a18c6f2890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a18c6f26e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    82.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.79 ms
whisper_print_timings:   sample time =    54.66 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1148.20 ms /     1 runs ( 1148.20 ms per run)
whisper_print_timings:   decode time =     9.20 ms /     2 runs (    4.60 ms per run)
whisper_print_timings:   batchd time =   206.37 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1519.76 ms
...
main:     load time =    66.47 ms
main:    total time = 10430.11 ms
embd_img
...
main:      load time =  4335.28 ms
main:    sample time =   467.54 ms / 7.31 ms per token
main:      eval time = 19460.05 ms / 278.00 ms per token
main:     total time = 24899.62 ms
...
main:      load time =  1204.20 ms
main:    sample time =   466.42 ms / 7.29 ms per token
main:      eval time =  8154.21 ms / 116.49 ms per token
main:     total time = 10203.33 ms
