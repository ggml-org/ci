...
- status:  SUCCESS ✅
- runtime: 7:53.33
- date:    Thu Dec  7 17:49:16 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.58 sec
...
19/19 Test #19: test-backend-ops .................   Passed   90.45 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 122.32 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    6.60 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.49 sec
...
main:     load time =   569.78 ms
main:   sample time =    34.98 ms
main:  predict time =   561.59 ms / 8.77 ms per token
main:    total time =  1191.04 ms
...
main:     load time =   561.51 ms
main:   sample time =    34.34 ms
main:  predict time =   554.83 ms / 7.93 ms per token
main:    total time =  1154.70 ms
...
main:     n_decoded =      504
main:     load time =   531.04 ms
main:   sample time =   234.90 ms
main:  predict time =  2207.70 ms
main:    total time =  3018.07 ms
...
main: loaded model in   394.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fca02fb6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fca02e37190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5568bcebf620                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fca02fb6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fca02fbb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5568bcec03e0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fca02e37190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5568bcebf620                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5568bcec0d30                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5568bcec03e0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fca02fb6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5568bcec1680                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5568bcec0d30                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5568bcec1fd0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fca02fb6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5568bcec1680                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5568bcec2180                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5568bcec1fd0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fca02fbb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5568bcec2330                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5568bcec2180       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   511.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.87 ms
whisper_print_timings:   sample time =    67.04 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.85 ms /     1 runs (   34.85 ms per run)
whisper_print_timings:   decode time =    13.23 ms /     2 runs (    6.62 ms per run)
whisper_print_timings:   batchd time =    84.42 ms /   125 runs (    0.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   741.39 ms
...
main:     load time =   500.26 ms
main:    total time =  7684.83 ms
embd_img
...
main:      load time =  6655.90 ms
main:    sample time =   529.37 ms / 8.27 ms per token
main:      eval time = 23274.56 ms / 332.49 ms per token
main:     total time = 31295.74 ms
...
main:      load time =  2093.22 ms
main:    sample time =   520.86 ms / 8.14 ms per token
main:      eval time = 12329.52 ms / 176.14 ms per token
main:     total time = 15572.06 ms
