...
- status:  SUCCESS ✅
- runtime: 5:29.52
- date:    Thu Dec  7 05:44:25 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/6911d40a25bb24514ceb37b0dad72d633b063f77
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.32 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.69 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   47.21 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  61.26 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.13 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed   12.32 sec
...
main:     load time =   192.21 ms
main:   sample time =    17.18 ms
main:  predict time =   823.40 ms / 12.87 ms per token
main:    total time =  1054.80 ms
...
main:     load time =   191.49 ms
main:   sample time =    17.24 ms
main:  predict time =   879.43 ms / 12.56 ms per token
main:    total time =  1091.02 ms
...
main:     n_decoded =      504
main:     load time =   160.99 ms
main:   sample time =   127.23 ms
main:  predict time =  5840.09 ms
main:    total time =  6209.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff894aa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8932b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabb7c2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff894aa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff894af900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabb7c3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8932b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabb7c2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabb7c4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaabb7c3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff894aa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabb7c4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaabb7c4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabb7c5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff894aa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaabb7c4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabb7c56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaabb7c5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff894af900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaabb7c5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaabb7c56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.81 ms
whisper_print_timings:   sample time =    65.91 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4642.68 ms /     1 runs ( 4642.68 ms per run)
whisper_print_timings:   decode time =    15.30 ms /     2 runs (    7.65 ms per run)
whisper_print_timings:   batchd time =   711.49 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5568.65 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.259000 sec.)
...
main:      load time =  5587.06 ms
main:    sample time =   533.74 ms / 8.34 ms per token
main:      eval time = 43479.04 ms / 621.13 ms per token
main:     total time = 51972.48 ms
...
main:      load time =  1579.60 ms
main:    sample time =   526.23 ms / 8.22 ms per token
main:      eval time = 17693.95 ms / 252.77 ms per token
main:     total time = 20769.82 ms
