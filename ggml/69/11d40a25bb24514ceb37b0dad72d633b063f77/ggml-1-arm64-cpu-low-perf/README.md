...
- status:  SUCCESS ✅
- runtime: 3:49.79
- date:    Thu Dec  7 05:42:10 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.26 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.84 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   55.05 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   12.63 sec
...
main:     load time =   191.06 ms
main:   sample time =    17.71 ms
main:  predict time =   837.99 ms / 13.09 ms per token
...
main:     load time =   190.21 ms
main:   sample time =    18.03 ms
main:  predict time =   914.32 ms / 13.06 ms per token
main:    total time =  1125.64 ms
...
main:     n_decoded =      504
main:     load time =   165.08 ms
main:   sample time =   130.00 ms
main:  predict time =  6022.67 ms
main:    total time =  6399.35 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8511a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84f9b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7ec5b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8511a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8511f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ec6940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84f9b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7ec5b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ec7290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ec6940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8511a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ec7be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ec7290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf7ec8530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8511a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf7ec7be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf7ec86e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf7ec8530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8511f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf7ec8890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf7ec86e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.81 ms
whisper_print_timings:   sample time =    67.28 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4700.31 ms /     1 runs ( 4700.31 ms per run)
whisper_print_timings:   decode time =    15.51 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   844.62 ms /   125 runs (    6.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5755.15 ms
...
main:     load time =    92.35 ms
main:    total time = 40266.37 ms
embd_img
