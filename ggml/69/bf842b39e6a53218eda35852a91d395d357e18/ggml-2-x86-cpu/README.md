...
- status:  SUCCESS ✅
- runtime: 2:28.81
- date:    Mon Aug 28 12:43:06 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.63 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.57 sec
      Start  2: test-opt
...
main:     load time =   197.81 ms
main:   sample time =    23.87 ms
main:  predict time =   435.38 ms / 6.80 ms per token
main:    total time =   670.18 ms
...
main:     load time =   132.96 ms
main:   sample time =    23.75 ms
main:  predict time =   464.42 ms / 6.63 ms per token
main:    total time =   624.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3e1cf598a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3e1cdda150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d6f7b88ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3e1cf58f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3e1cf5e800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d6f7b89830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3e1cdda150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d6f7b88ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d6f7b8a140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d6f7b89830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3e1cf58f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d6f7b8aa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d6f7b8a140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d6f7b8b360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3e1cf598a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d6f7b8aa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d6f7b8b4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d6f7b8b360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3e1cf5e800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d6f7b8b640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d6f7b8b4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5292.42 ms
main:    sample time =   469.74 ms / 7.34 ms per token
main:      eval time = 20409.66 ms / 291.57 ms per token
main:     total time = 26837.09 ms
...
main:      load time =  1266.52 ms
main:    sample time =   469.43 ms / 7.33 ms per token
main:      eval time =  8009.67 ms / 114.42 ms per token
main:     total time = 10124.70 ms
