...
- status:  SUCCESS ✅
- runtime: 3:34.49
- date:    Mon Aug 28 12:44:03 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/14 Test  #4: test-mul-mat0 ....................   Passed    1.11 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.44 sec
      Start  2: test-opt
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    1.07 sec
...
main:     load time =   191.56 ms
main:   sample time =    17.53 ms
main:  predict time =   812.93 ms / 12.70 ms per token
main:    total time =  1044.80 ms
...
main:  predict time =   879.36 ms / 12.56 ms per token
main:    total time =  1078.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf77a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaf5fb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf71aaab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf779f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf77f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf71ab830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaf5fb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf71aaab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf71ac140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf71ab830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf779f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf71aca50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf71ac140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf71ad360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf77a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf71aca50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf71ad4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf71ad360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf77f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf71ad640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf71ad4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12759.68 ms
main:    sample time =   632.53 ms / 9.88 ms per token
main:      eval time = 43632.86 ms / 623.33 ms per token
main:     total time = 59411.26 ms
...
main:      load time =  4354.24 ms
main:    sample time =   615.64 ms / 9.62 ms per token
main:      eval time = 17358.02 ms / 247.97 ms per token
main:     total time = 23287.76 ms
