...
- status:  SUCCESS ✅
- runtime: 2:48.95
- date:    Fri Dec 29 13:14:42 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.98 sec
...
main:  predict time =   602.29 ms / 9.41 ms per token
main:    total time =   764.86 ms
...
main:     load time =   125.91 ms
main:   sample time =    23.39 ms
main:  predict time =   626.66 ms / 8.95 ms per token
main:    total time =   778.14 ms
...
main:  predict time =  2363.67 ms
main:    total time =  2694.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa85a0f4990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa859f751a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b24ff48b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa85a0f4030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa85a0f9940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b24ff49960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa859f751a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b24ff48b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b24ff4a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b24ff49960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa85a0f4030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b24ff4ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b24ff4a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b24ff4b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa85a0f4990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b24ff4ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b24ff4b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b24ff4b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa85a0f9940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b24ff4b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b24ff4b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.24 ms
whisper_print_timings:   sample time =    73.50 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1992.25 ms /     1 runs ( 1992.25 ms per run)
whisper_print_timings:   decode time =    13.26 ms /     2 runs (    6.63 ms per run)
whisper_print_timings:   batchd time =   327.07 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2506.83 ms
