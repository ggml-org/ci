...
- status:  SUCCESS ✅
- runtime: 7:18.06
- date:    Fri Jan  5 15:33:13 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   27.70 sec
...
21/21 Test #21: test-backend-ops .................   Passed    7.84 sec
...
main:  predict time =   450.47 ms / 7.04 ms per token
main:    total time =   657.22 ms
...
main:  predict time =   468.45 ms / 6.69 ms per token
main:    total time =   618.65 ms
...
main:   sample time =   177.88 ms
main:  predict time =  1510.97 ms
main:    total time =  1829.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f76bc6f7990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f76bc5781a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cb63529b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f76bc6f7030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f76bc6fc940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cb6352a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f76bc5781a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cb63529b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cb6352b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cb6352a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f76bc6f7030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cb6352bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cb6352b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cb6352c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f76bc6f7990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cb6352bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cb6352c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cb6352c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f76bc6fc940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55cb6352c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cb6352c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   142.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.17 ms
whisper_print_timings:   sample time =    55.71 ms /   131 runs (    0.43 ms per run)
...
whisper_print_timings:   batchd time =   210.71 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1598.89 ms
...
main:      load time =  5358.02 ms
main:    sample time =   466.92 ms / 7.30 ms per token
main:      eval time = 20624.38 ms / 294.63 ms per token
main:     total time = 27117.06 ms
...
main:      load time =  1195.54 ms
main:    sample time =   464.71 ms / 7.26 ms per token
main:      eval time =  8199.36 ms / 117.13 ms per token
main:     total time = 10234.76 ms
