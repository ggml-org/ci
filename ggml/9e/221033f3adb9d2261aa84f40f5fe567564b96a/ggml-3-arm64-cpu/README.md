...
- status:  SUCCESS ✅
- runtime: 8:23.38
- date:    Fri Jan  5 03:34:04 PM UTC 2024
...
main:  predict time =   893.13 ms / 12.76 ms per token
main:    total time =  1088.59 ms
...
main:   sample time =   128.15 ms
main:  predict time =  5998.74 ms
main:    total time =  6357.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa80ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7f6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae225db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa80ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa80ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae225e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7f6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae225db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae225f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae225e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa80ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae225fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae225f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae2260580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa80ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae225fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae2260740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae2260580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa80ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae2260900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae2260740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4639.89 ms /     1 runs ( 4639.89 ms per run)
whisper_print_timings:   decode time =    15.00 ms /     2 runs (    7.50 ms per run)
whisper_print_timings:   batchd time =   705.84 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5548.37 ms
...
main:     load time =    89.72 ms
main:    total time = 39739.72 ms
embd_img
...
main:      load time =  5727.33 ms
main:    sample time =   524.33 ms / 8.19 ms per token
main:      eval time = 43707.94 ms / 624.40 ms per token
main:     total time = 52331.33 ms
...
main:      load time =  1556.11 ms
main:    sample time =   517.62 ms / 8.09 ms per token
main:      eval time = 17336.20 ms / 247.66 ms per token
main:     total time = 20383.34 ms
