...
- status:  SUCCESS ✅
- runtime: 22:40.76
- date:    Fri Jan  5 03:48:35 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.86 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   43.56 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.51 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.09 sec
...
main:  predict time =   925.71 ms / 14.46 ms per token
main:    total time =  1157.06 ms
...
main:     load time =   197.92 ms
main:   sample time =    17.85 ms
main:  predict time =   924.77 ms / 13.21 ms per token
main:    total time =  1143.63 ms
...
main:     n_decoded =      504
main:     load time =   162.90 ms
main:   sample time =   129.45 ms
main:  predict time =  6204.98 ms
main:    total time =  6579.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae53a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae3bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7a7eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae53a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae53f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae7a7f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae3bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7a7eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae7a802c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae7a7f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae53a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae7a80c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae7a802c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae7a81580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae53a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae7a80c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae7a81740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae7a81580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae53f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae7a81900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae7a81740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.49 ms
whisper_print_timings:   sample time =    66.69 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4676.06 ms /     1 runs ( 4676.06 ms per run)
whisper_print_timings:   decode time =    15.63 ms /     2 runs (    7.82 ms per run)
whisper_print_timings:   batchd time =   842.68 ms /   125 runs (    6.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5735.58 ms
