...
- status:  SUCCESS ✅
- runtime: 3:34.81
- date:    Wed Dec 27 09:48:26 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.71 sec
      Start  6: test0
 6/19 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.02 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.80 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.96 sec
...
main:  predict time =   900.83 ms / 14.08 ms per token
...
main:  predict time =   964.83 ms / 13.78 ms per token
main:    total time =  1182.14 ms
...
main:     n_decoded =      504
main:     load time =   164.78 ms
main:   sample time =   128.17 ms
main:  predict time =  6096.43 ms
main:    total time =  6471.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9532a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff951ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab10d5fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9532a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9532f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab10d60960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff951ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab10d5fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab10d612c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab10d60960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9532a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab10d61c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab10d612c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab10d62580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9532a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab10d61c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab10d62740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab10d62580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9532f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab10d62900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab10d62740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.69 ms
whisper_print_timings:   sample time =    66.88 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4749.36 ms /     1 runs ( 4749.36 ms per run)
whisper_print_timings:   decode time =    15.50 ms /     2 runs (    7.75 ms per run)
whisper_print_timings:   batchd time =   737.61 ms /   125 runs (    5.90 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5702.83 ms
...
main:     load time =    98.62 ms
main:    total time = 40375.00 ms
embd_img
