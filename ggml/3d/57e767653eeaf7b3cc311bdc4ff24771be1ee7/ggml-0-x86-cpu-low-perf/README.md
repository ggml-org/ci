...
- status:  SUCCESS ✅
- runtime: 2:48.79
- date:    Wed Dec 27 09:47:00 UTC 2023
...
main:  predict time =   602.14 ms / 9.41 ms per token
main:    total time =   768.88 ms
...
main:  predict time =   627.25 ms / 8.96 ms per token
...
main:  predict time =  2368.95 ms
main:    total time =  2698.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f837237e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f83721ff1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f51e2cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f837237e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8372383940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555f51e2d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f83721ff1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f51e2cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555f51e2e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555f51e2d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f837237e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555f51e2ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555f51e2e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555f51e2f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f837237e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555f51e2ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555f51e2f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555f51e2f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8372383940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555f51e2f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555f51e2f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.52 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.80 ms
whisper_print_timings:   sample time =    71.83 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1979.37 ms /     1 runs ( 1979.37 ms per run)
whisper_print_timings:   decode time =    12.07 ms /     2 runs (    6.03 ms per run)
whisper_print_timings:   batchd time =   321.25 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2485.15 ms
