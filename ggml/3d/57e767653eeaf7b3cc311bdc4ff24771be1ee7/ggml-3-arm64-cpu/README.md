...
- status:  SUCCESS ✅
- runtime: 5:38.19
- date:    Wed Dec 27 10:16:32 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.46 sec
      Start  6: test0
 6/19 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    0.13 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed    9.92 sec
...
main:     load time =   185.46 ms
main:   sample time =    16.98 ms
main:  predict time =   809.93 ms / 12.66 ms per token
main:    total time =  1034.23 ms
...
main:     load time =   171.62 ms
main:   sample time =    17.04 ms
main:  predict time =   876.26 ms / 12.52 ms per token
main:    total time =  1067.74 ms
...
main:  predict time =  5877.79 ms
main:    total time =  6235.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88aea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8896b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad5016b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88aea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88aef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad5017960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8896b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad5016b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad50182c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad5017960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88aea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad5018c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad50182c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad5019580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88aea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad5018c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad5019740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad5019580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88aef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad5019900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad5019740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   173.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.22 ms
whisper_print_timings:   sample time =    65.59 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4655.76 ms /     1 runs ( 4655.76 ms per run)
...
whisper_print_timings:    total time =  5636.91 ms
...
main:     load time =    83.05 ms
main:    total time = 39551.44 ms
embd_img
...
main:      load time =  9830.56 ms
main:    sample time =   517.73 ms / 8.09 ms per token
main:      eval time = 43475.81 ms / 621.08 ms per token
main:     total time = 56197.46 ms
...
main:      load time =  4359.36 ms
main:    sample time =   512.82 ms / 8.01 ms per token
main:      eval time = 17041.70 ms / 243.45 ms per token
main:     total time = 22869.60 ms
