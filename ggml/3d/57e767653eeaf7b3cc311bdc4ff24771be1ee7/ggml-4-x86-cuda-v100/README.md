...
- status:  SUCCESS ✅
- runtime: 8:11.69
- date:    Wed Dec 27 10:19:14 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/3d57e767653eeaf7b3cc311bdc4ff24771be1ee7
...
19/19 Test #19: test-backend-ops .................   Passed   59.97 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  92.09 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    8.00 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    1.10 sec
      Start 11: test-pool
11/20 Test #11: test-pool ........................   Passed    0.55 sec
      Start 12: test-conv-transpose
12/20 Test #12: test-conv-transpose ..............   Passed    0.53 sec
...
20/20 Test #20: test-backend-ops .................   Passed   23.45 sec
...
main:     load time =   566.76 ms
main:   sample time =    34.74 ms
main:  predict time =   576.33 ms / 9.01 ms per token
main:    total time =  1197.84 ms
...
main:     load time =   562.17 ms
main:   sample time =    33.69 ms
main:  predict time =   579.78 ms / 8.28 ms per token
main:    total time =  1179.76 ms
...
main:     n_decoded =      504
main:     load time =   543.97 ms
main:   sample time =   233.70 ms
main:  predict time =  2217.39 ms
main:    total time =  3039.27 ms
...
main: loaded model in   405.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5b653b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5b652371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a4858ede90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5b653b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5b653bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a4858eec60                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5b652371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a4858ede90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a4858ef5c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a4858eec60                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5b653b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a4858eff20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a4858ef5c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a4858f0880                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5b653b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a4858eff20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a4858f0a40                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a4858f0880                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5b653bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a4858f0c00                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a4858f0a40       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   497.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    24.27 ms
whisper_print_timings:   sample time =    66.16 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.51 ms /     1 runs (   34.51 ms per run)
whisper_print_timings:   decode time =    13.61 ms /     2 runs (    6.80 ms per run)
whisper_print_timings:   batchd time =    80.80 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   725.47 ms
...
main:     load time =   508.55 ms
main:    total time =  7926.30 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.637000 sec.)
...
main:      load time = 23295.70 ms
main:    sample time =   546.81 ms / 8.54 ms per token
main:      eval time = 25262.70 ms / 360.90 ms per token
main:     total time = 50028.10 ms
...
main:      load time = 11773.08 ms
main:    sample time =   539.07 ms / 8.42 ms per token
main:      eval time = 12219.62 ms / 174.57 ms per token
main:     total time = 25168.00 ms
