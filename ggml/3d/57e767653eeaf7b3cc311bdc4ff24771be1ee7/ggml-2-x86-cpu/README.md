...
- status:  SUCCESS ✅
- runtime: 6:11.45
- date:    Wed Dec 27 10:05:09 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   26.98 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.70 sec
...
main:  predict time =   432.54 ms / 6.76 ms per token
main:    total time =   640.49 ms
...
main:  predict time =   454.22 ms / 6.49 ms per token
main:    total time =   606.34 ms
...
main:     n_decoded =      504
main:     load time =   105.61 ms
main:   sample time =   177.95 ms
main:  predict time =  1478.92 ms
main:    total time =  1792.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f52cea71990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f52ce8f21a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c1fd363b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f52cea71030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f52cea76940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c1fd364960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f52ce8f21a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c1fd363b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c1fd3652c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c1fd364960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f52cea71030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c1fd365c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c1fd3652c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c1fd366580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f52cea71990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c1fd365c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c1fd366740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c1fd366580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f52cea76940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c1fd366900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c1fd366740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.80 ms
whisper_print_timings:   sample time =    54.52 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1163.04 ms /     1 runs ( 1163.04 ms per run)
whisper_print_timings:   decode time =     9.43 ms /     2 runs (    4.72 ms per run)
whisper_print_timings:   batchd time =   206.84 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1575.51 ms
...
main:      load time = 11006.51 ms
main:    sample time =   470.31 ms / 7.35 ms per token
main:      eval time = 20516.59 ms / 293.09 ms per token
main:     total time = 32674.73 ms
...
main:      load time =  4392.72 ms
main:    sample time =   465.82 ms / 7.28 ms per token
main:      eval time =  8192.62 ms / 117.04 ms per token
main:     total time = 13424.92 ms
