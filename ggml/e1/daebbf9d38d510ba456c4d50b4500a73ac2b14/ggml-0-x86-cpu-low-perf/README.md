...
- status:  SUCCESS ✅
- runtime: 3:31.32
- date:    Thu Apr 18 16:51:05 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.41 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.03 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.21 sec
      Start  9: test3
...
Total Test time (real) =  76.49 sec
...
main:  predict time =   693.60 ms / 10.84 ms per token
main:    total time =   834.76 ms
...
main:  predict time =   731.69 ms / 10.45 ms per token
main:    total time =   863.39 ms
...
main:     load time =   125.31 ms
main:   sample time =    23.78 ms
main:  predict time =   809.46 ms / 11.56 ms per token
main:    total time =   961.94 ms
...
main:     n_decoded =      504
main:     load time =   102.53 ms
main:   sample time =   177.83 ms
main:  predict time =  3091.43 ms
main:    total time =  3417.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb9cbe48990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb9cbcc91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5620ff881ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb9cbe48030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb9cbe4d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5620ff882ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb9cbcc91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5620ff881ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5620ff883410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5620ff882ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb9cbe48030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5620ff883d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5620ff883410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620ff8846d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb9cbe48990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5620ff883d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5620ff884890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620ff8846d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb9cbe4d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5620ff884a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5620ff884890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.23 ms
whisper_print_timings:   sample time =   632.30 ms /   131 runs (    4.83 ms per run)
whisper_print_timings:   encode time =  2048.38 ms /     1 runs ( 2048.38 ms per run)
whisper_print_timings:   decode time =    15.81 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   349.98 ms /   125 runs (    2.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  3149.69 ms
...
main:     load time =    71.86 ms
main:    total time = 19358.36 ms
embd_img
