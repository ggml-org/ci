...
- status:  SUCCESS ✅
- runtime: 3:10.75
- date:    Thu Apr 18 16:50:36 UTC 2024
...
17/23 Test #17: test-customop ....................   Passed    0.00 sec
      Start 18: test-xpos
18/23 Test #18: test-xpos ........................   Passed    0.01 sec
...
main:  predict time =   897.74 ms / 14.03 ms per token
main:    total time =  1092.91 ms
...
main:  predict time =   970.20 ms / 13.86 ms per token
main:    total time =  1137.80 ms
...
main:     load time =   180.77 ms
main:   sample time =    17.46 ms
main:  predict time =  1006.81 ms / 14.38 ms per token
main:    total time =  1208.18 ms
...
main:     n_decoded =      504
main:     load time =   153.25 ms
main:   sample time =   128.85 ms
main:  predict time =  6434.93 ms
main:    total time =  6799.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff965ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9643b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05181ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff965ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff965bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05182ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9643b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05181ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05183410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05182ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff965ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05183d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05183410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab051846d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff965ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05183d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05184890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab051846d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff965bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab05184a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05184890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =   746.40 ms /   131 runs (    5.70 ms per run)
whisper_print_timings:   encode time =  4678.68 ms /     1 runs ( 4678.68 ms per run)
...
whisper_print_timings:    total time =  6275.02 ms
...
main:     load time =    88.51 ms
main:    total time = 39785.68 ms
embd_img
