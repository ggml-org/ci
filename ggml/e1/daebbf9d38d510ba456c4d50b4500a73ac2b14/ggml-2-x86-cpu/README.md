...
- status:  SUCCESS ✅
- runtime: 2:11.00
- date:    Thu Apr 18 16:49:37 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.52 sec
...
main:     load time =   161.09 ms
main:   sample time =    23.96 ms
main:  predict time =   494.79 ms / 7.73 ms per token
main:    total time =   692.33 ms
...
main:  predict time =   518.09 ms / 7.40 ms per token
main:    total time =   649.99 ms
...
main:  predict time =   536.44 ms / 7.66 ms per token
main:    total time =   690.63 ms
...
main:  predict time =  1877.48 ms
main:    total time =  2192.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7febc814c990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7febc7fcd1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e6c2acfce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7febc814c030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7febc8151940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e6c2ad0ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7febc7fcd1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e6c2acfce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e6c2ad1410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e6c2ad0ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7febc814c030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e6c2ad1d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e6c2ad1410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e6c2ad26d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7febc814c990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e6c2ad1d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e6c2ad2890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e6c2ad26d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7febc8151940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e6c2ad2a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e6c2ad2890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    15.57 ms
whisper_print_timings:   sample time =   457.58 ms /   131 runs (    3.49 ms per run)
whisper_print_timings:   encode time =  1186.93 ms /     1 runs ( 1186.93 ms per run)
whisper_print_timings:   decode time =    12.48 ms /     2 runs (    6.24 ms per run)
whisper_print_timings:   batchd time =   219.02 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2003.75 ms
...
main:     load time =    64.66 ms
main:    total time = 10592.07 ms
embd_img
