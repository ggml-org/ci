...
- status:  SUCCESS ✅
- runtime: 4:08.30
- date:    Thu Apr 18 04:51:38 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    5.18 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   33.40 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.78 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.18 sec
      Start  9: test3
...
Total Test time (real) =  81.42 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.85 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   17.36 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.89 sec
      Start  4: test-mul-mat0
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.48 sec
      Start  9: test3
...
main:     load time =   157.34 ms
main:   sample time =    17.51 ms
main:  predict time =   908.99 ms / 14.20 ms per token
main:    total time =  1105.47 ms
...
main:     load time =   157.00 ms
main:   sample time =    17.55 ms
main:  predict time =   990.28 ms / 14.15 ms per token
main:    total time =  1167.65 ms
...
main:     load time =   185.08 ms
main:   sample time =    17.39 ms
main:  predict time =  1034.22 ms / 14.77 ms per token
main:    total time =  1240.10 ms
...
main:     n_decoded =      504
main:     load time =   157.47 ms
main:   sample time =   128.94 ms
main:  predict time =  6500.66 ms
main:    total time =  6869.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff803fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8027b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabef7fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff803fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff803ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabef80ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8027b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabef7fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabef81410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabef80ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff803fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabef81d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabef81410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabef826d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff803fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabef81d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabef82890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabef826d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff803ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaabef82a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabef82890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.54 ms
whisper_print_timings:   sample time =   744.41 ms /   131 runs (    5.68 ms per run)
whisper_print_timings:   encode time =  4691.34 ms /     1 runs ( 4691.34 ms per run)
whisper_print_timings:   decode time =    14.69 ms /     2 runs (    7.34 ms per run)
whisper_print_timings:   batchd time =   713.78 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6301.88 ms
...
main:     load time =    91.21 ms
main:    total time = 39928.22 ms
embd_img
