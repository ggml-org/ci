...
- status:  SUCCESS ✅
- runtime: 2:57.87
- date:    Sun Nov 12 14:02:00 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/e19c3bd08cd2742386623221c7bb741b655d9ad5
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.25 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.14 sec
      Start  2: test-opt
 2/18 Test  #2: test-opt .........................   Passed    1.62 sec
...
main:     load time =   173.21 ms
main:   sample time =    23.76 ms
main:  predict time =   435.18 ms / 6.80 ms per token
main:    total time =   644.80 ms
...
main:     n_decoded =      504
main:     load time =   103.09 ms
main:   sample time =   177.65 ms
main:  predict time =  1467.52 ms
main:    total time =  1779.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcdbd0c3960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcdbcf44190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556d3bc58b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcdbd0c3010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcdbd0c8900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556d3bc59940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcdbcf44190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556d3bc58b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556d3bc5a290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556d3bc59940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcdbd0c3010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556d3bc5abe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556d3bc5a290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556d3bc5b530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcdbd0c3960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556d3bc5abe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556d3bc5b6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556d3bc5b530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcdbd0c8900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556d3bc5b890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556d3bc5b6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.98 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.46 ms
whisper_print_timings:   sample time =    16.78 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  1172.89 ms /     1 runs ( 1172.89 ms per run)
whisper_print_timings:   decode time =    94.72 ms /    27 runs (    3.51 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1431.37 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.467000 sec.)
...
main:      load time =  5525.93 ms
main:    sample time =   469.27 ms / 7.33 ms per token
main:      eval time = 20467.73 ms / 292.40 ms per token
main:     total time = 27129.00 ms
...
main:      load time =  1210.44 ms
main:    sample time =   467.00 ms / 7.30 ms per token
main:      eval time =  8054.49 ms / 115.06 ms per token
main:     total time = 10107.82 ms
