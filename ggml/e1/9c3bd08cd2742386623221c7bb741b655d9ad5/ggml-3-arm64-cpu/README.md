...
- status:  SUCCESS ✅
- runtime: 4:36.64
- date:    Sun Nov 12 02:03:35 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.19 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.54 sec
      Start  6: test0
...
Total Test time (real) =  13.73 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.05 sec
      Start  2: test-opt
 ...
 5/18 Test  #5: test-mul-mat0 ....................   Passed    0.52 sec
...
main:     load time =   205.03 ms
main:   sample time =    16.98 ms
main:  predict time =   807.90 ms / 12.62 ms per token
main:    total time =  1052.43 ms
...
main:     load time =   176.31 ms
main:   sample time =    16.97 ms
main:  predict time =   878.06 ms / 12.54 ms per token
main:    total time =  1074.22 ms
...
main:     n_decoded =      504
main:     load time =   147.48 ms
main:   sample time =   128.55 ms
main:  predict time =  5834.67 ms
main:    total time =  6191.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb477a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb45fb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf866eb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb477a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb477f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf866f940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb45fb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf866eb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8670290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf866f940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb477a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8670be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8670290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8671530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb477a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8670be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf86716e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8671530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb477f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf8671890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf86716e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   184.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    19.67 ms /    27 runs (    0.73 ms per run)
whisper_print_timings:   encode time =  4636.40 ms /     1 runs ( 4636.40 ms per run)
whisper_print_timings:   decode time =   188.54 ms /    27 runs (    6.98 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5045.90 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.253000 sec.)
...
main:      load time =  5839.00 ms
main:    sample time =   533.43 ms / 8.33 ms per token
main:      eval time = 43462.59 ms / 620.89 ms per token
main:     total time = 52209.43 ms
...
main:      load time =  1500.33 ms
main:    sample time =   524.91 ms / 8.20 ms per token
main:      eval time = 17475.63 ms / 249.65 ms per token
main:     total time = 20470.24 ms
