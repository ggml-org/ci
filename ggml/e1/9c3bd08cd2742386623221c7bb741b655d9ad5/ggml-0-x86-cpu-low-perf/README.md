...
- status:  SUCCESS ✅
- runtime: 2:03.46
- date:    Sun Nov 12 14:01:03 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.32 sec
      Start  2: test-quantize-fns
...
main:  predict time =   604.41 ms / 9.44 ms per token
main:    total time =   766.56 ms
...
main:  predict time =   634.90 ms / 9.07 ms per token
main:    total time =   786.17 ms
...
main:   sample time =   178.95 ms
main:  predict time =  2380.54 ms
main:    total time =  2788.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98e6956960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98e67d7190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56214dcc6b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98e6956010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98e695b900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56214dcc7940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98e67d7190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56214dcc6b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56214dcc8290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56214dcc7940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98e6956010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56214dcc8be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56214dcc8290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56214dcc9530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98e6956960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56214dcc8be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56214dcc96e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56214dcc9530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98e695b900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56214dcc9890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56214dcc96e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.10 ms
whisper_print_timings:   sample time =    16.32 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  2084.58 ms /     1 runs ( 2084.58 ms per run)
whisper_print_timings:   decode time =   134.51 ms /    27 runs (    4.98 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2336.02 ms
...
main:     load time =    70.57 ms
main:    total time = 18891.57 ms
embd_img
