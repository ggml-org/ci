...
- status:  SUCCESS ✅
- runtime: 2:35.46
- date:    Sun Nov 12 02:01:28 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.28 sec
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.90 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.51 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.53 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.59 sec
      Start  9: test3
...
main:     load time =   195.31 ms
main:   sample time =    17.86 ms
main:  predict time =   842.55 ms / 13.16 ms per token
main:    total time =  1077.90 ms
...
main:     load time =   197.94 ms
main:   sample time =    17.71 ms
main:  predict time =   912.30 ms / 13.03 ms per token
main:    total time =  1131.07 ms
...
main:     n_decoded =      504
main:     load time =   160.07 ms
main:   sample time =   133.33 ms
main:  predict time =  5910.83 ms
main:    total time =  6360.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff86b0a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8698b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab09d44b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86b0a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff86b0f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab09d45940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8698b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab09d44b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab09d46290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab09d45940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86b0a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab09d46be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab09d46290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab09d47530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff86b0a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab09d46be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab09d476e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab09d47530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff86b0f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab09d47890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab09d476e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.03 ms
whisper_print_timings:   sample time =    19.57 ms /    27 runs (    0.72 ms per run)
whisper_print_timings:   encode time =  4709.77 ms /     1 runs ( 4709.77 ms per run)
whisper_print_timings:   decode time =   192.06 ms /    27 runs (    7.11 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5051.08 ms
...
main:     load time =    90.95 ms
main:    total time = 40138.96 ms
embd_img
