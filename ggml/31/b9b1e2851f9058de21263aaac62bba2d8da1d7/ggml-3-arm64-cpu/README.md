...
- status:  SUCCESS ✅
- runtime: 4:44.01
- date:    Mon Oct 16 12:32:54 PM UTC 2023
...
main:     load time =   241.23 ms
main:   sample time =    17.09 ms
main:  predict time =   802.58 ms / 12.54 ms per token
main:    total time =  1083.88 ms
...
main:  predict time =   869.97 ms / 12.43 ms per token
...
main:     n_decoded =      504
main:     load time =   139.37 ms
main:   sample time =   128.55 ms
main:  predict time =  5862.46 ms
main:    total time =  6212.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0ffa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0e7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbe83ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0ff9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0fff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadbe84870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0e7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbe83ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadbe851a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadbe84870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0ff9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadbe85ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadbe851a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadbe86400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0ffa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadbe85ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadbe86590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadbe86400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0fff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadbe86720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadbe86590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   204.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.60 ms
whisper_print_timings:   sample time =    20.95 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4601.87 ms /     1 runs ( 4601.87 ms per run)
whisper_print_timings:   decode time =   180.28 ms /    27 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5072.70 ms
...
main:     load time =    73.83 ms
main:    total time = 39330.14 ms
embd_img
...
main:      load time = 12589.85 ms
main:    sample time =   523.28 ms / 8.18 ms per token
main:      eval time = 43583.17 ms / 622.62 ms per token
main:     total time = 59069.48 ms
...
main:      load time =  4327.80 ms
main:    sample time =   515.89 ms / 8.06 ms per token
main:      eval time = 17515.01 ms / 250.21 ms per token
main:     total time = 23321.33 ms
