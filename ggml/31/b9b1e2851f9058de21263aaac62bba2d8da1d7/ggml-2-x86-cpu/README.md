...
- status:  SUCCESS ✅
- runtime: 3:08.87
- date:    Mon Oct 16 12:31:15 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.81 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.70 sec
      Start  2: test-opt
...
main:     load time =   171.41 ms
main:   sample time =    23.99 ms
main:  predict time =   479.72 ms / 7.50 ms per token
main:    total time =   688.79 ms
...
main:     load time =   120.60 ms
main:   sample time =    24.02 ms
main:  predict time =   503.17 ms / 7.19 ms per token
main:    total time =   650.84 ms
...
main:     n_decoded =      504
main:     load time =   115.52 ms
main:   sample time =   178.30 ms
main:  predict time =  1500.66 ms
main:    total time =  1828.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbe1189d900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbe1171e170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5614ba026ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbe1189cfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbe118a2880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5614ba027870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbe1171e170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5614ba026ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5614ba0281a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5614ba027870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbe1189cfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5614ba028ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5614ba0281a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5614ba029400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbe1189d900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5614ba028ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5614ba029590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5614ba029400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbe118a2880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5614ba029720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5614ba029590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   144.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.45 ms
whisper_print_timings:   sample time =    16.59 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1157.42 ms /     1 runs ( 1157.42 ms per run)
whisper_print_timings:   decode time =   107.08 ms /    27 runs (    3.97 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1484.27 ms
...
main:     load time =    66.04 ms
main:    total time = 10591.88 ms
embd_img
...
main:      load time =  8812.41 ms
main:    sample time =   464.10 ms / 7.25 ms per token
main:      eval time = 22010.50 ms / 314.44 ms per token
main:     total time = 31971.51 ms
...
main:      load time =  2566.11 ms
main:    sample time =   459.41 ms / 7.18 ms per token
main:      eval time =  8624.09 ms / 123.20 ms per token
main:     total time = 12036.48 ms
