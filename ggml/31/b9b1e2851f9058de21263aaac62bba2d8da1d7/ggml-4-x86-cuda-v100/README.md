...
- status:  SUCCESS ✅
- runtime: 5:30.33
- date:    Mon Oct 16 12:33:28 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/14 Test  #4: test-mul-mat0 ....................   Passed    0.74 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.77 sec
      Start  2: test-opt
...
main:     load time =   228.03 ms
main:   sample time =    35.16 ms
main:  predict time =   597.23 ms / 9.33 ms per token
main:    total time =   880.71 ms
...
main:     load time =   155.88 ms
main:   sample time =    35.19 ms
main:  predict time =   609.46 ms / 8.71 ms per token
main:    total time =   805.42 ms
...
main:   sample time =   239.88 ms
main:  predict time =  2321.57 ms
main:    total time =  2771.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f06e4f83900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f06e4e04170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d2ef801ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f06e4f82fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f06e4f88880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d2ef802870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f06e4e04170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d2ef801ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d2ef8031a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d2ef802870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f06e4f82fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d2ef803ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d2ef8031a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d2ef804400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f06e4f83900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d2ef803ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d2ef804590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d2ef804400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f06e4f88880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d2ef804720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d2ef804590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   448.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    25.06 ms
whisper_print_timings:   sample time =    20.64 ms /    27 runs (    0.76 ms per run)
whisper_print_timings:   encode time =  1856.07 ms /     1 runs ( 1856.07 ms per run)
whisper_print_timings:   decode time =   134.79 ms /    27 runs (    4.99 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2553.16 ms
...
main:     load time =   100.86 ms
main:    total time = 16777.55 ms
embd_img
...
main:      load time =  7236.67 ms
main:    sample time =   597.88 ms / 9.34 ms per token
main:      eval time = 26187.42 ms / 374.11 ms per token
main:     total time = 34960.16 ms
...
main:      load time =  1665.94 ms
main:    sample time =   583.30 ms / 9.11 ms per token
main:      eval time = 12514.08 ms / 178.77 ms per token
main:     total time = 15410.46 ms
