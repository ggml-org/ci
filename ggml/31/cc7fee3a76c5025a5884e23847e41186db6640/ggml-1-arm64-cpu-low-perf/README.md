...
- status:  SUCCESS ✅
- runtime: 3:55.84
- date:    Wed Dec 13 04:13:02 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   58.93 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.33 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   13.66 sec
...
main:     load time =   195.13 ms
main:   sample time =    17.95 ms
main:  predict time =   838.67 ms / 13.10 ms per token
main:    total time =  1074.05 ms
...
main:     load time =   195.42 ms
main:   sample time =    17.73 ms
main:  predict time =   905.51 ms / 12.94 ms per token
main:    total time =  1121.73 ms
...
main:     n_decoded =      504
main:     load time =   163.23 ms
main:   sample time =   132.53 ms
main:  predict time =  6123.81 ms
main:    total time =  6501.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaeada9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae95b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff5a2ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaeada050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaeadf980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaff5a3980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae95b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff5a2ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaff5a42f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaff5a3980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaeada050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaff5a4c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaff5a42f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaff5a55d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaeada9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaff5a4c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaff5a57a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaff5a55d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaeadf980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaff5a5970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaff5a57a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.87 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.33 ms
whisper_print_timings:   sample time =    66.84 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4788.56 ms /     1 runs ( 4788.56 ms per run)
whisper_print_timings:   decode time =    15.38 ms /     2 runs (    7.69 ms per run)
whisper_print_timings:   batchd time =   713.65 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5717.16 ms
...
main:     load time =   101.46 ms
main:    total time = 40490.56 ms
embd_img
