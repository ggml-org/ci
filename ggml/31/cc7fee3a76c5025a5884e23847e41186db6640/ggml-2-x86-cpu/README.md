...
- status:  SUCCESS ✅
- runtime: 3:59.41
- date:    Wed Dec 13 16:17:29 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.44 sec
...
19/19 Test #19: test-backend-ops .................   Passed   36.60 sec
...
20/20 Test #20: test-backend-ops .................   Passed   11.47 sec
...
main:     load time =   192.92 ms
main:   sample time =    23.44 ms
main:  predict time =   437.26 ms / 6.83 ms per token
main:    total time =   666.29 ms
...
main:  predict time =  1469.02 ms
main:    total time =  1779.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5909d859c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5909c061b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5638b9172ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5909d85050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5909d8a980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5638b9173980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5909c061b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5638b9172ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5638b91742f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5638b9173980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5909d85050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5638b9174c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5638b91742f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5638b91755d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5909d859c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5638b9174c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5638b91757a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5638b91755d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5909d8a980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5638b9175970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5638b91757a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   130.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.95 ms
whisper_print_timings:   sample time =    55.53 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.12 ms /     1 runs ( 1159.12 ms per run)
whisper_print_timings:   decode time =     9.82 ms /     2 runs (    4.91 ms per run)
whisper_print_timings:   batchd time =   212.04 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1586.46 ms
...
main:      load time = 11160.51 ms
main:    sample time =   468.45 ms / 7.32 ms per token
main:      eval time = 20332.19 ms / 290.46 ms per token
main:     total time = 32625.51 ms
...
main:      load time =  2960.56 ms
main:    sample time =   466.07 ms / 7.28 ms per token
main:      eval time =  8107.28 ms / 115.82 ms per token
main:     total time = 11921.46 ms
