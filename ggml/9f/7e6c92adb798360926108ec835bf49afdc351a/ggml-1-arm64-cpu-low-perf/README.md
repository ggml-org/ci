...
- status:  SUCCESS ✅
- runtime: 2:36.23
- date:    Sun Nov 12 02:32:15 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/9f7e6c92adb798360926108ec835bf49afdc351a
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.03 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.69 sec
      Start  6: test0
 6/17 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.47 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.50 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.39 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.21 sec
      Start  9: test3
...
Total Test time (real) =  17.53 sec
...
main:     load time =   189.61 ms
main:   sample time =    18.72 ms
main:  predict time =   838.34 ms / 13.10 ms per token
main:    total time =  1068.73 ms
...
main:     load time =   189.07 ms
main:   sample time =    17.50 ms
main:  predict time =   909.80 ms / 13.00 ms per token
main:    total time =  1119.31 ms
...
main:     n_decoded =      504
main:     load time =   160.13 ms
main:   sample time =   127.91 ms
main:  predict time =  5992.83 ms
main:    total time =  6362.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb616a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb5feb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4edab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb616a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb616f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad4edb940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb5feb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4edab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad4edc290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad4edb940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb616a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad4edcbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad4edc290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad4edd530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb616a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad4edcbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad4edd6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad4edd530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb616f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad4edd890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad4edd6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    13.58 ms
whisper_print_timings:   sample time =    19.57 ms /    27 runs (    0.72 ms per run)
whisper_print_timings:   encode time =  4717.84 ms /     1 runs ( 4717.84 ms per run)
whisper_print_timings:   decode time =   192.20 ms /    27 runs (    7.12 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5062.04 ms
...
main:     load time =    90.11 ms
main:    total time = 39990.43 ms
embd_img
