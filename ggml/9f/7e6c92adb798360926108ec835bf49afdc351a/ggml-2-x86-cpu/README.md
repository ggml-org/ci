...
- status:  SUCCESS ✅
- runtime: 2:44.17
- date:    Sun Nov 12 14:32:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.27 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.18 sec
      Start  2: test-opt
 2/18 Test  #2: test-opt .........................   Passed    1.61 sec
...
main:     load time =   121.71 ms
main:   sample time =    23.73 ms
main:  predict time =   459.75 ms / 7.18 ms per token
main:    total time =   617.58 ms
...
main:  predict time =   453.86 ms / 6.48 ms per token
main:    total time =   601.00 ms
...
main:     n_decoded =      504
main:     load time =   101.76 ms
main:   sample time =   177.45 ms
main:  predict time =  1440.69 ms
main:    total time =  1749.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd3992b2960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd399133190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b0e4ecfb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd3992b2010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd3992b7900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b0e4ed0940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd399133190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b0e4ecfb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b0e4ed1290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b0e4ed0940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd3992b2010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b0e4ed1be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b0e4ed1290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b0e4ed2530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd3992b2960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b0e4ed1be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b0e4ed26e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b0e4ed2530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd3992b7900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b0e4ed2890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b0e4ed26e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    81.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.69 ms
whisper_print_timings:   sample time =    16.33 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1132.29 ms /     1 runs ( 1132.29 ms per run)
whisper_print_timings:   decode time =    95.09 ms /    27 runs (    3.52 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1342.10 ms
...
main:     load time =    69.65 ms
main:    total time = 10414.18 ms
embd_img
...
main:      load time =  4442.74 ms
main:    sample time =   469.69 ms / 7.34 ms per token
main:      eval time = 19286.97 ms / 275.53 ms per token
main:     total time = 24853.47 ms
...
main:      load time =  1233.16 ms
main:    sample time =   467.17 ms / 7.30 ms per token
main:      eval time =  8204.71 ms / 117.21 ms per token
main:     total time = 10283.59 ms
