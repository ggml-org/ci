...
- status:  SUCCESS ✅
- runtime: 4:27.81
- date:    Sun Nov 12 02:34:08 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.57 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.10 sec
      Start  2: test-opt
...
main:     load time =   181.03 ms
main:   sample time =    16.92 ms
main:  predict time =   809.94 ms / 12.66 ms per token
main:    total time =  1030.35 ms
...
main:     load time =   180.59 ms
main:   sample time =    17.40 ms
main:  predict time =   879.49 ms / 12.56 ms per token
main:    total time =  1080.39 ms
...
main:   sample time =   127.26 ms
main:  predict time =  5829.63 ms
main:    total time =  6186.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb291a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb279b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4fb2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb291a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb291f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf4fb3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb279b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4fb2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf4fb4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf4fb3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb291a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf4fb4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf4fb4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf4fb5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb291a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf4fb4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf4fb56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf4fb5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb291f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf4fb5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf4fb56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.77 ms
whisper_print_timings:   sample time =    19.68 ms /    27 runs (    0.73 ms per run)
whisper_print_timings:   encode time =  4635.76 ms /     1 runs ( 4635.76 ms per run)
whisper_print_timings:   decode time =   189.59 ms /    27 runs (    7.02 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  4978.75 ms
...
main:      load time =  5616.77 ms
main:    sample time =   535.53 ms / 8.37 ms per token
main:      eval time = 43615.38 ms / 623.08 ms per token
main:     total time = 52141.50 ms
...
main:      load time =  1583.63 ms
main:    sample time =   527.19 ms / 8.24 ms per token
main:      eval time = 17514.86 ms / 250.21 ms per token
main:     total time = 20594.38 ms
