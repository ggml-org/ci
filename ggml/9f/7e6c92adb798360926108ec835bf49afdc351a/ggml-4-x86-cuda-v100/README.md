...
- status:  SUCCESS ✅
- runtime: 5:51.53
- date:    Sun Nov 12 14:35:24 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    6.26 sec
      Start  2: test-quantize-fns
 2/17 Test  #2: test-quantize-fns ................   Passed    0.56 sec
      Start  3: test-quantize-perf
 3/17 Test  #3: test-quantize-perf ...............   Passed    0.76 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    6.30 sec
      Start  2: test-opt
 ...
 6/18 Test  #6: test-mul-mat2 ....................   Passed    3.27 sec
      Start  7: test0
 7/18 Test  #7: test0 ............................   Passed    0.56 sec
      Start  8: test1
 8/18 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/18 Test  #9: test2 ............................   Passed    7.81 sec
      Start 10: test3
...
main:     load time =   563.04 ms
main:   sample time =    34.85 ms
main:  predict time =   598.40 ms / 9.35 ms per token
main:    total time =  1220.38 ms
...
main:     load time =   556.65 ms
main:   sample time =    36.09 ms
main:  predict time =   604.53 ms / 8.64 ms per token
main:    total time =  1201.01 ms
...
main:     n_decoded =      504
main:     load time =   519.91 ms
main:   sample time =   236.94 ms
main:  predict time =  2188.66 ms
main:    total time =  2988.89 ms
...
main: loaded model in   379.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5c72fb6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5c72e37190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f3c01737a0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5c72fb6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5c72fbb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f3c0174560                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5c72e37190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f3c01737a0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f3c0174eb0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f3c0174560                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5c72fb6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f3c0175800                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f3c0174eb0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f3c0176150                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5c72fb6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f3c0175800                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f3c0176300                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f3c0176150                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5c72fbb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f3c01764b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f3c0176300       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   487.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.67 ms
whisper_print_timings:   sample time =    20.52 ms /    27 runs (    0.76 ms per run)
whisper_print_timings:   encode time =   486.19 ms /     1 runs (  486.19 ms per run)
whisper_print_timings:   decode time =   129.07 ms /    27 runs (    4.78 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1147.80 ms
...
main:     load time =   482.40 ms
main:    total time =  7688.37 ms
embd_img
...
main:      load time =  6528.22 ms
main:    sample time =   516.68 ms / 8.07 ms per token
main:      eval time = 23240.61 ms / 332.01 ms per token
main:     total time = 31137.09 ms
...
main:      load time =  2050.96 ms
main:    sample time =   507.29 ms / 7.93 ms per token
main:      eval time = 12231.02 ms / 174.73 ms per token
main:     total time = 15442.48 ms
