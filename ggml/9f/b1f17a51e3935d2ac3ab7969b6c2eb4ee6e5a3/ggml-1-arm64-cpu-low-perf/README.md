...
- status:  SUCCESS ✅
- runtime: 6:20.34
- date:    Wed Feb 28 11:05:50 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed   13.20 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed   10.06 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.98 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  135.48 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 196.16 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.76 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   31.07 sec
...
main:  predict time =   910.11 ms / 14.22 ms per token
main:    total time =  1105.23 ms
...
main:  predict time =   990.43 ms / 14.15 ms per token
main:    total time =  1166.96 ms
...
main:     load time =   184.70 ms
main:   sample time =    17.08 ms
main:  predict time =  1006.86 ms / 14.38 ms per token
main:    total time =  1211.73 ms
...
main:  predict time =  6784.54 ms
main:    total time =  7152.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8713a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86fbb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5b54ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8713a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8713f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf5b55ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86fbb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5b54ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf5b56410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf5b55ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8713a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf5b56d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf5b56410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf5b576d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8713a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf5b56d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5b57890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf5b576d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8713f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf5b57a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5b57890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4852.52 ms /     1 runs ( 4852.52 ms per run)
whisper_print_timings:   decode time =    15.53 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   718.04 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5779.60 ms
...
main:     load time =    89.12 ms
main:    total time = 40520.43 ms
embd_img
