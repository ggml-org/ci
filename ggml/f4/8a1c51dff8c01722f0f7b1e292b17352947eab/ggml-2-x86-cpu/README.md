...
- status:  SUCCESS ✅
- runtime: 2:49.20
- date:    Thu Nov 30 15:11:29 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.35 sec
...
19/19 Test #19: test-backend-ops .................   Passed    1.02 sec
...
main:  predict time =   459.31 ms / 6.56 ms per token
main:    total time =   609.20 ms
...
main:     n_decoded =      504
main:     load time =   101.44 ms
main:   sample time =   175.07 ms
main:  predict time =  1451.71 ms
main:    total time =  1757.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f860fb01960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f860f982190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555559b90b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f860fb01010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f860fb06900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555559b91940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f860f982190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555559b90b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555559b92290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555559b91940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f860fb01010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555559b92be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555559b92290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555559b93530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f860fb01960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555559b92be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555559b936e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555559b93530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f860fb06900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555559b93890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555559b936e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    81.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    53.96 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1142.96 ms /     1 runs ( 1142.96 ms per run)
whisper_print_timings:   decode time =     9.33 ms /     2 runs (    4.66 ms per run)
whisper_print_timings:   batchd time =   205.54 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1510.67 ms
...
main:     load time =    69.91 ms
main:    total time = 10459.44 ms
embd_img
...
main:      load time =  4896.29 ms
main:    sample time =   471.21 ms / 7.36 ms per token
main:      eval time = 19951.06 ms / 285.02 ms per token
main:     total time = 25997.85 ms
...
main:      load time =  1196.88 ms
main:    sample time =   466.64 ms / 7.29 ms per token
main:      eval time =  8022.44 ms / 114.61 ms per token
main:     total time = 10057.73 ms
