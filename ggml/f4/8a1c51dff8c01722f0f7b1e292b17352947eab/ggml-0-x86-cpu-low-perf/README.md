...
- status:  SUCCESS ✅
- runtime: 2:06.72
- date:    Thu Nov 30 15:10:56 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f48a1c51dff8c01722f0f7b1e292b17352947eab
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.52 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.71 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.62 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed    1.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.46 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.74 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.62 sec
      Start 10: test-pool
...
main:     load time =   127.05 ms
main:   sample time =    23.88 ms
main:  predict time =   609.14 ms / 9.52 ms per token
main:    total time =   772.55 ms
...
main:     load time =   124.67 ms
main:   sample time =    23.79 ms
main:  predict time =   624.24 ms / 8.92 ms per token
main:    total time =   774.76 ms
...
main:  predict time =  2368.24 ms
main:    total time =  2692.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd59989a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd59971b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5619ff27cb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd59989a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd59989f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5619ff27d940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd59971b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5619ff27cb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5619ff27e290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5619ff27d940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd59989a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5619ff27ebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5619ff27e290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5619ff27f530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd59989a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5619ff27ebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5619ff27f6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5619ff27f530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd59989f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5619ff27f890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5619ff27f6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.99 ms
whisper_print_timings:   sample time =    70.84 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1983.93 ms /     1 runs ( 1983.93 ms per run)
whisper_print_timings:   decode time =    12.71 ms /     2 runs (    6.36 ms per run)
whisper_print_timings:   batchd time =   329.88 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2500.86 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.482000 sec.)
