...
- status:  SUCCESS ✅
- runtime: 2:40.67
- date:    Thu Nov 30 03:11:34 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.90 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.19 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.45 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    0.37 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  17.77 sec
...
main:     load time =   187.16 ms
main:   sample time =    17.13 ms
main:  predict time =   824.75 ms / 12.89 ms per token
main:    total time =  1050.79 ms
...
main:  predict time =   889.87 ms / 12.71 ms per token
...
main:     n_decoded =      504
main:     load time =   159.75 ms
main:   sample time =   128.51 ms
main:  predict time =  6002.08 ms
main:    total time =  6371.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaa4ca960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa34b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9ef0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaa4ca010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaa4cf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ef1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa34b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9ef0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ef2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ef1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaa4ca010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ef2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ef2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf9ef3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaa4ca960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ef2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf9ef36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf9ef3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaa4cf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf9ef3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf9ef36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4762.28 ms /     1 runs ( 4762.28 ms per run)
whisper_print_timings:   decode time =    15.30 ms /     2 runs (    7.65 ms per run)
whisper_print_timings:   batchd time =   713.07 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5684.07 ms
