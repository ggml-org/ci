...
- status:  SUCCESS ✅
- runtime: 4:30.63
- date:    Thu Nov 30 03:13:22 PM UTC 2023
...
main:  predict time =   879.06 ms / 12.56 ms per token
...
main:  predict time =  5827.66 ms
main:    total time =  6187.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb5c3a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb5abb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0940cb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb5c3a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb5c3f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0940d940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb5abb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0940cb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0940e290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0940d940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb5c3a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0940ebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0940e290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0940f530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb5c3a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0940ebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0940f6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0940f530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb5c3f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0940f890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0940f6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.22 ms
whisper_print_timings:   sample time =    65.78 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4653.22 ms /     1 runs ( 4653.22 ms per run)
whisper_print_timings:   decode time =    15.52 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   714.94 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5581.00 ms
...
main:      load time =  5653.89 ms
main:    sample time =   532.53 ms / 8.32 ms per token
main:      eval time = 43859.81 ms / 626.57 ms per token
main:     total time = 52418.92 ms
...
main:      load time =  1605.33 ms
main:    sample time =   527.70 ms / 8.25 ms per token
main:      eval time = 17548.94 ms / 250.70 ms per token
main:     total time = 20650.60 ms
