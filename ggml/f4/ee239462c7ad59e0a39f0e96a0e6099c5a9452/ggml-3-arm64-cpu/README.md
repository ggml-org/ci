...
- status:  SUCCESS ✅
- runtime: 3:09.90
- date:    Sun Jun 16 10:46:28 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f4ee239462c7ad59e0a39f0e96a0e6099c5a9452
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.51 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.31 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed   10.08 sec
      Start  4: test-mul-mat0
 4/21 Test  #4: test-mul-mat0 ....................   Passed    0.55 sec
      Start  5: test-mul-mat2
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.46 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/22 Test  #6: test-mul-mat2 ....................   Passed    1.79 sec
      Start  7: test0
 7/22 Test  #7: test0 ............................   Passed    0.00 sec
      Start  8: test1
 8/22 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
...
main:     load time =   161.85 ms
main:   sample time =    19.20 ms
main:  predict time =   891.53 ms / 13.93 ms per token
main:    total time =  1095.76 ms
...
main:  predict time =   958.13 ms / 13.69 ms per token
main:    total time =  1137.97 ms
...
main:     load time =   191.15 ms
main:   sample time =    20.85 ms
main:  predict time =   966.36 ms / 13.81 ms per token
main:    total time =  1181.67 ms
...
main:     n_decoded =      504
main:     load time =   165.10 ms
main:   sample time =   129.17 ms
main:  predict time =  6107.06 ms
main:    total time =  6484.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfaecb895a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfaecb87db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbc709fbedce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfaecb895a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfaecb895f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbc709fbeeab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfaecb87db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbc709fbedce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbc709fbef410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbc709fbeeab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfaecb895a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbc709fbefd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbc709fbef410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbc709fbf06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfaecb895a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbc709fbefd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbc709fbf0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbc709fbf06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfaecb895f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbc709fbf0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbc709fbf0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =    68.87 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4719.08 ms /     1 runs ( 4719.08 ms per run)
whisper_print_timings:   decode time =    15.20 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   734.88 ms /   125 runs (    5.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5683.68 ms
...
main:     load time =    94.47 ms
main:    total time = 40053.96 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.281000 sec.)
