...
- status:  SUCCESS ✅
- runtime: 4:03.32
- date:    Sun Jun 16 10:47:16 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.66 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.39 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed   10.10 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test2 ............................   Passed   21.22 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.63 sec
      Start 10: test-pool
...
main:  predict time =   898.61 ms / 14.04 ms per token
main:    total time =  1086.70 ms
...
main:  predict time =   980.72 ms / 14.01 ms per token
main:    total time =  1153.54 ms
...
main:  predict time =   962.29 ms / 13.75 ms per token
main:    total time =  1165.97 ms
...
main:   sample time =   129.41 ms
main:  predict time =  6108.93 ms
main:    total time =  6469.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xedb402fba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xedb402e3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8c830960ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xedb402fba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xedb402fbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8c830961ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xedb402e3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8c830960ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8c830962410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8c830961ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xedb402fba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8c830962d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8c830962410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8c8309636d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xedb402fba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8c830962d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8c830963890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8c8309636d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xedb402fbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb8c830963a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8c830963890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =    67.91 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4700.16 ms /     1 runs ( 4700.16 ms per run)
whisper_print_timings:   decode time =    15.21 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   734.77 ms /   125 runs (    5.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5652.50 ms
...
main:     load time =    93.57 ms
main:    total time = 39978.41 ms
embd_img
