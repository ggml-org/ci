...
- status:  SUCCESS ✅
- runtime: 2:08.71
- date:    Sun Jun 16 10:45:34 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   16.08 sec
...
main:  predict time =   486.80 ms / 7.61 ms per token
main:    total time =   627.93 ms
...
main:  predict time =   497.58 ms / 7.11 ms per token
main:    total time =   630.50 ms
...
main:  predict time =   516.16 ms / 7.37 ms per token
main:    total time =   674.09 ms
...
main:  predict time =  1548.00 ms
main:    total time =  1865.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x77e8176fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x77e81757b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5c78c5091ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x77e8176fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x77e8176ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5c78c5092ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x77e81757b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5c78c5091ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5c78c5093410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5c78c5092ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x77e8176fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5c78c5093d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5c78c5093410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5c78c50946d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x77e8176fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5c78c5093d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5c78c5094890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5c78c50946d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x77e8176ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5c78c5094a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5c78c5094890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.37 ms
whisper_print_timings:   sample time =    55.02 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1161.28 ms /     1 runs ( 1161.28 ms per run)
whisper_print_timings:   decode time =    11.03 ms /     2 runs (    5.52 ms per run)
whisper_print_timings:   batchd time =   220.75 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1550.20 ms
...
main:     load time =    66.95 ms
main:    total time = 10669.30 ms
embd_img
