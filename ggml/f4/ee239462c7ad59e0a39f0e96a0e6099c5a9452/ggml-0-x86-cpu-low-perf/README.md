...
- status:  SUCCESS ✅
- runtime: 3:25.37
- date:    Sun Jun 16 10:46:44 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.17 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   30.07 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.45 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.69 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.28 sec
      Start  9: test3
...
main:  predict time =   646.43 ms / 10.10 ms per token
main:    total time =   784.28 ms
...
main:  predict time =   671.18 ms / 9.59 ms per token
main:    total time =   802.83 ms
...
main:     load time =   122.12 ms
main:   sample time =    23.99 ms
main:  predict time =   687.04 ms / 9.81 ms per token
main:    total time =   836.23 ms
...
main:     n_decoded =      504
main:     load time =   101.14 ms
main:   sample time =   178.29 ms
main:  predict time =  2572.33 ms
main:    total time =  2897.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x726055efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x726055d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6085e1060ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x726055efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x726055eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6085e1061ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x726055d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6085e1060ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6085e1062410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6085e1061ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x726055efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6085e1062d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6085e1062410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6085e10636d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x726055efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6085e1062d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6085e1063890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6085e10636d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x726055eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x6085e1063a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6085e1063890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    70.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.16 ms
whisper_print_timings:   sample time =    72.04 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1998.32 ms /     1 runs ( 1998.32 ms per run)
whisper_print_timings:   decode time =    13.83 ms /     2 runs (    6.92 ms per run)
whisper_print_timings:   batchd time =   327.52 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2518.98 ms
