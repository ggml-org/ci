...
- status:  SUCCESS ✅
- runtime: 3:44.80
- date:    Thu Dec  7 17:36:45 UTC 2023
...
20/20 Test #20: test-backend-ops .................   Passed    8.90 sec
...
main:     load time =   258.72 ms
main:   sample time =    23.52 ms
main:  predict time =   443.80 ms / 6.93 ms per token
main:    total time =   738.51 ms
...
main:  predict time =   454.87 ms / 6.50 ms per token
main:    total time =   609.60 ms
...
main:  predict time =  1476.49 ms
main:    total time =  1789.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc26f1fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc26f07b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ecf1977b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc26f1fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc26f1ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ecf1978940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc26f07b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ecf1977b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ecf1979290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ecf1978940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc26f1fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ecf1979be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ecf1979290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ecf197a530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc26f1fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ecf1979be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ecf197a6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ecf197a530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc26f1ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55ecf197a890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ecf197a6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    89.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.13 ms
whisper_print_timings:   sample time =    54.84 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1144.85 ms /     1 runs ( 1144.85 ms per run)
whisper_print_timings:   decode time =     9.53 ms /     2 runs (    4.76 ms per run)
whisper_print_timings:   batchd time =   206.59 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1523.77 ms
...
main:      load time =  5195.61 ms
main:    sample time =   468.30 ms / 7.32 ms per token
main:      eval time = 20410.05 ms / 291.57 ms per token
main:     total time = 26772.63 ms
...
main:      load time =  1236.87 ms
main:    sample time =   468.39 ms / 7.32 ms per token
main:      eval time =  8054.94 ms / 115.07 ms per token
main:     total time = 10132.01 ms
