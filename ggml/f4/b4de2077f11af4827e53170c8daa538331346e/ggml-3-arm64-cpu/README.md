...
- status:  SUCCESS ✅
- runtime: 5:35.86
- date:    Thu Dec  7 05:38:35 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.50 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   46.86 sec
...
20/20 Test #20: test-backend-ops .................   Passed   11.99 sec
...
main:     load time =   230.21 ms
main:   sample time =    16.88 ms
main:  predict time =   808.74 ms / 12.64 ms per token
main:    total time =  1077.70 ms
...
main:     load time =   186.60 ms
main:   sample time =    17.08 ms
main:  predict time =   876.18 ms / 12.52 ms per token
...
main:   sample time =   127.12 ms
main:  predict time =  5842.31 ms
main:    total time =  6208.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf53a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaf3bb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9d06b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf53a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf53f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae9d07940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaf3bb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9d06b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae9d08290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae9d07940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf53a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae9d08be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae9d08290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae9d09530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf53a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae9d08be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae9d096e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae9d09530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf53f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae9d09890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae9d096e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.23 ms
whisper_print_timings:   sample time =    65.92 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4633.94 ms /     1 runs ( 4633.94 ms per run)
whisper_print_timings:   decode time =    15.06 ms /     2 runs (    7.53 ms per run)
whisper_print_timings:   batchd time =   711.74 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5622.31 ms
...
main:     load time =    81.85 ms
main:    total time = 39295.86 ms
embd_img
...
main:      load time =  5719.65 ms
main:    sample time =   534.67 ms / 8.35 ms per token
main:      eval time = 43555.27 ms / 622.22 ms per token
main:     total time = 52182.66 ms
...
main:      load time =  1534.38 ms
main:    sample time =   529.24 ms / 8.27 ms per token
main:      eval time = 17482.52 ms / 249.75 ms per token
main:     total time = 20517.00 ms
