...
- status:  SUCCESS ✅
- runtime: 3:07.65
- date:    Thu Dec  7 17:35:58 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.83 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   51.26 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.78 sec
...
main:  predict time =   609.59 ms / 9.52 ms per token
main:    total time =   775.49 ms
...
main:  predict time =   637.52 ms / 9.11 ms per token
main:    total time =   794.39 ms
...
main:  predict time =  2387.00 ms
main:    total time =  2714.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcf6ed59960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcf6ebda190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ac561a0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcf6ed59010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcf6ed5e900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ac561a1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcf6ebda190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ac561a0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ac561a2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ac561a1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcf6ed59010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ac561a2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ac561a2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ac561a3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcf6ed59960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ac561a2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ac561a36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ac561a3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcf6ed5e900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55ac561a3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ac561a36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.79 ms
whisper_print_timings:   sample time =    72.05 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2008.09 ms /     1 runs ( 2008.09 ms per run)
whisper_print_timings:   decode time =    12.14 ms /     2 runs (    6.07 ms per run)
whisper_print_timings:   batchd time =   320.96 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2513.42 ms
