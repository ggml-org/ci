...
- status:  SUCCESS ✅
- runtime: 3:49.40
- date:    Thu Dec  7 05:36:53 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.29 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.07 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.68 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed   55.30 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  79.86 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   12.57 sec
...
main:     load time =   193.70 ms
main:   sample time =    18.04 ms
main:  predict time =  1014.56 ms / 15.85 ms per token
main:    total time =  1248.20 ms
...
main:     load time =   195.58 ms
main:   sample time =    19.06 ms
main:  predict time =   914.76 ms / 13.07 ms per token
main:    total time =  1132.42 ms
...
main:     n_decoded =      504
main:     load time =   163.91 ms
main:   sample time =   137.52 ms
main:  predict time =  6019.92 ms
main:    total time =  6403.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa87ba960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa863b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1dbe6b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa87ba010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa87bf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1dbe7940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa863b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1dbe6b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1dbe8290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1dbe7940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa87ba010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1dbe8be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1dbe8290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1dbe9530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa87ba960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1dbe8be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1dbe96e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1dbe9530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa87bf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab1dbe9890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1dbe96e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    67.39 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4744.32 ms /     1 runs ( 4744.32 ms per run)
whisper_print_timings:   decode time =    15.53 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   743.86 ms /   125 runs (    5.95 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5698.06 ms
...
main:     load time =    93.68 ms
main:    total time = 40138.81 ms
embd_img
