...
- status:  SUCCESS ✅
- runtime: 3:07.91
- date:    Wed May 15 07:40:59 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   16.88 sec
...
main:     load time =   143.42 ms
main:   sample time =    16.84 ms
main:  predict time =   894.46 ms / 13.98 ms per token
main:    total time =  1076.04 ms
...
main:  predict time =   969.88 ms / 13.86 ms per token
main:    total time =  1133.10 ms
...
main:     load time =   170.68 ms
main:   sample time =    16.86 ms
main:  predict time =   994.70 ms / 14.21 ms per token
main:    total time =  1185.23 ms
...
main:     n_decoded =      504
main:     load time =   141.63 ms
main:   sample time =   126.40 ms
main:  predict time =  6414.55 ms
main:    total time =  6764.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xea051220a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xea051208b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xca72e5c5fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xea051220a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xea051220f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xca72e5c60ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xea051208b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xca72e5c5fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xca72e5c61410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xca72e5c60ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xea051220a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xca72e5c61d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xca72e5c61410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xca72e5c626d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xea051220a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xca72e5c61d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xca72e5c62890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xca72e5c626d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xea051220f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xca72e5c62a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xca72e5c62890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.19 ms
whisper_print_timings:   sample time =    65.62 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4644.91 ms /     1 runs ( 4644.91 ms per run)
whisper_print_timings:   decode time =    13.67 ms /     2 runs (    6.84 ms per run)
whisper_print_timings:   batchd time =   706.17 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5561.69 ms
...
main:     load time =    82.14 ms
main:    total time = 39788.64 ms
embd_img
