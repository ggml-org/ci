...
- status:  SUCCESS ✅
- runtime: 3:27.69
- date:    Wed May 15 07:41:28 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   29.90 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.31 sec
      Start  9: test3
...
main:  predict time =   696.90 ms / 10.89 ms per token
main:    total time =   835.10 ms
...
main:   sample time =    23.91 ms
main:  predict time =   739.01 ms / 10.56 ms per token
main:    total time =   866.73 ms
...
main:     load time =   125.78 ms
main:   sample time =    23.97 ms
main:  predict time =   749.61 ms / 10.71 ms per token
main:    total time =   902.33 ms
...
main:     n_decoded =      504
main:     load time =   100.02 ms
main:   sample time =   178.04 ms
main:  predict time =  3108.45 ms
main:    total time =  3432.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70650f8fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70650f77b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5578cc7d1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70650f8fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x70650f8ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5578cc7d2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70650f77b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5578cc7d1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5578cc7d3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5578cc7d2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70650f8fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5578cc7d3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5578cc7d3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5578cc7d46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70650f8fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5578cc7d3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5578cc7d4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5578cc7d46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x70650f8ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5578cc7d4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5578cc7d4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.08 ms
whisper_print_timings:   sample time =    71.46 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2020.51 ms /     1 runs ( 2020.51 ms per run)
whisper_print_timings:   decode time =    14.02 ms /     2 runs (    7.01 ms per run)
whisper_print_timings:   batchd time =   330.26 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2545.64 ms
