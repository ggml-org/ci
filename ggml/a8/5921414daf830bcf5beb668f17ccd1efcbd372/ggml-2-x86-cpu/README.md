...
- status:  SUCCESS ✅
- runtime: 2:13.61
- date:    Wed May 15 07:40:12 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/a85921414daf830bcf5beb668f17ccd1efcbd372
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.15 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.95 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   16.02 sec
...
main:     load time =   105.68 ms
main:   sample time =    24.01 ms
main:  predict time =   499.01 ms / 7.80 ms per token
main:    total time =   641.09 ms
...
main:     load time =   106.82 ms
main:   sample time =    23.89 ms
main:  predict time =   520.20 ms / 7.43 ms per token
main:    total time =   653.15 ms
...
main:     load time =   126.86 ms
main:   sample time =    23.94 ms
main:  predict time =   530.27 ms / 7.58 ms per token
main:    total time =   684.17 ms
...
main:     n_decoded =      504
main:     load time =   104.75 ms
main:   sample time =   178.33 ms
main:  predict time =  1825.92 ms
main:    total time =  2141.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x74f8296fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x74f82957b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6027165dbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x74f8296fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x74f8296ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6027165dcab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x74f82957b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6027165dbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6027165dd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6027165dcab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x74f8296fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6027165ddd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6027165dd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6027165de6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x74f8296fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6027165ddd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6027165de890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6027165de6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x74f8296ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x6027165dea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6027165de890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.93 ms
whisper_print_timings:   sample time =    54.31 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1155.76 ms /     1 runs ( 1155.76 ms per run)
whisper_print_timings:   decode time =    10.99 ms /     2 runs (    5.50 ms per run)
whisper_print_timings:   batchd time =   215.19 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1540.36 ms
...
main:     load time =    63.82 ms
main:    total time = 10666.45 ms
embd_img
