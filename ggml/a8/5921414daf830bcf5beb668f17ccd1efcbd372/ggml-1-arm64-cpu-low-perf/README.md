...
- status:  SUCCESS ✅
- runtime: 4:01.48
- date:    Wed May 15 07:41:56 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   32.95 sec
...
main:     load time =   142.95 ms
main:   sample time =    17.10 ms
main:  predict time =   910.40 ms / 14.22 ms per token
main:    total time =  1092.09 ms
...
main:     load time =   139.07 ms
main:   sample time =    16.81 ms
main:  predict time =   982.81 ms / 14.04 ms per token
main:    total time =  1141.23 ms
...
main:     load time =   172.05 ms
main:   sample time =    16.74 ms
main:  predict time =  1033.03 ms / 14.76 ms per token
main:    total time =  1224.83 ms
...
main:     n_decoded =      504
main:     load time =   138.63 ms
main:   sample time =   126.41 ms
main:  predict time =  6589.76 ms
main:    total time =  6936.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe8be9200a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe8be91e8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc257ab607ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe8be9200a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe8be9200f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc257ab608ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe8be91e8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc257ab607ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc257ab609410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc257ab608ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe8be9200a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc257ab609d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc257ab609410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc257ab60a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe8be9200a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc257ab609d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc257ab60a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc257ab60a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe8be9200f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc257ab60aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc257ab60a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    97.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.81 ms
whisper_print_timings:   sample time =    64.93 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4645.92 ms /     1 runs ( 4645.92 ms per run)
whisper_print_timings:   decode time =    13.63 ms /     2 runs (    6.81 ms per run)
whisper_print_timings:   batchd time =   711.38 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5563.32 ms
...
main:     load time =    86.90 ms
main:    total time = 39874.52 ms
embd_img
