...
- status:  SUCCESS ✅
- runtime: 3:15.86
- date:    Mon Feb 19 13:57:12 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/0fbec11bbaa6f5af18c8634468a97c6cc65d65fa
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.45 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    3.27 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    2.36 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   79.94 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 100.10 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.36 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.66 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.26 sec
...
21/21 Test #21: test-backend-ops .................   Passed   17.75 sec
...
main:     load time =   109.46 ms
main:   sample time =    23.89 ms
main:  predict time =   484.49 ms / 7.57 ms per token
main:    total time =   630.24 ms
...
main:  predict time =   512.67 ms / 7.32 ms per token
main:    total time =   644.29 ms
...
main:     load time =   128.96 ms
main:   sample time =    23.77 ms
main:  predict time =   516.27 ms / 7.38 ms per token
...
main:  predict time =  1832.52 ms
main:    total time =  2147.43 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbd2d8b5990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbd2d7361a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d8eae5cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbd2d8b5030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbd2d8ba940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d8eae5d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbd2d7361a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d8eae5cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d8eae5e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d8eae5d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbd2d8b5030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d8eae5ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d8eae5e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d8eae5f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbd2d8b5990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d8eae5ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d8eae5f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d8eae5f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbd2d8ba940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d8eae5f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d8eae5f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.70 ms
whisper_print_timings:   sample time =    54.86 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1187.22 ms /     1 runs ( 1187.22 ms per run)
whisper_print_timings:   decode time =    12.36 ms /     2 runs (    6.18 ms per run)
whisper_print_timings:   batchd time =   213.23 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1564.84 ms
