...
- status:  SUCCESS ✅
- runtime: 4:12.01
- date:    Mon Feb 19 13:57:18 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.74 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.51 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   80.16 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 122.02 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.61 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.27 sec
      Start  3: test-quantize-perf
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   16.18 sec
...
main:  predict time =   726.40 ms / 11.35 ms per token
...
main:  predict time =   741.52 ms / 10.59 ms per token
main:    total time =   872.90 ms
...
main:     load time =   125.82 ms
main:   sample time =    23.78 ms
main:  predict time =   770.13 ms / 11.00 ms per token
main:    total time =   922.25 ms
...
main:  predict time =  3121.05 ms
main:    total time =  3448.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe99b19d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe99b01e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559318eb9b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe99b19d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe99b1a2940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559318eba960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe99b01e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559318eb9b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559318ebb2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559318eba960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe99b19d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559318ebbc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559318ebb2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559318ebc580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe99b19d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559318ebbc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559318ebc740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559318ebc580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe99b1a2940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559318ebc900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559318ebc740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.63 ms
whisper_print_timings:   sample time =    72.31 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2042.60 ms /     1 runs ( 2042.60 ms per run)
whisper_print_timings:   decode time =    15.98 ms /     2 runs (    7.99 ms per run)
whisper_print_timings:   batchd time =   336.76 ms /   125 runs (    2.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2568.26 ms
