...
- status:  SUCCESS ✅
- runtime: 4:08.34
- date:    Mon Feb 19 02:46:03 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   97.87 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 115.40 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.76 sec
...
main:     load time =   144.90 ms
main:   sample time =    17.26 ms
main:  predict time =   892.70 ms / 13.95 ms per token
...
main:     load time =   145.71 ms
main:   sample time =    17.00 ms
main:  predict time =   965.99 ms / 13.80 ms per token
main:    total time =  1131.46 ms
...
main:  predict time =   986.82 ms / 14.10 ms per token
main:    total time =  1187.37 ms
...
main:  predict time =  6401.64 ms
main:    total time =  6760.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff90aca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9094b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaffa94b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff90aca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff90acf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaffa95960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9094b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaffa94b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaffa962c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaffa95960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff90aca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaffa96c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaffa962c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaffa97580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff90aca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaffa96c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaffa97740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaffa97580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff90acf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaffa97900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaffa97740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   decode time =    14.39 ms /     2 runs (    7.20 ms per run)
whisper_print_timings:   batchd time =   709.79 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5601.65 ms
