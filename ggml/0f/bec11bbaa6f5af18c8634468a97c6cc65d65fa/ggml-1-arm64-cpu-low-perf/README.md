...
- status:  SUCCESS ✅
- runtime: 5:05.22
- date:    Mon Feb 19 01:58:12 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.88 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   98.04 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.59 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.71 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   19.35 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  52.67 sec
...
main:  predict time =   935.83 ms / 14.62 ms per token
main:    total time =  1133.98 ms
...
main:     load time =   157.21 ms
main:   sample time =    16.84 ms
main:  predict time =   981.67 ms / 14.02 ms per token
main:    total time =  1158.36 ms
...
main:     load time =   188.68 ms
main:   sample time =    17.06 ms
main:  predict time =  1002.70 ms / 14.32 ms per token
main:    total time =  1211.72 ms
...
main:  predict time =  6586.56 ms
main:    total time =  6952.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8796a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff877eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3025b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8796a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8796f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf3026960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff877eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3025b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf30272c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf3026960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8796a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf3027c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf30272c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf3028580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8796a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf3027c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf3028740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf3028580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8796f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf3028900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf3028740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    66.09 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4840.78 ms /     1 runs ( 4840.78 ms per run)
whisper_print_timings:   decode time =    14.93 ms /     2 runs (    7.46 ms per run)
whisper_print_timings:   batchd time =   712.54 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5765.77 ms
