...
- status:  SUCCESS ✅
- runtime: 1:03.97
- date:    Tue Nov 26 13:51:39 UTC 2024
...
main:  predict time =   432.82 ms / 6.76 ms per token
main:    total time =   574.58 ms
...
main:  predict time =   442.36 ms / 6.32 ms per token
main:    total time =   572.15 ms
...
main:     load time =   124.30 ms
main:   sample time =    22.91 ms
main:  predict time =   448.95 ms / 6.41 ms per token
...
main:  predict time =  1374.71 ms
main:    total time =  1674.69 ms
