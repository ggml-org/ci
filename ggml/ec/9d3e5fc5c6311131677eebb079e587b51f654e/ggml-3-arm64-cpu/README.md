...
- status:  SUCCESS ✅
- runtime: 5:44.02
- date:    Wed Jan  3 11:08:10 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   34.70 sec
...
main:     load time =   206.93 ms
main:   sample time =    17.01 ms
main:  predict time =   823.95 ms / 12.87 ms per token
main:    total time =  1070.23 ms
...
main:  predict time =   890.92 ms / 12.73 ms per token
main:    total time =  1088.65 ms
...
main:  predict time =  6029.60 ms
main:    total time =  6383.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb3d6a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb3beb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae317ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb3d6a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb3d6f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae317b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb3beb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae317ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae317c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae317b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb3d6a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae317cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae317c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae317d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb3d6a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae317cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae317d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae317d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb3d6f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae317d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae317d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   180.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.11 ms
whisper_print_timings:   sample time =    65.31 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4640.61 ms /     1 runs ( 4640.61 ms per run)
whisper_print_timings:   decode time =    14.94 ms /     2 runs (    7.47 ms per run)
whisper_print_timings:   batchd time =   705.76 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5625.12 ms
...
main:     load time =    83.47 ms
main:    total time = 39687.46 ms
embd_img
...
main:      load time =  9649.75 ms
main:    sample time =   518.78 ms / 8.11 ms per token
main:      eval time = 43728.29 ms / 624.69 ms per token
main:     total time = 56269.34 ms
...
main:      load time =  4349.49 ms
main:    sample time =   511.35 ms / 7.99 ms per token
main:      eval time = 17436.48 ms / 249.09 ms per token
main:     total time = 23265.18 ms
