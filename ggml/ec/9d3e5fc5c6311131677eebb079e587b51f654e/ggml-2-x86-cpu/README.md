...
- status:  SUCCESS ✅
- runtime: 3:58.52
- date:    Wed Jan  3 11:06:36 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   27.28 sec
...
main:  predict time =   449.52 ms / 7.02 ms per token
main:    total time =   651.78 ms
...
main:  predict time =   458.44 ms / 6.55 ms per token
...
main:  predict time =  1517.04 ms
main:    total time =  1830.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f805c9d4990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f805c8551a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5581e695bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f805c9d4030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f805c9d9940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5581e695c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f805c8551a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5581e695bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5581e695d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5581e695c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f805c9d4030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5581e695dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5581e695d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5581e695e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f805c9d4990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5581e695dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5581e695e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5581e695e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f805c9d9940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5581e695e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5581e695e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    56.37 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1174.96 ms /     1 runs ( 1174.96 ms per run)
whisper_print_timings:   decode time =    10.16 ms /     2 runs (    5.08 ms per run)
whisper_print_timings:   batchd time =   211.98 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1598.88 ms
...
main:      load time =  6168.64 ms
main:    sample time =   469.73 ms / 7.34 ms per token
main:      eval time = 20554.81 ms / 293.64 ms per token
main:     total time = 27866.29 ms
...
main:      load time =  1913.64 ms
main:    sample time =   468.18 ms / 7.32 ms per token
main:      eval time =  9325.45 ms / 133.22 ms per token
main:     total time = 12081.55 ms
