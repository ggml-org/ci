...
- status:  SUCCESS ✅
- runtime: 5:15.52
- date:    Wed Jan  3 11:07:43 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.60 sec
...
20/20 Test #20: test-backend-ops .................   Passed   43.41 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.38 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.02 sec
...
main:     load time =   196.89 ms
main:   sample time =    18.28 ms
main:  predict time =   860.49 ms / 13.45 ms per token
...
main:  predict time =  6174.48 ms
main:    total time =  6552.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8cdfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8cc7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae30a0b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8cdfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8cdff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae30a1960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8cc7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae30a0b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae30a22c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae30a1960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8cdfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae30a2c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae30a22c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae30a3580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8cdfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae30a2c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae30a3740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae30a3580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8cdff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae30a3900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae30a3740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.64 ms
whisper_print_timings:   sample time =    67.03 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4694.89 ms /     1 runs ( 4694.89 ms per run)
whisper_print_timings:   decode time =    15.73 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   840.21 ms /   125 runs (    6.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5752.68 ms
...
main:     load time =    98.66 ms
main:    total time = 40742.99 ms
embd_img
