...
- status:  SUCCESS ✅
- runtime: 2:35.36
- date:    Sun Nov 12 02:37:40 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.97 sec
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.56 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.85 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.30 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.53 sec
      Start 10: test-pool
10/17 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
main:     load time =   189.20 ms
main:   sample time =    17.43 ms
main:  predict time =   823.22 ms / 12.86 ms per token
main:    total time =  1051.86 ms
...
main:     load time =   186.71 ms
main:   sample time =    17.43 ms
main:  predict time =   894.72 ms / 12.78 ms per token
...
main:     n_decoded =      504
main:     load time =   159.87 ms
main:   sample time =   129.05 ms
main:  predict time =  6031.85 ms
main:    total time =  6404.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb77fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb767b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaecc98b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb77fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb77ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaecc99940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb767b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaecc98b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaecc9a290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaecc99940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb77fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaecc9abe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaecc9a290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaecc9b530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb77fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaecc9abe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaecc9b6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaecc9b530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb77ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaecc9b890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaecc9b6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.06 ms
whisper_print_timings:   sample time =    19.55 ms /    27 runs (    0.72 ms per run)
whisper_print_timings:   encode time =  4733.44 ms /     1 runs ( 4733.44 ms per run)
whisper_print_timings:   decode time =   191.05 ms /    27 runs (    7.08 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5072.52 ms
...
main:     load time =    90.30 ms
main:    total time = 40096.36 ms
embd_img
