...
- status:  SUCCESS ✅
- runtime: 2:44.06
- date:    Sun Nov 12 14:38:01 UTC 2023
...
main:  predict time =  1472.03 ms
main:    total time =  1783.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa5ddf7c960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa5dddfd190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56504831bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa5ddf7c010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa5ddf81900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56504831c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa5dddfd190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56504831bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56504831d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56504831c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa5ddf7c010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56504831dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56504831d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56504831e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa5ddf7c960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56504831dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56504831e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56504831e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa5ddf81900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56504831e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56504831e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.75 ms
whisper_print_timings:   sample time =    16.39 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1139.24 ms /     1 runs ( 1139.24 ms per run)
whisper_print_timings:   decode time =    95.58 ms /    27 runs (    3.54 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1348.77 ms
...
main:      load time =  4317.58 ms
main:    sample time =   468.42 ms / 7.32 ms per token
main:      eval time = 19303.06 ms / 275.76 ms per token
main:     total time = 24721.93 ms
...
main:      load time =  1230.22 ms
main:    sample time =   465.89 ms / 7.28 ms per token
main:      eval time =  8125.43 ms / 116.08 ms per token
main:     total time = 10192.24 ms
