...
- status:  SUCCESS ✅
- runtime: 5:41.40
- date:    Sun Jan 28 18:13:09 UTC 2024
...
Total Test time (real) = 127.58 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.50 sec
...
main:     load time =   197.42 ms
main:   sample time =    23.85 ms
main:  predict time =   472.49 ms / 7.38 ms per token
main:    total time =   707.04 ms
...
main:  predict time =   483.38 ms / 6.91 ms per token
main:    total time =   635.10 ms
...
main:  predict time =  1530.66 ms
main:    total time =  1848.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe4d9527990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe4d93a81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5635931a3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe4d9527030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe4d952c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5635931a4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe4d93a81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5635931a3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5635931a52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5635931a4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe4d9527030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5635931a5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5635931a52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5635931a6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe4d9527990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5635931a5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5635931a6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5635931a6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe4d952c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5635931a6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5635931a6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.47 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.04 ms
whisper_print_timings:   sample time =    57.18 ms /   131 runs (    0.44 ms per run)
whisper_print_timings:   encode time =  1165.55 ms /     1 runs ( 1165.55 ms per run)
whisper_print_timings:   decode time =    11.02 ms /     2 runs (    5.51 ms per run)
whisper_print_timings:   batchd time =   219.93 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1595.31 ms
...
main:      load time =  6748.01 ms
main:    sample time =   472.90 ms / 7.39 ms per token
main:      eval time = 20757.41 ms / 296.53 ms per token
main:     total time = 28645.44 ms
...
main:      load time =  2522.41 ms
main:    sample time =   466.86 ms / 7.29 ms per token
main:      eval time =  8192.30 ms / 117.03 ms per token
main:     total time = 11566.97 ms
