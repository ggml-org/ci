...
- status:  SUCCESS ✅
- runtime: 7:36.67
- date:    Sun Jan 28 06:28:02 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  127.32 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 141.16 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.57 sec
...
main:     load time =   289.75 ms
main:   sample time =    17.10 ms
main:  predict time =   868.20 ms / 13.57 ms per token
main:    total time =  1197.60 ms
...
main:     load time =   181.21 ms
main:   sample time =    16.81 ms
main:  predict time =   938.48 ms / 13.41 ms per token
main:    total time =  1139.57 ms
...
main:     n_decoded =      504
main:     load time =   159.07 ms
main:   sample time =   128.69 ms
main:  predict time =  6016.47 ms
main:    total time =  6386.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd3ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbd26b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0cc51b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd3ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd3ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0cc52960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbd26b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0cc51b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0cc532c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0cc52960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd3ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0cc53c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0cc532c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0cc54580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd3ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0cc53c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0cc54740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0cc54580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd3ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0cc54900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0cc54740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   187.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =    65.17 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4635.43 ms /     1 runs ( 4635.43 ms per run)
...
whisper_print_timings:    total time =  5634.64 ms
...
main:     load time =    89.57 ms
main:    total time = 40228.41 ms
embd_img
...
main:      load time = 13247.83 ms
main:    sample time =   516.82 ms / 8.08 ms per token
main:      eval time = 43734.20 ms / 624.77 ms per token
main:     total time = 59871.73 ms
...
main:      load time =  4346.67 ms
main:    sample time =   515.98 ms / 8.06 ms per token
main:      eval time = 17728.81 ms / 253.27 ms per token
main:     total time = 23549.12 ms
