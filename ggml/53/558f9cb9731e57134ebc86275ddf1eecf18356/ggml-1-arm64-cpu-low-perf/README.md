...
- status:  SUCCESS ✅
- runtime: 6:07.30
- date:    Sun Jan 28 06:05:16 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.70 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  152.80 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 190.62 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.84 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.39 sec
...
main:  predict time =   909.27 ms / 14.21 ms per token
main:    total time =  1145.37 ms
...
main:     load time =   195.61 ms
main:   sample time =    17.62 ms
main:  predict time =   988.72 ms / 14.12 ms per token
main:    total time =  1205.30 ms
...
main:  predict time =  6240.29 ms
main:    total time =  6617.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdd7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdbfb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb306b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdd7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdd7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadb307960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdbfb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb306b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadb3082c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadb307960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdd7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadb308c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadb3082c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadb309580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdd7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadb308c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadb309740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadb309580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdd7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadb309900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadb309740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.66 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.29 ms
whisper_print_timings:   sample time =    67.59 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4787.31 ms /     1 runs ( 4787.31 ms per run)
whisper_print_timings:   decode time =    16.24 ms /     2 runs (    8.12 ms per run)
whisper_print_timings:   batchd time =   720.67 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5723.29 ms
...
main:     load time =    93.09 ms
main:    total time = 40849.95 ms
embd_img
