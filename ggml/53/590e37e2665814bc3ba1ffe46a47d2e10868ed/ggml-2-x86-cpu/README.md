...
- status:  SUCCESS ✅
- runtime: 2:43.92
- date:    Fri Oct 20 07:16:23 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/53590e37e2665814bc3ba1ffe46a47d2e10868ed
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.73 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.66 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.61 sec
...
main:     load time =   107.86 ms
main:   sample time =    23.50 ms
main:  predict time =   451.77 ms / 7.06 ms per token
main:    total time =   596.52 ms
...
main:     load time =   107.08 ms
main:   sample time =    23.48 ms
main:  predict time =   461.56 ms / 6.59 ms per token
main:    total time =   595.01 ms
...
main:   sample time =   176.20 ms
main:  predict time =  1504.73 ms
main:    total time =  1824.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f39393fc900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f393927d170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56458883ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f39393fbfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3939401880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56458883f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f393927d170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56458883ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5645888401a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56458883f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f39393fbfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564588840ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5645888401a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564588841400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f39393fc900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564588840ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564588841590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564588841400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3939401880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564588841720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564588841590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    89.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.61 ms
whisper_print_timings:   sample time =    16.37 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1151.37 ms /     1 runs ( 1151.37 ms per run)
whisper_print_timings:   decode time =    97.13 ms /    27 runs (    3.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1410.93 ms
...
main:     load time =    68.63 ms
main:    total time = 10461.30 ms
embd_img
...
main:      load time =  4536.32 ms
main:    sample time =   469.07 ms / 7.33 ms per token
main:      eval time = 19981.17 ms / 285.45 ms per token
main:     total time = 25675.74 ms
...
main:      load time =  1273.91 ms
main:    sample time =   467.75 ms / 7.31 ms per token
main:      eval time =  8383.63 ms / 119.77 ms per token
main:     total time = 10508.11 ms
