...
- status:  SUCCESS ✅
- runtime: 1:55.42
- date:    Fri Oct 20 07:15:39 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.88 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.81 sec
      Start  2: test-quantize-fns
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.76 sec
      Start  9: test3
...
main:  predict time =   604.23 ms / 9.44 ms per token
main:    total time =   747.20 ms
...
main:  predict time =   767.04 ms / 10.96 ms per token
main:    total time =   901.14 ms
...
main:     n_decoded =      504
main:     load time =   106.92 ms
main:   sample time =   176.44 ms
main:  predict time =  2378.56 ms
main:    total time =  2708.22 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f131b74d900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f131b5ce170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c313342ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f131b74cfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f131b752880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c313343870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f131b5ce170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c313342ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c3133441a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c313343870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f131b74cfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c313344ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c3133441a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c313345400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f131b74d900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c313344ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c313345590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c313345400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f131b752880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c313345720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c313345590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    84.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.28 ms
whisper_print_timings:   sample time =    15.89 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  2048.86 ms /     1 runs ( 2048.86 ms per run)
whisper_print_timings:   decode time =   129.54 ms /    27 runs (    4.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2343.10 ms
...
main:     load time =   423.67 ms
main:    total time = 19198.67 ms
embd_img
