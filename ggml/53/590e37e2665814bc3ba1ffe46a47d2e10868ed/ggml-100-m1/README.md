...
- status:  SUCCESS ✅
- runtime: 112.04
- date:    Fri Oct 20 10:14:29 EEST 2023
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 5/16 Test  #5: test-mul-mat0 ....................   Passed    0.39 sec
      Start  6: test-blas0
 6/16 Test  #6: test-blas0 .......................   Passed    0.23 sec
...
15/16 Test #15: test-customop ....................   Passed    0.18 sec
      Start 16: test-xpos
...
main:  predict time =   298.54 ms / 4.66 ms per token
main:    total time =   461.10 ms
...
main:  predict time =   304.63 ms / 4.35 ms per token
main:    total time =   404.55 ms
...
main:     n_decoded =      504
main:     load time =   120.15 ms
main:   sample time =    64.80 ms
main:  predict time =   761.12 ms
main:    total time =   957.28 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x134809160                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x134809f00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x138008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x134809160                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13480a830                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x134809f00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x138186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13480b160                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13480a830                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13480ba90                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1381878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13480b160                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13480bc20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13480ba90                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x13818c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13480bdb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13480bc20                           node_4
...
whisper_print_timings:     load time =   123.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.32 ms
whisper_print_timings:   sample time =    11.55 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   668.71 ms /     1 runs (  668.71 ms per run)
whisper_print_timings:   decode time =    63.24 ms /    27 runs (    2.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   887.57 ms
...
main:     load time =    71.62 ms
main:    total time =  5853.55 ms
embd_img
