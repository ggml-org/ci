...
- status:  SUCCESS ✅
- runtime: 4:21.70
- date:    Fri Oct 20 07:17:58 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.70 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    0.04 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.58 sec
...
main:     load time =   144.62 ms
main:   sample time =    16.75 ms
main:  predict time =   799.76 ms / 12.50 ms per token
main:    total time =   984.64 ms
...
main:  predict time =   868.11 ms / 12.40 ms per token
main:    total time =  1038.94 ms
...
main:   sample time =   126.49 ms
main:  predict time =  5856.27 ms
main:    total time =  6211.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff909ba900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9083b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafcc2bad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff909b9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff909bf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafcc2c870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9083b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafcc2bad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafcc2d1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafcc2c870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff909b9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafcc2dad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafcc2d1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafcc2e400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff909ba900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafcc2dad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafcc2e590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafcc2e400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff909bf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafcc2e720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafcc2e590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.85 ms
whisper_print_timings:   sample time =    20.93 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4607.14 ms /     1 runs ( 4607.14 ms per run)
whisper_print_timings:   decode time =   180.68 ms /    27 runs (    6.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5007.80 ms
...
main:      load time =  5578.36 ms
main:    sample time =   518.98 ms / 8.11 ms per token
main:      eval time = 43835.31 ms / 626.22 ms per token
main:     total time = 52305.71 ms
...
main:      load time =  1536.34 ms
main:    sample time =   514.00 ms / 8.03 ms per token
main:      eval time = 17375.98 ms / 248.23 ms per token
main:     total time = 20389.59 ms
