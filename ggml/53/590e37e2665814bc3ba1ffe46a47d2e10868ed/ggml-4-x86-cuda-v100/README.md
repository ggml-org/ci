...
- status:  SUCCESS ✅
- runtime: 5:56.02
- date:    Fri Oct 20 08:09:31 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.88 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.28 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.72 sec
      Start  2: test-opt
...
main:     load time =  1169.43 ms
main:   sample time =    35.55 ms
main:  predict time =   557.87 ms / 8.72 ms per token
main:    total time =  1784.04 ms
...
main:  predict time =   591.92 ms / 8.46 ms per token
main:    total time =   791.40 ms
...
main:     n_decoded =      504
main:     load time =   151.04 ms
main:   sample time =   233.92 ms
main:  predict time =  2248.94 ms
main:    total time =  2678.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6af66fa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6af657b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55808191cad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6af66f9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6af66ff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55808191d870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6af657b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55808191cad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55808191e1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55808191d870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6af66f9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55808191ead0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55808191e1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55808191f400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6af66fa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55808191ead0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55808191f590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55808191f400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6af66ff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55808191f720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55808191f590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   744.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.82 ms
whisper_print_timings:   sample time =    20.07 ms /    27 runs (    0.74 ms per run)
whisper_print_timings:   encode time =  1866.72 ms /     1 runs ( 1866.72 ms per run)
whisper_print_timings:   decode time =   133.52 ms /    27 runs (    4.95 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2848.02 ms
...
main:     load time =   102.59 ms
main:    total time = 16794.21 ms
embd_img
...
main:      load time =  6913.06 ms
main:    sample time =   595.96 ms / 9.31 ms per token
main:      eval time = 24988.87 ms / 356.98 ms per token
main:     total time = 33405.52 ms
...
main:      load time =  1681.14 ms
main:    sample time =   594.04 ms / 9.28 ms per token
main:      eval time = 12452.42 ms / 177.89 ms per token
main:     total time = 15398.25 ms
