...
- status:  SUCCESS ✅
- runtime: 2:47.37
- date:    Tue Jun 18 06:50:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.37 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   32.77 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   16.95 sec
      Start  4: test-quantize-perf
 4/22 Test  #4: test-quantize-perf ...............   Passed    5.59 sec
...
main:     load time =   146.61 ms
main:   sample time =    16.95 ms
main:  predict time =   845.85 ms / 13.22 ms per token
main:    total time =  1030.88 ms
...
main:  predict time =   926.91 ms / 13.24 ms per token
main:    total time =  1092.28 ms
...
main:     load time =   173.73 ms
main:   sample time =    16.75 ms
main:  predict time =   927.83 ms / 13.25 ms per token
main:    total time =  1121.31 ms
...
main:     n_decoded =      504
main:     load time =   146.39 ms
main:   sample time =   128.45 ms
main:  predict time =  6047.98 ms
main:    total time =  6405.49 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xefbcb095a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xefbcb07db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc5c2d198ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xefbcb095a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xefbcb095f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc5c2d198fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xefbcb07db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc5c2d198ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc5c2d1990410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc5c2d198fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xefbcb095a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc5c2d1990d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc5c2d1990410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc5c2d19916d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xefbcb095a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc5c2d1990d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc5c2d1991890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc5c2d19916d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xefbcb095f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc5c2d1991a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc5c2d1991890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
