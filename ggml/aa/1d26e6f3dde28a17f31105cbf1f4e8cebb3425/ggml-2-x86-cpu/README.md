...
- status:  SUCCESS ✅
- runtime: 3:11.89
- date:    Mon Nov 13 15:23:10 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.44 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.25 sec
      Start  2: test-opt
...
main:     load time =   170.83 ms
main:   sample time =    23.77 ms
main:  predict time =   438.76 ms / 6.86 ms per token
main:    total time =   645.90 ms
...
main:  predict time =   450.77 ms / 6.44 ms per token
main:    total time =   598.26 ms
...
main:     n_decoded =      504
main:     load time =   101.53 ms
main:   sample time =   174.83 ms
main:  predict time =  1459.51 ms
main:    total time =  1766.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f18514e9960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f185136a190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b9c201bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f18514e9010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f18514ee900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b9c201c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f185136a190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b9c201bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b9c201d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b9c201c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f18514e9010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b9c201dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b9c201d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b9c201e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f18514e9960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b9c201dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b9c201e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b9c201e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f18514ee900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b9c201e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b9c201e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 15769.29 ms
main:    sample time =   468.93 ms / 7.33 ms per token
main:      eval time = 20538.85 ms / 293.41 ms per token
main:     total time = 37486.46 ms
...
main:      load time =  4389.83 ms
main:    sample time =   466.65 ms / 7.29 ms per token
main:      eval time =  8515.88 ms / 121.66 ms per token
main:     total time = 13744.22 ms
