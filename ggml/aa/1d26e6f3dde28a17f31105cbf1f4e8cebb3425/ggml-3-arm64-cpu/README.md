...
- status:  SUCCESS ✅
- runtime: 4:48.20
- date:    Mon Nov 13 03:25:43 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/aa1d26e6f3dde28a17f31105cbf1f4e8cebb3425
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.48 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/18 Test  #5: test-mul-mat0 ....................   Passed    0.57 sec
...
main:     load time =   184.99 ms
main:   sample time =    17.13 ms
main:  predict time =   806.80 ms / 12.61 ms per token
main:    total time =  1031.40 ms
...
main:     load time =   174.35 ms
main:   sample time =    16.99 ms
main:  predict time =   875.34 ms / 12.50 ms per token
...
main:     n_decoded =      504
main:     load time =   146.12 ms
main:   sample time =   127.30 ms
main:  predict time =  5830.08 ms
main:    total time =  6183.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5f2a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5dab190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafa91ab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5f2a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5f2f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafa91b940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5dab190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafa91ab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafa91c290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafa91b940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5f2a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafa91cbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafa91c290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafa91d530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5f2a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafa91cbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafa91d6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafa91d530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5f2f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafa91d890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafa91d6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   189.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    19.49 ms /    27 runs (    0.72 ms per run)
whisper_print_timings:   encode time =  4637.21 ms /     1 runs ( 4637.21 ms per run)
whisper_print_timings:   decode time =   198.14 ms /    27 runs (    7.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5060.68 ms
...
main:     load time =    83.77 ms
main:    total time = 39346.57 ms
embd_img
...
main:      load time = 13964.52 ms
main:    sample time =   533.43 ms / 8.33 ms per token
main:      eval time = 43627.65 ms / 623.25 ms per token
main:     total time = 60498.89 ms
...
main:      load time =  4366.59 ms
main:    sample time =   535.74 ms / 8.37 ms per token
main:      eval time = 17723.73 ms / 253.20 ms per token
main:     total time = 23596.99 ms
