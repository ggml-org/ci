...
- status:  SUCCESS ✅
- runtime: 2:36.66
- date:    Mon Nov 13 03:22:38 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.98 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.15 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.54 sec
      Start  9: test3
...
Total Test time (real) =  16.65 sec
...
main:  predict time =   847.90 ms / 13.25 ms per token
main:    total time =  1077.74 ms
...
main:     load time =   190.44 ms
main:   sample time =    17.46 ms
main:  predict time =   898.63 ms / 12.84 ms per token
main:    total time =  1109.36 ms
...
main:     n_decoded =      504
main:     load time =   160.24 ms
main:   sample time =   130.63 ms
main:  predict time =  6013.05 ms
main:    total time =  6384.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8280a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8268b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafc94bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8280a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8280f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafc94c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8268b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafc94bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafc94d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafc94c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8280a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafc94dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafc94d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafc94e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8280a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafc94dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafc94e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafc94e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8280f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafc94e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafc94e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.75 ms
whisper_print_timings:   sample time =    19.64 ms /    27 runs (    0.73 ms per run)
whisper_print_timings:   encode time =  4679.65 ms /     1 runs ( 4679.65 ms per run)
whisper_print_timings:   decode time =   202.55 ms /    27 runs (    7.50 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5037.60 ms
