...
- status:  SUCCESS ✅
- runtime: 112.97
- date:    Tue Oct 24 21:11:56 EEST 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 3/15 Test  #3: test-quantize-perf ...............   Passed    0.29 sec
...
10/15 Test #10: test3 ............................   Passed    0.24 sec
      Start 11: test-pool
11/15 Test #11: test-pool ........................   Passed    0.23 sec
...
14/15 Test #14: test-customop ....................   Passed    0.25 sec
      Start 15: test-xpos
...
Test project /Users/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/16 Test  #1: test-grad0 .......................   Passed    1.14 sec
      Start  2: test-opt
...
main:  predict time =   299.15 ms / 4.67 ms per token
main:    total time =   460.51 ms
...
main:     load time =    88.21 ms
main:   sample time =     8.85 ms
main:  predict time =   305.39 ms / 4.36 ms per token
main:    total time =   403.52 ms
...
main:  predict time =   762.36 ms
main:    total time =   963.97 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x138009160                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x138009f00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x130008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x138009160                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13800a830                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x138009f00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x130186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13800b160                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13800a830                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13800ba90                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1301878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13800b160                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13800bc20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13800ba90                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x13018c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13800bdb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13800bc20                           node_4
...
whisper_print_timings:     load time =   124.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.37 ms
whisper_print_timings:   sample time =    11.57 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   724.11 ms /     1 runs (  724.11 ms per run)
whisper_print_timings:   decode time =    65.39 ms /    27 runs (    2.42 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   947.27 ms
...
main:     load time =    72.83 ms
main:    total time =  5560.38 ms
embd_img
