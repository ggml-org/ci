...
- status:  SUCCESS ✅
- runtime: 2:29.22
- date:    Tue Oct 24 06:14:35 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.14 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.07 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.06 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    0.56 sec
      Start 10: test-pool
10/14 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
11/14 Test #11: test-conv-transpose ..............   Passed    0.01 sec
...
main:     load time =   144.36 ms
main:   sample time =    17.00 ms
main:  predict time =   809.98 ms / 12.66 ms per token
main:    total time =   993.91 ms
...
main:     load time =   144.66 ms
main:   sample time =    17.39 ms
main:  predict time =   879.55 ms / 12.56 ms per token
main:    total time =  1045.42 ms
...
main:     n_decoded =      504
main:     load time =   148.92 ms
main:   sample time =   128.45 ms
main:  predict time =  5993.75 ms
main:    total time =  6353.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9a3a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa98bb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf687aad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9a39fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9a3f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf687b870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa98bb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf687aad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf687c1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf687b870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9a39fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf687cad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf687c1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf687d400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9a3a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf687cad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf687d590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf687d400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9a3f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf687d720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf687d590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4706.72 ms /     1 runs ( 4706.72 ms per run)
whisper_print_timings:   decode time =   191.07 ms /    27 runs (    7.08 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5094.10 ms
