...
- status:  SUCCESS ✅
- runtime: 5:53.00
- date:    Tue Oct 24 18:42:00 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/aa8d91ab38b0ec1047256cc30f8a6255cbca4cac
- author:  Georgi Gerganov
```
sync : llama.cpp (CUDA, Metal, OpenCL, gguf magic, ggml iter)
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.70 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.71 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.01 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.20 sec
      Start 10: test3
...
main:  predict time =   564.38 ms / 8.82 ms per token
main:    total time =   769.98 ms
...
main:  predict time =   581.49 ms / 8.31 ms per token
main:    total time =   773.69 ms
...
main:  predict time =  2265.91 ms
main:    total time =  2695.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8762fa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc87617b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e029901ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8762f9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8762ff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e029902870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc87617b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e029901ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e0299031a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e029902870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8762f9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e029903ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e0299031a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e029904400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8762fa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e029903ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e029904590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e029904400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8762ff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e029904720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e029904590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   719.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.50 ms
whisper_print_timings:   sample time =    20.30 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1844.32 ms /     1 runs ( 1844.32 ms per run)
whisper_print_timings:   decode time =   138.95 ms /    27 runs (    5.15 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2808.44 ms
...
main:     load time =    97.57 ms
main:    total time = 16604.60 ms
embd_img
...
main:      load time =  7505.09 ms
main:    sample time =   576.86 ms / 9.01 ms per token
main:      eval time = 24840.38 ms / 354.86 ms per token
main:     total time = 33807.90 ms
...
main:      load time =  1679.13 ms
main:    sample time =   590.53 ms / 9.23 ms per token
main:      eval time = 12131.87 ms / 173.31 ms per token
main:     total time = 15097.96 ms
