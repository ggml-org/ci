...
- status:  SUCCESS ✅
- runtime: 3:07.33
- date:    Tue Oct 24 18:24:11 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.65 sec
      Start  2: test-opt
...
main:     load time =   156.29 ms
main:   sample time =    23.59 ms
main:  predict time =   450.59 ms / 7.04 ms per token
...
main:  predict time =   453.76 ms / 6.48 ms per token
...
main:  predict time =  1474.50 ms
main:    total time =  1799.20 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efc5ab68900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efc5a9e9170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55bbc0a58ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efc5ab67fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efc5ab6d880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55bbc0a59870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efc5a9e9170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55bbc0a58ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55bbc0a5a1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55bbc0a59870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efc5ab67fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55bbc0a5aad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55bbc0a5a1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55bbc0a5b400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efc5ab68900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55bbc0a5aad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55bbc0a5b590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55bbc0a5b400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efc5ab6d880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55bbc0a5b720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55bbc0a5b590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.42 ms
whisper_print_timings:   sample time =    16.14 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1148.43 ms /     1 runs ( 1148.43 ms per run)
whisper_print_timings:   decode time =    94.35 ms /    27 runs (    3.49 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1443.03 ms
...
main:      load time =  9915.92 ms
main:    sample time =   466.86 ms / 7.29 ms per token
main:      eval time = 20137.50 ms / 287.68 ms per token
main:     total time = 31224.88 ms
...
main:      load time =  3671.80 ms
main:    sample time =   463.98 ms / 7.25 ms per token
main:      eval time =  8047.84 ms / 114.97 ms per token
main:     total time = 12584.81 ms
