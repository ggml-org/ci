...
- status:  SUCCESS ✅
- runtime: 4:47.08
- date:    Tue Oct 24 06:15:40 PM UTC 2023
...
main:  predict time =   870.58 ms / 12.44 ms per token
main:    total time =  1052.63 ms
...
main:  predict time =  5871.60 ms
main:    total time =  6241.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbcfba900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbce3b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0da38ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbcfb9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbcfbf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0da39870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbce3b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0da38ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0da3a1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0da39870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbcfb9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0da3aad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0da3a1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0da3b400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbcfba900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0da3aad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0da3b590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0da3b400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbcfbf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0da3b720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0da3b590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   201.16 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    20.93 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4604.72 ms /     1 runs ( 4604.72 ms per run)
whisper_print_timings:   decode time =   180.14 ms /    27 runs (    6.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5077.18 ms
...
main:      load time = 12517.45 ms
main:    sample time =   517.14 ms / 8.08 ms per token
main:      eval time = 43562.05 ms / 622.31 ms per token
main:     total time = 58971.00 ms
...
main:      load time =  4362.05 ms
main:    sample time =   513.38 ms / 8.02 ms per token
main:      eval time = 17603.58 ms / 251.48 ms per token
main:     total time = 23442.15 ms
