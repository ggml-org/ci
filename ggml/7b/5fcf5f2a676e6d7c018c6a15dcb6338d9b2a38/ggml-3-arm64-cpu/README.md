...
- status:  SUCCESS ✅
- runtime: 3:22.17
- date:    Tue Aug 29 13:40:35 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/7b5fcf5f2a676e6d7c018c6a15dcb6338d9b2a38
...
Total Test time (real) =  12.98 sec
...
main:     load time =   180.15 ms
main:   sample time =    17.56 ms
main:  predict time =   813.69 ms / 12.71 ms per token
main:    total time =  1033.99 ms
...
main:     load time =   179.75 ms
main:   sample time =    17.40 ms
main:  predict time =   878.95 ms / 12.56 ms per token
main:    total time =  1079.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83e0a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83c8b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab21c39ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83e09f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83e0f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab21c3a830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83c8b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab21c39ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab21c3b140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab21c3a830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83e09f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab21c3ba50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab21c3b140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab21c3c360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83e0a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab21c3ba50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab21c3c4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab21c3c360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83e0f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab21c3c640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab21c3c4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5475.21 ms
main:    sample time =   606.83 ms / 9.48 ms per token
main:      eval time = 44019.77 ms / 628.85 ms per token
main:     total time = 52488.63 ms
...
main:      load time =  1642.72 ms
main:    sample time =   616.77 ms / 9.64 ms per token
main:      eval time = 17323.40 ms / 247.48 ms per token
main:     total time = 20543.36 ms
