...
- status:  SUCCESS ✅
- runtime: 4:45.53
- date:    Tue Aug 29 13:42:01 UTC 2023
...
main:     load time =   196.81 ms
main:   sample time =    35.05 ms
main:  predict time =   562.48 ms / 8.79 ms per token
main:    total time =   814.38 ms
...
main:     load time =   199.52 ms
main:   sample time =    37.19 ms
main:  predict time =   612.26 ms / 8.75 ms per token
main:    total time =   854.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffb1b9208a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffb1b7a1150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557174388ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffb1b91ff90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffb1b925800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557174389830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffb1b7a1150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557174388ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55717438a140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557174389830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffb1b91ff90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55717438aa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55717438a140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55717438b360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffb1b9208a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55717438aa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55717438b4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55717438b360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffb1b925800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55717438b640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55717438b4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6881.23 ms
main:    sample time =   582.16 ms / 9.10 ms per token
main:      eval time = 24902.67 ms / 355.75 ms per token
main:     total time = 33242.38 ms
...
main:      load time =  1747.05 ms
main:    sample time =   588.02 ms / 9.19 ms per token
main:      eval time = 12261.24 ms / 175.16 ms per token
main:     total time = 15235.57 ms
