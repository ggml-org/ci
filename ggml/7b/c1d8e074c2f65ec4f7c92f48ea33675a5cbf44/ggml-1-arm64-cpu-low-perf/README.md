...
- status:  SUCCESS ✅
- runtime: 3:43.43
- date:    Sun Jun 16 17:35:35 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.64 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.34 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.21 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.09 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.66 sec
      Start 10: test-pool
...
main:     load time =   145.09 ms
main:   sample time =    18.56 ms
main:  predict time =   905.61 ms / 14.15 ms per token
main:    total time =  1090.73 ms
...
main:     load time =   148.36 ms
main:   sample time =    19.32 ms
main:  predict time =  1001.21 ms / 14.30 ms per token
main:    total time =  1171.72 ms
...
main:     load time =   179.77 ms
main:   sample time =    19.86 ms
main:  predict time =   983.46 ms / 14.05 ms per token
main:    total time =  1186.55 ms
...
main:   sample time =   129.71 ms
main:  predict time =  6135.48 ms
main:    total time =  6501.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfc77c7d2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfc77c7bab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xadf112d0cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfc77c7d2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfc77c7d2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xadf112d0dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfc77c7bab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xadf112d0cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xadf112d0e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xadf112d0dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfc77c7d2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xadf112d0ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xadf112d0e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xadf112d0f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfc77c7d2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xadf112d0ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xadf112d0f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xadf112d0f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfc77c7d2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xadf112d0fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xadf112d0f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    97.48 ms
main:    total time = 40044.98 ms
embd_img
