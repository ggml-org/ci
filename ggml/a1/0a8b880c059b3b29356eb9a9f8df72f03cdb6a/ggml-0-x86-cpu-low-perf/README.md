...
- status:  SUCCESS ✅
- runtime: 3:26.20
- date:    Sat May 25 12:46:06 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.65 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.10 sec
      Start  3: test-quantize-perf
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   23.89 sec
      Start  9: test3
...
main:  predict time =   706.53 ms / 11.04 ms per token
main:    total time =   845.35 ms
...
main:   sample time =    23.92 ms
main:  predict time =   746.02 ms / 10.66 ms per token
main:    total time =   875.21 ms
...
main:     load time =   126.40 ms
main:   sample time =    23.97 ms
main:  predict time =   769.78 ms / 11.00 ms per token
main:    total time =   923.20 ms
...
main:  predict time =  3107.18 ms
main:    total time =  3434.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x78ccffcfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78ccffb7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60ca9a320ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x78ccffcfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x78ccffcff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60ca9a321ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78ccffb7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60ca9a320ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60ca9a322410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60ca9a321ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x78ccffcfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60ca9a322d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60ca9a322410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60ca9a3236d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x78ccffcfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60ca9a322d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60ca9a323890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60ca9a3236d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x78ccffcff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x60ca9a323a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60ca9a323890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.89 ms
whisper_print_timings:   sample time =    71.72 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2025.84 ms /     1 runs ( 2025.84 ms per run)
whisper_print_timings:   decode time =    13.92 ms /     2 runs (    6.96 ms per run)
whisper_print_timings:   batchd time =   332.66 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2552.52 ms
...
main:     load time =    71.20 ms
main:    total time = 19373.04 ms
embd_img
