...
- status:  SUCCESS ✅
- runtime: 2:09.81
- date:    Sat May 25 12:44:59 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   29.69 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.79 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.34 sec
      Start  2: test-opt
...
Total Test time (real) =  27.93 sec
...
main:  predict time =   492.83 ms / 7.70 ms per token
main:    total time =   633.65 ms
...
main:     load time =   103.67 ms
main:   sample time =    23.87 ms
main:  predict time =   516.47 ms / 7.38 ms per token
main:    total time =   646.05 ms
...
main:     load time =   125.07 ms
main:   sample time =    23.80 ms
main:  predict time =   528.80 ms / 7.55 ms per token
main:    total time =   680.65 ms
...
main:     n_decoded =      504
main:     load time =   104.93 ms
main:   sample time =   178.43 ms
main:  predict time =  1849.08 ms
main:    total time =  2166.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f60a80fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f60a7f7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5a27ee989ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f60a80fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f60a80ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5a27ee98aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f60a7f7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5a27ee989ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5a27ee98b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5a27ee98aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f60a80fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5a27ee98bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5a27ee98b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5a27ee98c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f60a80fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5a27ee98bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5a27ee98c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5a27ee98c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f60a80ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5a27ee98ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5a27ee98c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.21 ms
whisper_print_timings:   sample time =    55.34 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1153.64 ms /     1 runs ( 1153.64 ms per run)
whisper_print_timings:   decode time =    11.38 ms /     2 runs (    5.69 ms per run)
whisper_print_timings:   batchd time =   216.90 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1539.82 ms
...
main:     load time =    63.40 ms
main:    total time = 10656.27 ms
embd_img
