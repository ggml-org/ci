...
- status:  SUCCESS ✅
- runtime: 3:13.48
- date:    Sat May 25 12:45:59 UTC 2024
...
main:     load time =   156.18 ms
main:   sample time =    19.11 ms
main:  predict time =   910.97 ms / 14.23 ms per token
main:    total time =  1108.46 ms
...
main:     load time =   182.85 ms
main:   sample time =    19.04 ms
main:  predict time =  1034.89 ms / 14.78 ms per token
main:    total time =  1240.06 ms
...
main:   sample time =   137.25 ms
main:  predict time =  6437.04 ms
main:    total time =  6812.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf8ea5d50a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf8ea5d38b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc9bbea5bbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf8ea5d50a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf8ea5d50f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc9bbea5bcab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf8ea5d38b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc9bbea5bbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc9bbea5bd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc9bbea5bcab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf8ea5d50a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc9bbea5bdd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc9bbea5bd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc9bbea5be6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf8ea5d50a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc9bbea5bdd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc9bbea5be890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc9bbea5be6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf8ea5d50f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc9bbea5bea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc9bbea5be890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.39 ms
whisper_print_timings:   sample time =    67.67 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4668.18 ms /     1 runs ( 4668.18 ms per run)
whisper_print_timings:   decode time =    14.03 ms /     2 runs (    7.02 ms per run)
whisper_print_timings:   batchd time =   712.11 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.99 ms
