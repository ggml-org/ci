...
- status:  SUCCESS ✅
- runtime: 4:00.67
- date:    Sat May 25 12:46:48 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.33 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.21 sec
      Start  9: test3
 9/22 Test  #9: test3 ............................   Passed    1.54 sec
      Start 10: test-pool
...
main:     load time =   139.15 ms
main:   sample time =    16.83 ms
main:  predict time =   895.99 ms / 14.00 ms per token
main:    total time =  1073.23 ms
...
main:  predict time =  1004.17 ms / 14.35 ms per token
main:    total time =  1162.72 ms
...
main:     load time =   171.24 ms
main:   sample time =    16.85 ms
main:  predict time =  1023.08 ms / 14.62 ms per token
main:    total time =  1214.52 ms
...
main:  predict time =  6595.43 ms
main:    total time =  6944.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xeea34a97a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xeea34a7fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc6e79210ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xeea34a97a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xeea34a97f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc6e79210bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xeea34a7fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc6e79210ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc6e79210c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc6e79210bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xeea34a97a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc6e79210cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc6e79210c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc6e79210d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xeea34a97a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc6e79210cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc6e79210d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc6e79210d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xeea34a97f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc6e79210da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc6e79210d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.52 ms
whisper_print_timings:   sample time =    65.20 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4672.09 ms /     1 runs ( 4672.09 ms per run)
whisper_print_timings:   decode time =    14.02 ms /     2 runs (    7.01 ms per run)
whisper_print_timings:   batchd time =   711.88 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5594.93 ms
