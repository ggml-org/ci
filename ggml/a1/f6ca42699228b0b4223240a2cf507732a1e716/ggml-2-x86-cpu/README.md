...
- status:  SUCCESS ✅
- runtime: 2:22.56
- date:    Fri Sep 15 17:57:42 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.17 sec
...
main:     load time =   127.82 ms
main:   sample time =    23.71 ms
main:  predict time =   432.00 ms / 6.75 ms per token
main:    total time =   596.71 ms
...
main:  predict time =   450.27 ms / 6.43 ms per token
main:    total time =   603.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6b0c7328d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6b0c5b3160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558061ef6ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6b0c731fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6b0c737840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558061ef7850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6b0c5b3160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558061ef6ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558061ef8170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558061ef7850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6b0c731fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558061ef8a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558061ef8170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558061ef93b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6b0c7328d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558061ef8a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558061ef9530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558061ef93b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6b0c737840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558061ef96b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558061ef9530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    88.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.89 ms
whisper_print_timings:   sample time =    16.36 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1156.95 ms /     1 runs ( 1156.95 ms per run)
whisper_print_timings:   decode time =    94.74 ms /    27 runs (    3.51 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1407.43 ms
```
### mpt
...
main:      load time =  5121.58 ms
main:    sample time =   471.95 ms / 7.37 ms per token
main:      eval time = 20133.33 ms / 287.62 ms per token
main:     total time = 26386.61 ms
...
main:      load time =  1239.35 ms
main:    sample time =   468.84 ms / 7.33 ms per token
main:      eval time =  8004.05 ms / 114.34 ms per token
main:     total time = 10093.50 ms
