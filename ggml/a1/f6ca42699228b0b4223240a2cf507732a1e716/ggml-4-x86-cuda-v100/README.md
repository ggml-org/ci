...
- status:  SUCCESS ✅
- runtime: 4:38.43
- date:    Fri Sep 15 18:02:51 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.72 sec
 ...
 8/14 Test  #8: test2 ............................   Passed   16.10 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    1.02 sec
      Start 10: test-pool
...
main:     load time =   207.80 ms
main:   sample time =    35.03 ms
main:  predict time =   549.37 ms / 8.58 ms per token
main:    total time =   812.75 ms
...
main:     load time =   202.12 ms
main:   sample time =    36.38 ms
main:  predict time =   576.34 ms / 8.23 ms per token
main:    total time =   820.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f52846a48d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5284525160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5600fe6adac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f52846a3fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f52846a9840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5600fe6ae850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5284525160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5600fe6adac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5600fe6af170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5600fe6ae850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f52846a3fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5600fe6afa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5600fe6af170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5600fe6b03b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f52846a48d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5600fe6afa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5600fe6b0530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5600fe6b03b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f52846a9840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5600fe6b06b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5600fe6b0530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.73 ms
whisper_print_timings:   sample time =    20.02 ms /    27 runs (    0.74 ms per run)
whisper_print_timings:   encode time =  1817.14 ms /     1 runs ( 1817.14 ms per run)
whisper_print_timings:   decode time =   131.10 ms /    27 runs (    4.86 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2173.14 ms
```
### mpt
...
main:      load time =  7019.82 ms
main:    sample time =   609.76 ms / 9.53 ms per token
main:      eval time = 25443.61 ms / 363.48 ms per token
main:     total time = 33968.80 ms
...
main:      load time =  1742.40 ms
main:    sample time =   602.92 ms / 9.42 ms per token
main:      eval time = 12221.82 ms / 174.60 ms per token
main:     total time = 15207.61 ms
