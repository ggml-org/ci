...
- status:  SUCCESS ✅
- runtime: 7:27.64
- date:    Mon Jan 29 09:30:04 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.53 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  124.63 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 138.92 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.28 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   24.24 sec
...
main:     load time =   192.72 ms
main:   sample time =    17.06 ms
main:  predict time =   877.95 ms / 13.72 ms per token
main:    total time =  1109.80 ms
...
main:  predict time =   938.95 ms / 13.41 ms per token
main:    total time =  1152.27 ms
...
main:     n_decoded =      504
main:     load time =   162.72 ms
main:   sample time =   128.85 ms
main:  predict time =  6047.73 ms
main:    total time =  6422.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f0ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7ef4b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab09b09b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f0ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f0cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab09b0a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7ef4b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab09b09b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab09b0b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab09b0a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f0ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab09b0bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab09b0b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab09b0c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f0ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab09b0bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab09b0c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab09b0c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f0cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab09b0c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab09b0c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   187.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.18 ms
whisper_print_timings:   sample time =    65.05 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4637.09 ms /     1 runs ( 4637.09 ms per run)
whisper_print_timings:   decode time =    15.51 ms /     2 runs (    7.75 ms per run)
whisper_print_timings:   batchd time =   711.41 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5634.80 ms
...
main:      load time = 12869.96 ms
main:    sample time =   517.81 ms / 8.09 ms per token
main:      eval time = 44007.09 ms / 628.67 ms per token
main:     total time = 59768.43 ms
...
main:      load time =  4350.83 ms
main:    sample time =   515.67 ms / 8.06 ms per token
main:      eval time = 17402.43 ms / 248.61 ms per token
main:     total time = 23225.56 ms
