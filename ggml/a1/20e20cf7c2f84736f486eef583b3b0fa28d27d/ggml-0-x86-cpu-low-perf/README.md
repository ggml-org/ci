...
- status:  SUCCESS ✅
- runtime: 4:52.37
- date:    Mon Jan 29 09:27:26 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/a120e20cf7c2f84736f486eef583b3b0fa28d27d
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.52 sec
...
20/20 Test #20: test-backend-ops .................   Passed  116.25 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 155.11 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.08 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.93 sec
...
main:     load time =   126.10 ms
main:   sample time =    23.87 ms
main:  predict time =   628.59 ms / 9.82 ms per token
main:    total time =   791.75 ms
...
main:     load time =   127.22 ms
main:   sample time =    23.76 ms
main:  predict time =   667.36 ms / 9.53 ms per token
main:    total time =   820.88 ms
...
main:     n_decoded =      504
main:     load time =   104.68 ms
main:   sample time =   178.31 ms
main:  predict time =  2524.74 ms
main:    total time =  2853.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae0cdac990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae0cc2d1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a3e2d3fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae0cdac030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae0cdb1940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a3e2d40960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae0cc2d1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a3e2d3fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a3e2d412c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a3e2d40960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae0cdac030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a3e2d41c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a3e2d412c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a3e2d42580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae0cdac990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a3e2d41c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a3e2d42740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a3e2d42580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae0cdb1940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a3e2d42900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a3e2d42740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.76 ms
whisper_print_timings:   sample time =    72.16 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1991.11 ms /     1 runs ( 1991.11 ms per run)
whisper_print_timings:   decode time =    13.01 ms /     2 runs (    6.50 ms per run)
whisper_print_timings:   batchd time =   327.86 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2505.93 ms
...
main:     load time =    69.07 ms
main:    total time = 18922.91 ms
embd_img
