...
- status:  SUCCESS ✅
- runtime: 6:04.98
- date:    Mon Jan 29 09:28:35 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  151.92 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.34 sec
      Start  9: test3
...
main:  predict time =  1014.62 ms / 15.85 ms per token
main:    total time =  1243.34 ms
...
main:  predict time =   961.42 ms / 13.73 ms per token
main:    total time =  1176.10 ms
...
main:  predict time =  6205.17 ms
main:    total time =  6575.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96caa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96b2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7880b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96caa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96caf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf7881960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96b2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7880b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf78822c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf7881960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96caa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf7882c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf78822c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf7883580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96caa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf7882c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf7883740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf7883580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96caf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf7883900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf7883740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.70 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.62 ms
whisper_print_timings:   sample time =    66.15 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4725.04 ms /     1 runs ( 4725.04 ms per run)
whisper_print_timings:   decode time =    15.84 ms /     2 runs (    7.92 ms per run)
whisper_print_timings:   batchd time =   718.09 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5653.65 ms
