...
- status:  SUCCESS ✅
- runtime: 5:34.74
- date:    Mon Jan 29 09:28:09 UTC 2024
...
Total Test time (real) = 123.66 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.41 sec
...
main:     load time =   193.02 ms
main:   sample time =    23.76 ms
main:  predict time =   462.78 ms / 7.23 ms per token
main:    total time =   692.70 ms
...
main:  predict time =  1551.03 ms
main:    total time =  1862.96 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f32859df990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f32858601a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ca169dcb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f32859df030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f32859e4940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ca169dd960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f32858601a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ca169dcb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ca169de2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ca169dd960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f32859df030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ca169dec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ca169de2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ca169df580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f32859df990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ca169dec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ca169df740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ca169df580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f32859e4940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55ca169df900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ca169df740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.53 ms
whisper_print_timings:   sample time =    54.93 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1165.43 ms /     1 runs ( 1165.43 ms per run)
whisper_print_timings:   decode time =    10.22 ms /     2 runs (    5.11 ms per run)
whisper_print_timings:   batchd time =   215.96 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1583.01 ms
...
main:     load time =    64.75 ms
main:    total time = 10654.67 ms
embd_img
...
main:      load time =  6372.51 ms
main:    sample time =   468.82 ms / 7.33 ms per token
main:      eval time = 21000.26 ms / 300.00 ms per token
main:     total time = 28513.27 ms
...
main:      load time =  1391.07 ms
main:    sample time =   470.77 ms / 7.36 ms per token
main:      eval time =  9727.54 ms / 138.96 ms per token
main:     total time = 11942.02 ms
