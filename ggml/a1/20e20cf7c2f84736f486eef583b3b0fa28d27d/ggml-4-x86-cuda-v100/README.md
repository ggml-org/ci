...
- status:  SUCCESS ✅
- runtime: 12:13.92
- date:    Mon Jan 29 09:34:52 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.45 sec
...
11/20 Test #11: test-conv-transpose ..............   Passed    0.55 sec
      Start 12: test-dup
12/20 Test #12: test-dup .........................   Passed    0.57 sec
...
20/20 Test #20: test-backend-ops .................   Passed  214.94 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 261.23 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.55 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.49 sec
...
21/21 Test #21: test-backend-ops .................   Passed   46.11 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  91.07 sec
...
main:     load time =  1053.09 ms
main:   sample time =    35.86 ms
main:  predict time =   594.37 ms / 9.29 ms per token
main:    total time =  1707.56 ms
...
main:     load time =   619.39 ms
main:   sample time =    34.00 ms
main:  predict time =   620.00 ms / 8.86 ms per token
main:    total time =  1277.86 ms
...
main:     n_decoded =      504
main:     load time =   540.91 ms
main:   sample time =   240.59 ms
main:  predict time =  2317.26 ms
main:    total time =  3148.87 ms
...
main: loaded model in   396.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91f1db6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91f1c371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5583e6bec7e0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91f1db6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91f1dbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5583e6bed5b0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91f1c371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5583e6bec7e0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5583e6bedf10                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5583e6bed5b0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91f1db6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5583e6bee870                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5583e6bedf10                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5583e6bef1d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91f1db6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5583e6bee870                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5583e6bef390                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5583e6bef1d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91f1dbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5583e6bef550                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5583e6bef390       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   867.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    23.79 ms
whisper_print_timings:   sample time =    65.58 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    22.73 ms /     1 runs (   22.73 ms per run)
whisper_print_timings:   decode time =    22.03 ms /     2 runs (   11.02 ms per run)
whisper_print_timings:   batchd time =    79.88 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1090.03 ms
...
main:     load time =   492.30 ms
main:    total time =  7887.40 ms
embd_img
...
main:      load time = 21276.19 ms
main:    sample time =   518.80 ms / 8.11 ms per token
main:      eval time = 25346.74 ms / 362.10 ms per token
main:     total time = 48010.59 ms
...
main:      load time = 13033.43 ms
main:    sample time =   520.98 ms / 8.14 ms per token
main:      eval time = 12413.11 ms / 177.33 ms per token
main:     total time = 26596.16 ms
