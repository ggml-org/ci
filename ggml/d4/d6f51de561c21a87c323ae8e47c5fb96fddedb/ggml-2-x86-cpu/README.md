...
- status:  SUCCESS ✅
- runtime: 2:37.96
- date:    Mon Aug 28 21:47:31 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.58 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.58 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.28 sec
...
main:     load time =   203.43 ms
main:   sample time =    23.67 ms
main:  predict time =   427.98 ms / 6.69 ms per token
main:    total time =   668.60 ms
...
main:     load time =   139.50 ms
main:   sample time =    23.75 ms
main:  predict time =   440.37 ms / 6.29 ms per token
main:    total time =   606.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3bd004d8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3bcfece150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564db6f4dab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3bd004cf90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3bd0052800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564db6f4e830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3bcfece150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564db6f4dab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564db6f4f140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564db6f4e830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3bd004cf90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564db6f4fa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564db6f4f140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564db6f50360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3bd004d8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564db6f4fa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564db6f504d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564db6f50360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3bd0052800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564db6f50640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564db6f504d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  9160.31 ms
main:    sample time =   470.45 ms / 7.35 ms per token
main:      eval time = 20290.04 ms / 289.86 ms per token
main:     total time = 30586.74 ms
...
main:      load time =  4204.83 ms
main:    sample time =   468.08 ms / 7.31 ms per token
main:      eval time =  8026.93 ms / 114.67 ms per token
main:     total time = 13073.69 ms
