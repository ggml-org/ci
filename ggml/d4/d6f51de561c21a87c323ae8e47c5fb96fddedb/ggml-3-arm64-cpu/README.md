...
- status:  SUCCESS ✅
- runtime: 3:39.26
- date:    Mon Aug 28 21:48:30 UTC 2023
...
main:     load time =   273.09 ms
main:   sample time =    17.55 ms
main:  predict time =   810.55 ms / 12.66 ms per token
...
main:  predict time =   876.74 ms / 12.52 ms per token
main:    total time =  1073.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff969aa8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9682b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbbcbab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff969a9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff969af800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadbbcc830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9682b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbbcbab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadbbcd140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadbbcc830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff969a9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadbbcda50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadbbcd140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadbbce360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff969aa8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadbbcda50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadbbce4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadbbce360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff969af800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadbbce640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadbbce4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12560.77 ms
main:    sample time =   627.63 ms / 9.81 ms per token
main:      eval time = 43668.01 ms / 623.83 ms per token
main:     total time = 59249.45 ms
...
main:      load time =  4371.37 ms
main:    sample time =   615.64 ms / 9.62 ms per token
main:      eval time = 17372.20 ms / 248.17 ms per token
main:     total time = 23319.81 ms
