...
- status:  SUCCESS ✅
- runtime: 4:56.60
- date:    Mon Aug 28 21:49:44 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/d4d6f51de561c21a87c323ae8e47c5fb96fddedb
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.34 sec
      Start  2: test-opt
...
main:     load time =   225.35 ms
main:   sample time =    34.72 ms
main:  predict time =   558.82 ms / 8.73 ms per token
main:    total time =   840.13 ms
...
main:     load time =   190.92 ms
main:   sample time =    34.51 ms
main:  predict time =   587.49 ms / 8.39 ms per token
main:    total time =   817.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd42918e8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd42900f150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560853cf2ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd42918df90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd429193800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560853cf3830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd42900f150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560853cf2ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560853cf4140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560853cf3830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd42918df90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560853cf4a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560853cf4140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560853cf5360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd42918e8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560853cf4a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560853cf54d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560853cf5360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd429193800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560853cf5640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560853cf54d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7129.12 ms
main:    sample time =   586.00 ms / 9.16 ms per token
main:      eval time = 25016.83 ms / 357.38 ms per token
main:     total time = 33623.39 ms
...
main:      load time =  1667.41 ms
main:    sample time =   584.15 ms / 9.13 ms per token
main:      eval time = 12188.75 ms / 174.12 ms per token
main:     total time = 15092.87 ms
