...
- status:  SUCCESS ✅
- runtime: 5:48.98
- date:    Mon Jan 29 18:09:34 UTC 2024
...
Total Test time (real) = 126.65 sec
...
main:     load time =   196.40 ms
main:   sample time =    23.85 ms
main:  predict time =   481.05 ms / 7.52 ms per token
main:    total time =   714.62 ms
...
main:  predict time =   491.13 ms / 7.02 ms per token
main:    total time =   650.55 ms
...
main:     n_decoded =      504
main:     load time =   109.07 ms
main:   sample time =   177.58 ms
main:  predict time =  1532.68 ms
main:    total time =  1852.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efd45bba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efd45a3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f6974e8b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efd45bba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efd45bbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f6974e9960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efd45a3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f6974e8b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f6974ea2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f6974e9960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efd45bba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f6974eac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f6974ea2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f6974eb580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efd45bba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f6974eac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f6974eb740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f6974eb580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efd45bbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f6974eb900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f6974eb740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   130.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.46 ms
whisper_print_timings:   sample time =    55.58 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.61 ms /     1 runs ( 1159.61 ms per run)
whisper_print_timings:   decode time =     9.69 ms /     2 runs (    4.85 ms per run)
whisper_print_timings:   batchd time =   213.08 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1587.13 ms
...
main:     load time =    60.11 ms
main:    total time = 10620.85 ms
embd_img
...
main:      load time = 13458.77 ms
main:    sample time =   472.34 ms / 7.38 ms per token
main:      eval time = 20621.23 ms / 294.59 ms per token
main:     total time = 35232.49 ms
...
main:      load time =  4375.02 ms
main:    sample time =   466.23 ms / 7.28 ms per token
main:      eval time =  8691.10 ms / 124.16 ms per token
main:     total time = 14228.05 ms
