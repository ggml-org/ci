...
- status:  SUCCESS ✅
- runtime: 7:37.38
- date:    Mon Jan 29 06:11:11 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.78 sec
...
20/20 Test #20: test-backend-ops .................   Passed  127.38 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 141.68 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.95 sec
...
main:     load time =   274.91 ms
main:   sample time =    17.14 ms
main:  predict time =   865.80 ms / 13.53 ms per token
...
main:     load time =   174.17 ms
main:   sample time =    16.96 ms
main:  predict time =   936.36 ms / 13.38 ms per token
main:    total time =  1130.55 ms
...
main:  predict time =  5993.94 ms
main:    total time =  6348.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb6b6a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb69eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafbf16b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb6b6a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb6b6f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafbf17960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb69eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafbf16b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafbf182c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafbf17960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb6b6a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafbf18c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafbf182c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafbf19580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb6b6a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafbf18c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafbf19740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafbf19580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb6b6f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafbf19900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafbf19740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   189.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.05 ms
whisper_print_timings:   sample time =    65.71 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4636.01 ms /     1 runs ( 4636.01 ms per run)
whisper_print_timings:   decode time =    15.74 ms /     2 runs (    7.87 ms per run)
whisper_print_timings:   batchd time =   713.57 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5638.14 ms
...
main:     load time =    77.16 ms
main:    total time = 39753.11 ms
embd_img
...
main:      load time = 12661.13 ms
main:    sample time =   512.63 ms / 8.01 ms per token
main:      eval time = 43926.79 ms / 627.53 ms per token
main:     total time = 59475.66 ms
...
main:      load time =  4361.68 ms
main:    sample time =   513.67 ms / 8.03 ms per token
main:      eval time = 17492.98 ms / 249.90 ms per token
main:     total time = 23325.42 ms
