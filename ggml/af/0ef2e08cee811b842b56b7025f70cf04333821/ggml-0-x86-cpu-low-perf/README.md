...
- status:  SUCCESS ✅
- runtime: 4:55.58
- date:    Mon Jan 29 18:08:34 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  118.47 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 157.06 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.42 sec
      Start  2: test-quantize-fns
...
main:  predict time =   639.18 ms / 9.99 ms per token
...
main:  predict time =   666.82 ms / 9.53 ms per token
main:    total time =   819.32 ms
...
main:  predict time =  2505.74 ms
main:    total time =  2834.66 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7d8c596990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7d8c4171a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5555e2e60b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7d8c596030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7d8c59b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5555e2e61960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7d8c4171a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5555e2e60b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5555e2e622c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5555e2e61960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7d8c596030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5555e2e62c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5555e2e622c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5555e2e63580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7d8c596990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5555e2e62c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5555e2e63740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5555e2e63580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7d8c59b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5555e2e63900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5555e2e63740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.06 ms
whisper_print_timings:   sample time =    72.22 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1988.82 ms /     1 runs ( 1988.82 ms per run)
whisper_print_timings:   decode time =    12.49 ms /     2 runs (    6.24 ms per run)
whisper_print_timings:   batchd time =   326.77 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.54 ms
