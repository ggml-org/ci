...
- status:  SUCCESS ✅
- runtime: 6:14.05
- date:    Mon Jan 29 06:09:49 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  161.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.92 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.28 sec
...
main:     load time =   186.72 ms
main:   sample time =    17.27 ms
main:  predict time =   884.78 ms / 13.82 ms per token
main:    total time =  1110.82 ms
...
main:     load time =   186.97 ms
main:   sample time =    17.06 ms
main:  predict time =   960.05 ms / 13.72 ms per token
main:    total time =  1167.19 ms
...
main:  predict time =  6190.16 ms
main:    total time =  6559.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdfea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbde6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaee84bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdfea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdfef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaee84c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbde6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaee84bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaee84d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaee84c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdfea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaee84dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaee84d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaee84e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdfea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaee84dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaee84e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaee84e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdfef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaee84e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaee84e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    65.70 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4784.92 ms /     1 runs ( 4784.92 ms per run)
whisper_print_timings:   decode time =    15.68 ms /     2 runs (    7.84 ms per run)
whisper_print_timings:   batchd time =   716.50 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5710.69 ms
