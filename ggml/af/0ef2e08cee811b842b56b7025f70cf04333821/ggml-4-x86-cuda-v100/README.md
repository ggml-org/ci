...
- status:  SUCCESS ✅
- runtime: 12:40.20
- date:    Mon Jan 29 18:16:13 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.56 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.90 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  253.94 sec
...
21/21 Test #21: test-backend-ops .................   Passed   46.25 sec
...
main:     load time =   610.75 ms
main:   sample time =    34.31 ms
main:  predict time =   595.01 ms / 9.30 ms per token
main:    total time =  1260.12 ms
...
main:     load time =   564.68 ms
main:   sample time =    35.40 ms
main:  predict time =   661.57 ms / 9.45 ms per token
main:    total time =  1266.23 ms
...
main:     n_decoded =      504
main:     load time =   558.17 ms
main:   sample time =   251.05 ms
main:  predict time =  2338.19 ms
main:    total time =  3191.88 ms
...
main: loaded model in   408.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f60dd3b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f60dd2371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564da576d9c0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f60dd3b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f60dd3bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564da576e790                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f60dd2371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564da576d9c0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564da576f0f0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564da576e790                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f60dd3b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564da576fa50                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564da576f0f0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564da57703b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f60dd3b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564da576fa50                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564da5770570                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564da57703b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f60dd3bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564da5770730                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564da5770570       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   524.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    25.71 ms
whisper_print_timings:   sample time =    67.83 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    23.76 ms /     1 runs (   23.76 ms per run)
whisper_print_timings:   decode time =    22.41 ms /     2 runs (   11.20 ms per run)
whisper_print_timings:   batchd time =    81.38 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   754.55 ms
...
main:     load time =   511.26 ms
main:    total time =  8032.57 ms
embd_img
...
main:      load time = 20921.78 ms
main:    sample time =   529.04 ms / 8.27 ms per token
main:      eval time = 25532.94 ms / 364.76 ms per token
main:     total time = 47884.32 ms
...
main:      load time = 12753.53 ms
main:    sample time =   521.80 ms / 8.15 ms per token
main:      eval time = 12445.08 ms / 177.79 ms per token
main:     total time = 26360.39 ms
