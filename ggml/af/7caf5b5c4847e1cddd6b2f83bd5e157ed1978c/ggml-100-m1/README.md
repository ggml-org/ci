...
- status:  SUCCESS ✅
- runtime: 139.85
- date:    Thu Nov 16 17:16:21 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    1.07 sec
      Start  2: test-opt
 2/19 Test  #2: test-opt .........................   Passed    2.53 sec
 ...
 7/19 Test  #7: test-mul-mat2 ....................   Passed    2.39 sec
      Start  8: test0
...
13/19 Test #13: test-conv-transpose ..............   Passed    0.19 sec
...
main:     load time =   151.82 ms
main:   sample time =     8.85 ms
main:  predict time =   301.44 ms / 4.71 ms per token
...
main:  predict time =   309.30 ms / 4.42 ms per token
main:    total time =   414.24 ms
...
main:     n_decoded =      504
main:     load time =   118.94 ms
main:   sample time =    65.13 ms
main:  predict time =   757.51 ms
main:    total time =   952.59 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x138018210                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x138018fd0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x148008180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x138018210                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x138019920                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x138018fd0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x148187000                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13801a270                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x138019920                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13801abc0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x148187950                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13801a270                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13801ad70                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13801abc0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14818c8f0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13801af20                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13801ad70                           node_4
...
whisper_print_timings:     load time =   113.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.34 ms
whisper_print_timings:   sample time =    33.78 ms /   131 runs (    0.26 ms per run)
whisper_print_timings:   encode time =   559.68 ms /     1 runs (  559.68 ms per run)
whisper_print_timings:   decode time =     5.46 ms /     2 runs (    2.73 ms per run)
whisper_print_timings:   batchd time =   102.03 ms /   125 runs (    0.82 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   821.89 ms
