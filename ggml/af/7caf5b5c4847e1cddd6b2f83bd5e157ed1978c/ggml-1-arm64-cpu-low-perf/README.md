...
- status:  SUCCESS ✅
- runtime: 2:40.99
- date:    Thu Nov 16 03:17:50 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.77 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.66 sec
      Start  6: test0
 6/17 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.36 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.60 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.97 sec
      Start  9: test3
...
main:     load time =   191.55 ms
main:   sample time =    17.59 ms
main:  predict time =   823.47 ms / 12.87 ms per token
main:    total time =  1054.48 ms
...
main:     load time =   189.83 ms
main:   sample time =    17.56 ms
main:  predict time =   891.90 ms / 12.74 ms per token
main:    total time =  1102.04 ms
...
main:     n_decoded =      504
main:     load time =   159.82 ms
main:   sample time =   129.29 ms
main:  predict time =  6011.74 ms
main:    total time =  6385.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff84bba960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84a3b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab03bcdb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff84bba010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff84bbf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab03bce940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84a3b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab03bcdb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab03bcf290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab03bce940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff84bba010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab03bcfbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab03bcf290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab03bd0530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff84bba960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab03bcfbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab03bd06e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab03bd0530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff84bbf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab03bd0890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab03bd06e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.27 ms
whisper_print_timings:   sample time =    66.05 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4743.98 ms /     1 runs ( 4743.98 ms per run)
whisper_print_timings:   decode time =    16.43 ms /     2 runs (    8.22 ms per run)
whisper_print_timings:   batchd time =   716.26 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5679.68 ms
...
main:     load time =    92.34 ms
main:    total time = 40262.23 ms
embd_img
