...
- status:  SUCCESS ✅
- runtime: 4:42.45
- date:    Thu Nov 16 03:33:10 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.27 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.17 sec
      Start  2: test-opt
...
main:     load time =   209.60 ms
main:   sample time =    17.09 ms
main:  predict time =   809.31 ms / 12.65 ms per token
main:    total time =  1058.03 ms
...
main:  predict time =   876.55 ms / 12.52 ms per token
...
main:  predict time =  5830.04 ms
main:    total time =  6182.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8afda960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ae5b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff387b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8afda010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8afdf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaff388940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ae5b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff387b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaff389290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaff388940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8afda010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaff389be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaff389290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaff38a530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8afda960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaff389be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaff38a6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaff38a530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8afdf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaff38a890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaff38a6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   185.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.22 ms
whisper_print_timings:   sample time =    64.74 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4637.25 ms /     1 runs ( 4637.25 ms per run)
whisper_print_timings:   decode time =    15.91 ms /     2 runs (    7.95 ms per run)
whisper_print_timings:   batchd time =   711.95 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5632.19 ms
...
main:      load time =  5827.25 ms
main:    sample time =   531.74 ms / 8.31 ms per token
main:      eval time = 43499.91 ms / 621.43 ms per token
main:     total time = 52232.57 ms
...
main:      load time =  1530.00 ms
main:    sample time =   528.97 ms / 8.27 ms per token
main:      eval time = 17505.28 ms / 250.08 ms per token
main:     total time = 20535.65 ms
