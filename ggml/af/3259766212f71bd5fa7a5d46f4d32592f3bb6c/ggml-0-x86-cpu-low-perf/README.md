...
- status:  SUCCESS ✅
- runtime: 3:30.82
- date:    Wed Mar 27 11:27:57 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.97 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.12 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.92 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.38 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.34 sec
      Start  9: test3
...
main:     load time =   110.43 ms
main:   sample time =    23.69 ms
main:  predict time =   717.52 ms / 11.21 ms per token
main:    total time =   864.30 ms
...
main:     load time =   109.25 ms
main:   sample time =    23.69 ms
main:  predict time =   767.67 ms / 10.97 ms per token
main:    total time =   902.77 ms
...
main:  predict time =   784.17 ms / 11.20 ms per token
main:    total time =   942.53 ms
...
main:  predict time =  3143.31 ms
main:    total time =  3476.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80ef6d0990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80ef5511a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555c597bdce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f80ef6d0030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f80ef6d5940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555c597beab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80ef5511a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555c597bdce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555c597bf410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555c597beab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f80ef6d0030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555c597bfd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555c597bf410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555c597c06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80ef6d0990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555c597bfd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555c597c0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555c597c06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f80ef6d5940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555c597c0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555c597c0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.60 ms
whisper_print_timings:   sample time =    72.58 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2085.04 ms /     1 runs ( 2085.04 ms per run)
whisper_print_timings:   decode time =    15.80 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   338.59 ms /   125 runs (    2.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2615.15 ms
...
main:     load time =    71.24 ms
main:    total time = 19467.49 ms
embd_img
