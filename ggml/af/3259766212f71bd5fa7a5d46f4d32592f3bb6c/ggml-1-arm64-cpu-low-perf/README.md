...
- status:  SUCCESS ✅
- runtime: 4:03.22
- date:    Wed Mar 27 11:28:24 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.87 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.18 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.34 sec
      Start  9: test3
...
main:     load time =   162.68 ms
main:   sample time =    17.93 ms
main:  predict time =   922.01 ms / 14.41 ms per token
main:    total time =  1124.74 ms
...
main:     load time =   163.80 ms
main:   sample time =    17.88 ms
main:  predict time =   996.69 ms / 14.24 ms per token
main:    total time =  1181.23 ms
...
main:     load time =   193.12 ms
main:   sample time =    18.06 ms
main:  predict time =  1025.19 ms / 14.65 ms per token
main:    total time =  1239.92 ms
...
main:   sample time =   131.00 ms
main:  predict time =  6515.71 ms
main:    total time =  6898.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa61fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa607b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad5b83ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa61fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa61ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad5b84ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa607b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad5b83ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad5b85410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad5b84ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa61fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad5b85d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad5b85410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad5b866d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa61fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad5b85d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad5b86890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad5b866d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa61ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad5b86a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad5b86890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.06 ms
whisper_print_timings:   sample time =    66.70 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4722.65 ms /     1 runs ( 4722.65 ms per run)
whisper_print_timings:   decode time =    15.61 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   716.03 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5657.13 ms
...
main:     load time =    92.86 ms
main:    total time = 40007.72 ms
embd_img
