...
- status:  SUCCESS ✅
- runtime: 5:15.97
- date:    Tue Mar  5 14:26:11 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f51f7e6de5b9e520a2216f43904674f2b17d27e6
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.08 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   14.14 sec
...
22/22 Test #22: test-backend-ops .................   Passed  127.01 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 163.52 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.88 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.16 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed    7.06 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.97 sec
...
23/23 Test #23: test-backend-ops .................   Passed   31.67 sec
...
main:  predict time =   890.00 ms / 13.91 ms per token
main:    total time =  1081.75 ms
...
main:  predict time =   970.67 ms / 13.87 ms per token
main:    total time =  1141.00 ms
...
main:     load time =   171.59 ms
main:   sample time =    17.48 ms
main:  predict time =   984.73 ms / 14.07 ms per token
main:    total time =  1176.78 ms
...
main:   sample time =   127.08 ms
main:  predict time =  6434.20 ms
main:    total time =  6793.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa10da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0f5b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab069e1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa10da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa10df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab069e2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0f5b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab069e1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab069e3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab069e2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa10da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab069e3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab069e3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab069e46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa10da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab069e3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab069e4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab069e46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa10df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab069e4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab069e4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    65.30 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4692.71 ms /     1 runs ( 4692.71 ms per run)
whisper_print_timings:   decode time =    14.57 ms /     2 runs (    7.28 ms per run)
whisper_print_timings:   batchd time =   710.66 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5606.13 ms
...
main:     load time =    91.51 ms
main:    total time = 39752.03 ms
embd_img
