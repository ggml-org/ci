...
- status:  SUCCESS ✅
- runtime: 3:53.36
- date:    Tue Mar  5 14:12:39 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   12.35 sec
...
22/22 Test #22: test-backend-ops .................   Passed  106.82 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 137.85 sec
...
23/23 Test #23: test-backend-ops .................   Passed   25.50 sec
...
main:  predict time =   496.28 ms / 7.75 ms per token
main:    total time =   637.22 ms
...
main:  predict time =   517.30 ms / 7.39 ms per token
...
main:  predict time =   518.90 ms / 7.41 ms per token
main:    total time =   670.08 ms
...
main:   sample time =   175.86 ms
main:  predict time =  1866.99 ms
main:    total time =  2181.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efec9a6d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efec98ee1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560cf8064ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efec9a6d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efec9a72940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560cf8065ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efec98ee1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560cf8064ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560cf8066410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560cf8065ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efec9a6d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560cf8066d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560cf8066410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560cf80676d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efec9a6d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560cf8066d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560cf8067890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560cf80676d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efec9a72940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560cf8067a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560cf8067890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1188.09 ms /     1 runs ( 1188.09 ms per run)
whisper_print_timings:   decode time =    12.83 ms /     2 runs (    6.41 ms per run)
whisper_print_timings:   batchd time =   217.36 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1566.99 ms
