...
- status:  SUCCESS ✅
- runtime: 5:12.08
- date:    Tue Mar  5 14:11:00 UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed  104.02 sec
...
main:  predict time =   711.60 ms / 11.12 ms per token
main:    total time =   856.29 ms
...
main:     load time =   109.35 ms
main:   sample time =    23.67 ms
main:  predict time =   752.66 ms / 10.75 ms per token
main:    total time =   887.87 ms
...
main:     load time =   132.52 ms
main:   sample time =    24.01 ms
main:  predict time =   754.48 ms / 10.78 ms per token
main:    total time =   913.58 ms
...
main:  predict time =  3108.71 ms
main:    total time =  3436.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb4d0f83990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb4d0e041a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ebbcc85ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb4d0f83030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb4d0f88940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ebbcc86ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb4d0e041a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ebbcc85ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ebbcc87410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ebbcc86ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb4d0f83030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ebbcc87d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ebbcc87410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ebbcc886d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb4d0f83990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ebbcc87d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ebbcc88890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ebbcc886d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb4d0f88940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55ebbcc88a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ebbcc88890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.39 ms
whisper_print_timings:   sample time =    72.23 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2059.20 ms /     1 runs ( 2059.20 ms per run)
whisper_print_timings:   decode time =    15.64 ms /     2 runs (    7.82 ms per run)
whisper_print_timings:   batchd time =   329.37 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2578.80 ms
