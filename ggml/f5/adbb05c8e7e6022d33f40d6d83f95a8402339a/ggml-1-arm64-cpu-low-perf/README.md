...
- status:  SUCCESS ✅
- runtime: 6:14.63
- date:    Thu Mar  7 01:34:13 AM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f5adbb05c8e7e6022d33f40d6d83f95a8402339a
- author:  slaren
```
magika : fix ggml_backend_graph_compute status check (closes #760)
```
...
22/22 Test #22: test-backend-ops .................   Passed  131.64 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 191.38 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.24 sec
      Start  9: test3
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   29.75 sec
...
main:     load time =   157.25 ms
main:   sample time =    17.14 ms
main:  predict time =   903.07 ms / 14.11 ms per token
main:    total time =  1099.35 ms
...
main:     load time =   156.62 ms
main:   sample time =    17.01 ms
main:  predict time =   989.75 ms / 14.14 ms per token
main:    total time =  1166.09 ms
...
main:     load time =   183.58 ms
main:   sample time =    17.17 ms
main:  predict time =   996.22 ms / 14.23 ms per token
main:    total time =  1200.17 ms
...
main:     n_decoded =      504
main:     load time =   156.52 ms
main:   sample time =   128.27 ms
main:  predict time =  6651.74 ms
main:    total time =  7019.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff93bea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff93a6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9f9cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff93bea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff93bef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf9f9dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff93a6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9f9cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf9f9e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf9f9dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff93bea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf9f9ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf9f9e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf9f9f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff93bea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf9f9ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf9f9f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf9f9f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff93bef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf9f9fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf9f9f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.82 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.81 ms
whisper_print_timings:   sample time =    65.60 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4751.66 ms /     1 runs ( 4751.66 ms per run)
whisper_print_timings:   decode time =    14.60 ms /     2 runs (    7.30 ms per run)
whisper_print_timings:   batchd time =   712.26 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5671.02 ms
