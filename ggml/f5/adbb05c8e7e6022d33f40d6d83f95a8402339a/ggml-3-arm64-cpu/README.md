...
- status:  SUCCESS ✅
- runtime: 5:16.00
- date:    Thu Mar  7 01:33:08 UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed  127.02 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 163.68 sec
...
main:  predict time =   889.74 ms / 13.90 ms per token
main:    total time =  1080.79 ms
...
main:  predict time =   968.00 ms / 13.83 ms per token
main:    total time =  1137.59 ms
...
main:     load time =   178.29 ms
main:   sample time =    16.94 ms
main:  predict time =   982.96 ms / 14.04 ms per token
main:    total time =  1181.29 ms
...
main:     n_decoded =      504
main:     load time =   151.19 ms
main:   sample time =   128.82 ms
main:  predict time =  6447.62 ms
main:    total time =  6810.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e6aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e52b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac608fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e6aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e6af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac6090ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e52b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac608fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac6091410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac6090ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e6aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac6091d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac6091410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac60926d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e6aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac6091d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac6092890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac60926d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e6af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac6092a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac6092890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    13.41 ms
whisper_print_timings:   sample time =    65.67 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4687.60 ms /     1 runs ( 4687.60 ms per run)
whisper_print_timings:   decode time =    14.41 ms /     2 runs (    7.21 ms per run)
whisper_print_timings:   batchd time =   710.80 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5600.90 ms
...
main:     load time =    90.58 ms
main:    total time = 39778.61 ms
embd_img
