...
- status:  SUCCESS ✅
- runtime: 2:58.20
- date:    Fri Mar 22 07:39:51 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f5c9599cdba3133da0158dce061b33413b49f6fd
- author:  Bryan Lozano
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   26.64 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.61 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.56 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.66 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.89 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.17 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   14.29 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.95 sec
...
main:     load time =   145.72 ms
main:   sample time =    17.15 ms
main:  predict time =   891.78 ms / 13.93 ms per token
main:    total time =  1076.46 ms
...
main:     load time =   150.21 ms
main:   sample time =    16.63 ms
main:  predict time =   967.68 ms / 13.82 ms per token
main:    total time =  1137.21 ms
...
main:     load time =   179.58 ms
main:   sample time =    16.92 ms
main:  predict time =   987.16 ms / 14.10 ms per token
main:    total time =  1187.54 ms
...
main:     n_decoded =      504
main:     load time =   146.00 ms
main:   sample time =   128.43 ms
main:  predict time =  6458.37 ms
main:    total time =  6814.91 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d12a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8cfab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadc088ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d12a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d12f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadc089ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8cfab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadc088ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadc08a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadc089ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d12a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadc08ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadc08a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadc08b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d12a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadc08ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadc08b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadc08b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d12f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadc08ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadc08b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.92 ms
whisper_print_timings:   sample time =    65.35 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4675.27 ms /     1 runs ( 4675.27 ms per run)
whisper_print_timings:   decode time =    15.36 ms /     2 runs (    7.68 ms per run)
whisper_print_timings:   batchd time =   709.70 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5587.28 ms
...
main:     load time =    88.79 ms
main:    total time = 39770.34 ms
embd_img
