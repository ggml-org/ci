...
- status:  SUCCESS ✅
- runtime: 3:20.74
- date:    Fri Mar 22 07:29:16 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.76 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   13.09 sec
      Start  3: test-quantize-perf
...
main:  predict time =   702.52 ms / 10.98 ms per token
main:    total time =   843.41 ms
...
main:  predict time =   742.42 ms / 10.61 ms per token
main:    total time =   873.52 ms
...
main:  predict time =   806.59 ms / 11.52 ms per token
main:    total time =   959.42 ms
...
main:  predict time =  3108.61 ms
main:    total time =  3436.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3000a14990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30008951a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5617f5518ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3000a14030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3000a19940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5617f5519ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30008951a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5617f5518ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5617f551a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5617f5519ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3000a14030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5617f551ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5617f551a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5617f551b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3000a14990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5617f551ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5617f551b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5617f551b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3000a19940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5617f551ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5617f551b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.16 ms
whisper_print_timings:   sample time =    72.13 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2057.61 ms /     1 runs ( 2057.61 ms per run)
whisper_print_timings:   decode time =    15.53 ms /     2 runs (    7.77 ms per run)
whisper_print_timings:   batchd time =   336.62 ms /   125 runs (    2.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2583.36 ms
