...
- status:  SUCCESS ✅
- runtime: 3:53.86
- date:    Fri Mar 22 07:28:46 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   26.63 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.20 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.04 sec
      Start  2: test-quantize-fns
...
main:     load time =   164.58 ms
main:   sample time =    17.79 ms
main:  predict time =   938.98 ms / 14.67 ms per token
...
main:     load time =   158.73 ms
main:   sample time =    18.04 ms
main:  predict time =  1002.33 ms / 14.32 ms per token
main:    total time =  1181.86 ms
...
main:     load time =   187.77 ms
main:   sample time =    17.77 ms
main:  predict time =  1009.76 ms / 14.43 ms per token
...
main:     n_decoded =      504
main:     load time =   162.42 ms
main:   sample time =   127.40 ms
main:  predict time =  6795.83 ms
main:    total time =  7167.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb7b0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb798b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaef58dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7b0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb7b0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaef58eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb798b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaef58dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaef58f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaef58eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7b0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaef58fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaef58f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaef5906d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb7b0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaef58fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaef590890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaef5906d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb7b0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaef590a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaef590890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =    66.96 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4734.60 ms /     1 runs ( 4734.60 ms per run)
whisper_print_timings:   decode time =    15.83 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   720.20 ms /   125 runs (    5.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5666.65 ms
...
main:     load time =    90.01 ms
main:    total time = 40051.52 ms
embd_img
