...
- status:  SUCCESS ✅
- runtime: 1:59.89
- date:    Fri Mar 22 07:32:07 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   24.71 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   13.11 sec
...
main:  predict time =   497.32 ms / 7.77 ms per token
main:    total time =   641.13 ms
...
main:  predict time =   519.11 ms / 7.42 ms per token
main:    total time =   649.67 ms
...
main:  predict time =   535.36 ms / 7.65 ms per token
...
main:   sample time =   175.16 ms
main:  predict time =  1859.90 ms
main:    total time =  2171.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8facd57990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8facbd81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56540c03cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8facd57030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8facd5c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56540c03dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8facbd81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56540c03cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56540c03e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56540c03dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8facd57030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56540c03ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56540c03e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56540c03f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8facd57990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56540c03ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56540c03f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56540c03f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8facd5c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56540c03fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56540c03f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.99 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.92 ms
whisper_print_timings:   sample time =    54.94 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1186.85 ms /     1 runs ( 1186.85 ms per run)
whisper_print_timings:   decode time =    12.05 ms /     2 runs (    6.03 ms per run)
whisper_print_timings:   batchd time =   212.23 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1560.96 ms
...
main:     load time =    64.27 ms
main:    total time = 10667.18 ms
embd_img
