...
- status:  SUCCESS ✅
- runtime: 3:56.16
- date:    Wed Dec 13 16:53:57 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   35.51 sec
...
20/20 Test #20: test-backend-ops .................   Passed   11.20 sec
...
main:     load time =   210.51 ms
main:   sample time =    23.45 ms
main:  predict time =   452.44 ms / 7.07 ms per token
main:    total time =   699.08 ms
...
main:     load time =   131.21 ms
main:   sample time =    23.43 ms
main:  predict time =   460.07 ms / 6.57 ms per token
main:    total time =   617.01 ms
...
main:  predict time =  1472.56 ms
main:    total time =  1790.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f897c1049c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f897bf851b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563c1edf6ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f897c104050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f897c109980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563c1edf7980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f897bf851b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563c1edf6ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563c1edf82f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563c1edf7980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f897c104050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563c1edf8c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563c1edf82f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563c1edf95d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f897c1049c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563c1edf8c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563c1edf97a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563c1edf95d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f897c109980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563c1edf9970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563c1edf97a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.70 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    56.27 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1166.43 ms /     1 runs ( 1166.43 ms per run)
whisper_print_timings:   decode time =    10.18 ms /     2 runs (    5.09 ms per run)
whisper_print_timings:   batchd time =   211.33 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1586.70 ms
...
main:     load time =    63.80 ms
main:    total time = 10584.07 ms
embd_img
...
main:      load time =  7771.54 ms
main:    sample time =   466.38 ms / 7.29 ms per token
main:      eval time = 20576.40 ms / 293.95 ms per token
main:     total time = 29531.70 ms
...
main:      load time =  2405.07 ms
main:    sample time =   466.23 ms / 7.28 ms per token
main:      eval time =  8140.12 ms / 116.29 ms per token
main:     total time = 11388.71 ms
