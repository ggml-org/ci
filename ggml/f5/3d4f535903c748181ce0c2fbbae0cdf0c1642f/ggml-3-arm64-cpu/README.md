...
- status:  SUCCESS ✅
- runtime: 5:40.88
- date:    Wed Dec 13 04:58:29 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.62 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   44.66 sec
...
20/20 Test #20: test-backend-ops .................   Passed   13.12 sec
...
main:     load time =   204.55 ms
main:   sample time =    17.15 ms
main:  predict time =   808.04 ms / 12.63 ms per token
main:    total time =  1051.53 ms
...
main:  predict time =   876.50 ms / 12.52 ms per token
main:    total time =  1087.63 ms
...
main:     n_decoded =      504
main:     load time =   160.65 ms
main:   sample time =   127.00 ms
main:  predict time =  5890.46 ms
main:    total time =  6259.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f30a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f18b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1954aba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f30a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f30f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1954b980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f18b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1954aba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1954c2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1954b980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f30a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1954cc60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1954c2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1954d5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f30a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1954cc60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1954d7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1954d5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f30f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab1954d970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1954d7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   187.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.82 ms
whisper_print_timings:   sample time =    65.33 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4657.65 ms /     1 runs ( 4657.65 ms per run)
whisper_print_timings:   decode time =    14.99 ms /     2 runs (    7.49 ms per run)
whisper_print_timings:   batchd time =   707.60 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5652.10 ms
...
main:     load time =    84.88 ms
main:    total time = 39466.43 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.235000 sec.)
...
main:      load time =  5608.20 ms
main:    sample time =   524.63 ms / 8.20 ms per token
main:      eval time = 43792.82 ms / 625.61 ms per token
main:     total time = 52300.84 ms
...
main:      load time =  1544.77 ms
main:    sample time =   524.82 ms / 8.20 ms per token
main:      eval time = 17784.74 ms / 254.07 ms per token
main:     total time = 20840.03 ms
