...
- status:  SUCCESS ✅
- runtime: 8:10.00
- date:    Wed Dec 13 17:15:58 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.84 sec
      Start  2: test-quantize-fns
 2/19 Test  #2: test-quantize-fns ................   Passed    0.57 sec
      Start  3: test-quantize-perf
 3/19 Test  #3: test-quantize-perf ...............   Passed    0.82 sec
 ...
 6/19 Test  #6: test0 ............................   Passed    0.54 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.58 sec
      Start  8: test2
...
19/19 Test #19: test-backend-ops .................   Passed   78.76 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 111.35 sec
...
20/20 Test #20: test-backend-ops .................   Passed   28.00 sec
...
main:     load time =  1557.09 ms
main:   sample time =    34.56 ms
main:  predict time =   584.33 ms / 9.13 ms per token
main:    total time =  2199.42 ms
...
main:     load time =   588.62 ms
main:   sample time =    35.70 ms
main:  predict time =   597.07 ms / 8.53 ms per token
main:    total time =  1225.87 ms
...
main:     n_decoded =      504
main:     load time =   576.66 ms
main:   sample time =   235.21 ms
main:  predict time =  2173.32 ms
main:    total time =  3030.47 ms
...
main: loaded model in   437.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f57337b69c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f57336371b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6cb0472e0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f57337b6050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f57337bb980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a6cb0480c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f57336371b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6cb0472e0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a6cb048a30                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a6cb0480c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f57337b6050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a6cb0493a0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a6cb048a30                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a6cb049d10                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f57337b69c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a6cb0493a0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a6cb049ee0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a6cb049d10                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f57337bb980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a6cb04a0b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a6cb049ee0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   529.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.79 ms
whisper_print_timings:   sample time =    68.61 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    37.07 ms /     1 runs (   37.07 ms per run)
whisper_print_timings:   decode time =    15.52 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =    84.65 ms /   125 runs (    0.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   761.69 ms
...
main:     load time =   494.89 ms
main:    total time =  7868.96 ms
embd_img
...
main:      load time =  7235.58 ms
main:    sample time =   517.00 ms / 8.08 ms per token
main:      eval time = 24485.82 ms / 349.80 ms per token
...
main:      load time =  2067.79 ms
main:    sample time =   525.01 ms / 8.20 ms per token
main:      eval time = 12280.37 ms / 175.43 ms per token
main:     total time = 15515.78 ms
