...
- status:  SUCCESS ✅
- runtime: 3:55.09
- date:    Wed Dec 13 04:51:21 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f53d4f535903c748181ce0c2fbbae0cdf0c1642f
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.54 sec
      Start  6: test0
 6/19 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.96 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   59.05 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.84 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   13.68 sec
...
main:     load time =   194.93 ms
main:   sample time =    17.83 ms
main:  predict time =   837.27 ms / 13.08 ms per token
main:    total time =  1071.93 ms
...
main:     load time =   193.56 ms
main:   sample time =    17.85 ms
main:  predict time =   912.47 ms / 13.04 ms per token
main:    total time =  1126.95 ms
...
main:     n_decoded =      504
main:     load time =   167.07 ms
main:   sample time =   128.07 ms
main:  predict time =  6093.15 ms
main:    total time =  6470.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9897a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff987fb1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad1cffba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9897a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9897f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad1d00980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff987fb1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad1cffba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad1d012f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad1d00980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9897a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad1d01c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad1d012f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad1d025d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9897a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad1d01c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad1d027a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad1d025d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9897f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad1d02970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad1d027a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.99 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.55 ms
whisper_print_timings:   sample time =    72.73 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  4758.49 ms /     1 runs ( 4758.49 ms per run)
whisper_print_timings:   decode time =    15.57 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   715.09 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5702.03 ms
