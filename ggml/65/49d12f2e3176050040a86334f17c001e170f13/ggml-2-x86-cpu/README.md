...
- status:  SUCCESS ✅
- runtime: 2:48.52
- date:    Mon Oct  9 15:21:43 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.74 sec
      Start  2: test-opt
...
main:  predict time =   480.72 ms / 7.51 ms per token
main:    total time =   688.84 ms
...
main:     load time =   109.48 ms
main:   sample time =    23.94 ms
main:  predict time =   492.73 ms / 7.04 ms per token
main:    total time =   629.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5c56505900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5c56386170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561f633f3ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5c56504fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5c5650a880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561f633f4870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5c56386170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561f633f3ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561f633f51a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561f633f4870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5c56504fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561f633f5ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561f633f51a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561f633f6400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5c56505900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561f633f5ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561f633f6590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561f633f6400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5c5650a880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x561f633f6720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561f633f6590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   141.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.70 ms
whisper_print_timings:   sample time =    16.68 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  1173.21 ms /     1 runs ( 1173.21 ms per run)
whisper_print_timings:   decode time =   108.01 ms /    27 runs (    4.00 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1496.79 ms
```
### mpt
...
main:      load time =  5761.98 ms
main:    sample time =   467.15 ms / 7.30 ms per token
main:      eval time = 22113.91 ms / 315.91 ms per token
main:     total time = 29036.54 ms
...
main:      load time =  1295.56 ms
main:    sample time =   462.59 ms / 7.23 ms per token
main:      eval time =  9324.27 ms / 133.20 ms per token
main:     total time = 11471.66 ms
