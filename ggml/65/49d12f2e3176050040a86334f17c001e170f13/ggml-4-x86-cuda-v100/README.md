...
- status:  SUCCESS ✅
- runtime: 4:53.39
- date:    Tue Oct 10 11:06:41 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.58 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    7.48 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.52 sec
      Start  2: test-opt
...
main:  predict time =   597.34 ms / 8.53 ms per token
main:    total time =   788.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f894c6a8900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f894c529170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d9961c8ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f894c6a7fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f894c6ad880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d9961c9870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f894c529170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d9961c8ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d9961ca1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d9961c9870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f894c6a7fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d9961caad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d9961ca1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d9961cb400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f894c6a8900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d9961caad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d9961cb590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d9961cb400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f894c6ad880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d9961cb720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d9961cb590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   751.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.84 ms
whisper_print_timings:   sample time =    23.84 ms /    27 runs (    0.88 ms per run)
whisper_print_timings:   encode time =  1868.38 ms /     1 runs ( 1868.38 ms per run)
whisper_print_timings:   decode time =   144.04 ms /    27 runs (    5.33 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2872.56 ms
```
### mpt
...
main:      load time = 10400.17 ms
main:    sample time =   578.89 ms / 9.05 ms per token
main:      eval time = 25813.39 ms / 368.76 ms per token
main:     total time = 37678.80 ms
...
main:      load time =  1788.06 ms
main:    sample time =   575.47 ms / 8.99 ms per token
main:      eval time = 12376.21 ms / 176.80 ms per token
main:     total time = 15414.59 ms
