...
- status:  SUCCESS ✅
- runtime: 3:39.69
- date:    Mon Oct  9 03:23:30 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.73 sec
...
main:     load time =   169.86 ms
main:   sample time =    16.91 ms
main:  predict time =   799.29 ms / 12.49 ms per token
main:    total time =  1009.23 ms
...
main:     load time =   147.79 ms
main:   sample time =    17.04 ms
main:  predict time =   869.33 ms / 12.42 ms per token
main:    total time =  1038.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2c5a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa2adb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafcf92ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2c59fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2c5f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafcf93870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa2adb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafcf92ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafcf941a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafcf93870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2c59fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafcf94ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafcf941a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafcf95400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2c5a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafcf94ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafcf95590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafcf95400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2c5f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafcf95720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafcf95590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   201.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =    20.96 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4605.36 ms /     1 runs ( 4605.36 ms per run)
whisper_print_timings:   decode time =   180.40 ms /    27 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5078.09 ms
```
### mpt
...
main:      load time =  5506.65 ms
main:    sample time =   525.07 ms / 8.20 ms per token
main:      eval time = 43829.05 ms / 626.13 ms per token
main:     total time = 52234.36 ms
...
main:      load time =  1538.90 ms
main:    sample time =   519.52 ms / 8.12 ms per token
main:      eval time = 17436.97 ms / 249.10 ms per token
main:     total time = 20460.51 ms
