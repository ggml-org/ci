...
- status:  SUCCESS ✅
- runtime: 1:41.07
- date:    Tue Jul 25 15:19:46 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/10 Test  #1: test-grad0 .......................   Passed    4.02 sec
      Start  2: test-quantize-fns
...
main:     load time =   133.29 ms
main:   sample time =    23.64 ms
main:  predict time =   596.89 ms / 9.33 ms per token
...
main:  predict time =   632.48 ms / 9.04 ms per token
main:    total time =   827.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8e3b9f870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa8e3a20140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56250e562aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa8e3b9ef70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa8e3ba47c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56250e563810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa8e3a20140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56250e562aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56250e564110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56250e563810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa8e3b9ef70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56250e564a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56250e564110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56250e565310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8e3b9f870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56250e564a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56250e565470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56250e565310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa8e3ba47c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56250e5655d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56250e565470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
+++ /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/stdall	2023-07-25 15:19:46.792664470 +0000
@@ -1,7 +1,7 @@
...
+rm: cannot remove '/home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/*.md': No such file or directory
...
++ tee /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/3d/d91c628dd486e82a4851f85504eceda15463be/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
...
+user	0m0.265s
+sys	0m0.120s
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_debug-make.log
 + make -j
...
+user	0m38.249s
+sys	0m3.526s
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_release.log
...
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_release-cmake.log
...
+user	0m0.254s
+sys	0m0.129s
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_release-make.log
 + make -j
...
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/ctest_release-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/gpt_2.log
...
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -506,15 +549,15 @@
...
@@ -554,8 +597,8 @@
 ...
 + cd /home/ggml/work/ggml
 + cd build-ci-release
++ tee /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/mnist.log
 + set -e
...
++ tee -a /home/ggml/results/ggml/c0/b3734b490e125a7cb379229f92e9996b91eb12/ggml-0-x86-cpu-low-perf/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
