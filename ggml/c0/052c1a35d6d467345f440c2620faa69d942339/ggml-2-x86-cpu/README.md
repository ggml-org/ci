...
- status:  SUCCESS ✅
- runtime: 3:57.98
- date:    Mon Mar  4 09:03:44 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.64 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   12.16 sec
...
22/22 Test #22: test-backend-ops .................   Passed  105.85 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.48 sec
      Start  2: test-opt
...
23/23 Test #23: test-backend-ops .................   Passed   28.25 sec
...
main:  predict time =   526.43 ms / 8.23 ms per token
main:    total time =   677.50 ms
...
main:     load time =   114.49 ms
main:   sample time =    23.87 ms
main:  predict time =   560.19 ms / 8.00 ms per token
main:    total time =   700.81 ms
...
main:     load time =   131.49 ms
main:   sample time =    24.07 ms
main:  predict time =   551.06 ms / 7.87 ms per token
main:    total time =   709.34 ms
...
main:     n_decoded =      504
main:     load time =   110.02 ms
main:   sample time =   175.84 ms
main:  predict time =  1884.29 ms
main:    total time =  2204.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffae4f86990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffae4e071a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55bbdf33dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffae4f86030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffae4f8b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55bbdf33eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffae4e071a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55bbdf33dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55bbdf33f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55bbdf33eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffae4f86030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55bbdf33fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55bbdf33f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55bbdf3406d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffae4f86990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55bbdf33fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55bbdf340890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55bbdf3406d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffae4f8b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55bbdf340a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55bbdf340890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.89 ms
whisper_print_timings:   sample time =    56.18 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1198.78 ms /     1 runs ( 1198.78 ms per run)
whisper_print_timings:   decode time =    12.83 ms /     2 runs (    6.42 ms per run)
whisper_print_timings:   batchd time =   217.02 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1585.06 ms
...
main:     load time =    69.26 ms
main:    total time = 10819.52 ms
embd_img
