...
- status:  SUCCESS ✅
- runtime: 5:13.68
- date:    Mon Mar  4 09:06:46 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/c0052c1a35d6d467345f440c2620faa69d942339
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.10 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   13.55 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.13 sec
...
22/22 Test #22: test-backend-ops .................   Passed  126.76 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 162.84 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.83 sec
      Start  2: test-opt
...
23/23 Test #23: test-backend-ops .................   Passed   31.41 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) =  50.84 sec
...
main:  predict time =   892.41 ms / 13.94 ms per token
main:    total time =  1082.84 ms
...
main:     load time =   153.45 ms
main:   sample time =    17.20 ms
main:  predict time =   969.41 ms / 13.85 ms per token
main:    total time =  1142.92 ms
...
main:     load time =   178.05 ms
main:   sample time =    17.16 ms
main:  predict time =   987.70 ms / 14.11 ms per token
main:    total time =  1186.02 ms
...
main:     n_decoded =      504
main:     load time =   152.10 ms
main:   sample time =   129.13 ms
main:  predict time =  6445.28 ms
main:    total time =  6809.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f51a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f39b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac8cffce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f51a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f51f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac8d00ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f39b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac8cffce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac8d01410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac8d00ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f51a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac8d01d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac8d01410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac8d026d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f51a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac8d01d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac8d02890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac8d026d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f51f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac8d02a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac8d02890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.77 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.17 ms
whisper_print_timings:   sample time =    65.25 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4681.74 ms /     1 runs ( 4681.74 ms per run)
whisper_print_timings:   decode time =    15.29 ms /     2 runs (    7.64 ms per run)
whisper_print_timings:   batchd time =   709.04 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5594.77 ms
...
main:     load time =    92.36 ms
main:    total time = 39728.30 ms
embd_img
