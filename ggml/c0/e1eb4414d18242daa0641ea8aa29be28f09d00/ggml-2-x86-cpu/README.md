...
- status:  SUCCESS ✅
- runtime: 3:03.63
- date:    Mon Oct 16 13:51:49 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/c0e1eb4414d18242daa0641ea8aa29be28f09d00
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.79 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/15 Test  #6: test-mul-mat2 ....................   Passed    2.86 sec
      Start  7: test0
...
main:     load time =   174.32 ms
main:   sample time =    24.13 ms
main:  predict time =   480.85 ms / 7.51 ms per token
main:    total time =   693.20 ms
...
main:     n_decoded =      504
main:     load time =   117.59 ms
main:   sample time =   178.31 ms
main:  predict time =  1550.54 ms
main:    total time =  1881.49 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff1a004a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff19fecb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56431aa54ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff1a0049fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff1a004f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56431aa55870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff19fecb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56431aa54ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56431aa561a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56431aa55870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff1a0049fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56431aa56ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56431aa561a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56431aa57400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff1a004a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56431aa56ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56431aa57590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56431aa57400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff1a004f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56431aa57720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56431aa57590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   148.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.59 ms
whisper_print_timings:   sample time =    16.60 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1165.12 ms /     1 runs ( 1165.12 ms per run)
whisper_print_timings:   decode time =   108.24 ms /    27 runs (    4.01 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1499.11 ms
...
main:     load time =    77.69 ms
main:    total time = 10652.46 ms
embd_img
...
main:      load time =  5857.99 ms
main:    sample time =   463.66 ms / 7.24 ms per token
main:      eval time = 22267.82 ms / 318.11 ms per token
main:     total time = 29280.48 ms
...
main:      load time =  1308.67 ms
main:    sample time =   480.50 ms / 7.51 ms per token
main:      eval time =  9551.61 ms / 136.45 ms per token
main:     total time = 11703.28 ms
