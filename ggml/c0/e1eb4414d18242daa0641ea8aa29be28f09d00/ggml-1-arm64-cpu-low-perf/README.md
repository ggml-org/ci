...
- status:  SUCCESS ✅
- runtime: 2:32.29
- date:    Mon Oct 16 01:51:22 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.15 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.32 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
...
Total Test time (real) =  17.93 sec
...
main:  predict time =   833.62 ms / 13.03 ms per token
main:    total time =  1027.03 ms
...
main:  predict time =   899.66 ms / 12.85 ms per token
main:    total time =  1074.07 ms
...
main:  predict time =  6094.64 ms
main:    total time =  6458.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa228a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa210b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae19cbad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2289fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa228f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae19cc870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa210b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae19cbad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae19cd1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae19cc870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2289fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae19cdad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae19cd1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae19ce400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa228a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae19cdad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae19ce590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae19ce400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa228f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae19ce720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae19ce590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.34 ms
whisper_print_timings:   sample time =    20.89 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4644.30 ms /     1 runs ( 4644.30 ms per run)
whisper_print_timings:   decode time =   187.10 ms /    27 runs (    6.93 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5038.77 ms
...
main:     load time =    84.10 ms
main:    total time = 40243.40 ms
embd_img
