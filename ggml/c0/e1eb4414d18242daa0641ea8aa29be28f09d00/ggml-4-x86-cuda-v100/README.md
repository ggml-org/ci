...
- status:  SUCCESS ✅
- runtime: 5:09.85
- date:    Mon Oct 16 13:53:55 UTC 2023
...
main:     load time =   227.53 ms
main:   sample time =    35.15 ms
main:  predict time =   571.50 ms / 8.93 ms per token
main:    total time =   854.37 ms
...
main:   sample time =    39.58 ms
main:  predict time =   613.86 ms / 8.77 ms per token
...
main:     n_decoded =      504
main:     load time =   162.71 ms
main:   sample time =   238.95 ms
main:  predict time =  2261.41 ms
main:    total time =  2709.04 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efd5d85e900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efd5d6df170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560bb45d7ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efd5d85dfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efd5d863880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560bb45d8870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efd5d6df170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560bb45d7ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560bb45d91a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560bb45d8870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efd5d85dfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560bb45d9ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560bb45d91a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560bb45da400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efd5d85e900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560bb45d9ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560bb45da590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560bb45da400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efd5d863880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560bb45da720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560bb45da590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   706.82 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.99 ms
whisper_print_timings:   sample time =    20.68 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  1914.49 ms /     1 runs ( 1914.49 ms per run)
whisper_print_timings:   decode time =   139.84 ms /    27 runs (    5.18 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2869.28 ms
...
main:     load time =   112.10 ms
main:    total time = 16722.51 ms
embd_img
...
main:      load time =  7059.69 ms
main:    sample time =   587.43 ms / 9.18 ms per token
main:      eval time = 26033.26 ms / 371.90 ms per token
main:     total time = 34569.01 ms
...
main:      load time =  1793.78 ms
main:    sample time =   596.96 ms / 9.33 ms per token
main:      eval time = 12415.35 ms / 177.36 ms per token
main:     total time = 15475.22 ms
