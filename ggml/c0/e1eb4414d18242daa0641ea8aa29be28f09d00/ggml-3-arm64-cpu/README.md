...
- status:  SUCCESS ✅
- runtime: 4:35.67
- date:    Mon Oct 16 01:53:23 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.68 sec
...
main:     load time =   141.37 ms
main:   sample time =    17.03 ms
main:  predict time =   797.35 ms / 12.46 ms per token
main:    total time =   978.78 ms
...
main:  predict time =   869.60 ms / 12.42 ms per token
main:    total time =  1036.66 ms
...
main:  predict time =  5855.90 ms
main:    total time =  6211.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9392a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff937ab170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0981ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff93929fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9392f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0981f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff937ab170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0981ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab098201a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0981f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff93929fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab09820ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab098201a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab09821400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9392a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab09820ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab09821590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab09821400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9392f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab09821720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab09821590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   228.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.49 ms
whisper_print_timings:   sample time =    20.90 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4599.72 ms /     1 runs ( 4599.72 ms per run)
whisper_print_timings:   decode time =   181.26 ms /    27 runs (    6.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5100.21 ms
...
main:     load time =    85.57 ms
main:    total time = 39328.24 ms
embd_img
...
main:      load time =  5685.47 ms
main:    sample time =   522.74 ms / 8.17 ms per token
main:      eval time = 43570.43 ms / 622.43 ms per token
main:     total time = 52150.15 ms
...
main:      load time =  1497.39 ms
main:    sample time =   525.64 ms / 8.21 ms per token
main:      eval time = 17337.30 ms / 247.68 ms per token
main:     total time = 20323.65 ms
