...
- status:  SUCCESS ✅
- runtime: 111.19
- date:    Mon Oct 16 16:49:44 EEST 2023
...
14/15 Test #14: test-customop ....................   Passed    0.21 sec
      Start 15: test-xpos
15/15 Test #15: test-xpos ........................   Passed    0.21 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/16 Test  #1: test-grad0 .......................   Passed    1.19 sec
      Start  2: test-opt
...
10/16 Test #10: test2 ............................   Passed    0.24 sec
      Start 11: test3
11/16 Test #11: test3 ............................   Passed    0.23 sec
      Start 12: test-pool
12/16 Test #12: test-pool ........................   Passed    0.21 sec
      Start 13: test-conv-transpose
13/16 Test #13: test-conv-transpose ..............   Passed    0.21 sec
      Start 14: test-rel-pos
14/16 Test #14: test-rel-pos .....................   Passed    0.24 sec
...
main:     load time =   153.68 ms
main:   sample time =     8.85 ms
main:  predict time =   299.43 ms / 4.68 ms per token
main:    total time =   465.29 ms
...
main:     load time =    88.41 ms
main:   sample time =     8.89 ms
main:  predict time =   305.11 ms / 4.36 ms per token
main:    total time =   403.39 ms
...
main:     n_decoded =      504
main:     load time =   134.06 ms
main:   sample time =    65.91 ms
main:  predict time =   760.96 ms
main:    total time =   972.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1381878f0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x138008160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x13280f760                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x138186fc0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x13818c870                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x132810500                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x138008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x13280f760                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x132810e30                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x132810500                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x138186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x132811760                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x132810e30                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x132812090                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1381878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x132811760                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x132812220                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x132812090                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x13818c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x1328123b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x132812220                           node_4
...
whisper_print_timings:     load time =   124.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.38 ms
whisper_print_timings:   sample time =    11.63 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   667.36 ms /     1 runs (  667.36 ms per run)
whisper_print_timings:   decode time =    63.45 ms /    27 runs (    2.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   887.68 ms
...
main:     load time =    76.11 ms
main:    total time =  5575.80 ms
embd_img
