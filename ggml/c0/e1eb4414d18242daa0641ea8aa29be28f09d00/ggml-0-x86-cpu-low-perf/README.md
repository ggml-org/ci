...
- status:  SUCCESS ✅
- runtime: 1:55.19
- date:    Mon Oct 16 13:50:52 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.07 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.79 sec
      Start  9: test3
...
main:     load time =   102.88 ms
main:   sample time =    23.77 ms
main:  predict time =   641.62 ms / 10.03 ms per token
main:    total time =   781.85 ms
...
main:     load time =   107.15 ms
main:   sample time =    23.88 ms
main:  predict time =   791.97 ms / 11.31 ms per token
main:    total time =   926.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fda4a2ec900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fda4a16d170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5617aeb97ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fda4a2ebfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fda4a2f1880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5617aeb98870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fda4a16d170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5617aeb97ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5617aeb991a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5617aeb98870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fda4a2ebfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5617aeb99ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5617aeb991a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5617aeb9a400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fda4a2ec900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5617aeb99ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5617aeb9a590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5617aeb9a400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fda4a2f1880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5617aeb9a720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5617aeb9a590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    82.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.97 ms
whisper_print_timings:   sample time =    16.34 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  2062.40 ms /     1 runs ( 2062.40 ms per run)
whisper_print_timings:   decode time =   134.06 ms /    27 runs (    4.97 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2357.21 ms
...
main:     load time =    62.88 ms
main:    total time = 18825.03 ms
embd_img
