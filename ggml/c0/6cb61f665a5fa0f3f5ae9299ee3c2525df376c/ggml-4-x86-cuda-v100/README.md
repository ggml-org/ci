...
- status:  SUCCESS ✅
- runtime: 5:07.86
- date:    Fri Sep  8 15:02:18 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.60 sec
      Start  2: test-opt
...
main:     load time =   199.12 ms
main:   sample time =    35.06 ms
main:  predict time =   560.47 ms / 8.76 ms per token
main:    total time =   815.27 ms
...
main:     load time =   201.52 ms
main:   sample time =    35.59 ms
main:  predict time =   571.61 ms / 8.17 ms per token
main:    total time =   814.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f352a94e8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f352a7cf160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55852fe91ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f352a94dfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f352a953840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55852fe92850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f352a7cf160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55852fe91ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55852fe93170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55852fe92850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f352a94dfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55852fe93a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55852fe93170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55852fe943b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f352a94e8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55852fe93a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55852fe94530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55852fe943b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f352a953840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55852fe946b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55852fe94530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12901.18 ms
main:    sample time =   578.21 ms / 9.03 ms per token
main:      eval time = 24794.30 ms / 354.20 ms per token
main:     total time = 39148.10 ms
...
main:      load time =  7691.77 ms
main:    sample time =   578.66 ms / 9.04 ms per token
main:      eval time = 12128.66 ms / 173.27 ms per token
main:     total time = 21050.21 ms
