...
- status:  SUCCESS ✅
- runtime: 3:41.31
- date:    Fri Sep  8 15:00:52 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.38 sec
      Start  6: test0
...
main:     load time =   269.93 ms
main:   sample time =    17.33 ms
main:  predict time =   808.78 ms / 12.64 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e21a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e09b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaef3b8ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e219fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e21f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaef3b9850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e09b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaef3b8ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaef3ba170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaef3b9850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e219fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaef3baa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaef3ba170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaef3bb3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e21a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaef3baa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaef3bb530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaef3bb3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e21f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaef3bb6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaef3bb530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 13697.18 ms
main:    sample time =   625.05 ms / 9.77 ms per token
main:      eval time = 43813.12 ms / 625.90 ms per token
main:     total time = 60513.32 ms
...
main:      load time =  4350.76 ms
main:    sample time =   616.50 ms / 9.63 ms per token
main:      eval time = 17360.02 ms / 248.00 ms per token
main:     total time = 23284.38 ms
