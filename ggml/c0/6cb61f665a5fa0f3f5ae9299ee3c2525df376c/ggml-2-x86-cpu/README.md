...
- status:  SUCCESS ✅
- runtime: 2:34.56
- date:    Fri Sep  8 14:59:45 UTC 2023
...
main:     load time =   240.83 ms
main:   sample time =    23.54 ms
main:  predict time =   433.20 ms / 6.77 ms per token
main:    total time =   710.98 ms
...
main:  predict time =   455.62 ms / 6.51 ms per token
main:    total time =   610.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8bb5878d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc8bb408160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a64c25eac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8bb586fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8bb58c840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a64c25f850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc8bb408160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a64c25eac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a64c260170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a64c25f850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8bb586fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a64c260a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a64c260170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a64c2613b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8bb5878d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a64c260a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a64c261530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a64c2613b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8bb58c840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a64c2616b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a64c261530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5454.35 ms
main:    sample time =   468.71 ms / 7.32 ms per token
main:      eval time = 20640.66 ms / 294.87 ms per token
main:     total time = 27228.34 ms
...
main:      load time =  1242.39 ms
main:    sample time =   466.13 ms / 7.28 ms per token
main:      eval time =  7978.60 ms / 113.98 ms per token
main:     total time = 10059.12 ms
