...
- status: SUCCESS ✅
- date:   Sat Jul 22 10:56:50 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/10 Test  #5: test-mul-mat2 ....................   Passed    7.41 sec
      Start  6: test0
 ...
 8/10 Test  #8: test2 ............................   Passed   16.16 sec
      Start  9: test3
 9/10 Test  #9: test3 ............................   Passed    0.89 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/11 Test  #1: test-grad0 .......................   Passed    4.61 sec
      Start  2: test-opt
 ...
 8/11 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/11 Test  #9: test2 ............................   Passed   16.13 sec
      Start 10: test3
...
main:     load time =   189.81 ms
main:   sample time =    34.47 ms
main:  predict time =   568.45 ms / 8.88 ms per token
main:    total time =   859.66 ms
...
main: mem per token =  2016924 bytes
main:     load time =   184.79 ms
main:   sample time =    40.46 ms
main:  predict time =   678.97 ms / 9.70 ms per token
main:    total time =   946.61 ms
...
main:      load time = 26347.04 ms
main:    sample time =   571.06 ms / 8.92 ms per token
main:      eval time = 26416.31 ms / 377.38 ms per token
main:     total time = 54812.30 ms
...
main:      load time =  8964.82 ms
main:    sample time =   578.33 ms / 9.04 ms per token
main:      eval time = 12715.07 ms / 181.64 ms per token
main:     total time = 23022.67 ms
...
+++ /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/stdall	2023-07-22 10:56:50.344520971 +0000
@@ -1,6 +1,6 @@
...
+rm: cannot remove '/home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/*.md': No such file or directory
...
++ tee /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/db/d2b0fff35263395cef6f0d7a1195d1138395f8/ggml-4-x86-cuda-v100/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_debug-cmake.log
...
+user	0m0.408s
+sys	0m0.139s
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_debug-make.log
 + make -j
...
+[ 19%] Linking C executable ../bin/test-opt
...
+user	0m37.659s
+sys	0m3.931s
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_release.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_release-cmake.log
...
+user	0m0.380s
+sys	0m0.156s
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_release-make.log
 + make -j
 [  1%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
 [  2%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
...
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/ctest_release-ctest.log
 + ctest --output-on-failure
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
+sys	0m5.599s
 ...
 + set +x
 + gg_run_gpt_2
++ tee /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/gpt_2.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -526,15 +526,15 @@
...
++ tee /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/mpt.log
 ++ pwd
...
+2023-07-22 10:53:22 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-22 10:53:23 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-22 10:53:23 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-22 10:53:24 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-22 10:53:24 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
 + cd /home/ggml/work/ggml
...
+main: quantize time = 47941.53 ms
+main:    total time = 47941.53 ms
++ tee -a /home/ggml/results/ggml/c0/98c44f60d259d4cf878528498606c8dd0015e1/ggml-4-x86-cuda-v100/mpt-tg.log
 + ./bin/mpt --model ../models-mnt/mpt/7B/ggml-model-f16.bin -s 1234 -n 64 -p 'I believe the meaning of life is'
 main: seed      = 1234
 main: n_threads = 4
@@ -1114,15 +1114,15 @@
...
+587.46user 60.82system 5:53.43elapsed 183%CPU (0avgtext+0avgdata 13062964maxresident)k
+12686528inputs+34074344outputs (46major+3493621minor)pagefaults 0swaps
```
</details>
