...
- status:  SUCCESS ✅
- runtime: 3:42.61
- date:    Sat Dec 23 16:01:00 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.46 sec
...
19/19 Test #19: test-backend-ops .................   Passed   27.46 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.53 sec
...
main:     load time =   196.10 ms
main:   sample time =    23.48 ms
main:  predict time =   437.96 ms / 6.84 ms per token
main:    total time =   670.23 ms
...
main:     load time =   125.57 ms
main:   sample time =    23.39 ms
main:  predict time =   451.07 ms / 6.44 ms per token
main:    total time =   602.07 ms
...
main:  predict time =  1492.42 ms
main:    total time =  1805.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd689a28990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd6898a91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5620b854ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd689a28030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd689a2d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5620b854b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd6898a91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5620b854ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5620b854c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5620b854b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd689a28030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5620b854cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5620b854c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620b854d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd689a28990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5620b854cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5620b854d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5620b854d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd689a2d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5620b854d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5620b854d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    55.92 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1165.38 ms /     1 runs ( 1165.38 ms per run)
whisper_print_timings:   decode time =    10.01 ms /     2 runs (    5.00 ms per run)
whisper_print_timings:   batchd time =   214.08 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1588.93 ms
...
main:      load time =  5746.72 ms
main:    sample time =   469.37 ms / 7.33 ms per token
main:      eval time = 21031.83 ms / 300.45 ms per token
main:     total time = 27921.22 ms
...
main:      load time =  1286.26 ms
main:    sample time =   467.89 ms / 7.31 ms per token
main:      eval time =  8252.85 ms / 117.90 ms per token
main:     total time = 10362.01 ms
