...
- status:  SUCCESS ✅
- runtime: 3:42.46
- date:    Fri Sep  8 16:58:22 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/dd1d575956e54c5bdc07632f25506b3b1884dbd2
- author:  Diogo
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.92 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.02 sec
      Start  4: test-mul-mat0
 4/14 Test  #4: test-mul-mat0 ....................   Passed    1.03 sec
      Start  5: test-mul-mat2
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.34 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.83 sec
      Start  2: test-opt
...
main:     load time =   251.04 ms
main:   sample time =    17.64 ms
main:  predict time =   815.64 ms / 12.74 ms per token
main:    total time =  1106.96 ms
...
main:     load time =   168.08 ms
main:   sample time =    17.46 ms
main:  predict time =   875.91 ms / 12.51 ms per token
main:    total time =  1065.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98f3a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98dbb160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae412dac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98f39fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98f3f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae412e850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98dbb160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae412dac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae412f170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae412e850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98f39fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae412fa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae412f170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae41303b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98f3a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae412fa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae4130530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae41303b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98f3f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae41306b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae4130530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 13062.52 ms
main:    sample time =   616.10 ms / 9.63 ms per token
main:      eval time = 43685.81 ms / 624.08 ms per token
main:     total time = 59740.19 ms
...
main:      load time =  4365.96 ms
main:    sample time =   626.75 ms / 9.79 ms per token
main:      eval time = 17534.11 ms / 250.49 ms per token
main:     total time = 23482.58 ms
