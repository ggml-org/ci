...
- status:  SUCCESS ✅
- runtime: 4:42.09
- date:    Tue Oct 24 06:56:00 PM UTC 2023
...
main:     load time =   205.88 ms
main:   sample time =    17.77 ms
main:  predict time =   804.22 ms / 12.57 ms per token
main:    total time =  1050.81 ms
...
main:  predict time =   875.42 ms / 12.51 ms per token
main:    total time =  1055.06 ms
...
main:   sample time =   129.47 ms
main:  predict time =  5861.42 ms
main:    total time =  6234.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd0aa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcf2b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad841bad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd0a9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd0af880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad841c870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcf2b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad841bad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad841d1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad841c870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd0a9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad841dad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad841d1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad841e400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd0aa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad841dad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad841e590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad841e400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd0af880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad841e720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad841e590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   202.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    20.89 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4602.50 ms /     1 runs ( 4602.50 ms per run)
whisper_print_timings:   decode time =   180.26 ms /    27 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5073.62 ms
...
main:     load time =    79.48 ms
main:    total time = 39323.20 ms
embd_img
...
main:      load time =  9301.83 ms
main:    sample time =   515.07 ms / 8.05 ms per token
main:      eval time = 43526.72 ms / 621.81 ms per token
main:     total time = 55715.80 ms
...
main:      load time =  3889.91 ms
main:    sample time =   516.21 ms / 8.07 ms per token
main:      eval time = 17389.10 ms / 248.42 ms per token
main:     total time = 22757.66 ms
