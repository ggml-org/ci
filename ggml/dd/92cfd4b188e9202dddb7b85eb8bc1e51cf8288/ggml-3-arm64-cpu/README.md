...
- status:  SUCCESS ✅
- runtime: 4:47.36
- date:    Sat Oct 28 09:09:53 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.51 sec
      Start  6: test0
...
main:     load time =   229.52 ms
main:   sample time =    17.12 ms
main:  predict time =   800.98 ms / 12.52 ms per token
main:    total time =  1070.33 ms
...
main:  predict time =   870.23 ms / 12.43 ms per token
main:    total time =  1039.13 ms
...
main:     n_decoded =      504
main:     load time =   141.82 ms
main:   sample time =   126.89 ms
main:  predict time =  5878.31 ms
main:    total time =  6229.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa203a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1ebb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf1e3bad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2039fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa203f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf1e3c870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1ebb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf1e3bad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf1e3d1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf1e3c870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2039fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf1e3dad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf1e3d1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf1e3e400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa203a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf1e3dad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf1e3e590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf1e3e400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa203f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf1e3e720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf1e3e590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   202.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.98 ms
whisper_print_timings:   sample time =    20.98 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4607.16 ms /     1 runs ( 4607.16 ms per run)
whisper_print_timings:   decode time =   181.02 ms /    27 runs (    6.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5077.14 ms
...
main:     load time =    76.58 ms
main:    total time = 39350.28 ms
embd_img
...
main:      load time = 12699.88 ms
main:    sample time =   520.32 ms / 8.13 ms per token
main:      eval time = 43503.71 ms / 621.48 ms per token
main:     total time = 59096.64 ms
...
main:      load time =  4357.75 ms
main:    sample time =   511.73 ms / 8.00 ms per token
main:      eval time = 17570.36 ms / 251.01 ms per token
main:     total time = 23403.14 ms
