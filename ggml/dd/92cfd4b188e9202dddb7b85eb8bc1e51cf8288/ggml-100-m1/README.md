...
- status:  SUCCESS ✅
- runtime: 112.97
- date:    Sat Oct 28 11:47:10 EEST 2023
...
15/16 Test #15: test-customop ....................   Passed    0.18 sec
      Start 16: test-xpos
16/16 Test #16: test-xpos ........................   Passed    0.17 sec
...
main:  predict time =   298.87 ms / 4.67 ms per token
main:    total time =   457.99 ms
...
main:  predict time =   305.35 ms / 4.36 ms per token
main:    total time =   405.35 ms
...
main:  predict time =   761.69 ms
main:    total time =   962.49 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x145809160                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x145809f00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x148008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x145809160                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14580a830                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x145809f00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x148186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14580b160                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14580a830                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14580ba90                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1481878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14580b160                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14580bc20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14580ba90                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14818c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x14580bdb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14580bc20                           node_4
...
whisper_print_timings:     load time =   123.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.35 ms
whisper_print_timings:   sample time =    11.59 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   702.96 ms /     1 runs (  702.96 ms per run)
whisper_print_timings:   decode time =    63.88 ms /    27 runs (    2.37 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   922.41 ms
