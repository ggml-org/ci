...
- status:  SUCCESS ✅
- runtime: 3:06.37
- date:    Sat Oct 28 08:58:52 UTC 2023
...
main:     load time =   154.20 ms
main:   sample time =    23.42 ms
main:  predict time =   429.29 ms / 6.71 ms per token
main:    total time =   620.02 ms
...
main:     load time =   102.25 ms
main:   sample time =    23.32 ms
main:  predict time =   440.99 ms / 6.30 ms per token
main:    total time =   569.29 ms
...
main:   sample time =   174.93 ms
main:  predict time =  1452.77 ms
main:    total time =  1764.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f63b5445900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f63b52c6170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560fbbd85ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f63b5444fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f63b544a880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560fbbd86870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f63b52c6170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560fbbd85ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560fbbd871a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560fbbd86870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f63b5444fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560fbbd87ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560fbbd871a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560fbbd88400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f63b5445900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560fbbd87ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560fbbd88590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560fbbd88400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f63b544a880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560fbbd88720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560fbbd88590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.56 ms
whisper_print_timings:   sample time =    15.93 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1185.88 ms /     1 runs ( 1185.88 ms per run)
whisper_print_timings:   decode time =    93.30 ms /    27 runs (    3.46 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1482.91 ms
...
main:     load time =    61.31 ms
main:    total time = 10421.86 ms
embd_img
...
main:      load time = 10691.21 ms
main:    sample time =   468.01 ms / 7.31 ms per token
main:      eval time = 20222.93 ms / 288.90 ms per token
main:     total time = 32052.33 ms
...
main:      load time =  2631.46 ms
main:    sample time =   466.13 ms / 7.28 ms per token
main:      eval time =  8200.54 ms / 117.15 ms per token
main:     total time = 12086.76 ms
