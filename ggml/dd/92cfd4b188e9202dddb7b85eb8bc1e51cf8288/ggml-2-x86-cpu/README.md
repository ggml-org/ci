...
- status:  SUCCESS ✅
- runtime: 3:01.41
- date:    Tue Oct 24 18:54:16 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.59 sec
      Start  2: test-opt
...
main:     load time =   155.48 ms
main:   sample time =    23.55 ms
main:  predict time =   444.56 ms / 6.95 ms per token
main:    total time =   637.01 ms
...
main:  predict time =   453.73 ms / 6.48 ms per token
main:    total time =   587.11 ms
...
main:   sample time =   175.68 ms
main:  predict time =  1469.64 ms
main:    total time =  1789.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff31d939900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff31d7ba170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5587c4ab0ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff31d938fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff31d93e880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5587c4ab1870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff31d7ba170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5587c4ab0ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5587c4ab21a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5587c4ab1870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff31d938fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5587c4ab2ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5587c4ab21a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5587c4ab3400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff31d939900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5587c4ab2ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5587c4ab3590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5587c4ab3400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff31d93e880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5587c4ab3720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5587c4ab3590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.76 ms
whisper_print_timings:   sample time =    16.38 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1146.81 ms /     1 runs ( 1146.81 ms per run)
whisper_print_timings:   decode time =   100.37 ms /    27 runs (    3.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1446.54 ms
...
main:      load time =  5566.71 ms
main:    sample time =   469.48 ms / 7.34 ms per token
main:      eval time = 20737.29 ms / 296.25 ms per token
main:     total time = 27457.43 ms
...
main:      load time =  1183.24 ms
main:    sample time =   498.89 ms / 7.80 ms per token
main:      eval time =  9018.24 ms / 128.83 ms per token
main:     total time = 11130.70 ms
