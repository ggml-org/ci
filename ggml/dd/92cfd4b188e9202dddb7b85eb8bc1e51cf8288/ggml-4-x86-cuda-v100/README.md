...
- status:  SUCCESS ✅
- runtime: 5:35.28
- date:    Sat Oct 28 07:56:04 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.94 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.03 sec
      Start  3: test-quantize-fns
 3/15 Test  #3: test-quantize-fns ................   Passed    0.01 sec
      Start  4: test-quantize-perf
 4/15 Test  #4: test-quantize-perf ...............   Passed    0.01 sec
      Start  5: test-mul-mat0
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.68 sec
      Start  6: test-mul-mat2
 6/15 Test  #6: test-mul-mat2 ....................   Passed    2.83 sec
      Start  7: test0
 7/15 Test  #7: test0 ............................   Passed    0.00 sec
      Start  8: test1
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.16 sec
      Start 10: test3
10/15 Test #10: test3 ............................   Passed    0.51 sec
      Start 11: test-pool
...
main:     load time =   698.46 ms
main:   sample time =    35.55 ms
main:  predict time =   587.22 ms / 9.18 ms per token
main:    total time =  1342.63 ms
...
main:     load time =   157.71 ms
main:   sample time =    35.12 ms
main:  predict time =   584.45 ms / 8.35 ms per token
main:    total time =   782.25 ms
...
main:     n_decoded =      504
main:     load time =   152.46 ms
main:   sample time =   233.56 ms
main:  predict time =  2263.48 ms
main:    total time =  2695.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1e694fa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1e6937b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e67c86dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1e694f9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1e694ff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e67c86e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1e6937b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e67c86dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e67c86f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e67c86e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1e694f9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e67c86fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e67c86f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e67c870400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1e694fa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e67c86fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e67c870590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e67c870400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1e694ff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e67c870720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e67c870590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   717.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.52 ms
whisper_print_timings:   sample time =    20.09 ms /    27 runs (    0.74 ms per run)
whisper_print_timings:   encode time =  1857.93 ms /     1 runs ( 1857.93 ms per run)
whisper_print_timings:   decode time =   137.84 ms /    27 runs (    5.11 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2817.75 ms
...
main:     load time =    98.27 ms
main:    total time = 16778.08 ms
embd_img
...
main:      load time =  8359.32 ms
main:    sample time =   586.66 ms / 9.17 ms per token
main:      eval time = 24625.51 ms / 351.79 ms per token
main:     total time = 34455.88 ms
...
main:      load time =  1857.31 ms
main:    sample time =   584.44 ms / 9.13 ms per token
main:      eval time = 12407.66 ms / 177.25 ms per token
main:     total time = 15502.87 ms
