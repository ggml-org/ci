...
- status:  SUCCESS ✅
- runtime: 1:54.98
- date:    Tue Oct 24 18:53:10 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.62 sec
      Start  9: test3
...
main:  predict time =   627.00 ms / 9.80 ms per token
main:    total time =   770.78 ms
...
main:  predict time =   775.38 ms / 11.08 ms per token
...
main:     n_decoded =      504
main:     load time =   109.01 ms
main:   sample time =   176.21 ms
main:  predict time =  2396.46 ms
main:    total time =  2728.49 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa126e4d900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa126cce170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b69c46ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa126e4cfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa126e52880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b69c46f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa126cce170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b69c46ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b69c4701a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b69c46f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa126e4cfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b69c470ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b69c4701a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b69c471400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa126e4d900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b69c470ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b69c471590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b69c471400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa126e52880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b69c471720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b69c471590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    83.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.51 ms
whisper_print_timings:   sample time =    16.45 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  2037.51 ms /     1 runs ( 2037.51 ms per run)
whisper_print_timings:   decode time =   129.53 ms /    27 runs (    4.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2330.93 ms
