...
- status:  SUCCESS ✅
- runtime: 1:55.44
- date:    Sat Oct 28 08:48:19 UTC 2023
...
main:  predict time =   603.37 ms / 9.43 ms per token
main:    total time =   745.79 ms
...
main:  predict time =   628.42 ms / 8.98 ms per token
main:    total time =   762.20 ms
...
main:   sample time =   176.02 ms
main:  predict time =  2497.72 ms
main:    total time =  2825.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbd521fd900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbd5207e170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563c4659ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbd521fcfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbd52202880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563c4659f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbd5207e170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563c4659ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563c465a01a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563c4659f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbd521fcfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563c465a0ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563c465a01a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563c465a1400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbd521fd900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563c465a0ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563c465a1590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563c465a1400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbd52202880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563c465a1720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563c465a1590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    85.71 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.20 ms
whisper_print_timings:   sample time =    16.49 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1962.75 ms /     1 runs ( 1962.75 ms per run)
whisper_print_timings:   decode time =   133.31 ms /    27 runs (    4.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2263.24 ms
...
main:     load time =    70.87 ms
main:    total time = 19019.49 ms
embd_img
