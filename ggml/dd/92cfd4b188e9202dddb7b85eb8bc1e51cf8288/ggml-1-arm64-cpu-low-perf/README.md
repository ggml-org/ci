...
- status:  SUCCESS ✅
- runtime: 2:29.55
- date:    Tue Oct 24 06:53:57 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.80 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.83 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
...
main:     load time =   143.62 ms
main:   sample time =    17.41 ms
main:  predict time =   813.29 ms / 12.71 ms per token
main:    total time =   996.99 ms
...
main:  predict time =   877.63 ms / 12.54 ms per token
main:    total time =  1042.14 ms
...
main:  predict time =  6023.59 ms
main:    total time =  6381.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff972ca900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9714b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaefdfbad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff972c9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff972cf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaefdfc870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9714b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaefdfbad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaefdfd1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaefdfc870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff972c9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaefdfdad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaefdfd1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaefdfe400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff972ca900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaefdfdad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaefdfe590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaefdfe400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff972cf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaefdfe720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaefdfe590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.77 ms
whisper_print_timings:   sample time =    20.86 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4710.55 ms /     1 runs ( 4710.55 ms per run)
whisper_print_timings:   decode time =   180.10 ms /    27 runs (    6.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5086.97 ms
