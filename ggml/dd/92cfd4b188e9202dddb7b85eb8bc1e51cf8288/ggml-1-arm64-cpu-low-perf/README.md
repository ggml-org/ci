...
- status:  SUCCESS ✅
- runtime: 2:29.92
- date:    Sat Oct 28 08:49:33 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.45 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.21 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
...
main:  predict time =   862.07 ms / 13.47 ms per token
main:    total time =  1051.18 ms
...
main:  predict time =   895.03 ms / 12.79 ms per token
...
main:     n_decoded =      504
main:     load time =   155.45 ms
main:   sample time =   129.91 ms
main:  predict time =  6048.55 ms
main:    total time =  6417.49 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8210a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81f8b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07082ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff82109fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8210f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab07083870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81f8b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07082ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab070841a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab07083870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff82109fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab07084ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab070841a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab07085400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8210a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab07084ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab07085590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab07085400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8210f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab07085720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab07085590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.18 ms
whisper_print_timings:   sample time =    21.06 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4714.92 ms /     1 runs ( 4714.92 ms per run)
whisper_print_timings:   decode time =   180.46 ms /    27 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5102.06 ms
