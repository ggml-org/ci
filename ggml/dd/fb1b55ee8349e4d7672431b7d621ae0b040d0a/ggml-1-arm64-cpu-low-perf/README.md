...
- status:  SUCCESS ✅
- runtime: 2:31.71
- date:    Mon Jul  8 10:08:43 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   32.86 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    0.17 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   20.48 sec
      Start  3: test-quantize-perf
...
main:     load time =   141.73 ms
main:   sample time =    17.58 ms
main:  predict time =   858.67 ms / 13.42 ms per token
main:    total time =  1039.43 ms
...
main:     load time =   142.25 ms
main:   sample time =    17.51 ms
main:  predict time =   929.03 ms / 13.27 ms per token
main:    total time =  1091.53 ms
...
main:     load time =   170.80 ms
main:   sample time =    17.63 ms
main:  predict time =   936.40 ms / 13.38 ms per token
main:    total time =  1128.24 ms
...
main:     n_decoded =      504
main:     load time =   143.88 ms
main:   sample time =   128.53 ms
main:  predict time =  6037.52 ms
main:    total time =  6391.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfbb77591a930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfbb77579b180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc94d7813bcd0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfbb775919ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfbb77591f8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc94d7813ca80                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfbb77579b180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc94d7813bcd0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc94d7813d3c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc94d7813ca80                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfbb775919ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc94d7813dd00                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc94d7813d3c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc94d7813e640                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfbb77591a930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc94d7813dd00                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc94d7813e7e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc94d7813e640                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfbb77591f8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc94d7813e980                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc94d7813e7e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    91.10 ms
main:    total time = 39387.81 ms
embd_img
