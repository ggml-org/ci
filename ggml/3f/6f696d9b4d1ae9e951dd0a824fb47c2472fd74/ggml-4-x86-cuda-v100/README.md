...
- status:  SUCCESS ✅
- runtime: 7:39.15
- date:    Sun Dec 24 14:25:43 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   60.35 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    7.94 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   21.77 sec
...
main:     load time =   559.31 ms
main:   sample time =    34.19 ms
main:  predict time =   577.44 ms / 9.02 ms per token
main:    total time =  1194.64 ms
...
main:     load time =   579.63 ms
main:   sample time =    33.87 ms
main:  predict time =   581.63 ms / 8.31 ms per token
main:    total time =  1199.25 ms
...
main:     n_decoded =      504
main:     load time =   554.12 ms
main:   sample time =   241.74 ms
main:  predict time =  2222.57 ms
main:    total time =  3063.94 ms
...
main: loaded model in   446.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae13cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae13b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561465ec97d0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae13cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae13cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561465eca5a0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae13b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561465ec97d0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561465ecaf00                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561465eca5a0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae13cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561465ecb860                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561465ecaf00                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561465ecc1c0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae13cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561465ecb860                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561465ecc380                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561465ecc1c0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae13cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561465ecc540                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561465ecc380       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   507.90 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.21 ms
whisper_print_timings:   sample time =    67.10 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.37 ms /     1 runs (   34.37 ms per run)
whisper_print_timings:   decode time =    13.46 ms /     2 runs (    6.73 ms per run)
whisper_print_timings:   batchd time =    81.94 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   731.46 ms
...
main:     load time =   554.23 ms
main:    total time =  7945.35 ms
embd_img
...
main:      load time =  8015.76 ms
main:    sample time =   534.65 ms / 8.35 ms per token
main:      eval time = 25583.42 ms / 365.48 ms per token
main:     total time = 35067.70 ms
...
main:      load time =  2033.75 ms
main:    sample time =   532.40 ms / 8.32 ms per token
main:      eval time = 12025.33 ms / 171.79 ms per token
main:     total time = 15229.74 ms
