...
- status:  SUCCESS ✅
- runtime: 5:46.75
- date:    Sun Dec 24 02:27:35 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/3f6f696d9b4d1ae9e951dd0a824fb47c2472fd74
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.34 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.44 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.27 sec
      Start  2: test-opt
 ...
 8/20 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    0.03 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   10.14 sec
...
main:     load time =   282.64 ms
main:   sample time =    16.94 ms
main:  predict time =   809.92 ms / 12.65 ms per token
main:    total time =  1131.66 ms
...
main:     load time =   184.29 ms
main:   sample time =    17.07 ms
main:  predict time =   876.62 ms / 12.52 ms per token
main:    total time =  1080.85 ms
...
main:   sample time =   127.24 ms
main:  predict time =  5880.99 ms
main:    total time =  6253.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6f9a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6e1b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2154b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6f9a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6f9f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2155960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6e1b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2154b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad21562c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2155960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6f9a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2156c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad21562c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2157580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6f9a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2156c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2157740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2157580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6f9f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad2157900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2157740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   182.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.37 ms
whisper_print_timings:   sample time =    65.80 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4659.41 ms /     1 runs ( 4659.41 ms per run)
whisper_print_timings:   decode time =    15.79 ms /     2 runs (    7.89 ms per run)
whisper_print_timings:   batchd time =   708.65 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5650.51 ms
...
main:     load time =    86.24 ms
main:    total time = 39567.09 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.236000 sec.)
...
main:      load time = 16144.55 ms
main:    sample time =   520.75 ms / 8.14 ms per token
main:      eval time = 43547.41 ms / 622.11 ms per token
main:     total time = 62587.97 ms
...
main:      load time =  4379.77 ms
main:    sample time =   514.60 ms / 8.04 ms per token
main:      eval time = 17745.50 ms / 253.51 ms per token
main:     total time = 23632.50 ms
