...
- status:  SUCCESS ✅
- runtime: 3:38.01
- date:    Sun Dec 24 02:07:06 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.85 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.53 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   42.69 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.90 sec
      Start  9: test3
...
main:     load time =   193.19 ms
main:   sample time =    19.46 ms
main:  predict time =   859.68 ms / 13.43 ms per token
main:    total time =  1094.25 ms
...
main:     load time =   196.12 ms
main:   sample time =    17.94 ms
main:  predict time =  1040.22 ms / 14.86 ms per token
main:    total time =  1257.24 ms
...
main:     n_decoded =      504
main:     load time =   162.17 ms
main:   sample time =   133.81 ms
main:  predict time =  6091.87 ms
main:    total time =  6469.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8870a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8858b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab171e8b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8870a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8870f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab171e9960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8858b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab171e8b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab171ea2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab171e9960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8870a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab171eac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab171ea2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab171eb580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8870a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab171eac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab171eb740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab171eb580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8870f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab171eb900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab171eb740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.22 ms
whisper_print_timings:   sample time =    66.96 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4750.95 ms /     1 runs ( 4750.95 ms per run)
whisper_print_timings:   decode time =    16.33 ms /     2 runs (    8.17 ms per run)
whisper_print_timings:   batchd time =   714.44 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5679.60 ms
...
main:     load time =    99.54 ms
main:    total time = 40575.73 ms
embd_img
