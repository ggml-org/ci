...
- status:  SUCCESS ✅
- runtime: 3:13.74
- date:    Sun Dec 24 14:06:31 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.15 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.73 sec
...
main:  predict time =   598.79 ms / 9.36 ms per token
main:    total time =   765.42 ms
...
main:     load time =   128.75 ms
main:   sample time =    23.43 ms
main:  predict time =   624.73 ms / 8.92 ms per token
...
main:  predict time =  2371.77 ms
main:    total time =  2700.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5d1b41f990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5d1b2a01a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555e96d9db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5d1b41f030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5d1b424940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555e96d9e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5d1b2a01a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555e96d9db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555e96d9f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555e96d9e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5d1b41f030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555e96d9fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555e96d9f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555e96da0580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5d1b41f990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555e96d9fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555e96da0740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555e96da0580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5d1b424940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555e96da0900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555e96da0740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.41 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.52 ms
whisper_print_timings:   sample time =    72.31 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1982.43 ms /     1 runs ( 1982.43 ms per run)
whisper_print_timings:   decode time =    12.51 ms /     2 runs (    6.26 ms per run)
whisper_print_timings:   batchd time =   322.50 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2490.07 ms
...
main:     load time =    69.63 ms
main:    total time = 18710.20 ms
embd_img
