...
- status:  SUCCESS ✅
- runtime: 4:33.26
- date:    Sun Dec 24 14:07:46 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.48 sec
...
19/19 Test #19: test-backend-ops .................   Passed   27.50 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.95 sec
...
main:     load time =   289.04 ms
main:   sample time =    23.41 ms
main:  predict time =   436.48 ms / 6.82 ms per token
main:    total time =   761.57 ms
...
main:  predict time =   448.66 ms / 6.41 ms per token
main:    total time =   601.27 ms
...
main:     n_decoded =      504
main:     load time =   102.51 ms
main:   sample time =   177.84 ms
main:  predict time =  1468.98 ms
main:    total time =  1779.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbeba9b9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbeba83a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561b6c6a9b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbeba9b9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbeba9be940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561b6c6aa960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbeba83a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561b6c6a9b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561b6c6ab2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561b6c6aa960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbeba9b9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561b6c6abc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561b6c6ab2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561b6c6ac580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbeba9b9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561b6c6abc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561b6c6ac740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561b6c6ac580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbeba9be940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561b6c6ac900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561b6c6ac740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   166.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.32 ms
whisper_print_timings:   sample time =    54.90 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1148.96 ms /     1 runs ( 1148.96 ms per run)
whisper_print_timings:   decode time =     9.47 ms /     2 runs (    4.73 ms per run)
whisper_print_timings:   batchd time =   205.76 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1603.37 ms
...
main:     load time =    61.35 ms
main:    total time = 10562.33 ms
embd_img
...
main:      load time =  5292.34 ms
main:    sample time =   469.01 ms / 7.33 ms per token
main:      eval time = 20593.36 ms / 294.19 ms per token
main:     total time = 27040.10 ms
...
main:      load time =  2386.51 ms
main:    sample time =   467.90 ms / 7.31 ms per token
main:      eval time =  8122.05 ms / 116.03 ms per token
main:     total time = 11326.21 ms
