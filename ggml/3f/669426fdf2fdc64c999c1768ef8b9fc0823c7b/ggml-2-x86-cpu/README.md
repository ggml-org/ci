...
- status:  SUCCESS ✅
- runtime: 3:20.89
- date:    Tue Dec  5 15:15:38 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   19.84 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.23 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    1.65 sec
...
20/20 Test #20: test-backend-ops .................   Passed    3.14 sec
...
main:     load time =   167.19 ms
main:   sample time =    23.47 ms
main:  predict time =   435.30 ms / 6.80 ms per token
main:    total time =   638.65 ms
...
main:   sample time =    23.47 ms
main:  predict time =   458.92 ms / 6.56 ms per token
main:    total time =   611.73 ms
...
main:  predict time =  1466.47 ms
main:    total time =  1778.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f388f9e9960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f388f86a190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56330fb5db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f388f9e9010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f388f9ee900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56330fb5e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f388f86a190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56330fb5db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56330fb5f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56330fb5e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f388f9e9010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56330fb5fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56330fb5f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56330fb60530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f388f9e9960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56330fb5fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56330fb606e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56330fb60530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f388f9ee900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56330fb60890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56330fb606e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   142.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.94 ms
whisper_print_timings:   sample time =    56.54 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1143.87 ms /     1 runs ( 1143.87 ms per run)
whisper_print_timings:   decode time =     9.80 ms /     2 runs (    4.90 ms per run)
whisper_print_timings:   batchd time =   208.02 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1579.45 ms
...
main:     load time =    64.25 ms
main:    total time = 10429.77 ms
embd_img
...
main:      load time =  5272.81 ms
main:    sample time =   467.49 ms / 7.30 ms per token
main:      eval time = 20332.46 ms / 290.46 ms per token
main:     total time = 26736.48 ms
...
main:      load time =  1181.66 ms
main:    sample time =   465.80 ms / 7.28 ms per token
main:      eval time =  8052.94 ms / 115.04 ms per token
main:     total time = 10074.78 ms
