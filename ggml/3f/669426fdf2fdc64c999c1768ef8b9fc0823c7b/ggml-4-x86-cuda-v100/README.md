...
- status:  SUCCESS ✅
- runtime: 7:01.85
- date:    Tue Dec  5 17:30:39 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/19 Test  #8: test2 ............................   Passed    8.06 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    1.19 sec
      Start 10: test-pool
10/19 Test #10: test-pool ........................   Passed    0.55 sec
      Start 11: test-conv-transpose
11/19 Test #11: test-conv-transpose ..............   Passed    0.56 sec
...
19/19 Test #19: test-backend-ops .................   Passed   49.98 sec
...
20/20 Test #20: test-backend-ops .................   Passed    9.03 sec
...
main:   sample time =    35.01 ms
main:  predict time =   553.43 ms / 8.65 ms per token
main:    total time =  1173.40 ms
...
main:     load time =   466.47 ms
main:   sample time =    33.79 ms
main:  predict time =   598.81 ms / 8.55 ms per token
...
main:     n_decoded =      504
main:     load time =   443.09 ms
main:   sample time =   233.40 ms
main:  predict time =  2198.27 ms
main:    total time =  2925.61 ms
...
main: loaded model in   300.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7effd1cfa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7effd1b7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55649c283660                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7effd1cfa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7effd1cff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55649c284420                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7effd1b7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55649c283660                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55649c284d70                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55649c284420                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7effd1cfa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55649c2856c0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55649c284d70                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55649c286010                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7effd1cfa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55649c2856c0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55649c2861c0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55649c286010                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7effd1cff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55649c286370                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55649c2861c0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   406.31 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.71 ms
whisper_print_timings:   sample time =    68.15 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    33.63 ms /     1 runs (   33.63 ms per run)
whisper_print_timings:   decode time =    13.46 ms /     2 runs (    6.73 ms per run)
whisper_print_timings:   batchd time =    84.22 ms /   125 runs (    0.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   631.81 ms
...
main:     load time =   399.50 ms
main:    total time =  7565.55 ms
embd_img
...
main:      load time =  8364.66 ms
main:    sample time =   519.74 ms / 8.12 ms per token
main:      eval time = 24591.84 ms / 351.31 ms per token
main:     total time = 34423.12 ms
...
main:      load time =  1986.08 ms
main:    sample time =   517.23 ms / 8.08 ms per token
main:      eval time = 12358.72 ms / 176.55 ms per token
main:     total time = 15499.03 ms
