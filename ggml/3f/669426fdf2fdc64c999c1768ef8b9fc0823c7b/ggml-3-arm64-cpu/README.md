...
- status:  SUCCESS ✅
- runtime: 5:11.90
- date:    Tue Dec  5 03:17:42 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   30.80 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.20 sec
      Start  2: test-opt
...
main:     load time =   183.18 ms
main:   sample time =    17.21 ms
main:  predict time =   812.45 ms / 12.69 ms per token
main:    total time =  1034.71 ms
...
main:     load time =   183.17 ms
main:   sample time =    17.00 ms
main:  predict time =   887.24 ms / 12.67 ms per token
main:    total time =  1090.20 ms
...
main:     n_decoded =      504
main:     load time =   147.10 ms
main:   sample time =   128.51 ms
main:  predict time =  5858.14 ms
main:    total time =  6214.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff993ba960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9923b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8b57b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff993ba010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff993bf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8b58940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9923b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8b57b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8b59290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8b58940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff993ba010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8b59be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8b59290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8b5a530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff993ba960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8b59be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf8b5a6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8b5a530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff993bf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf8b5a890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf8b5a6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.86 ms
whisper_print_timings:   sample time =    65.51 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4643.97 ms /     1 runs ( 4643.97 ms per run)
whisper_print_timings:   decode time =    15.85 ms /     2 runs (    7.92 ms per run)
whisper_print_timings:   batchd time =   712.00 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5565.01 ms
...
main:      load time =  5644.87 ms
main:    sample time =   533.17 ms / 8.33 ms per token
main:      eval time = 43509.02 ms / 621.56 ms per token
main:     total time = 52060.86 ms
...
main:      load time =  1512.77 ms
main:    sample time =   528.43 ms / 8.26 ms per token
main:      eval time = 17590.51 ms / 251.29 ms per token
main:     total time = 20602.68 ms
