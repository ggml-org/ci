...
- status:  SUCCESS ✅
- runtime: 6:42.44
- date:    Wed Jan  3 12:26:52 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   26.43 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.40 sec
...
main:     load time =   186.80 ms
main:   sample time =    23.39 ms
main:  predict time =   441.94 ms / 6.91 ms per token
main:    total time =   664.94 ms
...
main:     n_decoded =      504
main:     load time =   107.32 ms
main:   sample time =   178.13 ms
main:  predict time =  1498.36 ms
main:    total time =  1814.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f355befb990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f355bd7c1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560a564e2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f355befb030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f355bf00940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560a564e3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f355bd7c1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560a564e2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560a564e42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560a564e3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f355befb030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560a564e4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560a564e42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560a564e5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f355befb990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560a564e4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560a564e5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560a564e5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f355bf00940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560a564e5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560a564e5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   136.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.15 ms
whisper_print_timings:   sample time =    54.77 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1162.44 ms /     1 runs ( 1162.44 ms per run)
whisper_print_timings:   decode time =     9.32 ms /     2 runs (    4.66 ms per run)
whisper_print_timings:   batchd time =   204.61 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1587.41 ms
...
main:     load time =    63.03 ms
main:    total time = 10638.88 ms
embd_img
...
main:      load time =  9011.15 ms
main:    sample time =   469.94 ms / 7.34 ms per token
main:      eval time = 20560.50 ms / 293.72 ms per token
main:     total time = 30725.96 ms
...
main:      load time =  4370.69 ms
main:    sample time =   465.20 ms / 7.27 ms per token
main:      eval time =  8250.90 ms / 117.87 ms per token
main:     total time = 13481.50 ms
