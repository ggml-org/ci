...
- status:  SUCCESS ✅
- runtime: 8:40.81
- date:    Wed Jan  3 12:28:56 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.07 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   58.67 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.62 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   22.56 sec
...
main:     load time =   565.91 ms
main:   sample time =    34.11 ms
main:  predict time =   571.51 ms / 8.93 ms per token
main:    total time =  1195.94 ms
...
main:     load time =   581.87 ms
main:   sample time =    34.78 ms
main:  predict time =   589.03 ms / 8.41 ms per token
main:    total time =  1209.97 ms
...
main:     n_decoded =      504
main:     load time =   538.35 ms
main:   sample time =   244.62 ms
main:  predict time =  2325.78 ms
main:    total time =  3154.47 ms
...
main: loaded model in   398.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcb055b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcb054371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55add4cd5db0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcb055b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcb055bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55add4cd6b80                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcb054371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55add4cd5db0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55add4cd74e0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55add4cd6b80                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcb055b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55add4cd7e40                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55add4cd74e0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55add4cd87a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcb055b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55add4cd7e40                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55add4cd8960                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55add4cd87a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcb055bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55add4cd8b20                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55add4cd8960       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =   494.49 ms
main:    total time =  8168.63 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.639000 sec.)
...
main:      load time =  8087.29 ms
main:    sample time =   546.92 ms / 8.55 ms per token
main:      eval time = 26054.18 ms / 372.20 ms per token
main:     total time = 35566.35 ms
...
main:      load time =  2191.73 ms
main:    sample time =   543.03 ms / 8.48 ms per token
main:      eval time = 12568.20 ms / 179.55 ms per token
main:     total time = 15949.54 ms
