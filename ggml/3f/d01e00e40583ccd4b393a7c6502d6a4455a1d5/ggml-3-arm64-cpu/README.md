...
- status:  SUCCESS ✅
- runtime: 8:03.14
- date:    Wed Jan  3 12:28:09 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   35.12 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.16 sec
...
main:  predict time =   828.74 ms / 12.95 ms per token
main:    total time =  1050.04 ms
...
main:  predict time =   890.88 ms / 12.73 ms per token
main:    total time =  1085.89 ms
...
main:     n_decoded =      504
main:     load time =   153.47 ms
main:   sample time =   126.78 ms
main:  predict time =  6027.15 ms
main:    total time =  6388.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8090a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8078b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae096db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8090a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8090f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae096e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8078b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae096db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae096f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae096e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8090a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae096fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae096f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0970580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8090a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae096fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0970740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0970580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8090f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae0970900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0970740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:    total time =  5623.08 ms
...
main:      load time =  5699.14 ms
main:    sample time =   521.73 ms / 8.15 ms per token
main:      eval time = 43850.66 ms / 626.44 ms per token
main:     total time = 52445.36 ms
...
main:      load time =  1600.45 ms
main:    sample time =   517.83 ms / 8.09 ms per token
main:      eval time = 17335.23 ms / 247.65 ms per token
main:     total time = 20424.52 ms
