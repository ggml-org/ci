...
- status:  FAILURE ❌ (2)
- runtime: 1:35.05
- date:    Tue Aug 27 06:27:00 UTC 2024
...
main:  predict time =   911.74 ms / 14.25 ms per token
main:    total time =  1101.40 ms
...
main:  predict time =   933.95 ms / 13.34 ms per token
main:    total time =  1107.47 ms
...
main:     load time =   180.34 ms
main:   sample time =    18.93 ms
main:  predict time =   934.90 ms / 13.36 ms per token
main:    total time =  1136.99 ms
...
main:  predict time =  5969.80 ms
main:    total time =  6330.94 ms
