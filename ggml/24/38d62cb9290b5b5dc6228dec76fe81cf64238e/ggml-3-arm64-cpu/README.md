...
- status:  FAILURE ❌ (2)
- runtime: 1:38.13
- date:    Tue Aug 27 06:26:58 UTC 2024
...
main:  predict time =   860.68 ms / 13.45 ms per token
main:    total time =  1059.56 ms
...
main:     load time =   159.08 ms
main:   sample time =    19.05 ms
main:  predict time =   920.63 ms / 13.15 ms per token
main:    total time =  1101.07 ms
...
main:  predict time =  5985.58 ms
main:    total time =  6354.49 ms
