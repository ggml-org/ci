...
- status:  SUCCESS ✅
- runtime: 8:45.15
- date:    Tue Feb 20 19:42:18 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    5.56 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    1.25 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    1.13 sec
      Start  5: test-mul-mat2
 5/20 Test  #5: test-mul-mat2 ....................   Passed    7.87 sec
      Start  6: test0
...
13/20 Test #13: test-rel-pos .....................   Passed    0.58 sec
...
20/20 Test #20: test-backend-ops .................   Passed  142.81 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 193.18 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    4.86 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.55 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    3.41 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.78 sec
...
18/21 Test #18: test-conv2d ......................   Passed    0.60 sec
...
21/21 Test #21: test-backend-ops .................   Passed   36.92 sec
...
main:     load time =   564.85 ms
main:   sample time =    33.95 ms
main:  predict time =   693.14 ms / 10.83 ms per token
main:    total time =  1311.37 ms
...
main:     load time =   558.79 ms
main:   sample time =    34.20 ms
main:  predict time =   671.38 ms / 9.59 ms per token
main:    total time =  1268.04 ms
...
main:     load time =   586.80 ms
main:   sample time =    34.43 ms
main:  predict time =   701.49 ms / 10.02 ms per token
main:    total time =  1327.20 ms
...
main:     n_decoded =      504
main:     load time =   543.03 ms
main:   sample time =   234.61 ms
main:  predict time =  2925.34 ms
main:    total time =  3748.27 ms
...
main: loaded model in   416.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc2271b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc2270371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559a1b363980                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc2271b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc2271bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559a1b364750                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc2270371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559a1b363980                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559a1b3650b0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559a1b364750                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc2271b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559a1b365a10                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559a1b3650b0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559a1b366370                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc2271b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559a1b365a10                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559a1b366530                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559a1b366370                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc2271bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559a1b3666f0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559a1b366530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   503.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.94 ms
whisper_print_timings:   sample time =    66.59 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    28.34 ms /     1 runs (   28.34 ms per run)
whisper_print_timings:   decode time =    20.29 ms /     2 runs (   10.14 ms per run)
whisper_print_timings:   batchd time =    80.98 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   728.35 ms
...
main:     load time =   517.20 ms
main:    total time =  7969.69 ms
embd_img
