...
- status:  SUCCESS ✅
- runtime: 3:11.98
- date:    Tue Feb 20 19:22:21 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/25cc1d5d8329f55c8fc5202259046c73cc298e4e
- author:  bssrdf
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.41 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.27 sec
...
20/20 Test #20: test-backend-ops .................   Passed   78.13 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  92.60 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.30 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.66 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.30 sec
...
21/21 Test #21: test-backend-ops .................   Passed   17.80 sec
...
main:     load time =   104.79 ms
main:   sample time =    23.50 ms
main:  predict time =   482.27 ms / 7.54 ms per token
main:    total time =   623.20 ms
...
main:     load time =   103.01 ms
main:   sample time =    23.49 ms
main:  predict time =   507.27 ms / 7.25 ms per token
main:    total time =   635.74 ms
...
main:     load time =   126.11 ms
main:   sample time =    23.49 ms
main:  predict time =   514.93 ms / 7.36 ms per token
main:    total time =   666.91 ms
...
main:   sample time =   177.62 ms
main:  predict time =  1815.72 ms
main:    total time =  2129.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f183534b990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f18351cc1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561c2b2f3ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f183534b030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1835350940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561c2b2f4ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f18351cc1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561c2b2f3ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561c2b2f5410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561c2b2f4ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f183534b030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561c2b2f5d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561c2b2f5410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561c2b2f66d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f183534b990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561c2b2f5d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561c2b2f6890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561c2b2f66d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1835350940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561c2b2f6a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561c2b2f6890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =    55.12 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1178.57 ms /     1 runs ( 1178.57 ms per run)
whisper_print_timings:   decode time =    12.49 ms /     2 runs (    6.25 ms per run)
whisper_print_timings:   batchd time =   213.55 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1553.76 ms
...
main:     load time =    65.56 ms
main:    total time = 10656.19 ms
embd_img
