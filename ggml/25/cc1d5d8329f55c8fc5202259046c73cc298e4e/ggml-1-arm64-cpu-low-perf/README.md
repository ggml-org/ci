...
- status:  SUCCESS ✅
- runtime: 5:00.03
- date:    Tue Feb 20 07:22:23 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    4.52 sec
...
20/20 Test #20: test-backend-ops .................   Passed   95.60 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 136.68 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.01 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.35 sec
      Start  3: test-quantize-perf
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.72 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   19.56 sec
...
main:  predict time =   939.96 ms / 14.69 ms per token
main:    total time =  1136.41 ms
...
main:     load time =   157.62 ms
main:   sample time =    17.48 ms
main:  predict time =  1072.36 ms / 15.32 ms per token
main:    total time =  1250.39 ms
...
main:     load time =   189.28 ms
main:   sample time =    17.38 ms
main:  predict time =   998.47 ms / 14.26 ms per token
main:    total time =  1208.36 ms
...
main:     n_decoded =      504
main:     load time =   159.58 ms
main:   sample time =   128.21 ms
main:  predict time =  6603.53 ms
main:    total time =  6973.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8486a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff846eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae24f6ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8486a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8486f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae24f7ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff846eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae24f6ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae24f8410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae24f7ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8486a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae24f8d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae24f8410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae24f96d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8486a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae24f8d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae24f9890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae24f96d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8486f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae24f9a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae24f9890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.74 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.41 ms
whisper_print_timings:   sample time =    65.78 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4810.88 ms /     1 runs ( 4810.88 ms per run)
whisper_print_timings:   decode time =    14.96 ms /     2 runs (    7.48 ms per run)
whisper_print_timings:   batchd time =   715.74 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5737.85 ms
