...
- status:  SUCCESS ✅
- runtime: 4:14.83
- date:    Tue Feb 20 07:34:04 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.05 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.46 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.84 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   96.36 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.64 sec
...
main:  predict time =   893.88 ms / 13.97 ms per token
...
main:  predict time =   975.91 ms / 13.94 ms per token
main:    total time =  1147.40 ms
...
main:     load time =   178.44 ms
main:   sample time =    16.95 ms
main:  predict time =   976.71 ms / 13.95 ms per token
main:    total time =  1175.41 ms
...
main:     n_decoded =      504
main:     load time =   151.03 ms
main:   sample time =   127.04 ms
main:  predict time =  6438.61 ms
main:    total time =  6798.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8514a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84fcb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacd499ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8514a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8514f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacd49aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84fcb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacd499ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacd49b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacd49aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8514a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacd49bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacd49b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacd49c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8514a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacd49bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacd49c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacd49c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8514f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacd49ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacd49c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.53 ms
whisper_print_timings:   sample time =    65.90 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4689.95 ms /     1 runs ( 4689.95 ms per run)
...
whisper_print_timings:    total time =  5606.24 ms
