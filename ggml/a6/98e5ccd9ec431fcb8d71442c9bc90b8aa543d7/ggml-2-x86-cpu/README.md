...
- status:  SUCCESS ✅
- runtime: 3:21.55
- date:    Sat Feb 10 08:47:27 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.47 sec
...
20/20 Test #20: test-backend-ops .................   Passed  109.84 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 120.30 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.48 sec
...
main:     load time =   125.85 ms
main:   sample time =    23.48 ms
main:  predict time =   468.90 ms / 7.33 ms per token
main:    total time =   630.93 ms
...
main:     load time =   129.39 ms
main:   sample time =    23.42 ms
main:  predict time =   489.49 ms / 6.99 ms per token
main:    total time =   644.86 ms
...
main:     n_decoded =      504
main:     load time =   108.34 ms
main:   sample time =   178.32 ms
main:  predict time =  1539.73 ms
main:    total time =  1857.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7d8c225990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7d8c0a61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556bacf9cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7d8c225030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7d8c22a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556bacf9d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7d8c0a61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556bacf9cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556bacf9e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556bacf9d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7d8c225030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556bacf9ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556bacf9e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556bacf9f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7d8c225990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556bacf9ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556bacf9f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556bacf9f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7d8c22a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556bacf9f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556bacf9f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1158.38 ms /     1 runs ( 1158.38 ms per run)
whisper_print_timings:   decode time =    10.17 ms /     2 runs (    5.09 ms per run)
whisper_print_timings:   batchd time =   209.34 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1529.42 ms
...
main:     load time =    66.43 ms
main:    total time = 10617.45 ms
embd_img
