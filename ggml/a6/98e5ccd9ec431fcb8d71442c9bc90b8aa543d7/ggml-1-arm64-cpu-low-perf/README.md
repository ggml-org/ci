...
- status:  SUCCESS ✅
- runtime: 5:44.28
- date:    Sat Feb 10 08:49:53 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  145.08 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 182.29 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.25 sec
...
main:  predict time =   859.26 ms / 13.43 ms per token
...
main:   sample time =   128.41 ms
main:  predict time =  6070.54 ms
main:    total time =  6440.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa72aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa712b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6251b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa72aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa72af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6252960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa712b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6251b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf62532c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6252960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa72aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6253c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf62532c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6254580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa72aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6253c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6254740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6254580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa72af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf6254900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6254740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.25 ms
whisper_print_timings:   sample time =    65.94 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4665.50 ms /     1 runs ( 4665.50 ms per run)
whisper_print_timings:   decode time =    15.89 ms /     2 runs (    7.95 ms per run)
whisper_print_timings:   batchd time =   718.39 ms /   125 runs (    5.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5594.28 ms
...
main:     load time =    91.39 ms
main:    total time = 40408.38 ms
embd_img
