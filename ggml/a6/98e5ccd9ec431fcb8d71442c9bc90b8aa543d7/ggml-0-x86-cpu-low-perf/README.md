...
- status:  SUCCESS ✅
- runtime: 4:33.47
- date:    Sat Feb 10 08:48:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.95 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.09 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  110.17 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 147.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.71 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   23.85 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.68 sec
...
main:     load time =   131.46 ms
main:   sample time =    23.51 ms
main:  predict time =   646.70 ms / 10.10 ms per token
main:    total time =   814.59 ms
...
main:     load time =   129.72 ms
main:   sample time =    23.48 ms
main:  predict time =   674.55 ms / 9.64 ms per token
main:    total time =   830.26 ms
...
main:     n_decoded =      504
main:     load time =   106.98 ms
main:   sample time =   178.11 ms
main:  predict time =  2506.64 ms
main:    total time =  2838.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc268f6e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc268def1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55da27a94b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc268f6e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc268f73940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55da27a95960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc268def1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55da27a94b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55da27a962c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55da27a95960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc268f6e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55da27a96c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55da27a962c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55da27a97580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc268f6e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55da27a96c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55da27a97740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55da27a97580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc268f73940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55da27a97900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55da27a97740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.07 ms
whisper_print_timings:   sample time =    71.81 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1984.18 ms /     1 runs ( 1984.18 ms per run)
whisper_print_timings:   decode time =    13.44 ms /     2 runs (    6.72 ms per run)
whisper_print_timings:   batchd time =   325.77 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2497.70 ms
