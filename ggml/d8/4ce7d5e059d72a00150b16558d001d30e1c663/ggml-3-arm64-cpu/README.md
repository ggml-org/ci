...
- status:  SUCCESS ✅
- runtime: 4:48.73
- date:    Mon Nov 13 01:25:53 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.33 sec
...
main:     load time =   250.95 ms
main:   sample time =    17.41 ms
main:  predict time =   809.33 ms / 12.65 ms per token
main:    total time =  1099.82 ms
...
main:     load time =   183.68 ms
main:   sample time =    17.04 ms
main:  predict time =   877.31 ms / 12.53 ms per token
main:    total time =  1080.73 ms
...
main:     n_decoded =      504
main:     load time =   144.74 ms
main:   sample time =   128.35 ms
main:  predict time =  5826.09 ms
main:    total time =  6179.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbb5a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb9db190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadba7bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbb5a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbb5f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadba7c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb9db190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadba7bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadba7d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadba7c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbb5a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadba7dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadba7d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadba7e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbb5a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadba7dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadba7e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadba7e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbb5f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadba7e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadba7e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   184.17 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.03 ms
whisper_print_timings:   sample time =    19.63 ms /    27 runs (    0.73 ms per run)
whisper_print_timings:   encode time =  4632.12 ms /     1 runs ( 4632.12 ms per run)
whisper_print_timings:   decode time =   197.52 ms /    27 runs (    7.32 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5049.69 ms
...
main:      load time = 13223.41 ms
main:    sample time =   530.27 ms / 8.29 ms per token
main:      eval time = 43629.12 ms / 623.27 ms per token
main:     total time = 59756.45 ms
...
main:      load time =  4343.19 ms
main:    sample time =   526.92 ms / 8.23 ms per token
main:      eval time = 17536.59 ms / 250.52 ms per token
main:     total time = 23376.90 ms
