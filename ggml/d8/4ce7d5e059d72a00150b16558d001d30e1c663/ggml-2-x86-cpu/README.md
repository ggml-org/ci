...
- status:  SUCCESS ✅
- runtime: 3:09.21
- date:    Mon Nov 13 13:13:43 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.39 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.28 sec
      Start  2: test-opt
...
main:  predict time =   440.14 ms / 6.88 ms per token
main:    total time =   656.05 ms
...
main:     load time =   136.83 ms
main:   sample time =    23.67 ms
main:  predict time =   443.42 ms / 6.33 ms per token
main:    total time =   605.82 ms
...
main:  predict time =  1452.83 ms
main:    total time =  1764.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa80bbe1960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa80ba62190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f0131edb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa80bbe1010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa80bbe6900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f0131ee940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa80ba62190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f0131edb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f0131ef290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f0131ee940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa80bbe1010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f0131efbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f0131ef290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f0131f0530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa80bbe1960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f0131efbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f0131f06e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f0131f0530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa80bbe6900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f0131f0890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f0131f06e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   154.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.59 ms
whisper_print_timings:   sample time =    16.44 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1143.53 ms /     1 runs ( 1143.53 ms per run)
whisper_print_timings:   decode time =    93.23 ms /    27 runs (    3.45 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1424.77 ms
...
main:      load time = 14516.92 ms
main:    sample time =   465.47 ms / 7.27 ms per token
main:      eval time = 20370.02 ms / 291.00 ms per token
main:     total time = 36015.96 ms
...
main:      load time =  3851.69 ms
main:    sample time =   465.84 ms / 7.28 ms per token
main:      eval time =  8085.53 ms / 115.51 ms per token
main:     total time = 12773.86 ms
