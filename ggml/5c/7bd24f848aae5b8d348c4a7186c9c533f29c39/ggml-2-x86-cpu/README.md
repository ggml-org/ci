...
- status:  SUCCESS ✅
- runtime: 3:45.77
- date:    Wed Dec 13 19:57:12 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/5c7bd24f848aae5b8d348c4a7186c9c533f29c39
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.40 sec
...
19/19 Test #19: test-backend-ops .................   Passed   26.29 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.30 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  15.70 sec
...
main:     load time =   183.39 ms
main:   sample time =    23.52 ms
main:  predict time =   435.40 ms / 6.80 ms per token
main:    total time =   655.39 ms
...
main:  predict time =   454.35 ms / 6.49 ms per token
main:    total time =   606.86 ms
...
main:  predict time =  1470.61 ms
main:    total time =  1784.43 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc5421e49c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc5420651b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e56742fba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc5421e4050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc5421e9980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e567430980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc5420651b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e56742fba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e5674312f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e567430980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc5421e4050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e567431c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e5674312f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e5674325d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc5421e49c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e567431c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e5674327a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e5674325d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc5421e9980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e567432970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e5674327a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   127.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.98 ms
whisper_print_timings:   sample time =    55.65 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1158.06 ms /     1 runs ( 1158.06 ms per run)
whisper_print_timings:   decode time =     9.62 ms /     2 runs (    4.81 ms per run)
whisper_print_timings:   batchd time =   208.91 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1578.95 ms
...
main:     load time =    60.37 ms
main:    total time = 10560.76 ms
embd_img
...
main:      load time =  9198.44 ms
main:    sample time =   464.89 ms / 7.26 ms per token
main:      eval time = 20228.03 ms / 288.97 ms per token
main:     total time = 30582.63 ms
...
main:      load time =  3236.30 ms
main:    sample time =   463.02 ms / 7.23 ms per token
main:      eval time =  7997.45 ms / 114.25 ms per token
main:     total time = 12070.37 ms
