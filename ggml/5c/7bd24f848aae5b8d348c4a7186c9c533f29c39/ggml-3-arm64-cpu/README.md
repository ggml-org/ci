...
- status:  SUCCESS ✅
- runtime: 5:37.45
- date:    Wed Dec 13 07:59:01 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.18 sec
...
20/20 Test #20: test-backend-ops .................   Passed    9.87 sec
...
main:     load time =   177.95 ms
main:   sample time =    16.99 ms
main:  predict time =   807.97 ms / 12.62 ms per token
main:    total time =  1024.69 ms
...
main:     load time =   177.60 ms
main:   sample time =    16.93 ms
main:  predict time =   876.52 ms / 12.52 ms per token
main:    total time =  1073.85 ms
...
main:  predict time =  5882.55 ms
main:    total time =  6236.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf7da9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaf65b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf312aba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf7da050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf7df980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf312b980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaf65b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf312aba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf312c2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf312b980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf7da050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf312cc60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf312c2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf312d5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf7da9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf312cc60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf312d7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf312d5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf7df980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf312d970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf312d7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   180.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =    65.85 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4658.03 ms /     1 runs ( 4658.03 ms per run)
whisper_print_timings:   decode time =    14.96 ms /     2 runs (    7.48 ms per run)
whisper_print_timings:   batchd time =   708.84 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5646.91 ms
...
main:     load time =    79.26 ms
main:    total time = 39489.09 ms
embd_img
...
main:      load time = 11740.46 ms
main:    sample time =   529.84 ms / 8.28 ms per token
main:      eval time = 43605.25 ms / 622.93 ms per token
main:     total time = 58252.65 ms
...
main:      load time =  4095.51 ms
main:    sample time =   526.25 ms / 8.22 ms per token
main:      eval time = 17784.71 ms / 254.07 ms per token
main:     total time = 23392.75 ms
