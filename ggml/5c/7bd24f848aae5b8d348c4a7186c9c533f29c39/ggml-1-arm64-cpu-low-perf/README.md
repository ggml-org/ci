...
- status:  SUCCESS ✅
- runtime: 3:34.64
- date:    Wed Dec 13 07:57:05 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.93 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.14 sec
...
main:     load time =   197.08 ms
main:   sample time =    17.84 ms
main:  predict time =   835.91 ms / 13.06 ms per token
...
main:     load time =   198.54 ms
main:   sample time =    17.80 ms
main:  predict time =   903.84 ms / 12.91 ms per token
main:    total time =  1123.39 ms
...
main:     n_decoded =      504
main:     load time =   162.84 ms
main:   sample time =   134.44 ms
main:  predict time =  6061.52 ms
main:    total time =  6440.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a0ca9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff89f4b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec370ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a0ca050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a0cf980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaec371980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff89f4b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec370ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaec3722f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaec371980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a0ca050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaec372c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaec3722f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaec3735d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a0ca9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaec372c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaec3737a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaec3735d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a0cf980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaec373970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaec3737a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.98 ms
whisper_print_timings:   sample time =    66.98 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4772.36 ms /     1 runs ( 4772.36 ms per run)
whisper_print_timings:   decode time =    15.62 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   714.32 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5701.87 ms
