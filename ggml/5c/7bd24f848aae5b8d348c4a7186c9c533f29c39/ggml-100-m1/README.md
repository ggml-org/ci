...
- status:  SUCCESS ✅
- runtime: 259.75
- date:    Wed Dec 13 21:55:54 EET 2023
...
14/20 Test #14: test-customop ....................   Passed    0.23 sec
      Start 15: test-xpos
15/20 Test #15: test-xpos ........................   Passed    0.22 sec
      Start 16: test-conv1d
16/20 Test #16: test-conv1d ......................   Passed    0.32 sec
      Start 17: test-conv2d
17/20 Test #17: test-conv2d ......................   Passed    0.36 sec
...
20/20 Test #20: test-backend-ops .................   Passed   68.11 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  83.19 sec
...
21/21 Test #21: test-backend-ops .................   Passed   15.87 sec
...
main:  predict time =   299.69 ms / 4.68 ms per token
main:    total time =   462.90 ms
...
main:  predict time =   306.76 ms / 4.38 ms per token
main:    total time =   412.74 ms
...
main:     n_decoded =      504
main:     load time =   117.20 ms
main:   sample time =    65.55 ms
main:  predict time =   764.54 ms
main:    total time =   957.93 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x128018230                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x128019010                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x1100081a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x128018230                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x128019980                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x128019010                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x110187040                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x12801a2f0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x128019980                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x12801ac60                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1101879b0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x12801a2f0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x12801ae30                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x12801ac60                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x11018c970                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x12801b000                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x12801ae30                           node_4
...
whisper_print_timings:     load time =   145.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.35 ms
whisper_print_timings:   sample time =   139.38 ms /   131 runs (    1.06 ms per run)
whisper_print_timings:   encode time =   182.31 ms /     1 runs (  182.31 ms per run)
whisper_print_timings:   decode time =    20.24 ms /     2 runs (   10.12 ms per run)
whisper_print_timings:   batchd time =   209.80 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   707.52 ms
...
main:     load time =    70.18 ms
main:    total time =  5715.34 ms
embd_img
