...
- status:  SUCCESS ✅
- runtime: 2:48.87
- date:    Wed Dec 13 19:56:25 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.70 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.77 sec
...
main:     load time =   134.10 ms
main:   sample time =    23.46 ms
main:  predict time =   603.20 ms / 9.43 ms per token
main:    total time =   773.51 ms
...
main:     load time =   130.40 ms
main:   sample time =    23.51 ms
main:  predict time =   626.10 ms / 8.94 ms per token
...
main:  predict time =  2375.12 ms
main:    total time =  2705.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f944b1f49c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f944b0751b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5601df2f1ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f944b1f4050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f944b1f9980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5601df2f2980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f944b0751b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5601df2f1ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5601df2f32f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5601df2f2980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f944b1f4050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5601df2f3c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5601df2f32f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5601df2f45d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f944b1f49c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5601df2f3c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5601df2f47a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5601df2f45d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f944b1f9980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5601df2f4970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5601df2f47a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.36 ms
whisper_print_timings:   sample time =    72.63 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1978.67 ms /     1 runs ( 1978.67 ms per run)
whisper_print_timings:   decode time =    12.08 ms /     2 runs (    6.04 ms per run)
whisper_print_timings:   batchd time =   320.91 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2486.61 ms
...
main:     load time =    72.42 ms
main:    total time = 18820.05 ms
embd_img
