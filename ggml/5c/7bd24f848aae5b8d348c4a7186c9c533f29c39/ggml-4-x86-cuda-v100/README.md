...
- status:  SUCCESS ✅
- runtime: 7:54.57
- date:    Wed Dec 13 20:01:31 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.79 sec
...
12/19 Test #12: test-rel-pos .....................   Passed    0.58 sec
...
19/19 Test #19: test-backend-ops .................   Passed   59.98 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  92.54 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.90 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed   21.20 sec
...
main:     load time =   606.48 ms
main:   sample time =    38.45 ms
main:  predict time =   592.50 ms / 9.26 ms per token
main:    total time =  1259.41 ms
...
main:     load time =   586.17 ms
main:   sample time =    34.18 ms
main:  predict time =   606.08 ms / 8.66 ms per token
main:    total time =  1230.70 ms
...
main:     n_decoded =      504
main:     load time =   545.21 ms
main:   sample time =   238.02 ms
main:  predict time =  2264.53 ms
main:    total time =  3093.69 ms
...
main: loaded model in   390.66 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8469db69c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8469c371b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f037c6c510                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8469db6050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8469dbb980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f037c6d2f0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8469c371b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f037c6c510                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f037c6dc60                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f037c6d2f0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8469db6050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f037c6e5d0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f037c6dc60                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f037c6ef40                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8469db69c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f037c6e5d0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f037c6f110                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f037c6ef40                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8469dbb980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f037c6f2e0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f037c6f110       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1071.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.40 ms
whisper_print_timings:   sample time =    67.80 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    37.25 ms /     1 runs (   37.25 ms per run)
whisper_print_timings:   decode time =    14.07 ms /     2 runs (    7.04 ms per run)
whisper_print_timings:   batchd time =    82.93 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1300.16 ms
...
main:     load time =   509.94 ms
main:    total time =  7906.28 ms
embd_img
...
main:      load time =  7533.23 ms
main:    sample time =   516.99 ms / 8.08 ms per token
main:      eval time = 25072.54 ms / 358.18 ms per token
main:     total time = 34011.09 ms
...
main:      load time =  2268.24 ms
main:    sample time =   507.51 ms / 7.93 ms per token
main:      eval time = 12213.32 ms / 174.48 ms per token
main:     total time = 15654.89 ms
