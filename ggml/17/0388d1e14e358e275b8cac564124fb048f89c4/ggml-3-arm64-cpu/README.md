...
- status:  SUCCESS ✅
- runtime: 3:32.65
- date:    Mon Aug 21 12:35:02 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/13 Test  #5: test-mul-mat2 ....................   Passed    8.65 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/14 Test  #1: test-grad0 .......................   Passed    3.44 sec
      Start  2: test-opt
 2/14 Test  #2: test-opt .........................   Passed    1.48 sec
...
main:     load time =   245.26 ms
main:   sample time =    17.53 ms
main:  predict time =   805.26 ms / 12.58 ms per token
main:    total time =  1135.93 ms
...
main:  predict time =   873.26 ms / 12.48 ms per token
main:    total time =  1108.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9cdba870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9cc3b140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6b9caa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cdb9f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cdbf7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6b9d810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9cc3b140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6b9caa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6b9e110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6b9d810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cdb9f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6b9ea10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6b9e110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad6b9f310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9cdba870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6b9ea10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6b9f470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad6b9f310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cdbf7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad6b9f5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6b9f470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7106.20 ms
main:    sample time =   624.15 ms / 9.75 ms per token
main:      eval time = 43727.98 ms / 624.69 ms per token
main:     total time = 53834.30 ms
...
main:      load time =  1705.29 ms
main:    sample time =   624.89 ms / 9.76 ms per token
main:      eval time = 17349.58 ms / 247.85 ms per token
main:     total time = 20649.07 ms
