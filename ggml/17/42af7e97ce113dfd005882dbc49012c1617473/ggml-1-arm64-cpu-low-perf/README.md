...
- status:  SUCCESS ✅
- runtime: 5:52.52
- date:    Sat Feb 10 09:51:30 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.48 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed  150.27 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 187.47 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.67 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.79 sec
...
main:     load time =   158.86 ms
main:   sample time =    16.97 ms
main:  predict time =   844.01 ms / 13.19 ms per token
main:    total time =  1041.27 ms
...
main:  predict time =  1051.56 ms / 15.02 ms per token
main:    total time =  1229.33 ms
...
main:     load time =   187.21 ms
main:   sample time =    15.64 ms
main:  predict time =    15.56 ms / 0.22 ms per token
main:    total time =   220.78 ms
...
main:     n_decoded =      504
main:     load time =   157.13 ms
main:   sample time =   128.78 ms
main:  predict time =  6118.52 ms
main:    total time =  6486.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d2ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d16b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07343b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d2ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d2ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab07344960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d16b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07343b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab073452c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab07344960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d2ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab07345c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab073452c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab07346580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d2ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab07345c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab07346740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab07346580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d2ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab07346900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab07346740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4736.28 ms /     1 runs ( 4736.28 ms per run)
whisper_print_timings:   decode time =    15.65 ms /     2 runs (    7.83 ms per run)
whisper_print_timings:   batchd time =   713.22 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5658.79 ms
