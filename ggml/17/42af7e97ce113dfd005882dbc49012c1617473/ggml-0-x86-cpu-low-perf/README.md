...
- status:  SUCCESS ✅
- runtime: 4:35.18
- date:    Sat Feb 10 21:50:06 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.98 sec
...
20/20 Test #20: test-backend-ops .................   Passed  109.74 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 147.57 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.61 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.10 sec
      Start  3: test-quantize-perf
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.33 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.50 sec
...
main:  predict time =   684.58 ms / 10.70 ms per token
main:    total time =   827.76 ms
...
main:     load time =   109.54 ms
main:   sample time =    23.81 ms
main:  predict time =   703.26 ms / 10.05 ms per token
main:    total time =   838.77 ms
...
main:     load time =   132.05 ms
main:   sample time =    21.62 ms
main:  predict time =    11.90 ms / 0.17 ms per token
main:    total time =   168.10 ms
...
main:  predict time =  2532.70 ms
main:    total time =  2865.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3af7555990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3af73d61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557b8e843b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3af7555030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3af755a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557b8e844960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3af73d61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557b8e843b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557b8e8452c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557b8e844960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3af7555030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557b8e845c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557b8e8452c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557b8e846580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3af7555990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557b8e845c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557b8e846740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557b8e846580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3af755a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557b8e846900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557b8e846740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.77 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.47 ms
whisper_print_timings:   sample time =    73.39 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2010.24 ms /     1 runs ( 2010.24 ms per run)
whisper_print_timings:   decode time =    14.13 ms /     2 runs (    7.06 ms per run)
whisper_print_timings:   batchd time =   339.15 ms /   125 runs (    2.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2538.79 ms
...
main:     load time =    67.80 ms
main:    total time = 18946.34 ms
embd_img
