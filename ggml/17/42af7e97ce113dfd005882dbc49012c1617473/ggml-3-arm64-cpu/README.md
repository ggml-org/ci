...
- status:  SUCCESS ✅
- runtime: 4:51.25
- date:    Sat Feb 10 09:50:18 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.95 sec
...
20/20 Test #20: test-backend-ops .................   Passed  146.87 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 160.05 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    0.07 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   22.93 sec
...
main:     load time =   144.25 ms
main:   sample time =    17.11 ms
main:  predict time =   829.45 ms / 12.96 ms per token
main:    total time =  1012.36 ms
...
main:  predict time =   902.71 ms / 12.90 ms per token
main:    total time =  1067.35 ms
...
main:     load time =   177.21 ms
main:   sample time =    15.51 ms
main:  predict time =    14.91 ms / 0.21 ms per token
main:    total time =   210.12 ms
...
main:     n_decoded =      504
main:     load time =   148.16 ms
main:   sample time =   128.27 ms
main:  predict time =  5943.21 ms
main:    total time =  6301.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a36a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9a1eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0b72b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a36a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a36f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad0b73960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9a1eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0b72b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad0b742c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad0b73960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a36a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad0b74c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad0b742c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad0b75580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a36a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad0b74c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad0b75740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad0b75580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a36f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad0b75900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad0b75740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.57 ms
whisper_print_timings:   sample time =    65.44 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4639.91 ms /     1 runs ( 4639.91 ms per run)
whisper_print_timings:   decode time =    15.45 ms /     2 runs (    7.73 ms per run)
whisper_print_timings:   batchd time =   711.62 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5555.67 ms
...
main:     load time =    87.99 ms
main:    total time = 39588.98 ms
embd_img
