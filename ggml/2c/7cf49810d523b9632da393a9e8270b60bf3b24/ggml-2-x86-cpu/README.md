...
- status:  FAILURE ❌ (1)
- runtime: 4:15.78
- date:    Fri Feb  9 09:47:01 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    3.01 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  126.19 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 142.21 sec
...
main:     load time =   190.30 ms
main:   sample time =    23.41 ms
main:  predict time =   473.01 ms / 7.39 ms per token
main:    total time =   699.73 ms
...
main:     load time =   134.09 ms
main:   sample time =    23.43 ms
main:  predict time =   479.27 ms / 6.85 ms per token
main:    total time =   639.25 ms
...
main:  predict time =  1542.26 ms
main:    total time =  1859.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0d05764990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0d055e51a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560965020b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0d05764030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0d05769940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560965021960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0d055e51a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560965020b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5609650222c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560965021960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0d05764030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560965022c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5609650222c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560965023580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0d05764990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560965022c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560965023740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560965023580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0d05769940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560965023900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560965023740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   127.16 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    54.57 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1151.75 ms /     1 runs ( 1151.75 ms per run)
whisper_print_timings:   decode time =    10.30 ms /     2 runs (    5.15 ms per run)
whisper_print_timings:   batchd time =   211.21 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1574.04 ms
