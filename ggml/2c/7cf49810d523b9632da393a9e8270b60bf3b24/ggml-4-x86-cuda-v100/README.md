...
- status:  FAILURE ❌ (1)
- runtime: 9:42.27
- date:    Fri Feb  9 09:52:20 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.43 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.77 sec
 ...
 8/20 Test  #8: test2 ............................   Passed   20.85 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    2.06 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  273.49 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 320.48 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.66 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.51 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    0.67 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.81 sec
      Start  5: test-mul-mat0
 5/21 Test  #5: test-mul-mat0 ....................   Passed    1.08 sec
      Start  6: test-mul-mat2
 6/21 Test  #6: test-mul-mat2 ....................   Passed    3.29 sec
      Start  7: test0
 7/21 Test  #7: test0 ............................   Passed    0.58 sec
      Start  8: test1
...
21/21 Test #21: test-backend-ops .................   Passed   50.76 sec
...
main:     load time =  1099.26 ms
main:   sample time =    34.56 ms
main:  predict time =   627.61 ms / 9.81 ms per token
main:    total time =  1781.40 ms
...
main:     load time =   599.84 ms
main:   sample time =    33.97 ms
main:  predict time =   622.27 ms / 8.89 ms per token
main:    total time =  1260.61 ms
...
main:     n_decoded =      504
main:     load time =   557.95 ms
main:   sample time =   233.90 ms
main:  predict time =  2313.24 ms
main:    total time =  3166.85 ms
...
main: loaded model in   400.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff5beef8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff5bed791a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561159619070                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff5beef8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff5beefd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561159619e40                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff5bed791a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561159619070                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56115961a7a0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561159619e40                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff5beef8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56115961b100                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56115961a7a0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56115961ba60                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff5beef8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56115961b100                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56115961bc20                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56115961ba60                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff5beefd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56115961bde0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56115961bc20       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1094.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.50 ms
whisper_print_timings:   sample time =    68.97 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    23.65 ms /     1 runs (   23.65 ms per run)
whisper_print_timings:   decode time =    21.85 ms /     2 runs (   10.93 ms per run)
whisper_print_timings:   batchd time =    81.53 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1316.29 ms
...
main:     load time =   523.67 ms
main:    total time =  8189.55 ms
embd_img
