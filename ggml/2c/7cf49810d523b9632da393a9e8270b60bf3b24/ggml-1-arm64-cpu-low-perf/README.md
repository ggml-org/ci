...
- status:  SUCCESS ✅
- runtime: 5:53.39
- date:    Fri Feb  9 09:48:38 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.73 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.59 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  138.79 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 177.86 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.62 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   26.24 sec
...
main:  predict time =   862.78 ms / 13.48 ms per token
main:    total time =  1088.28 ms
...
main:     load time =   186.69 ms
main:   sample time =    16.88 ms
main:  predict time =   926.81 ms / 13.24 ms per token
main:    total time =  1133.48 ms
...
main:     n_decoded =      504
main:     load time =   157.54 ms
main:   sample time =   126.91 ms
main:  predict time =  6110.79 ms
main:    total time =  6476.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb50aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb4f2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab25861b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb50aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb50af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab25862960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb4f2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab25861b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab258632c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab25862960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb50aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab25863c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab258632c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab25864580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb50aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab25863c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab25864740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab25864580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb50af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab25864900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab25864740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.36 ms
whisper_print_timings:   sample time =    65.53 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4656.98 ms /     1 runs ( 4656.98 ms per run)
whisper_print_timings:   decode time =    16.88 ms /     2 runs (    8.44 ms per run)
whisper_print_timings:   batchd time =   843.55 ms /   125 runs (    6.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5716.42 ms
...
main:     load time =    94.19 ms
main:    total time = 40548.54 ms
embd_img
