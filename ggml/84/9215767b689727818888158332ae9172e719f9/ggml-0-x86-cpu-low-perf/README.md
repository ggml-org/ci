...
- status:  SUCCESS ✅
- runtime: 4:31.81
- date:    Mon Feb 12 17:11:48 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  105.01 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.61 sec
...
main:     load time =   106.93 ms
main:   sample time =    23.83 ms
main:  predict time =   734.56 ms / 11.48 ms per token
main:    total time =   877.89 ms
...
main:  predict time =   765.84 ms / 10.94 ms per token
main:    total time =   897.57 ms
...
main:  predict time =   779.74 ms / 11.14 ms per token
main:    total time =   933.49 ms
...
main:  predict time =  3098.55 ms
main:    total time =  3429.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1b7a6be990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1b7a53f1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5633b96afb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1b7a6be030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1b7a6c3940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5633b96b0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1b7a53f1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5633b96afb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5633b96b12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5633b96b0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1b7a6be030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5633b96b1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5633b96b12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5633b96b2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1b7a6be990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5633b96b1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5633b96b2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5633b96b2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1b7a6c3940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5633b96b2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5633b96b2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.61 ms
whisper_print_timings:   sample time =    72.61 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2034.97 ms /     1 runs ( 2034.97 ms per run)
whisper_print_timings:   decode time =    16.12 ms /     2 runs (    8.06 ms per run)
whisper_print_timings:   batchd time =   328.11 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2553.33 ms
...
main:     load time =    66.77 ms
main:    total time = 19176.52 ms
embd_img
