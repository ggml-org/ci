...
- status:  SUCCESS ✅
- runtime: 5:53.56
- date:    Mon Feb 12 05:13:15 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.37 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.50 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  151.30 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 188.26 sec
...
main:  predict time =   907.80 ms / 14.18 ms per token
main:    total time =  1104.82 ms
...
main:  predict time =  1026.71 ms / 14.67 ms per token
main:    total time =  1205.14 ms
...
main:     load time =   191.84 ms
main:   sample time =    17.14 ms
main:  predict time =  1039.18 ms / 14.85 ms per token
main:    total time =  1251.37 ms
...
main:     n_decoded =      504
main:     load time =   158.11 ms
main:   sample time =   127.24 ms
main:  predict time =  6611.23 ms
main:    total time =  6978.73 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9930b90                            input
...
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae9931960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb96b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9930b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae99322c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae9931960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbaea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae9932c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae99322c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae9933580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbaea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae9932c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae9933740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae9933580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbaef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae9933900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae9933740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    65.78 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4819.28 ms /     1 runs ( 4819.28 ms per run)
whisper_print_timings:   decode time =    14.73 ms /     2 runs (    7.37 ms per run)
whisper_print_timings:   batchd time =   713.85 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5742.86 ms
...
main:     load time =    93.65 ms
main:    total time = 40663.64 ms
embd_img
