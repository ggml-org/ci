...
- status:  SUCCESS ✅
- runtime: 9:32.46
- date:    Mon Feb 12 17:16:52 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/849215767b689727818888158332ae9172e719f9
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.82 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.79 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.71 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  203.02 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 248.13 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.64 sec
      Start  2: test-opt
 ...
 6/21 Test  #6: test-mul-mat2 ....................   Passed    3.26 sec
      Start  7: test0
 7/21 Test  #7: test0 ............................   Passed    0.55 sec
      Start  8: test1
 8/21 Test  #8: test1 ............................   Passed    0.56 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.67 sec
      Start 10: test3
...
20/21 Test #20: test-backend-buffer ..............   Passed    0.57 sec
      Start 21: test-backend-ops
21/21 Test #21: test-backend-ops .................   Passed   45.79 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  89.09 sec
...
main:     load time =   569.90 ms
main:   sample time =    35.86 ms
main:  predict time =   621.21 ms / 9.71 ms per token
main:    total time =  1246.25 ms
...
main:     load time =   524.67 ms
main:   sample time =    37.15 ms
main:  predict time =   695.78 ms / 9.94 ms per token
main:    total time =  1261.29 ms
...
main:     load time =   570.92 ms
main:   sample time =    33.81 ms
main:  predict time =   674.57 ms / 9.64 ms per token
main:    total time =  1288.76 ms
...
main:     n_decoded =      504
main:     load time =   538.91 ms
main:   sample time =   246.29 ms
main:  predict time =  2883.74 ms
main:    total time =  3714.26 ms
...
main: loaded model in   395.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fed311b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fed310371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55788aa1e580                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fed311b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fed311bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55788aa1f350                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fed310371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55788aa1e580                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55788aa1fcb0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55788aa1f350                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fed311b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55788aa20610                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55788aa1fcb0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55788aa20f70                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fed311b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55788aa20610                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55788aa21130                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55788aa20f70                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fed311bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55788aa212f0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55788aa21130       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   504.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.36 ms
whisper_print_timings:   sample time =    69.31 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    28.52 ms /     1 runs (   28.52 ms per run)
whisper_print_timings:   decode time =    20.52 ms /     2 runs (   10.26 ms per run)
whisper_print_timings:   batchd time =    81.75 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   733.30 ms
...
main:     load time =   507.75 ms
main:    total time =  7943.88 ms
embd_img
