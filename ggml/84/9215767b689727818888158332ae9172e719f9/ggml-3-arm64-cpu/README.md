...
- status:  SUCCESS ✅
- runtime: 4:59.30
- date:    Mon Feb 12 05:12:19 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  145.02 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 158.45 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.93 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   23.52 sec
...
main:  predict time =   922.39 ms / 14.41 ms per token
main:    total time =  1111.05 ms
...
main:     load time =   149.90 ms
main:   sample time =    17.15 ms
main:  predict time =   967.41 ms / 13.82 ms per token
main:    total time =  1137.27 ms
...
main:  predict time =   993.41 ms / 14.19 ms per token
main:    total time =  1191.89 ms
...
main:  predict time =  6407.71 ms
main:    total time =  6765.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb3e1a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb3c9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab174b1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb3e1a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb3e1f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab174b2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb3c9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab174b1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab174b32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab174b2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb3e1a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab174b3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab174b32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab174b4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb3e1a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab174b3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab174b4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab174b4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb3e1f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab174b4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab174b4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.54 ms
whisper_print_timings:   sample time =    65.76 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4699.79 ms /     1 runs ( 4699.79 ms per run)
whisper_print_timings:   decode time =    14.55 ms /     2 runs (    7.28 ms per run)
whisper_print_timings:   batchd time =   710.21 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5614.63 ms
