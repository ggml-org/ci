...
- status:  SUCCESS ✅
- runtime: 2:44.39
- date:    Fri Sep 15 11:49:14 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.07 sec
      Start  2: test-opt
...
main:     load time =   188.84 ms
main:   sample time =    23.71 ms
main:  predict time =   440.55 ms / 6.88 ms per token
main:    total time =   666.37 ms
...
main:     load time =   133.74 ms
main:   sample time =    23.74 ms
main:  predict time =   444.43 ms / 6.35 ms per token
main:    total time =   604.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2be8ed48d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2be8d55160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c2eac78ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2be8ed3fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2be8ed9840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c2eac79850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2be8d55160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c2eac78ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c2eac7a170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c2eac79850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2be8ed3fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c2eac7aa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c2eac7a170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c2eac7b3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2be8ed48d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c2eac7aa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c2eac7b530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c2eac7b3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2be8ed9840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c2eac7b6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c2eac7b530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11513.88 ms
main:    sample time =   470.20 ms / 7.35 ms per token
main:      eval time = 20047.10 ms / 286.39 ms per token
main:     total time = 32760.79 ms
...
main:      load time =  4367.29 ms
main:    sample time =   469.61 ms / 7.34 ms per token
main:      eval time =  7917.00 ms / 113.10 ms per token
main:     total time = 13129.39 ms
