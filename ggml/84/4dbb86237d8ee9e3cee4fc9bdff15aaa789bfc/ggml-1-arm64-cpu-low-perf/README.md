...
- status:  SUCCESS ✅
- runtime: 2:36.48
- date:    Mon Nov 13 02:57:13 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.48 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.70 sec
      Start  6: test0
 6/17 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.03 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.68 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.69 sec
      Start  9: test3
...
main:     load time =   196.16 ms
main:   sample time =    18.59 ms
main:  predict time =   834.51 ms / 13.04 ms per token
main:    total time =  1071.39 ms
...
main:     load time =   188.45 ms
main:   sample time =    17.89 ms
main:  predict time =   949.56 ms / 13.57 ms per token
main:    total time =  1158.64 ms
...
main:     n_decoded =      504
main:     load time =   168.73 ms
main:   sample time =   134.85 ms
main:  predict time =  6004.02 ms
main:    total time =  6388.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d1fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d07b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf61c1b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d1fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d1ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf61c2940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d07b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf61c1b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf61c3290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf61c2940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d1fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf61c3be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf61c3290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf61c4530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d1fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf61c3be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf61c46e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf61c4530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d1ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf61c4890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf61c46e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4766.40 ms /     1 runs ( 4766.40 ms per run)
whisper_print_timings:   decode time =   202.78 ms /    27 runs (    7.51 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5119.13 ms
...
main:     load time =    91.36 ms
main:    total time = 40116.02 ms
embd_img
