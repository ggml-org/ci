...
- status:  SUCCESS ✅
- runtime: 4:34.55
- date:    Mon Nov 13 02:59:14 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.32 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.28 sec
      Start  2: test-opt
...
main:  predict time =   808.73 ms / 12.64 ms per token
main:    total time =  1026.12 ms
...
main:     load time =   175.30 ms
main:   sample time =    17.01 ms
main:  predict time =   874.69 ms / 12.50 ms per token
main:    total time =  1069.82 ms
...
main:   sample time =   126.88 ms
main:  predict time =  5823.08 ms
main:    total time =  6173.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff91fda960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff91e5b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeac56b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff91fda010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff91fdf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaeac57940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff91e5b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeac56b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaeac58290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaeac57940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff91fda010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaeac58be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaeac58290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaeac59530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff91fda960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaeac58be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaeac596e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaeac59530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff91fdf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaeac59890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaeac596e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   194.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    19.66 ms /    27 runs (    0.73 ms per run)
whisper_print_timings:   encode time =  4638.50 ms /     1 runs ( 4638.50 ms per run)
whisper_print_timings:   decode time =   198.38 ms /    27 runs (    7.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5068.13 ms
...
main:     load time =    84.00 ms
main:    total time = 39330.63 ms
embd_img
...
main:      load time =  5745.47 ms
main:    sample time =   534.69 ms / 8.35 ms per token
main:      eval time = 43529.66 ms / 621.85 ms per token
main:     total time = 52181.40 ms
...
main:      load time =  1516.10 ms
main:    sample time =   531.59 ms / 8.31 ms per token
main:      eval time = 17476.53 ms / 249.66 ms per token
main:     total time = 20495.19 ms
