...
- status:  SUCCESS ✅
- runtime: 2:56.57
- date:    Mon Nov 13 14:57:41 UTC 2023
...
main:  predict time =   435.58 ms / 6.81 ms per token
main:    total time =   652.43 ms
...
main:     load time =   122.20 ms
main:   sample time =    23.66 ms
main:  predict time =   447.36 ms / 6.39 ms per token
main:    total time =   595.13 ms
...
main:     n_decoded =      504
main:     load time =   101.81 ms
main:   sample time =   177.65 ms
main:  predict time =  1445.87 ms
main:    total time =  1757.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc45379b960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc45361c190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5654aa506b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc45379b010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc4537a0900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5654aa507940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc45361c190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5654aa506b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5654aa508290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5654aa507940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc45379b010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5654aa508be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5654aa508290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5654aa509530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc45379b960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5654aa508be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5654aa5096e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5654aa509530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc4537a0900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5654aa509890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5654aa5096e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   136.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.64 ms
whisper_print_timings:   sample time =    16.33 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1182.15 ms /     1 runs ( 1182.15 ms per run)
whisper_print_timings:   decode time =    94.84 ms /    27 runs (    3.51 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1447.97 ms
...
main:     load time =    67.33 ms
main:    total time = 10539.26 ms
embd_img
...
main:      load time =  5539.89 ms
main:    sample time =   468.77 ms / 7.32 ms per token
main:      eval time = 20559.19 ms / 293.70 ms per token
main:     total time = 27259.40 ms
...
main:      load time =  1193.87 ms
main:    sample time =   465.17 ms / 7.27 ms per token
main:      eval time =  8167.97 ms / 116.69 ms per token
main:     total time = 10201.69 ms
