...
- status:  SUCCESS ✅
- runtime: 4:49.24
- date:    Fri Dec 22 03:58:40 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.66 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.05 sec
...
main:     load time =   197.80 ms
main:   sample time =    17.92 ms
main:  predict time =   863.92 ms / 13.50 ms per token
main:    total time =  1101.65 ms
...
main:     load time =   192.74 ms
main:   sample time =    17.47 ms
main:  predict time =   911.03 ms / 13.01 ms per token
...
main:   sample time =   131.25 ms
main:  predict time =  6086.29 ms
main:    total time =  6467.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9908a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98f0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0f70bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9908a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9908f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0f70c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98f0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0f70bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0f70d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0f70c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9908a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0f70dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0f70d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0f70e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9908a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0f70dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0f70e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0f70e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9908f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0f70e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0f70e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.15 ms
whisper_print_timings:   sample time =    67.10 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4819.22 ms /     1 runs ( 4819.22 ms per run)
whisper_print_timings:   decode time =    16.12 ms /     2 runs (    8.06 ms per run)
whisper_print_timings:   batchd time =   715.06 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5748.10 ms
