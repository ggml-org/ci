...
- status:  SUCCESS ✅
- runtime: 2:49.05
- date:    Fri Dec 22 16:01:32 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.27 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   34.79 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.23 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.76 sec
      Start  9: test3
...
main:  predict time =   608.30 ms / 9.50 ms per token
main:    total time =   775.61 ms
...
main:  predict time =   631.61 ms / 9.02 ms per token
main:    total time =   784.05 ms
...
main:  predict time =  2381.35 ms
main:    total time =  2708.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc0dffcf990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc0dfe501a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55eab1a56b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc0dffcf030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc0dffd4940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55eab1a57960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc0dfe501a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55eab1a56b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55eab1a582c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55eab1a57960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc0dffcf030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55eab1a58c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55eab1a582c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55eab1a59580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc0dffcf990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55eab1a58c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55eab1a59740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55eab1a59580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc0dffd4940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55eab1a59900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55eab1a59740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    23.45 ms
whisper_print_timings:   sample time =    71.56 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1990.37 ms /     1 runs ( 1990.37 ms per run)
whisper_print_timings:   decode time =    12.52 ms /     2 runs (    6.26 ms per run)
whisper_print_timings:   batchd time =   321.84 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2501.83 ms
...
main:     load time =    72.26 ms
main:    total time = 18884.69 ms
embd_img
