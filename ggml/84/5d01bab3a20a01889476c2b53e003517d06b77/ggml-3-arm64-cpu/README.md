...
- status:  SUCCESS ✅
- runtime: 5:44.40
- date:    Fri Dec 22 04:11:11 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/845d01bab3a20a01889476c2b53e003517d06b77
...
19/19 Test #19: test-backend-ops .................   Passed   34.24 sec
...
20/20 Test #20: test-backend-ops .................   Passed   10.19 sec
...
main:     load time =   248.72 ms
main:   sample time =    16.83 ms
main:  predict time =   809.48 ms / 12.65 ms per token
main:    total time =  1096.81 ms
...
main:  predict time =   880.00 ms / 12.57 ms per token
main:    total time =  1079.77 ms
...
main:     n_decoded =      504
main:     load time =   135.92 ms
main:   sample time =   127.60 ms
main:  predict time =  5866.94 ms
main:    total time =  6211.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa70fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6f7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad33d6b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa70fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa70ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad33d7960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6f7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad33d6b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad33d82c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad33d7960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa70fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad33d8c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad33d82c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad33d9580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa70fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad33d8c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad33d9740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad33d9580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa70ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad33d9900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad33d9740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   172.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.70 ms
whisper_print_timings:   sample time =    65.49 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4655.22 ms /     1 runs ( 4655.22 ms per run)
whisper_print_timings:   decode time =    15.73 ms /     2 runs (    7.87 ms per run)
whisper_print_timings:   batchd time =   708.41 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5634.88 ms
...
main:     load time =    79.16 ms
main:    total time = 39542.21 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.227000 sec.)
...
main:      load time = 11606.83 ms
main:    sample time =   520.51 ms / 8.13 ms per token
main:      eval time = 43556.62 ms / 622.24 ms per token
main:     total time = 58060.19 ms
...
main:      load time =  4347.87 ms
main:    sample time =   516.53 ms / 8.07 ms per token
main:      eval time = 17629.02 ms / 251.84 ms per token
main:     total time = 23486.86 ms
