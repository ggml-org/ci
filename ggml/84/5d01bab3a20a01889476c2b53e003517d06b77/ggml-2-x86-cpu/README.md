...
- status:  SUCCESS ✅
- runtime: 4:43.38
- date:    Fri Dec 22 16:00:38 UTC 2023
...
20/20 Test #20: test-backend-ops .................   Passed    8.47 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  16.86 sec
...
main:     load time =   185.80 ms
main:   sample time =    23.48 ms
main:  predict time =   436.40 ms / 6.82 ms per token
main:    total time =   658.35 ms
...
main:     load time =   131.94 ms
main:   sample time =    23.58 ms
main:  predict time =   451.88 ms / 6.46 ms per token
main:    total time =   609.50 ms
...
main:     n_decoded =      504
main:     load time =   110.55 ms
main:   sample time =   177.85 ms
main:  predict time =  1480.72 ms
main:    total time =  1800.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa7e9609990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa7e948a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563bc33c0b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa7e9609030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa7e960e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563bc33c1960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa7e948a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563bc33c0b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563bc33c22c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563bc33c1960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa7e9609030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563bc33c2c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563bc33c22c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563bc33c3580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa7e9609990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563bc33c2c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563bc33c3740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563bc33c3580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa7e960e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563bc33c3900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563bc33c3740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    54.43 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1160.50 ms /     1 runs ( 1160.50 ms per run)
whisper_print_timings:   decode time =     9.37 ms /     2 runs (    4.68 ms per run)
whisper_print_timings:   batchd time =   205.15 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1564.98 ms
...
main:     load time =    61.83 ms
main:    total time = 10562.49 ms
embd_img
...
main:      load time = 10906.49 ms
main:    sample time =   466.10 ms / 7.28 ms per token
main:      eval time = 20162.59 ms / 288.04 ms per token
main:     total time = 32221.43 ms
...
main:      load time =  4359.14 ms
main:    sample time =   463.74 ms / 7.25 ms per token
main:      eval time =  8098.01 ms / 115.69 ms per token
main:     total time = 13294.63 ms
