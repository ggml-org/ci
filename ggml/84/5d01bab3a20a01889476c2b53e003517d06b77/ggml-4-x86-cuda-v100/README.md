...
- status:  SUCCESS ✅
- runtime: 8:43.15
- date:    Fri Dec 22 16:12:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.48 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.00 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   61.62 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  93.75 sec
...
20/20 Test #20: test-backend-ops .................   Passed   21.27 sec
...
main:     load time =   567.22 ms
main:   sample time =    33.86 ms
main:  predict time =   545.00 ms / 8.52 ms per token
main:    total time =  1170.43 ms
...
main:     load time =   554.65 ms
main:   sample time =    34.03 ms
main:  predict time =   570.11 ms / 8.14 ms per token
main:    total time =  1162.84 ms
...
main:     n_decoded =      504
main:     load time =   533.43 ms
main:   sample time =   232.82 ms
main:  predict time =  2203.61 ms
main:    total time =  3014.03 ms
...
main: loaded model in   398.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7991efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7991d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b4d72f4380                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7991efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7991eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b4d72f5150                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7991d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b4d72f4380                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b4d72f5ab0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b4d72f5150                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7991efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b4d72f6410                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b4d72f5ab0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b4d72f6d70                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7991efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b4d72f6410                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b4d72f6f30                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b4d72f6d70                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7991eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b4d72f70f0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b4d72f6f30       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1054.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.56 ms
whisper_print_timings:   sample time =    66.61 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.02 ms /     1 runs (   34.02 ms per run)
whisper_print_timings:   decode time =    13.03 ms /     2 runs (    6.52 ms per run)
whisper_print_timings:   batchd time =    82.01 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1275.92 ms
...
main:     load time =   517.88 ms
main:    total time =  7782.45 ms
embd_img
...
main:      load time =  8629.69 ms
main:    sample time =   553.53 ms / 8.65 ms per token
main:      eval time = 25288.31 ms / 361.26 ms per token
main:     total time = 35368.18 ms
...
main:      load time =  2047.50 ms
main:    sample time =   539.72 ms / 8.43 ms per token
main:      eval time = 12008.68 ms / 171.55 ms per token
main:     total time = 15250.65 ms
