...
- status:  SUCCESS ✅
- runtime: 6:15.13
- date:    Wed Mar 13 02:39:35 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   14.17 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.68 sec
      Start  9: test3
...
22/22 Test #22: test-backend-ops .................   Passed  128.11 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 188.58 sec
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   29.76 sec
...
main:  predict time =   957.46 ms / 14.96 ms per token
main:    total time =  1161.82 ms
...
main:     load time =   164.05 ms
main:   sample time =    18.93 ms
main:  predict time =  1015.12 ms / 14.50 ms per token
main:    total time =  1200.99 ms
...
main:  predict time =  1047.69 ms / 14.97 ms per token
main:    total time =  1264.91 ms
...
main:   sample time =   129.87 ms
main:  predict time =  6604.85 ms
main:    total time =  6990.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6f2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6dab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab9b43ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6f2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6f2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab9b44ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6dab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab9b43ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab9b45410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab9b44ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6f2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab9b45d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab9b45410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab9b466d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6f2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab9b45d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab9b46890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab9b466d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6f2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab9b46a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab9b46890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   119.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.69 ms
whisper_print_timings:   sample time =    67.89 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4735.93 ms /     1 runs ( 4735.93 ms per run)
whisper_print_timings:   decode time =    15.70 ms /     2 runs (    7.85 ms per run)
whisper_print_timings:   batchd time =   720.38 ms /   125 runs (    5.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5679.88 ms
