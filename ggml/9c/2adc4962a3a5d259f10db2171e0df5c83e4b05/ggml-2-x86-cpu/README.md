...
- status:  SUCCESS ✅
- runtime: 3:52.63
- date:    Wed Mar 13 14:37:14 UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed  104.19 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 135.04 sec
...
23/23 Test #23: test-backend-ops .................   Passed   27.08 sec
...
main:  predict time =   517.87 ms / 7.40 ms per token
main:    total time =   649.55 ms
...
main:  predict time =   519.36 ms / 7.42 ms per token
main:    total time =   674.67 ms
...
main:  predict time =  1860.46 ms
main:    total time =  2174.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5d42321990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5d421a21a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f475eeece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5d42321030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5d42326940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f475eefab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5d421a21a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f475eeece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f475ef0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f475eefab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5d42321030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f475ef0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f475ef0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f475ef16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5d42321990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f475ef0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f475ef1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f475ef16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5d42326940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f475ef1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f475ef1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.93 ms
whisper_print_timings:   sample time =    54.34 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1185.34 ms /     1 runs ( 1185.34 ms per run)
whisper_print_timings:   decode time =    12.34 ms /     2 runs (    6.17 ms per run)
whisper_print_timings:   batchd time =   217.94 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1569.15 ms
