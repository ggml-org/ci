...
- status:  SUCCESS ✅
- runtime: 5:16.26
- date:    Wed Mar 13 14:38:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   14.33 sec
...
22/22 Test #22: test-backend-ops .................   Passed  126.81 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 163.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.81 sec
...
23/23 Test #23: test-backend-ops .................   Passed   31.06 sec
...
main:     load time =   152.94 ms
main:   sample time =    17.49 ms
main:  predict time =   898.77 ms / 14.04 ms per token
main:    total time =  1091.04 ms
...
main:  predict time =   973.51 ms / 13.91 ms per token
main:    total time =  1146.52 ms
...
main:     load time =   180.84 ms
main:   sample time =    17.56 ms
main:  predict time =   986.90 ms / 14.10 ms per token
main:    total time =  1188.46 ms
...
main:   sample time =   127.79 ms
main:  predict time =  6440.71 ms
main:    total time =  6803.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff997ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9964b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf0b03ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff997ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff997cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf0b04ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9964b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf0b03ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf0b05410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf0b04ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff997ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf0b05d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf0b05410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf0b066d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff997ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf0b05d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf0b06890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf0b066d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff997cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf0b06a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf0b06890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.59 ms
whisper_print_timings:   sample time =    66.22 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4684.70 ms /     1 runs ( 4684.70 ms per run)
whisper_print_timings:   decode time =    15.27 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   709.28 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5600.57 ms
...
main:     load time =    89.62 ms
main:    total time = 39769.51 ms
embd_img
