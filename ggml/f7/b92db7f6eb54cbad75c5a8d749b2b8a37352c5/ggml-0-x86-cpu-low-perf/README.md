...
- status:  SUCCESS ✅
- runtime: 3:48.66
- date:    Fri Dec 22 15:50:43 UTC 2023
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.78 sec
...
main:  predict time =   605.39 ms / 9.46 ms per token
main:    total time =   770.92 ms
...
main:  predict time =   634.10 ms / 9.06 ms per token
main:    total time =   789.35 ms
...
main:  predict time =  2375.09 ms
main:    total time =  2704.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4d084b9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4d0833a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fec8d34b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4d084b9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4d084be940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fec8d35960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4d0833a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fec8d34b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fec8d362c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fec8d35960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4d084b9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fec8d36c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fec8d362c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fec8d37580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4d084b9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fec8d36c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fec8d37740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fec8d37580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4d084be940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55fec8d37900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fec8d37740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.69 ms
whisper_print_timings:   sample time =    72.09 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1988.24 ms /     1 runs ( 1988.24 ms per run)
whisper_print_timings:   decode time =    12.81 ms /     2 runs (    6.41 ms per run)
whisper_print_timings:   batchd time =   331.42 ms /   125 runs (    2.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2506.62 ms
...
main:     load time =    69.98 ms
main:    total time = 18775.33 ms
embd_img
