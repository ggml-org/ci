...
- status:  SUCCESS ✅
- runtime: 4:33.44
- date:    Fri Dec 22 03:52:08 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.70 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.90 sec
...
main:  predict time =   966.07 ms / 15.09 ms per token
main:    total time =  1197.02 ms
...
main:     load time =   190.66 ms
main:   sample time =    17.80 ms
main:  predict time =   905.53 ms / 12.94 ms per token
main:    total time =  1116.90 ms
...
main:     n_decoded =      504
main:     load time =   161.98 ms
main:   sample time =   129.15 ms
main:  predict time =  6081.67 ms
main:    total time =  6454.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ab5a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8a9db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6f75b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ab5a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ab5f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae6f76960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8a9db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6f75b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae6f772c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae6f76960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ab5a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae6f77c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae6f772c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae6f78580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ab5a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae6f77c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae6f78740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae6f78580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ab5f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae6f78900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae6f78740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    66.73 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4761.61 ms /     1 runs ( 4761.61 ms per run)
whisper_print_timings:   decode time =    16.01 ms /     2 runs (    8.00 ms per run)
whisper_print_timings:   batchd time =   714.62 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5689.04 ms
...
main:     load time =    99.62 ms
main:    total time = 40349.48 ms
embd_img
