...
- status:  SUCCESS ✅
- runtime: 6:01.66
- date:    Sun Jan 14 09:44:02 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   39.98 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.31 sec
...
main:     load time =   266.87 ms
main:   sample time =    17.09 ms
main:  predict time =   848.89 ms / 13.26 ms per token
...
main:  predict time =   920.25 ms / 13.15 ms per token
main:    total time =  1113.46 ms
...
main:     n_decoded =      504
main:     load time =   144.88 ms
main:   sample time =   128.22 ms
main:  predict time =  5960.10 ms
main:    total time =  6315.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ce3a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ccbb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafe8b3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ce3a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ce3f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafe8b4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ccbb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafe8b3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafe8b52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafe8b4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ce3a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafe8b5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafe8b52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafe8b6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ce3a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafe8b5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafe8b6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafe8b6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ce3f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafe8b6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafe8b6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   183.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.19 ms
whisper_print_timings:   sample time =    65.29 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4672.78 ms /     1 runs ( 4672.78 ms per run)
whisper_print_timings:   decode time =    15.34 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   708.94 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5663.99 ms
...
main:     load time =    80.02 ms
main:    total time = 39790.34 ms
embd_img
...
main:      load time = 14144.17 ms
main:    sample time =   516.86 ms / 8.08 ms per token
main:      eval time = 43795.29 ms / 625.65 ms per token
main:     total time = 60832.33 ms
...
main:      load time =  4325.75 ms
main:    sample time =   521.09 ms / 8.14 ms per token
main:      eval time = 17284.49 ms / 246.92 ms per token
main:     total time = 23095.28 ms
