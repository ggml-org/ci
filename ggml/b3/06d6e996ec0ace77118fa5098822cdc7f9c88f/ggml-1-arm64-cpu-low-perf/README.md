...
- status:  SUCCESS ✅
- runtime: 3:38.29
- date:    Sun Jan 14 09:14:11 AM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b306d6e996ec0ace77118fa5098822cdc7f9c88f
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.85 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.28 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.52 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   48.75 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  72.00 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.91 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.48 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.58 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.99 sec
...
main:     load time =   188.74 ms
main:   sample time =    16.78 ms
main:  predict time =   991.71 ms / 15.50 ms per token
main:    total time =  1218.97 ms
...
main:     load time =   188.41 ms
main:   sample time =    17.19 ms
main:  predict time =   934.89 ms / 13.36 ms per token
main:    total time =  1143.50 ms
...
main:     n_decoded =      504
main:     load time =   161.48 ms
main:   sample time =   126.97 ms
main:  predict time =  6144.38 ms
main:    total time =  6515.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5c1a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5a9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3e4fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5c1a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5c1f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3e50960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa5a9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3e4fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3e512c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3e50960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5c1a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3e51c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3e512c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3e52580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5c1a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3e51c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3e52740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3e52580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5c1f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae3e52900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3e52740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.47 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.91 ms
whisper_print_timings:   sample time =    65.99 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4774.42 ms /     1 runs ( 4774.42 ms per run)
whisper_print_timings:   decode time =    15.40 ms /     2 runs (    7.70 ms per run)
whisper_print_timings:   batchd time =   712.36 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5696.80 ms
...
main:     load time =    96.53 ms
main:    total time = 40754.88 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.257000 sec.)
