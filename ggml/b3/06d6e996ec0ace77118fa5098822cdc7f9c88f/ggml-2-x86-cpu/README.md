...
- status:  SUCCESS ✅
- runtime: 4:23.87
- date:    Sun Jan 14 09:20:34 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    3.65 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    3.06 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   32.43 sec
...
21/21 Test #21: test-backend-ops .................   Passed    9.48 sec
...
main:     load time =   195.26 ms
main:   sample time =    23.39 ms
main:  predict time =   446.35 ms / 6.97 ms per token
main:    total time =   678.13 ms
...
main:  predict time =   464.23 ms / 6.63 ms per token
...
main:  predict time =  1508.56 ms
main:    total time =  1824.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f936d275990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f936d0f61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fe38622b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f936d275030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f936d27a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fe38623960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f936d0f61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fe38622b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fe386242c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fe38623960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f936d275030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fe38624c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fe386242c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fe38625580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f936d275990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fe38624c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fe38625740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fe38625580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f936d27a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55fe38625900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fe38625740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.84 ms
whisper_print_timings:   sample time =    54.92 ms /   131 runs (    0.42 ms per run)
...
whisper_print_timings:   batchd time =   207.63 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1581.06 ms
...
main:     load time =    60.72 ms
main:    total time = 10610.57 ms
embd_img
...
main:      load time = 12543.98 ms
main:    sample time =   469.36 ms / 7.33 ms per token
main:      eval time = 20508.84 ms / 292.98 ms per token
main:     total time = 34198.29 ms
...
main:      load time =  4368.15 ms
main:    sample time =   468.84 ms / 7.33 ms per token
main:      eval time =  8167.75 ms / 116.68 ms per token
main:     total time = 13402.24 ms
