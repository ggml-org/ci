...
- status:  SUCCESS ✅
- runtime: 2:54.87
- date:    Sun Jan 14 09:12:34 UTC 2024
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.17 sec
...
main:     load time =   133.94 ms
main:   sample time =    23.60 ms
main:  predict time =   653.43 ms / 10.21 ms per token
main:    total time =   824.10 ms
...
main:  predict time =  2499.46 ms
main:    total time =  2829.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcec6877990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcec66f81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5580ffd99b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcec6877030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcec687c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5580ffd9a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcec66f81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5580ffd99b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5580ffd9b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5580ffd9a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcec6877030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5580ffd9bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5580ffd9b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5580ffd9c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcec6877990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5580ffd9bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5580ffd9c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5580ffd9c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcec687c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5580ffd9c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5580ffd9c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.45 ms
whisper_print_timings:   sample time =    74.90 ms /   131 runs (    0.57 ms per run)
whisper_print_timings:   encode time =  1998.03 ms /     1 runs ( 1998.03 ms per run)
whisper_print_timings:   decode time =    12.65 ms /     2 runs (    6.32 ms per run)
whisper_print_timings:   batchd time =   330.30 ms /   125 runs (    2.64 ms per run)
