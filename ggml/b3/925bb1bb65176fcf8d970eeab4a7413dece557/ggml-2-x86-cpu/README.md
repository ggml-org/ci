...
- status:  SUCCESS ✅
- runtime: 2:56.81
- date:    Sun Feb 25 19:33:21 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   81.79 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.31 sec
      Start  2: test-opt
 ...
 6/21 Test  #6: test-mul-mat2 ....................   Passed    2.83 sec
      Start  7: test0
...
main:     load time =   107.21 ms
main:   sample time =    23.55 ms
main:  predict time =   489.91 ms / 7.65 ms per token
main:    total time =   633.27 ms
...
main:     load time =   107.26 ms
main:   sample time =    23.70 ms
main:  predict time =   514.98 ms / 7.36 ms per token
main:    total time =   648.06 ms
...
main:     load time =   124.63 ms
main:   sample time =    23.46 ms
main:  predict time =   517.46 ms / 7.39 ms per token
main:    total time =   668.14 ms
...
main:   sample time =   177.63 ms
main:  predict time =  1807.17 ms
main:    total time =  2122.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdfb2996990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdfb28171a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b20f24ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdfb2996030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdfb299b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555b20f25ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdfb28171a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b20f24ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555b20f26410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555b20f25ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdfb2996030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555b20f26d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555b20f26410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555b20f276d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdfb2996990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555b20f26d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555b20f27890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555b20f276d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdfb299b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555b20f27a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555b20f27890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.69 ms
whisper_print_timings:   sample time =    55.21 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1187.62 ms /     1 runs ( 1187.62 ms per run)
whisper_print_timings:   decode time =    12.73 ms /     2 runs (    6.36 ms per run)
whisper_print_timings:   batchd time =   213.65 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1562.39 ms
...
main:     load time =    68.27 ms
main:    total time = 10729.66 ms
embd_img
