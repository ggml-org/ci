...
- status:  SUCCESS ✅
- runtime: 5:09.73
- date:    Sun Feb 25 07:35:26 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  102.43 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 144.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.82 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.36 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.24 sec
      Start  4: test-mul-mat0
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.04 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   21.57 sec
...
main:     load time =   156.01 ms
main:   sample time =    17.40 ms
main:  predict time =   935.98 ms / 14.62 ms per token
main:    total time =  1131.00 ms
...
main:     load time =   160.04 ms
main:   sample time =    17.04 ms
main:  predict time =   989.33 ms / 14.13 ms per token
main:    total time =  1169.21 ms
...
main:     load time =   183.30 ms
main:   sample time =    17.09 ms
main:  predict time =  1046.78 ms / 14.95 ms per token
main:    total time =  1250.27 ms
...
main:  predict time =  6635.57 ms
main:    total time =  7001.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6fda990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6e5b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0020fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6fda030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6fdf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab00210ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6e5b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0020fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab00211410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab00210ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6fda030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab00211d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab00211410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab002126d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6fda990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab00211d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab00212890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab002126d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6fdf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab00212a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab00212890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.13 ms
whisper_print_timings:   sample time =    65.73 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4801.68 ms /     1 runs ( 4801.68 ms per run)
whisper_print_timings:   decode time =    15.42 ms /     2 runs (    7.71 ms per run)
whisper_print_timings:   batchd time =   719.55 ms /   125 runs (    5.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5727.76 ms
...
main:     load time =    89.27 ms
main:    total time = 40551.04 ms
embd_img
