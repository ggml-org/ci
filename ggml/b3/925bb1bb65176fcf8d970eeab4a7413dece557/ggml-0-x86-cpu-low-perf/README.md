...
- status:  SUCCESS ✅
- runtime: 4:18.54
- date:    Sun Feb 25 19:34:45 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.00 sec
...
20/20 Test #20: test-backend-ops .................   Passed   82.19 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 124.51 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.22 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.14 sec
...
main:  predict time =   707.81 ms / 11.06 ms per token
main:    total time =   852.47 ms
...
main:  predict time =   746.73 ms / 10.67 ms per token
main:    total time =   881.12 ms
...
main:     load time =   128.55 ms
main:   sample time =    23.61 ms
main:  predict time =   758.45 ms / 10.84 ms per token
main:    total time =   913.16 ms
...
main:  predict time =  3135.93 ms
main:    total time =  3463.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f16c7626990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f16c74a71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c7a755dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f16c7626030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f16c762b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c7a755eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f16c74a71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c7a755dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c7a755f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c7a755eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f16c7626030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c7a755fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c7a755f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c7a75606d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f16c7626990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c7a755fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c7a7560890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c7a75606d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f16c762b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c7a7560a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c7a7560890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.41 ms
whisper_print_timings:   sample time =    71.64 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2050.57 ms /     1 runs ( 2050.57 ms per run)
whisper_print_timings:   decode time =    15.09 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   329.67 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2571.13 ms
