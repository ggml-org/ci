...
- status:  SUCCESS ✅
- runtime: 4:04.89
- date:    Wed Mar 27 11:13:49 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.47 sec
      Start  6: test0
 6/22 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.50 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.64 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   20.98 sec
      Start  9: test3
...
main:     load time =   167.93 ms
main:   sample time =    18.00 ms
main:  predict time =   926.70 ms / 14.48 ms per token
main:    total time =  1134.46 ms
...
main:     load time =   167.90 ms
main:   sample time =    18.08 ms
main:  predict time =  1004.39 ms / 14.35 ms per token
main:    total time =  1193.23 ms
...
main:     load time =   203.72 ms
main:   sample time =    18.20 ms
main:  predict time =  1061.46 ms / 15.16 ms per token
main:    total time =  1286.93 ms
...
main:     n_decoded =      504
main:     load time =   164.96 ms
main:   sample time =   127.53 ms
main:  predict time =  6488.31 ms
main:    total time =  6863.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff882fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8817b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb7d2ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff882fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff882ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadb7d3ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8817b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb7d2ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadb7d4410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadb7d3ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff882fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadb7d4d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadb7d4410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadb7d56d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff882fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadb7d4d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadb7d5890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadb7d56d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff882ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadb7d5a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadb7d5890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.09 ms
whisper_print_timings:   sample time =    67.03 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4723.17 ms /     1 runs ( 4723.17 ms per run)
whisper_print_timings:   decode time =    15.82 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   715.97 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5658.27 ms
