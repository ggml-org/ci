...
- status:  SUCCESS ✅
- runtime: 3:30.23
- date:    Wed Mar 27 11:13:02 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/fe3158e174d4602e7c4a0b72a57b79fc7826c0b3
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.04 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.12 sec
...
Total Test time (real) =  76.01 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.77 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.48 sec
      Start  9: test3
...
main:     load time =   105.58 ms
main:   sample time =    23.54 ms
main:  predict time =   711.05 ms / 11.11 ms per token
main:    total time =   852.77 ms
...
main:     load time =   106.49 ms
main:   sample time =    23.52 ms
main:  predict time =   764.30 ms / 10.92 ms per token
main:    total time =   896.46 ms
...
main:     load time =   128.63 ms
main:   sample time =    23.89 ms
main:  predict time =   765.38 ms / 10.93 ms per token
main:    total time =   920.88 ms
...
main:     n_decoded =      504
main:     load time =   108.35 ms
main:   sample time =   175.89 ms
main:  predict time =  3146.05 ms
main:    total time =  3476.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f00d0539990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f00d03ba1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563400c82ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f00d0539030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f00d053e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563400c83ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f00d03ba1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563400c82ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563400c84410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563400c83ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f00d0539030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563400c84d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563400c84410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563400c856d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f00d0539990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563400c84d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563400c85890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563400c856d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f00d053e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563400c85a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563400c85890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.75 ms
whisper_print_timings:   sample time =    73.03 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2083.91 ms /     1 runs ( 2083.91 ms per run)
whisper_print_timings:   decode time =    15.98 ms /     2 runs (    7.99 ms per run)
whisper_print_timings:   batchd time =   338.58 ms /   125 runs (    2.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2614.69 ms
