...
- status:  SUCCESS ✅
- runtime: 5:29.02
- date:    Thu Jan 18 09:10:15 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.46 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  147.36 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 171.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.26 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.59 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   23.77 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  39.22 sec
...
main:     load time =   193.92 ms
main:   sample time =    17.28 ms
main:  predict time =   874.01 ms / 13.66 ms per token
main:    total time =  1107.18 ms
...
main:     load time =   187.07 ms
main:   sample time =    17.77 ms
main:  predict time =   973.63 ms / 13.91 ms per token
main:    total time =  1181.60 ms
...
main:   sample time =   127.25 ms
main:  predict time =  6137.89 ms
main:    total time =  6512.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa43ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa423b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab01ce3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa43ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa43bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab01ce4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa423b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab01ce3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab01ce52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab01ce4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa43ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab01ce5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab01ce52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab01ce6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa43ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab01ce5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab01ce6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab01ce6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa43bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab01ce6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab01ce6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.67 ms
whisper_print_timings:   sample time =    65.88 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4636.82 ms /     1 runs ( 4636.82 ms per run)
whisper_print_timings:   decode time =    15.99 ms /     2 runs (    7.99 ms per run)
whisper_print_timings:   batchd time =   836.32 ms /   125 runs (    6.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5682.99 ms
...
main:     load time =    93.64 ms
main:    total time = 40413.29 ms
embd_img
