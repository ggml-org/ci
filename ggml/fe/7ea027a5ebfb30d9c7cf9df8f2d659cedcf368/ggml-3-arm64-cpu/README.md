...
- status:  SUCCESS ✅
- runtime: 7:34.75
- date:    Thu Jan 18 09:23:16 AM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/fe7ea027a5ebfb30d9c7cf9df8f2d659cedcf368
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.38 sec
...
20/20 Test #20: test-backend-ops .................   Passed  127.46 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 141.51 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.13 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.10 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.39 sec
...
main:     load time =   188.98 ms
main:   sample time =    17.03 ms
main:  predict time =   853.29 ms / 13.33 ms per token
main:    total time =  1081.26 ms
...
main:     load time =   181.34 ms
main:   sample time =    16.52 ms
main:  predict time =   921.55 ms / 13.17 ms per token
main:    total time =  1122.45 ms
...
main:   sample time =   128.13 ms
main:  predict time =  5977.28 ms
main:    total time =  6340.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f6ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f54b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab150e3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f6ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f6cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab150e4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f54b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab150e3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab150e52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab150e4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f6ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab150e5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab150e52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab150e6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f6ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab150e5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab150e6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab150e6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f6cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab150e6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab150e6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    65.47 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4624.31 ms /     1 runs ( 4624.31 ms per run)
whisper_print_timings:   decode time =    15.86 ms /     2 runs (    7.93 ms per run)
whisper_print_timings:   batchd time =   709.29 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5551.33 ms
...
main:     load time =    87.90 ms
main:    total time = 39638.71 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.251000 sec.)
...
main:      load time = 12919.75 ms
main:    sample time =   529.98 ms / 8.28 ms per token
main:      eval time = 43818.63 ms / 625.98 ms per token
main:     total time = 59643.12 ms
...
main:      load time =  4369.22 ms
main:    sample time =   513.86 ms / 8.03 ms per token
main:      eval time = 17414.98 ms / 248.79 ms per token
main:     total time = 23254.39 ms
