...
- status:  SUCCESS ✅
- runtime: 5:12.46
- date:    Thu Jan 18 09:15:39 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.34 sec
...
20/20 Test #20: test-backend-ops .................   Passed  113.37 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 124.17 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.33 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.65 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.61 sec
...
main:     load time =   175.14 ms
main:   sample time =    23.64 ms
main:  predict time =   459.08 ms / 7.17 ms per token
main:    total time =   670.76 ms
...
main:     load time =   127.14 ms
main:   sample time =    23.77 ms
main:  predict time =   485.60 ms / 6.94 ms per token
main:    total time =   639.06 ms
...
main:  predict time =  1537.25 ms
main:    total time =  1850.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae0ef9e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae0ee1f1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564e95e02b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae0ef9e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae0efa3940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564e95e03960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae0ee1f1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564e95e02b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564e95e042c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564e95e03960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae0ef9e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564e95e04c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564e95e042c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564e95e05580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae0ef9e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564e95e04c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564e95e05740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564e95e05580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae0efa3940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564e95e05900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564e95e05740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    54.59 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1169.06 ms /     1 runs ( 1169.06 ms per run)
whisper_print_timings:   decode time =     9.62 ms /     2 runs (    4.81 ms per run)
whisper_print_timings:   batchd time =   206.96 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1573.93 ms
...
main:     load time =    61.19 ms
main:    total time = 10616.35 ms
embd_img
...
main:      load time =  5712.85 ms
main:    sample time =   467.60 ms / 7.31 ms per token
main:      eval time = 20621.03 ms / 294.59 ms per token
main:     total time = 27479.49 ms
...
main:      load time =  1221.52 ms
main:    sample time =   468.25 ms / 7.32 ms per token
main:      eval time =  8227.31 ms / 117.53 ms per token
main:     total time = 10265.81 ms
