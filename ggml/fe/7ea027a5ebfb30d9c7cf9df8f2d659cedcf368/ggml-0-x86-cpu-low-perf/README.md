...
- status:  SUCCESS ✅
- runtime: 4:21.88
- date:    Thu Jan 18 09:09:15 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  117.45 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 140.15 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.90 sec
...
main:  predict time =   613.06 ms / 9.58 ms per token
main:    total time =   775.80 ms
...
main:     load time =   127.25 ms
main:   sample time =    23.55 ms
main:  predict time =   650.51 ms / 9.29 ms per token
main:    total time =   803.80 ms
...
main:   sample time =   178.42 ms
main:  predict time =  2487.89 ms
main:    total time =  2816.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff20d333990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff20d1b41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558713c79b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff20d333030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff20d338940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558713c7a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff20d1b41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558713c79b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558713c7b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558713c7a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff20d333030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558713c7bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558713c7b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558713c7c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff20d333990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558713c7bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558713c7c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558713c7c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff20d338940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558713c7c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558713c7c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.23 ms
whisper_print_timings:   sample time =    72.60 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1981.37 ms /     1 runs ( 1981.37 ms per run)
whisper_print_timings:   decode time =    12.37 ms /     2 runs (    6.19 ms per run)
whisper_print_timings:   batchd time =   321.52 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2491.99 ms
...
main:     load time =    72.27 ms
main:    total time = 19018.60 ms
embd_img
