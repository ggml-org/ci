...
- status:  SUCCESS ✅
- runtime: 15:04.65
- date:    Thu Jan 18 09:31:45 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.84 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.85 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.04 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.54 sec
      Start 11: test-conv-transpose
11/20 Test #11: test-conv-transpose ..............   Passed    0.52 sec
      Start 12: test-dup
...
20/20 Test #20: test-backend-ops .................   Passed  240.97 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 273.76 sec
...
21/21 Test #21: test-backend-ops .................   Passed   47.54 sec
...
main:     load time =   565.98 ms
main:   sample time =    34.08 ms
main:  predict time =   578.56 ms / 9.04 ms per token
main:    total time =  1198.81 ms
...
main:     load time =   582.35 ms
main:   sample time =    35.35 ms
main:  predict time =   614.69 ms / 8.78 ms per token
main:    total time =  1236.99 ms
...
main:     n_decoded =      504
main:     load time =   534.57 ms
main:   sample time =   232.87 ms
main:  predict time =  2316.64 ms
main:    total time =  3128.53 ms
...
main: loaded model in   392.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f44c59b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f44c58371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560540e6cb00                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f44c59b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f44c59bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560540e6d8d0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f44c58371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560540e6cb00                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560540e6e230                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560540e6d8d0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f44c59b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560540e6eb90                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560540e6e230                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560540e6f4f0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f44c59b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560540e6eb90                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560540e6f6b0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560540e6f4f0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f44c59bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560540e6f870                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560540e6f6b0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   494.98 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.58 ms
whisper_print_timings:   sample time =    66.70 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    22.70 ms /     1 runs (   22.70 ms per run)
whisper_print_timings:   decode time =    20.74 ms /     2 runs (   10.37 ms per run)
whisper_print_timings:   batchd time =    86.41 ms /   125 runs (    0.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   717.68 ms
...
main:     load time =   507.40 ms
main:    total time =  8159.50 ms
embd_img
...
main:      load time = 31300.20 ms
main:    sample time =   548.96 ms / 8.58 ms per token
main:      eval time = 25823.00 ms / 368.90 ms per token
main:     total time = 58699.88 ms
...
main:      load time = 17659.60 ms
main:    sample time =   559.68 ms / 8.74 ms per token
main:      eval time = 12751.40 ms / 182.16 ms per token
main:     total time = 31647.89 ms
