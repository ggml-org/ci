...
- status:  SUCCESS ✅
- runtime: 4:05.75
- date:    Sat Apr  6 03:26:07 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   22.37 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.58 sec
      Start  2: test-quantize-fns
...
main:  predict time =   902.55 ms / 14.10 ms per token
...
main:     load time =   160.86 ms
main:   sample time =    17.29 ms
main:  predict time =   979.75 ms / 14.00 ms per token
main:    total time =  1160.67 ms
...
main:     load time =   195.30 ms
main:   sample time =    17.28 ms
main:  predict time =  1004.32 ms / 14.35 ms per token
main:    total time =  1220.52 ms
...
main:     n_decoded =      504
main:     load time =   159.79 ms
main:   sample time =   128.40 ms
main:  predict time =  6496.55 ms
main:    total time =  6867.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9343a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff932bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadfba4ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9343a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9343f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadfba5ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff932bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadfba4ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadfba6410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadfba5ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9343a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadfba6d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadfba6410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadfba76d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9343a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadfba6d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadfba7890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadfba76d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9343f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadfba7a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadfba7890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    14.50 ms
whisper_print_timings:   sample time =    65.16 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4702.16 ms /     1 runs ( 4702.16 ms per run)
whisper_print_timings:   decode time =    14.64 ms /     2 runs (    7.32 ms per run)
whisper_print_timings:   batchd time =   711.65 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5624.12 ms
...
main:     load time =    99.35 ms
main:    total time = 39920.41 ms
embd_img
