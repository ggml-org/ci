...
- status:  SUCCESS ✅
- runtime: 3:07.97
- date:    Sat Apr  6 15:25:18 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/4b2158db0e5ec709d359bfb0edbaeb47079ea203
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.07 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.64 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.90 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.52 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.58 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/23 Test  #1: test-grad0 .......................   Passed    2.97 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.13 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   17.47 sec
...
main:     load time =   152.80 ms
main:   sample time =    17.41 ms
main:  predict time =   893.75 ms / 13.96 ms per token
main:    total time =  1085.69 ms
...
main:     load time =   153.70 ms
main:   sample time =    17.31 ms
main:  predict time =   974.23 ms / 13.92 ms per token
main:    total time =  1148.09 ms
...
main:     load time =   181.36 ms
main:   sample time =    17.51 ms
main:  predict time =  1007.81 ms / 14.40 ms per token
main:    total time =  1210.06 ms
...
main:     n_decoded =      504
main:     load time =   153.13 ms
main:   sample time =   130.14 ms
main:  predict time =  6426.26 ms
main:    total time =  6791.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8860a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8848b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeb344ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8860a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8860f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeb345ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8848b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeb344ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeb346410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeb345ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8860a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeb346d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeb346410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeb3476d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8860a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeb346d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeb347890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeb3476d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8860f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeb347a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeb347890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.10 ms
whisper_print_timings:   sample time =    65.30 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4679.67 ms /     1 runs ( 4679.67 ms per run)
whisper_print_timings:   decode time =    14.38 ms /     2 runs (    7.19 ms per run)
whisper_print_timings:   batchd time =   710.88 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5597.05 ms
...
main:     load time =    92.08 ms
main:    total time = 39770.05 ms
embd_img
