...
- status:  SUCCESS ✅
- runtime: 3:30.58
- date:    Sat Apr  6 15:25:32 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.17 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.68 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.00 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.14 sec
      Start  9: test3
...
Total Test time (real) =  76.88 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.70 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.00 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.47 sec
      Start  4: test-mul-mat0
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.01 sec
      Start  9: test3
...
main:     load time =   110.54 ms
main:   sample time =    23.58 ms
main:  predict time =   735.58 ms / 11.49 ms per token
main:    total time =   882.32 ms
...
main:  predict time =   774.67 ms / 11.07 ms per token
main:    total time =   910.44 ms
...
main:     load time =   131.69 ms
main:   sample time =    24.00 ms
main:  predict time =   791.66 ms / 11.31 ms per token
main:    total time =   950.43 ms
...
main:     n_decoded =      504
main:     load time =   109.26 ms
main:   sample time =   175.78 ms
main:  predict time =  3122.89 ms
main:    total time =  3454.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fefbafe0990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fefbae611a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f9d4e20ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fefbafe0030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fefbafe5940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f9d4e21ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fefbae611a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f9d4e20ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f9d4e22410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f9d4e21ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fefbafe0030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f9d4e22d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f9d4e22410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f9d4e236d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fefbafe0990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f9d4e22d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f9d4e23890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f9d4e236d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fefbafe5940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f9d4e23a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f9d4e23890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.88 ms
whisper_print_timings:   sample time =    72.89 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2063.33 ms /     1 runs ( 2063.33 ms per run)
whisper_print_timings:   decode time =    16.31 ms /     2 runs (    8.16 ms per run)
whisper_print_timings:   batchd time =   336.10 ms /   125 runs (    2.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2592.60 ms
...
main:     load time =    73.66 ms
main:    total time = 19448.98 ms
embd_img
