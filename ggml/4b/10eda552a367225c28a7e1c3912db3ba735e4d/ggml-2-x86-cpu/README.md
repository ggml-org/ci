...
- status:  SUCCESS ✅
- runtime: 5:02.25
- date:    Sat Jan 27 15:56:00 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.41 sec
...
20/20 Test #20: test-backend-ops .................   Passed  111.96 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 122.85 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.55 sec
...
main:     load time =   124.39 ms
main:   sample time =    23.75 ms
main:  predict time =   468.34 ms / 7.32 ms per token
main:    total time =   629.49 ms
...
main:   sample time =    23.75 ms
main:  predict time =   487.79 ms / 6.97 ms per token
main:    total time =   642.35 ms
...
main:     n_decoded =      504
main:     load time =   105.45 ms
main:   sample time =   177.96 ms
main:  predict time =  1517.12 ms
main:    total time =  1831.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f614b2e4990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f614b1651a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559e0b58db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f614b2e4030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f614b2e9940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559e0b58e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f614b1651a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559e0b58db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559e0b58f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559e0b58e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f614b2e4030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559e0b58fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559e0b58f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559e0b590580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f614b2e4990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559e0b58fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559e0b590740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559e0b590580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f614b2e9940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559e0b590900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559e0b590740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    54.58 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1169.92 ms /     1 runs ( 1169.92 ms per run)
whisper_print_timings:   decode time =     9.69 ms /     2 runs (    4.85 ms per run)
whisper_print_timings:   batchd time =   212.50 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1540.12 ms
...
main:     load time =    67.07 ms
main:    total time = 10676.78 ms
embd_img
...
main:      load time =  5283.73 ms
main:    sample time =   470.66 ms / 7.35 ms per token
main:      eval time = 19757.86 ms / 282.26 ms per token
main:     total time = 26160.19 ms
...
main:      load time =  1250.40 ms
main:    sample time =   468.76 ms / 7.32 ms per token
main:      eval time =  8210.84 ms / 117.30 ms per token
main:     total time = 10304.21 ms
