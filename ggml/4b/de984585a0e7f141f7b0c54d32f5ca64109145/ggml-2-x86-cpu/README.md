...
- status:  SUCCESS ✅
- runtime: 3:52.98
- date:    Fri Dec  8 22:41:44 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.53 sec
...
main:     load time =   233.75 ms
main:   sample time =    23.49 ms
main:  predict time =   442.20 ms / 6.91 ms per token
main:    total time =   712.32 ms
...
main:   sample time =    23.49 ms
main:  predict time =   444.10 ms / 6.34 ms per token
...
main:  predict time =  1462.70 ms
main:    total time =  1775.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1306080960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1305f01190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aa8eba6b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1306080010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1306085900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aa8eba7940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1305f01190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aa8eba6b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aa8eba8290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aa8eba7940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1306080010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aa8eba8be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aa8eba8290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aa8eba9530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1306080960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aa8eba8be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aa8eba96e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aa8eba9530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1306085900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55aa8eba9890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aa8eba96e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.15 ms
whisper_print_timings:   sample time =    55.37 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1152.40 ms /     1 runs ( 1152.40 ms per run)
whisper_print_timings:   decode time =     9.85 ms /     2 runs (    4.93 ms per run)
whisper_print_timings:   batchd time =   207.46 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1569.48 ms
...
main:      load time =  5647.63 ms
main:    sample time =   470.84 ms / 7.36 ms per token
main:      eval time = 20585.09 ms / 294.07 ms per token
main:     total time = 27372.18 ms
...
main:      load time =  1243.49 ms
main:    sample time =   467.49 ms / 7.30 ms per token
main:      eval time =  8934.68 ms / 127.64 ms per token
main:     total time = 10996.72 ms
