...
- status:  SUCCESS ✅
- runtime: 8:16.56
- date:    Fri Dec  8 22:46:01 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.81 sec
...
19/19 Test #19: test-backend-ops .................   Passed   91.31 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 123.54 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.55 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    7.99 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   23.29 sec
...
main:     load time =   575.48 ms
main:   sample time =    35.26 ms
main:  predict time =   572.82 ms / 8.95 ms per token
main:    total time =  1207.12 ms
...
main:     load time =   587.60 ms
main:   sample time =    34.01 ms
main:  predict time =   597.82 ms / 8.54 ms per token
main:    total time =  1223.53 ms
...
main:     n_decoded =      504
main:     load time =   554.43 ms
main:   sample time =   232.92 ms
main:  predict time =  2230.48 ms
main:    total time =  3062.67 ms
...
main: loaded model in   418.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f00f05b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f00f0437190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560095f0ba20                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f00f05b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f00f05bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560095f0c7e0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f00f0437190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560095f0ba20                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560095f0d130                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560095f0c7e0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f00f05b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560095f0da80                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560095f0d130                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560095f0e3d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f00f05b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560095f0da80                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560095f0e580                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560095f0e3d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f00f05bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560095f0e730                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560095f0e580       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   548.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.09 ms
whisper_print_timings:   sample time =    66.70 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    33.01 ms /     1 runs (   33.01 ms per run)
whisper_print_timings:   decode time =    13.28 ms /     2 runs (    6.64 ms per run)
whisper_print_timings:   batchd time =    84.17 ms /   125 runs (    0.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   772.49 ms
...
main:     load time =   545.77 ms
main:    total time =  7964.64 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.654000 sec.)
...
main:      load time =  7185.04 ms
main:    sample time =   518.52 ms / 8.10 ms per token
main:      eval time = 24488.79 ms / 349.84 ms per token
main:     total time = 33026.44 ms
...
main:      load time =  2180.85 ms
main:    sample time =   519.26 ms / 8.11 ms per token
main:      eval time = 12513.75 ms / 178.77 ms per token
main:     total time = 15855.14 ms
