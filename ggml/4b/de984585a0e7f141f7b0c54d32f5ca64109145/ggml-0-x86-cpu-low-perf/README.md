...
- status:  SUCCESS ✅
- runtime: 3:07.82
- date:    Fri Dec  8 22:40:57 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   51.21 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.32 sec
      Start  9: test3
...
main:     load time =   124.96 ms
main:   sample time =    23.51 ms
main:  predict time =   600.09 ms / 9.38 ms per token
main:    total time =   761.23 ms
...
main:  predict time =   629.95 ms / 9.00 ms per token
main:    total time =   780.74 ms
...
main:  predict time =  2367.73 ms
main:    total time =  2694.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0448e38960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0448cb9190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c6faeaab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0448e38010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0448e3d900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c6faeab940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0448cb9190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c6faeaab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c6faeac290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c6faeab940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0448e38010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c6faeacbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c6faeac290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c6faead530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0448e38960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c6faeacbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c6faead6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c6faead530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0448e3d900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c6faead890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c6faead6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.34 ms
whisper_print_timings:   sample time =    72.58 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1984.14 ms /     1 runs ( 1984.14 ms per run)
whisper_print_timings:   decode time =    12.33 ms /     2 runs (    6.16 ms per run)
whisper_print_timings:   batchd time =   322.23 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2490.71 ms
