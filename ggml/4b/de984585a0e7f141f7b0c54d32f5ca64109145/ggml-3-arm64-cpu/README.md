...
- status:  SUCCESS ✅
- runtime: 5:39.38
- date:    Fri Dec  8 10:43:26 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.55 sec
      Start  6: test0
 6/19 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    0.14 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   47.15 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.03 sec
...
main:  predict time =   818.45 ms / 12.79 ms per token
...
main:  predict time =   891.28 ms / 12.73 ms per token
main:    total time =  1095.29 ms
...
main:  predict time =  5846.38 ms
main:    total time =  6207.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa93ea960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa926b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad36d0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa93ea010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa93ef900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad36d1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa926b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad36d0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad36d2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad36d1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa93ea010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad36d2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad36d2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad36d3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa93ea960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad36d2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad36d36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad36d3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa93ef900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad36d3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad36d36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4664.53 ms /     1 runs ( 4664.53 ms per run)
whisper_print_timings:   decode time =    15.73 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   708.15 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5608.35 ms
...
main:     load time =    91.07 ms
main:    total time = 39544.46 ms
embd_img
...
main:      load time =  5821.63 ms
main:    sample time =   534.25 ms / 8.35 ms per token
main:      eval time = 43508.99 ms / 621.56 ms per token
main:     total time = 52238.24 ms
...
main:      load time =  1500.74 ms
main:    sample time =   529.27 ms / 8.27 ms per token
main:      eval time = 17615.18 ms / 251.65 ms per token
main:     total time = 20638.43 ms
