...
- status:  SUCCESS ✅
- runtime: 3:49.66
- date:    Fri Dec  8 10:41:35 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/4bde984585a0e7f141f7b0c54d32f5ca64109145
- author:  slaren
```
add metal impl
ggml-ci
...
19/19 Test #19: test-backend-ops .................   Passed   55.36 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.71 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   12.69 sec
...
main:     load time =   195.18 ms
main:   sample time =    17.79 ms
main:  predict time =   850.63 ms / 13.29 ms per token
main:    total time =  1085.51 ms
...
main:     load time =   189.32 ms
main:   sample time =    17.58 ms
main:  predict time =   908.38 ms / 12.98 ms per token
main:    total time =  1118.20 ms
...
main:     n_decoded =      504
main:     load time =   161.41 ms
main:   sample time =   129.14 ms
main:  predict time =  6049.43 ms
main:    total time =  6421.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb7bfa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb7a7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9710b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7bfa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb7bff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf9711940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb7a7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9710b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf9712290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf9711940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7bfa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf9712be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf9712290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf9713530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb7bfa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf9712be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf97136e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf9713530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb7bff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf9713890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf97136e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.07 ms
whisper_print_timings:   sample time =    66.72 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4767.95 ms /     1 runs ( 4767.95 ms per run)
whisper_print_timings:   decode time =    16.17 ms /     2 runs (    8.09 ms per run)
whisper_print_timings:   batchd time =   715.30 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5694.86 ms
