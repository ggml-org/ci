...
- status:  SUCCESS ✅
- runtime: 2:09.20
- date:    Wed May 29 10:07:11 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.82 sec
...
main:  predict time =   517.33 ms / 8.08 ms per token
main:    total time =   661.06 ms
...
main:  predict time =   539.80 ms / 7.71 ms per token
main:    total time =   672.03 ms
...
main:     load time =   126.70 ms
main:   sample time =    23.90 ms
main:  predict time =   553.12 ms / 7.90 ms per token
main:    total time =   706.85 ms
...
main:  predict time =  1830.67 ms
main:    total time =  2148.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7702f4afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7702f497b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x64d0a469fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7702f4afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7702f4aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x64d0a46a0ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7702f497b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x64d0a469fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x64d0a46a1410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x64d0a46a0ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7702f4afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x64d0a46a1d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x64d0a46a1410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x64d0a46a26d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7702f4afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x64d0a46a1d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x64d0a46a2890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x64d0a46a26d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7702f4aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x64d0a46a2a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x64d0a46a2890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.41 ms
whisper_print_timings:   sample time =    55.78 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1163.52 ms /     1 runs ( 1163.52 ms per run)
whisper_print_timings:   decode time =    11.38 ms /     2 runs (    5.69 ms per run)
whisper_print_timings:   batchd time =   222.23 ms /   125 runs (    1.78 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1553.38 ms
...
main:     load time =    64.97 ms
main:    total time = 10922.47 ms
embd_img
