...
- status:  SUCCESS ✅
- runtime: 4:01.60
- date:    Wed May 29 10:09:07 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.88 sec
      Start  9: test3
...
main:     load time =   143.09 ms
main:   sample time =    16.66 ms
main:  predict time =   912.41 ms / 14.26 ms per token
main:    total time =  1093.56 ms
...
main:     load time =   138.84 ms
main:   sample time =    16.74 ms
main:  predict time =   990.73 ms / 14.15 ms per token
...
main:     load time =   170.44 ms
main:   sample time =    16.94 ms
main:  predict time =  1009.87 ms / 14.43 ms per token
main:    total time =  1200.51 ms
...
main:  predict time =  6651.70 ms
main:    total time =  7005.35 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfb1c0f72a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfb1c0f5ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc07788166ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfb1c0f72a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfb1c0f72f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc07788167ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfb1c0f5ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc07788166ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc07788168410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc07788167ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfb1c0f72a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc07788168d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc07788168410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc077881696d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfb1c0f72a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc07788168d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc07788169890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc077881696d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfb1c0f72f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc07788169a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc07788169890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    99.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.39 ms
whisper_print_timings:   sample time =    65.91 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4662.60 ms /     1 runs ( 4662.60 ms per run)
whisper_print_timings:   decode time =    14.38 ms /     2 runs (    7.19 ms per run)
whisper_print_timings:   batchd time =   724.76 ms /   125 runs (    5.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5598.57 ms
