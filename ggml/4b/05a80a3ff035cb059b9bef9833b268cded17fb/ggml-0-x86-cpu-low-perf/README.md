...
- status:  SUCCESS ✅
- runtime: 3:25.21
- date:    Wed May 29 10:08:20 UTC 2024
...
Total Test time (real) =  74.09 sec
...
main:     load time =    99.97 ms
main:   sample time =    24.01 ms
main:  predict time =   683.29 ms / 10.68 ms per token
main:    total time =   819.71 ms
...
main:  predict time =   730.85 ms / 10.44 ms per token
main:    total time =   857.17 ms
...
main:     load time =   120.39 ms
main:   sample time =    23.97 ms
main:  predict time =   730.16 ms / 10.43 ms per token
main:    total time =   877.61 ms
...
main:     n_decoded =      504
main:     load time =   101.08 ms
main:   sample time =   178.23 ms
main:  predict time =  2995.98 ms
main:    total time =  3321.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x77fd956fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x77fd9557b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f20911ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x77fd956fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x77fd956ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555f20912ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x77fd9557b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f20911ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555f20913410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555f20912ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x77fd956fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555f20913d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555f20913410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555f209146d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x77fd956fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555f20913d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555f20914890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555f209146d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x77fd956ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555f20914a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555f20914890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    71.98 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1995.38 ms /     1 runs ( 1995.38 ms per run)
whisper_print_timings:   decode time =    13.44 ms /     2 runs (    6.72 ms per run)
whisper_print_timings:   batchd time =   327.87 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2516.19 ms
