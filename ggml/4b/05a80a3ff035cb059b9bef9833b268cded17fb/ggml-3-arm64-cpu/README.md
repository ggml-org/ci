...
- status:  SUCCESS ✅
- runtime: 3:09.22
- date:    Wed May 29 10:08:17 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/4b05a80a3ff035cb059b9bef9833b268cded17fb
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.24 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   33.34 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.09 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.52 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.64 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.20 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.18 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   17.43 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.92 sec
...
main:     load time =   153.41 ms
main:   sample time =    17.93 ms
main:  predict time =   919.12 ms / 14.36 ms per token
main:    total time =  1111.88 ms
...
main:     load time =   152.86 ms
main:   sample time =    18.12 ms
main:  predict time =  1000.65 ms / 14.29 ms per token
main:    total time =  1174.31 ms
...
main:     load time =   181.55 ms
main:   sample time =    18.16 ms
main:  predict time =  1061.88 ms / 15.17 ms per token
main:    total time =  1264.86 ms
...
main:     n_decoded =      504
main:     load time =   152.79 ms
main:   sample time =   129.75 ms
main:  predict time =  6666.51 ms
main:    total time =  7032.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe0858d77a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe0858d5fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8bcc699ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe0858d77a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe0858d77f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8bcc699bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe0858d5fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8bcc699ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8bcc699c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8bcc699bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe0858d77a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8bcc699cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8bcc699c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8bcc699d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe0858d77a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8bcc699cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8bcc699d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8bcc699d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe0858d77f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb8bcc699da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8bcc699d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.52 ms
whisper_print_timings:   sample time =    67.80 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4673.48 ms /     1 runs ( 4673.48 ms per run)
whisper_print_timings:   decode time =    14.52 ms /     2 runs (    7.26 ms per run)
whisper_print_timings:   batchd time =   724.77 ms /   125 runs (    5.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5619.37 ms
...
main:     load time =    90.32 ms
main:    total time = 40394.23 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.276000 sec.)
