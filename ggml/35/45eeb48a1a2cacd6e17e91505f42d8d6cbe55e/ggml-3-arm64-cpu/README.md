...
- status:  SUCCESS ✅
- runtime: 3:31.37
- date:    Mon Aug 28 11:48:05 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/3545eeb48a1a2cacd6e17e91505f42d8d6cbe55e
- author:  Cebtenzzre
```
...
Total Test time (real) =  12.93 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.42 sec
      Start  2: test-opt
 ...
 6/15 Test  #6: test-mul-mat2 ....................   Passed    1.77 sec
      Start  7: test0
 7/15 Test  #7: test0 ............................   Passed    0.01 sec
      Start  8: test1
...
main:     load time =   290.43 ms
main:   sample time =    17.55 ms
main:  predict time =   812.51 ms / 12.70 ms per token
main:    total time =  1143.62 ms
...
main:     load time =   171.27 ms
main:   sample time =    17.33 ms
main:  predict time =   879.12 ms / 12.56 ms per token
main:    total time =  1071.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8187a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff816fb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab154a2ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81879f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8187f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab154a3830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff816fb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab154a2ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab154a4140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab154a3830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81879f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab154a4a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab154a4140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab154a5360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8187a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab154a4a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab154a54d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab154a5360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8187f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab154a5640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab154a54d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 10157.91 ms
main:    sample time =   613.06 ms / 9.58 ms per token
main:      eval time = 43675.89 ms / 623.94 ms per token
main:     total time = 56833.68 ms
...
main:      load time =  4357.56 ms
main:    sample time =   606.11 ms / 9.47 ms per token
main:      eval time = 17401.75 ms / 248.60 ms per token
main:     total time = 23325.94 ms
