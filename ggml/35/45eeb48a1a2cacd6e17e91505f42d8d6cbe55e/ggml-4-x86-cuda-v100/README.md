...
- status:  SUCCESS ✅
- runtime: 4:53.55
- date:    Mon Aug 28 11:51:36 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.53 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.42 sec
      Start  2: test-opt
...
main:     load time =   251.67 ms
main:   sample time =    35.34 ms
main:  predict time =   552.94 ms / 8.64 ms per token
main:    total time =   860.03 ms
...
main:     load time =   198.55 ms
main:   sample time =    34.99 ms
main:  predict time =   580.44 ms / 8.29 ms per token
main:    total time =   818.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f35bd7b68a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f35bd637150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55be00934ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f35bd7b5f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f35bd7bb800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55be00935830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f35bd637150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55be00934ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55be00936140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55be00935830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f35bd7b5f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55be00936a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55be00936140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55be00937360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f35bd7b68a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55be00936a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55be009374d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55be00937360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f35bd7bb800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55be00937640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55be009374d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7078.20 ms
main:    sample time =   583.07 ms / 9.11 ms per token
main:      eval time = 25400.45 ms / 362.86 ms per token
main:     total time = 33957.81 ms
...
main:      load time =  1668.85 ms
main:    sample time =   593.57 ms / 9.27 ms per token
main:      eval time = 12274.57 ms / 175.35 ms per token
main:     total time = 15235.46 ms
