...
- status:  SUCCESS ✅
- runtime: 2:43.99
- date:    Mon Aug 28 11:53:17 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.69 sec
...
main:     load time =   212.55 ms
main:   sample time =    23.53 ms
main:  predict time =   444.54 ms / 6.95 ms per token
...
main:     load time =   136.62 ms
main:   sample time =    23.45 ms
main:  predict time =   457.28 ms / 6.53 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc61a67e8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc61a4ff150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d3abe9dab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc61a67df90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc61a683800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d3abe9e830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc61a4ff150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d3abe9dab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d3abe9f140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d3abe9e830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc61a67df90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d3abe9fa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d3abe9f140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d3abea0360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc61a67e8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d3abe9fa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d3abea04d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d3abea0360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc61a683800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d3abea0640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d3abea04d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 10301.17 ms
main:    sample time =   465.95 ms / 7.28 ms per token
main:      eval time = 20452.40 ms / 292.18 ms per token
main:     total time = 31915.04 ms
...
main:      load time =  4181.80 ms
main:    sample time =   465.39 ms / 7.27 ms per token
main:      eval time =  8073.44 ms / 115.33 ms per token
main:     total time = 13097.33 ms
