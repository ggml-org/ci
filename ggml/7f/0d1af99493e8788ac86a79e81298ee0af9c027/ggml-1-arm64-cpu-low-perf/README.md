...
- status:  SUCCESS ✅
- runtime: 2:40.28
- date:    Fri Dec  1 12:06:03 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.11 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.25 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.58 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed    1.72 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.88 sec
      Start  2: test-quantize-fns
 ...
 8/19 Test  #8: test2 ............................   Passed    8.66 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.54 sec
      Start 10: test-pool
10/19 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    0.25 sec
...
main:     load time =   190.49 ms
main:   sample time =    17.51 ms
main:  predict time =   854.76 ms / 13.36 ms per token
main:    total time =  1084.43 ms
...
main:     load time =   187.10 ms
main:   sample time =    17.27 ms
main:  predict time =   893.00 ms / 12.76 ms per token
main:    total time =  1100.11 ms
...
main:     n_decoded =      504
main:     load time =   158.16 ms
main:   sample time =   126.71 ms
main:  predict time =  6013.93 ms
main:    total time =  6379.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaa27a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa0fb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeb4d2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaa27a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaa27f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaeb4d3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa0fb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeb4d2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaeb4d4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaeb4d3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaa27a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaeb4d4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaeb4d4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaeb4d5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaa27a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaeb4d4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaeb4d56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaeb4d5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaa27f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaeb4d5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaeb4d56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.58 ms
whisper_print_timings:   sample time =    65.43 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4746.82 ms /     1 runs ( 4746.82 ms per run)
whisper_print_timings:   decode time =    15.37 ms /     2 runs (    7.69 ms per run)
whisper_print_timings:   batchd time =   737.76 ms /   125 runs (    5.90 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5693.34 ms
...
main:     load time =    91.18 ms
main:    total time = 39992.77 ms
embd_img
