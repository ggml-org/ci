...
- status:  SUCCESS ✅
- runtime: 4:52.11
- date:    Fri Dec  1 12:08:11 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.20 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.08 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    2.03 sec
...
main:     load time =   252.03 ms
main:   sample time =    17.19 ms
main:  predict time =   821.48 ms / 12.84 ms per token
main:    total time =  1112.47 ms
...
main:     load time =   181.48 ms
main:   sample time =    17.37 ms
main:  predict time =   892.04 ms / 12.74 ms per token
main:    total time =  1093.72 ms
...
main:   sample time =   127.90 ms
main:  predict time =  5843.28 ms
main:    total time =  6190.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0aba960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa093b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab17ac8b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0aba010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0abf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab17ac9940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa093b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab17ac8b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab17aca290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab17ac9940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0aba010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab17acabe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab17aca290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab17acb530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0aba960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab17acabe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab17acb6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab17acb530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0abf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab17acb890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab17acb6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   178.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.11 ms
whisper_print_timings:   sample time =    64.83 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4632.15 ms /     1 runs ( 4632.15 ms per run)
whisper_print_timings:   decode time =    15.07 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   711.33 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5618.58 ms
...
main:     load time =    77.99 ms
main:    total time = 39317.19 ms
embd_img
...
main:      load time = 11642.13 ms
main:    sample time =   531.83 ms / 8.31 ms per token
main:      eval time = 43466.04 ms / 620.94 ms per token
main:     total time = 58012.55 ms
...
main:      load time =  4370.10 ms
main:    sample time =   530.66 ms / 8.29 ms per token
main:      eval time = 17593.15 ms / 251.33 ms per token
main:     total time = 23461.87 ms
