...
- status:  SUCCESS ✅
- runtime: 3:09.66
- date:    Fri Dec  1 00:06:24 UTC 2023
...
main:  predict time =   433.33 ms / 6.77 ms per token
main:    total time =   650.54 ms
...
main:     load time =   134.07 ms
main:   sample time =    23.38 ms
main:  predict time =   445.93 ms / 6.37 ms per token
main:    total time =   605.39 ms
...
main:  predict time =  1434.39 ms
main:    total time =  1748.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe67a50a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe67a38b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556d645fcb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe67a50a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe67a50f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556d645fd940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe67a38b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556d645fcb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556d645fe290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556d645fd940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe67a50a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556d645febe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556d645fe290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556d645ff530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe67a50a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556d645febe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556d645ff6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556d645ff530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe67a50f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556d645ff890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556d645ff6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    53.63 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1135.71 ms /     1 runs ( 1135.71 ms per run)
whisper_print_timings:   decode time =     9.72 ms /     2 runs (    4.86 ms per run)
whisper_print_timings:   batchd time =   206.32 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1556.77 ms
...
main:     load time =    61.64 ms
main:    total time = 10381.65 ms
embd_img
...
main:      load time = 12260.79 ms
main:    sample time =   467.66 ms / 7.31 ms per token
main:      eval time = 20482.49 ms / 292.61 ms per token
main:     total time = 33882.46 ms
...
main:      load time =  1392.82 ms
main:    sample time =   493.48 ms / 7.71 ms per token
main:      eval time =  9051.91 ms / 129.31 ms per token
main:     total time = 11295.74 ms
