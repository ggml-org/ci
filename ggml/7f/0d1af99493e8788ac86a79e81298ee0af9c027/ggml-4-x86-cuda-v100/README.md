...
- status:  SUCCESS ✅
- runtime: 7:08.29
- date:    Fri Dec  1 00:10:33 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/7f0d1af99493e8788ac86a79e81298ee0af9c027
- author:  slaren
```
add metal impl
ggml-ci
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/19 Test  #4: test-mul-mat0 ....................   Passed    1.06 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    7.75 sec
      Start  9: test3
...
12/19 Test #12: test-rel-pos .....................   Passed    0.54 sec
...
19/19 Test #19: test-backend-ops .................   Passed    3.22 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.65 sec
      Start  2: test-opt
 ...
 8/20 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    7.77 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    1.01 sec
      Start 11: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed    1.18 sec
...
main:     load time =  1120.93 ms
main:   sample time =    36.70 ms
main:  predict time =   604.47 ms / 9.44 ms per token
main:    total time =  1786.64 ms
...
main:     load time =   475.71 ms
main:   sample time =    33.58 ms
main:  predict time =   572.17 ms / 8.17 ms per token
main:    total time =  1085.31 ms
...
main:     n_decoded =      504
main:     load time =   438.47 ms
main:   sample time =   232.21 ms
main:  predict time =  2214.72 ms
main:    total time =  2930.54 ms
...
main: loaded model in   282.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fac8a9b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fac8a837190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559a3e6acc90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fac8a9b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fac8a9bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559a3e6ada50                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fac8a837190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559a3e6acc90                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559a3e6ae3a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559a3e6ada50                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fac8a9b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559a3e6aecf0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559a3e6ae3a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559a3e6af640                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fac8a9b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559a3e6aecf0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559a3e6af7f0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559a3e6af640                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fac8a9bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559a3e6af9a0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559a3e6af7f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   949.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.73 ms
whisper_print_timings:   sample time =    74.22 ms /   131 runs (    0.57 ms per run)
whisper_print_timings:   encode time =   475.90 ms /     1 runs (  475.90 ms per run)
whisper_print_timings:   decode time =    15.73 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   309.38 ms /   125 runs (    2.48 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1848.73 ms
...
main:     load time =   396.56 ms
main:    total time =  7605.87 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.667000 sec.)
...
main:      load time =  8734.64 ms
main:    sample time =   503.99 ms / 7.87 ms per token
main:      eval time = 24305.08 ms / 347.22 ms per token
main:     total time = 34394.67 ms
...
main:      load time =  1976.90 ms
main:    sample time =   519.42 ms / 8.12 ms per token
main:      eval time = 12309.28 ms / 175.85 ms per token
main:     total time = 15494.98 ms
