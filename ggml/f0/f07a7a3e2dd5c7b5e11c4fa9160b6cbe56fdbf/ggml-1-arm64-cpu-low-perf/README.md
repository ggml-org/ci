...
- status:  SUCCESS ✅
- runtime: 1:43.10
- date:    Mon Aug  7 11:02:16 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/11 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/11 Test  #8: test2 ............................   Passed   16.88 sec
      Start  9: test3
...
main:     load time =   165.30 ms
main:   sample time =    17.35 ms
main:  predict time =   802.35 ms / 12.54 ms per token
main:    total time =  1053.54 ms
...
main: mem per token =  2015032 bytes
main:     load time =   169.06 ms
main:   sample time =    17.31 ms
main:  predict time =   879.15 ms / 12.56 ms per token
main:    total time =  1115.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7bea870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7a6b140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4037aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7be9f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7bef7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad4038810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7a6b140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4037aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad4039110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad4038810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7be9f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad4039a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad4039110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad403a310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7bea870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad4039a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad403a470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad403a310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7bef7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad403a5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad403a470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
```diff
--- /home/ggml/results/ggml/0c/07d717fcf52dc16645ab8c5f87e8739ff3c04f/ggml-1-arm64-cpu-low-perf/stdall	2023-08-07 11:00:14.600411619 +0000
+++ /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/stdall	2023-08-07 11:02:16.840409135 +0000
@@ -1,7 +1,7 @@
...
+rm: cannot remove '/home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/*.md': No such file or directory
...
++ tee /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_debug.log
...
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_debug-cmake.log
...
+user	0m0.359s
+sys	0m0.310s
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_debug-make.log
 + make -j
...
+user	0m34.334s
+sys	0m5.353s
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_release.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_release-cmake.log
...
+user	0m0.312s
+sys	0m0.370s
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_release-make.log
 + make -j
-[  1%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
-[  2%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
+[  1%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
...
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/ctest_release-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/gpt_2.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -464,15 +464,15 @@
...
-+ tee /home/ggml/results/ggml/0c/07d717fcf52dc16645ab8c5f87e8739ff3c04f/ggml-1-arm64-cpu-low-perf/mnist.log
 + cd /home/ggml/work/ggml
++ tee /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/mnist.log
 + cd build-ci-release
 + set -e
...
++ tee -a /home/ggml/results/ggml/f0/f07a7a3e2dd5c7b5e11c4fa9160b6cbe56fdbf/ggml-1-arm64-cpu-low-perf/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
