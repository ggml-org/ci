...
- status:  SUCCESS ✅
- runtime: 2:44.49
- date:    Mon Aug  7 11:07:59 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/11 Test  #1: test-grad0 .......................   Passed    2.64 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/12 Test  #1: test-grad0 .......................   Passed    2.55 sec
      Start  2: test-opt
 2/12 Test  #2: test-opt .........................   Passed    1.19 sec
      Start  3: test-quantize-fns
 3/12 Test  #3: test-quantize-fns ................   Passed    0.00 sec
      Start  4: test-quantize-perf
 4/12 Test  #4: test-quantize-perf ...............   Passed    0.00 sec
      Start  5: test-mul-mat0
 5/12 Test  #5: test-mul-mat0 ....................   Passed    0.52 sec
...
main:     load time =   133.02 ms
main:   sample time =    23.76 ms
main:  predict time =   433.03 ms / 6.77 ms per token
main:    total time =   630.05 ms
...
main: mem per token =  2015032 bytes
main:     load time =   131.66 ms
main:   sample time =    23.78 ms
main:  predict time =   445.71 ms / 6.37 ms per token
main:    total time =   637.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f20d62e3870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f20d6164140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562c74ea2aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f20d62e2f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f20d62e87c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562c74ea3810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f20d6164140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562c74ea2aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562c74ea4110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562c74ea3810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f20d62e2f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562c74ea4a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562c74ea4110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562c74ea5310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f20d62e3870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562c74ea4a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x562c74ea5470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562c74ea5310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f20d62e87c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x562c74ea55d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x562c74ea5470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12620.69 ms
main:    sample time =   461.36 ms / 7.21 ms per token
main:      eval time = 21612.14 ms / 308.74 ms per token
main:     total time = 35899.95 ms
...
main:      load time =  4347.83 ms
main:    sample time =   458.08 ms / 7.16 ms per token
main:      eval time =  8310.04 ms / 118.71 ms per token
main:     total time = 13533.68 ms
