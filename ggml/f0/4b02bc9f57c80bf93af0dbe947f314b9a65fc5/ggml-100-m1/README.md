...
- status:  SUCCESS ✅
- runtime: 90.46
- date:    Thu Oct 12 17:39:39 EEST 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    1.28 sec
 ...
 4/15 Test  #4: test-mul-mat0 ....................   Passed    0.40 sec
      Start  5: test-blas0
 5/15 Test  #5: test-blas0 .......................   Passed    0.20 sec
      Start  6: test-mul-mat2
 6/15 Test  #6: test-mul-mat2 ....................   Passed    8.87 sec
      Start  7: test0
...
Test project /Users/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/16 Test  #1: test-grad0 .......................   Passed    1.11 sec
      Start  2: test-opt
 ...
 5/16 Test  #5: test-mul-mat0 ....................   Passed    0.38 sec
      Start  6: test-blas0
...
15/16 Test #15: test-customop ....................   Passed    0.23 sec
      Start 16: test-xpos
...
main:     load time =    90.20 ms
main:   sample time =     8.92 ms
main:  predict time =   305.21 ms / 4.36 ms per token
...
main:     n_decoded =      504
main:     load time =   118.24 ms
main:   sample time =    65.90 ms
main:  predict time =   760.88 ms
main:    total time =   956.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1501878f0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x150008160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x14e00e960                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x150186fc0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x15018c870                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x14e00f700                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x150008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x14e00e960                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14e010030                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x14e00f700                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x150186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14e010960                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14e010030                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14e011290                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1501878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14e010960                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14e011420                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14e011290                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x15018c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x14e0115b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14e011420                           node_4
...
whisper_print_timings:     load time =   110.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.47 ms
whisper_print_timings:   sample time =    11.61 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   630.19 ms /     1 runs (  630.19 ms per run)
whisper_print_timings:   decode time =    63.38 ms /    27 runs (    2.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   836.99 ms
```
