...
- status:  SUCCESS ✅
- runtime: 3:49.59
- date:    Thu Oct 12 02:42:47 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.69 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.33 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    4.56 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.02 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    0.06 sec
      Start 10: test3
...
main:     load time =   161.12 ms
main:   sample time =    17.08 ms
main:  predict time =   799.92 ms / 12.50 ms per token
main:    total time =  1001.31 ms
...
main:     load time =   144.64 ms
main:   sample time =    16.69 ms
main:  predict time =   867.97 ms / 12.40 ms per token
main:    total time =  1033.24 ms
...
main:   sample time =   127.19 ms
main:  predict time =  5873.38 ms
main:    total time =  6228.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab6a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa9eb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab19d12ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab69fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab6f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab19d13870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa9eb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab19d12ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab19d141a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab19d13870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab69fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab19d14ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab19d141a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab19d15400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab6a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab19d14ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab19d15590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab19d15400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab6f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab19d15720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab19d15590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   205.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.44 ms
whisper_print_timings:   sample time =    20.93 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4604.30 ms /     1 runs ( 4604.30 ms per run)
whisper_print_timings:   decode time =   179.64 ms /    27 runs (    6.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5079.51 ms
```
### mpt
...
main:      load time =  5691.25 ms
main:    sample time =   521.42 ms / 8.15 ms per token
main:      eval time = 43606.61 ms / 622.95 ms per token
main:     total time = 52193.09 ms
...
main:      load time =  1500.13 ms
main:    sample time =   519.28 ms / 8.11 ms per token
main:      eval time = 17336.18 ms / 247.66 ms per token
main:     total time = 20322.74 ms
