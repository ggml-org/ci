...
- status:  SUCCESS ✅
- runtime: 1:34.61
- date:    Thu Oct 12 14:40:39 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.03 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.68 sec
      Start  9: test3
...
main:     load time =   106.75 ms
main:   sample time =    23.94 ms
main:  predict time =   609.87 ms / 9.53 ms per token
main:    total time =   754.18 ms
...
main:  predict time =   652.46 ms / 9.32 ms per token
main:    total time =   784.47 ms
...
main:   sample time =   178.45 ms
main:  predict time =  2506.13 ms
main:    total time =  2836.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f64932de900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f649315f170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557ae194dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f64932ddfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f64932e3880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557ae194e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f649315f170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557ae194dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557ae194f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557ae194e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f64932ddfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557ae194fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557ae194f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557ae1950400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f64932de900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557ae194fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557ae1950590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557ae1950400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f64932e3880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557ae1950720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557ae1950590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    82.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.38 ms
whisper_print_timings:   sample time =    16.46 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1969.05 ms /     1 runs ( 1969.05 ms per run)
whisper_print_timings:   decode time =   132.74 ms /    27 runs (    4.92 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2264.38 ms
```
