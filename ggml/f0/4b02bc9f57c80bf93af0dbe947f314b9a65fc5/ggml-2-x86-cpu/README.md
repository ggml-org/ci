...
- status:  SUCCESS ✅
- runtime: 2:50.18
- date:    Thu Oct 12 14:41:50 UTC 2023
...
main:  predict time =   492.26 ms / 7.69 ms per token
main:    total time =   677.35 ms
...
main:     n_decoded =      504
main:     load time =   112.74 ms
main:   sample time =   178.23 ms
main:  predict time =  1496.22 ms
main:    total time =  1821.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc1166c1900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc116542170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c8f97adad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc1166c0fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc1166c6880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c8f97ae870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc116542170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c8f97adad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c8f97af1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c8f97ae870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc1166c0fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c8f97afad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c8f97af1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c8f97b0400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc1166c1900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c8f97afad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c8f97b0590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c8f97b0400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc1166c6880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c8f97b0720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c8f97b0590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   152.74 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.27 ms
whisper_print_timings:   sample time =    16.59 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1185.39 ms /     1 runs ( 1185.39 ms per run)
whisper_print_timings:   decode time =   113.78 ms /    27 runs (    4.21 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1526.91 ms
```
### mpt
...
main:      load time =  5663.81 ms
main:    sample time =   463.00 ms / 7.23 ms per token
main:      eval time = 21912.13 ms / 313.03 ms per token
main:     total time = 28728.54 ms
...
main:      load time =  1294.84 ms
main:    sample time =   461.68 ms / 7.21 ms per token
main:      eval time =  9303.57 ms / 132.91 ms per token
main:     total time = 11465.13 ms
