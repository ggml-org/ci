...
- status:  SUCCESS ✅
- runtime: 3:20.46
- date:    Tue Aug 22 10:32:25 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.57 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.36 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.38 sec
      Start  2: test-opt
...
main:     load time =   176.10 ms
main:   sample time =    17.77 ms
main:  predict time =   805.24 ms / 12.58 ms per token
main:    total time =  1067.37 ms
...
main: mem per token =  2017572 bytes
main:     load time =   170.85 ms
main:   sample time =    17.52 ms
main:  predict time =   874.14 ms / 12.49 ms per token
main:    total time =  1111.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff97f1a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97d9b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad556eab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff97f19f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff97f1f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad556f830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97d9b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad556eab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad5570140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad556f830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff97f19f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad5570a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad5570140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad5571360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff97f1a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad5570a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad55714d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad5571360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff97f1f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad5571640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad55714d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5463.61 ms
main:    sample time =   608.67 ms / 9.51 ms per token
main:      eval time = 44140.89 ms / 630.58 ms per token
main:     total time = 52600.24 ms
...
main:      load time =  1716.60 ms
main:    sample time =   616.46 ms / 9.63 ms per token
main:      eval time = 17401.36 ms / 248.59 ms per token
main:     total time = 20705.21 ms
