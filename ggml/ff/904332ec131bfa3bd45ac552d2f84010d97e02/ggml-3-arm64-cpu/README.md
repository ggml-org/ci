...
- status:  SUCCESS ✅
- runtime: 4:47.47
- date:    Fri Nov  3 08:13:41 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ff904332ec131bfa3bd45ac552d2f84010d97e02
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.07 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.97 sec
...
main:     load time =   182.45 ms
main:   sample time =    17.32 ms
main:  predict time =   809.84 ms / 12.65 ms per token
main:    total time =  1031.79 ms
...
main:  predict time =   876.29 ms / 12.52 ms per token
main:    total time =  1070.01 ms
...
main:     n_decoded =      504
main:     load time =   139.31 ms
main:   sample time =   127.03 ms
main:  predict time =  5825.48 ms
main:    total time =  6172.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5a9a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa591b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad8fd2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5a9a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5a9f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad8fd3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa591b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad8fd2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad8fd4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad8fd3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa5a9a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad8fd4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad8fd4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad8fd5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa5a9a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad8fd4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad8fd56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad8fd5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa5a9f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad8fd5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad8fd56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   213.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.61 ms
whisper_print_timings:   sample time =    20.95 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4607.78 ms /     1 runs ( 4607.78 ms per run)
whisper_print_timings:   decode time =   173.89 ms /    27 runs (    6.44 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5076.32 ms
...
main:     load time =    83.46 ms
main:    total time = 39261.02 ms
embd_img
...
main:      load time = 11999.89 ms
main:    sample time =   531.38 ms / 8.30 ms per token
main:      eval time = 43399.07 ms / 619.99 ms per token
main:     total time = 58299.70 ms
...
main:      load time =  4362.68 ms
main:    sample time =   534.17 ms / 8.35 ms per token
main:      eval time = 17426.81 ms / 248.95 ms per token
main:     total time = 23271.38 ms
