...
- status:  SUCCESS ✅
- runtime: 5:50.67
- date:    Fri Nov  3 08:34:14 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.26 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    5.98 sec
      Start  2: test-opt
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.31 sec
      Start 10: test3
...
main:     load time =   969.50 ms
main:   sample time =    35.95 ms
main:  predict time =   612.02 ms / 9.56 ms per token
...
main:  predict time =   594.22 ms / 8.49 ms per token
main:    total time =   823.64 ms
...
main:     n_decoded =      504
main:     load time =   161.56 ms
main:   sample time =   233.24 ms
main:  predict time =  2299.61 ms
main:    total time =  2739.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f181e6fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f181e57b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5572b8d7bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f181e6fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f181e6ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5572b8d7c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f181e57b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5572b8d7bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5572b8d7d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5572b8d7c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f181e6fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5572b8d7dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5572b8d7d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5572b8d7e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f181e6fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5572b8d7dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5572b8d7e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5572b8d7e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f181e6ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5572b8d7e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5572b8d7e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   712.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.69 ms
whisper_print_timings:   sample time =    19.96 ms /    27 runs (    0.74 ms per run)
whisper_print_timings:   encode time =  1867.05 ms /     1 runs ( 1867.05 ms per run)
whisper_print_timings:   decode time =   130.40 ms /    27 runs (    4.83 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2801.06 ms
...
main:      load time =  7548.02 ms
main:    sample time =   574.77 ms / 8.98 ms per token
main:      eval time = 25805.92 ms / 368.66 ms per token
main:     total time = 34829.12 ms
...
main:      load time =  1773.42 ms
main:    sample time =   586.86 ms / 9.17 ms per token
main:      eval time = 12846.64 ms / 183.52 ms per token
main:     total time = 15851.57 ms
