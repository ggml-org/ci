...
- status:  SUCCESS ✅
- runtime: 2:34.23
- date:    Fri Nov  3 08:10:59 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.56 sec
      Start  9: test3
...
main:     load time =   186.00 ms
main:   sample time =    17.75 ms
main:  predict time =   833.02 ms / 13.02 ms per token
main:    total time =  1058.71 ms
...
main:     load time =   192.85 ms
main:   sample time =    17.71 ms
main:  predict time =   896.91 ms / 12.81 ms per token
main:    total time =  1110.41 ms
...
main:   sample time =   132.14 ms
main:  predict time =  5941.29 ms
main:    total time =  6343.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffad0ea960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffacf6b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad87dab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffad0ea010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffad0ef900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad87db940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffacf6b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad87dab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad87dc290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad87db940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffad0ea010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad87dcbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad87dc290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad87dd530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffad0ea960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad87dcbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad87dd6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad87dd530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffad0ef900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad87dd890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad87dd6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.68 ms
whisper_print_timings:   sample time =    20.93 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4718.95 ms /     1 runs ( 4718.95 ms per run)
whisper_print_timings:   decode time =   176.70 ms /    27 runs (    6.54 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5094.90 ms
...
main:     load time =    89.80 ms
main:    total time = 40083.62 ms
embd_img
