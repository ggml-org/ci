...
- status:  SUCCESS ✅
- runtime: 4:02.45
- date:    Tue May 28 11:45:24 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ff1c61c3b98e516f9b5502d3470eb53c7f7a5989
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.28 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.89 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.36 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.55 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   19.84 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.78 sec
      Start  4: test-mul-mat0
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.38 sec
      Start  9: test3
...
Total Test time (real) =  52.51 sec
...
main:     load time =   140.18 ms
main:   sample time =    16.90 ms
main:  predict time =   939.21 ms / 14.68 ms per token
main:    total time =  1118.19 ms
...
main:  predict time =  1025.74 ms / 14.65 ms per token
main:    total time =  1184.21 ms
...
main:     load time =   168.02 ms
main:   sample time =    16.90 ms
main:  predict time =  1013.29 ms / 14.48 ms per token
main:    total time =  1201.42 ms
...
main:     n_decoded =      504
main:     load time =   143.08 ms
main:   sample time =   128.40 ms
main:  predict time =  6533.89 ms
main:    total time =  6887.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfe019b72a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfe019b5ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc25148ab9ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfe019b72a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfe019b72f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc25148abaab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfe019b5ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc25148ab9ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc25148abb410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc25148abaab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfe019b72a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc25148abbd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc25148abb410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc25148abc6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfe019b72a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc25148abbd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc25148abc890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc25148abc6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfe019b72f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc25148abca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc25148abc890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    98.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    65.41 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4650.33 ms /     1 runs ( 4650.33 ms per run)
whisper_print_timings:   decode time =    14.85 ms /     2 runs (    7.42 ms per run)
whisper_print_timings:   batchd time =   724.79 ms /   125 runs (    5.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5584.62 ms
...
main:     load time =    92.04 ms
main:    total time = 40285.14 ms
embd_img
