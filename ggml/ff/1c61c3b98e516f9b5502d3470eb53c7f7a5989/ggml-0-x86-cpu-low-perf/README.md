...
- status:  SUCCESS ✅
- runtime: 3:24.63
- date:    Tue May 28 11:44:48 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.01 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   29.83 sec
 ...
 8/22 Test  #8: test2 ............................   Passed   23.89 sec
      Start  9: test3
 9/22 Test  #9: test3 ............................   Passed    1.78 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.94 sec
      Start  2: test-quantize-fns
...
main:  predict time =   697.33 ms / 10.90 ms per token
main:    total time =   837.07 ms
...
main:     load time =   101.87 ms
main:   sample time =    24.06 ms
main:  predict time =   730.56 ms / 10.44 ms per token
main:    total time =   858.62 ms
...
main:     load time =   123.59 ms
main:   sample time =    23.81 ms
main:  predict time =   736.16 ms / 10.52 ms per token
main:    total time =   886.63 ms
...
main:     n_decoded =      504
main:     load time =   100.16 ms
main:   sample time =   179.71 ms
main:  predict time =  2979.55 ms
main:    total time =  3304.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7c0abb8fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7c0abb77b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5a4ade94ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7c0abb8fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7c0abb8ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5a4ade94bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7c0abb77b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5a4ade94ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5a4ade94c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5a4ade94bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7c0abb8fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5a4ade94cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5a4ade94c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5a4ade94d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7c0abb8fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5a4ade94cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5a4ade94d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5a4ade94d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7c0abb8ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5a4ade94da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5a4ade94d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.99 ms
whisper_print_timings:   sample time =    72.05 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1996.79 ms /     1 runs ( 1996.79 ms per run)
whisper_print_timings:   decode time =    13.70 ms /     2 runs (    6.85 ms per run)
whisper_print_timings:   batchd time =   327.76 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2518.76 ms
...
main:     load time =    69.64 ms
main:    total time = 18740.66 ms
embd_img
