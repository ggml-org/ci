...
- status:  SUCCESS ✅
- runtime: 3:05.41
- date:    Tue May 28 11:44:22 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.23 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.99 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.10 sec
      Start  2: test-opt
...
main:  predict time =   930.97 ms / 14.55 ms per token
main:    total time =  1114.94 ms
...
main:     load time =   145.57 ms
main:   sample time =    16.91 ms
main:  predict time =   982.15 ms / 14.03 ms per token
...
main:     load time =   173.63 ms
main:   sample time =    16.66 ms
main:  predict time =   995.98 ms / 14.23 ms per token
main:    total time =  1189.39 ms
...
main:  predict time =  6472.42 ms
main:    total time =  6828.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xef135624a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xef13560cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xab23b6722ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xef135624a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xef135624f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xab23b6723ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xef13560cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xab23b6722ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xab23b6724410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xab23b6723ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xef135624a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xab23b6724d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xab23b6724410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xab23b67256d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xef135624a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xab23b6724d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xab23b6725890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xab23b67256d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xef135624f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xab23b6725a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xab23b6725890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.81 ms
whisper_print_timings:   sample time =    65.75 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4660.84 ms /     1 runs ( 4660.84 ms per run)
whisper_print_timings:   decode time =    14.17 ms /     2 runs (    7.09 ms per run)
whisper_print_timings:   batchd time =   718.11 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5591.27 ms
...
main:     load time =    85.92 ms
main:    total time = 40109.39 ms
embd_img
