...
- status:  SUCCESS ✅
- runtime: 10:35.75
- date:    Tue May 28 11:51:57 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   36.00 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.81 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.04 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   20.41 sec
      Start  9: test3
...
22/22 Test #22: test-backend-ops .................   Passed  160.20 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 241.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/23 Test  #8: test1 ............................   Passed    0.04 sec
      Start  9: test2
 9/23 Test  #9: test2 ............................   Passed   20.24 sec
      Start 10: test3
...
23/23 Test #23: test-backend-ops .................   Passed   41.74 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) = 100.64 sec
...
main:  predict time =   652.55 ms / 10.20 ms per token
main:    total time =   861.14 ms
...
main:  predict time =   678.19 ms / 9.69 ms per token
main:    total time =   872.31 ms
...
main:  predict time =   692.36 ms / 9.89 ms per token
main:    total time =   914.08 ms
...
main:  predict time =  2877.00 ms
main:    total time =  3305.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb17e6fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb17e57b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562a45d8ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb17e6fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb17e6ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562a45d8b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb17e57b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562a45d8ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562a45d8c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562a45d8b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb17e6fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562a45d8cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562a45d8c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562a45d8d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb17e6fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562a45d8cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562a45d8d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562a45d8d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb17e6ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562a45d8d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562a45d8d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   499.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.46 ms
whisper_print_timings:   sample time =    64.33 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =    47.83 ms /     1 runs (   47.83 ms per run)
whisper_print_timings:   decode time =    11.35 ms /     2 runs (    5.67 ms per run)
whisper_print_timings:   batchd time =    77.74 ms /   125 runs (    0.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   728.68 ms
