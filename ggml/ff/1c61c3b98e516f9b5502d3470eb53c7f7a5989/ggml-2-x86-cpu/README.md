...
- status:  SUCCESS ✅
- runtime: 2:10.52
- date:    Tue May 28 11:43:30 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.85 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   29.80 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.81 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.51 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    6.60 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    1.82 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    1.64 sec
...
main:     load time =   106.13 ms
main:   sample time =    24.02 ms
main:  predict time =   540.00 ms / 8.44 ms per token
main:    total time =   682.50 ms
...
main:  predict time =   550.64 ms / 7.87 ms per token
main:    total time =   684.10 ms
...
main:  predict time =   569.54 ms / 8.14 ms per token
main:    total time =   725.20 ms
...
main:     n_decoded =      504
main:     load time =   108.26 ms
main:   sample time =   178.62 ms
main:  predict time =  1859.85 ms
main:    total time =  2180.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7263d92fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7263d917b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x606a0d598ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7263d92fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7263d92ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x606a0d599ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7263d917b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x606a0d598ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x606a0d59a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x606a0d599ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7263d92fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x606a0d59ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x606a0d59a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x606a0d59b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7263d92fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x606a0d59ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x606a0d59b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x606a0d59b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7263d92ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x606a0d59ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x606a0d59b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.23 ms
whisper_print_timings:   sample time =    56.85 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1177.83 ms /     1 runs ( 1177.83 ms per run)
whisper_print_timings:   decode time =    11.80 ms /     2 runs (    5.90 ms per run)
whisper_print_timings:   batchd time =   229.25 ms /   125 runs (    1.83 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1578.66 ms
...
main:     load time =    69.02 ms
main:    total time = 11163.43 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.487000 sec.)
