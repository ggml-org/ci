...
- status:  SUCCESS ✅
- runtime: 5:42.57
- date:    Fri Dec 22 09:30:13 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/caff3db90a57c098f0dc7efa9f738453a4e83525
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.28 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.36 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   34.21 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.09 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    9.93 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  18.57 sec
...
main:     load time =   193.34 ms
main:   sample time =    16.91 ms
main:  predict time =   809.44 ms / 12.65 ms per token
main:    total time =  1041.72 ms
...
main:     load time =   181.52 ms
main:   sample time =    16.75 ms
main:  predict time =   879.01 ms / 12.56 ms per token
main:    total time =  1080.19 ms
...
main:     n_decoded =      504
main:     load time =   154.17 ms
main:   sample time =   128.30 ms
main:  predict time =  5878.02 ms
main:    total time =  6241.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83c8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83b0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaade385b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83c8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83c8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaade386960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83b0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaade385b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaade3872c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaade386960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83c8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaade387c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaade3872c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaade388580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83c8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaade387c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaade388740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaade388580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83c8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaade388900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaade388740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   189.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.33 ms
whisper_print_timings:   sample time =    65.49 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4658.57 ms /     1 runs ( 4658.57 ms per run)
whisper_print_timings:   decode time =    15.63 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   707.93 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5655.14 ms
...
main:     load time =    82.00 ms
main:    total time = 39552.64 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.233000 sec.)
...
main:      load time = 13280.86 ms
main:    sample time =   519.83 ms / 8.12 ms per token
main:      eval time = 43527.37 ms / 621.82 ms per token
main:     total time = 59701.33 ms
...
main:      load time =  4354.29 ms
main:    sample time =   517.78 ms / 8.09 ms per token
main:      eval time = 17789.93 ms / 254.14 ms per token
main:     total time = 23654.02 ms
