...
- status:  SUCCESS ✅
- runtime: 3:53.15
- date:    Fri Dec 22 09:28:25 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.48 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.45 sec
...
main:     load time =   180.89 ms
main:   sample time =    23.45 ms
main:  predict time =   444.50 ms / 6.95 ms per token
main:    total time =   661.68 ms
...
main:  predict time =   442.27 ms / 6.32 ms per token
main:    total time =   592.77 ms
...
main:  predict time =  1459.28 ms
main:    total time =  1770.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f045c0a0990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f045bf211a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d2210bab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f045c0a0030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f045c0a5940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d2210bb960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f045bf211a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d2210bab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d2210bc2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d2210bb960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f045c0a0030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d2210bcc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d2210bc2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d2210bd580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f045c0a0990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d2210bcc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d2210bd740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d2210bd580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f045c0a5940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d2210bd900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d2210bd740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.62 ms
whisper_print_timings:   sample time =    55.78 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1157.95 ms /     1 runs ( 1157.95 ms per run)
whisper_print_timings:   decode time =     9.90 ms /     2 runs (    4.95 ms per run)
whisper_print_timings:   batchd time =   209.09 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1574.91 ms
...
main:      load time = 12582.88 ms
main:    sample time =   467.52 ms / 7.31 ms per token
main:      eval time = 20462.96 ms / 292.33 ms per token
main:     total time = 34181.38 ms
...
main:      load time =  4362.16 ms
main:    sample time =   466.43 ms / 7.29 ms per token
main:      eval time =  8406.74 ms / 120.10 ms per token
main:     total time = 14028.75 ms
