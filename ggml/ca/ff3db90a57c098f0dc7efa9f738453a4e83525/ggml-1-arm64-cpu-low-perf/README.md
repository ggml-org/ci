...
- status:  SUCCESS ✅
- runtime: 3:35.74
- date:    Fri Dec 22 09:28:01 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.95 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.35 sec
      Start  6: test0
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.92 sec
...
main:     load time =   200.16 ms
main:   sample time =    18.16 ms
main:  predict time =   912.05 ms / 13.03 ms per token
main:    total time =  1133.42 ms
...
main:     n_decoded =      504
main:     load time =   164.71 ms
main:   sample time =   131.04 ms
main:  predict time =  6055.45 ms
main:    total time =  6433.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8b4aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8b32b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae21c1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8b4aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8b4af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae21c2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8b32b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae21c1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae21c32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae21c2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8b4aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae21c3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae21c32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae21c4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8b4aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae21c3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae21c4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae21c4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8b4af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae21c4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae21c4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.69 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    67.11 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4783.59 ms /     1 runs ( 4783.59 ms per run)
whisper_print_timings:   decode time =    16.24 ms /     2 runs (    8.12 ms per run)
whisper_print_timings:   batchd time =   720.79 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5720.24 ms
...
main:     load time =   100.66 ms
main:    total time = 40475.61 ms
embd_img
