...
- status:  SUCCESS ✅
- runtime: 3:34.53
- date:    Fri Sep  8 13:25:12 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ca21b435983c77cc4c008d7fd145151e6cb3b0cd
- author:  YavorGIvanov
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.00 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.95 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.67 sec
...
main:     load time =   258.41 ms
main:   sample time =    17.73 ms
main:  predict time =   809.29 ms / 12.65 ms per token
main:    total time =  1108.22 ms
...
main:     load time =   165.01 ms
main:   sample time =    17.18 ms
main:  predict time =   873.66 ms / 12.48 ms per token
main:    total time =  1059.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbddda8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdc5b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafef6fac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbddd9fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdddf840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafef70850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdc5b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafef6fac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafef71170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafef70850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbddd9fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafef71a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafef71170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafef723b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbddda8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafef71a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafef72530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafef723b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdddf840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafef726b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafef72530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5850.12 ms
main:    sample time =   627.43 ms / 9.80 ms per token
main:      eval time = 43715.43 ms / 624.51 ms per token
main:     total time = 52570.10 ms
...
main:      load time =  1541.39 ms
main:    sample time =   619.72 ms / 9.68 ms per token
main:      eval time = 17301.81 ms / 247.17 ms per token
main:     total time = 20419.61 ms
