...
- status:  SUCCESS ✅
- runtime: 2:43.46
- date:    Fri Sep  8 13:24:16 UTC 2023
...
main:  predict time =   434.14 ms / 6.78 ms per token
...
main:     load time =   139.70 ms
main:   sample time =    23.68 ms
main:  predict time =   452.25 ms / 6.46 ms per token
main:    total time =   618.43 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbfb6de28d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbfb6c63160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560ad035fac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbfb6de1fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbfb6de7840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560ad0360850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbfb6c63160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560ad035fac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560ad0361170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560ad0360850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbfb6de1fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560ad0361a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560ad0361170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560ad03623b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbfb6de28d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560ad0361a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560ad0362530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560ad03623b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbfb6de7840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560ad03626b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560ad0362530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  8669.47 ms
main:    sample time =   472.87 ms / 7.39 ms per token
main:      eval time = 20213.97 ms / 288.77 ms per token
main:     total time = 30049.78 ms
...
main:      load time =  3523.73 ms
main:    sample time =   468.51 ms / 7.32 ms per token
main:      eval time =  8211.76 ms / 117.31 ms per token
main:     total time = 12577.90 ms
