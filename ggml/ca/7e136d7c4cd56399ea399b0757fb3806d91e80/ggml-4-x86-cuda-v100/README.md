...
- status:  SUCCESS ✅
- runtime: 11:46.34
- date:    Fri Jan 26 12:47:34 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  219.89 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 252.49 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    6.83 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.72 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    0.56 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.69 sec
...
21/21 Test #21: test-backend-ops .................   Passed   47.06 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  78.61 sec
...
main:     load time =   922.57 ms
main:   sample time =    34.22 ms
main:  predict time =   596.59 ms / 9.32 ms per token
main:    total time =  1577.45 ms
...
main:     load time =   580.22 ms
main:   sample time =    34.42 ms
main:  predict time =   653.54 ms / 9.34 ms per token
main:    total time =  1272.75 ms
...
main:     n_decoded =      504
main:     load time =   536.07 ms
main:   sample time =   245.61 ms
main:  predict time =  2329.68 ms
main:    total time =  3155.12 ms
...
main: loaded model in   411.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f665a7b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f665a6371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56454f032c00                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f665a7b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f665a7bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56454f0339d0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f665a6371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56454f032c00                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56454f034330                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56454f0339d0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f665a7b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56454f034c90                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56454f034330                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56454f0355f0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f665a7b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56454f034c90                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56454f0357b0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56454f0355f0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f665a7bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56454f035970                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56454f0357b0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   828.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    25.81 ms
whisper_print_timings:   sample time =    66.25 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    23.46 ms /     1 runs (   23.46 ms per run)
whisper_print_timings:   decode time =    22.20 ms /     2 runs (   11.10 ms per run)
whisper_print_timings:   batchd time =    81.56 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1056.85 ms
...
main:     load time =   548.07 ms
main:    total time =  8003.94 ms
embd_img
...
main:      load time =  8099.47 ms
main:    sample time =   546.94 ms / 8.55 ms per token
main:      eval time = 25815.92 ms / 368.80 ms per token
main:     total time = 35355.17 ms
...
main:      load time =  2629.14 ms
main:    sample time =   539.30 ms / 8.43 ms per token
main:      eval time = 12780.84 ms / 182.58 ms per token
main:     total time = 16656.54 ms
