...
- status:  SUCCESS ✅
- runtime: 5:28.99
- date:    Fri Jan 26 12:38:05 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.54 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  148.94 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 171.46 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.56 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   23.81 sec
...
main:  predict time =   976.55 ms / 15.26 ms per token
main:    total time =  1205.74 ms
...
main:  predict time =  6144.80 ms
main:    total time =  6519.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ee8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ed0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf2ac4b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ee8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ee8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf2ac5960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ed0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf2ac4b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf2ac62c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf2ac5960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ee8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf2ac6c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf2ac62c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf2ac7580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ee8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf2ac6c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf2ac7740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf2ac7580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ee8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf2ac7900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf2ac7740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.88 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.69 ms
whisper_print_timings:   sample time =    65.74 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4746.65 ms /     1 runs ( 4746.65 ms per run)
whisper_print_timings:   decode time =    16.09 ms /     2 runs (    8.04 ms per run)
whisper_print_timings:   batchd time =   709.76 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5668.02 ms
