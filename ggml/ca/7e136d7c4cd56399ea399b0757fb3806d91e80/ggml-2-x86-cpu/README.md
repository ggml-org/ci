...
- status:  SUCCESS ✅
- runtime: 6:15.12
- date:    Fri Jan 26 12:55:30 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    4.26 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    3.36 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  111.18 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 129.63 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.17 sec
...
main:     load time =   185.23 ms
main:   sample time =    23.48 ms
main:  predict time =   449.25 ms / 7.02 ms per token
main:    total time =   671.17 ms
...
main:     load time =   132.51 ms
main:   sample time =    23.49 ms
main:  predict time =   466.75 ms / 6.67 ms per token
main:    total time =   625.13 ms
...
main:  predict time =  1512.01 ms
main:    total time =  1827.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f01e8b82990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f01e8a031a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b687a8b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f01e8b82030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f01e8b87940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b687a9960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f01e8a031a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b687a8b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b687aa2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b687a9960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f01e8b82030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b687aac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b687aa2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b687ab580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f01e8b82990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b687aac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b687ab740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b687ab580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f01e8b87940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558b687ab900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b687ab740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.66 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.86 ms
whisper_print_timings:   sample time =    55.68 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1159.01 ms /     1 runs ( 1159.01 ms per run)
whisper_print_timings:   decode time =     9.22 ms /     2 runs (    4.61 ms per run)
whisper_print_timings:   batchd time =   206.95 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1575.44 ms
...
main:     load time =    60.61 ms
main:    total time = 10630.04 ms
embd_img
...
main:      load time = 12044.65 ms
main:    sample time =   467.35 ms / 7.30 ms per token
main:      eval time = 20483.07 ms / 292.62 ms per token
main:     total time = 33656.67 ms
...
main:      load time =  4391.32 ms
main:    sample time =   463.04 ms / 7.23 ms per token
main:      eval time =  8185.50 ms / 116.94 ms per token
main:     total time = 13409.24 ms
