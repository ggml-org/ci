...
- status:  SUCCESS ✅
- runtime: 6:18.18
- date:    Mon Jan 22 12:10:09 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/20 Test  #4: test-mul-mat0 ....................   Passed   10.26 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.33 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  110.64 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 131.59 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.38 sec
...
main:     load time =   192.47 ms
main:   sample time =    23.49 ms
main:  predict time =   445.72 ms / 6.96 ms per token
main:    total time =   674.56 ms
...
main:  predict time =   481.08 ms / 6.87 ms per token
...
main:  predict time =  1513.22 ms
main:    total time =  1830.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff7bec27990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff7beaa81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f574bf3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff7bec27030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff7bec2c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f574bf4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff7beaa81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f574bf3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f574bf52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f574bf4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff7bec27030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f574bf5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f574bf52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f574bf6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff7bec27990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f574bf5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f574bf6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f574bf6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff7bec2c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f574bf6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f574bf6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   121.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.96 ms
whisper_print_timings:   sample time =    54.58 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1167.38 ms /     1 runs ( 1167.38 ms per run)
whisper_print_timings:   decode time =     9.26 ms /     2 runs (    4.63 ms per run)
whisper_print_timings:   batchd time =   205.17 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1576.90 ms
...
main:     load time =    60.16 ms
main:    total time = 10642.63 ms
embd_img
...
main:      load time = 10454.75 ms
main:    sample time =   469.34 ms / 7.33 ms per token
main:      eval time = 20659.02 ms / 295.13 ms per token
main:     total time = 32269.81 ms
...
main:      load time =  4368.50 ms
main:    sample time =   465.74 ms / 7.28 ms per token
main:      eval time =  9027.05 ms / 128.96 ms per token
main:     total time = 14217.22 ms
