...
- status:  SUCCESS ✅
- runtime: 8:11.14
- date:    Mon Jan 22 12:15:43 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ca7e136d7c4cd56399ea399b0757fb3806d91e80
- author:  Jack Vial
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/20 Test  #4: test-mul-mat0 ....................   Passed    8.51 sec
      Start  5: test-mul-mat2
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.55 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed  125.15 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.98 sec
...
main:     load time =   283.72 ms
main:   sample time =    16.94 ms
main:  predict time =   848.50 ms / 13.26 ms per token
main:    total time =  1171.43 ms
...
main:     load time =   194.50 ms
main:   sample time =    16.96 ms
main:  predict time =   925.56 ms / 13.22 ms per token
main:    total time =  1140.11 ms
...
main:     n_decoded =      504
main:     load time =   156.49 ms
main:   sample time =   126.83 ms
main:  predict time =  5997.33 ms
main:    total time =  6362.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa112a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0fab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab5d24b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa112a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa112f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab5d25960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa0fab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab5d24b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab5d262c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab5d25960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa112a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab5d26c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab5d262c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab5d27580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa112a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab5d26c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab5d27740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab5d27580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa112f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab5d27900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab5d27740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   188.41 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    65.50 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4622.29 ms /     1 runs ( 4622.29 ms per run)
whisper_print_timings:   decode time =    15.80 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   708.20 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5618.67 ms
...
main:     load time =    84.66 ms
main:    total time = 39695.41 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.249000 sec.)
...
main:      load time = 12018.00 ms
main:    sample time =   518.64 ms / 8.10 ms per token
main:      eval time = 43735.38 ms / 624.79 ms per token
main:     total time = 58644.60 ms
...
main:      load time =  4316.79 ms
main:    sample time =   518.30 ms / 8.10 ms per token
main:      eval time = 17543.73 ms / 250.62 ms per token
main:     total time = 23335.93 ms
