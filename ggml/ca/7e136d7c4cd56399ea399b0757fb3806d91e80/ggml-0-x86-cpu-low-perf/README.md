...
- status:  SUCCESS ✅
- runtime: 4:43.73
- date:    Mon Jan 22 12:08:37 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  115.61 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 138.50 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.12 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.33 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.59 sec
...
main:     load time =   129.10 ms
main:   sample time =    23.54 ms
main:  predict time =   629.49 ms / 9.84 ms per token
...
main:     load time =   128.07 ms
main:   sample time =    23.53 ms
main:  predict time =   647.40 ms / 9.25 ms per token
main:    total time =   801.49 ms
...
main:  predict time =  2496.34 ms
main:    total time =  2823.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe7af9ad990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7af82e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a059e73b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe7af9ad030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe7af9b2940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a059e74960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7af82e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a059e73b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a059e752c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a059e74960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe7af9ad030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a059e75c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a059e752c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a059e76580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe7af9ad990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a059e75c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a059e76740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a059e76580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe7af9b2940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a059e76900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a059e76740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.08 ms
whisper_print_timings:   sample time =    72.75 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1992.76 ms /     1 runs ( 1992.76 ms per run)
whisper_print_timings:   decode time =    12.49 ms /     2 runs (    6.25 ms per run)
whisper_print_timings:   batchd time =   322.76 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.59 ms
...
main:     load time =    66.03 ms
main:    total time = 18965.37 ms
embd_img
