...
- status:  SUCCESS ✅
- runtime: 4:20.68
- date:    Fri Jan 26 12:33:54 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.54 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  116.05 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 138.84 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.51 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.62 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.00 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.70 sec
...
main:     load time =   131.23 ms
main:   sample time =    23.57 ms
main:  predict time =   665.30 ms / 10.40 ms per token
main:    total time =   833.16 ms
...
main:  predict time =   681.66 ms / 9.74 ms per token
main:    total time =   836.88 ms
...
main:     n_decoded =      504
main:     load time =   108.81 ms
main:   sample time =   178.12 ms
main:  predict time =  2516.87 ms
main:    total time =  2849.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fea94b7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fea949fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e333a1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fea94b7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fea94b7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560e333a2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fea949fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e333a1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560e333a32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560e333a2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fea94b7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560e333a3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560e333a32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560e333a4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fea94b7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560e333a3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560e333a4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560e333a4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fea94b7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560e333a4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560e333a4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.42 ms
whisper_print_timings:   sample time =    72.41 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2011.16 ms /     1 runs ( 2011.16 ms per run)
whisper_print_timings:   decode time =    12.87 ms /     2 runs (    6.43 ms per run)
whisper_print_timings:   batchd time =   322.83 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2522.43 ms
...
main:     load time =    69.92 ms
main:    total time = 18942.09 ms
embd_img
