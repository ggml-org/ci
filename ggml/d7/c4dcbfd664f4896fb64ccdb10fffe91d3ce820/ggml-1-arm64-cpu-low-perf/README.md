...
- status:  SUCCESS ✅
- runtime: 6:10.44
- date:    Mon Jan 29 09:43:09 AM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/d7c4dcbfd664f4896fb64ccdb10fffe91d3ce820
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.35 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  159.15 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 196.75 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.83 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.46 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.61 sec
...
main:     load time =   193.82 ms
main:   sample time =    17.30 ms
main:  predict time =  1016.41 ms / 15.88 ms per token
...
main:     load time =   188.93 ms
main:   sample time =    17.13 ms
main:  predict time =   946.80 ms / 13.53 ms per token
main:    total time =  1155.97 ms
...
main:     n_decoded =      504
main:     load time =   163.92 ms
main:   sample time =   128.50 ms
main:  predict time =  6175.02 ms
main:    total time =  6550.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff92e8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff92d0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab800eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff92e8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff92e8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab800f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff92d0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab800eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab80102c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab800f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff92e8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab8010c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab80102c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab8011580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff92e8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab8010c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab8011740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab8011580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff92e8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab8011900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab8011740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.72 ms
whisper_print_timings:   sample time =    66.08 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4736.06 ms /     1 runs ( 4736.06 ms per run)
whisper_print_timings:   decode time =    15.78 ms /     2 runs (    7.89 ms per run)
whisper_print_timings:   batchd time =   715.55 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5662.73 ms
...
main:     load time =    93.34 ms
main:    total time = 40500.00 ms
embd_img
