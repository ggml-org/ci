...
- status:  SUCCESS ✅
- runtime: 3:41.00
- date:    Mon Aug 28 11:19:50 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/9a66a1d7bf75057cf915df5aa5ef3cdaf7059257
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.47 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.46 sec
...
main:     load time =   292.45 ms
main:   sample time =    17.62 ms
main:  predict time =   810.16 ms / 12.66 ms per token
main:    total time =  1143.39 ms
...
main:     load time =   176.12 ms
main:   sample time =    17.14 ms
main:  predict time =   878.93 ms / 12.56 ms per token
main:    total time =  1075.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbc0ca8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbbf4b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab039b8ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbc0c9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbc0cf800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab039b9830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbbf4b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab039b8ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab039ba140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab039b9830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbc0c9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab039baa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab039ba140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab039bb360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbc0ca8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab039baa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab039bb4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab039bb360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbc0cf800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab039bb640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab039bb4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12166.98 ms
main:    sample time =   600.90 ms / 9.39 ms per token
main:      eval time = 43595.46 ms / 622.79 ms per token
main:     total time = 58751.22 ms
...
main:      load time =  4358.98 ms
main:    sample time =   616.53 ms / 9.63 ms per token
main:      eval time = 17290.37 ms / 247.01 ms per token
main:     total time = 23227.05 ms
