...
- status:  SUCCESS ✅
- runtime: 2:41.74
- date:    Mon Aug 28 11:11:59 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    2.52 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.33 sec
...
main:     load time =   194.75 ms
main:   sample time =    23.48 ms
main:  predict time =   431.92 ms / 6.75 ms per token
main:    total time =   663.59 ms
...
main:  predict time =   448.13 ms / 6.40 ms per token
main:    total time =   607.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5e23f948a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5e23e15150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564237e2dab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5e23f93f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5e23f99800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564237e2e830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5e23e15150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564237e2dab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564237e2f140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564237e2e830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5e23f93f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564237e2fa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564237e2f140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564237e30360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5e23f948a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564237e2fa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564237e304d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564237e30360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5e23f99800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564237e30640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564237e304d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 13706.51 ms
main:    sample time =   466.99 ms / 7.30 ms per token
main:      eval time = 19885.99 ms / 284.09 ms per token
main:     total time = 34714.18 ms
...
main:      load time =  4368.00 ms
main:    sample time =   463.32 ms / 7.24 ms per token
main:      eval time =  8027.52 ms / 114.68 ms per token
main:     total time = 13231.29 ms
