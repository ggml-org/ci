...
- status:  SUCCESS ✅
- runtime: 1:31.27
- date:    Wed Feb 12 20:02:02 UTC 2025
...
main:  predict time =   741.14 ms / 10.59 ms per token
main:    total time =   885.16 ms
...
main:     load time =   134.91 ms
main:   sample time =    33.09 ms
main:  predict time =   745.43 ms / 10.65 ms per token
main:    total time =   917.98 ms
...
main:   sample time =   211.49 ms
main:  predict time =  2891.99 ms
main:    total time =  3260.90 ms
...
main:     load time =    70.97 ms
main:    total time = 19038.11 ms
embd_img
