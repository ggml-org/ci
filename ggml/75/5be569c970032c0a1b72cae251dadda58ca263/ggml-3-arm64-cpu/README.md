...
- status:  SUCCESS ✅
- runtime: 3:44.76
- date:    Tue Sep  5 10:59:06 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.50 sec
      Start  6: test0
...
main:     load time =   248.51 ms
main:   sample time =    17.35 ms
main:  predict time =   811.31 ms / 12.68 ms per token
main:    total time =  1100.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa4b6a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa49eb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5935ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa4b69f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa4b6f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf5936830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa49eb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5935ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf5937140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf5936830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa4b69f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf5937a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf5937140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf5938360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa4b6a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf5937a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf59384d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf5938360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa4b6f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf5938640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf59384d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12366.86 ms
main:    sample time =   630.79 ms / 9.86 ms per token
main:      eval time = 43744.12 ms / 624.92 ms per token
main:     total time = 59131.84 ms
...
main:      load time =  4338.62 ms
main:    sample time =   618.83 ms / 9.67 ms per token
main:      eval time = 17375.29 ms / 248.22 ms per token
main:     total time = 23293.29 ms
