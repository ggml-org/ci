...
- status:  SUCCESS ✅
- runtime: 3:52.74
- date:    Sat Oct  7 10:33:33 AM UTC 2023
...
main:     load time =   239.52 ms
main:   sample time =    17.61 ms
main:  predict time =   816.15 ms / 12.75 ms per token
main:    total time =  1096.47 ms
...
main:     load time =   154.93 ms
main:   sample time =    17.39 ms
main:  predict time =   878.37 ms / 12.55 ms per token
main:    total time =  1054.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fa6a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f8eb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad728dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fa69fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fa6f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad728e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f8eb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad728dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad728f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad728e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fa69fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad728fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad728f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad7290400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fa6a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad728fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad7290590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad7290400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fa6f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad7290720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad7290590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12826.66 ms
main:    sample time =   522.87 ms / 8.17 ms per token
main:      eval time = 43525.27 ms / 621.79 ms per token
main:     total time = 59250.16 ms
...
main:      load time =  4360.83 ms
main:    sample time =   516.64 ms / 8.07 ms per token
main:      eval time = 17659.80 ms / 252.28 ms per token
main:     total time = 23500.22 ms
