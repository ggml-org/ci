...
- status:  SUCCESS ✅
- runtime: 4:24.78
- date:    Wed Jan  3 09:30:09 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   43.34 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.88 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.81 sec
      Start  9: test3
...
main:  predict time =   851.17 ms / 13.30 ms per token
main:    total time =  1084.11 ms
...
main:     load time =   191.16 ms
main:   sample time =    18.08 ms
main:  predict time =   925.11 ms / 13.22 ms per token
main:    total time =  1137.38 ms
...
main:     n_decoded =      504
main:     load time =   162.96 ms
main:   sample time =   132.00 ms
main:  predict time =  6350.85 ms
main:    total time =  6727.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb56ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb556b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0d93ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb56ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb56ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0d93b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb556b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0d93ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0d93c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0d93b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb56ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0d93cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0d93c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0d93d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb56ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0d93cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0d93d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0d93d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb56ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0d93d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0d93d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.73 ms
whisper_print_timings:   sample time =    67.03 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4764.04 ms /     1 runs ( 4764.04 ms per run)
whisper_print_timings:   decode time =    15.56 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   742.58 ms /   125 runs (    5.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5722.96 ms
...
main:     load time =    97.54 ms
main:    total time = 40639.71 ms
embd_img
