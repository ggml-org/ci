...
- status:  SUCCESS ✅
- runtime: 3:38.26
- date:    Wed Jan  3 09:29:14 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   26.85 sec
...
21/21 Test #21: test-backend-ops .................   Passed    7.70 sec
...
main:  predict time =   439.76 ms / 6.87 ms per token
main:    total time =   650.76 ms
...
main:  predict time =   452.40 ms / 6.46 ms per token
main:    total time =   602.77 ms
...
main:  predict time =  1499.99 ms
main:    total time =  1811.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f13d4085990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f13d3f061a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b0f5cfbb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f13d4085030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f13d408a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b0f5cfc960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f13d3f061a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b0f5cfbb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b0f5cfd2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b0f5cfc960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f13d4085030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b0f5cfdc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b0f5cfd2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b0f5cfe580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f13d4085990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b0f5cfdc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b0f5cfe740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b0f5cfe580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f13d408a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b0f5cfe900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b0f5cfe740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   120.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.89 ms
whisper_print_timings:   sample time =    54.23 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1155.90 ms /     1 runs ( 1155.90 ms per run)
whisper_print_timings:   decode time =     9.54 ms /     2 runs (    4.77 ms per run)
whisper_print_timings:   batchd time =   203.24 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1561.78 ms
...
main:     load time =    59.83 ms
main:    total time = 11878.20 ms
embd_img
...
main:      load time =  5701.05 ms
main:    sample time =   468.94 ms / 7.33 ms per token
main:      eval time = 20926.47 ms / 298.95 ms per token
main:     total time = 27806.69 ms
...
main:      load time =  1239.83 ms
main:    sample time =   467.32 ms / 7.30 ms per token
main:      eval time =  8177.22 ms / 116.82 ms per token
main:     total time = 10256.48 ms
