...
- status:  SUCCESS ✅
- runtime: 5:30.10
- date:    Wed Jan  3 09:31:10 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   35.02 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.26 sec
...
main:     load time =   219.50 ms
main:   sample time =    16.88 ms
main:  predict time =   821.29 ms / 12.83 ms per token
main:    total time =  1079.26 ms
...
main:     load time =   180.79 ms
main:   sample time =    17.16 ms
main:  predict time =   901.87 ms / 12.88 ms per token
main:    total time =  1102.75 ms
...
main:   sample time =   126.63 ms
main:  predict time =  6015.77 ms
main:    total time =  6376.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e79a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e61b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0708b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e79a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e79f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad0709960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e61b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0708b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad070a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad0709960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e79a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad070ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad070a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad070b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e79a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad070ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad070b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad070b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e79f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad070b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad070b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.21 ms
whisper_print_timings:   sample time =    65.82 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4639.04 ms /     1 runs ( 4639.04 ms per run)
whisper_print_timings:   decode time =    14.97 ms /     2 runs (    7.49 ms per run)
whisper_print_timings:   batchd time =   706.46 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5621.65 ms
...
main:     load time =    83.36 ms
main:    total time = 39798.55 ms
embd_img
...
main:      load time =  5910.04 ms
main:    sample time =   522.59 ms / 8.17 ms per token
main:      eval time = 43804.25 ms / 625.77 ms per token
main:     total time = 52609.50 ms
...
main:      load time =  1496.27 ms
main:    sample time =   516.39 ms / 8.07 ms per token
main:      eval time = 17637.45 ms / 251.96 ms per token
main:     total time = 20625.83 ms
