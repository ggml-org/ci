...
- status:  SUCCESS ✅
- runtime: 3:10.98
- date:    Sun Jun 16 11:16:50 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/21 Test  #3: test-quantize-perf ...............   Passed   10.77 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/22 Test  #6: test-mul-mat2 ....................   Passed    1.78 sec
      Start  7: test0
...
main:     load time =   159.17 ms
main:   sample time =    18.88 ms
main:  predict time =   880.28 ms / 13.75 ms per token
main:    total time =  1079.89 ms
...
main:     load time =   159.96 ms
main:   sample time =    18.76 ms
main:  predict time =   955.37 ms / 13.65 ms per token
main:    total time =  1136.69 ms
...
main:     load time =   189.12 ms
main:   sample time =    18.91 ms
main:  predict time =   970.97 ms / 13.87 ms per token
main:    total time =  1182.12 ms
...
main:     n_decoded =      504
main:     load time =   159.55 ms
main:   sample time =   128.55 ms
main:  predict time =  6085.39 ms
main:    total time =  6456.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf047275ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf0472744b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8a8244a2ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf047275ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf047275cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8a8244a3ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf0472744b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8a8244a2ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8a8244a4410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8a8244a3ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf047275ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8a8244a4d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8a8244a4410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8a8244a56d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf047275ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8a8244a4d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8a8244a5890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8a8244a56d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf047275cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb8a8244a5a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8a8244a5890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.54 ms
whisper_print_timings:   sample time =    68.00 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4696.86 ms /     1 runs ( 4696.86 ms per run)
whisper_print_timings:   decode time =    15.05 ms /     2 runs (    7.52 ms per run)
whisper_print_timings:   batchd time =   731.86 ms /   125 runs (    5.85 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5654.81 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.279000 sec.)
