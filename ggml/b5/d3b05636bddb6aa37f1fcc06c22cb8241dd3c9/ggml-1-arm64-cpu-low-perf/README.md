...
- status:  SUCCESS ✅
- runtime: 4:02.94
- date:    Sun Jun 16 11:17:45 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.72 sec
 ...
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.64 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.00 sec
      Start  9: test3
...
main:  predict time =   904.08 ms / 14.13 ms per token
main:    total time =  1095.58 ms
...
main:  predict time =   967.50 ms / 13.82 ms per token
main:    total time =  1141.75 ms
...
main:     load time =   179.66 ms
main:   sample time =    18.98 ms
main:  predict time =   991.17 ms / 14.16 ms per token
main:    total time =  1193.21 ms
...
main:     n_decoded =      504
main:     load time =   149.47 ms
main:   sample time =   128.07 ms
main:  predict time =  6101.68 ms
main:    total time =  6462.60 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfb8e3502a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfb8e34eab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc2b223daece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfb8e3502a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfb8e3502f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc2b223dafab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfb8e34eab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc2b223daece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc2b223db0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc2b223dafab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfb8e3502a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc2b223db0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc2b223db0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc2b223db16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfb8e3502a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc2b223db0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc2b223db1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc2b223db16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfb8e3502f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc2b223db1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc2b223db1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.48 ms
whisper_print_timings:   sample time =    68.13 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4680.54 ms /     1 runs ( 4680.54 ms per run)
whisper_print_timings:   decode time =    15.03 ms /     2 runs (    7.51 ms per run)
whisper_print_timings:   batchd time =   737.03 ms /   125 runs (    5.90 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5638.00 ms
