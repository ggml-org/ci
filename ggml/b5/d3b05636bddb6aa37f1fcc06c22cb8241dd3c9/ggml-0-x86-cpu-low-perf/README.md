...
- status:  SUCCESS ✅
- runtime: 3:25.76
- date:    Sun Jun 16 11:17:02 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   30.04 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed    8.89 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.27 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.14 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   16.04 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed    4.48 sec
      Start  4: test-mul-mat0
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.32 sec
      Start  9: test3
...
main:  predict time =   643.98 ms / 10.06 ms per token
main:    total time =   781.66 ms
...
main:     load time =   100.58 ms
main:   sample time =    23.85 ms
main:  predict time =   674.53 ms / 9.64 ms per token
main:    total time =   801.10 ms
...
main:     load time =   121.65 ms
main:   sample time =    23.98 ms
main:  predict time =   697.13 ms / 9.96 ms per token
main:    total time =   845.91 ms
...
main:     n_decoded =      504
main:     load time =   100.48 ms
main:   sample time =   178.72 ms
main:  predict time =  2580.46 ms
main:    total time =  2905.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7c6b9c0fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7c6b9bf7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5ccc2aca5ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7c6b9c0fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7c6b9c0ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5ccc2aca6ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7c6b9bf7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5ccc2aca5ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5ccc2aca7410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5ccc2aca6ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7c6b9c0fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5ccc2aca7d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5ccc2aca7410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5ccc2aca86d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7c6b9c0fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5ccc2aca7d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5ccc2aca8890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5ccc2aca86d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7c6b9c0ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5ccc2aca8a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5ccc2aca8890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.50 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.21 ms
whisper_print_timings:   sample time =    72.95 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2003.31 ms /     1 runs ( 2003.31 ms per run)
whisper_print_timings:   decode time =    13.87 ms /     2 runs (    6.94 ms per run)
whisper_print_timings:   batchd time =   329.98 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2528.03 ms
