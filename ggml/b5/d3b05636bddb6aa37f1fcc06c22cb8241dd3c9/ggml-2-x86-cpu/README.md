...
- status:  SUCCESS ✅
- runtime: 2:09.23
- date:    Sun Jun 16 11:15:38 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   30.14 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed    8.84 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.91 sec
      Start  2: test-opt
 2/22 Test  #2: test-opt .........................   Passed    1.66 sec
      Start  3: test-quantize-fns
 3/22 Test  #3: test-quantize-fns ................   Passed   16.07 sec
...
main:     load time =   104.88 ms
main:   sample time =    23.73 ms
main:  predict time =   479.52 ms / 7.49 ms per token
main:    total time =   620.44 ms
...
main:  predict time =   494.87 ms / 7.07 ms per token
main:    total time =   624.82 ms
...
main:     load time =   124.68 ms
main:   sample time =    23.77 ms
main:  predict time =   505.73 ms / 7.22 ms per token
main:    total time =   657.15 ms
...
main:     n_decoded =      504
main:     load time =   103.15 ms
main:   sample time =   177.85 ms
main:  predict time =  1541.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5c22afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5c2297b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f085452ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5c22afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5c22aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f085453ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5c2297b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f085452ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f085454410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f085453ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5c22afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f085454d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f085454410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f0854556d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5c22afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f085454d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f085455890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f0854556d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5c22aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f085455a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f085455890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.49 ms
whisper_print_timings:   sample time =    55.26 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1163.11 ms /     1 runs ( 1163.11 ms per run)
whisper_print_timings:   decode time =    11.18 ms /     2 runs (    5.59 ms per run)
whisper_print_timings:   batchd time =   221.11 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1554.05 ms
...
main:     load time =    66.37 ms
main:    total time = 10613.31 ms
embd_img
