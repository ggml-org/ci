...
- status:  SUCCESS ✅
- runtime: 10:23.12
- date:    Fri Jan 26 02:49:19 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  124.77 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.16 sec
...
main:     load time =   186.87 ms
main:   sample time =    17.69 ms
main:  predict time =   850.66 ms / 13.29 ms per token
main:    total time =  1077.71 ms
...
main:  predict time =   921.47 ms / 13.16 ms per token
main:    total time =  1127.06 ms
...
main:  predict time =  6005.99 ms
main:    total time =  6370.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83f5a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83ddb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab21443b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83f5a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83f5f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab21444960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff83ddb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab21443b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab214452c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab21444960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83f5a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab21445c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab214452c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab21446580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83f5a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab21445c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab21446740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab21446580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83f5f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab21446900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab21446740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   188.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.89 ms
whisper_print_timings:   sample time =    65.66 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4624.69 ms /     1 runs ( 4624.69 ms per run)
whisper_print_timings:   decode time =    15.76 ms /     2 runs (    7.88 ms per run)
whisper_print_timings:   batchd time =   706.04 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5620.15 ms
...
main:     load time =    85.39 ms
main:    total time = 39646.66 ms
embd_img
...
main:      load time = 12669.65 ms
main:    sample time =   520.03 ms / 8.13 ms per token
main:      eval time = 43726.41 ms / 624.66 ms per token
main:     total time = 59290.44 ms
...
main:      load time =  4342.99 ms
main:    sample time =   514.08 ms / 8.03 ms per token
main:      eval time = 17310.26 ms / 247.29 ms per token
main:     total time = 23122.76 ms
