...
- status:  SUCCESS ✅
- runtime: 15:50.93
- date:    Fri Jan 26 14:00:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    0.60 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.56 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.77 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.05 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  238.45 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.76 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.70 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   47.89 sec
...
main:     load time =   608.57 ms
main:   sample time =    34.12 ms
main:  predict time =   572.51 ms / 8.95 ms per token
main:    total time =  1235.44 ms
...
main:     load time =   583.18 ms
main:   sample time =    34.09 ms
main:  predict time =   614.99 ms / 8.79 ms per token
main:    total time =  1236.94 ms
...
main:     n_decoded =      504
main:     load time =   543.64 ms
main:   sample time =   239.67 ms
main:  predict time =  2358.79 ms
main:    total time =  3191.06 ms
...
main: loaded model in   404.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbeeddb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbeedc371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55edad21a910                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbeeddb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbeeddbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55edad21b6e0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbeedc371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55edad21a910                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55edad21c040                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55edad21b6e0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbeeddb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55edad21c9a0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55edad21c040                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55edad21d300                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbeeddb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55edad21c9a0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55edad21d4c0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55edad21d300                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbeeddbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55edad21d680                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55edad21d4c0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   795.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.62 ms
whisper_print_timings:   sample time =    66.19 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    23.63 ms /     1 runs (   23.63 ms per run)
whisper_print_timings:   decode time =    20.37 ms /     2 runs (   10.18 ms per run)
whisper_print_timings:   batchd time =    80.18 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1011.73 ms
...
main:     load time =   511.59 ms
main:    total time =  7986.98 ms
embd_img
...
main:      load time =  8491.16 ms
main:    sample time =   538.77 ms / 8.42 ms per token
main:      eval time = 26882.25 ms / 384.03 ms per token
main:     total time = 36812.60 ms
...
main:      load time =  2060.06 ms
main:    sample time =   550.28 ms / 8.60 ms per token
main:      eval time = 12511.13 ms / 178.73 ms per token
main:     total time = 15719.44 ms
