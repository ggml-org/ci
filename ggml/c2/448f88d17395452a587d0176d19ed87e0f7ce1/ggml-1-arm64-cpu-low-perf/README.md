...
- status:  SUCCESS ✅
- runtime: 5:32.44
- date:    Fri Jan 26 01:21:31 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.05 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.84 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.50 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  148.54 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 171.50 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.64 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.01 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   23.96 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  39.60 sec
...
main:     load time =   196.08 ms
main:   sample time =    18.19 ms
main:  predict time =   896.91 ms / 14.01 ms per token
main:    total time =  1133.76 ms
...
main:     load time =   195.64 ms
main:   sample time =    18.01 ms
main:  predict time =   957.65 ms / 13.68 ms per token
main:    total time =  1174.59 ms
...
main:     n_decoded =      504
main:     load time =   165.66 ms
main:   sample time =   130.94 ms
main:  predict time =  6203.25 ms
main:    total time =  6590.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff95aea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9596b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7e7cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff95aea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff95aef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf7e7d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9596b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf7e7cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf7e7e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf7e7d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff95aea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf7e7ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf7e7e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf7e7f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff95aea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf7e7ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf7e7f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf7e7f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff95aef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf7e7f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf7e7f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.99 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    68.49 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4741.25 ms /     1 runs ( 4741.25 ms per run)
whisper_print_timings:   decode time =    16.34 ms /     2 runs (    8.17 ms per run)
whisper_print_timings:   batchd time =   713.97 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5672.35 ms
...
main:     load time =    93.07 ms
main:    total time = 40503.04 ms
embd_img
