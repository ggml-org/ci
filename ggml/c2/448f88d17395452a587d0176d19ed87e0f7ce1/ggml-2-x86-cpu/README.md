...
- status:  SUCCESS ✅
- runtime: 6:02.56
- date:    Fri Jan 26 13:43:01 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  112.16 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 123.02 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.68 sec
...
main:     load time =   190.85 ms
main:   sample time =    23.49 ms
main:  predict time =   462.80 ms / 7.23 ms per token
main:    total time =   690.27 ms
...
main:     load time =   123.01 ms
main:   sample time =    23.47 ms
main:  predict time =   469.40 ms / 6.71 ms per token
main:    total time =   618.21 ms
...
main:  predict time =  1524.81 ms
main:    total time =  1837.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4c2452d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4c243ae1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5634ded06b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4c2452d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4c24532940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5634ded07960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4c243ae1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5634ded06b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5634ded082c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5634ded07960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4c2452d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5634ded08c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5634ded082c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5634ded09580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4c2452d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5634ded08c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5634ded09740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5634ded09580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4c24532940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5634ded09900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5634ded09740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.86 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    55.02 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1162.51 ms /     1 runs ( 1162.51 ms per run)
whisper_print_timings:   decode time =     9.35 ms /     2 runs (    4.68 ms per run)
whisper_print_timings:   batchd time =   205.80 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1569.21 ms
...
main:     load time =    62.66 ms
main:    total time = 10635.20 ms
embd_img
...
main:      load time = 15699.53 ms
main:    sample time =   469.33 ms / 7.33 ms per token
main:      eval time = 20694.10 ms / 295.63 ms per token
main:     total time = 37536.34 ms
...
main:      load time =  4266.31 ms
main:    sample time =   465.97 ms / 7.28 ms per token
main:      eval time =  9084.20 ms / 129.77 ms per token
main:     total time = 14167.16 ms
