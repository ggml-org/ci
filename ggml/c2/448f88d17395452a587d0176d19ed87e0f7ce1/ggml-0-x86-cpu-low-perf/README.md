...
- status:  SUCCESS ✅
- runtime: 5:31.96
- date:    Fri Jan 26 13:20:42 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/c2448f88d17395452a587d0176d19ed87e0f7ce1
- author:  Neuman Vong
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.17 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.41 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.66 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  117.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.02 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.37 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.66 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  37.10 sec
...
main:     load time =   128.18 ms
main:   sample time =    23.62 ms
main:  predict time =   629.95 ms / 9.84 ms per token
main:    total time =   794.74 ms
...
main:     load time =   126.81 ms
main:   sample time =    23.46 ms
main:  predict time =   651.69 ms / 9.31 ms per token
main:    total time =   804.41 ms
...
main:     n_decoded =      504
main:     load time =   105.48 ms
main:   sample time =   178.28 ms
main:  predict time =  2507.94 ms
main:    total time =  2836.91 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f811dd32990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f811dbb31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d01fbb2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f811dd32030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f811dd37940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d01fbb3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f811dbb31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d01fbb2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d01fbb42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d01fbb3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f811dd32030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d01fbb4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d01fbb42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d01fbb5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f811dd32990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d01fbb4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d01fbb5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d01fbb5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f811dd37940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d01fbb5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d01fbb5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.41 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.98 ms
whisper_print_timings:   sample time =    72.25 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1989.73 ms /     1 runs ( 1989.73 ms per run)
whisper_print_timings:   decode time =    12.68 ms /     2 runs (    6.34 ms per run)
whisper_print_timings:   batchd time =   321.64 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2500.97 ms
