...
- status:  SUCCESS ✅
- runtime: 5:07.84
- date:    Thu Jan 18 08:41:19 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  111.00 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 121.81 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    3.29 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.64 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.89 sec
...
main:     load time =   175.25 ms
main:   sample time =    23.48 ms
main:  predict time =   453.94 ms / 7.09 ms per token
main:    total time =   666.07 ms
...
main:     load time =   122.63 ms
main:   sample time =    23.43 ms
main:  predict time =   472.07 ms / 6.74 ms per token
main:    total time =   620.54 ms
...
main:  predict time =  1541.44 ms
main:    total time =  1853.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe51df22990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe51dda31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d92fa4eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe51df22030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe51df27940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d92fa4f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe51dda31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d92fa4eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d92fa502c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d92fa4f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe51df22030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d92fa50c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d92fa502c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d92fa51580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe51df22990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d92fa50c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d92fa51740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d92fa51580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe51df27940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d92fa51900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d92fa51740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    55.99 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1156.14 ms /     1 runs ( 1156.14 ms per run)
whisper_print_timings:   decode time =     9.56 ms /     2 runs (    4.78 ms per run)
whisper_print_timings:   batchd time =   206.15 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1521.59 ms
...
main:     load time =    61.44 ms
main:    total time = 10630.91 ms
embd_img
...
main:      load time =  5734.89 ms
main:    sample time =   467.76 ms / 7.31 ms per token
main:      eval time = 20606.61 ms / 294.38 ms per token
main:     total time = 27498.61 ms
...
main:      load time =  1203.07 ms
main:    sample time =   465.49 ms / 7.27 ms per token
main:      eval time =  8125.90 ms / 116.08 ms per token
main:     total time = 10182.55 ms
