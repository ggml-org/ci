...
- status:  SUCCESS ✅
- runtime: 6:17.69
- date:    Thu Jan 18 08:42:29 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.61 sec
...
20/20 Test #20: test-backend-ops .................   Passed  153.49 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 176.66 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   23.86 sec
...
main:  predict time =   878.28 ms / 13.72 ms per token
...
main:  predict time =   936.55 ms / 13.38 ms per token
main:    total time =  1143.82 ms
...
main:     n_decoded =      504
main:     load time =   160.66 ms
main:   sample time =   127.40 ms
main:  predict time =  6157.85 ms
main:    total time =  6528.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a1ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8a04b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab198ddb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a1ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a1cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab198de960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8a04b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab198ddb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab198df2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab198de960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a1ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab198dfc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab198df2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab198e0580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a1ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab198dfc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab198e0740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab198e0580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a1cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab198e0900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab198e0740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.83 ms
whisper_print_timings:   sample time =    66.06 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4740.33 ms /     1 runs ( 4740.33 ms per run)
whisper_print_timings:   decode time =    16.11 ms /     2 runs (    8.05 ms per run)
whisper_print_timings:   batchd time =   709.06 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5663.98 ms
