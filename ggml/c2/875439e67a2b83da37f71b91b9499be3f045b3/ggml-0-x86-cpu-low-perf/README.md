...
- status:  SUCCESS ✅
- runtime: 5:07.97
- date:    Thu Jan 18 08:41:18 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  115.86 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.25 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.81 sec
...
main:  predict time =   619.00 ms / 9.67 ms per token
main:    total time =   780.43 ms
...
main:  predict time =   654.39 ms / 9.35 ms per token
main:    total time =   808.80 ms
...
main:  predict time =  2489.49 ms
main:    total time =  2818.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fafbf016990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fafbee971a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56305ef66b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fafbf016030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fafbf01b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56305ef67960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fafbee971a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56305ef66b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56305ef682c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56305ef67960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fafbf016030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56305ef68c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56305ef682c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56305ef69580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fafbf016990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56305ef68c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56305ef69740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56305ef69580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fafbf01b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56305ef69900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56305ef69740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.18 ms
whisper_print_timings:   sample time =    72.10 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1988.33 ms /     1 runs ( 1988.33 ms per run)
...
whisper_print_timings:    total time =  2499.14 ms
...
main:     load time =    67.35 ms
main:    total time = 18945.23 ms
embd_img
