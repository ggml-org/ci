...
- status:  SUCCESS ✅
- runtime: 7:58.01
- date:    Thu Jan 18 08:44:07 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  124.34 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 138.38 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.43 sec
...
main:     load time =   266.26 ms
main:   sample time =    17.02 ms
main:  predict time =   846.53 ms / 13.23 ms per token
main:    total time =  1151.75 ms
...
main:     load time =   179.27 ms
main:   sample time =    16.93 ms
main:  predict time =   923.83 ms / 13.20 ms per token
main:    total time =  1123.07 ms
...
main:  predict time =  6002.50 ms
main:    total time =  6362.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff81f7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81dfb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafe9ceb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81f7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff81f7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafe9cf960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81dfb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafe9ceb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafe9d02c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafe9cf960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81f7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafe9d0c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafe9d02c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafe9d1580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff81f7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafe9d0c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafe9d1740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafe9d1580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff81f7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafe9d1900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafe9d1740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.42 ms
whisper_print_timings:   sample time =    65.43 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4624.75 ms /     1 runs ( 4624.75 ms per run)
whisper_print_timings:   decode time =    15.79 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   705.36 ms /   125 runs (    5.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5539.59 ms
...
main:     load time =    90.60 ms
main:    total time = 39664.34 ms
embd_img
...
main:      load time =  5693.25 ms
main:    sample time =   519.08 ms / 8.11 ms per token
main:      eval time = 43787.41 ms / 625.53 ms per token
main:     total time = 52371.80 ms
...
main:      load time =  1619.73 ms
main:    sample time =   516.63 ms / 8.07 ms per token
main:      eval time = 17272.49 ms / 246.75 ms per token
main:     total time = 20366.15 ms
