...
- status:  SUCCESS ✅
- runtime: 1:20.95
- date:    Fri Nov 15 21:43:57 UTC 2024
...
main:     load time =   128.73 ms
main:   sample time =    27.99 ms
main:  predict time =   483.48 ms / 6.91 ms per token
main:    total time =   642.12 ms
...
main:  predict time =  1603.31 ms
main:    total time =  1927.22 ms
