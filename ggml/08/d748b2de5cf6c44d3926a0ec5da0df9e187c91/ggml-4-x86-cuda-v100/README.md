...
- status:  SUCCESS ✅
- runtime: 5:52.36
- date:    Mon Oct 30 20:34:09 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.16 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    5.88 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.12 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.32 sec
      Start 10: test3
...
main:  predict time =   593.53 ms / 9.27 ms per token
main:    total time =   826.40 ms
...
main:     load time =   179.26 ms
main:   sample time =    35.38 ms
main:  predict time =   599.31 ms / 8.56 ms per token
...
main:     n_decoded =      504
main:     load time =   154.25 ms
main:   sample time =   238.01 ms
main:  predict time =  2249.61 ms
main:    total time =  2686.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f394a0fa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3949f7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55659f669b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f394a0f9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f394a0ff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55659f66a900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3949f7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55659f669b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55659f66b230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55659f66a900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f394a0f9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55659f66bb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55659f66b230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55659f66c490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f394a0fa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55659f66bb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55659f66c620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55659f66c490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f394a0ff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55659f66c7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55659f66c620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   716.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.55 ms
whisper_print_timings:   sample time =    20.23 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1912.76 ms /     1 runs ( 1912.76 ms per run)
whisper_print_timings:   decode time =   132.78 ms /    27 runs (    4.92 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2857.59 ms
...
main:     load time =    98.96 ms
main:    total time = 16683.57 ms
embd_img
...
main:      load time = 22101.07 ms
main:    sample time =   577.49 ms / 9.02 ms per token
main:      eval time = 25437.46 ms / 363.39 ms per token
main:     total time = 49000.73 ms
...
main:      load time = 11357.76 ms
main:    sample time =   586.73 ms / 9.17 ms per token
main:      eval time = 12313.37 ms / 175.91 ms per token
main:     total time = 24917.49 ms
