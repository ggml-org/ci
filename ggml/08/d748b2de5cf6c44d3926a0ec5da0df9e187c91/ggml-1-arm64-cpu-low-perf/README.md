...
- status:  SUCCESS ✅
- runtime: 2:33.91
- date:    Mon Oct 30 08:30:50 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.15 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.44 sec
      Start  9: test3
...
main:     load time =   188.15 ms
main:   sample time =    17.65 ms
main:  predict time =   828.07 ms / 12.94 ms per token
main:    total time =  1055.76 ms
...
main:   sample time =    17.65 ms
main:  predict time =   893.32 ms / 12.76 ms per token
main:    total time =  1103.84 ms
...
main:     n_decoded =      504
main:     load time =   160.39 ms
main:   sample time =   129.54 ms
main:  predict time =  6042.72 ms
main:    total time =  6413.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff950aa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff94f2b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab02a27b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff950a9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff950af880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab02a28900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff94f2b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab02a27b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab02a29230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab02a28900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff950a9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab02a29b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab02a29230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab02a2a490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff950aa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab02a29b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab02a2a620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab02a2a490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff950af880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab02a2a7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab02a2a620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    20.87 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4705.94 ms /     1 runs ( 4705.94 ms per run)
whisper_print_timings:   decode time =   183.24 ms /    27 runs (    6.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5091.13 ms
