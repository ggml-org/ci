...
- status:  SUCCESS ✅
- runtime: 4:34.80
- date:    Mon Oct 30 08:32:58 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.33 sec
...
main:     n_decoded =      504
main:     load time =   144.51 ms
main:   sample time =   127.10 ms
main:  predict time =  5866.70 ms
main:    total time =  6218.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa8a7a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa88fb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9ceab60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa8a79fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa8a7f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ceb900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa88fb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf9ceab60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf9cec230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf9ceb900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa8a79fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf9cecb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf9cec230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf9ced490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa8a7a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf9cecb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf9ced620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf9ced490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa8a7f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf9ced7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf9ced620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   202.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.75 ms
whisper_print_timings:   sample time =    20.84 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4610.91 ms /     1 runs ( 4610.91 ms per run)
whisper_print_timings:   decode time =   179.67 ms /    27 runs (    6.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5076.92 ms
...
main:      load time =  5760.08 ms
main:    sample time =   533.96 ms / 8.34 ms per token
main:      eval time = 43734.76 ms / 624.78 ms per token
main:     total time = 52402.39 ms
...
main:      load time =  1520.74 ms
main:    sample time =   523.67 ms / 8.18 ms per token
main:      eval time = 17299.88 ms / 247.14 ms per token
main:     total time = 20303.55 ms
