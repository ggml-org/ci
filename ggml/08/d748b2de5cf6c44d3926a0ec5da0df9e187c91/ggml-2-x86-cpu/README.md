...
- status:  SUCCESS ✅
- runtime: 3:02.64
- date:    Mon Oct 30 20:31:25 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.25 sec
      Start  2: test-opt
...
main:     load time =   187.35 ms
main:   sample time =    23.81 ms
main:  predict time =   439.65 ms / 6.87 ms per token
main:    total time =   663.39 ms
...
main:     load time =   128.10 ms
main:   sample time =    23.73 ms
main:  predict time =   459.43 ms / 6.56 ms per token
main:    total time =   613.20 ms
...
main:   sample time =   177.69 ms
main:  predict time =  1466.69 ms
main:    total time =  1780.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f12b8978900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f12b87f9170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5626e8954b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f12b8977fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f12b897d880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5626e8955900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f12b87f9170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5626e8954b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5626e8956230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5626e8955900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f12b8977fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5626e8956b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5626e8956230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5626e8957490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f12b8978900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5626e8956b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5626e8957620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5626e8957490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f12b897d880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5626e89577b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5626e8957620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   135.20 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    15.57 ms
whisper_print_timings:   sample time =    16.12 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1133.34 ms /     1 runs ( 1133.34 ms per run)
whisper_print_timings:   decode time =    92.07 ms /    27 runs (    3.41 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1427.88 ms
...
main:     load time =    65.15 ms
main:    total time = 10419.30 ms
embd_img
...
main:      load time =  5831.14 ms
main:    sample time =   467.45 ms / 7.30 ms per token
main:      eval time = 20597.48 ms / 294.25 ms per token
main:     total time = 27631.50 ms
...
main:      load time =  1212.95 ms
main:    sample time =   466.97 ms / 7.30 ms per token
main:      eval time =  8037.37 ms / 114.82 ms per token
main:     total time = 10083.41 ms
