...
- status:  SUCCESS ✅
- runtime: 2:01.75
- date:    Mon Oct 30 20:30:16 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.80 sec
      Start  9: test3
...
main:  predict time =   736.02 ms / 11.50 ms per token
main:    total time =   902.02 ms
...
main:  predict time =   634.28 ms / 9.06 ms per token
main:    total time =   785.92 ms
...
main:  predict time =  2371.60 ms
main:    total time =  2698.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd3049cc900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd30484d170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5635cebd3b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd3049cbfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd3049d1880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5635cebd4900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd30484d170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5635cebd3b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5635cebd5230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5635cebd4900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd3049cbfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5635cebd5b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5635cebd5230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5635cebd6490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd3049cc900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5635cebd5b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5635cebd6620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5635cebd6490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd3049d1880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5635cebd67b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5635cebd6620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    83.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.04 ms
whisper_print_timings:   sample time =    16.46 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  2066.58 ms /     1 runs ( 2066.58 ms per run)
whisper_print_timings:   decode time =   127.99 ms /    27 runs (    4.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2351.83 ms
