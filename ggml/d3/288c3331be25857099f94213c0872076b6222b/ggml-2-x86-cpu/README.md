...
- status:  FAILURE ❌ (1)
- runtime: 2:12.49
- date:    Sat May 11 18:34:56 UTC 2024
...
main:  predict time =   505.05 ms / 7.89 ms per token
...
main:  predict time =   525.12 ms / 7.50 ms per token
main:    total time =   654.40 ms
...
main:  predict time =   529.21 ms / 7.56 ms per token
main:    total time =   680.38 ms
...
main:     n_decoded =      504
main:     load time =   102.24 ms
main:   sample time =   178.04 ms
main:  predict time =  1856.51 ms
main:    total time =  2169.79 ms
