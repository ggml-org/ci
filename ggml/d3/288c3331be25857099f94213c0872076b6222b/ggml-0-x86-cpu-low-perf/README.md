...
- status:  SUCCESS ✅
- runtime: 3:30.10
- date:    Sat May 11 18:37:24 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.99 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   23.75 sec
      Start  9: test3
...
main:  predict time =   695.36 ms / 10.87 ms per token
main:    total time =   835.78 ms
...
main:  predict time =   736.26 ms / 10.52 ms per token
main:    total time =   868.63 ms
...
main:  predict time =   746.92 ms / 10.67 ms per token
main:    total time =   899.58 ms
...
main:  predict time =  3099.65 ms
main:    total time =  3428.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f351d466990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f351d2e71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5631c9c03ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f351d466030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f351d46b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5631c9c04ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f351d2e71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5631c9c03ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5631c9c05410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5631c9c04ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f351d466030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5631c9c05d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5631c9c05410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5631c9c066d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f351d466990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5631c9c05d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5631c9c06890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5631c9c066d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f351d46b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5631c9c06a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5631c9c06890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =   646.47 ms /   131 runs (    4.93 ms per run)
whisper_print_timings:   encode time =  2052.84 ms /     1 runs ( 2052.84 ms per run)
whisper_print_timings:   decode time =    15.92 ms /     2 runs (    7.96 ms per run)
whisper_print_timings:   batchd time =   335.88 ms /   125 runs (    2.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  3152.47 ms
...
main:     load time =    71.39 ms
main:    total time = 19370.08 ms
embd_img
