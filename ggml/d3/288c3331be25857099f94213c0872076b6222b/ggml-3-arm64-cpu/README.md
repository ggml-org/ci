...
- status:  SUCCESS ✅
- runtime: 3:13.65
- date:    Sat May 11 18:36:45 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/23 Test  #1: test-grad0 .......................   Passed    2.92 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.33 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   20.57 sec
...
main:     load time =   151.93 ms
main:   sample time =    17.47 ms
main:  predict time =   896.54 ms / 14.01 ms per token
main:    total time =  1087.51 ms
...
main:     load time =   151.55 ms
main:   sample time =    17.42 ms
main:  predict time =   975.28 ms / 13.93 ms per token
main:    total time =  1147.06 ms
...
main:  predict time =  1014.35 ms / 14.49 ms per token
main:    total time =  1215.77 ms
...
main:  predict time =  6440.32 ms
main:    total time =  6805.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8080a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8068b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0790dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8080a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8080f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0790eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8068b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0790dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0790f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0790eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8080a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0790fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0790f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab079106d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8080a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0790fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab07910890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab079106d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8080f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab07910a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab07910890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    12.91 ms
whisper_print_timings:   sample time =   738.64 ms /   131 runs (    5.64 ms per run)
whisper_print_timings:   encode time =  4691.44 ms /     1 runs ( 4691.44 ms per run)
whisper_print_timings:   decode time =    15.46 ms /     2 runs (    7.73 ms per run)
whisper_print_timings:   batchd time =   711.07 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6282.17 ms
