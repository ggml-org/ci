...
- status:  SUCCESS ✅
- runtime: 4:19.73
- date:    Sun Jan 14 09:00:56 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/bca51b528820d28f54ea092fd4deaafc812f39d9
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.39 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.03 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   32.39 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  43.25 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.47 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  18.80 sec
...
main:     load time =   196.79 ms
main:   sample time =    23.46 ms
main:  predict time =   443.89 ms / 6.94 ms per token
...
main:     load time =   125.39 ms
main:   sample time =    23.54 ms
main:  predict time =   473.05 ms / 6.76 ms per token
main:    total time =   624.46 ms
...
main:  predict time =  1516.98 ms
main:    total time =  1836.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0ba038b990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0ba020c1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5602b503ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0ba038b030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0ba0390940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5602b503b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0ba020c1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5602b503ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5602b503c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5602b503b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0ba038b030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5602b503cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5602b503c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5602b503d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0ba038b990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5602b503cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5602b503d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5602b503d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0ba0390940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5602b503d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5602b503d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.66 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.99 ms
whisper_print_timings:   sample time =    55.24 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1154.35 ms /     1 runs ( 1154.35 ms per run)
whisper_print_timings:   decode time =     9.36 ms /     2 runs (    4.68 ms per run)
whisper_print_timings:   batchd time =   208.37 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1578.23 ms
...
main:     load time =    60.78 ms
main:    total time = 10601.63 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.452000 sec.)
...
main:      load time = 14798.05 ms
main:    sample time =   469.35 ms / 7.33 ms per token
main:      eval time = 20823.39 ms / 297.48 ms per token
main:     total time = 36792.28 ms
...
main:      load time =  4387.99 ms
main:    sample time =   464.65 ms / 7.26 ms per token
main:      eval time =  8411.99 ms / 120.17 ms per token
main:     total time = 13635.07 ms
