...
- status:  SUCCESS ✅
- runtime: 8:53.66
- date:    Sun Jan 14 09:13:52 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    7.85 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.55 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.58 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.73 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.06 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   73.97 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 106.24 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.79 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.78 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   28.90 sec
...
main:     load time =   650.54 ms
main:   sample time =    34.10 ms
main:  predict time =   586.85 ms / 9.17 ms per token
main:    total time =  1291.28 ms
...
main:     load time =   588.08 ms
main:   sample time =    34.43 ms
main:  predict time =   608.58 ms / 8.69 ms per token
main:    total time =  1235.65 ms
...
main:     n_decoded =      504
main:     load time =   550.40 ms
main:   sample time =   232.84 ms
main:  predict time =  2259.70 ms
main:    total time =  3086.81 ms
...
main: loaded model in   394.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f99bf4f9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f99bf37a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557f0e8c7880                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f99bf4f9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f99bf4fe940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557f0e8c8650                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f99bf37a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557f0e8c7880                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557f0e8c8fb0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557f0e8c8650                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f99bf4f9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557f0e8c9910                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557f0e8c8fb0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557f0e8ca270                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f99bf4f9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557f0e8c9910                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557f0e8ca430                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557f0e8ca270                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f99bf4fe940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557f0e8ca5f0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557f0e8ca430       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   530.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.38 ms
whisper_print_timings:   sample time =    68.84 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    21.58 ms /     1 runs (   21.58 ms per run)
whisper_print_timings:   decode time =    20.98 ms /     2 runs (   10.49 ms per run)
whisper_print_timings:   batchd time =    81.22 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   748.53 ms
...
main:     load time =   507.24 ms
main:    total time =  8103.69 ms
embd_img
...
main:      load time = 13317.07 ms
main:    sample time =   545.09 ms / 8.52 ms per token
main:      eval time = 26766.10 ms / 382.37 ms per token
main:     total time = 41556.39 ms
...
main:      load time =  6446.95 ms
main:    sample time =   534.73 ms / 8.36 ms per token
main:      eval time = 12481.54 ms / 178.31 ms per token
main:     total time = 20130.51 ms
