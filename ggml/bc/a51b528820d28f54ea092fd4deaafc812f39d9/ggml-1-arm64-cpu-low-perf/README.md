...
- status:  SUCCESS ✅
- runtime: 3:36.42
- date:    Sun Jan 14 08:57:52 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.11 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.33 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   48.77 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.09 sec
      Start  9: test3
...
main:  predict time =   875.75 ms / 13.68 ms per token
main:    total time =  1103.10 ms
...
main:     load time =   192.56 ms
main:   sample time =    17.42 ms
main:  predict time =  1073.78 ms / 15.34 ms per token
main:    total time =  1286.94 ms
...
main:     n_decoded =      504
main:     load time =   166.11 ms
main:   sample time =   126.69 ms
main:  predict time =  6175.31 ms
main:    total time =  6551.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98d4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98bcb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05e99b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98d4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98d4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05e9a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98bcb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab05e99b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05e9b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab05e9a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98d4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05e9bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab05e9b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab05e9c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98d4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05e9bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05e9c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab05e9c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98d4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab05e9c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05e9c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.50 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    65.60 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4949.69 ms /     1 runs ( 4949.69 ms per run)
whisper_print_timings:   decode time =    15.37 ms /     2 runs (    7.68 ms per run)
whisper_print_timings:   batchd time =   711.11 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5870.35 ms
