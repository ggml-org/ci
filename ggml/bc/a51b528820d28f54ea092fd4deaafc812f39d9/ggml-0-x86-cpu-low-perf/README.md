...
- status:  SUCCESS ✅
- runtime: 2:56.40
- date:    Sun Jan 14 08:55:22 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   41.00 sec
...
main:     load time =   132.03 ms
main:   sample time =    23.58 ms
main:  predict time =   654.67 ms / 10.23 ms per token
main:    total time =   823.61 ms
...
main:     load time =   130.49 ms
main:   sample time =    23.55 ms
main:  predict time =   678.74 ms / 9.70 ms per token
main:    total time =   835.27 ms
...
main:     n_decoded =      504
main:     load time =   107.62 ms
main:   sample time =   178.11 ms
main:  predict time =  2501.38 ms
main:    total time =  2833.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f589da8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f589d90b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55658772bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f589da8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f589da8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55658772c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f589d90b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55658772bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55658772d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55658772c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f589da8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55658772dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55658772d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55658772e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f589da8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55658772dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55658772e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55658772e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f589da8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55658772e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55658772e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.08 ms
whisper_print_timings:   sample time =    73.14 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1986.75 ms /     1 runs ( 1986.75 ms per run)
whisper_print_timings:   decode time =    13.28 ms /     2 runs (    6.64 ms per run)
whisper_print_timings:   batchd time =   325.56 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2499.62 ms
...
main:     load time =    68.35 ms
main:    total time = 18954.56 ms
embd_img
