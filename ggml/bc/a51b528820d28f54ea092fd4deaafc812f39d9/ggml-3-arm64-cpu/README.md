...
- status:  SUCCESS ✅
- runtime: 6:11.32
- date:    Sun Jan 14 09:12:48 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.40 sec
...
20/20 Test #20: test-backend-ops .................   Passed   40.09 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.20 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   11.50 sec
...
main:     load time =   279.76 ms
main:   sample time =    16.80 ms
main:  predict time =   849.84 ms / 13.28 ms per token
main:    total time =  1168.48 ms
...
main:     load time =   193.73 ms
main:   sample time =    16.77 ms
main:  predict time =   919.20 ms / 13.13 ms per token
main:    total time =  1132.56 ms
...
main:     n_decoded =      504
main:     load time =   156.98 ms
main:   sample time =   126.82 ms
main:  predict time =  6017.35 ms
main:    total time =  6383.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0bba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0a3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacddf2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0bba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0bbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacddf3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0a3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacddf2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacddf42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacddf3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0bba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacddf4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacddf42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacddf5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0bba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacddf4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacddf5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacddf5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0bbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacddf5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacddf5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   181.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.03 ms
whisper_print_timings:   sample time =    65.39 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4663.07 ms /     1 runs ( 4663.07 ms per run)
whisper_print_timings:   decode time =    15.37 ms /     2 runs (    7.69 ms per run)
whisper_print_timings:   batchd time =   707.66 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5651.28 ms
...
main:     load time =    80.17 ms
main:    total time = 39964.47 ms
embd_img
...
main:      load time = 14517.52 ms
main:    sample time =   517.59 ms / 8.09 ms per token
main:      eval time = 43723.25 ms / 624.62 ms per token
main:     total time = 61133.31 ms
...
main:      load time =  4358.09 ms
main:    sample time =   514.20 ms / 8.03 ms per token
main:      eval time = 17327.50 ms / 247.54 ms per token
main:     total time = 23162.90 ms
