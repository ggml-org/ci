...
- status:  SUCCESS ✅
- runtime: 1:07.02
- date:    Thu Mar  6 19:02:21 UTC 2025
...
main:     load time =   118.82 ms
main:   sample time =    23.00 ms
main:  predict time =   464.84 ms / 7.26 ms per token
main:    total time =   620.87 ms
...
main:  predict time =   492.92 ms / 7.04 ms per token
main:    total time =   654.84 ms
...
main:   sample time =   167.57 ms
main:  predict time =  1414.68 ms
main:    total time =  1721.15 ms
...
main:     load time =    74.35 ms
main:    total time =  8545.14 ms
embd_img
