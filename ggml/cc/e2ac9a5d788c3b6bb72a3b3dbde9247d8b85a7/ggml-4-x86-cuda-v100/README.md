...
- status:  SUCCESS ✅
- runtime: 6:58.45
- date:    Thu Nov 16 15:29:40 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    6.53 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    7.91 sec
      Start  6: test0
 6/17 Test  #6: test0 ............................   Passed    0.54 sec
      Start  7: test1
 7/17 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    7.86 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/18 Test  #1: test-grad0 .......................   Passed    6.59 sec
      Start  2: test-opt
 2/18 Test  #2: test-opt .........................   Passed    3.63 sec
 ...
 8/18 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/18 Test  #9: test2 ............................   Passed    7.73 sec
      Start 10: test3
...
14/18 Test #14: test-customop ....................   Passed    0.55 sec
      Start 15: test-xpos
...
main:     load time =  1604.38 ms
main:   sample time =    34.56 ms
main:  predict time =   562.60 ms / 8.79 ms per token
main:    total time =  2225.03 ms
...
main:     load time =   574.72 ms
main:   sample time =    34.19 ms
main:  predict time =   577.32 ms / 8.25 ms per token
main:    total time =  1190.12 ms
...
main:     n_decoded =      504
main:     load time =   544.76 ms
main:   sample time =   234.30 ms
main:  predict time =  2206.40 ms
main:    total time =  3028.43 ms
...
main: loaded model in   390.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd7385b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd738437190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ab7776730                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd7385b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd7385bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ab77774f0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd738437190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ab7776730                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ab7777e40                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ab77774f0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd7385b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558ab7778790                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ab7777e40                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ab77790e0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd7385b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558ab7778790                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ab7779290                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ab77790e0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd7385bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558ab7779440                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ab7779290       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1039.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.61 ms
whisper_print_timings:   sample time =    20.23 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =   471.35 ms /     1 runs (  471.35 ms per run)
whisper_print_timings:   decode time =   146.90 ms /    27 runs (    5.44 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1702.03 ms
...
main:     load time =   498.86 ms
main:    total time =  7647.53 ms
embd_img
...
main:      load time =  8130.79 ms
main:    sample time =   507.91 ms / 7.94 ms per token
main:      eval time = 24801.65 ms / 354.31 ms per token
main:     total time = 34298.07 ms
...
main:      load time =  2033.99 ms
main:    sample time =   511.60 ms / 7.99 ms per token
main:      eval time = 12404.94 ms / 177.21 ms per token
main:     total time = 15589.21 ms
