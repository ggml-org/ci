...
- status:  SUCCESS ✅
- runtime: 4:46.61
- date:    Thu Nov 16 03:28:25 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.31 sec
      Start  2: test-quantize-fns
 2/17 Test  #2: test-quantize-fns ................   Passed    0.04 sec
      Start  3: test-quantize-perf
 3/17 Test  #3: test-quantize-perf ...............   Passed    0.29 sec
      Start  4: test-mul-mat0
 4/17 Test  #4: test-mul-mat0 ....................   Passed    0.55 sec
      Start  5: test-mul-mat2
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.68 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.14 sec
      Start  2: test-opt
 2/18 Test  #2: test-opt .........................   Passed    2.02 sec
...
main:     load time =   258.28 ms
main:   sample time =    17.27 ms
main:  predict time =   809.15 ms / 12.64 ms per token
main:    total time =  1106.53 ms
...
main:     load time =   175.86 ms
main:   sample time =    17.26 ms
main:  predict time =   878.35 ms / 12.55 ms per token
main:    total time =  1074.35 ms
...
main:     n_decoded =      504
main:     load time =   144.48 ms
main:   sample time =   126.94 ms
main:  predict time =  5822.52 ms
main:    total time =  6174.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb2b6a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb29eb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafc11bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb2b6a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb2b6f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafc11c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb29eb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafc11bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafc11d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafc11c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb2b6a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafc11dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafc11d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafc11e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb2b6a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafc11dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafc11e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafc11e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb2b6f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafc11e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafc11e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   172.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.92 ms
whisper_print_timings:   sample time =    19.50 ms /    27 runs (    0.72 ms per run)
whisper_print_timings:   encode time =  4633.92 ms /     1 runs ( 4633.92 ms per run)
whisper_print_timings:   decode time =   198.55 ms /    27 runs (    7.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5040.92 ms
...
main:     load time =    78.28 ms
main:    total time = 39334.46 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.243000 sec.)
...
main:      load time = 12719.07 ms
main:    sample time =   535.05 ms / 8.36 ms per token
main:      eval time = 43471.38 ms / 621.02 ms per token
main:     total time = 59097.55 ms
...
main:      load time =  4374.67 ms
main:    sample time =   526.93 ms / 8.23 ms per token
main:      eval time = 17635.47 ms / 251.94 ms per token
main:     total time = 23508.30 ms
