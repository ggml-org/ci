...
- status:  SUCCESS ✅
- runtime: 2:36.79
- date:    Thu Nov 16 03:10:03 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.95 sec
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.95 sec
      Start  9: test3
...
main:     load time =   189.21 ms
main:   sample time =    18.03 ms
main:  predict time =   831.36 ms / 12.99 ms per token
main:    total time =  1060.56 ms
...
main:     load time =   188.13 ms
main:   sample time =    17.42 ms
main:  predict time =   897.60 ms / 12.82 ms per token
main:    total time =  1105.96 ms
...
main:     n_decoded =      504
main:     load time =   168.30 ms
main:   sample time =   132.73 ms
main:  predict time =  6001.08 ms
main:    total time =  6383.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff819aa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8182b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad355ab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff819aa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff819af900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad355b940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8182b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad355ab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad355c290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad355b940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff819aa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad355cbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad355c290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad355d530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff819aa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad355cbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad355d6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad355d530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff819af900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad355d890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad355d6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4725.21 ms /     1 runs ( 4725.21 ms per run)
whisper_print_timings:   decode time =   201.71 ms /    27 runs (    7.47 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5085.09 ms
...
main:     load time =    92.65 ms
main:    total time = 40111.87 ms
embd_img
