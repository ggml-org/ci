...
- status:  SUCCESS ✅
- runtime: 2:03.45
- date:    Thu Nov 16 15:09:36 UTC 2023
...
main:  predict time =   593.29 ms / 9.27 ms per token
main:    total time =   756.58 ms
...
main:  predict time =   619.91 ms / 8.86 ms per token
main:    total time =   773.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c91b3b960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c919bc190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55dff8d6bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c91b3b010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c91b40900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55dff8d6c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c919bc190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55dff8d6bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55dff8d6d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55dff8d6c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c91b3b010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55dff8d6dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55dff8d6d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55dff8d6e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c91b3b960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55dff8d6dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55dff8d6e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55dff8d6e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c91b40900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55dff8d6e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55dff8d6e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.24 ms
whisper_print_timings:   sample time =    16.40 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1985.58 ms /     1 runs ( 1985.58 ms per run)
whisper_print_timings:   decode time =   134.50 ms /    27 runs (    4.98 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2239.27 ms
