...
- status:  SUCCESS ✅
- runtime: 5:08.37
- date:    Wed Jul 26 05:20:14 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/10 Test  #8: test2 ............................   Passed   16.20 sec
      Start  9: test3
 9/10 Test  #9: test3 ............................   Passed    0.90 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/11 Test  #1: test-grad0 .......................   Passed    4.72 sec
      Start  2: test-opt
 2/11 Test  #2: test-opt .........................   Passed    2.11 sec
 ...
 8/11 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/11 Test  #9: test2 ............................   Passed   16.12 sec
      Start 10: test3
...
main:     load time =   187.91 ms
main:   sample time =    34.72 ms
main:  predict time =   599.96 ms / 9.37 ms per token
main:    total time =   884.60 ms
...
main: mem per token =  2015100 bytes
main:     load time =   191.07 ms
main:   sample time =    35.58 ms
main:  predict time =   600.78 ms / 8.58 ms per token
main:    total time =   867.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4bea6f4870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4bea575140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558361b57aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4bea6f3f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4bea6f97c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558361b58810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4bea575140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558361b57aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558361b59110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558361b58810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4bea6f3f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558361b59a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558361b59110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558361b5a310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4bea6f4870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558361b59a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558361b5a470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558361b5a310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4bea6f97c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558361b5a5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558361b5a470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 17851.71 ms
main:    sample time =   593.58 ms / 9.27 ms per token
main:      eval time = 26377.41 ms / 376.82 ms per token
main:     total time = 46226.86 ms
...
main:      load time =  8926.33 ms
main:    sample time =   593.21 ms / 9.27 ms per token
main:      eval time = 13208.78 ms / 188.70 ms per token
main:     total time = 23400.44 ms
...
```diff
--- /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/stdall	2023-07-25 15:33:30.111440934 +0000
+++ /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/stdall	2023-07-26 05:20:14.648404721 +0000
@@ -1,9 +1,10 @@
-rm: cannot remove '/home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/*.log': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/*.exit': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/*.md': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/*.md': No such file or directory
...
-+ tee /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_debug.log
 + rm -rf build-ci-debug
++ tee /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_debug-cmake.log
...
-user	0m0.428s
-sys	0m0.120s
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_debug-make.log
+real	0m0.559s
+user	0m0.407s
+sys	0m0.150s
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_debug-make.log
 + make -j
...
-user	0m37.688s
-sys	0m4.497s
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_debug-ctest.log
+real	0m11.310s
+user	0m37.835s
+sys	0m4.010s
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
- 1/10 Test  #1: test-grad0 .......................   Passed    4.55 sec
+ 1/10 Test  #1: test-grad0 .......................   Passed    4.39 sec
       Start  2: test-quantize-fns
  2/10 Test  #2: test-quantize-fns ................   Passed    0.01 sec
       Start  3: test-quantize-perf
...
+ 5/10 Test  #5: test-mul-mat2 ....................   Passed    7.42 sec
  ...
  7/10 Test  #7: test1 ............................   Passed    0.01 sec
       Start  8: test2
- 8/10 Test  #8: test2 ............................   Passed   16.19 sec
+ 8/10 Test  #8: test2 ............................   Passed   16.20 sec
       Start  9: test3
  9/10 Test  #9: test3 ............................   Passed    0.90 sec
       Start 10: test-pool
...
+sys	0m5.270s
 ...
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_release.log
 + rm -rf build-ci-release
++ tee /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_release.log
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_release-cmake.log
...
-user	0m0.422s
-sys	0m0.171s
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_release-make.log
+real	0m0.544s
+user	0m0.421s
+sys	0m0.129s
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_release-make.log
 + make -j
...
+sys	0m3.524s
 + '[' -z ']'
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/ctest_release-ctest.log
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/ctest_release-ctest.log
 + ctest --output-on-failure
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
- 1/11 Test  #1: test-grad0 .......................   Passed    5.09 sec
+ 1/11 Test  #1: test-grad0 .......................   Passed    4.72 sec
       Start  2: test-opt
- 2/11 Test  #2: test-opt .........................   Passed    1.96 sec
+ 2/11 Test  #2: test-opt .........................   Passed    2.11 sec
       Start  3: test-quantize-fns
  3/11 Test  #3: test-quantize-fns ................   Passed    0.00 sec
       Start  4: test-quantize-perf
...
+ 6/11 Test  #6: test-mul-mat2 ....................   Passed    2.81 sec
  ...
  8/11 Test  #8: test1 ............................   Passed    0.01 sec
       Start  9: test2
- 9/11 Test  #9: test2 ............................   Passed   16.16 sec
+ 9/11 Test  #9: test2 ............................   Passed   16.12 sec
       Start 10: test3
 10/11 Test #10: test3 ............................   Passed    0.90 sec
       Start 11: test-pool
...
++ tee /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/gpt_2.log
 + local out=models-mnt/gpt-2
 + local url=https://huggingface.co/ggerganov/ggml/resolve/main/ggml-model-gpt-2-117M.bin
-+ tee /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/gpt_2.log
 ++ pwd
...
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/gpt_2-tg.log
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -562,15 +543,15 @@
 ...
 main: mem per token =  2015100 bytes
-main:     load time =   198.90 ms
+main:     load time =   187.91 ms
 main:   sample time =    34.72 ms
-main:  predict time =   589.25 ms / 9.21 ms per token
-main:    total time =   887.11 ms
+main:  predict time =   599.96 ms / 9.37 ms per token
+main:    total time =   884.60 ms
...
@@ -596,13 +577,13 @@
 ...
 main: mem per token =  2015100 bytes
 main:     load time =   191.07 ms
-main:   sample time =    34.79 ms
-main:  predict time =   653.71 ms / 9.34 ms per token
-main:    total time =   918.34 ms
-
-real	0m0.928s
-user	0m2.702s
-sys	0m0.194s
...
@@ -610,8 +591,8 @@
 ...
 + cd /home/ggml/work/ggml
 + cd build-ci-release
++ tee /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/mnist.log
 + set -e
-+ tee /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/mnist.log
...
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/mnist-mnist.log
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
@@ -778,67 +759,67 @@
 ...
 TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3             DATA             NAME
-f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7feb59956870                       fc2_weight
-f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7feb597d7140                       fc1_weight
-f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aaa1f7faa0                            input
-f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7feb59955f70                         fc1_bias
-f32    NONE                1 10 1 1 1                4               40               40               40   0x7feb5995b7c0                         fc2_bias
+f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4bea6f4870                       fc2_weight
+f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4bea575140                       fc1_weight
+f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558361b57aa0                            input
+f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4bea6f3f70                         fc1_bias
+f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4bea6f97c0                         fc2_bias
 ...
 ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
-DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aaa1f80810                           node_0
-SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7feb597d7140                       fc1_weight
-SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aaa1f7faa0                            input
-
-DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aaa1f81110                           node_1
-SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aaa1f80810                           node_0
-SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7feb59955f70                         fc1_bias
-
-DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aaa1f81a10                           node_2
-SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aaa1f81110                           node_1
-
-DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aaa1f82310                           node_3
-SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7feb59956870                       fc2_weight
-SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aaa1f81a10                           node_2
-
-DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aaa1f82470                           node_4
-SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aaa1f82310                           node_3
-SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7feb5995b7c0                         fc2_bias
+DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558361b58810                           node_0
+SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4bea575140                       fc1_weight
+SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558361b57aa0                            input
+
...
-DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55aaa1f825d0                            probs
-SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aaa1f82470       mnist_eval: exported compute graph to 'mnist.ggml'
+DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558361b5a5d0                            probs
+SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558361b5a470       mnist_eval: exported compute graph to 'mnist.ggml'
                     node_4
...
-+ tee /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/mpt.log
++ tee /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/mpt.log
...
-2023-07-25 15:30:24 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
+2023-07-26 05:16:48 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
 + cd /home/ggml/work/ggml
...
@@ -888,7 +869,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-07-25 15:30:24 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
+2023-07-26 05:16:49 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
 + cd /home/ggml/work/ggml
...
@@ -899,7 +880,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-07-25 15:30:25 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
+2023-07-26 05:16:49 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
 + cd /home/ggml/work/ggml
...
@@ -910,7 +891,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-07-25 15:30:25 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
+2023-07-26 05:16:50 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
 + cd /home/ggml/work/ggml
...
@@ -921,7 +902,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-07-25 15:30:25 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
+2023-07-26 05:16:50 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
 + cd /home/ggml/work/ggml
...
-main: quantize time = 52746.55 ms
-main:    total time = 52746.55 ms
-+ tee -a /home/ggml/results/ggml/73/536d9d35637ba87f9de4f383cc73872c925c44/ggml-4-x86-cuda-v100/mpt-tg.log
+main: quantize time = 52791.17 ms
+main:    total time = 52791.17 ms
++ tee -a /home/ggml/results/ggml/cc/d9f7cc329913af0dc639c1521dabab399e8234/ggml-4-x86-cuda-v100/mpt-tg.log
 + ./bin/mpt --model ../models-mnt/mpt/7B/ggml-model-f16.bin -s 1234 -n 64 -p 'I believe the meaning of life is'
 main: seed      = 1234
 main: n_threads = 4
@@ -1408,15 +1389,15 @@
 ...
 main: sampled tokens =       64
 main:  mem per token =   351304 bytes
-main:      load time =  6427.56 ms
-main:    sample time =   575.52 ms / 8.99 ms per token
-main:      eval time = 25479.03 ms / 363.99 ms per token
-main:     total time = 33878.63 ms
-
-real	0m33.928s
-user	1m47.704s
-sys	0m6.631s
...
@@ -1463,14 +1444,14 @@
 ...
 main: sampled tokens =       64
 main:  mem per token =   335944 bytes
-main:      load time =  1783.78 ms
-main:    sample time =   572.07 ms / 8.94 ms per token
-main:      eval time = 12533.97 ms / 179.06 ms per token
-main:     total time = 15868.70 ms
-
-real	0m15.887s
-user	0m54.241s
-sys	0m2.028s
