...
- status:  SUCCESS ✅
- runtime: 3:37.27
- date:    Thu Jan 11 07:59:22 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.74 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.60 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.51 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   49.11 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  72.54 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.29 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.98 sec
...
main:     load time =   192.45 ms
main:   sample time =    17.21 ms
main:  predict time =   836.57 ms / 13.07 ms per token
...
main:  predict time =   911.02 ms / 13.01 ms per token
main:    total time =  1120.70 ms
...
main:     n_decoded =      504
main:     load time =   159.27 ms
main:   sample time =   128.27 ms
main:  predict time =  6145.02 ms
main:    total time =  6514.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb83aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb822b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadec83b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb83aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb83af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadec84960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb822b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadec83b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadec852c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadec84960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb83aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadec85c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadec852c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadec86580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb83aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadec85c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadec86740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadec86580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb83af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadec86900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadec86740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.07 ms
whisper_print_timings:   sample time =    65.83 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4743.66 ms /     1 runs ( 4743.66 ms per run)
whisper_print_timings:   decode time =    15.26 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   710.26 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5661.81 ms
...
main:     load time =    94.27 ms
main:    total time = 40325.16 ms
embd_img
