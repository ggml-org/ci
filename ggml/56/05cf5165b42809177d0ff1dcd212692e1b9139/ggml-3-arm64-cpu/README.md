...
- status:  SUCCESS ✅
- runtime: 5:34.65
- date:    Thu Jan 11 08:08:04 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   40.14 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.68 sec
...
main:     load time =   191.03 ms
main:   sample time =    17.15 ms
main:  predict time =   822.83 ms / 12.86 ms per token
main:    total time =  1052.81 ms
...
main:     load time =   185.77 ms
main:   sample time =    17.26 ms
main:  predict time =   903.97 ms / 12.91 ms per token
main:    total time =  1109.96 ms
...
main:   sample time =   126.98 ms
main:  predict time =  6010.98 ms
main:    total time =  6375.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8163a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff814bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf59cfb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8163a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8163f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf59d0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff814bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf59cfb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf59d12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf59d0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8163a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf59d1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf59d12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf59d2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8163a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf59d1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf59d2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf59d2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8163f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf59d2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf59d2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   193.88 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.71 ms
whisper_print_timings:   sample time =    65.54 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4635.46 ms /     1 runs ( 4635.46 ms per run)
whisper_print_timings:   decode time =    15.12 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   706.82 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5635.88 ms
...
main:      load time =  5881.28 ms
main:    sample time =   521.40 ms / 8.15 ms per token
main:      eval time = 43788.26 ms / 625.55 ms per token
main:     total time = 52563.63 ms
...
main:      load time =  1547.25 ms
main:    sample time =   517.27 ms / 8.08 ms per token
main:      eval time = 17370.80 ms / 248.15 ms per token
main:     total time = 20395.53 ms
