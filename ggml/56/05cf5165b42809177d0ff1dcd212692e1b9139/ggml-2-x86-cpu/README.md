...
- status:  SUCCESS ✅
- runtime: 3:48.71
- date:    Thu Jan 11 20:10:07 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   31.84 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.01 sec
...
main:  predict time =   462.77 ms / 7.23 ms per token
main:    total time =   675.71 ms
...
main:  predict time =   479.07 ms / 6.84 ms per token
main:    total time =   631.99 ms
...
main:  predict time =  1516.57 ms
main:    total time =  1830.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff203393990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff2032141a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56511ec37b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff203393030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff203398940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56511ec38960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff2032141a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56511ec37b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56511ec392c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56511ec38960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff203393030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56511ec39c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56511ec392c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56511ec3a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff203393990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56511ec39c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56511ec3a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56511ec3a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff203398940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56511ec3a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56511ec3a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.03 ms
whisper_print_timings:   sample time =    54.88 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1279.60 ms /     1 runs ( 1279.60 ms per run)
whisper_print_timings:   decode time =     9.68 ms /     2 runs (    4.84 ms per run)
whisper_print_timings:   batchd time =   211.57 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1701.05 ms
...
main:      load time =  5568.86 ms
main:    sample time =   468.96 ms / 7.33 ms per token
main:      eval time = 20886.68 ms / 298.38 ms per token
main:     total time = 27597.05 ms
...
main:      load time =  1206.15 ms
main:    sample time =   532.21 ms / 8.32 ms per token
main:      eval time = 10299.55 ms / 147.14 ms per token
main:     total time = 12417.25 ms
