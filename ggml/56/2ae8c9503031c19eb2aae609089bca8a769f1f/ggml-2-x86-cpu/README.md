...
- status:  SUCCESS ✅
- runtime: 3:51.95
- date:    Wed Dec 27 09:20:04 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   26.51 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.64 sec
...
main:     load time =   181.94 ms
main:   sample time =    23.45 ms
main:  predict time =   436.98 ms / 6.83 ms per token
main:    total time =   654.85 ms
...
main:  predict time =   448.44 ms / 6.41 ms per token
main:    total time =   601.01 ms
...
main:  predict time =  1456.54 ms
main:    total time =  1766.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa3b6ae8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa3b69691a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d1fc7c9b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa3b6ae8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa3b6aed940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d1fc7ca960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa3b69691a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d1fc7c9b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d1fc7cb2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d1fc7ca960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa3b6ae8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d1fc7cbc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d1fc7cb2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d1fc7cc580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa3b6ae8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d1fc7cbc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d1fc7cc740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d1fc7cc580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa3b6aed940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d1fc7cc900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d1fc7cc740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   119.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.68 ms
whisper_print_timings:   sample time =    55.37 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1158.37 ms /     1 runs ( 1158.37 ms per run)
whisper_print_timings:   decode time =     9.99 ms /     2 runs (    4.99 ms per run)
whisper_print_timings:   batchd time =   210.41 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1572.08 ms
...
main:      load time = 11149.83 ms
main:    sample time =   466.76 ms / 7.29 ms per token
main:      eval time = 20029.53 ms / 286.14 ms per token
main:     total time = 32318.54 ms
...
main:      load time =  4382.89 ms
main:    sample time =   464.37 ms / 7.26 ms per token
main:      eval time =  8103.94 ms / 115.77 ms per token
main:     total time = 13325.93 ms
