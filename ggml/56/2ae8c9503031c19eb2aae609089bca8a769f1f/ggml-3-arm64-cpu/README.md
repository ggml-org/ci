...
- status:  SUCCESS ✅
- runtime: 6:45.96
- date:    Wed Dec 27 09:33:14 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.33 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.64 sec
...
20/20 Test #20: test-backend-ops .................   Passed    9.95 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  18.65 sec
...
main:     load time =   265.25 ms
main:   sample time =    16.98 ms
main:  predict time =   813.09 ms / 12.70 ms per token
main:    total time =  1117.14 ms
...
main:  predict time =   880.31 ms / 12.58 ms per token
main:    total time =  1079.64 ms
...
main:     n_decoded =      504
main:     load time =   143.46 ms
main:   sample time =   127.45 ms
main:  predict time =  5880.53 ms
main:    total time =  6232.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d57a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d3fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeb958b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d57a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d57f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeb959960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d3fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeb958b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeb95a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeb959960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d57a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeb95ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeb95a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeb95b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d57a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeb95ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeb95b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeb95b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d57f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeb95b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeb95b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.83 ms
whisper_print_timings:   sample time =    65.26 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4658.41 ms /     1 runs ( 4658.41 ms per run)
whisper_print_timings:   decode time =    15.12 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   707.91 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5641.26 ms
...
main:     load time =    78.50 ms
main:    total time = 39554.86 ms
embd_img
...
main:      load time = 12477.88 ms
main:    sample time =   521.06 ms / 8.14 ms per token
main:      eval time = 43493.99 ms / 621.34 ms per token
main:     total time = 58868.94 ms
...
main:      load time =  4342.22 ms
main:    sample time =   516.53 ms / 8.07 ms per token
main:      eval time = 17140.34 ms / 244.86 ms per token
main:     total time = 22953.66 ms
