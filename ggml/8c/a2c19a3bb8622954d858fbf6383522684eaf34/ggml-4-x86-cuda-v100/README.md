...
- status:  SUCCESS ✅
- runtime: 4:53.10
- date:    Fri Sep 15 18:29:27 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.86 sec
      Start  2: test-opt
...
main:     load time =   321.30 ms
main:   sample time =    34.59 ms
main:  predict time =   552.49 ms / 8.63 ms per token
main:    total time =   929.16 ms
...
main:     load time =   197.76 ms
main:   sample time =    34.38 ms
main:  predict time =   572.04 ms / 8.17 ms per token
main:    total time =   809.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f21a02098d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f21a008a160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561a849c7ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f21a0208fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f21a020e840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561a849c8850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f21a008a160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561a849c7ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561a849c9170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561a849c8850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f21a0208fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561a849c9a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561a849c9170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561a849ca3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f21a02098d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561a849c9a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561a849ca530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561a849ca3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f21a020e840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x561a849ca6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561a849ca530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   172.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.57 ms
whisper_print_timings:   sample time =    22.73 ms /    27 runs (    0.84 ms per run)
whisper_print_timings:   encode time =  1846.94 ms /     1 runs ( 1846.94 ms per run)
whisper_print_timings:   decode time =   151.00 ms /    27 runs (    5.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2271.48 ms
```
### mpt
...
main:      load time =  6986.04 ms
main:    sample time =   614.83 ms / 9.61 ms per token
main:      eval time = 25107.42 ms / 358.68 ms per token
main:     total time = 33626.28 ms
...
main:      load time =  1679.63 ms
main:    sample time =   615.43 ms / 9.62 ms per token
main:      eval time = 12377.00 ms / 176.81 ms per token
main:     total time = 15310.31 ms
