...
- status:  SUCCESS ✅
- runtime: 3:25.32
- date:    Fri Sep 15 18:03:28 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.97 sec
...
main:     load time =   181.69 ms
main:   sample time =    17.80 ms
main:  predict time =   876.48 ms / 12.52 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8626a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff860eb160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadaa63ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86269fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8626f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadaa64850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff860eb160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadaa63ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadaa65170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadaa64850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86269fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadaa65a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadaa65170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadaa663b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8626a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadaa65a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadaa66530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadaa663b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8626f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadaa666b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadaa66530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.68 ms
whisper_print_timings:   sample time =    20.38 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  4608.22 ms /     1 runs ( 4608.22 ms per run)
whisper_print_timings:   decode time =   181.10 ms /    27 runs (    6.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  4993.87 ms
```
### mpt
...
main:      load time =  5378.01 ms
main:    sample time =   614.08 ms / 9.59 ms per token
main:      eval time = 43957.47 ms / 627.96 ms per token
main:     total time = 52325.44 ms
...
main:      load time =  1551.75 ms
main:    sample time =   609.49 ms / 9.52 ms per token
main:      eval time = 17300.91 ms / 247.16 ms per token
main:     total time = 20419.06 ms
