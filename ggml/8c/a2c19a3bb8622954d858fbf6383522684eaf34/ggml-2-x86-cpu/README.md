...
- status:  SUCCESS ✅
- runtime: 2:20.44
- date:    Fri Sep 15 18:01:11 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/8ca2c19a3bb8622954d858fbf6383522684eaf34
...
main:  predict time =   441.39 ms / 6.90 ms per token
main:    total time =   608.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f69d49728d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f69d47f3160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56162d04dac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f69d4971fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f69d4977840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56162d04e850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f69d47f3160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56162d04dac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56162d04f170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56162d04e850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f69d4971fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56162d04fa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56162d04f170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56162d0503b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f69d49728d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56162d04fa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56162d050530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56162d0503b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f69d4977840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56162d0506b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56162d050530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    88.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.59 ms
whisper_print_timings:   sample time =    16.57 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1157.46 ms /     1 runs ( 1157.46 ms per run)
whisper_print_timings:   decode time =    94.01 ms /    27 runs (    3.48 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1407.30 ms
```
### mpt
...
main:      load time =  4643.88 ms
main:    sample time =   467.75 ms / 7.31 ms per token
main:      eval time = 19304.39 ms / 275.78 ms per token
main:     total time = 25053.71 ms
...
main:      load time =  1276.09 ms
main:    sample time =   468.21 ms / 7.32 ms per token
main:      eval time =  8073.60 ms / 115.34 ms per token
main:     total time = 10189.98 ms
