...
- status:  SUCCESS ✅
- runtime: 4:02.42
- date:    Tue May 14 16:23:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.41 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   33.04 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.64 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.12 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.86 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    5.56 sec
      Start  4: test-mul-mat0
...
main:     load time =   140.60 ms
main:   sample time =    16.86 ms
main:  predict time =   903.72 ms / 14.12 ms per token
main:    total time =  1082.67 ms
...
main:     load time =   140.21 ms
main:   sample time =    16.99 ms
main:  predict time =  1015.72 ms / 14.51 ms per token
main:    total time =  1175.48 ms
...
main:     load time =   172.07 ms
main:   sample time =    16.79 ms
main:  predict time =  1006.08 ms / 14.37 ms per token
main:    total time =  1198.24 ms
...
main:     n_decoded =      504
main:     load time =   143.55 ms
main:   sample time =   126.99 ms
main:  predict time =  6630.20 ms
main:    total time =  6983.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe75e4c8aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe75e4c72b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb235f46cece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe75e4c8aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe75e4c8af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb235f46cfab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe75e4c72b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb235f46cece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb235f46d0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb235f46cfab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe75e4c8aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb235f46d0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb235f46d0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb235f46d16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe75e4c8aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb235f46d0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb235f46d1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb235f46d16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe75e4c8af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb235f46d1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb235f46d1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    99.31 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.24 ms
whisper_print_timings:   sample time =    64.28 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4671.06 ms /     1 runs ( 4671.06 ms per run)
whisper_print_timings:   decode time =    14.55 ms /     2 runs (    7.27 ms per run)
whisper_print_timings:   batchd time =   735.69 ms /   125 runs (    5.89 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.51 ms
...
main:     load time =    88.25 ms
main:    total time = 39982.95 ms
embd_img
