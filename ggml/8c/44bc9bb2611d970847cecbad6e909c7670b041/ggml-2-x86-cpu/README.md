...
- status:  SUCCESS ✅
- runtime: 2:10.99
- date:    Tue May 14 16:31:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.49 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.15 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.82 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   15.99 sec
...
main:     load time =   107.79 ms
main:   sample time =    23.94 ms
main:  predict time =   508.24 ms / 7.94 ms per token
main:    total time =   652.33 ms
...
main:   sample time =    24.07 ms
main:  predict time =   538.04 ms / 7.69 ms per token
main:    total time =   692.44 ms
...
main:     n_decoded =      504
main:     load time =   105.76 ms
main:   sample time =   178.58 ms
main:  predict time =  1884.69 ms
main:    total time =  2201.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7dfbfbcfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7dfbfbb7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x604c007b3ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7dfbfbcfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7dfbfbcff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x604c007b4ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7dfbfbb7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x604c007b3ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x604c007b5410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x604c007b4ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7dfbfbcfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x604c007b5d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x604c007b5410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x604c007b66d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7dfbfbcfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x604c007b5d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x604c007b6890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x604c007b66d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7dfbfbcff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x604c007b6a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x604c007b6890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =    55.00 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.32 ms /     1 runs ( 1159.32 ms per run)
whisper_print_timings:   decode time =    12.84 ms /     2 runs (    6.42 ms per run)
whisper_print_timings:   batchd time =   217.63 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1541.77 ms
...
main:     load time =    66.36 ms
main:    total time = 10720.71 ms
embd_img
