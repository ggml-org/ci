...
- status:  SUCCESS ✅
- runtime: 3:11.00
- date:    Tue May 14 16:24:01 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.11 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.96 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.64 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.54 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.61 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   16.86 sec
...
main:     load time =   154.04 ms
main:   sample time =    18.71 ms
main:  predict time =   918.38 ms / 14.35 ms per token
main:    total time =  1112.81 ms
...
main:     load time =   182.24 ms
main:   sample time =    18.22 ms
main:  predict time =  1024.11 ms / 14.63 ms per token
main:    total time =  1227.88 ms
...
main:     n_decoded =      504
main:     load time =   152.19 ms
main:   sample time =   128.01 ms
main:  predict time =  6461.39 ms
main:    total time =  6824.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf588e214a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf588e1fcb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc1cceca33ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf588e214a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf588e214f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc1cceca34ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf588e1fcb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc1cceca33ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc1cceca35410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc1cceca34ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf588e214a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc1cceca35d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc1cceca35410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc1cceca366d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf588e214a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc1cceca35d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc1cceca36890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc1cceca366d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf588e214f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc1cceca36a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc1cceca36890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.58 ms
whisper_print_timings:   sample time =    66.66 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4686.32 ms /     1 runs ( 4686.32 ms per run)
whisper_print_timings:   decode time =    14.96 ms /     2 runs (    7.48 ms per run)
whisper_print_timings:   batchd time =   715.39 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5609.68 ms
...
main:     load time =    87.22 ms
main:    total time = 40078.20 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.272000 sec.)
