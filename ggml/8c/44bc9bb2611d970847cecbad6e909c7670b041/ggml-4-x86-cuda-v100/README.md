...
- status:  SUCCESS ✅
- runtime: 10:44.77
- date:    Tue May 14 16:51:47 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.76 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   37.02 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   11.06 sec
...
22/22 Test #22: test-backend-ops .................   Passed  168.90 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 252.70 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/23 Test  #1: test-grad0 .......................   Passed    4.66 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    3.25 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   20.72 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    6.20 sec
...
23/23 Test #23: test-backend-ops .................   Passed   41.02 sec
...
main:     load time =   151.40 ms
main:   sample time =    34.94 ms
main:  predict time =   628.83 ms / 9.83 ms per token
main:    total time =   834.39 ms
...
main:   sample time =    36.14 ms
main:  predict time =   735.28 ms / 10.50 ms per token
main:    total time =   923.96 ms
...
main:     load time =   187.75 ms
main:   sample time =    35.04 ms
main:  predict time =   730.74 ms / 10.44 ms per token
main:    total time =   958.90 ms
...
main:     n_decoded =      504
main:     load time =   149.11 ms
main:   sample time =   241.32 ms
main:  predict time =  3113.69 ms
main:    total time =  3548.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f92eeafa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f92ee97b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561e5b51aaf0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f92eeafa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f92eeaff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561e5b51b8c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f92ee97b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561e5b51aaf0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561e5b51c220                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561e5b51b8c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f92eeafa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561e5b51cb80                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561e5b51c220                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561e5b51d4e0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f92eeafa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561e5b51cb80                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561e5b51d6a0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561e5b51d4e0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f92eeaff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561e5b51d860                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561e5b51d6a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   517.50 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.05 ms
whisper_print_timings:   sample time =    70.07 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    48.36 ms /     1 runs (   48.36 ms per run)
whisper_print_timings:   decode time =    12.49 ms /     2 runs (    6.24 ms per run)
whisper_print_timings:   batchd time =    79.91 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   756.43 ms
...
main:     load time =   109.45 ms
main:    total time = 17900.68 ms
embd_img
