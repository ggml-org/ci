...
- status:  SUCCESS ✅
- runtime: 5:09.50
- date:    Thu Feb 22 06:30:48 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.96 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  103.37 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 144.82 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   21.03 sec
...
main:  predict time =   904.88 ms / 14.14 ms per token
main:    total time =  1099.38 ms
...
main:     load time =   156.21 ms
main:   sample time =    17.09 ms
main:  predict time =   994.78 ms / 14.21 ms per token
main:    total time =  1170.78 ms
...
main:  predict time =   989.85 ms / 14.14 ms per token
main:    total time =  1195.51 ms
...
main:     n_decoded =      504
main:     load time =   159.77 ms
main:   sample time =   128.56 ms
main:  predict time =  6608.80 ms
main:    total time =  7058.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e4ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e36b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad70a2ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e4ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e4ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad70a3ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e36b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad70a2ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad70a4410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad70a3ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e4ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad70a4d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad70a4410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad70a56d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e4ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad70a4d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad70a5890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad70a56d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e4ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad70a5a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad70a5890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    65.65 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4808.69 ms /     1 runs ( 4808.69 ms per run)
whisper_print_timings:   decode time =    14.82 ms /     2 runs (    7.41 ms per run)
whisper_print_timings:   batchd time =   713.06 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5732.10 ms
...
main:     load time =    88.92 ms
main:    total time = 40500.27 ms
embd_img
