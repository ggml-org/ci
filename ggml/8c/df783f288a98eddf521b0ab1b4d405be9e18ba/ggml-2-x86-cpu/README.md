...
- status:  SUCCESS ✅
- runtime: 3:19.73
- date:    Thu Feb 22 18:43:44 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/8cdf783f288a98eddf521b0ab1b4d405be9e18ba
...
20/20 Test #20: test-backend-ops .................   Passed   81.18 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.14 sec
...
main:     load time =   176.46 ms
main:   sample time =    23.57 ms
main:  predict time =   486.11 ms / 7.60 ms per token
main:    total time =   698.84 ms
...
main:     load time =   109.78 ms
main:   sample time =    23.57 ms
main:  predict time =   510.77 ms / 7.30 ms per token
main:    total time =   646.18 ms
...
main:  predict time =   517.28 ms / 7.39 ms per token
main:    total time =   668.42 ms
...
main:   sample time =   177.81 ms
main:  predict time =  1819.50 ms
main:    total time =  2132.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f54ec832990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f54ec6b31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fd78677ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f54ec832030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f54ec837940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fd78678ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f54ec6b31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55fd78677ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fd78679410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55fd78678ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f54ec832030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fd78679d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55fd78679410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fd7867a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f54ec832990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55fd78679d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fd7867a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55fd7867a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f54ec837940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55fd7867aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55fd7867a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.72 ms
whisper_print_timings:   sample time =    55.13 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1181.15 ms /     1 runs ( 1181.15 ms per run)
whisper_print_timings:   decode time =    12.12 ms /     2 runs (    6.06 ms per run)
whisper_print_timings:   batchd time =   212.19 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1597.97 ms
...
main:     load time =    64.99 ms
main:    total time = 10673.53 ms
embd_img
