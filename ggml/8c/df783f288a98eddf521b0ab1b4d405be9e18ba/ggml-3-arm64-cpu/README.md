...
- status:  SUCCESS ✅
- runtime: 4:15.98
- date:    Thu Feb 22 18:36:55 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    4.82 sec
...
20/20 Test #20: test-backend-ops .................   Passed   97.18 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.14 sec
...
main:  predict time =   918.99 ms / 14.36 ms per token
main:    total time =  1105.78 ms
...
main:  predict time =   975.81 ms / 13.94 ms per token
main:    total time =  1150.64 ms
...
main:     load time =   175.98 ms
main:   sample time =    16.97 ms
main:  predict time =   975.29 ms / 13.93 ms per token
main:    total time =  1171.38 ms
...
main:     n_decoded =      504
main:     load time =   152.20 ms
main:   sample time =   128.43 ms
main:  predict time =  6429.37 ms
main:    total time =  6792.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff961ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9606b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0294cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff961ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff961ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0294dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9606b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0294cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0294e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0294dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff961ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0294ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0294e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0294f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff961ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0294ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0294f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0294f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff961ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0294fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0294f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.67 ms
whisper_print_timings:   sample time =    65.82 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4685.79 ms /     1 runs ( 4685.79 ms per run)
whisper_print_timings:   decode time =    14.65 ms /     2 runs (    7.32 ms per run)
whisper_print_timings:   batchd time =   710.83 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5601.00 ms
...
main:     load time =    91.57 ms
main:    total time = 39762.67 ms
embd_img
