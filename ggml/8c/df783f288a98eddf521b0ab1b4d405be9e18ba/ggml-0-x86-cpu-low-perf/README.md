...
- status:  SUCCESS ✅
- runtime: 4:14.60
- date:    Thu Feb 22 18:29:52 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.94 sec
...
20/20 Test #20: test-backend-ops .................   Passed   81.45 sec
...
main:  predict time =   719.99 ms / 11.25 ms per token
...
main:     load time =   131.47 ms
main:   sample time =    23.71 ms
main:  predict time =   766.75 ms / 10.95 ms per token
...
main:  predict time =  3126.18 ms
main:    total time =  3460.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1a4c05a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1a4bedb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56504beaace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1a4c05a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1a4c05f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56504beabab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1a4bedb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56504beaace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56504beac410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56504beabab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1a4c05a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56504beacd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56504beac410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56504bead6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1a4c05a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56504beacd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56504bead890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56504bead6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1a4c05f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56504beada50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56504bead890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.84 ms
whisper_print_timings:   sample time =    72.21 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2048.93 ms /     1 runs ( 2048.93 ms per run)
whisper_print_timings:   decode time =    15.34 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   328.37 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2567.92 ms
