...
- status:  SUCCESS ✅
- runtime: 9:10.06
- date:    Thu Feb 22 18:58:14 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    5.58 sec
...
20/20 Test #20: test-backend-ops .................   Passed  147.10 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 197.82 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    5.10 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.68 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    3.39 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.85 sec
...
21/21 Test #21: test-backend-ops .................   Passed   40.33 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  87.40 sec
...
main:     load time =   546.55 ms
main:   sample time =    37.77 ms
main:  predict time =   677.69 ms / 10.59 ms per token
main:    total time =  1281.59 ms
...
main:     load time =   542.91 ms
main:   sample time =    34.43 ms
main:  predict time =   681.23 ms / 9.73 ms per token
main:    total time =  1262.30 ms
...
main:     load time =   565.27 ms
main:   sample time =    34.10 ms
main:  predict time =   731.29 ms / 10.45 ms per token
main:    total time =  1335.24 ms
...
main:     n_decoded =      504
main:     load time =   545.61 ms
main:   sample time =   233.14 ms
main:  predict time =  2975.18 ms
main:    total time =  3803.79 ms
...
main: loaded model in   429.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8a419b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8a418371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6449fe4a0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8a419b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8a419bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a6449ff270                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8a418371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6449fe4a0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a6449ffbd0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a6449ff270                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8a419b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a644a00530                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a6449ffbd0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a644a00e90                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8a419b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a644a00530                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a644a01050                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a644a00e90                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8a419bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a644a01210                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a644a01050       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   514.50 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.30 ms
whisper_print_timings:   sample time =    66.42 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    29.09 ms /     1 runs (   29.09 ms per run)
...
whisper_print_timings:    total time =   744.95 ms
...
main:     load time =   511.71 ms
main:    total time =  8108.60 ms
embd_img
