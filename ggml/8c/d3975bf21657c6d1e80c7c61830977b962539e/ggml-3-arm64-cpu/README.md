...
- status:  SUCCESS ✅
- runtime: 3:10.00
- date:    Wed May  1 21:51:47 UTC 2024
...
main:     load time =   150.06 ms
main:   sample time =    17.49 ms
main:  predict time =   894.18 ms / 13.97 ms per token
main:    total time =  1083.39 ms
...
main:  predict time =   975.86 ms / 13.94 ms per token
main:    total time =  1146.74 ms
...
main:     load time =   177.90 ms
main:   sample time =    17.42 ms
main:  predict time =  1011.97 ms / 14.46 ms per token
main:    total time =  1210.79 ms
...
main:   sample time =   129.01 ms
main:  predict time =  6427.08 ms
main:    total time =  6786.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9850a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9838b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae54f6ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9850a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9850f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae54f7ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9838b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae54f6ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae54f8410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae54f7ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9850a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae54f8d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae54f8410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae54f96d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9850a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae54f8d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae54f9890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae54f96d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9850f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae54f9a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae54f9890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.98 ms
whisper_print_timings:   sample time =   779.11 ms /   131 runs (    5.95 ms per run)
whisper_print_timings:   encode time =  4677.96 ms /     1 runs ( 4677.96 ms per run)
whisper_print_timings:   decode time =    14.66 ms /     2 runs (    7.33 ms per run)
whisper_print_timings:   batchd time =   711.23 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6305.56 ms
...
main:     load time =    84.79 ms
main:    total time = 39797.93 ms
embd_img
