...
- status:  SUCCESS ✅
- runtime: 4:05.72
- date:    Wed May  1 09:48:33 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.40 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.75 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.92 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.38 sec
      Start  2: test-quantize-fns
...
main:  predict time =   903.17 ms / 14.11 ms per token
...
main:     load time =   161.68 ms
main:   sample time =    17.53 ms
main:  predict time =   987.23 ms / 14.10 ms per token
main:    total time =  1169.15 ms
...
main:     load time =   185.57 ms
main:   sample time =    17.35 ms
main:  predict time =  1011.17 ms / 14.45 ms per token
main:    total time =  1217.45 ms
...
main:     n_decoded =      504
main:     load time =   157.78 ms
main:   sample time =   127.27 ms
main:  predict time =  6448.76 ms
main:    total time =  6816.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffba9ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffba86b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0933bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffba9ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffba9ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0933cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffba86b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0933bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0933d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0933cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffba9ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0933dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0933d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0933e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffba9ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0933dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0933e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0933e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffba9ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0933ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0933e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =   725.08 ms /   131 runs (    5.53 ms per run)
whisper_print_timings:   encode time =  4742.02 ms /     1 runs ( 4742.02 ms per run)
whisper_print_timings:   decode time =    14.68 ms /     2 runs (    7.34 ms per run)
whisper_print_timings:   batchd time =   715.64 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6327.66 ms
...
main:     load time =    91.85 ms
main:    total time = 39923.96 ms
embd_img
