...
- status:  SUCCESS ✅
- runtime: 3:22.08
- date:    Thu Sep 28 09:17:24 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.70 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.63 sec
      Start  2: test-opt
...
main:     load time =   176.36 ms
main:   sample time =    16.93 ms
main:  predict time =   807.62 ms / 12.62 ms per token
main:    total time =  1023.46 ms
...
main:     load time =   168.69 ms
main:   sample time =    16.85 ms
main:  predict time =   872.09 ms / 12.46 ms per token
main:    total time =  1061.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff99b8a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99a0b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6a77ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff99b89fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff99b8f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6a78850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99a0b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6a77ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6a79170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6a78850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff99b89fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6a79a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6a79170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6a7a3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff99b8a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6a79a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae6a7a530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6a7a3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff99b8f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae6a7a6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae6a7a530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   120.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.42 ms
whisper_print_timings:   sample time =    20.33 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  4590.08 ms /     1 runs ( 4590.08 ms per run)
whisper_print_timings:   decode time =   171.14 ms /    27 runs (    6.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  4965.54 ms
```
### mpt
...
main:      load time =  5436.12 ms
main:    sample time =   529.87 ms / 8.28 ms per token
main:      eval time = 43776.06 ms / 625.37 ms per token
main:     total time = 52113.64 ms
...
main:      load time =  1478.39 ms
main:    sample time =   522.73 ms / 8.17 ms per token
main:      eval time = 17606.52 ms / 251.52 ms per token
main:     total time = 20565.30 ms
