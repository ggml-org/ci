...
- status:  SUCCESS ✅
- runtime: 4:46.66
- date:    Thu Sep 28 21:20:39 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed   16.22 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    0.89 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    3.66 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.61 sec
...
main:     load time =   274.07 ms
main:   sample time =    34.90 ms
main:  predict time =   539.24 ms / 8.43 ms per token
main:    total time =   868.71 ms
...
main:     load time =   192.95 ms
main:   sample time =    34.49 ms
main:  predict time =   604.03 ms / 8.63 ms per token
main:    total time =   836.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe7d4dac8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7d4c2d160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a02d5d0ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe7d4dabfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe7d4db1840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a02d5d1850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7d4c2d160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a02d5d0ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a02d5d2170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a02d5d1850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe7d4dabfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a02d5d2a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a02d5d2170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a02d5d33b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe7d4dac8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a02d5d2a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a02d5d3530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a02d5d33b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe7d4db1840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a02d5d36b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a02d5d3530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.30 ms
whisper_print_timings:   sample time =    20.33 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1825.29 ms /     1 runs ( 1825.29 ms per run)
whisper_print_timings:   decode time =   126.93 ms /    27 runs (    4.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2227.93 ms
```
### mpt
...
main:      load time =  7092.88 ms
main:    sample time =   585.11 ms / 9.14 ms per token
main:      eval time = 25146.63 ms / 359.24 ms per token
main:     total time = 33718.73 ms
...
main:      load time =  1757.27 ms
main:    sample time =   590.80 ms / 9.23 ms per token
main:      eval time = 12024.96 ms / 171.79 ms per token
main:     total time = 15000.76 ms
