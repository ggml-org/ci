...
- status:  SUCCESS ✅
- runtime: 2:26.99
- date:    Thu Sep 28 21:15:25 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.28 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    2.23 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.42 sec
...
main:     load time =   137.31 ms
main:   sample time =    23.67 ms
main:  predict time =   472.73 ms / 7.39 ms per token
main:    total time =   647.48 ms
...
main:  predict time =   498.34 ms / 7.12 ms per token
main:    total time =   664.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8460528d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa845ed3160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556329329ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa846051fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa846057840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55632932a850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa845ed3160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556329329ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55632932b170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55632932a850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa846051fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55632932ba90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55632932b170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55632932c3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8460528d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55632932ba90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55632932c530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55632932c3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa846057840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55632932c6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55632932c530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    15.98 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1163.71 ms /     1 runs ( 1163.71 ms per run)
whisper_print_timings:   decode time =   102.39 ms /    27 runs (    3.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1424.78 ms
```
### mpt
...
main:      load time =  4905.56 ms
main:    sample time =   468.83 ms / 7.33 ms per token
main:      eval time = 20882.69 ms / 298.32 ms per token
main:     total time = 26927.35 ms
...
main:      load time =  1350.03 ms
main:    sample time =   469.88 ms / 7.34 ms per token
main:      eval time =  8682.59 ms / 124.04 ms per token
main:     total time = 10891.64 ms
