...
- status:  SUCCESS ✅
- runtime: 3:58.08
- date:    Mon Mar  4 09:07:45 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.58 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   12.19 sec
...
22/22 Test #22: test-backend-ops .................   Passed  105.63 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 136.53 sec
...
23/23 Test #23: test-backend-ops .................   Passed   28.06 sec
...
main:  predict time =   520.39 ms / 8.13 ms per token
...
main:  predict time =   525.18 ms / 7.50 ms per token
main:    total time =   658.00 ms
...
main:  predict time =   538.97 ms / 7.70 ms per token
main:    total time =   695.34 ms
...
main:  predict time =  1849.18 ms
main:    total time =  2166.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1bf9d40990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1bf9bc11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56200ecdece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1bf9d40030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1bf9d45940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56200ecdfab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1bf9bc11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56200ecdece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56200ece0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56200ecdfab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1bf9d40030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56200ece0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56200ece0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56200ece16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1bf9d40990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56200ece0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56200ece1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56200ece16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1bf9d45940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56200ece1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56200ece1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.98 ms
whisper_print_timings:   sample time =    56.12 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1200.22 ms /     1 runs ( 1200.22 ms per run)
whisper_print_timings:   decode time =    13.73 ms /     2 runs (    6.86 ms per run)
whisper_print_timings:   batchd time =   216.71 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1584.82 ms
