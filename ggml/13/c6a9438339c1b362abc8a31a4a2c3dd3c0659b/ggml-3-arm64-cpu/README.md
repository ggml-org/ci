...
- status:  SUCCESS ✅
- runtime: 5:15.92
- date:    Mon Mar  4 09:12:06 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   13.54 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.14 sec
...
22/22 Test #22: test-backend-ops .................   Passed  126.42 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed    8.25 sec
...
23/23 Test #23: test-backend-ops .................   Passed   31.48 sec
...
main:  predict time =   896.25 ms / 14.00 ms per token
main:    total time =  1085.64 ms
...
main:  predict time =   971.28 ms / 13.88 ms per token
main:    total time =  1140.94 ms
...
main:  predict time =   984.10 ms / 14.06 ms per token
main:    total time =  1183.36 ms
...
main:  predict time =  6461.08 ms
main:    total time =  6821.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff990ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98f3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8ef0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff990ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff990bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf8ef1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98f3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8ef0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf8ef2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf8ef1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff990ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf8ef2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf8ef2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf8ef36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff990ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf8ef2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf8ef3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf8ef36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff990bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf8ef3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf8ef3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.27 ms
whisper_print_timings:   sample time =    65.37 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4684.09 ms /     1 runs ( 4684.09 ms per run)
whisper_print_timings:   decode time =    15.13 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   709.34 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5595.76 ms
