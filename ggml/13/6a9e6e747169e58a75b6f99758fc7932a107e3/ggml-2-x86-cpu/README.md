...
- status:  SUCCESS ✅
- runtime: 2:19.68
- date:    Sun Jul 23 19:49:30 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/11 Test  #1: test-grad0 .......................   Passed    2.57 sec
      Start  2: test-opt
 2/11 Test  #2: test-opt .........................   Passed    1.23 sec
...
main:  predict time =   432.36 ms / 6.76 ms per token
main:    total time =   624.48 ms
...
main:  predict time =   449.33 ms / 6.42 ms per token
main:    total time =   633.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f65dfd28870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f65dfba9140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cc28b09aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f65dfd27f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f65dfd2d7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cc28b0a810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f65dfba9140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cc28b09aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cc28b0b110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cc28b0a810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f65dfd27f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cc28b0ba10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cc28b0b110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cc28b0c310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f65dfd28870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cc28b0ba10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cc28b0c470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cc28b0c310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f65dfd2d7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55cc28b0c5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cc28b0c470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4435.29 ms
main:    sample time =   468.78 ms / 7.32 ms per token
main:      eval time = 20164.82 ms / 288.07 ms per token
main:     total time = 26170.80 ms
...
main:      load time =  1187.21 ms
main:    sample time =   463.71 ms / 7.25 ms per token
main:      eval time =  8124.26 ms / 116.06 ms per token
main:     total time = 10204.72 ms
...
```diff
--- /home/ggml/results/ggml/be/4c8bad3588692caa453e32d60e8ff8cc797ea0/ggml-2-x86-cpu/stdall	2023-07-23 19:46:51.976079775 +0000
+++ /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/stdall	2023-07-23 19:49:30.140178014 +0000
@@ -1,6 +1,6 @@
...
+rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/*.md': No such file or directory
...
++ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/be/4c8bad3588692caa453e32d60e8ff8cc797ea0/ggml-2-x86-cpu/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_debug-cmake.log
...
+user	0m0.291s
+sys	0m0.094s
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_debug-make.log
 + make -j
...
+[ 18%] Building C object tests/CMakeFiles/test-opt.dir/test-opt.c.o
...
+[ 84%] Built target dollyv2
+[ 86%] Linking CXX executable ../../bin/mpt
...
+user	0m35.001s
+sys	0m3.672s
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
@@ -217,9 +217,9 @@
...
++ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_release.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_release-cmake.log
...
+user	0m0.265s
+sys	0m0.121s
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_release-make.log
 + make -j
-[  1%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
+[  2%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
 [  2%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
...
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/ctest_release-ctest.log
 + ctest --output-on-failure
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/gpt_2.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -507,15 +507,15 @@
...
++ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/mnist.log
 + cd /home/ggml/work/ggml
 + cd build-ci-release
 + set -e
@@ -680,40 +680,40 @@
...
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
+sys	0m0.004s
 ...
 + set +x
 + gg_run_mpt
++ tee /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/mpt.log
 + cd /home/ggml/work/ggml
...
+2023-07-23 19:47:57 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 19:47:57 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 19:47:57 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 19:47:57 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 19:47:57 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
 + cd /home/ggml/work/ggml
...
+main: quantize time = 29716.89 ms
+main:    total time = 29716.89 ms
++ tee -a /home/ggml/results/ggml/13/6a9e6e747169e58a75b6f99758fc7932a107e3/ggml-2-x86-cpu/mpt-tg.log
 + ./bin/mpt --model ../models-mnt/mpt/7B/ggml-model-f16.bin -s 1234 -n 64 -p 'I believe the meaning of life is'
 main: seed      = 1234
 main: n_threads = 4
@@ -1353,15 +1353,15 @@
