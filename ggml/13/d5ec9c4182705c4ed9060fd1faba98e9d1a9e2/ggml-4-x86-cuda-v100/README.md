...
- status:  SUCCESS ✅
- runtime: 4:47.86
- date:    Wed Oct  4 08:16:31 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    6.59 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.96 sec
...
main:     load time =  1130.14 ms
main:   sample time =    34.66 ms
main:  predict time =   588.42 ms / 9.19 ms per token
main:    total time =  1775.87 ms
...
main:     load time =   208.43 ms
main:   sample time =    34.60 ms
main:  predict time =   601.06 ms / 8.59 ms per token
main:    total time =   851.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa95ec628d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa95eae3160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c28ecaac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa95ec61fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa95ec67840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556c28ecb850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa95eae3160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c28ecaac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556c28ecc170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556c28ecb850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa95ec61fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556c28ecca90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556c28ecc170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556c28ecd3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa95ec628d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556c28ecca90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556c28ecd530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556c28ecd3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa95ec67840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556c28ecd6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556c28ecd530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   668.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.72 ms
whisper_print_timings:   sample time =    20.30 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1888.23 ms /     1 runs ( 1888.23 ms per run)
whisper_print_timings:   decode time =   131.61 ms /    27 runs (    4.87 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2793.59 ms
```
### mpt
...
main:      load time =  7282.73 ms
main:    sample time =   574.34 ms / 8.97 ms per token
main:      eval time = 25694.62 ms / 367.07 ms per token
main:     total time = 34425.90 ms
...
main:      load time =  1682.51 ms
main:    sample time =   579.99 ms / 9.06 ms per token
main:      eval time = 12272.51 ms / 175.32 ms per token
main:     total time = 15171.40 ms
