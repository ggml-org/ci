...
- status:  SUCCESS ✅
- runtime: 3:56.10
- date:    Wed Oct  4 08:15:38 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.44 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.99 sec
...
main:     load time =   268.15 ms
main:   sample time =    17.19 ms
main:  predict time =   804.45 ms / 12.57 ms per token
main:    total time =  1114.97 ms
...
main:  predict time =   874.92 ms / 12.50 ms per token
main:    total time =  1065.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb654a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb63cb160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab00a3cac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb6549fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb654f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab00a3d850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb63cb160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab00a3cac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab00a3e170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab00a3d850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb6549fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab00a3ea90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab00a3e170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab00a3f3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb654a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab00a3ea90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab00a3f530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab00a3f3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb654f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab00a3f6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab00a3f530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   197.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.37 ms
whisper_print_timings:   sample time =    16.87 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  4600.55 ms /     1 runs ( 4600.55 ms per run)
whisper_print_timings:   decode time =   174.85 ms /    27 runs (    6.48 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5055.04 ms
```
### mpt
...
main:      load time = 11857.64 ms
main:    sample time =   515.29 ms / 8.05 ms per token
main:      eval time = 43685.78 ms / 624.08 ms per token
main:     total time = 58431.89 ms
...
main:      load time =  4369.43 ms
main:    sample time =   512.23 ms / 8.00 ms per token
main:      eval time = 17733.73 ms / 253.34 ms per token
main:     total time = 23572.79 ms
