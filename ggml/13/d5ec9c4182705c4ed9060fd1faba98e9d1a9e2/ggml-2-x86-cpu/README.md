...
- status:  SUCCESS ✅
- runtime: 2:57.33
- date:    Wed Oct  4 08:14:40 UTC 2023
...
main:     load time =   196.56 ms
main:   sample time =    23.89 ms
main:  predict time =   471.48 ms / 7.37 ms per token
main:    total time =   706.98 ms
...
main:     load time =   142.37 ms
main:   sample time =    24.00 ms
main:  predict time =   496.46 ms / 7.09 ms per token
main:    total time =   667.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc5a53268d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc5a51a7160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555834ceaac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc5a5325fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc5a532b840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555834ceb850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc5a51a7160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555834ceaac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555834cec170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555834ceb850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc5a5325fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555834ceca90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555834cec170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555834ced3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc5a53268d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555834ceca90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555834ced530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555834ced3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc5a532b840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555834ced6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555834ced530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   139.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.71 ms
whisper_print_timings:   sample time =    16.45 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1154.00 ms /     1 runs ( 1154.00 ms per run)
whisper_print_timings:   decode time =   120.79 ms /    27 runs (    4.47 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1488.33 ms
```
### mpt
...
main:      load time = 11371.87 ms
main:    sample time =   461.61 ms / 7.21 ms per token
main:      eval time = 21933.42 ms / 313.33 ms per token
main:     total time = 34500.41 ms
...
main:      load time =  4416.64 ms
main:    sample time =   459.54 ms / 7.18 ms per token
main:      eval time =  8984.29 ms / 128.35 ms per token
main:     total time = 14297.75 ms
