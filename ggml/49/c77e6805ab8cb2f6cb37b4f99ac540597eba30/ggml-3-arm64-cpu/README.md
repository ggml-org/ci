...
- status:  SUCCESS ✅
- runtime: 3:09.97
- date:    Sun Jun 16 10:08:50 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.59 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/22 Test  #6: test-mul-mat2 ....................   Passed    1.80 sec
      Start  7: test0
...
main:     load time =   161.03 ms
main:   sample time =    19.47 ms
main:  predict time =   892.68 ms / 13.95 ms per token
main:    total time =  1094.72 ms
...
main:     load time =   161.02 ms
main:   sample time =    19.56 ms
main:  predict time =   973.36 ms / 13.91 ms per token
main:    total time =  1156.45 ms
...
main:  predict time =   967.40 ms / 13.82 ms per token
...
main:  predict time =  6132.53 ms
main:    total time =  6508.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfe7f5f95a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfe7f5f7db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb80d4fa56ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfe7f5f95a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfe7f5f95f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb80d4fa57ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfe7f5f7db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb80d4fa56ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb80d4fa58410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb80d4fa57ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfe7f5f95a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb80d4fa58d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb80d4fa58410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb80d4fa596d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfe7f5f95a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb80d4fa58d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb80d4fa59890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb80d4fa596d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfe7f5f95f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb80d4fa59a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb80d4fa59890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.68 ms
whisper_print_timings:   sample time =    68.32 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4702.82 ms /     1 runs ( 4702.82 ms per run)
whisper_print_timings:   decode time =    15.17 ms /     2 runs (    7.59 ms per run)
whisper_print_timings:   batchd time =   734.36 ms /   125 runs (    5.87 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5667.88 ms
