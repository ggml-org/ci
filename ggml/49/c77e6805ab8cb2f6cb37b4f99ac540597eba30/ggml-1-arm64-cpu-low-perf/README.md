...
- status:  SUCCESS ✅
- runtime: 4:06.22
- date:    Sun Jun 16 10:09:43 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.95 sec
 ...
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.60 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.08 sec
      Start  2: test-quantize-fns
...
main:     load time =   146.26 ms
main:   sample time =    19.78 ms
main:  predict time =   893.02 ms / 13.95 ms per token
main:    total time =  1080.52 ms
...
main:     load time =   149.35 ms
main:   sample time =    19.80 ms
main:  predict time =   991.89 ms / 14.17 ms per token
main:    total time =  1163.71 ms
...
main:     load time =   178.15 ms
main:   sample time =    18.90 ms
main:  predict time =   971.20 ms / 13.87 ms per token
main:    total time =  1171.74 ms
...
main:     n_decoded =      504
main:     load time =   148.54 ms
main:   sample time =   129.19 ms
main:  predict time =  6129.50 ms
main:    total time =  6490.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xed6a1ffca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xed6a1fe4b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb18c856dfce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xed6a1ffca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xed6a1ffcf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb18c856e0ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xed6a1fe4b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb18c856dfce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb18c856e1410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb18c856e0ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xed6a1ffca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb18c856e1d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb18c856e1410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb18c856e26d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xed6a1ffca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb18c856e1d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb18c856e2890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb18c856e26d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xed6a1ffcf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb18c856e2a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb18c856e2890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.20 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    67.91 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4684.87 ms /     1 runs ( 4684.87 ms per run)
whisper_print_timings:   decode time =    15.20 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   734.57 ms /   125 runs (    5.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5637.24 ms
...
main:     load time =    94.67 ms
main:    total time = 39943.87 ms
embd_img
