...
- status:  SUCCESS ✅
- runtime: 14:47.74
- date:    Sun Jun 16 10:20:28 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   35.85 sec
...
21/21 Test #21: test-backend-ops .................   Passed  198.19 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 279.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   20.34 sec
...
22/22 Test #22: test-backend-ops .................   Passed   45.32 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 104.34 sec
...
main:     load time =   151.39 ms
main:   sample time =    34.51 ms
main:  predict time =   611.26 ms / 9.55 ms per token
main:    total time =   816.37 ms
...
main:   sample time =    34.84 ms
main:  predict time =   623.48 ms / 8.91 ms per token
main:    total time =   823.27 ms
...
main:     load time =   181.64 ms
main:   sample time =    34.98 ms
main:  predict time =   639.42 ms / 9.13 ms per token
main:    total time =   861.47 ms
...
main:     n_decoded =      504
main:     load time =   155.66 ms
main:   sample time =   242.10 ms
main:  predict time =  2377.48 ms
main:    total time =  2820.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f72b5efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f72b5d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5639d4d89840                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f72b5efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f72b5eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5639d4d8a610                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f72b5d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5639d4d89840                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5639d4d8af70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5639d4d8a610                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f72b5efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5639d4d8b8d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5639d4d8af70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5639d4d8c230                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f72b5efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5639d4d8b8d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5639d4d8c3f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5639d4d8c230                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f72b5eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5639d4d8c5b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5639d4d8c3f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   500.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.38 ms
whisper_print_timings:   sample time =    65.18 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    47.57 ms /     1 runs (   47.57 ms per run)
whisper_print_timings:   decode time =    11.61 ms /     2 runs (    5.80 ms per run)
whisper_print_timings:   batchd time =    78.14 ms /   125 runs (    0.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   732.98 ms
...
main:     load time =   113.42 ms
main:    total time = 16638.81 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.660000 sec.)
