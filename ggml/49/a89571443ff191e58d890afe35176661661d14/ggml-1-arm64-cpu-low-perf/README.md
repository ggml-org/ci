...
- status:  SUCCESS ✅
- runtime: 3:35.25
- date:    Sat Dec 23 04:11:25 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.06 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   42.59 sec
...
main:  predict time =   841.76 ms / 13.15 ms per token
main:    total time =  1073.71 ms
...
main:     load time =   193.15 ms
main:   sample time =    18.37 ms
main:  predict time =   936.94 ms / 13.38 ms per token
main:    total time =  1151.47 ms
...
main:   sample time =   133.61 ms
main:  predict time =  6086.25 ms
main:    total time =  6474.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff978fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9777b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed2a1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff978fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff978ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaed2a2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9777b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed2a1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaed2a32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaed2a2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff978fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaed2a3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaed2a32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaed2a4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff978fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaed2a3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaed2a4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaed2a4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff978ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaed2a4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaed2a4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.93 ms
whisper_print_timings:   sample time =    67.39 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4754.46 ms /     1 runs ( 4754.46 ms per run)
whisper_print_timings:   decode time =    16.35 ms /     2 runs (    8.17 ms per run)
whisper_print_timings:   batchd time =   715.86 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5689.17 ms
