...
- status:  SUCCESS ✅
- runtime: 3:32.69
- date:    Sat Dec 23 16:22:46 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.42 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.49 sec
...
main:     load time =   210.35 ms
main:   sample time =    23.52 ms
main:  predict time =   444.36 ms / 6.94 ms per token
main:    total time =   690.79 ms
...
main:     load time =   125.53 ms
main:   sample time =    23.47 ms
main:  predict time =   458.11 ms / 6.54 ms per token
main:    total time =   609.23 ms
...
main:  predict time =  1466.96 ms
main:    total time =  1780.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f78c1970990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f78c17f11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559547139b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f78c1970030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f78c1975940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55954713a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f78c17f11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559547139b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55954713b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55954713a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f78c1970030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55954713bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55954713b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55954713c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f78c1970990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55954713bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55954713c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55954713c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f78c1975940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55954713c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55954713c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.76 ms
whisper_print_timings:   sample time =    54.61 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1152.25 ms /     1 runs ( 1152.25 ms per run)
whisper_print_timings:   decode time =     9.87 ms /     2 runs (    4.93 ms per run)
whisper_print_timings:   batchd time =   205.19 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1545.73 ms
...
main:     load time =    61.37 ms
main:    total time = 10577.38 ms
embd_img
...
main:      load time =  5442.04 ms
main:    sample time =   471.01 ms / 7.36 ms per token
main:      eval time = 20421.43 ms / 291.73 ms per token
main:     total time = 27022.60 ms
...
main:      load time =  1272.00 ms
main:    sample time =   467.01 ms / 7.30 ms per token
main:      eval time =  8027.18 ms / 114.67 ms per token
main:     total time = 10150.58 ms
