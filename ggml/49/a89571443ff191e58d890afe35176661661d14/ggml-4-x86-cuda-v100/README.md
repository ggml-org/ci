...
- status:  SUCCESS ✅
- runtime: 8:10.90
- date:    Sat Dec 23 16:17:53 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.62 sec
...
19/19 Test #19: test-backend-ops .................   Passed   60.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.58 sec
      Start  2: test-opt
 ...
 8/20 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    8.09 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   23.09 sec
...
main:     load time =   566.39 ms
main:   sample time =    34.19 ms
main:  predict time =   547.24 ms / 8.55 ms per token
main:    total time =  1167.81 ms
...
main:     load time =   557.66 ms
main:   sample time =    34.18 ms
main:  predict time =   568.32 ms / 8.12 ms per token
main:    total time =  1164.28 ms
...
main:     n_decoded =      504
main:     load time =   538.66 ms
main:   sample time =   232.52 ms
main:  predict time =  2215.90 ms
main:    total time =  3031.14 ms
...
main: loaded model in   393.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1b543b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1b542371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564be1a7f5f0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1b543b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1b543bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564be1a803c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1b542371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564be1a7f5f0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564be1a80d20                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564be1a803c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1b543b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564be1a81680                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564be1a80d20                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564be1a81fe0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1b543b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564be1a81680                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564be1a821a0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564be1a81fe0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1b543bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564be1a82360                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564be1a821a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1091.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.97 ms
whisper_print_timings:   sample time =    66.00 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    34.09 ms /     1 runs (   34.09 ms per run)
whisper_print_timings:   decode time =    13.80 ms /     2 runs (    6.90 ms per run)
whisper_print_timings:   batchd time =    80.92 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1311.83 ms
...
main:     load time =   509.44 ms
main:    total time =  7824.49 ms
embd_img
...
main:      load time =  8360.13 ms
main:    sample time =   535.39 ms / 8.37 ms per token
main:      eval time = 25850.12 ms / 369.29 ms per token
main:     total time = 35648.58 ms
...
main:      load time =  2043.70 ms
main:    sample time =   534.58 ms / 8.35 ms per token
main:      eval time = 12116.50 ms / 173.09 ms per token
main:     total time = 15361.45 ms
