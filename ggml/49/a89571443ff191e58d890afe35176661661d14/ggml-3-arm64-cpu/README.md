...
- status:  SUCCESS ✅
- runtime: 5:26.33
- date:    Sat Dec 23 04:14:04 PM UTC 2023
...
20/20 Test #20: test-backend-ops .................   Passed   10.08 sec
...
main:     load time =   222.01 ms
main:   sample time =    17.01 ms
main:  predict time =   811.86 ms / 12.69 ms per token
...
main:  predict time =   877.09 ms / 12.53 ms per token
main:    total time =  1072.43 ms
...
main:  predict time =  5895.97 ms
main:    total time =  6256.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87d5a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff87bdb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabce1cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87d5a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87d5f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabce1d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff87bdb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabce1cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabce1e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabce1d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87d5a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabce1ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabce1e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabce1f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87d5a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabce1ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabce1f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabce1f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87d5f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaabce1f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabce1f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   187.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =    65.60 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4660.29 ms /     1 runs ( 4660.29 ms per run)
whisper_print_timings:   decode time =    15.77 ms /     2 runs (    7.88 ms per run)
whisper_print_timings:   batchd time =   708.57 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5656.57 ms
...
main:     load time =    82.70 ms
main:    total time = 39538.52 ms
embd_img
...
main:      load time =  5958.86 ms
main:    sample time =   519.30 ms / 8.11 ms per token
main:      eval time = 43529.67 ms / 621.85 ms per token
main:     total time = 52382.96 ms
...
main:      load time =  1555.97 ms
main:    sample time =   516.93 ms / 8.08 ms per token
main:      eval time = 17559.09 ms / 250.84 ms per token
main:     total time = 20624.56 ms
