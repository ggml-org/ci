...
- status:  SUCCESS ✅
- runtime: 5:12.65
- date:    Fri Mar  8 10:03:58 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   13.34 sec
...
22/22 Test #22: test-backend-ops .................   Passed  125.47 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 161.30 sec
...
23/23 Test #23: test-backend-ops .................   Passed   31.19 sec
...
main:  predict time =   886.58 ms / 13.85 ms per token
main:    total time =  1077.12 ms
...
main:  predict time =   966.77 ms / 13.81 ms per token
main:    total time =  1136.45 ms
...
main:     load time =   178.02 ms
main:   sample time =    16.92 ms
main:  predict time =   976.87 ms / 13.96 ms per token
main:    total time =  1174.93 ms
...
main:  predict time =  6438.15 ms
main:    total time =  6801.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8205a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81edb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaddcbbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8205a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8205f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaddcbcab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff81edb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaddcbbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaddcbd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaddcbcab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8205a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaddcbdd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaddcbd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaddcbe6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8205a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaddcbdd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaddcbe890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaddcbe6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8205f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaddcbea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaddcbe890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.88 ms
whisper_print_timings:   sample time =    65.78 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4687.66 ms /     1 runs ( 4687.66 ms per run)
whisper_print_timings:   decode time =    15.25 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   710.75 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5600.68 ms
