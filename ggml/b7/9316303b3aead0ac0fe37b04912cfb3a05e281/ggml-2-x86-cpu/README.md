...
- status:  SUCCESS ✅
- runtime: 3:51.50
- date:    Fri Mar  8 09:54:58 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.42 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   12.32 sec
...
22/22 Test #22: test-backend-ops .................   Passed  104.32 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/23 Test  #1: test-grad0 .......................   Passed    2.33 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    1.67 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed    6.48 sec
...
23/23 Test #23: test-backend-ops .................   Passed   25.39 sec
...
main:     load time =   107.55 ms
main:   sample time =    23.54 ms
main:  predict time =   490.62 ms / 7.67 ms per token
main:    total time =   634.22 ms
...
main:     load time =   105.74 ms
main:   sample time =    23.52 ms
main:  predict time =   519.07 ms / 7.42 ms per token
main:    total time =   650.41 ms
...
main:  predict time =   523.51 ms / 7.48 ms per token
main:    total time =   675.84 ms
...
main:     n_decoded =      504
main:     load time =   105.23 ms
main:   sample time =   175.20 ms
main:  predict time =  1863.03 ms
main:    total time =  2175.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9459ccf990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9459b501a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c2cf29ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9459ccf030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9459cd4940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556c2cf2aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9459b501a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c2cf29ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556c2cf2b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556c2cf2aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9459ccf030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556c2cf2bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556c2cf2b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556c2cf2c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9459ccf990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556c2cf2bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556c2cf2c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556c2cf2c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9459cd4940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556c2cf2ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556c2cf2c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.64 ms
whisper_print_timings:   sample time =    54.80 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1185.73 ms /     1 runs ( 1185.73 ms per run)
whisper_print_timings:   decode time =    12.59 ms /     2 runs (    6.30 ms per run)
whisper_print_timings:   batchd time =   214.17 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1563.51 ms
...
main:     load time =    66.55 ms
main:    total time = 10686.99 ms
embd_img
