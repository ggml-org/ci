...
- status:  SUCCESS ✅
- runtime: 5:12.99
- date:    Fri Mar  8 09:52:06 UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed  106.52 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed    6.48 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.50 sec
      Start  4: test-mul-mat0
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   24.89 sec
...
main:     load time =   106.58 ms
main:   sample time =    23.59 ms
main:  predict time =   711.86 ms / 11.12 ms per token
main:    total time =   854.80 ms
...
main:     load time =   105.83 ms
main:   sample time =    23.55 ms
main:  predict time =   757.45 ms / 10.82 ms per token
main:    total time =   888.98 ms
...
main:     load time =   127.23 ms
main:   sample time =    23.85 ms
main:  predict time =   748.49 ms / 10.69 ms per token
main:    total time =   902.18 ms
...
main:     n_decoded =      504
main:     load time =   108.24 ms
main:   sample time =   175.70 ms
main:  predict time =  3107.47 ms
main:    total time =  3437.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd26e83e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd26e6bf1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5638e9a73ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd26e83e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd26e843940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5638e9a74ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd26e6bf1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5638e9a73ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5638e9a75410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5638e9a74ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd26e83e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5638e9a75d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5638e9a75410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5638e9a766d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd26e83e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5638e9a75d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5638e9a76890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5638e9a766d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd26e843940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5638e9a76a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5638e9a76890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.70 ms
whisper_print_timings:   sample time =    71.85 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2057.24 ms /     1 runs ( 2057.24 ms per run)
whisper_print_timings:   decode time =    16.04 ms /     2 runs (    8.02 ms per run)
whisper_print_timings:   batchd time =   330.39 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2578.63 ms
