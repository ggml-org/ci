...
- status:  SUCCESS ✅
- runtime: 6:11.37
- date:    Fri Mar  8 09:53:07 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.31 sec
      Start  9: test3
...
22/22 Test #22: test-backend-ops .................   Passed  128.31 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 187.70 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.66 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed    6.82 sec
      Start  3: test-quantize-perf
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.43 sec
      Start  9: test3
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   31.34 sec
...
main:     load time =   155.36 ms
main:   sample time =    16.94 ms
main:  predict time =   902.10 ms / 14.10 ms per token
main:    total time =  1096.11 ms
...
main:     load time =   155.25 ms
main:   sample time =    17.06 ms
main:  predict time =   983.39 ms / 14.05 ms per token
main:    total time =  1158.38 ms
...
main:     load time =   182.70 ms
main:   sample time =    16.92 ms
main:  predict time =   988.27 ms / 14.12 ms per token
main:    total time =  1191.02 ms
...
main:     n_decoded =      504
main:     load time =   156.23 ms
main:   sample time =   127.37 ms
main:  predict time =  6657.65 ms
main:    total time =  7024.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa501a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa4e9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaedabdce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa501a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa501f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaedabeab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa4e9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaedabdce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaedabf410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaedabeab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa501a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaedabfd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaedabf410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaedac06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa501a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaedabfd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaedac0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaedac06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa501f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaedac0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaedac0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    65.66 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4691.01 ms /     1 runs ( 4691.01 ms per run)
whisper_print_timings:   decode time =    15.80 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   716.78 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5616.68 ms
...
main:     load time =    88.78 ms
main:    total time = 39850.21 ms
embd_img
