...
- status:  SUCCESS ✅
- runtime: 5:02.33
- date:    Mon Feb 19 01:39:30 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.93 sec
...
20/20 Test #20: test-backend-ops .................   Passed   97.37 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 138.99 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.66 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.82 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   19.60 sec
...
main:  predict time =   907.14 ms / 14.17 ms per token
main:    total time =  1103.75 ms
...
main:     load time =   155.73 ms
main:   sample time =    17.89 ms
main:  predict time =  1138.46 ms / 16.26 ms per token
main:    total time =  1314.98 ms
...
main:     load time =   189.78 ms
main:   sample time =    17.24 ms
main:  predict time =  1005.48 ms / 14.36 ms per token
main:    total time =  1215.71 ms
...
main:  predict time =  6604.02 ms
main:    total time =  6974.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb28fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb277b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacbd19b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb28fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb28ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacbd1a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb277b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacbd19b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacbd1b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacbd1a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb28fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacbd1bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacbd1b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacbd1c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb28fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacbd1bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacbd1c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacbd1c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb28ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacbd1c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacbd1c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.86 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.14 ms
whisper_print_timings:   sample time =    64.77 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4795.84 ms /     1 runs ( 4795.84 ms per run)
whisper_print_timings:   decode time =    14.74 ms /     2 runs (    7.37 ms per run)
whisper_print_timings:   batchd time =   714.22 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5716.89 ms
