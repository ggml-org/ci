...
- status:  SUCCESS ✅
- runtime: 4:14.34
- date:    Mon Feb 19 01:50:51 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b70e86af23f598d192bc8cffb706a312823a017d
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.08 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.50 sec
...
20/20 Test #20: test-backend-ops .................   Passed   97.51 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 115.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.92 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.15 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.87 sec
...
main:  predict time =   888.45 ms / 13.88 ms per token
main:    total time =  1079.53 ms
...
main:     load time =   151.38 ms
main:   sample time =    17.07 ms
main:  predict time =   973.01 ms / 13.90 ms per token
main:    total time =  1144.21 ms
...
main:     load time =   175.81 ms
main:   sample time =    17.16 ms
main:  predict time =  1022.71 ms / 14.61 ms per token
main:    total time =  1218.86 ms
...
main:  predict time =  6404.52 ms
main:    total time =  6766.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa17fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa167b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8c2ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa17fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa17ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae8c2b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa167b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8c2ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae8c2c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae8c2b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa17fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae8c2cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae8c2c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae8c2d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa17fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae8c2cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae8c2d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae8c2d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa17ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae8c2d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae8c2d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    65.26 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4689.82 ms /     1 runs ( 4689.82 ms per run)
whisper_print_timings:   decode time =    14.46 ms /     2 runs (    7.23 ms per run)
whisper_print_timings:   batchd time =   710.41 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5605.09 ms
...
main:     load time =    86.89 ms
main:    total time = 39798.91 ms
embd_img
