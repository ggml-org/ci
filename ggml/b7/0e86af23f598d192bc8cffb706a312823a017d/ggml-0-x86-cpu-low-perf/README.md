...
- status:  SUCCESS ✅
- runtime: 4:08.85
- date:    Mon Feb 19 13:38:32 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   77.71 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 119.48 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.65 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.63 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.70 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.00 sec
      Start 11: test-conv-transpose
11/20 Test #11: test-conv-transpose ..............   Passed    0.00 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   15.99 sec
...
main:  predict time =   710.29 ms / 11.10 ms per token
main:    total time =   869.46 ms
...
main:     load time =   105.91 ms
main:   sample time =    23.78 ms
main:  predict time =   740.99 ms / 10.59 ms per token
main:    total time =   872.91 ms
...
main:     load time =   127.53 ms
main:   sample time =    23.93 ms
main:  predict time =   749.96 ms / 10.71 ms per token
main:    total time =   903.89 ms
...
main:     n_decoded =      504
main:     load time =   108.39 ms
main:   sample time =   177.95 ms
main:  predict time =  3110.44 ms
main:    total time =  3442.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7eff39f30990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7eff39db11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560f8adf2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7eff39f30030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7eff39f35940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560f8adf3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7eff39db11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560f8adf2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560f8adf42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560f8adf3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7eff39f30030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560f8adf4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560f8adf42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560f8adf5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7eff39f30990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560f8adf4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560f8adf5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560f8adf5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7eff39f35940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560f8adf5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560f8adf5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.70 ms
whisper_print_timings:   sample time =    72.81 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2048.35 ms /     1 runs ( 2048.35 ms per run)
whisper_print_timings:   decode time =    15.91 ms /     2 runs (    7.95 ms per run)
whisper_print_timings:   batchd time =   332.48 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2573.24 ms
...
main:     load time =    66.87 ms
main:    total time = 19307.62 ms
embd_img
