...
- status:  SUCCESS ✅
- runtime: 3:05.40
- date:    Sat Jun 15 17:59:55 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.57 sec
      Start  6: test0
...
main:  predict time =   849.08 ms / 13.27 ms per token
main:    total time =  1034.47 ms
...
main:     load time =   146.24 ms
main:   sample time =    16.74 ms
main:  predict time =   934.23 ms / 13.35 ms per token
main:    total time =  1099.47 ms
...
main:     load time =   176.56 ms
main:   sample time =    16.67 ms
main:  predict time =   927.89 ms / 13.26 ms per token
main:    total time =  1124.22 ms
...
main:  predict time =  6047.60 ms
main:    total time =  6405.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe8603601a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe86035e9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc5b263307ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe8603601a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe8603601f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc5b263308ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe86035e9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc5b263307ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc5b263309410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc5b263308ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe8603601a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc5b263309d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc5b263309410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc5b26330a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe8603601a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc5b263309d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc5b26330a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc5b26330a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe8603601f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc5b26330aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc5b26330a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   101.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.18 ms
whisper_print_timings:   sample time =    65.79 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4662.33 ms /     1 runs ( 4662.33 ms per run)
whisper_print_timings:   decode time =    14.67 ms /     2 runs (    7.33 ms per run)
whisper_print_timings:   batchd time =   724.20 ms /   125 runs (    5.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5599.96 ms
...
main:     load time =    87.93 ms
main:    total time = 39644.96 ms
embd_img
