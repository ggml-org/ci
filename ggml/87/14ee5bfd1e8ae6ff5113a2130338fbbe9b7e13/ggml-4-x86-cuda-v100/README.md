...
- status:  SUCCESS ✅
- runtime: 14:38.08
- date:    Sat Jun 15 18:23:43 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.50 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   36.29 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.04 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   20.46 sec
      Start  9: test3
...
21/21 Test #21: test-backend-ops .................   Passed  184.80 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 266.22 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/22 Test  #8: test1 ............................   Passed    0.04 sec
      Start  9: test2
 9/22 Test  #9: test2 ............................   Passed   20.30 sec
      Start 10: test3
...
22/22 Test #22: test-backend-ops .................   Passed   44.17 sec
...
main:  predict time =   590.56 ms / 9.23 ms per token
main:    total time =   797.76 ms
...
main:  predict time =   609.85 ms / 8.71 ms per token
main:    total time =   800.24 ms
...
main:     load time =   183.38 ms
main:   sample time =    34.77 ms
main:  predict time =   640.13 ms / 9.14 ms per token
main:    total time =   863.57 ms
...
main:     n_decoded =      504
main:     load time =   154.26 ms
main:   sample time =   241.50 ms
main:  predict time =  2333.59 ms
main:    total time =  2781.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb2d30fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb2d2f7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564aba108840                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb2d30fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb2d30ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564aba109610                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb2d2f7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564aba108840                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564aba109f70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564aba109610                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb2d30fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564aba10a8d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564aba109f70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564aba10b230                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb2d30fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564aba10a8d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564aba10b3f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564aba10b230                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb2d30ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564aba10b5b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564aba10b3f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   511.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.56 ms
whisper_print_timings:   sample time =    65.81 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    50.65 ms /     1 runs (   50.65 ms per run)
whisper_print_timings:   decode time =    12.43 ms /     2 runs (    6.22 ms per run)
whisper_print_timings:   batchd time =    79.03 ms /   125 runs (    0.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   746.15 ms
...
main:     load time =   112.44 ms
main:    total time = 16487.46 ms
embd_img
