...
- status:  SUCCESS ✅
- runtime: 3:24.58
- date:    Sat Jun 15 18:00:32 UTC 2024
...
main:     load time =   103.12 ms
main:   sample time =    24.01 ms
main:  predict time =   679.07 ms / 9.70 ms per token
main:    total time =   808.42 ms
...
main:  predict time =   686.53 ms / 9.81 ms per token
main:    total time =   837.12 ms
...
main:  predict time =  2601.64 ms
main:    total time =  2929.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7cfbecefa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7cfbecd7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x571595452ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7cfbecefa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7cfbeceff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x571595453ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7cfbecd7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x571595452ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x571595454410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x571595453ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7cfbecefa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x571595454d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x571595454410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5715954556d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7cfbecefa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x571595454d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x571595455890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5715954556d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7cfbeceff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x571595455a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x571595455890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    73.24 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2003.65 ms /     1 runs ( 2003.65 ms per run)
whisper_print_timings:   decode time =    14.19 ms /     2 runs (    7.10 ms per run)
whisper_print_timings:   batchd time =   333.66 ms /   125 runs (    2.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2535.17 ms
...
main:     load time =    69.60 ms
main:    total time = 18409.29 ms
embd_img
