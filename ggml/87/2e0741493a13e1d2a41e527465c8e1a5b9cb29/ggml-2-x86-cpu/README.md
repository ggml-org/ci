...
- status:  SUCCESS ✅
- runtime: 2:09.44
- date:    Sat Jun 15 17:19:31 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   30.09 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    1.93 sec
      Start  2: test-opt
 2/22 Test  #2: test-opt .........................   Passed    1.67 sec
...
main:     load time =   105.35 ms
main:   sample time =    23.98 ms
main:  predict time =   484.83 ms / 7.58 ms per token
main:    total time =   626.66 ms
...
main:  predict time =   495.42 ms / 7.08 ms per token
main:    total time =   625.83 ms
...
main:     load time =   123.54 ms
main:   sample time =    23.84 ms
main:  predict time =   506.76 ms / 7.24 ms per token
main:    total time =   657.16 ms
...
main:     n_decoded =      504
main:     load time =   101.91 ms
main:   sample time =   178.20 ms
main:  predict time =  1543.02 ms
main:    total time =  1856.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x785866afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78586697b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x63fb528adce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x785866afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x785866aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x63fb528aeab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78586697b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x63fb528adce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x63fb528af410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x63fb528aeab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x785866afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x63fb528afd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x63fb528af410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x63fb528b06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x785866afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x63fb528afd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x63fb528b0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x63fb528b06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x785866aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x63fb528b0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x63fb528b0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.92 ms
whisper_print_timings:   sample time =    55.49 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1162.23 ms /     1 runs ( 1162.23 ms per run)
whisper_print_timings:   decode time =    11.18 ms /     2 runs (    5.59 ms per run)
whisper_print_timings:   batchd time =   219.06 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1549.67 ms
...
main:     load time =    65.75 ms
main:    total time = 10654.82 ms
embd_img
