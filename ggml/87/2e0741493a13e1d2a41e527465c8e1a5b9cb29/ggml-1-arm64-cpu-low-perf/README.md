...
- status:  SUCCESS ✅
- runtime: 4:04.89
- date:    Sat Jun 15 17:21:21 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/21 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.32 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.97 sec
      Start  2: test-quantize-fns
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.56 sec
      Start  9: test3
...
main:     load time =   148.29 ms
main:   sample time =    18.16 ms
main:  predict time =   888.62 ms / 13.88 ms per token
main:    total time =  1076.69 ms
...
main:  predict time =   962.31 ms / 13.75 ms per token
main:    total time =  1131.50 ms
...
main:     load time =   178.78 ms
main:   sample time =    20.16 ms
main:  predict time =   967.55 ms / 13.82 ms per token
main:    total time =  1169.91 ms
...
main:     n_decoded =      504
main:     load time =   154.11 ms
main:   sample time =   129.67 ms
main:  predict time =  6109.70 ms
main:    total time =  6477.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf36d3329a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf36d3311b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc805942d3ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf36d3329a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf36d3329f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc805942d4ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf36d3311b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc805942d3ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc805942d5410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc805942d4ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf36d3329a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc805942d5d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc805942d5410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc805942d66d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf36d3329a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc805942d5d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc805942d6890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc805942d66d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf36d3329f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc805942d6a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc805942d6890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.39 ms
whisper_print_timings:   sample time =    69.81 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4680.88 ms /     1 runs ( 4680.88 ms per run)
whisper_print_timings:   decode time =    15.12 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   736.14 ms /   125 runs (    5.89 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5639.02 ms
...
main:     load time =    94.83 ms
main:    total time = 39978.00 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.277000 sec.)
