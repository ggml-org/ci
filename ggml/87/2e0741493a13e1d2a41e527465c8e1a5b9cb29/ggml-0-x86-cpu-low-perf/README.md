...
- status:  SUCCESS ✅
- runtime: 3:26.07
- date:    Sat Jun 15 17:20:47 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.21 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   30.05 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.16 sec
      Start  2: test-quantize-fns
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.24 sec
      Start  9: test3
...
main:     load time =   101.71 ms
main:   sample time =    23.75 ms
main:  predict time =   651.74 ms / 10.18 ms per token
main:    total time =   789.81 ms
...
main:  predict time =   671.52 ms / 9.59 ms per token
main:    total time =   798.76 ms
...
main:     load time =   122.81 ms
main:   sample time =    23.83 ms
main:  predict time =   688.32 ms / 9.83 ms per token
...
main:     n_decoded =      504
main:     load time =   101.83 ms
main:   sample time =   178.28 ms
main:  predict time =  2572.31 ms
main:    total time =  2898.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7bb9a7afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7bb9a797b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c0fbc08ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7bb9a7afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7bb9a7aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c0fbc09ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7bb9a797b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c0fbc08ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c0fbc0a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c0fbc09ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7bb9a7afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c0fbc0ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c0fbc0a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c0fbc0b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7bb9a7afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c0fbc0ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c0fbc0b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c0fbc0b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7bb9a7aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c0fbc0ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c0fbc0b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.23 ms
whisper_print_timings:   sample time =    72.54 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1999.63 ms /     1 runs ( 1999.63 ms per run)
whisper_print_timings:   decode time =    13.94 ms /     2 runs (    6.97 ms per run)
whisper_print_timings:   batchd time =   329.33 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2523.38 ms
...
main:     load time =    68.18 ms
main:    total time = 18378.58 ms
embd_img
