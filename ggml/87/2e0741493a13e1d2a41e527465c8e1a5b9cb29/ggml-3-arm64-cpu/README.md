...
- status:  SUCCESS ✅
- runtime: 3:08.41
- date:    Sat Jun 15 17:20:30 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.39 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.28 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.32 sec
      Start  2: test-opt
 2/22 Test  #2: test-opt .........................   Passed    2.20 sec
      Start  3: test-quantize-fns
 3/22 Test  #3: test-quantize-fns ................   Passed   19.82 sec
...
main:     load time =   147.08 ms
main:   sample time =    16.77 ms
main:  predict time =   853.90 ms / 13.34 ms per token
main:    total time =  1039.01 ms
...
main:     load time =   148.53 ms
main:   sample time =    16.86 ms
main:  predict time =   933.26 ms / 13.33 ms per token
main:    total time =  1101.20 ms
...
main:     load time =   179.84 ms
main:   sample time =    16.95 ms
main:  predict time =   931.18 ms / 13.30 ms per token
main:    total time =  1131.25 ms
...
main:     n_decoded =      504
main:     load time =   147.90 ms
main:   sample time =   128.26 ms
main:  predict time =  6095.74 ms
main:    total time =  6454.60 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfd1bba38a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfd1bba20b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbcc962399ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfd1bba38a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfd1bba38f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbcc96239aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfd1bba20b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbcc962399ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbcc96239b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbcc96239aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfd1bba38a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbcc96239bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbcc96239b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbcc96239c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfd1bba38a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbcc96239bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbcc96239c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbcc96239c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfd1bba38f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbcc96239ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbcc96239c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.74 ms
whisper_print_timings:   sample time =    66.35 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4662.46 ms /     1 runs ( 4662.46 ms per run)
whisper_print_timings:   decode time =    14.79 ms /     2 runs (    7.40 ms per run)
whisper_print_timings:   batchd time =   726.75 ms /   125 runs (    5.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.80 ms
...
main:     load time =    87.74 ms
main:    total time = 39715.06 ms
embd_img
