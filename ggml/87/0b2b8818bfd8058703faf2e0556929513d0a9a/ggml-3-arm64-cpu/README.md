...
- status:  SUCCESS ✅
- runtime: 5:45.31
- date:    Thu Dec  7 06:36:48 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/870b2b8818bfd8058703faf2e0556929513d0a9a
...
19/19 Test #19: test-backend-ops .................   Passed   46.98 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  60.97 sec
...
10/20 Test #10: test3 ............................   Passed    0.03 sec
      Start 11: test-pool
11/20 Test #11: test-pool ........................   Passed    0.01 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.01 sec
...
main:     load time =   276.29 ms
main:   sample time =    17.10 ms
main:  predict time =   823.49 ms / 12.87 ms per token
main:    total time =  1139.17 ms
...
main:     load time =   180.05 ms
main:   sample time =    17.07 ms
main:  predict time =   881.48 ms / 12.59 ms per token
main:    total time =  1081.56 ms
...
main:     n_decoded =      504
main:     load time =   146.96 ms
main:   sample time =   128.28 ms
main:  predict time =  5846.02 ms
main:    total time =  6202.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbba8a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb90b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0facb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbba8a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbba8f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae0fad940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb90b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0facb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae0fae290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae0fad940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbba8a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae0faebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae0fae290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae0faf530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbba8a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae0faebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae0faf6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae0faf530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbba8f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae0faf890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae0faf6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.17 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.45 ms
whisper_print_timings:   sample time =    65.09 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4650.81 ms /     1 runs ( 4650.81 ms per run)
whisper_print_timings:   decode time =    14.92 ms /     2 runs (    7.46 ms per run)
whisper_print_timings:   batchd time =   704.98 ms /   125 runs (    5.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5569.48 ms
...
main:     load time =    84.42 ms
main:    total time = 39444.17 ms
embd_img
...
main:      load time = 13950.91 ms
main:    sample time =   532.61 ms / 8.32 ms per token
main:      eval time = 43574.90 ms / 622.50 ms per token
main:     total time = 60431.22 ms
...
main:      load time =  4356.18 ms
main:    sample time =   528.19 ms / 8.25 ms per token
main:      eval time = 17484.02 ms / 249.77 ms per token
main:     total time = 23337.87 ms
