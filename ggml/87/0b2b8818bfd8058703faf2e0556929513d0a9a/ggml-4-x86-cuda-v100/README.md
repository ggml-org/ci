...
- status:  SUCCESS ✅
- runtime: 8:23.01
- date:    Thu Dec  7 18:41:32 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/19 Test  #4: test-mul-mat0 ....................   Passed    1.05 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.04 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    1.16 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed   90.66 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 122.82 sec
...
20/20 Test #20: test-backend-ops .................   Passed   22.91 sec
...
main:     load time =  1283.18 ms
main:   sample time =    35.14 ms
main:  predict time =   612.21 ms / 9.57 ms per token
main:    total time =  1950.49 ms
...
main:     load time =   571.32 ms
main:   sample time =    33.92 ms
main:  predict time =   579.26 ms / 8.28 ms per token
main:    total time =  1188.70 ms
...
main:     n_decoded =      504
main:     load time =   552.86 ms
main:   sample time =   234.39 ms
main:  predict time =  2154.04 ms
main:    total time =  2985.40 ms
...
main: loaded model in   397.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f21c47b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f21c4637190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b27225d8f0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f21c47b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f21c47bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b27225e6b0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f21c4637190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b27225d8f0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b27225f000                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b27225e6b0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f21c47b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b27225f950                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b27225f000                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b2722602a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f21c47b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b27225f950                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b272260450                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b2722602a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f21c47bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b272260600                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b272260450       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   961.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.64 ms
whisper_print_timings:   sample time =    66.18 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    36.11 ms /     1 runs (   36.11 ms per run)
whisper_print_timings:   decode time =    13.07 ms /     2 runs (    6.53 ms per run)
whisper_print_timings:   batchd time =    82.09 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1185.04 ms
...
main:     load time =   512.50 ms
main:    total time =  7838.06 ms
embd_img
...
main:      load time = 15136.39 ms
main:    sample time =   505.32 ms / 7.90 ms per token
main:      eval time = 23837.38 ms / 340.53 ms per token
main:     total time = 40341.17 ms
...
main:      load time =  7524.01 ms
main:    sample time =   510.74 ms / 7.98 ms per token
main:      eval time = 12512.88 ms / 178.76 ms per token
main:     total time = 21217.56 ms
