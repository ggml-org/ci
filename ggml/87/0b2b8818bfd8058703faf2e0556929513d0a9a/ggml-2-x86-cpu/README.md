...
- status:  SUCCESS ✅
- runtime: 3:58.34
- date:    Thu Dec  7 18:31:44 UTC 2023
...
main:  predict time =   442.93 ms / 6.92 ms per token
main:    total time =   660.72 ms
...
main:     load time =   129.01 ms
main:   sample time =    23.45 ms
main:  predict time =   455.68 ms / 6.51 ms per token
main:    total time =   610.22 ms
...
main:  predict time =  1478.31 ms
main:    total time =  1791.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f02143e8960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0214269190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55786c44cb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f02143e8010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f02143ed900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55786c44d940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0214269190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55786c44cb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55786c44e290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55786c44d940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f02143e8010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55786c44ebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55786c44e290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55786c44f530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f02143e8960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55786c44ebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55786c44f6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55786c44f530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f02143ed900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55786c44f890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55786c44f6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.26 ms
whisper_print_timings:   sample time =    55.01 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1164.85 ms /     1 runs ( 1164.85 ms per run)
whisper_print_timings:   decode time =     9.90 ms /     2 runs (    4.95 ms per run)
whisper_print_timings:   batchd time =   207.42 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1565.00 ms
...
main:      load time = 13677.38 ms
main:    sample time =   465.61 ms / 7.28 ms per token
main:      eval time = 20152.02 ms / 287.89 ms per token
main:     total time = 34955.44 ms
...
main:      load time =  4393.25 ms
main:    sample time =   463.79 ms / 7.25 ms per token
main:      eval time =  8185.20 ms / 116.93 ms per token
main:     total time = 13433.26 ms
