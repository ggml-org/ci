...
- status:  FAILURE ❌ (139)
- runtime: 304.06
- date:    Thu Dec  7 20:31:05 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    8.88 sec
      Start  7: test0
 7/20 Test  #7: test0 ............................   Passed    0.22 sec
      Start  8: test1
 8/20 Test  #8: test1 ............................   Passed    0.23 sec
      Start  9: test2
...
20/20 Test #20: test-backend-ops .................   Passed  128.06 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 142.39 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    1.19 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    0.91 sec
...
10/21 Test #10: test2 ............................   Passed    0.22 sec
      Start 11: test3
11/21 Test #11: test3 ............................   Passed    0.20 sec
      Start 12: test-pool
...
21/21 Test #21: test-backend-ops .................   Passed   11.22 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  19.55 sec
...
main:  predict time =   300.38 ms / 4.69 ms per token
main:    total time =   461.66 ms
...
main:     load time =    95.82 ms
main:   sample time =     8.81 ms
main:  predict time =   307.52 ms / 4.39 ms per token
main:    total time =   413.02 ms
...
main:     n_decoded =      504
main:     load time =   118.19 ms
main:   sample time =    65.89 ms
main:  predict time =   764.59 ms
main:    total time =   959.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x120187950                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x120008180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1202a8210                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x120187000                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x12018c8f0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x1202a8fd0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x120008180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1202a8210                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x1202a9920                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x1202a8fd0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x120187000                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x1202aa270                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x1202a9920                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x1202aabc0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x120187950                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x1202aa270                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x1202aad70                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x1202aabc0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x12018c8f0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x1202aaf20                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x1202aad70                           node_4
...
ggml_metal_init: error: Error Domain=NSCocoaErrorDomain Code=260 "The file “ggml-metal.metal” couldn’t be opened because there is no such file." UserInfo={NSFilePath=ggml-metal.metal, NSUnderlyingError=0x6000008bd710 {Error Domain=NSPOSIXErrorDomain Code=2 "No such file or directory"}}
whisper_backend_init: ggml_backend_metal_init() failed
ci/run.sh: line 219: 66794 Segmentation fault: 11  ./bin/whisper -m ${model_f16} -f ${audio_0}
```
