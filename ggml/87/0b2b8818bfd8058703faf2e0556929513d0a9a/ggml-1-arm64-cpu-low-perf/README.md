...
- status:  SUCCESS ✅
- runtime: 3:50.24
- date:    Thu Dec  7 06:31:42 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.82 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.70 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   55.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.18 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.70 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.60 sec
      Start 10: test-pool
...
main:  predict time =   844.73 ms / 13.20 ms per token
main:    total time =  1081.58 ms
...
main:     load time =   190.91 ms
main:   sample time =    19.33 ms
main:  predict time =   925.21 ms / 13.22 ms per token
main:    total time =  1138.46 ms
...
main:   sample time =   129.32 ms
main:  predict time =  6009.93 ms
main:    total time =  6391.35 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9f2a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9dab190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0859b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9f2a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9f2f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad085a940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9dab190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0859b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad085b290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad085a940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9f2a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad085bbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad085b290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad085c530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9f2a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad085bbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad085c6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad085c530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9f2f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad085c890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad085c6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    68.89 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4689.04 ms /     1 runs ( 4689.04 ms per run)
whisper_print_timings:   decode time =    15.71 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   848.67 ms /   125 runs (    6.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5750.92 ms
