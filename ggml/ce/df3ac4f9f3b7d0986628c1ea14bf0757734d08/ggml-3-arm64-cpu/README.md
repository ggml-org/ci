...
- status:  SUCCESS ✅
- runtime: 3:32.09
- date:    Fri Sep 15 11:54:15 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.91 sec
...
Total Test time (real) =  12.28 sec
...
main:     load time =   258.90 ms
main:   sample time =    17.79 ms
main:  predict time =   808.44 ms / 12.63 ms per token
main:    total time =  1107.84 ms
...
main:  predict time =   876.02 ms / 12.51 ms per token
main:    total time =  1077.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb776a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb75eb160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad8eabac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7769fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb776f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad8eac850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb75eb160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad8eabac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad8ead170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad8eac850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb7769fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad8eada90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad8ead170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad8eae3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb776a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad8eada90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad8eae530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad8eae3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb776f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad8eae6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad8eae530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:    sample time =   626.72 ms / 9.79 ms per token
main:      eval time = 43781.36 ms / 625.45 ms per token
main:     total time = 52573.16 ms
...
main:      load time =  1629.81 ms
main:    sample time =   627.79 ms / 9.81 ms per token
main:      eval time = 17285.67 ms / 246.94 ms per token
main:     total time = 20500.37 ms
