...
- status:  SUCCESS ✅
- runtime: 2:34.30
- date:    Fri Sep 15 11:52:10 UTC 2023
...
main:     load time =   129.78 ms
main:   sample time =    23.89 ms
main:  predict time =   446.62 ms / 6.38 ms per token
main:    total time =   603.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7eff04d6d8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7eff04bee160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5648bee3bac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7eff04d6cfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7eff04d72840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5648bee3c850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7eff04bee160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5648bee3bac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5648bee3d170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5648bee3c850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7eff04d6cfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5648bee3da90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5648bee3d170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5648bee3e3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7eff04d6d8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5648bee3da90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5648bee3e530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5648bee3e3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7eff04d72840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5648bee3e6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5648bee3e530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5605.75 ms
main:    sample time =   471.19 ms / 7.36 ms per token
main:      eval time = 20476.53 ms / 292.52 ms per token
main:     total time = 27220.87 ms
...
main:      load time =  1249.85 ms
main:    sample time =   467.63 ms / 7.31 ms per token
main:      eval time =  8601.07 ms / 122.87 ms per token
main:     total time = 10692.38 ms
