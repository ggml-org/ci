...
- status:  SUCCESS ✅
- runtime: 2:01.99
- date:    Fri Nov  3 19:44:34 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.43 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.71 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.01 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.04 sec
      Start  4: test-mul-mat0
 ...
 7/14 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.77 sec
      Start  9: test3
...
main:  predict time =   606.56 ms / 9.48 ms per token
main:    total time =   772.50 ms
...
main:     load time =   129.99 ms
main:   sample time =    24.05 ms
main:  predict time =   760.77 ms / 10.87 ms per token
main:    total time =   916.74 ms
...
main:   sample time =   180.57 ms
main:  predict time =  2365.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe9d74b7960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe9d7338190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555e4d8ccb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe9d74b7010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe9d74bc900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555e4d8cd940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe9d7338190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555e4d8ccb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555e4d8ce290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555e4d8cd940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe9d74b7010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555e4d8cebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555e4d8ce290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555e4d8cf530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe9d74b7960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555e4d8cebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555e4d8cf6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555e4d8cf530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe9d74bc900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555e4d8cf890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555e4d8cf6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    84.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    25.67 ms
whisper_print_timings:   sample time =    16.36 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  2089.48 ms /     1 runs ( 2089.48 ms per run)
whisper_print_timings:   decode time =   127.79 ms /    27 runs (    4.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2382.47 ms
