...
- status:  SUCCESS ✅
- runtime: 5:45.33
- date:    Fri Nov  3 19:48:17 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    5.87 sec
      Start  2: test-opt
...
main:     load time =   195.14 ms
main:   sample time =    34.60 ms
main:  predict time =   576.79 ms / 9.01 ms per token
main:    total time =   831.66 ms
...
main:  predict time =   584.36 ms / 8.35 ms per token
main:    total time =   803.66 ms
...
main:   sample time =   240.69 ms
main:  predict time =  2277.95 ms
main:    total time =  2719.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f62810fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6280f7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562989575b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f62810fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f62810ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562989576940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6280f7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562989575b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562989577290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562989576940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f62810fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562989577be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562989577290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562989578530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f62810fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562989577be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5629895786e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562989578530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f62810ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x562989578890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5629895786e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   746.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.09 ms
whisper_print_timings:   sample time =    20.88 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  1870.32 ms /     1 runs ( 1870.32 ms per run)
whisper_print_timings:   decode time =   138.57 ms /    27 runs (    5.13 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2859.96 ms
...
main:      load time =  7337.44 ms
main:    sample time =   583.34 ms / 9.11 ms per token
main:      eval time = 25191.68 ms / 359.88 ms per token
main:     total time = 34048.36 ms
...
main:      load time =  1748.74 ms
main:    sample time =   601.49 ms / 9.40 ms per token
main:      eval time = 12724.67 ms / 181.78 ms per token
main:     total time = 15808.03 ms
