...
- status:  SUCCESS ✅
- runtime: 2:34.76
- date:    Fri Nov  3 07:45:06 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.69 sec
      Start  9: test3
...
main:  predict time =   977.04 ms / 15.27 ms per token
main:    total time =  1205.09 ms
...
main:     load time =   187.71 ms
main:   sample time =    19.55 ms
main:  predict time =   895.54 ms / 12.79 ms per token
...
main:   sample time =   137.58 ms
main:  predict time =  5967.21 ms
main:    total time =  6350.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaba7a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffab8fb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab10edbb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaba7a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaba7f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab10edc940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffab8fb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab10edbb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab10edd290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab10edc940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaba7a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab10eddbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab10edd290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab10ede530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaba7a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab10eddbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab10ede6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab10ede530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaba7f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab10ede890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab10ede6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.70 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.93 ms
whisper_print_timings:   sample time =    23.81 ms /    27 runs (    0.88 ms per run)
whisper_print_timings:   encode time =  4713.86 ms /     1 runs ( 4713.86 ms per run)
whisper_print_timings:   decode time =   181.41 ms /    27 runs (    6.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5101.21 ms
...
main:     load time =    91.73 ms
main:    total time = 40199.74 ms
embd_img
