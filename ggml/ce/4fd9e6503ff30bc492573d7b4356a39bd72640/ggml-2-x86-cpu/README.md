...
- status:  SUCCESS ✅
- runtime: 3:14.64
- date:    Fri Nov  3 19:45:46 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.28 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.16 sec
      Start  2: test-opt
...
main:  predict time =   437.10 ms / 6.83 ms per token
main:    total time =   653.66 ms
...
main:  predict time =   448.90 ms / 6.41 ms per token
main:    total time =   604.49 ms
...
main:   sample time =   177.53 ms
main:  predict time =  1471.12 ms
main:    total time =  1781.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fafcfd15960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fafcfb96190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c07d43cb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fafcfd15010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fafcfd1a900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c07d43d940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fafcfb96190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c07d43cb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c07d43e290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c07d43d940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fafcfd15010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c07d43ebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c07d43e290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c07d43f530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fafcfd15960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c07d43ebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c07d43f6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c07d43f530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fafcfd1a900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c07d43f890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c07d43f6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   130.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    16.34 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1191.40 ms /     1 runs ( 1191.40 ms per run)
whisper_print_timings:   decode time =    91.78 ms /    27 runs (    3.40 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1479.45 ms
...
main:     load time =    61.30 ms
main:    total time = 10434.39 ms
embd_img
...
main:      load time = 10940.13 ms
main:    sample time =   470.86 ms / 7.36 ms per token
main:      eval time = 20072.34 ms / 286.75 ms per token
main:     total time = 32141.49 ms
...
main:      load time =  4378.29 ms
main:    sample time =   464.38 ms / 7.26 ms per token
main:      eval time =  8013.35 ms / 114.48 ms per token
main:     total time = 13228.26 ms
