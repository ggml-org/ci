...
- status:  SUCCESS ✅
- runtime: 4:50.89
- date:    Fri Nov  3 07:47:27 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ce4fd9e6503ff30bc492573d7b4356a39bd72640
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.47 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.04 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.29 sec
      Start  4: test-mul-mat0
 4/14 Test  #4: test-mul-mat0 ....................   Passed    0.57 sec
 ...
 8/14 Test  #8: test2 ............................   Passed    0.02 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    0.04 sec
      Start 10: test-pool
...
Total Test time (real) =  14.16 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.09 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.98 sec
      Start  3: test-quantize-fns
 3/15 Test  #3: test-quantize-fns ................   Passed    0.01 sec
      Start  4: test-quantize-perf
 4/15 Test  #4: test-quantize-perf ...............   Passed    0.05 sec
...
main:     load time =   223.88 ms
main:   sample time =    17.02 ms
main:  predict time =   808.23 ms / 12.63 ms per token
main:    total time =  1071.27 ms
...
main:     load time =   169.12 ms
main:   sample time =    16.69 ms
main:  predict time =   875.09 ms / 12.50 ms per token
main:    total time =  1063.77 ms
...
main:   sample time =   127.92 ms
main:  predict time =  5819.27 ms
main:    total time =  6164.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb44ba960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb433b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1edbeb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb44ba010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb44bf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1edbf940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb433b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1edbeb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1edc0290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1edbf940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb44ba010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1edc0be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1edc0290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1edc1530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb44ba960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1edc0be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1edc16e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1edc1530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb44bf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab1edc1890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1edc16e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   214.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.48 ms
whisper_print_timings:   sample time =    20.97 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4601.22 ms /     1 runs ( 4601.22 ms per run)
whisper_print_timings:   decode time =   174.78 ms /    27 runs (    6.47 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5072.54 ms
...
main:     load time =    78.63 ms
main:    total time = 39284.73 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.226000 sec.)
...
main:      load time = 11768.21 ms
main:    sample time =   536.28 ms / 8.38 ms per token
main:      eval time = 43430.34 ms / 620.43 ms per token
main:     total time = 58105.33 ms
...
main:      load time =  4343.68 ms
main:    sample time =   523.33 ms / 8.18 ms per token
main:      eval time = 17678.99 ms / 252.56 ms per token
main:     total time = 23493.60 ms
