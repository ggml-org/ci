...
- status:  SUCCESS ✅
- runtime: 3:33.12
- date:    Tue Jan  9 04:20:25 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   43.14 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.89 sec
...
main:     load time =   193.33 ms
main:   sample time =    17.78 ms
main:  predict time =   857.36 ms / 13.40 ms per token
main:    total time =  1090.26 ms
...
main:     n_decoded =      504
main:     load time =   163.19 ms
main:   sample time =   130.68 ms
main:  predict time =  6252.09 ms
main:    total time =  6627.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff95e6a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff95ceb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2478b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff95e6a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff95e6f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac2479960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff95ceb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2478b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac247a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac2479960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff95e6a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac247ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac247a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac247b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff95e6a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac247ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac247b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac247b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff95e6f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac247b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac247b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    68.39 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4769.44 ms /     1 runs ( 4769.44 ms per run)
whisper_print_timings:   decode time =    15.87 ms /     2 runs (    7.94 ms per run)
whisper_print_timings:   batchd time =   714.60 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5700.46 ms
...
main:     load time =    96.84 ms
main:    total time = 40605.30 ms
embd_img
