...
- status:  SUCCESS ✅
- runtime: 5:49.87
- date:    Tue Jan  9 04:22:34 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   34.90 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.13 sec
...
main:     load time =   185.65 ms
main:   sample time =    17.14 ms
main:  predict time =   822.06 ms / 12.84 ms per token
main:    total time =  1046.99 ms
...
main:  predict time =   896.85 ms / 12.81 ms per token
main:    total time =  1097.56 ms
...
main:  predict time =  6003.33 ms
main:    total time =  6366.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff94f5a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff94ddb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf25d8b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff94f5a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff94f5f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf25d9960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff94ddb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf25d8b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf25da2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf25d9960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff94f5a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf25dac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf25da2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf25db580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff94f5a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf25dac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf25db740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf25db580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff94f5f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf25db900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf25db740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   185.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.32 ms
whisper_print_timings:   sample time =    66.08 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4638.90 ms /     1 runs ( 4638.90 ms per run)
whisper_print_timings:   decode time =    15.17 ms /     2 runs (    7.59 ms per run)
whisper_print_timings:   batchd time =   706.43 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5630.23 ms
...
main:     load time =    84.16 ms
main:    total time = 39727.99 ms
embd_img
...
main:      load time = 13264.38 ms
main:    sample time =   516.54 ms / 8.07 ms per token
main:      eval time = 43814.53 ms / 625.92 ms per token
main:     total time = 59968.37 ms
...
main:      load time =  3799.77 ms
main:    sample time =   515.23 ms / 8.05 ms per token
main:      eval time = 17424.35 ms / 248.92 ms per token
main:     total time = 22695.85 ms
