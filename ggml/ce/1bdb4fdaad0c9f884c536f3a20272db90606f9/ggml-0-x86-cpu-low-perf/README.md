...
- status:  SUCCESS ✅
- runtime: 2:47.89
- date:    Tue Jan  9 16:19:29 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   34.86 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    7.74 sec
...
main:  predict time =   643.43 ms / 10.05 ms per token
main:    total time =   808.92 ms
...
main:     load time =   126.83 ms
main:   sample time =    23.53 ms
main:  predict time =   658.03 ms / 9.40 ms per token
main:    total time =   810.61 ms
...
main:  predict time =  2505.22 ms
main:    total time =  2835.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdfbe47d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdfbe2fe1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5648545b4b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdfbe47d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdfbe482940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5648545b5960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdfbe2fe1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5648545b4b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5648545b62c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5648545b5960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdfbe47d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5648545b6c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5648545b62c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5648545b7580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdfbe47d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5648545b6c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5648545b7740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5648545b7580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdfbe482940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5648545b7900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5648545b7740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.99 ms
whisper_print_timings:   sample time =    71.21 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  2018.06 ms /     1 runs ( 2018.06 ms per run)
whisper_print_timings:   decode time =    12.58 ms /     2 runs (    6.29 ms per run)
whisper_print_timings:   batchd time =   325.88 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2531.36 ms
