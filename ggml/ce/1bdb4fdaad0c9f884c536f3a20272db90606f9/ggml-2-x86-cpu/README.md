...
- status:  SUCCESS ✅
- runtime: 4:16.36
- date:    Tue Jan  9 16:21:09 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ce1bdb4fdaad0c9f884c536f3a20272db90606f9
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.38 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    3.24 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.65 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   26.98 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  42.68 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.95 sec
...
main:     load time =   191.51 ms
main:   sample time =    23.62 ms
main:  predict time =   461.25 ms / 7.21 ms per token
main:    total time =   689.34 ms
...
main:     load time =   126.75 ms
main:   sample time =    23.52 ms
main:  predict time =   468.89 ms / 6.70 ms per token
main:    total time =   621.48 ms
...
main:     n_decoded =      504
main:     load time =   103.82 ms
main:   sample time =   177.80 ms
main:  predict time =  1515.58 ms
main:    total time =  1828.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f72562b2990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f72561331a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f329607b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f72562b2030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f72562b7940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f329608960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f72561331a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f329607b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f3296092c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f329608960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f72562b2030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f329609c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f3296092c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f32960a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f72562b2990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f329609c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f32960a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f32960a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f72562b7940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f32960a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f32960a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.77 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.73 ms
whisper_print_timings:   sample time =    55.67 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1157.61 ms /     1 runs ( 1157.61 ms per run)
whisper_print_timings:   decode time =     9.93 ms /     2 runs (    4.97 ms per run)
whisper_print_timings:   batchd time =   208.97 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1581.05 ms
...
main:     load time =    59.53 ms
main:    total time = 10643.19 ms
embd_img
...
main:      load time = 12902.72 ms
main:    sample time =   468.41 ms / 7.32 ms per token
main:      eval time = 20783.46 ms / 296.91 ms per token
main:     total time = 34841.92 ms
...
main:      load time =  4389.39 ms
main:    sample time =   466.72 ms / 7.29 ms per token
main:      eval time =  8962.77 ms / 128.04 ms per token
main:     total time = 14169.80 ms
