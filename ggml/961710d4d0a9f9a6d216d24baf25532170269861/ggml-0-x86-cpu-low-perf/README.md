...
- status: SUCCESS ✅
- date:   Mon Jul 17 12:38:44 UTC 2023
...
main:     load time =   131.48 ms
main:   sample time =    23.63 ms
main:  predict time =   590.66 ms / 9.23 ms per token
...
main: mem per token =  2016924 bytes
main:     load time =   136.76 ms
main:   sample time =    23.46 ms
main:  predict time =   615.79 ms / 8.80 ms per token
main:    total time =   815.74 ms
