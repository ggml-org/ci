...
- status:  SUCCESS ✅
- runtime: 5:13.23
- date:    Fri Dec 29 08:58:20 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.27 sec
...
19/19 Test #19: test-backend-ops .................   Passed   35.15 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.24 sec
      Start  2: test-opt
 ...
 5/20 Test  #5: test-mul-mat0 ....................   Passed    0.56 sec
...
20/20 Test #20: test-backend-ops .................   Passed   10.30 sec
...
main:     load time =   187.63 ms
main:   sample time =    17.08 ms
main:  predict time =   808.98 ms / 12.64 ms per token
main:    total time =  1037.09 ms
...
main:     load time =   187.02 ms
main:   sample time =    16.97 ms
main:  predict time =   876.57 ms / 12.52 ms per token
main:    total time =  1083.60 ms
...
main:     n_decoded =      504
main:     load time =   155.41 ms
main:   sample time =   128.55 ms
main:  predict time =  5902.35 ms
main:    total time =  6267.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a00a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99e8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3a07b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a00a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a00f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3a08960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99e8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3a07b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3a092c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3a08960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a00a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3a09c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3a092c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3a0a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a00a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3a09c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3a0a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3a0a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a00f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae3a0a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3a0a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.05 ms
whisper_print_timings:   sample time =    65.34 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4628.12 ms /     1 runs ( 4628.12 ms per run)
whisper_print_timings:   decode time =    15.44 ms /     2 runs (    7.72 ms per run)
whisper_print_timings:   batchd time =   705.87 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5536.29 ms
...
main:     load time =   103.49 ms
main:    total time = 39538.76 ms
embd_img
...
main:      load time =  5606.45 ms
main:    sample time =   520.35 ms / 8.13 ms per token
main:      eval time = 43730.83 ms / 624.73 ms per token
main:     total time = 52230.77 ms
...
main:      load time =  1591.52 ms
main:    sample time =   516.30 ms / 8.07 ms per token
main:      eval time = 17126.01 ms / 244.66 ms per token
main:     total time = 20202.42 ms
