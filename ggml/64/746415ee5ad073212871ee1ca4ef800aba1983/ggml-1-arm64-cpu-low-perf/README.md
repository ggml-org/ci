...
- status:  SUCCESS ✅
- runtime: 3:34.52
- date:    Fri Dec 29 08:56:38 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.84 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.37 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   43.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.31 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.93 sec
...
main:     load time =   196.05 ms
main:   sample time =    17.92 ms
main:  predict time =   838.82 ms / 13.11 ms per token
...
main:     load time =   195.02 ms
main:   sample time =    17.73 ms
main:  predict time =  1033.12 ms / 14.76 ms per token
main:    total time =  1248.79 ms
...
main:     n_decoded =      504
main:     load time =   161.99 ms
main:   sample time =   128.92 ms
main:  predict time =  6131.64 ms
main:    total time =  6504.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffba8ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffba74b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5b68b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffba8ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffba8cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae5b69960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffba74b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5b68b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae5b6a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae5b69960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffba8ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae5b6ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae5b6a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae5b6b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffba8ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae5b6ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae5b6b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae5b6b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffba8cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae5b6b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae5b6b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.66 ms
whisper_print_timings:   sample time =    66.53 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4738.61 ms /     1 runs ( 4738.61 ms per run)
whisper_print_timings:   decode time =    15.56 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   743.23 ms /   125 runs (    5.95 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5694.81 ms
