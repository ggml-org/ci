...
- status:  SUCCESS ✅
- runtime: 7:33.26
- date:    Fri Dec 29 09:00:46 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   61.69 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  93.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    6.68 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.58 sec
      Start  3: test-quantize-fns
 3/20 Test  #3: test-quantize-fns ................   Passed    0.57 sec
 ...
 9/20 Test  #9: test2 ............................   Passed    8.02 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    1.15 sec
      Start 11: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   23.21 sec
...
main:     load time =   562.05 ms
main:   sample time =    35.91 ms
main:  predict time =   569.63 ms / 8.90 ms per token
main:    total time =  1187.46 ms
...
main:     load time =   568.35 ms
main:   sample time =    35.03 ms
main:  predict time =   578.46 ms / 8.26 ms per token
main:    total time =  1186.08 ms
...
main:     n_decoded =      504
main:     load time =   542.56 ms
main:   sample time =   236.59 ms
main:  predict time =  2161.77 ms
main:    total time =  2984.81 ms
...
main: loaded model in   405.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1f13cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1f13b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559abaf1e040                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1f13cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1f13cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559abaf1ee10                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1f13b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559abaf1e040                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559abaf1f770                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559abaf1ee10                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1f13cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559abaf200d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559abaf1f770                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559abaf20a30                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1f13cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559abaf200d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559abaf20bf0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559abaf20a30                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1f13cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559abaf20db0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559abaf20bf0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   499.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.95 ms
whisper_print_timings:   sample time =    68.71 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    34.72 ms /     1 runs (   34.72 ms per run)
whisper_print_timings:   decode time =    13.75 ms /     2 runs (    6.88 ms per run)
whisper_print_timings:   batchd time =    81.72 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   725.38 ms
...
main:     load time =   498.59 ms
main:    total time =  7790.66 ms
embd_img
...
main:      load time =  6877.79 ms
main:    sample time =   527.87 ms / 8.25 ms per token
main:      eval time = 23711.84 ms / 338.74 ms per token
main:     total time = 31980.63 ms
...
main:      load time =  2216.23 ms
main:    sample time =   549.68 ms / 8.59 ms per token
main:      eval time = 12193.54 ms / 174.19 ms per token
main:     total time = 15613.91 ms
