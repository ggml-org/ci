...
- status:  SUCCESS ✅
- runtime: 3:20.67
- date:    Fri Dec 29 08:56:31 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.13 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.24 sec
...
main:     load time =   121.95 ms
main:   sample time =    23.43 ms
main:  predict time =   427.93 ms / 6.69 ms per token
...
main:  predict time =  1455.35 ms
main:    total time =  1766.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f637f4ff990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f637f3801a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556568f72b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f637f4ff030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f637f504940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556568f73960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f637f3801a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556568f72b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556568f742c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556568f73960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f637f4ff030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556568f74c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556568f742c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556568f75580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f637f4ff990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556568f74c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556568f75740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556568f75580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f637f504940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556568f75900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556568f75740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.23 ms
whisper_print_timings:   sample time =    55.21 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1152.84 ms /     1 runs ( 1152.84 ms per run)
whisper_print_timings:   decode time =    10.10 ms /     2 runs (    5.05 ms per run)
whisper_print_timings:   batchd time =   209.37 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1522.97 ms
...
main:      load time =  4228.38 ms
main:    sample time =   468.49 ms / 7.32 ms per token
main:      eval time = 19210.87 ms / 274.44 ms per token
main:     total time = 24556.12 ms
...
main:      load time =  1258.16 ms
main:    sample time =   466.43 ms / 7.29 ms per token
main:      eval time =  8018.03 ms / 114.54 ms per token
main:     total time = 10114.87 ms
