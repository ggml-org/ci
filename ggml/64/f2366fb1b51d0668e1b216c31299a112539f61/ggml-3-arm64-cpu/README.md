...
- status:  SUCCESS ✅
- runtime: 4:54.26
- date:    Tue Dec  5 10:33:30 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/64f2366fb1b51d0668e1b216c31299a112539f61
- author:  Judd
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.26 sec
...
main:     load time =   254.31 ms
main:   sample time =    16.87 ms
main:  predict time =   809.72 ms / 12.65 ms per token
...
main:     load time =   179.46 ms
main:   sample time =    16.93 ms
main:  predict time =   875.22 ms / 12.50 ms per token
main:    total time =  1074.34 ms
...
main:     n_decoded =      504
main:     load time =   144.76 ms
main:   sample time =   127.89 ms
main:  predict time =  5844.10 ms
main:    total time =  6197.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85dba960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85c3b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae616fb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85dba010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85dbf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6170940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85c3b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae616fb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6171290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6170940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85dba010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6171be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6171290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6172530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85dba960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6171be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae61726e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6172530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85dbf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae6172890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae61726e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   182.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.86 ms
whisper_print_timings:   sample time =    63.83 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4628.00 ms /     1 runs ( 4628.00 ms per run)
whisper_print_timings:   decode time =    14.87 ms /     2 runs (    7.43 ms per run)
whisper_print_timings:   batchd time =   709.94 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5616.06 ms
...
main:     load time =    79.46 ms
main:    total time = 39299.40 ms
embd_img
...
main:      load time = 13096.39 ms
main:    sample time =   533.79 ms / 8.34 ms per token
main:      eval time = 43602.19 ms / 622.89 ms per token
main:     total time = 59605.51 ms
...
main:      load time =  4362.50 ms
main:    sample time =   522.08 ms / 8.16 ms per token
main:      eval time = 17737.96 ms / 253.40 ms per token
main:     total time = 23593.18 ms
