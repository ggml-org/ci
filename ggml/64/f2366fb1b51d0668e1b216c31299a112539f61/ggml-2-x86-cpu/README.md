...
- status:  SUCCESS ✅
- runtime: 3:15.58
- date:    Tue Dec  5 10:22:29 UTC 2023
...
main:     load time =   185.50 ms
main:   sample time =    23.36 ms
main:  predict time =   426.57 ms / 6.67 ms per token
main:    total time =   648.25 ms
...
main:     load time =   125.09 ms
main:   sample time =    23.35 ms
main:  predict time =   447.50 ms / 6.39 ms per token
main:    total time =   598.00 ms
...
main:  predict time =  1464.08 ms
main:    total time =  1775.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd570c34960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd570ab5190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e543cf5b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd570c34010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd570c39900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e543cf6940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd570ab5190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e543cf5b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e543cf7290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e543cf6940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd570c34010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e543cf7be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e543cf7290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e543cf8530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd570c34960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e543cf7be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e543cf86e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e543cf8530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd570c39900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e543cf8890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e543cf86e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   130.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.45 ms
whisper_print_timings:   sample time =    53.52 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1135.82 ms /     1 runs ( 1135.82 ms per run)
whisper_print_timings:   decode time =     9.06 ms /     2 runs (    4.53 ms per run)
whisper_print_timings:   batchd time =   202.68 ms /   125 runs (    1.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1549.07 ms
...
main:     load time =    60.22 ms
main:    total time = 10384.57 ms
embd_img
...
main:      load time = 12851.77 ms
main:    sample time =   468.25 ms / 7.32 ms per token
main:      eval time = 20319.20 ms / 290.27 ms per token
main:     total time = 34310.41 ms
...
main:      load time =  4382.46 ms
main:    sample time =   466.31 ms / 7.29 ms per token
main:      eval time =  8635.23 ms / 123.36 ms per token
main:     total time = 13857.80 ms
