...
- status:  SUCCESS ✅
- runtime: 2:06.60
- date:    Tue Dec  5 10:12:11 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.21 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.69 sec
      Start  9: test3
...
Total Test time (real) =  19.15 sec
...
main:  predict time =   604.56 ms / 9.45 ms per token
main:    total time =   767.90 ms
...
main:  predict time =   634.48 ms / 9.06 ms per token
...
main:     n_decoded =      504
main:     load time =   104.81 ms
main:   sample time =   178.03 ms
main:  predict time =  2368.62 ms
main:    total time =  2697.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe831612960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe831493190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5597ebedfb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe831612010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe831617900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5597ebee0940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe831493190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5597ebedfb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5597ebee1290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5597ebee0940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe831612010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5597ebee1be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5597ebee1290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5597ebee2530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe831612960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5597ebee1be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5597ebee26e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5597ebee2530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe831617900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5597ebee2890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5597ebee26e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    80.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.89 ms
whisper_print_timings:   sample time =    71.06 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1979.90 ms /     1 runs ( 1979.90 ms per run)
whisper_print_timings:   decode time =    12.39 ms /     2 runs (    6.19 ms per run)
whisper_print_timings:   batchd time =   322.69 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2491.93 ms
