...
- status:  SUCCESS ✅
- runtime: 3:08.22
- date:    Wed Mar 27 11:35:16 UTC 2024
...
main:  predict time =   896.71 ms / 14.01 ms per token
main:    total time =  1089.51 ms
...
main:  predict time =   971.95 ms / 13.88 ms per token
main:    total time =  1145.53 ms
...
main:     load time =   182.63 ms
main:   sample time =    17.71 ms
main:  predict time =  1001.47 ms / 14.31 ms per token
main:    total time =  1205.22 ms
...
main:     n_decoded =      504
main:     load time =   152.95 ms
main:   sample time =   129.10 ms
main:  predict time =  6550.39 ms
main:    total time =  6915.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87c7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff87afb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeeb24ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87c7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87c7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeeb25ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff87afb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeeb24ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeeb26410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeeb25ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87c7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeeb26d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeeb26410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeeb276d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff87c7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeeb26d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeeb27890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeeb276d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff87c7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeeb27a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeeb27890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.55 ms
whisper_print_timings:   sample time =    65.83 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4686.19 ms /     1 runs ( 4686.19 ms per run)
whisper_print_timings:   decode time =    15.56 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   709.79 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5602.60 ms
...
main:     load time =    92.10 ms
main:    total time = 39784.05 ms
embd_img
