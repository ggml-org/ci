...
- status:  SUCCESS ✅
- runtime: 4:04.44
- date:    Wed Mar 27 11:24:16 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.25 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.31 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   22.16 sec
      Start  9: test3
...
main:     load time =   161.51 ms
main:   sample time =    18.08 ms
main:  predict time =   937.61 ms / 14.65 ms per token
main:    total time =  1139.12 ms
...
main:     load time =   163.09 ms
main:   sample time =    17.86 ms
main:  predict time =   995.94 ms / 14.23 ms per token
main:    total time =  1179.78 ms
...
main:     load time =   193.59 ms
main:   sample time =    17.97 ms
main:  predict time =  1067.01 ms / 15.24 ms per token
main:    total time =  1282.07 ms
...
main:     n_decoded =      504
main:     load time =   161.92 ms
main:   sample time =   128.03 ms
main:  predict time =  6497.14 ms
main:    total time =  6870.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80b4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff809cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0b4bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80b4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80b4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0b4cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff809cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0b4bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae0b4d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0b4cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80b4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae0b4dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae0b4d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0b4e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80b4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae0b4dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0b4e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0b4e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80b4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae0b4ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0b4e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    66.83 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4744.86 ms /     1 runs ( 4744.86 ms per run)
whisper_print_timings:   decode time =    15.52 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   719.23 ms /   125 runs (    5.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5678.20 ms
...
main:     load time =    92.91 ms
main:    total time = 40037.30 ms
embd_img
