...
- status:  SUCCESS ✅
- runtime: 2:08.03
- date:    Wed Mar 27 11:28:24 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.32 sec
      Start  2: test-opt
...
main:  predict time =   492.80 ms / 7.70 ms per token
main:    total time =   635.92 ms
...
main:  predict time =   522.26 ms / 7.46 ms per token
main:    total time =   652.14 ms
...
main:     load time =   125.33 ms
main:   sample time =    23.81 ms
main:  predict time =   529.57 ms / 7.57 ms per token
main:    total time =   681.79 ms
...
main:     n_decoded =      504
main:     load time =   103.08 ms
main:   sample time =   175.15 ms
main:  predict time =  1830.96 ms
main:    total time =  2141.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcad4326990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcad41a71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d09e4acce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcad4326030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcad432b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d09e4adab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcad41a71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d09e4acce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d09e4ae410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d09e4adab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcad4326030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d09e4aed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d09e4ae410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d09e4af6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcad4326990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d09e4aed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d09e4af890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d09e4af6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcad432b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d09e4afa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d09e4af890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    55.03 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1185.78 ms /     1 runs ( 1185.78 ms per run)
whisper_print_timings:   decode time =    12.59 ms /     2 runs (    6.29 ms per run)
whisper_print_timings:   batchd time =   213.41 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1560.44 ms
...
main:     load time =    66.66 ms
main:    total time = 10709.62 ms
embd_img
