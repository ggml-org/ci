...
- status:  SUCCESS ✅
- runtime: 3:37.36
- date:    Sun Feb 11 12:20:31 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    2.44 sec
...
20/20 Test #20: test-backend-ops .................   Passed  110.81 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 121.23 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test1 ............................   Passed    0.00 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    0.04 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   18.41 sec
...
main:  predict time =   454.23 ms / 7.10 ms per token
main:    total time =   596.18 ms
...
main:  predict time =   468.76 ms / 6.70 ms per token
main:    total time =   599.69 ms
...
main:  predict time =    11.27 ms / 0.16 ms per token
main:    total time =   160.71 ms
...
main:  predict time =  1524.83 ms
main:    total time =  1836.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa32347f990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa3233001a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5561e1fa9b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa32347f030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa323484940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5561e1faa960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa3233001a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5561e1fa9b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5561e1fab2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5561e1faa960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa32347f030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5561e1fabc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5561e1fab2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5561e1fac580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa32347f990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5561e1fabc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5561e1fac740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5561e1fac580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa323484940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5561e1fac900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5561e1fac740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.95 ms
whisper_print_timings:   sample time =    54.93 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1148.78 ms /     1 runs ( 1148.78 ms per run)
whisper_print_timings:   decode time =    10.48 ms /     2 runs (    5.24 ms per run)
whisper_print_timings:   batchd time =   208.68 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1516.70 ms
...
main:     load time =    66.40 ms
main:    total time = 10461.92 ms
embd_img
