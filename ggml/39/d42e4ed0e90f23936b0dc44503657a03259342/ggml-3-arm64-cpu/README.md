...
- status:  SUCCESS ✅
- runtime: 4:51.03
- date:    Sun Feb 11 12:21:38 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  139.62 sec
...
21/21 Test #21: test-backend-ops .................   Passed   23.19 sec
...
main:  predict time =   830.73 ms / 12.98 ms per token
main:    total time =  1018.67 ms
...
main:  predict time =   905.29 ms / 12.93 ms per token
main:    total time =  1072.98 ms
...
main:   sample time =    15.59 ms
main:  predict time =    15.19 ms / 0.22 ms per token
main:    total time =   211.20 ms
...
main:  predict time =  5954.15 ms
main:    total time =  6314.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ebea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ea6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae87f1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ebea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ebef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae87f2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ea6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae87f1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae87f32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae87f2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ebea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae87f3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae87f32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae87f4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ebea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae87f3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae87f4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae87f4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ebef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae87f4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae87f4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4622.60 ms /     1 runs ( 4622.60 ms per run)
whisper_print_timings:   decode time =    15.49 ms /     2 runs (    7.74 ms per run)
whisper_print_timings:   batchd time =   711.46 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5537.01 ms
...
main:     load time =    88.77 ms
main:    total time = 39619.66 ms
embd_img
