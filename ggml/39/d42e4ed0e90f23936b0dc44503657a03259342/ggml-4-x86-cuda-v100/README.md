...
- status:  SUCCESS ✅
- runtime: 9:26.52
- date:    Sun Feb 11 12:26:16 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  248.82 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.90 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.55 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.86 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   43.36 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  86.98 sec
...
main:     load time =   561.10 ms
main:   sample time =    33.84 ms
main:  predict time =   578.32 ms / 9.04 ms per token
main:    total time =  1192.48 ms
...
main:     load time =   530.74 ms
main:   sample time =    34.23 ms
main:  predict time =   616.08 ms / 8.80 ms per token
main:    total time =  1184.69 ms
...
main:     load time =   572.70 ms
main:   sample time =    29.45 ms
main:  predict time =    22.07 ms / 0.32 ms per token
main:    total time =   627.56 ms
...
main:     n_decoded =      504
main:     load time =   529.34 ms
main:   sample time =   238.96 ms
main:  predict time =  2341.41 ms
main:    total time =  3154.70 ms
...
main: loaded model in   398.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbab1fb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbab1e371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562ffbba6730                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbab1fb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbab1fbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562ffbba7500                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbab1e371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562ffbba6730                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562ffbba7e60                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562ffbba7500                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbab1fb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562ffbba87c0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562ffbba7e60                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562ffbba9120                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbab1fb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562ffbba87c0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562ffbba92e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562ffbba9120                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbab1fbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562ffbba94a0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562ffbba92e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   500.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.33 ms
whisper_print_timings:   sample time =    65.98 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    29.28 ms /     1 runs (   29.28 ms per run)
whisper_print_timings:   decode time =    19.93 ms /     2 runs (    9.97 ms per run)
whisper_print_timings:   batchd time =    80.74 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   724.40 ms
...
main:     load time =   507.86 ms
main:    total time =  7852.73 ms
embd_img
