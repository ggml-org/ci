...
- status:  SUCCESS ✅
- runtime: 383.46
- date:    Sun Feb 11 14:20:53 EET 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/39d42e4ed0e90f23936b0dc44503657a03259342
- author:  slaren
```
style fixes
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    1.13 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed    0.42 sec
...
21/21 Test #21: test-backend-ops .................   Passed  153.41 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 168.11 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.12 sec
      Start  2: test-opt
 2/22 Test  #2: test-opt .........................   Passed    0.87 sec
      Start  3: test-quantize-fns
 3/22 Test  #3: test-quantize-fns ................   Passed    0.30 sec
      Start  4: test-quantize-perf
 4/22 Test  #4: test-quantize-perf ...............   Passed    0.35 sec
      Start  5: test-mul-mat0
 5/22 Test  #5: test-mul-mat0 ....................   Passed    0.34 sec
      Start  6: test-blas0
...
20/22 Test #20: test-mul-mat .....................   Passed    0.27 sec
      Start 21: test-backend-buffer
21/22 Test #21: test-backend-buffer ..............   Passed    0.25 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   29.04 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) =  37.53 sec
...
main:     load time =   145.26 ms
main:   sample time =     8.85 ms
main:  predict time =   325.75 ms / 5.09 ms per token
main:    total time =   482.88 ms
...
main:     load time =    89.07 ms
main:   sample time =     8.55 ms
main:  predict time =   337.23 ms / 4.82 ms per token
main:    total time =   435.61 ms
...
I believe the meaning of life is7)'1E4&)4D87BC<,58>:AG"D*+9C+5-!H9+FB)=H"/%%"*.51;,?4HB7,FDG1F8G

main:     load time =   122.70 ms
main:   sample time =     7.63 ms
main:  predict time =     6.06 ms / 0.09 ms per token
main:    total time =   137.18 ms
...
main:   sample time =    65.76 ms
main:  predict time =   900.23 ms
main:    total time =  1092.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x118187980                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x118008190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1182a8220                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x118187020                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x11818c930                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x1182a8ff0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x118008190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1182a8220                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x1182a9950                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x1182a8ff0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x118187020                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x1182aa2b0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x1182a9950                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x1182aac10                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x118187980                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x1182aa2b0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40      0x1182aadd0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x1182aac10                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x11818c930                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40      0x1182aaf90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40      0x1182aadd0                           node_4
...
whisper_print_timings:     load time =   150.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.31 ms
whisper_print_timings:   sample time =   140.09 ms /   131 runs (    1.07 ms per run)
whisper_print_timings:   encode time =   179.93 ms /     1 runs (  179.93 ms per run)
whisper_print_timings:   decode time =    18.25 ms /     2 runs (    9.13 ms per run)
whisper_print_timings:   batchd time =   197.05 ms /   125 runs (    1.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   699.53 ms
...
main:     load time =    69.11 ms
main:    total time =  4797.38 ms
embd_img
