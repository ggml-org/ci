...
- status:  SUCCESS ✅
- runtime: 2:29.39
- date:    Tue Dec  5 12:58:45 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   20.45 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    3.18 sec
...
main:  predict time =   595.83 ms / 9.31 ms per token
main:    total time =   756.35 ms
...
main:     load time =   125.32 ms
main:   sample time =    23.41 ms
main:  predict time =   626.01 ms / 8.94 ms per token
...
main:  predict time =  2372.88 ms
main:    total time =  2699.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa72e6a8960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa72e529190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5628a3d24b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa72e6a8010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa72e6ad900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5628a3d25940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa72e529190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5628a3d24b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5628a3d26290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5628a3d25940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa72e6a8010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5628a3d26be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5628a3d26290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5628a3d27530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa72e6a8960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5628a3d26be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5628a3d276e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5628a3d27530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa72e6ad900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5628a3d27890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5628a3d276e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.98 ms
whisper_print_timings:   sample time =    71.80 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1982.65 ms /     1 runs ( 1982.65 ms per run)
whisper_print_timings:   decode time =    12.46 ms /     2 runs (    6.23 ms per run)
whisper_print_timings:   batchd time =   318.48 ms /   125 runs (    2.55 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2484.29 ms
