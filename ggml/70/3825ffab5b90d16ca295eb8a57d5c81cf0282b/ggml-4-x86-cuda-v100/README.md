...
- status:  SUCCESS ✅
- runtime: 8:04.37
- date:    Tue Dec  5 13:04:29 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   49.93 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.97 sec
...
main:     load time =   466.89 ms
main:   sample time =    37.72 ms
main:  predict time =   604.70 ms / 9.45 ms per token
main:    total time =  1132.45 ms
...
main:     load time =   459.75 ms
main:   sample time =    34.81 ms
main:  predict time =   565.44 ms / 8.08 ms per token
main:    total time =  1064.05 ms
...
main:     n_decoded =      504
main:     load time =   433.48 ms
main:   sample time =   233.74 ms
main:  predict time =  2245.09 ms
main:    total time =  2957.02 ms
...
main: loaded model in   292.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f906d9b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f906d837190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558136bf3390                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f906d9b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f906d9bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558136bf4150                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f906d837190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558136bf3390                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558136bf4aa0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558136bf4150                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f906d9b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558136bf53f0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558136bf4aa0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558136bf5d40                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f906d9b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558136bf53f0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558136bf5ef0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558136bf5d40                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f906d9bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558136bf60a0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558136bf5ef0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   997.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.41 ms
whisper_print_timings:   sample time =    70.40 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =    33.44 ms /     1 runs (   33.44 ms per run)
whisper_print_timings:   decode time =    13.25 ms /     2 runs (    6.63 ms per run)
whisper_print_timings:   batchd time =    97.47 ms /   125 runs (    0.78 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1239.85 ms
...
main:     load time =   408.46 ms
main:    total time =  7839.99 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.757000 sec.)
...
main:      load time = 14537.71 ms
main:    sample time =   517.30 ms / 8.08 ms per token
main:      eval time = 25947.15 ms / 370.67 ms per token
main:     total time = 41883.74 ms
...
main:      load time =  1932.71 ms
main:    sample time =   518.36 ms / 8.10 ms per token
main:      eval time = 12406.08 ms / 177.23 ms per token
main:     total time = 15527.78 ms
