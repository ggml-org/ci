...
- status:  SUCCESS ✅
- runtime: 5:03.09
- date:    Tue Dec  5 01:01:20 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    0.15 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   30.81 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.19 sec
      Start  2: test-opt
...
main:     load time =   182.94 ms
main:   sample time =    17.15 ms
main:  predict time =   820.97 ms / 12.83 ms per token
main:    total time =  1042.78 ms
...
main:  predict time =   877.22 ms / 12.53 ms per token
...
main:     n_decoded =      504
main:     load time =   154.94 ms
main:   sample time =   127.07 ms
main:  predict time =  5853.11 ms
main:    total time =  6216.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb515a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb4fdb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaceeb7b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb515a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb515f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaceeb8940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb4fdb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaceeb7b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaceeb9290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaceeb8940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb515a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaceeb9be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaceeb9290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaceeba530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb515a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaceeb9be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaceeba6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaceeba530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb515f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaceeba890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaceeba6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.88 ms
whisper_print_timings:   sample time =    66.02 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4644.10 ms /     1 runs ( 4644.10 ms per run)
whisper_print_timings:   decode time =    16.05 ms /     2 runs (    8.02 ms per run)
whisper_print_timings:   batchd time =   712.89 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5568.30 ms
...
main:     load time =    98.65 ms
main:    total time = 39362.41 ms
embd_img
...
main:      load time =  5631.55 ms
main:    sample time =   532.81 ms / 8.33 ms per token
main:      eval time = 43795.74 ms / 625.65 ms per token
main:     total time = 52334.59 ms
...
main:      load time =  1602.55 ms
main:    sample time =   530.33 ms / 8.29 ms per token
main:      eval time = 17506.13 ms / 250.09 ms per token
main:     total time = 20609.60 ms
