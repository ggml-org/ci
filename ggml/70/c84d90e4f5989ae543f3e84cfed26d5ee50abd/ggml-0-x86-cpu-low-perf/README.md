...
- status:  FAILURE ❌ (1)
- runtime: 1:37.80
- date:    Sun Jul 23 14:21:08 UTC 2023
...
main:     load time =   128.91 ms
main:   sample time =    23.93 ms
main:  predict time =   591.89 ms / 9.25 ms per token
main:    total time =   799.50 ms
...
main:  predict time =   635.09 ms / 9.07 ms per token
