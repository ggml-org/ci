...
- status:  SUCCESS ✅
- runtime: 7:14.42
- date:    Sun Jan 28 06:35:19 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.34 sec
...
20/20 Test #20: test-backend-ops .................   Passed  127.33 sec
...
21/21 Test #21: test-backend-ops .................   Passed   25.03 sec
...
main:     load time =   233.94 ms
main:   sample time =    16.92 ms
main:  predict time =   859.82 ms / 13.43 ms per token
main:    total time =  1132.81 ms
...
main:  predict time =   933.38 ms / 13.33 ms per token
main:    total time =  1142.96 ms
...
main:  predict time =  6051.97 ms
main:    total time =  6421.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff985ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9844b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2801b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff985ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff985cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2802960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9844b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2801b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad28032c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2802960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff985ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2803c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad28032c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2804580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff985ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2803c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2804740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2804580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff985cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad2804900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2804740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   197.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.94 ms
whisper_print_timings:   sample time =    65.50 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4627.61 ms /     1 runs ( 4627.61 ms per run)
whisper_print_timings:   decode time =    15.68 ms /     2 runs (    7.84 ms per run)
whisper_print_timings:   batchd time =   711.85 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5637.15 ms
...
main:     load time =    91.92 ms
main:    total time = 39856.88 ms
embd_img
...
main:      load time =  5731.49 ms
main:    sample time =   517.41 ms / 8.08 ms per token
main:      eval time = 43789.62 ms / 625.57 ms per token
main:     total time = 52413.28 ms
...
main:      load time =  1585.17 ms
main:    sample time =   516.83 ms / 8.08 ms per token
main:      eval time = 17317.64 ms / 247.39 ms per token
main:     total time = 20377.14 ms
