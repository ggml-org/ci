...
- status:  SUCCESS ✅
- runtime: 4:51.73
- date:    Sun Jan 28 18:06:22 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.54 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.57 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  114.79 sec
...
main:  predict time =   638.00 ms / 9.97 ms per token
...
main:  predict time =   687.23 ms / 9.82 ms per token
main:    total time =   840.29 ms
...
main:     n_decoded =      504
main:     load time =   107.03 ms
main:   sample time =   178.21 ms
main:  predict time =  2519.47 ms
main:    total time =  2849.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f63fee29990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f63fecaa1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e71a193b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f63fee29030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f63fee2e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e71a194960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f63fecaa1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e71a193b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e71a1952c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e71a194960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f63fee29030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e71a195c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e71a1952c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e71a196580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f63fee29990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e71a195c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e71a196740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e71a196580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f63fee2e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e71a196900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e71a196740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.19 ms
whisper_print_timings:   sample time =    72.62 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2016.40 ms /     1 runs ( 2016.40 ms per run)
whisper_print_timings:   decode time =    13.47 ms /     2 runs (    6.73 ms per run)
whisper_print_timings:   batchd time =   327.46 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2532.10 ms
...
main:     load time =    69.58 ms
main:    total time = 19033.88 ms
embd_img
