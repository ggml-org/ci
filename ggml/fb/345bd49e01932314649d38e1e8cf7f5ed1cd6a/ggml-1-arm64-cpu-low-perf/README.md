...
- status:  SUCCESS ✅
- runtime: 6:07.91
- date:    Sun Jan 28 06:11:27 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  153.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.37 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.56 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.01 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.80 sec
...
main:  predict time =   907.31 ms / 14.18 ms per token
main:    total time =  1141.93 ms
...
main:     load time =   194.30 ms
main:   sample time =    17.98 ms
main:  predict time =  1007.89 ms / 14.40 ms per token
main:    total time =  1223.61 ms
...
main:     n_decoded =      504
main:     load time =   166.02 ms
main:   sample time =   129.79 ms
main:  predict time =  6236.88 ms
main:    total time =  6615.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8297a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff827fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab27175b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8297a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8297f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab27176960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff827fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab27175b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab271772c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab27176960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8297a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab27177c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab271772c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab27178580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8297a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab27177c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab27178740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab27178580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8297f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab27178900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab27178740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    67.46 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4658.68 ms /     1 runs ( 4658.68 ms per run)
whisper_print_timings:   decode time =    16.01 ms /     2 runs (    8.00 ms per run)
whisper_print_timings:   batchd time =   873.64 ms /   125 runs (    6.99 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5749.76 ms
...
main:     load time =    92.99 ms
main:    total time = 40750.31 ms
embd_img
