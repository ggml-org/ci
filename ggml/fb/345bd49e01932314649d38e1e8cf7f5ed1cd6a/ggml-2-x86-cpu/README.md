...
- status:  SUCCESS ✅
- runtime: 5:15.23
- date:    Sun Jan 28 18:18:27 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  112.76 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 123.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.28 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   18.47 sec
...
main:     load time =   175.52 ms
main:   sample time =    23.98 ms
main:  predict time =   483.68 ms / 7.56 ms per token
main:    total time =   696.49 ms
...
main:     load time =   129.62 ms
main:   sample time =    23.85 ms
main:  predict time =   497.65 ms / 7.11 ms per token
main:    total time =   653.49 ms
...
main:     n_decoded =      504
main:     load time =   109.95 ms
main:   sample time =   178.08 ms
main:  predict time =  1541.36 ms
main:    total time =  1862.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa6aeb4e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa6ae9cf1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b8b9d88b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa6aeb4e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa6aeb53940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b8b9d89960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa6ae9cf1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b8b9d88b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b8b9d8a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b8b9d89960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa6aeb4e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b8b9d8ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b8b9d8a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b8b9d8b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa6aeb4e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b8b9d8ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b8b9d8b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b8b9d8b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa6aeb53940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b8b9d8b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b8b9d8b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   130.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.11 ms
...
whisper_print_timings:   decode time =    10.41 ms /     2 runs (    5.21 ms per run)
whisper_print_timings:   batchd time =   214.45 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1591.05 ms
...
main:     load time =    67.17 ms
main:    total time = 10668.92 ms
embd_img
...
main:      load time =  5693.53 ms
main:    sample time =   469.58 ms / 7.34 ms per token
main:      eval time = 20949.20 ms / 299.27 ms per token
main:     total time = 27801.18 ms
...
main:      load time =  1171.85 ms
main:    sample time =   467.50 ms / 7.30 ms per token
main:      eval time =  8301.15 ms / 118.59 ms per token
main:     total time = 10293.87 ms
