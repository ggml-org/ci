...
- status:  SUCCESS ✅
- runtime: 11:32.22
- date:    Sun Jan 28 18:30:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.55 sec
...
20/20 Test #20: test-backend-ops .................   Passed  242.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.53 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.64 sec
 ...
 7/21 Test  #7: test0 ............................   Passed    0.55 sec
      Start  8: test1
 8/21 Test  #8: test1 ............................   Passed    0.57 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.81 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   43.12 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  88.35 sec
...
main:     load time =   593.44 ms
main:   sample time =    41.79 ms
main:  predict time =   682.14 ms / 10.66 ms per token
main:    total time =  1337.47 ms
...
main:     load time =   627.78 ms
main:   sample time =    37.75 ms
main:  predict time =   750.30 ms / 10.72 ms per token
main:    total time =  1420.97 ms
...
main:     n_decoded =      504
main:     load time =   557.53 ms
main:   sample time =   233.23 ms
main:  predict time =  2294.81 ms
main:    total time =  3129.85 ms
...
main: loaded model in   397.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4b359b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4b358371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b895c499a0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4b359b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4b359bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b895c4a770                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4b358371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b895c499a0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b895c4b0d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b895c4a770                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4b359b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b895c4ba30                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b895c4b0d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b895c4c390                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4b359b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b895c4ba30                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b895c4c550                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b895c4c390                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4b359bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b895c4c710                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b895c4c550       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   509.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.60 ms
whisper_print_timings:   sample time =    74.04 ms /   131 runs (    0.57 ms per run)
whisper_print_timings:   encode time =    22.13 ms /     1 runs (   22.13 ms per run)
whisper_print_timings:   decode time =    20.83 ms /     2 runs (   10.42 ms per run)
whisper_print_timings:   batchd time =    87.74 ms /   125 runs (    0.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   740.88 ms
...
main:     load time =   515.11 ms
main:    total time =  7981.02 ms
embd_img
...
main:      load time =  7103.28 ms
main:    sample time =   520.80 ms / 8.14 ms per token
main:      eval time = 24440.32 ms / 349.15 ms per token
main:     total time = 32982.45 ms
...
main:      load time =  2168.73 ms
main:    sample time =   522.94 ms / 8.17 ms per token
main:      eval time = 12463.82 ms / 178.05 ms per token
main:     total time = 15800.22 ms
