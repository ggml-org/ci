...
- status:  SUCCESS ✅
- runtime: 2:21.06
- date:    Wed Dec  6 20:08:38 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   13.28 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.84 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    2.17 sec
...
main:     load time =   128.77 ms
main:   sample time =    23.54 ms
main:  predict time =   623.26 ms / 9.74 ms per token
main:    total time =   788.19 ms
...
main:     load time =   129.46 ms
main:   sample time =    23.48 ms
main:  predict time =   651.66 ms / 9.31 ms per token
main:    total time =   806.83 ms
...
main:  predict time =  2382.21 ms
main:    total time =  2712.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f804d4b8960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f804d339190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563419be9b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f804d4b8010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f804d4bd900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563419bea940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f804d339190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563419be9b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563419beb290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563419bea940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f804d4b8010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563419bebbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563419beb290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563419bec530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f804d4b8960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563419bebbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563419bec6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563419bec530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f804d4bd900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563419bec890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563419bec6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.04 ms
whisper_print_timings:   sample time =    71.77 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1978.40 ms /     1 runs ( 1978.40 ms per run)
whisper_print_timings:   decode time =    12.66 ms /     2 runs (    6.33 ms per run)
whisper_print_timings:   batchd time =   321.42 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2485.93 ms
...
main:     load time =    66.96 ms
main:    total time = 18698.61 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.481000 sec.)
