...
- status:  SUCCESS ✅
- runtime: 2:59.95
- date:    Wed Dec  6 08:09:15 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.69 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.60 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.42 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    2.49 sec
...
main:     load time =   189.86 ms
main:   sample time =    18.04 ms
main:  predict time =   840.76 ms / 13.14 ms per token
main:    total time =  1070.44 ms
...
main:     load time =   193.07 ms
main:   sample time =    18.12 ms
main:  predict time =   927.62 ms / 13.25 ms per token
main:    total time =  1141.82 ms
...
main:     n_decoded =      504
main:     load time =   162.85 ms
main:   sample time =   131.54 ms
main:  predict time =  6088.36 ms
main:    total time =  6464.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fb4a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f9cb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1426bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fb4a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fb4f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1426c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f9cb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1426bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1426d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1426c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fb4a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1426dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1426d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1426e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fb4a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1426dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1426e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1426e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fb4f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab1426e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1426e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.48 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.12 ms
whisper_print_timings:   sample time =    67.21 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4746.11 ms /     1 runs ( 4746.11 ms per run)
whisper_print_timings:   decode time =    16.35 ms /     2 runs (    8.18 ms per run)
whisper_print_timings:   batchd time =   720.73 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5677.03 ms
