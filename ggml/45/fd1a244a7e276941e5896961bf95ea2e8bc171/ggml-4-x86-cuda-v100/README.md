...
- status:  SUCCESS ✅
- runtime: 7:07.22
- date:    Wed Dec  6 20:13:38 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.63 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    7.92 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   22.20 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.73 sec
      Start  2: test-opt
 ...
 5/20 Test  #5: test-mul-mat0 ....................   Passed    1.05 sec
...
20/20 Test #20: test-backend-ops .................   Passed    5.73 sec
...
main:     load time =   458.64 ms
main:   sample time =    38.72 ms
main:  predict time =   549.18 ms / 8.58 ms per token
main:    total time =  1066.55 ms
...
main:     load time =   462.31 ms
main:   sample time =    34.05 ms
main:  predict time =   573.89 ms / 8.20 ms per token
main:    total time =  1074.24 ms
...
main:     n_decoded =      504
main:     load time =   434.37 ms
main:   sample time =   232.78 ms
main:  predict time =  2212.83 ms
main:    total time =  2924.69 ms
...
main: loaded model in   292.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9fac1b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9fac037190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c65100e8c0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9fac1b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9fac1bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c65100f680                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9fac037190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c65100e8c0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c65100ffd0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c65100f680                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9fac1b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c651010920                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c65100ffd0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c651011270                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9fac1b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c651010920                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c651011420                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c651011270                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9fac1bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c6510115d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c651011420       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   397.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.08 ms
whisper_print_timings:   sample time =    66.80 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    33.04 ms /     1 runs (   33.04 ms per run)
whisper_print_timings:   decode time =    14.07 ms /     2 runs (    7.04 ms per run)
whisper_print_timings:   batchd time =    84.18 ms /   125 runs (    0.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   621.38 ms
...
main:     load time =   411.07 ms
main:    total time =  7570.28 ms
embd_img
...
main:      load time = 25403.39 ms
main:    sample time =   513.47 ms / 8.02 ms per token
main:      eval time = 24145.06 ms / 344.93 ms per token
main:     total time = 50935.37 ms
...
main:      load time = 11150.58 ms
main:    sample time =   513.14 ms / 8.02 ms per token
main:      eval time = 12103.50 ms / 172.91 ms per token
main:     total time = 24406.80 ms
