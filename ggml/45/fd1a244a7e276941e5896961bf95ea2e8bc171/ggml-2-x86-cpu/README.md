...
- status:  SUCCESS ✅
- runtime: 3:13.88
- date:    Wed Dec  6 20:09:32 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   11.27 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.26 sec
      Start  2: test-opt
 ...
 5/20 Test  #5: test-mul-mat0 ....................   Passed    0.51 sec
...
20/20 Test #20: test-backend-ops .................   Passed    2.38 sec
...
main:     load time =   173.45 ms
main:   sample time =    23.44 ms
main:  predict time =   441.29 ms / 6.90 ms per token
main:    total time =   651.01 ms
...
main:     load time =   122.65 ms
main:   sample time =    23.40 ms
main:  predict time =   454.71 ms / 6.50 ms per token
main:    total time =   602.84 ms
...
main:     n_decoded =      504
main:     load time =   102.00 ms
main:   sample time =   177.44 ms
main:  predict time =  1459.76 ms
main:    total time =  1768.43 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f954161b960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f954149c190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e26b9aeb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f954161b010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9541620900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e26b9af940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f954149c190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e26b9aeb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e26b9b0290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e26b9af940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f954161b010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e26b9b0be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e26b9b0290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e26b9b1530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f954161b960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e26b9b0be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e26b9b16e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e26b9b1530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9541620900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e26b9b1890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e26b9b16e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   121.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.14 ms
whisper_print_timings:   sample time =    54.41 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1168.27 ms /     1 runs ( 1168.27 ms per run)
whisper_print_timings:   decode time =     9.46 ms /     2 runs (    4.73 ms per run)
whisper_print_timings:   batchd time =   208.07 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1580.34 ms
...
main:     load time =    64.51 ms
main:    total time = 10419.74 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.477000 sec.)
...
main:      load time =  5440.12 ms
main:    sample time =   470.10 ms / 7.35 ms per token
main:      eval time = 20283.04 ms / 289.76 ms per token
main:     total time = 26879.08 ms
...
main:      load time =  1194.04 ms
main:    sample time =   467.67 ms / 7.31 ms per token
main:      eval time =  7980.68 ms / 114.01 ms per token
main:     total time = 10017.98 ms
