...
- status:  SUCCESS ✅
- runtime: 4:53.02
- date:    Wed Dec  6 08:11:12 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.64 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   14.24 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.18 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    2.57 sec
...
main:     load time =   178.76 ms
main:   sample time =    16.95 ms
main:  predict time =   811.36 ms / 12.68 ms per token
main:    total time =  1029.46 ms
...
main:   sample time =    16.82 ms
main:  predict time =   877.82 ms / 12.54 ms per token
main:    total time =  1076.16 ms
...
main:     n_decoded =      504
main:     load time =   149.88 ms
main:   sample time =   127.03 ms
main:  predict time =  5844.27 ms
main:    total time =  6202.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80f0a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80d8b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1574b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80f0a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80f0f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae1575940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80d8b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1574b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae1576290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae1575940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80f0a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae1576be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae1576290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae1577530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80f0a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae1576be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae15776e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae1577530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80f0f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae1577890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae15776e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    65.97 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4648.33 ms /     1 runs ( 4648.33 ms per run)
whisper_print_timings:   decode time =    15.86 ms /     2 runs (    7.93 ms per run)
whisper_print_timings:   batchd time =   712.37 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5650.38 ms
...
main:     load time =    85.05 ms
main:    total time = 39297.21 ms
embd_img
...
main:      load time =  5818.77 ms
main:    sample time =   534.22 ms / 8.35 ms per token
main:      eval time = 43444.49 ms / 620.64 ms per token
main:     total time = 52170.77 ms
...
main:      load time =  1506.78 ms
main:    sample time =   526.57 ms / 8.23 ms per token
main:      eval time = 17495.60 ms / 249.94 ms per token
main:     total time = 20500.31 ms
