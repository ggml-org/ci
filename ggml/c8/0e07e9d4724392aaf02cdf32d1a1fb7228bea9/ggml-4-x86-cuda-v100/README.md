...
- status:  SUCCESS ✅
- runtime: 9:07.24
- date:    Mon Dec 18 17:15:00 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   59.21 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  91.34 sec
...
20/20 Test #20: test-backend-ops .................   Passed   22.34 sec
...
main:     load time =   568.07 ms
main:   sample time =    34.09 ms
main:  predict time =   557.66 ms / 8.71 ms per token
main:    total time =  1183.75 ms
...
main:     load time =   561.59 ms
main:   sample time =    34.96 ms
main:  predict time =   578.71 ms / 8.27 ms per token
main:    total time =  1179.55 ms
...
main:     n_decoded =      504
main:     load time =   531.00 ms
main:   sample time =   235.80 ms
main:  predict time =  2213.39 ms
main:    total time =  3032.58 ms
...
main: loaded model in   407.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efd1cfb69c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efd1ce371b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55709e83c4c0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efd1cfb6050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efd1cfbb980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55709e83d2a0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efd1ce371b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55709e83c4c0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55709e83dc10                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55709e83d2a0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efd1cfb6050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55709e83e580                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55709e83dc10                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55709e83eef0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efd1cfb69c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55709e83e580                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55709e83f0c0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55709e83eef0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efd1cfbb980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55709e83f290                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55709e83f0c0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1078.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.69 ms
whisper_print_timings:   sample time =    67.41 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.90 ms /     1 runs (   34.90 ms per run)
whisper_print_timings:   decode time =    13.81 ms /     2 runs (    6.90 ms per run)
whisper_print_timings:   batchd time =    83.32 ms /   125 runs (    0.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1304.36 ms
...
main:     load time =   506.12 ms
main:    total time =  8002.91 ms
embd_img
...
main:      load time = 44843.68 ms
main:    sample time =   517.27 ms / 8.08 ms per token
main:      eval time = 25281.72 ms / 361.17 ms per token
main:     total time = 71487.35 ms
...
main:      load time = 17869.60 ms
main:    sample time =   516.43 ms / 8.07 ms per token
main:      eval time = 12048.92 ms / 172.13 ms per token
main:     total time = 31091.62 ms
