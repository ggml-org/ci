...
- status:  SUCCESS ✅
- runtime: 3:41.81
- date:    Mon Dec 18 17:09:34 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.29 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.52 sec
...
main:  predict time =   447.58 ms / 6.99 ms per token
main:    total time =   654.97 ms
...
main:     load time =   124.50 ms
main:   sample time =    23.43 ms
main:  predict time =   462.88 ms / 6.61 ms per token
...
main:  predict time =  1473.32 ms
main:    total time =  1784.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2fdcc229c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2fdcaa31b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556636242ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2fdcc22050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2fdcc27980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556636243980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2fdcaa31b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556636242ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5566362442f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556636243980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2fdcc22050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556636244c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5566362442f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5566362455d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2fdcc229c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556636244c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5566362457a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5566362455d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2fdcc27980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556636245970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5566362457a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    56.14 ms /   131 runs (    0.43 ms per run)
...
whisper_print_timings:   batchd time =   211.11 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1581.40 ms
...
main:      load time =  5718.92 ms
main:    sample time =   469.98 ms / 7.34 ms per token
main:      eval time = 20871.51 ms / 298.16 ms per token
main:     total time = 27738.17 ms
...
main:      load time =  1228.09 ms
main:    sample time =   467.13 ms / 7.30 ms per token
main:      eval time =  8158.08 ms / 116.54 ms per token
main:     total time = 10208.60 ms
