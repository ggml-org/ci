...
- status:  SUCCESS ✅
- runtime: 256.75
- date:    Mon Dec 18 19:08:07 EET 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/c80e07e9d4724392aaf02cdf32d1a1fb7228bea9
- author:  slaren
```
...
20/20 Test #20: test-backend-ops .................   Passed   65.26 sec
...
13/21 Test #13: test-conv-transpose ..............   Passed    0.21 sec
...
21/21 Test #21: test-backend-ops .................   Passed   13.65 sec
...
main:  predict time =   306.02 ms / 4.78 ms per token
main:    total time =   466.77 ms
...
main:     load time =    94.41 ms
main:   sample time =     8.73 ms
main:  predict time =   307.21 ms / 4.39 ms per token
main:    total time =   411.18 ms
...
main:     n_decoded =      504
main:     load time =   118.32 ms
main:   sample time =    65.58 ms
main:  predict time =   764.33 ms
main:    total time =   959.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1201879b0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x1200081a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x110018230                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x120187040                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x12018c970                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x110019010                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x1200081a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x110018230                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x110019980                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x110019010                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x120187040                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x11001a2f0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x110019980                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x11001ac60                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1201879b0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x11001a2f0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x11001ae30                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x11001ac60                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x12018c970                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x11001b000                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x11001ae30                           node_4
...
whisper_print_timings:     load time =   143.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.34 ms
whisper_print_timings:   sample time =   134.92 ms /   131 runs (    1.03 ms per run)
whisper_print_timings:   encode time =   183.74 ms /     1 runs (  183.74 ms per run)
whisper_print_timings:   decode time =    20.51 ms /     2 runs (   10.26 ms per run)
whisper_print_timings:   batchd time =   207.25 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   699.28 ms
