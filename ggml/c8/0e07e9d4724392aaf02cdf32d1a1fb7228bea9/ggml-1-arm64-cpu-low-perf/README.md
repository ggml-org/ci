...
- status:  SUCCESS ✅
- runtime: 3:34.87
- date:    Mon Dec 18 05:09:32 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.68 sec
...
19/19 Test #19: test-backend-ops .................   Passed   42.61 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.94 sec
...
main:  predict time =   861.06 ms / 13.45 ms per token
main:    total time =  1093.58 ms
...
main:     load time =   194.05 ms
main:   sample time =    17.91 ms
main:  predict time =   979.51 ms / 13.99 ms per token
main:    total time =  1194.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb247a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb22fb1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb71eba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb247a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb247f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadb71f980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb22fb1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadb71eba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadb7202f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadb71f980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb247a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadb720c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadb7202f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadb7215d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb247a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadb720c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadb7217a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadb7215d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb247f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadb721970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadb7217a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.83 ms
whisper_print_timings:   sample time =    67.01 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4770.77 ms /     1 runs ( 4770.77 ms per run)
whisper_print_timings:   decode time =    20.73 ms /     2 runs (   10.37 ms per run)
whisper_print_timings:   batchd time =   714.43 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5706.31 ms
