...
- status:  SUCCESS ✅
- runtime: 5:27.28
- date:    Mon Dec 18 05:11:23 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.30 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.36 sec
...
20/20 Test #20: test-backend-ops .................   Passed    9.99 sec
...
main:     load time =   211.60 ms
main:   sample time =    16.89 ms
main:  predict time =   807.29 ms / 12.61 ms per token
main:    total time =  1057.75 ms
...
main:     load time =   183.77 ms
main:   sample time =    16.92 ms
main:  predict time =   874.06 ms / 12.49 ms per token
...
main:  predict time =  5884.34 ms
main:    total time =  6244.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab9a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaaa1b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac96e5ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab9a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab9f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac96e6980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaaa1b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac96e5ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac96e72f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac96e6980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab9a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac96e7c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac96e72f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac96e85d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab9a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac96e7c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac96e87a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac96e85d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab9f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac96e8970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac96e87a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   175.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    65.46 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4655.91 ms /     1 runs ( 4655.91 ms per run)
whisper_print_timings:   decode time =    15.05 ms /     2 runs (    7.53 ms per run)
whisper_print_timings:   batchd time =   707.80 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5638.12 ms
...
main:     load time =    84.53 ms
main:    total time = 39475.07 ms
embd_img
...
main:      load time =  5831.76 ms
main:    sample time =   530.16 ms / 8.28 ms per token
main:      eval time = 43524.42 ms / 621.78 ms per token
main:     total time = 52262.09 ms
...
main:      load time =  1493.95 ms
main:    sample time =   528.44 ms / 8.26 ms per token
main:      eval time = 17604.80 ms / 251.50 ms per token
main:     total time = 20613.02 ms
