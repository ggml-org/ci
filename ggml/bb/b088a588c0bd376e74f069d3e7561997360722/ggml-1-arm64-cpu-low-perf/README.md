...
- status:  SUCCESS ✅
- runtime: 2:19.62
- date:    Sun Aug  4 08:59:22 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/bbb088a588c0bd376e74f069d3e7561997360722
- author:  Georgi Gerganov
```
metal : fix struct name
...
Total Test time (real) =  52.05 sec
...
main:  predict time =   850.70 ms / 13.29 ms per token
main:    total time =  1037.06 ms
...
main:  predict time =   922.13 ms / 13.17 ms per token
main:    total time =  1085.03 ms
...
main:     load time =   175.80 ms
main:   sample time =    17.34 ms
main:  predict time =   929.87 ms / 13.28 ms per token
...
main:     n_decoded =      504
main:     load time =   147.05 ms
main:   sample time =   128.48 ms
main:  predict time =  6224.97 ms
main:    total time =  6584.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf9c0f03da930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf9c0f025b180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8e5ff023ee0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf9c0f03d9ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf9c0f03df8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8e5ff024c90                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf9c0f025b180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8e5ff023ee0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8e5ff0255d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8e5ff024c90                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf9c0f03d9ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8e5ff025f10                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8e5ff0255d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8e5ff026850                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf9c0f03da930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8e5ff025f10                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8e5ff0269f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8e5ff026850                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf9c0f03df8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb8e5ff026b90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8e5ff0269f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    94.46 ms
main:    total time = 40252.19 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.285000 sec.)
