...
- status:  SUCCESS ✅
- runtime: 2:48.50
- date:    Tue Dec  5 11:39:51 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.35 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    1.60 sec
...
20/20 Test #20: test-backend-ops .................   Passed    0.18 sec
...
main:     load time =   125.02 ms
main:   sample time =    23.36 ms
main:  predict time =   432.11 ms / 6.75 ms per token
main:    total time =   592.90 ms
...
main:     load time =   126.29 ms
main:   sample time =    23.35 ms
main:  predict time =   445.07 ms / 6.36 ms per token
...
main:  predict time =  1480.46 ms
main:    total time =  1794.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbb4c1d8960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbb4c059190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5635fcd37b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbb4c1d8010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbb4c1dd900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5635fcd38940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbb4c059190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5635fcd37b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5635fcd39290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5635fcd38940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbb4c1d8010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5635fcd39be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5635fcd39290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5635fcd3a530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbb4c1d8960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5635fcd39be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5635fcd3a6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5635fcd3a530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbb4c1dd900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5635fcd3a890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5635fcd3a6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    85.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.27 ms
whisper_print_timings:   sample time =    54.27 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1147.39 ms /     1 runs ( 1147.39 ms per run)
whisper_print_timings:   decode time =     9.95 ms /     2 runs (    4.97 ms per run)
whisper_print_timings:   batchd time =   206.66 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1521.75 ms
...
main:     load time =    70.22 ms
main:    total time = 10401.71 ms
embd_img
...
main:      load time =  4352.47 ms
main:    sample time =   468.18 ms / 7.32 ms per token
main:      eval time = 19114.17 ms / 273.06 ms per token
main:     total time = 24575.92 ms
...
main:      load time =  1187.87 ms
main:    sample time =   466.72 ms / 7.29 ms per token
main:      eval time =  8010.88 ms / 114.44 ms per token
main:     total time = 10040.66 ms
