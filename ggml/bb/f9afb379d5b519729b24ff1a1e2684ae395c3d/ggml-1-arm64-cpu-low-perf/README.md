...
- status:  SUCCESS ✅
- runtime: 2:38.91
- date:    Tue Dec  5 11:39:42 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/bbf9afb379d5b519729b24ff1a1e2684ae395c3d
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.07 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.10 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.49 sec
      Start 10: test-pool
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.54 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.16 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.55 sec
      Start 10: test-pool
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    0.22 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  16.89 sec
...
main:     load time =   185.32 ms
main:   sample time =    17.03 ms
main:  predict time =   823.76 ms / 12.87 ms per token
main:    total time =  1047.81 ms
...
main:     load time =   184.32 ms
main:   sample time =    17.04 ms
main:  predict time =   904.77 ms / 12.93 ms per token
main:    total time =  1108.91 ms
...
main:     n_decoded =      504
main:     load time =   156.91 ms
main:   sample time =   126.99 ms
main:  predict time =  6007.84 ms
main:    total time =  6373.04 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9c9ea960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c86b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab50f1b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9c9ea010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9c9ef900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaab50f2940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c86b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab50f1b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaab50f3290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaab50f2940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9c9ea010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaab50f3be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaab50f3290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaab50f4530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9c9ea960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaab50f3be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaab50f46e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaab50f4530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9c9ef900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaab50f4890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaab50f46e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.17 ms
whisper_print_timings:   sample time =    65.26 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4662.01 ms /     1 runs ( 4662.01 ms per run)
whisper_print_timings:   decode time =    15.01 ms /     2 runs (    7.51 ms per run)
whisper_print_timings:   batchd time =   713.53 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5583.24 ms
...
main:     load time =    89.06 ms
main:    total time = 40103.70 ms
embd_img
