...
- status:  SUCCESS ✅
- runtime: 4:32.15
- date:    Tue Dec  5 11:41:36 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.56 sec
      Start  6: test0
...
main:  predict time =   810.66 ms / 12.67 ms per token
main:    total time =  1032.55 ms
...
main:  predict time =   892.23 ms / 12.75 ms per token
main:    total time =  1096.05 ms
...
main:  predict time =  5837.83 ms
main:    total time =  6199.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff935ca960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9344b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0bf1ab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff935ca010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff935cf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0bf1b940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9344b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0bf1ab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0bf1c290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0bf1b940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff935ca010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0bf1cbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0bf1c290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0bf1d530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff935ca960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0bf1cbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0bf1d6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0bf1d530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff935cf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0bf1d890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0bf1d6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   121.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.71 ms
whisper_print_timings:   sample time =    65.37 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4633.42 ms /     1 runs ( 4633.42 ms per run)
whisper_print_timings:   decode time =    15.10 ms /     2 runs (    7.55 ms per run)
whisper_print_timings:   batchd time =   711.97 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5565.25 ms
...
main:     load time =    95.74 ms
main:    total time = 39300.30 ms
embd_img
...
main:      load time =  5694.00 ms
main:    sample time =   534.08 ms / 8.34 ms per token
main:      eval time = 43601.50 ms / 622.88 ms per token
main:     total time = 52201.74 ms
...
main:      load time =  1601.16 ms
main:    sample time =   529.11 ms / 8.27 ms per token
main:      eval time = 17553.33 ms / 250.76 ms per token
main:     total time = 20654.22 ms
