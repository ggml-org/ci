...
- status:  SUCCESS ✅
- runtime: 3:12.28
- date:    Sun Apr  7 14:05:54 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/bb8d8cff851b2de6fde4904be492d39458837e1a
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.16 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.61 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.92 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.54 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.55 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.95 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.14 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   20.58 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.93 sec
      Start  5: test-mul-mat0
 5/23 Test  #5: test-mul-mat0 ....................   Passed    0.52 sec
...
Total Test time (real) =  33.03 sec
...
main:     load time =   148.41 ms
main:   sample time =    17.64 ms
main:  predict time =   893.21 ms / 13.96 ms per token
main:    total time =  1081.18 ms
...
main:     load time =   147.52 ms
main:   sample time =    17.38 ms
main:  predict time =   973.43 ms / 13.91 ms per token
main:    total time =  1141.16 ms
...
main:     load time =   178.62 ms
main:   sample time =    17.34 ms
main:  predict time =   995.04 ms / 14.21 ms per token
main:    total time =  1194.34 ms
...
main:   sample time =   127.67 ms
main:  predict time =  6423.78 ms
main:    total time =  6786.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9be2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9bcab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3cd7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9be2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9be2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3cd8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9bcab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3cd7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3cd9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3cd8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9be2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3cd9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3cd9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3cda6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9be2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3cd9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3cda890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3cda6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9be2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae3cdaa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3cda890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    65.42 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4679.41 ms /     1 runs ( 4679.41 ms per run)
whisper_print_timings:   decode time =    14.61 ms /     2 runs (    7.30 ms per run)
whisper_print_timings:   batchd time =   710.36 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5595.77 ms
...
main:     load time =    91.88 ms
main:    total time = 39794.34 ms
embd_img
