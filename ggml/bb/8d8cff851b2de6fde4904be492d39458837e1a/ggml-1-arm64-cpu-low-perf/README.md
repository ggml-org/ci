...
- status:  SUCCESS ✅
- runtime: 4:04.80
- date:    Sun Apr  7 02:06:47 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.52 sec
      Start  9: test3
...
main:     load time =   161.05 ms
main:   sample time =    17.68 ms
main:  predict time =   932.87 ms / 14.58 ms per token
main:    total time =  1134.29 ms
...
main:  predict time =   982.82 ms / 14.04 ms per token
main:    total time =  1163.75 ms
...
main:  predict time =  1022.40 ms / 14.61 ms per token
main:    total time =  1234.91 ms
...
main:     n_decoded =      504
main:     load time =   169.09 ms
main:   sample time =   127.93 ms
main:  predict time =  6450.33 ms
main:    total time =  6833.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9858a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9840b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2173ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9858a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9858f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae2174ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9840b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2173ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae2175410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae2174ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9858a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae2175d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae2175410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae21766d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9858a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae2175d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae2176890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae21766d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9858f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae2176a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae2176890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.16 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =    65.73 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4714.62 ms /     1 runs ( 4714.62 ms per run)
whisper_print_timings:   decode time =    14.63 ms /     2 runs (    7.32 ms per run)
whisper_print_timings:   batchd time =   712.35 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5636.60 ms
...
main:     load time =    99.89 ms
main:    total time = 39926.39 ms
embd_img
