...
- status:  SUCCESS ✅
- runtime: 12:32.29
- date:    Sun Jan 28 17:57:15 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  251.90 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 298.32 sec
...
12/21 Test #12: test-conv-transpose ..............   Passed    0.55 sec
      Start 13: test-dup
...
21/21 Test #21: test-backend-ops .................   Passed   47.30 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  92.41 sec
...
main:     load time =   679.88 ms
main:   sample time =    34.01 ms
main:  predict time =   601.49 ms / 9.40 ms per token
main:    total time =  1335.59 ms
...
main:     load time =   584.23 ms
main:   sample time =    33.86 ms
main:  predict time =   643.33 ms / 9.19 ms per token
main:    total time =  1266.01 ms
...
main:   sample time =   238.28 ms
main:  predict time =  2392.50 ms
main:    total time =  3217.66 ms
...
main: loaded model in   403.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4b31efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4b31d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56486ea86a50                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4b31efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4b31eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56486ea87820                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4b31d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56486ea86a50                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56486ea88180                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56486ea87820                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4b31efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56486ea88ae0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56486ea88180                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56486ea89440                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4b31efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56486ea88ae0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56486ea89600                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56486ea89440                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4b31eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56486ea897c0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56486ea89600       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   817.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.05 ms
whisper_print_timings:   sample time =    70.34 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =    22.02 ms /     1 runs (   22.02 ms per run)
whisper_print_timings:   decode time =    21.64 ms /     2 runs (   10.82 ms per run)
whisper_print_timings:   batchd time =    81.75 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1038.92 ms
...
main:     load time =   503.06 ms
main:    total time =  7922.43 ms
embd_img
...
main:      load time =  8802.54 ms
main:    sample time =   519.97 ms / 8.12 ms per token
main:      eval time = 25920.19 ms / 370.29 ms per token
main:     total time = 36125.34 ms
...
main:      load time =  3110.37 ms
main:    sample time =   534.04 ms / 8.34 ms per token
main:      eval time = 12788.23 ms / 182.69 ms per token
main:     total time = 17077.78 ms
