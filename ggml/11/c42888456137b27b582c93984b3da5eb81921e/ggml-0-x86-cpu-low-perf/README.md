...
- status:  SUCCESS ✅
- runtime: 4:55.07
- date:    Sun Jan 28 17:49:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/20 Test  #8: test2 ............................   Passed   24.35 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.80 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  118.43 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 157.35 sec
...
main:     load time =   127.09 ms
main:   sample time =    23.80 ms
main:  predict time =   639.91 ms / 10.00 ms per token
...
main:  predict time =   674.66 ms / 9.64 ms per token
main:    total time =   828.61 ms
...
main:  predict time =  2542.01 ms
main:    total time =  2875.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff8b2895990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff8b27161a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5575b1ba8b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff8b2895030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff8b289a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5575b1ba9960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff8b27161a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5575b1ba8b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5575b1baa2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5575b1ba9960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff8b2895030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5575b1baac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5575b1baa2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5575b1bab580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff8b2895990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5575b1baac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5575b1bab740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5575b1bab580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff8b289a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5575b1bab900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5575b1bab740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.43 ms
whisper_print_timings:   sample time =    72.30 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1990.73 ms /     1 runs ( 1990.73 ms per run)
whisper_print_timings:   decode time =    12.81 ms /     2 runs (    6.41 ms per run)
whisper_print_timings:   batchd time =   328.53 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2510.67 ms
