...
- status:  SUCCESS ✅
- runtime: 7:25.19
- date:    Sun Jan 28 05:52:01 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/11c42888456137b27b582c93984b3da5eb81921e
...
20/20 Test #20: test-backend-ops .................   Passed  123.66 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 137.71 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/21 Test  #5: test-mul-mat0 ....................   Passed    0.57 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.69 sec
...
main:     load time =   292.27 ms
main:   sample time =    17.17 ms
main:  predict time =   870.45 ms / 13.60 ms per token
...
main:     load time =   178.64 ms
main:   sample time =    16.92 ms
main:  predict time =   948.59 ms / 13.55 ms per token
main:    total time =  1147.15 ms
...
main:     n_decoded =      504
main:     load time =   157.12 ms
main:   sample time =   128.38 ms
main:  predict time =  5992.43 ms
main:    total time =  6360.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdc8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdb0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadec2fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdc8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdc8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadec30960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbdb0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadec2fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadec312c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadec30960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbdc8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadec31c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadec312c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadec32580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbdc8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadec31c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadec32740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadec32580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbdc8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadec32900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadec32740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   188.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =    65.99 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4631.63 ms /     1 runs ( 4631.63 ms per run)
whisper_print_timings:   decode time =    15.70 ms /     2 runs (    7.85 ms per run)
whisper_print_timings:   batchd time =   713.91 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5634.60 ms
...
main:     load time =    90.86 ms
main:    total time = 39868.14 ms
embd_img
...
main:      load time =  6671.30 ms
main:    sample time =   517.04 ms / 8.08 ms per token
main:      eval time = 43914.77 ms / 627.35 ms per token
main:     total time = 53475.63 ms
...
main:      load time =  2415.63 ms
main:    sample time =   515.75 ms / 8.06 ms per token
main:      eval time = 17490.71 ms / 249.87 ms per token
main:     total time = 21379.16 ms
