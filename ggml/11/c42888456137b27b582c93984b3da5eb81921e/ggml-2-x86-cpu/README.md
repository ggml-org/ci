...
- status:  SUCCESS ✅
- runtime: 5:49.81
- date:    Sun Jan 28 17:50:28 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.39 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  116.68 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.43 sec
...
main:     load time =   200.98 ms
main:   sample time =    23.92 ms
main:  predict time =   473.31 ms / 7.40 ms per token
main:    total time =   711.70 ms
...
main:  predict time =   485.37 ms / 6.93 ms per token
main:    total time =   637.03 ms
...
main:  predict time =  1532.94 ms
main:    total time =  1848.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f51a3ca7990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f51a3b281a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x565264d7bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f51a3ca7030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f51a3cac940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x565264d7c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f51a3b281a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x565264d7bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x565264d7d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x565264d7c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f51a3ca7030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x565264d7dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x565264d7d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x565264d7e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f51a3ca7990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x565264d7dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x565264d7e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x565264d7e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f51a3cac940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x565264d7e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x565264d7e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.82 ms
whisper_print_timings:   sample time =    55.18 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1156.72 ms /     1 runs ( 1156.72 ms per run)
whisper_print_timings:   decode time =    10.34 ms /     2 runs (    5.17 ms per run)
whisper_print_timings:   batchd time =   212.97 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1577.26 ms
...
main:     load time =    61.65 ms
main:    total time = 10613.02 ms
embd_img
...
main:      load time = 14017.04 ms
main:    sample time =   472.33 ms / 7.38 ms per token
main:      eval time = 20907.37 ms / 298.68 ms per token
main:     total time = 36156.50 ms
...
main:      load time =  4362.60 ms
main:    sample time =   469.51 ms / 7.34 ms per token
main:      eval time =  8435.22 ms / 120.50 ms per token
main:     total time = 13631.49 ms
