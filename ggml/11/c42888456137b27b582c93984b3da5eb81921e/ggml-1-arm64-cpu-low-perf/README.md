...
- status:  SUCCESS ✅
- runtime: 6:06.92
- date:    Sun Jan 28 05:50:44 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.70 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.78 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  150.94 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 189.35 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.08 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.90 sec
...
main:     load time =   195.44 ms
main:   sample time =    18.22 ms
main:  predict time =   939.30 ms / 14.68 ms per token
main:    total time =  1175.54 ms
...
main:     load time =   197.45 ms
main:   sample time =    18.15 ms
main:  predict time =   982.32 ms / 14.03 ms per token
main:    total time =  1201.19 ms
...
main:     n_decoded =      504
main:     load time =   168.20 ms
main:   sample time =   127.99 ms
main:  predict time =  6252.96 ms
main:    total time =  6632.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff82e8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82d0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec0aab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff82e8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff82e8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec0ab960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82d0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec0aab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec0ac2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec0ab960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff82e8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec0acc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec0ac2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec0ad580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff82e8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec0acc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec0ad740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec0ad580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff82e8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaec0ad900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec0ad740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    66.94 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4782.34 ms /     1 runs ( 4782.34 ms per run)
whisper_print_timings:   decode time =    15.94 ms /     2 runs (    7.97 ms per run)
whisper_print_timings:   batchd time =   742.48 ms /   125 runs (    5.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5741.29 ms
...
main:     load time =    93.99 ms
main:    total time = 40735.44 ms
embd_img
