...
- status:  SUCCESS ✅
- runtime: 3:21.13
- date:    Sun Feb 11 12:41:25 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  114.64 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 125.09 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.30 sec
...
main:  predict time =   461.41 ms / 7.21 ms per token
main:    total time =   601.89 ms
...
main:  predict time =   471.41 ms / 6.73 ms per token
main:    total time =   604.32 ms
...
main:  predict time =    11.61 ms / 0.17 ms per token
main:    total time =   161.86 ms
...
main:     n_decoded =      504
main:     load time =   105.41 ms
main:   sample time =   177.81 ms
main:  predict time =  1514.19 ms
main:    total time =  1828.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1d285be990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1d2843f1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560c388a8b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1d285be030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1d285c3940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560c388a9960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1d2843f1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560c388a8b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560c388aa2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560c388a9960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1d285be030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560c388aac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560c388aa2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560c388ab580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1d285be990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560c388aac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560c388ab740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560c388ab580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1d285c3940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560c388ab900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560c388ab740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    55.51 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1153.11 ms /     1 runs ( 1153.11 ms per run)
whisper_print_timings:   decode time =    10.94 ms /     2 runs (    5.47 ms per run)
whisper_print_timings:   batchd time =   212.14 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1524.30 ms
