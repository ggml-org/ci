...
- status:  SUCCESS ✅
- runtime: 8:43.63
- date:    Sun Feb 11 12:46:57 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  227.02 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.77 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.55 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.74 sec
      Start 10: test3
...
main:     load time =   537.88 ms
main:   sample time =    34.03 ms
main:  predict time =   591.44 ms / 9.24 ms per token
main:    total time =  1185.70 ms
...
main:     load time =   553.07 ms
main:   sample time =    34.01 ms
main:  predict time =   601.72 ms / 8.60 ms per token
main:    total time =  1192.39 ms
...
main:     load time =   564.52 ms
main:   sample time =    29.38 ms
main:  predict time =    21.89 ms / 0.31 ms per token
main:    total time =   619.24 ms
...
main:     n_decoded =      504
main:     load time =   537.01 ms
main:   sample time =   234.48 ms
main:  predict time =  2353.77 ms
main:    total time =  3170.60 ms
...
main: loaded model in   402.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8da2db6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8da2c371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557fb5bea510                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8da2db6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8da2dbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557fb5beb2e0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8da2c371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557fb5bea510                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557fb5bebc40                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557fb5beb2e0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8da2db6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557fb5bec5a0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557fb5bebc40                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557fb5becf00                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8da2db6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557fb5bec5a0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557fb5bed0c0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557fb5becf00                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8da2dbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557fb5bed280                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557fb5bed0c0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   507.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.70 ms
whisper_print_timings:   sample time =    67.51 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    29.29 ms /     1 runs (   29.29 ms per run)
whisper_print_timings:   decode time =    21.39 ms /     2 runs (   10.69 ms per run)
whisper_print_timings:   batchd time =    82.12 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   735.38 ms
...
main:     load time =   490.27 ms
main:    total time =  7820.73 ms
embd_img
