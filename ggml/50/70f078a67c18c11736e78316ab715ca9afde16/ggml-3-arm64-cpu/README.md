...
- status:  SUCCESS ✅
- runtime: 4:45.80
- date:    Sun Feb 11 12:42:59 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  143.16 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.66 sec
...
main:  predict time =   836.49 ms / 13.07 ms per token
main:    total time =  1024.85 ms
...
main:   sample time =    15.72 ms
main:  predict time =    14.76 ms / 0.21 ms per token
main:    total time =   205.43 ms
...
main:  predict time =  5955.63 ms
main:    total time =  6309.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb2c2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb2aab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5cf5b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb2c2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb2c2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf5cf6960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb2aab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5cf5b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf5cf72c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf5cf6960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb2c2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf5cf7c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf5cf72c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf5cf8580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb2c2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf5cf7c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5cf8740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf5cf8580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb2c2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf5cf8900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5cf8740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.25 ms
whisper_print_timings:   sample time =    65.33 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4622.41 ms /     1 runs ( 4622.41 ms per run)
whisper_print_timings:   decode time =    15.43 ms /     2 runs (    7.72 ms per run)
whisper_print_timings:   batchd time =   709.86 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5532.17 ms
