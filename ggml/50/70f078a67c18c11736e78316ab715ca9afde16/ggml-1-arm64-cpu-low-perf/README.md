...
- status:  SUCCESS ✅
- runtime: 5:52.05
- date:    Sun Feb 11 12:43:54 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/5070f078a67c18c11736e78316ab715ca9afde16
- author:  slaren
```
ggml-alloc : v3 (#727)
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.25 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.87 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.55 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  152.66 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.43 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.90 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.61 sec
      Start 10: test-pool
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.27 sec
...
main:     load time =   157.99 ms
main:   sample time =    16.86 ms
main:  predict time =   843.89 ms / 13.19 ms per token
main:    total time =  1040.40 ms
...
main:     load time =   158.88 ms
main:   sample time =    16.73 ms
main:  predict time =   928.05 ms / 13.26 ms per token
main:    total time =  1106.39 ms
...
main:     load time =   191.76 ms
main:   sample time =    15.77 ms
main:  predict time =    15.02 ms / 0.21 ms per token
main:    total time =   225.20 ms
...
main:     n_decoded =      504
main:     load time =   158.29 ms
main:   sample time =   126.96 ms
main:  predict time =  6108.62 ms
main:    total time =  6475.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ea7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e8fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeca70b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ea7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ea7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeca71960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e8fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeca70b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeca722c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeca71960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ea7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeca72c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeca722c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeca73580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ea7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeca72c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeca73740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeca73580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ea7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeca73900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeca73740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.57 ms
whisper_print_timings:   sample time =    65.51 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4757.73 ms /     1 runs ( 4757.73 ms per run)
whisper_print_timings:   decode time =    15.51 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   714.06 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5681.20 ms
...
main:     load time =    91.65 ms
main:    total time = 40319.34 ms
embd_img
