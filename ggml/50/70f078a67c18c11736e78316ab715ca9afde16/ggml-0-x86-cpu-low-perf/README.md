...
- status:  SUCCESS ✅
- runtime: 4:31.42
- date:    Sun Feb 11 12:42:33 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.87 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.24 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  106.84 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 144.68 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.55 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  51.18 sec
...
main:     load time =   105.60 ms
main:   sample time =    23.84 ms
main:  predict time =   639.27 ms / 9.99 ms per token
...
main:     load time =   105.16 ms
main:   sample time =    23.81 ms
main:  predict time =   672.30 ms / 9.60 ms per token
main:    total time =   803.32 ms
...
main:     load time =   131.63 ms
main:   sample time =    21.53 ms
main:  predict time =    11.77 ms / 0.17 ms per token
main:    total time =   166.94 ms
...
main:     n_decoded =      504
main:     load time =   107.51 ms
main:   sample time =   178.14 ms
main:  predict time =  2512.05 ms
main:    total time =  2843.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3b4b1cd990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3b4b04e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56155dd05b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3b4b1cd030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3b4b1d2940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56155dd06960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3b4b04e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56155dd05b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56155dd072c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56155dd06960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3b4b1cd030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56155dd07c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56155dd072c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56155dd08580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3b4b1cd990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56155dd07c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56155dd08740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56155dd08580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3b4b1d2940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56155dd08900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56155dd08740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.46 ms
whisper_print_timings:   sample time =    71.96 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1990.69 ms /     1 runs ( 1990.69 ms per run)
whisper_print_timings:   decode time =    13.35 ms /     2 runs (    6.67 ms per run)
whisper_print_timings:   batchd time =   324.47 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2501.82 ms
...
main:     load time =    67.23 ms
main:    total time = 19009.27 ms
embd_img
