...
- status:  SUCCESS ✅
- runtime: 2:59.53
- date:    Mon Oct  9 12:27:46 UTC 2023
...
main:     load time =   182.83 ms
main:   sample time =    24.00 ms
main:  predict time =   474.99 ms / 7.42 ms per token
main:    total time =   695.67 ms
...
main:     load time =   117.76 ms
main:   sample time =    24.03 ms
main:  predict time =   486.99 ms / 6.96 ms per token
main:    total time =   631.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbefe395900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbefe216170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5611421cbad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbefe394fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbefe39a880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5611421cc870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbefe216170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5611421cbad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5611421cd1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5611421cc870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbefe394fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5611421cdad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5611421cd1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5611421ce400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbefe395900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5611421cdad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5611421ce590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5611421ce400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbefe39a880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5611421ce720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5611421ce590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   147.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.49 ms
whisper_print_timings:   sample time =    16.96 ms /    27 runs (    0.63 ms per run)
whisper_print_timings:   encode time =  1156.74 ms /     1 runs ( 1156.74 ms per run)
whisper_print_timings:   decode time =   109.21 ms /    27 runs (    4.04 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1487.96 ms
```
### mpt
...
main:      load time = 11658.27 ms
main:    sample time =   465.55 ms / 7.27 ms per token
main:      eval time = 21876.05 ms / 312.52 ms per token
main:     total time = 34771.38 ms
...
main:      load time =  4401.70 ms
main:    sample time =   462.56 ms / 7.23 ms per token
main:      eval time =  9130.19 ms / 130.43 ms per token
main:     total time = 14376.77 ms
