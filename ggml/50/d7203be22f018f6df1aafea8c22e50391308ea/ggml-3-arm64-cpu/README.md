...
- status:  SUCCESS ✅
- runtime: 3:52.43
- date:    Mon Oct  9 12:28:45 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.83 sec
...
main:     load time =   242.59 ms
main:   sample time =    16.77 ms
main:  predict time =   801.00 ms / 12.52 ms per token
main:    total time =  1083.20 ms
...
main:  predict time =   871.37 ms / 12.45 ms per token
main:    total time =  1052.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9606a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff95eeb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafa2eaad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96069fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9606f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafa2eb870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff95eeb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafa2eaad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafa2ec1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafa2eb870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96069fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafa2ecad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafa2ec1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafa2ed400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9606a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafa2ecad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafa2ed590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafa2ed400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9606f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafa2ed720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafa2ed590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.43 ms
whisper_print_timings:   sample time =    20.82 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4607.37 ms /     1 runs ( 4607.37 ms per run)
whisper_print_timings:   decode time =   177.14 ms /    27 runs (    6.56 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5046.33 ms
```
### mpt
...
main:      load time =  5561.14 ms
main:    sample time =   520.36 ms / 8.13 ms per token
main:      eval time = 43496.31 ms / 621.38 ms per token
main:     total time = 51949.56 ms
...
main:      load time =  2844.44 ms
main:    sample time =   519.37 ms / 8.12 ms per token
main:      eval time = 17364.82 ms / 248.07 ms per token
main:     total time = 21692.19 ms
