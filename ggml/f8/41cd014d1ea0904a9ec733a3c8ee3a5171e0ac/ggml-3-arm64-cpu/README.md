...
- status:  SUCCESS ✅
- runtime: 7:40.10
- date:    Thu Jan 11 07:43:01 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.08 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   34.65 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.06 sec
...
main:     load time =   268.68 ms
main:   sample time =    17.00 ms
main:  predict time =   831.58 ms / 12.99 ms per token
main:    total time =  1139.21 ms
...
main:     load time =   189.06 ms
main:   sample time =    16.83 ms
main:  predict time =   894.20 ms / 12.77 ms per token
main:    total time =  1103.04 ms
...
main:     n_decoded =      504
main:     load time =   151.47 ms
main:   sample time =   128.35 ms
main:  predict time =  6021.00 ms
main:    total time =  6382.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d5fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d47b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeaa85b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d5fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d5ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa86960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d47b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeaa85b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa872c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa86960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d5fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa87c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa872c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeaa88580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d5fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa87c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeaa88740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeaa88580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d5ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeaa88900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeaa88740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.94 ms
whisper_print_timings:   sample time =    65.67 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4635.20 ms /     1 runs ( 4635.20 ms per run)
whisper_print_timings:   decode time =    14.96 ms /     2 runs (    7.48 ms per run)
whisper_print_timings:   batchd time =   706.15 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5616.91 ms
...
main:     load time =    81.29 ms
main:    total time = 39704.59 ms
embd_img
...
main:      load time = 12526.97 ms
main:    sample time =   520.09 ms / 8.13 ms per token
main:      eval time = 43656.89 ms / 623.67 ms per token
main:     total time = 59075.73 ms
...
main:      load time =  4372.33 ms
main:    sample time =   511.72 ms / 8.00 ms per token
main:      eval time = 17338.08 ms / 247.69 ms per token
main:     total time = 23178.50 ms
