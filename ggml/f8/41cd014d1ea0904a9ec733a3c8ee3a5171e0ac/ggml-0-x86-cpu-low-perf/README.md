...
- status:  SUCCESS ✅
- runtime: 2:48.01
- date:    Thu Jan 11 07:30:41 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f841cd014d1ea0904a9ec733a3c8ee3a5171e0ac
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.26 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   34.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.49 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    7.92 sec
...
main:     load time =   125.65 ms
main:   sample time =    23.49 ms
main:  predict time =   621.57 ms / 9.71 ms per token
main:    total time =   783.31 ms
...
main:     load time =   126.35 ms
main:   sample time =    23.40 ms
main:  predict time =   680.72 ms / 9.72 ms per token
main:    total time =   832.70 ms
...
main:   sample time =   178.20 ms
main:  predict time =  2515.09 ms
main:    total time =  2842.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f56f148b990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56f130c1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558c44509b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f56f148b030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f56f1490940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558c4450a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56f130c1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558c44509b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558c4450b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558c4450a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f56f148b030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558c4450bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558c4450b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558c4450c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f56f148b990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558c4450bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558c4450c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558c4450c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f56f1490940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558c4450c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558c4450c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.87 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.36 ms
whisper_print_timings:   sample time =    72.18 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1987.67 ms /     1 runs ( 1987.67 ms per run)
whisper_print_timings:   decode time =    13.02 ms /     2 runs (    6.51 ms per run)
whisper_print_timings:   batchd time =   323.42 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2496.79 ms
...
main:     load time =    72.33 ms
main:    total time = 19037.49 ms
embd_img
