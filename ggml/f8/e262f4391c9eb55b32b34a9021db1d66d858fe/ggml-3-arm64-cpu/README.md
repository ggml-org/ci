...
- status:  SUCCESS ✅
- runtime: 4:10.87
- date:    Sun Feb 25 14:08:59 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   99.99 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 117.92 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.33 sec
...
main:  predict time =   887.79 ms / 13.87 ms per token
main:    total time =  1072.31 ms
...
main:  predict time =   975.25 ms / 13.93 ms per token
main:    total time =  1146.11 ms
...
main:  predict time =  6447.06 ms
main:    total time =  6801.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9bc2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9baab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf64face0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9bc2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9bc2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf64fbab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9baab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf64face0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf64fc410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf64fbab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9bc2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf64fcd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf64fc410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf64fd6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9bc2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf64fcd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf64fd890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf64fd6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9bc2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf64fda50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf64fd890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.16 ms
whisper_print_timings:   sample time =    65.30 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4679.07 ms /     1 runs ( 4679.07 ms per run)
whisper_print_timings:   decode time =    15.33 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   707.97 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5591.77 ms
...
main:     load time =    92.62 ms
main:    total time = 39837.84 ms
embd_img
