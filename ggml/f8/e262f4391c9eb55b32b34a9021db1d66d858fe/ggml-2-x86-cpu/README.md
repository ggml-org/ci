...
- status:  SUCCESS ✅
- runtime: 2:55.08
- date:    Sun Feb 25 14:00:04 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f8e262f4391c9eb55b32b34a9021db1d66d858fe
...
20/20 Test #20: test-backend-ops .................   Passed   80.81 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  95.36 sec
...
21/21 Test #21: test-backend-ops .................   Passed   17.59 sec
...
main:     load time =   104.50 ms
main:   sample time =    23.57 ms
main:  predict time =   484.54 ms / 7.57 ms per token
main:    total time =   625.32 ms
...
main:     load time =   110.14 ms
main:   sample time =    23.54 ms
main:  predict time =   508.60 ms / 7.27 ms per token
main:    total time =   644.47 ms
...
main:  predict time =   515.14 ms / 7.36 ms per token
main:    total time =   670.53 ms
...
main:  predict time =  1811.14 ms
main:    total time =  2125.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1d421ce990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1d4204f1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562d8601ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1d421ce030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1d421d3940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562d8601bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1d4204f1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562d8601ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562d8601c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562d8601bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1d421ce030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562d8601cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562d8601c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562d8601d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1d421ce990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562d8601cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562d8601d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562d8601d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1d421d3940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562d8601da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562d8601d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.52 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.51 ms
whisper_print_timings:   sample time =    55.36 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1181.66 ms /     1 runs ( 1181.66 ms per run)
whisper_print_timings:   decode time =    12.36 ms /     2 runs (    6.18 ms per run)
whisper_print_timings:   batchd time =   212.89 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1559.20 ms
