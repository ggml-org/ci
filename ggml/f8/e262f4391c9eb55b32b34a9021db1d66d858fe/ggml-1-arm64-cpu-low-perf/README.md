...
- status:  SUCCESS ✅
- runtime: 5:08.26
- date:    Sun Feb 25 02:02:14 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.89 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.56 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  101.49 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 143.24 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   21.04 sec
...
main:     load time =   157.66 ms
main:   sample time =    16.88 ms
main:  predict time =   900.35 ms / 14.07 ms per token
main:    total time =  1096.39 ms
...
main:  predict time =   990.51 ms / 14.15 ms per token
main:    total time =  1168.59 ms
...
main:     load time =   186.62 ms
main:   sample time =    16.93 ms
main:  predict time =   999.78 ms / 14.28 ms per token
main:    total time =  1206.50 ms
...
main:  predict time =  6621.98 ms
main:    total time =  6995.19 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ca8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c90b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2c9dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ca8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ca8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2c9eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c90b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2c9dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad2c9f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2c9eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ca8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2c9fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad2c9f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2ca06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ca8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2c9fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2ca0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2ca06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ca8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad2ca0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2ca0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.10 ms
whisper_print_timings:   sample time =    66.06 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4792.14 ms /     1 runs ( 4792.14 ms per run)
whisper_print_timings:   decode time =    15.66 ms /     2 runs (    7.83 ms per run)
whisper_print_timings:   batchd time =   713.24 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5715.34 ms
...
main:     load time =    90.38 ms
main:    total time = 40482.10 ms
embd_img
