...
- status:  SUCCESS ✅
- runtime: 4:12.13
- date:    Sun Feb 25 14:01:21 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   79.75 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 121.47 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.67 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.11 sec
...
main:  predict time =   693.52 ms / 10.84 ms per token
main:    total time =   832.90 ms
...
main:     load time =   124.94 ms
main:   sample time =    23.66 ms
main:  predict time =   742.60 ms / 10.61 ms per token
main:    total time =   893.77 ms
...
main:  predict time =  3102.69 ms
main:    total time =  3430.22 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc0f25ec990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc0f246d1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55da5c2f2ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc0f25ec030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc0f25f1940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55da5c2f3ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc0f246d1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55da5c2f2ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55da5c2f4410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55da5c2f3ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc0f25ec030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55da5c2f4d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55da5c2f4410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55da5c2f56d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc0f25ec990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55da5c2f4d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55da5c2f5890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55da5c2f56d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc0f25f1940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55da5c2f5a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55da5c2f5890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.32 ms
whisper_print_timings:   sample time =    73.10 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2056.96 ms /     1 runs ( 2056.96 ms per run)
whisper_print_timings:   decode time =    16.04 ms /     2 runs (    8.02 ms per run)
whisper_print_timings:   batchd time =   331.04 ms /   125 runs (    2.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2580.78 ms
