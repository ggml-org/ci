...
- status:  SUCCESS ✅
- runtime: 5:03.70
- date:    Mon Feb 19 02:03:36 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.62 sec
...
20/20 Test #20: test-backend-ops .................   Passed   98.20 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.55 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.10 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.63 sec
      Start 10: test-pool
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   19.46 sec
...
main:  predict time =   904.27 ms / 14.13 ms per token
main:    total time =  1099.71 ms
...
main:     load time =   155.07 ms
main:   sample time =    16.84 ms
main:  predict time =   982.62 ms / 14.04 ms per token
...
main:  predict time =   998.07 ms / 14.26 ms per token
main:    total time =  1203.25 ms
...
main:     n_decoded =      504
main:     load time =   156.68 ms
main:   sample time =   128.05 ms
main:  predict time =  6604.28 ms
main:    total time =  6971.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9c68a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c50b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafade6ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9c68a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9c68f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafade7ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c50b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafade6ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafade8410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafade7ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9c68a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafade8d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafade8410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafade96d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9c68a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafade8d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafade9890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafade96d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9c68f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafade9a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafade9890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.96 ms
whisper_print_timings:   sample time =    65.91 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4711.62 ms /     1 runs ( 4711.62 ms per run)
whisper_print_timings:   decode time =    14.78 ms /     2 runs (    7.39 ms per run)
whisper_print_timings:   batchd time =   724.04 ms /   125 runs (    5.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5649.03 ms
