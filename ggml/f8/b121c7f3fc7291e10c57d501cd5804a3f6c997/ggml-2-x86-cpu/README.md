...
- status:  SUCCESS ✅
- runtime: 2:52.45
- date:    Mon Feb 19 14:00:56 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   78.48 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  92.98 sec
...
21/21 Test #21: test-backend-ops .................   Passed   17.78 sec
...
main:  predict time =   492.92 ms / 7.70 ms per token
main:    total time =   635.29 ms
...
main:     load time =   110.84 ms
main:   sample time =    23.54 ms
main:  predict time =   516.39 ms / 7.38 ms per token
main:    total time =   652.95 ms
...
main:  predict time =   521.27 ms / 7.45 ms per token
main:    total time =   671.27 ms
...
main:  predict time =  1807.92 ms
main:    total time =  2125.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc9e4e32990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc9e4cb31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562bbe94bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc9e4e32030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc9e4e37940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562bbe94cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc9e4cb31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562bbe94bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562bbe94d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562bbe94cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc9e4e32030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562bbe94dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562bbe94d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562bbe94e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc9e4e32990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562bbe94dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562bbe94e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562bbe94e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc9e4e37940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562bbe94ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562bbe94e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.84 ms
whisper_print_timings:   sample time =    54.85 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1190.62 ms /     1 runs ( 1190.62 ms per run)
whisper_print_timings:   decode time =    12.51 ms /     2 runs (    6.25 ms per run)
whisper_print_timings:   batchd time =   213.24 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1568.49 ms
...
main:     load time =    65.23 ms
main:    total time = 10770.07 ms
embd_img
