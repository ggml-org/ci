...
- status:  SUCCESS ✅
- runtime: 4:16.54
- date:    Mon Feb 19 02:41:52 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/f8b121c7f3fc7291e10c57d501cd5804a3f6c997
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.04 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.51 sec
...
20/20 Test #20: test-backend-ops .................   Passed   98.44 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 116.06 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.94 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.14 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.43 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.20 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.63 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  30.77 sec
...
main:  predict time =   890.39 ms / 13.91 ms per token
main:    total time =  1081.76 ms
...
main:     load time =   151.20 ms
main:   sample time =    16.97 ms
main:  predict time =   972.43 ms / 13.89 ms per token
...
main:     load time =   181.95 ms
main:   sample time =    17.22 ms
main:  predict time =   980.69 ms / 14.01 ms per token
main:    total time =  1182.92 ms
...
main:     n_decoded =      504
main:     load time =   150.28 ms
main:   sample time =   127.27 ms
main:  predict time =  6449.47 ms
main:    total time =  6809.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff97bda990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97a5b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacee5bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff97bda030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff97bdf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacee5cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97a5b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacee5bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacee5d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacee5cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff97bda030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacee5dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacee5d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacee5e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff97bda990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacee5dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacee5e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacee5e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff97bdf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacee5ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacee5e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.39 ms
whisper_print_timings:   sample time =    65.57 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4694.23 ms /     1 runs ( 4694.23 ms per run)
whisper_print_timings:   decode time =    14.55 ms /     2 runs (    7.28 ms per run)
whisper_print_timings:   batchd time =   709.40 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5606.18 ms
...
main:     load time =    84.37 ms
main:    total time = 39769.08 ms
embd_img
