...
- status:  SUCCESS ✅
- runtime: 1:53.22
- date:    Fri Feb 28 07:06:34 UTC 2025
...
main:     load time =   153.90 ms
main:   sample time =    17.57 ms
main:  predict time =   467.89 ms / 7.31 ms per token
...
main:  predict time =   490.61 ms / 7.01 ms per token
...
main:   sample time =   120.10 ms
main:  predict time =  1657.46 ms
