...
- status:  SUCCESS ✅
- runtime: 3:21.29
- date:    Tue Aug 22 10:43:01 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/85911622c1474b54c124375b0137f4bca218f15e
- author:  leejet
```
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.48 sec
      Start  2: test-opt
...
main:     load time =   177.11 ms
main:   sample time =    17.75 ms
main:  predict time =   804.70 ms / 12.57 ms per token
main:    total time =  1067.68 ms
...
main: mem per token =  2017572 bytes
main:     load time =   176.81 ms
main:   sample time =    17.73 ms
main:  predict time =   874.78 ms / 12.50 ms per token
main:    total time =  1118.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ea3a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e8bb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0198fab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ea39f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ea3f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab01990830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e8bb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0198fab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab01991140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab01990830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ea39f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab01991a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab01991140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab01992360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ea3a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab01991a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab019924d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab01992360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ea3f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab01992640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab019924d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5462.47 ms
main:    sample time =   611.10 ms / 9.55 ms per token
main:      eval time = 44124.21 ms / 630.35 ms per token
main:     total time = 52584.71 ms
...
main:      load time =  1724.00 ms
main:    sample time =   615.18 ms / 9.61 ms per token
main:      eval time = 17384.06 ms / 248.34 ms per token
main:     total time = 20694.77 ms
