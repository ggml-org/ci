...
- status:  SUCCESS ✅
- runtime: 4:39.24
- date:    Tue Aug 22 10:44:20 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.19 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.33 sec
...
main:     load time =   188.42 ms
main:   sample time =    34.40 ms
main:  predict time =   535.91 ms / 8.37 ms per token
main:    total time =   807.97 ms
...
main: mem per token =  2017572 bytes
main:     load time =   188.20 ms
main:   sample time =    35.04 ms
main:  predict time =   555.44 ms / 7.93 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe7fe5f48a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7fe475150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555787952ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe7fe5f3f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe7fe5f9800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555787953830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe7fe475150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555787952ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555787954140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555787953830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe7fe5f3f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555787954a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555787954140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555787955360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe7fe5f48a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555787954a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5557879554d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555787955360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe7fe5f9800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555787955640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5557879554d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6341.90 ms
main:    sample time =   582.91 ms / 9.11 ms per token
main:      eval time = 23352.71 ms / 333.61 ms per token
main:     total time = 31112.10 ms
...
main:      load time =  1780.37 ms
main:    sample time =   592.10 ms / 9.25 ms per token
main:      eval time = 12113.54 ms / 173.05 ms per token
main:     total time = 15125.96 ms
