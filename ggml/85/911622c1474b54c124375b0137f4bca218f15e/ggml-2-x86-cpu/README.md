...
- status:  SUCCESS ✅
- runtime: 2:16.82
- date:    Tue Aug 22 10:42:03 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.51 sec
      Start  2: test-opt
...
main:  predict time =   430.97 ms / 6.73 ms per token
main:    total time =   620.82 ms
...
main:  predict time =   447.22 ms / 6.39 ms per token
main:    total time =   626.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa23da268a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa23d8a7150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55933a6bfab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa23da25f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa23da2b800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55933a6c0830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa23d8a7150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55933a6bfab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55933a6c1140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55933a6c0830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa23da25f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55933a6c1a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55933a6c1140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55933a6c2360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa23da268a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55933a6c1a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55933a6c24d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55933a6c2360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa23da2b800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55933a6c2640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55933a6c24d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4304.67 ms
main:    sample time =   465.95 ms / 7.28 ms per token
main:      eval time = 18916.71 ms / 270.24 ms per token
main:     total time = 24323.58 ms
...
main:      load time =  1257.12 ms
main:    sample time =   466.08 ms / 7.28 ms per token
main:      eval time =  7965.72 ms / 113.80 ms per token
main:     total time = 10071.12 ms
