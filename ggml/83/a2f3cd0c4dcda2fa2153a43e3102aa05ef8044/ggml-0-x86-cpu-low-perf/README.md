...
- status:  SUCCESS ✅
- runtime: 3:24.12
- date:    Sun Jun 16 08:58:29 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.20 sec
      Start  9: test3
...
main:  predict time =   638.77 ms / 9.98 ms per token
...
main:     load time =   100.53 ms
main:   sample time =    23.77 ms
main:  predict time =   666.98 ms / 9.53 ms per token
main:    total time =   793.39 ms
...
main:     load time =   120.77 ms
main:   sample time =    23.91 ms
main:  predict time =   682.07 ms / 9.74 ms per token
...
main:     n_decoded =      504
main:     load time =    99.01 ms
main:   sample time =   178.17 ms
main:  predict time =  2563.02 ms
main:    total time =  2885.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7170174fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x71701737b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5825be940ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7170174fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7170174ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5825be941ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x71701737b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5825be940ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5825be942410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5825be941ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7170174fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5825be942d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5825be942410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5825be9436d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7170174fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5825be942d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5825be943890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5825be9436d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7170174ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5825be943a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5825be943890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.22 ms
whisper_print_timings:   sample time =    71.44 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2001.84 ms /     1 runs ( 2001.84 ms per run)
whisper_print_timings:   decode time =    13.63 ms /     2 runs (    6.81 ms per run)
whisper_print_timings:   batchd time =   326.35 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2521.06 ms
...
main:     load time =    67.87 ms
main:    total time = 18355.19 ms
embd_img
