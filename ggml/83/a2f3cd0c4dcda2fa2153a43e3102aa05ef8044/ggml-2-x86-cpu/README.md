...
- status:  SUCCESS ✅
- runtime: 2:09.46
- date:    Sun Jun 16 08:56:13 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   16.12 sec
...
main:  predict time =   480.71 ms / 7.51 ms per token
main:    total time =   622.17 ms
...
main:  predict time =   497.23 ms / 7.10 ms per token
main:    total time =   627.17 ms
...
main:  predict time =   515.37 ms / 7.36 ms per token
main:    total time =   666.42 ms
...
main:  predict time =  1538.77 ms
main:    total time =  1853.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x709819cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x709819b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x593d3c59cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x709819cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x709819cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x593d3c59dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x709819b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x593d3c59cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x593d3c59e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x593d3c59dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x709819cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x593d3c59ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x593d3c59e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x593d3c59f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x709819cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x593d3c59ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x593d3c59f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x593d3c59f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x709819cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x593d3c59fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x593d3c59f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.44 ms
whisper_print_timings:   sample time =    55.56 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1160.84 ms /     1 runs ( 1160.84 ms per run)
whisper_print_timings:   decode time =    11.00 ms /     2 runs (    5.50 ms per run)
whisper_print_timings:   batchd time =   219.47 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1547.91 ms
