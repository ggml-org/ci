...
- status:  SUCCESS ✅
- runtime: 3:08.05
- date:    Sun Jun 16 08:58:00 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.46 sec
...
12/22 Test #12: test-arange ......................   Passed    0.01 sec
...
main:  predict time =   878.14 ms / 13.72 ms per token
...
main:  predict time =   943.95 ms / 13.48 ms per token
main:    total time =  1115.81 ms
...
main:  predict time =   941.96 ms / 13.46 ms per token
main:    total time =  1143.66 ms
...
main:   sample time =   130.46 ms
main:  predict time =  6071.21 ms
main:    total time =  6435.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe63e94a8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe63e9490b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8fead67cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe63e94a8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe63e94a8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8fead67dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe63e9490b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8fead67cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8fead67e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8fead67dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe63e94a8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8fead67ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8fead67e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8fead67f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe63e94a8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8fead67ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8fead67f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8fead67f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe63e94a8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb8fead67fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8fead67f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    67.53 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4680.35 ms /     1 runs ( 4680.35 ms per run)
whisper_print_timings:   decode time =    15.08 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   731.65 ms /   125 runs (    5.85 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5631.97 ms
