...
- status:  SUCCESS ✅
- runtime: 4:05.24
- date:    Sun Jun 16 08:59:56 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   35.81 sec
...
main:  predict time =   885.28 ms / 13.83 ms per token
main:    total time =  1075.92 ms
...
main:     load time =   144.65 ms
main:   sample time =    18.48 ms
main:  predict time =   971.47 ms / 13.88 ms per token
...
main:     load time =   175.48 ms
main:   sample time =    18.28 ms
main:  predict time =   961.96 ms / 13.74 ms per token
main:    total time =  1159.18 ms
...
main:     n_decoded =      504
main:     load time =   152.44 ms
main:   sample time =   128.37 ms
main:  predict time =  6117.88 ms
main:    total time =  6481.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfc89741ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfc897404b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb1ee6b850ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfc89741ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfc89741cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb1ee6b851ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfc897404b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb1ee6b850ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb1ee6b852410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb1ee6b851ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfc89741ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb1ee6b852d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb1ee6b852410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb1ee6b8536d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfc89741ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb1ee6b852d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb1ee6b853890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb1ee6b8536d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfc89741cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb1ee6b853a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb1ee6b853890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.76 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.41 ms
whisper_print_timings:   sample time =    71.47 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  4682.18 ms /     1 runs ( 4682.18 ms per run)
whisper_print_timings:   decode time =    15.15 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   735.54 ms /   125 runs (    5.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5641.05 ms
