...
- status:  SUCCESS ✅
- runtime: 3:30.71
- date:    Mon Aug 28 09:37:53 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.53 sec
      Start  2: test-opt
...
main:     load time =   296.95 ms
main:   sample time =    17.54 ms
main:  predict time =   800.37 ms / 12.51 ms per token
...
main:     load time =   182.10 ms
main:   sample time =    17.35 ms
main:  predict time =   868.20 ms / 12.40 ms per token
main:    total time =  1071.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff903ba8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9023b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4d60ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff903b9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff903bf800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf4d61830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9023b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4d60ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf4d62140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf4d61830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff903b9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf4d62a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf4d62140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf4d63360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff903ba8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf4d62a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf4d634d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf4d63360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff903bf800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf4d63640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf4d634d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5895.32 ms
main:    sample time =   608.34 ms / 9.51 ms per token
main:      eval time = 43760.43 ms / 625.15 ms per token
main:     total time = 52652.50 ms
...
main:      load time =  1589.53 ms
main:    sample time =   612.94 ms / 9.58 ms per token
main:      eval time = 17375.02 ms / 248.21 ms per token
main:     total time = 20548.00 ms
