...
- status:  SUCCESS ✅
- runtime: 2:21.15
- date:    Mon Aug 28 09:36:40 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.55 sec
      Start  2: test-opt
...
main:     load time =   124.69 ms
main:   sample time =    23.40 ms
main:  predict time =   428.55 ms / 6.70 ms per token
main:    total time =   590.04 ms
...
main:     load time =   124.92 ms
main:   sample time =    23.37 ms
main:  predict time =   441.27 ms / 6.30 ms per token
main:    total time =   592.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5e9b6a58a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5e9b526150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563d02674ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5e9b6a4f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5e9b6aa800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563d02675830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5e9b526150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563d02674ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563d02676140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563d02675830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5e9b6a4f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563d02676a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563d02676140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563d02677360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5e9b6a58a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563d02676a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563d026774d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563d02677360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5e9b6aa800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563d02677640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563d026774d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4303.25 ms
main:    sample time =   466.11 ms / 7.28 ms per token
main:      eval time = 19054.11 ms / 272.20 ms per token
main:     total time = 24455.03 ms
...
main:      load time =  1255.61 ms
main:    sample time =   466.37 ms / 7.29 ms per token
main:      eval time =  7967.48 ms / 113.82 ms per token
main:     total time = 10075.11 ms
