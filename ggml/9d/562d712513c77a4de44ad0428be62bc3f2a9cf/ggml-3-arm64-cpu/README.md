...
- status:  SUCCESS ✅
- runtime: 3:09.26
- date:    Wed Jun  5 11:03:32 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   20.54 sec
...
main:  predict time =   902.02 ms / 14.09 ms per token
main:    total time =  1087.89 ms
...
main:  predict time =   978.11 ms / 13.97 ms per token
main:    total time =  1144.25 ms
...
main:     load time =   175.69 ms
main:   sample time =    16.76 ms
main:  predict time =  1003.45 ms / 14.34 ms per token
main:    total time =  1199.08 ms
...
main:  predict time =  6466.41 ms
main:    total time =  6827.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfca632f1a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfca632d9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb1b63946bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfca632f1a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfca632f1f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb1b63946cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfca632d9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb1b63946bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb1b63946d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb1b63946cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfca632f1a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb1b63946dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb1b63946d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb1b63946e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfca632f1a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb1b63946dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb1b63946e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb1b63946e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfca632f1f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb1b63946ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb1b63946e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   101.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.27 ms
whisper_print_timings:   sample time =    67.42 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4652.87 ms /     1 runs ( 4652.87 ms per run)
whisper_print_timings:   decode time =    14.34 ms /     2 runs (    7.17 ms per run)
whisper_print_timings:   batchd time =   719.95 ms /   125 runs (    5.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5588.09 ms
