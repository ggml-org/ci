...
- status:  SUCCESS ✅
- runtime: 3:25.57
- date:    Wed Jun  5 11:03:42 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.42 sec
      Start  9: test3
...
Total Test time (real) =  74.35 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.62 sec
      Start  9: test3
...
main:  predict time =   697.76 ms / 10.90 ms per token
main:    total time =   836.66 ms
...
main:  predict time =   742.56 ms / 10.61 ms per token
main:    total time =   870.28 ms
...
main:     load time =   123.81 ms
main:   sample time =    23.87 ms
main:  predict time =   737.59 ms / 10.54 ms per token
main:    total time =   888.35 ms
...
main:   sample time =   178.50 ms
main:  predict time =  3030.86 ms
main:    total time =  3355.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x723987afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x72398797b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x58ea81459ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x723987afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x723987aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x58ea8145aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x72398797b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x58ea81459ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x58ea8145b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x58ea8145aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x723987afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x58ea8145bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x58ea8145b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x58ea8145c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x723987afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x58ea8145bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x58ea8145c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x58ea8145c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x723987aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x58ea8145ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x58ea8145c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.94 ms
whisper_print_timings:   sample time =    72.57 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2005.44 ms /     1 runs ( 2005.44 ms per run)
whisper_print_timings:   decode time =    13.81 ms /     2 runs (    6.91 ms per run)
whisper_print_timings:   batchd time =   328.02 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2527.00 ms
...
main:     load time =    71.03 ms
main:    total time = 18791.44 ms
embd_img
