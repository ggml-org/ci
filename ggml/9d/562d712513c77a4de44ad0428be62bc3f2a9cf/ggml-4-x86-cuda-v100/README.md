...
- status:  SUCCESS ✅
- runtime: 10:23.40
- date:    Wed Jun  5 11:10:35 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   35.90 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   11.00 sec
...
22/22 Test #22: test-backend-ops .................   Passed  149.86 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 231.11 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    3.76 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    3.09 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   20.19 sec
 ...
 8/23 Test  #8: test1 ............................   Passed    0.04 sec
      Start  9: test2
 9/23 Test  #9: test2 ............................   Passed   20.25 sec
      Start 10: test3
...
23/23 Test #23: test-backend-ops .................   Passed   41.43 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) = 100.62 sec
...
main:   sample time =    34.99 ms
main:  predict time =   723.27 ms / 11.30 ms per token
main:    total time =   931.05 ms
...
main:     load time =   177.81 ms
main:   sample time =    40.08 ms
main:  predict time =   772.90 ms / 11.04 ms per token
main:    total time =   994.96 ms
...
main:     load time =   209.84 ms
main:   sample time =    40.29 ms
main:  predict time =   811.38 ms / 11.59 ms per token
main:    total time =  1067.65 ms
...
main:     n_decoded =      504
main:     load time =   179.01 ms
main:   sample time =   242.33 ms
main:  predict time =  2968.58 ms
main:    total time =  3438.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1caa8fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1caa77b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556e957acc50                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1caa8fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1caa8ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556e957ada20                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1caa77b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556e957acc50                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556e957ae380                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556e957ada20                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1caa8fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556e957aece0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556e957ae380                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556e957af640                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1caa8fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556e957aece0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556e957af800                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556e957af640                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1caa8ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556e957af9c0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556e957af800       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   493.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.37 ms
whisper_print_timings:   sample time =    64.64 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =    47.88 ms /     1 runs (   47.88 ms per run)
whisper_print_timings:   decode time =    11.41 ms /     2 runs (    5.71 ms per run)
whisper_print_timings:   batchd time =    79.00 ms /   125 runs (    0.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   726.25 ms
