...
- status:  SUCCESS ✅
- runtime: 2:36.45
- date:    Thu Nov 23 08:16:26 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/9d2d59ab1d258dfc2e124da3c17d8f994ff1309f
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.95 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.34 sec
      Start  6: test0
 6/17 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.96 sec
      Start  9: test3
...
Total Test time (real) =  23.70 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.91 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.09 sec
      Start  9: test3
 9/17 Test  #9: test3 ............................   Passed    0.57 sec
      Start 10: test-pool
...
main:     load time =   182.75 ms
main:   sample time =    17.13 ms
main:  predict time =   810.53 ms / 12.66 ms per token
main:    total time =  1032.19 ms
...
main:     load time =   189.11 ms
main:   sample time =    17.41 ms
main:  predict time =  1009.63 ms / 14.42 ms per token
main:    total time =  1219.04 ms
...
main:     n_decoded =      504
main:     load time =   157.86 ms
main:   sample time =   128.54 ms
main:  predict time =  5967.84 ms
main:    total time =  6334.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fb9a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7fa1b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac8d26b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fb9a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fb9f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac8d27940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7fa1b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac8d26b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac8d28290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac8d27940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fb9a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac8d28be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac8d28290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac8d29530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fb9a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac8d28be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac8d296e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac8d29530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fb9f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac8d29890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac8d296e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =    64.61 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4750.62 ms /     1 runs ( 4750.62 ms per run)
whisper_print_timings:   decode time =    15.63 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   713.46 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5671.43 ms
...
main:     load time =    90.25 ms
main:    total time = 40037.81 ms
embd_img
