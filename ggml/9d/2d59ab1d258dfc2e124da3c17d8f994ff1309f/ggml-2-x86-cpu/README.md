...
- status:  SUCCESS ✅
- runtime: 3:12.17
- date:    Thu Nov 23 08:17:03 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.32 sec
      Start  2: test-opt
...
main:     load time =   250.19 ms
main:   sample time =    23.99 ms
main:  predict time =   463.29 ms / 7.24 ms per token
main:    total time =   750.16 ms
...
main:  predict time =   484.48 ms / 6.92 ms per token
...
main:  predict time =  1474.96 ms
main:    total time =  1791.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa4d9193960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa4d9014190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562500883b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa4d9193010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa4d9198900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562500884940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa4d9014190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562500883b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562500885290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562500884940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa4d9193010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562500885be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562500885290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562500886530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa4d9193960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562500885be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5625008866e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562500886530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa4d9198900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x562500886890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5625008866e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    53.38 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1137.49 ms /     1 runs ( 1137.49 ms per run)
whisper_print_timings:   decode time =     9.26 ms /     2 runs (    4.63 ms per run)
whisper_print_timings:   batchd time =   203.41 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1549.06 ms
...
main:      load time = 11315.19 ms
main:    sample time =   470.62 ms / 7.35 ms per token
main:      eval time = 20089.72 ms / 287.00 ms per token
main:     total time = 32683.28 ms
...
main:      load time =  4397.10 ms
main:    sample time =   464.16 ms / 7.25 ms per token
main:      eval time =  8342.78 ms / 119.18 ms per token
main:     total time = 13588.09 ms
