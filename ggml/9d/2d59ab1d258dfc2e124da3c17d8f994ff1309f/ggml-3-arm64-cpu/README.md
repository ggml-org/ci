...
- status:  SUCCESS ✅
- runtime: 4:49.97
- date:    Thu Nov 23 08:18:35 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.37 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.56 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.99 sec
      Start  2: test-opt
 ...
 5/18 Test  #5: test-mul-mat0 ....................   Passed    0.56 sec
...
10/18 Test #10: test3 ............................   Passed    0.03 sec
      Start 11: test-pool
11/18 Test #11: test-pool ........................   Passed    0.01 sec
...
main:     load time =   176.15 ms
main:   sample time =    16.89 ms
main:  predict time =   810.01 ms / 12.66 ms per token
main:    total time =  1025.56 ms
...
main:     load time =   173.04 ms
main:   sample time =    17.05 ms
main:  predict time =   876.12 ms / 12.52 ms per token
main:    total time =  1069.03 ms
...
main:     n_decoded =      504
main:     load time =   147.32 ms
main:   sample time =   128.32 ms
main:  predict time =  5826.35 ms
main:    total time =  6182.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa421a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa409b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafad50b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa421a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa421f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafad51940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa409b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafad50b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafad52290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafad51940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa421a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafad52be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafad52290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafad53530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa421a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafad52be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafad536e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafad53530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa421f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafad53890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafad536e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   193.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.98 ms
whisper_print_timings:   sample time =    64.56 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4633.49 ms /     1 runs ( 4633.49 ms per run)
whisper_print_timings:   decode time =    15.63 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   710.20 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5634.47 ms
...
main:     load time =    79.23 ms
main:    total time = 39324.27 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.242000 sec.)
...
main:      load time = 12530.40 ms
main:    sample time =   529.86 ms / 8.28 ms per token
main:      eval time = 43477.76 ms / 621.11 ms per token
main:     total time = 58911.38 ms
...
main:      load time =  4323.64 ms
main:    sample time =   525.59 ms / 8.21 ms per token
main:      eval time = 17692.48 ms / 252.75 ms per token
main:     total time = 23512.38 ms
