...
- status:  SUCCESS ✅
- runtime: 2:37.67
- date:    Fri Sep  8 12:23:54 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.79 sec
...
main:     load time =   218.31 ms
main:   sample time =    23.49 ms
main:  predict time =   435.39 ms / 6.80 ms per token
main:    total time =   690.66 ms
...
main:  predict time =   457.03 ms / 6.53 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbdbc6638d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbdbc4e4160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558131402ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbdbc662fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbdbc668840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558131403850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbdbc4e4160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558131402ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558131404170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558131403850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbdbc662fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558131404a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558131404170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5581314053b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbdbc6638d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558131404a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558131405530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5581314053b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbdbc668840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5581314056b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558131405530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5472.92 ms
main:    sample time =   466.85 ms / 7.29 ms per token
main:      eval time = 20283.00 ms / 289.76 ms per token
main:     total time = 26944.11 ms
...
main:      load time =  1184.12 ms
main:    sample time =   463.61 ms / 7.24 ms per token
main:      eval time =  8204.94 ms / 117.21 ms per token
main:     total time = 10635.94 ms
