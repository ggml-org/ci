...
- status:  SUCCESS ✅
- runtime: 3:43.23
- date:    Fri Sep  8 12:34:00 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.96 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.94 sec
      Start  2: test-opt
...
main:     load time =   234.35 ms
main:   sample time =    17.74 ms
main:  predict time =   808.34 ms / 12.63 ms per token
...
main:  predict time =   878.78 ms / 12.55 ms per token
main:    total time =  1088.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb829a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb811b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab08482ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8299fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb829f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab08483850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb811b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab08482ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab08484170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab08483850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8299fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab08484a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab08484170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab084853b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb829a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab08484a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab08485530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab084853b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb829f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab084856b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab08485530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12088.55 ms
main:    sample time =   626.49 ms / 9.79 ms per token
main:      eval time = 43775.64 ms / 625.37 ms per token
main:     total time = 58868.69 ms
...
main:      load time =  4325.15 ms
main:    sample time =   620.04 ms / 9.69 ms per token
main:      eval time = 17373.42 ms / 248.19 ms per token
main:     total time = 23275.82 ms
