...
- status:  SUCCESS ✅
- runtime: 5:33.52
- date:    Fri Sep  8 12:37:46 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    3.63 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.67 sec
...
main:     load time =   350.04 ms
main:   sample time =    36.84 ms
main:  predict time =   560.08 ms / 8.75 ms per token
main:    total time =   968.09 ms
...
main:     load time =   193.88 ms
main:   sample time =    34.50 ms
main:  predict time =   580.40 ms / 8.29 ms per token
main:    total time =   813.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5f5ea1d8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5f5e89e160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c3c102cac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5f5ea1cfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5f5ea22840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c3c102d850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5f5e89e160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c3c102cac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c3c102e170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c3c102d850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5f5ea1cfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c3c102ea90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c3c102e170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c3c102f3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5f5ea1d8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c3c102ea90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c3c102f530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c3c102f3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5f5ea22840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c3c102f6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c3c102f530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 18982.84 ms
main:    sample time =   570.32 ms / 8.91 ms per token
main:      eval time = 25333.60 ms / 361.91 ms per token
main:     total time = 45933.22 ms
...
main:      load time = 13386.31 ms
main:    sample time =   578.82 ms / 9.04 ms per token
main:      eval time = 12281.64 ms / 175.45 ms per token
main:     total time = 26890.16 ms
