...
- status:  SUCCESS ✅
- runtime: 5:18.85
- date:    Sat Dec 23 04:48:53 PM UTC 2023
...
main:     load time =   226.80 ms
main:   sample time =    16.76 ms
main:  predict time =   806.59 ms / 12.60 ms per token
main:    total time =  1071.57 ms
...
main:     load time =   180.66 ms
main:   sample time =    16.98 ms
main:  predict time =   877.85 ms / 12.54 ms per token
...
main:     n_decoded =      504
main:     load time =   145.61 ms
main:   sample time =   126.74 ms
main:  predict time =  5896.02 ms
main:    total time =  6249.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa45aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa442b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabbc99b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa45aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa45af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabbc9a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa442b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabbc99b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabbc9b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabbc9a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa45aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabbc9bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabbc9b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabbc9c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa45aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabbc9bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabbc9c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabbc9c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa45af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaabbc9c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabbc9c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.34 ms
whisper_print_timings:   sample time =    65.63 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4660.53 ms /     1 runs ( 4660.53 ms per run)
whisper_print_timings:   decode time =    15.92 ms /     2 runs (    7.96 ms per run)
whisper_print_timings:   batchd time =   708.44 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5576.48 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.238000 sec.)
...
main:      load time =  5558.27 ms
main:    sample time =   518.55 ms / 8.10 ms per token
main:      eval time = 43568.37 ms / 622.41 ms per token
main:     total time = 52018.75 ms
...
main:      load time =  1581.90 ms
main:    sample time =   518.85 ms / 8.11 ms per token
main:      eval time = 17568.77 ms / 250.98 ms per token
main:     total time = 20663.01 ms
