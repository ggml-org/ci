...
- status:  SUCCESS ✅
- runtime: 3:36.46
- date:    Sat Dec 23 04:26:13 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.11 sec
...
19/19 Test #19: test-backend-ops .................   Passed   42.92 sec
...
main:  predict time =   845.02 ms / 13.20 ms per token
main:    total time =  1076.25 ms
...
main:     n_decoded =      504
main:     load time =   166.68 ms
main:   sample time =   129.47 ms
main:  predict time =  6065.94 ms
main:    total time =  6444.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e7ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e66b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2f6db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e7ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e7ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac2f6e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e66b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2f6db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac2f6f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac2f6e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e7ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac2f6fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac2f6f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac2f70580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e7ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac2f6fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac2f70740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac2f70580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e7ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac2f70900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac2f70740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.96 ms
whisper_print_timings:   sample time =    67.37 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4725.12 ms /     1 runs ( 4725.12 ms per run)
whisper_print_timings:   decode time =    16.22 ms /     2 runs (    8.11 ms per run)
whisper_print_timings:   batchd time =   835.15 ms /   125 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5778.68 ms
...
main:     load time =   100.98 ms
main:    total time = 40451.38 ms
embd_img
