...
- status:  SUCCESS ✅
- runtime: 2:49.60
- date:    Sat Dec 23 16:24:34 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.76 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.07 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.83 sec
...
main:     load time =   125.87 ms
main:   sample time =    23.52 ms
main:  predict time =   628.87 ms / 9.83 ms per token
main:    total time =   790.95 ms
...
main:  predict time =   661.67 ms / 9.45 ms per token
...
main:     n_decoded =      504
main:     load time =   105.77 ms
main:   sample time =   177.99 ms
main:  predict time =  2381.21 ms
main:    total time =  2710.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43a56e6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f43a55671a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5583340abb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43a56e6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43a56eb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5583340ac960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f43a55671a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5583340abb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5583340ad2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5583340ac960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43a56e6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5583340adc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5583340ad2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5583340ae580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43a56e6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5583340adc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5583340ae740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5583340ae580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43a56eb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5583340ae900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5583340ae740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.86 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.09 ms
whisper_print_timings:   sample time =    72.07 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2002.15 ms /     1 runs ( 2002.15 ms per run)
whisper_print_timings:   decode time =    13.04 ms /     2 runs (    6.52 ms per run)
whisper_print_timings:   batchd time =   327.20 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2515.69 ms
...
main:     load time =    71.56 ms
main:    total time = 18817.32 ms
embd_img
