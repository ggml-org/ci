...
- status:  SUCCESS ✅
- runtime: 2:48.73
- date:    Wed Dec 27 10:10:25 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.71 sec
...
main:  predict time =   606.17 ms / 9.47 ms per token
main:    total time =   772.87 ms
...
main:     load time =   128.46 ms
main:   sample time =    23.56 ms
main:  predict time =   629.41 ms / 8.99 ms per token
main:    total time =   783.65 ms
...
main:     n_decoded =      504
main:     load time =   106.04 ms
main:   sample time =   178.00 ms
main:  predict time =  2380.47 ms
main:    total time =  2709.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7f207fc990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7f2067d1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55de1819cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7f207fc030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7f20801940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55de1819d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7f2067d1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55de1819cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55de1819e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55de1819d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7f207fc030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55de1819ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55de1819e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55de1819f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7f207fc990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55de1819ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55de1819f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55de1819f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7f20801940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55de1819f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55de1819f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.44 ms
whisper_print_timings:   sample time =    72.13 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1989.24 ms /     1 runs ( 1989.24 ms per run)
whisper_print_timings:   decode time =    12.87 ms /     2 runs (    6.44 ms per run)
whisper_print_timings:   batchd time =   326.83 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.47 ms
