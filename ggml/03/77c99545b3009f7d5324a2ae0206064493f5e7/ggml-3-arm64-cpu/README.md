...
- status:  SUCCESS ✅
- runtime: 5:17.97
- date:    Wed Dec 27 10:21:54 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.29 sec
 ...
 8/19 Test  #8: test2 ............................   Passed    0.02 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.05 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed   34.69 sec
...
main:     load time =   263.90 ms
main:   sample time =    17.03 ms
main:  predict time =   814.61 ms / 12.73 ms per token
main:    total time =  1117.43 ms
...
main:     load time =   184.72 ms
main:   sample time =    17.16 ms
main:  predict time =   878.81 ms / 12.55 ms per token
main:    total time =  1083.68 ms
...
main:  predict time =  5875.69 ms
main:    total time =  6239.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa410a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa3f8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeec92b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa410a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa410f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeec93960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa3f8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeec92b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeec942c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeec93960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa410a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeec94c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeec942c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeec95580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa410a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeec94c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeec95740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeec95580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa410f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeec95900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeec95740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    65.73 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4653.97 ms /     1 runs ( 4653.97 ms per run)
whisper_print_timings:   decode time =    15.09 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   707.47 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5570.07 ms
...
main:     load time =    92.40 ms
main:    total time = 39573.06 ms
embd_img
...
main:      load time =  5663.79 ms
main:    sample time =   521.38 ms / 8.15 ms per token
main:      eval time = 43503.99 ms / 621.49 ms per token
main:     total time = 52063.77 ms
...
main:      load time =  1537.18 ms
main:    sample time =   512.49 ms / 8.01 ms per token
main:      eval time = 16930.43 ms / 241.86 ms per token
main:     total time = 19935.20 ms
