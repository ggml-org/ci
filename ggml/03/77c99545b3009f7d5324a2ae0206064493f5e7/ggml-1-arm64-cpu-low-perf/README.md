...
- status:  SUCCESS ✅
- runtime: 3:35.75
- date:    Wed Dec 27 10:11:14 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   43.02 sec
...
main:  predict time =   846.04 ms / 13.22 ms per token
main:    total time =  1078.76 ms
...
main:     n_decoded =      504
main:     load time =   167.38 ms
main:   sample time =   130.48 ms
main:  predict time =  6130.93 ms
main:    total time =  6510.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7e8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7d0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18366b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7e8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7e8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18367960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7d0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18366b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab183682c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18367960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7e8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18368c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab183682c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18369580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7e8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18368c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18369740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18369580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7e8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab18369900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18369740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.71 ms
whisper_print_timings:   sample time =    66.75 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4726.16 ms /     1 runs ( 4726.16 ms per run)
whisper_print_timings:   decode time =    15.60 ms /     2 runs (    7.80 ms per run)
whisper_print_timings:   batchd time =   843.35 ms /   125 runs (    6.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5783.15 ms
...
main:     load time =    98.46 ms
main:    total time = 40481.03 ms
embd_img
