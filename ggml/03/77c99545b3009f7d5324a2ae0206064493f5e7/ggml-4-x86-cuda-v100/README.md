...
- status:  SUCCESS ✅
- runtime: 7:38.56
- date:    Wed Dec 27 10:26:58 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    7.90 sec
      Start  6: test0
 6/19 Test  #6: test0 ............................   Passed    0.53 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.16 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   60.14 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/20 Test  #3: test-quantize-fns ................   Passed    0.59 sec
 ...
 8/20 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    7.92 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   25.05 sec
...
main:     load time =   581.77 ms
main:   sample time =    34.33 ms
main:  predict time =   550.35 ms / 8.60 ms per token
...
main:     load time =   560.15 ms
main:   sample time =    34.44 ms
main:  predict time =   586.96 ms / 8.39 ms per token
main:    total time =  1185.71 ms
...
main:     n_decoded =      504
main:     load time =   543.68 ms
main:   sample time =   234.85 ms
main:  predict time =  2227.75 ms
main:    total time =  3052.51 ms
...
main: loaded model in   395.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe961cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe961b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559c09e3cf90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe961cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe961cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559c09e3dd60                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe961b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559c09e3cf90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559c09e3e6c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559c09e3dd60                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe961cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559c09e3f020                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559c09e3e6c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559c09e3f980                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe961cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559c09e3f020                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559c09e3fb40                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559c09e3f980                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe961cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559c09e3fd00                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559c09e3fb40       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   525.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.58 ms
whisper_print_timings:   sample time =    66.45 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.30 ms /     1 runs (   34.30 ms per run)
whisper_print_timings:   decode time =    13.50 ms /     2 runs (    6.75 ms per run)
whisper_print_timings:   batchd time =    80.77 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   747.53 ms
...
main:     load time =   500.31 ms
main:    total time =  7911.01 ms
embd_img
...
main:      load time =  7266.93 ms
main:    sample time =   544.59 ms / 8.51 ms per token
main:      eval time = 24613.11 ms / 351.62 ms per token
main:     total time = 33313.19 ms
...
main:      load time =  2168.56 ms
main:    sample time =   547.23 ms / 8.55 ms per token
main:      eval time = 12111.65 ms / 173.02 ms per token
main:     total time = 15461.65 ms
