...
- status:  SUCCESS ✅
- runtime: 3:33.75
- date:    Wed Dec 27 10:11:14 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.54 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.44 sec
...
main:     load time =   205.51 ms
main:   sample time =    23.49 ms
main:  predict time =   439.42 ms / 6.87 ms per token
main:    total time =   681.23 ms
...
main:     load time =   121.90 ms
main:   sample time =    23.44 ms
main:  predict time =   453.39 ms / 6.48 ms per token
main:    total time =   600.81 ms
...
main:     n_decoded =      504
main:     load time =   100.91 ms
main:   sample time =   177.36 ms
main:  predict time =  1467.30 ms
main:    total time =  1777.91 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7657ae7990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f76579681a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b9a3b1bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7657ae7030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7657aec940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b9a3b1c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f76579681a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b9a3b1bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b9a3b1d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b9a3b1c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7657ae7030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b9a3b1dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b9a3b1d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b9a3b1e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7657ae7990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b9a3b1dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b9a3b1e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b9a3b1e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7657aec940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b9a3b1e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b9a3b1e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.20 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.07 ms
whisper_print_timings:   sample time =    54.32 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1152.76 ms /     1 runs ( 1152.76 ms per run)
whisper_print_timings:   decode time =     9.53 ms /     2 runs (    4.77 ms per run)
whisper_print_timings:   batchd time =   204.20 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1511.20 ms
...
main:     load time =    64.13 ms
main:    total time = 10576.08 ms
embd_img
...
main:      load time =  5356.31 ms
main:    sample time =   473.43 ms / 7.40 ms per token
main:      eval time = 20237.08 ms / 289.10 ms per token
main:     total time = 26757.52 ms
...
main:      load time =  1192.39 ms
main:    sample time =   465.70 ms / 7.28 ms per token
main:      eval time =  8092.52 ms / 115.61 ms per token
main:     total time = 10127.39 ms
