...
- status:  SUCCESS ✅
- runtime: 2:08.32
- date:    Sun Jun 16 08:53:42 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   30.00 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   16.01 sec
...
main:  predict time =   476.64 ms / 7.45 ms per token
main:    total time =   616.42 ms
...
main:  predict time =   496.21 ms / 7.09 ms per token
main:    total time =   625.60 ms
...
main:   sample time =    24.09 ms
main:  predict time =   505.43 ms / 7.22 ms per token
main:    total time =   655.77 ms
...
main:     n_decoded =      504
main:     load time =   101.95 ms
main:   sample time =   177.96 ms
main:  predict time =  1544.74 ms
main:    total time =  1857.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x706e96efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x706e96d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60226df7ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x706e96efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x706e96eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60226df7fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x706e96d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60226df7ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60226df80410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60226df7fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x706e96efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60226df80d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60226df80410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60226df816d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x706e96efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60226df80d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60226df81890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60226df816d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x706e96eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x60226df81a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60226df81890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    54.88 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1163.88 ms /     1 runs ( 1163.88 ms per run)
whisper_print_timings:   decode time =    11.21 ms /     2 runs (    5.60 ms per run)
whisper_print_timings:   batchd time =   218.52 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1549.88 ms
