...
- status:  SUCCESS ✅
- runtime: 4:03.55
- date:    Sun Jun 16 08:55:28 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/21 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.31 sec
      Start  9: test3
...
Total Test time (real) =  78.66 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.53 sec
      Start  2: test-quantize-fns
...
main:     load time =   145.46 ms
main:   sample time =    18.64 ms
main:  predict time =   895.16 ms / 13.99 ms per token
main:    total time =  1081.08 ms
...
main:   sample time =    21.46 ms
main:  predict time =   981.77 ms / 14.03 ms per token
main:    total time =  1157.79 ms
...
main:  predict time =   966.48 ms / 13.81 ms per token
main:    total time =  1167.68 ms
...
main:   sample time =   130.42 ms
main:  predict time =  6109.56 ms
main:    total time =  6473.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe98136aaa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe9813692b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xabfa32371ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe98136aaa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe98136aaf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xabfa32372ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe9813692b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xabfa32371ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xabfa32373410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xabfa32372ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe98136aaa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xabfa32373d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xabfa32373410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xabfa323746d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe98136aaa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xabfa32373d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xabfa32374890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xabfa323746d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe98136aaf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xabfa32374a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xabfa32374890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.12 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.44 ms
whisper_print_timings:   sample time =    68.29 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4698.93 ms /     1 runs ( 4698.93 ms per run)
whisper_print_timings:   decode time =    15.13 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   733.66 ms /   125 runs (    5.87 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5650.94 ms
...
main:     load time =    93.66 ms
main:    total time = 39966.83 ms
embd_img
