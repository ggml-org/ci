...
- status:  SUCCESS ✅
- runtime: 3:07.82
- date:    Sun Jun 16 08:54:29 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/0353410af6eb8a661b2c95f9d6b939cfad3ebae5
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.55 sec
 ...
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.66 sec
      Start  6: test0
...
Total Test time (real) =  55.27 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.48 sec
      Start  2: test-opt
 2/22 Test  #2: test-opt .........................   Passed    2.20 sec
      Start  3: test-quantize-fns
 3/22 Test  #3: test-quantize-fns ................   Passed   16.92 sec
      Start  4: test-quantize-perf
 4/22 Test  #4: test-quantize-perf ...............   Passed    4.78 sec
      Start  5: test-mul-mat0
 5/22 Test  #5: test-mul-mat0 ....................   Passed    0.56 sec
...
main:     load time =   151.15 ms
main:   sample time =    17.61 ms
main:  predict time =   863.88 ms / 13.50 ms per token
main:    total time =  1053.82 ms
...
main:     load time =   152.15 ms
main:   sample time =    19.48 ms
main:  predict time =   957.38 ms / 13.68 ms per token
main:    total time =  1132.75 ms
...
main:     load time =   180.95 ms
main:   sample time =    17.83 ms
main:  predict time =   942.92 ms / 13.47 ms per token
main:    total time =  1144.96 ms
...
main:     n_decoded =      504
main:     load time =   151.11 ms
main:   sample time =   133.57 ms
main:  predict time =  6072.27 ms
main:    total time =  6439.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe7094719a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe7094701b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc1e82e4a2ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe7094719a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe7094719f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc1e82e4a3ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe7094701b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc1e82e4a2ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc1e82e4a4410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc1e82e4a3ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe7094719a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc1e82e4a4d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc1e82e4a4410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc1e82e4a56d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe7094719a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc1e82e4a4d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc1e82e4a5890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc1e82e4a56d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe7094719f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc1e82e4a5a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc1e82e4a5890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    66.81 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4688.70 ms /     1 runs ( 4688.70 ms per run)
whisper_print_timings:   decode time =    14.85 ms /     2 runs (    7.42 ms per run)
whisper_print_timings:   batchd time =   729.14 ms /   125 runs (    5.83 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5636.92 ms
...
main:     load time =    89.04 ms
main:    total time = 39848.71 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.269000 sec.)
