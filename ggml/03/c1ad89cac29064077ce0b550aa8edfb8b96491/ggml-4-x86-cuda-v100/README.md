...
- status:  SUCCESS ✅
- runtime: 10:19.26
- date:    Mon Feb 12 07:56:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.75 sec
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    7.94 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.53 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.55 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.78 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  249.12 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 294.36 sec
...
17/21 Test #17: test-conv1d ......................   Passed    0.61 sec
...
21/21 Test #21: test-backend-ops .................   Passed   46.28 sec
...
main:     load time =   552.45 ms
main:   sample time =    34.76 ms
main:  predict time =   587.25 ms / 9.18 ms per token
main:    total time =  1197.39 ms
...
main:     load time =   543.59 ms
main:   sample time =    37.17 ms
main:  predict time =   634.19 ms / 9.06 ms per token
main:    total time =  1218.64 ms
...
main:     load time =   561.12 ms
main:   sample time =    34.01 ms
main:  predict time =   614.81 ms / 8.78 ms per token
main:    total time =  1214.45 ms
...
main:     n_decoded =      504
main:     load time =   552.17 ms
main:   sample time =   231.67 ms
main:  predict time =  2372.59 ms
main:    total time =  3201.57 ms
...
main: loaded model in   402.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8d27b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc8d26371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e87e6475d0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8d27b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8d27bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e87e6483a0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc8d26371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e87e6475d0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e87e648d00                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e87e6483a0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8d27b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e87e649660                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e87e648d00                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e87e649fc0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8d27b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e87e649660                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e87e64a180                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e87e649fc0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8d27bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e87e64a340                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e87e64a180       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   523.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.38 ms
whisper_print_timings:   sample time =    66.86 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    28.25 ms /     1 runs (   28.25 ms per run)
whisper_print_timings:   decode time =    21.06 ms /     2 runs (   10.53 ms per run)
whisper_print_timings:   batchd time =    82.30 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   748.41 ms
...
main:     load time =   509.17 ms
main:    total time =  7962.97 ms
embd_img
