...
- status:  SUCCESS ✅
- runtime: 4:55.59
- date:    Mon Feb 12 07:49:44 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  143.17 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 156.54 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.92 sec
...
main:  predict time =   840.42 ms / 13.13 ms per token
main:    total time =  1029.97 ms
...
main:     load time =   152.59 ms
main:   sample time =    17.18 ms
main:  predict time =   912.67 ms / 13.04 ms per token
main:    total time =  1085.22 ms
...
main:     load time =   180.61 ms
main:   sample time =    17.10 ms
main:  predict time =   933.57 ms / 13.34 ms per token
main:    total time =  1134.47 ms
...
main:  predict time =  5991.74 ms
main:    total time =  6352.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8304a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82ecb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad7456b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8304a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8304f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad7457960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82ecb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad7456b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad74582c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad7457960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8304a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad7458c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad74582c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad7459580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8304a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad7458c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad7459740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad7459580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8304f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad7459900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad7459740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.08 ms
whisper_print_timings:   sample time =    65.21 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4686.54 ms /     1 runs ( 4686.54 ms per run)
whisper_print_timings:   decode time =    14.45 ms /     2 runs (    7.23 ms per run)
whisper_print_timings:   batchd time =   714.27 ms /   125 runs (    5.71 ms per run)
