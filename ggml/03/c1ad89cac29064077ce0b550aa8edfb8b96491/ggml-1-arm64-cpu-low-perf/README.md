...
- status:  SUCCESS ✅
- runtime: 5:54.28
- date:    Mon Feb 12 07:42:21 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  153.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.49 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.22 sec
...
main:  predict time =   853.79 ms / 13.34 ms per token
main:    total time =  1052.38 ms
...
main:     load time =   163.08 ms
main:   sample time =    17.64 ms
main:  predict time =   949.41 ms / 13.56 ms per token
main:    total time =  1133.02 ms
...
main:     load time =   191.63 ms
main:   sample time =    17.41 ms
main:  predict time =   947.22 ms / 13.53 ms per token
main:    total time =  1159.45 ms
...
main:     n_decoded =      504
main:     load time =   162.67 ms
main:   sample time =   128.78 ms
main:  predict time =  6144.10 ms
main:    total time =  6517.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff99cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3568b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff99cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff99cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3569960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3568b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae356a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3569960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff99cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae356ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae356a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae356b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff99cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae356ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae356b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae356b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff99cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae356b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae356b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4686.59 ms /     1 runs ( 4686.59 ms per run)
whisper_print_timings:   decode time =    15.10 ms /     2 runs (    7.55 ms per run)
whisper_print_timings:   batchd time =   736.59 ms /   125 runs (    5.89 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5633.90 ms
