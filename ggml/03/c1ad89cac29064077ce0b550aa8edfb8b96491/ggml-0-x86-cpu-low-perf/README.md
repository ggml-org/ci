...
- status:  SUCCESS ✅
- runtime: 4:31.29
- date:    Mon Feb 12 07:39:56 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/03c1ad89cac29064077ce0b550aa8edfb8b96491
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   23.72 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  107.67 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 144.88 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.58 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   23.96 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.73 sec
...
main:     load time =   110.33 ms
main:   sample time =    23.81 ms
main:  predict time =   632.64 ms / 9.88 ms per token
main:    total time =   779.42 ms
...
main:  predict time =   679.68 ms / 9.71 ms per token
main:    total time =   815.00 ms
...
main:     load time =   130.19 ms
main:   sample time =    23.54 ms
main:  predict time =   669.95 ms / 9.57 ms per token
main:    total time =   826.24 ms
...
main:     n_decoded =      504
main:     load time =   107.65 ms
main:   sample time =   178.05 ms
main:  predict time =  2521.10 ms
main:    total time =  2852.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faec0ea7990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faec0d281a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ae03540b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faec0ea7030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7faec0eac940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ae03541960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faec0d281a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ae03540b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ae035422c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ae03541960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faec0ea7030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ae03542c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ae035422c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ae03543580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faec0ea7990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ae03542c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ae03543740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ae03543580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7faec0eac940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55ae03543900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ae03543740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.47 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.95 ms
whisper_print_timings:   sample time =    72.21 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2025.93 ms /     1 runs ( 2025.93 ms per run)
whisper_print_timings:   decode time =    13.13 ms /     2 runs (    6.56 ms per run)
whisper_print_timings:   batchd time =   329.32 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2542.57 ms
...
main:     load time =    68.68 ms
main:    total time = 19191.04 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.469000 sec.)
