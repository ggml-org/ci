...
- status:  SUCCESS ✅
- runtime: 3:21.51
- date:    Mon Feb 12 07:40:27 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  113.23 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.72 sec
...
main:  predict time =   469.01 ms / 7.33 ms per token
main:    total time =   614.12 ms
...
main:  predict time =   481.18 ms / 6.87 ms per token
main:    total time =   617.11 ms
...
main:  predict time =   480.05 ms / 6.86 ms per token
main:    total time =   637.48 ms
...
main:  predict time =  1539.05 ms
main:    total time =  1856.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f09cc794990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f09cc6151a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d4c94a0b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f09cc794030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f09cc799940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d4c94a1960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f09cc6151a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d4c94a0b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d4c94a22c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d4c94a1960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f09cc794030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d4c94a2c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d4c94a22c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d4c94a3580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f09cc794990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d4c94a2c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d4c94a3740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d4c94a3580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f09cc799940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d4c94a3900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d4c94a3740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.28 ms
whisper_print_timings:   sample time =    54.53 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1176.41 ms /     1 runs ( 1176.41 ms per run)
whisper_print_timings:   decode time =    10.49 ms /     2 runs (    5.25 ms per run)
whisper_print_timings:   batchd time =   216.57 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1551.79 ms
