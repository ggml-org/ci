...
- status:  SUCCESS ✅
- runtime: 3:04.90
- date:    Fri Nov 17 08:03:31 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.34 sec
...
main:  predict time =   449.42 ms / 6.42 ms per token
main:    total time =   604.24 ms
...
main:   sample time =   175.11 ms
main:  predict time =  1446.37 ms
main:    total time =  1754.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f41e4c02960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f41e4a83190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556fb2abeb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f41e4c02010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f41e4c07900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556fb2abf940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f41e4a83190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556fb2abeb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556fb2ac0290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556fb2abf940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f41e4c02010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556fb2ac0be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556fb2ac0290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556fb2ac1530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f41e4c02960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556fb2ac0be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556fb2ac16e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556fb2ac1530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f41e4c07900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556fb2ac1890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556fb2ac16e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    53.41 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1135.04 ms /     1 runs ( 1135.04 ms per run)
whisper_print_timings:   decode time =     9.60 ms /     2 runs (    4.80 ms per run)
whisper_print_timings:   batchd time =   201.74 ms /   125 runs (    1.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1544.02 ms
...
main:     load time =    61.45 ms
main:    total time = 10496.68 ms
embd_img
...
main:      load time =  6348.13 ms
main:    sample time =   467.22 ms / 7.30 ms per token
main:      eval time = 20257.91 ms / 289.40 ms per token
main:     total time = 27796.36 ms
...
main:      load time =  2055.54 ms
main:    sample time =   492.80 ms / 7.70 ms per token
main:      eval time =  8777.50 ms / 125.39 ms per token
main:     total time = 11677.60 ms
