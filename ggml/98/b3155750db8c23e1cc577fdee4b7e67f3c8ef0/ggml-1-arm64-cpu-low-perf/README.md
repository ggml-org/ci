...
- status:  SUCCESS ✅
- runtime: 2:38.81
- date:    Fri Nov 17 08:03:02 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.23 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.67 sec
      Start  6: test0
 6/17 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.68 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.19 sec
      Start  2: test-quantize-fns
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    9.00 sec
      Start  9: test3
...
main:     load time =   187.36 ms
main:   sample time =    18.31 ms
main:  predict time =   823.81 ms / 12.87 ms per token
main:    total time =  1051.42 ms
...
main:  predict time =  1035.76 ms / 14.80 ms per token
main:    total time =  1246.82 ms
...
main:   sample time =   130.48 ms
main:  predict time =  5992.82 ms
main:    total time =  6364.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e45a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e2db190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2da0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e45a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e45f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad2da1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e2db190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2da0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad2da2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad2da1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e45a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad2da2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad2da2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad2da3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e45a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad2da2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad2da36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad2da3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e45f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad2da3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad2da36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.76 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    65.83 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4778.88 ms /     1 runs ( 4778.88 ms per run)
whisper_print_timings:   decode time =    16.19 ms /     2 runs (    8.10 ms per run)
whisper_print_timings:   batchd time =   715.57 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5711.00 ms
