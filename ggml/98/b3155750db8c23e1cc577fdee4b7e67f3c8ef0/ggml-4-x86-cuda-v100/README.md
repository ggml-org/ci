...
- status:  SUCCESS ✅
- runtime: 7:51.02
- date:    Fri Nov 17 08:08:16 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    6.54 sec
 ...
 6/17 Test  #6: test0 ............................   Passed    0.52 sec
      Start  7: test1
 7/17 Test  #7: test1 ............................   Passed    0.56 sec
      Start  8: test2
...
13/17 Test #13: test-customop ....................   Passed    0.55 sec
      Start 14: test-xpos
14/17 Test #14: test-xpos ........................   Passed    0.56 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    6.44 sec
      Start  2: test-opt
 ...
 6/18 Test  #6: test-mul-mat2 ....................   Passed    3.27 sec
      Start  7: test0
 7/18 Test  #7: test0 ............................   Passed    0.55 sec
      Start  8: test1
 8/18 Test  #8: test1 ............................   Passed    0.51 sec
      Start  9: test2
...
17/18 Test #17: test-conv2d ......................   Passed    0.58 sec
...
main:     load time =  1582.25 ms
main:   sample time =    34.52 ms
main:  predict time =   546.85 ms / 8.54 ms per token
main:    total time =  2183.06 ms
...
main:     load time =   563.49 ms
main:   sample time =    33.79 ms
main:  predict time =   585.24 ms / 8.36 ms per token
...
main:     n_decoded =      504
main:     load time =   535.99 ms
main:   sample time =   233.38 ms
main:  predict time =  2150.21 ms
main:    total time =  2962.89 ms
...
main: loaded model in   413.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0c185b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0c18437190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562ebf07ea60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0c185b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0c185bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562ebf07f820                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0c18437190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562ebf07ea60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562ebf080170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562ebf07f820                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0c185b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562ebf080ac0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562ebf080170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562ebf081410                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0c185b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562ebf080ac0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x562ebf0815c0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562ebf081410                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0c185bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x562ebf081770                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x562ebf0815c0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1053.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.81 ms
whisper_print_timings:   sample time =    73.39 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =   493.55 ms /     1 runs (  493.55 ms per run)
whisper_print_timings:   decode time =    14.21 ms /     2 runs (    7.11 ms per run)
whisper_print_timings:   batchd time =   317.68 ms /   125 runs (    2.54 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1975.84 ms
...
main:     load time =   485.02 ms
main:    total time =  7611.96 ms
embd_img
...
main:      load time = 39290.54 ms
main:    sample time =   516.47 ms / 8.07 ms per token
main:      eval time = 24909.26 ms / 355.85 ms per token
main:     total time = 65615.62 ms
...
main:      load time = 17863.50 ms
main:    sample time =   511.38 ms / 7.99 ms per token
main:      eval time = 12304.14 ms / 175.77 ms per token
main:     total time = 31349.25 ms
