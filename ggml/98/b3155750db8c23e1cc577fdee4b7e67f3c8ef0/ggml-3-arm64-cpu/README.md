...
- status:  SUCCESS ✅
- runtime: 4:45.86
- date:    Fri Nov 17 08:05:11 AM UTC 2023
...
main:  predict time =   811.70 ms / 12.68 ms per token
main:    total time =  1039.30 ms
...
main:  predict time =   883.46 ms / 12.62 ms per token
main:    total time =  1078.23 ms
...
main:  predict time =  5828.91 ms
main:    total time =  6179.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8218a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8200b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae4a13b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8218a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8218f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae4a14940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8200b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae4a13b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae4a15290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae4a14940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8218a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae4a15be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae4a15290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae4a16530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8218a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae4a15be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae4a166e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae4a16530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8218f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae4a16890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae4a166e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   194.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.10 ms
whisper_print_timings:   sample time =    65.07 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4637.47 ms /     1 runs ( 4637.47 ms per run)
whisper_print_timings:   decode time =    15.93 ms /     2 runs (    7.96 ms per run)
whisper_print_timings:   batchd time =   714.49 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5644.73 ms
...
main:     load time =    81.47 ms
main:    total time = 39366.34 ms
embd_img
...
main:      load time =  7411.25 ms
main:    sample time =   529.35 ms / 8.27 ms per token
main:      eval time = 43630.41 ms / 623.29 ms per token
main:     total time = 53943.74 ms
...
main:      load time =  1508.90 ms
main:    sample time =   526.04 ms / 8.22 ms per token
main:      eval time = 17531.66 ms / 250.45 ms per token
main:     total time = 20537.56 ms
