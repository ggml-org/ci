...
- status:  SUCCESS ✅
- runtime: 2:10.34
- date:    Tue Apr  9 17:30:56 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/98875cdb7e9ceeb726d1c196d2fecb3cbb59b93a
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.30 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.41 sec
      Start  2: test-opt
...
main:     load time =   104.60 ms
main:   sample time =    23.80 ms
main:  predict time =   491.41 ms / 7.68 ms per token
main:    total time =   632.20 ms
...
main:  predict time =   515.62 ms / 7.37 ms per token
main:    total time =   644.73 ms
...
main:     load time =   123.41 ms
main:   sample time =    23.72 ms
main:  predict time =   533.26 ms / 7.62 ms per token
main:    total time =   683.27 ms
...
main:     n_decoded =      504
main:     load time =   102.75 ms
main:   sample time =   177.45 ms
main:  predict time =  1866.48 ms
main:    total time =  2178.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f36b3e9e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f36b3d1f1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5631c4475ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f36b3e9e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f36b3ea3940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5631c4476ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f36b3d1f1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5631c4475ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5631c4477410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5631c4476ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f36b3e9e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5631c4477d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5631c4477410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5631c44786d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f36b3e9e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5631c4477d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5631c4478890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5631c44786d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f36b3ea3940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5631c4478a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5631c4478890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.09 ms
whisper_print_timings:   sample time =   442.59 ms /   131 runs (    3.38 ms per run)
whisper_print_timings:   encode time =  1192.24 ms /     1 runs ( 1192.24 ms per run)
whisper_print_timings:   decode time =    12.42 ms /     2 runs (    6.21 ms per run)
whisper_print_timings:   batchd time =   217.34 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1960.83 ms
...
main:     load time =    64.88 ms
main:    total time = 10680.73 ms
embd_img
