...
- status:  SUCCESS ✅
- runtime: 3:31.66
- date:    Tue Apr  9 17:32:23 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.05 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.26 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.50 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.49 sec
      Start  2: test-quantize-fns
...
main:  predict time =   701.62 ms / 10.96 ms per token
main:    total time =   846.57 ms
...
main:  predict time =   736.43 ms / 10.52 ms per token
...
main:  predict time =   775.81 ms / 11.08 ms per token
main:    total time =   927.87 ms
...
main:  predict time =  3107.07 ms
main:    total time =  3435.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7fdf418990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7fdf2991a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e0d7532ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7fdf418030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7fdf41d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e0d7533ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7fdf2991a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e0d7532ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e0d7534410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e0d7533ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7fdf418030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e0d7534d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e0d7534410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e0d75356d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7fdf418990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e0d7534d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e0d7535890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e0d75356d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7fdf41d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e0d7535a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e0d7535890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.00 ms
whisper_print_timings:   sample time =   656.70 ms /   131 runs (    5.01 ms per run)
whisper_print_timings:   encode time =  2076.45 ms /     1 runs ( 2076.45 ms per run)
whisper_print_timings:   decode time =    16.68 ms /     2 runs (    8.34 ms per run)
whisper_print_timings:   batchd time =   333.15 ms /   125 runs (    2.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  3188.33 ms
...
main:     load time =    70.99 ms
main:    total time = 19465.14 ms
embd_img
