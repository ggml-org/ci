...
- status:  SUCCESS ✅
- runtime: 3:11.16
- date:    Tue Apr  9 17:32:08 UTC 2024
...
main:  predict time =   895.58 ms / 13.99 ms per token
main:    total time =  1087.46 ms
...
main:  predict time =  1016.01 ms / 14.51 ms per token
main:    total time =  1189.95 ms
...
main:     load time =   181.46 ms
main:   sample time =    17.54 ms
main:  predict time =   993.11 ms / 14.19 ms per token
main:    total time =  1195.66 ms
...
main:   sample time =   129.28 ms
main:  predict time =  6431.22 ms
main:    total time =  6794.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9bea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9a6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3e92ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9bea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9bef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3e93ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9a6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3e92ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3e94410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae3e93ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9bea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3e94d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae3e94410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3e956d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9bea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae3e94d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3e95890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae3e956d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9bef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae3e95a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae3e95890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.98 ms
whisper_print_timings:   sample time =   749.70 ms /   131 runs (    5.72 ms per run)
whisper_print_timings:   encode time =  4672.25 ms /     1 runs ( 4672.25 ms per run)
whisper_print_timings:   decode time =    14.41 ms /     2 runs (    7.20 ms per run)
whisper_print_timings:   batchd time =   710.17 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6270.37 ms
