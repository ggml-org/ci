...
- status:  SUCCESS ✅
- runtime: 4:08.01
- date:    Tue Apr  9 05:32:57 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   33.36 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.95 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.59 sec
      Start  9: test3
...
main:     load time =   166.15 ms
main:   sample time =    18.07 ms
main:  predict time =   986.00 ms / 14.09 ms per token
main:    total time =  1173.13 ms
...
main:     load time =   198.51 ms
main:   sample time =    17.69 ms
main:  predict time =  1040.45 ms / 14.86 ms per token
main:    total time =  1260.27 ms
...
main:     n_decoded =      504
main:     load time =   163.00 ms
main:   sample time =   129.11 ms
main:  predict time =  6454.97 ms
main:    total time =  6829.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb15da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb145b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf62c0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb15da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb15df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf62c1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb145b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf62c0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf62c2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf62c1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb15da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf62c2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf62c2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf62c36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb15da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf62c2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf62c3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf62c36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb15df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf62c3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf62c3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.21 ms
whisper_print_timings:   sample time =   751.08 ms /   131 runs (    5.73 ms per run)
whisper_print_timings:   encode time =  4716.05 ms /     1 runs ( 4716.05 ms per run)
...
whisper_print_timings:    total time =  6330.90 ms
...
main:     load time =    97.37 ms
main:    total time = 39999.71 ms
embd_img
