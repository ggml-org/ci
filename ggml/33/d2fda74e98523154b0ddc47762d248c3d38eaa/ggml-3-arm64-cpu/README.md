...
- status:  SUCCESS ✅
- runtime: 5:05.38
- date:    Tue Dec  5 01:23:07 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   30.82 sec
...
main:     load time =   184.57 ms
main:   sample time =    17.03 ms
main:  predict time =   818.18 ms / 12.78 ms per token
main:    total time =  1041.41 ms
...
main:     load time =   185.11 ms
main:   sample time =    16.94 ms
main:  predict time =   878.33 ms / 12.55 ms per token
main:    total time =  1083.37 ms
...
main:  predict time =  5854.96 ms
main:    total time =  6215.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9488a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9470b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed6ffb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9488a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9488f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaed700940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9470b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed6ffb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaed701290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaed700940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9488a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaed701be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaed701290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaed702530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9488a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaed701be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaed7026e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaed702530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9488f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaed702890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaed7026e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4649.79 ms /     1 runs ( 4649.79 ms per run)
...
whisper_print_timings:    total time =  5575.17 ms
...
main:      load time =  5656.91 ms
main:    sample time =   535.36 ms / 8.37 ms per token
main:      eval time = 43600.32 ms / 622.86 ms per token
main:     total time = 52165.13 ms
...
main:      load time =  1601.59 ms
main:    sample time =   530.71 ms / 8.29 ms per token
main:      eval time = 17501.71 ms / 250.02 ms per token
main:     total time = 20604.73 ms
