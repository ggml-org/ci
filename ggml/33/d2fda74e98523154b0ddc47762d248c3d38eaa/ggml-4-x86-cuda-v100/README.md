...
- status:  SUCCESS ✅
- runtime: 7:01.57
- date:    Tue Dec  5 13:25:08 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.85 sec
      Start  2: test-quantize-fns
 2/19 Test  #2: test-quantize-fns ................   Passed    0.58 sec
 ...
 9/19 Test  #9: test3 ............................   Passed    1.12 sec
      Start 10: test-pool
10/19 Test #10: test-pool ........................   Passed    0.57 sec
...
19/19 Test #19: test-backend-ops .................   Passed   49.92 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    6.71 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.53 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.94 sec
...
main:     load time =   482.67 ms
main:   sample time =    34.33 ms
main:  predict time =   559.70 ms / 8.75 ms per token
main:    total time =  1096.62 ms
...
main:     load time =   468.16 ms
main:   sample time =    34.00 ms
main:  predict time =   567.38 ms / 8.11 ms per token
main:    total time =  1073.72 ms
...
main:     n_decoded =      504
main:     load time =   442.28 ms
main:   sample time =   236.98 ms
main:  predict time =  2228.05 ms
main:    total time =  2951.09 ms
...
main: loaded model in   300.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe285cfa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe285b7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56538840a5c0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe285cfa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe285cff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56538840b380                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe285b7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56538840a5c0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56538840bcd0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56538840b380                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe285cfa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56538840c620                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56538840bcd0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56538840cf70                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe285cfa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56538840c620                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56538840d120                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56538840cf70                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe285cff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56538840d2d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56538840d120       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   421.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.91 ms
whisper_print_timings:   sample time =    66.86 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    32.48 ms /     1 runs (   32.48 ms per run)
whisper_print_timings:   decode time =    13.23 ms /     2 runs (    6.61 ms per run)
whisper_print_timings:   batchd time =    80.56 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   641.01 ms
...
main:     load time =   407.36 ms
main:    total time =  7564.81 ms
embd_img
...
main:      load time =  6705.56 ms
main:    sample time =   521.25 ms / 8.14 ms per token
main:      eval time = 23602.24 ms / 337.17 ms per token
main:     total time = 31688.82 ms
...
main:      load time =  1977.40 ms
main:    sample time =   529.16 ms / 8.27 ms per token
main:      eval time = 12609.08 ms / 180.13 ms per token
main:     total time = 15761.86 ms
