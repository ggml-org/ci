...
- status:  SUCCESS ✅
- runtime: 3:08.63
- date:    Tue Dec  5 13:20:59 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/33d2fda74e98523154b0ddc47762d248c3d38eaa
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.39 sec
...
19/19 Test #19: test-backend-ops .................   Passed   19.65 sec
...
20/20 Test #20: test-backend-ops .................   Passed    3.13 sec
...
main:     load time =   122.45 ms
main:   sample time =    23.43 ms
main:  predict time =   434.61 ms / 6.79 ms per token
main:    total time =   592.97 ms
...
main:  predict time =   449.38 ms / 6.42 ms per token
main:    total time =   598.82 ms
...
main:     n_decoded =      504
main:     load time =    99.79 ms
main:   sample time =   177.85 ms
main:  predict time =  1457.75 ms
main:    total time =  1766.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff49d147960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff49cfc8190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c897c99b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff49d147010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff49d14c900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c897c9a940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff49cfc8190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c897c99b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c897c9b290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c897c9a940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff49d147010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c897c9bbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c897c9b290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c897c9c530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff49d147960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c897c9bbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c897c9c6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c897c9c530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff49d14c900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c897c9c890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c897c9c6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.57 ms
whisper_print_timings:   sample time =    54.68 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1147.00 ms /     1 runs ( 1147.00 ms per run)
whisper_print_timings:   decode time =     9.79 ms /     2 runs (    4.90 ms per run)
whisper_print_timings:   batchd time =   210.38 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1512.56 ms
...
main:      load time =  4296.94 ms
main:    sample time =   466.69 ms / 7.29 ms per token
main:      eval time = 19181.02 ms / 274.01 ms per token
main:     total time = 24578.69 ms
...
main:      load time =  1243.40 ms
main:    sample time =   466.89 ms / 7.30 ms per token
main:      eval time =  8062.90 ms / 115.18 ms per token
main:     total time = 10145.58 ms
