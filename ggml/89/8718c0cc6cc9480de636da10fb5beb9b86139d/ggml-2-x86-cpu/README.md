...
- status:  SUCCESS ✅
- runtime: 2:48.24
- date:    Thu Oct 12 08:10:37 UTC 2023
...
main:     load time =   215.65 ms
main:   sample time =    24.13 ms
main:  predict time =   480.41 ms / 7.51 ms per token
main:    total time =   733.79 ms
...
main:     load time =   116.28 ms
main:   sample time =    23.92 ms
main:  predict time =   487.32 ms / 6.96 ms per token
main:    total time =   630.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd7fa676900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd7fa4f7170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5562f2259ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd7fa675fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd7fa67b880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5562f225a870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd7fa4f7170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5562f2259ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5562f225b1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5562f225a870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd7fa675fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5562f225bad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5562f225b1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5562f225c400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd7fa676900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5562f225bad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5562f225c590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5562f225c400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd7fa67b880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5562f225c720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5562f225c590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   141.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.38 ms
whisper_print_timings:   sample time =    16.56 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1193.17 ms /     1 runs ( 1193.17 ms per run)
whisper_print_timings:   decode time =   104.53 ms /    27 runs (    3.87 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1516.49 ms
```
### mpt
...
main:      load time =  5749.79 ms
main:    sample time =   463.18 ms / 7.24 ms per token
main:      eval time = 21961.97 ms / 313.74 ms per token
main:     total time = 28865.10 ms
...
main:      load time =  1285.62 ms
main:    sample time =   461.54 ms / 7.21 ms per token
main:      eval time =  9309.46 ms / 132.99 ms per token
main:     total time = 11451.46 ms
