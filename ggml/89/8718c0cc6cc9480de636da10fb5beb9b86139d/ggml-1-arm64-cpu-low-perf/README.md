...
- status:  SUCCESS ✅
- runtime: 1:40.79
- date:    Thu Oct 12 08:09:17 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.48 sec
      Start  6: test0
 6/14 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.08 sec
      Start  9: test3
...
main:  predict time =   830.55 ms / 12.98 ms per token
main:    total time =  1016.91 ms
...
main:  predict time =   896.87 ms / 12.81 ms per token
main:    total time =  1062.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f62a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f4ab170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1495dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f629fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f62f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1495e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f4ab170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1495dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1495f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1495e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f629fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1495fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1495f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab14960400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f62a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1495fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab14960590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab14960400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f62f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab14960720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab14960590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    20.91 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4775.25 ms /     1 runs ( 4775.25 ms per run)
whisper_print_timings:   decode time =   185.63 ms /    27 runs (    6.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5170.56 ms
```
