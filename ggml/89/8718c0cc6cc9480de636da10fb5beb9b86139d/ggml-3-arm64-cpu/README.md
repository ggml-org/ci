...
- status:  SUCCESS ✅
- runtime: 3:44.07
- date:    Thu Oct 12 08:11:34 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.87 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.02 sec
      Start  4: test-mul-mat0
 4/14 Test  #4: test-mul-mat0 ....................   Passed    0.58 sec
      Start  5: test-mul-mat2
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.56 sec
      Start  6: test0
...
main:     load time =   204.09 ms
main:   sample time =    16.76 ms
main:  predict time =   800.24 ms / 12.50 ms per token
main:    total time =  1044.04 ms
...
main:     load time =   147.38 ms
main:   sample time =    16.90 ms
main:  predict time =   867.68 ms / 12.40 ms per token
main:    total time =  1035.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa8aaa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa892b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad95abad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa8aa9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa8aaf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad95ac870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa892b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad95abad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad95ad1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad95ac870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa8aa9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad95adad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad95ad1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad95ae400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa8aaa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad95adad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad95ae590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad95ae400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa8aaf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad95ae720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad95ae590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   215.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    20.90 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4602.79 ms /     1 runs ( 4602.79 ms per run)
whisper_print_timings:   decode time =   179.95 ms /    27 runs (    6.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5088.37 ms
```
### mpt
...
main:      load time =  5570.70 ms
main:    sample time =   519.29 ms / 8.11 ms per token
main:      eval time = 43680.33 ms / 624.00 ms per token
main:     total time = 52146.17 ms
...
main:      load time =  1517.39 ms
main:    sample time =   518.84 ms / 8.11 ms per token
main:      eval time = 17392.28 ms / 248.46 ms per token
main:     total time = 20392.03 ms
