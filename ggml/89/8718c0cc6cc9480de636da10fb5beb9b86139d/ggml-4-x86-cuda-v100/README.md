...
- status:  SUCCESS ✅
- runtime: 5:03.01
- date:    Thu Oct 12 08:12:40 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.49 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.91 sec
      Start  2: test-opt
...
main:     load time =   288.02 ms
main:   sample time =    34.52 ms
main:  predict time =   548.03 ms / 8.56 ms per token
...
main:  predict time =   639.47 ms / 9.14 ms per token
main:    total time =   834.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc6569a7900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc656828170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ef42de6ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc6569a6fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc6569ac880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ef42de7870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc656828170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ef42de6ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ef42de81a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ef42de7870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc6569a6fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ef42de8ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ef42de81a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ef42de9400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc6569a7900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ef42de8ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ef42de9590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ef42de9400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc6569ac880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55ef42de9720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ef42de9590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   606.17 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.56 ms
whisper_print_timings:   sample time =    20.25 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1870.90 ms /     1 runs ( 1870.90 ms per run)
whisper_print_timings:   decode time =   140.85 ms /    27 runs (    5.22 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2723.09 ms
```
### mpt
...
main:      load time = 16861.68 ms
main:    sample time =   584.05 ms / 9.13 ms per token
main:      eval time = 24815.51 ms / 354.51 ms per token
main:     total time = 43145.00 ms
...
main:      load time =  7842.10 ms
main:    sample time =   580.44 ms / 9.07 ms per token
main:      eval time = 12234.46 ms / 174.78 ms per token
main:     total time = 21281.83 ms
