...
- status:  SUCCESS ✅
- runtime: 4:39.84
- date:    Tue Aug 22 08:53:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.26 sec
      Start  2: test-opt
...
main:     load time =   190.01 ms
main:   sample time =    36.76 ms
main:  predict time =   531.06 ms / 8.30 ms per token
main:    total time =   807.49 ms
...
main:  predict time =   544.83 ms / 7.78 ms per token
main:    total time =   808.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa01a3248a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa01a1a5150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560320325ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa01a323f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa01a329800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560320326830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa01a1a5150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560320325ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560320327140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560320326830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa01a323f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560320327a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560320327140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560320328360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa01a3248a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560320327a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5603203284d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560320328360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa01a329800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560320328640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5603203284d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6330.87 ms
main:    sample time =   574.77 ms / 8.98 ms per token
main:      eval time = 23579.24 ms / 336.85 ms per token
main:     total time = 31333.43 ms
...
main:      load time =  1715.25 ms
main:    sample time =   582.95 ms / 9.11 ms per token
main:      eval time = 12036.21 ms / 171.95 ms per token
main:     total time = 14973.80 ms
