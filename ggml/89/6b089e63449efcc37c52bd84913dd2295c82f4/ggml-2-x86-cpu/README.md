...
- status:  SUCCESS ✅
- runtime: 2:19.76
- date:    Tue Aug 22 08:47:45 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/896b089e63449efcc37c52bd84913dd2295c82f4
- author:  Jan Ploski
```
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.52 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.35 sec
      Start  3: test-quantize-fns
 3/15 Test  #3: test-quantize-fns ................   Passed    0.00 sec
      Start  4: test-quantize-perf
 4/15 Test  #4: test-quantize-perf ...............   Passed    0.01 sec
      Start  5: test-mul-mat0
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.51 sec
...
main:  predict time =   419.71 ms / 6.56 ms per token
main:    total time =   602.81 ms
...
main:   sample time =    23.35 ms
main:  predict time =   429.19 ms / 6.13 ms per token
main:    total time =   603.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fab27ba98a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fab27a2a150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557fc06a6ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fab27ba8f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fab27bae800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557fc06a7830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fab27a2a150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557fc06a6ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557fc06a8140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557fc06a7830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fab27ba8f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557fc06a8a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557fc06a8140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557fc06a9360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fab27ba98a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557fc06a8a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557fc06a94d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557fc06a9360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fab27bae800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557fc06a9640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557fc06a94d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4430.32 ms
main:    sample time =   459.20 ms / 7.18 ms per token
main:      eval time = 19447.50 ms / 277.82 ms per token
main:     total time = 25001.93 ms
...
main:      load time =  1301.74 ms
main:    sample time =   458.32 ms / 7.16 ms per token
main:      eval time =  8148.28 ms / 116.40 ms per token
main:     total time = 10293.18 ms
