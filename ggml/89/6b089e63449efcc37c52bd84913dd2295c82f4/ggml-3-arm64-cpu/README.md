...
- status:  SUCCESS ✅
- runtime: 3:21.01
- date:    Tue Aug 22 08:48:45 UTC 2023
...
main: mem per token =  2017572 bytes
main:     load time =   177.03 ms
main:   sample time =    17.43 ms
main:  predict time =   873.51 ms / 12.48 ms per token
main:    total time =  1117.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8cca8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8b4b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0497ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8cc9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8ccf800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad0498830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8b4b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0497ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad0499140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad0498830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8cc9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad0499a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad0499140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad049a360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8cca8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad0499a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad049a4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad049a360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8ccf800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad049a640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad049a4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5618.04 ms
main:    sample time =   618.69 ms / 9.67 ms per token
main:      eval time = 44194.48 ms / 631.35 ms per token
main:     total time = 52817.93 ms
...
main:      load time =  1718.25 ms
main:    sample time =   613.66 ms / 9.59 ms per token
main:      eval time = 17395.62 ms / 248.51 ms per token
main:     total time = 20698.57 ms
