...
- status:  SUCCESS ✅
- runtime: 87.37
- date:    Thu Oct 12 14:37:11 EEST 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 2/15 Test  #2: test-quantize-fns ................   Passed    0.25 sec
...
13/15 Test #13: test-rel-pos .....................   Passed    0.26 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 7/16 Test  #7: test-mul-mat2 ....................   Passed    2.36 sec
      Start  8: test0
...
main:  predict time =   303.16 ms / 4.74 ms per token
main:    total time =   461.26 ms
...
main:  predict time =   306.23 ms / 4.37 ms per token
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x130009160                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x130009f00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x128008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x130009160                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13000a830                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x130009f00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x128186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13000b160                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13000a830                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13000ba90                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1281878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13000b160                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13000bc20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13000ba90                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x12818c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13000bdb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13000bc20                           node_4
...
whisper_print_timings:     load time =   122.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.41 ms
whisper_print_timings:   sample time =    11.60 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   742.66 ms /     1 runs (  742.66 ms per run)
whisper_print_timings:   decode time =    63.29 ms /    27 runs (    2.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   961.60 ms
```
