...
- status:  SUCCESS ✅
- runtime: 3:31.18
- date:    Tue Sep  5 11:05:28 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.85 sec
      Start  2: test-opt
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.94 sec
...
main:     load time =   263.55 ms
main:   sample time =    17.62 ms
main:  predict time =   810.24 ms / 12.66 ms per token
main:    total time =  1114.72 ms
...
main:     load time =   177.45 ms
main:   sample time =    17.50 ms
main:  predict time =   875.16 ms / 12.50 ms per token
main:    total time =  1074.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8711a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86f9b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2a81ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87119fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8711f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad2a82850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86f9b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2a81ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad2a83170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad2a82850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff87119fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad2a83a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad2a83170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad2a843b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8711a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad2a83a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad2a84530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad2a843b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8711f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad2a846b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad2a84530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5728.94 ms
main:    sample time =   619.17 ms / 9.67 ms per token
main:      eval time = 43716.09 ms / 624.52 ms per token
main:     total time = 52440.77 ms
...
main:      load time =  1591.16 ms
main:    sample time =   624.15 ms / 9.75 ms per token
main:      eval time = 17289.51 ms / 246.99 ms per token
main:     total time = 20461.60 ms
