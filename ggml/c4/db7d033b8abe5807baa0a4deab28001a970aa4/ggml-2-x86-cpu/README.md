...
- status:  SUCCESS ✅
- runtime: 2:36.24
- date:    Tue Sep  5 11:04:46 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.18 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.14 sec
      Start  2: test-opt
...
main:     load time =   233.54 ms
main:   sample time =    23.84 ms
main:  predict time =   441.75 ms / 6.90 ms per token
main:    total time =   712.85 ms
...
main:     load time =   129.49 ms
main:   sample time =    23.74 ms
main:  predict time =   451.51 ms / 6.45 ms per token
main:    total time =   607.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe00bc238d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe00baa4160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a4fafa8ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe00bc22fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe00bc28840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a4fafa9850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe00baa4160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a4fafa8ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a4fafaa170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a4fafa9850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe00bc22fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a4fafaaa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a4fafaa170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a4fafab3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe00bc238d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a4fafaaa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a4fafab530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a4fafab3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe00bc28840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a4fafab6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a4fafab530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5643.63 ms
main:    sample time =   472.08 ms / 7.38 ms per token
main:      eval time = 20688.94 ms / 295.56 ms per token
main:     total time = 27471.37 ms
...
main:      load time =  1210.90 ms
main:    sample time =   495.52 ms / 7.74 ms per token
main:      eval time =  8818.43 ms / 125.98 ms per token
main:     total time = 10914.73 ms
