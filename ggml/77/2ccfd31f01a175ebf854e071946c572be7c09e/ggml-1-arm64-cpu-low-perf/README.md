...
- status:  SUCCESS ✅
- runtime: 4:06.10
- date:    Sat May 11 13:30:33 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.27 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.27 sec
      Start  9: test3
...
main:     load time =   160.02 ms
main:   sample time =    17.49 ms
main:  predict time =   910.60 ms / 14.23 ms per token
main:    total time =  1109.58 ms
...
main:     load time =   161.30 ms
main:   sample time =    17.42 ms
main:  predict time =   992.48 ms / 14.18 ms per token
main:    total time =  1173.89 ms
...
main:     load time =   186.76 ms
main:   sample time =    17.60 ms
main:  predict time =  1074.77 ms / 15.35 ms per token
main:    total time =  1282.59 ms
...
main:  predict time =  6467.42 ms
main:    total time =  6836.66 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa773a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa75bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2379ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa773a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa773f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac237aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa75bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac2379ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac237b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac237aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa773a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac237bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac237b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac237c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa773a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac237bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac237c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac237c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa773f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac237ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac237c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.66 ms
whisper_print_timings:   sample time =   733.58 ms /   131 runs (    5.60 ms per run)
whisper_print_timings:   encode time =  4732.74 ms /     1 runs ( 4732.74 ms per run)
whisper_print_timings:   decode time =    15.85 ms /     2 runs (    7.93 ms per run)
whisper_print_timings:   batchd time =   739.08 ms /   125 runs (    5.91 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6351.52 ms
...
main:     load time =    91.35 ms
main:    total time = 40043.02 ms
embd_img
