...
- status:  SUCCESS ✅
- runtime: 375.18
- date:    Sat May 11 16:31:09 EEST 2024
...
12/23 Test #12: test-arange ......................   Passed    4.90 sec
...
23/23 Test #23: test-backend-ops .................   Passed  110.93 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 3/24 Test  #3: test-quantize-fns ................   Passed   20.03 sec
      Start  4: test-quantize-perf
 4/24 Test  #4: test-quantize-perf ...............   Passed    5.70 sec
      Start  5: test-mul-mat0
 5/24 Test  #5: test-mul-mat0 ....................   Passed    0.36 sec
      Start  6: test-blas0
...
13/24 Test #13: test-arange ......................   Passed    1.36 sec
...
24/24 Test #24: test-backend-ops .................   Passed   29.30 sec
...
main:     load time =   150.05 ms
main:   sample time =     8.78 ms
main:  predict time =   389.98 ms / 6.09 ms per token
main:    total time =   551.46 ms
...
main:  predict time =   409.58 ms / 5.85 ms per token
main:    total time =   507.15 ms
...
main:  predict time =   413.27 ms / 5.90 ms per token
main:    total time =   544.03 ms
...
main:     n_decoded =      504
main:     load time =   116.10 ms
main:   sample time =    64.67 ms
main:  predict time =  1391.54 ms
main:    total time =  1583.52 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1502a8220                            input
...
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x1502a8ff0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x150008190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1502a8220                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x1502a9950                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x1502a8ff0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x150187020                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x1502aa2b0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x1502a9950                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x1502aac10                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x150187980                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x1502aa2b0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40      0x1502aadd0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x1502aac10                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x15018c930                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40      0x1502aaf90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40      0x1502aadd0                           node_4
...
whisper_print_timings:     load time =   155.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.30 ms
whisper_print_timings:   sample time =   346.51 ms /   131 runs (    2.65 ms per run)
whisper_print_timings:   encode time =   221.86 ms /     1 runs (  221.86 ms per run)
whisper_print_timings:   decode time =    30.31 ms /     2 runs (   15.16 ms per run)
whisper_print_timings:   batchd time =   200.92 ms /   125 runs (    1.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   969.67 ms
