...
- status:  SUCCESS ✅
- runtime: 3:10.65
- date:    Sat May 11 13:29:29 UTC 2024
...
main:  predict time =   894.76 ms / 13.98 ms per token
main:    total time =  1086.82 ms
...
main:     load time =   182.02 ms
main:   sample time =    17.72 ms
main:  predict time =  1038.79 ms / 14.84 ms per token
main:    total time =  1241.81 ms
...
main:   sample time =   127.29 ms
main:  predict time =  6428.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8bf8a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8be0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0af0dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8bf8a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8bf8f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0af0eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8be0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0af0dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0af0f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0af0eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8bf8a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0af0fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0af0f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0af106d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8bf8a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0af0fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0af10890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0af106d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8bf8f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0af10a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0af10890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.94 ms
whisper_print_timings:   sample time =   744.90 ms /   131 runs (    5.69 ms per run)
whisper_print_timings:   encode time =  4703.22 ms /     1 runs ( 4703.22 ms per run)
...
whisper_print_timings:    total time =  6301.50 ms
