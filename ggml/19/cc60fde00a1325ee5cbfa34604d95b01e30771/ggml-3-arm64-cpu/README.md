...
- status:  SUCCESS ✅
- runtime: 4:30.20
- date:    Thu Nov 30 05:44:39 PM UTC 2023
...
Total Test time (real) =  15.52 sec
...
main:  predict time =   810.48 ms / 12.66 ms per token
main:    total time =  1033.71 ms
...
main:     load time =   189.50 ms
main:   sample time =    17.24 ms
main:  predict time =   890.22 ms / 12.72 ms per token
main:    total time =  1099.92 ms
...
main:  predict time =  5841.36 ms
main:    total time =  6202.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f46a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f2eb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae572db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f46a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f46f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae572e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f2eb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae572db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae572f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae572e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f46a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae572fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae572f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5730530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f46a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae572fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae57306e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5730530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f46f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae5730890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae57306e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.27 ms
whisper_print_timings:   sample time =    64.65 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4633.86 ms /     1 runs ( 4633.86 ms per run)
whisper_print_timings:   decode time =    15.37 ms /     2 runs (    7.69 ms per run)
whisper_print_timings:   batchd time =   711.07 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5552.46 ms
...
main:      load time =  5635.49 ms
main:    sample time =   533.65 ms / 8.34 ms per token
main:      eval time = 43771.34 ms / 625.30 ms per token
main:     total time = 52311.94 ms
...
main:      load time =  1607.14 ms
main:    sample time =   527.33 ms / 8.24 ms per token
main:      eval time = 17493.11 ms / 249.90 ms per token
main:     total time = 20597.51 ms
