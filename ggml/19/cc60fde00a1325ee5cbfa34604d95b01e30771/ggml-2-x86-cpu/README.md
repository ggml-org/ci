...
- status:  SUCCESS ✅
- runtime: 2:46.80
- date:    Thu Nov 30 17:42:49 UTC 2023
...
main:  predict time =   433.08 ms / 6.77 ms per token
main:    total time =   591.61 ms
...
main:     load time =   123.07 ms
main:   sample time =    23.50 ms
main:  predict time =   454.48 ms / 6.49 ms per token
main:    total time =   603.13 ms
...
main:  predict time =  1442.57 ms
main:    total time =  1753.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9405daa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9405c2b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5583aba27b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9405daa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9405daf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5583aba28940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9405c2b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5583aba27b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5583aba29290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5583aba28940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9405daa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5583aba29be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5583aba29290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5583aba2a530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9405daa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5583aba29be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5583aba2a6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5583aba2a530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9405daf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5583aba2a890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5583aba2a6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.06 ms
whisper_print_timings:   sample time =    53.67 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1142.75 ms /     1 runs ( 1142.75 ms per run)
whisper_print_timings:   decode time =     9.06 ms /     2 runs (    4.53 ms per run)
whisper_print_timings:   batchd time =   203.46 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1506.62 ms
...
main:     load time =    67.94 ms
main:    total time = 10401.98 ms
embd_img
...
main:      load time =  4323.02 ms
main:    sample time =   469.54 ms / 7.34 ms per token
main:      eval time = 19153.68 ms / 273.62 ms per token
main:     total time = 24582.54 ms
...
main:      load time =  1207.93 ms
main:    sample time =   466.41 ms / 7.29 ms per token
main:      eval time =  8030.48 ms / 114.72 ms per token
main:     total time = 10076.04 ms
