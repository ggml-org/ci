...
- status:  SUCCESS ✅
- runtime: 3:04.64
- date:    Thu Nov 30 11:38:24 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    0.87 sec
...
20/20 Test #20: test-backend-ops .................   Passed    0.16 sec
...
main:     load time =   176.38 ms
main:   sample time =    23.95 ms
main:  predict time =   435.25 ms / 6.80 ms per token
main:    total time =   648.20 ms
...
main:  predict time =   465.23 ms / 6.65 ms per token
main:    total time =   618.00 ms
...
main:     n_decoded =      504
main:     load time =   101.79 ms
main:   sample time =   175.08 ms
main:  predict time =  1449.95 ms
main:    total time =  1756.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f31ad4c6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f31ad347190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a40f719b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f31ad4c6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f31ad4cb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a40f71a940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f31ad347190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a40f719b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a40f71b290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a40f71a940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f31ad4c6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a40f71bbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a40f71b290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a40f71c530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f31ad4c6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a40f71bbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a40f71c6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a40f71c530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f31ad4cb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a40f71c890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a40f71c6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.41 ms
whisper_print_timings:   sample time =    54.17 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1146.03 ms /     1 runs ( 1146.03 ms per run)
whisper_print_timings:   decode time =     9.55 ms /     2 runs (    4.77 ms per run)
whisper_print_timings:   batchd time =   206.63 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1566.10 ms
...
main:     load time =    65.69 ms
main:    total time = 10380.80 ms
embd_img
...
main:      load time =  5517.09 ms
main:    sample time =   469.61 ms / 7.34 ms per token
main:      eval time = 20445.84 ms / 292.08 ms per token
main:     total time = 27122.87 ms
...
main:      load time =  1136.65 ms
main:    sample time =   467.49 ms / 7.30 ms per token
main:      eval time =  8101.40 ms / 115.73 ms per token
main:     total time = 10080.65 ms
