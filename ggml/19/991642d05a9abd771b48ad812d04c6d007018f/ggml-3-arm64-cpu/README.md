...
- status:  SUCCESS ✅
- runtime: 4:44.81
- date:    Thu Nov 30 11:40:07 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    1.44 sec
...
20/20 Test #20: test-backend-ops .................   Passed    0.21 sec
...
main:     load time =   197.03 ms
main:   sample time =    16.84 ms
main:  predict time =   808.00 ms / 12.63 ms per token
main:    total time =  1043.82 ms
...
main:     load time =   175.74 ms
main:   sample time =    17.06 ms
main:  predict time =   877.35 ms / 12.53 ms per token
main:    total time =  1072.85 ms
...
main:  predict time =  5821.54 ms
main:    total time =  6177.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae10a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffadf8b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae434eb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae10a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae10f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae434f940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffadf8b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae434eb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae4350290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae434f940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae10a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae4350be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae4350290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae4351530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae10a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae4350be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae43516e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae4351530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae10f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae4351890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae43516e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   208.98 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.87 ms
whisper_print_timings:   sample time =    65.06 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4639.27 ms /     1 runs ( 4639.27 ms per run)
whisper_print_timings:   decode time =    15.23 ms /     2 runs (    7.61 ms per run)
whisper_print_timings:   batchd time =   710.67 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5656.07 ms
...
main:      load time =  5932.60 ms
main:    sample time =   533.64 ms / 8.34 ms per token
main:      eval time = 43491.93 ms / 621.31 ms per token
main:     total time = 52331.18 ms
...
main:      load time =  1539.82 ms
main:    sample time =   530.20 ms / 8.28 ms per token
main:      eval time = 17487.29 ms / 249.82 ms per token
main:     total time = 20528.08 ms
