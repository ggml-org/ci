...
- status:  SUCCESS ✅
- runtime: 2:40.60
- date:    Thu Nov 30 11:38:03 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    1.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.43 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.50 sec
      Start 10: test-pool
10/19 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
Total Test time (real) =  17.74 sec
...
main:     load time =   193.98 ms
main:   sample time =    17.21 ms
main:  predict time =   846.73 ms / 13.23 ms per token
main:    total time =  1079.85 ms
...
main:  predict time =   889.20 ms / 12.70 ms per token
main:    total time =  1095.22 ms
...
main:     n_decoded =      504
main:     load time =   161.91 ms
main:   sample time =   128.49 ms
main:  predict time =  6001.83 ms
main:    total time =  6372.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffabc7a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffabafb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1990b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffabc7a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffabc7f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae1991940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffabafb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae1990b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae1992290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae1991940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffabc7a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae1992be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae1992290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae1993530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffabc7a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae1992be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae19936e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae1993530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffabc7f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae1993890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae19936e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.00 ms
whisper_print_timings:   sample time =    64.59 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4643.09 ms /     1 runs ( 4643.09 ms per run)
whisper_print_timings:   decode time =    15.26 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   858.60 ms /   125 runs (    6.87 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5709.10 ms
...
main:     load time =    91.00 ms
main:    total time = 40112.36 ms
embd_img
