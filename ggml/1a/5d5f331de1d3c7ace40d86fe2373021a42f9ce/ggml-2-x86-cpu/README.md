...
- status:  SUCCESS ✅
- runtime: 2:36.86
- date:    Fri Aug 25 13:59:03 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.54 sec
      Start  2: test-opt
...
main:     load time =   195.15 ms
main:   sample time =    23.66 ms
main:  predict time =   509.39 ms / 7.96 ms per token
main:    total time =   771.68 ms
...
main: mem per token =  2017572 bytes
main:     load time =   137.68 ms
main:   sample time =    23.86 ms
main:  predict time =   470.92 ms / 6.73 ms per token
main:    total time =   657.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43d23948a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f43d2215150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560de9d81ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43d2393f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43d2399800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560de9d82830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f43d2215150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560de9d81ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560de9d83140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560de9d82830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43d2393f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560de9d83a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560de9d83140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560de9d84360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43d23948a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560de9d83a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560de9d844d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560de9d84360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43d2399800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560de9d84640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560de9d844d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  9053.43 ms
main:    sample time =   467.72 ms / 7.31 ms per token
main:      eval time = 20324.48 ms / 290.35 ms per token
main:     total time = 30531.85 ms
...
main:      load time =  2021.13 ms
main:    sample time =   463.51 ms / 7.24 ms per token
main:      eval time =  8127.87 ms / 116.11 ms per token
main:     total time = 11002.19 ms
