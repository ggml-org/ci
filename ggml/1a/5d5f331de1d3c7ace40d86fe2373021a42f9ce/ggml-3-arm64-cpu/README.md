...
- status:  SUCCESS ✅
- runtime: 3:34.12
- date:    Fri Aug 25 14:00:01 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.66 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.50 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.49 sec
...
main:     load time =   252.75 ms
main:   sample time =    17.58 ms
main:  predict time =   803.69 ms / 12.56 ms per token
main:    total time =  1142.12 ms
...
main: mem per token =  2017572 bytes
main:     load time =   172.23 ms
main:   sample time =    17.40 ms
main:  predict time =   871.58 ms / 12.45 ms per token
main:    total time =  1110.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa203a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1ebb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7d59ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2039f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa203f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae7d5a830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1ebb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7d59ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae7d5b140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae7d5a830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2039f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae7d5ba50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae7d5b140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae7d5c360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa203a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae7d5ba50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae7d5c4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae7d5c360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa203f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae7d5c640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae7d5c4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5775.76 ms
main:    sample time =   625.56 ms / 9.77 ms per token
main:      eval time = 43705.78 ms / 624.37 ms per token
main:     total time = 52497.54 ms
...
main:      load time =  2929.32 ms
main:    sample time =   619.68 ms / 9.68 ms per token
main:      eval time = 17381.19 ms / 248.30 ms per token
main:     total time = 21901.70 ms
