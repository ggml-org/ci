...
- status:  SUCCESS ✅
- runtime: 2:49.43
- date:    Thu Aug  8 10:28:53 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   32.82 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    0.18 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.97 sec
      Start  3: test-quantize-perf
...
main:     load time =   141.02 ms
main:   sample time =    16.50 ms
main:  predict time =   822.51 ms / 12.85 ms per token
main:    total time =  1001.22 ms
...
main:     load time =   141.36 ms
main:   sample time =    16.78 ms
main:  predict time =   893.51 ms / 12.76 ms per token
...
main:     load time =   170.61 ms
main:   sample time =    16.69 ms
main:  predict time =   918.34 ms / 13.12 ms per token
main:    total time =  1108.34 ms
...
main:     n_decoded =      504
main:     load time =   141.53 ms
main:   sample time =   128.82 ms
main:  predict time =  6187.79 ms
main:    total time =  6541.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf6ae58d2a930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf6ae58bab180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xca7a0b6e0ee0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf6ae58d29ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf6ae58d2f8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xca7a0b6e1c90                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf6ae58bab180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xca7a0b6e0ee0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xca7a0b6e25d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xca7a0b6e1c90                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf6ae58d29ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xca7a0b6e2f10                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xca7a0b6e25d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xca7a0b6e3850                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf6ae58d2a930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xca7a0b6e2f10                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xca7a0b6e39f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xca7a0b6e3850                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf6ae58d2f8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xca7a0b6e3b90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xca7a0b6e39f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.288000 sec.)
