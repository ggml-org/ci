...
- status:  SUCCESS ✅
- runtime: 2:46.85
- date:    Thu Aug  8 10:33:00 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   35.02 sec
...
main:  predict time =   825.49 ms / 12.90 ms per token
main:    total time =  1013.32 ms
...
main:     load time =   149.19 ms
main:   sample time =    17.87 ms
main:  predict time =   897.19 ms / 12.82 ms per token
main:    total time =  1066.70 ms
...
main:  predict time =   915.12 ms / 13.07 ms per token
main:    total time =  1115.07 ms
...
main:  predict time =  6138.09 ms
main:    total time =  6498.96 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf3ee4e6ba930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf3ee4e53b180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbd3e93cbeee0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf3ee4e6b9ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf3ee4e6bf8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbd3e93cbfc90                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf3ee4e53b180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbd3e93cbeee0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbd3e93cc05d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbd3e93cbfc90                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf3ee4e6b9ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbd3e93cc0f10                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbd3e93cc05d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbd3e93cc1850                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf3ee4e6ba930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbd3e93cc0f10                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbd3e93cc19f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbd3e93cc1850                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf3ee4e6bf8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbd3e93cc1b90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbd3e93cc19f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    89.50 ms
main:    total time = 40034.11 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.293000 sec.)
