...
- status:  SUCCESS ✅
- runtime: 4:07.07
- date:    Sat Jun 15 17:57:36 UTC 2024
...
Total Test time (real) =  81.54 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.11 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   16.90 sec
      Start  3: test-quantize-perf
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.44 sec
      Start  9: test3
...
main:     load time =   151.12 ms
main:   sample time =    18.83 ms
main:  predict time =   890.59 ms / 13.92 ms per token
main:    total time =  1082.07 ms
...
main:     load time =   152.30 ms
main:   sample time =    19.33 ms
main:  predict time =   979.48 ms / 13.99 ms per token
main:    total time =  1153.91 ms
...
main:     load time =   179.54 ms
main:   sample time =    18.95 ms
main:  predict time =   974.97 ms / 13.93 ms per token
main:    total time =  1176.96 ms
...
main:     n_decoded =      504
main:     load time =   153.87 ms
main:   sample time =   128.34 ms
main:  predict time =  6108.17 ms
main:    total time =  6473.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf94ae01ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf94ae006b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaf80cedb9ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf94ae01ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf94ae01ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaf80cedbaab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf94ae006b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaf80cedb9ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaf80cedbb410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaf80cedbaab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf94ae01ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaf80cedbbd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaf80cedbb410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaf80cedbc6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf94ae01ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaf80cedbbd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaf80cedbc890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaf80cedbc6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf94ae01ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaf80cedbca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaf80cedbc890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.41 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    68.29 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4681.60 ms /     1 runs ( 4681.60 ms per run)
whisper_print_timings:   decode time =    15.07 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   732.84 ms /   125 runs (    5.86 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5634.22 ms
...
main:     load time =    95.40 ms
main:    total time = 39956.71 ms
embd_img
