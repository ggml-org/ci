...
- status:  SUCCESS ✅
- runtime: 3:05.14
- date:    Sat Jun 15 17:56:27 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.63 sec
      Start  6: test0
...
main:     load time =   147.04 ms
main:   sample time =    16.99 ms
main:  predict time =   861.65 ms / 13.46 ms per token
main:    total time =  1047.59 ms
...
main:  predict time =   934.79 ms / 13.35 ms per token
main:    total time =  1100.24 ms
...
main:  predict time =   937.53 ms / 13.39 ms per token
...
main:  predict time =  6041.35 ms
main:    total time =  6398.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe00e52bea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe00e52a6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb038b2e38ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe00e52bea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe00e52bef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb038b2e39ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe00e52a6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb038b2e38ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb038b2e3a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb038b2e39ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe00e52bea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb038b2e3ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb038b2e3a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb038b2e3b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe00e52bea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb038b2e3ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb038b2e3b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb038b2e3b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe00e52bef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb038b2e3ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb038b2e3b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =    65.98 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4664.16 ms /     1 runs ( 4664.16 ms per run)
whisper_print_timings:   decode time =    14.80 ms /     2 runs (    7.40 ms per run)
whisper_print_timings:   batchd time =   725.88 ms /   125 runs (    5.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5604.46 ms
