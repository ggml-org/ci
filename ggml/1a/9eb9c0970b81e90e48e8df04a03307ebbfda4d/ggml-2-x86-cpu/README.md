...
- status:  SUCCESS ✅
- runtime: 2:08.62
- date:    Sat Jun 15 17:55:34 UTC 2024
...
main:  predict time =   479.61 ms / 7.49 ms per token
...
main:  predict time =   504.02 ms / 7.20 ms per token
main:    total time =   633.47 ms
...
main:     load time =   123.48 ms
main:   sample time =    24.17 ms
main:  predict time =   513.29 ms / 7.33 ms per token
main:    total time =   664.07 ms
...
main:  predict time =  1547.47 ms
main:    total time =  1862.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x712c29efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x712c29d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5cc014b76ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x712c29efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x712c29eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5cc014b77ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x712c29d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5cc014b76ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5cc014b78410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5cc014b77ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x712c29efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5cc014b78d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5cc014b78410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5cc014b796d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x712c29efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5cc014b78d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5cc014b79890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5cc014b796d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x712c29eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5cc014b79a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5cc014b79890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.62 ms
whisper_print_timings:   sample time =    54.74 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1163.08 ms /     1 runs ( 1163.08 ms per run)
whisper_print_timings:   decode time =    11.18 ms /     2 runs (    5.59 ms per run)
whisper_print_timings:   batchd time =   220.55 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1549.71 ms
...
main:     load time =    66.65 ms
main:    total time = 10626.64 ms
embd_img
