...
- status:  SUCCESS ✅
- runtime: 2:31.75
- date:    Thu Aug  3 08:09:06 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/12 Test  #1: test-grad0 .......................   Passed    2.59 sec
      Start  2: test-opt
...
main:     load time =   263.37 ms
main:   sample time =    23.76 ms
main:  predict time =   432.19 ms / 6.75 ms per token
main:    total time =   758.58 ms
...
main: mem per token =  2015100 bytes
main:     load time =   127.67 ms
main:   sample time =    23.87 ms
main:  predict time =   455.57 ms / 6.51 ms per token
main:    total time =   635.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8114721870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81145a2140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561a7523daa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8114720f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f81147267c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561a7523e810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81145a2140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561a7523daa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561a7523f110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561a7523e810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8114720f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561a7523fa10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561a7523f110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561a75240310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8114721870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561a7523fa10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561a75240470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561a75240310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f81147267c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x561a752405d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561a75240470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5217.54 ms
main:    sample time =   461.11 ms / 7.20 ms per token
main:      eval time = 21356.21 ms / 305.09 ms per token
main:     total time = 28216.16 ms
...
main:      load time =  1206.68 ms
main:    sample time =   458.46 ms / 7.16 ms per token
main:      eval time =  8040.63 ms / 114.87 ms per token
main:     total time = 10137.22 ms
...
```diff
--- /home/ggml/results/ggml/f6/f55ff8252cd7ec09da49dec45de84b161634d2/ggml-2-x86-cpu/stdall	2023-08-03 08:06:15.862250628 +0000
+++ /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/stdall	2023-08-03 08:09:06.486410695 +0000
@@ -1,63 +1,54 @@
...
+rm: cannot remove '/home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/*.md': No such file or directory
...
++ tee /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/f6/f55ff8252cd7ec09da49dec45de84b161634d2/ggml-2-x86-cpu/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_debug-cmake.log
...
+user	0m0.256s
+sys	0m0.137s
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_debug-make.log
 + make -j
...
+user	0m35.135s
+sys	0m3.799s
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_release.log
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/f6/f55ff8252cd7ec09da49dec45de84b161634d2/ggml-2-x86-cpu/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_release-cmake.log
...
+user	0m0.298s
+sys	0m0.091s
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_release-make.log
 + make -j
 [  1%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
 [  2%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
@@ -333,48 +324,48 @@
...
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/ctest_release-ctest.log
 + ctest --output-on-failure
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/gpt_2.log
...
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -543,15 +534,15 @@
...
+sys	0m0.145s
 ...
 + set +x
 + gg_run_mnist
++ tee /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/mnist.log
 + cd /home/ggml/work/ggml
 + cd build-ci-release
 + set -e
...
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
++ tee /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/mpt.log
 + cd /home/ggml/work/ggml
...
+2023-08-03 08:07:22 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-03 08:07:22 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-03 08:07:22 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-03 08:07:23 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-03 08:07:23 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
 + cd /home/ggml/work/ggml
...
+main: quantize time = 28320.26 ms
+main:    total time = 28320.26 ms
++ tee -a /home/ggml/results/ggml/62/7ed15f3d3eb77156a97ca168bdeba7e66552e7/ggml-2-x86-cpu/mpt-tg.log
 + ./bin/mpt --model ../models-mnt/mpt/7B/ggml-model-f16.bin -s 1234 -n 64 -p 'I believe the meaning of life is'
 main: seed      = 1234
 main: n_threads = 4
@@ -1389,15 +1380,15 @@
