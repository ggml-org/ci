...
- status:  SUCCESS ✅
- runtime: 326.73
- date:    Thu Dec  7 14:17:32 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.49 sec
...
20/20 Test #20: test-backend-ops .................   Passed  128.14 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.27 sec
...
main:     load time =   151.57 ms
main:   sample time =     8.82 ms
main:  predict time =   302.16 ms / 4.72 ms per token
main:    total time =   465.79 ms
...
main:     n_decoded =      504
main:     load time =   116.94 ms
main:   sample time =    65.99 ms
main:  predict time =   762.00 ms
main:    total time =   956.06 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x150018210                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x150018fd0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x160008180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x150018210                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x150019920                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x150018fd0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x160187000                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x15001a270                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x150019920                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x15001abc0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x160187950                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x15001a270                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x15001ad70                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x15001abc0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x16018c8f0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x15001af20                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x15001ad70                           node_4
...
ggml_metal_init: error: Error Domain=NSCocoaErrorDomain Code=260 "The file “ggml-metal.metal” couldn’t be opened because there is no such file." UserInfo={NSFilePath=ggml-metal.metal, NSUnderlyingError=0x600001751980 {Error Domain=NSPOSIXErrorDomain Code=2 "No such file or directory"}}
...
ggml_metal_init: error: could not use bundle path to find ggml-metal.metal, falling back to trying cwd
ggml_metal_init: loading 'ggml-metal.metal'
ggml_metal_init: error: Error Domain=NSCocoaErrorDomain Code=260 "The file “ggml-metal.metal” couldn’t be opened because there is no such file." UserInfo={NSFilePath=ggml-metal.metal, NSUnderlyingError=0x60000176c4b0 {Error Domain=NSPOSIXErrorDomain Code=2 "No such file or directory"}}
whisper_backend_init: ggml_backend_metal_init() failed
...
whisper_print_timings:     load time =   144.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.35 ms
whisper_print_timings:   sample time =    34.24 ms /   131 runs (    0.26 ms per run)
whisper_print_timings:   encode time =   680.60 ms /     1 runs (  680.60 ms per run)
whisper_print_timings:   decode time =     5.67 ms /     2 runs (    2.83 ms per run)
whisper_print_timings:   batchd time =   104.62 ms /   125 runs (    0.84 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   977.94 ms
