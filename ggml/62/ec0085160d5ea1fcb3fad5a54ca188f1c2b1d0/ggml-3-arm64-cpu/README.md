...
- status:  SUCCESS ✅
- runtime: 5:50.69
- date:    Thu Dec  7 12:23:25 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   46.82 sec
...
20/20 Test #20: test-backend-ops .................   Passed   11.84 sec
...
main:     load time =   185.86 ms
main:   sample time =    17.02 ms
main:  predict time =   880.41 ms / 12.58 ms per token
main:    total time =  1085.96 ms
...
main:  predict time =  5840.86 ms
main:    total time =  6197.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8c8ea960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8c76b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf89deb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8c8ea010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8c8ef900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf89df940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8c76b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf89deb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf89e0290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf89df940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8c8ea010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf89e0be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf89e0290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf89e1530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8c8ea960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf89e0be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf89e16e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf89e1530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8c8ef900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf89e1890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf89e16e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   180.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.05 ms
whisper_print_timings:   sample time =    65.18 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4648.38 ms /     1 runs ( 4648.38 ms per run)
whisper_print_timings:   decode time =    14.95 ms /     2 runs (    7.47 ms per run)
whisper_print_timings:   batchd time =   706.12 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5632.65 ms
...
main:     load time =    78.19 ms
main:    total time = 39423.91 ms
embd_img
...
main:      load time = 13177.24 ms
main:    sample time =   528.61 ms / 8.26 ms per token
main:      eval time = 43697.43 ms / 624.25 ms per token
main:     total time = 59777.07 ms
...
main:      load time =  4349.53 ms
main:    sample time =   527.43 ms / 8.24 ms per token
main:      eval time = 17748.85 ms / 253.56 ms per token
main:     total time = 23597.69 ms
