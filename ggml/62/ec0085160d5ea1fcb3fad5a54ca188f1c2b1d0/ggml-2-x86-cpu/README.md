...
- status:  SUCCESS ✅
- runtime: 3:48.66
- date:    Thu Dec  7 12:17:51 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.80 sec
...
main:     load time =   194.13 ms
main:   sample time =    23.36 ms
main:  predict time =   429.09 ms / 6.70 ms per token
main:    total time =   659.30 ms
...
main:     load time =   126.16 ms
main:   sample time =    23.34 ms
main:  predict time =   452.57 ms / 6.47 ms per token
main:    total time =   604.13 ms
...
main:     n_decoded =      504
main:     load time =   101.84 ms
main:   sample time =   177.71 ms
main:  predict time =  1482.46 ms
main:    total time =  1792.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f71303f2960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7130273190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5630deabeb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f71303f2010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f71303f7900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5630deabf940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7130273190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5630deabeb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5630deac0290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5630deabf940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f71303f2010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5630deac0be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5630deac0290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5630deac1530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f71303f2960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5630deac0be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5630deac16e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5630deac1530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f71303f7900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5630deac1890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5630deac16e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.41 ms
whisper_print_timings:   sample time =    55.14 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1156.84 ms /     1 runs ( 1156.84 ms per run)
whisper_print_timings:   decode time =    10.14 ms /     2 runs (    5.07 ms per run)
whisper_print_timings:   batchd time =   209.69 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1574.78 ms
...
main:      load time =  5436.86 ms
main:    sample time =   467.77 ms / 7.31 ms per token
main:      eval time = 20323.96 ms / 290.34 ms per token
main:     total time = 26923.65 ms
...
main:      load time =  1213.31 ms
main:    sample time =   464.38 ms / 7.26 ms per token
main:      eval time =  8145.55 ms / 116.37 ms per token
main:     total time = 10201.62 ms
