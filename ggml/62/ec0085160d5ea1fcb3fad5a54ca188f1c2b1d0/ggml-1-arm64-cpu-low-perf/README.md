...
- status:  SUCCESS ✅
- runtime: 3:51.19
- date:    Thu Dec  7 12:18:06 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   55.22 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.88 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.41 sec
      Start  9: test3
...
main:     load time =   195.60 ms
main:   sample time =    17.93 ms
main:  predict time =   918.75 ms / 13.13 ms per token
main:    total time =  1135.25 ms
...
main:     n_decoded =      504
main:     load time =   163.34 ms
main:   sample time =   129.90 ms
main:  predict time =  6070.30 ms
main:    total time =  6445.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9efaa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ee2b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab198e2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9efaa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9efaf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab198e3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ee2b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab198e2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab198e4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab198e3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9efaa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab198e4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab198e4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab198e5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9efaa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab198e4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab198e56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab198e5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9efaf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab198e5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab198e56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    67.52 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4666.87 ms /     1 runs ( 4666.87 ms per run)
whisper_print_timings:   decode time =    15.41 ms /     2 runs (    7.70 ms per run)
whisper_print_timings:   batchd time =   846.27 ms /   125 runs (    6.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5724.12 ms
