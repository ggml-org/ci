...
- status:  SUCCESS ✅
- runtime: 8:28.16
- date:    Thu Dec  7 12:22:46 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    7.94 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   90.09 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 122.21 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    3.31 sec
      Start  7: test0
...
20/20 Test #20: test-backend-ops .................   Passed   22.33 sec
...
main:     load time =   929.53 ms
main:   sample time =    33.98 ms
main:  predict time =   557.07 ms / 8.70 ms per token
main:    total time =  1540.12 ms
...
main:     load time =   474.40 ms
main:   sample time =    33.83 ms
main:  predict time =   563.51 ms / 8.05 ms per token
main:    total time =  1075.77 ms
...
main:     n_decoded =      504
main:     load time =   427.37 ms
main:   sample time =   232.74 ms
main:  predict time =  2133.40 ms
main:    total time =  2837.08 ms
...
main: loaded model in   306.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f737c3b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f737c237190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560ba1fdfb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f737c3b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f737c3bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560ba1fe0950                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f737c237190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560ba1fdfb90                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560ba1fe12a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560ba1fe0950                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f737c3b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560ba1fe1bf0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560ba1fe12a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560ba1fe2540                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f737c3b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560ba1fe1bf0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560ba1fe26f0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560ba1fe2540                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f737c3bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560ba1fe28a0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560ba1fe26f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   972.71 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.45 ms
whisper_print_timings:   sample time =    66.63 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.27 ms /     1 runs (   34.27 ms per run)
whisper_print_timings:   decode time =    13.99 ms /     2 runs (    7.00 ms per run)
whisper_print_timings:   batchd time =    82.20 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1195.35 ms
...
main:     load time =   382.14 ms
main:    total time =  7702.48 ms
embd_img
...
main:      load time = 15903.06 ms
main:    sample time =   517.98 ms / 8.09 ms per token
main:      eval time = 24483.65 ms / 349.77 ms per token
main:     total time = 41804.11 ms
...
main:      load time =  7773.20 ms
main:    sample time =   515.95 ms / 8.06 ms per token
main:      eval time = 12340.50 ms / 176.29 ms per token
main:     total time = 21293.32 ms
