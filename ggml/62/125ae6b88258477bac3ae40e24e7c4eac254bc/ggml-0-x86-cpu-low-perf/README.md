...
- status:  SUCCESS ✅
- runtime: 3:24.98
- date:    Wed Jun  5 08:45:20 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.99 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   23.97 sec
      Start  9: test3
...
main:     load time =   100.99 ms
main:   sample time =    23.92 ms
main:  predict time =   681.74 ms / 10.65 ms per token
...
main:     load time =   100.74 ms
main:   sample time =    23.89 ms
main:  predict time =   727.94 ms / 10.40 ms per token
main:    total time =   854.65 ms
...
main:     load time =   120.90 ms
main:   sample time =    24.00 ms
main:  predict time =   737.45 ms / 10.53 ms per token
main:    total time =   885.36 ms
...
main:     n_decoded =      504
main:     load time =   100.89 ms
main:   sample time =   178.15 ms
main:  predict time =  3011.10 ms
main:    total time =  3335.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x723126cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x723126b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x57e9387d1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x723126cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x723126cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x57e9387d2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x723126b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x57e9387d1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x57e9387d3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x57e9387d2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x723126cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x57e9387d3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x57e9387d3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x57e9387d46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x723126cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x57e9387d3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x57e9387d4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x57e9387d46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x723126cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x57e9387d4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x57e9387d4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    70.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.58 ms
whisper_print_timings:   sample time =    71.63 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2000.24 ms /     1 runs ( 2000.24 ms per run)
whisper_print_timings:   decode time =    13.81 ms /     2 runs (    6.91 ms per run)
whisper_print_timings:   batchd time =   325.97 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2519.45 ms
