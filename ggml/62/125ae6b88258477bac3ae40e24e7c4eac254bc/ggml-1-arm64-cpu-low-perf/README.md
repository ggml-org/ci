...
- status:  SUCCESS ✅
- runtime: 3:59.77
- date:    Wed Jun  5 08:46:05 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   33.28 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.10 sec
      Start  9: test3
...
main:  predict time =   908.17 ms / 14.19 ms per token
main:    total time =  1088.45 ms
...
main:     load time =   141.99 ms
main:   sample time =    16.81 ms
main:  predict time =   992.51 ms / 14.18 ms per token
main:    total time =  1153.90 ms
...
main:     load time =   170.86 ms
main:   sample time =    16.76 ms
main:  predict time =  1011.93 ms / 14.46 ms per token
main:    total time =  1202.68 ms
...
main:     n_decoded =      504
main:     load time =   142.06 ms
main:   sample time =   128.01 ms
main:  predict time =  6508.14 ms
main:    total time =  6861.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf094fa8ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf094fa76b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb2f867b6dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf094fa8ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf094fa8ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb2f867b6eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf094fa76b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb2f867b6dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb2f867b6f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb2f867b6eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf094fa8ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb2f867b6fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb2f867b6f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb2f867b706d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf094fa8ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb2f867b6fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb2f867b70890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb2f867b706d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf094fa8ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb2f867b70a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb2f867b70890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    99.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.06 ms
whisper_print_timings:   sample time =    66.38 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4654.22 ms /     1 runs ( 4654.22 ms per run)
whisper_print_timings:   decode time =    14.43 ms /     2 runs (    7.22 ms per run)
whisper_print_timings:   batchd time =   724.29 ms /   125 runs (    5.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5590.79 ms
...
main:     load time =    91.80 ms
main:    total time = 40340.21 ms
embd_img
