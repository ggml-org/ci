...
- status:  SUCCESS ✅
- runtime: 3:08.98
- date:    Wed Jun  5 08:45:06 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.27 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   33.35 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.19 sec
      Start  2: test-opt
...
main:     load time =   151.99 ms
main:   sample time =    17.82 ms
main:  predict time =   913.20 ms / 14.27 ms per token
main:    total time =  1104.45 ms
...
main:     load time =   151.30 ms
main:   sample time =    17.82 ms
main:  predict time =   992.74 ms / 14.18 ms per token
main:    total time =  1164.41 ms
...
main:   sample time =    17.81 ms
main:  predict time =  1009.41 ms / 14.42 ms per token
main:    total time =  1211.64 ms
...
main:     n_decoded =      504
main:     load time =   155.43 ms
main:   sample time =   128.09 ms
main:  predict time =  6494.32 ms
main:    total time =  6860.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xeb43d157a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xeb43d13fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc2f368391ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xeb43d157a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xeb43d157f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc2f368392ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xeb43d13fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc2f368391ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc2f368393410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc2f368392ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xeb43d157a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc2f368393d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc2f368393410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc2f3683946d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xeb43d157a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc2f368393d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc2f368394890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc2f3683946d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xeb43d157f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc2f368394a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc2f368394890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.61 ms
whisper_print_timings:   sample time =    67.06 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4673.87 ms /     1 runs ( 4673.87 ms per run)
whisper_print_timings:   decode time =    14.70 ms /     2 runs (    7.35 ms per run)
whisper_print_timings:   batchd time =   725.85 ms /   125 runs (    5.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5623.50 ms
...
main:     load time =    90.85 ms
main:    total time = 40299.23 ms
embd_img
