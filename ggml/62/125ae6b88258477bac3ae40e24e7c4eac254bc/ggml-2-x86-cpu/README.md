...
- status:  SUCCESS ✅
- runtime: 2:09.73
- date:    Wed Jun  5 08:48:29 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.83 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.06 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    1.77 sec
      Start  2: test-opt
...
main:  predict time =   514.26 ms / 8.04 ms per token
main:    total time =   656.55 ms
...
main:  predict time =   534.81 ms / 7.64 ms per token
main:    total time =   667.22 ms
...
main:     load time =   126.90 ms
main:   sample time =    23.98 ms
main:  predict time =   549.36 ms / 7.85 ms per token
main:    total time =   703.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x77de866fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x77de8657b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5745b1e6cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x77de866fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x77de866ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5745b1e6dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x77de8657b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5745b1e6cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5745b1e6e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5745b1e6dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x77de866fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5745b1e6ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5745b1e6e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5745b1e6f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x77de866fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5745b1e6ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5745b1e6f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5745b1e6f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x77de866ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5745b1e6fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5745b1e6f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.38 ms
whisper_print_timings:   sample time =    55.19 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1163.78 ms /     1 runs ( 1163.78 ms per run)
whisper_print_timings:   decode time =    10.97 ms /     2 runs (    5.49 ms per run)
whisper_print_timings:   batchd time =   219.97 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1551.88 ms
...
main:     load time =    64.47 ms
main:    total time = 10983.29 ms
embd_img
