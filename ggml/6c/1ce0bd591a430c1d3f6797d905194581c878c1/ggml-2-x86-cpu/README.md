...
- status:  SUCCESS ✅
- runtime: 5:48.03
- date:    Wed Jan 17 18:59:46 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.29 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.12 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  113.11 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 124.38 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.37 sec
...
main:  predict time =   462.60 ms / 7.23 ms per token
main:    total time =   690.45 ms
...
main:  predict time =   474.20 ms / 6.77 ms per token
main:    total time =   635.55 ms
...
main:  predict time =  1511.29 ms
main:    total time =  1827.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7cfcd6c990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7cfcbed1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5582ae823b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7cfcd6c030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7cfcd71940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5582ae824960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7cfcbed1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5582ae823b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5582ae8252c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5582ae824960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7cfcd6c030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5582ae825c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5582ae8252c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5582ae826580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7cfcd6c990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5582ae825c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5582ae826740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5582ae826580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7cfcd71940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5582ae826900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5582ae826740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   128.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.06 ms
whisper_print_timings:   sample time =    54.56 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1168.49 ms /     1 runs ( 1168.49 ms per run)
whisper_print_timings:   decode time =     9.85 ms /     2 runs (    4.92 ms per run)
whisper_print_timings:   batchd time =   208.43 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1595.70 ms
...
main:      load time = 11402.66 ms
main:    sample time =   468.00 ms / 7.31 ms per token
main:      eval time = 20417.63 ms / 291.68 ms per token
main:     total time = 32952.38 ms
...
main:      load time =  4375.07 ms
main:    sample time =   463.95 ms / 7.25 ms per token
main:      eval time =  8232.60 ms / 117.61 ms per token
main:     total time = 13444.03 ms
