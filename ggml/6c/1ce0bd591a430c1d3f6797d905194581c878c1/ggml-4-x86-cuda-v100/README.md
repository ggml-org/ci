...
- status:  SUCCESS ✅
- runtime: 12:47.00
- date:    Wed Jan 17 19:06:48 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.68 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  261.15 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/21 Test  #6: test-mul-mat2 ....................   Passed    3.30 sec
      Start  7: test0
 7/21 Test  #7: test0 ............................   Passed    0.55 sec
      Start  8: test1
 8/21 Test  #8: test1 ............................   Passed    0.57 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.81 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   47.69 sec
...
main:     load time =   589.56 ms
main:   sample time =    34.28 ms
main:  predict time =   585.67 ms / 9.15 ms per token
main:    total time =  1233.40 ms
...
main:     load time =   561.79 ms
main:   sample time =    35.61 ms
main:  predict time =   635.04 ms / 9.07 ms per token
main:    total time =  1237.00 ms
...
main:     n_decoded =      504
main:     load time =   535.52 ms
main:   sample time =   237.54 ms
main:  predict time =  2316.58 ms
main:    total time =  3134.38 ms
...
main: loaded model in   407.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5eec3b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5eec2371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b67510f830                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5eec3b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5eec3bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b675110600                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5eec2371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b67510f830                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b675110f60                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b675110600                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5eec3b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b6751118c0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b675110f60                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b675112220                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5eec3b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b6751118c0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b6751123e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b675112220                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5eec3bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b6751125a0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b6751123e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   596.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.32 ms
whisper_print_timings:   sample time =    66.81 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    23.74 ms /     1 runs (   23.74 ms per run)
whisper_print_timings:   decode time =    22.10 ms /     2 runs (   11.05 ms per run)
whisper_print_timings:   batchd time =    82.14 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   819.23 ms
...
main:     load time =   550.56 ms
main:    total time =  8215.32 ms
embd_img
...
main:      load time = 19747.04 ms
main:    sample time =   542.61 ms / 8.48 ms per token
main:      eval time = 26047.39 ms / 372.11 ms per token
main:     total time = 47214.38 ms
...
main:      load time =  7770.46 ms
main:    sample time =   541.64 ms / 8.46 ms per token
main:      eval time = 12575.54 ms / 179.65 ms per token
main:     total time = 21543.11 ms
