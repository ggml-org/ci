...
- status:  SUCCESS ✅
- runtime: 4:00.93
- date:    Tue May 14 12:13:54 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.77 sec
      Start  9: test3
...
main:     load time =   139.74 ms
main:   sample time =    16.86 ms
main:  predict time =   931.87 ms / 14.56 ms per token
main:    total time =  1110.01 ms
...
main:     load time =   138.77 ms
main:   sample time =    16.63 ms
main:  predict time =   978.50 ms / 13.98 ms per token
main:    total time =  1136.35 ms
...
main:  predict time =  1037.75 ms / 14.83 ms per token
main:    total time =  1225.92 ms
...
main:     n_decoded =      504
main:     load time =   140.65 ms
main:   sample time =   126.73 ms
main:  predict time =  6446.15 ms
main:    total time =  6796.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfd1e42c7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfd1e42afb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc627a89dece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfd1e42c7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfd1e42c7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc627a89dfab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfd1e42afb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc627a89dece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc627a89e0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc627a89dfab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfd1e42c7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc627a89e0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc627a89e0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc627a89e16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfd1e42c7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc627a89e0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc627a89e1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc627a89e16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfd1e42c7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc627a89e1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc627a89e1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.45 ms
whisper_print_timings:   sample time =    64.25 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4655.30 ms /     1 runs ( 4655.30 ms per run)
whisper_print_timings:   decode time =    15.54 ms /     2 runs (    7.77 ms per run)
whisper_print_timings:   batchd time =   712.38 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5566.62 ms
