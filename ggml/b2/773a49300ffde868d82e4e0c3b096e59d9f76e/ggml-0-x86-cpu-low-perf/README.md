...
- status:  SUCCESS ✅
- runtime: 3:28.30
- date:    Tue May 14 12:13:17 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.00 sec
...
main:     load time =   103.95 ms
main:   sample time =    23.86 ms
main:  predict time =   700.68 ms / 10.95 ms per token
main:    total time =   841.09 ms
...
main:  predict time =   749.78 ms / 10.71 ms per token
main:    total time =   879.02 ms
...
main:     load time =   124.20 ms
main:   sample time =    23.92 ms
main:  predict time =   751.92 ms / 10.74 ms per token
main:    total time =   903.14 ms
...
main:  predict time =  3120.38 ms
main:    total time =  3447.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x734002efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x734002d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x619bb36e5ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x734002efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x734002eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x619bb36e6ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x734002d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x619bb36e5ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x619bb36e7410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x619bb36e6ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x734002efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x619bb36e7d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x619bb36e7410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x619bb36e86d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x734002efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x619bb36e7d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x619bb36e8890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x619bb36e86d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x734002eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x619bb36e8a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x619bb36e8890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.53 ms
whisper_print_timings:   sample time =    72.17 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2022.68 ms /     1 runs ( 2022.68 ms per run)
whisper_print_timings:   decode time =    15.97 ms /     2 runs (    7.99 ms per run)
whisper_print_timings:   batchd time =   332.27 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2542.36 ms
...
main:     load time =    71.12 ms
main:    total time = 19396.58 ms
embd_img
