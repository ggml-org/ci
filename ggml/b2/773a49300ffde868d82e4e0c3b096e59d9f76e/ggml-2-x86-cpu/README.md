...
- status:  SUCCESS ✅
- runtime: 2:12.85
- date:    Tue May 14 12:11:58 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   16.04 sec
...
main:  predict time =   507.70 ms / 7.93 ms per token
main:    total time =   653.39 ms
...
main:  predict time =   534.43 ms / 7.63 ms per token
main:    total time =   669.27 ms
...
main:     load time =   133.76 ms
main:   sample time =    24.12 ms
main:  predict time =   548.36 ms / 7.83 ms per token
main:    total time =   709.36 ms
...
main:   sample time =   178.87 ms
main:  predict time =  1883.29 ms
main:    total time =  2206.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x79e07c8fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x79e07c77b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5ba8fd802ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x79e07c8fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x79e07c8ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5ba8fd803ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x79e07c77b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5ba8fd802ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5ba8fd804410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5ba8fd803ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x79e07c8fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5ba8fd804d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5ba8fd804410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5ba8fd8056d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x79e07c8fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5ba8fd804d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5ba8fd805890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5ba8fd8056d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x79e07c8ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5ba8fd805a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5ba8fd805890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   134.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =    54.69 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1169.03 ms /     1 runs ( 1169.03 ms per run)
whisper_print_timings:   decode time =    13.43 ms /     2 runs (    6.71 ms per run)
whisper_print_timings:   batchd time =   221.06 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1611.21 ms
