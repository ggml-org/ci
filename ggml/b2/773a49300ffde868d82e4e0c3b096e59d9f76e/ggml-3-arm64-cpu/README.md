...
- status:  SUCCESS ✅
- runtime: 3:10.73
- date:    Tue May 14 12:13:08 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b2773a49300ffde868d82e4e0c3b096e59d9f76e
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.06 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.87 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.21 sec
...
main:     load time =   142.40 ms
main:   sample time =    16.87 ms
main:  predict time =   893.20 ms / 13.96 ms per token
main:    total time =  1073.74 ms
...
main:     load time =   143.75 ms
main:   sample time =    16.71 ms
main:  predict time =   975.24 ms / 13.93 ms per token
main:    total time =  1138.12 ms
...
main:     load time =   169.39 ms
main:   sample time =    16.86 ms
main:  predict time =  1000.11 ms / 14.29 ms per token
main:    total time =  1189.52 ms
...
main:     n_decoded =      504
main:     load time =   142.81 ms
main:   sample time =   126.76 ms
main:  predict time =  6437.60 ms
main:    total time =  6788.96 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe09e5355a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe09e533db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb74f2e805ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe09e5355a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe09e5355f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb74f2e806ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe09e533db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb74f2e805ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb74f2e807410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb74f2e806ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe09e5355a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb74f2e807d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb74f2e807410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb74f2e8086d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe09e5355a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb74f2e807d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb74f2e808890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb74f2e8086d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe09e5355f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb74f2e808a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb74f2e808890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    99.40 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.37 ms
whisper_print_timings:   sample time =    63.65 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4650.16 ms /     1 runs ( 4650.16 ms per run)
whisper_print_timings:   decode time =    15.39 ms /     2 runs (    7.70 ms per run)
whisper_print_timings:   batchd time =   709.35 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5556.64 ms
...
main:     load time =    81.25 ms
main:    total time = 39824.39 ms
embd_img
