...
- status:  SUCCESS ✅
- runtime: 4:20.17
- date:    Wed Jan  3 12:30:03 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.32 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.71 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   43.13 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.32 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.11 sec
...
main:     load time =   193.09 ms
main:   sample time =    19.04 ms
main:  predict time =   856.20 ms / 13.38 ms per token
main:    total time =  1090.11 ms
...
main:     load time =   191.79 ms
main:   sample time =    17.80 ms
main:  predict time =   922.09 ms / 13.17 ms per token
main:    total time =  1134.70 ms
...
main:     n_decoded =      504
main:     load time =   164.36 ms
main:   sample time =   129.21 ms
main:  predict time =  6170.36 ms
main:    total time =  6545.91 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff97cfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97b7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafbc35b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff97cfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff97cff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafbc36960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97b7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafbc35b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafbc372c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafbc36960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff97cfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafbc37c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafbc372c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafbc38580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff97cfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafbc37c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafbc38740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafbc38580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff97cff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafbc38900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafbc38740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.71 ms
whisper_print_timings:   sample time =    67.08 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4768.84 ms /     1 runs ( 4768.84 ms per run)
whisper_print_timings:   decode time =    15.66 ms /     2 runs (    7.83 ms per run)
whisper_print_timings:   batchd time =   713.21 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5697.47 ms
...
main:     load time =    98.15 ms
main:    total time = 40572.68 ms
embd_img
