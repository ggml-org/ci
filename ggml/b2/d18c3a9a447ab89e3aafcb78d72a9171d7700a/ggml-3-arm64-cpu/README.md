...
- status:  SUCCESS ✅
- runtime: 6:00.56
- date:    Wed Jan  3 12:34:13 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b2d18c3a9a447ab89e3aafcb78d72a9171d7700a
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.29 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.04 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.29 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.56 sec
      Start  5: test-mul-mat2
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.68 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed   35.11 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.19 sec
      Start  2: test-opt
 ...
 5/21 Test  #5: test-mul-mat0 ....................   Passed    0.56 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.44 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  19.22 sec
...
main:     load time =   185.62 ms
main:   sample time =    17.16 ms
main:  predict time =   822.81 ms / 12.86 ms per token
main:    total time =  1047.51 ms
...
main:     load time =   185.03 ms
main:   sample time =    16.93 ms
main:  predict time =   891.85 ms / 12.74 ms per token
main:    total time =  1096.85 ms
...
main:     n_decoded =      504
main:     load time =   152.97 ms
main:   sample time =   127.06 ms
main:  predict time =  5985.37 ms
main:    total time =  6346.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96a0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9688b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadff21b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96a0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96a0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadff22960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9688b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadff21b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadff232c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadff22960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96a0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadff23c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadff232c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadff24580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96a0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadff23c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadff24740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadff24580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96a0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadff24900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadff24740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    65.85 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4639.77 ms /     1 runs ( 4639.77 ms per run)
whisper_print_timings:   decode time =    15.26 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   706.53 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5563.39 ms
...
main:     load time =    98.86 ms
main:    total time = 39884.67 ms
embd_img
...
main:      load time =  5484.87 ms
main:    sample time =   518.95 ms / 8.11 ms per token
main:      eval time = 43778.33 ms / 625.40 ms per token
main:     total time = 52154.16 ms
...
main:      load time =  1600.61 ms
main:    sample time =   513.70 ms / 8.03 ms per token
main:      eval time = 17329.18 ms / 247.56 ms per token
main:     total time = 20415.22 ms
