...
- status:  SUCCESS ✅
- runtime: 4:11.10
- date:    Wed Jan  3 12:29:52 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   10.06 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   10.18 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.69 sec
      Start 10: test-pool
...
main:     load time =   126.42 ms
main:   sample time =    23.61 ms
main:  predict time =   616.97 ms / 9.64 ms per token
main:    total time =   779.67 ms
...
main:     load time =   125.50 ms
main:   sample time =    23.43 ms
main:  predict time =   653.39 ms / 9.33 ms per token
main:    total time =   804.57 ms
...
main:  predict time =  2504.71 ms
main:    total time =  2831.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf14578990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf143f91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cbd903db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf14578030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf1457d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cbd903e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf143f91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cbd903db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cbd903f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cbd903e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf14578030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cbd903fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cbd903f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cbd9040580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf14578990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cbd903fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cbd9040740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cbd9040580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf1457d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55cbd9040900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cbd9040740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.16 ms
whisper_print_timings:   sample time =    71.42 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1988.14 ms /     1 runs ( 1988.14 ms per run)
whisper_print_timings:   decode time =    12.95 ms /     2 runs (    6.48 ms per run)
whisper_print_timings:   batchd time =   322.98 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2498.11 ms
...
main:     load time =    71.76 ms
main:    total time = 18977.86 ms
embd_img
