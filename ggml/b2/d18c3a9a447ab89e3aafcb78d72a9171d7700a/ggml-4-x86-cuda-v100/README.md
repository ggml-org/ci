...
- status:  SUCCESS ✅
- runtime: 10:00.97
- date:    Wed Jan  3 12:39:03 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.62 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.58 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.83 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    1.17 sec
...
20/20 Test #20: test-backend-ops .................   Passed   58.59 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  91.42 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.70 sec
      Start  2: test-opt
 ...
 5/21 Test  #5: test-mul-mat0 ....................   Passed    1.15 sec
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    8.07 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    1.10 sec
      Start 11: test-pool
...
21/21 Test #21: test-backend-ops .................   Passed   21.61 sec
...
main:     load time =   577.08 ms
main:   sample time =    33.71 ms
main:  predict time =   580.74 ms / 9.07 ms per token
main:    total time =  1215.68 ms
...
main:     load time =   588.78 ms
main:   sample time =    33.96 ms
main:  predict time =   615.54 ms / 8.79 ms per token
main:    total time =  1242.55 ms
...
main:     n_decoded =      504
main:     load time =   541.02 ms
main:   sample time =   234.45 ms
main:  predict time =  2332.29 ms
main:    total time =  3161.08 ms
...
main: loaded model in   405.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f24e19b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f24e18371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558d2452bcd0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f24e19b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f24e19bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558d2452caa0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f24e18371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558d2452bcd0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558d2452d400                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558d2452caa0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f24e19b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558d2452dd60                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558d2452d400                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558d2452e6c0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f24e19b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558d2452dd60                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558d2452e880                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558d2452e6c0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f24e19bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558d2452ea40                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558d2452e880       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   506.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.30 ms
whisper_print_timings:   sample time =    66.27 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.88 ms /     1 runs (   34.88 ms per run)
whisper_print_timings:   decode time =    14.07 ms /     2 runs (    7.03 ms per run)
whisper_print_timings:   batchd time =    81.63 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   730.99 ms
...
main:     load time =   509.58 ms
main:    total time =  8125.10 ms
embd_img
...
main:      load time =  6865.06 ms
main:    sample time =   529.29 ms / 8.27 ms per token
main:      eval time = 24279.86 ms / 346.86 ms per token
main:     total time = 32544.32 ms
...
main:      load time =  2194.25 ms
main:    sample time =   547.30 ms / 8.55 ms per token
main:      eval time = 12593.95 ms / 179.91 ms per token
main:     total time = 16011.97 ms
