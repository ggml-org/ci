...
- status:  SUCCESS ✅
- runtime: 4:33.99
- date:    Wed Jan  3 12:31:29 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.31 sec
...
20/20 Test #20: test-backend-ops .................   Passed   27.54 sec
...
21/21 Test #21: test-backend-ops .................   Passed    7.51 sec
...
main:     load time =   136.16 ms
main:   sample time =    23.58 ms
main:  predict time =   439.08 ms / 6.86 ms per token
main:    total time =   611.29 ms
...
main:     load time =   128.08 ms
main:   sample time =    23.39 ms
main:  predict time =   466.09 ms / 6.66 ms per token
main:    total time =   619.65 ms
...
main:     n_decoded =      504
main:     load time =   106.11 ms
main:   sample time =   178.13 ms
main:  predict time =  1498.12 ms
main:    total time =  1812.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f01a0af0990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f01a09711a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55acd352eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f01a0af0030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f01a0af5940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55acd352f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f01a09711a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55acd352eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55acd35302c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55acd352f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f01a0af0030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55acd3530c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55acd35302c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55acd3531580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f01a0af0990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55acd3530c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55acd3531740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55acd3531580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f01a0af5940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55acd3531900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55acd3531740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    84.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.57 ms
whisper_print_timings:   sample time =    55.79 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1159.16 ms /     1 runs ( 1159.16 ms per run)
whisper_print_timings:   decode time =     9.79 ms /     2 runs (    4.89 ms per run)
whisper_print_timings:   batchd time =   212.05 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1540.91 ms
...
main:     load time =    68.23 ms
main:    total time = 10650.41 ms
embd_img
...
main:      load time =  4986.47 ms
main:    sample time =   466.25 ms / 7.29 ms per token
main:      eval time = 20141.70 ms / 287.74 ms per token
main:     total time = 26278.61 ms
...
main:      load time =  1203.22 ms
main:    sample time =   465.11 ms / 7.27 ms per token
main:      eval time =  8209.88 ms / 117.28 ms per token
main:     total time = 10253.92 ms
