...
- status:  SUCCESS ✅
- runtime: 11:44.62
- date:    Mon Jan 29 12:49:36 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.79 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  222.94 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 269.27 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test1 ............................   Passed    0.55 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.91 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   43.42 sec
...
main:     load time =   585.16 ms
main:   sample time =    33.96 ms
main:  predict time =   600.89 ms / 9.39 ms per token
main:    total time =  1240.17 ms
...
main:     load time =   580.34 ms
main:   sample time =    34.46 ms
main:  predict time =   613.10 ms / 8.76 ms per token
main:    total time =  1232.53 ms
...
main:     n_decoded =      504
main:     load time =   544.36 ms
main:   sample time =   236.29 ms
main:  predict time =  2314.38 ms
main:    total time =  3140.08 ms
...
main: loaded model in   443.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6151efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6151d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5573c60fdb00                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6151efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6151eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5573c60fe8d0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6151d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5573c60fdb00                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5573c60ff230                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5573c60fe8d0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6151efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5573c60ffb90                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5573c60ff230                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5573c61004f0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6151efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5573c60ffb90                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5573c61006b0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5573c61004f0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6151eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5573c6100870                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5573c61006b0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   517.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.53 ms
whisper_print_timings:   sample time =    65.71 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    23.48 ms /     1 runs (   23.48 ms per run)
whisper_print_timings:   decode time =    21.04 ms /     2 runs (   10.52 ms per run)
whisper_print_timings:   batchd time =    81.34 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   736.29 ms
...
main:     load time =   501.59 ms
main:    total time =  7983.09 ms
embd_img
...
main:      load time =  7229.52 ms
main:    sample time =   525.70 ms / 8.21 ms per token
main:      eval time = 24655.25 ms / 352.22 ms per token
main:     total time = 33319.59 ms
...
main:      load time =  2216.98 ms
main:    sample time =   528.43 ms / 8.26 ms per token
main:      eval time = 12565.58 ms / 179.51 ms per token
main:     total time = 15963.72 ms
