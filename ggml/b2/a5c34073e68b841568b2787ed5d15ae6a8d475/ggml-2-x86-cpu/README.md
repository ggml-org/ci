...
- status:  SUCCESS ✅
- runtime: 5:41.87
- date:    Mon Jan 29 12:49:55 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b2a5c34073e68b841568b2787ed5d15ae6a8d475
- author:  John Balis
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.46 sec
...
20/20 Test #20: test-backend-ops .................   Passed  115.24 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 126.16 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.34 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.62 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.51 sec
...
main:     load time =   218.95 ms
main:   sample time =    23.71 ms
main:  predict time =   465.42 ms / 7.27 ms per token
main:    total time =   721.34 ms
...
main:     load time =   123.57 ms
main:   sample time =    23.83 ms
main:  predict time =   492.08 ms / 7.03 ms per token
main:    total time =   641.91 ms
...
main:     n_decoded =      504
main:     load time =   104.61 ms
main:   sample time =   177.50 ms
main:  predict time =  1527.61 ms
main:    total time =  1841.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f92820d2990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9281f531a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55715dcecb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f92820d2030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f92820d7940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55715dced960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9281f531a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55715dcecb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55715dcee2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55715dced960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f92820d2030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55715dceec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55715dcee2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55715dcef580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f92820d2990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55715dceec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55715dcef740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55715dcef580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f92820d7940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55715dcef900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55715dcef740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   139.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.04 ms
whisper_print_timings:   sample time =    55.11 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1162.18 ms /     1 runs ( 1162.18 ms per run)
whisper_print_timings:   decode time =    10.23 ms /     2 runs (    5.12 ms per run)
whisper_print_timings:   batchd time =   213.32 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1599.46 ms
...
main:     load time =    61.18 ms
main:    total time = 10616.66 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.460000 sec.)
...
main:      load time = 13820.73 ms
main:    sample time =   469.84 ms / 7.34 ms per token
main:      eval time = 20771.28 ms / 296.73 ms per token
main:     total time = 35738.02 ms
...
main:      load time =  4397.98 ms
main:    sample time =   498.18 ms / 7.78 ms per token
main:      eval time =  9230.81 ms / 131.87 ms per token
main:     total time = 14486.98 ms
