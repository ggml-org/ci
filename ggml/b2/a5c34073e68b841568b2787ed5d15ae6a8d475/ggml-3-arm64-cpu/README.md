...
- status:  SUCCESS ✅
- runtime: 7:23.06
- date:    Mon Jan 29 01:03:06 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.55 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  126.02 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 140.66 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.27 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   24.41 sec
...
main:     load time =   276.14 ms
main:   sample time =    17.19 ms
main:  predict time =   869.70 ms / 13.59 ms per token
main:    total time =  1187.48 ms
...
main:     load time =   175.11 ms
main:   sample time =    17.45 ms
main:  predict time =   941.37 ms / 13.45 ms per token
main:    total time =  1137.06 ms
...
main:     n_decoded =      504
main:     load time =   149.14 ms
main:   sample time =   128.20 ms
main:  predict time =  6018.78 ms
main:    total time =  6378.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98ada990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9895b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07615b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98ada030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98adf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab07616960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9895b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07615b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab076172c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab07616960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98ada030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab07617c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab076172c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab07618580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98ada990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab07617c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab07618740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab07618580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98adf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab07618900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab07618740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    13.20 ms
whisper_print_timings:   sample time =    65.29 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4636.27 ms /     1 runs ( 4636.27 ms per run)
whisper_print_timings:   decode time =    15.41 ms /     2 runs (    7.70 ms per run)
whisper_print_timings:   batchd time =   711.32 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5623.34 ms
...
main:     load time =    79.39 ms
main:    total time = 39746.56 ms
embd_img
...
main:      load time = 10325.90 ms
main:    sample time =   515.16 ms / 8.05 ms per token
main:      eval time = 43830.34 ms / 626.15 ms per token
main:     total time = 57045.95 ms
...
main:      load time =  4361.37 ms
main:    sample time =   516.14 ms / 8.06 ms per token
main:      eval time = 17496.13 ms / 249.94 ms per token
main:     total time = 23331.78 ms
