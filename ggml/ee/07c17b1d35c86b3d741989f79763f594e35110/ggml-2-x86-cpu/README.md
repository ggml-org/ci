...
- status:  SUCCESS ✅
- runtime: 3:19.59
- date:    Sat Feb 10 14:07:54 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  110.14 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.69 sec
...
main:  predict time =   461.97 ms / 7.22 ms per token
main:    total time =   629.59 ms
...
main:  predict time =   474.42 ms / 6.78 ms per token
...
main:  predict time =  1540.52 ms
main:    total time =  1853.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f30f6272990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30f60f31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5637fcd76b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f30f6272030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f30f6277940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5637fcd77960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30f60f31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5637fcd76b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5637fcd782c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5637fcd77960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f30f6272030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5637fcd78c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5637fcd782c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5637fcd79580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f30f6272990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5637fcd78c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5637fcd79740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5637fcd79580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f30f6277940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5637fcd79900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5637fcd79740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    14.34 ms
whisper_print_timings:   sample time =    54.83 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1160.14 ms /     1 runs ( 1160.14 ms per run)
whisper_print_timings:   decode time =     9.61 ms /     2 runs (    4.81 ms per run)
whisper_print_timings:   batchd time =   209.79 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1532.11 ms
