...
- status:  SUCCESS ✅
- runtime: 4:30.92
- date:    Sat Feb 10 14:08:51 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  107.63 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 145.31 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.76 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.67 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.00 sec
      Start 11: test-conv-transpose
11/20 Test #11: test-conv-transpose ..............   Passed    0.00 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   17.57 sec
...
main:  predict time =   639.43 ms / 9.99 ms per token
...
main:  predict time =   671.99 ms / 9.60 ms per token
main:    total time =   827.04 ms
...
main:  predict time =  2513.07 ms
main:    total time =  2841.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc95d240990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc95d0c11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562a532afb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc95d240030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc95d245940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562a532b0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc95d0c11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562a532afb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562a532b12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562a532b0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc95d240030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562a532b1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562a532b12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562a532b2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc95d240990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562a532b1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562a532b2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562a532b2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc95d245940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562a532b2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562a532b2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.03 ms
whisper_print_timings:   sample time =    72.54 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1987.58 ms /     1 runs ( 1987.58 ms per run)
whisper_print_timings:   decode time =    13.41 ms /     2 runs (    6.71 ms per run)
whisper_print_timings:   batchd time =   327.64 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.73 ms
