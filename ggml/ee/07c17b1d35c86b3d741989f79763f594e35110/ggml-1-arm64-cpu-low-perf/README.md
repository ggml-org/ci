...
- status:  SUCCESS ✅
- runtime: 5:54.98
- date:    Sat Feb 10 02:10:21 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.73 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.24 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  154.40 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 192.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.92 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.12 sec
      Start  3: test-quantize-perf
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.81 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.58 sec
      Start 10: test-pool
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.38 sec
...
main:     load time =   194.02 ms
main:   sample time =    17.14 ms
main:  predict time =   871.22 ms / 13.61 ms per token
main:    total time =  1104.72 ms
...
main:     load time =   191.74 ms
main:   sample time =    16.92 ms
main:  predict time =   940.68 ms / 13.44 ms per token
main:    total time =  1152.54 ms
...
main:     n_decoded =      504
main:     load time =   162.31 ms
main:   sample time =   127.27 ms
main:  predict time =  6212.58 ms
main:    total time =  6584.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff84bca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84a4b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18871b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff84bca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff84bcf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18872960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84a4b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18871b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab188732c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18872960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff84bca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18873c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab188732c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18874580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff84bca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18873c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18874740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18874580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff84bcf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab18874900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18874740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.69 ms
whisper_print_timings:   sample time =    65.54 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4675.88 ms /     1 runs ( 4675.88 ms per run)
whisper_print_timings:   decode time =    16.07 ms /     2 runs (    8.04 ms per run)
whisper_print_timings:   batchd time =   834.77 ms /   125 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5721.55 ms
...
main:     load time =    91.29 ms
main:    total time = 40620.01 ms
embd_img
