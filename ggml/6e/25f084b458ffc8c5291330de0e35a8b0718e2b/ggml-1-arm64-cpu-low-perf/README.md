...
- status:  SUCCESS ✅
- runtime: 3:54.76
- date:    Wed Dec 13 04:23:48 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.14 sec
...
19/19 Test #19: test-backend-ops .................   Passed   58.92 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.96 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   13.71 sec
...
main:     load time =   194.69 ms
main:   sample time =    17.82 ms
main:  predict time =   836.13 ms / 13.06 ms per token
main:    total time =  1070.50 ms
...
main:     load time =   194.24 ms
main:   sample time =    17.82 ms
main:  predict time =   903.53 ms / 12.91 ms per token
main:    total time =  1118.70 ms
...
main:   sample time =   129.49 ms
main:  predict time =  6111.66 ms
main:    total time =  6487.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0e9a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0d1b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3c18ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0e9a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0e9f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae3c19980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0d1b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3c18ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae3c1a2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae3c19980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0e9a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae3c1ac60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae3c1a2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae3c1b5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0e9a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae3c1ac60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae3c1b7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae3c1b5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0e9f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae3c1b970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae3c1b7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.41 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.27 ms
whisper_print_timings:   sample time =    67.74 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4684.96 ms /     1 runs ( 4684.96 ms per run)
whisper_print_timings:   decode time =    15.51 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   845.99 ms /   125 runs (    6.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5746.37 ms
...
main:     load time =   101.09 ms
main:    total time = 40451.22 ms
embd_img
