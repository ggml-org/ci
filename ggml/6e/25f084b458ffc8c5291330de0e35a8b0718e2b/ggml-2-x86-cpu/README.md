...
- status:  SUCCESS ✅
- runtime: 3:54.77
- date:    Wed Dec 13 16:35:42 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   36.26 sec
...
20/20 Test #20: test-backend-ops .................   Passed   11.33 sec
...
main:     load time =   162.37 ms
main:   sample time =    23.38 ms
main:  predict time =   443.55 ms / 6.93 ms per token
main:    total time =   642.06 ms
...
main:  predict time =   460.78 ms / 6.58 ms per token
main:    total time =   611.81 ms
...
main:  predict time =  1480.87 ms
main:    total time =  1797.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdc242ca9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdc2414b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f15a181ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdc242ca050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdc242cf980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f15a182980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdc2414b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f15a181ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f15a1832f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f15a182980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdc242ca050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f15a183c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f15a1832f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f15a1845d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdc242ca9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f15a183c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f15a1847a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f15a1845d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdc242cf980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f15a184970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f15a1847a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.67 ms
whisper_print_timings:   sample time =    56.55 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1159.72 ms /     1 runs ( 1159.72 ms per run)
whisper_print_timings:   decode time =     9.94 ms /     2 runs (    4.97 ms per run)
whisper_print_timings:   batchd time =   212.34 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1583.43 ms
...
main:     load time =    63.73 ms
main:    total time = 10574.98 ms
embd_img
...
main:      load time =  6522.05 ms
main:    sample time =   468.34 ms / 7.32 ms per token
main:      eval time = 20491.38 ms / 292.73 ms per token
main:     total time = 28160.26 ms
...
main:      load time =  1573.21 ms
main:    sample time =   465.98 ms / 7.28 ms per token
main:      eval time =  8100.28 ms / 115.72 ms per token
main:     total time = 10515.36 ms
