...
- status:  SUCCESS ✅
- runtime: 5:52.49
- date:    Wed Dec 13 04:28:58 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.23 sec
...
19/19 Test #19: test-backend-ops .................   Passed   44.79 sec
...
20/20 Test #20: test-backend-ops .................   Passed   13.35 sec
...
main:     load time =   301.01 ms
main:   sample time =    17.04 ms
main:  predict time =   809.80 ms / 12.65 ms per token
main:    total time =  1149.71 ms
...
main:     load time =   187.53 ms
main:   sample time =    16.76 ms
main:  predict time =   876.16 ms / 12.52 ms per token
main:    total time =  1083.30 ms
...
main:     n_decoded =      504
main:     load time =   163.68 ms
main:   sample time =   126.97 ms
main:  predict time =  5879.27 ms
main:    total time =  6251.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa78aa9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa772b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafba17ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa78aa050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa78af980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafba18980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa772b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafba17ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafba192f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafba18980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa78aa050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafba19c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafba192f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafba1a5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa78aa9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafba19c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafba1a7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafba1a5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa78af980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafba1a970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafba1a7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   190.52 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.96 ms
whisper_print_timings:   sample time =    65.70 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4657.27 ms /     1 runs ( 4657.27 ms per run)
whisper_print_timings:   decode time =    15.01 ms /     2 runs (    7.50 ms per run)
whisper_print_timings:   batchd time =   708.00 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5655.61 ms
...
main:     load time =    91.38 ms
main:    total time = 39478.91 ms
embd_img
...
main:      load time = 11863.46 ms
main:    sample time =   535.28 ms / 8.36 ms per token
main:      eval time = 43737.69 ms / 624.82 ms per token
main:     total time = 58513.80 ms
...
main:      load time =  4349.88 ms
main:    sample time =   524.22 ms / 8.19 ms per token
main:      eval time = 17787.83 ms / 254.11 ms per token
main:     total time = 23646.81 ms
