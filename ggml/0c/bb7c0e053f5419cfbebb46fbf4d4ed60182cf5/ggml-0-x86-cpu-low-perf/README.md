...
- status:  SUCCESS ✅
- runtime: 3:28.78
- date:    Sun May 19 08:08:59 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.82 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.30 sec
      Start  9: test3
...
Total Test time (real) =  74.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.61 sec
      Start  2: test-quantize-fns
...
main:     load time =   102.97 ms
main:   sample time =    23.89 ms
main:  predict time =   694.89 ms / 10.86 ms per token
main:    total time =   834.31 ms
...
main:  predict time =   736.62 ms / 10.52 ms per token
main:    total time =   862.68 ms
...
main:     load time =   121.87 ms
main:   sample time =    23.86 ms
main:  predict time =   747.76 ms / 10.68 ms per token
...
main:  predict time =  3105.65 ms
main:    total time =  3430.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7cbe068fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7cbe0677b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x604ff2d68ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7cbe068fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7cbe068ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x604ff2d69ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7cbe0677b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x604ff2d68ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x604ff2d6a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x604ff2d69ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7cbe068fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x604ff2d6ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x604ff2d6a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x604ff2d6b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7cbe068fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x604ff2d6ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x604ff2d6b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x604ff2d6b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7cbe068ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x604ff2d6ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x604ff2d6b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.47 ms
whisper_print_timings:   sample time =    71.58 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2013.24 ms /     1 runs ( 2013.24 ms per run)
whisper_print_timings:   decode time =    13.77 ms /     2 runs (    6.89 ms per run)
whisper_print_timings:   batchd time =   330.10 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2537.23 ms
