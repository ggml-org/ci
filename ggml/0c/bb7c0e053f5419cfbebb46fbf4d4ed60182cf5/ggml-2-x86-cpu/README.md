...
- status:  SUCCESS ✅
- runtime: 2:10.74
- date:    Sun May 19 08:22:51 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   16.11 sec
...
main:  predict time =   503.82 ms / 7.87 ms per token
main:    total time =   644.43 ms
...
main:     load time =   107.59 ms
main:   sample time =    23.94 ms
main:  predict time =   523.93 ms / 7.48 ms per token
main:    total time =   657.56 ms
...
main:     load time =   127.41 ms
main:   sample time =    24.02 ms
main:  predict time =   536.46 ms / 7.66 ms per token
main:    total time =   690.90 ms
...
main:     n_decoded =      504
main:     load time =   104.07 ms
main:   sample time =   178.18 ms
main:  predict time =  1828.23 ms
main:    total time =  2142.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x740dd04fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x740dd037b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60a324dddce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x740dd04fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x740dd04ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60a324ddeab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x740dd037b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60a324dddce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60a324ddf410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60a324ddeab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x740dd04fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60a324ddfd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60a324ddf410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60a324de06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x740dd04fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60a324ddfd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60a324de0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60a324de06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x740dd04ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x60a324de0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60a324de0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.89 ms
whisper_print_timings:   sample time =    55.82 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1153.31 ms /     1 runs ( 1153.31 ms per run)
whisper_print_timings:   decode time =    11.16 ms /     2 runs (    5.58 ms per run)
whisper_print_timings:   batchd time =   216.50 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1538.29 ms
...
main:     load time =    64.46 ms
main:    total time = 10669.48 ms
embd_img
