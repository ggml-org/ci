...
- status:  SUCCESS ✅
- runtime: 3:11.90
- date:    Sun May 19 08:13:52 UTC 2024
...
main:   sample time =    19.59 ms
main:  predict time =   929.22 ms / 14.52 ms per token
main:    total time =  1126.80 ms
...
main:  predict time =  1005.34 ms / 14.36 ms per token
main:    total time =  1184.66 ms
...
main:     load time =   184.10 ms
main:   sample time =    19.60 ms
main:  predict time =  1051.75 ms / 15.02 ms per token
main:    total time =  1258.81 ms
...
main:  predict time =  6480.21 ms
main:    total time =  6848.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xec1e1336a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xec1e131eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xab52309cbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xec1e1336a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xec1e1336f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xab52309ccab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xec1e131eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xab52309cbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xab52309cd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xab52309ccab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xec1e1336a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xab52309cdd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xab52309cd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xab52309ce6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xec1e1336a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xab52309cdd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xab52309ce890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xab52309ce6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xec1e1336f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xab52309cea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xab52309ce890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.09 ms
whisper_print_timings:   sample time =    70.06 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4690.74 ms /     1 runs ( 4690.74 ms per run)
whisper_print_timings:   decode time =    14.15 ms /     2 runs (    7.08 ms per run)
whisper_print_timings:   batchd time =   715.39 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5633.43 ms
...
main:     load time =    90.15 ms
main:    total time = 40156.39 ms
embd_img
