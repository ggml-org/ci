...
- status:  SUCCESS ✅
- runtime: 4:00.80
- date:    Sun May 19 08:09:35 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.29 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.52 sec
...
main:     load time =   139.21 ms
main:   sample time =    16.91 ms
main:  predict time =   899.40 ms / 14.05 ms per token
...
main:     load time =   139.17 ms
main:   sample time =    16.85 ms
main:  predict time =   978.44 ms / 13.98 ms per token
main:    total time =  1137.04 ms
...
main:     load time =   171.52 ms
main:   sample time =    17.17 ms
main:  predict time =  1037.50 ms / 14.82 ms per token
main:    total time =  1229.45 ms
...
main:     n_decoded =      504
main:     load time =   143.01 ms
main:   sample time =   128.25 ms
main:  predict time =  6454.19 ms
main:    total time =  6811.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xea783a82a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xea783a6ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc0cc4c990ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xea783a82a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xea783a82f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc0cc4c991ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xea783a6ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc0cc4c990ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc0cc4c992410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc0cc4c991ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xea783a82a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc0cc4c992d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc0cc4c992410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc0cc4c9936d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xea783a82a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc0cc4c992d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc0cc4c993890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc0cc4c9936d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xea783a82f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc0cc4c993a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc0cc4c993890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    99.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.84 ms
whisper_print_timings:   sample time =    65.70 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4669.75 ms /     1 runs ( 4669.75 ms per run)
whisper_print_timings:   decode time =    13.74 ms /     2 runs (    6.87 ms per run)
whisper_print_timings:   batchd time =   709.93 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5589.24 ms
...
main:     load time =    90.36 ms
main:    total time = 40000.41 ms
embd_img
