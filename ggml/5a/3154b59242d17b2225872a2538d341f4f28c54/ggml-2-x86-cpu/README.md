...
- status:  SUCCESS ✅
- runtime: 4:16.90
- date:    Mon Jan  8 21:40:46 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.97 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    4.77 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    2.35 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   27.07 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.29 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed    8.06 sec
...
main:     load time =   182.78 ms
main:   sample time =    23.46 ms
main:  predict time =   457.80 ms / 7.15 ms per token
main:    total time =   676.66 ms
...
main:     load time =   137.34 ms
main:   sample time =    23.49 ms
main:  predict time =   472.96 ms / 6.76 ms per token
main:    total time =   635.88 ms
...
main:     n_decoded =      504
main:     load time =   110.60 ms
main:   sample time =   178.07 ms
main:  predict time =  1516.50 ms
main:    total time =  1836.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98ed61d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98ed49e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9251a9b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98ed61d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98ed622940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c9251aa960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98ed49e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9251a9b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c9251ab2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c9251aa960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98ed61d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c9251abc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c9251ab2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c9251ac580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98ed61d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c9251abc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c9251ac740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c9251ac580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98ed622940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c9251ac900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c9251ac740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   120.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.11 ms
whisper_print_timings:   sample time =    55.17 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1160.45 ms /     1 runs ( 1160.45 ms per run)
whisper_print_timings:   decode time =     9.52 ms /     2 runs (    4.76 ms per run)
whisper_print_timings:   batchd time =   218.42 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1582.64 ms
...
main:     load time =    59.63 ms
main:    total time = 10626.40 ms
embd_img
...
main:      load time = 11954.98 ms
main:    sample time =   466.83 ms / 7.29 ms per token
main:      eval time = 20640.50 ms / 294.86 ms per token
main:     total time = 33771.05 ms
...
main:      load time =  4364.93 ms
main:    sample time =   465.69 ms / 7.28 ms per token
main:      eval time =  8462.27 ms / 120.89 ms per token
main:     total time = 13646.13 ms
