...
- status:  SUCCESS ✅
- runtime: 8:49.47
- date:    Mon Jan  8 21:45:19 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.76 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   61.41 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  93.82 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.71 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.58 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    0.56 sec
 ...
 9/21 Test  #9: test2 ............................   Passed    7.80 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    1.04 sec
      Start 11: test-pool
...
18/21 Test #18: test-conv2d ......................   Passed    0.56 sec
...
21/21 Test #21: test-backend-ops .................   Passed   21.95 sec
...
main:     load time =   576.98 ms
main:   sample time =    35.70 ms
main:  predict time =   602.89 ms / 9.42 ms per token
main:    total time =  1241.48 ms
...
main:   sample time =    33.48 ms
main:  predict time =   596.39 ms / 8.52 ms per token
main:    total time =  1224.85 ms
...
main:     n_decoded =      504
main:     load time =   539.66 ms
main:   sample time =   245.67 ms
main:  predict time =  2402.33 ms
main:    total time =  3233.87 ms
...
main: loaded model in   404.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffa927b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffa926371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e85a058690                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffa927b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffa927bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e85a059460                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffa926371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e85a058690                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e85a059dc0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e85a059460                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffa927b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e85a05a720                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e85a059dc0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e85a05b080                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffa927b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e85a05a720                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e85a05b240                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e85a05b080                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffa927bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e85a05b400                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e85a05b240       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   513.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    23.68 ms
whisper_print_timings:   sample time =    69.34 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    33.16 ms /     1 runs (   33.16 ms per run)
whisper_print_timings:   decode time =    13.61 ms /     2 runs (    6.80 ms per run)
whisper_print_timings:   batchd time =    81.98 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   743.99 ms
...
main:     load time =   491.83 ms
main:    total time =  7906.77 ms
embd_img
...
main:      load time = 25849.31 ms
main:    sample time =   544.55 ms / 8.51 ms per token
main:      eval time = 24939.79 ms / 356.28 ms per token
main:     total time = 52209.27 ms
...
main:      load time = 11253.63 ms
main:    sample time =   548.15 ms / 8.56 ms per token
main:      eval time = 12411.72 ms / 177.31 ms per token
main:     total time = 24870.96 ms
