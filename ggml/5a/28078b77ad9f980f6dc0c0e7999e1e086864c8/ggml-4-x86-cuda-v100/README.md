...
- status:  SUCCESS ✅
- runtime: 8:49.84
- date:    Wed Jan 10 13:22:35 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/5a28078b77ad9f980f6dc0c0e7999e1e086864c8
- author:  leejet
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    7.07 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.58 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.79 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    1.08 sec
      Start  5: test-mul-mat2
 5/20 Test  #5: test-mul-mat2 ....................   Passed    7.90 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.54 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
...
11/20 Test #11: test-conv-transpose ..............   Passed    0.54 sec
      Start 12: test-dup
...
20/20 Test #20: test-backend-ops .................   Passed   63.48 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.79 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   22.35 sec
...
main:     load time =   621.23 ms
main:   sample time =    35.50 ms
main:  predict time =   618.97 ms / 9.67 ms per token
main:    total time =  1296.44 ms
...
main:     load time =   574.55 ms
main:   sample time =    34.10 ms
main:  predict time =   603.28 ms / 8.62 ms per token
main:    total time =  1216.05 ms
...
main:     n_decoded =      504
main:     load time =   533.76 ms
main:   sample time =   235.57 ms
main:  predict time =  2321.14 ms
main:    total time =  3136.55 ms
...
main: loaded model in   410.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb771fb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb771e371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558da3a6d4f0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb771fb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb771fbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558da3a6e2c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb771e371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558da3a6d4f0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558da3a6ec20                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558da3a6e2c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb771fb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558da3a6f580                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558da3a6ec20                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558da3a6fee0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb771fb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558da3a6f580                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558da3a700a0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558da3a6fee0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb771fbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558da3a70260                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558da3a700a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   506.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.04 ms
whisper_print_timings:   sample time =    69.42 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    32.58 ms /     1 runs (   32.58 ms per run)
whisper_print_timings:   decode time =    17.88 ms /     2 runs (    8.94 ms per run)
whisper_print_timings:   batchd time =    84.11 ms /   125 runs (    0.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   738.33 ms
...
main:     load time =   508.91 ms
main:    total time =  7952.02 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.641000 sec.)
...
main:      load time = 24340.45 ms
main:    sample time =   547.63 ms / 8.56 ms per token
main:      eval time = 25777.02 ms / 368.24 ms per token
main:     total time = 51516.09 ms
...
main:      load time = 10248.18 ms
main:    sample time =   541.19 ms / 8.46 ms per token
main:      eval time = 12570.56 ms / 179.58 ms per token
main:     total time = 23998.95 ms
