...
- status:  SUCCESS ✅
- runtime: 3:33.41
- date:    Wed Jan 10 01:17:32 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.26 sec
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.60 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.47 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   43.15 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  66.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.38 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.53 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
main:     load time =   192.10 ms
main:   sample time =    17.74 ms
main:  predict time =   850.98 ms / 13.30 ms per token
main:    total time =  1082.74 ms
...
main:     load time =   193.60 ms
main:   sample time =    17.84 ms
main:  predict time =   929.88 ms / 13.28 ms per token
main:    total time =  1144.37 ms
...
main:     n_decoded =      504
main:     load time =   163.15 ms
main:   sample time =   128.30 ms
main:  predict time =  6179.73 ms
main:    total time =  6553.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e75a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e5db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad1f1eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e75a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e75f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad1f1f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e5db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad1f1eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad1f202c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad1f1f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e75a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad1f20c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad1f202c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad1f21580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e75a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad1f20c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad1f21740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad1f21580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e75f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad1f21900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad1f21740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    67.01 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4798.53 ms /     1 runs ( 4798.53 ms per run)
whisper_print_timings:   decode time =    15.72 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   716.13 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5729.17 ms
...
main:     load time =    97.38 ms
main:    total time = 40639.39 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.263000 sec.)
