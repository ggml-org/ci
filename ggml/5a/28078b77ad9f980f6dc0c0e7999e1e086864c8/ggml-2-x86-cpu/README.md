...
- status:  SUCCESS ✅
- runtime: 4:16.30
- date:    Wed Jan 10 13:18:05 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   27.92 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.02 sec
...
main:     load time =   189.09 ms
main:   sample time =    23.45 ms
main:  predict time =   451.46 ms / 7.05 ms per token
main:    total time =   676.82 ms
...
main:     load time =   134.44 ms
main:   sample time =    23.36 ms
main:  predict time =   460.79 ms / 6.58 ms per token
main:    total time =   620.75 ms
...
main:  predict time =  1509.33 ms
main:    total time =  1822.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f56e3de9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56e3c6a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55dcbe18cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f56e3de9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f56e3dee940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55dcbe18d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56e3c6a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55dcbe18cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55dcbe18e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55dcbe18d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f56e3de9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55dcbe18ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55dcbe18e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55dcbe18f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f56e3de9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55dcbe18ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55dcbe18f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55dcbe18f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f56e3dee940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55dcbe18f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55dcbe18f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.42 ms
whisper_print_timings:   sample time =    54.87 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1156.46 ms /     1 runs ( 1156.46 ms per run)
whisper_print_timings:   decode time =    10.27 ms /     2 runs (    5.14 ms per run)
whisper_print_timings:   batchd time =   209.22 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1575.94 ms
...
main:     load time =    62.10 ms
main:    total time = 10627.47 ms
embd_img
...
main:      load time = 11474.71 ms
main:    sample time =   469.16 ms / 7.33 ms per token
main:      eval time = 20634.29 ms / 294.78 ms per token
main:     total time = 33244.26 ms
...
main:      load time =  4383.97 ms
main:    sample time =   464.73 ms / 7.26 ms per token
main:      eval time =  8257.45 ms / 117.96 ms per token
main:     total time = 13456.27 ms
