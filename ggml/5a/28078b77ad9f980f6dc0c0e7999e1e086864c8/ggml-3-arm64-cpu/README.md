...
- status:  SUCCESS ✅
- runtime: 5:51.12
- date:    Wed Jan 10 01:19:36 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   34.97 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.02 sec
...
main:  predict time =   822.59 ms / 12.85 ms per token
main:    total time =  1124.79 ms
...
main:     load time =   181.16 ms
main:   sample time =    16.88 ms
main:  predict time =   907.02 ms / 12.96 ms per token
main:    total time =  1107.90 ms
...
main:  predict time =  6002.27 ms
main:    total time =  6355.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff984ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9836b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9117b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff984ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff984ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae9118960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9836b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae9117b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae91192c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae9118960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff984ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae9119c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae91192c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae911a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff984ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae9119c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae911a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae911a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff984ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae911a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae911a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   165.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.93 ms
whisper_print_timings:   sample time =    65.29 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4637.43 ms /     1 runs ( 4637.43 ms per run)
whisper_print_timings:   decode time =    15.15 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   707.46 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5608.28 ms
...
main:     load time =    78.58 ms
main:    total time = 39694.14 ms
embd_img
...
main:      load time = 12850.18 ms
main:    sample time =   523.94 ms / 8.19 ms per token
main:      eval time = 43724.12 ms / 624.63 ms per token
main:     total time = 59472.09 ms
...
main:      load time =  4336.06 ms
main:    sample time =   514.03 ms / 8.03 ms per token
main:      eval time = 17435.10 ms / 249.07 ms per token
main:     total time = 23241.40 ms
