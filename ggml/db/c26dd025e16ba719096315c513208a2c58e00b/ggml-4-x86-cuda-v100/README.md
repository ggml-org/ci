...
- status:  SUCCESS ✅
- runtime: 12:28.13
- date:    Sun Jan 28 16:57:45 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  257.88 sec
...
21/21 Test #21: test-backend-ops .................   Passed   43.31 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  88.46 sec
...
main:     load time =   895.22 ms
main:   sample time =    33.74 ms
main:  predict time =   591.58 ms / 9.24 ms per token
main:    total time =  1544.63 ms
...
main:     load time =   590.21 ms
main:   sample time =    34.74 ms
main:  predict time =   619.99 ms / 8.86 ms per token
main:    total time =  1249.40 ms
...
main:     n_decoded =      504
main:     load time =   538.56 ms
main:   sample time =   232.12 ms
main:  predict time =  2318.54 ms
main:    total time =  3143.54 ms
...
main: loaded model in   410.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f55decf8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f55deb791a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b08d51900                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f55decf8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f55decfd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555b08d526d0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f55deb791a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b08d51900                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555b08d53030                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555b08d526d0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f55decf8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555b08d53990                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555b08d53030                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555b08d542f0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f55decf8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555b08d53990                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555b08d544b0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555b08d542f0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f55decfd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555b08d54670                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555b08d544b0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   860.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.60 ms
whisper_print_timings:   sample time =    69.29 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    22.64 ms /     1 runs (   22.64 ms per run)
whisper_print_timings:   decode time =    21.22 ms /     2 runs (   10.61 ms per run)
whisper_print_timings:   batchd time =    84.08 ms /   125 runs (    0.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1083.71 ms
...
main:     load time =   510.54 ms
main:    total time =  7955.92 ms
embd_img
...
main:      load time =  8243.03 ms
main:    sample time =   525.40 ms / 8.21 ms per token
main:      eval time = 26385.07 ms / 376.93 ms per token
main:     total time = 36049.93 ms
...
main:      load time =  2047.56 ms
main:    sample time =   514.97 ms / 8.05 ms per token
main:      eval time = 12489.15 ms / 178.42 ms per token
main:     total time = 15713.54 ms
