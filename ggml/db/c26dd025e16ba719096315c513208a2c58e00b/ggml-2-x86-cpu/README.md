...
- status:  SUCCESS ✅
- runtime: 5:43.61
- date:    Sun Jan 28 16:51:09 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.95 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  112.90 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 124.76 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.62 sec
...
main:     load time =   191.19 ms
main:   sample time =    23.99 ms
main:  predict time =   472.59 ms / 7.38 ms per token
main:    total time =   701.01 ms
...
main:     load time =   136.78 ms
main:   sample time =    23.49 ms
main:  predict time =   479.98 ms / 6.86 ms per token
main:    total time =   642.65 ms
...
main:   sample time =   177.79 ms
main:  predict time =  1518.63 ms
main:    total time =  1834.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43bdb2e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f43bd9af1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557e94476b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43bdb2e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43bdb33940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557e94477960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f43bd9af1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557e94476b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557e944782c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557e94477960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f43bdb2e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557e94478c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557e944782c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557e94479580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f43bdb2e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557e94478c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557e94479740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557e94479580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f43bdb33940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557e94479900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557e94479740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.95 ms
whisper_print_timings:   sample time =    54.81 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1158.63 ms /     1 runs ( 1158.63 ms per run)
whisper_print_timings:   decode time =    10.18 ms /     2 runs (    5.09 ms per run)
whisper_print_timings:   batchd time =   216.88 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1583.44 ms
...
main:      load time = 14943.78 ms
main:    sample time =   471.05 ms / 7.36 ms per token
main:      eval time = 20742.11 ms / 296.32 ms per token
main:     total time = 36825.84 ms
...
main:      load time =  4380.44 ms
main:    sample time =   467.38 ms / 7.30 ms per token
main:      eval time =  8439.15 ms / 120.56 ms per token
main:     total time = 13639.79 ms
