...
- status:  SUCCESS ✅
- runtime: 4:54.44
- date:    Sun Jan 28 16:50:11 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.58 sec
...
20/20 Test #20: test-backend-ops .................   Passed  117.35 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 156.36 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.41 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.48 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.73 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.00 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   19.01 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  54.08 sec
...
main:     load time =   130.97 ms
main:   sample time =    24.02 ms
main:  predict time =   652.09 ms / 10.19 ms per token
main:    total time =   820.31 ms
...
main:     load time =   129.82 ms
main:   sample time =    23.97 ms
main:  predict time =   673.57 ms / 9.62 ms per token
main:    total time =   829.94 ms
...
main:     n_decoded =      504
main:     load time =   107.20 ms
main:   sample time =   178.22 ms
main:  predict time =  2541.13 ms
main:    total time =  2871.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c635e0990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c634611a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5594f5b4bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c635e0030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c635e5940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5594f5b4c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c634611a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5594f5b4bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5594f5b4d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5594f5b4c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c635e0030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5594f5b4dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5594f5b4d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5594f5b4e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c635e0990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5594f5b4dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5594f5b4e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5594f5b4e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c635e5940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5594f5b4e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5594f5b4e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.86 ms
whisper_print_timings:   sample time =    72.62 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2000.12 ms /     1 runs ( 2000.12 ms per run)
whisper_print_timings:   decode time =    13.26 ms /     2 runs (    6.63 ms per run)
whisper_print_timings:   batchd time =   329.81 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2518.69 ms
...
main:     load time =    69.35 ms
main:    total time = 19076.90 ms
embd_img
