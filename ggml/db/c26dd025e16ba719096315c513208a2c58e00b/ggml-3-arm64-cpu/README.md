...
- status:  SUCCESS ✅
- runtime: 7:34.14
- date:    Sun Jan 28 04:53:00 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  128.79 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 142.85 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.86 sec
...
main:     load time =   258.02 ms
main:   sample time =    17.01 ms
main:  predict time =   858.21 ms / 13.41 ms per token
main:    total time =  1155.14 ms
...
main:  predict time =   934.43 ms / 13.35 ms per token
main:    total time =  1132.70 ms
...
main:  predict time =  5994.57 ms
main:    total time =  6351.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ec2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9eaab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf0f0bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ec2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ec2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf0f0c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9eaab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf0f0bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf0f0d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf0f0c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9ec2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf0f0dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf0f0d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf0f0e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9ec2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf0f0dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf0f0e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf0f0e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9ec2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf0f0e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf0f0e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   177.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.16 ms
whisper_print_timings:   sample time =    65.50 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4623.15 ms /     1 runs ( 4623.15 ms per run)
whisper_print_timings:   decode time =    15.65 ms /     2 runs (    7.83 ms per run)
whisper_print_timings:   batchd time =   711.92 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5611.91 ms
...
main:     load time =    80.46 ms
main:    total time = 39735.30 ms
embd_img
...
main:      load time = 13461.08 ms
main:    sample time =   519.38 ms / 8.12 ms per token
main:      eval time = 43871.30 ms / 626.73 ms per token
main:     total time = 60226.18 ms
...
main:      load time =  4373.01 ms
main:    sample time =   514.54 ms / 8.04 ms per token
main:      eval time = 17461.46 ms / 249.45 ms per token
main:     total time = 23304.84 ms
