...
- status:  SUCCESS ✅
- runtime: 3:22.92
- date:    Fri Dec 29 08:36:08 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   26.56 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.34 sec
...
main:  predict time =   438.10 ms / 6.85 ms per token
main:    total time =   601.50 ms
...
main:     load time =   123.33 ms
main:   sample time =    23.41 ms
main:  predict time =   455.21 ms / 6.50 ms per token
main:    total time =   604.04 ms
...
main:  predict time =  1462.26 ms
main:    total time =  1776.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbf8506d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbf84eee1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e99bc64b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbf8506d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbf85072940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e99bc65960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbf84eee1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e99bc64b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e99bc662c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e99bc65960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbf8506d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e99bc66c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e99bc662c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e99bc67580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbf8506d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e99bc66c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e99bc67740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e99bc67580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbf85072940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e99bc67900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e99bc67740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    80.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.12 ms
whisper_print_timings:   sample time =    55.24 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1154.45 ms /     1 runs ( 1154.45 ms per run)
whisper_print_timings:   decode time =     9.92 ms /     2 runs (    4.96 ms per run)
whisper_print_timings:   batchd time =   208.98 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1528.72 ms
...
main:     load time =    64.93 ms
main:    total time = 10552.38 ms
embd_img
...
main:      load time =  4305.48 ms
main:    sample time =   468.99 ms / 7.33 ms per token
main:      eval time = 19214.34 ms / 274.49 ms per token
main:     total time = 24623.55 ms
...
main:      load time =  1192.97 ms
main:    sample time =   465.95 ms / 7.28 ms per token
main:      eval time =  8002.31 ms / 114.32 ms per token
main:     total time = 10035.24 ms
