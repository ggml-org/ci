...
- status:  SUCCESS ✅
- runtime: 2:48.96
- date:    Fri Dec 29 08:35:31 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/dbd02958fa4f46898f68ca29c27ddcdc58a06f98
- author:  bssrdf
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.08 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   35.02 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.20 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.10 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.89 sec
...
main:     load time =   134.08 ms
main:   sample time =    23.66 ms
main:  predict time =   630.91 ms / 9.86 ms per token
main:    total time =   801.41 ms
...
main:  predict time =   645.35 ms / 9.22 ms per token
main:    total time =   805.24 ms
...
main:     n_decoded =      504
main:     load time =   107.35 ms
main:   sample time =   178.35 ms
main:  predict time =  2381.49 ms
main:    total time =  2712.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cff531990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cff3b21a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563605cabb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cff531030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cff536940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563605cac960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cff3b21a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563605cabb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563605cad2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563605cac960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cff531030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563605cadc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563605cad2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563605cae580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cff531990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563605cadc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563605cae740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563605cae580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cff536940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563605cae900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563605cae740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.34 ms
whisper_print_timings:   sample time =    72.01 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1982.18 ms /     1 runs ( 1982.18 ms per run)
whisper_print_timings:   decode time =    12.65 ms /     2 runs (    6.32 ms per run)
whisper_print_timings:   batchd time =   322.75 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2492.73 ms
...
main:     load time =    70.39 ms
main:    total time = 18802.63 ms
embd_img
