...
- status:  SUCCESS ✅
- runtime: 3:35.75
- date:    Fri Dec 29 08:36:22 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.68 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   43.28 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.08 sec
...
main:     load time =   192.07 ms
main:   sample time =    18.00 ms
main:  predict time =   867.93 ms / 13.56 ms per token
...
main:     load time =   196.37 ms
main:   sample time =    18.01 ms
main:  predict time =   914.99 ms / 13.07 ms per token
main:    total time =  1132.47 ms
...
main:     n_decoded =      504
main:     load time =   162.01 ms
main:   sample time =   130.54 ms
main:  predict time =  6111.82 ms
main:    total time =  6486.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff996ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9953b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeaebbb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff996ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff996bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeaebc960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9953b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeaebbb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeaebd2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeaebc960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff996ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeaebdc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeaebd2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeaebe580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff996ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeaebdc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeaebe740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeaebe580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff996bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeaebe900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeaebe740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    66.82 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4727.72 ms /     1 runs ( 4727.72 ms per run)
whisper_print_timings:   decode time =    15.72 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   711.86 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5655.70 ms
...
main:     load time =    97.73 ms
main:    total time = 40340.45 ms
embd_img
