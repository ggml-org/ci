...
- status:  SUCCESS ✅
- runtime: 5:12.89
- date:    Fri Dec 29 08:37:52 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.96 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.07 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed   10.44 sec
...
main:     load time =   187.06 ms
main:   sample time =    17.16 ms
main:  predict time =   810.56 ms / 12.67 ms per token
main:    total time =  1036.55 ms
...
main:     load time =   185.16 ms
main:   sample time =    16.73 ms
main:  predict time =   878.48 ms / 12.55 ms per token
main:    total time =  1083.28 ms
...
main:  predict time =  5894.38 ms
main:    total time =  6252.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0fda990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0e5b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0b53b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0fda030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0fdf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad0b54960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb0e5b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0b53b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad0b552c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad0b54960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0fda030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad0b55c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad0b552c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad0b56580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0fda990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad0b55c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad0b56740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad0b56580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0fdf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad0b56900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad0b56740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4627.05 ms /     1 runs ( 4627.05 ms per run)
whisper_print_timings:   decode time =    15.11 ms /     2 runs (    7.56 ms per run)
whisper_print_timings:   batchd time =   705.83 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5540.53 ms
...
main:      load time =  5459.46 ms
main:    sample time =   517.24 ms / 8.08 ms per token
main:      eval time = 43808.87 ms / 625.84 ms per token
main:     total time = 52157.62 ms
...
main:      load time =  1604.81 ms
main:    sample time =   516.92 ms / 8.08 ms per token
main:      eval time = 17110.78 ms / 244.44 ms per token
main:     total time = 20204.54 ms
