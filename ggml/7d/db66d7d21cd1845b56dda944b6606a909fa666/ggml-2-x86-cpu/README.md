...
- status:  SUCCESS ✅
- runtime: 2:40.10
- date:    Fri Sep 15 16:20:31 UTC 2023
...
main:     load time =   211.63 ms
main:   sample time =    23.85 ms
main:  predict time =   428.34 ms / 6.69 ms per token
...
main:     load time =   134.04 ms
main:   sample time =    23.78 ms
main:  predict time =   445.44 ms / 6.36 ms per token
main:    total time =   606.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe1f628a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe1f610b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e16b603ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe1f6289fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe1f628f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e16b604850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe1f610b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e16b603ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e16b605170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e16b604850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe1f6289fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e16b605a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e16b605170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e16b6063b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe1f628a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e16b605a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e16b606530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e16b6063b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe1f628f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e16b6066b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e16b606530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  8824.35 ms
main:    sample time =   469.60 ms / 7.34 ms per token
main:      eval time = 20157.74 ms / 287.97 ms per token
main:     total time = 30151.40 ms
...
main:      load time =  3197.53 ms
main:    sample time =   468.65 ms / 7.32 ms per token
main:      eval time =  8064.77 ms / 115.21 ms per token
main:     total time = 12114.35 ms
