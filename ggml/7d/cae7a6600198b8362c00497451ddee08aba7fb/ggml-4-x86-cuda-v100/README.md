...
- status:  SUCCESS ✅
- runtime: 4:51.54
- date:    Wed Oct 11 19:03:33 UTC 2023
...
main:     load time =  1108.30 ms
main:   sample time =    35.77 ms
main:  predict time =   596.64 ms / 9.32 ms per token
main:    total time =  1761.21 ms
...
main:  predict time =   585.98 ms / 8.37 ms per token
main:    total time =   785.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff85be54900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff85bcd5170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5570d1102ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff85be53fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff85be59880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5570d1103870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff85bcd5170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5570d1102ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5570d11041a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5570d1103870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff85be53fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5570d1104ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5570d11041a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5570d1105400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff85be54900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5570d1104ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5570d1105590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5570d1105400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff85be59880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5570d1105720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5570d1105590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   655.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.81 ms
whisper_print_timings:   sample time =    23.71 ms /    27 runs (    0.88 ms per run)
whisper_print_timings:   encode time =  1846.78 ms /     1 runs ( 1846.78 ms per run)
whisper_print_timings:   decode time =   133.48 ms /    27 runs (    4.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2744.70 ms
```
### mpt
...
main:      load time =  7077.69 ms
main:    sample time =   580.07 ms / 9.06 ms per token
main:      eval time = 24829.07 ms / 354.70 ms per token
main:     total time = 33362.98 ms
...
main:      load time =  1645.12 ms
main:    sample time =   576.80 ms / 9.01 ms per token
main:      eval time = 12470.94 ms / 178.16 ms per token
main:     total time = 15314.88 ms
