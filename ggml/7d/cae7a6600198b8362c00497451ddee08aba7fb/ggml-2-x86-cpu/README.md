...
- status:  SUCCESS ✅
- runtime: 2:58.60
- date:    Wed Oct 11 18:55:58 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.82 sec
      Start  2: test-opt
...
main:     load time =   171.04 ms
main:   sample time =    24.09 ms
main:  predict time =   474.46 ms / 7.41 ms per token
main:    total time =   683.35 ms
...
main:  predict time =   491.95 ms / 7.03 ms per token
main:    total time =   635.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb67f60d900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb67f48e170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b4dc805ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb67f60cfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb67f612880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b4dc806870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb67f48e170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b4dc805ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b4dc8071a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b4dc806870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb67f60cfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b4dc807ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b4dc8071a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b4dc808400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb67f60d900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b4dc807ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b4dc808590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b4dc808400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb67f612880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b4dc808720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b4dc808590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   150.87 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.84 ms
whisper_print_timings:   sample time =    16.52 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1162.03 ms /     1 runs ( 1162.03 ms per run)
whisper_print_timings:   decode time =   109.07 ms /    27 runs (    4.04 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1497.08 ms
```
### mpt
...
main:      load time = 11820.95 ms
main:    sample time =   465.06 ms / 7.27 ms per token
main:      eval time = 22021.98 ms / 314.60 ms per token
main:     total time = 35022.09 ms
...
main:      load time =  4415.81 ms
main:    sample time =   463.21 ms / 7.24 ms per token
main:      eval time =  8773.05 ms / 125.33 ms per token
main:     total time = 14045.76 ms
