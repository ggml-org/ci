...
- status:  SUCCESS ✅
- runtime: 5:45.31
- date:    Fri Jan 12 08:27:54 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   40.37 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.89 sec
...
main:     load time =   293.65 ms
main:   sample time =    16.78 ms
main:  predict time =   843.13 ms / 13.17 ms per token
main:    total time =  1175.63 ms
...
main:     load time =   188.80 ms
main:   sample time =    16.96 ms
main:  predict time =   913.27 ms / 13.05 ms per token
main:    total time =  1122.16 ms
...
main:     n_decoded =      504
main:     load time =   158.78 ms
main:   sample time =   128.20 ms
main:  predict time =  6046.22 ms
main:    total time =  6414.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd7fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbd67b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacb237b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd7fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd7ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacb238960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbd67b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacb237b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacb2392c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacb238960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd7fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacb239c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacb2392c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacb23a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd7fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacb239c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacb23a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacb23a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd7ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacb23a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacb23a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   186.52 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.77 ms
whisper_print_timings:   sample time =    65.81 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4655.82 ms /     1 runs ( 4655.82 ms per run)
whisper_print_timings:   decode time =    15.48 ms /     2 runs (    7.74 ms per run)
whisper_print_timings:   batchd time =   707.99 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5650.69 ms
...
main:      load time = 12664.33 ms
main:    sample time =   519.20 ms / 8.11 ms per token
main:      eval time = 43706.93 ms / 624.38 ms per token
main:     total time = 59263.66 ms
...
main:      load time =  4351.21 ms
main:    sample time =   514.87 ms / 8.04 ms per token
main:      eval time = 17357.01 ms / 247.96 ms per token
main:     total time = 23188.32 ms
