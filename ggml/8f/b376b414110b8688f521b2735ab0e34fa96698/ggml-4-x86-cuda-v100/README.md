...
- status:  SUCCESS ✅
- runtime: 8:08.61
- date:    Fri Jan 12 20:33:34 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.67 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.86 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   73.76 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 106.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.67 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.83 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   28.00 sec
...
main:     load time =   611.14 ms
main:   sample time =    34.05 ms
main:  predict time =   577.67 ms / 9.03 ms per token
main:    total time =  1242.95 ms
...
main:     load time =   581.86 ms
main:   sample time =    34.51 ms
main:  predict time =   622.43 ms / 8.89 ms per token
main:    total time =  1243.46 ms
...
main:     n_decoded =      504
main:     load time =   559.15 ms
main:   sample time =   233.42 ms
main:  predict time =  2278.80 ms
main:    total time =  3115.81 ms
...
main: loaded model in   425.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcd236f9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcd2357a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55786f22c7b0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcd236f9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcd236fe940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55786f22d580                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcd2357a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55786f22c7b0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55786f22dee0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55786f22d580                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcd236f9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55786f22e840                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55786f22dee0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55786f22f1a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcd236f9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55786f22e840                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55786f22f360                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55786f22f1a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcd236fe940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55786f22f520                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55786f22f360       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   604.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.65 ms
whisper_print_timings:   sample time =    70.25 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =    21.21 ms /     1 runs (   21.21 ms per run)
whisper_print_timings:   decode time =    21.27 ms /     2 runs (   10.64 ms per run)
whisper_print_timings:   batchd time =    81.77 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   827.12 ms
...
main:     load time =   521.30 ms
main:    total time =  7972.69 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.636000 sec.)
...
main:      load time =  7651.12 ms
main:    sample time =   540.83 ms / 8.45 ms per token
main:      eval time = 26346.56 ms / 376.38 ms per token
main:     total time = 35420.02 ms
...
main:      load time =  2227.53 ms
main:    sample time =   538.63 ms / 8.42 ms per token
main:      eval time = 12949.27 ms / 184.99 ms per token
main:     total time = 16362.98 ms
