...
- status:  SUCCESS ✅
- runtime: 4:08.46
- date:    Fri Jan 12 20:02:26 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   32.21 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  43.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.35 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed    9.19 sec
...
main:     load time =   196.98 ms
main:   sample time =    23.42 ms
main:  predict time =   456.68 ms / 7.14 ms per token
main:    total time =   689.86 ms
...
main:     load time =   125.68 ms
main:   sample time =    23.44 ms
main:  predict time =   470.24 ms / 6.72 ms per token
main:    total time =   621.78 ms
...
main:     n_decoded =      504
main:     load time =   106.02 ms
main:   sample time =   177.64 ms
main:  predict time =  1506.83 ms
main:    total time =  1822.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7bc3fb4990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7bc3e351a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c93b4dbb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7bc3fb4030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7bc3fb9940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c93b4dc960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7bc3e351a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c93b4dbb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c93b4dd2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c93b4dc960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7bc3fb4030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c93b4ddc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c93b4dd2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c93b4de580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7bc3fb4990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c93b4ddc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c93b4de740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c93b4de580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7bc3fb9940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c93b4de900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c93b4de740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.10 ms
whisper_print_timings:   sample time =    55.89 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1171.15 ms /     1 runs ( 1171.15 ms per run)
whisper_print_timings:   decode time =     9.99 ms /     2 runs (    4.99 ms per run)
whisper_print_timings:   batchd time =   210.02 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1592.12 ms
...
main:      load time =  5665.05 ms
main:    sample time =   468.63 ms / 7.32 ms per token
main:      eval time = 20644.96 ms / 294.93 ms per token
main:     total time = 27447.51 ms
...
main:      load time =  1197.42 ms
main:    sample time =   519.79 ms / 8.12 ms per token
main:      eval time =  9925.90 ms / 141.80 ms per token
main:     total time = 12018.77 ms
