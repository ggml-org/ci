...
- status:  SUCCESS ✅
- runtime: 3:37.45
- date:    Fri Jan 12 07:58:42 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.93 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.53 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   49.02 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  72.60 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.73 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.52 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.56 sec
      Start 10: test-pool
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   11.03 sec
...
main:     load time =   188.90 ms
main:   sample time =    17.15 ms
main:  predict time =   863.08 ms / 13.49 ms per token
main:    total time =  1091.08 ms
...
main:     load time =   189.87 ms
main:   sample time =    17.15 ms
main:  predict time =   933.15 ms / 13.33 ms per token
main:    total time =  1143.24 ms
...
main:     n_decoded =      504
main:     load time =   159.19 ms
main:   sample time =   126.75 ms
main:  predict time =  6168.74 ms
main:    total time =  6537.22 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f8aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f72b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac79a2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f8aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f8af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac79a3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7f72b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac79a2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac79a42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac79a3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f8aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac79a4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac79a42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac79a5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f8aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac79a4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac79a5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac79a5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f8af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac79a5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac79a5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.68 ms
whisper_print_timings:   sample time =    66.39 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4687.76 ms /     1 runs ( 4687.76 ms per run)
whisper_print_timings:   decode time =    15.52 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   833.57 ms /   125 runs (    6.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5732.70 ms
...
main:     load time =    94.68 ms
main:    total time = 40714.12 ms
embd_img
