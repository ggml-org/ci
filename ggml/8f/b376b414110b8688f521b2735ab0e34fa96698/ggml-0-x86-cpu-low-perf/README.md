...
- status:  SUCCESS ✅
- runtime: 2:54.93
- date:    Fri Jan 12 19:56:46 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/8fb376b414110b8688f521b2735ab0e34fa96698
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.44 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.31 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   40.95 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  63.74 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.16 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.52 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.60 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.00 sec
      Start 11: test-conv-transpose
11/20 Test #11: test-conv-transpose ..............   Passed    0.00 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.06 sec
...
main:     load time =   127.81 ms
main:   sample time =    23.55 ms
main:  predict time =   654.56 ms / 10.23 ms per token
main:    total time =   819.19 ms
...
main:  predict time =   656.07 ms / 9.37 ms per token
main:    total time =   812.08 ms
...
main:     n_decoded =      504
main:     load time =   106.99 ms
main:   sample time =   178.25 ms
main:  predict time =  2488.99 ms
main:    total time =  2819.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f29fc864990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f29fc6e51a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5596d6bacb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f29fc864030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f29fc869940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5596d6bad960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f29fc6e51a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5596d6bacb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5596d6bae2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5596d6bad960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f29fc864030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5596d6baec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5596d6bae2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5596d6baf580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f29fc864990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5596d6baec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5596d6baf740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5596d6baf580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f29fc869940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5596d6baf900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5596d6baf740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.04 ms
whisper_print_timings:   sample time =    72.53 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1989.52 ms /     1 runs ( 1989.52 ms per run)
whisper_print_timings:   decode time =    12.25 ms /     2 runs (    6.13 ms per run)
whisper_print_timings:   batchd time =   323.74 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2500.01 ms
...
main:     load time =    70.38 ms
main:    total time = 18973.66 ms
embd_img
