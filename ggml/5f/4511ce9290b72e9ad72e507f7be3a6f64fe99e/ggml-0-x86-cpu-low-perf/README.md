...
- status:  SUCCESS ✅
- runtime: 2:20.13
- date:    Tue Mar  4 19:11:25 UTC 2025
...
main:     load time =   115.45 ms
main:   sample time =    32.27 ms
main:  predict time =   705.28 ms / 11.02 ms per token
main:    total time =   868.45 ms
...
main:  predict time =   740.25 ms / 10.57 ms per token
main:    total time =   911.30 ms
...
main:     n_decoded =      504
main:     load time =   118.05 ms
main:   sample time =   207.91 ms
main:  predict time =  2914.56 ms
main:    total time =  3299.49 ms
