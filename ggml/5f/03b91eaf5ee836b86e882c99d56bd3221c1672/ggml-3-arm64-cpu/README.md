...
- status:  SUCCESS ✅
- runtime: 3:31.99
- date:    Tue Aug 29 13:24:06 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/5f03b91eaf5ee836b86e882c99d56bd3221c1672
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.59 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.53 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    0.12 sec
      Start 10: test3
...
main:     load time =   263.49 ms
main:   sample time =    17.25 ms
main:  predict time =   809.41 ms / 12.65 ms per token
...
main:     load time =   174.26 ms
main:   sample time =    17.23 ms
main:  predict time =   876.71 ms / 12.52 ms per token
main:    total time =  1071.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9802a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97eab150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadfc81ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98029f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9802f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadfc82830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff97eab150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadfc81ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadfc83140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadfc82830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98029f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadfc83a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadfc83140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadfc84360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9802a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadfc83a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadfc844d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadfc84360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9802f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadfc84640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadfc844d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5894.81 ms
main:    sample time =   618.13 ms / 9.66 ms per token
main:      eval time = 43757.53 ms / 625.11 ms per token
main:     total time = 52659.52 ms
...
main:      load time =  1502.36 ms
main:    sample time =   619.69 ms / 9.68 ms per token
main:      eval time = 17271.30 ms / 246.73 ms per token
main:     total time = 20353.11 ms
