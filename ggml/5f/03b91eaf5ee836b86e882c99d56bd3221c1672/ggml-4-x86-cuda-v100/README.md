...
- status:  SUCCESS ✅
- runtime: 5:10.48
- date:    Tue Aug 29 13:25:37 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.48 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.46 sec
      Start  2: test-opt
...
main:     load time =   268.71 ms
main:   sample time =    37.04 ms
main:  predict time =   596.78 ms / 9.32 ms per token
main:    total time =   923.60 ms
...
main:     load time =   195.90 ms
main:   sample time =    34.83 ms
main:  predict time =   583.22 ms / 8.33 ms per token
main:    total time =   818.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbcdcac78a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbcdc948150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5565ba1e4ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbcdcac6f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbcdcacc800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5565ba1e5830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbcdc948150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5565ba1e4ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5565ba1e6140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5565ba1e5830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbcdcac6f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5565ba1e6a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5565ba1e6140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5565ba1e7360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbcdcac78a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5565ba1e6a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5565ba1e74d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5565ba1e7360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbcdcacc800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5565ba1e7640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5565ba1e74d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 14325.46 ms
main:    sample time =   578.03 ms / 9.03 ms per token
main:      eval time = 24905.29 ms / 355.79 ms per token
main:     total time = 40706.16 ms
...
main:      load time =  9175.05 ms
main:    sample time =   594.87 ms / 9.29 ms per token
main:      eval time = 12264.71 ms / 175.21 ms per token
main:     total time = 22715.64 ms
