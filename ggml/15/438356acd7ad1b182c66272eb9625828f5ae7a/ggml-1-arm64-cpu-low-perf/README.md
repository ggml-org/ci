...
- status:  SUCCESS ✅
- runtime: 5:47.39
- date:    Mon Feb 12 07:36:07 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.55 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  147.54 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 184.22 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.60 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.58 sec
      Start 10: test-pool
...
main:     load time =   160.67 ms
main:   sample time =    17.60 ms
main:  predict time =   859.38 ms / 13.43 ms per token
main:    total time =  1059.32 ms
...
main:     load time =   194.16 ms
main:   sample time =    17.29 ms
main:  predict time =   950.67 ms / 13.58 ms per token
main:    total time =  1165.45 ms
...
main:     n_decoded =      504
main:     load time =   160.11 ms
main:   sample time =   128.50 ms
main:  predict time =  6146.69 ms
main:    total time =  6517.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9c4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9acb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadc47db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9c4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9c4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadc47e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa9acb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadc47db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadc47f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadc47e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa9c4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadc47fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadc47f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadc480580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa9c4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadc47fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadc480740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadc480580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa9c4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadc480900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadc480740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.98 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.68 ms
whisper_print_timings:   sample time =    65.60 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4853.12 ms /     1 runs ( 4853.12 ms per run)
whisper_print_timings:   decode time =    14.56 ms /     2 runs (    7.28 ms per run)
whisper_print_timings:   batchd time =   712.87 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5775.34 ms
