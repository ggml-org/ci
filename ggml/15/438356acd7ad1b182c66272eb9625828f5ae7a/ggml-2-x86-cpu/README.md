...
- status:  SUCCESS ✅
- runtime: 3:40.69
- date:    Mon Feb 12 07:36:46 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  116.32 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.74 sec
...
main:     load time =   109.76 ms
main:   sample time =    23.96 ms
main:  predict time =   458.79 ms / 7.17 ms per token
main:    total time =   605.13 ms
...
main:  predict time =   493.26 ms / 7.05 ms per token
main:    total time =   624.55 ms
...
main:  predict time =   481.78 ms / 6.88 ms per token
main:    total time =   638.51 ms
...
main:     n_decoded =      504
main:     load time =   106.78 ms
main:   sample time =   177.85 ms
main:  predict time =  1548.96 ms
main:    total time =  1864.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f663622d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f66360ae1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d0dd9b1b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f663622d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6636232940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d0dd9b2960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f66360ae1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d0dd9b1b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d0dd9b32c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d0dd9b2960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f663622d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d0dd9b3c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d0dd9b32c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d0dd9b4580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f663622d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d0dd9b3c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d0dd9b4740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d0dd9b4580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6636232940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d0dd9b4900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d0dd9b4740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.49 ms
whisper_print_timings:   sample time =    55.18 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1181.27 ms /     1 runs ( 1181.27 ms per run)
whisper_print_timings:   decode time =    10.17 ms /     2 runs (    5.09 ms per run)
whisper_print_timings:   batchd time =   212.66 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1554.94 ms
...
main:     load time =    67.02 ms
main:    total time = 10686.63 ms
embd_img
