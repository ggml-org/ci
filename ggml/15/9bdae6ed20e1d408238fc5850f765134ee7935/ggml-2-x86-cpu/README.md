...
- status:  SUCCESS ✅
- runtime: 2:56.91
- date:    Thu Oct 12 11:46:55 UTC 2023
...
main:     load time =   156.72 ms
main:   sample time =    24.21 ms
main:  predict time =   472.85 ms / 7.39 ms per token
main:    total time =   667.38 ms
...
main:     load time =   114.59 ms
main:   sample time =    24.04 ms
main:  predict time =   491.93 ms / 7.03 ms per token
main:    total time =   633.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffa77f52900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffa77dd3170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5643f17ccad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffa77f51fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffa77f57880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5643f17cd870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffa77dd3170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5643f17ccad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5643f17ce1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5643f17cd870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffa77f51fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5643f17cead0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5643f17ce1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5643f17cf400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffa77f52900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5643f17cead0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5643f17cf590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5643f17cf400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffa77f57880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5643f17cf720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5643f17cf590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   155.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    16.62 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  1194.36 ms /     1 runs ( 1194.36 ms per run)
whisper_print_timings:   decode time =   106.04 ms /    27 runs (    3.93 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1531.74 ms
```
### mpt
...
main:      load time = 11514.82 ms
main:    sample time =   463.21 ms / 7.24 ms per token
main:      eval time = 21720.44 ms / 310.29 ms per token
main:     total time = 34380.70 ms
...
main:      load time =  4396.04 ms
main:    sample time =   461.33 ms / 7.21 ms per token
main:      eval time =  8602.19 ms / 122.89 ms per token
main:     total time = 13850.45 ms
