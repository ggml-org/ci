...
- status:  SUCCESS ✅
- runtime: 3:56.38
- date:    Thu Oct 12 11:44:59 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.67 sec
      Start  2: test-opt
...
main:     load time =   157.52 ms
main:   sample time =    17.09 ms
main:  predict time =   801.20 ms / 12.52 ms per token
main:    total time =   999.38 ms
...
main:  predict time =   867.56 ms / 12.39 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8192a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff817ab170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac870aad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81929fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8192f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac870b870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff817ab170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac870aad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac870c1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac870b870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81929fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac870cad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac870c1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac870d400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8192a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac870cad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac870d590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac870d400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8192f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac870d720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac870d590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   211.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.05 ms
whisper_print_timings:   sample time =    20.84 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4607.09 ms /     1 runs ( 4607.09 ms per run)
whisper_print_timings:   decode time =   181.36 ms /    27 runs (    6.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5087.51 ms
```
### mpt
...
main:      load time = 13201.90 ms
main:    sample time =   519.76 ms / 8.12 ms per token
main:      eval time = 43460.90 ms / 620.87 ms per token
main:     total time = 59554.82 ms
...
main:      load time =  4363.83 ms
main:    sample time =   513.42 ms / 8.02 ms per token
main:      eval time = 17736.96 ms / 253.39 ms per token
main:     total time = 23579.45 ms
