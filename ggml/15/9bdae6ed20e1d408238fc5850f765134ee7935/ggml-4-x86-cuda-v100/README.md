...
- status:  SUCCESS ✅
- runtime: 5:00.17
- date:    Thu Oct 12 11:47:58 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.69 sec
...
main:     load time =  1104.97 ms
main:   sample time =    34.51 ms
main:  predict time =   567.93 ms / 8.87 ms per token
main:    total time =  1727.51 ms
...
main:     load time =   159.78 ms
main:   sample time =    35.10 ms
main:  predict time =   579.01 ms / 8.27 ms per token
main:    total time =   778.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f93fe2aa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f93fe12b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555d82013ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f93fe2a9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f93fe2af880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555d82014870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f93fe12b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555d82013ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555d820151a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555d82014870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f93fe2a9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555d82015ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555d820151a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555d82016400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f93fe2aa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555d82015ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555d82016590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555d82016400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f93fe2af880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555d82016720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555d82016590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   719.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.90 ms
whisper_print_timings:   sample time =    27.11 ms /    27 runs (    1.00 ms per run)
whisper_print_timings:   encode time =  1867.28 ms /     1 runs ( 1867.28 ms per run)
whisper_print_timings:   decode time =   160.84 ms /    27 runs (    5.96 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2858.17 ms
```
### mpt
...
main:      load time =  7090.01 ms
main:    sample time =   588.87 ms / 9.20 ms per token
main:      eval time = 25646.14 ms / 366.37 ms per token
main:     total time = 34236.80 ms
...
main:      load time =  1730.30 ms
main:    sample time =   595.40 ms / 9.30 ms per token
main:      eval time = 12236.71 ms / 174.81 ms per token
main:     total time = 15210.25 ms
