...
- status:  SUCCESS ✅
- runtime: 3:40.05
- date:    Sat Jan 13 10:14:26 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.65 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   49.32 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.21 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   11.10 sec
...
main:     load time =   194.35 ms
main:   sample time =    17.94 ms
main:  predict time =   879.78 ms / 13.75 ms per token
main:    total time =  1114.20 ms
...
main:     load time =   196.65 ms
main:   sample time =    17.99 ms
main:  predict time =  1091.11 ms / 15.59 ms per token
main:    total time =  1308.99 ms
...
main:     n_decoded =      504
main:     load time =   166.23 ms
main:   sample time =   129.19 ms
main:  predict time =  6191.59 ms
main:    total time =  6569.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8c74a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8c5cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafb9edb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8c74a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8c74f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafb9ee960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8c5cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafb9edb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafb9ef2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafb9ee960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8c74a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafb9efc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafb9ef2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafb9f0580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8c74a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafb9efc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafb9f0740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafb9f0580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8c74f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafb9f0900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafb9f0740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    68.94 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4801.54 ms /     1 runs ( 4801.54 ms per run)
whisper_print_timings:   decode time =    15.96 ms /     2 runs (    7.98 ms per run)
whisper_print_timings:   batchd time =   715.30 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5734.06 ms
...
main:     load time =    97.42 ms
main:    total time = 40705.95 ms
embd_img
