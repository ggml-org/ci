...
- status:  SUCCESS ✅
- runtime: 5:56.60
- date:    Sat Jan 13 10:16:31 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/1553a05a4ada3ccc0716744bcd16d2a5f362b98d
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.27 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   40.33 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.32 sec
...
main:     load time =   246.74 ms
main:   sample time =    16.70 ms
main:  predict time =   845.39 ms / 13.21 ms per token
main:    total time =  1130.70 ms
...
main:  predict time =   919.61 ms / 13.14 ms per token
main:    total time =  1120.48 ms
...
main:     n_decoded =      504
main:     load time =   145.64 ms
main:   sample time =   126.79 ms
main:  predict time =  5960.41 ms
main:    total time =  6314.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fbda990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7fa5b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec10eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fbda030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fbdf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec10f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7fa5b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaec10eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec1102c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaec10f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7fbda030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec110c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaec1102c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec111580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7fbda990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaec110c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec111740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaec111580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7fbdf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaec111900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaec111740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   176.71 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.16 ms
whisper_print_timings:   sample time =    65.42 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4647.40 ms /     1 runs ( 4647.40 ms per run)
whisper_print_timings:   decode time =    15.27 ms /     2 runs (    7.64 ms per run)
whisper_print_timings:   batchd time =   707.43 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5630.17 ms
...
main:      load time = 12609.09 ms
main:    sample time =   520.10 ms / 8.13 ms per token
main:      eval time = 43711.85 ms / 624.45 ms per token
main:     total time = 59216.56 ms
...
main:      load time =  4339.94 ms
main:    sample time =   513.82 ms / 8.03 ms per token
main:      eval time = 17433.77 ms / 249.05 ms per token
main:     total time = 23252.71 ms
