...
- status:  SUCCESS ✅
- runtime: 4:15.86
- date:    Sat Jan 13 22:14:50 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   31.97 sec
...
main:     load time =   193.84 ms
main:   sample time =    23.51 ms
main:  predict time =   450.34 ms / 7.04 ms per token
main:    total time =   681.07 ms
...
main:     load time =   128.84 ms
main:   sample time =    23.56 ms
main:  predict time =   486.50 ms / 6.95 ms per token
main:    total time =   641.47 ms
...
main:  predict time =  1519.80 ms
main:    total time =  1838.43 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faa5b273990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faa5b0f41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561e64bfbb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faa5b273030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7faa5b278940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561e64bfc960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faa5b0f41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561e64bfbb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561e64bfd2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561e64bfc960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faa5b273030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561e64bfdc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561e64bfd2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561e64bfe580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faa5b273990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561e64bfdc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561e64bfe740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561e64bfe580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7faa5b278940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561e64bfe900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561e64bfe740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   128.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.29 ms
whisper_print_timings:   sample time =    54.83 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.07 ms /     1 runs ( 1159.07 ms per run)
whisper_print_timings:   decode time =     9.29 ms /     2 runs (    4.65 ms per run)
whisper_print_timings:   batchd time =   206.32 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1577.04 ms
...
main:     load time =    61.04 ms
main:    total time = 10625.54 ms
embd_img
...
main:      load time = 10298.52 ms
main:    sample time =   469.41 ms / 7.33 ms per token
main:      eval time = 20728.33 ms / 296.12 ms per token
main:     total time = 32171.59 ms
...
main:      load time =  4388.55 ms
main:    sample time =   464.08 ms / 7.25 ms per token
main:      eval time =  8372.01 ms / 119.60 ms per token
main:     total time = 13584.94 ms
