...
- status:  SUCCESS ✅
- runtime: 3:40.96
- date:    Mon Aug 28 08:44:24 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/14 Test  #4: test-mul-mat0 ....................   Passed    1.13 sec
...
main:     load time =   262.81 ms
main:   sample time =    17.49 ms
main:  predict time =   798.56 ms / 12.48 ms per token
main:    total time =  1101.48 ms
...
main:     load time =   167.09 ms
main:   sample time =    17.26 ms
main:  predict time =   867.06 ms / 12.39 ms per token
main:    total time =  1054.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa4efa8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa4d7b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad9d6cab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa4ef9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa4eff800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad9d6d830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa4d7b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad9d6cab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad9d6e140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad9d6d830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa4ef9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad9d6ea50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad9d6e140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad9d6f360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa4efa8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad9d6ea50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad9d6f4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad9d6f360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa4eff800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad9d6f640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad9d6f4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12345.60 ms
main:    sample time =   618.96 ms / 9.67 ms per token
main:      eval time = 43728.99 ms / 624.70 ms per token
main:     total time = 59082.61 ms
...
main:      load time =  4369.39 ms
main:    sample time =   598.59 ms / 9.35 ms per token
main:      eval time = 17440.54 ms / 249.15 ms per token
main:     total time = 23378.56 ms
