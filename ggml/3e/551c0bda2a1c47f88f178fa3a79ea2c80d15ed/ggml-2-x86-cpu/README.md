...
- status:  SUCCESS ✅
- runtime: 2:41.97
- date:    Mon Aug 28 08:34:28 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/3e551c0bda2a1c47f88f178fa3a79ea2c80d15ed
- author:  slaren
```
...
main:  predict time =   430.55 ms / 6.73 ms per token
...
main:     load time =   132.09 ms
main:   sample time =    23.29 ms
main:  predict time =   437.74 ms / 6.25 ms per token
main:    total time =   595.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd4e1bdf8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd4e1a60150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55843b1dfab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd4e1bdef90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd4e1be4800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55843b1e0830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd4e1a60150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55843b1dfab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55843b1e1140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55843b1e0830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd4e1bdef90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55843b1e1a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55843b1e1140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55843b1e2360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd4e1bdf8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55843b1e1a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55843b1e24d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55843b1e2360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd4e1be4800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55843b1e2640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55843b1e24d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11454.60 ms
main:    sample time =   466.58 ms / 7.29 ms per token
main:      eval time = 20309.03 ms / 290.13 ms per token
main:     total time = 32909.29 ms
...
main:      load time =  4401.18 ms
main:    sample time =   464.67 ms / 7.26 ms per token
main:      eval time =  8083.25 ms / 115.47 ms per token
main:     total time = 13322.50 ms
