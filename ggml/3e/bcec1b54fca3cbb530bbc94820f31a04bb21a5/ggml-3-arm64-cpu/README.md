...
- status:  SUCCESS ✅
- runtime: 5:07.42
- date:    Wed Dec  6 07:45:11 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   14.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.15 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    2.58 sec
...
main:     load time =   270.26 ms
main:   sample time =    16.85 ms
main:  predict time =   809.27 ms / 12.64 ms per token
...
main:     load time =   175.23 ms
main:   sample time =    16.69 ms
main:  predict time =   888.64 ms / 12.69 ms per token
main:    total time =  1083.14 ms
...
main:     n_decoded =      504
main:     load time =   142.21 ms
main:   sample time =   126.69 ms
main:  predict time =  5850.62 ms
main:    total time =  6200.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d9ca960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d84b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf19a5b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d9ca010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d9cf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf19a6940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9d84b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf19a5b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf19a7290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf19a6940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d9ca010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf19a7be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf19a7290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf19a8530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d9ca960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf19a7be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf19a86e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf19a8530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d9cf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf19a8890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf19a86e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:    total time =  5632.52 ms
...
main:     load time =    79.21 ms
main:    total time = 39297.27 ms
embd_img
...
main:      load time = 14179.32 ms
main:    sample time =   533.50 ms / 8.34 ms per token
main:      eval time = 43676.63 ms / 623.95 ms per token
main:     total time = 60764.10 ms
...
main:      load time =  4357.43 ms
main:    sample time =   532.57 ms / 8.32 ms per token
main:      eval time = 17583.70 ms / 251.20 ms per token
main:     total time = 23443.82 ms
