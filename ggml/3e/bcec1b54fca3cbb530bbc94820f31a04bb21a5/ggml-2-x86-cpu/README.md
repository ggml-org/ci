...
19/19 Test #19: test-backend-ops .................   Passed   11.26 sec
...
20/20 Test #20: test-backend-ops .................   Passed    2.07 sec
...
main:     load time =   184.63 ms
main:   sample time =    23.52 ms
main:  predict time =   437.35 ms / 6.83 ms per token
main:    total time =   658.16 ms
...
main:  predict time =   450.70 ms / 6.44 ms per token
main:    total time =   605.73 ms
...
main:     n_decoded =      504
main:     load time =   106.22 ms
main:   sample time =   178.26 ms
main:  predict time =  1444.58 ms
main:    total time =  1759.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8af423960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa8af2a4190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cbef8c6b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa8af423010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa8af428900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cbef8c7940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa8af2a4190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cbef8c6b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cbef8c8290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55cbef8c7940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa8af423010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cbef8c8be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55cbef8c8290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cbef8c9530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8af423960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55cbef8c8be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cbef8c96e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55cbef8c9530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa8af428900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55cbef8c9890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55cbef8c96e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.86 ms
whisper_print_timings:   sample time =    53.80 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1146.61 ms /     1 runs ( 1146.61 ms per run)
whisper_print_timings:   decode time =     9.73 ms /     2 runs (    4.87 ms per run)
whisper_print_timings:   batchd time =   211.15 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1563.36 ms
...
main:     load time =    61.99 ms
main:    total time = 10442.02 ms
embd_img
...
main:      load time = 13321.89 ms
main:    sample time =   466.79 ms / 7.29 ms per token
main:      eval time = 20285.41 ms / 289.79 ms per token
main:     total time = 34756.87 ms
...
main:      load time =  4370.48 ms
main:    sample time =   465.01 ms / 7.27 ms per token
main:      eval time =  8038.19 ms / 114.83 ms per token
main:     total time = 13243.68 ms
