...
- status:  SUCCESS ✅
- runtime: 4:07.53
- date:    Fri Jan  5 15:04:09 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   28.09 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.01 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  16.34 sec
...
main:     load time =   201.07 ms
main:   sample time =    24.02 ms
main:  predict time =   449.98 ms / 7.03 ms per token
main:    total time =   687.73 ms
...
main:  predict time =   459.44 ms / 6.56 ms per token
main:    total time =   610.91 ms
...
main:  predict time =  1493.35 ms
main:    total time =  1808.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f46f9f65990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f46f9de61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557cb6694b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f46f9f65030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f46f9f6a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557cb6695960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f46f9de61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557cb6694b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557cb66962c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557cb6695960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f46f9f65030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557cb6696c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557cb66962c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557cb6697580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f46f9f65990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557cb6696c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557cb6697740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557cb6697580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f46f9f6a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557cb6697900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557cb6697740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   142.90 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.39 ms
whisper_print_timings:   sample time =    56.19 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1163.62 ms /     1 runs ( 1163.62 ms per run)
whisper_print_timings:   decode time =    10.14 ms /     2 runs (    5.07 ms per run)
whisper_print_timings:   batchd time =   213.71 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1605.23 ms
...
main:     load time =    62.82 ms
main:    total time = 10630.68 ms
embd_img
...
main:      load time = 12139.37 ms
main:    sample time =   466.35 ms / 7.29 ms per token
main:      eval time = 20808.90 ms / 297.27 ms per token
main:     total time = 34083.45 ms
...
main:      load time =  4388.11 ms
main:    sample time =   466.50 ms / 7.29 ms per token
main:      eval time =  9143.13 ms / 130.62 ms per token
main:     total time = 14356.21 ms
