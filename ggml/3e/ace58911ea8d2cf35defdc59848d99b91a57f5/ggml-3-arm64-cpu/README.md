...
- status:  SUCCESS ✅
- runtime: 9:20.84
- date:    Fri Jan  5 03:17:53 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.28 sec
...
20/20 Test #20: test-backend-ops .................   Passed   34.58 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.07 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   10.25 sec
...
main:     load time =   270.37 ms
main:   sample time =    16.94 ms
main:  predict time =   821.75 ms / 12.84 ms per token
main:    total time =  1130.93 ms
...
main:     load time =   171.69 ms
main:   sample time =    16.86 ms
main:  predict time =   893.68 ms / 12.77 ms per token
main:    total time =  1085.05 ms
...
main:     n_decoded =      504
main:     load time =   146.32 ms
main:   sample time =   128.20 ms
main:  predict time =  5989.83 ms
main:    total time =  6345.66 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9464a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff944cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac9590b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9464a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9464f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac9591960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff944cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac9590b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac95922c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac9591960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9464a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac9592c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac95922c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac9593580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9464a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac9592c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac9593740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac9593580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9464f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac9593900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac9593740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   184.71 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.09 ms
whisper_print_timings:   sample time =    65.14 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4637.96 ms /     1 runs ( 4637.96 ms per run)
whisper_print_timings:   decode time =    15.21 ms /     2 runs (    7.61 ms per run)
whisper_print_timings:   batchd time =   706.65 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5627.61 ms
...
main:     load time =    79.24 ms
main:    total time = 39748.04 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.246000 sec.)
...
main:      load time = 10917.18 ms
main:    sample time =   517.35 ms / 8.08 ms per token
main:      eval time = 43698.62 ms / 624.27 ms per token
main:     total time = 57506.95 ms
...
main:      load time =  4373.90 ms
main:    sample time =   512.70 ms / 8.01 ms per token
main:      eval time = 17441.53 ms / 249.16 ms per token
main:     total time = 23300.56 ms
