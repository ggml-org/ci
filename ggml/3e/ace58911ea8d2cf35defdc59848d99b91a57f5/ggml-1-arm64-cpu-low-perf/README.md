...
- status:  SUCCESS ✅
- runtime: 6:13.74
- date:    Fri Jan  5 03:06:24 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.93 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   43.37 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.51 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.87 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.20 sec
...
main:  predict time =   850.17 ms / 13.28 ms per token
main:    total time =  1082.54 ms
...
main:  predict time =   921.92 ms / 13.17 ms per token
main:    total time =  1134.95 ms
...
main:     n_decoded =      504
main:     load time =   163.31 ms
main:   sample time =   132.13 ms
main:  predict time =  6171.10 ms
main:    total time =  6548.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80c5a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80adb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac838ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80c5a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80c5f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac838b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80adb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac838ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac838c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac838b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80c5a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac838cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac838c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac838d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80c5a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac838cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac838d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac838d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80c5f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac838d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac838d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.75 ms
whisper_print_timings:   sample time =    67.89 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4758.39 ms /     1 runs ( 4758.39 ms per run)
whisper_print_timings:   decode time =    15.83 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   717.74 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5691.67 ms
