...
- status:  FAILURE ❌ (2)
- runtime: 1:23.00
- date:    Sat Aug 24 13:09:43 UTC 2024
...
main:  predict time =   439.38 ms / 6.87 ms per token
main:    total time =   581.67 ms
...
main:  predict time =   455.24 ms / 6.50 ms per token
main:    total time =   587.22 ms
...
main:   sample time =   182.72 ms
main:  predict time =  1539.43 ms
main:    total time =  1857.82 ms
