...
- status:  SUCCESS ✅
- runtime: 2:10.81
- date:    Thu Apr 25 14:51:43 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/cf1acc512432a969cee18947330fd26df67fb456
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.47 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.10 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.37 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    1.63 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   16.00 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.46 sec
...
main:     load time =   163.30 ms
main:   sample time =    23.82 ms
main:  predict time =   488.61 ms / 7.63 ms per token
main:    total time =   688.16 ms
...
main:     load time =   102.92 ms
main:   sample time =    24.55 ms
main:  predict time =   521.55 ms / 7.45 ms per token
main:    total time =   650.94 ms
...
main:     load time =   123.67 ms
main:   sample time =    23.84 ms
main:  predict time =   527.68 ms / 7.54 ms per token
main:    total time =   678.18 ms
...
main:     n_decoded =      504
main:     load time =   104.69 ms
main:   sample time =   177.92 ms
main:  predict time =  1855.68 ms
main:    total time =  2170.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f06e92f8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f06e91791a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5623bbce7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f06e92f8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f06e92fd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5623bbce8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f06e91791a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5623bbce7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5623bbce9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5623bbce8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f06e92f8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5623bbce9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5623bbce9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5623bbcea6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f06e92f8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5623bbce9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5623bbcea890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5623bbcea6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f06e92fd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5623bbceaa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5623bbcea890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =   416.58 ms /   131 runs (    3.18 ms per run)
whisper_print_timings:   encode time =  1179.28 ms /     1 runs ( 1179.28 ms per run)
whisper_print_timings:   decode time =    12.48 ms /     2 runs (    6.24 ms per run)
whisper_print_timings:   batchd time =   215.47 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1958.66 ms
...
main:     load time =    60.59 ms
main:    total time = 10584.91 ms
embd_img
