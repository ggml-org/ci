...
- status:  SUCCESS ✅
- runtime: 3:10.11
- date:    Thu Apr 25 15:05:12 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.12 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.53 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.88 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.99 sec
      Start  2: test-opt
...
main:  predict time =   926.33 ms / 14.47 ms per token
main:    total time =  1113.45 ms
...
main:     load time =   156.58 ms
main:   sample time =    17.56 ms
main:  predict time =   973.52 ms / 13.91 ms per token
main:    total time =  1150.53 ms
...
main:     load time =   176.25 ms
main:   sample time =    17.40 ms
main:  predict time =  1006.64 ms / 14.38 ms per token
main:    total time =  1203.58 ms
...
main:     n_decoded =      504
main:     load time =   152.91 ms
main:   sample time =   129.67 ms
main:  predict time =  6577.24 ms
main:    total time =  6942.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8fbba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fa3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab084abce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8fbba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8fbbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab084acab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fa3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab084abce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab084ad410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab084acab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8fbba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab084add70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab084ad410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab084ae6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8fbba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab084add70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab084ae890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab084ae6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8fbbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab084aea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab084ae890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =   750.82 ms /   131 runs (    5.73 ms per run)
whisper_print_timings:   encode time =  4694.85 ms /     1 runs ( 4694.85 ms per run)
whisper_print_timings:   decode time =    14.58 ms /     2 runs (    7.29 ms per run)
whisper_print_timings:   batchd time =   711.06 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6297.31 ms
...
main:     load time =    86.12 ms
main:    total time = 39764.12 ms
embd_img
