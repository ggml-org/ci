...
- status:  SUCCESS ✅
- runtime: 3:31.27
- date:    Thu Apr 25 14:27:51 UTC 2024
...
Total Test time (real) =  76.22 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.74 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.16 sec
      Start  9: test3
...
main:     load time =   218.88 ms
main:   sample time =    23.94 ms
main:  predict time =   719.38 ms / 11.24 ms per token
main:    total time =   974.85 ms
...
main:  predict time =   743.29 ms / 10.62 ms per token
main:    total time =   877.71 ms
...
main:  predict time =   765.35 ms / 10.93 ms per token
main:    total time =   922.77 ms
...
main:     n_decoded =      504
main:     load time =   109.49 ms
main:   sample time =   178.17 ms
main:  predict time =  3120.66 ms
main:    total time =  3454.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae957ed990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae9566e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563bd055ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae957ed030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae957f2940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5563bd056ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fae9566e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563bd055ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5563bd057410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5563bd056ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fae957ed030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5563bd057d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5563bd057410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5563bd0586d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fae957ed990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5563bd057d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5563bd058890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5563bd0586d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fae957f2940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5563bd058a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5563bd058890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   153.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.76 ms
whisper_print_timings:   sample time =   650.16 ms /   131 runs (    4.96 ms per run)
whisper_print_timings:   encode time =  2053.18 ms /     1 runs ( 2053.18 ms per run)
whisper_print_timings:   decode time =    16.39 ms /     2 runs (    8.20 ms per run)
whisper_print_timings:   batchd time =   333.34 ms /   125 runs (    2.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  3232.70 ms
