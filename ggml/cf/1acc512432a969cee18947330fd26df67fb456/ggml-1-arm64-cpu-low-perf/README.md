...
- status:  SUCCESS ✅
- runtime: 4:07.52
- date:    Thu Apr 25 02:28:20 PM UTC 2024
...
main:  predict time =   906.85 ms / 14.17 ms per token
main:    total time =  1107.09 ms
...
main:     load time =   160.40 ms
main:   sample time =    17.72 ms
main:  predict time =  1024.84 ms / 14.64 ms per token
main:    total time =  1205.66 ms
...
main:     load time =   190.94 ms
main:   sample time =    17.26 ms
main:  predict time =  1028.97 ms / 14.70 ms per token
main:    total time =  1240.55 ms
...
main:     n_decoded =      504
main:     load time =   158.50 ms
main:   sample time =   126.97 ms
main:  predict time =  6495.74 ms
main:    total time =  6863.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa18fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa177b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf05d0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa18fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa18ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf05d1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa177b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf05d0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf05d2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf05d1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa18fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf05d2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf05d2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf05d36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa18fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf05d2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf05d3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf05d36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa18ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf05d3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf05d3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.00 ms
whisper_print_timings:   sample time =   717.28 ms /   131 runs (    5.48 ms per run)
whisper_print_timings:   encode time =  4707.75 ms /     1 runs ( 4707.75 ms per run)
whisper_print_timings:   decode time =    14.68 ms /     2 runs (    7.34 ms per run)
whisper_print_timings:   batchd time =   712.61 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6281.06 ms
