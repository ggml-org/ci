...
- status:  SUCCESS ✅
- runtime: 3:37.11
- date:    Fri Jan 12 07:42:42 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.96 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.30 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   49.09 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   11.06 sec
...
main:     load time =   187.84 ms
main:   sample time =    16.96 ms
main:  predict time =   862.37 ms / 13.47 ms per token
main:    total time =  1089.14 ms
...
main:     load time =   186.75 ms
main:   sample time =    17.24 ms
main:  predict time =   936.01 ms / 13.37 ms per token
main:    total time =  1143.01 ms
...
main:     n_decoded =      504
main:     load time =   159.50 ms
main:   sample time =   128.14 ms
main:  predict time =  6189.95 ms
main:    total time =  6559.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96c2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96aab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae46a2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96c2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96c2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae46a3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96aab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae46a2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae46a42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae46a3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96c2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae46a4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae46a42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae46a5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96c2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae46a4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae46a5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae46a5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96c2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae46a5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae46a5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.54 ms
whisper_print_timings:   sample time =    67.79 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4738.53 ms /     1 runs ( 4738.53 ms per run)
whisper_print_timings:   decode time =    15.59 ms /     2 runs (    7.79 ms per run)
whisper_print_timings:   batchd time =   713.19 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5663.31 ms
...
main:     load time =    97.15 ms
main:    total time = 40456.09 ms
embd_img
