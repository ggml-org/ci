...
- status:  SUCCESS ✅
- runtime: 2:53.84
- date:    Fri Jan 12 19:42:05 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.27 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.40 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   40.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.01 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.16 sec
...
main:  predict time =   625.90 ms / 9.78 ms per token
main:    total time =   792.42 ms
...
main:  predict time =   652.82 ms / 9.33 ms per token
main:    total time =   804.60 ms
...
main:     n_decoded =      504
main:     load time =   107.78 ms
main:   sample time =   178.04 ms
main:  predict time =  2484.64 ms
main:    total time =  2816.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1206465990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f12062e61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563fd8f4cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1206465030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f120646a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563fd8f4d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f12062e61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563fd8f4cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563fd8f4e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563fd8f4d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1206465030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563fd8f4ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563fd8f4e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563fd8f4f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1206465990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563fd8f4ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563fd8f4f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563fd8f4f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f120646a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563fd8f4f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563fd8f4f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.39 ms
whisper_print_timings:   sample time =    72.33 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1986.51 ms /     1 runs ( 1986.51 ms per run)
whisper_print_timings:   decode time =    12.97 ms /     2 runs (    6.48 ms per run)
whisper_print_timings:   batchd time =   322.12 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2498.29 ms
...
main:     load time =    68.39 ms
main:    total time = 18981.46 ms
embd_img
