...
- status:  SUCCESS ✅
- runtime: 6:00.30
- date:    Fri Jan 12 07:51:04 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.25 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   40.36 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.10 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   11.57 sec
...
main:     load time =   274.45 ms
main:   sample time =    16.91 ms
main:  predict time =   851.21 ms / 13.30 ms per token
main:    total time =  1164.94 ms
...
main:     load time =   183.55 ms
main:   sample time =    16.81 ms
main:  predict time =   919.58 ms / 13.14 ms per token
main:    total time =  1122.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8e2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8cab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad66edb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8e2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8e2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad66ee960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8cab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad66edb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad66ef2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad66ee960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8e2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad66efc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad66ef2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad66f0580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8e2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad66efc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad66f0740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad66f0580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8e2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad66f0900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad66f0740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   174.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.05 ms
whisper_print_timings:   sample time =    64.47 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4650.05 ms /     1 runs ( 4650.05 ms per run)
whisper_print_timings:   decode time =    15.05 ms /     2 runs (    7.52 ms per run)
whisper_print_timings:   batchd time =   707.48 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5629.76 ms
...
main:     load time =    80.24 ms
main:    total time = 39674.43 ms
embd_img
...
main:      load time = 13985.84 ms
main:    sample time =   521.07 ms / 8.14 ms per token
main:      eval time = 43855.02 ms / 626.50 ms per token
main:     total time = 60737.31 ms
...
main:      load time =  4324.80 ms
main:    sample time =   516.82 ms / 8.08 ms per token
main:      eval time = 17675.32 ms / 252.50 ms per token
main:     total time = 23481.00 ms
