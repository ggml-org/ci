...
- status:  SUCCESS ✅
- runtime: 3:55.08
- date:    Fri Jan 12 19:43:05 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   32.84 sec
...
21/21 Test #21: test-backend-ops .................   Passed    9.13 sec
...
main:     load time =   134.33 ms
main:   sample time =    23.57 ms
main:  predict time =   460.15 ms / 7.19 ms per token
main:    total time =   631.02 ms
...
main:   sample time =   178.00 ms
main:  predict time =  1519.13 ms
main:    total time =  1836.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5a49bc2990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5a49a431a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55eeee353b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5a49bc2030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5a49bc7940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55eeee354960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5a49a431a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55eeee353b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55eeee3552c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55eeee354960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5a49bc2030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55eeee355c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55eeee3552c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55eeee356580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5a49bc2990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55eeee355c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55eeee356740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55eeee356580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5a49bc7940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55eeee356900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55eeee356740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   133.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.63 ms
whisper_print_timings:   sample time =    55.07 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1158.04 ms /     1 runs ( 1158.04 ms per run)
whisper_print_timings:   decode time =     9.45 ms /     2 runs (    4.72 ms per run)
whisper_print_timings:   batchd time =   212.57 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1587.21 ms
...
main:     load time =    60.55 ms
main:    total time = 10646.47 ms
embd_img
...
main:      load time = 12057.64 ms
main:    sample time =   466.77 ms / 7.29 ms per token
main:      eval time = 20663.09 ms / 295.19 ms per token
main:     total time = 33872.11 ms
...
main:      load time =  4401.42 ms
main:    sample time =   464.57 ms / 7.26 ms per token
main:      eval time =  8947.97 ms / 127.83 ms per token
main:     total time = 14179.38 ms
