...
- status:  SUCCESS ✅
- runtime: 5:06.84
- date:    Wed Feb 21 02:26:37 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  100.68 sec
...
main:  predict time =   929.95 ms / 14.53 ms per token
main:    total time =  1125.92 ms
...
main:     load time =   157.93 ms
main:   sample time =    16.74 ms
main:  predict time =   983.75 ms / 14.05 ms per token
main:    total time =  1161.19 ms
...
main:  predict time =  1086.53 ms / 15.52 ms per token
main:    total time =  1296.20 ms
...
main:     n_decoded =      504
main:     load time =   159.32 ms
main:   sample time =   128.54 ms
main:  predict time =  6627.82 ms
main:    total time =  6998.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb82aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb812b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaea77ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb82aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb82af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaea77bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb812b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaea77ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaea77c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaea77bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb82aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaea77cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaea77c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaea77d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb82aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaea77cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaea77d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaea77d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb82af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaea77da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaea77d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4811.21 ms /     1 runs ( 4811.21 ms per run)
whisper_print_timings:   decode time =    14.67 ms /     2 runs (    7.34 ms per run)
whisper_print_timings:   batchd time =   734.72 ms /   125 runs (    5.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5756.47 ms
...
main:     load time =    90.09 ms
main:    total time = 40562.98 ms
embd_img
