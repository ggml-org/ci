...
- status:  SUCCESS ✅
- runtime: 112.45
- date:    Mon Oct 30 06:30:36 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 5/16 Test  #5: test-mul-mat0 ....................   Passed    0.23 sec
      Start  6: test-blas0
 6/16 Test  #6: test-blas0 .......................   Passed    0.07 sec
...
11/16 Test #11: test3 ............................   Passed    0.06 sec
      Start 12: test-pool
12/16 Test #12: test-pool ........................   Passed    0.04 sec
...
main:     load time =   141.62 ms
main:   sample time =     8.99 ms
main:  predict time =   299.70 ms / 4.68 ms per token
main:    total time =   453.54 ms
...
main:  predict time =   309.12 ms / 4.42 ms per token
main:    total time =   408.33 ms
...
main:     n_decoded =      504
main:     load time =    98.88 ms
main:   sample time =    65.90 ms
main:  predict time =   760.89 ms
main:    total time =   936.84 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x141009f60                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x14100ad00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x148008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x141009f60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14100b630                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x14100ad00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x148186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14100bf60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x14100b630                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14100c890                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1481878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x14100bf60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14100ca20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x14100c890                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14818c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x14100cbb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x14100ca20                           node_4
...
whisper_print_timings:     load time =   111.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.42 ms
whisper_print_timings:   sample time =    11.56 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   718.82 ms /     1 runs (  718.82 ms per run)
whisper_print_timings:   decode time =    63.42 ms /    27 runs (    2.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   926.83 ms
...
main:     load time =    59.19 ms
main:    total time =  5868.39 ms
embd_img
