...
- status:  SUCCESS ✅
- runtime: 1:55.62
- date:    Mon Oct 30 04:32:30 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.60 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.85 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.83 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    0.61 sec
      Start 10: test-pool
...
main:     load time =   109.44 ms
main:   sample time =    23.39 ms
main:  predict time =   726.81 ms / 11.36 ms per token
main:    total time =   873.18 ms
...
main:     load time =   103.00 ms
main:   sample time =    23.49 ms
main:  predict time =   626.94 ms / 8.96 ms per token
main:    total time =   756.39 ms
...
main:     n_decoded =      504
main:     load time =   103.72 ms
main:   sample time =   175.47 ms
main:  predict time =  2360.38 ms
main:    total time =  2685.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fee08318900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fee08199170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56026a34aad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fee08317fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fee0831d880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56026a34b870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fee08199170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56026a34aad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56026a34c1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56026a34b870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fee08317fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56026a34cad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56026a34c1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56026a34d400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fee08318900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56026a34cad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56026a34d590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56026a34d400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fee0831d880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56026a34d720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56026a34d590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    87.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.67 ms
whisper_print_timings:   sample time =    16.29 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  2046.67 ms /     1 runs ( 2046.67 ms per run)
whisper_print_timings:   decode time =   131.78 ms /    27 runs (    4.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2346.05 ms
...
main:     load time =    66.13 ms
main:    total time = 18844.73 ms
embd_img
