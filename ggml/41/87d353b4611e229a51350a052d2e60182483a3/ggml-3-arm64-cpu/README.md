...
- status:  SUCCESS ✅
- runtime: 4:35.37
- date:    Mon Oct 30 04:38:08 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.69 sec
      Start  2: test-opt
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.59 sec
...
main:     load time =   164.91 ms
main:   sample time =    16.96 ms
main:  predict time =   800.47 ms / 12.51 ms per token
main:    total time =  1005.23 ms
...
main:     load time =   144.11 ms
main:   sample time =    17.23 ms
main:  predict time =   868.40 ms / 12.41 ms per token
main:    total time =  1033.62 ms
...
main:     n_decoded =      504
main:     load time =   142.90 ms
main:   sample time =   126.84 ms
main:  predict time =  5857.00 ms
main:    total time =  6209.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8feaa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fd2b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafb568ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8fea9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8feaf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafb569870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fd2b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafb568ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafb56a1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafb569870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8fea9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafb56aad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafb56a1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafb56b400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8feaa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafb56aad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafb56b590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafb56b400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8feaf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafb56b720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafb56b590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    82.77 ms
main:    total time = 39340.17 ms
embd_img
...
main:      load time =  5752.31 ms
main:    sample time =   520.94 ms / 8.14 ms per token
main:      eval time = 43505.96 ms / 621.51 ms per token
main:     total time = 52151.31 ms
...
main:      load time =  1497.01 ms
main:    sample time =   516.44 ms / 8.07 ms per token
main:      eval time = 17386.11 ms / 248.37 ms per token
main:     total time = 20362.40 ms
