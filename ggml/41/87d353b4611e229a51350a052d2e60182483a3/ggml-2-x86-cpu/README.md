...
- status:  SUCCESS ✅
- runtime: 2:55.17
- date:    Mon Oct 30 04:34:36 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/4187d353b4611e229a51350a052d2e60182483a3
- author:  Jiří Podivín
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.63 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.49 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.64 sec
      Start  3: test-quantize-fns
 3/15 Test  #3: test-quantize-fns ................   Passed    0.00 sec
      Start  4: test-quantize-perf
 4/15 Test  #4: test-quantize-perf ...............   Passed    0.00 sec
      Start  5: test-mul-mat0
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.54 sec
...
main:     load time =   148.95 ms
main:   sample time =    23.56 ms
main:  predict time =   476.38 ms / 7.44 ms per token
main:    total time =   662.25 ms
...
main:     load time =   104.65 ms
main:   sample time =    23.31 ms
main:  predict time =   449.53 ms / 6.42 ms per token
main:    total time =   580.38 ms
...
main:     n_decoded =      504
main:     load time =   103.88 ms
main:   sample time =   175.19 ms
main:  predict time =  1466.44 ms
main:    total time =  1777.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f92e967a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f92e94fb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f54d17dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f92e9679fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f92e967f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f54d17e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f92e94fb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f54d17dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f54d17f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f54d17e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f92e9679fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f54d17fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f54d17f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f54d180400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f92e967a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f54d17fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f54d180590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f54d180400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f92e967f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f54d180720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f54d180590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.82 ms
whisper_print_timings:   sample time =    16.41 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1131.44 ms /     1 runs ( 1131.44 ms per run)
whisper_print_timings:   decode time =    93.52 ms /    27 runs (    3.46 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1422.27 ms
...
main:     load time =    66.32 ms
main:    total time = 10427.53 ms
embd_img
...
main:      load time =  5288.81 ms
main:    sample time =   468.13 ms / 7.31 ms per token
main:      eval time = 20261.19 ms / 289.45 ms per token
main:     total time = 26690.23 ms
...
main:      load time =  1171.11 ms
main:    sample time =   466.01 ms / 7.28 ms per token
main:      eval time =  8074.59 ms / 115.35 ms per token
main:     total time = 10155.71 ms
