...
- status:  SUCCESS ✅
- runtime: 2:29.51
- date:    Mon Oct 30 04:33:42 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.00 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.85 sec
      Start  9: test3
...
main:  predict time =   813.02 ms / 12.70 ms per token
main:    total time =  1010.37 ms
...
main:     load time =   162.82 ms
main:   sample time =    17.57 ms
main:  predict time =  1020.63 ms / 14.58 ms per token
main:    total time =  1204.97 ms
...
main:     n_decoded =      504
main:     load time =   157.53 ms
main:   sample time =   129.34 ms
main:  predict time =  6005.80 ms
main:    total time =  6375.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa191a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa179b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab12b83ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa1919fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa191f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab12b84870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa179b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab12b83ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab12b851a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab12b84870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa1919fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab12b85ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab12b851a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab12b86400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa191a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab12b85ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab12b86590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab12b86400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa191f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab12b86720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab12b86590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   121.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.87 ms
whisper_print_timings:   sample time =    20.84 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4694.78 ms /     1 runs ( 4694.78 ms per run)
whisper_print_timings:   decode time =   181.45 ms /    27 runs (    6.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5087.82 ms
...
main:     load time =    86.13 ms
main:    total time = 40115.84 ms
embd_img
