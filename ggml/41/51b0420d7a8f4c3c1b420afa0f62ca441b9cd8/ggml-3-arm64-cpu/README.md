...
- status:  SUCCESS ✅
- runtime: 3:09.81
- date:    Tue Apr  9 17:27:29 UTC 2024
...
main:  predict time =   897.57 ms / 14.02 ms per token
...
main:  predict time =   969.11 ms / 13.84 ms per token
main:    total time =  1135.58 ms
...
main:  predict time =  1009.04 ms / 14.41 ms per token
main:    total time =  1210.70 ms
...
main:     n_decoded =      504
main:     load time =   150.43 ms
main:   sample time =   129.13 ms
main:  predict time =  6437.29 ms
main:    total time =  6799.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff850aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84f2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1aa67ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff850aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff850af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1aa68ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff84f2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1aa67ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1aa69410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1aa68ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff850aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1aa69d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1aa69410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1aa6a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff850aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1aa69d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1aa6a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1aa6a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff850af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab1aa6aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1aa6a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.48 ms
whisper_print_timings:   sample time =    65.59 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4689.02 ms /     1 runs ( 4689.02 ms per run)
whisper_print_timings:   decode time =    14.52 ms /     2 runs (    7.26 ms per run)
whisper_print_timings:   batchd time =   709.59 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5605.67 ms
