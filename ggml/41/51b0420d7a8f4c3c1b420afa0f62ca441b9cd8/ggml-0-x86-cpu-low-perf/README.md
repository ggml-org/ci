...
- status:  SUCCESS ✅
- runtime: 3:31.98
- date:    Tue Apr  9 17:27:41 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.25 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.59 sec
      Start  9: test3
...
main:     load time =   111.49 ms
main:   sample time =    23.58 ms
main:  predict time =   706.40 ms / 11.04 ms per token
main:    total time =   854.01 ms
...
main:  predict time =   745.40 ms / 10.65 ms per token
main:    total time =   878.86 ms
...
main:  predict time =   820.61 ms / 11.72 ms per token
main:    total time =   979.67 ms
...
main:  predict time =  3126.55 ms
main:    total time =  3456.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc25fd7d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc25fbfe1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c35fd83ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc25fd7d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc25fd82940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c35fd84ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc25fbfe1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c35fd83ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c35fd85410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c35fd84ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc25fd7d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c35fd85d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c35fd85410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c35fd866d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc25fd7d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c35fd85d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c35fd86890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c35fd866d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc25fd82940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c35fd86a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c35fd86890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.48 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.94 ms
whisper_print_timings:   sample time =    72.01 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2075.26 ms /     1 runs ( 2075.26 ms per run)
whisper_print_timings:   decode time =    16.12 ms /     2 runs (    8.06 ms per run)
whisper_print_timings:   batchd time =   332.79 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2625.32 ms
...
main:     load time =    71.80 ms
main:    total time = 19447.95 ms
embd_img
