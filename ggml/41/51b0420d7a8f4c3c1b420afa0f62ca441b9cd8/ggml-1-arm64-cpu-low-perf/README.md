...
- status:  SUCCESS ✅
- runtime: 4:05.08
- date:    Tue Apr  9 05:28:11 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.02 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.56 sec
      Start  9: test3
...
main:  predict time =   908.71 ms / 14.20 ms per token
main:    total time =  1109.27 ms
...
main:     load time =   160.50 ms
main:   sample time =    17.58 ms
main:  predict time =   991.05 ms / 14.16 ms per token
main:    total time =  1171.98 ms
...
main:  predict time =  1025.28 ms / 14.65 ms per token
main:    total time =  1238.26 ms
...
main:  predict time =  6455.94 ms
main:    total time =  6830.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8617a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85ffb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac96e4ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8617a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8617f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac96e5ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85ffb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac96e4ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac96e6410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac96e5ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8617a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac96e6d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac96e6410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac96e76d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8617a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac96e6d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac96e7890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac96e76d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8617f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac96e7a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac96e7890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.16 ms
whisper_print_timings:   sample time =    65.34 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4716.11 ms /     1 runs ( 4716.11 ms per run)
whisper_print_timings:   decode time =    14.75 ms /     2 runs (    7.37 ms per run)
whisper_print_timings:   batchd time =   735.63 ms /   125 runs (    5.89 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5661.32 ms
