...
- status:  SUCCESS ✅
- runtime: 2:17.67
- date:    Fri Nov  1 14:57:37 UTC 2024
...
main:  predict time =   881.81 ms / 13.78 ms per token
main:    total time =  1070.73 ms
...
main:     load time =   179.97 ms
main:   sample time =    18.71 ms
main:  predict time =   955.98 ms / 13.66 ms per token
main:    total time =  1157.46 ms
