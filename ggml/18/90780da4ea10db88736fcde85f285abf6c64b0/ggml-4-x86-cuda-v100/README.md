...
- status:  SUCCESS ✅
- runtime: 9:22.85
- date:    Sat Jan 13 23:01:44 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.95 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.58 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.82 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   73.11 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 105.95 sec
...
21/21 Test #21: test-backend-ops .................   Passed   29.14 sec
...
main:     load time =   581.19 ms
main:   sample time =    34.23 ms
main:  predict time =   571.90 ms / 8.94 ms per token
main:    total time =  1211.02 ms
...
main:     load time =   579.89 ms
main:   sample time =    34.55 ms
main:  predict time =   660.22 ms / 9.43 ms per token
main:    total time =  1279.58 ms
...
main:     n_decoded =      504
main:     load time =   550.59 ms
main:   sample time =   250.72 ms
main:  predict time =  2507.28 ms
main:    total time =  3352.61 ms
...
main: loaded model in   400.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe8181b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe8180371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564b57d24a40                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe8181b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe8181bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564b57d25810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fe8180371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564b57d24a40                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564b57d26170                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564b57d25810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fe8181b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564b57d26ad0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564b57d26170                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564b57d27430                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fe8181b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564b57d26ad0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564b57d275f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564b57d27430                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fe8181bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564b57d277b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564b57d275f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   606.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.38 ms
whisper_print_timings:   sample time =    66.09 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    24.37 ms /     1 runs (   24.37 ms per run)
whisper_print_timings:   decode time =    22.10 ms /     2 runs (   11.05 ms per run)
whisper_print_timings:   batchd time =    82.55 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   828.50 ms
...
main:     load time =   505.81 ms
main:    total time =  7923.82 ms
embd_img
...
main:      load time = 23443.53 ms
main:    sample time =   539.85 ms / 8.44 ms per token
main:      eval time = 25867.82 ms / 369.54 ms per token
main:     total time = 50713.06 ms
...
main:      load time = 14481.25 ms
main:    sample time =   544.45 ms / 8.51 ms per token
main:      eval time = 12758.40 ms / 182.26 ms per token
main:     total time = 28433.58 ms
