...
- status:  SUCCESS ✅
- runtime: 5:58.21
- date:    Sat Jan 13 10:53:23 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   40.34 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.41 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  20.21 sec
...
main:     load time =   191.34 ms
main:   sample time =    17.07 ms
main:  predict time =   850.40 ms / 13.29 ms per token
main:    total time =  1081.02 ms
...
main:     load time =   179.00 ms
main:   sample time =    16.79 ms
main:  predict time =   915.93 ms / 13.08 ms per token
main:    total time =  1114.64 ms
...
main:  predict time =  5984.38 ms
main:    total time =  6348.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb251a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb239b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeacb2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb251a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb251f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeacb3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb239b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeacb2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeacb42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeacb3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb251a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeacb4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeacb42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeacb5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb251a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeacb4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeacb5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeacb5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb251f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeacb5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeacb5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4666.92 ms /     1 runs ( 4666.92 ms per run)
whisper_print_timings:   decode time =    15.17 ms /     2 runs (    7.58 ms per run)
whisper_print_timings:   batchd time =   708.90 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5665.90 ms
...
main:     load time =    83.50 ms
main:    total time = 39700.05 ms
embd_img
...
main:      load time = 11079.79 ms
main:    sample time =   520.14 ms / 8.13 ms per token
main:      eval time = 43836.66 ms / 626.24 ms per token
main:     total time = 57814.20 ms
...
main:      load time =  4349.87 ms
main:    sample time =   520.41 ms / 8.13 ms per token
main:      eval time = 17716.38 ms / 253.09 ms per token
main:     total time = 23551.52 ms
