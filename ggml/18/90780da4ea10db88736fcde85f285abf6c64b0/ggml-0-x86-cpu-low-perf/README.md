...
- status:  SUCCESS ✅
- runtime: 2:55.53
- date:    Sat Jan 13 22:24:53 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   40.92 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.15 sec
...
main:  predict time =   636.52 ms / 9.95 ms per token
main:    total time =   803.10 ms
...
main:  predict time =   658.34 ms / 9.40 ms per token
main:    total time =   814.20 ms
...
main:  predict time =  2510.33 ms
main:    total time =  2840.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3489f36990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3489db71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558032547b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3489f36030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3489f3b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558032548960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3489db71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558032547b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5580325492c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558032548960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3489f36030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558032549c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5580325492c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55803254a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3489f36990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558032549c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55803254a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55803254a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3489f3b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55803254a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55803254a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.94 ms
whisper_print_timings:   sample time =    71.50 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1992.20 ms /     1 runs ( 1992.20 ms per run)
whisper_print_timings:   decode time =    12.61 ms /     2 runs (    6.31 ms per run)
whisper_print_timings:   batchd time =   323.25 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2502.93 ms
