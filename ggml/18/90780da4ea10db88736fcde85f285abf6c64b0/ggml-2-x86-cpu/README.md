...
- status:  SUCCESS ✅
- runtime: 4:14.82
- date:    Sat Jan 13 22:38:04 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/1890780da4ea10db88736fcde85f285abf6c64b0
...
20/20 Test #20: test-backend-ops .................   Passed   33.37 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  44.29 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.54 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  18.87 sec
...
main:     load time =   182.44 ms
main:   sample time =    23.40 ms
main:  predict time =   448.03 ms / 7.00 ms per token
main:    total time =   667.14 ms
...
main:     n_decoded =      504
main:     load time =   103.99 ms
main:   sample time =   177.77 ms
main:  predict time =  1523.95 ms
main:    total time =  1837.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6607ebf990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6607d401a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c9528ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6607ebf030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6607ec4940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556c9528b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6607d401a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c9528ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556c9528c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556c9528b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6607ebf030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556c9528cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556c9528c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556c9528d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6607ebf990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556c9528cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556c9528d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556c9528d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6607ec4940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556c9528d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556c9528d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   133.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.58 ms
whisper_print_timings:   sample time =    55.22 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1164.06 ms /     1 runs ( 1164.06 ms per run)
whisper_print_timings:   decode time =    10.04 ms /     2 runs (    5.02 ms per run)
whisper_print_timings:   batchd time =   211.45 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1592.87 ms
...
main:     load time =    62.30 ms
main:    total time = 10636.39 ms
embd_img
...
main:      load time =  7890.83 ms
main:    sample time =   466.70 ms / 7.29 ms per token
main:      eval time = 20908.32 ms / 298.69 ms per token
main:     total time = 29980.01 ms
...
main:      load time =  3839.16 ms
main:    sample time =   465.54 ms / 7.27 ms per token
main:      eval time =  8410.77 ms / 120.15 ms per token
main:     total time = 13070.55 ms
