...
- status: SUCCESS ✅
- date:   Mon Jul 17 12:40:24 UTC 2023
...
main: mem per token =  2016924 bytes
main:     load time =   128.26 ms
main:   sample time =    23.52 ms
main:  predict time =   667.63 ms / 9.54 ms per token
main:    total time =   863.15 ms
