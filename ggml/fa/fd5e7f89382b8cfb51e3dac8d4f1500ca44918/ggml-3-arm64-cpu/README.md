...
- status:  SUCCESS ✅
- runtime: 3:06.81
- date:    Tue May 14 12:34:13 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.01 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.58 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.90 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.54 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.53 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.84 sec
      Start  2: test-opt
...
main:     load time =   143.68 ms
main:   sample time =    16.74 ms
main:  predict time =   896.63 ms / 14.01 ms per token
main:    total time =  1078.28 ms
...
main:     load time =   142.64 ms
main:   sample time =    16.73 ms
main:  predict time =   975.59 ms / 13.94 ms per token
...
main:     load time =   172.40 ms
main:   sample time =    16.70 ms
main:  predict time =   993.01 ms / 14.19 ms per token
main:    total time =  1185.31 ms
...
main:   sample time =   126.77 ms
main:  predict time =  6429.45 ms
main:    total time =  6781.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf430f2b2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf430f29ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbaee6dbb0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf430f2b2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf430f2b2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbaee6dbb1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf430f29ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbaee6dbb0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbaee6dbb2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbaee6dbb1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf430f2b2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbaee6dbb2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbaee6dbb2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbaee6dbb36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf430f2b2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbaee6dbb2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbaee6dbb3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbaee6dbb36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf430f2b2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbaee6dbb3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbaee6dbb3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.33 ms
whisper_print_timings:   sample time =    64.00 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4653.41 ms /     1 runs ( 4653.41 ms per run)
whisper_print_timings:   decode time =    15.33 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   708.60 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5560.17 ms
...
main:     load time =    82.75 ms
main:    total time = 39822.72 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.260000 sec.)
