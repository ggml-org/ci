...
- status:  SUCCESS ✅
- runtime: 2:12.22
- date:    Tue May 14 12:33:29 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.51 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   29.98 sec
...
main:     load time =   108.66 ms
main:   sample time =    24.08 ms
main:  predict time =   508.83 ms / 7.95 ms per token
main:    total time =   654.01 ms
...
main:     load time =   106.83 ms
main:   sample time =    23.91 ms
main:  predict time =   539.28 ms / 7.70 ms per token
main:    total time =   672.19 ms
...
main:     load time =   127.80 ms
main:   sample time =    23.91 ms
main:  predict time =   540.54 ms / 7.72 ms per token
main:    total time =   695.22 ms
...
main:     n_decoded =      504
main:     load time =   105.86 ms
main:   sample time =   178.48 ms
main:  predict time =  1852.66 ms
main:    total time =  2170.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x723ae46fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x723ae457b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5bc5e64dece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x723ae46fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x723ae46ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5bc5e64dfab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x723ae457b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5bc5e64dece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5bc5e64e0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5bc5e64dfab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x723ae46fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5bc5e64e0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5bc5e64e0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5bc5e64e16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x723ae46fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5bc5e64e0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5bc5e64e1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5bc5e64e16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x723ae46ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5bc5e64e1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5bc5e64e1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.42 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.30 ms
whisper_print_timings:   sample time =    55.57 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1167.15 ms /     1 runs ( 1167.15 ms per run)
whisper_print_timings:   decode time =    13.33 ms /     2 runs (    6.67 ms per run)
whisper_print_timings:   batchd time =   218.15 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1550.78 ms
...
main:     load time =    65.17 ms
main:    total time = 10689.23 ms
embd_img
