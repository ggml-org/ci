...
- status:  SUCCESS ✅
- runtime: 4:01.20
- date:    Tue May 14 12:35:07 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.41 sec
      Start  9: test3
...
main:  predict time =   898.99 ms / 14.05 ms per token
main:    total time =  1077.19 ms
...
main:  predict time =  1020.66 ms / 14.58 ms per token
main:    total time =  1182.46 ms
...
main:     load time =   168.55 ms
main:   sample time =    17.09 ms
main:  predict time =  1010.03 ms / 14.43 ms per token
main:    total time =  1198.93 ms
...
main:     n_decoded =      504
main:     load time =   143.36 ms
main:   sample time =   128.51 ms
main:  predict time =  6453.36 ms
main:    total time =  6807.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf2a3f518a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf2a3f500b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8bac1d87ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf2a3f518a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf2a3f518f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8bac1d88ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf2a3f500b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb8bac1d87ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8bac1d89410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8bac1d88ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf2a3f518a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8bac1d89d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8bac1d89410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8bac1d8a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf2a3f518a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8bac1d89d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8bac1d8a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8bac1d8a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf2a3f518f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb8bac1d8aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8bac1d8a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.99 ms
whisper_print_timings:   sample time =    64.61 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4683.14 ms /     1 runs ( 4683.14 ms per run)
whisper_print_timings:   decode time =    15.63 ms /     2 runs (    7.82 ms per run)
whisper_print_timings:   batchd time =   711.24 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5593.79 ms
...
main:     load time =    87.08 ms
main:    total time = 39983.38 ms
embd_img
