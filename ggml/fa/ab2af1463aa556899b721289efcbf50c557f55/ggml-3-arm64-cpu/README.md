...
- status:  SUCCESS ✅
- runtime: 7:30.22
- date:    Sat Jan 27 04:20:53 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.43 sec
...
20/20 Test #20: test-backend-ops .................   Passed  125.79 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 139.86 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.42 sec
...
main:     load time =   190.14 ms
main:   sample time =    17.10 ms
main:  predict time =   865.88 ms / 13.53 ms per token
main:    total time =  1095.56 ms
...
main:     load time =   177.65 ms
main:   sample time =    17.59 ms
main:  predict time =   931.51 ms / 13.31 ms per token
main:    total time =  1129.92 ms
...
main:     n_decoded =      504
main:     load time =   145.15 ms
main:   sample time =   126.73 ms
main:  predict time =  5987.18 ms
main:    total time =  6341.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb966a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb94eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad77eeb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb966a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb966f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad77ef960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb94eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad77eeb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad77f02c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad77ef960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb966a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad77f0c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad77f02c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad77f1580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb966a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad77f0c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad77f1740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad77f1580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb966f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad77f1900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad77f1740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   169.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.48 ms
whisper_print_timings:   sample time =    65.47 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4622.76 ms /     1 runs ( 4622.76 ms per run)
whisper_print_timings:   decode time =    16.86 ms /     2 runs (    8.43 ms per run)
whisper_print_timings:   batchd time =   710.10 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.37 ms
...
main:      load time =  9992.51 ms
main:    sample time =   516.64 ms / 8.07 ms per token
main:      eval time = 43749.25 ms / 624.99 ms per token
main:     total time = 56632.82 ms
...
main:      load time =  4370.01 ms
main:    sample time =   520.38 ms / 8.13 ms per token
main:      eval time = 17399.20 ms / 248.56 ms per token
main:     total time = 23246.10 ms
