...
- status:  SUCCESS ✅
- runtime: 13:13.66
- date:    Sat Jan 27 16:36:19 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.61 sec
...
20/20 Test #20: test-backend-ops .................   Passed  264.87 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 311.25 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 9/21 Test  #9: test2 ............................   Passed   20.85 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    2.11 sec
      Start 11: test-pool
...
Total Test time (real) =  92.51 sec
...
main:     load time =   959.93 ms
main:   sample time =    34.34 ms
main:  predict time =   601.65 ms / 9.40 ms per token
main:    total time =  1616.29 ms
...
main:     load time =   610.22 ms
main:   sample time =    33.97 ms
main:  predict time =   636.12 ms / 9.09 ms per token
main:    total time =  1284.82 ms
...
main:     n_decoded =      504
main:     load time =   544.62 ms
main:   sample time =   237.07 ms
main:  predict time =  2316.63 ms
main:    total time =  3143.60 ms
...
main: loaded model in   415.07 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6e3e9b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6e3e8371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e968d22940                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6e3e9b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6e3e9bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e968d23710                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6e3e8371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e968d22940                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e968d24070                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e968d23710                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6e3e9b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e968d249d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e968d24070                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e968d25330                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6e3e9b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e968d249d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e968d254f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e968d25330                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6e3e9bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e968d256b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e968d254f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1083.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.13 ms
whisper_print_timings:   sample time =    66.07 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    23.76 ms /     1 runs (   23.76 ms per run)
whisper_print_timings:   decode time =    23.32 ms /     2 runs (   11.66 ms per run)
whisper_print_timings:   batchd time =    81.45 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1303.98 ms
...
main:     load time =   507.45 ms
main:    total time =  7978.13 ms
embd_img
...
main:      load time = 15938.71 ms
main:    sample time =   520.97 ms / 8.14 ms per token
main:      eval time = 25144.02 ms / 359.20 ms per token
main:     total time = 42451.16 ms
...
main:      load time =  7532.20 ms
main:    sample time =   511.38 ms / 7.99 ms per token
main:      eval time = 12582.86 ms / 179.76 ms per token
main:     total time = 21274.04 ms
