...
- status:  SUCCESS ✅
- runtime: 7:41.28
- date:    Sat Jan 27 03:41:55 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  149.08 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 187.80 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.62 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.19 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.48 sec
...
main:     load time =   192.34 ms
main:   sample time =    17.72 ms
main:  predict time =   932.93 ms / 14.58 ms per token
main:    total time =  1165.11 ms
...
main:     load time =   191.85 ms
main:   sample time =    17.76 ms
main:  predict time =   965.51 ms / 13.79 ms per token
main:    total time =  1178.31 ms
...
main:   sample time =   131.35 ms
main:  predict time =  6181.46 ms
main:    total time =  6560.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbceaa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcd2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5671b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbceaa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbceaf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf5672960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcd2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf5671b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf56732c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf5672960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbceaa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf5673c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf56732c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf5674580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbceaa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf5673c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5674740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf5674580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbceaf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf5674900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf5674740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    67.44 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4803.63 ms /     1 runs ( 4803.63 ms per run)
whisper_print_timings:   decode time =    16.05 ms /     2 runs (    8.02 ms per run)
whisper_print_timings:   batchd time =   723.97 ms /   125 runs (    5.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5743.41 ms
...
main:     load time =    94.02 ms
main:    total time = 40721.31 ms
embd_img
