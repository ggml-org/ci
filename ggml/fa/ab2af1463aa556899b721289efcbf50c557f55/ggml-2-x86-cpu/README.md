...
- status:  SUCCESS ✅
- runtime: 5:09.93
- date:    Sat Jan 27 15:50:06 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  113.33 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.50 sec
...
main:     load time =   122.23 ms
main:   sample time =    23.76 ms
main:  predict time =   464.07 ms / 7.25 ms per token
main:    total time =   623.05 ms
...
main:     load time =   121.73 ms
main:   sample time =    23.71 ms
main:  predict time =   480.37 ms / 6.86 ms per token
main:    total time =   628.22 ms
...
main:     n_decoded =      504
main:     load time =   100.38 ms
main:   sample time =   177.47 ms
main:  predict time =  1531.26 ms
main:    total time =  1840.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f656c508990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f656c3891a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55edc8eb3b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f656c508030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f656c50d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55edc8eb4960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f656c3891a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55edc8eb3b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55edc8eb52c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55edc8eb4960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f656c508030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55edc8eb5c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55edc8eb52c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55edc8eb6580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f656c508990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55edc8eb5c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55edc8eb6740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55edc8eb6580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f656c50d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55edc8eb6900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55edc8eb6740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    80.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.59 ms
whisper_print_timings:   sample time =    54.69 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1157.31 ms /     1 runs ( 1157.31 ms per run)
whisper_print_timings:   decode time =     9.71 ms /     2 runs (    4.85 ms per run)
whisper_print_timings:   batchd time =   210.20 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1532.07 ms
...
main:     load time =    63.60 ms
main:    total time = 10660.41 ms
embd_img
...
main:      load time =  5324.52 ms
main:    sample time =   469.60 ms / 7.34 ms per token
main:      eval time = 19926.65 ms / 284.67 ms per token
main:     total time = 26361.25 ms
...
main:      load time =  1212.90 ms
main:    sample time =   467.89 ms / 7.31 ms per token
main:      eval time =  8342.75 ms / 119.18 ms per token
main:     total time = 10407.38 ms
