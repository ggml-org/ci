...
- status:  SUCCESS ✅
- runtime: 5:00.12
- date:    Sat Jan 27 15:39:03 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/faab2af1463aa556899b721289efcbf50c557f55
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    6.59 sec
      Start  6: test0
 ...
 8/20 Test  #8: test2 ............................   Passed   24.42 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.68 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  115.96 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 155.13 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.46 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.98 sec
...
main:     load time =   130.95 ms
main:   sample time =    23.84 ms
main:  predict time =   636.27 ms / 9.94 ms per token
main:    total time =   804.30 ms
...
main:  predict time =   663.12 ms / 9.47 ms per token
main:    total time =   818.93 ms
...
main:  predict time =  2499.01 ms
main:    total time =  2830.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f50ae69a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f50ae51b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56028b2fdb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f50ae69a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f50ae69f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56028b2fe960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f50ae51b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56028b2fdb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56028b2ff2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56028b2fe960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f50ae69a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56028b2ffc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56028b2ff2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56028b300580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f50ae69a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56028b2ffc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56028b300740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56028b300580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f50ae69f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56028b300900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56028b300740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.90 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.07 ms
whisper_print_timings:   sample time =    71.24 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1989.84 ms /     1 runs ( 1989.84 ms per run)
whisper_print_timings:   decode time =    12.97 ms /     2 runs (    6.49 ms per run)
whisper_print_timings:   batchd time =   323.22 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2498.55 ms
...
main:     load time =    68.69 ms
main:    total time = 19000.63 ms
embd_img
