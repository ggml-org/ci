...
- status:  SUCCESS ✅
- runtime: 3:53.21
- date:    Mon Oct  9 03:19:28 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.77 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.78 sec
      Start  2: test-opt
...
main:     load time =   272.62 ms
main:   sample time =    17.10 ms
main:  predict time =   800.50 ms / 12.51 ms per token
main:    total time =  1115.04 ms
...
main:  predict time =   867.85 ms / 12.40 ms per token
main:    total time =  1040.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f28a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f10b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab24d23ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f289fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f28f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab24d24870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f10b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab24d23ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab24d251a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab24d24870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f289fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab24d25ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab24d251a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab24d26400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f28a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab24d25ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab24d26590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab24d26400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f28f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab24d26720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab24d26590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   209.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.07 ms
whisper_print_timings:   sample time =    20.87 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4606.37 ms /     1 runs ( 4606.37 ms per run)
whisper_print_timings:   decode time =   176.37 ms /    27 runs (    6.53 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5080.32 ms
```
### mpt
...
main:      load time =  9864.70 ms
main:    sample time =   518.68 ms / 8.10 ms per token
main:      eval time = 43547.91 ms / 622.11 ms per token
main:     total time = 56303.87 ms
...
main:      load time =  2128.44 ms
main:    sample time =   517.89 ms / 8.09 ms per token
main:      eval time = 17469.63 ms / 249.57 ms per token
main:     total time = 21080.26 ms
