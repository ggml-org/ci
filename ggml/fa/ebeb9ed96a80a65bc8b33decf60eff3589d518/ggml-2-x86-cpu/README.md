...
- status:  SUCCESS ✅
- runtime: 2:55.81
- date:    Mon Oct  9 15:18:17 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/faebeb9ed96a80a65bc8b33decf60eff3589d518
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.82 sec
...
main:     load time =   183.34 ms
main:   sample time =    23.92 ms
main:  predict time =   482.26 ms / 7.54 ms per token
main:    total time =   703.12 ms
...
main:     load time =   113.93 ms
main:   sample time =    23.93 ms
main:  predict time =   490.70 ms / 7.01 ms per token
main:    total time =   631.66 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f56d7f17900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56d7d98170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b516e0ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f56d7f16fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f56d7f1c880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558b516e1870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56d7d98170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b516e0ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558b516e21a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558b516e1870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f56d7f16fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558b516e2ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558b516e21a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558b516e3400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f56d7f17900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558b516e2ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558b516e3590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558b516e3400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f56d7f1c880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558b516e3720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558b516e3590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   142.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.74 ms
whisper_print_timings:   sample time =    16.58 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1161.99 ms /     1 runs ( 1161.99 ms per run)
whisper_print_timings:   decode time =   108.29 ms /    27 runs (    4.01 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1488.02 ms
```
### mpt
...
main:      load time =  9501.61 ms
main:    sample time =   467.34 ms / 7.30 ms per token
main:      eval time = 22008.58 ms / 314.41 ms per token
main:     total time = 32768.10 ms
...
main:      load time =  4375.88 ms
main:    sample time =   459.63 ms / 7.18 ms per token
main:      eval time =  8619.03 ms / 123.13 ms per token
main:     total time = 13845.44 ms
