...
- status:  SUCCESS ✅
- runtime: 3:54.72
- date:    Sun Oct  8 04:48:24 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.64 sec
...
main:  predict time =   801.77 ms / 12.53 ms per token
main:    total time =  1021.78 ms
...
main:  predict time =   867.53 ms / 12.39 ms per token
main:    total time =  1038.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e00a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8de8b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadad11ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e009fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e00f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadad12870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8de8b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadad11ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadad131a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadad12870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e009fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadad13ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadad131a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadad14400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e00a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadad13ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadad14590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadad14400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e00f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadad14720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadad14590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12295.16 ms
main:    sample time =   513.59 ms / 8.02 ms per token
main:      eval time = 43792.10 ms / 625.60 ms per token
main:     total time = 58976.37 ms
...
main:      load time =  3858.54 ms
main:    sample time =   516.43 ms / 8.07 ms per token
main:      eval time = 17449.38 ms / 249.28 ms per token
main:     total time = 22787.59 ms
