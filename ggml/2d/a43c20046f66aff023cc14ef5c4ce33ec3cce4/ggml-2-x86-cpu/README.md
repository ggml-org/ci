...
- status:  SUCCESS ✅
- runtime: 2:46.27
- date:    Sun Oct  8 16:47:12 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/2da43c20046f66aff023cc14ef5c4ce33ec3cce4
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.69 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.65 sec
...
main:     load time =   178.27 ms
main:   sample time =    23.99 ms
main:  predict time =   471.08 ms / 7.36 ms per token
main:    total time =   687.00 ms
...
main:     load time =   110.34 ms
main:   sample time =    23.97 ms
main:  predict time =   492.66 ms / 7.04 ms per token
main:    total time =   630.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4a13504900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4a13385170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5606887f0ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4a13503fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4a13509880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5606887f1870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4a13385170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5606887f0ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5606887f21a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5606887f1870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4a13503fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5606887f2ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5606887f21a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5606887f3400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4a13504900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5606887f2ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5606887f3590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5606887f3400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4a13509880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5606887f3720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5606887f3590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   145.28 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.09 ms
whisper_print_timings:   sample time =    16.59 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1202.28 ms /     1 runs ( 1202.28 ms per run)
whisper_print_timings:   decode time =   105.75 ms /    27 runs (    3.92 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1529.69 ms
```
### mpt
...
main:      load time =  5641.15 ms
main:    sample time =   466.84 ms / 7.29 ms per token
main:      eval time = 22049.67 ms / 315.00 ms per token
main:     total time = 28854.21 ms
...
main:      load time =  1317.06 ms
main:    sample time =   461.61 ms / 7.21 ms per token
main:      eval time =  8656.63 ms / 123.67 ms per token
main:     total time = 10828.30 ms
