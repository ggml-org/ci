...
- status:  SUCCESS ✅
- runtime: 4:47.82
- date:    Sun Oct  8 16:49:06 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.38 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.31 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.48 sec
      Start  2: test-opt
...
main:   sample time =    35.88 ms
main:  predict time =   584.37 ms / 9.13 ms per token
main:    total time =   883.19 ms
...
main:     load time =   165.29 ms
main:   sample time =    34.44 ms
main:  predict time =   565.17 ms / 8.07 ms per token
main:    total time =   769.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efeb937a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efeb91fb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f0784cad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efeb9379fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efeb937f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555f0784d870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efeb91fb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f0784cad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555f0784e1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555f0784d870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efeb9379fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555f0784ead0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555f0784e1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555f0784f400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efeb937a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555f0784ead0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555f0784f590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555f0784f400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efeb937f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555f0784f720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555f0784f590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   192.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.88 ms
whisper_print_timings:   sample time =    20.46 ms /    27 runs (    0.76 ms per run)
whisper_print_timings:   encode time =  1860.75 ms /     1 runs ( 1860.75 ms per run)
whisper_print_timings:   decode time =   132.19 ms /    27 runs (    4.90 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2289.47 ms
```
### mpt
...
main:      load time =  8239.80 ms
main:    sample time =   598.11 ms / 9.35 ms per token
main:      eval time = 24424.34 ms / 348.92 ms per token
main:     total time = 34194.47 ms
...
main:      load time =  3125.53 ms
main:    sample time =   574.01 ms / 8.97 ms per token
main:      eval time = 12211.40 ms / 174.45 ms per token
main:     total time = 16574.96 ms
