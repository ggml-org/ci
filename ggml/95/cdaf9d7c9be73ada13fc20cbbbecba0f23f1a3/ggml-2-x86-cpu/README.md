...
- status:  SUCCESS ✅
- runtime: 3:57.24
- date:    Fri Dec  8 15:09:02 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    0.03 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   42.40 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.86 sec
...
main:     load time =   244.34 ms
main:   sample time =    23.35 ms
main:  predict time =   432.78 ms / 6.76 ms per token
main:    total time =   713.11 ms
...
main:  predict time =   453.92 ms / 6.48 ms per token
main:    total time =   606.01 ms
...
main:  predict time =  1465.87 ms
main:    total time =  1777.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4209b7c960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f42099fd190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559cd79b2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4209b7c010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4209b81900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559cd79b3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f42099fd190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559cd79b2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559cd79b4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559cd79b3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4209b7c010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559cd79b4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559cd79b4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559cd79b5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4209b7c960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559cd79b4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559cd79b56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559cd79b5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4209b81900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559cd79b5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559cd79b56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   143.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    55.84 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1151.30 ms /     1 runs ( 1151.30 ms per run)
whisper_print_timings:   decode time =     9.56 ms /     2 runs (    4.78 ms per run)
whisper_print_timings:   batchd time =   208.50 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1587.33 ms
...
main:      load time =  7263.71 ms
main:    sample time =   467.54 ms / 7.31 ms per token
main:      eval time = 20122.50 ms / 287.46 ms per token
main:     total time = 28509.21 ms
...
main:      load time =  3203.99 ms
main:    sample time =   464.85 ms / 7.26 ms per token
main:      eval time =  8052.77 ms / 115.04 ms per token
main:     total time = 12099.54 ms
