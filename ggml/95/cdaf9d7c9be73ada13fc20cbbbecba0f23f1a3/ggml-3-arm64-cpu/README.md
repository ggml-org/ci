...
- status:  SUCCESS ✅
- runtime: 5:40.24
- date:    Fri Dec  8 03:10:45 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.58 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   46.90 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.05 sec
...
main:     load time =   190.28 ms
main:   sample time =    17.13 ms
main:  predict time =   821.05 ms / 12.83 ms per token
main:    total time =  1050.12 ms
...
main:     load time =   181.87 ms
main:   sample time =    16.82 ms
main:  predict time =   878.51 ms / 12.55 ms per token
main:    total time =  1080.04 ms
...
main:     n_decoded =      504
main:     load time =   154.63 ms
main:   sample time =   127.06 ms
main:  predict time =  5841.39 ms
main:    total time =  6204.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8695a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff867db190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae86f4b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8695a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8695f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae86f5940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff867db190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae86f4b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae86f6290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae86f5940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8695a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae86f6be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae86f6290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae86f7530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8695a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae86f6be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae86f76e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae86f7530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8695f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae86f7890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae86f76e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.03 ms
whisper_print_timings:   sample time =    65.65 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4650.17 ms /     1 runs ( 4650.17 ms per run)
whisper_print_timings:   decode time =    15.26 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   706.98 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5567.82 ms
...
main:     load time =    90.98 ms
main:    total time = 39440.86 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.245000 sec.)
...
main:      load time =  7555.62 ms
main:    sample time =   529.25 ms / 8.27 ms per token
main:      eval time = 43620.10 ms / 623.14 ms per token
main:     total time = 54077.24 ms
...
main:      load time =  3240.64 ms
main:    sample time =   525.39 ms / 8.21 ms per token
main:      eval time = 17728.93 ms / 253.27 ms per token
main:     total time = 22465.07 ms
