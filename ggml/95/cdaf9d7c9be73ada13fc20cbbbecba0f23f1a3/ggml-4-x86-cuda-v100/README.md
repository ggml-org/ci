...
- status:  SUCCESS ✅
- runtime: 8:20.67
- date:    Fri Dec  8 15:13:31 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/95cdaf9d7c9be73ada13fc20cbbbecba0f23f1a3
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.73 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    7.89 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   91.18 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 123.40 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.79 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.63 sec
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    3.22 sec
      Start  7: test0
 7/20 Test  #7: test0 ............................   Passed    0.53 sec
      Start  8: test1
 8/20 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    8.01 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    1.08 sec
      Start 11: test-pool
11/20 Test #11: test-pool ........................   Passed    0.57 sec
      Start 12: test-conv-transpose
12/20 Test #12: test-conv-transpose ..............   Passed    0.55 sec
...
20/20 Test #20: test-backend-ops .................   Passed   22.53 sec
...
main:     load time =  1532.28 ms
main:   sample time =    34.53 ms
main:  predict time =   566.42 ms / 8.85 ms per token
main:    total time =  2157.21 ms
...
main:     load time =   615.44 ms
main:   sample time =    34.45 ms
main:  predict time =   583.64 ms / 8.34 ms per token
main:    total time =  1237.62 ms
...
main:     n_decoded =      504
main:     load time =   562.68 ms
main:   sample time =   235.98 ms
main:  predict time =  2229.46 ms
main:    total time =  3073.45 ms
...
main: loaded model in   405.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98b1bb6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98b1a37190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f85a36d9e0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98b1bb6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98b1bbb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f85a36e7a0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98b1a37190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f85a36d9e0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f85a36f0f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f85a36e7a0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98b1bb6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f85a36fa40                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f85a36f0f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f85a370390                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98b1bb6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f85a36fa40                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f85a370540                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f85a370390                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98b1bbb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f85a3706f0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f85a370540       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1082.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.63 ms
whisper_print_timings:   sample time =    66.29 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    35.34 ms /     1 runs (   35.34 ms per run)
whisper_print_timings:   decode time =    12.81 ms /     2 runs (    6.41 ms per run)
whisper_print_timings:   batchd time =    82.15 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1305.46 ms
...
main:     load time =   516.96 ms
main:    total time =  7891.20 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.665000 sec.)
...
main:      load time =  7401.66 ms
main:    sample time =   505.14 ms / 7.89 ms per token
main:      eval time = 24593.87 ms / 351.34 ms per token
main:     total time = 33354.83 ms
...
main:      load time =  2107.47 ms
main:    sample time =   532.19 ms / 8.32 ms per token
main:      eval time = 12453.84 ms / 177.91 ms per token
main:     total time = 15781.05 ms
