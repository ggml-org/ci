...
- status:  SUCCESS ✅
- runtime: 2:41.68
- date:    Sun Aug 13 18:53:44 UTC 2023
...
main:     load time =   160.25 ms
main:   sample time =    25.98 ms
main:  predict time =   510.51 ms / 7.98 ms per token
main:    total time =   733.14 ms
...
main: mem per token =  2015032 bytes
main:     load time =   128.89 ms
main:   sample time =    23.55 ms
main:  predict time =   436.05 ms / 6.23 ms per token
main:    total time =   613.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5ac4871870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ac46f2140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d8f725eaa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5ac4870f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5ac48767c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d8f725f810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ac46f2140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d8f725eaa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d8f7260110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d8f725f810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5ac4870f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d8f7260a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d8f7260110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d8f7261310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5ac4871870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d8f7260a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d8f7261470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d8f7261310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5ac48767c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d8f72615d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d8f7261470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 13704.24 ms
main:    sample time =   464.86 ms / 7.26 ms per token
main:      eval time = 20519.41 ms / 293.13 ms per token
main:     total time = 35354.97 ms
...
main:      load time =  4368.03 ms
main:    sample time =   459.97 ms / 7.19 ms per token
main:      eval time =  8316.95 ms / 118.81 ms per token
main:     total time = 13497.01 ms
...
```diff
--- /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/stdall	2023-08-07 12:14:24.527164109 +0000
+++ /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/stdall	2023-08-13 18:53:44.501000325 +0000
@@ -1,6 +1,6 @@
-rm: cannot remove '/home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/*.log': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/*.exit': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/*.md': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/*.md': No such file or directory
...
-+ tee /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_debug.log
++ tee /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_debug.log
 + rm -rf build-ci-debug
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_debug-cmake.log
...
-user	0m0.292s
-sys	0m0.100s
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_debug-make.log
+real	0m0.461s
+user	0m0.279s
+sys	0m0.105s
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_debug-make.log
 + make -j
...
-[ 66%] Building CXX object examples/gpt-neox/CMakeFiles/gpt-neox.dir/main.cpp.o
...
-[ 77%] Linking CXX executable ../../bin/dollyv2
...
-user	0m35.225s
-sys	0m3.905s
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_debug-ctest.log
+real	0m8.197s
+user	0m35.431s
+sys	0m3.524s
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
-+ tee /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_release.log
 + cd /home/ggml/work/ggml
 + rm -rf build-ci-release
++ tee /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_release.log
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_release-cmake.log
...
-user	0m0.293s
-sys	0m0.097s
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_release-make.log
+real	0m0.421s
+user	0m0.249s
+sys	0m0.134s
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_release-make.log
 + make -j
 [  1%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
 [  2%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
@@ -290,121 +290,121 @@
...
-[ 13%] Building CXX object tests/CMakeFiles/test-quantize-fns.dir/test-quantize-fns.cpp.o
-[ 13%] Building C object tests/CMakeFiles/test-vec1.dir/test-vec1.c.o
...
+sys	0m3.077s
 + '[' -z ']'
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/ctest_release-ctest.log
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/ctest_release-ctest.log
 + ctest --output-on-failure
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
@@ -412,9 +412,9 @@
  ...
  4/12 Test  #4: test-quantize-perf ...............   Passed    0.01 sec
       Start  5: test-mul-mat0
- 5/12 Test  #5: test-mul-mat0 ....................   Passed    0.72 sec
+ 5/12 Test  #5: test-mul-mat0 ....................   Passed    0.53 sec
       Start  6: test-mul-mat2
...
+sys	0m3.155s
 ...
 + gg_run_gpt_2
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/gpt_2.log
++ tee /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/gpt_2.log
...
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/gpt_2-tg.log
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -500,15 +500,15 @@
 ...
 main: mem per token =  2015032 bytes
-main:     load time =   202.18 ms
-main:   sample time =    23.51 ms
-main:  predict time =   459.77 ms / 7.18 ms per token
-main:    total time =   728.47 ms
-
-real	0m0.737s
-user	0m1.973s
-sys	0m0.187s
...
@@ -533,21 +533,21 @@
 ...
 main: mem per token =  2015032 bytes
-main:     load time =   135.38 ms
-main:   sample time =    23.39 ms
-main:  predict time =   444.52 ms / 6.35 ms per token
-main:    total time =   629.34 ms
-
-real	0m0.637s
-user	0m1.878s
-sys	0m0.116s
...
+sys	0m0.141s
 ...
 + set +x
 + gg_run_mnist
++ tee /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/mnist.log
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/mnist.log
 + cd build-ci-release
 + set -e
...
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/mnist-mnist.log
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
@@ -716,68 +716,68 @@
 ...
 TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3             DATA             NAME
-f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbadeb3e870                       fc2_weight
-f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbade9bf140                       fc1_weight
-f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561ffe6aeaa0                            input
-f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbadeb3df70                         fc1_bias
-f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbadeb437c0                         fc2_bias
+f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5ac4871870                       fc2_weight
+f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ac46f2140                       fc1_weight
+f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d8f725eaa0                            input
+f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5ac4870f70                         fc1_bias
+f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5ac48767c0                         fc2_bias
 ...
 ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
-DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561ffe6af810                           node_0
-SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbade9bf140                       fc1_weight
-SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561ffe6aeaa0                            input
-
-DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561ffe6b0110                           node_1
-SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561ffe6af810                           node_0
-SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbadeb3df70                         fc1_bias
-
-DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561ffe6b0a10                           node_2
-SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561ffe6b0110                           node_1
-
-DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561ffe6b1310                           node_3
-SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbadeb3e870                       fc2_weight
-SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561ffe6b0a10                           node_2
-
-DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561ffe6b1470                           node_4
-SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561ffe6b1310                           node_3
-SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbadeb437c0                         fc2_bias
+DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d8f725f810                           node_0
+SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ac46f2140                       fc1_weight
+SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d8f725eaa0                            input
+
...
-DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x561ffe6b15d0                            probs
-SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561ffe6b1470       mnist_eval: exported compute graph to 'mnist.ggml'
+DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d8f72615d0                            probs
+SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d8f7261470       mnist_eval: exported compute graph to 'mnist.ggml'
                     node_4
...
+sys	0m0.004s
 ...
 + gg_run_mpt
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/mpt.log
++ tee /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/mpt.log
...
-2023-08-07 12:12:35 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
...
@@ -826,7 +826,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-08-07 12:12:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
...
@@ -837,7 +837,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-08-07 12:12:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
...
@@ -848,7 +848,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-08-07 12:12:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
...
@@ -859,7 +859,7 @@
 ...
 Last-modified header missing -- time-stamps turned off.
-2023-08-07 12:12:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
...
-main: quantize time = 28833.92 ms
-main:    total time = 28833.92 ms
-+ tee -a /home/ggml/results/ggml/24/4776a089ebed7f0332f9c8bdc38d2d40464493/ggml-2-x86-cpu/mpt-tg.log
+main: quantize time = 28505.64 ms
+main:    total time = 28505.64 ms
++ tee -a /home/ggml/results/ggml/95/b559dbae6a25b2a7e26ab5989c1538387225e9/ggml-2-x86-cpu/mpt-tg.log
 + ./bin/mpt --model ../models-mnt/mpt/7B/ggml-model-f16.bin -s 1234 -n 64 -p 'I believe the meaning of life is'
 main: seed      = 1234
 main: n_threads = 4
@@ -1346,15 +1346,15 @@
 ...
 main: sampled tokens =       64
 main:  mem per token =   351236 bytes
-main:      load time = 13021.46 ms
-main:    sample time =   464.38 ms / 7.26 ms per token
-main:      eval time = 20393.08 ms / 291.33 ms per token
-main:     total time = 34604.19 ms
-
-real	0m34.969s
-user	1m24.871s
-sys	0m7.474s
...
@@ -1401,14 +1401,14 @@
 ...
 main: sampled tokens =       64
 main:  mem per token =   335876 bytes
-main:      load time =  4385.60 ms
-main:    sample time =   465.59 ms / 7.27 ms per token
-main:      eval time =  8219.98 ms / 117.43 ms per token
-main:     total time = 13444.12 ms
-
-real	0m13.458s
-user	0m34.716s
-sys	0m2.073s
