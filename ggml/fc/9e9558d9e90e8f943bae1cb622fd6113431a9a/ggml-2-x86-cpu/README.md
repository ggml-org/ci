...
- status:  SUCCESS ✅
- runtime: 2:55.46
- date:    Fri Oct  6 16:54:23 UTC 2023
...
main:  predict time =   503.83 ms / 7.87 ms per token
main:    total time =   727.62 ms
...
main:     load time =   113.10 ms
main:   sample time =    24.00 ms
main:  predict time =   494.82 ms / 7.07 ms per token
main:    total time =   634.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8dd142c900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8dd12ad170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561d5ee5dad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8dd142bfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8dd1431880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561d5ee5e870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8dd12ad170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561d5ee5dad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561d5ee5f1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561d5ee5e870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8dd142bfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561d5ee5fad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561d5ee5f1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561d5ee60400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8dd142c900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561d5ee5fad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561d5ee60590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561d5ee60400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8dd1431880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x561d5ee60720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561d5ee60590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 10329.51 ms
main:    sample time =   463.16 ms / 7.24 ms per token
main:      eval time = 22071.76 ms / 315.31 ms per token
main:     total time = 33673.63 ms
...
main:      load time =  4405.23 ms
main:    sample time =   461.48 ms / 7.21 ms per token
main:      eval time =  8663.89 ms / 123.77 ms per token
main:     total time = 13914.98 ms
