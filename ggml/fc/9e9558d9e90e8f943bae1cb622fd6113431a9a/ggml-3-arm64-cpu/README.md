...
- status:  SUCCESS ✅
- runtime: 3:49.56
- date:    Fri Oct  6 04:55:28 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/fc9e9558d9e90e8f943bae1cb622fd6113431a9a
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.79 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.61 sec
      Start  2: test-opt
...
main: compute buffer size: 14.58 MB
main: seed = 1234
...
main:     load time =   247.19 ms
main:   sample time =    17.03 ms
main:  predict time =   808.48 ms / 12.63 ms per token
main:    total time =  1096.21 ms
...
main:     load time =   151.42 ms
main:   sample time =    17.14 ms
main:  predict time =   872.47 ms / 12.46 ms per token
main:    total time =  1044.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85eca900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85d4b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafb3adad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85ec9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85ecf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafb3ae870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85d4b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafb3adad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafb3af1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafb3ae870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85ec9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafb3afad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafb3af1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafb3b0400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85eca900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafb3afad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafb3b0590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafb3b0400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85ecf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafb3b0720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafb3b0590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 12124.13 ms
main:    sample time =   523.01 ms / 8.17 ms per token
main:      eval time = 43543.93 ms / 622.06 ms per token
main:     total time = 58564.29 ms
...
main:      load time =  4343.95 ms
main:    sample time =   516.73 ms / 8.07 ms per token
main:      eval time = 17626.21 ms / 251.80 ms per token
main:     total time = 23449.21 ms
