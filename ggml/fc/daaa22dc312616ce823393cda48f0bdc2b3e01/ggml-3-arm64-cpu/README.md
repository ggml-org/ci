...
- status:  SUCCESS ✅
- runtime: 5:29.07
- date:    Thu Dec  7 03:05:15 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.37 sec
...
19/19 Test #19: test-backend-ops .................   Passed   47.18 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.14 sec
...
main:     load time =   183.03 ms
main:   sample time =    16.75 ms
main:  predict time =   818.02 ms / 12.78 ms per token
main:    total time =  1039.40 ms
...
main:     load time =   176.14 ms
main:   sample time =    16.98 ms
main:  predict time =   885.38 ms / 12.65 ms per token
main:    total time =  1081.15 ms
...
main:  predict time =  5850.64 ms
main:    total time =  6211.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8910a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88f8b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf39e0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8910a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8910f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf39e1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88f8b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf39e0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf39e2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf39e1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8910a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf39e2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf39e2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf39e3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8910a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf39e2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf39e36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf39e3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8910f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf39e3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf39e36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.83 ms
whisper_print_timings:   sample time =    65.64 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4649.25 ms /     1 runs ( 4649.25 ms per run)
whisper_print_timings:   decode time =    15.76 ms /     2 runs (    7.88 ms per run)
whisper_print_timings:   batchd time =   711.91 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5577.19 ms
...
main:     load time =    92.39 ms
main:    total time = 39343.89 ms
embd_img
...
main:      load time =  5573.29 ms
main:    sample time =   534.79 ms / 8.36 ms per token
main:      eval time = 43590.38 ms / 622.72 ms per token
main:     total time = 52072.18 ms
...
main:      load time =  1579.22 ms
main:    sample time =   527.18 ms / 8.24 ms per token
main:      eval time = 17590.26 ms / 251.29 ms per token
main:     total time = 20667.33 ms
