...
- status:  SUCCESS ✅
- runtime: 3:38.81
- date:    Thu Dec  7 03:03:27 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.76 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.80 sec
...
main:     load time =   121.22 ms
main:   sample time =    23.37 ms
main:  predict time =   440.36 ms / 6.88 ms per token
main:    total time =   597.20 ms
...
main:   sample time =    23.28 ms
main:  predict time =   444.15 ms / 6.35 ms per token
main:    total time =   592.33 ms
...
main:     n_decoded =      504
main:     load time =   100.81 ms
main:   sample time =   177.62 ms
main:  predict time =  1478.69 ms
main:    total time =  1788.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fccd3e01960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fccd3c82190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558d84cfeb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fccd3e01010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fccd3e06900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558d84cff940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fccd3c82190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558d84cfeb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558d84d00290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558d84cff940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fccd3e01010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558d84d00be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558d84d00290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558d84d01530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fccd3e01960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558d84d00be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558d84d016e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558d84d01530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fccd3e06900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558d84d01890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558d84d016e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.82 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.75 ms
whisper_print_timings:   sample time =    54.78 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1145.41 ms /     1 runs ( 1145.41 ms per run)
whisper_print_timings:   decode time =    10.09 ms /     2 runs (    5.04 ms per run)
whisper_print_timings:   batchd time =   206.41 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1512.29 ms
...
main:     load time =    68.57 ms
main:    total time = 10427.70 ms
embd_img
...
main:      load time =  4414.43 ms
main:    sample time =   467.05 ms / 7.30 ms per token
main:      eval time = 19191.65 ms / 274.17 ms per token
main:     total time = 24713.43 ms
...
main:      load time =  1184.10 ms
main:    sample time =   466.61 ms / 7.29 ms per token
main:      eval time =  8008.53 ms / 114.41 ms per token
main:     total time = 10044.38 ms
