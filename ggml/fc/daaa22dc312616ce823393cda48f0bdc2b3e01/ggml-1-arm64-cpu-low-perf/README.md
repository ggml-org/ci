...
- status:  SUCCESS ✅
- runtime: 3:48.05
- date:    Thu Dec  7 03:03:39 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.47 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   54.82 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.97 sec
      Start  9: test3
...
main:  predict time =   858.38 ms / 13.41 ms per token
main:    total time =  1092.03 ms
...
main:     load time =   191.23 ms
main:   sample time =    18.41 ms
main:  predict time =   934.18 ms / 13.35 ms per token
main:    total time =  1146.72 ms
...
main:     n_decoded =      504
main:     load time =   164.79 ms
main:   sample time =   127.82 ms
main:  predict time =  6026.17 ms
main:    total time =  6400.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98f1a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98d9b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3308b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98f1a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98f1f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae3309940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff98d9b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae3308b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae330a290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae3309940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff98f1a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae330abe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae330a290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae330b530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff98f1a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae330abe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae330b6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae330b530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff98f1f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae330b890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae330b6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    66.76 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4767.27 ms /     1 runs ( 4767.27 ms per run)
whisper_print_timings:   decode time =    16.13 ms /     2 runs (    8.07 ms per run)
whisper_print_timings:   batchd time =   715.92 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5693.51 ms
