...
- status:  SUCCESS ✅
- runtime: 6:22.47
- date:    Fri Dec 29 05:26:48 PM UTC 2023
...
20/20 Test #20: test-backend-ops .................   Passed   35.05 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.17 sec
...
main:     load time =   256.10 ms
main:   sample time =    17.00 ms
main:  predict time =   825.20 ms / 12.89 ms per token
main:    total time =  1120.10 ms
...
main:     load time =   183.28 ms
main:   sample time =    16.76 ms
main:  predict time =   892.21 ms / 12.75 ms per token
...
main:  predict time =  6004.18 ms
main:    total time =  6362.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb59aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb582b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae266bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb59aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb59af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae266c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb582b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae266bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae266d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae266c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb59aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae266dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae266d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae266e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb59aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae266dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae266e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae266e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb59af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae266e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae266e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   189.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.89 ms
whisper_print_timings:   sample time =    66.62 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4617.91 ms /     1 runs ( 4617.91 ms per run)
whisper_print_timings:   decode time =    15.17 ms /     2 runs (    7.59 ms per run)
whisper_print_timings:   batchd time =   706.49 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5613.38 ms
...
main:     load time =    78.54 ms
main:    total time = 39820.51 ms
embd_img
...
main:      load time = 12840.71 ms
main:    sample time =   514.15 ms / 8.03 ms per token
main:      eval time = 44171.38 ms / 631.02 ms per token
main:     total time = 59899.48 ms
...
main:      load time =  4363.39 ms
main:    sample time =   517.28 ms / 8.08 ms per token
main:      eval time = 17553.44 ms / 250.76 ms per token
main:     total time = 23403.04 ms
