...
- status:  SUCCESS ✅
- runtime: 4:46.80
- date:    Fri Dec 29 17:25:27 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/fca1caafea7de9fbd7efc733b9818f9cf2da3050
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.36 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.11 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.06 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   26.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.24 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed    7.81 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  16.15 sec
...
main:     load time =   184.38 ms
main:   sample time =    23.48 ms
main:  predict time =   447.95 ms / 7.00 ms per token
main:    total time =   668.48 ms
...
main:     load time =   134.38 ms
main:   sample time =    23.49 ms
main:  predict time =   457.02 ms / 6.53 ms per token
main:    total time =   616.97 ms
...
main:     n_decoded =      504
main:     load time =   106.41 ms
main:   sample time =   178.43 ms
main:  predict time =  1511.65 ms
main:    total time =  1827.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd79a910990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd79a7911a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5653b4eedb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd79a910030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd79a915940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5653b4eee960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd79a7911a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5653b4eedb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5653b4eef2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5653b4eee960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd79a910030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5653b4eefc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5653b4eef2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5653b4ef0580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd79a910990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5653b4eefc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5653b4ef0740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5653b4ef0580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd79a915940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5653b4ef0900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5653b4ef0740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   124.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.80 ms
whisper_print_timings:   sample time =    55.02 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1160.27 ms /     1 runs ( 1160.27 ms per run)
whisper_print_timings:   decode time =     9.48 ms /     2 runs (    4.74 ms per run)
whisper_print_timings:   batchd time =   207.79 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1575.39 ms
...
main:     load time =    63.67 ms
main:    total time = 10606.88 ms
embd_img
...
main:      load time = 11303.91 ms
main:    sample time =   466.98 ms / 7.30 ms per token
main:      eval time = 20374.17 ms / 291.06 ms per token
main:     total time = 32818.73 ms
...
main:      load time =  4373.52 ms
main:    sample time =   465.05 ms / 7.27 ms per token
main:      eval time =  8190.44 ms / 117.01 ms per token
main:     total time = 13390.30 ms
