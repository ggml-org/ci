...
- status:  SUCCESS ✅
- runtime: 3:37.96
- date:    Fri Dec 29 05:10:49 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.69 sec
...
20/20 Test #20: test-backend-ops .................   Passed   43.60 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.66 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   10.03 sec
...
main:  predict time =   851.49 ms / 13.30 ms per token
main:    total time =  1084.67 ms
...
main:     load time =   195.77 ms
main:   sample time =    17.83 ms
main:  predict time =  1061.31 ms / 15.16 ms per token
main:    total time =  1277.93 ms
...
main:     n_decoded =      504
main:     load time =   163.35 ms
main:   sample time =   131.15 ms
main:  predict time =  6168.59 ms
main:    total time =  6545.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff907ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9064b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed2d0b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff907ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff907cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaed2d1960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9064b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed2d0b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaed2d22c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaed2d1960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff907ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaed2d2c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaed2d22c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaed2d3580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff907ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaed2d2c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaed2d3740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaed2d3580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff907cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaed2d3900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaed2d3740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.68 ms
whisper_print_timings:   sample time =    67.57 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4744.63 ms /     1 runs ( 4744.63 ms per run)
whisper_print_timings:   decode time =    15.61 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   713.74 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5672.55 ms
...
main:     load time =    97.92 ms
main:    total time = 40708.78 ms
embd_img
