...
- status:  SUCCESS ✅
- runtime: 3:48.89
- date:    Thu Dec  7 05:58:00 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.78 sec
...
19/19 Test #19: test-backend-ops .................   Passed   55.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.48 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   12.58 sec
...
main:  predict time =   984.00 ms / 15.37 ms per token
main:    total time =  1215.49 ms
...
main:  predict time =   912.71 ms / 13.04 ms per token
...
main:     n_decoded =      504
main:     load time =   163.83 ms
main:   sample time =   129.45 ms
main:  predict time =  6041.94 ms
main:    total time =  6416.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8491a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8479b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab02824b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8491a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8491f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab02825940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8479b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab02824b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab02826290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab02825940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8491a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab02826be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab02826290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab02827530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8491a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab02826be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab028276e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab02827530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8491f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab02827890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab028276e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    18.49 ms
whisper_print_timings:   sample time =    67.41 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4747.96 ms /     1 runs ( 4747.96 ms per run)
whisper_print_timings:   decode time =    21.06 ms /     2 runs (   10.53 ms per run)
whisper_print_timings:   batchd time =   721.12 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5690.13 ms
...
main:     load time =    92.67 ms
main:    total time = 40121.38 ms
embd_img
