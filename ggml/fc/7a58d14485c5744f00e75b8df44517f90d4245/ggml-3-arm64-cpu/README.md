...
- status:  SUCCESS ✅
- runtime: 5:28.22
- date:    Thu Dec  7 05:59:38 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.22 sec
...
19/19 Test #19: test-backend-ops .................   Passed   47.16 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.36 sec
...
main:     load time =   191.01 ms
main:   sample time =    17.32 ms
main:  predict time =   818.09 ms / 12.78 ms per token
main:    total time =  1048.05 ms
...
main:     load time =   192.23 ms
main:   sample time =    17.07 ms
main:  predict time =   877.89 ms / 12.54 ms per token
main:    total time =  1090.12 ms
...
main:     n_decoded =      504
main:     load time =   155.12 ms
main:   sample time =   127.66 ms
main:  predict time =  5834.23 ms
main:    total time =  6198.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7d1a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7b9b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae035db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7d1a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7d1f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae035e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7b9b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae035db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae035f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae035e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7d1a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae035fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae035f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae0360530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7d1a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae035fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae03606e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae0360530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7d1f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae0360890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae03606e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.87 ms
whisper_print_timings:   sample time =    65.34 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4642.26 ms /     1 runs ( 4642.26 ms per run)
whisper_print_timings:   decode time =    15.32 ms /     2 runs (    7.66 ms per run)
whisper_print_timings:   batchd time =   709.84 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5560.50 ms
...
main:     load time =    97.63 ms
main:    total time = 39351.92 ms
embd_img
...
main:      load time =  5609.87 ms
main:    sample time =   533.89 ms / 8.34 ms per token
main:      eval time = 43537.76 ms / 621.97 ms per token
main:     total time = 52053.73 ms
...
main:      load time =  1519.86 ms
main:    sample time =   524.15 ms / 8.19 ms per token
main:      eval time = 17687.33 ms / 252.68 ms per token
main:     total time = 20701.16 ms
