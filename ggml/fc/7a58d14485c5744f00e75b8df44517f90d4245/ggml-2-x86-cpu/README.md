...
- status:  SUCCESS ✅
- runtime: 3:38.58
- date:    Thu Dec  7 17:57:55 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.43 sec
...
19/19 Test #19: test-backend-ops .................   Passed   42.67 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.78 sec
...
main:  predict time =   449.86 ms / 7.03 ms per token
main:    total time =   611.10 ms
...
main:     load time =   132.61 ms
main:   sample time =    23.62 ms
main:  predict time =   470.15 ms / 6.72 ms per token
main:    total time =   628.54 ms
...
main:  predict time =  1461.20 ms
main:    total time =  1776.08 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f73a5ced960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f73a5b6e190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559185c6eb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f73a5ced010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f73a5cf2900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559185c6f940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f73a5b6e190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559185c6eb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559185c70290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559185c6f940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f73a5ced010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559185c70be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559185c70290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559185c71530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f73a5ced960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559185c70be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559185c716e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559185c71530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f73a5cf2900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559185c71890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559185c716e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1148.32 ms /     1 runs ( 1148.32 ms per run)
whisper_print_timings:   decode time =     9.71 ms /     2 runs (    4.86 ms per run)
whisper_print_timings:   batchd time =   207.69 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1515.05 ms
...
main:     load time =    67.57 ms
main:    total time = 10425.92 ms
embd_img
...
main:      load time =  4453.44 ms
main:    sample time =   469.27 ms / 7.33 ms per token
main:      eval time = 19387.89 ms / 276.97 ms per token
main:     total time = 24948.48 ms
...
main:      load time =  1209.96 ms
main:    sample time =   466.63 ms / 7.29 ms per token
main:      eval time =  8118.97 ms / 115.99 ms per token
main:     total time = 10168.37 ms
