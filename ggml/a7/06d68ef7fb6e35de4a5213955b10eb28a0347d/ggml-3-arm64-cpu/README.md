...
- status:  SUCCESS ✅
- runtime: 3:47.86
- date:    Thu Sep 28 09:07:33 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.79 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.68 sec
      Start  2: test-opt
...
main:     load time =   254.80 ms
main:   sample time =    16.95 ms
main:  predict time =   804.60 ms / 12.57 ms per token
main:    total time =  1099.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff953aa8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9522b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7f56ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff953a9fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff953af840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae7f57850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9522b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7f56ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae7f58170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae7f57850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff953a9fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae7f58a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae7f58170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae7f593b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff953aa8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae7f58a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae7f59530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae7f593b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff953af840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae7f596b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae7f59530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   195.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.06 ms
whisper_print_timings:   sample time =    20.28 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  4589.77 ms /     1 runs ( 4589.77 ms per run)
whisper_print_timings:   decode time =   177.80 ms /    27 runs (    6.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5041.48 ms
```
### mpt
...
main:      load time = 12009.37 ms
main:    sample time =   523.27 ms / 8.18 ms per token
main:      eval time = 43725.96 ms / 624.66 ms per token
main:     total time = 58629.57 ms
...
main:      load time =  4364.23 ms
main:    sample time =   519.70 ms / 8.12 ms per token
main:      eval time = 17796.17 ms / 254.23 ms per token
main:     total time = 23637.31 ms
