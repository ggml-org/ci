...
- status:  SUCCESS ✅
- runtime: 5:14.71
- date:    Thu Sep 28 21:09:02 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed   16.25 sec
      Start 10: test3
...
main:  predict time =   567.34 ms / 8.10 ms per token
main:    total time =   807.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0ef76798d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0ef74fa160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555e7e007ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0ef7678fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0ef767e840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555e7e008850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0ef74fa160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555e7e007ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555e7e009170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555e7e008850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0ef7678fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555e7e009a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555e7e009170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555e7e00a3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0ef76798d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555e7e009a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555e7e00a530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555e7e00a3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0ef767e840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555e7e00a6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555e7e00a530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   697.88 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.06 ms
whisper_print_timings:   sample time =    21.01 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  1811.72 ms /     1 runs ( 1811.72 ms per run)
whisper_print_timings:   decode time =   121.74 ms /    27 runs (    4.51 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2729.96 ms
```
### mpt
...
main:      load time =  7324.84 ms
main:    sample time =   583.43 ms / 9.12 ms per token
main:      eval time = 25062.70 ms / 358.04 ms per token
main:     total time = 33863.89 ms
...
main:      load time =  1675.27 ms
main:    sample time =   572.18 ms / 8.94 ms per token
main:      eval time = 12078.93 ms / 172.56 ms per token
main:     total time = 14981.60 ms
