...
- status:  SUCCESS ✅
- runtime: 2:56.26
- date:    Thu Sep 28 21:06:35 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.23 sec
      Start  2: test-opt
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.60 sec
...
main:     load time =   203.87 ms
main:   sample time =    23.92 ms
main:  predict time =   476.53 ms / 7.45 ms per token
main:    total time =   718.28 ms
...
main:     load time =   145.20 ms
main:   sample time =    23.89 ms
main:  predict time =   517.32 ms / 7.39 ms per token
main:    total time =   689.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f651dd9f8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f651dc20160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b8ade38ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f651dd9efb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f651dda4840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b8ade39850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f651dc20160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b8ade38ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b8ade3a170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b8ade39850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f651dd9efb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b8ade3aa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b8ade3a170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b8ade3b3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f651dd9f8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b8ade3aa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b8ade3b530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b8ade3b3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f651dda4840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b8ade3b6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b8ade3b530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   127.50 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.85 ms
whisper_print_timings:   sample time =    16.17 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1163.49 ms /     1 runs ( 1163.49 ms per run)
whisper_print_timings:   decode time =   105.94 ms /    27 runs (    3.92 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1465.46 ms
```
### mpt
...
main:      load time = 13454.09 ms
main:    sample time =   462.82 ms / 7.23 ms per token
main:      eval time = 21944.33 ms / 313.49 ms per token
main:     total time = 36546.91 ms
...
main:      load time =  4377.37 ms
main:    sample time =   460.96 ms / 7.20 ms per token
main:      eval time =  8763.09 ms / 125.19 ms per token
main:     total time = 13987.76 ms
