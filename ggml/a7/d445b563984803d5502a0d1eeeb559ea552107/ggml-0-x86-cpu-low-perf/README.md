...
- status:  SUCCESS ✅
- runtime: 1:40.01
- date:    Mon Aug  7 11:29:28 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/11 Test  #1: test-grad0 .......................   Passed    4.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/11 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/11 Test  #8: test2 ............................   Passed   19.54 sec
      Start  9: test3
...
main:     load time =   133.87 ms
main:   sample time =    23.67 ms
main:  predict time =   597.42 ms / 9.33 ms per token
main:    total time =   799.38 ms
...
main: mem per token =  2015032 bytes
main:     load time =   132.46 ms
main:   sample time =    23.60 ms
main:  predict time =   616.02 ms / 8.80 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f81b1eac870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81b1d2d140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556255d2caa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f81b1eabf70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f81b1eb17c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556255d2d810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81b1d2d140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556255d2caa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556255d2e110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556255d2d810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f81b1eabf70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556255d2ea10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556255d2e110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556255d2f310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f81b1eac870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556255d2ea10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556255d2f470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556255d2f310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f81b1eb17c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556255d2f5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556255d2f470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
```diff
--- /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/stdall	2023-08-07 11:24:55.757044864 +0000
+++ /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/stdall	2023-08-07 11:29:28.745535330 +0000
@@ -1,7 +1,7 @@
 mkdir: cannot create directory ‘/mnt/ggml’: Permission denied
-rm: cannot remove '/home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/*.log': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/*.exit': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/*.md': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/*.md': No such file or directory
...
@@ -43,13 +43,13 @@
 ...
 + gg_run_ctest_debug
-+ tee /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_debug.log
 + cd /home/ggml/work/ggml
 + rm -rf build-ci-debug
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
...
-user	0m0.272s
-sys	0m0.105s
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_debug-make.log
+real	0m0.394s
+user	0m0.283s
+sys	0m0.090s
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_debug-make.log
 + make -j
...
-user	0m38.187s
-sys	0m3.544s
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_debug-ctest.log
+real	0m12.493s
+user	0m38.674s
+sys	0m3.406s
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
- 1/11 Test  #1: test-grad0 .......................   Passed    4.06 sec
+ 1/11 Test  #1: test-grad0 .......................   Passed    4.19 sec
       Start  2: test-quantize-fns
  2/11 Test  #2: test-quantize-fns ................   Passed    0.01 sec
       Start  3: test-quantize-perf
...
+ 8/11 Test  #8: test2 ............................   Passed   19.62 sec
       Start  9: test3
- 9/11 Test  #9: test3 ............................   Passed    1.03 sec
+ 9/11 Test  #9: test3 ............................   Passed    1.09 sec
       Start 10: test-pool
 10/11 Test #10: test-pool ........................   Passed    0.00 sec
       Start 11: test-customop
...
-+ tee /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_release.log
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_release.log
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_release-cmake.log
...
-user	0m0.276s
-sys	0m0.103s
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_release-make.log
+real	0m0.391s
+user	0m0.259s
+sys	0m0.113s
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_release-make.log
 + make -j
 [  1%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
 [  2%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
@@ -283,104 +283,104 @@
...
+sys	0m3.085s
 + '[' -z 1 ']'
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/ctest_release-ctest.log
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/ctest_release-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
@@ -410,9 +410,9 @@
  ...
  7/11 Test  #7: test1 ............................   Passed    0.00 sec
       Start  8: test2
- 8/11 Test  #8: test2 ............................   Passed   19.80 sec
+ 8/11 Test  #8: test2 ............................   Passed   19.54 sec
       Start  9: test3
...
-Total Test time (real) =  28.58 sec
+Total Test time (real) =  28.12 sec
...
+sys	0m3.096s
 ...
 + gg_run_gpt_2
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/gpt_2.log
 + gg_wget models-mnt/gpt-2 https://huggingface.co/ggerganov/ggml/resolve/main/ggml-model-gpt-2-117M.bin
 + local out=models-mnt/gpt-2
 + local url=https://huggingface.co/ggerganov/ggml/resolve/main/ggml-model-gpt-2-117M.bin
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/gpt_2.log
 ++ pwd
...
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/gpt_2-tg.log
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -490,15 +490,15 @@
...
-main:  predict time =   603.92 ms / 9.44 ms per token
-main:    total time =   812.02 ms
-
-real	0m0.820s
-user	0m2.533s
-sys	0m0.159s
...
@@ -523,14 +523,14 @@
 ...
 main: mem per token =  2015032 bytes
-main:     load time =   131.96 ms
-main:   sample time =    23.87 ms
-main:  predict time =   631.24 ms / 9.02 ms per token
-main:    total time =   827.67 ms
-
-real	0m0.835s
-user	0m2.652s
-sys	0m0.140s
...
@@ -539,8 +539,8 @@
 ...
 + cd build-ci-release
 + set -e
-+ tee /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/mnist.log
 + mkdir -p models/mnist
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/mnist.log
...
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-0-x86-cpu-low-perf/mnist-mnist.log
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-0-x86-cpu-low-perf/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
@@ -706,68 +706,68 @@
 ...
 TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3             DATA             NAME
-f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f85f9229870                       fc2_weight
-f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f85f90aa140                       fc1_weight
-f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c959d36aa0                            input
-f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f85f9228f70                         fc1_bias
-f32    NONE                1 10 1 1 1                4               40               40               40   0x7f85f922e7c0                         fc2_bias
+f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f81b1eac870                       fc2_weight
+f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81b1d2d140                       fc1_weight
+f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556255d2caa0                            input
+f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f81b1eabf70                         fc1_bias
+f32    NONE                1 10 1 1 1                4               40               40               40   0x7f81b1eb17c0                         fc2_bias
 ...
 ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
-DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c959d37810                           node_0
-SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f85f90aa140                       fc1_weight
-SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c959d36aa0                            input
-
-DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c959d38110                           node_1
-SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c959d37810                           node_0
-SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f85f9228f70                         fc1_bias
-
-DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c959d38a10                           node_2
-SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c959d38110                           node_1
-
-DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c959d39310                           node_3
-SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f85f9229870                       fc2_weight
-SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c959d38a10                           node_2
-
-DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c959d39470                           node_4
-SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c959d39310                           node_3
-SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f85f922e7c0                         fc2_bias
+DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556255d2d810                           node_0
+SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f81b1d2d140                       fc1_weight
+SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556255d2caa0                            input
+
...
-DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c959d395d0                            probs
-SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c959d39470       mnist_eval: exported compute graph to 'mnist.ggml'
+DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556255d2f5d0                            probs
+SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556255d2f470       mnist_eval: exported compute graph to 'mnist.ggml'
                     node_4
