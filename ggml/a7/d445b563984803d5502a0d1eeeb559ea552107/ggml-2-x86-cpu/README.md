...
- status:  SUCCESS ✅
- runtime: 2:41.28
- date:    Mon Aug  7 11:38:27 UTC 2023
...
main:     load time =   196.68 ms
main:   sample time =    26.11 ms
main:  predict time =   501.51 ms / 7.84 ms per token
main:    total time =   751.33 ms
...
main:  predict time =   442.29 ms / 6.32 ms per token
main:    total time =   620.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3ef4aca870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3ef494b140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555ddce38aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3ef4ac9f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3ef4acf7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555ddce39810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3ef494b140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555ddce38aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555ddce3a110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555ddce39810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3ef4ac9f70                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555ddce3aa10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555ddce3a110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555ddce3b310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3ef4aca870                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555ddce3aa10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555ddce3b470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555ddce3b310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3ef4acf7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555ddce3b5d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555ddce3b470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 13566.85 ms
main:    sample time =   463.20 ms / 7.24 ms per token
main:      eval time = 20540.53 ms / 293.44 ms per token
main:     total time = 35285.05 ms
...
main:      load time =  4384.60 ms
main:    sample time =   460.86 ms / 7.20 ms per token
main:      eval time =  8328.57 ms / 118.98 ms per token
main:     total time = 13527.38 ms
...
+++ /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/stdall	2023-08-07 11:38:27.933341060 +0000
@@ -1,54 +1,63 @@
...
+rm: cannot remove '/home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/*.md': No such file or directory
...
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-2-x86-cpu/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_debug-cmake.log
...
+user	0m0.274s
+sys	0m0.116s
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_debug-make.log
 + make -j
...
+[ 75%] Linking CXX executable ../../bin/gpt-2
+[ 75%] Built target mnist
+[ 75%] Built target gpt-2
...
+[ 81%] Built target starcoder-mmap
...
+user	0m35.422s
+sys	0m3.547s
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_release.log
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/12/68cbef8e34eec70844c5670a9283f315064b03/ggml-2-x86-cpu/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_release-cmake.log
...
+user	0m0.272s
+sys	0m0.119s
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_release-make.log
 + make -j
...
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/ctest_release-ctest.log
 + ctest --output-on-failure
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/gpt_2.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -491,15 +500,15 @@
...
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/mnist.log
 + cd /home/ggml/work/ggml
 + cd build-ci-release
 + set -e
@@ -664,40 +673,40 @@
...
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/mnist-mnist.log
 + ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
 _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
+sys	0m0.000s
 ...
 + set +x
 + gg_run_mpt
++ tee /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/mpt.log
 + cd /home/ggml/work/ggml
...
+2023-08-07 11:36:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-07 11:36:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-07 11:36:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-07 11:36:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-08-07 11:36:36 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
 + cd /home/ggml/work/ggml
...
+main: quantize time = 27926.16 ms
+main:    total time = 27926.16 ms
++ tee -a /home/ggml/results/ggml/a7/d445b563984803d5502a0d1eeeb559ea552107/ggml-2-x86-cpu/mpt-tg.log
 + ./bin/mpt --model ../models-mnt/mpt/7B/ggml-model-f16.bin -s 1234 -n 64 -p 'I believe the meaning of life is'
 main: seed      = 1234
 main: n_threads = 4
@@ -1337,15 +1346,15 @@
