...
- status:  SUCCESS ✅
- runtime: 5:13.40
- date:    Wed Feb 28 11:10:53 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.59 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed   12.31 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    9.04 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.38 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  108.24 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 166.44 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.72 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    6.60 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    4.55 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.52 sec
      Start  5: test-mul-mat2
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   25.78 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  69.80 sec
...
main:  predict time =   707.11 ms / 11.05 ms per token
main:    total time =   853.66 ms
...
main:  predict time =   762.57 ms / 10.89 ms per token
main:    total time =   895.10 ms
...
main:     load time =   131.04 ms
main:   sample time =    23.93 ms
main:  predict time =   762.03 ms / 10.89 ms per token
main:    total time =   919.65 ms
...
main:   sample time =   175.66 ms
main:  predict time =  3106.95 ms
main:    total time =  3434.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f28f9247990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f28f90c81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559b0bfcdce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f28f9247030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f28f924c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559b0bfceab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f28f90c81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559b0bfcdce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559b0bfcf410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559b0bfceab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f28f9247030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559b0bfcfd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559b0bfcf410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559b0bfd06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f28f9247990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559b0bfcfd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559b0bfd0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559b0bfd06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f28f924c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559b0bfd0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559b0bfd0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.41 ms
whisper_print_timings:   sample time =    71.90 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2059.06 ms /     1 runs ( 2059.06 ms per run)
whisper_print_timings:   decode time =    16.37 ms /     2 runs (    8.18 ms per run)
whisper_print_timings:   batchd time =   330.14 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2579.37 ms
