...
- status:  SUCCESS ✅
- runtime: 3:57.40
- date:    Wed Feb 28 11:09:33 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  107.99 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 139.02 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    6.53 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    4.61 sec
...
21/21 Test #21: test-backend-ops .................   Passed   28.08 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  46.67 sec
...
main:  predict time =   488.63 ms / 7.63 ms per token
main:    total time =   628.85 ms
...
main:  predict time =   512.75 ms / 7.32 ms per token
main:    total time =   642.51 ms
...
main:     load time =   128.58 ms
main:   sample time =    23.90 ms
main:  predict time =   518.04 ms / 7.40 ms per token
main:    total time =   673.13 ms
...
main:   sample time =   175.51 ms
main:  predict time =  1817.14 ms
main:    total time =  2128.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f32d0b3c990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f32d09bd1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560ae170dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f32d0b3c030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f32d0b41940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560ae170eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f32d09bd1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560ae170dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560ae170f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560ae170eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f32d0b3c030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560ae170fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560ae170f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560ae17106d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f32d0b3c990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560ae170fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560ae1710890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560ae17106d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f32d0b41940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560ae1710a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560ae1710890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.24 ms
whisper_print_timings:   sample time =    55.07 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1202.17 ms /     1 runs ( 1202.17 ms per run)
whisper_print_timings:   decode time =    12.97 ms /     2 runs (    6.49 ms per run)
whisper_print_timings:   batchd time =   213.92 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1580.77 ms
...
main:     load time =    66.14 ms
main:    total time = 10711.08 ms
embd_img
