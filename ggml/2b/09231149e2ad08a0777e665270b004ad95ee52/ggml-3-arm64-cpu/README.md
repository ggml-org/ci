...
- status:  SUCCESS ✅
- runtime: 5:19.17
- date:    Wed Feb 28 11:10:55 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed   13.23 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed   10.07 sec
...
20/20 Test #20: test-backend-ops .................   Passed  130.46 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 166.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    7.06 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    4.98 sec
...
21/21 Test #21: test-backend-ops .................   Passed   32.75 sec
...
main:     load time =   150.97 ms
main:   sample time =    17.00 ms
main:  predict time =   895.39 ms / 13.99 ms per token
main:    total time =  1085.36 ms
...
main:  predict time =   974.21 ms / 13.92 ms per token
main:    total time =  1138.65 ms
...
main:  predict time =   982.85 ms / 14.04 ms per token
...
main:  predict time =  6458.43 ms
main:    total time =  6819.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9cc5a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9cadb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeddbcce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cc5a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cc5f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeddbdab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9cadb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeddbcce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeddbe410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeddbdab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cc5a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeddbed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeddbe410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeddbf6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9cc5a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeddbed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeddbf890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeddbf6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cc5f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeddbfa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeddbf890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.34 ms
whisper_print_timings:   sample time =    65.79 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4684.26 ms /     1 runs ( 4684.26 ms per run)
whisper_print_timings:   decode time =    15.13 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   710.99 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5598.43 ms
