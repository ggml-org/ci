...
- status:  SUCCESS ✅
- runtime: 6:19.74
- date:    Wed Feb 28 11:12:30 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.06 sec
...
20/20 Test #20: test-backend-ops .................   Passed  135.36 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.68 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   30.42 sec
...
main:  predict time =   963.94 ms / 15.06 ms per token
main:    total time =  1163.96 ms
...
main:  predict time =  1035.08 ms / 14.79 ms per token
main:    total time =  1246.54 ms
...
main:     n_decoded =      504
main:     load time =   159.92 ms
main:   sample time =   126.86 ms
main:  predict time =  6804.89 ms
main:    total time =  7301.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb379a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb361b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbbb0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb379a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb379f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadbbb1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb361b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbbb0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadbbb2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadbbb1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb379a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadbbb2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadbbb2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadbbb36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb379a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadbbb2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadbbb3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadbbb36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb379f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadbbb3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadbbb3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    64.35 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4765.52 ms /     1 runs ( 4765.52 ms per run)
whisper_print_timings:   decode time =    15.25 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   709.45 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5680.99 ms
...
main:     load time =    89.37 ms
main:    total time = 40714.76 ms
embd_img
