...
- status:  SUCCESS ✅
- runtime: 5:02.60
- date:    Mon Jan 29 11:36:09 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  111.47 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 122.41 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.38 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   19.76 sec
...
main:     load time =   126.80 ms
main:   sample time =    23.81 ms
main:  predict time =   469.64 ms / 7.34 ms per token
main:    total time =   633.37 ms
...
main:  predict time =   496.66 ms / 7.10 ms per token
main:    total time =   649.06 ms
...
main:  predict time =  1534.71 ms
main:    total time =  1849.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9532152990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9531fd31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564d50abab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9532152030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9532157940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564d50abb960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9531fd31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564d50abab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564d50abc2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564d50abb960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9532152030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564d50abcc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564d50abc2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564d50abd580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9532152990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564d50abcc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564d50abd740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564d50abd580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9532157940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564d50abd900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564d50abd740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.42 ms
whisper_print_timings:   sample time =    56.16 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1158.17 ms /     1 runs ( 1158.17 ms per run)
whisper_print_timings:   decode time =    10.37 ms /     2 runs (    5.19 ms per run)
whisper_print_timings:   batchd time =   217.76 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1534.34 ms
...
main:     load time =    64.60 ms
main:    total time = 10637.28 ms
embd_img
...
main:      load time =  5280.20 ms
main:    sample time =   469.53 ms / 7.34 ms per token
main:      eval time = 19810.56 ms / 283.01 ms per token
main:     total time = 26201.05 ms
...
main:      load time =  1212.88 ms
main:    sample time =   466.77 ms / 7.29 ms per token
main:      eval time =  8173.31 ms / 116.76 ms per token
main:     total time = 10223.44 ms
