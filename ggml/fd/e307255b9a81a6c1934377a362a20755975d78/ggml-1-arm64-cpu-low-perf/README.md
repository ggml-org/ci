...
- status:  SUCCESS ✅
- runtime: 5:59.04
- date:    Mon Jan 29 11:37:54 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.04 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.40 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  148.79 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 186.36 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.75 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.19 sec
...
main:     load time =   193.65 ms
main:   sample time =    17.22 ms
main:  predict time =   892.15 ms / 13.94 ms per token
...
main:     load time =   188.43 ms
main:   sample time =    17.29 ms
main:  predict time =   957.00 ms / 13.67 ms per token
main:    total time =  1165.93 ms
...
main:     n_decoded =      504
main:     load time =   159.37 ms
main:   sample time =   130.24 ms
main:  predict time =  6215.25 ms
main:    total time =  6588.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaafda990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaae5b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeff80b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaafda030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaafdf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeff81960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaae5b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeff80b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeff822c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeff81960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaafda030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeff82c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeff822c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeff83580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaafda990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeff82c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeff83740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeff83580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaafdf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeff83900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeff83740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.62 ms
whisper_print_timings:   sample time =    65.65 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4728.95 ms /     1 runs ( 4728.95 ms per run)
whisper_print_timings:   decode time =    15.73 ms /     2 runs (    7.87 ms per run)
whisper_print_timings:   batchd time =   717.29 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5655.54 ms
