...
- status:  SUCCESS ✅
- runtime: 7:11.96
- date:    Mon Jan 29 11:40:30 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.13 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  124.94 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 139.09 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.22 sec
      Start  2: test-opt
...
main:  predict time =   866.78 ms / 13.54 ms per token
main:    total time =  1086.86 ms
...
main:     load time =   182.12 ms
main:   sample time =    17.63 ms
main:  predict time =   938.92 ms / 13.41 ms per token
main:    total time =  1141.81 ms
...
main:  predict time =  6065.29 ms
main:    total time =  6429.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a80a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9a68b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1a554b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a80a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a80f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1a555960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9a68b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1a554b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1a5562c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1a555960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a80a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1a556c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1a5562c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1a557580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a80a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1a556c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1a557740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1a557580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a80f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab1a557900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1a557740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =    65.56 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4633.59 ms /     1 runs ( 4633.59 ms per run)
whisper_print_timings:   decode time =    15.72 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   714.70 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5554.19 ms
...
main:      load time =  5700.72 ms
main:    sample time =   519.40 ms / 8.12 ms per token
main:      eval time = 43912.38 ms / 627.32 ms per token
main:     total time = 52506.38 ms
...
main:      load time =  1576.67 ms
main:    sample time =   516.70 ms / 8.07 ms per token
main:      eval time = 17306.22 ms / 247.23 ms per token
main:     total time = 20356.90 ms
