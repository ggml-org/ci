...
- status:  SUCCESS ✅
- runtime: 4:50.02
- date:    Mon Jan 29 11:35:43 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/fde307255b9a81a6c1934377a362a20755975d78
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.49 sec
...
20/20 Test #20: test-backend-ops .................   Passed  113.32 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 152.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.28 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   23.94 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.85 sec
...
main:     load time =   136.01 ms
main:   sample time =    24.00 ms
main:  predict time =   674.62 ms / 10.54 ms per token
main:    total time =   847.99 ms
...
main:  predict time =   694.52 ms / 9.92 ms per token
main:    total time =   853.00 ms
...
main:     n_decoded =      504
main:     load time =   108.06 ms
main:   sample time =   178.08 ms
main:  predict time =  2541.44 ms
main:    total time =  2872.86 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbf9dc45990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbf9dac61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e49517db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbf9dc45030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbf9dc4a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e49517e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbf9dac61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e49517db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e49517f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55e49517e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbf9dc45030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e49517fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55e49517f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e495180580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbf9dc45990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55e49517fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e495180740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55e495180580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbf9dc4a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55e495180900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55e495180740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.17 ms
whisper_print_timings:   sample time =    72.00 ms /   131 runs (    0.55 ms per run)
...
whisper_print_timings:   batchd time =   327.03 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2511.59 ms
...
main:     load time =    67.63 ms
main:    total time = 18929.55 ms
embd_img
