...
- status:  SUCCESS ✅
- runtime: 2:17.30
- date:    Wed Apr  3 20:02:27 UTC 2024
...
main:  predict time =   491.77 ms / 7.68 ms per token
main:    total time =   633.13 ms
...
main:  predict time =   515.65 ms / 7.37 ms per token
main:    total time =   649.24 ms
...
main:     load time =   133.52 ms
main:   sample time =    23.78 ms
main:  predict time =   529.11 ms / 7.56 ms per token
main:    total time =   689.59 ms
...
main:     n_decoded =      504
main:     load time =   105.93 ms
main:   sample time =   175.20 ms
main:  predict time =  1820.00 ms
main:    total time =  2132.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdb0c8c3990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdb0c7441a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55767667ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdb0c8c3030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdb0c8c8940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55767667fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdb0c7441a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55767667ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557676680410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55767667fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdb0c8c3030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557676680d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557676680410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576766816d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdb0c8c3990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557676680d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557676681890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576766816d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdb0c8c8940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557676681a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557676681890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.05 ms
whisper_print_timings:   sample time =    55.37 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1187.74 ms /     1 runs ( 1187.74 ms per run)
whisper_print_timings:   decode time =    12.18 ms /     2 runs (    6.09 ms per run)
whisper_print_timings:   batchd time =   213.11 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1564.27 ms
...
main:     load time =    65.48 ms
main:    total time = 10757.98 ms
embd_img
