...
- status:  SUCCESS ✅
- runtime: 3:07.79
- date:    Wed Apr  3 20:03:06 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.09 sec
 ...
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.69 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.93 sec
      Start  2: test-opt
...
main:     load time =   152.72 ms
main:   sample time =    17.74 ms
main:  predict time =   895.92 ms / 14.00 ms per token
main:    total time =  1088.32 ms
...
main:     load time =   153.44 ms
main:   sample time =    17.41 ms
main:  predict time =   971.40 ms / 13.88 ms per token
main:    total time =  1145.14 ms
...
main:     load time =   182.15 ms
main:   sample time =    17.49 ms
main:  predict time =  1018.35 ms / 14.55 ms per token
main:    total time =  1221.33 ms
...
main:     n_decoded =      504
main:     load time =   152.09 ms
main:   sample time =   128.77 ms
main:  predict time =  6433.59 ms
main:    total time =  6796.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f2da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f15b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1277ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f2da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f2df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1277fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f15b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1277ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab12780410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1277fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f2da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab12780d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab12780410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab127816d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f2da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab12780d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab12781890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab127816d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f2df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab12781a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab12781890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    65.66 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4679.51 ms /     1 runs ( 4679.51 ms per run)
whisper_print_timings:   decode time =    15.57 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   711.41 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5597.11 ms
...
main:     load time =    92.75 ms
main:    total time = 39834.83 ms
embd_img
