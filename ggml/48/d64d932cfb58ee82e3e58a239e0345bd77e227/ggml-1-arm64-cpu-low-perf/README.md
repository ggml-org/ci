...
- status:  SUCCESS ✅
- runtime: 4:08.63
- date:    Wed Apr  3 08:04:07 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.59 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.55 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.91 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.70 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.53 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   20.49 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.90 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.52 sec
      Start  5: test-mul-mat2
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.45 sec
      Start  9: test3
...
main:     load time =   159.62 ms
main:   sample time =    17.28 ms
main:  predict time =   902.78 ms / 14.11 ms per token
main:    total time =  1101.71 ms
...
main:     load time =   160.31 ms
main:   sample time =    17.87 ms
main:  predict time =  1018.29 ms / 14.55 ms per token
main:    total time =  1199.28 ms
...
main:     load time =   190.34 ms
main:   sample time =    17.58 ms
main:  predict time =  1056.95 ms / 15.10 ms per token
main:    total time =  1268.52 ms
...
main:     n_decoded =      504
main:     load time =   160.52 ms
main:   sample time =   127.99 ms
main:  predict time =  6455.16 ms
main:    total time =  6826.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb398a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb380b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6eb7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb398a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb398f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6eb8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb380b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf6eb7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf6eb9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf6eb8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb398a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6eb9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf6eb9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6eba6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb398a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf6eb9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6eba890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf6eba6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb398f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf6ebaa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf6eba890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.09 ms
whisper_print_timings:   sample time =    65.94 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4687.53 ms /     1 runs ( 4687.53 ms per run)
whisper_print_timings:   decode time =    15.62 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   721.31 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5620.29 ms
...
main:     load time =    97.33 ms
main:    total time = 40059.64 ms
embd_img
