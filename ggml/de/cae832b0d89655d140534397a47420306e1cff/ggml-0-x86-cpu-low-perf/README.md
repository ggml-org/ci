...
- status:  SUCCESS ✅
- runtime: 1:49.58
- date:    Fri Oct  4 06:43:41 UTC 2024
...
main:  predict time =   665.09 ms / 10.39 ms per token
main:    total time =   817.13 ms
...
main:     load time =   123.77 ms
main:   sample time =    31.68 ms
main:  predict time =   686.45 ms / 9.81 ms per token
main:    total time =   846.19 ms
...
main:  predict time =  2763.36 ms
main:    total time =  3122.82 ms
