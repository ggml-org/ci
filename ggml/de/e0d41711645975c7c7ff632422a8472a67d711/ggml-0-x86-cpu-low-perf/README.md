...
- status:  SUCCESS ✅
- runtime: 3:24.18
- date:    Sat Jun 15 19:09:27 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/21 Test  #3: test-quantize-perf ...............   Passed    8.88 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.26 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.65 sec
      Start 10: test-pool
...
Total Test time (real) =  74.24 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test2 ............................   Passed   24.26 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.67 sec
      Start 10: test-pool
10/21 Test #10: test-pool ........................   Passed    0.00 sec
      Start 11: test-arange
11/21 Test #11: test-arange ......................   Passed    0.00 sec
...
main:     load time =   102.46 ms
main:   sample time =    23.91 ms
main:  predict time =   655.92 ms / 10.25 ms per token
main:    total time =   794.94 ms
...
main:  predict time =   687.06 ms / 9.82 ms per token
main:    total time =   815.81 ms
...
main:  predict time =   687.62 ms / 9.82 ms per token
main:    total time =   836.48 ms
...
main:     n_decoded =      504
main:     load time =   102.02 ms
main:   sample time =   178.17 ms
main:  predict time =  2580.87 ms
main:    total time =  2906.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7b23564fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7b235637b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5678d2b7fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7b23564fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7b23564ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5678d2b80ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7b235637b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5678d2b7fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5678d2b81410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5678d2b80ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7b23564fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5678d2b81d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5678d2b81410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5678d2b826d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7b23564fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5678d2b81d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5678d2b82890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5678d2b826d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7b23564ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5678d2b82a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5678d2b82890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.12 ms
whisper_print_timings:   sample time =    72.35 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2002.90 ms /     1 runs ( 2002.90 ms per run)
whisper_print_timings:   decode time =    13.84 ms /     2 runs (    6.92 ms per run)
whisper_print_timings:   batchd time =   328.96 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2526.08 ms
