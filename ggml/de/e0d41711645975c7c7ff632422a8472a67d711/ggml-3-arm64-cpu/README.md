...
- status:  SUCCESS ✅
- runtime: 3:04.53
- date:    Sat Jun 15 19:09:08 UTC 2024
...
main:  predict time =   864.52 ms / 13.51 ms per token
main:    total time =  1049.71 ms
...
main:     load time =   146.49 ms
main:   sample time =    16.73 ms
main:  predict time =   928.28 ms / 13.26 ms per token
main:    total time =  1093.99 ms
...
main:     n_decoded =      504
main:     load time =   146.51 ms
main:   sample time =   128.54 ms
main:  predict time =  6044.50 ms
main:    total time =  6401.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf05f0d5ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf05f0d43b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb7d643331ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf05f0d5ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf05f0d5bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb7d643332ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf05f0d43b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb7d643331ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb7d643333410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb7d643332ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf05f0d5ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb7d643333d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb7d643333410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb7d6433346d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf05f0d5ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb7d643333d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb7d643334890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb7d6433346d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf05f0d5bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb7d643334a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb7d643334890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    66.17 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4663.71 ms /     1 runs ( 4663.71 ms per run)
whisper_print_timings:   decode time =    14.64 ms /     2 runs (    7.32 ms per run)
whisper_print_timings:   batchd time =   726.10 ms /   125 runs (    5.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5604.83 ms
