...
- status:  SUCCESS ✅
- runtime: 4:03.84
- date:    Sat Jun 15 19:10:00 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.81 sec
 ...
 7/21 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.22 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   16.92 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed    4.80 sec
      Start  4: test-mul-mat0
 4/21 Test  #4: test-mul-mat0 ....................   Passed    0.53 sec
      Start  5: test-mul-mat2
 ...
 7/21 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   21.38 sec
      Start  9: test3
...
main:     load time =   150.41 ms
main:   sample time =    18.75 ms
main:  predict time =   913.17 ms / 14.27 ms per token
main:    total time =  1103.92 ms
...
main:  predict time =   992.32 ms / 14.18 ms per token
main:    total time =  1164.24 ms
...
main:     load time =   180.83 ms
main:   sample time =    20.45 ms
main:  predict time =   968.51 ms / 13.84 ms per token
main:    total time =  1173.30 ms
...
main:     n_decoded =      504
main:     load time =   155.37 ms
main:   sample time =   132.46 ms
main:  predict time =  6117.04 ms
main:    total time =  6488.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfaf50438a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfaf50420b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xac8faad27ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfaf50438a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfaf50438f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xac8faad28ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfaf50420b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xac8faad27ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xac8faad29410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xac8faad28ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfaf50438a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xac8faad29d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xac8faad29410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xac8faad2a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfaf50438a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xac8faad29d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xac8faad2a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xac8faad2a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfaf50438f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xac8faad2aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xac8faad2a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.20 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.48 ms
whisper_print_timings:   sample time =    72.77 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  4695.43 ms /     1 runs ( 4695.43 ms per run)
whisper_print_timings:   decode time =    15.48 ms /     2 runs (    7.74 ms per run)
whisper_print_timings:   batchd time =   738.65 ms /   125 runs (    5.91 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5664.61 ms
...
main:     load time =    97.20 ms
main:    total time = 39998.26 ms
embd_img
