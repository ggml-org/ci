...
- status:  SUCCESS ✅
- runtime: 2:09.02
- date:    Sat Jun 15 19:08:02 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   16.00 sec
      Start  4: test-quantize-perf
 4/22 Test  #4: test-quantize-perf ...............   Passed    4.45 sec
...
main:  predict time =   477.81 ms / 7.47 ms per token
...
main:  predict time =   496.42 ms / 7.09 ms per token
...
main:     load time =   124.35 ms
main:   sample time =    23.91 ms
main:  predict time =   509.08 ms / 7.27 ms per token
main:    total time =   660.40 ms
...
main:   sample time =   178.41 ms
main:  predict time =  1544.76 ms
main:    total time =  1860.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x79ee30efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x79ee30d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60e2596f9ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x79ee30efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x79ee30eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60e2596faab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x79ee30d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x60e2596f9ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60e2596fb410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x60e2596faab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x79ee30efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60e2596fbd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x60e2596fb410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60e2596fc6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x79ee30efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x60e2596fbd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60e2596fc890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x60e2596fc6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x79ee30eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x60e2596fca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x60e2596fc890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.85 ms
whisper_print_timings:   sample time =    54.45 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1162.35 ms /     1 runs ( 1162.35 ms per run)
whisper_print_timings:   decode time =    11.17 ms /     2 runs (    5.58 ms per run)
whisper_print_timings:   batchd time =   219.75 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1551.46 ms
...
main:     load time =    66.28 ms
main:    total time = 10652.03 ms
embd_img
