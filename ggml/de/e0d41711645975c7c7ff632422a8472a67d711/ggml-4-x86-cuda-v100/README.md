...
- status:  SUCCESS ✅
- runtime: 14:41.40
- date:    Sat Jun 15 19:20:31 UTC 2024
...
21/21 Test #21: test-backend-ops .................   Passed  191.07 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 272.09 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/22 Test  #6: test-mul-mat2 ....................   Passed    2.80 sec
      Start  7: test0
 7/22 Test  #7: test0 ............................   Passed    0.04 sec
      Start  8: test1
 8/22 Test  #8: test1 ............................   Passed    0.04 sec
      Start  9: test2
 9/22 Test  #9: test2 ............................   Passed   20.50 sec
      Start 10: test3
10/22 Test #10: test3 ............................   Passed    1.56 sec
      Start 11: test-pool
...
main:  predict time =   596.73 ms / 9.32 ms per token
main:    total time =   802.49 ms
...
main:  predict time =   603.13 ms / 8.62 ms per token
main:    total time =   793.43 ms
...
main:     load time =   181.84 ms
main:   sample time =    34.89 ms
main:  predict time =   644.59 ms / 9.21 ms per token
...
main:  predict time =  2298.75 ms
main:    total time =  2730.20 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f35c5efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f35c5d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55963bf0e840                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f35c5efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f35c5eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55963bf0f610                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f35c5d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55963bf0e840                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55963bf0ff70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55963bf0f610                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f35c5efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55963bf108d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55963bf0ff70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55963bf11230                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f35c5efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55963bf108d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55963bf113f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55963bf11230                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f35c5eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55963bf115b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55963bf113f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   512.21 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.85 ms
whisper_print_timings:   sample time =    67.68 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    47.07 ms /     1 runs (   47.07 ms per run)
whisper_print_timings:   decode time =    12.42 ms /     2 runs (    6.21 ms per run)
whisper_print_timings:   batchd time =    86.20 ms /   125 runs (    0.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   753.13 ms
...
main:     load time =   114.12 ms
main:    total time = 16462.19 ms
embd_img
