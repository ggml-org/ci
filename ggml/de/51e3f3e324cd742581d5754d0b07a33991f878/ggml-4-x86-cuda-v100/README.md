...
- status:  SUCCESS ✅
- runtime: 8:56.25
- date:    Thu Jan 11 20:02:58 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.82 sec
 ...
 8/20 Test  #8: test2 ............................   Passed    7.76 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.09 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   71.52 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 104.14 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.75 sec
      Start  2: test-opt
 ...
 5/21 Test  #5: test-mul-mat0 ....................   Passed    1.06 sec
 ...
 8/21 Test  #8: test1 ............................   Passed    0.56 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.84 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   29.45 sec
...
main:     load time =   617.10 ms
main:   sample time =    34.22 ms
main:  predict time =   575.93 ms / 9.00 ms per token
main:    total time =  1247.19 ms
...
main:     load time =   589.42 ms
main:   sample time =    34.89 ms
main:  predict time =   620.40 ms / 8.86 ms per token
main:    total time =  1248.91 ms
...
main:     n_decoded =      504
main:     load time =   543.74 ms
main:   sample time =   234.55 ms
main:  predict time =  2289.74 ms
main:    total time =  3112.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8516bb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8516a371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cb1a114880                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8516bb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8516bbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cb1a115650                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8516a371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cb1a114880                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cb1a115fb0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cb1a115650                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8516bb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cb1a116910                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cb1a115fb0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cb1a117270                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8516bb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cb1a116910                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cb1a117430                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cb1a117270                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8516bbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55cb1a1175f0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cb1a117430       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   522.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    24.16 ms
whisper_print_timings:   sample time =    66.17 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    41.63 ms /     1 runs (   41.63 ms per run)
whisper_print_timings:   decode time =    15.58 ms /     2 runs (    7.79 ms per run)
whisper_print_timings:   batchd time =    81.94 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   760.09 ms
...
main:     load time =   502.37 ms
main:    total time =  7902.48 ms
embd_img
...
main:      load time = 18659.97 ms
main:    sample time =   541.01 ms / 8.45 ms per token
main:      eval time = 26153.36 ms / 373.62 ms per token
main:     total time = 46217.59 ms
...
main:      load time =  9484.58 ms
main:    sample time =   536.77 ms / 8.39 ms per token
main:      eval time = 12446.47 ms / 177.81 ms per token
main:     total time = 23138.53 ms
