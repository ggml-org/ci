...
- status:  SUCCESS ✅
- runtime: 6:01.65
- date:    Thu Jan 11 08:02:26 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/de51e3f3e324cd742581d5754d0b07a33991f878
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.39 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.04 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.29 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.74 sec
      Start  5: test-mul-mat2
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.64 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed   40.18 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  54.43 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.11 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.09 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    0.01 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.05 sec
      Start  5: test-mul-mat0
 5/21 Test  #5: test-mul-mat0 ....................   Passed    0.55 sec
...
21/21 Test #21: test-backend-ops .................   Passed   11.39 sec
...
main:     load time =   197.87 ms
main:   sample time =    16.98 ms
main:  predict time =   820.55 ms / 12.82 ms per token
main:    total time =  1057.50 ms
...
main:     load time =   186.54 ms
main:   sample time =    16.76 ms
main:  predict time =   891.60 ms / 12.74 ms per token
main:    total time =  1097.84 ms
...
main:     n_decoded =      504
main:     load time =   150.73 ms
main:   sample time =   126.64 ms
main:  predict time =  5979.39 ms
main:    total time =  6338.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa57ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa563b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0548b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa57ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa57bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0549960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa563b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0548b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae054a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0549960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa57ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae054ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae054a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae054b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa57ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae054ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae054b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae054b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa57bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae054b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae054b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   200.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.93 ms
whisper_print_timings:   sample time =    65.76 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4623.19 ms /     1 runs ( 4623.19 ms per run)
whisper_print_timings:   decode time =    15.30 ms /     2 runs (    7.65 ms per run)
whisper_print_timings:   batchd time =   706.72 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5629.63 ms
...
main:     load time =    81.66 ms
main:    total time = 39748.50 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.247000 sec.)
...
main:      load time = 13004.54 ms
main:    sample time =   522.01 ms / 8.16 ms per token
main:      eval time = 43714.61 ms / 624.49 ms per token
main:     total time = 59613.71 ms
...
main:      load time =  4345.83 ms
main:    sample time =   515.57 ms / 8.06 ms per token
main:      eval time = 17318.58 ms / 247.41 ms per token
main:     total time = 23134.94 ms
