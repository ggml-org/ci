...
- status:  SUCCESS ✅
- runtime: 3:38.41
- date:    Thu Jan 11 07:55:41 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.69 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.66 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.55 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   49.60 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.60 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.44 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   11.16 sec
...
main:     load time =   186.98 ms
main:   sample time =    16.95 ms
main:  predict time =   845.06 ms / 13.20 ms per token
main:    total time =  1071.07 ms
...
main:     load time =   186.50 ms
main:   sample time =    16.86 ms
main:  predict time =   913.56 ms / 13.05 ms per token
main:    total time =  1119.75 ms
...
main:     n_decoded =      504
main:     load time =   163.60 ms
main:   sample time =   128.35 ms
main:  predict time =  6213.60 ms
main:    total time =  6587.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb320a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb308b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab06a0eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb320a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb320f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab06a0f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb308b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab06a0eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab06a102c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab06a0f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb320a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab06a10c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab06a102c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab06a11580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb320a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab06a10c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab06a11740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab06a11580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb320f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab06a11900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab06a11740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.86 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.74 ms
whisper_print_timings:   sample time =    65.56 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4721.52 ms /     1 runs ( 4721.52 ms per run)
whisper_print_timings:   decode time =    15.13 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   709.20 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5642.34 ms
...
main:     load time =    94.40 ms
main:    total time = 40301.91 ms
embd_img
