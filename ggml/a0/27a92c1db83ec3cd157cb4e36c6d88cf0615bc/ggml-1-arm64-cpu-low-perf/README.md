...
- status:  SUCCESS ✅
- runtime: 3:49.28
- date:    Wed Dec 13 12:05:29 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/a027a92c1db83ec3cd157cb4e36c6d88cf0615bc
- author:  ariez-xyz
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.64 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.88 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.65 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed   55.24 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  80.00 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.63 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   12.61 sec
...
main:     load time =   191.96 ms
main:   sample time =    17.63 ms
main:  predict time =   842.35 ms / 13.16 ms per token
main:    total time =  1073.76 ms
...
main:     load time =   191.04 ms
main:   sample time =    17.74 ms
main:  predict time =  1040.62 ms / 14.87 ms per token
main:    total time =  1252.41 ms
...
main:     n_decoded =      504
main:     load time =   162.14 ms
main:   sample time =   128.38 ms
main:  predict time =  6138.73 ms
main:    total time =  6511.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9eb5a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e9db190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0db28b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9eb5a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9eb5f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0db29940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9e9db190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0db28b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0db2a290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0db29940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9eb5a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0db2abe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0db2a290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0db2b530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9eb5a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0db2abe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0db2b6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0db2b530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9eb5f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0db2b890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0db2b6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.41 ms
whisper_print_timings:   sample time =    67.00 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4768.96 ms /     1 runs ( 4768.96 ms per run)
whisper_print_timings:   decode time =    15.51 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   725.65 ms /   125 runs (    5.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5705.32 ms
...
main:     load time =    92.61 ms
main:    total time = 40412.59 ms
embd_img
