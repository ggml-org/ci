...
- status:  SUCCESS ✅
- runtime: 4:03.48
- date:    Wed Dec 13 12:05:37 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.45 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.71 sec
...
main:     load time =   307.14 ms
main:   sample time =    23.44 ms
main:  predict time =   436.71 ms / 6.82 ms per token
main:    total time =   780.12 ms
...
main:     load time =   130.33 ms
main:   sample time =    23.45 ms
main:  predict time =   451.65 ms / 6.45 ms per token
...
main:     n_decoded =      504
main:     load time =   106.70 ms
main:   sample time =   177.99 ms
main:  predict time =  1461.42 ms
main:    total time =  1774.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f31b3c0f960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f31b3a90190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b95b8c0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f31b3c0f010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f31b3c14900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b95b8c1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f31b3a90190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b95b8c0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b95b8c2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b95b8c1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f31b3c0f010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b95b8c2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b95b8c2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b95b8c3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f31b3c0f960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b95b8c2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b95b8c36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b95b8c3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f31b3c14900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b95b8c3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b95b8c36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   119.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.12 ms
whisper_print_timings:   sample time =    54.97 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1149.39 ms /     1 runs ( 1149.39 ms per run)
whisper_print_timings:   decode time =     9.43 ms /     2 runs (    4.71 ms per run)
whisper_print_timings:   batchd time =   206.65 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1558.02 ms
...
main:     load time =    62.15 ms
main:    total time = 10553.03 ms
embd_img
...
main:      load time = 10763.49 ms
main:    sample time =   467.28 ms / 7.30 ms per token
main:      eval time = 20293.30 ms / 289.90 ms per token
main:     total time = 32193.79 ms
...
main:      load time =  4366.92 ms
main:    sample time =   466.48 ms / 7.29 ms per token
main:      eval time =  8523.47 ms / 121.76 ms per token
main:     total time = 13732.41 ms
