...
- status:  SUCCESS ✅
- runtime: 5:48.69
- date:    Wed Dec 13 12:07:28 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   46.63 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    0.08 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   11.72 sec
...
main:     load time =   243.17 ms
main:   sample time =    17.19 ms
main:  predict time =   810.96 ms / 12.67 ms per token
main:    total time =  1093.19 ms
...
main:  predict time =   885.35 ms / 12.65 ms per token
main:    total time =  1082.70 ms
...
main:     n_decoded =      504
main:     load time =   140.14 ms
main:   sample time =   126.97 ms
main:  predict time =  5846.80 ms
main:    total time =  6194.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80e7a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80cfb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad8945b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80e7a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80e7f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad8946940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80cfb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad8945b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad8947290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad8946940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80e7a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad8947be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad8947290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad8948530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80e7a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad8947be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad89486e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad8948530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80e7f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad8948890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad89486e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   181.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.79 ms
whisper_print_timings:   sample time =    65.08 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4646.05 ms /     1 runs ( 4646.05 ms per run)
whisper_print_timings:   decode time =    14.95 ms /     2 runs (    7.48 ms per run)
whisper_print_timings:   batchd time =   704.43 ms /   125 runs (    5.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5630.63 ms
...
main:     load time =    76.40 ms
main:    total time = 39428.41 ms
embd_img
...
main:      load time = 12256.65 ms
main:    sample time =   533.32 ms / 8.33 ms per token
main:      eval time = 43546.20 ms / 622.09 ms per token
main:     total time = 58711.54 ms
...
main:      load time =  4347.84 ms
main:    sample time =   525.35 ms / 8.21 ms per token
main:      eval time = 17737.79 ms / 253.40 ms per token
main:     total time = 23581.14 ms
