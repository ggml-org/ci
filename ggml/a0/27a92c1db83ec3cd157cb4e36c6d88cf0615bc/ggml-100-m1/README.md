...
- status:  SUCCESS ✅
- runtime: 325.86
- date:    Wed Dec 13 14:05:05 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    1.20 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.26 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.41 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.41 sec
      Start  5: test-blas0
 5/20 Test  #5: test-blas0 .......................   Passed    0.28 sec
...
20/20 Test #20: test-backend-ops .................   Passed  128.00 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 142.57 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    1.23 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    0.92 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    0.20 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.24 sec
...
Total Test time (real) =  19.64 sec
...
main:  predict time =   307.05 ms / 4.39 ms per token
main:    total time =   411.24 ms
...
main:     n_decoded =      504
main:     load time =   117.43 ms
main:   sample time =    66.02 ms
main:  predict time =   761.94 ms
main:    total time =   956.30 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1502a8210                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x1502a8fd0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x150008180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1502a8210                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x1502a9920                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x1502a8fd0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x150187000                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x1502aa270                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x1502a9920                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x1502aabc0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x150187950                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x1502aa270                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x1502aad70                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x1502aabc0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x15018c8f0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x1502aaf20                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x1502aad70                           node_4
...
whisper_print_timings:   sample time =   153.98 ms /   139 runs (    1.11 ms per run)
whisper_print_timings:   encode time =   187.01 ms /     1 runs (  187.01 ms per run)
whisper_print_timings:   decode time =    13.61 ms /     1 runs (   13.61 ms per run)
whisper_print_timings:   batchd time =   221.51 ms /   134 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   732.13 ms
...
main:     load time =    70.08 ms
main:    total time =  5535.39 ms
embd_img
