...
- status:  SUCCESS ✅
- runtime: 8:25.04
- date:    Wed Dec 13 12:10:14 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/19 Test  #2: test-quantize-fns ................   Passed    0.59 sec
 ...
 6/19 Test  #6: test0 ............................   Passed    0.54 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.56 sec
      Start  8: test2
...
19/19 Test #19: test-backend-ops .................   Passed   91.05 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.91 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.57 sec
 ...
 7/20 Test  #7: test0 ............................   Passed    0.53 sec
      Start  8: test1
 8/20 Test  #8: test1 ............................   Passed    0.56 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    8.05 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   22.49 sec
...
main:     load time =  1520.20 ms
main:   sample time =    34.46 ms
main:  predict time =   547.20 ms / 8.55 ms per token
main:    total time =  2123.96 ms
...
main:     load time =   576.58 ms
main:   sample time =    34.62 ms
main:  predict time =   590.94 ms / 8.44 ms per token
main:    total time =  1206.39 ms
...
main:     n_decoded =      504
main:     load time =   556.56 ms
main:   sample time =   236.72 ms
main:  predict time =  2234.72 ms
main:    total time =  3079.49 ms
...
main: loaded model in   398.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f72119b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7211837190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56016aa537a0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f72119b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f72119bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56016aa54560                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7211837190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56016aa537a0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56016aa54eb0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56016aa54560                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f72119b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56016aa55800                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56016aa54eb0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56016aa56150                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f72119b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56016aa55800                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56016aa56300                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56016aa56150                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f72119bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56016aa564b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56016aa56300       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1020.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.93 ms
whisper_print_timings:   sample time =    67.02 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    36.00 ms /     1 runs (   36.00 ms per run)
whisper_print_timings:   decode time =    14.00 ms /     2 runs (    7.00 ms per run)
whisper_print_timings:   batchd time =    81.44 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1246.12 ms
...
main:     load time =   536.96 ms
main:    total time =  8012.40 ms
embd_img
...
main:      load time =  7703.46 ms
main:    sample time =   513.04 ms / 8.02 ms per token
main:      eval time = 25022.52 ms / 357.46 ms per token
main:     total time = 34158.19 ms
...
main:      load time =  2032.58 ms
main:    sample time =   517.62 ms / 8.09 ms per token
main:      eval time = 12470.46 ms / 178.15 ms per token
