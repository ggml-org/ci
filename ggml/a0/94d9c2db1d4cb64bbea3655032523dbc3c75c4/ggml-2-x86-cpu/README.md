...
- status:  SUCCESS ✅
- runtime: 2:57.83
- date:    Wed Oct  4 12:50:15 UTC 2023
...
main:     load time =   207.35 ms
main:   sample time =    23.98 ms
main:  predict time =   473.85 ms / 7.40 ms per token
main:    total time =   720.54 ms
...
main:     load time =   138.78 ms
main:   sample time =    23.99 ms
main:  predict time =   488.82 ms / 6.98 ms per token
main:    total time =   656.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f77a75008d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f77a7381160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561491af6ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f77a74fffb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f77a7505840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561491af7850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f77a7381160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561491af6ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561491af8170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561491af7850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f77a74fffb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561491af8a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561491af8170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561491af93b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f77a75008d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561491af8a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561491af9530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x561491af93b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f77a7505840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x561491af96b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561491af9530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   154.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.83 ms
whisper_print_timings:   sample time =    15.87 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1158.92 ms /     1 runs ( 1158.92 ms per run)
whisper_print_timings:   decode time =   104.51 ms /    27 runs (    3.87 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1493.23 ms
```
### mpt
...
main:      load time = 11341.29 ms
main:    sample time =   462.72 ms / 7.23 ms per token
main:      eval time = 22321.28 ms / 318.88 ms per token
main:     total time = 34816.62 ms
...
main:      load time =  4382.42 ms
main:    sample time =   460.94 ms / 7.20 ms per token
main:      eval time =  8713.44 ms / 124.48 ms per token
main:     total time = 13948.64 ms
