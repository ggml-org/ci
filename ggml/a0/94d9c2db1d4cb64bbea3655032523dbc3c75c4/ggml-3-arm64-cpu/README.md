...
- status:  SUCCESS ✅
- runtime: 3:56.02
- date:    Wed Oct  4 12:54:35 PM UTC 2023
...
main:     load time =   175.64 ms
main:   sample time =    17.03 ms
main:  predict time =   807.88 ms / 12.62 ms per token
main:    total time =  1025.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a01a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99e9b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1b200ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a019fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a01f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1b201850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff99e9b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab1b200ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1b202170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab1b201850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9a019fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1b202a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab1b202170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1b2033b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9a01a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab1b202a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1b203530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1b2033b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9a01f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab1b2036b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1b203530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   208.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    16.85 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  4608.32 ms /     1 runs ( 4608.32 ms per run)
whisper_print_timings:   decode time =   174.22 ms /    27 runs (    6.45 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5074.26 ms
```
### mpt
...
main:      load time = 12110.36 ms
main:    sample time =   518.19 ms / 8.10 ms per token
main:      eval time = 43662.17 ms / 623.75 ms per token
main:     total time = 58662.86 ms
...
main:      load time =  4317.13 ms
main:    sample time =   513.34 ms / 8.02 ms per token
main:      eval time = 17770.26 ms / 253.86 ms per token
main:     total time = 23557.38 ms
