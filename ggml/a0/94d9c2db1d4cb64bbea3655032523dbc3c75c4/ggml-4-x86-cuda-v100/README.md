...
- status:  SUCCESS ✅
- runtime: 5:04.67
- date:    Wed Oct  4 12:56:34 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.19 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.65 sec
      Start  2: test-opt
...
main:     load time =  1150.17 ms
main:   sample time =    35.71 ms
main:  predict time =   607.95 ms / 9.50 ms per token
main:    total time =  1816.31 ms
...
main:     load time =   209.93 ms
main:   sample time =    34.90 ms
main:  predict time =   596.13 ms / 8.52 ms per token
main:    total time =   849.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f14902108d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1490091160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5645d8a10ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f149020ffb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1490215840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5645d8a11850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1490091160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5645d8a10ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5645d8a12170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5645d8a11850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f149020ffb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5645d8a12a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5645d8a12170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5645d8a133b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f14902108d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5645d8a12a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5645d8a13530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5645d8a133b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1490215840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5645d8a136b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5645d8a13530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   181.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.82 ms
whisper_print_timings:   sample time =    20.18 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1878.11 ms /     1 runs ( 1878.11 ms per run)
whisper_print_timings:   decode time =   142.88 ms /    27 runs (    5.29 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2305.70 ms
```
### mpt
...
main:      load time =  7111.54 ms
main:    sample time =   584.72 ms / 9.14 ms per token
main:      eval time = 25387.96 ms / 362.69 ms per token
main:     total time = 34014.78 ms
...
main:      load time =  1763.40 ms
main:    sample time =   578.01 ms / 9.03 ms per token
main:      eval time = 12349.70 ms / 176.42 ms per token
main:     total time = 15468.66 ms
