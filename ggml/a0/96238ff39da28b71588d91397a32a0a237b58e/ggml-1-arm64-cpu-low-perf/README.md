...
- status:  SUCCESS ✅
- runtime: 4:05.59
- date:    Sat Apr  6 02:59:33 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.68 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.44 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.75 sec
      Start  9: test3
...
main:  predict time =   937.43 ms / 14.65 ms per token
main:    total time =  1137.81 ms
...
main:     load time =   159.35 ms
main:   sample time =    17.30 ms
main:  predict time =   988.95 ms / 14.13 ms per token
main:    total time =  1168.35 ms
...
main:  predict time =  1033.17 ms / 14.76 ms per token
main:    total time =  1246.21 ms
...
main:  predict time =  6442.62 ms
main:    total time =  6813.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8708a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86f0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab250dcce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8708a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8708f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab250ddab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86f0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab250dcce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab250de410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab250ddab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8708a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab250ded70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab250de410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab250df6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8708a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab250ded70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab250df890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab250df6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8708f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab250dfa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab250df890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.18 ms
whisper_print_timings:   sample time =    65.34 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4710.93 ms /     1 runs ( 4710.93 ms per run)
whisper_print_timings:   decode time =    14.75 ms /     2 runs (    7.38 ms per run)
whisper_print_timings:   batchd time =   713.76 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5635.56 ms
...
main:     load time =    99.61 ms
main:    total time = 39915.93 ms
embd_img
