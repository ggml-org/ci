...
- status:  SUCCESS ✅
- runtime: 2:10.36
- date:    Sat Apr  6 14:57:41 UTC 2024
...
main:  predict time =   490.67 ms / 7.67 ms per token
main:    total time =   630.26 ms
...
main:  predict time =   512.08 ms / 7.32 ms per token
main:    total time =   641.89 ms
...
main:     load time =   122.55 ms
main:   sample time =    23.76 ms
main:  predict time =   520.48 ms / 7.44 ms per token
main:    total time =   669.73 ms
...
main:   sample time =   175.01 ms
main:  predict time =  1810.79 ms
main:    total time =  2120.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd0dc118990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd0dbf991a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a222d34ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd0dc118030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd0dc11d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a222d35ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd0dbf991a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a222d34ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a222d36410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a222d35ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd0dc118030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a222d36d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a222d36410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a222d376d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd0dc118990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a222d36d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a222d37890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a222d376d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd0dc11d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a222d37a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a222d37890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.99 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.27 ms
whisper_print_timings:   sample time =    55.31 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1191.30 ms /     1 runs ( 1191.30 ms per run)
whisper_print_timings:   decode time =    12.14 ms /     2 runs (    6.07 ms per run)
whisper_print_timings:   batchd time =   211.30 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1566.24 ms
...
main:     load time =    64.82 ms
main:    total time = 10719.53 ms
embd_img
