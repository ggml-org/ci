...
- status:  SUCCESS ✅
- runtime: 3:11.74
- date:    Sat Apr  6 14:58:39 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   32.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    3.00 sec
      Start  2: test-opt
...
main:     load time =   152.99 ms
main:   sample time =    17.27 ms
main:  predict time =   894.05 ms / 13.97 ms per token
...
main:     load time =   148.23 ms
main:   sample time =    16.94 ms
main:  predict time =   971.92 ms / 13.88 ms per token
main:    total time =  1139.82 ms
...
main:  predict time =  1012.77 ms / 14.47 ms per token
main:    total time =  1214.83 ms
...
main:  predict time =  6435.78 ms
main:    total time =  6793.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb84aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb832b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae828cce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb84aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb84af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae828dab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb832b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae828cce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae828e410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae828dab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb84aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae828ed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae828e410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae828f6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb84aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae828ed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae828f890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae828f6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb84af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae828fa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae828f890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.97 ms
whisper_print_timings:   sample time =    65.55 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4683.90 ms /     1 runs ( 4683.90 ms per run)
whisper_print_timings:   decode time =    14.62 ms /     2 runs (    7.31 ms per run)
whisper_print_timings:   batchd time =   713.02 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5602.85 ms
