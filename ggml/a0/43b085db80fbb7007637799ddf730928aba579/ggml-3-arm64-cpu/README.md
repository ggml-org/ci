...
- status:  SUCCESS ✅
- runtime: 5:26.06
- date:    Mon Jan  8 09:47:44 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.40 sec
      Start  6: test0
...
main:     load time =   172.73 ms
main:   sample time =    16.81 ms
main:  predict time =   821.11 ms / 12.83 ms per token
main:    total time =  1032.45 ms
...
main:     load time =   177.34 ms
main:   sample time =    16.84 ms
main:  predict time =   894.67 ms / 12.78 ms per token
main:    total time =  1091.74 ms
...
main:     n_decoded =      504
main:     load time =   148.46 ms
main:   sample time =   128.14 ms
main:  predict time =  5985.75 ms
main:    total time =  6343.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85b5a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff859db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafadd6b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85b5a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85b5f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafadd7960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff859db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafadd6b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafadd82c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafadd7960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85b5a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafadd8c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafadd82c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafadd9580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85b5a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafadd8c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafadd9740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafadd9580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85b5f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafadd9900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafadd9740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   192.77 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.27 ms
whisper_print_timings:   sample time =    65.89 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4636.07 ms /     1 runs ( 4636.07 ms per run)
...
whisper_print_timings:    total time =  5636.50 ms
...
main:      load time =  5795.40 ms
main:    sample time =   519.52 ms / 8.12 ms per token
main:      eval time = 43686.39 ms / 624.09 ms per token
main:     total time = 52373.79 ms
...
main:      load time =  1503.14 ms
main:    sample time =   516.31 ms / 8.07 ms per token
main:      eval time = 17399.41 ms / 248.56 ms per token
main:     total time = 20386.58 ms
