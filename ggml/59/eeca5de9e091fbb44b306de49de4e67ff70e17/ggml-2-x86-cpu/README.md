...
- status:  SUCCESS ✅
- runtime: 2:42.77
- date:    Fri Sep 15 17:54:59 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/59eeca5de9e091fbb44b306de49de4e67ff70e17
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.08 sec
      Start  2: test-opt
...
main:     load time =   206.57 ms
main:   sample time =    23.75 ms
main:  predict time =   440.39 ms / 6.88 ms per token
main:    total time =   684.12 ms
...
main:  predict time =   447.26 ms / 6.39 ms per token
main:    total time =   602.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f135e87f8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f135e700160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556e9d6beac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f135e87efb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f135e884840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556e9d6bf850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f135e700160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556e9d6beac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556e9d6c0170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556e9d6bf850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f135e87efb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556e9d6c0a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556e9d6c0170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556e9d6c13b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f135e87f8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556e9d6c0a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556e9d6c1530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556e9d6c13b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f135e884840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556e9d6c16b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556e9d6c1530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 10556.03 ms
main:    sample time =   468.73 ms / 7.32 ms per token
main:      eval time = 20107.72 ms / 287.25 ms per token
main:     total time = 31818.76 ms
...
main:      load time =  4409.85 ms
main:    sample time =   467.64 ms / 7.31 ms per token
main:      eval time =  8074.16 ms / 115.35 ms per token
main:     total time = 13336.03 ms
...
whisper_print_timings:     load time =    83.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.44 ms
whisper_print_timings:   sample time =    15.99 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1152.50 ms /     1 runs ( 1152.50 ms per run)
whisper_print_timings:   decode time =    93.69 ms /    27 runs (    3.47 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1395.07 ms
```
