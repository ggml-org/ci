...
- status:  SUCCESS ✅
- runtime: 3:39.58
- date:    Fri Sep 15 17:55:55 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.05 sec
...
main:     load time =   264.91 ms
main:   sample time =    17.70 ms
main:  predict time =   810.18 ms / 12.66 ms per token
main:    total time =  1115.45 ms
...
main:     load time =   173.12 ms
main:   sample time =    17.38 ms
main:  predict time =   875.56 ms / 12.51 ms per token
main:    total time =  1069.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff815fa8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8147b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7d9bac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff815f9fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff815ff840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae7d9c850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8147b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae7d9bac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae7d9d170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae7d9c850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff815f9fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae7d9da90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae7d9d170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae7d9e3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff815fa8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae7d9da90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae7d9e530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae7d9e3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff815ff840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae7d9e6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae7d9e530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5623.31 ms
main:    sample time =   614.88 ms / 9.61 ms per token
main:      eval time = 43729.51 ms / 624.71 ms per token
main:     total time = 52344.08 ms
...
main:      load time =  1619.04 ms
main:    sample time =   622.53 ms / 9.73 ms per token
main:      eval time = 17306.36 ms / 247.23 ms per token
main:     total time = 20505.79 ms
...
whisper_print_timings:     load time =   113.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.25 ms
whisper_print_timings:   sample time =    20.40 ms /    27 runs (    0.76 ms per run)
whisper_print_timings:   encode time =  4608.18 ms /     1 runs ( 4608.18 ms per run)
whisper_print_timings:   decode time =   181.74 ms /    27 runs (    6.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  4988.47 ms
```
