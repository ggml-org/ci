...
- status:  SUCCESS ✅
- runtime: 5:18.99
- date:    Fri Sep 15 17:57:48 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed   16.07 sec
      Start 10: test3
...
main:     load time =   248.61 ms
main:   sample time =    38.00 ms
main:  predict time =   539.87 ms / 8.44 ms per token
main:    total time =   847.63 ms
...
main:     load time =   199.03 ms
main:   sample time =    35.12 ms
main:  predict time =   574.76 ms / 8.21 ms per token
main:    total time =   813.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6ffb8ee8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6ffb76f160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56377ea69ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6ffb8edfb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6ffb8f3840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56377ea6a850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6ffb76f160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56377ea69ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56377ea6b170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56377ea6a850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6ffb8edfb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56377ea6ba90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56377ea6b170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56377ea6c3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6ffb8ee8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56377ea6ba90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56377ea6c530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56377ea6c3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6ffb8f3840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56377ea6c6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56377ea6c530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 18493.60 ms
main:    sample time =   609.40 ms / 9.52 ms per token
main:      eval time = 24539.84 ms / 350.57 ms per token
main:     total time = 44500.01 ms
...
main:      load time = 13210.06 ms
main:    sample time =   604.74 ms / 9.45 ms per token
main:      eval time = 12277.12 ms / 175.39 ms per token
main:     total time = 26763.12 ms
...
whisper_print_timings:     load time =   121.01 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.67 ms
whisper_print_timings:   sample time =    21.59 ms /    27 runs (    0.80 ms per run)
whisper_print_timings:   encode time =  1825.36 ms /     1 runs ( 1825.36 ms per run)
whisper_print_timings:   decode time =   128.23 ms /    27 runs (    4.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2171.18 ms
```
