...
- status:  SUCCESS ✅
- runtime: 4:07.86
- date:    Wed Apr  3 09:01:22 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.07 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   35.38 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.58 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.53 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.57 sec
      Start  6: test0
 6/22 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.65 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.65 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   17.37 sec
      Start  3: test-quantize-perf
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.26 sec
      Start  9: test3
...
main:     load time =   161.01 ms
main:   sample time =    17.58 ms
main:  predict time =   907.39 ms / 14.18 ms per token
main:    total time =  1108.04 ms
...
main:     load time =   160.78 ms
main:   sample time =    17.57 ms
main:  predict time =   992.38 ms / 14.18 ms per token
main:    total time =  1173.69 ms
...
main:     load time =   191.38 ms
main:   sample time =    17.51 ms
main:  predict time =  1016.55 ms / 14.52 ms per token
main:    total time =  1228.99 ms
...
main:     n_decoded =      504
main:     load time =   167.31 ms
main:   sample time =   127.61 ms
main:  predict time =  6632.07 ms
main:    total time =  7010.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa8dba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa8c3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaee8bece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa8dba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa8dbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaee8bfab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa8c3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaee8bece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaee8c0410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaee8bfab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa8dba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaee8c0d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaee8c0410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaee8c16d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa8dba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaee8c0d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaee8c1890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaee8c16d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa8dbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaee8c1a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaee8c1890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.20 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.12 ms
whisper_print_timings:   sample time =    65.14 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4678.12 ms /     1 runs ( 4678.12 ms per run)
whisper_print_timings:   decode time =    15.34 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   712.18 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5600.64 ms
...
main:     load time =    99.90 ms
main:    total time = 40069.38 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.268000 sec.)
