...
- status:  SUCCESS ✅
- runtime: 2:15.06
- date:    Wed Apr  3 20:59:14 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/eddc30ab2aeec32464a50c037d4cb30880168a7d
- author:  Andrei
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.46 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.36 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    1.62 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   15.92 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.45 sec
...
main:     load time =   109.75 ms
main:   sample time =    23.53 ms
main:  predict time =   491.23 ms / 7.68 ms per token
main:    total time =   636.97 ms
...
main:     load time =   109.61 ms
main:   sample time =    23.45 ms
main:  predict time =   508.64 ms / 7.27 ms per token
main:    total time =   643.70 ms
...
main:     load time =   125.81 ms
main:   sample time =    23.81 ms
main:  predict time =   524.32 ms / 7.49 ms per token
main:    total time =   676.92 ms
...
main:     n_decoded =      504
main:     load time =   109.02 ms
main:   sample time =   175.37 ms
main:  predict time =  1808.23 ms
main:    total time =  2124.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f49cf6bd990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f49cf53e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5641564cbce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f49cf6bd030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f49cf6c2940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5641564ccab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f49cf53e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5641564cbce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5641564cd410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5641564ccab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f49cf6bd030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5641564cdd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5641564cd410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5641564ce6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f49cf6bd990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5641564cdd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5641564ce890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5641564ce6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f49cf6c2940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5641564cea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5641564ce890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.18 ms
whisper_print_timings:   sample time =    55.09 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1189.07 ms /     1 runs ( 1189.07 ms per run)
whisper_print_timings:   decode time =    12.09 ms /     2 runs (    6.05 ms per run)
whisper_print_timings:   batchd time =   212.10 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1563.78 ms
...
main:     load time =    65.47 ms
main:    total time = 10765.90 ms
embd_img
