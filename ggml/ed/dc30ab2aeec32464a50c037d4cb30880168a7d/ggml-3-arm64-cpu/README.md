...
- status:  SUCCESS ✅
- runtime: 3:10.80
- date:    Wed Apr  3 21:00:23 UTC 2024
...
main:  predict time =   898.28 ms / 14.04 ms per token
...
main:     load time =   151.68 ms
main:   sample time =    17.28 ms
main:  predict time =   976.01 ms / 13.94 ms per token
main:    total time =  1147.81 ms
...
main:     load time =   179.50 ms
main:   sample time =    17.35 ms
main:  predict time =  1014.07 ms / 14.49 ms per token
main:    total time =  1214.27 ms
...
main:     n_decoded =      504
main:     load time =   153.06 ms
main:   sample time =   128.29 ms
main:  predict time =  6408.71 ms
main:    total time =  6772.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9826a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff980eb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbbdcce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9826a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9826f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadbbddab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff980eb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadbbdcce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadbbde410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadbbddab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9826a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadbbded70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadbbde410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadbbdf6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9826a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadbbded70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadbbdf890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadbbdf6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9826f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadbbdfa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadbbdf890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    65.19 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4682.87 ms /     1 runs ( 4682.87 ms per run)
whisper_print_timings:   decode time =    15.42 ms /     2 runs (    7.71 ms per run)
whisper_print_timings:   batchd time =   710.77 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5599.52 ms
...
main:     load time =    92.14 ms
main:    total time = 39759.28 ms
embd_img
