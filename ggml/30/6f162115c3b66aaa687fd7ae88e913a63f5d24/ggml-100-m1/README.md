...
- status:  SUCCESS ✅
- runtime: 113.79
- date:    Mon Oct 30 06:29:22 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    1.30 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/16 Test  #1: test-grad0 .......................   Passed    1.13 sec
      Start  2: test-opt
...
15/16 Test #15: test-customop ....................   Passed    0.24 sec
      Start 16: test-xpos
...
main:   sample time =     8.99 ms
main:  predict time =   298.67 ms / 4.67 ms per token
main:    total time =   460.17 ms
...
main:  predict time =   761.01 ms
main:    total time =   964.72 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x12a809f60                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x12a80ad00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x130008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x12a809f60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x12a80b630                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x12a80ad00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x130186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x12a80bf60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x12a80b630                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x12a80c890                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1301878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x12a80bf60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x12a80ca20                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x12a80c890                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x13018c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x12a80cbb0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x12a80ca20                           node_4
...
whisper_print_timings:     load time =   126.25 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.39 ms
whisper_print_timings:   sample time =    11.60 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   708.65 ms /     1 runs (  708.65 ms per run)
whisper_print_timings:   decode time =    63.23 ms /    27 runs (    2.34 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   930.83 ms
...
main:     load time =    75.34 ms
main:    total time =  5750.54 ms
embd_img
