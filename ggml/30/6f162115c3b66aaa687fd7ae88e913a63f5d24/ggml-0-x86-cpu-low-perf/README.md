...
- status:  SUCCESS ✅
- runtime: 2:00.73
- date:    Mon Oct 30 04:30:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.69 sec
      Start  2: test-quantize-fns
...
main:  predict time =   718.83 ms / 11.23 ms per token
main:    total time =   866.01 ms
...
main:     load time =   113.71 ms
main:   sample time =    23.41 ms
main:  predict time =   623.82 ms / 8.91 ms per token
...
main:  predict time =  2363.44 ms
main:    total time =  2691.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4a8ab31900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4a8a9b2170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558dada28ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4a8ab30fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4a8ab36880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558dada29870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4a8a9b2170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558dada28ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558dada2a1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558dada29870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4a8ab30fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558dada2aad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558dada2a1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558dada2b400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4a8ab31900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558dada2aad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558dada2b590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558dada2b400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4a8ab36880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558dada2b720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558dada2b590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    82.74 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.77 ms
whisper_print_timings:   sample time =    16.19 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1961.57 ms /     1 runs ( 1961.57 ms per run)
whisper_print_timings:   decode time =   257.40 ms /    27 runs (    9.53 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2380.55 ms
...
main:     load time =    65.63 ms
main:    total time = 18855.97 ms
embd_img
