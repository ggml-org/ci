...
- status:  SUCCESS ✅
- runtime: 2:33.19
- date:    Mon Oct 30 04:30:52 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.03 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.66 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
...
main:  predict time =   887.85 ms / 13.87 ms per token
main:    total time =  1083.59 ms
...
main:  predict time =  6038.33 ms
main:    total time =  6410.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff974ba900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9733b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0c16fad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff974b9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff974bf880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0c170870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9733b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0c16fad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0c1711a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0c170870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff974b9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0c171ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0c1711a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0c172400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff974ba900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0c171ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0c172590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0c172400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff974bf880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0c172720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0c172590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.29 ms
whisper_print_timings:   sample time =    20.99 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4704.44 ms /     1 runs ( 4704.44 ms per run)
whisper_print_timings:   decode time =   183.82 ms /    27 runs (    6.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5091.37 ms
...
main:     load time =    82.30 ms
main:    total time = 40246.76 ms
embd_img
