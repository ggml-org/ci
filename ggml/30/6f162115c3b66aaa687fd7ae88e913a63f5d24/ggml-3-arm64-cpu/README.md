...
- status:  SUCCESS ✅
- runtime: 4:45.44
- date:    Mon Oct 30 04:33:13 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.47 sec
      Start  2: test-opt
...
main:     load time =   251.99 ms
main:   sample time =    17.06 ms
main:  predict time =   801.56 ms / 12.52 ms per token
main:    total time =  1093.53 ms
...
main:  predict time =   868.75 ms / 12.41 ms per token
main:    total time =  1039.65 ms
...
main:     n_decoded =      504
main:     load time =   140.81 ms
main:   sample time =   128.34 ms
main:  predict time =  5853.56 ms
main:    total time =  6204.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8695a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff867db170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaea601ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86959fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8695f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaea602870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff867db170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaea601ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaea6031a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaea602870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86959fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaea603ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaea6031a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaea604400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8695a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaea603ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaea604590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaea604400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8695f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaea604720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaea604590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    77.59 ms
main:    total time = 39366.53 ms
embd_img
...
main:      load time = 12675.99 ms
main:    sample time =   520.62 ms / 8.13 ms per token
main:      eval time = 43542.05 ms / 622.03 ms per token
main:     total time = 59112.89 ms
...
main:      load time =  4357.79 ms
main:    sample time =   514.30 ms / 8.04 ms per token
main:      eval time = 17460.53 ms / 249.44 ms per token
main:     total time = 23295.31 ms
