...
- status:  SUCCESS ✅
- runtime: 3:07.25
- date:    Mon Oct 30 04:31:21 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/306f162115c3b66aaa687fd7ae88e913a63f5d24
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.68 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.56 sec
      Start  2: test-opt
...
main:     load time =   160.90 ms
main:   sample time =    23.42 ms
main:  predict time =   425.66 ms / 6.65 ms per token
main:    total time =   623.58 ms
...
main:     load time =   102.72 ms
main:   sample time =    23.32 ms
main:  predict time =   450.55 ms / 6.44 ms per token
main:    total time =   579.33 ms
...
main:   sample time =   175.50 ms
main:  predict time =  1502.11 ms
main:    total time =  1815.60 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f903326b900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f90330ec170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557914e95ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f903326afd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9033270880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557914e96870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f90330ec170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557914e95ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557914e971a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557914e96870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f903326afd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557914e97ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557914e971a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557914e98400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f903326b900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557914e97ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557914e98590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557914e98400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9033270880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557914e98720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557914e98590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    16.80 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  1132.91 ms /     1 runs ( 1132.91 ms per run)
whisper_print_timings:   decode time =    92.28 ms /    27 runs (    3.42 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1427.43 ms
...
main:     load time =    59.95 ms
main:    total time = 10454.98 ms
embd_img
...
main:      load time = 11352.93 ms
main:    sample time =   468.40 ms / 7.32 ms per token
main:      eval time = 20273.46 ms / 289.62 ms per token
main:     total time = 32792.11 ms
...
main:      load time =  4383.10 ms
main:    sample time =   465.50 ms / 7.27 ms per token
main:      eval time =  8010.62 ms / 114.44 ms per token
main:     total time = 13231.61 ms
