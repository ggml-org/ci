...
- status:  SUCCESS ✅
- runtime: 2:01.75
- date:    Fri Mar 22 07:19:48 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   13.09 sec
...
main:     load time =   134.77 ms
main:   sample time =    23.57 ms
main:  predict time =   505.29 ms / 7.90 ms per token
main:    total time =   676.08 ms
...
main:  predict time =   519.65 ms / 7.42 ms per token
...
main:     load time =   128.98 ms
main:   sample time =    23.90 ms
main:  predict time =   539.43 ms / 7.71 ms per token
main:    total time =   695.87 ms
...
main:   sample time =   175.23 ms
main:  predict time =  1893.07 ms
main:    total time =  2206.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3053750990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30535d11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559c84b4fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3053750030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3053755940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559c84b50ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30535d11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559c84b4fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559c84b51410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559c84b50ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3053750030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559c84b51d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559c84b51410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559c84b526d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3053750990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559c84b51d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559c84b52890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559c84b526d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3053755940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559c84b52a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559c84b52890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.16 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.35 ms
whisper_print_timings:   sample time =    54.93 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1186.54 ms /     1 runs ( 1186.54 ms per run)
whisper_print_timings:   decode time =    12.37 ms /     2 runs (    6.19 ms per run)
whisper_print_timings:   batchd time =   212.67 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1591.21 ms
...
main:     load time =    64.85 ms
main:    total time = 10677.48 ms
embd_img
