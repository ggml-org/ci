...
- status:  SUCCESS ✅
- runtime: 4:16.14
- date:    Wed Feb 21 03:16:52 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   97.67 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 115.37 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.89 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.17 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.62 sec
...
main:  predict time =   890.14 ms / 13.91 ms per token
main:    total time =  1080.10 ms
...
main:  predict time =   969.47 ms / 13.85 ms per token
main:    total time =  1142.10 ms
...
main:  predict time =   975.26 ms / 13.93 ms per token
main:    total time =  1176.28 ms
...
main:  predict time =  6440.48 ms
main:    total time =  6802.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9313a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff92fbb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab133b8ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9313a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9313f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab133b9ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff92fbb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab133b8ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab133ba410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab133b9ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9313a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab133bad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab133ba410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab133bb6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9313a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab133bad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab133bb890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab133bb6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9313f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab133bba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab133bb890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    65.91 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4677.52 ms /     1 runs ( 4677.52 ms per run)
whisper_print_timings:   decode time =    14.80 ms /     2 runs (    7.40 ms per run)
whisper_print_timings:   batchd time =   710.84 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5591.69 ms
