...
- status:  SUCCESS ✅
- runtime: 5:10.91
- date:    Wed Feb 21 02:51:11 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/30805514e1bf389a59d30a54a0525cbdc30d5bd1
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.84 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.58 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.81 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.65 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.57 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  104.82 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 146.56 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.10 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.79 sec
      Start  3: test-quantize-perf
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.92 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   20.86 sec
...
main:     load time =   160.59 ms
main:   sample time =    17.60 ms
main:  predict time =   940.67 ms / 14.70 ms per token
main:    total time =  1140.43 ms
...
main:     load time =   157.36 ms
main:   sample time =    17.05 ms
main:  predict time =  1025.99 ms / 14.66 ms per token
main:    total time =  1203.18 ms
...
main:     load time =   188.23 ms
main:   sample time =    17.14 ms
main:  predict time =   995.59 ms / 14.22 ms per token
main:    total time =  1204.11 ms
...
main:     n_decoded =      504
main:     load time =   155.10 ms
main:   sample time =   128.40 ms
main:  predict time =  6587.04 ms
main:    total time =  6952.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab1a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa99b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad12e0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab1a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab1f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad12e1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa99b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad12e0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad12e2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad12e1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaab1a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad12e2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad12e2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad12e36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaab1a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad12e2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad12e3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad12e36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaab1f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad12e3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad12e3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.93 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.78 ms
whisper_print_timings:   sample time =    65.20 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4744.21 ms /     1 runs ( 4744.21 ms per run)
whisper_print_timings:   decode time =    15.15 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   711.87 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5662.44 ms
...
main:     load time =    87.51 ms
main:    total time = 40579.25 ms
embd_img
