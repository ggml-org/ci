...
- status:  SUCCESS ✅
- runtime: 8:58.91
- date:    Wed Feb 21 15:31:52 UTC 2024
...
16/20 Test #16: test-conv1d ......................   Passed    0.61 sec
...
20/20 Test #20: test-backend-ops .................   Passed  143.01 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 193.64 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.75 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.62 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    3.45 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.82 sec
      Start  5: test-mul-mat0
 5/21 Test  #5: test-mul-mat0 ....................   Passed    1.09 sec
      Start  6: test-mul-mat2
 6/21 Test  #6: test-mul-mat2 ....................   Passed    3.35 sec
      Start  7: test0
...
21/21 Test #21: test-backend-ops .................   Passed   42.14 sec
...
main:     load time =   619.51 ms
main:   sample time =    34.35 ms
main:  predict time =   686.45 ms / 10.73 ms per token
main:    total time =  1363.49 ms
...
main:     load time =   546.80 ms
main:   sample time =    34.31 ms
main:  predict time =   704.74 ms / 10.07 ms per token
main:    total time =  1289.63 ms
...
main:     load time =   598.78 ms
main:   sample time =    34.14 ms
main:  predict time =   713.47 ms / 10.19 ms per token
main:    total time =  1350.95 ms
...
main:     n_decoded =      504
main:     load time =   565.33 ms
main:   sample time =   239.39 ms
main:  predict time =  2977.52 ms
main:    total time =  3829.35 ms
...
main: loaded model in   427.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79305b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79304371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a39ffcd530                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79305b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79305bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a39ffce300                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79304371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a39ffcd530                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a39ffcec60                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a39ffce300                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79305b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a39ffcf5c0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a39ffcec60                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a39ffcff20                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79305b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a39ffcf5c0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a39ffd00e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a39ffcff20                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79305bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a39ffd02a0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a39ffd00e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   518.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.50 ms
whisper_print_timings:   sample time =    66.39 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    33.38 ms /     1 runs (   33.38 ms per run)
whisper_print_timings:   decode time =    20.73 ms /     2 runs (   10.37 ms per run)
whisper_print_timings:   batchd time =    82.70 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   749.07 ms
...
main:     load time =   509.26 ms
main:    total time =  8031.83 ms
embd_img
