...
- status:  SUCCESS ✅
- runtime: 7:01.69
- date:    Mon Jan 29 12:06:31 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.42 sec
...
20/20 Test #20: test-backend-ops .................   Passed  125.98 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 140.01 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.50 sec
...
main:     load time =   188.04 ms
main:   sample time =    17.28 ms
main:  predict time =   863.69 ms / 13.50 ms per token
main:    total time =  1091.03 ms
...
main:     load time =   188.75 ms
main:   sample time =    17.58 ms
main:  predict time =   933.19 ms / 13.33 ms per token
main:    total time =  1142.84 ms
...
main:   sample time =   127.16 ms
main:  predict time =  6011.99 ms
main:    total time =  6378.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8b3ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8b26b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0b73fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8b3ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8b3ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0b740960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8b26b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0b73fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0b7412c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0b740960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8b3ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0b741c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0b7412c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0b742580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8b3ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0b741c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0b742740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0b742580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8b3ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0b742900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0b742740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:    total time =  5562.56 ms
...
main:     load time =   101.94 ms
main:    total time = 39844.21 ms
embd_img
...
main:      load time =  5488.98 ms
main:    sample time =   518.63 ms / 8.10 ms per token
main:      eval time = 43902.79 ms / 627.18 ms per token
main:     total time = 52283.50 ms
...
main:      load time =  1581.69 ms
main:    sample time =   514.18 ms / 8.03 ms per token
main:      eval time = 17539.20 ms / 250.56 ms per token
main:     total time = 20592.76 ms
