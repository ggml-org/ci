...
- status:  SUCCESS ✅
- runtime: 5:03.21
- date:    Mon Jan 29 12:04:29 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  114.69 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.36 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   19.34 sec
...
main:  predict time =   470.50 ms / 7.35 ms per token
main:    total time =   634.30 ms
...
main:     load time =   124.33 ms
main:   sample time =    23.80 ms
main:  predict time =   486.13 ms / 6.94 ms per token
main:    total time =   636.58 ms
...
main:     n_decoded =      504
main:     load time =   102.20 ms
main:   sample time =   177.76 ms
main:  predict time =  1521.30 ms
main:    total time =  1832.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2767777990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f27675f81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563338095b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2767777030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f276777c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563338096960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f27675f81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563338095b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5633380972c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563338096960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2767777030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563338097c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5633380972c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563338098580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2767777990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563338097c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563338098740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563338098580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f276777c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563338098900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563338098740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1158.78 ms /     1 runs ( 1158.78 ms per run)
...
whisper_print_timings:    total time =  1530.46 ms
...
main:     load time =    65.29 ms
main:    total time = 10668.15 ms
embd_img
...
main:      load time =  4252.36 ms
main:    sample time =   471.53 ms / 7.37 ms per token
main:      eval time = 19530.68 ms / 279.01 ms per token
main:     total time = 24898.52 ms
...
main:      load time =  1242.65 ms
main:    sample time =   467.20 ms / 7.30 ms per token
main:      eval time =  8240.05 ms / 117.72 ms per token
main:     total time = 10324.34 ms
