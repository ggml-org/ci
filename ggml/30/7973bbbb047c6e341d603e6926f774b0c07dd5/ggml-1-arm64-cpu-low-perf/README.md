...
- status:  SUCCESS ✅
- runtime: 6:00.88
- date:    Mon Jan 29 12:05:37 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/307973bbbb047c6e341d603e6926f774b0c07dd5
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.57 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  149.35 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 187.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.61 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.41 sec
...
main:     load time =   187.58 ms
main:   sample time =    17.12 ms
main:  predict time =   886.26 ms / 13.85 ms per token
...
main:     load time =   193.31 ms
main:   sample time =    17.07 ms
main:  predict time =   945.94 ms / 13.51 ms per token
main:    total time =  1159.56 ms
...
main:     n_decoded =      504
main:     load time =   163.47 ms
main:   sample time =   127.48 ms
main:  predict time =  6234.27 ms
main:    total time =  6607.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9574a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff955cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2018b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9574a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9574f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae2019960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff955cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2018b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae201a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae2019960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9574a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae201ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae201a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae201b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9574a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae201ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae201b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae201b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9574f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae201b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae201b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.52 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.58 ms
whisper_print_timings:   sample time =    65.54 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4648.94 ms /     1 runs ( 4648.94 ms per run)
whisper_print_timings:   decode time =    15.83 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   837.72 ms /   125 runs (    6.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5696.33 ms
