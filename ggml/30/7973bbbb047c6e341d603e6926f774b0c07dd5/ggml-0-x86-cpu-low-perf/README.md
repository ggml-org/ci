...
- status:  SUCCESS ✅
- runtime: 4:51.99
- date:    Mon Jan 29 12:04:28 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.72 sec
...
20/20 Test #20: test-backend-ops .................   Passed  115.71 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 154.52 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.84 sec
...
main:  predict time =   640.47 ms / 10.01 ms per token
main:    total time =   804.82 ms
...
main:  predict time =   672.98 ms / 9.61 ms per token
main:    total time =   826.78 ms
...
main:  predict time =  2527.04 ms
main:    total time =  2856.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7b104e9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7b1036a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563f0b726b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7b104e9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7b104ee940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563f0b727960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7b1036a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563f0b726b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563f0b7282c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563f0b727960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7b104e9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563f0b728c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563f0b7282c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563f0b729580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7b104e9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563f0b728c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563f0b729740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563f0b729580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7b104ee940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563f0b729900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563f0b729740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    71.65 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1982.36 ms /     1 runs ( 1982.36 ms per run)
whisper_print_timings:   decode time =    12.75 ms /     2 runs (    6.37 ms per run)
whisper_print_timings:   batchd time =   326.82 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2493.91 ms
