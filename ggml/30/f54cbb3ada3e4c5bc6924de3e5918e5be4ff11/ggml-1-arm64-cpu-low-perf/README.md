...
- status:  SUCCESS ✅
- runtime: 4:08.69
- date:    Sat May 11 18:47:35 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.82 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   34.72 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.92 sec
      Start  2: test-quantize-fns
...
main:  predict time =   947.47 ms / 14.80 ms per token
main:    total time =  1155.17 ms
...
main:  predict time =   988.68 ms / 14.12 ms per token
main:    total time =  1169.40 ms
...
main:     load time =   191.45 ms
main:   sample time =    17.60 ms
main:  predict time =  1034.30 ms / 14.78 ms per token
main:    total time =  1246.81 ms
...
main:     n_decoded =      504
main:     load time =   164.28 ms
main:   sample time =   128.60 ms
main:  predict time =  6484.43 ms
main:    total time =  6860.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9dbba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9da3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab12309ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9dbba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9dbbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1230aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9da3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab12309ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1230b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab1230aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9dbba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1230bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab1230b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1230c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9dbba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab1230bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1230c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab1230c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9dbbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab1230ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab1230c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =   751.06 ms /   131 runs (    5.73 ms per run)
whisper_print_timings:   encode time =  4749.42 ms /     1 runs ( 4749.42 ms per run)
whisper_print_timings:   decode time =    15.41 ms /     2 runs (    7.71 ms per run)
whisper_print_timings:   batchd time =   715.24 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6360.90 ms
...
main:     load time =    91.68 ms
main:    total time = 40176.86 ms
embd_img
