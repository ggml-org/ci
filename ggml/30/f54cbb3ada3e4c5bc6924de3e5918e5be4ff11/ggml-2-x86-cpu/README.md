...
- status:  SUCCESS ✅
- runtime: 2:18.72
- date:    Sun May 12 08:02:15 UTC 2024
...
main:     load time =   107.13 ms
main:   sample time =    23.95 ms
main:  predict time =   528.90 ms / 8.26 ms per token
main:    total time =   676.12 ms
...
main:     load time =   106.20 ms
main:   sample time =    23.87 ms
main:  predict time =   521.11 ms / 7.44 ms per token
main:    total time =   653.26 ms
...
main:  predict time =   540.72 ms / 7.72 ms per token
main:    total time =   696.87 ms
...
main:  predict time =  1851.85 ms
main:    total time =  2165.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7a3fb30fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7a3fb2f7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x64ebb0c22ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7a3fb30fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7a3fb30ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x64ebb0c23ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7a3fb2f7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x64ebb0c22ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x64ebb0c24410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x64ebb0c23ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7a3fb30fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x64ebb0c24d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x64ebb0c24410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x64ebb0c256d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7a3fb30fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x64ebb0c24d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x64ebb0c25890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x64ebb0c256d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7a3fb30ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x64ebb0c25a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x64ebb0c25890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.94 ms
whisper_print_timings:   sample time =   468.19 ms /   131 runs (    3.57 ms per run)
whisper_print_timings:   encode time =  1189.55 ms /     1 runs ( 1189.55 ms per run)
whisper_print_timings:   decode time =    12.64 ms /     2 runs (    6.32 ms per run)
whisper_print_timings:   batchd time =   219.91 ms /   125 runs (    1.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1983.14 ms
...
main:     load time =    63.32 ms
main:    total time = 10654.63 ms
embd_img
