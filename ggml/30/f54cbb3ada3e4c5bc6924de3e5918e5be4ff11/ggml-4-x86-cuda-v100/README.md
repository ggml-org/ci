...
- status:  SUCCESS ✅
- runtime: 11:56.46
- date:    Sat May 11 19:50:44 UTC 2024
...
22/22 Test #22: test-backend-ops .................   Passed  153.90 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 238.25 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/23 Test  #1: test-grad0 .......................   Passed    4.52 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.99 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   20.28 sec
...
23/23 Test #23: test-backend-ops .................   Passed   40.34 sec
...
main:  predict time =   626.65 ms / 9.79 ms per token
main:    total time =   834.47 ms
...
main:     load time =   147.46 ms
main:   sample time =    35.23 ms
main:  predict time =   688.72 ms / 9.84 ms per token
main:    total time =   875.12 ms
...
main:     load time =   177.36 ms
main:   sample time =    34.69 ms
main:  predict time =   694.63 ms / 9.92 ms per token
main:    total time =   911.93 ms
...
main:   sample time =   234.39 ms
main:  predict time =  2897.62 ms
main:    total time =  3328.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6cccefa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6cccd7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563cb0dac30                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6cccefa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6ccceff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5563cb0dba00                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6cccd7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5563cb0dac30                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5563cb0dc360                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5563cb0dba00                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6cccefa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5563cb0dccc0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5563cb0dc360                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5563cb0dd620                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6cccefa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5563cb0dccc0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5563cb0dd7e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5563cb0dd620                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6ccceff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5563cb0dd9a0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5563cb0dd7e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   523.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.72 ms
whisper_print_timings:   sample time =   471.21 ms /   131 runs (    3.60 ms per run)
whisper_print_timings:   encode time =    50.80 ms /     1 runs (   50.80 ms per run)
whisper_print_timings:   decode time =    11.48 ms /     2 runs (    5.74 ms per run)
whisper_print_timings:   batchd time =    81.03 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1164.81 ms
