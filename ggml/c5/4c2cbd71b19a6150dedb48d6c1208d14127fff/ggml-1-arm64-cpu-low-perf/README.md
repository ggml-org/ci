...
- status:  SUCCESS ✅
- runtime: 3:14.45
- date:    Tue Dec  5 11:01:44 AM UTC 2023
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    3.94 sec
...
main:  predict time =   836.28 ms / 13.07 ms per token
main:    total time =  1060.09 ms
...
main:  predict time =   894.97 ms / 12.79 ms per token
...
main:   sample time =   128.84 ms
main:  predict time =  5997.64 ms
main:    total time =  6364.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83a3a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff838bb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab038b4b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83a3a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83a3f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab038b5940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff838bb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab038b4b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab038b6290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab038b5940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83a3a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab038b6be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab038b6290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab038b7530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff83a3a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab038b6be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab038b76e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab038b7530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff83a3f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab038b7890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab038b76e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =    65.84 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4761.38 ms /     1 runs ( 4761.38 ms per run)
whisper_print_timings:   decode time =    15.82 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   716.11 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5683.53 ms
...
main:     load time =    89.89 ms
main:    total time = 40081.87 ms
embd_img
