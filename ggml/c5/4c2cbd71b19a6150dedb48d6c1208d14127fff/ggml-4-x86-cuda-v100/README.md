...
- status:  SUCCESS ✅
- runtime: 7:59.85
- date:    Tue Dec  5 11:06:32 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/c54c2cbd71b19a6150dedb48d6c1208d14127fff
- author:  slaren
```
cleanup
ggml-ci
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.74 sec
...
12/19 Test #12: test-rel-pos .....................   Passed    0.57 sec
...
19/19 Test #19: test-backend-ops .................   Passed   49.03 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    6.71 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.59 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.99 sec
...
main:     load time =   478.09 ms
main:   sample time =    33.90 ms
main:  predict time =   552.50 ms / 8.63 ms per token
...
main:     load time =   470.83 ms
main:   sample time =    34.28 ms
main:  predict time =   597.45 ms / 8.54 ms per token
...
main:     n_decoded =      504
main:     load time =   452.69 ms
main:   sample time =   238.12 ms
main:  predict time =  2241.04 ms
main:    total time =  2975.79 ms
...
main: loaded model in   289.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f14085b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1408437190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564b96244aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f14085b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f14085bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564b96245860                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1408437190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564b96244aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564b962461b0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564b96245860                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f14085b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564b96246b00                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564b962461b0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564b96247450                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f14085b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564b96246b00                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564b96247600                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564b96247450                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f14085bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564b962477b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564b96247600       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1002.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.15 ms
whisper_print_timings:   sample time =    68.56 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    39.66 ms /     1 runs (   39.66 ms per run)
whisper_print_timings:   decode time =    13.83 ms /     2 runs (    6.91 ms per run)
whisper_print_timings:   batchd time =    80.87 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1233.03 ms
...
main:     load time =   394.51 ms
main:    total time =  7573.81 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.652000 sec.)
...
main:      load time =  8240.87 ms
main:    sample time =   523.13 ms / 8.17 ms per token
main:      eval time = 24975.26 ms / 356.79 ms per token
main:     total time = 34581.42 ms
...
main:      load time =  2003.54 ms
main:    sample time =   526.74 ms / 8.23 ms per token
main:      eval time = 12452.81 ms / 177.90 ms per token
main:     total time = 15654.43 ms
