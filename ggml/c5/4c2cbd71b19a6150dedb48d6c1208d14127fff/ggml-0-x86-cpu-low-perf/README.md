...
- status:  SUCCESS ✅
- runtime: 2:28.65
- date:    Tue Dec  5 11:01:02 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.96 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   20.36 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    3.20 sec
...
main:     load time =   125.40 ms
main:   sample time =    23.65 ms
main:  predict time =   603.17 ms / 9.42 ms per token
main:    total time =   764.82 ms
...
main:     load time =   124.08 ms
main:   sample time =    23.55 ms
main:  predict time =   631.66 ms / 9.02 ms per token
main:    total time =   781.49 ms
...
main:  predict time =  2367.14 ms
main:    total time =  2694.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fac4bde9960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fac4bc6a190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5581ae519b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fac4bde9010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fac4bdee900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5581ae51a940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fac4bc6a190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5581ae519b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5581ae51b290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5581ae51a940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fac4bde9010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5581ae51bbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5581ae51b290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5581ae51c530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fac4bde9960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5581ae51bbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5581ae51c6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5581ae51c530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fac4bdee900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5581ae51c890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5581ae51c6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.71 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.16 ms
whisper_print_timings:   sample time =    72.19 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1978.08 ms /     1 runs ( 1978.08 ms per run)
whisper_print_timings:   decode time =    13.05 ms /     2 runs (    6.52 ms per run)
whisper_print_timings:   batchd time =   322.48 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2485.71 ms
...
main:     load time =    69.36 ms
main:    total time = 18677.56 ms
embd_img
