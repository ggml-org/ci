...
- status:  SUCCESS ✅
- runtime: 3:21.85
- date:    Tue Dec  5 11:01:48 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   19.69 sec
...
main:     load time =   174.38 ms
main:   sample time =    23.46 ms
main:  predict time =   430.70 ms / 6.73 ms per token
main:    total time =   641.43 ms
...
main:     load time =   122.53 ms
main:   sample time =    23.48 ms
main:  predict time =   449.32 ms / 6.42 ms per token
main:    total time =   597.41 ms
...
main:  predict time =  1458.92 ms
main:    total time =  1770.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3a23685960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3a23506190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56385b74eb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3a23685010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3a2368a900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56385b74f940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3a23506190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56385b74eb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56385b750290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56385b74f940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3a23685010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56385b750be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56385b750290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56385b751530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3a23685960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56385b750be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56385b7516e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56385b751530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3a2368a900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56385b751890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56385b7516e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   119.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.54 ms
whisper_print_timings:   sample time =    55.12 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1144.96 ms /     1 runs ( 1144.96 ms per run)
whisper_print_timings:   decode time =     9.59 ms /     2 runs (    4.79 ms per run)
whisper_print_timings:   batchd time =   206.32 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1553.65 ms
...
main:     load time =    60.89 ms
main:    total time = 10428.18 ms
embd_img
...
main:      load time =  5385.23 ms
main:    sample time =   469.86 ms / 7.34 ms per token
main:      eval time = 20369.88 ms / 291.00 ms per token
main:     total time = 26893.51 ms
...
main:      load time =  1198.92 ms
main:    sample time =   467.00 ms / 7.30 ms per token
main:      eval time =  8018.63 ms / 114.55 ms per token
main:     total time = 10056.12 ms
