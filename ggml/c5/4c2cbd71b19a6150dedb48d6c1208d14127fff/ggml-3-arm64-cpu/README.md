...
- status:  SUCCESS ✅
- runtime: 5:13.33
- date:    Tue Dec  5 11:03:45 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   30.86 sec
...
main:     load time =   191.43 ms
main:   sample time =    16.96 ms
main:  predict time =   821.01 ms / 12.83 ms per token
main:    total time =  1051.10 ms
...
main:  predict time =   877.25 ms / 12.53 ms per token
main:    total time =  1078.55 ms
...
main:  predict time =  5842.54 ms
main:    total time =  6201.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9038a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9020b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6703b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9038a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9038f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6704940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9020b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae6703b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6705290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae6704940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9038a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6705be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae6705290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6706530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9038a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae6705be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae67066e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae6706530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9038f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae6706890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae67066e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   193.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    65.93 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4650.29 ms /     1 runs ( 4650.29 ms per run)
whisper_print_timings:   decode time =    15.79 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   714.05 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5658.69 ms
...
main:      load time =  5863.72 ms
main:    sample time =   533.19 ms / 8.33 ms per token
main:      eval time = 43481.39 ms / 621.16 ms per token
main:     total time = 52250.64 ms
...
main:      load time =  1544.83 ms
main:    sample time =   529.03 ms / 8.27 ms per token
main:      eval time = 17498.76 ms / 249.98 ms per token
main:     total time = 20543.12 ms
