...
- status:  SUCCESS ✅
- runtime: 3:57.45
- date:    Thu Dec  7 20:30:37 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.41 sec
...
Total Test time (real) =  17.09 sec
...
main:     load time =   252.09 ms
main:   sample time =    23.52 ms
main:  predict time =   446.80 ms / 6.98 ms per token
main:    total time =   735.28 ms
...
main:  predict time =   465.05 ms / 6.64 ms per token
main:    total time =   623.63 ms
...
main:  predict time =  1464.29 ms
main:    total time =  1783.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f67a113d960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f67a0fbe190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557a5d3c0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f67a113d010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f67a1142900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557a5d3c1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f67a0fbe190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557a5d3c0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557a5d3c2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557a5d3c1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f67a113d010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557a5d3c2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557a5d3c2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557a5d3c3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f67a113d960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557a5d3c2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557a5d3c36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557a5d3c3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f67a1142900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557a5d3c3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557a5d3c36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.17 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    55.40 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1150.59 ms /     1 runs ( 1150.59 ms per run)
whisper_print_timings:   decode time =     9.92 ms /     2 runs (    4.96 ms per run)
whisper_print_timings:   batchd time =   207.89 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1571.96 ms
...
main:      load time = 13927.89 ms
main:    sample time =   468.24 ms / 7.32 ms per token
main:      eval time = 19999.23 ms / 285.70 ms per token
main:     total time = 35050.59 ms
...
main:      load time =  4375.20 ms
main:    sample time =   464.66 ms / 7.26 ms per token
main:      eval time =  8067.21 ms / 115.25 ms per token
main:     total time = 13286.45 ms
