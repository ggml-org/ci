...
- status:  SUCCESS ✅
- runtime: 3:06.73
- date:    Thu Dec  7 20:29:46 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   51.02 sec
...
main:     load time =   131.55 ms
main:   sample time =    23.55 ms
main:  predict time =   607.47 ms / 9.49 ms per token
main:    total time =   775.44 ms
...
main:  predict time =   634.08 ms / 9.06 ms per token
main:    total time =   788.82 ms
...
main:  predict time =  2380.07 ms
main:    total time =  2710.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f525e943960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f525e7c4190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c832db2b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f525e943010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f525e948900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c832db3940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f525e7c4190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c832db2b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c832db4290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c832db3940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f525e943010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c832db4be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c832db4290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c832db5530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f525e943960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c832db4be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c832db56e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c832db5530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f525e948900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c832db5890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c832db56e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.66 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.99 ms
whisper_print_timings:   sample time =    71.65 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2000.02 ms /     1 runs ( 2000.02 ms per run)
whisper_print_timings:   decode time =    12.25 ms /     2 runs (    6.12 ms per run)
whisper_print_timings:   batchd time =   325.30 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2509.07 ms
