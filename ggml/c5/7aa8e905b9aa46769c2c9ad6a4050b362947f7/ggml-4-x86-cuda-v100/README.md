...
- status:  SUCCESS ✅
- runtime: 8:29.77
- date:    Thu Dec  7 20:35:21 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.59 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.52 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    7.96 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    1.08 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed   89.98 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 121.86 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    6.54 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.55 sec
...
20/20 Test #20: test-backend-ops .................   Passed   22.57 sec
...
main:     load time =  1437.82 ms
main:   sample time =    34.63 ms
main:  predict time =   569.36 ms / 8.90 ms per token
main:    total time =  2061.91 ms
...
main:     load time =   583.30 ms
main:   sample time =    34.09 ms
main:  predict time =   606.75 ms / 8.67 ms per token
main:    total time =  1228.47 ms
...
main:     n_decoded =      504
main:     load time =   562.98 ms
main:   sample time =   233.12 ms
main:  predict time =  2173.17 ms
main:    total time =  3016.07 ms
...
main: loaded model in   386.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbdc76f9960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbdc757a190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5643be4649f0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbdc76f9010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbdc76fe900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5643be4657b0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbdc757a190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5643be4649f0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5643be466100                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5643be4657b0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbdc76f9010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5643be466a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5643be466100                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5643be4673a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbdc76f9960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5643be466a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5643be467550                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5643be4673a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbdc76fe900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5643be467700                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5643be467550       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1058.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.18 ms
whisper_print_timings:   sample time =    65.97 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    35.76 ms /     1 runs (   35.76 ms per run)
whisper_print_timings:   decode time =    13.81 ms /     2 runs (    6.90 ms per run)
whisper_print_timings:   batchd time =    83.42 ms /   125 runs (    0.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1284.48 ms
...
main:     load time =   525.62 ms
main:    total time =  7816.32 ms
embd_img
...
main:      load time = 17010.50 ms
main:    sample time =   502.65 ms / 7.85 ms per token
main:      eval time = 23794.40 ms / 339.92 ms per token
main:     total time = 42187.66 ms
...
main:      load time =  8602.25 ms
main:    sample time =   511.72 ms / 8.00 ms per token
main:      eval time = 12401.27 ms / 177.16 ms per token
main:     total time = 22161.78 ms
