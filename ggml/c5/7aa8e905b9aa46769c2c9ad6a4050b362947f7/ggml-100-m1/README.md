...
- status:  SUCCESS ✅
- runtime: 326.57
- date:    Thu Dec  7 22:30:29 EET 2023
...
14/20 Test #14: test-customop ....................   Passed    0.23 sec
      Start 15: test-xpos
15/20 Test #15: test-xpos ........................   Passed    0.28 sec
      Start 16: test-conv1d
16/20 Test #16: test-conv1d ......................   Passed    0.31 sec
      Start 17: test-conv2d
17/20 Test #17: test-conv2d ......................   Passed    0.31 sec
...
Total Test time (real) = 143.14 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test-mul-mat2 ....................   Passed    2.44 sec
      Start  8: test0
...
main:  predict time =   300.45 ms / 4.69 ms per token
main:    total time =   464.58 ms
...
main:     load time =    95.00 ms
main:   sample time =     8.82 ms
main:  predict time =   308.48 ms / 4.41 ms per token
main:    total time =   413.14 ms
...
main:     n_decoded =      504
main:     load time =   116.46 ms
main:   sample time =    65.89 ms
main:  predict time =   762.71 ms
main:    total time =   956.19 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x110018210                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x110018fd0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x120008180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x110018210                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x110019920                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x110018fd0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x120187000                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x11001a270                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x110019920                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x11001abc0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x120187950                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x11001a270                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x11001ad70                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x11001abc0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x12018c8f0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x11001af20                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x11001ad70                           node_4
...
whisper_print_timings:     load time =   144.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.35 ms
whisper_print_timings:   sample time =   143.52 ms /   131 runs (    1.10 ms per run)
whisper_print_timings:   encode time =   181.72 ms /     1 runs (  181.72 ms per run)
whisper_print_timings:   decode time =    18.75 ms /     2 runs (    9.38 ms per run)
whisper_print_timings:   batchd time =   203.24 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   701.87 ms
...
main:     load time =    67.71 ms
main:    total time =  5855.91 ms
embd_img
