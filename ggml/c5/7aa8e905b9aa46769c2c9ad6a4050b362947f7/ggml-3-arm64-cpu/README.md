...
- status:  SUCCESS ✅
- runtime: 5:43.66
- date:    Thu Dec  7 08:32:25 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   46.92 sec
...
main:     load time =   279.28 ms
main:   sample time =    17.23 ms
main:  predict time =   811.41 ms / 12.68 ms per token
main:    total time =  1130.53 ms
...
main:  predict time =  5843.14 ms
main:    total time =  6205.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbcd3a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcbbb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae53a0b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbcd3a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbcd3f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae53a1940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcbbb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae53a0b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae53a2290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae53a1940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbcd3a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae53a2be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae53a2290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae53a3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbcd3a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae53a2be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae53a36e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae53a3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbcd3f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae53a3890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae53a36e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   182.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    65.71 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4650.09 ms /     1 runs ( 4650.09 ms per run)
whisper_print_timings:   decode time =    15.19 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   706.04 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5637.65 ms
...
main:     load time =    80.21 ms
main:    total time = 39389.21 ms
embd_img
...
main:      load time = 11608.84 ms
main:    sample time =   532.38 ms / 8.32 ms per token
main:      eval time = 43415.72 ms / 620.22 ms per token
main:     total time = 57927.87 ms
...
main:      load time =  4360.21 ms
main:    sample time =   523.81 ms / 8.18 ms per token
main:      eval time = 17697.00 ms / 252.81 ms per token
main:     total time = 23551.45 ms
