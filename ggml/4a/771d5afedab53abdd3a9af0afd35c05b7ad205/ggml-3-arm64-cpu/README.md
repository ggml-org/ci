...
- status:  SUCCESS ✅
- runtime: 3:51.70
- date:    Fri Oct  6 02:05:47 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/4a771d5afedab53abdd3a9af0afd35c05b7ad205
- author:  Hyunsung Lee
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.75 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.57 sec
      Start  2: test-opt
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.62 sec
...
main:     load time =   180.02 ms
main:   sample time =    17.26 ms
main:  predict time =   807.98 ms / 12.62 ms per token
main:    total time =  1029.81 ms
...
main:     load time =   168.60 ms
main:   sample time =    17.39 ms
main:  predict time =   881.24 ms / 12.59 ms per token
main:    total time =  1072.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96baa8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96a2b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafaf3bac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96ba9fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96baf840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafaf3c850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96a2b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafaf3bac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafaf3d170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafaf3c850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96ba9fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafaf3da90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafaf3d170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafaf3e3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96baa8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafaf3da90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafaf3e530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafaf3e3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96baf840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafaf3e6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafaf3e530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   211.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.13 ms
whisper_print_timings:   sample time =    16.93 ms /    27 runs (    0.63 ms per run)
whisper_print_timings:   encode time =  4601.51 ms /     1 runs ( 4601.51 ms per run)
whisper_print_timings:   decode time =   173.19 ms /    27 runs (    6.41 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5069.08 ms
```
### mpt
...
main:      load time =  7461.38 ms
main:    sample time =   514.95 ms / 8.05 ms per token
main:      eval time = 43647.29 ms / 623.53 ms per token
main:     total time = 53996.82 ms
...
main:      load time =  2538.89 ms
main:    sample time =   521.16 ms / 8.14 ms per token
main:      eval time = 17553.06 ms / 250.76 ms per token
main:     total time = 21573.00 ms
