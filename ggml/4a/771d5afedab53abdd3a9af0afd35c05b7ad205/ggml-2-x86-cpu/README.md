...
- status:  SUCCESS ✅
- runtime: 2:57.19
- date:    Fri Oct  6 14:04:48 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.92 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.81 sec
      Start  2: test-opt
...
main:     load time =   204.11 ms
main:   sample time =    23.97 ms
main:  predict time =   472.05 ms / 7.38 ms per token
main:    total time =   715.75 ms
...
main:  predict time =   488.49 ms / 6.98 ms per token
main:    total time =   661.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f66562578d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f66560d8160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5650694bdac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6656256fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f665625c840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5650694be850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f66560d8160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5650694bdac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5650694bf170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5650694be850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6656256fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5650694bfa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5650694bf170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5650694c03b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f66562578d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5650694bfa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5650694c0530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5650694c03b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f665625c840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5650694c06b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5650694c0530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   142.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.76 ms
whisper_print_timings:   sample time =    16.63 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  1196.65 ms /     1 runs ( 1196.65 ms per run)
whisper_print_timings:   decode time =   104.18 ms /    27 runs (    3.86 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1518.21 ms
```
### mpt
...
main:      load time = 11916.69 ms
main:    sample time =   465.77 ms / 7.28 ms per token
main:      eval time = 21862.74 ms / 312.32 ms per token
main:     total time = 34930.71 ms
...
main:      load time =  4370.50 ms
main:    sample time =   459.08 ms / 7.17 ms per token
main:      eval time =  8744.82 ms / 124.93 ms per token
main:     total time = 13958.14 ms
