...
- status:  SUCCESS ✅
- runtime: 5:30.41
- date:    Fri Oct  6 14:07:20 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.66 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.08 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.23 sec
      Start 10: test3
...
main:     load time =  1246.31 ms
main:   sample time =    34.93 ms
main:  predict time =   547.26 ms / 8.55 ms per token
main:    total time =  1851.35 ms
...
main:     load time =   197.70 ms
main:   sample time =    35.26 ms
main:  predict time =   646.16 ms / 9.23 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f463698b8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f463680c160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5630da76cac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f463698afb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4636990840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5630da76d850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f463680c160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5630da76cac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5630da76e170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5630da76d850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f463698afb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5630da76ea90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5630da76e170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5630da76f3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f463698b8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5630da76ea90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5630da76f530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5630da76f3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4636990840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5630da76f6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5630da76f530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   741.69 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.98 ms
whisper_print_timings:   sample time =    20.74 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  1854.34 ms /     1 runs ( 1854.34 ms per run)
whisper_print_timings:   decode time =   135.36 ms /    27 runs (    5.01 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2835.70 ms
```
### mpt
...
main:      load time =  6864.58 ms
main:    sample time =   573.86 ms / 8.97 ms per token
main:      eval time = 24621.82 ms / 351.74 ms per token
main:     total time = 32957.99 ms
...
main:      load time =  1672.77 ms
main:    sample time =   578.55 ms / 9.04 ms per token
main:      eval time = 12156.21 ms / 173.66 ms per token
main:     total time = 15066.09 ms
