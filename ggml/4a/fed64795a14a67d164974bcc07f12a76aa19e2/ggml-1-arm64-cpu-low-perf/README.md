...
- status:  SUCCESS ✅
- runtime: 4:06.69
- date:    Wed Mar 27 11:46:27 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.62 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.66 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   17.38 sec
      Start  3: test-quantize-perf
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.80 sec
      Start  9: test3
...
main:     load time =   166.00 ms
main:   sample time =    17.97 ms
main:  predict time =   915.67 ms / 14.31 ms per token
main:    total time =  1121.72 ms
...
main:     load time =   164.12 ms
main:   sample time =    18.14 ms
main:  predict time =  1007.01 ms / 14.39 ms per token
main:    total time =  1192.25 ms
...
main:  predict time =  1026.44 ms / 14.66 ms per token
main:    total time =  1240.89 ms
...
main:     n_decoded =      504
main:     load time =   164.84 ms
main:   sample time =   129.02 ms
main:  predict time =  6493.27 ms
main:    total time =  6885.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb930a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb918b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab25b11ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb930a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb930f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab25b12ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb918b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab25b11ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab25b13410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab25b12ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb930a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab25b13d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab25b13410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab25b146d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb930a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab25b13d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab25b14890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab25b146d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb930f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab25b14a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab25b14890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.19 ms
whisper_print_timings:   sample time =    66.32 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4719.48 ms /     1 runs ( 4719.48 ms per run)
whisper_print_timings:   decode time =    15.72 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   715.25 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5651.47 ms
