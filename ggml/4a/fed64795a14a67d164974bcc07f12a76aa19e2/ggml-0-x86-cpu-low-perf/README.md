...
- status:  SUCCESS ✅
- runtime: 3:30.77
- date:    Wed Mar 27 11:45:47 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.47 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.61 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.29 sec
      Start  9: test3
...
main:  predict time =   724.69 ms / 11.32 ms per token
...
main:     load time =   109.90 ms
main:   sample time =    23.51 ms
main:  predict time =   748.07 ms / 10.69 ms per token
main:    total time =   883.61 ms
...
main:  predict time =   762.91 ms / 10.90 ms per token
main:    total time =   922.87 ms
...
main:     n_decoded =      504
main:     load time =   107.83 ms
main:   sample time =   175.26 ms
main:  predict time =  3147.86 ms
main:    total time =  3477.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff1065a4990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff1064251a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562042f56ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff1065a4030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff1065a9940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562042f57ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff1064251a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562042f56ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562042f58410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562042f57ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff1065a4030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562042f58d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562042f58410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562042f596d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff1065a4990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562042f58d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562042f59890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562042f596d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff1065a9940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562042f59a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562042f59890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.62 ms
whisper_print_timings:   sample time =    72.04 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2061.70 ms /     1 runs ( 2061.70 ms per run)
whisper_print_timings:   decode time =    16.81 ms /     2 runs (    8.41 ms per run)
whisper_print_timings:   batchd time =   342.99 ms /   125 runs (    2.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2595.08 ms
...
main:     load time =    69.83 ms
main:    total time = 19495.66 ms
embd_img
