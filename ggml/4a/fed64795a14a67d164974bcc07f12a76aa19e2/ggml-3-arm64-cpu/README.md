...
- status:  SUCCESS ✅
- runtime: 3:11.60
- date:    Wed Mar 27 11:45:37 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   20.49 sec
...
main:  predict time =   894.98 ms / 13.98 ms per token
main:    total time =  1086.06 ms
...
main:  predict time =   974.07 ms / 13.92 ms per token
main:    total time =  1147.16 ms
...
main:     load time =   174.85 ms
main:   sample time =    17.59 ms
main:  predict time =  1015.80 ms / 14.51 ms per token
main:    total time =  1211.61 ms
...
main:   sample time =   128.95 ms
main:  predict time =  6421.77 ms
main:    total time =  6788.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff833ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8326b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafda87ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff833ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff833ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafda88ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8326b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafda87ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafda89410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaafda88ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff833ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafda89d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaafda89410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafda8a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff833ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaafda89d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafda8a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaafda8a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff833ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaafda8aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaafda8a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.97 ms
whisper_print_timings:   sample time =    65.11 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4689.96 ms /     1 runs ( 4689.96 ms per run)
whisper_print_timings:   decode time =    15.31 ms /     2 runs (    7.66 ms per run)
whisper_print_timings:   batchd time =   710.00 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5607.46 ms
...
main:     load time =    92.16 ms
main:    total time = 39771.68 ms
embd_img
