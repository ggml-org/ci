...
- status:  SUCCESS ✅
- runtime: 2:09.73
- date:    Wed Mar 27 11:44:36 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   15.90 sec
...
main:  predict time =   494.74 ms / 7.73 ms per token
main:    total time =   636.92 ms
...
main:     load time =   110.05 ms
main:   sample time =    23.44 ms
main:  predict time =   514.58 ms / 7.35 ms per token
main:    total time =   650.24 ms
...
main:  predict time =   526.03 ms / 7.51 ms per token
main:    total time =   677.90 ms
...
main:   sample time =   174.90 ms
main:  predict time =  1826.37 ms
main:    total time =  2136.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4daf3e6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4daf2671a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c954f1ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4daf3e6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4daf3eb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c954f1bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4daf2671a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c954f1ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c954f1c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c954f1bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4daf3e6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c954f1cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c954f1c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c954f1d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4daf3e6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c954f1cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c954f1d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c954f1d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4daf3eb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c954f1da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c954f1d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.23 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.75 ms
whisper_print_timings:   sample time =    55.22 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1194.46 ms /     1 runs ( 1194.46 ms per run)
whisper_print_timings:   decode time =    11.94 ms /     2 runs (    5.97 ms per run)
whisper_print_timings:   batchd time =   213.06 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1569.52 ms
...
main:     load time =    70.20 ms
main:    total time = 10730.20 ms
embd_img
