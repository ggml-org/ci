...
- status:  SUCCESS ✅
- runtime: 3:02.22
- date:    Fri Nov 17 08:31:07 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    3.23 sec
      Start  2: test-opt
...
main:     load time =   176.93 ms
main:   sample time =    23.73 ms
main:  predict time =   435.85 ms / 6.81 ms per token
main:    total time =   649.17 ms
...
main:  predict time =   443.08 ms / 6.33 ms per token
main:    total time =   592.58 ms
...
main:   sample time =   175.53 ms
main:  predict time =  1491.92 ms
main:    total time =  1802.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f723e79b960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f723e61c190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5602e708eb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f723e79b010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f723e7a0900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5602e708f940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f723e61c190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5602e708eb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5602e7090290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5602e708f940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f723e79b010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5602e7090be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5602e7090290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5602e7091530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f723e79b960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5602e7090be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5602e70916e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5602e7091530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f723e7a0900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5602e7091890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5602e70916e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   128.43 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.39 ms
whisper_print_timings:   sample time =    53.28 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1136.80 ms /     1 runs ( 1136.80 ms per run)
whisper_print_timings:   decode time =     9.21 ms /     2 runs (    4.61 ms per run)
whisper_print_timings:   batchd time =   201.35 ms /   125 runs (    1.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1546.76 ms
...
main:     load time =    63.71 ms
main:    total time = 10400.96 ms
embd_img
...
main:      load time =  5706.18 ms
main:    sample time =   472.14 ms / 7.38 ms per token
main:      eval time = 20509.80 ms / 293.00 ms per token
main:     total time = 27354.73 ms
...
main:      load time =  1355.14 ms
main:    sample time =   468.49 ms / 7.32 ms per token
main:      eval time =  8902.32 ms / 127.18 ms per token
main:     total time = 11078.03 ms
