...
- status:  SUCCESS ✅
- runtime: 2:03.92
- date:    Fri Nov 17 08:16:39 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.42 sec
...
main:  predict time =   605.86 ms / 9.47 ms per token
main:    total time =   768.63 ms
...
main:  predict time =   624.72 ms / 8.92 ms per token
main:    total time =   774.45 ms
...
main:   sample time =   175.59 ms
main:  predict time =  2363.11 ms
main:    total time =  2687.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4ad262f960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4ad24b0190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5647ba13bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4ad262f010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4ad2634900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5647ba13c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4ad24b0190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5647ba13bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5647ba13d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5647ba13c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4ad262f010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5647ba13dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5647ba13d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5647ba13e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4ad262f960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5647ba13dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5647ba13e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5647ba13e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4ad2634900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5647ba13e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5647ba13e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.83 ms
whisper_print_timings:   sample time =    70.46 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1992.80 ms /     1 runs ( 1992.80 ms per run)
whisper_print_timings:   decode time =    12.44 ms /     2 runs (    6.22 ms per run)
whisper_print_timings:   batchd time =   322.70 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.48 ms
