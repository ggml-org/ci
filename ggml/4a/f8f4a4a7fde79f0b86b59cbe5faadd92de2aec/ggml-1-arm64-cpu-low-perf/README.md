...
- status:  SUCCESS ✅
- runtime: 2:38.07
- date:    Fri Nov 17 08:17:16 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    5.06 sec
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.84 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/17 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/17 Test  #8: test2 ............................   Passed    8.04 sec
      Start  9: test3
...
main:     load time =   189.04 ms
main:   sample time =    17.75 ms
main:  predict time =   820.88 ms / 12.83 ms per token
main:    total time =  1049.65 ms
...
main:     load time =   189.42 ms
main:   sample time =    17.48 ms
main:  predict time =  1027.23 ms / 14.67 ms per token
main:    total time =  1236.98 ms
...
main:     n_decoded =      504
main:     load time =   165.76 ms
main:   sample time =   127.95 ms
main:  predict time =  5988.08 ms
main:    total time =  6364.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa879a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa861b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacc09bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa879a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa879f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacc09c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa861b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacc09bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacc09d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacc09c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa879a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacc09dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacc09d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacc09e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa879a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacc09dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacc09e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacc09e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa879f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaacc09e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacc09e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    13.49 ms
whisper_print_timings:   sample time =    66.18 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4788.71 ms /     1 runs ( 4788.71 ms per run)
whisper_print_timings:   decode time =    16.05 ms /     2 runs (    8.03 ms per run)
whisper_print_timings:   batchd time =   716.41 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5719.36 ms
