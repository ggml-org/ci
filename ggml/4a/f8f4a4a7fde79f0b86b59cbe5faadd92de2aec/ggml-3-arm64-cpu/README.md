...
- status:  SUCCESS ✅
- runtime: 4:50.37
- date:    Fri Nov 17 08:53:29 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/17 Test  #4: test-mul-mat0 ....................   Passed    0.58 sec
...
main:     load time =   243.18 ms
main:   sample time =    17.33 ms
main:  predict time =   808.77 ms / 12.64 ms per token
main:    total time =  1092.35 ms
...
main:  predict time =   879.90 ms / 12.57 ms per token
main:    total time =  1075.26 ms
...
main:     n_decoded =      504
main:     load time =   146.11 ms
main:   sample time =   128.29 ms
main:  predict time =  5827.29 ms
main:    total time =  6182.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9afaa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ae2b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6f0bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9afaa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9afaf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6f0c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ae2b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6f0bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6f0d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad6f0c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9afaa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6f0dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad6f0d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad6f0e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9afaa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad6f0dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6f0e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad6f0e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9afaf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad6f0e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad6f0e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   183.92 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.85 ms
whisper_print_timings:   sample time =    69.86 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4634.55 ms /     1 runs ( 4634.55 ms per run)
whisper_print_timings:   decode time =    15.77 ms /     2 runs (    7.89 ms per run)
whisper_print_timings:   batchd time =   711.15 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5632.02 ms
...
main:     load time =    78.33 ms
main:    total time = 39304.72 ms
embd_img
...
main:      load time = 10984.57 ms
main:    sample time =   528.98 ms / 8.27 ms per token
main:      eval time = 43481.14 ms / 621.16 ms per token
main:     total time = 57367.41 ms
...
main:      load time =  4317.33 ms
main:    sample time =   526.49 ms / 8.23 ms per token
main:      eval time = 17781.09 ms / 254.02 ms per token
main:     total time = 23595.99 ms
