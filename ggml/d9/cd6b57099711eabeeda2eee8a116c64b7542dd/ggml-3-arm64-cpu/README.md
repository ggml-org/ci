...
- status:  SUCCESS ✅
- runtime: 5:18.93
- date:    Wed Feb 28 16:45:47 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/20 Test  #3: test-quantize-perf ...............   Passed   10.63 sec
...
20/20 Test #20: test-backend-ops .................   Passed  129.71 sec
...
21/21 Test #21: test-backend-ops .................   Passed   32.36 sec
...
main:     load time =   149.50 ms
main:   sample time =    17.20 ms
main:  predict time =   900.34 ms / 14.07 ms per token
main:    total time =  1088.66 ms
...
main:  predict time =  1009.93 ms / 14.43 ms per token
main:    total time =  1174.75 ms
...
main:     load time =   179.69 ms
main:   sample time =    17.05 ms
main:  predict time =   983.45 ms / 14.05 ms per token
main:    total time =  1183.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbfea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbbe6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac5e14ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbfea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbfef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac5e15ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbbe6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac5e14ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac5e16410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac5e15ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbfea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac5e16d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac5e16410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac5e176d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbfea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac5e16d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac5e17890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac5e176d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbfef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac5e17a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac5e17890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.49 ms
whisper_print_timings:   sample time =    65.48 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4682.73 ms /     1 runs ( 4682.73 ms per run)
whisper_print_timings:   decode time =    15.34 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   709.08 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5592.24 ms
...
main:     load time =    87.98 ms
main:    total time = 39761.98 ms
embd_img
