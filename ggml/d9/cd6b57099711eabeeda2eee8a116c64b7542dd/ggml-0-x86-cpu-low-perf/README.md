...
- status:  SUCCESS ✅
- runtime: 5:15.30
- date:    Wed Feb 28 16:45:38 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.03 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  107.76 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.79 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    6.59 sec
      Start  3: test-quantize-perf
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   25.83 sec
...
main:  predict time =   734.93 ms / 11.48 ms per token
...
main:  predict time =   775.59 ms / 11.08 ms per token
main:    total time =   907.75 ms
...
main:  predict time =   781.25 ms / 11.16 ms per token
main:    total time =   935.25 ms
...
main:  predict time =  3092.17 ms
main:    total time =  3419.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f30b6eea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30b6d6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f1a1ec1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f30b6eea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f30b6eef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f1a1ec2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f30b6d6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f1a1ec1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f1a1ec3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f1a1ec2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f30b6eea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f1a1ec3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f1a1ec3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f1a1ec46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f30b6eea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f1a1ec3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f1a1ec4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f1a1ec46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f30b6eef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f1a1ec4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f1a1ec4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.21 ms
whisper_print_timings:   sample time =    72.07 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2056.62 ms /     1 runs ( 2056.62 ms per run)
whisper_print_timings:   decode time =    16.39 ms /     2 runs (    8.20 ms per run)
whisper_print_timings:   batchd time =   331.66 ms /   125 runs (    2.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2580.80 ms
...
main:     load time =    68.02 ms
main:    total time = 19409.30 ms
embd_img
