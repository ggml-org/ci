...
- status:  SUCCESS ✅
- runtime: 6:20.90
- date:    Wed Feb 28 04:46:40 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.76 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed   13.22 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed   10.05 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.00 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  135.69 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 196.53 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.82 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    7.06 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    4.98 sec
      Start  4: test-mul-mat0
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.45 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   30.30 sec
...
main:     load time =   156.46 ms
main:   sample time =    17.18 ms
main:  predict time =   907.79 ms / 14.18 ms per token
main:    total time =  1103.34 ms
...
main:     load time =   160.06 ms
main:   sample time =    17.52 ms
main:  predict time =  1144.98 ms / 16.36 ms per token
main:    total time =  1325.32 ms
...
main:     load time =   187.69 ms
main:   sample time =    17.48 ms
main:  predict time =  1008.37 ms / 14.41 ms per token
main:    total time =  1216.73 ms
...
main:     n_decoded =      504
main:     load time =   158.23 ms
main:   sample time =   126.94 ms
main:  predict time =  6633.86 ms
main:    total time =  7001.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa56aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa552b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac7050ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa56aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa56af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac7051ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa552b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac7050ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac7052410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac7051ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa56aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac7052d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac7052410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac70536d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa56aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac7052d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac7053890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac70536d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa56af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac7053a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac7053890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.06 ms
whisper_print_timings:   sample time =    65.69 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4827.35 ms /     1 runs ( 4827.35 ms per run)
whisper_print_timings:   decode time =    15.18 ms /     2 runs (    7.59 ms per run)
whisper_print_timings:   batchd time =   712.70 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5748.11 ms
...
main:     load time =    89.23 ms
main:    total time = 40543.55 ms
embd_img
