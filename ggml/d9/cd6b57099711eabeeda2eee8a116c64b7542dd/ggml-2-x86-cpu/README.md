...
- status:  SUCCESS ✅
- runtime: 3:54.39
- date:    Wed Feb 28 16:44:16 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed   12.29 sec
...
20/20 Test #20: test-backend-ops .................   Passed  106.45 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 137.46 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    6.54 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    4.60 sec
...
21/21 Test #21: test-backend-ops .................   Passed   26.52 sec
...
main:  predict time =   494.92 ms / 7.73 ms per token
main:    total time =   638.34 ms
...
main:  predict time =   512.09 ms / 7.32 ms per token
main:    total time =   644.90 ms
...
main:     load time =   128.28 ms
main:   sample time =    23.87 ms
main:  predict time =   523.03 ms / 7.47 ms per token
main:    total time =   677.59 ms
...
main:  predict time =  1844.08 ms
main:    total time =  2156.88 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8912522990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f89123a31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56476ca72ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8912522030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8912527940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56476ca73ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f89123a31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56476ca72ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56476ca74410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56476ca73ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8912522030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56476ca74d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56476ca74410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56476ca756d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8912522990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56476ca74d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56476ca75890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56476ca756d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8912527940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56476ca75a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56476ca75890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.61 ms
whisper_print_timings:   sample time =    54.69 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1193.39 ms /     1 runs ( 1193.39 ms per run)
whisper_print_timings:   decode time =    12.22 ms /     2 runs (    6.11 ms per run)
whisper_print_timings:   batchd time =   212.35 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1570.38 ms
