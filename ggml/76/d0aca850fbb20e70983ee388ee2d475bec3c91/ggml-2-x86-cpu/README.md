...
- status:  SUCCESS ✅
- runtime: 2:40.91
- date:    Thu Sep 28 21:12:37 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    6.62 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.20 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.41 sec
 ...
 6/15 Test  #6: test-mul-mat2 ....................   Passed    2.84 sec
      Start  7: test0
...
main:     load time =   219.33 ms
main:   sample time =    24.13 ms
main:  predict time =   483.06 ms / 7.55 ms per token
main:    total time =   740.24 ms
...
main:     load time =   139.05 ms
main:   sample time =    23.92 ms
main:  predict time =   491.18 ms / 7.02 ms per token
main:    total time =   657.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f952a7908d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f952a611160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561038492ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f952a78ffb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f952a795840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561038493850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f952a611160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561038492ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561038494170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x561038493850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f952a78ffb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561038494a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x561038494170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5610384953b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f952a7908d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x561038494a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561038495530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5610384953b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f952a795840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5610384956b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x561038495530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.47 ms
whisper_print_timings:   sample time =    16.29 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1199.05 ms /     1 runs ( 1199.05 ms per run)
whisper_print_timings:   decode time =   102.93 ms /    27 runs (    3.81 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1494.65 ms
```
### mpt
...
main:      load time =  5855.04 ms
main:    sample time =   473.00 ms / 7.39 ms per token
main:      eval time = 22009.80 ms / 314.43 ms per token
main:     total time = 29045.17 ms
...
main:      load time =  1355.61 ms
main:    sample time =   469.77 ms / 7.34 ms per token
main:      eval time =  8710.01 ms / 124.43 ms per token
main:     total time = 10933.16 ms
