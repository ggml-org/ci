...
- status:  SUCCESS ✅
- runtime: 3:34.51
- date:    Thu Sep 28 09:13:41 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.78 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.46 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.79 sec
      Start  2: test-opt
...
main:     load time =   164.66 ms
main:   sample time =    17.09 ms
main:  predict time =   807.66 ms / 12.62 ms per token
main:    total time =  1013.27 ms
...
main:     load time =   163.07 ms
main:   sample time =    16.96 ms
main:  predict time =   874.50 ms / 12.49 ms per token
main:    total time =  1058.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9efea8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ee6b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8428ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9efe9fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9efef840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8429850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ee6b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8428ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf842a170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8429850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9efe9fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf842aa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf842a170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf842b3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9efea8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf842aa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf842b530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf842b3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9efef840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf842b6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf842b530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   211.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.10 ms
...
whisper_print_timings:   decode time =   171.88 ms /    27 runs (    6.37 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5049.83 ms
```
### mpt
...
main:      load time =  5410.25 ms
main:    sample time =   530.23 ms / 8.28 ms per token
main:      eval time = 43455.43 ms / 620.79 ms per token
main:     total time = 51767.21 ms
...
main:      load time =  1435.19 ms
main:    sample time =   523.73 ms / 8.18 ms per token
main:      eval time = 17409.10 ms / 248.70 ms per token
main:     total time = 20325.79 ms
