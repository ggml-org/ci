...
- status:  SUCCESS ✅
- runtime: 3:48.86
- date:    Wed Dec 27 09:44:45 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   26.58 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.43 sec
...
main:     load time =   173.31 ms
main:   sample time =    23.58 ms
main:  predict time =   431.50 ms / 6.74 ms per token
main:    total time =   641.57 ms
...
main:  predict time =   447.97 ms / 6.40 ms per token
main:    total time =   594.98 ms
...
main:  predict time =  1460.05 ms
main:    total time =  1773.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6ea339e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6ea321f1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5625799aeb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6ea339e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6ea33a3940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5625799af960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6ea321f1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5625799aeb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5625799b02c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5625799af960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6ea339e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5625799b0c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5625799b02c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5625799b1580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6ea339e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5625799b0c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5625799b1740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5625799b1580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6ea33a3940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5625799b1900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5625799b1740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.16 ms
whisper_print_timings:   sample time =    54.87 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.02 ms /     1 runs ( 1159.02 ms per run)
whisper_print_timings:   decode time =     9.47 ms /     2 runs (    4.74 ms per run)
whisper_print_timings:   batchd time =   208.02 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1572.77 ms
...
main:     load time =    64.14 ms
main:    total time = 10565.72 ms
embd_img
...
main:      load time =  5568.34 ms
main:    sample time =   465.97 ms / 7.28 ms per token
main:      eval time = 20632.58 ms / 294.75 ms per token
main:     total time = 27346.49 ms
...
main:      load time =  1291.52 ms
main:    sample time =   466.73 ms / 7.29 ms per token
main:      eval time =  8056.25 ms / 115.09 ms per token
main:     total time = 10168.40 ms
