...
- status:  SUCCESS ✅
- runtime: 7:36.03
- date:    Wed Dec 27 09:48:38 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 9/19 Test  #9: test3 ............................   Passed    1.11 sec
      Start 10: test-pool
10/19 Test #10: test-pool ........................   Passed    0.72 sec
...
19/19 Test #19: test-backend-ops .................   Passed   60.36 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/20 Test  #5: test-mul-mat0 ....................   Passed    1.12 sec
...
20/20 Test #20: test-backend-ops .................   Passed   21.28 sec
...
main:     load time =   591.56 ms
main:   sample time =    33.81 ms
main:  predict time =   563.07 ms / 8.80 ms per token
main:    total time =  1212.29 ms
...
main:     load time =   578.66 ms
main:   sample time =    41.11 ms
main:  predict time =   669.40 ms / 9.56 ms per token
main:    total time =  1294.25 ms
...
main:     n_decoded =      504
main:     load time =   523.82 ms
main:   sample time =   233.87 ms
main:  predict time =  2172.91 ms
main:    total time =  2978.43 ms
...
main: loaded model in   408.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd30e5b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd30e4371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5576de1bdd70                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd30e5b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd30e5bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5576de1beb40                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd30e4371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5576de1bdd70                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5576de1bf4a0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5576de1beb40                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd30e5b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5576de1bfe00                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5576de1bf4a0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576de1c0760                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd30e5b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5576de1bfe00                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5576de1c0920                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576de1c0760                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd30e5bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5576de1c0ae0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5576de1c0920       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   508.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.40 ms
whisper_print_timings:   sample time =    66.62 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    33.42 ms /     1 runs (   33.42 ms per run)
whisper_print_timings:   decode time =    13.17 ms /     2 runs (    6.59 ms per run)
whisper_print_timings:   batchd time =    79.80 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   728.65 ms
...
main:     load time =   482.03 ms
main:    total time =  7847.74 ms
embd_img
...
main:      load time =  7627.20 ms
main:    sample time =   528.06 ms / 8.25 ms per token
main:      eval time = 24979.08 ms / 356.84 ms per token
main:     total time = 33988.83 ms
...
main:      load time =  2154.22 ms
main:    sample time =   537.61 ms / 8.40 ms per token
main:      eval time = 12185.43 ms / 174.08 ms per token
main:     total time = 15542.29 ms
