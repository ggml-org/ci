...
- status:  SUCCESS ✅
- runtime: 5:26.22
- date:    Wed Dec 27 09:46:28 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.61 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   34.52 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.10 sec
      Start  2: test-opt
 ...
 8/20 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    0.11 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   10.07 sec
...
main:     load time =   173.53 ms
main:   sample time =    17.09 ms
main:  predict time =   810.06 ms / 12.66 ms per token
main:    total time =  1022.36 ms
...
main:     load time =   179.10 ms
main:   sample time =    16.83 ms
main:  predict time =   880.08 ms / 12.57 ms per token
...
main:     n_decoded =      504
main:     load time =   149.91 ms
main:   sample time =   127.05 ms
main:  predict time =  5885.90 ms
main:    total time =  6243.97 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd09a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcf1b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadfc75b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd09a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd09f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadfc76960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcf1b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadfc75b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadfc772c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadfc76960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd09a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadfc77c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadfc772c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadfc78580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd09a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadfc77c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadfc78740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadfc78580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd09f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadfc78900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadfc78740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   187.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.36 ms
whisper_print_timings:   sample time =    65.32 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4667.70 ms /     1 runs ( 4667.70 ms per run)
whisper_print_timings:   decode time =    15.13 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   708.70 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5662.55 ms
...
main:     load time =    86.10 ms
main:    total time = 39546.40 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.231000 sec.)
...
main:      load time =  5901.71 ms
main:    sample time =   521.93 ms / 8.16 ms per token
main:      eval time = 43545.90 ms / 622.08 ms per token
main:     total time = 52343.40 ms
...
main:      load time =  1568.54 ms
main:    sample time =   516.03 ms / 8.06 ms per token
main:      eval time = 16907.22 ms / 241.53 ms per token
main:     total time = 19947.95 ms
