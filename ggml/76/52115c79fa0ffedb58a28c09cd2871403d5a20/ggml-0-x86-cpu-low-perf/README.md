...
- status:  SUCCESS ✅
- runtime: 3:21.53
- date:    Thu Mar 14 16:50:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.85 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   13.22 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.55 sec
      Start  4: test-mul-mat0
...
main:  predict time =   730.76 ms / 11.42 ms per token
main:    total time =   877.96 ms
...
main:  predict time =   759.91 ms / 10.86 ms per token
main:    total time =   896.63 ms
...
main:  predict time =   772.50 ms / 11.04 ms per token
main:    total time =   928.08 ms
...
main:     n_decoded =      504
main:     load time =   108.86 ms
main:   sample time =   176.06 ms
main:  predict time =  3139.87 ms
main:    total time =  3472.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd29c366990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd29c1e71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d153be5ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd29c366030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd29c36b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d153be6ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd29c1e71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d153be5ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d153be7410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d153be6ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd29c366030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d153be7d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d153be7410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d153be86d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd29c366990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d153be7d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d153be8890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d153be86d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd29c36b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d153be8a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d153be8890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    80.31 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.64 ms
whisper_print_timings:   sample time =    73.09 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2079.40 ms /     1 runs ( 2079.40 ms per run)
whisper_print_timings:   decode time =    17.86 ms /     2 runs (    8.93 ms per run)
whisper_print_timings:   batchd time =   335.29 ms /   125 runs (    2.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2612.53 ms
