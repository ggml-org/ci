...
- status:  SUCCESS ✅
- runtime: 2:59.41
- date:    Thu Mar 14 16:50:14 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/7652115c79fa0ffedb58a28c09cd2871403d5a20
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.02 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   26.58 sec
...
main:     load time =   144.91 ms
main:   sample time =    17.38 ms
main:  predict time =   892.98 ms / 13.95 ms per token
main:    total time =  1076.93 ms
...
main:     load time =   150.83 ms
main:   sample time =    17.04 ms
main:  predict time =   977.13 ms / 13.96 ms per token
main:    total time =  1147.85 ms
...
main:  predict time =   984.71 ms / 14.07 ms per token
main:    total time =  1183.40 ms
...
main:  predict time =  6503.32 ms
main:    total time =  6864.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7dba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7c3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabcccdce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7dba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7dbf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabccceab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa7c3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabcccdce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabcccf410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabccceab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7dba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabcccfd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabcccf410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabccd06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa7dba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabcccfd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabccd0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabccd06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa7dbf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaabccd0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabccd0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.38 ms
whisper_print_timings:   sample time =    65.57 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4686.90 ms /     1 runs ( 4686.90 ms per run)
whisper_print_timings:   decode time =    15.46 ms /     2 runs (    7.73 ms per run)
whisper_print_timings:   batchd time =   709.26 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5599.14 ms
