...
- status:  SUCCESS ✅
- runtime: 2:00.66
- date:    Thu Mar 14 16:49:16 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   24.35 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   13.23 sec
...
main:  predict time =   497.30 ms / 7.77 ms per token
main:    total time =   696.59 ms
...
main:  predict time =   535.15 ms / 7.65 ms per token
main:    total time =   687.33 ms
...
main:   sample time =   175.18 ms
main:  predict time =  1859.37 ms
main:    total time =  2169.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f862cf41990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f862cdc21a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5608d73c7ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f862cf41030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f862cf46940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5608d73c8ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f862cdc21a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5608d73c7ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5608d73c9410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5608d73c8ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f862cf41030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5608d73c9d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5608d73c9410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5608d73ca6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f862cf41990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5608d73c9d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5608d73ca890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5608d73ca6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f862cf46940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5608d73caa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5608d73ca890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.92 ms
whisper_print_timings:   sample time =    55.19 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1193.05 ms /     1 runs ( 1193.05 ms per run)
whisper_print_timings:   decode time =    12.33 ms /     2 runs (    6.17 ms per run)
whisper_print_timings:   batchd time =   215.40 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1600.42 ms
