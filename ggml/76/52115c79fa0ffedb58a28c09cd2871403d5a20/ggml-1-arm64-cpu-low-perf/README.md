...
- status:  SUCCESS ✅
- runtime: 3:55.78
- date:    Thu Mar 14 04:50:59 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.90 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   26.60 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    3.66 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   13.79 sec
      Start  3: test-quantize-perf
...
main:     load time =   166.99 ms
main:   sample time =    18.00 ms
main:  predict time =   943.98 ms / 14.75 ms per token
main:    total time =  1151.40 ms
...
main:  predict time =  1000.32 ms / 14.29 ms per token
main:    total time =  1186.25 ms
...
main:     load time =   196.03 ms
main:   sample time =    18.00 ms
main:  predict time =  1048.12 ms / 14.97 ms per token
main:    total time =  1266.48 ms
...
main:     n_decoded =      504
main:     load time =   162.80 ms
main:   sample time =   128.36 ms
main:  predict time =  6537.47 ms
main:    total time =  6922.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb824a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb80cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4e9bce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb824a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb824f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac4e9cab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb80cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4e9bce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac4e9d410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac4e9cab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb824a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac4e9dd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac4e9d410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac4e9e6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb824a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac4e9dd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac4e9e890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac4e9e6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb824f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac4e9ea50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac4e9e890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.84 ms
whisper_print_timings:   sample time =    66.94 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4734.49 ms /     1 runs ( 4734.49 ms per run)
whisper_print_timings:   decode time =    18.80 ms /     2 runs (    9.40 ms per run)
whisper_print_timings:   batchd time =   717.45 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5669.73 ms
