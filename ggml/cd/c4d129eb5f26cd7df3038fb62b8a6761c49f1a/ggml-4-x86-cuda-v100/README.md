...
- status:  SUCCESS ✅
- runtime: 8:22.73
- date:    Sat Dec 23 16:09:36 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.70 sec
      Start  2: test-quantize-fns
 2/19 Test  #2: test-quantize-fns ................   Passed    0.57 sec
      Start  3: test-quantize-perf
 3/19 Test  #3: test-quantize-perf ...............   Passed    0.79 sec
      Start  4: test-mul-mat0
 4/19 Test  #4: test-mul-mat0 ....................   Passed    1.17 sec
      Start  5: test-mul-mat2
 5/19 Test  #5: test-mul-mat2 ....................   Passed    7.99 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   59.74 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  92.11 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.69 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed   22.87 sec
...
main:     load time =   582.96 ms
main:   sample time =    39.59 ms
main:  predict time =   553.56 ms / 8.65 ms per token
main:    total time =  1200.41 ms
...
main:     load time =   574.34 ms
main:   sample time =    36.16 ms
main:  predict time =   598.06 ms / 8.54 ms per token
main:    total time =  1212.76 ms
...
main:     n_decoded =      504
main:     load time =   554.36 ms
main:   sample time =   232.62 ms
main:  predict time =  2168.19 ms
main:    total time =  2999.35 ms
...
main: loaded model in   401.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa6843b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa6842371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5555c6e8a530                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa6843b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa6843bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5555c6e8b300                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa6842371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5555c6e8a530                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5555c6e8bc60                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5555c6e8b300                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa6843b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5555c6e8c5c0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5555c6e8bc60                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5555c6e8cf20                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa6843b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5555c6e8c5c0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5555c6e8d0e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5555c6e8cf20                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa6843bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5555c6e8d2a0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5555c6e8d0e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1105.71 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.93 ms
whisper_print_timings:   sample time =    66.55 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    33.93 ms /     1 runs (   33.93 ms per run)
whisper_print_timings:   decode time =    13.54 ms /     2 runs (    6.77 ms per run)
whisper_print_timings:   batchd time =    80.84 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1328.18 ms
...
main:     load time =   503.46 ms
main:    total time =  7884.84 ms
embd_img
...
main:      load time =  8127.26 ms
main:    sample time =   543.36 ms / 8.49 ms per token
main:      eval time = 24659.46 ms / 352.28 ms per token
main:     total time = 34257.23 ms
...
main:      load time =  2062.32 ms
main:    sample time =   541.89 ms / 8.47 ms per token
main:      eval time = 12138.58 ms / 173.41 ms per token
main:     total time = 15401.33 ms
