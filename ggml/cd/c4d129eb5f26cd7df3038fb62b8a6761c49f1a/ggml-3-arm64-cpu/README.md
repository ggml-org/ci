...
- status:  SUCCESS ✅
- runtime: 5:40.03
- date:    Sat Dec 23 04:08:34 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.06 sec
...
20/20 Test #20: test-backend-ops .................   Passed    9.98 sec
...
main:     load time =   212.14 ms
main:   sample time =    16.95 ms
main:  predict time =   811.14 ms / 12.67 ms per token
main:    total time =  1062.16 ms
...
main:     load time =   173.28 ms
main:   sample time =    16.92 ms
main:  predict time =   880.52 ms / 12.58 ms per token
main:    total time =  1073.58 ms
...
main:   sample time =   128.11 ms
main:  predict time =  5899.49 ms
main:    total time =  6252.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96e4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96ccb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab095e9b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96e4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96e4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab095ea960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96ccb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab095e9b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab095eb2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab095ea960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96e4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab095ebc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab095eb2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab095ec580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96e4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab095ebc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab095ec740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab095ec580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96e4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab095ec900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab095ec740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   172.53 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.88 ms
whisper_print_timings:   sample time =    65.04 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4657.89 ms /     1 runs ( 4657.89 ms per run)
whisper_print_timings:   decode time =    15.81 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   708.30 ms /   125 runs (    5.67 ms per run)
...
main:     load time =    78.84 ms
main:    total time = 39541.48 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.230000 sec.)
...
main:      load time = 12356.35 ms
main:    sample time =   519.34 ms / 8.11 ms per token
main:      eval time = 43497.09 ms / 621.39 ms per token
main:     total time = 58747.48 ms
...
main:      load time =  4352.49 ms
main:    sample time =   512.35 ms / 8.01 ms per token
main:      eval time = 17642.64 ms / 252.04 ms per token
main:     total time = 23500.62 ms
