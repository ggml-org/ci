...
- status:  SUCCESS ✅
- runtime: 2:49.64
- date:    Sat Dec 23 16:00:53 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.19 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   34.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.25 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.85 sec
...
main:     load time =   126.34 ms
main:   sample time =    23.45 ms
main:  predict time =   601.82 ms / 9.40 ms per token
main:    total time =   764.28 ms
...
main:  predict time =   630.89 ms / 9.01 ms per token
main:    total time =   787.68 ms
...
main:     n_decoded =      504
main:     load time =   107.64 ms
main:   sample time =   177.90 ms
main:  predict time =  2374.82 ms
main:    total time =  2705.28 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb7e7082990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb7e6f031a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5619e3e84b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb7e7082030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb7e7087940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5619e3e85960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb7e6f031a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5619e3e84b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5619e3e862c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5619e3e85960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb7e7082030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5619e3e86c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5619e3e862c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5619e3e87580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb7e7082990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5619e3e86c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5619e3e87740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5619e3e87580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb7e7087940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5619e3e87900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5619e3e87740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.31 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.10 ms
whisper_print_timings:   sample time =    71.41 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1993.01 ms /     1 runs ( 1993.01 ms per run)
whisper_print_timings:   decode time =    14.51 ms /     2 runs (    7.25 ms per run)
whisper_print_timings:   batchd time =   332.50 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2513.05 ms
