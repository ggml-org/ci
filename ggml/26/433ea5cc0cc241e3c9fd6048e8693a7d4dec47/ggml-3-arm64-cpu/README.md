...
- status:  SUCCESS ✅
- runtime: 5:48.95
- date:    Thu Dec  7 12:54:34 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   47.09 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.21 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed   12.15 sec
...
main:     load time =   185.63 ms
main:   sample time =    17.00 ms
main:  predict time =   876.75 ms / 12.52 ms per token
main:    total time =  1082.20 ms
...
main:  predict time =  5845.72 ms
main:    total time =  6211.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb564a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb54cb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5101b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb564a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb564f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae5102940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb54cb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae5101b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae5103290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae5102940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb564a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae5103be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae5103290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5104530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb564a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae5103be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae51046e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae5104530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb564f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae5104890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae51046e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   184.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.42 ms
whisper_print_timings:   sample time =    65.52 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4653.85 ms /     1 runs ( 4653.85 ms per run)
whisper_print_timings:   decode time =    15.14 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   706.27 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5643.53 ms
...
main:      load time = 12986.94 ms
main:    sample time =   533.21 ms / 8.33 ms per token
main:      eval time = 43471.72 ms / 621.02 ms per token
main:     total time = 59365.19 ms
...
main:      load time =  4357.99 ms
main:    sample time =   523.91 ms / 8.19 ms per token
main:      eval time = 17748.92 ms / 253.56 ms per token
main:     total time = 23602.24 ms
