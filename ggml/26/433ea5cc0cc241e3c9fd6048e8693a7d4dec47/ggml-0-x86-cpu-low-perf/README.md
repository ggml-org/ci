...
- status:  SUCCESS ✅
- runtime: 3:06.83
- date:    Thu Dec  7 12:47:51 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.50 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.03 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   51.30 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  74.90 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.19 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.17 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.60 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  29.12 sec
...
main:  predict time =   643.17 ms / 10.05 ms per token
main:    total time =   810.65 ms
...
main:     load time =   130.64 ms
main:   sample time =    23.52 ms
main:  predict time =   667.51 ms / 9.54 ms per token
main:    total time =   824.31 ms
...
main:  predict time =  2383.42 ms
main:    total time =  2710.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f632c8bf960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f632c740190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ce2c3db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f632c8bf010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f632c8c4900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ce2c3e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f632c740190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ce2c3db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ce2c3f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ce2c3e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f632c8bf010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558ce2c3fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ce2c3f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ce2c40530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f632c8bf960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558ce2c3fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ce2c406e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ce2c40530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f632c8c4900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558ce2c40890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ce2c406e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.93 ms
whisper_print_timings:   sample time =    72.06 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1978.89 ms /     1 runs ( 1978.89 ms per run)
whisper_print_timings:   decode time =    12.33 ms /     2 runs (    6.17 ms per run)
whisper_print_timings:   batchd time =   322.45 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2484.72 ms
...
main:     load time =    70.74 ms
main:    total time = 18949.07 ms
embd_img
