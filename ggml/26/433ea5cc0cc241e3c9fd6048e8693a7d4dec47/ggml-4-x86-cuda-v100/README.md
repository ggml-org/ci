...
- status:  SUCCESS ✅
- runtime: 8:28.34
- date:    Thu Dec  7 12:55:50 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   90.53 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) = 122.48 sec
...
20/20 Test #20: test-backend-ops .................   Passed   22.45 sec
...
main:     load time =   634.92 ms
main:   sample time =    34.82 ms
main:  predict time =   557.41 ms / 8.71 ms per token
main:    total time =  1247.10 ms
...
main:     load time =   462.29 ms
main:   sample time =    37.38 ms
main:  predict time =   599.29 ms / 8.56 ms per token
main:    total time =  1103.02 ms
...
main:     n_decoded =      504
main:     load time =   438.92 ms
main:   sample time =   235.24 ms
main:  predict time =  2228.95 ms
main:    total time =  2948.13 ms
...
main: loaded model in   291.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8409b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa840837190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5582f727a930                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa8409b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa8409bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5582f727b6f0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa840837190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5582f727a930                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5582f727c040                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5582f727b6f0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa8409b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5582f727c990                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5582f727c040                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5582f727d2e0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa8409b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5582f727c990                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5582f727d490                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5582f727d2e0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa8409bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5582f727d640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5582f727d490       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   972.12 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.78 ms
whisper_print_timings:   sample time =    68.76 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    33.65 ms /     1 runs (   33.65 ms per run)
...
whisper_print_timings:    total time =  1197.76 ms
...
main:     load time =   400.35 ms
main:    total time =  7752.65 ms
embd_img
...
main:      load time = 13207.48 ms
main:    sample time =   508.14 ms / 7.94 ms per token
main:      eval time = 23910.40 ms / 341.58 ms per token
main:     total time = 38530.23 ms
...
main:      load time =  5942.07 ms
main:    sample time =   512.84 ms / 8.01 ms per token
main:      eval time = 12326.37 ms / 176.09 ms per token
main:     total time = 19427.27 ms
