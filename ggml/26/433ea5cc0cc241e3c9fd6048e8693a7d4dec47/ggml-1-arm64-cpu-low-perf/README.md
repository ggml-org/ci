...
- status:  SUCCESS ✅
- runtime: 3:48.94
- date:    Thu Dec  7 12:48:36 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.85 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.17 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   55.26 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.86 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.34 sec
      Start  9: test3
...
main:     load time =   192.58 ms
main:   sample time =    17.82 ms
main:  predict time =   847.42 ms / 13.24 ms per token
...
main:     load time =   190.84 ms
main:   sample time =    17.61 ms
main:  predict time =  1050.89 ms / 15.01 ms per token
main:    total time =  1262.20 ms
...
main:     n_decoded =      504
main:     load time =   165.21 ms
main:   sample time =   129.49 ms
main:  predict time =  6066.01 ms
main:    total time =  6442.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffac11a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffabf9b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac399cb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffac11a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffac11f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac399d940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffabf9b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac399cb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac399e290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac399d940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffac11a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac399ebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac399e290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac399f530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffac11a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac399ebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac399f6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac399f530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffac11f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac399f890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac399f6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4743.11 ms /     1 runs ( 4743.11 ms per run)
whisper_print_timings:   decode time =    15.52 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   713.05 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5666.06 ms
