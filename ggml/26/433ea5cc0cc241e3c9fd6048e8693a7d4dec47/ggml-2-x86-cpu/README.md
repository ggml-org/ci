...
- status:  SUCCESS ✅
- runtime: 4:03.10
- date:    Thu Dec  7 12:48:48 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/26433ea5cc0cc241e3c9fd6048e8693a7d4dec47
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.41 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    6.58 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   42.62 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.27 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    1.63 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.68 sec
...
main:     load time =   171.93 ms
main:   sample time =    23.47 ms
main:  predict time =   446.86 ms / 6.98 ms per token
main:    total time =   655.05 ms
...
main:     load time =   127.13 ms
main:   sample time =    23.44 ms
main:  predict time =   448.68 ms / 6.41 ms per token
main:    total time =   601.30 ms
...
main:     n_decoded =      504
main:     load time =   101.92 ms
main:   sample time =   178.10 ms
main:  predict time =  1476.27 ms
main:    total time =  1785.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa064001960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa063e82190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b56d021b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa064001010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa064006900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b56d022940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa063e82190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b56d021b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b56d023290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b56d022940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa064001010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b56d023be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b56d023290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b56d024530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa064001960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b56d023be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b56d0246e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b56d024530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa064006900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b56d024890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b56d0246e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.37 ms
whisper_print_timings:   sample time =    54.55 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1153.70 ms /     1 runs ( 1153.70 ms per run)
whisper_print_timings:   decode time =     9.61 ms /     2 runs (    4.81 ms per run)
whisper_print_timings:   batchd time =   208.49 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1573.96 ms
...
main:     load time =    69.40 ms
main:    total time = 10557.32 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.473000 sec.)
...
main:      load time = 15463.63 ms
main:    sample time =   470.43 ms / 7.35 ms per token
main:      eval time = 20281.85 ms / 289.74 ms per token
main:     total time = 36890.29 ms
...
main:      load time =  4400.72 ms
main:    sample time =   466.70 ms / 7.29 ms per token
main:      eval time =  8051.33 ms / 115.02 ms per token
main:     total time = 13307.34 ms
