...
- status:  SUCCESS ✅
- runtime: 4:38.81
- date:    Tue Sep  5 11:48:29 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.08 sec
      Start  2: test-opt
...
main:     load time =   199.58 ms
main:   sample time =    35.38 ms
main:  predict time =   611.65 ms / 9.56 ms per token
main:    total time =   867.31 ms
...
main:     load time =   193.00 ms
main:   sample time =    35.47 ms
main:  predict time =   640.78 ms / 9.15 ms per token
main:    total time =   874.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fec613188d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fec61199160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564b2d263ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fec61317fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fec6131d840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564b2d264850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fec61199160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564b2d263ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564b2d265170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564b2d264850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fec61317fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564b2d265a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564b2d265170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564b2d2663b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fec613188d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564b2d265a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564b2d266530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564b2d2663b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fec6131d840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564b2d2666b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564b2d266530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6585.69 ms
main:    sample time =   596.04 ms / 9.31 ms per token
main:      eval time = 24472.58 ms / 349.61 ms per token
main:     total time = 32559.66 ms
...
main:      load time =  1793.54 ms
main:    sample time =   589.09 ms / 9.20 ms per token
main:      eval time = 12181.67 ms / 174.02 ms per token
main:     total time = 15207.83 ms
