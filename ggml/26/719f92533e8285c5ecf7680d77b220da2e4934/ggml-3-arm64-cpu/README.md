...
- status:  SUCCESS ✅
- runtime: 3:20.22
- date:    Tue Sep  5 11:45:34 UTC 2023
...
main:  predict time =   815.92 ms / 12.75 ms per token
main:    total time =  1035.84 ms
...
main:  predict time =   876.04 ms / 12.51 ms per token
main:    total time =  1074.51 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb448a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb430b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad002bac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb4489fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb448f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad002c850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb430b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad002bac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad002d170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad002c850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb4489fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad002da90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad002d170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad002e3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb448a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad002da90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad002e530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad002e3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb448f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad002e6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad002e530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5552.43 ms
main:    sample time =   621.82 ms / 9.72 ms per token
main:      eval time = 44253.45 ms / 632.19 ms per token
main:     total time = 52806.68 ms
...
main:      load time =  1612.29 ms
main:    sample time =   617.33 ms / 9.65 ms per token
main:      eval time = 17302.36 ms / 247.18 ms per token
main:     total time = 20489.02 ms
