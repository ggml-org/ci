...
- status:  SUCCESS ✅
- runtime: 2:20.11
- date:    Tue Sep  5 11:43:39 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/26719f92533e8285c5ecf7680d77b220da2e4934
- author:  Yavor Ivanov
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.09 sec
      Start  2: test-opt
...
main:     load time =   129.77 ms
main:   sample time =    23.83 ms
main:  predict time =   435.08 ms / 6.80 ms per token
main:    total time =   602.15 ms
...
main:  predict time =   450.65 ms / 6.44 ms per token
main:    total time =   605.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf31b098d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf3198a160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5556bf1e9ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf31b08fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf31b0e840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5556bf1ea850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf3198a160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5556bf1e9ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5556bf1eb170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5556bf1ea850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf31b08fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5556bf1eba90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5556bf1eb170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5556bf1ec3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf31b098d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5556bf1eba90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5556bf1ec530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5556bf1ec3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf31b0e840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5556bf1ec6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5556bf1ec530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4675.15 ms
main:    sample time =   471.19 ms / 7.36 ms per token
main:      eval time = 19308.25 ms / 275.83 ms per token
main:     total time = 25092.74 ms
...
main:      load time =  1258.11 ms
main:    sample time =   469.01 ms / 7.33 ms per token
main:      eval time =  7967.27 ms / 113.82 ms per token
main:     total time = 10072.54 ms
