...
- status:  SUCCESS ✅
- runtime: 2:10.60
- date:    Sun May 12 09:19:36 UTC 2024
...
main:  predict time =   497.07 ms / 7.77 ms per token
main:    total time =   639.66 ms
...
main:  predict time =   516.21 ms / 7.37 ms per token
main:    total time =   649.16 ms
...
main:  predict time =   531.16 ms / 7.59 ms per token
main:    total time =   684.53 ms
...
main:  predict time =  1818.01 ms
main:    total time =  2132.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7dd6934fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7dd69337b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x638e7a56ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7dd6934fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7dd6934ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x638e7a56bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7dd69337b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x638e7a56ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x638e7a56c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x638e7a56bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7dd6934fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x638e7a56cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x638e7a56c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x638e7a56d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7dd6934fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x638e7a56cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x638e7a56d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x638e7a56d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7dd6934ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x638e7a56da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x638e7a56d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.63 ms
whisper_print_timings:   sample time =   457.70 ms /   131 runs (    3.49 ms per run)
whisper_print_timings:   encode time =  1187.39 ms /     1 runs ( 1187.39 ms per run)
whisper_print_timings:   decode time =    13.09 ms /     2 runs (    6.55 ms per run)
whisper_print_timings:   batchd time =   221.34 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1971.40 ms
