...
- status:  SUCCESS ✅
- runtime: 3:21.08
- date:    Sun May 12 09:20:50 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.90 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.56 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.79 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.17 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   17.50 sec
...
main:     load time =   132.67 ms
main:   sample time =    16.58 ms
main:  predict time =   919.59 ms / 14.37 ms per token
main:    total time =  1094.65 ms
...
main:     load time =   133.32 ms
main:   sample time =    16.67 ms
main:  predict time =   968.17 ms / 13.83 ms per token
main:    total time =  1120.44 ms
...
main:     load time =   158.81 ms
main:   sample time =    16.49 ms
main:  predict time =   988.96 ms / 14.13 ms per token
main:    total time =  1167.02 ms
...
main:     n_decoded =      504
main:     load time =   137.22 ms
main:   sample time =   125.96 ms
main:  predict time =  6404.58 ms
main:    total time =  6749.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe4a9de6aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe4a9de52b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbb3067073ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe4a9de6aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe4a9de6af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbb3067074ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe4a9de52b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbb3067073ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbb3067075410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbb3067074ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe4a9de6aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbb3067075d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbb3067075410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbb30670766d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe4a9de6aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbb3067075d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbb3067076890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbb30670766d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe4a9de6af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbb3067076a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbb3067076890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    92.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.94 ms
whisper_print_timings:   sample time =   695.77 ms /   131 runs (    5.31 ms per run)
whisper_print_timings:   encode time =  4685.37 ms /     1 runs ( 4685.37 ms per run)
whisper_print_timings:   decode time =    15.31 ms /     2 runs (    7.65 ms per run)
whisper_print_timings:   batchd time =   707.49 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6214.26 ms
...
main:     load time =    72.53 ms
main:    total time = 39677.34 ms
embd_img
