...
- status:  SUCCESS ✅
- runtime: 375.75
- date:    Sun May 12 12:22:05 EEST 2024
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 4/23 Test  #4: test-mul-mat0 ....................   Passed    0.40 sec
      Start  5: test-blas0
 5/23 Test  #5: test-blas0 .......................   Passed    0.19 sec
...
14/23 Test #14: test-conv-transpose ..............   Passed    0.19 sec
      Start 15: test-dup
15/23 Test #15: test-dup .........................   Passed    0.18 sec
...
23/23 Test #23: test-backend-ops .................   Passed  111.55 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) = 170.96 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 3/24 Test  #3: test-quantize-fns ................   Passed   20.09 sec
      Start  4: test-quantize-perf
 4/24 Test  #4: test-quantize-perf ...............   Passed    5.77 sec
...
21/24 Test #21: test-conv2d ......................   Passed    0.28 sec
      Start 22: test-mul-mat
22/24 Test #22: test-mul-mat .....................   Passed    0.25 sec
      Start 23: test-backend-buffer
23/24 Test #23: test-backend-buffer ..............   Passed    0.29 sec
      Start 24: test-backend-ops
24/24 Test #24: test-backend-ops .................   Passed   29.24 sec
...
main:     load time =   147.31 ms
main:   sample time =     8.79 ms
main:  predict time =   388.66 ms / 6.07 ms per token
main:    total time =   547.35 ms
...
main:  predict time =   413.28 ms / 5.90 ms per token
main:    total time =   511.59 ms
...
main:     n_decoded =      504
main:     load time =   114.09 ms
main:   sample time =    64.79 ms
main:  predict time =  1389.40 ms
main:    total time =  1579.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x160187980                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x160008190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1602a8220                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x160187020                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x16018c930                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x1602a8ff0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x160008190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x1602a8220                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x1602a9950                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x1602a8ff0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x160187020                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x1602aa2b0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x1602a9950                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x1602aac10                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x160187980                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x1602aa2b0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40      0x1602aadd0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x1602aac10                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x16018c930                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40      0x1602aaf90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40      0x1602aadd0                           node_4
...
whisper_print_timings:     load time =   156.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.29 ms
whisper_print_timings:   sample time =   352.63 ms /   131 runs (    2.69 ms per run)
whisper_print_timings:   encode time =   221.34 ms /     1 runs (  221.34 ms per run)
whisper_print_timings:   decode time =    23.84 ms /     2 runs (   11.92 ms per run)
whisper_print_timings:   batchd time =   204.17 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   973.56 ms
