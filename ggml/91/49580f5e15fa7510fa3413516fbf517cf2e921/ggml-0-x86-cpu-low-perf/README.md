...
- status:  SUCCESS ✅
- runtime: 3:47.97
- date:    Sun May 12 09:21:21 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.79 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.44 sec
      Start  9: test3
...
Total Test time (real) =  74.96 sec
...
Total Test time (real) =  52.20 sec
...
main:     load time =  2476.49 ms
main:   sample time =    23.84 ms
main:  predict time =   698.63 ms / 10.92 ms per token
main:    total time =  3214.72 ms
...
main:  predict time =   740.61 ms / 10.58 ms per token
...
main:   sample time =    23.93 ms
main:  predict time =   749.99 ms / 10.71 ms per token
main:    total time =   899.81 ms
...
main:     n_decoded =      504
main:     load time =   102.15 ms
main:   sample time =   178.04 ms
main:  predict time =  3124.75 ms
main:    total time =  3451.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70abbccfa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70abbcb7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x602bbf08ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70abbccfa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x70abbccff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x602bbf08bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70abbcb7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x602bbf08ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x602bbf08c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x602bbf08bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70abbccfa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x602bbf08cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x602bbf08c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x602bbf08d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70abbccfa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x602bbf08cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x602bbf08d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x602bbf08d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x70abbccff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x602bbf08da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x602bbf08d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   881.50 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.96 ms
whisper_print_timings:   sample time =   593.70 ms /   131 runs (    4.53 ms per run)
whisper_print_timings:   encode time =  2058.93 ms /     1 runs ( 2058.93 ms per run)
whisper_print_timings:   decode time =    15.55 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   333.69 ms /   125 runs (    2.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  3910.14 ms
...
main:     load time =    63.66 ms
main:    total time = 19350.06 ms
embd_img
