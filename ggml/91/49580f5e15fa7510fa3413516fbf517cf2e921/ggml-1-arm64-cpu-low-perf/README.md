...
- status:  SUCCESS ✅
- runtime: 4:14.46
- date:    Sun May 12 09:21:45 UTC 2024
...
main:     load time =  1437.93 ms
main:   sample time =    16.91 ms
main:  predict time =   903.52 ms / 14.12 ms per token
main:    total time =  2382.34 ms
...
main:     load time =   133.53 ms
main:   sample time =    16.58 ms
main:  predict time =   982.36 ms / 14.03 ms per token
main:    total time =  1134.99 ms
...
main:  predict time =  1007.08 ms / 14.39 ms per token
main:    total time =  1187.15 ms
...
main:  predict time =  6506.08 ms
main:    total time =  6846.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf29e8c60a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf29e8c48b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xad2be96f1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf29e8c60a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf29e8c60f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xad2be96f2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf29e8c48b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xad2be96f1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xad2be96f3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xad2be96f2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf29e8c60a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xad2be96f3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xad2be96f3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xad2be96f46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf29e8c60a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xad2be96f3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xad2be96f4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xad2be96f46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf29e8c60f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xad2be96f4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xad2be96f4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   950.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.03 ms
whisper_print_timings:   sample time =   690.76 ms /   131 runs (    5.27 ms per run)
whisper_print_timings:   encode time =  4695.04 ms /     1 runs ( 4695.04 ms per run)
whisper_print_timings:   decode time =    15.68 ms /     2 runs (    7.84 ms per run)
whisper_print_timings:   batchd time =   715.70 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  7085.68 ms
...
main:     load time =    74.85 ms
main:    total time = 39792.08 ms
embd_img
