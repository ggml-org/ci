...
- status:  SUCCESS ✅
- runtime: 1:45.10
- date:    Tue Dec 10 15:21:19 UTC 2024
...
main:  predict time =   474.89 ms / 6.78 ms per token
...
main:   sample time =    28.34 ms
main:  predict time =   490.56 ms / 7.01 ms per token
main:    total time =   647.20 ms
...
main:   sample time =   185.29 ms
main:  predict time =  1611.18 ms
main:    total time =  1937.56 ms
