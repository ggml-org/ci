...
- status:  SUCCESS ✅
- runtime: 3:28.21
- date:    Wed Mar 27 09:52:58 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.05 sec
      Start  9: test3
...
main:  predict time =   711.76 ms / 11.12 ms per token
main:    total time =   855.56 ms
...
main:  predict time =   750.59 ms / 10.72 ms per token
main:    total time =   882.60 ms
...
main:  predict time =   777.04 ms / 11.10 ms per token
main:    total time =   933.75 ms
...
main:  predict time =  3143.74 ms
main:    total time =  3473.33 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f75679d6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f75678571a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d5e2a71ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f75679d6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f75679db940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d5e2a72ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f75678571a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d5e2a71ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d5e2a73410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d5e2a72ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f75679d6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d5e2a73d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d5e2a73410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d5e2a746d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f75679d6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d5e2a73d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d5e2a74890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d5e2a746d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f75679db940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d5e2a74a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d5e2a74890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    22.99 ms
whisper_print_timings:   sample time =    73.46 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2073.19 ms /     1 runs ( 2073.19 ms per run)
whisper_print_timings:   decode time =    16.50 ms /     2 runs (    8.25 ms per run)
whisper_print_timings:   batchd time =   342.51 ms /   125 runs (    2.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2612.77 ms
...
main:     load time =    71.13 ms
main:    total time = 19429.54 ms
embd_img
