...
- status:  SUCCESS ✅
- runtime: 4:06.79
- date:    Wed Mar 27 09:53:33 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   35.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.60 sec
      Start  9: test3
...
main:  predict time =   917.51 ms / 14.34 ms per token
main:    total time =  1121.03 ms
...
main:  predict time =  1007.22 ms / 14.39 ms per token
main:    total time =  1192.29 ms
...
main:     load time =   197.82 ms
main:   sample time =    18.08 ms
main:  predict time =  1054.99 ms / 15.07 ms per token
main:    total time =  1274.54 ms
...
main:     n_decoded =      504
main:     load time =   163.21 ms
main:   sample time =   129.12 ms
main:  predict time =  6475.53 ms
main:    total time =  6851.23 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9627a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff960fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad3277ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9627a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9627f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad3278ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff960fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad3277ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad3279410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad3278ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9627a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad3279d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad3279410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad327a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9627a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad3279d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad327a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad327a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9627f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad327aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad327a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.31 ms
whisper_print_timings:   sample time =    66.80 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4721.86 ms /     1 runs ( 4721.86 ms per run)
whisper_print_timings:   decode time =    15.87 ms /     2 runs (    7.94 ms per run)
whisper_print_timings:   batchd time =   716.93 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5653.94 ms
...
main:     load time =    92.02 ms
main:    total time = 40029.79 ms
embd_img
