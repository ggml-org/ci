...
- status:  SUCCESS ✅
- runtime: 2:08.45
- date:    Wed Mar 27 09:51:45 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.14 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.90 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   15.94 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.43 sec
...
main:     load time =   104.47 ms
main:   sample time =    23.52 ms
main:  predict time =   500.20 ms / 7.82 ms per token
main:    total time =   640.61 ms
...
main:     load time =   107.39 ms
main:   sample time =    23.45 ms
main:  predict time =   506.83 ms / 7.24 ms per token
main:    total time =   639.82 ms
...
main:     load time =   124.38 ms
main:   sample time =    23.87 ms
main:  predict time =   530.65 ms / 7.58 ms per token
main:    total time =   681.89 ms
...
main:   sample time =   175.49 ms
main:  predict time =  1817.13 ms
main:    total time =  2134.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6542be0990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6542a611a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557b3e8b3ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6542be0030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6542be5940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557b3e8b4ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6542a611a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557b3e8b3ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557b3e8b5410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557b3e8b4ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6542be0030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557b3e8b5d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557b3e8b5410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557b3e8b66d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6542be0990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557b3e8b5d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557b3e8b6890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557b3e8b66d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6542be5940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557b3e8b6a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557b3e8b6890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.68 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.13 ms
whisper_print_timings:   sample time =    54.70 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1199.38 ms /     1 runs ( 1199.38 ms per run)
whisper_print_timings:   decode time =    12.60 ms /     2 runs (    6.30 ms per run)
whisper_print_timings:   batchd time =   215.35 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1579.17 ms
...
main:     load time =    67.90 ms
main:    total time = 10741.34 ms
embd_img
