...
- status:  SUCCESS ✅
- runtime: 3:08.18
- date:    Wed Mar 27 09:52:39 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.22 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/23 Test  #1: test-grad0 .......................   Passed    2.95 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.15 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   17.39 sec
...
main:     load time =   151.83 ms
main:   sample time =    17.33 ms
main:  predict time =   893.72 ms / 13.96 ms per token
main:    total time =  1084.70 ms
...
main:  predict time =  1015.31 ms / 14.50 ms per token
main:    total time =  1214.32 ms
...
main:     n_decoded =      504
main:     load time =   152.45 ms
main:   sample time =   127.41 ms
main:  predict time =  6546.74 ms
main:    total time =  6908.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa899a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa881b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3980ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa899a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa899f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf3981ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa881b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf3980ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf3982410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf3981ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa899a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf3982d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf3982410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf39836d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa899a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf3982d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf3983890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf39836d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa899f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf3983a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf3983890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    65.95 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4682.90 ms /     1 runs ( 4682.90 ms per run)
whisper_print_timings:   decode time =    15.30 ms /     2 runs (    7.65 ms per run)
whisper_print_timings:   batchd time =   709.39 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5595.22 ms
