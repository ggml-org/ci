...
- status:  SUCCESS ✅
- runtime: 2:22.19
- date:    Sun Jul 21 08:23:04 UTC 2024
...
main:  predict time =   858.96 ms / 13.42 ms per token
main:    total time =  1040.64 ms
...
main:     load time =   142.69 ms
main:   sample time =    16.97 ms
main:  predict time =   933.11 ms / 13.33 ms per token
...
main:     load time =   171.49 ms
main:   sample time =    17.28 ms
main:  predict time =   980.09 ms / 14.00 ms per token
main:    total time =  1172.44 ms
...
main:  predict time =  6047.39 ms
main:    total time =  6399.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xef4ca10ea930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xef4ca0f6b180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc42353772cd0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xef4ca10e9ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xef4ca10ef8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc42353773a80                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xef4ca0f6b180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc42353772cd0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc423537743c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc42353773a80                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xef4ca10e9ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc42353774d00                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc423537743c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc42353775640                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xef4ca10ea930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc42353774d00                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc423537757e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc42353775640                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xef4ca10ef8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc42353775980                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc423537757e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
