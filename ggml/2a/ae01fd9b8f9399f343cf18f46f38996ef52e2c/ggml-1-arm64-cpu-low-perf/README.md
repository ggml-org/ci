...
- status:  SUCCESS ✅
- runtime: 4:00.39
- date:    Wed May 29 10:20:54 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   33.30 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.74 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.29 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.29 sec
      Start  9: test3
...
main:     load time =   139.77 ms
main:   sample time =    16.74 ms
main:  predict time =   912.13 ms / 14.25 ms per token
main:    total time =  1089.91 ms
...
main:     load time =   139.61 ms
main:   sample time =    16.67 ms
main:  predict time =   987.32 ms / 14.10 ms per token
main:    total time =  1146.19 ms
...
main:     load time =   171.07 ms
main:   sample time =    16.68 ms
main:  predict time =  1048.12 ms / 14.97 ms per token
main:    total time =  1239.04 ms
...
main:     n_decoded =      504
main:     load time =   140.82 ms
main:   sample time =   127.82 ms
main:  predict time =  6489.85 ms
main:    total time =  6841.26 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf0189401a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf01893e9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaf0c6b84fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf0189401a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf0189401f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaf0c6b850ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf01893e9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaf0c6b84fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaf0c6b851410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaf0c6b850ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf0189401a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaf0c6b851d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaf0c6b851410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaf0c6b8526d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf0189401a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaf0c6b851d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaf0c6b852890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaf0c6b8526d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf0189401f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaf0c6b852a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaf0c6b852890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    64.68 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4657.59 ms /     1 runs ( 4657.59 ms per run)
whisper_print_timings:   decode time =    14.45 ms /     2 runs (    7.22 ms per run)
whisper_print_timings:   batchd time =   722.86 ms /   125 runs (    5.78 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5588.63 ms
...
main:     load time =    91.24 ms
main:    total time = 40277.19 ms
embd_img
