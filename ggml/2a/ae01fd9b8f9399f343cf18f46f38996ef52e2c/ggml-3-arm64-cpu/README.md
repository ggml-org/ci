...
- status:  SUCCESS ✅
- runtime: 3:08.26
- date:    Wed May 29 10:20:04 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.22 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   33.33 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.09 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.55 sec
      Start  5: test-mul-mat2
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.51 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.18 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.16 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   17.45 sec
...
main:     load time =   149.16 ms
main:   sample time =    17.42 ms
main:  predict time =   910.57 ms / 14.23 ms per token
main:    total time =  1098.61 ms
...
main:     load time =   149.04 ms
main:   sample time =    18.01 ms
main:  predict time =   994.03 ms / 14.20 ms per token
main:    total time =  1163.66 ms
...
main:     load time =   178.94 ms
main:   sample time =    18.10 ms
main:  predict time =  1012.92 ms / 14.47 ms per token
main:    total time =  1213.32 ms
...
main:     n_decoded =      504
main:     load time =   147.92 ms
main:   sample time =   133.22 ms
main:  predict time =  6476.80 ms
main:    total time =  6840.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xeb4e9d81a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xeb4e9d69b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb11f50a7ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xeb4e9d81a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xeb4e9d81f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb11f50a7fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xeb4e9d69b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb11f50a7ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb11f50a80410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb11f50a7fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xeb4e9d81a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb11f50a80d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb11f50a80410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb11f50a816d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xeb4e9d81a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb11f50a80d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb11f50a81890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb11f50a816d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xeb4e9d81f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb11f50a81a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb11f50a81890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    69.32 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4675.49 ms /     1 runs ( 4675.49 ms per run)
whisper_print_timings:   decode time =    14.32 ms /     2 runs (    7.16 ms per run)
whisper_print_timings:   batchd time =   724.16 ms /   125 runs (    5.79 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5618.93 ms
...
main:     load time =    88.07 ms
main:    total time = 40254.03 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.271000 sec.)
