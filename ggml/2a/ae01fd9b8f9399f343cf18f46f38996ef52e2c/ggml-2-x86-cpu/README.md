...
- status:  SUCCESS ✅
- runtime: 2:09.65
- date:    Wed May 29 10:19:02 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    1.81 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.02 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    1.76 sec
      Start  2: test-opt
...
main:  predict time =   504.28 ms / 7.88 ms per token
main:    total time =   643.09 ms
...
main:  predict time =   534.59 ms / 7.64 ms per token
main:    total time =   663.80 ms
...
main:     load time =   123.42 ms
main:   sample time =    24.03 ms
main:  predict time =   555.14 ms / 7.93 ms per token
main:    total time =   705.57 ms
...
main:     n_decoded =      504
main:     load time =   106.35 ms
main:   sample time =   178.43 ms
main:  predict time =  1816.45 ms
main:    total time =  2134.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7d51d80fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7d51d7f7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5c4be75adce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7d51d80fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7d51d80ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5c4be75aeab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7d51d7f7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5c4be75adce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5c4be75af410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5c4be75aeab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7d51d80fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5c4be75afd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5c4be75af410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5c4be75b06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7d51d80fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5c4be75afd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5c4be75b0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5c4be75b06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7d51d80ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5c4be75b0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5c4be75b0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.88 ms
whisper_print_timings:   sample time =    54.86 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1165.02 ms /     1 runs ( 1165.02 ms per run)
whisper_print_timings:   decode time =    11.36 ms /     2 runs (    5.68 ms per run)
whisper_print_timings:   batchd time =   221.76 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1554.15 ms
...
main:     load time =    63.24 ms
main:    total time = 10903.09 ms
embd_img
