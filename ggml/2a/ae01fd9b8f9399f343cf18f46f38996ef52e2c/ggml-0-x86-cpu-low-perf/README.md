...
- status:  SUCCESS ✅
- runtime: 3:24.44
- date:    Wed May 29 10:20:20 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.00 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   30.04 sec
...
main:     load time =   101.61 ms
main:   sample time =    24.00 ms
main:  predict time =   687.92 ms / 10.75 ms per token
main:    total time =   826.11 ms
...
main:     load time =   100.70 ms
main:   sample time =    23.95 ms
main:  predict time =   730.42 ms / 10.43 ms per token
main:    total time =   857.15 ms
...
main:     load time =   122.07 ms
main:   sample time =    23.87 ms
main:  predict time =   741.85 ms / 10.60 ms per token
main:    total time =   890.79 ms
...
main:   sample time =   178.38 ms
main:  predict time =  2996.27 ms
main:    total time =  3320.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7001b2efa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7001b2d7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x653e6bfe6ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7001b2efa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7001b2eff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x653e6bfe7ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7001b2d7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x653e6bfe6ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x653e6bfe8410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x653e6bfe7ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7001b2efa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x653e6bfe8d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x653e6bfe8410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x653e6bfe96d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7001b2efa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x653e6bfe8d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x653e6bfe9890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x653e6bfe96d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7001b2eff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x653e6bfe9a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x653e6bfe9890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.33 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.31 ms
whisper_print_timings:   sample time =    77.56 ms /   131 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1999.13 ms /     1 runs ( 1999.13 ms per run)
whisper_print_timings:   decode time =    13.62 ms /     2 runs (    6.81 ms per run)
whisper_print_timings:   batchd time =   327.73 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2526.29 ms
