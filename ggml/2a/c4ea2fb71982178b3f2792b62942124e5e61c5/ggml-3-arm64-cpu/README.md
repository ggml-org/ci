...
- status:  SUCCESS ✅
- runtime: 4:09.14
- date:    Thu Feb 22 21:49:04 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.01 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    4.64 sec
...
20/20 Test #20: test-backend-ops .................   Passed   98.21 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 115.92 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.87 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.16 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    2.78 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.08 sec
...
main:     load time =   150.63 ms
main:   sample time =    17.42 ms
main:  predict time =   891.85 ms / 13.94 ms per token
main:    total time =  1081.63 ms
...
main:     load time =   151.70 ms
main:   sample time =    16.99 ms
main:  predict time =   966.34 ms / 13.80 ms per token
main:    total time =  1137.95 ms
...
main:     load time =   177.52 ms
main:   sample time =    16.73 ms
main:  predict time =   976.15 ms / 13.95 ms per token
main:    total time =  1173.51 ms
...
main:     n_decoded =      504
main:     load time =   150.89 ms
main:   sample time =   128.46 ms
main:  predict time =  6581.90 ms
main:    total time =  6943.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85eba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85d3b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf1f73ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85eba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85ebf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf1f74ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85d3b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf1f73ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf1f75410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf1f74ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85eba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf1f75d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf1f75410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf1f766d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85eba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf1f75d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf1f76890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf1f766d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85ebf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf1f76a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf1f76890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.39 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.14 ms
whisper_print_timings:   sample time =    65.36 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4690.39 ms /     1 runs ( 4690.39 ms per run)
whisper_print_timings:   decode time =    14.56 ms /     2 runs (    7.28 ms per run)
whisper_print_timings:   batchd time =   712.54 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5601.76 ms
