...
- status:  SUCCESS ✅
- runtime: 5:11.26
- date:    Thu Feb 22 09:30:44 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.08 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  103.65 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 146.63 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   20.91 sec
...
main:  predict time =   903.31 ms / 14.11 ms per token
main:    total time =  1097.54 ms
...
main:     load time =   155.76 ms
main:   sample time =    16.90 ms
main:  predict time =  1017.82 ms / 14.54 ms per token
main:    total time =  1193.26 ms
...
main:  predict time =  1146.66 ms / 16.38 ms per token
main:    total time =  1350.77 ms
...
main:  predict time =  6601.84 ms
main:    total time =  6971.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f33a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f1bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacb73ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f33a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f33f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacb73fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f1bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacb73ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacb740410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacb73fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f33a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacb740d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacb740410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacb7416d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f33a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacb740d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacb741890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacb7416d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f33f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacb741a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacb741890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.45 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.23 ms
whisper_print_timings:   sample time =    66.17 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4804.36 ms /     1 runs ( 4804.36 ms per run)
whisper_print_timings:   decode time =    14.76 ms /     2 runs (    7.38 ms per run)
whisper_print_timings:   batchd time =   716.00 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5728.23 ms
