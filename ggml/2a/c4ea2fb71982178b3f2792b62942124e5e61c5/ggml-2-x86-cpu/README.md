...
- status:  SUCCESS ✅
- runtime: 2:55.21
- date:    Thu Feb 22 21:37:27 UTC 2024
...
Total Test time (real) =  95.31 sec
...
main:  predict time =   489.72 ms / 7.65 ms per token
...
main:  predict time =   507.62 ms / 7.25 ms per token
main:    total time =   639.42 ms
...
main:  predict time =   515.99 ms / 7.37 ms per token
main:    total time =   672.09 ms
...
main:  predict time =  1814.05 ms
main:    total time =  2130.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdbf6159990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdbf5fda1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b9ec242ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdbf6159030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdbf615e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b9ec243ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdbf5fda1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b9ec242ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b9ec244410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b9ec243ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdbf6159030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b9ec244d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b9ec244410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b9ec2456d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdbf6159990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b9ec244d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b9ec245890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b9ec2456d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdbf615e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b9ec245a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b9ec245890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.89 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.60 ms
whisper_print_timings:   sample time =    55.21 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1186.68 ms /     1 runs ( 1186.68 ms per run)
whisper_print_timings:   decode time =    12.44 ms /     2 runs (    6.22 ms per run)
whisper_print_timings:   batchd time =   212.85 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1562.79 ms
