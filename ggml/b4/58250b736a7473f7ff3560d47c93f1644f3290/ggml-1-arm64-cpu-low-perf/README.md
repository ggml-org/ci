...
- status:  SUCCESS ✅
- runtime: 5:19.37
- date:    Sun Feb 25 07:47:10 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    5.00 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   22.02 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  107.37 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 151.17 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.60 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    2.64 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    0.50 sec
      Start  4: test-mul-mat0
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.54 sec
      Start  5: test-mul-mat2
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   23.64 sec
...
main:  predict time =   952.29 ms / 14.88 ms per token
main:    total time =  1146.82 ms
...
main:     load time =   159.14 ms
main:   sample time =    17.65 ms
main:  predict time =  1052.65 ms / 15.04 ms per token
main:    total time =  1232.46 ms
...
main:  predict time =  1006.24 ms / 14.37 ms per token
main:    total time =  1217.55 ms
...
main:  predict time =  6762.23 ms
main:    total time =  7128.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8e7a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8cfb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad5888ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8e7a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8e7f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad5889ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8cfb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad5888ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad588a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad5889ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8e7a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad588ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad588a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad588b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8e7a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad588ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad588b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad588b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8e7f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad588ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad588b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.83 ms
whisper_print_timings:   sample time =    65.38 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4848.56 ms /     1 runs ( 4848.56 ms per run)
whisper_print_timings:   decode time =    15.93 ms /     2 runs (    7.96 ms per run)
whisper_print_timings:   batchd time =   742.75 ms /   125 runs (    5.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5798.68 ms
