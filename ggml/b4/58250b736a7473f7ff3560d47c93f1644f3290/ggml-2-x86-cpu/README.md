...
- status:  SUCCESS ✅
- runtime: 3:08.77
- date:    Sun Feb 25 19:44:46 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b458250b736a7473f7ff3560d47c93f1644f3290
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    4.60 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    1.16 sec
...
20/20 Test #20: test-backend-ops .................   Passed   90.15 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 105.57 sec
...
main:     load time =   108.93 ms
main:   sample time =    23.65 ms
main:  predict time =   499.39 ms / 7.80 ms per token
main:    total time =   644.53 ms
...
main:     load time =   106.31 ms
main:   sample time =    23.48 ms
main:  predict time =   520.18 ms / 7.43 ms per token
main:    total time =   652.03 ms
...
main:     load time =   127.66 ms
main:   sample time =    23.60 ms
main:  predict time =   524.89 ms / 7.50 ms per token
main:    total time =   678.79 ms
...
main:     n_decoded =      504
main:     load time =   104.33 ms
main:   sample time =   177.77 ms
main:  predict time =  1878.74 ms
main:    total time =  2192.06 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79fce5d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79fccde1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aaa4c3ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79fce5d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79fce62940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55aaa4c3bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f79fccde1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aaa4c3ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55aaa4c3c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55aaa4c3bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f79fce5d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55aaa4c3cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55aaa4c3c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55aaa4c3d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f79fce5d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55aaa4c3cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55aaa4c3d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55aaa4c3d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f79fce62940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55aaa4c3da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55aaa4c3d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.23 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.80 ms
whisper_print_timings:   sample time =    55.18 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1189.74 ms /     1 runs ( 1189.74 ms per run)
whisper_print_timings:   decode time =    12.62 ms /     2 runs (    6.31 ms per run)
whisper_print_timings:   batchd time =   213.67 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1569.40 ms
...
main:     load time =    67.12 ms
main:    total time = 10724.55 ms
embd_img
