...
- status:  SUCCESS ✅
- runtime: 4:23.45
- date:    Sun Feb 25 19:46:12 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/20 Test  #2: test-quantize-fns ................   Passed    5.01 sec
      Start  3: test-quantize-perf
 3/20 Test  #3: test-quantize-perf ...............   Passed    1.46 sec
...
20/20 Test #20: test-backend-ops .................   Passed  108.55 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 127.44 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    2.64 sec
      Start  4: test-quantize-perf
 4/21 Test  #4: test-quantize-perf ...............   Passed    0.53 sec
 ...
 9/21 Test  #9: test2 ............................   Passed    0.02 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    0.14 sec
      Start 11: test-pool
...
main:     load time =   149.44 ms
main:   sample time =    17.72 ms
main:  predict time =   978.91 ms / 13.98 ms per token
main:    total time =  1148.91 ms
...
main:     load time =   177.09 ms
main:   sample time =    16.90 ms
main:  predict time =   988.42 ms / 14.12 ms per token
main:    total time =  1185.53 ms
...
main:     n_decoded =      504
main:     load time =   149.54 ms
main:   sample time =   126.97 ms
main:  predict time =  6470.79 ms
main:    total time =  6830.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa631a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa619b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabda46ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa631a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa631f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabda47ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa619b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaabda46ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabda48410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaabda47ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa631a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabda48d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaabda48410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabda496d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa631a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaabda48d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabda49890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaabda496d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa631f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaabda49a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaabda49890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    65.56 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4679.81 ms /     1 runs ( 4679.81 ms per run)
whisper_print_timings:   decode time =    15.51 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   710.39 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5594.08 ms
...
main:     load time =    90.51 ms
main:    total time = 39752.95 ms
embd_img
