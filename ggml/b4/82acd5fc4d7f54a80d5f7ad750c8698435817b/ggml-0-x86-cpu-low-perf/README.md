...
- status:  FAILURE ❌ (2)
- runtime: 1:24.01
- date:    Sat Aug 24 13:07:57 UTC 2024
...
main:  predict time =   676.02 ms / 10.56 ms per token
main:    total time =   830.16 ms
...
main:  predict time =   709.56 ms / 10.14 ms per token
main:    total time =   873.09 ms
...
main:   sample time =   210.13 ms
main:  predict time =  2830.74 ms
main:    total time =  3195.17 ms
