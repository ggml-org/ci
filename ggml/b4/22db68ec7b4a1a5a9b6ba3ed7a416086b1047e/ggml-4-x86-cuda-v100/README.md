...
- status:  SUCCESS ✅
- runtime: 7:55.99
- date:    Thu Dec  7 18:10:33 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/b422db68ec7b4a1a5a9b6ba3ed7a416086b1047e
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 6/19 Test  #6: test0 ............................   Passed    0.54 sec
      Start  7: test1
 7/19 Test  #7: test1 ............................   Passed    0.55 sec
      Start  8: test2
...
19/19 Test #19: test-backend-ops .................   Passed   90.64 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    6.60 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    3.56 sec
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    3.26 sec
      Start  7: test0
...
main:     load time =   578.70 ms
main:   sample time =    34.28 ms
main:  predict time =   560.92 ms / 8.76 ms per token
main:    total time =  1197.41 ms
...
main:  predict time =   585.96 ms / 8.37 ms per token
main:    total time =  1204.22 ms
...
main:     n_decoded =      504
main:     load time =   541.52 ms
main:   sample time =   232.22 ms
main:  predict time =  2202.56 ms
main:    total time =  3020.72 ms
...
main: loaded model in   402.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f78529b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7852837190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aef17b2b00                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f78529b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f78529bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aef17b38c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7852837190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aef17b2b00                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aef17b4210                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55aef17b38c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f78529b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aef17b4b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55aef17b4210                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aef17b54b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f78529b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55aef17b4b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aef17b5660                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55aef17b54b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f78529bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55aef17b5810                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55aef17b5660       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   511.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.07 ms
whisper_print_timings:   sample time =    67.59 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    34.08 ms /     1 runs (   34.08 ms per run)
whisper_print_timings:   decode time =    12.91 ms /     2 runs (    6.45 ms per run)
whisper_print_timings:   batchd time =    83.12 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   738.07 ms
...
main:     load time =   502.98 ms
main:    total time =  7872.65 ms
embd_img
...
main:      load time =  6850.86 ms
main:    sample time =   518.64 ms / 8.10 ms per token
main:      eval time = 23367.31 ms / 333.82 ms per token
main:     total time = 31583.91 ms
...
main:      load time =  2163.59 ms
main:    sample time =   521.58 ms / 8.15 ms per token
main:      eval time = 12414.65 ms / 177.35 ms per token
main:     total time = 15750.74 ms
