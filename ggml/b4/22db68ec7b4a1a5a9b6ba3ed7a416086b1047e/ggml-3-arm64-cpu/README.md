...
- status:  SUCCESS ✅
- runtime: 5:27.84
- date:    Thu Dec  7 06:05:26 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.14 sec
...
19/19 Test #19: test-backend-ops .................   Passed   47.04 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.35 sec
...
main:     load time =   194.20 ms
main:   sample time =    17.15 ms
main:  predict time =   821.09 ms / 12.83 ms per token
main:    total time =  1054.29 ms
...
main:     load time =   191.66 ms
main:   sample time =    17.18 ms
main:  predict time =   890.07 ms / 12.72 ms per token
...
main:     n_decoded =      504
main:     load time =   161.59 ms
main:   sample time =   127.38 ms
main:  predict time =  5843.27 ms
main:    total time =  6213.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaa1ca960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa04b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf359ab80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaa1ca010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaa1cf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf359b940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaa04b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf359ab80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf359c290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf359b940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaa1ca010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf359cbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf359c290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf359d530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaa1ca960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf359cbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf359d6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf359d530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaa1cf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf359d890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf359d6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.57 ms
whisper_print_timings:   sample time =    65.31 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4652.51 ms /     1 runs ( 4652.51 ms per run)
whisper_print_timings:   decode time =    15.17 ms /     2 runs (    7.58 ms per run)
whisper_print_timings:   batchd time =   705.97 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5562.22 ms
...
main:     load time =    98.03 ms
main:    total time = 39473.82 ms
embd_img
...
main:      load time =  5526.44 ms
main:    sample time =   533.30 ms / 8.33 ms per token
main:      eval time = 43710.94 ms / 624.44 ms per token
main:     total time = 52144.12 ms
...
main:      load time =  1561.99 ms
main:    sample time =   528.10 ms / 8.25 ms per token
main:      eval time = 17545.19 ms / 250.65 ms per token
main:     total time = 20606.23 ms
