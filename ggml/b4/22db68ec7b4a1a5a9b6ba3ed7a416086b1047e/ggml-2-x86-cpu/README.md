...
- status:  SUCCESS ✅
- runtime: 3:39.09
- date:    Thu Dec  7 18:01:54 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.38 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.28 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    8.72 sec
...
main:     load time =   124.64 ms
main:   sample time =    23.44 ms
main:  predict time =   445.99 ms / 6.97 ms per token
main:    total time =   606.45 ms
...
main:     load time =   124.93 ms
main:   sample time =    23.45 ms
main:  predict time =   463.99 ms / 6.63 ms per token
main:    total time =   614.46 ms
...
main:  predict time =  1467.86 ms
main:    total time =  1786.65 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9dbce19960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9dbcc9a190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e0bc447b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9dbce19010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9dbce1e900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e0bc448940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9dbcc9a190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e0bc447b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e0bc449290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e0bc448940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9dbce19010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e0bc449be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e0bc449290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e0bc44a530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9dbce19960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e0bc449be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e0bc44a6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e0bc44a530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9dbce1e900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e0bc44a890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e0bc44a6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.02 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.31 ms
whisper_print_timings:   sample time =    55.01 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1160.87 ms /     1 runs ( 1160.87 ms per run)
whisper_print_timings:   decode time =     9.71 ms /     2 runs (    4.85 ms per run)
whisper_print_timings:   batchd time =   207.98 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1527.98 ms
...
main:     load time =    68.20 ms
main:    total time = 10551.07 ms
embd_img
...
main:      load time =  4510.47 ms
main:    sample time =   467.04 ms / 7.30 ms per token
main:      eval time = 19413.18 ms / 277.33 ms per token
main:     total time = 25047.12 ms
...
main:      load time =  1219.49 ms
main:    sample time =   466.84 ms / 7.29 ms per token
main:      eval time =  8065.28 ms / 115.22 ms per token
main:     total time = 10128.62 ms
