...
- status:  SUCCESS ✅
- runtime: 3:49.78
- date:    Thu Dec  7 06:02:10 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.06 sec
...
19/19 Test #19: test-backend-ops .................   Passed   54.88 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   12.67 sec
...
main:  predict time =   848.34 ms / 13.26 ms per token
main:    total time =  1079.28 ms
...
main:     load time =   190.04 ms
main:   sample time =    17.90 ms
main:  predict time =   910.32 ms / 13.00 ms per token
...
main:   sample time =   135.28 ms
main:  predict time =  6032.36 ms
main:    total time =  6410.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa672a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa65ab190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafa8d8b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa672a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa672f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafa8d9940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa65ab190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaafa8d8b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafa8da290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaafa8d9940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa672a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafa8dabe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaafa8da290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafa8db530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa672a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaafa8dabe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafa8db6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaafa8db530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa672f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaafa8db890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaafa8db6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    66.93 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4715.67 ms /     1 runs ( 4715.67 ms per run)
whisper_print_timings:   decode time =    16.68 ms /     2 runs (    8.34 ms per run)
whisper_print_timings:   batchd time =   712.78 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5639.65 ms
...
main:     load time =    91.99 ms
main:    total time = 40436.53 ms
embd_img
