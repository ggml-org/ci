...
- status:  SUCCESS ✅
- runtime: 2:49.22
- date:    Fri Dec 29 07:38:16 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.23 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   34.72 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.30 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.21 sec
      Start  9: test3
...
main:     load time =   131.88 ms
main:   sample time =    23.56 ms
main:  predict time =   630.76 ms / 9.86 ms per token
main:    total time =   799.08 ms
...
main:     load time =   128.99 ms
main:   sample time =    23.39 ms
main:  predict time =   671.05 ms / 9.59 ms per token
main:    total time =   825.69 ms
...
main:     n_decoded =      504
main:     load time =   107.28 ms
main:   sample time =   178.22 ms
main:  predict time =  2385.76 ms
main:    total time =  2720.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fca494ab990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fca4932c1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b6b8d19b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fca494ab030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fca494b0940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b6b8d1a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fca4932c1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b6b8d19b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b6b8d1b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b6b8d1a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fca494ab030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b6b8d1bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b6b8d1b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b6b8d1c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fca494ab990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b6b8d1bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b6b8d1c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b6b8d1c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fca494b0940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b6b8d1c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b6b8d1c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    20.46 ms
...
whisper_print_timings:   batchd time =   322.28 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2494.18 ms
...
main:     load time =    70.52 ms
main:    total time = 18840.11 ms
embd_img
