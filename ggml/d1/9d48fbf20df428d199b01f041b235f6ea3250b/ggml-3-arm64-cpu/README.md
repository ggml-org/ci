...
- status:  SUCCESS ✅
- runtime: 5:42.83
- date:    Fri Dec 29 07:41:17 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/d19d48fbf20df428d199b01f041b235f6ea3250b
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.68 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   34.35 sec
...
20/20 Test #20: test-backend-ops .................   Passed   10.05 sec
...
main:     load time =   185.00 ms
main:   sample time =    16.64 ms
main:  predict time =   878.13 ms / 12.54 ms per token
main:    total time =  1082.59 ms
...
main:   sample time =   128.07 ms
main:  predict time =  5892.70 ms
main:    total time =  6251.44 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa709a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6f1b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4d54b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa709a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa709f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf4d55960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6f1b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4d54b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf4d562c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf4d55960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa709a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf4d56c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf4d562c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf4d57580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa709a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf4d56c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf4d57740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf4d57580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa709f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf4d57900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf4d57740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   176.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.97 ms
whisper_print_timings:   sample time =    65.01 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4655.12 ms /     1 runs ( 4655.12 ms per run)
whisper_print_timings:   decode time =    14.88 ms /     2 runs (    7.44 ms per run)
whisper_print_timings:   batchd time =   707.22 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5636.89 ms
...
main:     load time =    79.12 ms
main:    total time = 39543.16 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.232000 sec.)
...
main:      load time = 13457.15 ms
main:    sample time =   520.50 ms / 8.13 ms per token
main:      eval time = 43591.13 ms / 622.73 ms per token
main:     total time = 59944.01 ms
...
main:      load time =  4364.25 ms
main:    sample time =   514.41 ms / 8.04 ms per token
main:      eval time = 16957.72 ms / 242.25 ms per token
main:     total time = 22790.86 ms
