...
- status:  SUCCESS ✅
- runtime: 8:20.72
- date:    Fri Dec 29 07:43:52 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   60.74 sec
...
20/20 Test #20: test-backend-ops .................   Passed   23.19 sec
...
main:     load time =   626.17 ms
main:   sample time =    34.38 ms
main:  predict time =   551.90 ms / 8.62 ms per token
main:    total time =  1232.49 ms
...
main:     load time =   557.67 ms
main:   sample time =    36.32 ms
main:  predict time =   595.91 ms / 8.51 ms per token
main:    total time =  1194.01 ms
...
main:     n_decoded =      504
main:     load time =   551.94 ms
main:   sample time =   233.84 ms
main:  predict time =  2221.82 ms
main:    total time =  3051.36 ms
...
main: loaded model in   402.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9d967b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9d966371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e91db0c80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9d967b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9d967bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560e91db1a50                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9d966371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560e91db0c80                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560e91db23b0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560e91db1a50                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9d967b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560e91db2d10                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560e91db23b0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560e91db3670                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9d967b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560e91db2d10                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560e91db3830                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560e91db3670                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9d967bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560e91db39f0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560e91db3830       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   492.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.58 ms
whisper_print_timings:   sample time =    65.42 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    33.59 ms /     1 runs (   33.59 ms per run)
whisper_print_timings:   decode time =    13.80 ms /     2 runs (    6.90 ms per run)
whisper_print_timings:   batchd time =    80.25 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   712.91 ms
...
main:     load time =   486.04 ms
main:    total time =  7823.06 ms
embd_img
...
main:      load time = 28363.29 ms
main:    sample time =   546.74 ms / 8.54 ms per token
main:      eval time = 24796.91 ms / 354.24 ms per token
main:     total time = 54565.73 ms
...
main:      load time = 15329.37 ms
main:    sample time =   544.73 ms / 8.51 ms per token
main:      eval time = 12158.49 ms / 173.69 ms per token
main:     total time = 28709.36 ms
