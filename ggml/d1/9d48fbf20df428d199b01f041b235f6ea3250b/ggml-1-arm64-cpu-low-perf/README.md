...
- status:  SUCCESS ✅
- runtime: 3:36.09
- date:    Fri Dec 29 07:39:12 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.95 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.54 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.34 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.23 sec
...
main:     load time =   191.75 ms
main:   sample time =    17.90 ms
main:  predict time =   866.65 ms / 13.54 ms per token
main:    total time =  1098.20 ms
...
main:     load time =   192.79 ms
main:   sample time =    17.62 ms
main:  predict time =   904.44 ms / 12.92 ms per token
main:    total time =  1117.80 ms
...
main:     n_decoded =      504
main:     load time =   161.73 ms
main:   sample time =   127.93 ms
main:  predict time =  6123.70 ms
main:    total time =  6495.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff86f4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86dcb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadcd0fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86f4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff86f4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadcd10960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff86dcb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadcd0fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadcd112c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadcd10960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff86f4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadcd11c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadcd112c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadcd12580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff86f4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadcd11c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadcd12740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadcd12580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff86f4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadcd12900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadcd12740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.74 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.66 ms
whisper_print_timings:   sample time =    69.67 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =  4801.26 ms /     1 runs ( 4801.26 ms per run)
whisper_print_timings:   decode time =    21.45 ms /     2 runs (   10.72 ms per run)
whisper_print_timings:   batchd time =   766.16 ms /   125 runs (    6.13 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5790.39 ms
...
main:     load time =    97.87 ms
main:    total time = 40449.28 ms
embd_img
