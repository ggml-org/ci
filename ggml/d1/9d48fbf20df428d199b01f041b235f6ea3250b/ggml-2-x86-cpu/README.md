...
- status:  SUCCESS ✅
- runtime: 3:57.54
- date:    Fri Dec 29 07:39:27 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.31 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  38.13 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.58 sec
...
main:   sample time =    23.27 ms
main:  predict time =   442.25 ms / 6.32 ms per token
main:    total time =   599.44 ms
...
main:  predict time =  1455.00 ms
main:    total time =  1769.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fee563aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fee5622b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f6b4f13b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fee563aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fee563af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f6b4f14960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fee5622b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f6b4f13b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f6b4f152c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f6b4f14960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fee563aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f6b4f15c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f6b4f152c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f6b4f16580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fee563aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f6b4f15c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f6b4f16740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f6b4f16580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fee563af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f6b4f16900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f6b4f16740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   124.16 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    55.54 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1155.20 ms /     1 runs ( 1155.20 ms per run)
whisper_print_timings:   decode time =     9.85 ms /     2 runs (    4.93 ms per run)
whisper_print_timings:   batchd time =   208.88 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1572.36 ms
...
main:     load time =    60.88 ms
main:    total time = 10567.64 ms
embd_img
...
main:      load time = 14363.96 ms
main:    sample time =   467.65 ms / 7.31 ms per token
main:      eval time = 20337.23 ms / 290.53 ms per token
main:     total time = 35844.27 ms
...
main:      load time =  4400.44 ms
main:    sample time =   465.57 ms / 7.27 ms per token
main:      eval time =  8049.89 ms / 115.00 ms per token
main:     total time = 13274.18 ms
