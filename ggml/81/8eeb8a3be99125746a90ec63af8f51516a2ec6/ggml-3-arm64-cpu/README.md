...
- status:  SUCCESS ✅
- runtime: 4:56.66
- date:    Mon Feb 19 01:00:02 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  144.49 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.96 sec
...
main:  predict time =   889.87 ms / 13.90 ms per token
...
main:  predict time =   967.47 ms / 13.82 ms per token
main:    total time =  1133.16 ms
...
main:     load time =   172.08 ms
main:   sample time =    16.91 ms
main:  predict time =  1035.48 ms / 14.79 ms per token
main:    total time =  1227.52 ms
...
main:  predict time =  6401.86 ms
main:    total time =  6755.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9430a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9418b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad3f45b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9430a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9430f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad3f46960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9418b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad3f45b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad3f472c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad3f46960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9430a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad3f47c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad3f472c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad3f48580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9430a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad3f47c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad3f48740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad3f48580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9430f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad3f48900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad3f48740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   103.05 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.24 ms
whisper_print_timings:   sample time =    65.68 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4715.89 ms /     1 runs ( 4715.89 ms per run)
whisper_print_timings:   decode time =    14.44 ms /     2 runs (    7.22 ms per run)
whisper_print_timings:   batchd time =   709.95 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5627.68 ms
