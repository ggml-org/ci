...
- status:  SUCCESS ✅
- runtime: 5:51.61
- date:    Mon Feb 19 12:47:53 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.44 sec
...
20/20 Test #20: test-backend-ops .................   Passed  150.03 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 187.95 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.12 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.89 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   22.21 sec
...
main:     load time =   156.24 ms
main:   sample time =    17.21 ms
main:  predict time =   904.83 ms / 14.14 ms per token
main:    total time =  1100.10 ms
...
main:     load time =   161.14 ms
main:   sample time =    17.51 ms
main:  predict time =  1061.96 ms / 15.17 ms per token
main:    total time =  1243.48 ms
...
main:     load time =   188.07 ms
main:   sample time =    17.23 ms
main:  predict time =  1012.23 ms / 14.46 ms per token
main:    total time =  1220.76 ms
...
main:  predict time =  6716.59 ms
main:    total time =  7085.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9687a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff966fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad888fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9687a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9687f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad8890960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff966fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad888fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad88912c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad8890960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9687a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad8891c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad88912c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad8892580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9687a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad8891c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad8892740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad8892580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9687f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad8892900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad8892740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.34 ms
whisper_print_timings:   sample time =    65.18 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4809.64 ms /     1 runs ( 4809.64 ms per run)
whisper_print_timings:   decode time =    15.08 ms /     2 runs (    7.54 ms per run)
whisper_print_timings:   batchd time =   746.22 ms /   125 runs (    5.97 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5765.04 ms
...
main:     load time =    89.82 ms
main:    total time = 40480.21 ms
embd_img
