...
- status:  SUCCESS ✅
- runtime: 7:02.81
- date:    Mon Jan 29 11:47:36 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  124.42 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 138.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.18 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   24.77 sec
...
main:     load time =   189.68 ms
main:   sample time =    17.02 ms
main:  predict time =   870.60 ms / 13.60 ms per token
main:    total time =  1099.46 ms
...
main:     load time =   187.48 ms
main:   sample time =    17.16 ms
main:  predict time =   938.69 ms / 13.41 ms per token
main:    total time =  1146.58 ms
...
main:     n_decoded =      504
main:     load time =   157.18 ms
main:   sample time =   128.53 ms
main:  predict time =  5993.51 ms
main:    total time =  6362.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9435a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff941db1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaace65db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9435a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9435f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaace65e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff941db1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaace65db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaace65f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaace65e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9435a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaace65fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaace65f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaace660580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9435a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaace65fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaace660740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaace660580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9435f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaace660900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaace660740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.74 ms
whisper_print_timings:   sample time =    65.72 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4641.33 ms /     1 runs ( 4641.33 ms per run)
whisper_print_timings:   decode time =    15.69 ms /     2 runs (    7.84 ms per run)
whisper_print_timings:   batchd time =   713.88 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5562.83 ms
...
main:      load time =  5629.48 ms
main:    sample time =   521.60 ms / 8.15 ms per token
main:      eval time = 43810.22 ms / 625.86 ms per token
main:     total time = 52334.67 ms
...
main:      load time =  1599.54 ms
main:    sample time =   515.10 ms / 8.05 ms per token
main:      eval time = 17323.50 ms / 247.48 ms per token
main:     total time = 20394.68 ms
