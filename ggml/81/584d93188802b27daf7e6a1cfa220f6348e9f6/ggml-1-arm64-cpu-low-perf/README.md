...
- status:  SUCCESS ✅
- runtime: 6:03.26
- date:    Mon Jan 29 11:44:00 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.53 sec
...
20/20 Test #20: test-backend-ops .................   Passed  151.15 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 189.37 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.24 sec
      Start  9: test3
...
main:  predict time =   889.91 ms / 13.90 ms per token
main:    total time =  1122.86 ms
...
main:  predict time =   960.92 ms / 13.73 ms per token
main:    total time =  1169.90 ms
...
main:  predict time =  6146.70 ms
main:    total time =  6516.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9b11a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9af9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4e9fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9b11a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9b11f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf4ea0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9af9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf4e9fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf4ea12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf4ea0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9b11a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf4ea1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf4ea12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf4ea2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9b11a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf4ea1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf4ea2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf4ea2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9b11f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf4ea2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf4ea2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   110.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.61 ms
whisper_print_timings:   sample time =    65.32 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4773.90 ms /     1 runs ( 4773.90 ms per run)
whisper_print_timings:   decode time =    15.82 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   716.55 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5701.03 ms
...
main:     load time =    91.26 ms
main:    total time = 40589.78 ms
embd_img
