...
- status:  SUCCESS ✅
- runtime: 11:20.27
- date:    Mon Jan 29 11:54:34 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/81584d93188802b27daf7e6a1cfa220f6348e9f6
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/20 Test  #4: test-mul-mat0 ....................   Passed    1.12 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.55 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.84 sec
      Start  9: test3
...
13/20 Test #13: test-rel-pos .....................   Passed    0.57 sec
...
20/20 Test #20: test-backend-ops .................   Passed  224.93 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 271.42 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.56 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.75 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   47.22 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  92.16 sec
...
main:     load time =   567.09 ms
main:   sample time =    34.18 ms
main:  predict time =   622.13 ms / 9.72 ms per token
main:    total time =  1247.08 ms
...
main:     load time =   588.43 ms
main:   sample time =    34.66 ms
main:  predict time =   628.45 ms / 8.98 ms per token
main:    total time =  1256.22 ms
...
main:     n_decoded =      504
main:     load time =   542.44 ms
main:   sample time =   235.82 ms
main:  predict time =  2278.70 ms
main:    total time =  3102.48 ms
...
main: loaded model in   408.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa6f6fb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa6f6e371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c4e0414800                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa6f6fb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa6f6fbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c4e04155d0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa6f6e371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c4e0414800                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c4e0415f30                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c4e04155d0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa6f6fb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c4e0416890                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c4e0415f30                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c4e04171f0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa6f6fb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c4e0416890                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c4e04173b0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c4e04171f0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa6f6fbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c4e0417570                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c4e04173b0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   501.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.61 ms
whisper_print_timings:   sample time =    66.45 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    23.31 ms /     1 runs (   23.31 ms per run)
whisper_print_timings:   decode time =    21.70 ms /     2 runs (   10.85 ms per run)
whisper_print_timings:   batchd time =    80.75 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   720.94 ms
...
main:     load time =   499.03 ms
main:    total time =  8004.70 ms
embd_img
...
main:      load time =  6797.48 ms
main:    sample time =   521.47 ms / 8.15 ms per token
main:      eval time = 23578.78 ms / 336.84 ms per token
main:     total time = 31755.55 ms
...
main:      load time =  2244.08 ms
main:    sample time =   528.95 ms / 8.26 ms per token
main:      eval time = 12503.16 ms / 178.62 ms per token
main:     total time = 15922.14 ms
