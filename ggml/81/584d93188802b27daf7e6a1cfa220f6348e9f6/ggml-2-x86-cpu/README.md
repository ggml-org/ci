...
- status:  SUCCESS ✅
- runtime: 4:59.77
- date:    Mon Jan 29 11:41:11 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.47 sec
...
20/20 Test #20: test-backend-ops .................   Passed  111.73 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 122.72 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.38 sec
...
main:     load time =   126.97 ms
main:   sample time =    23.67 ms
main:  predict time =   477.11 ms / 6.82 ms per token
main:    total time =   630.13 ms
...
main:   sample time =   177.75 ms
main:  predict time =  1533.29 ms
main:    total time =  1846.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc99b238990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc99b0b91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558788414b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc99b238030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc99b23d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558788415960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc99b0b91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558788414b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5587884162c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558788415960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc99b238030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558788416c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5587884162c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558788417580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc99b238990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558788416c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558788417740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558788417580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc99b23d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558788417900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558788417740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.44 ms
whisper_print_timings:   sample time =    55.06 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1157.10 ms /     1 runs ( 1157.10 ms per run)
whisper_print_timings:   decode time =    10.38 ms /     2 runs (    5.19 ms per run)
whisper_print_timings:   batchd time =   214.94 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1531.35 ms
...
main:      load time =  5122.06 ms
main:    sample time =   471.35 ms / 7.36 ms per token
main:      eval time = 19735.22 ms / 281.93 ms per token
main:     total time = 25999.83 ms
...
main:      load time =  1172.68 ms
main:    sample time =   469.03 ms / 7.33 ms per token
main:      eval time =  8144.87 ms / 116.36 ms per token
main:     total time = 10167.50 ms
