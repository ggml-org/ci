...
- status:  SUCCESS ✅
- runtime: 4:52.87
- date:    Mon Jan 29 11:40:55 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.57 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.36 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  115.73 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 154.80 sec
...
main:     load time =   126.33 ms
main:   sample time =    23.87 ms
main:  predict time =   642.13 ms / 10.03 ms per token
main:    total time =   805.48 ms
...
main:  predict time =   668.54 ms / 9.55 ms per token
main:    total time =   820.17 ms
...
main:     n_decoded =      504
main:     load time =   104.37 ms
main:   sample time =   177.99 ms
main:  predict time =  2510.01 ms
main:    total time =  2837.37 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5fc2274990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5fc20f51a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559fed610b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5fc2274030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5fc2279940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559fed611960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5fc20f51a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559fed610b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559fed6122c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x559fed611960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5fc2274030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559fed612c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x559fed6122c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559fed613580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5fc2274990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x559fed612c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559fed613740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x559fed613580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5fc2279940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x559fed613900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x559fed613740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.13 ms
whisper_print_timings:   sample time =    72.70 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1998.79 ms /     1 runs ( 1998.79 ms per run)
whisper_print_timings:   decode time =    13.31 ms /     2 runs (    6.65 ms per run)
whisper_print_timings:   batchd time =   329.92 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2516.45 ms
...
main:     load time =    70.80 ms
main:    total time = 19008.38 ms
embd_img
