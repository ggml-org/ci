...
- status:  SUCCESS ✅
- runtime: 3:50.13
- date:    Thu Dec  7 19:16:02 UTC 2023
...
20/20 Test #20: test-backend-ops .................   Passed    8.77 sec
...
main:     load time =   226.43 ms
main:   sample time =    23.39 ms
main:  predict time =   441.82 ms / 6.90 ms per token
main:    total time =   704.34 ms
...
main:  predict time =   454.74 ms / 6.50 ms per token
main:    total time =   605.66 ms
...
main:  predict time =  1471.17 ms
main:    total time =  1787.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fecb7101960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fecb6f82190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c87610b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fecb7101010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fecb7106900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556c87611940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fecb6f82190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556c87610b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556c87612290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x556c87611940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fecb7101010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556c87612be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x556c87612290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556c87613530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fecb7101960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x556c87612be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556c876136e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x556c87613530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fecb7106900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x556c87613890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x556c876136e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   155.75 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.11 ms
whisper_print_timings:   sample time =    55.32 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.94 ms /     1 runs ( 1159.94 ms per run)
whisper_print_timings:   decode time =     9.87 ms /     2 runs (    4.93 ms per run)
whisper_print_timings:   batchd time =   207.56 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1607.58 ms
...
main:     load time =    64.32 ms
main:    total time = 10534.89 ms
embd_img
...
main:      load time =  5218.75 ms
main:    sample time =   471.96 ms / 7.37 ms per token
main:      eval time = 20427.40 ms / 291.82 ms per token
main:     total time = 26793.18 ms
...
main:      load time =  1222.55 ms
main:    sample time =   465.50 ms / 7.27 ms per token
main:      eval time =  8081.31 ms / 115.45 ms per token
main:     total time = 10163.38 ms
