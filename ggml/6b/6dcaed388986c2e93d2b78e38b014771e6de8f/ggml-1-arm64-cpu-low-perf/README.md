...
- status:  SUCCESS ✅
- runtime: 3:50.06
- date:    Thu Dec  7 07:15:54 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   55.17 sec
...
main:  predict time =   881.64 ms / 13.78 ms per token
...
main:     load time =   189.88 ms
main:   sample time =    17.72 ms
main:  predict time =   907.77 ms / 12.97 ms per token
main:    total time =  1118.37 ms
...
main:   sample time =   134.49 ms
main:  predict time =  6035.63 ms
main:    total time =  6523.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa00aa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ff2b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07efeb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa00aa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa00af900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab07eff940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ff2b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab07efeb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab07f00290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab07eff940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa00aa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab07f00be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab07f00290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab07f01530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa00aa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab07f00be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab07f016e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab07f01530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa00af900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab07f01890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab07f016e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4784.72 ms /     1 runs ( 4784.72 ms per run)
whisper_print_timings:   decode time =    15.60 ms /     2 runs (    7.80 ms per run)
whisper_print_timings:   batchd time =   711.71 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5707.04 ms
