...
- status:  SUCCESS ✅
- runtime: 5:34.88
- date:    Thu Dec  7 07:17:36 PM UTC 2023
...
20/20 Test #20: test-backend-ops .................   Passed   12.00 sec
...
main:  predict time =   811.24 ms / 12.68 ms per token
main:    total time =  1032.25 ms
...
main:     load time =   183.25 ms
main:   sample time =    16.84 ms
main:  predict time =   889.90 ms / 12.71 ms per token
...
main:     n_decoded =      504
main:     load time =   155.51 ms
main:   sample time =   128.56 ms
main:  predict time =  5858.36 ms
main:    total time =  6223.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8464a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff844cb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadaf1bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8464a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8464f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadaf1c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff844cb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadaf1bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadaf1d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadaf1c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8464a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadaf1dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadaf1d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadaf1e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8464a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadaf1dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadaf1e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadaf1e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8464f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadaf1e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadaf1e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.34 ms
whisper_print_timings:   sample time =    65.75 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4651.40 ms /     1 runs ( 4651.40 ms per run)
whisper_print_timings:   decode time =    15.26 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   706.81 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5569.70 ms
...
main:      load time =  5502.88 ms
main:    sample time =   531.33 ms / 8.30 ms per token
main:      eval time = 43471.63 ms / 621.02 ms per token
main:     total time = 51878.32 ms
...
main:      load time =  1520.08 ms
main:    sample time =   528.52 ms / 8.26 ms per token
main:      eval time = 17498.09 ms / 249.97 ms per token
main:     total time = 20517.17 ms
