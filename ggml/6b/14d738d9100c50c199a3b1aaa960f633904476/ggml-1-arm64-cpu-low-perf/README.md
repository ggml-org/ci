...
- status:  SUCCESS ✅
- runtime: 6:20.65
- date:    Tue Jan 30 07:34:49 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.79 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  165.14 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 204.23 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   26.56 sec
...
main:  predict time =  1089.82 ms / 15.57 ms per token
main:    total time =  1297.76 ms
...
main:     n_decoded =      504
main:     load time =   164.27 ms
main:   sample time =   126.76 ms
main:  predict time =  6157.98 ms
main:    total time =  6532.32 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffab1ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffab03b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18f5eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffab1ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffab1bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18f5f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffab03b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab18f5eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab18f602c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab18f5f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffab1ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18f60c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab18f602c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18f61580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffab1ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab18f60c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18f61740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab18f61580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffab1bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab18f61900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab18f61740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    65.02 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4739.16 ms /     1 runs ( 4739.16 ms per run)
whisper_print_timings:   decode time =    16.65 ms /     2 runs (    8.32 ms per run)
whisper_print_timings:   batchd time =   715.81 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5665.97 ms
