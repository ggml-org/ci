...
- status:  SUCCESS ✅
- runtime: 5:02.54
- date:    Tue Jan 30 19:37:53 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.15 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  123.97 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.37 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   20.65 sec
...
main:  predict time =   665.44 ms / 10.40 ms per token
main:    total time =   827.50 ms
...
main:  predict time =   695.89 ms / 9.94 ms per token
main:    total time =   848.70 ms
...
main:     n_decoded =      504
main:     load time =   104.63 ms
main:   sample time =   178.20 ms
main:  predict time =  2521.49 ms
main:    total time =  2849.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4f67d70990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4f67bf11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b43651cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4f67d70030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4f67d75940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b43651d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4f67bf11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b43651cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b43651e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b43651d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4f67d70030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b43651ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b43651e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b43651f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4f67d70990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b43651ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b43651f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b43651f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4f67d75940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b43651f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b43651f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.86 ms
whisper_print_timings:   sample time =    71.40 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1984.63 ms /     1 runs ( 1984.63 ms per run)
whisper_print_timings:   decode time =    12.77 ms /     2 runs (    6.38 ms per run)
whisper_print_timings:   batchd time =   326.20 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2495.85 ms
...
main:     load time =    68.80 ms
main:    total time = 19034.53 ms
embd_img
