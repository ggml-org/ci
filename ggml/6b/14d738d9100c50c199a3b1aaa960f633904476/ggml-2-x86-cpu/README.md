...
- status:  SUCCESS ✅
- runtime: 5:54.93
- date:    Tue Jan 30 19:42:24 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.45 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.82 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.05 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  121.92 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 134.20 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.32 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.59 sec
...
21/21 Test #21: test-backend-ops .................   Passed   22.44 sec
...
main:     load time =   189.79 ms
main:   sample time =    23.57 ms
main:  predict time =   476.30 ms / 7.44 ms per token
main:    total time =   702.74 ms
...
main:     load time =   131.00 ms
main:   sample time =    23.69 ms
main:  predict time =   494.56 ms / 7.07 ms per token
main:    total time =   651.56 ms
...
main:     n_decoded =      504
main:     load time =   107.57 ms
main:   sample time =   177.96 ms
main:  predict time =  1528.31 ms
main:    total time =  1845.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9a0a652990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9a0a4d31a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5640a2203b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9a0a652030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9a0a657940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5640a2204960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9a0a4d31a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5640a2203b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5640a22052c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5640a2204960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9a0a652030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5640a2205c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5640a22052c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5640a2206580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9a0a652990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5640a2205c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5640a2206740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5640a2206580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9a0a657940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5640a2206900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5640a2206740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.32 ms
whisper_print_timings:   sample time =    55.73 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1157.48 ms /     1 runs ( 1157.48 ms per run)
whisper_print_timings:   decode time =    10.49 ms /     2 runs (    5.24 ms per run)
whisper_print_timings:   batchd time =   217.78 ms /   125 runs (    1.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1586.60 ms
...
main:     load time =    61.95 ms
main:    total time = 10652.96 ms
embd_img
...
main:      load time = 13862.36 ms
main:    sample time =   472.23 ms / 7.38 ms per token
main:      eval time = 20879.36 ms / 298.28 ms per token
main:     total time = 35902.86 ms
...
main:      load time =  4337.53 ms
main:    sample time =   471.31 ms / 7.36 ms per token
main:      eval time =  9229.70 ms / 131.85 ms per token
main:     total time = 14394.13 ms
