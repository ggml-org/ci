...
- status:  SUCCESS ✅
- runtime: 7:48.78
- date:    Tue Jan 30 07:55:55 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.41 sec
...
20/20 Test #20: test-backend-ops .................   Passed  137.76 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 152.42 sec
...
21/21 Test #21: test-backend-ops .................   Passed   26.59 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  35.68 sec
...
main:     load time =   182.58 ms
main:   sample time =    17.08 ms
main:  predict time =   942.34 ms / 13.46 ms per token
main:    total time =  1145.01 ms
...
main:     n_decoded =      504
main:     load time =   149.39 ms
main:   sample time =   126.70 ms
main:  predict time =  6001.22 ms
main:    total time =  6360.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d5ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d44b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8b5eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d5ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d5cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae8b5f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8d44b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8b5eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae8b602c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae8b5f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8d5ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae8b60c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae8b602c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae8b61580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8d5ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae8b60c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae8b61740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae8b61580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8d5cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae8b61900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae8b61740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   181.27 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.55 ms
whisper_print_timings:   sample time =    65.31 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4619.07 ms /     1 runs ( 4619.07 ms per run)
whisper_print_timings:   decode time =    16.16 ms /     2 runs (    8.08 ms per run)
whisper_print_timings:   batchd time =   713.82 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5613.98 ms
...
main:     load time =    79.53 ms
main:    total time = 39718.44 ms
embd_img
...
main:      load time = 14046.78 ms
main:    sample time =   520.18 ms / 8.13 ms per token
main:      eval time = 43734.35 ms / 624.78 ms per token
main:     total time = 60674.95 ms
...
main:      load time =  4348.71 ms
main:    sample time =   518.97 ms / 8.11 ms per token
main:      eval time = 17465.99 ms / 249.51 ms per token
main:     total time = 23290.79 ms
