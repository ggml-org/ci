...
- status:  SUCCESS ✅
- runtime: 6:26.12
- date:    Thu Dec 14 08:22:40 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    0.11 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   34.00 sec
...
20/20 Test #20: test-backend-ops .................   Passed    9.86 sec
...
main:     load time =   269.26 ms
main:   sample time =    16.90 ms
main:  predict time =   807.73 ms / 12.62 ms per token
main:    total time =  1115.76 ms
...
main:     load time =   185.04 ms
main:   sample time =    16.68 ms
main:  predict time =   875.23 ms / 12.50 ms per token
main:    total time =  1079.86 ms
...
main:     n_decoded =      504
main:     load time =   147.28 ms
main:   sample time =   128.07 ms
main:  predict time =  5883.31 ms
main:    total time =  6239.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa88fa9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa877b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0677bba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa88fa050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa88ff980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0677c980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa877b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0677bba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0677d2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0677c980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa88fa050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0677dc60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0677d2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0677e5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa88fa9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0677dc60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0677e7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0677e5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa88ff980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0677e970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0677e7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   187.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    65.07 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4659.39 ms /     1 runs ( 4659.39 ms per run)
whisper_print_timings:   decode time =    14.96 ms /     2 runs (    7.48 ms per run)
whisper_print_timings:   batchd time =   707.42 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5652.85 ms
...
main:     load time =    77.68 ms
main:    total time = 39473.76 ms
embd_img
...
main:      load time = 12150.19 ms
main:    sample time =   538.28 ms / 8.41 ms per token
main:      eval time = 43544.62 ms / 622.07 ms per token
main:     total time = 58609.30 ms
...
main:      load time =  4373.04 ms
main:    sample time =   531.23 ms / 8.30 ms per token
main:      eval time = 17613.10 ms / 251.62 ms per token
main:     total time = 23503.04 ms
