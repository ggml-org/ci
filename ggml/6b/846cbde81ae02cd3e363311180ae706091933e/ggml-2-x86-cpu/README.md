...
- status:  SUCCESS ✅
- runtime: 3:56.15
- date:    Thu Dec 14 08:19:00 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.33 sec
...
19/19 Test #19: test-backend-ops .................   Passed   27.06 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  37.85 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.00 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    0.04 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed    7.33 sec
...
main:  predict time =   437.70 ms / 6.84 ms per token
main:    total time =   665.48 ms
...
main:     load time =   132.94 ms
main:   sample time =    23.42 ms
main:  predict time =   448.71 ms / 6.41 ms per token
main:    total time =   607.11 ms
...
main:  predict time =  1460.16 ms
main:    total time =  1776.90 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd9608469c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd9606c71b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559b7b491ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd960846050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd96084b980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559b7b492980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd9606c71b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559b7b491ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559b7b4932f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559b7b492980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd960846050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559b7b493c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559b7b4932f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559b7b4945d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd9608469c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559b7b493c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559b7b4947a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559b7b4945d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd96084b980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559b7b494970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559b7b4947a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   124.76 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    56.36 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1153.77 ms /     1 runs ( 1153.77 ms per run)
whisper_print_timings:   decode time =    10.24 ms /     2 runs (    5.12 ms per run)
whisper_print_timings:   batchd time =   212.16 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1575.91 ms
...
main:     load time =    61.52 ms
main:    total time = 10580.70 ms
embd_img
...
main:      load time = 10407.60 ms
main:    sample time =   466.29 ms / 7.29 ms per token
main:      eval time = 20083.13 ms / 286.90 ms per token
main:     total time = 31615.13 ms
...
main:      load time =  3657.87 ms
main:    sample time =   464.92 ms / 7.26 ms per token
main:      eval time =  8060.81 ms / 115.15 ms per token
main:     total time = 12563.58 ms
