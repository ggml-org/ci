...
- status:  SUCCESS ✅
- runtime: 261.43
- date:    Thu Dec 14 10:16:57 EET 2023
...
16/20 Test #16: test-conv1d ......................   Passed    0.29 sec
...
20/20 Test #20: test-backend-ops .................   Passed   65.60 sec
...
18/21 Test #18: test-conv2d ......................   Passed    0.33 sec
...
21/21 Test #21: test-backend-ops .................   Passed   14.79 sec
...
main:  predict time =   302.10 ms / 4.72 ms per token
main:    total time =   466.15 ms
...
main:     load time =    94.49 ms
main:   sample time =     8.63 ms
main:  predict time =   307.43 ms / 4.39 ms per token
main:    total time =   411.40 ms
...
main:     n_decoded =      504
main:     load time =   116.13 ms
main:   sample time =    66.00 ms
main:  predict time =   762.55 ms
main:    total time =   955.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1101879b0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x1100081a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x108018230                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x110187040                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x11018c970                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x108019010                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x1100081a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x108018230                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x108019980                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x108019010                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x110187040                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x10801a2f0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x108019980                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x10801ac60                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1101879b0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x10801a2f0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x10801ae30                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x10801ac60                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x11018c970                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x10801b000                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x10801ae30                           node_4
...
whisper_print_timings:     load time =   141.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.33 ms
whisper_print_timings:   sample time =   134.24 ms /   131 runs (    1.02 ms per run)
whisper_print_timings:   encode time =   183.82 ms /     1 runs (  183.82 ms per run)
whisper_print_timings:   decode time =    18.67 ms /     2 runs (    9.34 ms per run)
whisper_print_timings:   batchd time =   198.43 ms /   125 runs (    1.59 ms per run)
