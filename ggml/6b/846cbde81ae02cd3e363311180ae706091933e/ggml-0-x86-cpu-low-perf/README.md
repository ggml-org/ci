...
- status:  SUCCESS ✅
- runtime: 3:00.23
- date:    Thu Dec 14 08:17:36 UTC 2023
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.74 sec
...
main:  predict time =   609.10 ms / 9.52 ms per token
main:    total time =   773.53 ms
...
main:  predict time =   626.25 ms / 8.95 ms per token
...
main:   sample time =   179.30 ms
main:  predict time =  2384.96 ms
main:    total time =  2716.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91c19549c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91c17d51b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55602e416ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91c1954050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91c1959980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55602e417980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91c17d51b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55602e416ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55602e4182f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55602e417980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91c1954050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55602e418c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55602e4182f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55602e4195d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91c19549c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55602e418c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55602e4197a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55602e4195d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91c1959980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55602e419970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55602e4197a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.00 ms
whisper_print_timings:   sample time =    71.68 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1974.49 ms /     1 runs ( 1974.49 ms per run)
whisper_print_timings:   decode time =    12.90 ms /     2 runs (    6.45 ms per run)
whisper_print_timings:   batchd time =   321.04 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2479.49 ms
...
main:     load time =    71.28 ms
main:    total time = 18684.14 ms
embd_img
