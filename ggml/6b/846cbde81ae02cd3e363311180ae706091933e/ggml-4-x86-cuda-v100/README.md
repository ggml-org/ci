...
- status:  SUCCESS ✅
- runtime: 8:06.68
- date:    Thu Dec 14 08:25:36 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.91 sec
...
19/19 Test #19: test-backend-ops .................   Passed   59.08 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 4/20 Test  #4: test-quantize-perf ...............   Passed    0.61 sec
...
20/20 Test #20: test-backend-ops .................   Passed   21.59 sec
...
main:     load time =   606.99 ms
main:   sample time =    35.27 ms
main:  predict time =   562.56 ms / 8.79 ms per token
main:    total time =  1225.41 ms
...
main:     load time =   588.76 ms
main:   sample time =    35.49 ms
main:  predict time =   618.96 ms / 8.84 ms per token
main:    total time =  1247.59 ms
...
main:     n_decoded =      504
main:     load time =   546.06 ms
main:   sample time =   241.36 ms
main:  predict time =  2243.38 ms
main:    total time =  3075.58 ms
...
main: loaded model in   417.49 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f88eadb69c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f88eac371b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555709fd2640                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f88eadb6050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f88eadbb980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555709fd3420                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f88eac371b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555709fd2640                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555709fd3d90                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555709fd3420                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f88eadb6050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555709fd4700                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555709fd3d90                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555709fd5070                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f88eadb69c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555709fd4700                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555709fd5240                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555709fd5070                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f88eadbb980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555709fd5410                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555709fd5240       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1184.90 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.65 ms
whisper_print_timings:   sample time =    68.21 ms /   131 runs (    0.52 ms per run)
...
whisper_print_timings:   batchd time =    84.61 ms /   125 runs (    0.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1412.59 ms
...
main:     load time =   541.09 ms
main:    total time =  7964.23 ms
embd_img
...
main:      load time =  7699.49 ms
main:    sample time =   529.16 ms / 8.27 ms per token
main:      eval time = 24881.92 ms / 355.46 ms per token
main:     total time = 33992.29 ms
...
main:      load time =  2032.02 ms
main:    sample time =   520.47 ms / 8.13 ms per token
main:      eval time = 12132.46 ms / 173.32 ms per token
main:     total time = 15333.42 ms
