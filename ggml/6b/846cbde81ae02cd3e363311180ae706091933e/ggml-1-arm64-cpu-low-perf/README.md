...
- status:  SUCCESS ✅
- runtime: 4:14.50
- date:    Thu Dec 14 08:19:55 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/6b846cbde81ae02cd3e363311180ae706091933e
- author:  chengchi
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.55 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.70 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   42.46 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.87 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.31 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.03 sec
...
main:     load time =   193.41 ms
main:   sample time =    18.63 ms
main:  predict time =   834.57 ms / 13.04 ms per token
main:    total time =  1068.53 ms
...
main:     load time =   195.53 ms
main:   sample time =    18.37 ms
main:  predict time =   906.82 ms / 12.95 ms per token
...
main:   sample time =   129.11 ms
main:  predict time =  6059.65 ms
main:    total time =  6440.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa14ea9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa136b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0a32eba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa14ea050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa14ef980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0a32f980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa136b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0a32eba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0a3302f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab0a32f980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa14ea050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0a330c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab0a3302f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0a3315d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa14ea9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab0a330c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0a3317a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab0a3315d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa14ef980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab0a331970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab0a3317a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.48 ms
whisper_print_timings:   sample time =    67.58 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4787.29 ms /     1 runs ( 4787.29 ms per run)
whisper_print_timings:   decode time =    15.50 ms /     2 runs (    7.75 ms per run)
whisper_print_timings:   batchd time =   720.43 ms /   125 runs (    5.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5723.32 ms
...
main:     load time =   100.17 ms
main:    total time = 40343.48 ms
embd_img
