...
- status:  SUCCESS ✅
- runtime: 5:20.45
- date:    Sun Mar  3 12:29:18 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   13.57 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.27 sec
...
22/22 Test #22: test-backend-ops .................   Passed  129.61 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 165.76 sec
...
23/23 Test #23: test-backend-ops .................   Passed   32.59 sec
...
main:     load time =   150.07 ms
main:   sample time =    17.10 ms
main:  predict time =   889.50 ms / 13.90 ms per token
main:    total time =  1078.51 ms
...
main:  predict time =   966.87 ms / 13.81 ms per token
main:    total time =  1136.75 ms
...
main:  predict time =  1013.44 ms / 14.48 ms per token
...
main:     n_decoded =      504
main:     load time =   150.34 ms
main:   sample time =   128.57 ms
main:  predict time =  6423.87 ms
main:    total time =  6785.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd03a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcebb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeecfcce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd03a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd03f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeecfdab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbcebb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeecfcce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeecfe410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeecfdab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbd03a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeecfed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeecfe410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeecff6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbd03a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeecfed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeecff890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeecff6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbd03f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeecffa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeecff890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.27 ms
whisper_print_timings:   sample time =    65.55 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4685.46 ms /     1 runs ( 4685.46 ms per run)
whisper_print_timings:   decode time =    15.33 ms /     2 runs (    7.67 ms per run)
whisper_print_timings:   batchd time =   710.61 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5599.75 ms
...
main:     load time =    91.58 ms
main:    total time = 39680.29 ms
embd_img
