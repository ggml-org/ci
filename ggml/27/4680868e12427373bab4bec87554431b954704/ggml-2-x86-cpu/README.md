...
- status:  SUCCESS ✅
- runtime: 3:58.44
- date:    Sun Mar  3 12:28:05 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/274680868e12427373bab4bec87554431b954704
- author:  leejet
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.45 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   12.23 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.98 sec
...
22/22 Test #22: test-backend-ops .................   Passed  106.27 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) = 137.16 sec
...
23/23 Test #23: test-backend-ops .................   Passed   26.31 sec
...
main:  predict time =   488.89 ms / 7.64 ms per token
main:    total time =   628.99 ms
...
main:     load time =   103.54 ms
main:   sample time =    23.49 ms
main:  predict time =   506.36 ms / 7.23 ms per token
main:    total time =   635.39 ms
...
main:     load time =   122.64 ms
main:   sample time =    23.75 ms
main:  predict time =   514.23 ms / 7.35 ms per token
main:    total time =   663.02 ms
...
main:   sample time =   175.27 ms
main:  predict time =  1811.59 ms
main:    total time =  2120.29 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f859eada990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f859e95b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56293f59dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f859eada030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f859eadf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56293f59eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f859e95b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56293f59dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56293f59f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56293f59eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f859eada030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56293f59fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56293f59f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56293f5a06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f859eada990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56293f59fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56293f5a0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56293f5a06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f859eadf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56293f5a0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56293f5a0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.91 ms
whisper_print_timings:   sample time =    54.48 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1188.02 ms /     1 runs ( 1188.02 ms per run)
whisper_print_timings:   decode time =    12.28 ms /     2 runs (    6.14 ms per run)
whisper_print_timings:   batchd time =   213.04 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1564.47 ms
...
main:     load time =    67.37 ms
main:    total time = 10698.88 ms
embd_img
