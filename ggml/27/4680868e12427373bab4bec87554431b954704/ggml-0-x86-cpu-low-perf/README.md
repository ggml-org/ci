...
- status:  SUCCESS ✅
- runtime: 5:15.22
- date:    Sun Mar  3 12:29:12 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.01 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   12.25 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   24.56 sec
      Start  9: test3
...
22/22 Test #22: test-backend-ops .................   Passed  107.76 sec
...
21/22 Test #21: test-backend-buffer ..............   Passed    0.00 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   25.62 sec

100% tests passed, 0 tests failed out of 22

Total Test time (real) =  69.36 sec
...
main:  predict time =   713.99 ms / 11.16 ms per token
main:    total time =   859.01 ms
...
main:  predict time =   755.74 ms / 10.80 ms per token
main:    total time =   890.47 ms
...
main:     load time =   129.09 ms
main:   sample time =    23.83 ms
main:  predict time =   758.42 ms / 10.83 ms per token
main:    total time =   913.93 ms
...
main:     n_decoded =      504
main:     load time =   107.16 ms
main:   sample time =   175.94 ms
main:  predict time =  3128.65 ms
main:    total time =  3457.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc4bc80d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc4bc68e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560464677ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc4bc80d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc4bc812940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560464678ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc4bc68e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560464677ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560464679410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560464678ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc4bc80d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560464679d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560464679410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56046467a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc4bc80d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560464679d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56046467a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56046467a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc4bc812940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56046467aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56046467a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.69 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.69 ms
whisper_print_timings:   sample time =    72.21 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2056.19 ms /     1 runs ( 2056.19 ms per run)
whisper_print_timings:   decode time =    16.56 ms /     2 runs (    8.28 ms per run)
whisper_print_timings:   batchd time =   333.31 ms /   125 runs (    2.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2581.36 ms
...
main:     load time =    70.86 ms
main:    total time = 19462.24 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.478000 sec.)
