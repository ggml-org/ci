...
- status:  SUCCESS ✅
- runtime: 2:49.23
- date:    Sun Jul 23 14:57:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/10 Test  #1: test-grad0 .......................   Passed    2.80 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/11 Test  #1: test-grad0 .......................   Passed    2.71 sec
      Start  2: test-opt
 2/11 Test  #2: test-opt .........................   Passed   33.84 sec
...
main:  predict time =   436.90 ms / 6.83 ms per token
main:    total time =   632.52 ms
...
main:  predict time =   446.78 ms / 6.38 ms per token
main:    total time =   626.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb646d4d870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb646bce140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563c4e51daa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb646d4cf70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb646d527c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563c4e51e810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb646bce140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563c4e51daa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563c4e51f110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563c4e51e810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb646d4cf70                         fc1_bias

DST    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0x563c4e51fa10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563c4e51f110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563c4e520310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb646d4d870                       fc2_weight
SRC    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0x563c4e51fa10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563c4e520470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563c4e520310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb646d527c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563c4e5205d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563c4e520470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4441.13 ms
main:    sample time =   467.79 ms / 7.31 ms per token
main:      eval time = 19994.58 ms / 285.64 ms per token
main:     total time = 26008.32 ms
...
main:      load time =  1248.26 ms
main:    sample time =   465.51 ms / 7.27 ms per token
main:      eval time =  8044.72 ms / 114.92 ms per token
main:     total time = 10195.06 ms
...
```diff
--- /home/ggml/results/ggml/3a/ccb95942d1f6b4f6b7b6a2e854b4f0beaef3d3/ggml-2-x86-cpu/stdall	2023-07-23 14:54:05.202364458 +0000
+++ /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/stdall	2023-07-23 14:57:13.082515280 +0000
@@ -1,6 +1,6 @@
...
+rm: cannot remove '/home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/*.md': No such file or directory
...
++ tee /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/3a/ccb95942d1f6b4f6b7b6a2e854b4f0beaef3d3/ggml-2-x86-cpu/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_debug-cmake.log
...
+sys	0m0.102s
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_debug-make.log
 + make -j
...
+[ 83%] Linking CXX executable ../../bin/starcoder
...
+user	0m34.621s
+sys	0m3.556s
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_release.log
 + rm -rf build-ci-release
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/3a/ccb95942d1f6b4f6b7b6a2e854b4f0beaef3d3/ggml-2-x86-cpu/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_release-cmake.log
...
+user	0m0.292s
+sys	0m0.099s
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_release-make.log
 + make -j
...
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/ctest_release-ctest.log
 + ctest --output-on-failure
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
++ tee /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/gpt_2.log
 + cd /home/ggml/work/ggml
...
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -495,7 +495,7 @@
...
++ set +x
++ gg_run_mnist
++ tee /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/mnist.log
++ cd /home/ggml/work/ggml
++ cd build-ci-release
++ set -e
...
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/mnist-mnist.log
++ ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
++ tee /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/mpt.log
...
+2023-07-23 14:55:43 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/config.json [1227/1227] -> "config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 14:55:43 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer.json [2113738/2113738] -> "tokenizer.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 14:55:43 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/tokenizer_config.json [237/237] -> "tokenizer_config.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 14:55:43 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/pytorch_model.bin.index.json [16023/16023] -> "pytorch_model.bin.index.json" [1]
 + cd /home/ggml/work/ggml
...
+2023-07-23 14:55:43 URL:https://huggingface.co/mosaicml/mpt-7b/raw/main/configuration_mpt.py [9198/9198] -> "configuration_mpt.py" [1]
 + cd /home/ggml/work/ggml
...
+main: quantize time = 28193.75 ms
+main:    total time = 28193.76 ms
++ tee -a /home/ggml/results/ggml/27/e2c5b63484bde71667d7a48c53a82d0434f620/ggml-2-x86-cpu/mpt-tg.log
 + ./bin/mpt --model ../models-mnt/mpt/7B/ggml-model-f16.bin -s 1234 -n 64 -p 'I believe the meaning of life is'
 main: seed      = 1234
 main: n_threads = 4
@@ -1094,16 +1352,16 @@
