...
- status:  SUCCESS ✅
- runtime: 3:21.90
- date:    Tue Aug 22 10:46:43 UTC 2023
...
Total Test time (real) =  12.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.39 sec
      Start  2: test-opt
...
main:     load time =   171.53 ms
main:   sample time =    17.84 ms
main:  predict time =   804.61 ms / 12.57 ms per token
main:    total time =  1062.11 ms
...
main:  predict time =   873.97 ms / 12.49 ms per token
main:    total time =  1117.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9caba8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c93b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaddd44ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cab9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cabf800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaddd45830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c93b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaddd44ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaddd46140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaddd45830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9cab9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaddd46a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaddd46140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaddd47360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9caba8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaddd46a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaddd474d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaddd47360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9cabf800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaddd47640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaddd474d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5435.14 ms
main:    sample time =   610.84 ms / 9.54 ms per token
main:      eval time = 44109.47 ms / 630.14 ms per token
main:     total time = 52541.52 ms
...
main:      load time =  1725.82 ms
main:    sample time =   619.24 ms / 9.68 ms per token
main:      eval time = 17382.42 ms / 248.32 ms per token
main:     total time = 20697.48 ms
