...
- status:  SUCCESS ✅
- runtime: 2:17.36
- date:    Tue Aug 22 10:44:40 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.60 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.53 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.30 sec
...
main:     load time =   131.05 ms
main:   sample time =    23.41 ms
main:  predict time =   420.24 ms / 6.57 ms per token
main:    total time =   608.58 ms
...
main:  predict time =   443.34 ms / 6.33 ms per token
main:    total time =   621.16 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf8f3608a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf8f1e1150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d3e91adab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf8f35ff90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf8f365800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d3e91ae830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdf8f1e1150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d3e91adab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d3e91af140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d3e91ae830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdf8f35ff90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d3e91afa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d3e91af140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d3e91b0360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdf8f3608a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d3e91afa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d3e91b04d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d3e91b0360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdf8f365800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d3e91b0640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d3e91b04d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4473.28 ms
main:    sample time =   467.17 ms / 7.30 ms per token
main:      eval time = 19051.99 ms / 272.17 ms per token
main:     total time = 24650.76 ms
...
main:      load time =  1196.67 ms
main:    sample time =   463.85 ms / 7.25 ms per token
main:      eval time =  7962.04 ms / 113.74 ms per token
main:     total time =  9996.31 ms
