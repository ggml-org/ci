...
- status:  SUCCESS ✅
- runtime: 4:05.55
- date:    Thu Dec  7 12:12:21 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    3.42 sec
...
19/19 Test #19: test-backend-ops .................   Passed   42.66 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  53.57 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.29 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    8.65 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  17.05 sec
...
main:     load time =   193.62 ms
main:   sample time =    23.42 ms
main:  predict time =   446.24 ms / 6.97 ms per token
main:    total time =   675.83 ms
...
main:     load time =   129.93 ms
main:   sample time =    23.48 ms
main:  predict time =   453.42 ms / 6.48 ms per token
main:    total time =   608.80 ms
...
main:     n_decoded =      504
main:     load time =   109.89 ms
main:   sample time =   177.94 ms
main:  predict time =  1464.18 ms
main:    total time =  1784.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7eff4b51d960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7eff4b39e190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5565e002bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7eff4b51d010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7eff4b522900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5565e002c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7eff4b39e190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5565e002bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5565e002d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5565e002c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7eff4b51d010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5565e002dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5565e002d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5565e002e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7eff4b51d960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5565e002dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5565e002e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5565e002e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7eff4b522900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5565e002e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5565e002e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   133.26 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.29 ms
whisper_print_timings:   sample time =    54.51 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1152.28 ms /     1 runs ( 1152.28 ms per run)
whisper_print_timings:   decode time =     9.43 ms /     2 runs (    4.72 ms per run)
whisper_print_timings:   batchd time =   207.25 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1575.93 ms
...
main:     load time =    60.99 ms
main:    total time = 10562.27 ms
embd_img
...
main:      load time = 14611.04 ms
main:    sample time =   470.03 ms / 7.34 ms per token
main:      eval time = 20314.80 ms / 290.21 ms per token
main:     total time = 36074.71 ms
...
main:      load time =  4393.78 ms
main:    sample time =   464.28 ms / 7.25 ms per token
main:      eval time =  7942.36 ms / 113.46 ms per token
main:     total time = 13181.39 ms
