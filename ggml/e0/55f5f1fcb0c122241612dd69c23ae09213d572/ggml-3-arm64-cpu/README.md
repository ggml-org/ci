...
- status:  SUCCESS ✅
- runtime: 22:58.30
- date:    Fri Jan 26 01:42:47 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  125.36 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.29 sec
...
main:     load time =   214.82 ms
main:   sample time =    16.98 ms
main:  predict time =   847.71 ms / 13.25 ms per token
main:    total time =  1101.35 ms
...
main:     load time =   183.54 ms
main:   sample time =    17.82 ms
main:  predict time =   929.15 ms / 13.27 ms per token
main:    total time =  1133.62 ms
...
main:     n_decoded =      504
main:     load time =   153.26 ms
main:   sample time =   128.33 ms
main:  predict time =  5990.91 ms
main:    total time =  6354.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb854a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb83cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0396ab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb854a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb854f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0396b960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb83cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0396ab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0396c2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0396b960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb854a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0396cc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0396c2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0396d580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb854a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0396cc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0396d740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0396d580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb854f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0396d900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0396d740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   190.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.43 ms
whisper_print_timings:   sample time =    65.17 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4620.71 ms /     1 runs ( 4620.71 ms per run)
whisper_print_timings:   decode time =    15.79 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   705.66 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5615.96 ms
...
main:     load time =    85.25 ms
main:    total time = 39677.24 ms
embd_img
...
main:      load time =  5987.49 ms
main:    sample time =   518.26 ms / 8.10 ms per token
main:      eval time = 43843.50 ms / 626.34 ms per token
main:     total time = 52722.52 ms
...
main:      load time =  1612.16 ms
main:    sample time =   516.58 ms / 8.07 ms per token
main:      eval time = 17325.44 ms / 247.51 ms per token
main:     total time = 20410.33 ms
