...
- status:  SUCCESS ✅
- runtime: 7:13.50
- date:    Wed Jan 17 07:08:55 PM UTC 2024
...
Total Test time (real) = 139.14 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.06 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   24.52 sec
...
main:     load time =   179.03 ms
main:   sample time =    17.12 ms
main:  predict time =   848.59 ms / 13.26 ms per token
...
main:     load time =   178.50 ms
main:   sample time =    16.94 ms
main:  predict time =   920.96 ms / 13.16 ms per token
...
main:  predict time =  5979.19 ms
main:    total time =  6338.11 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa54da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa535b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacf4bab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa54da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa54df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacf4bb960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa535b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacf4bab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacf4bc2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacf4bb960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa54da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacf4bcc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacf4bc2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacf4bd580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa54da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacf4bcc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacf4bd740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacf4bd580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa54df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacf4bd900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacf4bd740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   166.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.37 ms
whisper_print_timings:   sample time =    65.78 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4629.99 ms /     1 runs ( 4629.99 ms per run)
whisper_print_timings:   decode time =    15.88 ms /     2 runs (    7.94 ms per run)
whisper_print_timings:   batchd time =   706.64 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.55 ms
...
main:     load time =    83.66 ms
main:    total time = 39646.79 ms
embd_img
...
main:      load time =  6045.04 ms
main:    sample time =   518.86 ms / 8.11 ms per token
main:      eval time = 43811.06 ms / 625.87 ms per token
main:     total time = 52748.02 ms
...
main:      load time =  1522.52 ms
main:    sample time =   521.29 ms / 8.15 ms per token
main:      eval time = 17278.99 ms / 246.84 ms per token
main:     total time = 20279.67 ms
