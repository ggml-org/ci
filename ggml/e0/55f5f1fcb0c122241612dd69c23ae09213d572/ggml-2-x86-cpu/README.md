...
- status:  SUCCESS ✅
- runtime: 5:01.73
- date:    Fri Jan 26 13:03:37 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.37 sec
...
20/20 Test #20: test-backend-ops .................   Passed  112.83 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.78 sec
...
main:     load time =   122.42 ms
main:   sample time =    23.34 ms
main:  predict time =   468.43 ms / 6.69 ms per token
main:    total time =   616.49 ms
...
main:  predict time =  1533.24 ms
main:    total time =  1848.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc34d121990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc34cfa21a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ea68cecb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc34d121030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc34d126940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ea68ced960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc34cfa21a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ea68cecb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ea68cee2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55ea68ced960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc34d121030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ea68ceec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55ea68cee2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ea68cef580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc34d121990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55ea68ceec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ea68cef740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55ea68cef580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc34d126940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55ea68cef900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55ea68cef740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   126.85 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.21 ms
whisper_print_timings:   sample time =    55.25 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1164.92 ms /     1 runs ( 1164.92 ms per run)
whisper_print_timings:   decode time =     9.81 ms /     2 runs (    4.90 ms per run)
whisper_print_timings:   batchd time =   206.66 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1581.80 ms
...
main:     load time =    60.56 ms
main:    total time = 10643.31 ms
embd_img
...
main:      load time =  5082.52 ms
main:    sample time =   467.55 ms / 7.31 ms per token
main:      eval time = 19702.04 ms / 281.46 ms per token
main:     total time = 25919.69 ms
...
main:      load time =  1197.10 ms
main:    sample time =   465.23 ms / 7.27 ms per token
main:      eval time =  8217.14 ms / 117.39 ms per token
main:     total time = 10257.82 ms
