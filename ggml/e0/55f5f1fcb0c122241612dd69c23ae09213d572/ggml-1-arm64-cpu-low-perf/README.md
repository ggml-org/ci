...
- status:  SUCCESS ✅
- runtime: 5:36.37
- date:    Fri Jan 26 12:45:29 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.44 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.06 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  149.20 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 172.17 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.16 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.11 sec
...
main:     load time =   197.15 ms
main:   sample time =    17.43 ms
main:  predict time =   880.56 ms / 13.76 ms per token
main:    total time =  1117.40 ms
...
main:  predict time =   936.92 ms / 13.38 ms per token
main:    total time =  1160.71 ms
...
main:     n_decoded =      504
main:     load time =   164.85 ms
main:   sample time =   128.55 ms
main:  predict time =  6166.35 ms
main:    total time =  6542.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0ada990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb095b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed68eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0ada030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0adf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaed68f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb095b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaed68eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaed6902c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaed68f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb0ada030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaed690c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaed6902c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaed691580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb0ada990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaed690c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaed691740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaed691580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb0adf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaed691900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaed691740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    66.33 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4644.11 ms /     1 runs ( 4644.11 ms per run)
whisper_print_timings:   decode time =    16.18 ms /     2 runs (    8.09 ms per run)
whisper_print_timings:   batchd time =   834.40 ms /   125 runs (    6.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5690.81 ms
...
main:     load time =    89.34 ms
main:    total time = 40683.32 ms
embd_img
