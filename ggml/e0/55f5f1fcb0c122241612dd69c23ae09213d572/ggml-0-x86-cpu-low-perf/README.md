...
- status:  SUCCESS ✅
- runtime: 4:21.24
- date:    Fri Jan 26 12:39:58 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/e055f5f1fcb0c122241612dd69c23ae09213d572
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.89 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.42 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  113.44 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 135.83 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.09 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.28 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.80 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  37.26 sec
...
main:     load time =   129.57 ms
main:   sample time =    23.57 ms
main:  predict time =   617.11 ms / 9.64 ms per token
main:    total time =   783.60 ms
...
main:     load time =   135.84 ms
main:   sample time =    23.38 ms
main:  predict time =   657.95 ms / 9.40 ms per token
main:    total time =   819.58 ms
...
main:   sample time =   178.14 ms
main:  predict time =  2492.77 ms
main:    total time =  2822.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc290117990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc28ff981a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56279de3db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc290117030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc29011c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56279de3e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc28ff981a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56279de3db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56279de3f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56279de3e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc290117030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56279de3fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56279de3f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56279de40580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc290117990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56279de3fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56279de40740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56279de40580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc29011c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56279de40900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56279de40740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.09 ms
whisper_print_timings:   sample time =    71.87 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1992.26 ms /     1 runs ( 1992.26 ms per run)
whisper_print_timings:   decode time =    12.65 ms /     2 runs (    6.33 ms per run)
whisper_print_timings:   batchd time =   321.47 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2501.52 ms
...
main:     load time =    67.46 ms
main:    total time = 18992.16 ms
embd_img
