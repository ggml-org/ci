...
- status:  SUCCESS ✅
- runtime: 11:51.83
- date:    Wed Jan 17 19:18:47 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.11 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.57 sec
      Start  7: test1
...
20/20 Test #20: test-backend-ops .................   Passed  260.61 sec
...
21/21 Test #21: test-backend-ops .................   Passed   47.13 sec
...
main:     load time =   590.75 ms
main:   sample time =    34.11 ms
main:  predict time =   582.81 ms / 9.11 ms per token
main:    total time =  1227.78 ms
...
main:     load time =   567.32 ms
main:   sample time =    34.30 ms
main:  predict time =   610.17 ms / 8.72 ms per token
main:    total time =  1216.34 ms
...
main:     n_decoded =      504
main:     load time =   553.54 ms
main:   sample time =   238.72 ms
main:  predict time =  2506.61 ms
main:    total time =  3347.38 ms
...
main: loaded model in   400.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f71834f9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f718337a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5559f66b5ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f71834f9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f71834fe940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5559f66b6880                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f718337a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5559f66b5ab0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5559f66b71e0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5559f66b6880                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f71834f9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5559f66b7b40                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5559f66b71e0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5559f66b84a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f71834f9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5559f66b7b40                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5559f66b8660                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5559f66b84a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f71834fe940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5559f66b8820                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5559f66b8660       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   833.80 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.83 ms
whisper_print_timings:   sample time =    66.12 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    25.35 ms /     1 runs (   25.35 ms per run)
whisper_print_timings:   decode time =    21.01 ms /     2 runs (   10.51 ms per run)
whisper_print_timings:   batchd time =    80.94 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1053.68 ms
...
main:     load time =   705.86 ms
main:    total time =  8085.27 ms
embd_img
...
main:      load time =  8203.69 ms
main:    sample time =   553.95 ms / 8.66 ms per token
main:      eval time = 26999.86 ms / 385.71 ms per token
main:     total time = 36644.07 ms
...
main:      load time =  2168.58 ms
main:    sample time =   542.97 ms / 8.48 ms per token
main:      eval time = 12719.04 ms / 181.70 ms per token
main:     total time = 16089.70 ms
