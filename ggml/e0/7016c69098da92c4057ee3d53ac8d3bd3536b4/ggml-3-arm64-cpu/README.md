...
- status:  SUCCESS ✅
- runtime: 5:23.05
- date:    Fri Dec 29 07:49:14 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.38 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.53 sec
...
20/20 Test #20: test-backend-ops .................   Passed   10.18 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  18.81 sec
...
main:     load time =   179.60 ms
main:   sample time =    17.13 ms
main:  predict time =   878.09 ms / 12.54 ms per token
...
main:   sample time =   128.78 ms
main:  predict time =  5890.78 ms
main:    total time =  6253.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80f0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80d8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeaa8cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80f0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80f0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa8d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff80d8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaeaa8cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa8e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa8d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff80f0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa8ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa8e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeaa8f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff80f0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaeaa8ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeaa8f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaeaa8f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff80f0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaeaa8f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaeaa8f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   170.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.63 ms
whisper_print_timings:   sample time =    65.07 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4654.68 ms /     1 runs ( 4654.68 ms per run)
whisper_print_timings:   decode time =    15.27 ms /     2 runs (    7.63 ms per run)
whisper_print_timings:   batchd time =   708.25 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5631.42 ms
...
main:     load time =    79.17 ms
main:    total time = 39537.36 ms
embd_img
...
main:      load time =  5832.54 ms
main:    sample time =   518.11 ms / 8.10 ms per token
main:      eval time = 43596.46 ms / 622.81 ms per token
main:     total time = 52322.41 ms
...
main:      load time =  1537.30 ms
main:    sample time =   515.88 ms / 8.06 ms per token
main:      eval time = 16943.78 ms / 242.05 ms per token
main:     total time = 19952.56 ms
