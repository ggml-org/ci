...
- status:  SUCCESS ✅
- runtime: 3:34.80
- date:    Fri Dec 29 07:47:17 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.56 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.87 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   42.72 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.89 sec
...
main:     load time =   196.28 ms
main:   sample time =    18.04 ms
main:  predict time =   984.49 ms / 15.38 ms per token
main:    total time =  1220.78 ms
...
main:     load time =   191.41 ms
main:   sample time =    17.89 ms
main:  predict time =   912.57 ms / 13.04 ms per token
main:    total time =  1124.93 ms
...
main:  predict time =  6057.68 ms
main:    total time =  6435.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9acaa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ab2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaefa3db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9acaa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9acaf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaefa3e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ab2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaefa3db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaefa3f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaefa3e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9acaa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaefa3fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaefa3f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaefa40580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9acaa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaefa3fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaefa40740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaefa40580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9acaf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaefa40900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaefa40740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.70 ms
whisper_print_timings:   sample time =    67.22 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4850.89 ms /     1 runs ( 4850.89 ms per run)
whisper_print_timings:   decode time =    15.68 ms /     2 runs (    7.84 ms per run)
whisper_print_timings:   batchd time =   720.60 ms /   125 runs (    5.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5787.13 ms
...
main:     load time =    98.07 ms
main:    total time = 40424.15 ms
embd_img
