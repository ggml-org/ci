...
- status:  SUCCESS ✅
- runtime: 2:49.00
- date:    Fri Dec 29 07:46:37 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.85 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.22 sec
      Start  9: test3
...
main:     load time =   129.44 ms
main:   sample time =    23.48 ms
main:  predict time =   601.17 ms / 9.39 ms per token
main:    total time =   766.83 ms
...
main:     load time =   129.06 ms
main:   sample time =    23.49 ms
main:  predict time =   631.38 ms / 9.02 ms per token
main:    total time =   786.15 ms
...
main:  predict time =  2380.12 ms
main:    total time =  2710.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5d4a530990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5d4a3b11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55589666fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5d4a530030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5d4a535940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555896670960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5d4a3b11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55589666fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5558966712c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555896670960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5d4a530030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555896671c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5558966712c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555896672580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5d4a530990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555896671c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555896672740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555896672580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5d4a535940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555896672900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555896672740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.54 ms
whisper_print_timings:   sample time =    71.75 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2011.27 ms /     1 runs ( 2011.27 ms per run)
whisper_print_timings:   decode time =    12.64 ms /     2 runs (    6.32 ms per run)
whisper_print_timings:   batchd time =   322.60 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2520.70 ms
...
main:     load time =    70.93 ms
main:    total time = 18824.50 ms
embd_img
