...
- status:  SUCCESS ✅
- runtime: 3:35.71
- date:    Fri Dec 29 07:47:30 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.66 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.40 sec
...
main:     load time =   183.29 ms
main:   sample time =    23.37 ms
main:  predict time =   434.19 ms / 6.78 ms per token
main:    total time =   653.56 ms
...
main:  predict time =   447.58 ms / 6.39 ms per token
main:    total time =   596.53 ms
...
main:   sample time =   177.56 ms
main:  predict time =  1464.86 ms
main:    total time =  1775.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc67a476990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc67a2f71a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f1f94cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc67a476030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc67a47b940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555f1f94d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc67a2f71a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555f1f94cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555f1f94e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555f1f94d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc67a476030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555f1f94ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555f1f94e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555f1f94f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc67a476990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555f1f94ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555f1f94f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555f1f94f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc67a47b940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555f1f94f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555f1f94f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   120.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.09 ms
whisper_print_timings:   sample time =    54.20 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1151.53 ms /     1 runs ( 1151.53 ms per run)
whisper_print_timings:   decode time =     9.67 ms /     2 runs (    4.84 ms per run)
whisper_print_timings:   batchd time =   206.76 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1560.48 ms
...
main:     load time =    62.74 ms
main:    total time = 10566.34 ms
embd_img
...
main:      load time =  5297.04 ms
main:    sample time =   468.85 ms / 7.33 ms per token
main:      eval time = 20131.44 ms / 287.59 ms per token
main:     total time = 26580.09 ms
...
main:      load time =  1203.08 ms
main:    sample time =   466.35 ms / 7.29 ms per token
main:      eval time =  8064.11 ms / 115.20 ms per token
main:     total time = 10106.21 ms
