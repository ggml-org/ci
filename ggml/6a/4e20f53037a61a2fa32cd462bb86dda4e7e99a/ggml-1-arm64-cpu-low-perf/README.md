...
- status:  SUCCESS ✅
- runtime: 2:30.15
- date:    Fri Oct 20 06:59:56 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.59 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.11 sec
      Start  9: test3
...
main:  predict time =   816.01 ms / 12.75 ms per token
main:    total time =  1001.54 ms
...
main:  predict time =   884.06 ms / 12.63 ms per token
main:    total time =  1048.10 ms
...
main:   sample time =   128.17 ms
main:  predict time =  6021.96 ms
main:    total time =  6376.46 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8feea900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fd6b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaade684ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8fee9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8feef880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaade685870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8fd6b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaade684ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaade6861a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaade685870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8fee9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaade686ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaade6861a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaade687400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8feea900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaade686ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaade687590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaade687400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8feef880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaade687720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaade687590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4616.26 ms /     1 runs ( 4616.26 ms per run)
whisper_print_timings:   decode time =   182.79 ms /    27 runs (    6.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5005.68 ms
