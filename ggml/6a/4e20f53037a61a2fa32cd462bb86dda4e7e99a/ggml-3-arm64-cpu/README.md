...
- status:  SUCCESS ✅
- runtime: 4:49.09
- date:    Fri Oct 20 07:02:16 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.60 sec
      Start  2: test-opt
...
main:     load time =   152.87 ms
main:   sample time =    16.98 ms
main:  predict time =   802.26 ms / 12.54 ms per token
main:    total time =   995.25 ms
...
main:  predict time =   867.82 ms / 12.40 ms per token
main:    total time =  1033.88 ms
...
main:  predict time =  5861.22 ms
main:    total time =  6214.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9b35a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9b1db170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacb261ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9b359fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9b35f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacb262870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9b1db170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacb261ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacb2631a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaacb262870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9b359fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacb263ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaacb2631a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacb264400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9b35a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaacb263ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacb264590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaacb264400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9b35f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaacb264720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaacb264590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   218.35 ms
...
whisper_print_timings:   decode time =   179.69 ms /    27 runs (    6.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5088.25 ms
...
main:     load time =    82.37 ms
main:    total time = 39331.29 ms
embd_img
...
main:      load time = 13442.56 ms
main:    sample time =   521.93 ms / 8.16 ms per token
main:      eval time = 43574.65 ms / 622.49 ms per token
main:     total time = 59914.57 ms
...
main:      load time =  4369.96 ms
main:    sample time =   513.94 ms / 8.03 ms per token
main:      eval time = 17396.41 ms / 248.52 ms per token
main:     total time = 23244.20 ms
