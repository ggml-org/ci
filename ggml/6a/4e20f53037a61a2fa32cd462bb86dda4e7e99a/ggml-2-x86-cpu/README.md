...
- status:  SUCCESS ✅
- runtime: 3:09.17
- date:    Fri Oct 20 07:00:39 UTC 2023
...
main:  predict time =   450.27 ms / 7.04 ms per token
...
main:  predict time =   473.39 ms / 6.76 ms per token
main:    total time =   607.76 ms
...
main:  predict time =  1528.58 ms
main:    total time =  1848.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f45f9f81900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f45f9e02170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ce130cad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f45f9f80fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f45f9f86880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ce130d870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f45f9e02170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ce130cad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ce130e1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ce130d870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f45f9f80fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558ce130ead0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ce130e1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ce130f400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f45f9f81900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558ce130ead0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ce130f590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ce130f400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f45f9f86880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558ce130f720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ce130f590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    15.85 ms /    27 runs (    0.59 ms per run)
whisper_print_timings:   encode time =  1146.93 ms /     1 runs ( 1146.93 ms per run)
whisper_print_timings:   decode time =   104.49 ms /    27 runs (    3.87 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1458.84 ms
...
main:     load time =    65.05 ms
main:    total time = 10480.61 ms
embd_img
...
main:      load time = 11689.86 ms
main:    sample time =   468.48 ms / 7.32 ms per token
main:      eval time = 21053.00 ms / 300.76 ms per token
main:     total time = 33947.65 ms
...
main:      load time =  4366.57 ms
main:    sample time =   464.33 ms / 7.26 ms per token
main:      eval time =  8473.58 ms / 121.05 ms per token
main:     total time = 13705.99 ms
