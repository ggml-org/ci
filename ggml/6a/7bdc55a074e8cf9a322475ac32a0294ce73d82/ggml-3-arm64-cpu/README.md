...
- status:  SUCCESS ✅
- runtime: 4:47.03
- date:    Mon Oct 30 05:56:18 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.42 sec
...
main:     load time =   269.42 ms
main:   sample time =    17.01 ms
main:  predict time =   809.58 ms / 12.65 ms per token
main:    total time =  1118.16 ms
...
main:  predict time =   879.80 ms / 12.57 ms per token
main:    total time =  1084.58 ms
...
main:     n_decoded =      504
main:     load time =   145.88 ms
main:   sample time =   126.95 ms
main:  predict time =  5857.82 ms
main:    total time =  6211.20 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f8da900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f75b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8decb60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f8d9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f8df880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae8ded900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f75b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8decb60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae8dee230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae8ded900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f8d9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae8deeb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae8dee230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae8def490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f8da900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae8deeb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae8def620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae8def490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f8df880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae8def7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae8def620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   218.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.58 ms
whisper_print_timings:   sample time =    20.85 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4606.30 ms /     1 runs ( 4606.30 ms per run)
whisper_print_timings:   decode time =   179.20 ms /    27 runs (    6.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5084.01 ms
...
main:      load time = 11879.53 ms
main:    sample time =   534.11 ms / 8.35 ms per token
main:      eval time = 43609.40 ms / 622.99 ms per token
main:     total time = 58394.95 ms
...
main:      load time =  4358.60 ms
main:    sample time =   525.45 ms / 8.21 ms per token
main:      eval time = 17260.16 ms / 246.57 ms per token
main:     total time = 23104.24 ms
