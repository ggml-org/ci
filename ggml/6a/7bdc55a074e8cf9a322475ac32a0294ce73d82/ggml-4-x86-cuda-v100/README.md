...
- status:  SUCCESS ✅
- runtime: 5:45.79
- date:    Mon Oct 30 17:57:20 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.08 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.21 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.13 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.07 sec
...
main:     load time =   193.68 ms
main:   sample time =    34.59 ms
main:  predict time =   595.67 ms / 9.31 ms per token
main:    total time =   847.07 ms
...
main:     load time =   188.37 ms
main:   sample time =    34.75 ms
main:  predict time =   596.79 ms / 8.53 ms per token
main:    total time =   823.70 ms
...
main:     n_decoded =      504
main:     load time =   159.80 ms
main:   sample time =   235.85 ms
main:  predict time =  2288.40 ms
main:    total time =  2726.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8a7aefa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8a7ad7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ef54449b60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8a7aef9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8a7aeff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ef5444a900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8a7ad7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ef54449b60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ef5444b230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ef5444a900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8a7aef9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ef5444bb60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ef5444b230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ef5444c490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8a7aefa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ef5444bb60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ef5444c620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ef5444c490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8a7aeff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55ef5444c7b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ef5444c620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   705.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.51 ms
whisper_print_timings:   sample time =    20.39 ms /    27 runs (    0.76 ms per run)
whisper_print_timings:   encode time =  1821.87 ms /     1 runs ( 1821.87 ms per run)
whisper_print_timings:   decode time =   132.28 ms /    27 runs (    4.90 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2755.32 ms
...
main:     load time =    98.50 ms
main:    total time = 16758.70 ms
embd_img
...
main:      load time =  7498.54 ms
main:    sample time =   593.55 ms / 9.27 ms per token
main:      eval time = 25327.38 ms / 361.82 ms per token
main:     total time = 34369.38 ms
...
main:      load time =  1667.20 ms
main:    sample time =   594.10 ms / 9.28 ms per token
main:      eval time = 12538.18 ms / 179.12 ms per token
main:     total time = 15452.27 ms
