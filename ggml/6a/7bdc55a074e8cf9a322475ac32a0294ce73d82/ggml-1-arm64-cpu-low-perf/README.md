...
- status:  SUCCESS ✅
- runtime: 2:38.73
- date:    Mon Oct 30 05:54:06 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.09 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.52 sec
      Start  6: test0
 6/14 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.45 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.78 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    8.92 sec
      Start  9: test3
 9/14 Test  #9: test3 ............................   Passed    0.53 sec
      Start 10: test-pool
10/14 Test #10: test-pool ........................   Passed    0.01 sec
      Start 11: test-conv-transpose
...
Total Test time (real) =  16.60 sec
...
main:     load time =   189.34 ms
main:   sample time =    17.73 ms
main:  predict time =   832.18 ms / 13.00 ms per token
main:    total time =  1061.39 ms
...
main:     load time =   193.71 ms
main:   sample time =    17.73 ms
main:  predict time =   895.52 ms / 12.79 ms per token
main:    total time =  1109.88 ms
...
main:     n_decoded =      504
main:     load time =   164.99 ms
main:   sample time =   127.82 ms
main:  predict time =  6041.43 ms
main:    total time =  6415.35 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa283a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa26bb170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab17d2eb60                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2839fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa283f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab17d2f900                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa26bb170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab17d2eb60                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab17d30230                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab17d2f900                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2839fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab17d30b60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab17d30230                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab17d31490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa283a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab17d30b60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab17d31620                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab17d31490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa283f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab17d317b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab17d31620       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   116.32 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.72 ms
whisper_print_timings:   sample time =    21.01 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4710.68 ms /     1 runs ( 4710.68 ms per run)
whisper_print_timings:   decode time =   211.89 ms /    27 runs (    7.85 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5124.04 ms
...
main:     load time =    91.55 ms
main:    total time = 40194.48 ms
embd_img
