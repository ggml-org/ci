...
- status:  SUCCESS ✅
- runtime: 11:33.47
- date:    Mon Jan 29 12:06:30 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/2154c162a95c01985db55de6ba6e8fb6ef704ba4
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.52 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.55 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.82 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    2.04 sec
      Start 10: test-pool
...
14/20 Test #14: test-customop ....................   Passed    0.54 sec
      Start 15: test-xpos
15/20 Test #15: test-xpos ........................   Passed    0.57 sec
...
20/20 Test #20: test-backend-ops .................   Passed  237.29 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.74 sec
      Start  2: test-opt
 ...
 5/21 Test  #5: test-mul-mat0 ....................   Passed    1.07 sec
...
14/21 Test #14: test-rel-pos .....................   Passed    0.56 sec
...
21/21 Test #21: test-backend-ops .................   Passed   47.36 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  92.63 sec
...
main:     load time =   632.13 ms
main:   sample time =    34.38 ms
main:  predict time =   657.16 ms / 10.27 ms per token
main:    total time =  1347.17 ms
...
main:     load time =   576.74 ms
main:   sample time =    34.86 ms
main:  predict time =   639.66 ms / 9.14 ms per token
main:    total time =  1255.93 ms
...
main:     n_decoded =      504
main:     load time =   540.61 ms
main:   sample time =   232.88 ms
main:  predict time =  2289.77 ms
main:    total time =  3108.80 ms
...
main: loaded model in   400.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0982db6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0982c371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564e5aea1740                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0982db6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0982dbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564e5aea2510                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0982c371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564e5aea1740                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564e5aea2e70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x564e5aea2510                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0982db6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564e5aea37d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x564e5aea2e70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564e5aea4130                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0982db6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x564e5aea37d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564e5aea42f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x564e5aea4130                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0982dbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x564e5aea44b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x564e5aea42f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   531.66 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.45 ms
whisper_print_timings:   sample time =    67.56 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =    22.36 ms /     1 runs (   22.36 ms per run)
whisper_print_timings:   decode time =    21.05 ms /     2 runs (   10.52 ms per run)
whisper_print_timings:   batchd time =    81.25 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   750.89 ms
...
main:     load time =   518.36 ms
main:    total time =  8019.66 ms
embd_img
...
main:      load time =  6780.88 ms
main:    sample time =   521.21 ms / 8.14 ms per token
main:      eval time = 23921.83 ms / 341.74 ms per token
main:     total time = 32051.93 ms
...
main:      load time =  2183.26 ms
main:    sample time =   525.08 ms / 8.20 ms per token
main:      eval time = 12551.96 ms / 179.31 ms per token
main:     total time = 15890.82 ms
