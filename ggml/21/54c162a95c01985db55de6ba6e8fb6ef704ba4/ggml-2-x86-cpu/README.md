...
- status:  SUCCESS ✅
- runtime: 5:01.33
- date:    Mon Jan 29 11:49:32 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.49 sec
...
20/20 Test #20: test-backend-ops .................   Passed  113.58 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 124.56 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.45 sec
...
main:  predict time =   460.68 ms / 7.20 ms per token
main:    total time =   624.27 ms
...
main:  predict time =   478.62 ms / 6.84 ms per token
main:    total time =   632.96 ms
...
main:  predict time =  1530.78 ms
main:    total time =  1847.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f10de673990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f10de4f41a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555bba290b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f10de673030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f10de678940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555bba291960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f10de4f41a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555bba290b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555bba2922c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555bba291960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f10de673030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555bba292c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555bba2922c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555bba293580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f10de673990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555bba292c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555bba293740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555bba293580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f10de678940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555bba293900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555bba293740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.79 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.95 ms
whisper_print_timings:   sample time =    54.75 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1172.01 ms /     1 runs ( 1172.01 ms per run)
whisper_print_timings:   decode time =     9.97 ms /     2 runs (    4.98 ms per run)
whisper_print_timings:   batchd time =   211.08 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1541.88 ms
...
main:     load time =    64.10 ms
main:    total time = 10614.03 ms
embd_img
...
main:      load time =  4605.33 ms
main:    sample time =   472.54 ms / 7.38 ms per token
main:      eval time = 19549.36 ms / 279.28 ms per token
main:     total time = 25265.31 ms
...
main:      load time =  1184.80 ms
main:    sample time =   470.87 ms / 7.36 ms per token
main:      eval time =  8308.94 ms / 118.70 ms per token
main:     total time = 10344.57 ms
