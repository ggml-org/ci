...
- status:  SUCCESS ✅
- runtime: 6:04.15
- date:    Mon Jan 29 11:50:41 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.87 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.18 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  153.28 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 190.48 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.48 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.60 sec
...
main:     load time =   194.04 ms
main:   sample time =    17.26 ms
main:  predict time =   896.28 ms / 14.00 ms per token
...
main:  predict time =   974.29 ms / 13.92 ms per token
main:    total time =  1182.84 ms
...
main:   sample time =   127.11 ms
main:  predict time =  6149.81 ms
main:    total time =  6591.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbaea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb96b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae04f5b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbaea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbaef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae04f6960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb96b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae04f5b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae04f72c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae04f6960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbbaea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae04f7c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae04f72c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae04f8580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbbaea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae04f7c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae04f8740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae04f8580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbbaef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae04f8900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae04f8740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4745.03 ms /     1 runs ( 4745.03 ms per run)
whisper_print_timings:   decode time =    15.91 ms /     2 runs (    7.95 ms per run)
whisper_print_timings:   batchd time =   717.15 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5672.97 ms
...
main:     load time =    91.32 ms
main:    total time = 40503.70 ms
embd_img
