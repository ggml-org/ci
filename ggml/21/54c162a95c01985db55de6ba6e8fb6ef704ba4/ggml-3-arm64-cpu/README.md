...
- status:  SUCCESS ✅
- runtime: 7:06.42
- date:    Mon Jan 29 11:55:02 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.41 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed  129.22 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 143.07 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.24 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   24.68 sec
...
main:     load time =   182.42 ms
main:   sample time =    16.92 ms
main:  predict time =   865.33 ms / 13.52 ms per token
main:    total time =  1086.46 ms
...
main:  predict time =   937.30 ms / 13.39 ms per token
main:    total time =  1144.72 ms
...
main:  predict time =  5990.10 ms
main:    total time =  6352.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff91b4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff919cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab6b17b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff91b4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff91b4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab6b18960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff919cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab6b17b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab6b192c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab6b18960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff91b4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab6b19c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab6b192c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab6b1a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff91b4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab6b19c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab6b1a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab6b1a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff91b4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab6b1a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab6b1a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    65.44 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4637.51 ms /     1 runs ( 4637.51 ms per run)
whisper_print_timings:   decode time =    15.79 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   712.63 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5556.75 ms
...
main:     load time =    98.79 ms
main:    total time = 39790.40 ms
embd_img
...
main:      load time =  5470.77 ms
main:    sample time =   518.17 ms / 8.10 ms per token
main:      eval time = 43865.74 ms / 626.65 ms per token
main:     total time = 52227.55 ms
...
main:      load time =  1582.98 ms
main:    sample time =   514.83 ms / 8.04 ms per token
main:      eval time = 17817.40 ms / 254.53 ms per token
main:     total time = 20873.15 ms
