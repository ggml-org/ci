...
- status:  SUCCESS ✅
- runtime: 4:43.42
- date:    Mon Aug 28 11:56:25 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.32 sec
      Start  2: test-opt
...
main:     load time =   198.47 ms
main:   sample time =    34.85 ms
main:  predict time =   553.13 ms / 8.64 ms per token
main:    total time =   807.04 ms
...
main:     load time =   198.24 ms
main:   sample time =    36.26 ms
main:  predict time =   601.75 ms / 8.60 ms per token
main:    total time =   841.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9fc2ba28a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9fc2a23150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55828dd7dab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9fc2ba1f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9fc2ba7800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55828dd7e830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9fc2a23150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55828dd7dab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55828dd7f140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55828dd7e830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9fc2ba1f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55828dd7fa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55828dd7f140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55828dd80360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9fc2ba28a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55828dd7fa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55828dd804d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55828dd80360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9fc2ba7800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55828dd80640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55828dd804d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6597.33 ms
main:    sample time =   588.89 ms / 9.20 ms per token
main:      eval time = 24190.10 ms / 345.57 ms per token
main:     total time = 32230.15 ms
...
main:      load time =  1734.67 ms
main:    sample time =   589.18 ms / 9.21 ms per token
main:      eval time = 12226.60 ms / 174.67 ms per token
main:     total time = 15208.53 ms
