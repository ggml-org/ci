...
- status:  SUCCESS ✅
- runtime: 2:48.89
- date:    Thu Nov 30 15:18:46 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ea0323bfb24c2ec546fc19cff3abf82f4673477c
- author:  slaren
```
...
19/19 Test #19: test-backend-ops .................   Passed    1.03 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.24 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    0.19 sec
...
ggml_backend_sched size: 1466 KB
main: seed = 1234
...
main:     load time =   121.74 ms
main:   sample time =    23.78 ms
main:  predict time =   447.35 ms / 6.99 ms per token
main:    total time =   605.26 ms
...
main:     load time =   129.56 ms
main:   sample time =    23.77 ms
main:  predict time =   447.15 ms / 6.39 ms per token
main:    total time =   602.45 ms
...
main:   sample time =   175.28 ms
main:  predict time =  1442.63 ms
main:    total time =  1754.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fce1c90a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fce1c78b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56165cc7db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fce1c90a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fce1c90f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56165cc7e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fce1c78b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56165cc7db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56165cc7f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x56165cc7e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fce1c90a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56165cc7fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x56165cc7f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56165cc80530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fce1c90a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x56165cc7fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56165cc806e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x56165cc80530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fce1c90f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x56165cc80890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x56165cc806e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    79.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.14 ms
whisper_print_timings:   sample time =    53.89 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1142.34 ms /     1 runs ( 1142.34 ms per run)
whisper_print_timings:   decode time =     9.52 ms /     2 runs (    4.76 ms per run)
whisper_print_timings:   batchd time =   205.97 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1508.73 ms
...
main:     load time =    66.97 ms
main:    total time = 10431.05 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.476000 sec.)
...
main:      load time =  4468.64 ms
main:    sample time =   467.88 ms / 7.31 ms per token
main:      eval time = 19347.91 ms / 276.40 ms per token
main:     total time = 24920.88 ms
...
main:      load time =  1199.08 ms
main:    sample time =   466.68 ms / 7.29 ms per token
main:      eval time =  7997.06 ms / 114.24 ms per token
main:     total time = 10037.22 ms
