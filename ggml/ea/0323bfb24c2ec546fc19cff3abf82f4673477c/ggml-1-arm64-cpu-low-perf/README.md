...
- status:  SUCCESS ✅
- runtime: 2:40.55
- date:    Thu Nov 30 03:18:32 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    1.60 sec
...
main:     load time =   186.68 ms
main:   sample time =    17.83 ms
main:  predict time =   985.34 ms / 15.40 ms per token
main:    total time =  1212.17 ms
...
main:     n_decoded =      504
main:     load time =   160.08 ms
main:   sample time =   128.68 ms
main:  predict time =  5970.19 ms
main:    total time =  6339.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2e5a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa2cdb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae72a6b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2e5a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2e5f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae72a7940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa2cdb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae72a6b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae72a8290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae72a7940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2e5a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae72a8be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae72a8290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae72a9530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2e5a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae72a8be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae72a96e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae72a9530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2e5f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae72a9890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae72a96e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.49 ms
whisper_print_timings:   sample time =    65.01 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4742.26 ms /     1 runs ( 4742.26 ms per run)
whisper_print_timings:   decode time =    15.42 ms /     2 runs (    7.71 ms per run)
whisper_print_timings:   batchd time =   713.48 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5665.15 ms
