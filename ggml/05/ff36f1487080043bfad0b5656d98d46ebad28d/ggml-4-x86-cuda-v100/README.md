...
- status:  SUCCESS ✅
- runtime: 5:54.27
- date:    Mon Oct 30 16:41:26 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.84 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.40 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    7.11 sec
      Start  2: test-opt
 ...
 6/15 Test  #6: test-mul-mat2 ....................   Passed    2.80 sec
      Start  7: test0
 7/15 Test  #7: test0 ............................   Passed    0.00 sec
      Start  8: test1
 8/15 Test  #8: test1 ............................   Passed    0.02 sec
      Start  9: test2
...
main:   sample time =    38.09 ms
main:  predict time =   569.46 ms / 8.90 ms per token
main:    total time =   816.93 ms
...
main:   sample time =    41.96 ms
main:  predict time =   593.85 ms / 8.48 ms per token
main:    total time =   793.42 ms
...
main:   sample time =   235.62 ms
main:  predict time =  2240.22 ms
main:    total time =  2678.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f84150fa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8414f7b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5587c1c41ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f84150f9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f84150ff880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5587c1c42870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8414f7b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5587c1c41ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5587c1c431a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5587c1c42870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f84150f9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5587c1c43ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5587c1c431a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5587c1c44400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f84150fa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5587c1c43ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5587c1c44590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5587c1c44400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f84150ff880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5587c1c44720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5587c1c44590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   733.51 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    28.90 ms
whisper_print_timings:   sample time =    24.29 ms /    27 runs (    0.90 ms per run)
whisper_print_timings:   encode time =  1856.98 ms /     1 runs ( 1856.98 ms per run)
whisper_print_timings:   decode time =   135.54 ms /    27 runs (    5.02 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2848.49 ms
...
main:      load time =  7813.58 ms
main:    sample time =   582.08 ms / 9.10 ms per token
main:      eval time = 25901.12 ms / 370.02 ms per token
main:     total time = 35237.74 ms
...
main:      load time =  1685.40 ms
main:    sample time =   614.75 ms / 9.61 ms per token
main:      eval time = 12465.99 ms / 178.09 ms per token
main:     total time = 15462.95 ms
