...
- status:  SUCCESS ✅
- runtime: 4:27.68
- date:    Mon Oct 30 04:42:55 AM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/05ff36f1487080043bfad0b5656d98d46ebad28d
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.82 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/14 Test  #3: test-quantize-perf ...............   Passed    0.02 sec
      Start  4: test-mul-mat0
 4/14 Test  #4: test-mul-mat0 ....................   Passed    0.60 sec
      Start  5: test-mul-mat2
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.61 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.56 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.00 sec
...
main:     load time =   149.78 ms
main:   sample time =    17.26 ms
main:  predict time =   803.05 ms / 12.55 ms per token
main:    total time =   993.07 ms
...
main:     load time =   148.93 ms
main:   sample time =    16.96 ms
main:  predict time =   868.78 ms / 12.41 ms per token
main:    total time =  1038.78 ms
...
main:     n_decoded =      504
main:     load time =   149.09 ms
main:   sample time =   128.64 ms
main:  predict time =  5871.05 ms
main:    total time =  6231.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88f0a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88d8b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0182ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88f09fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88f0f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad0183870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff88d8b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad0182ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad01841a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad0183870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff88f09fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad0184ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad01841a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad0185400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff88f0a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad0184ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad0185590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad0185400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff88f0f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad0185720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad0185590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.75 ms
whisper_print_timings:   sample time =    20.97 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  4608.04 ms /     1 runs ( 4608.04 ms per run)
whisper_print_timings:   decode time =   177.69 ms /    27 runs (    6.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5005.33 ms
...
main:     load time =    90.63 ms
main:    total time = 39373.69 ms
embd_img
...
main:      load time =  5548.28 ms
main:    sample time =   517.57 ms / 8.09 ms per token
main:      eval time = 43747.40 ms / 624.96 ms per token
main:     total time = 52185.46 ms
...
main:      load time =  1551.43 ms
main:    sample time =   511.46 ms / 7.99 ms per token
main:      eval time = 17326.66 ms / 247.52 ms per token
main:     total time = 20351.67 ms
