...
- status:  SUCCESS ✅
- runtime: 2:46.47
- date:    Mon Oct 30 04:37:42 UTC 2023
...
main:  predict time =   431.38 ms / 6.74 ms per token
main:    total time =   570.53 ms
...
main:     load time =   102.31 ms
main:   sample time =    23.44 ms
main:  predict time =   475.04 ms / 6.79 ms per token
...
main:   sample time =   176.77 ms
main:  predict time =  1487.28 ms
main:    total time =  1798.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efe457c2900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efe45643170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5625350e9ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efe457c1fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efe457c7880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5625350ea870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efe45643170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5625350e9ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5625350eb1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5625350ea870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efe457c1fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5625350ebad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5625350eb1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5625350ec400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efe457c2900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5625350ebad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5625350ec590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5625350ec400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efe457c7880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5625350ec720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5625350ec590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    85.12 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.18 ms
whisper_print_timings:   sample time =    15.67 ms /    27 runs (    0.58 ms per run)
whisper_print_timings:   encode time =  1138.26 ms /     1 runs ( 1138.26 ms per run)
whisper_print_timings:   decode time =    93.44 ms /    27 runs (    3.46 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1388.04 ms
...
main:      load time =  4418.53 ms
main:    sample time =   468.57 ms / 7.32 ms per token
main:      eval time = 19323.27 ms / 276.05 ms per token
main:     total time = 24854.06 ms
...
main:      load time =  1209.01 ms
main:    sample time =   466.28 ms / 7.29 ms per token
main:      eval time =  7996.95 ms / 114.24 ms per token
main:     total time = 10044.89 ms
