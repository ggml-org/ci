...
- status:  SUCCESS ✅
- runtime: 1:48.88
- date:    Sun Jun 30 16:07:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   31.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    0.14 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   15.99 sec
      Start  3: test-quantize-perf
...
main:     load time =   101.57 ms
main:   sample time =    30.67 ms
main:  predict time =   650.27 ms / 10.16 ms per token
main:    total time =   798.77 ms
...
main:   sample time =    30.28 ms
main:  predict time =   682.54 ms / 9.75 ms per token
main:    total time =   821.29 ms
...
main:     load time =   121.98 ms
main:   sample time =    30.20 ms
main:  predict time =   689.84 ms / 9.85 ms per token
main:    total time =   847.33 ms
...
main:     n_decoded =      504
main:     load time =    99.72 ms
main:   sample time =   202.59 ms
main:  predict time =  2738.69 ms
main:    total time =  3089.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x775c844fa930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x775c8437b180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x574ff3fcfcd0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x775c844f9ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x775c844ff8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x574ff3fd0a80                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x775c8437b180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x574ff3fcfcd0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x574ff3fd13c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x574ff3fd0a80                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x775c844f9ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x574ff3fd1d00                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x574ff3fd13c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x574ff3fd2640                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x775c844fa930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x574ff3fd1d00                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x574ff3fd27e0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x574ff3fd2640                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x775c844ff8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x574ff3fd2980                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x574ff3fd27e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
