...
- status:  SUCCESS ✅
- runtime: 4:07.36
- date:    Wed Apr  3 09:05:51 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.06 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.56 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.23 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.26 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   20.50 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    5.76 sec
      Start  4: test-mul-mat0
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.42 sec
      Start  9: test3
...
main:     load time =   164.50 ms
main:   sample time =    17.66 ms
main:  predict time =   902.49 ms / 14.10 ms per token
main:    total time =  1106.51 ms
...
main:     load time =   160.00 ms
main:   sample time =    17.78 ms
main:  predict time =   989.52 ms / 14.14 ms per token
main:    total time =  1170.11 ms
...
main:     load time =   190.35 ms
main:   sample time =    17.83 ms
main:  predict time =  1037.80 ms / 14.83 ms per token
main:    total time =  1249.62 ms
...
main:     n_decoded =      504
main:     load time =   160.37 ms
main:   sample time =   129.54 ms
main:  predict time =  6448.89 ms
main:    total time =  6821.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa072a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa05ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad9c70ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa072a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa072f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad9c71ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa05ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad9c70ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad9c72410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad9c71ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa072a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad9c72d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad9c72410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad9c736d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa072a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad9c72d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad9c73890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad9c736d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa072f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad9c73a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad9c73890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.40 ms
whisper_print_timings:   sample time =    65.73 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4703.62 ms /     1 runs ( 4703.62 ms per run)
whisper_print_timings:   decode time =    15.75 ms /     2 runs (    7.88 ms per run)
whisper_print_timings:   batchd time =   715.72 ms /   125 runs (    5.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5639.11 ms
...
main:     load time =    99.68 ms
main:    total time = 39977.95 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.266000 sec.)
