...
- status:  SUCCESS ✅
- runtime: 9:08.46
- date:    Wed Apr  3 21:15:51 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   36.74 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.04 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   20.18 sec
      Start  9: test3
...
22/22 Test #22: test-backend-ops .................   Passed   95.76 sec
...
23/23 Test #23: test-backend-ops .................   Passed   38.89 sec

100% tests passed, 0 tests failed out of 23

Total Test time (real) = 100.41 sec
...
main:   sample time =    35.82 ms
main:  predict time =   631.87 ms / 9.87 ms per token
main:    total time =   837.92 ms
...
main:  predict time =   761.79 ms / 10.88 ms per token
main:    total time =   949.63 ms
...
main:     load time =   177.63 ms
main:   sample time =    36.20 ms
main:  predict time =   823.75 ms / 11.77 ms per token
main:    total time =  1042.73 ms
...
main:   sample time =   243.87 ms
main:  predict time =  3201.37 ms
main:    total time =  3641.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff36b6fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff36b57b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5605379d7e70                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff36b6fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff36b6ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5605379d8c40                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff36b57b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5605379d7e70                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5605379d95a0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5605379d8c40                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff36b6fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5605379d9f00                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5605379d95a0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5605379da860                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff36b6fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5605379d9f00                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5605379daa20                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5605379da860                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff36b6ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5605379dabe0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5605379daa20       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   517.95 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.63 ms
whisper_print_timings:   sample time =    65.82 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    49.02 ms /     1 runs (   49.02 ms per run)
whisper_print_timings:   decode time =    12.10 ms /     2 runs (    6.05 ms per run)
whisper_print_timings:   batchd time =    78.15 ms /   125 runs (    0.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   751.79 ms
...
main:     load time =   112.86 ms
main:    total time = 18184.58 ms
embd_img
