...
- status:  SUCCESS ✅
- runtime: 2:08.47
- date:    Wed Apr  3 21:01:43 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.19 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    8.88 sec
...
main:  predict time =   504.40 ms / 7.21 ms per token
main:    total time =   633.88 ms
...
main:     load time =   122.75 ms
main:   sample time =    23.68 ms
main:  predict time =   516.99 ms / 7.39 ms per token
main:    total time =   666.20 ms
...
main:   sample time =   175.14 ms
main:  predict time =  1834.68 ms
main:    total time =  2147.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6671fc8990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6671e491a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b45b0dcce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6671fc8030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6671fcd940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b45b0ddab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f6671e491a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b45b0dcce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b45b0de410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b45b0ddab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f6671fc8030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b45b0ded70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b45b0de410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b45b0df6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f6671fc8990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b45b0ded70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b45b0df890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b45b0df6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f6671fcd940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b45b0dfa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b45b0df890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.52 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.68 ms
whisper_print_timings:   sample time =    54.93 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1185.65 ms /     1 runs ( 1185.65 ms per run)
whisper_print_timings:   decode time =    12.09 ms /     2 runs (    6.05 ms per run)
whisper_print_timings:   batchd time =   211.98 ms /   125 runs (    1.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1558.74 ms
...
main:     load time =    65.07 ms
main:    total time = 10703.01 ms
embd_img
