...
- status:  SUCCESS ✅
- runtime: 3:11.47
- date:    Wed Apr  3 21:03:56 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   20.50 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.91 sec
...
main:     load time =   148.32 ms
main:   sample time =    17.31 ms
main:  predict time =   894.84 ms / 13.98 ms per token
main:    total time =  1082.31 ms
...
main:  predict time =   973.74 ms / 13.91 ms per token
main:    total time =  1141.09 ms
...
main:     load time =   179.28 ms
main:   sample time =    17.41 ms
main:  predict time =  1028.74 ms / 14.70 ms per token
main:    total time =  1228.96 ms
...
main:  predict time =  6420.44 ms
main:    total time =  6776.40 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff832aa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8312b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad797ece0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff832aa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff832af940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad797fab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8312b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad797ece0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad7980410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad797fab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff832aa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad7980d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad7980410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad79816d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff832aa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad7980d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad7981890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad79816d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff832af940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad7981a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad7981890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.08 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.92 ms
whisper_print_timings:   sample time =    64.99 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4683.58 ms /     1 runs ( 4683.58 ms per run)
whisper_print_timings:   decode time =    15.20 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   710.09 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5599.39 ms
...
main:     load time =    92.32 ms
main:    total time = 39739.68 ms
embd_img
