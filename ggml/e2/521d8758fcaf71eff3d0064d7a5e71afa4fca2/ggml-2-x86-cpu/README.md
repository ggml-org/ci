...
- status:  SUCCESS ✅
- runtime: 3:29.15
- date:    Tue Dec  5 14:45:11 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   19.79 sec
...
main:     load time =   234.55 ms
main:   sample time =    23.47 ms
main:  predict time =   442.78 ms / 6.92 ms per token
main:    total time =   713.23 ms
...
main:  predict time =  1453.92 ms
main:    total time =  1768.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9a4a97e960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9a4a7ff190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55786b5edb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9a4a97e010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9a4a983900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55786b5ee940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9a4a7ff190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55786b5edb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55786b5ef290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55786b5ee940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9a4a97e010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55786b5efbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55786b5ef290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55786b5f0530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9a4a97e960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55786b5efbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55786b5f06e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55786b5f0530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9a4a983900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55786b5f0890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55786b5f06e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.87 ms
whisper_print_timings:   sample time =    55.46 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1145.70 ms /     1 runs ( 1145.70 ms per run)
whisper_print_timings:   decode time =     9.48 ms /     2 runs (    4.74 ms per run)
whisper_print_timings:   batchd time =   204.69 ms /   125 runs (    1.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1539.80 ms
...
main:     load time =    63.78 ms
main:    total time = 10430.89 ms
embd_img
...
main:      load time = 14163.78 ms
main:    sample time =   466.99 ms / 7.30 ms per token
main:      eval time = 20062.29 ms / 286.60 ms per token
main:     total time = 35364.66 ms
...
main:      load time =  4378.06 ms
main:    sample time =   464.09 ms / 7.25 ms per token
main:      eval time =  7960.44 ms / 113.72 ms per token
main:     total time = 13176.07 ms
