...
- status:  SUCCESS ✅
- runtime: 2:30.29
- date:    Tue Dec  5 14:44:08 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   20.63 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.43 sec
      Start  9: test3
...
main:     load time =   128.47 ms
main:   sample time =    23.59 ms
main:  predict time =   599.85 ms / 9.37 ms per token
main:    total time =   764.46 ms
...
main:  predict time =   630.25 ms / 9.00 ms per token
main:    total time =   782.67 ms
...
main:  predict time =  2384.53 ms
main:    total time =  2713.04 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1ff9d19960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1ff9b9a190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559db68cdb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1ff9d19010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1ff9d1e900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559db68ce940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1ff9b9a190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559db68cdb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559db68cf290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559db68ce940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1ff9d19010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559db68cfbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559db68cf290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559db68d0530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1ff9d19960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559db68cfbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559db68d06e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559db68d0530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1ff9d1e900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559db68d0890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559db68d06e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.05 ms
whisper_print_timings:   sample time =    72.95 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1976.23 ms /     1 runs ( 1976.23 ms per run)
whisper_print_timings:   decode time =    12.66 ms /     2 runs (    6.33 ms per run)
whisper_print_timings:   batchd time =   325.37 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2486.24 ms
