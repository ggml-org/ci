...
- status:  SUCCESS ✅
- runtime: 7:51.87
- date:    Tue Dec  5 14:49:26 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    7.03 sec
      Start  2: test-quantize-fns
 2/19 Test  #2: test-quantize-fns ................   Passed    0.59 sec
      Start  3: test-quantize-perf
 3/19 Test  #3: test-quantize-perf ...............   Passed    0.83 sec
      Start  4: test-mul-mat0
 4/19 Test  #4: test-mul-mat0 ....................   Passed    1.13 sec
      Start  5: test-mul-mat2
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.01 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed   50.58 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    7.00 sec
      Start  2: test-opt
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    3.31 sec
      Start  7: test0
 7/20 Test  #7: test0 ............................   Passed    0.57 sec
      Start  8: test1
 8/20 Test  #8: test1 ............................   Passed    0.60 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    8.08 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed    9.12 sec
...
main:     load time =   504.71 ms
main:   sample time =    34.58 ms
main:  predict time =   567.62 ms / 8.87 ms per token
main:    total time =  1130.50 ms
...
main:     load time =   476.11 ms
main:   sample time =    34.54 ms
main:  predict time =   611.57 ms / 8.74 ms per token
main:    total time =  1126.51 ms
...
main:     n_decoded =      504
main:     load time =   450.04 ms
main:   sample time =   233.61 ms
main:  predict time =  2225.93 ms
main:    total time =  2953.42 ms
...
main: loaded model in   308.62 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f00009b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0000837190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564e578d63f0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f00009b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f00009bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564e578d71b0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0000837190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564e578d63f0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564e578d7b00                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564e578d71b0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f00009b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564e578d8450                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564e578d7b00                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564e578d8da0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f00009b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564e578d8450                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564e578d8f50                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564e578d8da0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f00009bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564e578d9100                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564e578d8f50       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   985.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.88 ms
whisper_print_timings:   sample time =    65.88 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    33.79 ms /     1 runs (   33.79 ms per run)
whisper_print_timings:   decode time =    12.84 ms /     2 runs (    6.42 ms per run)
whisper_print_timings:   batchd time =    82.33 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1206.36 ms
...
main:     load time =   428.19 ms
main:    total time =  7702.33 ms
embd_img
...
main:      load time = 26247.35 ms
main:    sample time =   521.03 ms / 8.14 ms per token
main:      eval time = 24147.59 ms / 344.97 ms per token
main:     total time = 51781.79 ms
...
main:      load time = 14356.72 ms
main:    sample time =   513.80 ms / 8.03 ms per token
main:      eval time = 12613.18 ms / 180.19 ms per token
main:     total time = 28128.32 ms
