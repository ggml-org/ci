...
- status:  SUCCESS ✅
- runtime: 3:26.00
- date:    Sat Jun 15 18:32:25 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.19 sec
      Start  9: test3
...
Total Test time (real) =  74.15 sec
...
main:  predict time =   658.07 ms / 10.28 ms per token
main:    total time =   797.51 ms
...
main:  predict time =   689.75 ms / 9.85 ms per token
main:    total time =   819.46 ms
...
main:     load time =   124.31 ms
main:   sample time =    23.99 ms
main:  predict time =   690.78 ms / 9.87 ms per token
main:    total time =   842.22 ms
...
main:  predict time =  2589.24 ms
main:    total time =  2919.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ac8ea8fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ac8ea77b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6492ba717ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ac8ea8fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ac8ea8ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6492ba718ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ac8ea77b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6492ba717ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6492ba719410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6492ba718ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ac8ea8fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6492ba719d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6492ba719410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6492ba71a6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ac8ea8fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6492ba719d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6492ba71a890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6492ba71a6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ac8ea8ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x6492ba71aa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6492ba71a890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:      mel time =    21.50 ms
whisper_print_timings:   sample time =    73.40 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  2008.94 ms /     1 runs ( 2008.94 ms per run)
whisper_print_timings:   decode time =    14.37 ms /     2 runs (    7.18 ms per run)
whisper_print_timings:   batchd time =   332.52 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2540.61 ms
...
main:     load time =    71.53 ms
main:    total time = 18501.00 ms
embd_img
