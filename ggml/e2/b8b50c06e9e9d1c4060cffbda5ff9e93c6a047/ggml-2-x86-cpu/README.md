...
- status:  SUCCESS ✅
- runtime: 2:09.14
- date:    Sat Jun 15 18:31:08 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-fns ................   Passed   16.09 sec
...
main:  predict time =   496.30 ms / 7.09 ms per token
...
main:  predict time =   515.53 ms / 7.36 ms per token
main:    total time =   667.37 ms
...
main:  predict time =  1545.13 ms
main:    total time =  1861.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70a69e8fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70a69e77b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5aa4f5778ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70a69e8fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x70a69e8ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5aa4f5779ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x70a69e77b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5aa4f5778ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5aa4f577a410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5aa4f5779ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x70a69e8fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5aa4f577ad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5aa4f577a410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5aa4f577b6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x70a69e8fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5aa4f577ad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5aa4f577b890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5aa4f577b6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x70a69e8ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5aa4f577ba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5aa4f577b890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    54.58 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1163.18 ms /     1 runs ( 1163.18 ms per run)
whisper_print_timings:   decode time =    11.05 ms /     2 runs (    5.53 ms per run)
whisper_print_timings:   batchd time =   219.31 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1549.14 ms
...
main:     load time =    67.05 ms
main:    total time = 10612.20 ms
embd_img
