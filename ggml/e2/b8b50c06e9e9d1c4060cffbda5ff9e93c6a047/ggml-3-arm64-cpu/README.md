...
- status:  SUCCESS ✅
- runtime: 3:05.58
- date:    Sat Jun 15 18:32:03 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.41 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.36 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed   10.73 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    2.31 sec
      Start  2: test-opt
 2/22 Test  #2: test-opt .........................   Passed    2.19 sec
 ...
 6/22 Test  #6: test-mul-mat2 ....................   Passed    1.76 sec
      Start  7: test0
...
main:     load time =   147.18 ms
main:   sample time =    17.04 ms
main:  predict time =   854.88 ms / 13.36 ms per token
main:    total time =  1040.56 ms
...
main:     load time =   147.88 ms
main:   sample time =    16.82 ms
main:  predict time =   927.56 ms / 13.25 ms per token
main:    total time =  1094.96 ms
...
main:     load time =   181.28 ms
main:   sample time =    16.71 ms
main:  predict time =   928.79 ms / 13.27 ms per token
main:    total time =  1130.07 ms
...
main:     n_decoded =      504
main:     load time =   152.05 ms
main:   sample time =   127.02 ms
main:  predict time =  6044.73 ms
main:    total time =  6406.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffdf80a9a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffdf8091b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbda3dec33ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffdf80a9a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffdf80a9f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbda3dec34ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffdf8091b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xbda3dec33ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbda3dec35410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xbda3dec34ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffdf80a9a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbda3dec35d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xbda3dec35410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbda3dec366d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffdf80a9a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xbda3dec35d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbda3dec36890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xbda3dec366d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffdf80a9f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xbda3dec36a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xbda3dec36890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.29 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.18 ms
whisper_print_timings:   sample time =    65.60 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4676.36 ms /     1 runs ( 4676.36 ms per run)
whisper_print_timings:   decode time =    14.44 ms /     2 runs (    7.22 ms per run)
whisper_print_timings:   batchd time =   725.18 ms /   125 runs (    5.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5614.88 ms
...
main:     load time =    87.30 ms
main:    total time = 39650.25 ms
embd_img
