...
- status:  SUCCESS ✅
- runtime: 2:24.90
- date:    Thu Aug  8 11:00:30 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    0.22 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   32.76 sec
      Start  3: test-quantize-perf
 3/22 Test  #3: test-quantize-perf ...............   Passed    9.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   19.86 sec
...
main:     load time =   153.17 ms
main:   sample time =    18.39 ms
main:  predict time =   846.24 ms / 13.22 ms per token
main:    total time =  1038.61 ms
...
main:     load time =   153.43 ms
main:   sample time =    18.18 ms
main:  predict time =   907.41 ms / 12.96 ms per token
main:    total time =  1081.20 ms
...
main:     load time =   186.45 ms
main:   sample time =    18.32 ms
main:  predict time =   920.09 ms / 13.14 ms per token
main:    total time =  1127.66 ms
...
main:     n_decoded =      504
main:     load time =   154.65 ms
main:   sample time =   129.70 ms
main:  predict time =  6190.42 ms
main:    total time =  6558.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe8504745a930                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe850472db180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb2719c0f7ee0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe85047459ff0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe8504745f8c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb2719c0f8c90                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe850472db180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb2719c0f7ee0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb2719c0f95d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb2719c0f8c90                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe85047459ff0                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb2719c0f9f10                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb2719c0f95d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb2719c0fa850                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe8504745a930                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb2719c0f9f10                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb2719c0fa9f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb2719c0fa850                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe8504745f8c0                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb2719c0fab90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb2719c0fa9f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:     load time =    90.64 ms
main:    total time = 40197.23 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.297000 sec.)
