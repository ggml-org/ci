...
- status:  SUCCESS ✅
- runtime: 6:58.70
- date:    Sat Dec  2 20:50:17 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    7.72 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed    3.14 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    7.73 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    0.98 sec
      Start 11: test-pool
...
17/20 Test #17: test-conv2d ......................   Passed    0.52 sec
...
main:     load time =   532.42 ms
main:   sample time =    36.14 ms
main:  predict time =   569.26 ms / 8.89 ms per token
main:    total time =  1157.61 ms
...
main:     load time =   472.64 ms
main:   sample time =    34.30 ms
main:  predict time =   584.39 ms / 8.35 ms per token
main:    total time =  1095.35 ms
...
main:     n_decoded =      504
main:     load time =   443.55 ms
main:   sample time =   232.48 ms
main:  predict time =  2239.49 ms
main:    total time =  2958.91 ms
...
main: loaded model in   295.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa5d91b6960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa5d9037190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55bce47bdc00                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa5d91b6010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa5d91bb900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55bce47be9c0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa5d9037190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55bce47bdc00                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55bce47bf310                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55bce47be9c0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa5d91b6010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55bce47bfc60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55bce47bf310                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55bce47c05b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa5d91b6960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55bce47bfc60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55bce47c0760                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55bce47c05b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa5d91bb900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55bce47c0910                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55bce47c0760       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   966.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.45 ms
whisper_print_timings:   sample time =    74.14 ms /   131 runs (    0.57 ms per run)
whisper_print_timings:   encode time =   500.99 ms /     1 runs (  500.99 ms per run)
whisper_print_timings:   decode time =    13.73 ms /     2 runs (    6.87 ms per run)
whisper_print_timings:   batchd time =   301.00 ms /   125 runs (    2.41 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1880.99 ms
...
main:     load time =   401.51 ms
main:    total time =  7605.63 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.678000 sec.)
...
main:      load time =  8205.63 ms
main:    sample time =   513.85 ms / 8.03 ms per token
main:      eval time = 24833.02 ms / 354.76 ms per token
main:     total time = 34404.05 ms
...
main:      load time =  1986.83 ms
main:    sample time =   516.08 ms / 8.06 ms per token
main:      eval time = 12365.07 ms / 176.64 ms per token
main:     total time = 15527.56 ms
