...
- status:  SUCCESS ✅
- runtime: 4:39.28
- date:    Sat Dec  2 08:47:44 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/7221ac64bf9af38c02408dd3966cdb46d08d59cc
- author:  slaren
```
add metal impl
ggml-ci
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.35 sec
...
19/19 Test #19: test-backend-ops .................   Passed    1.73 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  15.72 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.14 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    2.02 sec
      Start  3: test-quantize-fns
 3/20 Test  #3: test-quantize-fns ................   Passed    0.01 sec
      Start  4: test-quantize-perf
 4/20 Test  #4: test-quantize-perf ...............   Passed    0.05 sec
      Start  5: test-mul-mat0
 5/20 Test  #5: test-mul-mat0 ....................   Passed    0.52 sec
...
20/20 Test #20: test-backend-ops .................   Passed    0.25 sec
...
main:     load time =   188.47 ms
main:   sample time =    17.11 ms
main:  predict time =   819.52 ms / 12.81 ms per token
main:    total time =  1047.26 ms
...
main:     load time =   182.22 ms
main:   sample time =    16.85 ms
main:  predict time =   880.40 ms / 12.58 ms per token
main:    total time =  1082.23 ms
...
main:     n_decoded =      504
main:     load time =   145.02 ms
main:   sample time =   126.47 ms
main:  predict time =  5844.88 ms
main:    total time =  6197.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f11a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ef9b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadce31b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f11a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f11f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadce32940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9ef9b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadce31b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadce33290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaadce32940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f11a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadce33be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaadce33290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadce34530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f11a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaadce33be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadce346e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaadce34530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f11f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaadce34890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaadce346e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   189.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.18 ms
whisper_print_timings:   sample time =    64.90 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4635.37 ms /     1 runs ( 4635.37 ms per run)
whisper_print_timings:   decode time =    15.23 ms /     2 runs (    7.61 ms per run)
whisper_print_timings:   batchd time =   714.78 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5636.85 ms
...
main:     load time =    85.38 ms
main:    total time = 39276.77 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.252000 sec.)
...
main:      load time =  5820.08 ms
main:    sample time =   533.45 ms / 8.34 ms per token
main:      eval time = 43513.84 ms / 621.63 ms per token
main:     total time = 52240.25 ms
...
main:      load time =  1556.36 ms
main:    sample time =   526.60 ms / 8.23 ms per token
main:      eval time = 17488.62 ms / 249.84 ms per token
main:     total time = 20540.28 ms
