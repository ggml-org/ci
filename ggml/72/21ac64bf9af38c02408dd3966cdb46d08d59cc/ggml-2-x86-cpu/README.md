...
- status:  SUCCESS ✅
- runtime: 2:59.85
- date:    Sat Dec  2 20:46:05 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    1.12 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.24 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    1.62 sec
...
20/20 Test #20: test-backend-ops .................   Passed    0.20 sec
...
main:     load time =   169.62 ms
main:   sample time =    23.42 ms
main:  predict time =   430.16 ms / 6.72 ms per token
...
main:     load time =   127.85 ms
main:   sample time =    23.42 ms
main:  predict time =   451.32 ms / 6.45 ms per token
...
main:     n_decoded =      504
main:     load time =   100.32 ms
main:   sample time =   177.41 ms
main:  predict time =  1459.20 ms
main:    total time =  1767.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f21f1bbc960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f21f1a3d190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d3048c5b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f21f1bbc010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f21f1bc1900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d3048c6940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f21f1a3d190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d3048c5b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d3048c7290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55d3048c6940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f21f1bbc010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d3048c7be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55d3048c7290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d3048c8530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f21f1bbc960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55d3048c7be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d3048c86e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55d3048c8530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f21f1bc1900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55d3048c8890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55d3048c86e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   124.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.59 ms
whisper_print_timings:   sample time =    53.33 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1146.51 ms /     1 runs ( 1146.51 ms per run)
whisper_print_timings:   decode time =     9.50 ms /     2 runs (    4.75 ms per run)
whisper_print_timings:   batchd time =   203.94 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1555.68 ms
...
main:     load time =    63.72 ms
main:    total time = 10376.39 ms
embd_img
...
main:      load time =  5249.93 ms
main:    sample time =   466.51 ms / 7.29 ms per token
main:      eval time = 20238.70 ms / 289.12 ms per token
main:     total time = 26622.82 ms
...
main:      load time =  1180.76 ms
main:    sample time =   466.11 ms / 7.28 ms per token
main:      eval time =  7947.36 ms / 113.53 ms per token
main:     total time =  9963.78 ms
