...
- status:  SUCCESS ✅
- runtime: 2:44.44
- date:    Sat Sep  2 07:12:47 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/e41877e9d284b1956f8b77859c2767213af49bef
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.61 sec
...
main:     load time =   201.50 ms
main:   sample time =    23.73 ms
main:  predict time =   435.95 ms / 6.81 ms per token
main:    total time =   674.61 ms
...
main:     load time =   137.06 ms
main:   sample time =    23.75 ms
main:  predict time =   445.67 ms / 6.37 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb5eb40f8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb5eb290150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f466a12ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb5eb40ef90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb5eb414800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f466a13830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb5eb290150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f466a12ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f466a14140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f466a13830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb5eb40ef90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f466a14a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f466a14140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f466a15360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb5eb40f8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f466a14a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f466a154d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f466a15360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb5eb414800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f466a15640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f466a154d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11319.88 ms
main:    sample time =   470.50 ms / 7.35 ms per token
main:      eval time = 20037.90 ms / 286.26 ms per token
main:     total time = 32531.13 ms
...
main:      load time =  4385.15 ms
main:    sample time =   465.79 ms / 7.28 ms per token
main:      eval time =  8027.68 ms / 114.68 ms per token
main:     total time = 13256.85 ms
