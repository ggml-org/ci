...
- status:  SUCCESS ✅
- runtime: 5:18.17
- date:    Sat Sep  2 07:15:33 UTC 2023
...
main:     load time =   353.59 ms
main:   sample time =    34.97 ms
main:  predict time =   545.42 ms / 8.52 ms per token
main:    total time =   954.39 ms
...
main:  predict time =   577.50 ms / 8.25 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3c073598a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3c071da150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560d58e2bab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3c07358f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3c0735e800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560d58e2c830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3c071da150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560d58e2bab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560d58e2d140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x560d58e2c830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3c07358f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560d58e2da50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x560d58e2d140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560d58e2e360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3c073598a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x560d58e2da50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560d58e2e4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x560d58e2e360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3c0735e800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x560d58e2e640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x560d58e2e4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7024.30 ms
main:    sample time =   578.38 ms / 9.04 ms per token
main:      eval time = 25073.93 ms / 358.20 ms per token
main:     total time = 33534.27 ms
...
main:      load time =  1683.50 ms
main:    sample time =   585.76 ms / 9.15 ms per token
main:      eval time = 12059.08 ms / 172.27 ms per token
main:     total time = 14974.55 ms
