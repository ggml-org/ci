...
- status:  SUCCESS ✅
- runtime: 3:41.98
- date:    Sat Sep  2 07:13:47 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.40 sec
      Start  2: test-opt
...
main:     load time =   238.43 ms
main:   sample time =    17.35 ms
main:  predict time =   810.36 ms / 12.66 ms per token
main:    total time =  1088.48 ms
...
main:  predict time =   876.01 ms / 12.51 ms per token
main:    total time =  1061.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff93c7a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff93afb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae98faab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff93c79f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff93c7f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae98fb830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff93afb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae98faab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae98fc140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae98fb830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff93c79f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae98fca50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae98fc140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae98fd360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff93c7a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae98fca50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae98fd4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae98fd360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff93c7f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae98fd640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae98fd4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11976.52 ms
main:    sample time =   628.29 ms / 9.82 ms per token
main:      eval time = 43651.02 ms / 623.59 ms per token
main:     total time = 58642.03 ms
...
main:      load time =  4346.98 ms
main:    sample time =   611.50 ms / 9.55 ms per token
main:      eval time = 17359.43 ms / 247.99 ms per token
main:     total time = 23277.80 ms
