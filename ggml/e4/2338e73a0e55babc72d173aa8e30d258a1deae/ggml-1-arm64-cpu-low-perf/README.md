...
- status:  SUCCESS ✅
- runtime: 6:11.61
- date:    Mon Jan 29 09:49:40 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/20 Test  #8: test2 ............................   Passed   21.86 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.51 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  158.72 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.03 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.73 sec
      Start  9: test3
...
main:     load time =   193.76 ms
main:   sample time =    17.28 ms
main:  predict time =   876.19 ms / 13.69 ms per token
...
main:     load time =   191.20 ms
main:   sample time =    17.48 ms
main:  predict time =   950.58 ms / 13.58 ms per token
main:    total time =  1162.43 ms
...
main:     n_decoded =      504
main:     load time =   166.06 ms
main:   sample time =   127.36 ms
main:  predict time =  6202.89 ms
main:    total time =  6579.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa708a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6f0b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac670eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa708a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa708f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac670f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6f0b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac670eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac67102c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac670f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa708a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac6710c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac67102c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac6711580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa708a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac6710c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac6711740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac6711580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa708f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac6711900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac6711740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    65.74 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4638.75 ms /     1 runs ( 4638.75 ms per run)
whisper_print_timings:   decode time =    16.28 ms /     2 runs (    8.14 ms per run)
whisper_print_timings:   batchd time =   837.30 ms /   125 runs (    6.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5689.91 ms
...
main:     load time =    92.74 ms
main:    total time = 40460.16 ms
embd_img
