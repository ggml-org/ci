...
- status:  SUCCESS ✅
- runtime: 410.92
- date:    Mon Jan 29 11:47:32 EET 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/e42338e73a0e55babc72d173aa8e30d258a1deae
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    1.39 sec
...
20/21 Test #20: test-backend-buffer ..............   Passed    0.26 sec
      Start 21: test-backend-ops
21/21 Test #21: test-backend-ops .................   Passed  159.67 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 174.14 sec
...
20/22 Test #20: test-mul-mat .....................   Passed    0.29 sec
      Start 21: test-backend-buffer
21/22 Test #21: test-backend-buffer ..............   Passed    0.25 sec
      Start 22: test-backend-ops
22/22 Test #22: test-backend-ops .................   Passed   30.48 sec
...
main:     load time =   149.72 ms
main:   sample time =     8.84 ms
main:  predict time =   329.40 ms / 5.15 ms per token
main:    total time =   491.21 ms
...
main:     load time =    94.44 ms
main:   sample time =     8.54 ms
main:  predict time =   341.06 ms / 4.87 ms per token
main:    total time =   444.97 ms
...
main:     n_decoded =      504
main:     load time =   116.24 ms
main:   sample time =    65.60 ms
main:  predict time =   899.24 ms
main:    total time =  1091.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x130187980                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x130008190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x120018220                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x130187020                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x13018c930                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x120018ff0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x130008190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x120018220                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x120019950                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000      0x120018ff0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x130187020                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x12001a2b0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000      0x120019950                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x12001ac10                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x130187980                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000      0x12001a2b0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40      0x12001add0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40      0x12001ac10                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x13018c930                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40      0x12001af90                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40      0x12001add0                           node_4
...
whisper_print_timings:     load time =   147.12 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.35 ms
whisper_print_timings:   sample time =   139.34 ms /   131 runs (    1.06 ms per run)
whisper_print_timings:   encode time =   180.42 ms /     1 runs (  180.42 ms per run)
whisper_print_timings:   decode time =    19.30 ms /     2 runs (    9.65 ms per run)
whisper_print_timings:   batchd time =   199.27 ms /   125 runs (    1.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   695.56 ms
...
main:     load time =    70.16 ms
main:    total time =  4785.67 ms
embd_img
