...
- status:  FAILURE ❌ (124)
- runtime: 
- date:    Mon Jan 29 10:28:27 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  124.80 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 138.72 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.26 sec
...
main:     load time =   280.11 ms
main:   sample time =    17.01 ms
main:  predict time =   860.60 ms / 13.45 ms per token
main:    total time =  1179.88 ms
...
main:     load time =   174.43 ms
main:   sample time =    16.90 ms
main:  predict time =   924.61 ms / 13.21 ms per token
main:    total time =  1118.80 ms
...
main:  predict time =  5990.66 ms
main:    total time =  6348.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb83da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb825b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf429eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb83da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb83df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf429f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb825b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf429eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf42a02c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf429f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb83da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf42a0c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf42a02c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf42a1580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb83da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf42a0c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf42a1740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf42a1580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb83df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf42a1900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf42a1740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   190.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.41 ms
whisper_print_timings:   sample time =    65.38 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4633.08 ms /     1 runs ( 4633.08 ms per run)
whisper_print_timings:   decode time =    16.11 ms /     2 runs (    8.05 ms per run)
whisper_print_timings:   batchd time =   712.11 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5635.35 ms
...
main:     load time =    88.47 ms
main:    total time = 39711.86 ms
embd_img
