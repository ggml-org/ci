...
- status:  FAILURE ❌ (124)
- runtime: 
- date:    Mon Jan 29 10:33:49 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    6.49 sec
...
20/20 Test #20: test-backend-ops .................   Passed  236.92 sec
...
main:     load time =   608.64 ms
main:   sample time =    34.78 ms
main:  predict time =   602.43 ms / 9.41 ms per token
main:    total time =  1266.38 ms
...
main:     load time =   582.31 ms
main:   sample time =    34.58 ms
main:  predict time =   659.83 ms / 9.43 ms per token
main:    total time =  1281.39 ms
...
main:     n_decoded =      504
main:     load time =   541.46 ms
main:   sample time =   233.64 ms
main:  predict time =  2283.60 ms
main:    total time =  3105.35 ms
...
main: loaded model in   399.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f852a3b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f852a2371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d7c50e0cb0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f852a3b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f852a3bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d7c50e1a80                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f852a2371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55d7c50e0cb0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d7c50e23e0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55d7c50e1a80                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f852a3b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d7c50e2d40                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55d7c50e23e0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d7c50e36a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f852a3b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55d7c50e2d40                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d7c50e3860                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55d7c50e36a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f852a3bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55d7c50e3a20                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55d7c50e3860       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   846.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.75 ms
whisper_print_timings:   sample time =    66.40 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    25.35 ms /     1 runs (   25.35 ms per run)
whisper_print_timings:   decode time =    22.17 ms /     2 runs (   11.09 ms per run)
whisper_print_timings:   batchd time =    80.92 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1067.37 ms
...
main:     load time =   503.51 ms
main:    total time =  7895.29 ms
embd_img
