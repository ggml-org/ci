...
- status:  SUCCESS ✅
- runtime: 5:52.29
- date:    Mon Jan 29 09:51:10 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    4.56 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    3.30 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  113.98 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 132.68 sec
...
21/21 Test #21: test-backend-ops .................   Passed   20.26 sec
...
main:     load time =   203.16 ms
main:   sample time =    23.78 ms
main:  predict time =   465.12 ms / 7.27 ms per token
main:    total time =   705.10 ms
...
main:  predict time =   495.72 ms / 7.08 ms per token
main:    total time =   643.63 ms
...
main:     n_decoded =      504
main:     load time =   103.44 ms
main:   sample time =   177.69 ms
main:  predict time =  1518.81 ms
main:    total time =  1830.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5669294990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56691151a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5617d54e2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5669294030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5669299940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5617d54e3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f56691151a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5617d54e2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5617d54e42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5617d54e3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5669294030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5617d54e4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5617d54e42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5617d54e5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5669294990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5617d54e4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5617d54e5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5617d54e5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5669299940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5617d54e5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5617d54e5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.12 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.40 ms
whisper_print_timings:   sample time =    56.07 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1159.19 ms /     1 runs ( 1159.19 ms per run)
whisper_print_timings:   decode time =     9.97 ms /     2 runs (    4.98 ms per run)
whisper_print_timings:   batchd time =   216.74 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1589.55 ms
...
main:     load time =    60.93 ms
main:    total time = 10604.99 ms
embd_img
...
main:      load time = 13607.33 ms
main:    sample time =   469.47 ms / 7.34 ms per token
main:      eval time = 20674.27 ms / 295.35 ms per token
main:     total time = 35444.64 ms
...
main:      load time =  4386.28 ms
main:    sample time =   469.49 ms / 7.34 ms per token
main:      eval time =  9017.13 ms / 128.82 ms per token
main:     total time = 14227.17 ms
