...
- status:  SUCCESS ✅
- runtime: 5:37.81
- date:    Thu Jan 18 09:01:22 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.47 sec
      Start  6: test0
 6/20 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.40 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  156.47 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    8.50 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.01 sec
...
main:     load time =   187.64 ms
main:   sample time =    17.29 ms
main:  predict time =   867.24 ms / 13.55 ms per token
main:    total time =  1094.08 ms
...
main:  predict time =   964.95 ms / 13.78 ms per token
main:    total time =  1174.13 ms
...
main:     n_decoded =      504
main:     load time =   163.61 ms
main:   sample time =   128.25 ms
main:  predict time =  6192.47 ms
main:    total time =  6567.18 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f5ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f43b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac0f78b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f5ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f5bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac0f79960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8f43b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac0f78b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac0f7a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac0f79960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8f5ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac0f7ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac0f7a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac0f7b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8f5ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac0f7ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac0f7b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac0f7b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8f5bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac0f7b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac0f7b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.34 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.59 ms
whisper_print_timings:   sample time =    65.59 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4722.18 ms /     1 runs ( 4722.18 ms per run)
whisper_print_timings:   decode time =    15.93 ms /     2 runs (    7.97 ms per run)
whisper_print_timings:   batchd time =   708.69 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5640.51 ms
