...
- status:  SUCCESS ✅
- runtime: 5:53.64
- date:    Sat Jan  6 03:23:49 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.12 sec
      Start  9: test3
...
Total Test time (real) =  18.86 sec
...
main:     load time =   171.00 ms
main:   sample time =    17.00 ms
main:  predict time =   893.39 ms / 12.76 ms per token
main:    total time =  1084.28 ms
...
main:     n_decoded =      504
main:     load time =   144.47 ms
main:   sample time =   126.68 ms
main:  predict time =  5988.64 ms
main:    total time =  6341.04 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb515a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb4fdb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0516eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb515a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb515f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0516f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb4fdb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0516eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab051702c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0516f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb515a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05170c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab051702c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab05171580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb515a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab05170c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05171740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab05171580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb515f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab05171900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab05171740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   178.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.64 ms
whisper_print_timings:   sample time =    65.63 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4635.21 ms /     1 runs ( 4635.21 ms per run)
whisper_print_timings:   decode time =    15.21 ms /     2 runs (    7.61 ms per run)
whisper_print_timings:   batchd time =   707.51 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5619.64 ms
...
main:     load time =    81.01 ms
main:    total time = 39704.60 ms
embd_img
...
main:      load time = 16151.04 ms
main:    sample time =   524.88 ms / 8.20 ms per token
main:      eval time = 44059.00 ms / 629.41 ms per token
main:     total time = 63106.28 ms
...
main:      load time =  4371.00 ms
main:    sample time =   515.16 ms / 8.05 ms per token
main:      eval time = 17523.24 ms / 250.33 ms per token
main:     total time = 23392.12 ms
