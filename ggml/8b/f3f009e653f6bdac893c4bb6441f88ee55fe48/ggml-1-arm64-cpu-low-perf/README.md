...
- status:  SUCCESS ✅
- runtime: 3:37.20
- date:    Sat Jan  6 03:21:37 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.63 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   43.03 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.17 sec
      Start  9: test3
...
main:  predict time =   994.80 ms / 15.54 ms per token
main:    total time =  1227.15 ms
...
main:     load time =   193.57 ms
main:   sample time =    17.66 ms
main:  predict time =   922.26 ms / 13.18 ms per token
main:    total time =  1136.46 ms
...
main:     n_decoded =      504
main:     load time =   166.49 ms
main:   sample time =   127.83 ms
main:  predict time =  6235.28 ms
main:    total time =  6611.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a5ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8a44b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8af7b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a5ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a5cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf8af8960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8a44b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8af7b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf8af92c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf8af8960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a5ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf8af9c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf8af92c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf8afa580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a5ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf8af9c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf8afa740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf8afa580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a5cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf8afa900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf8afa740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    67.43 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4762.94 ms /     1 runs ( 4762.94 ms per run)
whisper_print_timings:   decode time =    15.64 ms /     2 runs (    7.82 ms per run)
whisper_print_timings:   batchd time =   715.11 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5693.10 ms
...
main:     load time =    97.04 ms
main:    total time = 40659.71 ms
embd_img
