...
- status:  SUCCESS ✅
- runtime: 4:17.51
- date:    Sat Jan  6 03:22:19 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/8bf3f009e653f6bdac893c4bb6441f88ee55fe48
- author:  旺旺碎冰冰
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.40 sec
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    6.58 sec
      Start  6: test0
...
20/20 Test #20: test-backend-ops .................   Passed   28.01 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    3.27 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    1.61 sec
 ...
 6/21 Test  #6: test-mul-mat2 ....................   Passed    2.82 sec
      Start  7: test0
...
21/21 Test #21: test-backend-ops .................   Passed    8.88 sec
...
main:     load time =   198.82 ms
main:   sample time =    23.47 ms
main:  predict time =   444.42 ms / 6.94 ms per token
main:    total time =   679.67 ms
...
main:     load time =   129.36 ms
main:   sample time =    23.47 ms
main:  predict time =   458.22 ms / 6.55 ms per token
main:    total time =   613.18 ms
...
main:     n_decoded =      504
main:     load time =   107.82 ms
main:   sample time =   177.95 ms
main:  predict time =  1501.05 ms
main:    total time =  1817.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5ae4a12990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ae48931a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c26fb60b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5ae4a12030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5ae4a17940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c26fb61960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f5ae48931a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c26fb60b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c26fb622c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c26fb61960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f5ae4a12030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c26fb62c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c26fb622c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c26fb63580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f5ae4a12990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c26fb62c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c26fb63740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c26fb63580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f5ae4a17940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c26fb63900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c26fb63740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   125.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.84 ms
whisper_print_timings:   sample time =    56.01 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1161.03 ms /     1 runs ( 1161.03 ms per run)
whisper_print_timings:   decode time =     9.91 ms /     2 runs (    4.95 ms per run)
whisper_print_timings:   batchd time =   214.78 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1586.40 ms
...
main:     load time =    62.41 ms
main:    total time = 10602.00 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 0.459000 sec.)
...
main:      load time = 14255.03 ms
main:    sample time =   467.55 ms / 7.31 ms per token
main:      eval time = 20733.31 ms / 296.19 ms per token
main:     total time = 36126.17 ms
...
main:      load time =  4368.54 ms
main:    sample time =   494.94 ms / 7.73 ms per token
main:      eval time =  9202.30 ms / 131.46 ms per token
main:     total time = 14421.68 ms
