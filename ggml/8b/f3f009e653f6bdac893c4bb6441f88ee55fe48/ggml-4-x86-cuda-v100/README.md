...
- status:  SUCCESS ✅
- runtime: 8:59.81
- date:    Sat Jan  6 03:26:48 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   62.51 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    8.12 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    1.08 sec
      Start 11: test-pool
...
21/21 Test #21: test-backend-ops .................   Passed   24.60 sec
...
main:     load time =   563.38 ms
main:   sample time =    34.10 ms
main:  predict time =   570.61 ms / 8.92 ms per token
main:    total time =  1187.93 ms
...
main:     load time =   562.14 ms
main:   sample time =    34.02 ms
main:  predict time =   584.78 ms / 8.35 ms per token
main:    total time =  1185.07 ms
...
main:     n_decoded =      504
main:     load time =   535.69 ms
main:   sample time =   232.04 ms
main:  predict time =  2299.76 ms
main:    total time =  3111.84 ms
...
main: loaded model in   412.38 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f61f7a59990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f61f78da1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c392aebca0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f61f7a59030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f61f7a5e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c392aeca70                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f61f78da1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c392aebca0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c392aed3d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c392aeca70                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f61f7a59030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c392aedd30                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c392aed3d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c392aee690                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f61f7a59990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c392aedd30                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c392aee850                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c392aee690                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f61f7a5e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c392aeea10                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c392aee850       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   507.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.31 ms
whisper_print_timings:   sample time =    69.16 ms /   131 runs (    0.53 ms per run)
whisper_print_timings:   encode time =    33.75 ms /     1 runs (   33.75 ms per run)
whisper_print_timings:   decode time =    13.05 ms /     2 runs (    6.53 ms per run)
whisper_print_timings:   batchd time =    82.68 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   733.53 ms
...
main:     load time =   498.32 ms
main:    total time =  8156.06 ms
embd_img
...
main:      load time = 27197.02 ms
main:    sample time =   548.38 ms / 8.57 ms per token
main:      eval time = 24989.95 ms / 357.00 ms per token
main:     total time = 53593.05 ms
...
main:      load time = 14563.75 ms
main:    sample time =   547.27 ms / 8.55 ms per token
main:      eval time = 12327.67 ms / 176.11 ms per token
main:     total time = 28112.62 ms
