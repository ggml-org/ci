...
- status:  SUCCESS ✅
- runtime: 3:46.80
- date:    Sat Oct  7 10:40:45 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.75 sec
      Start  2: test-opt
...
main:     load time =   187.25 ms
main:   sample time =    17.18 ms
main:  predict time =   806.57 ms / 12.60 ms per token
main:    total time =  1033.96 ms
...
main:  predict time =   871.76 ms / 12.45 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e0aa900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9df2b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2183ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e0a9fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e0af880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad2184870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9df2b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2183ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad21851a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad2184870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e0a9fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad2185ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad21851a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad2186400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e0aa900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad2185ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad2186590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad2186400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e0af880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad2186720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad2186590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   206.47 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.55 ms
whisper_print_timings:   sample time =    16.87 ms /    27 runs (    0.62 ms per run)
whisper_print_timings:   encode time =  4605.71 ms /     1 runs ( 4605.71 ms per run)
whisper_print_timings:   decode time =   175.84 ms /    27 runs (    6.51 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5075.65 ms
```
### mpt
...
main:      load time =  5654.54 ms
main:    sample time =   517.08 ms / 8.08 ms per token
main:      eval time = 43505.05 ms / 621.50 ms per token
main:     total time = 52048.99 ms
...
main:      load time =  1479.59 ms
main:    sample time =   517.79 ms / 8.09 ms per token
main:      eval time = 17332.91 ms / 247.61 ms per token
main:     total time = 20293.69 ms
