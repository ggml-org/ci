...
- status:  SUCCESS ✅
- runtime: 4:55.57
- date:    Sat Oct  7 10:42:06 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.28 sec
      Start 10: test3
...
main:     load time =   226.17 ms
main:   sample time =    35.29 ms
main:  predict time =   557.95 ms / 8.72 ms per token
main:    total time =   839.26 ms
...
main:  predict time =   572.23 ms / 8.17 ms per token
main:    total time =   760.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80d48be900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80d473f170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f37e5b0ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f80d48bdfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f80d48c3880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f37e5b1870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80d473f170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f37e5b0ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f37e5b21a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f37e5b1870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f80d48bdfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f37e5b2ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f37e5b21a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f37e5b3400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80d48be900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f37e5b2ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f37e5b3590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f37e5b3400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f80d48c3880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f37e5b3720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f37e5b3590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   248.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.34 ms
whisper_print_timings:   sample time =    20.28 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1841.10 ms /     1 runs ( 1841.10 ms per run)
whisper_print_timings:   decode time =   132.04 ms /    27 runs (    4.89 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2329.04 ms
```
### mpt
...
main:      load time = 14322.43 ms
main:    sample time =   579.25 ms / 9.05 ms per token
main:      eval time = 24084.94 ms / 344.07 ms per token
main:     total time = 39878.00 ms
...
main:      load time = 10029.38 ms
main:    sample time =   575.38 ms / 8.99 ms per token
main:      eval time = 12255.33 ms / 175.08 ms per token
main:     total time = 23484.71 ms
