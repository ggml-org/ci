...
- status:  SUCCESS ✅
- runtime: 2:48.38
- date:    Sat Oct  7 10:39:52 UTC 2023
...
main:     load time =   202.81 ms
main:   sample time =    23.94 ms
main:  predict time =   484.39 ms / 7.57 ms per token
main:    total time =   724.74 ms
...
main:     load time =   116.19 ms
main:   sample time =    23.97 ms
main:  predict time =   490.45 ms / 7.01 ms per token
main:    total time =   633.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f83e9083900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f83e8f04170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b689a6ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f83e9082fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f83e9088880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555b689a7870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f83e8f04170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555b689a6ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555b689a81a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x555b689a7870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f83e9082fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555b689a8ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x555b689a81a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555b689a9400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f83e9083900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x555b689a8ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555b689a9590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x555b689a9400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f83e9088880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x555b689a9720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x555b689a9590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   143.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.87 ms
whisper_print_timings:   sample time =    16.60 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1160.06 ms /     1 runs ( 1160.06 ms per run)
whisper_print_timings:   decode time =   109.28 ms /    27 runs (    4.05 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1488.88 ms
```
### mpt
...
main:      load time =  5681.23 ms
main:    sample time =   464.47 ms / 7.26 ms per token
main:      eval time = 22042.81 ms / 314.90 ms per token
main:     total time = 28878.70 ms
...
main:      load time =  1311.53 ms
main:    sample time =   462.69 ms / 7.23 ms per token
main:      eval time =  9161.35 ms / 130.88 ms per token
main:     total time = 11323.18 ms
