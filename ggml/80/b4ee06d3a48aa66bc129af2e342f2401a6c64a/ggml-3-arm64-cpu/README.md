...
- status:  SUCCESS ✅
- runtime: 3:09.90
- date:    Sun Jun 16 12:07:48 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.52 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   33.30 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed   10.76 sec
      Start  4: test-mul-mat0
 4/21 Test  #4: test-mul-mat0 ....................   Passed    0.57 sec
      Start  5: test-mul-mat2
 5/21 Test  #5: test-mul-mat2 ....................   Passed    8.62 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.43 sec
      Start  2: test-opt
 ...
 5/22 Test  #5: test-mul-mat0 ....................   Passed    0.53 sec
...
main:   sample time =    18.50 ms
main:  predict time =   879.79 ms / 13.75 ms per token
main:    total time =  1071.81 ms
...
main:     load time =   155.54 ms
main:   sample time =    18.46 ms
main:  predict time =   956.50 ms / 13.66 ms per token
main:    total time =  1133.17 ms
...
main:     load time =   191.17 ms
main:   sample time =    23.79 ms
main:  predict time =   962.09 ms / 13.74 ms per token
main:    total time =  1180.35 ms
...
main:     n_decoded =      504
main:     load time =   153.55 ms
main:   sample time =   127.94 ms
main:  predict time =  6079.71 ms
main:    total time =  6444.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe7479068a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe7479050b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc838cce26ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe7479068a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xe7479068f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc838cce27ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xe7479050b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc838cce26ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc838cce28410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc838cce27ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xe7479068a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc838cce28d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc838cce28410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc838cce296d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xe7479068a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc838cce28d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc838cce29890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc838cce296d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xe7479068f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc838cce29a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc838cce29890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.08 ms
whisper_print_timings:   sample time =    67.18 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4702.13 ms /     1 runs ( 4702.13 ms per run)
whisper_print_timings:   decode time =    14.71 ms /     2 runs (    7.36 ms per run)
whisper_print_timings:   batchd time =   730.55 ms /   125 runs (    5.84 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5653.85 ms
...
main:     load time =    90.72 ms
main:    total time = 39880.04 ms
embd_img
