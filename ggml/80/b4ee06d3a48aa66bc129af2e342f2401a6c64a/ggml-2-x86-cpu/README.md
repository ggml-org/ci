...
- status:  SUCCESS ✅
- runtime: 2:08.71
- date:    Sun Jun 16 12:09:24 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   30.06 sec
...
main:  predict time =   484.91 ms / 7.58 ms per token
main:    total time =   624.33 ms
...
main:  predict time =   492.62 ms / 7.04 ms per token
main:    total time =   621.28 ms
...
main:  predict time =   505.54 ms / 7.22 ms per token
main:    total time =   657.25 ms
...
main:  predict time =  1542.99 ms
main:    total time =  1857.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcbefafa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcbef97b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6256f9dd8ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcbefafa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcbefaff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6256f9dd9ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcbef97b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x6256f9dd8ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6256f9dda410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x6256f9dd9ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcbefafa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6256f9ddad70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x6256f9dda410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6256f9ddb6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcbefafa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x6256f9ddad70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6256f9ddb890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x6256f9ddb6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcbefaff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x6256f9ddba50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x6256f9ddb890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =    55.76 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1161.73 ms /     1 runs ( 1161.73 ms per run)
whisper_print_timings:   decode time =    11.30 ms /     2 runs (    5.65 ms per run)
whisper_print_timings:   batchd time =   220.69 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1551.70 ms
