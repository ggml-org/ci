...
- status:  SUCCESS ✅
- runtime: 4:05.50
- date:    Sun Apr  7 01:15:48 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/809a16326681caa73505042f98415d90b728b5ec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    3.40 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   22.07 sec
      Start  9: test3
...
main:  predict time =   903.57 ms / 14.12 ms per token
main:    total time =  1102.41 ms
...
main:  predict time =   984.52 ms / 14.06 ms per token
main:    total time =  1166.15 ms
...
main:  predict time =  1042.68 ms / 14.90 ms per token
main:    total time =  1263.86 ms
...
main:   sample time =   130.06 ms
main:  predict time =  6459.44 ms
main:    total time =  6832.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ef0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ed8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0ae76ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ef0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ef0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0ae77ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8ed8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0ae76ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0ae78410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0ae77ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8ef0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0ae78d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0ae78410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0ae796d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8ef0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0ae78d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0ae79890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0ae796d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8ef0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0ae79a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0ae79890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4741.89 ms /     1 runs ( 4741.89 ms per run)
whisper_print_timings:   decode time =    14.82 ms /     2 runs (    7.41 ms per run)
whisper_print_timings:   batchd time =   715.20 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5667.23 ms
...
main:     load time =    99.45 ms
main:    total time = 40173.52 ms
embd_img
