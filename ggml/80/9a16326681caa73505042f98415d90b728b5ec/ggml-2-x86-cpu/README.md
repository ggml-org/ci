...
- status:  SUCCESS ✅
- runtime: 2:10.82
- date:    Sun Apr  7 13:21:15 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   30.61 sec
...
main:  predict time =   495.66 ms / 7.74 ms per token
main:    total time =   637.41 ms
...
main:  predict time =   519.28 ms / 7.42 ms per token
main:    total time =   650.38 ms
...
main:  predict time =   521.51 ms / 7.45 ms per token
main:    total time =   672.56 ms
...
main:  predict time =  1821.64 ms
main:    total time =  2137.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff706b19990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff70699a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560b3366ace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff706b19030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff706b1e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560b3366bab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ff70699a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560b3366ace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560b3366c410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560b3366bab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ff706b19030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560b3366cd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560b3366c410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560b3366d6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ff706b19990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560b3366cd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560b3366d890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560b3366d6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ff706b1e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560b3366da50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560b3366d890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.50 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.81 ms
whisper_print_timings:   sample time =    56.48 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1189.32 ms /     1 runs ( 1189.32 ms per run)
whisper_print_timings:   decode time =    12.29 ms /     2 runs (    6.15 ms per run)
whisper_print_timings:   batchd time =   218.81 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1570.03 ms
