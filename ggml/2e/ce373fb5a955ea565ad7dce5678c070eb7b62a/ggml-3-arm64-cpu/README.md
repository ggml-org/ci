...
- status:  SUCCESS ✅
- runtime: 5:48.73
- date:    Fri Jan  5 02:06:27 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.26 sec
...
20/20 Test #20: test-backend-ops .................   Passed   34.71 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  48.58 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/21 Test  #1: test-grad0 .......................   Passed    4.14 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    2.07 sec
...
12/21 Test #12: test-conv-transpose ..............   Passed    0.00 sec
      Start 13: test-dup
13/21 Test #13: test-dup .........................   Passed    0.01 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.21 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  18.91 sec
...
main:     load time =   272.79 ms
main:   sample time =    16.92 ms
main:  predict time =   824.33 ms / 12.88 ms per token
main:    total time =  1135.91 ms
...
main:     load time =   166.01 ms
main:   sample time =    16.82 ms
main:  predict time =   904.74 ms / 12.92 ms per token
main:    total time =  1090.38 ms
...
main:     n_decoded =      504
main:     load time =   144.49 ms
main:   sample time =   128.72 ms
main:  predict time =  5999.38 ms
main:    total time =  6353.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a05a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff89edb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0b5bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a05a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a05f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0b5c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff89edb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae0b5bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae0b5d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae0b5c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8a05a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae0b5dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae0b5d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0b5e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8a05a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae0b5dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0b5e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae0b5e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8a05f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae0b5e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae0b5e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   184.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.99 ms
whisper_print_timings:   sample time =    65.64 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4643.57 ms /     1 runs ( 4643.57 ms per run)
whisper_print_timings:   decode time =    15.21 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   706.80 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5633.95 ms
...
main:     load time =    77.57 ms
main:    total time = 39746.28 ms
embd_img
...
main:      load time = 12750.26 ms
main:    sample time =   521.45 ms / 8.15 ms per token
main:      eval time = 43663.31 ms / 623.76 ms per token
main:     total time = 59306.92 ms
...
main:      load time =  4312.09 ms
main:    sample time =   517.79 ms / 8.09 ms per token
main:      eval time = 17740.22 ms / 253.43 ms per token
main:     total time = 23544.13 ms
