...
- status:  SUCCESS ✅
- runtime: 5:22.21
- date:    Fri Jan  5 13:45:31 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   27.96 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.07 sec
...
main:     load time =   195.55 ms
main:   sample time =    23.52 ms
main:  predict time =   452.53 ms / 7.07 ms per token
main:    total time =   684.43 ms
...
main:  predict time =  1508.43 ms
main:    total time =  1825.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4b8717a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4b86ffb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cb4433db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4b8717a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4b8717f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cb4433e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4b86ffb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cb4433db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cb4433f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cb4433e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4b8717a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cb4433fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cb4433f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cb44340580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4b8717a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cb4433fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cb44340740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cb44340580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4b8717f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55cb44340900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cb44340740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    55.90 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1164.67 ms /     1 runs ( 1164.67 ms per run)
whisper_print_timings:   decode time =    10.39 ms /     2 runs (    5.19 ms per run)
whisper_print_timings:   batchd time =   215.18 ms /   125 runs (    1.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1587.09 ms
...
main:      load time =  7899.30 ms
main:    sample time =   468.18 ms / 7.32 ms per token
main:      eval time = 20534.20 ms / 293.35 ms per token
main:     total time = 29569.80 ms
...
main:      load time =  1503.47 ms
main:    sample time =   466.10 ms / 7.28 ms per token
main:      eval time =  8156.20 ms / 116.52 ms per token
main:     total time = 10498.21 ms
