...
- status:  SUCCESS ✅
- runtime: 2:11.69
- date:    Sun Jul 23 14:46:30 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/10 Test  #1: test-grad0 .......................   Passed    6.41 sec
      Start  2: test-quantize-fns
 2/10 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 3/10 Test  #3: test-quantize-perf ...............   Passed    0.02 sec
      Start  4: test-mul-mat0
 4/10 Test  #4: test-mul-mat0 ....................   Passed    0.60 sec
 ...
 7/10 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/10 Test  #8: test2 ............................   Passed   16.92 sec
      Start  9: test3
...
main:     load time =   168.07 ms
main:   sample time =    17.42 ms
main:  predict time =   813.93 ms / 12.72 ms per token
main:    total time =  1072.89 ms
...
main: mem per token =  2015100 bytes
main:     load time =   168.54 ms
main:   sample time =    17.28 ms
main:  predict time =   879.76 ms / 12.57 ms per token
main:    total time =  1115.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb90da870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8f5b140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae70d5aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb90d9f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb90df7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae70d6810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8f5b140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae70d5aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae70d7110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae70d6810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb90d9f70                         fc1_bias

DST    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0xaaaae70d7a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae70d7110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae70d8310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb90da870                       fc2_weight
SRC    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0xaaaae70d7a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae70d8470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae70d8310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb90df7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae70d85d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae70d8470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
+++ /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-1-arm64-cpu-low-perf/stdall	2023-07-23 14:46:30.074838720 +0000
@@ -1,15 +1,105 @@
...
+     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 74.0/74.0 MB 9.8 MB/s eta 0:00:00
...
+     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 7.1/7.1 MB 93.9 MB/s eta 0:00:00
+Collecting psutil
+  Downloading psutil-5.9.5.tar.gz (493 kB)
+     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 493.5/493.5 KB 47.9 MB/s eta 0:00:00
...
+     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 48.9/48.9 KB 9.6 MB/s eta 0:00:00
...
+     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 769.2/769.2 KB 62.3 MB/s eta 0:00:00
...
+     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 163.8/163.8 KB 29.5 MB/s eta 0:00:00
+Collecting mpmath>=0.19
+  Downloading mpmath-1.3.0-py3-none-any.whl (536 kB)
+     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 536.2/536.2 KB 54.3 MB/s eta 0:00:00
...
+  Created wheel for psutil: filename=psutil-5.9.5-cp310-abi3-linux_aarch64.whl size=281041 sha256=17f885ecb546081c2551e09bd19d470ef20ce2cc2dcf27620eb6a93718a0aa0b
...
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-1-arm64-cpu-low-perf/mnist-mnist.log
++ ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
