...
- status:  SUCCESS ✅
- runtime: 1:39.90
- date:    Sun Jul 23 14:47:04 UTC 2023
...
Total Test time (real) =  32.30 sec
...
main:     load time =   126.77 ms
main:   sample time =    23.88 ms
main:  predict time =   605.73 ms / 9.46 ms per token
main:    total time =   810.68 ms
...
main: mem per token =  2015100 bytes
main:     load time =   129.55 ms
main:   sample time =    23.78 ms
main:  predict time =   636.64 ms / 9.09 ms per token
main:    total time =   830.95 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cfec39870                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cfeaba140                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ec4535aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cfec38f70                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cfec3e7c0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ec4536810                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8cfeaba140                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558ec4535aa0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ec4537110                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558ec4536810                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8cfec38f70                         fc1_bias

DST    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0x558ec4537a10                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558ec4537110                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ec4538310                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8cfec39870                       fc2_weight
SRC    f32    RELU                2 500 1 1 1                4             2000             2000             2000   0x558ec4537a10                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ec4538470                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558ec4538310                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8cfec3e7c0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558ec45385d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558ec4538470       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
```diff
--- /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/stdall	2023-07-23 14:36:49.410139577 +0000
+++ /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/stdall	2023-07-23 14:47:04.675471242 +0000
@@ -1,15 +1,55 @@
 mkdir: cannot create directory ‘/mnt/ggml’: Permission denied
-rm: cannot remove '/home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/*.log': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/*.exit': No such file or directory
-rm: cannot remove '/home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/*.md': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/*.log': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/*.exit': No such file or directory
+rm: cannot remove '/home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/*.md': No such file or directory
...
-+ tee /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_debug.log
++ tee /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_debug.log
 + mkdir build-ci-debug
 + cd build-ci-debug
 + set -e
-+ tee -a /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_debug-cmake.log
...
-user	0m0.284s
-sys	0m0.093s
-+ tee -a /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_debug-make.log
+real	0m0.414s
+user	0m0.245s
+sys	0m0.129s
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_debug-make.log
 + make -j
...
-[ 16%] Building CXX object examples/mnist/CMakeFiles/mnist-cpu.dir/main-cpu.cpp.o
...
-user	0m37.544s
-sys	0m3.576s
-+ tee -a /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_debug-ctest.log
+real	0m12.549s
+user	0m37.874s
+sys	0m3.327s
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_debug-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-debug
       Start  1: test-grad0
...
+sys	0m3.204s
 ...
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_release.log
 + rm -rf build-ci-release
++ tee /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_release.log
 + mkdir build-ci-release
 + cd build-ci-release
 + set -e
-+ tee -a /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_release-cmake.log
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_release-cmake.log
...
-user	0m0.270s
-sys	0m0.102s
-+ tee -a /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_release-make.log
+real	0m0.392s
+user	0m0.272s
+sys	0m0.103s
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_release-make.log
 + make -j
 [  1%] Building CXX object examples/CMakeFiles/common.dir/common.cpp.o
 [  2%] Building C object src/CMakeFiles/ggml.dir/ggml.c.o
...
+sys	0m3.055s
 + '[' -z 1 ']'
-+ tee -a /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/ctest_release-ctest.log
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/ctest_release-ctest.log
 + ctest --output-on-failure -E test-opt
 Test project /home/ggml/work/ggml/build-ci-release
       Start  1: test-grad0
...
+sys	0m3.059s
 ...
 + gg_run_gpt_2
 + cd /home/ggml/work/ggml
-+ tee /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/gpt_2.log
++ tee /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/gpt_2.log
...
-+ tee -a /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/gpt_2-tg.log
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/gpt_2-tg.log
 + ./bin/gpt-2 --model ../models-mnt/gpt-2/ggml-model-gpt-2-117M.bin -s 1234 -n 64 -tt ../examples/prompts/gpt-2.txt
 test_gpt_tokenizer : failed test: 'I l0ve t0 tr@vel @r0und the w0rld.'
 test_gpt_tokenizer : tokens in hf:   I(40),  l(300), 0(15), ve(303),  t(256), 0(15),  tr(491), @(31), vel(626),  @(2488), r(81), 0(15), und(917),  the(262),  w(266), 0(15), r(81), ld(335), .(13), 
@@ -466,15 +506,15 @@
 ...
 main: mem per token =  2015100 bytes
-main:     load time =   129.69 ms
-main:   sample time =    24.00 ms
-main:  predict time =   594.84 ms / 9.29 ms per token
-main:    total time =   802.84 ms
-
-real	0m0.811s
-user	0m2.501s
-sys	0m0.144s
...
@@ -499,14 +539,14 @@
 ...
 main: mem per token =  2015100 bytes
-main:     load time =   130.20 ms
-main:   sample time =    23.86 ms
-main:  predict time =   630.65 ms / 9.01 ms per token
-main:    total time =   825.87 ms
-
-real	0m0.834s
-user	0m2.611s
-sys	0m0.159s
...
@@ -514,15 +554,258 @@
 ...
 + cd /home/ggml/work/ggml
 + cd build-ci-release
++ tee /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/mnist.log
 + set -e
 + mkdir -p models/mnist
-+ tee /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/mnist.log
 + python3 ../examples/mnist/convert-h5-to-ggml.py ../examples/mnist/models/mnist/mnist_model.state_dict
-Traceback (most recent call last):
-  File "/home/ggml/work/ggml/build-ci-release/../examples/mnist/convert-h5-to-ggml.py", line 18, in <module>
-    import numpy as np
...
++ tee -a /home/ggml/results/ggml/2e/dd7a45bef7cbd02de319e68e7ab68e9a18b9f2/ggml-0-x86-cpu-low-perf/mnist-mnist.log
++ ./bin/mnist ./models/mnist/ggml-model-f32.bin ../examples/mnist/models/mnist/t10k-images.idx3-ubyte
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
+_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
...
++ echo 0
 + set +x
-cat: /home/ggml/results/ggml/58/ebb0eb64448418056fa668d9552ba244e1044f/ggml-0-x86-cpu-low-perf/mnist-mnist.log: No such file or directory
```
</details>
