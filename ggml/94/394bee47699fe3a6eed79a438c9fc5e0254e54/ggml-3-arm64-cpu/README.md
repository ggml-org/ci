...
- status:  SUCCESS ✅
- runtime: 5:48.54
- date:    Thu Jan  4 09:01:47 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/20 Test  #8: test2 ............................   Passed    0.31 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.30 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   34.74 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.18 sec
...
main:     load time =   268.61 ms
main:   sample time =    16.97 ms
main:  predict time =   824.59 ms / 12.88 ms per token
main:    total time =  1131.94 ms
...
main:  predict time =   895.59 ms / 12.79 ms per token
main:    total time =  1097.34 ms
...
main:     n_decoded =      504
main:     load time =   145.85 ms
main:   sample time =   126.80 ms
main:  predict time =  5988.67 ms
main:    total time =  6342.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa650a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa638b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadd38eb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa650a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa650f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadd38f960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa638b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadd38eb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadd3902c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadd38f960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa650a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadd390c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadd3902c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadd391580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa650a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadd390c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadd391740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadd391580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa650f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadd391900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadd391740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   182.96 ms
...
whisper_print_timings:   batchd time =   707.32 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5626.43 ms
...
main:     load time =    78.39 ms
main:    total time = 39729.26 ms
embd_img
...
main:      load time = 12329.31 ms
main:    sample time =   518.04 ms / 8.09 ms per token
main:      eval time = 43694.32 ms / 624.20 ms per token
main:     total time = 58914.18 ms
...
main:      load time =  4367.27 ms
main:    sample time =   513.50 ms / 8.02 ms per token
main:      eval time = 17408.81 ms / 248.70 ms per token
main:     total time = 23262.67 ms
