...
- status:  SUCCESS ✅
- runtime: 4:09.94
- date:    Thu Jan  4 21:00:12 UTC 2024
...
21/21 Test #21: test-backend-ops .................   Passed    7.98 sec
...
main:     load time =   183.88 ms
main:   sample time =    23.43 ms
main:  predict time =   441.51 ms / 6.90 ms per token
main:    total time =   661.48 ms
...
main:     load time =   131.99 ms
main:   sample time =    23.65 ms
main:  predict time =   466.25 ms / 6.66 ms per token
main:    total time =   624.06 ms
...
main:     n_decoded =      504
main:     load time =   106.88 ms
main:   sample time =   177.74 ms
main:  predict time =  1501.81 ms
main:    total time =  1817.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7ec2827990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7ec26a81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563bfd7f2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7ec2827030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7ec282c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563bfd7f3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7ec26a81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563bfd7f2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563bfd7f42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x563bfd7f3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7ec2827030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563bfd7f4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x563bfd7f42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563bfd7f5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7ec2827990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x563bfd7f4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563bfd7f5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x563bfd7f5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7ec282c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x563bfd7f5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x563bfd7f5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   120.12 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.36 ms
whisper_print_timings:   sample time =    55.94 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1166.35 ms /     1 runs ( 1166.35 ms per run)
whisper_print_timings:   decode time =     9.95 ms /     2 runs (    4.97 ms per run)
whisper_print_timings:   batchd time =   211.05 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1581.65 ms
...
main:      load time = 11740.26 ms
main:    sample time =   468.58 ms / 7.32 ms per token
main:      eval time = 20273.02 ms / 289.61 ms per token
main:     total time = 33167.37 ms
...
main:      load time =  4381.70 ms
main:    sample time =   463.81 ms / 7.25 ms per token
main:      eval time =  8223.24 ms / 117.47 ms per token
main:     total time = 13445.03 ms
