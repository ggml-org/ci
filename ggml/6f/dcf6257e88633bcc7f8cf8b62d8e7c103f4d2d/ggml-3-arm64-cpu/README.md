...
- status:  SUCCESS ✅
- runtime: 7:06.59
- date:    Wed Jan  3 09:15:05 AM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   34.91 sec
...
21/21 Test #21: test-backend-ops .................   Passed   10.15 sec
...
main:     load time =   255.56 ms
main:   sample time =    16.99 ms
main:  predict time =   822.28 ms / 12.85 ms per token
main:    total time =  1116.55 ms
...
main:     load time =   182.13 ms
main:   sample time =    16.80 ms
main:  predict time =   894.61 ms / 12.78 ms per token
main:    total time =  1096.53 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f60a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f48b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0bd47b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f60a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f60f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0bd48960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f48b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0bd47b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0bd492c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0bd48960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f60a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0bd49c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0bd492c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0bd4a580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f60a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0bd49c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0bd4a740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0bd4a580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f60f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0bd4a900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0bd4a740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   183.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.11 ms
whisper_print_timings:   sample time =    65.24 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4630.50 ms /     1 runs ( 4630.50 ms per run)
whisper_print_timings:   decode time =    15.06 ms /     2 runs (    7.53 ms per run)
whisper_print_timings:   batchd time =   707.62 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5619.61 ms
...
main:     load time =    79.44 ms
main:    total time = 39690.04 ms
embd_img
...
main:      load time = 11996.62 ms
main:    sample time =   519.52 ms / 8.12 ms per token
main:      eval time = 43733.22 ms / 624.76 ms per token
main:     total time = 58621.21 ms
...
main:      load time =  4352.98 ms
main:    sample time =   515.67 ms / 8.06 ms per token
main:      eval time = 17903.90 ms / 255.77 ms per token
main:     total time = 23743.51 ms
