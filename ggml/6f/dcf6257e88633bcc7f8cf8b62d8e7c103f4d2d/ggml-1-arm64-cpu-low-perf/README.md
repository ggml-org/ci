...
- status:  SUCCESS ✅
- runtime: 4:37.39
- date:    Wed Jan  3 09:12:21 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.61 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.36 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   43.06 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.21 sec
      Start  9: test3
...
main:     load time =   198.76 ms
main:   sample time =    18.51 ms
main:  predict time =   877.18 ms / 13.71 ms per token
main:    total time =  1116.88 ms
...
main:     load time =   191.09 ms
main:   sample time =    17.84 ms
main:  predict time =   923.25 ms / 13.19 ms per token
main:    total time =  1135.24 ms
...
main:     n_decoded =      504
main:     load time =   163.93 ms
main:   sample time =   129.40 ms
main:  predict time =  6220.92 ms
main:    total time =  6595.75 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff983ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9823b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf286cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff983ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff983bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf286d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9823b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf286cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf286e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf286d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff983ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf286ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf286e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf286f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff983ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf286ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf286f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf286f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff983bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf286f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf286f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.73 ms
whisper_print_timings:   sample time =    66.26 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4750.71 ms /     1 runs ( 4750.71 ms per run)
whisper_print_timings:   decode time =    15.52 ms /     2 runs (    7.76 ms per run)
whisper_print_timings:   batchd time =   711.26 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5676.49 ms
