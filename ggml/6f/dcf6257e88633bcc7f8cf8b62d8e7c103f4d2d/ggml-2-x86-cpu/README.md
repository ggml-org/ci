...
- status:  SUCCESS ✅
- runtime: 4:10.49
- date:    Wed Jan  3 09:11:49 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/6fdcf6257e88633bcc7f8cf8b62d8e7c103f4d2d
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.44 sec
...
20/20 Test #20: test-backend-ops .................   Passed   27.95 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.30 sec
      Start  2: test-opt
 ...
 5/21 Test  #5: test-mul-mat0 ....................   Passed    0.51 sec
...
main:     load time =   184.91 ms
main:   sample time =    23.53 ms
main:  predict time =   446.36 ms / 6.97 ms per token
main:    total time =   667.54 ms
...
main:     load time =   131.54 ms
main:   sample time =    23.50 ms
main:  predict time =   469.84 ms / 6.71 ms per token
main:    total time =   626.99 ms
...
main:     n_decoded =      504
main:     load time =   107.91 ms
main:   sample time =   177.64 ms
main:  predict time =  1520.10 ms
main:    total time =  1846.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f50f0e14990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f50f0c951a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a450c08b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f50f0e14030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f50f0e19940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a450c09960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f50f0c951a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a450c08b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a450c0a2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a450c09960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f50f0e14030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a450c0ac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a450c0a2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a450c0b580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f50f0e14990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a450c0ac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a450c0b740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a450c0b580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f50f0e19940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a450c0b900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a450c0b740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   122.70 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =    54.28 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1157.58 ms /     1 runs ( 1157.58 ms per run)
whisper_print_timings:   decode time =     9.30 ms /     2 runs (    4.65 ms per run)
whisper_print_timings:   batchd time =   205.94 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1568.16 ms
...
main:     load time =    60.00 ms
main:    total time = 10641.83 ms
embd_img
...
main:      load time = 11346.77 ms
main:    sample time =   469.92 ms / 7.34 ms per token
main:      eval time = 20365.89 ms / 290.94 ms per token
main:     total time = 32886.54 ms
...
main:      load time =  4372.15 ms
main:    sample time =   464.54 ms / 7.26 ms per token
main:      eval time =  8668.87 ms / 123.84 ms per token
main:     total time = 13887.29 ms
