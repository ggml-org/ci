...
- status:  SUCCESS ✅
- runtime: 2:49.74
- date:    Wed Jan  3 09:10:25 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   10.07 sec
      Start  9: test3
...
main:     load time =   131.12 ms
main:   sample time =    23.52 ms
main:  predict time =   613.96 ms / 9.59 ms per token
main:    total time =   782.29 ms
...
main:  predict time =   655.42 ms / 9.36 ms per token
main:    total time =   810.03 ms
...
main:  predict time =  2501.65 ms
main:    total time =  2830.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efe94d0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efe94b8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55baa005cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efe94d0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efe94d0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55baa005d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efe94b8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55baa005cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55baa005e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55baa005d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efe94d0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55baa005ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55baa005e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55baa005f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efe94d0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55baa005ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55baa005f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55baa005f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efe94d0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55baa005f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55baa005f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.54 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.13 ms
whisper_print_timings:   sample time =    72.93 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1991.20 ms /     1 runs ( 1991.20 ms per run)
whisper_print_timings:   decode time =    12.91 ms /     2 runs (    6.45 ms per run)
whisper_print_timings:   batchd time =   324.88 ms /   125 runs (    2.60 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2503.93 ms
...
main:     load time =    70.54 ms
main:    total time = 18986.01 ms
embd_img
