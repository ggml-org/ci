...
- status:  SUCCESS ✅
- runtime: 4:52.30
- date:    Wed Aug 30 11:53:11 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.57 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.36 sec
      Start  2: test-opt
...
main:     load time =  1195.69 ms
main:   sample time =    34.92 ms
main:  predict time =   550.26 ms / 8.60 ms per token
main:    total time =  1801.44 ms
...
main:     load time =   202.91 ms
main:   sample time =    35.10 ms
main:  predict time =   567.28 ms / 8.10 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3c4cd9a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3c4cc1b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f66d9cbab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3c4cd99f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3c4cd9f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f66d9cc830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f3c4cc1b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f66d9cbab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f66d9cd140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55f66d9cc830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f3c4cd99f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f66d9cda50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55f66d9cd140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f66d9ce360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f3c4cd9a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55f66d9cda50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f66d9ce4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55f66d9ce360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3c4cd9f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55f66d9ce640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55f66d9ce4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  7147.91 ms
main:    sample time =   577.52 ms / 9.02 ms per token
main:      eval time = 25088.36 ms / 358.41 ms per token
main:     total time = 33704.00 ms
...
main:      load time =  1682.14 ms
main:    sample time =   582.90 ms / 9.11 ms per token
main:      eval time = 12086.50 ms / 172.66 ms per token
main:     total time = 14997.46 ms
