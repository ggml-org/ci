...
- status:  SUCCESS ✅
- runtime: 3:45.03
- date:    Wed Aug 30 11:52:13 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/0407211ba0eb91c4ba4b9735e42f739e0216b615
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.61 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.65 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.51 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.48 sec
      Start  3: test-quantize-fns
 3/15 Test  #3: test-quantize-fns ................   Passed    0.01 sec
      Start  4: test-quantize-perf
 4/15 Test  #4: test-quantize-perf ...............   Passed    0.01 sec
      Start  5: test-mul-mat0
 5/15 Test  #5: test-mul-mat0 ....................   Passed    1.00 sec
...
main:     load time =   242.30 ms
main:   sample time =    18.22 ms
main:  predict time =   818.90 ms / 12.80 ms per token
main:    total time =  1102.10 ms
...
main:     load time =   174.05 ms
main:   sample time =    17.95 ms
main:  predict time =   888.37 ms / 12.69 ms per token
main:    total time =  1083.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96c3a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96abb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab12bc4ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96c39f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96c3f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab12bc5830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96abb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab12bc4ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab12bc6140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab12bc5830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96c39f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab12bc6a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab12bc6140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab12bc7360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96c3a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab12bc6a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab12bc74d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab12bc7360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96c3f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab12bc7640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab12bc74d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11736.61 ms
main:    sample time =   637.96 ms / 9.97 ms per token
main:      eval time = 44075.71 ms / 629.65 ms per token
main:     total time = 58847.43 ms
...
main:      load time =  4367.62 ms
main:    sample time =   633.26 ms / 9.89 ms per token
main:      eval time = 17364.68 ms / 248.07 ms per token
main:     total time = 23327.41 ms
