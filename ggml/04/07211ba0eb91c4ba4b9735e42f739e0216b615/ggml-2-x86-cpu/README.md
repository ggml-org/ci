...
- status:  SUCCESS ✅
- runtime: 2:43.94
- date:    Wed Aug 30 11:51:04 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    2.53 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.32 sec
...
main:     load time =   189.64 ms
main:   sample time =    23.88 ms
main:  predict time =   447.52 ms / 6.99 ms per token
main:    total time =   674.41 ms
...
main:     load time =   135.13 ms
main:   sample time =    23.83 ms
main:  predict time =   449.85 ms / 6.43 ms per token
main:    total time =   611.55 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80208538a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80206d4150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557cf38e7ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8020852f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8020858800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557cf38e8830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80206d4150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557cf38e7ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557cf38e9140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x557cf38e8830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8020852f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557cf38e9a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x557cf38e9140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557cf38ea360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80208538a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x557cf38e9a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557cf38ea4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x557cf38ea360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8020858800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x557cf38ea640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x557cf38ea4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time = 11353.17 ms
main:    sample time =   471.91 ms / 7.37 ms per token
main:      eval time = 20608.97 ms / 294.41 ms per token
main:     total time = 33098.64 ms
...
main:      load time =  4390.97 ms
main:    sample time =   469.62 ms / 7.34 ms per token
main:      eval time =  8082.33 ms / 115.46 ms per token
main:     total time = 13332.79 ms
