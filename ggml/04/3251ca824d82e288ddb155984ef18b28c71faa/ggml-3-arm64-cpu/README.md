...
- status:  SUCCESS ✅
- runtime: 3:32.02
- date:    Wed Oct  4 09:07:58 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.83 sec
...
Total Test time (real) =  12.21 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    2.71 sec
      Start  2: test-opt
...
main:     load time =   185.53 ms
main:   sample time =    16.97 ms
main:  predict time =   809.82 ms / 12.65 ms per token
main:    total time =  1035.01 ms
...
main:     load time =   169.79 ms
main:   sample time =    17.20 ms
main:  predict time =   871.75 ms / 12.45 ms per token
main:    total time =  1062.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2c0a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa2a8b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8670ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2c09fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2c0f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae8671850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa2a8b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8670ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae8672170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae8671850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa2c09fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae8672a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae8672170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae86733b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa2c0a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae8672a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae8673530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae86733b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa2c0f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae86736b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae8673530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   213.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.27 ms
whisper_print_timings:   sample time =    23.42 ms /    27 runs (    0.87 ms per run)
whisper_print_timings:   encode time =  4592.66 ms /     1 runs ( 4592.66 ms per run)
whisper_print_timings:   decode time =   170.62 ms /    27 runs (    6.32 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5060.12 ms
```
### mpt
...
main:      load time =  5676.38 ms
main:    sample time =   531.47 ms / 8.30 ms per token
main:      eval time = 43714.73 ms / 624.50 ms per token
main:     total time = 52294.80 ms
...
main:      load time =  1495.81 ms
main:    sample time =   523.45 ms / 8.18 ms per token
main:      eval time = 17324.07 ms / 247.49 ms per token
main:     total time = 20300.14 ms
