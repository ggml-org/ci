...
- status:  SUCCESS ✅
- runtime: 2:42.82
- date:    Wed Oct  4 09:07:14 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.27 sec
...
main:     load time =   239.19 ms
main:   sample time =    23.62 ms
main:  predict time =   470.86 ms / 7.36 ms per token
main:    total time =   748.00 ms
...
main:     load time =   136.41 ms
main:   sample time =    23.57 ms
main:  predict time =   483.80 ms / 6.91 ms per token
main:    total time =   646.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fec6800b8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fec67e8c160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55641055cac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fec6800afb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fec68010840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55641055d850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fec67e8c160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55641055cac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55641055e170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55641055d850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fec6800afb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55641055ea90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55641055e170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55641055f3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fec6800b8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55641055ea90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55641055f530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55641055f3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fec68010840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55641055f6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55641055f530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   144.73 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.74 ms
whisper_print_timings:   sample time =    16.33 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  1192.57 ms /     1 runs ( 1192.57 ms per run)
whisper_print_timings:   decode time =   101.64 ms /    27 runs (    3.76 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1509.43 ms
```
### mpt
...
main:      load time =  5709.79 ms
main:    sample time =   471.88 ms / 7.37 ms per token
main:      eval time = 22069.62 ms / 315.28 ms per token
main:     total time = 28957.17 ms
...
main:      load time =  1286.79 ms
main:    sample time =   468.15 ms / 7.31 ms per token
main:      eval time =  8667.49 ms / 123.82 ms per token
main:     total time = 10808.84 ms
