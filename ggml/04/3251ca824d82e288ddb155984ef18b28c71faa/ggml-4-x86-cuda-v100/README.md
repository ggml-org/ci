...
- status:  SUCCESS ✅
- runtime: 5:31.94
- date:    Wed Oct  4 09:09:56 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/043251ca824d82e288ddb155984ef18b28c71faa
- author:  布客飞龙
```
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.03 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    3.72 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.64 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed   16.09 sec
      Start 10: test3
10/15 Test #10: test3 ............................   Passed    0.93 sec
      Start 11: test-pool
...
main:     load time =   266.10 ms
main:   sample time =    34.62 ms
main:  predict time =   560.79 ms / 8.76 ms per token
main:    total time =   882.62 ms
...
main:     load time =   194.66 ms
main:   sample time =    38.58 ms
main:  predict time =   583.47 ms / 8.34 ms per token
main:    total time =   821.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc7ae1148d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc7adf95160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55add0030ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc7ae113fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc7ae119840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55add0031850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc7adf95160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55add0030ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55add0032170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55add0031850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc7ae113fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55add0032a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55add0032170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55add00333b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc7ae1148d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55add0032a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55add0033530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55add00333b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc7ae119840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55add00336b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55add0033530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   705.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.15 ms
whisper_print_timings:   sample time =    20.22 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  1858.47 ms /     1 runs ( 1858.47 ms per run)
whisper_print_timings:   decode time =   144.38 ms /    27 runs (    5.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2804.84 ms
```
### mpt
...
main:      load time = 22049.77 ms
main:    sample time =   581.80 ms / 9.09 ms per token
main:      eval time = 24680.10 ms / 352.57 ms per token
main:     total time = 48224.16 ms
...
main:      load time = 16754.05 ms
main:    sample time =   575.81 ms / 9.00 ms per token
main:      eval time = 12239.82 ms / 174.85 ms per token
main:     total time = 30224.83 ms
