...
- status:  FAILURE ❌ (1)
- runtime: 1:41.29
- date:    Sun Jul 23 14:23:22 UTC 2023
...
main:  predict time =   811.03 ms / 12.67 ms per token
main:    total time =  1072.44 ms
...
main:  predict time =   881.80 ms / 12.60 ms per token
main:    total time =  1118.62 ms
