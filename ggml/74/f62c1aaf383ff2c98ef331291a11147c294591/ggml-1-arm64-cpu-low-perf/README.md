...
- status:  SUCCESS ✅
- runtime: 4:09.56
- date:    Sat May 11 13:46:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   34.71 sec
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.06 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.78 sec
      Start  2: test-quantize-fns
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.51 sec
      Start  9: test3
...
main:     load time =   158.27 ms
main:   sample time =    17.55 ms
main:  predict time =   910.59 ms / 14.23 ms per token
...
main:     load time =   158.33 ms
main:   sample time =    17.73 ms
main:  predict time =   991.84 ms / 14.17 ms per token
main:    total time =  1170.67 ms
...
main:     load time =   186.25 ms
main:   sample time =    17.54 ms
main:  predict time =  1017.91 ms / 14.54 ms per token
main:    total time =  1225.20 ms
...
main:     n_decoded =      504
main:     load time =   158.22 ms
main:   sample time =   128.90 ms
main:  predict time =  6653.29 ms
main:    total time =  7023.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0a4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa08cb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab001acce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0a4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0a4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab001adab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa08cb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab001acce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab001ae410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab001adab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa0a4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab001aed70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab001ae410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab001af6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa0a4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab001aed70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab001af890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab001af6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa0a4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab001afa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab001af890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =   726.27 ms /   131 runs (    5.54 ms per run)
whisper_print_timings:   encode time =  4712.60 ms /     1 runs ( 4712.60 ms per run)
whisper_print_timings:   decode time =    15.86 ms /     2 runs (    7.93 ms per run)
whisper_print_timings:   batchd time =   717.05 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  6303.37 ms
