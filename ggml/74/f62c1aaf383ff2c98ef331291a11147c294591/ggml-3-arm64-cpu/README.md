...
- status:  SUCCESS ✅
- runtime: 3:12.09
- date:    Sat May 11 13:45:32 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 3/22 Test  #3: test-quantize-perf ...............   Passed   10.47 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    3.03 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    2.18 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   17.46 sec
...
main:     load time =   152.29 ms
main:   sample time =    17.46 ms
main:  predict time =   893.37 ms / 13.96 ms per token
main:    total time =  1084.77 ms
...
main:  predict time =   973.57 ms / 13.91 ms per token
main:    total time =  1147.47 ms
...
main:  predict time =  1014.39 ms / 14.49 ms per token
main:    total time =  1216.32 ms
...
main:  predict time =  6427.75 ms
main:    total time =  6793.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb57da990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb565b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf1473ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb57da030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb57df940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf1474ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb565b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf1473ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf1475410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf1474ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb57da030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf1475d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf1475410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf14766d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb57da990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf1475d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf1476890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf14766d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb57df940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf1476a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf1476890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   106.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.47 ms
whisper_print_timings:   sample time =   746.56 ms /   131 runs (    5.70 ms per run)
whisper_print_timings:   encode time =  4680.18 ms /     1 runs ( 4680.18 ms per run)
...
whisper_print_timings:    total time =  6278.34 ms
...
main:     load time =    88.35 ms
main:    total time = 39891.97 ms
embd_img
