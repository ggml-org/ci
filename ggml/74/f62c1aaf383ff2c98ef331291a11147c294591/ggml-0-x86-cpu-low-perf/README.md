...
- status:  SUCCESS ✅
- runtime: 3:30.18
- date:    Sat May 11 13:46:01 UTC 2024
...
main:  predict time =   699.48 ms / 10.93 ms per token
main:    total time =   844.08 ms
...
main:  predict time =   744.38 ms / 10.63 ms per token
main:    total time =   878.71 ms
...
main:     load time =   127.86 ms
main:   sample time =    23.92 ms
main:  predict time =   748.16 ms / 10.69 ms per token
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faac0af0990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faac09711a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55de323ccce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faac0af0030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7faac0af5940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55de323cdab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faac09711a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55de323ccce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55de323ce410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55de323cdab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faac0af0030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55de323ced70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55de323ce410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55de323cf6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faac0af0990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55de323ced70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55de323cf890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55de323cf6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7faac0af5940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55de323cfa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55de323cf890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.08 ms
whisper_print_timings:   sample time =   648.30 ms /   131 runs (    4.95 ms per run)
whisper_print_timings:   encode time =  2052.28 ms /     1 runs ( 2052.28 ms per run)
whisper_print_timings:   decode time =    15.57 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   333.11 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  3151.03 ms
...
main:     load time =    72.96 ms
main:    total time = 19402.45 ms
embd_img
