...
Total Test time (real) =  41.84 sec
...
main:  predict time =   868.06 ms / 13.56 ms per token
...
main:     load time =   155.23 ms
main:   sample time =    19.02 ms
main:  predict time =   935.25 ms / 13.36 ms per token
main:    total time =  1111.82 ms
...
main:  predict time =   929.25 ms / 13.27 ms per token
main:    total time =  1136.32 ms
