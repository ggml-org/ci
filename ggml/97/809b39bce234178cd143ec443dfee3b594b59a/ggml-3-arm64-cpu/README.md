...
- status:  SUCCESS ✅
- runtime: 4:03.28
- date:    Sun Oct 15 09:39:45 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.58 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    2.01 sec
...
main:     load time =   154.62 ms
main:   sample time =    17.01 ms
main:  predict time =   799.00 ms / 12.48 ms per token
main:    total time =   993.97 ms
...
main:     load time =   139.87 ms
main:   sample time =    16.80 ms
main:  predict time =   867.81 ms / 12.40 ms per token
main:    total time =  1028.20 ms
...
main:     n_decoded =      504
main:     load time =   140.50 ms
main:   sample time =   126.83 ms
main:  predict time =  5867.60 ms
main:    total time =  6217.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa495a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa47db170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf198ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa4959fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa495f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf198f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa47db170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf198ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf19901a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf198f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa4959fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf1990ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf19901a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf1991400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa495a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf1990ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf1991590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf1991400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa495f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf1991720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf1991590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   217.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.94 ms
whisper_print_timings:   sample time =    20.86 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4602.03 ms /     1 runs ( 4602.03 ms per run)
whisper_print_timings:   decode time =   179.63 ms /    27 runs (    6.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5085.08 ms
```
### mpt
...
main:      load time = 12701.74 ms
main:    sample time =   517.30 ms / 8.08 ms per token
main:      eval time = 43588.72 ms / 622.70 ms per token
main:     total time = 59179.06 ms
...
main:      load time =  4376.32 ms
main:    sample time =   517.36 ms / 8.08 ms per token
main:      eval time = 17667.80 ms / 252.40 ms per token
main:     total time = 23524.50 ms
