...
- status:  SUCCESS ✅
- runtime: 1:45.82
- date:    Sun Oct 15 09:26:21 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.16 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.99 sec
      Start  2: test-quantize-fns
 2/14 Test  #2: test-quantize-fns ................   Passed    0.01 sec
      Start  3: test-quantize-perf
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    9.25 sec
      Start  9: test3
...
Total Test time (real) =  18.09 sec
...
main:  predict time =   816.20 ms / 12.75 ms per token
main:    total time =  1004.16 ms
...
main:     load time =   146.53 ms
main:   sample time =    17.32 ms
main:  predict time =  1005.98 ms / 14.37 ms per token
main:    total time =  1173.85 ms
...
main:   sample time =   127.32 ms
main:  predict time =  6018.38 ms
main:    total time =  6375.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffab68a900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffab50b170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8927ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffab689fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffab68f880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8928870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffab50b170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8927ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf89291a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8928870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffab689fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8929ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf89291a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf892a400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffab68a900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8929ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf892a590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf892a400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffab68f880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf892a720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf892a590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    20.81 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4717.20 ms /     1 runs ( 4717.20 ms per run)
whisper_print_timings:   decode time =   181.68 ms /    27 runs (    6.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5096.88 ms
```
