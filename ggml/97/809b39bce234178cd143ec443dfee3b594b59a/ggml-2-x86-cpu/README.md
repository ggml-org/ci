...
- status:  SUCCESS ✅
- runtime: 3:01.07
- date:    Sun Oct 15 21:30:10 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.86 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.76 sec
      Start  2: test-opt
...
main:  predict time =   507.46 ms / 7.93 ms per token
main:    total time =   692.40 ms
...
main:     load time =   114.63 ms
main:   sample time =    23.89 ms
main:  predict time =   493.82 ms / 7.05 ms per token
main:    total time =   634.99 ms
...
main:     n_decoded =      504
main:     load time =   110.08 ms
main:   sample time =   177.86 ms
main:  predict time =  1505.43 ms
main:    total time =  1827.57 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb7a699d900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb7a681e170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ead30f4ad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb7a699cfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb7a69a2880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ead30f5870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb7a681e170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ead30f4ad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ead30f61a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ead30f5870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb7a699cfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ead30f6ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ead30f61a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ead30f7400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb7a699d900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ead30f6ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ead30f7590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ead30f7400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb7a69a2880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55ead30f7720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ead30f7590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   145.98 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.00 ms
whisper_print_timings:   sample time =    16.54 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1159.24 ms /     1 runs ( 1159.24 ms per run)
whisper_print_timings:   decode time =   106.75 ms /    27 runs (    3.95 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1488.77 ms
```
### mpt
...
main:      load time = 11442.61 ms
main:    sample time =   464.16 ms / 7.25 ms per token
main:      eval time = 21865.98 ms / 312.37 ms per token
main:     total time = 34466.44 ms
...
main:      load time =  4386.32 ms
main:    sample time =   459.82 ms / 7.18 ms per token
main:      eval time =  8989.37 ms / 128.42 ms per token
main:     total time = 14221.64 ms
