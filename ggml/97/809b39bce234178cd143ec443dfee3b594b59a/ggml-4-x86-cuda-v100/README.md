...
- status:  SUCCESS ✅
- runtime: 5:02.09
- date:    Sun Oct 15 21:41:27 UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/97809b39bce234178cd143ec443dfee3b594b59a
- author:  PAB
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.30 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    6.57 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    3.04 sec
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    7.30 sec
      Start 10: test3
...
main:     load time =  1066.63 ms
main:   sample time =    34.93 ms
main:  predict time =   546.32 ms / 8.54 ms per token
main:    total time =  1668.22 ms
...
main:     load time =   160.21 ms
main:   sample time =    34.78 ms
main:  predict time =   578.93 ms / 8.27 ms per token
...
main:   sample time =   233.91 ms
main:  predict time =  2197.55 ms
main:    total time =  2637.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2628c0d900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2628a8e170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e3d906ead0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2628c0cfd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2628c12880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e3d906f870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2628a8e170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55e3d906ead0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e3d90701a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55e3d906f870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2628c0cfd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e3d9070ad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55e3d90701a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e3d9071400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2628c0d900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55e3d9070ad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e3d9071590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55e3d9071400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2628c12880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55e3d9071720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55e3d9071590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   386.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.75 ms
whisper_print_timings:   sample time =    20.26 ms /    27 runs (    0.75 ms per run)
whisper_print_timings:   encode time =  2122.81 ms /     1 runs ( 2122.81 ms per run)
whisper_print_timings:   decode time =   153.98 ms /    27 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2768.91 ms
```
### mpt
...
main:      load time =  7056.62 ms
main:    sample time =   582.30 ms / 9.10 ms per token
main:      eval time = 24999.80 ms / 357.14 ms per token
main:     total time = 33525.78 ms
...
main:      load time =  1719.58 ms
main:    sample time =   581.75 ms / 9.09 ms per token
main:      eval time = 12246.88 ms / 174.96 ms per token
main:     total time = 15182.72 ms
