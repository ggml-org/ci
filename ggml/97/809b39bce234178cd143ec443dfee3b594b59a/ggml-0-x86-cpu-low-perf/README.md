...
- status:  SUCCESS ✅
- runtime: 1:33.42
- date:    Sun Oct 15 21:26:03 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    6.10 sec
...
main:  predict time =   606.84 ms / 9.48 ms per token
main:    total time =   751.19 ms
...
main:  predict time =   630.57 ms / 9.01 ms per token
main:    total time =   763.22 ms
...
main:   sample time =   180.03 ms
main:  predict time =  2522.12 ms
main:    total time =  2855.41 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcd84194900                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcd84015170                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ab4cddaad0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcd84193fd0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcd84199880                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ab4cddb870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fcd84015170                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55ab4cddaad0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ab4cddc1a0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55ab4cddb870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fcd84193fd0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ab4cddcad0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55ab4cddc1a0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ab4cddd400                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fcd84194900                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55ab4cddcad0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ab4cddd590                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55ab4cddd400                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fcd84199880                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55ab4cddd720                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55ab4cddd590       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    84.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.22 ms
whisper_print_timings:   sample time =    16.54 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1961.79 ms /     1 runs ( 1961.79 ms per run)
whisper_print_timings:   decode time =   134.30 ms /    27 runs (    4.97 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2260.92 ms
```
