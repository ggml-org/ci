...
- status:  SUCCESS ✅
- runtime: 92.51
- date:    Mon Oct 16 00:25:23 EEST 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
 ...
 3/15 Test  #3: test-quantize-perf ...............   Passed    0.22 sec
...
13/16 Test #13: test-conv-transpose ..............   Passed    0.19 sec
...
main:  predict time =   299.16 ms / 4.67 ms per token
main:    total time =   458.91 ms
...
main:  predict time =   304.93 ms / 4.36 ms per token
main:    total time =   404.31 ms
...
main:   sample time =    65.80 ms
main:  predict time =   760.68 ms
main:    total time =   964.03 ms
...
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x13b00f760                            input
...
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x13b010500                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x140008160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x13b00f760                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13b010e30                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x13b010500                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x140186fc0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13b011760                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x13b010e30                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13b012090                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1401878f0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13b011760                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13b012220                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13b012090                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14018c870                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13b0123b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13b012220                           node_4
...
whisper_print_timings:     load time =   122.84 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.37 ms
whisper_print_timings:   sample time =    11.64 ms /    27 runs (    0.43 ms per run)
whisper_print_timings:   encode time =   678.86 ms /     1 runs (  678.86 ms per run)
whisper_print_timings:   decode time =    63.54 ms /    27 runs (    2.35 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   896.63 ms
```
