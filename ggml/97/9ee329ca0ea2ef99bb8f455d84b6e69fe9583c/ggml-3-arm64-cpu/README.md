...
- status:  SUCCESS ✅
- runtime: 7:37.59
- date:    Wed Jan 17 07:51:47 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  127.00 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 140.99 sec
...
21/21 Test #21: test-backend-ops .................   Passed   24.37 sec
...
main:     load time =   194.11 ms
main:   sample time =    17.04 ms
main:  predict time =   847.99 ms / 13.25 ms per token
main:    total time =  1081.43 ms
...
main:  predict time =   920.01 ms / 13.14 ms per token
main:    total time =  1124.90 ms
...
main:     n_decoded =      504
main:     load time =   147.95 ms
main:   sample time =   127.18 ms
main:  predict time =  5995.89 ms
main:    total time =  6352.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9919a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9901b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac9f1fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9919a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9919f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac9f20960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9901b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac9f1fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac9f212c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac9f20960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9919a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac9f21c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac9f212c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac9f22580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9919a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac9f21c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac9f22740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac9f22580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9919f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac9f22900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac9f22740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   176.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    65.57 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4621.82 ms /     1 runs ( 4621.82 ms per run)
whisper_print_timings:   decode time =    15.91 ms /     2 runs (    7.95 ms per run)
whisper_print_timings:   batchd time =   707.59 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5605.75 ms
...
main:     load time =    85.27 ms
main:    total time = 39694.16 ms
embd_img
...
main:      load time = 11483.17 ms
main:    sample time =   518.33 ms / 8.10 ms per token
main:      eval time = 43740.21 ms / 624.86 ms per token
main:     total time = 58116.75 ms
...
main:    sample time =   516.41 ms / 8.07 ms per token
main:      eval time = 17379.35 ms / 248.28 ms per token
main:     total time = 23201.75 ms
