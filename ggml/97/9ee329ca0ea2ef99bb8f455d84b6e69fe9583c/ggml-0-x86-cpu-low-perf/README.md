...
- status:  SUCCESS ✅
- runtime: 4:22.81
- date:    Wed Jan 17 19:48:25 UTC 2024
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   19.04 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  37.74 sec
...
main:     load time =   132.15 ms
main:   sample time =    23.56 ms
main:  predict time =   634.14 ms / 9.91 ms per token
main:    total time =   803.17 ms
...
main:  predict time =   658.08 ms / 9.40 ms per token
main:    total time =   814.01 ms
...
main:     n_decoded =      504
main:     load time =   106.71 ms
main:   sample time =   178.03 ms
main:  predict time =  2498.39 ms
main:    total time =  2827.92 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0150e55990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0150cd61a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b81f4dab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0150e55030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0150e5a940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b81f4db960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0150cd61a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b81f4dab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b81f4dc2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b81f4db960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0150e55030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b81f4dcc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b81f4dc2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b81f4dd580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0150e55990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b81f4dcc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b81f4dd740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b81f4dd580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0150e5a940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b81f4dd900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b81f4dd740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   sample time =    73.04 ms /   131 runs (    0.56 ms per run)
whisper_print_timings:   encode time =  1982.95 ms /     1 runs ( 1982.95 ms per run)
whisper_print_timings:   decode time =    13.60 ms /     2 runs (    6.80 ms per run)
whisper_print_timings:   batchd time =   323.67 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2495.42 ms
