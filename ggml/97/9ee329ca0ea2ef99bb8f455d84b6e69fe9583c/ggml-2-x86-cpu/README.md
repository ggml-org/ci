...
- status:  SUCCESS ✅
- runtime: 5:47.30
- date:    Wed Jan 17 19:49:41 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  115.34 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 126.22 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.23 sec
...
main:  predict time =   467.40 ms / 6.68 ms per token
main:    total time =   620.88 ms
...
main:  predict time =  1526.13 ms
main:    total time =  1844.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1ff3397990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1ff32181a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b57789b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1ff3397030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1ff339c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b5778a960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1ff32181a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558b57789b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b5778b2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558b5778a960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1ff3397030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b5778bc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558b5778b2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b5778c580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1ff3397990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558b5778bc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b5778c740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558b5778c580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1ff339c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558b5778c900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558b5778c740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.61 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.45 ms
whisper_print_timings:   sample time =    55.31 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1157.66 ms /     1 runs ( 1157.66 ms per run)
whisper_print_timings:   decode time =    10.25 ms /     2 runs (    5.12 ms per run)
whisper_print_timings:   batchd time =   208.93 ms /   125 runs (    1.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1574.14 ms
...
main:     load time =    59.92 ms
main:    total time = 10663.05 ms
embd_img
...
main:      load time =  9100.21 ms
main:    sample time =   467.69 ms / 7.31 ms per token
main:      eval time = 20839.24 ms / 297.70 ms per token
main:     total time = 31076.50 ms
...
main:      load time =  4371.32 ms
main:    sample time =   464.77 ms / 7.26 ms per token
main:      eval time =  8419.02 ms / 120.27 ms per token
main:     total time = 13611.30 ms
