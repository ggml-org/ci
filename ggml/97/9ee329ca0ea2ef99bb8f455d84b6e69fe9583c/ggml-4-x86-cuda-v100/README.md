...
- status:  SUCCESS ✅
- runtime: 12:04.88
- date:    Wed Jan 17 19:56:00 UTC 2024
...
14/20 Test #14: test-customop ....................   Passed    0.59 sec
      Start 15: test-xpos
...
20/20 Test #20: test-backend-ops .................   Passed  252.79 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 285.21 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.83 sec
      Start  2: test-opt
 ...
 9/21 Test  #9: test2 ............................   Passed    7.78 sec
      Start 10: test3
10/21 Test #10: test3 ............................   Passed    1.07 sec
      Start 11: test-pool
...
19/21 Test #19: test-mul-mat .....................   Passed    0.53 sec
      Start 20: test-backend-buffer
20/21 Test #20: test-backend-buffer ..............   Passed    0.54 sec
      Start 21: test-backend-ops
21/21 Test #21: test-backend-ops .................   Passed   46.85 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  78.28 sec
...
main:     load time =   585.98 ms
main:   sample time =    34.06 ms
main:  predict time =   574.08 ms / 8.97 ms per token
...
main:     load time =   575.63 ms
main:   sample time =    34.08 ms
main:  predict time =   631.51 ms / 9.02 ms per token
main:    total time =  1245.89 ms
...
main:     n_decoded =      504
main:     load time =   550.72 ms
main:   sample time =   242.01 ms
main:  predict time =  2324.80 ms
main:    total time =  3161.48 ms
...
main: loaded model in   390.35 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7f1a3b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7f1a2371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6d9b65ae0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7f1a3b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7f1a3bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a6d9b668b0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7f1a2371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a6d9b65ae0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a6d9b67210                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a6d9b668b0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7f1a3b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a6d9b67b70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a6d9b67210                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a6d9b684d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7f1a3b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a6d9b67b70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a6d9b68690                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a6d9b684d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7f1a3bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a6d9b68850                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a6d9b68690       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   511.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.11 ms
whisper_print_timings:   sample time =    66.47 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    22.48 ms /     1 runs (   22.48 ms per run)
whisper_print_timings:   decode time =    21.03 ms /     2 runs (   10.51 ms per run)
whisper_print_timings:   batchd time =    80.49 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   727.22 ms
...
main:     load time =   502.04 ms
main:    total time =  7970.06 ms
embd_img
...
main:      load time =  7329.68 ms
main:    sample time =   543.66 ms / 8.49 ms per token
main:      eval time = 25187.16 ms / 359.82 ms per token
main:     total time = 33957.68 ms
...
main:      load time =  2142.89 ms
main:    sample time =   545.00 ms / 8.52 ms per token
main:      eval time = 12586.26 ms / 179.80 ms per token
main:     total time = 15901.60 ms
