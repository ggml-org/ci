...
- status:  SUCCESS ✅
- runtime: 7:06.89
- date:    Thu Jan 11 07:42:41 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.90 sec
...
20/20 Test #20: test-backend-ops .................   Passed   42.86 sec
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed    9.64 sec
...
main:     load time =   187.33 ms
main:   sample time =    17.41 ms
main:  predict time =   838.77 ms / 13.11 ms per token
main:    total time =  1065.16 ms
...
main:  predict time =   905.59 ms / 12.94 ms per token
main:    total time =  1112.33 ms
...
main:  predict time =  6137.82 ms
main:    total time =  6505.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff81b2a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff819ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf085cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81b2a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff81b2f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf085d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff819ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf085cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf085e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf085d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff81b2a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf085ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf085e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf085f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff81b2a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf085ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf085f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf085f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff81b2f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf085f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf085f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4742.07 ms /     1 runs ( 4742.07 ms per run)
whisper_print_timings:   decode time =    15.63 ms /     2 runs (    7.82 ms per run)
whisper_print_timings:   batchd time =   709.67 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5660.54 ms
...
main:     load time =    95.26 ms
main:    total time = 40522.73 ms
embd_img
