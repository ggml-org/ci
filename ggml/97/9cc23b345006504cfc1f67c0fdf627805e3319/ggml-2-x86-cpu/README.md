...
- status:  SUCCESS ✅
- runtime: 6:49.01
- date:    Thu Jan 11 07:46:10 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    4.65 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    3.90 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   26.91 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  46.30 sec
...
21/21 Test #21: test-backend-ops .................   Passed    8.82 sec
...
main:     load time =   185.87 ms
main:   sample time =    23.52 ms
main:  predict time =   453.99 ms / 7.09 ms per token
main:    total time =   676.06 ms
...
main:  predict time =   473.29 ms / 6.76 ms per token
main:    total time =   624.47 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1f3c480990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1f3c3011a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562f20a16b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1f3c480030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1f3c485940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562f20a17960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1f3c3011a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562f20a16b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562f20a182c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562f20a17960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1f3c480030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562f20a18c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562f20a182c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562f20a19580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1f3c480990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562f20a18c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562f20a19740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562f20a19580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1f3c485940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562f20a19900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562f20a19740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  1155.95 ms /     1 runs ( 1155.95 ms per run)
whisper_print_timings:   decode time =     9.78 ms /     2 runs (    4.89 ms per run)
whisper_print_timings:   batchd time =   206.36 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1572.35 ms
...
main:     load time =    60.49 ms
main:    total time = 10644.80 ms
embd_img
...
main:      load time =  5811.00 ms
main:    sample time =   466.66 ms / 7.29 ms per token
main:      eval time = 20615.43 ms / 294.51 ms per token
main:     total time = 27566.63 ms
...
main:      load time =  1356.07 ms
main:    sample time =   505.39 ms / 7.90 ms per token
main:      eval time =  9546.77 ms / 136.38 ms per token
main:     total time = 11770.95 ms
