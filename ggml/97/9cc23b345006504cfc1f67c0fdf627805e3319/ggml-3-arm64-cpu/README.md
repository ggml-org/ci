...
- status:  SUCCESS ✅
- runtime: 20:48.18
- date:    Thu Jan 11 08:28:49 AM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/979cc23b345006504cfc1f67c0fdf627805e3319
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/20 Test  #5: test-mul-mat2 ....................   Passed    8.54 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.21 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   10.09 sec
...
main:  predict time =   825.31 ms / 12.90 ms per token
main:    total time =  1043.58 ms
...
main:     load time =   181.14 ms
main:   sample time =    17.00 ms
main:  predict time =   894.12 ms / 12.77 ms per token
main:    total time =  1095.25 ms
...
main:  predict time =  5993.24 ms
main:    total time =  6353.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d0ea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9cf6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad1803b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d0ea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d0ef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad1804960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9cf6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad1803b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad18052c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad1804960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9d0ea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad1805c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad18052c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad1806580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9d0ea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad1805c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad1806740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad1806580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9d0ef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad1806900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad1806740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   191.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    65.52 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4638.30 ms /     1 runs ( 4638.30 ms per run)
whisper_print_timings:   decode time =    15.17 ms /     2 runs (    7.59 ms per run)
whisper_print_timings:   batchd time =   706.91 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5635.91 ms
...
main:      load time =  5966.68 ms
main:    sample time =   518.25 ms / 8.10 ms per token
main:      eval time = 43733.54 ms / 624.76 ms per token
main:     total time = 52594.95 ms
...
main:      load time =  1595.23 ms
main:    sample time =   516.81 ms / 8.08 ms per token
main:      eval time = 17422.56 ms / 248.89 ms per token
main:     total time = 20491.52 ms
