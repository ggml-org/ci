...
- status:  SUCCESS ✅
- runtime: 12:17.79
- date:    Thu Jan 11 08:20:44 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   60.89 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  93.18 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.80 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.86 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   23.42 sec
...
main:     load time =   654.33 ms
main:   sample time =    34.29 ms
main:  predict time =   577.47 ms / 9.02 ms per token
main:    total time =  1286.34 ms
...
main:     load time =   578.97 ms
main:   sample time =    34.52 ms
main:  predict time =   609.06 ms / 8.70 ms per token
main:    total time =  1226.62 ms
...
main:     n_decoded =      504
main:     load time =   544.61 ms
main:   sample time =   235.05 ms
main:  predict time =  2369.66 ms
main:    total time =  3194.07 ms
...
main: loaded model in   411.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdd63a59990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdd638da1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f8d66ae580                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdd63a59030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdd63a5e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f8d66af350                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdd638da1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f8d66ae580                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f8d66afcb0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f8d66af350                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdd63a59030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f8d66b0610                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f8d66afcb0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f8d66b0f70                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdd63a59990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f8d66b0610                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f8d66b1130                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f8d66b0f70                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdd63a5e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f8d66b12f0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f8d66b1130       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   503.64 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.74 ms
whisper_print_timings:   sample time =    67.29 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    32.05 ms /     1 runs (   32.05 ms per run)
whisper_print_timings:   decode time =    13.56 ms /     2 runs (    6.78 ms per run)
whisper_print_timings:   batchd time =    80.83 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   723.46 ms
...
main:     load time =   487.99 ms
main:    total time =  7864.06 ms
embd_img
...
main:      load time = 11808.74 ms
main:    sample time =   546.40 ms / 8.54 ms per token
main:      eval time = 26256.35 ms / 375.09 ms per token
main:     total time = 39737.38 ms
...
main:      load time =  5048.50 ms
main:    sample time =   541.75 ms / 8.46 ms per token
main:      eval time = 12528.13 ms / 178.97 ms per token
main:     total time = 18780.55 ms
