...
- status:  SUCCESS ✅
- runtime: 2:19.41
- date:    Tue Aug 22 09:38:33 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/15 Test  #1: test-grad0 .......................   Passed    2.56 sec
      Start  2: test-opt
 2/15 Test  #2: test-opt .........................   Passed    1.29 sec
...
main:  predict time =   423.18 ms / 6.61 ms per token
...
main:  predict time =   435.03 ms / 6.21 ms per token
main:    total time =   608.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80ebbba8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80eba3b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a1e7dd3ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f80ebbb9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f80ebbbf800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a1e7dd4830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f80eba3b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a1e7dd3ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a1e7dd5140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55a1e7dd4830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f80ebbb9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a1e7dd5a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55a1e7dd5140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a1e7dd6360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f80ebbba8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55a1e7dd5a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a1e7dd64d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55a1e7dd6360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f80ebbbf800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55a1e7dd6640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55a1e7dd64d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4377.75 ms
main:    sample time =   459.51 ms / 7.18 ms per token
main:      eval time = 19209.95 ms / 274.43 ms per token
main:     total time = 24683.32 ms
...
main:      load time =  1252.21 ms
main:    sample time =   459.08 ms / 7.17 ms per token
main:      eval time =  7929.65 ms / 113.28 ms per token
main:     total time = 10014.40 ms
