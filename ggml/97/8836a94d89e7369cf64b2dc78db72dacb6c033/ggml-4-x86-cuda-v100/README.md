...
- status:  SUCCESS ✅
- runtime: 4:39.27
- date:    Tue Aug 22 09:43:15 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed   16.06 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.29 sec
      Start  2: test-opt
...
main:  predict time =   540.17 ms / 8.44 ms per token
main:    total time =   823.80 ms
...
main: mem per token =  2017572 bytes
main:     load time =   188.59 ms
main:   sample time =    38.29 ms
main:  predict time =   594.88 ms / 8.50 ms per token
main:    total time =   858.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4539ed38a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4539d54150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5597cd665ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4539ed2f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4539ed8800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5597cd666830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f4539d54150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5597cd665ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5597cd667140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x5597cd666830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f4539ed2f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5597cd667a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x5597cd667140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5597cd668360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f4539ed38a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x5597cd667a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5597cd6684d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x5597cd668360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f4539ed8800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x5597cd668640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5597cd6684d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6375.78 ms
main:    sample time =   577.67 ms / 9.03 ms per token
main:      eval time = 23476.30 ms / 335.38 ms per token
main:     total time = 31296.46 ms
...
main:      load time =  1737.10 ms
main:    sample time =   583.53 ms / 9.12 ms per token
main:      eval time = 11938.14 ms / 170.54 ms per token
main:     total time = 14903.53 ms
