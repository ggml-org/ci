...
- status:  SUCCESS ✅
- runtime: 3:20.53
- date:    Tue Aug 22 09:40:33 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.46 sec
      Start  2: test-opt
...
main:     load time =   174.96 ms
main:   sample time =    17.47 ms
main:  predict time =   802.34 ms / 12.54 ms per token
main:    total time =  1063.14 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa714a8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6fcb150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff388ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7149f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa714f800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaff389830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6fcb150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaff388ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaff38a140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaff389830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa7149f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaff38aa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaff38a140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaff38b360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa714a8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaff38aa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaff38b4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaff38b360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa714f800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaff38b640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaff38b4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5506.81 ms
main:    sample time =   609.84 ms / 9.53 ms per token
main:      eval time = 44228.79 ms / 631.84 ms per token
main:     total time = 52734.47 ms
...
main:      load time =  1735.36 ms
main:    sample time =   616.69 ms / 9.64 ms per token
main:      eval time = 17395.32 ms / 248.50 ms per token
main:     total time = 20718.44 ms
