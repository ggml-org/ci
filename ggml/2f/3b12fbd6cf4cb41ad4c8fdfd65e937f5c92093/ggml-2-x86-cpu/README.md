...
- status:  SUCCESS ✅
- runtime: 4:40.61
- date:    Wed Jan 10 14:29:09 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    5.10 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    0.16 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   27.90 sec
...
21/21 Test #21: test-backend-ops .................   Passed    9.06 sec
...
main:  predict time =   449.84 ms / 7.03 ms per token
main:    total time =   677.58 ms
...
main:  predict time =   463.00 ms / 6.61 ms per token
main:    total time =   611.53 ms
...
main:  predict time =  1507.81 ms
main:    total time =  1829.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f71a0bd9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f71a0a5a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cd7e326b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f71a0bd9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f71a0bde940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cd7e327960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f71a0a5a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cd7e326b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cd7e3282c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cd7e327960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f71a0bd9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cd7e328c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cd7e3282c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cd7e329580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f71a0bd9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cd7e328c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cd7e329740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cd7e329580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f71a0bde940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55cd7e329900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cd7e329740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   119.48 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.79 ms
whisper_print_timings:   sample time =    55.74 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1166.83 ms /     1 runs ( 1166.83 ms per run)
whisper_print_timings:   decode time =     9.91 ms /     2 runs (    4.96 ms per run)
whisper_print_timings:   batchd time =   210.32 ms /   125 runs (    1.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1581.17 ms
...
main:     load time =    58.89 ms
main:    total time = 10627.15 ms
embd_img
...
main:      load time = 11264.29 ms
main:    sample time =   469.59 ms / 7.34 ms per token
main:      eval time = 20410.54 ms / 291.58 ms per token
main:     total time = 32816.11 ms
...
main:      load time =  4372.17 ms
main:    sample time =   464.12 ms / 7.25 ms per token
main:      eval time =  8171.73 ms / 116.74 ms per token
main:     total time = 13382.46 ms
