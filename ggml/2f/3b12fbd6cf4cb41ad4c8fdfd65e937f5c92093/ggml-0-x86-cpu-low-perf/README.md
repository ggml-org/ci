...
- status:  SUCCESS ✅
- runtime: 4:19.26
- date:    Wed Jan 10 14:23:50 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.20 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    9.50 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed   34.83 sec
...
main:     load time =   127.00 ms
main:   sample time =    23.63 ms
main:  predict time =   626.16 ms / 9.78 ms per token
main:    total time =   789.52 ms
...
main:  predict time =   656.28 ms / 9.38 ms per token
main:    total time =   807.27 ms
...
main:     n_decoded =      504
main:     load time =   105.06 ms
main:   sample time =   178.00 ms
main:  predict time =  2501.42 ms
main:    total time =  2830.02 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fab36c80990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fab36b011a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aa3fdbab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fab36c80030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fab36c85940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55aa3fdbb960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fab36b011a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55aa3fdbab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55aa3fdbc2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55aa3fdbb960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fab36c80030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55aa3fdbcc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55aa3fdbc2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55aa3fdbd580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fab36c80990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55aa3fdbcc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55aa3fdbd740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55aa3fdbd580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fab36c85940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55aa3fdbd900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55aa3fdbd740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    22.11 ms
whisper_print_timings:   sample time =    71.19 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1997.16 ms /     1 runs ( 1997.16 ms per run)
whisper_print_timings:   decode time =    12.20 ms /     2 runs (    6.10 ms per run)
whisper_print_timings:   batchd time =   321.62 ms /   125 runs (    2.57 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2504.37 ms
