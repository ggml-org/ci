...
- status:  SUCCESS ✅
- runtime: 5:52.17
- date:    Wed Jan 10 02:32:45 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    0.09 sec
      Start  9: test3
...
Total Test time (real) =  18.95 sec
...
main:     load time =   200.68 ms
main:   sample time =    17.05 ms
main:  predict time =   822.10 ms / 12.85 ms per token
main:    total time =  1061.83 ms
...
main:     load time =   176.22 ms
main:   sample time =    16.81 ms
main:  predict time =   893.92 ms / 12.77 ms per token
...
main:  predict time =  5991.94 ms
main:    total time =  6348.05 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff931ba990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9303b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0f605b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff931ba030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff931bf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0f606960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9303b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab0f605b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0f6072c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab0f606960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff931ba030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0f607c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab0f6072c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0f608580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff931ba990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab0f607c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0f608740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab0f608580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff931bf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab0f608900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab0f608740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   192.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.32 ms
whisper_print_timings:   sample time =    65.55 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4635.72 ms /     1 runs ( 4635.72 ms per run)
whisper_print_timings:   decode time =    15.28 ms /     2 runs (    7.64 ms per run)
whisper_print_timings:   batchd time =   705.98 ms /   125 runs (    5.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5632.94 ms
...
main:     load time =    81.76 ms
main:    total time = 39734.98 ms
embd_img
...
main:      load time = 12967.96 ms
main:    sample time =   524.02 ms / 8.19 ms per token
main:      eval time = 43686.20 ms / 624.09 ms per token
main:     total time = 59550.98 ms
...
main:      load time =  4356.20 ms
main:    sample time =   512.39 ms / 8.01 ms per token
main:      eval time = 17836.57 ms / 254.81 ms per token
main:     total time = 23661.59 ms
