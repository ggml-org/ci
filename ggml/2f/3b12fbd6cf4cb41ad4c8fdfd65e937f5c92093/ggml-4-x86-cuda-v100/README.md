...
- status:  SUCCESS ✅
- runtime: 8:37.65
- date:    Wed Jan 10 14:31:33 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.53 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed    7.80 sec
      Start  9: test3
...
16/20 Test #16: test-conv1d ......................   Passed    0.78 sec
...
Total Test time (real) =  93.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/21 Test  #8: test1 ............................   Passed    0.55 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.73 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   25.92 sec
...
main:     load time =   666.61 ms
main:   sample time =    34.19 ms
main:  predict time =   578.58 ms / 9.04 ms per token
main:    total time =  1303.94 ms
...
main:     load time =   596.73 ms
main:   sample time =    34.50 ms
main:  predict time =   594.04 ms / 8.49 ms per token
main:    total time =  1229.57 ms
...
main:     n_decoded =      504
main:     load time =   552.95 ms
main:   sample time =   237.92 ms
main:  predict time =  2358.85 ms
main:    total time =  3199.44 ms
...
main: loaded model in   416.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c23bb6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c23a371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5610e0b69600                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c23bb6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c23bbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5610e0b6a3d0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c23a371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5610e0b69600                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5610e0b6ad30                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5610e0b6a3d0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c23bb6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5610e0b6b690                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5610e0b6ad30                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5610e0b6bff0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c23bb6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5610e0b6b690                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5610e0b6c1b0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5610e0b6bff0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c23bbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5610e0b6c370                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5610e0b6c1b0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   584.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.79 ms
whisper_print_timings:   sample time =    66.72 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.01 ms /     1 runs (   34.01 ms per run)
whisper_print_timings:   decode time =    13.28 ms /     2 runs (    6.64 ms per run)
whisper_print_timings:   batchd time =    88.89 ms /   125 runs (    0.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   814.41 ms
...
main:     load time =   516.29 ms
main:    total time =  7884.67 ms
embd_img
...
main:      load time = 19053.26 ms
main:    sample time =   546.74 ms / 8.54 ms per token
main:      eval time = 25999.38 ms / 371.42 ms per token
main:     total time = 46459.46 ms
...
main:      load time =  8851.47 ms
main:    sample time =   546.45 ms / 8.54 ms per token
main:      eval time = 12932.92 ms / 184.76 ms per token
main:     total time = 23043.96 ms
