...
- status:  SUCCESS ✅
- runtime: 3:20.98
- date:    Tue Aug 22 09:36:52 UTC 2023
...
main:  predict time =   803.15 ms / 12.55 ms per token
main:    total time =  1064.19 ms
...
main: mem per token =  2017572 bytes
main:     load time =   169.34 ms
main:   sample time =    17.25 ms
main:  predict time =   870.15 ms / 12.43 ms per token
main:    total time =  1105.87 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96eaa8a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96d2b150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf331dab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96ea9f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96eaf800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf331e830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff96d2b150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf331dab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf331f140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf331e830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff96ea9f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf331fa50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf331f140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf3320360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff96eaa8a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf331fa50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf33204d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf3320360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff96eaf800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf3320640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf33204d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  5479.32 ms
main:    sample time =   608.28 ms / 9.50 ms per token
main:      eval time = 44143.41 ms / 630.62 ms per token
main:     total time = 52617.96 ms
...
main:      load time =  1728.69 ms
main:    sample time =   617.42 ms / 9.65 ms per token
main:      eval time = 17376.35 ms / 248.23 ms per token
main:     total time = 20693.48 ms
