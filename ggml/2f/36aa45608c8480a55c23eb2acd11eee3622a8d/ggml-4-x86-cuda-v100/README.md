...
- status:  SUCCESS ✅
- runtime: 4:40.50
- date:    Tue Aug 22 09:38:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.39 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.39 sec
      Start  2: test-opt
 ...
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed   16.03 sec
      Start 10: test3
...
main:     load time =   190.46 ms
main:   sample time =    34.52 ms
main:  predict time =   519.34 ms / 8.11 ms per token
main:    total time =   793.47 ms
...
main: mem per token =  2017572 bytes
main:     load time =   192.16 ms
main:   sample time =    34.18 ms
main:  predict time =   535.34 ms / 7.65 ms per token
main:    total time =   795.80 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa491a008a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa491881150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559165340ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa4919fff90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa491a05800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559165341830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fa491881150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559165340ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559165342140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559165341830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fa4919fff90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559165342a50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559165342140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559165343360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fa491a008a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559165342a50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5591653434d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559165343360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fa491a05800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559165343640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x5591653434d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  6484.97 ms
main:    sample time =   581.61 ms / 9.09 ms per token
main:      eval time = 23548.29 ms / 336.40 ms per token
main:     total time = 31464.89 ms
...
main:      load time =  1738.76 ms
main:    sample time =   584.00 ms / 9.13 ms per token
main:      eval time = 12151.37 ms / 173.59 ms per token
main:     total time = 15167.52 ms
