...
- status:  SUCCESS ✅
- runtime: 2:19.33
- date:    Tue Aug 22 09:35:54 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    2.64 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 5/15 Test  #5: test-mul-mat0 ....................   Passed    0.99 sec
...
main:     load time =   126.63 ms
main:   sample time =    23.55 ms
main:  predict time =   431.44 ms / 6.74 ms per token
main:    total time =   617.20 ms
...
main:  predict time =   443.68 ms / 6.34 ms per token
main:    total time =   619.74 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f832bd068a0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f832bb87150                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b416339ab0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f832bd05f90                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f832bd0b800                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b41633a830                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f832bb87150                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b416339ab0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b41633b140                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b41633a830                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f832bd05f90                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b41633ba50                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b41633b140                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b41633c360                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f832bd068a0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b41633ba50                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b41633c4d0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b41633c360                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f832bd0b800                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b41633c640                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b41633c4d0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
main:      load time =  4439.26 ms
main:    sample time =   460.91 ms / 7.20 ms per token
main:      eval time = 19072.87 ms / 272.47 ms per token
main:     total time = 24618.60 ms
...
main:      load time =  1217.04 ms
main:    sample time =   459.58 ms / 7.18 ms per token
main:      eval time =  7972.96 ms / 113.90 ms per token
main:     total time = 10021.83 ms
