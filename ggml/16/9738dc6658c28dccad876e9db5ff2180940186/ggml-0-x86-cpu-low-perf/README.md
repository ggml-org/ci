...
- status:  SUCCESS ✅
- runtime: 3:24.32
- date:    Sun Jun 16 15:39:54 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/169738dc6658c28dccad876e9db5ff2180940186
- author:  slaren
```
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.11 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.74 sec
      Start 10: test-pool
...
Total Test time (real) =  74.19 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/21 Test  #8: test2 ............................   Passed   24.31 sec
      Start  9: test3
...
main:     load time =   100.00 ms
main:   sample time =    23.72 ms
main:  predict time =   632.93 ms / 9.89 ms per token
main:    total time =   769.19 ms
...
main:  predict time =   674.52 ms / 9.64 ms per token
main:    total time =   800.88 ms
...
main:     load time =   119.63 ms
main:   sample time =    23.87 ms
main:  predict time =   675.59 ms / 9.65 ms per token
main:    total time =   822.09 ms
...
main:  predict time =  2566.18 ms
main:    total time =  2888.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x79886b6fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x79886b57b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5b9589416ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x79886b6fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x79886b6ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5b9589417ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x79886b57b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5b9589416ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5b9589418410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5b9589417ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x79886b6fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5b9589418d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5b9589418410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5b95894196d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x79886b6fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5b9589418d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5b9589419890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5b95894196d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x79886b6ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5b9589419a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5b9589419890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    70.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.03 ms
whisper_print_timings:   sample time =    71.17 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1993.98 ms /     1 runs ( 1993.98 ms per run)
whisper_print_timings:   decode time =    13.53 ms /     2 runs (    6.76 ms per run)
whisper_print_timings:   batchd time =   326.53 ms /   125 runs (    2.61 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2511.80 ms
...
main:     load time =    67.49 ms
main:    total time = 18354.22 ms
embd_img
