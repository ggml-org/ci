...
- status:  SUCCESS ✅
- runtime: 3:11.65
- date:    Sun Jun 16 15:39:16 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.44 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   36.19 sec
...
main:  predict time =   876.27 ms / 13.69 ms per token
main:    total time =  1069.98 ms
...
main:  predict time =   958.49 ms / 13.69 ms per token
main:    total time =  1133.41 ms
...
main:  predict time =   959.86 ms / 13.71 ms per token
main:    total time =  1166.87 ms
...
main:  predict time =  6084.86 ms
main:    total time =  6451.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfd5b32e4a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfd5b32ccb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc588e5876ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfd5b32e4a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfd5b32e4f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc588e5877ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfd5b32ccb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc588e5876ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc588e5878410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc588e5877ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfd5b32e4a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc588e5878d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc588e5878410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc588e58796d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfd5b32e4a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc588e5878d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc588e5879890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc588e58796d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfd5b32e4f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc588e5879a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc588e5879890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.94 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.01 ms
whisper_print_timings:   sample time =    67.66 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4687.71 ms /     1 runs ( 4687.71 ms per run)
whisper_print_timings:   decode time =    14.89 ms /     2 runs (    7.45 ms per run)
whisper_print_timings:   batchd time =   729.14 ms /   125 runs (    5.83 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5640.66 ms
...
main:     load time =    90.23 ms
main:    total time = 39929.16 ms
embd_img
