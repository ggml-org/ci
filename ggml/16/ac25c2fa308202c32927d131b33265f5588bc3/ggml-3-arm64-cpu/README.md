...
- status:  FAILURE ❌ (1)
- runtime: 5:00.90
- date:    Sat Feb 10 01:18:40 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/16ac25c2fa308202c32927d131b33265f5588bc3
- author:  slaren
```
fix ci
...
20/20 Test #20: test-backend-ops .................   Passed  150.05 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.83 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   22.58 sec
...
main:     load time =   149.21 ms
main:   sample time =    16.91 ms
main:  predict time =   829.06 ms / 12.95 ms per token
main:    total time =  1016.66 ms
...
main:  predict time =   903.52 ms / 12.91 ms per token
main:    total time =  1071.74 ms
...
main:     load time =   177.44 ms
main:   sample time =    16.84 ms
main:  predict time =   925.26 ms / 13.22 ms per token
main:    total time =  1122.68 ms
...
main:     n_decoded =      504
main:     load time =   150.09 ms
main:   sample time =   127.13 ms
main:  predict time =  5946.05 ms
main:    total time =  6305.12 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbeb0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbe98b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacfefdb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbeb0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbeb0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacfefe960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbe98b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaacfefdb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacfeff2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaacfefe960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbeb0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacfeffc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaacfeff2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacff00580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbeb0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaacfeffc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacff00740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaacff00580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbeb0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaacff00900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaacff00740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.11 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.51 ms
whisper_print_timings:   sample time =    65.86 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4620.27 ms /     1 runs ( 4620.27 ms per run)
whisper_print_timings:   decode time =    15.61 ms /     2 runs (    7.80 ms per run)
whisper_print_timings:   batchd time =   711.94 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5536.63 ms
...
main:     load time =    86.77 ms
main:    total time = 39612.04 ms
embd_img
