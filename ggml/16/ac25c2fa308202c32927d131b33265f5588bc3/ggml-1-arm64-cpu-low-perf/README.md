...
- status:  SUCCESS ✅
- runtime: 6:05.91
- date:    Sat Feb 10 01:19:43 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  156.60 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 194.00 sec
...
main:     load time =   158.18 ms
main:   sample time =    17.41 ms
main:  predict time =   849.30 ms / 13.27 ms per token
main:    total time =  1046.66 ms
...
main:     load time =   161.97 ms
main:   sample time =    17.31 ms
main:  predict time =  1047.94 ms / 14.97 ms per token
main:    total time =  1230.08 ms
...
main:     load time =   191.02 ms
main:   sample time =    17.35 ms
main:  predict time =   941.43 ms / 13.45 ms per token
main:    total time =  1153.06 ms
...
main:  predict time =  6093.03 ms
main:    total time =  6466.76 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff830ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82f4b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf368bb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff830ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff830cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf368c960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff82f4b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf368bb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf368d2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf368c960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff830ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf368dc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf368d2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf368e580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff830ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf368dc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf368e740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf368e580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff830cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf368e900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf368e740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4728.30 ms /     1 runs ( 4728.30 ms per run)
whisper_print_timings:   decode time =    15.73 ms /     2 runs (    7.86 ms per run)
whisper_print_timings:   batchd time =   713.18 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5651.27 ms
...
main:     load time =    91.64 ms
main:    total time = 40257.12 ms
embd_img
