...
- status:  SUCCESS ✅
- runtime: 5:26.95
- date:    Mon Dec 25 09:31:02 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.17 sec
...
20/20 Test #20: test-backend-ops .................   Passed    8.84 sec
...
main:     load time =   264.15 ms
main:   sample time =    23.43 ms
main:  predict time =   435.83 ms / 6.81 ms per token
main:    total time =   736.09 ms
...
main:     load time =   125.16 ms
main:   sample time =    23.48 ms
main:  predict time =   456.78 ms / 6.53 ms per token
main:    total time =   607.47 ms
...
main:     n_decoded =      504
main:     load time =   103.18 ms
main:   sample time =   177.60 ms
main:  predict time =  1457.32 ms
main:    total time =  1774.60 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91c8510990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91c83911a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5560be9a2b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91c8510030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91c8515940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5560be9a3960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91c83911a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5560be9a2b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5560be9a42c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5560be9a3960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91c8510030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5560be9a4c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5560be9a42c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5560be9a5580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91c8510990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5560be9a4c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5560be9a5740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5560be9a5580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91c8515940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5560be9a5900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5560be9a5740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   137.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.69 ms
whisper_print_timings:   sample time =    54.89 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1151.49 ms /     1 runs ( 1151.49 ms per run)
whisper_print_timings:   decode time =     9.75 ms /     2 runs (    4.88 ms per run)
whisper_print_timings:   batchd time =   207.31 ms /   125 runs (    1.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1579.33 ms
...
main:     load time =    63.35 ms
main:    total time = 10561.84 ms
embd_img
...
main:      load time = 15906.54 ms
main:    sample time =   465.83 ms / 7.28 ms per token
main:      eval time = 20159.02 ms / 287.99 ms per token
main:     total time = 37203.40 ms
...
main:      load time =  4374.54 ms
main:    sample time =   463.51 ms / 7.24 ms per token
main:      eval time =  8023.85 ms / 114.63 ms per token
main:     total time = 13235.00 ms
