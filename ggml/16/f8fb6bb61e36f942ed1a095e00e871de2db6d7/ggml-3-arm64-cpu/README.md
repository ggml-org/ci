...
- status:  SUCCESS ✅
- runtime: 7:16.00
- date:    Mon Dec 25 09:32:49 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.32 sec
...
main:     load time =   199.69 ms
main:   sample time =    17.19 ms
main:  predict time =   809.78 ms / 12.65 ms per token
main:    total time =  1048.74 ms
...
main:     load time =   188.92 ms
main:   sample time =    16.87 ms
main:  predict time =   880.88 ms / 12.58 ms per token
main:    total time =  1089.62 ms
...
main:   sample time =   128.59 ms
main:  predict time =  5890.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffad59a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffad41b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab19dffb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffad59a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffad59f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab19e00960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffad41b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab19dffb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab19e012c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaab19e00960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffad59a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab19e01c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaab19e012c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab19e02580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffad59a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaab19e01c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab19e02740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaab19e02580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffad59f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaab19e02900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaab19e02740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   147.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.94 ms
whisper_print_timings:   sample time =    65.41 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4657.66 ms /     1 runs ( 4657.66 ms per run)
whisper_print_timings:   decode time =    15.20 ms /     2 runs (    7.60 ms per run)
whisper_print_timings:   batchd time =   711.17 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5614.53 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.239000 sec.)
...
main:      load time = 13073.87 ms
main:    sample time =   519.92 ms / 8.12 ms per token
main:      eval time = 43566.75 ms / 622.38 ms per token
main:     total time = 59533.78 ms
...
main:      load time =  4357.24 ms
main:    sample time =   513.30 ms / 8.02 ms per token
main:      eval time = 17650.43 ms / 252.15 ms per token
main:     total time = 23513.55 ms
