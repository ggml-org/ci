...
- status:  SUCCESS ✅
- runtime: 8:40.15
- date:    Mon Dec 25 09:34:10 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    6.68 sec
...
19/19 Test #19: test-backend-ops .................   Passed   61.15 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.55 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    8.19 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   23.57 sec
...
main:     load time =   578.80 ms
main:   sample time =    34.42 ms
main:  predict time =   563.97 ms / 8.81 ms per token
main:    total time =  1197.08 ms
...
main:     load time =   560.38 ms
main:   sample time =    35.07 ms
main:  predict time =   579.83 ms / 8.28 ms per token
main:    total time =  1179.46 ms
...
main:     n_decoded =      504
main:     load time =   548.22 ms
main:   sample time =   244.96 ms
main:  predict time =  2279.24 ms
main:    total time =  3117.78 ms
...
main: loaded model in   389.25 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0fd3258990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0fd30d91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c8ef3a3dd0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0fd3258030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0fd325d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c8ef3a4ba0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f0fd30d91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c8ef3a3dd0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c8ef3a5500                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55c8ef3a4ba0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f0fd3258030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c8ef3a5e60                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55c8ef3a5500                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c8ef3a67c0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f0fd3258990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55c8ef3a5e60                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c8ef3a6980                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55c8ef3a67c0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f0fd325d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55c8ef3a6b40                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55c8ef3a6980       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   519.78 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.84 ms
whisper_print_timings:   sample time =    66.25 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    33.81 ms /     1 runs (   33.81 ms per run)
whisper_print_timings:   decode time =    14.34 ms /     2 runs (    7.17 ms per run)
whisper_print_timings:   batchd time =    80.64 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   741.31 ms
...
main:     load time =   496.33 ms
main:    total time =  7827.63 ms
embd_img
...
main:      load time = 31209.56 ms
main:    sample time =   533.77 ms / 8.34 ms per token
main:      eval time = 24570.87 ms / 351.01 ms per token
main:     total time = 57195.62 ms
...
main:      load time = 15336.37 ms
main:    sample time =   549.19 ms / 8.58 ms per token
main:      eval time = 12014.67 ms / 171.64 ms per token
main:     total time = 28556.51 ms
