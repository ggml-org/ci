...
- status:  SUCCESS ✅
- runtime: 2:49.61
- date:    Fri Dec 29 12:42:31 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/19 Test  #8: test2 ............................   Passed   10.03 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.81 sec
      Start 10: test-pool
...
main:  predict time =   590.67 ms / 9.23 ms per token
main:    total time =   753.36 ms
...
main:  predict time =   616.53 ms / 8.81 ms per token
main:    total time =   771.27 ms
...
main:  predict time =  2385.72 ms
main:    total time =  2711.70 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdecef27990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdeceda81a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a32af4db90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdecef27030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdecef2c940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a32af4e960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdeceda81a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a32af4db90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a32af4f2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a32af4e960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdecef27030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a32af4fc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a32af4f2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a32af50580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdecef27990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a32af4fc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a32af50740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a32af50580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdecef2c940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a32af50900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a32af50740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.88 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.92 ms
whisper_print_timings:   sample time =    71.62 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1981.27 ms /     1 runs ( 1981.27 ms per run)
whisper_print_timings:   decode time =    12.69 ms /     2 runs (    6.35 ms per run)
whisper_print_timings:   batchd time =   323.39 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2488.84 ms
