...
- status:  SUCCESS ✅
- runtime: 3:22.07
- date:    Fri Dec 29 12:42:53 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   26.30 sec
...
main:     load time =   123.51 ms
main:   sample time =    23.48 ms
main:  predict time =   447.01 ms / 6.98 ms per token
main:    total time =   606.43 ms
...
main:     load time =   123.28 ms
main:   sample time =    23.40 ms
main:  predict time =   449.43 ms / 6.42 ms per token
main:    total time =   598.35 ms
...
main:     n_decoded =      504
main:     load time =   100.68 ms
main:   sample time =   177.71 ms
main:  predict time =  1474.89 ms
main:    total time =  1782.39 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdb1269c990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdb1251d1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560db139cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdb1269c030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdb126a1940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560db139d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fdb1251d1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x560db139cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560db139e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x560db139d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fdb1269c030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560db139ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x560db139e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560db139f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fdb1269c990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x560db139ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560db139f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x560db139f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fdb126a1940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x560db139f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x560db139f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.24 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.07 ms
whisper_print_timings:   sample time =    54.78 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1156.12 ms /     1 runs ( 1156.12 ms per run)
whisper_print_timings:   decode time =     9.88 ms /     2 runs (    4.94 ms per run)
whisper_print_timings:   batchd time =   209.29 ms /   125 runs (    1.67 ms per run)
...
main:     load time =    66.54 ms
main:    total time = 10559.90 ms
embd_img
...
main:      load time =  4411.25 ms
main:    sample time =   467.45 ms / 7.30 ms per token
main:      eval time = 19236.92 ms / 274.81 ms per token
main:     total time = 24764.84 ms
...
main:      load time =  1242.94 ms
main:    sample time =   464.39 ms / 7.26 ms per token
main:      eval time =  8018.52 ms / 114.55 ms per token
main:     total time = 10113.62 ms
