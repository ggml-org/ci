...
- status:  SUCCESS ✅
- runtime: 3:35.79
- date:    Fri Dec 29 12:43:16 PM UTC 2023
...
main:  predict time =   838.86 ms / 13.11 ms per token
main:    total time =  1071.03 ms
...
main:     load time =   191.39 ms
main:   sample time =    18.07 ms
main:  predict time =   914.97 ms / 13.07 ms per token
main:    total time =  1127.35 ms
...
main:     n_decoded =      504
main:     load time =   162.58 ms
main:   sample time =   136.60 ms
main:  predict time =  6103.89 ms
main:    total time =  6484.77 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9bfaa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9be2b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadffe8b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9bfaa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9bfaf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadffe9960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9be2b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaadffe8b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadffea2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaadffe9960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9bfaa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadffeac20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaadffea2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadffeb580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9bfaa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaadffeac20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadffeb740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaadffeb580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9bfaf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaadffeb900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaadffeb740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   112.77 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.91 ms
whisper_print_timings:   sample time =    67.03 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4761.65 ms /     1 runs ( 4761.65 ms per run)
whisper_print_timings:   decode time =    15.49 ms /     2 runs (    7.75 ms per run)
whisper_print_timings:   batchd time =   712.95 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5689.16 ms
...
main:     load time =    98.59 ms
main:    total time = 40404.56 ms
embd_img
