...
- status:  SUCCESS ✅
- runtime: 7:32.55
- date:    Fri Dec 29 12:47:04 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.55 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.13 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   61.20 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 8/20 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    7.97 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   21.51 sec
...
main:     load time =   564.67 ms
main:   sample time =    33.96 ms
main:  predict time =   546.11 ms / 8.53 ms per token
main:    total time =  1164.67 ms
...
main:     load time =   591.69 ms
main:   sample time =    34.77 ms
main:  predict time =   565.60 ms / 8.08 ms per token
main:    total time =  1196.22 ms
...
main:     n_decoded =      504
main:     load time =   535.90 ms
main:   sample time =   237.42 ms
main:  predict time =  2164.77 ms
main:    total time =  2982.63 ms
...
main: loaded model in   397.09 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2a91db6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2a91c371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a547c65fb0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2a91db6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2a91dbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a547c66d80                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2a91c371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55a547c65fb0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a547c676e0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55a547c66d80                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2a91db6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a547c68040                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55a547c676e0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a547c689a0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2a91db6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55a547c68040                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a547c68b60                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55a547c689a0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2a91dbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55a547c68d20                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55a547c68b60       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   496.56 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.79 ms
whisper_print_timings:   sample time =    66.04 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    34.86 ms /     1 runs (   34.86 ms per run)
whisper_print_timings:   decode time =    13.57 ms /     2 runs (    6.78 ms per run)
whisper_print_timings:   batchd time =    81.87 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   720.38 ms
...
main:      load time =  6718.91 ms
main:    sample time =   541.71 ms / 8.46 ms per token
main:      eval time = 23677.07 ms / 338.24 ms per token
main:     total time = 31783.01 ms
...
main:      load time =  2174.79 ms
main:    sample time =   539.27 ms / 8.43 ms per token
main:      eval time = 12053.62 ms / 172.19 ms per token
main:     total time = 15411.34 ms
