...
- status:  SUCCESS ✅
- runtime: 5:13.94
- date:    Fri Dec 29 12:44:51 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.31 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.99 sec
...
main:  predict time =  5902.40 ms
main:    total time =  6260.34 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa1d1a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1b9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf09afb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa1d1a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa1d1f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf09b0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa1b9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf09afb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf09b12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf09b0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa1d1a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf09b1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf09b12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf09b2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa1d1a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf09b1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf09b2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf09b2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa1d1f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf09b2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf09b2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.01 ms
whisper_print_timings:   sample time =    66.17 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4630.44 ms /     1 runs ( 4630.44 ms per run)
whisper_print_timings:   decode time =    15.13 ms /     2 runs (    7.57 ms per run)
whisper_print_timings:   batchd time =   707.64 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5540.20 ms
...
main:     load time =    99.33 ms
main:    total time = 39482.66 ms
embd_img
...
main:      load time =  5573.63 ms
main:    sample time =   522.72 ms / 8.17 ms per token
main:      eval time = 43643.01 ms / 623.47 ms per token
main:     total time = 52113.09 ms
...
main:      load time =  1594.63 ms
main:    sample time =   517.02 ms / 8.08 ms per token
main:      eval time = 17103.05 ms / 244.33 ms per token
main:     total time = 20183.50 ms
