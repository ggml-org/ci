...
- status:  SUCCESS ✅
- runtime: 2:49.21
- date:    Wed Oct  4 12:56:10 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    3.84 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    6.60 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.77 sec
      Start  2: test-opt
 ...
 6/15 Test  #6: test-mul-mat2 ....................   Passed    2.82 sec
      Start  7: test0
 7/15 Test  #7: test0 ............................   Passed    0.00 sec
      Start  8: test1
 8/15 Test  #8: test1 ............................   Passed    0.01 sec
      Start  9: test2
 9/15 Test  #9: test2 ............................   Passed    0.03 sec
      Start 10: test3
...
main:     load time =   253.65 ms
main:   sample time =    23.96 ms
main:  predict time =   478.12 ms / 7.47 ms per token
main:    total time =   770.67 ms
...
main:  predict time =   493.05 ms / 7.04 ms per token
main:    total time =   657.78 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9dac7d38d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9dac654160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55789d398ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9dac7d2fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9dac7d8840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55789d399850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9dac654160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55789d398ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55789d39a170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55789d399850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9dac7d2fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55789d39aa90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55789d39a170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55789d39b3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9dac7d38d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55789d39aa90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55789d39b530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55789d39b3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9dac7d8840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55789d39b6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55789d39b530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   144.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.25 ms
whisper_print_timings:   sample time =    16.41 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1158.29 ms /     1 runs ( 1158.29 ms per run)
whisper_print_timings:   decode time =   108.13 ms /    27 runs (    4.00 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1487.08 ms
```
### mpt
...
main:      load time =  5869.60 ms
main:    sample time =   465.93 ms / 7.28 ms per token
main:      eval time = 22185.50 ms / 316.94 ms per token
main:     total time = 29213.64 ms
...
main:      load time =  1339.78 ms
main:    sample time =   488.64 ms / 7.63 ms per token
main:      eval time =  9384.83 ms / 134.07 ms per token
main:     total time = 11572.36 ms
