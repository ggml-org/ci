...
- status:  SUCCESS ✅
- runtime: 3:47.66
- date:    Wed Oct  4 12:58:44 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    4.85 sec
 ...
 5/14 Test  #5: test-mul-mat2 ....................   Passed    8.54 sec
      Start  6: test0
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.59 sec
      Start  2: test-opt
...
main:     load time =   191.72 ms
main:   sample time =    17.08 ms
main:  predict time =   805.36 ms / 12.58 ms per token
main:    total time =  1039.48 ms
...
main:     load time =   167.88 ms
main:   sample time =    17.50 ms
main:  predict time =   880.19 ms / 12.57 ms per token
main:    total time =  1071.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8330a8d0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8318b160                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4677ac0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83309fb0                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8330f840                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac4678850                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8318b160                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac4677ac0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac4679170                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaac4678850                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff83309fb0                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac4679a90                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaac4679170                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac467a3b0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8330a8d0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaac4679a90                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac467a530                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaac467a3b0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8330f840                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaac467a6b0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaac467a530       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   206.23 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.35 ms
whisper_print_timings:   sample time =    16.97 ms /    27 runs (    0.63 ms per run)
whisper_print_timings:   encode time =  4606.77 ms /     1 runs ( 4606.77 ms per run)
whisper_print_timings:   decode time =   173.01 ms /    27 runs (    6.41 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5069.39 ms
```
### mpt
...
main:      load time =  5627.58 ms
main:    sample time =   522.03 ms / 8.16 ms per token
main:      eval time = 43912.86 ms / 627.33 ms per token
main:     total time = 52436.23 ms
...
main:      load time =  1496.67 ms
main:    sample time =   516.84 ms / 8.08 ms per token
main:      eval time = 17372.56 ms / 248.18 ms per token
main:     total time = 20344.25 ms
