...
- status:  SUCCESS ✅
- runtime: 2:56.72
- date:    Fri Mar 15 12:13:42 UTC 2024
...
main:  predict time =   918.04 ms / 14.34 ms per token
...
main:  predict time =   966.84 ms / 13.81 ms per token
main:    total time =  1131.33 ms
...
main:     load time =   176.60 ms
main:   sample time =    16.72 ms
main:  predict time =   982.20 ms / 14.03 ms per token
main:    total time =  1179.65 ms
...
main:  predict time =  6453.00 ms
main:    total time =  6807.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbc57a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbc3fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad32d0ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbc57a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbc57f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad32d1ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbc3fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad32d0ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad32d2410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad32d1ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbc57a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad32d2d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad32d2410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad32d36d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbc57a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad32d2d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad32d3890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad32d36d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbc57f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad32d3a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad32d3890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.03 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.53 ms
whisper_print_timings:   sample time =    66.21 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4671.29 ms /     1 runs ( 4671.29 ms per run)
whisper_print_timings:   decode time =    15.56 ms /     2 runs (    7.78 ms per run)
whisper_print_timings:   batchd time =   709.74 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5585.79 ms
