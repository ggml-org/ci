...
- status:  SUCCESS ✅
- runtime: 1:08.68
- date:    Thu Mar 13 18:30:38 UTC 2025
...
main:  predict time =   462.88 ms / 7.23 ms per token
main:    total time =   611.22 ms
...
main:  predict time =   480.14 ms / 6.86 ms per token
main:    total time =   615.64 ms
...
main:     n_decoded =      504
main:     load time =   112.02 ms
main:   sample time =   167.90 ms
main:  predict time =  1419.50 ms
main:    total time =  1731.06 ms
...
main:     load time =    77.55 ms
main:    total time =  8560.37 ms
embd_img
