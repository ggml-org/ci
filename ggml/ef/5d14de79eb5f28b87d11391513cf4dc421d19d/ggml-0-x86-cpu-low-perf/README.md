...
- status:  SUCCESS ✅
- runtime: 3:24.89
- date:    Wed May 29 11:07:38 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/22 Test  #3: test-quantize-perf ...............   Passed    4.47 sec
      Start  4: test-mul-mat0
 4/22 Test  #4: test-mul-mat0 ....................   Passed    0.62 sec
      Start  5: test-mul-mat2
 ...
 8/22 Test  #8: test2 ............................   Passed   24.16 sec
      Start  9: test3
 9/22 Test  #9: test3 ............................   Passed    1.65 sec
      Start 10: test-pool
10/22 Test #10: test-pool ........................   Passed    0.00 sec
      Start 11: test-arange
11/22 Test #11: test-arange ......................   Passed    0.00 sec
...
main:  predict time =   684.81 ms / 10.70 ms per token
main:    total time =   826.04 ms
...
main:  predict time =   728.58 ms / 10.41 ms per token
main:    total time =   855.91 ms
...
main:     load time =   121.56 ms
main:   sample time =    23.83 ms
main:  predict time =   735.56 ms / 10.51 ms per token
main:    total time =   883.93 ms
...
main:  predict time =  2989.91 ms
main:    total time =  3314.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x717a176fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x717a1757b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x64280f38fce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x717a176fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x717a176ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x64280f390ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x717a1757b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x64280f38fce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x64280f391410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x64280f390ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x717a176fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x64280f391d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x64280f391410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x64280f3926d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x717a176fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x64280f391d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x64280f392890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x64280f3926d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x717a176ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x64280f392a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x64280f392890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.19 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.64 ms
whisper_print_timings:   sample time =    72.22 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2003.42 ms /     1 runs ( 2003.42 ms per run)
whisper_print_timings:   decode time =    13.93 ms /     2 runs (    6.97 ms per run)
whisper_print_timings:   batchd time =   328.03 ms /   125 runs (    2.62 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2531.14 ms
