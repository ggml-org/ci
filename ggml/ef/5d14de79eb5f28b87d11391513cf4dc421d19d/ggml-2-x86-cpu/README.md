...
- status:  SUCCESS ✅
- runtime: 2:09.99
- date:    Wed May 29 11:06:28 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    1.78 sec
      Start  2: test-opt
...
main:  predict time =   513.18 ms / 8.02 ms per token
main:    total time =   655.18 ms
...
main:  predict time =   531.95 ms / 7.60 ms per token
main:    total time =   662.28 ms
...
main:     load time =   126.37 ms
main:   sample time =    23.88 ms
main:  predict time =   554.50 ms / 7.92 ms per token
main:    total time =   707.85 ms
...
main:  predict time =  1830.41 ms
main:    total time =  2145.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x74c8f14fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x74c8f137b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x58acd1003ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x74c8f14fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x74c8f14ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x58acd1004ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x74c8f137b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x58acd1003ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x58acd1005410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x58acd1004ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x74c8f14fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x58acd1005d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x58acd1005410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x58acd10066d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x74c8f14fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x58acd1005d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x58acd1006890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x58acd10066d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x74c8f14ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x58acd1006a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x58acd1006890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    72.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.52 ms
whisper_print_timings:   sample time =    54.82 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1163.97 ms /     1 runs ( 1163.97 ms per run)
whisper_print_timings:   decode time =    11.49 ms /     2 runs (    5.75 ms per run)
whisper_print_timings:   batchd time =   221.87 ms /   125 runs (    1.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1553.60 ms
...
main:     load time =    64.70 ms
main:    total time = 11054.77 ms
embd_img
