...
- status:  SUCCESS ✅
- runtime: 5:03.68
- date:    Wed Feb 21 12:40:04 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   98.51 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 141.06 sec
...
main:  predict time =   902.33 ms / 14.10 ms per token
...
main:  predict time =   984.30 ms / 14.06 ms per token
main:    total time =  1159.57 ms
...
main:  predict time =   988.37 ms / 14.12 ms per token
main:    total time =  1196.50 ms
...
main:  predict time =  6619.37 ms
main:    total time =  6985.50 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff818fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8177b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac76bace0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff818fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff818ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac76bbab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8177b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaac76bace0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac76bc410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaac76bbab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff818fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac76bcd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaac76bc410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac76bd6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff818fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaac76bcd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac76bd890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaac76bd6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff818ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaac76bda50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaac76bd890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.80 ms
whisper_print_timings:   sample time =    66.00 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4695.35 ms /     1 runs ( 4695.35 ms per run)
whisper_print_timings:   decode time =    14.69 ms /     2 runs (    7.34 ms per run)
whisper_print_timings:   batchd time =   842.09 ms /   125 runs (    6.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5744.51 ms
