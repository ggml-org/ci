...
- status:  SUCCESS ✅
- runtime: 3:11.00
- date:    Wed Feb 21 12:38:18 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   79.72 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  94.23 sec
...
21/21 Test #21: test-backend-ops .................   Passed   19.32 sec
...
main:  predict time =   483.84 ms / 7.56 ms per token
...
main:     load time =   106.66 ms
main:   sample time =    23.54 ms
main:  predict time =   508.49 ms / 7.26 ms per token
main:    total time =   640.76 ms
...
main:  predict time =   515.77 ms / 7.37 ms per token
main:    total time =   669.37 ms
...
main:  predict time =  1814.26 ms
main:    total time =  2128.61 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f312450c990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f312438d1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561dd4d13ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f312450c030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3124511940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561dd4d14ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f312438d1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561dd4d13ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561dd4d15410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561dd4d14ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f312450c030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561dd4d15d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561dd4d15410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561dd4d166d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f312450c990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561dd4d15d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561dd4d16890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561dd4d166d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f3124511940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561dd4d16a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561dd4d16890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.98 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.64 ms
whisper_print_timings:   sample time =    54.89 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1183.36 ms /     1 runs ( 1183.36 ms per run)
whisper_print_timings:   decode time =    12.46 ms /     2 runs (    6.23 ms per run)
whisper_print_timings:   batchd time =   211.20 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1561.70 ms
...
main:     load time =    66.24 ms
main:    total time = 10685.08 ms
embd_img
