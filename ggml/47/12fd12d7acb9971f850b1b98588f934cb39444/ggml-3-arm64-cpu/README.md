...
- status:  SUCCESS ✅
- runtime: 4:15.12
- date:    Wed Feb 21 12:39:14 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/21 Test  #3: test-quantize-fns ................   Passed    2.35 sec
...
21/21 Test #21: test-backend-ops .................   Passed   21.02 sec
...
main:     load time =   150.68 ms
main:   sample time =    16.96 ms
main:  predict time =   884.43 ms / 13.82 ms per token
main:    total time =  1074.29 ms
...
main:  predict time =   969.37 ms / 13.85 ms per token
main:    total time =  1139.60 ms
...
main:  predict time =   975.80 ms / 13.94 ms per token
...
main:     n_decoded =      504
main:     load time =   149.98 ms
main:   sample time =   128.63 ms
main:  predict time =  6440.28 ms
main:    total time =  6800.96 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb70fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb6f7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2b02ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb70fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb70ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2b03ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb6f7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad2b02ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad2b04410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad2b03ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb70fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2b04d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad2b04410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2b056d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb70fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad2b04d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2b05890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad2b056d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb70ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad2b05a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad2b05890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   100.72 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.74 ms
whisper_print_timings:   sample time =    65.34 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4689.93 ms /     1 runs ( 4689.93 ms per run)
whisper_print_timings:   decode time =    14.30 ms /     2 runs (    7.15 ms per run)
whisper_print_timings:   batchd time =   709.30 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5597.69 ms
