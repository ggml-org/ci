...
- status:  SUCCESS ✅
- runtime: 8:50.00
- date:    Wed Feb 21 12:43:56 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/20 Test  #8: test2 ............................   Passed   20.85 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    2.07 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  149.80 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 200.27 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.80 sec
      Start  2: test-opt
 2/21 Test  #2: test-opt .........................   Passed    3.55 sec
      Start  3: test-quantize-fns
 3/21 Test  #3: test-quantize-fns ................   Passed    3.37 sec
 ...
 8/21 Test  #8: test1 ............................   Passed    0.56 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.79 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   35.62 sec
...
main:     load time =   547.92 ms
main:   sample time =    34.02 ms
main:  predict time =   639.28 ms / 9.99 ms per token
main:    total time =  1240.44 ms
...
main:     load time =   589.57 ms
main:   sample time =    44.44 ms
main:  predict time =   727.69 ms / 10.40 ms per token
main:    total time =  1366.26 ms
...
main:     n_decoded =      504
main:     load time =   549.17 ms
main:   sample time =   234.54 ms
main:  predict time =  2930.91 ms
main:    total time =  3761.63 ms
...
main: loaded model in   413.69 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f52d4db6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f52d4c371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557c7a1e0ae0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f52d4db6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f52d4dbb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557c7a1e18b0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f52d4c371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x557c7a1e0ae0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557c7a1e2210                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x557c7a1e18b0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f52d4db6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557c7a1e2b70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x557c7a1e2210                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557c7a1e34d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f52d4db6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x557c7a1e2b70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557c7a1e3690                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x557c7a1e34d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f52d4dbb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x557c7a1e3850                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x557c7a1e3690       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   501.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.01 ms
whisper_print_timings:   sample time =    66.17 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    28.07 ms /     1 runs (   28.07 ms per run)
whisper_print_timings:   decode time =    21.18 ms /     2 runs (   10.59 ms per run)
whisper_print_timings:   batchd time =    81.46 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   727.79 ms
...
main:     load time =   520.17 ms
main:    total time =  8019.78 ms
embd_img
