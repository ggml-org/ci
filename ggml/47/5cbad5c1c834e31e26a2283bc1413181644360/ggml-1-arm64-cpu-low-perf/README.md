...
- status:  SUCCESS ✅
- runtime: 6:09.19
- date:    Mon Jan 29 07:14:40 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.50 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   21.41 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  156.69 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 194.68 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.98 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.20 sec
...
main:  predict time =   883.88 ms / 13.81 ms per token
main:    total time =  1114.70 ms
...
main:  predict time =   958.30 ms / 13.69 ms per token
main:    total time =  1165.08 ms
...
main:     n_decoded =      504
main:     load time =   162.48 ms
main:   sample time =   127.34 ms
main:  predict time =  6246.42 ms
main:    total time =  6618.93 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb918a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb900b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae96d4b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb918a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb918f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae96d5960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb900b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae96d4b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae96d62c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae96d5960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb918a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae96d6c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae96d62c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae96d7580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb918a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae96d6c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae96d7740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae96d7580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb918f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae96d7900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae96d7740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4746.43 ms /     1 runs ( 4746.43 ms per run)
whisper_print_timings:   decode time =    15.86 ms /     2 runs (    7.93 ms per run)
whisper_print_timings:   batchd time =   742.26 ms /   125 runs (    5.94 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5701.97 ms
