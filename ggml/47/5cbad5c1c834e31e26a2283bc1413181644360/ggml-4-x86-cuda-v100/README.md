...
- status:  SUCCESS ✅
- runtime: 11:54.00
- date:    Mon Jan 29 19:20:26 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.56 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   20.91 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  256.85 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/21 Test  #7: test0 ............................   Passed    0.55 sec
      Start  8: test1
 8/21 Test  #8: test1 ............................   Passed    0.61 sec
      Start  9: test2
...
21/21 Test #21: test-backend-ops .................   Passed   47.48 sec
...
main:     load time =   616.08 ms
main:   sample time =    35.44 ms
main:  predict time =   622.81 ms / 9.73 ms per token
main:    total time =  1298.73 ms
...
main:     load time =   569.41 ms
main:   sample time =    34.29 ms
main:  predict time =   622.30 ms / 8.89 ms per token
main:    total time =  1230.79 ms
...
main:  predict time =  2333.23 ms
main:    total time =  3175.81 ms
...
main: loaded model in   402.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f14b3258990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f14b30d91a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561f75aa0aa0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f14b3258030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f14b325d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561f75aa1870                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f14b30d91a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x561f75aa0aa0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561f75aa21d0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x561f75aa1870                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f14b3258030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561f75aa2b30                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x561f75aa21d0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561f75aa3490                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f14b3258990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x561f75aa2b30                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561f75aa3650                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x561f75aa3490                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f14b325d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x561f75aa3810                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x561f75aa3650       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   523.59 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.50 ms
whisper_print_timings:   sample time =    65.59 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    21.96 ms /     1 runs (   21.96 ms per run)
whisper_print_timings:   decode time =    20.90 ms /     2 runs (   10.45 ms per run)
whisper_print_timings:   batchd time =    80.80 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   737.77 ms
...
main:     load time =   495.11 ms
main:    total time =  8022.84 ms
embd_img
...
main:      load time =  7323.95 ms
main:    sample time =   515.28 ms / 8.05 ms per token
main:      eval time = 24767.00 ms / 353.81 ms per token
main:     total time = 33492.98 ms
...
main:      load time =  2208.80 ms
main:    sample time =   521.78 ms / 8.15 ms per token
main:      eval time = 12427.48 ms / 177.54 ms per token
main:     total time = 15804.61 ms
