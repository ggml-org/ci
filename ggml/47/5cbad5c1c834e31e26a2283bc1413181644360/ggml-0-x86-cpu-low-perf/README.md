...
- status:  SUCCESS ✅
- runtime: 4:54.49
- date:    Mon Jan 29 19:13:14 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/475cbad5c1c834e31e26a2283bc1413181644360
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.67 sec
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.32 sec
      Start  9: test3
...
20/20 Test #20: test-backend-ops .................   Passed  117.18 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 156.31 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.30 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.14 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.95 sec
...
main:     load time =   132.21 ms
main:   sample time =    23.94 ms
main:  predict time =   670.76 ms / 10.48 ms per token
main:    total time =   840.31 ms
...
main:     load time =   130.10 ms
main:   sample time =    23.88 ms
main:  predict time =   696.70 ms / 9.95 ms per token
main:    total time =   853.22 ms
...
main:     n_decoded =      504
main:     load time =   109.03 ms
main:   sample time =   178.03 ms
main:  predict time =  2517.48 ms
main:    total time =  2851.49 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb75b0d2990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb75af531a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cbd9e43b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb75b0d2030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb75b0d7940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cbd9e44960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb75af531a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55cbd9e43b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cbd9e452c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55cbd9e44960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb75b0d2030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cbd9e45c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55cbd9e452c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cbd9e46580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb75b0d2990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55cbd9e45c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cbd9e46740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55cbd9e46580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb75b0d7940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55cbd9e46900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55cbd9e46740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    77.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.35 ms
whisper_print_timings:   sample time =    72.21 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2001.48 ms /     1 runs ( 2001.48 ms per run)
whisper_print_timings:   decode time =    13.66 ms /     2 runs (    6.83 ms per run)
whisper_print_timings:   batchd time =   329.86 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2521.54 ms
