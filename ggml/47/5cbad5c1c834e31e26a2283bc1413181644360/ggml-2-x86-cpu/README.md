...
- status:  SUCCESS ✅
- runtime: 5:10.67
- date:    Mon Jan 29 19:13:39 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  111.45 sec
...
main:     load time =   138.15 ms
main:   sample time =    24.00 ms
main:  predict time =   472.19 ms / 7.38 ms per token
main:    total time =   647.78 ms
...
main:  predict time =   494.84 ms / 7.07 ms per token
main:    total time =   647.99 ms
...
main:  predict time =  1536.43 ms
main:    total time =  1854.03 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8c39049990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8c38eca1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555615873b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8c39049030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8c3904e940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555615874960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8c38eca1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555615873b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5556158752c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555615874960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8c39049030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555615875c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5556158752c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555615876580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8c39049990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555615875c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555615876740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555615876580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8c3904e940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555615876900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555615876740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   159.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.08 ms
whisper_print_timings:   sample time =    55.33 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1167.52 ms /     1 runs ( 1167.52 ms per run)
whisper_print_timings:   decode time =    10.32 ms /     2 runs (    5.16 ms per run)
whisper_print_timings:   batchd time =   213.93 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1626.22 ms
...
main:     load time =    62.51 ms
main:    total time = 10635.97 ms
embd_img
...
main:      load time =  5485.35 ms
main:    sample time =   470.40 ms / 7.35 ms per token
main:      eval time = 20734.13 ms / 296.20 ms per token
main:     total time = 27407.41 ms
...
main:      load time =  1200.79 ms
main:    sample time =   467.75 ms / 7.31 ms per token
main:      eval time =  8298.66 ms / 118.55 ms per token
main:     total time = 10342.00 ms
