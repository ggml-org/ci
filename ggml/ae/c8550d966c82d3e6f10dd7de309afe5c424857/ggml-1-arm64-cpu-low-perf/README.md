...
- status:  SUCCESS ✅
- runtime: 6:06.62
- date:    Mon Jan 29 12:12:03 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  154.94 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.07 sec
      Start  2: test-quantize-fns
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   24.31 sec
...
main:     load time =   190.27 ms
main:   sample time =    17.17 ms
main:  predict time =   950.91 ms / 13.58 ms per token
main:    total time =  1161.62 ms
...
main:     n_decoded =      504
main:     load time =   164.40 ms
main:   sample time =   128.73 ms
main:  predict time =  6160.70 ms
main:    total time =  6537.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e10a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8df8b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad86aab90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e10a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e10f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad86ab960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8df8b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad86aab90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad86ac2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad86ab960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e10a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad86acc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad86ac2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad86ad580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e10a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad86acc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad86ad740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad86ad580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e10f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad86ad900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad86ad740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:   encode time =  4742.38 ms /     1 runs ( 4742.38 ms per run)
whisper_print_timings:   decode time =    15.85 ms /     2 runs (    7.93 ms per run)
whisper_print_timings:   batchd time =   715.21 ms /   125 runs (    5.72 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5666.73 ms
