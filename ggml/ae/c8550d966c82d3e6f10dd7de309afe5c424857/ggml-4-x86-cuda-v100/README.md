...
- status:  SUCCESS ✅
- runtime: 11:53.79
- date:    Mon Jan 29 12:18:51 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  257.70 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 304.01 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.44 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.53 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed   20.73 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   47.21 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) =  92.04 sec
...
main:     load time =   572.36 ms
main:   sample time =    35.03 ms
main:  predict time =   653.00 ms / 10.20 ms per token
main:    total time =  1286.20 ms
...
main:     load time =   574.83 ms
main:   sample time =    34.37 ms
main:  predict time =   637.49 ms / 9.11 ms per token
main:    total time =  1251.30 ms
...
main:     n_decoded =      504
main:     load time =   552.35 ms
main:   sample time =   236.91 ms
main:  predict time =  2300.88 ms
main:    total time =  3135.25 ms
...
main: loaded model in   392.72 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98e74f9990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98e737a1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56123aa54b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98e74f9030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98e74fe940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56123aa55960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f98e737a1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x56123aa54b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56123aa562c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x56123aa55960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f98e74f9030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56123aa56c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x56123aa562c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56123aa57580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f98e74f9990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x56123aa56c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56123aa57740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x56123aa57580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f98e74fe940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x56123aa57900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x56123aa57740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   526.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    19.01 ms
whisper_print_timings:   sample time =    66.07 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    24.81 ms /     1 runs (   24.81 ms per run)
whisper_print_timings:   decode time =    21.80 ms /     2 runs (   10.90 ms per run)
whisper_print_timings:   batchd time =    81.23 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   748.02 ms
...
main:     load time =   505.96 ms
main:    total time =  7940.15 ms
embd_img
...
main:      load time =  6977.87 ms
main:    sample time =   518.87 ms / 8.11 ms per token
main:      eval time = 24219.39 ms / 345.99 ms per token
main:     total time = 32593.60 ms
...
main:      load time =  2196.34 ms
main:    sample time =   525.52 ms / 8.21 ms per token
main:      eval time = 12480.99 ms / 178.30 ms per token
main:     total time = 15859.42 ms
