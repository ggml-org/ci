...
- status:  SUCCESS ✅
- runtime: 4:51.02
- date:    Mon Jan 29 12:09:38 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/20 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.02 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.74 sec
      Start 10: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed  115.69 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 154.39 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    5.22 sec
      Start  2: test-quantize-fns
 ...
 7/20 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/20 Test  #8: test2 ............................   Passed   24.01 sec
      Start  9: test3
...
19/20 Test #19: test-backend-buffer ..............   Passed    0.00 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   18.87 sec
...
main:     load time =   131.06 ms
main:   sample time =    24.02 ms
main:  predict time =   648.95 ms / 10.14 ms per token
main:    total time =   817.21 ms
...
main:     load time =   131.74 ms
main:   sample time =    23.90 ms
main:  predict time =   674.79 ms / 9.64 ms per token
main:    total time =   833.01 ms
...
main:     n_decoded =      504
main:     load time =   108.10 ms
main:   sample time =   178.40 ms
main:  predict time =  2523.12 ms
main:    total time =  2855.00 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd523e9e990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd523d1f1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5576b350cb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd523e9e030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd523ea3940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5576b350d960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fd523d1f1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5576b350cb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5576b350e2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5576b350d960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fd523e9e030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5576b350ec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5576b350e2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576b350f580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fd523e9e990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5576b350ec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5576b350f740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5576b350f580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fd523ea3940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5576b350f900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5576b350f740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.00 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.85 ms
whisper_print_timings:   sample time =    71.83 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1993.34 ms /     1 runs ( 1993.34 ms per run)
whisper_print_timings:   decode time =    12.81 ms /     2 runs (    6.41 ms per run)
whisper_print_timings:   batchd time =   332.65 ms /   125 runs (    2.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2514.83 ms
...
main:     load time =    67.62 ms
main:    total time = 19000.62 ms
embd_img
