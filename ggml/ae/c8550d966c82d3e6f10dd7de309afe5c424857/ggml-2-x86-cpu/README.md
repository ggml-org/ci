...
- status:  SUCCESS ✅
- runtime: 5:00.87
- date:    Mon Jan 29 12:09:49 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  114.21 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 125.16 sec
...
21/21 Test #21: test-backend-ops .................   Passed   18.10 sec
...
main:  predict time =   480.51 ms / 6.86 ms per token
main:    total time =   634.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1e0c11d990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1e0bf9e1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558eb393fb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1e0c11d030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1e0c122940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558eb3940960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f1e0bf9e1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558eb393fb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558eb39412c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x558eb3940960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f1e0c11d030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558eb3941c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x558eb39412c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558eb3942580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f1e0c11d990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x558eb3941c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558eb3942740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x558eb3942580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f1e0c122940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x558eb3942900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x558eb3942740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    75.55 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.21 ms
whisper_print_timings:   sample time =    55.66 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1161.09 ms /     1 runs ( 1161.09 ms per run)
whisper_print_timings:   decode time =    10.29 ms /     2 runs (    5.15 ms per run)
whisper_print_timings:   batchd time =   215.79 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1537.83 ms
...
main:      load time =  4235.04 ms
main:    sample time =   470.37 ms / 7.35 ms per token
main:      eval time = 19468.62 ms / 278.12 ms per token
main:     total time = 24827.13 ms
...
main:      load time =  1214.06 ms
main:    sample time =   467.31 ms / 7.30 ms per token
main:      eval time =  8230.18 ms / 117.57 ms per token
main:     total time = 10291.12 ms
