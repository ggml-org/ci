...
- status:  SUCCESS ✅
- runtime: 7:01.30
- date:    Mon Jan 29 12:13:52 PM UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed  125.61 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 139.57 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.15 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   24.54 sec
...
main:     load time =   188.03 ms
main:   sample time =    17.07 ms
main:  predict time =   865.68 ms / 13.53 ms per token
main:    total time =  1092.77 ms
...
main:     load time =   187.51 ms
main:   sample time =    17.03 ms
main:  predict time =   935.05 ms / 13.36 ms per token
main:    total time =  1142.79 ms
...
main:     n_decoded =      504
main:     load time =   157.88 ms
main:   sample time =   128.69 ms
main:  predict time =  5996.62 ms
main:    total time =  6366.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85fea990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85e6b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8befb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85fea030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85fef940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae8bf0960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff85e6b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae8befb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae8bf12c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae8bf0960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff85fea030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae8bf1c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae8bf12c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae8bf2580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff85fea990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae8bf1c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae8bf2740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae8bf2580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff85fef940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae8bf2900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae8bf2740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   107.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.90 ms
whisper_print_timings:   sample time =    65.83 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4641.98 ms /     1 runs ( 4641.98 ms per run)
whisper_print_timings:   decode time =    15.83 ms /     2 runs (    7.91 ms per run)
whisper_print_timings:   batchd time =   713.44 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5563.98 ms
...
main:     load time =    97.51 ms
main:    total time = 39930.84 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.261000 sec.)
...
main:      load time =  5607.50 ms
main:    sample time =   516.88 ms / 8.08 ms per token
main:      eval time = 43870.39 ms / 626.72 ms per token
main:     total time = 52366.67 ms
...
main:      load time =  1590.82 ms
main:    sample time =   514.35 ms / 8.04 ms per token
main:      eval time = 17444.27 ms / 249.20 ms per token
main:     total time = 20506.94 ms
