...
- status:  SUCCESS ✅
- runtime: 6:00.32
- date:    Wed Jan  3 01:08:40 PM UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/ae29248e6bf601aace1e00c9f707ee0bc81abab2
...
20/20 Test #20: test-backend-ops .................   Passed   34.75 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    4.17 sec
      Start  2: test-opt
...
21/21 Test #21: test-backend-ops .................   Passed   10.10 sec
...
main:     load time =   264.17 ms
main:   sample time =    17.40 ms
main:  predict time =   826.51 ms / 12.91 ms per token
main:    total time =  1129.66 ms
...
main:     load time =   172.28 ms
main:   sample time =    16.98 ms
main:  predict time =   901.10 ms / 12.87 ms per token
main:    total time =  1093.03 ms
...
main:     n_decoded =      504
main:     load time =   145.28 ms
main:   sample time =   126.64 ms
main:  predict time =  5986.99 ms
main:    total time =  6340.21 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf15a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaefdb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf2d62b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf15a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf15f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf2d63960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffaefdb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf2d62b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf2d642c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaaf2d63960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffaf15a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf2d64c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaaf2d642c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf2d65580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffaf15a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaaf2d64c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf2d65740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaaf2d65580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffaf15f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaaf2d65900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaaf2d65740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   162.99 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.17 ms
whisper_print_timings:   sample time =    65.96 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4638.59 ms /     1 runs ( 4638.59 ms per run)
whisper_print_timings:   decode time =    15.22 ms /     2 runs (    7.61 ms per run)
whisper_print_timings:   batchd time =   709.11 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5609.82 ms
...
main:     load time =    81.72 ms
main:    total time = 39690.90 ms
embd_img
...
main:      load time = 12366.61 ms
main:    sample time =   517.71 ms / 8.09 ms per token
main:      eval time = 43710.84 ms / 624.44 ms per token
main:     total time = 58968.61 ms
...
main:      load time =  4375.21 ms
main:    sample time =   518.71 ms / 8.10 ms per token
main:      eval time = 17359.93 ms / 248.00 ms per token
main:     total time = 23224.97 ms
