...
- status:  SUCCESS ✅
- runtime: 9:07.35
- date:    Wed Jan  3 13:32:25 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 8/20 Test  #8: test2 ............................   Passed    8.11 sec
      Start  9: test3
 9/20 Test  #9: test3 ............................   Passed    1.15 sec
      Start 10: test-pool
10/20 Test #10: test-pool ........................   Passed    0.59 sec
      Start 11: test-conv-transpose
11/20 Test #11: test-conv-transpose ..............   Passed    0.59 sec
      Start 12: test-dup
...
20/20 Test #20: test-backend-ops .................   Passed   59.47 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    6.57 sec
      Start  2: test-opt
 ...
 8/21 Test  #8: test1 ............................   Passed    0.54 sec
      Start  9: test2
 9/21 Test  #9: test2 ............................   Passed    7.90 sec
      Start 10: test3
...
21/21 Test #21: test-backend-ops .................   Passed   22.02 sec
...
main:     load time =   581.74 ms
main:   sample time =    33.91 ms
main:  predict time =   561.82 ms / 8.78 ms per token
main:    total time =  1201.33 ms
...
main:     load time =   569.50 ms
main:   sample time =    34.91 ms
main:  predict time =   604.04 ms / 8.63 ms per token
main:    total time =  1212.68 ms
...
main:     n_decoded =      504
main:     load time =   554.59 ms
main:   sample time =   233.65 ms
main:  predict time =  2286.57 ms
main:    total time =  3120.25 ms
...
main: loaded model in   407.58 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8813b6990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc8812371a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55eedb3a3e40                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8813b6030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8813bb940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55eedb3a4c10                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fc8812371a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55eedb3a3e40                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55eedb3a5570                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55eedb3a4c10                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fc8813b6030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55eedb3a5ed0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55eedb3a5570                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55eedb3a6830                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fc8813b6990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55eedb3a5ed0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55eedb3a69f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55eedb3a6830                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fc8813bb940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55eedb3a6bb0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55eedb3a69f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   494.69 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.57 ms
whisper_print_timings:   sample time =    67.44 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    35.78 ms /     1 runs (   35.78 ms per run)
whisper_print_timings:   decode time =    14.17 ms /     2 runs (    7.09 ms per run)
whisper_print_timings:   batchd time =    81.90 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   721.01 ms
...
main:     load time =   493.61 ms
main:    total time =  8118.38 ms
embd_img
...
main:      load time = 32448.04 ms
main:    sample time =   546.19 ms / 8.53 ms per token
main:      eval time = 25449.71 ms / 363.57 ms per token
main:     total time = 59350.78 ms
...
main:      load time = 16887.57 ms
main:    sample time =   539.21 ms / 8.43 ms per token
main:      eval time = 12528.35 ms / 178.98 ms per token
main:     total time = 30589.94 ms
