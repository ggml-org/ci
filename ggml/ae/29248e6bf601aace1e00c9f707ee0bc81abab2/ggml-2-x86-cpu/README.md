...
- status:  SUCCESS ✅
- runtime: 4:00.81
- date:    Wed Jan  3 12:56:33 UTC 2024
...
20/20 Test #20: test-backend-ops .................   Passed   27.21 sec
...
21/21 Test #21: test-backend-ops .................   Passed    9.05 sec
...
main:     load time =   266.83 ms
main:   sample time =    23.43 ms
main:  predict time =   445.45 ms / 6.96 ms per token
main:    total time =   748.53 ms
...
main:  predict time =   461.14 ms / 6.59 ms per token
main:    total time =   610.95 ms
...
main:  predict time =  1504.31 ms
main:    total time =  1818.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faf0e33a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faf0e1bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562aa37fcb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faf0e33a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7faf0e33f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562aa37fd960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7faf0e1bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562aa37fcb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562aa37fe2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562aa37fd960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7faf0e33a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562aa37fec20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562aa37fe2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562aa37ff580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7faf0e33a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562aa37fec20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562aa37ff740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562aa37ff580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7faf0e33f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562aa37ff900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562aa37ff740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   173.10 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.15 ms
whisper_print_timings:   sample time =    55.31 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1159.95 ms /     1 runs ( 1159.95 ms per run)
whisper_print_timings:   decode time =     9.99 ms /     2 runs (    4.99 ms per run)
whisper_print_timings:   batchd time =   211.37 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1629.03 ms
...
main:      load time = 11197.16 ms
main:    sample time =   466.86 ms / 7.29 ms per token
main:      eval time = 20542.71 ms / 293.47 ms per token
main:     total time = 32874.81 ms
...
main:      load time =  4388.57 ms
main:    sample time =   491.45 ms / 7.68 ms per token
main:      eval time =  9090.01 ms / 129.86 ms per token
main:     total time = 14322.26 ms
