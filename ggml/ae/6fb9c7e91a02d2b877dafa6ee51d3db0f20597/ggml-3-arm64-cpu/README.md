...
- status:  SUCCESS ✅
- runtime: 5:35.11
- date:    Wed Dec 13 06:14:44 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.16 sec
...
20/20 Test #20: test-backend-ops .................   Passed   10.15 sec
...
main:  predict time =   875.78 ms / 12.51 ms per token
main:    total time =  1083.11 ms
...
main:     n_decoded =      504
main:     load time =   147.40 ms
main:   sample time =   126.92 ms
main:  predict time =  5883.08 ms
main:    total time =  6238.54 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9230a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9218b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8c8eba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9230a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9230f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c8f980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9218b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf8c8eba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c902f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c8f980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9230a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c90c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c902f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8c915d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9230a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf8c90c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf8c917a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf8c915d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9230f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf8c91970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf8c917a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   181.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.65 ms
whisper_print_timings:   sample time =    65.25 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4660.99 ms /     1 runs ( 4660.99 ms per run)
whisper_print_timings:   decode time =    15.03 ms /     2 runs (    7.52 ms per run)
whisper_print_timings:   batchd time =   707.20 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5648.19 ms
...
main:     load time =    77.92 ms
main:    total time = 39488.91 ms
embd_img
...
main:      load time = 11288.89 ms
main:    sample time =   528.40 ms / 8.26 ms per token
main:      eval time = 43584.86 ms / 622.64 ms per token
main:     total time = 57777.71 ms
...
main:      load time =  3811.89 ms
main:    sample time =   529.18 ms / 8.27 ms per token
main:      eval time = 17843.04 ms / 254.90 ms per token
main:     total time = 23169.21 ms
