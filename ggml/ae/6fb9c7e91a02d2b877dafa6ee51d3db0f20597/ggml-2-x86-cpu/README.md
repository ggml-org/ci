...
- status:  SUCCESS ✅
- runtime: 3:42.91
- date:    Wed Dec 13 17:41:59 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   26.09 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.23 sec
...
main:     load time =   179.70 ms
main:   sample time =    23.39 ms
main:  predict time =   437.00 ms / 6.83 ms per token
main:    total time =   653.22 ms
...
main:     load time =   126.88 ms
main:   sample time =    23.41 ms
main:  predict time =   450.69 ms / 6.44 ms per token
main:    total time =   603.11 ms
...
main:     n_decoded =      504
main:     load time =   104.51 ms
main:   sample time =   177.90 ms
main:  predict time =  1473.67 ms
main:    total time =  1786.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb21379c9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb21361d1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558583bb9ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb21379c050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb2137a1980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558583bba980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fb21361d1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x558583bb9ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558583bbb2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x558583bba980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fb21379c050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558583bbbc60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x558583bbb2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558583bbc5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fb21379c9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x558583bbbc60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558583bbc7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x558583bbc5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fb2137a1980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x558583bbc970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x558583bbc7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   124.44 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.31 ms
whisper_print_timings:   sample time =    55.09 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1155.33 ms /     1 runs ( 1155.33 ms per run)
whisper_print_timings:   decode time =    10.25 ms /     2 runs (    5.13 ms per run)
whisper_print_timings:   batchd time =   206.28 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1571.04 ms
...
main:     load time =    63.79 ms
main:    total time = 10581.00 ms
embd_img
...
main:      load time =  7868.22 ms
main:    sample time =   469.16 ms / 7.33 ms per token
main:      eval time = 20521.30 ms / 293.16 ms per token
main:     total time = 29521.33 ms
...
main:      load time =  1660.51 ms
main:    sample time =   493.47 ms / 7.71 ms per token
main:      eval time =  8837.37 ms / 126.25 ms per token
main:     total time = 11365.14 ms
