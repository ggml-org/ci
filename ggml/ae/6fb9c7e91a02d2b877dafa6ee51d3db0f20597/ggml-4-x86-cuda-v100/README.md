...
- status:  SUCCESS ✅
- runtime: 7:36.27
- date:    Wed Dec 13 17:46:18 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.55 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.00 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   59.59 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  91.87 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    3.26 sec
      Start  7: test0
 7/20 Test  #7: test0 ............................   Passed    0.56 sec
      Start  8: test1
 8/20 Test  #8: test1 ............................   Passed    0.55 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    7.90 sec
      Start 10: test3
...
20/20 Test #20: test-backend-ops .................   Passed   21.53 sec
...
main:     load time =   593.84 ms
main:   sample time =    34.87 ms
main:  predict time =   582.71 ms / 9.10 ms per token
main:    total time =  1234.87 ms
...
main:     load time =   589.69 ms
main:   sample time =    35.08 ms
main:  predict time =   595.38 ms / 8.51 ms per token
main:    total time =  1224.44 ms
...
main:     n_decoded =      504
main:     load time =   553.35 ms
main:   sample time =   233.62 ms
main:  predict time =  2228.45 ms
main:    total time =  3064.03 ms
...
main: loaded model in   402.79 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9ec9db69c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9ec9c371b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563e912e0b00                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9ec9db6050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9ec9dbb980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563e912e18e0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9ec9c371b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563e912e0b00                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563e912e2250                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563e912e18e0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9ec9db6050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563e912e2bc0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563e912e2250                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563e912e3530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9ec9db69c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563e912e2bc0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563e912e3700                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563e912e3530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9ec9dbb980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563e912e38d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563e912e3700       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   547.62 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    18.67 ms
whisper_print_timings:   sample time =    66.20 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    34.38 ms /     1 runs (   34.38 ms per run)
whisper_print_timings:   decode time =    13.49 ms /     2 runs (    6.74 ms per run)
whisper_print_timings:   batchd time =    82.84 ms /   125 runs (    0.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   771.99 ms
...
main:     load time =   490.62 ms
main:    total time =  7886.23 ms
embd_img
...
main:      load time =  7173.93 ms
main:    sample time =   507.49 ms / 7.93 ms per token
main:      eval time = 24592.93 ms / 351.33 ms per token
main:     total time = 33135.57 ms
...
main:      load time =  2025.54 ms
main:    sample time =   516.78 ms / 8.07 ms per token
main:      eval time = 11993.33 ms / 171.33 ms per token
main:     total time = 15229.66 ms
