...
- status:  SUCCESS ✅
- runtime: 2:48.76
- date:    Wed Dec 13 17:29:04 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/19 Test  #7: test1 ............................   Passed    0.00 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed   10.25 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.80 sec
...
main:  predict time =   622.71 ms / 9.73 ms per token
main:    total time =   785.06 ms
...
main:  predict time =   638.47 ms / 9.12 ms per token
main:    total time =   789.64 ms
...
main:  predict time =  2372.14 ms
main:    total time =  2699.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c66a539c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c668d41b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559ca83acba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c66a53050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c66a58980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559ca83ad980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f2c668d41b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x559ca83acba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559ca83ae2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x559ca83ad980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f2c66a53050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559ca83aec60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x559ca83ae2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559ca83af5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f2c66a539c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x559ca83aec60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559ca83af7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x559ca83af5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2c66a58980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x559ca83af970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x559ca83af7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.49 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.14 ms
whisper_print_timings:   sample time =    71.92 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1980.49 ms /     1 runs ( 1980.49 ms per run)
whisper_print_timings:   decode time =    12.34 ms /     2 runs (    6.17 ms per run)
whisper_print_timings:   batchd time =   330.06 ms /   125 runs (    2.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2497.85 ms
...
main:     load time =    73.65 ms
main:    total time = 18759.12 ms
embd_img
