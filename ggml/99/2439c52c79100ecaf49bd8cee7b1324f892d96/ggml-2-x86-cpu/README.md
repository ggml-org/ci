...
- status:  SUCCESS ✅
- runtime: 3:10.63
- date:    Fri Nov 17 12:27:48 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    3.32 sec
...
main:     load time =   181.12 ms
main:   sample time =    23.77 ms
main:  predict time =   436.96 ms / 6.83 ms per token
main:    total time =   654.58 ms
...
main:  predict time =   454.94 ms / 6.50 ms per token
main:    total time =   606.85 ms
...
main:  predict time =  1502.01 ms
main:    total time =  1808.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7febee622960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7febee4a3190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562dfe9cbb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7febee622010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7febee627900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562dfe9cc940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7febee4a3190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562dfe9cbb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562dfe9cd290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x562dfe9cc940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7febee622010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562dfe9cdbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x562dfe9cd290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562dfe9ce530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7febee622960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x562dfe9cdbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x562dfe9ce6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x562dfe9ce530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7febee627900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x562dfe9ce890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x562dfe9ce6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   129.22 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.77 ms
whisper_print_timings:   sample time =    53.25 ms /   131 runs (    0.41 ms per run)
whisper_print_timings:   encode time =  1147.22 ms /     1 runs ( 1147.22 ms per run)
whisper_print_timings:   decode time =     9.48 ms /     2 runs (    4.74 ms per run)
whisper_print_timings:   batchd time =   206.72 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1563.88 ms
...
main:     load time =    62.93 ms
main:    total time = 10447.53 ms
embd_img
...
main:      load time =  9902.82 ms
main:    sample time =   468.11 ms / 7.31 ms per token
main:      eval time = 20194.98 ms / 288.50 ms per token
main:     total time = 31315.34 ms
...
main:      load time =  4380.66 ms
main:    sample time =   464.72 ms / 7.26 ms per token
main:      eval time =  8012.56 ms / 114.47 ms per token
main:     total time = 13231.72 ms
