...
- status:  SUCCESS ✅
- runtime: 4:54.34
- date:    Fri Nov 17 12:29:36 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/992439c52c79100ecaf49bd8cee7b1324f892d96
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    4.30 sec
 ...
 5/17 Test  #5: test-mul-mat2 ....................   Passed    8.53 sec
      Start  6: test0
...
Total Test time (real) =  13.83 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    4.22 sec
      Start  2: test-opt
 ...
 5/18 Test  #5: test-mul-mat0 ....................   Passed    0.55 sec
...
main:     load time =   173.51 ms
main:   sample time =    16.92 ms
main:  predict time =   805.33 ms / 12.58 ms per token
main:    total time =  1019.24 ms
...
main:     load time =   173.11 ms
main:   sample time =    17.22 ms
main:  predict time =   874.60 ms / 12.49 ms per token
main:    total time =  1067.73 ms
...
main:     n_decoded =      504
main:     load time =   145.39 ms
main:   sample time =   126.89 ms
main:  predict time =  5823.10 ms
main:    total time =  6175.83 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb30fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb2f7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab20d1db80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb30fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb30ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab20d1e940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb2f7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab20d1db80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab20d1f290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab20d1e940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb30fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab20d1fbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab20d1f290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab20d20530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb30fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab20d1fbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab20d206e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab20d20530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb30ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab20d20890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab20d206e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   202.46 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.97 ms
whisper_print_timings:   sample time =    64.38 ms /   131 runs (    0.49 ms per run)
whisper_print_timings:   encode time =  4632.06 ms /     1 runs ( 4632.06 ms per run)
whisper_print_timings:   decode time =    15.75 ms /     2 runs (    7.88 ms per run)
whisper_print_timings:   batchd time =   710.29 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5641.80 ms
...
main:     load time =    78.90 ms
main:    total time = 39329.65 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.241000 sec.)
...
main:      load time = 12692.88 ms
main:    sample time =   537.18 ms / 8.39 ms per token
main:      eval time = 43784.55 ms / 625.49 ms per token
main:     total time = 59387.30 ms
...
main:      load time =  4367.87 ms
main:    sample time =   530.31 ms / 8.29 ms per token
main:      eval time = 17831.01 ms / 254.73 ms per token
main:     total time = 23700.19 ms
