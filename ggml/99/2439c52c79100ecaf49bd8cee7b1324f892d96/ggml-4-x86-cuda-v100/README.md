...
- status:  SUCCESS ✅
- runtime: 6:34.66
- date:    Fri Nov 17 12:31:08 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/17 Test  #1: test-grad0 .......................   Passed    6.65 sec
      Start  2: test-quantize-fns
 2/17 Test  #2: test-quantize-fns ................   Passed    0.56 sec
      Start  3: test-quantize-perf
 3/17 Test  #3: test-quantize-perf ...............   Passed    0.79 sec
      Start  4: test-mul-mat0
 4/17 Test  #4: test-mul-mat0 ....................   Passed    1.09 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/18 Test  #1: test-grad0 .......................   Passed    6.61 sec
      Start  2: test-opt
 2/18 Test  #2: test-opt .........................   Passed    3.57 sec
...
12/18 Test #12: test-conv-transpose ..............   Passed    0.55 sec
      Start 13: test-rel-pos
13/18 Test #13: test-rel-pos .....................   Passed    0.52 sec
      Start 14: test-customop
14/18 Test #14: test-customop ....................   Passed    0.54 sec
      Start 15: test-xpos
...
main:     load time =  1565.35 ms
main:   sample time =    34.03 ms
main:  predict time =   588.37 ms / 9.19 ms per token
main:    total time =  2211.25 ms
...
main:     load time =   576.07 ms
main:   sample time =    34.15 ms
main:  predict time =   569.21 ms / 8.13 ms per token
main:    total time =  1183.33 ms
...
main:     n_decoded =      504
main:     load time =   543.30 ms
main:   sample time =   234.62 ms
main:  predict time =  2223.32 ms
main:    total time =  3053.22 ms
...
main: loaded model in   397.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efefc1b7960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efefc038190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b1b28ff7c0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efefc1b7010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efefc1bc900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b1b2900580                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efefc038190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b1b28ff7c0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b1b2900ed0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b1b2900580                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efefc1b7010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b1b2901820                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b1b2900ed0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b1b2902170                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efefc1b7960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b1b2901820                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b1b2902320                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b1b2902170                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efefc1bc900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b1b29024d0                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b1b2902320       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1058.71 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    16.94 ms
whisper_print_timings:   sample time =    74.57 ms /   131 runs (    0.57 ms per run)
whisper_print_timings:   encode time =   512.16 ms /     1 runs (  512.16 ms per run)
whisper_print_timings:   decode time =    15.61 ms /     2 runs (    7.81 ms per run)
whisper_print_timings:   batchd time =   310.37 ms /   125 runs (    2.48 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1995.89 ms
...
main:     load time =   484.18 ms
main:    total time =  7665.76 ms
embd_img
...
main:      load time = 10960.26 ms
main:    sample time =   517.20 ms / 8.08 ms per token
main:      eval time = 24595.11 ms / 351.36 ms per token
main:     total time = 36993.75 ms
...
main:      load time =  6258.01 ms
main:    sample time =   516.44 ms / 8.07 ms per token
main:      eval time = 12315.99 ms / 175.94 ms per token
main:     total time = 19765.64 ms
