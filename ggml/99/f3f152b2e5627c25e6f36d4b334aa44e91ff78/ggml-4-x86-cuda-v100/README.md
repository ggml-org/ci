...
- status:  SUCCESS ✅
- runtime: 8:53.05
- date:    Mon Dec 18 16:55:13 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.54 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    7.98 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   60.03 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 9/20 Test  #9: test2 ............................   Passed    8.02 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    1.14 sec
      Start 11: test-pool
...
20/20 Test #20: test-backend-ops .................   Passed   25.19 sec
...
main:     load time =  1588.06 ms
main:   sample time =    34.47 ms
main:  predict time =   561.19 ms / 8.77 ms per token
main:    total time =  2207.35 ms
...
main:     load time =   580.48 ms
main:   sample time =    34.29 ms
main:  predict time =   594.12 ms / 8.49 ms per token
main:    total time =  1213.09 ms
...
main:     n_decoded =      504
main:     load time =   538.43 ms
main:   sample time =   233.74 ms
main:  predict time =  2183.26 ms
main:    total time =  2999.15 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f53093b69c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f53092371b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9242d8660                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f53093b6050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f53093bb980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c9242d9440                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f53092371b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9242d8660                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c9242d9db0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c9242d9440                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f53093b6050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c9242da720                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c9242d9db0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c9242db090                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f53093b69c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c9242da720                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c9242db260                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c9242db090                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f53093bb980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c9242db430                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c9242db260       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =  1048.81 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.95 ms
whisper_print_timings:   sample time =    65.54 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =    35.39 ms /     1 runs (   35.39 ms per run)
whisper_print_timings:   decode time =    13.55 ms /     2 runs (    6.78 ms per run)
whisper_print_timings:   batchd time =    81.67 ms /   125 runs (    0.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1271.23 ms
...
main:     load time =   517.16 ms
main:    total time =  7934.48 ms
embd_img
...
main:      load time =  8145.01 ms
main:    sample time =   517.09 ms / 8.08 ms per token
main:      eval time = 24896.58 ms / 355.67 ms per token
main:     total time = 34470.80 ms
...
main:      load time =  2062.70 ms
main:    sample time =   517.66 ms / 8.09 ms per token
main:      eval time = 12464.07 ms / 178.06 ms per token
main:     total time = 15686.13 ms
