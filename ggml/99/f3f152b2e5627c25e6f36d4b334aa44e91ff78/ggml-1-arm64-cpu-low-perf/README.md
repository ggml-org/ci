...
- status:  SUCCESS ✅
- runtime: 3:49.64
- date:    Mon Dec 18 04:50:04 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.70 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.53 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.64 sec
      Start 10: test-pool
10/19 Test #10: test-pool ........................   Passed    0.04 sec
...
19/19 Test #19: test-backend-ops .................   Passed   42.35 sec
...
main:     load time =   190.89 ms
main:   sample time =    21.07 ms
main:  predict time =   842.41 ms / 13.16 ms per token
main:    total time =  1076.10 ms
...
main:     load time =   192.26 ms
main:   sample time =    17.59 ms
main:  predict time =   899.73 ms / 12.85 ms per token
...
main:     n_decoded =      504
main:     load time =   163.49 ms
main:   sample time =   130.70 ms
main:  predict time =  6043.14 ms
main:    total time =  6418.99 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8872a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff885ab1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad33caba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8872a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8872f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad33cb980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff885ab1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad33caba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad33cc2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad33cb980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8872a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad33ccc60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad33cc2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad33cd5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8872a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad33ccc60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad33cd7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad33cd5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8872f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad33cd970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad33cd7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   111.97 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.82 ms
whisper_print_timings:   sample time =    66.71 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4687.41 ms /     1 runs ( 4687.41 ms per run)
whisper_print_timings:   decode time =    15.54 ms /     2 runs (    7.77 ms per run)
whisper_print_timings:   batchd time =   841.38 ms /   125 runs (    6.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5742.28 ms
...
main:     load time =   100.06 ms
main:    total time = 40395.27 ms
embd_img
