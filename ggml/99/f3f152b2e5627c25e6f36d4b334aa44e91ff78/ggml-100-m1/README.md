...
- status:  SUCCESS ✅
- runtime: 260.92
- date:    Mon Dec 18 18:49:09 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    1.34 sec
 ...
 4/20 Test  #4: test-mul-mat0 ....................   Passed    0.44 sec
      Start  5: test-blas0
 5/20 Test  #5: test-blas0 .......................   Passed    0.30 sec
...
16/20 Test #16: test-conv1d ......................   Passed    0.31 sec
      Start 17: test-conv2d
17/20 Test #17: test-conv2d ......................   Passed    0.34 sec
      Start 18: test-mul-mat
18/20 Test #18: test-mul-mat .....................   Passed    0.32 sec
      Start 19: test-backend-buffer
19/20 Test #19: test-backend-buffer ..............   Passed    0.29 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed   65.24 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  80.37 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
 ...
 5/21 Test  #5: test-mul-mat0 ....................   Passed    0.38 sec
      Start  6: test-blas0
...
21/21 Test #21: test-backend-ops .................   Passed   13.79 sec
...
main:     load time =   153.29 ms
main:   sample time =     8.94 ms
main:  predict time =   300.10 ms / 4.69 ms per token
main:    total time =   465.38 ms
...
main:     load time =    94.13 ms
main:   sample time =     8.79 ms
main:  predict time =   306.88 ms / 4.38 ms per token
main:    total time =   410.64 ms
...
main:     n_decoded =      504
main:     load time =   115.81 ms
main:   sample time =    65.51 ms
main:  predict time =   763.75 ms
main:    total time =   956.01 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1401879b0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x1400081a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x130018230                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x140187040                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x14018c970                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x130019010                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x1400081a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x130018230                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x130019980                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x130019010                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x140187040                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13001a2f0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x130019980                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13001ac60                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x1401879b0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13001a2f0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13001ae30                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13001ac60                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14018c970                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13001b000                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13001ae30                           node_4
...
whisper_print_timings:     load time =   149.18 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.32 ms
whisper_print_timings:   sample time =   133.95 ms /   131 runs (    1.02 ms per run)
whisper_print_timings:   encode time =   182.39 ms /     1 runs (  182.39 ms per run)
whisper_print_timings:   decode time =    20.46 ms /     2 runs (   10.23 ms per run)
whisper_print_timings:   batchd time =   197.57 ms /   125 runs (    1.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   693.34 ms
...
main:     load time =    76.04 ms
main:    total time =  5477.43 ms
embd_img
