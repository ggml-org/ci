...
- status:  SUCCESS ✅
- runtime: 4:03.71
- date:    Mon Dec 18 16:50:23 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    0.05 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   27.35 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    3.32 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    8.51 sec
...
main:     load time =   193.79 ms
main:   sample time =    23.42 ms
main:  predict time =   438.57 ms / 6.85 ms per token
main:    total time =   668.74 ms
...
main:     load time =   133.15 ms
main:   sample time =    23.65 ms
main:  predict time =   456.67 ms / 6.52 ms per token
main:    total time =   615.79 ms
...
main:  predict time =  1461.50 ms
main:    total time =  1773.98 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9bf11339c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9bf0fb41b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c6e683cba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9bf1133050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9bf1138980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c6e683d980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9bf0fb41b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c6e683cba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c6e683e2f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c6e683d980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9bf1133050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c6e683ec60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c6e683e2f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c6e683f5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9bf11339c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c6e683ec60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c6e683f7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c6e683f5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9bf1138980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c6e683f970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c6e683f7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   123.16 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.24 ms
whisper_print_timings:   sample time =    56.83 ms /   131 runs (    0.43 ms per run)
whisper_print_timings:   encode time =  1162.06 ms /     1 runs ( 1162.06 ms per run)
whisper_print_timings:   decode time =     9.67 ms /     2 runs (    4.83 ms per run)
whisper_print_timings:   batchd time =   214.06 ms /   125 runs (    1.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1584.23 ms
...
main:     load time =    60.13 ms
main:    total time = 10578.72 ms
embd_img
...
main:      load time = 11452.64 ms
main:    sample time =   470.99 ms / 7.36 ms per token
main:      eval time = 20117.61 ms / 287.39 ms per token
main:     total time = 32759.67 ms
...
main:      eval time =  8093.60 ms / 115.62 ms per token
main:     total time = 13338.31 ms
