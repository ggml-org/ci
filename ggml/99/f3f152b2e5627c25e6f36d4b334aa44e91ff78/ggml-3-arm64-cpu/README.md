...
- status:  SUCCESS ✅
- runtime: 5:56.44
- date:    Mon Dec 18 04:52:18 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   34.14 sec
...
20/20 Test #20: test-backend-ops .................   Passed    9.82 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) =  18.41 sec
...
main:     load time =   228.36 ms
main:   sample time =    16.81 ms
main:  predict time =   814.05 ms / 12.72 ms per token
...
main:  predict time =   875.30 ms / 12.50 ms per token
main:    total time =  1069.27 ms
...
main:     n_decoded =      504
main:     load time =   141.56 ms
main:   sample time =   127.71 ms
main:  predict time =  5846.83 ms
main:    total time =  6196.94 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb661a9c0                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb649b1b0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab14147ba0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb661a050                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb661f980                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab14148980                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb649b1b0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab14147ba0                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab141492f0                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab14148980                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb661a050                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab14149c60                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab141492f0                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1414a5d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb661a9c0                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab14149c60                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1414a7a0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab1414a5d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb661f980                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab1414a970                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab1414a7a0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   172.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    65.09 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4656.15 ms /     1 runs ( 4656.15 ms per run)
whisper_print_timings:   decode time =    14.97 ms /     2 runs (    7.49 ms per run)
whisper_print_timings:   batchd time =   707.15 ms /   125 runs (    5.66 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5634.15 ms
...
main:     load time =    76.88 ms
main:    total time = 39480.23 ms
embd_img
...
main:      load time = 12203.85 ms
main:    sample time =   540.65 ms / 8.45 ms per token
main:      eval time = 43516.66 ms / 621.67 ms per token
main:     total time = 58636.91 ms
...
main:      load time =  4348.12 ms
main:    sample time =   525.25 ms / 8.21 ms per token
main:      eval time = 17772.36 ms / 253.89 ms per token
main:     total time = 23630.93 ms
