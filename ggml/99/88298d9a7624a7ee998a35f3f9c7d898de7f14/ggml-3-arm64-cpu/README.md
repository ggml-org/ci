...
- status:  SUCCESS ✅
- runtime: 3:07.61
- date:    Fri May 17 06:12:12 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.82 sec
      Start  2: test-opt
...
main:     load time =   145.32 ms
main:   sample time =    17.08 ms
main:  predict time =   886.95 ms / 13.86 ms per token
main:    total time =  1070.79 ms
...
main:     load time =   141.66 ms
main:   sample time =    16.64 ms
main:  predict time =  1001.78 ms / 14.31 ms per token
main:    total time =  1162.61 ms
...
main:  predict time =  1002.19 ms / 14.32 ms per token
main:    total time =  1195.13 ms
...
main:     n_decoded =      504
main:     load time =   141.18 ms
main:   sample time =   126.65 ms
main:  predict time =  6549.22 ms
main:    total time =  6899.30 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfce53701a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfce536e9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb84136289ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfce53701a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfce53701f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8413628aab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfce536e9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb84136289ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8413628b410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb8413628aab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfce53701a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8413628bd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb8413628b410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8413628c6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfce53701a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb8413628bd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8413628c890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb8413628c6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfce53701f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb8413628ca50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb8413628c890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    97.83 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.30 ms
whisper_print_timings:   sample time =    64.87 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4644.53 ms /     1 runs ( 4644.53 ms per run)
whisper_print_timings:   decode time =    13.66 ms /     2 runs (    6.83 ms per run)
whisper_print_timings:   batchd time =   704.40 ms /   125 runs (    5.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5555.98 ms
...
main:     load time =    83.78 ms
main:    total time = 39883.74 ms
embd_img
