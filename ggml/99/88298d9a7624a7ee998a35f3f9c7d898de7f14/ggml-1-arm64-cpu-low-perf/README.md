...
- status:  SUCCESS ✅
- runtime: 4:02.43
- date:    Fri May 17 06:13:05 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.57 sec
      Start  9: test3
...
main:     load time =   139.16 ms
main:   sample time =    17.04 ms
main:  predict time =   916.71 ms / 14.32 ms per token
main:    total time =  1094.26 ms
...
main:  predict time =  1001.67 ms / 14.31 ms per token
main:    total time =  1161.58 ms
...
main:     load time =   170.81 ms
main:   sample time =    17.19 ms
main:  predict time =  1001.97 ms / 14.31 ms per token
main:    total time =  1193.22 ms
...
main:  predict time =  6482.38 ms
main:    total time =  6836.27 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf547143ca990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf5471424b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc18c9bb13ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf547143ca030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xf547143cf940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc18c9bb14ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xf5471424b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xc18c9bb13ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc18c9bb15410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xc18c9bb14ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xf547143ca030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc18c9bb15d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xc18c9bb15410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc18c9bb166d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xf547143ca990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xc18c9bb15d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc18c9bb16890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xc18c9bb166d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xf547143cf940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xc18c9bb16a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xc18c9bb16890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    97.36 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.26 ms
whisper_print_timings:   sample time =    66.38 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4659.53 ms /     1 runs ( 4659.53 ms per run)
whisper_print_timings:   decode time =    13.95 ms /     2 runs (    6.97 ms per run)
whisper_print_timings:   batchd time =   710.60 ms /   125 runs (    5.68 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5578.53 ms
