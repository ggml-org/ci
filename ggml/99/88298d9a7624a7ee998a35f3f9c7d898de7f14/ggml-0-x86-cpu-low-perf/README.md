...
- status:  SUCCESS ✅
- runtime: 3:28.01
- date:    Fri May 17 06:12:44 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.85 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   29.74 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    2.68 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.08 sec
      Start  3: test-quantize-perf
...
main:  predict time =   718.60 ms / 11.23 ms per token
main:    total time =   862.23 ms
...
main:     load time =   111.98 ms
main:   sample time =    24.05 ms
main:  predict time =   773.18 ms / 11.05 ms per token
...
main:     load time =   128.38 ms
main:   sample time =    24.11 ms
main:  predict time =   779.05 ms / 11.13 ms per token
main:    total time =   934.64 ms
...
main:  predict time =  3175.88 ms
main:    total time =  3503.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f04cc0fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f04cbf7b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x654ea6ef3ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f04cc0fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f04cc0ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x654ea6ef4ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f04cbf7b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x654ea6ef3ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x654ea6ef5410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x654ea6ef4ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f04cc0fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x654ea6ef5d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x654ea6ef5410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x654ea6ef66d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f04cc0fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x654ea6ef5d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x654ea6ef6890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x654ea6ef66d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f04cc0ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x654ea6ef6a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x654ea6ef6890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.04 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.41 ms
whisper_print_timings:   sample time =    72.15 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  2029.36 ms /     1 runs ( 2029.36 ms per run)
whisper_print_timings:   decode time =    14.28 ms /     2 runs (    7.14 ms per run)
whisper_print_timings:   batchd time =   333.40 ms /   125 runs (    2.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2558.70 ms
