...
- status:  SUCCESS ✅
- runtime: 3:23.84
- date:    Sat Dec 23 16:26:30 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   27.22 sec
...
20/20 Test #20: test-backend-ops .................   Passed    7.41 sec
...
main:  predict time =   448.83 ms / 6.41 ms per token
main:    total time =   602.20 ms
...
main:  predict time =  1452.86 ms
main:    total time =  1768.85 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f162fe70990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f162fcf11a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562758afbb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f162fe70030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f162fe75940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562758afc960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f162fcf11a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x562758afbb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562758afd2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x562758afc960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f162fe70030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562758afdc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x562758afd2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562758afe580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f162fe70990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x562758afdc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562758afe740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x562758afe580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f162fe75940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x562758afe900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x562758afe740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    76.76 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.55 ms
whisper_print_timings:   sample time =    54.54 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1164.13 ms /     1 runs ( 1164.13 ms per run)
whisper_print_timings:   decode time =     9.13 ms /     2 runs (    4.56 ms per run)
whisper_print_timings:   batchd time =   205.97 ms /   125 runs (    1.65 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1529.48 ms
...
main:      load time =  4373.95 ms
main:    sample time =   467.98 ms / 7.31 ms per token
main:      eval time = 19378.54 ms / 276.84 ms per token
main:     total time = 24857.06 ms
...
main:      load time =  1191.53 ms
main:    sample time =   466.12 ms / 7.28 ms per token
main:      eval time =  8068.02 ms / 115.26 ms per token
main:     total time = 10101.32 ms
