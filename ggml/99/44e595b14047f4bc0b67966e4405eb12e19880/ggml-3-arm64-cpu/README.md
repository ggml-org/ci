...
- status:  SUCCESS ✅
- runtime: 5:41.34
- date:    Sat Dec 23 04:43:31 PM UTC 2023
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/9944e595b14047f4bc0b67966e4405eb12e19880
...
19/19 Test #19: test-backend-ops .................   Passed   34.40 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.17 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    2.05 sec
...
20/20 Test #20: test-backend-ops .................   Passed   10.12 sec
...
main:     load time =   180.72 ms
main:   sample time =    16.89 ms
main:  predict time =   807.22 ms / 12.61 ms per token
main:    total time =  1027.15 ms
...
main:     load time =   179.52 ms
main:   sample time =    16.93 ms
main:  predict time =   879.17 ms / 12.56 ms per token
main:    total time =  1078.57 ms
...
main:     n_decoded =      504
main:     load time =   150.87 ms
main:   sample time =   128.22 ms
main:  predict time =  5874.20 ms
main:    total time =  6234.59 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa047a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa02fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4143b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa047a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa047f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad4144960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa02fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4143b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad41452c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad4144960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa047a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad4145c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad41452c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad4146580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa047a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad4145c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad4146740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad4146580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa047f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad4146900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad4146740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   182.14 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.34 ms
whisper_print_timings:   sample time =    65.67 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4659.16 ms /     1 runs ( 4659.16 ms per run)
whisper_print_timings:   decode time =    15.59 ms /     2 runs (    7.79 ms per run)
whisper_print_timings:   batchd time =   708.59 ms /   125 runs (    5.67 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5649.63 ms
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.234000 sec.)
...
main:      load time = 11692.14 ms
main:    sample time =   519.17 ms / 8.11 ms per token
main:      eval time = 43525.40 ms / 621.79 ms per token
main:     total time = 58112.37 ms
...
main:      load time =  4374.43 ms
main:    sample time =   518.52 ms / 8.10 ms per token
main:      eval time = 17546.42 ms / 250.66 ms per token
main:     total time = 23433.38 ms
