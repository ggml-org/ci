...
- status:  SUCCESS ✅
- runtime: 3:34.98
- date:    Sat Dec 23 04:22:16 PM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   42.60 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.33 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    8.91 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   10.06 sec
...
main:     load time =   193.64 ms
main:   sample time =    19.76 ms
main:  predict time =   976.91 ms / 15.26 ms per token
main:    total time =  1212.32 ms
...
main:     load time =   193.69 ms
main:   sample time =    17.66 ms
main:  predict time =   906.63 ms / 12.95 ms per token
main:    total time =  1120.78 ms
...
main:     n_decoded =      504
main:     load time =   169.00 ms
main:   sample time =   129.02 ms
main:  predict time =  6060.63 ms
main:    total time =  6440.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbb51a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb39b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae57cdb90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbb51a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbb51f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae57ce960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffbb39b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae57cdb90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae57cf2c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae57ce960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffbb51a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae57cfc20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae57cf2c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae57d0580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffbb51a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae57cfc20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae57d0740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae57d0580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffbb51f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae57d0900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae57d0740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.06 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.57 ms
whisper_print_timings:   sample time =    66.85 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4824.01 ms /     1 runs ( 4824.01 ms per run)
whisper_print_timings:   decode time =    16.57 ms /     2 runs (    8.29 ms per run)
whisper_print_timings:   batchd time =   714.37 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5753.83 ms
...
main:     load time =    99.42 ms
main:    total time = 40392.19 ms
embd_img
