...
- status:  SUCCESS ✅
- runtime: 2:49.25
- date:    Sat Dec 23 16:21:24 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.74 sec
...
19/19 Test #19: test-backend-ops .................   Passed   34.81 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    7.92 sec
...
main:  predict time =   623.62 ms / 9.74 ms per token
main:    total time =   791.68 ms
...
main:  predict time =   626.85 ms / 8.95 ms per token
main:    total time =   783.37 ms
...
main:  predict time =  2414.68 ms
main:    total time =  2745.67 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9d35f34990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9d35db51a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b4b8650b90                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9d35f34030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9d35f39940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b4b8651960                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f9d35db51a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b4b8650b90                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b4b86522c0                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55b4b8651960                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f9d35f34030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b4b8652c20                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55b4b86522c0                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b4b8653580                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f9d35f34990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55b4b8652c20                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b4b8653740                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55b4b8653580                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f9d35f39940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55b4b8653900                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55b4b8653740       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.87 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.59 ms
whisper_print_timings:   sample time =    71.58 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1999.41 ms /     1 runs ( 1999.41 ms per run)
whisper_print_timings:   decode time =    12.66 ms /     2 runs (    6.33 ms per run)
whisper_print_timings:   batchd time =   323.27 ms /   125 runs (    2.59 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2512.80 ms
