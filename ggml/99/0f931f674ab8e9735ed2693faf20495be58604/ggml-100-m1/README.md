...
- status:  SUCCESS ✅
- runtime: 330.34
- date:    Thu Dec  7 10:55:18 EET 2023
...
Test project /Users/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    1.78 sec
      Start  2: test-quantize-fns
 2/20 Test  #2: test-quantize-fns ................   Passed    0.46 sec
 ...
 6/20 Test  #6: test-mul-mat2 ....................   Passed    9.05 sec
      Start  7: test0
 7/20 Test  #7: test0 ............................   Passed    0.37 sec
      Start  8: test1
 8/20 Test  #8: test1 ............................   Passed    0.41 sec
      Start  9: test2
 9/20 Test  #9: test2 ............................   Passed    0.39 sec
      Start 10: test3
10/20 Test #10: test3 ............................   Passed    0.41 sec
      Start 11: test-pool
11/20 Test #11: test-pool ........................   Passed    0.40 sec
...
14/20 Test #14: test-customop ....................   Passed    0.40 sec
      Start 15: test-xpos
15/20 Test #15: test-xpos ........................   Passed    0.36 sec
      Start 16: test-conv1d
16/20 Test #16: test-conv1d ......................   Passed    0.44 sec
      Start 17: test-conv2d
17/20 Test #17: test-conv2d ......................   Passed    0.48 sec
      Start 18: test-mul-mat
18/20 Test #18: test-mul-mat .....................   Passed    0.45 sec
      Start 19: test-backend-buffer
19/20 Test #19: test-backend-buffer ..............   Passed    0.42 sec
      Start 20: test-backend-ops
20/20 Test #20: test-backend-ops .................   Passed  129.69 sec

100% tests passed, 0 tests failed out of 20

Total Test time (real) = 147.85 sec
...
Test project /Users/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    1.26 sec
      Start  2: test-opt
...
main:  predict time =   301.65 ms / 4.71 ms per token
main:    total time =   464.37 ms
...
main:     load time =    96.56 ms
main:   sample time =     8.81 ms
main:  predict time =   308.30 ms / 4.40 ms per token
main:    total time =   414.53 ms
...
main:   sample time =    65.81 ms
main:  predict time =   760.37 ms
main:    total time =   952.64 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x140187950                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x140008180                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x130018210                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x140187000                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40      0x14018c8f0                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x130018fd0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000      0x140008180                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136      0x130018210                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x130019920                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000      0x130018fd0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000      0x140187000                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13001a270                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000      0x130019920                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13001abc0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000      0x140187950                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000      0x13001a270                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13001ad70                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40      0x13001abc0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40      0x14018c8f0                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40      0x13001af20                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40      0x13001ad70                           node_4
...
ggml_metal_init: error: Error Domain=NSCocoaErrorDomain Code=260 "The file “ggml-metal.metal” couldn’t be opened because there is no such file." UserInfo={NSFilePath=ggml-metal.metal, NSUnderlyingError=0x6000023d9c80 {Error Domain=NSPOSIXErrorDomain Code=2 "No such file or directory"}}
...
ggml_metal_init: error: could not use bundle path to find ggml-metal.metal, falling back to trying cwd
ggml_metal_init: loading 'ggml-metal.metal'
ggml_metal_init: error: Error Domain=NSCocoaErrorDomain Code=260 "The file “ggml-metal.metal” couldn’t be opened because there is no such file." UserInfo={NSFilePath=ggml-metal.metal, NSUnderlyingError=0x6000023d75a0 {Error Domain=NSPOSIXErrorDomain Code=2 "No such file or directory"}}
whisper_backend_init: ggml_backend_metal_init() failed
...
whisper_print_timings:     load time =   140.09 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =     6.32 ms
whisper_print_timings:   sample time =    33.74 ms /   131 runs (    0.26 ms per run)
whisper_print_timings:   encode time =   554.85 ms /     1 runs (  554.85 ms per run)
whisper_print_timings:   decode time =     5.56 ms /     2 runs (    2.78 ms per run)
whisper_print_timings:   batchd time =   102.24 ms /   125 runs (    0.82 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   844.84 ms
...
main:     load time =    70.61 ms
main:    total time =  5005.46 ms
embd_img
