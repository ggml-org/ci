...
- status:  SUCCESS ✅
- runtime: 3:37.97
- date:    Thu Dec  7 08:55:25 UTC 2023
...
main:  predict time =   437.74 ms / 6.84 ms per token
main:    total time =   595.72 ms
...
main:     load time =   124.07 ms
main:   sample time =    23.36 ms
main:  predict time =   450.61 ms / 6.44 ms per token
main:    total time =   600.11 ms
...
main:   sample time =   177.37 ms
main:  predict time =  1465.34 ms
main:    total time =  1775.82 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91f0f4d960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91f0dce190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9358f8b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91f0f4d010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91f0f52900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c9358f9940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f91f0dce190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9358f8b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c9358fa290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c9358f9940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f91f0f4d010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c9358fabe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c9358fa290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c9358fb530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f91f0f4d960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c9358fabe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c9358fb6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c9358fb530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f91f0f52900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c9358fb890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c9358fb6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.17 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.08 ms
whisper_print_timings:   sample time =    54.91 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1138.66 ms /     1 runs ( 1138.66 ms per run)
whisper_print_timings:   decode time =     9.70 ms /     2 runs (    4.85 ms per run)
whisper_print_timings:   batchd time =   203.38 ms /   125 runs (    1.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1500.03 ms
...
main:      load time =  4264.03 ms
main:    sample time =   470.67 ms / 7.35 ms per token
main:      eval time = 19079.17 ms / 272.56 ms per token
main:     total time = 24451.40 ms
...
main:      load time =  1191.69 ms
main:    sample time =   466.00 ms / 7.28 ms per token
main:      eval time =  8033.57 ms / 114.77 ms per token
main:     total time = 10065.54 ms
