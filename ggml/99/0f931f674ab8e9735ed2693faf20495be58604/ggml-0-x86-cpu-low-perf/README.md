...
- status:  SUCCESS ✅
- runtime: 3:06.66
- date:    Thu Dec  7 08:55:00 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 4/19 Test  #4: test-mul-mat0 ....................   Passed    0.60 sec
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.92 sec
      Start  9: test3
...
19/19 Test #19: test-backend-ops .................   Passed   51.28 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  74.71 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.24 sec
      Start  2: test-quantize-fns
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    9.61 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  29.05 sec
...
main:     load time =   125.20 ms
main:   sample time =    23.44 ms
main:  predict time =   602.30 ms / 9.41 ms per token
main:    total time =   763.60 ms
...
main:     load time =   123.46 ms
main:   sample time =    23.45 ms
main:  predict time =   627.46 ms / 8.96 ms per token
main:    total time =   776.50 ms
...
main:  predict time =  2365.20 ms
main:    total time =  2690.63 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7facad725960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7facad5a6190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c0cce31b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7facad725010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7facad72a900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c0cce32940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7facad5a6190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c0cce31b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c0cce33290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c0cce32940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7facad725010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c0cce33be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c0cce33290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c0cce34530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7facad725960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c0cce33be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c0cce346e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c0cce34530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7facad72a900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c0cce34890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c0cce346e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    73.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.17 ms
whisper_print_timings:   sample time =    71.33 ms /   131 runs (    0.54 ms per run)
whisper_print_timings:   encode time =  1979.46 ms /     1 runs ( 1979.46 ms per run)
whisper_print_timings:   decode time =    12.56 ms /     2 runs (    6.28 ms per run)
whisper_print_timings:   batchd time =   322.34 ms /   125 runs (    2.58 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2485.50 ms
...
main:     load time =    67.36 ms
main:    total time = 18681.25 ms
embd_img
