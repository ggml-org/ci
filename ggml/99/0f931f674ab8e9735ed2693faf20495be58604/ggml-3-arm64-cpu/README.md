...
- status:  SUCCESS ✅
- runtime: 5:27.93
- date:    Thu Dec  7 08:57:20 AM UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed   47.10 sec
...
20/20 Test #20: test-backend-ops .................   Passed   12.22 sec
...
main:  predict time =   813.83 ms / 12.72 ms per token
main:    total time =  1038.21 ms
...
main:  predict time =  5846.33 ms
main:    total time =  6207.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e0ba960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9df3b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf03bcb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e0ba010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e0bf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf03bd940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9df3b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaf03bcb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf03be290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaf03bd940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9e0ba010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf03bebe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaf03be290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf03bf530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9e0ba960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaf03bebe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf03bf6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaf03bf530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9e0bf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaf03bf890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaf03bf6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   109.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.28 ms
whisper_print_timings:   sample time =    66.15 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4647.35 ms /     1 runs ( 4647.35 ms per run)
whisper_print_timings:   decode time =    15.80 ms /     2 runs (    7.90 ms per run)
whisper_print_timings:   batchd time =   711.59 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5569.44 ms
...
main:      load time =  5581.83 ms
main:    sample time =   534.35 ms / 8.35 ms per token
main:      eval time = 43465.01 ms / 620.93 ms per token
main:     total time = 51954.46 ms
...
main:      load time =  1512.21 ms
main:    sample time =   527.62 ms / 8.24 ms per token
main:      eval time = 17718.51 ms / 253.12 ms per token
main:     total time = 20728.74 ms
