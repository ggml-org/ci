...
- status:  SUCCESS ✅
- runtime: 3:49.27
- date:    Thu Dec  7 08:55:43 AM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.36 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.70 sec
      Start  2: test-quantize-fns
 ...
 7/19 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/19 Test  #8: test2 ............................   Passed    9.18 sec
      Start  9: test3
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed   12.86 sec
...
main:     load time =   194.31 ms
main:   sample time =    17.92 ms
main:  predict time =   857.89 ms / 13.40 ms per token
main:    total time =  1092.36 ms
...
main:     n_decoded =      504
main:     load time =   163.10 ms
main:   sample time =   129.61 ms
main:  predict time =  6054.29 ms
main:    total time =  6428.52 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e9fa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e87b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab84a3b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e9fa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e9ff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaab84a4940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff8e87b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab84a3b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaab84a5290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaab84a4940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff8e9fa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaab84a5be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaab84a5290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaab84a6530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff8e9fa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaab84a5be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaab84a66e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaab84a6530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff8e9ff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaab84a6890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaab84a66e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   108.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    15.54 ms
whisper_print_timings:   sample time =    66.99 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4767.89 ms /     1 runs ( 4767.89 ms per run)
whisper_print_timings:   decode time =    16.12 ms /     2 runs (    8.06 ms per run)
whisper_print_timings:   batchd time =   722.27 ms /   125 runs (    5.78 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5702.79 ms
