...
- status:  SUCCESS ✅
- runtime: 2:57.32
- date:    Fri Mar 15 12:26:25 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   26.55 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   13.80 sec
...
main:  predict time =   894.89 ms / 13.98 ms per token
main:    total time =  1084.15 ms
...
main:     load time =   144.58 ms
main:   sample time =    17.47 ms
main:  predict time =   973.79 ms / 13.91 ms per token
main:    total time =  1138.57 ms
...
main:     load time =   172.70 ms
main:   sample time =    17.60 ms
main:  predict time =   987.38 ms / 14.11 ms per token
main:    total time =  1181.56 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f11a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7ef9b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2cbfce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f11a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f11f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae2cc0ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff7ef9b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae2cbfce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae2cc1410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaae2cc0ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff7f11a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae2cc1d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaae2cc1410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae2cc26d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff7f11a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaae2cc1d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae2cc2890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaae2cc26d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff7f11f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaae2cc2a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaae2cc2890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   102.87 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.32 ms
whisper_print_timings:   sample time =    65.29 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4686.55 ms /     1 runs ( 4686.55 ms per run)
whisper_print_timings:   decode time =    15.47 ms /     2 runs (    7.74 ms per run)
whisper_print_timings:   batchd time =   711.67 ms /   125 runs (    5.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5600.55 ms
