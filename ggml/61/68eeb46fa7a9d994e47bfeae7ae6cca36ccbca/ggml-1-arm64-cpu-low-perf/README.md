...
- status:  SUCCESS ✅
- runtime: 3:59.13
- date:    Fri Mar 15 12:27:12 PM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 5/22 Test  #5: test-mul-mat2 ....................   Passed    8.72 sec
      Start  6: test0
 6/22 Test  #6: test0 ............................   Passed    0.01 sec
      Start  7: test1
 7/22 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/22 Test  #8: test2 ............................   Passed   21.46 sec
      Start  9: test3
...
Total Test time (real) =  74.61 sec
...
main:     load time =   166.69 ms
main:   sample time =    20.57 ms
main:  predict time =   987.66 ms / 15.43 ms per token
main:    total time =  1197.14 ms
...
main:     load time =   170.42 ms
main:   sample time =    19.40 ms
main:  predict time =  1023.20 ms / 14.62 ms per token
main:    total time =  1216.08 ms
...
main:     load time =   202.97 ms
main:   sample time =    18.73 ms
main:  predict time =  1052.98 ms / 15.04 ms per token
main:    total time =  1279.01 ms
...
main:     n_decoded =      504
main:     load time =   166.70 ms
main:   sample time =   130.23 ms
main:  predict time =  6611.24 ms
main:    total time =  6990.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9243a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff922bb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4140ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9243a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9243f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad4141ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff922bb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad4140ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad4142410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad4141ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9243a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad4142d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad4142410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad41436d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9243a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad4142d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad4143890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad41436d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9243f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad4143a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad4143890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   117.07 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.17 ms
whisper_print_timings:   sample time =    67.65 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4776.58 ms /     1 runs ( 4776.58 ms per run)
whisper_print_timings:   decode time =    16.33 ms /     2 runs (    8.17 ms per run)
whisper_print_timings:   batchd time =   720.75 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5717.28 ms
