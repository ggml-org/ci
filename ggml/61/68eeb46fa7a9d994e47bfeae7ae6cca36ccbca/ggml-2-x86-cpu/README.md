...
- status:  SUCCESS ✅
- runtime: 2:00.37
- date:    Fri Mar 15 12:25:27 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   24.36 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/23 Test  #1: test-grad0 .......................   Passed    2.38 sec
      Start  2: test-opt
 2/23 Test  #2: test-opt .........................   Passed    1.67 sec
      Start  3: test-quantize-fns
 3/23 Test  #3: test-quantize-fns ................   Passed   13.25 sec
      Start  4: test-quantize-perf
 4/23 Test  #4: test-quantize-perf ...............   Passed    4.54 sec
...
main:     load time =   106.94 ms
main:   sample time =    23.54 ms
main:  predict time =   494.86 ms / 7.73 ms per token
main:    total time =   637.82 ms
...
main:     load time =   107.33 ms
main:   sample time =    23.47 ms
main:  predict time =   514.83 ms / 7.35 ms per token
main:    total time =   647.56 ms
...
main:     load time =   124.03 ms
main:   sample time =    23.70 ms
main:  predict time =   539.86 ms / 7.71 ms per token
main:    total time =   691.20 ms
...
main:   sample time =   175.10 ms
main:  predict time =  1867.57 ms
main:    total time =  2181.68 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbd2acab990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbd2ab2c1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f414bb2ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbd2acab030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbd2acb0940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f414bb3ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7fbd2ab2c1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55f414bb2ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f414bb4410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x55f414bb3ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7fbd2acab030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f414bb4d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x55f414bb4410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f414bb56d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7fbd2acab990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x55f414bb4d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f414bb5890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x55f414bb56d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7fbd2acb0940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x55f414bb5a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x55f414bb5890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    74.35 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.84 ms
whisper_print_timings:   sample time =    54.94 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1182.78 ms /     1 runs ( 1182.78 ms per run)
whisper_print_timings:   decode time =    12.13 ms /     2 runs (    6.07 ms per run)
whisper_print_timings:   batchd time =   211.68 ms /   125 runs (    1.69 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1555.75 ms
...
main:     load time =    66.31 ms
main:    total time = 10718.49 ms
embd_img
