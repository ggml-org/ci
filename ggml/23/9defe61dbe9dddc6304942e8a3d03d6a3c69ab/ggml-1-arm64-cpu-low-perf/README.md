...
- status:  SUCCESS ✅
- runtime: 2:35.01
- date:    Fri Nov  3 08:29:19 PM UTC 2023
...
main:  predict time =   822.72 ms / 12.86 ms per token
main:    total time =  1053.10 ms
...
main:  predict time =   891.39 ms / 12.73 ms per token
main:    total time =  1100.30 ms
...
main:     n_decoded =      504
main:     load time =   158.95 ms
main:   sample time =   131.16 ms
main:  predict time =  5988.29 ms
main:    total time =  6384.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6cca960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6b4b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad873bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6cca010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6ccf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad873c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa6b4b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad873bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad873d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaad873c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa6cca010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad873dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaad873d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad873e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa6cca960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaad873dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad873e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaad873e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa6ccf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaad873e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaad873e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   118.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.73 ms
whisper_print_timings:   sample time =    22.76 ms /    27 runs (    0.84 ms per run)
whisper_print_timings:   encode time =  4761.12 ms /     1 runs ( 4761.12 ms per run)
whisper_print_timings:   decode time =   181.22 ms /    27 runs (    6.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5147.35 ms
