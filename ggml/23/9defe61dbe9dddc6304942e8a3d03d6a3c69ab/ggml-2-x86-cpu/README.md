...
- status:  SUCCESS ✅
- runtime: 3:04.03
- date:    Fri Nov  3 20:29:42 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    3.13 sec
      Start  2: test-opt
...
main:     load time =   180.82 ms
main:   sample time =    23.85 ms
main:  predict time =   442.25 ms / 6.91 ms per token
main:    total time =   659.26 ms
...
main:  predict time =   457.72 ms / 6.54 ms per token
main:    total time =   605.88 ms
...
main:   sample time =   177.84 ms
main:  predict time =  1477.91 ms
main:    total time =  1792.36 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7edc6e1960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7edc562190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9e2a50b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7edc6e1010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7edc6e6900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c9e2a51940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f7edc562190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55c9e2a50b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c9e2a52290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55c9e2a51940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f7edc6e1010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c9e2a52be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55c9e2a52290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c9e2a53530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f7edc6e1960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55c9e2a52be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c9e2a536e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55c9e2a53530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f7edc6e6900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55c9e2a53890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55c9e2a536e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   131.37 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.78 ms
whisper_print_timings:   sample time =    16.41 ms /    27 runs (    0.61 ms per run)
whisper_print_timings:   encode time =  1136.27 ms /     1 runs ( 1136.27 ms per run)
whisper_print_timings:   decode time =    92.19 ms /    27 runs (    3.41 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1425.63 ms
...
main:     load time =    62.28 ms
main:    total time = 10463.06 ms
embd_img
...
main:      load time =  5532.79 ms
main:    sample time =   470.19 ms / 7.35 ms per token
main:      eval time = 20546.04 ms / 293.51 ms per token
main:     total time = 27216.48 ms
...
main:      load time =  1188.70 ms
main:    sample time =   466.36 ms / 7.29 ms per token
main:      eval time =  8876.34 ms / 126.80 ms per token
main:     total time = 10897.25 ms
