...
- status:  SUCCESS ✅
- runtime: 4:38.29
- date:    Fri Nov  3 08:31:22 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    4.14 sec
      Start  2: test-opt
...
main:     load time =   231.65 ms
main:   sample time =    17.06 ms
main:  predict time =   810.39 ms / 12.66 ms per token
main:    total time =  1081.30 ms
...
main:     load time =   175.39 ms
main:   sample time =    16.86 ms
main:  predict time =   875.64 ms / 12.51 ms per token
...
main:  predict time =  5826.30 ms
main:    total time =  6181.73 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9caaa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c92b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab01431b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9caaa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9caaf900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab01432940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9c92b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaab01431b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab01433290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaab01432940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9caaa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab01433be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaab01433290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab01434530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9caaa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaab01433be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab014346e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaab01434530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9caaf900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaab01434890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaab014346e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   205.38 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.00 ms
whisper_print_timings:   sample time =    20.90 ms /    27 runs (    0.77 ms per run)
whisper_print_timings:   encode time =  4604.98 ms /     1 runs ( 4604.98 ms per run)
whisper_print_timings:   decode time =   173.54 ms /    27 runs (    6.43 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5068.53 ms
...
main:     load time =    86.11 ms
main:    total time = 39272.38 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.237000 sec.)
...
main:      load time =  5921.21 ms
main:    sample time =   534.72 ms / 8.36 ms per token
main:      eval time = 43632.67 ms / 623.32 ms per token
main:     total time = 52457.06 ms
...
main:      load time =  1472.29 ms
main:    sample time =   527.59 ms / 8.24 ms per token
main:      eval time = 17446.64 ms / 249.24 ms per token
main:     total time = 20393.44 ms
