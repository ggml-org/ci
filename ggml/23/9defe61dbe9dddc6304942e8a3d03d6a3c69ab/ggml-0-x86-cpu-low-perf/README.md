...
- status:  SUCCESS ✅
- runtime: 2:02.46
- date:    Fri Nov  3 20:28:45 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.23 sec
...
main:  predict time =   600.96 ms / 9.39 ms per token
main:    total time =   763.43 ms
...
main:     load time =   128.79 ms
main:   sample time =    23.87 ms
main:  predict time =   752.25 ms / 10.75 ms per token
main:    total time =   906.95 ms
...
main:  predict time =  2368.39 ms
main:    total time =  2694.45 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f287342b960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f28732ac190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563f7d3b7b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f287342b010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2873430900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563f7d3b8940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f28732ac190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x563f7d3b7b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563f7d3b9290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x563f7d3b8940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f287342b010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563f7d3b9be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x563f7d3b9290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563f7d3ba530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f287342b960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x563f7d3b9be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563f7d3ba6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x563f7d3ba530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f2873430900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x563f7d3ba890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x563f7d3ba6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    82.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    21.17 ms
whisper_print_timings:   sample time =    16.10 ms /    27 runs (    0.60 ms per run)
whisper_print_timings:   encode time =  2048.39 ms /     1 runs ( 2048.39 ms per run)
whisper_print_timings:   decode time =   129.67 ms /    27 runs (    4.80 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2334.72 ms
