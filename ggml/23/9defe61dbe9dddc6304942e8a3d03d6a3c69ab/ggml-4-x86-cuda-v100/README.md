...
- status:  SUCCESS ✅
- runtime: 5:50.95
- date:    Fri Nov  3 20:32:29 UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/14 Test  #1: test-grad0 .......................   Passed    5.76 sec
 ...
 7/14 Test  #7: test1 ............................   Passed    0.01 sec
      Start  8: test2
 8/14 Test  #8: test2 ............................   Passed    7.23 sec
      Start  9: test3
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/15 Test  #1: test-grad0 .......................   Passed    5.95 sec
      Start  2: test-opt
...
main:  predict time =   577.43 ms / 9.02 ms per token
main:    total time =   817.64 ms
...
main:  predict time =   639.46 ms / 9.14 ms per token
main:    total time =   860.84 ms
...
main:     n_decoded =      504
main:     load time =   150.64 ms
main:   sample time =   233.26 ms
main:  predict time =  2284.06 ms
main:    total time =  2711.24 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f87aeefa960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f87aed7b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564d92291b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f87aeefa010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f87aeeff900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564d92292940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f87aed7b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x564d92291b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564d92293290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x564d92292940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f87aeefa010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564d92293be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x564d92293290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564d92294530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f87aeefa960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x564d92293be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564d922946e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x564d92294530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f87aeeff900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x564d92294890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x564d922946e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   752.57 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.79 ms
whisper_print_timings:   sample time =    21.03 ms /    27 runs (    0.78 ms per run)
whisper_print_timings:   encode time =  1871.46 ms /     1 runs ( 1871.46 ms per run)
whisper_print_timings:   decode time =   136.89 ms /    27 runs (    5.07 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2860.04 ms
...
main:      load time = 24649.65 ms
main:    sample time =   578.04 ms / 9.03 ms per token
main:      eval time = 25298.09 ms / 361.40 ms per token
main:     total time = 51423.83 ms
...
main:      load time = 13655.15 ms
main:    sample time =   573.68 ms / 8.96 ms per token
main:      eval time = 12761.32 ms / 182.30 ms per token
main:     total time = 27650.02 ms
