...
- status:  SUCCESS ✅
- runtime: 2:40.57
- date:    Thu Nov 30 02:38:55 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    5.75 sec
 ...
 8/19 Test  #8: test2 ............................   Passed    8.63 sec
      Start  9: test3
 9/19 Test  #9: test3 ............................   Passed    0.48 sec
      Start 10: test-pool
...
19/19 Test #19: test-backend-ops .................   Passed    1.45 sec
...
main:  predict time =   825.52 ms / 12.90 ms per token
...
main:  predict time =   895.87 ms / 12.80 ms per token
...
main:  predict time =  5984.65 ms
main:    total time =  6354.89 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8c0a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8a8b190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaee8dcb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8c0a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8c0f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaee8dd940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffb8a8b190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaaee8dcb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaee8de290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaaee8dd940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffb8c0a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaee8debe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaaee8de290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaee8df530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffb8c0a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaaee8debe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaee8df6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaaee8df530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffb8c0f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaaee8df890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaaee8df6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   114.63 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.73 ms
whisper_print_timings:   sample time =    65.20 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4757.43 ms /     1 runs ( 4757.43 ms per run)
whisper_print_timings:   decode time =    15.58 ms /     2 runs (    7.79 ms per run)
whisper_print_timings:   batchd time =   721.80 ms /   125 runs (    5.77 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5692.54 ms
