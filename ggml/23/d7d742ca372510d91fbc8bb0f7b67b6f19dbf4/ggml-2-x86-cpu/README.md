...
- status:  SUCCESS ✅
- runtime: 3:02.42
- date:    Thu Nov 30 14:39:07 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    0.88 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/20 Test  #1: test-grad0 .......................   Passed    3.25 sec
      Start  2: test-opt
 2/20 Test  #2: test-opt .........................   Passed    1.67 sec
...
main:  predict time =   446.53 ms / 6.98 ms per token
main:    total time =   610.19 ms
...
main:     load time =   122.95 ms
main:   sample time =    23.74 ms
main:  predict time =   450.20 ms / 6.43 ms per token
...
main:   sample time =   175.35 ms
main:  predict time =  1468.11 ms
main:    total time =  1780.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efc93835960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efc936b6190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b403c71b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efc93835010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7efc9383a900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b403c72940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7efc936b6190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b403c71b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b403c73290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b403c72940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7efc93835010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b403c73be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b403c73290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b403c74530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7efc93835960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b403c73be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b403c746e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b403c74530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7efc9383a900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b403c74890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b403c746e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    78.96 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.56 ms
whisper_print_timings:   sample time =    55.58 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1147.65 ms /     1 runs ( 1147.65 ms per run)
whisper_print_timings:   decode time =     9.74 ms /     2 runs (    4.87 ms per run)
whisper_print_timings:   batchd time =   222.53 ms /   125 runs (    1.78 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1532.30 ms
...
main:     load time =    71.82 ms
main:    total time = 10488.48 ms
embd_img
...
main:      load time =  8099.64 ms
main:    sample time =   468.53 ms / 7.32 ms per token
main:      eval time = 19903.77 ms / 284.34 ms per token
main:     total time = 29159.62 ms
...
main:      load time =  4373.11 ms
main:    sample time =   464.08 ms / 7.25 ms per token
main:      eval time =  8043.08 ms / 114.90 ms per token
main:     total time = 13251.14 ms
