...
- status:  SUCCESS ✅
- runtime: 2:06.16
- date:    Thu Nov 30 14:38:17 UTC 2023
...
19/19 Test #19: test-backend-ops .................   Passed    0.95 sec

100% tests passed, 0 tests failed out of 19

Total Test time (real) =  23.96 sec
...
18/19 Test #18: test-backend-buffer ..............   Passed    0.00 sec
      Start 19: test-backend-ops
19/19 Test #19: test-backend-ops .................   Passed    0.18 sec
...
main:  predict time =   623.83 ms / 9.75 ms per token
main:    total time =   789.38 ms
...
main:  predict time =  2373.55 ms
main:    total time =  2698.71 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffb106fb960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffb1057c190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b6ef5d1b80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffb106fb010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffb10700900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b6ef5d2940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7ffb1057c190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x55b6ef5d1b80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b6ef5d3290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0x55b6ef5d2940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7ffb106fb010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b6ef5d3be0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0x55b6ef5d3290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b6ef5d4530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7ffb106fb960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0x55b6ef5d3be0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b6ef5d46e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0x55b6ef5d4530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7ffb10700900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0x55b6ef5d4890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0x55b6ef5d46e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    82.67 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    20.45 ms
whisper_print_timings:   sample time =    71.42 ms /   131 runs (    0.55 ms per run)
whisper_print_timings:   encode time =  1978.86 ms /     1 runs ( 1978.86 ms per run)
whisper_print_timings:   decode time =    12.64 ms /     2 runs (    6.32 ms per run)
whisper_print_timings:   batchd time =   328.64 ms /   125 runs (    2.63 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  2499.12 ms
...
main:     load time =    70.14 ms
main:    total time = 18708.58 ms
embd_img
