...
- status:  SUCCESS ✅
- runtime: 4:32.39
- date:    Thu Nov 30 02:40:45 PM UTC 2023
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/19 Test  #1: test-grad0 .......................   Passed    4.39 sec
 ...
 5/19 Test  #5: test-mul-mat2 ....................   Passed    8.51 sec
      Start  6: test0
...
19/19 Test #19: test-backend-ops .................   Passed    1.46 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/20 Test  #1: test-grad0 .......................   Passed    4.22 sec
      Start  2: test-opt
...
20/20 Test #20: test-backend-ops .................   Passed    0.22 sec
...
main:     load time =   184.42 ms
main:   sample time =    17.35 ms
main:  predict time =   809.87 ms / 12.65 ms per token
main:    total time =  1033.55 ms
...
main:     load time =   180.01 ms
main:   sample time =    17.34 ms
main:  predict time =   880.29 ms / 12.58 ms per token
main:    total time =  1080.45 ms
...
main:     n_decoded =      504
main:     load time =   152.21 ms
main:   sample time =   127.65 ms
main:  predict time =  5829.16 ms
main:    total time =  6189.84 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f96a960                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f7eb190                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae945bb80                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f96a010                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f96f900                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae945c940                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffff9f7eb190                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaae945bb80                            input

DST    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae945d290                           node_1
SRC    f32    MUL_MAT             2 500 1 1 1                4             2000             2000             2000   0xaaaae945c940                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffff9f96a010                         fc1_bias

DST    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae945dbe0                           node_2
SRC    f32    ADD                 2 500 1 1 1                4             2000             2000             2000   0xaaaae945d290                           node_1

DST    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae945e530                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffff9f96a960                       fc2_weight
SRC    f32    UNARY               2 500 1 1 1                4             2000             2000             2000   0xaaaae945dbe0                           node_2

DST    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae945e6e0                           node_4
SRC    f32    MUL_MAT             2 10 1 1 1                4               40               40               40   0xaaaae945e530                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffff9f96f900                         fc2_bias

DST    f32    SOFT_MAX            2 10 1 1 1                4               40               40               40   0xaaaae945e890                            probs
SRC    f32    ADD                 2 10 1 1 1                4               40               40               40   0xaaaae945e6e0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   115.82 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    12.97 ms
whisper_print_timings:   sample time =    65.55 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4643.55 ms /     1 runs ( 4643.55 ms per run)
whisper_print_timings:   decode time =    15.22 ms /     2 runs (    7.61 ms per run)
whisper_print_timings:   batchd time =   713.80 ms /   125 runs (    5.71 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5571.00 ms
...
main:     load time =    94.04 ms
main:    total time = 39375.43 ms
embd_img
...
car: 62%
bicycle: 59%
Detected objects saved in 'predictions.jpg' (time: 1.256000 sec.)
...
main:      load time =  5752.82 ms
main:    sample time =   533.68 ms / 8.34 ms per token
main:      eval time = 43588.48 ms / 622.69 ms per token
main:     total time = 52251.95 ms
...
main:      load time =  1601.20 ms
main:    sample time =   525.83 ms / 8.22 ms per token
main:      eval time = 17572.36 ms / 251.03 ms per token
main:     total time = 20670.02 ms
