...
- status:  SUCCESS ✅
- runtime: 4:04.89
- date:    Sun Jun 16 09:44:57 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    2.54 sec
      Start  2: test-quantize-fns
...
main:  predict time =   897.98 ms / 14.03 ms per token
main:    total time =  1086.05 ms
...
main:     load time =   150.94 ms
main:   sample time =    18.62 ms
main:  predict time =   978.52 ms / 13.98 ms per token
main:    total time =  1150.95 ms
...
main:     load time =   177.02 ms
main:   sample time =    18.23 ms
main:  predict time =   976.95 ms / 13.96 ms per token
main:    total time =  1175.67 ms
...
main:   sample time =   130.66 ms
main:  predict time =  6120.84 ms
main:    total time =  6483.42 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfac5d6a0a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfac5d688b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb5123adb1ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfac5d6a0a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfac5d6a0f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb5123adb2ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfac5d688b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb5123adb1ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb5123adb3410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb5123adb2ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfac5d6a0a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb5123adb3d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb5123adb3410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb5123adb46d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfac5d6a0a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb5123adb3d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb5123adb4890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb5123adb46d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfac5d6a0f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb5123adb4a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb5123adb4890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   104.65 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.91 ms
whisper_print_timings:   sample time =    68.03 ms /   131 runs (    0.52 ms per run)
whisper_print_timings:   encode time =  4681.21 ms /     1 runs ( 4681.21 ms per run)
whisper_print_timings:   decode time =    15.16 ms /     2 runs (    7.58 ms per run)
whisper_print_timings:   batchd time =   735.02 ms /   125 runs (    5.88 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5636.54 ms
