...
- status:  SUCCESS ✅
- runtime: 2:08.65
- date:    Sun Jun 16 09:43:14 UTC 2024
...
main:  predict time =   478.16 ms / 7.47 ms per token
main:    total time =   620.73 ms
...
main:  predict time =   511.52 ms / 7.31 ms per token
main:    total time =   664.13 ms
...
main:  predict time =  1541.88 ms
main:    total time =  1856.17 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x78e9842fa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78e98417b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5bb4823adce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x78e9842fa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x78e9842ff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5bb4823aeab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x78e98417b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x5bb4823adce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5bb4823af410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x5bb4823aeab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x78e9842fa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5bb4823afd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x5bb4823af410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5bb4823b06d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x78e9842fa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x5bb4823afd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5bb4823b0890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x5bb4823b06d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x78e9842ff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x5bb4823b0a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x5bb4823b0890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    71.91 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.25 ms
whisper_print_timings:   sample time =    55.02 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1161.45 ms /     1 runs ( 1161.45 ms per run)
whisper_print_timings:   decode time =    11.18 ms /     2 runs (    5.59 ms per run)
whisper_print_timings:   batchd time =   219.03 ms /   125 runs (    1.75 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1547.58 ms
...
main:     load time =    66.82 ms
main:    total time = 10604.98 ms
embd_img
