...
- status:  SUCCESS ✅
- runtime: 15:01.35
- date:    Sun Jun 16 09:56:03 UTC 2024
- repo:    https://github.com/ggerganov/ggml
- commit:  https://github.com/ggerganov/ggml/commit/1ba593bdbef06041b8c94e327161e0b9ad4a348a
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/21 Test  #1: test-grad0 .......................   Passed    3.54 sec
      Start  2: test-quantize-fns
 2/21 Test  #2: test-quantize-fns ................   Passed   36.06 sec
      Start  3: test-quantize-perf
 3/21 Test  #3: test-quantize-perf ...............   Passed   10.68 sec
 ...
 8/21 Test  #8: test2 ............................   Passed   20.33 sec
      Start  9: test3
 9/21 Test  #9: test3 ............................   Passed    1.55 sec
      Start 10: test-pool
...
21/21 Test #21: test-backend-ops .................   Passed  208.66 sec

100% tests passed, 0 tests failed out of 21

Total Test time (real) = 289.80 sec
...
22/22 Test #22: test-backend-ops .................   Passed   43.91 sec
...
main:     load time =   155.97 ms
main:   sample time =    34.40 ms
main:  predict time =   609.90 ms / 9.53 ms per token
main:    total time =   822.60 ms
...
main:     load time =   155.30 ms
main:   sample time =    34.62 ms
main:  predict time =   602.70 ms / 8.61 ms per token
main:    total time =   796.49 ms
...
main:     load time =   184.09 ms
main:   sample time =    35.09 ms
main:  predict time =   651.60 ms / 9.31 ms per token
main:    total time =   876.16 ms
...
main:     n_decoded =      504
main:     load time =   150.65 ms
main:   sample time =   234.35 ms
main:  predict time =  2344.49 ms
main:    total time =  2774.81 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f27f4afa990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f27f497b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555ed76ec840                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f27f4afa030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f27f4aff940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555ed76ed610                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f27f497b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x555ed76ec840                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555ed76edf70                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x555ed76ed610                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f27f4afa030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555ed76ee8d0                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x555ed76edf70                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555ed76ef230                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f27f4afa990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x555ed76ee8d0                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555ed76ef3f0                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x555ed76ef230                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f27f4aff940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x555ed76ef5b0                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x555ed76ef3f0       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   548.30 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    17.24 ms
whisper_print_timings:   sample time =    66.95 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =    46.73 ms /     1 runs (   46.73 ms per run)
whisper_print_timings:   decode time =    12.24 ms /     2 runs (    6.12 ms per run)
whisper_print_timings:   batchd time =    79.59 ms /   125 runs (    0.64 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =   785.35 ms
...
main:     load time =   110.00 ms
main:    total time = 16470.35 ms
embd_img
