...
- status:  SUCCESS ✅
- runtime: 3:09.65
- date:    Sun Jun 16 09:44:13 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/21 Test  #2: test-quantize-fns ................   Passed   35.86 sec
...
main:  predict time =   938.34 ms / 13.40 ms per token
main:    total time =  1108.19 ms
...
main:     load time =   180.97 ms
main:   sample time =    18.00 ms
main:  predict time =   953.15 ms / 13.62 ms per token
main:    total time =  1157.42 ms
...
main:   sample time =   129.34 ms
main:  predict time =  6063.36 ms
main:    total time =  6426.10 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfeee5d61a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfeee5d49b1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb42e5cc5dce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfeee5d61a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xfeee5d61f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb42e5cc5eab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xfeee5d49b1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xb42e5cc5dce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb42e5cc5f410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xb42e5cc5eab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xfeee5d61a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb42e5cc5fd70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xb42e5cc5f410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb42e5cc606d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xfeee5d61a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xb42e5cc5fd70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb42e5cc60890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xb42e5cc606d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xfeee5d61f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xb42e5cc60a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xb42e5cc60890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   105.13 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.50 ms
whisper_print_timings:   sample time =    66.73 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4667.68 ms /     1 runs ( 4667.68 ms per run)
whisper_print_timings:   decode time =    14.74 ms /     2 runs (    7.37 ms per run)
whisper_print_timings:   batchd time =   728.09 ms /   125 runs (    5.82 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5614.01 ms
...
main:     load time =    89.54 ms
main:    total time = 39814.78 ms
embd_img
