...
- status:  SUCCESS ✅
- runtime: 2:00.21
- date:    Mon Mar 18 09:06:03 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
 ...
 2/22 Test  #2: test-quantize-fns ................   Passed   24.68 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   13.08 sec
...
main:  predict time =   495.94 ms / 7.75 ms per token
main:    total time =   640.92 ms
...
main:  predict time =   515.89 ms / 7.37 ms per token
main:    total time =   650.65 ms
...
main:     load time =   129.20 ms
main:   sample time =    23.80 ms
main:  predict time =   552.00 ms / 7.89 ms per token
main:    total time =   708.59 ms
...
main:   sample time =   175.05 ms
main:  predict time =  1864.53 ms
main:    total time =  2178.48 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8bc0298990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8bc01191a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556eecc55ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8bc0298030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8bc029d940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556eecc56ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0x7f8bc01191a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0x556eecc55ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556eecc57410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0x556eecc56ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0x7f8bc0298030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556eecc57d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0x556eecc57410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556eecc586d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0x7f8bc0298990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0x556eecc57d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556eecc58890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0x556eecc586d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0x7f8bc029d940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0x556eecc58a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0x556eecc58890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =    80.15 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    14.38 ms
whisper_print_timings:   sample time =    54.62 ms /   131 runs (    0.42 ms per run)
whisper_print_timings:   encode time =  1194.03 ms /     1 runs ( 1194.03 ms per run)
whisper_print_timings:   decode time =    12.17 ms /     2 runs (    6.09 ms per run)
whisper_print_timings:   batchd time =   216.52 ms /   125 runs (    1.73 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  1577.89 ms
...
main:     load time =    64.41 ms
main:    total time = 10771.94 ms
embd_img
