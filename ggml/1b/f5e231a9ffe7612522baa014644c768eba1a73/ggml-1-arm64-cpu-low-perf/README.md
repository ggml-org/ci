...
- status:  SUCCESS ✅
- runtime: 3:58.33
- date:    Mon Mar 18 09:08:14 AM UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-debug
      Start  1: test-grad0
 1/22 Test  #1: test-grad0 .......................   Passed    4.29 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   26.65 sec
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 1/22 Test  #1: test-grad0 .......................   Passed    4.07 sec
      Start  2: test-quantize-fns
 2/22 Test  #2: test-quantize-fns ................   Passed   16.89 sec
      Start  3: test-quantize-perf
...
main:     load time =   165.88 ms
main:   sample time =    17.81 ms
main:  predict time =   917.46 ms / 14.34 ms per token
main:    total time =  1123.16 ms
...
main:     load time =   164.76 ms
main:   sample time =    17.99 ms
main:  predict time =  1056.16 ms / 15.09 ms per token
main:    total time =  1241.79 ms
...
main:  predict time =  1017.41 ms / 14.53 ms per token
main:    total time =  1235.23 ms
...
main:     n_decoded =      504
main:     load time =   160.87 ms
main:   sample time =   128.23 ms
main:  predict time =  6532.71 ms
main:    total time =  6904.31 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa727a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa70fb1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab9fdcce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa727a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa727f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab9fddab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffa70fb1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaab9fdcce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab9fde410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaab9fddab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffa727a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab9fded70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaab9fde410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab9fdf6d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffa727a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaab9fded70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab9fdf890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaab9fdf6d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffa727f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaab9fdfa50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaab9fdf890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   113.58 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.86 ms
whisper_print_timings:   sample time =    66.97 ms /   131 runs (    0.51 ms per run)
whisper_print_timings:   encode time =  4762.25 ms /     1 runs ( 4762.25 ms per run)
whisper_print_timings:   decode time =    15.84 ms /     2 runs (    7.92 ms per run)
whisper_print_timings:   batchd time =   717.06 ms /   125 runs (    5.74 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5695.35 ms
...
main:     load time =    91.74 ms
main:    total time = 40038.89 ms
embd_img
