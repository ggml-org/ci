...
- status:  SUCCESS ✅
- runtime: 2:57.41
- date:    Mon Mar 18 09:07:02 UTC 2024
...
Test project /home/ggml/work/ggml/build-ci-release
 ...
 3/23 Test  #3: test-quantize-fns ................   Passed   14.28 sec
...
main:  predict time =   889.98 ms / 13.91 ms per token
main:    total time =  1079.10 ms
...
main:  predict time =   972.54 ms / 13.89 ms per token
main:    total time =  1142.45 ms
...
main:     load time =   179.51 ms
main:   sample time =    16.88 ms
main:  predict time =   985.77 ms / 14.08 ms per token
main:    total time =  1186.46 ms
...
main:  predict time =  6512.18 ms
main:    total time =  6870.13 ms
...
f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae92a990                       fc2_weight
f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae7ab1a0                       fc1_weight
f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6242ce0                            input
f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae92a030                         fc1_bias
f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae92f940                         fc2_bias

ARG    TYPE   OP              NDIMS      NE0      NE1      NE2      NE3              NB0              NB1              NB2              NB3   NTASKS             DATA             NAME
DST    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad6243ab0                           node_0
SRC    f32    NONE                2 784 500 1 1                4             3136          1568000          1568000   0xffffae7ab1a0                       fc1_weight
SRC    f32    NONE                1 784 1 1 1                4             3136             3136             3136   0xaaaad6242ce0                            input

DST    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad6244410                           node_1
SRC    f32    MUL_MAT             1 500 1 1 1                4             2000             2000             2000   0xaaaad6243ab0                           node_0
SRC    f32    NONE                1 500 1 1 1                4             2000             2000             2000   0xffffae92a030                         fc1_bias

DST    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad6244d70                           node_2
SRC    f32    ADD                 1 500 1 1 1                4             2000             2000             2000   0xaaaad6244410                           node_1

DST    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad62456d0                           node_3
SRC    f32    NONE                2 500 10 1 1                4             2000            20000            20000   0xffffae92a990                       fc2_weight
SRC    f32    UNARY               1 500 1 1 1                4             2000             2000             2000   0xaaaad6244d70                           node_2

DST    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad6245890                           node_4
SRC    f32    MUL_MAT             1 10 1 1 1                4               40               40               40   0xaaaad62456d0                           node_3
SRC    f32    NONE                1 10 1 1 1                4               40               40               40   0xffffae92f940                         fc2_bias

DST    f32    SOFT_MAX            1 10 1 1 1                4               40               40               40   0xaaaad6245a50                            probs
SRC    f32    ADD                 1 10 1 1 1                4               40               40               40   0xaaaad6245890       mnist_eval: exported compute graph to 'mnist.ggml'
                    node_4
...
whisper_print_timings:     load time =   101.60 ms
whisper_print_timings:     fallbacks =   0 p /   0 h
whisper_print_timings:      mel time =    13.24 ms
whisper_print_timings:   sample time =    65.49 ms /   131 runs (    0.50 ms per run)
whisper_print_timings:   encode time =  4689.98 ms /     1 runs ( 4689.98 ms per run)
whisper_print_timings:   decode time =    15.46 ms /     2 runs (    7.73 ms per run)
whisper_print_timings:   batchd time =   712.16 ms /   125 runs (    5.70 ms per run)
whisper_print_timings:   prompt time =     0.00 ms /     1 runs (    0.00 ms per run)
whisper_print_timings:    total time =  5603.24 ms
