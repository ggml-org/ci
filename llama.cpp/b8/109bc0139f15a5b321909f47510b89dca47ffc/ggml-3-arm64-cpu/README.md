...
- status:  SUCCESS ✅
- runtime: 19:20.04
- date:    Sat Apr 20 16:49:15 UTC 2024
...
Label Time Summary:
main    = 103.02 sec*proc (23 tests)

Total Test time (real) = 103.03 sec
...
llama_print_timings: prompt eval time =      19.03 ms /     9 tokens (    2.11 ms per token,   473.04 tokens per second)
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a world of mythical creatures, there lived a courageous princess named Anya.

**Anya's Powers and Abilities:**

* She possessed the ability
llama_print_timings:        load time =    3709.88 ms
llama_print_timings:      sample time =      41.50 ms /    32 runs   (    1.30 ms per token,   771.05 tokens per second)
llama_print_timings: prompt eval time =    6185.89 ms /     5 tokens ( 1237.18 ms per token,     0.81 tokens per second)
llama_print_timings:        eval time =   48531.74 ms /    31 runs   ( 1565.54 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   54873.08 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 The Witcher Season 2 spoilers are out there, and let me tell you, those twists and turns will leave you gasping for air!

**Spoilers ahead!**
llama_print_timings:        load time =    3717.31 ms
llama_print_timings:      sample time =      41.54 ms /    32 runs   (    1.30 ms per token,   770.29 tokens per second)
llama_print_timings: prompt eval time =    2707.02 ms /     2 tokens ( 1353.51 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48292.20 ms /    31 runs   ( 1557.81 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51153.97 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 When the narrator says, "I felt a flicker of something unexpected in the air," what does it suggest about the setting and the narrator's expectations?

Answer
llama_print_timings:        load time =    3704.39 ms
llama_print_timings:      sample time =      41.67 ms /    32 runs   (    1.30 ms per token,   767.99 tokens per second)
llama_print_timings: prompt eval time =    2719.59 ms /     2 tokens ( 1359.80 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48513.82 ms /    31 runs   ( 1564.96 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51388.46 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a bustling city, lived a curious young woman named Anya. Anya possessed a thirst for knowledge and a knack for exploring the world around her.

One
llama_print_timings:        load time =    1175.79 ms
llama_print_timings:      sample time =       7.94 ms /    32 runs   (    0.25 ms per token,  4028.70 tokens per second)
llama_print_timings: prompt eval time =     367.27 ms /     5 tokens (   73.45 ms per token,    13.61 tokens per second)
llama_print_timings:        eval time =    3118.25 ms /    31 runs   (  100.59 ms per token,     9.94 tokens per second)
llama_print_timings:       total time =    3525.93 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Heirs is a new reality series that follows the descendants of prominent families across America.

**Premise:**

The show features descendants of famous families from various backgrounds,
...
llama_print_timings:        eval time =    3113.52 ms /    31 runs   (  100.44 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    3319.32 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there lived a young girl named Anya. She had bright eyes that sparkled with mischief and a smile that could melt hearts. Anya possessed a heart of gold
llama_print_timings:        load time =    1152.34 ms
llama_print_timings:      sample time =       7.90 ms /    32 runs   (    0.25 ms per token,  4052.17 tokens per second)
llama_print_timings: prompt eval time =     370.47 ms /     5 tokens (   74.09 ms per token,    13.50 tokens per second)
llama_print_timings:        eval time =    3129.96 ms /    31 runs   (  100.97 ms per token,     9.90 tokens per second)
llama_print_timings:       total time =    3539.92 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    3129.85 ms
llama_print_timings:      sample time =       2.68 ms /    64 runs   (    0.04 ms per token, 23880.60 tokens per second)
llama_print_timings: prompt eval time =    2238.67 ms /     8 tokens (  279.83 ms per token,     3.57 tokens per second)
llama_print_timings:        eval time =   19773.70 ms /    63 runs   (  313.87 ms per token,     3.19 tokens per second)
llama_print_timings:       total time =   22025.90 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36558.05 ms /   128 tokens (  285.61 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36570.45 ms /   129 tokens
...
llama_print_timings:        eval time =    8433.79 ms /    63 runs   (  133.87 ms per token,     7.47 tokens per second)
...
[1]4.2615,
llama_print_timings:        load time =    1635.13 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14368.72 ms /   128 tokens (  112.26 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14380.40 ms /   129 tokens
...
llama_print_timings:        eval time =    7929.63 ms /    63 runs   (  125.87 ms per token,     7.94 tokens per second)
llama_print_timings:       total time =    8853.13 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14961.65 ms /   128 tokens (  116.89 ms per token,     8.56 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14974.23 ms /   129 tokens
...
llama_print_timings:        load time =    1137.67 ms
llama_print_timings:      sample time =       2.65 ms /    64 runs   (    0.04 ms per token, 24114.54 tokens per second)
llama_print_timings: prompt eval time =     960.70 ms /     8 tokens (  120.09 ms per token,     8.33 tokens per second)
llama_print_timings:        eval time =    8417.59 ms /    63 runs   (  133.61 ms per token,     7.48 tokens per second)
llama_print_timings:       total time =    9392.37 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15870.21 ms /   128 tokens (  123.99 ms per token,     8.07 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15882.44 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1210.92 ms /     8 tokens (  151.37 ms per token,     6.61 tokens per second)
llama_print_timings:        eval time =   10511.15 ms /    63 runs   (  166.84 ms per token,     5.99 tokens per second)
llama_print_timings:       total time =   11736.25 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20261.44 ms /   128 tokens (  158.29 ms per token,     6.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20273.76 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1229.80 ms /     8 tokens (  153.73 ms per token,     6.51 tokens per second)
llama_print_timings:        eval time =   10940.19 ms /    63 runs   (  173.65 ms per token,     5.76 tokens per second)
llama_print_timings:       total time =   12184.20 ms /    71 tokens
Log end
...
[1]4.2557,
llama_print_timings:        load time =    1326.82 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20130.96 ms /   128 tokens (  157.27 ms per token,     6.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20143.46 ms /   129 tokens
...
llama_print_timings:        load time =     896.12 ms
llama_print_timings:      sample time =       2.69 ms /    64 runs   (    0.04 ms per token, 23818.38 tokens per second)
llama_print_timings: prompt eval time =    1149.53 ms /     8 tokens (  143.69 ms per token,     6.96 tokens per second)
llama_print_timings:        eval time =    9821.35 ms /    63 runs   (  155.89 ms per token,     6.41 tokens per second)
llama_print_timings:       total time =   10984.47 ms /    71 tokens
Log end
...
[1]5.6188,
llama_print_timings:        load time =     854.18 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18774.41 ms /   128 tokens (  146.68 ms per token,     6.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18787.03 ms /   129 tokens
...
llama_print_timings:       total time =   10466.27 ms /    71 tokens
Log end
...
[1]4.4258,
llama_print_timings:        load time =     960.27 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17802.73 ms /   128 tokens (  139.08 ms per token,     7.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17814.31 ms /   129 tokens
...
I
llama_print_timings:        load time =    1144.63 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23934.18 tokens per second)
llama_print_timings: prompt eval time =     957.11 ms /     8 tokens (  119.64 ms per token,     8.36 tokens per second)
llama_print_timings:        eval time =    8386.62 ms /    63 runs   (  133.12 ms per token,     7.51 tokens per second)
llama_print_timings:       total time =    9357.02 ms /    71 tokens
Log end
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15691.97 ms /   129 tokens
...
I believe that you
llama_print_timings:        load time =    1329.39 ms
llama_print_timings:      sample time =       2.68 ms /    64 runs   (    0.04 ms per token, 23907.36 tokens per second)
llama_print_timings: prompt eval time =    1311.89 ms /     8 tokens (  163.99 ms per token,     6.10 tokens per second)
llama_print_timings:        eval time =   11188.78 ms /    63 runs   (  177.60 ms per token,     5.63 tokens per second)
llama_print_timings:       total time =   12514.12 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21487.81 ms /   128 tokens (  167.87 ms per token,     5.96 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21499.53 ms /   129 tokens
...
llama_print_timings:        load time =    1499.92 ms
...
llama_print_timings:        eval time =   11517.55 ms /    63 runs   (  182.82 ms per token,     5.47 tokens per second)
llama_print_timings:       total time =   12876.80 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22036.54 ms /   128 tokens (  172.16 ms per token,     5.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22048.47 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog in the morning watching. . essay about powerpoint technology


second run: The quick brown fox jumps over the lazy dog in the morning watching. . essay about powerpoint technology


single seq run: The quick brown fox jumps over the lazy dog in the morning watching. . essay about powerpoint technology
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 64.208 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.61 seconds per pass - ETA 0.60 minutes
[1]9.1017,
llama_print_timings:        load time =    3262.01 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36614.39 ms /   128 tokens (  286.05 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36680.26 ms /   129 tokens
...
[1]7.0171,
llama_print_timings:        load time =    6350.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36548.50 ms /   128 tokens (  285.54 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36613.59 ms /   129 tokens
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14427.22 ms /   129 tokens
...
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]6.9856,
llama_print_timings:        load time =    4487.74 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14369.35 ms /   128 tokens (  112.26 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14432.71 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 60.827 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]6.9967,
llama_print_timings:        load time =    5178.77 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14369.56 ms /   128 tokens (  112.26 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14432.64 ms /   129 tokens
...
0.37user 2.96system 0:03.34elapsed 100%CPU (0avgtext+0avgdata 6877696maxresident)k
...
0.09user 2.94system 0:03.04elapsed 100%CPU (0avgtext+0avgdata 6877176maxresident)k
