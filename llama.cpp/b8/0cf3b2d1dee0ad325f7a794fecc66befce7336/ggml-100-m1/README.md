...
- status:  SUCCESS ✅
- runtime: 515.23
- date:    Tue Mar 19 10:26:59 EET 2024
...
llama_print_timings: prompt eval time =      10.55 ms /     9 tokens (    1.17 ms per token,   853.40 tokens per second)
...
llama_print_timings:        load time =      71.47 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
