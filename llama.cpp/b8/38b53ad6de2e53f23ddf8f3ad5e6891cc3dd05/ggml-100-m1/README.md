...
- status:  SUCCESS ✅
- runtime: 470.47
- date:    Sun Mar 10 20:25:44 EET 2024
...
Label Time Summary:
main    = 227.15 sec*proc (21 tests)

Total Test time (real) = 227.16 sec
...
llama_print_timings:       total time =      37.30 ms /    10 tokens
...
llama_print_timings:        load time =      48.87 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
