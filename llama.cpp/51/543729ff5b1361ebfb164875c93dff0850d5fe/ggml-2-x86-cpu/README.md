...
- status:  SUCCESS ✅
- runtime: 19:49.61
- date:    Thu Apr 25 13:18:21 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-release
 ...
 1/23 Test  #1: test-quantize-fns ...................   Passed   15.95 sec
      Start  2: test-quantize-perf
 2/23 Test  #2: test-quantize-perf ..................   Passed    4.59 sec
      Start  3: test-sampling
...
llama_print_timings:       total time =      52.38 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.79 ms /     9 tokens (    0.42 ms per token,  2375.30 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> If the joint density function of two random variables X and Y is given by:

$$f(x,y) = \begin{cases} \frac{
llama_print_timings:        load time =    1244.36 ms
llama_print_timings:      sample time =      47.47 ms /    32 runs   (    1.48 ms per token,   674.08 tokens per second)
llama_print_timings: prompt eval time =    1139.70 ms /     2 tokens (  569.85 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21843.77 ms /    31 runs   (  704.64 ms per token,     1.42 tokens per second)
llama_print_timings:       total time =   23166.76 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
When we fall asleep, our brains and bodies enter a state of deep rest. During this time, our
...
llama_print_timings: prompt eval time =    1140.55 ms /     2 tokens (  570.27 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21678.14 ms /    31 runs   (  699.29 ms per token,     1.43 tokens per second)
llama_print_timings:       total time =   23002.80 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After an argument with his wife, Mark decides to go for a walk in the park to clear his head. As he walks, he notices a squirrel scampering
llama_print_timings:        load time =    1311.12 ms
llama_print_timings:      sample time =      47.54 ms /    32 runs   (    1.49 ms per token,   673.15 tokens per second)
llama_print_timings: prompt eval time =    1220.91 ms /     2 tokens (  610.46 ms per token,     1.64 tokens per second)
llama_print_timings:        eval time =   21631.76 ms /    31 runs   (  697.80 ms per token,     1.43 tokens per second)
llama_print_timings:       total time =   23036.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 199028.80 ms
main:    total time = 199028.80 ms
+ echo PASS
PASS
+ echo
...
* **Expand your family:** Create a diverse cast of Sims with unique skills, relationships, and aspirations.
llama_print_timings:        load time =     637.14 ms
llama_print_timings:      sample time =      48.11 ms /    32 runs   (    1.50 ms per token,   665.17 tokens per second)
llama_print_timings: prompt eval time =     567.40 ms /     2 tokens (  283.70 ms per token,     3.52 tokens per second)
llama_print_timings:        eval time =   10724.31 ms /    31 runs   (  345.95 ms per token,     2.89 tokens per second)
llama_print_timings:       total time =   11476.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 199069.48 ms
main:    total time = 199069.48 ms
+ echo PASS
PASS
+ echo
...
<bos> Soar Academy offers a unique learning experience that combines online and in-person instruction.

**In-person Instruction:**

* Small group workshops and classes
*
llama_print_timings:        load time =     635.73 ms
llama_print_timings:      sample time =      47.77 ms /    32 runs   (    1.49 ms per token,   669.85 tokens per second)
llama_print_timings: prompt eval time =     573.08 ms /     2 tokens (  286.54 ms per token,     3.49 tokens per second)
llama_print_timings:        eval time =   10611.33 ms /    31 runs   (  342.30 ms per token,     2.92 tokens per second)
llama_print_timings:       total time =   11367.69 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekhs are a significant and influential community within the Sikh faith. They have a rich history and a deep understanding of spirituality.

**Questions:**

1.
llama_print_timings:        load time =     185.62 ms
llama_print_timings:      sample time =       6.26 ms /    32 runs   (    0.20 ms per token,  5108.56 tokens per second)
llama_print_timings: prompt eval time =      75.08 ms /     2 tokens (   37.54 ms per token,    26.64 tokens per second)
llama_print_timings:        eval time =    2059.95 ms /    31 runs   (   66.45 ms per token,    15.05 tokens per second)
llama_print_timings:       total time =    2201.42 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After successfully cracking the password, you find yourself in a locked room with no way out. What are your options?

1. Call for help
2. Try
llama_print_timings:        load time =     155.25 ms
llama_print_timings:      sample time =       6.17 ms /    32 runs   (    0.19 ms per token,  5185.55 tokens per second)
llama_print_timings: prompt eval time =      72.03 ms /     2 tokens (   36.02 ms per token,    27.77 tokens per second)
llama_print_timings:        eval time =    1970.01 ms /    31 runs   (   63.55 ms per token,    15.74 tokens per second)
llama_print_timings:       total time =    2108.26 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekher was an exceptional ruler, who led the nation to unparalleled prosperity and stability. Discuss the reasons why Shekher was an exceptional ruler.

**Reasons
llama_print_timings:        load time =     167.44 ms
llama_print_timings:      sample time =       6.22 ms /    32 runs   (    0.19 ms per token,  5142.21 tokens per second)
llama_print_timings: prompt eval time =      77.77 ms /     2 tokens (   38.89 ms per token,    25.72 tokens per second)
llama_print_timings:        eval time =    2021.45 ms /    31 runs   (   65.21 ms per token,    15.34 tokens per second)
llama_print_timings:       total time =    2165.14 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31761.96 ms
main:    total time = 31761.96 ms
+ echo PASS
PASS
+ echo
...
def get_stock_prices():
    """
    Returns a list of stock prices from a given
llama_print_timings:        load time =     121.58 ms
llama_print_timings:      sample time =       6.85 ms /    32 runs   (    0.21 ms per token,  4672.90 tokens per second)
llama_print_timings: prompt eval time =      67.50 ms /     2 tokens (   33.75 ms per token,    29.63 tokens per second)
llama_print_timings:        eval time =    1528.76 ms /    31 runs   (   49.31 ms per token,    20.28 tokens per second)
llama_print_timings:       total time =    1664.18 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31852.32 ms
main:    total time = 31852.32 ms
+ echo PASS
PASS
+ echo
...
**A. Discuss the significance of the location of the workplace in the modern workplace.**

**B. Explain how the physical layout of an
llama_print_timings:        load time =     124.06 ms
llama_print_timings:      sample time =       6.54 ms /    32 runs   (    0.20 ms per token,  4895.96 tokens per second)
llama_print_timings: prompt eval time =      68.42 ms /     2 tokens (   34.21 ms per token,    29.23 tokens per second)
llama_print_timings:        eval time =    1530.41 ms /    31 runs   (   49.37 ms per token,    20.26 tokens per second)
llama_print_timings:       total time =    1668.42 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     608.97 ms
llama_print_timings:      sample time =       2.29 ms /    64 runs   (    0.04 ms per token, 27911.03 tokens per second)
llama_print_timings: prompt eval time =     306.71 ms /     8 tokens (   38.34 ms per token,    26.08 tokens per second)
llama_print_timings:        eval time =    7672.14 ms /    63 runs   (  121.78 ms per token,     8.21 tokens per second)
llama_print_timings:       total time =    8000.62 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     584.81 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4674.29 ms /   128 tokens (   36.52 ms per token,    27.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4684.48 ms /   129 tokens
...
llama_print_timings:        load time =     374.66 ms
llama_print_timings:      sample time =       2.03 ms /    64 runs   (    0.03 ms per token, 31496.06 tokens per second)
llama_print_timings: prompt eval time =     207.83 ms /     8 tokens (   25.98 ms per token,    38.49 tokens per second)
llama_print_timings:        eval time =    5374.05 ms /    63 runs   (   85.30 ms per token,    11.72 tokens per second)
llama_print_timings:       total time =    5601.37 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2818.99 ms /   128 tokens (   22.02 ms per token,    45.41 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2829.52 ms /   129 tokens
...
llama_print_timings:        eval time =    4560.40 ms /    63 runs   (   72.39 ms per token,    13.81 tokens per second)
llama_print_timings:       total time =    4783.88 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3122.77 ms /   128 tokens (   24.40 ms per token,    40.99 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3133.10 ms /   129 tokens
...
llama_print_timings:        load time =     297.66 ms
llama_print_timings:      sample time =       2.03 ms /    64 runs   (    0.03 ms per token, 31558.19 tokens per second)
llama_print_timings: prompt eval time =     371.85 ms /     8 tokens (   46.48 ms per token,    21.51 tokens per second)
llama_print_timings:        eval time =    4849.08 ms /    63 runs   (   76.97 ms per token,    12.99 tokens per second)
llama_print_timings:       total time =    5240.87 ms /    71 tokens
Log end
...
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.82 seconds per pass - ETA 0.08 minutes
[1]4.3889,
llama_print_timings:        load time =     276.21 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5824.27 ms /   128 tokens (   45.50 ms per token,    21.98 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5834.20 ms /   129 tokens
...
llama_print_timings: prompt eval time =     389.49 ms /     8 tokens (   48.69 ms per token,    20.54 tokens per second)
llama_print_timings:        eval time =    5108.00 ms /    63 runs   (   81.08 ms per token,    12.33 tokens per second)
llama_print_timings:       total time =    5516.35 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6327.62 ms /   128 tokens (   49.43 ms per token,    20.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6338.15 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     342.52 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31387.94 tokens per second)
llama_print_timings: prompt eval time =     419.51 ms /     8 tokens (   52.44 ms per token,    19.07 tokens per second)
llama_print_timings:        eval time =    5471.47 ms /    63 runs   (   86.85 ms per token,    11.51 tokens per second)
llama_print_timings:       total time =    5911.31 ms /    71 tokens
Log end
...
[1]4.2586,
llama_print_timings:        load time =     318.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6564.77 ms /   128 tokens (   51.29 ms per token,    19.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6575.17 ms /   129 tokens
...
llama_print_timings: prompt eval time =     610.40 ms /     8 tokens (   76.30 ms per token,    13.11 tokens per second)
llama_print_timings:        eval time =    5692.02 ms /    63 runs   (   90.35 ms per token,    11.07 tokens per second)
llama_print_timings:       total time =    6321.38 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9857.99 ms /   128 tokens (   77.02 ms per token,    12.98 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9868.12 ms /   129 tokens
...
llama_print_timings: prompt eval time =     463.25 ms /     8 tokens (   57.91 ms per token,    17.27 tokens per second)
llama_print_timings:        eval time =    4945.48 ms /    63 runs   (   78.50 ms per token,    12.74 tokens per second)
llama_print_timings:       total time =    5428.48 ms /    71 tokens
Log end
...
[1]4.4091,
llama_print_timings:        load time =     265.66 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7405.81 ms /   128 tokens (   57.86 ms per token,    17.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7416.04 ms /   129 tokens
...
llama_print_timings:        load time =     306.09 ms
...
llama_print_timings:        eval time =    4998.56 ms /    63 runs   (   79.34 ms per token,    12.60 tokens per second)
llama_print_timings:       total time =    5408.45 ms /    71 tokens
Log end
...
[1]4.1768,
llama_print_timings:        load time =     282.45 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6124.14 ms /   128 tokens (   47.84 ms per token,    20.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6134.76 ms /   129 tokens
...
-
llama_print_timings:        load time =     349.69 ms
llama_print_timings:      sample time =       2.08 ms /    64 runs   (    0.03 ms per token, 30769.23 tokens per second)
llama_print_timings: prompt eval time =     475.83 ms /     8 tokens (   59.48 ms per token,    16.81 tokens per second)
llama_print_timings:        eval time =    5709.19 ms /    63 runs   (   90.62 ms per token,    11.03 tokens per second)
llama_print_timings:       total time =    6204.66 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7316.53 ms /   128 tokens (   57.16 ms per token,    17.49 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7326.58 ms /   129 tokens
...
llama_print_timings:        load time =     385.52 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31620.55 tokens per second)
llama_print_timings: prompt eval time =     518.70 ms /     8 tokens (   64.84 ms per token,    15.42 tokens per second)
llama_print_timings:        eval time =    6316.63 ms /    63 runs   (  100.26 ms per token,     9.97 tokens per second)
llama_print_timings:       total time =    6855.47 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     364.39 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8121.57 ms /   128 tokens (   63.45 ms per token,    15.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8132.10 ms /   129 tokens
...
first run: The quick brown fox- sneaked bomb.
Eric controlled his mad jumping, for a second


second run: The quick brown fox- sneaked bomb.
Eric controlled his mad jumping, for a second


single seq run: The quick brown fox- sneaked bomb.
Eric controlled his mad jumping, for a second
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.213 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.67 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     581.43 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4668.93 ms /   128 tokens (   36.48 ms per token,    27.42 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4718.06 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.924 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.66 seconds per pass - ETA 0.07 minutes
[1]7.0156,
llama_print_timings:        load time =    5493.92 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4662.97 ms /   128 tokens (   36.43 ms per token,    27.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4709.59 ms /   129 tokens
...
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]9.1825,
llama_print_timings:        load time =     349.79 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2817.83 ms /   128 tokens (   22.01 ms per token,    45.42 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2868.44 ms /   129 tokens
...
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]7.0131,
llama_print_timings:        load time =    3881.29 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2815.20 ms /   128 tokens (   21.99 ms per token,    45.47 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2862.78 ms /   129 tokens
...
[1]7.0336,
llama_print_timings:        load time =    4286.24 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2809.43 ms /   128 tokens (   21.95 ms per token,    45.56 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2858.81 ms /   129 tokens
...
0.29user 0.81system 0:01.11elapsed 100%CPU (0avgtext+0avgdata 6878152maxresident)k
0inputs+40outputs (0major+111980minor)pagefaults 0swaps
```
...
0.07user 0.82system 0:00.89elapsed 99%CPU (0avgtext+0avgdata 6877736maxresident)k
