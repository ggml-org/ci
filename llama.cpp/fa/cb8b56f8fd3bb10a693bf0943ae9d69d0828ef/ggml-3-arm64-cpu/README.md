...
- status:  SUCCESS ✅
- runtime: 19:48.71
- date:    Tue Apr 16 21:27:59 UTC 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/facb8b56f8fd3bb10a693bf0943ae9d69d0828ef
- author:  Zheng.Deng
```
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 1/23 Test  #1: test-quantize-fns ...................   Passed   35.81 sec
...
11/23 Test #11: test-tokenizer-1-mpt ................   Passed    5.11 sec
...
16/23 Test #16: test-tokenizer-1-gpt2 ...............   Passed    5.16 sec
...
Label Time Summary:
main    = 104.06 sec*proc (23 tests)

Total Test time (real) = 104.07 sec
...
llama_print_timings:        load time =      42.30 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       6.67 ms /     9 tokens (    0.74 ms per token,  1349.33 tokens per second)
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      74.58 ms /    10 tokens
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 After a long day of work, you decide to relax with a warm bath. As you soak in the warm water, your mind starts to wander, and you find
llama_print_timings:        load time =    3713.67 ms
llama_print_timings:      sample time =      41.78 ms /    32 runs   (    1.31 ms per token,   765.99 tokens per second)
llama_print_timings: prompt eval time =    2714.44 ms /     2 tokens ( 1357.22 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48408.86 ms /    31 runs   ( 1561.58 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51277.99 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a bustling city, lived a young woman named Anya. Anya had a heart filled with dreams and aspirations, but she struggled to find her path in the
llama_print_timings:        load time =    3704.44 ms
llama_print_timings:      sample time =      41.79 ms /    32 runs   (    1.31 ms per token,   765.70 tokens per second)
llama_print_timings: prompt eval time =    6147.92 ms /     5 tokens ( 1229.58 ms per token,     0.81 tokens per second)
llama_print_timings:        eval time =   48346.13 ms /    31 runs   ( 1559.55 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   54649.58 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
Shelliel was a Jewish mystic and sage who lived in Egypt during the time of the Exodus. She possessed extraordinary knowledge and
llama_print_timings:        load time =    3721.06 ms
llama_print_timings:      sample time =      41.79 ms /    32 runs   (    1.31 ms per token,   765.75 tokens per second)
llama_print_timings: prompt eval time =    2708.91 ms /     2 tokens ( 1354.46 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48284.15 ms /    31 runs   ( 1557.55 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51148.11 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 When I use the term "frequency", what specifically do I mean?

The term "frequency" can refer to two different things:

* The number of occurrences
llama_print_timings:        load time =    1183.44 ms
llama_print_timings:      sample time =       7.82 ms /    32 runs   (    0.24 ms per token,  4093.12 tokens per second)
llama_print_timings: prompt eval time =     165.53 ms /     2 tokens (   82.76 ms per token,    12.08 tokens per second)
llama_print_timings:        eval time =    3114.87 ms /    31 runs   (  100.48 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    3321.05 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    1162.07 ms
llama_print_timings:      sample time =       7.44 ms /    32 runs   (    0.23 ms per token,  4303.97 tokens per second)
llama_print_timings: prompt eval time =     164.53 ms /     2 tokens (   82.26 ms per token,    12.16 tokens per second)
llama_print_timings:        eval time =    3114.38 ms /    31 runs   (  100.46 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    3318.21 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there lived a little girl named Anya. Anya had bright eyes and a smile that could brighten any day.

One sunny day, Anya decided to go for
llama_print_timings:        load time =    1185.74 ms
llama_print_timings:      sample time =       7.82 ms /    32 runs   (    0.24 ms per token,  4089.98 tokens per second)
llama_print_timings: prompt eval time =     366.32 ms /     5 tokens (   73.26 ms per token,    13.65 tokens per second)
llama_print_timings:        eval time =    3114.41 ms /    31 runs   (  100.46 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    3520.23 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    3385.83 ms
llama_print_timings:      sample time =       2.62 ms /    64 runs   (    0.04 ms per token, 24436.81 tokens per second)
llama_print_timings: prompt eval time =    1297.27 ms /     8 tokens (  162.16 ms per token,     6.17 tokens per second)
llama_print_timings:        eval time =   24659.99 ms /    63 runs   (  391.43 ms per token,     2.55 tokens per second)
llama_print_timings:       total time =   25971.03 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =    3401.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8999.98 ms /   128 tokens (   70.31 ms per token,    14.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9012.10 ms /   129 tokens
...
llama_print_timings:        load time =    1751.81 ms
llama_print_timings:      sample time =       2.76 ms /    64 runs   (    0.04 ms per token, 23163.23 tokens per second)
llama_print_timings: prompt eval time =     879.02 ms /     8 tokens (  109.88 ms per token,     9.10 tokens per second)
llama_print_timings:        eval time =    8418.16 ms /    63 runs   (  133.62 ms per token,     7.48 tokens per second)
llama_print_timings:       total time =    9311.04 ms /    71 tokens
Log end
...
[1]4.2582,
llama_print_timings:        load time =    1634.58 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14134.96 ms /   128 tokens (  110.43 ms per token,     9.06 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14147.31 ms /   129 tokens
...
llama_print_timings:        load time =    1047.86 ms
...
llama_print_timings:        eval time =    7899.68 ms /    63 runs   (  125.39 ms per token,     7.98 tokens per second)
llama_print_timings:       total time =    8820.17 ms /    71 tokens
Log end
...
[1]4.1546,
llama_print_timings:        load time =    1005.54 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14739.01 ms /   128 tokens (  115.15 ms per token,     8.68 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14750.54 ms /   129 tokens
...
llama_print_timings:        load time =    1137.65 ms
llama_print_timings:      sample time =       2.62 ms /    64 runs   (    0.04 ms per token, 24399.54 tokens per second)
llama_print_timings: prompt eval time =     959.80 ms /     8 tokens (  119.98 ms per token,     8.34 tokens per second)
llama_print_timings:        eval time =    8420.37 ms /    63 runs   (  133.66 ms per token,     7.48 tokens per second)
llama_print_timings:       total time =    9394.39 ms /    71 tokens
Log end
...
[1]4.3992,
llama_print_timings:        load time =    1112.32 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15683.98 ms /   128 tokens (  122.53 ms per token,     8.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15695.96 ms /   129 tokens
...
I believe the meaning of life is to find our purpose, live it, and inspire others to do the same.
I believe the meaning of life is to find our purpose, live it, and inspire others to do the same.
llama_print_timings:        load time =    1219.62 ms
llama_print_timings:      sample time =       2.58 ms /    64 runs   (    0.04 ms per token, 24806.20 tokens per second)
llama_print_timings: prompt eval time =    1218.08 ms /     8 tokens (  152.26 ms per token,     6.57 tokens per second)
llama_print_timings:        eval time =   10560.65 ms /    63 runs   (  167.63 ms per token,     5.97 tokens per second)
llama_print_timings:       total time =   11791.88 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 10.547 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 19.65 seconds per pass - ETA 0.32 minutes
[1]4.3301,
llama_print_timings:        load time =    1260.33 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   19650.70 ms /   128 tokens (  153.52 ms per token,     6.51 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   19662.89 ms /   129 tokens
...
-Mahatma Gandhi
This entry
llama_print_timings:        load time =    1343.99 ms
llama_print_timings:      sample time =       2.65 ms /    64 runs   (    0.04 ms per token, 24132.73 tokens per second)
llama_print_timings: prompt eval time =    1230.25 ms /     8 tokens (  153.78 ms per token,     6.50 tokens per second)
llama_print_timings:        eval time =   10936.56 ms /    63 runs   (  173.60 ms per token,     5.76 tokens per second)
llama_print_timings:       total time =   12180.33 ms /    71 tokens
Log end
...
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 19.97 seconds per pass - ETA 0.32 minutes
[1]4.2513,
llama_print_timings:        load time =    1296.28 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   19970.20 ms /   128 tokens (  156.02 ms per token,     6.41 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   19982.16 ms /   129 tokens
...
llama_print_timings:        load time =     883.68 ms
llama_print_timings:      sample time =       2.69 ms /    64 runs   (    0.04 ms per token, 23791.82 tokens per second)
llama_print_timings: prompt eval time =    1147.09 ms /     8 tokens (  143.39 ms per token,     6.97 tokens per second)
llama_print_timings:        eval time =    9803.72 ms /    63 runs   (  155.61 ms per token,     6.43 tokens per second)
llama_print_timings:       total time =   10964.65 ms /    71 tokens
Log end
...
[1]5.6472,
llama_print_timings:        load time =     864.44 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18550.95 ms /   128 tokens (  144.93 ms per token,     6.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18563.42 ms /   129 tokens
...
llama_print_timings:        load time =    1004.10 ms
llama_print_timings:      sample time =       2.63 ms /    64 runs   (    0.04 ms per token, 24297.65 tokens per second)
llama_print_timings: prompt eval time =    1078.55 ms /     8 tokens (  134.82 ms per token,     7.42 tokens per second)
llama_print_timings:        eval time =    9351.58 ms /    63 runs   (  148.44 ms per token,     6.74 tokens per second)
llama_print_timings:       total time =   10443.65 ms /    71 tokens
Log end
...
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 17.58 seconds per pass - ETA 0.28 minutes
[1]4.4127,
llama_print_timings:        load time =     979.54 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17580.41 ms /   128 tokens (  137.35 ms per token,     7.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17592.74 ms /   129 tokens
...
llama_print_timings:        load time =    1152.37 ms
llama_print_timings:      sample time =       2.66 ms /    64 runs   (    0.04 ms per token, 24078.25 tokens per second)
llama_print_timings: prompt eval time =     954.04 ms /     8 tokens (  119.26 ms per token,     8.39 tokens per second)
llama_print_timings:        eval time =    8363.34 ms /    63 runs   (  132.75 ms per token,     7.53 tokens per second)
llama_print_timings:       total time =    9331.40 ms /    71 tokens
Log end
...
[1]4.1904,
llama_print_timings:        load time =    1047.63 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15455.77 ms /   128 tokens (  120.75 ms per token,     8.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15467.67 ms /   129 tokens
...
llama_print_timings:        load time =    1344.87 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23934.18 tokens per second)
llama_print_timings: prompt eval time =    1309.75 ms /     8 tokens (  163.72 ms per token,     6.11 tokens per second)
llama_print_timings:        eval time =   11175.51 ms /    63 runs   (  177.39 ms per token,     5.64 tokens per second)
llama_print_timings:       total time =   12499.51 ms /    71 tokens
Log end
...
[1]4.2279,
llama_print_timings:        load time =    1325.80 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21294.35 ms /   128 tokens (  166.36 ms per token,     6.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21306.50 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1343.15 ms /     8 tokens (  167.89 ms per token,     5.96 tokens per second)
llama_print_timings:        eval time =   11493.03 ms /    63 runs   (  182.43 ms per token,     5.48 tokens per second)
llama_print_timings:       total time =   12850.10 ms /    71 tokens
Log end
...
[1]4.2383,
llama_print_timings:        load time =    1492.96 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21807.27 ms /   128 tokens (  170.37 ms per token,     5.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21819.72 ms /   129 tokens
...
first run: The quick brown fox jump on the bed, he get bump on the head.
I don’


second run: The quick brown fox jump on the bed, he get bump on the head.
I don’


single seq run: The quick brown fox jump on the bed, he get bump on the head.
I don’
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 65.673 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 8.90 seconds per pass - ETA 0.13 minutes
[1]9.1017,
llama_print_timings:        load time =    3363.09 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8901.53 ms /   128 tokens (   69.54 ms per token,    14.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8968.84 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 61.292 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 8.90 seconds per pass - ETA 0.13 minutes
[1]7.0172,
llama_print_timings:        load time =    5944.26 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8898.83 ms /   128 tokens (   69.52 ms per token,    14.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8961.91 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 67.296 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.14 seconds per pass - ETA 0.23 minutes
[1]9.1324,
llama_print_timings:        load time =    1659.06 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14143.00 ms /   128 tokens (  110.49 ms per token,     9.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14211.88 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 64.853 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.14 seconds per pass - ETA 0.23 minutes
[1]7.0274,
llama_print_timings:        load time =    4017.72 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14142.73 ms /   128 tokens (  110.49 ms per token,     9.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14208.79 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 60.973 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.14 seconds per pass - ETA 0.23 minutes
[1]7.0294,
llama_print_timings:        load time =    4639.61 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14137.78 ms /   128 tokens (  110.45 ms per token,     9.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14199.97 ms /   129 tokens
...
0.35user 2.92system 0:03.28elapsed 100%CPU (0avgtext+0avgdata 6877620maxresident)k
...
0.10user 2.76system 0:02.86elapsed 100%CPU (0avgtext+0avgdata 6877164maxresident)k
