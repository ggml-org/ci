...
- status:  SUCCESS ✅
- runtime: 511.41
- date:    Sat May 25 11:48:00 EEST 2024
...
20/22 Test #20: test-backend-ops .................   Passed  123.13 sec
      Start 21: test-rope
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.51 ms /     9 tokens (    1.39 ms per token,   719.60 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
