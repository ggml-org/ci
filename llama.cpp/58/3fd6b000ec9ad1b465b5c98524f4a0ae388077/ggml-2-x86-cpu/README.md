...
- status:  SUCCESS ✅
- runtime: 18:42.72
- date:    Wed May 15 07:03:13 UTC 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/583fd6b000ec9ad1b465b5c98524f4a0ae388077
...
llama_print_timings: prompt eval time =       4.04 ms /     9 tokens (    0.45 ms per token,  2227.17 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      53.54 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.87 ms /     9 tokens (    0.43 ms per token,  2327.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
- Judging the probability of an event based on how easily examples come to mind.
-
llama_print_timings:        load time =    1227.45 ms
llama_print_timings:      sample time =      47.58 ms /    32 runs   (    1.49 ms per token,   672.58 tokens per second)
llama_print_timings: prompt eval time =    1132.72 ms /     2 tokens (  566.36 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20760.33 ms /    31 runs   (  669.69 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22073.83 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say money can't buy happiness, but it can buy access to experiences that make you truly happy.  What are some experiences that can be purchased with money
llama_print_timings:        load time =    1218.62 ms
llama_print_timings:      sample time =      47.52 ms /    32 runs   (    1.48 ms per token,   673.46 tokens per second)
llama_print_timings: prompt eval time =    1166.67 ms /     2 tokens (  583.33 ms per token,     1.71 tokens per second)
llama_print_timings:        eval time =   20969.44 ms /    31 runs   (  676.43 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22316.66 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say the future belongs to those who believe in the beauty of their dreams. And that dream is the most powerful thing in the world.

**Questions:**


llama_print_timings:        load time =    1223.32 ms
llama_print_timings:      sample time =      47.74 ms /    32 runs   (    1.49 ms per token,   670.35 tokens per second)
llama_print_timings: prompt eval time =    1131.71 ms /     2 tokens (  565.86 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20962.09 ms /    31 runs   (  676.20 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22274.25 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a mystical forest, there lived a group of fairies.

**Part 1: The Gathering**

- The fairies gathered in the clearing, discussing
llama_print_timings:        load time =    1244.48 ms
llama_print_timings:      sample time =      47.69 ms /    32 runs   (    1.49 ms per token,   671.06 tokens per second)
llama_print_timings: prompt eval time =    2587.04 ms /     5 tokens (  517.41 ms per token,     1.93 tokens per second)
llama_print_timings:        eval time =   20964.60 ms /    31 runs   (  676.28 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   23731.13 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197332.05 ms
main:    total time = 197332.05 ms
+ echo PASS
PASS
+ echo
...
<bos> If the mean and standard deviation of a population are 50 and 10 respectively, then what is the range of possible values for the population mean?


llama_print_timings:        load time =     630.26 ms
llama_print_timings:      sample time =      47.53 ms /    32 runs   (    1.49 ms per token,   673.22 tokens per second)
llama_print_timings: prompt eval time =     571.20 ms /     2 tokens (  285.60 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =   10593.18 ms /    31 runs   (  341.72 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11345.80 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197106.87 ms
main:    total time = 197106.87 ms
+ echo PASS
PASS
+ echo
...
<bos> When the poem says "The mind is a boundless sea," what does it mean?

The poem says "The mind is a boundless sea." What does it mean
llama_print_timings:        load time =     648.69 ms
llama_print_timings:      sample time =      47.48 ms /    32 runs   (    1.48 ms per token,   674.02 tokens per second)
llama_print_timings: prompt eval time =     569.12 ms /     2 tokens (  284.56 ms per token,     3.51 tokens per second)
llama_print_timings:        eval time =   10616.51 ms /    31 runs   (  342.47 ms per token,     2.92 tokens per second)
llama_print_timings:       total time =   11366.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Escape rooms are a popular form of entertainment that allow players to immerse themselves in themed experiences and work together to solve puzzles
llama_print_timings:        load time =     182.24 ms
llama_print_timings:      sample time =       7.29 ms /    32 runs   (    0.23 ms per token,  4388.97 tokens per second)
llama_print_timings: prompt eval time =      79.29 ms /     2 tokens (   39.65 ms per token,    25.22 tokens per second)
llama_print_timings:        eval time =    2177.55 ms /    31 runs   (   70.24 ms per token,    14.24 tokens per second)
llama_print_timings:       total time =    2324.95 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     156.90 ms
llama_print_timings:      sample time =       7.14 ms /    32 runs   (    0.22 ms per token,  4481.17 tokens per second)
llama_print_timings: prompt eval time =      75.62 ms /     2 tokens (   37.81 ms per token,    26.45 tokens per second)
llama_print_timings:        eval time =    2087.73 ms /    31 runs   (   67.35 ms per token,    14.85 tokens per second)
llama_print_timings:       total time =    2231.88 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekher, a prominent member of the Bharatiya Janata Party (BJP), has been accused of several serious offences, including corruption, sexual harassment and money laundering.
llama_print_timings:        load time =     161.26 ms
llama_print_timings:      sample time =       8.11 ms /    32 runs   (    0.25 ms per token,  3947.21 tokens per second)
llama_print_timings: prompt eval time =      78.90 ms /     2 tokens (   39.45 ms per token,    25.35 tokens per second)
llama_print_timings:        eval time =    2239.43 ms /    31 runs   (   72.24 ms per token,    13.84 tokens per second)
llama_print_timings:       total time =    2388.41 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When the Sun Goes Down

The lyrics describe a situation where the sun has gone down and the speaker is left alone in a dark and quiet room. The imagery suggests
llama_print_timings:        load time =     161.02 ms
llama_print_timings:      sample time =       7.41 ms /    32 runs   (    0.23 ms per token,  4318.49 tokens per second)
llama_print_timings: prompt eval time =      78.62 ms /     2 tokens (   39.31 ms per token,    25.44 tokens per second)
llama_print_timings:        eval time =    2160.83 ms /    31 runs   (   69.70 ms per token,    14.35 tokens per second)
llama_print_timings:       total time =    2308.18 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32050.56 ms
main:    total time = 32050.56 ms
+ echo PASS
PASS
+ echo
...
<bos> Shekoul was born in 1948 in the village of Beit Jina, Israel. He grew up in a religious home and learned Hebrew, Arabic
llama_print_timings:        load time =     121.95 ms
llama_print_timings:      sample time =       7.00 ms /    32 runs   (    0.22 ms per token,  4574.04 tokens per second)
llama_print_timings: prompt eval time =      68.87 ms /     2 tokens (   34.43 ms per token,    29.04 tokens per second)
llama_print_timings:        eval time =    1609.44 ms /    31 runs   (   51.92 ms per token,    19.26 tokens per second)
llama_print_timings:       total time =    1748.78 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32085.01 ms
main:    total time = 32085.01 ms
+ echo PASS
PASS
+ echo
...
<bos> Heuristics for Decision Making

**1. Availability Heuristic**

- Perception: Things that are easily recalled are more likely to be chosen.
- Decision
llama_print_timings:        load time =     119.98 ms
llama_print_timings:      sample time =       6.87 ms /    32 runs   (    0.21 ms per token,  4660.65 tokens per second)
llama_print_timings: prompt eval time =      66.92 ms /     2 tokens (   33.46 ms per token,    29.89 tokens per second)
llama_print_timings:        eval time =    1585.39 ms /    31 runs   (   51.14 ms per token,    19.55 tokens per second)
llama_print_timings:       total time =    1720.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     380.69 ms
llama_print_timings:      sample time =       2.55 ms /    64 runs   (    0.04 ms per token, 25127.60 tokens per second)
llama_print_timings: prompt eval time =     302.85 ms /     8 tokens (   37.86 ms per token,    26.42 tokens per second)
llama_print_timings:        eval time =    7472.60 ms /    63 runs   (  118.61 ms per token,     8.43 tokens per second)
llama_print_timings:       total time =    7797.29 ms /    71 tokens
Log end
...
perplexity: 4.62 seconds per pass - ETA 0.07 minutes
[1]4.2447,
llama_print_timings:        load time =     346.32 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4615.87 ms /   128 tokens (   36.06 ms per token,    27.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4629.76 ms /   129 tokens
...
llama_print_timings:        load time =     274.98 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28082.49 tokens per second)
llama_print_timings: prompt eval time =     209.08 ms /     8 tokens (   26.14 ms per token,    38.26 tokens per second)
llama_print_timings:        eval time =    5232.97 ms /    63 runs   (   83.06 ms per token,    12.04 tokens per second)
llama_print_timings:       total time =    5462.12 ms /    71 tokens
Log end
...
[1]4.2536,
llama_print_timings:        load time =     240.11 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2848.10 ms /   128 tokens (   22.25 ms per token,    44.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2862.27 ms /   129 tokens
...
llama_print_timings: prompt eval time =     202.33 ms /     8 tokens (   25.29 ms per token,    39.54 tokens per second)
llama_print_timings:        eval time =    4397.12 ms /    63 runs   (   69.80 ms per token,    14.33 tokens per second)
llama_print_timings:       total time =    4619.04 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3119.58 ms /   128 tokens (   24.37 ms per token,    41.03 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3132.85 ms /   129 tokens
...
llama_print_timings:        eval time =    4609.32 ms /    63 runs   (   73.16 ms per token,    13.67 tokens per second)
llama_print_timings:       total time =    5001.35 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5861.01 ms /   128 tokens (   45.79 ms per token,    21.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5874.17 ms /   129 tokens
...
llama_print_timings:        load time =     248.24 ms
llama_print_timings:      sample time =       2.29 ms /    64 runs   (    0.04 ms per token, 27923.21 tokens per second)
llama_print_timings: prompt eval time =     412.41 ms /     8 tokens (   51.55 ms per token,    19.40 tokens per second)
llama_print_timings:        eval time =    5007.91 ms /    63 runs   (   79.49 ms per token,    12.58 tokens per second)
llama_print_timings:       total time =    5440.18 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6231.36 ms /   128 tokens (   48.68 ms per token,    20.54 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings: prompt eval time =     428.35 ms /     8 tokens (   53.54 ms per token,    18.68 tokens per second)
llama_print_timings:        eval time =    5235.61 ms /    63 runs   (   83.10 ms per token,    12.03 tokens per second)
llama_print_timings:       total time =    5684.01 ms /    71 tokens
Log end
...
[1]4.2586,
llama_print_timings:        load time =     224.47 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6634.90 ms /   128 tokens (   51.84 ms per token,    19.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6648.28 ms /   129 tokens
...
llama_print_timings: prompt eval time =     609.54 ms /     8 tokens (   76.19 ms per token,    13.12 tokens per second)
llama_print_timings:        eval time =    5706.13 ms /    63 runs   (   90.57 ms per token,    11.04 tokens per second)
llama_print_timings:       total time =    6335.56 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9904.41 ms /   128 tokens (   77.38 ms per token,    12.92 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9917.90 ms /   129 tokens
...
llama_print_timings:        load time =     238.77 ms
llama_print_timings:      sample time =       2.27 ms /    64 runs   (    0.04 ms per token, 28131.87 tokens per second)
llama_print_timings: prompt eval time =     461.88 ms /     8 tokens (   57.73 ms per token,    17.32 tokens per second)
llama_print_timings:        eval time =    4839.35 ms /    63 runs   (   76.82 ms per token,    13.02 tokens per second)
llama_print_timings:       total time =    5321.64 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.257 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 7.43 seconds per pass - ETA 0.12 minutes
[1]4.4091,
llama_print_timings:        load time =     206.27 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7428.47 ms /   128 tokens (   58.03 ms per token,    17.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7442.24 ms /   129 tokens
...
llama_print_timings: prompt eval time =     390.21 ms /     8 tokens (   48.78 ms per token,    20.50 tokens per second)
llama_print_timings:        eval time =    4811.93 ms /    63 runs   (   76.38 ms per token,    13.09 tokens per second)
llama_print_timings:       total time =    5222.16 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.255 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 6.31 seconds per pass - ETA 0.10 minutes
[1]4.1768,
llama_print_timings:        load time =     203.92 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6309.59 ms /   128 tokens (   49.29 ms per token,    20.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6322.96 ms /   129 tokens
...
-
llama_print_timings:        load time =     268.28 ms
...
llama_print_timings:        eval time =    5721.64 ms /    63 runs   (   90.82 ms per token,    11.01 tokens per second)
llama_print_timings:       total time =    6198.21 ms /    71 tokens
Log end
...
[1]4.2338,
llama_print_timings:        load time =     234.05 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7441.23 ms /   128 tokens (   58.13 ms per token,    17.20 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7455.06 ms /   129 tokens
...
llama_print_timings: prompt eval time =     521.06 ms /     8 tokens (   65.13 ms per token,    15.35 tokens per second)
llama_print_timings:        eval time =    6263.28 ms /    63 runs   (   99.42 ms per token,    10.06 tokens per second)
llama_print_timings:       total time =    6804.39 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     258.38 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8189.10 ms /   128 tokens (   63.98 ms per token,    15.63 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8202.86 ms /   129 tokens
...
llama_new_context_with_model: graph nodes  = 838
llama_new_context_with_model: graph splits = 1
main : serialized state into 1798868 out of a maximum of 236005464 bytes
llama_new_context_with_model: n_ctx      = 512
llama_new_context_with_model: n_batch    = 512
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: flash_attn = 0
...
llama_new_context_with_model: graph nodes  = 838
llama_new_context_with_model: graph splits = 1
main : deserialized state from 1798868 out of a maximum of 236005464 bytes
llama_new_context_with_model: n_ctx      = 512
llama_new_context_with_model: n_batch    = 512
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: flash_attn = 0
...
first run: The quick brown fox jumped over the lazy dog. Here divertated from the text above as you


second run: The quick brown fox jumped over the lazy dog. Here divertated from the text above as you


single seq run: The quick brown fox jumped over the lazy dog. Here divertated from the text above as you
...
0.35user 0.33system 0:00.69elapsed 99%CPU (0avgtext+0avgdata 6880624maxresident)k
0inputs+40outputs (0major+115223minor)pagefaults 0swaps
```
...
0.12user 0.35system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 6880316maxresident)k
0inputs+40outputs (0major+115216minor)pagefaults 0swaps
```
