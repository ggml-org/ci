...
- status:  SUCCESS ✅
- runtime: 467.19
- date:    Sat Mar  2 20:06:02 EET 2024
...
Label Time Summary:
main    = 225.47 sec*proc (21 tests)

Total Test time (real) = 225.48 sec
...
llama_print_timings:        load time =      54.92 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.28 ms /     9 tokens (    1.14 ms per token,   875.15 tokens per second)
