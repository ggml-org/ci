...
- status:  SUCCESS ✅
- runtime: 24:14.51
- date:    Thu Apr 25 17:06:18 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 9/23 Test  #9: test-tokenizer-1-falcon .............   Passed    6.42 sec
...
llama_print_timings:        load time =      40.92 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      19.18 ms /     9 tokens (    2.13 ms per token,   469.19 tokens per second)
...
<bos> Once upon a time, there was a princess named Anya who dreamt of a world where magic and kindness were intertwined.

One day, Anya stumbled upon a hidden grove where a magical
llama_print_timings:        load time =    3806.19 ms
llama_print_timings:      sample time =      41.61 ms /    32 runs   (    1.30 ms per token,   768.97 tokens per second)
llama_print_timings: prompt eval time =    6382.16 ms /     5 tokens ( 1276.43 ms per token,     0.78 tokens per second)
llama_print_timings:        eval time =   49918.82 ms /    31 runs   ( 1610.28 ms per token,     0.62 tokens per second)
llama_print_timings:       total time =   56456.53 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After the Great War, the world faced a severe economic depression. The global economy was in a poor state, with unemployment rates reaching unprecedented levels. Unemployment led to a
llama_print_timings:        load time =    3791.24 ms
llama_print_timings:      sample time =      41.61 ms /    32 runs   (    1.30 ms per token,   768.99 tokens per second)
llama_print_timings: prompt eval time =    2797.93 ms /     2 tokens ( 1398.97 ms per token,     0.71 tokens per second)
llama_print_timings:        eval time =   49852.38 ms /    31 runs   ( 1608.14 ms per token,     0.62 tokens per second)
llama_print_timings:       total time =   52806.89 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekhs are a group of nomadic people traditionally residing in the Thar Desert of northern India and Pakistan.

**Identify the characteristics that differentiate the Shekhs from
llama_print_timings:        load time =    3786.95 ms
llama_print_timings:      sample time =      41.32 ms /    32 runs   (    1.29 ms per token,   774.42 tokens per second)
llama_print_timings: prompt eval time =    2799.22 ms /     2 tokens ( 1399.61 ms per token,     0.71 tokens per second)
llama_print_timings:        eval time =   49873.71 ms /    31 runs   ( 1608.83 ms per token,     0.62 tokens per second)
llama_print_timings:       total time =   52827.86 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the mean of two random variables X and Y is 5 and the covariance between X and Y is 10, then what is the correlation coefficient between X
llama_print_timings:        load time =    1111.27 ms
llama_print_timings:      sample time =       7.64 ms /    32 runs   (    0.24 ms per token,  4190.13 tokens per second)
llama_print_timings: prompt eval time =     168.41 ms /     2 tokens (   84.20 ms per token,    11.88 tokens per second)
llama_print_timings:        eval time =    3158.86 ms /    31 runs   (  101.90 ms per token,     9.81 tokens per second)
llama_print_timings:       total time =    3366.67 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a young girl named Anya. She had bright eyes that sparkled with mischief and a smile that could brighten the darkest room.

One sunny afternoon
llama_print_timings:        load time =    1091.82 ms
llama_print_timings:      sample time =       7.98 ms /    32 runs   (    0.25 ms per token,  4012.04 tokens per second)
llama_print_timings: prompt eval time =     369.89 ms /     5 tokens (   73.98 ms per token,    13.52 tokens per second)
llama_print_timings:        eval time =    3166.55 ms /    31 runs   (  102.15 ms per token,     9.79 tokens per second)
llama_print_timings:       total time =    3576.44 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the mean of the following data set is 52, then the standard deviation of the data set is approximately 9.
...
llama_print_timings: prompt eval time =     167.52 ms /     2 tokens (   83.76 ms per token,    11.94 tokens per second)
llama_print_timings:        eval time =    3148.29 ms /    31 runs   (  101.56 ms per token,     9.85 tokens per second)
llama_print_timings:       total time =    3354.91 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 25784.22 ms
main:    total time = 25784.22 ms
+ echo PASS
PASS
+ echo
...
<bos> When I Breathe Underwater, I Feel Alive.

While diving deep beneath the waves, I am filled with a sense of tranquility and awe. The pressure holds me steady
llama_print_timings:        load time =     765.29 ms
llama_print_timings:      sample time =       7.90 ms /    32 runs   (    0.25 ms per token,  4053.20 tokens per second)
llama_print_timings: prompt eval time =     158.96 ms /     2 tokens (   79.48 ms per token,    12.58 tokens per second)
llama_print_timings:        eval time =    2972.35 ms /    31 runs   (   95.88 ms per token,    10.43 tokens per second)
llama_print_timings:       total time =    3171.60 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 25968.25 ms
main:    total time = 25968.25 ms
+ echo PASS
PASS
+ echo
...
**Get Together** is the latest expansion pack for The Sims 4, bringing the excitement of social interaction and gatherings to the
llama_print_timings:        load time =     775.86 ms
llama_print_timings:      sample time =       7.91 ms /    32 runs   (    0.25 ms per token,  4047.05 tokens per second)
llama_print_timings: prompt eval time =     158.58 ms /     2 tokens (   79.29 ms per token,    12.61 tokens per second)
llama_print_timings:        eval time =    2950.91 ms /    31 runs   (   95.19 ms per token,    10.51 tokens per second)
llama_print_timings:       total time =    3149.35 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    3276.47 ms
llama_print_timings:      sample time =       2.75 ms /    64 runs   (    0.04 ms per token, 23281.19 tokens per second)
llama_print_timings: prompt eval time =    2284.67 ms /     8 tokens (  285.58 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =   20022.50 ms /    63 runs   (  317.82 ms per token,     3.15 tokens per second)
llama_print_timings:       total time =   22321.01 ms /    71 tokens
Log end
...
[1]4.2442,
llama_print_timings:        load time =    3248.26 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36847.00 ms /   128 tokens (  287.87 ms per token,     3.47 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36858.80 ms /   129 tokens
...
llama_print_timings:        load time =    1668.03 ms
llama_print_timings:      sample time =       2.65 ms /    64 runs   (    0.04 ms per token, 24169.18 tokens per second)
llama_print_timings: prompt eval time =     915.93 ms /     8 tokens (  114.49 ms per token,     8.73 tokens per second)
llama_print_timings:        eval time =    8658.82 ms /    63 runs   (  137.44 ms per token,     7.28 tokens per second)
llama_print_timings:       total time =    9589.22 ms /    71 tokens
Log end
...
[1]4.2615,
llama_print_timings:        load time =    1649.09 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14669.37 ms /   128 tokens (  114.60 ms per token,     8.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14680.86 ms /   129 tokens
...
llama_print_timings: prompt eval time =     941.85 ms /     8 tokens (  117.73 ms per token,     8.49 tokens per second)
llama_print_timings:        eval time =    8138.72 ms /    63 runs   (  129.19 ms per token,     7.74 tokens per second)
llama_print_timings:       total time =    9094.80 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15266.74 ms /   128 tokens (  119.27 ms per token,     8.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15279.40 ms /   129 tokens
...
llama_print_timings: prompt eval time =     992.92 ms /     8 tokens (  124.12 ms per token,     8.06 tokens per second)
llama_print_timings:        eval time =    8644.17 ms /    63 runs   (  137.21 ms per token,     7.29 tokens per second)
llama_print_timings:       total time =    9651.68 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   16178.31 ms /   128 tokens (  126.39 ms per token,     7.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   16190.74 ms /   129 tokens
...
llama_print_timings:        load time =    1275.29 ms
llama_print_timings:      sample time =       2.70 ms /    64 runs   (    0.04 ms per token, 23668.64 tokens per second)
llama_print_timings: prompt eval time =    1263.90 ms /     8 tokens (  157.99 ms per token,     6.33 tokens per second)
llama_print_timings:        eval time =   10891.23 ms /    63 runs   (  172.88 ms per token,     5.78 tokens per second)
llama_print_timings:       total time =   12168.98 ms /    71 tokens
Log end
...
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 20.56 seconds per pass - ETA 0.33 minutes
[1]4.3466,
llama_print_timings:        load time =    1243.88 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20562.44 ms /   128 tokens (  160.64 ms per token,     6.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20574.42 ms /   129 tokens
...
llama_print_timings:        eval time =   11244.64 ms /    63 runs   (  178.49 ms per token,     5.60 tokens per second)
llama_print_timings:       total time =   12524.79 ms /    71 tokens
Log end
...
[1]4.2557,
llama_print_timings:        load time =    1359.91 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20424.65 ms /   128 tokens (  159.57 ms per token,     6.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20436.40 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1180.09 ms /     8 tokens (  147.51 ms per token,     6.78 tokens per second)
llama_print_timings:        eval time =   10026.45 ms /    63 runs   (  159.15 ms per token,     6.28 tokens per second)
llama_print_timings:       total time =   11220.09 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   19070.80 ms /   128 tokens (  148.99 ms per token,     6.71 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   19082.32 ms /   129 tokens
...
llama_print_timings:        load time =    1006.39 ms
llama_print_timings:      sample time =       2.65 ms /    64 runs   (    0.04 ms per token, 24150.94 tokens per second)
llama_print_timings: prompt eval time =    1113.81 ms /     8 tokens (  139.23 ms per token,     7.18 tokens per second)
llama_print_timings:        eval time =    9585.29 ms /    63 runs   (  152.15 ms per token,     6.57 tokens per second)
llama_print_timings:       total time =   10714.13 ms /    71 tokens
Log end
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18115.92 ms /   129 tokens
...
I
llama_print_timings:        load time =    1142.41 ms
llama_print_timings:      sample time =       2.70 ms /    64 runs   (    0.04 ms per token, 23721.28 tokens per second)
llama_print_timings: prompt eval time =     988.32 ms /     8 tokens (  123.54 ms per token,     8.09 tokens per second)
llama_print_timings:        eval time =    8608.61 ms /    63 runs   (  136.64 ms per token,     7.32 tokens per second)
llama_print_timings:       total time =    9611.19 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15979.60 ms /   128 tokens (  124.84 ms per token,     8.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15991.92 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1349.88 ms /     8 tokens (  168.73 ms per token,     5.93 tokens per second)
llama_print_timings:        eval time =   11400.61 ms /    63 runs   (  180.96 ms per token,     5.53 tokens per second)
llama_print_timings:       total time =   12764.71 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21785.79 ms /   128 tokens (  170.20 ms per token,     5.88 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21798.14 ms /   129 tokens
...
llama_print_timings:        load time =    1510.52 ms
...
llama_print_timings:        eval time =   11731.24 ms /    63 runs   (  186.21 ms per token,     5.37 tokens per second)
llama_print_timings:       total time =   13124.10 ms /    71 tokens
Log end
...
[1]4.2451,
llama_print_timings:        load time =    1474.45 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22342.37 ms /   128 tokens (  174.55 ms per token,     5.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22354.36 ms /   129 tokens
...
Back to "gynecological" versions:
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 63.268 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.85 seconds per pass - ETA 0.60 minutes
[1]9.1017,
llama_print_timings:        load time =    3107.19 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36850.01 ms /   128 tokens (  287.89 ms per token,     3.47 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36915.17 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 62.766 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.86 seconds per pass - ETA 0.60 minutes
[1]7.0171,
llama_print_timings:        load time =    6209.76 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36856.21 ms /   128 tokens (  287.94 ms per token,     3.47 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36920.29 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 64.645 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.67 seconds per pass - ETA 0.23 minutes
[1]9.1296,
llama_print_timings:        load time =    1669.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14670.08 ms /   128 tokens (  114.61 ms per token,     8.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14736.38 ms /   129 tokens
...
perplexity: 14.67 seconds per pass - ETA 0.23 minutes
[1]6.9856,
llama_print_timings:        load time =    4418.25 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14670.29 ms /   128 tokens (  114.61 ms per token,     8.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14733.47 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 60.329 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.68 seconds per pass - ETA 0.23 minutes
[1]6.9967,
llama_print_timings:        load time =    5160.67 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14675.45 ms /   128 tokens (  114.65 ms per token,     8.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14737.98 ms /   129 tokens
...
0.37user 2.76system 0:03.13elapsed 100%CPU (0avgtext+0avgdata 6877624maxresident)k
