...
- status:  SUCCESS ✅
- runtime: 17:28.50
- date:    Thu Aug 17 18:24:34 UTC 2023
...
llama_print_timings:        load time =  2512.50 ms
llama_print_timings:      sample time =   147.22 ms /   256 runs   (    0.58 ms per token,  1738.94 tokens per second)
llama_print_timings: prompt eval time =   167.91 ms /     8 tokens (   20.99 ms per token,    47.65 tokens per second)
llama_print_timings:        eval time =  4920.32 ms /   255 runs   (   19.30 ms per token,    51.83 tokens per second)
llama_print_timings:       total time =  5303.06 ms
...
llama_print_timings: prompt eval time = 12603.41 ms /  8192 tokens (    1.54 ms per token,   649.98 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 18812.00 ms
...
llama_print_timings:        load time =  1504.52 ms
...
llama_print_timings:        eval time =  3302.55 ms /   255 runs   (   12.95 ms per token,    77.21 tokens per second)
llama_print_timings:       total time =  3684.09 ms
...
llama_print_timings:        load time =  3740.83 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 12612.74 ms /  8192 tokens (    1.54 ms per token,   649.50 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 17866.16 ms
...
llama_print_timings:        load time =  1000.91 ms
...
llama_print_timings:        eval time =  2283.60 ms /   255 runs   (    8.96 ms per token,   111.67 tokens per second)
llama_print_timings:       total time =  2621.89 ms
...
llama_print_timings:        load time =  3089.93 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 11876.99 ms /  8192 tokens (    1.45 ms per token,   689.74 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 16527.34 ms
...
llama_print_timings:        load time =  1055.58 ms
llama_print_timings:      sample time =   144.89 ms /   256 runs   (    0.57 ms per token,  1766.81 tokens per second)
llama_print_timings: prompt eval time =   127.68 ms /     8 tokens (   15.96 ms per token,    62.66 tokens per second)
llama_print_timings:        eval time =  2375.56 ms /   255 runs   (    9.32 ms per token,   107.34 tokens per second)
llama_print_timings:       total time =  2719.83 ms
...
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 11868.83 ms /  8192 tokens (    1.45 ms per token,   690.21 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 16619.90 ms
...
llama_print_timings:        eval time =  2633.48 ms /   255 runs   (   10.33 ms per token,    96.83 tokens per second)
llama_print_timings:       total time =  2971.29 ms
...
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 11817.11 ms /  8192 tokens (    1.44 ms per token,   693.23 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 16593.72 ms
...
llama_print_timings:        load time =  1142.36 ms
llama_print_timings:      sample time =   147.69 ms /   256 runs   (    0.58 ms per token,  1733.31 tokens per second)
llama_print_timings: prompt eval time =   125.31 ms /     8 tokens (   15.66 ms per token,    63.84 tokens per second)
llama_print_timings:        eval time =  2673.27 ms /   255 runs   (   10.48 ms per token,    95.39 tokens per second)
llama_print_timings:       total time =  3013.06 ms
...
llama_print_timings:        load time =  3347.75 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 11856.55 ms /  8192 tokens (    1.45 ms per token,   690.93 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 16761.06 ms
...
generate: n_ctx = 512, n_batch = 512, n_predict = 256, n_keep = 0
 ...
 I believe the meaning of life is to create something meaningful for others. If you are not able, how can we help?
I've lost my way! My whole existence has been full of pain and suffering... There have never in a century where anyone was as miserable than me." 1950s - I hope it will be easy ... The only thing to remember is that the past should not think too far, after all.
I had two brothers one died when he got married; And another brother who became deaf and dumb! A life of misery may have more meaning... What would you say? In this way we can better understand each other's personality characteristics.... 1980 - I hope it will be easy ... The only thing to remember is that the past should not think too far, after all.
I was born in a small town of Qingyun; And my hometown and home are both on mountains... There have never been as much love for anything than me! "1985s - I hope it will be easy ... The only thing to remember is that the past should not think too far, after all.
I am a girl who has two brothers one died when he got married; And another brother how became deaf and dumb
llama_print_timings:        load time =   727.49 ms
...
llama_print_timings:        eval time =  2377.28 ms /   255 runs   (    9.32 ms per token,   107.27 tokens per second)
llama_print_timings:       total time =  2717.86 ms
...
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 3.18 seconds per pass - ETA 0 minutes
[1]7.1048,[2]10.1782,[3]11.9979,[4]12.3487,
llama_print_timings:        load time =  2840.46 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 11894.45 ms /  8192 tokens (    1.45 ms per token,   688.72 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 16292.49 ms
...
generate: n_ctx = 512, n_batch = 512, n_predict = 256, n_keep = 0
 ...
 I believe the meaning of life is to have fun. In my opinion, it’s not worth living a boring and stressful lifestyle that doesn’t even consist of any sort of joy or happiness for someone who wants more out of their time on Earth than merely having basic needs met every day until they die from old age at some point in the future? I believe life should be spent doing things you want to do, not what others tell a person is needed. So far my experiences have told me that it’s best for people who are independent thinkers and don’t take advice of other sources too seriously without first thinking through any given suggestion or command in their minds carefully before accepting its validity as being good enough by the source itself, because most often such directives from others can be misguided at times. There is also more than one way to do things; there are no right ways and wrong ones either- it’s all about what works best for each individual person themselves personally in their own unique fashion depending on where life takes them next by virtue of whatever happens during those moments when some event occurs along the timeline which affects an outcome (usually good or bad) that will change someone forever without warning.
It is a question asked often, What are we here to do? The answer seems
llama_print_timings:        load time =   863.27 ms
...
llama_print_timings:        eval time =  2983.52 ms /   255 runs   (   11.70 ms per token,    85.47 tokens per second)
llama_print_timings:       total time =  3364.36 ms
...
[1]5.0944,[2]6.6759,[3]7.7395,[4]7.6744,
llama_print_timings:        load time =  2966.18 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 12560.91 ms /  8192 tokens (    1.53 ms per token,   652.18 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 17031.68 ms
...
generate: n_ctx = 512, n_batch = 512, n_predict = 256, n_keep = 0
 ...
 I believe the meaning of life is to do with one's own happiness, and that it comes from achieving a sense of self-fulfilment through experiencing what you enjoy. To achieve this requires fulfilling your needs as well as desires:
This would make someone contented if they achieved these things - but not necessarily happy (though I wouldn't be surprised if there were some correlation between the two). But, to me happiness involves something greater than achieving just our own personal needs and wants alone. It is about being fulfilled through experiencing what we enjoy together with other people:
Now it may seem as though a person who achieves only their own self-fulfilment cannot possibly be happy - at least not in the way that I've just defined happiness above (though there are probably many exceptions to this). So then, how can one achieve both personal fulfilment and social/ethical satisfaction?
I believe it is through being able to share our enjoyment with others: This may involve sharing an enjoyable activity or a more general level of contentment that we experience when around people who make us feel good. Either way the outcome should be the same - whether its from doing something together, feeling emotionally close (e.g., laughing) or experiencing mutual respect and other feelings of connection with others
llama_print_timings:        load time =   970.33 ms
llama_print_timings:      sample time =   149.72 ms /   256 runs   (    0.58 ms per token,  1709.84 tokens per second)
llama_print_timings: prompt eval time =   159.97 ms /     8 tokens (   20.00 ms per token,    50.01 tokens per second)
llama_print_timings:        eval time =  2493.43 ms /   255 runs   (    9.78 ms per token,   102.27 tokens per second)
...
[1]4.8712,[2]6.4229,[3]7.4369,[4]7.3549,
llama_print_timings:        load time =  3158.41 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 12459.60 ms /  8192 tokens (    1.52 ms per token,   657.49 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 17152.76 ms
...
I can remember when my son was born and there was a time that he wasn’t able to stand up straight because his head hadn’t fully matured, if it got knocked forwards by another child they would have been in trouble! I spent every day of those three months watching him sleep wondering what the future held. He may never speak properly again or be able to look after himself when he is older and then one night out with friends my son suddenly said that his little sister was a bad person because she didn’t like how people dressed in their school uniform!
I couldn’t believe it, I thought “wow you are getting words now” but as the days went on more things became clear to me. He had learned from someone else and he knew who or what they were talking about even though we hadn’t told him that sort of thing was wrong before hand!
It made my blood boil at first, until I started thinking about it properly; if this little boy can teach his big brother not only how to talk but also understand other people then surely there is a message in that? If he could do all the things we had just seen him doing without us telling them
llama_print_timings:        load time =  1102.54 ms
llama_print_timings:      sample time =   152.81 ms /   256 runs   (    0.60 ms per token,  1675.26 tokens per second)
llama_print_timings: prompt eval time =   125.15 ms /     8 tokens (   15.64 ms per token,    63.93 tokens per second)
llama_print_timings:        eval time =  2829.47 ms /   255 runs   (   11.10 ms per token,    90.12 tokens per second)
llama_print_timings:       total time =  3180.17 ms
...
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 3.17 seconds per pass - ETA 0 minutes
[1]4.8155,[2]6.3793,[3]7.3992,[4]7.2881,
llama_print_timings:        load time =  3194.30 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 11856.48 ms /  8192 tokens (    1.45 ms per token,   690.93 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 16615.84 ms
...
llama_print_timings:        load time =  1285.95 ms
llama_print_timings:      sample time =   146.09 ms /   256 runs   (    0.57 ms per token,  1752.34 tokens per second)
llama_print_timings: prompt eval time =   119.08 ms /     8 tokens (   14.88 ms per token,    67.18 tokens per second)
llama_print_timings:        eval time =  3102.92 ms /   255 runs   (   12.17 ms per token,    82.18 tokens per second)
...
llama_print_timings:        load time =  3358.69 ms
llama_print_timings:      sample time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time = 11812.23 ms /  8192 tokens (    1.44 ms per token,   693.52 tokens per second)
llama_print_timings:        eval time =     0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time = 16731.93 ms
