...
- status:  SUCCESS ✅
- runtime: 363.90
- date:    Sat May 18 11:10:06 EEST 2024
...
20/22 Test #20: test-backend-ops .................   Passed  122.75 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 183.98 sec*proc (22 tests)

Total Test time (real) = 183.99 sec
...
llama_print_timings: prompt eval time =       9.05 ms /     9 tokens (    1.01 ms per token,   994.59 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.23 ms /     9 tokens (    1.25 ms per token,   801.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
