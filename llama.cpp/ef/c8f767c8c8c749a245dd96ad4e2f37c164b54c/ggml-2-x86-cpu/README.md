...
- status:  SUCCESS ✅
- runtime: 18:38.65
- date:    Tue May 14 07:49:19 UTC 2024
...
11/22 Test #11: test-tokenizer-1-llama-spm .......   Passed    0.45 sec
      Start 12: test-quantize-fns
12/22 Test #12: test-quantize-fns ................   Passed   15.85 sec
      Start 13: test-quantize-perf
...
llama_print_timings: prompt eval time =       4.22 ms /     9 tokens (    0.47 ms per token,  2134.22 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.87 ms /     9 tokens (    0.43 ms per token,  2324.98 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Soar! is a non-profit organization dedicated to empowering young women with the tools and resources to achieve their full potential and create positive change in the world.
...
llama_print_timings: prompt eval time =    1135.23 ms /     2 tokens (  567.62 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20797.06 ms /    31 runs   (  670.87 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22115.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heissler Company has been operating for over 100 years. Heissler is a leading provider of thermal management and filtration solutions for industrial and commercial applications
llama_print_timings:        load time =    1216.43 ms
llama_print_timings:      sample time =      47.72 ms /    32 runs   (    1.49 ms per token,   670.56 tokens per second)
llama_print_timings: prompt eval time =    1134.62 ms /     2 tokens (  567.31 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20689.65 ms /    31 runs   (  667.41 ms per token,     1.50 tokens per second)
llama_print_timings:       total time =   22006.90 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekera University organized a cultural extravaganza, showcasing the rich heritage of Kerala through dance, music, and drama. The event brought together people from all walks of
...
llama_print_timings:        eval time =   20935.30 ms /    31 runs   (  675.33 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22250.22 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekoul, a resident of the village of Ma'aleh, is known for his deep connection to nature and his passion for sustainable practices. He often engages
...
llama_print_timings: prompt eval time =    1135.71 ms /     2 tokens (  567.86 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20936.98 ms /    31 runs   (  675.39 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22255.95 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196860.85 ms
main:    total time = 196860.85 ms
+ echo PASS
PASS
+ echo
...
<bos> After a thorough review of our systems and processes, we have identified significant inefficiencies in our supply chain management.

**To address this issue, we have decided to
...
llama_print_timings: prompt eval time =     574.67 ms /     2 tokens (  287.34 ms per token,     3.48 tokens per second)
llama_print_timings:        eval time =   10585.71 ms /    31 runs   (  341.47 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11343.89 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196974.84 ms
main:    total time = 196974.84 ms
+ echo PASS
PASS
+ echo
...
<bos> When I Breathe Easy.

This poem is about a moment of serenity and calm that comes from deep breathing.
...
llama_print_timings: prompt eval time =     575.25 ms /     2 tokens (  287.62 ms per token,     3.48 tokens per second)
llama_print_timings:        eval time =   10619.89 ms /    31 runs   (  342.58 ms per token,     2.92 tokens per second)
llama_print_timings:       total time =   11378.16 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the cost price of a commodity is $80 per unit, and the market price is $90 per unit, what is the percentage of markup?


llama_print_timings:        load time =     166.69 ms
llama_print_timings:      sample time =       6.77 ms /    32 runs   (    0.21 ms per token,  4726.74 tokens per second)
llama_print_timings: prompt eval time =      75.68 ms /     2 tokens (   37.84 ms per token,    26.43 tokens per second)
llama_print_timings:        eval time =    2092.26 ms /    31 runs   (   67.49 ms per token,    14.82 tokens per second)
llama_print_timings:       total time =    2235.91 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After a period of heavy rain, the ground is saturated with water. A drain pipe is clogged with roots and debris. What is the most efficient and safe way to
llama_print_timings:        load time =     156.09 ms
llama_print_timings:      sample time =       7.05 ms /    32 runs   (    0.22 ms per token,  4538.36 tokens per second)
llama_print_timings: prompt eval time =      75.39 ms /     2 tokens (   37.70 ms per token,    26.53 tokens per second)
llama_print_timings:        eval time =    2056.79 ms /    31 runs   (   66.35 ms per token,    15.07 tokens per second)
llama_print_timings:       total time =    2199.70 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**Discover University** is an expansion pack for The Sims 4 that allows players to create and study at one of four prestigious
llama_print_timings:        load time =     157.79 ms
llama_print_timings:      sample time =       6.77 ms /    32 runs   (    0.21 ms per token,  4725.34 tokens per second)
llama_print_timings: prompt eval time =      80.28 ms /     2 tokens (   40.14 ms per token,    24.91 tokens per second)
llama_print_timings:        eval time =    2097.70 ms /    31 runs   (   67.67 ms per token,    14.78 tokens per second)
llama_print_timings:       total time =    2245.97 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When and Where Should I Invest in Real Estate?

**1. Assess Your Financial Situation:**

- Calculate your net worth and liquidity
- Determine your investment goals
llama_print_timings:        load time =     160.42 ms
...
llama_print_timings:        eval time =    2178.47 ms /    31 runs   (   70.27 ms per token,    14.23 tokens per second)
llama_print_timings:       total time =    2325.22 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a magical land of enchantment, lived a young apprentice named Anya. Anya possessed a unique gift for weaving intricate patterns, and her creations brought both wonder and
...
llama_print_timings: prompt eval time =     120.87 ms /     5 tokens (   24.17 ms per token,    41.37 tokens per second)
llama_print_timings:        eval time =    1559.98 ms /    31 runs   (   50.32 ms per token,    19.87 tokens per second)
llama_print_timings:       total time =    1752.07 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32023.12 ms
main:    total time = 32023.12 ms
+ echo PASS
PASS
+ echo
...
The Little Prince is a novel by Antoine de Saint-Exupéry, first published in 1950. The novel tells the story
llama_print_timings:        load time =     117.75 ms
llama_print_timings:      sample time =       6.91 ms /    32 runs   (    0.22 ms per token,  4634.32 tokens per second)
llama_print_timings: prompt eval time =      65.82 ms /     2 tokens (   32.91 ms per token,    30.38 tokens per second)
llama_print_timings:        eval time =    1635.17 ms /    31 runs   (   52.75 ms per token,    18.96 tokens per second)
llama_print_timings:       total time =    1772.14 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     377.36 ms
llama_print_timings:      sample time =       2.64 ms /    64 runs   (    0.04 ms per token, 24270.00 tokens per second)
llama_print_timings: prompt eval time =     302.20 ms /     8 tokens (   37.78 ms per token,    26.47 tokens per second)
llama_print_timings:        eval time =    7326.62 ms /    63 runs   (  116.30 ms per token,     8.60 tokens per second)
llama_print_timings:       total time =    7651.56 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4640.62 ms /   128 tokens (   36.25 ms per token,    27.58 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4653.94 ms /   129 tokens
...
llama_print_timings: prompt eval time =     202.43 ms /     8 tokens (   25.30 ms per token,    39.52 tokens per second)
llama_print_timings:        eval time =    4982.77 ms /    63 runs   (   79.09 ms per token,    12.64 tokens per second)
llama_print_timings:       total time =    5204.43 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2821.25 ms /   128 tokens (   22.04 ms per token,    45.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2834.35 ms /   129 tokens
...
llama_print_timings: prompt eval time =     202.55 ms /     8 tokens (   25.32 ms per token,    39.50 tokens per second)
llama_print_timings:        eval time =    4261.44 ms /    63 runs   (   67.64 ms per token,    14.78 tokens per second)
llama_print_timings:       total time =    4483.61 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3137.09 ms /   128 tokens (   24.51 ms per token,    40.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3150.74 ms /   129 tokens
...
llama_print_timings: prompt eval time =     371.13 ms /     8 tokens (   46.39 ms per token,    21.56 tokens per second)
llama_print_timings:        eval time =    4474.62 ms /    63 runs   (   71.03 ms per token,    14.08 tokens per second)
llama_print_timings:       total time =    4866.00 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5863.27 ms /   128 tokens (   45.81 ms per token,    21.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5876.91 ms /   129 tokens
...
llama_print_timings: prompt eval time =     389.32 ms /     8 tokens (   48.67 ms per token,    20.55 tokens per second)
llama_print_timings:        eval time =    4964.92 ms /    63 runs   (   78.81 ms per token,    12.69 tokens per second)
llama_print_timings:       total time =    5374.37 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6389.61 ms /   128 tokens (   49.92 ms per token,    20.03 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6403.16 ms /   129 tokens
...
llama_print_timings: prompt eval time =     427.29 ms /     8 tokens (   53.41 ms per token,    18.72 tokens per second)
llama_print_timings:        eval time =    5185.62 ms /    63 runs   (   82.31 ms per token,    12.15 tokens per second)
llama_print_timings:       total time =    5633.03 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6636.98 ms /   128 tokens (   51.85 ms per token,    19.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6650.37 ms /   129 tokens
...
llama_print_timings: prompt eval time =     610.78 ms /     8 tokens (   76.35 ms per token,    13.10 tokens per second)
llama_print_timings:        eval time =    5684.86 ms /    63 runs   (   90.24 ms per token,    11.08 tokens per second)
llama_print_timings:       total time =    6316.35 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9917.69 ms /   128 tokens (   77.48 ms per token,    12.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9931.14 ms /   129 tokens
...
llama_print_timings: prompt eval time =     461.64 ms /     8 tokens (   57.70 ms per token,    17.33 tokens per second)
llama_print_timings:        eval time =    4819.38 ms /    63 runs   (   76.50 ms per token,    13.07 tokens per second)
llama_print_timings:       total time =    5300.74 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7532.06 ms /   128 tokens (   58.84 ms per token,    16.99 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7545.01 ms /   129 tokens
...
llama_print_timings: prompt eval time =     389.60 ms /     8 tokens (   48.70 ms per token,    20.53 tokens per second)
llama_print_timings:        eval time =    4716.92 ms /    63 runs   (   74.87 ms per token,    13.36 tokens per second)
llama_print_timings:       total time =    5125.70 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6160.79 ms /   128 tokens (   48.13 ms per token,    20.78 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6174.27 ms /   129 tokens
...
-
llama_print_timings:        load time =     263.15 ms
llama_print_timings:      sample time =       2.32 ms /    64 runs   (    0.04 ms per token, 27550.58 tokens per second)
llama_print_timings: prompt eval time =     474.32 ms /     8 tokens (   59.29 ms per token,    16.87 tokens per second)
llama_print_timings:        eval time =    5628.64 ms /    63 runs   (   89.34 ms per token,    11.19 tokens per second)
llama_print_timings:       total time =    6123.28 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7303.84 ms /   128 tokens (   57.06 ms per token,    17.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7317.38 ms /   129 tokens
...
llama_print_timings:        eval time =    6078.76 ms /    63 runs   (   96.49 ms per token,    10.36 tokens per second)
llama_print_timings:       total time =    6620.02 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8188.87 ms /   128 tokens (   63.98 ms per token,    15.63 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8202.58 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy dog has nothing


second run: The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy dog has nothing


single seq run: The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy dog has nothing
...
first run: The quick brown fox jumps over the lazy dog is a simple sentence G(u(u^ee


second run: The quick brown fox jumps over the lazy dog is a simple sentence G(u(u^ee


single seq run: The quick brown fox jumps over the lazy dog is a simple sentence G(u(u^ee
...
0.35user 0.34system 0:00.69elapsed 99%CPU (0avgtext+0avgdata 6880724maxresident)k
...
0.14user 0.32system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 6880204maxresident)k
