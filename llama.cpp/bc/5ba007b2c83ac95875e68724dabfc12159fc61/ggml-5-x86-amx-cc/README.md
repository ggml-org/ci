...
- status:  SUCCESS ✅
- runtime: 4:29.52
- date:    Fri Oct 25 07:18:33 UTC 2024
...
0.00.000.657 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.348 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.008.385 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
0.00.008.385 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
0.00.008.385 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.008.387 I llama_model_loader: - type  f32:  124 tensors
0.00.008.389 I llama_model_loader: - type  f16:   73 tensors
0.00.019.675 I llm_load_vocab: special tokens cache size = 5
0.00.022.168 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.022.196 I llm_load_print_meta: format           = GGUF V3 (latest)
...
0.00.022.215 I llm_load_print_meta: n_gqa            = 1
...
0.00.022.221 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.022.221 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
...
0.00.022.225 I llm_load_print_meta: n_expert         = 0
0.00.022.226 I llm_load_print_meta: n_expert_used    = 0
0.00.022.226 I llm_load_print_meta: causal attn      = 0
0.00.022.226 I llm_load_print_meta: pooling type     = 2
0.00.022.226 I llm_load_print_meta: rope type        = 2
0.00.022.227 I llm_load_print_meta: rope scaling     = linear
0.00.022.228 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.022.230 I llm_load_print_meta: freq_scale_train = 1
0.00.022.231 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.022.231 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.022.233 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.022.234 I llm_load_print_meta: model type       = 33M
...
0.00.022.240 I llm_load_print_meta: max token length = 21
0.00.022.262 I llm_load_tensors: ggml ctx size =    0.08 MiB
0.00.025.642 I llm_load_tensors:        CPU buffer size =    63.84 MiB
...............................................
0.00.026.549 I llama_new_context_with_model: n_ctx      = 512
...
0.00.026.567 I llama_new_context_with_model: freq_scale = 1
0.00.029.011 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.029.039 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.029.047 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.030.339 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.030.357 I llama_new_context_with_model: graph nodes  = 429
0.00.030.357 I llama_new_context_with_model: graph splits = 1
0.00.030.359 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.033.914 I 
0.00.033.996 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.035.803 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.039.437 I llama_perf_context_print:        load time =      32.28 ms
0.00.039.439 I llama_perf_context_print: prompt eval time =       3.39 ms /     9 tokens (    0.38 ms per token,  2655.65 tokens per second)
0.00.039.440 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.039.440 I llama_perf_context_print:       total time =       5.52 ms /    10 tokens
...
0.00.000.435 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.919 I llama_model_loader: - type q8_0:   73 tensors
0.00.018.633 I llm_load_vocab: special tokens cache size = 5
0.00.021.188 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.217 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.217 I llm_load_print_meta: arch             = bert
0.00.021.217 I llm_load_print_meta: vocab type       = WPM
0.00.021.219 I llm_load_print_meta: n_vocab          = 30522
0.00.021.220 I llm_load_print_meta: n_merges         = 0
0.00.021.220 I llm_load_print_meta: vocab_only       = 0
0.00.021.220 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.221 I llm_load_print_meta: n_embd           = 384
0.00.021.221 I llm_load_print_meta: n_layer          = 12
...
0.00.021.237 I llm_load_print_meta: n_ff             = 1536
0.00.021.237 I llm_load_print_meta: n_expert         = 0
0.00.021.237 I llm_load_print_meta: n_expert_used    = 0
0.00.021.249 I llm_load_print_meta: causal attn      = 0
0.00.021.249 I llm_load_print_meta: pooling type     = 2
...
0.00.021.252 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.252 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.252 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.252 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.253 I llm_load_print_meta: ssm_d_state      = 0
0.00.021.253 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.021.253 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.254 I llm_load_print_meta: model type       = 33M
0.00.021.254 I llm_load_print_meta: model ftype      = Q8_0
0.00.021.255 I llm_load_print_meta: model params     = 33.21 M
0.00.021.256 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.021.256 I llm_load_print_meta: general.name     = Bge Small
0.00.021.256 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.256 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.257 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.258 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.258 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.258 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.258 I llm_load_print_meta: max token length = 21
0.00.021.271 I llm_load_tensors: ggml ctx size =    0.08 MiB
0.00.023.288 I llm_load_tensors:        CPU buffer size =    34.38 MiB
.................................................
0.00.024.101 I llama_new_context_with_model: n_ctx      = 512
0.00.024.115 I llama_new_context_with_model: n_batch    = 2048
0.00.024.116 I llama_new_context_with_model: n_ubatch   = 2048
0.00.024.116 I llama_new_context_with_model: flash_attn = 0
0.00.024.117 I llama_new_context_with_model: freq_base  = 10000.0
0.00.024.118 I llama_new_context_with_model: freq_scale = 1
0.00.026.316 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.026.342 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.026.348 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.027.537 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.027.557 I llama_new_context_with_model: graph nodes  = 429
0.00.027.557 I llama_new_context_with_model: graph splits = 1
0.00.027.558 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.030.223 I 
0.00.030.298 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.032.042 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.035.078 I llama_perf_context_print:        load time =      28.87 ms
0.00.035.080 I llama_perf_context_print: prompt eval time =       2.73 ms /     9 tokens (    0.30 ms per token,  3296.70 tokens per second)
0.00.035.080 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.035.081 I llama_perf_context_print:       total time =       4.86 ms /    10 tokens
...
0.00.000.612 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.009.409 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
...
0.00.015.339 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
...
0.00.020.365 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
...
0.00.020.367 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
...
0.00.020.374 I llama_model_loader: - type  f16:   29 tensors
0.00.038.130 W llm_load_vocab: empty token at index 5
0.00.048.812 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.062.364 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.062.472 I llm_load_vocab: special tokens cache size = 5
0.00.343.029 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.343.055 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.343.055 I llm_load_print_meta: arch             = jina-bert-v2
0.00.343.056 I llm_load_print_meta: vocab type       = BPE
0.00.343.057 I llm_load_print_meta: n_vocab          = 61056
0.00.343.057 I llm_load_print_meta: n_merges         = 39382
0.00.343.057 I llm_load_print_meta: vocab_only       = 0
0.00.343.058 I llm_load_print_meta: n_ctx_train      = 8192
0.00.343.058 I llm_load_print_meta: n_embd           = 384
0.00.343.058 I llm_load_print_meta: n_layer          = 4
0.00.343.070 I llm_load_print_meta: n_head           = 12
0.00.343.070 I llm_load_print_meta: n_head_kv        = 12
0.00.343.071 I llm_load_print_meta: n_rot            = 32
0.00.343.071 I llm_load_print_meta: n_swa            = 0
0.00.343.071 I llm_load_print_meta: n_embd_head_k    = 32
0.00.343.071 I llm_load_print_meta: n_embd_head_v    = 32
0.00.343.072 I llm_load_print_meta: n_gqa            = 1
0.00.343.073 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.343.074 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.343.076 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.343.076 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.343.076 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.343.077 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.343.077 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.343.078 I llm_load_print_meta: n_ff             = 1536
0.00.343.078 I llm_load_print_meta: n_expert         = 0
0.00.343.079 I llm_load_print_meta: n_expert_used    = 0
0.00.343.079 I llm_load_print_meta: causal attn      = 0
0.00.343.079 I llm_load_print_meta: pooling type     = -1
0.00.343.080 I llm_load_print_meta: rope type        = -1
0.00.343.080 I llm_load_print_meta: rope scaling     = linear
0.00.343.081 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.343.082 I llm_load_print_meta: freq_scale_train = 1
0.00.343.082 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.343.083 I llm_load_print_meta: rope_finetuned   = unknown
0.00.343.083 I llm_load_print_meta: ssm_d_conv       = 0
0.00.343.083 I llm_load_print_meta: ssm_d_inner      = 0
0.00.343.083 I llm_load_print_meta: ssm_d_state      = 0
0.00.343.084 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.343.084 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.343.085 I llm_load_print_meta: model type       = 33M
0.00.343.085 I llm_load_print_meta: model ftype      = F16
0.00.343.086 I llm_load_print_meta: model params     = 32.90 M
0.00.343.087 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.343.087 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.343.088 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.343.088 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.343.088 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.343.089 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.343.089 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.343.089 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.343.090 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.343.090 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.343.090 I llm_load_print_meta: max token length = 45
0.00.343.104 I llm_load_tensors: ggml ctx size =    0.03 MiB
0.00.346.279 I llm_load_tensors:        CPU buffer size =    62.78 MiB
......................
0.00.348.152 I llama_new_context_with_model: n_ctx      = 8192
0.00.348.175 I llama_new_context_with_model: n_batch    = 2048
0.00.348.175 I llama_new_context_with_model: n_ubatch   = 2048
0.00.348.176 I llama_new_context_with_model: flash_attn = 0
0.00.348.179 I llama_new_context_with_model: freq_base  = 10000.0
0.00.348.179 I llama_new_context_with_model: freq_scale = 1
0.00.357.311 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.357.332 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.357.340 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.359.120 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.359.144 I llama_new_context_with_model: graph nodes  = 154
0.00.359.145 I llama_new_context_with_model: graph splits = 1
0.00.359.148 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.367.632 I 
0.00.367.746 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.368.032 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.368.044 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.368.052 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.368.052 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.368.059 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.368.060 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.372.596 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.380.364 I llama_perf_context_print:        load time =     365.88 ms
0.00.380.366 I llama_perf_context_print: prompt eval time =       7.55 ms /    62 tokens (    0.12 ms per token,  8207.57 tokens per second)
0.00.380.368 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.380.369 I llama_perf_context_print:       total time =      12.73 ms /    63 tokens
...
0.00.000.789 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.368 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.368 I llm_load_print_meta: model params     = 1.41 B
0.00.076.369 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.166.450 I llm_load_tensors:        CPU buffer size =  2699.45 MiB
...............................................................................
0.00.168.762 I llama_new_context_with_model: n_ctx      = 2048
0.00.168.783 I llama_new_context_with_model: n_batch    = 2048
0.00.168.783 I llama_new_context_with_model: n_ubatch   = 512
0.00.168.783 I llama_new_context_with_model: flash_attn = 0
0.00.168.786 I llama_new_context_with_model: freq_base  = 10000.0
0.00.168.787 I llama_new_context_with_model: freq_scale = 1
0.00.237.863 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.237.894 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.237.921 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.239.929 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.239.955 I llama_new_context_with_model: graph nodes  = 967
0.00.239.955 I llama_new_context_with_model: graph splits = 1
0.00.239.959 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.344.394 I main: llama threadpool init, n_threads = 4
0.00.344.428 I 
0.00.344.518 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.344.530 I 
0.00.344.650 I sampler seed: 1234
0.00.344.670 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.344.674 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.04.912.856 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30842.75 tokens per second)
0.04.912.859 I llama_perf_context_print:        load time =     342.49 ms
0.04.912.861 I llama_perf_context_print: prompt eval time =     112.83 ms /     7 tokens (   16.12 ms per token,    62.04 tokens per second)
0.04.912.862 I llama_perf_context_print:        eval time =    4443.90 ms /    63 runs   (   70.54 ms per token,    14.18 tokens per second)
0.04.912.862 I llama_perf_context_print:       total time =    4568.47 ms /    70 tokens

real	0m4.981s
user	0m18.653s
sys	0m0.257s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-f16.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.664 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.520 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.075.110 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.075.125 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.169.123 I llm_load_tensors:        CPU buffer size =  2699.45 MiB
...............................................................................
0.00.171.129 I llama_new_context_with_model: n_ctx      = 128
0.00.171.151 I llama_new_context_with_model: n_batch    = 128
0.00.171.151 I llama_new_context_with_model: n_ubatch   = 128
0.00.171.151 I llama_new_context_with_model: flash_attn = 0
0.00.171.153 I llama_new_context_with_model: freq_base  = 10000.0
0.00.171.154 I llama_new_context_with_model: freq_scale = 1
0.00.176.046 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.176.074 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.176.090 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.177.669 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.177.686 I llama_new_context_with_model: graph nodes  = 967
0.00.177.686 I llama_new_context_with_model: graph splits = 1
0.00.177.688 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.246.206 I 
0.00.246.299 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.246.318 I perplexity: tokenizing the input ..
0.00.254.903 I perplexity: tokenization took 8.583 ms
0.00.254.933 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.176.129 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.180.002 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.180.040 I llama_perf_context_print:        load time =     244.56 ms
0.01.180.042 I llama_perf_context_print: prompt eval time =     919.62 ms /   128 tokens (    7.18 ms per token,   139.19 tokens per second)
0.01.180.043 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.180.044 I llama_perf_context_print:       total time =     933.83 ms /   129 tokens
...
0.00.000.769 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.441 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.442 I llm_load_print_meta: model params     = 1.41 B
0.00.076.443 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.151.948 I llm_load_tensors:        CPU buffer size =  1435.23 MiB
...............................................................................
0.00.154.017 I llama_new_context_with_model: n_ctx      = 2048
0.00.154.039 I llama_new_context_with_model: n_batch    = 2048
0.00.154.039 I llama_new_context_with_model: n_ubatch   = 512
0.00.154.039 I llama_new_context_with_model: flash_attn = 0
0.00.154.041 I llama_new_context_with_model: freq_base  = 10000.0
0.00.154.042 I llama_new_context_with_model: freq_scale = 1
0.00.224.063 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.224.096 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.224.122 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.225.746 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.225.770 I llama_new_context_with_model: graph nodes  = 967
0.00.225.770 I llama_new_context_with_model: graph splits = 1
0.00.225.775 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.326.164 I main: llama threadpool init, n_threads = 4
0.00.326.192 I 
0.00.326.281 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.326.293 I 
0.00.326.411 I sampler seed: 1234
0.00.326.431 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.326.434 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.326.434 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.326.434 I 
...
0.03.075.763 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31696.43 tokens per second)
0.03.075.766 I llama_perf_context_print:        load time =     324.24 ms
0.03.075.767 I llama_perf_context_print: prompt eval time =      93.66 ms /     7 tokens (   13.38 ms per token,    74.74 tokens per second)
0.03.075.768 I llama_perf_context_print:        eval time =    2644.11 ms /    63 runs   (   41.97 ms per token,    23.83 tokens per second)
0.03.075.769 I llama_perf_context_print:       total time =    2749.61 ms /    70 tokens

real	0m3.137s
user	0m11.350s
sys	0m0.252s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.629 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.685 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.686 I llm_load_print_meta: model params     = 1.41 B
0.00.075.687 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.153.497 I llm_load_tensors:        CPU buffer size =  1435.23 MiB
...............................................................................
0.00.155.518 I llama_new_context_with_model: n_ctx      = 128
0.00.155.539 I llama_new_context_with_model: n_batch    = 128
0.00.155.539 I llama_new_context_with_model: n_ubatch   = 128
0.00.155.540 I llama_new_context_with_model: flash_attn = 0
0.00.155.541 I llama_new_context_with_model: freq_base  = 10000.0
0.00.155.542 I llama_new_context_with_model: freq_scale = 1
0.00.160.227 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.160.254 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.160.273 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.162.190 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.162.211 I llama_new_context_with_model: graph nodes  = 967
0.00.162.212 I llama_new_context_with_model: graph splits = 1
0.00.162.214 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.227.737 I 
0.00.227.828 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.227.847 I perplexity: tokenizing the input ..
0.00.236.506 I perplexity: tokenization took 8.656 ms
0.00.236.536 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.129.171 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.132.969 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.133.007 I llama_perf_context_print:        load time =     226.18 ms
0.01.133.009 I llama_perf_context_print: prompt eval time =     891.06 ms /   128 tokens (    6.96 ms per token,   143.65 tokens per second)
0.01.133.010 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.133.011 I llama_perf_context_print:       total time =     905.27 ms /   129 tokens
...
0.00.000.610 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.737 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
0.00.021.740 I llama_model_loader: - type  f32:  194 tensors
0.00.021.742 I llama_model_loader: - type q4_0:   97 tensors
...
0.00.076.164 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.113.884 I llm_load_tensors:        CPU buffer size =   786.31 MiB
...............................................................................
0.00.115.942 I llama_new_context_with_model: n_ctx      = 2048
0.00.115.963 I llama_new_context_with_model: n_batch    = 2048
0.00.115.963 I llama_new_context_with_model: n_ubatch   = 512
0.00.115.963 I llama_new_context_with_model: flash_attn = 0
0.00.115.965 I llama_new_context_with_model: freq_base  = 10000.0
0.00.115.966 I llama_new_context_with_model: freq_scale = 1
0.00.186.114 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.186.144 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.186.168 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.187.870 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.283.618 I main: llama threadpool init, n_threads = 4
0.00.283.644 I 
0.00.283.730 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.283.743 I 
0.00.283.896 I sampler seed: 1234
0.00.283.914 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.283.917 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.283.918 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.283.918 I 
I believe the meaning of life is to know and experience things. I think that is the only way we can truly know ourselves. I have not really experienced anything. I don't know anything that I'm not going to be able to learn from others.

So it's a matter of life or death. It's a matter of life or death

0.02.206.653 I llama_perf_sampler_print:    sampling time =       2.41 ms /    71 runs   (    0.03 ms per token, 29521.83 tokens per second)
0.02.206.655 I llama_perf_context_print:        load time =     281.81 ms
0.02.206.657 I llama_perf_context_print: prompt eval time =     102.92 ms /     7 tokens (   14.70 ms per token,    68.02 tokens per second)
0.02.206.658 I llama_perf_context_print:        eval time =    1808.30 ms /    63 runs   (   28.70 ms per token,    34.84 tokens per second)
0.02.206.659 I llama_perf_context_print:       total time =    1923.04 ms /    70 tokens

real	0m2.247s
user	0m8.078s
sys	0m0.140s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.635 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.113.520 I llm_load_tensors:        CPU buffer size =   786.31 MiB
...............................................................................
0.00.115.563 I llama_new_context_with_model: n_ctx      = 128
0.00.115.584 I llama_new_context_with_model: n_batch    = 128
0.00.115.584 I llama_new_context_with_model: n_ubatch   = 128
0.00.115.584 I llama_new_context_with_model: flash_attn = 0
0.00.115.586 I llama_new_context_with_model: freq_base  = 10000.0
0.00.115.587 I llama_new_context_with_model: freq_scale = 1
0.00.120.227 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.120.254 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.120.270 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.121.706 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.121.730 I llama_new_context_with_model: graph nodes  = 967
0.00.121.731 I llama_new_context_with_model: graph splits = 1
0.00.121.733 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.181.709 I 
0.00.181.798 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.181.804 I perplexity: tokenizing the input ..
0.00.190.336 I perplexity: tokenization took 8.529 ms
0.00.190.369 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.200.673 I perplexity: 1.01 seconds per pass - ETA 0.02 minutes
[1]11.2206,
0.01.204.582 I Final estimate: PPL = 11.2206 +/- 3.51829

0.01.204.620 I llama_perf_context_print:        load time =     180.12 ms
0.01.204.622 I llama_perf_context_print: prompt eval time =    1008.63 ms /   128 tokens (    7.88 ms per token,   126.90 tokens per second)
0.01.204.623 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.204.624 I llama_perf_context_print:       total time =    1022.91 ms /   129 tokens
...
0.00.000.623 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.781 I llm_load_print_meta: ssm_d_inner      = 0
...
0.00.074.783 I llm_load_print_meta: model ftype      = Q4_1
0.00.074.784 I llm_load_print_meta: model params     = 1.41 B
0.00.074.786 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.110.189 I llm_load_tensors:        CPU buffer size =   864.46 MiB
..............................................................................
0.00.112.317 I llama_new_context_with_model: n_ctx      = 2048
0.00.112.338 I llama_new_context_with_model: n_batch    = 2048
0.00.112.338 I llama_new_context_with_model: n_ubatch   = 512
0.00.112.338 I llama_new_context_with_model: flash_attn = 0
0.00.112.340 I llama_new_context_with_model: freq_base  = 10000.0
0.00.112.341 I llama_new_context_with_model: freq_scale = 1
0.00.180.725 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.180.754 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.180.776 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.182.299 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.267.168 I main: llama threadpool init, n_threads = 4
0.00.267.195 I 
0.00.267.274 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.267.286 I 
0.00.267.389 I sampler seed: 1234
0.00.267.407 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.267.410 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.267.411 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.267.411 I 
I believe the meaning of life is that which you will do when you have no other choice."

The man looked at her, his face an unpleasant mask. "I think you're making too much of this. I was in the woods with your mother a few days ago, and I had no idea that she was pregnant. And she's not

0.02.282.265 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31513.54 tokens per second)
0.02.282.268 I llama_perf_context_print:        load time =     265.39 ms
0.02.282.269 I llama_perf_context_print: prompt eval time =     105.61 ms /     7 tokens (   15.09 ms per token,    66.28 tokens per second)
0.02.282.270 I llama_perf_context_print:        eval time =    1898.17 ms /    63 runs   (   30.13 ms per token,    33.19 tokens per second)
0.02.282.271 I llama_perf_context_print:       total time =    2015.10 ms /    70 tokens
...
0.00.112.405 I llm_load_tensors:        CPU buffer size =   864.46 MiB
..............................................................................
0.00.114.366 I llama_new_context_with_model: n_ctx      = 128
0.00.114.387 I llama_new_context_with_model: n_batch    = 128
0.00.114.387 I llama_new_context_with_model: n_ubatch   = 128
0.00.114.388 I llama_new_context_with_model: flash_attn = 0
0.00.114.389 I llama_new_context_with_model: freq_base  = 10000.0
0.00.114.390 I llama_new_context_with_model: freq_scale = 1
0.00.119.058 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.119.081 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.119.097 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.121.053 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.121.078 I llama_new_context_with_model: graph nodes  = 967
0.00.121.078 I llama_new_context_with_model: graph splits = 1
0.00.121.080 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.173.881 I 
0.00.173.981 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.173.991 I perplexity: tokenizing the input ..
0.00.182.945 I perplexity: tokenization took 8.95 ms
0.00.182.973 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.806.166 I perplexity: 1.62 seconds per pass - ETA 0.02 minutes
[1]10.5775,
0.01.809.956 I Final estimate: PPL = 10.5775 +/- 3.33909

0.01.809.996 I llama_perf_context_print:        load time =     172.28 ms
0.01.809.997 I llama_perf_context_print: prompt eval time =    1621.49 ms /   128 tokens (   12.67 ms per token,    78.94 tokens per second)
0.01.809.998 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.809.999 I llama_perf_context_print:       total time =    1636.11 ms /   129 tokens
...
0.00.000.596 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.942 I llm_load_print_meta: arch             = gptneox
...
0.00.074.944 I llm_load_print_meta: vocab_only       = 0
0.00.074.944 I llm_load_print_meta: n_ctx_train      = 2048
0.00.074.945 I llm_load_print_meta: n_embd           = 2048
0.00.074.945 I llm_load_print_meta: n_layer          = 24
...
0.00.074.967 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.114.181 I llm_load_tensors:        CPU buffer size =   942.60 MiB
..................................................................................
0.00.116.239 I llama_new_context_with_model: n_ctx      = 2048
0.00.116.260 I llama_new_context_with_model: n_batch    = 2048
0.00.116.260 I llama_new_context_with_model: n_ubatch   = 512
0.00.116.261 I llama_new_context_with_model: flash_attn = 0
0.00.116.263 I llama_new_context_with_model: freq_base  = 10000.0
0.00.116.264 I llama_new_context_with_model: freq_scale = 1
0.00.183.987 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.184.018 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.184.041 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.185.620 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.185.650 I llama_new_context_with_model: graph nodes  = 967
0.00.185.651 I llama_new_context_with_model: graph splits = 1
0.00.185.655 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.278.338 I main: llama threadpool init, n_threads = 4
0.00.278.367 I 
0.00.278.466 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.278.479 I 
0.00.278.598 I sampler seed: 1234
0.00.278.619 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.278.623 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.278.623 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.278.624 I 
...
0.02.522.451 I llama_perf_sampler_print:    sampling time =       2.31 ms /    71 runs   (    0.03 ms per token, 30762.56 tokens per second)
0.02.522.454 I llama_perf_context_print:        load time =     276.59 ms
0.02.522.455 I llama_perf_context_print: prompt eval time =     124.55 ms /     7 tokens (   17.79 ms per token,    56.20 tokens per second)
0.02.522.456 I llama_perf_context_print:        eval time =    2108.16 ms /    63 runs   (   33.46 ms per token,    29.88 tokens per second)
0.02.522.457 I llama_perf_context_print:       total time =    2244.12 ms /    70 tokens

real	0m2.562s
user	0m9.302s
sys	0m0.176s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.633 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.198 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.021.201 I llama_model_loader: - type  f32:  194 tensors
0.00.021.203 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.075.917 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.918 I llm_load_print_meta: model params     = 1.41 B
0.00.075.919 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.115.734 I llm_load_tensors:        CPU buffer size =   942.60 MiB
..................................................................................
0.00.117.778 I llama_new_context_with_model: n_ctx      = 128
0.00.117.799 I llama_new_context_with_model: n_batch    = 128
0.00.117.799 I llama_new_context_with_model: n_ubatch   = 128
0.00.117.799 I llama_new_context_with_model: flash_attn = 0
0.00.117.801 I llama_new_context_with_model: freq_base  = 10000.0
0.00.117.802 I llama_new_context_with_model: freq_scale = 1
0.00.122.582 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.122.603 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.122.618 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.124.525 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.124.549 I llama_new_context_with_model: graph nodes  = 967
0.00.124.550 I llama_new_context_with_model: graph splits = 1
0.00.124.552 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.177.232 I 
0.00.177.329 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.177.335 I perplexity: tokenizing the input ..
0.00.185.962 I perplexity: tokenization took 8.624 ms
0.00.185.996 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.179.555 I perplexity: 1.99 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.02.183.160 I Final estimate: PPL = 10.0390 +/- 3.19711

0.02.183.196 I llama_perf_context_print:        load time =     175.62 ms
0.02.183.199 I llama_perf_context_print: prompt eval time =    1991.69 ms /   128 tokens (   15.56 ms per token,    64.27 tokens per second)
0.02.183.201 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.183.201 I llama_perf_context_print:       total time =    2005.96 ms /   129 tokens
...
0.00.000.618 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.540 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.021.543 I llama_model_loader: - type  f32:  194 tensors
0.00.021.545 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.075.586 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.587 I llm_load_print_meta: model params     = 1.41 B
0.00.075.588 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.117.047 I llm_load_tensors:        CPU buffer size =  1020.74 MiB
...............................................................................
0.00.119.026 I llama_new_context_with_model: n_ctx      = 2048
0.00.119.048 I llama_new_context_with_model: n_batch    = 2048
0.00.119.048 I llama_new_context_with_model: n_ubatch   = 512
0.00.119.049 I llama_new_context_with_model: flash_attn = 0
0.00.119.051 I llama_new_context_with_model: freq_base  = 10000.0
0.00.119.052 I llama_new_context_with_model: freq_scale = 1
0.00.187.332 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.187.362 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.187.386 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.188.939 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.188.962 I llama_new_context_with_model: graph nodes  = 967
0.00.188.962 I llama_new_context_with_model: graph splits = 1
0.00.188.966 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.283.399 I main: llama threadpool init, n_threads = 4
0.00.283.426 I 
0.00.283.504 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.283.517 I 
0.00.283.631 I sampler seed: 1234
0.00.283.650 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.283.653 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.283.654 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.283.654 I 
...
0.02.610.034 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31654.03 tokens per second)
0.02.610.037 I llama_perf_context_print:        load time =     281.59 ms
0.02.610.039 I llama_perf_context_print: prompt eval time =     124.38 ms /     7 tokens (   17.77 ms per token,    56.28 tokens per second)
0.02.610.040 I llama_perf_context_print:        eval time =    2190.85 ms /    63 runs   (   34.78 ms per token,    28.76 tokens per second)
0.02.610.041 I llama_perf_context_print:       total time =    2326.64 ms /    70 tokens

real	0m2.653s
user	0m9.650s
sys	0m0.180s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.616 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.889 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.020.892 I llama_model_loader: - type  f32:  194 tensors
...
0.00.075.292 I llm_load_print_meta: ssm_d_conv       = 0
...
0.00.115.576 I llm_load_tensors:        CPU buffer size =  1020.74 MiB
...............................................................................
0.00.117.508 I llama_new_context_with_model: n_ctx      = 128
...
0.00.121.807 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.121.827 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.121.843 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.123.324 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
...
0.00.179.772 I 
0.00.179.889 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.179.896 I perplexity: tokenizing the input ..
0.00.189.019 I perplexity: tokenization took 9.119 ms
0.00.189.058 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.125.180 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.128.974 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.129.019 I llama_perf_context_print:        load time =     178.21 ms
0.02.129.033 I llama_perf_context_print: prompt eval time =    1934.47 ms /   128 tokens (   15.11 ms per token,    66.17 tokens per second)
0.02.129.035 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.129.036 I llama_perf_context_print:       total time =    1949.25 ms /   129 tokens
...
0.00.000.642 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.088 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.089 I llm_load_print_meta: model params     = 1.41 B
0.00.075.090 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.075.109 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.096.430 I llm_load_tensors:        CPU buffer size =   542.04 MiB
..........................................................................
0.00.098.388 I llama_new_context_with_model: n_ctx      = 2048
0.00.098.408 I llama_new_context_with_model: n_batch    = 2048
0.00.098.408 I llama_new_context_with_model: n_ubatch   = 512
0.00.098.409 I llama_new_context_with_model: flash_attn = 0
0.00.098.411 I llama_new_context_with_model: freq_base  = 10000.0
0.00.098.411 I llama_new_context_with_model: freq_scale = 1
0.00.166.413 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.166.442 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.166.462 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.168.513 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.168.538 I llama_new_context_with_model: graph nodes  = 967
0.00.168.538 I llama_new_context_with_model: graph splits = 1
0.00.168.541 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.242.763 I main: llama threadpool init, n_threads = 4
0.00.242.787 I 
0.00.242.872 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.242.885 I 
0.00.242.995 I sampler seed: 1234
0.00.243.014 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.243.017 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.243.017 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.243.018 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.669.271 I llama_perf_sampler_print:    sampling time =       2.15 ms /    71 runs   (    0.03 ms per token, 33069.40 tokens per second)
0.01.669.274 I llama_perf_context_print:        load time =     240.98 ms
0.01.669.276 I llama_perf_context_print: prompt eval time =      81.75 ms /     7 tokens (   11.68 ms per token,    85.63 tokens per second)
0.01.669.278 I llama_perf_context_print:        eval time =    1333.25 ms /    63 runs   (   21.16 ms per token,    47.25 tokens per second)
0.01.669.279 I llama_perf_context_print:       total time =    1426.51 ms /    70 tokens
...
0.00.020.857 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.857 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.075.178 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.178 I llm_load_print_meta: model params     = 1.41 B
0.00.075.179 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.075.202 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.096.747 I llm_load_tensors:        CPU buffer size =   542.04 MiB
..........................................................................
0.00.098.767 I llama_new_context_with_model: n_ctx      = 128
0.00.098.787 I llama_new_context_with_model: n_batch    = 128
0.00.098.787 I llama_new_context_with_model: n_ubatch   = 128
0.00.098.788 I llama_new_context_with_model: flash_attn = 0
0.00.098.789 I llama_new_context_with_model: freq_base  = 10000.0
0.00.098.790 I llama_new_context_with_model: freq_scale = 1
0.00.103.426 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.103.453 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.103.472 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.105.386 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.105.409 I llama_new_context_with_model: graph nodes  = 967
0.00.105.410 I llama_new_context_with_model: graph splits = 1
0.00.105.412 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.145.481 I 
0.00.145.581 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.145.588 I perplexity: tokenizing the input ..
0.00.154.428 I perplexity: tokenization took 8.835 ms
0.00.154.460 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.449.425 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.453.095 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.453.133 I llama_perf_context_print:        load time =     143.96 ms
0.01.453.135 I llama_perf_context_print: prompt eval time =    1293.29 ms /   128 tokens (   10.10 ms per token,    98.97 tokens per second)
0.01.453.136 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.453.137 I llama_perf_context_print:       total time =    1307.65 ms /   129 tokens
...
0.00.000.581 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.797 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.020.801 I llama_model_loader: - type  f32:  194 tensors
0.00.020.803 I llama_model_loader: - type q3_K:   25 tensors
0.00.020.803 I llama_model_loader: - type q4_K:   71 tensors
0.00.020.803 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.074.789 I llm_load_print_meta: model ftype      = Q3_K - Medium
...
0.00.103.498 I llm_load_tensors:        CPU buffer size =   724.27 MiB
...............................................................................
0.00.105.451 I llama_new_context_with_model: n_ctx      = 2048
0.00.105.471 I llama_new_context_with_model: n_batch    = 2048
0.00.105.471 I llama_new_context_with_model: n_ubatch   = 512
0.00.105.472 I llama_new_context_with_model: flash_attn = 0
0.00.105.473 I llama_new_context_with_model: freq_base  = 10000.0
0.00.105.474 I llama_new_context_with_model: freq_scale = 1
0.00.173.940 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.173.965 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.173.985 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.175.496 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.175.520 I llama_new_context_with_model: graph nodes  = 967
0.00.175.520 I llama_new_context_with_model: graph splits = 1
0.00.175.524 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.251.447 I main: llama threadpool init, n_threads = 4
0.00.251.474 I 
0.00.251.568 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.251.568 I 
0.00.251.695 I sampler seed: 1234
0.00.251.716 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.251.719 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.251.720 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.251.720 I 
...
0.01.931.548 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31710.59 tokens per second)
0.01.931.551 I llama_perf_context_print:        load time =     249.69 ms
0.01.931.553 I llama_perf_context_print: prompt eval time =      86.55 ms /     7 tokens (   12.36 ms per token,    80.88 tokens per second)
0.01.931.554 I llama_perf_context_print:        eval time =    1582.03 ms /    63 runs   (   25.11 ms per token,    39.82 tokens per second)
0.01.931.554 I llama_perf_context_print:       total time =    1680.11 ms /    70 tokens

real	0m1.965s
user	0m7.007s
sys	0m0.140s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q3_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.638 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.872 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.873 I llm_load_print_meta: model params     = 1.41 B
0.00.075.874 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.104.186 I llm_load_tensors:        CPU buffer size =   724.27 MiB
...............................................................................
0.00.106.231 I llama_new_context_with_model: n_ctx      = 128
0.00.106.251 I llama_new_context_with_model: n_batch    = 128
0.00.106.251 I llama_new_context_with_model: n_ubatch   = 128
0.00.106.252 I llama_new_context_with_model: flash_attn = 0
0.00.106.254 I llama_new_context_with_model: freq_base  = 10000.0
0.00.106.254 I llama_new_context_with_model: freq_scale = 1
0.00.110.892 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.110.919 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.110.936 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.112.442 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.112.465 I llama_new_context_with_model: graph nodes  = 967
0.00.112.465 I llama_new_context_with_model: graph splits = 1
0.00.112.467 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.152.690 I 
0.00.152.785 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.152.792 I perplexity: tokenizing the input ..
0.00.161.567 I perplexity: tokenization took 8.77 ms
0.00.161.595 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.492.142 I perplexity: 1.33 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.496.022 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.496.066 I llama_perf_context_print:        load time =     151.02 ms
0.01.496.068 I llama_perf_context_print: prompt eval time =    1328.84 ms /   128 tokens (   10.38 ms per token,    96.32 tokens per second)
0.01.496.070 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.496.071 I llama_perf_context_print:       total time =    1343.37 ms /   129 tokens
...
0.00.000.674 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.431 I llama_model_loader: - type q4_K:   61 tensors
0.00.021.431 I llama_model_loader: - type q5_K:   24 tensors
...
0.00.075.149 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.150 I llm_load_print_meta: model params     = 1.41 B
0.00.075.150 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.075.166 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.109.209 I llm_load_tensors:        CPU buffer size =   871.81 MiB
..............................................................................
0.00.111.173 I llama_new_context_with_model: n_ctx      = 2048
0.00.111.193 I llama_new_context_with_model: n_batch    = 2048
0.00.111.193 I llama_new_context_with_model: n_ubatch   = 512
0.00.111.194 I llama_new_context_with_model: flash_attn = 0
0.00.111.195 I llama_new_context_with_model: freq_base  = 10000.0
0.00.111.196 I llama_new_context_with_model: freq_scale = 1
0.00.179.389 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.179.420 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.179.445 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.181.476 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.181.500 I llama_new_context_with_model: graph nodes  = 967
0.00.181.500 I llama_new_context_with_model: graph splits = 1
0.00.181.504 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.263.869 I main: llama threadpool init, n_threads = 4
0.00.263.898 I 
0.00.263.993 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.264.006 I 
0.00.264.129 I sampler seed: 1234
0.00.264.149 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.264.152 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.264.153 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.264.153 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.150.193 I llama_perf_sampler_print:    sampling time =       2.34 ms /    71 runs   (    0.03 ms per token, 30393.84 tokens per second)
0.02.150.197 I llama_perf_context_print:        load time =     262.04 ms
0.02.150.199 I llama_perf_context_print: prompt eval time =      91.10 ms /     7 tokens (   13.01 ms per token,    76.84 tokens per second)
0.02.150.200 I llama_perf_context_print:        eval time =    1783.10 ms /    63 runs   (   28.30 ms per token,    35.33 tokens per second)
0.02.150.201 I llama_perf_context_print:       total time =    1886.34 ms /    70 tokens

real	0m2.189s
user	0m7.848s
sys	0m0.160s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.665 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.125 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.076.126 I llm_load_print_meta: model params     = 1.41 B
0.00.076.127 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.076.146 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.111.094 I llm_load_tensors:        CPU buffer size =   871.81 MiB
..............................................................................
0.00.113.103 I llama_new_context_with_model: n_ctx      = 128
0.00.113.124 I llama_new_context_with_model: n_batch    = 128
0.00.113.124 I llama_new_context_with_model: n_ubatch   = 128
0.00.113.125 I llama_new_context_with_model: flash_attn = 0
0.00.113.127 I llama_new_context_with_model: freq_base  = 10000.0
0.00.113.127 I llama_new_context_with_model: freq_scale = 1
0.00.117.788 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.117.810 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.117.827 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.119.807 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.119.832 I llama_new_context_with_model: graph nodes  = 967
0.00.119.832 I llama_new_context_with_model: graph splits = 1
0.00.119.835 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.163.909 I 
0.00.163.988 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.163.995 I perplexity: tokenizing the input ..
0.00.172.865 I perplexity: tokenization took 8.867 ms
0.00.172.895 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.565.026 I perplexity: 1.39 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.568.923 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.568.964 I llama_perf_context_print:        load time =     162.23 ms
0.01.568.966 I llama_perf_context_print: prompt eval time =    1390.35 ms /   128 tokens (   10.86 ms per token,    92.06 tokens per second)
0.01.568.967 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.568.968 I llama_perf_context_print:       total time =    1405.10 ms /   129 tokens
...
0.00.000.603 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.625 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.626 I llm_load_print_meta: model params     = 1.41 B
0.00.075.627 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.075.643 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.114.152 I llm_load_tensors:        CPU buffer size =  1006.35 MiB
................................................................................
0.00.116.157 I llama_new_context_with_model: n_ctx      = 2048
0.00.116.176 I llama_new_context_with_model: n_batch    = 2048
0.00.116.177 I llama_new_context_with_model: n_ubatch   = 512
0.00.116.177 I llama_new_context_with_model: flash_attn = 0
0.00.116.179 I llama_new_context_with_model: freq_base  = 10000.0
0.00.116.180 I llama_new_context_with_model: freq_scale = 1
0.00.185.483 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.185.510 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.185.539 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.187.075 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.187.099 I llama_new_context_with_model: graph nodes  = 967
0.00.187.100 I llama_new_context_with_model: graph splits = 1
0.00.187.104 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.274.792 I main: llama threadpool init, n_threads = 4
0.00.274.821 I 
0.00.274.917 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.274.930 I 
0.00.275.049 I sampler seed: 1234
0.00.275.070 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.275.074 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.275.074 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.275.074 I 
...
0.02.423.357 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30472.10 tokens per second)
0.02.423.360 I llama_perf_context_print:        load time =     272.96 ms
0.02.423.362 I llama_perf_context_print: prompt eval time =     107.05 ms /     7 tokens (   15.29 ms per token,    65.39 tokens per second)
0.02.423.364 I llama_perf_context_print:        eval time =    2029.39 ms /    63 runs   (   32.21 ms per token,    31.04 tokens per second)
0.02.423.364 I llama_perf_context_print:       total time =    2148.58 ms /    70 tokens
...
0.00.075.502 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.503 I llm_load_print_meta: model params     = 1.41 B
0.00.075.504 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.116.173 I llm_load_tensors:        CPU buffer size =  1006.35 MiB
................................................................................
0.00.118.141 I llama_new_context_with_model: n_ctx      = 128
0.00.118.163 I llama_new_context_with_model: n_batch    = 128
0.00.118.163 I llama_new_context_with_model: n_ubatch   = 128
0.00.118.164 I llama_new_context_with_model: flash_attn = 0
0.00.118.166 I llama_new_context_with_model: freq_base  = 10000.0
0.00.118.166 I llama_new_context_with_model: freq_scale = 1
0.00.122.928 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.122.948 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.122.965 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.124.956 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.124.976 I llama_new_context_with_model: graph nodes  = 967
0.00.124.976 I llama_new_context_with_model: graph splits = 1
0.00.124.978 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.180.112 I 
0.00.180.218 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.180.224 I perplexity: tokenizing the input ..
0.00.189.349 I perplexity: tokenization took 9.121 ms
0.00.189.384 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.870.765 I perplexity: 1.68 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.874.394 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.874.435 I llama_perf_context_print:        load time =     178.49 ms
0.01.874.452 I llama_perf_context_print: prompt eval time =    1679.58 ms /   128 tokens (   13.12 ms per token,    76.21 tokens per second)
0.01.874.454 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.874.455 I llama_perf_context_print:       total time =    1694.32 ms /   129 tokens
...
0.00.000.672 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.247 I llm_load_print_meta: n_ff             = 8192
...
0.00.111.051 I llm_load_tensors:        CPU buffer size =  1108.64 MiB
...............................................................................
0.00.113.031 I llama_new_context_with_model: n_ctx      = 2048
0.00.113.048 I llama_new_context_with_model: n_batch    = 2048
0.00.113.048 I llama_new_context_with_model: n_ubatch   = 512
0.00.113.048 I llama_new_context_with_model: flash_attn = 0
0.00.113.050 I llama_new_context_with_model: freq_base  = 10000.0
0.00.113.051 I llama_new_context_with_model: freq_scale = 1
0.00.181.983 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.182.009 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.182.033 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.183.590 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.183.616 I llama_new_context_with_model: graph nodes  = 967
0.00.183.616 I llama_new_context_with_model: graph splits = 1
0.00.183.620 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.272.697 I main: llama threadpool init, n_threads = 4
0.00.272.725 I 
0.00.272.816 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.272.828 I 
0.00.272.949 I sampler seed: 1234
0.00.272.969 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.272.972 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.272.973 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.272.973 I 
...
0.02.548.757 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31499.56 tokens per second)
0.02.548.760 I llama_perf_context_print:        load time =     270.79 ms
0.02.548.761 I llama_perf_context_print: prompt eval time =     105.48 ms /     7 tokens (   15.07 ms per token,    66.36 tokens per second)
0.02.548.762 I llama_perf_context_print:        eval time =    2158.97 ms /    63 runs   (   34.27 ms per token,    29.18 tokens per second)
0.02.548.763 I llama_perf_context_print:       total time =    2276.07 ms /    70 tokens

real	0m2.588s
user	0m9.407s
sys	0m0.188s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q6_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.662 I build: 3975 (bc5ba007) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.092 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.093 I llm_load_print_meta: model params     = 1.41 B
0.00.076.094 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.076.115 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.111.271 I llm_load_tensors:        CPU buffer size =  1108.64 MiB
...............................................................................
0.00.113.281 I llama_new_context_with_model: n_ctx      = 128
0.00.113.301 I llama_new_context_with_model: n_batch    = 128
0.00.113.302 I llama_new_context_with_model: n_ubatch   = 128
...
0.00.118.023 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.118.048 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.118.064 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.119.538 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.119.562 I llama_new_context_with_model: graph nodes  = 967
0.00.119.562 I llama_new_context_with_model: graph splits = 1
0.00.119.564 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.176.368 I 
0.00.176.474 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.176.482 I perplexity: tokenizing the input ..
0.00.185.557 I perplexity: tokenization took 9.071 ms
0.00.185.591 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.826.084 I perplexity: 1.64 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.829.987 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.830.023 I llama_perf_context_print:        load time =     174.80 ms
0.01.830.035 I llama_perf_context_print: prompt eval time =    1638.74 ms /   128 tokens (   12.80 ms per token,    78.11 tokens per second)
0.01.830.048 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.830.049 I llama_perf_context_print:       total time =    1653.66 ms /   129 tokens
...
0.00.185.379 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
0.48user 0.16system 0:00.65elapsed 99%CPU (0avgtext+0avgdata 2896652maxresident)k
...
0.16user 0.17system 0:00.34elapsed 100%CPU (0avgtext+0avgdata 2893212maxresident)k
0inputs+48outputs (0major+57657minor)pagefaults 0swaps
```
