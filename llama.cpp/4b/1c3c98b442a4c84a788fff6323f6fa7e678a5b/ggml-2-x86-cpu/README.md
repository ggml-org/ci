...
- status:  SUCCESS ✅
- runtime: 12:39.86
- date:    Fri Apr 26 14:18:26 UTC 2024
...
10/23 Test #10: test-tokenizer-1-aquila .............   Passed    8.56 sec
...
Label Time Summary:
main    =  96.15 sec*proc (23 tests)

Total Test time (real) =  96.16 sec
...
llama_print_timings: prompt eval time =       4.23 ms /     9 tokens (    0.47 ms per token,  2129.17 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      53.09 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.82 ms /     9 tokens (    0.42 ms per token,  2356.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      51.55 ms /    10 tokens
...
<bos> Soar is a leading provider of flight training and aircraft maintenance services. With a focus on safety, efficiency, and innovation, our mission is to empower pilots and businesses
llama_print_timings:        load time =    1228.39 ms
llama_print_timings:      sample time =      47.59 ms /    32 runs   (    1.49 ms per token,   672.38 tokens per second)
llama_print_timings: prompt eval time =    1121.84 ms /     2 tokens (  560.92 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20749.83 ms /    31 runs   (  669.35 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22053.67 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shein is a fashion retailer known for its low-cost, trendy apparel. Shein has gained significant popularity in recent years, attracting both consumers and businesses.


llama_print_timings:        load time =    1207.53 ms
llama_print_timings:      sample time =      47.40 ms /    32 runs   (    1.48 ms per token,   675.13 tokens per second)
llama_print_timings: prompt eval time =    1122.45 ms /     2 tokens (  561.23 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20743.94 ms /    31 runs   (  669.16 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22048.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When to Use an Exponential Function

An exponential function is a mathematical function that models exponential growth or decay. It has the general form:

$$y = ae^{
llama_print_timings:        load time =    1205.93 ms
llama_print_timings:      sample time =      48.02 ms /    32 runs   (    1.50 ms per token,   666.35 tokens per second)
llama_print_timings: prompt eval time =    1123.45 ms /     2 tokens (  561.72 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20794.85 ms /    31 runs   (  670.80 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22102.88 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say necessity is the mother of invention, and there is no greater testament to this than the humble toothbrush.

The humble toothbrush, an essential tool for maintaining oral
llama_print_timings:        load time =     179.36 ms
llama_print_timings:      sample time =       6.25 ms /    32 runs   (    0.20 ms per token,  5120.00 tokens per second)
llama_print_timings: prompt eval time =      73.84 ms /     2 tokens (   36.92 ms per token,    27.08 tokens per second)
llama_print_timings:        eval time =    2019.20 ms /    31 runs   (   65.14 ms per token,    15.35 tokens per second)
llama_print_timings:       total time =    2158.85 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say the future belongs to those who believe in the beauty of their dreams. And I believe in the power of my own dreams.

This statement resonates deeply with
llama_print_timings:        load time =     153.72 ms
llama_print_timings:      sample time =       6.28 ms /    32 runs   (    0.20 ms per token,  5097.16 tokens per second)
llama_print_timings: prompt eval time =      71.82 ms /     2 tokens (   35.91 ms per token,    27.85 tokens per second)
llama_print_timings:        eval time =    1966.98 ms /    31 runs   (   63.45 ms per token,    15.76 tokens per second)
llama_print_timings:       total time =    2104.43 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When a user signs up for an account, they should be able to choose between creating a username and password or linking their existing social media account.

**Implementation:**
llama_print_timings:        load time =     169.98 ms
llama_print_timings:      sample time =       6.92 ms /    32 runs   (    0.22 ms per token,  4622.94 tokens per second)
llama_print_timings: prompt eval time =      75.97 ms /     2 tokens (   37.99 ms per token,    26.33 tokens per second)
llama_print_timings:        eval time =    2029.92 ms /    31 runs   (   65.48 ms per token,    15.27 tokens per second)
llama_print_timings:       total time =    2175.81 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31775.25 ms
main:    total time = 31775.25 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a young girl named Alice. She had bright eyes that sparkled with mischief, a smile that could brighten the darkest room, and hair as black
llama_print_timings:        load time =     124.91 ms
llama_print_timings:      sample time =       6.20 ms /    32 runs   (    0.19 ms per token,  5160.46 tokens per second)
llama_print_timings: prompt eval time =     121.77 ms /     5 tokens (   24.35 ms per token,    41.06 tokens per second)
llama_print_timings:        eval time =    1559.44 ms /    31 runs   (   50.30 ms per token,    19.88 tokens per second)
llama_print_timings:       total time =    1746.68 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31851.15 ms
main:    total time = 31851.15 ms
+ echo PASS
PASS
+ echo
...
<bos> They say laughter is the best medicine, and it seems to be true in the case of the little boy who was diagnosed with a terminal illness.

The boy,
llama_print_timings:        load time =     122.74 ms
llama_print_timings:      sample time =       6.07 ms /    32 runs   (    0.19 ms per token,  5270.96 tokens per second)
llama_print_timings: prompt eval time =      66.64 ms /     2 tokens (   33.32 ms per token,    30.01 tokens per second)
llama_print_timings:        eval time =    1479.06 ms /    31 runs   (   47.71 ms per token,    20.96 tokens per second)
llama_print_timings:       total time =    1614.62 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     568.07 ms
llama_print_timings:      sample time =       2.75 ms /    64 runs   (    0.04 ms per token, 23289.67 tokens per second)
llama_print_timings: prompt eval time =     314.48 ms /     8 tokens (   39.31 ms per token,    25.44 tokens per second)
llama_print_timings:        eval time =    7735.28 ms /    63 runs   (  122.78 ms per token,     8.14 tokens per second)
llama_print_timings:       total time =    8073.19 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     548.40 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4840.00 ms /   128 tokens (   37.81 ms per token,    26.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4849.84 ms /   129 tokens
...
llama_print_timings:        load time =     374.99 ms
llama_print_timings:      sample time =       2.26 ms /    64 runs   (    0.04 ms per token, 28368.79 tokens per second)
llama_print_timings: prompt eval time =     209.05 ms /     8 tokens (   26.13 ms per token,    38.27 tokens per second)
llama_print_timings:        eval time =    5356.21 ms /    63 runs   (   85.02 ms per token,    11.76 tokens per second)
llama_print_timings:       total time =    5586.08 ms /    71 tokens
Log end
...
[1]4.2536,
llama_print_timings:        load time =     346.63 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2826.30 ms /   128 tokens (   22.08 ms per token,    45.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2836.83 ms /   129 tokens
...
llama_print_timings:        load time =     251.75 ms
...
llama_print_timings:        eval time =    4610.09 ms /    63 runs   (   73.18 ms per token,    13.67 tokens per second)
llama_print_timings:       total time =    4832.63 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3136.78 ms /   128 tokens (   24.51 ms per token,    40.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3146.44 ms /   129 tokens
...
llama_print_timings: prompt eval time =     380.43 ms /     8 tokens (   47.55 ms per token,    21.03 tokens per second)
llama_print_timings:        eval time =    4866.13 ms /    63 runs   (   77.24 ms per token,    12.95 tokens per second)
llama_print_timings:       total time =    5267.29 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5843.30 ms /   128 tokens (   45.65 ms per token,    21.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5853.30 ms /   129 tokens
...
llama_print_timings:        load time =     322.15 ms
...
llama_print_timings:        eval time =    5133.70 ms /    63 runs   (   81.49 ms per token,    12.27 tokens per second)
...
[1]4.3261,
llama_print_timings:        load time =     296.45 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6286.97 ms /   128 tokens (   49.12 ms per token,    20.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6297.09 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     338.54 ms
...
llama_print_timings:        eval time =    5504.42 ms /    63 runs   (   87.37 ms per token,    11.45 tokens per second)
llama_print_timings:       total time =    5962.42 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6583.22 ms /   128 tokens (   51.43 ms per token,    19.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6593.14 ms /   129 tokens
...
llama_print_timings:        load time =     295.43 ms
llama_print_timings:      sample time =       2.24 ms /    64 runs   (    0.03 ms per token, 28596.96 tokens per second)
llama_print_timings: prompt eval time =     610.83 ms /     8 tokens (   76.35 ms per token,    13.10 tokens per second)
llama_print_timings:        eval time =    5686.87 ms /    63 runs   (   90.27 ms per token,    11.08 tokens per second)
llama_print_timings:       total time =    6317.06 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9892.45 ms /   128 tokens (   77.28 ms per token,    12.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9902.13 ms /   129 tokens
...
llama_print_timings:        load time =     285.91 ms
llama_print_timings:      sample time =       2.29 ms /    64 runs   (    0.04 ms per token, 28008.75 tokens per second)
llama_print_timings: prompt eval time =     463.14 ms /     8 tokens (   57.89 ms per token,    17.27 tokens per second)
llama_print_timings:        eval time =    4946.99 ms /    63 runs   (   78.52 ms per token,    12.74 tokens per second)
llama_print_timings:       total time =    5430.73 ms /    71 tokens
Log end
...
[1]4.4091,
llama_print_timings:        load time =     263.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7437.04 ms /   128 tokens (   58.10 ms per token,    17.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7447.08 ms /   129 tokens
...
llama_print_timings:        load time =     303.86 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28107.16 tokens per second)
llama_print_timings: prompt eval time =     391.55 ms /     8 tokens (   48.94 ms per token,    20.43 tokens per second)
llama_print_timings:        eval time =    5020.23 ms /    63 runs   (   79.69 ms per token,    12.55 tokens per second)
llama_print_timings:       total time =    5431.28 ms /    71 tokens
Log end
...
[1]4.1768,
llama_print_timings:        load time =     288.49 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6157.36 ms /   128 tokens (   48.10 ms per token,    20.79 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6167.47 ms /   129 tokens
...
-
llama_print_timings:        load time =     347.18 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28107.16 tokens per second)
llama_print_timings: prompt eval time =     482.61 ms /     8 tokens (   60.33 ms per token,    16.58 tokens per second)
llama_print_timings:        eval time =    5767.83 ms /    63 runs   (   91.55 ms per token,    10.92 tokens per second)
llama_print_timings:       total time =    6270.43 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7300.15 ms /   128 tokens (   57.03 ms per token,    17.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7309.84 ms /   129 tokens
...
llama_print_timings:        load time =     387.54 ms
llama_print_timings:      sample time =       2.25 ms /    64 runs   (    0.04 ms per token, 28469.75 tokens per second)
llama_print_timings: prompt eval time =     526.23 ms /     8 tokens (   65.78 ms per token,    15.20 tokens per second)
llama_print_timings:        eval time =    6398.56 ms /    63 runs   (  101.56 ms per token,     9.85 tokens per second)
llama_print_timings:       total time =    6944.58 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     367.08 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8152.76 ms /   128 tokens (   63.69 ms per token,    15.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8162.71 ms /   129 tokens
...
llama_new_context_with_model: graph nodes  = 838
llama_new_context_with_model: graph splits = 1
main : serialized state into 1798809 out of a maximum of 236005460 bytes
llama_new_context_with_model: n_ctx      = 512
llama_new_context_with_model: n_batch    = 512
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: freq_base  = 10000.0
...
llama_new_context_with_model: graph nodes  = 838
llama_new_context_with_model: graph splits = 1
main : deserialized state from 1798809 out of a maximum of 236005460 bytes
llama_new_context_with_model: n_ctx      = 512
llama_new_context_with_model: n_batch    = 512
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: freq_base  = 10000.0
...
first run: The quick brown fox jumped over the lazy dog. The more time you spend with your friends and


second run: The quick brown fox jumped over the lazy dog. The more time you spend with your friends and


single seq run: The quick brown fox jumped over the lazy dog. The more time you spend with your friends and
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 49.091 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.85 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     535.56 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4848.15 ms /   128 tokens (   37.88 ms per token,    26.40 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4899.16 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 43.85 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.86 seconds per pass - ETA 0.07 minutes
[1]7.0156,
llama_print_timings:        load time =    5424.84 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4864.42 ms /   128 tokens (   38.00 ms per token,    26.31 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4910.43 ms /   129 tokens
...
perplexity: 2.83 seconds per pass - ETA 0.03 minutes
[1]9.1825,
llama_print_timings:        load time =     344.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2827.20 ms /   128 tokens (   22.09 ms per token,    45.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2875.88 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.934 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]7.0131,
llama_print_timings:        load time =    3910.06 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2815.64 ms /   128 tokens (   22.00 ms per token,    45.46 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2862.89 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 42.229 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.83 seconds per pass - ETA 0.03 minutes
[1]7.0336,
llama_print_timings:        load time =    4258.46 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2826.89 ms /   128 tokens (   22.09 ms per token,    45.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2871.13 ms /   129 tokens
...
0.32user 0.71system 0:01.03elapsed 100%CPU (0avgtext+0avgdata 6878080maxresident)k
...
0.09user 0.71system 0:00.80elapsed 100%CPU (0avgtext+0avgdata 6878008maxresident)k
