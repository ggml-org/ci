...
- status:  SUCCESS ✅
- runtime: 12:37.19
- date:    Sat Apr 27 19:14:48 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-release
      Start  1: test-quantize-fns
 1/23 Test  #1: test-quantize-fns ...................   Passed   16.24 sec
      Start  2: test-quantize-perf
...
llama_print_timings:        load time =      13.94 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       4.20 ms /     9 tokens (    0.47 ms per token,  2141.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      52.91 ms /    10 tokens
...
llama_print_timings:        load time =      10.15 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       4.29 ms /     9 tokens (    0.48 ms per token,  2098.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Soar! is a fundraising initiative that aims to raise funds for the renovation of the school's library.

**Objectives:**

- Enhance the accessibility and comfort
llama_print_timings:        load time =    1229.73 ms
llama_print_timings:      sample time =      47.64 ms /    32 runs   (    1.49 ms per token,   671.65 tokens per second)
llama_print_timings: prompt eval time =    1124.14 ms /     2 tokens (  562.07 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20853.05 ms /    31 runs   (  672.68 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22155.43 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Hebe, a daughter of Zeus and Hera, is the goddess of youth and springtime.

**a) Who is Hebe?**

**b) What
llama_print_timings:        load time =    1244.20 ms
llama_print_timings:      sample time =      47.65 ms /    32 runs   (    1.49 ms per token,   671.63 tokens per second)
llama_print_timings: prompt eval time =    1125.55 ms /     2 tokens (  562.78 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20829.15 ms /    31 runs   (  671.91 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22134.96 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heitner LLP, a leading international law firm, today announced its partnership with the International Chamber of Commerce (ICC) to offer a comprehensive dispute resolution and arbitration service
...
llama_print_timings: prompt eval time =    1121.64 ms /     2 tokens (  560.82 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20877.04 ms /    31 runs   (  673.45 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22178.36 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
## An Elegant Evening of Elegance and Entertainment

**Welcome to a night of exquisite dining, captivating performances, and enchanting ambiance.**

**Join us for
llama_print_timings:        load time =     178.31 ms
llama_print_timings:      sample time =       6.06 ms /    32 runs   (    0.19 ms per token,  5281.40 tokens per second)
llama_print_timings: prompt eval time =      74.11 ms /     2 tokens (   37.05 ms per token,    26.99 tokens per second)
llama_print_timings:        eval time =    2033.27 ms /    31 runs   (   65.59 ms per token,    15.25 tokens per second)
llama_print_timings:       total time =    2173.58 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
# Check if
llama_print_timings:        load time =     154.67 ms
llama_print_timings:      sample time =       6.20 ms /    32 runs   (    0.19 ms per token,  5157.96 tokens per second)
llama_print_timings: prompt eval time =      71.59 ms /     2 tokens (   35.80 ms per token,    27.94 tokens per second)
llama_print_timings:        eval time =    1959.44 ms /    31 runs   (   63.21 ms per token,    15.82 tokens per second)
llama_print_timings:       total time =    2097.90 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
# Tokenize the text
llama_print_timings:        load time =     159.38 ms
llama_print_timings:      sample time =       6.24 ms /    32 runs   (    0.20 ms per token,  5128.21 tokens per second)
llama_print_timings: prompt eval time =      75.52 ms /     2 tokens (   37.76 ms per token,    26.48 tokens per second)
llama_print_timings:        eval time =    2038.42 ms /    31 runs   (   65.76 ms per token,    15.21 tokens per second)
llama_print_timings:       total time =    2183.62 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32152.31 ms
main:    total time = 32152.31 ms
+ echo PASS
PASS
+ echo
...
def generate_password(length):
  ...
  # Define the character sets for uppercase letters
llama_print_timings:        load time =     150.20 ms
llama_print_timings:      sample time =       6.41 ms /    32 runs   (    0.20 ms per token,  4993.76 tokens per second)
llama_print_timings: prompt eval time =      83.44 ms /     2 tokens (   41.72 ms per token,    23.97 tokens per second)
llama_print_timings:        eval time =    1560.96 ms /    31 runs   (   50.35 ms per token,    19.86 tokens per second)
llama_print_timings:       total time =    1711.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After the rain, the sky turned bright blue. The sun shone brightly, casting a warm glow on everything in its path. Birdsong filled the air, and flowers
llama_print_timings:        load time =     119.73 ms
llama_print_timings:      sample time =       5.84 ms /    32 runs   (    0.18 ms per token,  5474.76 tokens per second)
llama_print_timings: prompt eval time =      63.53 ms /     2 tokens (   31.76 ms per token,    31.48 tokens per second)
llama_print_timings:        eval time =    1445.42 ms /    31 runs   (   46.63 ms per token,    21.45 tokens per second)
llama_print_timings:       total time =    1574.48 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     562.56 ms
llama_print_timings:      sample time =       2.53 ms /    64 runs   (    0.04 ms per token, 25306.45 tokens per second)
llama_print_timings: prompt eval time =     300.15 ms /     8 tokens (   37.52 ms per token,    26.65 tokens per second)
llama_print_timings:        eval time =    7628.95 ms /    63 runs   (  121.09 ms per token,     8.26 tokens per second)
llama_print_timings:       total time =    7951.55 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     538.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4577.21 ms /   128 tokens (   35.76 ms per token,    27.96 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4587.32 ms /   129 tokens
...
llama_print_timings:        load time =     373.98 ms
llama_print_timings:      sample time =       2.26 ms /    64 runs   (    0.04 ms per token, 28281.04 tokens per second)
llama_print_timings: prompt eval time =     207.86 ms /     8 tokens (   25.98 ms per token,    38.49 tokens per second)
llama_print_timings:        eval time =    5365.54 ms /    63 runs   (   85.17 ms per token,    11.74 tokens per second)
llama_print_timings:       total time =    5593.79 ms /    71 tokens
Log end
...
llama_print_timings:        load time =     249.17 ms
llama_print_timings:      sample time =       2.25 ms /    64 runs   (    0.04 ms per token, 28482.42 tokens per second)
llama_print_timings: prompt eval time =     201.99 ms /     8 tokens (   25.25 ms per token,    39.61 tokens per second)
llama_print_timings:        eval time =    4515.71 ms /    63 runs   (   71.68 ms per token,    13.95 tokens per second)
llama_print_timings:       total time =    4737.38 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3104.87 ms /   128 tokens (   24.26 ms per token,    41.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3115.39 ms /   129 tokens
...
llama_print_timings:        load time =     294.52 ms
...
llama_print_timings:        eval time =    4800.91 ms /    63 runs   (   76.20 ms per token,    13.12 tokens per second)
llama_print_timings:       total time =    5192.38 ms /    71 tokens
Log end
...
[1]4.3889,
llama_print_timings:        load time =     276.97 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5862.40 ms /   128 tokens (   45.80 ms per token,    21.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5872.63 ms /   129 tokens
...
llama_print_timings: prompt eval time =     410.36 ms /     8 tokens (   51.30 ms per token,    19.49 tokens per second)
llama_print_timings:        eval time =    5132.21 ms /    63 runs   (   81.46 ms per token,    12.28 tokens per second)
llama_print_timings:       total time =    5563.21 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6208.93 ms /   128 tokens (   48.51 ms per token,    20.62 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6218.95 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     341.62 ms
llama_print_timings:      sample time =       2.27 ms /    64 runs   (    0.04 ms per token, 28169.01 tokens per second)
llama_print_timings: prompt eval time =     419.58 ms /     8 tokens (   52.45 ms per token,    19.07 tokens per second)
llama_print_timings:        eval time =    5462.07 ms /    63 runs   (   86.70 ms per token,    11.53 tokens per second)
llama_print_timings:       total time =    5901.18 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6624.25 ms /   128 tokens (   51.75 ms per token,    19.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6634.93 ms /   129 tokens
...
llama_print_timings:        eval time =    5731.50 ms /    63 runs   (   90.98 ms per token,    10.99 tokens per second)
llama_print_timings:       total time =    6367.46 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9866.91 ms /   128 tokens (   77.09 ms per token,    12.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9877.37 ms /   129 tokens
...
llama_print_timings: prompt eval time =     461.86 ms /     8 tokens (   57.73 ms per token,    17.32 tokens per second)
llama_print_timings:        eval time =    4945.88 ms /    63 runs   (   78.51 ms per token,    12.74 tokens per second)
llama_print_timings:       total time =    5427.18 ms /    71 tokens
Log end
...
[1]4.4091,
llama_print_timings:        load time =     264.80 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7400.97 ms /   128 tokens (   57.82 ms per token,    17.30 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7410.92 ms /   129 tokens
...
llama_print_timings: prompt eval time =     390.80 ms /     8 tokens (   48.85 ms per token,    20.47 tokens per second)
llama_print_timings:        eval time =    5001.50 ms /    63 runs   (   79.39 ms per token,    12.60 tokens per second)
llama_print_timings:       total time =    5413.03 ms /    71 tokens
Log end
...
[1]4.1768,
llama_print_timings:        load time =     282.49 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6136.78 ms /   128 tokens (   47.94 ms per token,    20.86 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6146.79 ms /   129 tokens
...
-
llama_print_timings:        load time =     343.84 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28119.51 tokens per second)
llama_print_timings: prompt eval time =     465.30 ms /     8 tokens (   58.16 ms per token,    17.19 tokens per second)
llama_print_timings:        eval time =    5698.36 ms /    63 runs   (   90.45 ms per token,    11.06 tokens per second)
llama_print_timings:       total time =    6183.12 ms /    71 tokens
Log end
...
[1]4.2338,
llama_print_timings:        load time =     327.75 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7366.20 ms /   128 tokens (   57.55 ms per token,    17.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7376.68 ms /   129 tokens
...
llama_print_timings:        load time =     389.04 ms
llama_print_timings:      sample time =       2.24 ms /    64 runs   (    0.03 ms per token, 28584.19 tokens per second)
llama_print_timings: prompt eval time =     519.77 ms /     8 tokens (   64.97 ms per token,    15.39 tokens per second)
llama_print_timings:        eval time =    6302.61 ms /    63 runs   (  100.04 ms per token,    10.00 tokens per second)
llama_print_timings:       total time =    6842.22 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     368.11 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8137.10 ms /   128 tokens (   63.57 ms per token,    15.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8147.51 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.94 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.58 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     539.72 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4575.82 ms /   128 tokens (   35.75 ms per token,    27.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4625.71 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 46.099 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.58 seconds per pass - ETA 0.07 minutes
[1]7.0156,
llama_print_timings:        load time =    5409.09 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4583.68 ms /   128 tokens (   35.81 ms per token,    27.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4631.61 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.288 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]9.1825,
llama_print_timings:        load time =     344.69 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2817.65 ms /   128 tokens (   22.01 ms per token,    45.43 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.001 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.81 seconds per pass - ETA 0.03 minutes
[1]7.0131,
llama_print_timings:        load time =    3852.29 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2806.13 ms /   128 tokens (   21.92 ms per token,    45.61 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2851.87 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.428 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]7.0336,
llama_print_timings:        load time =    4177.49 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2819.91 ms /   128 tokens (   22.03 ms per token,    45.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2865.99 ms /   129 tokens
...
0.30user 0.73system 0:01.04elapsed 99%CPU (0avgtext+0avgdata 6878100maxresident)k
...
0.07user 0.75system 0:00.83elapsed 100%CPU (0avgtext+0avgdata 6877860maxresident)k
