...
- status:  SUCCESS ✅
- runtime: 14:50.02
- date:    Tue Jun  4 10:23:32 UTC 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/4df81854ab62d74fef219ba37b32ff1db7c2af71
...
main: build = 3089 (4df81854)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
main: seed  = 1717495882
...
llama_print_timings: prompt eval time =       4.08 ms /     9 tokens (    0.45 ms per token,  2203.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =       5.55 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.44 ms /     9 tokens (    0.38 ms per token,  2618.56 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increably and then slowly.

I am so sorry, but I cannot write a story that includes sexually suggestive content. [end of text]

llama_print_timings:        load time =    1296.78 ms
llama_print_timings:      sample time =      37.14 ms /    25 runs   (    1.49 ms per token,   673.15 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   16931.30 ms /    25 runs   (  677.25 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   17068.13 ms /    25 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    1285.90 ms
llama_print_timings:      sample time =       5.85 ms /     4 runs   (    1.46 ms per token,   683.76 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    2880.34 ms /     4 runs   (  720.08 ms per token,     1.39 tokens per second)
llama_print_timings:       total time =    2903.14 ms /     4 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities, and the broader cultural impact of these practices. [end of text]

llama_print_timings:        load time =    1268.43 ms
llama_print_timings:      sample time =      19.34 ms /    13 runs   (    1.49 ms per token,   672.11 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    8777.64 ms /    13 runs   (  675.20 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =    8849.25 ms /    13 tokens
Log end
+ echo PASS
PASS
+ echo
...
I. Explain the difference between a stock and a bond.
II. Describe the process of investing in a bond.
III. Discuss
llama_print_timings:        load time =    1266.47 ms
llama_print_timings:      sample time =      47.93 ms /    32 runs   (    1.50 ms per token,   667.68 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   21945.47 ms /    32 runs   (  685.80 ms per token,     1.46 tokens per second)
llama_print_timings:       total time =   22120.72 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196351.91 ms
main:    total time = 196351.91 ms
+ echo PASS
PASS
+ echo
...
I am unable to generate a response to your query because it contains inappropriate and potentially harmful content. My purpose is to assist with tasks that are
llama_print_timings:        load time =     677.79 ms
llama_print_timings:      sample time =      47.37 ms /    32 runs   (    1.48 ms per token,   675.53 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   10879.51 ms /    32 runs   (  339.98 ms per token,     2.94 tokens per second)
llama_print_timings:       total time =   11053.82 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196483.36 ms
main:    total time = 196483.36 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     669.75 ms
llama_print_timings:      sample time =       5.89 ms /     4 runs   (    1.47 ms per token,   678.89 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1375.10 ms /     4 runs   (  343.78 ms per token,     2.91 tokens per second)
llama_print_timings:       total time =    1398.11 ms /     4 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =     273.24 ms /     4 runs   (   68.31 ms per token,    14.64 tokens per second)
llama_print_timings:       total time =     282.14 ms /     4 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities, and other forms of inappropriate sexual behavior within a school environment.

This behavior creates a hostile and unsafe learning environment for students, staff, and visitors
llama_print_timings:        load time =     207.34 ms
llama_print_timings:      sample time =       4.86 ms /    32 runs   (    0.15 ms per token,  6591.14 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    2104.47 ms /    32 runs   (   65.76 ms per token,    15.21 tokens per second)
llama_print_timings:       total time =    2165.50 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =     275.82 ms /     4 runs   (   68.95 ms per token,    14.50 tokens per second)
llama_print_timings:       total time =     284.78 ms /     4 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities, and a general disregard for rules and boundaries.

Do you think the current state of affairs in the world is chaotic or disordered?
...
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    2219.62 ms /    32 runs   (   69.36 ms per token,    14.42 tokens per second)
llama_print_timings:       total time =    2281.89 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32224.71 ms
main:    total time = 32224.71 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 effega is a species of fungus that is known to cause respiratory infections in humans. It is commonly known as the "sinusitis fungus."

**Symptoms of
llama_print_timings:        load time =     173.57 ms
llama_print_timings:      sample time =       4.94 ms /    32 runs   (    0.15 ms per token,  6482.98 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1616.27 ms /    32 runs   (   50.51 ms per token,    19.80 tokens per second)
llama_print_timings:       total time =    1678.13 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31993.43 ms
main:    total time = 31993.43 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       3.51 ms /    21 runs   (    0.17 ms per token,  5981.20 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1035.20 ms /    21 runs   (   49.30 ms per token,    20.29 tokens per second)
llama_print_timings:       total time =    1076.31 ms /    21 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     277.02 ms
...
llama_print_timings:        eval time =    3304.52 ms /    63 runs   (   52.45 ms per token,    19.06 tokens per second)
llama_print_timings:       total time =    3457.59 ms /    71 tokens
Log end
...
[1]9.4753,
llama_print_timings:        load time =     174.83 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1846.07 ms /   128 tokens (   14.42 ms per token,    69.34 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1860.33 ms /   129 tokens
...
llama_print_timings: prompt eval time =      86.31 ms /     8 tokens (   10.79 ms per token,    92.68 tokens per second)
llama_print_timings:        eval time =    2545.58 ms /    63 runs   (   40.41 ms per token,    24.75 tokens per second)
llama_print_timings:       total time =    2658.16 ms /    71 tokens
Log end
...
[1]9.5664,
llama_print_timings:        load time =     151.05 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1103.76 ms /   128 tokens (    8.62 ms per token,   115.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1119.01 ms /   129 tokens
...
llama_print_timings:        load time =     197.06 ms
...
llama_print_timings:        eval time =    2050.37 ms /    63 runs   (   32.55 ms per token,    30.73 tokens per second)
llama_print_timings:       total time =    2158.16 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 0 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 10.857 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 1.21 seconds per pass - ETA 0.02 minutes
[1]10.2324,
llama_print_timings:        load time =      95.12 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1213.27 ms /   128 tokens (    9.48 ms per token,   105.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1228.89 ms /   129 tokens
...
llama_print_timings:        eval time =    2014.77 ms /    63 runs   (   31.98 ms per token,    31.27 tokens per second)
llama_print_timings:       total time =    2189.61 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2220.69 ms /   128 tokens (   17.35 ms per token,    57.64 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2234.69 ms /   129 tokens
...
llama_print_timings:      sample time =       2.34 ms /    64 runs   (    0.04 ms per token, 27397.26 tokens per second)
llama_print_timings: prompt eval time =     156.02 ms /     8 tokens (   19.50 ms per token,    51.28 tokens per second)
llama_print_timings:        eval time =    2186.39 ms /    63 runs   (   34.70 ms per token,    28.81 tokens per second)
llama_print_timings:       total time =    2369.06 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2386.61 ms /   128 tokens (   18.65 ms per token,    53.63 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2401.03 ms /   129 tokens
...
llama_print_timings: prompt eval time =     167.03 ms /     8 tokens (   20.88 ms per token,    47.90 tokens per second)
llama_print_timings:        eval time =    2306.91 ms /    63 runs   (   36.62 ms per token,    27.31 tokens per second)
llama_print_timings:       total time =    2501.06 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2505.84 ms /   128 tokens (   19.58 ms per token,    51.08 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2520.21 ms /   129 tokens
...
llama_print_timings:        load time =     180.38 ms
llama_print_timings:      sample time =       2.10 ms /    64 runs   (    0.03 ms per token, 30519.79 tokens per second)
llama_print_timings: prompt eval time =     113.40 ms /     8 tokens (   14.18 ms per token,    70.54 tokens per second)
llama_print_timings:        eval time =    1529.68 ms /    63 runs   (   24.28 ms per token,    41.19 tokens per second)
llama_print_timings:       total time =    1675.61 ms /    71 tokens
Log end
...
[1]68.7223,
llama_print_timings:        load time =      79.08 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1585.50 ms /   128 tokens (   12.39 ms per token,    80.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1600.76 ms /   129 tokens
...
llama_print_timings: prompt eval time =     113.87 ms /     8 tokens (   14.23 ms per token,    70.26 tokens per second)
llama_print_timings:        eval time =    1744.45 ms /    63 runs   (   27.69 ms per token,    36.11 tokens per second)
llama_print_timings:       total time =    1885.50 ms /    71 tokens
Log end
...
[1]11.5044,
llama_print_timings:        load time =      88.43 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1680.16 ms /   128 tokens (   13.13 ms per token,    76.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1694.91 ms /   129 tokens
...
llama_print_timings: prompt eval time =     119.33 ms /     8 tokens (   14.92 ms per token,    67.04 tokens per second)
llama_print_timings:        eval time =    1910.01 ms /    63 runs   (   30.32 ms per token,    32.98 tokens per second)
llama_print_timings:       total time =    2055.98 ms /    71 tokens
Log end
...
[1]9.5837,
llama_print_timings:        load time =      99.67 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1739.88 ms /   128 tokens (   13.59 ms per token,    73.57 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1754.80 ms /   129 tokens
...
I believe the
llama_print_timings:        load time =     212.35 ms
llama_print_timings:      sample time =       2.18 ms /    64 runs   (    0.03 ms per token, 29411.76 tokens per second)
llama_print_timings: prompt eval time =     138.71 ms /     8 tokens (   17.34 ms per token,    57.67 tokens per second)
llama_print_timings:        eval time =    2144.46 ms /    63 runs   (   34.04 ms per token,    29.38 tokens per second)
llama_print_timings:       total time =    2309.32 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2047.76 ms /   128 tokens (   16.00 ms per token,    62.51 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings:        load time =     223.74 ms
llama_print_timings:      sample time =       2.32 ms /    64 runs   (    0.04 ms per token, 27538.73 tokens per second)
llama_print_timings: prompt eval time =     131.04 ms /     8 tokens (   16.38 ms per token,    61.05 tokens per second)
llama_print_timings:        eval time =    2237.10 ms /    63 runs   (   35.51 ms per token,    28.16 tokens per second)
llama_print_timings:       total time =    2395.02 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1867.80 ms /   128 tokens (   14.59 ms per token,    68.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1882.15 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog: Establishing validity models and employing them to construct knowledge


second run: The quick brown fox jumps over the lazy dog: Establishing validity models and employing them to construct knowledge


single seq run: The quick brown fox jumps over the lazy dog: Establishing validity models and employing them to construct knowledge
...
first run: The quick brown fox jumps over some more easy eggs

1,629 shares<|endoftext|>Welcome Back


second run: The quick brown fox jumps over some more easy eggs

1,629 shares<|endoftext|>Welcome Back


single seq run: The quick brown fox jumps over some more easy eggs
...
1.22user 0.19system 0:01.41elapsed 99%CPU (0avgtext+0avgdata 2897356maxresident)k
0inputs+40outputs (0major+61529minor)pagefaults 0swaps
```
...
0.22user 0.22system 0:00.45elapsed 99%CPU (0avgtext+0avgdata 2896636maxresident)k
0inputs+40outputs (0major+59966minor)pagefaults 0swaps
```
