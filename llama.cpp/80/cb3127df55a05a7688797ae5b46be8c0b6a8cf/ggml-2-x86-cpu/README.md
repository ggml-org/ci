...
- status:  SUCCESS ✅
- runtime: 13:22.32
- date:    Mon Apr 29 12:38:41 UTC 2024
...
10/21 Test #10: test-tokenizer-1-llama-spm ........   Passed    3.42 sec
      Start 11: test-quantize-fns
11/21 Test #11: test-quantize-fns .................   Passed   31.05 sec
      Start 12: test-quantize-perf
12/21 Test #12: test-quantize-perf ................   Passed    9.08 sec
...
17/21 Test #17: test-grammar-integration ..........   Passed    0.01 sec
      Start 18: test-grad0
18/21 Test #18: test-grad0 ........................   Passed    2.55 sec
...
10/21 Test #10: test-tokenizer-1-llama-spm ........   Passed    0.45 sec
      Start 11: test-quantize-fns
11/21 Test #11: test-quantize-fns .................   Passed   16.24 sec
      Start 12: test-quantize-perf
12/21 Test #12: test-quantize-perf ................   Passed    4.44 sec
      Start 13: test-sampling
...
llama_print_timings: prompt eval time =       4.43 ms /     9 tokens (    0.49 ms per token,  2032.06 tokens per second)
...
llama_print_timings:        load time =      10.48 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Soar is a project dedicated to promoting aviation education, inspiring young minds to pursue careers in the aviation industry.

**a) Briefly explain the project's objective
llama_print_timings:        load time =    1246.72 ms
llama_print_timings:      sample time =      47.87 ms /    32 runs   (    1.50 ms per token,   668.51 tokens per second)
llama_print_timings: prompt eval time =    1120.82 ms /     2 tokens (  560.41 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20654.15 ms /    31 runs   (  666.26 ms per token,     1.50 tokens per second)
llama_print_timings:       total time =   21953.85 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
$$f(-2) =
llama_print_timings:        load time =    1208.19 ms
llama_print_timings:      sample time =      47.73 ms /    32 runs   (    1.49 ms per token,   670.38 tokens per second)
llama_print_timings: prompt eval time =    1200.30 ms /     2 tokens (  600.15 ms per token,     1.67 tokens per second)
llama_print_timings:        eval time =   20782.21 ms /    31 runs   (  670.39 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22161.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If f(x) = x^2 + 2x + 1, find f(-2) and f(3).

$$f(x)
llama_print_timings:        load time =    1209.09 ms
llama_print_timings:      sample time =      47.48 ms /    32 runs   (    1.48 ms per token,   673.91 tokens per second)
llama_print_timings: prompt eval time =    1123.02 ms /     2 tokens (  561.51 ms per token,     1.78 tokens per second)
llama_print_timings:        eval time =   20828.94 ms /    31 runs   (  671.90 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22129.46 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heuristics, and Confirmation Bias
...
llama_print_timings:      sample time =       6.55 ms /    32 runs   (    0.20 ms per token,  4888.48 tokens per second)
llama_print_timings: prompt eval time =      74.58 ms /     2 tokens (   37.29 ms per token,    26.82 tokens per second)
llama_print_timings:        eval time =    2065.85 ms /    31 runs   (   66.64 ms per token,    15.01 tokens per second)
llama_print_timings:       total time =    2207.65 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After reviewing the provided code snippet, I have some questions and need clarification.
...
llama_print_timings: prompt eval time =      83.08 ms /     2 tokens (   41.54 ms per token,    24.07 tokens per second)
llama_print_timings:        eval time =    2024.83 ms /    31 runs   (   65.32 ms per token,    15.31 tokens per second)
llama_print_timings:       total time =    2176.47 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When a researcher reports a statistically significant difference between two groups, what does it mean?

**A.** The groups are likely to be different in the population.

llama_print_timings:        load time =     158.02 ms
llama_print_timings:      sample time =       6.75 ms /    32 runs   (    0.21 ms per token,  4737.23 tokens per second)
...
llama_print_timings:       total time =    2207.33 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32090.17 ms
main:    total time = 32090.17 ms
+ echo PASS
PASS
+ echo
...
<bos> They say necessity is the mother of invention, and there is no greater necessity than the need to survive. This proverb highlights the fundamental importance of survival in shaping human behavior
llama_print_timings:        load time =     148.33 ms
llama_print_timings:      sample time =       7.04 ms /    32 runs   (    0.22 ms per token,  4544.81 tokens per second)
llama_print_timings: prompt eval time =      78.21 ms /     2 tokens (   39.11 ms per token,    25.57 tokens per second)
llama_print_timings:        eval time =    1620.64 ms /    31 runs   (   52.28 ms per token,    19.13 tokens per second)
llama_print_timings:       total time =    1769.29 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32103.12 ms
main:    total time = 32103.12 ms
+ echo PASS
PASS
+ echo
...
Get to Work is a new expansion pack for The Sims 4 that introduces a new career system,
...
llama_print_timings: prompt eval time =      64.39 ms /     2 tokens (   32.20 ms per token,    31.06 tokens per second)
llama_print_timings:        eval time =    1501.50 ms /    31 runs   (   48.44 ms per token,    20.65 tokens per second)
llama_print_timings:       total time =    1632.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     567.54 ms
llama_print_timings:      sample time =       2.32 ms /    64 runs   (    0.04 ms per token, 27621.92 tokens per second)
llama_print_timings: prompt eval time =     308.84 ms /     8 tokens (   38.60 ms per token,    25.90 tokens per second)
llama_print_timings:        eval time =    7700.44 ms /    63 runs   (  122.23 ms per token,     8.18 tokens per second)
llama_print_timings:       total time =    8031.53 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     548.50 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4848.88 ms /   128 tokens (   37.88 ms per token,    26.40 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4859.13 ms /   129 tokens
...
llama_print_timings:        load time =     371.02 ms
llama_print_timings:      sample time =       2.05 ms /    64 runs   (    0.03 ms per token, 31234.75 tokens per second)
llama_print_timings: prompt eval time =     207.32 ms /     8 tokens (   25.91 ms per token,    38.59 tokens per second)
llama_print_timings:        eval time =    5344.54 ms /    63 runs   (   84.83 ms per token,    11.79 tokens per second)
llama_print_timings:       total time =    5571.35 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2823.83 ms /   128 tokens (   22.06 ms per token,    45.33 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2834.23 ms /   129 tokens
...
llama_print_timings:        eval time =    4588.35 ms /    63 runs   (   72.83 ms per token,    13.73 tokens per second)
llama_print_timings:       total time =    4809.50 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3127.14 ms /   128 tokens (   24.43 ms per token,    40.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3136.86 ms /   129 tokens
...
llama_print_timings:        load time =     294.57 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31295.84 tokens per second)
llama_print_timings: prompt eval time =     372.62 ms /     8 tokens (   46.58 ms per token,    21.47 tokens per second)
llama_print_timings:        eval time =    4890.42 ms /    63 runs   (   77.63 ms per token,    12.88 tokens per second)
llama_print_timings:       total time =    5282.89 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5831.24 ms /   128 tokens (   45.56 ms per token,    21.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5841.10 ms /   129 tokens
...
llama_print_timings:        load time =     335.59 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31449.63 tokens per second)
llama_print_timings: prompt eval time =     401.60 ms /     8 tokens (   50.20 ms per token,    19.92 tokens per second)
llama_print_timings:        eval time =    5135.65 ms /    63 runs   (   81.52 ms per token,    12.27 tokens per second)
llama_print_timings:       total time =    5557.00 ms /    71 tokens
Log end
...
[1]4.3261,
llama_print_timings:        load time =     298.72 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6228.06 ms /   128 tokens (   48.66 ms per token,    20.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6238.22 ms /   129 tokens
...
llama_print_timings:        eval time =    5576.16 ms /    63 runs   (   88.51 ms per token,    11.30 tokens per second)
llama_print_timings:       total time =    6022.16 ms /    71 tokens
Log end
...
llama_print_timings: prompt eval time =     610.70 ms /     8 tokens (   76.34 ms per token,    13.10 tokens per second)
llama_print_timings:        eval time =    5716.49 ms /    63 runs   (   90.74 ms per token,    11.02 tokens per second)
llama_print_timings:       total time =    6347.25 ms /    71 tokens
Log end
...
[1]5.6204,
llama_print_timings:        load time =     277.25 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9908.41 ms /   128 tokens (   77.41 ms per token,    12.92 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9918.53 ms /   129 tokens
...
llama_print_timings: prompt eval time =     466.41 ms /     8 tokens (   58.30 ms per token,    17.15 tokens per second)
llama_print_timings:        eval time =    4961.15 ms /    63 runs   (   78.75 ms per token,    12.70 tokens per second)
llama_print_timings:       total time =    5446.76 ms /    71 tokens
Log end
...
[1]4.4091,
llama_print_timings:        load time =     274.91 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7430.56 ms /   128 tokens (   58.05 ms per token,    17.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7441.29 ms /   129 tokens
...
llama_print_timings: prompt eval time =     391.66 ms /     8 tokens (   48.96 ms per token,    20.43 tokens per second)
llama_print_timings:        eval time =    5035.38 ms /    63 runs   (   79.93 ms per token,    12.51 tokens per second)
llama_print_timings:       total time =    5446.42 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6178.74 ms /   128 tokens (   48.27 ms per token,    20.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6188.91 ms /   129 tokens
...
-
llama_print_timings:        load time =     349.78 ms
...
llama_print_timings:        eval time =    5710.65 ms /    63 runs   (   90.65 ms per token,    11.03 tokens per second)
llama_print_timings:       total time =    6205.64 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7412.55 ms /   128 tokens (   57.91 ms per token,    17.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7422.91 ms /   129 tokens
...
llama_print_timings:        eval time =    6329.86 ms /    63 runs   (  100.47 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    6871.07 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     369.85 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8153.34 ms /   128 tokens (   63.70 ms per token,    15.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8164.13 ms /   129 tokens
...
This sentence contains the following text fragments:: <
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 46.947 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.89 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     546.54 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4894.62 ms /   128 tokens (   38.24 ms per token,    26.15 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4944.19 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.581 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.92 seconds per pass - ETA 0.07 minutes
[1]7.0156,
llama_print_timings:        load time =    5591.61 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4915.08 ms /   128 tokens (   38.40 ms per token,    26.04 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4961.80 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.127 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]9.1825,
llama_print_timings:        load time =     358.32 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2820.90 ms /   128 tokens (   22.04 ms per token,    45.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2870.05 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.32 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]7.0131,
llama_print_timings:        load time =    3913.15 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2819.06 ms /   128 tokens (   22.02 ms per token,    45.41 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2865.56 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.161 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.82 seconds per pass - ETA 0.03 minutes
[1]7.0336,
llama_print_timings:        load time =    4265.31 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2819.79 ms /   128 tokens (   22.03 ms per token,    45.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2866.99 ms /   129 tokens
...
0.30user 0.74system 0:01.04elapsed 100%CPU (0avgtext+0avgdata 6878164maxresident)k
0inputs+40outputs (0major+112505minor)pagefaults 0swaps
```
...
1/2 Test #21: test-model-load-cancel ...........   Passed    0.04 sec
    Start 22: test-autorelease
2/2 Test #22: test-autorelease .................   Passed    0.77 sec
...
0.08user 0.74system 0:00.82elapsed 100%CPU (0avgtext+0avgdata 6878136maxresident)k
