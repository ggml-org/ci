...
- status:  SUCCESS ✅
- runtime: 536.88
- date:    Fri Mar 22 15:43:01 EET 2024
...
Label Time Summary:
main    = 194.90 sec*proc (22 tests)

Total Test time (real) = 194.92 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      13.12 ms /     9 tokens (    1.46 ms per token,   685.92 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
