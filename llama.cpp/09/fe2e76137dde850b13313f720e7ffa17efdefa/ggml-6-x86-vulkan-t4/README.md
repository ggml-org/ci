...
- status:  FAILURE ❌ (139)
- runtime: 6:14.41
- date:    Tue Dec 24 16:46:16 UTC 2024
...
24/28 Test #24: test-backend-ops ..................   Passed   46.01 sec
...
23/28 Test #23: test-gguf .........................   Passed    0.53 sec
      Start 24: test-backend-ops
24/28 Test #24: test-backend-ops ..................   Passed   10.15 sec
      Start 27: test-barrier
...
0.00.000.166 I build: 4389 (09fe2e76) with cc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0 for x86_64-linux-gnu
0.00.000.361 I llama_load_model_from_file: using device Vulkan0 (Tesla T4) - 16384 MiB free
0.00.004.367 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.010.640 I llama_model_loader: - kv  19:            tokenizer.ggml.unknown_token_id u32              = 100
0.00.010.640 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.010.641 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.010.641 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
0.00.010.642 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
0.00.010.642 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.010.644 I llama_model_loader: - type  f32:  124 tensors
0.00.010.645 I llama_model_loader: - type  f16:   73 tensors
0.00.019.877 I llm_load_vocab: special tokens cache size = 5
0.00.024.829 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.024.838 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.024.838 I llm_load_print_meta: arch             = bert
0.00.024.839 I llm_load_print_meta: vocab type       = WPM
0.00.024.839 I llm_load_print_meta: n_vocab          = 30522
0.00.024.839 I llm_load_print_meta: n_merges         = 0
0.00.024.839 I llm_load_print_meta: vocab_only       = 0
0.00.024.840 I llm_load_print_meta: n_ctx_train      = 512
0.00.024.840 I llm_load_print_meta: n_embd           = 384
0.00.024.840 I llm_load_print_meta: n_layer          = 12
0.00.024.846 I llm_load_print_meta: n_head           = 12
...
0.00.024.848 I llm_load_print_meta: n_embd_head_k    = 32
0.00.024.849 I llm_load_print_meta: n_embd_head_v    = 32
0.00.024.849 I llm_load_print_meta: n_gqa            = 1
0.00.024.851 I llm_load_print_meta: n_embd_k_gqa     = 384
...
0.00.024.854 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.024.855 I llm_load_print_meta: n_ff             = 1536
0.00.024.855 I llm_load_print_meta: n_expert         = 0
0.00.024.855 I llm_load_print_meta: n_expert_used    = 0
0.00.024.856 I llm_load_print_meta: causal attn      = 0
0.00.024.856 I llm_load_print_meta: pooling type     = 2
0.00.024.856 I llm_load_print_meta: rope type        = 2
0.00.024.856 I llm_load_print_meta: rope scaling     = linear
0.00.024.858 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.024.858 I llm_load_print_meta: freq_scale_train = 1
0.00.024.858 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.024.859 I llm_load_print_meta: rope_finetuned   = unknown
0.00.024.859 I llm_load_print_meta: ssm_d_conv       = 0
0.00.024.859 I llm_load_print_meta: ssm_d_inner      = 0
0.00.024.859 I llm_load_print_meta: ssm_d_state      = 0
0.00.024.860 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.024.860 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.024.860 I llm_load_print_meta: model type       = 33M
0.00.024.861 I llm_load_print_meta: model ftype      = F16
0.00.024.862 I llm_load_print_meta: model params     = 33.21 M
0.00.024.862 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.024.863 I llm_load_print_meta: general.name     = Bge Small
0.00.024.864 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.024.864 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.024.864 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.024.864 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.024.865 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.024.865 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.024.865 I llm_load_print_meta: max token length = 21
ggml_vulkan: Compiling shaders................................Done!
0.00.261.015 I llm_load_tensors: offloading 12 repeating layers to GPU
0.00.261.022 I llm_load_tensors: offloading output layer to GPU
0.00.261.023 I llm_load_tensors: offloaded 13/13 layers to GPU
0.00.261.028 I llm_load_tensors:      Vulkan0 model buffer size =    40.73 MiB
0.00.261.028 I llm_load_tensors:   CPU_Mapped model buffer size =    23.11 MiB
................................................
0.00.271.116 I llama_new_context_with_model: n_seq_max     = 1
0.00.271.121 I llama_new_context_with_model: n_ctx         = 512
0.00.271.121 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.271.121 I llama_new_context_with_model: n_batch       = 2048
0.00.271.121 I llama_new_context_with_model: n_ubatch      = 2048
0.00.271.122 I llama_new_context_with_model: flash_attn    = 0
0.00.271.125 I llama_new_context_with_model: freq_base     = 10000.0
0.00.271.125 I llama_new_context_with_model: freq_scale    = 1
0.00.271.615 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12
0.00.273.263 I llama_kv_cache_init:    Vulkan0 KV buffer size =     9.00 MiB
0.00.273.285 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.273.291 I llama_new_context_with_model: Vulkan_Host  output buffer size =     0.00 MiB
0.00.277.008 I llama_new_context_with_model:    Vulkan0 compute buffer size =    16.00 MiB
0.00.277.016 I llama_new_context_with_model: Vulkan_Host compute buffer size =     2.51 MiB
0.00.277.017 I llama_new_context_with_model: graph nodes  = 429
0.00.277.017 I llama_new_context_with_model: graph splits = 4 (with bs=512), 2 (with bs=1)
0.00.277.019 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.277.019 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.283.743 I 
0.00.283.804 I system_info: n_threads = 4 (n_threads_batch = 4) / 4 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.285.481 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.291.649 I llama_perf_context_print:        load time =     283.37 ms
0.00.291.650 I llama_perf_context_print: prompt eval time =       5.77 ms /     9 tokens (    0.64 ms per token,  1559.79 tokens per second)
0.00.291.651 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.291.652 I llama_perf_context_print:       total time =       7.91 ms /    10 tokens
...
0.00.004.411 I llama_model_loader: - kv  11:                          general.file_type u32              = 7
...
0.00.025.069 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.025.080 I llm_load_print_meta: n_vocab          = 30522
0.00.025.080 I llm_load_print_meta: n_merges         = 0
0.00.025.080 I llm_load_print_meta: vocab_only       = 0
0.00.025.081 I llm_load_print_meta: n_ctx_train      = 512
0.00.025.081 I llm_load_print_meta: n_embd           = 384
0.00.025.082 I llm_load_print_meta: n_layer          = 12
0.00.025.087 I llm_load_print_meta: n_head           = 12
0.00.025.088 I llm_load_print_meta: n_head_kv        = 12
0.00.025.088 I llm_load_print_meta: n_rot            = 32
0.00.025.089 I llm_load_print_meta: n_swa            = 0
0.00.025.089 I llm_load_print_meta: n_embd_head_k    = 32
0.00.025.090 I llm_load_print_meta: n_embd_head_v    = 32
0.00.025.091 I llm_load_print_meta: n_gqa            = 1
0.00.025.092 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.025.093 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.025.094 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.025.094 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.025.095 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.025.095 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.025.100 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.025.101 I llm_load_print_meta: freq_scale_train = 1
0.00.025.101 I llm_load_print_meta: n_ctx_orig_yarn  = 512
...
0.00.025.103 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.025.103 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.025.104 I llm_load_print_meta: model type       = 33M
0.00.025.105 I llm_load_print_meta: model ftype      = Q8_0
0.00.025.105 I llm_load_print_meta: model params     = 33.21 M
0.00.025.106 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.025.106 I llm_load_print_meta: general.name     = Bge Small
0.00.025.107 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.025.107 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.025.108 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.025.108 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.025.108 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.025.108 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.025.109 I llm_load_print_meta: max token length = 21
ggml_vulkan: Compiling shaders................................Done!
0.00.246.676 I llm_load_tensors: offloading 12 repeating layers to GPU
0.00.246.683 I llm_load_tensors: offloading output layer to GPU
0.00.246.684 I llm_load_tensors: offloaded 13/13 layers to GPU
0.00.246.689 I llm_load_tensors:      Vulkan0 model buffer size =    21.74 MiB
0.00.246.690 I llm_load_tensors:   CPU_Mapped model buffer size =    12.63 MiB
................................................
0.00.253.145 I llama_new_context_with_model: n_seq_max     = 1
0.00.253.150 I llama_new_context_with_model: n_ctx         = 512
0.00.253.150 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.253.151 I llama_new_context_with_model: n_batch       = 2048
0.00.253.151 I llama_new_context_with_model: n_ubatch      = 2048
0.00.253.151 I llama_new_context_with_model: flash_attn    = 0
0.00.253.155 I llama_new_context_with_model: freq_base     = 10000.0
0.00.253.155 I llama_new_context_with_model: freq_scale    = 1
0.00.253.633 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12
0.00.256.154 I llama_kv_cache_init:    Vulkan0 KV buffer size =     9.00 MiB
0.00.256.162 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.256.168 I llama_new_context_with_model: Vulkan_Host  output buffer size =     0.00 MiB
0.00.259.850 I llama_new_context_with_model:    Vulkan0 compute buffer size =    16.00 MiB
0.00.259.858 I llama_new_context_with_model: Vulkan_Host compute buffer size =     2.51 MiB
0.00.259.859 I llama_new_context_with_model: graph nodes  = 429
0.00.259.859 I llama_new_context_with_model: graph splits = 4 (with bs=512), 2 (with bs=1)
0.00.259.861 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.259.861 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.266.491 I 
0.00.266.555 I system_info: n_threads = 4 (n_threads_batch = 4) / 4 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.268.225 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.273.801 I llama_perf_context_print:        load time =     266.14 ms
0.00.273.803 I llama_perf_context_print: prompt eval time =       5.37 ms /     9 tokens (    0.60 ms per token,  1675.98 tokens per second)
0.00.273.804 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.273.804 I llama_perf_context_print:       total time =       7.31 ms /    10 tokens
ci/run.sh: line 710: 2155522 Segmentation fault      (core dumped) ./bin/llama-embedding --model ${model_q8_0} -p "I believe the meaning of life is" -ngl 99 -c 0
