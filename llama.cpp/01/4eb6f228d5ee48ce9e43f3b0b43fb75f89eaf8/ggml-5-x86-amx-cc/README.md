...
- status:  SUCCESS ✅
- runtime: 4:56.48
- date:    Sat Nov  9 10:26:15 UTC 2024
...
16/28 Test #16: test-arg-parser ...................   Passed    0.01 sec
      Start 17: test-quantize-fns
17/28 Test #17: test-quantize-fns .................   Passed   14.92 sec
      Start 18: test-quantize-perf
...
0.00.000.590 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.843 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
...
0.00.007.774 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.007.774 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.007.775 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
...
0.00.007.777 I llama_model_loader: - type  f16:   73 tensors
0.00.018.279 I llm_load_vocab: special tokens cache size = 5
0.00.020.823 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.845 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.846 I llm_load_print_meta: arch             = bert
0.00.020.846 I llm_load_print_meta: vocab type       = WPM
0.00.020.847 I llm_load_print_meta: n_vocab          = 30522
0.00.020.847 I llm_load_print_meta: n_merges         = 0
...
0.00.020.857 I llm_load_print_meta: n_head           = 12
0.00.020.857 I llm_load_print_meta: n_head_kv        = 12
0.00.020.858 I llm_load_print_meta: n_rot            = 32
0.00.020.858 I llm_load_print_meta: n_swa            = 0
...
0.00.020.862 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.020.862 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.020.862 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.020.863 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.020.863 I llm_load_print_meta: n_ff             = 1536
0.00.020.864 I llm_load_print_meta: n_expert         = 0
0.00.020.866 I llm_load_print_meta: n_expert_used    = 0
0.00.020.866 I llm_load_print_meta: causal attn      = 0
0.00.020.867 I llm_load_print_meta: pooling type     = 2
0.00.020.867 I llm_load_print_meta: rope type        = 2
...
0.00.020.886 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.020.899 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.899 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.899 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.899 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.900 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.900 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.900 I llm_load_print_meta: model type       = 33M
0.00.020.901 I llm_load_print_meta: model ftype      = F16
0.00.020.902 I llm_load_print_meta: model params     = 33.21 M
0.00.020.903 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.020.903 I llm_load_print_meta: general.name     = Bge Small
0.00.020.903 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.903 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.904 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.904 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.904 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.904 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.905 I llm_load_print_meta: max token length = 21
0.00.024.593 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
0.00.024.614 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
................................................
0.00.038.022 I llama_new_context_with_model: n_seq_max     = 1
0.00.038.037 I llama_new_context_with_model: n_ctx         = 512
0.00.038.037 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.038.038 I llama_new_context_with_model: n_batch       = 2048
0.00.038.038 I llama_new_context_with_model: n_ubatch      = 2048
0.00.038.038 I llama_new_context_with_model: flash_attn    = 0
0.00.038.040 I llama_new_context_with_model: freq_base     = 10000.0
0.00.038.041 I llama_new_context_with_model: freq_scale    = 1
0.00.040.572 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.040.598 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.040.604 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.042.245 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.042.269 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.042.269 I llama_new_context_with_model: graph nodes  = 429
0.00.042.269 I llama_new_context_with_model: graph splits = 145
0.00.042.271 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.046.231 I 
0.00.046.334 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
...
0.00.053.805 I llama_perf_context_print:        load time =      45.39 ms
0.00.053.807 I llama_perf_context_print: prompt eval time =       4.54 ms /     9 tokens (    0.50 ms per token,  1983.69 tokens per second)
0.00.053.808 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.053.809 I llama_perf_context_print:       total time =       7.57 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.588 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.619 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.647 I llm_load_print_meta: format           = GGUF V3 (latest)
...
0.00.020.650 I llm_load_print_meta: vocab_only       = 0
...
0.00.020.659 I llm_load_print_meta: n_head           = 12
0.00.020.659 I llm_load_print_meta: n_head_kv        = 12
0.00.020.660 I llm_load_print_meta: n_rot            = 32
0.00.020.660 I llm_load_print_meta: n_swa            = 0
0.00.020.660 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.660 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.661 I llm_load_print_meta: n_gqa            = 1
0.00.020.662 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.020.663 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.020.664 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.020.664 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.020.664 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.020.664 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.020.665 I llm_load_print_meta: f_logit_scale    = 0.0e+00
...
0.00.020.667 I llm_load_print_meta: causal attn      = 0
0.00.020.668 I llm_load_print_meta: pooling type     = 2
0.00.020.668 I llm_load_print_meta: rope type        = 2
0.00.020.668 I llm_load_print_meta: rope scaling     = linear
0.00.020.669 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.020.670 I llm_load_print_meta: freq_scale_train = 1
0.00.020.670 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.020.670 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.671 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.672 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.672 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.672 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.672 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
...
0.00.020.676 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.676 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.676 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.677 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.678 I llm_load_print_meta: MASK token       = 103 '[MASK]'
...
.................................................
0.00.024.452 I llama_new_context_with_model: n_seq_max     = 1
0.00.024.467 I llama_new_context_with_model: n_ctx         = 512
0.00.024.468 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.024.468 I llama_new_context_with_model: n_batch       = 2048
0.00.024.468 I llama_new_context_with_model: n_ubatch      = 2048
0.00.024.468 I llama_new_context_with_model: flash_attn    = 0
0.00.024.470 I llama_new_context_with_model: freq_base     = 10000.0
0.00.024.471 I llama_new_context_with_model: freq_scale    = 1
0.00.026.749 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.026.772 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.026.777 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.028.711 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.028.733 I llama_new_context_with_model: graph nodes  = 429
0.00.028.733 I llama_new_context_with_model: graph splits = 1
0.00.028.735 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.031.196 I 
0.00.031.273 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.032.777 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.035.726 I llama_perf_context_print:        load time =      30.41 ms
0.00.035.728 I llama_perf_context_print: prompt eval time =       2.73 ms /     9 tokens (    0.30 ms per token,  3299.12 tokens per second)
0.00.035.729 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.035.730 I llama_perf_context_print:       total time =       4.53 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.657 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.736 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.008.738 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.739 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.739 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.739 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.742 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.744 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.746 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.746 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.747 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.750 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.751 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.751 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.752 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.752 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
...
0.00.019.578 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.579 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.579 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.580 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.580 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.580 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.583 I llama_model_loader: - type  f32:   41 tensors
0.00.019.583 I llama_model_loader: - type  f16:   29 tensors
0.00.037.343 W llm_load_vocab: empty token at index 5
...
0.00.342.757 I llm_load_vocab: token to piece cache size = 1.5060 MB
...
0.00.342.791 I llm_load_print_meta: n_embd           = 384
0.00.342.791 I llm_load_print_meta: n_layer          = 4
0.00.342.804 I llm_load_print_meta: n_head           = 12
0.00.342.805 I llm_load_print_meta: n_head_kv        = 12
0.00.342.805 I llm_load_print_meta: n_rot            = 32
0.00.342.805 I llm_load_print_meta: n_swa            = 0
0.00.342.806 I llm_load_print_meta: n_embd_head_k    = 32
0.00.342.806 I llm_load_print_meta: n_embd_head_v    = 32
0.00.342.807 I llm_load_print_meta: n_gqa            = 1
0.00.342.808 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.342.808 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.342.810 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.342.811 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.342.811 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.342.812 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.342.812 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.342.813 I llm_load_print_meta: n_ff             = 1536
0.00.342.813 I llm_load_print_meta: n_expert         = 0
0.00.342.814 I llm_load_print_meta: n_expert_used    = 0
0.00.342.814 I llm_load_print_meta: causal attn      = 0
0.00.342.814 I llm_load_print_meta: pooling type     = -1
0.00.342.815 I llm_load_print_meta: rope type        = -1
0.00.342.815 I llm_load_print_meta: rope scaling     = linear
0.00.342.817 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.342.817 I llm_load_print_meta: freq_scale_train = 1
0.00.342.818 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.342.818 I llm_load_print_meta: rope_finetuned   = unknown
0.00.342.818 I llm_load_print_meta: ssm_d_conv       = 0
0.00.342.819 I llm_load_print_meta: ssm_d_inner      = 0
0.00.342.819 I llm_load_print_meta: ssm_d_state      = 0
0.00.342.819 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.342.819 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.342.820 I llm_load_print_meta: model type       = 33M
0.00.342.821 I llm_load_print_meta: model ftype      = F16
0.00.342.822 I llm_load_print_meta: model params     = 32.90 M
0.00.342.822 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.342.823 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.342.823 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.342.824 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.342.824 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.342.824 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.342.825 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.342.825 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.342.825 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.342.825 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.342.826 I llm_load_print_meta: max token length = 45
0.00.346.660 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
0.00.346.675 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
.....................
0.00.354.573 I llama_new_context_with_model: n_seq_max     = 1
0.00.354.590 I llama_new_context_with_model: n_ctx         = 8192
0.00.354.590 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.354.590 I llama_new_context_with_model: n_batch       = 2048
0.00.354.591 I llama_new_context_with_model: n_ubatch      = 2048
0.00.354.591 I llama_new_context_with_model: flash_attn    = 0
0.00.354.593 I llama_new_context_with_model: freq_base     = 10000.0
0.00.354.594 I llama_new_context_with_model: freq_scale    = 1
0.00.364.284 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.364.311 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.364.318 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.365.697 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.365.718 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.365.719 I llama_new_context_with_model: graph nodes  = 154
0.00.365.719 I llama_new_context_with_model: graph splits = 57
0.00.365.721 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.375.076 I 
0.00.375.181 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.375.454 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.375.467 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.474 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.375.474 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.480 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.375.480 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.379.586 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.389.661 I llama_perf_context_print:        load time =     374.22 ms
0.00.389.663 I llama_perf_context_print: prompt eval time =       9.84 ms /    62 tokens (    0.16 ms per token,  6301.45 tokens per second)
0.00.389.664 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.389.665 I llama_perf_context_print:       total time =      14.59 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.738 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.399 I llama_model_loader: - type  f16:   98 tensors
...
0.00.076.035 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.036 I llm_load_print_meta: model params     = 1.41 B
0.00.076.037 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.191.277 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.191.295 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.980.304 I llama_new_context_with_model: n_seq_max     = 1
0.00.980.326 I llama_new_context_with_model: n_ctx         = 2048
0.00.980.326 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.980.327 I llama_new_context_with_model: n_batch       = 2048
0.00.980.327 I llama_new_context_with_model: n_ubatch      = 512
0.00.980.327 I llama_new_context_with_model: flash_attn    = 0
0.00.980.332 I llama_new_context_with_model: freq_base     = 10000.0
0.00.980.333 I llama_new_context_with_model: freq_scale    = 1
0.01.054.968 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.054.997 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.055.026 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.057.894 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.057.914 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.057.914 I llama_new_context_with_model: graph nodes  = 967
0.01.057.915 I llama_new_context_with_model: graph splits = 194
0.01.057.919 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.161.344 I main: llama threadpool init, n_threads = 4
0.01.161.369 I 
0.01.161.446 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.161.459 I 
0.01.161.605 I sampler seed: 1234
0.01.161.624 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.161.627 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.161.628 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.161.628 I 
...
0.05.012.816 I llama_perf_sampler_print:    sampling time =       2.26 ms /    71 runs   (    0.03 ms per token, 31402.03 tokens per second)
0.05.012.819 I llama_perf_context_print:        load time =    1160.15 ms
0.05.012.820 I llama_perf_context_print: prompt eval time =      96.04 ms /     7 tokens (   13.72 ms per token,    72.89 tokens per second)
0.05.012.821 I llama_perf_context_print:        eval time =    3743.92 ms /    63 runs   (   59.43 ms per token,    16.83 tokens per second)
0.05.012.822 I llama_perf_context_print:       total time =    3851.48 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.728 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.993 I llama_model_loader: - type  f16:   98 tensors
...
0.00.194.124 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.194.142 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.983.065 I llama_new_context_with_model: n_seq_max     = 1
0.00.983.080 I llama_new_context_with_model: n_ctx         = 128
0.00.983.081 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.983.081 I llama_new_context_with_model: n_batch       = 128
0.00.983.081 I llama_new_context_with_model: n_ubatch      = 128
0.00.983.082 I llama_new_context_with_model: flash_attn    = 0
0.00.983.086 I llama_new_context_with_model: freq_base     = 10000.0
0.00.983.087 I llama_new_context_with_model: freq_scale    = 1
0.00.983.088 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.988.577 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.988.606 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.988.630 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.991.762 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.00.991.783 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.00.991.783 I llama_new_context_with_model: graph nodes  = 967
0.00.991.784 I llama_new_context_with_model: graph splits = 194
0.00.991.786 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.059.122 I 
0.01.059.241 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.059.249 I perplexity: tokenizing the input ..
0.01.068.702 I perplexity: tokenization took 9.45 ms
0.01.068.739 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.983.507 I perplexity: 0.91 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.987.150 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.987.248 I llama_perf_context_print:        load time =    1058.21 ms
0.01.987.251 I llama_perf_context_print: prompt eval time =     913.04 ms /   128 tokens (    7.13 ms per token,   140.19 tokens per second)
0.01.987.252 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.987.253 I llama_perf_context_print:       total time =     928.13 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.642 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.165.808 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.283 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.304 I llama_new_context_with_model: n_ctx         = 2048
0.00.168.304 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.168.304 I llama_new_context_with_model: n_batch       = 2048
0.00.168.305 I llama_new_context_with_model: n_ubatch      = 512
0.00.168.305 I llama_new_context_with_model: flash_attn    = 0
0.00.168.307 I llama_new_context_with_model: freq_base     = 10000.0
0.00.168.307 I llama_new_context_with_model: freq_scale    = 1
0.00.236.941 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.236.969 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.236.986 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.239.106 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.239.128 I llama_new_context_with_model: graph nodes  = 967
0.00.239.128 I llama_new_context_with_model: graph splits = 1
0.00.239.132 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.319.805 I main: llama threadpool init, n_threads = 4
0.00.319.831 I 
0.00.319.899 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.319.912 I 
0.00.320.027 I sampler seed: 1234
0.00.320.046 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.320.049 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.320.049 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.320.049 I 
...
0.03.076.799 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30472.10 tokens per second)
0.03.076.802 I llama_perf_context_print:        load time =     318.75 ms
0.03.076.804 I llama_perf_context_print: prompt eval time =      77.08 ms /     7 tokens (   11.01 ms per token,    90.82 tokens per second)
0.03.076.806 I llama_perf_context_print:        eval time =    2667.78 ms /    63 runs   (   42.35 ms per token,    23.62 tokens per second)
0.03.076.807 I llama_perf_context_print:       total time =    2757.00 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.687 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.568 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.165.337 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.167.534 I llama_new_context_with_model: n_seq_max     = 1
0.00.167.554 I llama_new_context_with_model: n_ctx         = 128
0.00.167.554 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.167.554 I llama_new_context_with_model: n_batch       = 128
0.00.167.554 I llama_new_context_with_model: n_ubatch      = 128
0.00.167.555 I llama_new_context_with_model: flash_attn    = 0
0.00.167.556 I llama_new_context_with_model: freq_base     = 10000.0
0.00.167.557 I llama_new_context_with_model: freq_scale    = 1
0.00.167.558 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.172.833 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.172.859 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
...
0.00.174.899 I llama_new_context_with_model: graph nodes  = 967
0.00.174.899 I llama_new_context_with_model: graph splits = 1
0.00.174.901 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.240.424 I 
0.00.240.513 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.240.520 I perplexity: tokenizing the input ..
0.00.249.026 I perplexity: tokenization took 8.502 ms
0.00.249.057 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.214.611 I perplexity: 0.97 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.218.557 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.218.600 I llama_perf_context_print:        load time =     239.56 ms
0.01.218.614 I llama_perf_context_print: prompt eval time =     964.02 ms /   128 tokens (    7.53 ms per token,   132.78 tokens per second)
0.01.218.615 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.218.615 I llama_perf_context_print:       total time =     978.17 ms /   129 tokens
...
0.00.075.167 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.127.412 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
0.00.127.435 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.382.291 I llama_new_context_with_model: n_seq_max     = 1
0.00.382.313 I llama_new_context_with_model: n_ctx         = 2048
0.00.382.313 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.382.314 I llama_new_context_with_model: n_batch       = 2048
0.00.382.314 I llama_new_context_with_model: n_ubatch      = 512
0.00.382.315 I llama_new_context_with_model: flash_attn    = 0
0.00.382.320 I llama_new_context_with_model: freq_base     = 10000.0
0.00.382.321 I llama_new_context_with_model: freq_scale    = 1
0.00.453.549 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.453.580 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.453.615 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.456.675 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.456.698 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.456.699 I llama_new_context_with_model: graph nodes  = 967
0.00.456.699 I llama_new_context_with_model: graph splits = 193
0.00.456.703 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.524.881 I main: llama threadpool init, n_threads = 4
0.00.524.909 I 
0.00.524.990 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.525.004 I 
0.00.525.142 I sampler seed: 1234
0.00.525.162 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.525.165 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.525.165 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.525.165 I 
...
0.01.938.945 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31938.82 tokens per second)
0.01.938.948 I llama_perf_context_print:        load time =     523.79 ms
0.01.938.949 I llama_perf_context_print: prompt eval time =      35.14 ms /     7 tokens (    5.02 ms per token,   199.20 tokens per second)
0.01.938.950 I llama_perf_context_print:        eval time =    1367.54 ms /    63 runs   (   21.71 ms per token,    46.07 tokens per second)
0.01.938.951 I llama_perf_context_print:       total time =    1414.07 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.706 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.124.999 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
0.00.125.019 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.370.593 I llama_new_context_with_model: n_seq_max     = 1
0.00.370.614 I llama_new_context_with_model: n_ctx         = 128
0.00.370.614 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.370.615 I llama_new_context_with_model: n_batch       = 128
0.00.370.615 I llama_new_context_with_model: n_ubatch      = 128
0.00.370.616 I llama_new_context_with_model: flash_attn    = 0
0.00.370.620 I llama_new_context_with_model: freq_base     = 10000.0
0.00.370.621 I llama_new_context_with_model: freq_scale    = 1
0.00.370.622 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.376.169 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.376.198 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.376.225 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.379.410 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.379.431 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.379.431 I llama_new_context_with_model: graph nodes  = 967
0.00.379.431 I llama_new_context_with_model: graph splits = 193
0.00.379.434 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.410.710 I 
0.00.410.842 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.410.850 I perplexity: tokenizing the input ..
0.00.420.449 I perplexity: tokenization took 9.594 ms
0.00.420.487 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.877.870 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.881.660 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.881.742 I llama_perf_context_print:        load time =     409.81 ms
0.00.881.744 I llama_perf_context_print: prompt eval time =     455.38 ms /   128 tokens (    3.56 ms per token,   281.09 tokens per second)
0.00.881.745 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.881.745 I llama_perf_context_print:       total time =     471.03 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.651 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.434 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.021.437 I llama_model_loader: - type  f32:  194 tensors
0.00.021.438 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.075.039 I llm_load_print_meta: n_head_kv        = 16
...
0.00.075.053 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.054 I llm_load_print_meta: model params     = 1.41 B
0.00.075.055 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.125.123 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.125.140 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.401.198 I llama_new_context_with_model: n_seq_max     = 1
0.00.401.216 I llama_new_context_with_model: n_ctx         = 2048
0.00.401.217 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.401.217 I llama_new_context_with_model: n_batch       = 2048
0.00.401.218 I llama_new_context_with_model: n_ubatch      = 512
0.00.401.218 I llama_new_context_with_model: flash_attn    = 0
0.00.401.224 I llama_new_context_with_model: freq_base     = 10000.0
0.00.401.225 I llama_new_context_with_model: freq_scale    = 1
0.00.472.674 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.472.704 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.472.737 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.475.796 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.475.823 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.475.824 I llama_new_context_with_model: graph nodes  = 967
0.00.475.824 I llama_new_context_with_model: graph splits = 193
0.00.475.828 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.543.414 I main: llama threadpool init, n_threads = 4
0.00.543.441 I 
0.00.543.525 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.543.538 I 
0.00.543.702 I sampler seed: 1234
0.00.543.722 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.543.725 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.543.726 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.543.726 I 
...
0.02.072.119 I llama_perf_sampler_print:    sampling time =       2.20 ms /    71 runs   (    0.03 ms per token, 32287.40 tokens per second)
0.02.072.123 I llama_perf_context_print:        load time =     542.27 ms
0.02.072.125 I llama_perf_context_print: prompt eval time =      36.99 ms /     7 tokens (    5.28 ms per token,   189.26 tokens per second)
0.02.072.126 I llama_perf_context_print:        eval time =    1480.05 ms /    63 runs   (   23.49 ms per token,    42.57 tokens per second)
0.02.072.127 I llama_perf_context_print:       total time =    1528.71 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.693 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.843 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
...
0.00.075.801 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.801 I llm_load_print_meta: model params     = 1.41 B
0.00.075.802 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.124.586 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.124.604 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.394.921 I llama_new_context_with_model: n_seq_max     = 1
0.00.394.943 I llama_new_context_with_model: n_ctx         = 128
0.00.394.943 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.394.943 I llama_new_context_with_model: n_batch       = 128
0.00.394.944 I llama_new_context_with_model: n_ubatch      = 128
0.00.394.944 I llama_new_context_with_model: flash_attn    = 0
0.00.394.948 I llama_new_context_with_model: freq_base     = 10000.0
0.00.394.949 I llama_new_context_with_model: freq_scale    = 1
0.00.394.950 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.400.480 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.400.509 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.400.536 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.403.078 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.403.100 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.403.100 I llama_new_context_with_model: graph nodes  = 967
0.00.403.101 I llama_new_context_with_model: graph splits = 193
0.00.403.103 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.438.978 I 
0.00.439.112 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.439.120 I perplexity: tokenizing the input ..
0.00.448.605 I perplexity: tokenization took 9.482 ms
0.00.448.645 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.934.990 I perplexity: 0.49 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.938.895 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.938.997 I llama_perf_context_print:        load time =     438.10 ms
0.00.938.999 I llama_perf_context_print: prompt eval time =     484.44 ms /   128 tokens (    3.78 ms per token,   264.22 tokens per second)
0.00.939.000 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.939.001 I llama_perf_context_print:       total time =     500.02 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.640 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.062.918 I llm_load_vocab: special tokens cache size = 25
...
0.00.074.847 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
...
0.00.074.851 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.121.466 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.124.050 I llama_new_context_with_model: n_seq_max     = 1
0.00.124.071 I llama_new_context_with_model: n_ctx         = 2048
0.00.124.071 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.124.072 I llama_new_context_with_model: n_batch       = 2048
0.00.124.072 I llama_new_context_with_model: n_ubatch      = 512
0.00.124.072 I llama_new_context_with_model: flash_attn    = 0
0.00.124.074 I llama_new_context_with_model: freq_base     = 10000.0
0.00.124.074 I llama_new_context_with_model: freq_scale    = 1
0.00.192.599 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.192.627 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.192.648 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.194.770 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.194.787 I llama_new_context_with_model: graph nodes  = 967
0.00.194.788 I llama_new_context_with_model: graph splits = 1
0.00.194.792 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.273.956 I main: llama threadpool init, n_threads = 4
0.00.273.986 I 
0.00.274.075 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.274.088 I 
0.00.274.205 I sampler seed: 1234
0.00.274.224 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.274.227 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.274.228 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.274.228 I 
...
0.02.522.377 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30445.97 tokens per second)
0.02.522.381 I llama_perf_context_print:        load time =     272.91 ms
0.02.522.383 I llama_perf_context_print: prompt eval time =      77.08 ms /     7 tokens (   11.01 ms per token,    90.81 tokens per second)
0.02.522.384 I llama_perf_context_print:        eval time =    2159.52 ms /    63 runs   (   34.28 ms per token,    29.17 tokens per second)
0.02.522.385 I llama_perf_context_print:       total time =    2248.43 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.675 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.035 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
...
0.00.076.250 I llm_load_print_meta: model ftype      = Q5_0
0.00.076.251 I llm_load_print_meta: model params     = 1.41 B
0.00.076.252 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
0.00.076.252 I llm_load_print_meta: general.name     = 1.4B
0.00.076.252 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
...
0.00.123.051 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.125.333 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.355 I llama_new_context_with_model: n_ctx         = 128
0.00.125.355 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.125.355 I llama_new_context_with_model: n_batch       = 128
0.00.125.356 I llama_new_context_with_model: n_ubatch      = 128
0.00.125.356 I llama_new_context_with_model: flash_attn    = 0
0.00.125.358 I llama_new_context_with_model: freq_base     = 10000.0
0.00.125.359 I llama_new_context_with_model: freq_scale    = 1
0.00.125.360 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.130.737 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.130.762 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.130.775 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.308 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.329 I llama_new_context_with_model: graph nodes  = 967
0.00.133.329 I llama_new_context_with_model: graph splits = 1
0.00.133.331 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.206.463 I 
0.00.206.553 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.206.558 I perplexity: tokenizing the input ..
0.00.215.027 I perplexity: tokenization took 8.465 ms
0.00.215.061 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.342.252 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.345.804 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.345.845 I llama_perf_context_print:        load time =     205.58 ms
0.01.345.846 I llama_perf_context_print: prompt eval time =    1125.51 ms /   128 tokens (    8.79 ms per token,   113.73 tokens per second)
0.01.345.847 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.345.848 I llama_perf_context_print:       total time =    1139.38 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.646 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.399 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
...
0.00.076.137 I llm_load_print_meta: ssm_d_conv       = 0
0.00.076.137 I llm_load_print_meta: ssm_d_inner      = 0
...
0.00.127.299 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.129.553 I llama_new_context_with_model: n_seq_max     = 1
0.00.129.568 I llama_new_context_with_model: n_ctx         = 2048
0.00.129.569 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.129.569 I llama_new_context_with_model: n_batch       = 2048
0.00.129.569 I llama_new_context_with_model: n_ubatch      = 512
0.00.129.570 I llama_new_context_with_model: flash_attn    = 0
0.00.129.572 I llama_new_context_with_model: freq_base     = 10000.0
0.00.129.572 I llama_new_context_with_model: freq_scale    = 1
0.00.198.290 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.198.318 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.198.338 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.200.433 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.200.454 I llama_new_context_with_model: graph nodes  = 967
0.00.200.454 I llama_new_context_with_model: graph splits = 1
0.00.200.458 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.291.807 I main: llama threadpool init, n_threads = 4
0.00.291.834 I 
0.00.291.911 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.291.924 I 
0.00.292.048 I sampler seed: 1234
0.00.292.067 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.292.070 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.292.071 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.292.071 I 
...
0.02.697.172 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31318.92 tokens per second)
0.02.697.175 I llama_perf_context_print:        load time =     290.73 ms
0.02.697.177 I llama_perf_context_print: prompt eval time =     120.48 ms /     7 tokens (   17.21 ms per token,    58.10 tokens per second)
0.02.697.178 I llama_perf_context_print:        eval time =    2273.30 ms /    63 runs   (   36.08 ms per token,    27.71 tokens per second)
0.02.697.179 I llama_perf_context_print:       total time =    2405.37 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.725 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.362 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.020.672 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.020.675 I llama_model_loader: - type  f32:  194 tensors
0.00.020.676 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.075.114 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.115 I llm_load_print_meta: model params     = 1.41 B
0.00.075.116 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.124.808 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.127.337 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.359 I llama_new_context_with_model: n_ctx         = 128
0.00.127.359 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.127.360 I llama_new_context_with_model: n_batch       = 128
0.00.127.360 I llama_new_context_with_model: n_ubatch      = 128
0.00.127.360 I llama_new_context_with_model: flash_attn    = 0
0.00.127.362 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.363 I llama_new_context_with_model: freq_scale    = 1
0.00.127.364 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.132.751 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.132.777 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.132.790 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.135.360 I llama_new_context_with_model: graph splits = 1
0.00.135.362 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.194.037 I 
0.00.194.138 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.194.148 I perplexity: tokenizing the input ..
0.00.202.925 I perplexity: tokenization took 8.774 ms
0.00.202.954 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.141.223 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.144.930 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.144.971 I llama_perf_context_print:        load time =     193.11 ms
0.02.144.974 I llama_perf_context_print: prompt eval time =    1936.58 ms /   128 tokens (   15.13 ms per token,    66.10 tokens per second)
0.02.144.977 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.144.978 I llama_perf_context_print:       total time =    1950.93 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.667 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.308 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.021.311 I llama_model_loader: - type  f32:  194 tensors
0.00.021.311 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.312 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.106.375 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.108.577 I llama_new_context_with_model: n_seq_max     = 1
0.00.108.598 I llama_new_context_with_model: n_ctx         = 2048
0.00.108.598 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.108.599 I llama_new_context_with_model: n_batch       = 2048
0.00.108.599 I llama_new_context_with_model: n_ubatch      = 512
0.00.108.599 I llama_new_context_with_model: flash_attn    = 0
0.00.108.601 I llama_new_context_with_model: freq_base     = 10000.0
0.00.108.601 I llama_new_context_with_model: freq_scale    = 1
0.00.177.366 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.177.393 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.177.413 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.179.491 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.179.510 I llama_new_context_with_model: graph nodes  = 967
0.00.179.510 I llama_new_context_with_model: graph splits = 1
0.00.179.513 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.253.499 I main: llama threadpool init, n_threads = 4
0.00.253.524 I 
0.00.253.607 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.253.621 I 
0.00.253.745 I sampler seed: 1234
0.00.253.764 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.253.767 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.253.768 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.253.768 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.731.677 I llama_perf_sampler_print:    sampling time =       2.16 ms /    71 runs   (    0.03 ms per token, 32855.16 tokens per second)
0.01.731.680 I llama_perf_context_print:        load time =     252.42 ms
0.01.731.682 I llama_perf_context_print: prompt eval time =      77.55 ms /     7 tokens (   11.08 ms per token,    90.27 tokens per second)
0.01.731.683 I llama_perf_context_print:        eval time =    1389.48 ms /    63 runs   (   22.06 ms per token,    45.34 tokens per second)
0.01.731.683 I llama_perf_context_print:       total time =    1478.18 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.692 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.447 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.074.685 I llm_load_print_meta: model ftype      = Q2_K - Medium
...
0.00.104.440 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.106.646 I llama_new_context_with_model: n_seq_max     = 1
0.00.106.660 I llama_new_context_with_model: n_ctx         = 128
0.00.106.661 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.106.661 I llama_new_context_with_model: n_batch       = 128
0.00.106.661 I llama_new_context_with_model: n_ubatch      = 128
0.00.106.662 I llama_new_context_with_model: flash_attn    = 0
0.00.106.663 I llama_new_context_with_model: freq_base     = 10000.0
0.00.106.664 I llama_new_context_with_model: freq_scale    = 1
0.00.106.664 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.112.212 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.112.239 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.112.253 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.114.225 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.114.248 I llama_new_context_with_model: graph nodes  = 967
0.00.114.249 I llama_new_context_with_model: graph splits = 1
0.00.114.251 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.153.624 I 
0.00.153.738 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.153.745 I perplexity: tokenizing the input ..
0.00.162.914 I perplexity: tokenization took 9.165 ms
0.00.162.943 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.455.775 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.459.536 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.459.578 I llama_perf_context_print:        load time =     152.75 ms
0.01.459.579 I llama_perf_context_print: prompt eval time =    1290.97 ms /   128 tokens (   10.09 ms per token,    99.15 tokens per second)
0.01.459.581 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.459.582 I llama_perf_context_print:       total time =    1305.95 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.658 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.882 I main: llama backend init
...
0.00.074.830 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.074.830 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.074.831 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.074.831 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.074.832 I llm_load_print_meta: n_ff             = 8192
...
0.00.074.834 I llm_load_print_meta: pooling type     = 0
...
0.00.113.231 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.115.492 I llama_new_context_with_model: n_seq_max     = 1
0.00.115.506 I llama_new_context_with_model: n_ctx         = 2048
0.00.115.506 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.115.506 I llama_new_context_with_model: n_batch       = 2048
0.00.115.507 I llama_new_context_with_model: n_ubatch      = 512
0.00.115.507 I llama_new_context_with_model: flash_attn    = 0
0.00.115.510 I llama_new_context_with_model: freq_base     = 10000.0
0.00.115.510 I llama_new_context_with_model: freq_scale    = 1
0.00.185.225 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.185.253 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.185.270 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.187.313 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.187.335 I llama_new_context_with_model: graph nodes  = 967
0.00.187.335 I llama_new_context_with_model: graph splits = 1
0.00.187.338 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.263.078 I main: llama threadpool init, n_threads = 4
0.00.263.104 I 
0.00.263.182 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.263.183 I 
0.00.263.296 I sampler seed: 1234
0.00.263.318 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.263.321 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.263.321 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.263.322 I 
...
0.02.021.551 I llama_perf_sampler_print:    sampling time =       2.16 ms /    71 runs   (    0.03 ms per token, 32855.16 tokens per second)
0.02.021.554 I llama_perf_context_print:        load time =     262.00 ms
0.02.021.556 I llama_perf_context_print: prompt eval time =      83.14 ms /     7 tokens (   11.88 ms per token,    84.19 tokens per second)
0.02.021.558 I llama_perf_context_print:        eval time =    1664.18 ms /    63 runs   (   26.42 ms per token,    37.86 tokens per second)
0.02.021.558 I llama_perf_context_print:       total time =    1758.48 ms /    70 tokens
...
0.00.074.814 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.112.416 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
...
0.00.114.565 I llama_new_context_with_model: freq_base     = 10000.0
...
0.00.119.899 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.119.925 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.119.938 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.164.682 I 
0.00.164.778 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.164.784 I perplexity: tokenizing the input ..
0.00.173.442 I perplexity: tokenization took 8.654 ms
0.00.173.474 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.510.608 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.514.296 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.514.336 I llama_perf_context_print:        load time =     163.81 ms
0.01.514.338 I llama_perf_context_print: prompt eval time =    1335.36 ms /   128 tokens (   10.43 ms per token,    95.85 tokens per second)
0.01.514.339 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.514.339 I llama_perf_context_print:       total time =    1349.65 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.752 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.121.953 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.124.077 I llama_new_context_with_model: n_seq_max     = 1
0.00.124.099 I llama_new_context_with_model: n_ctx         = 2048
0.00.124.099 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.124.100 I llama_new_context_with_model: n_batch       = 2048
0.00.124.100 I llama_new_context_with_model: n_ubatch      = 512
0.00.124.101 I llama_new_context_with_model: flash_attn    = 0
0.00.124.103 I llama_new_context_with_model: freq_base     = 10000.0
0.00.124.104 I llama_new_context_with_model: freq_scale    = 1
0.00.192.679 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.192.700 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.192.716 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.194.762 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.194.784 I llama_new_context_with_model: graph nodes  = 967
0.00.194.784 I llama_new_context_with_model: graph splits = 1
0.00.194.788 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.275.486 I main: llama threadpool init, n_threads = 4
0.00.275.513 I 
0.00.275.593 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.275.607 I 
0.00.275.745 I sampler seed: 1234
...
0.02.290.520 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30432.92 tokens per second)
0.02.290.523 I llama_perf_context_print:        load time =     274.30 ms
0.02.290.525 I llama_perf_context_print: prompt eval time =      90.16 ms /     7 tokens (   12.88 ms per token,    77.64 tokens per second)
0.02.290.526 I llama_perf_context_print:        eval time =    1913.27 ms /    63 runs   (   30.37 ms per token,    32.93 tokens per second)
0.02.290.526 I llama_perf_context_print:       total time =    2015.04 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.670 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.067 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
...
0.00.075.399 I llm_load_print_meta: n_embd_head_v    = 128
0.00.075.400 I llm_load_print_meta: n_gqa            = 1
0.00.075.401 I llm_load_print_meta: n_embd_k_gqa     = 2048
...
0.00.075.410 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.410 I llm_load_print_meta: model params     = 1.41 B
0.00.075.411 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.075.413 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.075.413 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.075.413 I llm_load_print_meta: max token length = 1024
0.00.120.937 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.123.111 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.132 I llama_new_context_with_model: n_ctx         = 128
0.00.123.132 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.123.133 I llama_new_context_with_model: n_batch       = 128
0.00.123.133 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.123.136 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.128.567 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.128.593 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.128.607 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.130.704 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.130.724 I llama_new_context_with_model: graph nodes  = 967
0.00.130.724 I llama_new_context_with_model: graph splits = 1
0.00.130.726 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.179.192 I 
0.00.179.295 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.179.321 I perplexity: tokenizing the input ..
0.00.188.046 I perplexity: tokenization took 8.727 ms
0.00.188.078 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.587.425 I perplexity: 1.40 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.591.123 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.591.162 I llama_perf_context_print:        load time =     178.35 ms
0.01.591.164 I llama_perf_context_print: prompt eval time =    1397.52 ms /   128 tokens (   10.92 ms per token,    91.59 tokens per second)
0.01.591.165 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.591.179 I llama_perf_context_print:       total time =    1411.97 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.790 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.001.058 I main: llama backend init
0.00.001.230 I main: load the model and apply lora adapter, if any
...
0.00.021.610 I llama_model_loader: - type q5_K:   61 tensors
0.00.021.610 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.077.340 I llm_load_print_meta: arch             = gptneox
0.00.077.341 I llm_load_print_meta: vocab type       = BPE
0.00.077.341 I llm_load_print_meta: n_vocab          = 50304
0.00.077.342 I llm_load_print_meta: n_merges         = 50009
0.00.077.342 I llm_load_print_meta: vocab_only       = 0
0.00.077.342 I llm_load_print_meta: n_ctx_train      = 2048
0.00.077.343 I llm_load_print_meta: n_embd           = 2048
0.00.077.343 I llm_load_print_meta: n_layer          = 24
...
0.00.077.359 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.077.363 I llm_load_print_meta: n_expert         = 0
0.00.077.363 I llm_load_print_meta: n_expert_used    = 0
0.00.077.365 I llm_load_print_meta: causal attn      = 1
0.00.077.366 I llm_load_print_meta: pooling type     = 0
0.00.077.366 I llm_load_print_meta: rope type        = 2
0.00.077.367 I llm_load_print_meta: rope scaling     = linear
0.00.077.369 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.077.369 I llm_load_print_meta: freq_scale_train = 1
...
0.00.077.374 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.077.375 I llm_load_print_meta: model params     = 1.41 B
0.00.077.376 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
0.00.077.376 I llm_load_print_meta: general.name     = 1.4B
0.00.077.377 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.077.378 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.077.378 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.077.378 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.077.379 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.077.380 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.077.380 I llm_load_print_meta: max token length = 1024
0.00.127.659 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.129.901 I llama_new_context_with_model: n_seq_max     = 1
0.00.129.922 I llama_new_context_with_model: n_ctx         = 2048
0.00.129.923 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.129.923 I llama_new_context_with_model: n_batch       = 2048
0.00.129.923 I llama_new_context_with_model: n_ubatch      = 512
0.00.129.924 I llama_new_context_with_model: flash_attn    = 0
0.00.129.925 I llama_new_context_with_model: freq_base     = 10000.0
0.00.129.926 I llama_new_context_with_model: freq_scale    = 1
0.00.199.970 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.199.998 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.200.012 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.202.618 I llama_new_context_with_model: graph splits = 1
0.00.202.622 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.295.685 I main: llama threadpool init, n_threads = 4
0.00.295.712 I 
0.00.295.793 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.295.807 I 
0.00.295.946 I sampler seed: 1234
...
0.02.588.510 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31710.59 tokens per second)
0.02.588.512 I llama_perf_context_print:        load time =     294.42 ms
0.02.588.514 I llama_perf_context_print: prompt eval time =     109.66 ms /     7 tokens (   15.67 ms per token,    63.84 tokens per second)
0.02.588.515 I llama_perf_context_print:        eval time =    2171.77 ms /    63 runs   (   34.47 ms per token,    29.01 tokens per second)
0.02.588.515 I llama_perf_context_print:       total time =    2292.83 ms /    70 tokens
...
0.00.020.388 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
0.00.020.390 I llama_model_loader: - type  f32:  194 tensors
0.00.020.391 I llama_model_loader: - type q5_K:   61 tensors
0.00.020.391 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.074.156 I llm_load_print_meta: arch             = gptneox
0.00.074.157 I llm_load_print_meta: vocab type       = BPE
0.00.074.157 I llm_load_print_meta: n_vocab          = 50304
0.00.074.158 I llm_load_print_meta: n_merges         = 50009
0.00.074.158 I llm_load_print_meta: vocab_only       = 0
0.00.074.158 I llm_load_print_meta: n_ctx_train      = 2048
0.00.074.159 I llm_load_print_meta: n_embd           = 2048
0.00.074.159 I llm_load_print_meta: n_layer          = 24
0.00.074.167 I llm_load_print_meta: n_head           = 16
0.00.074.168 I llm_load_print_meta: n_head_kv        = 16
0.00.074.168 I llm_load_print_meta: n_rot            = 32
0.00.074.168 I llm_load_print_meta: n_swa            = 0
0.00.074.169 I llm_load_print_meta: n_embd_head_k    = 128
0.00.074.169 I llm_load_print_meta: n_embd_head_v    = 128
0.00.074.170 I llm_load_print_meta: n_gqa            = 1
0.00.074.171 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.074.172 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.074.173 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.074.173 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.074.173 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.074.174 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.074.174 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.074.175 I llm_load_print_meta: n_ff             = 8192
0.00.074.175 I llm_load_print_meta: n_expert         = 0
0.00.074.176 I llm_load_print_meta: n_expert_used    = 0
0.00.074.176 I llm_load_print_meta: causal attn      = 1
0.00.074.176 I llm_load_print_meta: pooling type     = 0
0.00.074.176 I llm_load_print_meta: rope type        = 2
0.00.074.176 I llm_load_print_meta: rope scaling     = linear
...
0.00.074.179 I llm_load_print_meta: ssm_d_inner      = 0
0.00.074.179 I llm_load_print_meta: ssm_d_state      = 0
0.00.074.180 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.074.180 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.074.180 I llm_load_print_meta: model type       = 1.4B
0.00.074.181 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.074.182 I llm_load_print_meta: model params     = 1.41 B
0.00.074.183 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
0.00.074.183 I llm_load_print_meta: general.name     = 1.4B
0.00.074.184 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
...
0.00.074.185 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.074.185 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.186 I llm_load_print_meta: max token length = 1024
0.00.124.602 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.126.731 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.753 I llama_new_context_with_model: n_ctx         = 128
0.00.126.753 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.754 I llama_new_context_with_model: n_batch       = 128
0.00.126.754 I llama_new_context_with_model: n_ubatch      = 128
0.00.126.754 I llama_new_context_with_model: flash_attn    = 0
0.00.126.756 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.757 I llama_new_context_with_model: freq_scale    = 1
0.00.126.758 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.132.140 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.132.167 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.132.180 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.134.721 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
...
0.00.189.306 I 
0.00.189.411 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.189.417 I perplexity: tokenizing the input ..
0.00.198.278 I perplexity: tokenization took 8.857 ms
0.00.198.308 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.891.948 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.895.818 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.895.855 I llama_perf_context_print:        load time =     188.44 ms
0.01.895.857 I llama_perf_context_print: prompt eval time =    1691.91 ms /   128 tokens (   13.22 ms per token,    75.65 tokens per second)
0.01.895.859 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.895.860 I llama_perf_context_print:       total time =    1706.55 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.649 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.413 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
...
0.00.076.556 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.557 I llm_load_print_meta: model params     = 1.41 B
0.00.076.558 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.076.563 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.563 I llm_load_print_meta: max token length = 1024
0.00.131.274 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.133.670 I llama_new_context_with_model: n_seq_max     = 1
0.00.133.693 I llama_new_context_with_model: n_ctx         = 2048
0.00.133.693 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.133.694 I llama_new_context_with_model: n_batch       = 2048
0.00.133.694 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.204.198 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
...
0.00.207.011 I llama_new_context_with_model: graph nodes  = 967
0.00.207.011 I llama_new_context_with_model: graph splits = 1
0.00.207.016 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.297.831 I main: llama threadpool init, n_threads = 4
0.00.297.861 I 
0.00.297.972 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.297.984 I 
...
0.00.298.150 I sampler params: 
	...
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.298.155 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.298.156 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.298.156 I 
...
0.02.758.497 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30909.88 tokens per second)
0.02.758.501 I llama_perf_context_print:        load time =     296.78 ms
0.02.758.503 I llama_perf_context_print: prompt eval time =     110.10 ms /     7 tokens (   15.73 ms per token,    63.58 tokens per second)
0.02.758.504 I llama_perf_context_print:        eval time =    2338.60 ms /    63 runs   (   37.12 ms per token,    26.94 tokens per second)
0.02.758.505 I llama_perf_context_print:       total time =    2460.67 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.697 I build: 4062 (014eb6f2) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.392 I llm_load_vocab: token to piece cache size = 0.2984 MB
...
0.00.076.440 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
...
0.00.076.443 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.443 I llm_load_print_meta: model params     = 1.41 B
0.00.076.444 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.128.807 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.130.990 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.131.012 I llama_new_context_with_model: flash_attn    = 0
0.00.131.014 I llama_new_context_with_model: freq_base     = 10000.0
0.00.131.015 I llama_new_context_with_model: freq_scale    = 1
0.00.131.016 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.136.239 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.136.265 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.136.279 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.138.880 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.138.898 I llama_new_context_with_model: graph nodes  = 967
0.00.138.899 I llama_new_context_with_model: graph splits = 1
0.00.138.901 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.191.966 I 
...
0.00.201.307 I perplexity: tokenization took 9.203 ms
0.00.201.340 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.854.463 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.858.246 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.858.293 I llama_perf_context_print:        load time =     191.08 ms
0.01.858.296 I llama_perf_context_print: prompt eval time =    1651.40 ms /   128 tokens (   12.90 ms per token,    77.51 tokens per second)
0.01.858.297 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.858.298 I llama_perf_context_print:       total time =    1666.33 ms /   129 tokens
...
llama_new_context_with_model: graph splits = 193
0.00.443.399 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.57user 0.67system 0:01.24elapsed 100%CPU (0avgtext+0avgdata 5358556maxresident)k
...
0.46user 0.62system 0:01.08elapsed 100%CPU (0avgtext+0avgdata 5355248maxresident)k
