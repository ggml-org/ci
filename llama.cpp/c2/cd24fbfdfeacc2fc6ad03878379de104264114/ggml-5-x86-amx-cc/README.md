...
- status:  SUCCESS ✅
- runtime: 4:30.13
- date:    Sat Feb 15 18:34:45 UTC 2025
...
0.00.000.363 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.004.357 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.004.358 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
0.00.004.358 I llama_model_loader: - kv  13:                          bert.pooling_type u32              = 2
...
0.00.008.010 I llama_model_loader: - kv  22:               tokenizer.ggml.mask_token_id u32              = 103
0.00.008.010 I llama_model_loader: - kv  23:               general.quantization_version u32              = 2
0.00.008.012 I llama_model_loader: - type  f32:  124 tensors
0.00.008.012 I llama_model_loader: - type  f16:   73 tensors
0.00.008.014 I print_info: file format = GGUF V3 (latest)
0.00.008.015 I print_info: file type   = F16
0.00.008.017 I print_info: file size   = 63.84 MiB (16.12 BPW) 
0.00.019.352 I load: special tokens cache size = 5
0.00.021.936 I load: token to piece cache size = 0.2032 MB
0.00.021.961 I print_info: arch             = bert
0.00.021.962 I print_info: vocab_only       = 0
0.00.021.962 I print_info: n_ctx_train      = 512
0.00.021.962 I print_info: n_embd           = 384
0.00.021.963 I print_info: n_layer          = 12
0.00.021.972 I print_info: n_head           = 12
0.00.021.974 I print_info: n_head_kv        = 12
0.00.021.974 I print_info: n_rot            = 32
...
0.00.021.982 I print_info: f_norm_eps       = 1.0e-12
0.00.021.983 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.021.983 I print_info: f_clamp_kqv      = 0.0e+00
0.00.021.983 I print_info: f_max_alibi_bias = 0.0e+00
0.00.021.984 I print_info: f_logit_scale    = 0.0e+00
0.00.021.985 I print_info: n_ff             = 1536
0.00.021.985 I print_info: n_expert         = 0
0.00.021.986 I print_info: n_expert_used    = 0
0.00.021.986 I print_info: causal attn      = 0
0.00.021.986 I print_info: pooling type     = 2
0.00.021.986 I print_info: rope type        = 2
0.00.021.987 I print_info: rope scaling     = linear
0.00.021.988 I print_info: freq_base_train  = 10000.0
0.00.021.988 I print_info: freq_scale_train = 1
0.00.021.989 I print_info: n_ctx_orig_yarn  = 512
0.00.021.989 I print_info: rope_finetuned   = unknown
0.00.021.989 I print_info: ssm_d_conv       = 0
0.00.021.990 I print_info: ssm_d_inner      = 0
0.00.021.990 I print_info: ssm_d_state      = 0
0.00.021.990 I print_info: ssm_dt_rank      = 0
0.00.021.990 I print_info: ssm_dt_b_c_rms   = 0
0.00.021.991 I print_info: model type       = 33M
0.00.021.992 I print_info: model params     = 33.21 M
...
0.00.027.030 I load_tensors:          AMX model buffer size =    40.50 MiB
0.00.027.052 I load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
...
0.00.041.342 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.043.358 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.043.378 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.043.386 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.046.051 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.046.072 I llama_init_from_model: graph nodes  = 429
0.00.046.073 I llama_init_from_model: graph splits = 1
0.00.046.077 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.046.077 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.049.669 I 
0.00.049.755 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.051.331 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.055.751 I llama_perf_context_print:        load time =      49.26 ms
0.00.055.752 I llama_perf_context_print: prompt eval time =       4.12 ms /     9 tokens (    0.46 ms per token,  2186.59 tokens per second)
0.00.055.753 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.055.754 I llama_perf_context_print:       total time =       6.08 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.257 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.169 I llama_model_loader: loaded meta data with 24 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.004.207 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
0.00.004.208 I llama_model_loader: - kv   6:                        bert.context_length u32              = 512
0.00.004.208 I llama_model_loader: - kv   7:                      bert.embedding_length u32              = 384
...
0.00.004.214 I llama_model_loader: - kv  11:                      bert.attention.causal bool             = false
...
0.00.004.218 I llama_model_loader: - kv  14:                       tokenizer.ggml.model str              = bert
0.00.004.219 I llama_model_loader: - kv  15:                         tokenizer.ggml.pre str              = jina-v2-en
...
0.00.007.931 I llama_model_loader: - kv  18:            tokenizer.ggml.unknown_token_id u32              = 100
0.00.007.931 I llama_model_loader: - kv  19:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.007.932 I llama_model_loader: - kv  20:            tokenizer.ggml.padding_token_id u32              = 0
0.00.007.932 I llama_model_loader: - kv  21:               tokenizer.ggml.mask_token_id u32              = 103
0.00.007.932 I llama_model_loader: - kv  22:               general.quantization_version u32              = 2
0.00.007.933 I llama_model_loader: - kv  23:                          general.file_type u32              = 7
0.00.007.934 I llama_model_loader: - type  f32:  124 tensors
0.00.007.935 I llama_model_loader: - type q8_0:   73 tensors
0.00.007.936 I print_info: file format = GGUF V3 (latest)
0.00.007.937 I print_info: file type   = Q8_0
0.00.007.939 I print_info: file size   = 34.38 MiB (8.68 BPW) 
0.00.019.095 I load: special tokens cache size = 5
0.00.021.709 I load: token to piece cache size = 0.2032 MB
...
0.00.021.745 I print_info: n_rot            = 32
0.00.021.746 I print_info: n_swa            = 0
0.00.021.747 I print_info: n_embd_head_k    = 32
0.00.021.747 I print_info: n_embd_head_v    = 32
0.00.021.749 I print_info: n_gqa            = 1
0.00.021.750 I print_info: n_embd_k_gqa     = 384
0.00.021.751 I print_info: n_embd_v_gqa     = 384
0.00.021.752 I print_info: f_norm_eps       = 1.0e-12
...
0.00.021.756 I print_info: rope type        = 2
...
0.00.021.761 I print_info: model params     = 33.21 M
0.00.021.762 I print_info: general.name     = Bge Small
0.00.021.764 I print_info: vocab type       = WPM
0.00.021.765 I print_info: n_vocab          = 30522
0.00.021.765 I print_info: n_merges         = 0
0.00.021.765 I print_info: BOS token        = 101 '[CLS]'
0.00.021.766 I print_info: UNK token        = 100 '[UNK]'
0.00.021.766 I print_info: SEP token        = 102 '[SEP]'
0.00.021.767 I print_info: PAD token        = 0 '[PAD]'
...
0.00.021.770 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.024.726 I load_tensors:          AMX model buffer size =    24.05 MiB
0.00.024.744 I load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.030.888 I llama_init_from_model: n_seq_max     = 1
0.00.030.903 I llama_init_from_model: n_ctx         = 512
0.00.030.903 I llama_init_from_model: n_ctx_per_seq = 512
0.00.030.905 I llama_init_from_model: n_batch       = 2048
0.00.030.906 I llama_init_from_model: n_ubatch      = 2048
0.00.030.907 I llama_init_from_model: flash_attn    = 0
0.00.030.910 I llama_init_from_model: freq_base     = 10000.0
0.00.030.911 I llama_init_from_model: freq_scale    = 1
0.00.030.935 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.033.375 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.033.406 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.033.414 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.036.221 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.036.242 I llama_init_from_model: graph nodes  = 429
0.00.036.243 I llama_init_from_model: graph splits = 1
0.00.036.246 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.036.246 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.039.082 I 
0.00.039.170 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.040.378 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.042.904 I llama_perf_context_print:        load time =      38.78 ms
0.00.042.906 I llama_perf_context_print: prompt eval time =       2.19 ms /     9 tokens (    0.24 ms per token,  4107.71 tokens per second)
0.00.042.907 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.042.908 I llama_perf_context_print:       total time =       3.82 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.272 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.019.714 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
...
0.00.019.741 I llama_model_loader: - type  f16:   30 tensors
0.00.019.743 I print_info: file format = GGUF V3 (latest)
0.00.019.744 I print_info: file type   = F16
0.00.019.746 I print_info: file size   = 62.78 MiB (16.01 BPW) 
0.00.027.116 W load: empty token at index 5
0.00.037.782 W load: model vocab missing newline token, using special_pad_id instead
0.00.052.057 W load: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.052.174 I load: special tokens cache size = 5
0.00.341.673 I load: token to piece cache size = 1.5060 MB
0.00.341.697 I print_info: arch             = jina-bert-v2
0.00.341.698 I print_info: vocab_only       = 0
0.00.341.698 I print_info: n_ctx_train      = 8192
0.00.341.698 I print_info: n_embd           = 384
0.00.341.699 I print_info: n_layer          = 4
0.00.341.708 I print_info: n_head           = 12
0.00.341.710 I print_info: n_head_kv        = 12
0.00.341.710 I print_info: n_rot            = 32
0.00.341.710 I print_info: n_swa            = 0
0.00.341.711 I print_info: n_embd_head_k    = 32
0.00.341.711 I print_info: n_embd_head_v    = 32
0.00.341.713 I print_info: n_gqa            = 1
0.00.341.714 I print_info: n_embd_k_gqa     = 384
0.00.341.715 I print_info: n_embd_v_gqa     = 384
0.00.341.717 I print_info: f_norm_eps       = 1.0e-12
0.00.341.717 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.341.718 I print_info: f_clamp_kqv      = 0.0e+00
0.00.341.719 I print_info: f_max_alibi_bias = 8.0e+00
0.00.341.719 I print_info: f_logit_scale    = 0.0e+00
0.00.341.720 I print_info: n_ff             = 1536
0.00.341.721 I print_info: n_expert         = 0
0.00.341.721 I print_info: n_expert_used    = 0
0.00.341.721 I print_info: causal attn      = 0
0.00.341.722 I print_info: pooling type     = -1
0.00.341.722 I print_info: rope type        = -1
0.00.341.723 I print_info: rope scaling     = linear
0.00.341.724 I print_info: freq_base_train  = 10000.0
0.00.341.724 I print_info: freq_scale_train = 1
0.00.341.724 I print_info: n_ctx_orig_yarn  = 8192
0.00.341.725 I print_info: rope_finetuned   = unknown
0.00.341.725 I print_info: ssm_d_conv       = 0
0.00.341.725 I print_info: ssm_d_inner      = 0
0.00.341.726 I print_info: ssm_d_state      = 0
0.00.341.726 I print_info: ssm_dt_rank      = 0
0.00.341.726 I print_info: ssm_dt_b_c_rms   = 0
0.00.341.727 I print_info: model type       = 33M
0.00.341.728 I print_info: model params     = 32.90 M
0.00.341.728 I print_info: general.name     = Jina Bert Implementation
0.00.341.731 I print_info: vocab type       = BPE
0.00.341.732 I print_info: n_vocab          = 61056
0.00.341.732 I print_info: n_merges         = 39382
0.00.341.733 I print_info: BOS token        = 0 '<s>'
0.00.341.733 I print_info: EOS token        = 2 '</s>'
0.00.341.733 I print_info: UNK token        = 3 '<unk>'
0.00.341.734 I print_info: SEP token        = 2 '</s>'
0.00.341.734 I print_info: PAD token        = 1 '<pad>'
0.00.341.734 I print_info: MASK token       = 4 '<mask>'
0.00.341.734 I print_info: EOG token        = 2 '</s>'
0.00.341.735 I print_info: max token length = 45
0.00.341.736 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.346.603 I load_tensors:          AMX model buffer size =    18.00 MiB
0.00.346.622 I load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.352.649 I llama_init_from_model: n_seq_max     = 1
0.00.352.664 I llama_init_from_model: n_ctx         = 8192
0.00.352.664 I llama_init_from_model: n_ctx_per_seq = 8192
0.00.352.665 I llama_init_from_model: n_batch       = 2048
0.00.352.665 I llama_init_from_model: n_ubatch      = 2048
0.00.352.665 I llama_init_from_model: flash_attn    = 0
0.00.352.667 I llama_init_from_model: freq_base     = 10000.0
0.00.352.668 I llama_init_from_model: freq_scale    = 1
0.00.352.693 I llama_kv_cache_init: kv_size = 8192, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 4, can_shift = 1
0.00.361.794 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.361.822 I llama_init_from_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.361.830 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.363.951 I llama_init_from_model:        CPU compute buffer size =   220.02 MiB
0.00.363.972 I llama_init_from_model: graph nodes  = 154
0.00.363.972 I llama_init_from_model: graph splits = 1
0.00.363.976 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 8192
0.00.363.977 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.372.373 I 
0.00.372.525 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.372.695 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.372.708 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.372.714 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.372.715 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.372.719 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.372.720 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.384.808 I llama_perf_context_print:        load time =     372.06 ms
0.00.384.809 I llama_perf_context_print: prompt eval time =       7.83 ms /    62 tokens (    0.13 ms per token,  7921.30 tokens per second)
0.00.384.811 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.384.811 I llama_perf_context_print:       total time =      12.44 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.269 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.341 I llama_model_loader: - type  f16:   98 tensors
...
0.00.064.429 I print_info: f_logit_scale    = 0.0e+00
...
0.00.064.445 I print_info: EOG token        = 0 '<|endoftext|>'
...
0.00.197.393 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.197.416 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.029.824 I llama_init_from_model: n_seq_max     = 1
0.01.029.840 I llama_init_from_model: n_ctx         = 2048
0.01.029.840 I llama_init_from_model: n_ctx_per_seq = 2048
0.01.029.840 I llama_init_from_model: n_batch       = 2048
0.01.029.841 I llama_init_from_model: n_ubatch      = 512
0.01.029.842 I llama_init_from_model: flash_attn    = 0
0.01.029.847 I llama_init_from_model: freq_base     = 10000.0
0.01.029.848 I llama_init_from_model: freq_scale    = 1
0.01.029.876 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.115.037 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.115.067 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.115.101 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.119.401 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.01.119.421 I llama_init_from_model: graph nodes  = 967
0.01.119.422 I llama_init_from_model: graph splits = 1
0.01.119.434 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.01.119.814 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.01.119.827 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.230.377 I main: llama threadpool init, n_threads = 4
0.01.230.400 I 
0.01.230.473 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.230.486 I 
0.01.230.596 I sampler seed: 1234
0.01.230.615 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.230.618 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.230.619 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.230.619 I 
...
0.05.275.257 I llama_perf_sampler_print:    sampling time =       2.46 ms /    71 runs   (    0.03 ms per token, 28850.06 tokens per second)
0.05.275.261 I llama_perf_context_print:        load time =    1228.82 ms
0.05.275.264 I llama_perf_context_print: prompt eval time =     107.15 ms /     7 tokens (   15.31 ms per token,    65.33 tokens per second)
0.05.275.265 I llama_perf_context_print:        eval time =    3924.80 ms /    63 runs   (   62.30 ms per token,    16.05 tokens per second)
0.05.275.266 I llama_perf_context_print:       total time =    4045.94 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.358 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.203.964 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.203.978 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.027.803 I llama_init_from_model: n_seq_max     = 1
0.01.027.820 I llama_init_from_model: n_ctx         = 128
0.01.027.820 I llama_init_from_model: n_ctx_per_seq = 128
0.01.027.820 I llama_init_from_model: n_batch       = 128
0.01.027.821 I llama_init_from_model: n_ubatch      = 128
0.01.027.822 I llama_init_from_model: flash_attn    = 0
0.01.027.827 I llama_init_from_model: freq_base     = 10000.0
0.01.027.828 I llama_init_from_model: freq_scale    = 1
0.01.027.828 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.027.857 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.032.464 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.032.491 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.032.521 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.035.803 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.01.035.819 I llama_init_from_model: graph nodes  = 967
0.01.035.819 I llama_init_from_model: graph splits = 1
0.01.035.824 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.01.035.824 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.106.027 I 
0.01.106.129 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.106.151 I perplexity: tokenizing the input ..
0.01.112.454 I perplexity: tokenization took 6.3 ms
0.01.112.484 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.153.566 I perplexity: 1.04 seconds per pass - ETA 0.02 minutes
[1]10.1485,
0.02.157.232 I Final estimate: PPL = 10.1485 +/- 3.22644

0.02.157.275 I llama_perf_context_print:        load time =    1105.62 ms
0.02.157.291 I llama_perf_context_print: prompt eval time =    1039.25 ms /   128 tokens (    8.12 ms per token,   123.17 tokens per second)
0.02.157.306 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.157.307 I llama_perf_context_print:       total time =    1051.25 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.325 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.334 I print_info: file type   = Q8_0
...
0.00.150.968 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.150.989 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.310.670 I llama_init_from_model: n_seq_max     = 1
0.00.310.704 I llama_init_from_model: n_ctx         = 2048
0.00.310.711 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.310.718 I llama_init_from_model: n_batch       = 2048
0.00.310.725 I llama_init_from_model: n_ubatch      = 512
0.00.310.732 I llama_init_from_model: flash_attn    = 0
0.00.310.746 I llama_init_from_model: freq_base     = 10000.0
0.00.310.768 I llama_init_from_model: freq_scale    = 1
0.00.310.808 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.381.673 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.381.723 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.381.767 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.385.114 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.385.144 I llama_init_from_model: graph nodes  = 967
0.00.385.151 I llama_init_from_model: graph splits = 1
0.00.385.170 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.385.513 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.385.533 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.467.182 I main: llama threadpool init, n_threads = 4
0.00.467.203 I 
0.00.467.278 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.467.290 I 
0.00.467.397 I sampler seed: 1234
0.00.467.430 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.467.433 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.467.434 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.467.434 I 
I believe the meaning of life is to die, not live." "We're all going to die." "We all are." "We're all going to die." "The answer is no." "I can't do it." "What?" "I can't do it." "What?" "The answer is no." "No!" "It

0.02.727.783 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31753.13 tokens per second)
0.02.727.786 I llama_perf_context_print:        load time =     465.54 ms
0.02.727.787 I llama_perf_context_print: prompt eval time =      50.96 ms /     7 tokens (    7.28 ms per token,   137.37 tokens per second)
0.02.727.788 I llama_perf_context_print:        eval time =    2197.99 ms /    63 runs   (   34.89 ms per token,    28.66 tokens per second)
0.02.727.789 I llama_perf_context_print:       total time =    2261.66 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.332 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.981 I print_info: file format = GGUF V3 (latest)
0.00.020.982 I print_info: file type   = Q8_0
0.00.020.984 I print_info: file size   = 1.40 GiB (8.51 BPW) 
...
0.00.154.641 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.154.658 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.313.499 I llama_init_from_model: n_seq_max     = 1
0.00.313.535 I llama_init_from_model: n_ctx         = 128
0.00.313.542 I llama_init_from_model: n_ctx_per_seq = 128
0.00.313.548 I llama_init_from_model: n_batch       = 128
0.00.313.555 I llama_init_from_model: n_ubatch      = 128
0.00.313.561 I llama_init_from_model: flash_attn    = 0
0.00.313.571 I llama_init_from_model: freq_base     = 10000.0
0.00.313.580 I llama_init_from_model: freq_scale    = 1
0.00.313.640 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.313.675 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.318.426 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.318.469 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.318.507 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.321.891 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.321.922 I llama_init_from_model: graph nodes  = 967
0.00.321.928 I llama_init_from_model: graph splits = 1
0.00.321.939 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.321.946 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.382.720 I 
0.00.382.829 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.382.851 I perplexity: tokenizing the input ..
0.00.389.407 I perplexity: tokenization took 6.552 ms
0.00.389.440 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.782.942 I perplexity: 0.39 seconds per pass - ETA 0.00 minutes
[1]10.1611,
0.00.786.676 I Final estimate: PPL = 10.1611 +/- 3.23215

0.00.786.731 I llama_perf_context_print:        load time =     382.34 ms
0.00.786.734 I llama_perf_context_print: prompt eval time =     391.58 ms /   128 tokens (    3.06 ms per token,   326.88 tokens per second)
0.00.786.736 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.786.737 I llama_perf_context_print:       total time =     404.01 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.259 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.207 I print_info: file type   = Q4_0
...
0.00.115.315 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.115.337 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.224.916 I llama_init_from_model: n_seq_max     = 1
0.00.224.933 I llama_init_from_model: n_ctx         = 2048
0.00.224.933 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.224.933 I llama_init_from_model: n_batch       = 2048
0.00.224.934 I llama_init_from_model: n_ubatch      = 512
0.00.224.934 I llama_init_from_model: flash_attn    = 0
0.00.224.939 I llama_init_from_model: freq_base     = 10000.0
0.00.224.941 I llama_init_from_model: freq_scale    = 1
0.00.224.969 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.296.669 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.296.694 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.296.729 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.300.045 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.300.061 I llama_init_from_model: graph nodes  = 967
0.00.300.061 I llama_init_from_model: graph splits = 1
0.00.300.074 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.300.407 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.300.420 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.376.471 I main: llama threadpool init, n_threads = 4
0.00.376.493 I 
0.00.376.579 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.376.579 I 
0.00.376.712 I sampler seed: 1234
0.00.376.731 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.376.735 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.376.735 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.376.735 I 
I believe the meaning of life is to know and experience what you love and to do it." "If you love something, set it free." "You might just find something you didn't know you wanted." "I've always wanted to know the truth." "Now I have." "So I'm gonna get to the truth." "I'm gonna

0.01.879.161 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31696.43 tokens per second)
0.01.879.164 I llama_perf_context_print:        load time =     374.91 ms
0.01.879.165 I llama_perf_context_print: prompt eval time =      42.80 ms /     7 tokens (    6.11 ms per token,   163.56 tokens per second)
0.01.879.166 I llama_perf_context_print:        eval time =    1448.19 ms /    63 runs   (   22.99 ms per token,    43.50 tokens per second)
0.01.879.167 I llama_perf_context_print:       total time =    1503.77 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.351 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.062.187 I load: token to piece cache size = 0.2984 MB
0.00.062.211 I print_info: arch             = gptneox
0.00.062.211 I print_info: vocab_only       = 0
...
0.00.062.229 I print_info: n_embd_v_gqa     = 2048
...
0.00.062.233 I print_info: n_expert         = 0
...
0.00.062.235 I print_info: freq_scale_train = 1
0.00.062.236 I print_info: n_ctx_orig_yarn  = 2048
0.00.062.236 I print_info: rope_finetuned   = unknown
0.00.062.236 I print_info: ssm_d_conv       = 0
0.00.062.236 I print_info: ssm_d_inner      = 0
0.00.062.236 I print_info: ssm_d_state      = 0
0.00.062.236 I print_info: ssm_dt_rank      = 0
0.00.062.237 I print_info: ssm_dt_b_c_rms   = 0
0.00.062.237 I print_info: model type       = 1.4B
0.00.062.238 I print_info: model params     = 1.41 B
0.00.062.238 I print_info: general.name     = 1.4B
0.00.062.240 I print_info: vocab type       = BPE
0.00.062.241 I print_info: n_vocab          = 50304
0.00.062.242 I print_info: n_merges         = 50009
0.00.062.242 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.062.242 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.062.243 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.062.243 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.062.243 I print_info: LF token         = 187 'Ċ'
0.00.062.244 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.062.244 I print_info: max token length = 1024
0.00.062.245 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.113.213 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.113.232 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.223.644 I llama_init_from_model: n_seq_max     = 1
0.00.223.661 I llama_init_from_model: n_ctx         = 128
0.00.223.661 I llama_init_from_model: n_ctx_per_seq = 128
0.00.223.662 I llama_init_from_model: n_batch       = 128
0.00.223.662 I llama_init_from_model: n_ubatch      = 128
0.00.223.663 I llama_init_from_model: flash_attn    = 0
0.00.223.669 I llama_init_from_model: freq_base     = 10000.0
0.00.223.670 I llama_init_from_model: freq_scale    = 1
...
0.00.223.704 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.228.152 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.228.180 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.228.210 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.231.509 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.231.526 I llama_init_from_model: graph nodes  = 967
0.00.231.526 I llama_init_from_model: graph splits = 1
0.00.231.531 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.231.531 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.270.425 I 
0.00.270.551 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.270.573 I perplexity: tokenizing the input ..
0.00.277.146 I perplexity: tokenization took 6.569 ms
0.00.277.179 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.717.428 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]14.1117,
0.00.721.079 I Final estimate: PPL = 14.1117 +/- 4.42919

0.00.721.121 I llama_perf_context_print:        load time =     270.03 ms
0.00.721.123 I llama_perf_context_print: prompt eval time =     438.43 ms /   128 tokens (    3.43 ms per token,   291.95 tokens per second)
0.00.721.124 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.721.124 I llama_perf_context_print:       total time =     450.70 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.316 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.064.342 I print_info: general.name     = 1.4B
0.00.064.344 I print_info: vocab type       = BPE
0.00.064.345 I print_info: n_vocab          = 50304
0.00.064.346 I print_info: n_merges         = 50009
...
0.00.120.821 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.120.844 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.242.445 I llama_init_from_model: n_seq_max     = 1
0.00.242.461 I llama_init_from_model: n_ctx         = 2048
0.00.242.462 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.242.462 I llama_init_from_model: n_batch       = 2048
0.00.242.462 I llama_init_from_model: n_ubatch      = 512
0.00.242.463 I llama_init_from_model: flash_attn    = 0
0.00.242.467 I llama_init_from_model: freq_base     = 10000.0
0.00.242.468 I llama_init_from_model: freq_scale    = 1
0.00.242.498 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.314.245 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.314.283 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.314.318 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.317.598 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.317.615 I llama_init_from_model: graph nodes  = 967
0.00.317.615 I llama_init_from_model: graph splits = 1
0.00.317.628 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.317.937 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.317.949 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
0.00.399.870 I 
0.00.399.944 I sampler seed: 1234
0.00.399.977 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.399.980 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.399.980 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.399.980 I 
...
0.02.022.704 I llama_perf_sampler_print:    sampling time =       2.26 ms /    71 runs   (    0.03 ms per token, 31374.28 tokens per second)
0.02.022.707 I llama_perf_context_print:        load time =     398.19 ms
0.02.022.709 I llama_perf_context_print: prompt eval time =      43.79 ms /     7 tokens (    6.26 ms per token,   159.85 tokens per second)
0.02.022.710 I llama_perf_context_print:        eval time =    1567.62 ms /    63 runs   (   24.88 ms per token,    40.19 tokens per second)
0.02.022.710 I llama_perf_context_print:       total time =    1623.98 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.364 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.873 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.063.363 I print_info: n_rot            = 32
...
0.00.063.368 I print_info: n_embd_v_gqa     = 2048
0.00.063.369 I print_info: f_norm_eps       = 1.0e-05
...
0.00.063.372 I print_info: causal attn      = 1
...
0.00.118.618 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.118.638 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.246.100 I llama_init_from_model: n_seq_max     = 1
...
0.00.246.161 I llama_init_from_model: flash_attn    = 0
0.00.246.175 I llama_init_from_model: freq_base     = 10000.0
0.00.246.183 I llama_init_from_model: freq_scale    = 1
0.00.246.192 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.246.289 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.251.503 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.251.545 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.251.585 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.255.064 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.255.102 I llama_init_from_model: graph nodes  = 967
0.00.255.110 I llama_init_from_model: graph splits = 1
0.00.255.122 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.255.128 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.301.152 I 
0.00.301.320 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.301.344 I perplexity: tokenizing the input ..
0.00.307.922 I perplexity: tokenization took 6.575 ms
0.00.307.955 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.761.205 I perplexity: 0.45 seconds per pass - ETA 0.00 minutes
[1]12.6944,
0.00.765.149 I Final estimate: PPL = 12.6944 +/- 3.90928

0.00.765.193 I llama_perf_context_print:        load time =     300.74 ms
0.00.765.209 I llama_perf_context_print: prompt eval time =     451.32 ms /   128 tokens (    3.53 ms per token,   283.61 tokens per second)
0.00.765.210 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.765.211 I llama_perf_context_print:       total time =     464.04 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.271 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.258 I print_info: file type   = Q5_0
0.00.021.261 I print_info: file size   = 942.60 MiB (5.59 BPW) 
...
0.00.064.382 I print_info: n_head_kv        = 16
0.00.064.382 I print_info: n_rot            = 32
0.00.064.382 I print_info: n_swa            = 0
0.00.064.383 I print_info: n_embd_head_k    = 128
0.00.064.383 I print_info: n_embd_head_v    = 128
0.00.064.385 I print_info: n_gqa            = 1
0.00.064.387 I print_info: n_embd_k_gqa     = 2048
0.00.064.388 I print_info: n_embd_v_gqa     = 2048
0.00.064.390 I print_info: f_norm_eps       = 1.0e-05
0.00.064.390 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.064.392 I print_info: f_clamp_kqv      = 0.0e+00
0.00.064.393 I print_info: f_max_alibi_bias = 0.0e+00
0.00.064.393 I print_info: f_logit_scale    = 0.0e+00
0.00.064.394 I print_info: n_ff             = 8192
0.00.064.395 I print_info: n_expert         = 0
0.00.064.395 I print_info: n_expert_used    = 0
0.00.064.395 I print_info: causal attn      = 1
...
0.00.123.136 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.123.159 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.136.574 I llama_init_from_model: n_seq_max     = 1
0.00.136.589 I llama_init_from_model: n_ctx         = 2048
0.00.136.590 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.136.590 I llama_init_from_model: n_batch       = 2048
0.00.136.590 I llama_init_from_model: n_ubatch      = 512
0.00.136.591 I llama_init_from_model: flash_attn    = 0
0.00.136.594 I llama_init_from_model: freq_base     = 10000.0
0.00.136.594 I llama_init_from_model: freq_scale    = 1
0.00.136.617 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.210.387 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.210.411 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.210.443 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.213.791 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.213.807 I llama_init_from_model: graph nodes  = 967
0.00.213.808 I llama_init_from_model: graph splits = 1
0.00.213.819 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.214.161 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.214.174 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.303.453 I main: llama threadpool init, n_threads = 4
0.00.303.472 I 
0.00.303.542 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.303.542 I 
0.00.303.647 I sampler seed: 1234
...
0.00.303.676 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.303.676 I 
...
0.02.781.799 I llama_perf_sampler_print:    sampling time =       2.50 ms /    71 runs   (    0.04 ms per token, 28400.00 tokens per second)
0.02.781.802 I llama_perf_context_print:        load time =     301.85 ms
0.02.781.803 I llama_perf_context_print: prompt eval time =     103.10 ms /     7 tokens (   14.73 ms per token,    67.90 tokens per second)
0.02.781.804 I llama_perf_context_print:        eval time =    2362.91 ms /    63 runs   (   37.51 ms per token,    26.66 tokens per second)
0.02.781.805 I llama_perf_context_print:       total time =    2479.40 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.373 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.064.497 I print_info: n_expert_used    = 0
0.00.064.497 I print_info: causal attn      = 1
0.00.064.497 I print_info: pooling type     = 0
0.00.064.497 I print_info: rope type        = 2
0.00.064.498 I print_info: rope scaling     = linear
0.00.064.499 I print_info: freq_base_train  = 10000.0
0.00.064.500 I print_info: freq_scale_train = 1
...
0.00.064.501 I print_info: ssm_d_inner      = 0
...
0.00.064.503 I print_info: model params     = 1.41 B
0.00.064.503 I print_info: general.name     = 1.4B
0.00.064.506 I print_info: vocab type       = BPE
0.00.064.507 I print_info: n_vocab          = 50304
...
0.00.064.509 I print_info: LF token         = 187 'Ċ'
...
0.00.121.973 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.121.994 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.134.928 I llama_init_from_model: n_seq_max     = 1
0.00.134.947 I llama_init_from_model: n_ctx         = 128
0.00.134.947 I llama_init_from_model: n_ctx_per_seq = 128
0.00.134.948 I llama_init_from_model: n_batch       = 128
0.00.134.948 I llama_init_from_model: n_ubatch      = 128
0.00.134.948 I llama_init_from_model: flash_attn    = 0
0.00.134.951 I llama_init_from_model: freq_base     = 10000.0
0.00.134.952 I llama_init_from_model: freq_scale    = 1
0.00.134.953 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.134.974 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.139.695 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.139.724 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.139.748 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.142.843 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.142.860 I llama_init_from_model: graph nodes  = 967
0.00.142.860 I llama_init_from_model: graph splits = 1
0.00.142.864 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.142.864 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.196.099 I 
0.00.196.202 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.196.222 I perplexity: tokenizing the input ..
0.00.202.436 I perplexity: tokenization took 6.21 ms
0.00.202.462 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.333.890 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0822,
0.01.337.529 I Final estimate: PPL = 10.0822 +/- 3.20340

0.01.337.571 I llama_perf_context_print:        load time =     195.68 ms
0.01.337.574 I llama_perf_context_print: prompt eval time =    1129.65 ms /   128 tokens (    8.83 ms per token,   113.31 tokens per second)
0.01.337.589 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.337.590 I llama_perf_context_print:       total time =    1141.47 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.299 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.110 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.066.161 I print_info: n_ctx_train      = 2048
...
0.00.066.224 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.066.225 I print_info: max token length = 1024
0.00.066.225 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.117.907 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.117.928 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.131.131 I llama_init_from_model: n_seq_max     = 1
0.00.131.150 I llama_init_from_model: n_ctx         = 2048
0.00.131.150 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.131.150 I llama_init_from_model: n_batch       = 2048
0.00.131.150 I llama_init_from_model: n_ubatch      = 512
0.00.131.151 I llama_init_from_model: flash_attn    = 0
0.00.131.153 I llama_init_from_model: freq_base     = 10000.0
0.00.131.154 I llama_init_from_model: freq_scale    = 1
0.00.131.174 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.202.088 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.202.116 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.202.146 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.205.395 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.205.410 I llama_init_from_model: graph nodes  = 967
0.00.205.411 I llama_init_from_model: graph splits = 1
0.00.205.421 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.205.755 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.205.767 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.310.258 I main: llama threadpool init, n_threads = 4
0.00.310.280 I 
0.00.310.354 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.310.366 I 
0.00.310.460 I sampler seed: 1234
0.00.310.481 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.310.483 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.310.484 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.310.484 I 
...
0.02.940.670 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30577.09 tokens per second)
0.02.940.673 I llama_perf_context_print:        load time =     308.59 ms
0.02.940.675 I llama_perf_context_print: prompt eval time =     134.64 ms /     7 tokens (   19.23 ms per token,    51.99 tokens per second)
0.02.940.677 I llama_perf_context_print:        eval time =    2483.87 ms /    63 runs   (   39.43 ms per token,    25.36 tokens per second)
0.02.940.677 I llama_perf_context_print:       total time =    2631.55 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.362 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.671 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.020.674 I llama_model_loader: - type  f32:  194 tensors
0.00.020.675 I llama_model_loader: - type q5_1:   97 tensors
0.00.020.675 I llama_model_loader: - type q6_K:    1 tensors
0.00.020.677 I print_info: file format = GGUF V3 (latest)
0.00.020.677 I print_info: file type   = Q5_1
0.00.020.680 I print_info: file size   = 1020.74 MiB (6.05 BPW) 
0.00.050.802 I load: special tokens cache size = 25
0.00.062.795 I load: token to piece cache size = 0.2984 MB
...
0.00.062.866 I print_info: max token length = 1024
0.00.062.867 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.114.901 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.114.924 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.128.404 I llama_init_from_model: n_seq_max     = 1
0.00.128.407 I llama_init_from_model: n_ctx         = 128
0.00.128.407 I llama_init_from_model: n_ctx_per_seq = 128
0.00.128.407 I llama_init_from_model: n_batch       = 128
0.00.128.408 I llama_init_from_model: n_ubatch      = 128
0.00.128.408 I llama_init_from_model: flash_attn    = 0
0.00.128.411 I llama_init_from_model: freq_base     = 10000.0
0.00.128.412 I llama_init_from_model: freq_scale    = 1
0.00.128.413 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.128.435 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.132.884 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.132.913 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.132.934 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.136.032 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.136.048 I llama_init_from_model: graph nodes  = 967
0.00.136.048 I llama_init_from_model: graph splits = 1
0.00.136.052 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.136.052 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.196.397 I 
0.00.196.499 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.196.520 I perplexity: tokenizing the input ..
0.00.202.950 I perplexity: tokenization took 6.426 ms
0.00.202.978 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.174.757 I perplexity: 1.97 seconds per pass - ETA 0.02 minutes
[1]10.1864,
0.02.178.450 I Final estimate: PPL = 10.1864 +/- 3.18686

0.02.178.492 I llama_perf_context_print:        load time =     195.97 ms
0.02.178.507 I llama_perf_context_print: prompt eval time =    1969.97 ms /   128 tokens (   15.39 ms per token,    64.98 tokens per second)
0.02.178.531 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.178.532 I llama_perf_context_print:       total time =    1982.09 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.320 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.232 I print_info: file type   = Q2_K - Medium
...
0.00.093.623 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.093.643 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.106.501 I llama_init_from_model: n_seq_max     = 1
0.00.106.518 I llama_init_from_model: n_ctx         = 2048
0.00.106.518 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.106.518 I llama_init_from_model: n_batch       = 2048
0.00.106.518 I llama_init_from_model: n_ubatch      = 512
0.00.106.519 I llama_init_from_model: flash_attn    = 0
0.00.106.522 I llama_init_from_model: freq_base     = 10000.0
0.00.106.522 I llama_init_from_model: freq_scale    = 1
0.00.106.543 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.179.682 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.179.713 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.179.742 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.183.110 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.183.131 I llama_init_from_model: graph nodes  = 967
0.00.183.131 I llama_init_from_model: graph splits = 1
0.00.183.143 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.183.519 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.183.532 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.266.059 I main: llama threadpool init, n_threads = 4
0.00.266.082 I 
0.00.266.157 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.266.198 I 
0.00.266.290 I sampler seed: 1234
0.00.266.310 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.266.313 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.266.314 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.266.314 I 
...
0.01.802.901 I llama_perf_sampler_print:    sampling time =       2.11 ms /    71 runs   (    0.03 ms per token, 33585.62 tokens per second)
0.01.802.904 I llama_perf_context_print:        load time =     264.41 ms
0.01.802.905 I llama_perf_context_print: prompt eval time =      84.45 ms /     7 tokens (   12.06 ms per token,    82.89 tokens per second)
0.01.802.906 I llama_perf_context_print:        eval time =    1441.03 ms /    63 runs   (   22.87 ms per token,    43.72 tokens per second)
0.01.802.907 I llama_perf_context_print:       total time =    1537.94 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.313 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.915 I print_info: file type   = Q2_K - Medium
...
0.00.064.080 I print_info: f_norm_eps       = 1.0e-05
...
0.00.093.728 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.093.746 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.106.649 I llama_init_from_model: n_seq_max     = 1
0.00.106.664 I llama_init_from_model: n_ctx         = 128
0.00.106.665 I llama_init_from_model: n_ctx_per_seq = 128
0.00.106.665 I llama_init_from_model: n_batch       = 128
0.00.106.665 I llama_init_from_model: n_ubatch      = 128
0.00.106.665 I llama_init_from_model: flash_attn    = 0
0.00.106.669 I llama_init_from_model: freq_base     = 10000.0
0.00.106.670 I llama_init_from_model: freq_scale    = 1
0.00.106.670 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.106.691 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.111.346 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.111.404 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.111.428 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.114.626 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.114.642 I llama_init_from_model: graph nodes  = 967
0.00.114.643 I llama_init_from_model: graph splits = 1
0.00.114.646 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.114.647 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.159.072 I 
0.00.159.186 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.159.208 I perplexity: tokenizing the input ..
0.00.165.773 I perplexity: tokenization took 6.561 ms
0.00.165.800 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.460.046 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.7471,
0.01.463.785 I Final estimate: PPL = 70.7471 +/- 27.47559

0.01.463.825 I llama_perf_context_print:        load time =     158.67 ms
0.01.463.827 I llama_perf_context_print: prompt eval time =    1292.35 ms /   128 tokens (   10.10 ms per token,    99.04 tokens per second)
0.01.463.828 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.463.828 I llama_perf_context_print:       total time =    1304.75 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.253 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.495 I main: llama backend init
...
0.00.101.358 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.101.386 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.182.690 I llama_init_from_model: n_seq_max     = 1
0.00.182.723 I llama_init_from_model: n_ctx         = 2048
0.00.182.731 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.182.737 I llama_init_from_model: n_batch       = 2048
0.00.182.744 I llama_init_from_model: n_ubatch      = 512
0.00.182.750 I llama_init_from_model: flash_attn    = 0
0.00.182.761 I llama_init_from_model: freq_base     = 10000.0
0.00.182.767 I llama_init_from_model: freq_scale    = 1
0.00.182.801 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.254.188 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.254.235 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.254.313 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.257.461 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.257.479 I llama_init_from_model: graph nodes  = 967
0.00.257.479 I llama_init_from_model: graph splits = 1
0.00.257.492 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.257.817 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.257.829 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.348.477 I main: llama threadpool init, n_threads = 4
0.00.348.500 I 
0.00.348.578 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.348.592 I 
0.00.348.694 I sampler seed: 1234
0.00.348.714 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.348.717 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.348.717 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.348.718 I 
...
0.02.162.741 I llama_perf_sampler_print:    sampling time =       2.42 ms /    71 runs   (    0.03 ms per token, 29363.11 tokens per second)
0.02.162.743 I llama_perf_context_print:        load time =     346.85 ms
0.02.162.745 I llama_perf_context_print: prompt eval time =      68.21 ms /     7 tokens (    9.74 ms per token,   102.62 tokens per second)
0.02.162.746 I llama_perf_context_print:        eval time =    1733.48 ms /    63 runs   (   27.52 ms per token,    36.34 tokens per second)
0.02.162.746 I llama_perf_context_print:       total time =    1815.32 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.394 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.101.327 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.101.344 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.183.858 I llama_init_from_model: n_seq_max     = 1
0.00.183.876 I llama_init_from_model: n_ctx         = 128
0.00.183.877 I llama_init_from_model: n_ctx_per_seq = 128
0.00.183.877 I llama_init_from_model: n_batch       = 128
0.00.183.877 I llama_init_from_model: n_ubatch      = 128
0.00.183.878 I llama_init_from_model: flash_attn    = 0
0.00.183.883 I llama_init_from_model: freq_base     = 10000.0
0.00.183.884 I llama_init_from_model: freq_scale    = 1
0.00.183.885 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.183.912 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.188.415 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.188.443 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.188.472 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.191.751 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.191.767 I llama_init_from_model: graph nodes  = 967
0.00.191.768 I llama_init_from_model: graph splits = 1
...
0.00.236.304 I 
0.00.236.415 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.236.437 I perplexity: tokenizing the input ..
0.00.243.012 I perplexity: tokenization took 6.571 ms
0.00.243.043 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.146.428 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]12.3725,
0.01.150.273 I Final estimate: PPL = 12.3725 +/- 4.01345

0.01.150.313 I llama_perf_context_print:        load time =     235.86 ms
0.01.150.327 I llama_perf_context_print: prompt eval time =     901.46 ms /   128 tokens (    7.04 ms per token,   141.99 tokens per second)
0.01.150.328 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.150.329 I llama_perf_context_print:       total time =     914.01 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.254 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.248 I llama_model_loader: - type q4_K:   61 tensors
...
0.00.021.251 I print_info: file type   = Q4_K - Medium
0.00.021.254 I print_info: file size   = 871.81 MiB (5.17 BPW) 
...
0.00.107.103 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.107.124 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.227.632 I llama_init_from_model: n_seq_max     = 1
0.00.227.647 I llama_init_from_model: n_ctx         = 2048
0.00.227.647 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.227.648 I llama_init_from_model: n_batch       = 2048
0.00.227.648 I llama_init_from_model: n_ubatch      = 512
0.00.227.649 I llama_init_from_model: flash_attn    = 0
0.00.227.656 I llama_init_from_model: freq_base     = 10000.0
0.00.227.658 I llama_init_from_model: freq_scale    = 1
0.00.227.689 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.298.078 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.298.109 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.298.146 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.301.495 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.301.510 I llama_init_from_model: graph nodes  = 967
0.00.301.511 I llama_init_from_model: graph splits = 1
0.00.301.525 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.301.862 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.301.874 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.401.080 I main: llama threadpool init, n_threads = 4
0.00.401.101 I 
0.00.401.176 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.401.190 I 
0.00.401.292 I sampler seed: 1234
0.00.401.312 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.401.315 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.401.316 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.401.316 I 
...
0.02.523.076 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31113.06 tokens per second)
0.02.523.079 I llama_perf_context_print:        load time =     399.44 ms
0.02.523.080 I llama_perf_context_print: prompt eval time =      73.53 ms /     7 tokens (   10.50 ms per token,    95.20 tokens per second)
0.02.523.081 I llama_perf_context_print:        eval time =    2036.49 ms /    63 runs   (   32.33 ms per token,    30.94 tokens per second)
0.02.523.082 I llama_perf_context_print:       total time =    2123.10 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.390 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.145 I print_info: file size   = 871.81 MiB (5.17 BPW) 
...
0.00.064.355 I print_info: rope type        = 2
...
0.00.107.656 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.107.676 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.226.929 I llama_init_from_model: n_seq_max     = 1
0.00.226.947 I llama_init_from_model: n_ctx         = 128
0.00.226.948 I llama_init_from_model: n_ctx_per_seq = 128
0.00.226.949 I llama_init_from_model: n_batch       = 128
0.00.226.949 I llama_init_from_model: n_ubatch      = 128
0.00.226.950 I llama_init_from_model: flash_attn    = 0
0.00.226.956 I llama_init_from_model: freq_base     = 10000.0
0.00.226.957 I llama_init_from_model: freq_scale    = 1
0.00.226.959 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.226.989 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.231.845 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.231.878 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.231.912 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.235.305 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.235.320 I llama_init_from_model: graph nodes  = 967
0.00.235.320 I llama_init_from_model: graph splits = 1
0.00.235.326 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.235.326 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.287.667 I 
0.00.287.803 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.287.828 I perplexity: tokenizing the input ..
0.00.294.434 I perplexity: tokenization took 6.602 ms
0.00.294.466 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.867.639 I perplexity: 0.57 seconds per pass - ETA 0.00 minutes
[1]10.3355,
0.00.871.502 I Final estimate: PPL = 10.3355 +/- 3.28881

0.00.871.546 I llama_perf_context_print:        load time =     287.22 ms
0.00.871.560 I llama_perf_context_print: prompt eval time =     571.28 ms /   128 tokens (    4.46 ms per token,   224.06 tokens per second)
0.00.871.562 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.871.563 I llama_perf_context_print:       total time =     583.88 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.261 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.112.951 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.112.969 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.247.605 I llama_init_from_model: n_seq_max     = 1
0.00.247.623 I llama_init_from_model: n_ctx         = 2048
0.00.247.623 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.247.624 I llama_init_from_model: n_batch       = 2048
0.00.247.624 I llama_init_from_model: n_ubatch      = 512
0.00.247.625 I llama_init_from_model: flash_attn    = 0
0.00.247.629 I llama_init_from_model: freq_base     = 10000.0
0.00.247.630 I llama_init_from_model: freq_scale    = 1
0.00.247.709 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.319.762 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.319.791 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.319.830 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.323.241 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.323.257 I llama_init_from_model: graph nodes  = 967
0.00.323.258 I llama_init_from_model: graph splits = 1
0.00.323.271 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.323.617 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.323.630 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.426.568 I main: llama threadpool init, n_threads = 4
0.00.426.588 I 
0.00.426.695 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.426.697 I 
0.00.426.790 I sampler seed: 1234
0.00.426.809 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.426.813 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.426.813 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.426.813 I 
...
0.02.997.954 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31485.59 tokens per second)
0.02.997.957 I llama_perf_context_print:        load time =     425.01 ms
0.02.997.958 I llama_perf_context_print: prompt eval time =      89.29 ms /     7 tokens (   12.76 ms per token,    78.40 tokens per second)
0.02.997.959 I llama_perf_context_print:        eval time =    2470.25 ms /    63 runs   (   39.21 ms per token,    25.50 tokens per second)
0.02.997.960 I llama_perf_context_print:       total time =    2572.46 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.335 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.957 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
...
0.00.020.965 I print_info: file size   = 1006.35 MiB (5.97 BPW) 
...
0.00.064.066 I print_info: n_embd_k_gqa     = 2048
...
0.00.114.648 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.114.663 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.248.383 I llama_init_from_model: n_seq_max     = 1
0.00.248.418 I llama_init_from_model: n_ctx         = 128
0.00.248.425 I llama_init_from_model: n_ctx_per_seq = 128
0.00.248.432 I llama_init_from_model: n_batch       = 128
0.00.248.439 I llama_init_from_model: n_ubatch      = 128
0.00.248.446 I llama_init_from_model: flash_attn    = 0
0.00.248.501 I llama_init_from_model: freq_base     = 10000.0
0.00.248.512 I llama_init_from_model: freq_scale    = 1
0.00.248.520 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.248.559 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.253.766 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.253.798 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.253.831 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.257.183 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.257.199 I llama_init_from_model: graph nodes  = 967
0.00.257.199 I llama_init_from_model: graph splits = 1
0.00.257.205 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.257.205 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.324.795 I 
0.00.324.934 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.324.961 I perplexity: tokenizing the input ..
0.00.331.524 I perplexity: tokenization took 6.566 ms
0.00.331.557 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.998.667 I perplexity: 0.67 seconds per pass - ETA 0.00 minutes
[1]11.0242,
0.01.002.596 I Final estimate: PPL = 11.0242 +/- 3.53494

0.01.002.643 I llama_perf_context_print:        load time =     324.40 ms
0.01.002.669 I llama_perf_context_print: prompt eval time =     665.25 ms /   128 tokens (    5.20 ms per token,   192.41 tokens per second)
0.01.002.670 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.002.671 I llama_perf_context_print:       total time =     677.85 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.303 I build: 4723 (c2cd24fb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.099 I print_info: file type   = Q6_K
0.00.021.101 I print_info: file size   = 1.08 GiB (6.57 BPW) 
...
0.00.117.998 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.118.015 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.260.943 I llama_init_from_model: n_seq_max     = 1
0.00.260.974 I llama_init_from_model: n_ctx         = 2048
0.00.260.981 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.260.988 I llama_init_from_model: n_batch       = 2048
0.00.260.994 I llama_init_from_model: n_ubatch      = 512
0.00.261.001 I llama_init_from_model: flash_attn    = 0
0.00.261.015 I llama_init_from_model: freq_base     = 10000.0
0.00.261.026 I llama_init_from_model: freq_scale    = 1
0.00.261.065 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.337.506 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.337.540 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.337.582 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.341.129 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.341.146 I llama_init_from_model: graph nodes  = 967
0.00.341.147 I llama_init_from_model: graph splits = 1
0.00.341.159 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.341.493 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.341.505 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.460.261 I main: llama threadpool init, n_threads = 4
0.00.460.283 I 
0.00.460.371 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.460.393 I 
0.00.460.499 I sampler seed: 1234
0.00.460.520 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.460.524 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.460.525 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.460.525 I 
...
0.03.145.995 I llama_perf_sampler_print:    sampling time =       2.44 ms /    71 runs   (    0.03 ms per token, 29146.14 tokens per second)
0.03.145.999 I llama_perf_context_print:        load time =     458.61 ms
0.03.146.001 I llama_perf_context_print: prompt eval time =     114.03 ms /     7 tokens (   16.29 ms per token,    61.39 tokens per second)
0.03.146.002 I llama_perf_context_print:        eval time =    2559.28 ms /    63 runs   (   40.62 ms per token,    24.62 tokens per second)
0.03.146.003 I llama_perf_context_print:       total time =    2686.83 ms /    70 tokens
...
0.00.020.732 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
0.00.020.735 I llama_model_loader: - type  f32:  194 tensors
0.00.020.735 I llama_model_loader: - type q6_K:   98 tensors
0.00.020.738 I print_info: file format = GGUF V3 (latest)
0.00.020.738 I print_info: file type   = Q6_K
...
0.00.064.447 I print_info: n_head           = 16
0.00.064.448 I print_info: n_head_kv        = 16
0.00.064.449 I print_info: n_rot            = 32
...
0.00.064.459 I print_info: n_expert_used    = 0
0.00.064.459 I print_info: causal attn      = 1
0.00.064.459 I print_info: pooling type     = 0
0.00.064.460 I print_info: rope type        = 2
0.00.064.460 I print_info: rope scaling     = linear
0.00.064.461 I print_info: freq_base_train  = 10000.0
0.00.064.462 I print_info: freq_scale_train = 1
0.00.064.462 I print_info: n_ctx_orig_yarn  = 2048
0.00.064.463 I print_info: rope_finetuned   = unknown
0.00.064.463 I print_info: ssm_d_conv       = 0
0.00.064.463 I print_info: ssm_d_inner      = 0
0.00.064.464 I print_info: ssm_d_state      = 0
0.00.064.464 I print_info: ssm_dt_rank      = 0
0.00.064.464 I print_info: ssm_dt_b_c_rms   = 0
0.00.064.465 I print_info: model type       = 1.4B
0.00.064.465 I print_info: model params     = 1.41 B
...
0.00.118.294 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.118.316 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.256.101 I llama_init_from_model: n_seq_max     = 1
0.00.256.118 I llama_init_from_model: n_ctx         = 128
0.00.256.119 I llama_init_from_model: n_ctx_per_seq = 128
0.00.256.119 I llama_init_from_model: n_batch       = 128
0.00.256.119 I llama_init_from_model: n_ubatch      = 128
0.00.256.120 I llama_init_from_model: flash_attn    = 0
0.00.256.125 I llama_init_from_model: freq_base     = 10000.0
0.00.256.127 I llama_init_from_model: freq_scale    = 1
0.00.256.128 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.256.157 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.261.246 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.261.277 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.261.308 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.264.740 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.264.757 I llama_init_from_model: graph nodes  = 967
0.00.264.757 I llama_init_from_model: graph splits = 1
0.00.264.762 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.264.762 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.347.367 I 
0.00.347.482 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.347.503 I perplexity: tokenizing the input ..
0.00.354.194 I perplexity: tokenization took 6.688 ms
0.00.354.227 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.163.144 I perplexity: 0.81 seconds per pass - ETA 0.00 minutes
[1]10.3482,
0.01.166.969 I Final estimate: PPL = 10.3482 +/- 3.30522

0.01.167.013 I llama_perf_context_print:        load time =     346.99 ms
0.01.167.026 I llama_perf_context_print: prompt eval time =     807.03 ms /   128 tokens (    6.30 ms per token,   158.61 tokens per second)
0.01.167.027 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.167.028 I llama_perf_context_print:       total time =     819.65 ms /   129 tokens
...
0.00.300.254 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
...
llama_init_from_model: graph splits = 1
0.00.303.752 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
...
0.59user 0.77system 0:01.36elapsed 100%CPU (0avgtext+0avgdata 5356852maxresident)k
