...
- status:  SUCCESS ✅
- runtime: 819.13
- date:    Sat Dec  7 01:59:38 PST 2024
...
0.00.060.746 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.098.311 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.092.013 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.053.722 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.052.818 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.048.748 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.050.742 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.048.625 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.045.415 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.089.237 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.048.952 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.055.932 I llm_load_print_meta: LF token         = 128 'Ä'
