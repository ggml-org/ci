...
- status:  SUCCESS ✅
- runtime: 619.92
- date:    Sat Mar  9 00:37:03 EET 2024
...
20/21 Test #20: test-backend-ops ....................   Passed  149.43 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 227.68 sec*proc (21 tests)

Total Test time (real) = 227.69 sec
...
llama_print_timings:        load time =      57.15 ms
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.27 ms /     9 tokens (    1.36 ms per token,   733.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
