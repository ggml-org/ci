...
- status:  SUCCESS ✅
- runtime: 339.00
- date:    Sat May 25 11:16:21 EEST 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/9791f402580838d7f8543ae7bc633ef265e436f0
- author:  Elton Kola
```
android : module (#7502)
...
Label Time Summary:
main    = 183.32 sec*proc (22 tests)

Total Test time (real) = 183.33 sec
...
llama_print_timings: prompt eval time =       9.08 ms /     9 tokens (    1.01 ms per token,   990.97 tokens per second)
...
llama_print_timings:        load time =      53.98 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.55 ms /     9 tokens (    1.39 ms per token,   717.07 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      12.78 ms /    10 tokens
ggml_metal_free: deallocating
