...
- status:  SUCCESS ✅
- runtime: 14:45.15
- date:    Wed May 29 18:04:01 UTC 2024
...
**Get to Work** is a life simulation game pack for The Sims 4 that allows players to start their own business
...
llama_print_timings: prompt eval time =    1158.29 ms /     2 tokens (  579.14 ms per token,     1.73 tokens per second)
llama_print_timings:        eval time =   21015.56 ms /    31 runs   (  677.92 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22352.09 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Heidelberg, a prominent Jewish philosopher and mystic, formulated a rich philosophical system based on Jewish teachings and mystical experiences.

**Philosophical System of Heidelberg
llama_print_timings:        load time =    1254.32 ms
llama_print_timings:      sample time =      47.37 ms /    32 runs   (    1.48 ms per token,   675.60 tokens per second)
llama_print_timings: prompt eval time =    1149.03 ms /     2 tokens (  574.52 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21405.22 ms /    31 runs   (  690.49 ms per token,     1.45 tokens per second)
llama_print_timings:       total time =   22732.70 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a quaint village nestled amidst rolling hills, there lived a young storyteller named Anya. With a voice that carried the magic of the spoken word, she spun
llama_print_timings:        load time =    1228.31 ms
llama_print_timings:      sample time =      47.51 ms /    32 runs   (    1.48 ms per token,   673.50 tokens per second)
llama_print_timings: prompt eval time =    2602.16 ms /     5 tokens (  520.43 ms per token,     1.92 tokens per second)
llama_print_timings:        eval time =   20937.99 ms /    31 runs   (  675.42 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   23717.32 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They say money can't buy happiness, but it can buy a lot of things that make it easier to find it.

**What are some things that money
llama_print_timings:        load time =    1277.81 ms
llama_print_timings:      sample time =      47.28 ms /    32 runs   (    1.48 ms per token,   676.85 tokens per second)
llama_print_timings: prompt eval time =    1208.74 ms /     2 tokens (  604.37 ms per token,     1.65 tokens per second)
llama_print_timings:        eval time =   21073.11 ms /    31 runs   (  679.78 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22458.78 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198425.20 ms
main:    total time = 198425.20 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They are the ones who make the decisions that affect the lives of millions.
...
* Influence over
llama_print_timings:        load time =     633.81 ms
llama_print_timings:      sample time =      47.31 ms /    32 runs   (    1.48 ms per token,   676.32 tokens per second)
llama_print_timings: prompt eval time =     571.33 ms /     2 tokens (  285.66 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =   10578.23 ms /    31 runs   (  341.23 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11327.65 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198307.62 ms
main:    total time = 198307.62 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Soar was founded to empower individuals to achieve their full potential in life. 

**Here are some key principles that guide our work:**

**1. Empowerment
llama_print_timings:        load time =     627.72 ms
llama_print_timings:      sample time =      47.43 ms /    32 runs   (    1.48 ms per token,   674.62 tokens per second)
llama_print_timings: prompt eval time =     571.10 ms /     2 tokens (  285.55 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =   10570.25 ms /    31 runs   (  340.98 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11319.02 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They are a group of talented individuals with a passion for creating innovative solutions. They thrive in collaborative environments and are dedicated to pushing the boundaries of what is possible.
...
llama_print_timings: prompt eval time =      79.23 ms /     2 tokens (   39.61 ms per token,    25.24 tokens per second)
llama_print_timings:        eval time =    2154.71 ms /    31 runs   (   69.51 ms per token,    14.39 tokens per second)
llama_print_timings:       total time =    2295.66 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a realm of magic and wonder, there lived a courageous princess named Anya.

**Anya's Courage:**

- She possessed an unwavering spirit
llama_print_timings:        load time =     164.95 ms
llama_print_timings:      sample time =       4.99 ms /    32 runs   (    0.16 ms per token,  6410.26 tokens per second)
llama_print_timings: prompt eval time =     131.43 ms /     5 tokens (   26.29 ms per token,    38.04 tokens per second)
llama_print_timings:        eval time =    2073.58 ms /    31 runs   (   66.89 ms per token,    14.95 tokens per second)
llama_print_timings:       total time =    2269.68 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 When a person is experiencing suicidal thoughts, what should the first step be?

**a) Encourage them to seek professional help**
**b) Call 9
...
llama_print_timings:        eval time =    2217.83 ms /    31 runs   (   71.54 ms per token,    13.98 tokens per second)
llama_print_timings:       total time =    2364.26 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =      79.92 ms /     2 tokens (   39.96 ms per token,    25.03 tokens per second)
llama_print_timings:        eval time =    2213.77 ms /    31 runs   (   71.41 ms per token,    14.00 tokens per second)
llama_print_timings:       total time =    2356.22 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32074.50 ms
main:    total time = 32074.50 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a cozy village nestled amidst rolling hills, there lived a young girl named Anya. Anya had bright eyes that sparkled with curiosity, and a heart filled
...
llama_print_timings: prompt eval time =     125.50 ms /     5 tokens (   25.10 ms per token,    39.84 tokens per second)
llama_print_timings:        eval time =    1636.43 ms /    31 runs   (   52.79 ms per token,    18.94 tokens per second)
llama_print_timings:       total time =    1824.28 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32096.94 ms
main:    total time = 32096.94 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shelliel, a young woman with eyes full of dreams, awoke one morning to find her village submerged in a crimson tide. Panic surged through her veins, the
...
llama_print_timings: prompt eval time =      68.73 ms /     2 tokens (   34.37 ms per token,    29.10 tokens per second)
llama_print_timings:        eval time =    1591.69 ms /    31 runs   (   51.34 ms per token,    19.48 tokens per second)
llama_print_timings:       total time =    1722.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        eval time =    3375.99 ms /    63 runs   (   53.59 ms per token,    18.66 tokens per second)
llama_print_timings:       total time =    3536.05 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1900.05 ms /   128 tokens (   14.84 ms per token,    67.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1915.05 ms /   129 tokens
...
llama_print_timings: prompt eval time =      87.46 ms /     8 tokens (   10.93 ms per token,    91.47 tokens per second)
llama_print_timings:        eval time =    2567.42 ms /    63 runs   (   40.75 ms per token,    24.54 tokens per second)
llama_print_timings:       total time =    2683.28 ms /    71 tokens
Log end
...
[1]9.6348,
llama_print_timings:        load time =     151.16 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1115.35 ms /   128 tokens (    8.71 ms per token,   114.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings:        eval time =    2052.67 ms /    63 runs   (   32.58 ms per token,    30.69 tokens per second)
llama_print_timings:       total time =    2162.39 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1219.10 ms /   128 tokens (    9.52 ms per token,   105.00 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1233.82 ms /   129 tokens
...
llama_print_timings: prompt eval time =     151.11 ms /     8 tokens (   18.89 ms per token,    52.94 tokens per second)
llama_print_timings:        eval time =    2024.57 ms /    63 runs   (   32.14 ms per token,    31.12 tokens per second)
llama_print_timings:       total time =    2203.64 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2237.71 ms /   128 tokens (   17.48 ms per token,    57.20 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings: prompt eval time =     160.84 ms /     8 tokens (   20.10 ms per token,    49.74 tokens per second)
llama_print_timings:        eval time =    2220.96 ms /    63 runs   (   35.25 ms per token,    28.37 tokens per second)
llama_print_timings:       total time =    2410.15 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2360.27 ms /   128 tokens (   18.44 ms per token,    54.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2375.58 ms /   129 tokens
...
llama_print_timings: prompt eval time =     168.52 ms /     8 tokens (   21.07 ms per token,    47.47 tokens per second)
llama_print_timings:        eval time =    2324.12 ms /    63 runs   (   36.89 ms per token,    27.11 tokens per second)
llama_print_timings:       total time =    2520.07 ms /    71 tokens
Log end
...
[1]9.5488,
llama_print_timings:        load time =     116.79 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2530.01 ms /   128 tokens (   19.77 ms per token,    50.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2544.76 ms /   129 tokens
...
I believe this
llama_print_timings:        load time =      96.50 ms
llama_print_timings:      sample time =       2.19 ms /    64 runs   (    0.03 ms per token, 29197.08 tokens per second)
llama_print_timings: prompt eval time =     106.19 ms /     8 tokens (   13.27 ms per token,    75.34 tokens per second)
llama_print_timings:        eval time =    1597.38 ms /    63 runs   (   25.36 ms per token,    39.44 tokens per second)
llama_print_timings:       total time =    1731.47 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1596.48 ms /   128 tokens (   12.47 ms per token,    80.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1611.38 ms /   129 tokens
...
llama_print_timings: prompt eval time =     116.75 ms /     8 tokens (   14.59 ms per token,    68.52 tokens per second)
llama_print_timings:        eval time =    1779.36 ms /    63 runs   (   28.24 ms per token,    35.41 tokens per second)
llama_print_timings:       total time =    1924.29 ms /    71 tokens
Log end
...
[1]11.3556,
llama_print_timings:        load time =      89.23 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1683.65 ms /   128 tokens (   13.15 ms per token,    76.03 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1698.80 ms /   129 tokens
...
llama_print_timings:       total time =    2083.16 ms /    71 tokens
Log end
...
[1]9.5894,
llama_print_timings:        load time =      97.54 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1748.80 ms /   128 tokens (   13.66 ms per token,    73.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1763.89 ms /   129 tokens
...
llama_print_timings: prompt eval time =     142.11 ms /     8 tokens (   17.76 ms per token,    56.29 tokens per second)
llama_print_timings:        eval time =    2147.42 ms /    63 runs   (   34.09 ms per token,    29.34 tokens per second)
llama_print_timings:       total time =    2317.56 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2054.90 ms /   128 tokens (   16.05 ms per token,    62.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2070.35 ms /   129 tokens
...
llama_print_timings:        eval time =    2225.42 ms /    63 runs   (   35.32 ms per token,    28.31 tokens per second)
llama_print_timings:       total time =    2384.81 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1876.29 ms /   128 tokens (   14.66 ms per token,    68.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
first run: The quick brown fox jumped over the lazy dog. It was a surreal experience.

I had


second run: The quick brown fox jumped over the lazy dog. It was a surreal experience.

I had


single seq run: The quick brown fox jumped over the lazy dog. It was a surreal experience.
...
first run: The quick brown fox jumps over the lazy dog variety. In the 1986 Academy Award
winning supporting player


second run: The quick brown fox jumps over the lazy dog variety. In the 1986 Academy Award
winning supporting player


single seq run: The quick brown fox jumps over the lazy dog variety. In the 1986 Academy Award
winning supporting player
...
0.82user 0.20system 0:01.02elapsed 99%CPU (0avgtext+0avgdata 2895848maxresident)k
0inputs+40outputs (0major+59697minor)pagefaults 0swaps
```
...
0.19user 0.22system 0:00.41elapsed 99%CPU (0avgtext+0avgdata 2895384maxresident)k
