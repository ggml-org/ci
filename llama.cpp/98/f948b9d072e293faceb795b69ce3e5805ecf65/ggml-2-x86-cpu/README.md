...
- status:  SUCCESS ✅
- runtime: 15:10.56
- date:    Sun Jun 16 10:34:19 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 9/22 Test  #9: test-tokenizer-0-command-r .......   Passed    3.43 sec
...
Label Time Summary:
main    =  24.19 sec*proc (22 tests)

Total Test time (real) =  24.20 sec
...
main: build = 3156 (98f948b9)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
main: seed  = 1718533307
...
llama_print_timings:        load time =      12.27 ms
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.33 ms /     9 tokens (    0.37 ms per token,  2706.77 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =       4.41 ms /    10 tokens
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasels, the heroes of this story, are not real. Instead, they are fictional characters that represent different personality traits and abilities.

**Personality Traits:**
llama_print_timings:        load time =    1304.64 ms
llama_print_timings:      sample time =      47.94 ms /    32 runs   (    1.50 ms per token,   667.45 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   21611.44 ms /    32 runs   (  675.36 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   21786.86 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities, but I'm not sure if the context is appropriate for me to ask. [end of text]

llama_print_timings:        load time =    1292.55 ms
llama_print_timings:      sample time =      29.67 ms /    20 runs   (    1.48 ms per token,   674.15 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   13416.34 ms /    20 runs   (  670.82 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   13525.34 ms /    20 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    1257.90 ms
llama_print_timings:      sample time =       5.94 ms /     4 runs   (    1.48 ms per token,   673.63 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    2676.95 ms /     4 runs   (  669.24 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =    2699.62 ms /     4 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities is a trope that often features a damsel in distress and a brooding prince.

**Questions:**

* What are the elements that make this trope
llama_print_timings:        load time =    1256.55 ms
llama_print_timings:      sample time =      47.64 ms /    32 runs   (    1.49 ms per token,   671.75 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   21738.03 ms /    32 runs   (  679.31 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   21913.50 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197876.15 ms
main:    total time = 197876.15 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities, a new era in the history of the universe.

This new era will usher in an age of scientific exploration, technological advancement, and societal upheaval
llama_print_timings:        load time =     679.93 ms
llama_print_timings:      sample time =      47.66 ms /    32 runs   (    1.49 ms per token,   671.35 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   10810.96 ms /    32 runs   (  337.84 ms per token,     2.96 tokens per second)
llama_print_timings:       total time =   10984.70 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198163.90 ms
main:    total time = 198163.90 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 seconal of the soul, as taught by the Christian faith.

**Explanation:**

The Christian faith teaches that salvation is a free gift from God, received
llama_print_timings:        load time =     672.46 ms
llama_print_timings:      sample time =      47.66 ms /    32 runs   (    1.49 ms per token,   671.49 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   10904.92 ms /    32 runs   (  340.78 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11079.22 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities and engage in discussions about the nature of reality, consciousness, and the human experience. [end of text]

llama_print_timings:        load time =     225.38 ms
llama_print_timings:      sample time =       3.03 ms /    20 runs   (    0.15 ms per token,  6594.13 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1354.82 ms /    20 runs   (   67.74 ms per token,    14.76 tokens per second)
llama_print_timings:       total time =    1393.86 ms /    20 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       2.82 ms /    19 runs   (    0.15 ms per token,  6728.05 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1229.16 ms /    19 runs   (   64.69 ms per token,    15.46 tokens per second)
llama_print_timings:       total time =    1265.92 ms /    19 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       2.96 ms /    19 runs   (    0.16 ms per token,  6416.75 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1236.13 ms /    19 runs   (   65.06 ms per token,    15.37 tokens per second)
llama_print_timings:       total time =    1273.12 ms /    19 tokens
Log end
+ echo PASS
PASS
+ echo
...
I am curious to know what is the most common type of injury sustained by individuals involved in road traffic accidents?
...
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    2183.51 ms /    32 runs   (   68.23 ms per token,    14.66 tokens per second)
llama_print_timings:       total time =    2246.67 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32002.07 ms
main:    total time = 32002.07 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =     192.34 ms /     4 runs   (   48.09 ms per token,    20.80 tokens per second)
llama_print_timings:       total time =     201.66 ms /     4 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32054.06 ms
main:    total time = 32054.06 ms
+ echo PASS
PASS
+ echo
...
**Assistant:** I understand. I will ensure to communicate effectively and promptly.

**Task:** Please provide examples of how you communicate effectively with
llama_print_timings:        load time =     165.86 ms
llama_print_timings:      sample time =       4.71 ms /    32 runs   (    0.15 ms per token,  6786.85 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1529.66 ms /    32 runs   (   47.80 ms per token,    20.92 tokens per second)
llama_print_timings:       total time =    1590.55 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
The Life of Faith:
llama_print_timings:        load time =     289.26 ms
llama_print_timings:      sample time =       2.62 ms /    64 runs   (    0.04 ms per token, 24408.85 tokens per second)
llama_print_timings: prompt eval time =     124.27 ms /     8 tokens (   15.53 ms per token,    64.38 tokens per second)
llama_print_timings:        eval time =    3369.72 ms /    63 runs   (   53.49 ms per token,    18.70 tokens per second)
llama_print_timings:       total time =    3524.72 ms /    71 tokens
Log end
...
[1]9.4753,
llama_print_timings:        load time =     182.14 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1828.63 ms /   128 tokens (   14.29 ms per token,    70.00 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1844.21 ms /   129 tokens
...
llama_print_timings:        load time =     250.34 ms
llama_print_timings:      sample time =       2.15 ms /    64 runs   (    0.03 ms per token, 29712.16 tokens per second)
llama_print_timings: prompt eval time =      86.29 ms /     8 tokens (   10.79 ms per token,    92.71 tokens per second)
llama_print_timings:        eval time =    2511.89 ms /    63 runs   (   39.87 ms per token,    25.08 tokens per second)
llama_print_timings:       total time =    2624.68 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1089.50 ms /   128 tokens (    8.51 ms per token,   117.49 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1104.87 ms /   129 tokens
...
llama_print_timings:        load time =     197.80 ms
llama_print_timings:      sample time =       2.27 ms /    64 runs   (    0.04 ms per token, 28256.07 tokens per second)
llama_print_timings: prompt eval time =      80.13 ms /     8 tokens (   10.02 ms per token,    99.84 tokens per second)
llama_print_timings:        eval time =    2020.15 ms /    63 runs   (   32.07 ms per token,    31.19 tokens per second)
llama_print_timings:       total time =    2126.98 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1193.98 ms /   128 tokens (    9.33 ms per token,   107.20 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1209.87 ms /   129 tokens
...
llama_print_timings: prompt eval time =     147.49 ms /     8 tokens (   18.44 ms per token,    54.24 tokens per second)
llama_print_timings:        eval time =    1998.93 ms /    63 runs   (   31.73 ms per token,    31.52 tokens per second)
llama_print_timings:       total time =    2173.29 ms /    71 tokens
Log end
...
[1]9.8464,
llama_print_timings:        load time =     116.08 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2210.32 ms /   128 tokens (   17.27 ms per token,    57.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2225.86 ms /   129 tokens
...
llama_print_timings:        load time =     224.29 ms
llama_print_timings:      sample time =       2.27 ms /    64 runs   (    0.04 ms per token, 28231.14 tokens per second)
llama_print_timings: prompt eval time =     155.81 ms /     8 tokens (   19.48 ms per token,    51.35 tokens per second)
llama_print_timings:        eval time =    2177.46 ms /    63 runs   (   34.56 ms per token,    28.93 tokens per second)
llama_print_timings:       total time =    2360.87 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 0 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 9.509 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.38 seconds per pass - ETA 0.03 minutes
[1]9.4336,
llama_print_timings:        load time =     124.19 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2383.22 ms /   128 tokens (   18.62 ms per token,    53.71 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2398.82 ms /   129 tokens
...
llama_print_timings: prompt eval time =     165.85 ms /     8 tokens (   20.73 ms per token,    48.24 tokens per second)
llama_print_timings:        eval time =    2297.56 ms /    63 runs   (   36.47 ms per token,    27.42 tokens per second)
llama_print_timings:       total time =    2490.37 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2495.57 ms /   128 tokens (   19.50 ms per token,    51.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2511.59 ms /   129 tokens
...
— war
llama_print_timings:        load time =     182.70 ms
llama_print_timings:      sample time =       2.16 ms /    64 runs   (    0.03 ms per token, 29643.35 tokens per second)
llama_print_timings: prompt eval time =     103.76 ms /     8 tokens (   12.97 ms per token,    77.10 tokens per second)
llama_print_timings:        eval time =    1542.02 ms /    63 runs   (   24.48 ms per token,    40.86 tokens per second)
llama_print_timings:       total time =    1672.81 ms /    71 tokens
Log end
...
[1]68.7223,
llama_print_timings:        load time =      82.82 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1583.67 ms /   128 tokens (   12.37 ms per token,    80.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1599.44 ms /   129 tokens
...
llama_print_timings: prompt eval time =     112.72 ms /     8 tokens (   14.09 ms per token,    70.97 tokens per second)
llama_print_timings:        eval time =    1721.64 ms /    63 runs   (   27.33 ms per token,    36.59 tokens per second)
llama_print_timings:       total time =    1860.95 ms /    71 tokens
Log end
...
[1]11.5044,
llama_print_timings:        load time =      92.00 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1668.70 ms /   128 tokens (   13.04 ms per token,    76.71 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1683.92 ms /   129 tokens
...
llama_print_timings: prompt eval time =     118.42 ms /     8 tokens (   14.80 ms per token,    67.55 tokens per second)
llama_print_timings:        eval time =    1895.34 ms /    63 runs   (   30.08 ms per token,    33.24 tokens per second)
llama_print_timings:       total time =    2040.96 ms /    71 tokens
Log end
...
[1]9.5837,
llama_print_timings:        load time =     100.53 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1727.30 ms /   128 tokens (   13.49 ms per token,    74.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1742.63 ms /   129 tokens
...
I believe the
llama_print_timings:        load time =     219.07 ms
llama_print_timings:      sample time =       2.18 ms /    64 runs   (    0.03 ms per token, 29371.27 tokens per second)
llama_print_timings: prompt eval time =     139.21 ms /     8 tokens (   17.40 ms per token,    57.47 tokens per second)
llama_print_timings:        eval time =    2121.08 ms /    63 runs   (   33.67 ms per token,    29.70 tokens per second)
llama_print_timings:       total time =    2287.89 ms /    71 tokens
Log end
...
[1]9.5581,
llama_print_timings:        load time =     118.83 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2033.51 ms /   128 tokens (   15.89 ms per token,    62.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2049.40 ms /   129 tokens
...
llama_print_timings:        eval time =    2219.53 ms /    63 runs   (   35.23 ms per token,    28.38 tokens per second)
llama_print_timings:       total time =    2376.57 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1851.49 ms /   128 tokens (   14.46 ms per token,    69.13 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1867.12 ms /   129 tokens
...
llama_new_context_with_model: graph nodes  = 967
llama_new_context_with_model: graph splits = 1
main : serialized state into 1191130 out of a maximum of 814850136 bytes
llama_new_context_with_model: n_ctx      = 2048
llama_new_context_with_model: n_batch    = 2048
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: flash_attn = 0
...
llama_new_context_with_model: graph nodes  = 967
llama_new_context_with_model: graph splits = 1
main : deserialized state from 1191130 out of a maximum of 814850136 bytes
llama_new_context_with_model: n_ctx      = 2048
llama_new_context_with_model: n_batch    = 2048
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: flash_attn = 0
...
first run: The quick brown fox jumped over the lazy dog. Dorothy starts lamenting for her lost golden retri


second run: The quick brown fox jumped over the lazy dog. Dorothy starts lamenting for her lost golden retri


single seq run: The quick brown fox jumped over the lazy dog. Dorothy starts lamenting for her lost golden retri
...
first run: The quick brown fox jumps. Results

One possible explanation for why Pokémon Go going viral is because


second run: The quick brown fox jumps. Results

One possible explanation for why Pokémon Go going viral is because


single seq run: The quick brown fox jumps. Results
...
1.19user 0.23system 0:01.43elapsed 99%CPU (0avgtext+0avgdata 2897980maxresident)k
0inputs+40outputs (0major+60585minor)pagefaults 0swaps
```
...
0.23user 0.22system 0:00.46elapsed 99%CPU (0avgtext+0avgdata 2897440maxresident)k
0inputs+40outputs (0major+61586minor)pagefaults 0swaps
```
