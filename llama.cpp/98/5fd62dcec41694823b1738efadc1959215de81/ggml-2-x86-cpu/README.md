...
- status:  FAILURE ❌ (2)
- runtime: 4:34.58
- date:    Sun Feb 18 20:21:58 UTC 2024
...
Label Time Summary:
main    = 139.53 sec*proc (20 tests)

Total Test time (real) = 139.56 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       4.51 ms /     9 tokens (    0.50 ms per token,  1994.24 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
