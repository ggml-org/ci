...
- status:  SUCCESS ✅
- runtime: 4:21.05
- date:    Fri Nov 29 20:59:31 UTC 2024
...
0.00.000.721 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.019.619 I llm_load_vocab: special tokens cache size = 5
...
0.00.022.262 I llm_load_print_meta: n_ctx_train      = 512
0.00.022.262 I llm_load_print_meta: n_embd           = 384
0.00.022.262 I llm_load_print_meta: n_layer          = 12
0.00.022.271 I llm_load_print_meta: n_head           = 12
0.00.022.272 I llm_load_print_meta: n_head_kv        = 12
0.00.022.272 I llm_load_print_meta: n_rot            = 32
0.00.022.273 I llm_load_print_meta: n_swa            = 0
0.00.022.273 I llm_load_print_meta: n_embd_head_k    = 32
0.00.022.273 I llm_load_print_meta: n_embd_head_v    = 32
0.00.022.274 I llm_load_print_meta: n_gqa            = 1
0.00.022.275 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.022.276 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.022.277 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.022.277 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.022.277 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.022.278 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.022.278 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.022.279 I llm_load_print_meta: n_ff             = 1536
0.00.022.280 I llm_load_print_meta: n_expert         = 0
0.00.022.280 I llm_load_print_meta: n_expert_used    = 0
0.00.022.280 I llm_load_print_meta: causal attn      = 0
0.00.022.280 I llm_load_print_meta: pooling type     = 2
0.00.022.281 I llm_load_print_meta: rope type        = 2
0.00.022.282 I llm_load_print_meta: rope scaling     = linear
0.00.022.283 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.022.284 I llm_load_print_meta: freq_scale_train = 1
0.00.022.285 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.022.285 I llm_load_print_meta: rope_finetuned   = unknown
0.00.022.286 I llm_load_print_meta: ssm_d_conv       = 0
0.00.022.286 I llm_load_print_meta: ssm_d_inner      = 0
0.00.022.286 I llm_load_print_meta: ssm_d_state      = 0
0.00.022.287 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.022.287 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.022.288 I llm_load_print_meta: model type       = 33M
0.00.022.289 I llm_load_print_meta: model ftype      = F16
0.00.022.289 I llm_load_print_meta: model params     = 33.21 M
0.00.022.291 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.022.291 I llm_load_print_meta: general.name     = Bge Small
0.00.022.292 I llm_load_print_meta: UNK token        = 100 '[UNK]'
...
0.00.022.307 I llm_load_print_meta: max token length = 21
0.00.026.607 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.026.622 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.041.242 I llama_new_context_with_model: n_seq_max     = 1
0.00.041.257 I llama_new_context_with_model: n_ctx         = 512
0.00.041.257 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.041.258 I llama_new_context_with_model: n_batch       = 2048
0.00.041.259 I llama_new_context_with_model: n_ubatch      = 2048
0.00.041.259 I llama_new_context_with_model: flash_attn    = 0
0.00.041.262 I llama_new_context_with_model: freq_base     = 10000.0
0.00.041.263 I llama_new_context_with_model: freq_scale    = 1
0.00.043.386 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.043.414 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.043.421 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.045.585 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.045.604 I llama_new_context_with_model: graph nodes  = 429
0.00.045.604 I llama_new_context_with_model: graph splits = 1
0.00.045.607 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.049.175 I 
0.00.049.267 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.051.064 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.055.243 I llama_perf_context_print:        load time =      48.41 ms
0.00.055.244 I llama_perf_context_print: prompt eval time =       3.96 ms /     9 tokens (    0.44 ms per token,  2273.88 tokens per second)
0.00.055.245 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.055.245 I llama_perf_context_print:       total time =       6.07 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.737 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.910 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
0.00.003.932 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.003.943 I llama_model_loader: - kv   0:                       general.architecture str              = bert
0.00.003.944 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.003.945 I llama_model_loader: - kv   2:                               general.name str              = Bge Small
0.00.003.945 I llama_model_loader: - kv   3:                           general.basename str              = bge
0.00.003.945 I llama_model_loader: - kv   4:                         general.size_label str              = small
0.00.003.950 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
0.00.003.950 I llama_model_loader: - kv   6:                        bert.context_length u32              = 512
0.00.003.951 I llama_model_loader: - kv   7:                      bert.embedding_length u32              = 384
0.00.003.951 I llama_model_loader: - kv   8:                   bert.feed_forward_length u32              = 1536
0.00.003.951 I llama_model_loader: - kv   9:                  bert.attention.head_count u32              = 12
0.00.003.955 I llama_model_loader: - kv  10:          bert.attention.layer_norm_epsilon f32              = 0.000000
0.00.003.956 I llama_model_loader: - kv  11:                          general.file_type u32              = 7
0.00.003.956 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
0.00.003.957 I llama_model_loader: - kv  13:                          bert.pooling_type u32              = 2
0.00.003.957 I llama_model_loader: - kv  14:            tokenizer.ggml.token_type_count u32              = 2
0.00.003.957 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
0.00.003.958 I llama_model_loader: - kv  16:                         tokenizer.ggml.pre str              = jina-v2-en
...
0.00.019.131 I llm_load_vocab: special tokens cache size = 5
0.00.021.613 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.641 I llm_load_print_meta: format           = GGUF V3 (latest)
...
0.00.021.653 I llm_load_print_meta: n_head           = 12
0.00.021.654 I llm_load_print_meta: n_head_kv        = 12
0.00.021.654 I llm_load_print_meta: n_rot            = 32
...
0.00.021.658 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.658 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.658 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.659 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.659 I llm_load_print_meta: n_ff             = 1536
0.00.021.660 I llm_load_print_meta: n_expert         = 0
0.00.021.660 I llm_load_print_meta: n_expert_used    = 0
0.00.021.660 I llm_load_print_meta: causal attn      = 0
0.00.021.660 I llm_load_print_meta: pooling type     = 2
0.00.021.660 I llm_load_print_meta: rope type        = 2
0.00.021.660 I llm_load_print_meta: rope scaling     = linear
0.00.021.662 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.662 I llm_load_print_meta: freq_scale_train = 1
0.00.021.662 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.662 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.662 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.663 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.664 I llm_load_print_meta: ssm_d_state      = 0
...
0.00.021.667 I llm_load_print_meta: model params     = 33.21 M
0.00.021.668 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.021.668 I llm_load_print_meta: general.name     = Bge Small
0.00.021.669 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.669 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.669 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.670 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.671 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.671 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.671 I llm_load_print_meta: max token length = 21
0.00.024.294 I llm_load_tensors:          AMX model buffer size =    24.05 MiB
0.00.024.310 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.032.500 I llama_new_context_with_model: n_seq_max     = 1
0.00.032.515 I llama_new_context_with_model: n_ctx         = 512
0.00.032.515 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.032.515 I llama_new_context_with_model: n_batch       = 2048
0.00.032.516 I llama_new_context_with_model: n_ubatch      = 2048
0.00.032.516 I llama_new_context_with_model: flash_attn    = 0
0.00.032.517 I llama_new_context_with_model: freq_base     = 10000.0
0.00.032.518 I llama_new_context_with_model: freq_scale    = 1
0.00.034.174 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.034.199 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.034.206 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.036.184 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.036.204 I llama_new_context_with_model: graph nodes  = 429
0.00.036.205 I llama_new_context_with_model: graph splits = 1
0.00.036.206 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.038.674 I 
0.00.038.748 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.040.280 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.042.364 I llama_perf_context_print:        load time =      37.89 ms
0.00.042.365 I llama_perf_context_print: prompt eval time =       1.89 ms /     9 tokens (    0.21 ms per token,  4772.00 tokens per second)
0.00.042.366 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.042.366 I llama_perf_context_print:       total time =       3.69 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.633 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.432 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
...
0.00.014.370 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.015.825 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.387 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.406 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.406 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.407 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.407 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.408 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.408 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.409 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.409 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.409 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.410 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.410 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.413 I llama_model_loader: - type  f32:   41 tensors
0.00.019.414 I llama_model_loader: - type  f16:   29 tensors
0.00.037.379 W llm_load_vocab: empty token at index 5
0.00.047.710 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.450 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.581 I llm_load_vocab: special tokens cache size = 5
0.00.342.886 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.342.908 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.342.909 I llm_load_print_meta: arch             = jina-bert-v2
0.00.342.909 I llm_load_print_meta: vocab type       = BPE
0.00.342.910 I llm_load_print_meta: n_vocab          = 61056
0.00.342.910 I llm_load_print_meta: n_merges         = 39382
0.00.342.911 I llm_load_print_meta: vocab_only       = 0
0.00.342.911 I llm_load_print_meta: n_ctx_train      = 8192
0.00.342.911 I llm_load_print_meta: n_embd           = 384
0.00.342.912 I llm_load_print_meta: n_layer          = 4
0.00.342.920 I llm_load_print_meta: n_head           = 12
0.00.342.921 I llm_load_print_meta: n_head_kv        = 12
0.00.342.921 I llm_load_print_meta: n_rot            = 32
0.00.342.922 I llm_load_print_meta: n_swa            = 0
0.00.342.922 I llm_load_print_meta: n_embd_head_k    = 32
0.00.342.922 I llm_load_print_meta: n_embd_head_v    = 32
0.00.342.923 I llm_load_print_meta: n_gqa            = 1
0.00.342.924 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.342.924 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.342.926 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.342.926 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.342.927 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.342.927 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.342.928 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.342.928 I llm_load_print_meta: n_ff             = 1536
0.00.342.929 I llm_load_print_meta: n_expert         = 0
0.00.342.929 I llm_load_print_meta: n_expert_used    = 0
0.00.342.930 I llm_load_print_meta: causal attn      = 0
0.00.342.930 I llm_load_print_meta: pooling type     = -1
0.00.342.930 I llm_load_print_meta: rope type        = -1
0.00.342.931 I llm_load_print_meta: rope scaling     = linear
0.00.342.932 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.342.932 I llm_load_print_meta: freq_scale_train = 1
0.00.342.933 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.342.933 I llm_load_print_meta: rope_finetuned   = unknown
0.00.342.934 I llm_load_print_meta: ssm_d_conv       = 0
0.00.342.934 I llm_load_print_meta: ssm_d_inner      = 0
0.00.342.934 I llm_load_print_meta: ssm_d_state      = 0
0.00.342.934 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.342.935 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.342.935 I llm_load_print_meta: model type       = 33M
0.00.342.936 I llm_load_print_meta: model ftype      = F16
0.00.342.937 I llm_load_print_meta: model params     = 32.90 M
0.00.342.938 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.342.938 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.342.939 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.342.939 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.342.939 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.342.940 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.342.940 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.342.940 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.342.941 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.342.941 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.342.942 I llm_load_print_meta: max token length = 45
0.00.346.097 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.346.119 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.353.873 I llama_new_context_with_model: n_seq_max     = 1
0.00.353.896 I llama_new_context_with_model: n_ctx         = 8192
0.00.353.897 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.353.897 I llama_new_context_with_model: n_batch       = 2048
0.00.353.897 I llama_new_context_with_model: n_ubatch      = 2048
0.00.353.897 I llama_new_context_with_model: flash_attn    = 0
0.00.353.899 I llama_new_context_with_model: freq_base     = 10000.0
0.00.353.900 I llama_new_context_with_model: freq_scale    = 1
0.00.362.839 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.362.860 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.362.868 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.364.137 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.364.158 I llama_new_context_with_model: graph nodes  = 154
0.00.364.159 I llama_new_context_with_model: graph splits = 1
0.00.364.161 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.372.282 I 
0.00.372.367 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.372.563 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.372.575 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.372.581 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.372.581 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.372.586 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.372.586 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.376.513 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.384.137 I llama_perf_context_print:        load time =     371.61 ms
0.00.384.140 I llama_perf_context_print: prompt eval time =       7.46 ms /    62 tokens (    0.12 ms per token,  8310.99 tokens per second)
0.00.384.141 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.384.142 I llama_perf_context_print:       total time =      11.86 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.650 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.613 I llama_model_loader: - type  f16:   98 tensors
...
0.00.075.982 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.983 I llm_load_print_meta: model params     = 1.41 B
0.00.075.984 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.199.629 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.199.647 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.989.890 I llama_new_context_with_model: n_seq_max     = 1
0.00.989.911 I llama_new_context_with_model: n_ctx         = 2048
0.00.989.911 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.989.911 I llama_new_context_with_model: n_batch       = 2048
0.00.989.912 I llama_new_context_with_model: n_ubatch      = 512
0.00.989.912 I llama_new_context_with_model: flash_attn    = 0
0.00.989.917 I llama_new_context_with_model: freq_base     = 10000.0
0.00.989.918 I llama_new_context_with_model: freq_scale    = 1
0.01.058.627 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.058.657 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.058.692 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.060.961 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.01.060.985 I llama_new_context_with_model: graph nodes  = 967
0.01.060.985 I llama_new_context_with_model: graph splits = 1
0.01.060.990 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.160.407 I main: llama threadpool init, n_threads = 4
0.01.160.437 I 
0.01.160.519 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.160.519 I 
0.01.160.653 I sampler seed: 1234
0.01.160.675 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.160.677 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.160.678 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.160.678 I 
...
0.04.942.305 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31113.06 tokens per second)
0.04.942.308 I llama_perf_context_print:        load time =    1159.48 ms
0.04.942.309 I llama_perf_context_print: prompt eval time =      94.83 ms /     7 tokens (   13.55 ms per token,    73.82 tokens per second)
0.04.942.310 I llama_perf_context_print:        eval time =    3675.49 ms /    63 runs   (   58.34 ms per token,    17.14 tokens per second)
0.04.942.311 I llama_perf_context_print:       total time =    3781.90 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.717 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.099 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.076.100 I llm_load_print_meta: arch             = gptneox
0.00.076.101 I llm_load_print_meta: vocab type       = BPE
0.00.076.101 I llm_load_print_meta: n_vocab          = 50304
0.00.076.101 I llm_load_print_meta: n_merges         = 50009
0.00.076.102 I llm_load_print_meta: vocab_only       = 0
0.00.076.102 I llm_load_print_meta: n_ctx_train      = 2048
0.00.076.102 I llm_load_print_meta: n_embd           = 2048
0.00.076.103 I llm_load_print_meta: n_layer          = 24
...
0.00.076.116 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.076.117 I llm_load_print_meta: n_embd_v_gqa     = 2048
...
0.00.076.129 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.130 I llm_load_print_meta: model params     = 1.41 B
0.00.076.131 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.200.772 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.200.790 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.996.904 I llama_new_context_with_model: n_seq_max     = 1
0.00.996.927 I llama_new_context_with_model: n_ctx         = 128
0.00.996.927 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.996.928 I llama_new_context_with_model: n_batch       = 128
0.00.996.928 I llama_new_context_with_model: n_ubatch      = 128
0.00.996.929 I llama_new_context_with_model: flash_attn    = 0
0.00.996.934 I llama_new_context_with_model: freq_base     = 10000.0
0.00.996.935 I llama_new_context_with_model: freq_scale    = 1
0.00.996.936 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.001.784 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.001.812 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.001.835 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.004.098 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.01.004.114 I llama_new_context_with_model: graph nodes  = 967
0.01.004.114 I llama_new_context_with_model: graph splits = 1
0.01.004.117 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.070.071 I 
0.01.070.185 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.070.194 I perplexity: tokenizing the input ..
0.01.079.665 I perplexity: tokenization took 9.466 ms
0.01.079.699 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.961.536 I perplexity: 0.88 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.965.126 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.965.176 I llama_perf_context_print:        load time =    1069.31 ms
0.01.965.178 I llama_perf_context_print: prompt eval time =     880.07 ms /   128 tokens (    6.88 ms per token,   145.44 tokens per second)
0.01.965.180 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.965.181 I llama_perf_context_print:       total time =     895.10 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.656 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.220 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.170.436 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.170.456 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.629.078 I llama_new_context_with_model: n_seq_max     = 1
0.00.629.101 I llama_new_context_with_model: n_ctx         = 2048
0.00.629.101 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.629.102 I llama_new_context_with_model: n_batch       = 2048
0.00.629.102 I llama_new_context_with_model: n_ubatch      = 512
0.00.629.103 I llama_new_context_with_model: flash_attn    = 0
0.00.629.107 I llama_new_context_with_model: freq_base     = 10000.0
0.00.629.108 I llama_new_context_with_model: freq_scale    = 1
0.00.697.108 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.697.138 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.697.172 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.699.558 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.699.574 I llama_new_context_with_model: graph nodes  = 967
0.00.699.574 I llama_new_context_with_model: graph splits = 1
0.00.699.579 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.778.353 I main: llama threadpool init, n_threads = 4
0.00.778.384 I 
0.00.778.469 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.778.482 I 
0.00.778.613 I sampler seed: 1234
0.00.778.632 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.778.635 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.778.636 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.778.636 I 
...
0.02.981.591 I llama_perf_sampler_print:    sampling time =       2.23 ms /    71 runs   (    0.03 ms per token, 31867.15 tokens per second)
0.02.981.594 I llama_perf_context_print:        load time =     777.44 ms
0.02.981.595 I llama_perf_context_print: prompt eval time =      50.38 ms /     7 tokens (    7.20 ms per token,   138.93 tokens per second)
0.02.981.597 I llama_perf_context_print:        eval time =    2141.38 ms /    63 runs   (   33.99 ms per token,    29.42 tokens per second)
0.02.981.597 I llama_perf_context_print:       total time =    2203.24 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.642 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.905 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.906 I llm_load_print_meta: model params     = 1.41 B
0.00.075.907 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.075.909 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
...
...............................................................................
0.00.616.313 I llama_new_context_with_model: n_seq_max     = 1
0.00.616.336 I llama_new_context_with_model: n_ctx         = 128
0.00.616.336 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.616.337 I llama_new_context_with_model: n_batch       = 128
0.00.616.337 I llama_new_context_with_model: n_ubatch      = 128
0.00.616.338 I llama_new_context_with_model: flash_attn    = 0
0.00.616.341 I llama_new_context_with_model: freq_base     = 10000.0
0.00.616.342 I llama_new_context_with_model: freq_scale    = 1
0.00.616.343 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.621.158 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.621.184 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.621.207 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.623.325 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.623.347 I llama_new_context_with_model: graph nodes  = 967
0.00.623.348 I llama_new_context_with_model: graph splits = 1
0.00.623.350 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.667.930 I 
0.00.668.052 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.668.061 I perplexity: tokenizing the input ..
0.00.677.474 I perplexity: tokenization took 9.407 ms
0.00.677.508 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.053.050 I perplexity: 0.38 seconds per pass - ETA 0.00 minutes
[1]10.1288,
0.01.056.997 I Final estimate: PPL = 10.1288 +/- 3.22324

0.01.057.040 I llama_perf_context_print:        load time =     667.25 ms
0.01.057.043 I llama_perf_context_print: prompt eval time =     373.75 ms /   128 tokens (    2.92 ms per token,   342.47 tokens per second)
0.01.057.045 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.057.046 I llama_perf_context_print:       total time =     389.11 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.676 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.898 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
...
0.00.075.158 I llm_load_print_meta: n_expert_used    = 0
...
0.00.075.161 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.075.161 I llm_load_print_meta: rope_finetuned   = unknown
0.00.075.162 I llm_load_print_meta: ssm_d_conv       = 0
0.00.075.162 I llm_load_print_meta: ssm_d_inner      = 0
...
0.00.075.163 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.164 I llm_load_print_meta: model params     = 1.41 B
0.00.075.165 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.897 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.125.917 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.405.925 I llama_new_context_with_model: n_seq_max     = 1
0.00.405.948 I llama_new_context_with_model: n_ctx         = 2048
0.00.405.948 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.405.949 I llama_new_context_with_model: n_batch       = 2048
0.00.405.949 I llama_new_context_with_model: n_ubatch      = 512
0.00.405.950 I llama_new_context_with_model: flash_attn    = 0
0.00.405.954 I llama_new_context_with_model: freq_base     = 10000.0
0.00.405.954 I llama_new_context_with_model: freq_scale    = 1
0.00.474.206 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.474.237 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.474.269 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.476.489 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.476.509 I llama_new_context_with_model: graph nodes  = 967
0.00.476.509 I llama_new_context_with_model: graph splits = 1
0.00.476.514 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.553.097 I main: llama threadpool init, n_threads = 4
0.00.553.127 I 
0.00.553.215 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.553.215 I 
0.00.553.352 I sampler seed: 1234
0.00.553.372 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.553.376 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.553.376 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.553.376 I 
I believe the meaning of life is to know myself. It is to be able to say, “I am a person, I am a mother, a daughter, a sister, a friend, a mother of friends, a sister of sisters, and a sister of all the mothers.” It is to be able to say, “I am a human being

0.01.949.017 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31485.59 tokens per second)
0.01.949.020 I llama_perf_context_print:        load time =     552.17 ms
0.01.949.021 I llama_perf_context_print: prompt eval time =      44.96 ms /     7 tokens (    6.42 ms per token,   155.69 tokens per second)
0.01.949.022 I llama_perf_context_print:        eval time =    1339.96 ms /    63 runs   (   21.27 ms per token,    47.02 tokens per second)
0.01.949.023 I llama_perf_context_print:       total time =    1395.93 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.703 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.711 I llm_load_print_meta: n_embd_head_k    = 128
...
0.00.075.726 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.727 I llm_load_print_meta: model params     = 1.41 B
0.00.075.728 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.225 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.125.242 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.406.551 I llama_new_context_with_model: n_seq_max     = 1
0.00.406.573 I llama_new_context_with_model: n_ctx         = 128
0.00.406.573 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.406.573 I llama_new_context_with_model: n_batch       = 128
0.00.406.574 I llama_new_context_with_model: n_ubatch      = 128
0.00.406.575 I llama_new_context_with_model: flash_attn    = 0
0.00.406.580 I llama_new_context_with_model: freq_base     = 10000.0
0.00.406.581 I llama_new_context_with_model: freq_scale    = 1
0.00.406.581 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.411.417 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.411.446 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.411.469 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.414.280 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.414.299 I llama_new_context_with_model: graph nodes  = 967
0.00.414.299 I llama_new_context_with_model: graph splits = 1
0.00.414.301 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.457.497 I 
0.00.457.610 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.457.619 I perplexity: tokenizing the input ..
0.00.467.089 I perplexity: tokenization took 9.465 ms
0.00.467.130 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.885.661 I perplexity: 0.42 seconds per pass - ETA 0.00 minutes
[1]14.0715,
0.00.889.497 I Final estimate: PPL = 14.0715 +/- 4.41015

0.00.889.538 I llama_perf_context_print:        load time =     456.75 ms
0.00.889.552 I llama_perf_context_print: prompt eval time =     416.67 ms /   128 tokens (    3.26 ms per token,   307.19 tokens per second)
0.00.889.553 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.889.554 I llama_perf_context_print:       total time =     432.04 ms /   129 tokens
...
0.00.021.586 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
...
0.00.076.952 I llm_load_print_meta: n_gqa            = 1
0.00.076.953 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.076.953 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.076.955 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.076.955 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.076.956 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.076.956 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.076.956 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.076.957 I llm_load_print_meta: n_ff             = 8192
0.00.076.957 I llm_load_print_meta: n_expert         = 0
0.00.076.958 I llm_load_print_meta: n_expert_used    = 0
0.00.076.958 I llm_load_print_meta: causal attn      = 1
0.00.076.958 I llm_load_print_meta: pooling type     = 0
0.00.076.959 I llm_load_print_meta: rope type        = 2
0.00.076.959 I llm_load_print_meta: rope scaling     = linear
0.00.076.960 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.076.961 I llm_load_print_meta: freq_scale_train = 1
0.00.076.961 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
...
0.00.076.963 I llm_load_print_meta: model type       = 1.4B
0.00.076.964 I llm_load_print_meta: model ftype      = Q4_1
0.00.076.965 I llm_load_print_meta: model params     = 1.41 B
0.00.076.966 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
0.00.076.966 I llm_load_print_meta: general.name     = 1.4B
0.00.076.966 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.076.967 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.076.967 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.076.967 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.076.968 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.968 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.968 I llm_load_print_meta: max token length = 1024
0.00.133.763 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.133.782 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.441.305 I llama_new_context_with_model: n_seq_max     = 1
0.00.441.328 I llama_new_context_with_model: n_ctx         = 2048
0.00.441.328 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.441.329 I llama_new_context_with_model: n_batch       = 2048
0.00.441.329 I llama_new_context_with_model: n_ubatch      = 512
0.00.441.330 I llama_new_context_with_model: flash_attn    = 0
0.00.441.334 I llama_new_context_with_model: freq_base     = 10000.0
0.00.441.335 I llama_new_context_with_model: freq_scale    = 1
0.00.511.671 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.511.701 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.511.736 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.514.061 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.514.085 I llama_new_context_with_model: graph nodes  = 967
0.00.514.085 I llama_new_context_with_model: graph splits = 1
0.00.514.090 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.589.548 I main: llama threadpool init, n_threads = 4
0.00.589.579 I 
0.00.589.663 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.589.663 I 
0.00.589.790 I sampler seed: 1234
0.00.589.811 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.589.815 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.589.815 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.589.816 I 
...
0.02.097.161 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31696.43 tokens per second)
0.02.097.164 I llama_perf_context_print:        load time =     588.90 ms
0.02.097.165 I llama_perf_context_print: prompt eval time =      42.36 ms /     7 tokens (    6.05 ms per token,   165.24 tokens per second)
0.02.097.166 I llama_perf_context_print:        eval time =    1453.95 ms /    63 runs   (   23.08 ms per token,    43.33 tokens per second)
0.02.097.167 I llama_perf_context_print:       total time =    1507.62 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.641 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.373 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.075.381 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.382 I llm_load_print_meta: model params     = 1.41 B
0.00.075.383 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.202 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.130.220 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.443.161 I llama_new_context_with_model: n_seq_max     = 1
0.00.443.183 I llama_new_context_with_model: n_ctx         = 128
0.00.443.184 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.443.184 I llama_new_context_with_model: n_batch       = 128
0.00.443.184 I llama_new_context_with_model: n_ubatch      = 128
0.00.443.185 I llama_new_context_with_model: flash_attn    = 0
0.00.443.190 I llama_new_context_with_model: freq_base     = 10000.0
0.00.443.191 I llama_new_context_with_model: freq_scale    = 1
0.00.443.191 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.448.440 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.448.469 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.448.495 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.450.696 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.450.718 I llama_new_context_with_model: graph nodes  = 967
0.00.450.719 I llama_new_context_with_model: graph splits = 1
0.00.450.721 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.491.693 I 
0.00.491.823 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.491.856 I perplexity: tokenizing the input ..
0.00.501.426 I perplexity: tokenization took 9.567 ms
0.00.501.462 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.944.532 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]12.5781,
0.00.948.264 I Final estimate: PPL = 12.5781 +/- 3.87222

0.00.948.311 I llama_perf_context_print:        load time =     490.96 ms
0.00.948.313 I llama_perf_context_print: prompt eval time =     441.26 ms /   128 tokens (    3.45 ms per token,   290.08 tokens per second)
0.00.948.315 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.948.317 I llama_perf_context_print:       total time =     456.62 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.640 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.352 I llm_load_print_meta: n_swa            = 0
...
0.00.076.366 I llm_load_print_meta: model ftype      = Q5_0
0.00.076.366 I llm_load_print_meta: model params     = 1.41 B
0.00.076.367 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.136.382 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.136.399 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.172.342 I llama_new_context_with_model: n_seq_max     = 1
0.00.172.364 I llama_new_context_with_model: n_ctx         = 2048
0.00.172.364 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.172.365 I llama_new_context_with_model: n_batch       = 2048
0.00.172.365 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.241.692 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.241.716 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.241.744 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.244.056 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.244.076 I llama_new_context_with_model: graph nodes  = 967
0.00.244.077 I llama_new_context_with_model: graph splits = 1
0.00.244.081 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.354.238 I main: llama threadpool init, n_threads = 4
0.00.354.268 I 
0.00.354.343 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.354.356 I 
0.00.354.529 I sampler seed: 1234
0.00.354.548 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.354.552 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.354.553 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.354.553 I 
I believe the meaning of life is to do what is best for your self, and to be happy, and to enjoy the present moment, and to let go of the past, and to enjoy the moment, and to enjoy the life you have here on Earth." The words are spoken in a calm, measured tone, but the message is clear: it

0.02.679.824 I llama_perf_sampler_print:    sampling time =       2.39 ms /    71 runs   (    0.03 ms per token, 29769.39 tokens per second)
0.02.679.827 I llama_perf_context_print:        load time =     353.33 ms
0.02.679.829 I llama_perf_context_print: prompt eval time =     126.01 ms /     7 tokens (   18.00 ms per token,    55.55 tokens per second)
0.02.679.831 I llama_perf_context_print:        eval time =    2187.30 ms /    63 runs   (   34.72 ms per token,    28.80 tokens per second)
0.02.679.832 I llama_perf_context_print:       total time =    2325.59 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.394 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.232 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.075.836 I llm_load_print_meta: model ftype      = Q5_0
...
0.00.135.752 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.135.773 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.171.789 I llama_new_context_with_model: n_seq_max     = 1
0.00.171.812 I llama_new_context_with_model: n_ctx         = 128
0.00.171.812 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.171.812 I llama_new_context_with_model: n_batch       = 128
0.00.171.813 I llama_new_context_with_model: n_ubatch      = 128
0.00.171.813 I llama_new_context_with_model: flash_attn    = 0
0.00.171.816 I llama_new_context_with_model: freq_base     = 10000.0
0.00.171.817 I llama_new_context_with_model: freq_scale    = 1
0.00.171.818 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
...
0.00.176.923 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.179.558 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.179.581 I llama_new_context_with_model: graph nodes  = 967
0.00.179.582 I llama_new_context_with_model: graph splits = 1
0.00.179.584 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.253.742 I 
0.00.253.846 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.253.854 I perplexity: tokenizing the input ..
0.00.263.111 I perplexity: tokenization took 9.253 ms
0.00.263.145 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.353.831 I perplexity: 1.09 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.357.767 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.357.809 I llama_perf_context_print:        load time =     253.31 ms
0.01.357.823 I llama_perf_context_print: prompt eval time =    1088.96 ms /   128 tokens (    8.51 ms per token,   117.54 tokens per second)
0.01.357.825 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.357.826 I llama_perf_context_print:       total time =    1104.07 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.743 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.141.807 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.141.826 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.178.142 I llama_new_context_with_model: n_seq_max     = 1
0.00.178.165 I llama_new_context_with_model: n_ctx         = 2048
0.00.178.166 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.178.170 I llama_new_context_with_model: freq_base     = 10000.0
0.00.178.171 I llama_new_context_with_model: freq_scale    = 1
0.00.247.830 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.247.858 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.247.882 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.250.078 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.250.105 I llama_new_context_with_model: graph nodes  = 967
0.00.250.105 I llama_new_context_with_model: graph splits = 1
0.00.250.109 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.340.302 I main: llama threadpool init, n_threads = 4
0.00.340.333 I 
0.00.340.456 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.340.456 I 
0.00.340.597 I sampler seed: 1234
0.00.340.621 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
...
0.02.764.289 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31583.63 tokens per second)
0.02.764.292 I llama_perf_context_print:        load time =     339.29 ms
0.02.764.294 I llama_perf_context_print: prompt eval time =     121.48 ms /     7 tokens (   17.35 ms per token,    57.62 tokens per second)
0.02.764.295 I llama_perf_context_print:        eval time =    2291.12 ms /    63 runs   (   36.37 ms per token,    27.50 tokens per second)
0.02.764.295 I llama_perf_context_print:       total time =    2424.00 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.573 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.694 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.695 I llm_load_print_meta: model params     = 1.41 B
0.00.075.696 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.141.075 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.141.096 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.176.557 I llama_new_context_with_model: n_seq_max     = 1
0.00.176.579 I llama_new_context_with_model: n_ctx         = 128
0.00.176.579 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.176.579 I llama_new_context_with_model: n_batch       = 128
0.00.176.580 I llama_new_context_with_model: n_ubatch      = 128
0.00.176.580 I llama_new_context_with_model: flash_attn    = 0
0.00.176.584 I llama_new_context_with_model: freq_base     = 10000.0
0.00.176.585 I llama_new_context_with_model: freq_scale    = 1
0.00.176.585 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.181.386 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.181.408 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.181.429 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.183.455 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.183.476 I llama_new_context_with_model: graph nodes  = 967
0.00.183.477 I llama_new_context_with_model: graph splits = 1
0.00.183.479 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.245.868 I 
0.00.245.990 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.246.024 I perplexity: tokenizing the input ..
0.00.255.424 I perplexity: tokenization took 9.396 ms
0.00.255.461 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.161.013 I perplexity: 1.91 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.164.778 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.164.824 I llama_perf_context_print:        load time =     245.25 ms
0.02.164.827 I llama_perf_context_print: prompt eval time =    1903.84 ms /   128 tokens (   14.87 ms per token,    67.23 tokens per second)
0.02.164.828 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.164.829 I llama_perf_context_print:       total time =    1918.96 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.630 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.267 I llama_model_loader: - type q2_K:   49 tensors
...
0.00.076.346 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.076.347 I llm_load_print_meta: arch             = gptneox
0.00.076.347 I llm_load_print_meta: vocab type       = BPE
0.00.076.348 I llm_load_print_meta: n_vocab          = 50304
0.00.076.348 I llm_load_print_meta: n_merges         = 50009
0.00.076.348 I llm_load_print_meta: vocab_only       = 0
0.00.076.349 I llm_load_print_meta: n_ctx_train      = 2048
0.00.076.349 I llm_load_print_meta: n_embd           = 2048
...
0.00.076.360 I llm_load_print_meta: n_embd_head_k    = 128
...
0.00.076.384 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.385 I llm_load_print_meta: model params     = 1.41 B
0.00.076.386 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.111.647 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.111.666 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.147.393 I llama_new_context_with_model: n_seq_max     = 1
0.00.147.415 I llama_new_context_with_model: n_ctx         = 2048
0.00.147.415 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.147.416 I llama_new_context_with_model: n_batch       = 2048
0.00.147.416 I llama_new_context_with_model: n_ubatch      = 512
0.00.147.416 I llama_new_context_with_model: flash_attn    = 0
0.00.147.419 I llama_new_context_with_model: freq_base     = 10000.0
0.00.147.420 I llama_new_context_with_model: freq_scale    = 1
0.00.216.175 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.216.204 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
...
0.00.218.383 I llama_new_context_with_model: graph splits = 1
0.00.218.387 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.029 I main: llama threadpool init, n_threads = 4
0.00.290.060 I 
0.00.290.134 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.290.147 I 
0.00.290.269 I sampler seed: 1234
0.00.290.289 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.290.292 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.290.293 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.290.293 I 
I believe the meaning of life is a one-f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <

0.01.773.293 I llama_perf_sampler_print:    sampling time =       1.97 ms /    71 runs   (    0.03 ms per token, 36022.32 tokens per second)
0.01.773.296 I llama_perf_context_print:        load time =     289.16 ms
0.01.773.298 I llama_perf_context_print: prompt eval time =      79.43 ms /     7 tokens (   11.35 ms per token,    88.13 tokens per second)
0.01.773.300 I llama_perf_context_print:        eval time =    1392.73 ms /    63 runs   (   22.11 ms per token,    45.23 tokens per second)
0.01.773.301 I llama_perf_context_print:       total time =    1483.27 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.317 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.073 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.020.656 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.659 I llama_model_loader: - type  f32:  194 tensors
0.00.020.659 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.660 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.076.347 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.348 I llm_load_print_meta: model params     = 1.41 B
0.00.076.349 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.112.345 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.112.364 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.148.315 I llama_new_context_with_model: n_seq_max     = 1
0.00.148.337 I llama_new_context_with_model: n_ctx         = 128
0.00.148.337 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.148.338 I llama_new_context_with_model: n_batch       = 128
0.00.148.338 I llama_new_context_with_model: n_ubatch      = 128
0.00.148.338 I llama_new_context_with_model: flash_attn    = 0
0.00.148.342 I llama_new_context_with_model: freq_base     = 10000.0
0.00.148.342 I llama_new_context_with_model: freq_scale    = 1
0.00.148.343 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.153.761 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.153.789 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.153.815 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.156.465 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.156.490 I llama_new_context_with_model: graph nodes  = 967
...
0.00.197.785 I 
0.00.197.896 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.197.903 I perplexity: tokenizing the input ..
0.00.207.160 I perplexity: tokenization took 9.253 ms
0.00.207.195 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.462.464 I perplexity: 1.26 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.466.355 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.466.400 I llama_perf_context_print:        load time =     197.43 ms
0.01.466.414 I llama_perf_context_print: prompt eval time =    1253.56 ms /   128 tokens (    9.79 ms per token,   102.11 tokens per second)
0.01.466.415 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.466.416 I llama_perf_context_print:       total time =    1268.61 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.802 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.610 I llama_model_loader: - type q4_K:   71 tensors
...
0.00.076.954 I llm_load_print_meta: vocab type       = BPE
...
0.00.076.956 I llm_load_print_meta: n_layer          = 24
...
0.00.076.971 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.076.980 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.076.980 I llm_load_print_meta: model params     = 1.41 B
0.00.076.981 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
0.00.076.982 I llm_load_print_meta: general.name     = 1.4B
0.00.076.982 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.076.982 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
...
0.00.076.986 I llm_load_print_meta: max token length = 1024
0.00.124.956 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.124.972 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.326.815 I llama_new_context_with_model: n_seq_max     = 1
0.00.326.838 I llama_new_context_with_model: n_ctx         = 2048
0.00.326.838 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.326.838 I llama_new_context_with_model: n_batch       = 2048
0.00.326.838 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.396.162 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.396.193 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.396.224 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.398.447 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.398.471 I llama_new_context_with_model: graph nodes  = 967
0.00.398.471 I llama_new_context_with_model: graph splits = 1
0.00.398.476 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.478.709 I main: llama threadpool init, n_threads = 4
0.00.478.738 I 
0.00.478.814 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.478.827 I 
0.00.478.960 I sampler seed: 1234
0.00.478.980 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.478.983 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.478.983 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.478.983 I 
I believe the meaning of life is that one should never feel the need to be the best at anything, but rather, that one should be the best in whatever one does. This is a good philosophy, and I believe it to be a good basis for understanding how our lives are lived, as well as how we should live them.

It is

0.02.193.378 I llama_perf_sampler_print:    sampling time =       2.35 ms /    71 runs   (    0.03 ms per token, 30238.50 tokens per second)
0.02.193.381 I llama_perf_context_print:        load time =     477.64 ms
0.02.193.382 I llama_perf_context_print: prompt eval time =      70.90 ms /     7 tokens (   10.13 ms per token,    98.73 tokens per second)
0.02.193.383 I llama_perf_context_print:        eval time =    1632.33 ms /    63 runs   (   25.91 ms per token,    38.60 tokens per second)
0.02.193.383 I llama_perf_context_print:       total time =    1714.68 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.665 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.237 I llm_load_print_meta: model ftype      = Q3_K - Medium
...
0.00.122.876 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.122.894 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.321.989 I llama_new_context_with_model: n_seq_max     = 1
0.00.322.011 I llama_new_context_with_model: n_ctx         = 128
0.00.322.012 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.322.012 I llama_new_context_with_model: n_batch       = 128
0.00.322.012 I llama_new_context_with_model: n_ubatch      = 128
0.00.322.013 I llama_new_context_with_model: flash_attn    = 0
0.00.322.016 I llama_new_context_with_model: freq_base     = 10000.0
0.00.322.017 I llama_new_context_with_model: freq_scale    = 1
0.00.322.018 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.326.833 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.326.863 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.326.888 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.328.998 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.329.014 I llama_new_context_with_model: graph nodes  = 967
0.00.329.014 I llama_new_context_with_model: graph splits = 1
0.00.329.017 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.375.744 I 
0.00.375.874 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.375.902 I perplexity: tokenizing the input ..
0.00.385.399 I perplexity: tokenization took 9.5 ms
0.00.385.434 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.249.027 I perplexity: 0.86 seconds per pass - ETA 0.00 minutes
[1]12.3344,
0.01.252.682 I Final estimate: PPL = 12.3344 +/- 4.02919

0.01.252.728 I llama_perf_context_print:        load time =     375.04 ms
0.01.252.730 I llama_perf_context_print: prompt eval time =     861.67 ms /   128 tokens (    6.73 ms per token,   148.55 tokens per second)
0.01.252.732 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.252.732 I llama_perf_context_print:       total time =     876.98 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.794 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.304 I llm_load_vocab: token to piece cache size = 0.2984 MB
...
0.00.076.341 I llm_load_print_meta: n_embd_head_v    = 128
0.00.076.342 I llm_load_print_meta: n_gqa            = 1
0.00.076.343 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.076.344 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.076.345 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.076.354 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
...
0.00.076.356 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.076.359 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.359 I llm_load_print_meta: max token length = 1024
0.00.132.793 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.132.809 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.459.922 I llama_new_context_with_model: n_seq_max     = 1
0.00.459.944 I llama_new_context_with_model: n_ctx         = 2048
0.00.459.944 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.459.944 I llama_new_context_with_model: n_batch       = 2048
0.00.459.945 I llama_new_context_with_model: n_ubatch      = 512
0.00.459.946 I llama_new_context_with_model: flash_attn    = 0
0.00.459.951 I llama_new_context_with_model: freq_base     = 10000.0
0.00.459.952 I llama_new_context_with_model: freq_scale    = 1
0.00.528.362 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.528.389 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.528.424 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.531.191 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.531.216 I llama_new_context_with_model: graph nodes  = 967
0.00.531.216 I llama_new_context_with_model: graph splits = 1
0.00.531.221 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.614.973 I main: llama threadpool init, n_threads = 4
0.00.615.004 I 
0.00.615.087 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.615.102 I 
0.00.615.266 I sampler seed: 1234
0.00.615.285 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.615.288 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.615.289 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.615.289 I 
...
0.02.589.743 I llama_perf_sampler_print:    sampling time =       2.26 ms /    71 runs   (    0.03 ms per token, 31471.63 tokens per second)
0.02.589.746 I llama_perf_context_print:        load time =     613.89 ms
0.02.589.747 I llama_perf_context_print: prompt eval time =      60.76 ms /     7 tokens (    8.68 ms per token,   115.21 tokens per second)
0.02.589.748 I llama_perf_context_print:        eval time =    1902.68 ms /    63 runs   (   30.20 ms per token,    33.11 tokens per second)
0.02.589.749 I llama_perf_context_print:       total time =    1974.78 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.791 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.471 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
0.00.021.474 I llama_model_loader: - type  f32:  194 tensors
0.00.021.474 I llama_model_loader: - type q4_K:   61 tensors
0.00.021.475 I llama_model_loader: - type q5_K:   24 tensors
0.00.021.475 I llama_model_loader: - type q6_K:   13 tensors
...
0.00.075.990 I llm_load_print_meta: vocab_only       = 0
...
0.00.076.016 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.076.017 I llm_load_print_meta: model params     = 1.41 B
0.00.076.018 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.132.385 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.132.400 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.453.952 I llama_new_context_with_model: n_seq_max     = 1
0.00.453.974 I llama_new_context_with_model: n_ctx         = 128
0.00.453.974 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.453.974 I llama_new_context_with_model: n_batch       = 128
0.00.453.975 I llama_new_context_with_model: n_ubatch      = 128
0.00.453.975 I llama_new_context_with_model: flash_attn    = 0
0.00.453.980 I llama_new_context_with_model: freq_base     = 10000.0
0.00.453.981 I llama_new_context_with_model: freq_scale    = 1
0.00.453.982 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.458.740 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.458.767 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.458.793 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.460.937 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.460.956 I llama_new_context_with_model: graph nodes  = 967
0.00.460.956 I llama_new_context_with_model: graph splits = 1
0.00.460.959 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.510.949 I 
0.00.511.078 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.511.112 I perplexity: tokenizing the input ..
0.00.520.653 I perplexity: tokenization took 9.537 ms
0.00.520.687 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.068.717 I perplexity: 0.55 seconds per pass - ETA 0.00 minutes
[1]10.4776,
0.01.072.364 I Final estimate: PPL = 10.4776 +/- 3.36742

0.01.072.411 I llama_perf_context_print:        load time =     510.12 ms
0.01.072.438 I llama_perf_context_print: prompt eval time =     546.22 ms /   128 tokens (    4.27 ms per token,   234.34 tokens per second)
0.01.072.465 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.072.466 I llama_perf_context_print:       total time =     561.46 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.284 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.213 I llama_model_loader: - type q5_K:   61 tensors
0.00.021.213 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.076.152 I llm_load_print_meta: n_vocab          = 50304
...
0.00.076.180 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.076.180 I llm_load_print_meta: model params     = 1.41 B
0.00.076.181 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.137.317 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.137.334 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.519.019 I llama_new_context_with_model: n_seq_max     = 1
0.00.519.034 I llama_new_context_with_model: n_ctx         = 2048
0.00.519.035 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.519.035 I llama_new_context_with_model: n_batch       = 2048
0.00.519.035 I llama_new_context_with_model: n_ubatch      = 512
0.00.519.036 I llama_new_context_with_model: flash_attn    = 0
0.00.519.040 I llama_new_context_with_model: freq_base     = 10000.0
0.00.519.041 I llama_new_context_with_model: freq_scale    = 1
0.00.587.729 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.587.759 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.587.793 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.589.903 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.589.924 I llama_new_context_with_model: graph nodes  = 967
0.00.589.925 I llama_new_context_with_model: graph splits = 1
0.00.589.929 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.689.924 I main: llama threadpool init, n_threads = 4
0.00.689.955 I 
0.00.690.028 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.690.041 I 
0.00.690.178 I sampler seed: 1234
0.00.690.198 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.690.201 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.690.202 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.690.202 I 
I believe the meaning of life is to do the things we love, the things we are good at, the things we are good at doing, and the things that are good at doing. If we do those, we are happy. If we do not, then we are miserable, and we will do those things we hate the most.

I

0.03.126.139 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30563.93 tokens per second)
0.03.126.143 I llama_perf_context_print:        load time =     689.38 ms
0.03.126.144 I llama_perf_context_print: prompt eval time =      96.12 ms /     7 tokens (   13.73 ms per token,    72.82 tokens per second)
0.03.126.145 I llama_perf_context_print:        eval time =    2328.28 ms /    63 runs   (   36.96 ms per token,    27.06 tokens per second)
0.03.126.146 I llama_perf_context_print:       total time =    2436.22 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.322 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.829 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
0.00.020.832 I llama_model_loader: - type  f32:  194 tensors
0.00.020.832 I llama_model_loader: - type q5_K:   61 tensors
...
0.00.076.104 I llm_load_print_meta: n_head_kv        = 16
...
0.00.076.119 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.076.120 I llm_load_print_meta: model params     = 1.41 B
0.00.076.121 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.076.123 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.123 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.123 I llm_load_print_meta: max token length = 1024
0.00.136.661 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.136.677 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.514.373 I llama_new_context_with_model: n_seq_max     = 1
0.00.514.394 I llama_new_context_with_model: n_ctx         = 128
0.00.514.395 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.514.395 I llama_new_context_with_model: n_batch       = 128
0.00.514.395 I llama_new_context_with_model: n_ubatch      = 128
0.00.514.396 I llama_new_context_with_model: flash_attn    = 0
0.00.514.401 I llama_new_context_with_model: freq_base     = 10000.0
0.00.514.402 I llama_new_context_with_model: freq_scale    = 1
0.00.514.402 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.519.290 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.519.317 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.519.344 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.522.012 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.522.033 I llama_new_context_with_model: graph nodes  = 967
0.00.522.034 I llama_new_context_with_model: graph splits = 1
0.00.522.036 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.586.133 I 
0.00.586.264 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.586.299 I perplexity: tokenizing the input ..
0.00.595.869 I perplexity: tokenization took 9.565 ms
0.00.595.904 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.230.435 I perplexity: 0.63 seconds per pass - ETA 0.00 minutes
[1]10.6642,
0.01.234.530 I Final estimate: PPL = 10.6642 +/- 3.40033

0.01.234.572 I llama_perf_context_print:        load time =     585.77 ms
0.01.234.574 I llama_perf_context_print: prompt eval time =     632.63 ms /   128 tokens (    4.94 ms per token,   202.33 tokens per second)
0.01.234.575 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.234.575 I llama_perf_context_print:       total time =     648.44 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.734 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.136.104 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.136.125 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.535.057 I llama_new_context_with_model: n_seq_max     = 1
0.00.535.080 I llama_new_context_with_model: n_ctx         = 2048
0.00.535.080 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.535.081 I llama_new_context_with_model: n_batch       = 2048
0.00.535.081 I llama_new_context_with_model: n_ubatch      = 512
0.00.535.082 I llama_new_context_with_model: flash_attn    = 0
0.00.535.086 I llama_new_context_with_model: freq_base     = 10000.0
0.00.535.087 I llama_new_context_with_model: freq_scale    = 1
0.00.604.424 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.604.447 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.604.478 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.606.607 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.606.631 I llama_new_context_with_model: graph nodes  = 967
0.00.606.632 I llama_new_context_with_model: graph splits = 1
0.00.606.637 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.720.916 I main: llama threadpool init, n_threads = 4
0.00.720.947 I 
0.00.721.023 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.721.038 I 
0.00.721.179 I sampler seed: 1234
0.00.721.199 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.721.202 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.721.203 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.721.215 I 
...
0.03.283.000 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31332.74 tokens per second)
0.03.283.003 I llama_perf_context_print:        load time =     719.92 ms
0.03.283.005 I llama_perf_context_print: prompt eval time =     115.20 ms /     7 tokens (   16.46 ms per token,    60.76 tokens per second)
0.03.283.006 I llama_perf_context_print:        eval time =    2435.65 ms /    63 runs   (   38.66 ms per token,    25.87 tokens per second)
0.03.283.006 I llama_perf_context_print:       total time =    2562.09 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.673 I build: 4226 (7cc2d2c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.135.871 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.135.888 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.531.132 I llama_new_context_with_model: n_seq_max     = 1
0.00.531.154 I llama_new_context_with_model: n_ctx         = 128
0.00.531.154 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.531.155 I llama_new_context_with_model: n_batch       = 128
0.00.531.155 I llama_new_context_with_model: n_ubatch      = 128
0.00.531.156 I llama_new_context_with_model: flash_attn    = 0
0.00.531.160 I llama_new_context_with_model: freq_base     = 10000.0
0.00.531.161 I llama_new_context_with_model: freq_scale    = 1
0.00.531.162 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.536.058 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.536.087 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.536.111 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.538.256 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.538.280 I llama_new_context_with_model: graph nodes  = 967
0.00.538.280 I llama_new_context_with_model: graph splits = 1
0.00.538.283 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.618.856 I 
0.00.618.971 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.618.996 I perplexity: tokenizing the input ..
0.00.628.464 I perplexity: tokenization took 9.464 ms
0.00.628.497 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.397.290 I perplexity: 0.77 seconds per pass - ETA 0.00 minutes
[1]10.4463,
0.01.401.330 I Final estimate: PPL = 10.4463 +/- 3.33301

0.01.401.372 I llama_perf_context_print:        load time =     618.14 ms
0.01.401.389 I llama_perf_context_print: prompt eval time =     766.98 ms /   128 tokens (    5.99 ms per token,   166.89 tokens per second)
0.01.401.390 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.401.391 I llama_perf_context_print:       total time =     782.52 ms /   129 tokens
...
0.00.477.149 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.473.364 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.64user 0.61system 0:01.26elapsed 99%CPU (0avgtext+0avgdata 5357596maxresident)k
0inputs+32outputs (0major+53266minor)pagefaults 0swaps
```
