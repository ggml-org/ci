...
- status:  SUCCESS ✅
- runtime: 18:52.24
- date:    Mon May 13 00:22:04 UTC 2024
...
llama_print_timings:        load time =      11.37 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Soar! is a collaborative project by the Institute for Strategic Dialogue and the Center for Strategic and International Studies.
...
llama_print_timings: prompt eval time =    1147.92 ms /     2 tokens (  573.96 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   20920.41 ms /    31 runs   (  674.85 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22251.49 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say opposites attract, but is that just a fairytale or a truth?

**Arguments for Opposites Attracting:**

* Different perspectives and experiences create a richer
llama_print_timings:        load time =    1225.46 ms
llama_print_timings:      sample time =      47.59 ms /    32 runs   (    1.49 ms per token,   672.44 tokens per second)
llama_print_timings: prompt eval time =    1139.42 ms /     2 tokens (  569.71 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20841.42 ms /    31 runs   (  672.30 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22163.26 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heider Company is considering a capital budgeting decision to invest in a new automated assembly line. The new line is expected to increase production capacity by 20% and
llama_print_timings:        load time =    1250.21 ms
llama_print_timings:      sample time =      47.83 ms /    32 runs   (    1.49 ms per token,   669.08 tokens per second)
llama_print_timings: prompt eval time =    1140.31 ms /     2 tokens (  570.16 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21036.62 ms /    31 runs   (  678.60 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22360.70 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Witcher Season 2.

**Summary:**

The second season of The Witcher follows Geralt of Rivia, Cirilla, and Yennefer as they
llama_print_timings:        load time =    1227.42 ms
llama_print_timings:      sample time =      47.78 ms /    32 runs   (    1.49 ms per token,   669.79 tokens per second)
llama_print_timings: prompt eval time =    1144.67 ms /     2 tokens (  572.34 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21068.40 ms /    31 runs   (  679.63 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22396.33 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197065.04 ms
main:    total time = 197065.04 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a land filled with magical creatures, there lived a brave princess named Anya.

**Anya's Courage**

Anya possessed an unwavering spirit
llama_print_timings:        load time =     636.19 ms
llama_print_timings:      sample time =      47.82 ms /    32 runs   (    1.49 ms per token,   669.18 tokens per second)
llama_print_timings: prompt eval time =    1306.40 ms /     5 tokens (  261.28 ms per token,     3.83 tokens per second)
llama_print_timings:        eval time =   10750.45 ms /    31 runs   (  346.79 ms per token,     2.88 tokens per second)
llama_print_timings:       total time =   12239.88 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196489.74 ms
main:    total time = 196489.74 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     638.20 ms
llama_print_timings:      sample time =      47.52 ms /    32 runs   (    1.49 ms per token,   673.34 tokens per second)
llama_print_timings: prompt eval time =     581.26 ms /     2 tokens (  290.63 ms per token,     3.44 tokens per second)
llama_print_timings:        eval time =   10697.04 ms /    31 runs   (  345.07 ms per token,     2.90 tokens per second)
llama_print_timings:       total time =   11461.71 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     165.38 ms
llama_print_timings:      sample time =       6.77 ms /    32 runs   (    0.21 ms per token,  4725.34 tokens per second)
llama_print_timings: prompt eval time =      78.16 ms /     2 tokens (   39.08 ms per token,    25.59 tokens per second)
llama_print_timings:        eval time =    2137.29 ms /    31 runs   (   68.94 ms per token,    14.50 tokens per second)
llama_print_timings:       total time =    2285.42 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heinen's "A Christmas Carol" is a delightful and heartwarming tale, but it could benefit from more nuanced character development.
...
llama_print_timings:        eval time =    2111.07 ms /    31 runs   (   68.10 ms per token,    14.68 tokens per second)
llama_print_timings:       total time =    2254.56 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       6.75 ms /    32 runs   (    0.21 ms per token,  4742.85 tokens per second)
llama_print_timings: prompt eval time =      79.65 ms /     2 tokens (   39.82 ms per token,    25.11 tokens per second)
llama_print_timings:        eval time =    2165.97 ms /    31 runs   (   69.87 ms per token,    14.31 tokens per second)
llama_print_timings:       total time =    2313.12 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**Theme:** Empowerment and self-belief

**Concept:** The theme of this campaign is the transformative power of believing in yourself and embracing the potential to
llama_print_timings:        load time =     162.67 ms
llama_print_timings:      sample time =       6.77 ms /    32 runs   (    0.21 ms per token,  4725.34 tokens per second)
llama_print_timings: prompt eval time =      82.21 ms /     2 tokens (   41.11 ms per token,    24.33 tokens per second)
llama_print_timings:        eval time =    2226.20 ms /    31 runs   (   71.81 ms per token,    13.93 tokens per second)
llama_print_timings:       total time =    2378.52 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When You're Feeling Blue

**Verse 1:**
When shadows dance and blues arise,
Blue skies turn gray, the world cries.
A heavy
llama_print_timings:        load time =     121.96 ms
llama_print_timings:      sample time =       6.80 ms /    32 runs   (    0.21 ms per token,  4703.12 tokens per second)
llama_print_timings: prompt eval time =      68.22 ms /     2 tokens (   34.11 ms per token,    29.32 tokens per second)
llama_print_timings:        eval time =    1605.65 ms /    31 runs   (   51.80 ms per token,    19.31 tokens per second)
llama_print_timings:       total time =    1741.24 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31967.14 ms
main:    total time = 31967.14 ms
+ echo PASS
PASS
+ echo
...
**Welcome to Soar! where your dreams take flight!**

We offer personalized coaching and mentorship, helping you achieve your full potential in your
...
llama_print_timings:        eval time =    1651.36 ms /    31 runs   (   53.27 ms per token,    18.77 tokens per second)
llama_print_timings:       total time =    1789.87 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     392.38 ms
llama_print_timings:      sample time =       2.58 ms /    64 runs   (    0.04 ms per token, 24825.45 tokens per second)
llama_print_timings: prompt eval time =     324.28 ms /     8 tokens (   40.54 ms per token,    24.67 tokens per second)
llama_print_timings:        eval time =    7520.12 ms /    63 runs   (  119.37 ms per token,     8.38 tokens per second)
llama_print_timings:       total time =    7866.76 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     353.82 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4797.65 ms /   128 tokens (   37.48 ms per token,    26.68 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4814.23 ms /   129 tokens
...
llama_print_timings: prompt eval time =     229.09 ms /     8 tokens (   28.64 ms per token,    34.92 tokens per second)
llama_print_timings:        eval time =    5313.28 ms /    63 runs   (   84.34 ms per token,    11.86 tokens per second)
llama_print_timings:       total time =    5562.80 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3015.84 ms /   128 tokens (   23.56 ms per token,    42.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3032.78 ms /   129 tokens
...
llama_print_timings:        load time =     198.05 ms
...
llama_print_timings:        eval time =    4757.47 ms /    63 runs   (   75.52 ms per token,    13.24 tokens per second)
llama_print_timings:       total time =    5032.77 ms /    71 tokens
Log end
...
[1]4.1675,
llama_print_timings:        load time =     175.55 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3349.37 ms /   128 tokens (   26.17 ms per token,    38.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3366.36 ms /   129 tokens
...
llama_print_timings: prompt eval time =     393.80 ms /     8 tokens (   49.23 ms per token,    20.31 tokens per second)
llama_print_timings:        eval time =    4871.50 ms /    63 runs   (   77.33 ms per token,    12.93 tokens per second)
llama_print_timings:       total time =    5285.36 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6070.87 ms /   128 tokens (   47.43 ms per token,    21.08 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6087.49 ms /   129 tokens
...
llama_print_timings: prompt eval time =     420.45 ms /     8 tokens (   52.56 ms per token,    19.03 tokens per second)
llama_print_timings:        eval time =    5446.08 ms /    63 runs   (   86.45 ms per token,    11.57 tokens per second)
llama_print_timings:       total time =    5886.48 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6533.67 ms /   128 tokens (   51.04 ms per token,    19.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6550.65 ms /   129 tokens
...
llama_print_timings:        eval time =    5696.02 ms /    63 runs   (   90.41 ms per token,    11.06 tokens per second)
llama_print_timings:       total time =    6161.43 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6783.96 ms /   128 tokens (   53.00 ms per token,    18.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6800.93 ms /   129 tokens
...
llama_print_timings:        load time =     264.89 ms
llama_print_timings:      sample time =       2.26 ms /    64 runs   (    0.04 ms per token, 28331.12 tokens per second)
llama_print_timings: prompt eval time =     634.44 ms /     8 tokens (   79.31 ms per token,    12.61 tokens per second)
llama_print_timings:        eval time =    6112.76 ms /    63 runs   (   97.03 ms per token,    10.31 tokens per second)
llama_print_timings:       total time =    6766.66 ms /    71 tokens
Log end
...
[1]5.6204,
llama_print_timings:        load time =     244.51 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10077.89 ms /   128 tokens (   78.73 ms per token,    12.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10095.10 ms /   129 tokens
...
llama_print_timings: prompt eval time =     485.73 ms /     8 tokens (   60.72 ms per token,    16.47 tokens per second)
llama_print_timings:        eval time =    5342.94 ms /    63 runs   (   84.81 ms per token,    11.79 tokens per second)
llama_print_timings:       total time =    5848.71 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7607.65 ms /   128 tokens (   59.43 ms per token,    16.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7624.89 ms /   129 tokens
...
llama_print_timings: prompt eval time =     412.44 ms /     8 tokens (   51.55 ms per token,    19.40 tokens per second)
llama_print_timings:        eval time =    5182.81 ms /    63 runs   (   82.27 ms per token,    12.16 tokens per second)
llama_print_timings:       total time =    5615.50 ms /    71 tokens
Log end
...
[1]4.1768,
llama_print_timings:        load time =     215.87 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6330.29 ms /   128 tokens (   49.46 ms per token,    20.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6347.08 ms /   129 tokens
...
-
llama_print_timings:        load time =     272.52 ms
...
llama_print_timings:        eval time =    6054.92 ms /    63 runs   (   96.11 ms per token,    10.40 tokens per second)
llama_print_timings:       total time =    6555.66 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7510.44 ms /   128 tokens (   58.68 ms per token,    17.04 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7527.12 ms /   129 tokens
...
llama_print_timings: prompt eval time =     543.04 ms /     8 tokens (   67.88 ms per token,    14.73 tokens per second)
llama_print_timings:        eval time =    6474.40 ms /    63 runs   (  102.77 ms per token,     9.73 tokens per second)
llama_print_timings:       total time =    7038.02 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     272.95 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8346.59 ms /   128 tokens (   65.21 ms per token,    15.34 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8363.59 ms /   129 tokens
...
There is an important difference between fox squirrel
...
0.34user 0.33system 0:00.67elapsed 99%CPU (0avgtext+0avgdata 6880552maxresident)k
...
1/2 Test #22: test-model-load-cancel ...........   Passed    0.04 sec
    Start 23: test-autorelease
2/2 Test #23: test-autorelease .................   Passed    0.36 sec
...
0.12user 0.33system 0:00.46elapsed 99%CPU (0avgtext+0avgdata 6880144maxresident)k
0inputs+40outputs (0major+115209minor)pagefaults 0swaps
```
