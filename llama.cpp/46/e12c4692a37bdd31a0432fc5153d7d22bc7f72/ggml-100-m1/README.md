...
- status:  SUCCESS ✅
- runtime: 788.36
- date:    Thu Apr 25 22:46:06 EEST 2024
...
Test project /Users/ggml/work/llama.cpp/build-ci-debug
 ...
 1/23 Test  #1: test-quantize-fns ...................   Passed   35.23 sec
...
Label Time Summary:
main    = 195.53 sec*proc (23 tests)

Total Test time (real) = 195.54 sec
...
Test project /Users/ggml/work/llama.cpp/build-ci-release
 ...
 7/23 Test  #7: test-tokenizer-1-llama ..............   Passed    0.60 sec
      Start  8: test-tokenizer-1-baichuan
 8/23 Test  #8: test-tokenizer-1-baichuan ...........   Passed    0.76 sec
      Start  9: test-tokenizer-1-falcon
...
llama_print_timings: prompt eval time =      11.19 ms /     9 tokens (    1.24 ms per token,   804.15 tokens per second)
...
<bos> Soar, a cloud-based learning platform, offers a unique experience where users can learn through a gamified approach.

**Key Features:**

* **Adaptive
llama_print_timings:        load time =    3205.57 ms
llama_print_timings:      sample time =      56.42 ms /    32 runs   (    1.76 ms per token,   567.14 tokens per second)
llama_print_timings: prompt eval time =     194.87 ms /     2 tokens (   97.44 ms per token,    10.26 tokens per second)
llama_print_timings:        eval time =    1495.38 ms /    31 runs   (   48.24 ms per token,    20.73 tokens per second)
llama_print_timings:       total time =    2493.77 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After successfully installing and configuring the Apache web server, you want to add a custom error page for 404 errors.

**Step 1: Locate the
llama_print_timings:        load time =    3420.01 ms
llama_print_timings:      sample time =      56.15 ms /    32 runs   (    1.75 ms per token,   569.89 tokens per second)
llama_print_timings: prompt eval time =     202.58 ms /     2 tokens (  101.29 ms per token,     9.87 tokens per second)
llama_print_timings:        eval time =    1500.81 ms /    31 runs   (   48.41 ms per token,    20.66 tokens per second)
llama_print_timings:       total time =    2532.60 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, in a magical land of enchanted forests and glistening rivers, lived a curious young gnome named Barnaby.

Barnaby was known for his insatiable curiosity and always
llama_print_timings:        load time =    3164.98 ms
llama_print_timings:      sample time =      55.95 ms /    32 runs   (    1.75 ms per token,   571.91 tokens per second)
llama_print_timings: prompt eval time =     199.98 ms /     5 tokens (   40.00 ms per token,    25.00 tokens per second)
llama_print_timings:        eval time =    1496.71 ms /    31 runs   (   48.28 ms per token,    20.71 tokens per second)
llama_print_timings:       total time =    2487.92 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, there lived a little girl named Alice.

**Part 1: Setting the Scene**

* Where does Alice live?
* What is the time
llama_print_timings:        load time =    3043.90 ms
llama_print_timings:      sample time =      16.45 ms /    32 runs   (    0.51 ms per token,  1945.88 tokens per second)
llama_print_timings: prompt eval time =     196.70 ms /     5 tokens (   39.34 ms per token,    25.42 tokens per second)
llama_print_timings:        eval time =    1524.90 ms /    31 runs   (   49.19 ms per token,    20.33 tokens per second)
llama_print_timings:       total time =    1812.82 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
Heuristics are mental shortcuts used to make quick and efficient decisions in situations where there is insufficient
llama_print_timings:        load time =    2817.20 ms
llama_print_timings:      sample time =      16.38 ms /    32 runs   (    0.51 ms per token,  1953.36 tokens per second)
llama_print_timings: prompt eval time =     201.38 ms /     2 tokens (  100.69 ms per token,     9.93 tokens per second)
llama_print_timings:        eval time =    1520.26 ms /    31 runs   (   49.04 ms per token,    20.39 tokens per second)
llama_print_timings:       total time =    1813.64 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2628.34 ms
llama_print_timings:      sample time =      16.43 ms /    32 runs   (    0.51 ms per token,  1947.54 tokens per second)
llama_print_timings: prompt eval time =     196.54 ms /     2 tokens (   98.27 ms per token,    10.18 tokens per second)
llama_print_timings:        eval time =    1531.91 ms /    31 runs   (   49.42 ms per token,    20.24 tokens per second)
llama_print_timings:       total time =    1819.47 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21181.33 ms
main:    total time = 21181.33 ms
+ echo PASS
PASS
+ echo
...
This resonates deeply with me. The journey of self-discovery has been filled with
llama_print_timings:        load time =    1425.25 ms
llama_print_timings:      sample time =      16.55 ms /    32 runs   (    0.52 ms per token,  1933.18 tokens per second)
llama_print_timings: prompt eval time =     212.80 ms /     2 tokens (  106.40 ms per token,     9.40 tokens per second)
llama_print_timings:        eval time =    1090.70 ms /    31 runs   (   35.18 ms per token,    28.42 tokens per second)
llama_print_timings:       total time =    1393.49 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21475.93 ms
main:    total time = 21475.93 ms
+ echo PASS
PASS
+ echo
...
<bos> Shekhar, a renowned entrepreneur and investor, has a knack for identifying promising businesses and turning them into high-growth ventures. However, his ventures are often plagued by
llama_print_timings:        load time =    1541.35 ms
llama_print_timings:      sample time =      16.66 ms /    32 runs   (    0.52 ms per token,  1920.77 tokens per second)
llama_print_timings: prompt eval time =     214.88 ms /     2 tokens (  107.44 ms per token,     9.31 tokens per second)
llama_print_timings:        eval time =    1105.33 ms /    31 runs   (   35.66 ms per token,    28.05 tokens per second)
llama_print_timings:       total time =    1411.91 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
