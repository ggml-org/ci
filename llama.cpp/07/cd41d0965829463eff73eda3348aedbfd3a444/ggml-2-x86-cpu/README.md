...
- status:  SUCCESS ✅
- runtime: 19:34.00
- date:    Thu May  9 08:36:28 UTC 2024
...
llama_print_timings: prompt eval time =       4.36 ms /     9 tokens (    0.48 ms per token,  2063.27 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       5.69 ms /     9 tokens (    0.63 ms per token,  1580.89 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Heigl stars in a new movie called "The Interpreter," which also features Thomas Brodie.

The movie tells the story of a woman struggling to communicate with her autistic
llama_print_timings:        load time =    1249.59 ms
llama_print_timings:      sample time =      48.10 ms /    32 runs   (    1.50 ms per token,   665.32 tokens per second)
llama_print_timings: prompt eval time =    1143.20 ms /     2 tokens (  571.60 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   20882.31 ms /    31 runs   (  673.62 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22209.25 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Witcher Season 2 is coming soon, and excitement is brewing for another thrilling adventure filled with magic, monsters, and heart-pounding action.

**But
llama_print_timings:        load time =    1234.41 ms
llama_print_timings:      sample time =      47.71 ms /    32 runs   (    1.49 ms per token,   670.66 tokens per second)
llama_print_timings: prompt eval time =    1211.45 ms /     2 tokens (  605.73 ms per token,     1.65 tokens per second)
llama_print_timings:        eval time =   20915.71 ms /    31 runs   (  674.70 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22311.85 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say opposites attract, but have you ever experienced the complete opposite? 

I'm referring to a situation where two seemingly incompatible personalities come together, creating a
...
llama_print_timings: prompt eval time =    1140.14 ms /     2 tokens (  570.07 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21020.23 ms /    31 runs   (  678.07 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22342.49 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Sims 4: Get to Work EP introduces a new type of career called "Business Executive." This career offers a unique set of skills and challenges that allow players
llama_print_timings:        load time =    1249.80 ms
llama_print_timings:      sample time =      47.77 ms /    32 runs   (    1.49 ms per token,   669.93 tokens per second)
llama_print_timings: prompt eval time =    1153.89 ms /     2 tokens (  576.94 ms per token,     1.73 tokens per second)
llama_print_timings:        eval time =   20958.97 ms /    31 runs   (  676.10 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22296.90 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197929.19 ms
main:    total time = 197929.19 ms
+ echo PASS
PASS
+ echo
...
<bos> They say the early bird gets the worm, but in this case, it seems the early bird gets the traffic jam. 

The morning commute is a stressful time
llama_print_timings:        load time =     634.23 ms
llama_print_timings:      sample time =      47.81 ms /    32 runs   (    1.49 ms per token,   669.30 tokens per second)
llama_print_timings: prompt eval time =     575.09 ms /     2 tokens (  287.54 ms per token,     3.48 tokens per second)
llama_print_timings:        eval time =   10627.21 ms /    31 runs   (  342.81 ms per token,     2.92 tokens per second)
llama_print_timings:       total time =   11383.60 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198000.37 ms
main:    total time = 198000.37 ms
+ echo PASS
PASS
+ echo
...
<bos> Themed Escape Room

**Theme: Time Traveler's Odyssey**

**Scenario:**

You are the crew of the time-traveling ship Chronos, tasked
...
llama_print_timings: prompt eval time =     578.25 ms /     2 tokens (  289.12 ms per token,     3.46 tokens per second)
llama_print_timings:        eval time =   10644.03 ms /    31 runs   (  343.36 ms per token,     2.91 tokens per second)
llama_print_timings:       total time =   11405.31 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heirs is a reality TV series that follows the lives of the heirs to the Walt Disney Company, focusing on their careers, relationships, and the challenges and rewards of
llama_print_timings:        load time =     172.38 ms
llama_print_timings:      sample time =       6.44 ms /    32 runs   (    0.20 ms per token,  4967.40 tokens per second)
llama_print_timings: prompt eval time =      77.78 ms /     2 tokens (   38.89 ms per token,    25.71 tokens per second)
llama_print_timings:        eval time =    2077.02 ms /    31 runs   (   67.00 ms per token,    14.93 tokens per second)
llama_print_timings:       total time =    2221.59 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar! Aviation Career Fair is coming your way!

**Calling all aviation enthusiasts and aspiring pilots!**

Join us at Soar! Aviation Career Fair for
llama_print_timings:        load time =     157.10 ms
llama_print_timings:      sample time =       6.40 ms /    32 runs   (    0.20 ms per token,  5001.56 tokens per second)
llama_print_timings: prompt eval time =      74.87 ms /     2 tokens (   37.43 ms per token,    26.71 tokens per second)
llama_print_timings:        eval time =    2075.70 ms /    31 runs   (   66.96 ms per token,    14.93 tokens per second)
llama_print_timings:       total time =    2217.73 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
def generate_random_password(length=12, include_symbols=True):
    """
    Generates a random password with the
...
llama_print_timings: prompt eval time =      79.61 ms /     2 tokens (   39.81 ms per token,    25.12 tokens per second)
llama_print_timings:        eval time =    2082.62 ms /    31 runs   (   67.18 ms per token,    14.89 tokens per second)
llama_print_timings:       total time =    2232.77 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After a successful trial period, the company is considering expanding its product offering. However, there are concerns that expanding too quickly could jeopardize the company's core values and
llama_print_timings:        load time =     160.38 ms
llama_print_timings:      sample time =       6.89 ms /    32 runs   (    0.22 ms per token,  4647.11 tokens per second)
llama_print_timings: prompt eval time =      77.15 ms /     2 tokens (   38.58 ms per token,    25.92 tokens per second)
llama_print_timings:        eval time =    2217.82 ms /    31 runs   (   71.54 ms per token,    13.98 tokens per second)
llama_print_timings:       total time =    2363.94 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32276.42 ms
main:    total time = 32276.43 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       6.20 ms /    32 runs   (    0.19 ms per token,  5161.29 tokens per second)
llama_print_timings: prompt eval time =      69.47 ms /     2 tokens (   34.74 ms per token,    28.79 tokens per second)
llama_print_timings:        eval time =    1582.47 ms /    31 runs   (   51.05 ms per token,    19.59 tokens per second)
llama_print_timings:       total time =    1721.46 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31957.94 ms
main:    total time = 31957.94 ms
+ echo PASS
PASS
+ echo
...
<bos> Shemmassian Society for the Advancement of Learning has issued a statement calling for a comprehensive review of the Australian Curriculum, with a focus on ensuring its alignment with the needs
llama_print_timings:        load time =     119.72 ms
llama_print_timings:      sample time =       6.24 ms /    32 runs   (    0.20 ms per token,  5124.92 tokens per second)
llama_print_timings: prompt eval time =      67.53 ms /     2 tokens (   33.76 ms per token,    29.62 tokens per second)
llama_print_timings:        eval time =    1608.19 ms /    31 runs   (   51.88 ms per token,    19.28 tokens per second)
llama_print_timings:       total time =    1745.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     494.23 ms
llama_print_timings:      sample time =       2.42 ms /    64 runs   (    0.04 ms per token, 26446.28 tokens per second)
llama_print_timings: prompt eval time =     346.73 ms /     8 tokens (   43.34 ms per token,    23.07 tokens per second)
llama_print_timings:        eval time =    7945.27 ms /    63 runs   (  126.12 ms per token,     7.93 tokens per second)
llama_print_timings:       total time =    8315.36 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5099.44 ms /   128 tokens (   39.84 ms per token,    25.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5115.51 ms /   129 tokens
...
llama_print_timings: prompt eval time =     225.81 ms /     8 tokens (   28.23 ms per token,    35.43 tokens per second)
llama_print_timings:        eval time =    5573.90 ms /    63 runs   (   88.47 ms per token,    11.30 tokens per second)
llama_print_timings:       total time =    5818.91 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3021.21 ms /   128 tokens (   23.60 ms per token,    42.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3038.18 ms /   129 tokens
...
llama_print_timings:        eval time =    4666.08 ms /    63 runs   (   74.06 ms per token,    13.50 tokens per second)
llama_print_timings:       total time =    4912.74 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3316.68 ms /   128 tokens (   25.91 ms per token,    38.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3333.75 ms /   129 tokens
...
llama_print_timings: prompt eval time =     395.99 ms /     8 tokens (   49.50 ms per token,    20.20 tokens per second)
llama_print_timings:        eval time =    4812.56 ms /    63 runs   (   76.39 ms per token,    13.09 tokens per second)
llama_print_timings:       total time =    5228.35 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6049.09 ms /   128 tokens (   47.26 ms per token,    21.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6066.09 ms /   129 tokens
...
llama_print_timings: prompt eval time =     418.45 ms /     8 tokens (   52.31 ms per token,    19.12 tokens per second)
llama_print_timings:        eval time =    5456.29 ms /    63 runs   (   86.61 ms per token,    11.55 tokens per second)
llama_print_timings:       total time =    5895.36 ms /    71 tokens
Log end
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6401.72 ms /   129 tokens
...
llama_print_timings:        eval time =    5687.87 ms /    63 runs   (   90.28 ms per token,    11.08 tokens per second)
llama_print_timings:       total time =    6149.84 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6859.39 ms /   128 tokens (   53.59 ms per token,    18.66 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6876.76 ms /   129 tokens
...
llama_print_timings: prompt eval time =     639.14 ms /     8 tokens (   79.89 ms per token,    12.52 tokens per second)
llama_print_timings:        eval time =    6276.05 ms /    63 runs   (   99.62 ms per token,    10.04 tokens per second)
llama_print_timings:       total time =    6935.11 ms /    71 tokens
Log end
...
[1]5.6204,
llama_print_timings:        load time =     254.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10220.14 ms /   128 tokens (   79.84 ms per token,    12.52 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10237.25 ms /   129 tokens
...
llama_print_timings: prompt eval time =     484.49 ms /     8 tokens (   60.56 ms per token,    16.51 tokens per second)
llama_print_timings:        eval time =    5396.19 ms /    63 runs   (   85.65 ms per token,    11.67 tokens per second)
llama_print_timings:       total time =    5900.68 ms /    71 tokens
Log end
...
[1]4.4091,
llama_print_timings:        load time =     239.79 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7670.48 ms /   128 tokens (   59.93 ms per token,    16.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7687.45 ms /   129 tokens
...
llama_print_timings: prompt eval time =     412.32 ms /     8 tokens (   51.54 ms per token,    19.40 tokens per second)
llama_print_timings:        eval time =    5110.45 ms /    63 runs   (   81.12 ms per token,    12.33 tokens per second)
llama_print_timings:       total time =    5542.62 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6369.11 ms /   128 tokens (   49.76 ms per token,    20.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6386.55 ms /   129 tokens
...
llama_print_timings: prompt eval time =     488.33 ms /     8 tokens (   61.04 ms per token,    16.38 tokens per second)
llama_print_timings:        eval time =    6000.71 ms /    63 runs   (   95.25 ms per token,    10.50 tokens per second)
llama_print_timings:       total time =    6508.86 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7508.44 ms /   128 tokens (   58.66 ms per token,    17.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7525.95 ms /   129 tokens
...
llama_print_timings:        eval time =    6540.49 ms /    63 runs   (  103.82 ms per token,     9.63 tokens per second)
llama_print_timings:       total time =    7101.08 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8348.77 ms /   128 tokens (   65.22 ms per token,    15.33 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8365.49 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog is arbortically similar to the many examples of


second run: The quick brown fox jumps over the lazy dog is arbortically similar to the many examples of


single seq run: The quick brown fox jumps over the lazy dog is arbortically similar to the many examples of
...
first run: The quick brown fox jumps over the lazy dog. (7,950 words)
The


second run: The quick brown fox jumps over the lazy dog. (7,950 words)
The


single seq run: The quick brown fox jumps over the lazy dog. (7,950 words)
The
...
[1]9.1034,
llama_print_timings:        load time =     466.16 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5149.00 ms /   128 tokens (   40.23 ms per token,    24.86 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5204.23 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.348 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.15 seconds per pass - ETA 0.08 minutes
[1]7.0156,
llama_print_timings:        load time =    4457.74 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5147.46 ms /   128 tokens (   40.21 ms per token,    24.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5200.96 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.91 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.04 seconds per pass - ETA 0.05 minutes
[1]9.1825,
llama_print_timings:        load time =     306.29 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3029.44 ms /   128 tokens (   23.67 ms per token,    42.25 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3086.26 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 43.722 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.01 seconds per pass - ETA 0.05 minutes
[1]7.0131,
llama_print_timings:        load time =    3193.68 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3006.62 ms /   128 tokens (   23.49 ms per token,    42.57 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3059.05 ms /   129 tokens
...
[1]7.0336,
llama_print_timings:        load time =    3435.40 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3011.74 ms /   128 tokens (   23.53 ms per token,    42.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3064.62 ms /   129 tokens
...
0.33user 0.55system 0:00.89elapsed 99%CPU (0avgtext+0avgdata 6880424maxresident)k
0inputs+40outputs (0major+114703minor)pagefaults 0swaps
```
...
0.13user 0.54system 0:00.68elapsed 99%CPU (0avgtext+0avgdata 6880032maxresident)k
