...
- status:  SUCCESS ✅
- runtime: 827.62
- date:    Tue Dec 17 14:31:18 PST 2024
...
0.00.095.431 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.142.817 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.059.885 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.039.253 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.069.353 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.063.471 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.036.998 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.067.588 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.032.145 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.060.881 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.033.899 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.061.508 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.905 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.798 I llm_load_print_meta: LF token         = 128 'Ä'
