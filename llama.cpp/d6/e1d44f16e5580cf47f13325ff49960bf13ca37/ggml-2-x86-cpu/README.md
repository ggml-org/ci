...
- status:  SUCCESS ✅
- runtime: 13:51.54
- date:    Thu Apr 25 16:13:07 UTC 2024
...
llama_print_timings:       total time =      52.64 ms /    10 tokens
...
<bos> Shekoul, a prominent figure in the global Jewish community, recently made a controversial statement suggesting that non-Jews could not be considered Jewish. While his words sparked
...
llama_print_timings: prompt eval time =    1135.91 ms /     2 tokens (  567.96 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   21566.65 ms /    31 runs   (  695.70 ms per token,     1.44 tokens per second)
llama_print_timings:       total time =   22887.36 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**Chapter 1: A Symphony of Rhythm and Blood**

The city pulsed beneath Maya's feet, a symphony of concrete and steel
...
llama_print_timings: prompt eval time =    1195.88 ms /     2 tokens (  597.94 ms per token,     1.67 tokens per second)
llama_print_timings:        eval time =   21609.86 ms /    31 runs   (  697.09 ms per token,     1.43 tokens per second)
llama_print_timings:       total time =   22988.78 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say laughter is the best medicine. And when it comes to humor, there's no funnier place to be than in the world of stand-up comedy.
...
llama_print_timings: prompt eval time =    1219.22 ms /     2 tokens (  609.61 ms per token,     1.64 tokens per second)
llama_print_timings:        eval time =   21583.63 ms /    31 runs   (  696.25 ms per token,     1.44 tokens per second)
llama_print_timings:       total time =   22986.76 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heures is a French company specializing in digital experiences and employee experience solutions. They develop and implement innovative software solutions that bring value to HR professionals and employees.

**
llama_print_timings:        load time =     173.13 ms
llama_print_timings:      sample time =       6.20 ms /    32 runs   (    0.19 ms per token,  5159.63 tokens per second)
llama_print_timings: prompt eval time =      73.87 ms /     2 tokens (   36.93 ms per token,    27.08 tokens per second)
llama_print_timings:        eval time =    2034.88 ms /    31 runs   (   65.64 ms per token,    15.23 tokens per second)
llama_print_timings:       total time =    2174.81 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in the bustling metropolis of Cyberia, there lived a young programmer named Anya. Driven by her passion for coding, Anya spent countless hours in her secluded apartment
...
llama_print_timings: prompt eval time =     127.47 ms /     5 tokens (   25.49 ms per token,    39.23 tokens per second)
llama_print_timings:        eval time =    1983.44 ms /    31 runs   (   63.98 ms per token,    15.63 tokens per second)
llama_print_timings:       total time =    2177.05 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
**Get to Work!** is an expansion pack for The Sims 4 that introduces new gameplay features and career options for
llama_print_timings:        load time =     173.37 ms
llama_print_timings:      sample time =       6.91 ms /    32 runs   (    0.22 ms per token,  4632.98 tokens per second)
llama_print_timings: prompt eval time =      76.70 ms /     2 tokens (   38.35 ms per token,    26.08 tokens per second)
llama_print_timings:        eval time =    2034.04 ms /    31 runs   (   65.61 ms per token,    15.24 tokens per second)
llama_print_timings:       total time =    2181.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31674.33 ms
main:    total time = 31674.33 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a young girl named Anya who lived in a small village. Anya was a bright and curious girl, always eager to learn new things.
...
llama_print_timings: prompt eval time =     123.10 ms /     5 tokens (   24.62 ms per token,    40.62 tokens per second)
llama_print_timings:        eval time =    1533.58 ms /    31 runs   (   49.47 ms per token,    20.21 tokens per second)
llama_print_timings:       total time =    1723.51 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31787.45 ms
main:    total time = 31787.45 ms
+ echo PASS
PASS
+ echo
...
<bos> After a long day, you decide to relax with a warm cup of tea and a good book. What are the potential benefits you might experience?
...
llama_print_timings: prompt eval time =      65.19 ms /     2 tokens (   32.59 ms per token,    30.68 tokens per second)
llama_print_timings:        eval time =    1485.15 ms /    31 runs   (   47.91 ms per token,    20.87 tokens per second)
llama_print_timings:       total time =    1616.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     542.44 ms
llama_print_timings:      sample time =       2.35 ms /    64 runs   (    0.04 ms per token, 27222.46 tokens per second)
llama_print_timings: prompt eval time =     304.09 ms /     8 tokens (   38.01 ms per token,    26.31 tokens per second)
llama_print_timings:        eval time =    7621.05 ms /    63 runs   (  120.97 ms per token,     8.27 tokens per second)
llama_print_timings:       total time =    7947.45 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     521.98 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4725.84 ms /   128 tokens (   36.92 ms per token,    27.09 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4736.09 ms /   129 tokens
...
llama_print_timings:        load time =     374.05 ms
...
llama_print_timings:        eval time =    5417.83 ms /    63 runs   (   86.00 ms per token,    11.63 tokens per second)
llama_print_timings:       total time =    5644.21 ms /    71 tokens
Log end
...
[1]4.2536,
llama_print_timings:        load time =     350.66 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2822.55 ms /   128 tokens (   22.05 ms per token,    45.35 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2832.61 ms /   129 tokens
...
llama_print_timings: prompt eval time =     202.34 ms /     8 tokens (   25.29 ms per token,    39.54 tokens per second)
llama_print_timings:        eval time =    4586.40 ms /    63 runs   (   72.80 ms per token,    13.74 tokens per second)
llama_print_timings:       total time =    4808.38 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3130.22 ms /   128 tokens (   24.45 ms per token,    40.89 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3140.16 ms /   129 tokens
...
llama_print_timings:        eval time =    4872.35 ms /    63 runs   (   77.34 ms per token,    12.93 tokens per second)
llama_print_timings:       total time =    5265.02 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5844.67 ms /   128 tokens (   45.66 ms per token,    21.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5855.17 ms /   129 tokens
...
llama_print_timings:        load time =     320.02 ms
llama_print_timings:      sample time =       2.09 ms /    64 runs   (    0.03 ms per token, 30666.03 tokens per second)
llama_print_timings: prompt eval time =     388.61 ms /     8 tokens (   48.58 ms per token,    20.59 tokens per second)
llama_print_timings:        eval time =    5117.91 ms /    63 runs   (   81.24 ms per token,    12.31 tokens per second)
llama_print_timings:       total time =    5525.94 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6447.46 ms /   128 tokens (   50.37 ms per token,    19.85 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6457.83 ms /   129 tokens
...
llama_print_timings: prompt eval time =     421.94 ms /     8 tokens (   52.74 ms per token,    18.96 tokens per second)
llama_print_timings:        eval time =    5483.36 ms /    63 runs   (   87.04 ms per token,    11.49 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6599.78 ms /   128 tokens (   51.56 ms per token,    19.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6610.33 ms /   129 tokens
...
llama_print_timings: prompt eval time =     609.85 ms /     8 tokens (   76.23 ms per token,    13.12 tokens per second)
llama_print_timings:        eval time =    5689.08 ms /    63 runs   (   90.30 ms per token,    11.07 tokens per second)
llama_print_timings:       total time =    6319.01 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9862.74 ms /   128 tokens (   77.05 ms per token,    12.98 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9873.32 ms /   129 tokens
...
llama_print_timings:        eval time =    4951.09 ms /    63 runs   (   78.59 ms per token,    12.72 tokens per second)
llama_print_timings:       total time =    5431.45 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7392.22 ms /   128 tokens (   57.75 ms per token,    17.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7401.96 ms /   129 tokens
...
llama_print_timings:        eval time =    5007.89 ms /    63 runs   (   79.49 ms per token,    12.58 tokens per second)
llama_print_timings:       total time =    5417.03 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6117.41 ms /   128 tokens (   47.79 ms per token,    20.92 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6127.61 ms /   129 tokens
...
-
llama_print_timings:        load time =     349.37 ms
llama_print_timings:      sample time =       2.06 ms /    64 runs   (    0.03 ms per token, 31052.89 tokens per second)
llama_print_timings: prompt eval time =     474.78 ms /     8 tokens (   59.35 ms per token,    16.85 tokens per second)
llama_print_timings:        eval time =    5729.05 ms /    63 runs   (   90.94 ms per token,    11.00 tokens per second)
llama_print_timings:       total time =    6223.20 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7380.49 ms /   128 tokens (   57.66 ms per token,    17.34 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7390.31 ms /   129 tokens
...
llama_print_timings:        load time =     389.33 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31761.79 tokens per second)
llama_print_timings: prompt eval time =     521.30 ms /     8 tokens (   65.16 ms per token,    15.35 tokens per second)
llama_print_timings:        eval time =    6396.85 ms /    63 runs   (  101.54 ms per token,     9.85 tokens per second)
llama_print_timings:       total time =    6938.41 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4648.67 ms /   128 tokens (   36.32 ms per token,    27.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4698.08 ms /   129 tokens
...
[1]7.0156,
llama_print_timings:        load time =    5188.02 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4585.58 ms /   128 tokens (   35.82 ms per token,    27.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4632.45 ms /   129 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2814.72 ms /   128 tokens (   21.99 ms per token,    45.48 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2864.23 ms /   129 tokens
...
perplexity: 2.81 seconds per pass - ETA 0.03 minutes
[1]7.0131,
llama_print_timings:        load time =    3704.76 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2805.53 ms /   128 tokens (   21.92 ms per token,    45.62 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2852.44 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.495 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.81 seconds per pass - ETA 0.03 minutes
[1]7.0336,
llama_print_timings:        load time =    4103.35 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2808.79 ms /   128 tokens (   21.94 ms per token,    45.57 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2855.11 ms /   129 tokens
...
0.30user 0.68system 0:00.98elapsed 100%CPU (0avgtext+0avgdata 6877968maxresident)k
...
0.08user 0.69system 0:00.78elapsed 100%CPU (0avgtext+0avgdata 6877900maxresident)k
