...
- status:  SUCCESS ✅
- runtime: 18:37.23
- date:    Sat May 18 16:14:45 UTC 2024
...
12/22 Test #12: test-quantize-fns ................   Passed   31.48 sec
...
<bos> If f(x) = x^2 + 2x - 3, find the value of f(3).

$$f(x) = x
llama_print_timings:        load time =    1232.33 ms
llama_print_timings:      sample time =      47.60 ms /    32 runs   (    1.49 ms per token,   672.25 tokens per second)
llama_print_timings: prompt eval time =    1141.88 ms /     2 tokens (  570.94 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   20890.41 ms /    31 runs   (  673.88 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22216.19 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say a picture is worth a thousand words, but sometimes the best stories are those that resonate through touch and emotion.

**Story Prompt:**

Imagine a world
llama_print_timings:        load time =    1234.04 ms
...
llama_print_timings:        eval time =   21209.58 ms /    31 runs   (  684.18 ms per token,     1.46 tokens per second)
llama_print_timings:       total time =   22543.69 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =      47.89 ms /    32 runs   (    1.50 ms per token,   668.23 tokens per second)
llama_print_timings: prompt eval time =    1148.05 ms /     2 tokens (  574.03 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21151.06 ms /    31 runs   (  682.29 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22485.05 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say opposites attract, but have you ever seen the power of two seemingly incompatible things working together?

**The story:**

I stumbled upon an unlikely partnership between
llama_print_timings:        load time =    1338.61 ms
llama_print_timings:      sample time =      47.84 ms /    32 runs   (    1.50 ms per token,   668.88 tokens per second)
llama_print_timings: prompt eval time =    1206.41 ms /     2 tokens (  603.21 ms per token,     1.66 tokens per second)
llama_print_timings:        eval time =   20932.14 ms /    31 runs   (  675.23 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22322.85 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197306.44 ms
main:    total time = 197306.44 ms
+ echo PASS
PASS
+ echo
...
<bos> After careful consideration, I have decided to withdraw from the [program name] program.

I understand that this decision may cause inconvenience and disruption, and I am truly
llama_print_timings:        load time =     627.53 ms
llama_print_timings:      sample time =      47.54 ms /    32 runs   (    1.49 ms per token,   673.13 tokens per second)
llama_print_timings: prompt eval time =     568.48 ms /     2 tokens (  284.24 ms per token,     3.52 tokens per second)
llama_print_timings:        eval time =   10500.80 ms /    31 runs   (  338.74 ms per token,     2.95 tokens per second)
llama_print_timings:       total time =   11253.85 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197279.70 ms
main:    total time = 197279.70 ms
+ echo PASS
PASS
+ echo
...
# Check if the
llama_print_timings:        load time =     626.85 ms
llama_print_timings:      sample time =      47.57 ms /    32 runs   (    1.49 ms per token,   672.65 tokens per second)
llama_print_timings: prompt eval time =     569.31 ms /     2 tokens (  284.66 ms per token,     3.51 tokens per second)
llama_print_timings:        eval time =   10534.34 ms /    31 runs   (  339.82 ms per token,     2.94 tokens per second)
llama_print_timings:       total time =   11287.83 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heirs are a group of young men, each representing a different generation and social class. They are tasked with navigating a complex and uncertain world, where they encounter challenges
llama_print_timings:        load time =     186.62 ms
llama_print_timings:      sample time =       7.04 ms /    32 runs   (    0.22 ms per token,  4547.39 tokens per second)
llama_print_timings: prompt eval time =      77.96 ms /     2 tokens (   38.98 ms per token,    25.65 tokens per second)
llama_print_timings:        eval time =    2136.04 ms /    31 runs   (   68.90 ms per token,    14.51 tokens per second)
llama_print_timings:       total time =    2281.63 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       6.74 ms /    32 runs   (    0.21 ms per token,  4751.30 tokens per second)
llama_print_timings: prompt eval time =      73.12 ms /     2 tokens (   36.56 ms per token,    27.35 tokens per second)
llama_print_timings:        eval time =    2011.49 ms /    31 runs   (   64.89 ms per token,    15.41 tokens per second)
llama_print_timings:       total time =    2154.96 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the population of a certain city is 500,000 and the per capita income is $50,000, then what is
llama_print_timings:        load time =     159.82 ms
llama_print_timings:      sample time =       6.77 ms /    32 runs   (    0.21 ms per token,  4728.83 tokens per second)
llama_print_timings: prompt eval time =      88.96 ms /     2 tokens (   44.48 ms per token,    22.48 tokens per second)
llama_print_timings:        eval time =    2060.14 ms /    31 runs   (   66.46 ms per token,    15.05 tokens per second)
llama_print_timings:       total time =    2216.90 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Hunger Games: Catching Fire

The Hunger Games: Catching Fire is the second installment in the The Hunger Games film series, based on the novel of the
llama_print_timings:        load time =     158.16 ms
llama_print_timings:      sample time =       7.14 ms /    32 runs   (    0.22 ms per token,  4479.28 tokens per second)
llama_print_timings: prompt eval time =      76.84 ms /     2 tokens (   38.42 ms per token,    26.03 tokens per second)
llama_print_timings:        eval time =    2186.26 ms /    31 runs   (   70.52 ms per token,    14.18 tokens per second)
llama_print_timings:       total time =    2331.41 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31988.47 ms
main:    total time = 31988.47 ms
+ echo PASS
PASS
+ echo
...
<bos> They say the only way to predict the future is to create it.

While I agree that planning and preparation are essential, I believe that the most significant factor in
llama_print_timings:        load time =     122.80 ms
llama_print_timings:      sample time =       7.34 ms /    32 runs   (    0.23 ms per token,  4356.71 tokens per second)
llama_print_timings: prompt eval time =      65.56 ms /     2 tokens (   32.78 ms per token,    30.51 tokens per second)
llama_print_timings:        eval time =    1512.99 ms /    31 runs   (   48.81 ms per token,    20.49 tokens per second)
llama_print_timings:       total time =    1647.02 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32046.28 ms
main:    total time = 32046.28 ms
+ echo PASS
PASS
+ echo
...
<bos> When I use the word "they," it refers to all of them individually, rather than collectively as a group.

**Examples:**

* "They are going
llama_print_timings:        load time =     122.19 ms
llama_print_timings:      sample time =       7.42 ms /    32 runs   (    0.23 ms per token,  4310.93 tokens per second)
llama_print_timings: prompt eval time =      66.65 ms /     2 tokens (   33.33 ms per token,    30.01 tokens per second)
llama_print_timings:        eval time =    1550.92 ms /    31 runs   (   50.03 ms per token,    19.99 tokens per second)
llama_print_timings:       total time =    1686.19 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     375.73 ms
llama_print_timings:      sample time =       2.58 ms /    64 runs   (    0.04 ms per token, 24806.20 tokens per second)
llama_print_timings: prompt eval time =     297.88 ms /     8 tokens (   37.23 ms per token,    26.86 tokens per second)
llama_print_timings:        eval time =    7262.33 ms /    63 runs   (  115.28 ms per token,     8.67 tokens per second)
llama_print_timings:       total time =    7582.42 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4595.55 ms /   128 tokens (   35.90 ms per token,    27.85 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4608.44 ms /   129 tokens
...
llama_print_timings:        load time =     299.24 ms
llama_print_timings:      sample time =       2.26 ms /    64 runs   (    0.04 ms per token, 28268.55 tokens per second)
llama_print_timings: prompt eval time =     207.05 ms /     8 tokens (   25.88 ms per token,    38.64 tokens per second)
llama_print_timings:        eval time =    5311.09 ms /    63 runs   (   84.30 ms per token,    11.86 tokens per second)
llama_print_timings:       total time =    5537.87 ms /    71 tokens
Log end
...
[1]4.2465,
llama_print_timings:        load time =     264.61 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2835.35 ms /   128 tokens (   22.15 ms per token,    45.14 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2848.20 ms /   129 tokens
...
llama_print_timings: prompt eval time =     208.86 ms /     8 tokens (   26.11 ms per token,    38.30 tokens per second)
llama_print_timings:        eval time =    4275.93 ms /    63 runs   (   67.87 ms per token,    14.73 tokens per second)
llama_print_timings:       total time =    4504.31 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3133.37 ms /   128 tokens (   24.48 ms per token,    40.85 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3146.51 ms /   129 tokens
...
llama_print_timings: prompt eval time =     375.14 ms /     8 tokens (   46.89 ms per token,    21.33 tokens per second)
llama_print_timings:        eval time =    4549.74 ms /    63 runs   (   72.22 ms per token,    13.85 tokens per second)
llama_print_timings:       total time =    4944.72 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5852.43 ms /   128 tokens (   45.72 ms per token,    21.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5865.68 ms /   129 tokens
...
I believe the meaning of life is to find our purpose, live it, and inspire others to do the same.
llama_print_timings:        load time =     263.50 ms
llama_print_timings:      sample time =       2.22 ms /    64 runs   (    0.03 ms per token, 28802.88 tokens per second)
llama_print_timings: prompt eval time =     392.40 ms /     8 tokens (   49.05 ms per token,    20.39 tokens per second)
llama_print_timings:        eval time =    4951.95 ms /    63 runs   (   78.60 ms per token,    12.72 tokens per second)
llama_print_timings:       total time =    5364.05 ms /    71 tokens
Log end
...
[1]4.3207,
llama_print_timings:        load time =     234.20 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6168.35 ms /   128 tokens (   48.19 ms per token,    20.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6181.49 ms /   129 tokens
...
llama_print_timings: prompt eval time =     424.79 ms /     8 tokens (   53.10 ms per token,    18.83 tokens per second)
llama_print_timings:        eval time =    5230.57 ms /    63 runs   (   83.02 ms per token,    12.04 tokens per second)
llama_print_timings:       total time =    5676.15 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6560.48 ms /   128 tokens (   51.25 ms per token,    19.51 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6573.54 ms /   129 tokens
...
I am
llama_print_timings:        load time =     263.18 ms
...
llama_print_timings:        eval time =    5776.26 ms /    63 runs   (   91.69 ms per token,    10.91 tokens per second)
llama_print_timings:       total time =    6411.43 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9887.80 ms /   128 tokens (   77.25 ms per token,    12.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9901.56 ms /   129 tokens
...
I believe in karma.
I believe that you
llama_print_timings:        load time =     241.49 ms
llama_print_timings:      sample time =       2.26 ms /    64 runs   (    0.04 ms per token, 28306.06 tokens per second)
llama_print_timings: prompt eval time =     465.58 ms /     8 tokens (   58.20 ms per token,    17.18 tokens per second)
llama_print_timings:        eval time =    4903.47 ms /    63 runs   (   77.83 ms per token,    12.85 tokens per second)
llama_print_timings:       total time =    5388.66 ms /    71 tokens
Log end
...
[1]4.4095,
llama_print_timings:        load time =     209.33 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7412.15 ms /   128 tokens (   57.91 ms per token,    17.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7425.37 ms /   129 tokens
...
llama_print_timings: prompt eval time =     392.01 ms /     8 tokens (   49.00 ms per token,    20.41 tokens per second)
llama_print_timings:        eval time =    4776.03 ms /    63 runs   (   75.81 ms per token,    13.19 tokens per second)
llama_print_timings:       total time =    5188.39 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6155.27 ms /   128 tokens (   48.09 ms per token,    20.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6168.36 ms /   129 tokens
...
llama_print_timings: prompt eval time =     467.47 ms /     8 tokens (   58.43 ms per token,    17.11 tokens per second)
llama_print_timings:        eval time =    5547.91 ms /    63 runs   (   88.06 ms per token,    11.36 tokens per second)
llama_print_timings:       total time =    6034.83 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7262.90 ms /   128 tokens (   56.74 ms per token,    17.62 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7276.20 ms /   129 tokens
...
llama_print_timings:        load time =     297.11 ms
llama_print_timings:      sample time =       2.26 ms /    64 runs   (    0.04 ms per token, 28331.12 tokens per second)
llama_print_timings: prompt eval time =     519.28 ms /     8 tokens (   64.91 ms per token,    15.41 tokens per second)
llama_print_timings:        eval time =    6139.39 ms /    63 runs   (   97.45 ms per token,    10.26 tokens per second)
llama_print_timings:       total time =    6678.48 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8142.11 ms /   128 tokens (   63.61 ms per token,    15.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8155.52 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog! This time another fictional tale of rhyme is depicted


second run: The quick brown fox jumps over the lazy dog! This time another fictional tale of rhyme is depicted


single seq run: The quick brown fox jumps over the lazy dog! This time another fictional tale of rhyme is depicted
...
0.35user 0.34system 0:00.69elapsed 100%CPU (0avgtext+0avgdata 6880380maxresident)k
0inputs+40outputs (0major+115023minor)pagefaults 0swaps
```
...
0.12user 0.34system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 6879784maxresident)k
0inputs+40outputs (0major+114500minor)pagefaults 0swaps
```
