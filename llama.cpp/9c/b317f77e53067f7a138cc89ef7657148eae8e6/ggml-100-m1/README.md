...
- status:  SUCCESS ✅
- runtime: 447.34
- date:    Sat May 11 10:38:08 EEST 2024
...
llama_print_timings:        load time =      65.48 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.32 ms /     9 tokens (    1.26 ms per token,   795.26 tokens per second)
