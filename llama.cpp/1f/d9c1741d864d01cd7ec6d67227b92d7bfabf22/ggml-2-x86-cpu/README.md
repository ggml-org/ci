...
- status:  SUCCESS ✅
- runtime: 19:52.18
- date:    Wed May  8 11:44:21 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 9/21 Test  #9: test-tokenizer-0-command-r .......   Passed    3.18 sec
      Start 10: test-tokenizer-1-llama-spm
10/21 Test #10: test-tokenizer-1-llama-spm .......   Passed    3.40 sec
      Start 11: test-quantize-fns
11/21 Test #11: test-quantize-fns ................   Passed   31.05 sec
      Start 12: test-quantize-perf
12/21 Test #12: test-quantize-perf ...............   Passed    9.17 sec
...
llama_print_timings: prompt eval time =       4.58 ms /     9 tokens (    0.51 ms per token,  1965.07 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      55.36 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       5.73 ms /     9 tokens (    0.64 ms per token,  1570.41 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      56.47 ms /    10 tokens
...
<bos> If x is directly proportional to y, then as y increases, x also increases.<eos> [end of text]

llama_print_timings:        load time =    1248.30 ms
llama_print_timings:      sample time =      25.13 ms /    17 runs   (    1.48 ms per token,   676.51 tokens per second)
llama_print_timings: prompt eval time =    1143.57 ms /     2 tokens (  571.79 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   10756.16 ms /    16 runs   (  672.26 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   11995.49 ms /    18 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say that behind every successful person, there is a woman who holds the key.

**Discuss the significance of this statement and its relevance in today's context
...
llama_print_timings: prompt eval time =    1148.82 ms /     2 tokens (  574.41 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21076.99 ms /    31 runs   (  679.90 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22406.63 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
The reign of dinosaurs on Earth was a transformative period, leaving an indelible mark on the planet's biodiversity and
llama_print_timings:        load time =    1227.92 ms
llama_print_timings:      sample time =      47.68 ms /    32 runs   (    1.49 ms per token,   671.21 tokens per second)
llama_print_timings: prompt eval time =    1141.92 ms /     2 tokens (  570.96 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21004.05 ms /    31 runs   (  677.55 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22325.91 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Get Famous takes players on a journey to achieve superstardom. From humble beginnings, players must navigate the
...
llama_print_timings: prompt eval time =    1141.73 ms /     2 tokens (  570.87 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   20974.09 ms /    31 runs   (  676.58 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22294.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198206.69 ms
main:    total time = 198206.69 ms
+ echo PASS
PASS
+ echo
...
<bos> Soar is a travel agency specializing in adventure trips, luxury travel, and cultural experiences.

**a) Identify the target audience for Soar Soar.**


llama_print_timings:        load time =     635.01 ms
llama_print_timings:      sample time =      47.66 ms /    32 runs   (    1.49 ms per token,   671.35 tokens per second)
llama_print_timings: prompt eval time =     576.82 ms /     2 tokens (  288.41 ms per token,     3.47 tokens per second)
llama_print_timings:        eval time =   10664.92 ms /    31 runs   (  344.03 ms per token,     2.91 tokens per second)
llama_print_timings:       total time =   11421.33 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197866.99 ms
main:    total time = 197866.99 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =      47.79 ms /    32 runs   (    1.49 ms per token,   669.67 tokens per second)
llama_print_timings: prompt eval time =     577.91 ms /     2 tokens (  288.95 ms per token,     3.46 tokens per second)
llama_print_timings:        eval time =   10655.72 ms /    31 runs   (  343.73 ms per token,     2.91 tokens per second)
llama_print_timings:       total time =   11416.03 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heuristics are mental shortcuts used by people to make decisions quickly and efficiently.

**a) Explain how heuristics can impact decision making.**

**b
llama_print_timings:        load time =     171.24 ms
llama_print_timings:      sample time =       6.74 ms /    32 runs   (    0.21 ms per token,  4748.48 tokens per second)
llama_print_timings: prompt eval time =      80.53 ms /     2 tokens (   40.27 ms per token,    24.83 tokens per second)
llama_print_timings:        eval time =    2107.68 ms /    31 runs   (   67.99 ms per token,    14.71 tokens per second)
llama_print_timings:       total time =    2255.99 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shemiah ben Solomon was a prominent figure in the kingdom of Persia under King Ahasuerus. He is known for his wisdom, leadership, and administrative skills
...
llama_print_timings: prompt eval time =      75.31 ms /     2 tokens (   37.65 ms per token,    26.56 tokens per second)
llama_print_timings:        eval time =    2098.85 ms /    31 runs   (   67.70 ms per token,    14.77 tokens per second)
llama_print_timings:       total time =    2241.34 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heider Collection is a curated selection of vintage and modern furniture, lighting, and decorative objects.

**a.** What type of objects are featured in the Heider
llama_print_timings:        load time =     159.69 ms
llama_print_timings:      sample time =       6.78 ms /    32 runs   (    0.21 ms per token,  4720.46 tokens per second)
llama_print_timings: prompt eval time =      79.46 ms /     2 tokens (   39.73 ms per token,    25.17 tokens per second)
llama_print_timings:        eval time =    2125.10 ms /    31 runs   (   68.55 ms per token,    14.59 tokens per second)
llama_print_timings:       total time =    2275.21 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After you answer this question, please let me know if you would like more questions.

I have a list of 10 integers ranging from 1 to 
llama_print_timings:        load time =     159.79 ms
llama_print_timings:      sample time =       7.10 ms /    32 runs   (    0.22 ms per token,  4507.68 tokens per second)
llama_print_timings: prompt eval time =      79.96 ms /     2 tokens (   39.98 ms per token,    25.01 tokens per second)
llama_print_timings:        eval time =    2175.37 ms /    31 runs   (   70.17 ms per token,    14.25 tokens per second)
llama_print_timings:       total time =    2323.75 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32195.71 ms
main:    total time = 32195.71 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =      67.23 ms /     2 tokens (   33.62 ms per token,    29.75 tokens per second)
llama_print_timings:        eval time =    1607.49 ms /    31 runs   (   51.85 ms per token,    19.28 tokens per second)
llama_print_timings:       total time =    1744.77 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31956.62 ms
main:    total time = 31956.62 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       6.42 ms /    32 runs   (    0.20 ms per token,  4985.98 tokens per second)
llama_print_timings: prompt eval time =      67.54 ms /     2 tokens (   33.77 ms per token,    29.61 tokens per second)
llama_print_timings:        eval time =    1609.71 ms /    31 runs   (   51.93 ms per token,    19.26 tokens per second)
llama_print_timings:       total time =    1744.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     486.68 ms
llama_print_timings:      sample time =       2.40 ms /    64 runs   (    0.04 ms per token, 26688.91 tokens per second)
llama_print_timings: prompt eval time =     344.04 ms /     8 tokens (   43.00 ms per token,    23.25 tokens per second)
llama_print_timings:        eval time =    7919.17 ms /    63 runs   (  125.70 ms per token,     7.96 tokens per second)
llama_print_timings:       total time =    8286.96 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     459.46 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5075.09 ms /   128 tokens (   39.65 ms per token,    25.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5091.20 ms /   129 tokens
...
llama_print_timings: prompt eval time =     226.32 ms /     8 tokens (   28.29 ms per token,    35.35 tokens per second)
llama_print_timings:        eval time =    5562.97 ms /    63 runs   (   88.30 ms per token,    11.32 tokens per second)
llama_print_timings:       total time =    5808.79 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3010.48 ms /   128 tokens (   23.52 ms per token,    42.52 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3026.77 ms /   129 tokens
...
llama_print_timings:        load time =     208.29 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31636.18 tokens per second)
llama_print_timings: prompt eval time =     231.46 ms /     8 tokens (   28.93 ms per token,    34.56 tokens per second)
llama_print_timings:        eval time =    4606.36 ms /    63 runs   (   73.12 ms per token,    13.68 tokens per second)
llama_print_timings:       total time =    4858.33 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3331.93 ms /   128 tokens (   26.03 ms per token,    38.42 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3348.28 ms /   129 tokens
...
llama_print_timings:        eval time =    4806.71 ms /    63 runs   (   76.30 ms per token,    13.11 tokens per second)
llama_print_timings:       total time =    5223.52 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6032.93 ms /   128 tokens (   47.13 ms per token,    21.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6049.33 ms /   129 tokens
...
llama_print_timings:        eval time =    5478.07 ms /    63 runs   (   86.95 ms per token,    11.50 tokens per second)
llama_print_timings:       total time =    5920.83 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6470.68 ms /   128 tokens (   50.55 ms per token,    19.78 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6487.65 ms /   129 tokens
...
llama_print_timings: prompt eval time =     457.88 ms /     8 tokens (   57.24 ms per token,    17.47 tokens per second)
llama_print_timings:        eval time =    5718.51 ms /    63 runs   (   90.77 ms per token,    11.02 tokens per second)
llama_print_timings:       total time =    6195.73 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6790.23 ms /   128 tokens (   53.05 ms per token,    18.85 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6806.54 ms /   129 tokens
...
llama_print_timings: prompt eval time =     635.60 ms /     8 tokens (   79.45 ms per token,    12.59 tokens per second)
llama_print_timings:        eval time =    6213.93 ms /    63 runs   (   98.63 ms per token,    10.14 tokens per second)
llama_print_timings:       total time =    6868.91 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10093.53 ms /   128 tokens (   78.86 ms per token,    12.68 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10110.19 ms /   129 tokens
...
llama_print_timings: prompt eval time =     486.97 ms /     8 tokens (   60.87 ms per token,    16.43 tokens per second)
llama_print_timings:        eval time =    5405.59 ms /    63 runs   (   85.80 ms per token,    11.65 tokens per second)
llama_print_timings:       total time =    5912.11 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7635.90 ms /   128 tokens (   59.66 ms per token,    16.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7652.70 ms /   129 tokens
...
llama_print_timings: prompt eval time =     412.82 ms /     8 tokens (   51.60 ms per token,    19.38 tokens per second)
llama_print_timings:        eval time =    5147.00 ms /    63 runs   (   81.70 ms per token,    12.24 tokens per second)
llama_print_timings:       total time =    5579.66 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6351.99 ms /   128 tokens (   49.62 ms per token,    20.15 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6368.43 ms /   129 tokens
...
llama_print_timings: prompt eval time =     494.28 ms /     8 tokens (   61.79 ms per token,    16.19 tokens per second)
llama_print_timings:        eval time =    6012.01 ms /    63 runs   (   95.43 ms per token,    10.48 tokens per second)
llama_print_timings:       total time =    6525.64 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7519.58 ms /   128 tokens (   58.75 ms per token,    17.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7536.72 ms /   129 tokens
...
llama_print_timings:        load time =     299.53 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31449.63 tokens per second)
llama_print_timings: prompt eval time =     545.93 ms /     8 tokens (   68.24 ms per token,    14.65 tokens per second)
llama_print_timings:        eval time =    6518.62 ms /    63 runs   (  103.47 ms per token,     9.66 tokens per second)
llama_print_timings:       total time =    7084.32 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8336.32 ms /   128 tokens (   65.13 ms per token,    15.35 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8353.21 ms /   129 tokens
...
Even vampires are ankle biters by night
...
Super Mario geweihn accurhandfanz
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.706 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.09 seconds per pass - ETA 0.08 minutes
[1]9.1034,
llama_print_timings:        load time =     459.91 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5081.73 ms /   128 tokens (   39.70 ms per token,    25.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5137.73 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.059 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.10 seconds per pass - ETA 0.08 minutes
[1]7.0156,
llama_print_timings:        load time =    4283.97 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5094.88 ms /   128 tokens (   39.80 ms per token,    25.12 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5147.67 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.709 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.03 seconds per pass - ETA 0.05 minutes
[1]9.1825,
llama_print_timings:        load time =     291.00 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3023.27 ms /   128 tokens (   23.62 ms per token,    42.34 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3079.28 ms /   129 tokens
...
[1]7.0131,
llama_print_timings:        load time =    3227.32 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3004.23 ms /   128 tokens (   23.47 ms per token,    42.61 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3057.75 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 42.857 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.01 seconds per pass - ETA 0.05 minutes
[1]7.0336,
llama_print_timings:        load time =    3324.71 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3006.60 ms /   128 tokens (   23.49 ms per token,    42.57 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3057.63 ms /   129 tokens
...
0.34user 0.52system 0:00.87elapsed 99%CPU (0avgtext+0avgdata 6880544maxresident)k
0inputs+40outputs (0major+114710minor)pagefaults 0swaps
```
...
0.11user 0.55system 0:00.66elapsed 99%CPU (0avgtext+0avgdata 6880112maxresident)k
