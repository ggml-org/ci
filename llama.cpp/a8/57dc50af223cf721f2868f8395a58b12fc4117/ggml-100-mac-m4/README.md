...
- status:  SUCCESS ✅
- runtime: 820.21
- date:    Fri Jan 10 01:35:54 PST 2025
...
0.00.065.416 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.102.315 I print_info: LF token         = 128 'Ä'
...
0.00.059.232 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.100.326 I print_info: LF token         = 128 'Ä'
...
0.00.057.136 I print_info: LF token         = 128 'Ä'
...
0.00.039.358 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.069.990 I print_info: LF token         = 128 'Ä'
...
0.00.046.251 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.076.522 I print_info: LF token         = 128 'Ä'
...
0.00.059.645 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.098.309 I print_info: LF token         = 128 'Ä'
...
0.00.055.746 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.054.691 I print_info: LF token         = 128 'Ä'
...
0.00.027.724 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.053.429 I print_info: LF token         = 128 'Ä'
...
0.00.043.242 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.081.886 I print_info: LF token         = 128 'Ä'
...
0.00.056.319 I print_info: LF token         = 128 'Ä'
...
0.00.052.951 I print_info: LF token         = 128 'Ä'
...
0.00.036.518 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.076.586 I print_info: LF token         = 128 'Ä'
...
0.00.052.212 I print_info: LF token         = 128 'Ä'
...
0.00.057.110 I print_info: LF token         = 128 'Ä'
...
0.00.050.060 I print_info: LF token         = 128 'Ä'
...
0.00.064.484 I print_info: LF token         = 128 'Ä'
...
0.00.034.486 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.062.271 I print_info: LF token         = 128 'Ä'
...
0.00.039.325 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.078.373 I print_info: LF token         = 128 'Ä'
