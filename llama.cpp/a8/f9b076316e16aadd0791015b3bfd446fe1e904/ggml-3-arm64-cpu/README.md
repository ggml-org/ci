...
- status:  SUCCESS ✅
- runtime: 16:35.20
- date:    Tue Apr 30 21:53:11 UTC 2024
...
llama_print_timings:        load time =      37.24 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.78 ms /     9 tokens (    1.42 ms per token,   704.34 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       9.21 ms /     9 tokens (    1.02 ms per token,   976.88 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> The Witcher Season 2 spoilers are here.

**Spoiler Warnings**

**The Witcher Season 2 Spoilers**

In the second season of The Witcher, Ger
...
llama_print_timings:        eval time =    3156.26 ms /    31 runs   (  101.81 ms per token,     9.82 tokens per second)
llama_print_timings:       total time =    3363.61 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    1174.43 ms
llama_print_timings:      sample time =       7.70 ms /    32 runs   (    0.24 ms per token,  4156.92 tokens per second)
llama_print_timings: prompt eval time =     167.36 ms /     2 tokens (   83.68 ms per token,    11.95 tokens per second)
llama_print_timings:        eval time =    3150.36 ms /    31 runs   (  101.62 ms per token,     9.84 tokens per second)
llama_print_timings:       total time =    3358.60 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a bustling city, there lived a young artist named Anya. Driven by a passion for creating, she spent countless hours in her tiny studio, surrounded by
...
llama_print_timings: prompt eval time =     368.35 ms /     5 tokens (   73.67 ms per token,    13.57 tokens per second)
llama_print_timings:        eval time =    3141.75 ms /    31 runs   (  101.35 ms per token,     9.87 tokens per second)
llama_print_timings:       total time =    3550.20 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26675.08 ms
main:    total time = 26675.08 ms
+ echo PASS
PASS
+ echo
...
<bos> Shewans, a family of talented individuals dedicated to preserving and showcasing the rich heritage of the American West, have embarked on a mission to document and share the stories
...
llama_print_timings: prompt eval time =     157.80 ms /     2 tokens (   78.90 ms per token,    12.67 tokens per second)
llama_print_timings:        eval time =    2969.08 ms /    31 runs   (   95.78 ms per token,    10.44 tokens per second)
llama_print_timings:       total time =    3167.15 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26794.32 ms
main:    total time = 26794.32 ms
+ echo PASS
PASS
+ echo
...
<bos> After the rain, a stream flows with a steady velocity of 2 m/s. A swimmer standing on the bank of the stream notices that the water appears to
...
llama_print_timings:        eval time =    2945.50 ms /    31 runs   (   95.02 ms per token,    10.52 tokens per second)
llama_print_timings:       total time =    3143.35 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
0.37user 2.76system 0:03.14elapsed 100%CPU (0avgtext+0avgdata 6878008maxresident)k
