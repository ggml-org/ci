...
- status:  SUCCESS ✅
- runtime: 1006.39
- date:    Thu Jan  9 18:05:43 PST 2025
...
0.00.087.456 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.133.508 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.063.010 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.100.452 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.065.889 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.071.781 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.052.968 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.059.085 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.069.423 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.070.988 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.682 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.610 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.053.849 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.297 I llm_load_print_meta: LF token         = 128 'Ä'
