...
- status:  SUCCESS ✅
- runtime: 813.39
- date:    Mon Dec 23 23:51:15 PST 2024
...
0.00.116.809 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.158.900 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.521 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.085.282 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.027.603 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.064.579 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.043.468 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.050.261 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.041.679 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.048.980 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.579 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.052.880 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.463 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.049.352 I llm_load_print_meta: LF token         = 128 'Ä'
