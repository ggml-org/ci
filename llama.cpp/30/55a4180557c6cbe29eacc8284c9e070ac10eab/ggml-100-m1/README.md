...
- status:  SUCCESS ✅
- runtime: 784.18
- date:    Mon Apr 29 16:42:04 EEST 2024
...
Test project /Users/ggml/work/llama.cpp/build-ci-debug
 ...
 5/23 Test  #5: test-tokenizer-0-llama ..............   Passed    0.41 sec
...
Label Time Summary:
main    = 196.07 sec*proc (23 tests)

Total Test time (real) = 196.08 sec
...
llama_print_timings:        load time =      62.94 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.85 ms /     9 tokens (    1.32 ms per token,   759.81 tokens per second)
...
llama_print_timings:        load time =      53.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      13.24 ms /     9 tokens (    1.47 ms per token,   679.66 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
**The aftermath of the cataclysmic events in the first season leaves Geralt and Ciri in a precarious position.**

* **
llama_print_timings:        load time =    3157.46 ms
llama_print_timings:      sample time =      57.26 ms /    32 runs   (    1.79 ms per token,   558.90 tokens per second)
llama_print_timings: prompt eval time =     196.67 ms /     2 tokens (   98.34 ms per token,    10.17 tokens per second)
llama_print_timings:        eval time =    1500.75 ms /    31 runs   (   48.41 ms per token,    20.66 tokens per second)
llama_print_timings:       total time =    2536.39 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> The Sims 4 - Build and Decorate:

**Step 1: Build Your Dream Home**

- Select the "Build & Decorate" option.
-
llama_print_timings:        load time =    3795.11 ms
llama_print_timings:      sample time =      57.18 ms /    32 runs   (    1.79 ms per token,   559.62 tokens per second)
llama_print_timings: prompt eval time =     203.96 ms /     2 tokens (  101.98 ms per token,     9.81 tokens per second)
llama_print_timings:        eval time =    1505.40 ms /    31 runs   (   48.56 ms per token,    20.59 tokens per second)
llama_print_timings:       total time =    2546.94 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Heinkel aircraft was designed for what purpose?

a) Inter-continental passenger transport
b) Coastal defense
c) Reconnaissance
d) Air ambulance

Answer
llama_print_timings:        load time =    3189.68 ms
llama_print_timings:      sample time =      56.69 ms /    32 runs   (    1.77 ms per token,   564.45 tokens per second)
llama_print_timings: prompt eval time =     198.03 ms /     2 tokens (   99.01 ms per token,    10.10 tokens per second)
llama_print_timings:        eval time =    1496.06 ms /    31 runs   (   48.26 ms per token,    20.72 tokens per second)
llama_print_timings:       total time =    2507.80 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After a long and arduous journey, a weary traveler rests beneath a sprawling tree, the gentle breeze rustling through the leaves like a lullaby. Looking up at the vast
llama_print_timings:        load time =    2952.70 ms
llama_print_timings:      sample time =      16.71 ms /    32 runs   (    0.52 ms per token,  1915.59 tokens per second)
llama_print_timings: prompt eval time =     194.75 ms /     2 tokens (   97.37 ms per token,    10.27 tokens per second)
llama_print_timings:        eval time =    1535.25 ms /    31 runs   (   49.52 ms per token,    20.19 tokens per second)
llama_print_timings:       total time =    1821.15 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Shekoul is a renowned professor at the University of Haifa, specializing in ancient Near Eastern history and archaeology. He has extensive experience in excavation, research, and publication
llama_print_timings:        load time =    3120.16 ms
llama_print_timings:      sample time =      16.58 ms /    32 runs   (    0.52 ms per token,  1930.39 tokens per second)
llama_print_timings: prompt eval time =     201.65 ms /     2 tokens (  100.83 ms per token,     9.92 tokens per second)
llama_print_timings:        eval time =    1519.98 ms /    31 runs   (   49.03 ms per token,    20.40 tokens per second)
llama_print_timings:       total time =    1813.67 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If p is an odd prime number, then p is of the form 4k+1.

(a) Prove this statement.
(b) Determine
llama_print_timings:        load time =    3179.12 ms
llama_print_timings:      sample time =      16.37 ms /    32 runs   (    0.51 ms per token,  1955.15 tokens per second)
llama_print_timings: prompt eval time =     195.72 ms /     2 tokens (   97.86 ms per token,    10.22 tokens per second)
llama_print_timings:        eval time =    1523.06 ms /    31 runs   (   49.13 ms per token,    20.35 tokens per second)
llama_print_timings:       total time =    1809.37 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21246.85 ms
main:    total time = 21246.85 ms
+ echo PASS
PASS
+ echo
...
**Explore the world of fame and fortune!**

**Get ready to:**

* Build your own music career
*
llama_print_timings:        load time =    1471.64 ms
llama_print_timings:      sample time =      16.53 ms /    32 runs   (    0.52 ms per token,  1935.87 tokens per second)
llama_print_timings: prompt eval time =     212.93 ms /     2 tokens (  106.47 ms per token,     9.39 tokens per second)
llama_print_timings:        eval time =    1092.72 ms /    31 runs   (   35.25 ms per token,    28.37 tokens per second)
llama_print_timings:       total time =    1395.56 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21594.65 ms
main:    total time = 21594.65 ms
+ echo PASS
PASS
+ echo
...
<bos> They were a beacon in the night sky, guiding lost travelers home.
...
llama_print_timings:      sample time =      16.56 ms /    32 runs   (    0.52 ms per token,  1932.72 tokens per second)
llama_print_timings: prompt eval time =     215.16 ms /     2 tokens (  107.58 ms per token,     9.30 tokens per second)
llama_print_timings:        eval time =    1110.22 ms /    31 runs   (   35.81 ms per token,    27.92 tokens per second)
llama_print_timings:       total time =    1417.51 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
