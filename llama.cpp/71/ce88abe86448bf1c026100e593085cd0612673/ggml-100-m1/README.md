...
- status:  SUCCESS ✅
- runtime: 496.96
- date:    Wed Apr 24 10:01:09 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   91.51 sec
      Start 22: test-rope
...
llama_print_timings:        load time =      64.06 ms
...
<bos> Shekoul and his gang are engaged in a fierce battle against the Egyptian army.

**Shekoul**

"We must stand firm and defy these invaders
llama_print_timings:        load time =    2610.39 ms
llama_print_timings:      sample time =      58.17 ms /    32 runs   (    1.82 ms per token,   550.11 tokens per second)
llama_print_timings: prompt eval time =     195.53 ms /     2 tokens (   97.77 ms per token,    10.23 tokens per second)
llama_print_timings:        eval time =    1498.41 ms /    31 runs   (   48.34 ms per token,    20.69 tokens per second)
llama_print_timings:       total time =    2544.93 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
* She possessed a pure and noble heart,
llama_print_timings:        load time =    3327.29 ms
llama_print_timings:      sample time =      56.72 ms /    32 runs   (    1.77 ms per token,   564.18 tokens per second)
llama_print_timings: prompt eval time =     207.48 ms /     5 tokens (   41.50 ms per token,    24.10 tokens per second)
llama_print_timings:        eval time =    1500.30 ms /    31 runs   (   48.40 ms per token,    20.66 tokens per second)
llama_print_timings:       total time =    2521.32 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2672.31 ms
llama_print_timings:      sample time =      56.98 ms /    32 runs   (    1.78 ms per token,   561.65 tokens per second)
...
llama_print_timings:       total time =    2485.60 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, there lived a little girl named Lily who loved to play in the forest.

One sunny afternoon, Lily decided to explore the forest deeper than ever before.
llama_print_timings:        load time =    2525.22 ms
llama_print_timings:      sample time =      16.39 ms /    32 runs   (    0.51 ms per token,  1952.29 tokens per second)
llama_print_timings: prompt eval time =     198.87 ms /     5 tokens (   39.77 ms per token,    25.14 tokens per second)
llama_print_timings:        eval time =    1522.08 ms /    31 runs   (   49.10 ms per token,    20.37 tokens per second)
llama_print_timings:       total time =    1810.75 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say love makes the world go round, and this sentiment resonates deeply with me.

Throughout life, I have encountered countless individuals who have touched my heart deeply,
llama_print_timings:        load time =    2704.77 ms
llama_print_timings:      sample time =      16.21 ms /    32 runs   (    0.51 ms per token,  1974.33 tokens per second)
llama_print_timings: prompt eval time =     201.45 ms /     2 tokens (  100.73 ms per token,     9.93 tokens per second)
llama_print_timings:        eval time =    1519.41 ms /    31 runs   (   49.01 ms per token,    20.40 tokens per second)
llama_print_timings:       total time =    1812.21 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say opposites attract, but I'm not sure I believe it anymore. 🤔

**What are your thoughts on the statement "opposites attract"?**


llama_print_timings:        load time =    2757.71 ms
...
llama_print_timings:        eval time =    1531.99 ms /    31 runs   (   49.42 ms per token,    20.24 tokens per second)
llama_print_timings:       total time =    1818.49 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
