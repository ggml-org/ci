...
- status:  SUCCESS ✅
- runtime: 4:15.50
- date:    Sun Dec  8 18:23:53 UTC 2024
...
0.00.000.592 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.686 I llama_model_loader: - type  f16:   73 tensors
0.00.018.412 I llm_load_vocab: special tokens cache size = 5
0.00.020.901 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.020.932 I llm_load_print_meta: vocab_only       = 0
...
0.00.021.105 I llm_load_print_meta: n_expert_used    = 0
0.00.021.105 I llm_load_print_meta: causal attn      = 0
0.00.021.105 I llm_load_print_meta: pooling type     = 2
0.00.021.105 I llm_load_print_meta: rope type        = 2
0.00.021.106 I llm_load_print_meta: rope scaling     = linear
0.00.021.107 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.107 I llm_load_print_meta: freq_scale_train = 1
0.00.021.108 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.108 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.108 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.109 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.109 I llm_load_print_meta: ssm_d_state      = 0
0.00.021.109 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.021.110 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.110 I llm_load_print_meta: model type       = 33M
0.00.021.111 I llm_load_print_meta: model ftype      = F16
0.00.021.111 I llm_load_print_meta: model params     = 33.21 M
0.00.021.112 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.021.112 I llm_load_print_meta: general.name     = Bge Small
0.00.021.113 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.113 I llm_load_print_meta: SEP token        = 102 '[SEP]'
...
0.00.021.117 I llm_load_print_meta: max token length = 21
0.00.025.120 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
...
0.00.038.781 I llama_new_context_with_model: flash_attn    = 0
0.00.038.783 I llama_new_context_with_model: freq_base     = 10000.0
0.00.038.784 I llama_new_context_with_model: freq_scale    = 1
0.00.041.166 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.041.186 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.041.193 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.043.247 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.043.268 I llama_new_context_with_model: graph nodes  = 429
0.00.043.269 I llama_new_context_with_model: graph splits = 1
0.00.043.271 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.046.562 I 
0.00.046.657 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.048.361 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.053.154 I llama_perf_context_print:        load time =      45.93 ms
0.00.053.156 I llama_perf_context_print: prompt eval time =       4.42 ms /     9 tokens (    0.49 ms per token,  2035.74 tokens per second)
0.00.053.158 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.053.159 I llama_perf_context_print:       total time =       6.59 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.251 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.348 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.003.387 I llama_model_loader: - kv  11:                          general.file_type u32              = 7
0.00.003.388 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
0.00.003.388 I llama_model_loader: - kv  13:                          bert.pooling_type u32              = 2
0.00.003.388 I llama_model_loader: - kv  14:            tokenizer.ggml.token_type_count u32              = 2
0.00.003.389 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
0.00.003.389 I llama_model_loader: - kv  16:                         tokenizer.ggml.pre str              = jina-v2-en
0.00.006.520 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.007.216 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
...
0.00.007.220 I llama_model_loader: - type q8_0:   73 tensors
0.00.017.935 I llm_load_vocab: special tokens cache size = 5
0.00.020.405 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.434 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.435 I llm_load_print_meta: arch             = bert
0.00.020.436 I llm_load_print_meta: vocab type       = WPM
0.00.020.437 I llm_load_print_meta: n_vocab          = 30522
0.00.020.437 I llm_load_print_meta: n_merges         = 0
0.00.020.438 I llm_load_print_meta: vocab_only       = 0
0.00.020.438 I llm_load_print_meta: n_ctx_train      = 512
0.00.020.438 I llm_load_print_meta: n_embd           = 384
0.00.020.438 I llm_load_print_meta: n_layer          = 12
0.00.020.446 I llm_load_print_meta: n_head           = 12
0.00.020.447 I llm_load_print_meta: n_head_kv        = 12
0.00.020.447 I llm_load_print_meta: n_rot            = 32
0.00.020.447 I llm_load_print_meta: n_swa            = 0
0.00.020.447 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.447 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.448 I llm_load_print_meta: n_gqa            = 1
0.00.020.450 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.020.451 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.020.452 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.020.452 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.020.453 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.020.453 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.020.453 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.020.454 I llm_load_print_meta: n_ff             = 1536
0.00.020.454 I llm_load_print_meta: n_expert         = 0
0.00.020.454 I llm_load_print_meta: n_expert_used    = 0
0.00.020.454 I llm_load_print_meta: causal attn      = 0
0.00.020.454 I llm_load_print_meta: pooling type     = 2
0.00.020.455 I llm_load_print_meta: rope type        = 2
0.00.020.456 I llm_load_print_meta: rope scaling     = linear
0.00.020.457 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.020.459 I llm_load_print_meta: freq_scale_train = 1
0.00.020.459 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.020.460 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.460 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.460 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.460 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.462 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.462 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.462 I llm_load_print_meta: model type       = 33M
0.00.020.462 I llm_load_print_meta: model ftype      = Q8_0
0.00.020.463 I llm_load_print_meta: model params     = 33.21 M
0.00.020.464 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.020.464 I llm_load_print_meta: general.name     = Bge Small
0.00.020.466 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.466 I llm_load_print_meta: SEP token        = 102 '[SEP]'
...
0.00.023.207 I llm_load_tensors:          AMX model buffer size =    24.05 MiB
0.00.023.222 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.033.011 I llama_new_context_with_model: n_seq_max     = 1
0.00.033.027 I llama_new_context_with_model: n_ctx         = 512
0.00.033.027 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.033.028 I llama_new_context_with_model: n_batch       = 2048
0.00.033.030 I llama_new_context_with_model: n_ubatch      = 2048
0.00.033.031 I llama_new_context_with_model: flash_attn    = 0
0.00.033.033 I llama_new_context_with_model: freq_base     = 10000.0
0.00.033.034 I llama_new_context_with_model: freq_scale    = 1
0.00.035.341 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.035.372 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.035.377 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.036.827 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.036.846 I llama_new_context_with_model: graph nodes  = 429
0.00.036.847 I llama_new_context_with_model: graph splits = 1
0.00.036.848 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.039.085 I 
0.00.039.163 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.040.654 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.042.899 I llama_perf_context_print:        load time =      38.80 ms
0.00.042.901 I llama_perf_context_print: prompt eval time =       1.94 ms /     9 tokens (    0.22 ms per token,  4629.63 tokens per second)
0.00.042.902 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.042.903 I llama_perf_context_print:       total time =       3.81 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.622 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.354 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.008.376 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
...
0.00.008.385 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.386 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
...
0.00.008.391 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
...
0.00.008.398 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.399 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.399 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.400 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.014.213 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.015.595 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.093 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.113 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.113 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.114 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.114 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.115 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.115 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.116 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.116 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.117 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.117 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.117 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.120 I llama_model_loader: - type  f32:   41 tensors
0.00.019.121 I llama_model_loader: - type  f16:   29 tensors
0.00.037.123 W llm_load_vocab: empty token at index 5
0.00.046.883 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.060.404 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.060.528 I llm_load_vocab: special tokens cache size = 5
0.00.341.075 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.341.096 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.341.097 I llm_load_print_meta: arch             = jina-bert-v2
0.00.341.098 I llm_load_print_meta: vocab type       = BPE
0.00.341.098 I llm_load_print_meta: n_vocab          = 61056
0.00.341.098 I llm_load_print_meta: n_merges         = 39382
0.00.341.099 I llm_load_print_meta: vocab_only       = 0
0.00.341.099 I llm_load_print_meta: n_ctx_train      = 8192
0.00.341.099 I llm_load_print_meta: n_embd           = 384
0.00.341.100 I llm_load_print_meta: n_layer          = 4
0.00.341.108 I llm_load_print_meta: n_head           = 12
0.00.341.109 I llm_load_print_meta: n_head_kv        = 12
0.00.341.110 I llm_load_print_meta: n_rot            = 32
0.00.341.110 I llm_load_print_meta: n_swa            = 0
0.00.341.110 I llm_load_print_meta: n_embd_head_k    = 32
0.00.341.110 I llm_load_print_meta: n_embd_head_v    = 32
0.00.341.112 I llm_load_print_meta: n_gqa            = 1
0.00.341.112 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.341.113 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.341.115 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.341.115 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.341.116 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.341.116 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.341.117 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.341.117 I llm_load_print_meta: n_ff             = 1536
0.00.341.118 I llm_load_print_meta: n_expert         = 0
0.00.341.118 I llm_load_print_meta: n_expert_used    = 0
0.00.341.118 I llm_load_print_meta: causal attn      = 0
0.00.341.118 I llm_load_print_meta: pooling type     = -1
0.00.341.119 I llm_load_print_meta: rope type        = -1
0.00.341.119 I llm_load_print_meta: rope scaling     = linear
0.00.341.120 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.341.121 I llm_load_print_meta: freq_scale_train = 1
0.00.341.121 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.341.122 I llm_load_print_meta: rope_finetuned   = unknown
0.00.341.122 I llm_load_print_meta: ssm_d_conv       = 0
0.00.341.122 I llm_load_print_meta: ssm_d_inner      = 0
0.00.341.122 I llm_load_print_meta: ssm_d_state      = 0
0.00.341.123 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.341.123 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.341.124 I llm_load_print_meta: model type       = 33M
0.00.341.124 I llm_load_print_meta: model ftype      = F16
0.00.341.125 I llm_load_print_meta: model params     = 32.90 M
0.00.341.126 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.341.126 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.341.127 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.341.127 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.341.127 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.341.128 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.341.128 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.341.128 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.341.129 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.341.129 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.341.129 I llm_load_print_meta: max token length = 45
0.00.344.557 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.344.571 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.352.570 I llama_new_context_with_model: n_seq_max     = 1
0.00.352.593 I llama_new_context_with_model: n_ctx         = 8192
0.00.352.594 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.352.594 I llama_new_context_with_model: n_batch       = 2048
0.00.352.594 I llama_new_context_with_model: n_ubatch      = 2048
0.00.352.595 I llama_new_context_with_model: flash_attn    = 0
0.00.352.597 I llama_new_context_with_model: freq_base     = 10000.0
0.00.352.597 I llama_new_context_with_model: freq_scale    = 1
0.00.361.498 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.361.525 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.361.532 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.362.754 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.362.777 I llama_new_context_with_model: graph nodes  = 154
0.00.362.777 I llama_new_context_with_model: graph splits = 1
0.00.362.780 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.370.804 I 
0.00.370.899 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.371.134 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.371.147 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.152 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.371.153 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.157 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.371.158 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.039 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.382.648 I llama_perf_context_print:        load time =     370.14 ms
0.00.382.650 I llama_perf_context_print: prompt eval time =       7.42 ms /    62 tokens (    0.12 ms per token,  8355.80 tokens per second)
0.00.382.651 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.382.652 I llama_perf_context_print:       total time =      11.85 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.738 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.001.137 I main: llama backend init
...
0.00.080.102 I llm_load_vocab: token to piece cache size = 0.2984 MB
...
0.00.080.142 I llm_load_print_meta: n_head_kv        = 16
...
0.00.080.154 I llm_load_print_meta: causal attn      = 1
0.00.080.154 I llm_load_print_meta: pooling type     = 0
0.00.080.154 I llm_load_print_meta: rope type        = 2
0.00.080.155 I llm_load_print_meta: rope scaling     = linear
0.00.080.156 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.080.157 I llm_load_print_meta: freq_scale_train = 1
...
0.00.080.159 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.080.159 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.080.160 I llm_load_print_meta: model type       = 1.4B
0.00.080.161 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.080.162 I llm_load_print_meta: model params     = 1.41 B
0.00.080.163 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.265.810 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.265.826 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.074.576 I llama_new_context_with_model: n_seq_max     = 1
0.01.074.594 I llama_new_context_with_model: n_ctx         = 2048
0.01.074.594 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.01.074.595 I llama_new_context_with_model: n_batch       = 2048
0.01.074.595 I llama_new_context_with_model: n_ubatch      = 512
0.01.074.596 I llama_new_context_with_model: flash_attn    = 0
0.01.074.601 I llama_new_context_with_model: freq_base     = 10000.0
0.01.074.602 I llama_new_context_with_model: freq_scale    = 1
0.01.142.493 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.142.524 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.142.558 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.145.340 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.01.145.354 I llama_new_context_with_model: graph nodes  = 967
0.01.145.354 I llama_new_context_with_model: graph splits = 1
0.01.145.359 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.245.147 I main: llama threadpool init, n_threads = 4
0.01.245.170 I 
0.01.245.255 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.245.267 I 
0.01.245.394 I sampler seed: 1234
0.01.245.414 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.245.417 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.245.418 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.245.418 I 
...
0.05.039.873 I llama_perf_sampler_print:    sampling time =       2.61 ms /    71 runs   (    0.04 ms per token, 27171.83 tokens per second)
0.05.039.876 I llama_perf_context_print:        load time =    1243.97 ms
0.05.039.878 I llama_perf_context_print: prompt eval time =      98.82 ms /     7 tokens (   14.12 ms per token,    70.83 tokens per second)
0.05.039.879 I llama_perf_context_print:        eval time =    3683.97 ms /    63 runs   (   58.48 ms per token,    17.10 tokens per second)
0.05.039.880 I llama_perf_context_print:       total time =    3794.73 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.668 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.694 I llama_model_loader: - type  f16:   98 tensors
...
0.00.075.646 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.647 I llm_load_print_meta: model params     = 1.41 B
0.00.075.649 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.205.910 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.205.928 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.001.538 I llama_new_context_with_model: n_seq_max     = 1
0.01.001.554 I llama_new_context_with_model: n_ctx         = 128
0.01.001.554 I llama_new_context_with_model: n_ctx_per_seq = 128
0.01.001.555 I llama_new_context_with_model: n_batch       = 128
0.01.001.555 I llama_new_context_with_model: n_ubatch      = 128
0.01.001.556 I llama_new_context_with_model: flash_attn    = 0
0.01.001.561 I llama_new_context_with_model: freq_base     = 10000.0
0.01.001.562 I llama_new_context_with_model: freq_scale    = 1
0.01.001.563 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.006.505 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.006.534 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.006.559 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.009.203 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.01.009.226 I llama_new_context_with_model: graph nodes  = 967
0.01.009.226 I llama_new_context_with_model: graph splits = 1
0.01.009.229 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.075.120 I 
0.01.075.236 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.075.257 I perplexity: tokenizing the input ..
0.01.084.881 I perplexity: tokenization took 9.619 ms
0.01.084.913 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.975.345 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.979.014 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.979.058 I llama_perf_context_print:        load time =    1074.42 ms
0.01.979.071 I llama_perf_context_print: prompt eval time =     888.63 ms /   128 tokens (    6.94 ms per token,   144.04 tokens per second)
0.01.979.072 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.979.073 I llama_perf_context_print:       total time =     903.94 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.254 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.476 I main: llama backend init
0.00.000.494 I main: load the model and apply lora adapter, if any
0.00.008.944 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.008.984 I llama_model_loader: - kv   2:                               general.name str              = 1.4B
0.00.008.985 I llama_model_loader: - kv   3:                           general.finetune str              = 1.4B
0.00.008.985 I llama_model_loader: - kv   4:                         general.size_label str              = 1.4B
...
0.00.008.993 I llama_model_loader: - kv  10:               gptneox.attention.head_count u32              = 16
...
0.00.020.517 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
0.00.020.519 I llama_model_loader: - type  f32:  194 tensors
0.00.020.520 I llama_model_loader: - type q8_0:   98 tensors
...
0.00.075.376 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.377 I llm_load_print_meta: model params     = 1.41 B
0.00.075.377 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.166.271 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.166.287 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.327.800 I llama_new_context_with_model: n_seq_max     = 1
0.00.327.840 I llama_new_context_with_model: n_ctx         = 2048
0.00.327.847 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.327.854 I llama_new_context_with_model: n_batch       = 2048
0.00.327.860 I llama_new_context_with_model: n_ubatch      = 512
0.00.327.867 I llama_new_context_with_model: flash_attn    = 0
0.00.327.879 I llama_new_context_with_model: freq_base     = 10000.0
0.00.327.887 I llama_new_context_with_model: freq_scale    = 1
0.00.396.248 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.396.293 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.396.332 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.398.597 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.398.619 I llama_new_context_with_model: graph nodes  = 967
0.00.398.620 I llama_new_context_with_model: graph splits = 1
0.00.398.624 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.491.035 I main: llama threadpool init, n_threads = 4
0.00.491.066 I 
0.00.491.154 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.491.154 I 
0.00.491.286 I sampler seed: 1234
0.00.491.308 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.491.311 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.491.311 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.491.312 I 
...
0.02.637.514 I llama_perf_sampler_print:    sampling time =       2.62 ms /    71 runs   (    0.04 ms per token, 27088.90 tokens per second)
0.02.637.518 I llama_perf_context_print:        load time =     490.53 ms
0.02.637.519 I llama_perf_context_print: prompt eval time =      45.86 ms /     7 tokens (    6.55 ms per token,   152.64 tokens per second)
0.02.637.520 I llama_perf_context_print:        eval time =    2088.57 ms /    63 runs   (   33.15 ms per token,    30.16 tokens per second)
0.02.637.521 I llama_perf_context_print:       total time =    2146.49 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.721 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.456 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.075.968 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.169.410 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.169.428 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.326.263 I llama_new_context_with_model: n_seq_max     = 1
0.00.326.285 I llama_new_context_with_model: n_ctx         = 128
0.00.326.286 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.326.286 I llama_new_context_with_model: n_batch       = 128
0.00.326.286 I llama_new_context_with_model: n_ubatch      = 128
0.00.326.287 I llama_new_context_with_model: flash_attn    = 0
0.00.326.292 I llama_new_context_with_model: freq_base     = 10000.0
0.00.326.293 I llama_new_context_with_model: freq_scale    = 1
0.00.326.294 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.331.017 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.331.044 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.331.070 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.333.256 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.333.272 I llama_new_context_with_model: graph nodes  = 967
0.00.333.272 I llama_new_context_with_model: graph splits = 1
0.00.333.274 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.386.612 I 
0.00.386.729 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.386.751 I perplexity: tokenizing the input ..
0.00.396.343 I perplexity: tokenization took 9.588 ms
0.00.396.379 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.770.508 I perplexity: 0.37 seconds per pass - ETA 0.00 minutes
[1]10.1288,
0.00.774.375 I Final estimate: PPL = 10.1288 +/- 3.22324

0.00.774.416 I llama_perf_context_print:        load time =     385.85 ms
0.00.774.418 I llama_perf_context_print: prompt eval time =     372.29 ms /   128 tokens (    2.91 ms per token,   343.82 tokens per second)
0.00.774.419 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.774.420 I llama_perf_context_print:       total time =     387.80 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.264 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.459 I main: llama backend init
0.00.000.476 I main: load the model and apply lora adapter, if any
0.00.009.108 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_0.gguf (version GGUF V3 (latest))
...
0.00.020.639 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
0.00.020.641 I llama_model_loader: - type  f32:  194 tensors
0.00.020.642 I llama_model_loader: - type q4_0:   97 tensors
...
0.00.124.959 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.124.977 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.231.819 I llama_new_context_with_model: n_seq_max     = 1
0.00.231.842 I llama_new_context_with_model: n_ctx         = 2048
0.00.231.842 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.231.842 I llama_new_context_with_model: n_batch       = 2048
0.00.231.843 I llama_new_context_with_model: n_ubatch      = 512
0.00.231.843 I llama_new_context_with_model: flash_attn    = 0
0.00.231.849 I llama_new_context_with_model: freq_base     = 10000.0
0.00.231.850 I llama_new_context_with_model: freq_scale    = 1
0.00.300.313 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.300.346 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.300.385 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.302.683 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.302.698 I llama_new_context_with_model: graph nodes  = 967
0.00.302.698 I llama_new_context_with_model: graph splits = 1
0.00.302.703 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.373.938 I main: llama threadpool init, n_threads = 4
0.00.374.017 I 
0.00.374.114 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.374.114 I 
0.00.374.265 I sampler seed: 1234
0.00.374.302 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.374.306 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.374.307 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.374.307 I 
I believe the meaning of life is to know myself. It is to be able to say, “I am a person, I am a mother, a daughter, a sister, a friend, a mother of friends, a sister of sisters, and a sister of all the mothers.” It is to be able to say, “I am a human being

0.01.841.320 I llama_perf_sampler_print:    sampling time =       2.69 ms /    71 runs   (    0.04 ms per token, 26413.69 tokens per second)
0.01.841.323 I llama_perf_context_print:        load time =     373.44 ms
0.01.841.324 I llama_perf_context_print: prompt eval time =      45.67 ms /     7 tokens (    6.52 ms per token,   153.26 tokens per second)
0.01.841.326 I llama_perf_context_print:        eval time =    1409.45 ms /    63 runs   (   22.37 ms per token,    44.70 tokens per second)
0.01.841.326 I llama_perf_context_print:       total time =    1467.39 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.659 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.022 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
0.00.021.025 I llama_model_loader: - type  f32:  194 tensors
0.00.021.026 I llama_model_loader: - type q4_0:   97 tensors
...
0.00.076.042 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.671 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.125.688 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.232.931 I llama_new_context_with_model: n_seq_max     = 1
0.00.232.953 I llama_new_context_with_model: n_ctx         = 128
0.00.232.954 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.232.954 I llama_new_context_with_model: n_batch       = 128
0.00.232.954 I llama_new_context_with_model: n_ubatch      = 128
0.00.232.955 I llama_new_context_with_model: flash_attn    = 0
0.00.232.961 I llama_new_context_with_model: freq_base     = 10000.0
0.00.232.961 I llama_new_context_with_model: freq_scale    = 1
0.00.232.962 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.237.788 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.237.811 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.237.834 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.240.649 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.240.669 I llama_new_context_with_model: graph nodes  = 967
0.00.240.670 I llama_new_context_with_model: graph splits = 1
0.00.240.672 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.283.193 I 
0.00.283.357 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.283.381 I perplexity: tokenizing the input ..
0.00.292.998 I perplexity: tokenization took 9.613 ms
0.00.293.029 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.713.958 I perplexity: 0.42 seconds per pass - ETA 0.00 minutes
[1]14.0715,
0.00.717.846 I Final estimate: PPL = 14.0715 +/- 4.41015

0.00.717.887 I llama_perf_context_print:        load time =     282.50 ms
0.00.717.888 I llama_perf_context_print: prompt eval time =     419.15 ms /   128 tokens (    3.27 ms per token,   305.38 tokens per second)
0.00.717.889 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.717.891 I llama_perf_context_print:       total time =     434.69 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.604 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.275 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.673 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.130.691 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.243.550 I llama_new_context_with_model: n_seq_max     = 1
0.00.243.574 I llama_new_context_with_model: n_ctx         = 2048
0.00.243.575 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.243.575 I llama_new_context_with_model: n_batch       = 2048
0.00.243.575 I llama_new_context_with_model: n_ubatch      = 512
0.00.243.576 I llama_new_context_with_model: flash_attn    = 0
0.00.243.581 I llama_new_context_with_model: freq_base     = 10000.0
0.00.243.582 I llama_new_context_with_model: freq_scale    = 1
0.00.312.511 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.312.537 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.312.569 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.314.890 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.314.912 I llama_new_context_with_model: graph nodes  = 967
0.00.314.913 I llama_new_context_with_model: graph splits = 1
0.00.314.918 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.384.279 I main: llama threadpool init, n_threads = 4
0.00.384.313 I 
0.00.384.401 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.384.414 I 
0.00.384.554 I sampler seed: 1234
0.00.384.574 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.384.577 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.384.578 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.384.578 I 
...
0.01.908.620 I llama_perf_sampler_print:    sampling time =       2.54 ms /    71 runs   (    0.04 ms per token, 27908.81 tokens per second)
0.01.908.624 I llama_perf_context_print:        load time =     383.34 ms
0.01.908.625 I llama_perf_context_print: prompt eval time =      42.23 ms /     7 tokens (    6.03 ms per token,   165.77 tokens per second)
0.01.908.626 I llama_perf_context_print:        eval time =    1470.51 ms /    63 runs   (   23.34 ms per token,    42.84 tokens per second)
0.01.908.627 I llama_perf_context_print:       total time =    1524.35 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.661 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.212 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
...
0.00.132.438 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.132.455 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.243.531 I llama_new_context_with_model: n_seq_max     = 1
0.00.243.549 I llama_new_context_with_model: n_ctx         = 128
0.00.243.550 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.243.550 I llama_new_context_with_model: n_batch       = 128
0.00.243.550 I llama_new_context_with_model: n_ubatch      = 128
0.00.243.551 I llama_new_context_with_model: flash_attn    = 0
0.00.243.556 I llama_new_context_with_model: freq_base     = 10000.0
0.00.243.557 I llama_new_context_with_model: freq_scale    = 1
0.00.243.558 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.248.602 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.248.630 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.248.657 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.251.528 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.251.543 I llama_new_context_with_model: graph nodes  = 967
0.00.251.544 I llama_new_context_with_model: graph splits = 1
0.00.251.546 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.294.096 I 
0.00.294.213 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.294.236 I perplexity: tokenizing the input ..
0.00.303.896 I perplexity: tokenization took 9.657 ms
0.00.303.929 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.749.154 I perplexity: 0.45 seconds per pass - ETA 0.00 minutes
[1]12.5781,
0.00.752.833 I Final estimate: PPL = 12.5781 +/- 3.87222

0.00.752.872 I llama_perf_context_print:        load time =     293.40 ms
0.00.752.873 I llama_perf_context_print: prompt eval time =     443.37 ms /   128 tokens (    3.46 ms per token,   288.70 tokens per second)
0.00.752.875 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.752.877 I llama_perf_context_print:       total time =     458.77 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.588 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.790 I main: llama backend init
0.00.000.808 I main: load the model and apply lora adapter, if any
0.00.009.654 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.136.264 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.136.284 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.151.821 I llama_new_context_with_model: n_seq_max     = 1
0.00.151.844 I llama_new_context_with_model: n_ctx         = 2048
0.00.151.844 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.151.845 I llama_new_context_with_model: n_batch       = 2048
0.00.151.845 I llama_new_context_with_model: n_ubatch      = 512
0.00.151.845 I llama_new_context_with_model: flash_attn    = 0
0.00.151.849 I llama_new_context_with_model: freq_base     = 10000.0
0.00.151.850 I llama_new_context_with_model: freq_scale    = 1
0.00.220.361 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.220.391 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.220.417 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.222.722 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.320.305 I main: llama threadpool init, n_threads = 4
0.00.320.338 I 
0.00.320.440 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.320.455 I 
0.00.320.615 I sampler seed: 1234
0.00.320.635 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.320.638 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.590.769 I llama_perf_sampler_print:    sampling time =       2.65 ms /    71 runs   (    0.04 ms per token, 26792.45 tokens per second)
0.02.590.772 I llama_perf_context_print:        load time =     319.48 ms
0.02.590.773 I llama_perf_context_print: prompt eval time =      75.90 ms /     7 tokens (   10.84 ms per token,    92.23 tokens per second)
0.02.590.775 I llama_perf_context_print:        eval time =    2182.62 ms /    63 runs   (   34.64 ms per token,    28.86 tokens per second)
0.02.590.775 I llama_perf_context_print:       total time =    2270.47 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.327 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.156 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.020.700 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.020.702 I llama_model_loader: - type  f32:  194 tensors
0.00.020.703 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.075.429 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.430 I llm_load_print_meta: model params     = 1.41 B
0.00.075.431 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.137.863 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.137.883 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.153.640 I llama_new_context_with_model: n_seq_max     = 1
0.00.153.662 I llama_new_context_with_model: n_ctx         = 128
0.00.153.662 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.153.662 I llama_new_context_with_model: n_batch       = 128
0.00.153.663 I llama_new_context_with_model: n_ubatch      = 128
0.00.153.663 I llama_new_context_with_model: flash_attn    = 0
0.00.153.667 I llama_new_context_with_model: freq_base     = 10000.0
0.00.153.668 I llama_new_context_with_model: freq_scale    = 1
0.00.153.669 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.158.571 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.158.597 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.158.617 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.160.830 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.160.852 I llama_new_context_with_model: graph nodes  = 967
0.00.160.852 I llama_new_context_with_model: graph splits = 1
0.00.160.854 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.207.764 I 
0.00.207.872 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.207.891 I perplexity: tokenizing the input ..
0.00.217.482 I perplexity: tokenization took 9.587 ms
0.00.217.515 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.306.036 I perplexity: 1.09 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.309.915 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.309.953 I llama_perf_context_print:        load time =     207.40 ms
0.01.309.955 I llama_perf_context_print: prompt eval time =    1086.75 ms /   128 tokens (    8.49 ms per token,   117.78 tokens per second)
0.01.309.956 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.309.957 I llama_perf_context_print:       total time =    1102.19 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.618 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.843 I main: llama backend init
0.00.000.862 I main: load the model and apply lora adapter, if any
0.00.009.549 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.021.036 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.075.211 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.212 I llm_load_print_meta: model params     = 1.41 B
0.00.075.213 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.140.250 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.140.267 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.156.132 I llama_new_context_with_model: n_seq_max     = 1
0.00.156.155 I llama_new_context_with_model: n_ctx         = 2048
0.00.156.155 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.156.155 I llama_new_context_with_model: n_batch       = 2048
0.00.156.156 I llama_new_context_with_model: n_ubatch      = 512
0.00.156.156 I llama_new_context_with_model: flash_attn    = 0
0.00.156.159 I llama_new_context_with_model: freq_base     = 10000.0
0.00.156.160 I llama_new_context_with_model: freq_scale    = 1
0.00.224.637 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.224.666 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.224.692 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.226.911 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.226.925 I llama_new_context_with_model: graph nodes  = 967
0.00.226.926 I llama_new_context_with_model: graph splits = 1
0.00.226.930 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.327.134 I main: llama threadpool init, n_threads = 4
0.00.327.164 I 
0.00.327.252 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.327.253 I 
0.00.327.384 I sampler seed: 1234
0.00.327.404 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.327.407 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.327.408 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.327.408 I 
...
0.02.747.360 I llama_perf_sampler_print:    sampling time =       2.66 ms /    71 runs   (    0.04 ms per token, 26711.81 tokens per second)
0.02.747.363 I llama_perf_context_print:        load time =     326.25 ms
0.02.747.365 I llama_perf_context_print: prompt eval time =     121.15 ms /     7 tokens (   17.31 ms per token,    57.78 tokens per second)
0.02.747.366 I llama_perf_context_print:        eval time =    2287.22 ms /    63 runs   (   36.31 ms per token,    27.54 tokens per second)
0.02.747.367 I llama_perf_context_print:       total time =    2420.23 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.561 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.322 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.323 I llm_load_print_meta: model params     = 1.41 B
0.00.075.324 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.142.644 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.142.662 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.158.093 I llama_new_context_with_model: n_seq_max     = 1
0.00.158.114 I llama_new_context_with_model: n_ctx         = 128
0.00.158.115 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.158.115 I llama_new_context_with_model: n_batch       = 128
0.00.158.115 I llama_new_context_with_model: n_ubatch      = 128
0.00.158.116 I llama_new_context_with_model: flash_attn    = 0
0.00.158.118 I llama_new_context_with_model: freq_base     = 10000.0
0.00.158.119 I llama_new_context_with_model: freq_scale    = 1
0.00.158.120 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.162.977 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.163.056 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.163.077 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.165.237 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.165.261 I llama_new_context_with_model: graph nodes  = 967
0.00.165.261 I llama_new_context_with_model: graph splits = 1
0.00.165.264 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.228.770 I 
0.00.228.890 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.228.913 I perplexity: tokenizing the input ..
0.00.238.513 I perplexity: tokenization took 9.596 ms
0.00.238.547 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.141.903 I perplexity: 1.90 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.145.719 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.145.760 I llama_perf_context_print:        load time =     228.17 ms
0.02.145.762 I llama_perf_context_print: prompt eval time =    1901.52 ms /   128 tokens (   14.86 ms per token,    67.31 tokens per second)
0.02.145.763 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.145.764 I llama_perf_context_print:       total time =    1916.99 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.636 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.848 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.851 I llama_model_loader: - type  f32:  194 tensors
0.00.020.851 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.852 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.075.064 I llm_load_print_meta: f_logit_scale    = 0.0e+00
...
0.00.075.070 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.071 I llm_load_print_meta: model params     = 1.41 B
0.00.075.072 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.111.035 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.111.055 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.126.002 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.025 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.025 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.026 I llama_new_context_with_model: n_batch       = 2048
0.00.126.026 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.026 I llama_new_context_with_model: flash_attn    = 0
0.00.126.029 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.030 I llama_new_context_with_model: freq_scale    = 1
0.00.194.798 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.194.829 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.194.855 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.624 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.645 I llama_new_context_with_model: graph nodes  = 967
0.00.197.646 I llama_new_context_with_model: graph splits = 1
0.00.197.650 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.273.024 I main: llama threadpool init, n_threads = 4
0.00.273.055 I 
0.00.273.141 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.273.141 I 
0.00.273.282 I sampler seed: 1234
0.00.273.306 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.273.310 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.273.311 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.273.311 I 
I believe the meaning of life is a one-f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <

0.01.756.071 I llama_perf_sampler_print:    sampling time =       2.36 ms /    71 runs   (    0.03 ms per token, 30084.75 tokens per second)
0.01.756.074 I llama_perf_context_print:        load time =     272.10 ms
0.01.756.076 I llama_perf_context_print: prompt eval time =      77.07 ms /     7 tokens (   11.01 ms per token,    90.82 tokens per second)
0.01.756.077 I llama_perf_context_print:        eval time =    1394.70 ms /    63 runs   (   22.14 ms per token,    45.17 tokens per second)
0.01.756.077 I llama_perf_context_print:       total time =    1483.05 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.321 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.712 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.714 I llama_model_loader: - type  f32:  194 tensors
0.00.020.715 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.715 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.111.357 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.126.605 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.628 I llama_new_context_with_model: n_ctx         = 128
0.00.126.629 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.629 I llama_new_context_with_model: n_batch       = 128
0.00.126.629 I llama_new_context_with_model: n_ubatch      = 128
0.00.126.630 I llama_new_context_with_model: flash_attn    = 0
0.00.126.633 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.633 I llama_new_context_with_model: freq_scale    = 1
0.00.126.634 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.131.436 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.131.463 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.131.484 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.687 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.702 I llama_new_context_with_model: graph nodes  = 967
0.00.133.703 I llama_new_context_with_model: graph splits = 1
0.00.133.706 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.175.340 I 
0.00.175.459 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.175.468 I perplexity: tokenizing the input ..
0.00.185.035 I perplexity: tokenization took 9.563 ms
0.00.185.065 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.437.842 I perplexity: 1.25 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.441.746 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.441.786 I llama_perf_context_print:        load time =     174.98 ms
0.01.441.787 I llama_perf_context_print: prompt eval time =    1251.01 ms /   128 tokens (    9.77 ms per token,   102.32 tokens per second)
0.01.441.788 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.441.789 I llama_perf_context_print:       total time =    1266.44 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.642 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.443 I llama_model_loader: - type q3_K:   25 tensors
0.00.021.443 I llama_model_loader: - type q4_K:   71 tensors
0.00.021.444 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.076.402 I llm_load_print_meta: n_ctx_train      = 2048
...
0.00.076.412 I llm_load_print_meta: n_swa            = 0
...
0.00.076.421 I llm_load_print_meta: rope scaling     = linear
...
0.00.076.426 I llm_load_print_meta: model ftype      = Q3_K - Medium
...
0.00.123.700 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.123.716 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.202.833 I llama_new_context_with_model: n_seq_max     = 1
0.00.202.854 I llama_new_context_with_model: n_ctx         = 2048
0.00.202.854 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.202.855 I llama_new_context_with_model: n_batch       = 2048
0.00.202.855 I llama_new_context_with_model: n_ubatch      = 512
0.00.202.856 I llama_new_context_with_model: flash_attn    = 0
0.00.202.861 I llama_new_context_with_model: freq_base     = 10000.0
0.00.202.862 I llama_new_context_with_model: freq_scale    = 1
0.00.270.949 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.270.973 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.271.005 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.273.240 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.273.264 I llama_new_context_with_model: graph nodes  = 967
0.00.273.264 I llama_new_context_with_model: graph splits = 1
0.00.273.269 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.348.627 I main: llama threadpool init, n_threads = 4
0.00.348.658 I 
0.00.348.747 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.348.747 I 
0.00.348.873 I sampler seed: 1234
0.00.348.898 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.348.901 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.348.902 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.348.902 I 
I believe the meaning of life is that one should never feel the need to be the best at anything, but rather, that one should be the best in whatever one does. This is a good philosophy, and I believe it to be a good basis for understanding how our lives are lived, as well as how we should live them.

It is

0.02.055.271 I llama_perf_sampler_print:    sampling time =       2.58 ms /    71 runs   (    0.04 ms per token, 27487.42 tokens per second)
0.02.055.274 I llama_perf_context_print:        load time =     347.72 ms
0.02.055.276 I llama_perf_context_print: prompt eval time =      70.33 ms /     7 tokens (   10.05 ms per token,    99.53 tokens per second)
0.02.055.277 I llama_perf_context_print:        eval time =    1624.86 ms /    63 runs   (   25.79 ms per token,    38.77 tokens per second)
0.02.055.277 I llama_perf_context_print:       total time =    1706.65 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.338 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.071 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q3_k.gguf (version GGUF V3 (latest))
...
0.00.020.606 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.074.782 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.074.783 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.074.784 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.074.785 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.074.785 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.074.785 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.074.786 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.074.787 I llm_load_print_meta: n_ff             = 8192
0.00.074.787 I llm_load_print_meta: n_expert         = 0
0.00.074.787 I llm_load_print_meta: n_expert_used    = 0
...
0.00.074.793 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.074.793 I llm_load_print_meta: model type       = 1.4B
0.00.074.794 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.074.795 I llm_load_print_meta: model params     = 1.41 B
0.00.074.795 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.121.137 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.121.152 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.201.945 I llama_new_context_with_model: n_seq_max     = 1
0.00.201.967 I llama_new_context_with_model: n_ctx         = 128
0.00.201.967 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.201.968 I llama_new_context_with_model: n_batch       = 128
0.00.201.968 I llama_new_context_with_model: n_ubatch      = 128
0.00.201.968 I llama_new_context_with_model: flash_attn    = 0
0.00.201.973 I llama_new_context_with_model: freq_base     = 10000.0
0.00.201.974 I llama_new_context_with_model: freq_scale    = 1
0.00.201.975 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.206.891 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.206.918 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.206.943 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.209.179 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.209.196 I llama_new_context_with_model: graph nodes  = 967
0.00.209.197 I llama_new_context_with_model: graph splits = 1
0.00.209.199 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.264.936 I 
0.00.265.052 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.265.075 I perplexity: tokenizing the input ..
0.00.274.734 I perplexity: tokenization took 9.656 ms
0.00.274.766 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.138.046 I perplexity: 0.86 seconds per pass - ETA 0.00 minutes
[1]12.3344,
0.01.141.872 I Final estimate: PPL = 12.3344 +/- 4.02919

0.01.141.911 I llama_perf_context_print:        load time =     264.56 ms
0.01.141.913 I llama_perf_context_print: prompt eval time =     861.46 ms /   128 tokens (    6.73 ms per token,   148.59 tokens per second)
0.01.141.914 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.141.914 I llama_perf_context_print:       total time =     876.98 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.289 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.904 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
0.00.020.907 I llama_model_loader: - type  f32:  194 tensors
0.00.020.908 I llama_model_loader: - type q4_K:   61 tensors
0.00.020.908 I llama_model_loader: - type q5_K:   24 tensors
...
0.00.074.923 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.074.924 I llm_load_print_meta: model params     = 1.41 B
0.00.074.925 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.130.322 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.130.340 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.247.740 I llama_new_context_with_model: n_seq_max     = 1
0.00.247.763 I llama_new_context_with_model: n_ctx         = 2048
0.00.247.763 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.247.764 I llama_new_context_with_model: n_batch       = 2048
0.00.247.764 I llama_new_context_with_model: n_ubatch      = 512
0.00.247.765 I llama_new_context_with_model: flash_attn    = 0
0.00.247.770 I llama_new_context_with_model: freq_base     = 10000.0
0.00.247.771 I llama_new_context_with_model: freq_scale    = 1
0.00.316.391 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.316.421 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.316.454 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.319.277 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.319.300 I llama_new_context_with_model: graph nodes  = 967
0.00.319.301 I llama_new_context_with_model: graph splits = 1
0.00.319.305 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.416.254 I main: llama threadpool init, n_threads = 4
0.00.416.285 I 
0.00.416.371 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.416.385 I 
0.00.416.515 I sampler seed: 1234
0.00.416.580 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.416.584 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.416.584 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.416.585 I 
...
0.02.371.190 I llama_perf_sampler_print:    sampling time =       2.65 ms /    71 runs   (    0.04 ms per token, 26812.69 tokens per second)
0.02.371.193 I llama_perf_context_print:        load time =     415.65 ms
0.02.371.195 I llama_perf_context_print: prompt eval time =      63.15 ms /     7 tokens (    9.02 ms per token,   110.85 tokens per second)
0.02.371.196 I llama_perf_context_print:        eval time =    1879.88 ms /    63 runs   (   29.84 ms per token,    33.51 tokens per second)
0.02.371.196 I llama_perf_context_print:       total time =    1954.94 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.666 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.455 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf (version GGUF V3 (latest))
...
0.00.020.950 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
0.00.020.952 I llama_model_loader: - type  f32:  194 tensors
0.00.020.953 I llama_model_loader: - type q4_K:   61 tensors
0.00.020.953 I llama_model_loader: - type q5_K:   24 tensors
...
0.00.075.750 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.075.759 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.760 I llm_load_print_meta: model params     = 1.41 B
0.00.075.761 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.131.073 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.131.090 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.249.466 I llama_new_context_with_model: n_seq_max     = 1
0.00.249.505 I llama_new_context_with_model: n_ctx         = 128
0.00.249.512 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.249.519 I llama_new_context_with_model: n_batch       = 128
0.00.249.525 I llama_new_context_with_model: n_ubatch      = 128
0.00.249.531 I llama_new_context_with_model: flash_attn    = 0
0.00.249.555 I llama_new_context_with_model: freq_base     = 10000.0
0.00.249.564 I llama_new_context_with_model: freq_scale    = 1
0.00.249.571 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.254.401 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.254.440 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.254.470 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.257.212 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.257.245 I llama_new_context_with_model: graph nodes  = 967
0.00.257.252 I llama_new_context_with_model: graph splits = 1
0.00.257.260 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.316.308 I 
0.00.316.433 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.316.457 I perplexity: tokenizing the input ..
0.00.326.093 I perplexity: tokenization took 9.632 ms
0.00.326.127 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.872.989 I perplexity: 0.55 seconds per pass - ETA 0.00 minutes
[1]10.4776,
0.00.876.803 I Final estimate: PPL = 10.4776 +/- 3.36742

0.00.876.843 I llama_perf_context_print:        load time =     315.60 ms
0.00.876.844 I llama_perf_context_print: prompt eval time =     544.99 ms /   128 tokens (    4.26 ms per token,   234.87 tokens per second)
0.00.876.846 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.876.848 I llama_perf_context_print:       total time =     560.53 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.283 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.507 I main: llama backend init
0.00.000.524 I main: load the model and apply lora adapter, if any
0.00.009.383 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf (version GGUF V3 (latest))
...
0.00.140.091 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.140.108 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.267.276 I llama_new_context_with_model: n_seq_max     = 1
0.00.267.299 I llama_new_context_with_model: n_ctx         = 2048
0.00.267.299 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.267.300 I llama_new_context_with_model: n_batch       = 2048
0.00.267.300 I llama_new_context_with_model: n_ubatch      = 512
0.00.267.301 I llama_new_context_with_model: flash_attn    = 0
0.00.267.306 I llama_new_context_with_model: freq_base     = 10000.0
0.00.267.307 I llama_new_context_with_model: freq_scale    = 1
0.00.335.624 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.335.653 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.335.685 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.338.467 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.338.482 I llama_new_context_with_model: graph nodes  = 967
0.00.338.482 I llama_new_context_with_model: graph splits = 1
0.00.338.487 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.458.645 I main: llama threadpool init, n_threads = 4
0.00.458.675 I 
0.00.458.764 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.458.777 I 
0.00.458.913 I sampler seed: 1234
0.00.458.932 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.458.935 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.458.936 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.458.936 I 
I believe the meaning of life is to do the things we love, the things we are good at, the things we are good at doing, and the things that are good at doing. If we do those, we are happy. If we do not, then we are miserable, and we will do those things we hate the most.

I

0.02.845.585 I llama_perf_sampler_print:    sampling time =       2.58 ms /    71 runs   (    0.04 ms per token, 27562.11 tokens per second)
0.02.845.588 I llama_perf_context_print:        load time =     458.10 ms
0.02.845.590 I llama_perf_context_print: prompt eval time =      83.38 ms /     7 tokens (   11.91 ms per token,    83.95 tokens per second)
0.02.845.590 I llama_perf_context_print:        eval time =    2291.82 ms /    63 runs   (   36.38 ms per token,    27.49 tokens per second)
0.02.845.591 I llama_perf_context_print:       total time =    2386.95 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.716 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.552 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.074.553 I llm_load_print_meta: model params     = 1.41 B
0.00.074.554 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
0.00.074.555 I llm_load_print_meta: general.name     = 1.4B
...
0.00.074.556 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.074.556 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.074.557 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.557 I llm_load_print_meta: max token length = 1024
0.00.138.657 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.138.674 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.265.024 I llama_new_context_with_model: n_seq_max     = 1
0.00.265.047 I llama_new_context_with_model: n_ctx         = 128
0.00.265.048 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.265.048 I llama_new_context_with_model: n_batch       = 128
0.00.265.048 I llama_new_context_with_model: n_ubatch      = 128
0.00.265.049 I llama_new_context_with_model: flash_attn    = 0
0.00.265.054 I llama_new_context_with_model: freq_base     = 10000.0
0.00.265.055 I llama_new_context_with_model: freq_scale    = 1
0.00.265.056 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.269.881 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.269.907 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.269.931 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.272.049 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.272.072 I llama_new_context_with_model: graph nodes  = 967
0.00.272.072 I llama_new_context_with_model: graph splits = 1
0.00.272.074 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.344.490 I 
0.00.344.606 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.344.627 I perplexity: tokenizing the input ..
0.00.354.313 I perplexity: tokenization took 9.682 ms
0.00.354.347 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.992.799 I perplexity: 0.64 seconds per pass - ETA 0.00 minutes
[1]10.6642,
0.00.996.739 I Final estimate: PPL = 10.6642 +/- 3.40033

0.00.996.802 I llama_perf_context_print:        load time =     343.73 ms
0.00.996.803 I llama_perf_context_print: prompt eval time =     636.72 ms /   128 tokens (    4.97 ms per token,   201.03 tokens per second)
0.00.996.805 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.996.806 I llama_perf_context_print:       total time =     652.31 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.631 I build: 4289 (06d70147) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.034 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
...
0.00.075.534 I llm_load_print_meta: model ftype      = Q6_K
...
0.00.145.030 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.145.047 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.279.008 I llama_new_context_with_model: n_seq_max     = 1
0.00.279.050 I llama_new_context_with_model: n_ctx         = 2048
0.00.279.059 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.279.068 I llama_new_context_with_model: n_batch       = 2048
0.00.279.077 I llama_new_context_with_model: n_ubatch      = 512
0.00.279.086 I llama_new_context_with_model: flash_attn    = 0
0.00.279.101 I llama_new_context_with_model: freq_base     = 10000.0
0.00.279.111 I llama_new_context_with_model: freq_scale    = 1
0.00.347.752 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.347.803 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.347.851 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.350.066 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.350.104 I llama_new_context_with_model: graph nodes  = 967
0.00.350.113 I llama_new_context_with_model: graph splits = 1
0.00.350.127 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.461.637 I main: llama threadpool init, n_threads = 4
0.00.461.671 I 
0.00.461.767 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.461.782 I 
0.00.461.947 I sampler seed: 1234
0.00.461.967 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.461.970 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.461.971 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.461.971 I 
...
0.02.979.019 I llama_perf_sampler_print:    sampling time =       2.52 ms /    71 runs   (    0.04 ms per token, 28152.26 tokens per second)
0.02.979.022 I llama_perf_context_print:        load time =     460.77 ms
0.02.979.024 I llama_perf_context_print: prompt eval time =     107.42 ms /     7 tokens (   15.35 ms per token,    65.17 tokens per second)
0.02.979.025 I llama_perf_context_print:        eval time =    2398.16 ms /    63 runs   (   38.07 ms per token,    26.27 tokens per second)
0.02.979.025 I llama_perf_context_print:       total time =    2517.39 ms /    70 tokens
...
0.00.021.466 I llama_model_loader: - type q6_K:   98 tensors
0.00.066.247 I llm_load_vocab: special tokens cache size = 25
0.00.077.803 I llm_load_vocab: token to piece cache size = 0.2984 MB
0.00.077.827 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.077.827 I llm_load_print_meta: arch             = gptneox
0.00.077.828 I llm_load_print_meta: vocab type       = BPE
0.00.077.829 I llm_load_print_meta: n_vocab          = 50304
0.00.077.829 I llm_load_print_meta: n_merges         = 50009
0.00.077.830 I llm_load_print_meta: vocab_only       = 0
0.00.077.831 I llm_load_print_meta: n_ctx_train      = 2048
0.00.077.831 I llm_load_print_meta: n_embd           = 2048
0.00.077.832 I llm_load_print_meta: n_layer          = 24
...
0.00.077.846 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.077.847 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.077.848 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
...
0.00.077.851 I llm_load_print_meta: n_expert_used    = 0
0.00.077.852 I llm_load_print_meta: causal attn      = 1
0.00.077.852 I llm_load_print_meta: pooling type     = 0
0.00.077.852 I llm_load_print_meta: rope type        = 2
0.00.077.853 I llm_load_print_meta: rope scaling     = linear
0.00.077.854 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.077.855 I llm_load_print_meta: freq_scale_train = 1
0.00.077.855 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.077.855 I llm_load_print_meta: rope_finetuned   = unknown
0.00.077.856 I llm_load_print_meta: ssm_d_conv       = 0
0.00.077.856 I llm_load_print_meta: ssm_d_inner      = 0
0.00.077.856 I llm_load_print_meta: ssm_d_state      = 0
0.00.077.856 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.077.857 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.077.857 I llm_load_print_meta: model type       = 1.4B
0.00.077.858 I llm_load_print_meta: model ftype      = Q6_K
0.00.077.859 I llm_load_print_meta: model params     = 1.41 B
0.00.077.859 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.077.862 I llm_load_print_meta: max token length = 1024
0.00.158.715 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.158.731 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.293.795 I llama_new_context_with_model: n_seq_max     = 1
0.00.293.817 I llama_new_context_with_model: n_ctx         = 128
0.00.293.818 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.293.818 I llama_new_context_with_model: n_batch       = 128
0.00.293.818 I llama_new_context_with_model: n_ubatch      = 128
0.00.293.819 I llama_new_context_with_model: flash_attn    = 0
0.00.293.824 I llama_new_context_with_model: freq_base     = 10000.0
0.00.293.825 I llama_new_context_with_model: freq_scale    = 1
0.00.293.826 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.298.758 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.298.785 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.298.811 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.300.967 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.300.990 I llama_new_context_with_model: graph nodes  = 967
0.00.300.990 I llama_new_context_with_model: graph splits = 1
0.00.300.992 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.388.560 I 
0.00.388.678 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.388.702 I perplexity: tokenizing the input ..
0.00.398.230 I perplexity: tokenization took 9.524 ms
0.00.398.268 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.178.159 I perplexity: 0.78 seconds per pass - ETA 0.00 minutes
[1]10.4463,
0.01.181.994 I Final estimate: PPL = 10.4463 +/- 3.33301

0.01.182.033 I llama_perf_context_print:        load time =     387.80 ms
0.01.182.035 I llama_perf_context_print: prompt eval time =     777.99 ms /   128 tokens (    6.08 ms per token,   164.53 tokens per second)
0.01.182.036 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.182.036 I llama_perf_context_print:       total time =     793.48 ms /   129 tokens
...
0.00.301.360 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.301.961 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.63user 0.62system 0:01.25elapsed 100%CPU (0avgtext+0avgdata 5359740maxresident)k
...
0.44user 0.65system 0:01.10elapsed 100%CPU (0avgtext+0avgdata 5354008maxresident)k
