...
- status:  SUCCESS ✅
- runtime: 14:46.90
- date:    Thu May 23 14:46:18 UTC 2024
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       4.00 ms /     9 tokens (    0.44 ms per token,  2247.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings:        load time =    1257.55 ms
llama_print_timings:      sample time =      47.61 ms /    32 runs   (    1.49 ms per token,   672.18 tokens per second)
llama_print_timings: prompt eval time =    1149.48 ms /     2 tokens (  574.74 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21085.30 ms /    31 runs   (  680.17 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22415.51 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
## Soar: A Journey of Transformation

Soar is a comprehensive guide designed to help individuals reach their full potential by offering a holistic approach to personal
llama_print_timings:        load time =    1236.70 ms
llama_print_timings:      sample time =      47.57 ms /    32 runs   (    1.49 ms per token,   672.68 tokens per second)
llama_print_timings: prompt eval time =    1153.85 ms /     2 tokens (  576.92 ms per token,     1.73 tokens per second)
llama_print_timings:        eval time =   20965.83 ms /    31 runs   (  676.32 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22301.31 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekera Resort, a haven for those seeking tranquility amidst nature, offers a unique blend of luxury and sustainability.

**Luxury Accommodations:**

- Exquisite rooms and
llama_print_timings:        load time =    1239.97 ms
llama_print_timings:      sample time =      48.04 ms /    32 runs   (    1.50 ms per token,   666.08 tokens per second)
llama_print_timings: prompt eval time =    1177.04 ms /     2 tokens (  588.52 ms per token,     1.70 tokens per second)
llama_print_timings:        eval time =   21143.53 ms /    31 runs   (  682.05 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22504.51 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heigl is an American actress, producer, and director. She is known for her roles in Grey's Anatomy, How to Lose a Guy in 10
llama_print_timings:        load time =    1229.91 ms
llama_print_timings:      sample time =      47.66 ms /    32 runs   (    1.49 ms per token,   671.38 tokens per second)
llama_print_timings: prompt eval time =    1143.44 ms /     2 tokens (  571.72 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21021.74 ms /    31 runs   (  678.12 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22346.51 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 195558.12 ms
main:    total time = 195558.12 ms
+ echo PASS
PASS
+ echo
...
<bos> Soar! is a unique and exciting company that offers innovative solutions to empower creators and businesses.

**Here are some of their key features and benefits:**

**
llama_print_timings:        load time =     631.09 ms
...
llama_print_timings:        eval time =   10442.76 ms /    31 runs   (  336.86 ms per token,     2.97 tokens per second)
llama_print_timings:       total time =   11188.43 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 195493.99 ms
main:    total time = 195494.00 ms
+ echo PASS
PASS
+ echo
...
<bos> They say you should never underestimate the power of a woman, but they don't tell you how powerful a woman can be.
...
llama_print_timings: prompt eval time =     566.09 ms /     2 tokens (  283.04 ms per token,     3.53 tokens per second)
llama_print_timings:        eval time =   10454.01 ms /    31 runs   (  337.23 ms per token,     2.97 tokens per second)
llama_print_timings:       total time =   11200.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> He was born in the year 2000, and his birthday is on the 1st of every month.

What is his birthday for the year
...
llama_print_timings: prompt eval time =      75.45 ms /     2 tokens (   37.73 ms per token,    26.51 tokens per second)
llama_print_timings:        eval time =    2122.70 ms /    31 runs   (   68.47 ms per token,    14.60 tokens per second)
...
llama_print_timings:        load time =     158.43 ms
llama_print_timings:      sample time =       5.21 ms /    32 runs   (    0.16 ms per token,  6137.32 tokens per second)
llama_print_timings: prompt eval time =      75.23 ms /     2 tokens (   37.62 ms per token,    26.58 tokens per second)
llama_print_timings:        eval time =    2100.94 ms /    31 runs   (   67.77 ms per token,    14.76 tokens per second)
llama_print_timings:       total time =    2238.20 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
# Print the first 5
llama_print_timings:        load time =     163.71 ms
llama_print_timings:      sample time =       5.04 ms /    32 runs   (    0.16 ms per token,  6344.17 tokens per second)
llama_print_timings: prompt eval time =      80.45 ms /     2 tokens (   40.22 ms per token,    24.86 tokens per second)
llama_print_timings:        eval time =    2116.16 ms /    31 runs   (   68.26 ms per token,    14.65 tokens per second)
llama_print_timings:       total time =    2261.34 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a magical land of enchantment, there lived a courageous princess named Anya.

**Anya's Magic**

Anya possessed a special gift:
llama_print_timings:        load time =     159.78 ms
llama_print_timings:      sample time =       5.59 ms /    32 runs   (    0.17 ms per token,  5722.46 tokens per second)
llama_print_timings: prompt eval time =     136.89 ms /     5 tokens (   27.38 ms per token,    36.53 tokens per second)
llama_print_timings:        eval time =    2247.30 ms /    31 runs   (   72.49 ms per token,    13.79 tokens per second)
llama_print_timings:       total time =    2447.69 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32003.24 ms
main:    total time = 32003.24 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a magical land called Eldoria, there lived a courageous knight named Sir Eldric.
...
llama_print_timings: prompt eval time =     120.44 ms /     5 tokens (   24.09 ms per token,    41.52 tokens per second)
llama_print_timings:        eval time =    1615.97 ms /    31 runs   (   52.13 ms per token,    19.18 tokens per second)
llama_print_timings:       total time =    1798.25 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32114.83 ms
main:    total time = 32114.83 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a young woman named Anya. She was a bright and ambitious young woman, but she also had a fiery spirit and a penchant for impulsive decisions.
llama_print_timings:        load time =     122.23 ms
...
llama_print_timings:        eval time =    1615.26 ms /    31 runs   (   52.11 ms per token,    19.19 tokens per second)
llama_print_timings:       total time =    1799.48 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        eval time =    3385.38 ms /    63 runs   (   53.74 ms per token,    18.61 tokens per second)
llama_print_timings:       total time =    3546.31 ms /    71 tokens
Log end
...
[1]9.4758,
llama_print_timings:        load time =     183.54 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1884.62 ms /   128 tokens (   14.72 ms per token,    67.92 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1899.42 ms /   129 tokens
...
llama_print_timings:        load time =     153.61 ms
llama_print_timings:      sample time =       2.25 ms /    64 runs   (    0.04 ms per token, 28457.09 tokens per second)
llama_print_timings: prompt eval time =      85.83 ms /     8 tokens (   10.73 ms per token,    93.21 tokens per second)
llama_print_timings:        eval time =    2510.17 ms /    63 runs   (   39.84 ms per token,    25.10 tokens per second)
llama_print_timings:       total time =    2624.14 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1108.34 ms /   128 tokens (    8.66 ms per token,   115.49 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1123.13 ms /   129 tokens
...
llama_print_timings:        eval time =    2107.56 ms /    63 runs   (   33.45 ms per token,    29.89 tokens per second)
llama_print_timings:       total time =    2215.77 ms /    71 tokens
Log end
...
llama_print_timings: prompt eval time =     147.68 ms /     8 tokens (   18.46 ms per token,    54.17 tokens per second)
llama_print_timings:        eval time =    1986.26 ms /    63 runs   (   31.53 ms per token,    31.72 tokens per second)
llama_print_timings:       total time =    2161.56 ms /    71 tokens
Log end
...
[1]9.8554,
llama_print_timings:        load time =     100.56 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2222.20 ms /   128 tokens (   17.36 ms per token,    57.60 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2236.61 ms /   129 tokens
...
llama_print_timings:        eval time =    2171.76 ms /    63 runs   (   34.47 ms per token,    29.01 tokens per second)
llama_print_timings:       total time =    2357.75 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2385.97 ms /   128 tokens (   18.64 ms per token,    53.65 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2400.84 ms /   129 tokens
...
llama_print_timings:        eval time =    2290.80 ms /    63 runs   (   36.36 ms per token,    27.50 tokens per second)
llama_print_timings:       total time =    2486.94 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2509.54 ms /   128 tokens (   19.61 ms per token,    51.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2523.92 ms /   129 tokens
...
llama_print_timings: prompt eval time =     105.19 ms /     8 tokens (   13.15 ms per token,    76.05 tokens per second)
llama_print_timings:        eval time =    1548.77 ms /    63 runs   (   24.58 ms per token,    40.68 tokens per second)
llama_print_timings:       total time =    1681.40 ms /    71 tokens
Log end
...
[1]66.1404,
llama_print_timings:        load time =      73.10 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1594.70 ms /   128 tokens (   12.46 ms per token,    80.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1609.72 ms /   129 tokens
...
llama_print_timings:        eval time =    1727.81 ms /    63 runs   (   27.43 ms per token,    36.46 tokens per second)
llama_print_timings:       total time =    1869.47 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1689.36 ms /   128 tokens (   13.20 ms per token,    75.77 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1703.70 ms /   129 tokens
...
llama_print_timings:        eval time =    1875.54 ms /    63 runs   (   29.77 ms per token,    33.59 tokens per second)
llama_print_timings:       total time =    2023.39 ms /    71 tokens
Log end
...
[1]9.5894,
llama_print_timings:        load time =      89.45 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1762.23 ms /   128 tokens (   13.77 ms per token,    72.64 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1776.88 ms /   129 tokens
...
llama_print_timings: prompt eval time =     138.68 ms /     8 tokens (   17.33 ms per token,    57.69 tokens per second)
llama_print_timings:        eval time =    2074.37 ms /    63 runs   (   32.93 ms per token,    30.37 tokens per second)
llama_print_timings:       total time =    2241.16 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2051.37 ms /   128 tokens (   16.03 ms per token,    62.40 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings:        eval time =    2187.30 ms /    63 runs   (   34.72 ms per token,    28.80 tokens per second)
llama_print_timings:       total time =    2346.39 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1879.22 ms /   128 tokens (   14.68 ms per token,    68.11 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1894.30 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog, which is dragging a log while keen on his food


second run: The quick brown fox jumps over the lazy dog, which is dragging a log while keen on his food


single seq run: The quick brown fox jumps over the lazy dog, which is dragging a log while keen on his food
...
first run: The quick brown fox jumps over the lazy hobo with the red hat

1,600 shares


second run: The quick brown fox jumps over the lazy hobo with the red hat

1,600 shares


single seq run: The quick brown fox jumps over the lazy hobo with the red hat
...
0.94user 0.22system 0:01.17elapsed 99%CPU (0avgtext+0avgdata 2895900maxresident)k
...
0.21user 0.22system 0:00.44elapsed 99%CPU (0avgtext+0avgdata 2895048maxresident)k
0inputs+40outputs (0major+59685minor)pagefaults 0swaps
```
