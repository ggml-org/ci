...
- status:  SUCCESS ✅
- runtime: 4:31.07
- date:    Mon Mar 10 14:17:47 UTC 2025
...
0.00.000.257 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.860 I llama_model_loader: - kv  22:               tokenizer.ggml.mask_token_id u32              = 103
...
0.00.007.867 I print_info: file size   = 63.84 MiB (16.12 BPW) 
0.00.018.738 I load: special tokens cache size = 5
0.00.021.292 I load: token to piece cache size = 0.2032 MB
0.00.021.317 I print_info: arch             = bert
...
0.00.021.365 I print_info: n_head           = 12
0.00.021.367 I print_info: n_head_kv        = 12
0.00.021.367 I print_info: n_rot            = 32
0.00.021.368 I print_info: n_swa            = 0
0.00.021.368 I print_info: n_embd_head_k    = 32
0.00.021.368 I print_info: n_embd_head_v    = 32
0.00.021.370 I print_info: n_gqa            = 1
0.00.021.371 I print_info: n_embd_k_gqa     = 384
0.00.021.372 I print_info: n_embd_v_gqa     = 384
...
0.00.021.375 I print_info: f_logit_scale    = 0.0e+00
0.00.021.376 I print_info: n_ff             = 1536
0.00.021.376 I print_info: n_expert         = 0
0.00.021.376 I print_info: n_expert_used    = 0
0.00.021.377 I print_info: causal attn      = 0
0.00.021.377 I print_info: pooling type     = 2
0.00.021.377 I print_info: rope type        = 2
0.00.021.377 I print_info: rope scaling     = linear
0.00.021.378 I print_info: freq_base_train  = 10000.0
0.00.021.379 I print_info: freq_scale_train = 1
0.00.021.379 I print_info: n_ctx_orig_yarn  = 512
0.00.021.380 I print_info: rope_finetuned   = unknown
0.00.021.380 I print_info: ssm_d_conv       = 0
0.00.021.380 I print_info: ssm_d_inner      = 0
0.00.021.380 I print_info: ssm_d_state      = 0
0.00.021.381 I print_info: ssm_dt_rank      = 0
0.00.021.381 I print_info: ssm_dt_b_c_rms   = 0
0.00.021.382 I print_info: model type       = 33M
0.00.021.382 I print_info: model params     = 33.21 M
0.00.021.383 I print_info: general.name     = Bge Small
0.00.021.385 I print_info: vocab type       = WPM
0.00.021.386 I print_info: n_vocab          = 30522
0.00.021.386 I print_info: n_merges         = 0
0.00.021.386 I print_info: BOS token        = 101 '[CLS]'
0.00.021.387 I print_info: UNK token        = 100 '[UNK]'
0.00.021.387 I print_info: SEP token        = 102 '[SEP]'
0.00.021.387 I print_info: PAD token        = 0 '[PAD]'
0.00.021.387 I print_info: MASK token       = 103 '[MASK]'
0.00.021.387 I print_info: LF token         = 0 '[PAD]'
0.00.021.388 I print_info: max token length = 21
0.00.021.389 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.025.741 I load_tensors:          AMX model buffer size =    40.50 MiB
0.00.025.763 I load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.038.006 I llama_init_from_model: n_seq_max     = 1
0.00.038.019 I llama_init_from_model: n_ctx         = 512
...
0.00.038.021 I llama_init_from_model: freq_base     = 10000.0
0.00.038.022 I llama_init_from_model: freq_scale    = 1
0.00.038.038 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.039.978 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.040.003 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
...
0.00.042.607 I llama_init_from_model: graph nodes  = 429
0.00.042.608 I llama_init_from_model: graph splits = 1
0.00.042.612 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.042.612 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.046.112 I 
0.00.046.195 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
...
0.00.051.818 I llama_perf_context_print:        load time =      45.81 ms
0.00.051.820 I llama_perf_context_print: prompt eval time =       4.09 ms /     9 tokens (    0.45 ms per token,  2201.57 tokens per second)
0.00.051.821 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.051.821 I llama_perf_context_print:       total time =       5.71 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.292 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.167 I print_info: file format = GGUF V3 (latest)
...
0.00.022.215 I print_info: n_rot            = 32
0.00.022.216 I print_info: n_swa            = 0
0.00.022.216 I print_info: n_embd_head_k    = 32
...
0.00.025.316 I load_tensors:          AMX model buffer size =    24.05 MiB
0.00.025.339 I load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.031.749 I llama_init_from_model: n_seq_max     = 1
0.00.031.764 I llama_init_from_model: n_ctx         = 512
0.00.031.764 I llama_init_from_model: n_ctx_per_seq = 512
0.00.031.767 I llama_init_from_model: n_batch       = 2048
0.00.031.768 I llama_init_from_model: n_ubatch      = 2048
0.00.031.769 I llama_init_from_model: flash_attn    = 0
0.00.031.771 I llama_init_from_model: freq_base     = 10000.0
0.00.031.773 I llama_init_from_model: freq_scale    = 1
0.00.031.852 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.034.117 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.034.141 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.034.149 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.037.009 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
...
0.00.039.914 I 
0.00.039.987 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
...
0.00.043.637 I llama_perf_context_print:        load time =      39.58 ms
0.00.043.638 I llama_perf_context_print: prompt eval time =       2.04 ms /     9 tokens (    0.23 ms per token,  4403.13 tokens per second)
0.00.043.639 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.043.639 I llama_perf_context_print:       total time =       3.72 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.262 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.009.362 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
...
0.00.009.368 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
...
0.00.016.096 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
...
0.00.019.562 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.562 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.563 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.563 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.564 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.564 I llama_model_loader: - kv  24:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.565 I llama_model_loader: - kv  25:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.566 I llama_model_loader: - kv  26:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.566 I llama_model_loader: - kv  27:               general.quantization_version u32              = 2
0.00.019.568 I llama_model_loader: - type  f32:   40 tensors
0.00.019.569 I llama_model_loader: - type  f16:   30 tensors
0.00.019.571 I print_info: file format = GGUF V3 (latest)
0.00.019.571 I print_info: file type   = F16
0.00.019.574 I print_info: file size   = 62.78 MiB (16.01 BPW) 
0.00.026.812 W load: empty token at index 5
0.00.036.814 W load: model vocab missing newline token, using special_pad_id instead
0.00.050.796 W load: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.050.926 I load: special tokens cache size = 5
0.00.340.249 I load: token to piece cache size = 1.5060 MB
0.00.340.272 I print_info: arch             = jina-bert-v2
0.00.340.272 I print_info: vocab_only       = 0
0.00.340.273 I print_info: n_ctx_train      = 8192
0.00.340.273 I print_info: n_embd           = 384
0.00.340.273 I print_info: n_layer          = 4
0.00.340.287 I print_info: n_head           = 12
0.00.340.289 I print_info: n_head_kv        = 12
0.00.340.289 I print_info: n_rot            = 32
0.00.340.289 I print_info: n_swa            = 0
0.00.340.290 I print_info: n_embd_head_k    = 32
0.00.340.290 I print_info: n_embd_head_v    = 32
0.00.340.291 I print_info: n_gqa            = 1
0.00.340.293 I print_info: n_embd_k_gqa     = 384
0.00.340.294 I print_info: n_embd_v_gqa     = 384
0.00.340.295 I print_info: f_norm_eps       = 1.0e-12
0.00.340.296 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.340.296 I print_info: f_clamp_kqv      = 0.0e+00
0.00.340.297 I print_info: f_max_alibi_bias = 8.0e+00
0.00.340.297 I print_info: f_logit_scale    = 0.0e+00
0.00.340.298 I print_info: n_ff             = 1536
0.00.340.299 I print_info: n_expert         = 0
0.00.340.299 I print_info: n_expert_used    = 0
0.00.340.299 I print_info: causal attn      = 0
0.00.340.299 I print_info: pooling type     = -1
0.00.340.300 I print_info: rope type        = -1
0.00.340.300 I print_info: rope scaling     = linear
0.00.340.301 I print_info: freq_base_train  = 10000.0
0.00.340.302 I print_info: freq_scale_train = 1
0.00.340.302 I print_info: n_ctx_orig_yarn  = 8192
0.00.340.302 I print_info: rope_finetuned   = unknown
0.00.340.302 I print_info: ssm_d_conv       = 0
0.00.340.303 I print_info: ssm_d_inner      = 0
0.00.340.303 I print_info: ssm_d_state      = 0
0.00.340.303 I print_info: ssm_dt_rank      = 0
0.00.340.303 I print_info: ssm_dt_b_c_rms   = 0
0.00.340.304 I print_info: model type       = 33M
0.00.340.305 I print_info: model params     = 32.90 M
0.00.340.305 I print_info: general.name     = Jina Bert Implementation
0.00.340.308 I print_info: vocab type       = BPE
0.00.340.309 I print_info: n_vocab          = 61056
0.00.340.309 I print_info: n_merges         = 39382
0.00.340.309 I print_info: BOS token        = 0 '<s>'
0.00.340.310 I print_info: EOS token        = 2 '</s>'
0.00.340.310 I print_info: UNK token        = 3 '<unk>'
0.00.340.310 I print_info: SEP token        = 2 '</s>'
0.00.340.310 I print_info: PAD token        = 1 '<pad>'
0.00.340.311 I print_info: MASK token       = 4 '<mask>'
0.00.340.311 I print_info: EOG token        = 2 '</s>'
0.00.340.311 I print_info: max token length = 45
0.00.340.312 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.345.328 I load_tensors:          AMX model buffer size =    18.00 MiB
0.00.345.350 I load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.351.419 I llama_init_from_model: n_seq_max     = 1
0.00.351.437 I llama_init_from_model: n_ctx         = 8192
0.00.351.437 I llama_init_from_model: n_ctx_per_seq = 8192
0.00.351.438 I llama_init_from_model: n_batch       = 2048
0.00.351.438 I llama_init_from_model: n_ubatch      = 2048
0.00.351.438 I llama_init_from_model: flash_attn    = 0
0.00.351.440 I llama_init_from_model: freq_base     = 10000.0
0.00.351.441 I llama_init_from_model: freq_scale    = 1
0.00.351.458 I llama_kv_cache_init: kv_size = 8192, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 4, can_shift = 1
...
0.00.360.923 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.363.031 I llama_init_from_model:        CPU compute buffer size =   220.02 MiB
0.00.363.052 I llama_init_from_model: graph nodes  = 154
0.00.363.053 I llama_init_from_model: graph splits = 1
0.00.363.057 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 8192
0.00.363.057 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.371.165 I 
0.00.371.255 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.371.394 I main: prompt 0: 'what is panda?</s></s>hi'
...
0.00.371.413 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.418 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.316 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.383.082 I llama_perf_context_print:        load time =     370.85 ms
0.00.383.084 I llama_perf_context_print: prompt eval time =       7.57 ms /    62 tokens (    0.12 ms per token,  8195.64 tokens per second)
0.00.383.085 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.383.086 I llama_perf_context_print:       total time =      11.92 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.264 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.063.361 I print_info: n_head           = 16
...
0.00.063.374 I print_info: causal attn      = 1
0.00.063.374 I print_info: pooling type     = 0
0.00.063.374 I print_info: rope type        = 2
0.00.063.375 I print_info: rope scaling     = linear
...
0.00.196.757 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.196.773 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.015.999 I llama_init_from_model: n_seq_max     = 1
0.01.016.016 I llama_init_from_model: n_ctx         = 2048
0.01.016.017 I llama_init_from_model: n_ctx_per_seq = 2048
0.01.016.017 I llama_init_from_model: n_batch       = 2048
0.01.016.017 I llama_init_from_model: n_ubatch      = 512
0.01.016.018 I llama_init_from_model: flash_attn    = 0
0.01.016.023 I llama_init_from_model: freq_base     = 10000.0
0.01.016.024 I llama_init_from_model: freq_scale    = 1
0.01.016.053 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.088.032 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.088.063 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.088.099 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.091.447 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.01.091.468 I llama_init_from_model: graph nodes  = 967
0.01.091.468 I llama_init_from_model: graph splits = 1
0.01.091.481 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.01.091.921 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.01.091.934 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.198.252 I main: llama threadpool init, n_threads = 4
0.01.198.276 I 
0.01.198.351 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.198.364 I 
0.01.198.455 I sampler seed: 1234
0.01.198.474 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.198.477 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.198.477 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.198.477 I 
...
0.05.224.744 I llama_perf_sampler_print:    sampling time =       2.52 ms /    71 runs   (    0.04 ms per token, 28152.26 tokens per second)
0.05.224.747 I llama_perf_context_print:        load time =    1196.70 ms
0.05.224.748 I llama_perf_context_print: prompt eval time =     103.54 ms /     7 tokens (   14.79 ms per token,    67.61 tokens per second)
0.05.224.749 I llama_perf_context_print:        eval time =    3910.85 ms /    63 runs   (   62.08 ms per token,    16.11 tokens per second)
0.05.224.750 I llama_perf_context_print:       total time =    4027.56 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.346 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.560 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.021.212 I print_info: file type   = all F32 (guessed)
0.00.021.214 I print_info: file size   = 2.64 GiB (16.01 BPW) 
...
0.00.204.191 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.204.211 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.039.697 I llama_init_from_model: n_seq_max     = 1
0.01.039.716 I llama_init_from_model: n_ctx         = 128
0.01.039.716 I llama_init_from_model: n_ctx_per_seq = 128
0.01.039.717 I llama_init_from_model: n_batch       = 128
0.01.039.717 I llama_init_from_model: n_ubatch      = 128
0.01.039.718 I llama_init_from_model: flash_attn    = 0
0.01.039.723 I llama_init_from_model: freq_base     = 10000.0
0.01.039.724 I llama_init_from_model: freq_scale    = 1
0.01.039.725 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.039.753 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.044.419 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.044.448 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.044.479 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.047.728 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.01.047.750 I llama_init_from_model: graph nodes  = 967
0.01.047.751 I llama_init_from_model: graph splits = 1
0.01.047.755 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.01.047.756 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.119.632 I 
0.01.119.743 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.119.762 I perplexity: tokenizing the input ..
0.01.126.387 I perplexity: tokenization took 6.621 ms
0.01.126.419 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.158.198 I perplexity: 1.03 seconds per pass - ETA 0.02 minutes
[1]10.1485,
0.02.162.086 I Final estimate: PPL = 10.1485 +/- 3.22644

0.02.162.134 I llama_perf_context_print:        load time =    1119.22 ms
0.02.162.160 I llama_perf_context_print: prompt eval time =    1029.88 ms /   128 tokens (    8.05 ms per token,   124.29 tokens per second)
0.02.162.174 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.162.175 I llama_perf_context_print:       total time =    1042.50 ms /   129 tokens
...
0.00.151.518 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.151.540 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.310.895 I llama_init_from_model: n_seq_max     = 1
0.00.310.925 I llama_init_from_model: n_ctx         = 2048
0.00.310.932 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.310.939 I llama_init_from_model: n_batch       = 2048
0.00.310.946 I llama_init_from_model: n_ubatch      = 512
0.00.310.953 I llama_init_from_model: flash_attn    = 0
0.00.310.963 I llama_init_from_model: freq_base     = 10000.0
0.00.310.972 I llama_init_from_model: freq_scale    = 1
0.00.311.006 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.382.570 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.382.664 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.382.712 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.386.002 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.386.017 I llama_init_from_model: graph nodes  = 967
0.00.386.017 I llama_init_from_model: graph splits = 1
0.00.386.031 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.386.417 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.386.430 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.479.217 I main: llama threadpool init, n_threads = 4
0.00.479.236 I 
0.00.479.322 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.479.337 I 
0.00.479.467 I sampler seed: 1234
0.00.479.488 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.479.491 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.479.491 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.479.491 I 
I believe the meaning of life is to die, not live." "We're all going to die." "We all are." "We're all going to die." "The answer is no." "I can't do it." "What?" "I can't do it." "What?" "The answer is no." "No!" "It

0.02.740.488 I llama_perf_sampler_print:    sampling time =       2.39 ms /    71 runs   (    0.03 ms per token, 29694.69 tokens per second)
0.02.740.492 I llama_perf_context_print:        load time =     477.57 ms
0.02.740.493 I llama_perf_context_print: prompt eval time =      50.22 ms /     7 tokens (    7.17 ms per token,   139.39 tokens per second)
0.02.740.494 I llama_perf_context_print:        eval time =    2198.42 ms /    63 runs   (   34.90 ms per token,    28.66 tokens per second)
0.02.740.495 I llama_perf_context_print:       total time =    2262.43 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.319 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.154.066 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.154.086 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.315.199 I llama_init_from_model: n_seq_max     = 1
0.00.315.235 I llama_init_from_model: n_ctx         = 128
0.00.315.242 I llama_init_from_model: n_ctx_per_seq = 128
0.00.315.248 I llama_init_from_model: n_batch       = 128
0.00.315.254 I llama_init_from_model: n_ubatch      = 128
0.00.315.261 I llama_init_from_model: flash_attn    = 0
0.00.315.272 I llama_init_from_model: freq_base     = 10000.0
0.00.315.281 I llama_init_from_model: freq_scale    = 1
0.00.315.288 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.315.322 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.320.137 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.320.183 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.320.221 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.323.563 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.323.598 I llama_init_from_model: graph nodes  = 967
0.00.323.605 I llama_init_from_model: graph splits = 1
0.00.323.616 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.323.623 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.376.246 I 
0.00.376.368 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.376.392 I perplexity: tokenizing the input ..
0.00.382.983 I perplexity: tokenization took 6.587 ms
0.00.383.015 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.783.031 I perplexity: 0.40 seconds per pass - ETA 0.00 minutes
[1]10.1611,
0.00.786.766 I Final estimate: PPL = 10.1611 +/- 3.23215

0.00.786.839 I llama_perf_context_print:        load time =     375.88 ms
0.00.786.840 I llama_perf_context_print: prompt eval time =     398.06 ms /   128 tokens (    3.11 ms per token,   321.56 tokens per second)
0.00.786.841 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.786.842 I llama_perf_context_print:       total time =     410.59 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.266 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.111.066 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.111.088 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.226.894 I llama_init_from_model: n_seq_max     = 1
0.00.226.913 I llama_init_from_model: n_ctx         = 2048
0.00.226.913 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.226.914 I llama_init_from_model: n_batch       = 2048
0.00.226.914 I llama_init_from_model: n_ubatch      = 512
0.00.226.916 I llama_init_from_model: flash_attn    = 0
0.00.226.923 I llama_init_from_model: freq_base     = 10000.0
0.00.226.925 I llama_init_from_model: freq_scale    = 1
0.00.226.967 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.298.845 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.298.880 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.298.918 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.302.268 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.302.287 I llama_init_from_model: graph nodes  = 967
0.00.302.288 I llama_init_from_model: graph splits = 1
0.00.302.304 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.302.753 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.302.765 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.386.595 I main: llama threadpool init, n_threads = 4
0.00.386.615 I 
0.00.386.715 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.386.729 I 
0.00.386.852 I sampler seed: 1234
0.00.386.874 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.386.879 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.386.881 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.386.881 I 
I believe the meaning of life is to know and experience what you love and to do it." "If you love something, set it free." "You might just find something you didn't know you wanted." "I've always wanted to know the truth." "Now I have." "So I'm gonna get to the truth." "I'm gonna

0.01.920.276 I llama_perf_sampler_print:    sampling time =       2.56 ms /    71 runs   (    0.04 ms per token, 27745.21 tokens per second)
0.01.920.280 I llama_perf_context_print:        load time =     384.89 ms
0.01.920.281 I llama_perf_context_print: prompt eval time =      49.36 ms /     7 tokens (    7.05 ms per token,   141.82 tokens per second)
0.01.920.283 I llama_perf_context_print:        eval time =    1471.72 ms /    63 runs   (   23.36 ms per token,    42.81 tokens per second)
0.01.920.284 I llama_perf_context_print:       total time =    1534.84 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.314 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.166 I print_info: file type   = Q4_0
...
0.00.063.803 I print_info: n_embd_k_gqa     = 2048
...
0.00.111.078 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.111.100 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.220.584 I llama_init_from_model: n_seq_max     = 1
0.00.220.597 I llama_init_from_model: n_ctx         = 128
0.00.220.598 I llama_init_from_model: n_ctx_per_seq = 128
0.00.220.599 I llama_init_from_model: n_batch       = 128
0.00.220.599 I llama_init_from_model: n_ubatch      = 128
0.00.220.600 I llama_init_from_model: flash_attn    = 0
0.00.220.606 I llama_init_from_model: freq_base     = 10000.0
0.00.220.607 I llama_init_from_model: freq_scale    = 1
0.00.220.608 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.220.648 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.225.314 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.225.346 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.225.380 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.228.737 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.228.752 I llama_init_from_model: graph nodes  = 967
0.00.228.753 I llama_init_from_model: graph splits = 1
0.00.228.758 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.228.758 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.275.037 I 
0.00.275.158 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.275.182 I perplexity: tokenizing the input ..
0.00.281.712 I perplexity: tokenization took 6.527 ms
0.00.281.744 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.719.915 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]14.1117,
0.00.723.732 I Final estimate: PPL = 14.1117 +/- 4.42919

0.00.723.775 I llama_perf_context_print:        load time =     274.68 ms
0.00.723.788 I llama_perf_context_print: prompt eval time =     436.31 ms /   128 tokens (    3.41 ms per token,   293.37 tokens per second)
0.00.723.789 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.723.790 I llama_perf_context_print:       total time =     448.74 ms /   129 tokens
...
0.00.021.375 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
...
0.00.021.384 I print_info: file size   = 864.46 MiB (5.13 BPW) 
0.00.052.398 I load: special tokens cache size = 25
0.00.064.239 I load: token to piece cache size = 0.2984 MB
...
0.00.123.049 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.123.052 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.254.078 I llama_init_from_model: n_seq_max     = 1
0.00.254.108 I llama_init_from_model: n_ctx         = 2048
0.00.254.115 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.254.122 I llama_init_from_model: n_batch       = 2048
0.00.254.128 I llama_init_from_model: n_ubatch      = 512
0.00.254.135 I llama_init_from_model: flash_attn    = 0
0.00.254.157 I llama_init_from_model: freq_base     = 10000.0
0.00.254.165 I llama_init_from_model: freq_scale    = 1
0.00.254.199 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.327.273 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.327.308 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.327.348 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.330.894 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.330.916 I llama_init_from_model: graph nodes  = 967
0.00.330.917 I llama_init_from_model: graph splits = 1
0.00.330.969 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.331.336 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.331.349 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.412.923 I main: llama threadpool init, n_threads = 4
0.00.412.972 I 
0.00.413.046 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.413.046 I 
0.00.413.149 I sampler seed: 1234
0.00.413.156 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.413.161 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.413.162 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.413.162 I 
...
0.02.035.906 I llama_perf_sampler_print:    sampling time =       2.36 ms /    71 runs   (    0.03 ms per token, 30097.50 tokens per second)
0.02.035.909 I llama_perf_context_print:        load time =     411.31 ms
0.02.035.910 I llama_perf_context_print: prompt eval time =      46.22 ms /     7 tokens (    6.60 ms per token,   151.46 tokens per second)
0.02.035.911 I llama_perf_context_print:        eval time =    1564.95 ms /    63 runs   (   24.84 ms per token,    40.26 tokens per second)
0.02.035.912 I llama_perf_context_print:       total time =    1624.10 ms /    70 tokens
...
0.00.021.004 I print_info: file type   = Q4_1
0.00.021.007 I print_info: file size   = 864.46 MiB (5.13 BPW) 
...
0.00.122.484 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.122.506 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.249.333 I llama_init_from_model: n_seq_max     = 1
0.00.249.350 I llama_init_from_model: n_ctx         = 128
0.00.249.351 I llama_init_from_model: n_ctx_per_seq = 128
0.00.249.351 I llama_init_from_model: n_batch       = 128
0.00.249.352 I llama_init_from_model: n_ubatch      = 128
0.00.249.352 I llama_init_from_model: flash_attn    = 0
0.00.249.357 I llama_init_from_model: freq_base     = 10000.0
0.00.249.358 I llama_init_from_model: freq_scale    = 1
0.00.249.359 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.249.386 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.253.995 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.254.023 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.254.054 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.257.236 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.257.251 I llama_init_from_model: graph nodes  = 967
0.00.257.252 I llama_init_from_model: graph splits = 1
0.00.257.256 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.257.256 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.301.731 I 
0.00.301.843 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.301.864 I perplexity: tokenizing the input ..
0.00.308.421 I perplexity: tokenization took 6.553 ms
0.00.308.455 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.765.228 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]12.6944,
0.00.769.143 I Final estimate: PPL = 12.6944 +/- 3.90928

0.00.769.184 I llama_perf_context_print:        load time =     301.37 ms
0.00.769.208 I llama_perf_context_print: prompt eval time =     454.79 ms /   128 tokens (    3.55 ms per token,   281.45 tokens per second)
0.00.769.209 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.769.210 I llama_perf_context_print:       total time =     467.45 ms /   129 tokens
...
0.00.128.176 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.128.192 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.141.818 I llama_init_from_model: n_seq_max     = 1
0.00.141.834 I llama_init_from_model: n_ctx         = 2048
0.00.141.835 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.141.835 I llama_init_from_model: n_batch       = 2048
0.00.141.836 I llama_init_from_model: n_ubatch      = 512
0.00.141.836 I llama_init_from_model: flash_attn    = 0
0.00.141.900 I llama_init_from_model: freq_base     = 10000.0
0.00.141.901 I llama_init_from_model: freq_scale    = 1
0.00.141.922 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.212.463 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.212.491 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.212.514 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.215.740 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.215.761 I llama_init_from_model: graph nodes  = 967
0.00.215.761 I llama_init_from_model: graph splits = 1
0.00.215.772 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.216.218 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.216.231 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.326.165 I main: llama threadpool init, n_threads = 4
0.00.326.187 I 
0.00.326.260 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.326.272 I 
0.00.326.368 I sampler seed: 1234
0.00.326.388 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.326.391 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.326.392 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.326.393 I 
...
0.02.825.640 I llama_perf_sampler_print:    sampling time =       2.38 ms /    71 runs   (    0.03 ms per token, 29831.93 tokens per second)
0.02.825.643 I llama_perf_context_print:        load time =     324.56 ms
0.02.825.644 I llama_perf_context_print: prompt eval time =     134.15 ms /     7 tokens (   19.16 ms per token,    52.18 tokens per second)
0.02.825.645 I llama_perf_context_print:        eval time =    2353.15 ms /    63 runs   (   37.35 ms per token,    26.77 tokens per second)
0.02.825.646 I llama_perf_context_print:       total time =    2500.59 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.364 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.064.665 I print_info: rope type        = 2
...
0.00.064.671 I print_info: model params     = 1.41 B
...
0.00.130.025 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.130.048 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.144.178 I llama_init_from_model: n_seq_max     = 1
0.00.144.197 I llama_init_from_model: n_ctx         = 128
0.00.144.198 I llama_init_from_model: n_ctx_per_seq = 128
0.00.144.198 I llama_init_from_model: n_batch       = 128
0.00.144.198 I llama_init_from_model: n_ubatch      = 128
...
0.00.144.203 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.144.230 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.148.892 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.148.921 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.148.949 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.152.163 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.152.184 I llama_init_from_model: graph nodes  = 967
0.00.152.185 I llama_init_from_model: graph splits = 1
0.00.152.189 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.152.189 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.224.810 I 
0.00.224.918 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.224.937 I perplexity: tokenizing the input ..
0.00.231.228 I perplexity: tokenization took 6.287 ms
0.00.231.257 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.365.032 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0822,
0.01.368.704 I Final estimate: PPL = 10.0822 +/- 3.20340

0.01.368.743 I llama_perf_context_print:        load time =     224.40 ms
0.01.368.745 I llama_perf_context_print: prompt eval time =    1131.94 ms /   128 tokens (    8.84 ms per token,   113.08 tokens per second)
0.01.368.747 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.368.749 I llama_perf_context_print:       total time =    1143.93 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.316 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.411 I print_info: file size   = 1020.74 MiB (6.05 BPW) 
...
0.00.064.425 I print_info: LF token         = 187 'Ċ'
...
0.00.133.236 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.133.250 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.146.993 I llama_init_from_model: n_seq_max     = 1
0.00.147.011 I llama_init_from_model: n_ctx         = 2048
0.00.147.012 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.147.012 I llama_init_from_model: n_batch       = 2048
0.00.147.012 I llama_init_from_model: n_ubatch      = 512
0.00.147.013 I llama_init_from_model: flash_attn    = 0
0.00.147.016 I llama_init_from_model: freq_base     = 10000.0
0.00.147.016 I llama_init_from_model: freq_scale    = 1
0.00.147.044 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.218.765 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.218.794 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.218.823 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.222.129 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.222.179 I llama_init_from_model: graph nodes  = 967
0.00.222.179 I llama_init_from_model: graph splits = 1
0.00.222.191 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.222.604 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.222.617 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.326.921 I main: llama threadpool init, n_threads = 4
0.00.326.943 I 
0.00.327.019 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.327.019 I 
0.00.327.114 I sampler seed: 1234
0.00.327.169 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
...
0.02.955.099 I llama_perf_sampler_print:    sampling time =       2.41 ms /    71 runs   (    0.03 ms per token, 29411.76 tokens per second)
0.02.955.102 I llama_perf_context_print:        load time =     325.30 ms
0.02.955.104 I llama_perf_context_print: prompt eval time =     135.19 ms /     7 tokens (   19.31 ms per token,    51.78 tokens per second)
0.02.955.105 I llama_perf_context_print:        eval time =    2481.23 ms /    63 runs   (   39.38 ms per token,    25.39 tokens per second)
0.02.955.106 I llama_perf_context_print:       total time =    2629.26 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.338 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.930 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.021.514 I print_info: file type   = Q5_1
0.00.021.517 I print_info: file size   = 1020.74 MiB (6.05 BPW) 
...
0.00.133.861 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.133.875 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.147.237 I llama_init_from_model: n_seq_max     = 1
0.00.147.255 I llama_init_from_model: n_ctx         = 128
0.00.147.256 I llama_init_from_model: n_ctx_per_seq = 128
0.00.147.256 I llama_init_from_model: n_batch       = 128
0.00.147.257 I llama_init_from_model: n_ubatch      = 128
0.00.147.257 I llama_init_from_model: flash_attn    = 0
0.00.147.260 I llama_init_from_model: freq_base     = 10000.0
0.00.147.261 I llama_init_from_model: freq_scale    = 1
0.00.147.262 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.147.284 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.152.001 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.152.030 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.152.058 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.155.263 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.155.279 I llama_init_from_model: graph nodes  = 967
0.00.155.280 I llama_init_from_model: graph splits = 1
0.00.155.284 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.155.284 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.219.387 I 
0.00.219.508 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.219.530 I perplexity: tokenizing the input ..
0.00.225.940 I perplexity: tokenization took 6.406 ms
0.00.225.970 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.204.308 I perplexity: 1.98 seconds per pass - ETA 0.02 minutes
[1]10.1864,
0.02.208.977 I Final estimate: PPL = 10.1864 +/- 3.18686

0.02.209.022 I llama_perf_context_print:        load time =     218.98 ms
0.02.209.040 I llama_perf_context_print: prompt eval time =    1976.40 ms /   128 tokens (   15.44 ms per token,    64.76 tokens per second)
0.02.209.041 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.209.042 I llama_perf_context_print:       total time =    1989.64 ms /   129 tokens
...
0.00.021.086 I print_info: file type   = Q2_K - Medium
...
0.00.100.762 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.100.778 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.114.219 I llama_init_from_model: n_seq_max     = 1
0.00.114.239 I llama_init_from_model: n_ctx         = 2048
0.00.114.239 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.114.239 I llama_init_from_model: n_batch       = 2048
0.00.114.239 I llama_init_from_model: n_ubatch      = 512
0.00.114.240 I llama_init_from_model: flash_attn    = 0
0.00.114.242 I llama_init_from_model: freq_base     = 10000.0
0.00.114.243 I llama_init_from_model: freq_scale    = 1
0.00.114.270 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.186.195 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.186.224 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.186.248 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.189.553 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
...
0.00.189.995 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.190.007 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.272.221 I main: llama threadpool init, n_threads = 4
0.00.272.242 I 
0.00.272.316 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.272.317 I 
0.00.272.414 I sampler seed: 1234
...
0.00.272.486 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.272.486 I 
...
0.01.829.426 I llama_perf_sampler_print:    sampling time =       2.14 ms /    71 runs   (    0.03 ms per token, 33193.08 tokens per second)
0.01.829.429 I llama_perf_context_print:        load time =     270.60 ms
0.01.829.431 I llama_perf_context_print: prompt eval time =      82.23 ms /     7 tokens (   11.75 ms per token,    85.13 tokens per second)
0.01.829.432 I llama_perf_context_print:        eval time =    1463.40 ms /    63 runs   (   23.23 ms per token,    43.05 tokens per second)
0.01.829.432 I llama_perf_context_print:       total time =    1558.28 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.315 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.101.137 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.101.154 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.114.234 I llama_init_from_model: n_seq_max     = 1
0.00.114.251 I llama_init_from_model: n_ctx         = 128
0.00.114.251 I llama_init_from_model: n_ctx_per_seq = 128
0.00.114.252 I llama_init_from_model: n_batch       = 128
0.00.114.252 I llama_init_from_model: n_ubatch      = 128
0.00.114.252 I llama_init_from_model: flash_attn    = 0
0.00.114.255 I llama_init_from_model: freq_base     = 10000.0
0.00.114.256 I llama_init_from_model: freq_scale    = 1
0.00.114.257 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.114.277 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.119.310 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.119.338 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.119.364 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.122.451 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.122.467 I llama_init_from_model: graph nodes  = 967
0.00.122.467 I llama_init_from_model: graph splits = 1
0.00.122.471 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
...
0.00.167.504 I perplexity: tokenizing the input ..
0.00.173.974 I perplexity: tokenization took 6.467 ms
0.00.174.003 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.475.564 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]70.7471,
0.01.479.280 I Final estimate: PPL = 70.7471 +/- 27.47559

0.01.479.320 I llama_perf_context_print:        load time =     166.97 ms
0.01.479.322 I llama_perf_context_print: prompt eval time =    1299.65 ms /   128 tokens (   10.15 ms per token,    98.49 tokens per second)
0.01.479.324 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.479.325 I llama_perf_context_print:       total time =    1311.99 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.261 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.114.019 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.114.038 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.198.429 I llama_init_from_model: n_seq_max     = 1
0.00.198.447 I llama_init_from_model: n_ctx         = 2048
0.00.198.448 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.198.448 I llama_init_from_model: n_batch       = 2048
0.00.198.448 I llama_init_from_model: n_ubatch      = 512
0.00.198.449 I llama_init_from_model: flash_attn    = 0
0.00.198.454 I llama_init_from_model: freq_base     = 10000.0
0.00.198.455 I llama_init_from_model: freq_scale    = 1
0.00.198.483 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.268.993 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.269.025 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.269.059 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.272.213 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.272.229 I llama_init_from_model: graph nodes  = 967
0.00.272.229 I llama_init_from_model: graph splits = 1
0.00.272.241 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.272.628 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.272.640 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.352.941 I main: llama threadpool init, n_threads = 4
0.00.352.963 I 
0.00.353.039 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.353.051 I 
0.00.353.145 I sampler seed: 1234
0.00.353.165 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.353.169 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.171.497 I llama_perf_sampler_print:    sampling time =       2.47 ms /    71 runs   (    0.03 ms per token, 28744.94 tokens per second)
0.02.171.500 I llama_perf_context_print:        load time =     351.38 ms
0.02.171.501 I llama_perf_context_print: prompt eval time =      75.46 ms /     7 tokens (   10.78 ms per token,    92.77 tokens per second)
0.02.171.502 I llama_perf_context_print:        eval time =    1731.34 ms /    63 runs   (   27.48 ms per token,    36.39 tokens per second)
0.02.171.502 I llama_perf_context_print:       total time =    1819.64 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.321 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.826 I print_info: file type   = Q3_K - Medium
...
0.00.112.978 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.112.996 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.197.488 I llama_init_from_model: n_seq_max     = 1
0.00.197.524 I llama_init_from_model: n_ctx         = 128
0.00.197.531 I llama_init_from_model: n_ctx_per_seq = 128
0.00.197.537 I llama_init_from_model: n_batch       = 128
0.00.197.544 I llama_init_from_model: n_ubatch      = 128
0.00.197.550 I llama_init_from_model: flash_attn    = 0
0.00.197.560 I llama_init_from_model: freq_base     = 10000.0
0.00.197.567 I llama_init_from_model: freq_scale    = 1
0.00.197.576 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.197.610 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.202.443 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.202.472 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.202.506 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.205.969 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.205.985 I llama_init_from_model: graph nodes  = 967
0.00.205.985 I llama_init_from_model: graph splits = 1
0.00.205.990 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.205.990 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.256.626 I 
0.00.256.770 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.256.793 I perplexity: tokenizing the input ..
0.00.263.263 I perplexity: tokenization took 6.466 ms
0.00.263.294 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.166.819 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]12.3725,
0.01.170.584 I Final estimate: PPL = 12.3725 +/- 4.01345

0.01.170.626 I llama_perf_context_print:        load time =     256.26 ms
0.01.170.715 I llama_perf_context_print: prompt eval time =     901.68 ms /   128 tokens (    7.04 ms per token,   141.96 tokens per second)
0.01.170.716 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.170.717 I llama_perf_context_print:       total time =     914.00 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.255 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.121.748 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.121.764 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.242.970 I llama_init_from_model: n_seq_max     = 1
0.00.242.989 I llama_init_from_model: n_ctx         = 2048
0.00.242.989 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.242.990 I llama_init_from_model: n_batch       = 2048
0.00.242.990 I llama_init_from_model: n_ubatch      = 512
0.00.242.991 I llama_init_from_model: flash_attn    = 0
0.00.242.996 I llama_init_from_model: freq_base     = 10000.0
0.00.242.997 I llama_init_from_model: freq_scale    = 1
0.00.243.025 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.313.803 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.313.833 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.313.870 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.317.230 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.317.247 I llama_init_from_model: graph nodes  = 967
0.00.317.247 I llama_init_from_model: graph splits = 1
0.00.317.259 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.317.705 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.317.717 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.421.511 I main: llama threadpool init, n_threads = 4
0.00.421.536 I 
0.00.421.612 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.421.626 I 
0.00.421.746 I sampler seed: 1234
...
0.00.421.784 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.421.784 I 
...
0.02.529.896 I llama_perf_sampler_print:    sampling time =       2.46 ms /    71 runs   (    0.03 ms per token, 28897.03 tokens per second)
0.02.529.899 I llama_perf_context_print:        load time =     419.88 ms
0.02.529.900 I llama_perf_context_print: prompt eval time =      66.06 ms /     7 tokens (    9.44 ms per token,   105.97 tokens per second)
0.02.529.901 I llama_perf_context_print:        eval time =    2030.14 ms /    63 runs   (   32.22 ms per token,    31.03 tokens per second)
0.02.529.902 I llama_perf_context_print:       total time =    2109.50 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.333 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.063.626 I print_info: n_embd_head_k    = 128
...
0.00.121.792 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.121.809 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.243.207 I llama_init_from_model: n_seq_max     = 1
0.00.243.225 I llama_init_from_model: n_ctx         = 128
0.00.243.226 I llama_init_from_model: n_ctx_per_seq = 128
0.00.243.226 I llama_init_from_model: n_batch       = 128
0.00.243.226 I llama_init_from_model: n_ubatch      = 128
0.00.243.227 I llama_init_from_model: flash_attn    = 0
0.00.243.233 I llama_init_from_model: freq_base     = 10000.0
0.00.243.234 I llama_init_from_model: freq_scale    = 1
0.00.243.235 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.243.265 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.247.842 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.247.870 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.247.901 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.251.162 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.251.178 I llama_init_from_model: graph nodes  = 967
0.00.251.179 I llama_init_from_model: graph splits = 1
0.00.251.183 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.251.183 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.312.591 I 
0.00.312.716 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.312.741 I perplexity: tokenizing the input ..
0.00.319.270 I perplexity: tokenization took 6.525 ms
0.00.319.301 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.893.444 I perplexity: 0.57 seconds per pass - ETA 0.00 minutes
[1]10.3355,
0.00.897.131 I Final estimate: PPL = 10.3355 +/- 3.28881

0.00.897.174 I llama_perf_context_print:        load time =     312.21 ms
0.00.897.198 I llama_perf_context_print: prompt eval time =     572.28 ms /   128 tokens (    4.47 ms per token,   223.67 tokens per second)
0.00.897.199 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.897.200 I llama_perf_context_print:       total time =     584.58 ms /   129 tokens
...
0.00.021.347 I print_info: file type   = Q5_K - Medium
0.00.021.350 I print_info: file size   = 1006.35 MiB (5.97 BPW) 
...
0.00.131.321 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.131.342 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.264.284 I llama_init_from_model: n_seq_max     = 1
0.00.264.320 I llama_init_from_model: n_ctx         = 2048
0.00.264.328 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.264.337 I llama_init_from_model: n_batch       = 2048
0.00.264.345 I llama_init_from_model: n_ubatch      = 512
0.00.264.353 I llama_init_from_model: flash_attn    = 0
0.00.264.367 I llama_init_from_model: freq_base     = 10000.0
0.00.264.377 I llama_init_from_model: freq_scale    = 1
0.00.264.435 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.335.952 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.336.001 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.336.046 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.339.346 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.339.385 I llama_init_from_model: graph nodes  = 967
0.00.339.394 I llama_init_from_model: graph splits = 1
0.00.339.416 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.339.882 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.339.903 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.442.811 I main: llama threadpool init, n_threads = 4
0.00.442.832 I 
0.00.442.914 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.442.928 I 
0.00.443.065 I sampler seed: 1234
0.00.443.085 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.443.088 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.443.089 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.443.089 I 
...
0.03.003.144 I llama_perf_sampler_print:    sampling time =       2.45 ms /    71 runs   (    0.03 ms per token, 28955.95 tokens per second)
0.03.003.148 I llama_perf_context_print:        load time =     441.24 ms
0.03.003.149 I llama_perf_context_print: prompt eval time =      89.06 ms /     7 tokens (   12.72 ms per token,    78.59 tokens per second)
0.03.003.150 I llama_perf_context_print:        eval time =    2459.53 ms /    63 runs   (   39.04 ms per token,    25.61 tokens per second)
0.03.003.151 I llama_perf_context_print:       total time =    2561.43 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.326 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.062.907 I print_info: freq_base_train  = 10000.0
0.00.062.907 I print_info: freq_scale_train = 1
0.00.062.908 I print_info: n_ctx_orig_yarn  = 2048
0.00.062.908 I print_info: rope_finetuned   = unknown
0.00.062.908 I print_info: ssm_d_conv       = 0
0.00.062.908 I print_info: ssm_d_inner      = 0
0.00.062.909 I print_info: ssm_d_state      = 0
0.00.062.909 I print_info: ssm_dt_rank      = 0
0.00.062.909 I print_info: ssm_dt_b_c_rms   = 0
0.00.062.910 I print_info: model type       = 1.4B
0.00.062.910 I print_info: model params     = 1.41 B
0.00.062.911 I print_info: general.name     = 1.4B
0.00.062.913 I print_info: vocab type       = BPE
...
0.00.129.344 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.129.365 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.263.518 I llama_init_from_model: n_seq_max     = 1
0.00.263.553 I llama_init_from_model: n_ctx         = 128
0.00.263.560 I llama_init_from_model: n_ctx_per_seq = 128
0.00.263.567 I llama_init_from_model: n_batch       = 128
0.00.263.573 I llama_init_from_model: n_ubatch      = 128
0.00.263.580 I llama_init_from_model: flash_attn    = 0
0.00.263.591 I llama_init_from_model: freq_base     = 10000.0
0.00.263.601 I llama_init_from_model: freq_scale    = 1
0.00.263.608 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.263.649 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.268.145 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.268.175 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.268.210 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.271.469 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.271.486 I llama_init_from_model: graph nodes  = 967
0.00.271.486 I llama_init_from_model: graph splits = 1
0.00.271.492 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.271.492 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.347.590 I 
0.00.347.703 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.347.724 I perplexity: tokenizing the input ..
0.00.354.276 I perplexity: tokenization took 6.548 ms
0.00.354.308 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.021.309 I perplexity: 0.67 seconds per pass - ETA 0.00 minutes
[1]11.0242,
0.01.025.039 I Final estimate: PPL = 11.0242 +/- 3.53494

0.01.025.082 I llama_perf_context_print:        load time =     347.22 ms
0.01.025.097 I llama_perf_context_print: prompt eval time =     665.22 ms /   128 tokens (    5.20 ms per token,   192.42 tokens per second)
0.01.025.098 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.025.099 I llama_perf_context_print:       total time =     677.49 ms /   129 tokens
...
0.00.125.732 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.125.748 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.264.020 I llama_init_from_model: n_seq_max     = 1
0.00.264.056 I llama_init_from_model: n_ctx         = 2048
0.00.264.063 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.264.070 I llama_init_from_model: n_batch       = 2048
0.00.264.076 I llama_init_from_model: n_ubatch      = 512
0.00.264.082 I llama_init_from_model: flash_attn    = 0
0.00.264.094 I llama_init_from_model: freq_base     = 10000.0
0.00.264.102 I llama_init_from_model: freq_scale    = 1
0.00.264.138 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.339.313 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.339.346 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.339.381 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.342.826 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.342.840 I llama_init_from_model: graph nodes  = 967
0.00.342.841 I llama_init_from_model: graph splits = 1
0.00.342.853 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.343.266 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.343.278 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.491.244 I main: llama threadpool init, n_threads = 4
0.00.491.265 I 
0.00.491.335 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.491.337 I 
0.00.491.432 I sampler seed: 1234
0.00.491.453 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.491.456 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.491.456 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.491.457 I 
...
0.03.174.922 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30511.39 tokens per second)
0.03.174.926 I llama_perf_context_print:        load time =     489.57 ms
0.03.174.927 I llama_perf_context_print: prompt eval time =     116.06 ms /     7 tokens (   16.58 ms per token,    60.31 tokens per second)
0.03.174.928 I llama_perf_context_print:        eval time =    2555.88 ms /    63 runs   (   40.57 ms per token,    24.65 tokens per second)
0.03.174.929 I llama_perf_context_print:       total time =    2684.83 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.341 I build: 4866 (89b2b56e) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.125.230 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.125.253 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.264.126 I llama_init_from_model: n_seq_max     = 1
0.00.264.161 I llama_init_from_model: n_ctx         = 128
0.00.264.168 I llama_init_from_model: n_ctx_per_seq = 128
0.00.264.174 I llama_init_from_model: n_batch       = 128
0.00.264.181 I llama_init_from_model: n_ubatch      = 128
0.00.264.188 I llama_init_from_model: flash_attn    = 0
0.00.264.214 I llama_init_from_model: freq_base     = 10000.0
0.00.264.221 I llama_init_from_model: freq_scale    = 1
0.00.264.229 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.264.264 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.268.947 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.268.985 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.269.026 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.272.527 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.272.559 I llama_init_from_model: graph nodes  = 967
0.00.272.566 I llama_init_from_model: graph splits = 1
0.00.272.577 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.272.584 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.364.422 I 
0.00.364.531 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | BMI2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.364.551 I perplexity: tokenizing the input ..
0.00.371.040 I perplexity: tokenization took 6.485 ms
0.00.371.071 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.190.729 I perplexity: 0.82 seconds per pass - ETA 0.00 minutes
[1]10.3482,
0.01.194.650 I Final estimate: PPL = 10.3482 +/- 3.30522

0.01.194.692 I llama_perf_context_print:        load time =     364.04 ms
0.01.194.707 I llama_perf_context_print: prompt eval time =     817.73 ms /   128 tokens (    6.39 ms per token,   156.53 tokens per second)
0.01.194.708 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.194.709 I llama_perf_context_print:       total time =     830.27 ms /   129 tokens
...
0.00.295.348 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.295.369 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_init_from_model: graph splits = 1
0.00.295.648 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.295.711 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_init_from_model: n_seq_max     = 1
llama_init_from_model: n_ctx         = 2048
llama_init_from_model: n_ctx_per_seq = 2048
...
0.59user 0.68system 0:01.26elapsed 100%CPU (0avgtext+0avgdata 5356848maxresident)k
