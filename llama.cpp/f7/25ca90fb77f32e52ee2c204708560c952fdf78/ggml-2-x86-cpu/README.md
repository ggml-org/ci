...
- status:  SUCCESS ✅
- runtime: 13:41.72
- date:    Mon Apr 22 12:07:03 UTC 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/f725ca90fb77f32e52ee2c204708560c952fdf78
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 2/23 Test  #2: test-quantize-perf ..................   Passed    9.34 sec
 ...
 9/23 Test  #9: test-tokenizer-1-falcon .............   Passed    6.12 sec
      Start 10: test-tokenizer-1-aquila
10/23 Test #10: test-tokenizer-1-aquila .............   Passed    8.70 sec
...
22/23 Test #22: test-rope ...........................   Passed    0.05 sec
      Start 25: test-json-schema-to-grammar
23/23 Test #25: test-json-schema-to-grammar .........   Passed    1.27 sec

100% tests passed, 0 tests failed out of 23

Label Time Summary:
main    =  30.87 sec*proc (23 tests)
...
llama_print_timings: prompt eval time =       6.07 ms /     9 tokens (    0.67 ms per token,  1481.97 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       5.25 ms /     9 tokens (    0.58 ms per token,  1713.63 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
The Mockingjay - Part 2 picks up right where the first film left off, with Katniss Everdeen
llama_print_timings:        load time =     820.49 ms
llama_print_timings:      sample time =      47.51 ms /    32 runs   (    1.48 ms per token,   673.56 tokens per second)
llama_print_timings: prompt eval time =     712.76 ms /     2 tokens (  356.38 ms per token,     2.81 tokens per second)
llama_print_timings:        eval time =   12959.78 ms /    31 runs   (  418.06 ms per token,     2.39 tokens per second)
llama_print_timings:       total time =   13849.45 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Soar is a program that helps users achieve their goals by providing them with a supportive and motivating environment.

**Program Features:**

* **Goal setting and tracking
llama_print_timings:        load time =     797.25 ms
llama_print_timings:      sample time =      48.20 ms /    32 runs   (    1.51 ms per token,   663.89 tokens per second)
llama_print_timings: prompt eval time =     730.17 ms /     2 tokens (  365.08 ms per token,     2.74 tokens per second)
llama_print_timings:        eval time =   13030.68 ms /    31 runs   (  420.34 ms per token,     2.38 tokens per second)
llama_print_timings:       total time =   13939.66 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 If the equation 2x + 5 = 19, what are the solutions?

To solve the equation, we need to isolate the variable x on
llama_print_timings:        load time =     801.52 ms
llama_print_timings:      sample time =      47.60 ms /    32 runs   (    1.49 ms per token,   672.21 tokens per second)
llama_print_timings: prompt eval time =     714.60 ms /     2 tokens (  357.30 ms per token,     2.80 tokens per second)
llama_print_timings:        eval time =   13041.56 ms /    31 runs   (  420.70 ms per token,     2.38 tokens per second)
llama_print_timings:       total time =   13935.83 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 The Mandalorian Season 2 finale was a cliffhanger, leaving fans on the edge of their seats. The episode's ending leaves us with more questions than answers,
llama_print_timings:        load time =     194.54 ms
llama_print_timings:      sample time =       6.12 ms /    32 runs   (    0.19 ms per token,  5225.34 tokens per second)
llama_print_timings: prompt eval time =      88.92 ms /     2 tokens (   44.46 ms per token,    22.49 tokens per second)
llama_print_timings:        eval time =    2122.05 ms /    31 runs   (   68.45 ms per token,    14.61 tokens per second)
llama_print_timings:       total time =    2277.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 When the narrator states that "she had a sharp mind and a quick mind", it is being used to describe:

A. Intelligence
B. Creativity
C
llama_print_timings:        load time =     170.12 ms
llama_print_timings:      sample time =       6.21 ms /    32 runs   (    0.19 ms per token,  5150.49 tokens per second)
llama_print_timings: prompt eval time =      88.72 ms /     2 tokens (   44.36 ms per token,    22.54 tokens per second)
llama_print_timings:        eval time =    2060.99 ms /    31 runs   (   66.48 ms per token,    15.04 tokens per second)
llama_print_timings:       total time =    2216.73 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**Hebert Hebert** is a fictional character in the Grand Theft Auto series. He is a member of the infamous Hebert family, and has
llama_print_timings:        load time =     170.67 ms
llama_print_timings:      sample time =       6.23 ms /    32 runs   (    0.19 ms per token,  5134.79 tokens per second)
llama_print_timings: prompt eval time =      92.22 ms /     2 tokens (   46.11 ms per token,    21.69 tokens per second)
llama_print_timings:        eval time =    2064.60 ms /    31 runs   (   66.60 ms per token,    15.02 tokens per second)
llama_print_timings:       total time =    2223.14 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     704.02 ms
llama_print_timings:      sample time =       2.46 ms /    64 runs   (    0.04 ms per token, 25963.49 tokens per second)
llama_print_timings: prompt eval time =     527.23 ms /     8 tokens (   65.90 ms per token,    15.17 tokens per second)
llama_print_timings:        eval time =   10247.41 ms /    63 runs   (  162.66 ms per token,     6.15 tokens per second)
llama_print_timings:       total time =   10797.82 ms /    71 tokens
Log end
...
[1]4.2453,
llama_print_timings:        load time =     686.67 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7684.53 ms /   128 tokens (   60.04 ms per token,    16.66 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7695.32 ms /   129 tokens
...
llama_print_timings:        load time =     422.36 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31730.29 tokens per second)
llama_print_timings: prompt eval time =     356.56 ms /     8 tokens (   44.57 ms per token,    22.44 tokens per second)
llama_print_timings:        eval time =    6488.76 ms /    63 runs   (  103.00 ms per token,     9.71 tokens per second)
llama_print_timings:       total time =    6864.94 ms /    71 tokens
Log end
...
[1]4.2539,
llama_print_timings:        load time =     413.67 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4959.99 ms /   128 tokens (   38.75 ms per token,    25.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4969.93 ms /   129 tokens
...
llama_print_timings: prompt eval time =     340.41 ms /     8 tokens (   42.55 ms per token,    23.50 tokens per second)
llama_print_timings:        eval time =    4542.98 ms /    63 runs   (   72.11 ms per token,    13.87 tokens per second)
llama_print_timings:       total time =    4903.14 ms /    71 tokens
Log end
...
[1]4.1757,
llama_print_timings:        load time =     270.60 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5216.08 ms /   128 tokens (   40.75 ms per token,    24.54 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5225.92 ms /   129 tokens
...
llama_print_timings:        load time =     310.30 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31357.18 tokens per second)
llama_print_timings: prompt eval time =     399.85 ms /     8 tokens (   49.98 ms per token,    20.01 tokens per second)
llama_print_timings:        eval time =    5049.87 ms /    63 runs   (   80.16 ms per token,    12.48 tokens per second)
llama_print_timings:       total time =    5469.17 ms /    71 tokens
Log end
...
[1]4.3727,
llama_print_timings:        load time =     294.58 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6095.98 ms /   128 tokens (   47.62 ms per token,    21.00 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6106.44 ms /   129 tokens
...
llama_print_timings: prompt eval time =     434.60 ms /     8 tokens (   54.32 ms per token,    18.41 tokens per second)
llama_print_timings:        eval time =    5683.46 ms /    63 runs   (   90.21 ms per token,    11.08 tokens per second)
llama_print_timings:       total time =    6137.95 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6526.85 ms /   128 tokens (   50.99 ms per token,    19.61 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6536.93 ms /   129 tokens
...
I believe that
llama_print_timings:        load time =     351.32 ms
llama_print_timings:      sample time =       2.05 ms /    64 runs   (    0.03 ms per token, 31219.51 tokens per second)
llama_print_timings: prompt eval time =     449.31 ms /     8 tokens (   56.16 ms per token,    17.80 tokens per second)
llama_print_timings:        eval time =    5871.32 ms /    63 runs   (   93.20 ms per token,    10.73 tokens per second)
llama_print_timings:       total time =    6339.54 ms /    71 tokens
Log end
...
[1]4.2597,
llama_print_timings:        load time =     336.33 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6847.33 ms /   128 tokens (   53.49 ms per token,    18.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6857.41 ms /   129 tokens
...
llama_print_timings: prompt eval time =     637.15 ms /     8 tokens (   79.64 ms per token,    12.56 tokens per second)
llama_print_timings:        eval time =    6163.39 ms /    63 runs   (   97.83 ms per token,    10.22 tokens per second)
llama_print_timings:       total time =    6819.57 ms /    71 tokens
Log end
...
[1]5.6444,
llama_print_timings:        load time =     294.01 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10131.13 ms /   128 tokens (   79.15 ms per token,    12.63 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10141.37 ms /   129 tokens
...
llama_print_timings: prompt eval time =     487.21 ms /     8 tokens (   60.90 ms per token,    16.42 tokens per second)
llama_print_timings:        eval time =    5469.19 ms /    63 runs   (   86.81 ms per token,    11.52 tokens per second)
llama_print_timings:       total time =    5975.47 ms /    71 tokens
Log end
...
[1]4.4045,
llama_print_timings:        load time =     285.93 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7634.18 ms /   128 tokens (   59.64 ms per token,    16.77 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7645.01 ms /   129 tokens
...
llama_print_timings: prompt eval time =     419.06 ms /     8 tokens (   52.38 ms per token,    19.09 tokens per second)
llama_print_timings:        eval time =    5343.22 ms /    63 runs   (   84.81 ms per token,    11.79 tokens per second)
llama_print_timings:       total time =    5781.65 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.522 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 6.36 seconds per pass - ETA 0.10 minutes
[1]4.1832,
llama_print_timings:        load time =     297.48 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6362.10 ms /   128 tokens (   49.70 ms per token,    20.12 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6372.53 ms /   129 tokens
...
llama_print_timings:        load time =     353.98 ms
llama_print_timings:      sample time =       2.08 ms /    64 runs   (    0.03 ms per token, 30769.23 tokens per second)
llama_print_timings: prompt eval time =     494.45 ms /     8 tokens (   61.81 ms per token,    16.18 tokens per second)
llama_print_timings:        eval time =    6092.58 ms /    63 runs   (   96.71 ms per token,    10.34 tokens per second)
llama_print_timings:       total time =    6607.55 ms /    71 tokens
Log end
...
[1]4.2451,
llama_print_timings:        load time =     346.01 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7525.75 ms /   128 tokens (   58.79 ms per token,    17.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7536.00 ms /   129 tokens
...
llama_print_timings: prompt eval time =     546.47 ms /     8 tokens (   68.31 ms per token,    14.64 tokens per second)
llama_print_timings:        eval time =    6713.30 ms /    63 runs   (  106.56 ms per token,     9.38 tokens per second)
llama_print_timings:       total time =    7278.92 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8403.48 ms /   128 tokens (   65.65 ms per token,    15.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8413.72 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.842 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 7.45 seconds per pass - ETA 0.12 minutes
[1]9.1010,
llama_print_timings:        load time =     681.78 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7450.77 ms /   128 tokens (   58.21 ms per token,    17.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7500.65 ms /   129 tokens
...
[1]7.0168,
llama_print_timings:        load time =    5611.40 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7363.21 ms /   128 tokens (   57.53 ms per token,    17.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7409.90 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 48.42 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.94 seconds per pass - ETA 0.07 minutes
[1]9.2039,
llama_print_timings:        load time =     397.44 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4939.50 ms /   128 tokens (   38.59 ms per token,    25.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4990.46 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.549 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.90 seconds per pass - ETA 0.07 minutes
[1]7.0066,
llama_print_timings:        load time =    4072.16 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4904.17 ms /   128 tokens (   38.31 ms per token,    26.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4951.24 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.454 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.55 seconds per pass - ETA 0.08 minutes
[1]6.9704,
llama_print_timings:        load time =    4369.39 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5553.89 ms /   128 tokens (   43.39 ms per token,    23.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5600.16 ms /   129 tokens
...
0.31user 0.80system 0:01.11elapsed 100%CPU (0avgtext+0avgdata 6878128maxresident)k
0inputs+40outputs (0major+112489minor)pagefaults 0swaps
```
...
0.09user 0.80system 0:00.89elapsed 100%CPU (0avgtext+0avgdata 6877808maxresident)k
