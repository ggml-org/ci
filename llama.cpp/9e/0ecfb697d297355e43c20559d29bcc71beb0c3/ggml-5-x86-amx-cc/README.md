...
- status:  SUCCESS ✅
- runtime: 4:30.66
- date:    Mon Nov  4 15:38:19 UTC 2024
...
0.00.000.688 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.004.022 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
...
0.00.004.031 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
0.00.004.032 I llama_model_loader: - kv  13:                          bert.pooling_type u32              = 2
0.00.004.032 I llama_model_loader: - kv  14:            tokenizer.ggml.token_type_count u32              = 2
0.00.004.033 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
0.00.004.033 I llama_model_loader: - kv  16:                         tokenizer.ggml.pre str              = jina-v2-en
...
0.00.022.156 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.022.157 I llm_load_print_meta: arch             = bert
0.00.022.157 I llm_load_print_meta: vocab type       = WPM
0.00.022.158 I llm_load_print_meta: n_vocab          = 30522
0.00.022.159 I llm_load_print_meta: n_merges         = 0
0.00.022.159 I llm_load_print_meta: vocab_only       = 0
...
0.00.022.171 I llm_load_print_meta: n_swa            = 0
...
0.00.022.178 I llm_load_print_meta: n_expert_used    = 0
0.00.022.178 I llm_load_print_meta: causal attn      = 0
...
0.00.022.188 I llm_load_print_meta: ssm_d_inner      = 0
0.00.022.188 I llm_load_print_meta: ssm_d_state      = 0
0.00.022.189 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.022.189 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
...
0.00.026.246 I llm_load_tensors:        AMX model buffer size =    40.50 MiB
................................................
0.00.040.589 I llama_new_context_with_model: n_seq_max     = 1
0.00.040.606 I llama_new_context_with_model: n_ctx         = 512
0.00.040.606 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.040.606 I llama_new_context_with_model: n_batch       = 2048
0.00.040.607 I llama_new_context_with_model: n_ubatch      = 2048
0.00.040.608 I llama_new_context_with_model: flash_attn    = 0
0.00.040.609 I llama_new_context_with_model: freq_base     = 10000.0
0.00.040.610 I llama_new_context_with_model: freq_scale    = 1
0.00.043.464 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.043.490 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.043.496 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.045.311 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.045.333 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.045.334 I llama_new_context_with_model: graph nodes  = 429
0.00.045.335 I llama_new_context_with_model: graph splits = 145
0.00.045.337 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.049.163 I 
0.00.049.253 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
...
0.00.056.532 I llama_perf_context_print:        load time =      48.28 ms
0.00.056.534 I llama_perf_context_print: prompt eval time =       5.26 ms /     9 tokens (    0.58 ms per token,  1709.40 tokens per second)
0.00.056.536 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.056.536 I llama_perf_context_print:       total time =       7.37 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.549 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.523 I llama_model_loader: - kv  19:            tokenizer.ggml.unknown_token_id u32              = 100
0.00.007.523 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.007.524 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.007.524 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
0.00.007.524 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
0.00.007.525 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.007.526 I llama_model_loader: - type  f32:  124 tensors
0.00.007.527 I llama_model_loader: - type q8_0:   73 tensors
0.00.018.100 I llm_load_vocab: special tokens cache size = 5
...
0.00.020.691 I llm_load_print_meta: n_layer          = 12
0.00.020.698 I llm_load_print_meta: n_head           = 12
0.00.020.699 I llm_load_print_meta: n_head_kv        = 12
0.00.020.700 I llm_load_print_meta: n_rot            = 32
0.00.020.700 I llm_load_print_meta: n_swa            = 0
0.00.020.700 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.700 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.701 I llm_load_print_meta: n_gqa            = 1
...
0.00.020.707 I llm_load_print_meta: n_expert         = 0
0.00.020.707 I llm_load_print_meta: n_expert_used    = 0
0.00.020.707 I llm_load_print_meta: causal attn      = 0
...
0.00.020.710 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.710 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.711 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.711 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.711 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.711 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.712 I llm_load_print_meta: model type       = 33M
0.00.020.712 I llm_load_print_meta: model ftype      = Q8_0
0.00.020.713 I llm_load_print_meta: model params     = 33.21 M
0.00.020.714 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.020.714 I llm_load_print_meta: general.name     = Bge Small
...
0.00.020.715 I llm_load_print_meta: CLS token        = 101 '[CLS]'
...
0.00.023.400 I llm_load_tensors: CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.024.170 I llama_new_context_with_model: n_seq_max     = 1
0.00.024.185 I llama_new_context_with_model: n_ctx         = 512
0.00.024.186 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.024.186 I llama_new_context_with_model: n_batch       = 2048
0.00.024.186 I llama_new_context_with_model: n_ubatch      = 2048
0.00.024.187 I llama_new_context_with_model: flash_attn    = 0
0.00.024.188 I llama_new_context_with_model: freq_base     = 10000.0
0.00.024.188 I llama_new_context_with_model: freq_scale    = 1
0.00.027.179 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.027.201 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.027.205 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.028.459 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.028.476 I llama_new_context_with_model: graph nodes  = 429
0.00.028.476 I llama_new_context_with_model: graph splits = 1
0.00.028.478 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.031.205 I 
0.00.031.283 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
...
0.00.035.819 I llama_perf_context_print:        load time =      30.49 ms
0.00.035.833 I llama_perf_context_print: prompt eval time =       2.73 ms /     9 tokens (    0.30 ms per token,  3293.08 tokens per second)
0.00.035.834 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.035.835 I llama_perf_context_print:       total time =       4.61 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.687 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.797 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.008.827 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.008.835 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.008.836 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.837 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.837 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.838 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.841 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.843 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.844 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.844 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.845 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.849 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.850 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.851 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.852 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.853 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.014.939 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.016.367 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.824 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
...
0.00.019.847 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.847 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
...
0.00.019.853 I llama_model_loader: - type  f32:   41 tensors
0.00.019.854 I llama_model_loader: - type  f16:   29 tensors
0.00.037.301 W llm_load_vocab: empty token at index 5
0.00.047.860 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
...
0.00.345.093 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.345.116 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.345.116 I llm_load_print_meta: arch             = jina-bert-v2
0.00.345.117 I llm_load_print_meta: vocab type       = BPE
0.00.345.117 I llm_load_print_meta: n_vocab          = 61056
0.00.345.118 I llm_load_print_meta: n_merges         = 39382
0.00.345.118 I llm_load_print_meta: vocab_only       = 0
0.00.345.118 I llm_load_print_meta: n_ctx_train      = 8192
0.00.345.119 I llm_load_print_meta: n_embd           = 384
0.00.345.119 I llm_load_print_meta: n_layer          = 4
0.00.345.129 I llm_load_print_meta: n_head           = 12
0.00.345.130 I llm_load_print_meta: n_head_kv        = 12
0.00.345.130 I llm_load_print_meta: n_rot            = 32
0.00.345.131 I llm_load_print_meta: n_swa            = 0
0.00.345.131 I llm_load_print_meta: n_embd_head_k    = 32
0.00.345.131 I llm_load_print_meta: n_embd_head_v    = 32
0.00.345.132 I llm_load_print_meta: n_gqa            = 1
0.00.345.133 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.345.133 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.345.135 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.345.135 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.345.136 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.345.136 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.345.136 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.345.137 I llm_load_print_meta: n_ff             = 1536
0.00.345.137 I llm_load_print_meta: n_expert         = 0
0.00.345.138 I llm_load_print_meta: n_expert_used    = 0
0.00.345.138 I llm_load_print_meta: causal attn      = 0
0.00.345.138 I llm_load_print_meta: pooling type     = -1
0.00.345.138 I llm_load_print_meta: rope type        = -1
0.00.345.139 I llm_load_print_meta: rope scaling     = linear
0.00.345.140 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.345.141 I llm_load_print_meta: freq_scale_train = 1
0.00.345.141 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.345.142 I llm_load_print_meta: rope_finetuned   = unknown
0.00.345.142 I llm_load_print_meta: ssm_d_conv       = 0
0.00.345.142 I llm_load_print_meta: ssm_d_inner      = 0
0.00.345.142 I llm_load_print_meta: ssm_d_state      = 0
0.00.345.142 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.345.142 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.345.143 I llm_load_print_meta: model type       = 33M
0.00.345.144 I llm_load_print_meta: model ftype      = F16
0.00.345.145 I llm_load_print_meta: model params     = 32.90 M
0.00.345.145 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.345.145 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.345.146 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.345.146 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.345.147 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.345.147 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.345.147 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.345.147 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.345.147 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.345.148 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.345.148 I llm_load_print_meta: max token length = 45
0.00.348.996 I llm_load_tensors: CPU_Mapped model buffer size =    62.78 MiB
0.00.349.014 I llm_load_tensors:        AMX model buffer size =    18.00 MiB
.....................
0.00.356.521 I llama_new_context_with_model: n_seq_max     = 1
0.00.356.543 I llama_new_context_with_model: n_ctx         = 8192
0.00.356.543 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.356.544 I llama_new_context_with_model: n_batch       = 2048
0.00.356.544 I llama_new_context_with_model: n_ubatch      = 2048
0.00.356.544 I llama_new_context_with_model: flash_attn    = 0
0.00.356.546 I llama_new_context_with_model: freq_base     = 10000.0
0.00.356.547 I llama_new_context_with_model: freq_scale    = 1
0.00.366.564 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.366.587 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.366.594 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.368.584 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.368.608 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.368.609 I llama_new_context_with_model: graph nodes  = 154
0.00.368.609 I llama_new_context_with_model: graph splits = 57
0.00.368.611 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.377.272 I 
0.00.377.371 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.377.604 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.377.617 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.377.622 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.377.622 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.377.627 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.377.627 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.381.474 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.389.958 I llama_perf_context_print:        load time =     376.38 ms
0.00.389.959 I llama_perf_context_print: prompt eval time =       8.19 ms /    62 tokens (    0.13 ms per token,  7570.21 tokens per second)
0.00.389.961 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.389.961 I llama_perf_context_print:       total time =      12.69 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.681 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.249 I llama_model_loader: - type  f16:   98 tensors
...
0.00.075.470 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.471 I llm_load_print_meta: model params     = 1.41 B
0.00.075.472 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.188.272 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.188.290 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.971.800 I llama_new_context_with_model: n_seq_max     = 1
0.00.971.821 I llama_new_context_with_model: n_ctx         = 2048
0.00.971.821 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.971.822 I llama_new_context_with_model: n_batch       = 2048
0.00.971.822 I llama_new_context_with_model: n_ubatch      = 512
0.00.971.823 I llama_new_context_with_model: flash_attn    = 0
0.00.971.828 I llama_new_context_with_model: freq_base     = 10000.0
0.00.971.829 I llama_new_context_with_model: freq_scale    = 1
0.01.040.658 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.040.688 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.040.721 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.043.814 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.043.835 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.043.836 I llama_new_context_with_model: graph nodes  = 967
0.01.043.836 I llama_new_context_with_model: graph splits = 194
0.01.043.840 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.148.428 I main: llama threadpool init, n_threads = 4
0.01.148.455 I 
0.01.148.544 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.148.557 I 
0.01.148.689 I sampler seed: 1234
0.01.148.708 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.148.711 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.148.711 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.148.712 I 
...
0.05.013.110 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30656.30 tokens per second)
0.05.013.114 I llama_perf_context_print:        load time =    1147.27 ms
0.05.013.116 I llama_perf_context_print: prompt eval time =     103.67 ms /     7 tokens (   14.81 ms per token,    67.52 tokens per second)
0.05.013.117 I llama_perf_context_print:        eval time =    3749.38 ms /    63 runs   (   59.51 ms per token,    16.80 tokens per second)
0.05.013.118 I llama_perf_context_print:       total time =    3864.69 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.780 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.296 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.298 I llm_load_print_meta: model params     = 1.41 B
0.00.076.298 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.191.579 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.191.599 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.979.831 I llama_new_context_with_model: n_seq_max     = 1
0.00.979.852 I llama_new_context_with_model: n_ctx         = 128
0.00.979.852 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.979.853 I llama_new_context_with_model: n_batch       = 128
0.00.979.853 I llama_new_context_with_model: n_ubatch      = 128
0.00.979.854 I llama_new_context_with_model: flash_attn    = 0
0.00.979.858 I llama_new_context_with_model: freq_base     = 10000.0
0.00.979.859 I llama_new_context_with_model: freq_scale    = 1
0.00.979.860 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.985.562 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.985.591 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.985.614 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.988.726 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.00.988.741 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.00.988.742 I llama_new_context_with_model: graph nodes  = 967
0.00.988.742 I llama_new_context_with_model: graph splits = 194
0.00.988.744 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.054.929 I 
0.01.055.054 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.055.074 I perplexity: tokenizing the input ..
0.01.064.396 I perplexity: tokenization took 9.319 ms
0.01.064.435 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.979.939 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.983.616 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.983.698 I llama_perf_context_print:        load time =    1053.94 ms
0.01.983.700 I llama_perf_context_print: prompt eval time =     913.70 ms /   128 tokens (    7.14 ms per token,   140.09 tokens per second)
0.01.983.702 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.983.703 I llama_perf_context_print:       total time =     928.77 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.659 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.964 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.965 I llm_load_print_meta: model params     = 1.41 B
0.00.075.965 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
...............................................................................
0.00.168.006 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.168.025 I llama_new_context_with_model: n_ubatch      = 512
0.00.168.026 I llama_new_context_with_model: flash_attn    = 0
0.00.168.028 I llama_new_context_with_model: freq_base     = 10000.0
0.00.168.028 I llama_new_context_with_model: freq_scale    = 1
0.00.236.929 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.236.957 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.236.977 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.239.032 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.239.055 I llama_new_context_with_model: graph nodes  = 967
0.00.239.055 I llama_new_context_with_model: graph splits = 1
0.00.239.060 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.339.166 I main: llama threadpool init, n_threads = 4
0.00.339.191 I 
0.00.339.270 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.339.285 I 
0.00.339.428 I sampler seed: 1234
0.00.339.446 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.339.450 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.339.450 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.339.450 I 
...
0.03.115.203 I llama_perf_sampler_print:    sampling time =       2.29 ms /    71 runs   (    0.03 ms per token, 31017.91 tokens per second)
0.03.115.205 I llama_perf_context_print:        load time =     338.06 ms
0.03.115.207 I llama_perf_context_print: prompt eval time =     123.84 ms /     7 tokens (   17.69 ms per token,    56.52 tokens per second)
0.03.115.208 I llama_perf_context_print:        eval time =    2640.52 ms /    63 runs   (   41.91 ms per token,    23.86 tokens per second)
0.03.115.208 I llama_perf_context_print:       total time =    2776.04 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.666 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.978 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.979 I llm_load_print_meta: model params     = 1.41 B
0.00.075.980 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.168.797 I llm_load_tensors: CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.173.779 I llama_new_context_with_model: n_seq_max     = 1
0.00.173.802 I llama_new_context_with_model: n_ctx         = 128
0.00.173.802 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.173.802 I llama_new_context_with_model: n_batch       = 128
0.00.173.803 I llama_new_context_with_model: n_ubatch      = 128
0.00.173.803 I llama_new_context_with_model: flash_attn    = 0
0.00.173.805 I llama_new_context_with_model: freq_base     = 10000.0
0.00.173.805 I llama_new_context_with_model: freq_scale    = 1
0.00.173.806 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.179.533 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.179.561 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.179.574 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.182.131 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.182.155 I llama_new_context_with_model: graph nodes  = 967
0.00.182.155 I llama_new_context_with_model: graph splits = 1
0.00.182.157 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.249.188 I 
0.00.249.283 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.249.302 I perplexity: tokenizing the input ..
0.00.257.806 I perplexity: tokenization took 8.5 ms
0.00.257.838 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.170.454 I perplexity: 0.91 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.174.178 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.174.218 I llama_perf_context_print:        load time =     248.33 ms
0.01.174.219 I llama_perf_context_print: prompt eval time =     910.71 ms /   128 tokens (    7.11 ms per token,   140.55 tokens per second)
0.01.174.220 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.174.221 I llama_perf_context_print:       total time =     925.03 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.654 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.158 I llm_load_print_meta: model ftype      = Q4_0
0.00.076.159 I llm_load_print_meta: model params     = 1.41 B
0.00.076.160 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.124.365 I llm_load_tensors: CPU_Mapped model buffer size =   777.31 MiB
0.00.124.385 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.370.617 I llama_new_context_with_model: n_seq_max     = 1
0.00.370.640 I llama_new_context_with_model: n_ctx         = 2048
0.00.370.640 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.370.645 I llama_new_context_with_model: freq_base     = 10000.0
0.00.370.645 I llama_new_context_with_model: freq_scale    = 1
0.00.439.806 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.439.836 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.439.867 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.442.929 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.442.956 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.442.956 I llama_new_context_with_model: graph nodes  = 967
0.00.442.957 I llama_new_context_with_model: graph splits = 193
0.00.442.962 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.509.481 I main: llama threadpool init, n_threads = 4
0.00.509.509 I 
0.00.509.600 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.509.601 I 
0.00.509.732 I sampler seed: 1234
0.00.509.753 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.509.756 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.509.757 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.509.757 I 
...
0.01.912.278 I llama_perf_sampler_print:    sampling time =       2.17 ms /    71 runs   (    0.03 ms per token, 32688.77 tokens per second)
0.01.912.281 I llama_perf_context_print:        load time =     508.40 ms
0.01.912.283 I llama_perf_context_print: prompt eval time =      39.73 ms /     7 tokens (    5.68 ms per token,   176.19 tokens per second)
0.01.912.283 I llama_perf_context_print:        eval time =    1351.91 ms /    63 runs   (   21.46 ms per token,    46.60 tokens per second)
0.01.912.284 I llama_perf_context_print:       total time =    1402.80 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.701 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.067 I llm_load_print_meta: model ftype      = Q4_0
...
0.00.125.036 I llm_load_tensors: CPU_Mapped model buffer size =   777.31 MiB
0.00.125.055 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.371.857 I llama_new_context_with_model: n_seq_max     = 1
0.00.371.877 I llama_new_context_with_model: n_ctx         = 128
0.00.371.877 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.371.878 I llama_new_context_with_model: n_batch       = 128
0.00.371.878 I llama_new_context_with_model: n_ubatch      = 128
0.00.371.878 I llama_new_context_with_model: flash_attn    = 0
0.00.371.883 I llama_new_context_with_model: freq_base     = 10000.0
0.00.371.884 I llama_new_context_with_model: freq_scale    = 1
0.00.371.885 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.377.646 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.377.669 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.377.693 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.380.744 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.380.770 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.380.770 I llama_new_context_with_model: graph nodes  = 967
0.00.380.770 I llama_new_context_with_model: graph splits = 193
0.00.380.772 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.417.855 I 
0.00.417.968 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.417.974 I perplexity: tokenizing the input ..
0.00.427.329 I perplexity: tokenization took 9.35 ms
0.00.427.360 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.885.817 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.889.461 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.889.534 I llama_perf_context_print:        load time =     416.95 ms
0.00.889.536 I llama_perf_context_print: prompt eval time =     456.62 ms /   128 tokens (    3.57 ms per token,   280.32 tokens per second)
0.00.889.537 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.889.537 I llama_perf_context_print:       total time =     471.68 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.658 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.218 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.219 I llm_load_print_meta: model params     = 1.41 B
0.00.075.220 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.115.396 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.115.416 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.387.427 I llama_new_context_with_model: n_seq_max     = 1
0.00.387.449 I llama_new_context_with_model: n_ctx         = 2048
0.00.387.449 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.387.449 I llama_new_context_with_model: n_batch       = 2048
0.00.387.449 I llama_new_context_with_model: n_ubatch      = 512
0.00.387.450 I llama_new_context_with_model: flash_attn    = 0
0.00.387.454 I llama_new_context_with_model: freq_base     = 10000.0
0.00.387.455 I llama_new_context_with_model: freq_scale    = 1
0.00.456.285 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.456.311 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.456.344 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.458.893 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.458.919 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.458.919 I llama_new_context_with_model: graph nodes  = 967
0.00.458.920 I llama_new_context_with_model: graph splits = 193
0.00.458.924 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.529.335 I main: llama threadpool init, n_threads = 4
0.00.529.361 I 
0.00.529.447 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.529.447 I 
0.00.529.590 I sampler seed: 1234
0.00.529.611 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.529.614 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.529.615 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.529.615 I 
...
0.02.031.242 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30842.75 tokens per second)
0.02.031.245 I llama_perf_context_print:        load time =     528.26 ms
0.02.031.246 I llama_perf_context_print: prompt eval time =      38.87 ms /     7 tokens (    5.55 ms per token,   180.08 tokens per second)
0.02.031.247 I llama_perf_context_print:        eval time =    1451.73 ms /    63 runs   (   23.04 ms per token,    43.40 tokens per second)
0.02.031.248 I llama_perf_context_print:       total time =    1501.91 ms /    70 tokens
...
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.701 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.285 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.021.504 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.021.507 I llama_model_loader: - type  f32:  194 tensors
0.00.021.508 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.077.783 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.077.784 I llm_load_print_meta: arch             = gptneox
0.00.077.784 I llm_load_print_meta: vocab type       = BPE
0.00.077.785 I llm_load_print_meta: n_vocab          = 50304
0.00.077.785 I llm_load_print_meta: n_merges         = 50009
0.00.077.785 I llm_load_print_meta: vocab_only       = 0
0.00.077.786 I llm_load_print_meta: n_ctx_train      = 2048
0.00.077.786 I llm_load_print_meta: n_embd           = 2048
0.00.077.786 I llm_load_print_meta: n_layer          = 24
0.00.077.796 I llm_load_print_meta: n_head           = 16
...
0.00.077.802 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.077.805 I llm_load_print_meta: pooling type     = 0
0.00.077.805 I llm_load_print_meta: rope type        = 2
0.00.077.806 I llm_load_print_meta: rope scaling     = linear
0.00.077.807 I llm_load_print_meta: freq_base_train  = 10000.0
...
0.00.077.810 I llm_load_print_meta: model ftype      = Q4_1
0.00.077.811 I llm_load_print_meta: model params     = 1.41 B
0.00.077.812 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
0.00.077.812 I llm_load_print_meta: general.name     = 1.4B
0.00.077.813 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.077.813 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.077.813 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.077.814 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.077.814 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.077.814 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.077.815 I llm_load_print_meta: max token length = 1024
0.00.117.145 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.117.166 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.388.577 I llama_new_context_with_model: n_seq_max     = 1
0.00.388.599 I llama_new_context_with_model: n_ctx         = 128
0.00.388.599 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.388.600 I llama_new_context_with_model: n_batch       = 128
0.00.388.600 I llama_new_context_with_model: n_ubatch      = 128
0.00.388.600 I llama_new_context_with_model: flash_attn    = 0
0.00.388.605 I llama_new_context_with_model: freq_base     = 10000.0
0.00.388.606 I llama_new_context_with_model: freq_scale    = 1
0.00.388.607 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.394.321 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.394.349 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.394.373 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.396.823 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.396.848 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.396.848 I llama_new_context_with_model: graph nodes  = 967
0.00.396.848 I llama_new_context_with_model: graph splits = 193
0.00.396.851 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.428.383 I 
0.00.428.515 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.428.536 I perplexity: tokenizing the input ..
0.00.437.638 I perplexity: tokenization took 9.098 ms
0.00.437.678 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.916.243 I perplexity: 0.48 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.920.316 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.920.395 I llama_perf_context_print:        load time =     427.49 ms
0.00.920.398 I llama_perf_context_print: prompt eval time =     476.66 ms /   128 tokens (    3.72 ms per token,   268.54 tokens per second)
0.00.920.399 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.920.400 I llama_perf_context_print:       total time =     492.01 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.704 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.120.060 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.122.193 I llama_new_context_with_model: n_seq_max     = 1
0.00.122.215 I llama_new_context_with_model: n_ctx         = 2048
0.00.122.215 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.122.216 I llama_new_context_with_model: n_batch       = 2048
0.00.122.216 I llama_new_context_with_model: n_ubatch      = 512
0.00.122.216 I llama_new_context_with_model: flash_attn    = 0
0.00.122.218 I llama_new_context_with_model: freq_base     = 10000.0
0.00.122.218 I llama_new_context_with_model: freq_scale    = 1
0.00.192.081 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.192.109 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.192.131 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.194.187 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.194.211 I llama_new_context_with_model: graph nodes  = 967
0.00.194.211 I llama_new_context_with_model: graph splits = 1
...
0.00.301.785 I 
0.00.301.869 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.301.882 I 
0.00.302.002 I sampler seed: 1234
0.00.302.021 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.302.024 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.302.024 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.302.025 I 
...
0.02.579.569 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31236.25 tokens per second)
0.02.579.572 I llama_perf_context_print:        load time =     300.65 ms
0.02.579.574 I llama_perf_context_print: prompt eval time =     123.92 ms /     7 tokens (   17.70 ms per token,    56.49 tokens per second)
0.02.579.575 I llama_perf_context_print:        eval time =    2142.07 ms /    63 runs   (   34.00 ms per token,    29.41 tokens per second)
0.02.579.576 I llama_perf_context_print:       total time =    2277.82 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.699 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.120.209 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.122.361 I llama_new_context_with_model: n_seq_max     = 1
0.00.122.383 I llama_new_context_with_model: n_ctx         = 128
0.00.122.383 I llama_new_context_with_model: n_ctx_per_seq = 128
...
0.00.122.387 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.127.717 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.127.743 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.127.757 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.130.289 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.130.305 I llama_new_context_with_model: graph nodes  = 967
0.00.130.306 I llama_new_context_with_model: graph splits = 1
0.00.130.308 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.203.461 I 
0.00.203.553 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.203.560 I perplexity: tokenizing the input ..
0.00.211.779 I perplexity: tokenization took 8.216 ms
0.00.211.811 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.338.946 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.342.532 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.342.571 I llama_perf_context_print:        load time =     202.58 ms
0.01.342.573 I llama_perf_context_print: prompt eval time =    1125.57 ms /   128 tokens (    8.79 ms per token,   113.72 tokens per second)
0.01.342.575 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.342.576 I llama_perf_context_print:       total time =    1139.11 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.712 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.149 I llm_load_print_meta: model ftype      = Q5_1
0.00.076.150 I llm_load_print_meta: model params     = 1.41 B
0.00.076.151 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.124.424 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.126.617 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.639 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.640 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.640 I llama_new_context_with_model: n_batch       = 2048
0.00.126.640 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.640 I llama_new_context_with_model: flash_attn    = 0
0.00.126.642 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.643 I llama_new_context_with_model: freq_scale    = 1
0.00.195.328 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.352 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.372 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.501 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.515 I llama_new_context_with_model: graph nodes  = 967
0.00.197.516 I llama_new_context_with_model: graph splits = 1
0.00.197.519 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.293.584 I main: llama threadpool init, n_threads = 4
0.00.293.608 I 
0.00.293.691 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.293.704 I 
...
0.02.683.583 I llama_perf_sampler_print:    sampling time =       2.29 ms /    71 runs   (    0.03 ms per token, 31017.91 tokens per second)
0.02.683.586 I llama_perf_context_print:        load time =     292.44 ms
0.02.683.587 I llama_perf_context_print: prompt eval time =     128.83 ms /     7 tokens (   18.40 ms per token,    54.34 tokens per second)
0.02.683.588 I llama_perf_context_print:        eval time =    2249.57 ms /    63 runs   (   35.71 ms per token,    28.01 tokens per second)
0.02.683.589 I llama_perf_context_print:       total time =    2390.01 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.697 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.103 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.123.302 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.125.507 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.529 I llama_new_context_with_model: n_ctx         = 128
0.00.125.529 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.125.529 I llama_new_context_with_model: n_batch       = 128
0.00.125.530 I llama_new_context_with_model: n_ubatch      = 128
0.00.125.530 I llama_new_context_with_model: flash_attn    = 0
0.00.125.532 I llama_new_context_with_model: freq_base     = 10000.0
0.00.125.533 I llama_new_context_with_model: freq_scale    = 1
...
0.00.131.010 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
...
0.00.133.622 I llama_new_context_with_model: graph nodes  = 967
0.00.133.622 I llama_new_context_with_model: graph splits = 1
0.00.133.624 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.194.644 I 
0.00.194.746 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.194.753 I perplexity: tokenizing the input ..
0.00.203.267 I perplexity: tokenization took 8.51 ms
0.00.203.301 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.141.744 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.145.424 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.145.461 I llama_perf_context_print:        load time =     193.76 ms
0.02.145.463 I llama_perf_context_print: prompt eval time =    1936.76 ms /   128 tokens (   15.13 ms per token,    66.09 tokens per second)
0.02.145.464 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.145.465 I llama_perf_context_print:       total time =    1950.82 ms /   129 tokens
...
0.00.021.552 I llama_model_loader: - type q2_K:   49 tensors
...
0.00.076.028 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.029 I llm_load_print_meta: model params     = 1.41 B
0.00.076.031 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.104.470 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.106.929 I llama_new_context_with_model: n_seq_max     = 1
0.00.106.951 I llama_new_context_with_model: n_ctx         = 2048
0.00.106.951 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.106.952 I llama_new_context_with_model: n_batch       = 2048
0.00.106.953 I llama_new_context_with_model: n_ubatch      = 512
0.00.106.953 I llama_new_context_with_model: flash_attn    = 0
0.00.106.956 I llama_new_context_with_model: freq_base     = 10000.0
0.00.106.956 I llama_new_context_with_model: freq_scale    = 1
0.00.176.282 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.176.312 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.176.333 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.178.446 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.178.464 I llama_new_context_with_model: graph nodes  = 967
0.00.178.464 I llama_new_context_with_model: graph splits = 1
0.00.178.468 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.251.349 I main: llama threadpool init, n_threads = 4
0.00.251.377 I 
0.00.251.489 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.251.502 I 
0.00.251.650 I sampler seed: 1234
0.00.251.670 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.251.675 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.251.676 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.251.676 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.784.628 I llama_perf_sampler_print:    sampling time =       2.12 ms /    71 runs   (    0.03 ms per token, 33569.74 tokens per second)
0.01.784.631 I llama_perf_context_print:        load time =     250.27 ms
0.01.784.633 I llama_perf_context_print: prompt eval time =      81.67 ms /     7 tokens (   11.67 ms per token,    85.71 tokens per second)
0.01.784.634 I llama_perf_context_print:        eval time =    1440.31 ms /    63 runs   (   22.86 ms per token,    43.74 tokens per second)
0.01.784.634 I llama_perf_context_print:       total time =    1533.29 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.791 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.520 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.074.521 I llm_load_print_meta: model params     = 1.41 B
0.00.074.522 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.103.279 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.105.450 I llama_new_context_with_model: n_seq_max     = 1
0.00.105.471 I llama_new_context_with_model: n_ctx         = 128
0.00.105.471 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.105.471 I llama_new_context_with_model: n_batch       = 128
0.00.105.472 I llama_new_context_with_model: n_ubatch      = 128
0.00.105.472 I llama_new_context_with_model: flash_attn    = 0
0.00.105.474 I llama_new_context_with_model: freq_base     = 10000.0
0.00.105.474 I llama_new_context_with_model: freq_scale    = 1
0.00.105.475 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.110.899 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.110.925 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.110.937 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.113.029 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.113.046 I llama_new_context_with_model: graph nodes  = 967
0.00.113.046 I llama_new_context_with_model: graph splits = 1
0.00.113.048 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.151.994 I 
0.00.152.091 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.152.097 I perplexity: tokenizing the input ..
0.00.160.621 I perplexity: tokenization took 8.521 ms
0.00.160.650 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.456.471 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.460.264 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.460.370 I llama_perf_context_print:        load time =     151.02 ms
0.01.460.383 I llama_perf_context_print: prompt eval time =    1294.18 ms /   128 tokens (   10.11 ms per token,    98.90 tokens per second)
0.01.460.384 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.460.385 I llama_perf_context_print:       total time =    1308.38 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.670 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.490 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.112.280 I llm_load_tensors: CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.114.501 I llama_new_context_with_model: n_seq_max     = 1
0.00.114.523 I llama_new_context_with_model: n_ctx         = 2048
0.00.114.523 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.114.523 I llama_new_context_with_model: n_batch       = 2048
0.00.114.524 I llama_new_context_with_model: n_ubatch      = 512
0.00.114.524 I llama_new_context_with_model: flash_attn    = 0
0.00.114.526 I llama_new_context_with_model: freq_base     = 10000.0
0.00.114.527 I llama_new_context_with_model: freq_scale    = 1
0.00.183.394 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.183.424 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.183.440 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.185.595 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.185.612 I llama_new_context_with_model: graph nodes  = 967
0.00.185.612 I llama_new_context_with_model: graph splits = 1
0.00.185.615 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.266.686 I main: llama threadpool init, n_threads = 4
0.00.266.716 I 
0.00.266.804 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.266.817 I 
0.00.266.941 I sampler seed: 1234
0.00.266.965 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.266.970 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.266.971 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.266.971 I 
...
0.02.020.443 I llama_perf_sampler_print:    sampling time =       2.15 ms /    71 runs   (    0.03 ms per token, 33084.81 tokens per second)
0.02.020.447 I llama_perf_context_print:        load time =     265.50 ms
0.02.020.449 I llama_perf_context_print: prompt eval time =      83.53 ms /     7 tokens (   11.93 ms per token,    83.80 tokens per second)
0.02.020.451 I llama_perf_context_print:        eval time =    1658.74 ms /    63 runs   (   26.33 ms per token,    37.98 tokens per second)
0.02.020.452 I llama_perf_context_print:       total time =    1753.76 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.706 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.077 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.111.664 I llm_load_tensors: CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.113.814 I llama_new_context_with_model: n_seq_max     = 1
0.00.113.836 I llama_new_context_with_model: n_ctx         = 128
0.00.113.836 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.113.836 I llama_new_context_with_model: n_batch       = 128
0.00.113.837 I llama_new_context_with_model: n_ubatch      = 128
0.00.113.837 I llama_new_context_with_model: flash_attn    = 0
0.00.113.838 I llama_new_context_with_model: freq_base     = 10000.0
0.00.113.839 I llama_new_context_with_model: freq_scale    = 1
0.00.113.840 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.119.371 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.119.397 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.119.411 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.121.346 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.121.368 I llama_new_context_with_model: graph nodes  = 967
0.00.121.368 I llama_new_context_with_model: graph splits = 1
0.00.121.370 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.165.905 I 
0.00.166.004 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.166.010 I perplexity: tokenizing the input ..
0.00.174.455 I perplexity: tokenization took 8.441 ms
0.00.174.486 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.513.428 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.517.108 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.517.147 I llama_perf_context_print:        load time =     165.01 ms
0.01.517.150 I llama_perf_context_print: prompt eval time =    1337.14 ms /   128 tokens (   10.45 ms per token,    95.73 tokens per second)
0.01.517.151 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.517.152 I llama_perf_context_print:       total time =    1351.24 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.655 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.880 I main: llama backend init
0.00.001.048 I main: load the model and apply lora adapter, if any
...
0.00.118.725 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.120.873 I llama_new_context_with_model: n_seq_max     = 1
0.00.120.894 I llama_new_context_with_model: n_ctx         = 2048
0.00.120.895 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.120.895 I llama_new_context_with_model: n_batch       = 2048
0.00.120.895 I llama_new_context_with_model: n_ubatch      = 512
0.00.120.895 I llama_new_context_with_model: flash_attn    = 0
0.00.120.897 I llama_new_context_with_model: freq_base     = 10000.0
0.00.120.898 I llama_new_context_with_model: freq_scale    = 1
0.00.190.019 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.190.048 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.190.067 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.192.581 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.192.603 I llama_new_context_with_model: graph nodes  = 967
0.00.192.604 I llama_new_context_with_model: graph splits = 1
...
0.00.276.031 I 
0.00.276.116 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.276.129 I 
...
0.02.248.679 I llama_perf_sampler_print:    sampling time =       2.20 ms /    71 runs   (    0.03 ms per token, 32272.73 tokens per second)
0.02.248.683 I llama_perf_context_print:        load time =     274.92 ms
0.02.248.685 I llama_perf_context_print: prompt eval time =      90.81 ms /     7 tokens (   12.97 ms per token,    77.08 tokens per second)
0.02.248.686 I llama_perf_context_print:        eval time =    1870.53 ms /    63 runs   (   29.69 ms per token,    33.68 tokens per second)
0.02.248.687 I llama_perf_context_print:       total time =    1972.68 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.627 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.117.723 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.119.929 I llama_new_context_with_model: n_seq_max     = 1
0.00.119.944 I llama_new_context_with_model: n_ctx         = 128
0.00.119.944 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.119.944 I llama_new_context_with_model: n_batch       = 128
0.00.119.944 I llama_new_context_with_model: n_ubatch      = 128
0.00.119.945 I llama_new_context_with_model: flash_attn    = 0
0.00.119.946 I llama_new_context_with_model: freq_base     = 10000.0
0.00.119.946 I llama_new_context_with_model: freq_scale    = 1
0.00.119.947 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.125.354 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.125.380 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.125.396 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.127.982 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.128.000 I llama_new_context_with_model: graph nodes  = 967
0.00.128.001 I llama_new_context_with_model: graph splits = 1
0.00.128.002 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.176.214 I 
0.00.176.310 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.176.317 I perplexity: tokenizing the input ..
0.00.184.823 I perplexity: tokenization took 8.502 ms
0.00.184.853 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.592.979 I perplexity: 1.41 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.596.733 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.596.772 I llama_perf_context_print:        load time =     175.42 ms
0.01.596.774 I llama_perf_context_print: prompt eval time =    1406.40 ms /   128 tokens (   10.99 ms per token,    91.01 tokens per second)
0.01.596.776 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.596.776 I llama_perf_context_print:       total time =    1420.56 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.671 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.257 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.258 I llm_load_print_meta: model params     = 1.41 B
0.00.075.259 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.124.950 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
...
0.00.127.194 I llama_new_context_with_model: n_batch       = 2048
0.00.127.194 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.196.618 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.196.640 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.198.747 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.198.765 I llama_new_context_with_model: graph nodes  = 967
0.00.198.766 I llama_new_context_with_model: graph splits = 1
0.00.198.770 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.289.854 I main: llama threadpool init, n_threads = 4
0.00.289.881 I 
0.00.289.968 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.289.981 I 
0.00.290.098 I sampler seed: 1234
...
0.02.560.485 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30923.34 tokens per second)
0.02.560.489 I llama_perf_context_print:        load time =     288.74 ms
0.02.560.490 I llama_perf_context_print: prompt eval time =     112.68 ms /     7 tokens (   16.10 ms per token,    62.12 tokens per second)
0.02.560.491 I llama_perf_context_print:        eval time =    2146.71 ms /    63 runs   (   34.07 ms per token,    29.35 tokens per second)
0.02.560.492 I llama_perf_context_print:       total time =    2270.64 ms /    70 tokens
...
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.699 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.138 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf (version GGUF V3 (latest))
...
0.00.020.459 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
0.00.020.462 I llama_model_loader: - type  f32:  194 tensors
0.00.020.463 I llama_model_loader: - type q5_K:   61 tensors
0.00.020.463 I llama_model_loader: - type q6_K:   37 tensors
0.00.062.506 I llm_load_vocab: special tokens cache size = 25
...
0.00.074.275 I llm_load_print_meta: n_layer          = 24
0.00.074.284 I llm_load_print_meta: n_head           = 16
0.00.074.285 I llm_load_print_meta: n_head_kv        = 16
0.00.074.285 I llm_load_print_meta: n_rot            = 32
0.00.074.285 I llm_load_print_meta: n_swa            = 0
0.00.074.285 I llm_load_print_meta: n_embd_head_k    = 128
0.00.074.286 I llm_load_print_meta: n_embd_head_v    = 128
0.00.074.287 I llm_load_print_meta: n_gqa            = 1
0.00.074.288 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.074.288 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.074.290 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.074.290 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.074.291 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.074.291 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.074.291 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.074.292 I llm_load_print_meta: n_ff             = 8192
...
0.00.074.294 I llm_load_print_meta: rope scaling     = linear
...
0.00.074.299 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.074.300 I llm_load_print_meta: model params     = 1.41 B
0.00.074.301 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.074.303 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.303 I llm_load_print_meta: max token length = 1024
0.00.119.855 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.121.938 I llama_new_context_with_model: n_seq_max     = 1
0.00.121.959 I llama_new_context_with_model: n_ctx         = 128
0.00.121.959 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.121.960 I llama_new_context_with_model: n_batch       = 128
0.00.121.960 I llama_new_context_with_model: n_ubatch      = 128
0.00.121.960 I llama_new_context_with_model: flash_attn    = 0
0.00.121.962 I llama_new_context_with_model: freq_base     = 10000.0
0.00.121.963 I llama_new_context_with_model: freq_scale    = 1
0.00.121.964 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.127.416 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.127.439 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.127.451 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.129.963 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.129.985 I llama_new_context_with_model: graph nodes  = 967
0.00.129.986 I llama_new_context_with_model: graph splits = 1
0.00.129.988 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.188.659 I 
0.00.188.765 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.188.773 I perplexity: tokenizing the input ..
0.00.197.739 I perplexity: tokenization took 8.962 ms
0.00.197.772 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.893.953 I perplexity: 1.70 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.897.530 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.897.568 I llama_perf_context_print:        load time =     187.76 ms
0.01.897.569 I llama_perf_context_print: prompt eval time =    1694.41 ms /   128 tokens (   13.24 ms per token,    75.54 tokens per second)
0.01.897.570 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.897.571 I llama_perf_context_print:       total time =    1708.91 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.645 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.345 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.075.346 I llm_load_print_meta: model type       = 1.4B
0.00.075.347 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.347 I llm_load_print_meta: model params     = 1.41 B
0.00.075.348 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.125.000 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.127.274 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.291 I llama_new_context_with_model: n_ctx         = 2048
0.00.127.292 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.127.292 I llama_new_context_with_model: n_batch       = 2048
0.00.127.292 I llama_new_context_with_model: n_ubatch      = 512
0.00.127.292 I llama_new_context_with_model: flash_attn    = 0
0.00.127.294 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.295 I llama_new_context_with_model: freq_scale    = 1
0.00.195.380 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.404 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.420 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.644 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.668 I llama_new_context_with_model: graph nodes  = 967
0.00.197.668 I llama_new_context_with_model: graph splits = 1
0.00.197.672 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.284.476 I main: llama threadpool init, n_threads = 4
0.00.284.501 I 
0.00.284.585 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.284.599 I 
0.00.284.731 I sampler seed: 1234
0.00.284.763 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.284.766 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.284.766 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.284.766 I 
...
0.02.622.868 I llama_perf_sampler_print:    sampling time =       2.18 ms /    71 runs   (    0.03 ms per token, 32538.96 tokens per second)
0.02.622.871 I llama_perf_context_print:        load time =     283.40 ms
0.02.622.873 I llama_perf_context_print: prompt eval time =     106.58 ms /     7 tokens (   15.22 ms per token,    65.68 tokens per second)
0.02.622.874 I llama_perf_context_print:        eval time =    2220.81 ms /    63 runs   (   35.25 ms per token,    28.37 tokens per second)
0.02.622.875 I llama_perf_context_print:       total time =    2338.40 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.720 I build: 4029 (9e0ecfb6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.118 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.127.656 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.129.881 I llama_new_context_with_model: n_seq_max     = 1
0.00.129.902 I llama_new_context_with_model: n_ctx         = 128
0.00.129.902 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.129.902 I llama_new_context_with_model: n_batch       = 128
0.00.129.902 I llama_new_context_with_model: n_ubatch      = 128
0.00.129.903 I llama_new_context_with_model: flash_attn    = 0
0.00.129.905 I llama_new_context_with_model: freq_base     = 10000.0
0.00.129.905 I llama_new_context_with_model: freq_scale    = 1
0.00.129.906 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.135.583 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.135.609 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.135.623 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.138.309 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.138.330 I llama_new_context_with_model: graph nodes  = 967
0.00.138.330 I llama_new_context_with_model: graph splits = 1
0.00.138.332 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.196.459 I 
0.00.196.581 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.196.591 I perplexity: tokenizing the input ..
0.00.205.750 I perplexity: tokenization took 9.156 ms
0.00.205.788 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.855.096 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.858.927 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.858.968 I llama_perf_context_print:        load time =     195.53 ms
0.01.858.970 I llama_perf_context_print: prompt eval time =    1647.53 ms /   128 tokens (   12.87 ms per token,    77.69 tokens per second)
0.01.858.972 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.858.973 I llama_perf_context_print:       total time =    1662.51 ms /   129 tokens
...
0.00.438.286 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.440.066 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.63user 0.60system 0:01.23elapsed 100%CPU (0avgtext+0avgdata 5358688maxresident)k
...
0.47user 0.62system 0:01.10elapsed 100%CPU (0avgtext+0avgdata 5355248maxresident)k
