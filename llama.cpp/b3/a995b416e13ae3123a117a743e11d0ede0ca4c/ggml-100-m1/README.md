...
- status:  SUCCESS ✅
- runtime: 602.10
- date:    Mon May  6 18:41:58 EEST 2024
...
19/21 Test #19: test-backend-ops .................   Passed  103.55 sec
      Start 20: test-rope
...
Label Time Summary:
main    = 164.98 sec*proc (21 tests)

Total Test time (real) = 165.00 sec
...
14/21 Test #14: test-chat-template ...............   Passed    0.18 sec
      Start 15: test-grammar-parser
15/21 Test #15: test-grammar-parser ..............   Passed    0.20 sec
      Start 16: test-llama-grammar
...
llama_print_timings: prompt eval time =      12.06 ms /     9 tokens (    1.34 ms per token,   745.96 tokens per second)
...
<bos> Once upon a time, in a magical forest, lived a curious gnome named Barnaby.

One day, Barnaby stumbled upon a magical wishing stone hidden deep within the forest.
llama_print_timings:        load time =    2619.04 ms
llama_print_timings:      sample time =      16.56 ms /    32 runs   (    0.52 ms per token,  1932.72 tokens per second)
llama_print_timings: prompt eval time =     198.27 ms /     5 tokens (   39.65 ms per token,    25.22 tokens per second)
llama_print_timings:        eval time =    1527.38 ms /    31 runs   (   49.27 ms per token,    20.30 tokens per second)
llama_print_timings:       total time =    1817.19 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Shekera, the legendary queen of Sheba, is revered for her wisdom, power, and beauty. She is depicted as a majestic figure with a flowing robe
llama_print_timings:        load time =    3314.34 ms
llama_print_timings:      sample time =      16.57 ms /    32 runs   (    0.52 ms per token,  1930.62 tokens per second)
llama_print_timings: prompt eval time =     201.27 ms /     2 tokens (  100.64 ms per token,     9.94 tokens per second)
llama_print_timings:        eval time =    1527.22 ms /    31 runs   (   49.27 ms per token,    20.30 tokens per second)
llama_print_timings:       total time =    1821.01 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soar! is a non-profit organization dedicated to empowering young people to explore their passions and achieve their dreams.

**Our Mission:**

* To provide a
llama_print_timings:        load time =    2674.58 ms
...
llama_print_timings:        eval time =    1541.66 ms /    31 runs   (   49.73 ms per token,    20.11 tokens per second)
llama_print_timings:       total time =    1828.84 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2664.81 ms
llama_print_timings:      sample time =      16.20 ms /    32 runs   (    0.51 ms per token,  1974.82 tokens per second)
llama_print_timings: prompt eval time =     196.85 ms /     2 tokens (   98.42 ms per token,    10.16 tokens per second)
llama_print_timings:        eval time =    1529.97 ms /    31 runs   (   49.35 ms per token,    20.26 tokens per second)
llama_print_timings:       total time =    1819.25 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21273.54 ms
main:    total time = 21273.54 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a king and queen who had no children of their own. They sought the help of a wise woman to bless their kingdom with a child.
...
llama_print_timings: prompt eval time =     215.75 ms /     5 tokens (   43.15 ms per token,    23.18 tokens per second)
llama_print_timings:        eval time =    1097.66 ms /    31 runs   (   35.41 ms per token,    28.24 tokens per second)
llama_print_timings:       total time =    1403.75 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21527.16 ms
main:    total time = 21527.16 ms
+ echo PASS
PASS
+ echo
...
<bos> They say knowledge is power, but knowledge without action is useless. What does this mean?

**Answer:**

The statement highlights the importance of translating knowledge into action
...
llama_print_timings: prompt eval time =     215.81 ms /     2 tokens (  107.91 ms per token,     9.27 tokens per second)
llama_print_timings:        eval time =    1115.57 ms /    31 runs   (   35.99 ms per token,    27.79 tokens per second)
llama_print_timings:       total time =    1423.63 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
