...
- status:  SUCCESS ✅
- runtime: 467.31
- date:    Sun Mar  3 12:51:45 EET 2024
...
llama_print_timings: prompt eval time =      11.78 ms /     9 tokens (    1.31 ms per token,   763.81 tokens per second)
...
llama_print_timings:        load time =      55.34 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
