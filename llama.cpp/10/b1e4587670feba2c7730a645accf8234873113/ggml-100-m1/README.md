...
- status:  SUCCESS ✅
- runtime: 310.88
- date:    Mon May 27 20:43:11 EEST 2024
...
Label Time Summary:
main    = 168.21 sec*proc (22 tests)

Total Test time (real) = 168.22 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.49 ms /     9 tokens (    1.17 ms per token,   857.71 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
