...
- status:  SUCCESS ✅
- runtime: 4:43.03
- date:    Sun Nov 17 22:25:40 UTC 2024
...
0.00.000.708 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.738 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
...
0.00.007.739 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
...
0.00.020.932 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.020.960 I llm_load_print_meta: n_layer          = 12
0.00.020.969 I llm_load_print_meta: n_head           = 12
0.00.020.970 I llm_load_print_meta: n_head_kv        = 12
0.00.020.970 I llm_load_print_meta: n_rot            = 32
...
0.00.020.977 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.020.977 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.020.978 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.020.979 I llm_load_print_meta: n_ff             = 1536
0.00.020.980 I llm_load_print_meta: n_expert         = 0
0.00.020.980 I llm_load_print_meta: n_expert_used    = 0
0.00.020.980 I llm_load_print_meta: causal attn      = 0
0.00.020.981 I llm_load_print_meta: pooling type     = 2
0.00.020.982 I llm_load_print_meta: rope type        = 2
0.00.020.982 I llm_load_print_meta: rope scaling     = linear
0.00.020.983 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.020.984 I llm_load_print_meta: freq_scale_train = 1
0.00.020.984 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.020.985 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.985 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.985 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.986 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.987 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.987 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.989 I llm_load_print_meta: model type       = 33M
0.00.020.990 I llm_load_print_meta: model ftype      = F16
0.00.020.991 I llm_load_print_meta: model params     = 33.21 M
0.00.020.991 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.020.992 I llm_load_print_meta: general.name     = Bge Small
0.00.020.992 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.992 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.993 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.993 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.994 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.994 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.995 I llm_load_print_meta: max token length = 21
0.00.025.186 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.025.201 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.037.529 I llama_new_context_with_model: n_seq_max     = 1
0.00.037.544 I llama_new_context_with_model: n_ctx         = 512
0.00.037.544 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.037.545 I llama_new_context_with_model: n_batch       = 2048
0.00.037.545 I llama_new_context_with_model: n_ubatch      = 2048
0.00.037.545 I llama_new_context_with_model: flash_attn    = 0
0.00.037.547 I llama_new_context_with_model: freq_base     = 10000.0
0.00.037.548 I llama_new_context_with_model: freq_scale    = 1
...
0.00.041.770 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.041.787 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.041.788 I llama_new_context_with_model: graph nodes  = 429
0.00.041.788 I llama_new_context_with_model: graph splits = 145
0.00.041.790 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.047.311 I 
0.00.047.398 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
...
0.00.056.608 I llama_perf_context_print:        load time =      46.56 ms
0.00.056.610 I llama_perf_context_print: prompt eval time =       6.85 ms /     9 tokens (    0.76 ms per token,  1313.68 tokens per second)
0.00.056.611 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.056.612 I llama_perf_context_print:       total time =       9.30 ms /    10 tokens
...
0.00.017.930 I llm_load_vocab: special tokens cache size = 5
0.00.020.542 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.569 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.570 I llm_load_print_meta: arch             = bert
0.00.020.571 I llm_load_print_meta: vocab type       = WPM
0.00.020.571 I llm_load_print_meta: n_vocab          = 30522
0.00.020.573 I llm_load_print_meta: n_merges         = 0
0.00.020.573 I llm_load_print_meta: vocab_only       = 0
0.00.020.573 I llm_load_print_meta: n_ctx_train      = 512
...
0.00.020.586 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.020.586 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.020.587 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.020.587 I llm_load_print_meta: n_ff             = 1536
0.00.020.587 I llm_load_print_meta: n_expert         = 0
0.00.020.588 I llm_load_print_meta: n_expert_used    = 0
0.00.020.588 I llm_load_print_meta: causal attn      = 0
0.00.020.590 I llm_load_print_meta: pooling type     = 2
0.00.020.591 I llm_load_print_meta: rope type        = 2
0.00.020.591 I llm_load_print_meta: rope scaling     = linear
0.00.020.592 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.020.592 I llm_load_print_meta: freq_scale_train = 1
0.00.020.593 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.020.593 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.594 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.594 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.594 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.594 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.594 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.595 I llm_load_print_meta: model type       = 33M
0.00.020.596 I llm_load_print_meta: model ftype      = Q8_0
0.00.020.597 I llm_load_print_meta: model params     = 33.21 M
0.00.020.597 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.020.598 I llm_load_print_meta: general.name     = Bge Small
0.00.020.598 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.598 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.598 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.600 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.600 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.601 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.601 I llm_load_print_meta: max token length = 21
0.00.023.169 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.024.155 I llama_new_context_with_model: n_seq_max     = 1
0.00.024.170 I llama_new_context_with_model: n_ctx         = 512
0.00.024.171 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.024.171 I llama_new_context_with_model: n_batch       = 2048
0.00.024.171 I llama_new_context_with_model: n_ubatch      = 2048
...
0.00.026.221 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.026.247 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.026.252 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.027.567 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.027.588 I llama_new_context_with_model: graph nodes  = 429
0.00.027.589 I llama_new_context_with_model: graph splits = 1
0.00.027.590 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.030.143 I 
0.00.030.220 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.031.857 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.035.023 I llama_perf_context_print:        load time =      29.50 ms
0.00.035.025 I llama_perf_context_print: prompt eval time =       2.70 ms /     9 tokens (    0.30 ms per token,  3333.33 tokens per second)
0.00.035.026 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.035.027 I llama_perf_context_print:       total time =       4.88 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.665 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.698 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.008.699 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.700 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.700 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.701 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.704 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.706 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.706 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.707 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.707 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.712 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.712 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.714 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.714 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.714 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
...
0.00.019.696 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
...
0.00.019.699 I llama_model_loader: - type  f32:   41 tensors
0.00.019.700 I llama_model_loader: - type  f16:   29 tensors
0.00.037.577 W llm_load_vocab: empty token at index 5
0.00.047.965 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.536 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.657 I llm_load_vocab: special tokens cache size = 5
0.00.343.484 I llm_load_vocab: token to piece cache size = 1.5060 MB
...
0.00.343.510 I llm_load_print_meta: n_merges         = 39382
0.00.343.511 I llm_load_print_meta: vocab_only       = 0
0.00.343.511 I llm_load_print_meta: n_ctx_train      = 8192
0.00.343.511 I llm_load_print_meta: n_embd           = 384
0.00.343.512 I llm_load_print_meta: n_layer          = 4
0.00.343.522 I llm_load_print_meta: n_head           = 12
0.00.343.523 I llm_load_print_meta: n_head_kv        = 12
0.00.343.523 I llm_load_print_meta: n_rot            = 32
0.00.343.523 I llm_load_print_meta: n_swa            = 0
0.00.343.524 I llm_load_print_meta: n_embd_head_k    = 32
0.00.343.524 I llm_load_print_meta: n_embd_head_v    = 32
0.00.343.525 I llm_load_print_meta: n_gqa            = 1
0.00.343.526 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.343.526 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.343.528 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.343.529 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.343.529 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.343.530 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.343.530 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.343.531 I llm_load_print_meta: n_ff             = 1536
0.00.343.531 I llm_load_print_meta: n_expert         = 0
0.00.343.531 I llm_load_print_meta: n_expert_used    = 0
0.00.343.532 I llm_load_print_meta: causal attn      = 0
0.00.343.532 I llm_load_print_meta: pooling type     = -1
0.00.343.532 I llm_load_print_meta: rope type        = -1
0.00.343.533 I llm_load_print_meta: rope scaling     = linear
0.00.343.534 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.343.535 I llm_load_print_meta: freq_scale_train = 1
0.00.343.535 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.343.536 I llm_load_print_meta: rope_finetuned   = unknown
0.00.343.536 I llm_load_print_meta: ssm_d_conv       = 0
0.00.343.536 I llm_load_print_meta: ssm_d_inner      = 0
0.00.343.536 I llm_load_print_meta: ssm_d_state      = 0
0.00.343.537 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.343.537 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.343.537 I llm_load_print_meta: model type       = 33M
0.00.343.538 I llm_load_print_meta: model ftype      = F16
0.00.343.539 I llm_load_print_meta: model params     = 32.90 M
0.00.343.540 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.343.540 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.343.541 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.343.541 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.343.542 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.343.542 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.343.542 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.343.543 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.343.543 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.343.543 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.343.543 I llm_load_print_meta: max token length = 45
0.00.347.323 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.347.338 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.355.801 I llama_new_context_with_model: n_seq_max     = 1
0.00.355.823 I llama_new_context_with_model: n_ctx         = 8192
0.00.355.823 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.355.823 I llama_new_context_with_model: n_batch       = 2048
0.00.355.824 I llama_new_context_with_model: n_ubatch      = 2048
0.00.355.824 I llama_new_context_with_model: flash_attn    = 0
0.00.355.826 I llama_new_context_with_model: freq_base     = 10000.0
0.00.355.827 I llama_new_context_with_model: freq_scale    = 1
0.00.365.768 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.365.794 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.365.802 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.367.799 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.367.822 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.367.823 I llama_new_context_with_model: graph nodes  = 154
0.00.367.823 I llama_new_context_with_model: graph splits = 57
0.00.367.825 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.378.027 I 
0.00.378.125 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.378.416 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.378.429 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.378.435 I main: prompt 1: 'what is panda?</s></s>it's a bear'
...
0.00.378.440 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.378.441 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.382.522 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.398.461 I llama_perf_context_print:        load time =     377.32 ms
0.00.398.463 I llama_perf_context_print: prompt eval time =      15.68 ms /    62 tokens (    0.25 ms per token,  3954.33 tokens per second)
0.00.398.466 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.398.467 I llama_perf_context_print:       total time =      20.44 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.685 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.190 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.195.513 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.195.529 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.994.091 I llama_new_context_with_model: n_seq_max     = 1
0.00.994.114 I llama_new_context_with_model: n_ctx         = 2048
0.00.994.114 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.994.114 I llama_new_context_with_model: n_batch       = 2048
0.00.994.115 I llama_new_context_with_model: n_ubatch      = 512
0.00.994.115 I llama_new_context_with_model: flash_attn    = 0
0.00.994.120 I llama_new_context_with_model: freq_base     = 10000.0
0.00.994.121 I llama_new_context_with_model: freq_scale    = 1
0.01.063.429 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.063.453 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.063.484 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.066.603 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.066.628 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.066.628 I llama_new_context_with_model: graph nodes  = 967
0.01.066.628 I llama_new_context_with_model: graph splits = 194
0.01.066.633 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.330.242 I main: llama threadpool init, n_threads = 4
0.01.330.270 I 
0.01.330.360 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.330.375 I 
0.01.330.558 I sampler seed: 1234
0.01.330.578 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.330.582 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.330.583 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.330.583 I 
...
0.15.571.463 I llama_perf_sampler_print:    sampling time =       2.52 ms /    71 runs   (    0.04 ms per token, 28174.60 tokens per second)
0.15.571.468 I llama_perf_context_print:        load time =    1329.27 ms
0.15.571.470 I llama_perf_context_print: prompt eval time =     436.73 ms /     7 tokens (   62.39 ms per token,    16.03 tokens per second)
0.15.571.472 I llama_perf_context_print:        eval time =   13791.75 ms /    63 runs   (  218.92 ms per token,     4.57 tokens per second)
0.15.571.472 I llama_perf_context_print:       total time =   14241.23 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.695 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.369 I llama_model_loader: - kv  21:               general.quantization_version u32              = 2
0.00.020.371 I llama_model_loader: - type  f32:  194 tensors
0.00.020.372 I llama_model_loader: - type  f16:   98 tensors
...
0.00.075.181 I llm_load_print_meta: model ftype      = all F32 (guessed)
...
0.00.198.091 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.198.111 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.994.288 I llama_new_context_with_model: n_seq_max     = 1
0.00.994.309 I llama_new_context_with_model: n_ctx         = 128
0.00.994.309 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.994.310 I llama_new_context_with_model: n_batch       = 128
0.00.994.310 I llama_new_context_with_model: n_ubatch      = 128
0.00.994.310 I llama_new_context_with_model: flash_attn    = 0
0.00.994.315 I llama_new_context_with_model: freq_base     = 10000.0
0.00.994.316 I llama_new_context_with_model: freq_scale    = 1
0.00.994.317 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.999.110 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.999.139 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.999.162 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.002.207 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.01.002.226 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.01.002.226 I llama_new_context_with_model: graph nodes  = 967
0.01.002.227 I llama_new_context_with_model: graph splits = 194
0.01.002.229 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.232.436 I 
0.01.232.563 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.232.584 I perplexity: tokenizing the input ..
0.01.242.106 I perplexity: tokenization took 9.518 ms
0.01.242.147 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.04.824.132 I perplexity: 3.58 seconds per pass - ETA 0.05 minutes
[1]10.1479,
0.04.828.800 I Final estimate: PPL = 10.1479 +/- 3.22609

0.04.828.881 I llama_perf_context_print:        load time =    1231.69 ms
0.04.828.883 I llama_perf_context_print: prompt eval time =    3580.00 ms /   128 tokens (   27.97 ms per token,    35.75 tokens per second)
0.04.828.884 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.04.828.885 I llama_perf_context_print:       total time =    3596.45 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.670 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.279 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
...
0.00.075.175 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.176 I llm_load_print_meta: model params     = 1.41 B
0.00.075.177 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.165.062 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.167.318 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.235.816 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.235.841 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.235.860 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.237.953 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.237.976 I llama_new_context_with_model: graph nodes  = 967
0.00.237.977 I llama_new_context_with_model: graph splits = 1
0.00.237.981 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.319.251 I main: llama threadpool init, n_threads = 4
0.00.319.278 I 
0.00.319.355 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.319.369 I 
0.00.319.503 I sampler seed: 1234
0.00.319.522 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.319.525 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.319.526 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.319.526 I 
...
0.03.109.977 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31332.74 tokens per second)
0.03.109.980 I llama_perf_context_print:        load time =     318.28 ms
0.03.109.981 I llama_perf_context_print: prompt eval time =     117.56 ms /     7 tokens (   16.79 ms per token,    59.55 tokens per second)
0.03.109.983 I llama_perf_context_print:        eval time =    2661.34 ms /    63 runs   (   42.24 ms per token,    23.67 tokens per second)
0.03.109.983 I llama_perf_context_print:       total time =    2790.73 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.769 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.403 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.020.715 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
...
0.00.167.614 I llama_new_context_with_model: n_ctx         = 128
0.00.167.614 I llama_new_context_with_model: n_ctx_per_seq = 128
...
0.00.167.616 I llama_new_context_with_model: freq_base     = 10000.0
0.00.167.617 I llama_new_context_with_model: freq_scale    = 1
0.00.167.618 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.172.275 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.172.301 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.172.316 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.221.848 I 
0.00.221.939 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.221.958 I perplexity: tokenizing the input ..
0.00.230.533 I perplexity: tokenization took 8.571 ms
0.00.230.565 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.126.739 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.130.456 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.130.496 I llama_perf_context_print:        load time =     221.04 ms
0.01.130.498 I llama_perf_context_print: prompt eval time =     894.50 ms /   128 tokens (    6.99 ms per token,   143.10 tokens per second)
0.01.130.500 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.130.500 I llama_perf_context_print:       total time =     908.65 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.696 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.126.253 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
...............................................................................
0.00.370.097 I llama_new_context_with_model: n_seq_max     = 1
0.00.370.117 I llama_new_context_with_model: n_ctx         = 2048
0.00.370.117 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.370.122 I llama_new_context_with_model: freq_base     = 10000.0
0.00.370.123 I llama_new_context_with_model: freq_scale    = 1
0.00.439.014 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.439.045 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.439.077 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.442.265 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.442.284 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.442.285 I llama_new_context_with_model: graph nodes  = 967
0.00.442.285 I llama_new_context_with_model: graph splits = 193
0.00.442.289 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.564.313 I main: llama threadpool init, n_threads = 4
0.00.564.343 I 
0.00.564.440 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.564.456 I 
0.00.564.649 I sampler seed: 1234
0.00.564.670 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.564.674 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.564.674 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.564.674 I 
I believe the meaning of life is to know and experience things. I think that is the only way we can truly know ourselves. I don't see any other way to truly know ourselves.

It's the same thing with our society. Our society is becoming a self-centered society, where we don't care about others. We are becoming so

0.04.687.829 I llama_perf_sampler_print:    sampling time =       2.74 ms /    71 runs   (    0.04 ms per token, 25921.87 tokens per second)
0.04.687.833 I llama_perf_context_print:        load time =     563.33 ms
0.04.687.835 I llama_perf_context_print: prompt eval time =     109.66 ms /     7 tokens (   15.67 ms per token,    63.83 tokens per second)
0.04.687.838 I llama_perf_context_print:        eval time =    4001.67 ms /    63 runs   (   63.52 ms per token,    15.74 tokens per second)
0.04.687.839 I llama_perf_context_print:       total time =    4123.52 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.715 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.400 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_0.gguf (version GGUF V3 (latest))
...
0.00.126.087 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
0.00.126.106 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
...............................................................................
0.00.369.933 I llama_new_context_with_model: n_seq_max     = 1
0.00.369.955 I llama_new_context_with_model: n_ctx         = 128
0.00.369.955 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.369.956 I llama_new_context_with_model: n_batch       = 128
0.00.369.956 I llama_new_context_with_model: n_ubatch      = 128
0.00.369.956 I llama_new_context_with_model: flash_attn    = 0
0.00.369.961 I llama_new_context_with_model: freq_base     = 10000.0
0.00.369.962 I llama_new_context_with_model: freq_scale    = 1
0.00.369.963 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.374.937 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.374.965 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.375.030 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.377.662 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.377.689 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.377.690 I llama_new_context_with_model: graph nodes  = 967
0.00.377.690 I llama_new_context_with_model: graph splits = 193
0.00.377.692 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.464.988 I 
0.00.465.107 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.465.128 I perplexity: tokenizing the input ..
0.00.474.689 I perplexity: tokenization took 9.557 ms
0.00.474.729 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.946.972 I perplexity: 1.47 seconds per pass - ETA 0.02 minutes
[1]14.0286,
0.02.004.778 I Final estimate: PPL = 14.0286 +/- 4.40641

0.02.004.863 I llama_perf_context_print:        load time =     464.23 ms
0.02.004.865 I llama_perf_context_print: prompt eval time =    1470.33 ms /   128 tokens (   11.49 ms per token,    87.06 tokens per second)
0.02.004.867 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.004.868 I llama_perf_context_print:       total time =    1539.87 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.697 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.132.137 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
0.00.132.153 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
................................................................................
0.00.400.128 I llama_new_context_with_model: n_seq_max     = 1
0.00.400.149 I llama_new_context_with_model: n_ctx         = 2048
0.00.400.149 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.400.150 I llama_new_context_with_model: n_batch       = 2048
0.00.400.150 I llama_new_context_with_model: n_ubatch      = 512
0.00.400.151 I llama_new_context_with_model: flash_attn    = 0
0.00.400.155 I llama_new_context_with_model: freq_base     = 10000.0
0.00.400.156 I llama_new_context_with_model: freq_scale    = 1
0.00.469.156 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.469.186 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.469.217 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.471.981 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.472.005 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.472.005 I llama_new_context_with_model: graph nodes  = 967
0.00.472.006 I llama_new_context_with_model: graph splits = 193
0.00.472.010 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.601.608 I main: llama threadpool init, n_threads = 4
0.00.601.639 I 
0.00.601.738 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.601.755 I 
0.00.601.929 I sampler seed: 1234
0.00.601.951 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.601.954 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.601.955 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.601.955 I 
...
0.05.122.571 I llama_perf_sampler_print:    sampling time =       2.72 ms /    71 runs   (    0.04 ms per token, 26102.94 tokens per second)
0.05.122.575 I llama_perf_context_print:        load time =     600.64 ms
0.05.122.577 I llama_perf_context_print: prompt eval time =     114.03 ms /     7 tokens (   16.29 ms per token,    61.39 tokens per second)
0.05.122.579 I llama_perf_context_print:        eval time =    4394.98 ms /    63 runs   (   69.76 ms per token,    14.33 tokens per second)
0.05.122.580 I llama_perf_context_print:       total time =    4520.97 ms /    70 tokens
...
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.697 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.303 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.076.089 I llm_load_print_meta: model ftype      = Q4_1
0.00.076.090 I llm_load_print_meta: model params     = 1.41 B
0.00.076.091 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.554 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
0.00.130.570 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
................................................................................
0.00.396.696 I llama_new_context_with_model: n_seq_max     = 1
0.00.396.715 I llama_new_context_with_model: n_ctx         = 128
0.00.396.715 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.396.715 I llama_new_context_with_model: n_batch       = 128
0.00.396.716 I llama_new_context_with_model: n_ubatch      = 128
0.00.396.716 I llama_new_context_with_model: flash_attn    = 0
0.00.396.721 I llama_new_context_with_model: freq_base     = 10000.0
0.00.396.722 I llama_new_context_with_model: freq_scale    = 1
0.00.396.723 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.401.923 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.401.952 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.401.976 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.404.933 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.404.957 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.404.958 I llama_new_context_with_model: graph nodes  = 967
0.00.404.958 I llama_new_context_with_model: graph splits = 193
0.00.404.960 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.496.903 I 
0.00.497.032 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.497.041 I perplexity: tokenizing the input ..
0.00.506.613 I perplexity: tokenization took 9.568 ms
0.00.506.643 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.005.660 I perplexity: 1.50 seconds per pass - ETA 0.02 minutes
[1]12.6335,
0.02.063.763 I Final estimate: PPL = 12.6335 +/- 3.89535

0.02.063.845 I llama_perf_context_print:        load time =     496.16 ms
0.02.063.847 I llama_perf_context_print: prompt eval time =    1497.22 ms /   128 tokens (   11.70 ms per token,    85.49 tokens per second)
0.02.063.849 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.063.851 I llama_perf_context_print:       total time =    1566.94 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.659 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.587 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.588 I llm_load_print_meta: model params     = 1.41 B
0.00.075.589 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.132.683 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
...
0.00.202.750 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.202.778 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.202.799 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.204.822 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.204.844 I llama_new_context_with_model: graph nodes  = 967
0.00.204.845 I llama_new_context_with_model: graph splits = 1
0.00.204.849 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.312.116 I main: llama threadpool init, n_threads = 4
0.00.312.144 I 
0.00.312.225 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.312.239 I 
...
0.02.623.324 I llama_perf_sampler_print:    sampling time =       2.68 ms /    71 runs   (    0.04 ms per token, 26492.54 tokens per second)
0.02.623.328 I llama_perf_context_print:        load time =     311.19 ms
0.02.623.329 I llama_perf_context_print: prompt eval time =     124.51 ms /     7 tokens (   17.79 ms per token,    56.22 tokens per second)
0.02.623.331 I llama_perf_context_print:        eval time =    2174.60 ms /    63 runs   (   34.52 ms per token,    28.97 tokens per second)
0.02.623.332 I llama_perf_context_print:       total time =    2311.21 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.694 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.164 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.020.316 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
0.00.020.335 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.020.336 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 0
0.00.020.336 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 0
0.00.020.337 I llama_model_loader: - kv  21:               general.quantization_version u32              = 2
0.00.020.337 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.020.340 I llama_model_loader: - type  f32:  194 tensors
0.00.020.340 I llama_model_loader: - type q5_0:   97 tensors
0.00.020.341 I llama_model_loader: - type q6_K:    1 tensors
0.00.062.729 I llm_load_vocab: special tokens cache size = 25
...
0.00.074.514 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.074.515 I llm_load_print_meta: n_ff             = 8192
0.00.074.515 I llm_load_print_meta: n_expert         = 0
...
0.00.131.565 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.134.008 I llama_new_context_with_model: n_seq_max     = 1
0.00.134.029 I llama_new_context_with_model: n_ctx         = 128
0.00.134.030 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.134.030 I llama_new_context_with_model: n_batch       = 128
0.00.134.030 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.134.035 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.138.714 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.138.741 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.138.754 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.140.802 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.183.388 I 
0.00.183.486 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.183.492 I perplexity: tokenizing the input ..
0.00.192.065 I perplexity: tokenization took 8.57 ms
0.00.192.098 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.322.762 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.380.418 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.380.456 I llama_perf_context_print:        load time =     182.65 ms
0.01.380.458 I llama_perf_context_print: prompt eval time =    1128.96 ms /   128 tokens (    8.82 ms per token,   113.38 tokens per second)
0.01.380.460 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.380.461 I llama_perf_context_print:       total time =    1197.07 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.699 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.925 I main: llama backend init
0.00.000.943 I main: load the model and apply lora adapter, if any
0.00.009.288 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.128.275 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.130.411 I llama_new_context_with_model: n_seq_max     = 1
0.00.130.432 I llama_new_context_with_model: n_ctx         = 2048
0.00.130.432 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.130.433 I llama_new_context_with_model: n_batch       = 2048
0.00.130.433 I llama_new_context_with_model: n_ubatch      = 512
0.00.130.433 I llama_new_context_with_model: flash_attn    = 0
0.00.130.435 I llama_new_context_with_model: freq_base     = 10000.0
0.00.130.435 I llama_new_context_with_model: freq_scale    = 1
0.00.199.314 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.199.344 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.199.360 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.201.490 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.201.509 I llama_new_context_with_model: graph nodes  = 967
0.00.201.509 I llama_new_context_with_model: graph splits = 1
0.00.201.513 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.294.473 I main: llama threadpool init, n_threads = 4
0.00.294.503 I 
0.00.294.593 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.294.606 I 
0.00.294.724 I sampler seed: 1234
0.00.294.745 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.294.749 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.294.749 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.294.749 I 
...
0.02.707.454 I llama_perf_sampler_print:    sampling time =       2.68 ms /    71 runs   (    0.04 ms per token, 26472.78 tokens per second)
0.02.707.458 I llama_perf_context_print:        load time =     293.51 ms
0.02.707.459 I llama_perf_context_print: prompt eval time =     125.14 ms /     7 tokens (   17.88 ms per token,    55.94 tokens per second)
0.02.707.461 I llama_perf_context_print:        eval time =    2276.04 ms /    63 runs   (   36.13 ms per token,    27.68 tokens per second)
0.02.707.462 I llama_perf_context_print:       total time =    2412.99 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.700 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.127.491 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.129.612 I llama_new_context_with_model: n_seq_max     = 1
0.00.129.633 I llama_new_context_with_model: n_ctx         = 128
0.00.129.633 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.129.633 I llama_new_context_with_model: n_batch       = 128
0.00.129.634 I llama_new_context_with_model: n_ubatch      = 128
0.00.129.634 I llama_new_context_with_model: flash_attn    = 0
0.00.129.636 I llama_new_context_with_model: freq_base     = 10000.0
0.00.129.637 I llama_new_context_with_model: freq_scale    = 1
0.00.129.637 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.134.241 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.134.268 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.134.282 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.198.124 I 
0.00.198.225 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.198.232 I perplexity: tokenizing the input ..
0.00.206.905 I perplexity: tokenization took 8.67 ms
0.00.206.936 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.147.211 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.205.370 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.205.415 I llama_perf_context_print:        load time =     197.38 ms
0.02.205.417 I llama_perf_context_print: prompt eval time =    1938.49 ms /   128 tokens (   15.14 ms per token,    66.03 tokens per second)
0.02.205.419 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.205.420 I llama_perf_context_print:       total time =    2007.29 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.635 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.459 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.460 I llm_load_print_meta: model params     = 1.41 B
0.00.075.461 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.107.856 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.110.043 I llama_new_context_with_model: n_seq_max     = 1
0.00.110.064 I llama_new_context_with_model: n_ctx         = 2048
0.00.110.064 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.178.207 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.178.235 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.178.252 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.180.850 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.180.872 I llama_new_context_with_model: graph nodes  = 967
0.00.180.872 I llama_new_context_with_model: graph splits = 1
0.00.180.876 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.254.643 I main: llama threadpool init, n_threads = 4
0.00.254.672 I 
0.00.254.756 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.254.756 I 
0.00.254.870 I sampler seed: 1234
0.00.254.877 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.254.881 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.254.881 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.254.882 I 
I believe the meaning of life is a one-f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <

0.01.728.287 I llama_perf_sampler_print:    sampling time =       2.35 ms /    71 runs   (    0.03 ms per token, 30148.62 tokens per second)
0.01.728.290 I llama_perf_context_print:        load time =     253.74 ms
0.01.728.292 I llama_perf_context_print: prompt eval time =      80.10 ms /     7 tokens (   11.44 ms per token,    87.39 tokens per second)
0.01.728.294 I llama_perf_context_print:        eval time =    1382.11 ms /    63 runs   (   21.94 ms per token,    45.58 tokens per second)
0.01.728.295 I llama_perf_context_print:       total time =    1473.65 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.676 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.184 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.184 I llm_load_print_meta: model params     = 1.41 B
0.00.076.185 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.110.301 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.112.507 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.112.530 I llama_new_context_with_model: n_ubatch      = 128
0.00.112.531 I llama_new_context_with_model: flash_attn    = 0
0.00.112.532 I llama_new_context_with_model: freq_base     = 10000.0
...
0.00.117.193 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.117.217 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.117.232 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.119.814 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.119.830 I llama_new_context_with_model: graph nodes  = 967
0.00.119.830 I llama_new_context_with_model: graph splits = 1
0.00.119.832 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.158.873 I 
0.00.158.974 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.158.981 I perplexity: tokenizing the input ..
0.00.167.640 I perplexity: tokenization took 8.655 ms
0.00.167.669 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.463.945 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.521.866 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.521.910 I llama_perf_context_print:        load time =     158.16 ms
0.01.521.914 I llama_perf_context_print: prompt eval time =    1294.57 ms /   128 tokens (   10.11 ms per token,    98.87 tokens per second)
0.01.521.928 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.521.929 I llama_perf_context_print:       total time =    1363.04 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.656 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.907 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.908 I llm_load_print_meta: model params     = 1.41 B
0.00.075.908 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.115.700 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.117.884 I llama_new_context_with_model: n_seq_max     = 1
0.00.117.906 I llama_new_context_with_model: n_ctx         = 2048
0.00.117.906 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.117.906 I llama_new_context_with_model: n_batch       = 2048
0.00.117.907 I llama_new_context_with_model: n_ubatch      = 512
0.00.117.907 I llama_new_context_with_model: flash_attn    = 0
0.00.117.909 I llama_new_context_with_model: freq_base     = 10000.0
0.00.117.909 I llama_new_context_with_model: freq_scale    = 1
0.00.186.017 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.186.045 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.186.061 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.188.140 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.188.156 I llama_new_context_with_model: graph nodes  = 967
0.00.188.156 I llama_new_context_with_model: graph splits = 1
0.00.188.159 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.269.465 I main: llama threadpool init, n_threads = 4
0.00.269.494 I 
0.00.269.581 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.269.594 I 
0.00.269.709 I sampler seed: 1234
0.00.269.729 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.269.732 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.269.733 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.269.733 I 
...
0.02.049.757 I llama_perf_sampler_print:    sampling time =       2.60 ms /    71 runs   (    0.04 ms per token, 27297.19 tokens per second)
0.02.049.761 I llama_perf_context_print:        load time =     268.53 ms
0.02.049.763 I llama_perf_context_print: prompt eval time =      89.64 ms /     7 tokens (   12.81 ms per token,    78.09 tokens per second)
0.02.049.765 I llama_perf_context_print:        eval time =    1678.98 ms /    63 runs   (   26.65 ms per token,    37.52 tokens per second)
0.02.049.766 I llama_perf_context_print:       total time =    1780.30 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.675 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.114.648 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.116.859 I llama_new_context_with_model: n_seq_max     = 1
0.00.116.882 I llama_new_context_with_model: n_ctx         = 128
0.00.116.882 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.116.883 I llama_new_context_with_model: n_batch       = 128
0.00.116.883 I llama_new_context_with_model: n_ubatch      = 128
0.00.116.883 I llama_new_context_with_model: flash_attn    = 0
0.00.116.885 I llama_new_context_with_model: freq_base     = 10000.0
0.00.116.886 I llama_new_context_with_model: freq_scale    = 1
0.00.116.887 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.121.514 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.121.541 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.121.559 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.123.649 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
...
0.00.170.471 I 
0.00.170.603 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.170.629 I perplexity: tokenizing the input ..
0.00.180.036 I perplexity: tokenization took 9.404 ms
0.00.180.069 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.520.890 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.5352,
0.01.578.899 I Final estimate: PPL = 12.5352 +/- 4.09556

0.01.578.941 I llama_perf_context_print:        load time =     169.75 ms
0.01.578.944 I llama_perf_context_print: prompt eval time =    1338.95 ms /   128 tokens (   10.46 ms per token,    95.60 tokens per second)
0.01.578.945 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.578.947 I llama_perf_context_print:       total time =    1408.47 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.667 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.635 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
..............................................................................
0.00.125.270 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.291 I llama_new_context_with_model: n_ctx         = 2048
0.00.125.291 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.125.291 I llama_new_context_with_model: n_batch       = 2048
0.00.125.292 I llama_new_context_with_model: n_ubatch      = 512
0.00.125.292 I llama_new_context_with_model: flash_attn    = 0
0.00.125.293 I llama_new_context_with_model: freq_base     = 10000.0
0.00.125.294 I llama_new_context_with_model: freq_scale    = 1
0.00.194.593 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.194.622 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.194.644 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.196.807 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.196.823 I llama_new_context_with_model: graph nodes  = 967
0.00.196.823 I llama_new_context_with_model: graph splits = 1
0.00.196.827 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.280.149 I main: llama threadpool init, n_threads = 4
0.00.280.177 I 
0.00.280.264 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.280.278 I 
0.00.280.407 I sampler seed: 1234
0.00.280.427 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.280.430 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.280.431 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.280.431 I 
I believe the meaning of life is that it's up to us to make it."

"I agree with that," said I. "But the Bible isn't the only place we get our meaning of life, and it certainly isn't the only place that's more important than all others. The meaning of life isn't in the stars, the

0.02.310.837 I llama_perf_sampler_print:    sampling time =       2.65 ms /    71 runs   (    0.04 ms per token, 26832.96 tokens per second)
0.02.310.840 I llama_perf_context_print:        load time =     279.24 ms
0.02.310.842 I llama_perf_context_print: prompt eval time =      93.27 ms /     7 tokens (   13.32 ms per token,    75.05 tokens per second)
0.02.310.844 I llama_perf_context_print:        eval time =    1925.73 ms /    63 runs   (   30.57 ms per token,    32.71 tokens per second)
0.02.310.844 I llama_perf_context_print:       total time =    2030.69 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.811 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.123.074 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.125.382 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.405 I llama_new_context_with_model: n_ctx         = 128
0.00.125.405 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.125.405 I llama_new_context_with_model: n_batch       = 128
0.00.125.406 I llama_new_context_with_model: n_ubatch      = 128
0.00.125.406 I llama_new_context_with_model: flash_attn    = 0
0.00.125.408 I llama_new_context_with_model: freq_base     = 10000.0
0.00.125.409 I llama_new_context_with_model: freq_scale    = 1
0.00.125.410 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.130.109 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
...
0.00.183.431 I 
0.00.183.549 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.183.570 I perplexity: tokenizing the input ..
0.00.192.394 I perplexity: tokenization took 8.821 ms
0.00.192.426 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.596.948 I perplexity: 1.40 seconds per pass - ETA 0.02 minutes
[1]10.3212,
0.01.655.016 I Final estimate: PPL = 10.3212 +/- 3.25897

0.01.655.062 I llama_perf_context_print:        load time =     182.57 ms
0.01.655.065 I llama_perf_context_print: prompt eval time =    1402.76 ms /   128 tokens (   10.96 ms per token,    91.25 tokens per second)
0.01.655.067 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.655.068 I llama_perf_context_print:       total time =    1471.63 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.666 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.932 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.074.933 I llm_load_print_meta: model params     = 1.41 B
0.00.074.934 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.127.475 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.129.606 I llama_new_context_with_model: n_seq_max     = 1
0.00.129.628 I llama_new_context_with_model: n_ctx         = 2048
0.00.129.628 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.129.628 I llama_new_context_with_model: n_batch       = 2048
0.00.129.629 I llama_new_context_with_model: n_ubatch      = 512
0.00.129.629 I llama_new_context_with_model: flash_attn    = 0
0.00.129.631 I llama_new_context_with_model: freq_base     = 10000.0
0.00.129.631 I llama_new_context_with_model: freq_scale    = 1
0.00.197.353 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.197.381 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.197.399 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.199.524 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.199.541 I llama_new_context_with_model: graph nodes  = 967
0.00.199.541 I llama_new_context_with_model: graph splits = 1
0.00.199.544 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.285.953 I main: llama threadpool init, n_threads = 4
0.00.285.983 I 
0.00.286.075 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.286.088 I 
0.00.286.220 I sampler seed: 1234
0.00.286.241 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.286.244 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.286.245 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.286.245 I 
I believe the meaning of life is to die in one’s sleep. I believe that the only way to be happy is to be happy.
I believe that there is no point in living if there is no meaning in life. I believe that the reason we humans live our lives is to enjoy them.
I believe that life is not a matter

0.02.600.854 I llama_perf_sampler_print:    sampling time =       2.79 ms /    71 runs   (    0.04 ms per token, 25457.15 tokens per second)
0.02.600.857 I llama_perf_context_print:        load time =     285.02 ms
0.02.600.859 I llama_perf_context_print: prompt eval time =     108.11 ms /     7 tokens (   15.44 ms per token,    64.75 tokens per second)
0.02.600.861 I llama_perf_context_print:        eval time =    2194.77 ms /    63 runs   (   34.84 ms per token,    28.70 tokens per second)
0.02.600.862 I llama_perf_context_print:       total time =    2314.91 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.736 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.646 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.647 I llm_load_print_meta: model params     = 1.41 B
0.00.075.648 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.128.292 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.130.470 I llama_new_context_with_model: n_seq_max     = 1
0.00.130.492 I llama_new_context_with_model: n_ctx         = 128
0.00.130.493 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.130.493 I llama_new_context_with_model: n_batch       = 128
0.00.130.493 I llama_new_context_with_model: n_ubatch      = 128
0.00.130.494 I llama_new_context_with_model: flash_attn    = 0
0.00.130.495 I llama_new_context_with_model: freq_base     = 10000.0
0.00.130.496 I llama_new_context_with_model: freq_scale    = 1
0.00.130.497 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.135.914 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.135.939 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.135.956 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.138.683 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.138.707 I llama_new_context_with_model: graph nodes  = 967
0.00.138.707 I llama_new_context_with_model: graph splits = 1
0.00.138.709 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.190.016 I 
0.00.190.123 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.190.143 I perplexity: tokenizing the input ..
0.00.199.214 I perplexity: tokenization took 9.068 ms
0.00.199.250 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.888.773 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.7557,
0.01.946.843 I Final estimate: PPL = 10.7557 +/- 3.44724

0.01.946.884 I llama_perf_context_print:        load time =     189.24 ms
0.01.946.886 I llama_perf_context_print: prompt eval time =    1687.81 ms /   128 tokens (   13.19 ms per token,    75.84 tokens per second)
0.01.946.888 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.946.890 I llama_perf_context_print:       total time =    1756.87 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.645 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.499 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.075.972 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.973 I llm_load_print_meta: model params     = 1.41 B
0.00.075.974 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.129.447 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.131.709 I llama_new_context_with_model: n_seq_max     = 1
0.00.131.729 I llama_new_context_with_model: n_ctx         = 2048
0.00.131.730 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.131.730 I llama_new_context_with_model: n_batch       = 2048
0.00.131.730 I llama_new_context_with_model: n_ubatch      = 512
0.00.131.731 I llama_new_context_with_model: flash_attn    = 0
0.00.131.733 I llama_new_context_with_model: freq_base     = 10000.0
0.00.131.733 I llama_new_context_with_model: freq_scale    = 1
0.00.199.693 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.199.717 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.199.737 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.202.376 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.202.398 I llama_new_context_with_model: graph nodes  = 967
0.00.202.399 I llama_new_context_with_model: graph splits = 1
0.00.202.403 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.157 I main: llama threadpool init, n_threads = 4
0.00.290.185 I 
0.00.290.275 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.290.290 I 
0.00.290.438 I sampler seed: 1234
0.00.290.459 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.290.462 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.290.463 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.290.463 I 
I believe the meaning of life is to do good works in the world." "I believe that if I had to do it all over again, I wouldn't change a thing." "I know I wouldn't." "If I could do it all over again, I wouldn't have a car or a phone or a television or a computer." "I

0.02.762.663 I llama_perf_sampler_print:    sampling time =       2.70 ms /    71 runs   (    0.04 ms per token, 26267.11 tokens per second)
0.02.762.666 I llama_perf_context_print:        load time =     289.25 ms
0.02.762.668 I llama_perf_context_print: prompt eval time =     107.07 ms /     7 tokens (   15.30 ms per token,    65.38 tokens per second)
0.02.762.670 I llama_perf_context_print:        eval time =    2353.24 ms /    63 runs   (   37.35 ms per token,    26.77 tokens per second)
0.02.762.671 I llama_perf_context_print:       total time =    2472.51 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.698 I build: 4120 (76e9e58b) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.560 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.561 I llm_load_print_meta: model params     = 1.41 B
0.00.075.562 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.130.735 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.132.871 I llama_new_context_with_model: n_seq_max     = 1
0.00.132.893 I llama_new_context_with_model: n_ctx         = 128
0.00.132.894 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.132.894 I llama_new_context_with_model: n_batch       = 128
...
0.00.132.898 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.137.794 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.137.815 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.137.829 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.140.541 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.140.563 I llama_new_context_with_model: graph nodes  = 967
...
0.00.197.925 I 
0.00.198.054 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.198.077 I perplexity: tokenizing the input ..
0.00.207.521 I perplexity: tokenization took 9.44 ms
0.00.207.559 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.860.204 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.3422,
0.01.918.299 I Final estimate: PPL = 10.3422 +/- 3.28010

0.01.918.344 I llama_perf_context_print:        load time =     197.18 ms
0.01.918.347 I llama_perf_context_print: prompt eval time =    1650.53 ms /   128 tokens (   12.89 ms per token,    77.55 tokens per second)
0.01.918.349 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.918.350 I llama_perf_context_print:       total time =    1720.42 ms /   129 tokens
...
0.00.436.500 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
0.63user 0.61system 0:01.24elapsed 100%CPU (0avgtext+0avgdata 5359508maxresident)k
...
0.48user 0.63system 0:01.10elapsed 100%CPU (0avgtext+0avgdata 5356080maxresident)k
0inputs+32outputs (0major+53231minor)pagefaults 0swaps
```
