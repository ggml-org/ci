...
- status:  SUCCESS ✅
- runtime: 816.30
- date:    Sat Dec  7 01:31:05 PST 2024
...
0.00.078.041 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.062.260 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.102.006 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.048.521 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.050.129 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.733 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.048.459 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.026.969 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.048.758 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.040.919 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.085.486 I llm_load_print_meta: LF token         = 128 'Ä'
