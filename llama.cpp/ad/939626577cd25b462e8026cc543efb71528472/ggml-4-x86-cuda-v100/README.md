...
- status:  SUCCESS ✅
- runtime: 20:50.04
- date:    Tue Oct 24 20:50:45 UTC 2023
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 7/17 Test  #7: test-tokenizer-1-baichuan ........   Passed   10.40 sec
...
Log start
main: build = 1426 (ad93962)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
main: seed  = 1234
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 18 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-f16.gguf (version unknown)
...
I am particularly keen that new approaches will be adopted in order to solve problems rather than just addressing symptoms, which is what we are currently witnessing happening all too often nowadays.. I believe change comes from people - when they get together! And there’s no better way for them to do this then by sharing knowledge and understanding through the use of stories.
In my spare time you will usually find me out hiking somewhere in Sweden or reading a book about happiness, psychology, education or sustainability (or any combination thereof). I also love travelling - preferably with good company! In fact one day if there is still much to discover on this planet then that’s the best way for life to go: exploring together.
Lars Oskarsson has been working as innovation manager at The Natural Step Sweden since 2015 and started his career as an
llama_print_timings:        load time =    2484.48 ms
llama_print_timings:      sample time =     117.45 ms /   256 runs   (    0.46 ms per token,  2179.71 tokens per second)
llama_print_timings: prompt eval time =      25.28 ms /     8 tokens (    3.16 ms per token,   316.46 tokens per second)
llama_print_timings:        eval time =    4830.44 ms /   255 runs   (   18.94 ms per token,    52.79 tokens per second)
llama_print_timings:       total time =    5056.31 ms
Log end
...
perplexity: tokenization took 1052.05 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 0.97 seconds per pass - ETA 0.05 minutes
[1]5.5246,[2]6.8304,[3]7.4340,[4]6.8791,
llama_print_timings:        load time =    3032.88 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3111.69 ms /  8192 tokens (    0.38 ms per token,  2632.65 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4997.46 ms
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q8_0.gguf (version unknown)
...
I believe the meaning of life is to do with helping other people. This may be in many ways; it could mean giving money, food or goods that you have bought at a supermarket (whatever they are) but there's more going on here than meets first glance!
To me this means being kind and thoughtful towards others - perhaps when we see somebody who is struggling with life maybe help them out in some way whether it be getting up an extra set of stairs for example. This will not only make the person you have helped feel better but makes us a happier soul as well, because deep down inside every one loves to get a compliment or thank-you!
The key here is that we are all human and need things at times in our lives so by helping out another it creates an equilibrium; I am sure this has been said before. But when doing something for somebody else whether you know them personally, see them on the street or simply read about their plight (there's a lot going on every day!) - do not think of what they can get back to me but focus instead that whatever it is your helping out with will make someone elses life better in some way.
The best part is you don’t even have to go far for this, maybe just being kind
llama_print_timings:        load time =    1499.35 ms
llama_print_timings:      sample time =     120.03 ms /   256 runs   (    0.47 ms per token,  2132.75 tokens per second)
llama_print_timings: prompt eval time =     109.15 ms /     8 tokens (   13.64 ms per token,    73.29 tokens per second)
llama_print_timings:        eval time =    3248.88 ms /   255 runs   (   12.74 ms per token,    78.49 tokens per second)
llama_print_timings:       total time =    3562.98 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1062.89 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.59 seconds per pass - ETA 0.10 minutes
[1]5.5280,[2]6.8258,[3]7.4303,[4]6.8772,
llama_print_timings:        load time =    2066.39 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5518.04 ms /  8192 tokens (    0.67 ms per token,  1484.58 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7455.91 ms

Final estimate: PPL = 6.8772 +/- 0.25570
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q4_0.gguf (version unknown)
...
I believe the meaning of life is to have a family. I think everyone should be able to experience it, and if you can’t get that kind of happiness in this world then there isn’t much point going on with anything else really when we do end up dying at some stage anyway!
The first thing about having children for me personally was the knowledge from my parents. I believe they are one of those people who always go out doing something interesting and exciting to share their experience so that you too can enjoy them as well if possible - which could be any number things like movies/plays or even sports games together with all sorts in between such as camping holidays!
The second thing about having children for me personally was the knowledge from my parents. I believe they are one of those people who always go out doing something interesting and exciting to share their experience so that you too can enjoy them if possible - which could be anything like movies/plays or even sports games together with all sorts in between such as camping holidays!
And finally, the third thing about having children for me personally was knowing how much fun it is. It’s always been something I enjoyed doing and have spent many years of my life around them so far; whether that’s being a mum or auntie/n
llama_print_timings:        load time =     945.01 ms
llama_print_timings:      sample time =     117.11 ms /   256 runs   (    0.46 ms per token,  2185.92 tokens per second)
llama_print_timings: prompt eval time =      93.41 ms /     8 tokens (   11.68 ms per token,    85.65 tokens per second)
llama_print_timings:        eval time =    2201.18 ms /   255 runs   (    8.63 ms per token,   115.85 tokens per second)
llama_print_timings:       total time =    2494.28 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1047.04 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.68 seconds per pass - ETA 0.10 minutes
[1]5.6481,[2]6.9321,[3]7.5687,[4]7.0074,
llama_print_timings:        load time =    1493.67 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5962.45 ms /  8192 tokens (    0.73 ms per token,  1373.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7866.46 ms

Final estimate: PPL = 7.0074 +/- 0.26069
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q4_1.gguf (version unknown)
...
I believe the meaning of life is to have a happy childhood.
And I think that it’s true for everyone, not just me.
Life can be so difficult sometimes and you feel lost in all sorts of ways…but if when your children were babies they had no troubles or worries – then why should we as adults? Our time on this planet is precious to us; its the only one we get! That’s also what life means for me. I have been really lucky with my childhood and feel blessed that it was so peaceful, because now things can be difficult when you are older…that makes your children happy too though if they had a normal upbringing like mine – no problems or worries in this world!
I think the meaning of life is to live your dreams. Your whole purpose for living should revolve around what gives joy and happiness each day, not just because it’s expected but also by doing things that make you happy as well- even if other people don’t understand why some decisions have been made – such an important part in determining whether or
I believe the meaning of life is to enjoy every moment. To embrace change and never be afraid to try something new, especially when it comes with risk because this world isn’t perfect enough yet for us
llama_print_timings:        load time =    1023.81 ms
llama_print_timings:      sample time =     117.52 ms /   256 runs   (    0.46 ms per token,  2178.37 tokens per second)
llama_print_timings: prompt eval time =     112.59 ms /     8 tokens (   14.07 ms per token,    71.06 tokens per second)
llama_print_timings:        eval time =    2301.97 ms /   255 runs   (    9.03 ms per token,   110.77 tokens per second)
llama_print_timings:       total time =    2616.29 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1034.28 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.94 seconds per pass - ETA 0.12 minutes
[1]5.6820,[2]6.9508,[3]7.5642,[4]7.0203,
llama_print_timings:        load time =    1557.15 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7004.63 ms /  8192 tokens (    0.86 ms per token,  1169.51 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8876.65 ms

Final estimate: PPL = 7.0203 +/- 0.26057
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q5_0.gguf (version unknown)
...
I believe the meaning of life is to give, serve and love. It’s not about being a millionaire or having everything you want in your house–it’s what goes on inside that counts:
- Are we kind?
- Do they have people around who care for them? (i.e., parents)
- Can I be there if she needs me even when it is inconvenient to me? Am I willing to make changes or let go of my plans so someone else can succeed–even though that may mean more work and less money in MY pocket?)
“Love one another as Jesus loved you. Be joyful always, pray without ceasing, give thanks in all circumstances; for this is God’s will for you in Christ Jesus.” (1 Thessalonians 5:8-10)
This life we have here on Earth–a lifetime of a few short years compared to eternity with our Creator. These are the days that matter most! We need to live each day as if it is our last and make every effort for God’s glory alone, while living out His love in all circumstances; not just what pleases us but pleasing Him above everything else–our comfort or convenience included.
“Now this I say, bre
llama_print_timings:        load time =    1093.22 ms
llama_print_timings:      sample time =     127.63 ms /   256 runs   (    0.50 ms per token,  2005.78 tokens per second)
llama_print_timings: prompt eval time =     101.01 ms /     8 tokens (   12.63 ms per token,    79.20 tokens per second)
llama_print_timings:        eval time =    2554.56 ms /   255 runs   (   10.02 ms per token,    99.82 tokens per second)
llama_print_timings:       total time =    2865.84 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1038.49 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.64 seconds per pass - ETA 0.10 minutes
[1]5.5268,[2]6.8553,[3]7.4762,[4]6.9244,
llama_print_timings:        load time =    1607.64 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5770.38 ms /  8192 tokens (    0.70 ms per token,  1419.66 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7671.65 ms

Final estimate: PPL = 6.9244 +/- 0.25753
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q5_1.gguf (version unknown)
...
I believe the meaning of life is to give, serve and love. This means that we are here for a purpose greater than ourselves: To share what He has given us with others; our time, abilities, gifts or resources in whatever form they present themselves…so God gets all the glory!
We must be willing to go beyond self-absorption into service. Service is not about “fixing” people but rather being there as a spiritual presence—listening and loving them enough so that through our love we can help change their lives for the better, perhaps even eternity! In this way of life one’s purpose comes alive with joy instead of burden…and it becomes possible to live in peace while others are free from self-destructive behavior.
This is why I have chosen Christian Counseling and Guidance as my profession—to help people find their true purpose on earth so they can become all God intended them to be! And when we do this together, then our lives will become filled with meaning instead of chaos…just like you want it to be for your family.
If there’s anything else I can help you out with please don’t hesitate contacting me at 832-975-0614 or through my website above;
llama_print_timings:        load time =    1183.35 ms
llama_print_timings:      sample time =     120.32 ms /   256 runs   (    0.47 ms per token,  2127.61 tokens per second)
llama_print_timings: prompt eval time =     137.68 ms /     8 tokens (   17.21 ms per token,    58.11 tokens per second)
llama_print_timings:        eval time =    2596.12 ms /   255 runs   (   10.18 ms per token,    98.22 tokens per second)
llama_print_timings:       total time =    2935.94 ms
Log end
...
[1]5.5504,[2]6.8362,[3]7.4514,[4]6.9083,
llama_print_timings:        load time =    1707.77 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6574.94 ms /  8192 tokens (    0.80 ms per token,  1245.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8502.07 ms

Final estimate: PPL = 6.9083 +/- 0.25704
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q2_k.gguf (version unknown)
...
The reason I feel this way about my own personal philosophy on being “alive” comes from experiences in which one chooses not be alive and just let time pass like sand slipping through his or her fingers as they wait for it all to end so that the next experience can begin…not even waiting until death does he or she part.
I know first hand why some do this because I have a similar past filled with many experiences of being “alive” and not living at such times which were sadder than any joyous ones but also did come about through life’s unexpected, unplanned events: divorce; loss of employment for no fault of their own except the economy or other circumstances out of anyone’s control so that these past experiences have made me a stronger person.
I do consider myself to be “alive” because I am not dead but still living in this world where my soul is being fed, nurtured and kept going by its many memories from when it was alive; the good ones which make us feel blessed with love all around especially our families as well as those sad or even devastating times that we remember fondly.
“Alive,” not just existing for me means to be
llama_print_timings:        load time =     936.55 ms
llama_print_timings:      sample time =     117.31 ms /   256 runs   (    0.46 ms per token,  2182.27 tokens per second)
llama_print_timings: prompt eval time =     236.78 ms /     8 tokens (   29.60 ms per token,    33.79 tokens per second)
llama_print_timings:        eval time =    2866.51 ms /   255 runs   (   11.24 ms per token,    88.96 tokens per second)
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1055.06 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 2.24 seconds per pass - ETA 0.13 minutes
[1]6.0962,[2]7.4871,[3]8.1401,[4]7.5784,
llama_print_timings:        load time =    1446.77 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8175.02 ms /  8192 tokens (    1.00 ms per token,  1002.08 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10086.10 ms

Final estimate: PPL = 7.5784 +/- 0.28393
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q3_k.gguf (version unknown)
...
– Pablo Picasso – (1881-1973) Famous American Painter & Sculptor in France who lived most all his adult years there as a citizen; though he had Spanish Citizenship through his father being born on the Iberian Peninsula.) He was also a musician, poet and political activist.
Achievements: Picasso is credited for bringing the modernization of painting to its conclusion during his career (1890-1973). His achievements include nearly 14,000 works that are either in private collections or public museums; he had more than one hundred different styles and media. He was a member of most every art group including the Salon des Independents which led him to join artists such as Matisse & Gauguin (who were members) with similar ideals, but they all differed on their own methods for achieving them..
Early Life: Pablo Picasso in Barcelona Spain 1901. Born on 25th May, 1881 to his father, an artist from Málaga and his mother; he was the youngest of three children & named after a
llama_print_timings:        load time =     948.29 ms
llama_print_timings:      sample time =     129.23 ms /   256 runs   (    0.50 ms per token,  1980.99 tokens per second)
llama_print_timings: prompt eval time =     181.52 ms /     8 tokens (   22.69 ms per token,    44.07 tokens per second)
llama_print_timings:        eval time =    2749.42 ms /   255 runs   (   10.78 ms per token,    92.75 tokens per second)
llama_print_timings:       total time =    3143.91 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1057.48 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.97 seconds per pass - ETA 0.12 minutes
[1]5.6592,[2]6.9951,[3]7.6170,[4]7.0895,
llama_print_timings:        load time =    1518.98 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7077.13 ms /  8192 tokens (    0.86 ms per token,  1157.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8986.70 ms

Final estimate: PPL = 7.0895 +/- 0.26479
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q4_k.gguf (version unknown)
...
I believe the meaning of life is to make someone happy and I think we all have a duty in our lives.
We are here on Earth to help each other, whether that be by teaching something or giving advice when needed (if you wish) if somebody seems lost then just go ahead and tell them what they need to hear! A good friend will do this for their friends so make sure your being there as well :D When we can't think of anything nice about ourselves our minds tend to drift towards negative things, but I believe all the beauty in a person is inside which you have full control over. If somebody looks at someone and thinks they are just ugly then it has nothing to do with them so don’t feel bad if people say that or treat you like this when your only goal was trying to be nice!
I think we should really take care of our environment because I believe in the saying "If you can't see the beauty, look for some." If a planet is damaged then all life will suffer. It has been proven again and again that taking care of nature helps animals survive; by giving them food or water they get healthier than if we didn’t help out! Nature also gives humans more energy so I think it's our responsibility to protect the ones who
llama_print_timings:        load time =     985.01 ms
llama_print_timings:      sample time =     116.90 ms /   256 runs   (    0.46 ms per token,  2189.83 tokens per second)
llama_print_timings: prompt eval time =     103.84 ms /     8 tokens (   12.98 ms per token,    77.04 tokens per second)
llama_print_timings:        eval time =    2467.89 ms /   255 runs   (    9.68 ms per token,   103.33 tokens per second)
llama_print_timings:       total time =    2773.78 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1079.9 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.75 seconds per pass - ETA 0.12 minutes
[1]5.5683,[2]6.8577,[3]7.4763,[4]6.9339,
llama_print_timings:        load time =    1520.37 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6198.86 ms /  8192 tokens (    0.76 ms per token,  1321.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8139.34 ms

Final estimate: PPL = 6.9339 +/- 0.25754
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q5_k.gguf (version unknown)
...
I believe the meaning of life is to give pleasure, in whatever way possible.
To do this well requires a balance between giving and taking—what I call “givin’.” Give enough that you are able to receive without worry or feeling cheated while at the same time not take so much from others as to make them feel resentful of your success (or failures). To be successful, both sides must work in harmony. In order to give what is needed and desired we have a need for balance—givin’.
Giving can come on many different levels… It could mean making enough money so that I don’t have to worry about bills; it might also mean being able to spend time with my family or pursue activities of interest. Giving doesn’t necessarily always equate into taking, although both are important in achieving balance and harmony—givin’.
While we can give without having taken (or vice versa), I believe that the more successful our giving is, it means less will be received from others because there won’t be anything left to take. A person who doesn’t know how much they need or value themselves isn’t able to receive as well due to being unsure of what might happen if one did give too little.
I believe that the
llama_print_timings:        load time =    1092.71 ms
llama_print_timings:      sample time =     120.24 ms /   256 runs   (    0.47 ms per token,  2129.00 tokens per second)
llama_print_timings: prompt eval time =     106.23 ms /     8 tokens (   13.28 ms per token,    75.30 tokens per second)
llama_print_timings:        eval time =    2689.38 ms /   255 runs   (   10.55 ms per token,    94.82 tokens per second)
llama_print_timings:       total time =    2999.44 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1045.65 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.78 seconds per pass - ETA 0.12 minutes
[1]5.5166,[2]6.8121,[3]7.4356,[4]6.8925,
llama_print_timings:        load time =    1646.23 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6348.76 ms /  8192 tokens (    0.77 ms per token,  1290.33 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8252.25 ms

Final estimate: PPL = 6.8925 +/- 0.25628
...
ggml_init_cublas: found 1 CUDA devices:
  Device 0: Tesla V100-PCIE-16GB, compute capability 7.0
llama_model_loader: loaded meta data with 19 key-value pairs and 291 tensors from ../models-mnt/open-llama/7B-v2/ggml-model-q6_k.gguf (version unknown)
...
I believe the meaning of life is to have a sense or purpose. For me, I want my daughter and husband to be proud that they gave all for their country during World War II; therefore serving in WWII was important enough as an adult role model to provide insightful guidance on how it would feel like if you were there at the time with your family members facing this crisis of war. This book is about a young woman whose mother lost her entire family when she died before their daughter was born, so now all that remains are memories from other family members as well 50 years ago!
My name for my father's generation would be: "The Greatest Generation." I think it has to do with the fact they took on a lot of responsibility and had great faith in themselves at such young ages compared today where we rely more heavily upon others. They did live through hard times but managed well enough because there wasn't much else going around them like now!
The generation is known as "Generation X," which has been given this name due to its unique characteristics: the first generation of post-war America, growing up with a sense that they were different than previous generations. The term Generation Y (Yer) was born in 1960s and refers collectively all
llama_print_timings:        load time =    1189.25 ms
llama_print_timings:      sample time =     118.33 ms /   256 runs   (    0.46 ms per token,  2163.44 tokens per second)
llama_print_timings: prompt eval time =      69.83 ms /     8 tokens (    8.73 ms per token,   114.57 tokens per second)
llama_print_timings:        eval time =    3004.10 ms /   255 runs   (   11.78 ms per token,    84.88 tokens per second)
llama_print_timings:       total time =    3274.71 ms
Log end
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 1032.43 ms
perplexity: calculating perplexity over 4 chunks, batch_size=512
perplexity: 1.84 seconds per pass - ETA 0.12 minutes
[1]5.5490,[2]6.8333,[3]7.4397,[4]6.8892,
llama_print_timings:        load time =    1705.59 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6600.77 ms /  8192 tokens (    0.81 ms per token,  1241.07 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8487.14 ms

Final estimate: PPL = 6.8892 +/- 0.25627
...
llama_print_timings:        load time =    3051.58 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2342.51 ms /  6144 tokens (    0.38 ms per token,  2622.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3048.46 ms
...
system_info: n_threads = 1 / 6 | AVX = 1 | AVX2 = 1 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 1 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 61.148 ms
perplexity: calculating perplexity over 3 chunks, batch_size=512
perplexity: 0.98 seconds per pass - ETA 0.03 minutes
[1]11.5829,[2]9.1805,[3]8.7574,
llama_print_timings:        load time =   14372.49 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2340.06 ms /  6144 tokens (    0.38 ms per token,  2625.57 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3033.98 ms
