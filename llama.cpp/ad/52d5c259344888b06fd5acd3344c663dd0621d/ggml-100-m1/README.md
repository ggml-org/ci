...
- status:  SUCCESS ✅
- runtime: 343.04
- date:    Thu May 16 08:46:41 EEST 2024
...
Label Time Summary:
main    = 184.82 sec*proc (22 tests)

Total Test time (real) = 184.83 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.01 ms /     9 tokens (    1.22 ms per token,   817.51 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
