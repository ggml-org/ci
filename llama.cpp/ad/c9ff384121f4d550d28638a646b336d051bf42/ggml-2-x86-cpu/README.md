...
- status:  SUCCESS ✅
- runtime: 14:55.33
- date:    Tue Jun  4 12:47:47 UTC 2024
...
12/22 Test #12: test-quantize-fns ................   Passed   31.54 sec
...
llama_print_timings: prompt eval time =       3.85 ms /     9 tokens (    0.43 ms per token,  2337.06 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.36 ms /     9 tokens (    0.37 ms per token,  2675.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 If x is a random variable following a binomial distribution with parameters n = 5 and p = 0.4, find the probability that x is equal to 
llama_print_timings:        load time =    1243.19 ms
llama_print_timings:      sample time =      48.07 ms /    32 runs   (    1.50 ms per token,   665.67 tokens per second)
llama_print_timings: prompt eval time =    1132.93 ms /     2 tokens (  566.47 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20929.56 ms /    31 runs   (  675.15 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22242.00 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Sockets are virtual communication endpoints that allow multiple processes to communicate with each other. They provide a mechanism for asynchronous communication
llama_print_timings:        load time =    1227.18 ms
llama_print_timings:      sample time =      47.51 ms /    32 runs   (    1.48 ms per token,   673.51 tokens per second)
llama_print_timings: prompt eval time =    1133.77 ms /     2 tokens (  566.88 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   21117.26 ms /    31 runs   (  681.20 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22428.39 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
## Soaring High: A Guide to Reaching Your Goals

**Chapter 1: Understanding Your Ascent**

* Identifying your current limitations and strengths
llama_print_timings:        load time =    1216.87 ms
llama_print_timings:      sample time =      47.73 ms /    32 runs   (    1.49 ms per token,   670.42 tokens per second)
llama_print_timings: prompt eval time =    1132.18 ms /     2 tokens (  566.09 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20749.65 ms /    31 runs   (  669.34 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22058.88 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
## **Soar: A Journey of Learning and Growth**

**Soar** is a journey of learning, discovery, and personal development.
llama_print_timings:        load time =    1213.88 ms
llama_print_timings:      sample time =      47.57 ms /    32 runs   (    1.49 ms per token,   672.65 tokens per second)
llama_print_timings: prompt eval time =    1174.24 ms /     2 tokens (  587.12 ms per token,     1.70 tokens per second)
llama_print_timings:        eval time =   20931.05 ms /    31 runs   (  675.20 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22282.88 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197831.66 ms
main:    total time = 197831.66 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shekheria, an Indian politician, has been accused of corruption and financial irregularities in connection with his business ventures.

**Questions:**

1. What are
llama_print_timings:        load time =     642.30 ms
llama_print_timings:      sample time =      47.73 ms /    32 runs   (    1.49 ms per token,   670.40 tokens per second)
llama_print_timings: prompt eval time =     570.98 ms /     2 tokens (  285.49 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =   10566.41 ms /    31 runs   (  340.85 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11314.30 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197562.25 ms
main:    total time = 197562.25 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Heider's influence on television

**Heider's Influence on Television:**

Heider's vision and methods had a profound impact on television, influencing
llama_print_timings:        load time =     630.21 ms
llama_print_timings:      sample time =      47.70 ms /    32 runs   (    1.49 ms per token,   670.92 tokens per second)
llama_print_timings: prompt eval time =     573.55 ms /     2 tokens (  286.77 ms per token,     3.49 tokens per second)
llama_print_timings:        eval time =   10619.41 ms /    31 runs   (  342.56 ms per token,     2.92 tokens per second)
llama_print_timings:       total time =   11371.69 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Geralt of Rivia is a monster hunter, specializing in eliminating dangerous creatures and protecting the innocent. Born and raised on the harsh and unforgiving continent
llama_print_timings:        load time =     185.26 ms
llama_print_timings:      sample time =       5.13 ms /    32 runs   (    0.16 ms per token,  6240.25 tokens per second)
llama_print_timings: prompt eval time =      77.23 ms /     2 tokens (   38.62 ms per token,    25.90 tokens per second)
llama_print_timings:        eval time =    2127.93 ms /    31 runs   (   68.64 ms per token,    14.57 tokens per second)
llama_print_timings:       total time =    2267.86 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there lived a young woman named Anya who was known for her bright mind and quick wit.

One fateful day, Anya found herself in a room filled with
llama_print_timings:        load time =     168.93 ms
llama_print_timings:      sample time =       5.03 ms /    32 runs   (    0.16 ms per token,  6364.36 tokens per second)
llama_print_timings: prompt eval time =     130.97 ms /     5 tokens (   26.19 ms per token,    38.18 tokens per second)
llama_print_timings:        eval time =    2033.85 ms /    31 runs   (   65.61 ms per token,    15.24 tokens per second)
llama_print_timings:       total time =    2227.86 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 After successfully logging in, I am unable to access my account details, such as username and password.

**Possible Causes:**

- Weak or compromised password
-
llama_print_timings:        load time =     166.06 ms
llama_print_timings:      sample time =       5.06 ms /    32 runs   (    0.16 ms per token,  6322.86 tokens per second)
llama_print_timings: prompt eval time =      78.59 ms /     2 tokens (   39.30 ms per token,    25.45 tokens per second)
llama_print_timings:        eval time =    2094.04 ms /    31 runs   (   67.55 ms per token,    14.80 tokens per second)
llama_print_timings:       total time =    2234.93 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 He, a social media influencer with a large following, shared a series of cryptic posts that sent fans and followers scratching their heads.

**Post 1:**


llama_print_timings:        load time =     159.18 ms
llama_print_timings:      sample time =       5.18 ms /    32 runs   (    0.16 ms per token,  6182.38 tokens per second)
llama_print_timings: prompt eval time =      77.58 ms /     2 tokens (   38.79 ms per token,    25.78 tokens per second)
llama_print_timings:        eval time =    2138.39 ms /    31 runs   (   68.98 ms per token,    14.50 tokens per second)
llama_print_timings:       total time =    2281.92 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32039.39 ms
main:    total time = 32039.39 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 If 2/3 of a number is equal to 12, what is the number?

Let's denote the number as 'x'.

According
llama_print_timings:        load time =     135.87 ms
llama_print_timings:      sample time =       4.86 ms /    32 runs   (    0.15 ms per token,  6583.01 tokens per second)
llama_print_timings: prompt eval time =      67.35 ms /     2 tokens (   33.67 ms per token,    29.70 tokens per second)
llama_print_timings:        eval time =    1622.23 ms /    31 runs   (   52.33 ms per token,    19.11 tokens per second)
llama_print_timings:       total time =    1751.52 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32176.94 ms
main:    total time = 32176.94 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shekher, an Indian-American entrepreneur, has been making waves in the tech industry. Shekher is the co-founder and CEO of Zoho,
llama_print_timings:        load time =     125.83 ms
llama_print_timings:      sample time =       4.85 ms /    32 runs   (    0.15 ms per token,  6597.94 tokens per second)
llama_print_timings: prompt eval time =      67.43 ms /     2 tokens (   33.72 ms per token,    29.66 tokens per second)
llama_print_timings:        eval time =    1594.66 ms /    31 runs   (   51.44 ms per token,    19.44 tokens per second)
llama_print_timings:       total time =    1724.05 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     200.88 ms
llama_print_timings:      sample time =       2.64 ms /    64 runs   (    0.04 ms per token, 24242.42 tokens per second)
llama_print_timings: prompt eval time =     128.54 ms /     8 tokens (   16.07 ms per token,    62.24 tokens per second)
llama_print_timings:        eval time =    3433.48 ms /    63 runs   (   54.50 ms per token,    18.35 tokens per second)
llama_print_timings:       total time =    3594.79 ms /    71 tokens
Log end
...
[1]9.4753,
llama_print_timings:        load time =     179.41 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1911.28 ms /   128 tokens (   14.93 ms per token,    66.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1927.99 ms /   129 tokens
...
llama_print_timings:        load time =     168.60 ms
llama_print_timings:      sample time =       2.25 ms /    64 runs   (    0.04 ms per token, 28393.97 tokens per second)
llama_print_timings: prompt eval time =      87.27 ms /     8 tokens (   10.91 ms per token,    91.67 tokens per second)
llama_print_timings:        eval time =    2602.41 ms /    63 runs   (   41.31 ms per token,    24.21 tokens per second)
llama_print_timings:       total time =    2717.92 ms /    71 tokens
Log end
...
[1]9.5664,
llama_print_timings:        load time =     148.49 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1118.49 ms /   128 tokens (    8.74 ms per token,   114.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1134.93 ms /   129 tokens
...
llama_print_timings:        load time =     117.52 ms
llama_print_timings:      sample time =       2.38 ms /    64 runs   (    0.04 ms per token, 26924.69 tokens per second)
llama_print_timings: prompt eval time =      82.03 ms /     8 tokens (   10.25 ms per token,    97.52 tokens per second)
llama_print_timings:        eval time =    2030.43 ms /    63 runs   (   32.23 ms per token,    31.03 tokens per second)
llama_print_timings:       total time =    2141.16 ms /    71 tokens
Log end
...
[1]10.2324,
llama_print_timings:        load time =      96.97 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1216.94 ms /   128 tokens (    9.51 ms per token,   105.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1233.37 ms /   129 tokens
...
I
llama_print_timings:        load time =     141.82 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28021.02 tokens per second)
llama_print_timings: prompt eval time =     149.85 ms /     8 tokens (   18.73 ms per token,    53.39 tokens per second)
llama_print_timings:        eval time =    2059.20 ms /    63 runs   (   32.69 ms per token,    30.59 tokens per second)
llama_print_timings:       total time =    2236.03 ms /    71 tokens
Log end
...
[1]9.8464,
llama_print_timings:        load time =     124.15 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2253.24 ms /   128 tokens (   17.60 ms per token,    56.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2269.39 ms /   129 tokens
...
llama_print_timings:        load time =     137.36 ms
llama_print_timings:      sample time =       2.37 ms /    64 runs   (    0.04 ms per token, 26981.45 tokens per second)
llama_print_timings: prompt eval time =     156.95 ms /     8 tokens (   19.62 ms per token,    50.97 tokens per second)
llama_print_timings:        eval time =    2236.74 ms /    63 runs   (   35.50 ms per token,    28.17 tokens per second)
llama_print_timings:       total time =    2420.70 ms /    71 tokens
Log end
...
[1]9.4336,
llama_print_timings:        load time =     116.86 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2368.26 ms /   128 tokens (   18.50 ms per token,    54.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2384.60 ms /   129 tokens
...
llama_print_timings: prompt eval time =     170.32 ms /     8 tokens (   21.29 ms per token,    46.97 tokens per second)
llama_print_timings:        eval time =    2347.76 ms /    63 runs   (   37.27 ms per token,    26.83 tokens per second)
llama_print_timings:       total time =    2545.68 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2517.05 ms /   128 tokens (   19.66 ms per token,    50.85 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2532.96 ms /   129 tokens
...
llama_print_timings:        load time =     101.28 ms
llama_print_timings:      sample time =       2.14 ms /    64 runs   (    0.03 ms per token, 29920.52 tokens per second)
llama_print_timings: prompt eval time =     106.75 ms /     8 tokens (   13.34 ms per token,    74.94 tokens per second)
llama_print_timings:        eval time =    1615.41 ms /    63 runs   (   25.64 ms per token,    39.00 tokens per second)
llama_print_timings:       total time =    1748.63 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1598.39 ms /   128 tokens (   12.49 ms per token,    80.08 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1614.62 ms /   129 tokens
...
llama_print_timings:        load time =     113.21 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28070.18 tokens per second)
llama_print_timings: prompt eval time =     115.78 ms /     8 tokens (   14.47 ms per token,    69.10 tokens per second)
llama_print_timings:        eval time =    1788.54 ms /    63 runs   (   28.39 ms per token,    35.22 tokens per second)
llama_print_timings:       total time =    1931.44 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1690.96 ms /   128 tokens (   13.21 ms per token,    75.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1707.42 ms /   129 tokens
...
llama_print_timings:        load time =     120.64 ms
llama_print_timings:      sample time =       2.23 ms /    64 runs   (    0.03 ms per token, 28673.84 tokens per second)
llama_print_timings: prompt eval time =     121.64 ms /     8 tokens (   15.21 ms per token,    65.77 tokens per second)
llama_print_timings:        eval time =    1949.86 ms /    63 runs   (   30.95 ms per token,    32.31 tokens per second)
llama_print_timings:       total time =    2098.96 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1752.84 ms /   128 tokens (   13.69 ms per token,    73.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1769.53 ms /   129 tokens
...
llama_print_timings: prompt eval time =     143.44 ms /     8 tokens (   17.93 ms per token,    55.77 tokens per second)
llama_print_timings:        eval time =    2189.27 ms /    63 runs   (   34.75 ms per token,    28.78 tokens per second)
llama_print_timings:       total time =    2359.92 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2070.34 ms /   128 tokens (   16.17 ms per token,    61.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2086.03 ms /   129 tokens
...
llama_print_timings:        load time =     141.41 ms
llama_print_timings:      sample time =       2.31 ms /    64 runs   (    0.04 ms per token, 27705.63 tokens per second)
llama_print_timings: prompt eval time =     132.56 ms /     8 tokens (   16.57 ms per token,    60.35 tokens per second)
llama_print_timings:        eval time =    2295.39 ms /    63 runs   (   36.43 ms per token,    27.45 tokens per second)
llama_print_timings:       total time =    2456.38 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1884.37 ms /   128 tokens (   14.72 ms per token,    67.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1900.18 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog Getting the equivalent lacking upper lip on calculations was on a


second run: The quick brown fox jumps over the lazy dog Getting the equivalent lacking upper lip on calculations was on a


single seq run: The quick brown fox jumps over the lazy dog Getting the equivalent lacking upper lip on calculations was on a
...
first run: The quick brown fox jumps over the lazy Yeats in you’ll find to be in an unconscious


second run: The quick brown fox jumps over the lazy Yeats in you’ll find to be in an unconscious


single seq run: The quick brown fox jumps over the lazy Yeats in you’ll find to be in an unconscious
...
1.23user 0.22system 0:01.46elapsed 100%CPU (0avgtext+0avgdata 2897788maxresident)k
0inputs+40outputs (0major+60528minor)pagefaults 0swaps
```
...
0.23user 0.23system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 2897180maxresident)k
