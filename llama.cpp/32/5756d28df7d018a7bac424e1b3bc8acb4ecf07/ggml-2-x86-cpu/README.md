...
- status:  SUCCESS ✅
- runtime: 19:33.37
- date:    Sat May 11 19:19:45 UTC 2024
...
llama_print_timings: prompt eval time =       4.19 ms /     9 tokens (    0.47 ms per token,  2150.54 tokens per second)
...
<bos> Heirs.
Heirs is a series of novels that follows the lives of five young heirs to powerful families across Europe. The novels explore themes of family, loyalty
...
llama_print_timings: prompt eval time =    1140.65 ms /     2 tokens (  570.32 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   20894.68 ms /    31 runs   (  674.02 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22217.24 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Sheldrake's work on subtle energy and energetic signatures has shown that our emotional state can affect our energy field and that we can leverage this knowledge to heal ourselves
...
llama_print_timings:        eval time =   21254.16 ms /    31 runs   (  685.62 ms per token,     1.46 tokens per second)
llama_print_timings:       total time =   22578.24 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After years of speculation and debate, the Supreme Court of the United States has finally issued its decision in the landmark case of Dobbs v. Jackson.
...
llama_print_timings:        eval time =   20978.44 ms /    31 runs   (  676.72 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22304.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heirs, a Nigerian music group, has been making waves with their unique sound and captivating performances.

**Here are some key points about their achievements:**

**
llama_print_timings:        load time =    1239.68 ms
llama_print_timings:      sample time =      47.72 ms /    32 runs   (    1.49 ms per token,   670.62 tokens per second)
llama_print_timings: prompt eval time =    1150.04 ms /     2 tokens (  575.02 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21081.52 ms /    31 runs   (  680.05 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22414.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198113.50 ms
main:    total time = 198113.50 ms
+ echo PASS
PASS
+ echo
...
<bos> After successfully defending their title against reigning champions, Team Alpha finds themselves in a position to challenge for the championship once again.

However, Team Alpha's roster has
llama_print_timings:        load time =     645.48 ms
llama_print_timings:      sample time =      47.74 ms /    32 runs   (    1.49 ms per token,   670.30 tokens per second)
llama_print_timings: prompt eval time =     579.24 ms /     2 tokens (  289.62 ms per token,     3.45 tokens per second)
llama_print_timings:        eval time =   10760.85 ms /    31 runs   (  347.12 ms per token,     2.88 tokens per second)
llama_print_timings:       total time =   11522.22 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196115.60 ms
main:    total time = 196115.60 ms
+ echo PASS
PASS
+ echo
...
<bos> After a long day, you are feeling exhausted and in need of relaxation. What kind of activities would be most beneficial for your physical and mental health?

**A
llama_print_timings:        load time =     638.22 ms
llama_print_timings:      sample time =      47.50 ms /    32 runs   (    1.48 ms per token,   673.64 tokens per second)
llama_print_timings: prompt eval time =     581.52 ms /     2 tokens (  290.76 ms per token,     3.44 tokens per second)
llama_print_timings:        eval time =   10726.04 ms /    31 runs   (  346.00 ms per token,     2.89 tokens per second)
llama_print_timings:       total time =   11491.99 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a young woman named Anya who had a passion for music.

**Anya's Journey**

Anya's journey began with a
...
llama_print_timings: prompt eval time =     133.71 ms /     5 tokens (   26.74 ms per token,    37.39 tokens per second)
llama_print_timings:        eval time =    2096.79 ms /    31 runs   (   67.64 ms per token,    14.78 tokens per second)
llama_print_timings:       total time =    2299.68 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If f(x) = 2x^2 + 3x - 1, find the following:

a) f(-2)
b)
llama_print_timings:        load time =     160.71 ms
llama_print_timings:      sample time =       7.13 ms /    32 runs   (    0.22 ms per token,  4484.93 tokens per second)
llama_print_timings: prompt eval time =      79.43 ms /     2 tokens (   39.71 ms per token,    25.18 tokens per second)
llama_print_timings:        eval time =    2073.08 ms /    31 runs   (   66.87 ms per token,    14.95 tokens per second)
llama_print_timings:       total time =    2220.57 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When, Where, and How of Financial Inclusion

**1. Importance of Financial Inclusion:**

- Promotes economic growth and development by increasing access to financial services.

llama_print_timings:        load time =     167.72 ms
llama_print_timings:      sample time =       7.58 ms /    32 runs   (    0.24 ms per token,  4221.08 tokens per second)
llama_print_timings: prompt eval time =      83.48 ms /     2 tokens (   41.74 ms per token,    23.96 tokens per second)
llama_print_timings:        eval time =    2080.56 ms /    31 runs   (   67.11 ms per token,    14.90 tokens per second)
llama_print_timings:       total time =    2233.49 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Heirs graduate with honors, signifying their academic and personal excellence.

The graduating class of Heirs, a distinguished group of young adults
...
llama_print_timings: prompt eval time =      79.41 ms /     2 tokens (   39.70 ms per token,    25.19 tokens per second)
llama_print_timings:        eval time =    2181.69 ms /    31 runs   (   70.38 ms per token,    14.21 tokens per second)
llama_print_timings:       total time =    2332.66 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32060.77 ms
main:    total time = 32060.77 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:        eval time =    1583.06 ms /    31 runs   (   51.07 ms per token,    19.58 tokens per second)
llama_print_timings:       total time =    1739.48 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31955.47 ms
main:    total time = 31955.47 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       6.82 ms /    32 runs   (    0.21 ms per token,  4695.52 tokens per second)
llama_print_timings: prompt eval time =      66.55 ms /     2 tokens (   33.28 ms per token,    30.05 tokens per second)
llama_print_timings:        eval time =    1643.97 ms /    31 runs   (   53.03 ms per token,    18.86 tokens per second)
llama_print_timings:       total time =    1777.60 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =     344.82 ms /     8 tokens (   43.10 ms per token,    23.20 tokens per second)
llama_print_timings:        eval time =    8099.23 ms /    63 runs   (  128.56 ms per token,     7.78 tokens per second)
llama_print_timings:       total time =    8469.06 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5100.62 ms /   128 tokens (   39.85 ms per token,    25.09 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5117.70 ms /   129 tokens
...
llama_print_timings:        load time =     360.07 ms
...
llama_print_timings:        eval time =    5715.92 ms /    63 runs   (   90.73 ms per token,    11.02 tokens per second)
llama_print_timings:       total time =    5962.67 ms /    71 tokens
Log end
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3032.32 ms /   129 tokens
...
llama_print_timings:        eval time =    4711.29 ms /    63 runs   (   74.78 ms per token,    13.37 tokens per second)
llama_print_timings:       total time =    4959.06 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3298.99 ms /   128 tokens (   25.77 ms per token,    38.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3315.53 ms /   129 tokens
...
llama_print_timings: prompt eval time =     395.19 ms /     8 tokens (   49.40 ms per token,    20.24 tokens per second)
llama_print_timings:        eval time =    4932.53 ms /    63 runs   (   78.29 ms per token,    12.77 tokens per second)
llama_print_timings:       total time =    5348.25 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6083.18 ms /   128 tokens (   47.52 ms per token,    21.04 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6100.09 ms /   129 tokens
...
llama_print_timings:        eval time =    5459.78 ms /    63 runs   (   86.66 ms per token,    11.54 tokens per second)
llama_print_timings:       total time =    5921.99 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6529.64 ms /   128 tokens (   51.01 ms per token,    19.60 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6546.91 ms /   129 tokens
...
llama_print_timings:        eval time =    5759.83 ms /    63 runs   (   91.43 ms per token,    10.94 tokens per second)
llama_print_timings:       total time =    6225.42 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6770.36 ms /   128 tokens (   52.89 ms per token,    18.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6787.69 ms /   129 tokens
...
llama_print_timings: prompt eval time =     635.92 ms /     8 tokens (   79.49 ms per token,    12.58 tokens per second)
llama_print_timings:        eval time =    6196.75 ms /    63 runs   (   98.36 ms per token,    10.17 tokens per second)
llama_print_timings:       total time =    6853.36 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10080.84 ms /   128 tokens (   78.76 ms per token,    12.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10097.96 ms /   129 tokens
...
llama_print_timings: prompt eval time =     486.91 ms /     8 tokens (   60.86 ms per token,    16.43 tokens per second)
llama_print_timings:        eval time =    5427.31 ms /    63 runs   (   86.15 ms per token,    11.61 tokens per second)
llama_print_timings:       total time =    5934.24 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7609.84 ms /   128 tokens (   59.45 ms per token,    16.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7626.36 ms /   129 tokens
...
llama_print_timings:        eval time =    5106.20 ms /    63 runs   (   81.05 ms per token,    12.34 tokens per second)
llama_print_timings:       total time =    5540.47 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6333.52 ms /   128 tokens (   49.48 ms per token,    20.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6350.33 ms /   129 tokens
...
llama_print_timings: prompt eval time =     496.58 ms /     8 tokens (   62.07 ms per token,    16.11 tokens per second)
llama_print_timings:        eval time =    6030.36 ms /    63 runs   (   95.72 ms per token,    10.45 tokens per second)
llama_print_timings:       total time =    6547.81 ms /    71 tokens
Log end
...
[1]4.2338,
llama_print_timings:        load time =     292.08 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7492.59 ms /   128 tokens (   58.54 ms per token,    17.08 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings:        eval time =    6484.31 ms /    63 runs   (  102.93 ms per token,     9.72 tokens per second)
llama_print_timings:       total time =    7045.64 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     302.16 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8345.82 ms /   128 tokens (   65.20 ms per token,    15.34 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8362.44 ms /   129 tokens
...
first run: The quick brown fox... seriously?
The".
About this entry
You’re currently reading


second run: The quick brown fox... seriously?
The".
About this entry
You’re currently reading


single seq run: The quick brown fox... seriously?
The".
About this entry
You’re currently reading
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.54 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.10 seconds per pass - ETA 0.08 minutes
[1]9.1034,
llama_print_timings:        load time =     484.94 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5096.73 ms /   128 tokens (   39.82 ms per token,    25.11 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5153.37 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.337 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.10 seconds per pass - ETA 0.08 minutes
[1]7.0156,
llama_print_timings:        load time =    4264.42 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5088.54 ms /   128 tokens (   39.75 ms per token,    25.15 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5142.97 ms /   129 tokens
...
[1]9.1825,
llama_print_timings:        load time =     323.99 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3026.81 ms /   128 tokens (   23.65 ms per token,    42.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3081.54 ms /   129 tokens
...
perplexity: 3.02 seconds per pass - ETA 0.05 minutes
[1]7.0336,
llama_print_timings:        load time =    3557.54 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3013.95 ms /   128 tokens (   23.55 ms per token,    42.47 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3067.03 ms /   129 tokens
...
0.34user 0.58system 0:00.92elapsed 99%CPU (0avgtext+0avgdata 6880660maxresident)k
...
0.15user 0.54system 0:00.69elapsed 99%CPU (0avgtext+0avgdata 6880040maxresident)k
