...
- status:  SUCCESS ✅
- runtime: 4:27.90
- date:    Thu Oct 17 23:46:38 UTC 2024
...
0.00.000.608 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.004.235 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
...
0.00.021.915 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.916 I llm_load_print_meta: freq_scale_train = 1
0.00.021.916 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.916 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.916 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.917 I llm_load_print_meta: ssm_d_inner      = 0
...
0.00.021.936 I llm_load_tensors: ggml ctx size =    0.08 MiB
0.00.024.674 I llm_load_tensors:        CPU buffer size =    63.84 MiB
...............................................
...
0.00.027.259 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.027.266 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.029.013 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.029.036 I llama_new_context_with_model: graph nodes  = 429
0.00.029.036 I llama_new_context_with_model: graph splits = 1
0.00.029.038 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.032.332 I 
0.00.032.411 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.034.136 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.037.587 I llama_perf_context_print:        load time =      30.84 ms
0.00.037.589 I llama_perf_context_print: prompt eval time =       3.21 ms /     9 tokens (    0.36 ms per token,  2801.99 tokens per second)
0.00.037.590 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.037.591 I llama_perf_context_print:       total time =       5.26 ms /    10 tokens
...
0.00.000.401 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.018.407 I llm_load_vocab: special tokens cache size = 5
0.00.020.842 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.871 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.873 I llm_load_print_meta: arch             = bert
0.00.020.874 I llm_load_print_meta: vocab type       = WPM
0.00.020.874 I llm_load_print_meta: n_vocab          = 30522
0.00.020.875 I llm_load_print_meta: n_merges         = 0
0.00.020.875 I llm_load_print_meta: vocab_only       = 0
0.00.020.875 I llm_load_print_meta: n_ctx_train      = 512
0.00.020.875 I llm_load_print_meta: n_embd           = 384
0.00.020.875 I llm_load_print_meta: n_layer          = 12
0.00.020.882 I llm_load_print_meta: n_head           = 12
0.00.020.883 I llm_load_print_meta: n_head_kv        = 12
0.00.020.883 I llm_load_print_meta: n_rot            = 32
0.00.020.883 I llm_load_print_meta: n_swa            = 0
0.00.020.883 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.883 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.884 I llm_load_print_meta: n_gqa            = 1
0.00.020.885 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.020.885 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.020.887 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.020.888 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
...
0.00.020.891 I llm_load_print_meta: n_ff             = 1536
0.00.020.892 I llm_load_print_meta: n_expert         = 0
0.00.020.892 I llm_load_print_meta: n_expert_used    = 0
0.00.020.893 I llm_load_print_meta: causal attn      = 0
0.00.020.893 I llm_load_print_meta: pooling type     = 2
0.00.020.893 I llm_load_print_meta: rope type        = 2
0.00.020.893 I llm_load_print_meta: rope scaling     = linear
0.00.020.895 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.020.895 I llm_load_print_meta: freq_scale_train = 1
0.00.020.896 I llm_load_print_meta: n_ctx_orig_yarn  = 512
...
0.00.020.897 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.897 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.897 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.898 I llm_load_print_meta: model type       = 33M
...
0.00.020.902 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.902 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.903 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.903 I llm_load_print_meta: max token length = 21
0.00.020.916 I llm_load_tensors: ggml ctx size =    0.08 MiB
0.00.022.712 I llm_load_tensors:        CPU buffer size =    34.38 MiB
.................................................
0.00.023.436 I llama_new_context_with_model: n_ctx      = 512
...
0.00.023.454 I llama_new_context_with_model: freq_base  = 10000.0
0.00.023.455 I llama_new_context_with_model: freq_scale = 1
0.00.024.767 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.024.793 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.024.800 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.026.652 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.026.674 I llama_new_context_with_model: graph nodes  = 429
0.00.026.674 I llama_new_context_with_model: graph splits = 1
0.00.026.676 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.029.048 I 
0.00.029.130 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.030.621 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.033.682 I llama_perf_context_print:        load time =      27.75 ms
0.00.033.684 I llama_perf_context_print: prompt eval time =       2.73 ms /     9 tokens (    0.30 ms per token,  3301.54 tokens per second)
0.00.033.685 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.033.685 I llama_perf_context_print:       total time =       4.63 ms /    10 tokens
...
0.00.000.656 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.528 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.017.101 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
...
0.00.020.693 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.020.693 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.020.694 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.020.694 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.020.695 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.020.695 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.020.696 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.020.696 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.020.696 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.020.699 I llama_model_loader: - type  f32:   41 tensors
0.00.020.701 I llama_model_loader: - type  f16:   29 tensors
0.00.038.946 W llm_load_vocab: empty token at index 5
0.00.050.027 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.064.342 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.064.469 I llm_load_vocab: special tokens cache size = 5
0.00.347.318 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.347.339 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.347.340 I llm_load_print_meta: arch             = jina-bert-v2
0.00.347.341 I llm_load_print_meta: vocab type       = BPE
0.00.347.341 I llm_load_print_meta: n_vocab          = 61056
0.00.347.341 I llm_load_print_meta: n_merges         = 39382
0.00.347.342 I llm_load_print_meta: vocab_only       = 0
0.00.347.342 I llm_load_print_meta: n_ctx_train      = 8192
0.00.347.343 I llm_load_print_meta: n_embd           = 384
0.00.347.343 I llm_load_print_meta: n_layer          = 4
0.00.347.352 I llm_load_print_meta: n_head           = 12
0.00.347.353 I llm_load_print_meta: n_head_kv        = 12
0.00.347.353 I llm_load_print_meta: n_rot            = 32
0.00.347.354 I llm_load_print_meta: n_swa            = 0
0.00.347.354 I llm_load_print_meta: n_embd_head_k    = 32
0.00.347.354 I llm_load_print_meta: n_embd_head_v    = 32
0.00.347.355 I llm_load_print_meta: n_gqa            = 1
0.00.347.356 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.347.356 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.347.358 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.347.359 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.347.359 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.347.360 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.347.360 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.347.361 I llm_load_print_meta: n_ff             = 1536
0.00.347.361 I llm_load_print_meta: n_expert         = 0
0.00.347.361 I llm_load_print_meta: n_expert_used    = 0
0.00.347.362 I llm_load_print_meta: causal attn      = 0
0.00.347.362 I llm_load_print_meta: pooling type     = -1
0.00.347.362 I llm_load_print_meta: rope type        = -1
0.00.347.363 I llm_load_print_meta: rope scaling     = linear
0.00.347.364 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.347.365 I llm_load_print_meta: freq_scale_train = 1
0.00.347.365 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.347.365 I llm_load_print_meta: rope_finetuned   = unknown
0.00.347.366 I llm_load_print_meta: ssm_d_conv       = 0
0.00.347.366 I llm_load_print_meta: ssm_d_inner      = 0
0.00.347.366 I llm_load_print_meta: ssm_d_state      = 0
0.00.347.367 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.347.367 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.347.368 I llm_load_print_meta: model type       = 33M
0.00.347.369 I llm_load_print_meta: model ftype      = F16
0.00.347.370 I llm_load_print_meta: model params     = 32.90 M
0.00.347.370 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.347.371 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.347.371 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.347.372 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.347.372 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.347.372 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.347.373 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.347.373 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.347.373 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.347.374 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.347.374 I llm_load_print_meta: max token length = 45
0.00.347.386 I llm_load_tensors: ggml ctx size =    0.03 MiB
0.00.350.269 I llm_load_tensors:        CPU buffer size =    62.78 MiB
......................
0.00.352.124 I llama_new_context_with_model: n_ctx      = 8192
0.00.352.146 I llama_new_context_with_model: n_batch    = 2048
0.00.352.146 I llama_new_context_with_model: n_ubatch   = 2048
0.00.352.146 I llama_new_context_with_model: flash_attn = 0
0.00.352.148 I llama_new_context_with_model: freq_base  = 10000.0
0.00.352.149 I llama_new_context_with_model: freq_scale = 1
0.00.361.141 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.361.167 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.361.175 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.362.842 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.362.866 I llama_new_context_with_model: graph nodes  = 154
0.00.362.866 I llama_new_context_with_model: graph splits = 1
0.00.362.868 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.371.246 I 
0.00.371.330 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.371.568 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.371.581 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.596 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.371.596 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.601 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.371.601 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.622 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.383.897 I llama_perf_context_print:        load time =     369.59 ms
0.00.383.899 I llama_perf_context_print: prompt eval time =       8.08 ms /    62 tokens (    0.13 ms per token,  7672.32 tokens per second)
0.00.383.900 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.383.902 I llama_perf_context_print:       total time =      12.65 ms /    63 tokens
...
0.00.000.612 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.577 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.578 I llm_load_print_meta: model params     = 1.41 B
0.00.076.579 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.076.600 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.149.456 I llm_load_tensors:        CPU buffer size =  2699.45 MiB
...............................................................................
0.00.151.435 I llama_new_context_with_model: n_ctx      = 2048
0.00.151.456 I llama_new_context_with_model: n_batch    = 2048
0.00.151.456 I llama_new_context_with_model: n_ubatch   = 512
0.00.151.457 I llama_new_context_with_model: flash_attn = 0
0.00.151.458 I llama_new_context_with_model: freq_base  = 10000.0
0.00.151.459 I llama_new_context_with_model: freq_scale = 1
0.00.219.667 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.219.696 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.219.719 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.221.852 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.221.871 I llama_new_context_with_model: graph nodes  = 967
0.00.221.871 I llama_new_context_with_model: graph splits = 1
0.00.221.875 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.324.222 I main: llama threadpool init, n_threads = 4
0.00.324.249 I 
0.00.324.328 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.324.341 I 
0.00.324.451 I sampler seed: 1234
0.00.324.469 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.324.473 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
...
0.04.808.103 I llama_perf_sampler_print:    sampling time =       2.38 ms /    71 runs   (    0.03 ms per token, 29882.15 tokens per second)
0.04.808.106 I llama_perf_context_print:        load time =     322.36 ms
0.04.808.107 I llama_perf_context_print: prompt eval time =     111.85 ms /     7 tokens (   15.98 ms per token,    62.59 tokens per second)
0.04.808.108 I llama_perf_context_print:        eval time =    4361.37 ms /    63 runs   (   69.23 ms per token,    14.44 tokens per second)
0.04.808.109 I llama_perf_context_print:       total time =    4483.89 ms /    70 tokens

real	0m4.871s
user	0m18.333s
sys	0m0.213s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-f16.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.702 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.518 I llm_load_print_meta: model ftype      = all F32 (guessed)
...
0.00.156.428 I llm_load_tensors:        CPU buffer size =  2699.45 MiB
...............................................................................
0.00.158.352 I llama_new_context_with_model: n_ctx      = 128
0.00.158.373 I llama_new_context_with_model: n_batch    = 128
0.00.158.374 I llama_new_context_with_model: n_ubatch   = 128
0.00.158.374 I llama_new_context_with_model: flash_attn = 0
0.00.158.376 I llama_new_context_with_model: freq_base  = 10000.0
0.00.158.377 I llama_new_context_with_model: freq_scale = 1
0.00.163.026 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.163.053 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.163.067 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.164.598 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.164.621 I llama_new_context_with_model: graph nodes  = 967
0.00.164.621 I llama_new_context_with_model: graph splits = 1
0.00.164.623 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.231.007 I 
0.00.231.098 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.231.110 I perplexity: tokenizing the input ..
0.00.239.538 I perplexity: tokenization took 8.43 ms
0.00.239.566 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.158.041 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.161.679 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.161.715 I llama_perf_context_print:        load time =     229.36 ms
0.01.161.717 I llama_perf_context_print: prompt eval time =     916.84 ms /   128 tokens (    7.16 ms per token,   139.61 tokens per second)
0.01.161.718 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.161.718 I llama_perf_context_print:       total time =     930.71 ms /   129 tokens
...
0.00.000.621 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.138.824 I llm_load_tensors:        CPU buffer size =  1435.23 MiB
...............................................................................
0.00.140.748 I llama_new_context_with_model: n_ctx      = 2048
0.00.140.769 I llama_new_context_with_model: n_batch    = 2048
0.00.140.769 I llama_new_context_with_model: n_ubatch   = 512
0.00.140.770 I llama_new_context_with_model: flash_attn = 0
...
0.00.209.420 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.209.438 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.211.470 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.211.494 I llama_new_context_with_model: graph nodes  = 967
0.00.211.494 I llama_new_context_with_model: graph splits = 1
0.00.211.498 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.310.915 I main: llama threadpool init, n_threads = 4
0.00.310.942 I 
0.00.311.015 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.311.028 I 
0.00.311.121 I sampler seed: 1234
0.00.311.138 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.311.142 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.311.142 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.311.142 I 
...
0.03.027.655 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30829.35 tokens per second)
0.03.027.659 I llama_perf_context_print:        load time =     309.15 ms
0.03.027.660 I llama_perf_context_print: prompt eval time =     123.67 ms /     7 tokens (   17.67 ms per token,    56.60 tokens per second)
0.03.027.662 I llama_perf_context_print:        eval time =    2582.51 ms /    63 runs   (   40.99 ms per token,    24.39 tokens per second)
0.03.027.663 I llama_perf_context_print:       total time =    2716.75 ms /    70 tokens

real	0m3.084s
user	0m11.225s
sys	0m0.224s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.642 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.143 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.144 I llm_load_print_meta: model params     = 1.41 B
0.00.075.144 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.137.385 I llm_load_tensors:        CPU buffer size =  1435.23 MiB
...............................................................................
0.00.139.301 I llama_new_context_with_model: n_ctx      = 128
...
0.00.139.323 I llama_new_context_with_model: freq_base  = 10000.0
0.00.139.323 I llama_new_context_with_model: freq_scale = 1
0.00.144.034 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.144.059 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.144.076 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.146.149 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.146.173 I llama_new_context_with_model: graph nodes  = 967
0.00.146.173 I llama_new_context_with_model: graph splits = 1
0.00.146.175 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.214.967 I 
0.00.215.069 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.215.088 I perplexity: tokenizing the input ..
0.00.223.492 I perplexity: tokenization took 8.401 ms
0.00.223.526 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.122.570 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.126.456 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.126.499 I llama_perf_context_print:        load time =     213.28 ms
0.01.126.524 I llama_perf_context_print: prompt eval time =     897.37 ms /   128 tokens (    7.01 ms per token,   142.64 tokens per second)
0.01.126.526 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.126.527 I llama_perf_context_print:       total time =     911.53 ms /   129 tokens
...
0.00.075.782 I llm_load_print_meta: model ftype      = Q4_0
...
0.00.106.223 I llm_load_tensors:        CPU buffer size =   786.31 MiB
...............................................................................
0.00.108.153 I llama_new_context_with_model: n_ctx      = 2048
0.00.108.173 I llama_new_context_with_model: n_batch    = 2048
0.00.108.174 I llama_new_context_with_model: n_ubatch   = 512
0.00.108.174 I llama_new_context_with_model: flash_attn = 0
0.00.108.176 I llama_new_context_with_model: freq_base  = 10000.0
0.00.108.177 I llama_new_context_with_model: freq_scale = 1
0.00.175.418 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.175.446 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.175.463 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.177.453 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.177.472 I llama_new_context_with_model: graph nodes  = 967
0.00.177.473 I llama_new_context_with_model: graph splits = 1
0.00.177.476 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.270.921 I main: llama threadpool init, n_threads = 4
0.00.270.946 I 
0.00.271.016 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.271.029 I 
0.00.271.121 I sampler seed: 1234
0.00.271.139 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.271.143 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.271.143 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.271.143 I 
I believe the meaning of life is to know and experience things. I think that is the only way we can truly know ourselves. I have not really experienced anything. I don't know anything that I'm not going to be able to learn from others.

So it's a matter of life or death. It's a matter of life or death

0.02.090.989 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30459.03 tokens per second)
0.02.090.992 I llama_perf_context_print:        load time =     269.04 ms
0.02.090.993 I llama_perf_context_print: prompt eval time =      75.37 ms /     7 tokens (   10.77 ms per token,    92.87 tokens per second)
0.02.090.994 I llama_perf_context_print:        eval time =    1734.05 ms /    63 runs   (   27.52 ms per token,    36.33 tokens per second)
0.02.090.995 I llama_perf_context_print:       total time =    1820.07 ms /    70 tokens

real	0m2.127s
user	0m7.639s
sys	0m0.144s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.570 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.497 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.498 I llm_load_print_meta: model params     = 1.41 B
0.00.075.499 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.105.535 I llm_load_tensors:        CPU buffer size =   786.31 MiB
...............................................................................
0.00.107.452 I llama_new_context_with_model: n_ctx      = 128
0.00.107.473 I llama_new_context_with_model: n_batch    = 128
0.00.107.473 I llama_new_context_with_model: n_ubatch   = 128
0.00.107.474 I llama_new_context_with_model: flash_attn = 0
0.00.107.476 I llama_new_context_with_model: freq_base  = 10000.0
0.00.107.476 I llama_new_context_with_model: freq_scale = 1
0.00.111.993 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.112.020 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.112.033 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.113.948 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.113.971 I llama_new_context_with_model: graph nodes  = 967
0.00.113.971 I llama_new_context_with_model: graph splits = 1
0.00.113.973 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.174.733 I 
0.00.174.819 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.174.844 I perplexity: tokenizing the input ..
0.00.183.282 I perplexity: tokenization took 8.441 ms
0.00.183.311 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.192.467 I perplexity: 1.01 seconds per pass - ETA 0.02 minutes
[1]11.2206,
0.01.196.061 I Final estimate: PPL = 11.2206 +/- 3.51829

0.01.196.100 I llama_perf_context_print:        load time =     173.22 ms
0.01.196.114 I llama_perf_context_print: prompt eval time =    1007.58 ms /   128 tokens (    7.87 ms per token,   127.04 tokens per second)
0.01.196.115 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.196.116 I llama_perf_context_print:       total time =    1021.37 ms /   129 tokens
...
0.00.000.652 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.845 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.074.854 I llm_load_print_meta: model ftype      = Q4_1
0.00.074.855 I llm_load_print_meta: model params     = 1.41 B
0.00.074.856 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.074.871 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.100.042 I llm_load_tensors:        CPU buffer size =   864.46 MiB
..............................................................................
0.00.101.983 I llama_new_context_with_model: n_ctx      = 2048
0.00.102.004 I llama_new_context_with_model: n_batch    = 2048
0.00.102.004 I llama_new_context_with_model: n_ubatch   = 512
0.00.102.004 I llama_new_context_with_model: flash_attn = 0
0.00.102.006 I llama_new_context_with_model: freq_base  = 10000.0
0.00.102.007 I llama_new_context_with_model: freq_scale = 1
0.00.170.267 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.170.302 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.170.318 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.171.783 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.171.807 I llama_new_context_with_model: graph nodes  = 967
0.00.171.807 I llama_new_context_with_model: graph splits = 1
0.00.171.810 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.258.558 I main: llama threadpool init, n_threads = 4
0.00.258.585 I 
0.00.258.661 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.258.674 I 
0.00.258.770 I sampler seed: 1234
0.00.258.789 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.258.792 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.258.793 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.258.793 I 
I believe the meaning of life is that which you will do when you have no other choice."

The man looked at her, his face an unpleasant mask. "I think you're making too much of this. I was in the woods with your mother a few days ago, and I had no idea that she was pregnant. And she's not

0.02.213.294 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30616.65 tokens per second)
0.02.213.297 I llama_perf_context_print:        load time =     256.67 ms
0.02.213.298 I llama_perf_context_print: prompt eval time =     105.69 ms /     7 tokens (   15.10 ms per token,    66.23 tokens per second)
0.02.213.299 I llama_perf_context_print:        eval time =    1838.92 ms /    63 runs   (   29.19 ms per token,    34.26 tokens per second)
0.02.213.300 I llama_perf_context_print:       total time =    1954.74 ms /    70 tokens

real	0m2.246s
user	0m8.153s
sys	0m0.132s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.640 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.750 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.750 I llm_load_print_meta: model params     = 1.41 B
0.00.075.752 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.075.768 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.101.170 I llm_load_tensors:        CPU buffer size =   864.46 MiB
..............................................................................
0.00.103.104 I llama_new_context_with_model: n_ctx      = 128
0.00.103.125 I llama_new_context_with_model: n_batch    = 128
0.00.103.125 I llama_new_context_with_model: n_ubatch   = 128
0.00.103.126 I llama_new_context_with_model: flash_attn = 0
0.00.103.127 I llama_new_context_with_model: freq_base  = 10000.0
0.00.103.128 I llama_new_context_with_model: freq_scale = 1
0.00.107.789 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.107.816 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.107.831 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.109.852 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.109.872 I llama_new_context_with_model: graph nodes  = 967
0.00.109.873 I llama_new_context_with_model: graph splits = 1
0.00.109.875 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.164.615 I 
0.00.164.708 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.164.741 I perplexity: tokenizing the input ..
0.00.173.269 I perplexity: tokenization took 8.551 ms
0.00.173.296 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.802.720 I perplexity: 1.63 seconds per pass - ETA 0.02 minutes
[1]10.5775,
0.01.806.496 I Final estimate: PPL = 10.5775 +/- 3.33909

0.01.806.538 I llama_perf_context_print:        load time =     162.94 ms
0.01.806.552 I llama_perf_context_print: prompt eval time =    1627.77 ms /   128 tokens (   12.72 ms per token,    78.64 tokens per second)
0.01.806.553 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.806.554 I llama_perf_context_print:       total time =    1641.92 ms /   129 tokens
...
0.00.000.595 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.760 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
...
0.00.075.576 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.576 I llm_load_print_meta: model params     = 1.41 B
0.00.075.577 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.098.988 I llm_load_tensors:        CPU buffer size =   942.60 MiB
..................................................................................
0.00.100.937 I llama_new_context_with_model: n_ctx      = 2048
0.00.100.958 I llama_new_context_with_model: n_batch    = 2048
0.00.100.958 I llama_new_context_with_model: n_ubatch   = 512
0.00.100.958 I llama_new_context_with_model: flash_attn = 0
0.00.100.960 I llama_new_context_with_model: freq_base  = 10000.0
0.00.100.961 I llama_new_context_with_model: freq_scale = 1
0.00.170.563 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.170.587 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.170.605 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.172.176 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.172.200 I llama_new_context_with_model: graph nodes  = 967
0.00.172.201 I llama_new_context_with_model: graph splits = 1
0.00.172.205 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.258.337 I main: llama threadpool init, n_threads = 4
0.00.258.364 I 
0.00.258.477 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.258.490 I 
0.00.258.615 I sampler seed: 1234
0.00.258.633 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.258.637 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.258.637 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.258.638 I 
...
0.02.413.957 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 32025.26 tokens per second)
0.02.413.960 I llama_perf_context_print:        load time =     256.58 ms
0.02.413.962 I llama_perf_context_print: prompt eval time =     118.34 ms /     7 tokens (   16.91 ms per token,    59.15 tokens per second)
0.02.413.963 I llama_perf_context_print:        eval time =    2026.96 ms /    63 runs   (   32.17 ms per token,    31.08 tokens per second)
0.02.413.964 I llama_perf_context_print:       total time =    2155.63 ms /    70 tokens

real	0m2.446s
user	0m8.950s
sys	0m0.136s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.735 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.099.254 I llm_load_tensors:        CPU buffer size =   942.60 MiB
..................................................................................
0.00.101.296 I llama_new_context_with_model: n_ctx      = 128
0.00.101.317 I llama_new_context_with_model: n_batch    = 128
0.00.101.317 I llama_new_context_with_model: n_ubatch   = 128
0.00.101.318 I llama_new_context_with_model: flash_attn = 0
0.00.101.320 I llama_new_context_with_model: freq_base  = 10000.0
0.00.101.320 I llama_new_context_with_model: freq_scale = 1
0.00.106.084 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.106.111 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.106.128 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.107.514 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.107.538 I llama_new_context_with_model: graph nodes  = 967
0.00.107.538 I llama_new_context_with_model: graph splits = 1
0.00.107.540 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.167.186 I 
0.00.167.279 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.167.285 I perplexity: tokenizing the input ..
0.00.175.724 I perplexity: tokenization took 8.436 ms
0.00.175.759 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.162.092 I perplexity: 1.99 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.02.165.621 I Final estimate: PPL = 10.0390 +/- 3.19711

0.02.165.662 I llama_perf_context_print:        load time =     165.51 ms
0.02.165.663 I llama_perf_context_print: prompt eval time =    1984.56 ms /   128 tokens (   15.50 ms per token,    64.50 tokens per second)
0.02.165.665 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.165.666 I llama_perf_context_print:       total time =    1998.48 ms /   129 tokens
...
0.00.099.463 I llm_load_tensors:        CPU buffer size =  1020.74 MiB
...............................................................................
0.00.101.407 I llama_new_context_with_model: n_ctx      = 2048
0.00.101.428 I llama_new_context_with_model: n_batch    = 2048
0.00.101.428 I llama_new_context_with_model: n_ubatch   = 512
0.00.101.428 I llama_new_context_with_model: flash_attn = 0
0.00.101.430 I llama_new_context_with_model: freq_base  = 10000.0
0.00.101.431 I llama_new_context_with_model: freq_scale = 1
0.00.169.325 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.169.354 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.169.372 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.171.318 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.171.339 I llama_new_context_with_model: graph nodes  = 967
0.00.171.339 I llama_new_context_with_model: graph splits = 1
0.00.171.342 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.262.188 I main: llama threadpool init, n_threads = 4
0.00.262.214 I 
0.00.262.287 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.262.300 I 
0.00.262.400 I sampler seed: 1234
0.00.262.419 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.262.423 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.262.423 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.262.423 I 
...
0.02.520.930 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30459.03 tokens per second)
0.02.520.933 I llama_perf_context_print:        load time =     260.48 ms
0.02.520.935 I llama_perf_context_print: prompt eval time =     118.19 ms /     7 tokens (   16.88 ms per token,    59.23 tokens per second)
0.02.520.936 I llama_perf_context_print:        eval time =    2130.20 ms /    63 runs   (   33.81 ms per token,    29.57 tokens per second)
0.02.520.936 I llama_perf_context_print:       total time =    2258.75 ms /    70 tokens

real	0m2.554s
user	0m9.365s
sys	0m0.152s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.598 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.100.222 I llm_load_tensors:        CPU buffer size =  1020.74 MiB
...............................................................................
0.00.102.239 I llama_new_context_with_model: n_ctx      = 128
0.00.102.254 I llama_new_context_with_model: n_batch    = 128
0.00.102.255 I llama_new_context_with_model: n_ubatch   = 128
0.00.102.255 I llama_new_context_with_model: flash_attn = 0
0.00.102.257 I llama_new_context_with_model: freq_base  = 10000.0
0.00.102.258 I llama_new_context_with_model: freq_scale = 1
0.00.106.965 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.106.991 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.107.006 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.108.488 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.108.511 I llama_new_context_with_model: graph nodes  = 967
0.00.108.511 I llama_new_context_with_model: graph splits = 1
0.00.108.514 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.169.636 I 
0.00.169.744 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.169.751 I perplexity: tokenizing the input ..
0.00.178.327 I perplexity: tokenization took 8.572 ms
0.00.178.355 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.106.960 I perplexity: 1.93 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.110.392 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.110.429 I llama_perf_context_print:        load time =     168.14 ms
0.02.110.431 I llama_perf_context_print: prompt eval time =    1926.86 ms /   128 tokens (   15.05 ms per token,    66.43 tokens per second)
0.02.110.432 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.110.434 I llama_perf_context_print:       total time =    1940.79 ms /   129 tokens
...
0.00.000.609 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.065.276 I llm_load_vocab: special tokens cache size = 25
...
0.00.076.953 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.954 I llm_load_print_meta: model params     = 1.41 B
0.00.076.955 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.076.980 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.090.503 I llm_load_tensors:        CPU buffer size =   542.04 MiB
..........................................................................
0.00.092.408 I llama_new_context_with_model: n_ctx      = 2048
0.00.092.427 I llama_new_context_with_model: n_batch    = 2048
0.00.092.428 I llama_new_context_with_model: n_ubatch   = 512
0.00.092.428 I llama_new_context_with_model: flash_attn = 0
0.00.092.430 I llama_new_context_with_model: freq_base  = 10000.0
0.00.092.431 I llama_new_context_with_model: freq_scale = 1
0.00.160.509 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.160.537 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.160.556 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.162.542 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.162.566 I llama_new_context_with_model: graph nodes  = 967
0.00.162.566 I llama_new_context_with_model: graph splits = 1
0.00.162.570 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.235.696 I main: llama threadpool init, n_threads = 4
0.00.235.722 I 
0.00.235.804 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.235.805 I 
0.00.235.912 I sampler seed: 1234
0.00.235.931 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.235.934 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.235.934 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.235.935 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.652.615 I llama_perf_sampler_print:    sampling time =       2.12 ms /    71 runs   (    0.03 ms per token, 33443.24 tokens per second)
0.01.652.619 I llama_perf_context_print:        load time =     233.90 ms
0.01.652.621 I llama_perf_context_print: prompt eval time =      81.50 ms /     7 tokens (   11.64 ms per token,    85.88 tokens per second)
0.01.652.621 I llama_perf_context_print:        eval time =    1325.45 ms /    63 runs   (   21.04 ms per token,    47.53 tokens per second)
0.01.652.622 I llama_perf_context_print:       total time =    1416.93 ms /    70 tokens

real	0m1.678s
user	0m5.946s
sys	0m0.116s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.651 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.089.215 I llm_load_tensors:        CPU buffer size =   542.04 MiB
..........................................................................
0.00.091.191 I llama_new_context_with_model: n_ctx      = 128
0.00.091.208 I llama_new_context_with_model: n_batch    = 128
0.00.091.208 I llama_new_context_with_model: n_ubatch   = 128
0.00.091.208 I llama_new_context_with_model: flash_attn = 0
0.00.091.210 I llama_new_context_with_model: freq_base  = 10000.0
0.00.091.211 I llama_new_context_with_model: freq_scale = 1
0.00.095.934 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.095.961 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.095.976 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.097.410 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.097.433 I llama_new_context_with_model: graph nodes  = 967
0.00.097.434 I llama_new_context_with_model: graph splits = 1
0.00.097.435 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.136.841 I 
0.00.136.939 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.136.959 I perplexity: tokenizing the input ..
0.00.145.535 I perplexity: tokenization took 8.573 ms
0.00.145.567 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.434.470 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.438.219 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.438.257 I llama_perf_context_print:        load time =     135.23 ms
0.01.438.260 I llama_perf_context_print: prompt eval time =    1287.11 ms /   128 tokens (   10.06 ms per token,    99.45 tokens per second)
0.01.438.261 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.438.262 I llama_perf_context_print:       total time =    1301.41 ms /   129 tokens
...
0.00.021.210 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.093.847 I llm_load_tensors:        CPU buffer size =   724.27 MiB
...............................................................................
0.00.095.742 I llama_new_context_with_model: n_ctx      = 2048
0.00.095.764 I llama_new_context_with_model: n_batch    = 2048
0.00.095.764 I llama_new_context_with_model: n_ubatch   = 512
0.00.095.764 I llama_new_context_with_model: flash_attn = 0
0.00.095.766 I llama_new_context_with_model: freq_base  = 10000.0
0.00.095.767 I llama_new_context_with_model: freq_scale = 1
0.00.164.004 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.164.032 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.164.049 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.166.028 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.166.045 I llama_new_context_with_model: graph nodes  = 967
0.00.166.045 I llama_new_context_with_model: graph splits = 1
0.00.166.049 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.242.934 I main: llama threadpool init, n_threads = 4
0.00.242.956 I 
0.00.243.031 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.243.032 I 
0.00.243.131 I sampler seed: 1234
0.00.243.137 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.243.162 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.243.175 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.243.176 I 
...
0.01.843.607 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32375.74 tokens per second)
0.01.843.610 I llama_perf_context_print:        load time =     241.11 ms
0.01.843.611 I llama_perf_context_print: prompt eval time =      84.80 ms /     7 tokens (   12.11 ms per token,    82.55 tokens per second)
0.01.843.612 I llama_perf_context_print:        eval time =    1505.77 ms /    63 runs   (   23.90 ms per token,    41.84 tokens per second)
0.01.843.613 I llama_perf_context_print:       total time =    1600.68 ms /    70 tokens

real	0m1.872s
user	0m6.703s
sys	0m0.117s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q3_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.634 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.856 I llama_model_loader: - type q4_K:   71 tensors
0.00.020.856 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.093.632 I llm_load_tensors:        CPU buffer size =   724.27 MiB
...............................................................................
0.00.095.617 I llama_new_context_with_model: n_ctx      = 128
0.00.095.637 I llama_new_context_with_model: n_batch    = 128
0.00.095.637 I llama_new_context_with_model: n_ubatch   = 128
0.00.095.638 I llama_new_context_with_model: flash_attn = 0
0.00.095.640 I llama_new_context_with_model: freq_base  = 10000.0
0.00.095.640 I llama_new_context_with_model: freq_scale = 1
0.00.100.279 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.100.305 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.100.319 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.102.326 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.102.349 I llama_new_context_with_model: graph nodes  = 967
0.00.102.349 I llama_new_context_with_model: graph splits = 1
0.00.102.351 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.143.417 I 
0.00.143.511 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.143.519 I perplexity: tokenizing the input ..
0.00.151.976 I perplexity: tokenization took 8.453 ms
0.00.152.010 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.478.962 I perplexity: 1.33 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.482.541 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.482.582 I llama_perf_context_print:        load time =     141.79 ms
0.01.482.585 I llama_perf_context_print: prompt eval time =    1325.13 ms /   128 tokens (   10.35 ms per token,    96.59 tokens per second)
0.01.482.587 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.482.588 I llama_perf_context_print:       total time =    1339.16 ms /   129 tokens
...
0.00.076.396 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.076.396 I llm_load_print_meta: model params     = 1.41 B
0.00.076.397 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.076.413 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.097.910 I llm_load_tensors:        CPU buffer size =   871.81 MiB
..............................................................................
0.00.099.932 I llama_new_context_with_model: n_ctx      = 2048
0.00.099.952 I llama_new_context_with_model: n_batch    = 2048
0.00.099.952 I llama_new_context_with_model: n_ubatch   = 512
0.00.099.953 I llama_new_context_with_model: flash_attn = 0
0.00.099.955 I llama_new_context_with_model: freq_base  = 10000.0
0.00.099.955 I llama_new_context_with_model: freq_scale = 1
0.00.168.087 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.168.116 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.168.132 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.170.147 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.170.171 I llama_new_context_with_model: graph nodes  = 967
0.00.170.172 I llama_new_context_with_model: graph splits = 1
0.00.170.175 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.247.351 I main: llama threadpool init, n_threads = 4
0.00.247.378 I 
0.00.247.456 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.247.469 I 
0.00.247.573 I sampler seed: 1234
0.00.247.591 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.247.594 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.247.595 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.247.595 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.057.536 I llama_perf_sampler_print:    sampling time =       2.31 ms /    71 runs   (    0.03 ms per token, 30762.56 tokens per second)
0.02.057.539 I llama_perf_context_print:        load time =     245.45 ms
0.02.057.541 I llama_perf_context_print: prompt eval time =      90.85 ms /     7 tokens (   12.98 ms per token,    77.05 tokens per second)
0.02.057.542 I llama_perf_context_print:        eval time =    1709.15 ms /    63 runs   (   27.13 ms per token,    36.86 tokens per second)
0.02.057.542 I llama_perf_context_print:       total time =    1810.19 ms /    70 tokens

real	0m2.088s
user	0m7.525s
sys	0m0.140s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.657 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.413 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.076.414 I llm_load_print_meta: model params     = 1.41 B
0.00.076.414 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.097.639 I llm_load_tensors:        CPU buffer size =   871.81 MiB
..............................................................................
0.00.099.558 I llama_new_context_with_model: n_ctx      = 128
...
0.00.099.583 I llama_new_context_with_model: freq_base  = 10000.0
0.00.099.583 I llama_new_context_with_model: freq_scale = 1
0.00.104.301 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.104.328 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.104.345 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.106.369 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.106.391 I llama_new_context_with_model: graph nodes  = 967
0.00.106.392 I llama_new_context_with_model: graph splits = 1
0.00.106.393 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.150.864 I 
0.00.150.963 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.150.970 I perplexity: tokenizing the input ..
0.00.159.620 I perplexity: tokenization took 8.646 ms
0.00.159.652 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.543.360 I perplexity: 1.38 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.546.980 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.547.018 I llama_perf_context_print:        load time =     149.19 ms
0.01.547.021 I llama_perf_context_print: prompt eval time =    1381.86 ms /   128 tokens (   10.80 ms per token,    92.63 tokens per second)
0.01.547.024 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.547.025 I llama_perf_context_print:       total time =    1396.16 ms /   129 tokens
...
0.00.000.583 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.881 I main: llama backend init
...
0.00.076.112 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.076.113 I llm_load_print_meta: model params     = 1.41 B
0.00.076.114 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.101.040 I llm_load_tensors:        CPU buffer size =  1006.35 MiB
................................................................................
0.00.102.927 I llama_new_context_with_model: n_ctx      = 2048
0.00.102.949 I llama_new_context_with_model: n_batch    = 2048
0.00.102.949 I llama_new_context_with_model: n_ubatch   = 512
0.00.102.950 I llama_new_context_with_model: flash_attn = 0
0.00.102.951 I llama_new_context_with_model: freq_base  = 10000.0
0.00.102.952 I llama_new_context_with_model: freq_scale = 1
0.00.170.859 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.170.888 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.170.905 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.172.410 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.259.407 I main: llama threadpool init, n_threads = 4
0.00.259.435 I 
0.00.259.513 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.259.526 I 
0.00.259.640 I sampler seed: 1234
0.00.259.659 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.259.662 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.259.663 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.259.663 I 
...
0.02.332.994 I llama_perf_sampler_print:    sampling time =       2.29 ms /    71 runs   (    0.03 ms per token, 31058.62 tokens per second)
0.02.332.997 I llama_perf_context_print:        load time =     257.62 ms
0.02.332.998 I llama_perf_context_print: prompt eval time =     109.01 ms /     7 tokens (   15.57 ms per token,    64.21 tokens per second)
0.02.333.000 I llama_perf_context_print:        eval time =    1954.25 ms /    63 runs   (   31.02 ms per token,    32.24 tokens per second)
0.02.333.000 I llama_perf_context_print:       total time =    2073.59 ms /    70 tokens

real	0m2.365s
user	0m8.608s
sys	0m0.152s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.644 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.079 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
...
0.00.076.186 I llm_load_print_meta: model ftype      = Q5_K - Medium
...
0.00.101.395 I llm_load_tensors:        CPU buffer size =  1006.35 MiB
................................................................................
0.00.103.349 I llama_new_context_with_model: n_ctx      = 128
0.00.103.368 I llama_new_context_with_model: n_batch    = 128
0.00.103.368 I llama_new_context_with_model: n_ubatch   = 128
0.00.103.369 I llama_new_context_with_model: flash_attn = 0
0.00.103.371 I llama_new_context_with_model: freq_base  = 10000.0
0.00.103.371 I llama_new_context_with_model: freq_scale = 1
0.00.108.005 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.108.026 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.108.039 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.110.019 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.110.038 I llama_new_context_with_model: graph nodes  = 967
0.00.110.038 I llama_new_context_with_model: graph splits = 1
0.00.110.040 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.163.460 I 
0.00.163.569 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.163.582 I perplexity: tokenizing the input ..
0.00.172.337 I perplexity: tokenization took 8.751 ms
0.00.172.367 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.851.377 I perplexity: 1.68 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.854.905 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.854.945 I llama_perf_context_print:        load time =     161.84 ms
0.01.854.946 I llama_perf_context_print: prompt eval time =    1677.21 ms /   128 tokens (   13.10 ms per token,    76.32 tokens per second)
0.01.854.949 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.854.949 I llama_perf_context_print:       total time =    1691.48 ms /   129 tokens
...
0.00.000.593 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.049 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
...
0.00.075.744 I llm_load_print_meta: model ftype      = Q6_K
...
0.00.100.709 I llm_load_tensors:        CPU buffer size =  1108.64 MiB
...............................................................................
0.00.102.620 I llama_new_context_with_model: n_ctx      = 2048
0.00.102.641 I llama_new_context_with_model: n_batch    = 2048
0.00.102.641 I llama_new_context_with_model: n_ubatch   = 512
0.00.102.642 I llama_new_context_with_model: flash_attn = 0
0.00.102.643 I llama_new_context_with_model: freq_base  = 10000.0
0.00.102.644 I llama_new_context_with_model: freq_scale = 1
0.00.170.563 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.170.592 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.170.610 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.172.596 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.172.622 I llama_new_context_with_model: graph nodes  = 967
0.00.172.622 I llama_new_context_with_model: graph splits = 1
0.00.172.626 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.257.737 I main: llama threadpool init, n_threads = 4
0.00.257.765 I 
0.00.257.848 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.257.861 I 
0.00.257.968 I sampler seed: 1234
0.00.257.986 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.257.990 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> softmax -> dist 
0.00.257.990 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.257.990 I 
...
0.02.514.660 I llama_perf_sampler_print:    sampling time =       2.26 ms /    71 runs   (    0.03 ms per token, 31457.69 tokens per second)
0.02.514.664 I llama_perf_context_print:        load time =     256.01 ms
0.02.514.665 I llama_perf_context_print: prompt eval time =     104.64 ms /     7 tokens (   14.95 ms per token,    66.89 tokens per second)
0.02.514.666 I llama_perf_context_print:        eval time =    2141.71 ms /    63 runs   (   34.00 ms per token,    29.42 tokens per second)
0.02.514.666 I llama_perf_context_print:       total time =    2256.93 ms /    70 tokens

real	0m2.547s
user	0m9.347s
sys	0m0.140s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q6_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.785 I build: 3938 (6f55bccb) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.100.816 I llm_load_tensors:        CPU buffer size =  1108.64 MiB
...............................................................................
0.00.102.916 I llama_new_context_with_model: n_ctx      = 128
0.00.102.937 I llama_new_context_with_model: n_batch    = 128
0.00.102.937 I llama_new_context_with_model: n_ubatch   = 128
0.00.102.937 I llama_new_context_with_model: flash_attn = 0
0.00.102.939 I llama_new_context_with_model: freq_base  = 10000.0
0.00.102.940 I llama_new_context_with_model: freq_scale = 1
0.00.107.581 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.107.607 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.107.624 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.109.584 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.109.606 I llama_new_context_with_model: graph nodes  = 967
0.00.109.607 I llama_new_context_with_model: graph splits = 1
0.00.109.608 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.161.734 I 
0.00.161.835 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.161.854 I perplexity: tokenizing the input ..
0.00.170.727 I perplexity: tokenization took 8.868 ms
0.00.170.759 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.807.892 I perplexity: 1.64 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.811.780 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.811.837 I llama_perf_context_print:        load time =     159.98 ms
0.01.811.838 I llama_perf_context_print: prompt eval time =    1635.22 ms /   128 tokens (   12.78 ms per token,    78.28 tokens per second)
0.01.811.840 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.811.841 I llama_perf_context_print:       total time =    1650.10 ms /   129 tokens
...
0.00.175.728 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
0.47user 0.16system 0:00.63elapsed 99%CPU (0avgtext+0avgdata 2896344maxresident)k
0inputs+48outputs (0major+58289minor)pagefaults 0swaps
```
...
0.17user 0.14system 0:00.31elapsed 100%CPU (0avgtext+0avgdata 2893060maxresident)k
0inputs+48outputs (0major+57611minor)pagefaults 0swaps
```
