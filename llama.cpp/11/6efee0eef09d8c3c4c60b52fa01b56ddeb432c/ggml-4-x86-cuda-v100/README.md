...
- status:  FAILURE ❌ (8)
- runtime: 6:48.10
- date:    Tue Sep 24 00:21:18 UTC 2024
...
26/28 Test #26: test-backend-ops ..................***Failed  298.65 sec
...
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[CPY] NMSE = 0.000003008 > 0.000001000 ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[1;31mFAIL[0m
...
Label Time Summary:
main    = 365.54 sec*proc (28 tests)

Total Test time (real) = 365.56 sec
