...
- status:  SUCCESS ✅
- runtime: 630.53
- date:    Sat Feb 22 03:26:24 PST 2025
...
0.00.000.118 I build: 4758 (5fa07c2f) with Apple clang version 16.0.0 (clang-1600.0.26.4) for arm64-apple-darwin24.1.0
0.00.015.074 I llama_model_load_from_file_impl: using device Metal (Apple M4) - 10922 MiB free
0.00.020.424 I llama_model_loader: loaded meta data with 24 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.020.430 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.020.433 I llama_model_loader: - kv   0:                       general.architecture str              = bert
0.00.020.433 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.020.434 I llama_model_loader: - kv   2:                               general.name str              = Bge Small
0.00.020.435 I llama_model_loader: - kv   3:                           general.basename str              = bge
0.00.020.436 I llama_model_loader: - kv   4:                         general.size_label str              = small
0.00.020.437 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
0.00.020.437 I llama_model_loader: - kv   6:                        bert.context_length u32              = 512
0.00.020.438 I llama_model_loader: - kv   7:                      bert.embedding_length u32              = 384
0.00.020.438 I llama_model_loader: - kv   8:                   bert.feed_forward_length u32              = 1536
0.00.020.439 I llama_model_loader: - kv   9:                  bert.attention.head_count u32              = 12
0.00.020.441 I llama_model_loader: - kv  10:          bert.attention.layer_norm_epsilon f32              = 0.000000
0.00.020.442 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.020.443 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
0.00.020.443 I llama_model_loader: - kv  13:                          bert.pooling_type u32              = 2
0.00.020.444 I llama_model_loader: - kv  14:            tokenizer.ggml.token_type_count u32              = 2
0.00.020.444 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
0.00.020.448 I llama_model_loader: - kv  16:                         tokenizer.ggml.pre str              = jina-v2-en
0.00.024.839 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.025.893 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.025.893 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.025.894 I llama_model_loader: - kv  22:               tokenizer.ggml.mask_token_id u32              = 103
0.00.025.894 I llama_model_loader: - kv  23:               general.quantization_version u32              = 2
0.00.025.895 I llama_model_loader: - type  f32:  124 tensors
0.00.025.895 I llama_model_loader: - type  f16:   73 tensors
...
0.00.030.066 I load: special tokens cache size = 5
...
0.00.032.275 I print_info: n_layer          = 12
0.00.032.278 I print_info: n_head           = 12
0.00.032.279 I print_info: n_head_kv        = 12
0.00.032.279 I print_info: n_rot            = 32
0.00.032.280 I print_info: n_swa            = 0
0.00.032.282 I print_info: n_embd_head_k    = 32
0.00.032.282 I print_info: n_embd_head_v    = 32
0.00.032.283 I print_info: n_gqa            = 1
0.00.032.284 I print_info: n_embd_k_gqa     = 384
0.00.032.285 I print_info: n_embd_v_gqa     = 384
...
0.00.032.289 I print_info: n_expert         = 0
0.00.032.289 I print_info: n_expert_used    = 0
0.00.032.289 I print_info: causal attn      = 0
0.00.032.290 I print_info: pooling type     = 2
0.00.032.290 I print_info: rope type        = 2
...
0.00.032.292 I print_info: rope_finetuned   = unknown
0.00.032.292 I print_info: ssm_d_conv       = 0
0.00.032.295 I print_info: ssm_d_inner      = 0
0.00.032.295 I print_info: ssm_d_state      = 0
0.00.032.295 I print_info: ssm_dt_rank      = 0
0.00.032.295 I print_info: ssm_dt_b_c_rms   = 0
0.00.032.296 I print_info: model type       = 33M
0.00.032.296 I print_info: model params     = 33.21 M
0.00.032.296 I print_info: general.name     = Bge Small
0.00.032.297 I print_info: vocab type       = WPM
0.00.032.297 I print_info: n_vocab          = 30522
0.00.032.297 I print_info: n_merges         = 0
0.00.032.298 I print_info: BOS token        = 101 '[CLS]'
0.00.032.298 I print_info: UNK token        = 100 '[UNK]'
0.00.032.298 I print_info: SEP token        = 102 '[SEP]'
0.00.032.299 I print_info: PAD token        = 0 '[PAD]'
0.00.032.299 I print_info: MASK token       = 103 '[MASK]'
...
0.00.035.276 I load_tensors: offloading 12 repeating layers to GPU
0.00.035.278 I load_tensors: offloading output layer to GPU
0.00.035.278 I load_tensors: offloaded 13/13 layers to GPU
0.00.035.297 I load_tensors: Metal_Mapped model buffer size =    40.73 MiB
0.00.035.299 I load_tensors:   CPU_Mapped model buffer size =    23.11 MiB
................................................
0.00.035.564 I llama_init_from_model: n_seq_max     = 1
0.00.035.566 I llama_init_from_model: n_ctx         = 512
0.00.035.566 I llama_init_from_model: n_ctx_per_seq = 512
0.00.035.566 I llama_init_from_model: n_batch       = 2048
0.00.035.566 I llama_init_from_model: n_ubatch      = 2048
0.00.035.567 I llama_init_from_model: flash_attn    = 0
0.00.035.567 I llama_init_from_model: freq_base     = 10000.0
0.00.035.568 I llama_init_from_model: freq_scale    = 1
0.00.035.568 I ggml_metal_init: allocating
0.00.035.581 I ggml_metal_init: found device: Apple M4
0.00.035.593 I ggml_metal_init: picking default device: Apple M4
0.00.036.336 I ggml_metal_init: using embedded metal library
0.00.040.273 I ggml_metal_init: GPU name:   Apple M4
0.00.040.276 I ggml_metal_init: GPU family: MTLGPUFamilyApple9  (1009)
0.00.040.276 I ggml_metal_init: GPU family: MTLGPUFamilyCommon3 (3003)
0.00.040.277 I ggml_metal_init: GPU family: MTLGPUFamilyMetal3  (5001)
0.00.040.277 I ggml_metal_init: simdgroup reduction   = true
0.00.040.277 I ggml_metal_init: simdgroup matrix mul. = true
0.00.040.278 I ggml_metal_init: has residency sets    = true
0.00.040.278 I ggml_metal_init: has bfloat            = true
0.00.040.278 I ggml_metal_init: use bfloat            = true
0.00.040.278 I ggml_metal_init: hasUnifiedMemory      = true
0.00.040.279 I ggml_metal_init: recommendedMaxWorkingSetSize  = 11453.25 MB
0.00.051.741 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.052.407 I llama_kv_cache_init:      Metal KV buffer size =     9.00 MiB
0.00.052.410 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.052.424 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.053.542 I llama_init_from_model:      Metal compute buffer size =    16.00 MiB
0.00.053.543 I llama_init_from_model:        CPU compute buffer size =     2.51 MiB
0.00.053.543 I llama_init_from_model: graph nodes  = 429
0.00.053.544 I llama_init_from_model: graph splits = 2
0.00.053.545 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.053.545 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.059.094 I 
0.00.059.124 I system_info: n_threads = 4 (n_threads_batch = 4) / 10 | Metal : EMBED_LIBRARY = 1 | BF16 = 1 | CPU : NEON = 1 | ARM_FMA = 1 | FP16_VA = 1 | MATMUL_INT8 = 1 | DOTPROD = 1 | SME = 1 | ACCELERATE = 1 | AARCH64_REPACK = 1 | 
0.00.059.797 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.064.984 I llama_perf_context_print:        load time =      44.02 ms
0.00.064.985 I llama_perf_context_print: prompt eval time =       5.02 ms /     9 tokens (    0.56 ms per token,  1792.83 tokens per second)
0.00.064.986 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.064.986 I llama_perf_context_print:       total time =       5.89 ms /    10 tokens
0.00.065.126 I ggml_metal_free: deallocating
...
0.00.009.337 I llama_model_load_from_file_impl: using device Metal (Apple M4) - 10922 MiB free
...
0.00.012.032 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
0.00.012.033 I llama_model_loader: - kv   6:                        bert.context_length u32              = 512
0.00.012.033 I llama_model_loader: - kv   7:                      bert.embedding_length u32              = 384
...
0.00.012.037 I llama_model_loader: - kv  15:                         tokenizer.ggml.pre str              = jina-v2-en
0.00.014.462 I llama_model_loader: - kv  16:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.015.144 I llama_model_loader: - kv  20:            tokenizer.ggml.padding_token_id u32              = 0
...
0.00.015.145 I print_info: file format = GGUF V3 (latest)
0.00.015.146 I print_info: file type   = Q8_0
0.00.015.147 I print_info: file size   = 34.38 MiB (8.68 BPW) 
0.00.017.609 I load: special tokens cache size = 5
0.00.018.921 I load: token to piece cache size = 0.2032 MB
0.00.018.924 I print_info: arch             = bert
0.00.018.925 I print_info: vocab_only       = 0
0.00.018.925 I print_info: n_ctx_train      = 512
0.00.018.925 I print_info: n_embd           = 384
0.00.018.925 I print_info: n_layer          = 12
0.00.018.928 I print_info: n_head           = 12
0.00.018.929 I print_info: n_head_kv        = 12
0.00.018.931 I print_info: n_rot            = 32
0.00.018.931 I print_info: n_swa            = 0
0.00.018.931 I print_info: n_embd_head_k    = 32
0.00.018.932 I print_info: n_embd_head_v    = 32
0.00.018.932 I print_info: n_gqa            = 1
0.00.018.933 I print_info: n_embd_k_gqa     = 384
0.00.018.933 I print_info: n_embd_v_gqa     = 384
0.00.018.934 I print_info: f_norm_eps       = 1.0e-12
0.00.018.935 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.018.935 I print_info: f_clamp_kqv      = 0.0e+00
0.00.018.935 I print_info: f_max_alibi_bias = 0.0e+00
0.00.018.935 I print_info: f_logit_scale    = 0.0e+00
0.00.018.936 I print_info: n_ff             = 1536
0.00.018.936 I print_info: n_expert         = 0
0.00.018.936 I print_info: n_expert_used    = 0
0.00.018.936 I print_info: causal attn      = 0
0.00.018.936 I print_info: pooling type     = 2
0.00.018.936 I print_info: rope type        = 2
0.00.018.958 I print_info: rope scaling     = linear
0.00.018.960 I print_info: freq_base_train  = 10000.0
0.00.018.960 I print_info: freq_scale_train = 1
0.00.018.964 I print_info: n_ctx_orig_yarn  = 512
0.00.018.964 I print_info: rope_finetuned   = unknown
0.00.018.965 I print_info: ssm_d_conv       = 0
0.00.018.965 I print_info: ssm_d_inner      = 0
0.00.018.965 I print_info: ssm_d_state      = 0
0.00.018.965 I print_info: ssm_dt_rank      = 0
0.00.018.966 I print_info: ssm_dt_b_c_rms   = 0
0.00.018.966 I print_info: model type       = 33M
0.00.018.966 I print_info: model params     = 33.21 M
0.00.018.967 I print_info: general.name     = Bge Small
0.00.018.967 I print_info: vocab type       = WPM
0.00.018.967 I print_info: n_vocab          = 30522
0.00.018.968 I print_info: n_merges         = 0
0.00.018.968 I print_info: BOS token        = 101 '[CLS]'
0.00.018.968 I print_info: UNK token        = 100 '[UNK]'
0.00.018.968 I print_info: SEP token        = 102 '[SEP]'
0.00.018.968 I print_info: PAD token        = 0 '[PAD]'
0.00.018.969 I print_info: MASK token       = 103 '[MASK]'
0.00.018.969 I print_info: LF token         = 0 '[PAD]'
0.00.018.970 I print_info: max token length = 21
0.00.018.971 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.020.668 I load_tensors: offloading 12 repeating layers to GPU
0.00.020.669 I load_tensors: offloading output layer to GPU
0.00.020.669 I load_tensors: offloaded 13/13 layers to GPU
0.00.020.675 I load_tensors: Metal_Mapped model buffer size =    21.75 MiB
0.00.020.676 I load_tensors:   CPU_Mapped model buffer size =    12.63 MiB
................................................
0.00.020.841 I llama_init_from_model: n_seq_max     = 1
0.00.020.842 I llama_init_from_model: n_ctx         = 512
0.00.020.842 I llama_init_from_model: n_ctx_per_seq = 512
0.00.020.842 I llama_init_from_model: n_batch       = 2048
0.00.020.843 I llama_init_from_model: n_ubatch      = 2048
0.00.020.843 I llama_init_from_model: flash_attn    = 0
0.00.020.843 I llama_init_from_model: freq_base     = 10000.0
0.00.020.843 I llama_init_from_model: freq_scale    = 1
0.00.020.844 I ggml_metal_init: allocating
0.00.020.847 I ggml_metal_init: found device: Apple M4
0.00.020.852 I ggml_metal_init: picking default device: Apple M4
0.00.021.378 I ggml_metal_init: using embedded metal library
0.00.023.860 I ggml_metal_init: GPU name:   Apple M4
0.00.023.862 I ggml_metal_init: GPU family: MTLGPUFamilyApple9  (1009)
0.00.023.862 I ggml_metal_init: GPU family: MTLGPUFamilyCommon3 (3003)
...
0.00.034.425 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.035.032 I llama_kv_cache_init:      Metal KV buffer size =     9.00 MiB
0.00.035.034 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.035.047 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.036.093 I llama_init_from_model:      Metal compute buffer size =    16.00 MiB
0.00.036.094 I llama_init_from_model:        CPU compute buffer size =     2.51 MiB
0.00.036.094 I llama_init_from_model: graph nodes  = 429
0.00.036.094 I llama_init_from_model: graph splits = 2
0.00.036.096 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.036.096 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.040.149 I 
0.00.040.175 I system_info: n_threads = 4 (n_threads_batch = 4) / 10 | Metal : EMBED_LIBRARY = 1 | BF16 = 1 | CPU : NEON = 1 | ARM_FMA = 1 | FP16_VA = 1 | MATMUL_INT8 = 1 | DOTPROD = 1 | SME = 1 | ACCELERATE = 1 | AARCH64_REPACK = 1 | 
0.00.040.697 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.045.092 I llama_perf_context_print:        load time =      30.81 ms
0.00.045.093 I llama_perf_context_print: prompt eval time =       4.29 ms /     9 tokens (    0.48 ms per token,  2099.86 tokens per second)
0.00.045.093 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.045.094 I llama_perf_context_print:       total time =       4.94 ms /    10 tokens
0.00.045.261 I ggml_metal_free: deallocating
...
0.00.000.269 I build: 4758 (5fa07c2f) with Apple clang version 16.0.0 (clang-1600.0.26.4) for arm64-apple-darwin24.1.0
0.00.023.507 I llama_model_load_from_file_impl: using device Metal (Apple M4) - 10922 MiB free
0.00.036.402 I llama_model_loader: loaded meta data with 28 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.036.407 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.036.410 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.036.410 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.036.413 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.036.414 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.036.414 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.036.416 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.036.416 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.036.417 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.036.418 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.036.418 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.036.422 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.036.422 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.036.423 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.036.424 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.036.424 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.043.268 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.045.429 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.049.830 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.049.832 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.049.832 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.049.833 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
...
0.00.049.834 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 4
0.00.049.834 I llama_model_loader: - kv  24:            tokenizer.ggml.token_type_count u32              = 2
0.00.049.835 I llama_model_loader: - kv  25:               tokenizer.ggml.add_bos_token bool             = true
0.00.049.835 I llama_model_loader: - kv  26:               tokenizer.ggml.add_eos_token bool             = true
0.00.049.835 I llama_model_loader: - kv  27:               general.quantization_version u32              = 2
0.00.049.836 I llama_model_loader: - type  f32:   40 tensors
0.00.049.836 I llama_model_loader: - type  f16:   30 tensors
0.00.049.837 I print_info: file format = GGUF V3 (latest)
...
0.00.058.976 W load: model vocab missing newline token, using special_pad_id instead
0.00.060.409 W load: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.060.444 I load: special tokens cache size = 5
0.00.321.053 I load: token to piece cache size = 1.5060 MB
0.00.321.060 I print_info: arch             = jina-bert-v2
0.00.321.060 I print_info: vocab_only       = 0
0.00.321.061 I print_info: n_ctx_train      = 8192
0.00.321.061 I print_info: n_embd           = 384
0.00.321.061 I print_info: n_layer          = 4
0.00.321.068 I print_info: n_head           = 12
0.00.321.069 I print_info: n_head_kv        = 12
0.00.321.069 I print_info: n_rot            = 32
0.00.321.071 I print_info: n_swa            = 0
0.00.321.071 I print_info: n_embd_head_k    = 32
0.00.321.071 I print_info: n_embd_head_v    = 32
0.00.321.072 I print_info: n_gqa            = 1
0.00.321.072 I print_info: n_embd_k_gqa     = 384
0.00.321.073 I print_info: n_embd_v_gqa     = 384
0.00.321.074 I print_info: f_norm_eps       = 1.0e-12
0.00.321.074 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.321.074 I print_info: f_clamp_kqv      = 0.0e+00
0.00.321.075 I print_info: f_max_alibi_bias = 8.0e+00
0.00.321.075 I print_info: f_logit_scale    = 0.0e+00
0.00.321.076 I print_info: n_ff             = 1536
0.00.321.076 I print_info: n_expert         = 0
0.00.321.076 I print_info: n_expert_used    = 0
0.00.321.076 I print_info: causal attn      = 0
0.00.321.076 I print_info: pooling type     = -1
0.00.321.076 I print_info: rope type        = -1
0.00.321.077 I print_info: rope scaling     = linear
0.00.321.078 I print_info: freq_base_train  = 10000.0
0.00.321.078 I print_info: freq_scale_train = 1
0.00.321.078 I print_info: n_ctx_orig_yarn  = 8192
0.00.321.079 I print_info: rope_finetuned   = unknown
0.00.321.079 I print_info: ssm_d_conv       = 0
0.00.321.079 I print_info: ssm_d_inner      = 0
0.00.321.079 I print_info: ssm_d_state      = 0
0.00.321.079 I print_info: ssm_dt_rank      = 0
0.00.321.082 I print_info: ssm_dt_b_c_rms   = 0
0.00.321.082 I print_info: model type       = 33M
0.00.321.083 I print_info: model params     = 32.90 M
0.00.321.083 I print_info: general.name     = Jina Bert Implementation
0.00.321.084 I print_info: vocab type       = BPE
0.00.321.084 I print_info: n_vocab          = 61056
0.00.321.084 I print_info: n_merges         = 39382
0.00.321.084 I print_info: BOS token        = 0 '<s>'
0.00.321.084 I print_info: EOS token        = 2 '</s>'
0.00.321.084 I print_info: UNK token        = 3 '<unk>'
0.00.321.084 I print_info: SEP token        = 2 '</s>'
0.00.321.085 I print_info: PAD token        = 1 '<pad>'
0.00.321.085 I print_info: MASK token       = 4 '<mask>'
0.00.321.092 I print_info: EOG token        = 2 '</s>'
0.00.321.092 I print_info: max token length = 45
0.00.321.093 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.323.061 I load_tensors: offloading 4 repeating layers to GPU
0.00.323.062 I load_tensors: offloading output layer to GPU
0.00.323.063 I load_tensors: offloaded 5/5 layers to GPU
0.00.323.085 I load_tensors: Metal_Mapped model buffer size =    18.06 MiB
0.00.323.086 I load_tensors:   CPU_Mapped model buffer size =    44.72 MiB
....................
0.00.323.303 I llama_init_from_model: n_seq_max     = 1
0.00.323.304 I llama_init_from_model: n_ctx         = 8192
0.00.323.304 I llama_init_from_model: n_ctx_per_seq = 8192
0.00.323.305 I llama_init_from_model: n_batch       = 2048
0.00.323.305 I llama_init_from_model: n_ubatch      = 2048
0.00.323.305 I llama_init_from_model: flash_attn    = 0
0.00.323.305 I llama_init_from_model: freq_base     = 10000.0
0.00.323.306 I llama_init_from_model: freq_scale    = 1
0.00.323.306 I ggml_metal_init: allocating
0.00.323.309 I ggml_metal_init: found device: Apple M4
0.00.323.313 I ggml_metal_init: picking default device: Apple M4
0.00.324.037 I ggml_metal_init: using embedded metal library
0.00.326.891 I ggml_metal_init: GPU name:   Apple M4
0.00.326.893 I ggml_metal_init: GPU family: MTLGPUFamilyApple9  (1009)
0.00.326.893 I ggml_metal_init: GPU family: MTLGPUFamilyCommon3 (3003)
0.00.326.894 I ggml_metal_init: GPU family: MTLGPUFamilyMetal3  (5001)
0.00.326.894 I ggml_metal_init: simdgroup reduction   = true
0.00.326.895 I ggml_metal_init: simdgroup matrix mul. = true
0.00.326.895 I ggml_metal_init: has residency sets    = true
0.00.326.895 I ggml_metal_init: has bfloat            = true
0.00.326.895 I ggml_metal_init: use bfloat            = true
0.00.326.895 I ggml_metal_init: hasUnifiedMemory      = true
0.00.326.896 I ggml_metal_init: recommendedMaxWorkingSetSize  = 11453.25 MB
0.00.336.313 I llama_kv_cache_init: kv_size = 8192, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 4, can_shift = 1
0.00.339.262 I llama_kv_cache_init:      Metal KV buffer size =    48.00 MiB
0.00.339.264 I llama_init_from_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.339.284 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.345.004 I llama_init_from_model:      Metal compute buffer size =   220.01 MiB
0.00.345.005 I llama_init_from_model:        CPU compute buffer size =    22.02 MiB
0.00.345.005 I llama_init_from_model: graph nodes  = 154
0.00.345.006 I llama_init_from_model: graph splits = 2
0.00.345.007 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 8192
0.00.345.007 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.352.288 I 
0.00.352.316 I system_info: n_threads = 4 (n_threads_batch = 4) / 10 | Metal : EMBED_LIBRARY = 1 | BF16 = 1 | CPU : NEON = 1 | ARM_FMA = 1 | FP16_VA = 1 | MATMUL_INT8 = 1 | DOTPROD = 1 | SME = 1 | ACCELERATE = 1 | AARCH64_REPACK = 1 | 
0.00.352.407 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.352.408 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.352.410 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.352.411 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.352.412 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.352.413 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.352.895 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.356.591 I llama_perf_context_print:        load time =     328.77 ms
0.00.356.593 I llama_perf_context_print: prompt eval time =       3.69 ms /    62 tokens (    0.06 ms per token, 16806.72 tokens per second)
0.00.356.593 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.356.594 I llama_perf_context_print:       total time =       4.30 ms /    63 tokens
0.00.356.846 I ggml_metal_free: deallocating
