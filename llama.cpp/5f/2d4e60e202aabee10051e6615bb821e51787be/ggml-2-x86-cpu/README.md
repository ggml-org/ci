...
- status:  SUCCESS ✅
- runtime: 14:41.78
- date:    Wed Jul  3 17:48:26 UTC 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/5f2d4e60e202aabee10051e6615bb821e51787be
- author:  slaren
```
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 2/22 Test  #2: test-tokenizer-0-llama-bpe .......   Passed    1.36 sec
 ...
 8/22 Test  #8: test-tokenizer-0-refact ..........   Passed    0.35 sec
...
11/22 Test #11: test-tokenizer-1-llama-spm .......   Passed    2.60 sec
...
22/22 Test #24: test-json-schema-to-grammar ......   Passed    1.99 sec
...
main: build = 3289 (5f2d4e60)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
main: seed  = 1720028124
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.80 ms /     9 tokens (    0.42 ms per token,  2367.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
**Workplace harassment and discrimination** are serious issues that can have a devastating impact on individuals and organizations
llama_print_timings:        load time =    1358.94 ms
llama_print_timings:      sample time =      49.29 ms /    32 runs   (    1.54 ms per token,   649.26 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   23269.00 ms /    32 runs   (  727.16 ms per token,     1.38 tokens per second)
llama_print_timings:       total time =   23554.90 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
I am unable to answer this question as it requires me to make subjective judgments about the acceptability of language. [end of text]

llama_print_timings:        load time =    1350.17 ms
llama_print_timings:      sample time =      40.05 ms /    26 runs   (    1.54 ms per token,   649.27 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   18730.29 ms /    26 runs   (  720.40 ms per token,     1.39 tokens per second)
llama_print_timings:       total time =   18961.13 ms /    26 tokens
Log end
+ echo PASS
PASS
+ echo
...
I am unable to generate a response as the context provided does not contain any information regarding the capability of generating responses or the ability to create content
...
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   23200.38 ms /    32 runs   (  725.01 ms per token,     1.38 tokens per second)
llama_print_timings:       total time =   23481.76 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
I'm so tired, I just wanna curl up on the couch and binge-watch my favorite shows.

I'm craving a
llama_print_timings:        load time =    1395.30 ms
llama_print_timings:      sample time =      49.09 ms /    32 runs   (    1.53 ms per token,   651.84 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   23056.06 ms /    32 runs   (  720.50 ms per token,     1.39 tokens per second)
llama_print_timings:       total time =   23340.77 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197965.37 ms
main:    total time = 197965.37 ms
+ echo PASS
PASS
+ echo
...
I'm so tired. I just want to crawl into bed and stay there forever.

I wish I had more time.

I
llama_print_timings:        load time =     677.26 ms
llama_print_timings:      sample time =      48.89 ms /    32 runs   (    1.53 ms per token,   654.57 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   10874.69 ms /    32 runs   (  339.83 ms per token,     2.94 tokens per second)
llama_print_timings:       total time =   11154.07 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197977.45 ms
main:    total time = 197977.45 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 seconded questions in order to elicit more information from the respondent.

**Example:**

**Original question:** How are you feeling today?

**Rephra
llama_print_timings:        load time =     669.56 ms
llama_print_timings:      sample time =      49.05 ms /    32 runs   (    1.53 ms per token,   652.34 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =   10793.43 ms /    32 runs   (  337.29 ms per token,     2.96 tokens per second)
...
llama_print_timings:      sample time =       2.06 ms /    13 runs   (    0.16 ms per token,  6313.74 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =     898.46 ms /    13 runs   (   69.11 ms per token,    14.47 tokens per second)
llama_print_timings:       total time =     923.98 ms /    13 tokens
Log end
+ echo PASS
PASS
+ echo
...
I understand that the provided text contains sexually suggestive content. I am unable to provide a response that includes sexually suggestive content. [end of text]

llama_print_timings:        load time =     218.49 ms
llama_print_timings:      sample time =       4.55 ms /    29 runs   (    0.16 ms per token,  6366.63 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1907.53 ms /    29 runs   (   65.78 ms per token,    15.20 tokens per second)
llama_print_timings:       total time =    1963.89 ms /    29 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increably, but sadly, the fire spread rapidly, engulfing everything in its path.

The scene is one I am particularly invested in, but I am
llama_print_timings:        load time =     204.59 ms
llama_print_timings:      sample time =       5.19 ms /    32 runs   (    0.16 ms per token,  6163.33 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    2151.88 ms /    32 runs   (   67.25 ms per token,    14.87 tokens per second)
llama_print_timings:       total time =    2216.74 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 increasities on Twitter are getting out of hand.

**Arguments for action:**

* **Harmful effects:** These posts spread misinformation, hate speech, and conspiracy
llama_print_timings:        load time =     201.35 ms
llama_print_timings:      sample time =       4.90 ms /    32 runs   (    0.15 ms per token,  6537.28 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    2223.07 ms /    32 runs   (   69.47 ms per token,    14.39 tokens per second)
llama_print_timings:       total time =    2287.37 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32002.12 ms
main:    total time = 32002.12 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       2.68 ms /    18 runs   (    0.15 ms per token,  6718.92 tokens per second)
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =     919.02 ms /    18 runs   (   51.06 ms per token,    19.59 tokens per second)
llama_print_timings:       total time =     954.18 ms /    18 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32103.38 ms
main:    total time = 32103.38 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 8192, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 fufilling in a dimly lit tavern, his face illuminated by the flickering flames of the hearth. The tavern was filled with the murmurs of patrons, tales spun by
...
llama_print_timings: prompt eval time =       0.00 ms /     0 tokens (    -nan ms per token,     -nan tokens per second)
llama_print_timings:        eval time =    1558.90 ms /    32 runs   (   48.72 ms per token,    20.53 tokens per second)
llama_print_timings:       total time =    1620.68 ms /    32 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     296.28 ms
llama_print_timings:      sample time =       2.69 ms /    64 runs   (    0.04 ms per token, 23774.15 tokens per second)
llama_print_timings: prompt eval time =     126.82 ms /     7 tokens (   18.12 ms per token,    55.20 tokens per second)
llama_print_timings:        eval time =    3379.33 ms /    63 runs   (   53.64 ms per token,    18.64 tokens per second)
llama_print_timings:       total time =    3538.41 ms /    70 tokens
Log end
...
[1]10.1479,
llama_print_timings:        load time =     188.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1863.09 ms /   128 tokens (   14.56 ms per token,    68.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1879.06 ms /   129 tokens
...
llama_print_timings: prompt eval time =      91.80 ms /     7 tokens (   13.11 ms per token,    76.26 tokens per second)
llama_print_timings:        eval time =    2516.98 ms /    63 runs   (   39.95 ms per token,    25.03 tokens per second)
llama_print_timings:       total time =    2635.65 ms /    70 tokens
Log end
...
[1]10.1344,
llama_print_timings:        load time =     143.59 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1081.82 ms /   128 tokens (    8.45 ms per token,   118.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1098.43 ms /   129 tokens
...
llama_print_timings: prompt eval time =      76.34 ms /     7 tokens (   10.91 ms per token,    91.69 tokens per second)
llama_print_timings:        eval time =    2023.13 ms /    63 runs   (   32.11 ms per token,    31.14 tokens per second)
llama_print_timings:       total time =    2126.44 ms /    70 tokens
Log end
...
llama_print_timings: prompt eval time =     130.47 ms /     7 tokens (   18.64 ms per token,    53.65 tokens per second)
llama_print_timings:        eval time =    1967.42 ms /    63 runs   (   31.23 ms per token,    32.02 tokens per second)
llama_print_timings:       total time =    2124.73 ms /    70 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2217.58 ms /   128 tokens (   17.32 ms per token,    57.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2233.35 ms /   129 tokens
...
llama_print_timings:        eval time =    2173.83 ms /    63 runs   (   34.51 ms per token,    28.98 tokens per second)
llama_print_timings:       total time =    2339.69 ms /    70 tokens
Log end
...
[1]10.0390,
llama_print_timings:        load time =     121.97 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2334.01 ms /   128 tokens (   18.23 ms per token,    54.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2349.80 ms /   129 tokens
...
llama_print_timings: prompt eval time =     148.65 ms /     7 tokens (   21.24 ms per token,    47.09 tokens per second)
llama_print_timings:        eval time =    2281.00 ms /    63 runs   (   36.21 ms per token,    27.62 tokens per second)
llama_print_timings:       total time =    2457.08 ms /    70 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2492.32 ms /   128 tokens (   19.47 ms per token,    51.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2508.56 ms /   129 tokens
...
llama_print_timings: prompt eval time =      89.26 ms /     7 tokens (   12.75 ms per token,    78.42 tokens per second)
llama_print_timings:        eval time =    1513.63 ms /    63 runs   (   24.03 ms per token,    41.62 tokens per second)
llama_print_timings:       total time =    1629.35 ms /    70 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1523.62 ms /   128 tokens (   11.90 ms per token,    84.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1540.18 ms /   129 tokens
...
llama_print_timings: prompt eval time =      97.09 ms /     7 tokens (   13.87 ms per token,    72.10 tokens per second)
llama_print_timings:        eval time =    1716.08 ms /    63 runs   (   27.24 ms per token,    36.71 tokens per second)
llama_print_timings:       total time =    1839.68 ms /    70 tokens
Log end
...
[1]12.3055,
llama_print_timings:        load time =      96.77 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1621.16 ms /   128 tokens (   12.67 ms per token,    78.96 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1637.50 ms /   129 tokens
...
llama_print_timings: prompt eval time =     103.99 ms /     7 tokens (   14.86 ms per token,    67.31 tokens per second)
llama_print_timings:        eval time =    1892.10 ms /    63 runs   (   30.03 ms per token,    33.30 tokens per second)
llama_print_timings:       total time =    2023.58 ms /    70 tokens
Log end
...
[1]10.5104,
llama_print_timings:        load time =     108.70 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1703.87 ms /   128 tokens (   13.31 ms per token,    75.12 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1720.12 ms /   129 tokens
...
llama_print_timings: prompt eval time =     121.73 ms /     7 tokens (   17.39 ms per token,    57.51 tokens per second)
llama_print_timings:        eval time =    2125.17 ms /    63 runs   (   33.73 ms per token,    29.64 tokens per second)
llama_print_timings:       total time =    2273.76 ms /    70 tokens
Log end
...
[1]10.6295,
llama_print_timings:        load time =     129.55 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1986.39 ms /   128 tokens (   15.52 ms per token,    64.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2002.78 ms /   129 tokens
...
llama_print_timings:        eval time =    2227.20 ms /    63 runs   (   35.35 ms per token,    28.29 tokens per second)
llama_print_timings:       total time =    2368.77 ms /    70 tokens
Log end
...
[1]10.2564,
llama_print_timings:        load time =     129.13 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1806.82 ms /   128 tokens (   14.12 ms per token,    70.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1823.22 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog." Bucky laughed at that, and Dobsky,


second run: The quick brown fox jumps over the lazy dog." Bucky laughed at that, and Dobsky,


single seq run: The quick brown fox jumps over the lazy dog." Bucky laughed at that, and Dobsky,
...
first run: The quick brown fox jumps over the lazy dog.' So it began; and it left its intang


second run: The quick brown fox jumps over the lazy dog.' So it began; and it left its intang


single seq run: The quick brown fox jumps over the lazy dog.' So it began; and it left its intang
...
0.73user 0.23system 0:00.97elapsed 99%CPU (0avgtext+0avgdata 2900384maxresident)k
0inputs+40outputs (0major+61700minor)pagefaults 0swaps
```
...
0.24user 0.21system 0:00.46elapsed 99%CPU (0avgtext+0avgdata 2897536maxresident)k
