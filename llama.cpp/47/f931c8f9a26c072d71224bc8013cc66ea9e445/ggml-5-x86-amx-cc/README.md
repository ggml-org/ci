...
- status:  SUCCESS ✅
- runtime: 5:14.41
- date:    Mon Nov 25 20:00:12 UTC 2024
...
0.00.000.578 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.018.697 I llm_load_vocab: special tokens cache size = 5
0.00.021.230 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.021.258 I llm_load_print_meta: n_vocab          = 30522
0.00.021.258 I llm_load_print_meta: n_merges         = 0
0.00.021.260 I llm_load_print_meta: vocab_only       = 0
0.00.021.261 I llm_load_print_meta: n_ctx_train      = 512
...
0.00.021.278 I llm_load_print_meta: n_expert_used    = 0
0.00.021.279 I llm_load_print_meta: causal attn      = 0
0.00.021.279 I llm_load_print_meta: pooling type     = 2
...
0.00.021.284 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.284 I llm_load_print_meta: ssm_d_state      = 0
0.00.021.284 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.021.284 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.285 I llm_load_print_meta: model type       = 33M
...
0.00.021.290 I llm_load_print_meta: general.name     = Bge Small
...
0.00.025.508 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.038.728 I llama_new_context_with_model: n_seq_max     = 1
0.00.038.743 I llama_new_context_with_model: n_ctx         = 512
0.00.038.743 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.038.743 I llama_new_context_with_model: n_batch       = 2048
0.00.038.744 I llama_new_context_with_model: n_ubatch      = 2048
0.00.038.744 I llama_new_context_with_model: flash_attn    = 0
0.00.038.746 I llama_new_context_with_model: freq_base     = 10000.0
0.00.038.746 I llama_new_context_with_model: freq_scale    = 1
0.00.041.123 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.041.147 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.041.154 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.043.048 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.043.064 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.043.064 I llama_new_context_with_model: graph nodes  = 429
0.00.043.065 I llama_new_context_with_model: graph splits = 145
0.00.043.067 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.048.736 I 
0.00.048.827 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.050.657 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.057.910 I llama_perf_context_print:        load time =      48.11 ms
0.00.057.925 I llama_perf_context_print: prompt eval time =       7.01 ms /     9 tokens (    0.78 ms per token,  1283.70 tokens per second)
0.00.057.939 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.057.940 I llama_perf_context_print:       total time =       9.17 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.526 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.571 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
0.00.003.594 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.003.601 I llama_model_loader: - kv   0:                       general.architecture str              = bert
0.00.003.602 I llama_model_loader: - kv   1:                               general.type str              = model
...
0.00.003.603 I llama_model_loader: - kv   4:                         general.size_label str              = small
...
0.00.003.613 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
...
0.00.018.521 I llm_load_vocab: special tokens cache size = 5
0.00.020.993 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.020 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.021 I llm_load_print_meta: arch             = bert
0.00.021.021 I llm_load_print_meta: vocab type       = WPM
0.00.021.022 I llm_load_print_meta: n_vocab          = 30522
0.00.021.022 I llm_load_print_meta: n_merges         = 0
0.00.021.023 I llm_load_print_meta: vocab_only       = 0
0.00.021.023 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.023 I llm_load_print_meta: n_embd           = 384
0.00.021.024 I llm_load_print_meta: n_layer          = 12
0.00.021.031 I llm_load_print_meta: n_head           = 12
0.00.021.031 I llm_load_print_meta: n_head_kv        = 12
0.00.021.032 I llm_load_print_meta: n_rot            = 32
0.00.021.032 I llm_load_print_meta: n_swa            = 0
0.00.021.032 I llm_load_print_meta: n_embd_head_k    = 32
0.00.021.032 I llm_load_print_meta: n_embd_head_v    = 32
0.00.021.033 I llm_load_print_meta: n_gqa            = 1
0.00.021.034 I llm_load_print_meta: n_embd_k_gqa     = 384
...
0.00.021.042 I llm_load_print_meta: freq_base_train  = 10000.0
...
0.00.021.045 I llm_load_print_meta: model params     = 33.21 M
0.00.021.046 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.021.046 I llm_load_print_meta: general.name     = Bge Small
0.00.021.047 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.047 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.047 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.047 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.047 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.048 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.048 I llm_load_print_meta: max token length = 21
0.00.024.044 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.024.823 I llama_new_context_with_model: n_seq_max     = 1
0.00.024.838 I llama_new_context_with_model: n_ctx         = 512
0.00.024.839 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.024.839 I llama_new_context_with_model: n_batch       = 2048
0.00.024.839 I llama_new_context_with_model: n_ubatch      = 2048
0.00.024.840 I llama_new_context_with_model: flash_attn    = 0
0.00.024.841 I llama_new_context_with_model: freq_base     = 10000.0
0.00.024.842 I llama_new_context_with_model: freq_scale    = 1
0.00.027.131 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.027.154 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.027.159 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.028.422 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.028.443 I llama_new_context_with_model: graph nodes  = 429
0.00.028.443 I llama_new_context_with_model: graph splits = 1
0.00.028.445 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.031.277 I 
0.00.031.356 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.033.078 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.036.060 I llama_perf_context_print:        load time =      30.71 ms
0.00.036.061 I llama_perf_context_print: prompt eval time =       2.69 ms /     9 tokens (    0.30 ms per token,  3340.76 tokens per second)
0.00.036.063 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.036.064 I llama_perf_context_print:       total time =       4.78 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.643 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.621 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.622 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.625 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
...
0.00.008.628 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.631 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.632 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.632 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.633 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.633 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.014.651 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
...
0.00.019.615 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.616 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.616 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.617 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.617 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.617 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.618 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.618 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.619 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.619 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.622 I llama_model_loader: - type  f32:   41 tensors
0.00.019.622 I llama_model_loader: - type  f16:   29 tensors
0.00.037.680 W llm_load_vocab: empty token at index 5
0.00.047.524 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.084 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.194 I llm_load_vocab: special tokens cache size = 5
0.00.343.247 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.343.268 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.343.268 I llm_load_print_meta: arch             = jina-bert-v2
0.00.343.269 I llm_load_print_meta: vocab type       = BPE
0.00.343.270 I llm_load_print_meta: n_vocab          = 61056
0.00.343.270 I llm_load_print_meta: n_merges         = 39382
0.00.343.270 I llm_load_print_meta: vocab_only       = 0
0.00.343.271 I llm_load_print_meta: n_ctx_train      = 8192
...
0.00.343.284 I llm_load_print_meta: n_embd_v_gqa     = 384
...
0.00.343.289 I llm_load_print_meta: n_expert_used    = 0
0.00.343.289 I llm_load_print_meta: causal attn      = 0
0.00.343.290 I llm_load_print_meta: pooling type     = -1
0.00.343.290 I llm_load_print_meta: rope type        = -1
0.00.343.290 I llm_load_print_meta: rope scaling     = linear
0.00.343.291 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.343.292 I llm_load_print_meta: freq_scale_train = 1
0.00.343.292 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.343.293 I llm_load_print_meta: rope_finetuned   = unknown
0.00.343.293 I llm_load_print_meta: ssm_d_conv       = 0
0.00.343.293 I llm_load_print_meta: ssm_d_inner      = 0
0.00.343.293 I llm_load_print_meta: ssm_d_state      = 0
0.00.343.294 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.343.294 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.343.294 I llm_load_print_meta: model type       = 33M
0.00.343.295 I llm_load_print_meta: model ftype      = F16
0.00.343.296 I llm_load_print_meta: model params     = 32.90 M
0.00.343.297 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.343.297 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.343.298 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.343.298 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.343.298 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.343.299 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.343.299 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.343.299 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.343.300 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.343.300 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.343.300 I llm_load_print_meta: max token length = 45
0.00.346.596 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.346.614 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.354.342 I llama_new_context_with_model: n_seq_max     = 1
0.00.354.363 I llama_new_context_with_model: n_ctx         = 8192
0.00.354.363 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.354.364 I llama_new_context_with_model: n_batch       = 2048
0.00.354.364 I llama_new_context_with_model: n_ubatch      = 2048
0.00.354.364 I llama_new_context_with_model: flash_attn    = 0
0.00.354.366 I llama_new_context_with_model: freq_base     = 10000.0
0.00.354.367 I llama_new_context_with_model: freq_scale    = 1
0.00.363.180 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.363.206 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.363.212 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.365.099 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.365.122 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.365.122 I llama_new_context_with_model: graph nodes  = 154
0.00.365.123 I llama_new_context_with_model: graph splits = 57
0.00.365.125 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.374.695 I 
0.00.374.778 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.374.981 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.374.994 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.374.999 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.375.000 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.004 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.375.005 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.394.277 I llama_perf_context_print:        load time =     374.01 ms
0.00.394.279 I llama_perf_context_print: prompt eval time =      15.14 ms /    62 tokens (    0.24 ms per token,  4095.65 tokens per second)
0.00.394.280 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.394.281 I llama_perf_context_print:       total time =      19.58 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.868 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.079.281 I llm_load_print_meta: vocab type       = BPE
...
0.00.079.296 I llm_load_print_meta: n_head_kv        = 16
0.00.079.296 I llm_load_print_meta: n_rot            = 32
0.00.079.297 I llm_load_print_meta: n_swa            = 0
0.00.079.297 I llm_load_print_meta: n_embd_head_k    = 128
0.00.079.297 I llm_load_print_meta: n_embd_head_v    = 128
0.00.079.298 I llm_load_print_meta: n_gqa            = 1
0.00.079.299 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.079.300 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.079.301 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.079.302 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.079.302 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.079.303 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.079.303 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.079.304 I llm_load_print_meta: n_ff             = 8192
0.00.079.304 I llm_load_print_meta: n_expert         = 0
0.00.079.305 I llm_load_print_meta: n_expert_used    = 0
0.00.079.305 I llm_load_print_meta: causal attn      = 1
0.00.079.306 I llm_load_print_meta: pooling type     = 0
0.00.079.306 I llm_load_print_meta: rope type        = 2
0.00.079.307 I llm_load_print_meta: rope scaling     = linear
0.00.079.308 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.079.309 I llm_load_print_meta: freq_scale_train = 1
0.00.079.309 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.079.309 I llm_load_print_meta: rope_finetuned   = unknown
0.00.079.310 I llm_load_print_meta: ssm_d_conv       = 0
0.00.079.310 I llm_load_print_meta: ssm_d_inner      = 0
0.00.079.311 I llm_load_print_meta: ssm_d_state      = 0
0.00.079.311 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.079.311 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.079.312 I llm_load_print_meta: model type       = 1.4B
0.00.079.313 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.079.314 I llm_load_print_meta: model params     = 1.41 B
0.00.079.315 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.247.703 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.247.723 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.104.125 I llama_new_context_with_model: n_seq_max     = 1
0.01.104.146 I llama_new_context_with_model: n_ctx         = 2048
0.01.104.147 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.01.104.147 I llama_new_context_with_model: n_batch       = 2048
0.01.104.148 I llama_new_context_with_model: n_ubatch      = 512
0.01.104.149 I llama_new_context_with_model: flash_attn    = 0
0.01.104.153 I llama_new_context_with_model: freq_base     = 10000.0
0.01.104.154 I llama_new_context_with_model: freq_scale    = 1
0.01.180.090 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.180.123 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.180.153 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.183.482 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.183.506 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.183.507 I llama_new_context_with_model: graph nodes  = 967
0.01.183.507 I llama_new_context_with_model: graph splits = 194
0.01.183.512 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.447.916 I main: llama threadpool init, n_threads = 4
0.01.447.947 I 
0.01.448.034 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.448.047 I 
0.01.448.201 I sampler seed: 1234
0.01.448.221 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.448.224 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.448.225 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.448.225 I 
...
0.15.535.426 I llama_perf_sampler_print:    sampling time =       2.35 ms /    71 runs   (    0.03 ms per token, 30277.19 tokens per second)
0.15.535.429 I llama_perf_context_print:        load time =    1446.76 ms
0.15.535.430 I llama_perf_context_print: prompt eval time =     433.13 ms /     7 tokens (   61.88 ms per token,    16.16 tokens per second)
0.15.535.431 I llama_perf_context_print:        eval time =   13642.47 ms /    63 runs   (  216.55 ms per token,     4.62 tokens per second)
0.15.535.432 I llama_perf_context_print:       total time =   14087.52 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.334 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.001 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.020.712 I llama_model_loader: - type  f16:   98 tensors
...
0.00.075.561 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.562 I llm_load_print_meta: model params     = 1.41 B
0.00.075.563 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.200.571 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.200.590 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.992.809 I llama_new_context_with_model: n_seq_max     = 1
0.00.992.832 I llama_new_context_with_model: n_ctx         = 128
0.00.992.832 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.992.832 I llama_new_context_with_model: n_batch       = 128
0.00.992.833 I llama_new_context_with_model: n_ubatch      = 128
0.00.992.833 I llama_new_context_with_model: flash_attn    = 0
0.00.992.838 I llama_new_context_with_model: freq_base     = 10000.0
0.00.992.839 I llama_new_context_with_model: freq_scale    = 1
0.00.992.840 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.997.599 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.997.627 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.997.650 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.000.164 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.01.000.189 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.01.000.189 I llama_new_context_with_model: graph nodes  = 967
0.01.000.190 I llama_new_context_with_model: graph splits = 194
0.01.000.192 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.227.988 I 
0.01.228.099 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.228.119 I perplexity: tokenizing the input ..
0.01.237.577 I perplexity: tokenization took 9.455 ms
0.01.237.615 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.04.805.909 I perplexity: 3.57 seconds per pass - ETA 0.05 minutes
[1]10.1479,
0.04.810.681 I Final estimate: PPL = 10.1479 +/- 3.22609

0.04.810.745 I llama_perf_context_print:        load time =    1227.62 ms
0.04.810.758 I llama_perf_context_print: prompt eval time =    3566.46 ms /   128 tokens (   27.86 ms per token,    35.89 tokens per second)
0.04.810.760 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.04.810.761 I llama_perf_context_print:       total time =    3582.76 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.267 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.540 I main: llama backend init
0.00.000.557 I main: load the model and apply lora adapter, if any
0.00.009.207 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.075.633 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.634 I llm_load_print_meta: model params     = 1.41 B
0.00.075.635 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.165.022 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.167.132 I llama_new_context_with_model: n_seq_max     = 1
0.00.167.154 I llama_new_context_with_model: n_ctx         = 2048
0.00.167.154 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.167.155 I llama_new_context_with_model: n_batch       = 2048
0.00.167.155 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.237.134 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.237.152 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.239.791 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.239.815 I llama_new_context_with_model: graph nodes  = 967
0.00.239.816 I llama_new_context_with_model: graph splits = 1
0.00.239.821 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.339.275 I main: llama threadpool init, n_threads = 4
0.00.339.299 I 
0.00.339.367 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.339.381 I 
0.00.339.492 I sampler seed: 1234
...
0.00.339.514 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.339.515 I 
...
0.03.129.705 I llama_perf_sampler_print:    sampling time =       2.39 ms /    71 runs   (    0.03 ms per token, 29731.99 tokens per second)
0.03.129.708 I llama_perf_context_print:        load time =     338.70 ms
0.03.129.709 I llama_perf_context_print: prompt eval time =     123.62 ms /     7 tokens (   17.66 ms per token,    56.63 tokens per second)
0.03.129.710 I llama_perf_context_print:        eval time =    2654.89 ms /    63 runs   (   42.14 ms per token,    23.73 tokens per second)
0.03.129.711 I llama_perf_context_print:       total time =    2790.44 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.673 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.166.244 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.361 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.383 I llama_new_context_with_model: n_ctx         = 128
0.00.168.383 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.168.383 I llama_new_context_with_model: n_batch       = 128
0.00.168.384 I llama_new_context_with_model: n_ubatch      = 128
0.00.168.384 I llama_new_context_with_model: flash_attn    = 0
0.00.168.386 I llama_new_context_with_model: freq_base     = 10000.0
0.00.168.387 I llama_new_context_with_model: freq_scale    = 1
0.00.168.388 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.173.043 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
...
0.00.175.648 I llama_new_context_with_model: graph nodes  = 967
0.00.175.649 I llama_new_context_with_model: graph splits = 1
0.00.175.651 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.241.911 I 
0.00.241.998 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.242.004 I perplexity: tokenizing the input ..
0.00.250.463 I perplexity: tokenization took 8.455 ms
0.00.250.492 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.144.573 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.148.363 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.148.402 I llama_perf_context_print:        load time =     241.20 ms
0.01.148.405 I llama_perf_context_print: prompt eval time =     892.49 ms /   128 tokens (    6.97 ms per token,   143.42 tokens per second)
0.01.148.417 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.148.418 I llama_perf_context_print:       total time =     906.49 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.667 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.496 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
...
0.00.075.798 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.710 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
0.00.125.729 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
...............................................................................
0.00.363.318 I llama_new_context_with_model: n_seq_max     = 1
0.00.363.338 I llama_new_context_with_model: n_ctx         = 2048
0.00.363.338 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.363.339 I llama_new_context_with_model: n_batch       = 2048
0.00.363.339 I llama_new_context_with_model: n_ubatch      = 512
0.00.363.340 I llama_new_context_with_model: flash_attn    = 0
0.00.363.343 I llama_new_context_with_model: freq_base     = 10000.0
0.00.363.344 I llama_new_context_with_model: freq_scale    = 1
0.00.431.824 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.431.854 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.431.886 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.435.016 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.435.033 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.435.034 I llama_new_context_with_model: graph nodes  = 967
0.00.435.034 I llama_new_context_with_model: graph splits = 193
0.00.435.039 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.590.748 I main: llama threadpool init, n_threads = 4
0.00.590.781 I 
0.00.590.912 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.590.926 I 
0.00.591.076 I sampler seed: 1234
0.00.591.097 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.591.101 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.591.101 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.591.101 I 
I believe the meaning of life is to know and experience things. I think that is the only way we can truly know ourselves. I don't see any other way to truly know ourselves.

It's the same thing with our society. Our society is becoming a self-centered society, where we don't care about others. We are becoming so

0.04.755.873 I llama_perf_sampler_print:    sampling time =       2.70 ms /    71 runs   (    0.04 ms per token, 26267.11 tokens per second)
0.04.755.877 I llama_perf_context_print:        load time =     589.83 ms
0.04.755.879 I llama_perf_context_print: prompt eval time =     132.71 ms /     7 tokens (   18.96 ms per token,    52.75 tokens per second)
0.04.755.882 I llama_perf_context_print:        eval time =    4020.06 ms /    63 runs   (   63.81 ms per token,    15.67 tokens per second)
0.04.755.883 I llama_perf_context_print:       total time =    4165.13 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.700 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.537 I llm_load_print_meta: n_head           = 16
...
0.00.124.741 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
0.00.124.759 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
...............................................................................
0.00.361.775 I llama_new_context_with_model: n_seq_max     = 1
0.00.361.797 I llama_new_context_with_model: n_ctx         = 128
0.00.361.798 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.361.798 I llama_new_context_with_model: n_batch       = 128
0.00.361.798 I llama_new_context_with_model: n_ubatch      = 128
0.00.361.799 I llama_new_context_with_model: flash_attn    = 0
0.00.361.803 I llama_new_context_with_model: freq_base     = 10000.0
0.00.361.804 I llama_new_context_with_model: freq_scale    = 1
0.00.361.805 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.366.871 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.366.895 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.366.919 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.369.497 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.369.522 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.369.522 I llama_new_context_with_model: graph nodes  = 967
0.00.369.523 I llama_new_context_with_model: graph splits = 193
0.00.369.525 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.487.810 I 
0.00.487.931 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.487.953 I perplexity: tokenizing the input ..
0.00.497.418 I perplexity: tokenization took 9.461 ms
0.00.497.457 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.103.975 I perplexity: 1.61 seconds per pass - ETA 0.02 minutes
[1]14.0286,
0.02.161.825 I Final estimate: PPL = 14.0286 +/- 4.40641

0.02.161.903 I llama_perf_context_print:        load time =     487.07 ms
0.02.161.905 I llama_perf_context_print: prompt eval time =    1604.66 ms /   128 tokens (   12.54 ms per token,    79.77 tokens per second)
0.02.161.907 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.161.909 I llama_perf_context_print:       total time =    1674.09 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.655 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.158 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.158 I llm_load_print_meta: model params     = 1.41 B
0.00.075.160 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.128.941 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
0.00.128.957 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
................................................................................
0.00.390.691 I llama_new_context_with_model: n_seq_max     = 1
0.00.390.711 I llama_new_context_with_model: n_ctx         = 2048
0.00.390.711 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.390.712 I llama_new_context_with_model: n_batch       = 2048
0.00.390.712 I llama_new_context_with_model: n_ubatch      = 512
0.00.390.713 I llama_new_context_with_model: flash_attn    = 0
0.00.390.717 I llama_new_context_with_model: freq_base     = 10000.0
0.00.390.718 I llama_new_context_with_model: freq_scale    = 1
0.00.458.811 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.458.843 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.458.876 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.461.575 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.461.597 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.461.598 I llama_new_context_with_model: graph nodes  = 967
0.00.461.598 I llama_new_context_with_model: graph splits = 193
0.00.461.603 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.611.022 I main: llama threadpool init, n_threads = 4
0.00.611.055 I 
0.00.611.147 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.611.162 I 
0.00.611.336 I sampler seed: 1234
0.00.611.357 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.611.361 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.611.361 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.611.361 I 
...
0.05.129.280 I llama_perf_sampler_print:    sampling time =       2.57 ms /    71 runs   (    0.04 ms per token, 27583.53 tokens per second)
0.05.129.284 I llama_perf_context_print:        load time =     610.10 ms
0.05.129.286 I llama_perf_context_print: prompt eval time =     134.89 ms /     7 tokens (   19.27 ms per token,    51.89 tokens per second)
0.05.129.289 I llama_perf_context_print:        eval time =    4371.75 ms /    63 runs   (   69.39 ms per token,    14.41 tokens per second)
0.05.129.290 I llama_perf_context_print:       total time =    4518.26 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.342 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.151 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.075.652 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.652 I llm_load_print_meta: model params     = 1.41 B
0.00.075.653 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.742 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
0.00.130.758 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
................................................................................
0.00.395.038 I llama_new_context_with_model: n_seq_max     = 1
0.00.395.060 I llama_new_context_with_model: n_ctx         = 128
0.00.395.061 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.395.061 I llama_new_context_with_model: n_batch       = 128
0.00.395.061 I llama_new_context_with_model: n_ubatch      = 128
0.00.395.062 I llama_new_context_with_model: flash_attn    = 0
0.00.395.066 I llama_new_context_with_model: freq_base     = 10000.0
0.00.395.067 I llama_new_context_with_model: freq_scale    = 1
0.00.395.068 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.400.031 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.400.059 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.400.084 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.402.686 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.402.710 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.402.711 I llama_new_context_with_model: graph nodes  = 967
0.00.402.711 I llama_new_context_with_model: graph splits = 193
0.00.402.713 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.515.634 I 
0.00.515.768 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.515.803 I perplexity: tokenizing the input ..
0.00.525.324 I perplexity: tokenization took 9.517 ms
0.00.525.360 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.172.412 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]12.6335,
0.02.230.129 I Final estimate: PPL = 12.6335 +/- 3.89535

0.02.230.211 I llama_perf_context_print:        load time =     515.24 ms
0.02.230.214 I llama_perf_context_print: prompt eval time =    1645.19 ms /   128 tokens (   12.85 ms per token,    77.80 tokens per second)
0.02.230.216 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.230.217 I llama_perf_context_print:       total time =    1714.58 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.280 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.522 I main: llama backend init
0.00.000.539 I main: load the model and apply lora adapter, if any
0.00.009.417 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.076.239 I llm_load_print_meta: model ftype      = Q5_0
0.00.076.240 I llm_load_print_meta: model params     = 1.41 B
0.00.076.241 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.136.776 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.139.070 I llama_new_context_with_model: n_seq_max     = 1
0.00.139.086 I llama_new_context_with_model: n_ctx         = 2048
0.00.139.087 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.139.087 I llama_new_context_with_model: n_batch       = 2048
0.00.139.088 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.206.325 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.206.348 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.208.607 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.208.625 I llama_new_context_with_model: graph nodes  = 967
0.00.208.625 I llama_new_context_with_model: graph splits = 1
0.00.208.629 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.317.381 I main: llama threadpool init, n_threads = 4
0.00.317.411 I 
0.00.317.490 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.317.505 I 
0.00.317.655 I sampler seed: 1234
0.00.317.674 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.317.677 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.641.152 I llama_perf_sampler_print:    sampling time =       2.74 ms /    71 runs   (    0.04 ms per token, 25902.96 tokens per second)
0.02.641.155 I llama_perf_context_print:        load time =     316.82 ms
0.02.641.157 I llama_perf_context_print: prompt eval time =     125.92 ms /     7 tokens (   17.99 ms per token,    55.59 tokens per second)
0.02.641.159 I llama_perf_context_print:        eval time =    2185.51 ms /    63 runs   (   34.69 ms per token,    28.83 tokens per second)
0.02.641.160 I llama_perf_context_print:       total time =    2323.78 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.326 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.083 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.075.669 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.137.643 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.142.332 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.142.358 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.142.372 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.144.493 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.144.512 I llama_new_context_with_model: graph nodes  = 967
0.00.144.512 I llama_new_context_with_model: graph splits = 1
0.00.144.514 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.190.243 I 
0.00.190.338 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.190.344 I perplexity: tokenizing the input ..
0.00.198.721 I perplexity: tokenization took 8.374 ms
0.00.198.753 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.330.048 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.387.877 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.387.917 I llama_perf_context_print:        load time =     189.88 ms
0.01.387.919 I llama_perf_context_print: prompt eval time =    1129.58 ms /   128 tokens (    8.82 ms per token,   113.32 tokens per second)
0.01.387.921 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.387.921 I llama_perf_context_print:       total time =    1197.67 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.656 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.269 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.137.602 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.139.750 I llama_new_context_with_model: n_seq_max     = 1
0.00.139.771 I llama_new_context_with_model: n_ctx         = 2048
0.00.139.771 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.139.771 I llama_new_context_with_model: n_batch       = 2048
0.00.139.772 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.207.833 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.207.861 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.207.880 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.209.967 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.209.989 I llama_new_context_with_model: graph nodes  = 967
0.00.209.990 I llama_new_context_with_model: graph splits = 1
0.00.209.994 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.310.792 I main: llama threadpool init, n_threads = 4
0.00.310.825 I 
0.00.310.964 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.310.980 I 
0.00.311.104 I sampler seed: 1234
0.00.311.123 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.311.126 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.311.127 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.311.127 I 
...
0.02.749.827 I llama_perf_sampler_print:    sampling time =       2.72 ms /    71 runs   (    0.04 ms per token, 26141.38 tokens per second)
0.02.749.830 I llama_perf_context_print:        load time =     309.87 ms
0.02.749.832 I llama_perf_context_print: prompt eval time =     122.23 ms /     7 tokens (   17.46 ms per token,    57.27 tokens per second)
0.02.749.833 I llama_perf_context_print:        eval time =    2304.94 ms /    63 runs   (   36.59 ms per token,    27.33 tokens per second)
0.02.749.834 I llama_perf_context_print:       total time =    2439.04 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.672 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.827 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.138.138 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.140.410 I llama_new_context_with_model: n_seq_max     = 1
0.00.140.432 I llama_new_context_with_model: n_ctx         = 128
0.00.140.433 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.140.433 I llama_new_context_with_model: n_batch       = 128
0.00.140.433 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.145.117 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.145.142 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.145.158 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.147.788 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.147.805 I llama_new_context_with_model: graph nodes  = 967
0.00.147.805 I llama_new_context_with_model: graph splits = 1
0.00.147.807 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.207.059 I 
0.00.207.162 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.207.169 I perplexity: tokenizing the input ..
0.00.215.826 I perplexity: tokenization took 8.653 ms
0.00.215.856 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.159.378 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.217.226 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.217.272 I llama_perf_context_print:        load time =     206.34 ms
0.02.217.290 I llama_perf_context_print: prompt eval time =    1941.81 ms /   128 tokens (   15.17 ms per token,    65.92 tokens per second)
0.02.217.292 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.217.293 I llama_perf_context_print:       total time =    2010.21 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.278 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.474 I main: llama backend init
0.00.000.491 I main: load the model and apply lora adapter, if any
0.00.009.034 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.020.537 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.540 I llama_model_loader: - type  f32:  194 tensors
0.00.020.540 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.541 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.109.715 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.111.821 I llama_new_context_with_model: n_seq_max     = 1
0.00.111.843 I llama_new_context_with_model: n_ctx         = 2048
0.00.111.843 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.111.843 I llama_new_context_with_model: n_batch       = 2048
0.00.111.844 I llama_new_context_with_model: n_ubatch      = 512
0.00.111.844 I llama_new_context_with_model: flash_attn    = 0
0.00.111.845 I llama_new_context_with_model: freq_base     = 10000.0
0.00.111.846 I llama_new_context_with_model: freq_scale    = 1
0.00.179.388 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
...
0.00.181.650 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.256.317 I main: llama threadpool init, n_threads = 4
0.00.256.349 I 
0.00.256.438 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.256.451 I 
0.00.256.586 I sampler seed: 1234
...
0.01.751.016 I llama_perf_sampler_print:    sampling time =       2.37 ms /    71 runs   (    0.03 ms per token, 30008.45 tokens per second)
0.01.751.020 I llama_perf_context_print:        load time =     255.81 ms
0.01.751.022 I llama_perf_context_print: prompt eval time =      81.23 ms /     7 tokens (   11.60 ms per token,    86.18 tokens per second)
0.01.751.024 I llama_perf_context_print:        eval time =    1401.77 ms /    63 runs   (   22.25 ms per token,    44.94 tokens per second)
0.01.751.024 I llama_perf_context_print:       total time =    1494.71 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.705 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.218 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.218 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.111.770 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.113.861 I llama_new_context_with_model: n_seq_max     = 1
0.00.113.883 I llama_new_context_with_model: n_ctx         = 128
0.00.113.884 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.113.884 I llama_new_context_with_model: n_batch       = 128
0.00.113.884 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.113.887 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.118.497 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.118.518 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.118.532 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.121.067 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.121.085 I llama_new_context_with_model: graph nodes  = 967
0.00.121.085 I llama_new_context_with_model: graph splits = 1
0.00.121.087 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.162.052 I 
0.00.162.169 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.162.193 I perplexity: tokenizing the input ..
0.00.170.940 I perplexity: tokenization took 8.743 ms
0.00.170.974 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.466.803 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.524.725 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.524.772 I llama_perf_context_print:        load time =     161.31 ms
0.01.524.776 I llama_perf_context_print: prompt eval time =    1294.14 ms /   128 tokens (   10.11 ms per token,    98.91 tokens per second)
0.01.524.778 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.524.779 I llama_perf_context_print:       total time =    1362.72 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.649 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.332 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.076.333 I llm_load_print_meta: model params     = 1.41 B
0.00.076.334 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.120.031 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.122.224 I llama_new_context_with_model: n_seq_max     = 1
0.00.122.245 I llama_new_context_with_model: n_ctx         = 2048
0.00.122.246 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.122.246 I llama_new_context_with_model: n_batch       = 2048
0.00.122.246 I llama_new_context_with_model: n_ubatch      = 512
0.00.122.247 I llama_new_context_with_model: flash_attn    = 0
0.00.122.248 I llama_new_context_with_model: freq_base     = 10000.0
0.00.122.249 I llama_new_context_with_model: freq_scale    = 1
0.00.190.226 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.190.255 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.190.277 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.192.477 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.192.499 I llama_new_context_with_model: graph nodes  = 967
0.00.192.499 I llama_new_context_with_model: graph splits = 1
0.00.192.504 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.273.449 I main: llama threadpool init, n_threads = 4
0.00.273.480 I 
0.00.273.563 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.273.577 I 
0.00.273.704 I sampler seed: 1234
0.00.273.724 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.273.728 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.273.729 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.273.729 I 
...
0.02.088.516 I llama_perf_sampler_print:    sampling time =       2.58 ms /    71 runs   (    0.04 ms per token, 27530.05 tokens per second)
0.02.088.519 I llama_perf_context_print:        load time =     272.53 ms
0.02.088.521 I llama_perf_context_print: prompt eval time =      88.23 ms /     7 tokens (   12.60 ms per token,    79.34 tokens per second)
0.02.088.523 I llama_perf_context_print:        eval time =    1714.93 ms /    63 runs   (   27.22 ms per token,    36.74 tokens per second)
0.02.088.524 I llama_perf_context_print:       total time =    1815.07 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.686 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.805 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.075.797 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.798 I llm_load_print_meta: model params     = 1.41 B
0.00.075.799 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
0.00.075.799 I llm_load_print_meta: general.name     = 1.4B
0.00.075.799 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
...
0.00.075.801 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.075.801 I llm_load_print_meta: max token length = 1024
0.00.118.685 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.120.801 I llama_new_context_with_model: n_seq_max     = 1
0.00.120.822 I llama_new_context_with_model: n_ctx         = 128
0.00.120.822 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.120.823 I llama_new_context_with_model: n_batch       = 128
0.00.120.823 I llama_new_context_with_model: n_ubatch      = 128
0.00.120.824 I llama_new_context_with_model: flash_attn    = 0
0.00.120.825 I llama_new_context_with_model: freq_base     = 10000.0
0.00.120.826 I llama_new_context_with_model: freq_scale    = 1
0.00.120.827 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.125.424 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.125.449 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.125.464 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.128.079 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.128.100 I llama_new_context_with_model: graph nodes  = 967
0.00.128.100 I llama_new_context_with_model: graph splits = 1
0.00.128.103 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.173.172 I 
0.00.173.271 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.173.278 I perplexity: tokenizing the input ..
0.00.181.864 I perplexity: tokenization took 8.582 ms
0.00.181.943 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.523.836 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.5352,
0.01.581.840 I Final estimate: PPL = 12.5352 +/- 4.09556

0.01.581.882 I llama_perf_context_print:        load time =     172.45 ms
0.01.581.884 I llama_perf_context_print: prompt eval time =    1340.09 ms /   128 tokens (   10.47 ms per token,    95.52 tokens per second)
0.01.581.886 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.581.887 I llama_perf_context_print:       total time =    1408.71 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.293 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.930 I llama_model_loader: - kv   3:                           general.finetune str              = 1.4B
0.00.008.930 I llama_model_loader: - kv   4:                         general.size_label str              = 1.4B
...
0.00.020.455 I llama_model_loader: - type q5_K:   24 tensors
...
0.00.074.743 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.074.744 I llm_load_print_meta: model params     = 1.41 B
0.00.074.745 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.124.089 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.126.316 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.337 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.338 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.338 I llama_new_context_with_model: n_batch       = 2048
0.00.126.338 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.339 I llama_new_context_with_model: flash_attn    = 0
0.00.126.340 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.341 I llama_new_context_with_model: freq_scale    = 1
0.00.195.180 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.213 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.238 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.514 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.531 I llama_new_context_with_model: graph nodes  = 967
0.00.197.532 I llama_new_context_with_model: graph splits = 1
0.00.197.536 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.282.547 I main: llama threadpool init, n_threads = 4
0.00.282.577 I 
0.00.282.668 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.282.682 I 
0.00.282.811 I sampler seed: 1234
0.00.282.831 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.282.834 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.282.835 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.282.835 I 
I believe the meaning of life is that it's up to us to make it."

"I agree with that," said I. "But the Bible isn't the only place we get our meaning of life, and it certainly isn't the only place that's more important than all others. The meaning of life isn't in the stars, the

0.02.344.035 I llama_perf_sampler_print:    sampling time =       2.69 ms /    71 runs   (    0.04 ms per token, 26364.65 tokens per second)
0.02.344.038 I llama_perf_context_print:        load time =     282.01 ms
0.02.344.040 I llama_perf_context_print: prompt eval time =      93.40 ms /     7 tokens (   13.34 ms per token,    74.94 tokens per second)
0.02.344.042 I llama_perf_context_print:        eval time =    1956.11 ms /    63 runs   (   31.05 ms per token,    32.21 tokens per second)
0.02.344.043 I llama_perf_context_print:       total time =    2061.49 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.669 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.579 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.580 I llm_load_print_meta: model params     = 1.41 B
0.00.075.581 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.125.759 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.127.925 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.947 I llama_new_context_with_model: n_ctx         = 128
0.00.127.947 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.127.948 I llama_new_context_with_model: n_batch       = 128
0.00.127.948 I llama_new_context_with_model: n_ubatch      = 128
0.00.127.948 I llama_new_context_with_model: flash_attn    = 0
0.00.127.950 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.951 I llama_new_context_with_model: freq_scale    = 1
0.00.127.952 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.132.616 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.132.642 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.132.656 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.134.825 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.134.853 I llama_new_context_with_model: graph nodes  = 967
0.00.134.853 I llama_new_context_with_model: graph splits = 1
0.00.134.856 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.182.343 I 
0.00.182.453 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.182.473 I perplexity: tokenizing the input ..
0.00.191.292 I perplexity: tokenization took 8.816 ms
0.00.191.323 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.600.593 I perplexity: 1.41 seconds per pass - ETA 0.02 minutes
[1]10.3212,
0.01.658.610 I Final estimate: PPL = 10.3212 +/- 3.25897

0.01.658.665 I llama_perf_context_print:        load time =     181.63 ms
0.01.658.680 I llama_perf_context_print: prompt eval time =    1407.50 ms /   128 tokens (   11.00 ms per token,    90.94 tokens per second)
0.01.658.682 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.658.683 I llama_perf_context_print:       total time =    1476.31 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.274 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.129.531 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.131.672 I llama_new_context_with_model: n_seq_max     = 1
0.00.131.694 I llama_new_context_with_model: n_ctx         = 2048
0.00.131.694 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.131.694 I llama_new_context_with_model: n_batch       = 2048
0.00.131.695 I llama_new_context_with_model: n_ubatch      = 512
0.00.131.695 I llama_new_context_with_model: flash_attn    = 0
0.00.131.697 I llama_new_context_with_model: freq_base     = 10000.0
0.00.131.697 I llama_new_context_with_model: freq_scale    = 1
0.00.199.826 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.199.855 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.199.872 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.201.962 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.201.980 I llama_new_context_with_model: graph nodes  = 967
0.00.201.981 I llama_new_context_with_model: graph splits = 1
0.00.201.985 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.294.000 I main: llama threadpool init, n_threads = 4
0.00.294.032 I 
0.00.294.117 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.294.131 I 
0.00.294.256 I sampler seed: 1234
0.00.294.276 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.294.279 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.294.279 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.294.280 I 
I believe the meaning of life is to die in one’s sleep. I believe that the only way to be happy is to be happy.
I believe that there is no point in living if there is no meaning in life. I believe that the reason we humans live our lives is to enjoy them.
I believe that life is not a matter

0.02.713.469 I llama_perf_sampler_print:    sampling time =       2.68 ms /    71 runs   (    0.04 ms per token, 26522.23 tokens per second)
0.02.713.472 I llama_perf_context_print:        load time =     293.48 ms
0.02.713.474 I llama_perf_context_print: prompt eval time =     112.26 ms /     7 tokens (   16.04 ms per token,    62.35 tokens per second)
0.02.713.476 I llama_perf_context_print:        eval time =    2295.00 ms /    63 runs   (   36.43 ms per token,    27.45 tokens per second)
0.02.713.477 I llama_perf_context_print:       total time =    2419.47 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.665 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.302 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf (version GGUF V3 (latest))
...
0.00.130.060 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.132.208 I llama_new_context_with_model: n_seq_max     = 1
0.00.132.229 I llama_new_context_with_model: n_ctx         = 128
0.00.132.229 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.132.230 I llama_new_context_with_model: n_batch       = 128
0.00.132.230 I llama_new_context_with_model: n_ubatch      = 128
0.00.132.230 I llama_new_context_with_model: flash_attn    = 0
0.00.132.232 I llama_new_context_with_model: freq_base     = 10000.0
0.00.132.233 I llama_new_context_with_model: freq_scale    = 1
0.00.132.234 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.136.896 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.136.921 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.136.937 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.139.470 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.139.489 I llama_new_context_with_model: graph nodes  = 967
...
0.00.194.654 I 
0.00.194.760 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.194.767 I perplexity: tokenizing the input ..
0.00.203.698 I perplexity: tokenization took 8.927 ms
0.00.203.730 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.897.846 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.7557,
0.01.955.747 I Final estimate: PPL = 10.7557 +/- 3.44724

0.01.955.787 I llama_perf_context_print:        load time =     193.94 ms
0.01.955.789 I llama_perf_context_print: prompt eval time =    1692.35 ms /   128 tokens (   13.22 ms per token,    75.63 tokens per second)
0.01.955.791 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.955.791 I llama_perf_context_print:       total time =    1761.13 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.648 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.341 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.133.151 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.135.421 I llama_new_context_with_model: n_seq_max     = 1
0.00.135.437 I llama_new_context_with_model: n_ctx         = 2048
0.00.135.437 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.135.438 I llama_new_context_with_model: n_batch       = 2048
0.00.135.438 I llama_new_context_with_model: n_ubatch      = 512
0.00.135.439 I llama_new_context_with_model: flash_attn    = 0
0.00.135.441 I llama_new_context_with_model: freq_base     = 10000.0
0.00.135.442 I llama_new_context_with_model: freq_scale    = 1
0.00.203.269 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.203.299 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.203.374 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.205.541 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.205.565 I llama_new_context_with_model: graph nodes  = 967
...
0.00.297.375 I 
0.00.297.488 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.297.501 I 
0.00.297.645 I sampler seed: 1234
0.00.297.667 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.297.671 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.297.672 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.297.673 I 
I believe the meaning of life is to do good works in the world." "I believe that if I had to do it all over again, I wouldn't change a thing." "I know I wouldn't." "If I could do it all over again, I wouldn't have a car or a phone or a television or a computer." "I

0.02.780.206 I llama_perf_sampler_print:    sampling time =       2.63 ms /    71 runs   (    0.04 ms per token, 26985.94 tokens per second)
0.02.780.209 I llama_perf_context_print:        load time =     296.41 ms
0.02.780.212 I llama_perf_context_print: prompt eval time =     111.80 ms /     7 tokens (   15.97 ms per token,    62.61 tokens per second)
0.02.780.214 I llama_perf_context_print:        eval time =    2358.96 ms /    63 runs   (   37.44 ms per token,    26.71 tokens per second)
0.02.780.215 I llama_perf_context_print:       total time =    2482.87 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.330 I build: 4170 (47f931c8) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.132.410 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.134.754 I llama_new_context_with_model: n_seq_max     = 1
0.00.134.776 I llama_new_context_with_model: n_ctx         = 128
0.00.134.776 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.134.776 I llama_new_context_with_model: n_batch       = 128
0.00.134.777 I llama_new_context_with_model: n_ubatch      = 128
0.00.134.777 I llama_new_context_with_model: flash_attn    = 0
0.00.134.779 I llama_new_context_with_model: freq_base     = 10000.0
0.00.134.779 I llama_new_context_with_model: freq_scale    = 1
0.00.134.780 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.139.227 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.139.254 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.139.269 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.141.321 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.141.344 I llama_new_context_with_model: graph nodes  = 967
...
0.00.197.507 I 
0.00.197.619 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.197.643 I perplexity: tokenizing the input ..
0.00.206.711 I perplexity: tokenization took 9.064 ms
0.00.206.741 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.859.792 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.3422,
0.01.917.762 I Final estimate: PPL = 10.3422 +/- 3.28010

0.01.917.812 I llama_perf_context_print:        load time =     197.14 ms
0.01.917.829 I llama_perf_context_print: prompt eval time =    1651.38 ms /   128 tokens (   12.90 ms per token,    77.51 tokens per second)
0.01.917.844 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.917.871 I llama_perf_context_print:       total time =    1720.30 ms /   129 tokens
...
0.00.437.513 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.430.936 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.58user 0.66system 0:01.24elapsed 100%CPU (0avgtext+0avgdata 5359620maxresident)k
