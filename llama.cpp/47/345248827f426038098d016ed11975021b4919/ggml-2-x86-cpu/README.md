...
- status:  SUCCESS ✅
- runtime: 19:34.86
- date:    Thu May  9 09:54:27 UTC 2024
...
llama_print_timings: prompt eval time =       4.47 ms /     9 tokens (    0.50 ms per token,  2014.32 tokens per second)
...
<bos> Shek, the enigmatic founder of the Benevolent Society, has a hidden agenda that threatens the world's balance.
...
llama_print_timings: prompt eval time =    1165.76 ms /     2 tokens (  582.88 ms per token,     1.72 tokens per second)
llama_print_timings:        eval time =   21153.55 ms /    31 runs   (  682.37 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22500.40 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say the early bird gets the worm, but in this case, it seems like the early bird got the chicken dinner.
...
llama_print_timings: prompt eval time =    1146.52 ms /     2 tokens (  573.26 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21017.78 ms /    31 runs   (  677.99 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22346.35 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say time heals all, but sometimes the pain lingers for years.

**Answer the question based on the provided context.**

**How does the passage suggest the
llama_print_timings:        load time =    1224.26 ms
llama_print_timings:      sample time =      47.59 ms /    32 runs   (    1.49 ms per token,   672.37 tokens per second)
llama_print_timings: prompt eval time =    1148.92 ms /     2 tokens (  574.46 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21036.46 ms /    31 runs   (  678.60 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22369.40 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar is a revolutionary flight training software designed to transform the way pilots train.

**Key Features:**

- **Personalized Flight Paths:** Create customized flight plans with
llama_print_timings:        load time =    1229.20 ms
llama_print_timings:      sample time =      47.56 ms /    32 runs   (    1.49 ms per token,   672.82 tokens per second)
llama_print_timings: prompt eval time =    1137.55 ms /     2 tokens (  568.77 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20966.19 ms /    31 runs   (  676.33 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22284.16 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197968.60 ms
main:    total time = 197968.60 ms
+ echo PASS
PASS
+ echo
...
<bos> When is it appropriate to use the term "boundary" in this context?

**Boundary** refers to a limit or separation that defines the extent to which something can
llama_print_timings:        load time =     647.83 ms
llama_print_timings:      sample time =      47.63 ms /    32 runs   (    1.49 ms per token,   671.86 tokens per second)
llama_print_timings: prompt eval time =     578.52 ms /     2 tokens (  289.26 ms per token,     3.46 tokens per second)
llama_print_timings:        eval time =   10622.89 ms /    31 runs   (  342.67 ms per token,     2.92 tokens per second)
llama_print_timings:       total time =   11381.59 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198195.26 ms
main:    total time = 198195.26 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in the magical realm of Eldoria, there lived a brave knight named Sir Eldric.

**Part 1: The Trials of Eldoria**
...
llama_print_timings: prompt eval time =    1287.41 ms /     5 tokens (  257.48 ms per token,     3.88 tokens per second)
llama_print_timings:        eval time =   10802.03 ms /    31 runs   (  348.45 ms per token,     2.87 tokens per second)
llama_print_timings:       total time =   12268.78 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a world of whimsical creatures and boundless imagination, there lived a curious and imaginative young girl named Anya.

Anya had a heart filled with wanderlust
llama_print_timings:        load time =     170.48 ms
llama_print_timings:      sample time =       6.99 ms /    32 runs   (    0.22 ms per token,  4579.28 tokens per second)
llama_print_timings: prompt eval time =     134.14 ms /     5 tokens (   26.83 ms per token,    37.27 tokens per second)
llama_print_timings:        eval time =    2107.94 ms /    31 runs   (   68.00 ms per token,    14.71 tokens per second)
llama_print_timings:       total time =    2310.13 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If a particle is moving with uniform acceleration, then its position and velocity will:

a) Increase over time
b) Remain the same
c) Decrease over
llama_print_timings:        load time =     157.47 ms
llama_print_timings:      sample time =       6.33 ms /    32 runs   (    0.20 ms per token,  5059.29 tokens per second)
llama_print_timings: prompt eval time =      75.32 ms /     2 tokens (   37.66 ms per token,    26.55 tokens per second)
llama_print_timings:        eval time =    2088.12 ms /    31 runs   (   67.36 ms per token,    14.85 tokens per second)
llama_print_timings:       total time =    2233.00 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After completing the first level of a language course, students should be able to:

**A.** Understand and use vocabulary related to everyday life situations.
**B
llama_print_timings:        load time =     165.61 ms
llama_print_timings:      sample time =       6.48 ms /    32 runs   (    0.20 ms per token,  4935.99 tokens per second)
llama_print_timings: prompt eval time =      81.10 ms /     2 tokens (   40.55 ms per token,    24.66 tokens per second)
llama_print_timings:        eval time =    2185.93 ms /    31 runs   (   70.51 ms per token,    14.18 tokens per second)
llama_print_timings:       total time =    2337.50 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After you've chosen a method for data analysis, what steps should you take to ensure that your analysis is valid and reliable?

**Steps for Ensuring the Validity
llama_print_timings:        load time =     159.26 ms
llama_print_timings:      sample time =       6.72 ms /    32 runs   (    0.21 ms per token,  4764.03 tokens per second)
llama_print_timings: prompt eval time =      80.07 ms /     2 tokens (   40.03 ms per token,    24.98 tokens per second)
llama_print_timings:        eval time =    2158.70 ms /    31 runs   (   69.64 ms per token,    14.36 tokens per second)
llama_print_timings:       total time =    2306.86 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31969.42 ms
main:    total time = 31969.42 ms
+ echo PASS
PASS
+ echo
...
<bos> Shekhs of Egypt were known for their power, wealth, and lavish lifestyles.

**True or False**

True<eos> [end of text]

llama_print_timings:        load time =     127.18 ms
llama_print_timings:      sample time =       5.08 ms /    25 runs   (    0.20 ms per token,  4918.36 tokens per second)
llama_print_timings: prompt eval time =      69.95 ms /     2 tokens (   34.97 ms per token,    28.59 tokens per second)
llama_print_timings:        eval time =    1305.47 ms /    24 runs   (   54.39 ms per token,    18.38 tokens per second)
llama_print_timings:       total time =    1428.03 ms /    26 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32026.91 ms
main:    total time = 32026.91 ms
+ echo PASS
PASS
+ echo
...
<bos> Shein is a popular online retailer that sells a wide variety of fashion, beauty, and home goods. Shein has gained significant popularity in recent years, and many
llama_print_timings:        load time =     132.41 ms
llama_print_timings:      sample time =       6.55 ms /    32 runs   (    0.20 ms per token,  4886.24 tokens per second)
llama_print_timings: prompt eval time =      83.82 ms /     2 tokens (   41.91 ms per token,    23.86 tokens per second)
llama_print_timings:        eval time =    1638.90 ms /    31 runs   (   52.87 ms per token,    18.92 tokens per second)
llama_print_timings:       total time =    1790.01 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     492.81 ms
llama_print_timings:      sample time =       2.41 ms /    64 runs   (    0.04 ms per token, 26600.17 tokens per second)
llama_print_timings: prompt eval time =     344.25 ms /     8 tokens (   43.03 ms per token,    23.24 tokens per second)
llama_print_timings:        eval time =    7961.28 ms /    63 runs   (  126.37 ms per token,     7.91 tokens per second)
llama_print_timings:       total time =    8328.28 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     472.14 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5130.70 ms /   128 tokens (   40.08 ms per token,    24.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5148.00 ms /   129 tokens
...
llama_print_timings:        eval time =    5712.47 ms /    63 runs   (   90.67 ms per token,    11.03 tokens per second)
llama_print_timings:       total time =    5961.71 ms /    71 tokens
Log end
...
[1]4.2536,
llama_print_timings:        load time =     311.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3022.00 ms /   128 tokens (   23.61 ms per token,    42.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3038.61 ms /   129 tokens
...
llama_print_timings: prompt eval time =     223.88 ms /     8 tokens (   27.98 ms per token,    35.73 tokens per second)
llama_print_timings:        eval time =    4631.70 ms /    63 runs   (   73.52 ms per token,    13.60 tokens per second)
llama_print_timings:       total time =    4874.98 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3326.36 ms /   128 tokens (   25.99 ms per token,    38.48 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3342.78 ms /   129 tokens
...
llama_print_timings: prompt eval time =     397.42 ms /     8 tokens (   49.68 ms per token,    20.13 tokens per second)
llama_print_timings:        eval time =    4865.23 ms /    63 runs   (   77.23 ms per token,    12.95 tokens per second)
llama_print_timings:       total time =    5281.93 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6037.76 ms /   128 tokens (   47.17 ms per token,    21.20 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6054.17 ms /   129 tokens
...
llama_print_timings: prompt eval time =     426.03 ms /     8 tokens (   53.25 ms per token,    18.78 tokens per second)
llama_print_timings:        eval time =    5451.93 ms /    63 runs   (   86.54 ms per token,    11.56 tokens per second)
llama_print_timings:       total time =    5897.40 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6433.63 ms /   128 tokens (   50.26 ms per token,    19.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6450.30 ms /   129 tokens
...
llama_print_timings: prompt eval time =     448.19 ms /     8 tokens (   56.02 ms per token,    17.85 tokens per second)
llama_print_timings:        eval time =    5750.44 ms /    63 runs   (   91.28 ms per token,    10.96 tokens per second)
llama_print_timings:       total time =    6219.00 ms /    71 tokens
Log end
...
[1]4.2586,
llama_print_timings:        load time =     258.91 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6822.88 ms /   128 tokens (   53.30 ms per token,    18.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6839.87 ms /   129 tokens
...
llama_print_timings: prompt eval time =     640.96 ms /     8 tokens (   80.12 ms per token,    12.48 tokens per second)
llama_print_timings:        eval time =    6230.65 ms /    63 runs   (   98.90 ms per token,    10.11 tokens per second)
llama_print_timings:       total time =    6891.18 ms /    71 tokens
Log end
...
[1]5.6204,
llama_print_timings:        load time =     255.71 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10086.77 ms /   128 tokens (   78.80 ms per token,    12.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10103.17 ms /   129 tokens
...
llama_print_timings: prompt eval time =     486.64 ms /     8 tokens (   60.83 ms per token,    16.44 tokens per second)
llama_print_timings:        eval time =    5424.96 ms /    63 runs   (   86.11 ms per token,    11.61 tokens per second)
llama_print_timings:       total time =    5931.77 ms /    71 tokens
Log end
...
[1]4.4091,
llama_print_timings:        load time =     241.89 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7644.06 ms /   128 tokens (   59.72 ms per token,    16.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7660.50 ms /   129 tokens
...
llama_print_timings: prompt eval time =     413.83 ms /     8 tokens (   51.73 ms per token,    19.33 tokens per second)
llama_print_timings:        eval time =    5211.37 ms /    63 runs   (   82.72 ms per token,    12.09 tokens per second)
llama_print_timings:       total time =    5645.09 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6367.20 ms /   128 tokens (   49.74 ms per token,    20.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6383.50 ms /   129 tokens
...
llama_print_timings:        eval time =    6002.03 ms /    63 runs   (   95.27 ms per token,    10.50 tokens per second)
llama_print_timings:       total time =    6515.64 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7564.42 ms /   128 tokens (   59.10 ms per token,    16.92 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7581.36 ms /   129 tokens
...
llama_print_timings:        load time =     311.44 ms
llama_print_timings:      sample time =       2.06 ms /    64 runs   (    0.03 ms per token, 31098.15 tokens per second)
llama_print_timings: prompt eval time =     541.33 ms /     8 tokens (   67.67 ms per token,    14.78 tokens per second)
llama_print_timings:        eval time =    6609.95 ms /    63 runs   (  104.92 ms per token,     9.53 tokens per second)
llama_print_timings:       total time =    7170.28 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8347.26 ms /   128 tokens (   65.21 ms per token,    15.33 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8364.25 ms /   129 tokens
...
first run: The quick brown fox did a lap dance at the entertainment showcase. At this display there will be a


second run: The quick brown fox did a lap dance at the entertainment showcase. At this display there will be a


single seq run: The quick brown fox did a lap dance at the entertainment showcase. At this display there will be a
...
llama_new_context_with_model: graph splits = 1
main : serialized state into 1798820 out of a maximum of 236005464 bytes
llama_new_context_with_model: n_ctx      = 512
llama_new_context_with_model: n_batch    = 512
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: flash_attn = 1
...
llama_new_context_with_model: graph nodes  = 735
llama_new_context_with_model: graph splits = 1
main : deserialized state from 1798820 out of a maximum of 236005464 bytes
llama_new_context_with_model: n_ctx      = 512
llama_new_context_with_model: n_batch    = 512
llama_new_context_with_model: n_ubatch   = 512
llama_new_context_with_model: flash_attn = 1
...
Back to index</s>Boots (clothing
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.5 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.22 seconds per pass - ETA 0.08 minutes
[1]9.1034,
llama_print_timings:        load time =     469.84 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5213.23 ms /   128 tokens (   40.73 ms per token,    24.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5269.73 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 43.95 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.15 seconds per pass - ETA 0.08 minutes
[1]7.0156,
llama_print_timings:        load time =    4475.01 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5144.96 ms /   128 tokens (   40.20 ms per token,    24.88 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5197.06 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.847 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.03 seconds per pass - ETA 0.05 minutes
[1]9.1825,
llama_print_timings:        load time =     307.87 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3024.59 ms /   128 tokens (   23.63 ms per token,    42.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3081.51 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.179 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.02 seconds per pass - ETA 0.05 minutes
[1]7.0131,
llama_print_timings:        load time =    3267.88 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3011.50 ms /   128 tokens (   23.53 ms per token,    42.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3064.87 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 43.188 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.02 seconds per pass - ETA 0.05 minutes
[1]7.0336,
llama_print_timings:        load time =    3396.87 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3008.89 ms /   128 tokens (   23.51 ms per token,    42.54 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3060.54 ms /   129 tokens
...
0.33user 0.56system 0:00.89elapsed 99%CPU (0avgtext+0avgdata 6880320maxresident)k
0inputs+40outputs (0major+114705minor)pagefaults 0swaps
```
...
0.12user 0.55system 0:00.68elapsed 99%CPU (0avgtext+0avgdata 6880128maxresident)k
