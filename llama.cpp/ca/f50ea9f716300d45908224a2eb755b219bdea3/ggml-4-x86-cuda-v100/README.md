...
- status:  FAILURE ❌ (124)
- runtime: 
- date:    Mon Jun 24 19:36:21 UTC 2024
...
20/22 Test #20: test-backend-ops .................   Passed  208.47 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 270.00 sec*proc (22 tests)

Total Test time (real) = 270.01 sec
...
llama_print_timings:        load time =     432.47 ms
...
llama_print_timings:        load time =     389.93 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       4.80 ms /     9 tokens (    0.53 ms per token,  1873.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
