...
- status:  SUCCESS ✅
- runtime: 311.39
- date:    Tue May 28 20:29:40 EEST 2024
...
20/22 Test #20: test-backend-ops .................   Passed  107.81 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 168.95 sec*proc (22 tests)

Total Test time (real) = 168.96 sec
...
llama_print_timings: prompt eval time =      11.57 ms /     9 tokens (    1.29 ms per token,   777.94 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.49 ms /     9 tokens (    1.17 ms per token,   858.12 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
