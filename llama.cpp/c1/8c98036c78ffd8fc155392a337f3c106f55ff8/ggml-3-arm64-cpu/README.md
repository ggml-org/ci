...
- status:  SUCCESS ✅
- runtime: 22:22.76
- date:    Sat Apr 20 14:09:41 UTC 2024
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there was a small village nestled amidst rolling hills.

**The villagers were kind and resourceful, and they lived in harmony with nature. The village was known
...
llama_print_timings: prompt eval time =    6136.96 ms /     5 tokens ( 1227.39 ms per token,     0.81 tokens per second)
llama_print_timings:        eval time =   48101.64 ms /    31 runs   ( 1551.67 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   54395.49 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They say a picture is worth a thousand words, but what if the words themselves could paint a thousand pictures?

**Story:**

Imagine a world where spoken word
llama_print_timings:        load time =    3713.89 ms
llama_print_timings:      sample time =      41.82 ms /    32 runs   (    1.31 ms per token,   765.26 tokens per second)
llama_print_timings: prompt eval time =    2696.89 ms /     2 tokens ( 1348.44 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48107.83 ms /    31 runs   ( 1551.87 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   50960.32 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there lived a brave princess named Anya. She was known for her kindness, bravery, and determination.

One day, Anya received a letter from her kingdom
llama_print_timings:        load time =    3740.92 ms
llama_print_timings:      sample time =      41.61 ms /    32 runs   (    1.30 ms per token,   769.05 tokens per second)
llama_print_timings: prompt eval time =    6150.27 ms /     5 tokens ( 1230.05 ms per token,     0.81 tokens per second)
llama_print_timings:        eval time =   48199.46 ms /    31 runs   ( 1554.82 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   54504.82 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 After a successful trial run, Acme Enterprises is considering scaling up its cloud infrastructure to support a larger user base and more complex data analysis.
...
llama_print_timings:        eval time =    3112.37 ms /    31 runs   (  100.40 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    3318.03 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
## Soar: The Journey of a Lifetime

**A personal adventure through self-discovery, personal growth, and the power of dreams.**


llama_print_timings:        load time =    1098.84 ms
llama_print_timings:      sample time =       7.85 ms /    32 runs   (    0.25 ms per token,  4077.99 tokens per second)
llama_print_timings: prompt eval time =     164.88 ms /     2 tokens (   82.44 ms per token,    12.13 tokens per second)
llama_print_timings:        eval time =    3103.76 ms /    31 runs   (  100.12 ms per token,     9.99 tokens per second)
llama_print_timings:       total time =    3308.75 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there was a kingdom with a magical sword that granted its bearer the power to conquer any foe.

One day, a young knight named Arthur emerged from the
llama_print_timings:        load time =    1176.89 ms
llama_print_timings:      sample time =       7.83 ms /    32 runs   (    0.24 ms per token,  4084.24 tokens per second)
llama_print_timings: prompt eval time =     368.19 ms /     5 tokens (   73.64 ms per token,    13.58 tokens per second)
llama_print_timings:        eval time =    3119.45 ms /    31 runs   (  100.63 ms per token,     9.94 tokens per second)
llama_print_timings:       total time =    3527.98 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    3116.29 ms
llama_print_timings:      sample time =       2.63 ms /    64 runs   (    0.04 ms per token, 24316.11 tokens per second)
llama_print_timings: prompt eval time =    2267.65 ms /     8 tokens (  283.46 ms per token,     3.53 tokens per second)
llama_print_timings:        eval time =   19864.39 ms /    63 runs   (  315.31 ms per token,     3.17 tokens per second)
llama_print_timings:       total time =   22145.19 ms /    71 tokens
Log end
...
llama_print_timings:        load time =    1687.53 ms
...
llama_print_timings:       total time =    9348.62 ms /    71 tokens
Log end
...
[1]4.2615,
llama_print_timings:        load time =    1564.08 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14372.60 ms /   128 tokens (  112.29 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14384.35 ms /   129 tokens
...
llama_print_timings:        load time =    1054.85 ms
...
llama_print_timings:        eval time =    7962.47 ms /    63 runs   (  126.39 ms per token,     7.91 tokens per second)
...
[1]4.1750,
llama_print_timings:        load time =    1015.75 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14969.07 ms /   128 tokens (  116.95 ms per token,     8.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14981.59 ms /   129 tokens
...
llama_print_timings:        load time =    1120.39 ms
llama_print_timings:      sample time =       2.63 ms /    64 runs   (    0.04 ms per token, 24316.11 tokens per second)
llama_print_timings: prompt eval time =     961.01 ms /     8 tokens (  120.13 ms per token,     8.32 tokens per second)
llama_print_timings:        eval time =    8445.96 ms /    63 runs   (  134.06 ms per token,     7.46 tokens per second)
llama_print_timings:       total time =    9420.63 ms /    71 tokens
Log end
...
[1]4.3861,
llama_print_timings:        load time =    1045.36 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15881.34 ms /   128 tokens (  124.07 ms per token,     8.06 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15892.51 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1213.49 ms /     8 tokens (  151.69 ms per token,     6.59 tokens per second)
llama_print_timings:        eval time =   10550.83 ms /    63 runs   (  167.47 ms per token,     5.97 tokens per second)
llama_print_timings:       total time =   11778.57 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20081.64 ms /   128 tokens (  156.89 ms per token,     6.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20093.28 ms /   129 tokens
...
I believe that love
llama_print_timings:        load time =    1348.32 ms
llama_print_timings:      sample time =       2.66 ms /    64 runs   (    0.04 ms per token, 24069.20 tokens per second)
llama_print_timings: prompt eval time =    1228.01 ms /     8 tokens (  153.50 ms per token,     6.51 tokens per second)
llama_print_timings:        eval time =   10842.03 ms /    63 runs   (  172.10 ms per token,     5.81 tokens per second)
llama_print_timings:       total time =   12084.35 ms /    71 tokens
Log end
...
[1]4.2557,
llama_print_timings:        load time =    1402.87 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20132.51 ms /   128 tokens (  157.29 ms per token,     6.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20144.57 ms /   129 tokens
...
llama_print_timings:      sample time =       2.68 ms /    64 runs   (    0.04 ms per token, 23907.36 tokens per second)
llama_print_timings: prompt eval time =    1149.31 ms /     8 tokens (  143.66 ms per token,     6.96 tokens per second)
llama_print_timings:        eval time =    9847.43 ms /    63 runs   (  156.31 ms per token,     6.40 tokens per second)
llama_print_timings:       total time =   11010.38 ms /    71 tokens
Log end
...
[1]5.6188,
llama_print_timings:        load time =     825.07 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18775.92 ms /   128 tokens (  146.69 ms per token,     6.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings:        eval time =    9394.12 ms /    63 runs   (  149.11 ms per token,     6.71 tokens per second)
llama_print_timings:       total time =   10489.59 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17810.21 ms /   128 tokens (  139.14 ms per token,     7.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17822.04 ms /   129 tokens
...
llama_print_timings: prompt eval time =     956.87 ms /     8 tokens (  119.61 ms per token,     8.36 tokens per second)
llama_print_timings:        eval time =    8399.38 ms /    63 runs   (  133.32 ms per token,     7.50 tokens per second)
llama_print_timings:       total time =    9369.91 ms /    71 tokens
Log end
...
[1]4.1929,
llama_print_timings:        load time =    1139.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15686.93 ms /   128 tokens (  122.55 ms per token,     8.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15699.16 ms /   129 tokens
...
I believe that you
llama_print_timings:        load time =    1367.88 ms
...
llama_print_timings:        eval time =   11207.75 ms /    63 runs   (  177.90 ms per token,     5.62 tokens per second)
llama_print_timings:       total time =   12534.68 ms /    71 tokens
Log end
...
[1]4.2316,
llama_print_timings:        load time =    1337.29 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21497.12 ms /   128 tokens (  167.95 ms per token,     5.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21509.75 ms /   129 tokens
...
llama_print_timings:        load time =    1478.38 ms
...
llama_print_timings:        eval time =   11533.30 ms /    63 runs   (  183.07 ms per token,     5.46 tokens per second)
llama_print_timings:       total time =   12889.89 ms /    71 tokens
Log end
...
[1]4.2451,
llama_print_timings:        load time =    1478.84 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22043.91 ms /   128 tokens (  172.22 ms per token,     5.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22056.32 ms /   129 tokens
...
first run: The quick brown fox song from Over-the-Hill, performer Chet Atkins, The


second run: The quick brown fox song from Over-the-Hill, performer Chet Atkins, The


single seq run: The quick brown fox song from Over-the-Hill, performer Chet Atkins, The
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 65.086 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.69 seconds per pass - ETA 0.60 minutes
[1]9.1017,
llama_print_timings:        load time =    3257.07 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36692.93 ms /   128 tokens (  286.66 ms per token,     3.49 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36759.89 ms /   129 tokens
...
perplexity: 36.57 seconds per pass - ETA 0.60 minutes
[1]7.0171,
llama_print_timings:        load time =    6265.36 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36572.83 ms /   128 tokens (  285.73 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36636.14 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 62.653 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]6.9856,
llama_print_timings:        load time =    4507.06 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14371.11 ms /   128 tokens (  112.27 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14435.57 ms /   129 tokens
...
[1]6.9967,
llama_print_timings:        load time =    5149.44 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14377.51 ms /   128 tokens (  112.32 ms per token,     8.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14441.49 ms /   129 tokens
...
0.36user 2.77system 0:03.13elapsed 100%CPU (0avgtext+0avgdata 6877696maxresident)k
...
0.12user 2.77system 0:02.89elapsed 100%CPU (0avgtext+0avgdata 6877176maxresident)k
