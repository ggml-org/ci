...
- status:  SUCCESS ✅
- runtime: 13:15.41
- date:    Sat Apr 20 14:00:44 UTC 2024
...
llama_print_timings: prompt eval time =       5.87 ms /     9 tokens (    0.65 ms per token,  1533.74 tokens per second)
...
a) f(3)
b) The domain of f
llama_print_timings:        load time =     833.92 ms
llama_print_timings:      sample time =      47.53 ms /    32 runs   (    1.49 ms per token,   673.20 tokens per second)
llama_print_timings: prompt eval time =     718.44 ms /     2 tokens (  359.22 ms per token,     2.78 tokens per second)
llama_print_timings:        eval time =   13006.62 ms /    31 runs   (  419.57 ms per token,     2.38 tokens per second)
llama_print_timings:       total time =   13907.32 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there lived a group of young adventurers in a bustling village.

One sunny morning, they stumbled upon an ancient map hidden within the ruins of an old castle
llama_print_timings:        load time =     844.26 ms
llama_print_timings:      sample time =      47.71 ms /    32 runs   (    1.49 ms per token,   670.75 tokens per second)
llama_print_timings: prompt eval time =    1623.11 ms /     5 tokens (  324.62 ms per token,     3.08 tokens per second)
llama_print_timings:        eval time =   13108.11 ms /    31 runs   (  422.84 ms per token,     2.36 tokens per second)
llama_print_timings:       total time =   14919.82 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Heider Center for Social Justice hosted a panel discussion on "The Impact of Social Media Algorithms on Youth Mental Health."

**Discussion Points:**

* The role of
llama_print_timings:        load time =     797.12 ms
llama_print_timings:      sample time =      47.65 ms /    32 runs   (    1.49 ms per token,   671.52 tokens per second)
llama_print_timings: prompt eval time =     713.29 ms /     2 tokens (  356.65 ms per token,     2.80 tokens per second)
llama_print_timings:        eval time =   12944.38 ms /    31 runs   (  417.56 ms per token,     2.39 tokens per second)
llama_print_timings:       total time =   13840.17 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They call me the outlier, the one who doesn't fit in. But I'm not going to let that define me. I'm a beacon of
...
llama_print_timings: prompt eval time =      88.39 ms /     2 tokens (   44.20 ms per token,    22.63 tokens per second)
llama_print_timings:        eval time =    2114.84 ms /    31 runs   (   68.22 ms per token,    14.66 tokens per second)
llama_print_timings:       total time =    2269.37 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shein is a popular online retailer that offers a wide variety of products at low prices. However, there are concerns about the quality and safety of some of their products
llama_print_timings:        load time =     168.47 ms
llama_print_timings:      sample time =       6.29 ms /    32 runs   (    0.20 ms per token,  5089.06 tokens per second)
llama_print_timings: prompt eval time =      86.74 ms /     2 tokens (   43.37 ms per token,    23.06 tokens per second)
llama_print_timings:        eval time =    2024.68 ms /    31 runs   (   65.31 ms per token,    15.31 tokens per second)
llama_print_timings:       total time =    2176.98 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**A thrilling journey through the world of magic and monsters**

The Witcher season 2 picks up right where the first left off
...
llama_print_timings: prompt eval time =      89.95 ms /     2 tokens (   44.98 ms per token,    22.23 tokens per second)
llama_print_timings:        eval time =    2037.87 ms /    31 runs   (   65.74 ms per token,    15.21 tokens per second)
llama_print_timings:       total time =    2193.18 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =     499.53 ms /     8 tokens (   62.44 ms per token,    16.02 tokens per second)
llama_print_timings:        eval time =    9921.50 ms /    63 runs   (  157.48 ms per token,     6.35 tokens per second)
llama_print_timings:       total time =   10443.40 ms /    71 tokens
Log end
...
[1]4.2453,
llama_print_timings:        load time =     662.78 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6992.27 ms /   128 tokens (   54.63 ms per token,    18.31 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7002.21 ms /   129 tokens
...
llama_print_timings:        load time =     406.63 ms
...
llama_print_timings:        eval time =    6178.33 ms /    63 runs   (   98.07 ms per token,    10.20 tokens per second)
llama_print_timings:       total time =    6531.18 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4698.13 ms /   128 tokens (   36.70 ms per token,    27.24 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4708.68 ms /   129 tokens
...
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31636.18 tokens per second)
llama_print_timings: prompt eval time =     319.43 ms /     8 tokens (   39.93 ms per token,    25.04 tokens per second)
llama_print_timings:        eval time =    4314.78 ms /    63 runs   (   68.49 ms per token,    14.60 tokens per second)
llama_print_timings:       total time =    4653.47 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5055.20 ms /   128 tokens (   39.49 ms per token,    25.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5065.05 ms /   129 tokens
...
llama_print_timings: prompt eval time =     376.08 ms /     8 tokens (   47.01 ms per token,    21.27 tokens per second)
llama_print_timings:        eval time =    4884.22 ms /    63 runs   (   77.53 ms per token,    12.90 tokens per second)
llama_print_timings:       total time =    5279.01 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5836.78 ms /   128 tokens (   45.60 ms per token,    21.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5847.39 ms /   129 tokens
...
llama_print_timings:        load time =     323.42 ms
...
llama_print_timings:        eval time =    5167.59 ms /    63 runs   (   82.03 ms per token,    12.19 tokens per second)
llama_print_timings:       total time =    5600.76 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6234.16 ms /   128 tokens (   48.70 ms per token,    20.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6244.55 ms /   129 tokens
...
I believe in the
llama_print_timings:        load time =     340.64 ms
llama_print_timings:      sample time =       2.05 ms /    64 runs   (    0.03 ms per token, 31158.71 tokens per second)
llama_print_timings: prompt eval time =     426.81 ms /     8 tokens (   53.35 ms per token,    18.74 tokens per second)
llama_print_timings:        eval time =    5551.01 ms /    63 runs   (   88.11 ms per token,    11.35 tokens per second)
llama_print_timings:       total time =    5997.99 ms /    71 tokens
Log end
...
[1]4.2597,
llama_print_timings:        load time =     320.58 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6624.83 ms /   128 tokens (   51.76 ms per token,    19.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6635.18 ms /   129 tokens
...
llama_print_timings: prompt eval time =     612.10 ms /     8 tokens (   76.51 ms per token,    13.07 tokens per second)
llama_print_timings:        eval time =    5795.24 ms /    63 runs   (   91.99 ms per token,    10.87 tokens per second)
llama_print_timings:       total time =    6427.08 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9889.15 ms /   128 tokens (   77.26 ms per token,    12.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9899.85 ms /   129 tokens
...
llama_print_timings:        load time =     289.02 ms
llama_print_timings:      sample time =       2.01 ms /    64 runs   (    0.03 ms per token, 31809.15 tokens per second)
llama_print_timings: prompt eval time =     465.28 ms /     8 tokens (   58.16 ms per token,    17.19 tokens per second)
llama_print_timings:        eval time =    5039.71 ms /    63 runs   (   80.00 ms per token,    12.50 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7410.98 ms /   128 tokens (   57.90 ms per token,    17.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7421.39 ms /   129 tokens
...
llama_print_timings:        load time =     308.44 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31761.79 tokens per second)
llama_print_timings: prompt eval time =     394.21 ms /     8 tokens (   49.28 ms per token,    20.29 tokens per second)
llama_print_timings:        eval time =    5039.77 ms /    63 runs   (   80.00 ms per token,    12.50 tokens per second)
llama_print_timings:       total time =    5453.50 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6148.73 ms /   128 tokens (   48.04 ms per token,    20.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6159.06 ms /   129 tokens
...
I believe in
llama_print_timings:        load time =     346.87 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31326.48 tokens per second)
llama_print_timings: prompt eval time =     464.91 ms /     8 tokens (   58.11 ms per token,    17.21 tokens per second)
llama_print_timings:        eval time =    5792.22 ms /    63 runs   (   91.94 ms per token,    10.88 tokens per second)
llama_print_timings:       total time =    6276.05 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7396.65 ms /   128 tokens (   57.79 ms per token,    17.31 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7406.87 ms /   129 tokens
...
llama_print_timings:        eval time =    6406.24 ms /    63 runs   (  101.69 ms per token,     9.83 tokens per second)
llama_print_timings:       total time =    6946.06 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8124.96 ms /   128 tokens (   63.48 ms per token,    15.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8135.39 ms /   129 tokens
...
Recently, I noticed schoolboys in uniform
...
[1]9.1010,
llama_print_timings:        load time =     659.03 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7080.72 ms /   128 tokens (   55.32 ms per token,    18.08 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7130.21 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.383 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 6.95 seconds per pass - ETA 0.10 minutes
[1]7.0168,
llama_print_timings:        load time =    5778.47 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6952.88 ms /   128 tokens (   54.32 ms per token,    18.41 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7000.42 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.259 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.69 seconds per pass - ETA 0.07 minutes
[1]9.2039,
llama_print_timings:        load time =     383.51 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4694.51 ms /   128 tokens (   36.68 ms per token,    27.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4743.74 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.103 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.67 seconds per pass - ETA 0.07 minutes
[1]7.0066,
llama_print_timings:        load time =    4010.14 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4667.19 ms /   128 tokens (   36.46 ms per token,    27.43 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4714.92 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.941 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.17 seconds per pass - ETA 0.08 minutes
[1]6.9704,
llama_print_timings:        load time =    4363.73 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5165.64 ms /   128 tokens (   40.36 ms per token,    24.78 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5212.93 ms /   129 tokens
...
0.31user 0.80system 0:01.11elapsed 100%CPU (0avgtext+0avgdata 6878160maxresident)k
...
0.08user 0.81system 0:00.89elapsed 100%CPU (0avgtext+0avgdata 6877772maxresident)k
0inputs+56outputs (0major+111957minor)pagefaults 0swaps
```
