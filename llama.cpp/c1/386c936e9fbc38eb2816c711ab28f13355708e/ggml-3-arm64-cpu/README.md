...
- status:  SUCCESS ✅
- runtime: 19:13.27
- date:    Sun Apr 21 13:17:46 UTC 2024
...
Label Time Summary:
main    = 102.93 sec*proc (23 tests)

Total Test time (real) = 102.94 sec
...
llama_print_timings:        load time =      24.75 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there lived a young girl named Anya. She had bright eyes that sparkled with curiosity, and a smile that could light up the darkest room.

One
llama_print_timings:        load time =    3734.81 ms
llama_print_timings:      sample time =      41.49 ms /    32 runs   (    1.30 ms per token,   771.18 tokens per second)
llama_print_timings: prompt eval time =    6166.46 ms /     5 tokens ( 1233.29 ms per token,     0.81 tokens per second)
llama_print_timings:        eval time =   48363.65 ms /    31 runs   ( 1560.12 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   54686.17 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shekera is a powerful female figure in the Bible who played a significant role in the deliverance of the Israelites from Egyptian bondage. Her story serves as a powerful reminder
llama_print_timings:        load time =    3711.06 ms
llama_print_timings:      sample time =      41.40 ms /    32 runs   (    1.29 ms per token,   773.02 tokens per second)
llama_print_timings: prompt eval time =    2704.80 ms /     2 tokens ( 1352.40 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48248.53 ms /    31 runs   ( 1556.40 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51108.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 After a long day, all I want is a quiet and relaxing evening. A cozy reading nook with a soft glow and warm blankets is calling my name.

**
llama_print_timings:        load time =    3713.10 ms
llama_print_timings:      sample time =      41.22 ms /    32 runs   (    1.29 ms per token,   776.28 tokens per second)
llama_print_timings: prompt eval time =    2717.01 ms /     2 tokens ( 1358.50 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48463.47 ms /    31 runs   ( 1563.34 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51335.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
The novel explores the complex and devastating consequences of a love triangle between a struggling writer, a renowned actress, and a charismatic musician
llama_print_timings:        load time =    1148.14 ms
llama_print_timings:      sample time =       7.94 ms /    32 runs   (    0.25 ms per token,  4029.72 tokens per second)
llama_print_timings: prompt eval time =     165.55 ms /     2 tokens (   82.77 ms per token,    12.08 tokens per second)
llama_print_timings:        eval time =    3112.18 ms /    31 runs   (  100.39 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    3318.22 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Heuristics are mental shortcuts or rules of thumb that people use to make decisions and judgments quickly and efficiently. They are cognitive
...
llama_print_timings:        eval time =    3116.36 ms /    31 runs   (  100.53 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    3321.63 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 When I am feeling overwhelmed, I tend to feel a sense of helplessness and anxiety.

This helplessness and anxiety can lead to further feelings of overwhelm, creating a vicious
llama_print_timings:        load time =    1137.76 ms
llama_print_timings:      sample time =       7.93 ms /    32 runs   (    0.25 ms per token,  4035.31 tokens per second)
llama_print_timings: prompt eval time =     164.79 ms /     2 tokens (   82.39 ms per token,    12.14 tokens per second)
llama_print_timings:        eval time =    3109.45 ms /    31 runs   (  100.30 ms per token,     9.97 tokens per second)
llama_print_timings:       total time =    3314.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =    2239.98 ms /     8 tokens (  280.00 ms per token,     3.57 tokens per second)
llama_print_timings:        eval time =   19752.76 ms /    63 runs   (  313.54 ms per token,     3.19 tokens per second)
llama_print_timings:       total time =   22006.88 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36574.88 ms /   128 tokens (  285.74 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36586.70 ms /   129 tokens
...
llama_print_timings:        load time =    1651.21 ms
llama_print_timings:      sample time =       2.68 ms /    64 runs   (    0.04 ms per token, 23916.29 tokens per second)
llama_print_timings: prompt eval time =     882.13 ms /     8 tokens (  110.27 ms per token,     9.07 tokens per second)
llama_print_timings:        eval time =    8444.30 ms /    63 runs   (  134.04 ms per token,     7.46 tokens per second)
llama_print_timings:       total time =    9339.92 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14381.39 ms /   128 tokens (  112.35 ms per token,     8.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14393.00 ms /   129 tokens
...
llama_print_timings: prompt eval time =     910.27 ms /     8 tokens (  113.78 ms per token,     8.79 tokens per second)
llama_print_timings:        eval time =    7921.74 ms /    63 runs   (  125.74 ms per token,     7.95 tokens per second)
llama_print_timings:       total time =    8846.48 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14969.48 ms /   128 tokens (  116.95 ms per token,     8.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14981.14 ms /   129 tokens
...
llama_print_timings:        eval time =    8417.99 ms /    63 runs   (  133.62 ms per token,     7.48 tokens per second)
llama_print_timings:       total time =    9391.68 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15881.38 ms /   128 tokens (  124.07 ms per token,     8.06 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15892.91 ms /   129 tokens
...
llama_print_timings:        eval time =   10507.89 ms /    63 runs   (  166.79 ms per token,     6.00 tokens per second)
llama_print_timings:       total time =   11732.26 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20112.73 ms /   128 tokens (  157.13 ms per token,     6.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20124.58 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1225.17 ms /     8 tokens (  153.15 ms per token,     6.53 tokens per second)
llama_print_timings:        eval time =   10768.78 ms /    63 runs   (  170.93 ms per token,     5.85 tokens per second)
llama_print_timings:       total time =   12007.84 ms /    71 tokens
Log end
...
[1]4.2557,
llama_print_timings:        load time =    1306.91 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20130.25 ms /   128 tokens (  157.27 ms per token,     6.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20142.26 ms /   129 tokens
...
llama_print_timings:        load time =     891.24 ms
llama_print_timings:      sample time =       2.75 ms /    64 runs   (    0.04 ms per token, 23230.49 tokens per second)
llama_print_timings: prompt eval time =    1150.06 ms /     8 tokens (  143.76 ms per token,     6.96 tokens per second)
llama_print_timings:        eval time =    9828.71 ms /    63 runs   (  156.01 ms per token,     6.41 tokens per second)
llama_print_timings:       total time =   10992.86 ms /    71 tokens
Log end
...
[1]5.6188,
llama_print_timings:        load time =     815.96 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18771.35 ms /   128 tokens (  146.65 ms per token,     6.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18782.75 ms /   129 tokens
...
llama_print_timings:        eval time =    9382.04 ms /    63 runs   (  148.92 ms per token,     6.71 tokens per second)
llama_print_timings:       total time =   10477.55 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17803.64 ms /   128 tokens (  139.09 ms per token,     7.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17815.00 ms /   129 tokens
...
llama_print_timings: prompt eval time =     956.91 ms /     8 tokens (  119.61 ms per token,     8.36 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15679.44 ms /   128 tokens (  122.50 ms per token,     8.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15691.41 ms /   129 tokens
...
llama_print_timings:        eval time =   11178.24 ms /    63 runs   (  177.43 ms per token,     5.64 tokens per second)
llama_print_timings:       total time =   12504.49 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21496.73 ms /   128 tokens (  167.94 ms per token,     5.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21508.62 ms /   129 tokens
...
llama_print_timings:        eval time =   11529.29 ms /    63 runs   (  183.00 ms per token,     5.46 tokens per second)
llama_print_timings:       total time =   12888.54 ms /    71 tokens
Log end
...
[1]4.2451,
llama_print_timings:        load time =    1436.79 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22038.33 ms /   128 tokens (  172.17 ms per token,     5.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22050.17 ms /   129 tokens
...
first run: The quick brown fox presumably jumping over the lazy dogsѵeԁ ѕuρeг


second run: The quick brown fox presumably jumping over the lazy dogsѵeԁ ѕuρeг


single seq run: The quick brown fox presumably jumping over the lazy dogsѵeԁ ѕuρeг
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 62.014 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.60 seconds per pass - ETA 0.60 minutes
[1]9.1017,
llama_print_timings:        load time =    3074.89 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36603.40 ms /   128 tokens (  285.96 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36666.99 ms /   129 tokens
...
perplexity: 36.57 seconds per pass - ETA 0.60 minutes
[1]7.0171,
llama_print_timings:        load time =    6303.31 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36566.81 ms /   128 tokens (  285.68 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36629.62 ms /   129 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14367.42 ms /   128 tokens (  112.25 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14432.48 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 57.575 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]6.9856,
llama_print_timings:        load time =    4450.76 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14368.72 ms /   128 tokens (  112.26 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14427.69 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 60.038 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]6.9967,
llama_print_timings:        load time =    5185.70 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14374.63 ms /   128 tokens (  112.30 ms per token,     8.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14436.69 ms /   129 tokens
...
0.36user 2.89system 0:03.25elapsed 100%CPU (0avgtext+0avgdata 6877760maxresident)k
...
0.11user 2.95system 0:03.06elapsed 100%CPU (0avgtext+0avgdata 6877304maxresident)k
