...
- status:  SUCCESS ✅
- runtime: 18:39.13
- date:    Sat May 18 06:43:06 UTC 2024
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.37 ms /     9 tokens (    0.37 ms per token,  2668.25 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Once upon a time, in a world where dreams were real, a group of children discovered a hidden chamber within a magical castle. Within, they found a magical book that transported them
...
llama_print_timings: prompt eval time =    2617.22 ms /     5 tokens (  523.44 ms per token,     1.91 tokens per second)
llama_print_timings:        eval time =   21074.28 ms /    31 runs   (  679.82 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   23873.45 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After the war, the nation of ____ experienced a cultural revival.
...
llama_print_timings: prompt eval time =    1146.76 ms /     2 tokens (  573.38 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   20974.81 ms /    31 runs   (  676.61 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22304.21 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After much deliberation, my partner and I have decided to end our romantic relationship. We acknowledge the pain and sadness this decision will cause, but we believe it is the
llama_print_timings:        load time =    1230.45 ms
llama_print_timings:      sample time =      46.31 ms /    32 runs   (    1.45 ms per token,   690.94 tokens per second)
llama_print_timings: prompt eval time =    1211.38 ms /     2 tokens (  605.69 ms per token,     1.65 tokens per second)
llama_print_timings:        eval time =   21053.52 ms /    31 runs   (  679.15 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22449.05 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =      46.00 ms /    32 runs   (    1.44 ms per token,   695.65 tokens per second)
llama_print_timings: prompt eval time =    1143.65 ms /     2 tokens (  571.83 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21144.56 ms /    31 runs   (  682.08 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22469.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197277.94 ms
main:    total time = 197277.94 ms
+ echo PASS
PASS
+ echo
...
<bos> When You Fall Asleep

**Introduction:**

As we fall into deeper sleep, the body's natural healing processes become more active. The brain waves slow down
llama_print_timings:        load time =     626.29 ms
...
llama_print_timings:        eval time =   10498.85 ms /    31 runs   (  338.67 ms per token,     2.95 tokens per second)
llama_print_timings:       total time =   11248.75 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197324.83 ms
main:    total time = 197324.83 ms
+ echo PASS
PASS
+ echo
...
<bos> When, Where, Why and How of Life

**Part 1: Understanding Our Journey (Why)**

* **Identify your core values:** What matters most to
...
llama_print_timings:        eval time =   10520.88 ms /    31 runs   (  339.38 ms per token,     2.95 tokens per second)
llama_print_timings:       total time =   11270.34 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
### Get to Work: Career Mode

**Concept:**

Get to Work is a new gameplay mode that simulates the challenges
llama_print_timings:        load time =     186.14 ms
llama_print_timings:      sample time =       6.29 ms /    32 runs   (    0.20 ms per token,  5091.49 tokens per second)
llama_print_timings: prompt eval time =      76.01 ms /     2 tokens (   38.00 ms per token,    26.31 tokens per second)
llama_print_timings:        eval time =    2138.43 ms /    31 runs   (   68.98 ms per token,    14.50 tokens per second)
llama_print_timings:       total time =    2283.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Bookkeeper chronicles the story of a young woman named Amelia who discovers a hidden book in a dusty attic and embarks on a journey to understand its secrets.


llama_print_timings:        load time =     156.81 ms
llama_print_timings:      sample time =       6.59 ms /    32 runs   (    0.21 ms per token,  4858.79 tokens per second)
llama_print_timings: prompt eval time =      72.52 ms /     2 tokens (   36.26 ms per token,    27.58 tokens per second)
llama_print_timings:        eval time =    2029.07 ms /    31 runs   (   65.45 ms per token,    15.28 tokens per second)
llama_print_timings:       total time =    2169.23 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say opposites attract, and that couldn't be more true in the case of Emily and Ethan.

Emily, a free spirit with a vibrant personality, was
...
llama_print_timings:       total time =    2213.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekoul, an Egyptian archaeologist, has been excavating at the site of ancient Egypt, El Kabkab.

**Questions:**

1. What is the
llama_print_timings:        load time =     163.24 ms
llama_print_timings:      sample time =       6.66 ms /    32 runs   (    0.21 ms per token,  4806.97 tokens per second)
llama_print_timings: prompt eval time =      77.49 ms /     2 tokens (   38.75 ms per token,    25.81 tokens per second)
llama_print_timings:        eval time =    2159.55 ms /    31 runs   (   69.66 ms per token,    14.35 tokens per second)
llama_print_timings:       total time =    2305.16 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar aims to empower the next generation of entrepreneurs and disrupt the existing business landscape. It provides comprehensive training, mentorship, and networking opportunities to help aspiring entrepreneurs achieve their
...
llama_print_timings: prompt eval time =      66.21 ms /     2 tokens (   33.10 ms per token,    30.21 tokens per second)
llama_print_timings:        eval time =    1490.81 ms /    31 runs   (   48.09 ms per token,    20.79 tokens per second)
llama_print_timings:       total time =    1627.39 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32073.30 ms
main:    total time = 32073.30 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:       total time =    1675.32 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =     298.32 ms /     8 tokens (   37.29 ms per token,    26.82 tokens per second)
llama_print_timings:        eval time =    7247.63 ms /    63 runs   (  115.04 ms per token,     8.69 tokens per second)
llama_print_timings:       total time =    7568.46 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4589.92 ms /   128 tokens (   35.86 ms per token,    27.89 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4603.88 ms /   129 tokens
...
llama_print_timings: prompt eval time =     207.51 ms /     8 tokens (   25.94 ms per token,    38.55 tokens per second)
llama_print_timings:        eval time =    5295.79 ms /    63 runs   (   84.06 ms per token,    11.90 tokens per second)
llama_print_timings:       total time =    5523.04 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2827.64 ms /   128 tokens (   22.09 ms per token,    45.27 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2841.10 ms /   129 tokens
...
llama_print_timings:       total time =    4464.31 ms /    71 tokens
Log end
...
[1]4.1642,
llama_print_timings:        load time =     174.48 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3126.32 ms /   128 tokens (   24.42 ms per token,    40.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3139.31 ms /   129 tokens
...
llama_print_timings: prompt eval time =     374.26 ms /     8 tokens (   46.78 ms per token,    21.38 tokens per second)
llama_print_timings:        eval time =    4558.26 ms /    63 runs   (   72.35 ms per token,    13.82 tokens per second)
llama_print_timings:       total time =    4952.34 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5854.27 ms /   128 tokens (   45.74 ms per token,    21.86 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5867.67 ms /   129 tokens
...
llama_print_timings:        eval time =    4962.43 ms /    63 runs   (   78.77 ms per token,    12.70 tokens per second)
llama_print_timings:       total time =    5379.70 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6263.55 ms /   128 tokens (   48.93 ms per token,    20.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6277.19 ms /   129 tokens
...
llama_print_timings:        eval time =    5195.32 ms /    63 runs   (   82.47 ms per token,    12.13 tokens per second)
llama_print_timings:       total time =    5639.62 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6553.33 ms /   128 tokens (   51.20 ms per token,    19.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6566.99 ms /   129 tokens
...
llama_print_timings:        eval time =    5765.74 ms /    63 runs   (   91.52 ms per token,    10.93 tokens per second)
llama_print_timings:       total time =    6398.55 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9969.06 ms /   128 tokens (   77.88 ms per token,    12.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9982.69 ms /   129 tokens
...
llama_print_timings: prompt eval time =     464.57 ms /     8 tokens (   58.07 ms per token,    17.22 tokens per second)
llama_print_timings:        eval time =    4893.66 ms /    63 runs   (   77.68 ms per token,    12.87 tokens per second)
llama_print_timings:       total time =    5377.32 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7414.75 ms /   128 tokens (   57.93 ms per token,    17.26 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings: prompt eval time =     391.25 ms /     8 tokens (   48.91 ms per token,    20.45 tokens per second)
llama_print_timings:        eval time =    4761.82 ms /    63 runs   (   75.58 ms per token,    13.23 tokens per second)
llama_print_timings:       total time =    5172.03 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6148.41 ms /   128 tokens (   48.03 ms per token,    20.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6162.14 ms /   129 tokens
...
llama_print_timings:        eval time =    5535.92 ms /    63 runs   (   87.87 ms per token,    11.38 tokens per second)
llama_print_timings:       total time =    6023.25 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7243.63 ms /   128 tokens (   56.59 ms per token,    17.67 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7257.16 ms /   129 tokens
...
llama_print_timings: prompt eval time =     518.21 ms /     8 tokens (   64.78 ms per token,    15.44 tokens per second)
llama_print_timings:        eval time =    6131.76 ms /    63 runs   (   97.33 ms per token,    10.27 tokens per second)
llama_print_timings:       total time =    6669.59 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8152.11 ms /   128 tokens (   63.69 ms per token,    15.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8165.43 ms /   129 tokens
...
first run: The quick brown fox has no health.
So it took a very long call, turns out the


second run: The quick brown fox has no health.
So it took a very long call, turns out the


single seq run: The quick brown fox has no health.
So it took a very long call, turns out the
...
alternative type with horizontal line and origin
...
0.35user 0.33system 0:00.68elapsed 100%CPU (0avgtext+0avgdata 6880364maxresident)k
...
0.14user 0.32system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 6879780maxresident)k
