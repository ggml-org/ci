...
- status:  SUCCESS ✅
- runtime: 4:27.94
- date:    Wed Feb 26 11:44:13 UTC 2025
...
0.00.000.273 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.298 I llama_model_loader: loaded meta data with 24 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.004.355 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
...
0.00.008.106 I llama_model_loader: - kv  22:               tokenizer.ggml.mask_token_id u32              = 103
...
0.00.022.714 I load: token to piece cache size = 0.2032 MB
0.00.022.739 I print_info: arch             = bert
0.00.022.739 I print_info: vocab_only       = 0
0.00.022.740 I print_info: n_ctx_train      = 512
0.00.022.740 I print_info: n_embd           = 384
0.00.022.740 I print_info: n_layer          = 12
0.00.022.750 I print_info: n_head           = 12
0.00.022.751 I print_info: n_head_kv        = 12
0.00.022.752 I print_info: n_rot            = 32
0.00.022.752 I print_info: n_swa            = 0
0.00.022.752 I print_info: n_embd_head_k    = 32
0.00.022.753 I print_info: n_embd_head_v    = 32
0.00.022.754 I print_info: n_gqa            = 1
0.00.022.756 I print_info: n_embd_k_gqa     = 384
0.00.022.757 I print_info: n_embd_v_gqa     = 384
0.00.022.758 I print_info: f_norm_eps       = 1.0e-12
0.00.022.759 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.022.759 I print_info: f_clamp_kqv      = 0.0e+00
0.00.022.759 I print_info: f_max_alibi_bias = 0.0e+00
0.00.022.760 I print_info: f_logit_scale    = 0.0e+00
0.00.022.761 I print_info: n_ff             = 1536
0.00.022.761 I print_info: n_expert         = 0
0.00.022.762 I print_info: n_expert_used    = 0
0.00.022.762 I print_info: causal attn      = 0
0.00.022.762 I print_info: pooling type     = 2
0.00.022.763 I print_info: rope type        = 2
0.00.022.763 I print_info: rope scaling     = linear
0.00.022.764 I print_info: freq_base_train  = 10000.0
0.00.022.765 I print_info: freq_scale_train = 1
0.00.022.765 I print_info: n_ctx_orig_yarn  = 512
0.00.022.765 I print_info: rope_finetuned   = unknown
0.00.022.766 I print_info: ssm_d_conv       = 0
0.00.022.766 I print_info: ssm_d_inner      = 0
0.00.022.766 I print_info: ssm_d_state      = 0
...
0.00.022.774 I print_info: BOS token        = 101 '[CLS]'
0.00.022.775 I print_info: UNK token        = 100 '[UNK]'
0.00.022.775 I print_info: SEP token        = 102 '[SEP]'
0.00.022.776 I print_info: PAD token        = 0 '[PAD]'
0.00.022.777 I print_info: MASK token       = 103 '[MASK]'
0.00.022.778 I print_info: LF token         = 0 '[PAD]'
0.00.022.779 I print_info: max token length = 21
0.00.022.781 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.027.606 I load_tensors:          AMX model buffer size =    40.50 MiB
0.00.027.627 I load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.041.393 I llama_init_from_model: n_seq_max     = 1
0.00.041.406 I llama_init_from_model: n_ctx         = 512
0.00.041.407 I llama_init_from_model: n_ctx_per_seq = 512
0.00.041.407 I llama_init_from_model: n_batch       = 2048
0.00.041.408 I llama_init_from_model: n_ubatch      = 2048
0.00.041.408 I llama_init_from_model: flash_attn    = 0
0.00.041.410 I llama_init_from_model: freq_base     = 10000.0
0.00.041.411 I llama_init_from_model: freq_scale    = 1
0.00.041.438 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.043.721 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.043.747 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.043.755 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.046.565 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.046.586 I llama_init_from_model: graph nodes  = 429
0.00.046.586 I llama_init_from_model: graph splits = 1
0.00.046.590 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.046.590 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.050.229 I 
0.00.050.327 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.051.667 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.056.759 I llama_perf_context_print:        load time =      49.91 ms
0.00.056.761 I llama_perf_context_print: prompt eval time =       4.30 ms /     9 tokens (    0.48 ms per token,  2092.54 tokens per second)
0.00.056.763 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.056.763 I llama_perf_context_print:       total time =       6.53 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.272 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.064 I llama_model_loader: - kv  18:            tokenizer.ggml.unknown_token_id u32              = 100
0.00.008.065 I llama_model_loader: - kv  19:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.008.066 I llama_model_loader: - kv  20:            tokenizer.ggml.padding_token_id u32              = 0
0.00.008.066 I llama_model_loader: - kv  21:               tokenizer.ggml.mask_token_id u32              = 103
0.00.008.067 I llama_model_loader: - kv  22:               general.quantization_version u32              = 2
0.00.008.067 I llama_model_loader: - kv  23:                          general.file_type u32              = 7
0.00.008.069 I llama_model_loader: - type  f32:  124 tensors
0.00.008.069 I llama_model_loader: - type q8_0:   73 tensors
0.00.008.071 I print_info: file format = GGUF V3 (latest)
0.00.008.071 I print_info: file type   = Q8_0
0.00.008.074 I print_info: file size   = 34.38 MiB (8.68 BPW) 
0.00.019.393 I load: special tokens cache size = 5
0.00.022.021 I load: token to piece cache size = 0.2032 MB
0.00.022.046 I print_info: arch             = bert
0.00.022.047 I print_info: vocab_only       = 0
...
0.00.022.063 I print_info: n_embd_v_gqa     = 384
0.00.022.064 I print_info: f_norm_eps       = 1.0e-12
...
0.00.022.066 I print_info: n_ff             = 1536
0.00.022.067 I print_info: n_expert         = 0
0.00.022.067 I print_info: n_expert_used    = 0
0.00.022.067 I print_info: causal attn      = 0
0.00.022.067 I print_info: pooling type     = 2
0.00.022.067 I print_info: rope type        = 2
0.00.022.068 I print_info: rope scaling     = linear
...
0.00.022.070 I print_info: ssm_d_inner      = 0
0.00.022.070 I print_info: ssm_d_state      = 0
0.00.022.070 I print_info: ssm_dt_rank      = 0
0.00.022.071 I print_info: ssm_dt_b_c_rms   = 0
...
0.00.022.076 I print_info: BOS token        = 101 '[CLS]'
...
0.00.025.041 I load_tensors:          AMX model buffer size =    24.05 MiB
0.00.025.058 I load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.031.693 I llama_init_from_model: n_seq_max     = 1
0.00.031.720 I llama_init_from_model: n_ctx         = 512
0.00.031.729 I llama_init_from_model: n_ctx_per_seq = 512
0.00.031.738 I llama_init_from_model: n_batch       = 2048
0.00.031.748 I llama_init_from_model: n_ubatch      = 2048
0.00.031.756 I llama_init_from_model: flash_attn    = 0
0.00.031.768 I llama_init_from_model: freq_base     = 10000.0
0.00.031.776 I llama_init_from_model: freq_scale    = 1
0.00.031.856 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.033.933 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.033.972 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.033.989 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.036.627 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.036.646 I llama_init_from_model: graph nodes  = 429
0.00.036.647 I llama_init_from_model: graph splits = 1
0.00.036.660 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.036.661 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.039.747 I 
0.00.039.893 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.040.950 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.043.709 I llama_perf_context_print:        load time =      39.43 ms
0.00.043.711 I llama_perf_context_print: prompt eval time =       2.48 ms /     9 tokens (    0.28 ms per token,  3629.03 tokens per second)
0.00.043.712 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.043.712 I llama_perf_context_print:       total time =       3.96 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.265 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.213 I llama_model_loader: loaded meta data with 28 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.009.253 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.009.254 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.009.256 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.009.257 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
...
0.00.014.627 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
...
0.00.019.348 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.348 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.349 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.349 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.350 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.350 I llama_model_loader: - kv  24:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.351 I llama_model_loader: - kv  25:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.351 I llama_model_loader: - kv  26:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.352 I llama_model_loader: - kv  27:               general.quantization_version u32              = 2
0.00.019.354 I llama_model_loader: - type  f32:   40 tensors
0.00.019.356 I llama_model_loader: - type  f16:   30 tensors
0.00.019.359 I print_info: file format = GGUF V3 (latest)
0.00.019.359 I print_info: file type   = F16
0.00.019.362 I print_info: file size   = 62.78 MiB (16.01 BPW) 
0.00.026.488 W load: empty token at index 5
0.00.036.504 W load: model vocab missing newline token, using special_pad_id instead
0.00.050.562 W load: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.050.716 I load: special tokens cache size = 5
0.00.340.848 I load: token to piece cache size = 1.5060 MB
0.00.340.871 I print_info: arch             = jina-bert-v2
0.00.340.872 I print_info: vocab_only       = 0
0.00.340.872 I print_info: n_ctx_train      = 8192
0.00.340.872 I print_info: n_embd           = 384
0.00.340.873 I print_info: n_layer          = 4
0.00.340.882 I print_info: n_head           = 12
0.00.340.883 I print_info: n_head_kv        = 12
0.00.340.884 I print_info: n_rot            = 32
0.00.340.884 I print_info: n_swa            = 0
0.00.340.884 I print_info: n_embd_head_k    = 32
0.00.340.884 I print_info: n_embd_head_v    = 32
0.00.340.886 I print_info: n_gqa            = 1
0.00.340.887 I print_info: n_embd_k_gqa     = 384
0.00.340.888 I print_info: n_embd_v_gqa     = 384
0.00.340.890 I print_info: f_norm_eps       = 1.0e-12
0.00.340.890 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.340.891 I print_info: f_clamp_kqv      = 0.0e+00
0.00.340.891 I print_info: f_max_alibi_bias = 8.0e+00
0.00.340.891 I print_info: f_logit_scale    = 0.0e+00
0.00.340.893 I print_info: n_ff             = 1536
0.00.340.893 I print_info: n_expert         = 0
0.00.340.893 I print_info: n_expert_used    = 0
0.00.340.893 I print_info: causal attn      = 0
0.00.340.893 I print_info: pooling type     = -1
0.00.340.894 I print_info: rope type        = -1
0.00.340.894 I print_info: rope scaling     = linear
0.00.340.895 I print_info: freq_base_train  = 10000.0
0.00.340.896 I print_info: freq_scale_train = 1
0.00.340.896 I print_info: n_ctx_orig_yarn  = 8192
0.00.340.896 I print_info: rope_finetuned   = unknown
0.00.340.896 I print_info: ssm_d_conv       = 0
0.00.340.897 I print_info: ssm_d_inner      = 0
0.00.340.897 I print_info: ssm_d_state      = 0
0.00.340.897 I print_info: ssm_dt_rank      = 0
0.00.340.897 I print_info: ssm_dt_b_c_rms   = 0
0.00.340.898 I print_info: model type       = 33M
0.00.340.898 I print_info: model params     = 32.90 M
0.00.340.899 I print_info: general.name     = Jina Bert Implementation
0.00.340.901 I print_info: vocab type       = BPE
0.00.340.902 I print_info: n_vocab          = 61056
0.00.340.903 I print_info: n_merges         = 39382
0.00.340.903 I print_info: BOS token        = 0 '<s>'
0.00.340.903 I print_info: EOS token        = 2 '</s>'
0.00.340.903 I print_info: UNK token        = 3 '<unk>'
0.00.340.904 I print_info: SEP token        = 2 '</s>'
0.00.340.904 I print_info: PAD token        = 1 '<pad>'
0.00.340.904 I print_info: MASK token       = 4 '<mask>'
0.00.340.904 I print_info: EOG token        = 2 '</s>'
0.00.340.905 I print_info: max token length = 45
0.00.340.905 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.345.654 I load_tensors:          AMX model buffer size =    18.00 MiB
0.00.345.676 I load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.351.556 I llama_init_from_model: n_seq_max     = 1
0.00.351.571 I llama_init_from_model: n_ctx         = 8192
0.00.351.572 I llama_init_from_model: n_ctx_per_seq = 8192
0.00.351.572 I llama_init_from_model: n_batch       = 2048
0.00.351.572 I llama_init_from_model: n_ubatch      = 2048
...
0.00.351.592 I llama_kv_cache_init: kv_size = 8192, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 4, can_shift = 1
0.00.360.552 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.360.578 I llama_init_from_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.360.587 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.362.643 I llama_init_from_model:        CPU compute buffer size =   220.02 MiB
0.00.362.662 I llama_init_from_model: graph nodes  = 154
0.00.362.662 I llama_init_from_model: graph splits = 1
0.00.362.666 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 8192
0.00.362.666 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.370.856 I 
0.00.370.943 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.371.109 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.371.122 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.127 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.371.128 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.132 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.371.132 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.193 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.383.008 I llama_perf_context_print:        load time =     370.45 ms
0.00.383.009 I llama_perf_context_print: prompt eval time =       7.63 ms /    62 tokens (    0.12 ms per token,  8122.63 tokens per second)
0.00.383.010 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.383.011 I llama_perf_context_print:       total time =      12.15 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.336 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.334 I print_info: file type   = all F32 (guessed)
0.00.021.336 I print_info: file size   = 2.64 GiB (16.01 BPW) 
0.00.052.507 I load: special tokens cache size = 25
0.00.064.506 I load: token to piece cache size = 0.2984 MB
...
0.00.197.435 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.197.449 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.030.232 I llama_init_from_model: n_seq_max     = 1
0.01.030.285 I llama_init_from_model: n_ctx         = 2048
0.01.030.286 I llama_init_from_model: n_ctx_per_seq = 2048
0.01.030.286 I llama_init_from_model: n_batch       = 2048
0.01.030.286 I llama_init_from_model: n_ubatch      = 512
0.01.030.287 I llama_init_from_model: flash_attn    = 0
0.01.030.293 I llama_init_from_model: freq_base     = 10000.0
0.01.030.294 I llama_init_from_model: freq_scale    = 1
0.01.030.321 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.102.293 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.102.318 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.102.351 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.105.664 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.01.105.681 I llama_init_from_model: graph nodes  = 967
0.01.105.681 I llama_init_from_model: graph splits = 1
0.01.105.693 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.01.106.000 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.01.106.012 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.212.724 I main: llama threadpool init, n_threads = 4
0.01.212.745 I 
0.01.212.819 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.212.831 I 
0.01.212.903 I sampler seed: 1234
0.01.212.923 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.212.926 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.212.927 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.212.927 I 
...
0.05.247.740 I llama_perf_sampler_print:    sampling time =       2.48 ms /    71 runs   (    0.03 ms per token, 28663.71 tokens per second)
0.05.247.744 I llama_perf_context_print:        load time =    1211.04 ms
0.05.247.745 I llama_perf_context_print: prompt eval time =     106.57 ms /     7 tokens (   15.22 ms per token,    65.68 tokens per second)
0.05.247.746 I llama_perf_context_print:        eval time =    3915.72 ms /    63 runs   (   62.15 ms per token,    16.09 tokens per second)
0.05.247.746 I llama_perf_context_print:       total time =    4036.13 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.371 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.063.952 I print_info: n_head           = 16
...
0.00.063.970 I print_info: model type       = 1.4B
...
0.00.201.040 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.201.055 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.018.259 I llama_init_from_model: n_seq_max     = 1
0.01.018.276 I llama_init_from_model: n_ctx         = 128
0.01.018.276 I llama_init_from_model: n_ctx_per_seq = 128
0.01.018.277 I llama_init_from_model: n_batch       = 128
0.01.018.277 I llama_init_from_model: n_ubatch      = 128
0.01.018.278 I llama_init_from_model: flash_attn    = 0
0.01.018.283 I llama_init_from_model: freq_base     = 10000.0
0.01.018.284 I llama_init_from_model: freq_scale    = 1
0.01.018.285 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.018.313 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.022.867 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.022.905 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.022.936 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.026.307 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.01.026.323 I llama_init_from_model: graph nodes  = 967
0.01.026.324 I llama_init_from_model: graph splits = 1
0.01.026.329 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.01.026.329 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.098.192 I 
0.01.098.319 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.098.353 I perplexity: tokenizing the input ..
0.01.104.586 I perplexity: tokenization took 6.23 ms
0.01.104.619 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.140.896 I perplexity: 1.04 seconds per pass - ETA 0.02 minutes
[1]10.1485,
0.02.144.898 I Final estimate: PPL = 10.1485 +/- 3.22644

0.02.144.946 I llama_perf_context_print:        load time =    1097.77 ms
0.02.144.976 I llama_perf_context_print: prompt eval time =    1034.44 ms /   128 tokens (    8.08 ms per token,   123.74 tokens per second)
0.02.144.977 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.144.978 I llama_perf_context_print:       total time =    1046.75 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.271 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.098 I print_info: file type   = Q8_0
0.00.021.100 I print_info: file size   = 1.40 GiB (8.51 BPW) 
0.00.052.148 I load: special tokens cache size = 25
0.00.064.138 I load: token to piece cache size = 0.2984 MB
0.00.064.168 I print_info: arch             = gptneox
0.00.064.169 I print_info: vocab_only       = 0
0.00.064.169 I print_info: n_ctx_train      = 2048
0.00.064.169 I print_info: n_embd           = 2048
0.00.064.170 I print_info: n_layer          = 24
...
0.00.157.406 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.157.427 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.321.218 I llama_init_from_model: n_seq_max     = 1
0.00.321.233 I llama_init_from_model: n_ctx         = 2048
0.00.321.234 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.321.234 I llama_init_from_model: n_batch       = 2048
0.00.321.235 I llama_init_from_model: n_ubatch      = 512
0.00.321.235 I llama_init_from_model: flash_attn    = 0
0.00.321.241 I llama_init_from_model: freq_base     = 10000.0
0.00.321.243 I llama_init_from_model: freq_scale    = 1
0.00.321.272 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.392.351 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.392.384 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.392.423 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.395.734 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.395.754 I llama_init_from_model: graph nodes  = 967
0.00.395.755 I llama_init_from_model: graph splits = 1
0.00.395.769 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.396.146 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.396.159 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.494.378 I main: llama threadpool init, n_threads = 4
0.00.494.401 I 
0.00.494.479 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.494.494 I 
0.00.494.612 I sampler seed: 1234
0.00.494.632 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.494.635 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.494.636 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.494.636 I 
I believe the meaning of life is to die, not live." "We're all going to die." "We all are." "We're all going to die." "The answer is no." "I can't do it." "What?" "I can't do it." "What?" "The answer is no." "No!" "It

0.02.750.734 I llama_perf_sampler_print:    sampling time =       2.38 ms /    71 runs   (    0.03 ms per token, 29794.38 tokens per second)
0.02.750.737 I llama_perf_context_print:        load time =     492.75 ms
0.02.750.739 I llama_perf_context_print: prompt eval time =      49.71 ms /     7 tokens (    7.10 ms per token,   140.82 tokens per second)
0.02.750.740 I llama_perf_context_print:        eval time =    2194.27 ms /    63 runs   (   34.83 ms per token,    28.71 tokens per second)
0.02.750.741 I llama_perf_context_print:       total time =    2257.49 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.340 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.546 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.021.154 I print_info: file type   = Q8_0
0.00.021.156 I print_info: file size   = 1.40 GiB (8.51 BPW) 
...
0.00.156.487 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.156.508 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.318.012 I llama_init_from_model: n_seq_max     = 1
0.00.318.043 I llama_init_from_model: n_ctx         = 128
0.00.318.050 I llama_init_from_model: n_ctx_per_seq = 128
0.00.318.057 I llama_init_from_model: n_batch       = 128
0.00.318.064 I llama_init_from_model: n_ubatch      = 128
0.00.318.071 I llama_init_from_model: flash_attn    = 0
0.00.318.083 I llama_init_from_model: freq_base     = 10000.0
0.00.318.093 I llama_init_from_model: freq_scale    = 1
0.00.318.100 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.318.134 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.322.751 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.322.793 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.322.833 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.326.125 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.326.157 I llama_init_from_model: graph nodes  = 967
0.00.326.164 I llama_init_from_model: graph splits = 1
0.00.326.175 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.326.182 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.381.446 I 
0.00.381.575 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.381.606 I perplexity: tokenizing the input ..
0.00.388.151 I perplexity: tokenization took 6.548 ms
0.00.388.182 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.782.586 I perplexity: 0.39 seconds per pass - ETA 0.00 minutes
[1]10.1611,
0.00.786.358 I Final estimate: PPL = 10.1611 +/- 3.23215

0.00.786.406 I llama_perf_context_print:        load time =     381.04 ms
0.00.786.419 I llama_perf_context_print: prompt eval time =     392.43 ms /   128 tokens (    3.07 ms per token,   326.17 tokens per second)
0.00.786.420 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.786.421 I llama_perf_context_print:       total time =     404.96 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.252 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.116.205 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.116.227 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.226.928 I llama_init_from_model: n_seq_max     = 1
0.00.226.944 I llama_init_from_model: n_ctx         = 2048
0.00.226.944 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.226.944 I llama_init_from_model: n_batch       = 2048
0.00.226.945 I llama_init_from_model: n_ubatch      = 512
0.00.226.945 I llama_init_from_model: flash_attn    = 0
0.00.226.950 I llama_init_from_model: freq_base     = 10000.0
0.00.226.951 I llama_init_from_model: freq_scale    = 1
0.00.226.987 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.297.846 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.297.875 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.297.909 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.301.178 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.301.193 I llama_init_from_model: graph nodes  = 967
0.00.301.193 I llama_init_from_model: graph splits = 1
0.00.301.204 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.301.537 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.301.549 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.384.960 I main: llama threadpool init, n_threads = 4
0.00.384.981 I 
0.00.385.056 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.385.069 I 
0.00.385.162 I sampler seed: 1234
0.00.385.182 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.385.185 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.385.185 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.385.186 I 
I believe the meaning of life is to know and experience what you love and to do it." "If you love something, set it free." "You might just find something you didn't know you wanted." "I've always wanted to know the truth." "Now I have." "So I'm gonna get to the truth." "I'm gonna

0.01.901.649 I llama_perf_sampler_print:    sampling time =       2.34 ms /    71 runs   (    0.03 ms per token, 30354.85 tokens per second)
0.01.901.652 I llama_perf_context_print:        load time =     383.41 ms
0.01.901.653 I llama_perf_context_print: prompt eval time =      48.89 ms /     7 tokens (    6.98 ms per token,   143.18 tokens per second)
0.01.901.654 I llama_perf_context_print:        eval time =    1455.83 ms /    63 runs   (   23.11 ms per token,    43.27 tokens per second)
0.01.901.655 I llama_perf_context_print:       total time =    1517.77 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.323 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.063.493 I print_info: pooling type     = 0
...
0.00.114.383 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.114.404 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.225.312 I llama_init_from_model: n_seq_max     = 1
0.00.225.346 I llama_init_from_model: n_ctx         = 128
0.00.225.353 I llama_init_from_model: n_ctx_per_seq = 128
0.00.225.360 I llama_init_from_model: n_batch       = 128
0.00.225.366 I llama_init_from_model: n_ubatch      = 128
0.00.225.373 I llama_init_from_model: flash_attn    = 0
0.00.225.387 I llama_init_from_model: freq_base     = 10000.0
0.00.225.394 I llama_init_from_model: freq_scale    = 1
0.00.225.404 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.225.437 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.230.085 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.230.127 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.230.164 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.233.415 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.233.448 I llama_init_from_model: graph nodes  = 967
0.00.233.455 I llama_init_from_model: graph splits = 1
0.00.233.466 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.233.473 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.272.075 I 
0.00.272.202 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.272.236 I perplexity: tokenizing the input ..
0.00.278.703 I perplexity: tokenization took 6.463 ms
0.00.278.768 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.717.367 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]14.1117,
0.00.721.070 I Final estimate: PPL = 14.1117 +/- 4.42919

0.00.721.113 I llama_perf_context_print:        load time =     271.70 ms
0.00.721.115 I llama_perf_context_print: prompt eval time =     436.86 ms /   128 tokens (    3.41 ms per token,   293.00 tokens per second)
0.00.721.116 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.721.117 I llama_perf_context_print:       total time =     449.04 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.341 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.363 I print_info: file type   = Q4_1
0.00.021.366 I print_info: file size   = 864.46 MiB (5.13 BPW) 
...
0.00.063.108 I print_info: f_clamp_kqv      = 0.0e+00
...
0.00.063.174 I print_info: ssm_dt_b_c_rms   = 0
0.00.063.175 I print_info: model type       = 1.4B
0.00.063.176 I print_info: model params     = 1.41 B
0.00.063.176 I print_info: general.name     = 1.4B
0.00.063.179 I print_info: vocab type       = BPE
0.00.063.180 I print_info: n_vocab          = 50304
0.00.063.180 I print_info: n_merges         = 50009
0.00.063.180 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.063.181 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.063.181 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.063.181 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.063.182 I print_info: LF token         = 187 'Ċ'
0.00.063.182 I print_info: EOG token        = 0 '<|endoftext|>'
...
0.00.119.555 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.119.575 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.243.524 I llama_init_from_model: n_seq_max     = 1
0.00.243.559 I llama_init_from_model: n_ctx         = 2048
0.00.243.567 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.243.573 I llama_init_from_model: n_batch       = 2048
0.00.243.580 I llama_init_from_model: n_ubatch      = 512
0.00.243.588 I llama_init_from_model: flash_attn    = 0
0.00.243.599 I llama_init_from_model: freq_base     = 10000.0
0.00.243.606 I llama_init_from_model: freq_scale    = 1
0.00.243.653 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.314.657 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.314.705 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.314.747 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.318.147 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.318.151 I llama_init_from_model: graph nodes  = 967
0.00.318.151 I llama_init_from_model: graph splits = 1
0.00.318.164 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.318.459 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.318.460 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.402.089 I main: llama threadpool init, n_threads = 4
0.00.402.109 I 
0.00.402.185 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.402.186 I 
0.00.402.289 I sampler seed: 1234
0.00.402.301 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.402.308 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.402.313 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.402.313 I 
...
0.02.029.538 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30616.65 tokens per second)
0.02.029.541 I llama_perf_context_print:        load time =     400.33 ms
0.02.029.542 I llama_perf_context_print: prompt eval time =      45.19 ms /     7 tokens (    6.46 ms per token,   154.89 tokens per second)
0.02.029.543 I llama_perf_context_print:        eval time =    1570.26 ms /    63 runs   (   24.92 ms per token,    40.12 tokens per second)
0.02.029.544 I llama_perf_context_print:       total time =    1628.61 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.319 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.063.819 I print_info: ssm_dt_rank      = 0
...
0.00.063.824 I print_info: n_vocab          = 50304
...
0.00.063.828 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.120.020 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.120.041 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.245.837 I llama_init_from_model: n_seq_max     = 1
0.00.245.851 I llama_init_from_model: n_ctx         = 128
0.00.245.852 I llama_init_from_model: n_ctx_per_seq = 128
0.00.245.852 I llama_init_from_model: n_batch       = 128
0.00.245.852 I llama_init_from_model: n_ubatch      = 128
0.00.245.853 I llama_init_from_model: flash_attn    = 0
0.00.245.858 I llama_init_from_model: freq_base     = 10000.0
0.00.245.859 I llama_init_from_model: freq_scale    = 1
0.00.245.860 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.245.887 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.250.478 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.250.506 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.250.536 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.253.857 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.253.872 I llama_init_from_model: graph nodes  = 967
0.00.253.872 I llama_init_from_model: graph splits = 1
0.00.253.877 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.253.877 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.298.429 I 
0.00.298.596 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.298.619 I perplexity: tokenizing the input ..
0.00.305.143 I perplexity: tokenization took 6.52 ms
0.00.305.175 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.762.128 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]12.6944,
0.00.766.022 I Final estimate: PPL = 12.6944 +/- 3.90928

0.00.766.093 I llama_perf_context_print:        load time =     298.07 ms
0.00.766.110 I llama_perf_context_print: prompt eval time =     455.00 ms /   128 tokens (    3.55 ms per token,   281.32 tokens per second)
0.00.766.111 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.766.112 I llama_perf_context_print:       total time =     467.66 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.259 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.125.915 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.139.525 I llama_init_from_model: n_seq_max     = 1
0.00.139.542 I llama_init_from_model: n_ctx         = 2048
0.00.139.543 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.139.543 I llama_init_from_model: n_batch       = 2048
0.00.139.544 I llama_init_from_model: n_ubatch      = 512
0.00.139.544 I llama_init_from_model: flash_attn    = 0
0.00.139.547 I llama_init_from_model: freq_base     = 10000.0
0.00.139.548 I llama_init_from_model: freq_scale    = 1
0.00.139.577 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.213.146 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.213.177 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.213.203 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.216.428 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.216.444 I llama_init_from_model: graph nodes  = 967
0.00.216.444 I llama_init_from_model: graph splits = 1
0.00.216.456 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.216.818 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.216.831 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.323.984 I main: llama threadpool init, n_threads = 4
0.00.324.003 I 
0.00.324.081 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.324.096 I 
0.00.324.201 I sampler seed: 1234
...
0.02.769.791 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30524.51 tokens per second)
0.02.769.794 I llama_perf_context_print:        load time =     322.38 ms
0.02.769.796 I llama_perf_context_print: prompt eval time =      81.37 ms /     7 tokens (   11.62 ms per token,    86.03 tokens per second)
0.02.769.796 I llama_perf_context_print:        eval time =    2352.28 ms /    63 runs   (   37.34 ms per token,    26.78 tokens per second)
0.02.769.797 I llama_perf_context_print:       total time =    2446.93 ms /    70 tokens
...
0.00.064.475 I load: token to piece cache size = 0.2984 MB
...
0.00.139.841 I llama_init_from_model: n_ctx         = 128
0.00.139.841 I llama_init_from_model: n_ctx_per_seq = 128
0.00.139.842 I llama_init_from_model: n_batch       = 128
0.00.139.842 I llama_init_from_model: n_ubatch      = 128
0.00.139.842 I llama_init_from_model: flash_attn    = 0
0.00.139.845 I llama_init_from_model: freq_base     = 10000.0
0.00.139.846 I llama_init_from_model: freq_scale    = 1
0.00.139.847 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.139.868 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.144.614 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.144.643 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.144.670 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.147.810 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.147.827 I llama_init_from_model: graph nodes  = 967
0.00.147.828 I llama_init_from_model: graph splits = 1
0.00.147.831 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.147.832 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.218.791 I 
0.00.218.904 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.218.927 I perplexity: tokenizing the input ..
0.00.225.212 I perplexity: tokenization took 6.282 ms
0.00.225.241 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.359.159 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0822,
0.01.362.894 I Final estimate: PPL = 10.0822 +/- 3.20340

0.01.362.936 I llama_perf_context_print:        load time =     218.42 ms
0.01.362.953 I llama_perf_context_print: prompt eval time =    1132.08 ms /   128 tokens (    8.84 ms per token,   113.07 tokens per second)
0.01.362.954 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.362.955 I llama_perf_context_print:       total time =    1144.14 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.260 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.062.705 I print_info: n_embd_v_gqa     = 2048
0.00.062.706 I print_info: f_norm_eps       = 1.0e-05
0.00.062.707 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.062.707 I print_info: f_clamp_kqv      = 0.0e+00
0.00.062.707 I print_info: f_max_alibi_bias = 0.0e+00
...
0.00.062.713 I print_info: model params     = 1.41 B
...
0.00.062.718 I print_info: LF token         = 187 'Ċ'
0.00.062.719 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.062.719 I print_info: max token length = 1024
0.00.062.720 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.129.775 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.129.797 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.143.356 I llama_init_from_model: n_seq_max     = 1
0.00.143.374 I llama_init_from_model: n_ctx         = 2048
0.00.143.374 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.143.375 I llama_init_from_model: n_batch       = 2048
0.00.143.375 I llama_init_from_model: n_ubatch      = 512
0.00.143.375 I llama_init_from_model: flash_attn    = 0
0.00.143.378 I llama_init_from_model: freq_base     = 10000.0
0.00.143.379 I llama_init_from_model: freq_scale    = 1
0.00.143.397 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.213.766 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.213.794 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.213.818 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.216.988 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.217.004 I llama_init_from_model: graph nodes  = 967
0.00.217.004 I llama_init_from_model: graph splits = 1
0.00.217.015 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.217.348 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.217.360 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.321.192 I main: llama threadpool init, n_threads = 4
0.00.321.214 I 
0.00.321.289 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.321.301 I 
0.00.321.402 I sampler seed: 1234
0.00.321.425 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.321.429 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.321.430 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.321.430 I 
...
0.02.937.029 I llama_perf_sampler_print:    sampling time =       2.47 ms /    71 runs   (    0.03 ms per token, 28756.58 tokens per second)
0.02.937.032 I llama_perf_context_print:        load time =     319.60 ms
0.02.937.034 I llama_perf_context_print: prompt eval time =     128.68 ms /     7 tokens (   18.38 ms per token,    54.40 tokens per second)
0.02.937.035 I llama_perf_context_print:        eval time =    2475.08 ms /    63 runs   (   39.29 ms per token,    25.45 tokens per second)
0.02.937.036 I llama_perf_context_print:       total time =    2616.95 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.359 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.132.523 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.132.538 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.145.766 I llama_init_from_model: n_seq_max     = 1
0.00.145.784 I llama_init_from_model: n_ctx         = 128
0.00.145.785 I llama_init_from_model: n_ctx_per_seq = 128
0.00.145.785 I llama_init_from_model: n_batch       = 128
0.00.145.785 I llama_init_from_model: n_ubatch      = 128
0.00.145.786 I llama_init_from_model: flash_attn    = 0
0.00.145.789 I llama_init_from_model: freq_base     = 10000.0
0.00.145.790 I llama_init_from_model: freq_scale    = 1
0.00.145.791 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.145.811 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.150.503 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.150.532 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.150.557 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.153.665 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.153.682 I llama_init_from_model: graph nodes  = 967
0.00.153.682 I llama_init_from_model: graph splits = 1
0.00.153.686 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.153.687 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.218.854 I 
0.00.218.962 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.218.971 I perplexity: tokenizing the input ..
0.00.225.326 I perplexity: tokenization took 6.351 ms
0.00.225.355 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.207.543 I perplexity: 1.98 seconds per pass - ETA 0.02 minutes
[1]10.1864,
0.02.211.273 I Final estimate: PPL = 10.1864 +/- 3.18686

0.02.211.315 I llama_perf_context_print:        load time =     218.45 ms
0.02.211.339 I llama_perf_context_print: prompt eval time =    1980.39 ms /   128 tokens (   15.47 ms per token,    64.63 tokens per second)
0.02.211.342 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.211.343 I llama_perf_context_print:       total time =    1992.46 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.303 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.099.770 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.099.791 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.113.442 I llama_init_from_model: n_seq_max     = 1
0.00.113.458 I llama_init_from_model: n_ctx         = 2048
0.00.113.458 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.113.458 I llama_init_from_model: n_batch       = 2048
0.00.113.458 I llama_init_from_model: n_ubatch      = 512
0.00.113.459 I llama_init_from_model: flash_attn    = 0
0.00.113.461 I llama_init_from_model: freq_base     = 10000.0
0.00.113.462 I llama_init_from_model: freq_scale    = 1
0.00.113.482 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.183.884 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.183.913 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.183.943 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.187.088 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.187.110 I llama_init_from_model: graph nodes  = 967
0.00.187.110 I llama_init_from_model: graph splits = 1
0.00.187.121 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.187.486 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.187.499 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.271.141 I main: llama threadpool init, n_threads = 4
0.00.271.162 I 
0.00.271.268 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.271.270 I 
0.00.271.359 I sampler seed: 1234
0.00.271.378 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.271.382 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.271.383 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.271.383 I 
...
0.01.818.232 I llama_perf_sampler_print:    sampling time =       2.01 ms /    71 runs   (    0.03 ms per token, 35340.97 tokens per second)
0.01.818.235 I llama_perf_context_print:        load time =     269.53 ms
0.01.818.237 I llama_perf_context_print: prompt eval time =      85.19 ms /     7 tokens (   12.17 ms per token,    82.17 tokens per second)
0.01.818.238 I llama_perf_context_print:        eval time =    1450.64 ms /    63 runs   (   23.03 ms per token,    43.43 tokens per second)
0.01.818.238 I llama_perf_context_print:       total time =    1548.17 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.317 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.836 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.838 I llama_model_loader: - type  f32:  194 tensors
0.00.020.839 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.839 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.061.884 I print_info: arch             = gptneox
0.00.061.884 I print_info: vocab_only       = 0
0.00.061.884 I print_info: n_ctx_train      = 2048
0.00.061.884 I print_info: n_embd           = 2048
0.00.061.885 I print_info: n_layer          = 24
0.00.061.893 I print_info: n_head           = 16
0.00.061.894 I print_info: n_head_kv        = 16
0.00.061.895 I print_info: n_rot            = 32
0.00.061.895 I print_info: n_swa            = 0
0.00.061.895 I print_info: n_embd_head_k    = 128
0.00.061.896 I print_info: n_embd_head_v    = 128
0.00.061.897 I print_info: n_gqa            = 1
0.00.061.899 I print_info: n_embd_k_gqa     = 2048
0.00.061.900 I print_info: n_embd_v_gqa     = 2048
0.00.061.901 I print_info: f_norm_eps       = 1.0e-05
0.00.061.902 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.061.902 I print_info: f_clamp_kqv      = 0.0e+00
0.00.061.902 I print_info: f_max_alibi_bias = 0.0e+00
0.00.061.903 I print_info: f_logit_scale    = 0.0e+00
0.00.061.904 I print_info: n_ff             = 8192
0.00.061.904 I print_info: n_expert         = 0
0.00.061.904 I print_info: n_expert_used    = 0
0.00.061.905 I print_info: causal attn      = 1
0.00.061.905 I print_info: pooling type     = 0
0.00.061.905 I print_info: rope type        = 2
0.00.061.905 I print_info: rope scaling     = linear
0.00.061.907 I print_info: freq_base_train  = 10000.0
0.00.061.907 I print_info: freq_scale_train = 1
0.00.061.907 I print_info: n_ctx_orig_yarn  = 2048
0.00.061.908 I print_info: rope_finetuned   = unknown
0.00.061.908 I print_info: ssm_d_conv       = 0
0.00.061.908 I print_info: ssm_d_inner      = 0
0.00.061.908 I print_info: ssm_d_state      = 0
0.00.061.908 I print_info: ssm_dt_rank      = 0
0.00.061.909 I print_info: ssm_dt_b_c_rms   = 0
0.00.061.909 I print_info: model type       = 1.4B
0.00.061.910 I print_info: model params     = 1.41 B
0.00.061.910 I print_info: general.name     = 1.4B
0.00.061.912 I print_info: vocab type       = BPE
0.00.061.913 I print_info: n_vocab          = 50304
0.00.061.913 I print_info: n_merges         = 50009
0.00.061.914 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.061.914 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.061.914 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.061.915 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.061.915 I print_info: LF token         = 187 'Ċ'
0.00.061.915 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.061.916 I print_info: max token length = 1024
0.00.061.917 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.097.795 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.097.808 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.111.059 I llama_init_from_model: n_seq_max     = 1
0.00.111.077 I llama_init_from_model: n_ctx         = 128
0.00.111.077 I llama_init_from_model: n_ctx_per_seq = 128
0.00.111.077 I llama_init_from_model: n_batch       = 128
0.00.111.077 I llama_init_from_model: n_ubatch      = 128
...
0.00.111.100 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.115.744 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.115.771 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.115.789 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.118.875 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.118.892 I llama_init_from_model: graph nodes  = 967
0.00.118.892 I llama_init_from_model: graph splits = 1
0.00.118.896 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.118.897 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.162.905 I 
0.00.163.031 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.163.063 I perplexity: tokenizing the input ..
0.00.169.387 I perplexity: tokenization took 6.32 ms
0.00.169.417 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.470.650 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]70.7471,
0.01.474.361 I Final estimate: PPL = 70.7471 +/- 27.47559

0.01.474.412 I llama_perf_context_print:        load time =     162.54 ms
0.01.474.427 I llama_perf_context_print: prompt eval time =    1299.30 ms /   128 tokens (   10.15 ms per token,    98.51 tokens per second)
0.01.474.452 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.474.453 I llama_perf_context_print:       total time =    1311.50 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.301 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.065 I print_info: file type   = Q3_K - Medium
0.00.021.068 I print_info: file size   = 724.27 MiB (4.29 BPW) 
0.00.050.655 I load: special tokens cache size = 25
0.00.062.608 I load: token to piece cache size = 0.2984 MB
0.00.062.632 I print_info: arch             = gptneox
0.00.062.632 I print_info: vocab_only       = 0
0.00.062.632 I print_info: n_ctx_train      = 2048
0.00.062.633 I print_info: n_embd           = 2048
0.00.062.633 I print_info: n_layer          = 24
0.00.062.641 I print_info: n_head           = 16
0.00.062.643 I print_info: n_head_kv        = 16
0.00.062.643 I print_info: n_rot            = 32
0.00.062.643 I print_info: n_swa            = 0
0.00.062.644 I print_info: n_embd_head_k    = 128
0.00.062.644 I print_info: n_embd_head_v    = 128
0.00.062.646 I print_info: n_gqa            = 1
0.00.062.647 I print_info: n_embd_k_gqa     = 2048
0.00.062.649 I print_info: n_embd_v_gqa     = 2048
0.00.062.650 I print_info: f_norm_eps       = 1.0e-05
0.00.062.651 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.062.651 I print_info: f_clamp_kqv      = 0.0e+00
0.00.062.652 I print_info: f_max_alibi_bias = 0.0e+00
0.00.062.652 I print_info: f_logit_scale    = 0.0e+00
0.00.062.653 I print_info: n_ff             = 8192
0.00.062.653 I print_info: n_expert         = 0
0.00.062.653 I print_info: n_expert_used    = 0
0.00.062.653 I print_info: causal attn      = 1
0.00.062.654 I print_info: pooling type     = 0
0.00.062.654 I print_info: rope type        = 2
0.00.062.654 I print_info: rope scaling     = linear
0.00.062.655 I print_info: freq_base_train  = 10000.0
0.00.062.656 I print_info: freq_scale_train = 1
0.00.062.656 I print_info: n_ctx_orig_yarn  = 2048
0.00.062.657 I print_info: rope_finetuned   = unknown
0.00.062.657 I print_info: ssm_d_conv       = 0
0.00.062.657 I print_info: ssm_d_inner      = 0
...
0.00.062.661 I print_info: vocab type       = BPE
0.00.062.662 I print_info: n_vocab          = 50304
0.00.062.662 I print_info: n_merges         = 50009
0.00.062.663 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.062.663 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.062.664 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.062.664 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.062.664 I print_info: LF token         = 187 'Ċ'
0.00.062.665 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.062.665 I print_info: max token length = 1024
0.00.062.666 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.109.307 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.109.329 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.193.735 I llama_init_from_model: n_seq_max     = 1
0.00.193.767 I llama_init_from_model: n_ctx         = 2048
0.00.193.774 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.193.781 I llama_init_from_model: n_batch       = 2048
0.00.193.787 I llama_init_from_model: n_ubatch      = 512
0.00.193.794 I llama_init_from_model: flash_attn    = 0
0.00.193.805 I llama_init_from_model: freq_base     = 10000.0
0.00.193.815 I llama_init_from_model: freq_scale    = 1
0.00.193.849 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.264.538 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.264.583 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.264.623 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.267.983 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.268.016 I llama_init_from_model: graph nodes  = 967
0.00.268.024 I llama_init_from_model: graph splits = 1
0.00.268.043 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.268.357 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.268.377 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.358.863 I main: llama threadpool init, n_threads = 4
0.00.358.885 I 
0.00.358.966 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.358.981 I 
0.00.359.108 I sampler seed: 1234
0.00.359.129 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.359.132 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.359.133 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.359.133 I 
...
0.02.178.949 I llama_perf_sampler_print:    sampling time =       2.43 ms /    71 runs   (    0.03 ms per token, 29266.28 tokens per second)
0.02.178.952 I llama_perf_context_print:        load time =     357.14 ms
0.02.178.954 I llama_perf_context_print: prompt eval time =      68.17 ms /     7 tokens (    9.74 ms per token,   102.69 tokens per second)
0.02.178.955 I llama_perf_context_print:        eval time =    1739.99 ms /    63 runs   (   27.62 ms per token,    36.21 tokens per second)
0.02.178.955 I llama_perf_context_print:       total time =    1821.22 ms /    70 tokens
...
0.00.021.151 I llama_model_loader: - type  f32:  194 tensors
0.00.021.151 I llama_model_loader: - type q3_K:   25 tensors
0.00.021.152 I llama_model_loader: - type q4_K:   71 tensors
0.00.021.152 I llama_model_loader: - type q5_K:    1 tensors
0.00.021.152 I llama_model_loader: - type q6_K:    1 tensors
0.00.021.154 I print_info: file format = GGUF V3 (latest)
0.00.021.155 I print_info: file type   = Q3_K - Medium
0.00.021.158 I print_info: file size   = 724.27 MiB (4.29 BPW) 
...
0.00.110.392 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.110.414 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.193.908 I llama_init_from_model: n_seq_max     = 1
0.00.193.937 I llama_init_from_model: n_ctx         = 128
0.00.193.944 I llama_init_from_model: n_ctx_per_seq = 128
0.00.193.951 I llama_init_from_model: n_batch       = 128
0.00.193.957 I llama_init_from_model: n_ubatch      = 128
0.00.193.964 I llama_init_from_model: flash_attn    = 0
0.00.193.974 I llama_init_from_model: freq_base     = 10000.0
0.00.193.994 I llama_init_from_model: freq_scale    = 1
0.00.194.001 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.194.033 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.198.619 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.198.661 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.198.698 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.202.062 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.202.095 I llama_init_from_model: graph nodes  = 967
0.00.202.102 I llama_init_from_model: graph splits = 1
0.00.202.113 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.202.121 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.247.880 I 
0.00.248.010 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.248.031 I perplexity: tokenizing the input ..
0.00.254.552 I perplexity: tokenization took 6.518 ms
0.00.254.586 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.162.535 I perplexity: 0.91 seconds per pass - ETA 0.00 minutes
[1]12.3725,
0.01.166.217 I Final estimate: PPL = 12.3725 +/- 4.01345

0.01.166.262 I llama_perf_context_print:        load time =     247.50 ms
0.01.166.264 I llama_perf_context_print: prompt eval time =     906.05 ms /   128 tokens (    7.08 ms per token,   141.27 tokens per second)
0.01.166.265 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.166.267 I llama_perf_context_print:       total time =     918.39 ms /   129 tokens
...
0.00.109.997 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.110.048 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.236.774 I llama_init_from_model: n_seq_max     = 1
0.00.236.792 I llama_init_from_model: n_ctx         = 2048
0.00.236.792 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.236.792 I llama_init_from_model: n_batch       = 2048
0.00.236.793 I llama_init_from_model: n_ubatch      = 512
0.00.236.793 I llama_init_from_model: flash_attn    = 0
0.00.236.798 I llama_init_from_model: freq_base     = 10000.0
0.00.236.799 I llama_init_from_model: freq_scale    = 1
0.00.236.827 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.314.534 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.314.567 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.314.603 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.317.928 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.317.949 I llama_init_from_model: graph nodes  = 967
0.00.317.949 I llama_init_from_model: graph splits = 1
0.00.317.962 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.318.311 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.318.324 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.420.664 I main: llama threadpool init, n_threads = 4
0.00.420.687 I 
0.00.420.767 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.420.783 I 
0.00.420.902 I sampler seed: 1234
0.00.420.922 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.420.925 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.420.926 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.420.926 I 
...
0.02.534.164 I llama_perf_sampler_print:    sampling time =       2.61 ms /    71 runs   (    0.04 ms per token, 27171.83 tokens per second)
0.02.534.167 I llama_perf_context_print:        load time =     418.96 ms
0.02.534.169 I llama_perf_context_print: prompt eval time =      65.80 ms /     7 tokens (    9.40 ms per token,   106.39 tokens per second)
0.02.534.170 I llama_perf_context_print:        eval time =    2035.34 ms /    63 runs   (   32.31 ms per token,    30.95 tokens per second)
0.02.534.171 I llama_perf_context_print:       total time =    2114.66 ms /    70 tokens
...
0.00.064.671 I print_info: arch             = gptneox
0.00.064.672 I print_info: vocab_only       = 0
0.00.064.672 I print_info: n_ctx_train      = 2048
0.00.064.673 I print_info: n_embd           = 2048
0.00.064.673 I print_info: n_layer          = 24
0.00.064.682 I print_info: n_head           = 16
0.00.064.683 I print_info: n_head_kv        = 16
0.00.064.683 I print_info: n_rot            = 32
0.00.064.684 I print_info: n_swa            = 0
0.00.064.684 I print_info: n_embd_head_k    = 128
0.00.064.684 I print_info: n_embd_head_v    = 128
0.00.064.686 I print_info: n_gqa            = 1
...
0.00.064.690 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.064.690 I print_info: f_clamp_kqv      = 0.0e+00
...
0.00.064.695 I print_info: freq_scale_train = 1
...
0.00.064.699 I print_info: model params     = 1.41 B
0.00.064.700 I print_info: general.name     = 1.4B
0.00.064.702 I print_info: vocab type       = BPE
0.00.064.703 I print_info: n_vocab          = 50304
0.00.064.703 I print_info: n_merges         = 50009
0.00.064.703 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.064.704 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.064.704 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.064.704 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.064.705 I print_info: LF token         = 187 'Ċ'
0.00.064.705 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.064.706 I print_info: max token length = 1024
0.00.064.706 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.110.583 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.110.600 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.231.922 I llama_init_from_model: n_seq_max     = 1
0.00.231.940 I llama_init_from_model: n_ctx         = 128
0.00.231.941 I llama_init_from_model: n_ctx_per_seq = 128
0.00.231.941 I llama_init_from_model: n_batch       = 128
0.00.231.941 I llama_init_from_model: n_ubatch      = 128
0.00.231.942 I llama_init_from_model: flash_attn    = 0
0.00.231.947 I llama_init_from_model: freq_base     = 10000.0
0.00.231.948 I llama_init_from_model: freq_scale    = 1
0.00.231.949 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.231.978 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.236.647 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.236.675 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.236.705 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.239.930 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.239.948 I llama_init_from_model: graph nodes  = 967
0.00.239.948 I llama_init_from_model: graph splits = 1
0.00.239.953 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.239.953 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.303.450 I 
0.00.303.561 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.303.584 I perplexity: tokenizing the input ..
0.00.310.049 I perplexity: tokenization took 6.461 ms
0.00.310.080 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.885.779 I perplexity: 0.58 seconds per pass - ETA 0.00 minutes
[1]10.3355,
0.00.889.466 I Final estimate: PPL = 10.3355 +/- 3.28881

0.00.889.505 I llama_perf_context_print:        load time =     303.02 ms
0.00.889.520 I llama_perf_context_print: prompt eval time =     573.77 ms /   128 tokens (    4.48 ms per token,   223.09 tokens per second)
0.00.889.521 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.889.521 I llama_perf_context_print:       total time =     586.06 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.305 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.115.094 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.115.117 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.246.295 I llama_init_from_model: n_seq_max     = 1
0.00.246.325 I llama_init_from_model: n_ctx         = 2048
0.00.246.333 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.246.339 I llama_init_from_model: n_batch       = 2048
0.00.246.346 I llama_init_from_model: n_ubatch      = 512
0.00.246.352 I llama_init_from_model: flash_attn    = 0
0.00.246.364 I llama_init_from_model: freq_base     = 10000.0
0.00.246.372 I llama_init_from_model: freq_scale    = 1
0.00.246.414 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.318.665 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.318.716 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.318.758 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.322.112 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.322.228 I llama_init_from_model: graph nodes  = 967
0.00.322.244 I llama_init_from_model: graph splits = 1
0.00.322.259 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.322.567 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.322.579 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.437.087 I main: llama threadpool init, n_threads = 4
0.00.437.113 I 
0.00.437.243 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.437.255 I 
0.00.437.372 I sampler seed: 1234
0.00.437.394 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.437.398 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.437.399 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.437.399 I 
...
0.03.004.290 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31140.35 tokens per second)
0.03.004.294 I llama_perf_context_print:        load time =     435.46 ms
0.03.004.296 I llama_perf_context_print: prompt eval time =      89.44 ms /     7 tokens (   12.78 ms per token,    78.27 tokens per second)
0.03.004.298 I llama_perf_context_print:        eval time =    2465.15 ms /    63 runs   (   39.13 ms per token,    25.56 tokens per second)
0.03.004.299 I llama_perf_context_print:       total time =    2568.31 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.370 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.064.088 I load: token to piece cache size = 0.2984 MB
...
0.00.064.156 I print_info: n_swa            = 0
...
0.00.064.171 I print_info: n_expert         = 0
0.00.064.171 I print_info: n_expert_used    = 0
0.00.064.172 I print_info: causal attn      = 1
0.00.064.172 I print_info: pooling type     = 0
0.00.064.173 I print_info: rope type        = 2
0.00.064.173 I print_info: rope scaling     = linear
...
0.00.115.718 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.115.741 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.250.273 I llama_init_from_model: n_seq_max     = 1
0.00.250.302 I llama_init_from_model: n_ctx         = 128
0.00.250.309 I llama_init_from_model: n_ctx_per_seq = 128
0.00.250.315 I llama_init_from_model: n_batch       = 128
0.00.250.322 I llama_init_from_model: n_ubatch      = 128
0.00.250.328 I llama_init_from_model: flash_attn    = 0
0.00.250.341 I llama_init_from_model: freq_base     = 10000.0
0.00.250.349 I llama_init_from_model: freq_scale    = 1
0.00.250.356 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.250.403 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.254.972 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.255.014 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.255.052 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.258.395 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.258.425 I llama_init_from_model: graph nodes  = 967
0.00.258.432 I llama_init_from_model: graph splits = 1
0.00.258.443 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.258.449 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.338.583 I 
0.00.338.707 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.338.730 I perplexity: tokenizing the input ..
0.00.345.278 I perplexity: tokenization took 6.544 ms
0.00.345.309 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.015.945 I perplexity: 0.67 seconds per pass - ETA 0.00 minutes
[1]11.0242,
0.01.019.699 I Final estimate: PPL = 11.0242 +/- 3.53494

0.01.019.760 I llama_perf_context_print:        load time =     338.17 ms
0.01.019.779 I llama_perf_context_print: prompt eval time =     668.76 ms /   128 tokens (    5.22 ms per token,   191.40 tokens per second)
0.01.019.780 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.019.781 I llama_perf_context_print:       total time =     681.18 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.283 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.976 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
...
0.00.020.981 I print_info: file type   = Q6_K
0.00.020.983 I print_info: file size   = 1.08 GiB (6.57 BPW) 
...
0.00.118.341 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.118.362 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.255.745 I llama_init_from_model: n_seq_max     = 1
0.00.255.760 I llama_init_from_model: n_ctx         = 2048
0.00.255.760 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.255.761 I llama_init_from_model: n_batch       = 2048
0.00.255.761 I llama_init_from_model: n_ubatch      = 512
0.00.255.762 I llama_init_from_model: flash_attn    = 0
0.00.255.767 I llama_init_from_model: freq_base     = 10000.0
0.00.255.768 I llama_init_from_model: freq_scale    = 1
0.00.255.796 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.328.712 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.328.742 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.328.778 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.332.073 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.332.091 I llama_init_from_model: graph nodes  = 967
0.00.332.091 I llama_init_from_model: graph splits = 1
0.00.332.104 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.332.425 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.332.437 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.449.623 I main: llama threadpool init, n_threads = 4
0.00.449.645 I 
0.00.449.718 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.449.731 I 
0.00.449.836 I sampler seed: 1234
0.00.449.871 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, top_n_sigma = -1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.449.874 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.449.874 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.449.875 I 
...
0.03.135.248 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30909.88 tokens per second)
0.03.135.252 I llama_perf_context_print:        load time =     447.92 ms
0.03.135.253 I llama_perf_context_print: prompt eval time =     113.10 ms /     7 tokens (   16.16 ms per token,    61.89 tokens per second)
0.03.135.255 I llama_perf_context_print:        eval time =    2560.43 ms /    63 runs   (   40.64 ms per token,    24.61 tokens per second)
0.03.135.256 I llama_perf_context_print:       total time =    2686.75 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.327 I build: 4781 (3567ee3a) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.190 I print_info: file type   = Q6_K
0.00.021.192 I print_info: file size   = 1.08 GiB (6.57 BPW) 
...
0.00.118.937 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.118.959 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.258.984 I llama_init_from_model: n_seq_max     = 1
0.00.259.037 I llama_init_from_model: n_ctx         = 128
0.00.259.054 I llama_init_from_model: n_ctx_per_seq = 128
0.00.259.072 I llama_init_from_model: n_batch       = 128
0.00.259.104 I llama_init_from_model: n_ubatch      = 128
0.00.259.120 I llama_init_from_model: flash_attn    = 0
0.00.259.142 I llama_init_from_model: freq_base     = 10000.0
0.00.259.173 I llama_init_from_model: freq_scale    = 1
0.00.259.190 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.259.234 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.263.829 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.263.889 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.263.951 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.267.256 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.267.315 I llama_init_from_model: graph nodes  = 967
0.00.267.347 I llama_init_from_model: graph splits = 1
0.00.267.406 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.267.488 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.349.714 I 
0.00.349.834 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.349.868 I perplexity: tokenizing the input ..
0.00.356.359 I perplexity: tokenization took 6.487 ms
0.00.356.420 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.167.035 I perplexity: 0.81 seconds per pass - ETA 0.00 minutes
[1]10.3482,
0.01.170.883 I Final estimate: PPL = 10.3482 +/- 3.30522

0.01.170.929 I llama_perf_context_print:        load time =     349.30 ms
0.01.170.944 I llama_perf_context_print: prompt eval time =     808.82 ms /   128 tokens (    6.32 ms per token,   158.26 tokens per second)
0.01.170.970 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.170.971 I llama_perf_context_print:       total time =     821.22 ms /   129 tokens
...
0.00.312.617 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.312.637 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_init_from_model: graph splits = 1
0.00.298.789 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.298.807 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_init_from_model: n_seq_max     = 1
llama_init_from_model: n_ctx         = 2048
llama_init_from_model: n_ctx_per_seq = 2048
...
0.59user 0.68system 0:01.27elapsed 100%CPU (0avgtext+0avgdata 5356824maxresident)k
