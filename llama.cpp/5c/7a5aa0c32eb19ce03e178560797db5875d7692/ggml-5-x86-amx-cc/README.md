...
- status:  SUCCESS ✅
- runtime: 4:17.26
- date:    Sun Dec  1 18:16:10 UTC 2024
...
0.00.000.268 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.389 I llama_model_loader: - kv   9:                  bert.attention.head_count u32              = 12
0.00.003.393 I llama_model_loader: - kv  10:          bert.attention.layer_norm_epsilon f32              = 0.000000
0.00.003.393 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
...
0.00.007.306 I llama_model_loader: - type  f16:   73 tensors
0.00.018.256 I llm_load_vocab: special tokens cache size = 5
0.00.020.695 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.725 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.726 I llm_load_print_meta: arch             = bert
0.00.020.726 I llm_load_print_meta: vocab type       = WPM
0.00.020.727 I llm_load_print_meta: n_vocab          = 30522
0.00.020.727 I llm_load_print_meta: n_merges         = 0
0.00.020.727 I llm_load_print_meta: vocab_only       = 0
...
0.00.020.737 I llm_load_print_meta: n_head           = 12
...
0.00.020.738 I llm_load_print_meta: n_embd_head_v    = 32
...
0.00.020.756 I llm_load_print_meta: model type       = 33M
0.00.020.757 I llm_load_print_meta: model ftype      = F16
0.00.020.758 I llm_load_print_meta: model params     = 33.21 M
0.00.020.759 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.020.759 I llm_load_print_meta: general.name     = Bge Small
0.00.020.760 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.760 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.760 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.761 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.762 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.762 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.762 I llm_load_print_meta: max token length = 21
0.00.024.711 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.024.728 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.038.970 I llama_new_context_with_model: n_seq_max     = 1
0.00.038.986 I llama_new_context_with_model: n_ctx         = 512
0.00.038.986 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.038.986 I llama_new_context_with_model: n_batch       = 2048
0.00.038.987 I llama_new_context_with_model: n_ubatch      = 2048
0.00.038.987 I llama_new_context_with_model: flash_attn    = 0
...
0.00.040.885 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.042.982 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.043.004 I llama_new_context_with_model: graph nodes  = 429
0.00.043.004 I llama_new_context_with_model: graph splits = 1
0.00.043.006 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.046.357 I 
0.00.046.460 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
...
0.00.052.365 I llama_perf_context_print:        load time =      46.05 ms
0.00.052.367 I llama_perf_context_print: prompt eval time =       3.85 ms /     9 tokens (    0.43 ms per token,  2335.24 tokens per second)
0.00.052.368 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.052.369 I llama_perf_context_print:       total time =       6.01 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.493 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.553 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
0.00.003.577 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
...
0.00.003.586 I llama_model_loader: - kv   3:                           general.basename str              = bge
...
0.00.007.486 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.007.487 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.007.487 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
...
0.00.018.334 I llm_load_vocab: special tokens cache size = 5
0.00.020.772 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.801 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.802 I llm_load_print_meta: arch             = bert
0.00.020.802 I llm_load_print_meta: vocab type       = WPM
0.00.020.803 I llm_load_print_meta: n_vocab          = 30522
0.00.020.803 I llm_load_print_meta: n_merges         = 0
0.00.020.803 I llm_load_print_meta: vocab_only       = 0
...
0.00.020.819 I llm_load_print_meta: pooling type     = 2
...
0.00.020.824 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.824 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
...
0.00.020.828 I llm_load_print_meta: PAD token        = 0 '[PAD]'
...
0.00.023.662 I llm_load_tensors:          AMX model buffer size =    24.05 MiB
0.00.023.678 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.031.327 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.031.345 I llama_new_context_with_model: freq_base     = 10000.0
0.00.031.345 I llama_new_context_with_model: freq_scale    = 1
0.00.032.887 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.032.913 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.032.920 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.035.003 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.035.024 I llama_new_context_with_model: graph nodes  = 429
0.00.035.024 I llama_new_context_with_model: graph splits = 1
0.00.035.026 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.037.163 I 
0.00.037.239 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.038.768 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.040.769 I llama_perf_context_print:        load time =      36.63 ms
0.00.040.771 I llama_perf_context_print: prompt eval time =       1.81 ms /     9 tokens (    0.20 ms per token,  4977.88 tokens per second)
0.00.040.772 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.040.773 I llama_perf_context_print:       total time =       3.61 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.736 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.692 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
...
0.00.008.697 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.697 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.698 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.699 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.702 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.703 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.703 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
...
0.00.019.701 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.702 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.703 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.703 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.704 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.705 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.705 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.706 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.707 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.708 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.708 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.711 I llama_model_loader: - type  f32:   41 tensors
0.00.019.712 I llama_model_loader: - type  f16:   29 tensors
0.00.037.377 W llm_load_vocab: empty token at index 5
0.00.047.973 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.783 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.927 I llm_load_vocab: special tokens cache size = 5
0.00.344.037 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.344.065 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.344.066 I llm_load_print_meta: arch             = jina-bert-v2
0.00.344.067 I llm_load_print_meta: vocab type       = BPE
0.00.344.068 I llm_load_print_meta: n_vocab          = 61056
0.00.344.068 I llm_load_print_meta: n_merges         = 39382
0.00.344.069 I llm_load_print_meta: vocab_only       = 0
0.00.344.070 I llm_load_print_meta: n_ctx_train      = 8192
0.00.344.070 I llm_load_print_meta: n_embd           = 384
0.00.344.071 I llm_load_print_meta: n_layer          = 4
0.00.344.118 I llm_load_print_meta: n_head           = 12
0.00.344.120 I llm_load_print_meta: n_head_kv        = 12
0.00.344.120 I llm_load_print_meta: n_rot            = 32
0.00.344.121 I llm_load_print_meta: n_swa            = 0
0.00.344.121 I llm_load_print_meta: n_embd_head_k    = 32
0.00.344.122 I llm_load_print_meta: n_embd_head_v    = 32
0.00.344.123 I llm_load_print_meta: n_gqa            = 1
0.00.344.124 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.344.125 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.344.128 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.344.128 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.344.129 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.344.131 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.344.131 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.344.132 I llm_load_print_meta: n_ff             = 1536
0.00.344.133 I llm_load_print_meta: n_expert         = 0
0.00.344.133 I llm_load_print_meta: n_expert_used    = 0
0.00.344.134 I llm_load_print_meta: causal attn      = 0
0.00.344.134 I llm_load_print_meta: pooling type     = -1
0.00.344.134 I llm_load_print_meta: rope type        = -1
0.00.344.135 I llm_load_print_meta: rope scaling     = linear
0.00.344.137 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.344.138 I llm_load_print_meta: freq_scale_train = 1
0.00.344.138 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
...
0.00.344.141 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.344.141 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.344.142 I llm_load_print_meta: model type       = 33M
0.00.344.143 I llm_load_print_meta: model ftype      = F16
0.00.344.144 I llm_load_print_meta: model params     = 32.90 M
0.00.344.145 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.344.146 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.344.147 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.344.147 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.344.148 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.344.148 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.344.149 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.344.163 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.344.163 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.344.164 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.344.164 I llm_load_print_meta: max token length = 45
0.00.347.563 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.347.580 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.355.495 I llama_new_context_with_model: n_seq_max     = 1
0.00.355.517 I llama_new_context_with_model: n_ctx         = 8192
0.00.355.517 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.355.518 I llama_new_context_with_model: n_batch       = 2048
0.00.355.518 I llama_new_context_with_model: n_ubatch      = 2048
0.00.355.519 I llama_new_context_with_model: flash_attn    = 0
0.00.355.521 I llama_new_context_with_model: freq_base     = 10000.0
0.00.355.522 I llama_new_context_with_model: freq_scale    = 1
0.00.364.634 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.364.657 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.364.666 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.366.487 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.366.503 I llama_new_context_with_model: graph nodes  = 154
0.00.366.504 I llama_new_context_with_model: graph splits = 1
0.00.366.506 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.375.021 I 
0.00.375.142 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.375.427 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.375.439 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.448 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.375.448 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.455 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.375.456 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.379.342 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.386.830 I llama_perf_context_print:        load time =     374.24 ms
0.00.386.832 I llama_perf_context_print: prompt eval time =       7.33 ms /    62 tokens (    0.12 ms per token,  8460.70 tokens per second)
0.00.386.834 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.386.835 I llama_perf_context_print:       total time =      11.81 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.638 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.757 I llm_load_print_meta: model ftype      = all F32 (guessed)
...
0.00.196.845 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.985.870 I llama_new_context_with_model: n_seq_max     = 1
0.00.985.890 I llama_new_context_with_model: n_ctx         = 2048
0.00.985.890 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.985.890 I llama_new_context_with_model: n_batch       = 2048
0.00.985.891 I llama_new_context_with_model: n_ubatch      = 512
0.00.985.891 I llama_new_context_with_model: flash_attn    = 0
0.00.985.896 I llama_new_context_with_model: freq_base     = 10000.0
0.00.985.897 I llama_new_context_with_model: freq_scale    = 1
0.01.054.954 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.054.988 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.055.020 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.057.286 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.01.057.310 I llama_new_context_with_model: graph nodes  = 967
0.01.057.310 I llama_new_context_with_model: graph splits = 1
0.01.057.315 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.156.810 I main: llama threadpool init, n_threads = 4
0.01.156.843 I 
0.01.156.934 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.156.946 I 
0.01.157.069 I sampler seed: 1234
0.01.157.089 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.157.093 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.157.093 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.157.093 I 
...
0.04.986.695 I llama_perf_sampler_print:    sampling time =       2.35 ms /    71 runs   (    0.03 ms per token, 30174.25 tokens per second)
0.04.986.697 I llama_perf_context_print:        load time =    1155.89 ms
0.04.986.699 I llama_perf_context_print: prompt eval time =      95.62 ms /     7 tokens (   13.66 ms per token,    73.20 tokens per second)
0.04.986.700 I llama_perf_context_print:        eval time =    3722.18 ms /    63 runs   (   59.08 ms per token,    16.93 tokens per second)
0.04.986.700 I llama_perf_context_print:       total time =    3829.89 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.820 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.689 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.690 I llm_load_print_meta: model params     = 1.41 B
0.00.075.691 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.195.262 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.195.282 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.985.000 I llama_new_context_with_model: n_seq_max     = 1
0.00.985.016 I llama_new_context_with_model: n_ctx         = 128
0.00.985.016 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.985.017 I llama_new_context_with_model: n_batch       = 128
0.00.985.017 I llama_new_context_with_model: n_ubatch      = 128
0.00.985.018 I llama_new_context_with_model: flash_attn    = 0
...
0.00.989.771 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.989.800 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.989.825 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.992.032 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.992.052 I llama_new_context_with_model: graph nodes  = 967
0.00.992.052 I llama_new_context_with_model: graph splits = 1
0.00.992.054 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.058.434 I 
0.01.058.557 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.058.585 I perplexity: tokenizing the input ..
0.01.068.116 I perplexity: tokenization took 9.528 ms
0.01.068.155 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.965.265 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.968.877 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.968.920 I llama_perf_context_print:        load time =    1057.57 ms
0.01.968.922 I llama_perf_context_print: prompt eval time =     895.23 ms /   128 tokens (    6.99 ms per token,   142.98 tokens per second)
0.01.968.923 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.968.923 I llama_perf_context_print:       total time =     910.49 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.821 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.241 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.242 I llm_load_print_meta: model params     = 1.41 B
0.00.076.243 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.169.193 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.169.209 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.636.814 I llama_new_context_with_model: n_seq_max     = 1
0.00.636.834 I llama_new_context_with_model: n_ctx         = 2048
0.00.636.834 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.636.835 I llama_new_context_with_model: n_batch       = 2048
0.00.636.835 I llama_new_context_with_model: n_ubatch      = 512
0.00.636.836 I llama_new_context_with_model: flash_attn    = 0
0.00.636.840 I llama_new_context_with_model: freq_base     = 10000.0
0.00.636.841 I llama_new_context_with_model: freq_scale    = 1
0.00.706.399 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.706.429 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.706.462 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.709.354 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.709.371 I llama_new_context_with_model: graph nodes  = 967
0.00.709.372 I llama_new_context_with_model: graph splits = 1
0.00.709.376 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.788.496 I main: llama threadpool init, n_threads = 4
0.00.788.522 I 
0.00.788.609 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.788.622 I 
0.00.788.759 I sampler seed: 1234
0.00.788.779 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.788.782 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.788.783 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.788.783 I 
...
0.02.924.666 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31236.25 tokens per second)
0.02.924.669 I llama_perf_context_print:        load time =     787.41 ms
0.02.924.670 I llama_perf_context_print: prompt eval time =      45.81 ms /     7 tokens (    6.54 ms per token,   152.80 tokens per second)
0.02.924.671 I llama_perf_context_print:        eval time =    2078.48 ms /    63 runs   (   32.99 ms per token,    30.31 tokens per second)
0.02.924.672 I llama_perf_context_print:       total time =    2136.18 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.685 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.164.241 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.164.262 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.615.246 I llama_new_context_with_model: n_seq_max     = 1
0.00.615.268 I llama_new_context_with_model: n_ctx         = 128
0.00.615.269 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.615.269 I llama_new_context_with_model: n_batch       = 128
0.00.615.269 I llama_new_context_with_model: n_ubatch      = 128
0.00.615.270 I llama_new_context_with_model: flash_attn    = 0
0.00.615.275 I llama_new_context_with_model: freq_base     = 10000.0
0.00.615.275 I llama_new_context_with_model: freq_scale    = 1
0.00.615.276 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.620.216 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.620.245 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.620.268 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.622.455 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.622.472 I llama_new_context_with_model: graph nodes  = 967
0.00.622.472 I llama_new_context_with_model: graph splits = 1
0.00.622.475 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.667.198 I 
0.00.667.325 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.667.360 I perplexity: tokenizing the input ..
0.00.676.777 I perplexity: tokenization took 9.413 ms
0.00.676.818 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.047.173 I perplexity: 0.37 seconds per pass - ETA 0.00 minutes
[1]10.1288,
0.01.050.989 I Final estimate: PPL = 10.1288 +/- 3.22324

0.01.051.033 I llama_perf_context_print:        load time =     666.47 ms
0.01.051.035 I llama_perf_context_print: prompt eval time =     368.33 ms /   128 tokens (    2.88 ms per token,   347.51 tokens per second)
0.01.051.037 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.051.038 I llama_perf_context_print:       total time =     383.84 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.656 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.123.614 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.123.630 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.401.811 I llama_new_context_with_model: n_seq_max     = 1
0.00.401.829 I llama_new_context_with_model: n_ctx         = 2048
0.00.401.829 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.401.829 I llama_new_context_with_model: n_batch       = 2048
0.00.401.830 I llama_new_context_with_model: n_ubatch      = 512
0.00.401.830 I llama_new_context_with_model: flash_attn    = 0
0.00.401.834 I llama_new_context_with_model: freq_base     = 10000.0
0.00.401.836 I llama_new_context_with_model: freq_scale    = 1
0.00.469.647 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.469.681 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.469.714 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.471.966 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.471.984 I llama_new_context_with_model: graph nodes  = 967
0.00.471.985 I llama_new_context_with_model: graph splits = 1
0.00.471.989 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.548.704 I main: llama threadpool init, n_threads = 4
0.00.548.737 I 
0.00.548.831 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.548.831 I 
0.00.548.965 I sampler seed: 1234
0.00.548.988 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.548.991 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.548.992 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.548.992 I 
I believe the meaning of life is to know myself. It is to be able to say, “I am a person, I am a mother, a daughter, a sister, a friend, a mother of friends, a sister of sisters, and a sister of all the mothers.” It is to be able to say, “I am a human being

0.01.991.045 I llama_perf_sampler_print:    sampling time =       2.37 ms /    71 runs   (    0.03 ms per token, 29995.78 tokens per second)
0.01.991.048 I llama_perf_context_print:        load time =     547.78 ms
0.01.991.050 I llama_perf_context_print: prompt eval time =      44.74 ms /     7 tokens (    6.39 ms per token,   156.46 tokens per second)
0.01.991.051 I llama_perf_context_print:        eval time =    1385.68 ms /    63 runs   (   21.99 ms per token,    45.47 tokens per second)
0.01.991.052 I llama_perf_context_print:       total time =    1442.35 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.750 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.123.967 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.123.986 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.399.744 I llama_new_context_with_model: n_seq_max     = 1
0.00.399.765 I llama_new_context_with_model: n_ctx         = 128
0.00.399.765 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.399.766 I llama_new_context_with_model: n_batch       = 128
0.00.399.766 I llama_new_context_with_model: n_ubatch      = 128
0.00.399.767 I llama_new_context_with_model: flash_attn    = 0
0.00.399.771 I llama_new_context_with_model: freq_base     = 10000.0
0.00.399.772 I llama_new_context_with_model: freq_scale    = 1
0.00.399.773 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.404.611 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.404.638 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.404.662 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.406.811 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.406.835 I llama_new_context_with_model: graph nodes  = 967
0.00.406.835 I llama_new_context_with_model: graph splits = 1
0.00.406.837 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.448.943 I 
0.00.449.073 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.449.106 I perplexity: tokenizing the input ..
0.00.458.568 I perplexity: tokenization took 9.459 ms
0.00.458.605 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.876.823 I perplexity: 0.42 seconds per pass - ETA 0.00 minutes
[1]14.0715,
0.00.880.655 I Final estimate: PPL = 14.0715 +/- 4.41015

0.00.880.701 I llama_perf_context_print:        load time =     448.15 ms
0.00.880.704 I llama_perf_context_print: prompt eval time =     416.28 ms /   128 tokens (    3.25 ms per token,   307.49 tokens per second)
0.00.880.706 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.880.707 I llama_perf_context_print:       total time =     431.76 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.263 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.129.899 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.129.919 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.435.760 I llama_new_context_with_model: n_seq_max     = 1
0.00.435.782 I llama_new_context_with_model: n_ctx         = 2048
0.00.435.783 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.435.783 I llama_new_context_with_model: n_batch       = 2048
0.00.435.783 I llama_new_context_with_model: n_ubatch      = 512
0.00.435.784 I llama_new_context_with_model: flash_attn    = 0
0.00.435.789 I llama_new_context_with_model: freq_base     = 10000.0
0.00.435.790 I llama_new_context_with_model: freq_scale    = 1
0.00.504.799 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.504.832 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.504.862 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.507.092 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.507.115 I llama_new_context_with_model: graph nodes  = 967
0.00.507.115 I llama_new_context_with_model: graph splits = 1
0.00.507.119 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.582.935 I main: llama threadpool init, n_threads = 4
0.00.582.968 I 
0.00.583.058 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.583.070 I 
0.00.583.192 I sampler seed: 1234
0.00.583.212 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.583.215 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.583.216 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.583.216 I 
...
0.02.117.455 I llama_perf_sampler_print:    sampling time =       2.17 ms /    71 runs   (    0.03 ms per token, 32658.69 tokens per second)
0.02.117.458 I llama_perf_context_print:        load time =     582.41 ms
0.02.117.459 I llama_perf_context_print: prompt eval time =      41.85 ms /     7 tokens (    5.98 ms per token,   167.27 tokens per second)
0.02.117.461 I llama_perf_context_print:        eval time =    1481.21 ms /    63 runs   (   23.51 ms per token,    42.53 tokens per second)
0.02.117.461 I llama_perf_context_print:       total time =    1534.53 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.691 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.732 I llm_load_print_meta: model ftype      = Q4_1
0.00.074.732 I llm_load_print_meta: model params     = 1.41 B
0.00.074.733 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.128.484 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.128.500 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.433.080 I llama_new_context_with_model: n_seq_max     = 1
0.00.433.101 I llama_new_context_with_model: n_ctx         = 128
0.00.433.101 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.433.102 I llama_new_context_with_model: n_batch       = 128
0.00.433.102 I llama_new_context_with_model: n_ubatch      = 128
0.00.433.103 I llama_new_context_with_model: flash_attn    = 0
0.00.433.107 I llama_new_context_with_model: freq_base     = 10000.0
0.00.433.108 I llama_new_context_with_model: freq_scale    = 1
0.00.433.109 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.438.073 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.438.101 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.438.124 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.440.216 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.440.239 I llama_new_context_with_model: graph nodes  = 967
0.00.440.239 I llama_new_context_with_model: graph splits = 1
0.00.440.242 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.481.161 I 
0.00.481.295 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.481.323 I perplexity: tokenizing the input ..
0.00.490.837 I perplexity: tokenization took 9.514 ms
0.00.490.872 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.931.349 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]12.5781,
0.00.935.021 I Final estimate: PPL = 12.5781 +/- 3.87222

0.00.935.067 I llama_perf_context_print:        load time =     480.43 ms
0.00.935.070 I llama_perf_context_print: prompt eval time =     438.62 ms /   128 tokens (    3.43 ms per token,   291.82 tokens per second)
0.00.935.072 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.935.073 I llama_perf_context_print:       total time =     453.91 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.296 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.134.124 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.134.143 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.169.707 I llama_new_context_with_model: n_seq_max     = 1
0.00.169.728 I llama_new_context_with_model: n_ctx         = 2048
0.00.169.728 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.169.729 I llama_new_context_with_model: n_batch       = 2048
0.00.169.729 I llama_new_context_with_model: n_ubatch      = 512
0.00.169.730 I llama_new_context_with_model: flash_attn    = 0
0.00.169.733 I llama_new_context_with_model: freq_base     = 10000.0
0.00.169.734 I llama_new_context_with_model: freq_scale    = 1
0.00.237.280 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.237.310 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.237.339 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.239.563 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.349.593 I 
0.00.349.684 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.349.698 I 
0.00.349.865 I sampler seed: 1234
0.00.349.886 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.349.889 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.349.890 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.349.890 I 
I believe the meaning of life is to do what is best for your self, and to be happy, and to enjoy the present moment, and to let go of the past, and to enjoy the moment, and to enjoy the life you have here on Earth." The words are spoken in a calm, measured tone, but the message is clear: it

0.02.721.122 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31113.06 tokens per second)
0.02.721.125 I llama_perf_context_print:        load time =     348.99 ms
0.02.721.127 I llama_perf_context_print: prompt eval time =     126.44 ms /     7 tokens (   18.06 ms per token,    55.36 tokens per second)
0.02.721.129 I llama_perf_context_print:        eval time =    2233.18 ms /    63 runs   (   35.45 ms per token,    28.21 tokens per second)
0.02.721.130 I llama_perf_context_print:       total time =    2371.57 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.710 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.595 I llm_load_print_meta: rope type        = 2
...
0.00.075.598 I llm_load_print_meta: rope_finetuned   = unknown
0.00.075.598 I llm_load_print_meta: ssm_d_conv       = 0
...
0.00.075.600 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.601 I llm_load_print_meta: model params     = 1.41 B
0.00.075.602 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.133.805 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.133.823 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.169.327 I llama_new_context_with_model: n_seq_max     = 1
0.00.169.349 I llama_new_context_with_model: n_ctx         = 128
0.00.169.349 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.169.349 I llama_new_context_with_model: n_batch       = 128
0.00.169.349 I llama_new_context_with_model: n_ubatch      = 128
0.00.169.350 I llama_new_context_with_model: flash_attn    = 0
0.00.169.353 I llama_new_context_with_model: freq_base     = 10000.0
0.00.169.354 I llama_new_context_with_model: freq_scale    = 1
0.00.169.355 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.174.098 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.174.125 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.174.146 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.176.265 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.176.281 I llama_new_context_with_model: graph nodes  = 967
0.00.176.282 I llama_new_context_with_model: graph splits = 1
0.00.176.284 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.250.862 I 
0.00.250.998 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.251.025 I perplexity: tokenizing the input ..
0.00.260.459 I perplexity: tokenization took 9.436 ms
0.00.260.502 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.364.763 I perplexity: 1.10 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.368.621 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.368.662 I llama_perf_context_print:        load time =     250.11 ms
0.01.368.665 I llama_perf_context_print: prompt eval time =    1102.50 ms /   128 tokens (    8.61 ms per token,   116.10 tokens per second)
0.01.368.666 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.368.667 I llama_perf_context_print:       total time =    1117.80 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.280 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.504 I main: llama backend init
0.00.000.522 I main: load the model and apply lora adapter, if any
0.00.009.151 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.075.536 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.537 I llm_load_print_meta: model params     = 1.41 B
0.00.075.538 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.139.435 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.139.453 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.175.714 I llama_new_context_with_model: n_seq_max     = 1
0.00.175.732 I llama_new_context_with_model: n_ctx         = 2048
0.00.175.732 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.175.733 I llama_new_context_with_model: n_batch       = 2048
0.00.175.733 I llama_new_context_with_model: n_ubatch      = 512
0.00.175.733 I llama_new_context_with_model: flash_attn    = 0
0.00.175.737 I llama_new_context_with_model: freq_base     = 10000.0
0.00.175.738 I llama_new_context_with_model: freq_scale    = 1
0.00.244.058 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.244.090 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.244.121 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.246.941 I llama_new_context_with_model: graph splits = 1
0.00.246.945 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.337.390 I main: llama threadpool init, n_threads = 4
0.00.337.422 I 
0.00.337.512 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.337.524 I 
0.00.337.731 I sampler seed: 1234
0.00.337.752 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.337.755 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.337.756 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.337.756 I 
...
0.02.835.439 I llama_perf_sampler_print:    sampling time =       2.23 ms /    71 runs   (    0.03 ms per token, 31767.34 tokens per second)
0.02.835.442 I llama_perf_context_print:        load time =     336.85 ms
0.02.835.444 I llama_perf_context_print: prompt eval time =     126.64 ms /     7 tokens (   18.09 ms per token,    55.27 tokens per second)
0.02.835.445 I llama_perf_context_print:        eval time =    2359.63 ms /    63 runs   (   37.45 ms per token,    26.70 tokens per second)
0.02.835.445 I llama_perf_context_print:       total time =    2498.06 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.700 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.176 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.020.876 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
...
0.00.075.203 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.204 I llm_load_print_meta: model params     = 1.41 B
0.00.075.205 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.140.236 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.140.253 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.175.123 I llama_new_context_with_model: n_seq_max     = 1
0.00.175.143 I llama_new_context_with_model: n_ctx         = 128
0.00.175.144 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.175.144 I llama_new_context_with_model: n_batch       = 128
0.00.175.144 I llama_new_context_with_model: n_ubatch      = 128
0.00.175.145 I llama_new_context_with_model: flash_attn    = 0
0.00.175.148 I llama_new_context_with_model: freq_base     = 10000.0
0.00.175.148 I llama_new_context_with_model: freq_scale    = 1
0.00.175.149 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.179.793 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.179.820 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.179.840 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.182.407 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.182.430 I llama_new_context_with_model: graph nodes  = 967
0.00.182.430 I llama_new_context_with_model: graph splits = 1
0.00.182.433 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.242.528 I 
0.00.242.706 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.242.729 I perplexity: tokenizing the input ..
0.00.252.199 I perplexity: tokenization took 9.465 ms
0.00.252.231 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.159.329 I perplexity: 1.91 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.163.059 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.163.099 I llama_perf_context_print:        load time =     241.78 ms
0.02.163.116 I llama_perf_context_print: prompt eval time =    1905.25 ms /   128 tokens (   14.88 ms per token,    67.18 tokens per second)
0.02.163.132 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.163.158 I llama_perf_context_print:       total time =    1920.57 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.633 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.406 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.021.409 I llama_model_loader: - type  f32:  194 tensors
0.00.021.409 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.410 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.075.661 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.662 I llm_load_print_meta: model params     = 1.41 B
0.00.075.663 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.109.608 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.109.625 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.145.125 I llama_new_context_with_model: n_seq_max     = 1
0.00.145.147 I llama_new_context_with_model: n_ctx         = 2048
...
0.00.145.151 I llama_new_context_with_model: freq_base     = 10000.0
0.00.145.152 I llama_new_context_with_model: freq_scale    = 1
0.00.214.581 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.214.611 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.214.640 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.216.860 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.216.880 I llama_new_context_with_model: graph nodes  = 967
0.00.216.880 I llama_new_context_with_model: graph splits = 1
0.00.216.884 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.326 I main: llama threadpool init, n_threads = 4
0.00.290.357 I 
0.00.290.444 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.290.456 I 
0.00.290.584 I sampler seed: 1234
0.00.290.604 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.290.607 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.290.608 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.290.608 I 
I believe the meaning of life is a one-f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <

0.01.781.429 I llama_perf_sampler_print:    sampling time =       1.99 ms /    71 runs   (    0.03 ms per token, 35642.57 tokens per second)
0.01.781.432 I llama_perf_context_print:        load time =     289.42 ms
0.01.781.433 I llama_perf_context_print: prompt eval time =      76.93 ms /     7 tokens (   10.99 ms per token,    90.99 tokens per second)
0.01.781.434 I llama_perf_context_print:        eval time =    1402.98 ms /    63 runs   (   22.27 ms per token,    44.90 tokens per second)
0.01.781.435 I llama_perf_context_print:       total time =    1491.11 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.716 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.398 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.075.879 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.880 I llm_load_print_meta: model params     = 1.41 B
0.00.075.881 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.112.109 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.112.127 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.147.805 I llama_new_context_with_model: n_seq_max     = 1
0.00.147.824 I llama_new_context_with_model: n_ctx         = 128
0.00.147.825 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.147.825 I llama_new_context_with_model: n_batch       = 128
0.00.147.826 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.147.833 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.152.629 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.152.659 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.152.684 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.155.377 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.155.399 I llama_new_context_with_model: graph nodes  = 967
...
0.00.193.535 I 
0.00.193.667 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.193.701 I perplexity: tokenizing the input ..
0.00.203.165 I perplexity: tokenization took 9.458 ms
0.00.203.201 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.457.369 I perplexity: 1.25 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.461.091 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.461.136 I llama_perf_context_print:        load time =     192.78 ms
0.01.461.138 I llama_perf_context_print: prompt eval time =    1252.37 ms /   128 tokens (    9.78 ms per token,   102.21 tokens per second)
0.01.461.140 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.461.141 I llama_perf_context_print:       total time =    1267.60 ms /   129 tokens
...
0.00.123.061 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.123.077 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.330.290 I llama_new_context_with_model: n_seq_max     = 1
0.00.330.306 I llama_new_context_with_model: n_ctx         = 2048
0.00.330.307 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.330.307 I llama_new_context_with_model: n_batch       = 2048
0.00.330.307 I llama_new_context_with_model: n_ubatch      = 512
0.00.330.308 I llama_new_context_with_model: flash_attn    = 0
0.00.330.312 I llama_new_context_with_model: freq_base     = 10000.0
0.00.330.313 I llama_new_context_with_model: freq_scale    = 1
0.00.402.045 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.402.070 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.402.103 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.404.907 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.404.928 I llama_new_context_with_model: graph nodes  = 967
0.00.404.929 I llama_new_context_with_model: graph splits = 1
0.00.404.934 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.486.275 I main: llama threadpool init, n_threads = 4
0.00.486.307 I 
0.00.486.394 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.486.407 I 
0.00.486.539 I sampler seed: 1234
0.00.486.560 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.486.563 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.486.564 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.486.564 I 
I believe the meaning of life is that one should never feel the need to be the best at anything, but rather, that one should be the best in whatever one does. This is a good philosophy, and I believe it to be a good basis for understanding how our lives are lived, as well as how we should live them.

It is

0.02.199.626 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31611.75 tokens per second)
0.02.199.629 I llama_perf_context_print:        load time =     485.37 ms
0.02.199.631 I llama_perf_context_print: prompt eval time =      64.07 ms /     7 tokens (    9.15 ms per token,   109.26 tokens per second)
0.02.199.632 I llama_perf_context_print:        eval time =    1637.79 ms /    63 runs   (   26.00 ms per token,    38.47 tokens per second)
0.02.199.633 I llama_perf_context_print:       total time =    1713.36 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.764 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.479 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.021.482 I llama_model_loader: - type  f32:  194 tensors
0.00.021.483 I llama_model_loader: - type q3_K:   25 tensors
0.00.021.483 I llama_model_loader: - type q4_K:   71 tensors
0.00.021.483 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.075.913 I llm_load_print_meta: model ftype      = Q3_K - Medium
...
0.00.121.707 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.121.725 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.321.272 I llama_new_context_with_model: n_seq_max     = 1
0.00.321.294 I llama_new_context_with_model: n_ctx         = 128
0.00.321.295 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.321.295 I llama_new_context_with_model: n_batch       = 128
0.00.321.295 I llama_new_context_with_model: n_ubatch      = 128
0.00.321.296 I llama_new_context_with_model: flash_attn    = 0
0.00.321.301 I llama_new_context_with_model: freq_base     = 10000.0
0.00.321.302 I llama_new_context_with_model: freq_scale    = 1
0.00.321.303 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.326.206 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.326.236 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.326.263 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.328.473 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.328.490 I llama_new_context_with_model: graph nodes  = 967
0.00.328.491 I llama_new_context_with_model: graph splits = 1
0.00.328.493 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.374.738 I 
...
0.00.374.867 I perplexity: tokenizing the input ..
0.00.384.329 I perplexity: tokenization took 9.458 ms
0.00.384.360 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.247.664 I perplexity: 0.86 seconds per pass - ETA 0.00 minutes
[1]12.3344,
0.01.251.312 I Final estimate: PPL = 12.3344 +/- 4.02919

0.01.251.354 I llama_perf_context_print:        load time =     373.93 ms
0.01.251.355 I llama_perf_context_print: prompt eval time =     861.47 ms /   128 tokens (    6.73 ms per token,   148.58 tokens per second)
0.01.251.357 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.251.357 I llama_perf_context_print:       total time =     876.62 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.311 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.130.580 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.130.597 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.453.057 I llama_new_context_with_model: n_seq_max     = 1
0.00.453.078 I llama_new_context_with_model: n_ctx         = 2048
0.00.453.078 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.453.079 I llama_new_context_with_model: n_batch       = 2048
0.00.453.079 I llama_new_context_with_model: n_ubatch      = 512
0.00.453.080 I llama_new_context_with_model: flash_attn    = 0
0.00.453.084 I llama_new_context_with_model: freq_base     = 10000.0
0.00.453.085 I llama_new_context_with_model: freq_scale    = 1
0.00.520.439 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.520.470 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.520.503 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.523.267 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.523.288 I llama_new_context_with_model: graph nodes  = 967
0.00.523.289 I llama_new_context_with_model: graph splits = 1
0.00.523.293 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.612.122 I main: llama threadpool init, n_threads = 4
0.00.612.153 I 
0.00.612.241 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.612.256 I 
0.00.612.414 I sampler seed: 1234
0.00.612.435 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.612.438 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.612.438 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.612.438 I 
...
0.02.660.949 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31724.75 tokens per second)
0.02.660.952 I llama_perf_context_print:        load time =     611.49 ms
0.02.660.954 I llama_perf_context_print: prompt eval time =      68.45 ms /     7 tokens (    9.78 ms per token,   102.27 tokens per second)
0.02.660.956 I llama_perf_context_print:        eval time =    1968.51 ms /    63 runs   (   31.25 ms per token,    32.00 tokens per second)
0.02.660.957 I llama_perf_context_print:       total time =    2048.83 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.322 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.663 I llama_model_loader: - type q6_K:   13 tensors
...
0.00.074.320 I llm_load_print_meta: n_merges         = 50009
...
0.00.128.881 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.128.900 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.453.281 I llama_new_context_with_model: n_seq_max     = 1
0.00.453.299 I llama_new_context_with_model: n_ctx         = 128
0.00.453.299 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.453.300 I llama_new_context_with_model: n_batch       = 128
0.00.453.300 I llama_new_context_with_model: n_ubatch      = 128
0.00.453.301 I llama_new_context_with_model: flash_attn    = 0
0.00.453.304 I llama_new_context_with_model: freq_base     = 10000.0
0.00.453.305 I llama_new_context_with_model: freq_scale    = 1
0.00.453.306 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.458.346 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.458.375 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.458.399 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.460.429 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.460.453 I llama_new_context_with_model: graph nodes  = 967
0.00.460.453 I llama_new_context_with_model: graph splits = 1
0.00.460.455 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.511.680 I 
0.00.511.800 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.511.824 I perplexity: tokenizing the input ..
0.00.521.241 I perplexity: tokenization took 9.412 ms
0.00.521.270 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.067.821 I perplexity: 0.55 seconds per pass - ETA 0.00 minutes
[1]10.4776,
0.01.071.509 I Final estimate: PPL = 10.4776 +/- 3.36742

0.01.071.549 I llama_perf_context_print:        load time =     511.32 ms
0.01.071.550 I llama_perf_context_print: prompt eval time =     544.79 ms /   128 tokens (    4.26 ms per token,   234.95 tokens per second)
0.01.071.552 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.071.553 I llama_perf_context_print:       total time =     559.87 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.618 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.069 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.070 I llm_load_print_meta: model params     = 1.41 B
0.00.075.071 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.136.889 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.136.907 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.517.444 I llama_new_context_with_model: n_seq_max     = 1
0.00.517.466 I llama_new_context_with_model: n_ctx         = 2048
0.00.517.466 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.517.467 I llama_new_context_with_model: n_batch       = 2048
0.00.517.467 I llama_new_context_with_model: n_ubatch      = 512
0.00.517.468 I llama_new_context_with_model: flash_attn    = 0
0.00.517.473 I llama_new_context_with_model: freq_base     = 10000.0
0.00.517.474 I llama_new_context_with_model: freq_scale    = 1
0.00.585.769 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.585.802 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.585.834 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.588.052 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.588.076 I llama_new_context_with_model: graph nodes  = 967
0.00.588.076 I llama_new_context_with_model: graph splits = 1
0.00.588.081 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.690.577 I main: llama threadpool init, n_threads = 4
0.00.690.611 I 
0.00.690.706 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.690.722 I 
0.00.690.860 I sampler seed: 1234
0.00.690.882 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.690.885 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.690.885 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.690.885 I 
I believe the meaning of life is to do the things we love, the things we are good at, the things we are good at doing, and the things that are good at doing. If we do those, we are happy. If we do not, then we are miserable, and we will do those things we hate the most.

I

0.03.110.882 I llama_perf_sampler_print:    sampling time =       2.29 ms /    71 runs   (    0.03 ms per token, 31058.62 tokens per second)
0.03.110.885 I llama_perf_context_print:        load time =     689.63 ms
0.03.110.886 I llama_perf_context_print: prompt eval time =      85.85 ms /     7 tokens (   12.26 ms per token,    81.54 tokens per second)
0.03.110.887 I llama_perf_context_print:        eval time =    2322.46 ms /    63 runs   (   36.86 ms per token,    27.13 tokens per second)
0.03.110.888 I llama_perf_context_print:       total time =    2420.32 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.672 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.920 I llm_load_print_meta: model ftype      = Q5_K - Medium
...
0.00.135.275 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.135.294 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.512.814 I llama_new_context_with_model: n_seq_max     = 1
0.00.512.867 I llama_new_context_with_model: n_ctx         = 128
0.00.512.867 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.512.868 I llama_new_context_with_model: n_batch       = 128
0.00.512.868 I llama_new_context_with_model: n_ubatch      = 128
0.00.512.868 I llama_new_context_with_model: flash_attn    = 0
0.00.512.873 I llama_new_context_with_model: freq_base     = 10000.0
0.00.512.873 I llama_new_context_with_model: freq_scale    = 1
0.00.512.874 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.517.705 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.517.734 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.517.758 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.519.858 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.519.881 I llama_new_context_with_model: graph nodes  = 967
0.00.519.881 I llama_new_context_with_model: graph splits = 1
0.00.519.884 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.585.203 I 
0.00.585.340 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.585.350 I perplexity: tokenizing the input ..
0.00.594.843 I perplexity: tokenization took 9.488 ms
0.00.594.882 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.229.836 I perplexity: 0.63 seconds per pass - ETA 0.00 minutes
[1]10.6642,
0.01.233.464 I Final estimate: PPL = 10.6642 +/- 3.40033

0.01.233.511 I llama_perf_context_print:        load time =     584.49 ms
0.01.233.513 I llama_perf_context_print: prompt eval time =     632.94 ms /   128 tokens (    4.94 ms per token,   202.23 tokens per second)
0.01.233.514 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.233.515 I llama_perf_context_print:       total time =     648.31 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.628 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.729 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.136.475 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.136.493 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.526.205 I llama_new_context_with_model: n_seq_max     = 1
0.00.526.226 I llama_new_context_with_model: n_ctx         = 2048
0.00.526.226 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.526.227 I llama_new_context_with_model: n_batch       = 2048
0.00.526.227 I llama_new_context_with_model: n_ubatch      = 512
0.00.526.228 I llama_new_context_with_model: flash_attn    = 0
0.00.526.232 I llama_new_context_with_model: freq_base     = 10000.0
0.00.526.233 I llama_new_context_with_model: freq_scale    = 1
0.00.594.839 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.594.864 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.594.900 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.597.611 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.597.635 I llama_new_context_with_model: graph nodes  = 967
0.00.597.635 I llama_new_context_with_model: graph splits = 1
0.00.597.640 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.713.894 I main: llama threadpool init, n_threads = 4
0.00.713.929 I 
0.00.714.024 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.714.037 I 
0.00.714.183 I sampler seed: 1234
0.00.714.204 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.714.207 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.714.208 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.714.208 I 
...
0.03.440.982 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31938.82 tokens per second)
0.03.440.986 I llama_perf_context_print:        load time =     713.00 ms
0.03.440.987 I llama_perf_context_print: prompt eval time =     114.35 ms /     7 tokens (   16.34 ms per token,    61.21 tokens per second)
0.03.440.989 I llama_perf_context_print:        eval time =    2600.66 ms /    63 runs   (   41.28 ms per token,    24.22 tokens per second)
0.03.440.990 I llama_perf_context_print:       total time =    2727.10 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.704 I build: 4235 (5c7a5aa0) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.135.989 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.136.007 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.526.705 I llama_new_context_with_model: n_seq_max     = 1
0.00.526.727 I llama_new_context_with_model: n_ctx         = 128
0.00.526.727 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.526.727 I llama_new_context_with_model: n_batch       = 128
0.00.526.727 I llama_new_context_with_model: n_ubatch      = 128
0.00.526.728 I llama_new_context_with_model: flash_attn    = 0
0.00.526.732 I llama_new_context_with_model: freq_base     = 10000.0
0.00.526.733 I llama_new_context_with_model: freq_scale    = 1
0.00.526.734 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.531.665 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.531.688 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.531.715 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.534.463 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.534.485 I llama_new_context_with_model: graph nodes  = 967
0.00.534.485 I llama_new_context_with_model: graph splits = 1
0.00.534.488 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.627.785 I 
0.00.627.923 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.627.933 I perplexity: tokenizing the input ..
0.00.637.362 I perplexity: tokenization took 9.423 ms
0.00.637.403 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.409.864 I perplexity: 0.77 seconds per pass - ETA 0.00 minutes
[1]10.4463,
0.01.413.798 I Final estimate: PPL = 10.4463 +/- 3.33301

0.01.413.843 I llama_perf_context_print:        load time =     627.03 ms
0.01.413.845 I llama_perf_context_print: prompt eval time =     770.58 ms /   128 tokens (    6.02 ms per token,   166.11 tokens per second)
0.01.413.847 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.413.848 I llama_perf_context_print:       total time =     786.06 ms /   129 tokens
...
0.00.471.296 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.484.469 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.61user 0.63system 0:01.24elapsed 100%CPU (0avgtext+0avgdata 5357720maxresident)k
...
0.47user 0.64system 0:01.11elapsed 100%CPU (0avgtext+0avgdata 5355908maxresident)k
