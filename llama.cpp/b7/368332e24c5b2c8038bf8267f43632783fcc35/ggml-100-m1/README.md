...
- status:  SUCCESS ✅
- runtime: 800.49
- date:    Sat Apr 27 18:58:18 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   93.20 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 195.65 sec*proc (23 tests)

Total Test time (real) = 195.66 sec
...
Test project /Users/ggml/work/llama.cpp/build-ci-release
      Start  1: test-quantize-fns
 1/23 Test  #1: test-quantize-fns ...................   Passed   20.11 sec
      Start  2: test-quantize-perf
...
15/23 Test #15: test-tokenizer-1-starcoder ..........   Passed    0.67 sec
      Start 16: test-tokenizer-1-gpt2
16/23 Test #16: test-tokenizer-1-gpt2 ...............   Passed    0.74 sec
      Start 17: test-grammar-parser
...
llama_print_timings:        load time =      64.95 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.65 ms /     9 tokens (    1.29 ms per token,   772.27 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.45 ms /     9 tokens (    1.27 ms per token,   786.03 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Soar is a leadership development company specializing in empowering individuals and organizations. They provide customized leadership training, coaching, and consulting services.

**So Soar's
llama_print_timings:        load time =    2602.67 ms
llama_print_timings:      sample time =      58.30 ms /    32 runs   (    1.82 ms per token,   548.85 tokens per second)
llama_print_timings: prompt eval time =     195.56 ms /     2 tokens (   97.78 ms per token,    10.23 tokens per second)
llama_print_timings:        eval time =    1503.56 ms /    31 runs   (   48.50 ms per token,    20.62 tokens per second)
llama_print_timings:       total time =    2555.76 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Shelliad has been accused of witchcraft. What should be done?

The accusation against Shelliad has sparked outrage and calls for an investigation. As per established
llama_print_timings:        load time =    2734.83 ms
llama_print_timings:      sample time =      57.31 ms /    32 runs   (    1.79 ms per token,   558.34 tokens per second)
llama_print_timings: prompt eval time =     203.29 ms /     2 tokens (  101.65 ms per token,     9.84 tokens per second)
llama_print_timings:        eval time =    1500.42 ms /    31 runs   (   48.40 ms per token,    20.66 tokens per second)
llama_print_timings:       total time =    2538.43 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soar is a flight simulation software that offers a variety of features and experiences, including:

**Realistic Flight Simulations:**

- Accurate physics engine
- Diverse aircraft
llama_print_timings:        load time =    2682.74 ms
llama_print_timings:      sample time =      56.76 ms /    32 runs   (    1.77 ms per token,   563.77 tokens per second)
llama_print_timings: prompt eval time =     197.53 ms /     2 tokens (   98.76 ms per token,    10.13 tokens per second)
llama_print_timings:        eval time =    1496.40 ms /    31 runs   (   48.27 ms per token,    20.72 tokens per second)
llama_print_timings:       total time =    2502.52 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> The Little Mermaid follows Ariel, a human princess who desires to become human and escape the constraints of her underwater life. With the help of a sea witch, she makes
llama_print_timings:        load time =    1848.26 ms
llama_print_timings:      sample time =      16.61 ms /    32 runs   (    0.52 ms per token,  1927.13 tokens per second)
llama_print_timings: prompt eval time =     195.79 ms /     2 tokens (   97.90 ms per token,    10.21 tokens per second)
llama_print_timings:        eval time =    1523.64 ms /    31 runs   (   49.15 ms per token,    20.35 tokens per second)
...
<bos> They say the early bird catches the worm. But in the case of dating, is it more advantageous to be the first one to initiate contact or the last to do
llama_print_timings:        load time =    3127.35 ms
...
llama_print_timings:       total time =    1819.59 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soirée: A Celebration of Black Excellence

**Introduction:**

Black excellence has long been celebrated, but this year, we elevate the celebration to a new level by
llama_print_timings:        load time =    2727.01 ms
llama_print_timings:      sample time =      16.52 ms /    32 runs   (    0.52 ms per token,  1936.46 tokens per second)
llama_print_timings: prompt eval time =     196.55 ms /     2 tokens (   98.28 ms per token,    10.18 tokens per second)
llama_print_timings:        eval time =    1549.00 ms /    31 runs   (   49.97 ms per token,    20.01 tokens per second)
llama_print_timings:       total time =    1836.73 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21294.02 ms
main:    total time = 21294.02 ms
+ echo PASS
PASS
+ echo
...
<bos> The Alchemist's Secret

The Alchemist's Secret is a hidden book within the book of Genesis, hidden within the narrative of creation. It contains the key to
llama_print_timings:        load time =    1394.88 ms
llama_print_timings:      sample time =      16.70 ms /    32 runs   (    0.52 ms per token,  1915.82 tokens per second)
llama_print_timings: prompt eval time =     212.89 ms /     2 tokens (  106.45 ms per token,     9.39 tokens per second)
llama_print_timings:        eval time =    1093.67 ms /    31 runs   (   35.28 ms per token,    28.34 tokens per second)
llama_print_timings:       total time =    1396.98 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21605.50 ms
main:    total time = 21605.50 ms
+ echo PASS
PASS
+ echo
...
<bos> After a thorough analysis, you conclude that the optimal policy is to implement a policy that incentivizes individuals to adopt sustainable practices.

What type of policy would best achieve
llama_print_timings:        load time =    1549.33 ms
llama_print_timings:      sample time =      16.67 ms /    32 runs   (    0.52 ms per token,  1920.08 tokens per second)
llama_print_timings: prompt eval time =     213.88 ms /     2 tokens (  106.94 ms per token,     9.35 tokens per second)
llama_print_timings:        eval time =    1105.30 ms /    31 runs   (   35.65 ms per token,    28.05 tokens per second)
llama_print_timings:       total time =    1410.89 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
