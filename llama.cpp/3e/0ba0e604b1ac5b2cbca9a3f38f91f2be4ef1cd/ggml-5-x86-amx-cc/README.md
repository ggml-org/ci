...
- status:  SUCCESS ✅
- runtime: 4:13.99
- date:    Sat Nov 30 08:13:48 UTC 2024
...
14/27 Test #14: test-tokenizer-1-llama-spm ........   Passed    1.19 sec
      Start 15: test-log
...
0.00.000.294 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.442 I llama_model_loader: - kv   0:                       general.architecture str              = bert
0.00.003.443 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.003.444 I llama_model_loader: - kv   2:                               general.name str              = Bge Small
0.00.003.444 I llama_model_loader: - kv   3:                           general.basename str              = bge
0.00.003.445 I llama_model_loader: - kv   4:                         general.size_label str              = small
0.00.003.449 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
...
0.00.003.451 I llama_model_loader: - kv   9:                  bert.attention.head_count u32              = 12
...
0.00.006.691 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.007.395 I llama_model_loader: - type  f32:  124 tensors
0.00.007.395 I llama_model_loader: - type  f16:   73 tensors
...
0.00.020.878 I llm_load_print_meta: arch             = bert
...
0.00.020.889 I llm_load_print_meta: n_head           = 12
0.00.020.890 I llm_load_print_meta: n_head_kv        = 12
0.00.020.890 I llm_load_print_meta: n_rot            = 32
0.00.020.891 I llm_load_print_meta: n_swa            = 0
0.00.020.891 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.891 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.892 I llm_load_print_meta: n_gqa            = 1
0.00.020.893 I llm_load_print_meta: n_embd_k_gqa     = 384
...
0.00.020.909 I llm_load_print_meta: model ftype      = F16
0.00.020.911 I llm_load_print_meta: model params     = 33.21 M
0.00.020.912 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.020.921 I llm_load_print_meta: general.name     = Bge Small
0.00.020.922 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.922 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.923 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.923 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.020.923 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.020.924 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.020.924 I llm_load_print_meta: max token length = 21
0.00.024.981 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.025.003 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.037.669 I llama_new_context_with_model: n_seq_max     = 1
0.00.037.684 I llama_new_context_with_model: n_ctx         = 512
0.00.037.684 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.037.685 I llama_new_context_with_model: n_batch       = 2048
0.00.037.685 I llama_new_context_with_model: n_ubatch      = 2048
0.00.037.685 I llama_new_context_with_model: flash_attn    = 0
0.00.037.688 I llama_new_context_with_model: freq_base     = 10000.0
0.00.037.688 I llama_new_context_with_model: freq_scale    = 1
0.00.039.545 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.039.570 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.039.577 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.041.009 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.041.033 I llama_new_context_with_model: graph nodes  = 429
0.00.041.033 I llama_new_context_with_model: graph splits = 1
0.00.041.036 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.044.310 I 
0.00.044.400 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
...
0.00.050.468 I llama_perf_context_print:        load time =      43.98 ms
0.00.050.470 I llama_perf_context_print: prompt eval time =       4.03 ms /     9 tokens (    0.45 ms per token,  2232.14 tokens per second)
0.00.050.471 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.050.472 I llama_perf_context_print:       total time =       6.16 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.515 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.599 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.003.605 I llama_model_loader: - kv   0:                       general.architecture str              = bert
0.00.003.606 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.003.607 I llama_model_loader: - kv   2:                               general.name str              = Bge Small
...
0.00.007.537 I llama_model_loader: - type  f32:  124 tensors
0.00.007.537 I llama_model_loader: - type q8_0:   73 tensors
0.00.018.440 I llm_load_vocab: special tokens cache size = 5
0.00.020.929 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.958 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.959 I llm_load_print_meta: arch             = bert
0.00.020.959 I llm_load_print_meta: vocab type       = WPM
0.00.020.960 I llm_load_print_meta: n_vocab          = 30522
0.00.020.960 I llm_load_print_meta: n_merges         = 0
0.00.020.960 I llm_load_print_meta: vocab_only       = 0
0.00.020.960 I llm_load_print_meta: n_ctx_train      = 512
0.00.020.960 I llm_load_print_meta: n_embd           = 384
0.00.020.961 I llm_load_print_meta: n_layer          = 12
0.00.020.968 I llm_load_print_meta: n_head           = 12
0.00.020.969 I llm_load_print_meta: n_head_kv        = 12
0.00.020.969 I llm_load_print_meta: n_rot            = 32
0.00.020.969 I llm_load_print_meta: n_swa            = 0
0.00.020.970 I llm_load_print_meta: n_embd_head_k    = 32
0.00.020.970 I llm_load_print_meta: n_embd_head_v    = 32
0.00.020.970 I llm_load_print_meta: n_gqa            = 1
0.00.020.971 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.020.972 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.020.973 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.020.973 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
...
0.00.020.985 I llm_load_print_meta: PAD token        = 0 '[PAD]'
...
0.00.023.717 I llm_load_tensors:          AMX model buffer size =    24.05 MiB
0.00.023.735 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
...
0.00.032.466 I llama_new_context_with_model: n_batch       = 2048
0.00.032.467 I llama_new_context_with_model: n_ubatch      = 2048
0.00.032.467 I llama_new_context_with_model: flash_attn    = 0
0.00.032.469 I llama_new_context_with_model: freq_base     = 10000.0
0.00.032.469 I llama_new_context_with_model: freq_scale    = 1
0.00.034.817 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.034.843 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.034.849 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.036.205 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.036.228 I llama_new_context_with_model: graph nodes  = 429
0.00.036.228 I llama_new_context_with_model: graph splits = 1
0.00.036.230 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.038.589 I 
0.00.038.665 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.040.202 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.042.509 I llama_perf_context_print:        load time =      38.03 ms
0.00.042.524 I llama_perf_context_print: prompt eval time =       2.00 ms /     9 tokens (    0.22 ms per token,  4511.28 tokens per second)
0.00.042.538 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.042.552 I llama_perf_context_print:       total time =       3.92 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.664 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.739 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.008.762 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
...
0.00.008.779 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.779 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.782 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.784 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.785 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.786 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.786 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.791 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.792 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.792 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.793 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.793 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
...
0.00.019.913 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.930 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.930 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.931 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.931 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.932 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.932 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.932 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.933 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.933 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.934 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.934 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.937 I llama_model_loader: - type  f32:   41 tensors
0.00.019.938 I llama_model_loader: - type  f16:   29 tensors
0.00.037.708 W llm_load_vocab: empty token at index 5
0.00.048.250 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.062.087 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.062.230 I llm_load_vocab: special tokens cache size = 5
0.00.346.062 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.346.084 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.346.085 I llm_load_print_meta: arch             = jina-bert-v2
0.00.346.086 I llm_load_print_meta: vocab type       = BPE
0.00.346.086 I llm_load_print_meta: n_vocab          = 61056
0.00.346.086 I llm_load_print_meta: n_merges         = 39382
0.00.346.087 I llm_load_print_meta: vocab_only       = 0
0.00.346.087 I llm_load_print_meta: n_ctx_train      = 8192
0.00.346.087 I llm_load_print_meta: n_embd           = 384
0.00.346.088 I llm_load_print_meta: n_layer          = 4
0.00.346.096 I llm_load_print_meta: n_head           = 12
0.00.346.097 I llm_load_print_meta: n_head_kv        = 12
0.00.346.097 I llm_load_print_meta: n_rot            = 32
0.00.346.097 I llm_load_print_meta: n_swa            = 0
0.00.346.098 I llm_load_print_meta: n_embd_head_k    = 32
0.00.346.098 I llm_load_print_meta: n_embd_head_v    = 32
0.00.346.099 I llm_load_print_meta: n_gqa            = 1
0.00.346.100 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.346.100 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.346.102 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.346.103 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.346.103 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.346.104 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.346.104 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.346.105 I llm_load_print_meta: n_ff             = 1536
0.00.346.105 I llm_load_print_meta: n_expert         = 0
0.00.346.105 I llm_load_print_meta: n_expert_used    = 0
0.00.346.106 I llm_load_print_meta: causal attn      = 0
0.00.346.106 I llm_load_print_meta: pooling type     = -1
0.00.346.106 I llm_load_print_meta: rope type        = -1
0.00.346.107 I llm_load_print_meta: rope scaling     = linear
0.00.346.108 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.346.109 I llm_load_print_meta: freq_scale_train = 1
0.00.346.109 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.346.109 I llm_load_print_meta: rope_finetuned   = unknown
0.00.346.109 I llm_load_print_meta: ssm_d_conv       = 0
0.00.346.110 I llm_load_print_meta: ssm_d_inner      = 0
0.00.346.110 I llm_load_print_meta: ssm_d_state      = 0
0.00.346.110 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.346.111 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.346.111 I llm_load_print_meta: model type       = 33M
0.00.346.112 I llm_load_print_meta: model ftype      = F16
0.00.346.113 I llm_load_print_meta: model params     = 32.90 M
0.00.346.113 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.346.114 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.346.114 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.346.115 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.346.115 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.346.115 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.346.115 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.346.116 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.346.116 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.346.116 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.346.116 I llm_load_print_meta: max token length = 45
0.00.349.345 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.349.361 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.356.623 I llama_new_context_with_model: n_seq_max     = 1
0.00.356.645 I llama_new_context_with_model: n_ctx         = 8192
0.00.356.645 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.356.646 I llama_new_context_with_model: n_batch       = 2048
0.00.356.646 I llama_new_context_with_model: n_ubatch      = 2048
0.00.356.647 I llama_new_context_with_model: flash_attn    = 0
0.00.356.648 I llama_new_context_with_model: freq_base     = 10000.0
0.00.356.649 I llama_new_context_with_model: freq_scale    = 1
0.00.365.820 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.365.846 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.365.853 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.367.669 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.367.690 I llama_new_context_with_model: graph nodes  = 154
0.00.367.690 I llama_new_context_with_model: graph splits = 1
0.00.367.692 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.375.549 I 
0.00.375.635 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.375.885 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.375.898 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.903 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.375.904 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.908 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.375.909 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.379.804 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.386.896 I llama_perf_context_print:        load time =     374.84 ms
0.00.386.898 I llama_perf_context_print: prompt eval time =       6.94 ms /    62 tokens (    0.11 ms per token,  8935.01 tokens per second)
0.00.386.899 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.386.900 I llama_perf_context_print:       total time =      11.35 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.280 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.065.050 I llm_load_vocab: special tokens cache size = 25
...
0.00.076.679 I llm_load_print_meta: n_embd_v_gqa     = 2048
...
0.00.076.690 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.690 I llm_load_print_meta: model params     = 1.41 B
0.00.076.691 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.196.835 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.196.853 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.989.344 I llama_new_context_with_model: n_seq_max     = 1
0.00.989.367 I llama_new_context_with_model: n_ctx         = 2048
0.00.989.367 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.989.367 I llama_new_context_with_model: n_batch       = 2048
0.00.989.368 I llama_new_context_with_model: n_ubatch      = 512
0.00.989.369 I llama_new_context_with_model: flash_attn    = 0
0.00.989.374 I llama_new_context_with_model: freq_base     = 10000.0
0.00.989.375 I llama_new_context_with_model: freq_scale    = 1
0.01.056.955 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.056.984 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.057.015 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.059.160 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.01.059.183 I llama_new_context_with_model: graph nodes  = 967
0.01.059.183 I llama_new_context_with_model: graph splits = 1
0.01.059.188 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.158.982 I main: llama threadpool init, n_threads = 4
0.01.159.012 I 
0.01.159.098 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.159.115 I 
0.01.159.242 I sampler seed: 1234
0.01.159.262 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.159.265 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.159.266 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.159.266 I 
...
0.04.944.568 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31938.82 tokens per second)
0.04.944.571 I llama_perf_context_print:        load time =    1158.45 ms
0.04.944.573 I llama_perf_context_print: prompt eval time =     100.17 ms /     7 tokens (   14.31 ms per token,    69.88 tokens per second)
0.04.944.574 I llama_perf_context_print:        eval time =    3673.81 ms /    63 runs   (   58.31 ms per token,    17.15 tokens per second)
0.04.944.575 I llama_perf_context_print:       total time =    3785.59 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.722 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.472 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
...
0.00.076.473 I llm_load_print_meta: ssm_d_state      = 0
...
0.00.076.475 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.476 I llm_load_print_meta: model params     = 1.41 B
0.00.076.477 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.076.478 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.076.479 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.479 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.479 I llm_load_print_meta: max token length = 1024
0.00.199.840 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.199.857 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.994.467 I llama_new_context_with_model: n_seq_max     = 1
0.00.994.490 I llama_new_context_with_model: n_ctx         = 128
0.00.994.490 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.994.490 I llama_new_context_with_model: n_batch       = 128
0.00.994.490 I llama_new_context_with_model: n_ubatch      = 128
0.00.994.491 I llama_new_context_with_model: flash_attn    = 0
0.00.994.496 I llama_new_context_with_model: freq_base     = 10000.0
0.00.994.497 I llama_new_context_with_model: freq_scale    = 1
0.00.994.498 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.999.381 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.999.409 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.999.435 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.001.625 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.01.001.647 I llama_new_context_with_model: graph nodes  = 967
0.01.001.648 I llama_new_context_with_model: graph splits = 1
0.01.001.650 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.067.372 I 
0.01.067.493 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.067.513 I perplexity: tokenizing the input ..
0.01.076.963 I perplexity: tokenization took 9.446 ms
0.01.076.996 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.958.019 I perplexity: 0.88 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.961.532 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.961.582 I llama_perf_context_print:        load time =    1066.61 ms
0.01.961.584 I llama_perf_context_print: prompt eval time =     879.19 ms /   128 tokens (    6.87 ms per token,   145.59 tokens per second)
0.01.961.586 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.961.587 I llama_perf_context_print:       total time =     894.21 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.648 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.236 I llm_load_print_meta: model ftype      = Q8_0
...
0.00.165.056 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.165.073 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.624.321 I llama_new_context_with_model: n_seq_max     = 1
0.00.624.344 I llama_new_context_with_model: n_ctx         = 2048
0.00.624.345 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.624.345 I llama_new_context_with_model: n_batch       = 2048
0.00.624.345 I llama_new_context_with_model: n_ubatch      = 512
0.00.624.346 I llama_new_context_with_model: flash_attn    = 0
0.00.624.349 I llama_new_context_with_model: freq_base     = 10000.0
0.00.624.350 I llama_new_context_with_model: freq_scale    = 1
0.00.692.695 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.692.723 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.692.754 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.695.005 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.695.020 I llama_new_context_with_model: graph nodes  = 967
0.00.695.020 I llama_new_context_with_model: graph splits = 1
0.00.695.025 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.774.024 I main: llama threadpool init, n_threads = 4
0.00.774.052 I 
0.00.774.137 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.774.150 I 
0.00.774.281 I sampler seed: 1234
0.00.774.302 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.774.305 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.774.306 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.774.306 I 
...
0.02.975.378 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30550.77 tokens per second)
0.02.975.381 I llama_perf_context_print:        load time =     773.11 ms
0.02.975.383 I llama_perf_context_print: prompt eval time =      49.24 ms /     7 tokens (    7.03 ms per token,   142.16 tokens per second)
0.02.975.384 I llama_perf_context_print:        eval time =    2140.48 ms /    63 runs   (   33.98 ms per token,    29.43 tokens per second)
0.02.975.385 I llama_perf_context_print:       total time =    2201.36 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.318 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.052 I llm_load_print_meta: model ftype      = Q8_0
...
0.00.165.923 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.165.939 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.621.567 I llama_new_context_with_model: n_seq_max     = 1
0.00.621.589 I llama_new_context_with_model: n_ctx         = 128
0.00.621.590 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.621.590 I llama_new_context_with_model: n_batch       = 128
0.00.621.590 I llama_new_context_with_model: n_ubatch      = 128
0.00.621.591 I llama_new_context_with_model: flash_attn    = 0
0.00.621.595 I llama_new_context_with_model: freq_base     = 10000.0
0.00.621.596 I llama_new_context_with_model: freq_scale    = 1
0.00.621.597 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.626.845 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.626.875 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.626.904 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.629.181 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.629.197 I llama_new_context_with_model: graph nodes  = 967
0.00.629.198 I llama_new_context_with_model: graph splits = 1
0.00.629.200 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.673.611 I 
0.00.673.740 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.673.767 I perplexity: tokenizing the input ..
0.00.683.234 I perplexity: tokenization took 9.469 ms
0.00.683.272 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.055.690 I perplexity: 0.37 seconds per pass - ETA 0.00 minutes
[1]10.1288,
0.01.059.445 I Final estimate: PPL = 10.1288 +/- 3.22324

0.01.059.506 I llama_perf_context_print:        load time =     673.26 ms
0.01.059.521 I llama_perf_context_print: prompt eval time =     370.56 ms /   128 tokens (    2.89 ms per token,   345.43 tokens per second)
0.01.059.523 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.059.524 I llama_perf_context_print:       total time =     385.88 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.731 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.124.626 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.124.642 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.403.941 I llama_new_context_with_model: n_seq_max     = 1
0.00.403.964 I llama_new_context_with_model: n_ctx         = 2048
0.00.403.964 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.403.964 I llama_new_context_with_model: n_batch       = 2048
0.00.403.964 I llama_new_context_with_model: n_ubatch      = 512
0.00.403.965 I llama_new_context_with_model: flash_attn    = 0
0.00.403.969 I llama_new_context_with_model: freq_base     = 10000.0
0.00.403.969 I llama_new_context_with_model: freq_scale    = 1
0.00.472.666 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.472.691 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.472.725 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.475.480 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.475.502 I llama_new_context_with_model: graph nodes  = 967
0.00.475.503 I llama_new_context_with_model: graph splits = 1
0.00.475.507 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.551.551 I main: llama threadpool init, n_threads = 4
0.00.551.577 I 
0.00.551.663 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.551.663 I 
0.00.551.793 I sampler seed: 1234
0.00.551.814 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.551.817 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.551.818 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.551.818 I 
I believe the meaning of life is to know myself. It is to be able to say, “I am a person, I am a mother, a daughter, a sister, a friend, a mother of friends, a sister of sisters, and a sister of all the mothers.” It is to be able to say, “I am a human being

0.01.940.980 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31113.06 tokens per second)
0.01.940.984 I llama_perf_context_print:        load time =     550.56 ms
0.01.940.985 I llama_perf_context_print: prompt eval time =      44.57 ms /     7 tokens (    6.37 ms per token,   157.07 tokens per second)
0.01.940.987 I llama_perf_context_print:        eval time =    1333.40 ms /    63 runs   (   21.17 ms per token,    47.25 tokens per second)
0.01.940.988 I llama_perf_context_print:       total time =    1389.44 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.673 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.869 I llm_load_print_meta: n_expert         = 0
...
0.00.075.872 I llm_load_print_meta: freq_base_train  = 10000.0
...
0.00.075.876 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.878 I llm_load_print_meta: model params     = 1.41 B
0.00.075.879 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.360 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.125.377 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.405.055 I llama_new_context_with_model: n_seq_max     = 1
0.00.405.078 I llama_new_context_with_model: n_ctx         = 128
0.00.405.079 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.405.079 I llama_new_context_with_model: n_batch       = 128
0.00.405.079 I llama_new_context_with_model: n_ubatch      = 128
0.00.405.080 I llama_new_context_with_model: flash_attn    = 0
0.00.405.084 I llama_new_context_with_model: freq_base     = 10000.0
0.00.405.085 I llama_new_context_with_model: freq_scale    = 1
0.00.405.086 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.409.948 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.409.977 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.410.007 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.412.755 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.412.774 I llama_new_context_with_model: graph nodes  = 967
0.00.412.775 I llama_new_context_with_model: graph splits = 1
0.00.412.777 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.455.628 I 
0.00.455.734 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.455.755 I perplexity: tokenizing the input ..
0.00.465.208 I perplexity: tokenization took 9.449 ms
0.00.465.242 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.884.730 I perplexity: 0.42 seconds per pass - ETA 0.00 minutes
[1]14.0715,
0.00.888.461 I Final estimate: PPL = 14.0715 +/- 4.41015

0.00.888.504 I llama_perf_context_print:        load time =     454.91 ms
0.00.888.518 I llama_perf_context_print: prompt eval time =     417.69 ms /   128 tokens (    3.26 ms per token,   306.45 tokens per second)
0.00.888.519 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.888.520 I llama_perf_context_print:       total time =     432.88 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.270 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.457 I main: llama backend init
0.00.000.474 I main: load the model and apply lora adapter, if any
0.00.009.118 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.020.767 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.020.769 I llama_model_loader: - type  f32:  194 tensors
0.00.020.770 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.075.216 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.216 I llm_load_print_meta: model params     = 1.41 B
0.00.075.218 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.459 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.130.473 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.437.889 I llama_new_context_with_model: n_seq_max     = 1
0.00.437.912 I llama_new_context_with_model: n_ctx         = 2048
0.00.437.912 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.437.913 I llama_new_context_with_model: n_batch       = 2048
0.00.437.913 I llama_new_context_with_model: n_ubatch      = 512
0.00.437.914 I llama_new_context_with_model: flash_attn    = 0
0.00.437.918 I llama_new_context_with_model: freq_base     = 10000.0
0.00.437.919 I llama_new_context_with_model: freq_scale    = 1
0.00.506.447 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.506.471 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.506.502 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.508.742 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.508.762 I llama_new_context_with_model: graph nodes  = 967
0.00.508.763 I llama_new_context_with_model: graph splits = 1
0.00.508.767 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.583.366 I main: llama threadpool init, n_threads = 4
0.00.583.398 I 
0.00.583.485 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.583.486 I 
0.00.583.623 I sampler seed: 1234
0.00.583.643 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.583.647 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.583.647 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.583.648 I 
...
0.02.086.334 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31236.25 tokens per second)
0.02.086.337 I llama_perf_context_print:        load time =     582.87 ms
0.02.086.339 I llama_perf_context_print: prompt eval time =      41.73 ms /     7 tokens (    5.96 ms per token,   167.76 tokens per second)
0.02.086.340 I llama_perf_context_print:        eval time =    1450.03 ms /    63 runs   (   23.02 ms per token,    43.45 tokens per second)
0.02.086.341 I llama_perf_context_print:       total time =    1502.97 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.343 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.124 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.074.264 I llm_load_print_meta: rope scaling     = linear
0.00.074.265 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.074.266 I llm_load_print_meta: freq_scale_train = 1
0.00.074.266 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.074.267 I llm_load_print_meta: rope_finetuned   = unknown
0.00.074.267 I llm_load_print_meta: ssm_d_conv       = 0
0.00.074.267 I llm_load_print_meta: ssm_d_inner      = 0
0.00.074.267 I llm_load_print_meta: ssm_d_state      = 0
0.00.074.268 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.074.268 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.074.268 I llm_load_print_meta: model type       = 1.4B
0.00.074.269 I llm_load_print_meta: model ftype      = Q4_1
0.00.074.270 I llm_load_print_meta: model params     = 1.41 B
0.00.074.270 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
0.00.074.271 I llm_load_print_meta: general.name     = 1.4B
...
0.00.074.272 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.074.272 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.074.272 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.273 I llm_load_print_meta: max token length = 1024
0.00.128.758 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.128.779 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.439.335 I llama_new_context_with_model: n_seq_max     = 1
0.00.439.357 I llama_new_context_with_model: n_ctx         = 128
0.00.439.358 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.439.358 I llama_new_context_with_model: n_batch       = 128
0.00.439.358 I llama_new_context_with_model: n_ubatch      = 128
0.00.439.359 I llama_new_context_with_model: flash_attn    = 0
0.00.439.364 I llama_new_context_with_model: freq_base     = 10000.0
0.00.439.365 I llama_new_context_with_model: freq_scale    = 1
0.00.439.366 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.444.266 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.444.295 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.444.320 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.446.530 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.446.550 I llama_new_context_with_model: graph nodes  = 967
0.00.446.550 I llama_new_context_with_model: graph splits = 1
0.00.446.553 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.487.217 I 
0.00.487.344 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.487.380 I perplexity: tokenizing the input ..
0.00.496.844 I perplexity: tokenization took 9.46 ms
0.00.496.885 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.936.430 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]12.5781,
0.00.940.140 I Final estimate: PPL = 12.5781 +/- 3.87222

0.00.940.185 I llama_perf_context_print:        load time =     486.82 ms
0.00.940.187 I llama_perf_context_print: prompt eval time =     437.66 ms /   128 tokens (    3.42 ms per token,   292.46 tokens per second)
0.00.940.189 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.940.191 I llama_perf_context_print:       total time =     452.97 ms /   129 tokens
...
0.00.075.924 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.136.232 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.136.246 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.172.648 I llama_new_context_with_model: n_seq_max     = 1
0.00.172.670 I llama_new_context_with_model: n_ctx         = 2048
0.00.172.671 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.172.671 I llama_new_context_with_model: n_batch       = 2048
0.00.172.671 I llama_new_context_with_model: n_ubatch      = 512
0.00.172.672 I llama_new_context_with_model: flash_attn    = 0
0.00.172.675 I llama_new_context_with_model: freq_base     = 10000.0
0.00.172.675 I llama_new_context_with_model: freq_scale    = 1
0.00.241.243 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.241.272 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.241.298 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.243.319 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.243.341 I llama_new_context_with_model: graph nodes  = 967
0.00.243.341 I llama_new_context_with_model: graph splits = 1
0.00.243.346 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.352.361 I main: llama threadpool init, n_threads = 4
0.00.352.390 I 
0.00.352.474 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.352.489 I 
0.00.352.618 I sampler seed: 1234
0.00.352.637 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.352.641 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.352.641 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.352.641 I 
I believe the meaning of life is to do what is best for your self, and to be happy, and to enjoy the present moment, and to let go of the past, and to enjoy the moment, and to enjoy the life you have here on Earth." The words are spoken in a calm, measured tone, but the message is clear: it

0.02.660.870 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30577.09 tokens per second)
0.02.660.872 I llama_perf_context_print:        load time =     351.37 ms
0.02.660.874 I llama_perf_context_print: prompt eval time =     125.64 ms /     7 tokens (   17.95 ms per token,    55.71 tokens per second)
0.02.660.875 I llama_perf_context_print:        eval time =    2171.21 ms /    63 runs   (   34.46 ms per token,    29.02 tokens per second)
0.02.660.876 I llama_perf_context_print:       total time =    2308.52 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.728 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.108 I llm_load_print_meta: model ftype      = Q5_0
0.00.076.108 I llm_load_print_meta: model params     = 1.41 B
0.00.076.109 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.136.641 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.136.655 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.174.233 I llama_new_context_with_model: n_seq_max     = 1
0.00.174.256 I llama_new_context_with_model: n_ctx         = 128
0.00.174.257 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.174.257 I llama_new_context_with_model: n_batch       = 128
0.00.174.257 I llama_new_context_with_model: n_ubatch      = 128
0.00.174.258 I llama_new_context_with_model: flash_attn    = 0
0.00.174.261 I llama_new_context_with_model: freq_base     = 10000.0
0.00.174.262 I llama_new_context_with_model: freq_scale    = 1
0.00.174.263 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.179.495 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.179.523 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
...
0.00.182.273 I llama_new_context_with_model: graph nodes  = 967
0.00.182.274 I llama_new_context_with_model: graph splits = 1
0.00.182.276 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.229.483 I 
0.00.229.585 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.229.592 I perplexity: tokenizing the input ..
0.00.239.086 I perplexity: tokenization took 9.489 ms
0.00.239.121 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.339.475 I perplexity: 1.10 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.343.290 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.343.339 I llama_perf_context_print:        load time =     228.71 ms
0.01.343.340 I llama_perf_context_print: prompt eval time =    1098.55 ms /   128 tokens (    8.58 ms per token,   116.52 tokens per second)
0.01.343.342 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.343.344 I llama_perf_context_print:       total time =    1113.86 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.679 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.010 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.021.013 I llama_model_loader: - type  f32:  194 tensors
0.00.021.014 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.075.218 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.218 I llm_load_print_meta: model params     = 1.41 B
0.00.075.219 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.137.040 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.137.058 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.172.897 I llama_new_context_with_model: n_seq_max     = 1
0.00.172.921 I llama_new_context_with_model: n_ctx         = 2048
0.00.172.921 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.172.922 I llama_new_context_with_model: n_batch       = 2048
0.00.172.922 I llama_new_context_with_model: n_ubatch      = 512
0.00.172.922 I llama_new_context_with_model: flash_attn    = 0
0.00.172.927 I llama_new_context_with_model: freq_base     = 10000.0
0.00.172.927 I llama_new_context_with_model: freq_scale    = 1
0.00.240.900 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.240.935 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.240.971 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.243.687 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.243.710 I llama_new_context_with_model: graph nodes  = 967
0.00.243.710 I llama_new_context_with_model: graph splits = 1
0.00.243.715 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.338.943 I main: llama threadpool init, n_threads = 4
0.00.338.977 I 
0.00.339.071 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.339.085 I 
0.00.339.242 I sampler seed: 1234
0.00.339.263 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.339.267 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.339.267 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.339.268 I 
...
0.02.804.795 I llama_perf_sampler_print:    sampling time =       2.43 ms /    71 runs   (    0.03 ms per token, 29206.09 tokens per second)
0.02.804.799 I llama_perf_context_print:        load time =     338.02 ms
0.02.804.801 I llama_perf_context_print: prompt eval time =     126.40 ms /     7 tokens (   18.06 ms per token,    55.38 tokens per second)
0.02.804.803 I llama_perf_context_print:        eval time =    2327.26 ms /    63 runs   (   36.94 ms per token,    27.07 tokens per second)
0.02.804.803 I llama_perf_context_print:       total time =    2465.86 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.739 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.315 I llm_load_print_meta: model ftype      = Q5_1
...
0.00.140.427 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.140.446 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.176.071 I llama_new_context_with_model: n_seq_max     = 1
0.00.176.095 I llama_new_context_with_model: n_ctx         = 128
0.00.176.095 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.176.095 I llama_new_context_with_model: n_batch       = 128
0.00.176.095 I llama_new_context_with_model: n_ubatch      = 128
0.00.176.096 I llama_new_context_with_model: flash_attn    = 0
0.00.176.099 I llama_new_context_with_model: freq_base     = 10000.0
0.00.176.100 I llama_new_context_with_model: freq_scale    = 1
0.00.176.101 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.180.840 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.180.867 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.180.886 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.183.109 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.244.784 I 
0.00.244.907 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.244.927 I perplexity: tokenizing the input ..
0.00.254.364 I perplexity: tokenization took 9.433 ms
0.00.254.395 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.161.981 I perplexity: 1.91 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.165.585 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.165.632 I llama_perf_context_print:        load time =     244.00 ms
0.02.165.635 I llama_perf_context_print: prompt eval time =    1905.89 ms /   128 tokens (   14.89 ms per token,    67.16 tokens per second)
0.02.165.637 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.165.638 I llama_perf_context_print:       total time =    1920.85 ms /   129 tokens
...
0.00.109.672 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.109.689 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.145.975 I llama_new_context_with_model: n_seq_max     = 1
0.00.145.999 I llama_new_context_with_model: n_ctx         = 2048
0.00.145.999 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.146.000 I llama_new_context_with_model: n_batch       = 2048
0.00.146.000 I llama_new_context_with_model: n_ubatch      = 512
0.00.146.001 I llama_new_context_with_model: flash_attn    = 0
0.00.146.004 I llama_new_context_with_model: freq_base     = 10000.0
0.00.146.004 I llama_new_context_with_model: freq_scale    = 1
0.00.214.570 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.214.602 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.214.636 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.216.993 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.217.009 I llama_new_context_with_model: graph nodes  = 967
0.00.217.009 I llama_new_context_with_model: graph splits = 1
0.00.217.013 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.291.842 I main: llama threadpool init, n_threads = 4
0.00.291.872 I 
0.00.291.957 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.291.957 I 
0.00.292.083 I sampler seed: 1234
0.00.292.104 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.292.107 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.01.772.286 I llama_perf_sampler_print:    sampling time =       1.96 ms /    71 runs   (    0.03 ms per token, 36224.49 tokens per second)
0.01.772.289 I llama_perf_context_print:        load time =     290.85 ms
0.01.772.290 I llama_perf_context_print: prompt eval time =      80.31 ms /     7 tokens (   11.47 ms per token,    87.16 tokens per second)
0.01.772.291 I llama_perf_context_print:        eval time =    1389.29 ms /    63 runs   (   22.05 ms per token,    45.35 tokens per second)
0.01.772.292 I llama_perf_context_print:       total time =    1480.45 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.725 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.109.451 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.109.472 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.144.391 I llama_new_context_with_model: n_seq_max     = 1
0.00.144.413 I llama_new_context_with_model: n_ctx         = 128
0.00.144.414 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.144.414 I llama_new_context_with_model: n_batch       = 128
0.00.144.414 I llama_new_context_with_model: n_ubatch      = 128
0.00.144.415 I llama_new_context_with_model: flash_attn    = 0
0.00.144.417 I llama_new_context_with_model: freq_base     = 10000.0
0.00.144.418 I llama_new_context_with_model: freq_scale    = 1
0.00.144.419 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.149.082 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.149.110 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.149.127 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.151.272 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.151.289 I llama_new_context_with_model: graph nodes  = 967
0.00.151.289 I llama_new_context_with_model: graph splits = 1
0.00.151.291 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.191.403 I 
0.00.191.511 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.191.531 I perplexity: tokenizing the input ..
0.00.200.874 I perplexity: tokenization took 9.34 ms
0.00.200.908 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.458.598 I perplexity: 1.26 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.462.265 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.462.303 I llama_perf_context_print:        load time =     190.63 ms
0.01.462.305 I llama_perf_context_print: prompt eval time =    1255.84 ms /   128 tokens (    9.81 ms per token,   101.92 tokens per second)
0.01.462.307 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.462.307 I llama_perf_context_print:       total time =    1270.90 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.627 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.408 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.121.123 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.121.136 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.322.328 I llama_new_context_with_model: n_seq_max     = 1
0.00.322.351 I llama_new_context_with_model: n_ctx         = 2048
0.00.322.351 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.322.351 I llama_new_context_with_model: n_batch       = 2048
0.00.322.351 I llama_new_context_with_model: n_ubatch      = 512
0.00.322.352 I llama_new_context_with_model: flash_attn    = 0
0.00.322.357 I llama_new_context_with_model: freq_base     = 10000.0
0.00.322.358 I llama_new_context_with_model: freq_scale    = 1
0.00.390.486 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.390.516 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.390.547 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.392.815 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.392.839 I llama_new_context_with_model: graph nodes  = 967
0.00.392.840 I llama_new_context_with_model: graph splits = 1
0.00.392.844 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.473.709 I main: llama threadpool init, n_threads = 4
0.00.473.740 I 
0.00.473.827 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.473.840 I 
0.00.473.968 I sampler seed: 1234
0.00.473.988 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.473.992 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.473.993 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.473.993 I 
I believe the meaning of life is that one should never feel the need to be the best at anything, but rather, that one should be the best in whatever one does. This is a good philosophy, and I believe it to be a good basis for understanding how our lives are lived, as well as how we should live them.

It is

0.02.164.248 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31953.20 tokens per second)
0.02.164.251 I llama_perf_context_print:        load time =     472.77 ms
0.02.164.252 I llama_perf_context_print: prompt eval time =      63.86 ms /     7 tokens (    9.12 ms per token,   109.62 tokens per second)
0.02.164.253 I llama_perf_context_print:        eval time =    1615.45 ms /    63 runs   (   25.64 ms per token,    39.00 tokens per second)
0.02.164.254 I llama_perf_context_print:       total time =    1690.55 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.325 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.927 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.074.928 I llm_load_print_meta: model params     = 1.41 B
0.00.074.929 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.121.332 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.121.353 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.324.395 I llama_new_context_with_model: n_seq_max     = 1
0.00.324.418 I llama_new_context_with_model: n_ctx         = 128
0.00.324.418 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.324.419 I llama_new_context_with_model: n_batch       = 128
0.00.324.419 I llama_new_context_with_model: n_ubatch      = 128
0.00.324.419 I llama_new_context_with_model: flash_attn    = 0
0.00.324.424 I llama_new_context_with_model: freq_base     = 10000.0
0.00.324.424 I llama_new_context_with_model: freq_scale    = 1
0.00.324.425 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.329.313 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.329.342 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.329.367 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.331.539 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.331.559 I llama_new_context_with_model: graph nodes  = 967
0.00.331.559 I llama_new_context_with_model: graph splits = 1
0.00.331.562 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.378.209 I 
0.00.378.327 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.378.356 I perplexity: tokenizing the input ..
0.00.387.790 I perplexity: tokenization took 9.436 ms
0.00.387.824 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.250.660 I perplexity: 0.86 seconds per pass - ETA 0.00 minutes
[1]12.3344,
0.01.254.399 I Final estimate: PPL = 12.3344 +/- 4.02919

0.01.254.439 I llama_perf_context_print:        load time =     377.83 ms
0.01.254.441 I llama_perf_context_print: prompt eval time =     861.02 ms /   128 tokens (    6.73 ms per token,   148.66 tokens per second)
0.01.254.442 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.254.442 I llama_perf_context_print:       total time =     876.23 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.283 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.002 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.076.003 I llm_load_print_meta: model params     = 1.41 B
0.00.076.004 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.132.055 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.132.071 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.460.903 I llama_new_context_with_model: n_seq_max     = 1
0.00.460.925 I llama_new_context_with_model: n_ctx         = 2048
0.00.460.925 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.460.925 I llama_new_context_with_model: n_batch       = 2048
0.00.460.926 I llama_new_context_with_model: n_ubatch      = 512
0.00.460.926 I llama_new_context_with_model: flash_attn    = 0
0.00.460.930 I llama_new_context_with_model: freq_base     = 10000.0
0.00.460.931 I llama_new_context_with_model: freq_scale    = 1
0.00.530.195 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.530.226 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.530.257 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.532.533 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.532.556 I llama_new_context_with_model: graph nodes  = 967
0.00.532.556 I llama_new_context_with_model: graph splits = 1
0.00.532.561 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.621.796 I main: llama threadpool init, n_threads = 4
0.00.621.827 I 
0.00.621.911 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.621.923 I 
0.00.622.056 I sampler seed: 1234
0.00.622.081 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.622.086 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.622.086 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.622.087 I 
...
0.02.590.631 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31222.52 tokens per second)
0.02.590.634 I llama_perf_context_print:        load time =     621.22 ms
0.02.590.635 I llama_perf_context_print: prompt eval time =      68.31 ms /     7 tokens (    9.76 ms per token,   102.48 tokens per second)
0.02.590.636 I llama_perf_context_print:        eval time =    1889.29 ms /    63 runs   (   29.99 ms per token,    33.35 tokens per second)
0.02.590.637 I llama_perf_context_print:       total time =    1968.84 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.345 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.208 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
...
0.00.076.406 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.076.407 I llm_load_print_meta: n_ff             = 8192
0.00.076.407 I llm_load_print_meta: n_expert         = 0
...
0.00.076.414 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.076.415 I llm_load_print_meta: model params     = 1.41 B
0.00.076.415 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.132.256 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.460.208 I llama_new_context_with_model: n_seq_max     = 1
0.00.460.229 I llama_new_context_with_model: n_ctx         = 128
0.00.460.229 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.460.230 I llama_new_context_with_model: n_batch       = 128
0.00.460.230 I llama_new_context_with_model: n_ubatch      = 128
0.00.460.231 I llama_new_context_with_model: flash_attn    = 0
0.00.460.236 I llama_new_context_with_model: freq_base     = 10000.0
0.00.460.237 I llama_new_context_with_model: freq_scale    = 1
0.00.460.238 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.465.075 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.465.104 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.465.126 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.467.852 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.467.870 I llama_new_context_with_model: graph nodes  = 967
0.00.467.871 I llama_new_context_with_model: graph splits = 1
0.00.467.873 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.522.308 I 
0.00.522.437 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.522.471 I perplexity: tokenizing the input ..
0.00.531.995 I perplexity: tokenization took 9.521 ms
0.00.532.029 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.075.130 I perplexity: 0.54 seconds per pass - ETA 0.00 minutes
[1]10.4776,
0.01.078.806 I Final estimate: PPL = 10.4776 +/- 3.36742

0.01.078.853 I llama_perf_context_print:        load time =     521.92 ms
0.01.078.855 I llama_perf_context_print: prompt eval time =     541.32 ms /   128 tokens (    4.23 ms per token,   236.46 tokens per second)
0.01.078.856 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.078.857 I llama_perf_context_print:       total time =     556.54 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.738 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.644 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
...
0.00.075.951 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.952 I llm_load_print_meta: model params     = 1.41 B
0.00.075.953 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.135.977 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.135.998 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.518.098 I llama_new_context_with_model: n_seq_max     = 1
0.00.518.120 I llama_new_context_with_model: n_ctx         = 2048
0.00.518.120 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.518.121 I llama_new_context_with_model: n_batch       = 2048
0.00.518.121 I llama_new_context_with_model: n_ubatch      = 512
0.00.518.122 I llama_new_context_with_model: flash_attn    = 0
0.00.518.127 I llama_new_context_with_model: freq_base     = 10000.0
0.00.518.128 I llama_new_context_with_model: freq_scale    = 1
0.00.586.927 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.586.959 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.586.991 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.589.244 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.589.259 I llama_new_context_with_model: graph nodes  = 967
0.00.589.259 I llama_new_context_with_model: graph splits = 1
0.00.589.263 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.690.596 I main: llama threadpool init, n_threads = 4
0.00.690.627 I 
0.00.690.710 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.690.710 I 
0.00.690.836 I sampler seed: 1234
0.00.690.863 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.690.867 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.690.868 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.690.869 I 
I believe the meaning of life is to do the things we love, the things we are good at, the things we are good at doing, and the things that are good at doing. If we do those, we are happy. If we do not, then we are miserable, and we will do those things we hate the most.

I

0.03.102.315 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31291.32 tokens per second)
0.03.102.318 I llama_perf_context_print:        load time =     689.55 ms
0.03.102.320 I llama_perf_context_print: prompt eval time =      87.88 ms /     7 tokens (   12.55 ms per token,    79.66 tokens per second)
0.03.102.321 I llama_perf_context_print:        eval time =    2312.48 ms /    63 runs   (   36.71 ms per token,    27.24 tokens per second)
0.03.102.321 I llama_perf_context_print:       total time =    2411.73 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.685 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.136.200 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.136.216 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.516.430 I llama_new_context_with_model: n_seq_max     = 1
0.00.516.452 I llama_new_context_with_model: n_ctx         = 128
0.00.516.452 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.516.453 I llama_new_context_with_model: n_batch       = 128
0.00.516.453 I llama_new_context_with_model: n_ubatch      = 128
0.00.516.454 I llama_new_context_with_model: flash_attn    = 0
0.00.516.458 I llama_new_context_with_model: freq_base     = 10000.0
0.00.516.459 I llama_new_context_with_model: freq_scale    = 1
0.00.516.460 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.521.261 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.521.290 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.521.313 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.523.408 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.523.428 I llama_new_context_with_model: graph nodes  = 967
0.00.523.428 I llama_new_context_with_model: graph splits = 1
0.00.523.430 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.586.648 I 
0.00.586.762 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.586.771 I perplexity: tokenizing the input ..
0.00.596.252 I perplexity: tokenization took 9.476 ms
0.00.596.283 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.230.860 I perplexity: 0.63 seconds per pass - ETA 0.00 minutes
[1]10.6642,
0.01.234.869 I Final estimate: PPL = 10.6642 +/- 3.40033

0.01.234.912 I llama_perf_context_print:        load time =     585.92 ms
0.01.234.914 I llama_perf_context_print: prompt eval time =     632.76 ms /   128 tokens (    4.94 ms per token,   202.29 tokens per second)
0.01.234.916 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.234.916 I llama_perf_context_print:       total time =     648.26 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.666 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.433 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.433 I llm_load_print_meta: model params     = 1.41 B
0.00.076.434 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.137.172 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.137.191 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.535.457 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.535.479 I llama_new_context_with_model: freq_base     = 10000.0
0.00.535.480 I llama_new_context_with_model: freq_scale    = 1
0.00.604.060 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.604.090 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.604.120 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.606.372 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.606.395 I llama_new_context_with_model: graph nodes  = 967
0.00.606.395 I llama_new_context_with_model: graph splits = 1
0.00.606.400 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.721.966 I main: llama threadpool init, n_threads = 4
0.00.721.998 I 
0.00.722.084 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.722.098 I 
0.00.722.267 I sampler seed: 1234
0.00.722.287 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.722.290 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.722.291 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.722.291 I 
...
0.03.262.591 I llama_perf_sampler_print:    sampling time =       2.18 ms /    71 runs   (    0.03 ms per token, 32538.96 tokens per second)
0.03.262.594 I llama_perf_context_print:        load time =     721.00 ms
0.03.262.595 I llama_perf_context_print: prompt eval time =     112.34 ms /     7 tokens (   16.05 ms per token,    62.31 tokens per second)
0.03.262.596 I llama_perf_context_print:        eval time =    2417.10 ms /    63 runs   (   38.37 ms per token,    26.06 tokens per second)
0.03.262.596 I llama_perf_context_print:       total time =    2540.63 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.774 I build: 4229 (3e0ba0e6) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.176 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.075.171 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.171 I llm_load_print_meta: model params     = 1.41 B
0.00.075.172 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.134.671 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.134.691 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.526.676 I llama_new_context_with_model: n_seq_max     = 1
0.00.526.700 I llama_new_context_with_model: n_ctx         = 128
0.00.526.700 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.526.700 I llama_new_context_with_model: n_batch       = 128
0.00.526.701 I llama_new_context_with_model: n_ubatch      = 128
0.00.526.701 I llama_new_context_with_model: flash_attn    = 0
0.00.526.705 I llama_new_context_with_model: freq_base     = 10000.0
0.00.526.706 I llama_new_context_with_model: freq_scale    = 1
0.00.526.707 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.531.654 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.531.684 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.531.709 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.533.916 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.533.939 I llama_new_context_with_model: graph nodes  = 967
0.00.533.940 I llama_new_context_with_model: graph splits = 1
0.00.533.943 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.615.024 I 
0.00.615.153 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.615.165 I perplexity: tokenizing the input ..
0.00.624.679 I perplexity: tokenization took 9.51 ms
0.00.624.711 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.396.507 I perplexity: 0.77 seconds per pass - ETA 0.00 minutes
[1]10.4463,
0.01.400.540 I Final estimate: PPL = 10.4463 +/- 3.33301

0.01.400.583 I llama_perf_context_print:        load time =     614.21 ms
0.01.400.597 I llama_perf_context_print: prompt eval time =     770.01 ms /   128 tokens (    6.02 ms per token,   166.23 tokens per second)
0.01.400.599 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.400.601 I llama_perf_context_print:       total time =     785.56 ms /   129 tokens
...
0.00.474.761 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.474.150 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.63user 0.62system 0:01.25elapsed 100%CPU (0avgtext+0avgdata 5359476maxresident)k
