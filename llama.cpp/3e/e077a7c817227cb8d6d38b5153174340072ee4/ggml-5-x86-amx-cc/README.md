...
- status:  SUCCESS ✅
- runtime: 4:02.87
- date:    Wed Nov  6 16:53:16 UTC 2024
...
0.00.000.743 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.044 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.004.113 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
...
0.00.008.210 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
...
0.00.022.330 I llm_load_print_meta: n_merges         = 0
0.00.022.330 I llm_load_print_meta: vocab_only       = 0
0.00.022.331 I llm_load_print_meta: n_ctx_train      = 512
0.00.022.331 I llm_load_print_meta: n_embd           = 384
0.00.022.332 I llm_load_print_meta: n_layer          = 12
...
0.00.022.347 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.022.348 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.022.348 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.022.348 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.022.349 I llm_load_print_meta: n_ff             = 1536
0.00.022.349 I llm_load_print_meta: n_expert         = 0
0.00.022.350 I llm_load_print_meta: n_expert_used    = 0
0.00.022.350 I llm_load_print_meta: causal attn      = 0
0.00.022.350 I llm_load_print_meta: pooling type     = 2
0.00.022.350 I llm_load_print_meta: rope type        = 2
...
0.00.022.355 I llm_load_print_meta: n_ctx_orig_yarn  = 512
...
0.00.022.370 I llm_load_print_meta: ssm_d_state      = 0
0.00.022.371 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.022.371 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
...
0.00.022.374 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.022.375 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.022.376 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.022.376 I llm_load_print_meta: CLS token        = 101 '[CLS]'
...
0.00.026.381 I llm_load_tensors:        AMX model buffer size =    40.50 MiB
................................................
0.00.041.240 I llama_new_context_with_model: n_seq_max     = 1
0.00.041.256 I llama_new_context_with_model: n_ctx         = 512
0.00.041.256 I llama_new_context_with_model: n_ctx_per_seq = 512
...
0.00.041.260 I llama_new_context_with_model: freq_base     = 10000.0
0.00.041.261 I llama_new_context_with_model: freq_scale    = 1
0.00.044.803 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.044.825 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.044.832 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.046.760 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.046.780 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.046.781 I llama_new_context_with_model: graph nodes  = 429
0.00.046.781 I llama_new_context_with_model: graph splits = 145
0.00.046.783 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.050.703 I 
0.00.050.797 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.052.620 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.058.337 I llama_perf_context_print:        load time =      49.76 ms
0.00.058.339 I llama_perf_context_print: prompt eval time =       5.23 ms /     9 tokens (    0.58 ms per token,  1722.16 tokens per second)
0.00.058.339 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.058.340 I llama_perf_context_print:       total time =       7.63 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.515 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.675 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.003.723 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
...
0.00.007.631 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.007.632 I llama_model_loader: - type  f32:  124 tensors
0.00.007.633 I llama_model_loader: - type q8_0:   73 tensors
0.00.018.619 I llm_load_vocab: special tokens cache size = 5
...
0.00.021.127 I llm_load_print_meta: n_rot            = 32
0.00.021.127 I llm_load_print_meta: n_swa            = 0
...
0.00.021.129 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.130 I llm_load_print_meta: n_embd_v_gqa     = 384
...
0.00.021.132 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.132 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.133 I llm_load_print_meta: n_ff             = 1536
0.00.021.133 I llm_load_print_meta: n_expert         = 0
0.00.021.134 I llm_load_print_meta: n_expert_used    = 0
0.00.021.134 I llm_load_print_meta: causal attn      = 0
0.00.021.134 I llm_load_print_meta: pooling type     = 2
0.00.021.134 I llm_load_print_meta: rope type        = 2
0.00.021.134 I llm_load_print_meta: rope scaling     = linear
0.00.021.136 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.136 I llm_load_print_meta: freq_scale_train = 1
0.00.021.137 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.138 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.138 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.138 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.138 I llm_load_print_meta: ssm_d_state      = 0
0.00.021.138 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.021.138 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
...
0.00.024.188 I llm_load_tensors: CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.025.349 I llama_new_context_with_model: n_seq_max     = 1
0.00.025.365 I llama_new_context_with_model: n_ctx         = 512
0.00.025.366 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.025.366 I llama_new_context_with_model: n_batch       = 2048
0.00.025.366 I llama_new_context_with_model: n_ubatch      = 2048
0.00.025.366 I llama_new_context_with_model: flash_attn    = 0
0.00.025.368 I llama_new_context_with_model: freq_base     = 10000.0
0.00.025.369 I llama_new_context_with_model: freq_scale    = 1
0.00.028.323 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.028.350 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.028.355 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.029.703 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.029.725 I llama_new_context_with_model: graph nodes  = 429
0.00.029.726 I llama_new_context_with_model: graph splits = 1
0.00.029.727 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.032.547 I 
0.00.032.635 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
...
0.00.037.256 I llama_perf_context_print:        load time =      31.84 ms
0.00.037.258 I llama_perf_context_print: prompt eval time =       2.66 ms /     9 tokens (    0.30 ms per token,  3378.38 tokens per second)
0.00.037.259 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.037.260 I llama_perf_context_print:       total time =       4.71 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.708 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.887 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.008.917 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.008.925 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.008.926 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.927 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.928 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.928 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.931 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.932 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.933 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.933 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.934 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.937 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.938 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.938 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.939 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.941 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.014.999 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
...
0.00.019.991 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.991 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.992 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.992 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.993 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.993 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.994 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.995 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.995 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.995 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.998 I llama_model_loader: - type  f32:   41 tensors
0.00.020.000 I llama_model_loader: - type  f16:   29 tensors
0.00.038.033 W llm_load_vocab: empty token at index 5
0.00.048.348 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.384 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.493 I llm_load_vocab: special tokens cache size = 5
0.00.342.561 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.342.585 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.342.586 I llm_load_print_meta: arch             = jina-bert-v2
0.00.342.586 I llm_load_print_meta: vocab type       = BPE
0.00.342.587 I llm_load_print_meta: n_vocab          = 61056
0.00.342.587 I llm_load_print_meta: n_merges         = 39382
0.00.342.587 I llm_load_print_meta: vocab_only       = 0
0.00.342.588 I llm_load_print_meta: n_ctx_train      = 8192
0.00.342.588 I llm_load_print_meta: n_embd           = 384
0.00.342.588 I llm_load_print_meta: n_layer          = 4
0.00.342.598 I llm_load_print_meta: n_head           = 12
0.00.342.599 I llm_load_print_meta: n_head_kv        = 12
0.00.342.599 I llm_load_print_meta: n_rot            = 32
0.00.342.599 I llm_load_print_meta: n_swa            = 0
0.00.342.600 I llm_load_print_meta: n_embd_head_k    = 32
0.00.342.600 I llm_load_print_meta: n_embd_head_v    = 32
0.00.342.601 I llm_load_print_meta: n_gqa            = 1
0.00.342.602 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.342.602 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.342.605 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.342.605 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.342.606 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.342.607 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.342.607 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.342.608 I llm_load_print_meta: n_ff             = 1536
0.00.342.608 I llm_load_print_meta: n_expert         = 0
0.00.342.608 I llm_load_print_meta: n_expert_used    = 0
0.00.342.609 I llm_load_print_meta: causal attn      = 0
0.00.342.609 I llm_load_print_meta: pooling type     = -1
0.00.342.609 I llm_load_print_meta: rope type        = -1
0.00.342.610 I llm_load_print_meta: rope scaling     = linear
0.00.342.611 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.342.611 I llm_load_print_meta: freq_scale_train = 1
0.00.342.612 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.342.612 I llm_load_print_meta: rope_finetuned   = unknown
0.00.342.612 I llm_load_print_meta: ssm_d_conv       = 0
0.00.342.612 I llm_load_print_meta: ssm_d_inner      = 0
0.00.342.612 I llm_load_print_meta: ssm_d_state      = 0
0.00.342.613 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.342.613 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.342.613 I llm_load_print_meta: model type       = 33M
0.00.342.614 I llm_load_print_meta: model ftype      = F16
0.00.342.615 I llm_load_print_meta: model params     = 32.90 M
0.00.342.616 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.342.616 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.342.616 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.342.617 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.342.617 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.342.617 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.342.617 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.342.618 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.342.618 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.342.618 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.342.618 I llm_load_print_meta: max token length = 45
0.00.346.454 I llm_load_tensors: CPU_Mapped model buffer size =    62.78 MiB
0.00.346.470 I llm_load_tensors:        AMX model buffer size =    18.00 MiB
.....................
0.00.354.271 I llama_new_context_with_model: n_seq_max     = 1
0.00.354.293 I llama_new_context_with_model: n_ctx         = 8192
0.00.354.294 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.354.294 I llama_new_context_with_model: n_batch       = 2048
0.00.354.294 I llama_new_context_with_model: n_ubatch      = 2048
0.00.354.295 I llama_new_context_with_model: flash_attn    = 0
0.00.354.297 I llama_new_context_with_model: freq_base     = 10000.0
0.00.354.297 I llama_new_context_with_model: freq_scale    = 1
0.00.364.070 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.364.096 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.364.103 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.366.023 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.366.046 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.366.047 I llama_new_context_with_model: graph nodes  = 154
0.00.366.047 I llama_new_context_with_model: graph splits = 57
0.00.366.049 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.374.981 I 
0.00.375.080 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.375.325 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.375.338 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.344 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.375.344 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.349 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.375.349 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.379.319 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.388.199 I llama_perf_context_print:        load time =     374.08 ms
0.00.388.200 I llama_perf_context_print: prompt eval time =       8.65 ms /    62 tokens (    0.14 ms per token,  7170.95 tokens per second)
0.00.388.202 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.388.202 I llama_perf_context_print:       total time =      13.22 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.654 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.077.197 I llm_load_print_meta: n_head_kv        = 16
...
0.00.077.201 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.077.203 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.077.203 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.077.204 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.077.204 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.077.204 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.077.205 I llm_load_print_meta: n_ff             = 8192
...
0.00.077.210 I llm_load_print_meta: ssm_d_state      = 0
0.00.077.211 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.077.211 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.077.211 I llm_load_print_meta: model type       = 1.4B
0.00.077.212 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.077.213 I llm_load_print_meta: model params     = 1.41 B
0.00.077.214 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
0.00.077.215 I llm_load_print_meta: general.name     = 1.4B
0.00.077.215 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.077.215 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.077.215 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.077.216 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.077.216 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.077.217 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.077.217 I llm_load_print_meta: max token length = 1024
0.00.191.737 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.191.752 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.977.393 I llama_new_context_with_model: n_seq_max     = 1
0.00.977.414 I llama_new_context_with_model: n_ctx         = 2048
0.00.977.414 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.977.414 I llama_new_context_with_model: n_batch       = 2048
0.00.977.415 I llama_new_context_with_model: n_ubatch      = 512
0.00.977.415 I llama_new_context_with_model: flash_attn    = 0
0.00.977.420 I llama_new_context_with_model: freq_base     = 10000.0
0.00.977.421 I llama_new_context_with_model: freq_scale    = 1
0.01.045.717 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.045.746 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.045.779 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.048.872 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.048.894 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.048.895 I llama_new_context_with_model: graph nodes  = 967
0.01.048.895 I llama_new_context_with_model: graph splits = 194
0.01.048.899 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.152.421 I main: llama threadpool init, n_threads = 4
0.01.152.448 I 
0.01.152.545 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.152.557 I 
0.01.152.705 I sampler seed: 1234
0.01.152.725 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.152.727 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.152.728 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.152.728 I 
...
0.05.015.284 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30485.19 tokens per second)
0.05.015.287 I llama_perf_context_print:        load time =    1151.34 ms
0.05.015.288 I llama_perf_context_print: prompt eval time =     100.44 ms /     7 tokens (   14.35 ms per token,    69.69 tokens per second)
0.05.015.289 I llama_perf_context_print:        eval time =    3750.63 ms /    63 runs   (   59.53 ms per token,    16.80 tokens per second)
0.05.015.290 I llama_perf_context_print:       total time =    3862.87 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.731 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.636 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.075.631 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.632 I llm_load_print_meta: model params     = 1.41 B
0.00.075.633 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
0.00.075.633 I llm_load_print_meta: general.name     = 1.4B
0.00.075.633 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.075.634 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
...
0.00.193.176 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.193.196 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.997.398 I llama_new_context_with_model: n_seq_max     = 1
0.00.997.419 I llama_new_context_with_model: n_ctx         = 128
0.00.997.419 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.997.420 I llama_new_context_with_model: n_batch       = 128
0.00.997.420 I llama_new_context_with_model: n_ubatch      = 128
0.00.997.421 I llama_new_context_with_model: flash_attn    = 0
0.00.997.426 I llama_new_context_with_model: freq_base     = 10000.0
0.00.997.427 I llama_new_context_with_model: freq_scale    = 1
0.00.997.428 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.003.037 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.003.060 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.003.083 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.005.994 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.01.006.018 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.01.006.019 I llama_new_context_with_model: graph nodes  = 967
0.01.006.019 I llama_new_context_with_model: graph splits = 194
0.01.006.021 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.073.746 I 
0.01.073.869 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.073.903 I perplexity: tokenizing the input ..
0.01.083.339 I perplexity: tokenization took 9.433 ms
0.01.083.372 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.000.481 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.02.004.180 I Final estimate: PPL = 10.1479 +/- 3.22609

0.02.004.281 I llama_perf_context_print:        load time =    1072.81 ms
0.02.004.283 I llama_perf_context_print: prompt eval time =     915.33 ms /   128 tokens (    7.15 ms per token,   139.84 tokens per second)
0.02.004.285 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.004.285 I llama_perf_context_print:       total time =     930.53 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.690 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.168.515 I llm_load_tensors: CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.170.763 I llama_new_context_with_model: n_seq_max     = 1
0.00.170.783 I llama_new_context_with_model: n_ctx         = 2048
0.00.170.783 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.170.783 I llama_new_context_with_model: n_batch       = 2048
0.00.170.784 I llama_new_context_with_model: n_ubatch      = 512
0.00.170.784 I llama_new_context_with_model: flash_attn    = 0
0.00.170.786 I llama_new_context_with_model: freq_base     = 10000.0
0.00.170.786 I llama_new_context_with_model: freq_scale    = 1
0.00.241.327 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.241.357 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.241.379 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.243.550 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.243.573 I llama_new_context_with_model: graph nodes  = 967
0.00.243.573 I llama_new_context_with_model: graph splits = 1
0.00.243.577 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.343.738 I main: llama threadpool init, n_threads = 4
0.00.343.764 I 
0.00.343.845 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.343.845 I 
0.00.343.963 I sampler seed: 1234
0.00.343.970 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
...
0.03.134.148 I llama_perf_sampler_print:    sampling time =       2.26 ms /    71 runs   (    0.03 ms per token, 31457.69 tokens per second)
0.03.134.151 I llama_perf_context_print:        load time =     342.62 ms
0.03.134.152 I llama_perf_context_print: prompt eval time =     124.41 ms /     7 tokens (   17.77 ms per token,    56.27 tokens per second)
0.03.134.153 I llama_perf_context_print:        eval time =    2654.23 ms /    63 runs   (   42.13 ms per token,    23.74 tokens per second)
0.03.134.154 I llama_perf_context_print:       total time =    2790.42 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.863 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.150 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.151 I llm_load_print_meta: model params     = 1.41 B
0.00.076.151 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.165.438 I llm_load_tensors: CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.167.590 I llama_new_context_with_model: n_seq_max     = 1
0.00.167.610 I llama_new_context_with_model: n_ctx         = 128
0.00.167.611 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.167.611 I llama_new_context_with_model: n_batch       = 128
0.00.167.611 I llama_new_context_with_model: n_ubatch      = 128
0.00.167.612 I llama_new_context_with_model: flash_attn    = 0
0.00.167.613 I llama_new_context_with_model: freq_base     = 10000.0
0.00.167.614 I llama_new_context_with_model: freq_scale    = 1
0.00.167.615 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.173.098 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.173.124 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.173.140 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.175.167 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.175.186 I llama_new_context_with_model: graph nodes  = 967
0.00.175.186 I llama_new_context_with_model: graph splits = 1
0.00.175.189 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.241.787 I 
0.00.241.900 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.241.908 I perplexity: tokenizing the input ..
0.00.250.794 I perplexity: tokenization took 8.883 ms
0.00.250.828 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.176.505 I perplexity: 0.93 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.180.151 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.180.278 I llama_perf_context_print:        load time =     240.75 ms
0.01.180.293 I llama_perf_context_print: prompt eval time =     923.94 ms /   128 tokens (    7.22 ms per token,   138.54 tokens per second)
0.01.180.295 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.180.295 I llama_perf_context_print:       total time =     938.49 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.757 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.555 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
...
0.00.075.973 I llm_load_print_meta: model ftype      = Q4_0
...
0.00.128.450 I llm_load_tensors: CPU_Mapped model buffer size =   777.31 MiB
0.00.128.468 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.373.677 I llama_new_context_with_model: n_seq_max     = 1
0.00.373.699 I llama_new_context_with_model: n_ctx         = 2048
0.00.373.699 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.373.699 I llama_new_context_with_model: n_batch       = 2048
0.00.373.700 I llama_new_context_with_model: n_ubatch      = 512
0.00.373.700 I llama_new_context_with_model: flash_attn    = 0
0.00.373.705 I llama_new_context_with_model: freq_base     = 10000.0
0.00.373.705 I llama_new_context_with_model: freq_scale    = 1
0.00.443.952 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.443.983 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.444.015 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.447.172 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.447.193 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.447.194 I llama_new_context_with_model: graph nodes  = 967
0.00.447.194 I llama_new_context_with_model: graph splits = 193
0.00.447.198 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.520.302 I main: llama threadpool init, n_threads = 4
0.00.520.330 I 
0.00.520.420 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.520.434 I 
0.00.520.581 I sampler seed: 1234
0.00.520.600 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.520.603 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.520.604 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.520.604 I 
...
0.01.930.750 I llama_perf_sampler_print:    sampling time =       2.18 ms /    71 runs   (    0.03 ms per token, 32524.05 tokens per second)
0.01.930.753 I llama_perf_context_print:        load time =     519.11 ms
0.01.930.755 I llama_perf_context_print: prompt eval time =      39.63 ms /     7 tokens (    5.66 ms per token,   176.61 tokens per second)
0.01.930.756 I llama_perf_context_print:        eval time =    1359.56 ms /    63 runs   (   21.58 ms per token,    46.34 tokens per second)
0.01.930.757 I llama_perf_context_print:       total time =    1410.45 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.645 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.125.499 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.369.601 I llama_new_context_with_model: n_seq_max     = 1
0.00.369.620 I llama_new_context_with_model: n_ctx         = 128
0.00.369.621 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.369.621 I llama_new_context_with_model: n_batch       = 128
0.00.369.621 I llama_new_context_with_model: n_ubatch      = 128
0.00.369.622 I llama_new_context_with_model: flash_attn    = 0
0.00.369.626 I llama_new_context_with_model: freq_base     = 10000.0
0.00.369.627 I llama_new_context_with_model: freq_scale    = 1
0.00.369.628 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.375.082 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.375.110 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.375.134 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.377.599 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.377.619 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.377.620 I llama_new_context_with_model: graph nodes  = 967
0.00.377.620 I llama_new_context_with_model: graph splits = 193
0.00.377.622 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.409.383 I 
0.00.409.485 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.409.506 I perplexity: tokenizing the input ..
0.00.418.708 I perplexity: tokenization took 9.199 ms
0.00.418.738 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.884.922 I perplexity: 0.47 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.888.836 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.888.915 I llama_perf_context_print:        load time =     408.55 ms
0.00.888.916 I llama_perf_context_print: prompt eval time =     464.32 ms /   128 tokens (    3.63 ms per token,   275.67 tokens per second)
0.00.888.918 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.888.919 I llama_perf_context_print:       total time =     479.53 ms /   129 tokens
...
0.00.074.804 I llm_load_print_meta: model ftype      = Q4_1
0.00.074.804 I llm_load_print_meta: model params     = 1.41 B
0.00.074.805 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.115.927 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.115.946 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.391.122 I llama_new_context_with_model: n_seq_max     = 1
0.00.391.144 I llama_new_context_with_model: n_ctx         = 2048
0.00.391.145 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.391.145 I llama_new_context_with_model: n_batch       = 2048
0.00.391.145 I llama_new_context_with_model: n_ubatch      = 512
0.00.391.146 I llama_new_context_with_model: flash_attn    = 0
0.00.391.150 I llama_new_context_with_model: freq_base     = 10000.0
0.00.391.151 I llama_new_context_with_model: freq_scale    = 1
0.00.460.796 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.460.824 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.460.858 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.463.916 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.463.940 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.463.940 I llama_new_context_with_model: graph nodes  = 967
0.00.463.941 I llama_new_context_with_model: graph splits = 193
0.00.463.946 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.532.232 I main: llama threadpool init, n_threads = 4
0.00.532.260 I 
0.00.532.352 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.532.365 I 
0.00.532.517 I sampler seed: 1234
0.00.532.541 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.532.545 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.532.546 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.532.546 I 
...
0.02.065.657 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32112.17 tokens per second)
0.02.065.660 I llama_perf_context_print:        load time =     531.06 ms
0.02.065.661 I llama_perf_context_print: prompt eval time =      39.27 ms /     7 tokens (    5.61 ms per token,   178.24 tokens per second)
0.02.065.662 I llama_perf_context_print:        eval time =    1482.78 ms /    63 runs   (   23.54 ms per token,    42.49 tokens per second)
0.02.065.663 I llama_perf_context_print:       total time =    1533.43 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.725 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.171 I llm_load_print_meta: model ftype      = Q4_1
0.00.076.171 I llm_load_print_meta: model params     = 1.41 B
0.00.076.172 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.118.333 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.118.352 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.389.390 I llama_new_context_with_model: n_seq_max     = 1
0.00.389.411 I llama_new_context_with_model: n_ctx         = 128
0.00.389.411 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.389.411 I llama_new_context_with_model: n_batch       = 128
0.00.389.412 I llama_new_context_with_model: n_ubatch      = 128
0.00.389.412 I llama_new_context_with_model: flash_attn    = 0
0.00.389.416 I llama_new_context_with_model: freq_base     = 10000.0
0.00.389.417 I llama_new_context_with_model: freq_scale    = 1
0.00.389.418 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.395.048 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.395.077 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.395.103 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.398.095 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.398.119 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.398.119 I llama_new_context_with_model: graph nodes  = 967
0.00.398.120 I llama_new_context_with_model: graph splits = 193
0.00.398.122 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.430.210 I 
0.00.430.324 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.430.330 I perplexity: tokenizing the input ..
0.00.439.740 I perplexity: tokenization took 9.406 ms
0.00.439.770 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.910.824 I perplexity: 0.47 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.914.641 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.914.721 I llama_perf_context_print:        load time =     429.30 ms
0.00.914.723 I llama_perf_context_print: prompt eval time =     469.22 ms /   128 tokens (    3.67 ms per token,   272.79 tokens per second)
0.00.914.724 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.914.725 I llama_perf_context_print:       total time =     484.51 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.676 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.647 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.076.219 I llm_load_print_meta: model ftype      = Q5_0
0.00.076.220 I llm_load_print_meta: model params     = 1.41 B
0.00.076.221 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.121.798 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.123.995 I llama_new_context_with_model: n_seq_max     = 1
0.00.124.017 I llama_new_context_with_model: n_ctx         = 2048
0.00.124.017 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.124.018 I llama_new_context_with_model: n_batch       = 2048
0.00.124.018 I llama_new_context_with_model: n_ubatch      = 512
0.00.124.018 I llama_new_context_with_model: flash_attn    = 0
0.00.124.020 I llama_new_context_with_model: freq_base     = 10000.0
0.00.124.021 I llama_new_context_with_model: freq_scale    = 1
0.00.192.775 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.192.803 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.192.825 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.195.474 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.195.498 I llama_new_context_with_model: graph nodes  = 967
0.00.195.498 I llama_new_context_with_model: graph splits = 1
0.00.195.502 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.303.658 I main: llama threadpool init, n_threads = 4
0.00.303.685 I 
0.00.303.769 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.303.784 I 
0.00.303.927 I sampler seed: 1234
0.00.303.946 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.303.949 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.303.950 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.303.950 I 
...
0.02.585.937 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31696.43 tokens per second)
0.02.585.941 I llama_perf_context_print:        load time =     302.52 ms
0.02.585.943 I llama_perf_context_print: prompt eval time =     118.27 ms /     7 tokens (   16.90 ms per token,    59.19 tokens per second)
0.02.585.944 I llama_perf_context_print:        eval time =    2151.86 ms /    63 runs   (   34.16 ms per token,    29.28 tokens per second)
0.02.585.945 I llama_perf_context_print:       total time =    2282.29 ms /    70 tokens
...
0.00.021.497 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.021.500 I llama_model_loader: - type  f32:  194 tensors
0.00.021.501 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.121.651 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.123.846 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.867 I llama_new_context_with_model: n_ctx         = 128
0.00.123.868 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.123.868 I llama_new_context_with_model: n_batch       = 128
0.00.123.868 I llama_new_context_with_model: n_ubatch      = 128
0.00.123.869 I llama_new_context_with_model: flash_attn    = 0
0.00.123.871 I llama_new_context_with_model: freq_base     = 10000.0
0.00.123.871 I llama_new_context_with_model: freq_scale    = 1
0.00.123.872 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.129.487 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.129.508 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.129.522 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.131.609 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.131.631 I llama_new_context_with_model: graph nodes  = 967
0.00.131.631 I llama_new_context_with_model: graph splits = 1
0.00.131.633 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.194.589 I 
0.00.194.704 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.194.725 I perplexity: tokenizing the input ..
0.00.203.539 I perplexity: tokenization took 8.811 ms
0.00.203.575 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.330.971 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.334.830 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.334.875 I llama_perf_context_print:        load time =     193.69 ms
0.01.334.891 I llama_perf_context_print: prompt eval time =    1125.72 ms /   128 tokens (    8.79 ms per token,   113.71 tokens per second)
0.01.334.892 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.334.894 I llama_perf_context_print:       total time =    1140.29 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.681 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.470 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.076.449 I llm_load_print_meta: model ftype      = Q5_1
0.00.076.449 I llm_load_print_meta: model params     = 1.41 B
0.00.076.451 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.124.334 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.126.516 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.538 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.538 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.538 I llama_new_context_with_model: n_batch       = 2048
0.00.126.539 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.539 I llama_new_context_with_model: flash_attn    = 0
0.00.126.541 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.541 I llama_new_context_with_model: freq_scale    = 1
0.00.194.971 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.001 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.022 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.173 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.188 I llama_new_context_with_model: graph nodes  = 967
0.00.197.188 I llama_new_context_with_model: graph splits = 1
0.00.197.192 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.287.973 I main: llama threadpool init, n_threads = 4
0.00.288.000 I 
0.00.288.095 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.288.108 I 
0.00.288.243 I sampler seed: 1234
0.00.288.263 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.288.266 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.288.267 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.288.267 I 
...
0.02.683.440 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31167.69 tokens per second)
0.02.683.443 I llama_perf_context_print:        load time =     286.81 ms
0.02.683.445 I llama_perf_context_print: prompt eval time =     120.21 ms /     7 tokens (   17.17 ms per token,    58.23 tokens per second)
0.02.683.445 I llama_perf_context_print:        eval time =    2263.69 ms /    63 runs   (   35.93 ms per token,    27.83 tokens per second)
0.02.683.446 I llama_perf_context_print:       total time =    2395.48 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.680 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.023 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.021.026 I llama_model_loader: - type  f32:  194 tensors
0.00.021.026 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.075.274 I llm_load_print_meta: model ftype      = Q5_1
...
0.00.123.788 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.126.182 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.200 I llama_new_context_with_model: n_ctx         = 128
0.00.126.201 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.201 I llama_new_context_with_model: n_batch       = 128
0.00.126.201 I llama_new_context_with_model: n_ubatch      = 128
0.00.126.202 I llama_new_context_with_model: flash_attn    = 0
0.00.126.203 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.204 I llama_new_context_with_model: freq_scale    = 1
0.00.126.205 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
...
0.00.131.715 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.807 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.828 I llama_new_context_with_model: graph nodes  = 967
0.00.133.829 I llama_new_context_with_model: graph splits = 1
0.00.133.830 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.193.583 I 
0.00.193.700 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.193.720 I perplexity: tokenizing the input ..
0.00.202.769 I perplexity: tokenization took 9.045 ms
0.00.202.799 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.143.285 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.147.268 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.147.309 I llama_perf_context_print:        load time =     192.72 ms
0.02.147.322 I llama_perf_context_print: prompt eval time =    1938.66 ms /   128 tokens (   15.15 ms per token,    66.02 tokens per second)
0.02.147.325 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.147.326 I llama_perf_context_print:       total time =    1953.73 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.658 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.104.780 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.106.956 I llama_new_context_with_model: n_seq_max     = 1
0.00.107.052 I llama_new_context_with_model: n_ctx         = 2048
0.00.107.052 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.107.053 I llama_new_context_with_model: n_batch       = 2048
0.00.107.053 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.176.069 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.176.096 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.176.116 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.178.137 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.178.159 I llama_new_context_with_model: graph nodes  = 967
0.00.178.160 I llama_new_context_with_model: graph splits = 1
0.00.178.164 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.253.490 I main: llama threadpool init, n_threads = 4
0.00.253.518 I 
0.00.253.612 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.253.613 I 
0.00.253.734 I sampler seed: 1234
0.00.253.755 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.253.757 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.253.758 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.253.758 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.732.043 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32054.18 tokens per second)
0.01.732.046 I llama_perf_context_print:        load time =     252.40 ms
0.01.732.047 I llama_perf_context_print: prompt eval time =      81.58 ms /     7 tokens (   11.65 ms per token,    85.81 tokens per second)
0.01.732.048 I llama_perf_context_print:        eval time =    1385.68 ms /    63 runs   (   21.99 ms per token,    45.46 tokens per second)
0.01.732.049 I llama_perf_context_print:       total time =    1478.56 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.695 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.113 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.113 I llm_load_print_meta: model params     = 1.41 B
0.00.075.114 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.103.961 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.106.182 I llama_new_context_with_model: n_seq_max     = 1
0.00.106.204 I llama_new_context_with_model: n_ctx         = 128
0.00.106.204 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.106.204 I llama_new_context_with_model: n_batch       = 128
0.00.106.204 I llama_new_context_with_model: n_ubatch      = 128
0.00.106.205 I llama_new_context_with_model: flash_attn    = 0
0.00.106.206 I llama_new_context_with_model: freq_base     = 10000.0
0.00.106.207 I llama_new_context_with_model: freq_scale    = 1
0.00.106.208 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.111.655 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.111.682 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.111.699 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.114.235 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.114.252 I llama_new_context_with_model: graph nodes  = 967
0.00.114.253 I llama_new_context_with_model: graph splits = 1
0.00.114.254 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.153.848 I 
0.00.153.966 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.153.989 I perplexity: tokenizing the input ..
0.00.163.232 I perplexity: tokenization took 9.24 ms
0.00.163.267 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.461.461 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.465.117 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.465.159 I llama_perf_context_print:        load time =     152.97 ms
0.01.465.161 I llama_perf_context_print: prompt eval time =    1296.32 ms /   128 tokens (   10.13 ms per token,    98.74 tokens per second)
0.01.465.163 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.465.165 I llama_perf_context_print:       total time =    1311.31 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.648 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.679 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.680 I llm_load_print_meta: model params     = 1.41 B
0.00.075.681 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.112.204 I llm_load_tensors: CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.114.363 I llama_new_context_with_model: n_seq_max     = 1
0.00.114.385 I llama_new_context_with_model: n_ctx         = 2048
0.00.114.385 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.114.386 I llama_new_context_with_model: n_batch       = 2048
0.00.114.386 I llama_new_context_with_model: n_ubatch      = 512
0.00.114.386 I llama_new_context_with_model: flash_attn    = 0
0.00.114.388 I llama_new_context_with_model: freq_base     = 10000.0
0.00.114.389 I llama_new_context_with_model: freq_scale    = 1
0.00.183.184 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.183.210 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.183.237 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.185.354 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.264.664 I main: llama threadpool init, n_threads = 4
0.00.264.693 I 
0.00.264.789 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.264.789 I 
0.00.264.923 I sampler seed: 1234
0.00.264.944 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.264.947 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.264.948 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.264.948 I 
...
0.02.037.125 I llama_perf_sampler_print:    sampling time =       2.31 ms /    71 runs   (    0.03 ms per token, 30775.90 tokens per second)
0.02.037.128 I llama_perf_context_print:        load time =     263.58 ms
0.02.037.129 I llama_perf_context_print: prompt eval time =      87.52 ms /     7 tokens (   12.50 ms per token,    79.98 tokens per second)
0.02.037.130 I llama_perf_context_print:        eval time =    1673.31 ms /    63 runs   (   26.56 ms per token,    37.65 tokens per second)
0.02.037.131 I llama_perf_context_print:       total time =    1772.47 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.738 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.113.239 I llm_load_tensors: CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.115.471 I llama_new_context_with_model: n_seq_max     = 1
0.00.115.491 I llama_new_context_with_model: n_ctx         = 128
0.00.115.491 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.115.492 I llama_new_context_with_model: n_batch       = 128
0.00.115.492 I llama_new_context_with_model: n_ubatch      = 128
0.00.115.492 I llama_new_context_with_model: flash_attn    = 0
0.00.115.494 I llama_new_context_with_model: freq_base     = 10000.0
0.00.115.495 I llama_new_context_with_model: freq_scale    = 1
0.00.115.495 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.120.951 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.120.976 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.120.990 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.123.573 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.123.589 I llama_new_context_with_model: graph nodes  = 967
0.00.123.590 I llama_new_context_with_model: graph splits = 1
0.00.123.592 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.168.546 I 
0.00.168.652 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.168.661 I perplexity: tokenizing the input ..
0.00.177.561 I perplexity: tokenization took 8.896 ms
0.00.177.593 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.514.240 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.518.033 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.518.073 I llama_perf_context_print:        load time =     167.62 ms
0.01.518.087 I llama_perf_context_print: prompt eval time =    1334.86 ms /   128 tokens (   10.43 ms per token,    95.89 tokens per second)
0.01.518.089 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.518.090 I llama_perf_context_print:       total time =    1349.53 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.662 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.900 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.901 I llm_load_print_meta: model params     = 1.41 B
0.00.075.902 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.118.666 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.120.865 I llama_new_context_with_model: n_seq_max     = 1
0.00.120.886 I llama_new_context_with_model: n_ctx         = 2048
0.00.120.886 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.120.886 I llama_new_context_with_model: n_batch       = 2048
0.00.120.887 I llama_new_context_with_model: n_ubatch      = 512
0.00.120.887 I llama_new_context_with_model: flash_attn    = 0
0.00.120.889 I llama_new_context_with_model: freq_base     = 10000.0
0.00.120.889 I llama_new_context_with_model: freq_scale    = 1
0.00.189.400 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.189.430 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.189.456 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.192.058 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.192.079 I llama_new_context_with_model: graph nodes  = 967
0.00.192.079 I llama_new_context_with_model: graph splits = 1
0.00.192.084 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.272.269 I main: llama threadpool init, n_threads = 4
0.00.272.295 I 
0.00.272.382 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.272.394 I 
0.00.272.518 I sampler seed: 1234
0.00.272.537 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.272.540 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.272.541 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.272.541 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.284.607 I llama_perf_sampler_print:    sampling time =       2.48 ms /    71 runs   (    0.03 ms per token, 28629.03 tokens per second)
0.02.284.611 I llama_perf_context_print:        load time =     271.19 ms
0.02.284.612 I llama_perf_context_print: prompt eval time =      89.01 ms /     7 tokens (   12.72 ms per token,    78.64 tokens per second)
0.02.284.613 I llama_perf_context_print:        eval time =    1911.54 ms /    63 runs   (   30.34 ms per token,    32.96 tokens per second)
0.02.284.614 I llama_perf_context_print:       total time =    2012.35 ms /    70 tokens
...
0.00.118.972 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.121.129 I llama_new_context_with_model: n_seq_max     = 1
0.00.121.151 I llama_new_context_with_model: n_ctx         = 128
0.00.121.151 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.121.152 I llama_new_context_with_model: n_batch       = 128
0.00.121.152 I llama_new_context_with_model: n_ubatch      = 128
0.00.121.152 I llama_new_context_with_model: flash_attn    = 0
0.00.121.154 I llama_new_context_with_model: freq_base     = 10000.0
0.00.121.155 I llama_new_context_with_model: freq_scale    = 1
0.00.121.156 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.126.546 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.126.611 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.126.626 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.129.065 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.129.089 I llama_new_context_with_model: graph nodes  = 967
0.00.129.089 I llama_new_context_with_model: graph splits = 1
0.00.129.091 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.174.852 I 
0.00.174.957 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.174.964 I perplexity: tokenizing the input ..
0.00.183.789 I perplexity: tokenization took 8.821 ms
0.00.183.819 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.586.121 I perplexity: 1.40 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.589.781 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.589.822 I llama_perf_context_print:        load time =     173.98 ms
0.01.589.824 I llama_perf_context_print: prompt eval time =    1400.52 ms /   128 tokens (   10.94 ms per token,    91.39 tokens per second)
0.01.589.826 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.589.827 I llama_perf_context_print:       total time =    1414.97 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.703 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.363 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.076.364 I llm_load_print_meta: model params     = 1.41 B
0.00.076.365 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.124.515 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.126.661 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.683 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.683 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.683 I llama_new_context_with_model: n_batch       = 2048
0.00.126.684 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.684 I llama_new_context_with_model: flash_attn    = 0
0.00.126.686 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.686 I llama_new_context_with_model: freq_scale    = 1
0.00.196.395 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.196.424 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.196.444 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.199.070 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
...
0.00.287.790 I 
0.00.287.878 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.287.890 I 
0.00.288.019 I sampler seed: 1234
0.00.288.039 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.288.042 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.288.043 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.288.043 I 
...
0.02.586.383 I llama_perf_sampler_print:    sampling time =       2.23 ms /    71 runs   (    0.03 ms per token, 31824.29 tokens per second)
0.02.586.386 I llama_perf_context_print:        load time =     286.63 ms
0.02.586.388 I llama_perf_context_print: prompt eval time =     111.84 ms /     7 tokens (   15.98 ms per token,    62.59 tokens per second)
0.02.586.389 I llama_perf_context_print:        eval time =    2174.74 ms /    63 runs   (   34.52 ms per token,    28.97 tokens per second)
0.02.586.390 I llama_perf_context_print:       total time =    2298.63 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.701 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.739 I llama_model_loader: - type q5_K:   61 tensors
0.00.020.739 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.075.138 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.123.281 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.125.372 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.393 I llama_new_context_with_model: n_ctx         = 128
0.00.125.393 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.125.394 I llama_new_context_with_model: n_batch       = 128
0.00.125.394 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.130.930 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.458 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.480 I llama_new_context_with_model: graph nodes  = 967
0.00.133.480 I llama_new_context_with_model: graph splits = 1
0.00.133.482 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.190.328 I 
0.00.190.430 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.190.449 I perplexity: tokenizing the input ..
0.00.199.273 I perplexity: tokenization took 8.821 ms
0.00.199.305 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.888.282 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.892.050 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.892.089 I llama_perf_context_print:        load time =     189.44 ms
0.01.892.091 I llama_perf_context_print: prompt eval time =    1687.22 ms /   128 tokens (   13.18 ms per token,    75.86 tokens per second)
0.01.892.092 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.892.092 I llama_perf_context_print:       total time =    1701.76 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.633 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.125.186 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.127.426 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.195.451 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.481 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.505 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.662 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.680 I llama_new_context_with_model: graph nodes  = 967
0.00.197.680 I llama_new_context_with_model: graph splits = 1
0.00.197.685 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.289.774 I main: llama threadpool init, n_threads = 4
0.00.289.802 I 
0.00.289.896 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.289.909 I 
0.00.290.031 I sampler seed: 1234
...
0.02.654.408 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32097.65 tokens per second)
0.02.654.411 I llama_perf_context_print:        load time =     288.65 ms
0.02.654.413 I llama_perf_context_print: prompt eval time =     111.50 ms /     7 tokens (   15.93 ms per token,    62.78 tokens per second)
0.02.654.414 I llama_perf_context_print:        eval time =    2241.50 ms /    63 runs   (   35.58 ms per token,    28.11 tokens per second)
0.02.654.415 I llama_perf_context_print:       total time =    2364.64 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.577 I build: 4039 (3ee077a7) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.079 I llm_load_print_meta: model ftype      = Q6_K
...
0.00.126.275 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.128.502 I llama_new_context_with_model: n_seq_max     = 1
0.00.128.524 I llama_new_context_with_model: n_ctx         = 128
0.00.128.524 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.128.524 I llama_new_context_with_model: n_batch       = 128
0.00.128.524 I llama_new_context_with_model: n_ubatch      = 128
0.00.128.525 I llama_new_context_with_model: flash_attn    = 0
0.00.128.527 I llama_new_context_with_model: freq_base     = 10000.0
0.00.128.527 I llama_new_context_with_model: freq_scale    = 1
0.00.128.528 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.133.921 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.133.943 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.133.962 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.136.500 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.193.453 I 
0.00.193.579 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.193.590 I perplexity: tokenizing the input ..
0.00.202.993 I perplexity: tokenization took 9.398 ms
0.00.203.027 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.850.333 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.854.041 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.854.083 I llama_perf_context_print:        load time =     192.68 ms
0.01.854.100 I llama_perf_context_print: prompt eval time =    1645.42 ms /   128 tokens (   12.85 ms per token,    77.79 tokens per second)
0.01.854.101 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.854.102 I llama_perf_context_print:       total time =    1660.63 ms /   129 tokens
...
0.00.440.017 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.442.178 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.61user 0.62system 0:01.23elapsed 100%CPU (0avgtext+0avgdata 5358556maxresident)k
...
0.45user 0.65system 0:01.10elapsed 100%CPU (0avgtext+0avgdata 5353368maxresident)k
