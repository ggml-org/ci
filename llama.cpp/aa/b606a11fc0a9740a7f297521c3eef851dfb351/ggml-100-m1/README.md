...
- status:  SUCCESS ✅
- runtime: 447.19
- date:    Fri Mar 15 10:49:59 EET 2024
...
llama_print_timings: prompt eval time =      12.38 ms /     9 tokens (    1.38 ms per token,   727.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      36.47 ms /    10 tokens
