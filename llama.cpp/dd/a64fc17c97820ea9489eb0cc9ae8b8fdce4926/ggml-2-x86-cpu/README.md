...
- status:  SUCCESS ✅
- runtime: 18:42.79
- date:    Thu May 16 06:54:46 UTC 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/dda64fc17c97820ea9489eb0cc9ae8b8fdce4926
...
main: build = 2900 (dda64fc1)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
main: seed  = 1715841470
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.73 ms /     9 tokens (    0.41 ms per token,  2410.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      52.47 ms /    10 tokens
...
data = {'Name': ['John', 'Mary', 'Bob'],
        'Age': [25,
llama_print_timings:        load time =    1233.12 ms
llama_print_timings:      sample time =      47.73 ms /    32 runs   (    1.49 ms per token,   670.41 tokens per second)
llama_print_timings: prompt eval time =    1144.15 ms /     2 tokens (  572.08 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   20937.31 ms /    31 runs   (  675.40 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22264.63 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After you have uploaded a file to Google Drive, is there a way to download it directly to your computer without going through the Google Drive web interface?

There are
llama_print_timings:        load time =    1229.77 ms
llama_print_timings:      sample time =      47.63 ms /    32 runs   (    1.49 ms per token,   671.89 tokens per second)
llama_print_timings: prompt eval time =    1147.32 ms /     2 tokens (  573.66 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   20914.79 ms /    31 runs   (  674.67 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22242.67 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If x is the number of successes in a sequence of n independent Bernoulli trials, then the probability mass function of X is given by $$P(X = x)
llama_print_timings:        load time =    1228.49 ms
llama_print_timings:      sample time =      47.80 ms /    32 runs   (    1.49 ms per token,   669.51 tokens per second)
llama_print_timings: prompt eval time =    1142.55 ms /     2 tokens (  571.27 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21082.31 ms /    31 runs   (  680.07 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22405.46 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After the successful implementation of the ERP system, the company faced a challenge in maintaining and updating the system.

**Challenges in Maintaining and Updating ERP System**

-
llama_print_timings:        load time =    1244.62 ms
llama_print_timings:      sample time =      47.64 ms /    32 runs   (    1.49 ms per token,   671.72 tokens per second)
llama_print_timings: prompt eval time =    1144.77 ms /     2 tokens (  572.39 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21077.77 ms /    31 runs   (  679.93 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22403.43 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197317.51 ms
main:    total time = 197317.51 ms
+ echo PASS
PASS
+ echo
...
# Print the first 5
llama_print_timings:        load time =     623.85 ms
llama_print_timings:      sample time =      47.66 ms /    32 runs   (    1.49 ms per token,   671.35 tokens per second)
llama_print_timings: prompt eval time =     567.24 ms /     2 tokens (  283.62 ms per token,     3.53 tokens per second)
llama_print_timings:        eval time =   10504.77 ms /    31 runs   (  338.86 ms per token,     2.95 tokens per second)
llama_print_timings:       total time =   11252.80 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197035.81 ms
main:    total time = 197035.81 ms
+ echo PASS
PASS
+ echo
...
This book is a journey of self-discovery and personal growth. It is a guide to navigating the challenges and opportunities that
...
llama_print_timings: prompt eval time =     566.59 ms /     2 tokens (  283.29 ms per token,     3.53 tokens per second)
llama_print_timings:        eval time =   10495.08 ms /    31 runs   (  338.55 ms per token,     2.95 tokens per second)
llama_print_timings:       total time =   11242.32 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
While contemplating this statement, I couldn't help but reflect on the immense power and influence that individuals possess within
llama_print_timings:        load time =     183.71 ms
llama_print_timings:      sample time =       6.79 ms /    32 runs   (    0.21 ms per token,  4714.90 tokens per second)
llama_print_timings: prompt eval time =      78.32 ms /     2 tokens (   39.16 ms per token,    25.54 tokens per second)
llama_print_timings:        eval time =    2162.21 ms /    31 runs   (   69.75 ms per token,    14.34 tokens per second)
llama_print_timings:       total time =    2309.08 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Casting long shadows in the night.
But what if the sun never sets?

Would the world
llama_print_timings:        load time =     157.19 ms
llama_print_timings:      sample time =       6.70 ms /    32 runs   (    0.21 ms per token,  4778.97 tokens per second)
llama_print_timings: prompt eval time =      75.74 ms /     2 tokens (   37.87 ms per token,    26.41 tokens per second)
llama_print_timings:        eval time =    2074.72 ms /    31 runs   (   66.93 ms per token,    14.94 tokens per second)
llama_print_timings:       total time =    2220.50 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heals is a faith-based mental health platform that provides evidence-based therapy sessions and resources for individuals struggling with anxiety, depression, and other mental health challenges.
llama_print_timings:        load time =     160.48 ms
llama_print_timings:      sample time =       7.62 ms /    32 runs   (    0.24 ms per token,  4202.23 tokens per second)
llama_print_timings: prompt eval time =      76.95 ms /     2 tokens (   38.48 ms per token,    25.99 tokens per second)
llama_print_timings:        eval time =    2122.20 ms /    31 runs   (   68.46 ms per token,    14.61 tokens per second)
llama_print_timings:       total time =    2268.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say opposites attract, and that seems to be true in the case of Emily and Ethan.

Emily, a bright and bubbly social media influencer, thrives on the
llama_print_timings:        load time =     160.86 ms
llama_print_timings:      sample time =       6.97 ms /    32 runs   (    0.22 ms per token,  4590.45 tokens per second)
llama_print_timings: prompt eval time =      79.77 ms /     2 tokens (   39.88 ms per token,    25.07 tokens per second)
llama_print_timings:        eval time =    2217.58 ms /    31 runs   (   71.53 ms per token,    13.98 tokens per second)
llama_print_timings:       total time =    2366.58 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31973.17 ms
main:    total time = 31973.17 ms
+ echo PASS
PASS
+ echo
...
<bos> The Legend of Zelda: Breath of the Wild

**Introduction:**

The Legend of Zelda: Breath of the Wild is a groundbreaking open-world adventure game that has
llama_print_timings:        load time =     121.95 ms
llama_print_timings:      sample time =       7.01 ms /    32 runs   (    0.22 ms per token,  4566.21 tokens per second)
llama_print_timings: prompt eval time =      66.88 ms /     2 tokens (   33.44 ms per token,    29.90 tokens per second)
llama_print_timings:        eval time =    1560.59 ms /    31 runs   (   50.34 ms per token,    19.86 tokens per second)
llama_print_timings:       total time =    1695.81 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32058.91 ms
main:    total time = 32058.91 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a young girl named Lily who dreamed of becoming an astronaut. She spent countless hours studying star charts, dreaming of the vast unknown beyond Earth.


llama_print_timings:        load time =     122.92 ms
llama_print_timings:      sample time =       6.65 ms /    32 runs   (    0.21 ms per token,  4810.58 tokens per second)
llama_print_timings: prompt eval time =     120.98 ms /     5 tokens (   24.20 ms per token,    41.33 tokens per second)
llama_print_timings:        eval time =    1641.60 ms /    31 runs   (   52.95 ms per token,    18.88 tokens per second)
llama_print_timings:       total time =    1830.88 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     377.13 ms
llama_print_timings:      sample time =       2.35 ms /    64 runs   (    0.04 ms per token, 27245.64 tokens per second)
llama_print_timings: prompt eval time =     301.61 ms /     8 tokens (   37.70 ms per token,    26.52 tokens per second)
llama_print_timings:        eval time =    7394.97 ms /    63 runs   (  117.38 ms per token,     8.52 tokens per second)
llama_print_timings:       total time =    7720.47 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     342.15 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4682.69 ms /   128 tokens (   36.58 ms per token,    27.33 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4695.79 ms /   129 tokens
...
llama_print_timings:        load time =     295.70 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31746.03 tokens per second)
llama_print_timings: prompt eval time =     206.92 ms /     8 tokens (   25.86 ms per token,    38.66 tokens per second)
llama_print_timings:        eval time =    5276.61 ms /    63 runs   (   83.76 ms per token,    11.94 tokens per second)
llama_print_timings:       total time =    5502.55 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2843.32 ms /   128 tokens (   22.21 ms per token,    45.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2856.60 ms /   129 tokens
...
llama_print_timings: prompt eval time =     207.43 ms /     8 tokens (   25.93 ms per token,    38.57 tokens per second)
llama_print_timings:        eval time =    4321.07 ms /    63 runs   (   68.59 ms per token,    14.58 tokens per second)
llama_print_timings:       total time =    4548.09 ms /    71 tokens
Log end
...
[1]4.1675,
llama_print_timings:        load time =     171.45 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3151.92 ms /   128 tokens (   24.62 ms per token,    40.61 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3165.35 ms /   129 tokens
...
llama_print_timings: prompt eval time =     374.83 ms /     8 tokens (   46.85 ms per token,    21.34 tokens per second)
llama_print_timings:        eval time =    4573.75 ms /    63 runs   (   72.60 ms per token,    13.77 tokens per second)
llama_print_timings:       total time =    4967.77 ms /    71 tokens
Log end
...
[1]4.3889,
llama_print_timings:        load time =     201.81 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5874.19 ms /   128 tokens (   45.89 ms per token,    21.79 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5887.24 ms /   129 tokens
...
llama_print_timings:        load time =     245.11 ms
llama_print_timings:      sample time =       2.07 ms /    64 runs   (    0.03 ms per token, 30902.95 tokens per second)
llama_print_timings: prompt eval time =     394.80 ms /     8 tokens (   49.35 ms per token,    20.26 tokens per second)
llama_print_timings:        eval time =    4995.62 ms /    63 runs   (   79.30 ms per token,    12.61 tokens per second)
llama_print_timings:       total time =    5410.05 ms /    71 tokens
Log end
...
[1]4.3261,
llama_print_timings:        load time =     214.98 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6158.04 ms /   128 tokens (   48.11 ms per token,    20.79 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6171.53 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     262.15 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31387.94 tokens per second)
llama_print_timings: prompt eval time =     420.41 ms /     8 tokens (   52.55 ms per token,    19.03 tokens per second)
llama_print_timings:        eval time =    5270.96 ms /    63 runs   (   83.67 ms per token,    11.95 tokens per second)
llama_print_timings:       total time =    5711.59 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.364 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 6.59 seconds per pass - ETA 0.10 minutes
[1]4.2586,
llama_print_timings:        load time =     229.53 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6584.40 ms /   128 tokens (   51.44 ms per token,    19.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6597.91 ms /   129 tokens
...
llama_print_timings:        load time =     264.39 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31620.55 tokens per second)
llama_print_timings: prompt eval time =     614.56 ms /     8 tokens (   76.82 ms per token,    13.02 tokens per second)
llama_print_timings:        eval time =    5790.88 ms /    63 runs   (   91.92 ms per token,    10.88 tokens per second)
llama_print_timings:       total time =    6424.84 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9919.13 ms /   128 tokens (   77.49 ms per token,    12.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9933.08 ms /   129 tokens
...
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31387.94 tokens per second)
llama_print_timings: prompt eval time =     467.61 ms /     8 tokens (   58.45 ms per token,    17.11 tokens per second)
llama_print_timings:        eval time =    4950.61 ms /    63 runs   (   78.58 ms per token,    12.73 tokens per second)
llama_print_timings:       total time =    5438.02 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7429.29 ms /   128 tokens (   58.04 ms per token,    17.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7442.80 ms /   129 tokens
...
llama_print_timings:        load time =     237.77 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31295.84 tokens per second)
llama_print_timings: prompt eval time =     392.35 ms /     8 tokens (   49.04 ms per token,    20.39 tokens per second)
llama_print_timings:        eval time =    4818.99 ms /    63 runs   (   76.49 ms per token,    13.07 tokens per second)
llama_print_timings:       total time =    5230.44 ms /    71 tokens
Log end
...
[1]4.1768,
llama_print_timings:        load time =     204.03 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6175.00 ms /   128 tokens (   48.24 ms per token,    20.73 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6188.51 ms /   129 tokens
...
llama_print_timings: prompt eval time =     463.51 ms /     8 tokens (   57.94 ms per token,    17.26 tokens per second)
llama_print_timings:        eval time =    5608.40 ms /    63 runs   (   89.02 ms per token,    11.23 tokens per second)
llama_print_timings:       total time =    6091.23 ms /    71 tokens
Log end
...
[1]4.2338,
llama_print_timings:        load time =     233.02 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7289.20 ms /   128 tokens (   56.95 ms per token,    17.56 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7302.41 ms /   129 tokens
...
llama_print_timings:        load time =     293.49 ms
llama_print_timings:      sample time =       2.02 ms /    64 runs   (    0.03 ms per token, 31761.79 tokens per second)
llama_print_timings: prompt eval time =     519.25 ms /     8 tokens (   64.91 ms per token,    15.41 tokens per second)
llama_print_timings:        eval time =    6220.58 ms /    63 runs   (   98.74 ms per token,    10.13 tokens per second)
llama_print_timings:       total time =    6759.79 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     259.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8149.89 ms /   128 tokens (   63.67 ms per token,    15.71 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8163.04 ms /   129 tokens
...
first run: The quick brown fox jumping over a lazy dog is an example of:
-Don't tell


second run: The quick brown fox jumping over a lazy dog is an example of:
-Don't tell


single seq run: The quick brown fox jumping over a lazy dog is an example of:
-Don't tell
...
first run: The quick brown fox jumped over the big wide garden.
For –
Wh: How, what


second run: The quick brown fox jumped over the big wide garden.
For –
Wh: How, what


single seq run: The quick brown fox jumped over the big wide garden.
For –
Wh: How, what
...
0.33user 0.36system 0:00.70elapsed 99%CPU (0avgtext+0avgdata 6880760maxresident)k
...
0.12user 0.35system 0:00.48elapsed 99%CPU (0avgtext+0avgdata 6880176maxresident)k
0inputs+40outputs (0major+114699minor)pagefaults 0swaps
```
