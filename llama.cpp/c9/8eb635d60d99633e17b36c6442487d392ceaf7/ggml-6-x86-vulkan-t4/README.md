...
- status:  FAILURE ❌ (139)
- runtime: 5:53.12
- date:    Sat Jan  4 14:28:10 UTC 2025
...
24/28 Test #24: test-backend-ops ..................   Passed   46.99 sec
...
23/28 Test #23: test-gguf .........................   Passed    0.59 sec
      Start 24: test-backend-ops
24/28 Test #24: test-backend-ops ..................   Passed   10.58 sec
      Start 27: test-barrier
...
0.00.000.178 I build: 4415 (c98eb635) with cc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0 for x86_64-linux-gnu
0.00.000.358 I llama_load_model_from_file: using device Vulkan0 (Tesla T4) - 16384 MiB free
0.00.004.362 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.004.395 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
...
0.00.010.933 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.010.934 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
0.00.010.934 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
...
0.00.024.166 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.024.176 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.024.177 I llm_load_print_meta: arch             = bert
0.00.024.177 I llm_load_print_meta: vocab type       = WPM
0.00.024.178 I llm_load_print_meta: n_vocab          = 30522
0.00.024.178 I llm_load_print_meta: n_merges         = 0
0.00.024.178 I llm_load_print_meta: vocab_only       = 0
0.00.024.179 I llm_load_print_meta: n_ctx_train      = 512
0.00.024.179 I llm_load_print_meta: n_embd           = 384
0.00.024.179 I llm_load_print_meta: n_layer          = 12
0.00.024.185 I llm_load_print_meta: n_head           = 12
0.00.024.187 I llm_load_print_meta: n_head_kv        = 12
0.00.024.187 I llm_load_print_meta: n_rot            = 32
0.00.024.187 I llm_load_print_meta: n_swa            = 0
0.00.024.188 I llm_load_print_meta: n_embd_head_k    = 32
0.00.024.188 I llm_load_print_meta: n_embd_head_v    = 32
0.00.024.189 I llm_load_print_meta: n_gqa            = 1
0.00.024.191 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.024.192 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.024.193 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.024.193 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.024.194 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.024.194 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.024.194 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.024.196 I llm_load_print_meta: n_ff             = 1536
0.00.024.196 I llm_load_print_meta: n_expert         = 0
0.00.024.196 I llm_load_print_meta: n_expert_used    = 0
0.00.024.197 I llm_load_print_meta: causal attn      = 0
0.00.024.197 I llm_load_print_meta: pooling type     = 2
0.00.024.197 I llm_load_print_meta: rope type        = 2
0.00.024.197 I llm_load_print_meta: rope scaling     = linear
0.00.024.198 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.024.199 I llm_load_print_meta: freq_scale_train = 1
0.00.024.199 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.024.200 I llm_load_print_meta: rope_finetuned   = unknown
0.00.024.200 I llm_load_print_meta: ssm_d_conv       = 0
0.00.024.201 I llm_load_print_meta: ssm_d_inner      = 0
0.00.024.201 I llm_load_print_meta: ssm_d_state      = 0
0.00.024.202 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.024.202 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.024.203 I llm_load_print_meta: model type       = 33M
0.00.024.205 I llm_load_print_meta: model ftype      = F16
0.00.024.206 I llm_load_print_meta: model params     = 33.21 M
0.00.024.206 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.024.207 I llm_load_print_meta: general.name     = Bge Small
0.00.024.207 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.024.207 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.024.208 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.024.209 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.024.209 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.024.209 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.024.210 I llm_load_print_meta: max token length = 21
ggml_vulkan: Compiling shaders...................................................Done!
0.00.293.410 I llm_load_tensors: offloading 12 repeating layers to GPU
0.00.293.417 I llm_load_tensors: offloading output layer to GPU
0.00.293.417 I llm_load_tensors: offloaded 13/13 layers to GPU
0.00.293.422 I llm_load_tensors:      Vulkan0 model buffer size =    40.73 MiB
0.00.293.423 I llm_load_tensors:   CPU_Mapped model buffer size =    23.11 MiB
................................................
0.00.303.468 I llama_new_context_with_model: n_seq_max     = 1
0.00.303.472 I llama_new_context_with_model: n_ctx         = 512
0.00.303.473 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.303.473 I llama_new_context_with_model: n_batch       = 2048
0.00.303.473 I llama_new_context_with_model: n_ubatch      = 2048
0.00.303.474 I llama_new_context_with_model: flash_attn    = 0
0.00.303.478 I llama_new_context_with_model: freq_base     = 10000.0
0.00.303.479 I llama_new_context_with_model: freq_scale    = 1
0.00.303.994 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.306.525 I llama_kv_cache_init:    Vulkan0 KV buffer size =     9.00 MiB
0.00.306.533 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.306.539 I llama_new_context_with_model: Vulkan_Host  output buffer size =     0.00 MiB
0.00.310.269 I llama_new_context_with_model:    Vulkan0 compute buffer size =    16.00 MiB
0.00.310.276 I llama_new_context_with_model: Vulkan_Host compute buffer size =     2.51 MiB
0.00.310.277 I llama_new_context_with_model: graph nodes  = 429
0.00.310.277 I llama_new_context_with_model: graph splits = 4 (with bs=512), 2 (with bs=1)
0.00.310.280 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.310.280 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.317.028 I 
0.00.317.089 I system_info: n_threads = 4 (n_threads_batch = 4) / 4 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.318.784 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.324.916 I llama_perf_context_print:        load time =     316.66 ms
0.00.324.917 I llama_perf_context_print: prompt eval time =       5.95 ms /     9 tokens (    0.66 ms per token,  1512.86 tokens per second)
0.00.324.918 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.324.919 I llama_perf_context_print:       total time =       7.89 ms /    10 tokens
ci/run.sh: line 709: 1036684 Segmentation fault      (core dumped) ./bin/llama-embedding --model ${model_f16} -p "I believe the meaning of life is" -ngl 99 -c 0
