...
- status:  FAILURE ❌ (139)
- runtime: 6:13.01
- date:    Tue Aug 27 07:41:50 UTC 2024
...
llama_print_timings: prompt eval time =       7.04 ms /     9 tokens (    0.78 ms per token,  1278.41 tokens per second)
...
ci/run.sh: line 463: 2991366 Segmentation fault      (core dumped) ./bin/llama-cli --model ${model_f16} -s 1234 -n 64 --ignore-eos -p "I believe the meaning of life is"
