...
- status:  SUCCESS ✅
- runtime: 4:14.84
- date:    Tue Dec  3 09:44:19 UTC 2024
...
0.00.000.290 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.359 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.003.397 I llama_model_loader: - kv   4:                         general.size_label str              = small
0.00.003.401 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
...
0.00.006.662 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.007.412 I llama_model_loader: - type  f16:   73 tensors
0.00.018.466 I llm_load_vocab: special tokens cache size = 5
0.00.021.023 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.051 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.052 I llm_load_print_meta: arch             = bert
0.00.021.054 I llm_load_print_meta: vocab type       = WPM
0.00.021.054 I llm_load_print_meta: n_vocab          = 30522
0.00.021.055 I llm_load_print_meta: n_merges         = 0
0.00.021.055 I llm_load_print_meta: vocab_only       = 0
0.00.021.055 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.055 I llm_load_print_meta: n_embd           = 384
0.00.021.056 I llm_load_print_meta: n_layer          = 12
0.00.021.065 I llm_load_print_meta: n_head           = 12
0.00.021.065 I llm_load_print_meta: n_head_kv        = 12
0.00.021.066 I llm_load_print_meta: n_rot            = 32
0.00.021.066 I llm_load_print_meta: n_swa            = 0
0.00.021.066 I llm_load_print_meta: n_embd_head_k    = 32
0.00.021.066 I llm_load_print_meta: n_embd_head_v    = 32
0.00.021.067 I llm_load_print_meta: n_gqa            = 1
0.00.021.068 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.069 I llm_load_print_meta: n_embd_v_gqa     = 384
...
0.00.021.073 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.021.078 I llm_load_print_meta: rope type        = 2
0.00.021.079 I llm_load_print_meta: rope scaling     = linear
0.00.021.080 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.081 I llm_load_print_meta: freq_scale_train = 1
0.00.021.145 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.146 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.146 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.147 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.148 I llm_load_print_meta: ssm_d_state      = 0
0.00.021.149 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.021.149 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.151 I llm_load_print_meta: model type       = 33M
0.00.021.152 I llm_load_print_meta: model ftype      = F16
0.00.021.153 I llm_load_print_meta: model params     = 33.21 M
0.00.021.155 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.021.155 I llm_load_print_meta: general.name     = Bge Small
0.00.021.156 I llm_load_print_meta: UNK token        = 100 '[UNK]'
...
0.00.025.207 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.025.221 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.039.874 I llama_new_context_with_model: n_seq_max     = 1
0.00.039.889 I llama_new_context_with_model: n_ctx         = 512
0.00.039.889 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.039.889 I llama_new_context_with_model: n_batch       = 2048
0.00.039.890 I llama_new_context_with_model: n_ubatch      = 2048
0.00.039.890 I llama_new_context_with_model: flash_attn    = 0
0.00.039.892 I llama_new_context_with_model: freq_base     = 10000.0
0.00.039.893 I llama_new_context_with_model: freq_scale    = 1
0.00.041.814 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.041.840 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.041.847 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.043.865 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.043.887 I llama_new_context_with_model: graph nodes  = 429
0.00.043.887 I llama_new_context_with_model: graph splits = 1
0.00.043.890 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.047.220 I 
0.00.047.325 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.049.076 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.053.322 I llama_perf_context_print:        load time =      46.89 ms
0.00.053.324 I llama_perf_context_print: prompt eval time =       3.81 ms /     9 tokens (    0.42 ms per token,  2362.20 tokens per second)
0.00.053.325 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.053.326 I llama_perf_context_print:       total time =       6.10 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.609 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.736 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.003.773 I llama_model_loader: - kv   3:                           general.basename str              = bge
...
0.00.019.050 I llm_load_vocab: special tokens cache size = 5
0.00.021.664 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.021.691 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.692 I llm_load_print_meta: n_embd           = 384
0.00.021.692 I llm_load_print_meta: n_layer          = 12
0.00.021.701 I llm_load_print_meta: n_head           = 12
0.00.021.701 I llm_load_print_meta: n_head_kv        = 12
0.00.021.702 I llm_load_print_meta: n_rot            = 32
0.00.021.702 I llm_load_print_meta: n_swa            = 0
0.00.021.702 I llm_load_print_meta: n_embd_head_k    = 32
0.00.021.702 I llm_load_print_meta: n_embd_head_v    = 32
0.00.021.703 I llm_load_print_meta: n_gqa            = 1
0.00.021.704 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.705 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.021.706 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.021.706 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.706 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.706 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.707 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.707 I llm_load_print_meta: n_ff             = 1536
0.00.021.708 I llm_load_print_meta: n_expert         = 0
0.00.021.708 I llm_load_print_meta: n_expert_used    = 0
0.00.021.709 I llm_load_print_meta: causal attn      = 0
0.00.021.709 I llm_load_print_meta: pooling type     = 2
0.00.021.709 I llm_load_print_meta: rope type        = 2
0.00.021.710 I llm_load_print_meta: rope scaling     = linear
0.00.021.711 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.712 I llm_load_print_meta: freq_scale_train = 1
0.00.021.712 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.712 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.713 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.713 I llm_load_print_meta: ssm_d_inner      = 0
...
0.00.021.715 I llm_load_print_meta: model ftype      = Q8_0
0.00.021.716 I llm_load_print_meta: model params     = 33.21 M
0.00.021.717 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.021.717 I llm_load_print_meta: general.name     = Bge Small
0.00.021.718 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.718 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.719 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.719 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.719 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.720 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.720 I llm_load_print_meta: max token length = 21
0.00.024.473 I llm_load_tensors:          AMX model buffer size =    24.05 MiB
0.00.024.490 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.032.236 I llama_new_context_with_model: n_seq_max     = 1
0.00.032.252 I llama_new_context_with_model: n_ctx         = 512
0.00.032.252 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.032.252 I llama_new_context_with_model: n_batch       = 2048
0.00.032.252 I llama_new_context_with_model: n_ubatch      = 2048
0.00.032.253 I llama_new_context_with_model: flash_attn    = 0
0.00.032.254 I llama_new_context_with_model: freq_base     = 10000.0
0.00.032.255 I llama_new_context_with_model: freq_scale    = 1
0.00.033.855 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.033.880 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.033.885 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.035.813 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.035.836 I llama_new_context_with_model: graph nodes  = 429
0.00.035.837 I llama_new_context_with_model: graph splits = 1
0.00.035.839 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.038.061 I 
0.00.038.150 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.039.685 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.042.495 I llama_perf_context_print:        load time =      37.41 ms
0.00.042.497 I llama_perf_context_print: prompt eval time =       1.93 ms /     9 tokens (    0.21 ms per token,  4672.90 tokens per second)
0.00.042.499 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.042.499 I llama_perf_context_print:       total time =       4.43 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.274 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.060 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.008.083 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.008.096 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.008.097 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.098 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.099 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.099 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.102 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.104 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.104 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.105 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.106 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.110 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.111 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.112 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.112 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.112 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.014.047 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.015.572 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.260 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.277 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.278 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.278 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.278 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.279 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.279 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.280 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.280 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.280 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.281 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.281 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.284 I llama_model_loader: - type  f32:   41 tensors
0.00.019.284 I llama_model_loader: - type  f16:   29 tensors
0.00.037.153 W llm_load_vocab: empty token at index 5
0.00.047.658 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.122 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.249 I llm_load_vocab: special tokens cache size = 5
0.00.343.907 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.343.930 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.343.930 I llm_load_print_meta: arch             = jina-bert-v2
0.00.343.931 I llm_load_print_meta: vocab type       = BPE
0.00.343.931 I llm_load_print_meta: n_vocab          = 61056
0.00.343.932 I llm_load_print_meta: n_merges         = 39382
0.00.343.932 I llm_load_print_meta: vocab_only       = 0
0.00.343.932 I llm_load_print_meta: n_ctx_train      = 8192
0.00.343.933 I llm_load_print_meta: n_embd           = 384
0.00.343.933 I llm_load_print_meta: n_layer          = 4
0.00.343.941 I llm_load_print_meta: n_head           = 12
0.00.343.942 I llm_load_print_meta: n_head_kv        = 12
0.00.343.942 I llm_load_print_meta: n_rot            = 32
0.00.343.943 I llm_load_print_meta: n_swa            = 0
0.00.343.943 I llm_load_print_meta: n_embd_head_k    = 32
0.00.343.943 I llm_load_print_meta: n_embd_head_v    = 32
0.00.343.944 I llm_load_print_meta: n_gqa            = 1
0.00.343.945 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.343.945 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.343.947 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.343.948 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.343.948 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.343.949 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.343.949 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.343.950 I llm_load_print_meta: n_ff             = 1536
0.00.343.950 I llm_load_print_meta: n_expert         = 0
0.00.343.950 I llm_load_print_meta: n_expert_used    = 0
0.00.343.951 I llm_load_print_meta: causal attn      = 0
0.00.343.951 I llm_load_print_meta: pooling type     = -1
0.00.343.951 I llm_load_print_meta: rope type        = -1
0.00.343.952 I llm_load_print_meta: rope scaling     = linear
0.00.343.953 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.343.954 I llm_load_print_meta: freq_scale_train = 1
0.00.343.954 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.343.954 I llm_load_print_meta: rope_finetuned   = unknown
0.00.343.955 I llm_load_print_meta: ssm_d_conv       = 0
0.00.343.955 I llm_load_print_meta: ssm_d_inner      = 0
0.00.343.955 I llm_load_print_meta: ssm_d_state      = 0
0.00.343.956 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.343.956 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.343.956 I llm_load_print_meta: model type       = 33M
0.00.343.957 I llm_load_print_meta: model ftype      = F16
0.00.343.958 I llm_load_print_meta: model params     = 32.90 M
0.00.343.959 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.343.959 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.343.959 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.343.960 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.343.960 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.343.960 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.343.961 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.343.961 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.343.961 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.343.962 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.343.962 I llm_load_print_meta: max token length = 45
0.00.347.311 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.347.326 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.355.208 I llama_new_context_with_model: n_seq_max     = 1
0.00.355.231 I llama_new_context_with_model: n_ctx         = 8192
0.00.355.232 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.355.232 I llama_new_context_with_model: n_batch       = 2048
0.00.355.232 I llama_new_context_with_model: n_ubatch      = 2048
0.00.355.233 I llama_new_context_with_model: flash_attn    = 0
0.00.355.234 I llama_new_context_with_model: freq_base     = 10000.0
0.00.355.235 I llama_new_context_with_model: freq_scale    = 1
0.00.364.182 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.364.208 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.364.215 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.366.000 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.366.021 I llama_new_context_with_model: graph nodes  = 154
0.00.366.022 I llama_new_context_with_model: graph splits = 1
0.00.366.024 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.374.091 I 
0.00.374.179 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.374.396 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.374.409 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.374.414 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.374.415 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.374.420 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.374.420 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.385.784 I llama_perf_context_print:        load time =     373.77 ms
0.00.385.785 I llama_perf_context_print: prompt eval time =       7.31 ms /    62 tokens (    0.12 ms per token,  8486.18 tokens per second)
0.00.385.786 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.385.787 I llama_perf_context_print:       total time =      11.69 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.298 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.078.142 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.078.143 I llm_load_print_meta: arch             = gptneox
0.00.078.143 I llm_load_print_meta: vocab type       = BPE
0.00.078.144 I llm_load_print_meta: n_vocab          = 50304
0.00.078.144 I llm_load_print_meta: n_merges         = 50009
0.00.078.144 I llm_load_print_meta: vocab_only       = 0
0.00.078.145 I llm_load_print_meta: n_ctx_train      = 2048
0.00.078.145 I llm_load_print_meta: n_embd           = 2048
0.00.078.145 I llm_load_print_meta: n_layer          = 24
0.00.078.154 I llm_load_print_meta: n_head           = 16
0.00.078.155 I llm_load_print_meta: n_head_kv        = 16
0.00.078.155 I llm_load_print_meta: n_rot            = 32
0.00.078.155 I llm_load_print_meta: n_swa            = 0
0.00.078.156 I llm_load_print_meta: n_embd_head_k    = 128
0.00.078.156 I llm_load_print_meta: n_embd_head_v    = 128
0.00.078.157 I llm_load_print_meta: n_gqa            = 1
0.00.078.158 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.078.159 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.078.160 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.078.161 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.078.161 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.078.162 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.078.162 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.078.163 I llm_load_print_meta: n_ff             = 8192
0.00.078.163 I llm_load_print_meta: n_expert         = 0
0.00.078.163 I llm_load_print_meta: n_expert_used    = 0
0.00.078.163 I llm_load_print_meta: causal attn      = 1
0.00.078.164 I llm_load_print_meta: pooling type     = 0
0.00.078.164 I llm_load_print_meta: rope type        = 2
0.00.078.164 I llm_load_print_meta: rope scaling     = linear
0.00.078.166 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.078.166 I llm_load_print_meta: freq_scale_train = 1
0.00.078.167 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.078.167 I llm_load_print_meta: rope_finetuned   = unknown
0.00.078.168 I llm_load_print_meta: ssm_d_conv       = 0
0.00.078.168 I llm_load_print_meta: ssm_d_inner      = 0
0.00.078.168 I llm_load_print_meta: ssm_d_state      = 0
0.00.078.168 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.078.168 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.078.169 I llm_load_print_meta: model type       = 1.4B
0.00.078.170 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.078.171 I llm_load_print_meta: model params     = 1.41 B
0.00.078.172 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
0.00.078.172 I llm_load_print_meta: general.name     = 1.4B
0.00.078.172 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.078.173 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.078.173 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.078.173 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.078.174 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.078.174 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.078.175 I llm_load_print_meta: max token length = 1024
0.00.198.576 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.198.593 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.995.100 I llama_new_context_with_model: n_seq_max     = 1
0.00.995.124 I llama_new_context_with_model: n_ctx         = 2048
0.00.995.125 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.995.125 I llama_new_context_with_model: n_batch       = 2048
0.00.995.125 I llama_new_context_with_model: n_ubatch      = 512
0.00.995.126 I llama_new_context_with_model: flash_attn    = 0
0.00.995.131 I llama_new_context_with_model: freq_base     = 10000.0
0.00.995.132 I llama_new_context_with_model: freq_scale    = 1
0.01.066.074 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.066.105 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.066.138 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.068.299 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.01.068.323 I llama_new_context_with_model: graph nodes  = 967
0.01.068.324 I llama_new_context_with_model: graph splits = 1
0.01.068.328 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.167.384 I main: llama threadpool init, n_threads = 4
0.01.167.416 I 
0.01.167.496 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.167.509 I 
0.01.167.646 I sampler seed: 1234
0.01.167.666 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.167.669 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.167.670 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.167.670 I 
...
0.04.967.513 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31541.54 tokens per second)
0.04.967.516 I llama_perf_context_print:        load time =    1166.80 ms
0.04.967.517 I llama_perf_context_print: prompt eval time =      95.22 ms /     7 tokens (   13.60 ms per token,    73.51 tokens per second)
0.04.967.518 I llama_perf_context_print:        eval time =    3693.51 ms /    63 runs   (   58.63 ms per token,    17.06 tokens per second)
0.04.967.519 I llama_perf_context_print:       total time =    3800.14 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.741 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.080 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.020.756 I llama_model_loader: - type  f16:   98 tensors
0.00.063.323 I llm_load_vocab: special tokens cache size = 25
...
0.00.201.200 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.201.217 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.002.051 I llama_new_context_with_model: n_seq_max     = 1
0.01.002.074 I llama_new_context_with_model: n_ctx         = 128
0.01.002.074 I llama_new_context_with_model: n_ctx_per_seq = 128
0.01.002.075 I llama_new_context_with_model: n_batch       = 128
0.01.002.075 I llama_new_context_with_model: n_ubatch      = 128
0.01.002.076 I llama_new_context_with_model: flash_attn    = 0
0.01.002.082 I llama_new_context_with_model: freq_base     = 10000.0
0.01.002.082 I llama_new_context_with_model: freq_scale    = 1
0.01.002.083 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.006.914 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.006.944 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.006.974 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.009.184 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.01.009.199 I llama_new_context_with_model: graph nodes  = 967
0.01.009.200 I llama_new_context_with_model: graph splits = 1
0.01.009.202 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.072.939 I 
0.01.073.050 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.01.073.057 I perplexity: tokenizing the input ..
0.01.082.566 I perplexity: tokenization took 9.505 ms
0.01.082.602 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.978.235 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.981.806 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.981.848 I llama_perf_context_print:        load time =    1072.15 ms
0.01.981.850 I llama_perf_context_print: prompt eval time =     893.87 ms /   128 tokens (    6.98 ms per token,   143.20 tokens per second)
0.01.981.852 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.981.853 I llama_perf_context_print:       total time =     908.91 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.688 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.655 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
0.00.021.657 I llama_model_loader: - type  f32:  194 tensors
0.00.021.658 I llama_model_loader: - type q8_0:   98 tensors
...
0.00.076.090 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.090 I llm_load_print_meta: model params     = 1.41 B
0.00.076.091 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.166.223 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.166.239 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.621.451 I llama_new_context_with_model: n_seq_max     = 1
0.00.621.467 I llama_new_context_with_model: n_ctx         = 2048
0.00.621.467 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.621.468 I llama_new_context_with_model: n_batch       = 2048
0.00.621.468 I llama_new_context_with_model: n_ubatch      = 512
0.00.621.469 I llama_new_context_with_model: flash_attn    = 0
0.00.621.473 I llama_new_context_with_model: freq_base     = 10000.0
0.00.621.474 I llama_new_context_with_model: freq_scale    = 1
0.00.690.997 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.691.029 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.691.058 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.693.310 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.693.327 I llama_new_context_with_model: graph nodes  = 967
0.00.693.327 I llama_new_context_with_model: graph splits = 1
0.00.693.332 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.772.214 I main: llama threadpool init, n_threads = 4
0.00.772.244 I 
0.00.772.326 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.772.327 I 
0.00.772.464 I sampler seed: 1234
0.00.772.485 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.772.488 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.772.489 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.772.489 I 
...
0.02.904.095 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32126.70 tokens per second)
0.02.904.098 I llama_perf_context_print:        load time =     771.25 ms
0.02.904.099 I llama_perf_context_print: prompt eval time =      49.97 ms /     7 tokens (    7.14 ms per token,   140.10 tokens per second)
0.02.904.100 I llama_perf_context_print:        eval time =    2070.74 ms /    63 runs   (   32.87 ms per token,    30.42 tokens per second)
0.02.904.101 I llama_perf_context_print:       total time =    2131.89 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.717 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.065.196 I llm_load_vocab: special tokens cache size = 25
...
0.00.076.785 I llm_load_print_meta: vocab_only       = 0
0.00.076.785 I llm_load_print_meta: n_ctx_train      = 2048
0.00.076.785 I llm_load_print_meta: n_embd           = 2048
0.00.076.786 I llm_load_print_meta: n_layer          = 24
0.00.076.795 I llm_load_print_meta: n_head           = 16
0.00.076.796 I llm_load_print_meta: n_head_kv        = 16
0.00.076.796 I llm_load_print_meta: n_rot            = 32
0.00.076.796 I llm_load_print_meta: n_swa            = 0
0.00.076.797 I llm_load_print_meta: n_embd_head_k    = 128
0.00.076.797 I llm_load_print_meta: n_embd_head_v    = 128
0.00.076.798 I llm_load_print_meta: n_gqa            = 1
0.00.076.799 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.076.800 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.076.801 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.076.802 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.076.802 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.076.803 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.076.803 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.076.804 I llm_load_print_meta: n_ff             = 8192
0.00.076.804 I llm_load_print_meta: n_expert         = 0
0.00.076.804 I llm_load_print_meta: n_expert_used    = 0
0.00.076.805 I llm_load_print_meta: causal attn      = 1
0.00.076.805 I llm_load_print_meta: pooling type     = 0
0.00.076.805 I llm_load_print_meta: rope type        = 2
0.00.076.805 I llm_load_print_meta: rope scaling     = linear
0.00.076.807 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.076.808 I llm_load_print_meta: freq_scale_train = 1
0.00.076.808 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.076.808 I llm_load_print_meta: rope_finetuned   = unknown
0.00.076.809 I llm_load_print_meta: ssm_d_conv       = 0
0.00.076.809 I llm_load_print_meta: ssm_d_inner      = 0
0.00.076.809 I llm_load_print_meta: ssm_d_state      = 0
...
0.00.076.811 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.811 I llm_load_print_meta: model params     = 1.41 B
0.00.076.812 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
0.00.076.812 I llm_load_print_meta: general.name     = 1.4B
0.00.076.813 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.076.813 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.076.813 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.076.814 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.076.814 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.814 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.815 I llm_load_print_meta: max token length = 1024
0.00.167.902 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.167.919 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.629.870 I llama_new_context_with_model: n_seq_max     = 1
0.00.629.885 I llama_new_context_with_model: n_ctx         = 128
0.00.629.885 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.629.885 I llama_new_context_with_model: n_batch       = 128
0.00.629.886 I llama_new_context_with_model: n_ubatch      = 128
0.00.629.886 I llama_new_context_with_model: flash_attn    = 0
0.00.629.891 I llama_new_context_with_model: freq_base     = 10000.0
0.00.629.892 I llama_new_context_with_model: freq_scale    = 1
0.00.629.893 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.634.755 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.634.784 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.634.809 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.636.897 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.636.919 I llama_new_context_with_model: graph nodes  = 967
0.00.636.919 I llama_new_context_with_model: graph splits = 1
0.00.636.922 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.680.486 I 
0.00.680.601 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.680.610 I perplexity: tokenizing the input ..
0.00.690.131 I perplexity: tokenization took 9.518 ms
0.00.690.162 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.064.210 I perplexity: 0.37 seconds per pass - ETA 0.00 minutes
[1]10.1288,
0.01.068.135 I Final estimate: PPL = 10.1288 +/- 3.22324

0.01.068.177 I llama_perf_context_print:        load time =     679.73 ms
0.01.068.179 I llama_perf_context_print: prompt eval time =     372.17 ms /   128 tokens (    2.91 ms per token,   343.93 tokens per second)
0.01.068.181 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.068.182 I llama_perf_context_print:       total time =     387.69 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.646 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.189 I llama_model_loader: - type q4_0:   97 tensors
...
0.00.075.948 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.949 I llm_load_print_meta: model params     = 1.41 B
0.00.075.950 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.126.199 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.126.216 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.404.462 I llama_new_context_with_model: n_seq_max     = 1
0.00.404.483 I llama_new_context_with_model: n_ctx         = 2048
0.00.404.483 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.404.484 I llama_new_context_with_model: n_batch       = 2048
0.00.404.484 I llama_new_context_with_model: n_ubatch      = 512
0.00.404.485 I llama_new_context_with_model: flash_attn    = 0
0.00.404.489 I llama_new_context_with_model: freq_base     = 10000.0
0.00.404.490 I llama_new_context_with_model: freq_scale    = 1
0.00.473.367 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.473.396 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.473.430 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.475.649 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.475.665 I llama_new_context_with_model: graph nodes  = 967
0.00.475.665 I llama_new_context_with_model: graph splits = 1
0.00.475.669 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.553.209 I main: llama threadpool init, n_threads = 4
0.00.553.240 I 
0.00.553.325 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.553.326 I 
0.00.553.454 I sampler seed: 1234
0.00.553.475 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.553.478 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.553.479 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.553.479 I 
I believe the meaning of life is to know myself. It is to be able to say, “I am a person, I am a mother, a daughter, a sister, a friend, a mother of friends, a sister of sisters, and a sister of all the mothers.” It is to be able to say, “I am a human being

0.01.971.431 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31346.58 tokens per second)
0.01.971.434 I llama_perf_context_print:        load time =     552.30 ms
0.01.971.435 I llama_perf_context_print: prompt eval time =      44.65 ms /     7 tokens (    6.38 ms per token,   156.79 tokens per second)
0.01.971.436 I llama_perf_context_print:        eval time =    1362.33 ms /    63 runs   (   21.62 ms per token,    46.24 tokens per second)
0.01.971.437 I llama_perf_context_print:       total time =    1418.23 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.318 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.011 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
...
0.00.075.957 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.958 I llm_load_print_meta: model params     = 1.41 B
0.00.075.958 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.126.521 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.126.540 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.406.605 I llama_new_context_with_model: n_seq_max     = 1
0.00.406.629 I llama_new_context_with_model: n_ctx         = 128
0.00.406.629 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.406.629 I llama_new_context_with_model: n_batch       = 128
0.00.406.630 I llama_new_context_with_model: n_ubatch      = 128
0.00.406.630 I llama_new_context_with_model: flash_attn    = 0
0.00.406.635 I llama_new_context_with_model: freq_base     = 10000.0
0.00.406.636 I llama_new_context_with_model: freq_scale    = 1
0.00.406.636 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.411.505 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.411.532 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.411.557 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.413.588 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.413.611 I llama_new_context_with_model: graph nodes  = 967
0.00.413.611 I llama_new_context_with_model: graph splits = 1
0.00.413.614 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.450.695 I 
0.00.450.823 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.450.844 I perplexity: tokenizing the input ..
0.00.460.298 I perplexity: tokenization took 9.451 ms
0.00.460.335 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.878.888 I perplexity: 0.42 seconds per pass - ETA 0.00 minutes
[1]14.0715,
0.00.882.654 I Final estimate: PPL = 14.0715 +/- 4.41015

0.00.882.703 I llama_perf_context_print:        load time =     450.34 ms
0.00.882.717 I llama_perf_context_print: prompt eval time =     416.72 ms /   128 tokens (    3.26 ms per token,   307.16 tokens per second)
0.00.882.719 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.882.720 I llama_perf_context_print:       total time =     432.01 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.645 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.996 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.075.997 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.075.998 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.075.999 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.075.999 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
...
0.00.076.008 I llm_load_print_meta: model ftype      = Q4_1
0.00.076.009 I llm_load_print_meta: model params     = 1.41 B
0.00.076.010 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.807 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.130.822 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.439.715 I llama_new_context_with_model: n_seq_max     = 1
0.00.439.736 I llama_new_context_with_model: n_ctx         = 2048
0.00.439.736 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.439.744 I llama_new_context_with_model: freq_base     = 10000.0
0.00.439.745 I llama_new_context_with_model: freq_scale    = 1
0.00.508.634 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.508.665 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.508.697 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.511.019 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.511.034 I llama_new_context_with_model: graph nodes  = 967
0.00.511.034 I llama_new_context_with_model: graph splits = 1
0.00.511.039 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.584.755 I main: llama threadpool init, n_threads = 4
0.00.584.788 I 
0.00.584.876 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.584.889 I 
0.00.585.026 I sampler seed: 1234
0.00.585.046 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.585.049 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.585.050 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.585.050 I 
...
0.02.114.987 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31938.82 tokens per second)
0.02.114.991 I llama_perf_context_print:        load time =     583.85 ms
0.02.114.992 I llama_perf_context_print: prompt eval time =      41.68 ms /     7 tokens (    5.95 ms per token,   167.95 tokens per second)
0.02.114.993 I llama_perf_context_print:        eval time =    1477.20 ms /    63 runs   (   23.45 ms per token,    42.65 tokens per second)
0.02.114.994 I llama_perf_context_print:       total time =    1530.24 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.684 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.290 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.020.822 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.020.824 I llama_model_loader: - type  f32:  194 tensors
0.00.020.825 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.075.951 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.952 I llm_load_print_meta: model params     = 1.41 B
0.00.075.953 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.131.333 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.131.351 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.437.874 I llama_new_context_with_model: n_seq_max     = 1
0.00.437.897 I llama_new_context_with_model: n_ctx         = 128
0.00.437.898 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.437.898 I llama_new_context_with_model: n_batch       = 128
0.00.437.898 I llama_new_context_with_model: n_ubatch      = 128
0.00.437.899 I llama_new_context_with_model: flash_attn    = 0
0.00.437.903 I llama_new_context_with_model: freq_base     = 10000.0
0.00.437.904 I llama_new_context_with_model: freq_scale    = 1
0.00.437.905 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.442.876 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.442.905 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.442.931 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.445.072 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.445.097 I llama_new_context_with_model: graph nodes  = 967
0.00.445.097 I llama_new_context_with_model: graph splits = 1
0.00.445.100 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.485.560 I 
0.00.485.692 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.485.728 I perplexity: tokenizing the input ..
0.00.495.289 I perplexity: tokenization took 9.557 ms
0.00.495.325 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.936.845 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]12.5781,
0.00.940.587 I Final estimate: PPL = 12.5781 +/- 3.87222

0.00.940.632 I llama_perf_context_print:        load time =     484.83 ms
0.00.940.634 I llama_perf_context_print: prompt eval time =     439.68 ms /   128 tokens (    3.44 ms per token,   291.12 tokens per second)
0.00.940.636 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.940.637 I llama_perf_context_print:       total time =     455.07 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.643 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.308 I llm_load_print_meta: n_vocab          = 50304
...
0.00.076.336 I llm_load_print_meta: model ftype      = Q5_0
0.00.076.336 I llm_load_print_meta: model params     = 1.41 B
0.00.076.337 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.137.688 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.137.705 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.173.302 I llama_new_context_with_model: n_seq_max     = 1
0.00.173.318 I llama_new_context_with_model: n_ctx         = 2048
0.00.173.318 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.173.318 I llama_new_context_with_model: n_batch       = 2048
0.00.173.318 I llama_new_context_with_model: n_ubatch      = 512
0.00.173.319 I llama_new_context_with_model: flash_attn    = 0
0.00.173.321 I llama_new_context_with_model: freq_base     = 10000.0
0.00.173.322 I llama_new_context_with_model: freq_scale    = 1
0.00.241.363 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.241.385 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.241.409 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.243.655 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.243.672 I llama_new_context_with_model: graph nodes  = 967
0.00.243.672 I llama_new_context_with_model: graph splits = 1
0.00.243.676 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.351.866 I main: llama threadpool init, n_threads = 4
0.00.351.896 I 
0.00.351.979 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.351.992 I 
...
0.00.352.137 I sampler params: 
	...
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.352.140 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.352.141 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.352.141 I 
I believe the meaning of life is to do what is best for your self, and to be happy, and to enjoy the present moment, and to let go of the past, and to enjoy the moment, and to enjoy the life you have here on Earth." The words are spoken in a calm, measured tone, but the message is clear: it

0.02.655.056 I llama_perf_sampler_print:    sampling time =       2.31 ms /    71 runs   (    0.03 ms per token, 30735.93 tokens per second)
0.02.655.059 I llama_perf_context_print:        load time =     350.95 ms
0.02.655.061 I llama_perf_context_print: prompt eval time =     125.72 ms /     7 tokens (   17.96 ms per token,    55.68 tokens per second)
0.02.655.062 I llama_perf_context_print:        eval time =    2165.40 ms /    63 runs   (   34.37 ms per token,    29.09 tokens per second)
0.02.655.063 I llama_perf_context_print:       total time =    2303.20 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.723 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.560 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.075.307 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.308 I llm_load_print_meta: model params     = 1.41 B
0.00.075.309 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.134.958 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.134.977 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.170.699 I llama_new_context_with_model: n_seq_max     = 1
0.00.170.721 I llama_new_context_with_model: n_ctx         = 128
0.00.170.721 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.170.721 I llama_new_context_with_model: n_batch       = 128
0.00.170.722 I llama_new_context_with_model: n_ubatch      = 128
0.00.170.722 I llama_new_context_with_model: flash_attn    = 0
0.00.170.725 I llama_new_context_with_model: freq_base     = 10000.0
0.00.170.726 I llama_new_context_with_model: freq_scale    = 1
0.00.170.727 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.175.547 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.175.574 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.175.593 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.177.810 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.177.828 I llama_new_context_with_model: graph nodes  = 967
0.00.177.829 I llama_new_context_with_model: graph splits = 1
0.00.177.831 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.220.468 I 
0.00.220.587 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.220.610 I perplexity: tokenizing the input ..
0.00.229.876 I perplexity: tokenization took 9.262 ms
0.00.229.911 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.319.007 I perplexity: 1.09 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.322.940 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.322.986 I llama_perf_context_print:        load time =     219.70 ms
0.01.322.989 I llama_perf_context_print: prompt eval time =    1087.48 ms /   128 tokens (    8.50 ms per token,   117.70 tokens per second)
0.01.322.990 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.322.991 I llama_perf_context_print:       total time =    1102.52 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.277 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.494 I main: llama backend init
0.00.000.511 I main: load the model and apply lora adapter, if any
0.00.009.074 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.020.731 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
...
0.00.075.176 I llm_load_print_meta: model ftype      = Q5_1
...
0.00.139.880 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.139.897 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.175.692 I llama_new_context_with_model: n_seq_max     = 1
0.00.175.712 I llama_new_context_with_model: n_ctx         = 2048
0.00.175.713 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.175.713 I llama_new_context_with_model: n_batch       = 2048
0.00.175.714 I llama_new_context_with_model: n_ubatch      = 512
0.00.175.714 I llama_new_context_with_model: flash_attn    = 0
0.00.175.717 I llama_new_context_with_model: freq_base     = 10000.0
0.00.175.718 I llama_new_context_with_model: freq_scale    = 1
0.00.243.559 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.243.583 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.243.605 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.245.692 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.245.713 I llama_new_context_with_model: graph nodes  = 967
0.00.245.714 I llama_new_context_with_model: graph splits = 1
0.00.245.718 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.339.557 I main: llama threadpool init, n_threads = 4
0.00.339.586 I 
0.00.339.672 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.339.685 I 
0.00.339.808 I sampler seed: 1234
0.00.339.829 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.339.832 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.339.833 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.339.833 I 
...
0.02.742.927 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31583.63 tokens per second)
0.02.742.930 I llama_perf_context_print:        load time =     339.02 ms
0.02.742.931 I llama_perf_context_print: prompt eval time =     126.53 ms /     7 tokens (   18.08 ms per token,    55.32 tokens per second)
0.02.742.932 I llama_perf_context_print:        eval time =    2265.91 ms /    63 runs   (   35.97 ms per token,    27.80 tokens per second)
0.02.742.933 I llama_perf_context_print:       total time =    2403.38 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.595 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.009 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
...
0.00.075.062 I llm_load_print_meta: n_ctx_train      = 2048
0.00.075.062 I llm_load_print_meta: n_embd           = 2048
...
0.00.075.084 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.075.085 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.075.086 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.075.087 I llm_load_print_meta: model type       = 1.4B
0.00.075.088 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.088 I llm_load_print_meta: model params     = 1.41 B
0.00.075.089 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.140.126 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.140.142 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.175.086 I llama_new_context_with_model: n_seq_max     = 1
0.00.175.108 I llama_new_context_with_model: n_ctx         = 128
0.00.175.108 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.175.108 I llama_new_context_with_model: n_batch       = 128
0.00.175.109 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.175.114 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.179.850 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.179.872 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.179.893 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.181.968 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.181.987 I llama_new_context_with_model: graph nodes  = 967
0.00.181.987 I llama_new_context_with_model: graph splits = 1
0.00.181.990 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.238.281 I 
0.00.238.393 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.238.401 I perplexity: tokenizing the input ..
0.00.247.808 I perplexity: tokenization took 9.403 ms
0.00.247.835 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.151.847 I perplexity: 1.90 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.155.499 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.155.539 I llama_perf_context_print:        load time =     237.64 ms
0.02.155.554 I llama_perf_context_print: prompt eval time =    1902.26 ms /   128 tokens (   14.86 ms per token,    67.29 tokens per second)
0.02.155.556 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.155.556 I llama_perf_context_print:       total time =    1917.26 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.278 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.500 I main: llama backend init
0.00.000.517 I main: load the model and apply lora adapter, if any
0.00.009.357 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.111.287 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
...
0.00.146.121 I llama_new_context_with_model: n_ctx         = 2048
0.00.146.122 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.146.122 I llama_new_context_with_model: n_batch       = 2048
0.00.146.122 I llama_new_context_with_model: n_ubatch      = 512
0.00.146.122 I llama_new_context_with_model: flash_attn    = 0
0.00.146.125 I llama_new_context_with_model: freq_base     = 10000.0
0.00.146.126 I llama_new_context_with_model: freq_scale    = 1
0.00.215.382 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.215.407 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.215.430 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.218.060 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.218.083 I llama_new_context_with_model: graph nodes  = 967
0.00.218.084 I llama_new_context_with_model: graph splits = 1
0.00.218.088 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.293.967 I main: llama threadpool init, n_threads = 4
0.00.293.995 I 
0.00.294.079 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.294.079 I 
0.00.294.212 I sampler seed: 1234
0.00.294.232 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.294.235 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.294.236 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.294.236 I 
I believe the meaning of life is a one-f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <

0.01.771.284 I llama_perf_sampler_print:    sampling time =       2.07 ms /    71 runs   (    0.03 ms per token, 34332.69 tokens per second)
0.01.771.287 I llama_perf_context_print:        load time =     293.43 ms
0.01.771.289 I llama_perf_context_print: prompt eval time =      82.91 ms /     7 tokens (   11.84 ms per token,    84.43 tokens per second)
0.01.771.290 I llama_perf_context_print:        eval time =    1383.56 ms /    63 runs   (   21.96 ms per token,    45.53 tokens per second)
0.01.771.290 I llama_perf_context_print:       total time =    1477.32 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.786 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.419 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.021.422 I llama_model_loader: - type  f32:  194 tensors
0.00.021.423 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.423 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.076.303 I llm_load_print_meta: ssm_d_inner      = 0
0.00.076.303 I llm_load_print_meta: ssm_d_state      = 0
0.00.076.303 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.076.304 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.076.304 I llm_load_print_meta: model type       = 1.4B
0.00.076.305 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.306 I llm_load_print_meta: model params     = 1.41 B
0.00.076.307 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
0.00.076.307 I llm_load_print_meta: general.name     = 1.4B
0.00.076.307 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.076.308 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.076.308 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.076.308 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.076.309 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.309 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.309 I llm_load_print_meta: max token length = 1024
0.00.112.220 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.112.238 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.147.769 I llama_new_context_with_model: n_seq_max     = 1
0.00.147.792 I llama_new_context_with_model: n_ctx         = 128
0.00.147.792 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.147.793 I llama_new_context_with_model: n_batch       = 128
0.00.147.793 I llama_new_context_with_model: n_ubatch      = 128
0.00.147.794 I llama_new_context_with_model: flash_attn    = 0
0.00.147.797 I llama_new_context_with_model: freq_base     = 10000.0
0.00.147.798 I llama_new_context_with_model: freq_scale    = 1
0.00.147.799 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.152.600 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
...
0.00.154.768 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.154.792 I llama_new_context_with_model: graph nodes  = 967
...
0.00.194.892 I 
0.00.195.019 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.195.028 I perplexity: tokenizing the input ..
0.00.204.459 I perplexity: tokenization took 9.427 ms
0.00.204.500 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.461.612 I perplexity: 1.26 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.465.344 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.465.391 I llama_perf_context_print:        load time =     194.06 ms
0.01.465.394 I llama_perf_context_print: prompt eval time =    1255.40 ms /   128 tokens (    9.81 ms per token,   101.96 tokens per second)
0.01.465.396 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.465.396 I llama_perf_context_print:       total time =    1270.50 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.736 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.484 I llama_model_loader: - type q3_K:   25 tensors
0.00.021.485 I llama_model_loader: - type q4_K:   71 tensors
0.00.021.485 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.075.557 I llm_load_print_meta: model ftype      = Q3_K - Medium
...
0.00.122.138 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.122.155 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.321.939 I llama_new_context_with_model: n_seq_max     = 1
0.00.321.961 I llama_new_context_with_model: n_ctx         = 2048
0.00.321.961 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.321.961 I llama_new_context_with_model: n_batch       = 2048
0.00.321.962 I llama_new_context_with_model: n_ubatch      = 512
0.00.321.962 I llama_new_context_with_model: flash_attn    = 0
0.00.321.967 I llama_new_context_with_model: freq_base     = 10000.0
0.00.321.968 I llama_new_context_with_model: freq_scale    = 1
0.00.390.240 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.390.269 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.390.301 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.392.643 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.392.659 I llama_new_context_with_model: graph nodes  = 967
0.00.392.659 I llama_new_context_with_model: graph splits = 1
0.00.392.663 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.473.247 I main: llama threadpool init, n_threads = 4
0.00.473.279 I 
0.00.473.364 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.473.377 I 
0.00.473.506 I sampler seed: 1234
0.00.473.526 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.473.530 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.473.530 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.473.530 I 
I believe the meaning of life is that one should never feel the need to be the best at anything, but rather, that one should be the best in whatever one does. This is a good philosophy, and I believe it to be a good basis for understanding how our lives are lived, as well as how we should live them.

It is

0.02.176.322 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31513.54 tokens per second)
0.02.176.325 I llama_perf_context_print:        load time =     472.24 ms
0.02.176.327 I llama_perf_context_print: prompt eval time =      70.38 ms /     7 tokens (   10.05 ms per token,    99.46 tokens per second)
0.02.176.328 I llama_perf_context_print:        eval time =    1621.15 ms /    63 runs   (   25.73 ms per token,    38.86 tokens per second)
0.02.176.329 I llama_perf_context_print:       total time =    1703.08 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.325 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.125 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q3_k.gguf (version GGUF V3 (latest))
...
0.00.020.744 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.020.747 I llama_model_loader: - type  f32:  194 tensors
0.00.020.748 I llama_model_loader: - type q3_K:   25 tensors
0.00.020.748 I llama_model_loader: - type q4_K:   71 tensors
...
0.00.074.970 I llm_load_print_meta: ssm_d_conv       = 0
...
0.00.074.973 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.074.973 I llm_load_print_meta: model params     = 1.41 B
0.00.074.974 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.121.458 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.323.008 I llama_new_context_with_model: n_seq_max     = 1
0.00.323.028 I llama_new_context_with_model: n_ctx         = 128
0.00.323.029 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.323.029 I llama_new_context_with_model: n_batch       = 128
0.00.323.029 I llama_new_context_with_model: n_ubatch      = 128
0.00.323.030 I llama_new_context_with_model: flash_attn    = 0
0.00.323.035 I llama_new_context_with_model: freq_base     = 10000.0
0.00.323.036 I llama_new_context_with_model: freq_scale    = 1
0.00.323.036 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.327.938 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.327.966 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.327.991 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.330.223 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.330.245 I llama_new_context_with_model: graph nodes  = 967
0.00.330.246 I llama_new_context_with_model: graph splits = 1
0.00.330.248 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.373.527 I 
0.00.373.661 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.373.696 I perplexity: tokenizing the input ..
0.00.383.176 I perplexity: tokenization took 9.476 ms
0.00.383.215 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.248.018 I perplexity: 0.86 seconds per pass - ETA 0.00 minutes
[1]12.3344,
0.01.251.833 I Final estimate: PPL = 12.3344 +/- 4.02919

0.01.251.878 I llama_perf_context_print:        load time =     373.16 ms
0.01.251.893 I llama_perf_context_print: prompt eval time =     862.93 ms /   128 tokens (    6.74 ms per token,   148.33 tokens per second)
0.01.251.895 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.251.895 I llama_perf_context_print:       total time =     878.35 ms /   129 tokens
...
0.00.009.595 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf (version GGUF V3 (latest))
...
0.00.076.136 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.076.137 I llm_load_print_meta: model params     = 1.41 B
0.00.076.138 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.132.424 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.132.440 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.455.626 I llama_new_context_with_model: n_seq_max     = 1
0.00.455.646 I llama_new_context_with_model: n_ctx         = 2048
0.00.455.646 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.455.647 I llama_new_context_with_model: n_batch       = 2048
0.00.455.647 I llama_new_context_with_model: n_ubatch      = 512
0.00.455.648 I llama_new_context_with_model: flash_attn    = 0
0.00.455.652 I llama_new_context_with_model: freq_base     = 10000.0
0.00.455.653 I llama_new_context_with_model: freq_scale    = 1
0.00.524.799 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.524.824 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.524.854 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.527.034 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.527.057 I llama_new_context_with_model: graph nodes  = 967
0.00.527.057 I llama_new_context_with_model: graph splits = 1
0.00.527.062 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.610.846 I main: llama threadpool init, n_threads = 4
0.00.610.876 I 
0.00.610.961 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.610.974 I 
0.00.611.084 I sampler seed: 1234
0.00.611.104 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.611.108 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.611.108 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.611.108 I 
...
0.02.557.473 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31099.43 tokens per second)
0.02.557.477 I llama_perf_context_print:        load time =     609.82 ms
0.02.557.478 I llama_perf_context_print: prompt eval time =      60.86 ms /     7 tokens (    8.69 ms per token,   115.02 tokens per second)
0.02.557.479 I llama_perf_context_print:        eval time =    1874.39 ms /    63 runs   (   29.75 ms per token,    33.61 tokens per second)
0.02.557.480 I llama_perf_context_print:       total time =    1946.63 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.837 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.911 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
...
0.00.075.209 I llm_load_print_meta: vocab type       = BPE
...
0.00.075.221 I llm_load_print_meta: n_swa            = 0
...
0.00.075.234 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.235 I llm_load_print_meta: model params     = 1.41 B
0.00.075.235 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.131.399 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.131.420 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.457.263 I llama_new_context_with_model: n_seq_max     = 1
0.00.457.285 I llama_new_context_with_model: n_ctx         = 128
0.00.457.285 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.457.286 I llama_new_context_with_model: n_batch       = 128
0.00.457.286 I llama_new_context_with_model: n_ubatch      = 128
0.00.457.287 I llama_new_context_with_model: flash_attn    = 0
0.00.457.292 I llama_new_context_with_model: freq_base     = 10000.0
0.00.457.293 I llama_new_context_with_model: freq_scale    = 1
0.00.457.294 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.462.121 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.462.149 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.462.175 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.464.889 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.464.908 I llama_new_context_with_model: graph nodes  = 967
0.00.464.908 I llama_new_context_with_model: graph splits = 1
0.00.464.910 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.519.130 I 
0.00.519.258 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.519.265 I perplexity: tokenizing the input ..
0.00.528.496 I perplexity: tokenization took 9.227 ms
0.00.528.529 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.075.551 I perplexity: 0.55 seconds per pass - ETA 0.00 minutes
[1]10.4776,
0.01.079.321 I Final estimate: PPL = 10.4776 +/- 3.36742

0.01.079.365 I llama_perf_context_print:        load time =     518.25 ms
0.01.079.367 I llama_perf_context_print: prompt eval time =     545.22 ms /   128 tokens (    4.26 ms per token,   234.77 tokens per second)
0.01.079.369 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.079.371 I llama_perf_context_print:       total time =     560.23 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.575 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.464 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
0.00.021.466 I llama_model_loader: - type  f32:  194 tensors
0.00.021.467 I llama_model_loader: - type q5_K:   61 tensors
0.00.021.468 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.076.234 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.076.235 I llm_load_print_meta: model params     = 1.41 B
0.00.076.236 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.142.486 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.142.502 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.520.212 I llama_new_context_with_model: n_seq_max     = 1
0.00.520.233 I llama_new_context_with_model: n_ctx         = 2048
0.00.520.233 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.520.234 I llama_new_context_with_model: n_batch       = 2048
0.00.520.234 I llama_new_context_with_model: n_ubatch      = 512
0.00.520.235 I llama_new_context_with_model: flash_attn    = 0
0.00.520.239 I llama_new_context_with_model: freq_base     = 10000.0
0.00.520.240 I llama_new_context_with_model: freq_scale    = 1
0.00.588.159 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.588.188 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.588.216 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.590.989 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.591.011 I llama_new_context_with_model: graph nodes  = 967
0.00.591.011 I llama_new_context_with_model: graph splits = 1
0.00.591.016 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.691.786 I main: llama threadpool init, n_threads = 4
0.00.691.817 I 
0.00.691.901 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.691.913 I 
0.00.692.050 I sampler seed: 1234
0.00.692.070 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.692.074 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.692.075 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.692.075 I 
I believe the meaning of life is to do the things we love, the things we are good at, the things we are good at doing, and the things that are good at doing. If we do those, we are happy. If we do not, then we are miserable, and we will do those things we hate the most.

I

0.03.117.496 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31753.13 tokens per second)
0.03.117.499 I llama_perf_context_print:        load time =     690.94 ms
0.03.117.500 I llama_perf_context_print: prompt eval time =      88.59 ms /     7 tokens (   12.66 ms per token,    79.02 tokens per second)
0.03.117.502 I llama_perf_context_print:        eval time =    2325.68 ms /    63 runs   (   36.92 ms per token,    27.09 tokens per second)
0.03.117.502 I llama_perf_context_print:       total time =    2425.72 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.333 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.833 I llama_model_loader: - type q5_K:   61 tensors
0.00.020.833 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.075.834 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.834 I llm_load_print_meta: model params     = 1.41 B
0.00.075.835 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.140.274 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.140.293 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.517.848 I llama_new_context_with_model: n_seq_max     = 1
0.00.517.871 I llama_new_context_with_model: n_ctx         = 128
0.00.517.871 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.517.871 I llama_new_context_with_model: n_batch       = 128
0.00.517.871 I llama_new_context_with_model: n_ubatch      = 128
0.00.517.872 I llama_new_context_with_model: flash_attn    = 0
0.00.517.877 I llama_new_context_with_model: freq_base     = 10000.0
0.00.517.878 I llama_new_context_with_model: freq_scale    = 1
0.00.517.879 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.522.725 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.522.754 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.522.776 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.524.845 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.524.870 I llama_new_context_with_model: graph nodes  = 967
0.00.524.870 I llama_new_context_with_model: graph splits = 1
0.00.524.873 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.605.313 I 
0.00.605.450 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.605.472 I perplexity: tokenizing the input ..
0.00.615.008 I perplexity: tokenization took 9.532 ms
0.00.615.050 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.250.568 I perplexity: 0.64 seconds per pass - ETA 0.00 minutes
[1]10.6642,
0.01.254.218 I Final estimate: PPL = 10.6642 +/- 3.40033

0.01.254.265 I llama_perf_context_print:        load time =     604.94 ms
0.01.254.267 I llama_perf_context_print: prompt eval time =     633.67 ms /   128 tokens (    4.95 ms per token,   202.00 tokens per second)
0.01.254.268 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.254.269 I llama_perf_context_print:       total time =     648.95 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.269 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.489 I main: llama backend init
0.00.000.506 I main: load the model and apply lora adapter, if any
0.00.009.206 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q6_k.gguf (version GGUF V3 (latest))
...
0.00.075.838 I llm_load_print_meta: n_ff             = 8192
...
0.00.075.846 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.846 I llm_load_print_meta: model params     = 1.41 B
0.00.075.847 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.137.471 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.137.492 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.535.055 I llama_new_context_with_model: n_seq_max     = 1
0.00.535.078 I llama_new_context_with_model: n_ctx         = 2048
0.00.535.078 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.535.078 I llama_new_context_with_model: n_batch       = 2048
0.00.535.079 I llama_new_context_with_model: n_ubatch      = 512
0.00.535.080 I llama_new_context_with_model: flash_attn    = 0
0.00.535.083 I llama_new_context_with_model: freq_base     = 10000.0
0.00.535.084 I llama_new_context_with_model: freq_scale    = 1
0.00.604.509 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.604.535 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.604.567 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.607.332 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.607.352 I llama_new_context_with_model: graph nodes  = 967
0.00.607.353 I llama_new_context_with_model: graph splits = 1
0.00.607.356 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.720.539 I main: llama threadpool init, n_threads = 4
0.00.720.572 I 
0.00.720.657 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.720.670 I 
0.00.720.803 I sampler seed: 1234
0.00.720.823 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.720.827 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.03.226.307 I llama_perf_sampler_print:    sampling time =       2.23 ms /    71 runs   (    0.03 ms per token, 31895.78 tokens per second)
0.03.226.310 I llama_perf_context_print:        load time =     720.01 ms
0.03.226.312 I llama_perf_context_print: prompt eval time =     110.26 ms /     7 tokens (   15.75 ms per token,    63.49 tokens per second)
0.03.226.313 I llama_perf_context_print:        eval time =    2384.16 ms /    63 runs   (   37.84 ms per token,    26.42 tokens per second)
0.03.226.313 I llama_perf_context_print:       total time =    2505.77 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.655 I build: 4243 (434fc452) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.095 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.096 I llm_load_print_meta: model params     = 1.41 B
0.00.076.097 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
0.00.076.097 I llm_load_print_meta: general.name     = 1.4B
0.00.076.097 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
...
0.00.137.145 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.137.165 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.527.408 I llama_new_context_with_model: n_seq_max     = 1
0.00.527.431 I llama_new_context_with_model: n_ctx         = 128
0.00.527.431 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.527.431 I llama_new_context_with_model: n_batch       = 128
0.00.527.432 I llama_new_context_with_model: n_ubatch      = 128
0.00.527.433 I llama_new_context_with_model: flash_attn    = 0
0.00.527.438 I llama_new_context_with_model: freq_base     = 10000.0
0.00.527.439 I llama_new_context_with_model: freq_scale    = 1
0.00.527.440 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.532.207 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.532.233 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.532.259 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.534.936 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.534.954 I llama_new_context_with_model: graph nodes  = 967
0.00.534.954 I llama_new_context_with_model: graph splits = 1
0.00.534.956 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.617.382 I 
0.00.617.526 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | AARCH64_REPACK = 1 | 
0.00.617.549 I perplexity: tokenizing the input ..
0.00.627.136 I perplexity: tokenization took 9.582 ms
0.00.627.169 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.396.252 I perplexity: 0.77 seconds per pass - ETA 0.00 minutes
[1]10.4463,
0.01.400.088 I Final estimate: PPL = 10.4463 +/- 3.33301

0.01.400.134 I llama_perf_context_print:        load time =     616.68 ms
0.01.400.136 I llama_perf_context_print: prompt eval time =     767.23 ms /   128 tokens (    5.99 ms per token,   166.83 tokens per second)
0.01.400.137 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.400.138 I llama_perf_context_print:       total time =     782.75 ms /   129 tokens
...
0.00.482.195 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.476.626 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.57user 0.68system 0:01.25elapsed 100%CPU (0avgtext+0avgdata 5359736maxresident)k
...
0.41user 0.69system 0:01.10elapsed 100%CPU (0avgtext+0avgdata 5354008maxresident)k
0inputs+32outputs (0major+53622minor)pagefaults 0swaps
```
