...
- status:  SUCCESS ✅
- runtime: 788.63
- date:    Fri Apr 26 10:49:22 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   93.97 sec
      Start 22: test-rope
...
Test project /Users/ggml/work/llama.cpp/build-ci-release
      Start  1: test-quantize-fns
 1/23 Test  #1: test-quantize-fns ...................   Passed   19.87 sec
      Start  2: test-quantize-perf
...
llama_print_timings: prompt eval time =      11.66 ms /     9 tokens (    1.30 ms per token,   772.00 tokens per second)
...
<bos> Once upon a time, in a quaint village nestled amidst rolling hills, there lived a young weaver named Anya.

**Anya's Skill**

Anya possessed an exceptional
llama_print_timings:        load time =    2608.69 ms
llama_print_timings:      sample time =      56.68 ms /    32 runs   (    1.77 ms per token,   564.54 tokens per second)
llama_print_timings: prompt eval time =     198.19 ms /     5 tokens (   39.64 ms per token,    25.23 tokens per second)
llama_print_timings:        eval time =    1506.37 ms /    31 runs   (   48.59 ms per token,    20.58 tokens per second)
llama_print_timings:       total time =    2547.57 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say the future belongs to those who believe in the beauty of their dreams. And that dream is what drives them forward, propelling them through any obstacle.


llama_print_timings:        load time =    2743.60 ms
llama_print_timings:      sample time =      56.62 ms /    32 runs   (    1.77 ms per token,   565.14 tokens per second)
llama_print_timings: prompt eval time =     204.47 ms /     2 tokens (  102.23 ms per token,     9.78 tokens per second)
llama_print_timings:        eval time =    1503.78 ms /    31 runs   (   48.51 ms per token,    20.61 tokens per second)
llama_print_timings:       total time =    2519.28 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
# Parse the
llama_print_timings:        load time =    2701.23 ms
llama_print_timings:      sample time =      59.06 ms /    32 runs   (    1.85 ms per token,   541.83 tokens per second)
llama_print_timings: prompt eval time =     197.71 ms /     2 tokens (   98.86 ms per token,    10.12 tokens per second)
llama_print_timings:        eval time =    1502.68 ms /    31 runs   (   48.47 ms per token,    20.63 tokens per second)
llama_print_timings:       total time =    2569.38 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After successfully logging in to the application, an error message pops up stating "Sorry, we're experiencing technical difficulties. Please try again later."

**Possible Causes
llama_print_timings:        load time =    2570.90 ms
...
llama_print_timings:        eval time =    1525.62 ms /    31 runs   (   49.21 ms per token,    20.32 tokens per second)
llama_print_timings:       total time =    1812.38 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> When I think about you, I feel a sense of peace and tranquility. 

I would like to express my gratitude for the joy and companionship you have brought into
llama_print_timings:        load time =    2716.39 ms
llama_print_timings:      sample time =      16.07 ms /    32 runs   (    0.50 ms per token,  1991.78 tokens per second)
llama_print_timings: prompt eval time =     200.93 ms /     2 tokens (  100.47 ms per token,     9.95 tokens per second)
llama_print_timings:        eval time =    1515.81 ms /    31 runs   (   48.90 ms per token,    20.45 tokens per second)
llama_print_timings:       total time =    1807.25 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If you have a quadratic equation ax^2+bx+c=0, then what is the relationship between a, b, and c?

The relationship between
llama_print_timings:        load time =    2780.50 ms
llama_print_timings:      sample time =      16.35 ms /    32 runs   (    0.51 ms per token,  1957.07 tokens per second)
llama_print_timings: prompt eval time =     196.17 ms /     2 tokens (   98.08 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1530.15 ms /    31 runs   (   49.36 ms per token,    20.26 tokens per second)
llama_print_timings:       total time =    1818.57 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21163.39 ms
main:    total time = 21163.39 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a king who dreamed of a powerful sword. He searched far and wide for it, and eventually, he found it in the depths of a forgotten
...
llama_print_timings: prompt eval time =     215.09 ms /     5 tokens (   43.02 ms per token,    23.25 tokens per second)
llama_print_timings:        eval time =    1092.93 ms /    31 runs   (   35.26 ms per token,    28.36 tokens per second)
llama_print_timings:       total time =    1398.45 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21537.38 ms
main:    total time = 21537.38 ms
+ echo PASS
PASS
+ echo
...
<bos> Shemory, an assistant to a renowned astrophysicist, faces a dilemma. She is tasked with ensuring the accurate recording of observations and calculations, but is also
llama_print_timings:        load time =    1596.88 ms
llama_print_timings:      sample time =      16.62 ms /    32 runs   (    0.52 ms per token,  1925.51 tokens per second)
llama_print_timings: prompt eval time =     214.67 ms /     2 tokens (  107.33 ms per token,     9.32 tokens per second)
llama_print_timings:        eval time =    1103.12 ms /    31 runs   (   35.58 ms per token,    28.10 tokens per second)
llama_print_timings:       total time =    1409.10 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
