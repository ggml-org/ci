...
- status:  FAILURE ❌ (139)
- runtime: 1:59.77
- date:    Wed Feb 12 12:07:48 UTC 2025
...
0.00.000.240 I build: 4723 (3a4d2cbf) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.234 I llama_model_loader: loaded meta data with 24 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.007.457 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.008.252 I llama_model_loader: - kv  22:               tokenizer.ggml.mask_token_id u32              = 103
0.00.008.252 I llama_model_loader: - kv  23:               general.quantization_version u32              = 2
...
0.00.022.223 I print_info: n_head           = 12
...
0.00.022.238 I print_info: f_logit_scale    = 0.0e+00
0.00.022.240 I print_info: n_ff             = 1536
0.00.022.240 I print_info: n_expert         = 0
0.00.022.241 I print_info: n_expert_used    = 0
0.00.022.241 I print_info: causal attn      = 0
0.00.022.242 I print_info: pooling type     = 2
0.00.022.243 I print_info: rope type        = 2
...
0.00.022.249 I print_info: ssm_dt_rank      = 0
0.00.022.250 I print_info: ssm_dt_b_c_rms   = 0
0.00.022.250 I print_info: model type       = 33M
...
0.00.022.265 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.027.084 I load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.027.845 I llama_context_unified: n_seq_max     = 1
0.00.027.849 I llama_context_unified: n_ctx         = 512
0.00.027.849 I llama_context_unified: n_ctx_per_seq = 512
0.00.027.850 I llama_context_unified: n_batch       = 2048
0.00.027.850 I llama_context_unified: n_ubatch      = 2048
0.00.027.850 I llama_context_unified: flash_attn    = 0
0.00.027.852 I llama_context_unified: freq_base     = 10000.0
0.00.027.853 I llama_context_unified: freq_scale    = 1
0.00.027.866 I init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.029.834 I init:        CPU KV buffer size =     9.00 MiB
0.00.029.844 I llama_context_unified: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.029.851 I llama_context_unified:        CPU  output buffer size =     0.00 MiB
ci/run.sh: line 709: 478355 Segmentation fault      (core dumped) ./bin/llama-embedding --model ${model_f16} -p "I believe the meaning of life is" -ngl 99 -c 0
