...
- status:  SUCCESS ✅
- runtime: 14:19.87
- date:    Sun Apr 28 15:50:53 UTC 2024
...
Label Time Summary:
main    =  96.28 sec*proc (23 tests)

Total Test time (real) =  96.29 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.81 ms /     9 tokens (    0.42 ms per token,  2359.11 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      51.31 ms /    10 tokens
...
<bos> Shekoul, a renowned archaeologist, has dedicated his life to unraveling the mysteries of ancient civilizations. His latest discovery is a previously unknown artifact that holds the key
llama_print_timings:        load time =    1240.33 ms
llama_print_timings:      sample time =      47.73 ms /    32 runs   (    1.49 ms per token,   670.37 tokens per second)
llama_print_timings: prompt eval time =    1133.88 ms /     2 tokens (  566.94 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20728.87 ms /    31 runs   (  668.67 ms per token,     1.50 tokens per second)
llama_print_timings:       total time =   22040.70 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Lily was a bright and curious child, with a thirst for adventure. She spent her days exploring the woods behind
...
llama_print_timings: prompt eval time =    2745.38 ms /     5 tokens (  549.08 ms per token,     1.82 tokens per second)
llama_print_timings:        eval time =   20642.72 ms /    31 runs   (  665.89 ms per token,     1.50 tokens per second)
llama_print_timings:       total time =   23566.80 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
The Hunger Games: Catching Fire is the second installment in the Hunger Games film series, based on the novel of the same
llama_print_timings:        load time =    1224.16 ms
llama_print_timings:      sample time =      47.64 ms /    32 runs   (    1.49 ms per token,   671.73 tokens per second)
llama_print_timings: prompt eval time =    1202.62 ms /     2 tokens (  601.31 ms per token,     1.66 tokens per second)
llama_print_timings:        eval time =   20706.63 ms /    31 runs   (  667.96 ms per token,     1.50 tokens per second)
llama_print_timings:       total time =   22088.11 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar is a new online platform that connects businesses and individuals with professional coaches and coaches.

**How does So Soar work?**

- Users can search
llama_print_timings:        load time =     180.57 ms
llama_print_timings:      sample time =       6.19 ms /    32 runs   (    0.19 ms per token,  5172.97 tokens per second)
llama_print_timings: prompt eval time =      74.48 ms /     2 tokens (   37.24 ms per token,    26.85 tokens per second)
llama_print_timings:        eval time =    2054.54 ms /    31 runs   (   66.28 ms per token,    15.09 tokens per second)
llama_print_timings:       total time =    2196.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar is a global education platform offering personalized online courses in aviation, navigation, and weather.

**a) Explain the concept of online courses offered by So So
llama_print_timings:        load time =     153.79 ms
llama_print_timings:      sample time =       6.16 ms /    32 runs   (    0.19 ms per token,  5198.18 tokens per second)
llama_print_timings: prompt eval time =      71.77 ms /     2 tokens (   35.88 ms per token,    27.87 tokens per second)
llama_print_timings:        eval time =    1986.07 ms /    31 runs   (   64.07 ms per token,    15.61 tokens per second)
llama_print_timings:       total time =    2124.62 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekera is a Hindu god who is associated with fire and destruction. He is often depicted as a fierce warrior, holding a flaming mace.

Shekera
llama_print_timings:        load time =     158.77 ms
llama_print_timings:      sample time =       6.20 ms /    32 runs   (    0.19 ms per token,  5157.96 tokens per second)
llama_print_timings: prompt eval time =      77.12 ms /     2 tokens (   38.56 ms per token,    25.93 tokens per second)
llama_print_timings:        eval time =    2048.88 ms /    31 runs   (   66.09 ms per token,    15.13 tokens per second)
llama_print_timings:       total time =    2192.64 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32113.05 ms
main:    total time = 32113.05 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:        eval time =    1592.45 ms /    31 runs   (   51.37 ms per token,    19.47 tokens per second)
llama_print_timings:       total time =    1735.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32173.99 ms
main:    total time = 32173.99 ms
+ echo PASS
PASS
+ echo
...
<bos> They say the best way to learn is by doing. And there's no better way to learn than through hands-on experience.

**True or False?
llama_print_timings:        load time =     120.39 ms
llama_print_timings:      sample time =       5.82 ms /    32 runs   (    0.18 ms per token,  5502.06 tokens per second)
llama_print_timings: prompt eval time =      62.74 ms /     2 tokens (   31.37 ms per token,    31.88 tokens per second)
llama_print_timings:        eval time =    1438.30 ms /    31 runs   (   46.40 ms per token,    21.55 tokens per second)
llama_print_timings:       total time =    1568.84 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     565.08 ms
llama_print_timings:      sample time =       2.54 ms /    64 runs   (    0.04 ms per token, 25226.65 tokens per second)
llama_print_timings: prompt eval time =     302.88 ms /     8 tokens (   37.86 ms per token,    26.41 tokens per second)
llama_print_timings:        eval time =    7655.22 ms /    63 runs   (  121.51 ms per token,     8.23 tokens per second)
llama_print_timings:       total time =    7980.59 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4609.98 ms /   128 tokens (   36.02 ms per token,    27.77 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4620.08 ms /   129 tokens
...
llama_print_timings:        load time =     369.23 ms
llama_print_timings:      sample time =       2.25 ms /    64 runs   (    0.04 ms per token, 28393.97 tokens per second)
llama_print_timings: prompt eval time =     208.94 ms /     8 tokens (   26.12 ms per token,    38.29 tokens per second)
llama_print_timings:        eval time =    5325.45 ms /    63 runs   (   84.53 ms per token,    11.83 tokens per second)
llama_print_timings:       total time =    5553.87 ms /    71 tokens
Log end
...
[1]4.2536,
llama_print_timings:        load time =     350.38 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2823.29 ms /   128 tokens (   22.06 ms per token,    45.34 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2833.43 ms /   129 tokens
...
llama_print_timings: prompt eval time =     199.68 ms /     8 tokens (   24.96 ms per token,    40.06 tokens per second)
llama_print_timings:        eval time =    4560.79 ms /    63 runs   (   72.39 ms per token,    13.81 tokens per second)
llama_print_timings:       total time =    4779.79 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3120.65 ms /   128 tokens (   24.38 ms per token,    41.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3130.77 ms /   129 tokens
...
llama_print_timings:        eval time =    4859.95 ms /    63 runs   (   77.14 ms per token,    12.96 tokens per second)
llama_print_timings:       total time =    5256.43 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5863.15 ms /   128 tokens (   45.81 ms per token,    21.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5873.25 ms /   129 tokens
...
llama_print_timings: prompt eval time =     419.69 ms /     8 tokens (   52.46 ms per token,    19.06 tokens per second)
llama_print_timings:        eval time =    5085.51 ms /    63 runs   (   80.72 ms per token,    12.39 tokens per second)
llama_print_timings:       total time =    5524.34 ms /    71 tokens
Log end
...
[1]4.3261,
llama_print_timings:        load time =     300.02 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6220.30 ms /   128 tokens (   48.60 ms per token,    20.58 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6230.49 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     344.20 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28021.02 tokens per second)
llama_print_timings: prompt eval time =     426.23 ms /     8 tokens (   53.28 ms per token,    18.77 tokens per second)
llama_print_timings:        eval time =    5479.46 ms /    63 runs   (   86.98 ms per token,    11.50 tokens per second)
llama_print_timings:       total time =    5925.68 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6634.20 ms /   128 tokens (   51.83 ms per token,    19.29 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6644.67 ms /   129 tokens
...
llama_print_timings: prompt eval time =     610.08 ms /     8 tokens (   76.26 ms per token,    13.11 tokens per second)
llama_print_timings:        eval time =    5706.99 ms /    63 runs   (   90.59 ms per token,    11.04 tokens per second)
llama_print_timings:       total time =    6337.22 ms /    71 tokens
Log end
...
[1]5.6204,
llama_print_timings:        load time =     275.78 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9900.25 ms /   128 tokens (   77.35 ms per token,    12.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9910.66 ms /   129 tokens
...
llama_print_timings:        load time =     284.96 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28082.49 tokens per second)
llama_print_timings: prompt eval time =     462.73 ms /     8 tokens (   57.84 ms per token,    17.29 tokens per second)
llama_print_timings:        eval time =    4942.68 ms /    63 runs   (   78.46 ms per token,    12.75 tokens per second)
llama_print_timings:       total time =    5425.18 ms /    71 tokens
Log end
...
[1]4.4091,
llama_print_timings:        load time =     267.05 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7397.85 ms /   128 tokens (   57.80 ms per token,    17.30 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7407.57 ms /   129 tokens
...
llama_print_timings:      sample time =       2.27 ms /    64 runs   (    0.04 ms per token, 28256.07 tokens per second)
llama_print_timings: prompt eval time =     390.12 ms /     8 tokens (   48.76 ms per token,    20.51 tokens per second)
llama_print_timings:        eval time =    4999.51 ms /    63 runs   (   79.36 ms per token,    12.60 tokens per second)
llama_print_timings:       total time =    5409.61 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6142.00 ms /   128 tokens (   47.98 ms per token,    20.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6151.85 ms /   129 tokens
...
-
llama_print_timings:        load time =     345.49 ms
llama_print_timings:      sample time =       2.24 ms /    64 runs   (    0.04 ms per token, 28520.50 tokens per second)
llama_print_timings: prompt eval time =     479.22 ms /     8 tokens (   59.90 ms per token,    16.69 tokens per second)
llama_print_timings:        eval time =    5692.04 ms /    63 runs   (   90.35 ms per token,    11.07 tokens per second)
llama_print_timings:       total time =    6191.20 ms /    71 tokens
Log end
...
[1]4.2338,
llama_print_timings:        load time =     330.82 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7318.04 ms /   128 tokens (   57.17 ms per token,    17.49 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7328.32 ms /   129 tokens
...
llama_print_timings: prompt eval time =     517.41 ms /     8 tokens (   64.68 ms per token,    15.46 tokens per second)
llama_print_timings:        eval time =    6326.27 ms /    63 runs   (  100.42 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    6862.89 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     368.73 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8151.36 ms /   128 tokens (   63.68 ms per token,    15.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8161.69 ms /   129 tokens
...
first run: The quick brown fox jumped over the lazy dogs bed a few nights ago.
Essentially this


second run: The quick brown fox jumped over the lazy dogs bed a few nights ago.
Essentially this


single seq run: The quick brown fox jumped over the lazy dogs bed a few nights ago.
Essentially this
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 47.285 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.59 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     541.59 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4593.93 ms /   128 tokens (   35.89 ms per token,    27.86 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4643.76 ms /   129 tokens
...
perplexity: 4.59 seconds per pass - ETA 0.07 minutes
[1]7.0156,
llama_print_timings:        load time =    5367.06 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4590.47 ms /   128 tokens (   35.86 ms per token,    27.88 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4637.96 ms /   129 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2818.43 ms /   128 tokens (   22.02 ms per token,    45.42 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2868.71 ms /   129 tokens
...
[1]7.0131,
llama_print_timings:        load time =    3950.65 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2810.17 ms /   128 tokens (   21.95 ms per token,    45.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2857.77 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.681 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.83 seconds per pass - ETA 0.03 minutes
[1]7.0336,
llama_print_timings:        load time =    4284.40 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2834.53 ms /   128 tokens (   22.14 ms per token,    45.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2881.45 ms /   129 tokens
...
0.29user 0.74system 0:01.03elapsed 100%CPU (0avgtext+0avgdata 6878132maxresident)k
...
0.09user 0.73system 0:00.83elapsed 99%CPU (0avgtext+0avgdata 6877852maxresident)k
