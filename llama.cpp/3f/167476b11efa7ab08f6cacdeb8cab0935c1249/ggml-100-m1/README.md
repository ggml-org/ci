...
- status:  SUCCESS ✅
- runtime: 785.00
- date:    Mon Apr 29 16:49:48 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   92.87 sec
      Start 22: test-rope
...
llama_print_timings: prompt eval time =      12.52 ms /     9 tokens (    1.39 ms per token,   719.02 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.32 ms /     9 tokens (    1.37 ms per token,   730.58 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> They say opposites attract. Is this true?
...
Opposites attract
llama_print_timings:        load time =    2587.08 ms
llama_print_timings:      sample time =      59.06 ms /    32 runs   (    1.85 ms per token,   541.78 tokens per second)
llama_print_timings: prompt eval time =     196.03 ms /     2 tokens (   98.02 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1502.70 ms /    31 runs   (   48.47 ms per token,    20.63 tokens per second)
llama_print_timings:       total time =    2557.28 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say the early bird gets the worm, but in this case, it seems like the "early bird" is also the one getting the worm.

**Scenario
llama_print_timings:        load time =    3292.28 ms
llama_print_timings:      sample time =      57.01 ms /    32 runs   (    1.78 ms per token,   561.27 tokens per second)
llama_print_timings: prompt eval time =     204.19 ms /     2 tokens (  102.09 ms per token,     9.79 tokens per second)
llama_print_timings:        eval time =    1506.25 ms /    31 runs   (   48.59 ms per token,    20.58 tokens per second)
llama_print_timings:       total time =    2543.12 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Shekoul Center, a renowned institution promoting interfaith harmony and social justice, organized a special event titled "Building Bridges of Understanding: Exploring the Role of Religion in
llama_print_timings:        load time =    2624.33 ms
...
llama_print_timings:        eval time =    1496.94 ms /    31 runs   (   48.29 ms per token,    20.71 tokens per second)
llama_print_timings:       total time =    2520.93 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say a picture is worth a thousand words, but in this case, the picture speaks for itself. 

**Image Description:**

A close-up of
llama_print_timings:        load time =    1965.66 ms
llama_print_timings:      sample time =      16.44 ms /    32 runs   (    0.51 ms per token,  1946.24 tokens per second)
llama_print_timings: prompt eval time =     195.41 ms /     2 tokens (   97.70 ms per token,    10.24 tokens per second)
llama_print_timings:        eval time =    1522.39 ms /    31 runs   (   49.11 ms per token,    20.36 tokens per second)
llama_print_timings:       total time =    1807.87 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If A and B are two events, then the probability that both A and B occur is given by:
$$P(A \cap B) = P(
llama_print_timings:        load time =    2808.03 ms
llama_print_timings:      sample time =      16.23 ms /    32 runs   (    0.51 ms per token,  1971.54 tokens per second)
...
llama_print_timings:       total time =    1821.56 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> The Bookworm's Guide to Mental Wellbeing

## Introduction

Mental well-being is more than just the absence of mental illness. It encompasses our emotional, physical
llama_print_timings:        load time =    2721.79 ms
llama_print_timings:      sample time =      15.70 ms /    32 runs   (    0.49 ms per token,  2038.87 tokens per second)
llama_print_timings: prompt eval time =     196.31 ms /     2 tokens (   98.15 ms per token,    10.19 tokens per second)
llama_print_timings:        eval time =    1518.55 ms /    31 runs   (   48.99 ms per token,    20.41 tokens per second)
llama_print_timings:       total time =    1802.76 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21218.93 ms
main:    total time = 21218.93 ms
+ echo PASS
PASS
+ echo
...
<bos> Heirs are a group of individuals who are entitled to inherit a portion of the family's wealth. They typically inherit a percentage of the family's assets based
...
llama_print_timings: prompt eval time =     212.99 ms /     2 tokens (  106.50 ms per token,     9.39 tokens per second)
llama_print_timings:        eval time =    1094.76 ms /    31 runs   (   35.31 ms per token,    28.32 tokens per second)
llama_print_timings:       total time =    1398.04 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21457.01 ms
main:    total time = 21457.01 ms
+ echo PASS
PASS
+ echo
...
<bos> Shelliel, a young woman of high intelligence and quick wit, navigated the treacherous world of politics in her quest to find the truth.

She possessed a
llama_print_timings:        load time =    1504.61 ms
llama_print_timings:      sample time =      16.73 ms /    32 runs   (    0.52 ms per token,  1913.30 tokens per second)
llama_print_timings: prompt eval time =     214.81 ms /     2 tokens (  107.40 ms per token,     9.31 tokens per second)
llama_print_timings:        eval time =    1104.89 ms /    31 runs   (   35.64 ms per token,    28.06 tokens per second)
llama_print_timings:       total time =    1411.79 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
