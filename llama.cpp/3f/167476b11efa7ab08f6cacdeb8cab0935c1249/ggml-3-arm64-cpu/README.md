...
- status:  SUCCESS ✅
- runtime: 19:44.51
- date:    Mon Apr 29 14:09:41 UTC 2024
...
15/23 Test #15: test-tokenizer-1-starcoder ..........   Passed    5.07 sec
      Start 16: test-tokenizer-1-gpt2
16/23 Test #16: test-tokenizer-1-gpt2 ...............   Passed    5.35 sec
...
Label Time Summary:
main    = 105.08 sec*proc (23 tests)

Total Test time (real) = 105.09 sec
...
llama_print_timings: prompt eval time =      13.27 ms /     9 tokens (    1.47 ms per token,   678.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      80.78 ms /    10 tokens
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      76.91 ms /    10 tokens
...
<bos> Shekhs were a group of nomadic warriors in ancient Mesopotamia, known for their warrior prowess and their use of chariots.

**Identify two key strengths of the She
llama_print_timings:        load time =    3731.95 ms
llama_print_timings:      sample time =      42.07 ms /    32 runs   (    1.31 ms per token,   760.58 tokens per second)
llama_print_timings: prompt eval time =    2733.92 ms /     2 tokens ( 1366.96 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   48822.36 ms /    31 runs   ( 1574.91 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   51712.22 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When You Fall Down, You Get Up Again

**Meaning:**

The message of this poem is that even after facing difficulties and setbacks, one should not give up
llama_print_timings:        load time =    3726.16 ms
llama_print_timings:      sample time =      41.64 ms /    32 runs   (    1.30 ms per token,   768.45 tokens per second)
llama_print_timings: prompt eval time =    2734.30 ms /     2 tokens ( 1367.15 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   48814.54 ms /    31 runs   ( 1574.66 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51704.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> He's not just a tech investor, he's a pioneer in the world of AI and blockchain.

This is the bio of a person who is a
llama_print_timings:        load time =    3730.41 ms
llama_print_timings:      sample time =      41.84 ms /    32 runs   (    1.31 ms per token,   764.75 tokens per second)
llama_print_timings: prompt eval time =    2734.02 ms /     2 tokens ( 1367.01 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   48792.05 ms /    31 runs   ( 1573.94 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51685.71 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar is a new company specializing in space tourism experiences.

**a.** What is the purpose of So Soar?
**b.** What are the potential
llama_print_timings:        load time =    1174.91 ms
llama_print_timings:      sample time =       8.18 ms /    32 runs   (    0.26 ms per token,  3912.94 tokens per second)
llama_print_timings: prompt eval time =     165.56 ms /     2 tokens (   82.78 ms per token,    12.08 tokens per second)
llama_print_timings:        eval time =    3120.51 ms /    31 runs   (  100.66 ms per token,     9.93 tokens per second)
...
Jasper was known for his sharp mind and his vast knowledge of the forest. He spent countless hours perched high
llama_print_timings:        load time =    1161.41 ms
llama_print_timings:      sample time =       8.08 ms /    32 runs   (    0.25 ms per token,  3962.36 tokens per second)
llama_print_timings: prompt eval time =     362.10 ms /     5 tokens (   72.42 ms per token,    13.81 tokens per second)
llama_print_timings:        eval time =    3121.77 ms /    31 runs   (  100.70 ms per token,     9.93 tokens per second)
llama_print_timings:       total time =    3524.38 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When You Say Goodbye

**Theme:** Grief and acceptance

**Characters:**

* John - A man struggling with grief
* Sarah - A woman offering support and
...
llama_print_timings:       total time =    3325.08 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26723.61 ms
main:    total time = 26723.61 ms
+ echo PASS
PASS
+ echo
...
<bos> Heider's theory of bounded rationality suggests that individuals make decisions based on their beliefs, emotions, and past experiences, but are limited in their ability to process information
llama_print_timings:        load time =     771.65 ms
...
llama_print_timings:        eval time =    2960.38 ms /    31 runs   (   95.50 ms per token,    10.47 tokens per second)
llama_print_timings:       total time =    3157.94 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26849.21 ms
main:    total time = 26849.21 ms
+ echo PASS
PASS
+ echo
...
<bos> Heuristics is a cognitive bias that describes the tendency to rely on mental shortcuts or heuristics to make decisions. Heuristics are mental rules or strategies that people use
llama_print_timings:        load time =     767.13 ms
llama_print_timings:      sample time =       7.92 ms /    32 runs   (    0.25 ms per token,  4038.36 tokens per second)
llama_print_timings: prompt eval time =     156.75 ms /     2 tokens (   78.38 ms per token,    12.76 tokens per second)
llama_print_timings:        eval time =    2932.94 ms /    31 runs   (   94.61 ms per token,    10.57 tokens per second)
llama_print_timings:       total time =    3130.12 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    2942.03 ms
llama_print_timings:      sample time =       2.69 ms /    64 runs   (    0.04 ms per token, 23827.25 tokens per second)
llama_print_timings: prompt eval time =    1121.86 ms /     8 tokens (  140.23 ms per token,     7.13 tokens per second)
llama_print_timings:        eval time =   14122.35 ms /    63 runs   (  224.16 ms per token,     4.46 tokens per second)
llama_print_timings:       total time =   15258.18 ms /    71 tokens
Log end
...
[1]4.2449,
llama_print_timings:        load time =    2963.86 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22242.10 ms /   128 tokens (  173.77 ms per token,     5.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22253.87 ms /   129 tokens
...
llama_print_timings:       total time =    9332.23 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14322.98 ms /   128 tokens (  111.90 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14335.36 ms /   129 tokens
...
llama_print_timings: prompt eval time =     908.75 ms /     8 tokens (  113.59 ms per token,     8.80 tokens per second)
llama_print_timings:        eval time =    7899.27 ms /    63 runs   (  125.39 ms per token,     7.98 tokens per second)
llama_print_timings:       total time =    8822.19 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14912.53 ms /   128 tokens (  116.50 ms per token,     8.58 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14924.99 ms /   129 tokens
...
llama_print_timings: prompt eval time =     959.52 ms /     8 tokens (  119.94 ms per token,     8.34 tokens per second)
llama_print_timings:        eval time =    8388.23 ms /    63 runs   (  133.15 ms per token,     7.51 tokens per second)
llama_print_timings:       total time =    9361.95 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15828.26 ms /   128 tokens (  123.66 ms per token,     8.09 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15840.00 ms /   129 tokens
...
llama_print_timings:        eval time =   10482.78 ms /    63 runs   (  166.39 ms per token,     6.01 tokens per second)
llama_print_timings:       total time =   11701.89 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   19853.71 ms /   128 tokens (  155.11 ms per token,     6.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   19865.84 ms /   129 tokens
...
I believe
llama_print_timings:        load time =    1345.17 ms
llama_print_timings:      sample time =       2.73 ms /    64 runs   (    0.04 ms per token, 23486.24 tokens per second)
llama_print_timings: prompt eval time =    1232.38 ms /     8 tokens (  154.05 ms per token,     6.49 tokens per second)
llama_print_timings:        eval time =   11137.31 ms /    63 runs   (  176.78 ms per token,     5.66 tokens per second)
llama_print_timings:       total time =   12384.14 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20109.81 ms /   128 tokens (  157.11 ms per token,     6.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20122.28 ms /   129 tokens
...
llama_print_timings:        eval time =    9793.21 ms /    63 runs   (  155.45 ms per token,     6.43 tokens per second)
llama_print_timings:       total time =   10954.80 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18726.15 ms /   128 tokens (  146.30 ms per token,     6.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18738.06 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1079.94 ms /     8 tokens (  134.99 ms per token,     7.41 tokens per second)
llama_print_timings:        eval time =    9348.88 ms /    63 runs   (  148.39 ms per token,     6.74 tokens per second)
llama_print_timings:       total time =   10451.75 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17747.01 ms /   128 tokens (  138.65 ms per token,     7.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17759.02 ms /   129 tokens
...
llama_print_timings:        load time =    1131.28 ms
llama_print_timings:      sample time =       2.69 ms /    64 runs   (    0.04 ms per token, 23809.52 tokens per second)
llama_print_timings: prompt eval time =     953.82 ms /     8 tokens (  119.23 ms per token,     8.39 tokens per second)
llama_print_timings:        eval time =    8349.90 ms /    63 runs   (  132.54 ms per token,     7.55 tokens per second)
llama_print_timings:       total time =    9317.55 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15632.20 ms /   128 tokens (  122.13 ms per token,     8.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15644.15 ms /   129 tokens
...
llama_print_timings:      sample time =       2.69 ms /    64 runs   (    0.04 ms per token, 23827.25 tokens per second)
llama_print_timings: prompt eval time =    1315.78 ms /     8 tokens (  164.47 ms per token,     6.08 tokens per second)
llama_print_timings:        eval time =   11157.11 ms /    63 runs   (  177.10 ms per token,     5.65 tokens per second)
llama_print_timings:       total time =   12486.59 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21439.19 ms /   128 tokens (  167.49 ms per token,     5.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21451.70 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1345.70 ms /     8 tokens (  168.21 ms per token,     5.94 tokens per second)
llama_print_timings:        eval time =   11499.16 ms /    63 runs   (  182.53 ms per token,     5.48 tokens per second)
llama_print_timings:       total time =   12859.41 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 10.456 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 21.99 seconds per pass - ETA 0.35 minutes
[1]4.2538,
llama_print_timings:        load time =    1483.53 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21988.00 ms /   128 tokens (  171.78 ms per token,     5.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22000.26 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy dog. Falling rain, mihi a mihi nice


second run: The quick brown fox jumps over the lazy dog. Falling rain, mihi a mihi nice


single seq run: The quick brown fox jumps over the lazy dog. Falling rain, mihi a mihi nice
...
perplexity: 22.24 seconds per pass - ETA 0.37 minutes
[1]9.1008,
llama_print_timings:        load time =    2912.74 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22241.50 ms /   128 tokens (  173.76 ms per token,     5.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22310.76 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 64.644 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 22.21 seconds per pass - ETA 0.37 minutes
[1]7.0171,
llama_print_timings:        load time =    6967.16 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22213.70 ms /   128 tokens (  173.54 ms per token,     5.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22280.39 ms /   129 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14320.13 ms /   128 tokens (  111.88 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14388.68 ms /   129 tokens
...
perplexity: 14.32 seconds per pass - ETA 0.23 minutes
[1]6.9493,
llama_print_timings:        load time =    5450.69 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14320.70 ms /   128 tokens (  111.88 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14386.42 ms /   129 tokens
...
perplexity: 14.32 seconds per pass - ETA 0.23 minutes
[1]7.0116,
llama_print_timings:        load time =    6147.27 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14319.30 ms /   128 tokens (  111.87 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14383.80 ms /   129 tokens
...
0.37user 2.78system 0:03.15elapsed 100%CPU (0avgtext+0avgdata 6877816maxresident)k
