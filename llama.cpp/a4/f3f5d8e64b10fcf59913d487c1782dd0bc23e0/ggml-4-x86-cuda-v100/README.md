...
- status:  FAILURE ❌ (8)
- runtime: 5:04.18
- date:    Tue Jan 14 07:46:33 UTC 2025
...
15/28 Test #15: test-grammar-parser ...............   Passed    0.07 sec
...
24/28 Test #24: test-backend-ops ..................***Failed  199.74 sec
...
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[MUL_MAT] NMSE = 0.000557859 > 0.000500000 ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[1;31mFAIL[0m
  MUL_MAT(type_a=q5_0,type_b=f32,m=16,n=1,k=256,bs=[1,1],nr=[1,1],per=[0,1,2,3]): ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
...
Label Time Summary:
main    = 276.73 sec*proc (28 tests)

Total Test time (real) = 276.76 sec
