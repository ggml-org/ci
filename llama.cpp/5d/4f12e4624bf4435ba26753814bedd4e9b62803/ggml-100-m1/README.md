...
- status:  SUCCESS ✅
- runtime: 463.58
- date:    Wed Apr  3 21:04:44 EEST 2024
...
20/22 Test #20: test-backend-ops ....................   Passed  107.82 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 210.46 sec*proc (22 tests)

Total Test time (real) = 210.47 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      13.40 ms /     9 tokens (    1.49 ms per token,   671.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
