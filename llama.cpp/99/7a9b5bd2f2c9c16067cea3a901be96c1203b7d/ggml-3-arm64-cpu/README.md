...
- status:  SUCCESS ✅
- runtime: 20:53.09
- date:    Wed Apr 17 17:33:55 UTC 2024
...
Label Time Summary:
main    = 103.67 sec*proc (23 tests)

Total Test time (real) = 103.68 sec
...
main: build = 2703 (997a9b5b)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for aarch64-linux-gnu
main: seed  = 1713374287
...
llama_print_timings:        load time =      43.24 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       6.77 ms /     9 tokens (    0.75 ms per token,  1329.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      73.83 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       9.37 ms /     9 tokens (    1.04 ms per token,   960.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      76.07 ms /    10 tokens
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They say a picture is worth a thousand words, but the following image speaks volumes without needing a thousand words.

**A group of friends laughing and playing in a
llama_print_timings:        load time =    3761.41 ms
llama_print_timings:      sample time =      41.74 ms /    32 runs   (    1.30 ms per token,   766.67 tokens per second)
llama_print_timings: prompt eval time =    2746.76 ms /     2 tokens ( 1373.38 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   49002.26 ms /    31 runs   ( 1580.72 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   51903.73 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Soar is a revolutionary app that combines AI-powered flight tracking with personalized recommendations to help individuals achieve their aerial ambitions.

**Here's what makes So So
llama_print_timings:        load time =    3748.65 ms
llama_print_timings:      sample time =      41.92 ms /    32 runs   (    1.31 ms per token,   763.40 tokens per second)
llama_print_timings: prompt eval time =    2746.14 ms /     2 tokens ( 1373.07 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   48993.24 ms /    31 runs   ( 1580.43 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   51894.92 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shewans are a diverse group of people with a rich cultural history.

This statement highlights the diversity of the Shewans while also acknowledging their rich cultural history
llama_print_timings:        load time =    3744.11 ms
llama_print_timings:      sample time =      42.23 ms /    32 runs   (    1.32 ms per token,   757.72 tokens per second)
llama_print_timings: prompt eval time =    2748.28 ms /     2 tokens ( 1374.14 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   49010.69 ms /    31 runs   ( 1580.99 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   51921.20 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**The Witcher Season 2: A Bloody and Epic Return**

The Witcher returns with a vengeance-fueled and captivating
llama_print_timings:        load time =    1176.60 ms
llama_print_timings:      sample time =       7.75 ms /    32 runs   (    0.24 ms per token,  4131.16 tokens per second)
llama_print_timings: prompt eval time =     165.90 ms /     2 tokens (   82.95 ms per token,    12.06 tokens per second)
llama_print_timings:        eval time =    3128.50 ms /    31 runs   (  100.92 ms per token,     9.91 tokens per second)
llama_print_timings:       total time =    3334.43 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a bustling city, lived a young woman named Anya. Anya possessed a heart of gold and a passion for helping others.

One fateful day, Anya
llama_print_timings:        load time =    1166.51 ms
llama_print_timings:      sample time =       7.66 ms /    32 runs   (    0.24 ms per token,  4179.73 tokens per second)
llama_print_timings: prompt eval time =     360.21 ms /     5 tokens (   72.04 ms per token,    13.88 tokens per second)
llama_print_timings:        eval time =    3120.55 ms /    31 runs   (  100.66 ms per token,     9.93 tokens per second)
llama_print_timings:       total time =    3520.06 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They say a picture is worth a thousand words, but how many words can truly capture the essence of a person's journey?

**Essay:**

The human
llama_print_timings:        load time =    1178.72 ms
llama_print_timings:      sample time =       8.84 ms /    32 runs   (    0.28 ms per token,  3621.55 tokens per second)
llama_print_timings: prompt eval time =     164.87 ms /     2 tokens (   82.43 ms per token,    12.13 tokens per second)
llama_print_timings:        eval time =    3111.04 ms /    31 runs   (  100.36 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    3316.94 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    3388.84 ms
...
llama_print_timings:        eval time =   24648.46 ms /    63 runs   (  391.25 ms per token,     2.56 tokens per second)
llama_print_timings:       total time =   25960.36 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =    3404.76 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8897.54 ms /   128 tokens (   69.51 ms per token,    14.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8909.35 ms /   129 tokens
...
llama_print_timings:        load time =    1677.25 ms
llama_print_timings:      sample time =       2.63 ms /    64 runs   (    0.04 ms per token, 24325.35 tokens per second)
llama_print_timings: prompt eval time =     879.00 ms /     8 tokens (  109.88 ms per token,     9.10 tokens per second)
llama_print_timings:        eval time =    8418.29 ms /    63 runs   (  133.62 ms per token,     7.48 tokens per second)
llama_print_timings:       total time =    9310.81 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14152.51 ms /   128 tokens (  110.57 ms per token,     9.04 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14164.87 ms /   129 tokens
...
llama_print_timings:        eval time =    7897.08 ms /    63 runs   (  125.35 ms per token,     7.98 tokens per second)
llama_print_timings:       total time =    8817.76 ms /    71 tokens
Log end
...
[1]4.1546,
llama_print_timings:        load time =     998.34 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14737.78 ms /   128 tokens (  115.14 ms per token,     8.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14749.50 ms /   129 tokens
...
llama_print_timings:        load time =    1126.06 ms
...
llama_print_timings:        eval time =    8420.21 ms /    63 runs   (  133.65 ms per token,     7.48 tokens per second)
llama_print_timings:       total time =    9394.07 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15688.80 ms /   128 tokens (  122.57 ms per token,     8.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15700.68 ms /   129 tokens
...
llama_print_timings:      sample time =       2.63 ms /    64 runs   (    0.04 ms per token, 24325.35 tokens per second)
llama_print_timings: prompt eval time =    1231.13 ms /     8 tokens (  153.89 ms per token,     6.50 tokens per second)
llama_print_timings:        eval time =   10660.76 ms /    63 runs   (  169.22 ms per token,     5.91 tokens per second)
llama_print_timings:       total time =   11905.71 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20096.99 ms /   128 tokens (  157.01 ms per token,     6.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20109.18 ms /   129 tokens
...
-Mahatma Gandhi
This entry
llama_print_timings:        load time =    1344.35 ms
...
llama_print_timings:        eval time =   10903.18 ms /    63 runs   (  173.07 ms per token,     5.78 tokens per second)
llama_print_timings:       total time =   12146.34 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   19967.39 ms /   128 tokens (  156.00 ms per token,     6.41 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   19978.91 ms /   129 tokens
...
llama_print_timings:        eval time =    9807.21 ms /    63 runs   (  155.67 ms per token,     6.42 tokens per second)
llama_print_timings:       total time =   10967.38 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18549.62 ms /   128 tokens (  144.92 ms per token,     6.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18561.38 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1078.34 ms /     8 tokens (  134.79 ms per token,     7.42 tokens per second)
llama_print_timings:        eval time =    9354.17 ms /    63 runs   (  148.48 ms per token,     6.73 tokens per second)
llama_print_timings:       total time =   10446.08 ms /    71 tokens
Log end
...
[1]4.4127,
llama_print_timings:        load time =     984.77 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17577.74 ms /   128 tokens (  137.33 ms per token,     7.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17590.00 ms /   129 tokens
...
llama_print_timings: prompt eval time =     953.93 ms /     8 tokens (  119.24 ms per token,     8.39 tokens per second)
llama_print_timings:        eval time =    8365.45 ms /    63 runs   (  132.78 ms per token,     7.53 tokens per second)
llama_print_timings:       total time =    9333.29 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15462.02 ms /   128 tokens (  120.80 ms per token,     8.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15473.82 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1309.46 ms /     8 tokens (  163.68 ms per token,     6.11 tokens per second)
llama_print_timings:        eval time =   11176.01 ms /    63 runs   (  177.40 ms per token,     5.64 tokens per second)
llama_print_timings:       total time =   12499.17 ms /    71 tokens
Log end
...
[1]4.2279,
llama_print_timings:        load time =    1331.81 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21290.63 ms /   128 tokens (  166.33 ms per token,     6.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21303.00 ms /   129 tokens
...
llama_print_timings:        load time =    1513.55 ms
llama_print_timings:      sample time =       2.68 ms /    64 runs   (    0.04 ms per token, 23845.01 tokens per second)
llama_print_timings: prompt eval time =    1342.55 ms /     8 tokens (  167.82 ms per token,     5.96 tokens per second)
llama_print_timings:        eval time =   11488.05 ms /    63 runs   (  182.35 ms per token,     5.48 tokens per second)
llama_print_timings:       total time =   12844.12 ms /    71 tokens
Log end
...
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 21.82 seconds per pass - ETA 0.35 minutes
[1]4.2383,
llama_print_timings:        load time =    1616.06 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21817.82 ms /   128 tokens (  170.45 ms per token,     5.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21830.00 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 64.323 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 8.91 seconds per pass - ETA 0.13 minutes
[1]9.1017,
llama_print_timings:        load time =    3344.65 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8913.69 ms /   128 tokens (   69.64 ms per token,    14.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8979.36 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 60.39 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 8.89 seconds per pass - ETA 0.13 minutes
[1]7.0172,
llama_print_timings:        load time =    5997.36 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8892.53 ms /   128 tokens (   69.47 ms per token,    14.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8954.17 ms /   129 tokens
...
perplexity: 14.15 seconds per pass - ETA 0.23 minutes
[1]9.1324,
llama_print_timings:        load time =    1641.33 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14147.29 ms /   128 tokens (  110.53 ms per token,     9.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14215.45 ms /   129 tokens
...
[1]7.0274,
llama_print_timings:        load time =    4062.80 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14143.95 ms /   128 tokens (  110.50 ms per token,     9.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14207.12 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 61.899 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.15 seconds per pass - ETA 0.23 minutes
[1]7.0294,
llama_print_timings:        load time =    4719.87 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14148.20 ms /   128 tokens (  110.53 ms per token,     9.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14211.63 ms /   129 tokens
...
0.37user 2.77system 0:03.14elapsed 99%CPU (0avgtext+0avgdata 6877684maxresident)k
...
0.10user 2.78system 0:02.89elapsed 100%CPU (0avgtext+0avgdata 6877164maxresident)k
0inputs+40outputs (0major+153622minor)pagefaults 0swaps
```
