...
- status:  SUCCESS ✅
- runtime: 21:38.65
- date:    Fri Apr 19 09:57:40 UTC 2024
...
10/23 Test #10: test-tokenizer-1-aquila .............   Passed    9.18 sec
...
Label Time Summary:
main    = 102.94 sec*proc (23 tests)

Total Test time (real) = 102.95 sec
...
llama_print_timings:        load time =      40.94 ms
...
llama_print_timings:        load time =      25.61 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 After reviewing the provided context, identify the key points of disagreement and potential areas of convergence.

**Context:**

The company is considering expanding its product line to include
llama_print_timings:        load time =    3707.06 ms
llama_print_timings:      sample time =      41.77 ms /    32 runs   (    1.31 ms per token,   766.03 tokens per second)
llama_print_timings: prompt eval time =    2722.31 ms /     2 tokens ( 1361.16 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   48586.03 ms /    31 runs   ( 1567.29 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51464.62 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 If f(x) = x^2 + 2x, find the derivative of f(x).

$$f(x) = x^2 +
llama_print_timings:        load time =    3703.90 ms
llama_print_timings:      sample time =      41.74 ms /    32 runs   (    1.30 ms per token,   766.58 tokens per second)
llama_print_timings: prompt eval time =    2720.85 ms /     2 tokens ( 1360.42 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48552.77 ms /    31 runs   ( 1566.22 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51428.92 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 He, the enigmatic figure, whispered secrets into the ear of a sleeping village, promising them prosperity. But beneath his guise lay a darkness that devoured all in its path
llama_print_timings:        load time =    3713.76 ms
llama_print_timings:      sample time =      41.91 ms /    32 runs   (    1.31 ms per token,   763.50 tokens per second)
llama_print_timings: prompt eval time =    2717.66 ms /     2 tokens ( 1358.83 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48485.30 ms /    31 runs   ( 1564.04 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51360.05 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 The Simpsons meme template

**Image:** A screenshot or image of The Simpsons cartoon.

**Caption:**

* **Topic:** [Insert meme topic]
*
llama_print_timings:        load time =    1162.32 ms
llama_print_timings:      sample time =       7.81 ms /    32 runs   (    0.24 ms per token,  4099.41 tokens per second)
llama_print_timings: prompt eval time =     166.00 ms /     2 tokens (   83.00 ms per token,    12.05 tokens per second)
llama_print_timings:        eval time =    3120.20 ms /    31 runs   (  100.65 ms per token,     9.94 tokens per second)
llama_print_timings:       total time =    3326.65 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shekhs are a fictional group of people from ancient Mesopotamia. They are often depicted as being wealthy and powerful, with a sophisticated culture. However, there is little
llama_print_timings:        load time =    1153.19 ms
llama_print_timings:      sample time =       7.71 ms /    32 runs   (    0.24 ms per token,  4151.53 tokens per second)
llama_print_timings: prompt eval time =     165.63 ms /     2 tokens (   82.81 ms per token,    12.08 tokens per second)
llama_print_timings:        eval time =    3113.86 ms /    31 runs   (  100.45 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    3318.90 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**A thrilling and captivating continuation of the Witcher saga, Season 2 delivers a rollercoaster of action, intrigue, and emotional depth,
llama_print_timings:        load time =    1165.83 ms
...
llama_print_timings:       total time =    3320.82 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    3327.70 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23988.01 tokens per second)
llama_print_timings: prompt eval time =    2240.17 ms /     8 tokens (  280.02 ms per token,     3.57 tokens per second)
llama_print_timings:        eval time =   19762.22 ms /    63 runs   (  313.69 ms per token,     3.19 tokens per second)
llama_print_timings:       total time =   22016.66 ms /    71 tokens
Log end
...
[1]4.2442,
llama_print_timings:        load time =    3270.74 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36552.68 ms /   128 tokens (  285.57 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36564.64 ms /   129 tokens
...
llama_print_timings:        load time =    1695.81 ms
...
llama_print_timings:        eval time =    8431.67 ms /    63 runs   (  133.84 ms per token,     7.47 tokens per second)
...
[1]4.2615,
llama_print_timings:        load time =    1669.97 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14366.32 ms /   128 tokens (  112.24 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14378.12 ms /   129 tokens
...
llama_print_timings:        load time =    1047.54 ms
llama_print_timings:      sample time =       2.63 ms /    64 runs   (    0.04 ms per token, 24316.11 tokens per second)
llama_print_timings: prompt eval time =     911.09 ms /     8 tokens (  113.89 ms per token,     8.78 tokens per second)
llama_print_timings:        eval time =    7934.20 ms /    63 runs   (  125.94 ms per token,     7.94 tokens per second)
...
[1]4.1750,
llama_print_timings:        load time =    1017.09 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14965.16 ms /   128 tokens (  116.92 ms per token,     8.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14977.72 ms /   129 tokens
...
llama_print_timings: prompt eval time =     960.19 ms /     8 tokens (  120.02 ms per token,     8.33 tokens per second)
llama_print_timings:        eval time =    8427.36 ms /    63 runs   (  133.77 ms per token,     7.48 tokens per second)
llama_print_timings:       total time =    9401.45 ms /    71 tokens
Log end
...
[1]4.3861,
llama_print_timings:        load time =    1044.00 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15874.78 ms /   128 tokens (  124.02 ms per token,     8.06 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15886.55 ms /   129 tokens
...
llama_print_timings:        load time =    1286.72 ms
...
llama_print_timings:        eval time =   10516.61 ms /    63 runs   (  166.93 ms per token,     5.99 tokens per second)
llama_print_timings:       total time =   11740.66 ms /    71 tokens
Log end
...
[1]4.3466,
llama_print_timings:        load time =    1267.55 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20083.91 ms /   128 tokens (  156.91 ms per token,     6.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20096.53 ms /   129 tokens
...
I believe that love
llama_print_timings:        load time =    1372.31 ms
...
llama_print_timings:        eval time =   10994.23 ms /    63 runs   (  174.51 ms per token,     5.73 tokens per second)
llama_print_timings:       total time =   12237.58 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20118.59 ms /   128 tokens (  157.18 ms per token,     6.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20130.83 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1150.04 ms /     8 tokens (  143.75 ms per token,     6.96 tokens per second)
llama_print_timings:        eval time =    9814.80 ms /    63 runs   (  155.79 ms per token,     6.42 tokens per second)
llama_print_timings:       total time =   10979.11 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18774.69 ms /   128 tokens (  146.68 ms per token,     6.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18786.72 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1082.48 ms /     8 tokens (  135.31 ms per token,     7.39 tokens per second)
llama_print_timings:        eval time =    9379.49 ms /    63 runs   (  148.88 ms per token,     6.72 tokens per second)
llama_print_timings:       total time =   10475.89 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17808.03 ms /   128 tokens (  139.13 ms per token,     7.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17820.65 ms /   129 tokens
...
I
llama_print_timings:        load time =    1133.78 ms
llama_print_timings:      sample time =       2.68 ms /    64 runs   (    0.04 ms per token, 23880.60 tokens per second)
llama_print_timings: prompt eval time =     957.56 ms /     8 tokens (  119.70 ms per token,     8.35 tokens per second)
llama_print_timings:        eval time =    8387.40 ms /    63 runs   (  133.13 ms per token,     7.51 tokens per second)
llama_print_timings:       total time =    9359.14 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15684.02 ms /   128 tokens (  122.53 ms per token,     8.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15695.14 ms /   129 tokens
...
llama_print_timings:        eval time =   11191.93 ms /    63 runs   (  177.65 ms per token,     5.63 tokens per second)
llama_print_timings:       total time =   12518.02 ms /    71 tokens
Log end
...
[1]4.2316,
llama_print_timings:        load time =    1263.46 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21482.99 ms /   128 tokens (  167.84 ms per token,     5.96 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21494.30 ms /   129 tokens
...
llama_print_timings:        load time =    1426.99 ms
llama_print_timings:      sample time =       2.66 ms /    64 runs   (    0.04 ms per token, 24042.07 tokens per second)
llama_print_timings: prompt eval time =    1345.63 ms /     8 tokens (  168.20 ms per token,     5.95 tokens per second)
llama_print_timings:        eval time =   11515.52 ms /    63 runs   (  182.79 ms per token,     5.47 tokens per second)
llama_print_timings:       total time =   12874.56 ms /    71 tokens
Log end
...
[1]4.2451,
llama_print_timings:        load time =    1463.53 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22033.10 ms /   128 tokens (  172.13 ms per token,     5.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22045.56 ms /   129 tokens
...
Walks: prep for writing books theses in
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 67.42 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.60 seconds per pass - ETA 0.60 minutes
[1]9.1017,
llama_print_timings:        load time =    3265.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36599.68 ms /   128 tokens (  285.94 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36668.56 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 62.911 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.55 seconds per pass - ETA 0.60 minutes
[1]7.0171,
llama_print_timings:        load time =    6304.18 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36546.23 ms /   128 tokens (  285.52 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36610.57 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 65.684 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]9.1296,
llama_print_timings:        load time =    1625.46 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14366.87 ms /   128 tokens (  112.24 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14434.38 ms /   129 tokens
...
[1]6.9856,
llama_print_timings:        load time =    4453.76 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14362.96 ms /   128 tokens (  112.21 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14422.72 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 65.26 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]6.9967,
llama_print_timings:        load time =    5151.15 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14373.42 ms /   128 tokens (  112.29 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14440.34 ms /   129 tokens
...
0.35user 3.00system 0:03.35elapsed 100%CPU (0avgtext+0avgdata 6877696maxresident)k
...
0.10user 3.01system 0:03.12elapsed 100%CPU (0avgtext+0avgdata 6877176maxresident)k
