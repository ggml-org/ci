...
- status:  SUCCESS ✅
- runtime: 345.63
- date:    Fri May 17 10:03:48 EEST 2024
...
Label Time Summary:
main    = 183.21 sec*proc (22 tests)

Total Test time (real) = 183.22 sec
...
llama_print_timings:        load time =      67.80 ms
...
llama_print_timings:        load time =      55.98 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
