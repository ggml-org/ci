...
- status:  SUCCESS ✅
- runtime: 4:32.36
- date:    Wed Feb 12 20:41:06 UTC 2025
...
0.00.000.304 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.004.344 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.004.355 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
0.00.004.357 I llama_model_loader: - kv  13:                          bert.pooling_type u32              = 2
...
0.00.008.093 I llama_model_loader: - kv  22:               tokenizer.ggml.mask_token_id u32              = 103
...
0.00.008.098 I print_info: file type   = F16
0.00.008.100 I print_info: file size   = 63.84 MiB (16.12 BPW) 
0.00.019.834 I load: special tokens cache size = 5
0.00.022.515 I load: token to piece cache size = 0.2032 MB
0.00.022.541 I print_info: arch             = bert
0.00.022.542 I print_info: vocab_only       = 0
0.00.022.542 I print_info: n_ctx_train      = 512
...
0.00.022.562 I print_info: n_embd_head_k    = 32
0.00.022.563 I print_info: n_embd_head_v    = 32
0.00.022.565 I print_info: n_gqa            = 1
0.00.022.566 I print_info: n_embd_k_gqa     = 384
0.00.022.568 I print_info: n_embd_v_gqa     = 384
0.00.022.569 I print_info: f_norm_eps       = 1.0e-12
0.00.022.569 I print_info: f_norm_rms_eps   = 0.0e+00
...
0.00.022.575 I print_info: n_ff             = 1536
0.00.022.575 I print_info: n_expert         = 0
0.00.022.576 I print_info: n_expert_used    = 0
...
0.00.022.584 I print_info: ssm_d_state      = 0
0.00.022.584 I print_info: ssm_dt_rank      = 0
0.00.022.585 I print_info: ssm_dt_b_c_rms   = 0
0.00.022.586 I print_info: model type       = 33M
0.00.022.586 I print_info: model params     = 33.21 M
0.00.022.587 I print_info: general.name     = Bge Small
0.00.022.590 I print_info: vocab type       = WPM
0.00.022.592 I print_info: n_vocab          = 30522
0.00.022.592 I print_info: n_merges         = 0
0.00.022.593 I print_info: BOS token        = 101 '[CLS]'
0.00.022.593 I print_info: UNK token        = 100 '[UNK]'
0.00.022.594 I print_info: SEP token        = 102 '[SEP]'
0.00.022.594 I print_info: PAD token        = 0 '[PAD]'
0.00.022.594 I print_info: MASK token       = 103 '[MASK]'
0.00.022.595 I print_info: LF token         = 0 '[PAD]'
0.00.022.595 I print_info: max token length = 21
0.00.022.596 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.028.015 I load_tensors:          AMX model buffer size =    40.50 MiB
0.00.028.037 I load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.042.799 I llama_init_from_model: n_seq_max     = 1
0.00.042.813 I llama_init_from_model: n_ctx         = 512
0.00.042.813 I llama_init_from_model: n_ctx_per_seq = 512
0.00.042.814 I llama_init_from_model: n_batch       = 2048
0.00.042.814 I llama_init_from_model: n_ubatch      = 2048
0.00.042.815 I llama_init_from_model: flash_attn    = 0
0.00.042.817 I llama_init_from_model: freq_base     = 10000.0
0.00.042.818 I llama_init_from_model: freq_scale    = 1
0.00.042.836 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.045.110 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.045.137 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.045.145 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.048.089 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.048.112 I llama_init_from_model: graph nodes  = 429
0.00.048.112 I llama_init_from_model: graph splits = 1
0.00.048.117 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.048.117 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.051.680 I 
0.00.051.771 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.053.097 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.057.829 I llama_perf_context_print:        load time =      51.32 ms
0.00.057.830 I llama_perf_context_print: prompt eval time =       4.50 ms /     9 tokens (    0.50 ms per token,  2001.78 tokens per second)
0.00.057.831 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.057.831 I llama_perf_context_print:       total time =       6.15 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.303 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.004.319 I llama_model_loader: - kv  13:            tokenizer.ggml.token_type_count u32              = 2
0.00.004.320 I llama_model_loader: - kv  14:                       tokenizer.ggml.model str              = bert
0.00.004.320 I llama_model_loader: - kv  15:                         tokenizer.ggml.pre str              = jina-v2-en
...
0.00.008.059 I llama_model_loader: - kv  21:               tokenizer.ggml.mask_token_id u32              = 103
0.00.008.060 I llama_model_loader: - kv  22:               general.quantization_version u32              = 2
0.00.008.060 I llama_model_loader: - kv  23:                          general.file_type u32              = 7
0.00.008.062 I llama_model_loader: - type  f32:  124 tensors
0.00.008.063 I llama_model_loader: - type q8_0:   73 tensors
0.00.008.064 I print_info: file format = GGUF V3 (latest)
...
0.00.021.916 I print_info: n_head           = 12
0.00.021.918 I print_info: n_head_kv        = 12
0.00.021.919 I print_info: n_rot            = 32
0.00.021.920 I print_info: n_swa            = 0
0.00.021.920 I print_info: n_embd_head_k    = 32
0.00.021.920 I print_info: n_embd_head_v    = 32
0.00.021.922 I print_info: n_gqa            = 1
0.00.021.923 I print_info: n_embd_k_gqa     = 384
0.00.021.924 I print_info: n_embd_v_gqa     = 384
0.00.021.925 I print_info: f_norm_eps       = 1.0e-12
0.00.021.925 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.021.926 I print_info: f_clamp_kqv      = 0.0e+00
0.00.021.926 I print_info: f_max_alibi_bias = 0.0e+00
0.00.021.926 I print_info: f_logit_scale    = 0.0e+00
0.00.021.927 I print_info: n_ff             = 1536
0.00.021.927 I print_info: n_expert         = 0
0.00.021.928 I print_info: n_expert_used    = 0
0.00.021.928 I print_info: causal attn      = 0
0.00.021.928 I print_info: pooling type     = 2
0.00.021.928 I print_info: rope type        = 2
0.00.021.929 I print_info: rope scaling     = linear
0.00.021.930 I print_info: freq_base_train  = 10000.0
0.00.021.930 I print_info: freq_scale_train = 1
0.00.021.931 I print_info: n_ctx_orig_yarn  = 512
0.00.021.931 I print_info: rope_finetuned   = unknown
0.00.021.931 I print_info: ssm_d_conv       = 0
0.00.021.932 I print_info: ssm_d_inner      = 0
0.00.021.932 I print_info: ssm_d_state      = 0
0.00.021.932 I print_info: ssm_dt_rank      = 0
0.00.021.932 I print_info: ssm_dt_b_c_rms   = 0
0.00.021.933 I print_info: model type       = 33M
0.00.021.934 I print_info: model params     = 33.21 M
0.00.021.934 I print_info: general.name     = Bge Small
0.00.021.937 I print_info: vocab type       = WPM
0.00.021.938 I print_info: n_vocab          = 30522
0.00.021.938 I print_info: n_merges         = 0
0.00.021.938 I print_info: BOS token        = 101 '[CLS]'
0.00.021.939 I print_info: UNK token        = 100 '[UNK]'
0.00.021.940 I print_info: SEP token        = 102 '[SEP]'
0.00.021.940 I print_info: PAD token        = 0 '[PAD]'
0.00.021.941 I print_info: MASK token       = 103 '[MASK]'
0.00.021.941 I print_info: LF token         = 0 '[PAD]'
0.00.021.942 I print_info: max token length = 21
0.00.021.943 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.024.894 I load_tensors:          AMX model buffer size =    24.05 MiB
0.00.024.912 I load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.031.080 I llama_init_from_model: n_seq_max     = 1
0.00.031.094 I llama_init_from_model: n_ctx         = 512
0.00.031.095 I llama_init_from_model: n_ctx_per_seq = 512
0.00.031.097 I llama_init_from_model: n_batch       = 2048
0.00.031.098 I llama_init_from_model: n_ubatch      = 2048
0.00.031.098 I llama_init_from_model: flash_attn    = 0
0.00.031.101 I llama_init_from_model: freq_base     = 10000.0
0.00.031.102 I llama_init_from_model: freq_scale    = 1
0.00.031.117 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.032.973 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.032.997 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.033.004 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.035.679 I llama_init_from_model:        CPU compute buffer size =    16.01 MiB
0.00.035.693 I llama_init_from_model: graph nodes  = 429
0.00.035.694 I llama_init_from_model: graph splits = 1
0.00.035.697 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.035.698 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.038.014 I 
0.00.038.094 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.039.069 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.041.538 I llama_perf_context_print:        load time =      37.67 ms
0.00.041.554 I llama_perf_context_print: prompt eval time =       2.07 ms /     9 tokens (    0.23 ms per token,  4341.53 tokens per second)
0.00.041.569 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.041.570 I llama_perf_context_print:       total time =       3.53 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.316 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.014.752 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.016.111 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.491 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
...
0.00.019.510 I llama_model_loader: - kv  24:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.511 I llama_model_loader: - kv  25:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.512 I llama_model_loader: - kv  26:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.512 I llama_model_loader: - kv  27:               general.quantization_version u32              = 2
0.00.019.515 I llama_model_loader: - type  f32:   40 tensors
0.00.019.515 I llama_model_loader: - type  f16:   30 tensors
0.00.019.517 I print_info: file format = GGUF V3 (latest)
0.00.019.518 I print_info: file type   = F16
0.00.019.520 I print_info: file size   = 62.78 MiB (16.01 BPW) 
0.00.026.845 W load: empty token at index 5
0.00.037.584 W load: model vocab missing newline token, using special_pad_id instead
0.00.051.597 W load: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.051.711 I load: special tokens cache size = 5
0.00.340.792 I load: token to piece cache size = 1.5060 MB
0.00.340.815 I print_info: arch             = jina-bert-v2
0.00.340.816 I print_info: vocab_only       = 0
0.00.340.816 I print_info: n_ctx_train      = 8192
0.00.340.816 I print_info: n_embd           = 384
0.00.340.817 I print_info: n_layer          = 4
0.00.340.825 I print_info: n_head           = 12
0.00.340.827 I print_info: n_head_kv        = 12
0.00.340.827 I print_info: n_rot            = 32
0.00.340.828 I print_info: n_swa            = 0
0.00.340.828 I print_info: n_embd_head_k    = 32
0.00.340.828 I print_info: n_embd_head_v    = 32
0.00.340.830 I print_info: n_gqa            = 1
0.00.340.831 I print_info: n_embd_k_gqa     = 384
0.00.340.833 I print_info: n_embd_v_gqa     = 384
0.00.340.834 I print_info: f_norm_eps       = 1.0e-12
0.00.340.835 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.340.835 I print_info: f_clamp_kqv      = 0.0e+00
0.00.340.836 I print_info: f_max_alibi_bias = 8.0e+00
0.00.340.836 I print_info: f_logit_scale    = 0.0e+00
0.00.340.837 I print_info: n_ff             = 1536
0.00.340.838 I print_info: n_expert         = 0
0.00.340.838 I print_info: n_expert_used    = 0
0.00.340.838 I print_info: causal attn      = 0
0.00.340.839 I print_info: pooling type     = -1
0.00.340.839 I print_info: rope type        = -1
0.00.340.839 I print_info: rope scaling     = linear
0.00.340.840 I print_info: freq_base_train  = 10000.0
0.00.340.841 I print_info: freq_scale_train = 1
0.00.340.841 I print_info: n_ctx_orig_yarn  = 8192
0.00.340.842 I print_info: rope_finetuned   = unknown
0.00.340.842 I print_info: ssm_d_conv       = 0
0.00.340.842 I print_info: ssm_d_inner      = 0
0.00.340.843 I print_info: ssm_d_state      = 0
0.00.340.843 I print_info: ssm_dt_rank      = 0
0.00.340.843 I print_info: ssm_dt_b_c_rms   = 0
0.00.340.844 I print_info: model type       = 33M
0.00.340.845 I print_info: model params     = 32.90 M
0.00.340.845 I print_info: general.name     = Jina Bert Implementation
0.00.340.848 I print_info: vocab type       = BPE
0.00.340.849 I print_info: n_vocab          = 61056
0.00.340.849 I print_info: n_merges         = 39382
0.00.340.850 I print_info: BOS token        = 0 '<s>'
0.00.340.850 I print_info: EOS token        = 2 '</s>'
0.00.340.850 I print_info: UNK token        = 3 '<unk>'
0.00.340.851 I print_info: SEP token        = 2 '</s>'
0.00.340.851 I print_info: PAD token        = 1 '<pad>'
0.00.340.851 I print_info: MASK token       = 4 '<mask>'
0.00.340.851 I print_info: EOG token        = 2 '</s>'
0.00.340.852 I print_info: max token length = 45
0.00.340.853 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.345.468 I load_tensors:          AMX model buffer size =    18.00 MiB
0.00.345.487 I load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.352.145 I llama_init_from_model: n_seq_max     = 1
0.00.352.162 I llama_init_from_model: n_ctx         = 8192
0.00.352.162 I llama_init_from_model: n_ctx_per_seq = 8192
0.00.352.162 I llama_init_from_model: n_batch       = 2048
0.00.352.163 I llama_init_from_model: n_ubatch      = 2048
0.00.352.163 I llama_init_from_model: flash_attn    = 0
0.00.352.165 I llama_init_from_model: freq_base     = 10000.0
0.00.352.166 I llama_init_from_model: freq_scale    = 1
0.00.352.183 I llama_kv_cache_init: kv_size = 8192, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 4, can_shift = 1
0.00.361.095 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.361.121 I llama_init_from_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.361.129 I llama_init_from_model:        CPU  output buffer size =     0.00 MiB
0.00.363.271 I llama_init_from_model:        CPU compute buffer size =   220.02 MiB
0.00.363.285 I llama_init_from_model: graph nodes  = 154
0.00.363.285 I llama_init_from_model: graph splits = 1
0.00.363.289 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 8192
0.00.363.290 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.371.468 I 
0.00.371.559 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.371.742 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.371.755 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.761 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.371.761 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.371.766 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.371.766 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.375.769 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.383.462 I llama_perf_context_print:        load time =     371.10 ms
0.00.383.464 I llama_perf_context_print: prompt eval time =       7.50 ms /    62 tokens (    0.12 ms per token,  8262.26 tokens per second)
0.00.383.465 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.383.466 I llama_perf_context_print:       total time =      11.99 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.288 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.065.441 I load: token to piece cache size = 0.2984 MB
0.00.065.466 I print_info: arch             = gptneox
0.00.065.467 I print_info: vocab_only       = 0
0.00.065.467 I print_info: n_ctx_train      = 2048
0.00.065.468 I print_info: n_embd           = 2048
0.00.065.468 I print_info: n_layer          = 24
0.00.065.478 I print_info: n_head           = 16
0.00.065.480 I print_info: n_head_kv        = 16
0.00.065.481 I print_info: n_rot            = 32
0.00.065.481 I print_info: n_swa            = 0
...
0.00.065.490 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.065.490 I print_info: f_clamp_kqv      = 0.0e+00
0.00.065.491 I print_info: f_max_alibi_bias = 0.0e+00
0.00.065.492 I print_info: f_logit_scale    = 0.0e+00
0.00.065.493 I print_info: n_ff             = 8192
0.00.065.493 I print_info: n_expert         = 0
0.00.065.494 I print_info: n_expert_used    = 0
0.00.065.494 I print_info: causal attn      = 1
0.00.065.495 I print_info: pooling type     = 0
0.00.065.495 I print_info: rope type        = 2
0.00.065.496 I print_info: rope scaling     = linear
0.00.065.497 I print_info: freq_base_train  = 10000.0
0.00.065.498 I print_info: freq_scale_train = 1
0.00.065.498 I print_info: n_ctx_orig_yarn  = 2048
0.00.065.499 I print_info: rope_finetuned   = unknown
0.00.065.499 I print_info: ssm_d_conv       = 0
0.00.065.499 I print_info: ssm_d_inner      = 0
0.00.065.500 I print_info: ssm_d_state      = 0
0.00.065.500 I print_info: ssm_dt_rank      = 0
0.00.065.500 I print_info: ssm_dt_b_c_rms   = 0
0.00.065.501 I print_info: model type       = 1.4B
0.00.065.502 I print_info: model params     = 1.41 B
0.00.065.503 I print_info: general.name     = 1.4B
0.00.065.505 I print_info: vocab type       = BPE
0.00.065.507 I print_info: n_vocab          = 50304
0.00.065.507 I print_info: n_merges         = 50009
0.00.065.508 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.065.508 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.065.509 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.065.509 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.065.509 I print_info: LF token         = 187 'Ċ'
0.00.065.510 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.065.510 I print_info: max token length = 1024
0.00.065.512 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.208.947 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.208.965 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.018.286 I llama_init_from_model: n_seq_max     = 1
0.01.018.304 I llama_init_from_model: n_ctx         = 2048
0.01.018.304 I llama_init_from_model: n_ctx_per_seq = 2048
0.01.018.304 I llama_init_from_model: n_batch       = 2048
0.01.018.305 I llama_init_from_model: n_ubatch      = 512
0.01.018.305 I llama_init_from_model: flash_attn    = 0
0.01.018.309 I llama_init_from_model: freq_base     = 10000.0
0.01.018.310 I llama_init_from_model: freq_scale    = 1
0.01.018.338 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.088.907 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.088.937 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.088.971 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.092.182 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.01.092.198 I llama_init_from_model: graph nodes  = 967
0.01.092.199 I llama_init_from_model: graph splits = 1
0.01.092.212 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.01.092.571 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.01.092.584 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.197.475 I main: llama threadpool init, n_threads = 4
0.01.197.498 I 
0.01.197.572 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.197.584 I 
0.01.197.714 I sampler seed: 1234
0.01.197.733 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.197.736 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.197.737 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.197.737 I 
...
0.05.217.313 I llama_perf_sampler_print:    sampling time =       2.34 ms /    71 runs   (    0.03 ms per token, 30341.88 tokens per second)
0.05.217.316 I llama_perf_context_print:        load time =    1195.89 ms
0.05.217.317 I llama_perf_context_print: prompt eval time =     106.50 ms /     7 tokens (   15.21 ms per token,    65.73 tokens per second)
0.05.217.318 I llama_perf_context_print:        eval time =    3901.47 ms /    63 runs   (   61.93 ms per token,    16.15 tokens per second)
0.05.217.319 I llama_perf_context_print:       total time =    4020.90 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.395 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.891 I print_info: file type   = all F32 (guessed)
0.00.020.893 I print_info: file size   = 2.64 GiB (16.01 BPW) 
...
0.00.062.987 I print_info: general.name     = 1.4B
...
0.00.195.569 I load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.195.584 I load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.026.619 I llama_init_from_model: n_seq_max     = 1
0.01.026.636 I llama_init_from_model: n_ctx         = 128
0.01.026.636 I llama_init_from_model: n_ctx_per_seq = 128
0.01.026.637 I llama_init_from_model: n_batch       = 128
0.01.026.637 I llama_init_from_model: n_ubatch      = 128
0.01.026.637 I llama_init_from_model: flash_attn    = 0
0.01.026.642 I llama_init_from_model: freq_base     = 10000.0
0.01.026.643 I llama_init_from_model: freq_scale    = 1
0.01.026.644 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.01.026.673 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.01.031.226 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.01.031.255 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.01.031.286 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.01.034.741 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.01.034.759 I llama_init_from_model: graph nodes  = 967
0.01.034.759 I llama_init_from_model: graph splits = 1
0.01.034.763 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.01.034.763 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.112.408 I 
0.01.112.514 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.112.534 I perplexity: tokenizing the input ..
0.01.119.087 I perplexity: tokenization took 6.55 ms
0.01.119.117 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.149.608 I perplexity: 1.03 seconds per pass - ETA 0.02 minutes
[1]10.1485,
0.02.153.215 I Final estimate: PPL = 10.1485 +/- 3.22644

0.02.153.255 I llama_perf_context_print:        load time =    1111.92 ms
0.02.153.258 I llama_perf_context_print: prompt eval time =    1028.55 ms /   128 tokens (    8.04 ms per token,   124.45 tokens per second)
0.02.153.259 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.153.260 I llama_perf_context_print:       total time =    1040.85 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.348 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.170 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
...
0.00.021.176 I print_info: file type   = Q8_0
...
0.00.063.594 I print_info: vocab_only       = 0
0.00.063.594 I print_info: n_ctx_train      = 2048
0.00.063.594 I print_info: n_embd           = 2048
0.00.063.595 I print_info: n_layer          = 24
...
0.00.063.631 I print_info: n_merges         = 50009
...
0.00.063.633 I print_info: max token length = 1024
0.00.063.634 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.149.090 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.149.111 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.310.742 I llama_init_from_model: n_seq_max     = 1
0.00.310.777 I llama_init_from_model: n_ctx         = 2048
0.00.310.784 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.310.790 I llama_init_from_model: n_batch       = 2048
0.00.310.797 I llama_init_from_model: n_ubatch      = 512
0.00.310.804 I llama_init_from_model: flash_attn    = 0
0.00.310.818 I llama_init_from_model: freq_base     = 10000.0
0.00.310.842 I llama_init_from_model: freq_scale    = 1
0.00.310.880 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.383.100 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.383.143 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.383.180 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.386.515 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.386.531 I llama_init_from_model: graph nodes  = 967
0.00.386.532 I llama_init_from_model: graph splits = 1
0.00.386.546 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.386.931 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.386.943 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.468.418 I main: llama threadpool init, n_threads = 4
0.00.468.438 I 
0.00.468.525 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.468.537 I 
0.00.468.652 I sampler seed: 1234
...
0.02.724.894 I llama_perf_sampler_print:    sampling time =       2.39 ms /    71 runs   (    0.03 ms per token, 29756.92 tokens per second)
0.02.724.898 I llama_perf_context_print:        load time =     466.75 ms
0.02.724.900 I llama_perf_context_print: prompt eval time =      49.22 ms /     7 tokens (    7.03 ms per token,   142.21 tokens per second)
0.02.724.901 I llama_perf_context_print:        eval time =    2195.16 ms /    63 runs   (   34.84 ms per token,    28.70 tokens per second)
0.02.724.902 I llama_perf_context_print:       total time =    2257.55 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.334 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.827 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
0.00.020.831 I llama_model_loader: - type  f32:  194 tensors
0.00.020.831 I llama_model_loader: - type q8_0:   98 tensors
0.00.020.833 I print_info: file format = GGUF V3 (latest)
0.00.020.834 I print_info: file type   = Q8_0
0.00.020.836 I print_info: file size   = 1.40 GiB (8.51 BPW) 
...
0.00.063.591 I print_info: n_embd_k_gqa     = 2048
...
0.00.063.608 I print_info: BOS token        = 0 '<|endoftext|>'
...
0.00.150.278 I load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.150.301 I load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.307.567 I llama_init_from_model: n_seq_max     = 1
0.00.307.585 I llama_init_from_model: n_ctx         = 128
0.00.307.585 I llama_init_from_model: n_ctx_per_seq = 128
0.00.307.586 I llama_init_from_model: n_batch       = 128
0.00.307.586 I llama_init_from_model: n_ubatch      = 128
0.00.307.587 I llama_init_from_model: flash_attn    = 0
0.00.307.592 I llama_init_from_model: freq_base     = 10000.0
0.00.307.593 I llama_init_from_model: freq_scale    = 1
0.00.307.594 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.307.622 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.312.393 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.312.424 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.312.455 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.315.774 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.315.790 I llama_init_from_model: graph nodes  = 967
0.00.315.791 I llama_init_from_model: graph splits = 1
0.00.315.798 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.315.798 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.371.327 I 
0.00.371.446 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.371.474 I perplexity: tokenizing the input ..
0.00.378.108 I perplexity: tokenization took 6.637 ms
0.00.378.139 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.776.279 I perplexity: 0.40 seconds per pass - ETA 0.00 minutes
[1]10.1611,
0.00.780.126 I Final estimate: PPL = 10.1611 +/- 3.23215

0.00.780.168 I llama_perf_context_print:        load time =     370.95 ms
0.00.780.182 I llama_perf_context_print: prompt eval time =     396.19 ms /   128 tokens (    3.10 ms per token,   323.08 tokens per second)
0.00.780.184 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.780.185 I llama_perf_context_print:       total time =     408.84 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.327 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.809 I llama_model_loader: - type q4_0:   97 tensors
0.00.020.810 I llama_model_loader: - type q6_K:    1 tensors
0.00.020.812 I print_info: file format = GGUF V3 (latest)
0.00.020.813 I print_info: file type   = Q4_0
0.00.020.816 I print_info: file size   = 786.31 MiB (4.66 BPW) 
...
0.00.063.683 I print_info: f_norm_eps       = 1.0e-05
...
0.00.063.686 I print_info: n_expert_used    = 0
...
0.00.063.693 I print_info: model type       = 1.4B
0.00.063.693 I print_info: model params     = 1.41 B
0.00.063.694 I print_info: general.name     = 1.4B
0.00.063.696 I print_info: vocab type       = BPE
0.00.063.697 I print_info: n_vocab          = 50304
0.00.063.697 I print_info: n_merges         = 50009
0.00.063.698 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.063.698 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.063.698 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.063.699 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.063.699 I print_info: LF token         = 187 'Ċ'
...
0.00.114.283 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.114.297 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.227.723 I llama_init_from_model: n_seq_max     = 1
0.00.227.760 I llama_init_from_model: n_ctx         = 2048
0.00.227.767 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.227.774 I llama_init_from_model: n_batch       = 2048
0.00.227.781 I llama_init_from_model: n_ubatch      = 512
0.00.227.788 I llama_init_from_model: flash_attn    = 0
0.00.227.801 I llama_init_from_model: freq_base     = 10000.0
0.00.227.809 I llama_init_from_model: freq_scale    = 1
0.00.227.846 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.300.008 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.300.059 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.300.099 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.303.434 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.303.469 I llama_init_from_model: graph nodes  = 967
0.00.303.475 I llama_init_from_model: graph splits = 1
0.00.303.495 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.303.901 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.303.920 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.380.192 I main: llama threadpool init, n_threads = 4
0.00.380.216 I 
0.00.380.290 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.380.290 I 
0.00.380.393 I sampler seed: 1234
0.00.380.403 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.380.412 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.380.413 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.380.414 I 
I believe the meaning of life is to know and experience what you love and to do it." "If you love something, set it free." "You might just find something you didn't know you wanted." "I've always wanted to know the truth." "Now I have." "So I'm gonna get to the truth." "I'm gonna

0.01.881.216 I llama_perf_sampler_print:    sampling time =       2.83 ms /    71 runs   (    0.04 ms per token, 25106.08 tokens per second)
0.01.881.220 I llama_perf_context_print:        load time =     378.54 ms
0.01.881.221 I llama_perf_context_print: prompt eval time =      42.87 ms /     7 tokens (    6.12 ms per token,   163.30 tokens per second)
0.01.881.222 I llama_perf_context_print:        eval time =    1445.48 ms /    63 runs   (   22.94 ms per token,    43.58 tokens per second)
0.01.881.223 I llama_perf_context_print:       total time =    1502.13 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.368 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.089 I llama_model_loader: - type q4_0:   97 tensors
...
0.00.021.095 I print_info: file size   = 786.31 MiB (4.66 BPW) 
0.00.051.911 I load: special tokens cache size = 25
0.00.063.633 I load: token to piece cache size = 0.2984 MB
0.00.063.657 I print_info: arch             = gptneox
...
0.00.113.943 I load_tensors:          AMX model buffer size =   728.60 MiB
0.00.113.964 I load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.225.717 I llama_init_from_model: n_seq_max     = 1
0.00.225.735 I llama_init_from_model: n_ctx         = 128
0.00.225.735 I llama_init_from_model: n_ctx_per_seq = 128
0.00.225.736 I llama_init_from_model: n_batch       = 128
0.00.225.736 I llama_init_from_model: n_ubatch      = 128
0.00.225.737 I llama_init_from_model: flash_attn    = 0
0.00.225.742 I llama_init_from_model: freq_base     = 10000.0
0.00.225.743 I llama_init_from_model: freq_scale    = 1
0.00.225.744 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.225.773 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.230.153 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.230.182 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.230.210 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.233.618 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.233.635 I llama_init_from_model: graph nodes  = 967
0.00.233.635 I llama_init_from_model: graph splits = 1
0.00.233.640 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.233.640 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.279.824 I 
0.00.279.936 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.279.964 I perplexity: tokenizing the input ..
0.00.286.552 I perplexity: tokenization took 6.591 ms
0.00.286.581 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.726.030 I perplexity: 0.44 seconds per pass - ETA 0.00 minutes
[1]14.1117,
0.00.729.748 I Final estimate: PPL = 14.1117 +/- 4.42919

0.00.729.792 I llama_perf_context_print:        load time =     279.41 ms
0.00.729.820 I llama_perf_context_print: prompt eval time =     437.60 ms /   128 tokens (    3.42 ms per token,   292.51 tokens per second)
0.00.729.845 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.729.859 I llama_perf_context_print:       total time =     449.97 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.274 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.062.986 I print_info: arch             = gptneox
0.00.062.986 I print_info: vocab_only       = 0
0.00.062.987 I print_info: n_ctx_train      = 2048
0.00.062.987 I print_info: n_embd           = 2048
0.00.062.987 I print_info: n_layer          = 24
...
0.00.063.009 I print_info: n_expert         = 0
0.00.063.009 I print_info: n_expert_used    = 0
0.00.063.009 I print_info: causal attn      = 1
0.00.063.010 I print_info: pooling type     = 0
0.00.063.010 I print_info: rope type        = 2
0.00.063.010 I print_info: rope scaling     = linear
0.00.063.012 I print_info: freq_base_train  = 10000.0
0.00.063.012 I print_info: freq_scale_train = 1
0.00.063.013 I print_info: n_ctx_orig_yarn  = 2048
0.00.063.013 I print_info: rope_finetuned   = unknown
0.00.063.013 I print_info: ssm_d_conv       = 0
0.00.063.014 I print_info: ssm_d_inner      = 0
0.00.063.014 I print_info: ssm_d_state      = 0
0.00.063.014 I print_info: ssm_dt_rank      = 0
0.00.063.014 I print_info: ssm_dt_b_c_rms   = 0
0.00.063.015 I print_info: model type       = 1.4B
0.00.063.016 I print_info: model params     = 1.41 B
0.00.063.016 I print_info: general.name     = 1.4B
...
0.00.063.021 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.063.022 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.063.022 I print_info: LF token         = 187 'Ċ'
0.00.063.022 I print_info: EOG token        = 0 '<|endoftext|>'
...
0.00.115.874 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.115.894 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.246.852 I llama_init_from_model: n_seq_max     = 1
0.00.246.887 I llama_init_from_model: n_ctx         = 2048
0.00.246.894 I llama_init_from_model: n_ctx_per_seq = 2048
...
0.00.246.926 I llama_init_from_model: freq_base     = 10000.0
0.00.246.928 I llama_init_from_model: freq_scale    = 1
0.00.246.964 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.322.084 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.322.119 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.322.155 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.325.534 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.325.550 I llama_init_from_model: graph nodes  = 967
0.00.325.551 I llama_init_from_model: graph splits = 1
0.00.325.563 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.325.963 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.325.975 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.407.486 I main: llama threadpool init, n_threads = 4
0.00.407.507 I 
0.00.407.585 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.407.599 I 
0.00.407.716 I sampler seed: 1234
0.00.407.735 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.407.738 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.407.739 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.407.739 I 
...
0.02.025.838 I llama_perf_sampler_print:    sampling time =       2.34 ms /    71 runs   (    0.03 ms per token, 30367.84 tokens per second)
0.02.025.841 I llama_perf_context_print:        load time =     405.82 ms
0.02.025.842 I llama_perf_context_print: prompt eval time =      41.34 ms /     7 tokens (    5.91 ms per token,   169.32 tokens per second)
0.02.025.843 I llama_perf_context_print:        eval time =    1565.21 ms /    63 runs   (   24.84 ms per token,    40.25 tokens per second)
0.02.025.844 I llama_perf_context_print:       total time =    1619.47 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.328 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.403 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.020.790 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.020.793 I llama_model_loader: - type  f32:  194 tensors
0.00.020.793 I llama_model_loader: - type q4_1:   97 tensors
0.00.020.794 I llama_model_loader: - type q6_K:    1 tensors
0.00.020.795 I print_info: file format = GGUF V3 (latest)
0.00.020.796 I print_info: file type   = Q4_1
0.00.020.798 I print_info: file size   = 864.46 MiB (5.13 BPW) 
0.00.051.389 I load: special tokens cache size = 25
0.00.063.126 I load: token to piece cache size = 0.2984 MB
0.00.063.152 I print_info: arch             = gptneox
0.00.063.152 I print_info: vocab_only       = 0
0.00.063.152 I print_info: n_ctx_train      = 2048
0.00.063.153 I print_info: n_embd           = 2048
0.00.063.153 I print_info: n_layer          = 24
0.00.063.162 I print_info: n_head           = 16
0.00.063.163 I print_info: n_head_kv        = 16
0.00.063.164 I print_info: n_rot            = 32
0.00.063.164 I print_info: n_swa            = 0
0.00.063.164 I print_info: n_embd_head_k    = 128
0.00.063.164 I print_info: n_embd_head_v    = 128
0.00.063.166 I print_info: n_gqa            = 1
0.00.063.168 I print_info: n_embd_k_gqa     = 2048
0.00.063.169 I print_info: n_embd_v_gqa     = 2048
0.00.063.170 I print_info: f_norm_eps       = 1.0e-05
0.00.063.171 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.063.171 I print_info: f_clamp_kqv      = 0.0e+00
0.00.063.171 I print_info: f_max_alibi_bias = 0.0e+00
0.00.063.171 I print_info: f_logit_scale    = 0.0e+00
0.00.063.172 I print_info: n_ff             = 8192
0.00.063.173 I print_info: n_expert         = 0
0.00.063.173 I print_info: n_expert_used    = 0
0.00.063.173 I print_info: causal attn      = 1
0.00.063.173 I print_info: pooling type     = 0
0.00.063.174 I print_info: rope type        = 2
0.00.063.174 I print_info: rope scaling     = linear
0.00.063.175 I print_info: freq_base_train  = 10000.0
0.00.063.176 I print_info: freq_scale_train = 1
0.00.063.176 I print_info: n_ctx_orig_yarn  = 2048
0.00.063.176 I print_info: rope_finetuned   = unknown
...
0.00.063.184 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.063.184 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.063.184 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.063.185 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.063.185 I print_info: LF token         = 187 'Ċ'
0.00.063.185 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.063.186 I print_info: max token length = 1024
0.00.063.186 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.116.166 I load_tensors:          AMX model buffer size =   800.60 MiB
0.00.116.187 I load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.247.103 I llama_init_from_model: n_seq_max     = 1
0.00.247.121 I llama_init_from_model: n_ctx         = 128
0.00.247.122 I llama_init_from_model: n_ctx_per_seq = 128
0.00.247.122 I llama_init_from_model: n_batch       = 128
0.00.247.122 I llama_init_from_model: n_ubatch      = 128
0.00.247.123 I llama_init_from_model: flash_attn    = 0
0.00.247.127 I llama_init_from_model: freq_base     = 10000.0
0.00.247.128 I llama_init_from_model: freq_scale    = 1
0.00.247.129 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.247.156 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.251.676 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.251.699 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.251.731 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.255.025 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.255.041 I llama_init_from_model: graph nodes  = 967
0.00.255.041 I llama_init_from_model: graph splits = 1
0.00.255.046 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.255.046 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.299.383 I 
0.00.299.490 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.299.514 I perplexity: tokenizing the input ..
0.00.306.089 I perplexity: tokenization took 6.575 ms
0.00.306.119 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.756.182 I perplexity: 0.45 seconds per pass - ETA 0.00 minutes
[1]12.6944,
0.00.760.037 I Final estimate: PPL = 12.6944 +/- 3.90928

0.00.760.079 I llama_perf_context_print:        load time =     299.01 ms
0.00.760.093 I llama_perf_context_print: prompt eval time =     448.19 ms /   128 tokens (    3.50 ms per token,   285.59 tokens per second)
0.00.760.095 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.760.095 I llama_perf_context_print:       total time =     460.70 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.267 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.094 I print_info: file type   = Q5_0
...
0.00.112.776 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.112.790 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.125.880 I llama_init_from_model: n_seq_max     = 1
0.00.125.900 I llama_init_from_model: n_ctx         = 2048
0.00.125.900 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.125.901 I llama_init_from_model: n_batch       = 2048
0.00.125.901 I llama_init_from_model: n_ubatch      = 512
0.00.125.901 I llama_init_from_model: flash_attn    = 0
0.00.125.904 I llama_init_from_model: freq_base     = 10000.0
0.00.125.905 I llama_init_from_model: freq_scale    = 1
0.00.125.924 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.198.863 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.198.892 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.198.925 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.202.319 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.202.341 I llama_init_from_model: graph nodes  = 967
0.00.202.341 I llama_init_from_model: graph splits = 1
0.00.202.352 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.202.808 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.202.820 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.312.720 I main: llama threadpool init, n_threads = 4
0.00.312.742 I 
0.00.312.812 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.312.824 I 
0.00.312.913 I sampler seed: 1234
0.00.312.933 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.312.936 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.312.937 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.312.937 I 
...
0.02.790.139 I llama_perf_sampler_print:    sampling time =       2.48 ms /    71 runs   (    0.03 ms per token, 28571.43 tokens per second)
0.02.790.142 I llama_perf_context_print:        load time =     311.12 ms
0.02.790.143 I llama_perf_context_print: prompt eval time =     108.11 ms /     7 tokens (   15.44 ms per token,    64.75 tokens per second)
0.02.790.144 I llama_perf_context_print:        eval time =    2356.88 ms /    63 runs   (   37.41 ms per token,    26.73 tokens per second)
0.02.790.145 I llama_perf_context_print:       total time =    2478.49 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.355 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.367 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.020.753 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.020.756 I llama_model_loader: - type  f32:  194 tensors
0.00.020.756 I llama_model_loader: - type q5_0:   97 tensors
0.00.020.757 I llama_model_loader: - type q6_K:    1 tensors
0.00.020.759 I print_info: file format = GGUF V3 (latest)
0.00.020.759 I print_info: file type   = Q5_0
0.00.020.762 I print_info: file size   = 942.60 MiB (5.59 BPW) 
0.00.051.008 I load: special tokens cache size = 25
0.00.062.895 I load: token to piece cache size = 0.2984 MB
0.00.062.920 I print_info: arch             = gptneox
0.00.062.921 I print_info: vocab_only       = 0
0.00.062.921 I print_info: n_ctx_train      = 2048
0.00.062.921 I print_info: n_embd           = 2048
0.00.062.922 I print_info: n_layer          = 24
...
0.00.062.971 I print_info: n_expert_used    = 0
...
0.00.112.194 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.112.209 I load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.125.184 I llama_init_from_model: n_seq_max     = 1
0.00.125.200 I llama_init_from_model: n_ctx         = 128
0.00.125.200 I llama_init_from_model: n_ctx_per_seq = 128
0.00.125.201 I llama_init_from_model: n_batch       = 128
0.00.125.201 I llama_init_from_model: n_ubatch      = 128
0.00.125.201 I llama_init_from_model: flash_attn    = 0
0.00.125.204 I llama_init_from_model: freq_base     = 10000.0
0.00.125.205 I llama_init_from_model: freq_scale    = 1
0.00.125.205 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.125.225 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.129.893 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.129.921 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.129.981 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.133.233 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
...
0.00.177.680 I 
0.00.177.783 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.177.803 I perplexity: tokenizing the input ..
0.00.183.850 I perplexity: tokenization took 6.043 ms
0.00.183.877 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.314.335 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0822,
0.01.317.902 I Final estimate: PPL = 10.0822 +/- 3.20340

0.01.317.985 I llama_perf_context_print:        load time =     177.27 ms
0.01.317.987 I llama_perf_context_print: prompt eval time =    1128.62 ms /   128 tokens (    8.82 ms per token,   113.41 tokens per second)
0.01.317.990 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.318.005 I llama_perf_context_print:       total time =    1140.30 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.279 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.215 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
...
0.00.021.222 I print_info: file type   = Q5_1
0.00.021.225 I print_info: file size   = 1020.74 MiB (6.05 BPW) 
0.00.052.285 I load: special tokens cache size = 25
0.00.063.961 I load: token to piece cache size = 0.2984 MB
...
0.00.064.005 I print_info: n_rot            = 32
0.00.064.005 I print_info: n_swa            = 0
0.00.064.005 I print_info: n_embd_head_k    = 128
0.00.064.006 I print_info: n_embd_head_v    = 128
...
0.00.064.030 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.115.216 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.115.231 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.134.369 I llama_init_from_model: n_seq_max     = 1
0.00.134.386 I llama_init_from_model: n_ctx         = 2048
0.00.134.386 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.134.387 I llama_init_from_model: n_batch       = 2048
0.00.134.387 I llama_init_from_model: n_ubatch      = 512
0.00.134.388 I llama_init_from_model: flash_attn    = 0
0.00.134.392 I llama_init_from_model: freq_base     = 10000.0
0.00.134.393 I llama_init_from_model: freq_scale    = 1
0.00.134.415 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.205.851 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.205.881 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.205.952 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.209.139 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.209.155 I llama_init_from_model: graph nodes  = 967
0.00.209.156 I llama_init_from_model: graph splits = 1
0.00.209.167 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.209.548 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.209.560 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.308.219 I main: llama threadpool init, n_threads = 4
0.00.308.239 I 
0.00.308.320 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.308.332 I 
0.00.308.439 I sampler seed: 1234
0.00.308.460 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
...
0.02.957.107 I llama_perf_sampler_print:    sampling time =       2.47 ms /    71 runs   (    0.03 ms per token, 28768.23 tokens per second)
0.02.957.111 I llama_perf_context_print:        load time =     306.65 ms
0.02.957.112 I llama_perf_context_print: prompt eval time =     134.68 ms /     7 tokens (   19.24 ms per token,    51.98 tokens per second)
0.02.957.114 I llama_perf_context_print:        eval time =    2501.82 ms /    63 runs   (   39.71 ms per token,    25.18 tokens per second)
0.02.957.115 I llama_perf_context_print:       total time =    2649.95 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.384 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.063.737 I print_info: n_swa            = 0
...
0.00.114.363 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.114.378 I load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.127.051 I llama_init_from_model: n_seq_max     = 1
0.00.127.069 I llama_init_from_model: n_ctx         = 128
0.00.127.070 I llama_init_from_model: n_ctx_per_seq = 128
0.00.127.070 I llama_init_from_model: n_batch       = 128
0.00.127.070 I llama_init_from_model: n_ubatch      = 128
0.00.127.071 I llama_init_from_model: flash_attn    = 0
0.00.127.073 I llama_init_from_model: freq_base     = 10000.0
0.00.127.074 I llama_init_from_model: freq_scale    = 1
0.00.127.075 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.127.096 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.131.896 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.131.925 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.131.952 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.135.149 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.135.172 I llama_init_from_model: graph nodes  = 967
0.00.135.172 I llama_init_from_model: graph splits = 1
0.00.135.177 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.135.177 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.202.459 I 
0.00.202.577 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.202.607 I perplexity: tokenizing the input ..
0.00.208.939 I perplexity: tokenization took 6.334 ms
0.00.208.967 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.177.751 I perplexity: 1.97 seconds per pass - ETA 0.02 minutes
[1]10.1864,
0.02.181.416 I Final estimate: PPL = 10.1864 +/- 3.18686

0.02.181.459 I llama_perf_context_print:        load time =     202.03 ms
0.02.181.477 I llama_perf_context_print: prompt eval time =    1966.89 ms /   128 tokens (   15.37 ms per token,    65.08 tokens per second)
0.02.181.492 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.181.493 I llama_perf_context_print:       total time =    1979.00 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.342 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.035 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.035 I llama_model_loader: - type q3_K:   48 tensors
0.00.021.036 I llama_model_loader: - type q6_K:    1 tensors
0.00.021.038 I print_info: file format = GGUF V3 (latest)
0.00.021.038 I print_info: file type   = Q2_K - Medium
...
0.00.064.070 I print_info: n_head_kv        = 16
...
0.00.064.081 I print_info: rope type        = 2
...
0.00.064.090 I print_info: n_merges         = 50009
0.00.064.091 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.064.091 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.064.091 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.064.091 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.064.092 I print_info: LF token         = 187 'Ċ'
0.00.064.092 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.064.092 I print_info: max token length = 1024
0.00.064.093 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.092.267 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.092.281 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.104.758 I llama_init_from_model: n_seq_max     = 1
0.00.104.774 I llama_init_from_model: n_ctx         = 2048
0.00.104.774 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.104.774 I llama_init_from_model: n_batch       = 2048
0.00.104.774 I llama_init_from_model: n_ubatch      = 512
0.00.104.775 I llama_init_from_model: flash_attn    = 0
0.00.104.778 I llama_init_from_model: freq_base     = 10000.0
0.00.104.778 I llama_init_from_model: freq_scale    = 1
0.00.104.800 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.179.524 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.179.553 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.179.584 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.182.973 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.182.992 I llama_init_from_model: graph nodes  = 967
0.00.182.992 I llama_init_from_model: graph splits = 1
0.00.183.005 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.183.428 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.183.441 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.266.728 I main: llama threadpool init, n_threads = 4
0.00.266.749 I 
0.00.266.836 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.266.837 I 
0.00.266.949 I sampler seed: 1234
0.00.266.969 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.266.973 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.266.974 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.266.974 I 
...
0.01.827.133 I llama_perf_sampler_print:    sampling time =       2.32 ms /    71 runs   (    0.03 ms per token, 30590.26 tokens per second)
0.01.827.137 I llama_perf_context_print:        load time =     265.05 ms
0.01.827.139 I llama_perf_context_print: prompt eval time =      81.27 ms /     7 tokens (   11.61 ms per token,    86.13 tokens per second)
0.01.827.141 I llama_perf_context_print:        eval time =    1467.39 ms /    63 runs   (   23.29 ms per token,    42.93 tokens per second)
0.01.827.142 I llama_perf_context_print:       total time =    1561.51 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.323 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.480 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.020.958 I print_info: file size   = 542.04 MiB (3.21 BPW) 
...
0.00.091.692 I load_tensors:          AMX model buffer size =    80.60 MiB
0.00.091.708 I load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.104.150 I llama_init_from_model: n_seq_max     = 1
0.00.104.167 I llama_init_from_model: n_ctx         = 128
0.00.104.168 I llama_init_from_model: n_ctx_per_seq = 128
0.00.104.168 I llama_init_from_model: n_batch       = 128
0.00.104.169 I llama_init_from_model: n_ubatch      = 128
0.00.104.169 I llama_init_from_model: flash_attn    = 0
0.00.104.173 I llama_init_from_model: freq_base     = 10000.0
0.00.104.174 I llama_init_from_model: freq_scale    = 1
0.00.104.175 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.104.198 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.108.975 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.109.005 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.109.028 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.112.286 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.112.309 I llama_init_from_model: graph nodes  = 967
0.00.112.309 I llama_init_from_model: graph splits = 1
0.00.112.315 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.112.315 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.151.777 I 
0.00.151.892 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.151.927 I perplexity: tokenizing the input ..
0.00.158.299 I perplexity: tokenization took 6.368 ms
0.00.158.330 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.449.723 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.7471,
0.01.453.513 I Final estimate: PPL = 70.7471 +/- 27.47559

0.01.453.559 I llama_perf_context_print:        load time =     151.37 ms
0.01.453.574 I llama_perf_context_print: prompt eval time =    1289.53 ms /   128 tokens (   10.07 ms per token,    99.26 tokens per second)
0.01.453.600 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.453.601 I llama_perf_context_print:       total time =    1301.78 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.308 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.064.168 I print_info: f_norm_eps       = 1.0e-05
...
0.00.064.175 I print_info: ssm_d_conv       = 0
...
0.00.064.186 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.064.186 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.064.186 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.064.187 I print_info: LF token         = 187 'Ċ'
0.00.064.187 I print_info: EOG token        = 0 '<|endoftext|>'
0.00.064.200 I print_info: max token length = 1024
0.00.064.201 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.101.400 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.101.422 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.183.368 I llama_init_from_model: n_seq_max     = 1
0.00.183.387 I llama_init_from_model: n_ctx         = 2048
0.00.183.387 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.183.388 I llama_init_from_model: n_batch       = 2048
0.00.183.388 I llama_init_from_model: n_ubatch      = 512
0.00.183.389 I llama_init_from_model: flash_attn    = 0
0.00.183.395 I llama_init_from_model: freq_base     = 10000.0
0.00.183.397 I llama_init_from_model: freq_scale    = 1
0.00.183.429 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.255.721 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.255.753 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.255.791 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.259.111 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.259.128 I llama_init_from_model: graph nodes  = 967
0.00.259.128 I llama_init_from_model: graph splits = 1
0.00.259.143 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.259.530 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.259.542 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.340.397 I main: llama threadpool init, n_threads = 4
0.00.340.420 I 
0.00.340.508 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.340.531 I 
0.00.340.682 I sampler seed: 1234
0.00.340.705 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.340.709 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.340.710 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.340.711 I 
...
0.02.149.373 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30882.99 tokens per second)
0.02.149.376 I llama_perf_context_print:        load time =     338.76 ms
0.02.149.378 I llama_perf_context_print: prompt eval time =      75.28 ms /     7 tokens (   10.75 ms per token,    92.99 tokens per second)
0.02.149.380 I llama_perf_context_print:        eval time =    1721.55 ms /    63 runs   (   27.33 ms per token,    36.60 tokens per second)
0.02.149.380 I llama_perf_context_print:       total time =    1810.05 ms /    70 tokens
...
0.00.020.945 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.020.947 I llama_model_loader: - type  f32:  194 tensors
0.00.020.948 I llama_model_loader: - type q3_K:   25 tensors
0.00.020.948 I llama_model_loader: - type q4_K:   71 tensors
0.00.020.949 I llama_model_loader: - type q5_K:    1 tensors
0.00.020.949 I llama_model_loader: - type q6_K:    1 tensors
0.00.020.951 I print_info: file format = GGUF V3 (latest)
0.00.020.951 I print_info: file type   = Q3_K - Medium
0.00.020.954 I print_info: file size   = 724.27 MiB (4.29 BPW) 
0.00.051.503 I load: special tokens cache size = 25
0.00.063.107 I load: token to piece cache size = 0.2984 MB
...
0.00.063.134 I print_info: n_layer          = 24
...
0.00.063.152 I print_info: f_norm_eps       = 1.0e-05
0.00.063.152 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.063.152 I print_info: f_clamp_kqv      = 0.0e+00
0.00.063.153 I print_info: f_max_alibi_bias = 0.0e+00
0.00.063.153 I print_info: f_logit_scale    = 0.0e+00
0.00.063.154 I print_info: n_ff             = 8192
...
0.00.063.158 I print_info: freq_scale_train = 1
0.00.063.158 I print_info: n_ctx_orig_yarn  = 2048
0.00.063.158 I print_info: rope_finetuned   = unknown
0.00.063.159 I print_info: ssm_d_conv       = 0
0.00.063.159 I print_info: ssm_d_inner      = 0
...
0.00.063.166 I print_info: BOS token        = 0 '<|endoftext|>'
...
0.00.063.168 I print_info: max token length = 1024
0.00.063.169 I load_tensors: loading model tensors, this can take a while... (mmap = true)
0.00.100.352 I load_tensors:          AMX model buffer size =   526.60 MiB
0.00.100.374 I load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.182.026 I llama_init_from_model: n_seq_max     = 1
0.00.182.040 I llama_init_from_model: n_ctx         = 128
0.00.182.041 I llama_init_from_model: n_ctx_per_seq = 128
0.00.182.041 I llama_init_from_model: n_batch       = 128
0.00.182.042 I llama_init_from_model: n_ubatch      = 128
0.00.182.043 I llama_init_from_model: flash_attn    = 0
0.00.182.049 I llama_init_from_model: freq_base     = 10000.0
0.00.182.051 I llama_init_from_model: freq_scale    = 1
0.00.182.052 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.182.083 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.186.549 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.186.580 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.186.614 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.189.962 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.189.976 I llama_init_from_model: graph nodes  = 967
0.00.189.977 I llama_init_from_model: graph splits = 1
0.00.189.982 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.189.983 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.235.722 I 
0.00.235.860 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.235.883 I perplexity: tokenizing the input ..
0.00.242.422 I perplexity: tokenization took 6.536 ms
0.00.242.456 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.139.839 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]12.3725,
0.01.143.518 I Final estimate: PPL = 12.3725 +/- 4.01345

0.01.143.558 I llama_perf_context_print:        load time =     235.35 ms
0.01.143.559 I llama_perf_context_print: prompt eval time =     895.44 ms /   128 tokens (    7.00 ms per token,   142.95 tokens per second)
0.01.143.560 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.143.561 I llama_perf_context_print:       total time =     907.84 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.362 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.560 I main: llama backend init
0.00.000.576 I main: load the model and apply lora adapter, if any
0.00.010.947 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf (version GGUF V3 (latest))
...
0.00.021.548 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
0.00.021.550 I llama_model_loader: - type  f32:  194 tensors
0.00.021.551 I llama_model_loader: - type q4_K:   61 tensors
0.00.021.551 I llama_model_loader: - type q5_K:   24 tensors
0.00.021.551 I llama_model_loader: - type q6_K:   13 tensors
0.00.021.553 I print_info: file format = GGUF V3 (latest)
0.00.021.554 I print_info: file type   = Q4_K - Medium
0.00.021.557 I print_info: file size   = 871.81 MiB (5.17 BPW) 
...
0.00.104.932 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.104.954 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.226.870 I llama_init_from_model: n_seq_max     = 1
0.00.226.886 I llama_init_from_model: n_ctx         = 2048
0.00.226.886 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.226.887 I llama_init_from_model: n_batch       = 2048
0.00.226.887 I llama_init_from_model: n_ubatch      = 512
0.00.226.888 I llama_init_from_model: flash_attn    = 0
0.00.226.896 I llama_init_from_model: freq_base     = 10000.0
0.00.226.897 I llama_init_from_model: freq_scale    = 1
0.00.226.927 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.300.126 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.300.153 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.300.192 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.303.466 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.303.483 I llama_init_from_model: graph nodes  = 967
0.00.303.483 I llama_init_from_model: graph splits = 1
0.00.303.497 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.303.881 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.303.893 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.396.318 I main: llama threadpool init, n_threads = 4
0.00.396.340 I 
0.00.396.428 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.396.455 I 
0.00.396.573 I sampler seed: 1234
0.00.396.595 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.396.600 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.396.602 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.396.602 I 
...
0.02.508.726 I llama_perf_sampler_print:    sampling time =       2.45 ms /    71 runs   (    0.03 ms per token, 28967.77 tokens per second)
0.02.508.730 I llama_perf_context_print:        load time =     394.66 ms
0.02.508.732 I llama_perf_context_print: prompt eval time =      66.02 ms /     7 tokens (    9.43 ms per token,   106.02 tokens per second)
0.02.508.733 I llama_perf_context_print:        eval time =    2033.94 ms /    63 runs   (   32.28 ms per token,    30.97 tokens per second)
0.02.508.734 I llama_perf_context_print:       total time =    2113.48 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.329 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.884 I print_info: file type   = Q4_K - Medium
0.00.020.886 I print_info: file size   = 871.81 MiB (5.17 BPW) 
...
0.00.104.286 I load_tensors:          AMX model buffer size =   829.10 MiB
0.00.104.308 I load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.225.235 I llama_init_from_model: n_seq_max     = 1
0.00.225.254 I llama_init_from_model: n_ctx         = 128
0.00.225.255 I llama_init_from_model: n_ctx_per_seq = 128
0.00.225.255 I llama_init_from_model: n_batch       = 128
0.00.225.255 I llama_init_from_model: n_ubatch      = 128
0.00.225.256 I llama_init_from_model: flash_attn    = 0
0.00.225.261 I llama_init_from_model: freq_base     = 10000.0
0.00.225.262 I llama_init_from_model: freq_scale    = 1
0.00.225.263 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.225.291 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.229.992 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.230.022 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.230.051 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.233.539 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.233.554 I llama_init_from_model: graph nodes  = 967
0.00.233.554 I llama_init_from_model: graph splits = 1
0.00.233.558 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.233.559 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.294.678 I 
0.00.294.797 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.294.820 I perplexity: tokenizing the input ..
0.00.301.429 I perplexity: tokenization took 6.605 ms
0.00.301.459 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.873.241 I perplexity: 0.57 seconds per pass - ETA 0.00 minutes
[1]10.3355,
0.00.876.980 I Final estimate: PPL = 10.3355 +/- 3.28881

0.00.877.025 I llama_perf_context_print:        load time =     294.25 ms
0.00.877.027 I llama_perf_context_print: prompt eval time =     569.94 ms /   128 tokens (    4.45 ms per token,   224.59 tokens per second)
0.00.877.028 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.877.029 I llama_perf_context_print:       total time =     582.35 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.280 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.518 I main: llama backend init
0.00.000.535 I main: load the model and apply lora adapter, if any
0.00.010.667 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf (version GGUF V3 (latest))
...
0.00.021.088 I llama_model_loader: - type q5_K:   61 tensors
0.00.021.088 I llama_model_loader: - type q6_K:   37 tensors
0.00.021.090 I print_info: file format = GGUF V3 (latest)
0.00.021.090 I print_info: file type   = Q5_K - Medium
0.00.021.094 I print_info: file size   = 1006.35 MiB (5.97 BPW) 
...
0.00.063.632 I print_info: n_head           = 16
0.00.063.634 I print_info: n_head_kv        = 16
0.00.063.634 I print_info: n_rot            = 32
0.00.063.634 I print_info: n_swa            = 0
0.00.063.635 I print_info: n_embd_head_k    = 128
0.00.063.635 I print_info: n_embd_head_v    = 128
...
0.00.063.649 I print_info: ssm_dt_b_c_rms   = 0
...
0.00.109.363 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.109.437 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.242.302 I llama_init_from_model: n_seq_max     = 1
0.00.242.320 I llama_init_from_model: n_ctx         = 2048
0.00.242.321 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.242.321 I llama_init_from_model: n_batch       = 2048
0.00.242.322 I llama_init_from_model: n_ubatch      = 512
0.00.242.323 I llama_init_from_model: flash_attn    = 0
0.00.242.329 I llama_init_from_model: freq_base     = 10000.0
0.00.242.331 I llama_init_from_model: freq_scale    = 1
0.00.242.362 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.313.957 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.313.990 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.314.028 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.317.348 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.317.369 I llama_init_from_model: graph nodes  = 967
0.00.317.370 I llama_init_from_model: graph splits = 1
0.00.317.422 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.317.796 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.317.808 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.420.453 I main: llama threadpool init, n_threads = 4
0.00.420.474 I 
0.00.420.564 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.420.576 I 
0.00.420.688 I sampler seed: 1234
0.00.420.709 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.420.713 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.420.714 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.420.714 I 
...
0.03.001.474 I llama_perf_sampler_print:    sampling time =       2.30 ms /    71 runs   (    0.03 ms per token, 30829.35 tokens per second)
0.03.001.478 I llama_perf_context_print:        load time =     418.79 ms
0.03.001.480 I llama_perf_context_print: prompt eval time =      88.88 ms /     7 tokens (   12.70 ms per token,    78.76 tokens per second)
0.03.001.482 I llama_perf_context_print:        eval time =    2480.22 ms /    63 runs   (   39.37 ms per token,    25.40 tokens per second)
0.03.001.483 I llama_perf_context_print:       total time =    2582.13 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.391 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.790 I print_info: file type   = Q5_K - Medium
0.00.020.793 I print_info: file size   = 1006.35 MiB (5.97 BPW) 
0.00.051.545 I load: special tokens cache size = 25
...
0.00.063.241 I print_info: n_ctx_train      = 2048
...
0.00.108.458 I load_tensors:          AMX model buffer size =   946.85 MiB
0.00.108.479 I load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.240.336 I llama_init_from_model: n_seq_max     = 1
0.00.240.352 I llama_init_from_model: n_ctx         = 128
0.00.240.353 I llama_init_from_model: n_ctx_per_seq = 128
0.00.240.353 I llama_init_from_model: n_batch       = 128
0.00.240.354 I llama_init_from_model: n_ubatch      = 128
0.00.240.355 I llama_init_from_model: flash_attn    = 0
0.00.240.361 I llama_init_from_model: freq_base     = 10000.0
0.00.240.363 I llama_init_from_model: freq_scale    = 1
0.00.240.364 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.240.395 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.245.197 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.245.230 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.245.266 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.248.547 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.248.564 I llama_init_from_model: graph nodes  = 967
0.00.248.564 I llama_init_from_model: graph splits = 1
0.00.248.570 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 128
0.00.248.570 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.325.199 I 
0.00.325.313 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.325.336 I perplexity: tokenizing the input ..
0.00.331.873 I perplexity: tokenization took 6.533 ms
0.00.331.904 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.006.564 I perplexity: 0.67 seconds per pass - ETA 0.00 minutes
[1]11.0242,
0.01.010.417 I Final estimate: PPL = 11.0242 +/- 3.53494

0.01.010.458 I llama_perf_context_print:        load time =     324.76 ms
0.01.010.461 I llama_perf_context_print: prompt eval time =     672.76 ms /   128 tokens (    5.26 ms per token,   190.26 tokens per second)
0.01.010.462 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.010.463 I llama_perf_context_print:       total time =     685.26 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.265 I build: 4698 (bfd11a23) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.968 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
0.00.020.971 I llama_model_loader: - type  f32:  194 tensors
0.00.020.972 I llama_model_loader: - type q6_K:   98 tensors
0.00.020.974 I print_info: file format = GGUF V3 (latest)
0.00.020.974 I print_info: file type   = Q6_K
0.00.020.976 I print_info: file size   = 1.08 GiB (6.57 BPW) 
0.00.051.423 I load: special tokens cache size = 25
0.00.063.167 I load: token to piece cache size = 0.2984 MB
...
0.00.063.203 I print_info: n_rot            = 32
0.00.063.203 I print_info: n_swa            = 0
0.00.063.204 I print_info: n_embd_head_k    = 128
0.00.063.204 I print_info: n_embd_head_v    = 128
0.00.063.206 I print_info: n_gqa            = 1
0.00.063.207 I print_info: n_embd_k_gqa     = 2048
0.00.063.209 I print_info: n_embd_v_gqa     = 2048
0.00.063.210 I print_info: f_norm_eps       = 1.0e-05
0.00.063.210 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.063.211 I print_info: f_clamp_kqv      = 0.0e+00
0.00.063.211 I print_info: f_max_alibi_bias = 0.0e+00
0.00.063.212 I print_info: f_logit_scale    = 0.0e+00
...
0.00.063.223 I print_info: vocab type       = BPE
0.00.063.224 I print_info: n_vocab          = 50304
0.00.063.224 I print_info: n_merges         = 50009
0.00.063.225 I print_info: BOS token        = 0 '<|endoftext|>'
0.00.063.225 I print_info: EOS token        = 0 '<|endoftext|>'
0.00.063.225 I print_info: EOT token        = 0 '<|endoftext|>'
...
0.00.114.416 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.114.438 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.251.841 I llama_init_from_model: n_seq_max     = 1
0.00.251.855 I llama_init_from_model: n_ctx         = 2048
0.00.251.856 I llama_init_from_model: n_ctx_per_seq = 2048
0.00.251.857 I llama_init_from_model: n_batch       = 2048
0.00.251.857 I llama_init_from_model: n_ubatch      = 512
0.00.251.858 I llama_init_from_model: flash_attn    = 0
0.00.251.864 I llama_init_from_model: freq_base     = 10000.0
0.00.251.866 I llama_init_from_model: freq_scale    = 1
0.00.251.896 I llama_kv_cache_init: kv_size = 2048, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.323.482 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.323.513 I llama_init_from_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.323.550 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.326.912 I llama_init_from_model:        CPU compute buffer size =   102.25 MiB
0.00.326.928 I llama_init_from_model: graph nodes  = 967
0.00.326.928 I llama_init_from_model: graph splits = 1
0.00.326.944 I common_init_from_params: added <|endoftext|> logit bias = -inf
0.00.327.330 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.327.342 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.445.184 I main: llama threadpool init, n_threads = 4
0.00.445.205 I 
0.00.445.288 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.445.289 I 
0.00.445.400 I sampler seed: 1234
0.00.445.421 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = 2048
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.445.425 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.445.426 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.445.426 I 
...
0.03.130.217 I llama_perf_sampler_print:    sampling time =       2.27 ms /    71 runs   (    0.03 ms per token, 31236.25 tokens per second)
0.03.130.221 I llama_perf_context_print:        load time =     443.63 ms
0.03.130.223 I llama_perf_context_print: prompt eval time =     113.33 ms /     7 tokens (   16.19 ms per token,    61.77 tokens per second)
0.03.130.224 I llama_perf_context_print:        eval time =    2559.23 ms /    63 runs   (   40.62 ms per token,    24.62 tokens per second)
0.03.130.226 I llama_perf_context_print:       total time =    2686.10 ms /    70 tokens
...
0.00.020.858 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.063.905 I load: token to piece cache size = 0.2984 MB
...
0.00.064.007 I print_info: n_head           = 16
...
0.00.064.036 I print_info: EOT token        = 0 '<|endoftext|>'
0.00.064.037 I print_info: UNK token        = 0 '<|endoftext|>'
0.00.064.037 I print_info: LF token         = 187 'Ċ'
...
0.00.113.711 I load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.113.733 I load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.250.868 I llama_init_from_model: n_seq_max     = 1
0.00.250.887 I llama_init_from_model: n_ctx         = 128
0.00.250.887 I llama_init_from_model: n_ctx_per_seq = 128
0.00.250.888 I llama_init_from_model: n_batch       = 128
0.00.250.888 I llama_init_from_model: n_ubatch      = 128
0.00.250.889 I llama_init_from_model: flash_attn    = 0
0.00.250.896 I llama_init_from_model: freq_base     = 10000.0
0.00.250.898 I llama_init_from_model: freq_scale    = 1
0.00.250.899 W llama_init_from_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.250.983 I llama_kv_cache_init: kv_size = 128, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 24, can_shift = 1
0.00.255.625 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.255.656 I llama_init_from_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.255.691 I llama_init_from_model:        CPU  output buffer size =     0.19 MiB
0.00.259.185 I llama_init_from_model:        CPU compute buffer size =    25.56 MiB
0.00.259.202 I llama_init_from_model: graph nodes  = 967
0.00.259.202 I llama_init_from_model: graph splits = 1
...
0.00.350.356 I 
0.00.350.468 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.350.489 I perplexity: tokenizing the input ..
0.00.357.013 I perplexity: tokenization took 6.52 ms
0.00.357.042 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.171.374 I perplexity: 0.81 seconds per pass - ETA 0.00 minutes
[1]10.3482,
0.01.175.185 I Final estimate: PPL = 10.3482 +/- 3.30522

0.01.175.224 I llama_perf_context_print:        load time =     349.98 ms
0.01.175.238 I llama_perf_context_print: prompt eval time =     812.50 ms /   128 tokens (    6.35 ms per token,   157.54 tokens per second)
0.01.175.240 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.175.242 I llama_perf_context_print:       total time =     824.87 ms /   129 tokens
...
0.00.298.183 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 2048
0.00.298.201 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
0.00.298.564 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_init_from_model: n_seq_max     = 1
llama_init_from_model: n_ctx         = 2048
llama_init_from_model: n_ctx_per_seq = 2048
