...
- status:  SUCCESS ✅
- runtime: 18:44.73
- date:    Fri May 17 14:44:44 UTC 2024
...
main: build = 2913 (f4bd8b3d)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
main: seed  = 1715956066
...
llama_print_timings: prompt eval time =       5.79 ms /     9 tokens (    0.64 ms per token,  1554.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      56.84 ms /    10 tokens
...
llama_print_timings:        load time =      11.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.99 ms /     9 tokens (    0.44 ms per token,  2255.64 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      53.63 ms /    10 tokens
...
<bos> Shekera is the goddess of **knowledge, wisdom, and justice**.

**True or False?**

Shekera is the goddess of war.<eos> [end of text]

llama_print_timings:        load time =    1236.43 ms
llama_print_timings:      sample time =      45.97 ms /    32 runs   (    1.44 ms per token,   696.06 tokens per second)
llama_print_timings: prompt eval time =    1144.05 ms /     2 tokens (  572.03 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21092.86 ms /    31 runs   (  680.41 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22419.55 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shek, a renowned scholar and mystic, has dedicated his life to understanding the mysteries of the universe and exploring ancient wisdom traditions.

**Shek's teachings
llama_print_timings:        load time =    1235.59 ms
llama_print_timings:      sample time =      46.09 ms /    32 runs   (    1.44 ms per token,   694.22 tokens per second)
llama_print_timings: prompt eval time =    1147.40 ms /     2 tokens (  573.70 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21007.28 ms /    31 runs   (  677.65 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22338.07 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Elder Scrolls series is renowned for its immersive world-building, and the Elder Scrolls V: Skyrim holds a special place in the hearts of many fans.

**
llama_print_timings:        load time =    1232.07 ms
llama_print_timings:      sample time =      46.16 ms /    32 runs   (    1.44 ms per token,   693.30 tokens per second)
llama_print_timings: prompt eval time =    1189.97 ms /     2 tokens (  594.98 ms per token,     1.68 tokens per second)
llama_print_timings:        eval time =   21132.92 ms /    31 runs   (  681.71 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22506.37 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When and Where to Find the Best Deals on Furniture

**1. Online Retailers:**

* **Wayfair:** Wide selection, curated collections, and competitive prices.
llama_print_timings:        load time =    1256.50 ms
llama_print_timings:      sample time =      46.33 ms /    32 runs   (    1.45 ms per token,   690.74 tokens per second)
llama_print_timings: prompt eval time =    1147.10 ms /     2 tokens (  573.55 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21295.04 ms /    31 runs   (  686.94 ms per token,     1.46 tokens per second)
llama_print_timings:       total time =   22624.25 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197131.37 ms
main:    total time = 197131.37 ms
+ echo PASS
PASS
+ echo
...
response = requests.get(url="https://api.github.com/users/octocat
llama_print_timings:        load time =     625.85 ms
llama_print_timings:      sample time =      46.37 ms /    32 runs   (    1.45 ms per token,   690.16 tokens per second)
llama_print_timings: prompt eval time =     565.82 ms /     2 tokens (  282.91 ms per token,     3.53 tokens per second)
llama_print_timings:        eval time =   10462.17 ms /    31 runs   (  337.49 ms per token,     2.96 tokens per second)
llama_print_timings:       total time =   11210.33 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197220.20 ms
main:    total time = 197220.20 ms
+ echo PASS
PASS
+ echo
...
<bos> After studying the provided text, answer the following questions:

1. What is the significance of the phrase "the sky is the limit"?
2. What are
llama_print_timings:        load time =     623.10 ms
llama_print_timings:      sample time =      46.01 ms /    32 runs   (    1.44 ms per token,   695.44 tokens per second)
llama_print_timings: prompt eval time =     565.18 ms /     2 tokens (  282.59 ms per token,     3.54 tokens per second)
llama_print_timings:        eval time =   10488.48 ms /    31 runs   (  338.34 ms per token,     2.96 tokens per second)
llama_print_timings:       total time =   11235.70 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When We Fall Asleep, Where Do We Go?

When we fall asleep, the mind and body engage in a complex interplay of physical and psychological processes. One
llama_print_timings:        load time =     186.01 ms
llama_print_timings:      sample time =       6.78 ms /    32 runs   (    0.21 ms per token,  4723.25 tokens per second)
llama_print_timings: prompt eval time =      78.41 ms /     2 tokens (   39.20 ms per token,    25.51 tokens per second)
llama_print_timings:        eval time =    2173.89 ms /    31 runs   (   70.13 ms per token,    14.26 tokens per second)
llama_print_timings:       total time =    2320.29 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When It Rains, It Really Rains
**Summary:**

The lyrics express the speaker's joy and anticipation for a downpour, acknowledging the beauty and cleansing power
llama_print_timings:        load time =     159.66 ms
llama_print_timings:      sample time =       6.95 ms /    32 runs   (    0.22 ms per token,  4606.97 tokens per second)
llama_print_timings: prompt eval time =      77.89 ms /     2 tokens (   38.95 ms per token,    25.68 tokens per second)
llama_print_timings:        eval time =    2101.21 ms /    31 runs   (   67.78 ms per token,    14.75 tokens per second)
llama_print_timings:       total time =    2249.68 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say a picture paints a thousand words, but I believe a photograph captures the essence of an experience in a way that transcends words.

**The photograph captures the
llama_print_timings:        load time =     160.78 ms
llama_print_timings:      sample time =       6.76 ms /    32 runs   (    0.21 ms per token,  4732.33 tokens per second)
llama_print_timings: prompt eval time =      80.16 ms /     2 tokens (   40.08 ms per token,    24.95 tokens per second)
llama_print_timings:        eval time =    2136.53 ms /    31 runs   (   68.92 ms per token,    14.51 tokens per second)
llama_print_timings:       total time =    2284.94 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say opposites attract. But what if opposites repel?

**Scenario:**

Two individuals, Amelia and Ben, have very different personalities and values. Amelia is a
llama_print_timings:        load time =     161.24 ms
llama_print_timings:      sample time =       7.25 ms /    32 runs   (    0.23 ms per token,  4413.79 tokens per second)
llama_print_timings: prompt eval time =      79.48 ms /     2 tokens (   39.74 ms per token,    25.16 tokens per second)
llama_print_timings:        eval time =    2200.51 ms /    31 runs   (   70.98 ms per token,    14.09 tokens per second)
llama_print_timings:       total time =    2348.83 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shewczyk argues that the current financial system is inherently unsustainable and should be reformed.

**Arguments in support of reform:**

- **Excessive leverage:** The current
...
llama_print_timings: prompt eval time =      67.08 ms /     2 tokens (   33.54 ms per token,    29.81 tokens per second)
llama_print_timings:        eval time =    1611.35 ms /    31 runs   (   51.98 ms per token,    19.24 tokens per second)
llama_print_timings:       total time =    1748.02 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32092.90 ms
main:    total time = 32092.90 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a quaint village nestled amidst rolling hills, lived a curious boy named Oliver. Oliver had a thirst for knowledge and a heart that longed for adventure.


llama_print_timings:        load time =     122.62 ms
llama_print_timings:      sample time =       6.84 ms /    32 runs   (    0.21 ms per token,  4681.10 tokens per second)
llama_print_timings: prompt eval time =     119.53 ms /     5 tokens (   23.91 ms per token,    41.83 tokens per second)
llama_print_timings:        eval time =    1648.22 ms /    31 runs   (   53.17 ms per token,    18.81 tokens per second)
llama_print_timings:       total time =    1835.93 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     382.21 ms
llama_print_timings:      sample time =       2.38 ms /    64 runs   (    0.04 ms per token, 26890.76 tokens per second)
llama_print_timings: prompt eval time =     306.29 ms /     8 tokens (   38.29 ms per token,    26.12 tokens per second)
llama_print_timings:        eval time =    7406.35 ms /    63 runs   (  117.56 ms per token,     8.51 tokens per second)
llama_print_timings:       total time =    7735.17 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     343.41 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4697.68 ms /   128 tokens (   36.70 ms per token,    27.25 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4711.31 ms /   129 tokens
...
llama_print_timings: prompt eval time =     206.37 ms /     8 tokens (   25.80 ms per token,    38.77 tokens per second)
llama_print_timings:        eval time =    5338.45 ms /    63 runs   (   84.74 ms per token,    11.80 tokens per second)
llama_print_timings:       total time =    5563.91 ms /    71 tokens
Log end
...
[1]4.2465,
llama_print_timings:        load time =     260.31 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2843.16 ms /   128 tokens (   22.21 ms per token,    45.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2857.01 ms /   129 tokens
...
llama_print_timings: prompt eval time =     202.02 ms /     8 tokens (   25.25 ms per token,    39.60 tokens per second)
llama_print_timings:        eval time =    4378.88 ms /    63 runs   (   69.51 ms per token,    14.39 tokens per second)
llama_print_timings:       total time =    4601.12 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3135.53 ms /   128 tokens (   24.50 ms per token,    40.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3148.87 ms /   129 tokens
...
The meaning
llama_print_timings:        load time =     248.27 ms
llama_print_timings:      sample time =       2.05 ms /    64 runs   (    0.03 ms per token, 31280.55 tokens per second)
llama_print_timings: prompt eval time =     378.30 ms /     8 tokens (   47.29 ms per token,    21.15 tokens per second)
llama_print_timings:        eval time =    4645.75 ms /    63 runs   (   73.74 ms per token,    13.56 tokens per second)
llama_print_timings:       total time =    5043.74 ms /    71 tokens
Log end
...
[1]4.3918,
llama_print_timings:        load time =     214.26 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5873.16 ms /   128 tokens (   45.88 ms per token,    21.79 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5885.86 ms /   129 tokens
...
llama_print_timings: prompt eval time =     400.24 ms /     8 tokens (   50.03 ms per token,    19.99 tokens per second)
llama_print_timings:        eval time =    5078.88 ms /    63 runs   (   80.62 ms per token,    12.40 tokens per second)
llama_print_timings:       total time =    5498.95 ms /    71 tokens
Log end
...
[1]4.3207,
llama_print_timings:        load time =     219.04 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6177.73 ms /   128 tokens (   48.26 ms per token,    20.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6191.63 ms /   129 tokens
...
llama_print_timings: prompt eval time =     444.17 ms /     8 tokens (   55.52 ms per token,    18.01 tokens per second)
llama_print_timings:        eval time =    5303.78 ms /    63 runs   (   84.19 ms per token,    11.88 tokens per second)
llama_print_timings:       total time =    5767.75 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.124 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 6.61 seconds per pass - ETA 0.10 minutes
[1]4.2617,
llama_print_timings:        load time =     229.50 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6603.78 ms /   128 tokens (   51.59 ms per token,    19.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6617.59 ms /   129 tokens
...
llama_print_timings: prompt eval time =     615.64 ms /     8 tokens (   76.95 ms per token,    12.99 tokens per second)
llama_print_timings:        eval time =    5800.00 ms /    63 runs   (   92.06 ms per token,    10.86 tokens per second)
llama_print_timings:       total time =    6434.71 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9925.16 ms /   128 tokens (   77.54 ms per token,    12.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9938.92 ms /   129 tokens
...
I believe in karma.
I believe that you
llama_print_timings:        load time =     243.22 ms
llama_print_timings:      sample time =       2.07 ms /    64 runs   (    0.03 ms per token, 30962.75 tokens per second)
llama_print_timings: prompt eval time =     467.64 ms /     8 tokens (   58.46 ms per token,    17.11 tokens per second)
llama_print_timings:        eval time =    4965.34 ms /    63 runs   (   78.81 ms per token,    12.69 tokens per second)
llama_print_timings:       total time =    5452.78 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.379 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 7.45 seconds per pass - ETA 0.12 minutes
[1]4.4095,
llama_print_timings:        load time =     208.42 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7450.07 ms /   128 tokens (   58.20 ms per token,    17.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7463.54 ms /   129 tokens
...
llama_print_timings:        load time =     241.80 ms
llama_print_timings:      sample time =       2.08 ms /    64 runs   (    0.03 ms per token, 30843.37 tokens per second)
llama_print_timings: prompt eval time =     393.79 ms /     8 tokens (   49.22 ms per token,    20.32 tokens per second)
llama_print_timings:        eval time =    4865.00 ms /    63 runs   (   77.22 ms per token,    12.95 tokens per second)
llama_print_timings:       total time =    5277.95 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6160.51 ms /   128 tokens (   48.13 ms per token,    20.78 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6173.74 ms /   129 tokens
...
-
llama_print_timings:        load time =     274.76 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31357.18 tokens per second)
llama_print_timings: prompt eval time =     464.12 ms /     8 tokens (   58.01 ms per token,    17.24 tokens per second)
llama_print_timings:        eval time =    5603.33 ms /    63 runs   (   88.94 ms per token,    11.24 tokens per second)
llama_print_timings:       total time =    6086.56 ms /    71 tokens
Log end
...
[1]4.2379,
llama_print_timings:        load time =     237.60 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7278.37 ms /   128 tokens (   56.86 ms per token,    17.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7291.85 ms /   129 tokens
...
llama_print_timings:        load time =     299.64 ms
llama_print_timings:      sample time =       2.03 ms /    64 runs   (    0.03 ms per token, 31573.75 tokens per second)
llama_print_timings: prompt eval time =     519.01 ms /     8 tokens (   64.88 ms per token,    15.41 tokens per second)
llama_print_timings:        eval time =    6192.08 ms /    63 runs   (   98.29 ms per token,    10.17 tokens per second)
llama_print_timings:       total time =    6730.36 ms /    71 tokens
Log end
...
[1]4.2523,
llama_print_timings:        load time =     264.10 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8182.32 ms /   128 tokens (   63.92 ms per token,    15.64 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8196.01 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy tired x dog. The red haired idiots do not


second run: The quick brown fox jumps over the lazy tired x dog. The red haired idiots do not


single seq run: The quick brown fox jumps over the lazy tired x dog. The red haired idiots do not
...
first run: The quick brown fox jumps over the grain of cheese.
\have/ have, \be/


second run: The quick brown fox jumps over the grain of cheese.
\have/ have, \be/


single seq run: The quick brown fox jumps over the grain of cheese.
\have/ have, \be/
...
0.32user 0.36system 0:00.69elapsed 99%CPU (0avgtext+0avgdata 6880380maxresident)k
0inputs+40outputs (0major+114587minor)pagefaults 0swaps
```
...
0.15user 0.32system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 6880008maxresident)k
0inputs+40outputs (0major+115086minor)pagefaults 0swaps
```
