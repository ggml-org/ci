...
- status:  SUCCESS ✅
- runtime: 785.92
- date:    Mon Apr 29 16:22:52 EEST 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/577277ffd203b190c3dc2ab3e737946dc432132c
...
12/23 Test #12: test-tokenizer-1-stablelm-3b-4e1t ...   Passed    5.20 sec
...
21/23 Test #21: test-backend-ops ....................   Passed   94.55 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 197.34 sec*proc (23 tests)

Total Test time (real) = 197.36 sec
...
llama_print_timings:        load time =      63.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.33 ms /     9 tokens (    1.26 ms per token,   794.56 tokens per second)
...
llama_print_timings:        load time =      53.65 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.37 ms /     9 tokens (    1.26 ms per token,   791.42 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Heider Company, a leading provider of agricultural machinery and equipment, announced today the launch of its new line of precision agriculture solutions.

The company claims that these solutions
llama_print_timings:        load time =    3110.60 ms
llama_print_timings:      sample time =      56.84 ms /    32 runs   (    1.78 ms per token,   563.02 tokens per second)
llama_print_timings: prompt eval time =     196.09 ms /     2 tokens (   98.05 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1500.66 ms /    31 runs   (   48.41 ms per token,    20.66 tokens per second)
llama_print_timings:       total time =    2503.45 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, in a quaint little town, lived a young girl named Anya. Anya had bright eyes, a smile that could brighten any room, and a heart full of
llama_print_timings:        load time =    3259.59 ms
llama_print_timings:      sample time =      57.26 ms /    32 runs   (    1.79 ms per token,   558.87 tokens per second)
llama_print_timings: prompt eval time =     206.86 ms /     5 tokens (   41.37 ms per token,    24.17 tokens per second)
llama_print_timings:        eval time =    1503.39 ms /    31 runs   (   48.50 ms per token,    20.62 tokens per second)
llama_print_timings:       total time =    2532.31 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
user
llama_print_timings:        load time =    3139.59 ms
llama_print_timings:      sample time =      57.59 ms /    32 runs   (    1.80 ms per token,   555.62 tokens per second)
llama_print_timings: prompt eval time =     196.84 ms /     2 tokens (   98.42 ms per token,    10.16 tokens per second)
llama_print_timings:        eval time =    1503.67 ms /    31 runs   (   48.51 ms per token,    20.62 tokens per second)
llama_print_timings:       total time =    2545.19 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If a function is one-to-one, then it is also onto.
...
A function
llama_print_timings:        load time =    2894.12 ms
llama_print_timings:      sample time =      16.37 ms /    32 runs   (    0.51 ms per token,  1955.15 tokens per second)
llama_print_timings: prompt eval time =     195.30 ms /     2 tokens (   97.65 ms per token,    10.24 tokens per second)
llama_print_timings:        eval time =    1525.42 ms /    31 runs   (   49.21 ms per token,    20.32 tokens per second)
llama_print_timings:       total time =    1810.80 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soar! is a company dedicated to promoting mental health awareness. They offer various resources and support systems to help individuals manage their emotions and build resilience.

**a
llama_print_timings:        load time =    3408.95 ms
llama_print_timings:      sample time =      16.53 ms /    32 runs   (    0.52 ms per token,  1935.64 tokens per second)
llama_print_timings: prompt eval time =     201.79 ms /     2 tokens (  100.89 ms per token,     9.91 tokens per second)
llama_print_timings:        eval time =    1524.57 ms /    31 runs   (   49.18 ms per token,    20.33 tokens per second)
llama_print_timings:       total time =    1818.78 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    3235.90 ms
llama_print_timings:      sample time =      16.37 ms /    32 runs   (    0.51 ms per token,  1955.03 tokens per second)
llama_print_timings: prompt eval time =     195.98 ms /     2 tokens (   97.99 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1523.70 ms /    31 runs   (   49.15 ms per token,    20.35 tokens per second)
llama_print_timings:       total time =    1811.83 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21644.15 ms
main:    total time = 21644.15 ms
+ echo PASS
PASS
+ echo
...
<bos> They say a picture is worth a thousand words, but truly, it can paint a thousand unspoken emotions.

This statement resonates deeply with me, as I find myself
llama_print_timings:        load time =    1633.66 ms
llama_print_timings:      sample time =      16.55 ms /    32 runs   (    0.52 ms per token,  1932.95 tokens per second)
llama_print_timings: prompt eval time =     212.73 ms /     2 tokens (  106.36 ms per token,     9.40 tokens per second)
llama_print_timings:        eval time =    1091.50 ms /    31 runs   (   35.21 ms per token,    28.40 tokens per second)
llama_print_timings:       total time =    1395.33 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21961.28 ms
main:    total time = 21961.28 ms
+ echo PASS
PASS
+ echo
...
The full moon occurs when the moon is positioned between the earth and the sun, and its illuminated side is visible from the Earth.
llama_print_timings:        load time =    1817.14 ms
llama_print_timings:      sample time =      16.49 ms /    32 runs   (    0.52 ms per token,  1940.22 tokens per second)
llama_print_timings: prompt eval time =     214.32 ms /     2 tokens (  107.16 ms per token,     9.33 tokens per second)
llama_print_timings:        eval time =    1101.92 ms /    31 runs   (   35.55 ms per token,    28.13 tokens per second)
llama_print_timings:       total time =    1407.66 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
