...
- status:  SUCCESS ✅
- runtime: 12:41.13
- date:    Mon Apr 29 13:25:48 UTC 2024
...
llama_print_timings: prompt eval time =       4.37 ms /     9 tokens (    0.49 ms per token,  2060.91 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.75 ms /     9 tokens (    0.42 ms per token,  2399.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Once upon a time, there lived a young girl named Anya. Anya was a curious and imaginative girl, always eager to explore the world around her.

One sunny day, Anya
llama_print_timings:        load time =    1234.48 ms
llama_print_timings:      sample time =      47.80 ms /    32 runs   (    1.49 ms per token,   669.53 tokens per second)
llama_print_timings: prompt eval time =    2589.73 ms /     5 tokens (  517.95 ms per token,     1.93 tokens per second)
llama_print_timings:        eval time =   20665.41 ms /    31 runs   (  666.63 ms per token,     1.50 tokens per second)
llama_print_timings:       total time =   23433.58 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soirée is a social media platform designed specifically for professional women to connect, collaborate, and elevate their careers.

**Features:**

* **Networking:** Connect with
llama_print_timings:        load time =    1284.28 ms
llama_print_timings:      sample time =      47.65 ms /    32 runs   (    1.49 ms per token,   671.61 tokens per second)
llama_print_timings: prompt eval time =    1189.62 ms /     2 tokens (  594.81 ms per token,     1.68 tokens per second)
llama_print_timings:        eval time =   20903.28 ms /    31 runs   (  674.30 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22271.81 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
In the novel "The Heirs," the protagonist, named Sebastian, faces a harsh reality check after his parents' sudden passing
...
llama_print_timings: prompt eval time =    1211.29 ms /     2 tokens (  605.64 ms per token,     1.65 tokens per second)
llama_print_timings:        eval time =   20722.67 ms /    31 runs   (  668.47 ms per token,     1.50 tokens per second)
llama_print_timings:       total time =   22112.76 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say behind every great man, there's a great woman.

Answer: This statement highlights the importance of women in a man's life and acknowledges the
llama_print_timings:        load time =     179.78 ms
llama_print_timings:      sample time =       6.30 ms /    32 runs   (    0.20 ms per token,  5082.59 tokens per second)
llama_print_timings: prompt eval time =      75.46 ms /     2 tokens (   37.73 ms per token,    26.50 tokens per second)
llama_print_timings:        eval time =    2017.76 ms /    31 runs   (   65.09 ms per token,    15.36 tokens per second)
llama_print_timings:       total time =    2159.92 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Witcher's Geralt of Rivia is a complex and multifaceted character. Discuss his personality, motivations, and role in the narrative.
...
llama_print_timings: prompt eval time =      71.79 ms /     2 tokens (   35.89 ms per token,    27.86 tokens per second)
llama_print_timings:        eval time =    1981.23 ms /    31 runs   (   63.91 ms per token,    15.65 tokens per second)
llama_print_timings:       total time =    2119.81 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After a long day, the last thing you want to do is clean. Here at [Insert company name], we understand the struggle. That's why we offer
llama_print_timings:        load time =     158.72 ms
llama_print_timings:      sample time =       6.64 ms /    32 runs   (    0.21 ms per token,  4820.73 tokens per second)
llama_print_timings: prompt eval time =      74.79 ms /     2 tokens (   37.39 ms per token,    26.74 tokens per second)
llama_print_timings:        eval time =    2075.19 ms /    31 runs   (   66.94 ms per token,    14.94 tokens per second)
llama_print_timings:       total time =    2216.98 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32351.84 ms
main:    total time = 32351.84 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a young girl named Anya who dreamed of becoming a doctor. She spent countless hours studying anatomy and physiology, determined to understand the human body and heal
...
llama_print_timings: prompt eval time =     118.41 ms /     5 tokens (   23.68 ms per token,    42.23 tokens per second)
llama_print_timings:        eval time =    1521.10 ms /    31 runs   (   49.07 ms per token,    20.38 tokens per second)
llama_print_timings:       total time =    1706.35 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32136.24 ms
main:    total time = 32136.24 ms
+ echo PASS
PASS
+ echo
...
<bos> Shelliah was a powerful woman, who used her influence to advocate for the rights of women and children. She challenged the patriarchal norms of her time, advocating for
llama_print_timings:        load time =     120.48 ms
llama_print_timings:      sample time =       6.24 ms /    32 runs   (    0.20 ms per token,  5126.56 tokens per second)
llama_print_timings: prompt eval time =      63.95 ms /     2 tokens (   31.98 ms per token,    31.27 tokens per second)
llama_print_timings:        eval time =    1552.38 ms /    31 runs   (   50.08 ms per token,    19.97 tokens per second)
...
llama_print_timings:        load time =     575.34 ms
llama_print_timings:      sample time =       2.61 ms /    64 runs   (    0.04 ms per token, 24511.68 tokens per second)
llama_print_timings: prompt eval time =     309.18 ms /     8 tokens (   38.65 ms per token,    25.87 tokens per second)
llama_print_timings:        eval time =    7743.88 ms /    63 runs   (  122.92 ms per token,     8.14 tokens per second)
llama_print_timings:       total time =    8075.72 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4964.51 ms /   128 tokens (   38.79 ms per token,    25.78 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4975.15 ms /   129 tokens
...
llama_print_timings:        load time =     370.80 ms
llama_print_timings:      sample time =       2.25 ms /    64 runs   (    0.04 ms per token, 28381.37 tokens per second)
llama_print_timings: prompt eval time =     207.52 ms /     8 tokens (   25.94 ms per token,    38.55 tokens per second)
llama_print_timings:        eval time =    5380.51 ms /    63 runs   (   85.40 ms per token,    11.71 tokens per second)
llama_print_timings:       total time =    5613.60 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2851.62 ms /   128 tokens (   22.28 ms per token,    44.89 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2861.77 ms /   129 tokens
...
llama_print_timings: prompt eval time =     201.55 ms /     8 tokens (   25.19 ms per token,    39.69 tokens per second)
llama_print_timings:        eval time =    4621.90 ms /    63 runs   (   73.36 ms per token,    13.63 tokens per second)
llama_print_timings:       total time =    4843.32 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3144.76 ms /   128 tokens (   24.57 ms per token,    40.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3154.96 ms /   129 tokens
...
llama_print_timings:        eval time =    4876.13 ms /    63 runs   (   77.40 ms per token,    12.92 tokens per second)
llama_print_timings:       total time =    5270.12 ms /    71 tokens
Log end
...
[1]4.3889,
llama_print_timings:        load time =     280.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5869.89 ms /   128 tokens (   45.86 ms per token,    21.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5879.72 ms /   129 tokens
...
llama_print_timings:        load time =     321.11 ms
...
llama_print_timings:        eval time =    5176.48 ms /    63 runs   (   82.17 ms per token,    12.17 tokens per second)
llama_print_timings:       total time =    5591.13 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6213.80 ms /   128 tokens (   48.55 ms per token,    20.60 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6224.05 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     344.13 ms
...
llama_print_timings:        eval time =    5501.56 ms /    63 runs   (   87.33 ms per token,    11.45 tokens per second)
llama_print_timings:       total time =    5953.68 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6587.49 ms /   128 tokens (   51.46 ms per token,    19.43 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6597.65 ms /   129 tokens
...
llama_print_timings: prompt eval time =     615.06 ms /     8 tokens (   76.88 ms per token,    13.01 tokens per second)
llama_print_timings:        eval time =    5739.85 ms /    63 runs   (   91.11 ms per token,    10.98 tokens per second)
llama_print_timings:       total time =    6374.16 ms /    71 tokens
Log end
...
[1]5.6204,
llama_print_timings:        load time =     276.41 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9890.75 ms /   128 tokens (   77.27 ms per token,    12.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9900.83 ms /   129 tokens
...
llama_print_timings: prompt eval time =     462.27 ms /     8 tokens (   57.78 ms per token,    17.31 tokens per second)
llama_print_timings:        eval time =    4962.28 ms /    63 runs   (   78.77 ms per token,    12.70 tokens per second)
llama_print_timings:       total time =    5444.54 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.15 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 7.43 seconds per pass - ETA 0.12 minutes
[1]4.4091,
llama_print_timings:        load time =     266.28 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7427.22 ms /   128 tokens (   58.03 ms per token,    17.23 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7437.97 ms /   129 tokens
...
llama_print_timings: prompt eval time =     391.41 ms /     8 tokens (   48.93 ms per token,    20.44 tokens per second)
llama_print_timings:        eval time =    5029.41 ms /    63 runs   (   79.83 ms per token,    12.53 tokens per second)
llama_print_timings:       total time =    5440.04 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6166.86 ms /   128 tokens (   48.18 ms per token,    20.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6176.70 ms /   129 tokens
...
-
llama_print_timings:        load time =     348.94 ms
llama_print_timings:      sample time =       2.25 ms /    64 runs   (    0.04 ms per token, 28419.18 tokens per second)
llama_print_timings: prompt eval time =     466.77 ms /     8 tokens (   58.35 ms per token,    17.14 tokens per second)
llama_print_timings:        eval time =    5709.29 ms /    63 runs   (   90.62 ms per token,    11.03 tokens per second)
llama_print_timings:       total time =    6523.20 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7303.93 ms /   128 tokens (   57.06 ms per token,    17.52 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7314.74 ms /   129 tokens
...
llama_print_timings:        load time =     386.91 ms
llama_print_timings:      sample time =       2.27 ms /    64 runs   (    0.04 ms per token, 28243.60 tokens per second)
llama_print_timings: prompt eval time =     527.31 ms /     8 tokens (   65.91 ms per token,    15.17 tokens per second)
llama_print_timings:        eval time =    7497.05 ms /    63 runs   (  119.00 ms per token,     8.40 tokens per second)
llama_print_timings:       total time =    9066.26 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     368.75 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8233.44 ms /   128 tokens (   64.32 ms per token,    15.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8243.98 ms /   129 tokens
...
dog. My nether regions are agreeably energized
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 49.173 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.80 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     553.42 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4796.17 ms /   128 tokens (   37.47 ms per token,    26.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4848.01 ms /   129 tokens
...
[1]7.0156,
llama_print_timings:        load time =    5636.43 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4834.17 ms /   128 tokens (   37.77 ms per token,    26.48 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4883.45 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 49.224 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.85 seconds per pass - ETA 0.03 minutes
[1]9.1825,
llama_print_timings:        load time =     351.29 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2846.97 ms /   128 tokens (   22.24 ms per token,    44.96 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2898.19 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 49.723 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 2.86 seconds per pass - ETA 0.03 minutes
[1]7.0131,
llama_print_timings:        load time =    4096.46 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2855.47 ms /   128 tokens (   22.31 ms per token,    44.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2907.35 ms /   129 tokens
...
[1]7.0336,
llama_print_timings:        load time =    4410.64 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2836.20 ms /   128 tokens (   22.16 ms per token,    45.13 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2883.88 ms /   129 tokens
...
2/2 Test #24: test-autorelease .................   Passed    0.89 sec
...
0.30user 0.75system 0:01.05elapsed 100%CPU (0avgtext+0avgdata 6878168maxresident)k
...
0.09user 0.73system 0:00.82elapsed 99%CPU (0avgtext+0avgdata 6877944maxresident)k
0inputs+40outputs (0major+111972minor)pagefaults 0swaps
```
