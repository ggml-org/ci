...
- status:  SUCCESS ✅
- runtime: 783.87
- date:    Fri Apr 26 10:33:35 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   92.33 sec
      Start 22: test-rope
...
Test project /Users/ggml/work/llama.cpp/build-ci-release
 ...
 3/23 Test  #3: test-sampling .......................   Passed    0.18 sec
      Start  4: test-chat-template
 4/23 Test  #4: test-chat-template ..................   Passed    0.41 sec
      Start  5: test-tokenizer-0-llama
...
llama_print_timings:        load time =      61.85 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.16 ms /     9 tokens (    1.13 ms per token,   886.00 tokens per second)
...
# Print
llama_print_timings:        load time =    2606.18 ms
llama_print_timings:      sample time =      57.05 ms /    32 runs   (    1.78 ms per token,   560.88 tokens per second)
llama_print_timings: prompt eval time =     195.45 ms /     2 tokens (   97.72 ms per token,    10.23 tokens per second)
llama_print_timings:        eval time =    1496.01 ms /    31 runs   (   48.26 ms per token,    20.72 tokens per second)
llama_print_timings:       total time =    2489.91 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
One day, a group of children gathered in the square, their eyes shining with excitement. They were planning a
llama_print_timings:        load time =    2737.74 ms
llama_print_timings:      sample time =      56.82 ms /    32 runs   (    1.78 ms per token,   563.20 tokens per second)
llama_print_timings: prompt eval time =     206.69 ms /     5 tokens (   41.34 ms per token,    24.19 tokens per second)
llama_print_timings:        eval time =    1500.54 ms /    31 runs   (   48.40 ms per token,    20.66 tokens per second)
llama_print_timings:       total time =    2542.35 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After-Sales Service (ASAS) is a critical component of any customer-centric business. It ensures that customers continue to experience satisfaction with the products and services provided
llama_print_timings:        load time =    2683.06 ms
llama_print_timings:      sample time =      57.08 ms /    32 runs   (    1.78 ms per token,   560.67 tokens per second)
llama_print_timings: prompt eval time =     197.23 ms /     2 tokens (   98.62 ms per token,    10.14 tokens per second)
llama_print_timings:        eval time =    1494.61 ms /    31 runs   (   48.21 ms per token,    20.74 tokens per second)
llama_print_timings:       total time =    2511.18 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Heals Foundation is dedicated to providing essential healthcare services and resources to underserved communities in the United States.

**a. Explain the mission and vision of He Heals
llama_print_timings:        load time =    2588.10 ms
...
<bos> Soar is a mental health and well-being initiative designed to empower young adults to take charge of their mental health and navigate challenges with grace and resilience.

**
llama_print_timings:        load time =    3054.67 ms
llama_print_timings:      sample time =      16.47 ms /    32 runs   (    0.51 ms per token,  1942.81 tokens per second)
...
llama_print_timings:       total time =    1815.88 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Shekera, the enigmatic ruler of ancient Egypt, is shrouded in mystery and intrigue.

**Who was Shekera?**

Shekera was the
llama_print_timings:        load time =    2736.27 ms
...
llama_print_timings:        eval time =    1528.93 ms /    31 runs   (   49.32 ms per token,    20.28 tokens per second)
llama_print_timings:       total time =    1814.67 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21206.88 ms
main:    total time = 21206.88 ms
+ echo PASS
PASS
+ echo
...
<bos> After using the "Find" feature to locate a specific cell, how can I quickly jump to that cell using the keyboard?

**Option 1:** Select and
llama_print_timings:        load time =    1419.51 ms
llama_print_timings:      sample time =      15.96 ms /    32 runs   (    0.50 ms per token,  2005.26 tokens per second)
llama_print_timings: prompt eval time =     212.74 ms /     2 tokens (  106.37 ms per token,     9.40 tokens per second)
llama_print_timings:        eval time =    1086.42 ms /    31 runs   (   35.05 ms per token,    28.53 tokens per second)
llama_print_timings:       total time =    1386.60 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21560.78 ms
main:    total time = 21560.78 ms
+ echo PASS
PASS
+ echo
...
<bos> The Witcher series is a great example of fantasy storytelling, and I'm eager to learn more about its elements and tropes.

**Elements of The Witcher:**


llama_print_timings:        load time =    1517.22 ms
llama_print_timings:      sample time =      16.56 ms /    32 runs   (    0.52 ms per token,  1932.60 tokens per second)
llama_print_timings: prompt eval time =     214.53 ms /     2 tokens (  107.26 ms per token,     9.32 tokens per second)
llama_print_timings:        eval time =    1101.93 ms /    31 runs   (   35.55 ms per token,    28.13 tokens per second)
llama_print_timings:       total time =    1408.13 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
