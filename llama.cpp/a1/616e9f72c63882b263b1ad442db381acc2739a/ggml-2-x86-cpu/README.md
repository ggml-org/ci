...
- status:  SUCCESS ✅
- runtime: 14:31.27
- date:    Mon Apr 29 14:39:16 UTC 2024
...
11/21 Test #11: test-quantize-fns .................   Passed   31.02 sec
...
llama_print_timings: prompt eval time =       4.01 ms /     9 tokens (    0.45 ms per token,  2242.71 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.83 ms /     9 tokens (    0.43 ms per token,  2349.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Shek Company is considering a capital expenditure of $100,000 to purchase new equipment. The equipment has an expected life of five years and will
llama_print_timings:        load time =    1253.46 ms
llama_print_timings:      sample time =      45.76 ms /    32 runs   (    1.43 ms per token,   699.36 tokens per second)
llama_print_timings: prompt eval time =    1131.23 ms /     2 tokens (  565.61 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20787.51 ms /    31 runs   (  670.56 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22099.07 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After much research, I've narrowed down my search for a specific product to two options:
...
llama_print_timings: prompt eval time =    1210.73 ms /     2 tokens (  605.36 ms per token,     1.65 tokens per second)
llama_print_timings:        eval time =   21137.50 ms /    31 runs   (  681.85 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22529.97 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heinkel P3 is a single-seat biplane fighter aircraft designed and manufactured by Heinkel Flugzeugwerke. The aircraft was first flown in 1935
llama_print_timings:        load time =    1221.23 ms
llama_print_timings:      sample time =      46.12 ms /    32 runs   (    1.44 ms per token,   693.86 tokens per second)
llama_print_timings: prompt eval time =    1131.13 ms /     2 tokens (  565.57 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20941.36 ms /    31 runs   (  675.53 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22254.01 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say the best way to learn is by doing. And what better way to learn than by building something tangible? This is the mantra of the Makerspaces, a
...
llama_print_timings:        eval time =    2121.37 ms /    31 runs   (   68.43 ms per token,    14.61 tokens per second)
llama_print_timings:       total time =    2269.16 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a magical forest filled with wondrous creatures.

**A gentle breeze rustling through the leaves, a melodious tune sung by a bird, and the sweet
...
llama_print_timings: prompt eval time =     131.19 ms /     5 tokens (   26.24 ms per token,    38.11 tokens per second)
llama_print_timings:        eval time =    2064.11 ms /    31 runs   (   66.58 ms per token,    15.02 tokens per second)
llama_print_timings:       total time =    2263.12 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
The full moon occurs when the Moon is on the opposite side of Earth from the Sun, with its entire visible side illuminated by sunlight
llama_print_timings:        load time =     158.32 ms
llama_print_timings:      sample time =       6.14 ms /    32 runs   (    0.19 ms per token,  5210.03 tokens per second)
llama_print_timings: prompt eval time =      75.65 ms /     2 tokens (   37.83 ms per token,    26.44 tokens per second)
llama_print_timings:        eval time =    2057.42 ms /    31 runs   (   66.37 ms per token,    15.07 tokens per second)
llama_print_timings:       total time =    2199.88 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32152.83 ms
main:    total time = 32152.83 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       7.25 ms /    32 runs   (    0.23 ms per token,  4412.58 tokens per second)
llama_print_timings: prompt eval time =      68.51 ms /     2 tokens (   34.26 ms per token,    29.19 tokens per second)
llama_print_timings:        eval time =    1679.31 ms /    31 runs   (   54.17 ms per token,    18.46 tokens per second)
llama_print_timings:       total time =    1817.45 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32229.08 ms
main:    total time = 32229.08 ms
+ echo PASS
PASS
+ echo
...
<bos> The Grand Bazaar of Istanbul

The Grand Bazaar of Istanbul is a sprawling labyrinth of shops selling everything from spices and textiles to furniture and electronics. It is one of the
llama_print_timings:        load time =     121.70 ms
llama_print_timings:      sample time =       6.78 ms /    32 runs   (    0.21 ms per token,  4719.07 tokens per second)
llama_print_timings: prompt eval time =      70.91 ms /     2 tokens (   35.46 ms per token,    28.20 tokens per second)
llama_print_timings:        eval time =    1640.21 ms /    31 runs   (   52.91 ms per token,    18.90 tokens per second)
llama_print_timings:       total time =    1779.41 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     604.33 ms
llama_print_timings:      sample time =       2.44 ms /    64 runs   (    0.04 ms per token, 26197.30 tokens per second)
llama_print_timings: prompt eval time =     341.48 ms /     8 tokens (   42.68 ms per token,    23.43 tokens per second)
llama_print_timings:        eval time =    8148.92 ms /    63 runs   (  129.35 ms per token,     7.73 tokens per second)
llama_print_timings:       total time =    8513.27 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     574.25 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5014.52 ms /   128 tokens (   39.18 ms per token,    25.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5031.18 ms /   129 tokens
...
llama_print_timings:        load time =     434.79 ms
...
llama_print_timings:        eval time =    7368.12 ms /    63 runs   (  116.95 ms per token,     8.55 tokens per second)
llama_print_timings:       total time =    7718.57 ms /    71 tokens
Log end
...
llama_print_timings: prompt eval time =     224.27 ms /     8 tokens (   28.03 ms per token,    35.67 tokens per second)
llama_print_timings:        eval time =    4716.54 ms /    63 runs   (   74.87 ms per token,    13.36 tokens per second)
llama_print_timings:       total time =    4960.68 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3334.44 ms /   128 tokens (   26.05 ms per token,    38.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3350.60 ms /   129 tokens
...
llama_print_timings:        eval time =    4984.47 ms /    63 runs   (   79.12 ms per token,    12.64 tokens per second)
llama_print_timings:       total time =    5403.80 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6047.74 ms /   128 tokens (   47.25 ms per token,    21.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6064.13 ms /   129 tokens
...
llama_print_timings:        load time =     340.23 ms
...
llama_print_timings:        eval time =    5618.13 ms /    63 runs   (   89.18 ms per token,    11.21 tokens per second)
llama_print_timings:       total time =    6070.08 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6581.09 ms /   128 tokens (   51.41 ms per token,    19.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6597.73 ms /   129 tokens
...
llama_print_timings:       total time =    6322.56 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6768.61 ms /   128 tokens (   52.88 ms per token,    18.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6785.09 ms /   129 tokens
...
llama_print_timings:        eval time =    6180.78 ms /    63 runs   (   98.11 ms per token,    10.19 tokens per second)
llama_print_timings:       total time =    6833.33 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10170.16 ms /   128 tokens (   79.45 ms per token,    12.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10186.75 ms /   129 tokens
...
llama_print_timings:        load time =     306.24 ms
llama_print_timings:      sample time =       2.05 ms /    64 runs   (    0.03 ms per token, 31173.89 tokens per second)
llama_print_timings: prompt eval time =     486.25 ms /     8 tokens (   60.78 ms per token,    16.45 tokens per second)
llama_print_timings:        eval time =    5464.01 ms /    63 runs   (   86.73 ms per token,    11.53 tokens per second)
llama_print_timings:       total time =    5969.40 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7586.09 ms /   128 tokens (   59.27 ms per token,    16.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7602.40 ms /   129 tokens
...
llama_print_timings:        eval time =    5295.58 ms /    63 runs   (   84.06 ms per token,    11.90 tokens per second)
llama_print_timings:       total time =    5729.74 ms /    71 tokens
Log end
...
[1]4.1768,
llama_print_timings:        load time =     300.83 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6330.70 ms /   128 tokens (   49.46 ms per token,    20.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6346.41 ms /   129 tokens
...
llama_print_timings:        eval time =    6069.18 ms /    63 runs   (   96.34 ms per token,    10.38 tokens per second)
llama_print_timings:       total time =    6575.86 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7554.33 ms /   128 tokens (   59.02 ms per token,    16.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7570.91 ms /   129 tokens
...
llama_print_timings:        eval time =    6695.13 ms /    63 runs   (  106.27 ms per token,     9.41 tokens per second)
llama_print_timings:       total time =    7255.32 ms /    71 tokens
Log end
...
[1]4.2549,
llama_print_timings:        load time =     384.12 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8307.31 ms /   128 tokens (   64.90 ms per token,    15.41 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8323.37 ms /   129 tokens
...
He only did it because it was such a
...
first run: The quick brown fox jumps over the lazy dog in this three-digit number problem.
TRIN


second run: The quick brown fox jumps over the lazy dog in this three-digit number problem.
TRIN


single seq run: The quick brown fox jumps over the lazy dog in this three-digit number problem.
TRIN
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 48.288 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.80 seconds per pass - ETA 0.07 minutes
[1]9.1034,
llama_print_timings:        load time =     572.73 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4794.92 ms /   128 tokens (   37.46 ms per token,    26.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4851.62 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.934 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.83 seconds per pass - ETA 0.07 minutes
[1]7.0156,
llama_print_timings:        load time =    5367.41 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4821.19 ms /   128 tokens (   37.67 ms per token,    26.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4875.83 ms /   129 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3002.27 ms /   128 tokens (   23.46 ms per token,    42.63 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3059.27 ms /   129 tokens
...
[1]7.0131,
llama_print_timings:        load time =    3938.37 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3015.42 ms /   128 tokens (   23.56 ms per token,    42.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3068.95 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 49.222 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.04 seconds per pass - ETA 0.05 minutes
[1]7.0336,
llama_print_timings:        load time =    4324.66 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3033.10 ms /   128 tokens (   23.70 ms per token,    42.20 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3091.61 ms /   129 tokens
...
0.29user 0.76system 0:01.06elapsed 100%CPU (0avgtext+0avgdata 6878208maxresident)k
...
0.09user 0.73system 0:00.83elapsed 100%CPU (0avgtext+0avgdata 6878096maxresident)k
