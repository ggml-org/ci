...
- status:  SUCCESS ✅
- runtime: 23:15.94
- date:    Mon Apr 29 15:34:39 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 4/21 Test  #4: test-tokenizer-0-falcon ...........   Passed    1.14 sec
...
10/21 Test #10: test-tokenizer-1-llama-spm ........   Passed    2.70 sec
...
llama_print_timings: prompt eval time =      12.92 ms /     9 tokens (    1.44 ms per token,   696.43 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      79.90 ms /    10 tokens
...
<bos> Once upon a time, in a vibrant forest filled with towering trees and sparkling streams, lived a curious squirrel named Nutmeg.

Nutmeg was known for his insatiable curiosity and love
llama_print_timings:        load time =    3874.07 ms
llama_print_timings:      sample time =      41.59 ms /    32 runs   (    1.30 ms per token,   769.40 tokens per second)
llama_print_timings: prompt eval time =    6337.69 ms /     5 tokens ( 1267.54 ms per token,     0.79 tokens per second)
llama_print_timings:        eval time =   49564.44 ms /    31 runs   ( 1598.85 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   56058.06 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Hebe, daughter of Zeus, is said to have been the first mortal woman to appear on Earth. What does this passage suggest about the historical relationship between humans and
llama_print_timings:        load time =    3773.38 ms
llama_print_timings:      sample time =      41.41 ms /    32 runs   (    1.29 ms per token,   772.67 tokens per second)
llama_print_timings: prompt eval time =    2781.15 ms /     2 tokens ( 1390.58 ms per token,     0.72 tokens per second)
llama_print_timings:        eval time =   49566.54 ms /    31 runs   ( 1598.92 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   52503.32 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heirs graduate with honors, securing a prestigious scholarship for postgraduate studies in law

**Summary:**

The graduating class of Heirs High School has achieved exceptional results,
llama_print_timings:        load time =    3768.62 ms
llama_print_timings:      sample time =      41.53 ms /    32 runs   (    1.30 ms per token,   770.53 tokens per second)
llama_print_timings: prompt eval time =    2782.13 ms /     2 tokens ( 1391.06 ms per token,     0.72 tokens per second)
llama_print_timings:        eval time =   49543.62 ms /    31 runs   ( 1598.18 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   52480.97 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar is a travel agency specializing in adventure and luxury travel. So So Soar has a team of travel experts who are passionate about creating unforgettable travel experiences for their
llama_print_timings:        load time =    1184.28 ms
...
llama_print_timings:        eval time =    3152.93 ms /    31 runs   (  101.71 ms per token,     9.83 tokens per second)
llama_print_timings:       total time =    3361.51 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekoul, a renowned astrologer and spiritual guide, passed away on January 15, 2023. She was 87.
...
llama_print_timings:        eval time =    3160.47 ms /    31 runs   (  101.95 ms per token,     9.81 tokens per second)
llama_print_timings:       total time =    3368.45 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When, Where, Who, Why

This is a mnemonic device for remembering the acronym WHO.

**When:**
- Who is the person or entity involved?
llama_print_timings:        load time =    1178.41 ms
llama_print_timings:      sample time =       8.05 ms /    32 runs   (    0.25 ms per token,  3976.64 tokens per second)
llama_print_timings: prompt eval time =     167.24 ms /     2 tokens (   83.62 ms per token,    11.96 tokens per second)
llama_print_timings:        eval time =    3155.74 ms /    31 runs   (  101.80 ms per token,     9.82 tokens per second)
llama_print_timings:       total time =    3363.88 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26653.95 ms
main:    total time = 26653.95 ms
+ echo PASS
PASS
+ echo
...
<bos> Soar is a virtual reality travel company that offers immersive travel experiences.

**a. Explain the concept of VR travel.**

VR travel is a form of experiential
llama_print_timings:        load time =     783.11 ms
llama_print_timings:      sample time =       7.98 ms /    32 runs   (    0.25 ms per token,  4012.54 tokens per second)
llama_print_timings: prompt eval time =     158.43 ms /     2 tokens (   79.22 ms per token,    12.62 tokens per second)
llama_print_timings:        eval time =    2970.07 ms /    31 runs   (   95.81 ms per token,    10.44 tokens per second)
llama_print_timings:       total time =    3168.93 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26862.15 ms
main:    total time = 26862.15 ms
+ echo PASS
PASS
+ echo
...
<bos> The Black Company, an infamous pirate group, has a reputation for brutality and cunning. The crew is led by the enigmatic Captain Bloodbeard, a notorious pirate with a
llama_print_timings:        load time =     730.89 ms
llama_print_timings:      sample time =       7.67 ms /    32 runs   (    0.24 ms per token,  4171.56 tokens per second)
llama_print_timings: prompt eval time =     157.39 ms /     2 tokens (   78.70 ms per token,    12.71 tokens per second)
llama_print_timings:        eval time =    2936.92 ms /    31 runs   (   94.74 ms per token,    10.56 tokens per second)
llama_print_timings:       total time =    3134.12 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    2993.59 ms
llama_print_timings:      sample time =       2.73 ms /    64 runs   (    0.04 ms per token, 23400.37 tokens per second)
llama_print_timings: prompt eval time =    1146.52 ms /     8 tokens (  143.31 ms per token,     6.98 tokens per second)
llama_print_timings:        eval time =   14319.46 ms /    63 runs   (  227.29 ms per token,     4.40 tokens per second)
llama_print_timings:       total time =   15479.92 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22128.18 ms /   128 tokens (  172.88 ms per token,     5.78 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22141.78 ms /   129 tokens
...
llama_print_timings:        load time =    1679.82 ms
llama_print_timings:      sample time =       2.65 ms /    64 runs   (    0.04 ms per token, 24123.63 tokens per second)
llama_print_timings: prompt eval time =     907.82 ms /     8 tokens (  113.48 ms per token,     8.81 tokens per second)
llama_print_timings:        eval time =    8605.23 ms /    63 runs   (  136.59 ms per token,     7.32 tokens per second)
llama_print_timings:       total time =    9527.66 ms /    71 tokens
Log end
...
[1]4.2505,
llama_print_timings:        load time =    1660.80 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14546.08 ms /   128 tokens (  113.64 ms per token,     8.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14560.24 ms /   129 tokens
...
llama_print_timings: prompt eval time =     934.00 ms /     8 tokens (  116.75 ms per token,     8.57 tokens per second)
llama_print_timings:        eval time =    8104.64 ms /    63 runs   (  128.65 ms per token,     7.77 tokens per second)
llama_print_timings:       total time =    9052.29 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15144.72 ms /   128 tokens (  118.32 ms per token,     8.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15157.70 ms /   129 tokens
...
llama_print_timings:        load time =    1144.40 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23988.01 tokens per second)
llama_print_timings: prompt eval time =     986.30 ms /     8 tokens (  123.29 ms per token,     8.11 tokens per second)
llama_print_timings:        eval time =    8594.33 ms /    63 runs   (  136.42 ms per token,     7.33 tokens per second)
llama_print_timings:       total time =    9594.36 ms /    71 tokens
Log end
...
[1]4.3892,
llama_print_timings:        load time =    1068.26 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   16085.06 ms /   128 tokens (  125.66 ms per token,     7.96 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   16098.07 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1235.74 ms /     8 tokens (  154.47 ms per token,     6.47 tokens per second)
llama_print_timings:        eval time =   10703.23 ms /    63 runs   (  169.89 ms per token,     5.89 tokens per second)
llama_print_timings:       total time =   11953.40 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20016.58 ms /   128 tokens (  156.38 ms per token,     6.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20030.87 ms /   129 tokens
...
I believe
llama_print_timings:        load time =    1378.17 ms
llama_print_timings:      sample time =       2.72 ms /    64 runs   (    0.04 ms per token, 23546.73 tokens per second)
llama_print_timings: prompt eval time =    1254.70 ms /     8 tokens (  156.84 ms per token,     6.38 tokens per second)
llama_print_timings:        eval time =   11254.83 ms /    63 runs   (  178.65 ms per token,     5.60 tokens per second)
llama_print_timings:       total time =   12524.13 ms /    71 tokens
Log end
...
[1]4.2508,
llama_print_timings:        load time =    1289.91 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20285.43 ms /   128 tokens (  158.48 ms per token,     6.31 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20299.19 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1170.62 ms /     8 tokens (  146.33 ms per token,     6.83 tokens per second)
llama_print_timings:        eval time =    9993.42 ms /    63 runs   (  158.63 ms per token,     6.30 tokens per second)
llama_print_timings:       total time =   11177.35 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18952.75 ms /   128 tokens (  148.07 ms per token,     6.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18966.69 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1104.52 ms /     8 tokens (  138.06 ms per token,     7.24 tokens per second)
llama_print_timings:        eval time =    9528.14 ms /    63 runs   (  151.24 ms per token,     6.61 tokens per second)
llama_print_timings:       total time =   10647.25 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17978.71 ms /   128 tokens (  140.46 ms per token,     7.12 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17992.39 ms /   129 tokens
...
llama_print_timings:        load time =    1082.81 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23961.06 tokens per second)
llama_print_timings: prompt eval time =     979.06 ms /     8 tokens (  122.38 ms per token,     8.17 tokens per second)
llama_print_timings:        eval time =    8545.84 ms /    63 runs   (  135.65 ms per token,     7.37 tokens per second)
llama_print_timings:       total time =    9538.17 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15858.24 ms /   128 tokens (  123.89 ms per token,     8.07 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15871.60 ms /   129 tokens
...
llama_print_timings:        load time =    1447.49 ms
llama_print_timings:      sample time =       3.00 ms /    64 runs   (    0.05 ms per token, 21354.69 tokens per second)
llama_print_timings: prompt eval time =    1335.90 ms /     8 tokens (  166.99 ms per token,     5.99 tokens per second)
llama_print_timings:        eval time =   11365.00 ms /    63 runs   (  180.40 ms per token,     5.54 tokens per second)
llama_print_timings:       total time =   12715.11 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21686.37 ms /   128 tokens (  169.42 ms per token,     5.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21699.83 ms /   129 tokens
...
I
llama_print_timings:        load time =    1522.81 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23988.01 tokens per second)
llama_print_timings: prompt eval time =    1370.38 ms /     8 tokens (  171.30 ms per token,     5.84 tokens per second)
llama_print_timings:        eval time =   11687.38 ms /    63 runs   (  185.51 ms per token,     5.39 tokens per second)
llama_print_timings:       total time =   13071.90 ms /    71 tokens
Log end
...
[1]4.2538,
llama_print_timings:        load time =    1407.49 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22213.11 ms /   128 tokens (  173.54 ms per token,     5.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22227.09 ms /   129 tokens
...
This poorly formed sentence is chatty, not
...
first run: The quick brown fox jumped over the juicy granny.
The quick brown fox jumped over the


second run: The quick brown fox jumped over the juicy granny.
The quick brown fox jumped over the


single seq run: The quick brown fox jumped over the juicy granny.
The quick brown fox jumped over the
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22169.44 ms /   128 tokens (  173.20 ms per token,     5.77 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22236.29 ms /   129 tokens
...
[1]7.0171,
llama_print_timings:        load time =    7011.80 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22440.79 ms /   128 tokens (  175.32 ms per token,     5.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22507.50 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 67.631 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.56 seconds per pass - ETA 0.23 minutes
[1]9.1403,
llama_print_timings:        load time =    1645.58 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14554.20 ms /   128 tokens (  113.70 ms per token,     8.79 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14625.68 ms /   129 tokens
...
perplexity: 14.55 seconds per pass - ETA 0.23 minutes
[1]6.9493,
llama_print_timings:        load time =    5468.14 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14549.54 ms /   128 tokens (  113.67 ms per token,     8.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14615.28 ms /   129 tokens
...
perplexity: 14.55 seconds per pass - ETA 0.23 minutes
[1]7.0116,
llama_print_timings:        load time =    6115.47 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14552.54 ms /   128 tokens (  113.69 ms per token,     8.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14618.47 ms /   129 tokens
...
0.36user 2.97system 0:03.33elapsed 100%CPU (0avgtext+0avgdata 6878008maxresident)k
...
0.11user 2.82system 0:02.94elapsed 100%CPU (0avgtext+0avgdata 6877360maxresident)k
