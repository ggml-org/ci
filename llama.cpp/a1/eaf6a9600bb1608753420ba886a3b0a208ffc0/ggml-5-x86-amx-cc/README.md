...
- status:  SUCCESS ✅
- runtime: 4:02.76
- date:    Wed Nov  6 08:28:50 UTC 2024
...
0.00.000.570 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.718 I llama_model_loader: - type  f16:   73 tensors
...
0.00.021.165 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.166 I llm_load_print_meta: arch             = bert
0.00.021.166 I llm_load_print_meta: vocab type       = WPM
...
0.00.021.167 I llm_load_print_meta: n_ctx_train      = 512
...
0.00.021.178 I llm_load_print_meta: n_head_kv        = 12
0.00.021.178 I llm_load_print_meta: n_rot            = 32
0.00.021.178 I llm_load_print_meta: n_swa            = 0
0.00.021.178 I llm_load_print_meta: n_embd_head_k    = 32
0.00.021.178 I llm_load_print_meta: n_embd_head_v    = 32
0.00.021.179 I llm_load_print_meta: n_gqa            = 1
0.00.021.180 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.181 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.021.182 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.021.182 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.183 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.183 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.183 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.184 I llm_load_print_meta: n_ff             = 1536
0.00.021.184 I llm_load_print_meta: n_expert         = 0
0.00.021.184 I llm_load_print_meta: n_expert_used    = 0
0.00.021.184 I llm_load_print_meta: causal attn      = 0
0.00.021.184 I llm_load_print_meta: pooling type     = 2
0.00.021.185 I llm_load_print_meta: rope type        = 2
0.00.021.185 I llm_load_print_meta: rope scaling     = linear
0.00.021.186 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.186 I llm_load_print_meta: freq_scale_train = 1
0.00.021.186 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.187 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.187 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.187 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.187 I llm_load_print_meta: ssm_d_state      = 0
...
0.00.021.193 I llm_load_print_meta: general.name     = Bge Small
0.00.021.193 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.194 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.194 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.195 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.195 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.195 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.195 I llm_load_print_meta: max token length = 21
0.00.025.362 I llm_load_tensors: CPU_Mapped model buffer size =    63.84 MiB
0.00.025.381 I llm_load_tensors:        AMX model buffer size =    40.50 MiB
................................................
0.00.038.407 I llama_new_context_with_model: n_seq_max     = 1
0.00.038.423 I llama_new_context_with_model: n_ctx         = 512
0.00.038.423 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.038.424 I llama_new_context_with_model: n_batch       = 2048
0.00.038.424 I llama_new_context_with_model: n_ubatch      = 2048
0.00.038.424 I llama_new_context_with_model: flash_attn    = 0
0.00.038.426 I llama_new_context_with_model: freq_base     = 10000.0
0.00.038.426 I llama_new_context_with_model: freq_scale    = 1
0.00.040.982 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.041.008 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.041.014 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.043.306 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.043.325 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.043.325 I llama_new_context_with_model: graph nodes  = 429
0.00.043.326 I llama_new_context_with_model: graph splits = 145
0.00.043.328 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.047.291 I 
0.00.047.385 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.049.154 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.053.991 I llama_perf_context_print:        load time =      46.54 ms
0.00.053.993 I llama_perf_context_print: prompt eval time =       4.54 ms /     9 tokens (    0.50 ms per token,  1980.63 tokens per second)
0.00.053.994 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.053.995 I llama_perf_context_print:       total time =       6.70 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.582 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.894 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.003.895 I llama_model_loader: - kv   2:                               general.name str              = Bge Small
0.00.003.895 I llama_model_loader: - kv   3:                           general.basename str              = bge
...
0.00.003.900 I llama_model_loader: - kv   6:                        bert.context_length u32              = 512
...
0.00.021.546 I llm_load_print_meta: arch             = bert
0.00.021.547 I llm_load_print_meta: vocab type       = WPM
0.00.021.548 I llm_load_print_meta: n_vocab          = 30522
0.00.021.548 I llm_load_print_meta: n_merges         = 0
0.00.021.548 I llm_load_print_meta: vocab_only       = 0
0.00.021.549 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.549 I llm_load_print_meta: n_embd           = 384
0.00.021.549 I llm_load_print_meta: n_layer          = 12
0.00.021.557 I llm_load_print_meta: n_head           = 12
0.00.021.558 I llm_load_print_meta: n_head_kv        = 12
...
0.00.021.559 I llm_load_print_meta: n_embd_head_v    = 32
0.00.021.560 I llm_load_print_meta: n_gqa            = 1
0.00.021.561 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.561 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.021.563 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.021.564 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.565 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.566 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.021.573 I llm_load_print_meta: freq_scale_train = 1
0.00.021.574 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.574 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.575 I llm_load_print_meta: ssm_d_conv       = 0
...
0.00.021.576 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.576 I llm_load_print_meta: model type       = 33M
0.00.021.578 I llm_load_print_meta: model ftype      = Q8_0
0.00.021.580 I llm_load_print_meta: model params     = 33.21 M
0.00.021.580 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
...
0.00.021.584 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.585 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.585 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.586 I llm_load_print_meta: max token length = 21
...
0.00.028.330 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.028.355 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.028.361 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.030.463 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.030.484 I llama_new_context_with_model: graph nodes  = 429
0.00.030.485 I llama_new_context_with_model: graph splits = 1
0.00.030.487 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.033.163 I 
0.00.033.242 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.035.000 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.037.874 I llama_perf_context_print:        load time =      32.37 ms
0.00.037.876 I llama_perf_context_print: prompt eval time =       2.61 ms /     9 tokens (    0.29 ms per token,  3452.24 tokens per second)
0.00.037.877 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.037.878 I llama_perf_context_print:       total time =       4.71 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.718 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.754 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.008.755 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.756 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.757 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.758 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.760 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.762 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.763 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
...
0.00.008.770 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.772 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.772 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.773 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
...
0.00.019.788 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.810 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.811 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.811 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.812 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
...
0.00.019.813 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.813 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.814 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.814 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.815 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.818 I llama_model_loader: - type  f32:   41 tensors
0.00.019.818 I llama_model_loader: - type  f16:   29 tensors
0.00.037.788 W llm_load_vocab: empty token at index 5
0.00.048.331 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.969 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.062.094 I llm_load_vocab: special tokens cache size = 5
0.00.343.911 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.343.933 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.343.933 I llm_load_print_meta: arch             = jina-bert-v2
0.00.343.934 I llm_load_print_meta: vocab type       = BPE
0.00.343.934 I llm_load_print_meta: n_vocab          = 61056
0.00.343.934 I llm_load_print_meta: n_merges         = 39382
0.00.343.935 I llm_load_print_meta: vocab_only       = 0
0.00.343.935 I llm_load_print_meta: n_ctx_train      = 8192
0.00.343.935 I llm_load_print_meta: n_embd           = 384
0.00.343.936 I llm_load_print_meta: n_layer          = 4
0.00.343.945 I llm_load_print_meta: n_head           = 12
0.00.343.945 I llm_load_print_meta: n_head_kv        = 12
0.00.343.946 I llm_load_print_meta: n_rot            = 32
0.00.343.946 I llm_load_print_meta: n_swa            = 0
0.00.343.946 I llm_load_print_meta: n_embd_head_k    = 32
0.00.343.946 I llm_load_print_meta: n_embd_head_v    = 32
0.00.343.947 I llm_load_print_meta: n_gqa            = 1
0.00.343.948 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.343.949 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.343.950 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.343.951 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.343.951 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.343.952 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.343.952 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.343.953 I llm_load_print_meta: n_ff             = 1536
0.00.343.953 I llm_load_print_meta: n_expert         = 0
0.00.343.953 I llm_load_print_meta: n_expert_used    = 0
0.00.343.954 I llm_load_print_meta: causal attn      = 0
0.00.343.954 I llm_load_print_meta: pooling type     = -1
0.00.343.955 I llm_load_print_meta: rope type        = -1
0.00.343.955 I llm_load_print_meta: rope scaling     = linear
0.00.343.956 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.343.957 I llm_load_print_meta: freq_scale_train = 1
0.00.343.957 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.343.957 I llm_load_print_meta: rope_finetuned   = unknown
0.00.343.958 I llm_load_print_meta: ssm_d_conv       = 0
0.00.343.958 I llm_load_print_meta: ssm_d_inner      = 0
0.00.343.958 I llm_load_print_meta: ssm_d_state      = 0
0.00.343.958 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.343.959 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.343.959 I llm_load_print_meta: model type       = 33M
0.00.343.960 I llm_load_print_meta: model ftype      = F16
0.00.343.961 I llm_load_print_meta: model params     = 32.90 M
0.00.343.961 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.343.962 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.343.962 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.343.963 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.343.963 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.343.963 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.343.964 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.343.964 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.343.964 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.343.964 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.343.965 I llm_load_print_meta: max token length = 45
0.00.347.679 I llm_load_tensors: CPU_Mapped model buffer size =    62.78 MiB
0.00.347.698 I llm_load_tensors:        AMX model buffer size =    18.00 MiB
.....................
0.00.356.259 I llama_new_context_with_model: n_seq_max     = 1
0.00.356.281 I llama_new_context_with_model: n_ctx         = 8192
0.00.356.281 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.356.281 I llama_new_context_with_model: n_batch       = 2048
0.00.356.282 I llama_new_context_with_model: n_ubatch      = 2048
0.00.356.282 I llama_new_context_with_model: flash_attn    = 0
0.00.356.284 I llama_new_context_with_model: freq_base     = 10000.0
0.00.356.285 I llama_new_context_with_model: freq_scale    = 1
0.00.366.111 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.366.137 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.366.143 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.367.510 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.367.534 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.367.534 I llama_new_context_with_model: graph nodes  = 154
0.00.367.535 I llama_new_context_with_model: graph splits = 57
0.00.367.537 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.376.944 I 
0.00.377.088 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.377.345 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.377.357 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.377.363 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.377.364 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.377.369 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.377.369 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.381.394 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.390.354 I llama_perf_context_print:        load time =     376.01 ms
0.00.390.356 I llama_perf_context_print: prompt eval time =       8.73 ms /    62 tokens (    0.14 ms per token,  7105.20 tokens per second)
0.00.390.357 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.390.358 I llama_perf_context_print:       total time =      13.41 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.764 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.065.018 I llm_load_vocab: special tokens cache size = 25
...
0.00.076.510 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.511 I llm_load_print_meta: model params     = 1.41 B
0.00.076.512 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.198.939 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.198.955 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.992.018 I llama_new_context_with_model: n_seq_max     = 1
0.00.992.039 I llama_new_context_with_model: n_ctx         = 2048
0.00.992.040 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.992.040 I llama_new_context_with_model: n_batch       = 2048
0.00.992.040 I llama_new_context_with_model: n_ubatch      = 512
0.00.992.041 I llama_new_context_with_model: flash_attn    = 0
0.00.992.046 I llama_new_context_with_model: freq_base     = 10000.0
0.00.992.047 I llama_new_context_with_model: freq_scale    = 1
0.01.061.581 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.061.606 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.061.637 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.064.654 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.064.680 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.064.681 I llama_new_context_with_model: graph nodes  = 967
0.01.064.681 I llama_new_context_with_model: graph splits = 194
0.01.064.685 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.166.749 I main: llama threadpool init, n_threads = 4
0.01.166.775 I 
0.01.166.861 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.166.876 I 
0.01.167.011 I sampler seed: 1234
0.01.167.018 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.167.021 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.167.021 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.167.021 I 
...
0.04.995.219 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 32025.26 tokens per second)
0.04.995.222 I llama_perf_context_print:        load time =    1165.49 ms
0.04.995.224 I llama_perf_context_print: prompt eval time =      97.39 ms /     7 tokens (   13.91 ms per token,    71.88 tokens per second)
0.04.995.225 I llama_perf_context_print:        eval time =    3719.63 ms /    63 runs   (   59.04 ms per token,    16.94 tokens per second)
0.04.995.225 I llama_perf_context_print:       total time =    3828.48 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.736 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.992 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.993 I llm_load_print_meta: model params     = 1.41 B
0.00.075.994 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.191.068 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.191.085 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.986.453 I llama_new_context_with_model: n_seq_max     = 1
0.00.986.469 I llama_new_context_with_model: n_ctx         = 128
0.00.986.469 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.986.470 I llama_new_context_with_model: n_batch       = 128
0.00.986.470 I llama_new_context_with_model: n_ubatch      = 128
0.00.986.471 I llama_new_context_with_model: flash_attn    = 0
0.00.986.475 I llama_new_context_with_model: freq_base     = 10000.0
0.00.986.476 I llama_new_context_with_model: freq_scale    = 1
0.00.986.477 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.992.037 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.992.064 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.992.085 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.994.653 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.00.994.672 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.00.994.673 I llama_new_context_with_model: graph nodes  = 967
0.00.994.673 I llama_new_context_with_model: graph splits = 194
0.00.994.675 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.059.558 I 
0.01.059.657 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.059.677 I perplexity: tokenizing the input ..
0.01.069.036 I perplexity: tokenization took 9.356 ms
0.01.069.072 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.987.224 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.990.951 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.991.036 I llama_perf_context_print:        load time =    1058.63 ms
0.01.991.038 I llama_perf_context_print: prompt eval time =     916.26 ms /   128 tokens (    7.16 ms per token,   139.70 tokens per second)
0.01.991.039 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.991.040 I llama_perf_context_print:       total time =     931.48 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.685 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.340 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.341 I llm_load_print_meta: model params     = 1.41 B
0.00.076.342 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.166.365 I llm_load_tensors: CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.512 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.535 I llama_new_context_with_model: n_ctx         = 2048
0.00.168.536 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.168.536 I llama_new_context_with_model: n_batch       = 2048
0.00.168.536 I llama_new_context_with_model: n_ubatch      = 512
0.00.168.536 I llama_new_context_with_model: flash_attn    = 0
0.00.168.538 I llama_new_context_with_model: freq_base     = 10000.0
0.00.168.539 I llama_new_context_with_model: freq_scale    = 1
0.00.237.666 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.237.689 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.237.707 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.239.758 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.239.780 I llama_new_context_with_model: graph nodes  = 967
0.00.239.781 I llama_new_context_with_model: graph splits = 1
0.00.239.784 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.340.498 I main: llama threadpool init, n_threads = 4
0.00.340.526 I 
0.00.340.604 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.340.617 I 
0.00.340.725 I sampler seed: 1234
0.00.340.744 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.340.747 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.03.068.517 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31167.69 tokens per second)
0.03.068.520 I llama_perf_context_print:        load time =     339.39 ms
0.03.068.522 I llama_perf_context_print: prompt eval time =      77.31 ms /     7 tokens (   11.04 ms per token,    90.55 tokens per second)
0.03.068.523 I llama_perf_context_print:        eval time =    2639.15 ms /    63 runs   (   41.89 ms per token,    23.87 tokens per second)
0.03.068.524 I llama_perf_context_print:       total time =    2728.03 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.765 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.165.755 I llm_load_tensors: CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.048 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.070 I llama_new_context_with_model: n_ctx         = 128
0.00.168.070 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.168.120 I llama_new_context_with_model: n_batch       = 128
0.00.168.121 I llama_new_context_with_model: n_ubatch      = 128
0.00.168.121 I llama_new_context_with_model: flash_attn    = 0
0.00.168.123 I llama_new_context_with_model: freq_base     = 10000.0
0.00.168.124 I llama_new_context_with_model: freq_scale    = 1
0.00.168.124 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.173.476 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.173.501 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.173.514 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.175.468 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.175.491 I llama_new_context_with_model: graph nodes  = 967
0.00.175.491 I llama_new_context_with_model: graph splits = 1
0.00.175.493 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.241.279 I 
0.00.241.362 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.241.368 I perplexity: tokenizing the input ..
0.00.249.775 I perplexity: tokenization took 8.403 ms
0.00.249.806 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.142.814 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.146.492 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.146.531 I llama_perf_context_print:        load time =     240.34 ms
0.01.146.533 I llama_perf_context_print: prompt eval time =     891.40 ms /   128 tokens (    6.96 ms per token,   143.59 tokens per second)
0.01.146.534 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.146.534 I llama_perf_context_print:       total time =     905.25 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.677 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.420 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.505 I llm_load_tensors: CPU_Mapped model buffer size =   777.31 MiB
0.00.125.521 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.372.890 I llama_new_context_with_model: n_seq_max     = 1
0.00.372.912 I llama_new_context_with_model: n_ctx         = 2048
0.00.372.912 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.372.913 I llama_new_context_with_model: n_batch       = 2048
0.00.372.913 I llama_new_context_with_model: n_ubatch      = 512
0.00.372.914 I llama_new_context_with_model: flash_attn    = 0
0.00.372.918 I llama_new_context_with_model: freq_base     = 10000.0
0.00.372.919 I llama_new_context_with_model: freq_scale    = 1
0.00.442.142 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.442.172 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.442.204 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.445.316 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.445.333 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.445.334 I llama_new_context_with_model: graph nodes  = 967
0.00.445.334 I llama_new_context_with_model: graph splits = 193
0.00.445.338 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.519.998 I main: llama threadpool init, n_threads = 4
0.00.520.027 I 
0.00.520.108 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.520.121 I 
0.00.520.258 I sampler seed: 1234
0.00.520.277 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.520.280 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.520.281 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.520.281 I 
...
0.01.921.668 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32112.17 tokens per second)
0.01.921.671 I llama_perf_context_print:        load time =     518.93 ms
0.01.921.673 I llama_perf_context_print: prompt eval time =      41.29 ms /     7 tokens (    5.90 ms per token,   169.54 tokens per second)
0.01.921.674 I llama_perf_context_print:        eval time =    1348.91 ms /    63 runs   (   21.41 ms per token,    46.70 tokens per second)
0.01.921.675 I llama_perf_context_print:       total time =    1401.68 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.635 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.120 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
...
0.00.075.369 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.370 I llm_load_print_meta: model params     = 1.41 B
0.00.075.371 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.124.635 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.368.982 I llama_new_context_with_model: n_seq_max     = 1
0.00.369.003 I llama_new_context_with_model: n_ctx         = 128
0.00.369.003 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.369.004 I llama_new_context_with_model: n_batch       = 128
0.00.369.004 I llama_new_context_with_model: n_ubatch      = 128
0.00.369.004 I llama_new_context_with_model: flash_attn    = 0
0.00.369.009 I llama_new_context_with_model: freq_base     = 10000.0
0.00.369.010 I llama_new_context_with_model: freq_scale    = 1
0.00.369.011 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.374.644 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.374.673 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.374.697 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.377.764 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.377.783 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.377.784 I llama_new_context_with_model: graph nodes  = 967
0.00.377.784 I llama_new_context_with_model: graph splits = 193
0.00.377.786 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.409.593 I 
0.00.409.700 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.409.721 I perplexity: tokenizing the input ..
0.00.419.107 I perplexity: tokenization took 9.383 ms
0.00.419.143 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.878.204 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.882.011 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.882.092 I llama_perf_context_print:        load time =     408.77 ms
0.00.882.094 I llama_perf_context_print: prompt eval time =     457.20 ms /   128 tokens (    3.57 ms per token,   279.96 tokens per second)
0.00.882.095 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.882.096 I llama_perf_context_print:       total time =     472.50 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.681 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.914 I main: llama backend init
...
0.00.075.765 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.115.490 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.115.508 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.389.297 I llama_new_context_with_model: n_seq_max     = 1
0.00.389.312 I llama_new_context_with_model: n_ctx         = 2048
0.00.389.312 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.389.313 I llama_new_context_with_model: n_batch       = 2048
0.00.389.313 I llama_new_context_with_model: n_ubatch      = 512
0.00.389.314 I llama_new_context_with_model: flash_attn    = 0
0.00.389.320 I llama_new_context_with_model: freq_base     = 10000.0
0.00.389.321 I llama_new_context_with_model: freq_scale    = 1
0.00.458.970 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.459.002 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.459.035 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.461.675 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.461.695 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.461.696 I llama_new_context_with_model: graph nodes  = 967
0.00.461.696 I llama_new_context_with_model: graph splits = 193
0.00.461.700 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.532.716 I main: llama threadpool init, n_threads = 4
0.00.532.745 I 
0.00.532.833 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.532.833 I 
0.00.532.983 I sampler seed: 1234
0.00.533.077 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.533.080 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.533.080 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.533.081 I 
...
0.02.064.316 I llama_perf_sampler_print:    sampling time =       2.17 ms /    71 runs   (    0.03 ms per token, 32673.72 tokens per second)
0.02.064.319 I llama_perf_context_print:        load time =     531.55 ms
0.02.064.320 I llama_perf_context_print: prompt eval time =      39.08 ms /     7 tokens (    5.58 ms per token,   179.13 tokens per second)
0.02.064.321 I llama_perf_context_print:        eval time =    1481.37 ms /    63 runs   (   23.51 ms per token,    42.53 tokens per second)
0.02.064.322 I llama_perf_context_print:       total time =    1531.61 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.680 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.557 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.020.560 I llama_model_loader: - type  f32:  194 tensors
0.00.020.560 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.074.104 I llm_load_print_meta: n_swa            = 0
...
0.00.074.109 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.074.109 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.074.110 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.074.110 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.074.112 I llm_load_print_meta: n_expert_used    = 0
0.00.074.112 I llm_load_print_meta: causal attn      = 1
0.00.074.112 I llm_load_print_meta: pooling type     = 0
0.00.074.112 I llm_load_print_meta: rope type        = 2
0.00.074.113 I llm_load_print_meta: rope scaling     = linear
0.00.074.114 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.074.115 I llm_load_print_meta: freq_scale_train = 1
...
0.00.074.118 I llm_load_print_meta: model ftype      = Q4_1
0.00.074.119 I llm_load_print_meta: model params     = 1.41 B
0.00.074.120 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
0.00.074.120 I llm_load_print_meta: general.name     = 1.4B
0.00.074.121 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.074.121 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.074.121 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.074.121 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.074.122 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.074.122 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.123 I llm_load_print_meta: max token length = 1024
0.00.113.978 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.113.993 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.385.299 I llama_new_context_with_model: n_seq_max     = 1
0.00.385.320 I llama_new_context_with_model: n_ctx         = 128
0.00.385.321 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.385.321 I llama_new_context_with_model: n_batch       = 128
0.00.385.322 I llama_new_context_with_model: n_ubatch      = 128
0.00.385.322 I llama_new_context_with_model: flash_attn    = 0
0.00.385.327 I llama_new_context_with_model: freq_base     = 10000.0
0.00.385.328 I llama_new_context_with_model: freq_scale    = 1
0.00.385.329 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.390.938 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.390.965 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.390.988 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.393.395 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.393.415 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.393.416 I llama_new_context_with_model: graph nodes  = 967
0.00.393.416 I llama_new_context_with_model: graph splits = 193
0.00.393.418 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.424.590 I 
0.00.424.705 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.424.712 I perplexity: tokenizing the input ..
0.00.434.107 I perplexity: tokenization took 9.392 ms
0.00.434.137 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.912.859 I perplexity: 0.48 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.916.473 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.916.554 I llama_perf_context_print:        load time =     423.73 ms
0.00.916.555 I llama_perf_context_print: prompt eval time =     476.88 ms /   128 tokens (    3.73 ms per token,   268.41 tokens per second)
0.00.916.556 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.916.557 I llama_perf_context_print:       total time =     491.96 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.662 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.654 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.655 I llm_load_print_meta: model params     = 1.41 B
0.00.075.655 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.120.098 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.122.329 I llama_new_context_with_model: n_seq_max     = 1
0.00.122.351 I llama_new_context_with_model: n_ctx         = 2048
0.00.122.351 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.122.351 I llama_new_context_with_model: n_batch       = 2048
...
0.00.122.354 I llama_new_context_with_model: freq_scale    = 1
0.00.190.893 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.190.916 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.190.934 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.192.976 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.192.998 I llama_new_context_with_model: graph nodes  = 967
0.00.192.998 I llama_new_context_with_model: graph splits = 1
0.00.193.003 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.277.332 I main: llama threadpool init, n_threads = 4
0.00.277.358 I 
0.00.277.431 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.277.444 I 
0.00.277.536 I sampler seed: 1234
0.00.277.554 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.277.557 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.277.558 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.277.558 I 
...
0.02.496.537 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32155.80 tokens per second)
0.02.496.540 I llama_perf_context_print:        load time =     276.23 ms
0.02.496.541 I llama_perf_context_print: prompt eval time =      75.44 ms /     7 tokens (   10.78 ms per token,    92.79 tokens per second)
0.02.496.542 I llama_perf_context_print:        eval time =    2132.11 ms /    63 runs   (   33.84 ms per token,    29.55 tokens per second)
0.02.496.543 I llama_perf_context_print:       total time =    2219.21 ms /    70 tokens
...
0.00.021.256 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
...
0.00.120.196 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.122.381 I llama_new_context_with_model: n_seq_max     = 1
0.00.122.402 I llama_new_context_with_model: n_ctx         = 128
0.00.122.402 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.122.402 I llama_new_context_with_model: n_batch       = 128
0.00.122.403 I llama_new_context_with_model: n_ubatch      = 128
0.00.122.403 I llama_new_context_with_model: flash_attn    = 0
0.00.122.405 I llama_new_context_with_model: freq_base     = 10000.0
0.00.122.405 I llama_new_context_with_model: freq_scale    = 1
0.00.122.406 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.127.708 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.127.734 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.127.747 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.129.697 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.129.713 I llama_new_context_with_model: graph nodes  = 967
0.00.129.713 I llama_new_context_with_model: graph splits = 1
0.00.129.715 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.202.874 I 
0.00.202.965 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.202.971 I perplexity: tokenizing the input ..
0.00.211.253 I perplexity: tokenization took 8.278 ms
0.00.211.283 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.340.629 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.344.302 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.344.342 I llama_perf_context_print:        load time =     202.01 ms
0.01.344.345 I llama_perf_context_print: prompt eval time =    1127.75 ms /   128 tokens (    8.81 ms per token,   113.50 tokens per second)
0.01.344.346 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.344.347 I llama_perf_context_print:       total time =    1141.47 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.664 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.137 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
...
0.00.075.548 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.122.901 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
...
0.00.124.986 I llama_new_context_with_model: n_batch       = 2048
...
0.00.195.099 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.129 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.146 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.159 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.182 I llama_new_context_with_model: graph nodes  = 967
0.00.197.182 I llama_new_context_with_model: graph splits = 1
0.00.197.187 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.882 I main: llama threadpool init, n_threads = 4
0.00.290.910 I 
0.00.290.991 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.291.003 I 
0.00.291.120 I sampler seed: 1234
0.00.291.140 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.291.144 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.291.144 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.291.144 I 
...
0.02.679.305 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32184.95 tokens per second)
0.02.679.309 I llama_perf_context_print:        load time =     289.79 ms
0.02.679.310 I llama_perf_context_print: prompt eval time =     125.03 ms /     7 tokens (   17.86 ms per token,    55.98 tokens per second)
0.02.679.312 I llama_perf_context_print:        eval time =    2252.03 ms /    63 runs   (   35.75 ms per token,    27.97 tokens per second)
0.02.679.313 I llama_perf_context_print:       total time =    2388.43 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.767 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.583 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.584 I llm_load_print_meta: model params     = 1.41 B
0.00.075.585 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.123.722 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.125.920 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.941 I llama_new_context_with_model: n_ctx         = 128
0.00.125.941 I llama_new_context_with_model: n_ctx_per_seq = 128
...
0.00.125.945 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.131.368 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.131.395 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.131.408 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.400 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.418 I llama_new_context_with_model: graph nodes  = 967
0.00.133.418 I llama_new_context_with_model: graph splits = 1
0.00.133.420 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.189.972 I 
0.00.190.064 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.190.071 I perplexity: tokenizing the input ..
0.00.198.778 I perplexity: tokenization took 8.705 ms
0.00.198.812 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.138.775 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.142.754 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.142.793 I llama_perf_context_print:        load time =     189.02 ms
0.02.142.795 I llama_perf_context_print: prompt eval time =    1938.13 ms /   128 tokens (   15.14 ms per token,    66.04 tokens per second)
0.02.142.796 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.142.797 I llama_perf_context_print:       total time =    1952.82 ms /   129 tokens
...
0.00.009.983 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.021.879 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.075.681 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.682 I llm_load_print_meta: model params     = 1.41 B
0.00.075.683 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.104.678 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.106.895 I llama_new_context_with_model: n_seq_max     = 1
0.00.106.918 I llama_new_context_with_model: n_ctx         = 2048
0.00.106.918 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.106.918 I llama_new_context_with_model: n_batch       = 2048
0.00.106.919 I llama_new_context_with_model: n_ubatch      = 512
0.00.106.919 I llama_new_context_with_model: flash_attn    = 0
0.00.106.921 I llama_new_context_with_model: freq_base     = 10000.0
0.00.106.922 I llama_new_context_with_model: freq_scale    = 1
0.00.177.481 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.177.503 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.177.523 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.180.120 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.180.142 I llama_new_context_with_model: graph nodes  = 967
0.00.180.142 I llama_new_context_with_model: graph splits = 1
0.00.180.146 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.259.100 I main: llama threadpool init, n_threads = 4
0.00.259.128 I 
0.00.259.220 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.259.234 I 
0.00.259.338 I sampler seed: 1234
0.00.259.357 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.259.359 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.259.360 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.259.360 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.717.334 I llama_perf_sampler_print:    sampling time =       2.18 ms /    71 runs   (    0.03 ms per token, 32643.68 tokens per second)
0.01.717.337 I llama_perf_context_print:        load time =     257.93 ms
0.01.717.339 I llama_perf_context_print: prompt eval time =      76.77 ms /     7 tokens (   10.97 ms per token,    91.19 tokens per second)
0.01.717.341 I llama_perf_context_print:        eval time =    1370.50 ms /    63 runs   (   21.75 ms per token,    45.97 tokens per second)
0.01.717.342 I llama_perf_context_print:       total time =    1458.24 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.724 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.105.435 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.107.534 I llama_new_context_with_model: n_seq_max     = 1
0.00.107.555 I llama_new_context_with_model: n_ctx         = 128
0.00.107.556 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.107.556 I llama_new_context_with_model: n_batch       = 128
0.00.107.556 I llama_new_context_with_model: n_ubatch      = 128
0.00.107.557 I llama_new_context_with_model: flash_attn    = 0
0.00.107.558 I llama_new_context_with_model: freq_base     = 10000.0
0.00.107.559 I llama_new_context_with_model: freq_scale    = 1
0.00.107.560 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.113.058 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.113.085 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.113.101 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.115.161 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.115.185 I llama_new_context_with_model: graph nodes  = 967
0.00.115.186 I llama_new_context_with_model: graph splits = 1
0.00.115.188 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.154.311 I 
0.00.154.415 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.154.421 I perplexity: tokenizing the input ..
0.00.162.888 I perplexity: tokenization took 8.464 ms
0.00.162.921 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.461.580 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.465.241 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.465.281 I llama_perf_context_print:        load time =     153.42 ms
0.01.465.282 I llama_perf_context_print: prompt eval time =    1296.94 ms /   128 tokens (   10.13 ms per token,    98.69 tokens per second)
0.01.465.285 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.465.286 I llama_perf_context_print:       total time =    1310.97 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.749 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.520 I llm_load_print_meta: model ftype      = Q3_K - Medium
...
0.00.113.691 I llm_load_tensors: CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
...
0.00.184.160 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.184.188 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.184.207 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.186.416 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.186.437 I llama_new_context_with_model: graph nodes  = 967
0.00.186.438 I llama_new_context_with_model: graph splits = 1
0.00.186.441 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.265.496 I main: llama threadpool init, n_threads = 4
0.00.265.523 I 
0.00.265.608 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.265.609 I 
0.00.265.725 I sampler seed: 1234
0.00.265.744 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.265.748 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.265.749 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.265.749 I 
...
0.02.025.840 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32199.55 tokens per second)
0.02.025.843 I llama_perf_context_print:        load time =     264.27 ms
0.02.025.844 I llama_perf_context_print: prompt eval time =      87.43 ms /     7 tokens (   12.49 ms per token,    80.07 tokens per second)
0.02.025.846 I llama_perf_context_print:        eval time =    1661.61 ms /    63 runs   (   26.37 ms per token,    37.92 tokens per second)
0.02.025.846 I llama_perf_context_print:       total time =    1760.35 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.726 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.001 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.021.004 I llama_model_loader: - type  f32:  194 tensors
0.00.021.004 I llama_model_loader: - type q3_K:   25 tensors
0.00.021.005 I llama_model_loader: - type q4_K:   71 tensors
0.00.021.005 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.075.512 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.513 I llm_load_print_meta: model params     = 1.41 B
0.00.075.514 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.112.131 I llm_load_tensors: CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.114.328 I llama_new_context_with_model: n_seq_max     = 1
0.00.114.350 I llama_new_context_with_model: n_ctx         = 128
0.00.114.351 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.114.351 I llama_new_context_with_model: n_batch       = 128
0.00.114.351 I llama_new_context_with_model: n_ubatch      = 128
0.00.114.352 I llama_new_context_with_model: flash_attn    = 0
0.00.114.353 I llama_new_context_with_model: freq_base     = 10000.0
0.00.114.354 I llama_new_context_with_model: freq_scale    = 1
0.00.114.355 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.119.379 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.119.405 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.119.421 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.121.470 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.121.486 I llama_new_context_with_model: graph nodes  = 967
0.00.121.487 I llama_new_context_with_model: graph splits = 1
0.00.121.488 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.167.215 I 
0.00.167.311 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.167.318 I perplexity: tokenizing the input ..
0.00.175.924 I perplexity: tokenization took 8.602 ms
0.00.175.956 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.513.620 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.517.464 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.517.504 I llama_perf_context_print:        load time =     166.31 ms
0.01.517.517 I llama_perf_context_print: prompt eval time =    1336.15 ms /   128 tokens (   10.44 ms per token,    95.80 tokens per second)
0.01.517.519 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.517.519 I llama_perf_context_print:       total time =    1350.29 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.667 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.118.933 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.121.079 I llama_new_context_with_model: n_seq_max     = 1
0.00.121.100 I llama_new_context_with_model: n_ctx         = 2048
0.00.121.100 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.121.100 I llama_new_context_with_model: n_batch       = 2048
0.00.121.101 I llama_new_context_with_model: n_ubatch      = 512
0.00.121.101 I llama_new_context_with_model: flash_attn    = 0
0.00.121.103 I llama_new_context_with_model: freq_base     = 10000.0
0.00.121.103 I llama_new_context_with_model: freq_scale    = 1
0.00.189.765 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.189.790 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
...
0.00.191.938 I llama_new_context_with_model: graph nodes  = 967
0.00.191.938 I llama_new_context_with_model: graph splits = 1
0.00.191.942 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.276.608 I main: llama threadpool init, n_threads = 4
0.00.276.635 I 
0.00.276.712 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.276.726 I 
0.00.276.857 I sampler seed: 1234
0.00.276.875 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.276.878 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.276.879 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.276.879 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.273.701 I llama_perf_sampler_print:    sampling time =       2.35 ms /    71 runs   (    0.03 ms per token, 30277.19 tokens per second)
0.02.273.704 I llama_perf_context_print:        load time =     275.47 ms
0.02.273.706 I llama_perf_context_print: prompt eval time =      90.07 ms /     7 tokens (   12.87 ms per token,    77.72 tokens per second)
0.02.273.708 I llama_perf_context_print:        eval time =    1895.74 ms /    63 runs   (   30.09 ms per token,    33.23 tokens per second)
0.02.273.709 I llama_perf_context_print:       total time =    1997.10 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.692 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.478 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf (version GGUF V3 (latest))
...
0.00.021.144 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
...
0.00.076.518 I llm_load_print_meta: n_head           = 16
...
0.00.121.099 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.123.327 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.349 I llama_new_context_with_model: n_ctx         = 128
0.00.123.349 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.123.349 I llama_new_context_with_model: n_batch       = 128
0.00.123.349 I llama_new_context_with_model: n_ubatch      = 128
0.00.123.350 I llama_new_context_with_model: flash_attn    = 0
0.00.123.351 I llama_new_context_with_model: freq_base     = 10000.0
0.00.123.352 I llama_new_context_with_model: freq_scale    = 1
0.00.123.353 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.128.891 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.128.918 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.128.935 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.131.441 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.131.460 I llama_new_context_with_model: graph nodes  = 967
0.00.131.460 I llama_new_context_with_model: graph splits = 1
0.00.131.463 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.180.430 I 
0.00.180.535 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.180.543 I perplexity: tokenizing the input ..
0.00.189.357 I perplexity: tokenization took 8.811 ms
0.00.189.392 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.590.470 I perplexity: 1.40 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.594.078 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.594.120 I llama_perf_context_print:        load time =     179.54 ms
0.01.594.134 I llama_perf_context_print: prompt eval time =    1399.28 ms /   128 tokens (   10.93 ms per token,    91.48 tokens per second)
0.01.594.135 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.594.136 I llama_perf_context_print:       total time =    1413.69 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.670 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.604 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
0.00.021.607 I llama_model_loader: - type  f32:  194 tensors
0.00.021.607 I llama_model_loader: - type q5_K:   61 tensors
0.00.021.608 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.075.743 I llm_load_print_meta: model ftype      = Q5_K - Medium
...
0.00.123.000 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.125.162 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.182 I llama_new_context_with_model: n_ctx         = 2048
0.00.125.182 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.193.675 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.193.693 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.196.258 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.196.279 I llama_new_context_with_model: graph nodes  = 967
0.00.196.280 I llama_new_context_with_model: graph splits = 1
0.00.196.284 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.284.823 I main: llama threadpool init, n_threads = 4
0.00.284.849 I 
0.00.284.931 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.284.943 I 
0.00.285.052 I sampler seed: 1234
0.00.285.071 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.285.074 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.285.075 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.285.075 I 
...
0.02.531.309 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31140.35 tokens per second)
0.02.531.313 I llama_perf_context_print:        load time =     283.72 ms
0.02.531.314 I llama_perf_context_print: prompt eval time =     110.92 ms /     7 tokens (   15.85 ms per token,    63.11 tokens per second)
0.02.531.316 I llama_perf_context_print:        eval time =    2124.10 ms /    63 runs   (   33.72 ms per token,    29.66 tokens per second)
0.02.531.317 I llama_perf_context_print:       total time =    2246.49 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.653 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.594 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.595 I llm_load_print_meta: model params     = 1.41 B
0.00.075.596 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.123.599 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.125.738 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.760 I llama_new_context_with_model: n_ctx         = 128
0.00.125.760 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.125.761 I llama_new_context_with_model: n_batch       = 128
0.00.125.761 I llama_new_context_with_model: n_ubatch      = 128
0.00.125.761 I llama_new_context_with_model: flash_attn    = 0
0.00.125.763 I llama_new_context_with_model: freq_base     = 10000.0
0.00.125.764 I llama_new_context_with_model: freq_scale    = 1
0.00.125.764 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.131.212 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.131.238 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.131.252 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.640 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.662 I llama_new_context_with_model: graph nodes  = 967
0.00.133.662 I llama_new_context_with_model: graph splits = 1
0.00.133.665 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.184.204 I 
0.00.184.311 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.184.330 I perplexity: tokenizing the input ..
0.00.192.977 I perplexity: tokenization took 8.644 ms
0.00.193.012 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.880.562 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.884.443 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.884.484 I llama_perf_context_print:        load time =     183.37 ms
0.01.884.487 I llama_perf_context_print: prompt eval time =    1685.77 ms /   128 tokens (   13.17 ms per token,    75.93 tokens per second)
0.01.884.489 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.884.489 I llama_perf_context_print:       total time =    1700.28 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.661 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.220 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
0.00.021.223 I llama_model_loader: - type  f32:  194 tensors
0.00.021.224 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.126.163 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.128.304 I llama_new_context_with_model: n_seq_max     = 1
0.00.128.326 I llama_new_context_with_model: n_ctx         = 2048
0.00.128.326 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.198.217 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.198.237 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.200.288 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.200.311 I llama_new_context_with_model: graph nodes  = 967
0.00.200.312 I llama_new_context_with_model: graph splits = 1
0.00.200.316 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.287.092 I main: llama threadpool init, n_threads = 4
0.00.287.121 I 
0.00.287.212 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.287.225 I 
0.00.287.353 I sampler seed: 1234
0.00.287.373 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.287.376 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.287.376 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.287.376 I 
...
0.02.638.590 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32494.28 tokens per second)
0.02.638.592 I llama_perf_context_print:        load time =     286.02 ms
0.02.638.594 I llama_perf_context_print: prompt eval time =     106.50 ms /     7 tokens (   15.21 ms per token,    65.73 tokens per second)
0.02.638.595 I llama_perf_context_print:        eval time =    2233.52 ms /    63 runs   (   35.45 ms per token,    28.21 tokens per second)
0.02.638.595 I llama_perf_context_print:       total time =    2351.51 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.695 I build: 4035 (a1eaf6a9) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.287 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.288 I llm_load_print_meta: model params     = 1.41 B
0.00.076.288 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.127.955 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.130.219 I llama_new_context_with_model: n_seq_max     = 1
0.00.130.241 I llama_new_context_with_model: n_ctx         = 128
0.00.130.241 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.130.241 I llama_new_context_with_model: n_batch       = 128
0.00.130.242 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.130.245 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
...
0.00.135.889 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.138.468 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.138.488 I llama_new_context_with_model: graph nodes  = 967
0.00.138.488 I llama_new_context_with_model: graph splits = 1
0.00.138.490 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.193.904 I 
0.00.194.021 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.194.054 I perplexity: tokenizing the input ..
0.00.203.041 I perplexity: tokenization took 8.983 ms
0.00.203.074 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.853.248 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.857.007 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.857.053 I llama_perf_context_print:        load time =     193.00 ms
0.01.857.079 I llama_perf_context_print: prompt eval time =    1648.39 ms /   128 tokens (   12.88 ms per token,    77.65 tokens per second)
0.01.857.080 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.857.081 I llama_perf_context_print:       total time =    1663.15 ms /   129 tokens
...
0.00.446.670 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.441.266 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.63user 0.61system 0:01.24elapsed 100%CPU (0avgtext+0avgdata 5358560maxresident)k
