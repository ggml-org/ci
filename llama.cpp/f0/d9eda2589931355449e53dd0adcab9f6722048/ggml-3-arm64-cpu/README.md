...
- status:  FAILURE ❌ (1)
- runtime: 4:03.38
- date:    Wed May 22 16:16:35 UTC 2024
...
Total Test time (real) =  33.08 sec
...
llama_print_timings:        load time =      14.28 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       8.02 ms /     9 tokens (    0.89 ms per token,  1122.89 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       6.21 ms /     9 tokens (    0.69 ms per token,  1450.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =       7.59 ms /    10 tokens
...
llama_model_load: error loading model: unknown architecture
llama_load_model_from_file: failed to load model
llama_init_from_gpt_params: error: failed to load model '../models-mnt/pythia/1.4B/ggml-model-f16.gguf'
