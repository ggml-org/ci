...
- status:  SUCCESS ✅
- runtime: 338.74
- date:    Wed May 22 19:17:04 EEST 2024
...
llama_print_timings:        load time =      57.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.28 ms /     9 tokens (    1.14 ms per token,   875.66 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
