...
- status:  FAILURE ❌ (8)
- runtime: 6:33.70
- date:    Tue Sep 24 07:52:44 UTC 2024
...
26/28 Test #26: test-backend-ops ..................***Failed  279.03 sec
...
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[MUL_MAT] NMSE = 0.000544110 > 0.000500000 ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[1;31mFAIL[0m
...
Label Time Summary:
main    = 355.82 sec*proc (28 tests)

Total Test time (real) = 355.84 sec
