...
- status:  SUCCESS ✅
- runtime: 4:15.31
- date:    Sat Dec  7 21:16:56 UTC 2024
...
0.00.000.702 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.007.678 I llama_model_loader: - kv  19:            tokenizer.ggml.unknown_token_id u32              = 100
0.00.007.679 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.007.679 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.007.679 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
0.00.007.680 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
0.00.007.680 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.007.682 I llama_model_loader: - type  f32:  124 tensors
...
0.00.021.279 I llm_load_print_meta: n_head_kv        = 12
...
0.00.021.294 I llm_load_print_meta: n_gqa            = 1
0.00.021.295 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.296 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.021.298 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.021.298 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.310 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.310 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.021.318 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.021.321 I llm_load_print_meta: model ftype      = F16
0.00.021.322 I llm_load_print_meta: model params     = 33.21 M
0.00.021.323 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.021.324 I llm_load_print_meta: general.name     = Bge Small
0.00.021.324 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.325 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.325 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.326 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.326 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.326 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.327 I llm_load_print_meta: max token length = 21
0.00.025.415 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
0.00.025.431 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
...............................................
0.00.038.787 I llama_new_context_with_model: n_seq_max     = 1
0.00.038.803 I llama_new_context_with_model: n_ctx         = 512
0.00.038.804 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.038.804 I llama_new_context_with_model: n_batch       = 2048
0.00.038.804 I llama_new_context_with_model: n_ubatch      = 2048
0.00.038.805 I llama_new_context_with_model: flash_attn    = 0
0.00.038.806 I llama_new_context_with_model: freq_base     = 10000.0
0.00.038.807 I llama_new_context_with_model: freq_scale    = 1
0.00.041.389 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.041.411 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
...
0.00.043.015 I llama_new_context_with_model: graph nodes  = 429
0.00.043.015 I llama_new_context_with_model: graph splits = 1
0.00.043.017 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.046.444 I 
0.00.046.533 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
...
0.00.052.511 I llama_perf_context_print:        load time =      45.69 ms
0.00.052.513 I llama_perf_context_print: prompt eval time =       3.94 ms /     9 tokens (    0.44 ms per token,  2286.59 tokens per second)
0.00.052.514 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.052.514 I llama_perf_context_print:       total time =       6.07 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.523 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.580 I llama_model_loader: - kv   7:                      bert.embedding_length u32              = 384
...
0.00.003.585 I llama_model_loader: - kv  11:                          general.file_type u32              = 7
...
0.00.003.587 I llama_model_loader: - kv  14:            tokenizer.ggml.token_type_count u32              = 2
0.00.003.587 I llama_model_loader: - kv  15:                       tokenizer.ggml.model str              = bert
...
0.00.021.822 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.021.860 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.860 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.021.861 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.021.862 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.862 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.862 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.862 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.863 I llm_load_print_meta: n_ff             = 1536
0.00.021.863 I llm_load_print_meta: n_expert         = 0
0.00.021.863 I llm_load_print_meta: n_expert_used    = 0
0.00.021.864 I llm_load_print_meta: causal attn      = 0
0.00.021.864 I llm_load_print_meta: pooling type     = 2
...
0.00.021.866 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.021.867 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.868 I llm_load_print_meta: model type       = 33M
0.00.021.869 I llm_load_print_meta: model ftype      = Q8_0
0.00.021.869 I llm_load_print_meta: model params     = 33.21 M
0.00.021.870 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.021.871 I llm_load_print_meta: general.name     = Bge Small
0.00.021.871 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.872 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.873 I llm_load_print_meta: PAD token        = 0 '[PAD]'
...
0.00.024.686 I llm_load_tensors:          AMX model buffer size =    24.05 MiB
0.00.024.704 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
...............................................
0.00.035.282 I llama_new_context_with_model: n_seq_max     = 1
0.00.035.300 I llama_new_context_with_model: n_ctx         = 512
0.00.035.302 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.035.303 I llama_new_context_with_model: n_batch       = 2048
0.00.035.303 I llama_new_context_with_model: n_ubatch      = 2048
0.00.035.304 I llama_new_context_with_model: flash_attn    = 0
0.00.035.306 I llama_new_context_with_model: freq_base     = 10000.0
0.00.035.307 I llama_new_context_with_model: freq_scale    = 1
0.00.037.765 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.037.790 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.037.795 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.039.912 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.039.931 I llama_new_context_with_model: graph nodes  = 429
0.00.039.931 I llama_new_context_with_model: graph splits = 1
0.00.039.933 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.042.217 I 
0.00.042.299 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
...
0.00.046.140 I llama_perf_context_print:        load time =      41.66 ms
0.00.046.141 I llama_perf_context_print: prompt eval time =       1.99 ms /     9 tokens (    0.22 ms per token,  4531.72 tokens per second)
0.00.046.142 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.046.143 I llama_perf_context_print:       total time =       3.92 ms /    10 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.284 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.303 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.008.311 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.008.312 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.008.313 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.008.314 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.008.314 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.008.317 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.008.319 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.320 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.322 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.322 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.326 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.327 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.327 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.008.328 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.008.328 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
0.00.014.351 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,61056]   = ["<s>", "<pad>", "</s>", "<unk>", "<m...
0.00.015.773 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.307 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.327 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
...
0.00.019.330 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
...
0.00.019.332 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.332 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.335 I llama_model_loader: - type  f32:   41 tensors
0.00.019.337 I llama_model_loader: - type  f16:   29 tensors
0.00.037.762 W llm_load_vocab: empty token at index 5
0.00.048.436 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.707 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.831 I llm_load_vocab: special tokens cache size = 5
0.00.345.957 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.345.979 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.345.979 I llm_load_print_meta: arch             = jina-bert-v2
0.00.345.980 I llm_load_print_meta: vocab type       = BPE
0.00.345.981 I llm_load_print_meta: n_vocab          = 61056
0.00.345.981 I llm_load_print_meta: n_merges         = 39382
0.00.345.981 I llm_load_print_meta: vocab_only       = 0
0.00.345.982 I llm_load_print_meta: n_ctx_train      = 8192
0.00.345.982 I llm_load_print_meta: n_embd           = 384
0.00.345.982 I llm_load_print_meta: n_layer          = 4
0.00.345.990 I llm_load_print_meta: n_head           = 12
0.00.345.991 I llm_load_print_meta: n_head_kv        = 12
0.00.345.992 I llm_load_print_meta: n_rot            = 32
0.00.345.992 I llm_load_print_meta: n_swa            = 0
0.00.345.992 I llm_load_print_meta: n_embd_head_k    = 32
0.00.345.992 I llm_load_print_meta: n_embd_head_v    = 32
0.00.345.993 I llm_load_print_meta: n_gqa            = 1
0.00.345.994 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.345.995 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.345.997 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.345.997 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.345.997 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.345.998 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.345.998 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.345.999 I llm_load_print_meta: n_ff             = 1536
0.00.345.999 I llm_load_print_meta: n_expert         = 0
0.00.346.000 I llm_load_print_meta: n_expert_used    = 0
0.00.346.000 I llm_load_print_meta: causal attn      = 0
0.00.346.000 I llm_load_print_meta: pooling type     = -1
0.00.346.000 I llm_load_print_meta: rope type        = -1
0.00.346.001 I llm_load_print_meta: rope scaling     = linear
0.00.346.002 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.346.002 I llm_load_print_meta: freq_scale_train = 1
0.00.346.003 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.346.003 I llm_load_print_meta: rope_finetuned   = unknown
0.00.346.003 I llm_load_print_meta: ssm_d_conv       = 0
...
0.00.346.005 I llm_load_print_meta: model type       = 33M
0.00.346.006 I llm_load_print_meta: model ftype      = F16
0.00.346.006 I llm_load_print_meta: model params     = 32.90 M
0.00.346.007 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.346.008 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.346.008 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.346.009 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.346.009 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.346.009 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.346.009 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.346.010 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.346.010 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.346.010 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.346.011 I llm_load_print_meta: max token length = 45
0.00.349.372 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
0.00.349.386 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
....................
0.00.356.713 I llama_new_context_with_model: n_seq_max     = 1
0.00.356.728 I llama_new_context_with_model: n_ctx         = 8192
0.00.356.729 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.356.729 I llama_new_context_with_model: n_batch       = 2048
0.00.356.729 I llama_new_context_with_model: n_ubatch      = 2048
0.00.356.730 I llama_new_context_with_model: flash_attn    = 0
0.00.356.732 I llama_new_context_with_model: freq_base     = 10000.0
0.00.356.732 I llama_new_context_with_model: freq_scale    = 1
0.00.365.775 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.365.802 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.365.809 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.367.572 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.367.593 I llama_new_context_with_model: graph nodes  = 154
0.00.367.594 I llama_new_context_with_model: graph splits = 1
0.00.367.596 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.376.039 I 
0.00.376.125 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.376.326 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.376.339 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.376.344 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.376.345 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.376.349 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.376.349 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.380.248 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.387.630 I llama_perf_context_print:        load time =     375.72 ms
0.00.387.631 I llama_perf_context_print: prompt eval time =       7.19 ms /    62 tokens (    0.12 ms per token,  8621.89 tokens per second)
0.00.387.632 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.387.633 I llama_perf_context_print:       total time =      11.59 ms /    63 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.314 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.439 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.440 I llm_load_print_meta: model params     = 1.41 B
0.00.076.441 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.203.708 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.203.727 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.01.001.550 I llama_new_context_with_model: n_seq_max     = 1
0.01.001.567 I llama_new_context_with_model: n_ctx         = 2048
0.01.001.567 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.01.001.568 I llama_new_context_with_model: n_batch       = 2048
0.01.001.568 I llama_new_context_with_model: n_ubatch      = 512
...
0.01.069.950 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.069.974 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.070.007 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.072.751 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.01.072.774 I llama_new_context_with_model: graph nodes  = 967
0.01.072.774 I llama_new_context_with_model: graph splits = 1
0.01.072.779 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.173.765 I main: llama threadpool init, n_threads = 4
0.01.173.796 I 
0.01.173.882 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.173.897 I 
0.01.174.064 I sampler seed: 1234
0.01.174.084 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.174.087 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.174.088 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.174.088 I 
...
0.04.978.488 I llama_perf_sampler_print:    sampling time =       2.62 ms /    71 runs   (    0.04 ms per token, 27078.57 tokens per second)
0.04.978.492 I llama_perf_context_print:        load time =    1173.16 ms
0.04.978.493 I llama_perf_context_print: prompt eval time =      97.59 ms /     7 tokens (   13.94 ms per token,    71.73 tokens per second)
0.04.978.494 I llama_perf_context_print:        eval time =    3694.92 ms /    63 runs   (   58.65 ms per token,    17.05 tokens per second)
0.04.978.495 I llama_perf_context_print:       total time =    3804.73 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.321 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.118 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.020.657 I llama_model_loader: - type  f16:   98 tensors
...
0.00.075.756 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.757 I llm_load_print_meta: model params     = 1.41 B
0.00.075.758 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.202.790 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
0.00.202.810 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
.................................................................................
0.00.993.827 I llama_new_context_with_model: n_seq_max     = 1
0.00.993.849 I llama_new_context_with_model: n_ctx         = 128
0.00.993.849 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.993.850 I llama_new_context_with_model: n_batch       = 128
0.00.993.850 I llama_new_context_with_model: n_ubatch      = 128
0.00.993.851 I llama_new_context_with_model: flash_attn    = 0
0.00.993.856 I llama_new_context_with_model: freq_base     = 10000.0
0.00.993.857 I llama_new_context_with_model: freq_scale    = 1
0.00.993.858 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.998.725 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.998.752 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.998.776 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.001.065 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.01.001.087 I llama_new_context_with_model: graph nodes  = 967
0.01.001.087 I llama_new_context_with_model: graph splits = 1
0.01.001.090 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.066.910 I 
0.01.067.020 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.01.067.029 I perplexity: tokenizing the input ..
0.01.076.724 I perplexity: tokenization took 9.691 ms
0.01.076.755 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.988.073 I perplexity: 0.91 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.992.025 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.992.085 I llama_perf_context_print:        load time =    1066.55 ms
0.01.992.100 I llama_perf_context_print: prompt eval time =     909.60 ms /   128 tokens (    7.11 ms per token,   140.72 tokens per second)
0.01.992.101 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.992.102 I llama_perf_context_print:       total time =     925.17 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.294 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.165.358 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.165.375 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.325.897 I llama_new_context_with_model: n_seq_max     = 1
0.00.325.939 I llama_new_context_with_model: n_ctx         = 2048
0.00.325.946 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.325.953 I llama_new_context_with_model: n_batch       = 2048
0.00.325.960 I llama_new_context_with_model: n_ubatch      = 512
0.00.325.966 I llama_new_context_with_model: flash_attn    = 0
0.00.325.979 I llama_new_context_with_model: freq_base     = 10000.0
0.00.325.986 I llama_new_context_with_model: freq_scale    = 1
0.00.395.506 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.395.550 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.395.591 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.397.848 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.397.884 I llama_new_context_with_model: graph nodes  = 967
0.00.397.891 I llama_new_context_with_model: graph splits = 1
0.00.397.903 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.487.961 I main: llama threadpool init, n_threads = 4
0.00.487.997 I 
0.00.488.089 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.488.102 I 
0.00.488.241 I sampler seed: 1234
0.00.488.262 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.488.265 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.488.266 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.488.266 I 
...
0.02.635.191 I llama_perf_sampler_print:    sampling time =       2.64 ms /    71 runs   (    0.04 ms per token, 26863.41 tokens per second)
0.02.635.194 I llama_perf_context_print:        load time =     487.32 ms
0.02.635.196 I llama_perf_context_print: prompt eval time =      50.38 ms /     7 tokens (    7.20 ms per token,   138.95 tokens per second)
0.02.635.197 I llama_perf_context_print:        eval time =    2084.84 ms /    63 runs   (   33.09 ms per token,    30.22 tokens per second)
0.02.635.198 I llama_perf_context_print:       total time =    2147.24 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.650 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.240 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
0.00.021.242 I llama_model_loader: - type  f32:  194 tensors
0.00.021.243 I llama_model_loader: - type q8_0:   98 tensors
...
0.00.074.744 I llm_load_print_meta: model ftype      = Q8_0
...
0.00.165.136 I llm_load_tensors:          AMX model buffer size =  1484.67 MiB
0.00.165.153 I llm_load_tensors:   CPU_Mapped model buffer size =  1313.84 MiB
...............................................................................
0.00.328.409 I llama_new_context_with_model: n_seq_max     = 1
0.00.328.445 I llama_new_context_with_model: n_ctx         = 128
0.00.328.453 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.328.459 I llama_new_context_with_model: n_batch       = 128
0.00.328.466 I llama_new_context_with_model: n_ubatch      = 128
0.00.328.473 I llama_new_context_with_model: flash_attn    = 0
0.00.328.483 I llama_new_context_with_model: freq_base     = 10000.0
0.00.328.491 I llama_new_context_with_model: freq_scale    = 1
0.00.328.499 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.333.300 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.333.340 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.333.369 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.335.633 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.335.670 I llama_new_context_with_model: graph nodes  = 967
0.00.335.677 I llama_new_context_with_model: graph splits = 1
0.00.335.686 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.389.371 I 
0.00.389.507 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.389.528 I perplexity: tokenizing the input ..
0.00.399.134 I perplexity: tokenization took 9.603 ms
0.00.399.173 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.773.654 I perplexity: 0.37 seconds per pass - ETA 0.00 minutes
[1]10.1288,
0.00.777.277 I Final estimate: PPL = 10.1288 +/- 3.22324

0.00.777.320 I llama_perf_context_print:        load time =     388.68 ms
0.00.777.323 I llama_perf_context_print: prompt eval time =     372.53 ms /   128 tokens (    2.91 ms per token,   343.60 tokens per second)
0.00.777.324 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.777.325 I llama_perf_context_print:       total time =     387.95 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.273 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.497 I main: llama backend init
0.00.000.514 I main: load the model and apply lora adapter, if any
0.00.009.184 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_0.gguf (version GGUF V3 (latest))
...
0.00.020.742 I llama_model_loader: - kv  22:                          general.file_type u32              = 2
...
0.00.075.486 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.487 I llm_load_print_meta: model params     = 1.41 B
0.00.075.488 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.126.975 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.126.991 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.232.593 I llama_new_context_with_model: n_seq_max     = 1
0.00.232.616 I llama_new_context_with_model: n_ctx         = 2048
0.00.232.616 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.232.617 I llama_new_context_with_model: n_batch       = 2048
0.00.232.617 I llama_new_context_with_model: n_ubatch      = 512
0.00.232.617 I llama_new_context_with_model: flash_attn    = 0
0.00.232.623 I llama_new_context_with_model: freq_base     = 10000.0
0.00.232.624 I llama_new_context_with_model: freq_scale    = 1
0.00.301.250 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.301.282 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.301.314 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.304.171 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.304.192 I llama_new_context_with_model: graph nodes  = 967
0.00.304.192 I llama_new_context_with_model: graph splits = 1
0.00.304.196 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.375.839 I main: llama threadpool init, n_threads = 4
0.00.375.874 I 
0.00.375.961 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.375.977 I 
0.00.376.109 I sampler seed: 1234
0.00.376.129 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.376.133 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.376.133 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.376.133 I 
I believe the meaning of life is to know myself. It is to be able to say, “I am a person, I am a mother, a daughter, a sister, a friend, a mother of friends, a sister of sisters, and a sister of all the mothers.” It is to be able to say, “I am a human being

0.01.796.776 I llama_perf_sampler_print:    sampling time =       2.61 ms /    71 runs   (    0.04 ms per token, 27234.37 tokens per second)
0.01.796.779 I llama_perf_context_print:        load time =     375.31 ms
0.01.796.780 I llama_perf_context_print: prompt eval time =      45.13 ms /     7 tokens (    6.45 ms per token,   155.10 tokens per second)
0.01.796.781 I llama_perf_context_print:        eval time =    1364.09 ms /    63 runs   (   21.65 ms per token,    46.18 tokens per second)
0.01.796.782 I llama_perf_context_print:       total time =    1420.94 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.757 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.696 I llm_load_print_meta: model ftype      = Q4_0
0.00.076.697 I llm_load_print_meta: model params     = 1.41 B
0.00.076.698 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.135.070 I llm_load_tensors:          AMX model buffer size =   728.60 MiB
0.00.135.086 I llm_load_tensors:   CPU_Mapped model buffer size =   696.72 MiB
..............................................................................
0.00.240.651 I llama_new_context_with_model: n_seq_max     = 1
0.00.240.675 I llama_new_context_with_model: n_ctx         = 128
0.00.240.675 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.240.675 I llama_new_context_with_model: n_batch       = 128
0.00.240.675 I llama_new_context_with_model: n_ubatch      = 128
0.00.240.676 I llama_new_context_with_model: flash_attn    = 0
0.00.240.681 I llama_new_context_with_model: freq_base     = 10000.0
0.00.240.682 I llama_new_context_with_model: freq_scale    = 1
0.00.240.683 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.245.627 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.245.655 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.245.681 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.247.894 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.247.910 I llama_new_context_with_model: graph nodes  = 967
0.00.247.910 I llama_new_context_with_model: graph splits = 1
0.00.247.912 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.424 I 
0.00.290.537 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.290.559 I perplexity: tokenizing the input ..
0.00.300.243 I perplexity: tokenization took 9.68 ms
0.00.300.275 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.721.252 I perplexity: 0.42 seconds per pass - ETA 0.00 minutes
[1]14.0715,
0.00.725.067 I Final estimate: PPL = 14.0715 +/- 4.41015

0.00.725.105 I llama_perf_context_print:        load time =     289.63 ms
0.00.725.106 I llama_perf_context_print: prompt eval time =     419.13 ms /   128 tokens (    3.27 ms per token,   305.39 tokens per second)
0.00.725.108 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.725.109 I llama_perf_context_print:       total time =     434.68 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.567 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.130.458 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.130.476 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.237.958 I llama_new_context_with_model: n_seq_max     = 1
0.00.237.979 I llama_new_context_with_model: n_ctx         = 2048
0.00.237.980 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.237.980 I llama_new_context_with_model: n_batch       = 2048
0.00.237.980 I llama_new_context_with_model: n_ubatch      = 512
0.00.237.981 I llama_new_context_with_model: flash_attn    = 0
0.00.237.986 I llama_new_context_with_model: freq_base     = 10000.0
0.00.237.986 I llama_new_context_with_model: freq_scale    = 1
0.00.306.810 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.306.842 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.306.874 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.309.205 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.309.219 I llama_new_context_with_model: graph nodes  = 967
0.00.309.219 I llama_new_context_with_model: graph splits = 1
0.00.309.224 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.393.773 I main: llama threadpool init, n_threads = 4
0.00.393.808 I 
0.00.393.900 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.393.912 I 
0.00.394.051 I sampler seed: 1234
0.00.394.072 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.394.075 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.394.076 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.394.076 I 
...
0.01.916.601 I llama_perf_sampler_print:    sampling time =       2.53 ms /    71 runs   (    0.04 ms per token, 28041.07 tokens per second)
0.01.916.604 I llama_perf_context_print:        load time =     392.91 ms
0.01.916.605 I llama_perf_context_print: prompt eval time =      43.59 ms /     7 tokens (    6.23 ms per token,   160.57 tokens per second)
0.01.916.606 I llama_perf_context_print:        eval time =    1467.70 ms /    63 runs   (   23.30 ms per token,    42.92 tokens per second)
0.01.916.607 I llama_perf_context_print:       total time =    1522.83 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.320 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.212 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.075.106 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.107 I llm_load_print_meta: model params     = 1.41 B
0.00.075.108 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.130.585 I llm_load_tensors:          AMX model buffer size =   800.60 MiB
0.00.130.602 I llm_load_tensors:   CPU_Mapped model buffer size =   773.86 MiB
..............................................................................
0.00.240.554 I llama_new_context_with_model: n_seq_max     = 1
0.00.240.569 I llama_new_context_with_model: n_ctx         = 128
0.00.240.570 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.240.570 I llama_new_context_with_model: n_batch       = 128
0.00.240.570 I llama_new_context_with_model: n_ubatch      = 128
0.00.240.571 I llama_new_context_with_model: flash_attn    = 0
0.00.240.576 I llama_new_context_with_model: freq_base     = 10000.0
0.00.240.577 I llama_new_context_with_model: freq_scale    = 1
0.00.240.578 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.245.446 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.245.473 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.245.498 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.247.725 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.247.744 I llama_new_context_with_model: graph nodes  = 967
0.00.247.744 I llama_new_context_with_model: graph splits = 1
0.00.247.747 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.295.467 I 
0.00.295.592 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.295.615 I perplexity: tokenizing the input ..
0.00.305.333 I perplexity: tokenization took 9.714 ms
0.00.305.365 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.762.018 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]12.5781,
0.00.765.902 I Final estimate: PPL = 12.5781 +/- 3.87222

0.00.765.943 I llama_perf_context_print:        load time =     295.11 ms
0.00.765.945 I llama_perf_context_print: prompt eval time =     454.88 ms /   128 tokens (    3.55 ms per token,   281.39 tokens per second)
0.00.765.947 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.765.948 I llama_perf_context_print:       total time =     470.48 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.260 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.472 I main: llama backend init
0.00.000.489 I main: load the model and apply lora adapter, if any
0.00.009.274 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.134.909 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.134.930 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.149.712 I llama_new_context_with_model: n_seq_max     = 1
0.00.149.732 I llama_new_context_with_model: n_ctx         = 2048
0.00.149.733 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.149.733 I llama_new_context_with_model: n_batch       = 2048
0.00.149.733 I llama_new_context_with_model: n_ubatch      = 512
0.00.149.734 I llama_new_context_with_model: flash_attn    = 0
0.00.149.737 I llama_new_context_with_model: freq_base     = 10000.0
0.00.149.737 I llama_new_context_with_model: freq_scale    = 1
0.00.218.531 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.218.561 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.218.589 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.220.867 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.220.887 I llama_new_context_with_model: graph nodes  = 967
0.00.220.887 I llama_new_context_with_model: graph splits = 1
0.00.220.892 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.310.252 I main: llama threadpool init, n_threads = 4
0.00.310.284 I 
0.00.310.370 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.310.370 I 
0.00.310.491 I sampler seed: 1234
0.00.310.514 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.310.518 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.310.519 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.310.520 I 
I believe the meaning of life is to do what is best for your self, and to be happy, and to enjoy the present moment, and to let go of the past, and to enjoy the moment, and to enjoy the life you have here on Earth." The words are spoken in a calm, measured tone, but the message is clear: it

0.02.645.658 I llama_perf_sampler_print:    sampling time =       2.58 ms /    71 runs   (    0.04 ms per token, 27540.73 tokens per second)
0.02.645.661 I llama_perf_context_print:        load time =     309.75 ms
0.02.645.663 I llama_perf_context_print: prompt eval time =     127.05 ms /     7 tokens (   18.15 ms per token,    55.10 tokens per second)
0.02.645.664 I llama_perf_context_print:        eval time =    2196.51 ms /    63 runs   (   34.87 ms per token,    28.68 tokens per second)
0.02.645.664 I llama_perf_context_print:       total time =    2335.41 ms /    70 tokens
...
0.00.008.922 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.008.971 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = olmo
0.00.014.302 I llama_model_loader: - kv  15:                      tokenizer.ggml.tokens arr[str,50304]   = ["<|endoftext|>", "<|padding|>", "!",...
...
0.00.020.531 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.020.533 I llama_model_loader: - type  f32:  194 tensors
0.00.020.534 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.074.468 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.074.469 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
...
0.00.136.740 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.136.758 I llm_load_tensors:   CPU_Mapped model buffer size =   862.00 MiB
..................................................................................
0.00.152.271 I llama_new_context_with_model: n_seq_max     = 1
0.00.152.293 I llama_new_context_with_model: n_ctx         = 128
0.00.152.293 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.152.294 I llama_new_context_with_model: n_batch       = 128
0.00.152.294 I llama_new_context_with_model: n_ubatch      = 128
0.00.152.294 I llama_new_context_with_model: flash_attn    = 0
0.00.152.297 I llama_new_context_with_model: freq_base     = 10000.0
0.00.152.299 I llama_new_context_with_model: freq_scale    = 1
0.00.152.300 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.157.119 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.157.144 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.157.162 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.159.379 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.159.395 I llama_new_context_with_model: graph nodes  = 967
0.00.159.395 I llama_new_context_with_model: graph splits = 1
0.00.159.398 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.200.106 I 
0.00.200.210 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.200.230 I perplexity: tokenizing the input ..
0.00.209.658 I perplexity: tokenization took 9.425 ms
0.00.209.687 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.297.849 I perplexity: 1.09 seconds per pass - ETA 0.02 minutes
[1]10.1183,
0.01.301.448 I Final estimate: PPL = 10.1183 +/- 3.22500

0.01.301.485 I llama_perf_context_print:        load time =     199.75 ms
0.01.301.486 I llama_perf_context_print: prompt eval time =    1086.54 ms /   128 tokens (    8.49 ms per token,   117.81 tokens per second)
0.01.301.487 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.301.488 I llama_perf_context_print:       total time =    1101.38 ms /   129 tokens
...
0.00.076.021 I llm_load_print_meta: model ftype      = Q5_1
0.00.076.022 I llm_load_print_meta: model params     = 1.41 B
0.00.076.023 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.142.718 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.142.736 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.158.975 I llama_new_context_with_model: n_seq_max     = 1
0.00.158.997 I llama_new_context_with_model: n_ctx         = 2048
0.00.158.998 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.158.998 I llama_new_context_with_model: n_batch       = 2048
0.00.158.998 I llama_new_context_with_model: n_ubatch      = 512
0.00.158.999 I llama_new_context_with_model: flash_attn    = 0
...
0.00.227.207 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.227.233 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.230.051 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.230.064 I llama_new_context_with_model: graph nodes  = 967
0.00.230.064 I llama_new_context_with_model: graph splits = 1
0.00.230.068 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.319.752 I main: llama threadpool init, n_threads = 4
0.00.319.783 I 
0.00.319.869 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.319.884 I 
0.00.320.011 I sampler seed: 1234
0.00.320.019 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.320.022 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.320.022 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.320.023 I 
...
0.02.732.066 I llama_perf_sampler_print:    sampling time =       2.56 ms /    71 runs   (    0.04 ms per token, 27712.72 tokens per second)
0.02.732.069 I llama_perf_context_print:        load time =     319.23 ms
0.02.732.070 I llama_perf_context_print: prompt eval time =     124.54 ms /     7 tokens (   17.79 ms per token,    56.21 tokens per second)
0.02.732.071 I llama_perf_context_print:        eval time =    2276.75 ms /    63 runs   (   36.14 ms per token,    27.67 tokens per second)
0.02.732.072 I llama_perf_context_print:       total time =    2412.32 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.654 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.075 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.140.946 I llm_load_tensors:   CPU_Mapped model buffer size =   940.14 MiB
...............................................................................
0.00.155.769 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.160.336 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.160.362 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.160.382 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.163.131 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.163.154 I llama_new_context_with_model: graph nodes  = 967
0.00.163.154 I llama_new_context_with_model: graph splits = 1
0.00.163.156 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.220.674 I 
0.00.220.801 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.220.823 I perplexity: tokenizing the input ..
0.00.230.278 I perplexity: tokenization took 9.451 ms
0.00.230.314 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.135.940 I perplexity: 1.91 seconds per pass - ETA 0.02 minutes
[1]10.0755,
0.02.139.693 I Final estimate: PPL = 10.0755 +/- 3.14603

0.02.139.732 I llama_perf_context_print:        load time =     219.98 ms
0.02.139.734 I llama_perf_context_print: prompt eval time =    1904.02 ms /   128 tokens (   14.88 ms per token,    67.23 tokens per second)
0.02.139.735 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.139.736 I llama_perf_context_print:       total time =    1919.06 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.687 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.125 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.125 I llm_load_print_meta: model params     = 1.41 B
0.00.076.126 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.112.134 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.112.149 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
0.00.127.275 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.298 I llama_new_context_with_model: n_ctx         = 2048
0.00.127.299 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.127.299 I llama_new_context_with_model: n_batch       = 2048
0.00.127.299 I llama_new_context_with_model: n_ubatch      = 512
0.00.127.300 I llama_new_context_with_model: flash_attn    = 0
0.00.127.303 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.304 I llama_new_context_with_model: freq_scale    = 1
0.00.195.478 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.506 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.531 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.754 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.776 I llama_new_context_with_model: graph nodes  = 967
0.00.197.777 I llama_new_context_with_model: graph splits = 1
0.00.197.781 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.279.159 I main: llama threadpool init, n_threads = 4
0.00.279.189 I 
0.00.279.277 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.279.277 I 
0.00.279.402 I sampler seed: 1234
0.00.279.422 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.279.426 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.279.426 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.279.426 I 
I believe the meaning of life is a one-f                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               <

0.01.761.658 I llama_perf_sampler_print:    sampling time =       2.31 ms /    71 runs   (    0.03 ms per token, 30682.80 tokens per second)
0.01.761.661 I llama_perf_context_print:        load time =     278.24 ms
0.01.761.662 I llama_perf_context_print: prompt eval time =      84.77 ms /     7 tokens (   12.11 ms per token,    82.58 tokens per second)
0.01.761.663 I llama_perf_context_print:        eval time =    1386.75 ms /    63 runs   (   22.01 ms per token,    45.43 tokens per second)
0.01.761.664 I llama_perf_context_print:       total time =    1482.51 ms /    70 tokens
...
warning: consult docs/build.md for compilation instructions
0.00.000.321 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.971 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf (version GGUF V3 (latest))
...
0.00.020.481 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.484 I llama_model_loader: - type  f32:  194 tensors
0.00.020.484 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.485 I llama_model_loader: - type q3_K:   48 tensors
0.00.020.485 I llama_model_loader: - type q6_K:    1 tensors
...
0.00.075.634 I llm_load_print_meta: model ftype      = Q2_K - Medium
...
0.00.112.042 I llm_load_tensors:          AMX model buffer size =    80.60 MiB
0.00.112.057 I llm_load_tensors:   CPU_Mapped model buffer size =   461.44 MiB
..........................................................................
...
0.00.127.071 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.072 I llama_new_context_with_model: freq_scale    = 1
0.00.127.073 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.132.981 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.133.009 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.133.029 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.135.480 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.135.507 I llama_new_context_with_model: graph nodes  = 967
0.00.135.508 I llama_new_context_with_model: graph splits = 1
0.00.135.510 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.180.021 I 
0.00.180.134 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.180.156 I perplexity: tokenizing the input ..
0.00.189.822 I perplexity: tokenization took 9.662 ms
0.00.189.853 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.451.312 I perplexity: 1.26 seconds per pass - ETA 0.02 minutes
[1]68.7474,
0.01.455.122 I Final estimate: PPL = 68.7474 +/- 26.65510

0.01.455.166 I llama_perf_context_print:        load time =     179.66 ms
0.01.455.168 I llama_perf_context_print: prompt eval time =    1259.71 ms /   128 tokens (    9.84 ms per token,   101.61 tokens per second)
0.01.455.169 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.455.170 I llama_perf_context_print:       total time =    1275.14 ms /   129 tokens
...
0.00.076.009 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.076.010 I llm_load_print_meta: model params     = 1.41 B
0.00.076.011 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.123.043 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.123.060 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.202.984 I llama_new_context_with_model: n_seq_max     = 1
0.00.203.006 I llama_new_context_with_model: n_ctx         = 2048
0.00.203.007 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.203.007 I llama_new_context_with_model: n_batch       = 2048
0.00.203.008 I llama_new_context_with_model: n_ubatch      = 512
0.00.203.008 I llama_new_context_with_model: flash_attn    = 0
0.00.203.013 I llama_new_context_with_model: freq_base     = 10000.0
0.00.203.014 I llama_new_context_with_model: freq_scale    = 1
0.00.273.108 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.273.139 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.273.172 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.275.472 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.275.491 I llama_new_context_with_model: graph nodes  = 967
0.00.275.491 I llama_new_context_with_model: graph splits = 1
0.00.275.495 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.352.669 I main: llama threadpool init, n_threads = 4
0.00.352.704 I 
0.00.352.796 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.352.809 I 
0.00.352.938 I sampler seed: 1234
0.00.352.958 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.352.961 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.352.962 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.352.962 I 
I believe the meaning of life is that one should never feel the need to be the best at anything, but rather, that one should be the best in whatever one does. This is a good philosophy, and I believe it to be a good basis for understanding how our lives are lived, as well as how we should live them.

It is

0.02.054.485 I llama_perf_sampler_print:    sampling time =       2.58 ms /    71 runs   (    0.04 ms per token, 27530.05 tokens per second)
0.02.054.488 I llama_perf_context_print:        load time =     351.81 ms
0.02.054.490 I llama_perf_context_print: prompt eval time =      69.62 ms /     7 tokens (    9.95 ms per token,   100.54 tokens per second)
0.02.054.491 I llama_perf_context_print:        eval time =    1620.79 ms /    63 runs   (   25.73 ms per token,    38.87 tokens per second)
0.02.054.491 I llama_perf_context_print:       total time =    1701.82 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.602 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.099 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.100 I llm_load_print_meta: model params     = 1.41 B
0.00.075.101 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.122.144 I llm_load_tensors:          AMX model buffer size =   526.60 MiB
0.00.122.162 I llm_load_tensors:   CPU_Mapped model buffer size =   643.67 MiB
...............................................................................
0.00.201.247 I llama_new_context_with_model: n_seq_max     = 1
0.00.201.288 I llama_new_context_with_model: n_ctx         = 128
0.00.201.297 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.201.305 I llama_new_context_with_model: n_batch       = 128
0.00.201.314 I llama_new_context_with_model: n_ubatch      = 128
0.00.201.322 I llama_new_context_with_model: flash_attn    = 0
0.00.201.337 I llama_new_context_with_model: freq_base     = 10000.0
0.00.201.346 I llama_new_context_with_model: freq_scale    = 1
0.00.201.354 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.206.167 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.206.210 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.206.245 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.209.033 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.209.076 I llama_new_context_with_model: graph nodes  = 967
...
0.00.250.905 I 
0.00.251.029 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.251.063 I perplexity: tokenizing the input ..
0.00.260.718 I perplexity: tokenization took 9.651 ms
0.00.260.754 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.127.435 I perplexity: 0.87 seconds per pass - ETA 0.00 minutes
[1]12.3344,
0.01.131.009 I Final estimate: PPL = 12.3344 +/- 4.02919

0.01.131.054 I llama_perf_context_print:        load time =     250.22 ms
0.01.131.056 I llama_perf_context_print: prompt eval time =     864.78 ms /   128 tokens (    6.76 ms per token,   148.01 tokens per second)
0.01.131.058 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.131.058 I llama_perf_context_print:       total time =     880.15 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.704 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.763 I llm_load_print_meta: model ftype      = Q4_K - Medium
...
0.00.131.089 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.131.108 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.247.268 I llama_new_context_with_model: n_seq_max     = 1
0.00.247.291 I llama_new_context_with_model: n_ctx         = 2048
0.00.247.291 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.247.291 I llama_new_context_with_model: n_batch       = 2048
0.00.247.292 I llama_new_context_with_model: n_ubatch      = 512
0.00.247.293 I llama_new_context_with_model: flash_attn    = 0
0.00.247.297 I llama_new_context_with_model: freq_base     = 10000.0
0.00.247.298 I llama_new_context_with_model: freq_scale    = 1
0.00.315.997 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.316.026 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.316.059 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.318.946 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.318.968 I llama_new_context_with_model: graph nodes  = 967
0.00.318.968 I llama_new_context_with_model: graph splits = 1
0.00.318.973 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.402.081 I main: llama threadpool init, n_threads = 4
0.00.402.112 I 
0.00.402.200 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.402.213 I 
0.00.402.344 I sampler seed: 1234
0.00.402.364 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.402.367 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.402.368 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.402.368 I 
...
0.02.355.655 I llama_perf_sampler_print:    sampling time =       2.66 ms /    71 runs   (    0.04 ms per token, 26701.77 tokens per second)
0.02.355.658 I llama_perf_context_print:        load time =     401.12 ms
0.02.355.660 I llama_perf_context_print: prompt eval time =      61.24 ms /     7 tokens (    8.75 ms per token,   114.31 tokens per second)
0.02.355.661 I llama_perf_context_print:        eval time =    1880.93 ms /    63 runs   (   29.86 ms per token,    33.49 tokens per second)
0.02.355.661 I llama_perf_context_print:       total time =    1953.58 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.690 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.077 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.132.020 I llm_load_tensors:          AMX model buffer size =   829.10 MiB
0.00.132.037 I llm_load_tensors:   CPU_Mapped model buffer size =   782.22 MiB
................................................................................
0.00.249.658 I llama_new_context_with_model: n_seq_max     = 1
0.00.249.682 I llama_new_context_with_model: n_ctx         = 128
0.00.249.683 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.249.683 I llama_new_context_with_model: n_batch       = 128
0.00.249.683 I llama_new_context_with_model: n_ubatch      = 128
0.00.249.684 I llama_new_context_with_model: flash_attn    = 0
0.00.249.689 I llama_new_context_with_model: freq_base     = 10000.0
0.00.249.690 I llama_new_context_with_model: freq_scale    = 1
0.00.249.691 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.254.863 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.254.884 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.254.909 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.257.665 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.257.688 I llama_new_context_with_model: graph nodes  = 967
0.00.257.688 I llama_new_context_with_model: graph splits = 1
0.00.257.691 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.327.519 I 
0.00.327.635 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.327.656 I perplexity: tokenizing the input ..
0.00.337.282 I perplexity: tokenization took 9.622 ms
0.00.337.316 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.891.258 I perplexity: 0.55 seconds per pass - ETA 0.00 minutes
[1]10.4776,
0.00.894.874 I Final estimate: PPL = 10.4776 +/- 3.36742

0.00.894.914 I llama_perf_context_print:        load time =     326.79 ms
0.00.894.915 I llama_perf_context_print: prompt eval time =     552.05 ms /   128 tokens (    4.31 ms per token,   231.86 tokens per second)
0.00.894.916 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.894.917 I llama_perf_context_print:       total time =     567.39 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.269 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.888 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
0.00.020.891 I llama_model_loader: - type  f32:  194 tensors
0.00.020.891 I llama_model_loader: - type q5_K:   61 tensors
...
0.00.075.714 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.715 I llm_load_print_meta: model params     = 1.41 B
0.00.075.716 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.140.496 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.140.512 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.267.918 I llama_new_context_with_model: n_seq_max     = 1
0.00.267.933 I llama_new_context_with_model: n_ctx         = 2048
0.00.267.933 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.267.934 I llama_new_context_with_model: n_batch       = 2048
0.00.267.934 I llama_new_context_with_model: n_ubatch      = 512
0.00.267.935 I llama_new_context_with_model: flash_attn    = 0
0.00.267.940 I llama_new_context_with_model: freq_base     = 10000.0
0.00.267.941 I llama_new_context_with_model: freq_scale    = 1
0.00.336.852 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.336.883 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.336.917 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.339.123 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.339.146 I llama_new_context_with_model: graph nodes  = 967
0.00.339.146 I llama_new_context_with_model: graph splits = 1
0.00.339.151 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.447.144 I main: llama threadpool init, n_threads = 4
0.00.447.176 I 
0.00.447.263 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.447.276 I 
0.00.447.413 I sampler seed: 1234
0.00.447.433 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.447.436 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.447.437 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.447.437 I 
I believe the meaning of life is to do the things we love, the things we are good at, the things we are good at doing, and the things that are good at doing. If we do those, we are happy. If we do not, then we are miserable, and we will do those things we hate the most.

I

0.02.853.581 I llama_perf_sampler_print:    sampling time =       2.75 ms /    71 runs   (    0.04 ms per token, 25818.18 tokens per second)
0.02.853.584 I llama_perf_context_print:        load time =     446.61 ms
0.02.853.586 I llama_perf_context_print: prompt eval time =      90.73 ms /     7 tokens (   12.96 ms per token,    77.15 tokens per second)
0.02.853.587 I llama_perf_context_print:        eval time =    2303.90 ms /    63 runs   (   36.57 ms per token,    27.34 tokens per second)
0.02.853.587 I llama_perf_context_print:       total time =    2406.44 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.313 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.598 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
...
0.00.139.554 I llm_load_tensors:          AMX model buffer size =   946.85 MiB
0.00.139.571 I llm_load_tensors:   CPU_Mapped model buffer size =   914.75 MiB
.................................................................................
0.00.268.245 I llama_new_context_with_model: n_seq_max     = 1
0.00.268.268 I llama_new_context_with_model: n_ctx         = 128
0.00.268.268 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.268.268 I llama_new_context_with_model: n_batch       = 128
0.00.268.269 I llama_new_context_with_model: n_ubatch      = 128
0.00.268.270 I llama_new_context_with_model: flash_attn    = 0
0.00.268.275 I llama_new_context_with_model: freq_base     = 10000.0
0.00.268.276 I llama_new_context_with_model: freq_scale    = 1
0.00.268.277 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.272.969 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.272.997 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.273.020 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.275.241 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.275.258 I llama_new_context_with_model: graph nodes  = 967
0.00.275.259 I llama_new_context_with_model: graph splits = 1
0.00.275.261 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.359.626 I 
0.00.359.745 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.359.766 I perplexity: tokenizing the input ..
0.00.369.334 I perplexity: tokenization took 9.564 ms
0.00.369.372 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.009.890 I perplexity: 0.64 seconds per pass - ETA 0.00 minutes
[1]10.6642,
0.01.013.719 I Final estimate: PPL = 10.6642 +/- 3.40033

0.01.013.761 I llama_perf_context_print:        load time =     359.28 ms
0.01.013.763 I llama_perf_context_print: prompt eval time =     638.72 ms /   128 tokens (    4.99 ms per token,   200.40 tokens per second)
0.01.013.764 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.013.765 I llama_perf_context_print:       total time =     654.13 ms /   129 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.276 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.474 I main: llama backend init
0.00.000.491 I main: load the model and apply lora adapter, if any
0.00.009.320 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q6_k.gguf (version GGUF V3 (latest))
...
0.00.076.192 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.193 I llm_load_print_meta: model params     = 1.41 B
0.00.076.194 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.146.016 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.146.037 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.279.807 I llama_new_context_with_model: n_seq_max     = 1
0.00.279.846 I llama_new_context_with_model: n_ctx         = 2048
0.00.279.853 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.279.860 I llama_new_context_with_model: n_batch       = 2048
0.00.279.866 I llama_new_context_with_model: n_ubatch      = 512
0.00.279.873 I llama_new_context_with_model: flash_attn    = 0
0.00.279.883 I llama_new_context_with_model: freq_base     = 10000.0
0.00.279.904 I llama_new_context_with_model: freq_scale    = 1
0.00.348.455 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.348.500 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.348.541 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.350.835 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.350.862 I llama_new_context_with_model: graph nodes  = 967
0.00.350.869 I llama_new_context_with_model: graph splits = 1
0.00.350.880 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.482.496 I main: llama threadpool init, n_threads = 4
0.00.482.522 I 
0.00.482.609 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.482.622 I 
0.00.482.777 I sampler seed: 1234
0.00.482.797 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.482.800 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.482.801 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.482.801 I 
...
0.02.996.018 I llama_perf_sampler_print:    sampling time =       2.67 ms /    71 runs   (    0.04 ms per token, 26631.66 tokens per second)
0.02.996.021 I llama_perf_context_print:        load time =     481.99 ms
0.02.996.023 I llama_perf_context_print: prompt eval time =     107.36 ms /     7 tokens (   15.34 ms per token,    65.20 tokens per second)
0.02.996.024 I llama_perf_context_print:        eval time =    2394.04 ms /    63 runs   (   38.00 ms per token,    26.32 tokens per second)
0.02.996.024 I llama_perf_context_print:       total time =    2513.53 ms /    70 tokens
...
warning: one possible reason is that llama.cpp was compiled without GPU support
warning: consult docs/build.md for compilation instructions
0.00.000.703 I build: 4286 (62e84d98) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.829 I llm_load_print_meta: model ftype      = Q6_K
...
0.00.144.955 I llm_load_tensors:          AMX model buffer size =  1025.60 MiB
0.00.144.973 I llm_load_tensors:   CPU_Mapped model buffer size =  1014.92 MiB
.................................................................................
0.00.279.137 I llama_new_context_with_model: n_seq_max     = 1
0.00.279.160 I llama_new_context_with_model: n_ctx         = 128
0.00.279.161 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.279.161 I llama_new_context_with_model: n_batch       = 128
0.00.279.161 I llama_new_context_with_model: n_ubatch      = 128
0.00.279.162 I llama_new_context_with_model: flash_attn    = 0
0.00.279.167 I llama_new_context_with_model: freq_base     = 10000.0
0.00.279.168 I llama_new_context_with_model: freq_scale    = 1
0.00.279.169 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.284.572 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.284.599 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.284.627 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.287.500 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
...
0.00.378.403 I 
0.00.378.518 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.378.539 I perplexity: tokenizing the input ..
0.00.388.345 I perplexity: tokenization took 9.802 ms
0.00.388.376 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.169.640 I perplexity: 0.78 seconds per pass - ETA 0.00 minutes
[1]10.4463,
0.01.173.305 I Final estimate: PPL = 10.4463 +/- 3.33301

0.01.173.346 I llama_perf_context_print:        load time =     377.66 ms
0.01.173.348 I llama_perf_context_print: prompt eval time =     779.56 ms /   128 tokens (    6.09 ms per token,   164.19 tokens per second)
0.01.173.349 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.173.350 I llama_perf_context_print:       total time =     794.94 ms /   129 tokens
...
0.00.303.583 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.304.858 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.44user 0.66system 0:01.11elapsed 100%CPU (0avgtext+0avgdata 5354008maxresident)k
