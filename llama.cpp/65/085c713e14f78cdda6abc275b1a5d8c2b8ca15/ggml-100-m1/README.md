...
- status:  SUCCESS ✅
- runtime: 411.58
- date:    Fri Feb 16 13:49:58 EET 2024
...
19/20 Test #19: test-backend-ops ....................   Passed  119.90 sec
      Start 20: test-rope
...
Label Time Summary:
main    = 175.20 sec*proc (20 tests)

Total Test time (real) = 175.21 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.43 ms /     9 tokens (    1.16 ms per token,   862.98 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
