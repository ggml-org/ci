...
- status:  FAILURE ❌ (139)
- runtime: 6:44.48
- date:    Sat Jan 11 15:59:06 UTC 2025
...
Label Time Summary:
main    = 111.10 sec*proc (28 tests)

Total Test time (real) = 111.11 sec
...
23/28 Test #23: test-gguf .........................   Passed    0.77 sec
      Start 24: test-backend-ops
24/28 Test #24: test-backend-ops ..................   Passed   10.37 sec
      Start 27: test-barrier
...
0.00.000.192 I build: 4466 (6540935b) with cc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0 for x86_64-linux-gnu
0.00.000.373 I llama_model_load_from_file: using device Vulkan0 (Tesla T4) - 16384 MiB free
0.00.005.148 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.005.162 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.005.169 I llama_model_loader: - kv   0:                       general.architecture str              = bert
...
0.00.005.177 I llama_model_loader: - kv   5:                           bert.block_count u32              = 12
0.00.005.178 I llama_model_loader: - kv   6:                        bert.context_length u32              = 512
0.00.005.179 I llama_model_loader: - kv   7:                      bert.embedding_length u32              = 384
0.00.005.179 I llama_model_loader: - kv   8:                   bert.feed_forward_length u32              = 1536
0.00.005.180 I llama_model_loader: - kv   9:                  bert.attention.head_count u32              = 12
0.00.005.183 I llama_model_loader: - kv  10:          bert.attention.layer_norm_epsilon f32              = 0.000000
...
0.00.011.264 I print_info: file type   = F16
0.00.011.266 I print_info: file size   = 63.84 MiB (16.12 BPW) 
0.00.023.051 I load: special tokens cache size = 5
0.00.028.270 I load: token to piece cache size = 0.2032 MB
0.00.028.282 I print_info: arch             = bert
0.00.028.283 I print_info: vocab_only       = 0
0.00.028.284 I print_info: n_ctx_train      = 512
0.00.028.284 I print_info: n_embd           = 384
0.00.028.284 I print_info: n_layer          = 12
0.00.028.290 I print_info: n_head           = 12
0.00.028.292 I print_info: n_head_kv        = 12
0.00.028.292 I print_info: n_rot            = 32
0.00.028.293 I print_info: n_swa            = 0
0.00.028.293 I print_info: n_embd_head_k    = 32
0.00.028.293 I print_info: n_embd_head_v    = 32
0.00.028.295 I print_info: n_gqa            = 1
0.00.028.296 I print_info: n_embd_k_gqa     = 384
0.00.028.298 I print_info: n_embd_v_gqa     = 384
0.00.028.299 I print_info: f_norm_eps       = 1.0e-12
0.00.028.299 I print_info: f_norm_rms_eps   = 0.0e+00
0.00.028.300 I print_info: f_clamp_kqv      = 0.0e+00
0.00.028.300 I print_info: f_max_alibi_bias = 0.0e+00
0.00.028.301 I print_info: f_logit_scale    = 0.0e+00
0.00.028.302 I print_info: n_ff             = 1536
0.00.028.302 I print_info: n_expert         = 0
0.00.028.302 I print_info: n_expert_used    = 0
0.00.028.303 I print_info: causal attn      = 0
0.00.028.303 I print_info: pooling type     = 2
0.00.028.303 I print_info: rope type        = 2
0.00.028.304 I print_info: rope scaling     = linear
0.00.028.305 I print_info: freq_base_train  = 10000.0
0.00.028.305 I print_info: freq_scale_train = 1
0.00.028.306 I print_info: n_ctx_orig_yarn  = 512
0.00.028.306 I print_info: rope_finetuned   = unknown
0.00.028.307 I print_info: ssm_d_conv       = 0
0.00.028.308 I print_info: ssm_d_inner      = 0
0.00.028.308 I print_info: ssm_d_state      = 0
0.00.028.308 I print_info: ssm_dt_rank      = 0
0.00.028.308 I print_info: ssm_dt_b_c_rms   = 0
0.00.028.309 I print_info: model type       = 33M
0.00.028.309 I print_info: model params     = 33.21 M
0.00.028.310 I print_info: general.name     = Bge Small
0.00.028.312 I print_info: vocab type       = WPM
0.00.028.312 I print_info: n_vocab          = 30522
0.00.028.313 I print_info: n_merges         = 0
0.00.028.313 I print_info: UNK token        = 100 '[UNK]'
0.00.028.313 I print_info: SEP token        = 102 '[SEP]'
0.00.028.314 I print_info: PAD token        = 0 '[PAD]'
0.00.028.314 I print_info: CLS token        = 101 '[CLS]'
0.00.028.314 I print_info: MASK token       = 103 '[MASK]'
0.00.028.314 I print_info: LF token         = 0 '[PAD]'
0.00.028.315 I print_info: max token length = 21
ggml_vulkan: Compiling shaders...................................................Done!
0.00.306.082 I load_tensors: offloading 12 repeating layers to GPU
0.00.306.090 I load_tensors: offloading output layer to GPU
0.00.306.090 I load_tensors: offloaded 13/13 layers to GPU
0.00.306.096 I load_tensors:      Vulkan0 model buffer size =    40.73 MiB
0.00.306.096 I load_tensors:   CPU_Mapped model buffer size =    23.11 MiB
0.00.315.809 I llama_init_from_model: n_seq_max     = 1
0.00.315.816 I llama_init_from_model: n_ctx         = 512
0.00.315.816 I llama_init_from_model: n_ctx_per_seq = 512
0.00.315.817 I llama_init_from_model: n_batch       = 2048
0.00.315.817 I llama_init_from_model: n_ubatch      = 2048
0.00.315.817 I llama_init_from_model: flash_attn    = 0
0.00.315.821 I llama_init_from_model: freq_base     = 10000.0
0.00.315.822 I llama_init_from_model: freq_scale    = 1
0.00.316.341 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.318.808 I llama_kv_cache_init:    Vulkan0 KV buffer size =     9.00 MiB
0.00.318.817 I llama_init_from_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.318.830 I llama_init_from_model: Vulkan_Host  output buffer size =     0.00 MiB
0.00.322.700 I llama_init_from_model:    Vulkan0 compute buffer size =    16.00 MiB
0.00.322.707 I llama_init_from_model: Vulkan_Host compute buffer size =     2.51 MiB
0.00.322.708 I llama_init_from_model: graph nodes  = 429
0.00.322.708 I llama_init_from_model: graph splits = 4 (with bs=512), 2 (with bs=1)
0.00.322.712 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.322.712 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.329.393 I 
...
0.00.330.361 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.336.530 I llama_perf_context_print:        load time =     329.01 ms
0.00.336.532 I llama_perf_context_print: prompt eval time =       5.94 ms /     9 tokens (    0.66 ms per token,  1514.64 tokens per second)
0.00.336.533 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.336.533 I llama_perf_context_print:       total time =       7.14 ms /    10 tokens
ci/run.sh: line 709: 530855 Segmentation fault      (core dumped) ./bin/llama-embedding --model ${model_f16} -p "I believe the meaning of life is" -ngl 99 -c 0
