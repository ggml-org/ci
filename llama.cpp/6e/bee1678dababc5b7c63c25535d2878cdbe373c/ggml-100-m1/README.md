...
- status:  SUCCESS ✅
- runtime: 327.15
- date:    Thu May 30 14:49:52 EEST 2024
...
llama_print_timings:        load time =      71.25 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.01 ms /     9 tokens (    1.33 ms per token,   749.31 tokens per second)
