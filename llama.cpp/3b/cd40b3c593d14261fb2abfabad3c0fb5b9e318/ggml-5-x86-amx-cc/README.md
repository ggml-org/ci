...
- status:  SUCCESS ✅
- runtime: 5:26.64
- date:    Thu Nov  7 07:24:50 UTC 2024
...
0.00.000.612 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.903 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
...
0.00.021.244 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.271 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.272 I llm_load_print_meta: arch             = bert
0.00.021.274 I llm_load_print_meta: vocab type       = WPM
0.00.021.275 I llm_load_print_meta: n_vocab          = 30522
...
0.00.021.287 I llm_load_print_meta: n_swa            = 0
...
0.00.021.294 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.295 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.295 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.021.297 I llm_load_print_meta: n_expert_used    = 0
...
0.00.021.303 I llm_load_print_meta: model type       = 33M
0.00.021.304 I llm_load_print_meta: model ftype      = F16
0.00.021.305 I llm_load_print_meta: model params     = 33.21 M
0.00.021.305 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.021.306 I llm_load_print_meta: general.name     = Bge Small
0.00.021.306 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.306 I llm_load_print_meta: SEP token        = 102 '[SEP]'
...
0.00.025.037 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
0.00.025.057 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
................................................
0.00.038.841 I llama_new_context_with_model: n_seq_max     = 1
0.00.038.855 I llama_new_context_with_model: n_ctx         = 512
0.00.038.855 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.038.855 I llama_new_context_with_model: n_batch       = 2048
0.00.038.856 I llama_new_context_with_model: n_ubatch      = 2048
0.00.038.856 I llama_new_context_with_model: flash_attn    = 0
0.00.038.858 I llama_new_context_with_model: freq_base     = 10000.0
0.00.038.859 I llama_new_context_with_model: freq_scale    = 1
0.00.041.446 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.041.472 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.041.478 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.043.805 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.043.831 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.043.832 I llama_new_context_with_model: graph nodes  = 429
0.00.043.832 I llama_new_context_with_model: graph splits = 145
0.00.043.834 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.048.145 I 
0.00.048.263 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.049.947 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.054.819 I llama_perf_context_print:        load time =      47.34 ms
0.00.054.820 I llama_perf_context_print: prompt eval time =       4.61 ms /     9 tokens (    0.51 ms per token,  1953.12 tokens per second)
0.00.054.821 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.054.822 I llama_perf_context_print:       total time =       6.67 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.623 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.018.786 I llm_load_vocab: special tokens cache size = 5
0.00.021.284 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.311 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.312 I llm_load_print_meta: arch             = bert
0.00.021.314 I llm_load_print_meta: vocab type       = WPM
0.00.021.315 I llm_load_print_meta: n_vocab          = 30522
0.00.021.315 I llm_load_print_meta: n_merges         = 0
0.00.021.316 I llm_load_print_meta: vocab_only       = 0
...
0.00.021.327 I llm_load_print_meta: n_gqa            = 1
...
0.00.021.331 I llm_load_print_meta: f_logit_scale    = 0.0e+00
...
0.00.021.332 I llm_load_print_meta: causal attn      = 0
0.00.021.332 I llm_load_print_meta: pooling type     = 2
0.00.021.332 I llm_load_print_meta: rope type        = 2
0.00.021.332 I llm_load_print_meta: rope scaling     = linear
0.00.021.334 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.334 I llm_load_print_meta: freq_scale_train = 1
0.00.021.334 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.334 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.021.339 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.340 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.340 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.340 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.340 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.340 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.341 I llm_load_print_meta: max token length = 21
0.00.024.309 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.025.266 I llama_new_context_with_model: n_seq_max     = 1
0.00.025.281 I llama_new_context_with_model: n_ctx         = 512
0.00.025.282 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.025.282 I llama_new_context_with_model: n_batch       = 2048
0.00.025.282 I llama_new_context_with_model: n_ubatch      = 2048
0.00.025.283 I llama_new_context_with_model: flash_attn    = 0
0.00.025.284 I llama_new_context_with_model: freq_base     = 10000.0
0.00.025.284 I llama_new_context_with_model: freq_scale    = 1
0.00.028.322 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.028.349 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.028.354 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.029.646 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
...
0.00.032.392 I 
0.00.032.475 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.034.130 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.037.088 I llama_perf_context_print:        load time =      31.60 ms
0.00.037.090 I llama_perf_context_print: prompt eval time =       2.75 ms /     9 tokens (    0.31 ms per token,  3270.35 tokens per second)
0.00.037.091 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.037.091 I llama_perf_context_print:       total time =       4.70 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.694 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.008.702 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.008.756 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.756 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.757 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.758 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.762 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.763 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.008.763 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
...
0.00.016.065 I llama_model_loader: - kv  16:                  tokenizer.ggml.token_type arr[i32,61056]   = [3, 3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, ...
0.00.019.725 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.747 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.747 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.748 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.748 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.749 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.749 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.750 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.750 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.751 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.751 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.752 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.754 I llama_model_loader: - type  f32:   41 tensors
0.00.019.755 I llama_model_loader: - type  f16:   29 tensors
0.00.037.480 W llm_load_vocab: empty token at index 5
0.00.047.697 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.302 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.422 I llm_load_vocab: special tokens cache size = 5
0.00.341.840 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.341.864 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.341.864 I llm_load_print_meta: arch             = jina-bert-v2
0.00.341.865 I llm_load_print_meta: vocab type       = BPE
0.00.341.866 I llm_load_print_meta: n_vocab          = 61056
0.00.341.866 I llm_load_print_meta: n_merges         = 39382
0.00.341.866 I llm_load_print_meta: vocab_only       = 0
0.00.341.867 I llm_load_print_meta: n_ctx_train      = 8192
0.00.341.867 I llm_load_print_meta: n_embd           = 384
0.00.341.868 I llm_load_print_meta: n_layer          = 4
0.00.341.879 I llm_load_print_meta: n_head           = 12
0.00.341.880 I llm_load_print_meta: n_head_kv        = 12
0.00.341.880 I llm_load_print_meta: n_rot            = 32
0.00.341.880 I llm_load_print_meta: n_swa            = 0
0.00.341.880 I llm_load_print_meta: n_embd_head_k    = 32
0.00.341.881 I llm_load_print_meta: n_embd_head_v    = 32
0.00.341.882 I llm_load_print_meta: n_gqa            = 1
0.00.341.882 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.341.883 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.341.885 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.341.885 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.341.886 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.341.887 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.341.887 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.341.888 I llm_load_print_meta: n_ff             = 1536
0.00.341.888 I llm_load_print_meta: n_expert         = 0
0.00.341.888 I llm_load_print_meta: n_expert_used    = 0
0.00.341.889 I llm_load_print_meta: causal attn      = 0
0.00.341.889 I llm_load_print_meta: pooling type     = -1
0.00.341.889 I llm_load_print_meta: rope type        = -1
0.00.341.890 I llm_load_print_meta: rope scaling     = linear
0.00.341.891 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.341.891 I llm_load_print_meta: freq_scale_train = 1
0.00.341.892 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.341.892 I llm_load_print_meta: rope_finetuned   = unknown
0.00.341.893 I llm_load_print_meta: ssm_d_conv       = 0
0.00.341.893 I llm_load_print_meta: ssm_d_inner      = 0
0.00.341.893 I llm_load_print_meta: ssm_d_state      = 0
0.00.341.893 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.341.894 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.341.894 I llm_load_print_meta: model type       = 33M
0.00.341.895 I llm_load_print_meta: model ftype      = F16
0.00.341.896 I llm_load_print_meta: model params     = 32.90 M
0.00.341.896 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.341.897 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.341.897 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.341.898 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.341.898 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.341.898 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.341.899 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.341.899 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.341.899 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.341.899 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.341.900 I llm_load_print_meta: max token length = 45
0.00.345.925 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
0.00.345.939 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
.....................
0.00.353.987 I llama_new_context_with_model: n_seq_max     = 1
0.00.354.009 I llama_new_context_with_model: n_ctx         = 8192
0.00.354.009 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.354.010 I llama_new_context_with_model: n_batch       = 2048
0.00.354.010 I llama_new_context_with_model: n_ubatch      = 2048
0.00.354.010 I llama_new_context_with_model: flash_attn    = 0
0.00.354.012 I llama_new_context_with_model: freq_base     = 10000.0
0.00.354.013 I llama_new_context_with_model: freq_scale    = 1
0.00.363.871 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.363.898 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.363.905 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.365.356 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.365.370 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.365.371 I llama_new_context_with_model: graph nodes  = 154
0.00.365.371 I llama_new_context_with_model: graph splits = 57
0.00.365.373 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.374.566 I 
...
0.00.374.919 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.374.932 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.374.937 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.374.937 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.374.942 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.374.942 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.379.049 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.389.025 I llama_perf_context_print:        load time =     373.68 ms
0.00.389.027 I llama_perf_context_print: prompt eval time =       9.74 ms /    62 tokens (    0.16 ms per token,  6365.50 tokens per second)
0.00.389.029 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.389.030 I llama_perf_context_print:       total time =      14.46 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.817 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.189.325 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.189.341 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.985.966 I llama_new_context_with_model: n_seq_max     = 1
0.00.985.990 I llama_new_context_with_model: n_ctx         = 2048
0.00.985.990 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.985.991 I llama_new_context_with_model: n_batch       = 2048
0.00.985.991 I llama_new_context_with_model: n_ubatch      = 512
0.00.985.991 I llama_new_context_with_model: flash_attn    = 0
0.00.985.996 I llama_new_context_with_model: freq_base     = 10000.0
0.00.985.997 I llama_new_context_with_model: freq_scale    = 1
0.01.071.186 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.071.216 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.071.249 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.074.167 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.074.194 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.074.195 I llama_new_context_with_model: graph nodes  = 967
0.01.074.195 I llama_new_context_with_model: graph splits = 194
0.01.074.200 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.177.890 I main: llama threadpool init, n_threads = 4
0.01.177.917 I 
0.01.178.002 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.178.017 I 
0.01.178.158 I sampler seed: 1234
0.01.178.177 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.178.181 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.178.181 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.178.181 I 
...
0.05.010.147 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31924.46 tokens per second)
0.05.010.151 I llama_perf_context_print:        load time =    1176.66 ms
0.05.010.152 I llama_perf_context_print: prompt eval time =      96.24 ms /     7 tokens (   13.75 ms per token,    72.74 tokens per second)
0.05.010.153 I llama_perf_context_print:        eval time =    3724.53 ms /    63 runs   (   59.12 ms per token,    16.91 tokens per second)
0.05.010.154 I llama_perf_context_print:       total time =    3832.26 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.771 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.226 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.227 I llm_load_print_meta: model params     = 1.41 B
0.00.075.228 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.192.071 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.192.091 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.984.756 I llama_new_context_with_model: n_seq_max     = 1
0.00.984.771 I llama_new_context_with_model: n_ctx         = 128
0.00.984.772 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.984.772 I llama_new_context_with_model: n_batch       = 128
0.00.984.772 I llama_new_context_with_model: n_ubatch      = 128
0.00.984.773 I llama_new_context_with_model: flash_attn    = 0
0.00.984.777 I llama_new_context_with_model: freq_base     = 10000.0
0.00.984.778 I llama_new_context_with_model: freq_scale    = 1
0.00.984.779 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.990.335 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.990.364 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.990.386 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.992.908 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.00.992.925 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.00.992.925 I llama_new_context_with_model: graph nodes  = 967
0.00.992.926 I llama_new_context_with_model: graph splits = 194
0.00.992.927 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.059.549 I 
0.01.059.661 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.059.680 I perplexity: tokenizing the input ..
0.01.069.150 I perplexity: tokenization took 9.467 ms
0.01.069.180 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.986.035 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.989.880 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.989.962 I llama_perf_context_print:        load time =    1058.59 ms
0.01.989.965 I llama_perf_context_print: prompt eval time =     915.11 ms /   128 tokens (    7.15 ms per token,   139.87 tokens per second)
0.01.989.966 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.989.968 I llama_perf_context_print:       total time =     930.41 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.954 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.638 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
0.00.021.641 I llama_model_loader: - type  f32:  194 tensors
0.00.021.641 I llama_model_loader: - type q8_0:   98 tensors
...
0.00.075.733 I llm_load_print_meta: model ftype      = Q8_0
0.00.075.734 I llm_load_print_meta: model params     = 1.41 B
0.00.075.735 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.165.612 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.167.793 I llama_new_context_with_model: n_seq_max     = 1
0.00.167.814 I llama_new_context_with_model: n_ctx         = 2048
0.00.167.815 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.167.815 I llama_new_context_with_model: n_batch       = 2048
0.00.167.815 I llama_new_context_with_model: n_ubatch      = 512
0.00.167.816 I llama_new_context_with_model: flash_attn    = 0
0.00.167.817 I llama_new_context_with_model: freq_base     = 10000.0
0.00.167.818 I llama_new_context_with_model: freq_scale    = 1
0.00.236.335 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.236.363 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.236.380 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.238.326 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.238.347 I llama_new_context_with_model: graph nodes  = 967
0.00.238.347 I llama_new_context_with_model: graph splits = 1
0.00.238.351 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.323.580 I main: llama threadpool init, n_threads = 4
0.00.323.607 I 
0.00.323.687 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.323.699 I 
0.00.323.805 I sampler seed: 1234
0.00.323.824 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.323.827 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.323.827 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.323.828 I 
...
0.03.056.820 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31569.59 tokens per second)
0.03.056.822 I llama_perf_context_print:        load time =     322.20 ms
0.03.056.824 I llama_perf_context_print: prompt eval time =      78.29 ms /     7 tokens (   11.18 ms per token,    89.41 tokens per second)
0.03.056.825 I llama_perf_context_print:        eval time =    2643.36 ms /    63 runs   (   41.96 ms per token,    23.83 tokens per second)
0.03.056.825 I llama_perf_context_print:       total time =    2733.24 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.645 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.526 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.166.418 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.567 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.590 I llama_new_context_with_model: n_ctx         = 128
0.00.168.590 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.168.591 I llama_new_context_with_model: n_batch       = 128
0.00.168.591 I llama_new_context_with_model: n_ubatch      = 128
0.00.168.592 I llama_new_context_with_model: flash_attn    = 0
...
0.00.174.058 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.174.083 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.174.101 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.237.201 I 
0.00.237.378 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.237.401 I perplexity: tokenizing the input ..
0.00.246.138 I perplexity: tokenization took 8.735 ms
0.00.246.169 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.138.574 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.142.369 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.142.409 I llama_perf_context_print:        load time =     236.37 ms
0.01.142.411 I llama_perf_context_print: prompt eval time =     890.75 ms /   128 tokens (    6.96 ms per token,   143.70 tokens per second)
0.01.142.412 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.142.414 I llama_perf_context_print:       total time =     905.21 ms /   129 tokens
...
0.00.075.652 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.653 I llm_load_print_meta: model params     = 1.41 B
0.00.075.653 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.125.656 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.371.037 I llama_new_context_with_model: n_seq_max     = 1
0.00.371.052 I llama_new_context_with_model: n_ctx         = 2048
0.00.371.053 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.371.053 I llama_new_context_with_model: n_batch       = 2048
0.00.371.053 I llama_new_context_with_model: n_ubatch      = 512
0.00.371.054 I llama_new_context_with_model: flash_attn    = 0
0.00.371.059 I llama_new_context_with_model: freq_base     = 10000.0
0.00.371.060 I llama_new_context_with_model: freq_scale    = 1
0.00.440.509 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.440.539 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.440.571 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.443.684 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.443.706 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.443.707 I llama_new_context_with_model: graph nodes  = 967
0.00.443.707 I llama_new_context_with_model: graph splits = 193
0.00.443.711 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.515.542 I main: llama threadpool init, n_threads = 4
0.00.515.569 I 
0.00.515.661 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.515.661 I 
0.00.515.807 I sampler seed: 1234
0.00.515.829 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.515.832 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.515.832 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.515.832 I 
...
0.01.920.321 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31195.08 tokens per second)
0.01.920.325 I llama_perf_context_print:        load time =     514.49 ms
0.01.920.326 I llama_perf_context_print: prompt eval time =      39.73 ms /     7 tokens (    5.68 ms per token,   176.19 tokens per second)
0.01.920.328 I llama_perf_context_print:        eval time =    1353.63 ms /    63 runs   (   21.49 ms per token,    46.54 tokens per second)
0.01.920.329 I llama_perf_context_print:       total time =    1404.79 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.685 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.011 I llm_load_print_meta: model type       = 1.4B
0.00.076.012 I llm_load_print_meta: model ftype      = Q4_0
0.00.076.012 I llm_load_print_meta: model params     = 1.41 B
0.00.076.013 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
0.00.076.014 I llm_load_print_meta: general.name     = 1.4B
...
0.00.125.917 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.376.181 I llama_new_context_with_model: n_seq_max     = 1
0.00.376.200 I llama_new_context_with_model: n_ctx         = 128
0.00.376.201 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.376.201 I llama_new_context_with_model: n_batch       = 128
0.00.376.201 I llama_new_context_with_model: n_ubatch      = 128
0.00.376.202 I llama_new_context_with_model: flash_attn    = 0
0.00.376.208 I llama_new_context_with_model: freq_base     = 10000.0
0.00.376.208 I llama_new_context_with_model: freq_scale    = 1
0.00.376.209 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.381.863 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.381.892 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.381.915 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.384.945 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.384.967 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.384.967 I llama_new_context_with_model: graph nodes  = 967
0.00.384.968 I llama_new_context_with_model: graph splits = 193
0.00.384.970 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.422.328 I 
0.00.422.468 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.422.489 I perplexity: tokenizing the input ..
0.00.431.935 I perplexity: tokenization took 9.443 ms
0.00.431.969 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.887.467 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.891.431 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.891.516 I llama_perf_context_print:        load time =     421.47 ms
0.00.891.518 I llama_perf_context_print: prompt eval time =     453.65 ms /   128 tokens (    3.54 ms per token,   282.16 tokens per second)
0.00.891.519 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.891.519 I llama_perf_context_print:       total time =     469.19 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.823 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.383 I llama_model_loader: - kv  22:                          general.file_type u32              = 3
0.00.021.385 I llama_model_loader: - type  f32:  194 tensors
0.00.021.386 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.075.486 I llm_load_print_meta: model ftype      = Q4_1
0.00.075.487 I llm_load_print_meta: model params     = 1.41 B
0.00.075.488 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.119.363 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.119.380 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.389.482 I llama_new_context_with_model: n_seq_max     = 1
0.00.389.502 I llama_new_context_with_model: n_ctx         = 2048
0.00.389.503 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.389.503 I llama_new_context_with_model: n_batch       = 2048
0.00.389.503 I llama_new_context_with_model: n_ubatch      = 512
0.00.389.504 I llama_new_context_with_model: flash_attn    = 0
0.00.389.508 I llama_new_context_with_model: freq_base     = 10000.0
0.00.389.510 I llama_new_context_with_model: freq_scale    = 1
0.00.458.036 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.458.060 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.458.093 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.461.172 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.461.191 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.461.191 I llama_new_context_with_model: graph nodes  = 967
0.00.461.192 I llama_new_context_with_model: graph splits = 193
0.00.461.196 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.532.149 I main: llama threadpool init, n_threads = 4
0.00.532.176 I 
0.00.532.271 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.532.271 I 
0.00.532.477 I sampler seed: 1234
0.00.532.498 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.532.501 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.532.502 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.532.502 I 
...
0.02.040.743 I llama_perf_sampler_print:    sampling time =       2.15 ms /    71 runs   (    0.03 ms per token, 33023.26 tokens per second)
0.02.040.746 I llama_perf_context_print:        load time =     530.88 ms
0.02.040.748 I llama_perf_context_print: prompt eval time =      38.43 ms /     7 tokens (    5.49 ms per token,   182.14 tokens per second)
0.02.040.749 I llama_perf_context_print:        eval time =    1458.82 ms /    63 runs   (   23.16 ms per token,    43.19 tokens per second)
0.02.040.749 I llama_perf_context_print:       total time =    1508.60 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.844 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.292 I llama_model_loader: - type q4_1:   97 tensors
...
0.00.118.891 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.118.907 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.387.151 I llama_new_context_with_model: n_seq_max     = 1
0.00.387.172 I llama_new_context_with_model: n_ctx         = 128
0.00.387.172 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.387.172 I llama_new_context_with_model: n_batch       = 128
0.00.387.172 I llama_new_context_with_model: n_ubatch      = 128
0.00.387.173 I llama_new_context_with_model: flash_attn    = 0
0.00.387.177 I llama_new_context_with_model: freq_base     = 10000.0
0.00.387.178 I llama_new_context_with_model: freq_scale    = 1
0.00.387.179 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.392.756 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.392.778 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.392.795 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.395.765 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.395.789 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.395.790 I llama_new_context_with_model: graph nodes  = 967
0.00.395.790 I llama_new_context_with_model: graph splits = 193
0.00.395.792 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.427.647 I 
0.00.427.780 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.427.815 I perplexity: tokenizing the input ..
0.00.437.250 I perplexity: tokenization took 9.432 ms
0.00.437.285 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.909.575 I perplexity: 0.47 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.913.465 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.913.560 I llama_perf_context_print:        load time =     426.63 ms
0.00.913.563 I llama_perf_context_print: prompt eval time =     470.48 ms /   128 tokens (    3.68 ms per token,   272.06 tokens per second)
0.00.913.565 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.913.566 I llama_perf_context_print:       total time =     485.91 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.624 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.374 I llm_load_print_meta: model ftype      = Q5_0
...
0.00.075.377 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
...
0.00.119.678 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.121.821 I llama_new_context_with_model: n_seq_max     = 1
0.00.121.843 I llama_new_context_with_model: n_ctx         = 2048
0.00.121.843 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.121.843 I llama_new_context_with_model: n_batch       = 2048
0.00.121.844 I llama_new_context_with_model: n_ubatch      = 512
0.00.121.844 I llama_new_context_with_model: flash_attn    = 0
0.00.121.846 I llama_new_context_with_model: freq_base     = 10000.0
0.00.121.847 I llama_new_context_with_model: freq_scale    = 1
0.00.191.416 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.191.447 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.191.475 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.193.552 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.193.575 I llama_new_context_with_model: graph nodes  = 967
0.00.193.575 I llama_new_context_with_model: graph splits = 1
0.00.193.579 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.303.639 I main: llama threadpool init, n_threads = 4
0.00.303.670 I 
0.00.303.773 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.303.785 I 
0.00.303.936 I sampler seed: 1234
0.00.303.958 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.303.961 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.303.962 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.303.962 I 
...
0.02.631.091 I llama_perf_sampler_print:    sampling time =       2.33 ms /    71 runs   (    0.03 ms per token, 30498.28 tokens per second)
0.02.631.093 I llama_perf_context_print:        load time =     302.63 ms
0.02.631.095 I llama_perf_context_print: prompt eval time =     124.65 ms /     7 tokens (   17.81 ms per token,    56.16 tokens per second)
0.02.631.096 I llama_perf_context_print:        eval time =    2190.85 ms /    63 runs   (   34.78 ms per token,    28.76 tokens per second)
0.02.631.096 I llama_perf_context_print:       total time =    2327.46 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.729 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.170 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.121.519 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.123.651 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.673 I llama_new_context_with_model: n_ctx         = 128
0.00.123.673 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.123.674 I llama_new_context_with_model: n_batch       = 128
0.00.123.674 I llama_new_context_with_model: n_ubatch      = 128
0.00.123.674 I llama_new_context_with_model: flash_attn    = 0
0.00.123.676 I llama_new_context_with_model: freq_base     = 10000.0
0.00.123.676 I llama_new_context_with_model: freq_scale    = 1
0.00.123.677 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.129.118 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.129.145 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.129.158 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.131.652 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.131.676 I llama_new_context_with_model: graph nodes  = 967
0.00.131.676 I llama_new_context_with_model: graph splits = 1
0.00.131.678 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.204.543 I 
0.00.204.637 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.204.644 I perplexity: tokenizing the input ..
0.00.213.049 I perplexity: tokenization took 8.403 ms
0.00.213.080 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.339.876 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.343.629 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.343.669 I llama_perf_context_print:        load time =     203.64 ms
0.01.343.672 I llama_perf_context_print: prompt eval time =    1125.14 ms /   128 tokens (    8.79 ms per token,   113.76 tokens per second)
0.01.343.673 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.343.674 I llama_perf_context_print:       total time =    1139.12 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.674 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.527 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.021.529 I llama_model_loader: - type  f32:  194 tensors
0.00.021.530 I llama_model_loader: - type q5_1:   97 tensors
...
0.00.076.534 I llm_load_print_meta: model ftype      = Q5_1
0.00.076.535 I llm_load_print_meta: model params     = 1.41 B
0.00.076.536 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.124.758 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.126.977 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.195.696 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.725 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.743 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.198.326 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.198.345 I llama_new_context_with_model: graph nodes  = 967
0.00.198.345 I llama_new_context_with_model: graph splits = 1
0.00.198.349 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.838 I main: llama threadpool init, n_threads = 4
0.00.290.866 I 
0.00.290.949 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.290.962 I 
0.00.291.084 I sampler seed: 1234
0.00.291.103 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.291.106 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.291.107 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.291.107 I 
...
0.02.674.732 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31753.13 tokens per second)
0.02.674.735 I llama_perf_context_print:        load time =     289.74 ms
0.02.674.737 I llama_perf_context_print: prompt eval time =     121.35 ms /     7 tokens (   17.34 ms per token,    57.68 tokens per second)
0.02.674.739 I llama_perf_context_print:        eval time =    2251.05 ms /    63 runs   (   35.73 ms per token,    27.99 tokens per second)
0.02.674.740 I llama_perf_context_print:       total time =    2383.90 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.769 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.959 I llm_load_print_meta: model ftype      = Q5_1
0.00.074.960 I llm_load_print_meta: model params     = 1.41 B
0.00.074.961 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.123.405 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.125.550 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.573 I llama_new_context_with_model: n_ctx         = 128
0.00.125.573 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.125.573 I llama_new_context_with_model: n_batch       = 128
0.00.125.574 I llama_new_context_with_model: n_ubatch      = 128
0.00.125.574 I llama_new_context_with_model: flash_attn    = 0
0.00.125.576 I llama_new_context_with_model: freq_base     = 10000.0
0.00.125.577 I llama_new_context_with_model: freq_scale    = 1
0.00.125.578 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.130.894 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.130.920 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.130.933 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.450 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.469 I llama_new_context_with_model: graph nodes  = 967
0.00.133.469 I llama_new_context_with_model: graph splits = 1
0.00.133.472 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.191.778 I 
0.00.191.877 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.191.888 I perplexity: tokenizing the input ..
0.00.200.539 I perplexity: tokenization took 8.642 ms
0.00.200.567 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.139.813 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.143.337 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.143.376 I llama_perf_context_print:        load time =     190.83 ms
0.02.143.378 I llama_perf_context_print: prompt eval time =    1937.54 ms /   128 tokens (   15.14 ms per token,    66.06 tokens per second)
0.02.143.379 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.143.380 I llama_perf_context_print:       total time =    1951.60 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.660 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.634 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.021.637 I llama_model_loader: - type  f32:  194 tensors
0.00.021.638 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.638 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.076.064 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.065 I llm_load_print_meta: model params     = 1.41 B
0.00.076.066 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.105.073 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.107.199 I llama_new_context_with_model: n_seq_max     = 1
0.00.107.221 I llama_new_context_with_model: n_ctx         = 2048
0.00.107.222 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.107.222 I llama_new_context_with_model: n_batch       = 2048
0.00.107.222 I llama_new_context_with_model: n_ubatch      = 512
0.00.107.223 I llama_new_context_with_model: flash_attn    = 0
0.00.107.224 I llama_new_context_with_model: freq_base     = 10000.0
0.00.107.225 I llama_new_context_with_model: freq_scale    = 1
0.00.176.210 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.176.239 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.176.256 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.178.678 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.178.699 I llama_new_context_with_model: graph nodes  = 967
0.00.178.700 I llama_new_context_with_model: graph splits = 1
0.00.178.704 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.251.173 I main: llama threadpool init, n_threads = 4
0.00.251.201 I 
0.00.251.283 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.251.283 I 
0.00.251.391 I sampler seed: 1234
0.00.251.398 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.251.402 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.251.403 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.251.403 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.711.620 I llama_perf_sampler_print:    sampling time =       2.15 ms /    71 runs   (    0.03 ms per token, 33084.81 tokens per second)
0.01.711.623 I llama_perf_context_print:        load time =     250.02 ms
0.01.711.625 I llama_perf_context_print: prompt eval time =      76.77 ms /     7 tokens (   10.97 ms per token,    91.18 tokens per second)
0.01.711.626 I llama_perf_context_print:        eval time =    1372.49 ms /    63 runs   (   21.79 ms per token,    45.90 tokens per second)
0.01.711.626 I llama_perf_context_print:       total time =    1460.45 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.693 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.449 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
...
0.00.104.402 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.106.563 I llama_new_context_with_model: n_seq_max     = 1
0.00.106.585 I llama_new_context_with_model: n_ctx         = 128
0.00.106.586 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.106.586 I llama_new_context_with_model: n_batch       = 128
0.00.106.586 I llama_new_context_with_model: n_ubatch      = 128
0.00.106.587 I llama_new_context_with_model: flash_attn    = 0
0.00.106.588 I llama_new_context_with_model: freq_base     = 10000.0
0.00.106.589 I llama_new_context_with_model: freq_scale    = 1
0.00.106.590 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.112.001 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.112.022 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.112.035 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.114.566 I llama_new_context_with_model: graph splits = 1
0.00.114.568 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.154.487 I 
0.00.154.588 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.154.594 I perplexity: tokenizing the input ..
0.00.163.075 I perplexity: tokenization took 8.477 ms
0.00.163.107 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.457.483 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.461.343 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.461.382 I llama_perf_context_print:        load time =     153.59 ms
0.01.461.384 I llama_perf_context_print: prompt eval time =    1292.63 ms /   128 tokens (   10.10 ms per token,    99.02 tokens per second)
0.01.461.386 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.461.388 I llama_perf_context_print:       total time =    1306.89 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.638 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.202 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.075.880 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.112.320 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.114.505 I llama_new_context_with_model: n_seq_max     = 1
0.00.114.520 I llama_new_context_with_model: n_ctx         = 2048
0.00.114.520 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.114.521 I llama_new_context_with_model: n_batch       = 2048
0.00.114.521 I llama_new_context_with_model: n_ubatch      = 512
0.00.114.521 I llama_new_context_with_model: flash_attn    = 0
0.00.114.523 I llama_new_context_with_model: freq_base     = 10000.0
0.00.114.523 I llama_new_context_with_model: freq_scale    = 1
0.00.182.998 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.183.023 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.183.041 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.185.017 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.185.038 I llama_new_context_with_model: graph nodes  = 967
0.00.185.038 I llama_new_context_with_model: graph splits = 1
0.00.185.043 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.261.155 I main: llama threadpool init, n_threads = 4
0.00.261.183 I 
0.00.261.263 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.261.275 I 
0.00.261.387 I sampler seed: 1234
0.00.261.406 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.261.409 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.261.410 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.261.410 I 
...
0.02.004.733 I llama_perf_sampler_print:    sampling time =       2.14 ms /    71 runs   (    0.03 ms per token, 33208.61 tokens per second)
0.02.004.736 I llama_perf_context_print:        load time =     260.11 ms
0.02.004.737 I llama_perf_context_print: prompt eval time =      82.77 ms /     7 tokens (   11.82 ms per token,    84.58 tokens per second)
0.02.004.738 I llama_perf_context_print:        eval time =    1649.84 ms /    63 runs   (   26.19 ms per token,    38.19 tokens per second)
0.02.004.739 I llama_perf_context_print:       total time =    1743.58 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.700 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.600 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q3_k.gguf (version GGUF V3 (latest))
...
0.00.075.384 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.075.385 I llm_load_print_meta: model params     = 1.41 B
0.00.075.386 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.112.188 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.114.433 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.114.453 I llama_new_context_with_model: freq_base     = 10000.0
0.00.114.454 I llama_new_context_with_model: freq_scale    = 1
0.00.114.454 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.119.912 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.119.938 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.119.955 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.122.085 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.122.104 I llama_new_context_with_model: graph nodes  = 967
0.00.122.105 I llama_new_context_with_model: graph splits = 1
0.00.122.107 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.166.425 I 
0.00.166.523 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.166.530 I perplexity: tokenizing the input ..
0.00.175.057 I perplexity: tokenization took 8.524 ms
0.00.175.087 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.510.599 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.514.481 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.514.521 I llama_perf_context_print:        load time =     165.45 ms
0.01.514.523 I llama_perf_context_print: prompt eval time =    1333.77 ms /   128 tokens (   10.42 ms per token,    95.97 tokens per second)
0.01.514.524 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.514.538 I llama_perf_context_print:       total time =    1348.10 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.712 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.433 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
...
0.00.021.437 I llama_model_loader: - type q6_K:   13 tensors
...
0.00.075.780 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.781 I llm_load_print_meta: model params     = 1.41 B
0.00.075.782 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.120.412 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.122.660 I llama_new_context_with_model: n_seq_max     = 1
0.00.122.682 I llama_new_context_with_model: n_ctx         = 2048
0.00.122.682 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.122.682 I llama_new_context_with_model: n_batch       = 2048
0.00.122.683 I llama_new_context_with_model: n_ubatch      = 512
0.00.122.683 I llama_new_context_with_model: flash_attn    = 0
0.00.122.685 I llama_new_context_with_model: freq_base     = 10000.0
0.00.122.685 I llama_new_context_with_model: freq_scale    = 1
0.00.191.585 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.191.613 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.191.632 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.194.176 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.194.198 I llama_new_context_with_model: graph nodes  = 967
0.00.194.198 I llama_new_context_with_model: graph splits = 1
0.00.194.203 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.278.035 I main: llama threadpool init, n_threads = 4
0.00.278.063 I 
0.00.278.149 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.278.163 I 
0.00.278.312 I sampler seed: 1234
0.00.278.332 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.278.335 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.278.336 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.278.336 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.278.196 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31654.03 tokens per second)
0.02.278.199 I llama_perf_context_print:        load time =     276.82 ms
0.02.278.201 I llama_perf_context_print: prompt eval time =      93.14 ms /     7 tokens (   13.31 ms per token,    75.15 tokens per second)
0.02.278.202 I llama_perf_context_print:        eval time =    1895.61 ms /    63 runs   (   30.09 ms per token,    33.23 tokens per second)
0.02.278.202 I llama_perf_context_print:       total time =    2000.17 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.814 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.948 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.949 I llm_load_print_meta: model params     = 1.41 B
0.00.075.950 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.120.710 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.122.962 I llama_new_context_with_model: n_seq_max     = 1
0.00.122.984 I llama_new_context_with_model: n_ctx         = 128
0.00.122.984 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.122.985 I llama_new_context_with_model: n_batch       = 128
0.00.122.985 I llama_new_context_with_model: n_ubatch      = 128
0.00.122.985 I llama_new_context_with_model: flash_attn    = 0
0.00.122.987 I llama_new_context_with_model: freq_base     = 10000.0
0.00.122.988 I llama_new_context_with_model: freq_scale    = 1
0.00.122.989 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.128.476 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.128.498 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.128.513 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.130.961 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.130.984 I llama_new_context_with_model: graph nodes  = 967
0.00.130.984 I llama_new_context_with_model: graph splits = 1
0.00.130.986 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.179.542 I 
0.00.179.656 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.179.663 I perplexity: tokenizing the input ..
0.00.188.886 I perplexity: tokenization took 9.219 ms
0.00.188.917 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.588.626 I perplexity: 1.40 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.592.415 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.592.456 I llama_perf_context_print:        load time =     178.53 ms
0.01.592.470 I llama_perf_context_print: prompt eval time =    1397.99 ms /   128 tokens (   10.92 ms per token,    91.56 tokens per second)
0.01.592.471 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.592.472 I llama_perf_context_print:       total time =    1412.91 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.680 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.956 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.075.957 I llm_load_print_meta: model params     = 1.41 B
0.00.075.958 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.124.667 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.126.940 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.962 I llama_new_context_with_model: n_ctx         = 2048
0.00.126.962 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.126.962 I llama_new_context_with_model: n_batch       = 2048
0.00.126.963 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.963 I llama_new_context_with_model: flash_attn    = 0
0.00.126.965 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.966 I llama_new_context_with_model: freq_scale    = 1
0.00.195.472 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.501 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.520 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.724 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.739 I llama_new_context_with_model: graph nodes  = 967
0.00.197.740 I llama_new_context_with_model: graph splits = 1
0.00.197.743 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.290.498 I main: llama threadpool init, n_threads = 4
0.00.290.527 I 
0.00.290.622 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.290.637 I 
0.00.290.785 I sampler seed: 1234
0.00.290.806 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.290.809 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.290.810 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.290.810 I 
...
0.02.570.142 I llama_perf_sampler_print:    sampling time =       2.22 ms /    71 runs   (    0.03 ms per token, 31953.20 tokens per second)
0.02.570.145 I llama_perf_context_print:        load time =     289.38 ms
0.02.570.147 I llama_perf_context_print: prompt eval time =     109.98 ms /     7 tokens (   15.71 ms per token,    63.65 tokens per second)
0.02.570.148 I llama_perf_context_print:        eval time =    2158.24 ms /    63 runs   (   34.26 ms per token,    29.19 tokens per second)
0.02.570.148 I llama_perf_context_print:       total time =    2279.65 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.742 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.104 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf (version GGUF V3 (latest))
...
0.00.020.682 I llama_model_loader: - type q5_K:   61 tensors
0.00.020.682 I llama_model_loader: - type q6_K:   37 tensors
0.00.062.706 I llm_load_vocab: special tokens cache size = 25
...
0.00.074.361 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.361 I llm_load_print_meta: max token length = 1024
0.00.124.007 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.126.186 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.201 I llama_new_context_with_model: n_ctx         = 128
0.00.126.202 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.202 I llama_new_context_with_model: n_batch       = 128
0.00.126.202 I llama_new_context_with_model: n_ubatch      = 128
0.00.126.203 I llama_new_context_with_model: flash_attn    = 0
0.00.126.204 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.205 I llama_new_context_with_model: freq_scale    = 1
0.00.126.206 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.131.550 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.131.572 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.131.585 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.133.532 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.133.554 I llama_new_context_with_model: graph nodes  = 967
0.00.133.554 I llama_new_context_with_model: graph splits = 1
0.00.133.556 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.188.409 I 
0.00.188.514 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.188.520 I perplexity: tokenizing the input ..
0.00.197.386 I perplexity: tokenization took 8.862 ms
0.00.197.420 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.895.490 I perplexity: 1.70 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.899.258 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.899.296 I llama_perf_context_print:        load time =     187.47 ms
0.01.899.298 I llama_perf_context_print: prompt eval time =    1696.26 ms /   128 tokens (   13.25 ms per token,    75.46 tokens per second)
0.01.899.300 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.899.313 I llama_perf_context_print:       total time =    1710.89 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.643 I build: 4040 (3bcd40b3) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.979 I llm_load_vocab: token to piece cache size = 0.2984 MB
...
0.00.075.031 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.031 I llm_load_print_meta: model params     = 1.41 B
0.00.075.032 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.124.778 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
...
0.00.127.110 I llama_new_context_with_model: n_batch       = 2048
0.00.127.110 I llama_new_context_with_model: n_ubatch      = 512
...
0.00.196.101 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.196.119 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.198.616 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.198.639 I llama_new_context_with_model: graph nodes  = 967
0.00.198.639 I llama_new_context_with_model: graph splits = 1
0.00.198.643 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.287.102 I main: llama threadpool init, n_threads = 4
0.00.287.127 I 
0.00.287.217 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.287.229 I 
0.00.287.358 I sampler seed: 1234
0.00.287.377 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.287.380 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.287.381 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.287.381 I 
...
0.02.634.288 I llama_perf_sampler_print:    sampling time =       2.18 ms /    71 runs   (    0.03 ms per token, 32524.05 tokens per second)
0.02.634.291 I llama_perf_context_print:        load time =     286.03 ms
0.02.634.293 I llama_perf_context_print: prompt eval time =     106.40 ms /     7 tokens (   15.20 ms per token,    65.79 tokens per second)
0.02.634.294 I llama_perf_context_print:        eval time =    2229.15 ms /    63 runs   (   35.38 ms per token,    28.26 tokens per second)
0.02.634.295 I llama_perf_context_print:       total time =    2347.19 ms /    70 tokens
...
0.00.020.648 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
...
0.00.074.615 I llm_load_print_meta: model ftype      = Q6_K
...
0.00.124.533 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.127.014 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.035 I llama_new_context_with_model: n_ctx         = 128
0.00.127.036 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.127.036 I llama_new_context_with_model: n_batch       = 128
0.00.127.036 I llama_new_context_with_model: n_ubatch      = 128
0.00.127.037 I llama_new_context_with_model: flash_attn    = 0
0.00.127.038 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.039 I llama_new_context_with_model: freq_scale    = 1
0.00.127.040 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.132.427 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.132.453 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.132.467 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.134.545 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
...
0.00.189.686 I 
0.00.189.783 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.189.791 I perplexity: tokenizing the input ..
0.00.198.564 I perplexity: tokenization took 8.769 ms
0.00.198.596 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.847.283 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.851.144 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.851.185 I llama_perf_context_print:        load time =     188.82 ms
0.01.851.187 I llama_perf_context_print: prompt eval time =    1646.95 ms /   128 tokens (   12.87 ms per token,    77.72 tokens per second)
0.01.851.188 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.851.189 I llama_perf_context_print:       total time =    1661.50 ms /   129 tokens
...
0.00.446.568 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.447.472 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.61user 0.62system 0:01.24elapsed 100%CPU (0avgtext+0avgdata 5358564maxresident)k
0inputs+40outputs (0major+53786minor)pagefaults 0swaps
```
...
0.48user 0.62system 0:01.10elapsed 100%CPU (0avgtext+0avgdata 5355120maxresident)k
