...
- status:  SUCCESS ✅
- runtime: 4:03.60
- date:    Sat Nov  9 07:40:01 UTC 2024
...
0.00.000.631 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.003.987 I llama_model_loader: - kv  12:                      bert.attention.causal bool             = false
...
0.00.021.932 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.021.965 I llm_load_print_meta: n_embd           = 384
...
0.00.021.976 I llm_load_print_meta: n_rot            = 32
0.00.021.976 I llm_load_print_meta: n_swa            = 0
...
0.00.021.981 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.021.981 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.982 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.982 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.021.986 I llm_load_print_meta: causal attn      = 0
0.00.021.986 I llm_load_print_meta: pooling type     = 2
0.00.021.987 I llm_load_print_meta: rope type        = 2
0.00.021.987 I llm_load_print_meta: rope scaling     = linear
0.00.021.988 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.989 I llm_load_print_meta: freq_scale_train = 1
...
0.00.021.991 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.991 I llm_load_print_meta: ssm_d_state      = 0
0.00.021.992 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.021.992 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.992 I llm_load_print_meta: model type       = 33M
0.00.021.993 I llm_load_print_meta: model ftype      = F16
...
0.00.021.997 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.997 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.998 I llm_load_print_meta: CLS token        = 101 '[CLS]'
...
0.00.025.850 I llm_load_tensors:   CPU_Mapped model buffer size =    63.84 MiB
0.00.025.864 I llm_load_tensors:          AMX model buffer size =    40.50 MiB
................................................
0.00.040.185 I llama_new_context_with_model: n_seq_max     = 1
0.00.040.200 I llama_new_context_with_model: n_ctx         = 512
0.00.040.200 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.040.201 I llama_new_context_with_model: n_batch       = 2048
0.00.040.202 I llama_new_context_with_model: n_ubatch      = 2048
0.00.040.202 I llama_new_context_with_model: flash_attn    = 0
0.00.040.204 I llama_new_context_with_model: freq_base     = 10000.0
0.00.040.205 I llama_new_context_with_model: freq_scale    = 1
0.00.042.993 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.043.015 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.043.021 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.044.841 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.044.862 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.044.863 I llama_new_context_with_model: graph nodes  = 429
0.00.044.863 I llama_new_context_with_model: graph splits = 145
0.00.044.865 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.048.724 I 
0.00.048.812 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.050.527 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.056.000 I llama_perf_context_print:        load time =      47.90 ms
0.00.056.002 I llama_perf_context_print: prompt eval time =       5.25 ms /     9 tokens (    0.58 ms per token,  1714.29 tokens per second)
0.00.056.004 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.056.004 I llama_perf_context_print:       total time =       7.28 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.623 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.018.998 I llm_load_vocab: special tokens cache size = 5
0.00.021.486 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.514 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.516 I llm_load_print_meta: arch             = bert
...
0.00.021.518 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.518 I llm_load_print_meta: n_embd           = 384
...
0.00.021.528 I llm_load_print_meta: n_rot            = 32
...
0.00.021.542 I llm_load_print_meta: model type       = 33M
0.00.021.543 I llm_load_print_meta: model ftype      = Q8_0
...
0.00.024.219 I llm_load_tensors:   CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.025.274 I llama_new_context_with_model: n_seq_max     = 1
0.00.025.288 I llama_new_context_with_model: n_ctx         = 512
0.00.025.289 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.025.289 I llama_new_context_with_model: n_batch       = 2048
0.00.025.289 I llama_new_context_with_model: n_ubatch      = 2048
0.00.025.290 I llama_new_context_with_model: flash_attn    = 0
0.00.025.291 I llama_new_context_with_model: freq_base     = 10000.0
0.00.025.291 I llama_new_context_with_model: freq_scale    = 1
0.00.028.162 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.028.188 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.028.193 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.029.417 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.029.438 I llama_new_context_with_model: graph nodes  = 429
0.00.029.439 I llama_new_context_with_model: graph splits = 1
0.00.029.440 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.032.052 I 
0.00.032.134 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.033.685 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.036.957 I llama_perf_context_print:        load time =      31.26 ms
0.00.036.959 I llama_perf_context_print: prompt eval time =       3.04 ms /     9 tokens (    0.34 ms per token,  2956.64 tokens per second)
0.00.036.960 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.036.961 I llama_perf_context_print:       total time =       4.90 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.688 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.008.619 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.008.620 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.008.620 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.008.621 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.008.625 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.008.626 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
...
0.00.019.477 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
...
0.00.019.478 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.481 I llama_model_loader: - type  f32:   41 tensors
0.00.019.482 I llama_model_loader: - type  f16:   29 tensors
0.00.037.286 W llm_load_vocab: empty token at index 5
0.00.046.883 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.060.277 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.060.401 I llm_load_vocab: special tokens cache size = 5
0.00.340.816 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.340.838 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.340.838 I llm_load_print_meta: arch             = jina-bert-v2
0.00.340.839 I llm_load_print_meta: vocab type       = BPE
0.00.340.839 I llm_load_print_meta: n_vocab          = 61056
0.00.340.840 I llm_load_print_meta: n_merges         = 39382
0.00.340.840 I llm_load_print_meta: vocab_only       = 0
0.00.340.840 I llm_load_print_meta: n_ctx_train      = 8192
0.00.340.840 I llm_load_print_meta: n_embd           = 384
0.00.340.841 I llm_load_print_meta: n_layer          = 4
0.00.340.849 I llm_load_print_meta: n_head           = 12
0.00.340.850 I llm_load_print_meta: n_head_kv        = 12
0.00.340.850 I llm_load_print_meta: n_rot            = 32
0.00.340.850 I llm_load_print_meta: n_swa            = 0
0.00.340.851 I llm_load_print_meta: n_embd_head_k    = 32
0.00.340.851 I llm_load_print_meta: n_embd_head_v    = 32
0.00.340.852 I llm_load_print_meta: n_gqa            = 1
0.00.340.852 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.340.853 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.340.855 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.340.855 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.340.856 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.340.856 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.340.856 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.340.857 I llm_load_print_meta: n_ff             = 1536
0.00.340.857 I llm_load_print_meta: n_expert         = 0
0.00.340.857 I llm_load_print_meta: n_expert_used    = 0
0.00.340.858 I llm_load_print_meta: causal attn      = 0
0.00.340.858 I llm_load_print_meta: pooling type     = -1
0.00.340.858 I llm_load_print_meta: rope type        = -1
0.00.340.858 I llm_load_print_meta: rope scaling     = linear
0.00.340.860 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.340.860 I llm_load_print_meta: freq_scale_train = 1
0.00.340.861 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.340.861 I llm_load_print_meta: rope_finetuned   = unknown
0.00.340.861 I llm_load_print_meta: ssm_d_conv       = 0
0.00.340.861 I llm_load_print_meta: ssm_d_inner      = 0
0.00.340.862 I llm_load_print_meta: ssm_d_state      = 0
0.00.340.862 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.340.862 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.340.863 I llm_load_print_meta: model type       = 33M
0.00.340.863 I llm_load_print_meta: model ftype      = F16
0.00.340.864 I llm_load_print_meta: model params     = 32.90 M
0.00.340.865 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.340.865 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.340.866 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.340.866 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.340.866 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.340.866 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.340.866 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.340.867 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.340.867 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.340.867 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.340.867 I llm_load_print_meta: max token length = 45
0.00.344.614 I llm_load_tensors:   CPU_Mapped model buffer size =    62.78 MiB
0.00.344.636 I llm_load_tensors:          AMX model buffer size =    18.00 MiB
.....................
0.00.351.975 I llama_new_context_with_model: n_seq_max     = 1
0.00.351.996 I llama_new_context_with_model: n_ctx         = 8192
0.00.351.996 I llama_new_context_with_model: n_ctx_per_seq = 8192
...
0.00.351.999 I llama_new_context_with_model: freq_scale    = 1
0.00.361.676 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.361.698 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.361.704 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.363.486 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.363.507 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.363.508 I llama_new_context_with_model: graph nodes  = 154
0.00.363.508 I llama_new_context_with_model: graph splits = 57
0.00.363.510 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.372.181 I 
0.00.372.267 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.372.469 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.372.482 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.372.489 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.372.489 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.372.493 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.372.493 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.376.416 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.384.660 I llama_perf_context_print:        load time =     371.29 ms
0.00.384.662 I llama_perf_context_print: prompt eval time =       8.01 ms /    62 tokens (    0.13 ms per token,  7741.29 tokens per second)
0.00.384.663 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.384.664 I llama_perf_context_print:       total time =      12.48 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.683 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.287 I llama_model_loader: - type  f16:   98 tensors
...
0.00.076.257 I llm_load_print_meta: model ftype      = all F32 (guessed)
...
0.00.192.502 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.192.519 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.985.468 I llama_new_context_with_model: n_seq_max     = 1
0.00.985.491 I llama_new_context_with_model: n_ctx         = 2048
0.00.985.491 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.985.491 I llama_new_context_with_model: n_batch       = 2048
0.00.985.492 I llama_new_context_with_model: n_ubatch      = 512
0.00.985.492 I llama_new_context_with_model: flash_attn    = 0
0.00.985.496 I llama_new_context_with_model: freq_base     = 10000.0
0.00.985.497 I llama_new_context_with_model: freq_scale    = 1
0.01.054.272 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.054.302 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.054.331 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.057.414 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.057.438 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.057.438 I llama_new_context_with_model: graph nodes  = 967
0.01.057.439 I llama_new_context_with_model: graph splits = 194
0.01.057.443 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.159.849 I main: llama threadpool init, n_threads = 4
0.01.159.876 I 
0.01.159.965 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.159.981 I 
0.01.160.133 I sampler seed: 1234
0.01.160.152 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.160.155 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.160.155 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.160.156 I 
...
0.05.017.340 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31569.59 tokens per second)
0.05.017.343 I llama_perf_context_print:        load time =    1158.71 ms
0.05.017.345 I llama_perf_context_print: prompt eval time =      98.44 ms /     7 tokens (   14.06 ms per token,    71.11 tokens per second)
0.05.017.346 I llama_perf_context_print:        eval time =    3747.27 ms /    63 runs   (   59.48 ms per token,    16.81 tokens per second)
0.05.017.346 I llama_perf_context_print:       total time =    3857.50 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.740 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.702 I llama_model_loader: - type  f16:   98 tensors
...
0.00.075.692 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.075.693 I llm_load_print_meta: model params     = 1.41 B
0.00.075.694 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.195.617 I llm_load_tensors:   CPU_Mapped model buffer size =  2502.95 MiB
0.00.195.635 I llm_load_tensors:          AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.989.889 I llama_new_context_with_model: n_seq_max     = 1
0.00.989.911 I llama_new_context_with_model: n_ctx         = 128
0.00.989.911 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.989.911 I llama_new_context_with_model: n_batch       = 128
0.00.989.912 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.989.919 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.995.514 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.995.542 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.995.566 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.998.044 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.00.998.063 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.00.998.064 I llama_new_context_with_model: graph nodes  = 967
0.00.998.064 I llama_new_context_with_model: graph splits = 194
0.00.998.066 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.065.031 I 
0.01.065.139 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.065.163 I perplexity: tokenizing the input ..
0.01.074.752 I perplexity: tokenization took 9.543 ms
0.01.074.786 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.990.878 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.994.483 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.994.570 I llama_perf_context_print:        load time =    1064.11 ms
0.01.994.572 I llama_perf_context_print: prompt eval time =     914.29 ms /   128 tokens (    7.14 ms per token,   140.00 tokens per second)
0.01.994.573 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.994.573 I llama_perf_context_print:       total time =     929.54 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.645 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.164.541 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.166.813 I llama_new_context_with_model: n_seq_max     = 1
0.00.166.836 I llama_new_context_with_model: n_ctx         = 2048
0.00.166.836 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.166.837 I llama_new_context_with_model: n_batch       = 2048
0.00.166.837 I llama_new_context_with_model: n_ubatch      = 512
0.00.166.837 I llama_new_context_with_model: flash_attn    = 0
0.00.166.839 I llama_new_context_with_model: freq_base     = 10000.0
0.00.166.840 I llama_new_context_with_model: freq_scale    = 1
0.00.235.364 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.235.391 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.235.410 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.237.927 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.237.949 I llama_new_context_with_model: graph nodes  = 967
0.00.237.949 I llama_new_context_with_model: graph splits = 1
0.00.237.953 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.337.384 I main: llama threadpool init, n_threads = 4
0.00.337.411 I 
0.00.337.492 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.337.506 I 
0.00.337.607 I sampler seed: 1234
0.00.337.624 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.337.627 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.337.628 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.337.628 I 
...
0.03.068.030 I llama_perf_sampler_print:    sampling time =       2.23 ms /    71 runs   (    0.03 ms per token, 31852.85 tokens per second)
0.03.068.033 I llama_perf_context_print:        load time =     336.32 ms
0.03.068.034 I llama_perf_context_print: prompt eval time =      86.92 ms /     7 tokens (   12.42 ms per token,    80.53 tokens per second)
0.03.068.035 I llama_perf_context_print:        eval time =    2632.06 ms /    63 runs   (   41.78 ms per token,    23.94 tokens per second)
0.03.068.036 I llama_perf_context_print:       total time =    2730.65 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.695 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.167.139 I llm_load_tensors:   CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.169.350 I llama_new_context_with_model: n_seq_max     = 1
0.00.169.367 I llama_new_context_with_model: n_ctx         = 128
0.00.169.367 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.169.368 I llama_new_context_with_model: n_batch       = 128
0.00.169.368 I llama_new_context_with_model: n_ubatch      = 128
0.00.169.368 I llama_new_context_with_model: flash_attn    = 0
...
0.00.174.708 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.174.725 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.177.476 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.177.494 I llama_new_context_with_model: graph nodes  = 967
0.00.177.494 I llama_new_context_with_model: graph splits = 1
0.00.177.496 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.242.574 I 
0.00.242.679 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.242.691 I perplexity: tokenizing the input ..
0.00.251.214 I perplexity: tokenization took 8.524 ms
0.00.251.247 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.141.640 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.145.527 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.145.569 I llama_perf_context_print:        load time =     241.70 ms
0.01.145.572 I llama_perf_context_print: prompt eval time =     889.08 ms /   128 tokens (    6.95 ms per token,   143.97 tokens per second)
0.01.145.573 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.145.574 I llama_perf_context_print:       total time =     902.99 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.717 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.412 I llm_load_print_meta: vocab type       = BPE
...
0.00.076.439 I llm_load_print_meta: model ftype      = Q4_0
0.00.076.439 I llm_load_print_meta: model params     = 1.41 B
0.00.076.440 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.126.555 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
0.00.126.573 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.372.216 I llama_new_context_with_model: n_seq_max     = 1
0.00.372.235 I llama_new_context_with_model: n_ctx         = 2048
0.00.372.235 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.372.236 I llama_new_context_with_model: n_batch       = 2048
0.00.372.236 I llama_new_context_with_model: n_ubatch      = 512
0.00.372.237 I llama_new_context_with_model: flash_attn    = 0
0.00.372.240 I llama_new_context_with_model: freq_base     = 10000.0
0.00.372.241 I llama_new_context_with_model: freq_scale    = 1
0.00.441.653 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.441.684 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.441.715 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.444.778 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.444.797 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.444.798 I llama_new_context_with_model: graph nodes  = 967
0.00.444.798 I llama_new_context_with_model: graph splits = 193
0.00.444.802 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.515.766 I main: llama threadpool init, n_threads = 4
0.00.515.794 I 
0.00.515.881 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.515.894 I 
0.00.516.047 I sampler seed: 1234
0.00.516.066 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.516.069 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.516.070 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.516.070 I 
...
0.01.914.899 I llama_perf_sampler_print:    sampling time =       2.17 ms /    71 runs   (    0.03 ms per token, 32658.69 tokens per second)
0.01.914.902 I llama_perf_context_print:        load time =     514.63 ms
0.01.914.903 I llama_perf_context_print: prompt eval time =      39.31 ms /     7 tokens (    5.62 ms per token,   178.06 tokens per second)
0.01.914.904 I llama_perf_context_print:        eval time =    1348.72 ms /    63 runs   (   21.41 ms per token,    46.71 tokens per second)
0.01.914.905 I llama_perf_context_print:       total time =    1399.14 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.721 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.845 I llama_model_loader: - type q4_0:   97 tensors
...
0.00.074.406 I llm_load_print_meta: n_vocab          = 50304
0.00.074.406 I llm_load_print_meta: n_merges         = 50009
0.00.074.407 I llm_load_print_meta: vocab_only       = 0
0.00.074.407 I llm_load_print_meta: n_ctx_train      = 2048
0.00.074.407 I llm_load_print_meta: n_embd           = 2048
0.00.074.407 I llm_load_print_meta: n_layer          = 24
0.00.074.416 I llm_load_print_meta: n_head           = 16
0.00.074.417 I llm_load_print_meta: n_head_kv        = 16
...
0.00.074.433 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.123.568 I llm_load_tensors:   CPU_Mapped model buffer size =   777.31 MiB
0.00.123.587 I llm_load_tensors:          AMX model buffer size =   648.00 MiB
.............................................................................
0.00.368.306 I llama_new_context_with_model: n_seq_max     = 1
0.00.368.327 I llama_new_context_with_model: n_ctx         = 128
0.00.368.328 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.368.328 I llama_new_context_with_model: n_batch       = 128
0.00.368.329 I llama_new_context_with_model: n_ubatch      = 128
0.00.368.329 I llama_new_context_with_model: flash_attn    = 0
0.00.368.334 I llama_new_context_with_model: freq_base     = 10000.0
0.00.368.335 I llama_new_context_with_model: freq_scale    = 1
0.00.368.336 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.373.926 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.373.953 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.373.980 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.376.420 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.376.445 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.376.445 I llama_new_context_with_model: graph nodes  = 967
0.00.376.446 I llama_new_context_with_model: graph splits = 193
0.00.376.448 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.412.375 I 
0.00.412.495 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.412.502 I perplexity: tokenizing the input ..
0.00.422.053 I perplexity: tokenization took 9.548 ms
0.00.422.085 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.880.581 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.884.302 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.884.382 I llama_perf_context_print:        load time =     411.47 ms
0.00.884.384 I llama_perf_context_print: prompt eval time =     456.66 ms /   128 tokens (    3.57 ms per token,   280.30 tokens per second)
0.00.884.386 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.884.386 I llama_perf_context_print:       total time =     472.01 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.755 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.414 I llm_load_print_meta: n_layer          = 24
0.00.076.423 I llm_load_print_meta: n_head           = 16
0.00.076.424 I llm_load_print_meta: n_head_kv        = 16
...
0.00.076.472 I llm_load_print_meta: model ftype      = Q4_1
0.00.076.473 I llm_load_print_meta: model params     = 1.41 B
0.00.076.474 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.123.937 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.123.953 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.399.651 I llama_new_context_with_model: n_seq_max     = 1
0.00.399.672 I llama_new_context_with_model: n_ctx         = 2048
0.00.399.672 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.399.673 I llama_new_context_with_model: n_batch       = 2048
0.00.399.673 I llama_new_context_with_model: n_ubatch      = 512
0.00.399.674 I llama_new_context_with_model: flash_attn    = 0
0.00.399.679 I llama_new_context_with_model: freq_base     = 10000.0
0.00.399.681 I llama_new_context_with_model: freq_scale    = 1
0.00.468.900 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.468.925 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.468.956 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.471.531 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.471.556 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.471.557 I llama_new_context_with_model: graph nodes  = 967
0.00.471.557 I llama_new_context_with_model: graph splits = 193
0.00.471.562 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.543.777 I main: llama threadpool init, n_threads = 4
0.00.543.804 I 
0.00.543.896 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.543.897 I 
0.00.544.048 I sampler seed: 1234
0.00.544.072 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.544.075 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.544.076 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.544.076 I 
...
0.02.059.707 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32405.29 tokens per second)
0.02.059.710 I llama_perf_context_print:        load time =     542.57 ms
0.02.059.711 I llama_perf_context_print: prompt eval time =      37.08 ms /     7 tokens (    5.30 ms per token,   188.78 tokens per second)
0.02.059.712 I llama_perf_context_print:        eval time =    1467.69 ms /    63 runs   (   23.30 ms per token,    42.92 tokens per second)
0.02.059.713 I llama_perf_context_print:       total time =    1515.94 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.671 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.074.356 I llm_load_print_meta: n_embd_head_k    = 128
...
0.00.074.361 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
...
0.00.074.367 I llm_load_print_meta: model ftype      = Q4_1
...
0.00.122.777 I llm_load_tensors:   CPU_Mapped model buffer size =   854.46 MiB
0.00.122.794 I llm_load_tensors:          AMX model buffer size =   720.00 MiB
............................................................................
0.00.395.198 I llama_new_context_with_model: n_seq_max     = 1
0.00.395.220 I llama_new_context_with_model: n_ctx         = 128
0.00.395.220 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.395.220 I llama_new_context_with_model: n_batch       = 128
0.00.395.221 I llama_new_context_with_model: n_ubatch      = 128
0.00.395.221 I llama_new_context_with_model: flash_attn    = 0
0.00.395.225 I llama_new_context_with_model: freq_base     = 10000.0
0.00.395.227 I llama_new_context_with_model: freq_scale    = 1
0.00.395.228 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.400.725 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.400.754 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.400.776 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.403.741 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.403.767 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.403.767 I llama_new_context_with_model: graph nodes  = 967
0.00.403.767 I llama_new_context_with_model: graph splits = 193
0.00.403.769 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.439.228 I 
0.00.439.362 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.439.371 I perplexity: tokenizing the input ..
0.00.448.834 I perplexity: tokenization took 9.459 ms
0.00.448.872 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.925.980 I perplexity: 0.48 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.929.839 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.929.932 I llama_perf_context_print:        load time =     438.39 ms
0.00.929.934 I llama_perf_context_print: prompt eval time =     475.23 ms /   128 tokens (    3.71 ms per token,   269.34 tokens per second)
0.00.929.936 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.929.937 I llama_perf_context_print:       total time =     490.70 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.664 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.356 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.075.839 I llm_load_print_meta: model ftype      = Q5_0
...
0.00.122.629 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
...
0.00.125.157 I llama_new_context_with_model: n_batch       = 2048
...
0.00.125.160 I llama_new_context_with_model: freq_scale    = 1
0.00.193.105 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.193.128 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.193.147 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.302.592 I main: llama threadpool init, n_threads = 4
0.00.302.620 I 
0.00.302.694 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.302.707 I 
0.00.302.802 I sampler seed: 1234
0.00.302.821 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.302.824 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.302.824 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.302.825 I 
...
0.02.527.725 I llama_perf_sampler_print:    sampling time =       2.26 ms /    71 runs   (    0.03 ms per token, 31457.69 tokens per second)
0.02.527.728 I llama_perf_context_print:        load time =     301.49 ms
0.02.527.730 I llama_perf_context_print: prompt eval time =      75.20 ms /     7 tokens (   10.74 ms per token,    93.09 tokens per second)
0.02.527.731 I llama_perf_context_print:        eval time =    2138.45 ms /    63 runs   (   33.94 ms per token,    29.46 tokens per second)
0.02.527.731 I llama_perf_context_print:       total time =    2225.14 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.698 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.066 I llm_load_print_meta: model ftype      = Q5_0
...
0.00.122.918 I llm_load_tensors:   CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.125.128 I llama_new_context_with_model: n_seq_max     = 1
0.00.125.145 I llama_new_context_with_model: n_ctx         = 128
0.00.125.145 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.125.145 I llama_new_context_with_model: n_batch       = 128
0.00.125.146 I llama_new_context_with_model: n_ubatch      = 128
0.00.125.146 I llama_new_context_with_model: flash_attn    = 0
0.00.125.148 I llama_new_context_with_model: freq_base     = 10000.0
0.00.125.148 I llama_new_context_with_model: freq_scale    = 1
0.00.125.149 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.130.511 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.130.539 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.130.552 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
...
0.00.175.896 I 
0.00.175.997 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.176.016 I perplexity: tokenizing the input ..
0.00.184.380 I perplexity: tokenization took 8.361 ms
0.00.184.418 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.312.254 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.316.144 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.316.192 I llama_perf_context_print:        load time =     174.92 ms
0.01.316.207 I llama_perf_context_print: prompt eval time =    1126.16 ms /   128 tokens (    8.80 ms per token,   113.66 tokens per second)
0.01.316.209 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.316.210 I llama_perf_context_print:       total time =    1140.29 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.791 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.276 I llm_load_print_meta: model ftype      = Q5_1
...
0.00.125.120 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.127.370 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.391 I llama_new_context_with_model: n_ctx         = 2048
0.00.127.392 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.127.392 I llama_new_context_with_model: n_batch       = 2048
0.00.127.392 I llama_new_context_with_model: n_ubatch      = 512
0.00.127.393 I llama_new_context_with_model: flash_attn    = 0
0.00.127.394 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.395 I llama_new_context_with_model: freq_scale    = 1
0.00.195.493 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.519 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.537 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.735 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.755 I llama_new_context_with_model: graph nodes  = 967
0.00.197.755 I llama_new_context_with_model: graph splits = 1
0.00.197.759 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.291.266 I main: llama threadpool init, n_threads = 4
0.00.291.293 I 
0.00.291.377 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.291.391 I 
0.00.291.528 I sampler seed: 1234
0.00.291.560 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.291.563 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.676.533 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31696.43 tokens per second)
0.02.676.536 I llama_perf_context_print:        load time =     290.00 ms
0.02.676.538 I llama_perf_context_print: prompt eval time =     125.03 ms /     7 tokens (   17.86 ms per token,    55.99 tokens per second)
0.02.676.539 I llama_perf_context_print:        eval time =    2249.11 ms /    63 runs   (   35.70 ms per token,    28.01 tokens per second)
0.02.676.539 I llama_perf_context_print:       total time =    2385.28 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.711 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.820 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
...
0.00.075.504 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.505 I llm_load_print_meta: model params     = 1.41 B
0.00.075.506 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.124.075 I llm_load_tensors:   CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.126.294 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.316 I llama_new_context_with_model: n_ctx         = 128
0.00.126.317 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.317 I llama_new_context_with_model: n_batch       = 128
0.00.126.318 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.126.321 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.131.713 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
...
0.00.134.266 I llama_new_context_with_model: graph nodes  = 967
0.00.134.266 I llama_new_context_with_model: graph splits = 1
0.00.134.268 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.195.374 I 
0.00.195.474 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.195.481 I perplexity: tokenizing the input ..
0.00.204.149 I perplexity: tokenization took 8.664 ms
0.00.204.184 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.140.618 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.144.576 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.144.617 I llama_perf_context_print:        load time =     194.40 ms
0.02.144.631 I llama_perf_context_print: prompt eval time =    1934.69 ms /   128 tokens (   15.11 ms per token,    66.16 tokens per second)
0.02.144.632 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.144.632 I llama_perf_context_print:       total time =    1949.24 ms /   129 tokens
...
0.00.021.479 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.021.482 I llama_model_loader: - type  f32:  194 tensors
0.00.021.482 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.483 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.076.309 I llm_load_print_meta: n_ctx_train      = 2048
...
0.00.076.329 I llm_load_print_meta: rope scaling     = linear
...
0.00.076.334 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.076.335 I llm_load_print_meta: model params     = 1.41 B
0.00.076.336 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.106.098 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.108.289 I llama_new_context_with_model: n_seq_max     = 1
0.00.108.310 I llama_new_context_with_model: n_ctx         = 2048
0.00.108.311 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.108.311 I llama_new_context_with_model: n_batch       = 2048
0.00.108.311 I llama_new_context_with_model: n_ubatch      = 512
0.00.108.312 I llama_new_context_with_model: flash_attn    = 0
0.00.108.313 I llama_new_context_with_model: freq_base     = 10000.0
0.00.108.314 I llama_new_context_with_model: freq_scale    = 1
0.00.176.633 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.176.661 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.176.677 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.178.779 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.178.796 I llama_new_context_with_model: graph nodes  = 967
0.00.178.796 I llama_new_context_with_model: graph splits = 1
0.00.178.800 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.253.658 I main: llama threadpool init, n_threads = 4
0.00.253.684 I 
0.00.253.761 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.253.761 I 
0.00.253.887 I sampler seed: 1234
0.00.253.899 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.253.904 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.253.905 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.253.905 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.731.154 I llama_perf_sampler_print:    sampling time =       2.13 ms /    71 runs   (    0.03 ms per token, 33317.69 tokens per second)
0.01.731.157 I llama_perf_context_print:        load time =     252.47 ms
0.01.731.158 I llama_perf_context_print: prompt eval time =      82.06 ms /     7 tokens (   11.72 ms per token,    85.31 tokens per second)
0.01.731.160 I llama_perf_context_print:        eval time =    1384.41 ms /    63 runs   (   21.97 ms per token,    45.51 tokens per second)
0.01.731.160 I llama_perf_context_print:       total time =    1477.50 ms /    70 tokens
...
0.00.020.472 I llama_model_loader: - kv  22:                          general.file_type u32              = 10
0.00.020.475 I llama_model_loader: - type  f32:  194 tensors
0.00.020.476 I llama_model_loader: - type q2_K:   49 tensors
0.00.020.476 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.105.147 I llm_load_tensors:   CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.107.288 I llama_new_context_with_model: n_seq_max     = 1
0.00.107.309 I llama_new_context_with_model: n_ctx         = 128
0.00.107.309 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.107.310 I llama_new_context_with_model: n_batch       = 128
0.00.107.310 I llama_new_context_with_model: n_ubatch      = 128
0.00.107.310 I llama_new_context_with_model: flash_attn    = 0
0.00.107.312 I llama_new_context_with_model: freq_base     = 10000.0
0.00.107.312 I llama_new_context_with_model: freq_scale    = 1
0.00.107.313 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.112.634 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.112.656 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.112.669 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.115.226 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.115.243 I llama_new_context_with_model: graph nodes  = 967
0.00.115.243 I llama_new_context_with_model: graph splits = 1
0.00.115.245 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.154.292 I 
0.00.154.394 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.154.401 I perplexity: tokenizing the input ..
0.00.163.208 I perplexity: tokenization took 8.803 ms
0.00.163.237 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.459.908 I perplexity: 1.30 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.463.607 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.463.649 I llama_perf_context_print:        load time =     153.41 ms
0.01.463.651 I llama_perf_context_print: prompt eval time =    1294.68 ms /   128 tokens (   10.11 ms per token,    98.87 tokens per second)
0.01.463.652 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.463.653 I llama_perf_context_print:       total time =    1309.36 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.676 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.113.521 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.115.676 I llama_new_context_with_model: n_seq_max     = 1
0.00.115.697 I llama_new_context_with_model: n_ctx         = 2048
0.00.115.697 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.115.698 I llama_new_context_with_model: n_batch       = 2048
0.00.115.698 I llama_new_context_with_model: n_ubatch      = 512
0.00.115.698 I llama_new_context_with_model: flash_attn    = 0
0.00.115.700 I llama_new_context_with_model: freq_base     = 10000.0
0.00.115.700 I llama_new_context_with_model: freq_scale    = 1
0.00.185.862 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.185.889 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.185.907 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.188.433 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.188.454 I llama_new_context_with_model: graph nodes  = 967
0.00.188.454 I llama_new_context_with_model: graph splits = 1
0.00.188.458 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.269.043 I main: llama threadpool init, n_threads = 4
0.00.269.069 I 
0.00.269.150 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.269.162 I 
0.00.269.286 I sampler seed: 1234
0.00.269.304 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.269.307 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.269.307 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.269.308 I 
...
0.02.026.049 I llama_perf_sampler_print:    sampling time =       2.14 ms /    71 runs   (    0.03 ms per token, 33224.15 tokens per second)
0.02.026.052 I llama_perf_context_print:        load time =     267.95 ms
0.02.026.053 I llama_perf_context_print: prompt eval time =      87.49 ms /     7 tokens (   12.50 ms per token,    80.01 tokens per second)
0.02.026.054 I llama_perf_context_print:        eval time =    1658.51 ms /    63 runs   (   26.33 ms per token,    37.99 tokens per second)
0.02.026.055 I llama_perf_context_print:       total time =    1757.01 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.701 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.511 I llama_model_loader: - type q3_K:   25 tensors
0.00.020.511 I llama_model_loader: - type q4_K:   71 tensors
0.00.020.512 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.074.947 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.074.948 I llm_load_print_meta: model params     = 1.41 B
0.00.074.949 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.112.409 I llm_load_tensors:   CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.114.582 I llama_new_context_with_model: n_seq_max     = 1
0.00.114.604 I llama_new_context_with_model: n_ctx         = 128
0.00.114.604 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.114.604 I llama_new_context_with_model: n_batch       = 128
0.00.114.605 I llama_new_context_with_model: n_ubatch      = 128
0.00.114.605 I llama_new_context_with_model: flash_attn    = 0
0.00.114.607 I llama_new_context_with_model: freq_base     = 10000.0
0.00.114.607 I llama_new_context_with_model: freq_scale    = 1
0.00.114.608 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.120.130 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.120.155 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.120.168 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.122.854 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.122.876 I llama_new_context_with_model: graph nodes  = 967
0.00.122.876 I llama_new_context_with_model: graph splits = 1
0.00.122.878 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.164.843 I 
0.00.164.943 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.164.949 I perplexity: tokenizing the input ..
0.00.173.665 I perplexity: tokenization took 8.713 ms
0.00.173.693 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.509.618 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.513.517 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.513.560 I llama_perf_context_print:        load time =     163.96 ms
0.01.513.562 I llama_perf_context_print: prompt eval time =    1334.14 ms /   128 tokens (   10.42 ms per token,    95.94 tokens per second)
0.01.513.562 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.513.563 I llama_perf_context_print:       total time =    1348.72 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.674 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.066 I llama_model_loader: - type q5_K:   24 tensors
...
0.00.122.585 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.124.741 I llama_new_context_with_model: n_seq_max     = 1
0.00.124.762 I llama_new_context_with_model: n_ctx         = 2048
0.00.124.762 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.124.763 I llama_new_context_with_model: n_batch       = 2048
0.00.124.763 I llama_new_context_with_model: n_ubatch      = 512
0.00.124.763 I llama_new_context_with_model: flash_attn    = 0
0.00.124.765 I llama_new_context_with_model: freq_base     = 10000.0
0.00.124.766 I llama_new_context_with_model: freq_scale    = 1
0.00.194.041 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.194.070 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
...
0.00.196.722 I llama_new_context_with_model: graph nodes  = 967
0.00.196.722 I llama_new_context_with_model: graph splits = 1
0.00.196.726 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.277.208 I main: llama threadpool init, n_threads = 4
0.00.277.235 I 
0.00.277.316 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.277.329 I 
...
0.00.277.471 I sampler params: 
	...
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.277.474 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.275.838 I llama_perf_sampler_print:    sampling time =       2.29 ms /    71 runs   (    0.03 ms per token, 31058.62 tokens per second)
0.02.275.841 I llama_perf_context_print:        load time =     276.15 ms
0.02.275.842 I llama_perf_context_print: prompt eval time =      88.95 ms /     7 tokens (   12.71 ms per token,    78.69 tokens per second)
0.02.275.843 I llama_perf_context_print:        eval time =    1898.32 ms /    63 runs   (   30.13 ms per token,    33.19 tokens per second)
0.02.275.843 I llama_perf_context_print:       total time =    1998.64 ms /    70 tokens
...
0.00.075.938 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.121.485 I llm_load_tensors:   CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.123.598 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.620 I llama_new_context_with_model: n_ctx         = 128
0.00.123.620 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.123.620 I llama_new_context_with_model: n_batch       = 128
0.00.123.620 I llama_new_context_with_model: n_ubatch      = 128
0.00.123.621 I llama_new_context_with_model: flash_attn    = 0
0.00.123.622 I llama_new_context_with_model: freq_base     = 10000.0
0.00.123.623 I llama_new_context_with_model: freq_scale    = 1
0.00.123.623 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.129.194 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.129.214 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.129.228 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.131.235 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.131.256 I llama_new_context_with_model: graph nodes  = 967
0.00.131.257 I llama_new_context_with_model: graph splits = 1
0.00.131.258 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.180.405 I 
0.00.180.516 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.180.522 I perplexity: tokenizing the input ..
0.00.189.444 I perplexity: tokenization took 8.917 ms
0.00.189.472 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.586.931 I perplexity: 1.40 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.590.770 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.590.811 I llama_perf_context_print:        load time =     179.57 ms
0.01.590.813 I llama_perf_context_print: prompt eval time =    1395.72 ms /   128 tokens (   10.90 ms per token,    91.71 tokens per second)
0.01.590.814 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.590.814 I llama_perf_context_print:       total time =    1410.41 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.639 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.163 I llama_model_loader: - kv  22:                          general.file_type u32              = 17
...
0.00.075.776 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.124.907 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.127.067 I llama_new_context_with_model: n_seq_max     = 1
0.00.127.089 I llama_new_context_with_model: n_ctx         = 2048
0.00.127.089 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.127.089 I llama_new_context_with_model: n_batch       = 2048
0.00.127.090 I llama_new_context_with_model: n_ubatch      = 512
0.00.127.090 I llama_new_context_with_model: flash_attn    = 0
0.00.127.092 I llama_new_context_with_model: freq_base     = 10000.0
0.00.127.093 I llama_new_context_with_model: freq_scale    = 1
0.00.195.565 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.195.593 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.195.610 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.197.575 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.197.597 I llama_new_context_with_model: graph nodes  = 967
0.00.197.598 I llama_new_context_with_model: graph splits = 1
0.00.197.601 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.286.210 I main: llama threadpool init, n_threads = 4
0.00.286.239 I 
0.00.286.325 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.286.338 I 
0.00.286.501 I sampler seed: 1234
0.00.286.519 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.286.522 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.568.949 I llama_perf_sampler_print:    sampling time =       2.21 ms /    71 runs   (    0.03 ms per token, 32068.65 tokens per second)
0.02.568.952 I llama_perf_context_print:        load time =     285.16 ms
0.02.568.953 I llama_perf_context_print: prompt eval time =     111.75 ms /     7 tokens (   15.96 ms per token,    62.64 tokens per second)
0.02.568.954 I llama_perf_context_print:        eval time =    2159.66 ms /    63 runs   (   34.28 ms per token,    29.17 tokens per second)
0.02.568.955 I llama_perf_context_print:       total time =    2282.75 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.805 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.124.393 I llm_load_tensors:   CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.126.567 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.589 I llama_new_context_with_model: n_ctx         = 128
0.00.126.589 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.589 I llama_new_context_with_model: n_batch       = 128
0.00.126.590 I llama_new_context_with_model: n_ubatch      = 128
0.00.126.590 I llama_new_context_with_model: flash_attn    = 0
0.00.126.592 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.592 I llama_new_context_with_model: freq_scale    = 1
0.00.126.593 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.131.970 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.131.996 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.132.012 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.134.567 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.134.589 I llama_new_context_with_model: graph nodes  = 967
0.00.134.589 I llama_new_context_with_model: graph splits = 1
0.00.134.591 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.190.057 I 
0.00.190.170 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.190.191 I perplexity: tokenizing the input ..
0.00.198.769 I perplexity: tokenization took 8.575 ms
0.00.198.807 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.891.305 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.895.082 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.895.126 I llama_perf_context_print:        load time =     189.07 ms
0.01.895.129 I llama_perf_context_print: prompt eval time =    1690.68 ms /   128 tokens (   13.21 ms per token,    75.71 tokens per second)
0.01.895.130 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.895.131 I llama_perf_context_print:       total time =    1705.07 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.693 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.245 I llm_load_print_meta: ssm_d_inner      = 0
...
0.00.076.247 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.248 I llm_load_print_meta: model params     = 1.41 B
0.00.076.249 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.129.582 I llm_load_tensors:   CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.131.771 I llama_new_context_with_model: n_seq_max     = 1
0.00.131.794 I llama_new_context_with_model: n_ctx         = 2048
0.00.131.794 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.131.794 I llama_new_context_with_model: n_batch       = 2048
0.00.131.795 I llama_new_context_with_model: n_ubatch      = 512
0.00.131.795 I llama_new_context_with_model: flash_attn    = 0
0.00.131.797 I llama_new_context_with_model: freq_base     = 10000.0
0.00.131.797 I llama_new_context_with_model: freq_scale    = 1
0.00.200.188 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.200.216 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.200.234 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.202.320 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.202.342 I llama_new_context_with_model: graph nodes  = 967
0.00.202.342 I llama_new_context_with_model: graph splits = 1
0.00.202.346 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.293.945 I main: llama threadpool init, n_threads = 4
0.00.293.972 I 
0.00.294.050 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.294.064 I 
0.00.294.199 I sampler seed: 1234
0.00.294.218 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.294.222 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.294.222 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.294.222 I 
...
0.02.721.565 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31113.06 tokens per second)
0.02.721.568 I llama_perf_context_print:        load time =     292.76 ms
0.02.721.569 I llama_perf_context_print: prompt eval time =     111.34 ms /     7 tokens (   15.91 ms per token,    62.87 tokens per second)
0.02.721.570 I llama_perf_context_print:        eval time =    2304.89 ms /    63 runs   (   36.59 ms per token,    27.33 tokens per second)
0.02.721.571 I llama_perf_context_print:       total time =    2427.62 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.816 I build: 4056 (5b359bb1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.251 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
0.00.021.253 I llama_model_loader: - type  f32:  194 tensors
0.00.021.254 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.075.464 I llm_load_print_meta: model ftype      = Q6_K
...
...............................................................................
0.00.130.537 I llama_new_context_with_model: n_seq_max     = 1
0.00.130.559 I llama_new_context_with_model: n_ctx         = 128
0.00.130.559 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.130.559 I llama_new_context_with_model: n_batch       = 128
0.00.130.559 I llama_new_context_with_model: n_ubatch      = 128
0.00.130.560 I llama_new_context_with_model: flash_attn    = 0
...
0.00.135.553 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.135.580 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.135.597 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.137.592 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.137.613 I llama_new_context_with_model: graph nodes  = 967
0.00.137.613 I llama_new_context_with_model: graph splits = 1
0.00.137.615 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.193.085 I 
0.00.193.192 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.193.211 I perplexity: tokenizing the input ..
0.00.202.106 I perplexity: tokenization took 8.891 ms
0.00.202.138 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.854.495 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.858.151 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.858.193 I llama_perf_context_print:        load time =     192.09 ms
0.01.858.195 I llama_perf_context_print: prompt eval time =    1650.79 ms /   128 tokens (   12.90 ms per token,    77.54 tokens per second)
0.01.858.197 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.858.198 I llama_perf_context_print:       total time =    1665.11 ms /   129 tokens
...
0.00.440.966 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.436.143 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.61user 0.63system 0:01.23elapsed 100%CPU (0avgtext+0avgdata 5358556maxresident)k
...
0inputs+32outputs (0major+53639minor)pagefaults 0swaps
```
