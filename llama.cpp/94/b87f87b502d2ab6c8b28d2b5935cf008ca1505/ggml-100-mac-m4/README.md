...
- status:  SUCCESS ✅
- runtime: 871.16
- date:    Fri Feb 14 06:41:41 PST 2025
...
0.00.284.833 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.299.194 I print_info: LF token         = 187 'Ċ'
...
0.00.056.827 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.076.744 I print_info: LF token         = 187 'Ċ'
...
0.00.035.172 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.051.205 I print_info: LF token         = 187 'Ċ'
...
0.00.041.817 I print_info: LF token         = 187 'Ċ'
...
0.00.026.865 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.040.397 I print_info: LF token         = 187 'Ċ'
...
0.00.037.959 I print_info: LF token         = 187 'Ċ'
...
0.00.026.922 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.039.775 I print_info: LF token         = 187 'Ċ'
...
0.00.026.743 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.041.053 I print_info: LF token         = 187 'Ċ'
...
0.00.040.017 I print_info: LF token         = 187 'Ċ'
...
0.00.027.547 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.042.024 I print_info: LF token         = 187 'Ċ'
