...
- status:  SUCCESS ✅
- runtime: 491.53
- date:    Mon Apr 22 14:02:13 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   93.16 sec
      Start 22: test-rope
...
15/23 Test #15: test-tokenizer-1-starcoder ..........   Passed    0.68 sec
      Start 16: test-tokenizer-1-gpt2
16/23 Test #16: test-tokenizer-1-gpt2 ...............   Passed    0.75 sec
      Start 17: test-grammar-parser
...
<bos> After many years of waiting, I finally got my chance to take the exam.

The anticipation was building day and night, and the tension was palpable as I sat
llama_print_timings:        load time =    2605.46 ms
llama_print_timings:      sample time =      55.91 ms /    32 runs   (    1.75 ms per token,   572.30 tokens per second)
llama_print_timings: prompt eval time =     196.80 ms /     2 tokens (   98.40 ms per token,    10.16 tokens per second)
llama_print_timings:        eval time =    1488.81 ms /    31 runs   (   48.03 ms per token,    20.82 tokens per second)
llama_print_timings:       total time =    2476.33 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After a long day, you decide to take a relaxing bath. As you soak in the warm water, your mind begins to drift into a peaceful state. Your body
llama_print_timings:        load time =    2712.71 ms
llama_print_timings:      sample time =      58.60 ms /    32 runs   (    1.83 ms per token,   546.06 tokens per second)
llama_print_timings: prompt eval time =     205.33 ms /     2 tokens (  102.67 ms per token,     9.74 tokens per second)
llama_print_timings:        eval time =    1495.24 ms /    31 runs   (   48.23 ms per token,    20.73 tokens per second)
llama_print_timings:       total time =    2550.08 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> When, Where and Who

**When:**
- Events occur regularly or seasonally.
- Scheduled activities or appointments.
- Time-based deadlines or milestones.
llama_print_timings:        load time =    2678.53 ms
llama_print_timings:      sample time =      57.52 ms /    32 runs   (    1.80 ms per token,   556.34 tokens per second)
llama_print_timings: prompt eval time =     198.10 ms /     2 tokens (   99.05 ms per token,    10.10 tokens per second)
llama_print_timings:        eval time =    1495.79 ms /    31 runs   (   48.25 ms per token,    20.72 tokens per second)
llama_print_timings:       total time =    2523.52 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2492.68 ms
llama_print_timings:      sample time =      16.53 ms /    32 runs   (    0.52 ms per token,  1936.23 tokens per second)
llama_print_timings: prompt eval time =     197.17 ms /     2 tokens (   98.59 ms per token,    10.14 tokens per second)
llama_print_timings:        eval time =    1523.23 ms /    31 runs   (   49.14 ms per token,    20.35 tokens per second)
...
<bos> Heuristics:
Heuristics are mental shortcuts that people use to make decisions quickly and efficiently. They are based on past experiences and intuitive reasoning, rather than
llama_print_timings:        load time =    3202.41 ms
llama_print_timings:      sample time =      16.47 ms /    32 runs   (    0.51 ms per token,  1943.40 tokens per second)
llama_print_timings: prompt eval time =     201.18 ms /     2 tokens (  100.59 ms per token,     9.94 tokens per second)
llama_print_timings:        eval time =    1555.84 ms /    31 runs   (   50.19 ms per token,    19.92 tokens per second)
llama_print_timings:       total time =    1848.25 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
f(-2) = 3(-
llama_print_timings:        load time =    2761.24 ms
llama_print_timings:      sample time =      16.35 ms /    32 runs   (    0.51 ms per token,  1957.19 tokens per second)
llama_print_timings: prompt eval time =     196.01 ms /     2 tokens (   98.00 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1544.78 ms /    31 runs   (   49.83 ms per token,    20.07 tokens per second)
llama_print_timings:       total time =    1831.01 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
