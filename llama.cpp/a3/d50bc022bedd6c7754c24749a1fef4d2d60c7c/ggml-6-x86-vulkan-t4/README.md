...
- status:  FAILURE ❌ (139)
- runtime: 5:48.37
- date:    Tue Jan  7 11:44:07 UTC 2025
...
18/28 Test #18: test-json-schema-to-grammar .......   Passed   10.58 sec
...
Label Time Summary:
main    = 119.21 sec*proc (28 tests)

Total Test time (real) = 119.22 sec
...
23/28 Test #23: test-gguf .........................   Passed    0.60 sec
      Start 24: test-backend-ops
24/28 Test #24: test-backend-ops ..................   Passed   10.71 sec
      Start 27: test-barrier
...
0.00.000.183 I build: 4434 (a3d50bc0) with cc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0 for x86_64-linux-gnu
...
0.00.024.186 I llm_load_vocab: token to piece cache size = 0.2032 MB
...
0.00.024.199 I llm_load_print_meta: vocab_only       = 0
0.00.024.200 I llm_load_print_meta: n_ctx_train      = 512
0.00.024.200 I llm_load_print_meta: n_embd           = 384
0.00.024.201 I llm_load_print_meta: n_layer          = 12
0.00.024.206 I llm_load_print_meta: n_head           = 12
0.00.024.208 I llm_load_print_meta: n_head_kv        = 12
0.00.024.208 I llm_load_print_meta: n_rot            = 32
0.00.024.208 I llm_load_print_meta: n_swa            = 0
0.00.024.209 I llm_load_print_meta: n_embd_head_k    = 32
0.00.024.209 I llm_load_print_meta: n_embd_head_v    = 32
0.00.024.210 I llm_load_print_meta: n_gqa            = 1
0.00.024.212 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.024.213 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.024.214 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.024.214 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.024.215 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.024.215 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.024.215 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.024.216 I llm_load_print_meta: n_ff             = 1536
0.00.024.217 I llm_load_print_meta: n_expert         = 0
0.00.024.217 I llm_load_print_meta: n_expert_used    = 0
0.00.024.217 I llm_load_print_meta: causal attn      = 0
0.00.024.217 I llm_load_print_meta: pooling type     = 2
0.00.024.218 I llm_load_print_meta: rope type        = 2
0.00.024.218 I llm_load_print_meta: rope scaling     = linear
0.00.024.219 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.024.220 I llm_load_print_meta: freq_scale_train = 1
0.00.024.220 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.024.220 I llm_load_print_meta: rope_finetuned   = unknown
0.00.024.221 I llm_load_print_meta: ssm_d_conv       = 0
0.00.024.221 I llm_load_print_meta: ssm_d_inner      = 0
0.00.024.221 I llm_load_print_meta: ssm_d_state      = 0
0.00.024.221 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.024.222 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.024.223 I llm_load_print_meta: model type       = 33M
0.00.024.224 I llm_load_print_meta: model ftype      = F16
0.00.024.225 I llm_load_print_meta: model params     = 33.21 M
0.00.024.226 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
0.00.024.226 I llm_load_print_meta: general.name     = Bge Small
0.00.024.227 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.024.227 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.024.227 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.024.227 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.024.228 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.024.228 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.024.229 I llm_load_print_meta: max token length = 21
ggml_vulkan: Compiling shaders...................................................Done!
0.00.294.546 I llm_load_tensors: offloading 12 repeating layers to GPU
0.00.294.550 I llm_load_tensors: offloading output layer to GPU
0.00.294.551 I llm_load_tensors: offloaded 13/13 layers to GPU
0.00.294.556 I llm_load_tensors:      Vulkan0 model buffer size =    40.73 MiB
0.00.294.557 I llm_load_tensors:   CPU_Mapped model buffer size =    23.11 MiB
................................................
0.00.304.729 I llama_new_context_with_model: n_seq_max     = 1
0.00.304.733 I llama_new_context_with_model: n_ctx         = 512
0.00.304.733 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.304.734 I llama_new_context_with_model: n_batch       = 2048
0.00.304.734 I llama_new_context_with_model: n_ubatch      = 2048
0.00.304.734 I llama_new_context_with_model: flash_attn    = 0
0.00.304.738 I llama_new_context_with_model: freq_base     = 10000.0
0.00.304.739 I llama_new_context_with_model: freq_scale    = 1
0.00.305.212 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.307.627 I llama_kv_cache_init:    Vulkan0 KV buffer size =     9.00 MiB
0.00.307.636 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.307.651 I llama_new_context_with_model: Vulkan_Host  output buffer size =     0.00 MiB
0.00.311.393 I llama_new_context_with_model:    Vulkan0 compute buffer size =    16.00 MiB
0.00.311.401 I llama_new_context_with_model: Vulkan_Host compute buffer size =     2.51 MiB
0.00.311.402 I llama_new_context_with_model: graph nodes  = 429
0.00.311.402 I llama_new_context_with_model: graph splits = 4 (with bs=512), 2 (with bs=1)
0.00.311.405 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.311.406 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.318.056 I 
0.00.318.119 I system_info: n_threads = 4 (n_threads_batch = 4) / 4 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.319.808 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.325.676 I llama_perf_context_print:        load time =     317.69 ms
0.00.325.678 I llama_perf_context_print: prompt eval time =       5.68 ms /     9 tokens (    0.63 ms per token,  1583.67 tokens per second)
0.00.325.679 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.325.679 I llama_perf_context_print:       total time =       7.62 ms /    10 tokens
...
ggml_vulkan: Found 1 Vulkan devices:
ggml_vulkan: 0 = Tesla T4 (NVIDIA) | uma: 0 | fp16: 1 | warp size: 32 | matrix cores: KHR_coopmat
0.00.000.176 I build: 4434 (a3d50bc0) with cc (Ubuntu 13.3.0-6ubuntu2~24.04) 13.3.0 for x86_64-linux-gnu
...
0.00.010.498 I llama_model_loader: - kv  19:            tokenizer.ggml.unknown_token_id u32              = 100
0.00.010.499 I llama_model_loader: - kv  20:          tokenizer.ggml.seperator_token_id u32              = 102
0.00.010.499 I llama_model_loader: - kv  21:            tokenizer.ggml.padding_token_id u32              = 0
0.00.010.500 I llama_model_loader: - kv  22:                tokenizer.ggml.cls_token_id u32              = 101
0.00.010.500 I llama_model_loader: - kv  23:               tokenizer.ggml.mask_token_id u32              = 103
0.00.010.500 I llama_model_loader: - kv  24:               general.quantization_version u32              = 2
0.00.010.502 I llama_model_loader: - type  f32:  124 tensors
0.00.010.502 I llama_model_loader: - type q8_0:   73 tensors
0.00.018.781 I llm_load_vocab: special tokens cache size = 5
0.00.023.992 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.024.002 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.024.003 I llm_load_print_meta: arch             = bert
0.00.024.003 I llm_load_print_meta: vocab type       = WPM
0.00.024.003 I llm_load_print_meta: n_vocab          = 30522
0.00.024.004 I llm_load_print_meta: n_merges         = 0
0.00.024.004 I llm_load_print_meta: vocab_only       = 0
0.00.024.004 I llm_load_print_meta: n_ctx_train      = 512
0.00.024.006 I llm_load_print_meta: n_embd           = 384
0.00.024.006 I llm_load_print_meta: n_layer          = 12
0.00.024.012 I llm_load_print_meta: n_head           = 12
0.00.024.013 I llm_load_print_meta: n_head_kv        = 12
0.00.024.014 I llm_load_print_meta: n_rot            = 32
0.00.024.014 I llm_load_print_meta: n_swa            = 0
0.00.024.014 I llm_load_print_meta: n_embd_head_k    = 32
0.00.024.014 I llm_load_print_meta: n_embd_head_v    = 32
0.00.024.016 I llm_load_print_meta: n_gqa            = 1
0.00.024.018 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.024.019 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.024.020 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.024.020 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.024.020 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.024.021 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.024.022 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.024.023 I llm_load_print_meta: n_ff             = 1536
0.00.024.024 I llm_load_print_meta: n_expert         = 0
0.00.024.024 I llm_load_print_meta: n_expert_used    = 0
0.00.024.025 I llm_load_print_meta: causal attn      = 0
0.00.024.025 I llm_load_print_meta: pooling type     = 2
0.00.024.025 I llm_load_print_meta: rope type        = 2
0.00.024.025 I llm_load_print_meta: rope scaling     = linear
0.00.024.027 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.024.027 I llm_load_print_meta: freq_scale_train = 1
0.00.024.027 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.024.028 I llm_load_print_meta: rope_finetuned   = unknown
0.00.024.028 I llm_load_print_meta: ssm_d_conv       = 0
0.00.024.028 I llm_load_print_meta: ssm_d_inner      = 0
0.00.024.028 I llm_load_print_meta: ssm_d_state      = 0
0.00.024.028 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.024.029 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.024.031 I llm_load_print_meta: model type       = 33M
0.00.024.032 I llm_load_print_meta: model ftype      = Q8_0
0.00.024.033 I llm_load_print_meta: model params     = 33.21 M
0.00.024.034 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.024.034 I llm_load_print_meta: general.name     = Bge Small
0.00.024.034 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.024.035 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.024.035 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.024.035 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.024.035 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.024.036 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.024.036 I llm_load_print_meta: max token length = 21
ggml_vulkan: Compiling shaders...................................................Done!
0.00.277.625 I llm_load_tensors: offloading 12 repeating layers to GPU
0.00.277.631 I llm_load_tensors: offloading output layer to GPU
0.00.277.631 I llm_load_tensors: offloaded 13/13 layers to GPU
0.00.277.636 I llm_load_tensors:      Vulkan0 model buffer size =    21.74 MiB
0.00.277.637 I llm_load_tensors:   CPU_Mapped model buffer size =    12.63 MiB
................................................
0.00.284.790 I llama_new_context_with_model: n_seq_max     = 1
0.00.284.795 I llama_new_context_with_model: n_ctx         = 512
0.00.284.795 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.284.795 I llama_new_context_with_model: n_batch       = 2048
0.00.284.796 I llama_new_context_with_model: n_ubatch      = 2048
0.00.284.796 I llama_new_context_with_model: flash_attn    = 0
0.00.284.800 I llama_new_context_with_model: freq_base     = 10000.0
0.00.284.800 I llama_new_context_with_model: freq_scale    = 1
0.00.285.262 I llama_kv_cache_init: kv_size = 512, offload = 1, type_k = 'f16', type_v = 'f16', n_layer = 12, can_shift = 1
0.00.287.699 I llama_kv_cache_init:    Vulkan0 KV buffer size =     9.00 MiB
0.00.287.706 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.287.719 I llama_new_context_with_model: Vulkan_Host  output buffer size =     0.00 MiB
0.00.291.450 I llama_new_context_with_model:    Vulkan0 compute buffer size =    16.00 MiB
0.00.291.458 I llama_new_context_with_model: Vulkan_Host compute buffer size =     2.51 MiB
0.00.291.459 I llama_new_context_with_model: graph nodes  = 429
0.00.291.459 I llama_new_context_with_model: graph splits = 4 (with bs=512), 2 (with bs=1)
0.00.291.462 I common_init_from_params: setting dry_penalty_last_n to ctx_size = 512
0.00.291.463 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.298.099 I 
0.00.298.162 I system_info: n_threads = 4 (n_threads_batch = 4) / 4 | CPU : SSE3 = 1 | SSSE3 = 1 | AVX = 1 | AVX2 = 1 | F16C = 1 | FMA = 1 | LLAMAFILE = 1 | OPENMP = 1 | AARCH64_REPACK = 1 | 
0.00.299.831 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.305.277 I llama_perf_context_print:        load time =     297.74 ms
0.00.305.279 I llama_perf_context_print: prompt eval time =       5.25 ms /     9 tokens (    0.58 ms per token,  1712.98 tokens per second)
0.00.305.280 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.305.280 I llama_perf_context_print:       total time =       7.18 ms /    10 tokens
ci/run.sh: line 710: 3473182 Segmentation fault      (core dumped) ./bin/llama-embedding --model ${model_q8_0} -p "I believe the meaning of life is" -ngl 99 -c 0
