...
- status:  SUCCESS ✅
- runtime: 489.06
- date:    Wed Apr 24 12:06:37 EEST 2024
...
Test project /Users/ggml/work/llama.cpp/build-ci-debug
 ...
 1/23 Test  #1: test-quantize-fns ...................   Passed   35.21 sec
...
Label Time Summary:
main    = 196.85 sec*proc (23 tests)

Total Test time (real) = 196.87 sec
...
llama_print_timings: prompt eval time =      11.55 ms /     9 tokens (    1.28 ms per token,   779.09 tokens per second)
...
llama_print_timings:        load time =      52.52 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> If the average monthly spending on groceries is $400, what is the total monthly spending on groceries for the year?

**A.** $480
llama_print_timings:        load time =    2575.68 ms
llama_print_timings:      sample time =      58.96 ms /    32 runs   (    1.84 ms per token,   542.71 tokens per second)
...
llama_print_timings:       total time =    2537.12 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Heider, the infamous bootleg artist, is a controversial figure. Some hail him as a visionary artist who broke barriers and challenged norms, while others condemn him as a
llama_print_timings:        load time =    2754.39 ms
llama_print_timings:      sample time =      57.38 ms /    32 runs   (    1.79 ms per token,   557.67 tokens per second)
llama_print_timings: prompt eval time =     204.01 ms /     2 tokens (  102.01 ms per token,     9.80 tokens per second)
llama_print_timings:        eval time =    1498.76 ms /    31 runs   (   48.35 ms per token,    20.68 tokens per second)
llama_print_timings:       total time =    2522.70 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soar! is a non-profit organization dedicated to empowering and inspiring young people to achieve their full potential.

**Our mission is to:**

* Provide young
llama_print_timings:        load time =    2787.73 ms
llama_print_timings:      sample time =      56.58 ms /    32 runs   (    1.77 ms per token,   565.58 tokens per second)
llama_print_timings: prompt eval time =     197.25 ms /     2 tokens (   98.63 ms per token,    10.14 tokens per second)
llama_print_timings:        eval time =    1495.26 ms /    31 runs   (   48.23 ms per token,    20.73 tokens per second)
llama_print_timings:       total time =    2492.08 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> When the Moon is in Retrograde?

**A)** When the moon is moving away from the sun.
**B)** When the moon is moving towards the
llama_print_timings:        load time =    2539.73 ms
llama_print_timings:      sample time =      16.44 ms /    32 runs   (    0.51 ms per token,  1946.71 tokens per second)
llama_print_timings: prompt eval time =     194.08 ms /     2 tokens (   97.04 ms per token,    10.31 tokens per second)
llama_print_timings:        eval time =    1521.56 ms /    31 runs   (   49.08 ms per token,    20.37 tokens per second)
llama_print_timings:       total time =    1806.21 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2740.67 ms
llama_print_timings:      sample time =      16.36 ms /    32 runs   (    0.51 ms per token,  1955.75 tokens per second)
llama_print_timings: prompt eval time =     200.43 ms /     2 tokens (  100.22 ms per token,     9.98 tokens per second)
llama_print_timings:        eval time =    1522.22 ms /    31 runs   (   49.10 ms per token,    20.36 tokens per second)
llama_print_timings:       total time =    1814.70 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If f(x) = 2x^3 + 3x^2 - x + 1, then find f(-2).

$$f(-
llama_print_timings:        load time =    2768.13 ms
llama_print_timings:      sample time =      16.26 ms /    32 runs   (    0.51 ms per token,  1968.02 tokens per second)
llama_print_timings: prompt eval time =     195.43 ms /     2 tokens (   97.71 ms per token,    10.23 tokens per second)
llama_print_timings:        eval time =    1530.69 ms /    31 runs   (   49.38 ms per token,    20.25 tokens per second)
llama_print_timings:       total time =    1817.21 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
