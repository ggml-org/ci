...
- status:  SUCCESS ✅
- runtime: 491.67
- date:    Mon Apr 22 14:29:24 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   94.34 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 197.14 sec*proc (23 tests)

Total Test time (real) = 197.16 sec
...
llama_print_timings: prompt eval time =      11.82 ms /     9 tokens (    1.31 ms per token,   761.68 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.36 ms /     9 tokens (    1.26 ms per token,   792.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
The alignment of the Moon, sun, and Earth is rare and unpredictable, but it can happen with the right conditions.

**
llama_print_timings:        load time =    2629.71 ms
llama_print_timings:      sample time =      57.45 ms /    32 runs   (    1.80 ms per token,   556.98 tokens per second)
llama_print_timings: prompt eval time =     196.38 ms /     2 tokens (   98.19 ms per token,    10.18 tokens per second)
llama_print_timings:        eval time =    1499.96 ms /    31 runs   (   48.39 ms per token,    20.67 tokens per second)
llama_print_timings:       total time =    2536.25 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, there was a young girl named Anya who lived in a small village. Anya had a big heart and a dream to become a doctor.

One day,
llama_print_timings:        load time =    2783.31 ms
llama_print_timings:      sample time =      57.44 ms /    32 runs   (    1.80 ms per token,   557.08 tokens per second)
llama_print_timings: prompt eval time =     206.21 ms /     5 tokens (   41.24 ms per token,    24.25 tokens per second)
llama_print_timings:        eval time =    1508.09 ms /    31 runs   (   48.65 ms per token,    20.56 tokens per second)
llama_print_timings:       total time =    2563.24 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
The Witcher Season 2 picks up after the shocking events of the first season. Geralt of Rivia is struggling with his newfound identity
llama_print_timings:        load time =    2643.51 ms
llama_print_timings:      sample time =      56.31 ms /    32 runs   (    1.76 ms per token,   568.25 tokens per second)
...
llama_print_timings:       total time =    2524.80 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say the early bird catches the worm. But what if the worm waits for the early bird?

**Scenario:**

Imagine a scenario where a group of birds
llama_print_timings:        load time =    2536.30 ms
llama_print_timings:      sample time =      16.48 ms /    32 runs   (    0.52 ms per token,  1941.28 tokens per second)
llama_print_timings: prompt eval time =     195.74 ms /     2 tokens (   97.87 ms per token,    10.22 tokens per second)
llama_print_timings:        eval time =    1522.95 ms /    31 runs   (   49.13 ms per token,    20.36 tokens per second)
llama_print_timings:       total time =    1811.00 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, there lived a young girl named Anya. Anya was a bright and inquisitive child, always eager to learn new things.

One sunny day, Anya was exploring
llama_print_timings:        load time =    3009.13 ms
llama_print_timings:      sample time =      16.48 ms /    32 runs   (    0.51 ms per token,  1942.22 tokens per second)
llama_print_timings: prompt eval time =     201.76 ms /     5 tokens (   40.35 ms per token,    24.78 tokens per second)
llama_print_timings:        eval time =    1518.87 ms /    31 runs   (   49.00 ms per token,    20.41 tokens per second)
llama_print_timings:       total time =    1813.47 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Once upon a time, there was a young woman named Anya. She was kind, compassionate, and had a heart of gold.

One day, Anya was walking in the forest
llama_print_timings:        load time =    2707.93 ms
llama_print_timings:      sample time =      16.41 ms /    32 runs   (    0.51 ms per token,  1949.91 tokens per second)
llama_print_timings: prompt eval time =     198.68 ms /     5 tokens (   39.74 ms per token,    25.17 tokens per second)
llama_print_timings:        eval time =    1528.12 ms /    31 runs   (   49.29 ms per token,    20.29 tokens per second)
llama_print_timings:       total time =    1817.30 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
