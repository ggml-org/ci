...
- status:  SUCCESS ✅
- runtime: 19:02.40
- date:    Fri May 10 22:20:10 UTC 2024
...
llama_print_timings: prompt eval time =       4.41 ms /     9 tokens (    0.49 ms per token,  2041.74 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.76 ms /     9 tokens (    0.42 ms per token,  2392.34 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      53.50 ms /    10 tokens
...
<bos> Soar is a flight training company that prioritizes personalized instruction and comprehensive flight training solutions.

**Mission:**
- To empower individuals to achieve their aviation aspirations.
llama_print_timings:        load time =    1246.82 ms
llama_print_timings:      sample time =      47.73 ms /    32 runs   (    1.49 ms per token,   670.49 tokens per second)
llama_print_timings: prompt eval time =    1138.84 ms /     2 tokens (  569.42 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20906.67 ms /    31 runs   (  674.41 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22228.39 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After a successful surgery, the patient is transferred to a regular hospital room. The nurse prepares a plan for the patient's discharge.
...
llama_print_timings: prompt eval time =    1142.11 ms /     2 tokens (  571.06 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21186.56 ms /    31 runs   (  683.44 ms per token,     1.46 tokens per second)
llama_print_timings:       total time =   22511.23 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heuristics is a cognitive bias that describes the tendency to rely on initial impressions or heuristics as guides in making decisions. This can lead to systematic errors in judgment and
llama_print_timings:        load time =    1224.25 ms
llama_print_timings:      sample time =      47.49 ms /    32 runs   (    1.48 ms per token,   673.80 tokens per second)
llama_print_timings: prompt eval time =    1139.38 ms /     2 tokens (  569.69 ms per token,     1.76 tokens per second)
llama_print_timings:        eval time =   20804.66 ms /    31 runs   (  671.12 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22126.53 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a realm of enchanted forests and shimmering rivers, there lived a young gnome named Sprigg.

Sprigg was no ordinary gnome. He possessed a
...
llama_print_timings: prompt eval time =    2741.05 ms /     5 tokens (  548.21 ms per token,     1.82 tokens per second)
llama_print_timings:        eval time =   20766.42 ms /    31 runs   (  669.88 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   23686.89 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198089.36 ms
main:    total time = 198089.36 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a wise and resourceful woman named Eleanor.

One day, while exploring the forest, she stumbled upon a hidden cave. Curiosity got the better of
llama_print_timings:        load time =     641.13 ms
llama_print_timings:      sample time =      47.61 ms /    32 runs   (    1.49 ms per token,   672.16 tokens per second)
llama_print_timings: prompt eval time =    1305.89 ms /     5 tokens (  261.18 ms per token,     3.83 tokens per second)
llama_print_timings:        eval time =   10716.92 ms /    31 runs   (  345.71 ms per token,     2.89 tokens per second)
llama_print_timings:       total time =   12203.95 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198052.59 ms
main:    total time = 198052.59 ms
+ echo PASS
PASS
+ echo
...
<bos> If f(x) = x^2 + 2x + 1, then the derivative of f(x) is f'(x) = 2
llama_print_timings:        load time =     648.62 ms
llama_print_timings:      sample time =      47.27 ms /    32 runs   (    1.48 ms per token,   677.03 tokens per second)
llama_print_timings: prompt eval time =     577.15 ms /     2 tokens (  288.57 ms per token,     3.47 tokens per second)
llama_print_timings:        eval time =   10683.69 ms /    31 runs   (  344.64 ms per token,     2.90 tokens per second)
llama_print_timings:       total time =   11441.12 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say with great power comes great responsibility. But sometimes, those who wield that power choose not to use it responsibly.

What are some of the reasons why powerful
...
llama_print_timings: prompt eval time =      75.89 ms /     2 tokens (   37.94 ms per token,    26.35 tokens per second)
llama_print_timings:        eval time =    2089.34 ms /    31 runs   (   67.40 ms per token,    14.84 tokens per second)
llama_print_timings:       total time =    2233.16 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shelliah is a leader who inspires hope and change. She embodies the power of resilience, compassion, and wisdom. What qualities make Shelliah a leader of
llama_print_timings:        load time =     157.22 ms
llama_print_timings:      sample time =       6.92 ms /    32 runs   (    0.22 ms per token,  4624.28 tokens per second)
llama_print_timings: prompt eval time =      75.49 ms /     2 tokens (   37.75 ms per token,    26.49 tokens per second)
llama_print_timings:        eval time =    2110.22 ms /    31 runs   (   68.07 ms per token,    14.69 tokens per second)
llama_print_timings:       total time =    2253.31 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heigl, and Lea Michele were all on the same season of Grey's Anatomy. Do you think they had a falling out or was it just a coincidence?
llama_print_timings:        load time =     166.39 ms
llama_print_timings:      sample time =       6.73 ms /    32 runs   (    0.21 ms per token,  4755.54 tokens per second)
llama_print_timings: prompt eval time =      88.77 ms /     2 tokens (   44.38 ms per token,    22.53 tokens per second)
llama_print_timings:        eval time =    2116.56 ms /    31 runs   (   68.28 ms per token,    14.65 tokens per second)
llama_print_timings:       total time =    2272.42 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekoul is a well-known rabbi and spiritual teacher with a deep connection to nature and a unique ability to connect with people on an emotional level. He is
...
llama_print_timings: prompt eval time =      77.63 ms /     2 tokens (   38.81 ms per token,    25.76 tokens per second)
llama_print_timings:        eval time =    2208.05 ms /    31 runs   (   71.23 ms per token,    14.04 tokens per second)
llama_print_timings:       total time =    2353.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32251.91 ms
main:    total time = 32251.91 ms
+ echo PASS
PASS
+ echo
...
<bos> Heigl's career trajectory has been remarkable, from early days as a popular TV star to becoming a critically acclaimed actress.

**Key Milestones in His Heigl
llama_print_timings:        load time =     120.60 ms
llama_print_timings:      sample time =       6.62 ms /    32 runs   (    0.21 ms per token,  4835.30 tokens per second)
llama_print_timings: prompt eval time =      65.98 ms /     2 tokens (   32.99 ms per token,    30.31 tokens per second)
llama_print_timings:        eval time =    1590.38 ms /    31 runs   (   51.30 ms per token,    19.49 tokens per second)
llama_print_timings:       total time =    1724.12 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When the going gets tough, tough.

This phrase is often used to describe situations where people are facing adversity. However, it can also be used metaphorically to
...
llama_print_timings: prompt eval time =      67.26 ms /     2 tokens (   33.63 ms per token,    29.74 tokens per second)
llama_print_timings:        eval time =    1602.73 ms /    31 runs   (   51.70 ms per token,    19.34 tokens per second)
llama_print_timings:       total time =    1736.79 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     495.69 ms
...
llama_print_timings:       total time =    8337.43 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     476.81 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5122.93 ms /   128 tokens (   40.02 ms per token,    24.99 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5139.17 ms /   129 tokens
...
llama_print_timings: prompt eval time =     231.44 ms /     8 tokens (   28.93 ms per token,    34.57 tokens per second)
llama_print_timings:        eval time =    5695.84 ms /    63 runs   (   90.41 ms per token,    11.06 tokens per second)
llama_print_timings:       total time =    5946.28 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3022.03 ms /   128 tokens (   23.61 ms per token,    42.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3038.68 ms /   129 tokens
...
llama_print_timings: prompt eval time =     225.36 ms /     8 tokens (   28.17 ms per token,    35.50 tokens per second)
llama_print_timings:        eval time =    4731.53 ms /    63 runs   (   75.10 ms per token,    13.31 tokens per second)
llama_print_timings:       total time =    4976.66 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3312.99 ms /   128 tokens (   25.88 ms per token,    38.64 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3329.64 ms /   129 tokens
...
llama_print_timings:        eval time =    4860.83 ms /    63 runs   (   77.16 ms per token,    12.96 tokens per second)
llama_print_timings:       total time =    5274.94 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6039.92 ms /   128 tokens (   47.19 ms per token,    21.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6056.68 ms /   129 tokens
...
llama_print_timings:        load time =     287.32 ms
llama_print_timings:      sample time =       2.05 ms /    64 runs   (    0.03 ms per token, 31158.71 tokens per second)
llama_print_timings: prompt eval time =     415.83 ms /     8 tokens (   51.98 ms per token,    19.24 tokens per second)
llama_print_timings:        eval time =    5467.10 ms /    63 runs   (   86.78 ms per token,    11.52 tokens per second)
llama_print_timings:       total time =    5902.62 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6385.35 ms /   128 tokens (   49.89 ms per token,    20.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6402.07 ms /   129 tokens
...
llama_print_timings: prompt eval time =     456.24 ms /     8 tokens (   57.03 ms per token,    17.53 tokens per second)
llama_print_timings:        eval time =    5727.37 ms /    63 runs   (   90.91 ms per token,    11.00 tokens per second)
llama_print_timings:       total time =    6203.49 ms /    71 tokens
Log end
...
[1]4.2586,
llama_print_timings:        load time =     282.68 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6806.01 ms /   128 tokens (   53.17 ms per token,    18.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6823.07 ms /   129 tokens
...
llama_print_timings: prompt eval time =     637.65 ms /     8 tokens (   79.71 ms per token,    12.55 tokens per second)
llama_print_timings:        eval time =    6203.24 ms /    63 runs   (   98.46 ms per token,    10.16 tokens per second)
llama_print_timings:       total time =    6861.47 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10098.49 ms /   128 tokens (   78.89 ms per token,    12.68 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10114.85 ms /   129 tokens
...
llama_print_timings:        load time =     271.93 ms
llama_print_timings:      sample time =       2.06 ms /    64 runs   (    0.03 ms per token, 31143.55 tokens per second)
llama_print_timings: prompt eval time =     489.62 ms /     8 tokens (   61.20 ms per token,    16.34 tokens per second)
llama_print_timings:        eval time =    5399.81 ms /    63 runs   (   85.71 ms per token,    11.67 tokens per second)
llama_print_timings:       total time =    5910.22 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7620.45 ms /   128 tokens (   59.53 ms per token,    16.80 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7636.78 ms /   129 tokens
...
llama_print_timings: prompt eval time =     412.67 ms /     8 tokens (   51.58 ms per token,    19.39 tokens per second)
llama_print_timings:        eval time =    5154.63 ms /    63 runs   (   81.82 ms per token,    12.22 tokens per second)
llama_print_timings:       total time =    5586.31 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6344.87 ms /   128 tokens (   49.57 ms per token,    20.17 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6361.91 ms /   129 tokens
...
-
llama_print_timings:        load time =     287.78 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31372.55 tokens per second)
llama_print_timings: prompt eval time =     486.18 ms /     8 tokens (   60.77 ms per token,    16.45 tokens per second)
llama_print_timings:        eval time =    6006.24 ms /    63 runs   (   95.34 ms per token,    10.49 tokens per second)
llama_print_timings:       total time =    6512.03 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7524.80 ms /   128 tokens (   58.79 ms per token,    17.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7541.23 ms /   129 tokens
...
llama_print_timings: prompt eval time =     539.32 ms /     8 tokens (   67.42 ms per token,    14.83 tokens per second)
llama_print_timings:        eval time =    6533.82 ms /    63 runs   (  103.71 ms per token,     9.64 tokens per second)
llama_print_timings:       total time =    7092.66 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8355.44 ms /   128 tokens (   65.28 ms per token,    15.32 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8372.36 ms /   129 tokens
...
first run: The quick brown fox jumps flat over the lazy dog – Halfway.com – (/halfway/


second run: The quick brown fox jumps flat over the lazy dog – Halfway.com – (/halfway/


single seq run: The quick brown fox jumps flat over the lazy dog – Halfway.com – (/halfway/
...
first run: The quick brown fox jumped over the tree stump. asdfasdfasrf p
the


second run: The quick brown fox jumped over the tree stump. asdfasdfasrf p
the


single seq run: The quick brown fox jumped over the tree stump. asdfasdfasrf p
the
...
0.33user 0.56system 0:00.90elapsed 99%CPU (0avgtext+0avgdata 6880616maxresident)k
0inputs+40outputs (0major+114735minor)pagefaults 0swaps
```
...
0.11user 0.57system 0:00.69elapsed 99%CPU (0avgtext+0avgdata 6880232maxresident)k
0inputs+40outputs (0major+114731minor)pagefaults 0swaps
```
