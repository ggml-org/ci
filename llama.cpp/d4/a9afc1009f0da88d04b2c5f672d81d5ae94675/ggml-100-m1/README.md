...
- status:  SUCCESS ✅
- runtime: 783.82
- date:    Fri Apr 26 10:41:17 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   93.01 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 195.98 sec*proc (23 tests)

Total Test time (real) = 196.00 sec
...
llama_print_timings:        load time =      62.85 ms
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.39 ms /     9 tokens (    1.27 ms per token,   790.24 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      33.62 ms /    10 tokens
ggml_metal_free: deallocating
...
<bos> If 15% of a number is 180, what is the number?

Let x be the number.
15% of x =
llama_print_timings:        load time =    2556.49 ms
llama_print_timings:      sample time =      57.45 ms /    32 runs   (    1.80 ms per token,   557.00 tokens per second)
llama_print_timings: prompt eval time =     194.95 ms /     2 tokens (   97.48 ms per token,    10.26 tokens per second)
llama_print_timings:        eval time =    1503.23 ms /    31 runs   (   48.49 ms per token,    20.62 tokens per second)
llama_print_timings:       total time =    2528.16 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If x is directly proportional to y, and y is inversely proportional to z, then which of the following is true?

A. x is directly proportional to z
llama_print_timings:        load time =    3280.25 ms
llama_print_timings:      sample time =      54.17 ms /    32 runs   (    1.69 ms per token,   590.75 tokens per second)
llama_print_timings: prompt eval time =     203.42 ms /     2 tokens (  101.71 ms per token,     9.83 tokens per second)
llama_print_timings:        eval time =    1499.91 ms /    31 runs   (   48.38 ms per token,    20.67 tokens per second)
llama_print_timings:       total time =    2485.20 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2686.83 ms
llama_print_timings:      sample time =      57.19 ms /    32 runs   (    1.79 ms per token,   559.53 tokens per second)
llama_print_timings: prompt eval time =     196.81 ms /     2 tokens (   98.40 ms per token,    10.16 tokens per second)
llama_print_timings:        eval time =    1496.58 ms /    31 runs   (   48.28 ms per token,    20.71 tokens per second)
llama_print_timings:       total time =    2547.97 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Heider Corporation is considering investing in a new manufacturing facility. The investment will require an initial investment of $10 million and will result in annual operating costs of $
llama_print_timings:        load time =    1966.48 ms
...
llama_print_timings:       total time =    1807.18 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After the success of the first season of "The Umbrella Academy," fans are eagerly anticipating the release of the second season. Here's all the information we have so
llama_print_timings:        load time =    2920.75 ms
llama_print_timings:      sample time =      16.43 ms /    32 runs   (    0.51 ms per token,  1947.54 tokens per second)
llama_print_timings: prompt eval time =     201.55 ms /     2 tokens (  100.77 ms per token,     9.92 tokens per second)
llama_print_timings:        eval time =    1521.89 ms /    31 runs   (   49.09 ms per token,    20.37 tokens per second)
llama_print_timings:       total time =    1816.02 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say the only limit to our realization is our imagination.

**Questions:**

1. What is the significance of this quote?
2. What does the
llama_print_timings:        load time =    2737.67 ms
llama_print_timings:      sample time =      16.46 ms /    32 runs   (    0.51 ms per token,  1943.52 tokens per second)
llama_print_timings: prompt eval time =     196.35 ms /     2 tokens (   98.17 ms per token,    10.19 tokens per second)
llama_print_timings:        eval time =    1528.77 ms /    31 runs   (   49.32 ms per token,    20.28 tokens per second)
llama_print_timings:       total time =    1816.21 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21172.48 ms
main:    total time = 21172.48 ms
+ echo PASS
PASS
+ echo
...
<bos> Soar! is a children's book that inspires children to explore, learn, and dream big.

## Inspiring Themes:

* **Exploration:** The book
llama_print_timings:        load time =    1413.62 ms
llama_print_timings:      sample time =      16.52 ms /    32 runs   (    0.52 ms per token,  1936.69 tokens per second)
llama_print_timings: prompt eval time =     212.73 ms /     2 tokens (  106.37 ms per token,     9.40 tokens per second)
llama_print_timings:        eval time =    1093.36 ms /    31 runs   (   35.27 ms per token,    28.35 tokens per second)
llama_print_timings:       total time =    1396.15 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21518.25 ms
main:    total time = 21518.25 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there lived a brave knight named Sir Lancelot. He was known for his courage, his swordsmanship, and his unwavering loyalty to King Arthur.

One
llama_print_timings:        load time =    1545.25 ms
llama_print_timings:      sample time =      16.51 ms /    32 runs   (    0.52 ms per token,  1937.98 tokens per second)
llama_print_timings: prompt eval time =     217.95 ms /     5 tokens (   43.59 ms per token,    22.94 tokens per second)
llama_print_timings:        eval time =    1110.29 ms /    31 runs   (   35.82 ms per token,    27.92 tokens per second)
llama_print_timings:       total time =    1420.16 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
