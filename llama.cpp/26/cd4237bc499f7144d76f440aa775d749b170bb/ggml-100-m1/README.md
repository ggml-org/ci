...
- status:  SUCCESS ✅
- runtime: 340.35
- date:    Mon May 20 13:00:26 EEST 2024
...
Label Time Summary:
main    = 183.95 sec*proc (22 tests)

Total Test time (real) = 183.96 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.29 ms /     9 tokens (    1.37 ms per token,   732.54 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
