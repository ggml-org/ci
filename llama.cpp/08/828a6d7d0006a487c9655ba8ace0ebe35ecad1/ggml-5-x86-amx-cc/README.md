...
- status:  SUCCESS ✅
- runtime: 4:03.83
- date:    Sun Nov  3 13:23:09 UTC 2024
...
0.00.000.509 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.430 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.021.607 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.021.629 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.021.630 I llm_load_print_meta: arch             = bert
0.00.021.630 I llm_load_print_meta: vocab type       = WPM
0.00.021.631 I llm_load_print_meta: n_vocab          = 30522
0.00.021.631 I llm_load_print_meta: n_merges         = 0
0.00.021.631 I llm_load_print_meta: vocab_only       = 0
0.00.021.631 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.631 I llm_load_print_meta: n_embd           = 384
0.00.021.632 I llm_load_print_meta: n_layer          = 12
...
0.00.021.645 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.646 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.646 I llm_load_print_meta: n_ff             = 1536
0.00.021.646 I llm_load_print_meta: n_expert         = 0
...
0.00.021.649 I llm_load_print_meta: rope scaling     = linear
0.00.021.651 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.021.651 I llm_load_print_meta: freq_scale_train = 1
0.00.021.651 I llm_load_print_meta: n_ctx_orig_yarn  = 512
0.00.021.652 I llm_load_print_meta: rope_finetuned   = unknown
0.00.021.652 I llm_load_print_meta: ssm_d_conv       = 0
0.00.021.652 I llm_load_print_meta: ssm_d_inner      = 0
0.00.021.652 I llm_load_print_meta: ssm_d_state      = 0
...
0.00.021.653 I llm_load_print_meta: model ftype      = F16
0.00.021.654 I llm_load_print_meta: model params     = 33.21 M
0.00.021.655 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
...
0.00.021.656 I llm_load_print_meta: max token length = 21
0.00.025.434 I llm_load_tensors: CPU_Mapped model buffer size =    63.84 MiB
0.00.025.451 I llm_load_tensors:        AMX model buffer size =    40.50 MiB
................................................
0.00.037.689 I llama_new_context_with_model: n_seq_max     = 1
0.00.037.704 I llama_new_context_with_model: n_ctx         = 512
0.00.037.704 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.037.704 I llama_new_context_with_model: n_batch       = 2048
0.00.037.704 I llama_new_context_with_model: n_ubatch      = 2048
0.00.037.705 I llama_new_context_with_model: flash_attn    = 0
0.00.037.706 I llama_new_context_with_model: freq_base     = 10000.0
0.00.037.707 I llama_new_context_with_model: freq_scale    = 1
...
0.00.040.133 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.041.869 I llama_new_context_with_model:        AMX compute buffer size =     3.75 MiB
0.00.041.886 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.041.886 I llama_new_context_with_model: graph nodes  = 429
0.00.041.886 I llama_new_context_with_model: graph splits = 145
0.00.041.888 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.045.982 I 
0.00.046.063 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.047.872 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.053.265 I llama_perf_context_print:        load time =      44.58 ms
0.00.053.267 I llama_perf_context_print: prompt eval time =       5.14 ms /     9 tokens (    0.57 ms per token,  1750.97 tokens per second)
0.00.053.268 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.053.269 I llama_perf_context_print:       total time =       7.29 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.629 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.662 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
...
0.00.004.707 I llama_model_loader: - kv  11:                          general.file_type u32              = 7
...
0.00.021.889 I llm_load_print_meta: n_vocab          = 30522
0.00.021.890 I llm_load_print_meta: n_merges         = 0
0.00.021.890 I llm_load_print_meta: vocab_only       = 0
0.00.021.890 I llm_load_print_meta: n_ctx_train      = 512
0.00.021.891 I llm_load_print_meta: n_embd           = 384
0.00.021.891 I llm_load_print_meta: n_layer          = 12
0.00.021.899 I llm_load_print_meta: n_head           = 12
0.00.021.899 I llm_load_print_meta: n_head_kv        = 12
0.00.021.900 I llm_load_print_meta: n_rot            = 32
0.00.021.900 I llm_load_print_meta: n_swa            = 0
0.00.021.901 I llm_load_print_meta: n_embd_head_k    = 32
0.00.021.901 I llm_load_print_meta: n_embd_head_v    = 32
0.00.021.909 I llm_load_print_meta: n_gqa            = 1
...
0.00.021.914 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.021.914 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.021.914 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.021.915 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.021.916 I llm_load_print_meta: n_ff             = 1536
0.00.021.916 I llm_load_print_meta: n_expert         = 0
0.00.021.917 I llm_load_print_meta: n_expert_used    = 0
0.00.021.918 I llm_load_print_meta: causal attn      = 0
0.00.021.918 I llm_load_print_meta: pooling type     = 2
0.00.021.919 I llm_load_print_meta: rope type        = 2
...
0.00.021.936 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.021.936 I llm_load_print_meta: model type       = 33M
0.00.021.937 I llm_load_print_meta: model ftype      = Q8_0
0.00.021.938 I llm_load_print_meta: model params     = 33.21 M
0.00.021.938 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.021.939 I llm_load_print_meta: general.name     = Bge Small
0.00.021.939 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.021.940 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.021.940 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.021.940 I llm_load_print_meta: CLS token        = 101 '[CLS]'
0.00.021.941 I llm_load_print_meta: MASK token       = 103 '[MASK]'
0.00.021.941 I llm_load_print_meta: LF token         = 0 '[PAD]'
0.00.021.941 I llm_load_print_meta: max token length = 21
0.00.024.700 I llm_load_tensors: CPU_Mapped model buffer size =    34.38 MiB
.................................................
0.00.025.687 I llama_new_context_with_model: n_seq_max     = 1
0.00.025.702 I llama_new_context_with_model: n_ctx         = 512
0.00.025.702 I llama_new_context_with_model: n_ctx_per_seq = 512
0.00.025.702 I llama_new_context_with_model: n_batch       = 2048
0.00.025.703 I llama_new_context_with_model: n_ubatch      = 2048
0.00.025.703 I llama_new_context_with_model: flash_attn    = 0
0.00.025.704 I llama_new_context_with_model: freq_base     = 10000.0
0.00.025.705 I llama_new_context_with_model: freq_scale    = 1
0.00.027.254 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
0.00.027.280 I llama_new_context_with_model: KV self size  =    9.00 MiB, K (f16):    4.50 MiB, V (f16):    4.50 MiB
0.00.027.285 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.028.551 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.028.572 I llama_new_context_with_model: graph nodes  = 429
0.00.028.572 I llama_new_context_with_model: graph splits = 1
0.00.028.574 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.031.231 I 
0.00.031.307 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.032.836 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.035.718 I llama_perf_context_print:        load time =      29.63 ms
0.00.035.719 I llama_perf_context_print: prompt eval time =       2.67 ms /     9 tokens (    0.30 ms per token,  3370.79 tokens per second)
0.00.035.720 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.035.720 I llama_perf_context_print:       total time =       4.49 ms /    10 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.688 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.414 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.020.152 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.020.174 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.020.175 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.020.175 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.020.176 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
...
0.00.048.030 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.061.659 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.061.800 I llm_load_vocab: special tokens cache size = 5
0.00.342.404 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.342.426 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.342.426 I llm_load_print_meta: arch             = jina-bert-v2
0.00.342.427 I llm_load_print_meta: vocab type       = BPE
0.00.342.427 I llm_load_print_meta: n_vocab          = 61056
0.00.342.428 I llm_load_print_meta: n_merges         = 39382
0.00.342.428 I llm_load_print_meta: vocab_only       = 0
0.00.342.428 I llm_load_print_meta: n_ctx_train      = 8192
0.00.342.429 I llm_load_print_meta: n_embd           = 384
0.00.342.429 I llm_load_print_meta: n_layer          = 4
0.00.342.439 I llm_load_print_meta: n_head           = 12
0.00.342.440 I llm_load_print_meta: n_head_kv        = 12
0.00.342.440 I llm_load_print_meta: n_rot            = 32
0.00.342.441 I llm_load_print_meta: n_swa            = 0
0.00.342.441 I llm_load_print_meta: n_embd_head_k    = 32
0.00.342.441 I llm_load_print_meta: n_embd_head_v    = 32
0.00.342.442 I llm_load_print_meta: n_gqa            = 1
0.00.342.443 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.342.443 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.342.445 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.342.446 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.342.446 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.342.446 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.342.447 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.342.448 I llm_load_print_meta: n_ff             = 1536
0.00.342.448 I llm_load_print_meta: n_expert         = 0
0.00.342.448 I llm_load_print_meta: n_expert_used    = 0
0.00.342.448 I llm_load_print_meta: causal attn      = 0
0.00.342.449 I llm_load_print_meta: pooling type     = -1
0.00.342.449 I llm_load_print_meta: rope type        = -1
0.00.342.450 I llm_load_print_meta: rope scaling     = linear
0.00.342.451 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.342.451 I llm_load_print_meta: freq_scale_train = 1
0.00.342.452 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.342.452 I llm_load_print_meta: rope_finetuned   = unknown
0.00.342.452 I llm_load_print_meta: ssm_d_conv       = 0
0.00.342.453 I llm_load_print_meta: ssm_d_inner      = 0
0.00.342.453 I llm_load_print_meta: ssm_d_state      = 0
0.00.342.453 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.342.454 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.342.454 I llm_load_print_meta: model type       = 33M
0.00.342.455 I llm_load_print_meta: model ftype      = F16
0.00.342.456 I llm_load_print_meta: model params     = 32.90 M
0.00.342.456 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.342.457 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.342.457 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.342.458 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.342.458 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.342.458 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.342.458 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.342.459 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.342.459 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.342.459 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.342.459 I llm_load_print_meta: max token length = 45
0.00.346.107 I llm_load_tensors: CPU_Mapped model buffer size =    62.78 MiB
0.00.346.122 I llm_load_tensors:        AMX model buffer size =    18.00 MiB
.....................
0.00.353.403 I llama_new_context_with_model: n_seq_max     = 1
0.00.353.424 I llama_new_context_with_model: n_ctx         = 8192
0.00.353.424 I llama_new_context_with_model: n_ctx_per_seq = 8192
0.00.353.424 I llama_new_context_with_model: n_batch       = 2048
0.00.353.424 I llama_new_context_with_model: n_ubatch      = 2048
0.00.353.425 I llama_new_context_with_model: flash_attn    = 0
0.00.353.426 I llama_new_context_with_model: freq_base     = 10000.0
0.00.353.427 I llama_new_context_with_model: freq_scale    = 1
0.00.362.417 I llama_kv_cache_init:        AMX KV buffer size =    48.00 MiB
0.00.362.443 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.362.449 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.364.418 I llama_new_context_with_model:        AMX compute buffer size =    15.00 MiB
0.00.364.441 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.364.442 I llama_new_context_with_model: graph nodes  = 154
0.00.364.442 I llama_new_context_with_model: graph splits = 57
0.00.364.443 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.373.693 I 
0.00.373.780 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.374.004 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.374.016 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.374.021 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.374.022 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.374.026 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.374.027 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.377.959 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.386.210 I llama_perf_context_print:        load time =     371.96 ms
0.00.386.212 I llama_perf_context_print: prompt eval time =       8.02 ms /    62 tokens (    0.13 ms per token,  7729.71 tokens per second)
0.00.386.213 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.386.214 I llama_perf_context_print:       total time =      12.52 ms /    63 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.837 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.022.862 I llama_model_loader: - type  f16:   98 tensors
0.00.067.653 I llm_load_vocab: special tokens cache size = 25
0.00.079.343 I llm_load_vocab: token to piece cache size = 0.2984 MB
...
0.00.079.368 I llm_load_print_meta: n_ctx_train      = 2048
0.00.079.368 I llm_load_print_meta: n_embd           = 2048
0.00.079.368 I llm_load_print_meta: n_layer          = 24
0.00.079.378 I llm_load_print_meta: n_head           = 16
0.00.079.379 I llm_load_print_meta: n_head_kv        = 16
0.00.079.379 I llm_load_print_meta: n_rot            = 32
0.00.079.380 I llm_load_print_meta: n_swa            = 0
0.00.079.380 I llm_load_print_meta: n_embd_head_k    = 128
0.00.079.381 I llm_load_print_meta: n_embd_head_v    = 128
0.00.079.382 I llm_load_print_meta: n_gqa            = 1
0.00.079.383 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.079.383 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.079.385 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.079.386 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.079.386 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.079.387 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.079.387 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.079.388 I llm_load_print_meta: n_ff             = 8192
0.00.079.389 I llm_load_print_meta: n_expert         = 0
0.00.079.389 I llm_load_print_meta: n_expert_used    = 0
0.00.079.389 I llm_load_print_meta: causal attn      = 1
0.00.079.390 I llm_load_print_meta: pooling type     = 0
0.00.079.390 I llm_load_print_meta: rope type        = 2
0.00.079.390 I llm_load_print_meta: rope scaling     = linear
0.00.079.391 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.079.392 I llm_load_print_meta: freq_scale_train = 1
0.00.079.392 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.079.393 I llm_load_print_meta: rope_finetuned   = unknown
0.00.079.393 I llm_load_print_meta: ssm_d_conv       = 0
0.00.079.393 I llm_load_print_meta: ssm_d_inner      = 0
0.00.079.394 I llm_load_print_meta: ssm_d_state      = 0
0.00.079.394 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.079.394 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.079.395 I llm_load_print_meta: model type       = 1.4B
0.00.079.396 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.079.397 I llm_load_print_meta: model params     = 1.41 B
0.00.079.398 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.079.400 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.079.401 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.079.401 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.079.401 I llm_load_print_meta: max token length = 1024
0.00.233.573 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.233.594 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.01.024.102 I llama_new_context_with_model: n_seq_max     = 1
0.01.024.124 I llama_new_context_with_model: n_ctx         = 2048
0.01.024.124 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.01.024.124 I llama_new_context_with_model: n_batch       = 2048
0.01.024.125 I llama_new_context_with_model: n_ubatch      = 512
0.01.024.125 I llama_new_context_with_model: flash_attn    = 0
0.01.024.129 I llama_new_context_with_model: freq_base     = 10000.0
0.01.024.130 I llama_new_context_with_model: freq_scale    = 1
0.01.092.335 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.01.092.365 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.01.092.400 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.01.095.078 I llama_new_context_with_model:        AMX compute buffer size =   102.25 MiB
0.01.095.095 I llama_new_context_with_model:        CPU compute buffer size =    92.01 MiB
0.01.095.095 I llama_new_context_with_model: graph nodes  = 967
0.01.095.096 I llama_new_context_with_model: graph splits = 194
0.01.095.099 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.196.246 I main: llama threadpool init, n_threads = 4
0.01.196.272 I 
0.01.196.358 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.196.371 I 
0.01.196.511 I sampler seed: 1234
0.01.196.530 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.01.196.533 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.01.196.533 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.01.196.533 I 
...
0.05.016.056 I llama_perf_sampler_print:    sampling time =       2.25 ms /    71 runs   (    0.03 ms per token, 31597.69 tokens per second)
0.05.016.059 I llama_perf_context_print:        load time =    1194.23 ms
0.05.016.061 I llama_perf_context_print: prompt eval time =      98.11 ms /     7 tokens (   14.02 ms per token,    71.35 tokens per second)
0.05.016.062 I llama_perf_context_print:        eval time =    3710.06 ms /    63 runs   (   58.89 ms per token,    16.98 tokens per second)
0.05.016.062 I llama_perf_context_print:       total time =    3819.81 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.798 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.264 I llm_load_print_meta: pooling type     = 0
...
0.00.076.270 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.076.272 I llm_load_print_meta: model params     = 1.41 B
0.00.076.273 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.191.466 I llm_load_tensors: CPU_Mapped model buffer size =  2502.95 MiB
0.00.191.486 I llm_load_tensors:        AMX model buffer size =  2500.50 MiB
...............................................................................
0.00.981.654 I llama_new_context_with_model: n_seq_max     = 1
0.00.981.676 I llama_new_context_with_model: n_ctx         = 128
0.00.981.676 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.981.677 I llama_new_context_with_model: n_batch       = 128
0.00.981.677 I llama_new_context_with_model: n_ubatch      = 128
0.00.981.678 I llama_new_context_with_model: flash_attn    = 0
0.00.981.684 I llama_new_context_with_model: freq_base     = 10000.0
0.00.981.685 I llama_new_context_with_model: freq_scale    = 1
0.00.981.686 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.986.544 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.986.572 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.986.594 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.989.610 I llama_new_context_with_model:        AMX compute buffer size =    25.56 MiB
0.00.989.630 I llama_new_context_with_model:        CPU compute buffer size =     7.06 MiB
0.00.989.630 I llama_new_context_with_model: graph nodes  = 967
0.00.989.630 I llama_new_context_with_model: graph splits = 194
0.00.989.632 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.01.056.871 I 
0.01.056.994 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.01.057.002 I perplexity: tokenizing the input ..
0.01.066.542 I perplexity: tokenization took 9.536 ms
0.01.066.578 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.940.068 I perplexity: 0.87 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.943.764 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.943.858 I llama_perf_context_print:        load time =    1055.13 ms
0.01.943.861 I llama_perf_context_print: prompt eval time =     871.58 ms /   128 tokens (    6.81 ms per token,   146.86 tokens per second)
0.01.943.862 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.943.864 I llama_perf_context_print:       total time =     886.99 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.638 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.852 I main: llama backend init
0.00.001.725 I main: load the model and apply lora adapter, if any
...
0.00.021.887 I llama_model_loader: - kv  22:                          general.file_type u32              = 7
...
0.00.076.283 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.076.291 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.292 I llm_load_print_meta: model params     = 1.41 B
0.00.076.292 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.165.086 I llm_load_tensors: CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.167.324 I llama_new_context_with_model: n_seq_max     = 1
0.00.167.346 I llama_new_context_with_model: n_ctx         = 2048
0.00.167.346 I llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.00.167.348 I llama_new_context_with_model: freq_base     = 10000.0
0.00.167.349 I llama_new_context_with_model: freq_scale    = 1
0.00.235.507 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.235.535 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.235.558 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.238.084 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.238.106 I llama_new_context_with_model: graph nodes  = 967
0.00.238.106 I llama_new_context_with_model: graph splits = 1
0.00.238.110 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.338.809 I main: llama threadpool init, n_threads = 4
0.00.338.836 I 
0.00.338.918 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.338.930 I 
0.00.339.039 I sampler seed: 1234
0.00.339.058 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.339.061 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.339.062 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.339.062 I 
...
0.03.112.178 I llama_perf_sampler_print:    sampling time =       2.20 ms /    71 runs   (    0.03 ms per token, 32272.73 tokens per second)
0.03.112.182 I llama_perf_context_print:        load time =     337.05 ms
0.03.112.184 I llama_perf_context_print: prompt eval time =     123.73 ms /     7 tokens (   17.68 ms per token,    56.57 tokens per second)
0.03.112.186 I llama_perf_context_print:        eval time =    2637.77 ms /    63 runs   (   41.87 ms per token,    23.88 tokens per second)
0.03.112.187 I llama_perf_context_print:       total time =    2773.38 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.696 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.908 I llama_model_loader: - type q8_0:   98 tensors
...
0.00.076.515 I llm_load_print_meta: n_embd_v_gqa     = 2048
...
0.00.076.526 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.527 I llm_load_print_meta: model params     = 1.41 B
0.00.076.528 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.076.529 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.530 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.530 I llm_load_print_meta: max token length = 1024
0.00.166.540 I llm_load_tensors: CPU_Mapped model buffer size =  1435.23 MiB
...............................................................................
0.00.168.723 I llama_new_context_with_model: n_seq_max     = 1
0.00.168.746 I llama_new_context_with_model: n_ctx         = 128
0.00.168.746 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.168.747 I llama_new_context_with_model: n_batch       = 128
0.00.168.747 I llama_new_context_with_model: n_ubatch      = 128
...
0.00.168.751 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.173.547 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.173.574 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.173.592 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.175.785 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.175.802 I llama_new_context_with_model: graph nodes  = 967
...
0.00.241.152 I 
0.00.241.251 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.241.258 I perplexity: tokenizing the input ..
0.00.249.770 I perplexity: tokenization took 8.509 ms
0.00.249.804 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.145.355 I perplexity: 0.90 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.149.176 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.149.218 I llama_perf_context_print:        load time =     239.52 ms
0.01.149.242 I llama_perf_context_print: prompt eval time =     894.11 ms /   128 tokens (    6.99 ms per token,   143.16 tokens per second)
0.01.149.243 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.149.243 I llama_perf_context_print:       total time =     908.07 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.649 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.077.016 I llm_load_print_meta: rope_finetuned   = unknown
0.00.077.016 I llm_load_print_meta: ssm_d_conv       = 0
0.00.077.016 I llm_load_print_meta: ssm_d_inner      = 0
0.00.077.017 I llm_load_print_meta: ssm_d_state      = 0
0.00.077.017 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.077.017 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.077.018 I llm_load_print_meta: model type       = 1.4B
0.00.077.018 I llm_load_print_meta: model ftype      = Q4_0
0.00.077.019 I llm_load_print_meta: model params     = 1.41 B
0.00.077.020 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.077.022 I llm_load_print_meta: max token length = 1024
0.00.123.330 I llm_load_tensors: CPU_Mapped model buffer size =   777.31 MiB
0.00.123.346 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.369.287 I llama_new_context_with_model: n_seq_max     = 1
0.00.369.309 I llama_new_context_with_model: n_ctx         = 2048
0.00.369.309 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.369.309 I llama_new_context_with_model: n_batch       = 2048
0.00.369.310 I llama_new_context_with_model: n_ubatch      = 512
0.00.369.310 I llama_new_context_with_model: flash_attn    = 0
0.00.369.313 I llama_new_context_with_model: freq_base     = 10000.0
0.00.369.314 I llama_new_context_with_model: freq_scale    = 1
0.00.438.689 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.438.720 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.438.754 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.441.392 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.441.416 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.441.417 I llama_new_context_with_model: graph nodes  = 967
0.00.441.417 I llama_new_context_with_model: graph splits = 193
0.00.441.422 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.513.150 I main: llama threadpool init, n_threads = 4
0.00.513.178 I 
0.00.513.267 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.513.268 I 
0.00.513.409 I sampler seed: 1234
0.00.513.430 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.513.434 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.513.435 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.513.435 I 
...
0.01.930.416 I llama_perf_sampler_print:    sampling time =       2.18 ms /    71 runs   (    0.03 ms per token, 32568.81 tokens per second)
0.01.930.420 I llama_perf_context_print:        load time =     511.35 ms
0.01.930.422 I llama_perf_context_print: prompt eval time =      39.77 ms /     7 tokens (    5.68 ms per token,   176.02 tokens per second)
0.01.930.424 I llama_perf_context_print:        eval time =    1366.08 ms /    63 runs   (   21.68 ms per token,    46.12 tokens per second)
0.01.930.425 I llama_perf_context_print:       total time =    1417.27 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.626 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.403 I llm_load_print_meta: vocab type       = BPE
...
0.00.076.420 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.076.421 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.076.421 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.076.421 I llm_load_print_meta: n_ff             = 8192
0.00.076.422 I llm_load_print_meta: n_expert         = 0
0.00.076.422 I llm_load_print_meta: n_expert_used    = 0
0.00.076.422 I llm_load_print_meta: causal attn      = 1
0.00.076.422 I llm_load_print_meta: pooling type     = 0
...
0.00.076.425 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.076.426 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.076.426 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.076.426 I llm_load_print_meta: model type       = 1.4B
0.00.076.427 I llm_load_print_meta: model ftype      = Q4_0
0.00.076.428 I llm_load_print_meta: model params     = 1.41 B
0.00.076.428 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
...
0.00.121.797 I llm_load_tensors: CPU_Mapped model buffer size =   777.31 MiB
0.00.121.815 I llm_load_tensors:        AMX model buffer size =   648.00 MiB
.............................................................................
0.00.368.820 I llama_new_context_with_model: n_seq_max     = 1
0.00.368.842 I llama_new_context_with_model: n_ctx         = 128
0.00.368.842 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.368.843 I llama_new_context_with_model: n_batch       = 128
0.00.368.843 I llama_new_context_with_model: n_ubatch      = 128
0.00.368.843 I llama_new_context_with_model: flash_attn    = 0
0.00.368.848 I llama_new_context_with_model: freq_base     = 10000.0
0.00.368.849 I llama_new_context_with_model: freq_scale    = 1
0.00.368.850 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.373.638 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.373.665 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.373.689 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.376.720 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.376.740 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.376.741 I llama_new_context_with_model: graph nodes  = 967
0.00.376.741 I llama_new_context_with_model: graph splits = 193
0.00.376.743 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.413.296 I 
0.00.413.420 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.413.429 I perplexity: tokenizing the input ..
0.00.422.815 I perplexity: tokenization took 9.383 ms
0.00.422.855 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.883.439 I perplexity: 0.46 seconds per pass - ETA 0.00 minutes
[1]13.9353,
0.00.887.382 I Final estimate: PPL = 13.9353 +/- 4.36074

0.00.887.464 I llama_perf_context_print:        load time =     411.70 ms
0.00.887.466 I llama_perf_context_print: prompt eval time =     458.68 ms /   128 tokens (    3.58 ms per token,   279.06 tokens per second)
0.00.887.467 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.887.468 I llama_perf_context_print:       total time =     474.17 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.757 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.454 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.114.160 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.114.178 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.384.726 I llama_new_context_with_model: n_seq_max     = 1
0.00.384.745 I llama_new_context_with_model: n_ctx         = 2048
0.00.384.746 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.384.746 I llama_new_context_with_model: n_batch       = 2048
0.00.384.746 I llama_new_context_with_model: n_ubatch      = 512
0.00.384.747 I llama_new_context_with_model: flash_attn    = 0
0.00.384.751 I llama_new_context_with_model: freq_base     = 10000.0
0.00.384.752 I llama_new_context_with_model: freq_scale    = 1
0.00.453.022 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.453.050 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.453.082 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.455.567 I llama_new_context_with_model:        AMX compute buffer size =    20.00 MiB
0.00.455.591 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.455.592 I llama_new_context_with_model: graph nodes  = 967
0.00.455.593 I llama_new_context_with_model: graph splits = 193
0.00.455.598 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.526.033 I main: llama threadpool init, n_threads = 4
0.00.526.059 I 
0.00.526.149 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.526.149 I 
0.00.526.295 I sampler seed: 1234
0.00.526.316 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.526.321 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.526.321 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.526.321 I 
...
0.02.029.513 I llama_perf_sampler_print:    sampling time =       2.15 ms /    71 runs   (    0.03 ms per token, 33054.00 tokens per second)
0.02.029.517 I llama_perf_context_print:        load time =     524.14 ms
0.02.029.519 I llama_perf_context_print: prompt eval time =      38.96 ms /     7 tokens (    5.57 ms per token,   179.67 tokens per second)
0.02.029.520 I llama_perf_context_print:        eval time =    1453.03 ms /    63 runs   (   23.06 ms per token,    43.36 tokens per second)
0.02.029.522 I llama_perf_context_print:       total time =    1503.49 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.737 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.306 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf (version GGUF V3 (latest))
...
0.00.076.168 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
...
0.00.076.175 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.076.176 I llm_load_print_meta: model type       = 1.4B
0.00.076.176 I llm_load_print_meta: model ftype      = Q4_1
0.00.076.177 I llm_load_print_meta: model params     = 1.41 B
0.00.076.178 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.076.180 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.181 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.181 I llm_load_print_meta: max token length = 1024
0.00.115.127 I llm_load_tensors: CPU_Mapped model buffer size =   854.46 MiB
0.00.115.144 I llm_load_tensors:        AMX model buffer size =   720.00 MiB
............................................................................
0.00.384.192 I llama_new_context_with_model: n_seq_max     = 1
0.00.384.215 I llama_new_context_with_model: n_ctx         = 128
0.00.384.215 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.384.215 I llama_new_context_with_model: n_batch       = 128
0.00.384.216 I llama_new_context_with_model: n_ubatch      = 128
0.00.384.216 I llama_new_context_with_model: flash_attn    = 0
0.00.384.220 I llama_new_context_with_model: freq_base     = 10000.0
0.00.384.221 I llama_new_context_with_model: freq_scale    = 1
0.00.384.222 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.389.088 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.389.116 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.389.140 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.392.174 I llama_new_context_with_model:        AMX compute buffer size =     5.00 MiB
0.00.392.196 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.392.197 I llama_new_context_with_model: graph nodes  = 967
0.00.392.197 I llama_new_context_with_model: graph splits = 193
0.00.392.199 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.424.339 I 
0.00.424.448 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.424.455 I perplexity: tokenizing the input ..
0.00.433.841 I perplexity: tokenization took 9.382 ms
0.00.433.875 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.00.908.864 I perplexity: 0.47 seconds per pass - ETA 0.00 minutes
[1]12.5780,
0.00.912.743 I Final estimate: PPL = 12.5780 +/- 3.87217

0.00.912.812 I llama_perf_context_print:        load time =     422.63 ms
0.00.912.814 I llama_perf_context_print: prompt eval time =     473.11 ms /   128 tokens (    3.70 ms per token,   270.55 tokens per second)
0.00.912.815 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.912.816 I llama_perf_context_print:       total time =     488.47 ms /   129 tokens
...
0.00.010.325 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf (version GGUF V3 (latest))
...
0.00.118.751 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.120.815 I llama_new_context_with_model: n_seq_max     = 1
0.00.120.837 I llama_new_context_with_model: n_ctx         = 2048
0.00.120.837 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.120.837 I llama_new_context_with_model: n_batch       = 2048
0.00.120.838 I llama_new_context_with_model: n_ubatch      = 512
0.00.120.838 I llama_new_context_with_model: flash_attn    = 0
0.00.120.840 I llama_new_context_with_model: freq_base     = 10000.0
0.00.120.841 I llama_new_context_with_model: freq_scale    = 1
0.00.187.806 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.187.832 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.187.851 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.189.964 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.189.978 I llama_new_context_with_model: graph nodes  = 967
0.00.189.978 I llama_new_context_with_model: graph splits = 1
0.00.189.982 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.273.841 I main: llama threadpool init, n_threads = 4
0.00.273.868 I 
0.00.273.951 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.273.951 I 
0.00.274.063 I sampler seed: 1234
0.00.274.083 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.274.086 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.274.086 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.274.086 I 
...
0.02.546.532 I llama_perf_sampler_print:    sampling time =       2.23 ms /    71 runs   (    0.03 ms per token, 31810.04 tokens per second)
0.02.546.535 I llama_perf_context_print:        load time =     272.01 ms
0.02.546.537 I llama_perf_context_print: prompt eval time =     123.56 ms /     7 tokens (   17.65 ms per token,    56.65 tokens per second)
0.02.546.538 I llama_perf_context_print:        eval time =    2137.56 ms /    63 runs   (   33.93 ms per token,    29.47 tokens per second)
0.02.546.538 I llama_perf_context_print:       total time =    2272.70 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.694 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.291 I llama_model_loader: - type q5_0:   97 tensors
0.00.021.291 I llama_model_loader: - type q6_K:    1 tensors
0.00.063.840 I llm_load_vocab: special tokens cache size = 25
0.00.075.593 I llm_load_vocab: token to piece cache size = 0.2984 MB
...
0.00.075.642 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.643 I llm_load_print_meta: model params     = 1.41 B
0.00.075.644 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.119.140 I llm_load_tensors: CPU_Mapped model buffer size =   942.60 MiB
..................................................................................
0.00.121.246 I llama_new_context_with_model: n_seq_max     = 1
0.00.121.268 I llama_new_context_with_model: n_ctx         = 128
0.00.121.268 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.121.268 I llama_new_context_with_model: n_batch       = 128
0.00.121.268 I llama_new_context_with_model: n_ubatch      = 128
0.00.121.269 I llama_new_context_with_model: flash_attn    = 0
0.00.121.270 I llama_new_context_with_model: freq_base     = 10000.0
0.00.121.271 I llama_new_context_with_model: freq_scale    = 1
0.00.121.271 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.125.866 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.125.892 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.125.905 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.128.447 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.128.464 I llama_new_context_with_model: graph nodes  = 967
0.00.128.464 I llama_new_context_with_model: graph splits = 1
0.00.128.466 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.201.180 I 
0.00.201.269 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.201.274 I perplexity: tokenizing the input ..
0.00.209.495 I perplexity: tokenization took 8.217 ms
0.00.209.524 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.337.318 I perplexity: 1.13 seconds per pass - ETA 0.02 minutes
[1]10.0390,
0.01.340.886 I Final estimate: PPL = 10.0390 +/- 3.19711

0.01.340.926 I llama_perf_context_print:        load time =     199.55 ms
0.01.340.929 I llama_perf_context_print: prompt eval time =    1126.15 ms /   128 tokens (    8.80 ms per token,   113.66 tokens per second)
0.01.340.931 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.340.931 I llama_perf_context_print:       total time =    1139.75 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.671 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.000.892 I main: llama backend init
0.00.001.776 I main: load the model and apply lora adapter, if any
0.00.010.493 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf (version GGUF V3 (latest))
...
0.00.076.897 I llm_load_vocab: token to piece cache size = 0.2984 MB
0.00.076.920 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.076.921 I llm_load_print_meta: arch             = gptneox
0.00.076.922 I llm_load_print_meta: vocab type       = BPE
0.00.076.922 I llm_load_print_meta: n_vocab          = 50304
0.00.076.922 I llm_load_print_meta: n_merges         = 50009
0.00.076.923 I llm_load_print_meta: vocab_only       = 0
0.00.076.923 I llm_load_print_meta: n_ctx_train      = 2048
0.00.076.923 I llm_load_print_meta: n_embd           = 2048
0.00.076.924 I llm_load_print_meta: n_layer          = 24
0.00.076.933 I llm_load_print_meta: n_head           = 16
0.00.076.934 I llm_load_print_meta: n_head_kv        = 16
0.00.076.934 I llm_load_print_meta: n_rot            = 32
0.00.076.934 I llm_load_print_meta: n_swa            = 0
0.00.076.935 I llm_load_print_meta: n_embd_head_k    = 128
0.00.076.935 I llm_load_print_meta: n_embd_head_v    = 128
0.00.076.936 I llm_load_print_meta: n_gqa            = 1
0.00.076.937 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.076.938 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.076.939 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.076.940 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
...
0.00.076.942 I llm_load_print_meta: n_ff             = 8192
0.00.076.942 I llm_load_print_meta: n_expert         = 0
0.00.076.942 I llm_load_print_meta: n_expert_used    = 0
0.00.076.943 I llm_load_print_meta: causal attn      = 1
0.00.076.943 I llm_load_print_meta: pooling type     = 0
0.00.076.943 I llm_load_print_meta: rope type        = 2
0.00.076.944 I llm_load_print_meta: rope scaling     = linear
0.00.076.945 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.076.946 I llm_load_print_meta: freq_scale_train = 1
0.00.076.946 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.076.947 I llm_load_print_meta: rope_finetuned   = unknown
0.00.076.947 I llm_load_print_meta: ssm_d_conv       = 0
0.00.076.948 I llm_load_print_meta: ssm_d_inner      = 0
0.00.076.948 I llm_load_print_meta: ssm_d_state      = 0
0.00.076.948 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.076.948 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.076.949 I llm_load_print_meta: model type       = 1.4B
0.00.076.949 I llm_load_print_meta: model ftype      = Q5_1
0.00.076.950 I llm_load_print_meta: model params     = 1.41 B
0.00.076.952 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
0.00.076.952 I llm_load_print_meta: general.name     = 1.4B
0.00.076.952 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.076.952 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.076.953 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.076.953 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.076.953 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.954 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.954 I llm_load_print_meta: max token length = 1024
0.00.124.728 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
...
0.00.126.952 I llama_new_context_with_model: n_batch       = 2048
0.00.126.953 I llama_new_context_with_model: n_ubatch      = 512
0.00.126.953 I llama_new_context_with_model: flash_attn    = 0
0.00.126.955 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.956 I llama_new_context_with_model: freq_scale    = 1
...
0.00.196.886 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.196.902 I llama_new_context_with_model: graph nodes  = 967
0.00.196.903 I llama_new_context_with_model: graph splits = 1
0.00.196.906 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.289.900 I main: llama threadpool init, n_threads = 4
0.00.289.927 I 
0.00.290.011 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.290.025 I 
0.00.290.153 I sampler seed: 1234
0.00.290.171 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.290.175 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.290.176 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.290.176 I 
...
0.02.676.843 I llama_perf_sampler_print:    sampling time =       2.28 ms /    71 runs   (    0.03 ms per token, 31113.06 tokens per second)
0.02.676.846 I llama_perf_context_print:        load time =     288.09 ms
0.02.676.848 I llama_perf_context_print: prompt eval time =     123.07 ms /     7 tokens (   17.58 ms per token,    56.88 tokens per second)
0.02.676.850 I llama_perf_context_print:        eval time =    2252.42 ms /    63 runs   (   35.75 ms per token,    27.97 tokens per second)
0.02.676.850 I llama_perf_context_print:       total time =    2386.95 ms /    70 tokens
...
0.00.076.509 I llm_load_vocab: token to piece cache size = 0.2984 MB
...
0.00.076.546 I llm_load_print_meta: n_rot            = 32
0.00.076.546 I llm_load_print_meta: n_swa            = 0
0.00.076.547 I llm_load_print_meta: n_embd_head_k    = 128
0.00.076.547 I llm_load_print_meta: n_embd_head_v    = 128
0.00.076.548 I llm_load_print_meta: n_gqa            = 1
0.00.076.549 I llm_load_print_meta: n_embd_k_gqa     = 2048
0.00.076.550 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.076.551 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.076.552 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.076.552 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.076.552 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.076.553 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.076.553 I llm_load_print_meta: n_ff             = 8192
0.00.076.554 I llm_load_print_meta: n_expert         = 0
0.00.076.554 I llm_load_print_meta: n_expert_used    = 0
...
0.00.076.557 I llm_load_print_meta: freq_scale_train = 1
0.00.076.558 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
0.00.076.558 I llm_load_print_meta: rope_finetuned   = unknown
...
0.00.076.563 I llm_load_print_meta: model ftype      = Q5_1
0.00.076.564 I llm_load_print_meta: model params     = 1.41 B
0.00.076.565 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.123.213 I llm_load_tensors: CPU_Mapped model buffer size =  1020.74 MiB
...............................................................................
0.00.125.314 I llama_new_context_with_model: n_seq_max     = 1
...
0.00.125.337 I llama_new_context_with_model: freq_base     = 10000.0
...
0.00.130.043 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.130.058 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.132.050 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.132.071 I llama_new_context_with_model: graph nodes  = 967
0.00.132.071 I llama_new_context_with_model: graph splits = 1
0.00.132.073 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.190.342 I 
0.00.190.439 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.190.446 I perplexity: tokenizing the input ..
0.00.198.993 I perplexity: tokenization took 8.543 ms
0.00.199.023 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.134.590 I perplexity: 1.94 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.138.425 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.138.464 I llama_perf_context_print:        load time =     188.72 ms
0.02.138.466 I llama_perf_context_print: prompt eval time =    1933.88 ms /   128 tokens (   15.11 ms per token,    66.19 tokens per second)
0.02.138.467 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.138.467 I llama_perf_context_print:       total time =    1948.12 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.652 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.104.274 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.106.419 I llama_new_context_with_model: n_seq_max     = 1
0.00.106.441 I llama_new_context_with_model: n_ctx         = 2048
0.00.106.441 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.106.442 I llama_new_context_with_model: n_batch       = 2048
0.00.106.442 I llama_new_context_with_model: n_ubatch      = 512
0.00.106.442 I llama_new_context_with_model: flash_attn    = 0
0.00.106.444 I llama_new_context_with_model: freq_base     = 10000.0
0.00.106.445 I llama_new_context_with_model: freq_scale    = 1
0.00.175.436 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.175.463 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.175.480 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.178.010 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.178.026 I llama_new_context_with_model: graph nodes  = 967
0.00.178.026 I llama_new_context_with_model: graph splits = 1
0.00.178.030 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.253.409 I main: llama threadpool init, n_threads = 4
0.00.253.433 I 
0.00.253.515 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.253.527 I 
0.00.253.652 I sampler seed: 1234
0.00.253.671 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.253.674 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.253.675 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.253.675 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.720.898 I llama_perf_sampler_print:    sampling time =       2.08 ms /    71 runs   (    0.03 ms per token, 34151.03 tokens per second)
0.01.720.901 I llama_perf_context_print:        load time =     251.45 ms
0.01.720.903 I llama_perf_context_print: prompt eval time =      80.18 ms /     7 tokens (   11.45 ms per token,    87.30 tokens per second)
0.01.720.904 I llama_perf_context_print:        eval time =    1376.48 ms /    63 runs   (   21.85 ms per token,    45.77 tokens per second)
0.01.720.904 I llama_perf_context_print:       total time =    1467.50 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.682 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.929 I llm_load_print_meta: f_norm_eps       = 1.0e-05
...
0.00.076.937 I llm_load_print_meta: ssm_d_state      = 0
...
0.00.106.279 I llm_load_tensors: CPU_Mapped model buffer size =   542.04 MiB
..........................................................................
0.00.108.433 I llama_new_context_with_model: n_seq_max     = 1
0.00.108.453 I llama_new_context_with_model: n_ctx         = 128
0.00.108.453 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.108.453 I llama_new_context_with_model: n_batch       = 128
0.00.108.454 I llama_new_context_with_model: n_ubatch      = 128
0.00.108.454 I llama_new_context_with_model: flash_attn    = 0
0.00.108.455 I llama_new_context_with_model: freq_base     = 10000.0
0.00.108.456 I llama_new_context_with_model: freq_scale    = 1
0.00.108.457 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.113.188 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.113.209 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.113.225 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.115.671 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.115.694 I llama_new_context_with_model: graph nodes  = 967
0.00.115.695 I llama_new_context_with_model: graph splits = 1
0.00.115.697 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.152.781 I 
0.00.152.924 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.152.943 I perplexity: tokenizing the input ..
0.00.161.592 I perplexity: tokenization took 8.646 ms
0.00.161.621 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.454.878 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.458.816 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.458.855 I llama_perf_context_print:        load time =     151.06 ms
0.01.458.857 I llama_perf_context_print: prompt eval time =    1291.56 ms /   128 tokens (   10.09 ms per token,    99.10 tokens per second)
0.01.458.858 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.458.859 I llama_perf_context_print:       total time =    1306.07 ms /   129 tokens
...
0.00.076.318 I llm_load_print_meta: arch             = gptneox
0.00.076.318 I llm_load_print_meta: vocab type       = BPE
0.00.076.319 I llm_load_print_meta: n_vocab          = 50304
...
0.00.076.340 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.076.341 I llm_load_print_meta: model params     = 1.41 B
0.00.076.342 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.076.344 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.076.344 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.076.344 I llm_load_print_meta: max token length = 1024
0.00.111.689 I llm_load_tensors: CPU_Mapped model buffer size =   724.27 MiB
...............................................................................
0.00.113.851 I llama_new_context_with_model: n_seq_max     = 1
0.00.113.871 I llama_new_context_with_model: n_ctx         = 2048
0.00.113.871 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.113.872 I llama_new_context_with_model: n_batch       = 2048
0.00.113.872 I llama_new_context_with_model: n_ubatch      = 512
0.00.113.872 I llama_new_context_with_model: flash_attn    = 0
0.00.113.874 I llama_new_context_with_model: freq_base     = 10000.0
0.00.113.874 I llama_new_context_with_model: freq_scale    = 1
0.00.182.054 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.182.076 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.182.092 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.184.521 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.184.543 I llama_new_context_with_model: graph nodes  = 967
0.00.184.544 I llama_new_context_with_model: graph splits = 1
0.00.184.547 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.263.941 I main: llama threadpool init, n_threads = 4
0.00.263.969 I 
0.00.264.049 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.264.061 I 
0.00.264.174 I sampler seed: 1234
0.00.264.193 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.264.196 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.264.197 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.264.197 I 
...
0.01.988.630 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32434.90 tokens per second)
0.01.988.633 I llama_perf_context_print:        load time =     262.09 ms
0.01.988.634 I llama_perf_context_print: prompt eval time =      87.90 ms /     7 tokens (   12.56 ms per token,    79.64 tokens per second)
0.01.988.635 I llama_perf_context_print:        eval time =    1625.95 ms /    63 runs   (   25.81 ms per token,    38.75 tokens per second)
0.01.988.636 I llama_perf_context_print:       total time =    1724.69 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.689 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.746 I llama_model_loader: - type q3_K:   25 tensors
0.00.021.746 I llama_model_loader: - type q4_K:   71 tensors
0.00.021.747 I llama_model_loader: - type q5_K:    1 tensors
...
0.00.076.404 I llm_load_print_meta: arch             = gptneox
0.00.076.404 I llm_load_print_meta: vocab type       = BPE
0.00.076.405 I llm_load_print_meta: n_vocab          = 50304
0.00.076.405 I llm_load_print_meta: n_merges         = 50009
0.00.076.405 I llm_load_print_meta: vocab_only       = 0
0.00.076.406 I llm_load_print_meta: n_ctx_train      = 2048
0.00.076.406 I llm_load_print_meta: n_embd           = 2048
...
0.00.076.424 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
...
0.00.076.431 I llm_load_print_meta: model type       = 1.4B
0.00.076.432 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.076.433 I llm_load_print_meta: model params     = 1.41 B
0.00.076.434 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
...............................................................................
0.00.114.436 I llama_new_context_with_model: n_seq_max     = 1
0.00.114.455 I llama_new_context_with_model: n_ctx         = 128
0.00.114.455 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.114.456 I llama_new_context_with_model: n_batch       = 128
0.00.114.456 I llama_new_context_with_model: n_ubatch      = 128
0.00.114.456 I llama_new_context_with_model: flash_attn    = 0
0.00.114.458 I llama_new_context_with_model: freq_base     = 10000.0
0.00.114.459 I llama_new_context_with_model: freq_scale    = 1
0.00.114.459 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.118.738 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.118.764 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.118.781 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.121.263 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.121.287 I llama_new_context_with_model: graph nodes  = 967
0.00.121.287 I llama_new_context_with_model: graph splits = 1
0.00.121.289 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.166.490 I 
0.00.166.599 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.166.624 I perplexity: tokenizing the input ..
0.00.175.318 I perplexity: tokenization took 8.697 ms
0.00.175.352 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.510.430 I perplexity: 1.34 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.514.329 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.514.372 I llama_perf_context_print:        load time =     164.85 ms
0.01.514.375 I llama_perf_context_print: prompt eval time =    1333.65 ms /   128 tokens (   10.42 ms per token,    95.98 tokens per second)
0.01.514.377 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.514.378 I llama_perf_context_print:       total time =    1347.88 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.644 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.414 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
...
0.00.021.418 I llama_model_loader: - type q6_K:   13 tensors
...
0.00.075.153 I llm_load_print_meta: freq_base_train  = 10000.0
...
0.00.075.155 I llm_load_print_meta: ssm_d_state      = 0
0.00.075.155 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.075.155 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.075.156 I llm_load_print_meta: model type       = 1.4B
0.00.075.157 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.158 I llm_load_print_meta: model params     = 1.41 B
0.00.075.158 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.075.161 I llm_load_print_meta: max token length = 1024
0.00.115.418 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.117.552 I llama_new_context_with_model: n_seq_max     = 1
0.00.117.574 I llama_new_context_with_model: n_ctx         = 2048
0.00.117.575 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.117.575 I llama_new_context_with_model: n_batch       = 2048
0.00.117.575 I llama_new_context_with_model: n_ubatch      = 512
0.00.117.575 I llama_new_context_with_model: flash_attn    = 0
0.00.117.577 I llama_new_context_with_model: freq_base     = 10000.0
0.00.117.578 I llama_new_context_with_model: freq_scale    = 1
0.00.185.628 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.185.655 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.185.671 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.188.269 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.188.286 I llama_new_context_with_model: graph nodes  = 967
0.00.188.286 I llama_new_context_with_model: graph splits = 1
0.00.188.289 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.271.595 I main: llama threadpool init, n_threads = 4
0.00.271.624 I 
0.00.271.706 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.271.718 I 
0.00.271.913 I sampler seed: 1234
0.00.271.932 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.271.936 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.271.937 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.271.937 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.189.207 I llama_perf_sampler_print:    sampling time =       2.31 ms /    71 runs   (    0.03 ms per token, 30802.60 tokens per second)
0.02.189.210 I llama_perf_context_print:        load time =     269.81 ms
0.02.189.212 I llama_perf_context_print: prompt eval time =      87.50 ms /     7 tokens (   12.50 ms per token,    80.00 tokens per second)
0.02.189.213 I llama_perf_context_print:        eval time =    1818.88 ms /    63 runs   (   28.87 ms per token,    34.64 tokens per second)
0.02.189.214 I llama_perf_context_print:       total time =    1917.62 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.691 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.211 I llama_model_loader: - kv  22:                          general.file_type u32              = 15
...
0.00.116.032 I llm_load_tensors: CPU_Mapped model buffer size =   871.81 MiB
..............................................................................
0.00.118.092 I llama_new_context_with_model: n_seq_max     = 1
0.00.118.114 I llama_new_context_with_model: n_ctx         = 128
0.00.118.115 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.118.115 I llama_new_context_with_model: n_batch       = 128
0.00.118.115 I llama_new_context_with_model: n_ubatch      = 128
0.00.118.116 I llama_new_context_with_model: flash_attn    = 0
0.00.118.117 I llama_new_context_with_model: freq_base     = 10000.0
0.00.118.118 I llama_new_context_with_model: freq_scale    = 1
0.00.118.119 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.122.785 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.122.806 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.122.819 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.125.234 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.125.256 I llama_new_context_with_model: graph nodes  = 967
0.00.125.256 I llama_new_context_with_model: graph splits = 1
0.00.125.258 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.171.097 I 
0.00.171.193 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.171.200 I perplexity: tokenizing the input ..
0.00.179.954 I perplexity: tokenization took 8.75 ms
0.00.179.984 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.574.274 I perplexity: 1.39 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.578.055 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.578.094 I llama_perf_context_print:        load time =     169.46 ms
0.01.578.096 I llama_perf_context_print: prompt eval time =    1392.54 ms /   128 tokens (   10.88 ms per token,    91.92 tokens per second)
0.01.578.098 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.578.099 I llama_perf_context_print:       total time =    1407.00 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.774 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.629 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
...
0.00.076.637 I llm_load_print_meta: model ftype      = Q5_K - Medium
...
0.00.122.344 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.124.523 I llama_new_context_with_model: n_seq_max     = 1
0.00.124.544 I llama_new_context_with_model: n_ctx         = 2048
0.00.124.544 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.124.545 I llama_new_context_with_model: n_batch       = 2048
0.00.124.545 I llama_new_context_with_model: n_ubatch      = 512
0.00.124.546 I llama_new_context_with_model: flash_attn    = 0
0.00.124.547 I llama_new_context_with_model: freq_base     = 10000.0
0.00.124.548 I llama_new_context_with_model: freq_scale    = 1
0.00.193.713 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.193.741 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.193.761 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.195.787 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.195.811 I llama_new_context_with_model: graph nodes  = 967
0.00.195.811 I llama_new_context_with_model: graph splits = 1
0.00.195.816 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.286.491 I main: llama threadpool init, n_threads = 4
0.00.286.518 I 
0.00.286.604 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.286.616 I 
0.00.286.735 I sampler seed: 1234
0.00.286.753 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.286.756 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.286.757 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.286.757 I 
...
0.02.473.749 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32464.56 tokens per second)
0.02.473.752 I llama_perf_context_print:        load time =     284.57 ms
0.02.473.754 I llama_perf_context_print: prompt eval time =     110.84 ms /     7 tokens (   15.83 ms per token,    63.15 tokens per second)
0.02.473.755 I llama_perf_context_print:        eval time =    2065.39 ms /    63 runs   (   32.78 ms per token,    30.50 tokens per second)
0.02.473.756 I llama_perf_context_print:       total time =    2187.27 ms /    70 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.788 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.010.392 I llama_model_loader: loaded meta data with 23 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf (version GGUF V3 (latest))
...
0.00.021.849 I llama_model_loader: - type q5_K:   61 tensors
0.00.021.850 I llama_model_loader: - type q6_K:   37 tensors
...
0.00.076.308 I llm_load_print_meta: model ftype      = Q5_K - Medium
0.00.076.309 I llm_load_print_meta: model params     = 1.41 B
0.00.076.310 I llm_load_print_meta: model size       = 1006.35 MiB (5.97 BPW) 
...
0.00.121.181 I llm_load_tensors: CPU_Mapped model buffer size =  1006.35 MiB
................................................................................
0.00.123.359 I llama_new_context_with_model: n_seq_max     = 1
0.00.123.380 I llama_new_context_with_model: n_ctx         = 128
0.00.123.380 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.123.381 I llama_new_context_with_model: n_batch       = 128
0.00.123.381 I llama_new_context_with_model: n_ubatch      = 128
0.00.123.381 I llama_new_context_with_model: flash_attn    = 0
0.00.123.383 I llama_new_context_with_model: freq_base     = 10000.0
0.00.123.384 I llama_new_context_with_model: freq_scale    = 1
0.00.123.384 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.128.019 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.128.045 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.128.064 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.130.073 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.130.094 I llama_new_context_with_model: graph nodes  = 967
0.00.130.094 I llama_new_context_with_model: graph splits = 1
0.00.130.096 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.180.403 I 
0.00.180.508 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.180.517 I perplexity: tokenizing the input ..
0.00.189.549 I perplexity: tokenization took 9.03 ms
0.00.189.580 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.876.251 I perplexity: 1.69 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.880.016 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.880.058 I llama_perf_context_print:        load time =     178.71 ms
0.01.880.061 I llama_perf_context_print: prompt eval time =    1684.93 ms /   128 tokens (   13.16 ms per token,    75.97 tokens per second)
0.01.880.062 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.880.062 I llama_perf_context_print:       total time =    1699.65 ms /   129 tokens
...
warning: not compiled with GPU offload support, --gpu-layers option will be ignored
warning: see main README.md for information on enabling GPU BLAS support
0.00.000.776 I build: 4019 (08828a6d) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.022.041 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.076.468 I llm_load_print_meta: model ftype      = Q6_K
0.00.076.469 I llm_load_print_meta: model params     = 1.41 B
0.00.076.469 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.126.016 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.128.111 I llama_new_context_with_model: n_seq_max     = 1
0.00.128.173 I llama_new_context_with_model: n_ctx         = 2048
0.00.128.173 I llama_new_context_with_model: n_ctx_per_seq = 2048
0.00.128.174 I llama_new_context_with_model: n_batch       = 2048
0.00.128.174 I llama_new_context_with_model: n_ubatch      = 512
0.00.128.175 I llama_new_context_with_model: flash_attn    = 0
0.00.128.177 I llama_new_context_with_model: freq_base     = 10000.0
0.00.128.180 I llama_new_context_with_model: freq_scale    = 1
0.00.198.219 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.198.246 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.198.265 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.200.765 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.200.780 I llama_new_context_with_model: graph nodes  = 967
0.00.200.781 I llama_new_context_with_model: graph splits = 1
0.00.200.784 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.289.125 I main: llama threadpool init, n_threads = 4
0.00.289.153 I 
0.00.289.232 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.289.244 I 
0.00.289.371 I sampler seed: 1234
0.00.289.390 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	dry_multiplier = 0.000, dry_base = 1.750, dry_allowed_length = 2, dry_penalty_last_n = -1
	top_k = 40, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.289.393 I sampler chain: logits -> logit-bias -> penalties -> dry -> top-k -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.289.393 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.289.393 I 
...
0.02.617.594 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32420.09 tokens per second)
0.02.617.597 I llama_perf_context_print:        load time =     287.21 ms
0.02.617.598 I llama_perf_context_print: prompt eval time =     109.08 ms /     7 tokens (   15.58 ms per token,    64.18 tokens per second)
0.02.617.599 I llama_perf_context_print:        eval time =    2208.51 ms /    63 runs   (   35.06 ms per token,    28.53 tokens per second)
0.02.617.600 I llama_perf_context_print:       total time =    2328.48 ms /    70 tokens
...
0.00.124.491 I llm_load_tensors: CPU_Mapped model buffer size =  1108.64 MiB
...............................................................................
0.00.126.843 I llama_new_context_with_model: n_seq_max     = 1
0.00.126.864 I llama_new_context_with_model: n_ctx         = 128
0.00.126.864 I llama_new_context_with_model: n_ctx_per_seq = 128
0.00.126.864 I llama_new_context_with_model: n_batch       = 128
0.00.126.865 I llama_new_context_with_model: n_ubatch      = 128
0.00.126.865 I llama_new_context_with_model: flash_attn    = 0
0.00.126.867 I llama_new_context_with_model: freq_base     = 10000.0
0.00.126.868 I llama_new_context_with_model: freq_scale    = 1
0.00.126.868 W llama_new_context_with_model: n_ctx_per_seq (128) < n_ctx_train (2048) -- the full capacity of the model will not be utilized
0.00.131.501 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.131.527 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.131.540 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.134.045 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.134.061 I llama_new_context_with_model: graph nodes  = 967
0.00.134.061 I llama_new_context_with_model: graph splits = 1
0.00.134.063 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.189.136 I 
0.00.189.240 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.189.249 I perplexity: tokenizing the input ..
0.00.198.199 I perplexity: tokenization took 8.946 ms
0.00.198.228 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.844.822 I perplexity: 1.65 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.848.671 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.848.713 I llama_perf_context_print:        load time =     187.49 ms
0.01.848.715 I llama_perf_context_print: prompt eval time =    1644.77 ms /   128 tokens (   12.85 ms per token,    77.82 tokens per second)
0.01.848.716 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.848.717 I llama_perf_context_print:       total time =    1659.58 ms /   129 tokens
...
0.00.442.565 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 193
0.00.438.379 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_seq_max     = 1
llama_new_context_with_model: n_ctx         = 2048
llama_new_context_with_model: n_ctx_per_seq = 2048
...
0.58user 0.65system 0:01.23elapsed 100%CPU (0avgtext+0avgdata 5359216maxresident)k
...
0.47user 0.60system 0:01.07elapsed 100%CPU (0avgtext+0avgdata 5353900maxresident)k
0inputs+32outputs (0major+53718minor)pagefaults 0swaps
```
