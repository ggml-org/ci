...
- status:  SUCCESS ✅
- runtime: 19:04.61
- date:    Wed May 22 18:12:43 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-release
 ...
 9/22 Test  #9: test-tokenizer-0-command-r .......   Passed    0.72 sec
      Start 10: test-tokenizer-0-qwen2
10/22 Test #10: test-tokenizer-0-qwen2 ...........   Passed    0.35 sec
      Start 11: test-tokenizer-1-llama-spm
...
llama_print_timings:        load time =      13.00 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       4.06 ms /     9 tokens (    0.45 ms per token,  2215.66 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.57 ms /     9 tokens (    0.40 ms per token,  2521.01 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Once upon a time, there lived a young girl named Anya. Anya had bright eyes and a smile that could brighten any room. However, Anya also had a secret: she was
llama_print_timings:        load time =    1262.82 ms
llama_print_timings:      sample time =      46.34 ms /    32 runs   (    1.45 ms per token,   690.55 tokens per second)
llama_print_timings: prompt eval time =    2624.33 ms /     5 tokens (  524.87 ms per token,     1.91 tokens per second)
llama_print_timings:        eval time =   21371.99 ms /    31 runs   (  689.42 ms per token,     1.45 tokens per second)
llama_print_timings:       total time =   24177.27 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> After the wedding, the bride and groom embarked on a honeymoon in Paris.

The honeymoon was a dream come true for the bride, filled with luxurious accommodations, exquisite
llama_print_timings:        load time =    1245.71 ms
llama_print_timings:      sample time =      46.59 ms /    32 runs   (    1.46 ms per token,   686.90 tokens per second)
llama_print_timings: prompt eval time =    1160.93 ms /     2 tokens (  580.46 ms per token,     1.72 tokens per second)
llama_print_timings:        eval time =   21149.37 ms /    31 runs   (  682.24 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22490.00 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the average time for a task is 2 minutes, what will be the average time for the same task if the number of attempts is doubled?

**A
llama_print_timings:        load time =    1306.65 ms
llama_print_timings:      sample time =      46.55 ms /    32 runs   (    1.45 ms per token,   687.39 tokens per second)
llama_print_timings: prompt eval time =    1230.18 ms /     2 tokens (  615.09 ms per token,     1.63 tokens per second)
llama_print_timings:        eval time =   21244.53 ms /    31 runs   (  685.31 ms per token,     1.46 tokens per second)
llama_print_timings:       total time =   22653.57 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
**a)** Who was Anya's guardian?
**b)** What was Anya's greatest wish?
llama_print_timings:        load time =    1257.83 ms
llama_print_timings:      sample time =      46.38 ms /    32 runs   (    1.45 ms per token,   689.88 tokens per second)
llama_print_timings: prompt eval time =    2786.94 ms /     5 tokens (  557.39 ms per token,     1.79 tokens per second)
llama_print_timings:        eval time =   21138.22 ms /    31 runs   (  681.88 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   24104.66 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197128.04 ms
main:    total time = 197128.04 ms
+ echo PASS
PASS
+ echo
...
<bos> They say necessity is the mother of invention. And while I agree that basic necessities are essential for survival, I believe there are also other important factors at play when it
llama_print_timings:        load time =     628.28 ms
llama_print_timings:      sample time =      46.32 ms /    32 runs   (    1.45 ms per token,   690.79 tokens per second)
llama_print_timings: prompt eval time =     569.30 ms /     2 tokens (  284.65 ms per token,     3.51 tokens per second)
llama_print_timings:        eval time =   10516.18 ms /    31 runs   (  339.23 ms per token,     2.95 tokens per second)
llama_print_timings:       total time =   11266.01 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196807.95 ms
main:    total time = 196807.95 ms
+ echo PASS
PASS
+ echo
...
- Overemphas
llama_print_timings:        load time =     624.97 ms
llama_print_timings:      sample time =      46.21 ms /    32 runs   (    1.44 ms per token,   692.43 tokens per second)
llama_print_timings: prompt eval time =     565.61 ms /     2 tokens (  282.81 ms per token,     3.54 tokens per second)
llama_print_timings:        eval time =   10437.19 ms /    31 runs   (  336.68 ms per token,     2.97 tokens per second)
llama_print_timings:       total time =   11181.74 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar! is a game designed to teach children about the importance of dreams and aspirations. The game features whimsical characters, engaging challenges, and a positive and encouraging narrative
llama_print_timings:        load time =     195.78 ms
llama_print_timings:      sample time =       5.59 ms /    32 runs   (    0.17 ms per token,  5723.48 tokens per second)
llama_print_timings: prompt eval time =      81.47 ms /     2 tokens (   40.73 ms per token,    24.55 tokens per second)
llama_print_timings:        eval time =    2274.35 ms /    31 runs   (   73.37 ms per token,    13.63 tokens per second)
llama_print_timings:       total time =    2418.25 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If \(p\) is a prime number, then \(p\) has exactly two distinct positive divisors: 1 and \(p\).

**True or False?
llama_print_timings:        load time =     159.49 ms
llama_print_timings:      sample time =       5.35 ms /    32 runs   (    0.17 ms per token,  5982.43 tokens per second)
llama_print_timings: prompt eval time =      73.70 ms /     2 tokens (   36.85 ms per token,    27.14 tokens per second)
llama_print_timings:        eval time =    2121.13 ms /    31 runs   (   68.42 ms per token,    14.61 tokens per second)
llama_print_timings:       total time =    2256.59 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a little girl named Lily who lived in a cozy village.

One day, Lily decided to explore the nearby forest. As she ventured deeper and
llama_print_timings:        load time =     170.14 ms
llama_print_timings:      sample time =       5.08 ms /    32 runs   (    0.16 ms per token,  6293.02 tokens per second)
llama_print_timings: prompt eval time =     138.03 ms /     5 tokens (   27.61 ms per token,    36.22 tokens per second)
llama_print_timings:        eval time =    2134.78 ms /    31 runs   (   68.86 ms per token,    14.52 tokens per second)
llama_print_timings:       total time =    2335.30 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
**Summary**
Helianthus tuberosus is a herbaceous plant belonging to the family Asteraceae. It is native to South
llama_print_timings:        load time =     164.10 ms
llama_print_timings:      sample time =       5.38 ms /    32 runs   (    0.17 ms per token,  5943.54 tokens per second)
llama_print_timings: prompt eval time =      83.56 ms /     2 tokens (   41.78 ms per token,    23.94 tokens per second)
llama_print_timings:        eval time =    2251.09 ms /    31 runs   (   72.62 ms per token,    13.77 tokens per second)
llama_print_timings:       total time =    2399.44 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heirs, a law firm specializing in complex corporate disputes and shareholder rights, has announced the launch of their new practice area focused on blockchain and cryptocurrency.

**Key
llama_print_timings:        load time =     126.01 ms
llama_print_timings:      sample time =       5.86 ms /    32 runs   (    0.18 ms per token,  5457.96 tokens per second)
llama_print_timings: prompt eval time =      70.54 ms /     2 tokens (   35.27 ms per token,    28.35 tokens per second)
llama_print_timings:        eval time =    1668.28 ms /    31 runs   (   53.82 ms per token,    18.58 tokens per second)
llama_print_timings:       total time =    1803.70 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32152.62 ms
main:    total time = 32152.62 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       5.22 ms /    32 runs   (    0.16 ms per token,  6131.44 tokens per second)
llama_print_timings: prompt eval time =      70.19 ms /     2 tokens (   35.09 ms per token,    28.50 tokens per second)
llama_print_timings:        eval time =    1651.22 ms /    31 runs   (   53.27 ms per token,    18.77 tokens per second)
llama_print_timings:       total time =    1784.14 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     387.91 ms
llama_print_timings:      sample time =       2.77 ms /    64 runs   (    0.04 ms per token, 23079.70 tokens per second)
llama_print_timings: prompt eval time =     313.68 ms /     8 tokens (   39.21 ms per token,    25.50 tokens per second)
llama_print_timings:        eval time =    7536.65 ms /    63 runs   (  119.63 ms per token,     8.36 tokens per second)
llama_print_timings:       total time =    7873.42 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5001.85 ms /   128 tokens (   39.08 ms per token,    25.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5015.36 ms /   129 tokens
...
llama_print_timings:        load time =     317.11 ms
llama_print_timings:      sample time =       2.33 ms /    64 runs   (    0.04 ms per token, 27456.03 tokens per second)
llama_print_timings: prompt eval time =     216.00 ms /     8 tokens (   27.00 ms per token,    37.04 tokens per second)
llama_print_timings:        eval time =    5523.02 ms /    63 runs   (   87.67 ms per token,    11.41 tokens per second)
llama_print_timings:       total time =    5757.80 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2862.47 ms /   128 tokens (   22.36 ms per token,    44.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2876.50 ms /   129 tokens
...
llama_print_timings:        load time =     214.05 ms
llama_print_timings:      sample time =       2.31 ms /    64 runs   (    0.04 ms per token, 27705.63 tokens per second)
llama_print_timings: prompt eval time =     201.92 ms /     8 tokens (   25.24 ms per token,    39.62 tokens per second)
llama_print_timings:        eval time =    4473.16 ms /    63 runs   (   71.00 ms per token,    14.08 tokens per second)
llama_print_timings:       total time =    4693.60 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.338 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.15 seconds per pass - ETA 0.05 minutes
[1]4.1642,
llama_print_timings:        load time =     182.18 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3150.75 ms /   128 tokens (   24.62 ms per token,    40.63 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3164.95 ms /   129 tokens
...
llama_print_timings:      sample time =       2.31 ms /    64 runs   (    0.04 ms per token, 27657.74 tokens per second)
llama_print_timings: prompt eval time =     379.02 ms /     8 tokens (   47.38 ms per token,    21.11 tokens per second)
llama_print_timings:        eval time =    4782.77 ms /    63 runs   (   75.92 ms per token,    13.17 tokens per second)
llama_print_timings:       total time =    5180.43 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5905.86 ms /   128 tokens (   46.14 ms per token,    21.67 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5919.64 ms /   129 tokens
...
I believe the meaning of life is to find our purpose, live it, and inspire others to do the same.
llama_print_timings:        load time =     273.97 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28107.16 tokens per second)
llama_print_timings: prompt eval time =     403.60 ms /     8 tokens (   50.45 ms per token,    19.82 tokens per second)
llama_print_timings:        eval time =    5161.00 ms /    63 runs   (   81.92 ms per token,    12.21 tokens per second)
llama_print_timings:       total time =    5584.46 ms /    71 tokens
Log end
...
[1]4.3207,
llama_print_timings:        load time =     236.40 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6181.24 ms /   128 tokens (   48.29 ms per token,    20.71 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6194.64 ms /   129 tokens
...
I
llama_print_timings:        load time =     280.38 ms
llama_print_timings:      sample time =       2.33 ms /    64 runs   (    0.04 ms per token, 27491.41 tokens per second)
llama_print_timings: prompt eval time =     426.14 ms /     8 tokens (   53.27 ms per token,    18.77 tokens per second)
llama_print_timings:        eval time =    5341.18 ms /    63 runs   (   84.78 ms per token,    11.80 tokens per second)
llama_print_timings:       total time =    5786.70 ms /    71 tokens
Log end
...
[1]4.2617,
llama_print_timings:        load time =     246.26 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6602.08 ms /   128 tokens (   51.58 ms per token,    19.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6615.20 ms /   129 tokens
...
llama_print_timings: prompt eval time =     621.34 ms /     8 tokens (   77.67 ms per token,    12.88 tokens per second)
llama_print_timings:        eval time =    5814.88 ms /    63 runs   (   92.30 ms per token,    10.83 tokens per second)
llama_print_timings:       total time =    6454.88 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9956.60 ms /   128 tokens (   77.79 ms per token,    12.86 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9969.85 ms /   129 tokens
...
llama_print_timings: prompt eval time =     469.92 ms /     8 tokens (   58.74 ms per token,    17.02 tokens per second)
llama_print_timings:        eval time =    5022.57 ms /    63 runs   (   79.72 ms per token,    12.54 tokens per second)
llama_print_timings:       total time =    5512.06 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7478.66 ms /   128 tokens (   58.43 ms per token,    17.12 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7492.34 ms /   129 tokens
...
llama_print_timings:        load time =     259.37 ms
llama_print_timings:      sample time =       2.31 ms /    64 runs   (    0.04 ms per token, 27693.64 tokens per second)
llama_print_timings: prompt eval time =     397.38 ms /     8 tokens (   49.67 ms per token,    20.13 tokens per second)
llama_print_timings:        eval time =    4953.83 ms /    63 runs   (   78.63 ms per token,    12.72 tokens per second)
llama_print_timings:       total time =    5370.82 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6211.81 ms /   128 tokens (   48.53 ms per token,    20.61 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6224.93 ms /   129 tokens
...
llama_print_timings: prompt eval time =     465.38 ms /     8 tokens (   58.17 ms per token,    17.19 tokens per second)
llama_print_timings:        eval time =    5678.44 ms /    63 runs   (   90.13 ms per token,    11.09 tokens per second)
llama_print_timings:       total time =    6163.44 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 0 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 8.313 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 7.34 seconds per pass - ETA 0.12 minutes
[1]4.2379,
llama_print_timings:        load time =     256.28 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7334.32 ms /   128 tokens (   57.30 ms per token,    17.45 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7348.17 ms /   129 tokens
...
llama_print_timings:        load time =     321.37 ms
llama_print_timings:      sample time =       2.30 ms /    64 runs   (    0.04 ms per token, 27850.30 tokens per second)
llama_print_timings: prompt eval time =     527.52 ms /     8 tokens (   65.94 ms per token,    15.17 tokens per second)
llama_print_timings:        eval time =    6331.83 ms /    63 runs   (  100.51 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    6877.84 ms /    71 tokens
Log end
...
[1]4.2523,
llama_print_timings:        load time =     286.39 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8229.65 ms /   128 tokens (   64.29 ms per token,    15.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8243.23 ms /   129 tokens
...
first run: The quick brown fox had a busy day feeding strung beads someone had thrown in its garden
After


second run: The quick brown fox had a busy day feeding strung beads someone had thrown in its garden
After


single seq run: The quick brown fox had a busy day feeding strung beads someone had thrown in its garden
After
...
first run: The quick brown fox jumps over the lazy dog. xxxxx india bhabi ki sexyi photo


second run: The quick brown fox jumps over the lazy dog. xxxxx india bhabi ki sexyi photo


single seq run: The quick brown fox jumps over the lazy dog. xxxxx india bhabi ki sexyi photo
...
0.34user 0.35system 0:00.69elapsed 99%CPU (0avgtext+0avgdata 6880300maxresident)k
0inputs+40outputs (0major+114542minor)pagefaults 0swaps
```
...
0.11user 0.36system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 6879832maxresident)k
0inputs+40outputs (0major+115037minor)pagefaults 0swaps
```
