...
- status:  SUCCESS ✅
- runtime: 341.56
- date:    Sun May 19 19:42:01 EEST 2024
...
Label Time Summary:
main    = 187.84 sec*proc (22 tests)

Total Test time (real) = 187.85 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.54 ms /     9 tokens (    1.17 ms per token,   854.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
