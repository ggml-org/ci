...
- status:  FAILURE ❌ (1)
- runtime: 3:34.28
- date:    Sun May 19 16:40:51 UTC 2024
...
llama_print_timings: prompt eval time =       3.83 ms /     9 tokens (    0.43 ms per token,  2352.94 tokens per second)
...
<bos> Soar is a company dedicated to empowering businesses and individuals to achieve their full potential through personalized coaching, leadership development, and team dynamics workshops.

**Challenges:**


llama_print_timings:        load time =    1242.32 ms
llama_print_timings:      sample time =      47.54 ms /    32 runs   (    1.49 ms per token,   673.19 tokens per second)
llama_print_timings: prompt eval time =    1148.91 ms /     2 tokens (  574.46 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   20923.61 ms /    31 runs   (  674.96 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22255.04 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar! is a comprehensive guide to the application process, eligibility criteria, selection criteria, and benefits of pursuing a scholarship offered by the University of the Philippines Diliman
llama_print_timings:        load time =    1232.64 ms
llama_print_timings:      sample time =      48.00 ms /    32 runs   (    1.50 ms per token,   666.72 tokens per second)
llama_print_timings: prompt eval time =    1178.16 ms /     2 tokens (  589.08 ms per token,     1.70 tokens per second)
llama_print_timings:        eval time =   21331.44 ms /    31 runs   (  688.11 ms per token,     1.45 tokens per second)
llama_print_timings:       total time =   22694.90 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
* Strengthen, break, or maintain relationships with friends, family, and romantic
...
llama_print_timings: prompt eval time =    1155.24 ms /     2 tokens (  577.62 ms per token,     1.73 tokens per second)
llama_print_timings:        eval time =   21105.94 ms /    31 runs   (  680.84 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22444.76 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Witcher Season 2: A Look at the Future

**The Hype is On:**

The Witcher Season 2 is generating significant buzz, with anticipation building for
...
llama_print_timings: prompt eval time =    1147.97 ms /     2 tokens (  573.99 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21118.38 ms /    31 runs   (  681.24 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22450.65 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
usage: /home/ggml/work/llama.cpp/build-ci-debug/bin/quantize [--help] [--allow-requantize] [--leave-output-tensor] [--pure] [--imatrix] [--include-weights] [--exclude-weights] [--output-tensor-type] [--token-embedding-type] [--override-kv] model-f32.gguf [model-quant.gguf] type [nthreads]
