...
- status:  SUCCESS ✅
- runtime: 807.93
- date:    Tue Nov 26 03:43:50 PST 2024
...
0.00.085.550 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.126.029 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.054.690 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.091.079 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.033.372 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.060.684 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.059.968 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.026.432 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.052.987 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.600 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.053.411 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.544 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.862 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.023.417 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.051.928 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.023.601 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.052.486 I llm_load_print_meta: LF token         = 128 'Ä'
