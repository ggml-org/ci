...
- status:  SUCCESS ✅
- runtime: 18:38.39
- date:    Mon May 20 06:53:18 UTC 2024
...
<bos> If the marginal cost is increasing, then the total cost is also increasing.
...
llama_print_timings:        load time =    1236.96 ms
llama_print_timings:      sample time =      47.37 ms /    32 runs   (    1.48 ms per token,   675.60 tokens per second)
llama_print_timings: prompt eval time =    1145.09 ms /     2 tokens (  572.54 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   20953.80 ms /    31 runs   (  675.93 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22281.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekoul, a renowned professor at a prestigious university, grapples with a profound crisis of conscience. Torn between his unwavering academic integrity and the mounting societal pressures surrounding
...
llama_print_timings: prompt eval time =    1146.68 ms /     2 tokens (  573.34 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21283.34 ms /    31 runs   (  686.56 ms per token,     1.46 tokens per second)
llama_print_timings:       total time =   22615.39 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a young girl named Anya who dreamt of becoming an astronaut.

Anya spent countless hours studying astronomy and space exploration. She devoured books and articles
...
llama_print_timings: prompt eval time =    2602.06 ms /     5 tokens (  520.41 ms per token,     1.92 tokens per second)
llama_print_timings:        eval time =   20869.78 ms /    31 runs   (  673.22 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   23655.47 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =    1143.73 ms /     2 tokens (  571.86 ms per token,     1.75 tokens per second)
llama_print_timings:        eval time =   21019.75 ms /    31 runs   (  678.06 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22347.37 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197219.53 ms
main:    total time = 197219.53 ms
+ echo PASS
PASS
+ echo
...
<bos> The Simpsons is an American animated sitcom created by Matt Groening. The show follows the lives of the Simpson family, a dysfunctional but lovable group of individuals living in the
llama_print_timings:        load time =     624.92 ms
llama_print_timings:      sample time =      47.75 ms /    32 runs   (    1.49 ms per token,   670.20 tokens per second)
llama_print_timings: prompt eval time =     566.11 ms /     2 tokens (  283.05 ms per token,     3.53 tokens per second)
llama_print_timings:        eval time =   10478.21 ms /    31 runs   (  338.01 ms per token,     2.96 tokens per second)
llama_print_timings:       total time =   11228.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 196939.55 ms
main:    total time = 196939.55 ms
+ echo PASS
PASS
+ echo
...
**Verse 1**
Sunrise peekin', clouds are light,
Birds are chirpin', a beautiful sight.
Sun is risin
...
llama_print_timings: prompt eval time =     567.55 ms /     2 tokens (  283.78 ms per token,     3.52 tokens per second)
llama_print_timings:        eval time =   10512.29 ms /    31 runs   (  339.11 ms per token,     2.95 tokens per second)
llama_print_timings:       total time =   11260.72 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heiss Elementary School in Aurora, Illinois, proudly stands as a beacon of educational excellence within the community.

**Our Mission:**

To empower all students to reach
...
llama_print_timings:        eval time =    2161.08 ms /    31 runs   (   69.71 ms per token,    14.34 tokens per second)
llama_print_timings:       total time =    2308.42 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say the early bird gets the worm, but in this case, it seems the early bird got the blame.

The controversy erupted when a group of students at
...
llama_print_timings:        eval time =    2014.88 ms /    31 runs   (   65.00 ms per token,    15.39 tokens per second)
llama_print_timings:       total time =    2158.68 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Soar is a company that provides online training and coaching.

**Mission:**

To empower individuals and organizations to achieve their full potential by providing accessible, engaging,
...
llama_print_timings: prompt eval time =      77.71 ms /     2 tokens (   38.86 ms per token,    25.74 tokens per second)
llama_print_timings:        eval time =    2080.62 ms /    31 runs   (   67.12 ms per token,    14.90 tokens per second)
llama_print_timings:       total time =    2226.37 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
The Big Short is a nonfiction book that tells the story of the 2008 financial crisis through the perspectives of investors, bankers,
...
llama_print_timings:        eval time =    2174.03 ms /    31 runs   (   70.13 ms per token,    14.26 tokens per second)
llama_print_timings:       total time =    2319.77 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32012.07 ms
main:    total time = 32012.07 ms
+ echo PASS
PASS
+ echo
...
<bos> Heuristics: An overview

**What are Heuristics?**

Heuristics are mental shortcuts or rules of thumb that people use to make decisions,
...
llama_print_timings: prompt eval time =      65.68 ms /     2 tokens (   32.84 ms per token,    30.45 tokens per second)
llama_print_timings:        eval time =    1516.71 ms /    31 runs   (   48.93 ms per token,    20.44 tokens per second)
llama_print_timings:       total time =    1651.53 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32048.32 ms
main:    total time = 32048.32 ms
+ echo PASS
PASS
+ echo
...
Get Together Edition brings the social interaction and relationships of The Sims 4 to life. Players can now
...
llama_print_timings: prompt eval time =      67.48 ms /     2 tokens (   33.74 ms per token,    29.64 tokens per second)
llama_print_timings:        eval time =    1519.48 ms /    31 runs   (   49.02 ms per token,    20.40 tokens per second)
llama_print_timings:       total time =    1654.95 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     393.66 ms
llama_print_timings:      sample time =       2.34 ms /    64 runs   (    0.04 ms per token, 27303.75 tokens per second)
llama_print_timings: prompt eval time =     300.04 ms /     8 tokens (   37.51 ms per token,    26.66 tokens per second)
llama_print_timings:        eval time =    7292.79 ms /    63 runs   (  115.76 ms per token,     8.64 tokens per second)
llama_print_timings:       total time =    7615.55 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4675.24 ms /   128 tokens (   36.53 ms per token,    27.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4688.44 ms /   129 tokens
...
llama_print_timings:        eval time =    5358.28 ms /    63 runs   (   85.05 ms per token,    11.76 tokens per second)
llama_print_timings:       total time =    5584.75 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2828.49 ms /   128 tokens (   22.10 ms per token,    45.25 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2841.01 ms /   129 tokens
...
llama_print_timings: prompt eval time =     206.05 ms /     8 tokens (   25.76 ms per token,    38.83 tokens per second)
llama_print_timings:        eval time =    4327.11 ms /    63 runs   (   68.68 ms per token,    14.56 tokens per second)
llama_print_timings:       total time =    4552.70 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3114.24 ms /   128 tokens (   24.33 ms per token,    41.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3127.39 ms /   129 tokens
...
llama_print_timings: prompt eval time =     375.10 ms /     8 tokens (   46.89 ms per token,    21.33 tokens per second)
llama_print_timings:        eval time =    4578.70 ms /    63 runs   (   72.68 ms per token,    13.76 tokens per second)
llama_print_timings:       total time =    4973.72 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5843.27 ms /   128 tokens (   45.65 ms per token,    21.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5856.46 ms /   129 tokens
...
llama_print_timings:       total time =    5409.69 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6239.91 ms /   128 tokens (   48.75 ms per token,    20.51 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6253.79 ms /   129 tokens
...
llama_print_timings: prompt eval time =     422.75 ms /     8 tokens (   52.84 ms per token,    18.92 tokens per second)
llama_print_timings:        eval time =    5257.19 ms /    63 runs   (   83.45 ms per token,    11.98 tokens per second)
llama_print_timings:       total time =    5699.69 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6554.04 ms /   128 tokens (   51.20 ms per token,    19.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6567.06 ms /   129 tokens
...
llama_print_timings: prompt eval time =     615.56 ms /     8 tokens (   76.95 ms per token,    13.00 tokens per second)
llama_print_timings:        eval time =    5784.09 ms /    63 runs   (   91.81 ms per token,    10.89 tokens per second)
llama_print_timings:       total time =    6419.05 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9898.57 ms /   128 tokens (   77.33 ms per token,    12.93 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9911.96 ms /   129 tokens
...
llama_print_timings:        eval time =    4922.08 ms /    63 runs   (   78.13 ms per token,    12.80 tokens per second)
llama_print_timings:       total time =    5407.33 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7424.34 ms /   128 tokens (   58.00 ms per token,    17.24 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7437.14 ms /   129 tokens
...
llama_print_timings:        eval time =    4795.31 ms /    63 runs   (   76.12 ms per token,    13.14 tokens per second)
llama_print_timings:       total time =    5205.96 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6142.02 ms /   128 tokens (   47.98 ms per token,    20.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6155.54 ms /   129 tokens
...
llama_print_timings: prompt eval time =     467.51 ms /     8 tokens (   58.44 ms per token,    17.11 tokens per second)
llama_print_timings:        eval time =    5573.56 ms /    63 runs   (   88.47 ms per token,    11.30 tokens per second)
llama_print_timings:       total time =    6060.43 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7213.06 ms /   128 tokens (   56.35 ms per token,    17.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7226.29 ms /   129 tokens
...
llama_print_timings: prompt eval time =     519.75 ms /     8 tokens (   64.97 ms per token,    15.39 tokens per second)
llama_print_timings:        eval time =    6176.01 ms /    63 runs   (   98.03 ms per token,    10.20 tokens per second)
llama_print_timings:       total time =    6715.23 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8129.19 ms /   128 tokens (   63.51 ms per token,    15.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8142.06 ms /   129 tokens
...
0.34user 0.34system 0:00.68elapsed 99%CPU (0avgtext+0avgdata 6880356maxresident)k
...
0.12user 0.34system 0:00.47elapsed 99%CPU (0avgtext+0avgdata 6879772maxresident)k
