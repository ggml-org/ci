...
- status:  SUCCESS ✅
- runtime: 835.47
- date:    Mon Dec 16 11:12:42 PST 2024
...
0.00.059.882 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.095.055 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.031.828 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.059.921 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.061.639 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.040.002 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.052.176 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.046.113 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.097.668 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.050.305 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.033.159 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.061.798 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.023.943 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,50009]   = ["Ġ Ġ", "Ġ t", "Ġ a", "h e", "i n...
...
0.00.051.060 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.051.848 I llm_load_print_meta: LF token         = 128 'Ä'
...
0.00.049.925 I llm_load_print_meta: LF token         = 128 'Ä'
