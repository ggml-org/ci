...
- status:  FAILURE ❌ (8)
- runtime: 8:42.25
- date:    Fri Jun  7 02:25:24 UTC 2024
...
20/22 Test #20: test-backend-ops .................***Failed  206.03 sec
...
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[MUL_MAT] NMSE = 0.000708315 > 0.000500000 ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
ggml_backend_cuda_graph_compute: disabling CUDA graphs due to GPU architecture
[1;31mFAIL[0m
...
Label Time Summary:
main    = 273.72 sec*proc (22 tests)

Total Test time (real) = 273.73 sec
