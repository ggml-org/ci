...
- status:  SUCCESS ✅
- runtime: 508.85
- date:    Wed Apr 24 10:08:18 EEST 2024
...
Label Time Summary:
main    = 195.85 sec*proc (23 tests)

Total Test time (real) = 195.86 sec
...
llama_print_timings:        load time =      53.02 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.31 ms /     9 tokens (    1.26 ms per token,   795.40 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Shekhs are a powerful and ancient group with a rich history. They have played a significant role in shaping the political landscape of the Middle East and North Africa.
llama_print_timings:        load time =    2649.09 ms
llama_print_timings:      sample time =      58.80 ms /    32 runs   (    1.84 ms per token,   544.25 tokens per second)
llama_print_timings: prompt eval time =     196.07 ms /     2 tokens (   98.03 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1497.41 ms /    31 runs   (   48.30 ms per token,    20.70 tokens per second)
...
<bos> Once upon a time, in a bustling city, there lived a young woman named Anya. Driven by ambition, she embarked on a journey to pursue her dreams.

As Anya ventured
llama_print_timings:        load time =    3279.91 ms
llama_print_timings:      sample time =      57.91 ms /    32 runs   (    1.81 ms per token,   552.60 tokens per second)
llama_print_timings: prompt eval time =     206.09 ms /     5 tokens (   41.22 ms per token,    24.26 tokens per second)
llama_print_timings:        eval time =    1504.44 ms /    31 runs   (   48.53 ms per token,    20.61 tokens per second)
llama_print_timings:       total time =    2542.61 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say opposites attract, and the same could be said about the clash of contrasting styles in fashion. But while some pairings work flawlessly, others end up clashing,
llama_print_timings:        load time =    2668.57 ms
llama_print_timings:      sample time =      58.72 ms /    32 runs   (    1.83 ms per token,   544.96 tokens per second)
llama_print_timings: prompt eval time =     196.85 ms /     2 tokens (   98.42 ms per token,    10.16 tokens per second)
llama_print_timings:        eval time =    1497.58 ms /    31 runs   (   48.31 ms per token,    20.70 tokens per second)
llama_print_timings:       total time =    2530.78 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If x is a variable representing an integer, then the expression 3x + 5 is an integer as well.

True
False<eos> [end of text]

llama_print_timings:        load time =    1900.02 ms
llama_print_timings:      sample time =      14.21 ms /    28 runs   (    0.51 ms per token,  1970.86 tokens per second)
llama_print_timings: prompt eval time =     195.51 ms /     2 tokens (   97.75 ms per token,    10.23 tokens per second)
llama_print_timings:        eval time =    1326.36 ms /    27 runs   (   49.12 ms per token,    20.36 tokens per second)
llama_print_timings:       total time =    1601.49 ms /    29 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2973.01 ms
llama_print_timings:      sample time =      16.05 ms /    32 runs   (    0.50 ms per token,  1994.02 tokens per second)
llama_print_timings: prompt eval time =     201.04 ms /     2 tokens (  100.52 ms per token,     9.95 tokens per second)
llama_print_timings:        eval time =    1517.95 ms /    31 runs   (   48.97 ms per token,    20.42 tokens per second)
llama_print_timings:       total time =    1808.82 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Heirs is a family drama television series that explores the complex dynamics of a wealthy family and the power struggles that ensue.

**Characters:**

* **The Spencer
llama_print_timings:        load time =    2737.02 ms
llama_print_timings:      sample time =      16.58 ms /    32 runs   (    0.52 ms per token,  1930.15 tokens per second)
llama_print_timings: prompt eval time =     194.90 ms /     2 tokens (   97.45 ms per token,    10.26 tokens per second)
llama_print_timings:        eval time =    1526.41 ms /    31 runs   (   49.24 ms per token,    20.31 tokens per second)
llama_print_timings:       total time =    1813.56 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
