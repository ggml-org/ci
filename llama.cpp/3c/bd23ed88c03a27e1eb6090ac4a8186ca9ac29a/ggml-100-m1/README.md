...
- status:  SUCCESS ✅
- runtime: 339.94
- date:    Sat May 25 12:35:25 EEST 2024
...
Label Time Summary:
main    = 183.84 sec*proc (22 tests)

Total Test time (real) = 183.85 sec
...
llama_print_timings:       total time =      12.54 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.46 ms /     9 tokens (    1.27 ms per token,   785.68 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
