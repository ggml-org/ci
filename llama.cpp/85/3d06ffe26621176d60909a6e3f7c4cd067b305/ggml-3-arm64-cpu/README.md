...
- status:  SUCCESS ✅
- runtime: 19:13.71
- date:    Thu Apr 25 14:39:16 UTC 2024
...
Label Time Summary:
main    = 103.28 sec*proc (23 tests)

Total Test time (real) = 103.29 sec
...
llama_print_timings:       total time =      78.77 ms /    10 tokens
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      75.03 ms /    10 tokens
...
<bos> After implementing the new policy, the organization's employees noticed a significant decrease in their motivation and productivity.

**What could be the underlying causes of this decline in
llama_print_timings:        load time =    3744.62 ms
llama_print_timings:      sample time =      41.61 ms /    32 runs   (    1.30 ms per token,   769.01 tokens per second)
llama_print_timings: prompt eval time =    2743.84 ms /     2 tokens ( 1371.92 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   49001.61 ms /    31 runs   ( 1580.70 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   51905.13 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Sims 4 has a variety of interactions that allow players to interact with their neighbors, but there are some interactions that are particularly unique to this game.

**
llama_print_timings:        load time =    3740.19 ms
llama_print_timings:      sample time =      41.46 ms /    32 runs   (    1.30 ms per token,   771.77 tokens per second)
llama_print_timings: prompt eval time =    2746.41 ms /     2 tokens ( 1373.21 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   49006.50 ms /    31 runs   ( 1580.85 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   51908.97 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When I perform a test of a function and it passes, is it safe to assume that the function is working correctly?

While this may seem like a straightforward question
llama_print_timings:        load time =    3742.40 ms
llama_print_timings:      sample time =      41.62 ms /    32 runs   (    1.30 ms per token,   768.94 tokens per second)
llama_print_timings: prompt eval time =    2745.86 ms /     2 tokens ( 1372.93 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   48994.30 ms /    31 runs   ( 1580.46 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   51896.28 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the joint probability density function of two random variables X and Y is given by $$f(x,y) = \begin{cases} 2xy &
llama_print_timings:        load time =    1166.33 ms
llama_print_timings:      sample time =       8.09 ms /    32 runs   (    0.25 ms per token,  3956.48 tokens per second)
...
llama_print_timings:       total time =    3327.17 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When You Choose to Fight Back

**Introduction**

Choosing to fight back can be a complex and daunting decision. It requires careful consideration of the potential consequences, the
llama_print_timings:        load time =    1176.29 ms
llama_print_timings:      sample time =       8.10 ms /    32 runs   (    0.25 ms per token,  3948.67 tokens per second)
llama_print_timings: prompt eval time =     166.81 ms /     2 tokens (   83.40 ms per token,    11.99 tokens per second)
llama_print_timings:        eval time =    3130.68 ms /    31 runs   (  100.99 ms per token,     9.90 tokens per second)
llama_print_timings:       total time =    3338.37 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
This campaign focuses on inspiring and encouraging individuals to pursue their dreams and aspirations. Through storytelling, social media engagement, and interactive
llama_print_timings:        load time =    1168.64 ms
llama_print_timings:      sample time =       8.21 ms /    32 runs   (    0.26 ms per token,  3898.64 tokens per second)
llama_print_timings: prompt eval time =     165.03 ms /     2 tokens (   82.52 ms per token,    12.12 tokens per second)
llama_print_timings:        eval time =    3106.07 ms /    31 runs   (  100.20 ms per token,     9.98 tokens per second)
llama_print_timings:       total time =    3312.49 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 25816.73 ms
main:    total time = 25816.73 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a mystical realm called Fantasia, there lived a curious alchemist named Balthazar. Balthazar possessed a passion for experimenting with strange and unusual ingredients, often pushing
llama_print_timings:        load time =     778.60 ms
llama_print_timings:      sample time =       7.69 ms /    32 runs   (    0.24 ms per token,  4159.63 tokens per second)
llama_print_timings: prompt eval time =     340.07 ms /     5 tokens (   68.01 ms per token,    14.70 tokens per second)
llama_print_timings:        eval time =    2939.20 ms /    31 runs   (   94.81 ms per token,    10.55 tokens per second)
llama_print_timings:       total time =    3319.99 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26032.08 ms
main:    total time = 26032.08 ms
+ echo PASS
PASS
+ echo
...
<bos> If the population of the earth is approximately 8 billion people, and the global GDP is approximately $25 trillion, what percentage of the global GDP is contributed by
...
llama_print_timings: prompt eval time =     155.74 ms /     2 tokens (   77.87 ms per token,    12.84 tokens per second)
llama_print_timings:        eval time =    2905.88 ms /    31 runs   (   93.74 ms per token,    10.67 tokens per second)
llama_print_timings:       total time =    3101.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    2769.51 ms
llama_print_timings:      sample time =       2.64 ms /    64 runs   (    0.04 ms per token, 24233.24 tokens per second)
llama_print_timings: prompt eval time =    1123.09 ms /     8 tokens (  140.39 ms per token,     7.12 tokens per second)
llama_print_timings:        eval time =   14209.59 ms /    63 runs   (  225.55 ms per token,     4.43 tokens per second)
llama_print_timings:       total time =   15346.78 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22289.27 ms /   128 tokens (  174.13 ms per token,     5.74 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22301.64 ms /   129 tokens
...
llama_print_timings:        load time =    1569.48 ms
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14316.05 ms /   128 tokens (  111.84 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14327.31 ms /   129 tokens
...
llama_print_timings:        eval time =    7908.70 ms /    63 runs   (  125.53 ms per token,     7.97 tokens per second)
llama_print_timings:       total time =    8831.36 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14917.11 ms /   128 tokens (  116.54 ms per token,     8.58 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14929.09 ms /   129 tokens
...
llama_print_timings:        load time =    1144.57 ms
...
llama_print_timings:        eval time =    8396.96 ms /    63 runs   (  133.29 ms per token,     7.50 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15854.17 ms /   128 tokens (  123.86 ms per token,     8.07 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15866.01 ms /   129 tokens
...
llama_print_timings:        load time =    1273.29 ms
...
llama_print_timings:        eval time =   10509.04 ms /    63 runs   (  166.81 ms per token,     5.99 tokens per second)
llama_print_timings:       total time =   11729.42 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20208.98 ms /   128 tokens (  157.88 ms per token,     6.33 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20221.21 ms /   129 tokens
...
llama_print_timings:        eval time =   11030.88 ms /    63 runs   (  175.09 ms per token,     5.71 tokens per second)
llama_print_timings:       total time =   12275.74 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20058.46 ms /   128 tokens (  156.71 ms per token,     6.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20070.53 ms /   129 tokens
...
llama_print_timings:        eval time =    9780.09 ms /    63 runs   (  155.24 ms per token,     6.44 tokens per second)
llama_print_timings:       total time =   10941.29 ms /    71 tokens
Log end
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18727.68 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1079.88 ms /     8 tokens (  134.98 ms per token,     7.41 tokens per second)
llama_print_timings:        eval time =    9340.70 ms /    63 runs   (  148.27 ms per token,     6.74 tokens per second)
llama_print_timings:       total time =   10433.98 ms /    71 tokens
Log end
...
[1]4.4094,
llama_print_timings:        load time =     983.83 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17749.28 ms /   128 tokens (  138.67 ms per token,     7.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17761.41 ms /   129 tokens
...
llama_print_timings:        load time =    1116.89 ms
llama_print_timings:      sample time =       2.88 ms /    64 runs   (    0.05 ms per token, 22214.51 tokens per second)
llama_print_timings: prompt eval time =     954.22 ms /     8 tokens (  119.28 ms per token,     8.38 tokens per second)
llama_print_timings:        eval time =    8365.36 ms /    63 runs   (  132.78 ms per token,     7.53 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15628.75 ms /   128 tokens (  122.10 ms per token,     8.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15640.30 ms /   129 tokens
...
llama_print_timings:        load time =    1370.15 ms
llama_print_timings:      sample time =       2.69 ms /    64 runs   (    0.04 ms per token, 23836.13 tokens per second)
llama_print_timings: prompt eval time =    1309.81 ms /     8 tokens (  163.73 ms per token,     6.11 tokens per second)
llama_print_timings:        eval time =   11168.62 ms /    63 runs   (  177.28 ms per token,     5.64 tokens per second)
llama_print_timings:       total time =   12492.69 ms /    71 tokens
Log end
...
[1]4.2277,
llama_print_timings:        load time =    1266.05 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21453.66 ms /   128 tokens (  167.61 ms per token,     5.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21465.61 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1345.53 ms /     8 tokens (  168.19 ms per token,     5.95 tokens per second)
llama_print_timings:        eval time =   11477.01 ms /    63 runs   (  182.17 ms per token,     5.49 tokens per second)
llama_print_timings:       total time =   12835.62 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21980.01 ms /   128 tokens (  171.72 ms per token,     5.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21992.01 ms /   129 tokens
...
first run: The quick brown fox japanese tale "that kaloku bhojpurico". Blood slots


second run: The quick brown fox japanese tale "that kaloku bhojpurico". Blood slots


single seq run: The quick brown fox japanese tale "that kaloku bhojpurico". Blood slots
...
[1]9.1008,
llama_print_timings:        load time =    2743.57 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22369.38 ms /   128 tokens (  174.76 ms per token,     5.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22436.87 ms /   129 tokens
...
[1]7.0171,
llama_print_timings:        load time =    6940.96 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22267.62 ms /   128 tokens (  173.97 ms per token,     5.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22331.14 ms /   129 tokens
...
perplexity: 14.31 seconds per pass - ETA 0.23 minutes
[1]6.9493,
llama_print_timings:        load time =    5437.27 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14310.40 ms /   128 tokens (  111.80 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14373.70 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 72.736 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.31 seconds per pass - ETA 0.23 minutes
[1]7.0116,
llama_print_timings:        load time =    6101.16 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14308.19 ms /   128 tokens (  111.78 ms per token,     8.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14383.05 ms /   129 tokens
...
0.36user 2.98system 0:03.35elapsed 100%CPU (0avgtext+0avgdata 6877624maxresident)k
0inputs+56outputs (0major+153650minor)pagefaults 0swaps
```
...
0.12user 2.96system 0:03.09elapsed 100%CPU (0avgtext+0avgdata 6877296maxresident)k
