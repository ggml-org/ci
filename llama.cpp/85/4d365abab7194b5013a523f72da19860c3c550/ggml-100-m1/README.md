...
- status:  SUCCESS ✅
- runtime: 341.98
- date:    Sun May 19 11:06:14 EEST 2024
...
Label Time Summary:
main    = 183.90 sec*proc (22 tests)

Total Test time (real) = 183.91 sec
...
llama_print_timings:        load time =      63.61 ms
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      10.51 ms /     9 tokens (    1.17 ms per token,   856.08 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
