...
- status:  SUCCESS ✅
- runtime: 305.33
- date:    Fri May 10 17:57:58 EEST 2024
...
20/22 Test #20: test-backend-ops .................   Passed  102.25 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 164.95 sec*proc (22 tests)

Total Test time (real) = 164.96 sec
...
llama_print_timings:       total time =      33.30 ms /    10 tokens
...
llama_print_timings:        load time =      57.26 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.76 ms /     9 tokens (    1.42 ms per token,   705.38 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
