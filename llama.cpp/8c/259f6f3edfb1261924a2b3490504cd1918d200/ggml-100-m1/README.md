...
- status:  SUCCESS ✅
- runtime: 3354.42
- date:    Thu Apr 25 14:56:39 EEST 2024
...
10/23 Test #10: test-tokenizer-1-aquila .............   Passed    8.92 sec
...
13/23 Test #13: test-tokenizer-1-gpt-neox ...........   Passed    5.21 sec
...
Label Time Summary:
main    = 196.05 sec*proc (23 tests)

Total Test time (real) = 196.06 sec
...
llama_print_timings:        load time =      61.94 ms
...
llama_print_timings:       total time =      34.52 ms /    10 tokens
...
llama_print_timings:        load time =      49.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> If a company has a market share of 20%, it means that:
a) It has a very low market share
b) It has a significant
llama_print_timings:        load time =    2596.54 ms
llama_print_timings:      sample time =      57.88 ms /    32 runs   (    1.81 ms per token,   552.83 tokens per second)
llama_print_timings: prompt eval time =     196.62 ms /     2 tokens (   98.31 ms per token,    10.17 tokens per second)
llama_print_timings:        eval time =    1497.16 ms /    31 runs   (   48.30 ms per token,    20.71 tokens per second)
llama_print_timings:       total time =    2503.44 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If the following conditions are satisfied:
$$|a_n| \le 1 \text{ for all } n\text{ and } \sum\
llama_print_timings:        load time =    2754.39 ms
llama_print_timings:      sample time =      58.17 ms /    32 runs   (    1.82 ms per token,   550.12 tokens per second)
llama_print_timings: prompt eval time =     203.26 ms /     2 tokens (  101.63 ms per token,     9.84 tokens per second)
llama_print_timings:        eval time =    1505.15 ms /    31 runs   (   48.55 ms per token,    20.60 tokens per second)
llama_print_timings:       total time =    2559.67 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
Greetings from Soar! Soar is your one-stop platform for all things aviation, offering comprehensive information and
llama_print_timings:        load time =    2669.85 ms
llama_print_timings:      sample time =      57.43 ms /    32 runs   (    1.79 ms per token,   557.20 tokens per second)
llama_print_timings: prompt eval time =     197.33 ms /     2 tokens (   98.67 ms per token,    10.14 tokens per second)
llama_print_timings:        eval time =    1499.19 ms /    31 runs   (   48.36 ms per token,    20.68 tokens per second)
llama_print_timings:       total time =    2519.60 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 196691.93 ms
main:    total time = 196691.93 ms
+ echo PASS
PASS
+ echo
...
# Check the
llama_print_timings:        load time =    1559.65 ms
llama_print_timings:      sample time =      44.84 ms /    32 runs   (    1.40 ms per token,   713.60 tokens per second)
llama_print_timings: prompt eval time =     213.48 ms /     2 tokens (  106.74 ms per token,     9.37 tokens per second)
llama_print_timings:        eval time =    1055.38 ms /    31 runs   (   34.04 ms per token,    29.37 tokens per second)
llama_print_timings:       total time =    1896.72 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 197396.84 ms
main:    total time = 197396.84 ms
+ echo PASS
PASS
+ echo
...
<bos> Shewans are a group of people who believe that the government is secretly controlling the world through a combination of surveillance and propaganda.

Is there any evidence to support
llama_print_timings:        load time =    1727.92 ms
llama_print_timings:      sample time =      45.34 ms /    32 runs   (    1.42 ms per token,   705.86 tokens per second)
llama_print_timings: prompt eval time =     217.55 ms /     2 tokens (  108.77 ms per token,     9.19 tokens per second)
llama_print_timings:        eval time =    1072.97 ms /    31 runs   (   34.61 ms per token,    28.89 tokens per second)
llama_print_timings:       total time =    1931.82 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
# Define
llama_print_timings:        load time =    2020.77 ms
llama_print_timings:      sample time =      16.36 ms /    32 runs   (    0.51 ms per token,  1955.75 tokens per second)
llama_print_timings: prompt eval time =     195.97 ms /     2 tokens (   97.98 ms per token,    10.21 tokens per second)
llama_print_timings:        eval time =    1530.35 ms /    31 runs   (   49.37 ms per token,    20.26 tokens per second)
llama_print_timings:       total time =    1816.26 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After a long day, I'm exhausted. I want to unwind and relieve my stress.

**Stress Relief Activities:**

**1. Mindfulness Meditation:**

llama_print_timings:        load time =    2797.41 ms
...
llama_print_timings:        eval time =    1527.76 ms /    31 runs   (   49.28 ms per token,    20.29 tokens per second)
...
<bos> They say that laughter is the best medicine and I couldn't agree more. Today, I'm feeling stressed and overwhelmed by life's challenges. Laughter has
llama_print_timings:        load time =    2636.38 ms
llama_print_timings:      sample time =      16.44 ms /    32 runs   (    0.51 ms per token,  1946.59 tokens per second)
llama_print_timings: prompt eval time =     198.28 ms /     2 tokens (   99.14 ms per token,    10.09 tokens per second)
llama_print_timings:        eval time =    1511.57 ms /    31 runs   (   48.76 ms per token,    20.51 tokens per second)
llama_print_timings:       total time =    1801.14 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21178.72 ms
main:    total time = 21178.72 ms
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a magical land where dreams intertwined with reality, there lived a curious little girl named Luna.

Luna had a unique gift. Whenever she closed her eyes
llama_print_timings:        load time =    1445.53 ms
llama_print_timings:      sample time =      16.12 ms /    32 runs   (    0.50 ms per token,  1985.48 tokens per second)
llama_print_timings: prompt eval time =     215.85 ms /     5 tokens (   43.17 ms per token,    23.16 tokens per second)
llama_print_timings:        eval time =    1093.04 ms /    31 runs   (   35.26 ms per token,    28.36 tokens per second)
llama_print_timings:       total time =    1397.44 ms /    36 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21539.47 ms
main:    total time = 21539.47 ms
+ echo PASS
PASS
+ echo
...
<bos> Shekoul, an Egyptian-American entrepreneur, is the founder and CEO of AI-powered financial advisory firm, Kredio. Kredio uses AI to
llama_print_timings:        load time =    1564.88 ms
llama_print_timings:      sample time =      16.55 ms /    32 runs   (    0.52 ms per token,  1933.65 tokens per second)
llama_print_timings: prompt eval time =     214.59 ms /     2 tokens (  107.29 ms per token,     9.32 tokens per second)
llama_print_timings:        eval time =    1107.47 ms /    31 runs   (   35.72 ms per token,    27.99 tokens per second)
llama_print_timings:       total time =    1413.32 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
