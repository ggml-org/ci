...
- status:  SUCCESS ✅
- runtime: 21:09.36
- date:    Fri May 10 12:49:25 UTC 2024
...
llama_print_timings: prompt eval time =       4.25 ms /     9 tokens (    0.47 ms per token,  2116.15 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.78 ms /     9 tokens (    0.42 ms per token,  2379.69 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> When Answering The Question:

1. Give a clear and concise response.
2. Stick to the provided topic.
3. Use formal language and maintain a
llama_print_timings:        load time =    1239.73 ms
llama_print_timings:      sample time =      47.64 ms /    32 runs   (    1.49 ms per token,   671.65 tokens per second)
llama_print_timings: prompt eval time =    1149.19 ms /     2 tokens (  574.60 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   20929.29 ms /    31 runs   (  675.14 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22261.57 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekhs of Persia and the Rise of Islam

**Introduction:**

The rise of Islam in Persia has been a pivotal event in the history of the region,
llama_print_timings:        load time =    1235.31 ms
llama_print_timings:      sample time =      47.49 ms /    32 runs   (    1.48 ms per token,   673.78 tokens per second)
llama_print_timings: prompt eval time =    1224.23 ms /     2 tokens (  612.11 ms per token,     1.63 tokens per second)
llama_print_timings:        eval time =   20958.90 ms /    31 runs   (  676.09 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22365.11 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Last Kingdom: Chapter 1 - The Burning Tower.

The Last Kingdom: Chapter 1 is a captivating tale of betrayal, political intrigue, and the struggle
llama_print_timings:        load time =    1227.36 ms
llama_print_timings:      sample time =      47.65 ms /    32 runs   (    1.49 ms per token,   671.54 tokens per second)
llama_print_timings: prompt eval time =    1158.66 ms /     2 tokens (  579.33 ms per token,     1.73 tokens per second)
llama_print_timings:        eval time =   21151.80 ms /    31 runs   (  682.32 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22492.71 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a mystical forest, there lived a wise old owl named Ember.

**Ember the Owl**

Ember the Owl was known for his vast wisdom and
llama_print_timings:        load time =    1224.89 ms
llama_print_timings:      sample time =      47.74 ms /    32 runs   (    1.49 ms per token,   670.23 tokens per second)
llama_print_timings: prompt eval time =    2618.10 ms /     5 tokens (  523.62 ms per token,     1.91 tokens per second)
llama_print_timings:        eval time =   20966.87 ms /    31 runs   (  676.35 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   23767.84 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198372.96 ms
main:    total time = 198372.96 ms
+ echo PASS
PASS
+ echo
...
<bos> Shemmassian College, with its focus on holistic development, welcomes applications from students with a passion for environmental justice and social justice issues.

**Eligibility:**

*
llama_print_timings:        load time =     640.46 ms
llama_print_timings:      sample time =      47.77 ms /    32 runs   (    1.49 ms per token,   669.93 tokens per second)
llama_print_timings: prompt eval time =     585.35 ms /     2 tokens (  292.68 ms per token,     3.42 tokens per second)
llama_print_timings:        eval time =   10728.29 ms /    31 runs   (  346.07 ms per token,     2.89 tokens per second)
llama_print_timings:       total time =   11495.29 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 198283.74 ms
main:    total time = 198283.74 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =      47.39 ms /    32 runs   (    1.48 ms per token,   675.25 tokens per second)
llama_print_timings: prompt eval time =     582.21 ms /     2 tokens (  291.11 ms per token,     3.44 tokens per second)
llama_print_timings:        eval time =   10740.49 ms /    31 runs   (  346.47 ms per token,     2.89 tokens per second)
llama_print_timings:       total time =   11505.50 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =       6.91 ms /    32 runs   (    0.22 ms per token,  4630.97 tokens per second)
llama_print_timings: prompt eval time =      76.81 ms /     2 tokens (   38.40 ms per token,    26.04 tokens per second)
llama_print_timings:        eval time =    2106.06 ms /    31 runs   (   67.94 ms per token,    14.72 tokens per second)
llama_print_timings:       total time =    2252.85 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heigl stars in the ABC sitcom "Doubt."

Can you explain what the passage is about?

The passage is about an ABC sitcom called "Doubt." It
llama_print_timings:        load time =     157.26 ms
llama_print_timings:      sample time =       6.77 ms /    32 runs   (    0.21 ms per token,  4729.53 tokens per second)
llama_print_timings: prompt eval time =      75.88 ms /     2 tokens (   37.94 ms per token,    26.36 tokens per second)
llama_print_timings:        eval time =    2092.22 ms /    31 runs   (   67.49 ms per token,    14.82 tokens per second)
llama_print_timings:       total time =    2235.23 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heider's research on aggression and its effects on social groups has significant implications for understanding and addressing various forms of aggression and oppression in contemporary society.

**Key
llama_print_timings:        load time =     159.96 ms
llama_print_timings:      sample time =       6.50 ms /    32 runs   (    0.20 ms per token,  4920.81 tokens per second)
llama_print_timings: prompt eval time =      83.33 ms /     2 tokens (   41.67 ms per token,    24.00 tokens per second)
llama_print_timings:        eval time =    2107.75 ms /    31 runs   (   67.99 ms per token,    14.71 tokens per second)
llama_print_timings:       total time =    2258.42 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, there was a little girl named Lily who had a very happy and carefree life. She spent her days playing in the park, reading books, and drawing pictures
llama_print_timings:        load time =     162.47 ms
llama_print_timings:      sample time =       7.11 ms /    32 runs   (    0.22 ms per token,  4498.81 tokens per second)
llama_print_timings: prompt eval time =     140.44 ms /     5 tokens (   28.09 ms per token,    35.60 tokens per second)
llama_print_timings:        eval time =    2179.81 ms /    31 runs   (   70.32 ms per token,    14.22 tokens per second)
llama_print_timings:       total time =    2391.14 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32189.25 ms
main:    total time = 32189.25 ms
+ echo PASS
PASS
+ echo
...
# Replace these values with your own API key and URL
...
llama_print_timings: prompt eval time =      67.71 ms /     2 tokens (   33.85 ms per token,    29.54 tokens per second)
llama_print_timings:        eval time =    1637.19 ms /    31 runs   (   52.81 ms per token,    18.93 tokens per second)
llama_print_timings:       total time =    1773.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31987.77 ms
main:    total time = 31987.77 ms
+ echo PASS
PASS
+ echo
...
<bos> Shein, a global online clothing retailer, has faced scrutiny over its labor practices. Shein has been accused of unfair working conditions, inadequate compensation, and poor working
...
llama_print_timings:        eval time =    1633.69 ms /    31 runs   (   52.70 ms per token,    18.98 tokens per second)
llama_print_timings:       total time =    1769.14 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     501.36 ms
llama_print_timings:      sample time =       2.44 ms /    64 runs   (    0.04 ms per token, 26229.51 tokens per second)
llama_print_timings: prompt eval time =     352.25 ms /     8 tokens (   44.03 ms per token,    22.71 tokens per second)
llama_print_timings:        eval time =    8040.93 ms /    63 runs   (  127.63 ms per token,     7.83 tokens per second)
llama_print_timings:       total time =    8417.26 ms /    71 tokens
Log end
...
[1]4.2447,
llama_print_timings:        load time =     475.33 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5130.96 ms /   128 tokens (   40.09 ms per token,    24.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5147.82 ms /   129 tokens
...
llama_print_timings:        load time =     359.59 ms
llama_print_timings:      sample time =       2.04 ms /    64 runs   (    0.03 ms per token, 31418.75 tokens per second)
llama_print_timings: prompt eval time =     227.22 ms /     8 tokens (   28.40 ms per token,    35.21 tokens per second)
llama_print_timings:        eval time =    5707.95 ms /    63 runs   (   90.60 ms per token,    11.04 tokens per second)
llama_print_timings:       total time =    5955.26 ms /    71 tokens
Log end
...
[1]4.2536,
llama_print_timings:        load time =     319.64 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3021.36 ms /   128 tokens (   23.60 ms per token,    42.36 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3037.92 ms /   129 tokens
...
llama_print_timings: prompt eval time =     227.70 ms /     8 tokens (   28.46 ms per token,    35.13 tokens per second)
llama_print_timings:        eval time =    4611.62 ms /    63 runs   (   73.20 ms per token,    13.66 tokens per second)
llama_print_timings:       total time =    4858.37 ms /    71 tokens
Log end
...
[1]4.1675,
llama_print_timings:        load time =     212.82 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3323.06 ms /   128 tokens (   25.96 ms per token,    38.52 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3340.13 ms /   129 tokens
...
llama_print_timings:        eval time =    4809.64 ms /    63 runs   (   76.34 ms per token,    13.10 tokens per second)
llama_print_timings:       total time =    5223.64 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6038.45 ms /   128 tokens (   47.18 ms per token,    21.20 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6054.86 ms /   129 tokens
...
llama_print_timings:        load time =     283.69 ms
...
llama_print_timings:        eval time =    5455.27 ms /    63 runs   (   86.59 ms per token,    11.55 tokens per second)
llama_print_timings:       total time =    5918.18 ms /    71 tokens
Log end
...
[1]4.3261,
llama_print_timings:        load time =     262.43 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6387.78 ms /   128 tokens (   49.90 ms per token,    20.04 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6404.12 ms /   129 tokens
...
I have a few
llama_print_timings:        load time =     305.45 ms
llama_print_timings:      sample time =       2.06 ms /    64 runs   (    0.03 ms per token, 31037.83 tokens per second)
llama_print_timings: prompt eval time =     444.44 ms /     8 tokens (   55.56 ms per token,    18.00 tokens per second)
llama_print_timings:        eval time =    5705.94 ms /    63 runs   (   90.57 ms per token,    11.04 tokens per second)
llama_print_timings:       total time =    6170.44 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6837.47 ms /   128 tokens (   53.42 ms per token,    18.72 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6853.71 ms /   129 tokens
...
llama_print_timings: prompt eval time =     637.49 ms /     8 tokens (   79.69 ms per token,    12.55 tokens per second)
llama_print_timings:        eval time =    6192.61 ms /    63 runs   (   98.30 ms per token,    10.17 tokens per second)
llama_print_timings:       total time =    6850.45 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   10098.72 ms /   128 tokens (   78.90 ms per token,    12.67 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   10115.06 ms /   129 tokens
...
llama_print_timings: prompt eval time =     488.63 ms /     8 tokens (   61.08 ms per token,    16.37 tokens per second)
llama_print_timings:        eval time =    5393.38 ms /    63 runs   (   85.61 ms per token,    11.68 tokens per second)
llama_print_timings:       total time =    5901.98 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7699.31 ms /   128 tokens (   60.15 ms per token,    16.62 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7716.29 ms /   129 tokens
...
llama_print_timings: prompt eval time =     415.87 ms /     8 tokens (   51.98 ms per token,    19.24 tokens per second)
llama_print_timings:        eval time =    5111.15 ms /    63 runs   (   81.13 ms per token,    12.33 tokens per second)
llama_print_timings:       total time =    5546.12 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6331.95 ms /   128 tokens (   49.47 ms per token,    20.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6348.04 ms /   129 tokens
...
llama_print_timings:        eval time =    6024.56 ms /    63 runs   (   95.63 ms per token,    10.46 tokens per second)
llama_print_timings:       total time =    6528.94 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7536.30 ms /   128 tokens (   58.88 ms per token,    16.98 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7553.11 ms /   129 tokens
...
llama_print_timings: prompt eval time =     550.87 ms /     8 tokens (   68.86 ms per token,    14.52 tokens per second)
llama_print_timings:        eval time =    6564.98 ms /    63 runs   (  104.21 ms per token,     9.60 tokens per second)
llama_print_timings:       total time =    7135.05 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8375.41 ms /   128 tokens (   65.43 ms per token,    15.28 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8391.69 ms /   129 tokens
...
first run: The quick brown fox jumped over the lazy dog, one liam spends less money and everyone.



second run: The quick brown fox jumped over the lazy dog, one liam spends less money and everyone.



single seq run: The quick brown fox jumped over the lazy dog, one liam spends less money and everyone.
...
first run: The quick brown foxes death.
West Midlands
GEDANON - 11


second run: The quick brown foxes death.
West Midlands
GEDANON - 11


single seq run: The quick brown foxes death.
West Midlands
GEDANON - 11
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 46.283 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.12 seconds per pass - ETA 0.08 minutes
[1]9.1034,
llama_print_timings:        load time =     472.28 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5112.42 ms /   128 tokens (   39.94 ms per token,    25.04 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5166.62 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 44.387 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.12 seconds per pass - ETA 0.08 minutes
[1]7.0156,
llama_print_timings:        load time =    4303.10 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5115.47 ms /   128 tokens (   39.96 ms per token,    25.02 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5168.71 ms /   129 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3021.22 ms /   128 tokens (   23.60 ms per token,    42.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3076.61 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 43.012 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.01 seconds per pass - ETA 0.05 minutes
[1]7.0131,
llama_print_timings:        load time =    3101.56 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3004.59 ms /   128 tokens (   23.47 ms per token,    42.60 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 43.439 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 3.03 seconds per pass - ETA 0.05 minutes
[1]7.0336,
llama_print_timings:        load time =    3487.92 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    3021.05 ms /   128 tokens (   23.60 ms per token,    42.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    3072.70 ms /   129 tokens
...
0.34user 0.56system 0:00.90elapsed 100%CPU (0avgtext+0avgdata 6880716maxresident)k
0inputs+40outputs (0major+115256minor)pagefaults 0swaps
```
