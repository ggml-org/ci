...
- status:  SUCCESS ✅
- runtime: 21:34.58
- date:    Thu Apr 18 11:59:49 UTC 2024
...
11/23 Test #11: test-tokenizer-1-mpt ................   Passed    5.23 sec
...
Label Time Summary:
main    = 103.70 sec*proc (23 tests)

Total Test time (real) = 103.71 sec
...
main: build = 2692 (e11b2e6e)
main: built with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for aarch64-linux-gnu
main: seed  = 1713440547
...
llama_print_timings:        load time =      41.29 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      19.29 ms /     9 tokens (    2.14 ms per token,   466.51 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      85.52 ms /    10 tokens
...
llama_print_timings:        load time =    3700.84 ms
llama_print_timings:      sample time =      41.55 ms /    32 runs   (    1.30 ms per token,   770.14 tokens per second)
llama_print_timings: prompt eval time =    2706.35 ms /     2 tokens ( 1353.17 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   48305.56 ms /    31 runs   ( 1558.24 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   51166.95 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there was a little girl named Alice who lived in a quaint village nestled between rolling hills.

**Alice's Adventures**

Alice's days were
llama_print_timings:        load time =    3630.16 ms
llama_print_timings:      sample time =      41.56 ms /    32 runs   (    1.30 ms per token,   769.92 tokens per second)
llama_print_timings: prompt eval time =    6153.10 ms /     5 tokens ( 1230.62 ms per token,     0.81 tokens per second)
llama_print_timings:        eval time =   48242.86 ms /    31 runs   ( 1556.22 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   54550.93 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shekera and his son Shaka are two prominent figures in Zulu mythology.

**a) True**
**b) False** [end of text]

llama_print_timings:        load time =    3648.31 ms
llama_print_timings:      sample time =      36.67 ms /    28 runs   (    1.31 ms per token,   763.50 tokens per second)
llama_print_timings: prompt eval time =    2698.41 ms /     2 tokens ( 1349.20 ms per token,     0.74 tokens per second)
llama_print_timings:        eval time =   41940.39 ms /    27 runs   ( 1553.35 ms per token,     0.64 tokens per second)
llama_print_timings:       total time =   44774.84 ms /    29 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 After the fall of the Berlin Wall, the question of how to dismantle the Soviet Union arose.

**A.** The Cold War powers of the United States and the
...
llama_print_timings:        eval time =    3120.82 ms /    31 runs   (  100.67 ms per token,     9.93 tokens per second)
llama_print_timings:       total time =    3326.82 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, in a hidden valley, lived a curious girl named Anya. Anya possessed a thirst for knowledge and a heart full of imagination.

One day, Anya stumbled
llama_print_timings:        load time =    1103.56 ms
llama_print_timings:      sample time =       7.48 ms /    32 runs   (    0.23 ms per token,  4280.36 tokens per second)
llama_print_timings: prompt eval time =     359.42 ms /     5 tokens (   71.88 ms per token,    13.91 tokens per second)
llama_print_timings:        eval time =    3104.09 ms /    31 runs   (  100.13 ms per token,     9.99 tokens per second)
llama_print_timings:       total time =    3502.86 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 If f(x) = 3x^2 + 2x - 1, find f(-2) and evaluate the limit of f(x)
llama_print_timings:        load time =    1167.85 ms
llama_print_timings:      sample time =       7.72 ms /    32 runs   (    0.24 ms per token,  4146.15 tokens per second)
llama_print_timings: prompt eval time =     165.33 ms /     2 tokens (   82.67 ms per token,    12.10 tokens per second)
llama_print_timings:        eval time =    3116.85 ms /    31 runs   (  100.54 ms per token,     9.95 tokens per second)
llama_print_timings:       total time =    3321.31 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    3339.58 ms
...
llama_print_timings:        eval time =   19829.52 ms /    63 runs   (  314.75 ms per token,     3.18 tokens per second)
llama_print_timings:       total time =   22084.07 ms /    71 tokens
Log end
...
[1]4.2442,
llama_print_timings:        load time =    3127.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36565.92 ms /   128 tokens (  285.67 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36577.81 ms /   129 tokens
...
llama_print_timings:        load time =    1691.98 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23979.02 tokens per second)
llama_print_timings: prompt eval time =     881.56 ms /     8 tokens (  110.20 ms per token,     9.07 tokens per second)
llama_print_timings:        eval time =    8448.75 ms /    63 runs   (  134.11 ms per token,     7.46 tokens per second)
llama_print_timings:       total time =    9344.11 ms /    71 tokens
Log end
...
[1]4.2615,
llama_print_timings:        load time =    1679.26 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14372.11 ms /   128 tokens (  112.28 ms per token,     8.91 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings: prompt eval time =     908.60 ms /     8 tokens (  113.58 ms per token,     8.80 tokens per second)
llama_print_timings:        eval time =    7977.91 ms /    63 runs   (  126.63 ms per token,     7.90 tokens per second)
llama_print_timings:       total time =    8901.17 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14971.01 ms /   128 tokens (  116.96 ms per token,     8.55 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14983.15 ms /   129 tokens
...
llama_print_timings:        load time =    1149.66 ms
...
llama_print_timings:        eval time =    8438.35 ms /    63 runs   (  133.94 ms per token,     7.47 tokens per second)
llama_print_timings:       total time =    9413.19 ms /    71 tokens
Log end
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 10.528 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 15.88 seconds per pass - ETA 0.25 minutes
[1]4.3861,
llama_print_timings:        load time =    1114.03 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15877.68 ms /   128 tokens (  124.04 ms per token,     8.06 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15889.75 ms /   129 tokens
...
llama_print_timings:        load time =    1280.65 ms
llama_print_timings:      sample time =       2.67 ms /    64 runs   (    0.04 ms per token, 23979.02 tokens per second)
llama_print_timings: prompt eval time =    1222.89 ms /     8 tokens (  152.86 ms per token,     6.54 tokens per second)
llama_print_timings:        eval time =   10618.47 ms /    63 runs   (  168.55 ms per token,     5.93 tokens per second)
llama_print_timings:       total time =   11855.15 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   19895.84 ms /   128 tokens (  155.44 ms per token,     6.43 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   19907.63 ms /   129 tokens
...
I believe that love
llama_print_timings:        load time =    1459.56 ms
llama_print_timings:      sample time =       2.63 ms /    64 runs   (    0.04 ms per token, 24297.65 tokens per second)
llama_print_timings: prompt eval time =    1230.74 ms /     8 tokens (  153.84 ms per token,     6.50 tokens per second)
llama_print_timings:        eval time =   10827.30 ms /    63 runs   (  171.86 ms per token,     5.82 tokens per second)
llama_print_timings:       total time =   12071.95 ms /    71 tokens
Log end
...
[1]4.2557,
llama_print_timings:        load time =    1359.98 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20161.52 ms /   128 tokens (  157.51 ms per token,     6.35 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20173.37 ms /   129 tokens
...
llama_print_timings:        eval time =    9827.52 ms /    63 runs   (  155.99 ms per token,     6.41 tokens per second)
llama_print_timings:       total time =   10990.93 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18778.48 ms /   128 tokens (  146.71 ms per token,     6.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18791.42 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1081.33 ms /     8 tokens (  135.17 ms per token,     7.40 tokens per second)
llama_print_timings:        eval time =    9389.30 ms /    63 runs   (  149.04 ms per token,     6.71 tokens per second)
llama_print_timings:       total time =   10484.14 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17815.48 ms /   128 tokens (  139.18 ms per token,     7.18 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17827.58 ms /   129 tokens
...
I
llama_print_timings:        load time =    1150.35 ms
...
llama_print_timings:        eval time =    8396.68 ms /    63 runs   (  133.28 ms per token,     7.50 tokens per second)
llama_print_timings:       total time =    9365.12 ms /    71 tokens
Log end
...
[1]4.1929,
llama_print_timings:        load time =    1133.27 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15692.64 ms /   128 tokens (  122.60 ms per token,     8.16 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15704.37 ms /   129 tokens
...
I believe that you
llama_print_timings:        load time =    1370.41 ms
...
llama_print_timings:        eval time =   11204.97 ms /    63 runs   (  177.86 ms per token,     5.62 tokens per second)
llama_print_timings:       total time =   12528.99 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21491.02 ms /   128 tokens (  167.90 ms per token,     5.96 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21502.31 ms /   129 tokens
...
llama_print_timings:        eval time =   11526.18 ms /    63 runs   (  182.96 ms per token,     5.47 tokens per second)
llama_print_timings:       total time =   12886.13 ms /    71 tokens
Log end
...
[1]4.2451,
llama_print_timings:        load time =    1492.98 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22046.27 ms /   128 tokens (  172.24 ms per token,     5.81 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22058.65 ms /   129 tokens
...
first run: The quick brown fox jumped over the lazy dog soccer shooting game
A great game of Marketing-Sam


second run: The quick brown fox jumped over the lazy dog soccer shooting game
A great game of Marketing-Sam


single seq run: The quick brown fox jumped over the lazy dog soccer shooting game
A great game of Marketing-Sam
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 65.441 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.68 seconds per pass - ETA 0.60 minutes
[1]9.1017,
llama_print_timings:        load time =    3317.80 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36677.59 ms /   128 tokens (  286.54 ms per token,     3.49 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36744.92 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 62.92 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 36.56 seconds per pass - ETA 0.60 minutes
[1]7.0171,
llama_print_timings:        load time =    6354.65 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   36564.26 ms /   128 tokens (  285.66 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   36628.47 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 70.118 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.38 seconds per pass - ETA 0.23 minutes
[1]9.1296,
llama_print_timings:        load time =    1645.80 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14380.99 ms /   128 tokens (  112.35 ms per token,     8.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14452.54 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 65.822 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.37 seconds per pass - ETA 0.23 minutes
[1]6.9856,
llama_print_timings:        load time =    4495.71 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14374.13 ms /   128 tokens (  112.30 ms per token,     8.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14441.48 ms /   129 tokens
...
perplexity: 14.38 seconds per pass - ETA 0.23 minutes
[1]6.9967,
llama_print_timings:        load time =    5185.18 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14379.47 ms /   128 tokens (  112.34 ms per token,     8.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14443.37 ms /   129 tokens
...
0.34user 2.81system 0:03.15elapsed 100%CPU (0avgtext+0avgdata 6877760maxresident)k
