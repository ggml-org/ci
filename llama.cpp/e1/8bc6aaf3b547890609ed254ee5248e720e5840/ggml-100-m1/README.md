...
- status:  SUCCESS ✅
- runtime: 357.41
- date:    Fri May 17 10:09:09 EEST 2024
...
20/22 Test #20: test-backend-ops .................   Passed  120.91 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 183.71 sec*proc (22 tests)

Total Test time (real) = 183.72 sec
...
llama_print_timings: prompt eval time =      10.82 ms /     9 tokens (    1.20 ms per token,   831.56 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.36 ms /     9 tokens (    1.26 ms per token,   792.53 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
