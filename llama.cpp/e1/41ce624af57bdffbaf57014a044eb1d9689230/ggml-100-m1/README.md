...
- status:  SUCCESS ✅
- runtime: 358.66
- date:    Sun Jun  2 00:31:07 EEST 2024
...
llama_print_timings:        load time =      65.75 ms
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.76 ms /     9 tokens (    1.42 ms per token,   705.61 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
