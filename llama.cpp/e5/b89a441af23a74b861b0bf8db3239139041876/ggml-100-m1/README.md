...
- status:  SUCCESS ✅
- runtime: 467.77
- date:    Wed Mar 27 16:13:08 EET 2024
...
20/22 Test #20: test-backend-ops ....................   Passed  109.30 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 211.56 sec*proc (22 tests)

Total Test time (real) = 211.57 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.86 ms /     9 tokens (    1.43 ms per token,   700.12 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
