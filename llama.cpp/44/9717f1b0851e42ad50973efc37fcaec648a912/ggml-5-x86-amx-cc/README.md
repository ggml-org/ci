...
- status:  SUCCESS ✅
- runtime: 4:01.16
- date:    Fri Oct 25 11:31:54 UTC 2024
...
19/28 Test #19: test-sampling .....................   Passed    5.51 sec
...
0.00.000.581 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.004.141 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.004.188 I llama_model_loader: - kv   6:                        bert.context_length u32              = 512
0.00.004.189 I llama_model_loader: - kv   7:                      bert.embedding_length u32              = 384
0.00.004.190 I llama_model_loader: - kv   8:                   bert.feed_forward_length u32              = 1536
0.00.004.190 I llama_model_loader: - kv   9:                  bert.attention.head_count u32              = 12
0.00.004.193 I llama_model_loader: - kv  10:          bert.attention.layer_norm_epsilon f32              = 0.000000
...
0.00.004.213 I llama_model_loader: - kv  13:                          bert.pooling_type u32              = 2
...
0.00.007.353 I llama_model_loader: - kv  17:                      tokenizer.ggml.tokens arr[str,30522]   = ["[PAD]", "[unused0]", "[unused1]", "...
...
0.00.019.341 I llm_load_vocab: special tokens cache size = 5
...
0.00.021.950 I llm_load_print_meta: arch             = bert
...
0.00.021.961 I llm_load_print_meta: n_head           = 12
0.00.021.962 I llm_load_print_meta: n_head_kv        = 12
0.00.021.962 I llm_load_print_meta: n_rot            = 32
0.00.021.962 I llm_load_print_meta: n_swa            = 0
0.00.021.963 I llm_load_print_meta: n_embd_head_k    = 32
0.00.021.963 I llm_load_print_meta: n_embd_head_v    = 32
0.00.021.964 I llm_load_print_meta: n_gqa            = 1
0.00.021.965 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.021.965 I llm_load_print_meta: n_embd_v_gqa     = 384
...
0.00.021.969 I llm_load_print_meta: n_expert_used    = 0
...
0.00.021.979 I llm_load_print_meta: model ftype      = F16
0.00.021.980 I llm_load_print_meta: model params     = 33.21 M
0.00.021.981 I llm_load_print_meta: model size       = 63.84 MiB (16.12 BPW) 
...
0.00.021.999 I llm_load_tensors: ggml ctx size =    0.08 MiB
0.00.024.643 I llm_load_tensors:        CPU buffer size =    63.84 MiB
...............................................
0.00.025.478 I llama_new_context_with_model: n_ctx      = 512
0.00.025.492 I llama_new_context_with_model: n_batch    = 2048
0.00.025.493 I llama_new_context_with_model: n_ubatch   = 2048
0.00.025.493 I llama_new_context_with_model: flash_attn = 0
0.00.025.494 I llama_new_context_with_model: freq_base  = 10000.0
0.00.025.495 I llama_new_context_with_model: freq_scale = 1
...
0.00.029.203 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.029.224 I llama_new_context_with_model: graph nodes  = 429
0.00.029.224 I llama_new_context_with_model: graph splits = 1
0.00.029.226 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.032.748 I 
0.00.032.826 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
...
0.00.038.110 I llama_perf_context_print:        load time =      31.19 ms
0.00.038.112 I llama_perf_context_print: prompt eval time =       3.22 ms /     9 tokens (    0.36 ms per token,  2797.64 tokens per second)
0.00.038.113 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.038.114 I llama_perf_context_print:       total time =       5.35 ms /    10 tokens
...
0.00.000.371 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.003.938 I llama_model_loader: loaded meta data with 25 key-value pairs and 197 tensors from ../models-mnt/bge-small/ggml-model-q8_0.gguf (version GGUF V3 (latest))
0.00.003.964 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.003.970 I llama_model_loader: - kv   0:                       general.architecture str              = bert
...
0.00.007.832 I llama_model_loader: - type q8_0:   73 tensors
0.00.018.404 I llm_load_vocab: special tokens cache size = 5
0.00.020.923 I llm_load_vocab: token to piece cache size = 0.2032 MB
0.00.020.953 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.020.953 I llm_load_print_meta: arch             = bert
0.00.020.955 I llm_load_print_meta: vocab type       = WPM
0.00.020.955 I llm_load_print_meta: n_vocab          = 30522
0.00.020.956 I llm_load_print_meta: n_merges         = 0
0.00.020.956 I llm_load_print_meta: vocab_only       = 0
0.00.020.956 I llm_load_print_meta: n_ctx_train      = 512
...
0.00.020.964 I llm_load_print_meta: n_head_kv        = 12
0.00.020.964 I llm_load_print_meta: n_rot            = 32
...
0.00.020.968 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.020.969 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.020.969 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.020.969 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.020.969 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.020.970 I llm_load_print_meta: n_ff             = 1536
0.00.020.970 I llm_load_print_meta: n_expert         = 0
0.00.020.970 I llm_load_print_meta: n_expert_used    = 0
0.00.020.970 I llm_load_print_meta: causal attn      = 0
0.00.020.971 I llm_load_print_meta: pooling type     = 2
...
0.00.020.975 I llm_load_print_meta: rope_finetuned   = unknown
0.00.020.976 I llm_load_print_meta: ssm_d_conv       = 0
0.00.020.976 I llm_load_print_meta: ssm_d_inner      = 0
0.00.020.976 I llm_load_print_meta: ssm_d_state      = 0
0.00.020.976 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.020.977 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.020.977 I llm_load_print_meta: model type       = 33M
0.00.020.978 I llm_load_print_meta: model ftype      = Q8_0
0.00.020.979 I llm_load_print_meta: model params     = 33.21 M
0.00.020.980 I llm_load_print_meta: model size       = 34.38 MiB (8.68 BPW) 
0.00.020.981 I llm_load_print_meta: general.name     = Bge Small
0.00.020.981 I llm_load_print_meta: UNK token        = 100 '[UNK]'
0.00.020.982 I llm_load_print_meta: SEP token        = 102 '[SEP]'
0.00.020.982 I llm_load_print_meta: PAD token        = 0 '[PAD]'
0.00.020.982 I llm_load_print_meta: CLS token        = 101 '[CLS]'
...
0.00.020.998 I llm_load_tensors: ggml ctx size =    0.08 MiB
0.00.022.723 I llm_load_tensors:        CPU buffer size =    34.38 MiB
.................................................
0.00.023.576 I llama_new_context_with_model: n_ctx      = 512
0.00.023.591 I llama_new_context_with_model: n_batch    = 2048
0.00.023.591 I llama_new_context_with_model: n_ubatch   = 2048
0.00.023.591 I llama_new_context_with_model: flash_attn = 0
0.00.023.593 I llama_new_context_with_model: freq_base  = 10000.0
0.00.023.593 I llama_new_context_with_model: freq_scale = 1
0.00.025.625 I llama_kv_cache_init:        CPU KV buffer size =     9.00 MiB
...
0.00.026.855 I llama_new_context_with_model:        CPU compute buffer size =    16.01 MiB
0.00.026.871 I llama_new_context_with_model: graph nodes  = 429
0.00.026.872 I llama_new_context_with_model: graph splits = 1
0.00.026.873 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.029.456 I 
0.00.029.530 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.031.237 I batch_decode: n_tokens = 9, n_seq = 1
...
0.00.034.185 I llama_perf_context_print:        load time =      28.13 ms
0.00.034.186 I llama_perf_context_print: prompt eval time =       2.62 ms /     9 tokens (    0.29 ms per token,  3429.88 tokens per second)
0.00.034.187 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.034.188 I llama_perf_context_print:       total time =       4.73 ms /    10 tokens
...
0.00.000.556 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.070 I llama_model_loader: loaded meta data with 29 key-value pairs and 70 tensors from ../models-mnt/rerank-tiny/ggml-model-f16.gguf (version GGUF V3 (latest))
0.00.009.089 I llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
0.00.009.098 I llama_model_loader: - kv   0:                       general.architecture str              = jina-bert-v2
0.00.009.098 I llama_model_loader: - kv   1:                               general.type str              = model
0.00.009.099 I llama_model_loader: - kv   2:                               general.name str              = Jina Bert Implementation
0.00.009.100 I llama_model_loader: - kv   3:                       general.organization str              = Jinaai
0.00.009.100 I llama_model_loader: - kv   4:                         general.size_label str              = 33M
0.00.009.103 I llama_model_loader: - kv   5:                   jina-bert-v2.block_count u32              = 4
0.00.009.105 I llama_model_loader: - kv   6:                jina-bert-v2.context_length u32              = 8192
0.00.009.105 I llama_model_loader: - kv   7:              jina-bert-v2.embedding_length u32              = 384
0.00.009.106 I llama_model_loader: - kv   8:           jina-bert-v2.feed_forward_length u32              = 1536
0.00.009.106 I llama_model_loader: - kv   9:          jina-bert-v2.attention.head_count u32              = 12
0.00.009.110 I llama_model_loader: - kv  10:  jina-bert-v2.attention.layer_norm_epsilon f32              = 0.000000
0.00.009.110 I llama_model_loader: - kv  11:                          general.file_type u32              = 1
0.00.009.110 I llama_model_loader: - kv  12:              jina-bert-v2.attention.causal bool             = false
0.00.009.111 I llama_model_loader: - kv  13:                       tokenizer.ggml.model str              = gpt2
0.00.009.111 I llama_model_loader: - kv  14:                         tokenizer.ggml.pre str              = jina-v1-en
...
0.00.019.928 I llama_model_loader: - kv  17:                      tokenizer.ggml.merges arr[str,39382]   = ["t h", "i n", "a n", "e r", "th e", ...
0.00.019.950 I llama_model_loader: - kv  18:                tokenizer.ggml.bos_token_id u32              = 0
0.00.019.950 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 2
0.00.019.951 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 3
0.00.019.951 I llama_model_loader: - kv  21:          tokenizer.ggml.seperator_token_id u32              = 2
0.00.019.952 I llama_model_loader: - kv  22:            tokenizer.ggml.padding_token_id u32              = 1
0.00.019.952 I llama_model_loader: - kv  23:                tokenizer.ggml.cls_token_id u32              = 0
0.00.019.952 I llama_model_loader: - kv  24:               tokenizer.ggml.mask_token_id u32              = 4
0.00.019.953 I llama_model_loader: - kv  25:            tokenizer.ggml.token_type_count u32              = 2
0.00.019.953 I llama_model_loader: - kv  26:               tokenizer.ggml.add_bos_token bool             = true
0.00.019.954 I llama_model_loader: - kv  27:               tokenizer.ggml.add_eos_token bool             = true
0.00.019.954 I llama_model_loader: - kv  28:               general.quantization_version u32              = 2
0.00.019.957 I llama_model_loader: - type  f32:   41 tensors
0.00.019.960 I llama_model_loader: - type  f16:   29 tensors
0.00.037.664 W llm_load_vocab: empty token at index 5
0.00.048.207 W llm_load_vocab: model vocab missing newline token, using special_pad_id instead
0.00.062.089 W llm_load_vocab: special_eos_id is not in special_eog_ids - the tokenizer config may be incorrect
0.00.062.199 I llm_load_vocab: special tokens cache size = 5
0.00.341.598 I llm_load_vocab: token to piece cache size = 1.5060 MB
0.00.341.618 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.341.618 I llm_load_print_meta: arch             = jina-bert-v2
0.00.341.619 I llm_load_print_meta: vocab type       = BPE
0.00.341.619 I llm_load_print_meta: n_vocab          = 61056
0.00.341.620 I llm_load_print_meta: n_merges         = 39382
0.00.341.620 I llm_load_print_meta: vocab_only       = 0
0.00.341.621 I llm_load_print_meta: n_ctx_train      = 8192
0.00.341.621 I llm_load_print_meta: n_embd           = 384
0.00.341.621 I llm_load_print_meta: n_layer          = 4
0.00.341.630 I llm_load_print_meta: n_head           = 12
0.00.341.631 I llm_load_print_meta: n_head_kv        = 12
0.00.341.631 I llm_load_print_meta: n_rot            = 32
0.00.341.631 I llm_load_print_meta: n_swa            = 0
0.00.341.631 I llm_load_print_meta: n_embd_head_k    = 32
0.00.341.631 I llm_load_print_meta: n_embd_head_v    = 32
0.00.341.632 I llm_load_print_meta: n_gqa            = 1
0.00.341.633 I llm_load_print_meta: n_embd_k_gqa     = 384
0.00.341.633 I llm_load_print_meta: n_embd_v_gqa     = 384
0.00.341.635 I llm_load_print_meta: f_norm_eps       = 1.0e-12
0.00.341.635 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.341.636 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.341.636 I llm_load_print_meta: f_max_alibi_bias = 8.0e+00
0.00.341.637 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.341.637 I llm_load_print_meta: n_ff             = 1536
0.00.341.637 I llm_load_print_meta: n_expert         = 0
0.00.341.638 I llm_load_print_meta: n_expert_used    = 0
0.00.341.638 I llm_load_print_meta: causal attn      = 0
0.00.341.638 I llm_load_print_meta: pooling type     = -1
0.00.341.638 I llm_load_print_meta: rope type        = -1
0.00.341.639 I llm_load_print_meta: rope scaling     = linear
0.00.341.640 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.341.640 I llm_load_print_meta: freq_scale_train = 1
0.00.341.641 I llm_load_print_meta: n_ctx_orig_yarn  = 8192
0.00.341.641 I llm_load_print_meta: rope_finetuned   = unknown
0.00.341.641 I llm_load_print_meta: ssm_d_conv       = 0
0.00.341.641 I llm_load_print_meta: ssm_d_inner      = 0
0.00.341.642 I llm_load_print_meta: ssm_d_state      = 0
0.00.341.642 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.341.642 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.341.643 I llm_load_print_meta: model type       = 33M
0.00.341.643 I llm_load_print_meta: model ftype      = F16
0.00.341.644 I llm_load_print_meta: model params     = 32.90 M
0.00.341.645 I llm_load_print_meta: model size       = 62.78 MiB (16.01 BPW) 
0.00.341.645 I llm_load_print_meta: general.name     = Jina Bert Implementation
0.00.341.645 I llm_load_print_meta: BOS token        = 0 '<s>'
0.00.341.646 I llm_load_print_meta: EOS token        = 2 '</s>'
0.00.341.646 I llm_load_print_meta: UNK token        = 3 '<unk>'
0.00.341.646 I llm_load_print_meta: SEP token        = 2 '</s>'
0.00.341.646 I llm_load_print_meta: PAD token        = 1 '<pad>'
0.00.341.647 I llm_load_print_meta: CLS token        = 0 '<s>'
0.00.341.647 I llm_load_print_meta: MASK token       = 4 '<mask>'
0.00.341.647 I llm_load_print_meta: EOG token        = 2 '</s>'
0.00.341.647 I llm_load_print_meta: max token length = 45
0.00.341.664 I llm_load_tensors: ggml ctx size =    0.03 MiB
0.00.344.755 I llm_load_tensors:        CPU buffer size =    62.78 MiB
......................
0.00.346.533 I llama_new_context_with_model: n_ctx      = 8192
0.00.346.555 I llama_new_context_with_model: n_batch    = 2048
0.00.346.555 I llama_new_context_with_model: n_ubatch   = 2048
0.00.346.555 I llama_new_context_with_model: flash_attn = 0
0.00.346.557 I llama_new_context_with_model: freq_base  = 10000.0
0.00.346.558 I llama_new_context_with_model: freq_scale = 1
0.00.355.522 I llama_kv_cache_init:        CPU KV buffer size =    48.00 MiB
0.00.355.548 I llama_new_context_with_model: KV self size  =   48.00 MiB, K (f16):   24.00 MiB, V (f16):   24.00 MiB
0.00.355.556 I llama_new_context_with_model:        CPU  output buffer size =     0.00 MiB
0.00.357.228 I llama_new_context_with_model:        CPU compute buffer size =   220.02 MiB
0.00.357.244 I llama_new_context_with_model: graph nodes  = 154
0.00.357.244 I llama_new_context_with_model: graph splits = 1
0.00.357.246 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.365.311 I 
0.00.365.392 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.365.577 I main: prompt 0: 'what is panda?</s></s>hi'
0.00.365.589 I main: number of tokens in prompt = 9
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.365.594 I main: prompt 1: 'what is panda?</s></s>it's a bear'
0.00.365.595 I main: number of tokens in prompt = 13
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.365.598 I main: prompt 2: 'what is panda?</s></s>The giant panda (Ailuropoda melanoleuca), sometimes called a panda bear or simply panda, is a bear species endemic to China.'
0.00.365.598 I main: number of tokens in prompt = 40
     0 -> '<s>'
 21381 -> 'what'
 21152 -> 'is'
 49990 -> 'panda'
...
0.00.369.499 I batch_decode: n_tokens = 62, n_seq = 3

rerank score 0:    0.023
rerank score 1:    0.024
rerank score 2:    0.199

0.00.377.103 I llama_perf_context_print:        load time =     363.72 ms
0.00.377.104 I llama_perf_context_print: prompt eval time =       7.36 ms /    62 tokens (    0.12 ms per token,  8425.06 tokens per second)
0.00.377.105 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.00.377.106 I llama_perf_context_print:       total time =      11.79 ms /    63 tokens
...
0.00.000.595 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.467 I llama_model_loader: - type  f16:   98 tensors
0.00.065.868 I llm_load_vocab: special tokens cache size = 25
0.00.077.416 I llm_load_vocab: token to piece cache size = 0.2984 MB
0.00.077.441 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.077.442 I llm_load_print_meta: arch             = gptneox
0.00.077.443 I llm_load_print_meta: vocab type       = BPE
0.00.077.443 I llm_load_print_meta: n_vocab          = 50304
0.00.077.443 I llm_load_print_meta: n_merges         = 50009
0.00.077.444 I llm_load_print_meta: vocab_only       = 0
0.00.077.444 I llm_load_print_meta: n_ctx_train      = 2048
0.00.077.445 I llm_load_print_meta: n_embd           = 2048
0.00.077.445 I llm_load_print_meta: n_layer          = 24
...
0.00.077.456 I llm_load_print_meta: n_swa            = 0
...
0.00.077.465 I llm_load_print_meta: n_expert_used    = 0
...
0.00.077.472 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.077.473 I llm_load_print_meta: model params     = 1.41 B
0.00.077.474 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
0.00.077.474 I llm_load_print_meta: general.name     = 1.4B
0.00.077.475 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.077.475 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.077.475 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
...
0.00.077.493 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.168.096 I llm_load_tensors:        CPU buffer size =  2699.45 MiB
...............................................................................
0.00.170.137 I llama_new_context_with_model: n_ctx      = 2048
0.00.170.153 I llama_new_context_with_model: n_batch    = 2048
0.00.170.153 I llama_new_context_with_model: n_ubatch   = 512
0.00.170.154 I llama_new_context_with_model: flash_attn = 0
0.00.170.156 I llama_new_context_with_model: freq_base  = 10000.0
0.00.170.156 I llama_new_context_with_model: freq_scale = 1
0.00.238.694 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.238.723 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.238.746 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.240.279 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.240.302 I llama_new_context_with_model: graph nodes  = 967
0.00.240.303 I llama_new_context_with_model: graph splits = 1
0.00.240.306 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.340.877 I main: llama threadpool init, n_threads = 4
0.00.340.902 I 
0.00.340.981 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.340.994 I 
0.00.341.105 I sampler seed: 1234
0.00.341.123 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.341.126 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.04.859.264 I llama_perf_sampler_print:    sampling time =       2.38 ms /    71 runs   (    0.03 ms per token, 29894.74 tokens per second)
0.04.859.267 I llama_perf_context_print:        load time =     339.10 ms
0.04.859.268 I llama_perf_context_print: prompt eval time =     112.24 ms /     7 tokens (   16.03 ms per token,    62.37 tokens per second)
0.04.859.269 I llama_perf_context_print:        eval time =    4394.44 ms /    63 runs   (   69.75 ms per token,    14.34 tokens per second)
0.04.859.270 I llama_perf_context_print:       total time =    4518.39 ms /    70 tokens

real	0m4.928s
user	0m18.447s
sys	0m0.256s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-f16.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.641 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
0.00.009.241 I llama_model_loader: loaded meta data with 22 key-value pairs and 292 tensors from ../models-mnt/pythia/1.4B/ggml-model-f16.gguf (version GGUF V3 (latest))
...
0.00.020.724 I llama_model_loader: - kv  19:                tokenizer.ggml.eos_token_id u32              = 0
...
0.00.074.497 I llm_load_print_meta: ssm_dt_rank      = 0
0.00.074.497 I llm_load_print_meta: ssm_dt_b_c_rms   = 0
0.00.074.498 I llm_load_print_meta: model type       = 1.4B
0.00.074.499 I llm_load_print_meta: model ftype      = all F32 (guessed)
0.00.074.500 I llm_load_print_meta: model params     = 1.41 B
0.00.074.501 I llm_load_print_meta: model size       = 2.64 GiB (16.01 BPW) 
...
0.00.074.503 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.503 I llm_load_print_meta: max token length = 1024
0.00.074.516 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.167.427 I llm_load_tensors:        CPU buffer size =  2699.45 MiB
...............................................................................
0.00.169.367 I llama_new_context_with_model: n_ctx      = 128
0.00.169.388 I llama_new_context_with_model: n_batch    = 128
0.00.169.389 I llama_new_context_with_model: n_ubatch   = 128
...
0.00.175.968 I llama_new_context_with_model: graph nodes  = 967
0.00.175.969 I llama_new_context_with_model: graph splits = 1
0.00.175.971 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.244.821 I 
0.00.244.921 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.244.928 I perplexity: tokenizing the input ..
0.00.253.447 I perplexity: tokenization took 8.515 ms
0.00.253.478 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.176.812 I perplexity: 0.92 seconds per pass - ETA 0.00 minutes
[1]10.1479,
0.01.180.626 I Final estimate: PPL = 10.1479 +/- 3.22609

0.01.180.669 I llama_perf_context_print:        load time =     243.22 ms
0.01.180.671 I llama_perf_context_print: prompt eval time =     921.58 ms /   128 tokens (    7.20 ms per token,   138.89 tokens per second)
0.01.180.672 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.180.673 I llama_perf_context_print:       total time =     935.85 ms /   129 tokens
...
0.00.000.593 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.064.735 I llm_load_vocab: special tokens cache size = 25
...
0.00.076.362 I llm_load_print_meta: model ftype      = Q8_0
0.00.076.363 I llm_load_print_meta: model params     = 1.41 B
0.00.076.364 I llm_load_print_meta: model size       = 1.40 GiB (8.51 BPW) 
...
0.00.076.380 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.152.067 I llm_load_tensors:        CPU buffer size =  1435.23 MiB
...............................................................................
0.00.154.044 I llama_new_context_with_model: n_ctx      = 2048
0.00.154.064 I llama_new_context_with_model: n_batch    = 2048
0.00.154.064 I llama_new_context_with_model: n_ubatch   = 512
...
0.00.223.119 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.223.148 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.223.171 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.224.775 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.224.799 I llama_new_context_with_model: graph nodes  = 967
0.00.224.800 I llama_new_context_with_model: graph splits = 1
0.00.224.804 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.308.737 I main: llama threadpool init, n_threads = 4
0.00.308.764 I 
0.00.308.840 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.308.853 I 
0.00.308.946 I sampler seed: 1234
0.00.308.964 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.308.967 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.308.968 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.308.968 I 
...
0.03.044.637 I llama_perf_sampler_print:    sampling time =       2.35 ms /    71 runs   (    0.03 ms per token, 30161.43 tokens per second)
0.03.044.641 I llama_perf_context_print:        load time =     306.97 ms
0.03.044.642 I llama_perf_context_print: prompt eval time =     112.24 ms /     7 tokens (   16.03 ms per token,    62.37 tokens per second)
0.03.044.644 I llama_perf_context_print:        eval time =    2611.50 ms /    63 runs   (   41.45 ms per token,    24.12 tokens per second)
0.03.044.645 I llama_perf_context_print:       total time =    2735.91 ms /    70 tokens

real	0m3.107s
user	0m11.235s
sys	0m0.248s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q8_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.642 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.151.979 I llm_load_tensors:        CPU buffer size =  1435.23 MiB
...............................................................................
0.00.154.024 I llama_new_context_with_model: n_ctx      = 128
0.00.154.046 I llama_new_context_with_model: n_batch    = 128
0.00.154.046 I llama_new_context_with_model: n_ubatch   = 128
0.00.154.047 I llama_new_context_with_model: flash_attn = 0
0.00.154.049 I llama_new_context_with_model: freq_base  = 10000.0
0.00.154.050 I llama_new_context_with_model: freq_scale = 1
0.00.159.001 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.159.029 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.159.046 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.160.962 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.160.987 I llama_new_context_with_model: graph nodes  = 967
0.00.160.988 I llama_new_context_with_model: graph splits = 1
0.00.160.989 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.226.654 I 
0.00.226.742 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.226.749 I perplexity: tokenizing the input ..
0.00.235.148 I perplexity: tokenization took 8.396 ms
0.00.235.175 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.125.997 I perplexity: 0.89 seconds per pass - ETA 0.00 minutes
[1]10.1344,
0.01.129.802 I Final estimate: PPL = 10.1344 +/- 3.22696

0.01.129.837 I llama_perf_context_print:        load time =     225.06 ms
0.01.129.840 I llama_perf_context_print: prompt eval time =     889.22 ms /   128 tokens (    6.95 ms per token,   143.95 tokens per second)
0.01.129.841 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.129.842 I llama_perf_context_print:       total time =     903.18 ms /   129 tokens
...
0.00.000.584 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.659 I llm_load_print_meta: n_embd_v_gqa     = 2048
0.00.076.660 I llm_load_print_meta: f_norm_eps       = 1.0e-05
0.00.076.661 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
0.00.076.661 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.076.661 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.076.661 I llm_load_print_meta: f_logit_scale    = 0.0e+00
0.00.076.662 I llm_load_print_meta: n_ff             = 8192
0.00.076.662 I llm_load_print_meta: n_expert         = 0
...
0.00.076.663 I llm_load_print_meta: rope type        = 2
...
0.00.076.667 I llm_load_print_meta: model ftype      = Q4_0
0.00.076.668 I llm_load_print_meta: model params     = 1.41 B
0.00.076.669 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
0.00.076.669 I llm_load_print_meta: general.name     = 1.4B
0.00.076.669 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.076.670 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
...
0.00.115.522 I llm_load_tensors:        CPU buffer size =   786.31 MiB
...............................................................................
0.00.117.577 I llama_new_context_with_model: n_ctx      = 2048
0.00.117.598 I llama_new_context_with_model: n_batch    = 2048
0.00.117.598 I llama_new_context_with_model: n_ubatch   = 512
0.00.117.598 I llama_new_context_with_model: flash_attn = 0
0.00.117.600 I llama_new_context_with_model: freq_base  = 10000.0
0.00.117.601 I llama_new_context_with_model: freq_scale = 1
0.00.186.828 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.186.857 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.186.878 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.188.943 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.188.960 I llama_new_context_with_model: graph nodes  = 967
0.00.188.961 I llama_new_context_with_model: graph splits = 1
0.00.188.964 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.284.191 I main: llama threadpool init, n_threads = 4
0.00.284.217 I 
0.00.284.291 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.284.304 I 
0.00.284.408 I sampler seed: 1234
0.00.284.426 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.284.429 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.284.430 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.284.430 I 
I believe the meaning of life is to know and experience things. I think that is the only way we can truly know ourselves. I have not really experienced anything. I don't know anything that I'm not going to be able to learn from others.

So it's a matter of life or death. It's a matter of life or death

0.02.282.835 I llama_perf_sampler_print:    sampling time =       2.36 ms /    71 runs   (    0.03 ms per token, 30072.00 tokens per second)
0.02.282.838 I llama_perf_context_print:        load time =     282.43 ms
0.02.282.840 I llama_perf_context_print: prompt eval time =     103.16 ms /     7 tokens (   14.74 ms per token,    67.86 tokens per second)
0.02.282.841 I llama_perf_context_print:        eval time =    1883.91 ms /    63 runs   (   29.90 ms per token,    33.44 tokens per second)
0.02.282.842 I llama_perf_context_print:       total time =    1998.65 ms /    70 tokens

real	0m2.325s
user	0m8.354s
sys	0m0.168s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.623 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.797 I llm_load_print_meta: model ftype      = Q4_0
0.00.075.798 I llm_load_print_meta: model params     = 1.41 B
0.00.075.799 I llm_load_print_meta: model size       = 786.31 MiB (4.66 BPW) 
0.00.075.799 I llm_load_print_meta: general.name     = 1.4B
0.00.075.800 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.075.800 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.075.800 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
...
0.00.114.179 I llm_load_tensors:        CPU buffer size =   786.31 MiB
...............................................................................
0.00.116.164 I llama_new_context_with_model: n_ctx      = 128
0.00.116.185 I llama_new_context_with_model: n_batch    = 128
0.00.116.186 I llama_new_context_with_model: n_ubatch   = 128
0.00.116.186 I llama_new_context_with_model: flash_attn = 0
0.00.116.188 I llama_new_context_with_model: freq_base  = 10000.0
0.00.116.188 I llama_new_context_with_model: freq_scale = 1
0.00.120.673 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.120.695 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.120.716 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.122.613 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.122.635 I llama_new_context_with_model: graph nodes  = 967
0.00.122.635 I llama_new_context_with_model: graph splits = 1
0.00.122.637 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.182.776 I 
0.00.182.865 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.182.870 I perplexity: tokenizing the input ..
0.00.191.258 I perplexity: tokenization took 8.384 ms
0.00.191.288 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.200.513 I perplexity: 1.01 seconds per pass - ETA 0.02 minutes
[1]11.2206,
0.01.204.521 I Final estimate: PPL = 11.2206 +/- 3.51829

0.01.204.557 I llama_perf_context_print:        load time =     181.24 ms
0.01.204.559 I llama_perf_context_print: prompt eval time =    1007.79 ms /   128 tokens (    7.87 ms per token,   127.01 tokens per second)
0.01.204.560 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.204.561 I llama_perf_context_print:       total time =    1021.78 ms /   129 tokens
...
0.00.000.658 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.705 I llm_load_print_meta: model size       = 864.46 MiB (5.13 BPW) 
...
0.00.075.723 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.112.121 I llm_load_tensors:        CPU buffer size =   864.46 MiB
..............................................................................
0.00.114.048 I llama_new_context_with_model: n_ctx      = 2048
0.00.114.068 I llama_new_context_with_model: n_batch    = 2048
0.00.114.069 I llama_new_context_with_model: n_ubatch   = 512
...
0.00.181.705 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.181.733 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.181.749 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.183.289 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.183.310 I llama_new_context_with_model: graph nodes  = 967
0.00.183.310 I llama_new_context_with_model: graph splits = 1
0.00.183.314 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.270.593 I main: llama threadpool init, n_threads = 4
0.00.270.620 I 
0.00.270.732 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.270.732 I 
0.00.270.827 I sampler seed: 1234
0.00.270.845 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.270.848 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
...
0.02.277.852 I llama_perf_sampler_print:    sampling time =       2.38 ms /    71 runs   (    0.03 ms per token, 29882.15 tokens per second)
0.02.277.855 I llama_perf_context_print:        load time =     268.76 ms
0.02.277.857 I llama_perf_context_print: prompt eval time =     106.11 ms /     7 tokens (   15.16 ms per token,    65.97 tokens per second)
0.02.277.859 I llama_perf_context_print:        eval time =    1889.95 ms /    63 runs   (   30.00 ms per token,    33.33 tokens per second)
0.02.277.860 I llama_perf_context_print:       total time =    2007.26 ms /    70 tokens

real	0m2.320s
user	0m8.326s
sys	0m0.192s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_1.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.635 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.187 I llm_load_print_meta: model ftype      = Q4_1
...
0.00.112.663 I llm_load_tensors:        CPU buffer size =   864.46 MiB
..............................................................................
0.00.114.658 I llama_new_context_with_model: n_ctx      = 128
0.00.114.678 I llama_new_context_with_model: n_batch    = 128
0.00.114.679 I llama_new_context_with_model: n_ubatch   = 128
0.00.114.679 I llama_new_context_with_model: flash_attn = 0
0.00.114.681 I llama_new_context_with_model: freq_base  = 10000.0
0.00.114.681 I llama_new_context_with_model: freq_scale = 1
0.00.119.320 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.119.348 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.119.364 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.121.362 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.121.379 I llama_new_context_with_model: graph nodes  = 967
0.00.121.380 I llama_new_context_with_model: graph splits = 1
0.00.121.381 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.168.528 I 
0.00.168.618 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.168.625 I perplexity: tokenizing the input ..
0.00.177.113 I perplexity: tokenization took 8.485 ms
0.00.177.147 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.798.590 I perplexity: 1.62 seconds per pass - ETA 0.02 minutes
[1]10.5775,
0.01.802.324 I Final estimate: PPL = 10.5775 +/- 3.33909

0.01.802.361 I llama_perf_context_print:        load time =     166.90 ms
0.01.802.363 I llama_perf_context_print: prompt eval time =    1619.74 ms /   128 tokens (   12.65 ms per token,    79.03 tokens per second)
0.01.802.364 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.802.365 I llama_perf_context_print:       total time =    1633.83 ms /   129 tokens
...
0.00.000.594 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.089 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
0.00.021.091 I llama_model_loader: - type  f32:  194 tensors
0.00.021.093 I llama_model_loader: - type q5_0:   97 tensors
...
0.00.075.398 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.399 I llm_load_print_meta: model params     = 1.41 B
0.00.075.400 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.115.726 I llm_load_tensors:        CPU buffer size =   942.60 MiB
..................................................................................
0.00.117.660 I llama_new_context_with_model: n_ctx      = 2048
0.00.117.680 I llama_new_context_with_model: n_batch    = 2048
0.00.117.680 I llama_new_context_with_model: n_ubatch   = 512
0.00.117.681 I llama_new_context_with_model: flash_attn = 0
0.00.117.682 I llama_new_context_with_model: freq_base  = 10000.0
0.00.117.683 I llama_new_context_with_model: freq_scale = 1
0.00.186.497 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.186.520 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.186.537 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.188.045 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.188.068 I llama_new_context_with_model: graph nodes  = 967
0.00.188.069 I llama_new_context_with_model: graph splits = 1
0.00.188.072 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.281.147 I main: llama threadpool init, n_threads = 4
0.00.281.174 I 
0.00.281.249 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.281.262 I 
...
0.00.281.382 I sampler params: 
	...
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.281.386 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.281.387 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.281.387 I 
...
0.02.480.852 I llama_perf_sampler_print:    sampling time =       2.13 ms /    71 runs   (    0.03 ms per token, 33286.45 tokens per second)
0.02.480.855 I llama_perf_context_print:        load time =     279.42 ms
0.02.480.857 I llama_perf_context_print: prompt eval time =     127.52 ms /     7 tokens (   18.22 ms per token,    54.89 tokens per second)
0.02.480.859 I llama_perf_context_print:        eval time =    2061.05 ms /    63 runs   (   32.72 ms per token,    30.57 tokens per second)
0.02.480.860 I llama_perf_context_print:       total time =    2199.71 ms /    70 tokens

real	0m2.523s
user	0m9.166s
sys	0m0.152s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_0.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.757 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.546 I llama_model_loader: - kv  22:                          general.file_type u32              = 8
...
0.00.075.495 I llm_load_print_meta: model ftype      = Q5_0
0.00.075.496 I llm_load_print_meta: model params     = 1.41 B
0.00.075.497 I llm_load_print_meta: model size       = 942.60 MiB (5.59 BPW) 
...
0.00.114.752 I llm_load_tensors:        CPU buffer size =   942.60 MiB
..................................................................................
0.00.116.772 I llama_new_context_with_model: n_ctx      = 128
0.00.116.794 I llama_new_context_with_model: n_batch    = 128
0.00.116.794 I llama_new_context_with_model: n_ubatch   = 128
0.00.116.794 I llama_new_context_with_model: flash_attn = 0
0.00.116.796 I llama_new_context_with_model: freq_base  = 10000.0
0.00.116.797 I llama_new_context_with_model: freq_scale = 1
0.00.121.383 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
...
0.00.122.938 I llama_new_context_with_model: graph nodes  = 967
0.00.122.938 I llama_new_context_with_model: graph splits = 1
0.00.122.941 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.181.542 I 
0.00.181.643 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.181.662 I perplexity: tokenizing the input ..
0.00.190.170 I perplexity: tokenization took 8.504 ms
0.00.190.207 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.213.575 I perplexity: 2.02 seconds per pass - ETA 0.03 minutes
[1]10.0390,
0.02.217.275 I Final estimate: PPL = 10.0390 +/- 3.19711

0.02.217.322 I llama_perf_context_print:        load time =     179.82 ms
0.02.217.336 I llama_perf_context_print: prompt eval time =    2021.69 ms /   128 tokens (   15.79 ms per token,    63.31 tokens per second)
0.02.217.338 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.217.339 I llama_perf_context_print:       total time =    2035.78 ms /   129 tokens
...
0.00.000.605 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.373 I llama_model_loader: - kv  21:               general.quantization_version u32              = 2
0.00.021.373 I llama_model_loader: - kv  22:                          general.file_type u32              = 9
0.00.021.376 I llama_model_loader: - type  f32:  194 tensors
...
0.00.075.766 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.767 I llm_load_print_meta: model params     = 1.41 B
0.00.075.768 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.118.365 I llm_load_tensors:        CPU buffer size =  1020.74 MiB
...............................................................................
0.00.120.348 I llama_new_context_with_model: n_ctx      = 2048
0.00.120.368 I llama_new_context_with_model: n_batch    = 2048
0.00.120.369 I llama_new_context_with_model: n_ubatch   = 512
0.00.120.369 I llama_new_context_with_model: flash_attn = 0
0.00.120.371 I llama_new_context_with_model: freq_base  = 10000.0
0.00.120.371 I llama_new_context_with_model: freq_scale = 1
0.00.187.808 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.187.836 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.187.855 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.189.372 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.189.396 I llama_new_context_with_model: graph nodes  = 967
0.00.189.396 I llama_new_context_with_model: graph splits = 1
0.00.189.399 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.283.499 I main: llama threadpool init, n_threads = 4
0.00.283.526 I 
0.00.283.598 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.283.611 I 
0.00.283.704 I sampler seed: 1234
0.00.283.722 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.283.725 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.283.726 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.283.726 I 
...
0.02.595.003 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32390.51 tokens per second)
0.02.595.007 I llama_perf_context_print:        load time =     281.75 ms
0.02.595.009 I llama_perf_context_print: prompt eval time =     124.97 ms /     7 tokens (   17.85 ms per token,    56.01 tokens per second)
0.02.595.010 I llama_perf_context_print:        eval time =    2175.72 ms /    63 runs   (   34.54 ms per token,    28.96 tokens per second)
0.02.595.011 I llama_perf_context_print:       total time =    2311.51 ms /    70 tokens

real	0m2.638s
user	0m9.619s
sys	0m0.152s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_1.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.620 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.316 I llm_load_print_meta: model ftype      = Q5_1
0.00.075.316 I llm_load_print_meta: model params     = 1.41 B
0.00.075.317 I llm_load_print_meta: model size       = 1020.74 MiB (6.05 BPW) 
...
0.00.117.872 I llm_load_tensors:        CPU buffer size =  1020.74 MiB
...............................................................................
0.00.119.805 I llama_new_context_with_model: n_ctx      = 128
0.00.119.862 I llama_new_context_with_model: n_batch    = 128
0.00.119.862 I llama_new_context_with_model: n_ubatch   = 128
0.00.119.863 I llama_new_context_with_model: flash_attn = 0
0.00.119.865 I llama_new_context_with_model: freq_base  = 10000.0
0.00.119.866 I llama_new_context_with_model: freq_scale = 1
0.00.124.517 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.124.544 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.124.559 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.126.416 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.126.441 I llama_new_context_with_model: graph nodes  = 967
0.00.126.441 I llama_new_context_with_model: graph splits = 1
0.00.126.443 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.183.980 I 
0.00.184.069 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.184.077 I perplexity: tokenizing the input ..
0.00.192.582 I perplexity: tokenization took 8.501 ms
0.00.192.611 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.02.141.250 I perplexity: 1.95 seconds per pass - ETA 0.02 minutes
[1]10.0753,
0.02.145.082 I Final estimate: PPL = 10.0753 +/- 3.14595

0.02.145.121 I llama_perf_context_print:        load time =     182.41 ms
0.02.145.123 I llama_perf_context_print: prompt eval time =    1946.91 ms /   128 tokens (   15.21 ms per token,    65.75 tokens per second)
0.02.145.125 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.02.145.126 I llama_perf_context_print:       total time =    1961.14 ms /   129 tokens
...
0.00.000.651 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.657 I llama_model_loader: - type q2_K:   49 tensors
0.00.021.657 I llama_model_loader: - type q3_K:   48 tensors
...
0.00.075.515 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.516 I llm_load_print_meta: model params     = 1.41 B
0.00.075.517 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.097.651 I llm_load_tensors:        CPU buffer size =   542.04 MiB
..........................................................................
0.00.099.625 I llama_new_context_with_model: n_ctx      = 2048
0.00.099.645 I llama_new_context_with_model: n_batch    = 2048
0.00.099.646 I llama_new_context_with_model: n_ubatch   = 512
0.00.099.646 I llama_new_context_with_model: flash_attn = 0
0.00.099.648 I llama_new_context_with_model: freq_base  = 10000.0
0.00.099.649 I llama_new_context_with_model: freq_scale = 1
0.00.167.530 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.167.554 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.167.574 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.169.102 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.169.126 I llama_new_context_with_model: graph nodes  = 967
0.00.169.126 I llama_new_context_with_model: graph splits = 1
0.00.169.130 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.242.874 I main: llama threadpool init, n_threads = 4
0.00.242.901 I 
0.00.243.015 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.243.015 I 
0.00.243.114 I sampler seed: 1234
0.00.243.132 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.243.135 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.243.136 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.243.136 I 
I believe the meaning of life is to do. and yes, i still believe in the concept of a free and open and a random and open? huh? i don't think so. and he? not? i don't. and i'd not be any rounder. and the day i signed on? i signed on? i signed on.

0.01.648.770 I llama_perf_sampler_print:    sampling time =       2.08 ms /    71 runs   (    0.03 ms per token, 34101.83 tokens per second)
0.01.648.774 I llama_perf_context_print:        load time =     241.08 ms
0.01.648.775 I llama_perf_context_print: prompt eval time =      82.77 ms /     7 tokens (   11.82 ms per token,    84.57 tokens per second)
0.01.648.777 I llama_perf_context_print:        eval time =    1312.29 ms /    63 runs   (   20.83 ms per token,    48.01 tokens per second)
0.01.648.778 I llama_perf_context_print:       total time =    1405.90 ms /    70 tokens

real	0m1.680s
user	0m5.927s
sys	0m0.108s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q2_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.627 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.110 I llm_load_print_meta: model ftype      = Q2_K - Medium
0.00.075.111 I llm_load_print_meta: model params     = 1.41 B
0.00.075.111 I llm_load_print_meta: model size       = 542.04 MiB (3.21 BPW) 
...
0.00.075.133 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.097.181 I llm_load_tensors:        CPU buffer size =   542.04 MiB
..........................................................................
0.00.099.193 I llama_new_context_with_model: n_ctx      = 128
0.00.099.214 I llama_new_context_with_model: n_batch    = 128
0.00.099.214 I llama_new_context_with_model: n_ubatch   = 128
0.00.099.214 I llama_new_context_with_model: flash_attn = 0
0.00.099.216 I llama_new_context_with_model: freq_base  = 10000.0
0.00.099.217 I llama_new_context_with_model: freq_scale = 1
0.00.103.837 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.103.866 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.103.881 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.105.364 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.105.388 I llama_new_context_with_model: graph nodes  = 967
0.00.105.389 I llama_new_context_with_model: graph splits = 1
0.00.105.390 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.143.510 I 
0.00.143.603 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.143.611 I perplexity: tokenizing the input ..
0.00.152.164 I perplexity: tokenization took 8.549 ms
0.00.152.192 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.443.776 I perplexity: 1.29 seconds per pass - ETA 0.02 minutes
[1]70.4342,
0.01.447.600 I Final estimate: PPL = 70.4342 +/- 27.31048

0.01.447.640 I llama_perf_context_print:        load time =     141.97 ms
0.01.447.642 I llama_perf_context_print: prompt eval time =    1289.89 ms /   128 tokens (   10.08 ms per token,    99.23 tokens per second)
0.01.447.644 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.447.644 I llama_perf_context_print:       total time =    1304.13 ms /   129 tokens
...
0.00.000.626 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.465 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
0.00.021.468 I llama_model_loader: - type  f32:  194 tensors
0.00.021.471 I llama_model_loader: - type q3_K:   25 tensors
...
0.00.076.352 I llm_load_print_meta: freq_base_train  = 10000.0
0.00.076.352 I llm_load_print_meta: freq_scale_train = 1
0.00.076.353 I llm_load_print_meta: n_ctx_orig_yarn  = 2048
...
0.00.076.384 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.105.293 I llm_load_tensors:        CPU buffer size =   724.27 MiB
...............................................................................
0.00.107.321 I llama_new_context_with_model: n_ctx      = 2048
0.00.107.342 I llama_new_context_with_model: n_batch    = 2048
0.00.107.342 I llama_new_context_with_model: n_ubatch   = 512
0.00.107.343 I llama_new_context_with_model: flash_attn = 0
0.00.107.344 I llama_new_context_with_model: freq_base  = 10000.0
0.00.107.345 I llama_new_context_with_model: freq_scale = 1
0.00.175.666 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.175.693 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.175.712 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.177.169 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.177.193 I llama_new_context_with_model: graph nodes  = 967
0.00.177.193 I llama_new_context_with_model: graph splits = 1
0.00.177.197 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.254.556 I main: llama threadpool init, n_threads = 4
0.00.254.581 I 
0.00.254.661 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.254.663 I 
0.00.254.777 I sampler seed: 1234
0.00.254.795 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.254.798 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.254.799 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.254.799 I 
...
0.01.903.910 I llama_perf_sampler_print:    sampling time =       2.14 ms /    71 runs   (    0.03 ms per token, 33131.12 tokens per second)
0.01.903.913 I llama_perf_context_print:        load time =     252.78 ms
0.01.903.915 I llama_perf_context_print: prompt eval time =      85.56 ms /     7 tokens (   12.22 ms per token,    81.82 tokens per second)
0.01.903.916 I llama_perf_context_print:        eval time =    1552.76 ms /    63 runs   (   24.65 ms per token,    40.57 tokens per second)
0.01.903.917 I llama_perf_context_print:       total time =    1649.36 ms /    70 tokens

real	0m1.939s
user	0m6.879s
sys	0m0.156s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q3_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.638 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.722 I llama_model_loader: - kv  22:                          general.file_type u32              = 12
...
0.00.074.864 I llm_load_print_meta: model ftype      = Q3_K - Medium
0.00.074.865 I llm_load_print_meta: model params     = 1.41 B
0.00.074.865 I llm_load_print_meta: model size       = 724.27 MiB (4.29 BPW) 
...
0.00.103.845 I llm_load_tensors:        CPU buffer size =   724.27 MiB
...............................................................................
0.00.105.803 I llama_new_context_with_model: n_ctx      = 128
0.00.105.823 I llama_new_context_with_model: n_batch    = 128
0.00.105.824 I llama_new_context_with_model: n_ubatch   = 128
0.00.105.824 I llama_new_context_with_model: flash_attn = 0
0.00.105.826 I llama_new_context_with_model: freq_base  = 10000.0
0.00.105.827 I llama_new_context_with_model: freq_scale = 1
0.00.110.382 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.110.409 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.110.423 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.112.384 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.112.408 I llama_new_context_with_model: graph nodes  = 967
0.00.112.408 I llama_new_context_with_model: graph splits = 1
0.00.112.410 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.153.009 I 
0.00.153.157 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.153.166 I perplexity: tokenizing the input ..
0.00.161.819 I perplexity: tokenization took 8.65 ms
0.00.161.848 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.494.504 I perplexity: 1.33 seconds per pass - ETA 0.02 minutes
[1]12.3055,
0.01.498.439 I Final estimate: PPL = 12.3055 +/- 4.00505

0.01.498.480 I llama_perf_context_print:        load time =     151.34 ms
0.01.498.495 I llama_perf_context_print: prompt eval time =    1330.95 ms /   128 tokens (   10.40 ms per token,    96.17 tokens per second)
0.01.498.496 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.498.496 I llama_perf_context_print:       total time =    1345.47 ms /   129 tokens
...
0.00.001.667 I main: load the model and apply lora adapter, if any
...
0.00.075.034 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.075.034 I llm_load_print_meta: model params     = 1.41 B
0.00.075.035 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
...
0.00.110.424 I llm_load_tensors:        CPU buffer size =   871.81 MiB
..............................................................................
0.00.112.363 I llama_new_context_with_model: n_ctx      = 2048
0.00.112.385 I llama_new_context_with_model: n_batch    = 2048
0.00.112.385 I llama_new_context_with_model: n_ubatch   = 512
0.00.112.386 I llama_new_context_with_model: flash_attn = 0
0.00.112.387 I llama_new_context_with_model: freq_base  = 10000.0
0.00.112.388 I llama_new_context_with_model: freq_scale = 1
...
0.00.180.467 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.181.970 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.181.995 I llama_new_context_with_model: graph nodes  = 967
0.00.181.995 I llama_new_context_with_model: graph splits = 1
0.00.181.999 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.265.690 I main: llama threadpool init, n_threads = 4
0.00.265.718 I 
0.00.265.794 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.265.807 I 
0.00.265.909 I sampler seed: 1234
0.00.265.927 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.265.930 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.265.931 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.265.931 I 
I believe the meaning of life is that there is a divine plan for everyone, and that there is no such thing as a perfect life. If I understood the meaning of life, I would be very upset with the way I am living right now. I can’t deny my free will, but I don’t have the right to dictate what I

0.02.123.600 I llama_perf_sampler_print:    sampling time =       2.24 ms /    71 runs   (    0.03 ms per token, 31738.94 tokens per second)
0.02.123.604 I llama_perf_context_print:        load time =     263.99 ms
0.02.123.606 I llama_perf_context_print: prompt eval time =      91.49 ms /     7 tokens (   13.07 ms per token,    76.51 tokens per second)
0.02.123.607 I llama_perf_context_print:        eval time =    1755.07 ms /    63 runs   (   27.86 ms per token,    35.90 tokens per second)
0.02.123.608 I llama_perf_context_print:       total time =    1857.92 ms /    70 tokens

real	0m2.162s
user	0m7.751s
sys	0m0.152s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q4_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.692 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.079.274 I llm_load_vocab: token to piece cache size = 0.2984 MB
0.00.079.297 I llm_load_print_meta: format           = GGUF V3 (latest)
0.00.079.298 I llm_load_print_meta: arch             = gptneox
0.00.079.298 I llm_load_print_meta: vocab type       = BPE
0.00.079.299 I llm_load_print_meta: n_vocab          = 50304
0.00.079.299 I llm_load_print_meta: n_merges         = 50009
0.00.079.300 I llm_load_print_meta: vocab_only       = 0
0.00.079.300 I llm_load_print_meta: n_ctx_train      = 2048
0.00.079.300 I llm_load_print_meta: n_embd           = 2048
0.00.079.301 I llm_load_print_meta: n_layer          = 24
0.00.079.310 I llm_load_print_meta: n_head           = 16
0.00.079.311 I llm_load_print_meta: n_head_kv        = 16
0.00.079.311 I llm_load_print_meta: n_rot            = 32
0.00.079.311 I llm_load_print_meta: n_swa            = 0
0.00.079.312 I llm_load_print_meta: n_embd_head_k    = 128
0.00.079.312 I llm_load_print_meta: n_embd_head_v    = 128
0.00.079.313 I llm_load_print_meta: n_gqa            = 1
0.00.079.314 I llm_load_print_meta: n_embd_k_gqa     = 2048
...
0.00.079.317 I llm_load_print_meta: f_clamp_kqv      = 0.0e+00
0.00.079.317 I llm_load_print_meta: f_max_alibi_bias = 0.0e+00
0.00.079.318 I llm_load_print_meta: f_logit_scale    = 0.0e+00
...
0.00.079.325 I llm_load_print_meta: model ftype      = Q4_K - Medium
0.00.079.326 I llm_load_print_meta: model params     = 1.41 B
0.00.079.328 I llm_load_print_meta: model size       = 871.81 MiB (5.17 BPW) 
0.00.079.328 I llm_load_print_meta: general.name     = 1.4B
0.00.079.328 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.079.329 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
...
0.00.079.351 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.114.770 I llm_load_tensors:        CPU buffer size =   871.81 MiB
..............................................................................
0.00.116.721 I llama_new_context_with_model: n_ctx      = 128
0.00.116.741 I llama_new_context_with_model: n_batch    = 128
0.00.116.741 I llama_new_context_with_model: n_ubatch   = 128
0.00.116.741 I llama_new_context_with_model: flash_attn = 0
0.00.116.743 I llama_new_context_with_model: freq_base  = 10000.0
0.00.116.744 I llama_new_context_with_model: freq_scale = 1
0.00.121.404 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.121.426 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.121.442 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.123.428 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.123.453 I llama_new_context_with_model: graph nodes  = 967
0.00.123.454 I llama_new_context_with_model: graph splits = 1
0.00.123.455 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.170.307 I 
0.00.170.398 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.170.405 I perplexity: tokenizing the input ..
0.00.179.086 I perplexity: tokenization took 8.678 ms
0.00.179.117 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.571.986 I perplexity: 1.39 seconds per pass - ETA 0.02 minutes
[1]10.5104,
0.01.575.844 I Final estimate: PPL = 10.5104 +/- 3.37236

0.01.575.883 I llama_perf_context_print:        load time =     168.59 ms
0.01.575.884 I llama_perf_context_print: prompt eval time =    1391.17 ms /   128 tokens (   10.87 ms per token,    92.01 tokens per second)
0.01.575.887 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.575.887 I llama_perf_context_print:       total time =    1405.57 ms /   129 tokens
...
0.00.000.737 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.076.309 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.117.028 I llm_load_tensors:        CPU buffer size =  1006.35 MiB
................................................................................
0.00.119.033 I llama_new_context_with_model: n_ctx      = 2048
...
0.00.119.058 I llama_new_context_with_model: freq_scale = 1
0.00.188.065 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.188.095 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.188.116 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.189.711 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.189.734 I llama_new_context_with_model: graph nodes  = 967
0.00.189.735 I llama_new_context_with_model: graph splits = 1
0.00.189.738 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.277.142 I main: llama threadpool init, n_threads = 4
0.00.277.170 I 
0.00.277.253 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.277.265 I 
0.00.277.413 I sampler seed: 1234
0.00.277.431 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.277.434 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.277.435 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.277.435 I 
...
0.02.384.611 I llama_perf_sampler_print:    sampling time =       2.19 ms /    71 runs   (    0.03 ms per token, 32494.28 tokens per second)
0.02.384.614 I llama_perf_context_print:        load time =     275.22 ms
0.02.384.615 I llama_perf_context_print: prompt eval time =     106.92 ms /     7 tokens (   15.27 ms per token,    65.47 tokens per second)
0.02.384.616 I llama_perf_context_print:        eval time =    1989.50 ms /    63 runs   (   31.58 ms per token,    31.67 tokens per second)
0.02.384.617 I llama_perf_context_print:       total time =    2107.48 ms /    70 tokens

real	0m2.426s
user	0m8.773s
sys	0m0.152s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q5_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.837 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.075.227 I llm_load_print_meta: model type       = 1.4B
0.00.075.228 I llm_load_print_meta: model ftype      = Q5_K - Medium
...
0.00.116.037 I llm_load_tensors:        CPU buffer size =  1006.35 MiB
................................................................................
0.00.118.109 I llama_new_context_with_model: n_ctx      = 128
0.00.118.129 I llama_new_context_with_model: n_batch    = 128
0.00.118.129 I llama_new_context_with_model: n_ubatch   = 128
0.00.118.130 I llama_new_context_with_model: flash_attn = 0
0.00.118.132 I llama_new_context_with_model: freq_base  = 10000.0
0.00.118.132 I llama_new_context_with_model: freq_scale = 1
0.00.122.847 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.122.874 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.122.890 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.124.296 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.124.320 I llama_new_context_with_model: graph nodes  = 967
0.00.124.320 I llama_new_context_with_model: graph splits = 1
0.00.124.322 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.179.660 I 
0.00.179.756 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.179.762 I perplexity: tokenizing the input ..
0.00.188.353 I perplexity: tokenization took 8.588 ms
0.00.188.387 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.870.648 I perplexity: 1.68 seconds per pass - ETA 0.02 minutes
[1]10.6295,
0.01.874.556 I Final estimate: PPL = 10.6295 +/- 3.40266

0.01.874.595 I llama_perf_context_print:        load time =     177.92 ms
0.01.874.597 I llama_perf_context_print: prompt eval time =    1680.55 ms /   128 tokens (   13.13 ms per token,    76.17 tokens per second)
0.01.874.598 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.874.600 I llama_perf_context_print:       total time =    1694.93 ms /   129 tokens
...
0.00.000.632 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.021.464 I llama_model_loader: - kv  20:            tokenizer.ggml.unknown_token_id u32              = 0
0.00.021.464 I llama_model_loader: - kv  21:               general.quantization_version u32              = 2
0.00.021.465 I llama_model_loader: - kv  22:                          general.file_type u32              = 18
0.00.021.467 I llama_model_loader: - type  f32:  194 tensors
0.00.021.470 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.075.639 I llm_load_print_meta: model ftype      = Q6_K
0.00.075.640 I llm_load_print_meta: model params     = 1.41 B
0.00.075.641 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
...
0.00.075.656 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.114.628 I llm_load_tensors:        CPU buffer size =  1108.64 MiB
...............................................................................
0.00.116.666 I llama_new_context_with_model: n_ctx      = 2048
0.00.116.686 I llama_new_context_with_model: n_batch    = 2048
0.00.116.686 I llama_new_context_with_model: n_ubatch   = 512
0.00.116.687 I llama_new_context_with_model: flash_attn = 0
0.00.116.689 I llama_new_context_with_model: freq_base  = 10000.0
0.00.116.689 I llama_new_context_with_model: freq_scale = 1
0.00.186.009 I llama_kv_cache_init:        CPU KV buffer size =   384.00 MiB
0.00.186.037 I llama_new_context_with_model: KV self size  =  384.00 MiB, K (f16):  192.00 MiB, V (f16):  192.00 MiB
0.00.186.058 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.188.045 I llama_new_context_with_model:        CPU compute buffer size =   102.25 MiB
0.00.188.070 I llama_new_context_with_model: graph nodes  = 967
0.00.188.070 I llama_new_context_with_model: graph splits = 1
0.00.188.073 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.274.158 I main: llama threadpool init, n_threads = 4
0.00.274.185 I 
0.00.274.267 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.274.280 I 
0.00.274.395 I sampler seed: 1234
0.00.274.413 I sampler params: 
	repeat_last_n = 64, repeat_penalty = 1.000, frequency_penalty = 0.000, presence_penalty = 0.000
	top_k = 40, tfs_z = 1.000, top_p = 0.950, min_p = 0.050, xtc_probability = 0.000, xtc_threshold = 0.100, typical_p = 1.000, temp = 0.800
	mirostat = 0, mirostat_lr = 0.100, mirostat_ent = 5.000
0.00.274.416 I sampler chain: logits -> logit-bias -> penalties -> top-k -> tail-free -> typical -> top-p -> min-p -> xtc -> temp-ext -> dist 
0.00.274.417 I generate: n_ctx = 2048, n_batch = 2048, n_predict = 64, n_keep = 0
0.00.274.417 I 
...
0.02.515.968 I llama_perf_sampler_print:    sampling time =       2.15 ms /    71 runs   (    0.03 ms per token, 33054.00 tokens per second)
0.02.515.971 I llama_perf_context_print:        load time =     272.32 ms
0.02.515.973 I llama_perf_context_print: prompt eval time =     104.20 ms /     7 tokens (   14.89 ms per token,    67.18 tokens per second)
0.02.515.974 I llama_perf_context_print:        eval time =    2126.53 ms /    63 runs   (   33.75 ms per token,    29.63 tokens per second)
0.02.515.975 I llama_perf_context_print:       total time =    2241.82 ms /    70 tokens

real	0m2.557s
user	0m9.299s
sys	0m0.156s
+ ./bin/llama-perplexity --model ../models-mnt/pythia/1.4B/ggml-model-q6_k.gguf -f ../models-mnt/wikitext/wikitext-2-raw/wiki.test-60.raw -c 128 -b 128 --chunks 1
0.00.000.662 I build: 3976 (449717f1) with cc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0 for x86_64-linux-gnu
...
0.00.020.565 I llama_model_loader: - type q6_K:   98 tensors
...
0.00.074.794 I llm_load_print_meta: f_norm_rms_eps   = 0.0e+00
...
0.00.074.805 I llm_load_print_meta: model ftype      = Q6_K
0.00.074.807 I llm_load_print_meta: model params     = 1.41 B
0.00.074.807 I llm_load_print_meta: model size       = 1.08 GiB (6.57 BPW) 
0.00.074.808 I llm_load_print_meta: general.name     = 1.4B
0.00.074.808 I llm_load_print_meta: BOS token        = 0 '<|endoftext|>'
0.00.074.809 I llm_load_print_meta: EOS token        = 0 '<|endoftext|>'
0.00.074.809 I llm_load_print_meta: EOT token        = 0 '<|endoftext|>'
0.00.074.809 I llm_load_print_meta: UNK token        = 0 '<|endoftext|>'
0.00.074.810 I llm_load_print_meta: LF token         = 128 'Ä'
0.00.074.811 I llm_load_print_meta: EOG token        = 0 '<|endoftext|>'
0.00.074.811 I llm_load_print_meta: max token length = 1024
0.00.074.827 I llm_load_tensors: ggml ctx size =    0.13 MiB
0.00.113.965 I llm_load_tensors:        CPU buffer size =  1108.64 MiB
...............................................................................
0.00.115.930 I llama_new_context_with_model: n_ctx      = 128
0.00.115.950 I llama_new_context_with_model: n_batch    = 128
0.00.115.950 I llama_new_context_with_model: n_ubatch   = 128
0.00.115.951 I llama_new_context_with_model: flash_attn = 0
0.00.115.952 I llama_new_context_with_model: freq_base  = 10000.0
0.00.115.953 I llama_new_context_with_model: freq_scale = 1
0.00.120.536 I llama_kv_cache_init:        CPU KV buffer size =    24.00 MiB
0.00.120.562 I llama_new_context_with_model: KV self size  =   24.00 MiB, K (f16):   12.00 MiB, V (f16):   12.00 MiB
0.00.120.576 I llama_new_context_with_model:        CPU  output buffer size =     0.19 MiB
0.00.122.588 I llama_new_context_with_model:        CPU compute buffer size =    25.56 MiB
0.00.122.608 I llama_new_context_with_model: graph nodes  = 967
0.00.122.609 I llama_new_context_with_model: graph splits = 1
0.00.122.611 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
0.00.173.673 I 
0.00.173.771 I system_info: n_threads = 4 (n_threads_batch = 4) / 8 | AVX = 1 | AVX_VNNI = 1 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | AVX512_BF16 = 1 | AMX_INT8 = 1 | FMA = 1 | NEON = 0 | SVE = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | RISCV_VECT = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | LLAMAFILE = 1 | 
0.00.173.778 I perplexity: tokenizing the input ..
0.00.182.485 I perplexity: tokenization took 8.703 ms
0.00.182.514 I perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
0.01.822.082 I perplexity: 1.64 seconds per pass - ETA 0.02 minutes
[1]10.2564,
0.01.825.968 I Final estimate: PPL = 10.2564 +/- 3.23596

0.01.826.007 I llama_perf_context_print:        load time =     172.07 ms
0.01.826.020 I llama_perf_context_print: prompt eval time =    1637.80 ms /   128 tokens (   12.80 ms per token,    78.15 tokens per second)
0.01.826.022 I llama_perf_context_print:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
0.01.826.023 I llama_perf_context_print:       total time =    1652.33 ms /   129 tokens
...
0.00.183.963 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
...
llama_new_context_with_model: graph splits = 1
0.00.184.704 W common_init_from_params: warming up the model with an empty run - please wait ... (--no-warmup to disable)
main : serialized state into 988319 out of a maximum of 988319 bytes
llama_new_context_with_model: n_ctx      = 2048
llama_new_context_with_model: n_batch    = 2048
llama_new_context_with_model: n_ubatch   = 512
...
0.46user 0.19system 0:00.65elapsed 100%CPU (0avgtext+0avgdata 2896540maxresident)k
...
0.17user 0.16system 0:00.33elapsed 99%CPU (0avgtext+0avgdata 2891188maxresident)k
0inputs+48outputs (0major+57168minor)pagefaults 0swaps
```
