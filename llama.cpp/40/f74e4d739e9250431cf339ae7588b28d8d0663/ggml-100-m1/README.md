...
- status:  SUCCESS ✅
- runtime: 513.00
- date:    Sun Apr 21 18:43:37 EEST 2024
- repo:    https://github.com/ggerganov/llama.cpp
- commit:  https://github.com/ggerganov/llama.cpp/commit/40f74e4d739e9250431cf339ae7588b28d8d0663
...
21/23 Test #21: test-backend-ops ....................   Passed   93.31 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 196.11 sec*proc (23 tests)

Total Test time (real) = 196.12 sec
...
Test project /Users/ggml/work/llama.cpp/build-ci-release
 ...
 1/23 Test  #1: test-quantize-fns ...................   Passed   19.85 sec
      Start  2: test-quantize-perf
 2/23 Test  #2: test-quantize-perf ..................   Passed    5.69 sec
      Start  3: test-sampling
 3/23 Test  #3: test-sampling .......................   Passed    0.18 sec
      Start  4: test-chat-template
 4/23 Test  #4: test-chat-template ..................   Passed    0.19 sec
      Start  5: test-tokenizer-0-llama
...
Label Time Summary:
main    =  64.64 sec*proc (23 tests)

Total Test time (real) =  64.66 sec
...
llama_print_timings:        load time =      62.61 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      12.60 ms /     9 tokens (    1.40 ms per token,   714.06 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      36.03 ms /    10 tokens
...
llama_print_timings:        load time =      53.95 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.58 ms /     9 tokens (    1.29 ms per token,   777.07 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =      32.84 ms /    10 tokens
ggml_metal_free: deallocating
...
## Get to Work: A Sim's Guide to Career Success

**Get to Work** brings exciting new gameplay elements
llama_print_timings:        load time =    2743.78 ms
llama_print_timings:      sample time =      56.97 ms /    32 runs   (    1.78 ms per token,   561.71 tokens per second)
llama_print_timings: prompt eval time =     195.57 ms /     2 tokens (   97.79 ms per token,    10.23 tokens per second)
llama_print_timings:        eval time =    1501.36 ms /    31 runs   (   48.43 ms per token,    20.65 tokens per second)
llama_print_timings:       total time =    2519.23 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> The Simpsons: Treehouse of Horrors

The Simpsons family decides to renovate their treehouse, transforming it into a "Treehouse of Horrors." They recruit Homer
llama_print_timings:        load time =    3053.84 ms
llama_print_timings:      sample time =      57.12 ms /    32 runs   (    1.78 ms per token,   560.23 tokens per second)
llama_print_timings: prompt eval time =     202.79 ms /     2 tokens (  101.40 ms per token,     9.86 tokens per second)
llama_print_timings:        eval time =    1508.01 ms /    31 runs   (   48.65 ms per token,    20.56 tokens per second)
llama_print_timings:       total time =    2523.72 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
llama_print_timings:        load time =    2711.40 ms
llama_print_timings:      sample time =      57.38 ms /    32 runs   (    1.79 ms per token,   557.65 tokens per second)
llama_print_timings: prompt eval time =     196.89 ms /     2 tokens (   98.45 ms per token,    10.16 tokens per second)
llama_print_timings:        eval time =    1497.39 ms /    31 runs   (   48.30 ms per token,    20.70 tokens per second)
llama_print_timings:       total time =    2529.05 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
def generate_random_password(length):
  ...
  # Define the character sets for
llama_print_timings:        load time =    2583.67 ms
llama_print_timings:      sample time =      16.56 ms /    32 runs   (    0.52 ms per token,  1932.25 tokens per second)
llama_print_timings: prompt eval time =     194.56 ms /     2 tokens (   97.28 ms per token,    10.28 tokens per second)
llama_print_timings:        eval time =    1528.00 ms /    31 runs   (   49.29 ms per token,    20.29 tokens per second)
llama_print_timings:       total time =    1813.76 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> If x is the number of successes in a sequence of n independent Bernoulli trials, then the probability that exactly k successes occur is given by the following formula:

$$
llama_print_timings:        load time =    3058.79 ms
llama_print_timings:      sample time =      16.36 ms /    32 runs   (    0.51 ms per token,  1956.11 tokens per second)
llama_print_timings: prompt eval time =     201.30 ms /     2 tokens (  100.65 ms per token,     9.94 tokens per second)
llama_print_timings:        eval time =    1519.15 ms /    31 runs   (   49.00 ms per token,    20.41 tokens per second)
llama_print_timings:       total time =    1813.85 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say opposites attract, and when it comes to fashion, this couldn't be more true. While contrasting styles can be a statement, it's essential to
llama_print_timings:        load time =    2760.07 ms
llama_print_timings:      sample time =      16.56 ms /    32 runs   (    0.52 ms per token,  1932.13 tokens per second)
llama_print_timings: prompt eval time =     197.03 ms /     2 tokens (   98.51 ms per token,    10.15 tokens per second)
llama_print_timings:        eval time =    1530.40 ms /    31 runs   (   49.37 ms per token,    20.26 tokens per second)
llama_print_timings:       total time =    1821.10 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
