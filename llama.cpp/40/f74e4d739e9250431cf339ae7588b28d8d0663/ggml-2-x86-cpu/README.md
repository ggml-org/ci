...
- status:  SUCCESS ✅
- runtime: 12:35.69
- date:    Sun Apr 21 15:49:35 UTC 2024
...
10/23 Test #10: test-tokenizer-1-aquila .............   Passed    8.64 sec
...
llama_print_timings:       total time =      54.54 ms /    10 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       5.10 ms /     9 tokens (    0.57 ms per token,  1764.71 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> Helianthium, also known as Helium-3, is a noble gas with a symbol He and atomic number 2. It is the lightest element in the
llama_print_timings:        load time =     822.41 ms
llama_print_timings:      sample time =      47.74 ms /    32 runs   (    1.49 ms per token,   670.31 tokens per second)
llama_print_timings: prompt eval time =     718.73 ms /     2 tokens (  359.37 ms per token,     2.78 tokens per second)
llama_print_timings:        eval time =   12917.76 ms /    31 runs   (  416.70 ms per token,     2.40 tokens per second)
llama_print_timings:       total time =   13814.56 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say a picture is worth a thousand words, but sometimes a song can capture the essence of an experience in a way that resonates even deeper. 

Today,
llama_print_timings:        load time =     800.26 ms
llama_print_timings:      sample time =      47.70 ms /    32 runs   (    1.49 ms per token,   670.82 tokens per second)
llama_print_timings: prompt eval time =     720.10 ms /     2 tokens (  360.05 ms per token,     2.78 tokens per second)
llama_print_timings:        eval time =   13110.73 ms /    31 runs   (  422.93 ms per token,     2.36 tokens per second)
llama_print_timings:       total time =   14008.47 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If x=4 and y=5, find the value of 2x + 3y.

Given values:
x = 4
y =
llama_print_timings:        load time =     800.52 ms
llama_print_timings:      sample time =      47.69 ms /    32 runs   (    1.49 ms per token,   670.96 tokens per second)
llama_print_timings: prompt eval time =     715.54 ms /     2 tokens (  357.77 ms per token,     2.80 tokens per second)
llama_print_timings:        eval time =   13062.15 ms /    31 runs   (  421.36 ms per token,     2.37 tokens per second)
llama_print_timings:       total time =   13957.58 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a magical kingdom filled with enchanted forests and shimmering rivers, lived a brave princess named Anya.

Anya's kingdom was under threat from the sinister
llama_print_timings:        load time =     191.97 ms
llama_print_timings:      sample time =       6.08 ms /    32 runs   (    0.19 ms per token,  5259.70 tokens per second)
llama_print_timings: prompt eval time =     147.70 ms /     5 tokens (   29.54 ms per token,    33.85 tokens per second)
llama_print_timings:        eval time =    2082.07 ms /    31 runs   (   67.16 ms per token,    14.89 tokens per second)
llama_print_timings:       total time =    2295.57 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Once upon a time, in a bustling city, lived a young woman named Anya. Anya was known for her radiant smile and her infectious optimism, but deep down, she carried a
llama_print_timings:        load time =     169.02 ms
llama_print_timings:      sample time =       6.22 ms /    32 runs   (    0.19 ms per token,  5147.18 tokens per second)
llama_print_timings: prompt eval time =     145.31 ms /     5 tokens (   29.06 ms per token,    34.41 tokens per second)
llama_print_timings:        eval time =    2025.86 ms /    31 runs   (   65.35 ms per token,    15.30 tokens per second)
llama_print_timings:       total time =    2240.75 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
**Challenge 1: The Skywriting Challenge**

- Write a message in the sky using biodegradable ink.
- Share your photo on social
llama_print_timings:        load time =     173.26 ms
llama_print_timings:      sample time =       6.19 ms /    32 runs   (    0.19 ms per token,  5168.79 tokens per second)
llama_print_timings: prompt eval time =      87.78 ms /     2 tokens (   43.89 ms per token,    22.79 tokens per second)
llama_print_timings:        eval time =    2046.93 ms /    31 runs   (   66.03 ms per token,    15.14 tokens per second)
llama_print_timings:       total time =    2201.68 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =     689.46 ms
...
llama_print_timings:       total time =   10444.22 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6993.42 ms /   128 tokens (   54.64 ms per token,    18.30 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7004.06 ms /   129 tokens
...
llama_print_timings:        eval time =    6198.34 ms /    63 runs   (   98.39 ms per token,    10.16 tokens per second)
llama_print_timings:       total time =    6551.49 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4732.02 ms /   128 tokens (   36.97 ms per token,    27.05 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4741.97 ms /   129 tokens
...
llama_print_timings: prompt eval time =     327.45 ms /     8 tokens (   40.93 ms per token,    24.43 tokens per second)
llama_print_timings:        eval time =    4314.96 ms /    63 runs   (   68.49 ms per token,    14.60 tokens per second)
llama_print_timings:       total time =    4661.70 ms /    71 tokens
Log end
...
[1]4.1757,
llama_print_timings:        load time =     255.85 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5220.57 ms /   128 tokens (   40.79 ms per token,    24.52 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5231.19 ms /   129 tokens
...
llama_print_timings: prompt eval time =     375.78 ms /     8 tokens (   46.97 ms per token,    21.29 tokens per second)
llama_print_timings:        eval time =    4903.55 ms /    63 runs   (   77.83 ms per token,    12.85 tokens per second)
llama_print_timings:       total time =    5298.21 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5844.30 ms /   128 tokens (   45.66 ms per token,    21.90 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5854.25 ms /   129 tokens
...
llama_print_timings:        eval time =    5204.00 ms /    63 runs   (   82.60 ms per token,    12.11 tokens per second)
llama_print_timings:       total time =    5630.97 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6184.98 ms /   128 tokens (   48.32 ms per token,    20.70 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6194.61 ms /   129 tokens
...
<s> I believe the meaning of life is to live and die as the best version of ourselves.
...
I believe in the
llama_print_timings:        load time =     344.41 ms
llama_print_timings:      sample time =       2.10 ms /    64 runs   (    0.03 ms per token, 30534.35 tokens per second)
llama_print_timings: prompt eval time =     426.53 ms /     8 tokens (   53.32 ms per token,    18.76 tokens per second)
llama_print_timings:        eval time =    5552.09 ms /    63 runs   (   88.13 ms per token,    11.35 tokens per second)
llama_print_timings:       total time =    5997.93 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6557.70 ms /   128 tokens (   51.23 ms per token,    19.52 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6568.23 ms /   129 tokens
...
llama_print_timings: prompt eval time =     613.81 ms /     8 tokens (   76.73 ms per token,    13.03 tokens per second)
llama_print_timings:        eval time =    5768.28 ms /    63 runs   (   91.56 ms per token,    10.92 tokens per second)
llama_print_timings:       total time =    6401.91 ms /    71 tokens
Log end
...
[1]5.6444,
llama_print_timings:        load time =     278.74 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    9888.57 ms /   128 tokens (   77.25 ms per token,    12.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    9899.09 ms /   129 tokens
...
llama_print_timings: prompt eval time =     466.80 ms /     8 tokens (   58.35 ms per token,    17.14 tokens per second)
llama_print_timings:        eval time =    5057.60 ms /    63 runs   (   80.28 ms per token,    12.46 tokens per second)
llama_print_timings:       total time =    5543.94 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7436.98 ms /   128 tokens (   58.10 ms per token,    17.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7446.72 ms /   129 tokens
...
<s> I believe the meaning of life is to love, and I’m not sure I’ve ever met anyone who doesn’t love. I’ve had this belief since I was a little girl, so I’m not sure when I first really understood this to mean something. I know that I believe in love, and I know that I believe
...
llama_print_timings: prompt eval time =     395.10 ms /     8 tokens (   49.39 ms per token,    20.25 tokens per second)
llama_print_timings:        eval time =    5049.75 ms /    63 runs   (   80.15 ms per token,    12.48 tokens per second)
llama_print_timings:       total time =    5464.43 ms /    71 tokens
Log end
...
[1]4.1832,
llama_print_timings:        load time =     286.14 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6132.65 ms /   128 tokens (   47.91 ms per token,    20.87 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6142.89 ms /   129 tokens
...
<s> I believe the meaning of life is to find our passion, then to live our passion.
...
I believe in
llama_print_timings:        load time =     349.91 ms
llama_print_timings:      sample time =       2.08 ms /    64 runs   (    0.03 ms per token, 30739.67 tokens per second)
llama_print_timings: prompt eval time =     468.72 ms /     8 tokens (   58.59 ms per token,    17.07 tokens per second)
llama_print_timings:        eval time =    5778.73 ms /    63 runs   (   91.73 ms per token,    10.90 tokens per second)
llama_print_timings:       total time =    6266.97 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    7265.86 ms /   128 tokens (   56.76 ms per token,    17.62 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    7276.11 ms /   129 tokens
...
<s> I believe the meaning of life is to love. To be a loving person and to love others. I believe the meaning of life is to love. To be a loving person and to love others. I believe in the power of love. Love is the only reason I wake up in the morning. Love is the only reason I’m breathing today.
...
llama_print_timings:        eval time =    6427.66 ms /    63 runs   (  102.03 ms per token,     9.80 tokens per second)
llama_print_timings:       total time =    6968.94 ms /    71 tokens
Log end
...
[1]4.2445,
llama_print_timings:        load time =     370.34 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    8123.57 ms /   128 tokens (   63.47 ms per token,    15.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    8134.18 ms /   129 tokens
...
first run: The quick brown fox jumps over the lazy HSAT® class.
In the innovative PCQ,


second run: The quick brown fox jumps over the lazy HSAT® class.
In the innovative PCQ,


single seq run: The quick brown fox jumps over the lazy HSAT® class.
In the innovative PCQ,
...
[1]9.1010,
llama_print_timings:        load time =     663.40 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6675.40 ms /   128 tokens (   52.15 ms per token,    19.17 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6724.70 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 43.608 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 6.65 seconds per pass - ETA 0.10 minutes
[1]7.0168,
llama_print_timings:        load time =    5609.99 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    6645.48 ms /   128 tokens (   51.92 ms per token,    19.26 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    6691.40 ms /   129 tokens
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4723.84 ms /   128 tokens (   36.90 ms per token,    27.10 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4774.50 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.755 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 4.67 seconds per pass - ETA 0.07 minutes
[1]7.0066,
llama_print_timings:        load time =    3974.68 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    4668.37 ms /   128 tokens (   36.47 ms per token,    27.42 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    4716.01 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 1 | AVX_VNNI = 0 | AVX2 = 1 | AVX512 = 1 | AVX512_VBMI = 1 | AVX512_VNNI = 1 | FMA = 1 | NEON = 0 | ARM_FMA = 0 | F16C = 1 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 1 | SSSE3 = 1 | VSX = 0 | MATMUL_INT8 = 0 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 45.125 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 5.51 seconds per pass - ETA 0.08 minutes
[1]6.9704,
llama_print_timings:        load time =    4143.20 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    5512.17 ms /   128 tokens (   43.06 ms per token,    23.22 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    5559.83 ms /   129 tokens
...
0.31user 0.80system 0:01.12elapsed 100%CPU (0avgtext+0avgdata 6878048maxresident)k
...
0.10user 0.80system 0:00.90elapsed 100%CPU (0avgtext+0avgdata 6877892maxresident)k
0inputs+56outputs (0major+111960minor)pagefaults 0swaps
```
