...
- status:  SUCCESS ✅
- runtime: 625.00
- date:    Wed Apr 24 12:15:53 EEST 2024
...
21/23 Test #21: test-backend-ops ....................   Passed   92.41 sec
      Start 22: test-rope
...
Label Time Summary:
main    = 195.32 sec*proc (23 tests)

Total Test time (real) = 195.33 sec
...
llama_print_timings:        load time =      62.95 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.60 ms /     9 tokens (    1.29 ms per token,   775.66 tokens per second)
...
llama_print_timings:        load time =      56.24 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
**When:**
* Events occur regularly or predictably.
* Urgent decisions need to be made.
* Time is
llama_print_timings:        load time =    2568.61 ms
llama_print_timings:      sample time =      58.61 ms /    32 runs   (    1.83 ms per token,   546.02 tokens per second)
llama_print_timings: prompt eval time =     197.04 ms /     2 tokens (   98.52 ms per token,    10.15 tokens per second)
llama_print_timings:        eval time =    1501.36 ms /    31 runs   (   48.43 ms per token,    20.65 tokens per second)
llama_print_timings:       total time =    2566.11 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say money can't buy happiness, but it can buy you a lot of things that make you feel good.

**True or False?**

The
llama_print_timings:        load time =    2829.78 ms
llama_print_timings:      sample time =      56.66 ms /    32 runs   (    1.77 ms per token,   564.73 tokens per second)
llama_print_timings: prompt eval time =     202.44 ms /     2 tokens (  101.22 ms per token,     9.88 tokens per second)
llama_print_timings:        eval time =    1509.70 ms /    31 runs   (   48.70 ms per token,    20.53 tokens per second)
llama_print_timings:       total time =    2539.28 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
Heuristics are mental shortcuts or rules of thumb that people use to make decisions quickly and efficiently. Heuristics are often based on past experiences,
llama_print_timings:        load time =    3192.20 ms
llama_print_timings:      sample time =      56.28 ms /    32 runs   (    1.76 ms per token,   568.56 tokens per second)
llama_print_timings: prompt eval time =     197.38 ms /     2 tokens (   98.69 ms per token,    10.13 tokens per second)
llama_print_timings:        eval time =    1500.56 ms /    31 runs   (   48.41 ms per token,    20.66 tokens per second)
llama_print_timings:       total time =    2502.54 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> They say opposites attract, and that certainly seems to be true with the rivalry between the human brain and the artificial intelligence (AI) brain.

**Human Brain:**
llama_print_timings:        load time =    2899.13 ms
llama_print_timings:      sample time =      18.41 ms /    32 runs   (    0.58 ms per token,  1738.09 tokens per second)
llama_print_timings: prompt eval time =     194.01 ms /     2 tokens (   97.01 ms per token,    10.31 tokens per second)
llama_print_timings:        eval time =    1524.49 ms /    31 runs   (   49.18 ms per token,    20.33 tokens per second)
llama_print_timings:       total time =    1811.49 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> After a period of time, the amount of bacteria in a sample decreases by 25% per day.

a) Determine the initial number of bacteria in the
llama_print_timings:        load time =    3606.28 ms
llama_print_timings:      sample time =      18.38 ms /    32 runs   (    0.57 ms per token,  1740.64 tokens per second)
llama_print_timings: prompt eval time =     201.22 ms /     2 tokens (  100.61 ms per token,     9.94 tokens per second)
llama_print_timings:        eval time =    1521.80 ms /    31 runs   (   49.09 ms per token,    20.37 tokens per second)
llama_print_timings:       total time =    1817.50 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
Heuristics are mental shortcuts or rules of thumb that people use to make quick and efficient decisions.
llama_print_timings:        load time =    3034.02 ms
llama_print_timings:      sample time =      18.39 ms /    32 runs   (    0.57 ms per token,  1739.70 tokens per second)
llama_print_timings: prompt eval time =     196.22 ms /     2 tokens (   98.11 ms per token,    10.19 tokens per second)
llama_print_timings:        eval time =    1523.15 ms /    31 runs   (   49.13 ms per token,    20.35 tokens per second)
llama_print_timings:       total time =    1813.15 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
