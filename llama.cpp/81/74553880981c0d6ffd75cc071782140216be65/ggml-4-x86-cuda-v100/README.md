...
- status:  FAILURE ❌ (124)
- runtime: 
- date:    Mon May  6 07:40:59 UTC 2024
...
Test project /home/ggml/work/llama.cpp/build-ci-debug
 ...
 5/21 Test  #5: test-tokenizer-0-bert-bge ........   Passed    0.73 sec
 ...
 8/21 Test  #8: test-tokenizer-0-refact ..........   Passed    1.16 sec
      Start  9: test-tokenizer-0-command-r
 9/21 Test  #9: test-tokenizer-0-command-r .......   Passed    4.13 sec
      Start 10: test-tokenizer-1-llama-spm
10/21 Test #10: test-tokenizer-1-llama-spm .......   Passed    3.75 sec
...
19/21 Test #19: test-backend-ops .................   Passed  136.79 sec
      Start 20: test-rope
...
Label Time Summary:
main    = 207.86 sec*proc (21 tests)

Total Test time (real) = 207.87 sec
...
10/21 Test #10: test-tokenizer-1-llama-spm .......   Passed    0.55 sec
      Start 11: test-quantize-fns
11/21 Test #11: test-quantize-fns ................   Passed   20.89 sec
      Start 12: test-quantize-perf
12/21 Test #12: test-quantize-perf ...............   Passed    6.02 sec
      Start 13: test-sampling
...
18/21 Test #18: test-grad0 .......................   Passed    4.59 sec
      Start 19: test-backend-ops
19/21 Test #19: test-backend-ops .................   Passed   39.06 sec
      Start 20: test-rope
...
llama_print_timings:        load time =     421.44 ms
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       6.04 ms /     9 tokens (    0.67 ms per token,  1488.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> After the first 10 iterations of the for loop, the value of the loop counter is 10. Why?

```for (int i = 
llama_print_timings:        load time =    2269.61 ms
llama_print_timings:      sample time =      57.06 ms /    32 runs   (    1.78 ms per token,   560.79 tokens per second)
llama_print_timings: prompt eval time =    1721.94 ms /     2 tokens (  860.97 ms per token,     1.16 tokens per second)
llama_print_timings:        eval time =   37047.07 ms /    31 runs   ( 1195.07 ms per token,     0.84 tokens per second)
llama_print_timings:       total time =   39011.93 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Get Together is a pack for The Sims 4 that focuses on social interactions, relationships, and community building
llama_print_timings:        load time =    2333.70 ms
llama_print_timings:      sample time =      53.18 ms /    32 runs   (    1.66 ms per token,   601.79 tokens per second)
llama_print_timings: prompt eval time =    1752.47 ms /     2 tokens (  876.24 ms per token,     1.14 tokens per second)
llama_print_timings:        eval time =   33554.10 ms /    31 runs   ( 1082.39 ms per token,     0.92 tokens per second)
llama_print_timings:       total time =   35542.77 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When I am using the mouse, the cursor is moving erratically and not staying in place.

**Possible causes:**

* Hardware issues with the mouse
*
llama_print_timings:        load time =    2350.34 ms
llama_print_timings:      sample time =      51.17 ms /    32 runs   (    1.60 ms per token,   625.42 tokens per second)
llama_print_timings: prompt eval time =    1737.84 ms /     2 tokens (  868.92 ms per token,     1.15 tokens per second)
llama_print_timings:        eval time =   33747.55 ms /    31 runs   ( 1088.63 ms per token,     0.92 tokens per second)
llama_print_timings:       total time =   35724.56 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say that a picture is worth a thousand words, but in this case, a single image speaks volumes.

This single image captures the essence of a bustling marketplace
llama_print_timings:        load time =    2480.58 ms
llama_print_timings:      sample time =      51.58 ms /    32 runs   (    1.61 ms per token,   620.41 tokens per second)
llama_print_timings: prompt eval time =    1887.65 ms /     2 tokens (  943.83 ms per token,     1.06 tokens per second)
llama_print_timings:        eval time =   33499.14 ms /    31 runs   ( 1080.62 ms per token,     0.93 tokens per second)
llama_print_timings:       total time =   35620.76 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 225767.81 ms
main:    total time = 225767.81 ms
+ echo PASS
PASS
+ echo
...
<bos> Shekera was a king of ancient Egypt who ruled for over 70 years. He is known for his great military conquests and his ability to unite the Egyptian
llama_print_timings:        load time =    1188.11 ms
llama_print_timings:      sample time =      52.68 ms /    32 runs   (    1.65 ms per token,   607.43 tokens per second)
llama_print_timings: prompt eval time =     710.71 ms /     2 tokens (  355.35 ms per token,     2.81 tokens per second)
llama_print_timings:        eval time =   12161.60 ms /    31 runs   (  392.31 ms per token,     2.55 tokens per second)
llama_print_timings:       total time =   13109.58 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 225399.34 ms
main:    total time = 225399.34 ms
+ echo PASS
PASS
+ echo
...
<bos> Shekoul University students participated in a unique initiative aimed at promoting environmental awareness and sustainability among their peers.

**Here's what they did:**

* **
llama_print_timings:        load time =    1107.87 ms
llama_print_timings:      sample time =      52.82 ms /    32 runs   (    1.65 ms per token,   605.84 tokens per second)
llama_print_timings: prompt eval time =     639.90 ms /     2 tokens (  319.95 ms per token,     3.13 tokens per second)
llama_print_timings:        eval time =   12088.17 ms /    31 runs   (  389.94 ms per token,     2.56 tokens per second)
llama_print_timings:       total time =   12965.97 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Witcher Season 2: Release Date and Where to Watch

**Release Date:**

The Witcher Season 2 is scheduled to release on **December 17
...
llama_print_timings: prompt eval time =      79.73 ms /     2 tokens (   39.87 ms per token,    25.08 tokens per second)
llama_print_timings:        eval time =    2277.15 ms /    31 runs   (   73.46 ms per token,    13.61 tokens per second)
llama_print_timings:       total time =    2440.93 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> When I was a boy, I always wondered why the sky was blue.

As I grew older, I learned that the blue color of the sky is caused by
llama_print_timings:        load time =     607.18 ms
llama_print_timings:      sample time =       5.75 ms /    32 runs   (    0.18 ms per token,  5562.32 tokens per second)
llama_print_timings: prompt eval time =      81.03 ms /     2 tokens (   40.52 ms per token,    24.68 tokens per second)
llama_print_timings:        eval time =    2414.24 ms /    31 runs   (   77.88 ms per token,    12.84 tokens per second)
llama_print_timings:       total time =    2629.05 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> They say a picture is worth a thousand words, but I believe a song has the power to paint a thousand emotions in the heart.

- What is the main
llama_print_timings:        load time =     673.01 ms
llama_print_timings:      sample time =       6.52 ms /    32 runs   (    0.20 ms per token,  4910.23 tokens per second)
llama_print_timings: prompt eval time =     116.73 ms /     2 tokens (   58.37 ms per token,    17.13 tokens per second)
llama_print_timings:        eval time =    3299.31 ms /    31 runs   (  106.43 ms per token,     9.40 tokens per second)
llama_print_timings:       total time =    3514.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shekoul, a renowned astrologer and spiritual guide, shares his insights on navigating the challenges of modern life.

**Shekoul's Guiding Principles:**
llama_print_timings:        load time =     666.99 ms
llama_print_timings:      sample time =       5.77 ms /    32 runs   (    0.18 ms per token,  5547.85 tokens per second)
llama_print_timings: prompt eval time =     114.59 ms /     2 tokens (   57.29 ms per token,    17.45 tokens per second)
llama_print_timings:        eval time =    2530.84 ms /    31 runs   (   81.64 ms per token,    12.25 tokens per second)
llama_print_timings:       total time =    2735.64 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 44095.05 ms
main:    total time = 44095.05 ms
+ echo PASS
PASS
+ echo
...
<bos> Hebe, daughter of Atlas and Rhea, was a goddess of inspiration, beauty, and youth.

**Answer the following questions based on the provided text:**


llama_print_timings:        load time =     828.23 ms
llama_print_timings:      sample time =       5.25 ms /    32 runs   (    0.16 ms per token,  6097.56 tokens per second)
llama_print_timings: prompt eval time =      86.10 ms /     2 tokens (   43.05 ms per token,    23.23 tokens per second)
llama_print_timings:        eval time =    1562.12 ms /    31 runs   (   50.39 ms per token,    19.84 tokens per second)
llama_print_timings:       total time =    1786.02 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 42095.13 ms
main:    total time = 42095.14 ms
+ echo PASS
PASS
+ echo
...
This statement resonates deeply with me. It reminds me that the journey towards my dreams
llama_print_timings:        load time =     643.22 ms
llama_print_timings:      sample time =       5.70 ms /    32 runs   (    0.18 ms per token,  5612.07 tokens per second)
llama_print_timings: prompt eval time =      88.73 ms /     2 tokens (   44.37 ms per token,    22.54 tokens per second)
llama_print_timings:        eval time =    1845.42 ms /    31 runs   (   59.53 ms per token,    16.80 tokens per second)
llama_print_timings:       total time =    2045.45 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
