...
- status:  SUCCESS ✅
- runtime: 14:42.66
- date:    Tue Jun  4 07:15:54 UTC 2024
...
12/22 Test #12: test-quantize-fns ................   Passed   31.60 sec
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =       3.25 ms /     9 tokens (    0.36 ms per token,  2771.79 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 They say the only way to learn is by experience. But what if the only way to gain experience is by making mistakes?

**Exploring this idea:**

**
llama_print_timings:        load time =    1245.75 ms
llama_print_timings:      sample time =      47.42 ms /    32 runs   (    1.48 ms per token,   674.85 tokens per second)
llama_print_timings: prompt eval time =    1130.31 ms /     2 tokens (  565.15 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20767.16 ms /    31 runs   (  669.91 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22074.27 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 If the sequence is exponential, write the equation that represents it.

4, 8, 16, 32, 64, 1
llama_print_timings:        load time =    1226.95 ms
llama_print_timings:      sample time =      47.32 ms /    32 runs   (    1.48 ms per token,   676.19 tokens per second)
llama_print_timings: prompt eval time =    1226.88 ms /     2 tokens (  613.44 ms per token,     1.63 tokens per second)
llama_print_timings:        eval time =   20853.96 ms /    31 runs   (  672.71 ms per token,     1.49 tokens per second)
llama_print_timings:       total time =   22258.35 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
The Little Prince is a famous children's novel written by Antoine de Saint-Exupéry. It tells the story of a young prince who
llama_print_timings:        load time =    1214.71 ms
llama_print_timings:      sample time =      47.43 ms /    32 runs   (    1.48 ms per token,   674.71 tokens per second)
llama_print_timings: prompt eval time =    1152.72 ms /     2 tokens (  576.36 ms per token,     1.74 tokens per second)
llama_print_timings:        eval time =   21048.27 ms /    31 runs   (  678.98 ms per token,     1.47 tokens per second)
llama_print_timings:       total time =   22378.54 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
Escape rooms are typically themed around a single overarching narrative, with puzzles and challenges based on that theme. However, this concept
llama_print_timings:        load time =    1211.08 ms
llama_print_timings:      sample time =      47.66 ms /    32 runs   (    1.49 ms per token,   671.42 tokens per second)
llama_print_timings: prompt eval time =    1130.56 ms /     2 tokens (  565.28 ms per token,     1.77 tokens per second)
llama_print_timings:        eval time =   20887.96 ms /    31 runs   (  673.81 ms per token,     1.48 tokens per second)
llama_print_timings:       total time =   22195.81 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197362.29 ms
main:    total time = 197362.29 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Shew is a global leader in the manufacturing and distribution of high-quality, innovative tools and equipment for woodworkers, builders, and industrial users.

**What
llama_print_timings:        load time =     638.83 ms
llama_print_timings:      sample time =      47.49 ms /    32 runs   (    1.48 ms per token,   673.81 tokens per second)
llama_print_timings: prompt eval time =     570.73 ms /     2 tokens (  285.37 ms per token,     3.50 tokens per second)
llama_print_timings:        eval time =   10582.13 ms /    31 runs   (  341.36 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11330.98 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 197397.53 ms
main:    total time = 197397.53 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings:      sample time =      47.29 ms /    32 runs   (    1.48 ms per token,   676.63 tokens per second)
llama_print_timings: prompt eval time =     570.48 ms /     2 tokens (  285.24 ms per token,     3.51 tokens per second)
llama_print_timings:        eval time =   10588.56 ms /    31 runs   (  341.57 ms per token,     2.93 tokens per second)
llama_print_timings:       total time =   11337.38 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Soar is a technology company specializing in AI-powered data visualization. They empower businesses and organizations to create compelling, interactive visualizations that unlock deeper insights.
...
llama_print_timings: prompt eval time =      75.99 ms /     2 tokens (   38.00 ms per token,    26.32 tokens per second)
llama_print_timings:        eval time =    2094.24 ms /    31 runs   (   67.56 ms per token,    14.80 tokens per second)
llama_print_timings:       total time =    2232.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
This is a powerful message that encourages us to pursue our passions and to never give
llama_print_timings:        load time =     170.15 ms
...
llama_print_timings:        eval time =    2012.28 ms /    31 runs   (   64.91 ms per token,    15.41 tokens per second)
llama_print_timings:       total time =    2147.54 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Heissler's research on the evolutionary origins of human language provides valuable insights into the development of human communication and cognition.

**a)** True
**b
llama_print_timings:        load time =     159.84 ms
llama_print_timings:      sample time =       4.63 ms /    32 runs   (    0.14 ms per token,  6911.45 tokens per second)
llama_print_timings: prompt eval time =      78.91 ms /     2 tokens (   39.45 ms per token,    25.35 tokens per second)
llama_print_timings:        eval time =    2056.91 ms /    31 runs   (   66.35 ms per token,    15.07 tokens per second)
llama_print_timings:       total time =    2197.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Once upon a time, there was a young girl named Anya who loved to play in the forest.

**Part 1**

Anya would spend hours exploring the hidden paths
...
llama_print_timings: prompt eval time =     137.69 ms /     5 tokens (   27.54 ms per token,    36.31 tokens per second)
llama_print_timings:        eval time =    2162.02 ms /    31 runs   (   69.74 ms per token,    14.34 tokens per second)
llama_print_timings:       total time =    2364.77 ms /    36 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 31960.30 ms
main:    total time = 31960.30 ms
+ echo PASS
PASS
+ echo
...
**Context:** The speaker is writing a letter to someone they love.
...
llama_print_timings:        eval time =    1563.59 ms /    31 runs   (   50.44 ms per token,    19.83 tokens per second)
llama_print_timings:       total time =    1693.37 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 32134.04 ms
main:    total time = 32134.04 ms
+ echo PASS
PASS
+ echo
...
generate: n_ctx = 512, n_batch = 2048, n_predict = 32, n_keep = 1
 ...
 Heuristics can help in making decisions more efficient and effective.
...
llama_print_timings: prompt eval time =      67.20 ms /     2 tokens (   33.60 ms per token,    29.76 tokens per second)
llama_print_timings:        eval time =    1540.53 ms /    31 runs   (   49.69 ms per token,    20.12 tokens per second)
llama_print_timings:       total time =    1669.22 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =     123.01 ms /     8 tokens (   15.38 ms per token,    65.03 tokens per second)
llama_print_timings:        eval time =    3280.16 ms /    63 runs   (   52.07 ms per token,    19.21 tokens per second)
llama_print_timings:       total time =    3433.84 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1824.90 ms /   128 tokens (   14.26 ms per token,    70.14 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1840.44 ms /   129 tokens
...
llama_print_timings: prompt eval time =      86.52 ms /     8 tokens (   10.81 ms per token,    92.46 tokens per second)
llama_print_timings:        eval time =    2550.80 ms /    63 runs   (   40.49 ms per token,    24.70 tokens per second)
llama_print_timings:       total time =    2664.75 ms /    71 tokens
Log end
...
[1]9.5664,
llama_print_timings:        load time =     146.32 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1097.83 ms /   128 tokens (    8.58 ms per token,   116.59 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1113.75 ms /   129 tokens
...
llama_print_timings:        load time =     118.50 ms
llama_print_timings:      sample time =       2.28 ms /    64 runs   (    0.04 ms per token, 28057.87 tokens per second)
llama_print_timings: prompt eval time =      81.10 ms /     8 tokens (   10.14 ms per token,    98.64 tokens per second)
llama_print_timings:        eval time =    2035.11 ms /    63 runs   (   32.30 ms per token,    30.96 tokens per second)
llama_print_timings:       total time =    2143.11 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1208.93 ms /   128 tokens (    9.44 ms per token,   105.88 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1224.45 ms /   129 tokens
...
llama_print_timings: prompt eval time =     147.76 ms /     8 tokens (   18.47 ms per token,    54.14 tokens per second)
llama_print_timings:        eval time =    1985.77 ms /    63 runs   (   31.52 ms per token,    31.73 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2216.36 ms /   128 tokens (   17.32 ms per token,    57.75 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2231.60 ms /   129 tokens
...
llama_print_timings: prompt eval time =     158.50 ms /     8 tokens (   19.81 ms per token,    50.47 tokens per second)
llama_print_timings:        eval time =    2162.77 ms /    63 runs   (   34.33 ms per token,    29.13 tokens per second)
llama_print_timings:       total time =    2348.11 ms /    71 tokens
Log end
...
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2371.87 ms /   129 tokens
...
llama_print_timings:        eval time =    2284.55 ms /    63 runs   (   36.26 ms per token,    27.58 tokens per second)
llama_print_timings:       total time =    2478.09 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2512.70 ms /   128 tokens (   19.63 ms per token,    50.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2528.38 ms /   129 tokens
...
llama_print_timings:        eval time =    1503.06 ms /    63 runs   (   23.86 ms per token,    41.91 tokens per second)
llama_print_timings:       total time =    1634.80 ms /    71 tokens
Log end
...
[1]68.7223,
llama_print_timings:        load time =      78.90 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1592.19 ms /   128 tokens (   12.44 ms per token,    80.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1607.91 ms /   129 tokens
...
llama_print_timings:        eval time =    1715.96 ms /    63 runs   (   27.24 ms per token,    36.71 tokens per second)
llama_print_timings:       total time =    1856.96 ms /    71 tokens
Log end
...
[1]11.5044,
llama_print_timings:        load time =      89.51 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1676.05 ms /   128 tokens (   13.09 ms per token,    76.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1691.43 ms /   129 tokens
...
llama_print_timings:        eval time =    1882.36 ms /    63 runs   (   29.88 ms per token,    33.47 tokens per second)
llama_print_timings:       total time =    2030.63 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1738.55 ms /   128 tokens (   13.58 ms per token,    73.62 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1753.92 ms /   129 tokens
...
llama_print_timings:        eval time =    2125.98 ms /    63 runs   (   33.75 ms per token,    29.63 tokens per second)
llama_print_timings:       total time =    2292.36 ms /    71 tokens
Log end
...
[1]9.5581,
llama_print_timings:        load time =     116.54 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    2049.95 ms /   128 tokens (   16.02 ms per token,    62.44 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    2066.09 ms /   129 tokens
...
llama_print_timings:        load time =     139.23 ms
...
llama_print_timings:        eval time =    2232.53 ms /    63 runs   (   35.44 ms per token,    28.22 tokens per second)
llama_print_timings:       total time =    2391.12 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =    1859.21 ms /   128 tokens (   14.53 ms per token,    68.85 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =    1874.57 ms /   129 tokens
...
first run: The quick brown fox jumps over the fence in Rodeo Drive in preparation for training. In addition


second run: The quick brown fox jumps over the fence in Rodeo Drive in preparation for training. In addition


single seq run: The quick brown fox jumps over the fence in Rodeo Drive in preparation for training. In addition
...
1.22user 0.19system 0:01.41elapsed 99%CPU (0avgtext+0avgdata 2897852maxresident)k
...
0.23user 0.20system 0:00.44elapsed 99%CPU (0avgtext+0avgdata 2897060maxresident)k
