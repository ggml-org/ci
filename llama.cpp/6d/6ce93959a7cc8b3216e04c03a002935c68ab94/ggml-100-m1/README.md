...
- status:  SUCCESS ✅
- runtime: 712.56
- date:    Mon Apr 29 14:54:40 EEST 2024
...
20/22 Test #20: test-backend-ops ..................   Passed   93.21 sec
      Start 21: test-rope
...
Label Time Summary:
main    = 170.46 sec*proc (22 tests)

Total Test time (real) = 170.48 sec
...
Test project /Users/ggml/work/llama.cpp/build-ci-release
 ...
 9/22 Test  #9: test-tokenizer-0-gpt-2 ............   Passed    0.11 sec
      Start 10: test-tokenizer-1-gpt2
10/22 Test #10: test-tokenizer-1-gpt2 .............   Passed    2.30 sec
      Start 11: test-tokenizer-1-llama-spm
...
19/22 Test #19: test-grad0 ........................   Passed    0.82 sec
      Start 20: test-backend-ops
20/22 Test #20: test-backend-ops ..................   Passed   28.23 sec
      Start 21: test-rope
...
llama_print_timings: prompt eval time =      11.98 ms /     9 tokens (    1.33 ms per token,   751.31 tokens per second)
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      13.30 ms /     9 tokens (    1.48 ms per token,   676.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
<bos> After a lot of research, I have chosen a university and program that aligns with my career goals.

However, I need to formally submit my application to the university
llama_print_timings:        load time =    3243.04 ms
llama_print_timings:      sample time =      59.48 ms /    32 runs   (    1.86 ms per token,   538.04 tokens per second)
llama_print_timings: prompt eval time =     196.04 ms /     2 tokens (   98.02 ms per token,    10.20 tokens per second)
llama_print_timings:        eval time =    1506.11 ms /    31 runs   (   48.58 ms per token,    20.58 tokens per second)
llama_print_timings:       total time =    2560.74 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soar is a software solution designed to help businesses improve their customer experience and boost their revenue. It offers a comprehensive suite of features and services, including:

**
llama_print_timings:        load time =    3000.93 ms
llama_print_timings:      sample time =      57.40 ms /    32 runs   (    1.79 ms per token,   557.46 tokens per second)
...
llama_print_timings:       total time =    2526.40 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soar is a comprehensive, data-driven approach to employee engagement and leadership development.

**Key features of So Soar:**

* **Personalized dashboards:** Employees
llama_print_timings:        load time =    2686.03 ms
llama_print_timings:      sample time =      57.99 ms /    32 runs   (    1.81 ms per token,   551.78 tokens per second)
llama_print_timings: prompt eval time =     197.63 ms /     2 tokens (   98.82 ms per token,    10.12 tokens per second)
llama_print_timings:        eval time =    1499.81 ms /    31 runs   (   48.38 ms per token,    20.67 tokens per second)
llama_print_timings:       total time =    2519.59 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
<bos> Soar is a travel agency that specializes in adventure travel, specializing in activities like bungee jumping, ziplining, whitewater rafting, scuba diving, and wildlife saf
llama_print_timings:        load time =    2528.02 ms
llama_print_timings:      sample time =      16.68 ms /    32 runs   (    0.52 ms per token,  1918.01 tokens per second)
llama_print_timings: prompt eval time =     195.18 ms /     2 tokens (   97.59 ms per token,    10.25 tokens per second)
llama_print_timings:        eval time =    1524.28 ms /    31 runs   (   49.17 ms per token,    20.34 tokens per second)
llama_print_timings:       total time =    1810.29 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
To provide holistic and effective healing solutions through personalized and integrative approaches that promote physical, emotional, and spiritual well-being.


llama_print_timings:        load time =    2732.83 ms
llama_print_timings:      sample time =      16.68 ms /    32 runs   (    0.52 ms per token,  1918.12 tokens per second)
llama_print_timings: prompt eval time =     201.87 ms /     2 tokens (  100.93 ms per token,     9.91 tokens per second)
llama_print_timings:        eval time =    1521.01 ms /    31 runs   (   49.06 ms per token,    20.38 tokens per second)
llama_print_timings:       total time =    1815.45 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
$$f(
llama_print_timings:        load time =    2776.33 ms
llama_print_timings:      sample time =      16.28 ms /    32 runs   (    0.51 ms per token,  1965.12 tokens per second)
...
llama_print_timings:       total time =    1817.97 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21310.35 ms
main:    total time = 21310.35 ms
+ echo PASS
PASS
+ echo
...
llama_print_timings: prompt eval time =     212.56 ms /     2 tokens (  106.28 ms per token,     9.41 tokens per second)
llama_print_timings:        eval time =    1090.40 ms /    31 runs   (   35.17 ms per token,    28.43 tokens per second)
llama_print_timings:       total time =    1393.36 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
...
main: quantize time = 21597.16 ms
main:    total time = 21597.16 ms
+ echo PASS
PASS
+ echo
...
It is currently today, so the
llama_print_timings:        load time =    1587.79 ms
llama_print_timings:      sample time =      16.30 ms /    32 runs   (    0.51 ms per token,  1963.55 tokens per second)
llama_print_timings: prompt eval time =     214.67 ms /     2 tokens (  107.33 ms per token,     9.32 tokens per second)
llama_print_timings:        eval time =    1099.77 ms /    31 runs   (   35.48 ms per token,    28.19 tokens per second)
llama_print_timings:       total time =    1405.10 ms /    33 tokens
ggml_metal_free: deallocating
Log end
+ echo PASS
PASS
