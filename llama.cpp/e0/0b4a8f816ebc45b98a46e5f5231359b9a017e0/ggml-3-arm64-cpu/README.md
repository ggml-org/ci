...
- status:  SUCCESS ✅
- runtime: 19:39.42
- date:    Sun Apr 28 22:58:32 UTC 2024
...
14/23 Test #14: test-tokenizer-1-refact .............   Passed    5.23 sec
...
llama_print_timings: prompt eval time =      12.98 ms /     9 tokens (    1.44 ms per token,   693.11 tokens per second)
...
**2.
llama_print_timings:        load time =    3763.30 ms
llama_print_timings:      sample time =      41.60 ms /    32 runs   (    1.30 ms per token,   769.30 tokens per second)
llama_print_timings: prompt eval time =    2753.35 ms /     2 tokens ( 1376.68 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   49140.56 ms /    31 runs   ( 1585.18 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   52050.06 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> If the radius of the circle is 5 cm, then its area is:
a) 78.5 cm²
b) 125
llama_print_timings:        load time =    3748.02 ms
llama_print_timings:      sample time =      41.39 ms /    32 runs   (    1.29 ms per token,   773.13 tokens per second)
llama_print_timings: prompt eval time =    2754.21 ms /     2 tokens ( 1377.10 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   49119.70 ms /    31 runs   ( 1584.51 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   52029.16 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
To inspire young people to achieve their full potential through mentorship, education, and empowerment.

**Values:**

* Empowerment

llama_print_timings:        load time =    3743.28 ms
llama_print_timings:      sample time =      41.84 ms /    32 runs   (    1.31 ms per token,   764.75 tokens per second)
llama_print_timings: prompt eval time =    2754.63 ms /     2 tokens ( 1377.32 ms per token,     0.73 tokens per second)
llama_print_timings:        eval time =   49152.15 ms /    31 runs   ( 1585.55 ms per token,     0.63 tokens per second)
llama_print_timings:       total time =   52062.46 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> The Office (US) characters often engage in playful banter, which often involves making sarcastic or witty remarks. This element adds humor and lightness to the show, making it
llama_print_timings:        load time =    1172.19 ms
...
llama_print_timings:        eval time =    3113.76 ms /    31 runs   (  100.44 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    3319.45 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Heuristics (HUs) are mental shortcuts that people use to make decisions quickly and efficiently. HUs are based on psychological principles such as mental representation, perception
...
llama_print_timings:        eval time =    3109.28 ms /    31 runs   (  100.30 ms per token,     9.97 tokens per second)
llama_print_timings:       total time =    3315.18 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
<bos> Shelliel is the protagonist of the Hebrew Bible. She is believed to be a prophetess sent by God to deliver judgment upon Israel.

**Questions:**


llama_print_timings:        load time =    1176.86 ms
...
llama_print_timings:        eval time =    3112.20 ms /    31 runs   (  100.39 ms per token,     9.96 tokens per second)
llama_print_timings:       total time =    3319.29 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26730.51 ms
main:    total time = 26730.51 ms
+ echo PASS
PASS
+ echo
...
This powerful quote captures the essence of breathwork. It's a reminder that breath is more than just a physical process
...
llama_print_timings: prompt eval time =     155.61 ms /     2 tokens (   77.80 ms per token,    12.85 tokens per second)
llama_print_timings:        eval time =    2915.52 ms /    31 runs   (   94.05 ms per token,    10.63 tokens per second)
llama_print_timings:       total time =    3111.61 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
main: quantize time = 26857.92 ms
main:    total time = 26857.92 ms
+ echo PASS
PASS
+ echo
...
<bos> Heider Agency - The Professionals Behind the Branding

**The Heider Agency: Your Trusted Partner in Branding**

Established in 1946, The He
llama_print_timings:        load time =     761.62 ms
llama_print_timings:      sample time =       8.07 ms /    32 runs   (    0.25 ms per token,  3962.85 tokens per second)
llama_print_timings: prompt eval time =     155.13 ms /     2 tokens (   77.56 ms per token,    12.89 tokens per second)
llama_print_timings:        eval time =    2899.74 ms /    31 runs   (   93.54 ms per token,    10.69 tokens per second)
llama_print_timings:       total time =    3095.43 ms /    33 tokens
Log end
+ echo PASS
PASS
+ echo
...
llama_print_timings:        load time =    2910.49 ms
llama_print_timings:      sample time =       2.72 ms /    64 runs   (    0.04 ms per token, 23555.39 tokens per second)
llama_print_timings: prompt eval time =    1119.48 ms /     8 tokens (  139.93 ms per token,     7.15 tokens per second)
llama_print_timings:        eval time =   14095.91 ms /    63 runs   (  223.74 ms per token,     4.47 tokens per second)
llama_print_timings:       total time =   15229.23 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22173.90 ms /   128 tokens (  173.23 ms per token,     5.77 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22186.49 ms /   129 tokens
...
llama_print_timings:        load time =    1641.26 ms
llama_print_timings:      sample time =       2.64 ms /    64 runs   (    0.04 ms per token, 24251.61 tokens per second)
llama_print_timings: prompt eval time =     880.84 ms /     8 tokens (  110.11 ms per token,     9.08 tokens per second)
llama_print_timings:        eval time =    8395.37 ms /    63 runs   (  133.26 ms per token,     7.50 tokens per second)
llama_print_timings:       total time =    9290.34 ms /    71 tokens
Log end
...
[1]4.2505,
llama_print_timings:        load time =    1620.89 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14305.45 ms /   128 tokens (  111.76 ms per token,     8.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14317.45 ms /   129 tokens
...
llama_print_timings: prompt eval time =     907.25 ms /     8 tokens (  113.41 ms per token,     8.82 tokens per second)
llama_print_timings:        eval time =    7880.98 ms /    63 runs   (  125.09 ms per token,     7.99 tokens per second)
llama_print_timings:       total time =    8802.59 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14911.43 ms /   128 tokens (  116.50 ms per token,     8.58 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
...
llama_print_timings: prompt eval time =     959.10 ms /     8 tokens (  119.89 ms per token,     8.34 tokens per second)
llama_print_timings:        eval time =    8380.10 ms /    63 runs   (  133.02 ms per token,     7.52 tokens per second)
llama_print_timings:       total time =    9353.29 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15828.19 ms /   128 tokens (  123.66 ms per token,     8.09 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15839.77 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1220.46 ms /     8 tokens (  152.56 ms per token,     6.55 tokens per second)
llama_print_timings:        eval time =   10582.86 ms /    63 runs   (  167.98 ms per token,     5.95 tokens per second)
llama_print_timings:       total time =   11817.08 ms /    71 tokens
Log end
...
[1]4.3235,
llama_print_timings:        load time =    1247.30 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20032.20 ms /   128 tokens (  156.50 ms per token,     6.39 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20043.89 ms /   129 tokens
...
llama_print_timings: prompt eval time =    1233.96 ms /     8 tokens (  154.25 ms per token,     6.48 tokens per second)
llama_print_timings:        eval time =   10944.60 ms /    63 runs   (  173.72 ms per token,     5.76 tokens per second)
llama_print_timings:       total time =   12192.79 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   20082.94 ms /   128 tokens (  156.90 ms per token,     6.37 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   20095.44 ms /   129 tokens
...
llama_print_timings:        eval time =    9790.19 ms /    63 runs   (  155.40 ms per token,     6.44 tokens per second)
llama_print_timings:       total time =   10952.62 ms /    71 tokens
Log end
...
[1]5.6277,
llama_print_timings:        load time =     844.74 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   18719.69 ms /   128 tokens (  146.25 ms per token,     6.84 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   18731.94 ms /   129 tokens
...
llama_print_timings:        load time =     998.13 ms
llama_print_timings:      sample time =       2.79 ms /    64 runs   (    0.04 ms per token, 22930.85 tokens per second)
llama_print_timings: prompt eval time =    1080.24 ms /     8 tokens (  135.03 ms per token,     7.41 tokens per second)
llama_print_timings:        eval time =    9337.23 ms /    63 runs   (  148.21 ms per token,     6.75 tokens per second)
llama_print_timings:       total time =   10432.03 ms /    71 tokens
Log end
...
[1]4.4094,
llama_print_timings:        load time =     962.07 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   17751.43 ms /   128 tokens (  138.68 ms per token,     7.21 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   17763.99 ms /   129 tokens
...
llama_print_timings:        load time =    1134.87 ms
llama_print_timings:      sample time =       2.70 ms /    64 runs   (    0.04 ms per token, 23677.40 tokens per second)
llama_print_timings: prompt eval time =     957.00 ms /     8 tokens (  119.62 ms per token,     8.36 tokens per second)
llama_print_timings:        eval time =    8343.19 ms /    63 runs   (  132.43 ms per token,     7.55 tokens per second)
llama_print_timings:       total time =    9314.18 ms /    71 tokens
Log end
...
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   15631.54 ms /   128 tokens (  122.12 ms per token,     8.19 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   15644.11 ms /   129 tokens
...
llama_print_timings:        load time =    1329.04 ms
llama_print_timings:      sample time =       2.74 ms /    64 runs   (    0.04 ms per token, 23349.14 tokens per second)
llama_print_timings: prompt eval time =    1314.09 ms /     8 tokens (  164.26 ms per token,     6.09 tokens per second)
llama_print_timings:        eval time =   11148.80 ms /    63 runs   (  176.97 ms per token,     5.65 tokens per second)
llama_print_timings:       total time =   12477.40 ms /    71 tokens
Log end
...
[1]4.2277,
llama_print_timings:        load time =    1339.25 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21439.79 ms /   128 tokens (  167.50 ms per token,     5.97 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   21452.07 ms /   129 tokens
...
llama_print_timings:       total time =   12829.97 ms /    71 tokens
Log end
...
[1]4.2538,
llama_print_timings:        load time =    1449.91 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22000.95 ms /   128 tokens (  171.88 ms per token,     5.82 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22013.40 ms /   129 tokens
...
single seq run: The quick brown fox jumps over the lan.
Perhaps a print of this.
this world
...
[1]9.1008,
llama_print_timings:        load time =    2935.09 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   22205.70 ms /   128 tokens (  173.48 ms per token,     5.76 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22272.95 ms /   129 tokens
...
[1]7.0171,
llama_print_timings:        load time =    6923.03 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   21945.21 ms /   128 tokens (  171.45 ms per token,     5.83 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   22008.83 ms /   129 tokens
...
perplexity: 14.31 seconds per pass - ETA 0.23 minutes
[1]9.1403,
llama_print_timings:        load time =    1525.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14313.46 ms /   128 tokens (  111.82 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14377.61 ms /   129 tokens
...
[1]6.9493,
llama_print_timings:        load time =    5442.64 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14316.40 ms /   128 tokens (  111.85 ms per token,     8.94 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14385.05 ms /   129 tokens
...
system_info: n_threads = 4 / 8 | AVX = 0 | AVX_VNNI = 0 | AVX2 = 0 | AVX512 = 0 | AVX512_VBMI = 0 | AVX512_VNNI = 0 | FMA = 0 | NEON = 1 | ARM_FMA = 1 | F16C = 0 | FP16_VA = 0 | WASM_SIMD = 0 | BLAS = 0 | SSE3 = 0 | SSSE3 = 0 | VSX = 0 | MATMUL_INT8 = 0 | LAMMAFILE = 1 | 
perplexity: tokenizing the input ..
perplexity: tokenization took 60.073 ms
perplexity: calculating perplexity over 1 chunks, n_ctx=128, batch_size=128, n_seq=1
perplexity: 14.31 seconds per pass - ETA 0.23 minutes
[1]7.0116,
llama_print_timings:        load time =    6066.62 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =   14308.99 ms /   128 tokens (  111.79 ms per token,     8.95 tokens per second)
llama_print_timings:        eval time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings:       total time =   14370.38 ms /   129 tokens
...
0.36user 2.75system 0:03.11elapsed 100%CPU (0avgtext+0avgdata 6877816maxresident)k
...
0.11user 2.92system 0:03.03elapsed 100%CPU (0avgtext+0avgdata 6877360maxresident)k
