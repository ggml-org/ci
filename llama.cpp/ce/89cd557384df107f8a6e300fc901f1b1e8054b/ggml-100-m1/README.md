...
- status:  SUCCESS ✅
- runtime: 362.41
- date:    Wed May 22 10:16:35 EEST 2024
...
Label Time Summary:
main    = 184.16 sec*proc (22 tests)

Total Test time (real) = 184.18 sec
...
llama_print_timings:        load time =      71.92 ms
llama_print_timings:      sample time =       0.00 ms /     1 runs   (    0.00 ms per token,      inf tokens per second)
llama_print_timings: prompt eval time =      11.93 ms /     9 tokens (    1.33 ms per token,   754.46 tokens per second)
